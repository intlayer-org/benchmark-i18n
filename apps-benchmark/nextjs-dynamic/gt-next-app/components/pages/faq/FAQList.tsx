...
export default function FAQList() {
  const faqs = [
    ...
    },
    {
      ...
      a: (
        <T>
          ...
          statistical significance. All test configurations are publicly
    ...
    },
    {
      ...
      a: (
        <T>
          We support react-i18next, react-intl (FormatJS), Lingui,
          typesafe-i18n, next-intl, Paraglide, Rosetta, i18n-js, Polyglot.js,
          vue-i18n, @fluent/react, and Tolgee.
        </T>
      ),
    },
    {
    ...
    },
    {
      ...
      a: (
        <T>
          Yes, our Enterprise plan includes consulting hours for teams
          evaluating i18n solutions. We can provide tailored recommendations
          based on your specific use case, scale, and constraints.
        </T>
      ),
    },
    {
      ...
      a: (
        <T>
          ...
          documentation, report bugs, suggest new metrics, or sponsor the
          project. Visit our GitHub repository for more details.
        </T>
      ),
    },
  ];
