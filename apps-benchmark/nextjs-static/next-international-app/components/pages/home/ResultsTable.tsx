  ...
  return (
    <section>
      <h2 className="mb-6 text-2xl font-bold text-foreground">
        {t("home.results-table.sampleResults")}
      </h2>
          ...
          <thead className="bg-muted">
            <tr>
              <th className="px-4 py-3 text-left font-medium text-muted-foreground">
                {t("home.results-table.libraryColumn")}
              </th>
              <th className="px-4 py-3 text-left font-medium text-muted-foreground">
                {t("home.results-table.bundleSize")}
              </th>
              <th className="px-4 py-3 text-left font-medium text-muted-foreground">
                {t("home.results-table.lookupTime")}
              </th>
              <th className="px-4 py-3 text-left font-medium text-muted-foreground">
                {t("home.results-table.lazyLoading")}
              </th>
            </tr>
          </thead>
          <tbody>
