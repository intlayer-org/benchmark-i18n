...
Error: page.evaluate: Error: E2E timeout: html[lang] did not change to 'fr'
    at eval (eval at evaluate (:302:30), <anonymous>:26:16)
```
  ...
  - generic [ref=e20]:
    ...
    - generic [ref=e39]:
      ...
      - generic [ref=e41]:
        ...
        - paragraph [ref=e43]: Many i18n libraries store translations in large JSON files that are loaded upfront. This can significantly increase the "Time to Interactive" as the browser must download and parse these files before the app can be used.
        - list [ref=e44]:
          - listitem [ref=e45]: The JSON must be parsed on every page load — blocking the main thread.
          - listitem [ref=e46]: Context-based architectures can cause the entire app to re-render when the language changes. For large apps with thousands of components, this can lead to noticeable lag during locale switches.
