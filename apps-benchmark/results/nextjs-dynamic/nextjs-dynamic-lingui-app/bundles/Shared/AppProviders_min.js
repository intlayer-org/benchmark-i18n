import { Profiler as e, createContext as t, useCallback as n, useEffect as r, useMemo as i, useRef as a, useState as o } from "react";
import { jsx as s } from "react/jsx-runtime";
//#region \0rolldown/runtime.js
var c = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), l = t(null), u = ({ i18n: e, defaultComponent: t, children: i }) => {
	let c = a(e.locale), u = n(() => ({
		i18n: e,
		defaultComponent: t,
		_: e.t.bind(e)
	}), [e, t]), [d, f] = o(u());
...
function j(e, t) {
	return /^::/.test(e) ? E(ne(e.substring(2)), void 0, t) : e;
}
function M(e, t = (e) => e) {
	return A((0, h.parse)(e), t);
}
function N(e, t = (e) => e) {
	try {
		return M(e, t);
...
function z(e, t, n) {
	...
	return H(() => U("date", r, n), () => new Intl.DateTimeFormat(r, i)).format(P(t) ? new Date(t) : t);
}
function re(e, t, n) {
	let r;
...
function Y(e, t, n) {
	return (r = {}, i) => {
		...
		return P(s) && W.test(s) ? G(s) : P(s) ? s : s ? String(s) : "";
	};
}
...
}, ce = Object.defineProperty, le = (e, t, n) => t in e ? ce(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, X = (e, t, n) => (le(e, typeof t == "symbol" ? t : t + "", n), n), ue = class extends se {
	constructor(e) {
		super(), X(this, "_locale", ""), X(this, "_locales"), X(this, "_localeData", {}), X(this, "_messages", {}), X(this, "_missing"), X(this, "_messageCompiler"), X(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(N), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? L, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), P(s) && W.test(s) ? G(s) : P(s) ? s : Y(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
function $({ children: t, locale: n, messages: a }) {
	let o = i(() => Q(n, a), [n, a]);
	return r(() => {
