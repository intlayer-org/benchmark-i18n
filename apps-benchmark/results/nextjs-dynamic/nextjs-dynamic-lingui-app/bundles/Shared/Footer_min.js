import { Profiler as e, cloneElement as t, createContext as n, useCallback as r, useContext as i, useEffect as a, useMemo as o, useRef as s, useState as c } from "react";
import { useParams as l } from "next/navigation";
import u from "next/link";
import { Fragment as d, jsx as f, jsxs as p } from "react/jsx-runtime";
//#region \0rolldown/runtime.js
var m = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), h = (e) => /^https?:\/\//.test(e ?? ""), g = ({ href: e, children: t, ...n }) => {
...
function y(e, n = {}) {
	...
	o && a.push(o);
	for (let [e, o, s] of b(r)) {
		let r = e === void 0 ? void 0 : n[e];
		(!r || v[r.type] && o) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${e}' as it is not declared in the original translation`), r = f(d, {})), Array.isArray(r) && (r = f(d, { children: r })), a.push(t(r, { key: i() }, o ? y(o, n) : r.props.children)), s && a.push(s);
	}
...
var x = (e = 0, t = "") => () => `${t}_${e++}`;
function S(e) {
	let { render: t, component: n, id: r, message: i, formats: a, lingui: { i18n: o, defaultComponent: s } } = e, { values: c, components: l } = w(e), u = o && typeof o._ == "function" ? o._(r, c, {
		message: i,
		formats: a
	}) : r, d = u ? y(u, l) : null;
...
var te = ({ i18n: e, defaultComponent: t, children: n }) => {
...
var Ce = Object.defineProperty, we = (e, t, n) => t in e ? Ce(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Te = (e, t, n) => (we(e, typeof t == "symbol" ? t : t + "", n), n), Ee = class {
	constructor() {
		Te(this, "_events", {});
	}
	on(e, t) {
...
}, De = Object.defineProperty, Oe = (e, t, n) => t in e ? De(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (Oe(e, typeof t == "symbol" ? t : t + "", n), n), Q = class extends Ee {
	constructor(e) {
		super(), Z(this, "_locale", ""), Z(this, "_locales"), Z(this, "_localeData", {}), Z(this, "_messages", {}), Z(this, "_missing"), Z(this, "_messageCompiler"), Z(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(_e), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? V, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
function Ae({ children: t, locale: n, messages: r }) {
	let i = o(() => ke(n, r), [n, r]);
	return a(() => {
