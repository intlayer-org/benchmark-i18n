import { Profiler as e, createContext as t, useCallback as n, useContext as r, useEffect as i, useLayoutEffect as a, useMemo as o, useRef as s, useState as c } from "react";
...
var g = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), _ = (e) => /^https?:\/\//.test(e ?? ""), v = ({ href: e, children: t, ...n }) => {
	let r = l().locale ?? "en", i = _(e.toString());
	return p(f, {
...
var S = ({ i18n: e, defaultComponent: t, children: r }) => {
					...
					children: [
						...
						m("div", {
							...
							children: [m("button", {
								...
								onMouseLeave: () => n(!1),
								onClick: () => n(!t),
								children: [e._("header.mockPages"), p(h, {
									size: 14,
