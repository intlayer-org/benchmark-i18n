...
var u = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), d = (e) => /^https?:\/\//.test(e ?? ""), f = ({ href: e, children: t, ...n }) => {
...
}, p = t(null), m = ({ i18n: e, defaultComponent: t, children: i }) => {
...
function me({ children: t, locale: n, messages: a }) {
	let o = i(() => $(n, a), [n, a]);
	return r(() => {
