...
var d = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), f = d(((e, t) => {
	(function(e, n) {
...
var Z = Object.defineProperty, ne = (e, t, n) => t in e ? Z(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, re = (e, t, n) => (ne(e, typeof t == "symbol" ? t : t + "", n), n), ie = class {
	constructor() {
		re(this, "_events", {});
	}
	on(e, t) {
	...
	writable: !0,
	value: n
}) : e[t] = n, Q = (e, t, n) => (oe(e, typeof t == "symbol" ? t : t + "", n), n), se = class extends ie {
	constructor(e) {
...
`)), F(s) && G.test(s) ? K(s) : F(s) ? s : X(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
var fe = t(null), pe = ({ i18n: e, defaultComponent: t, children: i }) => {
	let s = a(e.locale), c = n(() => ({
		i18n: e,
		defaultComponent: t,
		_: e.t.bind(e)
	}), [e, t]), [l, d] = o(c());
...
function ge({ children: t, locale: n, messages: a }) {
	let o = i(() => ue(n, a), [n, a]);
	return r(() => {
