...
var l = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), u = t(null), d = (e) => {
	let t = r(u);
...
var p = ({ i18n: e, defaultComponent: t, children: r }) => {
	let a = o(e.locale), l = n(() => ({
		i18n: e,
		defaultComponent: t,
		_: e.t.bind(e)
	}), [e, t]), [d, f] = s(l());
...
function me({ children: t, locale: n, messages: r }) {
	let o = a(() => $(n, r), [n, r]);
	return i(() => {
