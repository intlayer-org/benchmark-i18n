...
var h = ({ i18n: e, defaultComponent: t, children: r }) => {
...
function ae(e, t) {
	return /^::/.test(e) ? M(ie(e.substring(2)), void 0, t) : e;
}
function oe(e, t = (e) => e) {
	return F((0, S.parse)(e), t);
}
function I(e, t = (e) => e) {
	try {
		return oe(e, t);
...
var ue = Object.defineProperty, de = (e, t, n) => t in e ? ue(e, t, {
	...
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (he(e, typeof t == "symbol" ? t : t + "", n), n), ge = class extends pe {
	constructor(e) {
...
function _e({ children: t, locale: n, messages: r }) {
	let o = a(() => $(n, r), [n, r]);
	return i(() => {
