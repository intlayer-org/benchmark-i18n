import { Profiler as e, cloneElement as t, createContext as n, useCallback as r, useContext as i, useEffect as a, useLayoutEffect as o, useMemo as s, useRef as c, useState as l } from "react";
...
function I(e, t) {
	return /^::/.test(e) ? pe(P(e.substring(2)), void 0, t) : e;
}
function L(e, t = (e) => e) {
	return F((0, ae.parse)(e), t);
}
function R(e, t = (e) => e) {
	try {
		return L(e, t);
...
var z = (e) => typeof e == "string", ge = (e) => typeof e == "function", B = /* @__PURE__ */ new Map(), V = "en";
function H(e) {
...
}), X = "%__lingui_octothorpe__%", ve = (e, t, n = {}) => {
...
var xe = Object.defineProperty, Se = (e, t, n) => t in e ? xe(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (Se(e, typeof t == "symbol" ? t : t + "", n), n), Ce = class {
	constructor() {
		Z(this, "_events", {});
	}
	on(e, t) {
	...
	writable: !0,
	value: n
}) : e[t] = n, Q = (e, t, n) => (Te(e, typeof t == "symbol" ? t : t + "", n), n), Ee = class extends Ce {
	constructor(e) {
...
`)), z(s) && J.test(s) ? Y(s) : z(s) ? s : be(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
function Oe({ children: t, locale: n, messages: r }) {
	let i = s(() => De(n, r), [n, r]);
	return a(() => {
