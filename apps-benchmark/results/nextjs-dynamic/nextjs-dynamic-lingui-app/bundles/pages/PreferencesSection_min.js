import { Profiler as e, cloneElement as t, createContext as n, useCallback as r, useContext as i, useEffect as a, useId as o, useMemo as s, useRef as c, useState as l } from "react";
...
function g(e, n = {}) {
	...
	o && a.push(o);
	for (let [e, o, s] of _(r)) {
		let r = e === void 0 ? void 0 : n[e];
		(!r || h[r.type] && o) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${e}' as it is not declared in the original translation`), r = d(u, {})), Array.isArray(r) && (r = d(u, { children: r })), a.push(t(r, { key: i() }, o ? g(o, n) : r.props.children)), s && a.push(s);
	}
...
var T = ({ i18n: e, defaultComponent: t, children: n }) => {
...
var be = Object.defineProperty, xe = (e, t, n) => t in e ? be(e, t, {
	...
	writable: !0,
	value: n
}) : e[t] = n, Se = (e, t, n) => (xe(e, typeof t == "symbol" ? t : t + "", n), n), Z = class {
	constructor() {
		Se(this, "_events", {});
	}
	on(e, t) {
	...
	writable: !0,
	value: n
}) : e[t] = n, Q = (e, t, n) => (we(e, typeof t == "symbol" ? t : t + "", n), n), Te = class extends Z {
	constructor(e) {
		super(), Q(this, "_locale", ""), Q(this, "_locales"), Q(this, "_localeData", {}), Q(this, "_messages", {}), Q(this, "_missing"), Q(this, "_messageCompiler"), Q(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(R), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? V, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
function De({ children: t, locale: n, messages: r }) {
	let i = s(() => Ee(n, r), [n, r]);
	return a(() => {
