...
function h(e, n = {}) {
	...
	o && a.push(o);
	for (let [e, o, s] of g(r)) {
		let r = e === void 0 ? void 0 : n[e];
		(!r || m[r.type] && o) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${e}' as it is not declared in the original translation`), r = u(l, {})), Array.isArray(r) && (r = u(l, { children: r })), a.push(t(r, { key: i() }, o ? h(o, n) : r.props.children)), s && a.push(s);
	}
...
var w = ({ i18n: e, defaultComponent: t, children: n }) => {
