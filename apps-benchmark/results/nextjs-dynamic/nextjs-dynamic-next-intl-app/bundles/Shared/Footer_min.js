...
var C = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, w = /^(@+)?(\+|#+)?[rs]?$/g, pe = /(\*)(0+)|(#+)(0+)|(0+)/g, T = /^(0+)$/;
function E(e) {
	let t = {};
...
var Te = !!Object.fromEntries, Ee = !!String.prototype.trimStart, De = !!String.prototype.trimEnd, V = Te ? Object.fromEntries : function(e) {
	let t = {};
...
function qe(e) {
	...
	return function({ cache: e, formats: n, formatters: i, getMessageFallback: a = Ge, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, h, g) {
			...
			try {
				return We(Z(c, p), v, m && function(e) {
					let n = {};
			...
			children: [u("div", {
				...
				children: [
					...
					u("div", { children: [l("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => l("li", { children: e.isInternal ? l(f, {
							href: e.href,
