...
var $ = n(void 0);
function Ye({ children: e, formats: t, getMessageFallback: n, locale: r, messages: a, now: o, onError: c, timeZone: u }) {
	let d = i($), f = s((() => d?.cache || ie()), [r, d?.cache]), p = s((() => d?.formatters || oe(f)), [f, d?.formatters]), m = s((() => ({
		...Je({
			locale: r,
...
function st({ children: t, locale: n, messages: r }) {
	return a(() => {
