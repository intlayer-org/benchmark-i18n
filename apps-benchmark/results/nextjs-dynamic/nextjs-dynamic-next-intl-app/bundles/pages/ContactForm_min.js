	...
	return l("form", {
		...
		children: [
			...
			l("div", { children: [c("label", {
				...
				children: [
					c("option", { children: e("contact.contact-form.bugReport") }),
					c("option", { children: e("contact.contact-form.newBenchmarkIdea") }),
					c("option", { children: e("contact.contact-form.methodologyQuestion") }),
					c("option", { children: e("contact-header.getInTouch") })
				]
			})] }),
			l("div", { children: [c("label", {
				htmlFor: i,
