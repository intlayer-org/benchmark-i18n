		...
		children: [c("h2", {
			...
			children: [
				...
				l("div", { children: [c("label", {
					...
					children: [
						c("option", { children: e("settings.preferences-section.englishEn") }),
						c("option", { children: e("settings.preferences-section.frenchFr") }),
						c("option", { children: e("settings.preferences-section.germanDe") }),
						c("option", { children: e("settings.preferences-section.spanishEs") }),
						c("option", { children: e("settings.preferences-section.japaneseJa") }),
						c("option", { children: e("settings.preferences-section.chineseSimplifiedZhCn") }),
						c("option", { children: e("settings.preferences-section.arabicAr") })
					]
				})] })
			]
		})]
