...
}), h = (e) => /^https?:\/\//.test(e ?? ""), g = ({ href: e, children: t, ...n }) => {
	let r = l().locale ?? "en", i = h(e.toString());
	return d(u, {
...
var L = (e) => !_(e) && typeof e != "boolean" && typeof e != "number", R = class e extends P {
	constructor(e, t = {}) {
		super(), b([
			"resourceStore",
			"languageUtils",
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return _(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? I(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			E(n.loaded, [i], a), ye(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), H = (e) => (_(e.ns) && (e.ns = [e.ns]), _(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), _(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), U = () => {}, xe = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, W = class e extends P {
	constructor(e = {}, t) {
		if (super(), this.options = H(e), this.services = {}, this.logger = N, this.modules = { external: [] }, xe(this), t && !this.isInitialized && !e.isClone) {
...
var Se = (e, t, n, r) => {
	...
	Y(n) && G[n] || (Y(n) && (G[n] = /* @__PURE__ */ new Date()), Se(e, t, n, r));
}, q = (e, t) => () => {
...
}, we = (e, t, n = {}) => !t.languages || !t.languages.length ? (K(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Y = (e) => typeof e == "string", Te = (e) => typeof e == "object" && !!e, Ee = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, De = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (Y(t)) return t;
		if (Te(t) && Y(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: n } = t, { i18n: l, defaultNS: u } = i(Fe) || {}, d = n || l || Ne();
	d && !d.reportNamespaces && (d.reportNamespaces = new Ie()), d || K(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = o(() => ({
		...Ae(),
		...d?.options?.react,
		...t
	...
	if (d && p && !T) throw new Promise((e) => {
		let n = () => e();
		t.lng ? Ce(d, t.lng, _, n) : J(d, _, n);
	});
	return A;
};
function Ue({ i18n: e, defaultNS: t, children: r }) {
	let i = o(() => ({
		i18n: e,
		defaultNS: t
	}), [e, t]);
	return n(Fe.Provider, { value: i }, r);
}
function We() {
	let { t: e } = He("shared"), t = [
		{
...
async function Xe(e, t = Q) {
	...
	for (let e of t) {
		...
		let r = await Ye(n, e);
		W.addResourceBundle(n, e, r, !0, !0), Je.add(t);
	}
}
W.use(Pe).init({
	resources: {},
