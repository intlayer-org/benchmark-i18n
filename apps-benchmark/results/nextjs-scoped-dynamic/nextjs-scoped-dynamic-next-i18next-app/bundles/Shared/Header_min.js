...
var _ = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), v = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	if (typeof require < "u") return require.apply(this, arguments);
	throw Error("Calling `require` for \"" + e + "\" in an environment that doesn't expose the `require` function. See https://rolldown.rs/in-depth/bundling-cjs#require-external-modules for more details.");
}), y = (e) => /^https?:\/\//.test(e ?? ""), b = ({ href: e, children: t, ...n }) => {
	let r = u().locale ?? "en", i = y(e.toString());
	return m(p, {
...
var V = (e) => !x(e) && typeof e != "boolean" && typeof e != "number", ue = class e extends L {
	constructor(e, t = {}) {
		super(), w([
			"resourceStore",
			"languageUtils",
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			A(n.loaded, [i], a), xe(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), W = (e) => (x(e.ns) && (e.ns = [e.ns]), x(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), x(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), G = () => {}, Ce = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, K = class e extends L {
	constructor(e = {}, t) {
		if (super(), this.options = W(e), this.services = {}, this.logger = I, this.modules = { external: [] }, Ce(this), t && !this.isInitialized && !e.isClone) {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new de(U());
...
var we = (e, t, n, r) => {
	...
	Y(n) && Te[n] || (Y(n) && (Te[n] = /* @__PURE__ */ new Date()), we(e, t, n, r));
}, Ee = (e, t) => () => {
...
}, Oe = (e, t, n = {}) => !t.languages || !t.languages.length ? (q(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Y = (e) => typeof e == "string", ke = (e) => typeof e == "object" && !!e, Ae = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, je = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	process.env.NODE_ENV !== "production" && (function() {
		...
		var a = v("react"), o = typeof Object.is == "function" ? Object.is : t, s = a.useState, c = a.useEffect, l = a.useLayoutEffect, u = a.useDebugValue, d = !1, f = !1, p = typeof window > "u" || window.document === void 0 || window.document.createElement === void 0 ? i : n;
	...
	t: (e, t) => {
		if (Y(t)) return t;
		if (ke(t) && Y(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: n } = t, { i18n: o, defaultNS: u } = i(ze) || {}, d = n || o || Le();
	d && !d.reportNamespaces && (d.reportNamespaces = new Be()), d || q(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = s(() => ({
		...Pe(),
		...d?.options?.react,
		...t
	}), [d, t]), { useSuspense: p, keyPrefix: m } = f, h = e || u || d?.options?.defaultNS, g = Y(h) ? [h] : h || ["translation"], _ = s(() => g, g);
	...
	let v = c(0), y = r((e) => {
		...
		f,
		t.lng
	]), [S, C] = l(0), { t: w, ready: T } = (0, Ue.useSyncExternalStore)(y, x, x);
	a(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
			t.lng ? De(d, t.lng, _, e) : J(d, _, e);
		}
	}, [
		d,
		t.lng,
	...
	if (d && p && !T) throw new Promise((e) => {
		let n = () => e();
		t.lng ? De(d, t.lng, _, n) : J(d, _, n);
	});
	return A;
};
function qe({ i18n: e, defaultNS: t, children: r }) {
	let i = s(() => ({
		i18n: e,
		defaultNS: t
	}), [e, t]);
	return n(ze.Provider, { value: i }, r);
}
function Je() {
...
function et() {
	let { t: e } = Ke("shared");
	$e("Header");
	let [t, n] = l(!1), r = u().locale ?? "en", i = d(), a = [
		{
			href: "/products",
					...
					children: [
						...
						h("div", {
							...
							children: [h("button", {
								...
								onMouseLeave: () => n(!1),
								onClick: () => n(!t),
								children: [e("header.mockPages"), m(g, {
									size: 14,
...
async function ot(e, t) {
	...
	try {
		...
		return n === "en" ? {} : (await rt(Object.assign({
			"./locales/de/about.json": () => import("../i18n/locales/de/about.json"),
			"./locales/de/blog.json": () => import("../i18n/locales/de/blog.json"),
			"./locales/de/careers.json": () => import("../i18n/locales/de/careers.json"),
			"./locales/de/contact.json": () => import("../i18n/locales/de/contact.json"),
...
async function st(e, t = Q) {
	let n = e || "en";
	for (let e of t) {
		let t = `${n}:${e}`;
		if (at.has(t)) continue;
		let r = await ot(n, e);
		K.addResourceBundle(n, e, r, !0, !0), at.add(t);
	}
}
K.use(Re).init({
	resources: {},
...
function ct({ children: t }) {
	...
	return a(() => {
		let e = !1;
		return (async () => {
			await st(n, Q), !e && $.language !== n && await $.changeLanguage(n);
		})(), () => {
			e = !0;
		};
	}, [n]), a(() => {
...
function lt({ children: e }) {
	return m(ct, { children: e });
}
function ut() {
	return m(lt, { children: m(et, {}) });
}
