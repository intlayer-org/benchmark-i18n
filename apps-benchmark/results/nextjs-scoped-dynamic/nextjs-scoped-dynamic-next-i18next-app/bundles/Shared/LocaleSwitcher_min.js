...
var f = (e) => typeof e == "string", p = () => {
	...
	getResource(e, t, n, r = {}) {
		...
		let s = S(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !f(n) ? s : k(this.data?.[e]?.[t], n, i);
	}
...
function I(e, t) {
	let { [F]: n } = e(ie()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var L = (e) => !f(e) && typeof e != "boolean" && typeof e != "number", R = class e extends M {
	constructor(e, t = {}) {
		super(), h([
			"resourceStore",
			"languageUtils",
	...
	translate(t, n, r) {
		...
		b && !h && S && (D = E);
		let O = L(D), ee = Object.prototype.toString.apply(D);
		if (b && D && O && !v.includes(ee) && !(f(y) && Array.isArray(D))) {
	...
	let a = C(e, t, n);
	return !a && i && f(n) && (a = k(e, n, r), a === void 0 && (a = k(t, n, r))), a;
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			x(n.loaded, [i], a), le(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), q = (e) => (f(e.ns) && (e.ns = [e.ns]), f(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), f(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), J = () => {}, de = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Y = class e extends M {
	constructor(e = {}, t) {
		if (super(), this.options = q(e), this.services = {}, this.logger = j, this.modules = { external: [] }, de(this), t && !this.isInitialized && !e.isClone) {
...
function ve({ i18n: e, defaultNS: t, children: r }) {
	...
	return n(_e.Provider, { value: a }, r);
}
function ye() {
	if (!(typeof window > "u")) {
...
async function we(e, t = Q) {
	let n = e || "en";
	for (let e of t) {
		let t = `${n}:${e}`;
		if (Se.has(t)) continue;
		let r = await Ce(n, e);
		Y.addResourceBundle(n, e, r, !0, !0), Se.add(t);
	}
}
Y.use(ge).init({
	resources: {},
...
function Te({ children: t }) {
	...
	return r(() => {
		let e = !1;
		return (async () => {
			await we(n, Q), !e && $.language !== n && await $.changeLanguage(n);
		})(), () => {
			e = !0;
		};
	}, [n]), r(() => {
...
function Ee({ children: e }) {
	return c(Te, { children: e });
}
function De() {
	return c(Ee, { children: c(d, {}) });
}
