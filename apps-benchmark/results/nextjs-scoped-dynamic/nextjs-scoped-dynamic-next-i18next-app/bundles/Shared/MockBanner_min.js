...
var R = (e) => !p(e) && typeof e != "boolean" && typeof e != "number", z = class e extends P {
	constructor(e, t = {}) {
		super(), g([
			"resourceStore",
			"languageUtils",
	...
	init(e, t = { interpolation: {} }) {
		...
		let n = t.cacheInBuiltFormats ? fe : pe;
		this.formats = {
			number: n((e, t) => {
...
var ve = (e, t, n, r) => {
	...
	Y(n) && G[n] || (Y(n) && (G[n] = /* @__PURE__ */ new Date()), ve(e, t, n, r));
}, q = (e, t) => () => {
...
}, be = (e, t, n = {}) => !t.languages || !t.languages.length ? (K(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Y = (e) => typeof e == "string", xe = (e) => typeof e == "object" && !!e, Se = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Ce = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (Y(t)) return t;
		if (xe(t) && Y(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: n } = t, { i18n: l, defaultNS: u } = i(je) || {}, d = n || l || ke();
	d && !d.reportNamespaces && (d.reportNamespaces = new Me()), d || K(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = o(() => ({
		...Ee(),
		...d?.options?.react,
		...t
	...
	if (d && p && !T) throw new Promise((e) => {
		let n = () => e();
		t.lng ? ye(d, t.lng, _, n) : J(d, _, n);
	});
	return A;
};
function ze({ i18n: e, defaultNS: t, children: r }) {
	let i = o(() => ({
		i18n: e,
		defaultNS: t
	}), [e, t]);
	return n(je.Provider, { value: i }, r);
}
var Be = () => {
	let { t: e } = Re("shared");
	return l("div", {
...
async function Ke(e, t = Q) {
	let n = e || "en";
	for (let e of t) {
		let t = `${n}:${e}`;
		if (We.has(t)) continue;
		let r = await Ge(n, e);
		W.addResourceBundle(n, e, r, !0, !0), We.add(t);
	}
}
W.use(Ae).init({
	resources: {},
...
function qe({ children: t }) {
	...
	return a(() => {
		let e = !1;
		return (async () => {
			await Ke(n, Q), !e && $.language !== n && await $.changeLanguage(n);
		})(), () => {
			e = !0;
		};
	}, [n]), a(() => {
