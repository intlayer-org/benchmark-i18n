...
var I = (e) => !p(e) && typeof e != "boolean" && typeof e != "number", L = class e extends N {
	constructor(e, t = {}) {
		super(), g([
			"resourceStore",
			"languageUtils",
...
}), _e = (e) => (p(e.ns) && (e.ns = [e.ns]), p(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), p(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), H = () => {}, ve = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, U = class e extends N {
	constructor(e = {}, t) {
		if (super(), this.options = _e(e), this.services = {}, this.logger = M, this.modules = { external: [] }, ve(this), t && !this.isInitialized && !e.isClone) {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new R(V());
...
var ye = (e, t, n, r) => {
	...
	J(n) && W[n] || (J(n) && (W[n] = /* @__PURE__ */ new Date()), ye(e, t, n, r));
}, K = (e, t) => () => {
	...
	e.loadNamespaces(t, K(e, n));
}, be = (e, t, n, r) => {
	if (J(n) && (n = [n]), e.options.preload && e.options.preload.indexOf(t) > -1) return q(e, n, r);
	n.forEach((t) => {
		e.options.ns.indexOf(t) < 0 && e.options.ns.push(t);
	}), e.loadLanguages(t, K(e, r));
}, xe = (e, t, n = {}) => !t.languages || !t.languages.length ? (G(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), J = (e) => typeof e == "string", Se = (e) => typeof e == "object" && !!e, Ce = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, we = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (J(t)) return t;
		if (Se(t) && J(t.defaultValue)) return t.defaultValue;
	...
	d && !d.reportNamespaces && (d.reportNamespaces = new Ne()), d || G(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = o(() => ({
		...De(),
		...d?.options?.react,
		...t
	...
	let E = d || {}, D = s(null), O = s(), k = (e) => {
		...
		let r = !T && !p ? (...e) => (G(d, "USE_T_BEFORE_READY", "useTranslation: t was called before ready. When using useSuspense: false, make sure to check the ready flag before using t."), w(...e)) : w, i = [
			r,
			n,
			T
		];
...
async function Je(e, t = Q) {
	...
	for (let e of t) {
		...
		let r = await qe(n, e);
		U.addResourceBundle(n, e, r, !0, !0), Ke.add(t);
	}
}
U.use(je).init({
	resources: {},
