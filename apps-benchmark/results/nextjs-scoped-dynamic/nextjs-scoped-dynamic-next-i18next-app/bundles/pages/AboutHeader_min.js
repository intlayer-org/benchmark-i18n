...
var I = (e) => !g(e) && typeof e != "boolean" && typeof e != "number", ue = class e extends P {
	...
	toResolveHierarchy(e, t) {
		...
		return g(e) && (e.includes("-") || e.includes("_")) ? (this.options.load !== "languageOnly" && i(this.formatLanguageCode(e)), this.options.load !== "languageOnly" && this.options.load !== "currentOnly" && i(this.getScriptPartFromCode(e)), this.options.load !== "currentOnly" && i(this.getLanguagePartFromCode(e))) : g(e) && i(this.formatLanguageCode(e)), n.forEach((e) => {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? ee : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? k(i) : a || "{{", this.suffix = o ? k(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? k(d) : f || k("$t("), this.nestingSuffix = p ? k(p) : m || k(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
...
}), G = (e) => (g(e.ns) && (e.ns = [e.ns]), g(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), g(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), K = () => {}, _e = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, q = class e extends P {
	constructor(e = {}, t) {
		if (super(), this.options = G(e), this.services = {}, this.logger = N, this.modules = { external: [] }, _e(this), t && !this.isInitialized && !e.isClone) {
...
var ve = (e, t, n, r) => {
	...
	X(n) && ye[n] || (X(n) && (ye[n] = /* @__PURE__ */ new Date()), ve(e, t, n, r));
}, be = (e, t) => () => {
...
}, Se = (e, t, n = {}) => !t.languages || !t.languages.length ? (J(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), X = (e) => typeof e == "string", Ce = (e) => typeof e == "object" && !!e, we = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Te = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (X(t)) return t;
		if (Ce(t) && X(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: n } = t, { i18n: o, defaultNS: u } = i(Ne) || {}, d = n || o || je();
	d && !d.reportNamespaces && (d.reportNamespaces = new Pe()), d || J(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = s(() => ({
		...Oe(),
		...d?.options?.react,
		...t
	...
	let v = c(0), y = r((e) => {
		...
		f,
		t.lng
	]), [S, C] = l(0), { t: w, ready: T } = (0, Le.useSyncExternalStore)(y, x, x);
	a(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
			t.lng ? xe(d, t.lng, _, e) : Y(d, _, e);
		}
	}, [
		d,
		t.lng,
	...
	if (d && p && !T) throw new Promise((e) => {
		let n = () => e();
		t.lng ? xe(d, t.lng, _, n) : Y(d, _, n);
	});
	return A;
};
function Ve({ i18n: e, defaultNS: t, children: r }) {
	let i = s(() => ({
		i18n: e,
		defaultNS: t
	}), [e, t]);
...
function Ue() {
	let { t: e } = Be("about");
	return He("AboutHeader"), f(u, { children: [d("h1", {
...
var Ke = (e, t, n) => {
	...
	"shared",
	"team"
], qe = "shared", Je = /* @__PURE__ */ new Set();
async function Ye(e, t) {
	let n = e || "en";
	try {
		return (await Ke(Object.assign({
		...
		return n === "en" ? {} : (await Ke(Object.assign({
			"./locales/de/about.json": () => import("../../../i18n/locales/de/about.json"),
			"./locales/de/blog.json": () => import("../../../i18n/locales/de/blog.json"),
			"./locales/de/careers.json": () => import("../../../i18n/locales/de/careers.json"),
			"./locales/de/contact.json": () => import("../../../i18n/locales/de/contact.json"),
...
async function Xe(e, t = Q) {
	let n = e || "en";
	for (let e of t) {
		let t = `${n}:${e}`;
		if (Je.has(t)) continue;
		let r = await Ye(n, e);
		q.addResourceBundle(n, e, r, !0, !0), Je.add(t);
	}
}
q.use(Me).init({
	resources: {},
...
function Ze({ children: t }) {
	...
	return a(() => {
		let e = !1;
		return (async () => {
			await Xe(n, Q), !e && $.language !== n && await $.changeLanguage(n);
		})(), () => {
			e = !0;
		};
	}, [n]), a(() => {
