import { Profiler as e, createContext as t, createElement as n, useCallback as r, useContext as i, useEffect as a, useLayoutEffect as o, useMemo as s, useRef as c, useState as l } from "react";
...
function He() {
	let { t: e } = ze(["home", "shared"]);
	return Ve("Hero"), d("section", {
...
async function Ye(e, t = Q) {
	...
	for (let e of t) {
		...
		let r = await Je(n, e);
		W.addResourceBundle(n, e, r, !0, !0), qe.add(t);
	}
}
W.use(je).init({
	resources: {},
