import { Profiler as e, createContext as t, createElement as n, useCallback as r, useContext as i, useEffect as a, useId as o, useMemo as s, useRef as c, useState as l } from "react";
...
function L(e, t) {
	let { [I]: n } = e(oe()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var R = (e) => !h(e) && typeof e != "boolean" && typeof e != "number", z = class e extends P {
	constructor(e, t = {}) {
		super(), v([
			"resourceStore",
			"languageUtils",
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? A : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? O(i) : a || "{{", this.suffix = o ? O(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? O(d) : f || O("$t("), this.nestingSuffix = p ? O(p) : m || O(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		let i, a, o, s = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (e) => {
			if (!e.includes(this.formatSeparator)) {
				let i = de(t, s, e, this.options.keySeparator, this.options.ignoreJSONStructure);
			...
			return this.format(de(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
				...r,
				...t,
				interpolationkey: a
			});
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			w(n.loaded, [i], a), _e(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), H = (e) => (h(e.ns) && (e.ns = [e.ns]), h(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), h(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), U = () => {}, ye = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, W = class e extends P {
	constructor(e = {}, t) {
		if (super(), this.options = H(e), this.services = {}, this.logger = N, this.modules = { external: [] }, ye(this), t && !this.isInitialized && !e.isClone) {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new se(V());
	...
	cloneInstance(t = {}, n = U) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a.services.interpolator = new fe(n);
		}
...
var be = (e, t, n, r) => {
	...
	X(n) && G[n] || (X(n) && (G[n] = /* @__PURE__ */ new Date()), be(e, t, n, r));
}, q = (e, t) => () => {
...
}, xe = (e, t, n = {}) => !t.languages || !t.languages.length ? (K(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), X = (e) => typeof e == "string", Se = (e) => typeof e == "object" && !!e, Ce = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, we = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (X(t)) return t;
		if (Se(t) && X(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: n } = t, { i18n: o, defaultNS: u } = i(Me) || {}, d = n || o || Ae();
	d && !d.reportNamespaces && (d.reportNamespaces = new Ne()), d || K(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = s(() => ({
		...De(),
		...d?.options?.react,
		...t
	...
	let v = c(0), y = r((e) => {
		...
		f,
		t.lng
	]), [S, C] = l(0), { t: w, ready: T } = (0, Ie.useSyncExternalStore)(y, x, x);
	a(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
...
var We = (e, t, n) => {
	...
	"shared",
	"team"
], Ge = "shared", Ke = /* @__PURE__ */ new Set();
async function qe(e, t) {
	let n = e || "en";
	try {
		return (await We(Object.assign({
		...
		return n === "en" ? {} : (await We(Object.assign({
			"./locales/de/about.json": () => import("../../../i18n/locales/de/about.json"),
			"./locales/de/blog.json": () => import("../../../i18n/locales/de/blog.json"),
			"./locales/de/careers.json": () => import("../../../i18n/locales/de/careers.json"),
			"./locales/de/contact.json": () => import("../../../i18n/locales/de/contact.json"),
...
async function Je(e, t = Q) {
	let n = e || "en";
	for (let e of t) {
		let t = `${n}:${e}`;
		if (Ke.has(t)) continue;
		let r = await qe(n, e);
		W.addResourceBundle(n, e, r, !0, !0), Ke.add(t);
	}
}
W.use(je).init({
	resources: {},
...
function Ye({ children: t }) {
	...
	return a(() => {
		let e = !1;
		return (async () => {
			await Je(n, Q), !e && $.language !== n && await $.changeLanguage(n);
		})(), () => {
			e = !0;
		};
	}, [n]), a(() => {
