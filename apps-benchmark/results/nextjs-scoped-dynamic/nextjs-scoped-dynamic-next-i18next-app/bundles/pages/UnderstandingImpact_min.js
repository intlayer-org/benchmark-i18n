			...
			u("div", {
				...
				children: [
					...
					u("ul", {
						...
						children: [
							l("li", { children: e("understandingImpact.theJsonMustBeParsed") }),
							l("li", { children: e("understandingImpact.contextBasedArchitecturesCanCause") }),
							l("li", { children: e("understandingImpact.duringServerSideRenderingThe") })
						]
					})
				]
			}),
