...
var Ee = !!Object.fromEntries, De = !!String.prototype.trimStart, Oe = !!String.prototype.trimEnd, B = Ee ? Object.fromEntries : function(e) {
	let t = {};
...
var Me = class {
	...
	parseTag(e, t) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !H(this.char())) return this.error(L.INVALID_TAG, z(o, this.clonePosition()));
				let e = this.clonePosition();
...
function U(e) {
	e.forEach((e) => {
		if (delete e.location, ye(e) || N(e)) for (let t in e.options) delete e.options[t].location, U(e.options[t].value);
		else j(e) && F(e.style) || (M(e) || ve(e)) && I(e.style) ? delete e.style.location : P(e) && U(e.children);
	});
}
function Ie(e, t = {}) {
	t = {
...
var _t = "en";
async function vt({ children: e }) {
	return l(ct, {
		locale: _t,
		messages: await gt(_t),
		children: e
	});
}
//#endregion
