...
var A = 86400;
7 * A, 365 * A;
function j({ formats: e, getMessageFallback: t, messages: n, onError: r, ...i }) {
	return {
		...i,
		formats: e || void 0,
		messages: n || void 0,
...
async function B(e, t) {
	return (await (z[e]?.[t] ?? z.en[t])()).default;
}
function V(e) {
	let t = {};
...
function H(e, t) {
	...
	for (let [e, r] of Object.entries(t)) {
		let t = n[e];
		typeof r == "object" && r && !Array.isArray(r) && typeof t == "object" && t && !Array.isArray(t) ? n[e] = H(t, r) : n[e] = r;
	}
	return n;
}
function U(e) {
	return e.reduce((e, t) => H(e, t), {});
}
