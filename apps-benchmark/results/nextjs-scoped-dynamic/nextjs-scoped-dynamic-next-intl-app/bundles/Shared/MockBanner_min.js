...
var w = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, se = /^(@+)?(\+|#+)?[rs]?$/g, ce = /(\*)(0+)|(#+)(0+)|(0+)/g, le = /^(0+)$/;
function ue(e) {
	let t = {};
...
function He(e) {
	...
	return function({ cache: e, formats: n, formatters: i, getMessageFallback: a = Be, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, h, g) {
			...
			try {
				return ze(Z(c, p), v, m && function(e) {
					let n = {};
...
function Ke({ children: e, formats: t, getMessageFallback: n, locale: r, messages: a, now: c, onError: l, timeZone: u }) {
	let d = i($), f = o((() => d?.cache || ee()), [r, d?.cache]), p = o((() => d?.formatters || te(f)), [f, d?.formatters]), m = o((() => ({
		...Ge({
			locale: r,
...
function Xe(e) {
	return function(e, t, n) {
		...
		return u || Je || !Ye || (Je = !0, l(new b(x.ENVIRONMENT_FALLBACK, void 0))), o((() => He({
			cache: r,
			formatters: a,
...
var et = () => s("div", {
	...
	children: Qe()("mock-banner.mockBanner")
});
//#endregion
...
async function ot(e, t) {
	return (await (at[e]?.[t] ?? at.en[t])()).default;
}
function st(e) {
	let t = {};
...
function ct(e, t) {
	...
	for (let [e, r] of Object.entries(t)) {
		let t = n[e];
		typeof r == "object" && r && !Array.isArray(r) && typeof t == "object" && t && !Array.isArray(t) ? n[e] = ct(t, r) : n[e] = r;
	}
	return n;
}
function lt(e) {
