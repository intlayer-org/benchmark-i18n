...
var S = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, C = /^(@+)?(\+|#+)?[rs]?$/g, ue = /(\*)(0+)|(#+)(0+)|(0+)/g, w = /^(0+)$/;
function T(e) {
	let t = {};
...
function U(e) {
	e.forEach((e) => {
		...
		else A(e) && _e(e.style) || (j(e) || he(e)) && F(e.style) ? delete e.style.location : P(e) && U(e.children);
	});
}
function Me(e, t = {}) {
	t = {
...
function Ue(e) {
	...
	return function({ cache: e, formats: n, formatters: i, getMessageFallback: a = Ve, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, ee, h) {
			...
			try {
				return Be(Z(c, p), _, m && function(e) {
					let n = {};
...
function Ke({ formats: e, getMessageFallback: t, messages: n, onError: r, ...i }) {
	return {
		...
		messages: n || void 0,
		onError: r || He,
		getMessageFallback: t || Ve
	};
}
//#endregion
//#region ../../../node_modules/.bun/use-intl@4.9.1+b1ab299f0a400331/node_modules/use-intl/dist/esm/production/react.js
var $ = n(void 0);
function qe({ children: e, formats: t, getMessageFallback: n, locale: r, messages: a, now: c, onError: l, timeZone: u }) {
	let d = i($), f = o((() => d?.cache || ne()), [r, d?.cache]), p = o((() => d?.formatters || ie(f)), [f, d?.formatters]), m = o((() => ({
		...Ke({
			locale: r,
...
function Ze(e) {
	return function(e, t, n) {
		let { cache: r, formats: i, formatters: a, getMessageFallback: s, locale: c, onError: l, timeZone: u } = Je(), d = e[n], f = We(t, n);
		return u || Ye || !Xe || (Ye = !0, l(new y(b.ENVIRONMENT_FALLBACK, void 0))), o((() => Ue({
			cache: r,
			formatters: a,
...
function tt() {
	...
	return s("div", {
		...
		children: [
			{
				title: e("blog-list.comparingI18nLibrariesIn2026"),
...
function it({ children: t, locale: n, messages: r }) {
	return a(() => {
...
async function st(e, t) {
	return (await (ot[e]?.[t] ?? ot.en[t])()).default;
}
function ct(e) {
	let t = {};
...
function lt(e, t) {
	...
	for (let [e, r] of Object.entries(t)) {
		let t = n[e];
		typeof r == "object" && r && !Array.isArray(r) && typeof t == "object" && t && !Array.isArray(t) ? n[e] = lt(t, r) : n[e] = r;
	}
	return n;
}
function ut(e) {
	return e.reduce((e, t) => lt(e, t), {});
}
