...
function nt() {
	let e = et(), t = [{
		title: e("open-positions.seniorFrontendEngineer"),
		location: e("open-positions.remote"),
		type: e("open-positions.fullTime"),
	...
	return l(s, { children: [c("h2", {
		...
		children: e("open-positions.openPositions")
	}), c("div", {
		className: "space-y-4",
		children: t.map((t) => l("div", {
			...
			children: [l("div", { children: [
				...
				children: e("open-positions.applyNow")
			})]
		}, t.title))
	})] });
}
