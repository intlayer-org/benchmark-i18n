...
var $ = n(void 0);
function Je({ children: e, formats: t, getMessageFallback: n, locale: r, messages: a, now: o, onError: l, timeZone: u }) {
	let d = i($), f = s((() => d?.cache || re()), [r, d?.cache]), p = s((() => d?.formatters || ae(f)), [f, d?.formatters]), m = s((() => ({
		...qe({
			locale: r,
		...
		children: [c("h2", {
			...
			children: [
				...
				l("div", { children: [c("label", {
					...
					children: [
						c("option", { children: e("preferences-section.englishEn") }),
						c("option", { children: e("preferences-section.frenchFr") }),
						c("option", { children: e("preferences-section.germanDe") }),
						c("option", { children: e("preferences-section.spanishEs") }),
						c("option", { children: e("preferences-section.japaneseJa") }),
						c("option", { children: e("preferences-section.chineseSimplifiedZhCn") }),
						c("option", { children: e("preferences-section.arabicAr") })
					]
				})] })
			]
		})]
...
function at({ children: t, locale: n, messages: r }) {
	return a(() => {
...
function ut(e, t) {
	...
	for (let [e, r] of Object.entries(t)) {
		let t = n[e];
		typeof r == "object" && r && !Array.isArray(r) && typeof t == "object" && t && !Array.isArray(t) ? n[e] = ut(t, r) : n[e] = r;
	}
	return n;
}
function dt(e) {
