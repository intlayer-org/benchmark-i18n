...
var Q = n(void 0);
function Ye({ children: e, formats: t, getMessageFallback: n, locale: r, messages: a, now: s, onError: l, timeZone: u }) {
	let d = i(Q), f = o((() => d?.cache || ie()), [r, d?.cache]), p = o((() => d?.formatters || oe(f)), [f, d?.formatters]), m = o((() => ({
		...Je({
			locale: r,
...
var nt = () => c("div", {
	...
	children: $()("mock-banner.mockBanner")
});
//#endregion
//#region components/pages/products/ProductsHeader.tsx
function rt() {
	let e = $(), t = $("products-header");
	return l(s, { children: [
		c(nt, {}),
		c("h1", {
...
function dt(e, t) {
	...
	for (let [e, r] of Object.entries(t)) {
		let t = n[e];
		typeof r == "object" && r && !Array.isArray(r) && typeof t == "object" && t && !Array.isArray(t) ? n[e] = dt(t, r) : n[e] = r;
	}
	return n;
}
function ft(e) {
	return e.reduce((e, t) => dt(e, t), {});
}
...
async function gt({ children: e }) {
	return c(ot, {
		locale: ht,
		messages: await mt(ht),
		children: e
	});
}
//#endregion
//#region components/pages/products/ProductsHeader.wrapper.tsx
function _t() {
	return c(gt, { children: c(rt, {}) });
}
//#endregion
