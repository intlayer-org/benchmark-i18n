...
function b(e) {
	var t = globalThis.__NEXT_TRANSLATE__ ?? {}, n = t.lang, r = t.namespaces, a = t.config, o = a.localesToIgnore || ["default"], c = !n || o.includes(n), l = function() {
		return s(m({
			config: a,
			allNamespaces: r,
...
function D({ children: e, locale: n }) {
	return r(() => {
