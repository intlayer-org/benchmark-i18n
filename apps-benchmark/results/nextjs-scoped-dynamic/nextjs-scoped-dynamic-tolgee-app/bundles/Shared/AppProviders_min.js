...
var c = Object.defineProperty, l = Object.getOwnPropertySymbols, u = Object.prototype.hasOwnProperty, d = Object.prototype.propertyIsEnumerable, f = (e, t, n) => t in e ? c(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
	...
	if (l) for (var n of l(t)) d.call(t, n) && f(e, n, t[n]);
	return e;
}, m;
function h(e, t) {
...
function _(e, t) {
	return g(e) ? Promise.resolve(e).then(t) : t(e);
}
function v(e, t, n) {
	function r(n) {
		let r = t(n);
...
}, M = (e) => Object.fromEntries(j(e).entries()), N = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
	};
}, P = ({ language: e, namespace: t }) => t ? `${e}:${t}` : e;
...
function R(e, t) {
	...
	return n.apiUrl = T(n.apiUrl), e?.fetch && (n.fetch = k(e.fetch)), {
		initialOptions: n,
...
function ce(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return v(s.onError, (e) => new ie("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return v(s.onError, (e) => new re("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function D(e) {
		e && l.backends.push(e);
	}
	...
	let A = Object.freeze({
		...
		getInitialLanguage() {
			let e = n();
			return _(w(), (t) => (!e || e.includes(t)) && t ? t : T());
		},
		setStoredLanguage(e) {
			return v(s.onError, (e) => new ie("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = F(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = E(e) || I, r = t().onFormatError, a = typeof r;
	...
	let r = R(), i, a = Object.freeze({
		...
		getRequiredNamespaces() {
			return w([
				a.getDefaultNs(),
				...r.initialOptions.ns || [],
				...S(r.initialOptions.fallbackNs),
				...r.activeNamespaces.keys()
			]);
		},
		getFallbackLangs(e) {
			let t = e || a.getLanguage();
			return t ? w([t, ...C(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
			return S(r.initialOptions.fallbackNs);
		},
		getNs() {
		...
		overrideCredentials(e) {
			i = e ? Object.assign(Object.assign({}, e), { apiUrl: T(e.apiUrl) }) : void 0;
		}
	});
	return a;
}
...
var B = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, ue(r)), n)), n;
};
function de({ options: e }) {
	let t = te(), n = z(!1, () => o.isFetching(), t.onFetchingChange.emit), r = z(!1, () => D.isLoading(), t.onLoadingChange.emit), i = le(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ce(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, b, x, f, t), o = ae(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
	...
	function d(e) {
		return w([...S(e ?? l()), ...i.getRequiredNamespaces()]);
	}
	function f(e, t, n) {
	...
	function C() {
		...
		if (g(e)) return i.setInitialLoading(!0), n.notify(), r.notify(), Promise.resolve(e).then(() => {
			i.setInitialLoading(!1), n.notify(), r.notify(), t.onInitialLoaded.emit();
		});
		t.onInitialLoaded.emit();
	}
	function T() {
		if (!i.getLanguage()) return _(a.getInitialLanguage(), (e) => {
			let t = e || i.getInitialOptions().defaultLanguage;
			t && i.setLanguage(t);
		});
	}
	function E() {
		if ((a.getLanguageDetector() || a.getLanguageStorage()) && !i.getAvailableLanguages()) throw Error(y("availableLanguages"));
		if (!i.getLanguage() && !i.getInitialOptions().defaultLanguage) throw Error(y(["defaultLanguage", "language"]));
	}
	let D = Object.freeze(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, t), i), a), o), {
		...
		run() {
			return E(), i.isRunning() || (i.setRunning(!0), a.run(), s = C()), Promise.resolve(s);
		},
		stop() {
...
var pe = () => {
	let e = {
		...
		init(t) {
			let n = fe(L(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, V = 0, H = 1, me = 2, he = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var W = 0, G = 1, K = 2, q = 3, J = 4, ge = new Set([
	K,
	G,
	W
]), Y = "'", _e = new Set([
...
function ye(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case W:
			...
			break;
		case G:
			_e.has(i) ? (n = n.slice(0, -1) + i, t = K) : (n += i, t = W);
			break;
		case K:
			i === Y ? t = W : (n += i, t = K);
			break;
...
var Se = () => (e, t) => (t.setFinalFormatter(xe()), e), Ce = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, X = {};
(function(e) {
	function t(e, t) {
		var n;
...
(m = console.assert) == null || m.call(console, we), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Te(e, t) {
	let n = (n) => {
...
var Z = null;
function Ne(e) {
	return Z ||= Me(`${je}/@tolgee/web@${e}/dist/${Oe}`).then(() => window[ke][Ae]), Z;
}
var Pe = "__tolgee_apiKey", Fe = "__tolgee_apiUrl", Ie = "__tolgee_branch";
function Le() {
	let e = sessionStorage.getItem(Pe) || void 0, t = sessionStorage.getItem(Fe) || void 0, n = sessionStorage.getItem(Ie) || void 0;
	if (!(!e || !t)) return p({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Re() {
	sessionStorage.removeItem(Pe), sessionStorage.removeItem(Fe), sessionStorage.removeItem(Ie);
}
function ze(e) {
...
var Ge = { useSuspense: !1 }, Ke, qe = () => (Ke ||= e.createContext(void 0), Ke), Q = void 0, Je = ({ tolgee: t, options: i, children: o, fallback: s, ssr: c }) => {
	r(() => {
		Q?.run !== t.run && (Q && Q.stop(), Q = t, t.run().catch((e) => {
			console.error(e);
		}).finally(() => {
			p(!1);
		}));
	...
	l = We(t, u, d, !!c);
	let [f, p] = a(!l.isLoaded()), m = Object.assign(Object.assign({}, Ge), i), h = qe();
...
}, Xe = /* @__PURE__ */ "route.header.footer.themeToggle.hero.whyItMatters.understandingImpact.resultsTable.aboutHeader.aboutGrid.whatWeMeasure.blogHeader.blogList.careersHeader.careersBenefits.openPositions.contactHeader.contactForm.faqHeader.faqList.pricingHeader.pricingTiers.productsHeader.productsGrid.settingsHeader.profileSection.preferencesSection.apiAccessSection.settingsFooter.teamHeader.teamGrid.common.home.about.blog.careers.contact.faq.pricing.products.settings.team".split("."), $ = /* @__PURE__ */ new Map();
async function Ze(e, t) {
	let n = e || "en";
	try {
		return (await Ye(Object.assign({
		...
		return n === "en" ? {} : (await Ye(Object.assign({
			"./locales/en/about.json": () => import("./about-CQ_ilyIS.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-CgUNdN6m.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-BY7Mk-pN.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-pmhxdFgQ.js"),
...
async function Qe(e) {
	let t = e || "en", n = $.get(t);
	if (n) return n;
	let r = await Promise.all(Xe.map(async (e) => [e, await Ze(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return $.set(t, o), o;
...
function et() {
	return Ve().use(Se()).use(He()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries($e.map((e) => [e, () => Qe(e)]))
	});
}
//#endregion
//#region tolgee/client.tsx
var tt = et().init(), nt = ({ language: e, staticData: t, children: n }) => {
	let i = o();
	return r(() => {
		let { unsubscribe: e } = tt.on("permanentChange", () => {
			i.refresh();
		});
		return () => e();
	}, [i]), s(Je, {
...
function at({ children: e, locale: n, staticData: i }) {
	return r(() => {
...
var ot = "en";
async function st({ children: e }) {
	return s(at, {
		locale: ot,
		staticData: await Qe(ot),
		children: e
	});
}
//#endregion
