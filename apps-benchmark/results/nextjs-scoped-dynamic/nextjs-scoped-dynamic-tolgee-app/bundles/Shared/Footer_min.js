...
var p = ({ children: e, ...t }) => u(l, {
	...t,
	children: e
}), m = Object.defineProperty, h = Object.getOwnPropertySymbols, g = Object.prototype.hasOwnProperty, _ = Object.prototype.propertyIsEnumerable, v = (e, t, n) => t in e ? m(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
}, P = (e) => Object.fromEntries(ce(e).entries()), F = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function B(e, t) {
	...
	return n.apiUrl = j(n.apiUrl), e?.fetch && (n.fetch = re(e.fetch)), {
		initialOptions: n,
...
var G = 0, K = 1, q = 2, J = 3, Y = 4, xe = new Set([
	q,
	K,
	G
]), X = "'", Se = new Set([
...
function we(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case G:
			...
			break;
		case K:
			Se.has(i) ? (n = n.slice(0, -1) + i, t = q) : (n += i, t = G);
			break;
		case q:
			i === X ? t = G : (n += i, t = q);
			break;
		case J:
			i === "}" ? (d(), t = G) : be(i) ? r !== "" && (d(), t = Y) : (u(), t = J);
			break;
		case Y: i == "}" ? t = G : be(i) ? t = Y : c(W);
	}
...
var De = () => (e, t) => (t.setFinalFormatter(Ee()), e), Oe = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, ke = {};
(function(e) {
	function t(e, t) {
		var n;
...
(b = console.assert) == null || b.call(console, Ae), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function je(e, t) {
	let n = (n) => {
...
var Qe = { useSuspense: !1 }, $e, et = () => ($e ||= e.createContext(void 0), $e), Z = void 0, tt = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
...
var it = () => {
	...
	let { tolgee: n, options: i } = it(), o = D(e), c = O(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = at(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
var Q = (t) => {
	let n = ct(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, ut(t))) : ut(n);
}, dt = (t) => {
	...
	let { t: n } = ot();
	return e.createElement(dt, Object.assign({ t: n }, t));
};
//#endregion
			...
			children: [d("div", {
				...
				children: [
					...
					d("div", { children: [u("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => u("li", { children: e.isInternal ? u(p, {
							href: e.href,
...
function xt() {
	return Je().use(De()).use(Ye()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(bt.map((e) => [e, () => yt(e)]))
	});
}
//#endregion
//#region tolgee/client.tsx
var St = xt().init(), Ct = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return a(() => {
		let { unsubscribe: e } = St.on("permanentChange", () => {
			r.refresh();
		});
		return () => e();
	}, [r]), u(tt, {
...
function Et({ children: e, locale: n, staticData: r }) {
	return a(() => {
