...
}, N = (e) => Object.fromEntries(pe(e).entries()), P = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function z(e, t) {
	let n = R(ge, t?.initialOptions, e);
	return n.apiUrl = j(n.apiUrl), e?.fetch && (n.fetch = se(e.fetch)), {
		initialOptions: n,
...
function _e(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return D(s.onError, (e) => new fe("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
		if (!l.languageDetector) return;
		let e = n();
		return D(s.onError, (e) => new de("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function C(e) {
		e && l.backends.push(e);
	}
	...
	let O = Object.freeze({
		...
		getInitialLanguage() {
			let e = n();
			return E(S(), (t) => (!e || e.includes(t)) && t ? t : ee());
		},
		setStoredLanguage(e) {
			return D(s.onError, (e) => new fe("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function xe({ options: e }) {
	let t = le(), n = ve(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ve(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ye(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = _e(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = me(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Ce = () => {
	let e = {
		...
		init(t) {
			let n = Se(R(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, we = 0, V = 1, Te = 2, Ee = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === we ? r = "Empty parameter" : e === V ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function De(e) {
	return /\s/.test(e);
}
var H = 0, U = 1, W = 2, G = 3, K = 4, Oe = new Set([
	W,
	U,
	H
]), q = "'", ke = new Set([
...
function je(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case H:
			...
			break;
		case U:
			ke.has(i) ? (n = n.slice(0, -1) + i, t = W) : (n += i, t = H);
			break;
		case W:
			i === q ? t = H : (n += i, t = W);
			break;
		case G:
			i === "}" ? (d(), t = H) : De(i) ? r !== "" && (d(), t = K) : (u(), t = G);
			break;
		case K: i == "}" ? t = H : De(i) ? t = K : c(V);
	}
...
var Pe = () => (e, t) => (t.setFinalFormatter(Ne()), e), Fe = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, J = {};
(function(e) {
	function t(e, t) {
		var n;
...
(C = console.assert) == null || C.call(console, Ie), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Le(e, t) {
	let n = (n) => {
...
var it = { useSuspense: !1 }, at, ot = () => (at ||= e.createContext(void 0), at), Y = void 0, st = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
	...
	c = rt(t, u, d, !!s);
	let [f, p] = l(!c.isLoaded()), m = Object.assign(Object.assign({}, it), r), h = ot();
...
var ut = () => {
	...
	let { tolgee: n, options: i } = ut(), o = ne(e), s = k(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = dt(), f = c([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
var X = (t) => {
	let n = mt(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, gt(t))) : gt(n);
}, _t = (t) => {
	...
	let { t: n } = ft();
	return e.createElement(_t, Object.assign({ t: n }, t));
}, yt = (e) => {
	let { tolgee: t } = ut(), { rerender: n } = dt();
	return a(() => {
...
}, wt = /* @__PURE__ */ "route.header.footer.themeToggle.hero.whyItMatters.understandingImpact.resultsTable.aboutHeader.aboutGrid.whatWeMeasure.blogHeader.blogList.careersHeader.careersBenefits.openPositions.contactHeader.contactForm.faqHeader.faqList.pricingHeader.pricingTiers.productsHeader.productsGrid.settingsHeader.profileSection.preferencesSection.apiAccessSection.settingsFooter.teamHeader.teamGrid.common.home.about.blog.careers.contact.faq.pricing.products.settings.team".split("."), Tt = /* @__PURE__ */ new Map();
async function Et(e, t) {
	let n = e || "en";
	try {
		return (await Ct(Object.assign({
		...
		return n === "en" ? {} : (await Ct(Object.assign({
			"./locales/en/about.json": () => import("./about-CQ_ilyIS.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-CgUNdN6m.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-BY7Mk-pN.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-pmhxdFgQ.js"),
...
async function Dt(e) {
	...
	if (n) return n;
	let r = await Promise.all(wt.map(async (e) => [e, await Et(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return Tt.set(t, o), o;
...
function kt() {
	return et().use(Pe()).use(tt()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(Ot.map((e) => [e, () => Dt(e)]))
	});
}
//#endregion
...
var At = "NEXT_LOCALE";
async function jt(e) {
	(await g()).set(At, e, { maxAge: 1e3 * 60 * 60 * 24 * 365 });
}
//#endregion
...
function Pt() {
	let e = yt(), t = e.getLanguage() || "en", n = async (t) => {
		await jt(t), await e.changeLanguage(t);
	};
	return d("div", {
...
var Lt = kt().init(), Rt = ({ language: e, staticData: t, children: n }) => {
	let r = m();
	return a(() => {
		let { unsubscribe: e } = Lt.on("permanentChange", () => {
			r.refresh();
		});
		return () => e();
	}, [r]), d(st, {
