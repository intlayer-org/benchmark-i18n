...
var l = ({ children: e, ...t }) => s(o, {
	...t,
	children: e
}), u = Object.defineProperty, d = Object.getOwnPropertySymbols, f = Object.prototype.hasOwnProperty, p = Object.prototype.propertyIsEnumerable, m = (e, t, n) => t in e ? u(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
var Q = null;
function Pe(e) {
	return Q ||= Ne(`${Me}/@tolgee/web@${e}/dist/${ke}`).then(() => window[Ae][je]), Q;
}
...
var Ke = { useSuspense: !1 }, qe, Je = () => (qe ||= e.createContext(void 0), qe), $ = void 0, Ye = ({ tolgee: t, options: i, children: o, fallback: s, ssr: c }) => {
	r(() => {
	...
	l = Ge(t, u, d, !!c);
	let [f, p] = a(!l.isLoaded()), m = Object.assign(Object.assign({}, Ke), i), h = Je();
...
async function $e(e, t) {
	...
	try {
		...
		return n === "en" ? {} : (await Xe(Object.assign({
			"./locales/en/about.json": () => import("./about-CQ_ilyIS.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-CgUNdN6m.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-BY7Mk-pN.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-pmhxdFgQ.js"),
...
async function et(e) {
	...
	if (n) return n;
	let r = await Promise.all(Ze.map(async (e) => [e, await $e(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return Qe.set(t, o), o;
...
function nt() {
	return He().use(Ce()).use(Ue()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(tt.map((e) => [e, () => et(e)]))
	});
}
//#endregion
//#region tolgee/client.tsx
var rt = nt().init(), it = ({ language: e, staticData: t, children: n }) => {
	let i = c();
	return r(() => {
		let { unsubscribe: e } = rt.on("permanentChange", () => {
			i.refresh();
		});
		return () => e();
	}, [i]), s(Ye, {
...
function st({ children: e, locale: n, staticData: i }) {
	return r(() => {
...
var ct = "en";
async function lt({ children: e }) {
	return s(st, {
		locale: ct,
		staticData: await et(ct),
		children: e
	});
}
//#endregion
