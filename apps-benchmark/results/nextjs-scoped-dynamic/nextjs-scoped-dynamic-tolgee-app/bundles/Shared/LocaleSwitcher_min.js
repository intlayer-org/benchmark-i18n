...
}, P = (e) => Object.fromEntries(ae(e).entries()), F = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function ue(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return x(s.onError, (e) => new N("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
	...
	let k = Object.freeze({
		...
		setStoredLanguage(e) {
			return x(s.onError, (e) => new N("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function pe({ options: e }) {
	let t = re(), n = B(!1, () => o.isFetching(), t.onFetchingChange.emit), r = B(!1, () => E.isLoading(), t.onLoadingChange.emit), i = de(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ue(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = oe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var qe = { useSuspense: !1 }, Je, Ye = () => (Je ||= e.createContext(void 0), Je), $ = void 0, Xe = ({ tolgee: t, options: r, children: i, fallback: o, ssr: c }) => {
	a(() => {
...
}, rt = /* @__PURE__ */ "route.header.footer.themeToggle.hero.whyItMatters.understandingImpact.resultsTable.aboutHeader.aboutGrid.whatWeMeasure.blogHeader.blogList.careersHeader.careersBenefits.openPositions.contactHeader.contactForm.faqHeader.faqList.pricingHeader.pricingTiers.productsHeader.productsGrid.settingsHeader.profileSection.preferencesSection.apiAccessSection.settingsFooter.teamHeader.teamGrid.common.home.about.blog.careers.contact.faq.pricing.products.settings.team".split("."), it = /* @__PURE__ */ new Map();
async function at(e, t) {
	...
	try {
		...
		return n === "en" ? {} : (await nt(Object.assign({
			"./locales/en/about.json": () => import("./about-CQ_ilyIS.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-CgUNdN6m.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-BY7Mk-pN.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-pmhxdFgQ.js"),
...
async function ot(e) {
	...
	if (n) return n;
	let r = await Promise.all(rt.map(async (e) => [e, await at(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return it.set(t, o), o;
...
function ct() {
	return Ue().use(we()).use(We()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(st.map((e) => [e, () => ot(e)]))
	});
}
//#endregion
...
var lt = "NEXT_LOCALE";
async function ut(e) {
	(await c()).set(lt, e, { maxAge: 1e3 * 60 * 60 * 24 * 365 });
}
//#endregion
...
function pt() {
	let e = tt(), t = e.getLanguage() || "en", n = async (t) => {
		await ut(t), await e.changeLanguage(t);
	};
	return l("div", {
...
var mt = ct().init(), ht = ({ language: e, staticData: t, children: n }) => {
	let r = u();
	return a(() => {
