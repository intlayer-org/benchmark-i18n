...
}, N = (e) => Object.fromEntries(oe(e).entries()), P = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
var W = 0, G = 1, K = 2, q = 3, J = 4, ye = new Set([
	K,
	G,
	W
]), Y = "'", be = new Set([
...
function Se(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case W:
			...
			break;
		case G:
			be.has(i) ? (n = n.slice(0, -1) + i, t = K) : (n += i, t = W);
			break;
		case K:
			i === Y ? t = W : (n += i, t = K);
			break;
...
var Xe = { useSuspense: !1 }, Ze, Qe = () => (Ze ||= e.createContext(void 0), Ze), X = void 0, $e = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
...
var nt = () => {
	...
	let { tolgee: n, options: i } = nt(), o = w(e), c = T(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = rt(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
function _t() {
	return Ke().use(Te()).use(qe()).updateDefaults({
