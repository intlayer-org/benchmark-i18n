...
function fe(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return x(s.onError, (e) => new oe("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
	...
	let k = Object.freeze({
		...
		setStoredLanguage(e) {
			return x(s.onError, (e) => new oe("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ee(e) || F, r = t().onFormatError, a = typeof r;
...
function he({ options: e }) {
	let t = ie(), n = R(!1, () => o.isFetching(), t.onFetchingChange.emit), r = R(!1, () => E.isLoading(), t.onLoadingChange.emit), i = pe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = fe(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = ce(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var _e = () => {
	let e = {
		...
		init(t) {
			let n = ge(I(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, ve = 0, B = 1, ye = 2, be = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === ve ? r = "Empty parameter" : e === B ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function xe(e) {
	return /\s/.test(e);
}
var V = 0, H = 1, U = 2, W = 3, G = 4, Se = new Set([
	U,
	H,
	V
]), K = "'", Ce = new Set([
...
function Te(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case V:
			...
			break;
		case H:
			Ce.has(i) ? (n = n.slice(0, -1) + i, t = U) : (n += i, t = V);
			break;
		case U:
			i === K ? t = V : (n += i, t = U);
			break;
		case W:
			i === "}" ? (d(), t = V) : xe(i) ? r !== "" && (d(), t = G) : (u(), t = W);
			break;
		case G: i == "}" ? t = V : xe(i) ? t = G : c(B);
	}
	return Se.has(t) || c(ye), l(), [a, o];
}
function Ee(e, t) {
	let [n, r] = Te(e), i = [n[0]];
...
var Oe = () => (e, t) => (t.setFinalFormatter(De()), e), ke = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, q = {};
(function(e) {
	function t(e, t) {
		var n;
...
(_ = console.assert) == null || _.call(console, Ae), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function je(e, t) {
	let n = (n) => {
...
var J = null;
function ze(e) {
	return J ||= Re(`${Le}/@tolgee/web@${e}/dist/${Pe}`).then(() => window[Fe][Ie]), J;
}
...
var Ze = { useSuspense: !1 }, Qe, $e = () => (Qe ||= e.createContext(void 0), Qe), Y = void 0, et = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
	...
	l = Xe(t, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, Ze), r), h = $e();
...
var rt = () => {
	...
	let { tolgee: n, options: i } = rt(), o = w(e), c = T(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = it(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
async function _t(e, t) {
	...
	try {
		...
		return n === "en" ? {} : (await $(Object.assign({
			"./locales/en/about.json": () => import("./about-CQ_ilyIS.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-CgUNdN6m.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-BY7Mk-pN.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-pmhxdFgQ.js"),
...
function bt() {
	return qe().use(Oe()).use(Je()).updateDefaults({
