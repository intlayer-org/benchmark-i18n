...
var m = Object.defineProperty, h = Object.getOwnPropertySymbols, g = Object.prototype.hasOwnProperty, _ = Object.prototype.propertyIsEnumerable, v = (e, t, n) => t in e ? m(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function B(e, t) {
	let n = z(de, t?.initialOptions, e);
	return n.apiUrl = A(n.apiUrl), e?.fetch && (n.fetch = j(e.fetch)), {
		initialOptions: n,
...
function fe(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return w(s.onError, (e) => new N("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return w(s.onError, (e) => new se("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function ee(e) {
		e && l.backends.push(e);
	}
	...
	let O = Object.freeze({
		...
		setStoredLanguage(e) {
			return w(s.onError, (e) => new N("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = le(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = te(e) || R, r = t().onFormatError, a = typeof r;
...
function pe(e, t, n) {
	let r = B(), i, a = Object.freeze({
		...
		overrideCredentials(e) {
			i = e ? Object.assign(Object.assign({}, e), { apiUrl: A(e.apiUrl) }) : void 0;
		}
	});
	return a;
}
function me(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = le(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
function he({ options: e }) {
	let t = ae(), n = V(!1, () => o.isFetching(), t.onFetchingChange.emit), r = V(!1, () => w.isLoading(), t.onLoadingChange.emit), i = pe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = fe(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = ce(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var _e = () => {
	let e = {
		...
		init(t) {
			let n = ge(z(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, U = 0, W = 1, ve = 2, ye = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var K = 0, q = 1, J = 2, Y = 3, X = 4, be = new Set([
	J,
	q,
	K
]), Z = "'", xe = new Set([
...
function Ce(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case K:
			...
			break;
		case q:
			xe.has(i) ? (n = n.slice(0, -1) + i, t = J) : (n += i, t = K);
			break;
		case J:
			i === Z ? t = K : (n += i, t = J);
			break;
...
function Te() {
	return { format: ({ translation: e, params: t }) => we(e, t) };
}
var Ee = () => (e, t) => (t.setFinalFormatter(Te()), e), De = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Oe = {};
(function(e) {
	function t(e, t) {
		var n;
...
(b = console.assert) == null || b.call(console, ke), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ae(e, t) {
	let n = (n) => {
...
var Ze = { useSuspense: !1 }, Qe, $e = () => (Qe ||= e.createContext(void 0), Qe), Q = void 0, et = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
...
function bt() {
	return qe().use(Ee()).use(Je()).updateDefaults({
