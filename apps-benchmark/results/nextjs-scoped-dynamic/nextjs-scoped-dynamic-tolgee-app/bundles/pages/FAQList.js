import React, { Profiler, Suspense, useCallback, useContext, useEffect, useMemo, useRef, useState } from "react";
		...
		children: [
			{
				...
				a: t("faqList.i18nBenchmarkIsAnOpenSource", "i18n Benchmark is an open-source benchmarking suite that measures and compares the performance, bundle size, and developer experience of internationalization libraries for JavaScript and React applications.")
			},
			{
				q: t("faqList.howAreBenchmarksConducted", "How are benchmarks conducted?"),
				a: t("faqList.weRunStandardizedTestsInIsolated", "We run standardized tests in isolated environments using consistent hardware. Each benchmark is repeated multiple times to ensure statistical significance. All test configurations are publicly available in our GitHub repository.")
			},
			{
				q: t("faqList.whichLibrariesAreCurrentlySupported", "Which libraries are currently supported?"),
				a: t("faqList.weSupportReactI18nextReactIntl", "We support react-i18next, react-intl (FormatJS), Lingui, typesafe-i18n, next-intl, Paraglide, Rosetta, i18n-js, Polyglot.js, vue-i18n, @fluent/react, and Tolgee.")
			},
			{
				q: t("faqList.canISubmitMyOwnBenchmarks", "Can I submit my own benchmarks?"),
				a: t("faqList.yesCommunityBenchmarkSubmissionsAre", "Yes! Community benchmark submissions are welcome. Fork our repository, add your benchmark following our contribution guide, and submit a pull request. Our team will review and merge qualifying submissions.")
			},
			{
				q: t("faqList.howOftenAreBenchmarksUpdated", "How often are benchmarks updated?"),
				a: t("faqList.weReRunAllBenchmarksWeekly", "We re-run all benchmarks weekly against the latest stable versions of each library. Major version releases trigger an immediate re-benchmark cycle.")
			},
			{
				q: t("faqList.isTheDataReliable", "Is the data reliable?"),
				a: t("faqList.weFollowRigorousStatisticalMethodologyIncluding", "We follow rigorous statistical methodology including warm-up runs, outlier detection, and confidence intervals. All raw data is published alongside our analysis for full transparency.")
			},
			{
				q: t("faqList.doYouOfferConsultingServices", "Do you offer consulting services?"),
				a: t("faqList.yesOurEnterprisePlanIncludesConsulting", "Yes, our Enterprise plan includes consulting hours for teams evaluating i18n solutions. We can provide tailored recommendations based on your specific use case, scale, and constraints.")
			},
			{
				q: t("faqList.howCanIContribute", "How can I contribute?"),
				a: t("faqList.thereAreManyWaysToContribute", "There are many ways to contribute: submit benchmarks, improve documentation, report bugs, suggest new metrics, or sponsor the project. Visit our GitHub repository for more details.")
			}
		].map((f) => jsxs("details", {
...
async function loadNamespace(locale, namespace) {
	...
	try {
		return (await _rolldown_dynamic_import_helper_default(Object.assign({
			...
			"./locales/en/about.json": () => import("./about-D0SbLfZ4.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-BWOfp5dv.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-Dgz2a6oQ.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-BHgd9Brh.js"),
			"./locales/en/blog.json": () => import("./blog-D99lMxOE.js"),
			"./locales/en/blogHeader.json": () => import("./blogHeader-DmopFGcS.js"),
			"./locales/en/blogList.json": () => import("./blogList-CNvf79lJ.js"),
			"./locales/en/careers.json": () => import("./careers-C16dOWgl.js"),
			"./locales/en/careersBenefits.json": () => import("./careersBenefits-CXHDkjkd.js"),
			"./locales/en/careersHeader.json": () => import("./careersHeader-MsP9XZ1h.js"),
			"./locales/en/common.json": () => import("./common-BVxS0kKL.js"),
			"./locales/en/contact.json": () => import("./contact-Bg130Jvt.js"),
			"./locales/en/contactForm.json": () => import("./contactForm-BnrLi81_.js"),
			"./locales/en/contactHeader.json": () => import("./contactHeader-CyrSNZ81.js"),
			"./locales/en/faq.json": () => import("./faq-fc0iHknO.js"),
			"./locales/en/faqHeader.json": () => import("./faqHeader-Bm5RHYAF.js"),
			"./locales/en/faqList.json": () => import("./faqList-TsXI-uLC.js"),
			"./locales/en/footer.json": () => import("./footer-CDZgauYs.js"),
			"./locales/en/header.json": () => import("./header-DPvzdR4o.js"),
			"./locales/en/hero.json": () => import("./hero-BDpGzBW2.js"),
			"./locales/en/home.json": () => import("./home-YHA9dK6M.js"),
			"./locales/en/mockBanner.json": () => import("./mockBanner-Dl9FD65J.js"),
			"./locales/en/openPositions.json": () => import("./openPositions-D3MXPN8u.js"),
			"./locales/en/preferencesSection.json": () => import("./preferencesSection-Dt9s8sTt.js"),
			"./locales/en/pricing.json": () => import("./pricing-DABZP1Og.js"),
			"./locales/en/pricingHeader.json": () => import("./pricingHeader-CT6ngTH9.js"),
			"./locales/en/pricingTiers.json": () => import("./pricingTiers-CGnFtCgB.js"),
			"./locales/en/products.json": () => import("./products-CDLsGL58.js"),
			"./locales/en/productsGrid.json": () => import("./productsGrid-CYgvXp7N.js"),
			"./locales/en/productsHeader.json": () => import("./productsHeader-Bn1Lj0Jp.js"),
			"./locales/en/profileSection.json": () => import("./profileSection-BXEgFaKo.js"),
			"./locales/en/resultsTable.json": () => import("./resultsTable-DhBOM5Jw.js"),
			"./locales/en/route.json": () => import("./route-Bhh4kLEQ.js"),
			"./locales/en/settings.json": () => import("./settings-DCGzhC-7.js"),
			"./locales/en/settingsFooter.json": () => import("./settingsFooter-Cwq0SWRV.js"),
			"./locales/en/settingsHeader.json": () => import("./settingsHeader-JfOMXtsD.js"),
			"./locales/en/team.json": () => import("./team-jYBGCB_y.js"),
			"./locales/en/teamGrid.json": () => import("./teamGrid-B-B8rgUj.js"),
			"./locales/en/teamHeader.json": () => import("./teamHeader-x0pVna7f.js"),
			"./locales/en/themeToggle.json": () => import("./themeToggle-DjjavUNd.js"),
			"./locales/en/understandingImpact.json": () => import("./understandingImpact-g9aVoIja.js"),
			"./locales/en/whatWeMeasure.json": () => import("./whatWeMeasure-25cmCzSX.js"),
			"./locales/en/whyItMatters.json": () => import("./whyItMatters-Bq9S5WrZ.js"),
...
function TolgeeBase() {
	return Tolgee().use(FormatSimple()).use(DevTools()).updateDefaults({
		...
		staticData: Object.fromEntries(ALL_LOCALES.map((locale) => [locale, () => getMessages(locale)]))
	});
}
//#endregion
...
function AppProviders({ children, locale, staticData }) {
	...
	return jsx(Profiler, {
		...
		children: jsx(TolgeeNextProvider, {
			language: locale,
			staticData,
			children
		})
