import e, { Profiler as t, Suspense as n, useCallback as r, useContext as i, useEffect as a, useId as o, useMemo as s, useRef as c, useState as l } from "react";
...
}, N = (e) => Object.fromEntries(ce(e).entries()), P = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
	};
}, F = ({ language: e, namespace: t }) => t ? `${e}:${t}` : e;
...
function fe(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return C(s.onError, (e) => new se("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return C(s.onError, (e) => new oe("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function E(e) {
		e && l.backends.push(e);
	}
	...
	let O = Object.freeze({
		...
		setStoredLanguage(e) {
			return C(s.onError, (e) => new se("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		getBackendDevRecord: async ({ language: e, namespace: n }) => {
			...
			if (!(!r || !i || !O.hasDevBackend())) return l.devBackend?.getRecord(Object.assign({
				apiKey: r,
				apiUrl: i,
				projectId: a,
				branch: o,
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = I(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = te(e) || L, r = t().onFormatError, a = typeof r;
...
function me(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = I(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
var V = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, me(r)), n)), n;
};
function he({ options: e }) {
	let t = ae(), n = B(!1, () => o.isFetching(), t.onFetchingChange.emit), r = B(!1, () => T.isLoading(), t.onLoadingChange.emit), i = pe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = fe(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = le(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var _e = () => {
	let e = {
		...
		init(t) {
			let n = ge(R(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, H = 0, U = 1, ve = 2, ye = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === H ? r = "Empty parameter" : e === U ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function be(e) {
	return /\s/.test(e);
}
var W = 0, G = 1, K = 2, q = 3, J = 4, xe = new Set([
	K,
	G,
	W
]), Y = "'", Se = new Set([
...
function we(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case W:
			...
			break;
		case G:
			Se.has(i) ? (n = n.slice(0, -1) + i, t = K) : (n += i, t = W);
			break;
		case K:
			i === Y ? t = W : (n += i, t = K);
			break;
		case q:
			i === "}" ? (d(), t = W) : be(i) ? r !== "" && (d(), t = J) : (u(), t = q);
			break;
		case J: i == "}" ? t = W : be(i) ? t = J : c(U);
	}
	return xe.has(t) || c(ve), l(), [a, o];
}
function Te(e, t) {
	let [n, r] = we(e), i = [n[0]];
...
function Ee() {
	return { format: ({ translation: e, params: t }) => Te(e, t) };
}
var De = () => (e, t) => (t.setFinalFormatter(Ee()), e), Oe = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, X = {};
(function(e) {
	function t(e, t) {
		var n;
...
})(typeof window < "u" ? window : Oe);
var ke = b({
	__proto__: null,
	default: X
}, [X]);
(y = console.assert) == null || y.call(console, ke), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ae(e, t) {
	let n = (n) => {
...
function je({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var Ne = "tolgee-in-context-tools.umd.min.js", Pe = "@tolgee/in-context-tools", Fe = "InContextTools", Ie = "https://cdn.jsdelivr.net/npm";
function Le(e) {
...
var Re = null;
function ze(e) {
	return Re ||= Le(`${Ie}/@tolgee/web@${e}/dist/${Ne}`).then(() => window[Pe][Fe]), Re;
}
var Be = "__tolgee_apiKey", Ve = "__tolgee_apiUrl", He = "__tolgee_branch";
function Ue() {
	let e = sessionStorage.getItem(Be) || void 0, t = sessionStorage.getItem(Ve) || void 0, n = sessionStorage.getItem(He) || void 0;
	if (!(!e || !t)) return v({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function We() {
	sessionStorage.removeItem(Be), sessionStorage.removeItem(Ve), sessionStorage.removeItem(He);
}
function Ge(e) {
...
var Ze = { useSuspense: !1 }, Qe, $e = () => (Qe ||= e.createContext(void 0), Qe), Z = void 0, et = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
	...
	c = Xe(t, u, d, !!s);
	let [f, p] = l(!c.isLoaded()), m = Object.assign(Object.assign({}, Ze), r), h = $e();
...
var rt = () => {
	...
	let { tolgee: n, options: i } = rt(), o = E(e), s = D(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = it(), f = c([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
var Q = (t) => {
	let n = st(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, lt(t))) : lt(n);
}, ut = (t) => {
	...
	let { t: n } = at();
	return e.createElement(ut, Object.assign({ t: n }, t));
};
//#endregion
...
}, ht = /* @__PURE__ */ "route.header.footer.themeToggle.hero.whyItMatters.understandingImpact.resultsTable.aboutHeader.aboutGrid.whatWeMeasure.blogHeader.blogList.careersHeader.careersBenefits.openPositions.contactHeader.contactForm.faqHeader.faqList.pricingHeader.pricingTiers.productsHeader.productsGrid.settingsHeader.profileSection.preferencesSection.apiAccessSection.settingsFooter.teamHeader.teamGrid.common.home.about.blog.careers.contact.faq.pricing.products.settings.team".split("."), gt = /* @__PURE__ */ new Map();
async function _t(e, t) {
	let n = e || "en";
	try {
		return (await mt(Object.assign({
			...
			"./locales/en/about.json": () => import("./about-CQ_ilyIS.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-CgUNdN6m.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-BY7Mk-pN.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-pmhxdFgQ.js"),
			"./locales/en/blog.json": () => import("./blog-BjPPOiRU.js"),
			"./locales/en/blogHeader.json": () => import("./blogHeader-BkQUyRbh.js"),
			"./locales/en/blogList.json": () => import("./blogList-Cex7lE63.js"),
			"./locales/en/careers.json": () => import("./careers-Csx3-Een.js"),
			"./locales/en/careersBenefits.json": () => import("./careersBenefits-BtCdfKPU.js"),
			"./locales/en/careersHeader.json": () => import("./careersHeader-BRYXSwoe.js"),
			"./locales/en/common.json": () => import("./common-z7sXCq4z.js"),
			"./locales/en/contact.json": () => import("./contact-Be7Xzs0n.js"),
			"./locales/en/contactForm.json": () => import("./contactForm-BSeLp8sc.js"),
			"./locales/en/contactHeader.json": () => import("./contactHeader-DpJIzn_V.js"),
			"./locales/en/faq.json": () => import("./faq-Dqj0dQM_.js"),
			"./locales/en/faqHeader.json": () => import("./faqHeader-D7crjHh5.js"),
			"./locales/en/faqList.json": () => import("./faqList-1eYhMPeC.js"),
			"./locales/en/footer.json": () => import("./footer-B7R1Peel.js"),
			"./locales/en/header.json": () => import("./header-CJCjdiGY.js"),
			"./locales/en/hero.json": () => import("./hero-Dp_g4jtS.js"),
			"./locales/en/home.json": () => import("./home-BbE2Ag1j.js"),
			"./locales/en/mockBanner.json": () => import("./mockBanner-Bs3qsUN1.js"),
			"./locales/en/openPositions.json": () => import("./openPositions-DrP7iy1Y.js"),
			"./locales/en/preferencesSection.json": () => import("./preferencesSection-pOrJhb-7.js"),
			"./locales/en/pricing.json": () => import("./pricing-Cajf0hnn.js"),
			"./locales/en/pricingHeader.json": () => import("./pricingHeader-BE69I_1R.js"),
			"./locales/en/pricingTiers.json": () => import("./pricingTiers-BC3JtsGj.js"),
			"./locales/en/products.json": () => import("./products-CmRkpVH6.js"),
			"./locales/en/productsGrid.json": () => import("./productsGrid-D8F4J1cv.js"),
			"./locales/en/productsHeader.json": () => import("./productsHeader-DN3RIiSo.js"),
			"./locales/en/profileSection.json": () => import("./profileSection-DlpByxLp.js"),
			"./locales/en/resultsTable.json": () => import("./resultsTable-CMOe9M5c.js"),
			"./locales/en/route.json": () => import("./route-Bjvu05oV.js"),
			"./locales/en/settings.json": () => import("./settings-DoGWXxX_.js"),
			"./locales/en/settingsFooter.json": () => import("./settingsFooter-BkGBar1w.js"),
			"./locales/en/settingsHeader.json": () => import("./settingsHeader-BDcYDdv7.js"),
			"./locales/en/team.json": () => import("./team-BYo5rP_g.js"),
			"./locales/en/teamGrid.json": () => import("./teamGrid-BmHT-JaH.js"),
			"./locales/en/teamHeader.json": () => import("./teamHeader-DynT1Y6r.js"),
			"./locales/en/themeToggle.json": () => import("./themeToggle-Dhf6hoID.js"),
			"./locales/en/understandingImpact.json": () => import("./understandingImpact-KS76Gbat.js"),
			"./locales/en/whatWeMeasure.json": () => import("./whatWeMeasure-V5WU5ylz.js"),
			"./locales/en/whyItMatters.json": () => import("./whyItMatters-DynQ7I2_.js"),
		...
		return n === "en" ? {} : (await mt(Object.assign({
			"./locales/en/about.json": () => import("./about-CQ_ilyIS.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-CgUNdN6m.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-BY7Mk-pN.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-pmhxdFgQ.js"),
...
async function vt(e) {
	let t = e || "en", n = gt.get(t);
	if (n) return n;
	let r = await Promise.all(ht.map(async (e) => [e, await _t(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return gt.set(t, o), o;
...
function bt() {
	return qe().use(De()).use(Je()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(yt.map((e) => [e, () => vt(e)]))
	});
}
//#endregion
//#region tolgee/client.tsx
var xt = bt().init(), St = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return a(() => {
...
function Tt({ children: e, locale: n, staticData: r }) {
	return a(() => {
...
var Et = "en";
async function Dt({ children: e }) {
	return u(Tt, {
		locale: Et,
		staticData: await vt(Et),
		children: e
	});
}
//#endregion
...
function Ot() {
	return u(Dt, { children: u(pt, {}) });
}
//#endregion
export { Ot as default };
//#region i18n/locales/en/about.json
var e = {
...
//#endregion
export { e as default };
//#region i18n/locales/en/aboutGrid.json
...
//#region i18n/locales/en/aboutHeader.json
...
//#region i18n/locales/en/apiAccessSection.json
...
//#region i18n/locales/en/blog.json
var e = {
...
//#endregion
export { e as default };
//#region i18n/locales/en/blogHeader.json
...
//#region i18n/locales/en/blogList.json
...
//#region i18n/locales/en/careers.json
var e = {
...
//#endregion
export { e as default };
//#region i18n/locales/en/careersBenefits.json
...
//#region i18n/locales/en/careersHeader.json
...
//#region i18n/locales/en/common.json
...
//#region i18n/locales/en/contact.json
var e = {
...
//#endregion
export { e as default };
//#region i18n/locales/en/contactForm.json
...
//#region i18n/locales/en/contactHeader.json
...
//#region i18n/locales/en/faq.json
var e = {
...
//#endregion
export { e as default };
//#region i18n/locales/en/faqHeader.json
...
//#region i18n/locales/en/faqList.json
...
//#region i18n/locales/en/footer.json
...
//#region i18n/locales/en/header.json
...
//#region i18n/locales/en/hero.json
...
//#region i18n/locales/en/home.json
var e = {
...
//#endregion
export { e as default };
//#region i18n/locales/en/mockBanner.json
...
//#region i18n/locales/en/openPositions.json
...
//#region i18n/locales/en/preferencesSection.json
...
//#region i18n/locales/en/pricing.json
var e = {
...
//#endregion
export { e as default };
//#region i18n/locales/en/pricingHeader.json
...
//#region i18n/locales/en/pricingTiers.json
...
//#region i18n/locales/en/products.json
var e = {
...
//#endregion
export { e as default };
//#region i18n/locales/en/productsGrid.json
...
//#region i18n/locales/en/productsHeader.json
...
//#region i18n/locales/en/profileSection.json
...
//#region i18n/locales/en/resultsTable.json
...
//#region i18n/locales/en/route.json
...
//#region i18n/locales/en/settings.json
var e = {
...
//#endregion
export { e as default };
//#region i18n/locales/en/settingsFooter.json
...
//#region i18n/locales/en/settingsHeader.json
...
//#region i18n/locales/en/team.json
var e = {
...
//#endregion
export { e as default };
//#region i18n/locales/en/teamGrid.json
...
//#region i18n/locales/en/teamHeader.json
...
//#region i18n/locales/en/themeToggle.json
...
//#region i18n/locales/en/understandingImpact.json
...
//#region i18n/locales/en/whatWeMeasure.json
...
//#region i18n/locales/en/whyItMatters.json
