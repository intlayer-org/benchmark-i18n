...
var Qe = { useSuspense: !1 }, $e, et = () => ($e ||= e.createContext(void 0), $e), X = void 0, tt = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	...
	l = Ze(t, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, Qe), r), h = et();
...
var it = () => {
	...
	let { tolgee: n, options: i } = it(), o = E(e), c = D(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = at(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
function ft() {
	return d(l, { children: [u(dt, {}), d("div", {
...
}, mt = /* @__PURE__ */ "route.header.footer.themeToggle.hero.whyItMatters.understandingImpact.resultsTable.aboutHeader.aboutGrid.whatWeMeasure.blogHeader.blogList.careersHeader.careersBenefits.openPositions.contactHeader.contactForm.faqHeader.faqList.pricingHeader.pricingTiers.productsHeader.productsGrid.settingsHeader.profileSection.preferencesSection.apiAccessSection.settingsFooter.teamHeader.teamGrid.common.home.about.blog.careers.contact.faq.pricing.products.settings.team".split("."), ht = /* @__PURE__ */ new Map();
async function gt(e, t) {
	...
	try {
		...
		return n === "en" ? {} : (await pt(Object.assign({
			"./locales/en/about.json": () => import("./about-CQ_ilyIS.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-CgUNdN6m.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-BY7Mk-pN.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-pmhxdFgQ.js"),
...
async function _t(e) {
	let t = e || "en", n = ht.get(t);
	if (n) return n;
	let r = await Promise.all(mt.map(async (e) => [e, await gt(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return ht.set(t, o), o;
...
function yt() {
	return Je().use(Oe()).use(Ye()).updateDefaults({
		...
		staticData: Object.fromEntries(vt.map((e) => [e, () => _t(e)]))
	});
}
//#endregion
//#region tolgee/client.tsx
var bt = yt().init(), xt = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return a(() => {
		let { unsubscribe: e } = bt.on("permanentChange", () => {
			r.refresh();
		});
		return () => e();
	}, [r]), u(tt, {
...
function wt({ children: e, locale: n, staticData: r }) {
	return a(() => {
...
var Tt = "en";
async function Et({ children: e }) {
	return u(wt, {
		locale: Tt,
		staticData: await _t(Tt),
		children: e
	});
}
//#endregion
