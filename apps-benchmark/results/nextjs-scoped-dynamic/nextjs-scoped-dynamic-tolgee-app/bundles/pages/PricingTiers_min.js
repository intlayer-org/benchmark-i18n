...
}, P = (e) => Object.fromEntries(oe(e).entries()), F = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function de(e, t, n, r, i, a, o, s) {
	...
	let k = Object.freeze({
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = ce(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = ee(e) || L, r = t().onFormatError, a = typeof r;
...
function pe(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = ce(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
function me({ options: e }) {
	let t = ie(), n = B(!1, () => o.isFetching(), t.onFetchingChange.emit), r = B(!1, () => T.isLoading(), t.onLoadingChange.emit), i = fe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = de(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = se(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var ge = () => {
	let e = {
		...
		init(t) {
			let n = he(R(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, H = 0, U = 1, _e = 2, ve = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
function Se(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		...
		case q:
			...
			break;
		case J:
			i === "}" ? (d(), t = G) : W(i) ? r !== "" && (d(), t = Y) : (u(), t = J);
			break;
		case Y: i == "}" ? t = G : W(i) ? t = Y : c(U);
	}
...
var Te = () => (e, t) => (t.setFinalFormatter(we()), e), Ee = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Z = {};
(function(e) {
	function t(e, t) {
		var n;
...
(v = console.assert) == null || v.call(console, De), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Oe(e, t) {
	let n = (n) => {
...
function ke({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var je = "tolgee-in-context-tools.umd.min.js", Me = "@tolgee/in-context-tools", Ne = "InContextTools", Pe = "https://cdn.jsdelivr.net/npm";
function Fe(e) {
...
var Ie = null;
function Le(e) {
	return Ie ||= Fe(`${Pe}/@tolgee/web@${e}/dist/${je}`).then(() => window[Me][Ne]), Ie;
}
var Re = "__tolgee_apiKey", ze = "__tolgee_apiUrl", Be = "__tolgee_branch";
function Ve() {
	let e = sessionStorage.getItem(Re) || void 0, t = sessionStorage.getItem(ze) || void 0, n = sessionStorage.getItem(Be) || void 0;
	if (!(!e || !t)) return _({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function He() {
	sessionStorage.removeItem(Re), sessionStorage.removeItem(ze), sessionStorage.removeItem(Be);
}
function Ue(e) {
...
var Ye = { useSuspense: !1 }, Xe, Ze = () => (Xe ||= e.createContext(void 0), Xe), Q = void 0, Qe = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
...
function ot() {
	...
	return l("div", {
		...
		children: [
			{
				name: e("pricingTiers.freeTier", "Free Tier"),
				price: e("pricingTiers.free", "Free"),
				period: "",
				features: [
					e("pricingTiers.publicBenchmarkDashboard", "Public benchmark dashboard"),
					e("pricingTiers.basicLibraryComparisons", "Basic library comparisons"),
					e("pricingTiers.communityForumAccess", "Community forum access"),
					e("pricingTiers.monthlyResultDigest", "Monthly result digest")
				],
				cta: e("pricingTiers.getStarted", "Get Started")
			},
			{
				name: e("pricingTiers.proTier", "Pro Tier"),
				price: "$29",
				period: e("pricingTiers.perMonth", "/month"),
				features: [
					e("pricingTiers.allFreeFeatures", "All Free features"),
					e("pricingTiers.customBenchmarkConfigurations", "Custom benchmark configurations"),
					e("pricingTiers.privateResultsDashboard", "Private results dashboard"),
					e("pricingTiers.apiAccess1000Requests", "API access (1,000 requests/day)"),
					e("pricingTiers.slackIntegration", "Slack integration")
				],
				highlighted: !0,
				cta: e("pricingTiers.subscribeToPro", "Subscribe to Pro")
			},
			{
				name: e("pricingTiers.enterpriseTier", "Enterprise Tier"),
				price: e("pricingTiers.custom", "Custom"),
				period: "",
				features: [
					e("pricingTiers.allProFeatures", "All Pro features"),
					e("pricingTiers.dedicatedBenchmarkInfrastructure", "Dedicated benchmark infrastructure"),
					e("pricingTiers.customLibraryIntegrations", "Custom library integrations"),
					e("pricingTiers.slaGuarantees", "SLA guarantees"),
					e("pricingTiers.prioritySupport", "Priority support")
				],
				cta: e("pricingTiers.contactSales", "Contact Sales")
			}
		].map((e) => u("div", {
...
}, ct = /* @__PURE__ */ "route.header.footer.themeToggle.hero.whyItMatters.understandingImpact.resultsTable.aboutHeader.aboutGrid.whatWeMeasure.blogHeader.blogList.careersHeader.careersBenefits.openPositions.contactHeader.contactForm.faqHeader.faqList.pricingHeader.pricingTiers.productsHeader.productsGrid.settingsHeader.profileSection.preferencesSection.apiAccessSection.settingsFooter.teamHeader.teamGrid.common.home.about.blog.careers.contact.faq.pricing.products.settings.team".split("."), lt = /* @__PURE__ */ new Map();
async function ut(e, t) {
	let n = e || "en";
	try {
		return (await st(Object.assign({
		...
		return n === "en" ? {} : (await st(Object.assign({
			"./locales/en/about.json": () => import("./about-CQ_ilyIS.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-CgUNdN6m.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-BY7Mk-pN.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-pmhxdFgQ.js"),
...
async function dt(e) {
	let t = e || "en", n = lt.get(t);
	if (n) return n;
	let r = await Promise.all(ct.map(async (e) => [e, await ut(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return lt.set(t, o), o;
...
function pt() {
	return Ge().use(Te()).use(Ke()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(ft.map((e) => [e, () => dt(e)]))
	});
}
//#endregion
//#region tolgee/client.tsx
var mt = pt().init(), ht = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return a(() => {
		let { unsubscribe: e } = mt.on("permanentChange", () => {
			r.refresh();
		});
		return () => e();
	}, [r]), l(Qe, {
...
function vt({ children: e, locale: n, staticData: r }) {
	return a(() => {
