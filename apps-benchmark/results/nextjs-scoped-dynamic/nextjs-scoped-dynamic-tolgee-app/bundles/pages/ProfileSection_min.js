...
function pe(e, t, n, r, i, a, o, s) {
	...
	let O = Object.freeze({
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = ue(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = te(e) || I, r = t().onFormatError, a = typeof r;
...
function he(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = ue(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
var B = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, he(r)), n)), n;
};
function ge({ options: e }) {
	let t = ae(), n = z(!1, () => o.isFetching(), t.onFetchingChange.emit), r = z(!1, () => T.isLoading(), t.onLoadingChange.emit), i = me(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = pe(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = le(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var ve = () => {
	let e = {
		...
		init(t) {
			let n = _e(L(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, ye = 0, V = 1, be = 2, xe = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === ye ? r = "Empty parameter" : e === V ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function H(e) {
	return /\s/.test(e);
}
var U = 0, W = 1, G = 2, K = 3, q = 4, Se = new Set([
	G,
	W,
	U
]), J = "'", Ce = new Set([
...
function Te(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case U:
			...
			break;
		case W:
			Ce.has(i) ? (n = n.slice(0, -1) + i, t = G) : (n += i, t = U);
			break;
		case G:
			i === J ? t = U : (n += i, t = G);
			break;
		case K:
			i === "}" ? (d(), t = U) : H(i) ? r !== "" && (d(), t = q) : (u(), t = K);
			break;
		case q: i == "}" ? t = U : H(i) ? t = q : c(V);
	}
	return Se.has(t) || c(be), l(), [a, o];
}
function Ee(e, t) {
	let [n, r] = Te(e), i = [n[0]];
...
function De() {
	return { format: ({ translation: e, params: t }) => Ee(e, t) };
}
var Oe = () => (e, t) => (t.setFinalFormatter(De()), e), ke = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Y = {};
(function(e) {
	function t(e, t) {
		var n;
...
})(typeof window < "u" ? window : ke);
var Ae = b({
	__proto__: null,
	default: Y
}, [Y]);
(y = console.assert) == null || y.call(console, Ae), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function je(e, t) {
	let n = (n) => {
...
function Me({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var Pe = "tolgee-in-context-tools.umd.min.js", Fe = "@tolgee/in-context-tools", Ie = "InContextTools", Le = "https://cdn.jsdelivr.net/npm";
function Re(e) {
...
var ze = null;
function Be(e) {
	return ze ||= Re(`${Le}/@tolgee/web@${e}/dist/${Pe}`).then(() => window[Fe][Ie]), ze;
}
var Ve = "__tolgee_apiKey", He = "__tolgee_apiUrl", Ue = "__tolgee_branch";
function We() {
	let e = sessionStorage.getItem(Ve) || void 0, t = sessionStorage.getItem(He) || void 0, n = sessionStorage.getItem(Ue) || void 0;
	if (!(!e || !t)) return v({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Ge() {
	sessionStorage.removeItem(Ve), sessionStorage.removeItem(He), sessionStorage.removeItem(Ue);
}
function Ke(e) {
...
var Qe = { useSuspense: !1 }, $e, et = () => ($e ||= e.createContext(void 0), $e), X = void 0, tt = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
	...
	c = Ze(t, u, d, !!s);
	let [f, p] = l(!c.isLoaded()), m = Object.assign(Object.assign({}, Qe), r), h = et();
...
var it = () => {
	...
	let { tolgee: n, options: i } = it(), o = E(e), s = D(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = at(), f = c([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
var Q = (t) => {
	...
	let { t: n } = ot();
	return e.createElement(lt, Object.assign({ t: n }, t));
};
//#endregion
...
}, pt = /* @__PURE__ */ "route.header.footer.themeToggle.hero.whyItMatters.understandingImpact.resultsTable.aboutHeader.aboutGrid.whatWeMeasure.blogHeader.blogList.careersHeader.careersBenefits.openPositions.contactHeader.contactForm.faqHeader.faqList.pricingHeader.pricingTiers.productsHeader.productsGrid.settingsHeader.profileSection.preferencesSection.apiAccessSection.settingsFooter.teamHeader.teamGrid.common.home.about.blog.careers.contact.faq.pricing.products.settings.team".split("."), mt = /* @__PURE__ */ new Map();
async function ht(e, t) {
	let n = e || "en";
	try {
		return (await ft(Object.assign({
		...
		return n === "en" ? {} : (await ft(Object.assign({
			"./locales/en/about.json": () => import("./about-CQ_ilyIS.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-CgUNdN6m.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-BY7Mk-pN.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-pmhxdFgQ.js"),
...
async function gt(e) {
	let t = e || "en", n = mt.get(t);
	if (n) return n;
	let r = await Promise.all(pt.map(async (e) => [e, await ht(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return mt.set(t, o), o;
...
function vt() {
	return Je().use(Oe()).use(Ye()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(_t.map((e) => [e, () => gt(e)]))
	});
}
//#endregion
//#region tolgee/client.tsx
var yt = vt().init(), bt = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return a(() => {
		let { unsubscribe: e } = yt.on("permanentChange", () => {
			r.refresh();
		});
		return () => e();
	}, [r]), u(tt, {
...
function Ct({ children: e, locale: n, staticData: r }) {
	return a(() => {
...
var wt = "en";
async function Tt({ children: e }) {
	return u(Ct, {
		locale: wt,
		staticData: await gt(wt),
		children: e
	});
}
//#endregion
