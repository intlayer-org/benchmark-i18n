...
}, N = (e) => Object.fromEntries(se(e).entries()), P = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function fe(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return S(s.onError, (e) => new oe("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
	...
	let k = Object.freeze({
		...
		setStoredLanguage(e) {
			return S(s.onError, (e) => new oe("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ee(e) || I, r = t().onFormatError, a = typeof r;
...
function he({ options: e }) {
	let t = ie(), n = z(!1, () => o.isFetching(), t.onFetchingChange.emit), r = z(!1, () => T.isLoading(), t.onLoadingChange.emit), i = pe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = fe(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = ce(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
}, ft = /* @__PURE__ */ "route.header.footer.themeToggle.hero.whyItMatters.understandingImpact.resultsTable.aboutHeader.aboutGrid.whatWeMeasure.blogHeader.blogList.careersHeader.careersBenefits.openPositions.contactHeader.contactForm.faqHeader.faqList.pricingHeader.pricingTiers.productsHeader.productsGrid.settingsHeader.profileSection.preferencesSection.apiAccessSection.settingsFooter.teamHeader.teamGrid.common.home.about.blog.careers.contact.faq.pricing.products.settings.team".split("."), pt = /* @__PURE__ */ new Map();
async function mt(e, t) {
	...
	try {
		...
		return n === "en" ? {} : (await dt(Object.assign({
			"./locales/en/about.json": () => import("./about-CQ_ilyIS.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-CgUNdN6m.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-BY7Mk-pN.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-pmhxdFgQ.js"),
...
async function ht(e) {
	let t = e || "en", n = pt.get(t);
	if (n) return n;
	let r = await Promise.all(ft.map(async (e) => [e, await mt(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return pt.set(t, o), o;
...
function _t() {
	return Ke().use(Ee()).use(qe()).updateDefaults({
		...
		staticData: Object.fromEntries(gt.map((e) => [e, () => ht(e)]))
	});
}
//#endregion
//#region tolgee/client.tsx
var vt = _t().init(), yt = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return a(() => {
		let { unsubscribe: e } = vt.on("permanentChange", () => {
			r.refresh();
		});
		return () => e();
	}, [r]), l($e, {
...
function St({ children: e, locale: n, staticData: r }) {
	return a(() => {
