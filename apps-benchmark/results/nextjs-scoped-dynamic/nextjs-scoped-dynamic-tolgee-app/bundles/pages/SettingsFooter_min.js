...
}, M = (e) => Object.fromEntries(ce(e).entries()), N = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function R(e, t) {
	let n = L(de, t?.initialOptions, e);
	return n.apiUrl = O(n.apiUrl), e?.fetch && (n.fetch = k(e.fetch)), {
		initialOptions: n,
...
function fe(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return S(s.onError, (e) => new se("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
	...
	let O = Object.freeze({
		...
		setStoredLanguage(e) {
			return S(s.onError, (e) => new se("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function he({ options: e }) {
	let t = ae(), n = z(!1, () => o.isFetching(), t.onFetchingChange.emit), r = z(!1, () => T.isLoading(), t.onLoadingChange.emit), i = pe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = fe(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = le(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var _e = () => {
	let e = {
		...
		init(t) {
			let n = ge(L(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, V = 0, H = 1, ve = 2, ye = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var W = 0, G = 1, K = 2, q = 3, J = 4, be = new Set([
	K,
	G,
	W
]), Y = "'", xe = new Set([
...
function Ce(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case W:
			...
			break;
		case G:
			xe.has(i) ? (n = n.slice(0, -1) + i, t = K) : (n += i, t = W);
			break;
		case K:
			i === Y ? t = W : (n += i, t = K);
			break;
...
var Ee = () => (e, t) => (t.setFinalFormatter(Te()), e), De = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, X = {};
(function(e) {
	function t(e, t) {
		var n;
...
var Xe = { useSuspense: !1 }, Ze, Qe = () => (Ze ||= e.createContext(void 0), Ze), Z = void 0, $e = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
	...
	l = Ye(t, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, Xe), r), h = Qe();
...
var nt = () => {
	...
	let { tolgee: n, options: i } = nt(), o = T(e), c = E(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = rt(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
var Q = (t) => {
	let n = at(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, st(t))) : st(n);
}, ct = (t) => {
	...
	let { t: n } = it();
	return e.createElement(ct, Object.assign({ t: n }, t));
};
//#endregion
...
function vt() {
	return Ke().use(Ee()).use(qe()).updateDefaults({
...
//#endregion
//#region components/pages/settings/SettingsFooter.wrapper.tsx
function Tt() {
	return l(wt, { children: l(dt, {}) });
}
//#endregion
