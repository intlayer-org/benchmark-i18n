...
var Kt = (e) => /^https?:\/\//.test(e ?? ""), qt = ({ href: e, children: t, ...n }) => {
	let r = s().locale ?? "en", i = Kt(e.toString());
	return l(c, {
...
function y(e, t) {
	let n = t && t.cache ? t.cache : en, r = t && t.serializer ? t.serializer : Qt;
...
var rn = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function an(e) {
	let t = {};
	return e.replace(rn, (e) => {
		let n = e.length;
		switch (e[0]) {
			case "G":
...
function sn(e) {
	...
	let t = e.split(on).filter((e) => e.length > 0), n = [];
	for (let e of t) {
		let t = e.split("/");
...
var O = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, k = /^(@+)?(\+|#+)?[rs]?$/g, ln = /(\*)(0+)|(#+)(0+)|(0+)/g, A = /^(0+)$/;
function j(e) {
	let t = {};
...
var Cn = RegExp(`^${bn.source}*`), wn = RegExp(`${bn.source}*$`);
function V(e, t) {
	return {
		start: e,
		end: t
...
var Tn = !!Object.fromEntries, En = !!String.prototype.trimStart, Dn = !!String.prototype.trimEnd, On = Tn ? Object.fromEntries : function(e) {
	let t = {};
	...
	return e.replace(wn, "");
}, jn = /* @__PURE__ */ RegExp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
function Mn(e, t) {
	return jn.lastIndex = t, jn.exec(e)[1] ?? "";
}
var Nn = class {
	message;
	position;
	...
	tryParseLeftAngleBracket() {
		return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !Pn(this.peek() || 0)) ? (this.bump(), "<") : null;
	}
	tryParseQuote(e) {
	...
	parseIdentifierIfPossible() {
		let e = this.clonePosition(), t = this.offset(), n = Mn(this.message, t), r = t + n.length;
...
function U(e) {
	e.forEach((e) => {
		if (delete e.location, hn(e) || gn(e)) for (let t in e.options) delete e.options[t].location, U(e.options[t].value);
		else L(e) && yn(e.style) || (pn(e) || mn(e)) && R(e.style) ? delete e.style.location : vn(e) && U(e.children);
	});
}
function Ln(e, t = {}) {
	t = {
...
function q(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (L(c)) {
			let e = typeof c.style == "string" ? r.number[c.style] : yn(c.style) ? c.style.parsedOptions : void 0;
			if (e && e.scale) {
				let t = e.scale || 1;
				if (typeof l == "bigint") {
		...
		if (vn(c)) {
			...
			if (!Hn(u)) throw new zn(l, "function", o);
		...
		if (hn(c)) {
			...
			if (!a) throw new Rn(c.value, l, Object.keys(c.options), o);
...
function Wn(e, t) {
	return t ? Object.keys(e).reduce((n, r) => (n[r] = Un(e[r], t[r]), n), { ...e }) : e;
}
function J(e) {
	return { create() {
		return {
...
var Y = class e {
	...
	constructor(t, n = e.defaultLocale, r, i) {
		...
		this.formats = Wn(e.formats, r), this.formatters = i && i.formatters || Gn(this.formatterCache);
	}
	format = (e) => {
...
function Yn(e) {
	...
	return function({ cache: e, formats: n, formatters: i, getMessageFallback: a = qn, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, h, g) {
			...
			try {
				return Kn(X(c, p), v, m && function(e) {
					let n = {};
...
function Qn({ formats: e, getMessageFallback: t, messages: n, onError: r, ...i }) {
	return {
		...
		messages: n || void 0,
		onError: r || Jn,
		getMessageFallback: t || qn
	};
}
var Q = n(void 0);
function $n({ children: e, formats: t, getMessageFallback: n, locale: r, messages: a, now: s, onError: c, timeZone: u }) {
	let d = i(Q), f = o((() => d?.cache || tn()), [r, d?.cache]), p = o((() => d?.formatters || nn(f)), [f, d?.formatters]), m = o((() => ({
		...Qn({
			locale: r,
...
var tr = !1, nr = typeof window > "u";
function rr(e) {
	return function(e, t, n) {
		let { cache: r, formats: i, formatters: a, getMessageFallback: s, locale: c, onError: l, timeZone: u } = er(), d = e[n], f = Xn(t, n);
		return u || tr || !nr || (tr = !0, l(new w(T.ENVIRONMENT_FALLBACK, void 0))), o((() => Yn({
			cache: r,
			formatters: a,
			...
			children: [u("div", {
				...
				children: [
					...
					u("div", { children: [l("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => l("li", { children: e.isInternal ? l(qt, {
							href: e.href,
...
function ur({ children: t, locale: n, messages: r }) {
	return a(() => {
