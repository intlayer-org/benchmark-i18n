...
import g from "../messages/fr/about.json";
import _ from "../messages/fr/blog.json";
import v from "../messages/fr/careers.json";
import ee from "../messages/fr/contact.json";
import te from "../messages/fr/faq.json";
import ne from "../messages/fr/home.json";
import re from "../messages/fr/pricing.json";
import ie from "../messages/fr/products.json";
import ae from "../messages/fr/route.json";
import oe from "../messages/fr/settings.json";
import se from "../messages/fr/shared.json";
import ce from "../messages/fr/team.json";
import le from "../messages/es/about.json";
import ue from "../messages/es/blog.json";
import de from "../messages/es/careers.json";
import fe from "../messages/es/contact.json";
import pe from "../messages/es/faq.json";
import me from "../messages/es/home.json";
import he from "../messages/es/pricing.json";
import ge from "../messages/es/products.json";
import _e from "../messages/es/route.json";
import ve from "../messages/es/settings.json";
import ye from "../messages/es/shared.json";
import be from "../messages/es/team.json";
import xe from "../messages/de/about.json";
import Se from "../messages/de/blog.json";
import Ce from "../messages/de/careers.json";
import we from "../messages/de/contact.json";
import Te from "../messages/de/faq.json";
import Ee from "../messages/de/home.json";
import De from "../messages/de/pricing.json";
import Oe from "../messages/de/products.json";
import ke from "../messages/de/route.json";
import Ae from "../messages/de/settings.json";
import je from "../messages/de/shared.json";
import Me from "../messages/de/team.json";
import Ne from "../messages/it/about.json";
import Pe from "../messages/it/blog.json";
import Fe from "../messages/it/careers.json";
import Ie from "../messages/it/contact.json";
import Le from "../messages/it/faq.json";
import Re from "../messages/it/home.json";
import ze from "../messages/it/pricing.json";
import Be from "../messages/it/products.json";
import Ve from "../messages/it/route.json";
import He from "../messages/it/settings.json";
import Ue from "../messages/it/shared.json";
import We from "../messages/it/team.json";
import Ge from "../messages/pt/about.json";
import Ke from "../messages/pt/blog.json";
import qe from "../messages/pt/careers.json";
import Je from "../messages/pt/contact.json";
import Ye from "../messages/pt/faq.json";
import Xe from "../messages/pt/home.json";
import Ze from "../messages/pt/pricing.json";
import Qe from "../messages/pt/products.json";
import $e from "../messages/pt/route.json";
import et from "../messages/pt/settings.json";
import tt from "../messages/pt/shared.json";
import nt from "../messages/pt/team.json";
import rt from "../messages/zh/about.json";
import it from "../messages/zh/blog.json";
import at from "../messages/zh/careers.json";
import ot from "../messages/zh/contact.json";
import st from "../messages/zh/faq.json";
import ct from "../messages/zh/home.json";
import lt from "../messages/zh/pricing.json";
import ut from "../messages/zh/products.json";
import dt from "../messages/zh/route.json";
import ft from "../messages/zh/settings.json";
import pt from "../messages/zh/shared.json";
import mt from "../messages/zh/team.json";
import ht from "../messages/ja/about.json";
import gt from "../messages/ja/blog.json";
import _t from "../messages/ja/careers.json";
import vt from "../messages/ja/contact.json";
import yt from "../messages/ja/faq.json";
import bt from "../messages/ja/home.json";
import xt from "../messages/ja/pricing.json";
import St from "../messages/ja/products.json";
import Ct from "../messages/ja/route.json";
import wt from "../messages/ja/settings.json";
import Tt from "../messages/ja/shared.json";
import Et from "../messages/ja/team.json";
import Dt from "../messages/ko/about.json";
import Ot from "../messages/ko/blog.json";
import kt from "../messages/ko/careers.json";
import At from "../messages/ko/contact.json";
import jt from "../messages/ko/faq.json";
import Mt from "../messages/ko/home.json";
import Nt from "../messages/ko/pricing.json";
import Pt from "../messages/ko/products.json";
import Ft from "../messages/ko/route.json";
import It from "../messages/ko/settings.json";
import Lt from "../messages/ko/shared.json";
import Rt from "../messages/ko/team.json";
import zt from "../messages/ru/about.json";
import Bt from "../messages/ru/blog.json";
import Vt from "../messages/ru/careers.json";
import Ht from "../messages/ru/contact.json";
import Ut from "../messages/ru/faq.json";
import Wt from "../messages/ru/home.json";
import Gt from "../messages/ru/pricing.json";
import Kt from "../messages/ru/products.json";
import qt from "../messages/ru/route.json";
import Jt from "../messages/ru/settings.json";
import Yt from "../messages/ru/shared.json";
import Xt from "../messages/ru/team.json";
var Zt = (e) => /^https?:\/\//.test(e ?? ""), y = ({ href: e, children: t, ...n }) => {
	let r = l().locale ?? "en", i = Zt(e.toString());
	return p(f, {
...
function b(e, t) {
	let n = t && t.cache ? t.cache : an, r = t && t.serializer ? t.serializer : nn;
...
function dn(e) {
	...
	let t = e.split(un).filter((e) => e.length > 0), n = [];
	for (let e of t) {
		let t = e.split("/");
...
var k = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, A = /^(@+)?(\+|#+)?[rs]?$/g, pn = /(\*)(0+)|(#+)(0+)|(0+)/g, j = /^(0+)$/;
function M(e) {
	let t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(A, function(e, n, r) {
...
function mn(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		let n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !j.test(e)) throw Error("Malformed concise eng/scientific notation");
	...
	for (let n of e) {
		switch (n.stem) {
			...
			case "integer-width":
				...
				n.options[0].replace(pn, function(e, n, r, i, a, o) {
		...
		if (k.test(n.stem)) {
			...
			n.stem.replace(k, function(e, n, r, i, a, o) {
...
function Zn(e = {
	...
	return {
		getNumberFormat: b((...e) => new Intl.NumberFormat(...e), {
			cache: q(e.number),
			strategy: w.variadic
		}),
		getDateTimeFormat: b((...e) => new Intl.DateTimeFormat(...e), {
			cache: q(e.dateTime),
			strategy: w.variadic
		}),
		getPluralRules: b((...e) => new Intl.PluralRules(...e), {
...
function Qn(...[e, t, n, i]) {
	if (Array.isArray(t)) throw new T(E.INVALID_MESSAGE, void 0);
	if (typeof t == "object") throw new T(E.INSUFFICIENT_PATH, void 0);
	if (typeof t == "string") {
		let e = function(e, t) {
	...
	try {
		...
		throw new T(E.INVALID_MESSAGE, void 0);
	}
	let f = d.format(n);
...
function tr(e) {
	let n = function(e, t, n) {
		try {
			...
			return new T(E.MISSING_MESSAGE, e.message);
		}
	}(e.locale, e.messages, e.namespace);
	return function({ cache: e, formats: n, formatters: i, getMessageFallback: a = $n, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		let d = s instanceof T;
		function f(e, t, n, r) {
			let i = new T(t, n);
			return l(i), r ?? a({
				error: i,
		...
		function p(p, m, h, g) {
			...
			if (d) {
				...
				try {
					...
					if (!_) return f(p, E.MISSING_MESSAGE, e.message, _);
					v = _;
				}
			}
			try {
				return Qn(Y(c, p), v, m && function(e) {
					let n = {};
				...
				let t, n;
				return e instanceof T ? (t = e.code, n = e.originalMessage) : (t = E.FORMATTING_ERROR, n = e.message), f(p, t, n, _);
			}
		}
		function m(e, t, n, r) {
			let i = p(e, t, n, r);
			return typeof i == "string" ? i : f(e, E.INVALID_MESSAGE, void 0);
		}
		return m.rich = p, m.markup = (e, t, n, r) => p(e, t, n, r), m.raw = (e) => {
			...
			try {
				...
				return f(e, E.MISSING_MESSAGE, t.message);
			}
		}, m.has = (e) => {
			if (d) return !1;
			try {
...
var Z = n(void 0);
function ar({ children: e, formats: t, getMessageFallback: n, locale: r, messages: a, now: o, onError: c, timeZone: l }) {
	let u = i(Z), d = s((() => u?.cache || on()), [r, u?.cache]), f = s((() => u?.formatters || sn(d)), [d, u?.formatters]), m = s((() => ({
		...ir({
			locale: r,
...
function lr(e) {
	return function(e, t, n) {
		let { cache: r, formats: i, formatters: a, getMessageFallback: o, locale: c, onError: l, timeZone: u } = or(), d = e[n], f = nr(t, n);
		return u || sr || !cr || (sr = !0, l(new T(E.ENVIRONMENT_FALLBACK, void 0))), s((() => tr({
			cache: r,
			formatters: a,
