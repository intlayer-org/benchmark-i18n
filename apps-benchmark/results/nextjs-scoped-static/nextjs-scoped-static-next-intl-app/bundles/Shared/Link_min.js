...
import h from "../messages/es/home.json";
import g from "../messages/es/pricing.json";
import _ from "../messages/es/products.json";
import v from "../messages/es/route.json";
import y from "../messages/es/settings.json";
import b from "../messages/es/shared.json";
import x from "../messages/es/team.json";
import S from "../messages/de/about.json";
import C from "../messages/de/blog.json";
import w from "../messages/de/careers.json";
import T from "../messages/de/contact.json";
import E from "../messages/de/faq.json";
import D from "../messages/de/home.json";
import O from "../messages/de/pricing.json";
import k from "../messages/de/products.json";
import A from "../messages/de/route.json";
import j from "../messages/de/settings.json";
import M from "../messages/de/shared.json";
import N from "../messages/de/team.json";
import P from "../messages/it/about.json";
import F from "../messages/it/blog.json";
import I from "../messages/it/careers.json";
import L from "../messages/it/contact.json";
import R from "../messages/it/faq.json";
import z from "../messages/it/home.json";
import B from "../messages/it/pricing.json";
import V from "../messages/it/products.json";
import H from "../messages/it/route.json";
import U from "../messages/it/settings.json";
import W from "../messages/it/shared.json";
import ue from "../messages/it/team.json";
import de from "../messages/pt/about.json";
import fe from "../messages/pt/blog.json";
import pe from "../messages/pt/careers.json";
import me from "../messages/pt/contact.json";
import he from "../messages/pt/faq.json";
import ge from "../messages/pt/home.json";
import _e from "../messages/pt/pricing.json";
import ve from "../messages/pt/products.json";
import ye from "../messages/pt/route.json";
import be from "../messages/pt/settings.json";
import xe from "../messages/pt/shared.json";
import Se from "../messages/pt/team.json";
import Ce from "../messages/zh/about.json";
import we from "../messages/zh/blog.json";
import Te from "../messages/zh/careers.json";
import Ee from "../messages/zh/contact.json";
import De from "../messages/zh/faq.json";
import Oe from "../messages/zh/home.json";
import ke from "../messages/zh/pricing.json";
import Ae from "../messages/zh/products.json";
import je from "../messages/zh/route.json";
import Me from "../messages/zh/settings.json";
import Ne from "../messages/zh/shared.json";
import Pe from "../messages/zh/team.json";
import Fe from "../messages/ja/about.json";
import Ie from "../messages/ja/blog.json";
import Le from "../messages/ja/careers.json";
import Re from "../messages/ja/contact.json";
import ze from "../messages/ja/faq.json";
import Be from "../messages/ja/home.json";
import Ve from "../messages/ja/pricing.json";
import He from "../messages/ja/products.json";
import Ue from "../messages/ja/route.json";
import We from "../messages/ja/settings.json";
import Ge from "../messages/ja/shared.json";
import Ke from "../messages/ja/team.json";
import qe from "../messages/ko/about.json";
import Je from "../messages/ko/blog.json";
import Ye from "../messages/ko/careers.json";
import Xe from "../messages/ko/contact.json";
import Ze from "../messages/ko/faq.json";
import Qe from "../messages/ko/home.json";
import $e from "../messages/ko/pricing.json";
import et from "../messages/ko/products.json";
import tt from "../messages/ko/route.json";
import nt from "../messages/ko/settings.json";
import rt from "../messages/ko/shared.json";
import it from "../messages/ko/team.json";
import at from "../messages/ru/about.json";
import ot from "../messages/ru/blog.json";
import st from "../messages/ru/careers.json";
import ct from "../messages/ru/contact.json";
import lt from "../messages/ru/faq.json";
import ut from "../messages/ru/home.json";
import dt from "../messages/ru/pricing.json";
import ft from "../messages/ru/products.json";
import pt from "../messages/ru/route.json";
import mt from "../messages/ru/settings.json";
import ht from "../messages/ru/shared.json";
import gt from "../messages/ru/team.json";
var _t = (e) => /^https?:\/\//.test(e ?? ""), vt = ({ href: e, children: t, ...n }) => {
	let r = a().locale ?? "en", i = _t(e.toString());
	return s(o, {
...
function yt(e, t) {
	let n = t && t.cache ? t.cache : Et, r = t && t.serializer ? t.serializer : wt;
...
function Ft({ formats: e, getMessageFallback: t, messages: n, onError: r, ...i }) {
	return {
		...
		messages: n || void 0,
		onError: r || Pt,
		getMessageFallback: t || Nt
	};
}
var X = t(void 0);
function It({ children: e, formats: t, getMessageFallback: r, locale: a, messages: o, now: c, onError: l, timeZone: u }) {
	let d = n(X), f = i((() => d?.cache || kt()), [a, d?.cache]), p = i((() => d?.formatters || jt(f)), [f, d?.formatters]), m = i((() => ({
		...Ft({
			locale: a,
...
function Bt({ children: t, locale: n, messages: i }) {
	return r(() => {
