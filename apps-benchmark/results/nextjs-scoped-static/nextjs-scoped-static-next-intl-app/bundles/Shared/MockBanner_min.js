...
import c from "../messages/fr/about.json";
import l from "../messages/fr/blog.json";
import u from "../messages/fr/careers.json";
import d from "../messages/fr/contact.json";
import f from "../messages/fr/faq.json";
import p from "../messages/fr/home.json";
import m from "../messages/fr/pricing.json";
import h from "../messages/fr/products.json";
import ee from "../messages/fr/route.json";
import g from "../messages/fr/settings.json";
import _ from "../messages/fr/shared.json";
import te from "../messages/fr/team.json";
import ne from "../messages/es/about.json";
import re from "../messages/es/blog.json";
import ie from "../messages/es/careers.json";
import ae from "../messages/es/contact.json";
import oe from "../messages/es/faq.json";
import se from "../messages/es/home.json";
import ce from "../messages/es/pricing.json";
import le from "../messages/es/products.json";
import ue from "../messages/es/route.json";
import de from "../messages/es/settings.json";
import fe from "../messages/es/shared.json";
import pe from "../messages/es/team.json";
import me from "../messages/de/about.json";
import he from "../messages/de/blog.json";
import ge from "../messages/de/careers.json";
import _e from "../messages/de/contact.json";
import ve from "../messages/de/faq.json";
import ye from "../messages/de/home.json";
import be from "../messages/de/pricing.json";
import xe from "../messages/de/products.json";
import Se from "../messages/de/route.json";
import Ce from "../messages/de/settings.json";
import we from "../messages/de/shared.json";
import Te from "../messages/de/team.json";
import Ee from "../messages/it/about.json";
import De from "../messages/it/blog.json";
import Oe from "../messages/it/careers.json";
import ke from "../messages/it/contact.json";
import Ae from "../messages/it/faq.json";
import je from "../messages/it/home.json";
import Me from "../messages/it/pricing.json";
import Ne from "../messages/it/products.json";
import Pe from "../messages/it/route.json";
import Fe from "../messages/it/settings.json";
import Ie from "../messages/it/shared.json";
import Le from "../messages/it/team.json";
import Re from "../messages/pt/about.json";
import ze from "../messages/pt/blog.json";
import Be from "../messages/pt/careers.json";
import Ve from "../messages/pt/contact.json";
import He from "../messages/pt/faq.json";
import Ue from "../messages/pt/home.json";
import We from "../messages/pt/pricing.json";
import Ge from "../messages/pt/products.json";
import Ke from "../messages/pt/route.json";
import qe from "../messages/pt/settings.json";
import Je from "../messages/pt/shared.json";
import Ye from "../messages/pt/team.json";
import Xe from "../messages/zh/about.json";
import Ze from "../messages/zh/blog.json";
import Qe from "../messages/zh/careers.json";
import $e from "../messages/zh/contact.json";
import et from "../messages/zh/faq.json";
import tt from "../messages/zh/home.json";
import nt from "../messages/zh/pricing.json";
import rt from "../messages/zh/products.json";
import it from "../messages/zh/route.json";
import at from "../messages/zh/settings.json";
import ot from "../messages/zh/shared.json";
import st from "../messages/zh/team.json";
import ct from "../messages/ja/about.json";
import lt from "../messages/ja/blog.json";
import ut from "../messages/ja/careers.json";
import dt from "../messages/ja/contact.json";
import ft from "../messages/ja/faq.json";
import pt from "../messages/ja/home.json";
import mt from "../messages/ja/pricing.json";
import ht from "../messages/ja/products.json";
import gt from "../messages/ja/route.json";
import _t from "../messages/ja/settings.json";
import vt from "../messages/ja/shared.json";
import yt from "../messages/ja/team.json";
import bt from "../messages/ko/about.json";
import xt from "../messages/ko/blog.json";
import St from "../messages/ko/careers.json";
import Ct from "../messages/ko/contact.json";
import wt from "../messages/ko/faq.json";
import Tt from "../messages/ko/home.json";
import Et from "../messages/ko/pricing.json";
import Dt from "../messages/ko/products.json";
import Ot from "../messages/ko/route.json";
import kt from "../messages/ko/settings.json";
import At from "../messages/ko/shared.json";
import jt from "../messages/ko/team.json";
import Mt from "../messages/ru/about.json";
import Nt from "../messages/ru/blog.json";
import Pt from "../messages/ru/careers.json";
import Ft from "../messages/ru/contact.json";
import It from "../messages/ru/faq.json";
import Lt from "../messages/ru/home.json";
import Rt from "../messages/ru/pricing.json";
import zt from "../messages/ru/products.json";
import Bt from "../messages/ru/route.json";
import Vt from "../messages/ru/settings.json";
import Ht from "../messages/ru/shared.json";
...
function Kt(e, t) {
	let n = e.length === 1 ? y : Gt;
	return b(e, this, n, t.cache.create(), t.serializer);
}
function qt(e, t) {
	return b(e, this, Gt, t.cache.create(), t.serializer);
}
function Jt(e, t) {
...
var sn = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, cn = /^(@+)?(\+|#+)?[rs]?$/g, ln = /(\*)(0+)|(#+)(0+)|(0+)/g, un = /^(0+)$/;
function T(e) {
	let t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(cn, function(e, n, r) {
...
function dn(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		let n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !un.test(e)) throw Error("Malformed concise eng/scientific notation");
	...
	for (let n of e) {
		switch (n.stem) {
			...
			case "integer-width":
				...
				n.options[0].replace(ln, function(e, n, r, i, a, o) {
		...
		if (sn.test(n.stem)) {
			...
			n.stem.replace(sn, function(e, n, r, i, a, o) {
...
function gn(e, t) {
	...
	for (let r = 0; r < e.length; r++) {
		...
		if (i === "j") {
			...
			let o = 1 + (a & 1), s = a < 2 ? 1 : 3 + (a >> 1), c = _n(t);
...
var vn = RegExp(`^${hn.source}*`), yn = RegExp(`${hn.source}*$`);
function V(e, t) {
	return {
		start: e,
		end: t
...
var bn = !!Object.fromEntries, xn = !!String.prototype.trimStart, Sn = !!String.prototype.trimEnd, Cn = bn ? Object.fromEntries : function(e) {
	let t = {};
	...
	return e.replace(yn, "");
}, En = /* @__PURE__ */ RegExp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
function Dn(e, t) {
...
var On = class {
	...
	parseTagName() {
		let e = this.offset();
		for (this.bump(); !this.isEOF() && An(this.char());) this.bump();
	...
	tryParseLeftAngleBracket() {
		return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !kn(this.peek() || 0)) ? (this.bump(), "<") : null;
	}
	tryParseQuote(e) {
	...
	parseIdentifierIfPossible() {
		let e = this.clonePosition(), t = this.offset(), n = Dn(this.message, t), r = t + n.length;
			...
			case "time": {
				...
				if (e && e.style.startsWith("::")) {
					...
					if (a === "number") {
						...
						let r = t;
						this.locale && (r = gn(t, this.locale));
						let o = {
							type: k.dateTime,
							pattern: r,
...
function U(e) {
	e.forEach((e) => {
		...
		else j(e) && L(e.style) || (M(e) || N(e)) && R(e.style) ? delete e.style.location : I(e) && U(e.children);
	});
}
function Mn(e, t = {}) {
	t = {
...
function q(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (j(c)) {
			let e = typeof c.style == "string" ? r.number[c.style] : L(c.style) ? c.style.parsedOptions : void 0;
			if (e && e.scale) {
				let t = e.scale || 1;
				if (typeof l == "bigint") {
		...
		if (I(c)) {
			...
			if (!Ln(u)) throw new Pn(l, "function", o);
		...
		if (P(c)) {
			...
			if (!a) throw new Nn(c.value, l, Object.keys(c.options), o);
...
function zn(e, t) {
	return t ? Object.keys(e).reduce((n, r) => (n[r] = Rn(e[r], t[r]), n), { ...e }) : e;
}
function J(e) {
	return { create() {
		return {
...
function Bn(e = {
	...
	return {
		getNumberFormat: v((...e) => new Intl.NumberFormat(...e), {
			cache: J(e.number),
			strategy: x.variadic
		}),
		getDateTimeFormat: v((...e) => new Intl.DateTimeFormat(...e), {
			cache: J(e.dateTime),
			strategy: x.variadic
		}),
		getPluralRules: v((...e) => new Intl.PluralRules(...e), {
...
var Y = class e {
	...
	constructor(t, n = e.defaultLocale, r, i) {
		...
		this.formats = zn(e.formats, r), this.formatters = i && i.formatters || Bn(this.formatterCache);
	}
	format = (e) => {
...
function Vn(...[e, t, n, i]) {
	if (Array.isArray(t)) throw new S(C.INVALID_MESSAGE, void 0);
	if (typeof t == "object") throw new S(C.INSUFFICIENT_PATH, void 0);
	if (typeof t == "string") {
		let e = function(e, t) {
	...
	try {
		...
		throw new S(C.INVALID_MESSAGE, void 0);
	}
	let f = d.format(n);
...
function Wn(e) {
	...
	return function({ cache: e, formats: n, formatters: i, getMessageFallback: a = Hn, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		let d = s instanceof S;
		function f(e, t, n, r) {
			let i = new S(t, n);
			return l(i), r ?? a({
				error: i,
		...
		function p(p, m, h, ee) {
			...
			if (d) {
				...
				try {
					...
					if (!g) return f(p, C.MISSING_MESSAGE, e.message, g);
					_ = g;
				}
			}
			try {
				return Vn(X(c, p), _, m && function(e) {
					let n = {};
				...
				let t, n;
				return e instanceof S ? (t = e.code, n = e.originalMessage) : (t = C.FORMATTING_ERROR, n = e.message), f(p, t, n, g);
			}
		}
		function m(e, t, n, r) {
			let i = p(e, t, n, r);
			return typeof i == "string" ? i : f(e, C.INVALID_MESSAGE, void 0);
		}
		return m.rich = p, m.markup = (e, t, n, r) => p(e, t, n, r), m.raw = (e) => {
			...
			try {
				...
				return f(e, C.MISSING_MESSAGE, t.message);
			}
		}, m.has = (e) => {
			if (d) return !1;
			try {
...
var Kn = 86400;
7 * Kn, 365 * Kn;
function qn({ formats: e, getMessageFallback: t, messages: n, onError: r, ...i }) {
	return {
		...i,
		formats: e || void 0,
		messages: n || void 0,
		onError: r || Un,
		getMessageFallback: t || Hn
	};
}
var Q = n(void 0);
function Jn({ children: e, formats: t, getMessageFallback: n, locale: r, messages: a, now: c, onError: l, timeZone: u }) {
	let d = i(Q), f = o((() => d?.cache || Qt()), [r, d?.cache]), p = o((() => d?.formatters || en(f)), [f, d?.formatters]), m = o((() => ({
		...qn({
			locale: r,
...
var Xn = !1, Zn = typeof window > "u";
function Qn(e) {
	return function(e, t, n) {
		let { cache: r, formats: i, formatters: a, getMessageFallback: s, locale: c, onError: l, timeZone: u } = Yn(), d = e[n], f = Gn(t, n);
		return u || Xn || !Zn || (Xn = !0, l(new S(C.ENVIRONMENT_FALLBACK, void 0))), o((() => Wn({
			cache: r,
			formatters: a,
...
var nr = () => s("div", {
	...
	children: er()("mock-banner.mockBanner")
});
function rr() {
	if (!(typeof window > "u")) {
...
function ar({ children: t, locale: n, messages: r }) {
	return a(() => {
