import { Profiler as e, cloneElement as t, createContext as n, isValidElement as r, useContext as i, useEffect as a, useMemo as o, useState as s } from "react";
...
function H(e) {
	e.forEach((e) => {
		if (delete e.location, fn(e) || pn(e)) for (let t in e.options) delete e.options[t].location, H(e.options[t].value);
		else ln(e) && gn(e.style) || (un(e) || dn(e)) && L(e.style) ? delete e.style.location : hn(e) && H(e.children);
	});
}
function Pn(e, t = {}) {
	t = {
...
function Kn(e) {
	...
	return function({ cache: e, formats: n, formatters: i, getMessageFallback: a = Wn, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, h, g) {
			...
			try {
				return Un(Y(c, p), v, m && function(e) {
					let n = {};
...
var Z = n(void 0);
function Xn({ children: e, formats: t, getMessageFallback: n, locale: r, messages: a, now: s, onError: l, timeZone: u }) {
	let d = i(Z), f = o((() => d?.cache || Zt()), [r, d?.cache]), p = o((() => d?.formatters || Qt(f)), [f, d?.formatters]), m = o((() => ({
		...Yn({
			locale: r,
...
function cr({ children: t, locale: n, messages: r }) {
	return a(() => {
