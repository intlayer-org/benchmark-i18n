import { Profiler as e, cloneElement as t, createContext as n, isValidElement as r, useContext as i, useEffect as a, useLayoutEffect as o, useMemo as s } from "react";
...
function Kn(e) {
	...
	return function({ cache: e, formats: n, formatters: i, getMessageFallback: a = Z, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, h, g) {
			...
			try {
				return Wn(X(c, p), v, m && function(e) {
					let n = {};
...
var $ = n(void 0);
function Xn({ children: e, formats: t, getMessageFallback: n, locale: r, messages: a, now: o, onError: c, timeZone: u }) {
	let d = i($), f = s((() => d?.cache || $t()), [r, d?.cache]), p = s((() => d?.formatters || en(f)), [f, d?.formatters]), m = s((() => ({
		...Yn({
			locale: r,
...
function ar() {
	let e = nr();
	return ir("AboutHeader"), u(c, { children: [l("h1", {
