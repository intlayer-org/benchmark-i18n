...
import h from "../../../messages/fr/pricing.json";
import g from "../../../messages/fr/products.json";
import _ from "../../../messages/fr/route.json";
import v from "../../../messages/fr/settings.json";
import ee from "../../../messages/fr/shared.json";
...
function y(e, t) {
	let n = t && t.cache ? t.cache : Xt, r = t && t.serializer ? t.serializer : Jt;
	return (t && t.strategy ? t.strategy : Gt)(e, {
		cache: n,
		serializer: r
	});
}
...
function nn(e) {
	...
	let t = e.split(tn).filter((e) => e.length > 0), n = [];
	for (let e of t) {
		let t = e.split("/");
...
var O = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, k = /^(@+)?(\+|#+)?[rs]?$/g, an = /(\*)(0+)|(#+)(0+)|(0+)/g, A = /^(0+)$/;
function j(e) {
	let t = {};
	...
	for (let n of e) {
		switch (n.stem) {
			...
			case "integer-width":
				...
				n.options[0].replace(an, function(e, n, r, i, a, o) {
...
function _n(e, t) {
	...
	for (let r = 0; r < e.length; r++) {
		...
		if (i === "j") {
			...
			let o = 1 + (a & 1), s = a < 2 ? 1 : 3 + (a >> 1), c = vn(t);
...
var yn = RegExp(`^${gn.source}*`), bn = RegExp(`${gn.source}*$`);
function V(e, t) {
	return {
		start: e,
		end: t
...
var xn = !!Object.fromEntries, Sn = !!String.prototype.trimStart, Cn = !!String.prototype.trimEnd, wn = xn ? Object.fromEntries : function(e) {
	let t = {};
	...
	return e.replace(bn, "");
}, Dn = /* @__PURE__ */ RegExp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
function On(e, t) {
	return Dn.lastIndex = t, Dn.exec(e)[1] ?? "";
}
var kn = class {
	message;
	position;
	...
	parseTagName() {
		let e = this.offset();
		for (this.bump(); !this.isEOF() && jn(this.char());) this.bump();
	...
	tryParseLeftAngleBracket() {
		return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !An(this.peek() || 0)) ? (this.bump(), "<") : null;
	}
	tryParseQuote(e) {
	...
	parseIdentifierIfPossible() {
		let e = this.clonePosition(), t = this.offset(), n = On(this.message, t), r = t + n.length;
			...
			case "time": {
				...
				if (e && e.style.startsWith("::")) {
					...
					if (a === "number") {
						...
						let r = t;
						this.locale && (r = _n(t, this.locale));
						let o = {
							type: F.dateTime,
							pattern: r,
	...
	bumpSpace() {
		for (; !this.isEOF() && Mn(this.char());) this.bump();
	}
	peek() {
		if (this.isEOF()) return null;
...
function U(e) {
	e.forEach((e) => {
		if (delete e.location, dn(e) || fn(e)) for (let t in e.options) delete e.options[t].location, U(e.options[t].value);
		else L(e) && hn(e.style) || (ln(e) || un(e)) && R(e.style) ? delete e.style.location : mn(e) && U(e.children);
	});
}
function Nn(e, t = {}) {
	t = {
...
function q(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (L(c)) {
			let e = typeof c.style == "string" ? r.number[c.style] : hn(c.style) ? c.style.parsedOptions : void 0;
			if (e && e.scale) {
				let t = e.scale || 1;
				if (typeof l == "bigint") {
		...
		if (mn(c)) {
			...
			if (!Rn(u)) throw new Fn(l, "function", o);
		...
		if (dn(c)) {
			...
			if (!a) throw new Pn(c.value, l, Object.keys(c.options), o);
...
function Bn(e, t) {
	return t ? Object.keys(e).reduce((n, r) => (n[r] = zn(e[r], t[r]), n), { ...e }) : e;
}
function J(e) {
	return { create() {
		return {
...
var Y = class e {
	...
	constructor(t, n = e.defaultLocale, r, i) {
		...
		this.formats = Bn(e.formats, r), this.formatters = i && i.formatters || Vn(this.formatterCache);
	}
	format = (e) => {
...
function Gn(e) {
	...
	return function({ cache: e, formats: n, formatters: i, getMessageFallback: a = Un, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, h, g) {
			...
			try {
				return Hn(X(c, p), v, m && function(e) {
					let n = {};
...
var qn = 86400;
7 * qn, 365 * qn;
function Jn({ formats: e, getMessageFallback: t, messages: n, onError: r, ...i }) {
	return {
		...i,
		formats: e || void 0,
		messages: n || void 0,
		onError: r || Wn,
		getMessageFallback: t || Un
	};
}
var Q = n(void 0);
function Yn({ children: e, formats: t, getMessageFallback: n, locale: r, messages: a, now: c, onError: l, timeZone: u }) {
	let d = i(Q), f = o((() => d?.cache || Zt()), [r, d?.cache]), p = o((() => d?.formatters || Qt(f)), [f, d?.formatters]), m = o((() => ({
		...Jn({
			locale: r,
...
var Zn = !1, Qn = typeof window > "u";
function $n(e) {
	return function(e, t, n) {
		let { cache: r, formats: i, formatters: a, getMessageFallback: s, locale: c, onError: l, timeZone: u } = Xn(), d = e[n], f = Kn(t, n);
		return u || Zn || !Qn || (Zn = !0, l(new w(T.ENVIRONMENT_FALLBACK, void 0))), o((() => Gn({
			cache: r,
			formatters: a,
...
function rr() {
	...
	return s("div", {
		...
		children: [
			{
				name: e("pricing-tiers.starter"),
				price: e("pricing-tiers.price0"),
				period: e("pricing-tiers.forever"),
				features: [
					e("pricing-tiers.benchmarkRunPerDay", { runs: 5 }),
					e("pricing-tiers.librariesNumber", { libs: 3 }),
					e("pricing-tiers.communitySupport"),
					e("pricing-tiers.publicResults")
				]
			},
			{
				name: e("pricing-tiers.pro"),
				price: e("pricing-tiers.price29"),
				period: e("pricing-tiers.month"),
				features: [
					e("pricing-tiers.unlimitedRuns"),
					e("pricing-tiers.allLibraries"),
					e("pricing-tiers.prioritySupport"),
					e("pricing-tiers.privateResults"),
					e("pricing-tiers.ciIntegration"),
					e("pricing-tiers.historicalData")
				],
				highlighted: !0
			},
			{
				name: e("pricing-tiers.enterprise"),
				price: e("pricing-tiers.customPrice"),
				period: "",
				features: [
					e("pricing-tiers.everythingInPro"),
					e("pricing-tiers.onPremiseOption"),
					e("pricing-tiers.ssoSaml"),
					e("pricing-tiers.dedicatedAccountManager"),
					e("pricing-tiers.customSlas"),
					e("pricing-tiers.auditLogs"),
					e("pricing-tiers.trainingSessions")
				]
			}
		].map((t) => c("div", {
			...
			children: [
				...
				s("button", {
					...
					children: t.name === e("pricing-tiers.enterprise") ? e("pricing-tiers.contactSales") : e("pricing-tiers.getStarted")
				})
			]
		}, t.name))
	});
...
function or({ children: t, locale: n, messages: r }) {
	return a(() => {
