			...
			c("div", {
				...
				children: [
					...
					c("ul", {
						...
						children: [
							s("li", { children: e("understanding-impact.theJsonMustBeParsed") }),
							s("li", { children: e("understanding-impact.contextBasedArchitecturesCanCause") }),
							s("li", { children: e("understanding-impact.duringServerSideRenderingThe") })
						]
					})
				]
			}),
