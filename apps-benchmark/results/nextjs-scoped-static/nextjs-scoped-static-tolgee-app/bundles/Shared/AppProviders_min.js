...
function is(e, t, n, r, i, a, o, s) {
	...
	function ee() {
		...
		let e = n();
		return A(s.onError, (e) => new Qo("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let C = Object.freeze({
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = es(n, ["formatEnabled"]);
...
function ss(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = es(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
var cs = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, ss(r)), n)), n;
};
function ls({ options: e }) {
	let t = Zo(), n = as(!1, () => o.isFetching(), t.onFetchingChange.emit), r = as(!1, () => S.isLoading(), t.onLoadingChange.emit), i = os(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = is(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = $o(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var ds = () => {
	let e = {
		...
		init(t) {
			let n = us(W(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, fs = 0, G = 1, ps = 2, ms = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === fs ? r = "Empty parameter" : e === G ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function hs(e) {
	return /\s/.test(e);
}
var K = 0, q = 1, J = 2, Y = 3, X = 4, gs = new Set([
	J,
	q,
	K
]), Z = "'", _s = new Set([
...
function ys(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case K:
			...
			break;
		case q:
			_s.has(i) ? (n = n.slice(0, -1) + i, t = J) : (n += i, t = K);
			break;
		case J:
			i === Z ? t = K : (n += i, t = J);
			break;
		case Y:
			i === "}" ? (d(), t = K) : hs(i) ? r !== "" && (d(), t = X) : (u(), t = Y);
			break;
		case X: i == "}" ? t = K : hs(i) ? t = X : c(G);
	}
	return gs.has(t) || c(ps), l(), [a, o];
}
function bs(e, t) {
	let [n, r] = ys(e), i = [n[0]];
...
function xs() {
	return { format: ({ translation: e, params: t }) => bs(e, t) };
}
var Ss = () => (e, t) => (t.setFinalFormatter(xs()), e), Cs = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, ws = {};
(function(e) {
	function t(e, t) {
		var n;
...
})(typeof window < "u" ? window : Cs);
var Ts = Uo({
	__proto__: null,
	default: ws
}, [ws]);
(Ho = console.assert) == null || Ho.call(console, Ts), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Es(e, t) {
	let n = (n) => {
...
function Ds({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var ks = "tolgee-in-context-tools.umd.min.js", As = "@tolgee/in-context-tools", js = "InContextTools", Ms = "https://cdn.jsdelivr.net/npm";
function Ns(e) {
...
var Ps = null;
function Fs(e) {
	return Ps ||= Ns(`${Ms}/@tolgee/web@${e}/dist/${ks}`).then(() => window[As][js]), Ps;
}
var Is = "__tolgee_apiKey", Ls = "__tolgee_apiUrl", Rs = "__tolgee_branch";
function zs() {
	let e = sessionStorage.getItem(Is) || void 0, t = sessionStorage.getItem(Ls) || void 0, n = sessionStorage.getItem(Rs) || void 0;
	if (!(!e || !t)) return Vo({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Bs() {
	sessionStorage.removeItem(Is), sessionStorage.removeItem(Ls), sessionStorage.removeItem(Rs);
}
function Vs(e) {
...
var Ks = { useSuspense: !1 }, qs, Js = () => (qs ||= e.createContext(void 0), qs), $ = void 0, Ys = ({ tolgee: t, options: i, children: o, fallback: s, ssr: c }) => {
	r(() => {
...
function Vc() {
	return Hs().use(Ss()).use(Us()).updateDefaults({
...
var Hc = Vc().init(), Uc = ({ language: e, staticData: t, children: n }) => {
	let i = o();
	return r(() => {
		let { unsubscribe: e } = Hc.on("permanentChange", () => {
			i.refresh();
		});
		return () => e();
	}, [i]), D(Ys, {
...
function Kc({ children: e, locale: n, staticData: i }) {
	return r(() => {
