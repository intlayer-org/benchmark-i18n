...
var Ho = ({ children: e, ...t }) => u(l, {
	...t,
	children: e
}), Uo = Object.defineProperty, Wo = Object.getOwnPropertySymbols, Go = Object.prototype.hasOwnProperty, Ko = Object.prototype.propertyIsEnumerable, qo = (e, t, n) => t in e ? Uo(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function ps(e, t, n, r, i, a, o, s) {
	...
	function ee() {
		...
		let e = n();
		return k(s.onError, (e) => new ss("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let C = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ts(e) || B, r = t().onFormatError, a = typeof r;
...
function hs(e, t, n) {
	let r = fs(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? M([t, ...$o(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
var ys = () => {
	...
	return t;
}, bs = 0, U = 1, xs = 2, Ss = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === bs ? r = "Empty parameter" : e === U ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Cs(e) {
	return /\s/.test(e);
}
var W = 0, G = 1, K = 2, q = 3, J = 4, ws = new Set([
	K,
	G,
	W
]), Y = "'", Ts = new Set([
...
function Ds(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case W:
			...
			break;
		case G:
			Ts.has(i) ? (n = n.slice(0, -1) + i, t = K) : (n += i, t = W);
			break;
		case K:
			i === Y ? t = W : (n += i, t = K);
			break;
		case q:
			i === "}" ? (d(), t = W) : Cs(i) ? r !== "" && (d(), t = J) : (u(), t = q);
			break;
		case J: i == "}" ? t = W : Cs(i) ? t = J : c(U);
	}
...
var tc = { useSuspense: !1 }, nc, rc = () => (nc ||= e.createContext(void 0), nc), X = void 0, ic = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
	...
	l = ec(t, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, tc), r), h = rc();
...
var sc = () => {
	...
	let { tolgee: n, options: i } = sc(), o = Qo(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = cc(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
var Q = (t) => {
	let n = uc(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, fc(t))) : fc(n);
}, pc = (t) => {
	...
	let { t: n } = Z();
	return e.createElement(pc, Object.assign({ t: n }, t));
};
//#endregion
			...
			children: [d("div", {
				...
				children: [
					...
					d("div", { children: [u("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => u("li", { children: e.isInternal ? u(Ho, {
							href: e.href,
...
function cl() {
	return Zs().use(As()).use(Qs()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(sl.map((e) => [e, () => Promise.resolve(ol(e))]))
	});
}
//#endregion
//#region tolgee/client.tsx
var ll = cl().init(), ul = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return a(() => {
...
function pl({ children: e, locale: n, staticData: r }) {
	return a(() => {
