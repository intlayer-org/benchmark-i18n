...
import { useRouter as c } from "next/navigation";
...
import me from "../i18n/locales/de/home.json";
import he from "../i18n/locales/de/about.json";
import ge from "../i18n/locales/de/blog.json";
import _e from "../i18n/locales/de/careers.json";
import ve from "../i18n/locales/de/contact.json";
import ye from "../i18n/locales/de/faq.json";
import be from "../i18n/locales/de/pricing.json";
import xe from "../i18n/locales/de/products.json";
import Se from "../i18n/locales/de/settings.json";
import Ce from "../i18n/locales/de/team.json";
import we from "../i18n/locales/es/route.json";
import Te from "../i18n/locales/es/header.json";
import Ee from "../i18n/locales/es/footer.json";
import De from "../i18n/locales/es/themeToggle.json";
import Oe from "../i18n/locales/es/hero.json";
import ke from "../i18n/locales/es/whyItMatters.json";
import Ae from "../i18n/locales/es/understandingImpact.json";
import je from "../i18n/locales/es/resultsTable.json";
import Me from "../i18n/locales/es/aboutHeader.json";
import Ne from "../i18n/locales/es/aboutGrid.json";
import Pe from "../i18n/locales/es/whatWeMeasure.json";
import Fe from "../i18n/locales/es/blogHeader.json";
import Ie from "../i18n/locales/es/blogList.json";
import Le from "../i18n/locales/es/careersHeader.json";
import Re from "../i18n/locales/es/careersBenefits.json";
import ze from "../i18n/locales/es/openPositions.json";
import Be from "../i18n/locales/es/contactHeader.json";
import Ve from "../i18n/locales/es/contactForm.json";
import He from "../i18n/locales/es/faqHeader.json";
import Ue from "../i18n/locales/es/faqList.json";
import We from "../i18n/locales/es/pricingHeader.json";
import Ge from "../i18n/locales/es/pricingTiers.json";
import Ke from "../i18n/locales/es/productsHeader.json";
import qe from "../i18n/locales/es/productsGrid.json";
import Je from "../i18n/locales/es/settingsHeader.json";
import Ye from "../i18n/locales/es/profileSection.json";
import Xe from "../i18n/locales/es/preferencesSection.json";
import Ze from "../i18n/locales/es/apiAccessSection.json";
import Qe from "../i18n/locales/es/settingsFooter.json";
import $e from "../i18n/locales/es/teamHeader.json";
import et from "../i18n/locales/es/teamGrid.json";
import tt from "../i18n/locales/es/common.json";
import nt from "../i18n/locales/es/home.json";
import rt from "../i18n/locales/es/about.json";
import it from "../i18n/locales/es/blog.json";
import at from "../i18n/locales/es/careers.json";
import ot from "../i18n/locales/es/contact.json";
import st from "../i18n/locales/es/faq.json";
import ct from "../i18n/locales/es/pricing.json";
import lt from "../i18n/locales/es/products.json";
import ut from "../i18n/locales/es/settings.json";
import dt from "../i18n/locales/es/team.json";
import ft from "../i18n/locales/fr/route.json";
import pt from "../i18n/locales/fr/header.json";
import mt from "../i18n/locales/fr/footer.json";
import ht from "../i18n/locales/fr/themeToggle.json";
import gt from "../i18n/locales/fr/hero.json";
import _t from "../i18n/locales/fr/whyItMatters.json";
import vt from "../i18n/locales/fr/understandingImpact.json";
import yt from "../i18n/locales/fr/resultsTable.json";
import bt from "../i18n/locales/fr/aboutHeader.json";
import xt from "../i18n/locales/fr/aboutGrid.json";
import St from "../i18n/locales/fr/whatWeMeasure.json";
import Ct from "../i18n/locales/fr/blogHeader.json";
import wt from "../i18n/locales/fr/blogList.json";
import Tt from "../i18n/locales/fr/careersHeader.json";
import Et from "../i18n/locales/fr/careersBenefits.json";
import Dt from "../i18n/locales/fr/openPositions.json";
import Ot from "../i18n/locales/fr/contactHeader.json";
import kt from "../i18n/locales/fr/contactForm.json";
import At from "../i18n/locales/fr/faqHeader.json";
import jt from "../i18n/locales/fr/faqList.json";
import Mt from "../i18n/locales/fr/pricingHeader.json";
import Nt from "../i18n/locales/fr/pricingTiers.json";
import Pt from "../i18n/locales/fr/productsHeader.json";
import Ft from "../i18n/locales/fr/productsGrid.json";
import It from "../i18n/locales/fr/settingsHeader.json";
import Lt from "../i18n/locales/fr/profileSection.json";
import Rt from "../i18n/locales/fr/preferencesSection.json";
import zt from "../i18n/locales/fr/apiAccessSection.json";
import Bt from "../i18n/locales/fr/settingsFooter.json";
import Vt from "../i18n/locales/fr/teamHeader.json";
import Ht from "../i18n/locales/fr/teamGrid.json";
import Ut from "../i18n/locales/fr/common.json";
import Wt from "../i18n/locales/fr/home.json";
import Gt from "../i18n/locales/fr/about.json";
import Kt from "../i18n/locales/fr/blog.json";
import qt from "../i18n/locales/fr/careers.json";
import Jt from "../i18n/locales/fr/contact.json";
import Yt from "../i18n/locales/fr/faq.json";
import Xt from "../i18n/locales/fr/pricing.json";
import Zt from "../i18n/locales/fr/products.json";
import Qt from "../i18n/locales/fr/settings.json";
import $t from "../i18n/locales/fr/team.json";
import en from "../i18n/locales/it/route.json";
import tn from "../i18n/locales/it/header.json";
import nn from "../i18n/locales/it/footer.json";
import rn from "../i18n/locales/it/themeToggle.json";
import an from "../i18n/locales/it/hero.json";
import on from "../i18n/locales/it/whyItMatters.json";
import sn from "../i18n/locales/it/understandingImpact.json";
import cn from "../i18n/locales/it/resultsTable.json";
import ln from "../i18n/locales/it/aboutHeader.json";
import un from "../i18n/locales/it/aboutGrid.json";
import dn from "../i18n/locales/it/whatWeMeasure.json";
import fn from "../i18n/locales/it/blogHeader.json";
import pn from "../i18n/locales/it/blogList.json";
import mn from "../i18n/locales/it/careersHeader.json";
import hn from "../i18n/locales/it/careersBenefits.json";
import gn from "../i18n/locales/it/openPositions.json";
import _n from "../i18n/locales/it/contactHeader.json";
import vn from "../i18n/locales/it/contactForm.json";
import yn from "../i18n/locales/it/faqHeader.json";
import bn from "../i18n/locales/it/faqList.json";
import xn from "../i18n/locales/it/pricingHeader.json";
import Sn from "../i18n/locales/it/pricingTiers.json";
import Cn from "../i18n/locales/it/productsHeader.json";
import wn from "../i18n/locales/it/productsGrid.json";
import Tn from "../i18n/locales/it/settingsHeader.json";
import En from "../i18n/locales/it/profileSection.json";
import Dn from "../i18n/locales/it/preferencesSection.json";
import On from "../i18n/locales/it/apiAccessSection.json";
import kn from "../i18n/locales/it/settingsFooter.json";
import An from "../i18n/locales/it/teamHeader.json";
import jn from "../i18n/locales/it/teamGrid.json";
import Mn from "../i18n/locales/it/common.json";
import Nn from "../i18n/locales/it/home.json";
import Pn from "../i18n/locales/it/about.json";
import Fn from "../i18n/locales/it/blog.json";
import In from "../i18n/locales/it/careers.json";
import Ln from "../i18n/locales/it/contact.json";
import Rn from "../i18n/locales/it/faq.json";
import zn from "../i18n/locales/it/pricing.json";
import Bn from "../i18n/locales/it/products.json";
import Vn from "../i18n/locales/it/settings.json";
import Hn from "../i18n/locales/it/team.json";
import Un from "../i18n/locales/ja/route.json";
import Wn from "../i18n/locales/ja/header.json";
import Gn from "../i18n/locales/ja/footer.json";
import Kn from "../i18n/locales/ja/themeToggle.json";
import qn from "../i18n/locales/ja/hero.json";
import Jn from "../i18n/locales/ja/whyItMatters.json";
import Yn from "../i18n/locales/ja/understandingImpact.json";
import Xn from "../i18n/locales/ja/resultsTable.json";
import Zn from "../i18n/locales/ja/aboutHeader.json";
import Qn from "../i18n/locales/ja/aboutGrid.json";
import $n from "../i18n/locales/ja/whatWeMeasure.json";
import er from "../i18n/locales/ja/blogHeader.json";
import tr from "../i18n/locales/ja/blogList.json";
import nr from "../i18n/locales/ja/careersHeader.json";
import rr from "../i18n/locales/ja/careersBenefits.json";
import ir from "../i18n/locales/ja/openPositions.json";
import ar from "../i18n/locales/ja/contactHeader.json";
import or from "../i18n/locales/ja/contactForm.json";
import sr from "../i18n/locales/ja/faqHeader.json";
import cr from "../i18n/locales/ja/faqList.json";
import lr from "../i18n/locales/ja/pricingHeader.json";
import ur from "../i18n/locales/ja/pricingTiers.json";
import dr from "../i18n/locales/ja/productsHeader.json";
import fr from "../i18n/locales/ja/productsGrid.json";
import pr from "../i18n/locales/ja/settingsHeader.json";
import mr from "../i18n/locales/ja/profileSection.json";
import hr from "../i18n/locales/ja/preferencesSection.json";
import gr from "../i18n/locales/ja/apiAccessSection.json";
import _r from "../i18n/locales/ja/settingsFooter.json";
import vr from "../i18n/locales/ja/teamHeader.json";
import yr from "../i18n/locales/ja/teamGrid.json";
import br from "../i18n/locales/ja/common.json";
import xr from "../i18n/locales/ja/home.json";
import Sr from "../i18n/locales/ja/about.json";
import Cr from "../i18n/locales/ja/blog.json";
import wr from "../i18n/locales/ja/careers.json";
import Tr from "../i18n/locales/ja/contact.json";
import Er from "../i18n/locales/ja/faq.json";
import Dr from "../i18n/locales/ja/pricing.json";
import Or from "../i18n/locales/ja/products.json";
import kr from "../i18n/locales/ja/settings.json";
import Ar from "../i18n/locales/ja/team.json";
import jr from "../i18n/locales/ko/route.json";
import Mr from "../i18n/locales/ko/header.json";
import Nr from "../i18n/locales/ko/footer.json";
import Pr from "../i18n/locales/ko/themeToggle.json";
import Fr from "../i18n/locales/ko/hero.json";
import Ir from "../i18n/locales/ko/whyItMatters.json";
import Lr from "../i18n/locales/ko/understandingImpact.json";
import Rr from "../i18n/locales/ko/resultsTable.json";
import zr from "../i18n/locales/ko/aboutHeader.json";
import Br from "../i18n/locales/ko/aboutGrid.json";
import Vr from "../i18n/locales/ko/whatWeMeasure.json";
import Hr from "../i18n/locales/ko/blogHeader.json";
import Ur from "../i18n/locales/ko/blogList.json";
import Wr from "../i18n/locales/ko/careersHeader.json";
import Gr from "../i18n/locales/ko/careersBenefits.json";
import Kr from "../i18n/locales/ko/openPositions.json";
import qr from "../i18n/locales/ko/contactHeader.json";
import Jr from "../i18n/locales/ko/contactForm.json";
import Yr from "../i18n/locales/ko/faqHeader.json";
import Xr from "../i18n/locales/ko/faqList.json";
import Zr from "../i18n/locales/ko/pricingHeader.json";
import Qr from "../i18n/locales/ko/pricingTiers.json";
import $r from "../i18n/locales/ko/productsHeader.json";
import ei from "../i18n/locales/ko/productsGrid.json";
import ti from "../i18n/locales/ko/settingsHeader.json";
import ni from "../i18n/locales/ko/profileSection.json";
import ri from "../i18n/locales/ko/preferencesSection.json";
import ii from "../i18n/locales/ko/apiAccessSection.json";
import ai from "../i18n/locales/ko/settingsFooter.json";
import oi from "../i18n/locales/ko/teamHeader.json";
import si from "../i18n/locales/ko/teamGrid.json";
import ci from "../i18n/locales/ko/common.json";
import li from "../i18n/locales/ko/home.json";
import ui from "../i18n/locales/ko/about.json";
import di from "../i18n/locales/ko/blog.json";
import fi from "../i18n/locales/ko/careers.json";
import pi from "../i18n/locales/ko/contact.json";
import mi from "../i18n/locales/ko/faq.json";
import hi from "../i18n/locales/ko/pricing.json";
import gi from "../i18n/locales/ko/products.json";
import _i from "../i18n/locales/ko/settings.json";
import vi from "../i18n/locales/ko/team.json";
import yi from "../i18n/locales/pt/route.json";
import bi from "../i18n/locales/pt/header.json";
import xi from "../i18n/locales/pt/footer.json";
import Si from "../i18n/locales/pt/themeToggle.json";
import Ci from "../i18n/locales/pt/hero.json";
import wi from "../i18n/locales/pt/whyItMatters.json";
import Ti from "../i18n/locales/pt/understandingImpact.json";
import Ei from "../i18n/locales/pt/resultsTable.json";
import Di from "../i18n/locales/pt/aboutHeader.json";
import Oi from "../i18n/locales/pt/aboutGrid.json";
import ki from "../i18n/locales/pt/whatWeMeasure.json";
import Ai from "../i18n/locales/pt/blogHeader.json";
import ji from "../i18n/locales/pt/blogList.json";
import Mi from "../i18n/locales/pt/careersHeader.json";
import Ni from "../i18n/locales/pt/careersBenefits.json";
import Pi from "../i18n/locales/pt/openPositions.json";
import Fi from "../i18n/locales/pt/contactHeader.json";
import Ii from "../i18n/locales/pt/contactForm.json";
import Li from "../i18n/locales/pt/faqHeader.json";
import Ri from "../i18n/locales/pt/faqList.json";
import zi from "../i18n/locales/pt/pricingHeader.json";
import Bi from "../i18n/locales/pt/pricingTiers.json";
import Vi from "../i18n/locales/pt/productsHeader.json";
import Hi from "../i18n/locales/pt/productsGrid.json";
import Ui from "../i18n/locales/pt/settingsHeader.json";
import Wi from "../i18n/locales/pt/profileSection.json";
import Gi from "../i18n/locales/pt/preferencesSection.json";
import Ki from "../i18n/locales/pt/apiAccessSection.json";
import qi from "../i18n/locales/pt/settingsFooter.json";
import Ji from "../i18n/locales/pt/teamHeader.json";
import Yi from "../i18n/locales/pt/teamGrid.json";
import Xi from "../i18n/locales/pt/common.json";
...
import Do from "../i18n/locales/zh/home.json";
import Oo from "../i18n/locales/zh/about.json";
import ko from "../i18n/locales/zh/blog.json";
import Ao from "../i18n/locales/zh/careers.json";
import jo from "../i18n/locales/zh/contact.json";
import Mo from "../i18n/locales/zh/faq.json";
import No from "../i18n/locales/zh/pricing.json";
import Po from "../i18n/locales/zh/products.json";
import Fo from "../i18n/locales/zh/settings.json";
import Io from "../i18n/locales/zh/team.json";
//#region components/Link.tsx
var Lo = ({ children: e, ...t }) => s(o, {
	...t,
	children: e
}), Ro = Object.defineProperty, zo = Object.getOwnPropertySymbols, Bo = Object.prototype.hasOwnProperty, Vo = Object.prototype.propertyIsEnumerable, Ho = (e, t, n) => t in e ? Ro(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Uo = (e, t) => {
	for (var n in t ||= {}) Bo.call(t, n) && Ho(e, n, t[n]);
	if (zo) for (var n of zo(t)) Vo.call(t, n) && Ho(e, n, t[n]);
	return e;
}, Wo;
function Go(e, t) {
...
}, B = (e) => Object.fromEntries(z(e).entries()), V = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function ts(e, t, n, r, i, a, o) {
	...
	let m = Object.freeze({
		...
		getAllRecords() {
			return Array.from(c.entries()).map(([e]) => m.getRecord(V(e)));
		},
		getTranslation(e, t) {
			return c.get(H(e))?.data[t];
		},
		getTranslationNs(e, t, n) {
			for (let r of e) for (let e of t) if (c.get(H({
				language: e,
				namespace: r
		...
		isFetching(e) {
			...
			let t = M(e);
			return !!Array.from(s.keys()).find((e) => t.includes(V(e).namespace));
		},
		isLoading(e, t) {
			let n = M(t);
		...
		async loadRecords(e, t) {
			...
			return n.forEach((e) => {
				e.promise && (e.data = B(c[0] ?? {}), c.shift());
...
function os(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return A(s.onError, (e) => new R("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
		if (!l.languageDetector) return;
		let e = n();
		return A(s.onError, (e) => new es("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let T = Object.freeze({
		...
		setStoredLanguage(e) {
			return A(s.onError, (e) => new R("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = ns(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = Yo(e) || U, r = t().onFormatError, a = typeof r;
...
function cs(e, t, n) {
	let r = as(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? N([t, ...Jo(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
		...
		getAvailableLanguages() {
			...
			if (r.initialOptions.staticData) {
				let e = Object.keys(r.initialOptions.staticData).map((e) => V(e).language);
				return Array.from(new Set(e));
			}
		},
		getAvailableNs() {
		...
		overrideCredentials(e) {
			i = e ? Object.assign(Object.assign({}, e), { apiUrl: P(e.apiUrl) }) : void 0;
		}
	});
	return a;
}
function ls(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = ns(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
var us = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, ls(r)), n)), n;
};
function ds({ options: e }) {
	let t = $o(), n = ss(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ss(!1, () => S.isLoading(), t.onLoadingChange.emit), i = cs(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = os(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = ts(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var ps = () => {
	let e = {
		...
		init(t) {
			let n = fs(W(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, ms = 0, G = 1, hs = 2, gs = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === ms ? r = "Empty parameter" : e === G ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function _s(e) {
	return /\s/.test(e);
}
var K = 0, q = 1, J = 2, Y = 3, X = 4, vs = new Set([
	J,
	q,
	K
]), Z = "'", ys = new Set([
...
function xs(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case K:
			...
			break;
		case q:
			ys.has(i) ? (n = n.slice(0, -1) + i, t = J) : (n += i, t = K);
			break;
		case J:
			i === Z ? t = K : (n += i, t = J);
			break;
		case Y:
			i === "}" ? (d(), t = K) : _s(i) ? r !== "" && (d(), t = X) : (u(), t = Y);
			break;
		case X: i == "}" ? t = K : _s(i) ? t = X : c(G);
	}
	return vs.has(t) || c(hs), l(), [a, o];
}
function Ss(e, t) {
	let [n, r] = xs(e), i = [n[0]];
...
function Cs() {
	return { format: ({ translation: e, params: t }) => Ss(e, t) };
}
var ws = () => (e, t) => (t.setFinalFormatter(Cs()), e), Ts = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Es = {};
(function(e) {
	function t(e, t) {
		var n;
...
})(typeof window < "u" ? window : Ts);
var Ds = Go({
	__proto__: null,
	default: Es
}, [Es]);
(Wo = console.assert) == null || Wo.call(console, Ds), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Os(e, t) {
	let n = (n) => {
...
function ks({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var js = "tolgee-in-context-tools.umd.min.js", Ms = "@tolgee/in-context-tools", Ns = "InContextTools", Ps = "https://cdn.jsdelivr.net/npm";
function Fs(e) {
...
var Q = null;
function Is(e) {
	return Q ||= Fs(`${Ps}/@tolgee/web@${e}/dist/${js}`).then(() => window[Ms][Ns]), Q;
}
var Ls = "__tolgee_apiKey", Rs = "__tolgee_apiUrl", zs = "__tolgee_branch";
function Bs() {
	let e = sessionStorage.getItem(Ls) || void 0, t = sessionStorage.getItem(Rs) || void 0, n = sessionStorage.getItem(zs) || void 0;
	if (!(!e || !t)) return Uo({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Vs() {
	sessionStorage.removeItem(Ls), sessionStorage.removeItem(Rs), sessionStorage.removeItem(zs);
}
function Hs(e) {
...
var Js = { useSuspense: !1 }, Ys, Xs = () => (Ys ||= e.createContext(void 0), Ys), $ = void 0, Zs = ({ tolgee: t, options: i, children: o, fallback: s, ssr: c }) => {
	r(() => {
	...
	l = qs(t, u, d, !!c);
	let [f, p] = a(!l.isLoaded()), m = Object.assign(Object.assign({}, Js), i), h = Xs();
...
function Uc() {
	return Ws().use(ws()).use(Gs()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(Hc.map((e) => [e, () => Promise.resolve(Vc(e))]))
	});
}
//#endregion
//#region tolgee/client.tsx
var Wc = Uc().init(), Gc = ({ language: e, staticData: t, children: n }) => {
	let i = c();
	return r(() => {
		let { unsubscribe: e } = Wc.on("permanentChange", () => {
			i.refresh();
		});
		return () => e();
	}, [i]), s(Zs, {
...
function Jc({ children: e, locale: n, staticData: i }) {
	return r(() => {
