...
function cs(e, t, n, r, i, a, o, s) {
	...
	function ee() {
		...
		let e = n();
		return k(s.onError, (e) => new ns("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
...
(Ko = console.assert) == null || Ko.call(console, ks), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function As(e, t) {
	let n = (n) => {
...
var Zs = { useSuspense: !1 }, Qs, $s = () => (Qs ||= e.createContext(void 0), Qs), Z = void 0, ec = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
		Z?.run !== t.run && (Z && Z.stop(), Z = t, t.run().catch((e) => {
			console.error(e);
		}).finally(() => {
			p(!1);
		}));
...
var rc = () => {
	...
	let { tolgee: n, options: i } = rc(), o = Yo(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = ic(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
function rl() {
	return qs().use(Es()).use(Js()).updateDefaults({
...
var il = rl().init(), al = ({ language: e, staticData: t, children: n }) => {
	let r = u();
	return a(() => {
		let { unsubscribe: e } = il.on("permanentChange", () => {
			r.refresh();
		});
		return () => e();
	}, [r]), l(ec, {
...
function cl({ children: e, locale: n, staticData: r }) {
	return a(() => {
