...
import Ln from "../i18n/locales/it/common.json";
...
function us(e, t) {
	let n = B(ls, t?.initialOptions, e);
	return n.apiUrl = Qo(n.apiUrl), e?.fetch && (n.fetch = ns(e.fetch)), {
		initialOptions: n,
...
function ds(e, t, n, r, i, a, o, s) {
	...
	function ee() {
		...
		let e = n();
		return O(s.onError, (e) => new as("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let C = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = $o(e) || z, r = t().onFormatError, a = typeof r;
...
function ps(e, t, n) {
	let r = us(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? j([t, ...Zo(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
var _s = () => {
	let e = {
		...
		init(t) {
			let n = gs(B(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, vs = 0, H = 1, ys = 2, bs = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === vs ? r = "Empty parameter" : e === H ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function xs(e) {
	return /\s/.test(e);
}
var U = 0, W = 1, G = 2, K = 3, q = 4, Ss = new Set([
	G,
	W,
	U
]), J = "'", Cs = new Set([
...
function Ts(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case U:
			...
			break;
		case W:
			Cs.has(i) ? (n = n.slice(0, -1) + i, t = G) : (n += i, t = U);
			break;
		case G:
			i === J ? t = U : (n += i, t = G);
			break;
		case K:
			i === "}" ? (d(), t = U) : xs(i) ? r !== "" && (d(), t = q) : (u(), t = K);
			break;
		case q: i == "}" ? t = U : xs(i) ? t = q : c(H);
	}
	return Ss.has(t) || c(ys), l(), [a, o];
}
function Es(e, t) {
	let [n, r] = Ts(e), i = [n[0]];
...
function Ds() {
	return { format: ({ translation: e, params: t }) => Es(e, t) };
}
var Os = () => (e, t) => (t.setFinalFormatter(Ds()), e), ks = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, As = {};
(function(e) {
	function t(e, t) {
		var n;
...
})(typeof window < "u" ? window : ks);
var js = Jo({
	__proto__: null,
	default: As
}, [As]);
(qo = console.assert) == null || qo.call(console, js), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ms(e, t) {
	let n = (n) => {
...
function Ns({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var Fs = "tolgee-in-context-tools.umd.min.js", Is = "@tolgee/in-context-tools", Ls = "InContextTools", Rs = "https://cdn.jsdelivr.net/npm";
function zs(e) {
...
var Bs = null;
function Vs(e) {
	return Bs ||= zs(`${Rs}/@tolgee/web@${e}/dist/${Fs}`).then(() => window[Is][Ls]), Bs;
}
var Hs = "__tolgee_apiKey", Us = "__tolgee_apiUrl", Ws = "__tolgee_branch";
function Gs() {
	let e = sessionStorage.getItem(Hs) || void 0, t = sessionStorage.getItem(Us) || void 0, n = sessionStorage.getItem(Ws) || void 0;
	if (!(!e || !t)) return Ko({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Ks() {
	sessionStorage.removeItem(Hs), sessionStorage.removeItem(Us), sessionStorage.removeItem(Ws);
}
function qs(e) {
...
var $s = { useSuspense: !1 }, ec, tc = () => (ec ||= e.createContext(void 0), ec), Y = void 0, nc = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
	...
	l = Qs(t, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, $s), r), h = tc();
...
var ac = () => {
	...
	let { tolgee: n, options: i } = ac(), o = Xo(e), c = A(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = oc(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
var Z = (t) => {
	let n = cc(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, uc(t))) : uc(n);
}, dc = (t) => {
...
function sl() {
	return Ys().use(Os()).use(Xs()).updateDefaults({
...
var cl = sl().init(), ll = ({ language: e, staticData: t, children: n }) => {
	let r = u();
	return a(() => {
...
function fl({ children: e, locale: n, staticData: r }) {
	return a(() => {
