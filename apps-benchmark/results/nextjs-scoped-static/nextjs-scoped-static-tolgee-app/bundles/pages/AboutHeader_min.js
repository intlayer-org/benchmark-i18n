	...
	let C = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = es(e) || H, r = t().onFormatError, a = typeof r;
...
var vs = () => {
	let e = {
		...
		init(t) {
			let n = _s(U(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, ys = 0, W = 1, bs = 2, xs = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === ys ? r = "Empty parameter" : e === W ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Ss(e) {
	return /\s/.test(e);
}
var G = 0, K = 1, q = 2, J = 3, Y = 4, Cs = new Set([
	q,
	K,
	G
]), X = "'", ws = new Set([
...
function Es(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case G:
			...
			break;
		case K:
			ws.has(i) ? (n = n.slice(0, -1) + i, t = q) : (n += i, t = G);
			break;
		case q:
			i === X ? t = G : (n += i, t = q);
			break;
		case J:
			i === "}" ? (d(), t = G) : Ss(i) ? r !== "" && (d(), t = Y) : (u(), t = J);
			break;
		case Y: i == "}" ? t = G : Ss(i) ? t = Y : c(W);
	}
...
(Yo = console.assert) == null || Yo.call(console, Ms), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ns(e, t) {
	let n = (n) => {
...
var ec = { useSuspense: !1 }, tc, nc = () => (tc ||= e.createContext(void 0), tc), Z = void 0, rc = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
...
var oc = () => {
	...
	let { tolgee: n, options: i } = oc(), o = Qo(e), s = j(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = sc(), f = c([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
function hc() {
	return mc("AboutHeader"), f(u, { children: [d("h1", {
