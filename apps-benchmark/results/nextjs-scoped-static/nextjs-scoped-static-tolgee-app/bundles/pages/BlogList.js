		...
		children: [
			{
				...
				excerpt: t("blogList.weTested12DifferentInternationalization", "We tested 12 different internationalization libraries across performance, bundle size, and DX. Here are the surprising results."),
			...
			},
			{
				...
				excerpt: t("blogList.practicalStrategiesForOptimizingTranslation", "Practical strategies for optimizing translation bundles including lazy loading, code splitting, and compile-time optimizations."),
			...
			},
			{
				...
				excerpt: t("blogList.anOverviewOfTheCurrentI18n", "An overview of the current i18n ecosystem in React, covering trends, emerging patterns, and community preferences."),
			...
			},
			{
				...
				excerpt: t("blogList.aStepByStepGuideOnMigrating", "A step-by-step guide on migrating a production app with 50,000 translation keys from react-i18next to Lingui."),
				category: t("blogList.tutorial", "Tutorial")
			},
			{
				...
				excerpt: t("blogList.reactServerComponentsIntroduceNew", "React Server Components introduce new patterns for internationalization. We explore the implications and best practices."),
				category: t("blogList.analysis", "Analysis")
			},
			{
				...
				excerpt: t("blogList.aTransparentLookAtOurBenchmarking", "A transparent look at our benchmarking methodology, including test environments, statistical methods, and reproducibility."),
