...
var oc = () => {
	...
	let { tolgee: n, options: i } = oc(), o = Zo(e), s = j(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = sc(), f = c([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
