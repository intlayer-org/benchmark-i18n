...
(Jo = console.assert) == null || Jo.call(console, js), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ms(e, t) {
	let n = (n) => {
...
var $s = { useSuspense: !1 }, ec, tc = () => (ec ||= e.createContext(void 0), ec), Z = void 0, nc = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
...
var ac = () => {
	...
	let { tolgee: n, options: i } = ac(), o = Zo(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = oc(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
