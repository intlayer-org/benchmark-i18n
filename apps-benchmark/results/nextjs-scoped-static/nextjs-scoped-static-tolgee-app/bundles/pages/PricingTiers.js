		...
		children: [
			...
			},
			{
				...
				features: [
					...
					t("pricingTiers.customBenchmarkConfigurations", "Custom benchmark configurations"),
			...
			},
			{
				...
				features: [
					...
					t("pricingTiers.dedicatedBenchmarkInfrastructure", "Dedicated benchmark infrastructure"),
					t("pricingTiers.customLibraryIntegrations", "Custom library integrations"),
