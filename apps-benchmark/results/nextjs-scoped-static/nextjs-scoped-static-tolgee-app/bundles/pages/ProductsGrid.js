		...
		children: [
			{
				...
				desc: t("productsGrid.interactiveChartsAndTables", "Interactive charts and tables comparing i18n libraries across bundle size, render time, and hydration cost."),
				price: t("pricingTiers.free", "Free")
			},
			{
				name: t("productsGrid.bundleAnalyzer", "Bundle Analyzer"),
				desc: t("productsGrid.uploadYourBuildOutput", "Upload your build output and get a detailed breakdown of how much of your bundle is i18n overhead."),
				price: "$29/mo"
			},
			{
				name: t("productsGrid.migrationAssistant", "Migration Assistant"),
				desc: t("productsGrid.automatedCodemodsAndGuides", "Automated codemods and guides for migrating between i18n libraries with minimal disruption."),
				price: t("pricingTiers.custom", "Custom")
			},
			{
				name: t("productsGrid.performanceMonitor", "Performance Monitor"),
				desc: t("productsGrid.continuousPerformanceTrackingFor", "Continuous performance tracking for your i18n implementation. Get alerts when translation loading degrades."),
				price: "$49/mo"
			}
		].map((p) => jsxs("div", {
