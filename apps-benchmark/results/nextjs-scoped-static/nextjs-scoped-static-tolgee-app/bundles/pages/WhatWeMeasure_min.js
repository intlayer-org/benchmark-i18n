...
var Qs = { useSuspense: !1 }, $s, ec = () => ($s ||= e.createContext(void 0), $s), Z = void 0, tc = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
...
var ic = () => {
	...
	let { tolgee: n, options: i } = ic(), o = Xo(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = ac(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
function ol() {
	return Js().use(Ds()).use(Ys()).updateDefaults({
