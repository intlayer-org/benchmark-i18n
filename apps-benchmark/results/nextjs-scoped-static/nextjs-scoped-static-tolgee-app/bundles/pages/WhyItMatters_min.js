...
var $s = { useSuspense: !1 }, ec, tc = () => (ec ||= e.createContext(void 0), ec), X = void 0, nc = ({ tolgee: t, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
...
var ac = () => {
	...
	let { tolgee: n, options: i } = ac(), o = Xo(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = oc(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
function il() {
	return Ys().use(Os()).use(Xs()).updateDefaults({
		...
		staticData: Object.fromEntries(rl.map((e) => [e, () => Promise.resolve(nl(e))]))
	});
}
//#endregion
//#region tolgee/client.tsx
var al = il().init(), ol = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return a(() => {
		let { unsubscribe: e } = al.on("permanentChange", () => {
			r.refresh();
		});
		return () => e();
	}, [r]), l(nc, {
...
function ll({ children: e, locale: n, staticData: r }) {
	return a(() => {
