...
var o = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), s = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	var n = Object.create, r = Object.defineProperty, i = Object.getOwnPropertyDescriptor, a = Object.getOwnPropertyNames, o = Object.getOwnPropertySymbols, c = Object.getPrototypeOf, l = Object.prototype.hasOwnProperty, d = Object.prototype.propertyIsEnumerable, f = (e, t, n) => t in e ? r(e, t, {
		enumerable: !0,
		configurable: !0,
		writable: !0,
		value: n
	...
	m(v, { createI18nClient: () => V }), t.exports = _(v), u();
...
}), f = d.useScopedI18n, { I18nProviderClient: p, useChangeLocale: m, useCurrentLocale: h } = d;
//#endregion
			...
			children: [a("div", {
				...
				children: [
					...
					a("div", { children: [i("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => i("li", { children: e.isInternal ? i(l, {
							href: e.href,
