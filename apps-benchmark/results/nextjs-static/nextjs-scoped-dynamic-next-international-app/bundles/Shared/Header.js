...
var client = (0, __commonJSMin(((exports, module) => {
	...
	fr: () => import("./fr-DFk5UAbk.js"),
	es: () => import("./es-Cx7Yb0HB.js"),
	de: () => import("./de-IH1iP1Tp.js"),
	it: () => import("./it-BE6rpzzi.js"),
	pt: () => import("./pt-CkNIWuyv.js"),
	zh: () => import("./zh-sTCcIU-6.js"),
	ja: () => import("./ja-Cvl8tLXw.js"),
	ko: () => import("./ko-DxOSFOoz.js"),
	ru: () => import("./ru-UCbngYY8.js")
});
			...
			children: [jsxs("div", {
				...
				children: [jsx(Link, {
					...
					children: [
						jsx(Link, {
							href: `/${currentLocale}`,
							className: `nav-link${isExactActive(`/${currentLocale}`) || isExactActive(`/${currentLocale}/`) ? " is-active" : ""}`,
