...
var d = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), f = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	var y = f("next/navigation"), b = g(f("react")), x = (e, t = "") => Object.entries(e).reduce((e, [n, r]) => d(d({}, e), typeof r == "string" ? { [t + n]: r } : x(r, `${t}${n}.`)), {});
	function S(e, t) {
	...
	var D = f("react"), O = f("react"), k = f("react");
	function A(e, t) {
	...
	var L = f("next/navigation"), R = f("react"), z = "locale";
	function B(e, t) {
		return function() {
	...
	fr: () => import("./fr-U143hu9c.js"),
	es: () => import("./es-CuEFAJ5Y.js"),
	de: () => import("./de-DxM8Des7.js"),
	it: () => import("./it-C3QygvLt.js"),
	pt: () => import("./pt-BdQnz07E.js"),
	zh: () => import("./zh-BqslrVQB.js"),
	ja: () => import("./ja-sGt89jmX.js"),
	ko: () => import("./ko-C0478R7p.js"),
	ru: () => import("./ru-DUWxqmYS.js")
...
function C() {
	let e = _("theme-toggle"), [n, i] = r("auto");
	t(() => {
		let e = x();
		i(e), S(e);
	}, []), t(() => {
...
function j({ children: n, locale: r }) {
	return t(() => {
