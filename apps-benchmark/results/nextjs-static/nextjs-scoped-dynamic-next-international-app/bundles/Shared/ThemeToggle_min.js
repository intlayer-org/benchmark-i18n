...
}), c = s.useScopedI18n, { I18nProviderClient: l, useChangeLocale: u, useCurrentLocale: d } = s;
//#endregion
...
function m() {
	let e = c("theme-toggle"), [i, a] = n("auto");
	t(() => {
		let e = f();
		a(e), p(e);
	}, []), t(() => {
		if (i !== "auto") return;
		let e = window.matchMedia("(prefers-color-scheme: dark)"), t = () => p("auto");
	...
	function o() {
		...
		a(e), p(e), window.localStorage.setItem("theme", e);
	}
	let s = e(i === "auto" ? "themeModeAutoSystemClick" : i === "light" ? "themeModeLightClick" : "themeModeDarkClick");
	return r("button", {
		type: "button",
		onClick: o,
		"aria-label": s,
		...
		children: e(i === "auto" ? "themeAuto" : i === "dark" ? "themeDark" : "themeLight")
	});
}
//#endregion
...
function _({ children: n, locale: i }) {
	return t(() => {
