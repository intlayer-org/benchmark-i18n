...
var client = (0, __commonJSMin(((exports, module) => {
	...
	en: () => import("./en-DPlr65rW.js"),
	fr: () => import("./fr-C_iWD5Ud.js"),
	es: () => import("./es-mvxKeS0o.js"),
	de: () => import("./de-BJGqcaYU.js"),
	it: () => import("./it-_CIsx6QF.js"),
	pt: () => import("./pt-Cbe3FiWh.js"),
	zh: () => import("./zh-DN50n5fC.js"),
	ja: () => import("./ja-LlQ5_ku-.js"),
	ko: () => import("./ko-ymAagNo2.js"),
	ru: () => import("./ru-Dd37G3tO.js")
});
		...
		children: [jsx("h2", {
			...
			children: [
				...
				jsxs("div", { children: [jsx("label", {
					...
					children: [
						jsx("option", { children: scopedT("englishEn") }),
						jsx("option", { children: scopedT("frenchFr") }),
						jsx("option", { children: scopedT("germanDe") }),
						jsx("option", { children: scopedT("spanishEs") }),
						jsx("option", { children: scopedT("japaneseJa") }),
						jsx("option", { children: scopedT("chineseSimplifiedZhCn") }),
						jsx("option", { children: scopedT("arabicAr") })
					]
				})] })
			]
		})]
...
import { n as nestify, t as mergeAll } from "./scopedMessages-DGudMztF.js";
