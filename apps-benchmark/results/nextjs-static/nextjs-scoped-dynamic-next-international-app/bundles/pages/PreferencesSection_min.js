...
function p() {
	let e = l("preferences-section"), t = n();
	return i("section", {
		...
		children: [r("h2", {
			...
			children: [
				...
				i("div", { children: [r("label", {
					...
					children: [
						r("option", { children: e("englishEn") }),
						r("option", { children: e("frenchFr") }),
						r("option", { children: e("germanDe") }),
						r("option", { children: e("spanishEs") }),
						r("option", { children: e("japaneseJa") }),
						r("option", { children: e("chineseSimplifiedZhCn") }),
						r("option", { children: e("arabicAr") })
					]
				})] })
			]
		})]
