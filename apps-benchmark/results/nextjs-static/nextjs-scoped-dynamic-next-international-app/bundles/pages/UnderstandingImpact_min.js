			...
			r("div", {
				...
				children: [
					...
					r("ul", {
						...
						children: [
							n("li", { children: e("theJsonMustBeParsed") }),
							n("li", { children: e("contextBasedArchitecturesCanCause") }),
							n("li", { children: e("duringServerSideRenderingThe") })
						]
					})
				]
			}),
...
function h({ children: r, locale: i }) {
	return t(() => {
