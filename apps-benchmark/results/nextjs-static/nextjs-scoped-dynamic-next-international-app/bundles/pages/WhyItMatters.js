...
function WhyItMatters() {
	...
	return jsxs("section", {
		...
		children: [jsx("h2", {
			...
			children: scopedT("whyTheseMetricsMatter")
		}), jsxs("div", {
			...
			children: [
				jsxs("div", {
					...
					children: [jsx("h3", {
						...
						children: scopedResultsT("bundleSize")
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
						children: scopedT("theBundleIsTheData")
					})]
				}),
				jsxs("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [jsx("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: scopedT("renderingHydration")
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
						children: scopedT("connectingALargeJsonDictionary")
					})]
				}),
				jsxs("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [jsx("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: scopedT("dynamicLoading")
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
						children: scopedT("loadingAllTranslationsUpfrontOverloads")
					})]
				})
			]
		})]
