...
var kt = X("de"), At = X("en"), jt = X("es"), Mt = X("fr"), Nt = X("it"), Pt = X("ja"), Ft = X("ko"), Z = X("pt"), It = X("ru"), Lt = X("zh"), Q = (0, ft.createI18nClient)({
...
Q.useScopedI18n;
var { I18nProviderClient: Rt, useChangeLocale: zt, useCurrentLocale: Bt } = Q;
//#endregion
