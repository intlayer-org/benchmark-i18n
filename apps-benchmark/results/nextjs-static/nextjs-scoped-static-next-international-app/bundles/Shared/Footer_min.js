...
import h from "../messages/fr/settings.json";
import g from "../messages/fr/shared.json";
import _ from "../messages/fr/team.json";
import v from "../messages/es/about.json";
import y from "../messages/es/blog.json";
import b from "../messages/es/careers.json";
import x from "../messages/es/contact.json";
import S from "../messages/es/faq.json";
import C from "../messages/es/home.json";
import w from "../messages/es/pricing.json";
import T from "../messages/es/products.json";
import E from "../messages/es/route.json";
import D from "../messages/es/settings.json";
import O from "../messages/es/shared.json";
import k from "../messages/es/team.json";
import A from "../messages/de/about.json";
import j from "../messages/de/blog.json";
import M from "../messages/de/careers.json";
import N from "../messages/de/contact.json";
import P from "../messages/de/faq.json";
import F from "../messages/de/home.json";
import I from "../messages/de/pricing.json";
import L from "../messages/de/products.json";
import R from "../messages/de/route.json";
import z from "../messages/de/settings.json";
import ee from "../messages/de/shared.json";
import te from "../messages/de/team.json";
import ne from "../messages/it/about.json";
import re from "../messages/it/blog.json";
import ie from "../messages/it/careers.json";
import ae from "../messages/it/contact.json";
import oe from "../messages/it/faq.json";
import se from "../messages/it/home.json";
...
import G from "../messages/it/team.json";
import K from "../messages/pt/about.json";
import ce from "../messages/pt/blog.json";
import le from "../messages/pt/careers.json";
...
var q = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), J = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
}), pt = (e) => /^https?:\/\//.test(e ?? ""), mt = ({ href: e, children: t, ...a }) => {
	let o = n().locale ?? "en", s = pt(e.toString());
	return i(r, {
	...
	f(g, { createI18nClient: () => z }), t.exports = h(g), ht();
...
var Nt = Z("de"), Pt = Z("en"), Ft = Z("es"), It = Z("fr"), Lt = Z("it"), Rt = Z("ja"), zt = Z("ko"), Bt = Z("pt"), Vt = Z("ru"), Q = Z("zh"), $ = (0, gt.createI18nClient)({
	en: () => Promise.resolve({ default: Pt }),
	fr: () => Promise.resolve({ default: It }),
	es: () => Promise.resolve({ default: Ft }),
	de: () => Promise.resolve({ default: Nt }),
	it: () => Promise.resolve({ default: Lt }),
	pt: () => Promise.resolve({ default: Bt }),
	zh: () => Promise.resolve({ default: Q }),
	ja: () => Promise.resolve({ default: Rt }),
	ko: () => Promise.resolve({ default: zt }),
	ru: () => Promise.resolve({ default: Vt })
}), Ht = $.useScopedI18n, { I18nProviderClient: Ut, useChangeLocale: Wt, useCurrentLocale: Gt } = $;
//#endregion
			...
			children: [a("div", {
				...
				children: [
					...
					a("div", { children: [i("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => i("li", { children: e.isInternal ? i(mt, {
							href: e.href,
...
function Yt({ children: n, locale: r }) {
	return t(() => {
