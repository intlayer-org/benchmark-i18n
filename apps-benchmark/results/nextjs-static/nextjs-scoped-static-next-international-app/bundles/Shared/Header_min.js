...
import y from "../messages/fr/route.json";
import b from "../messages/fr/settings.json";
import x from "../messages/fr/shared.json";
import S from "../messages/fr/team.json";
import C from "../messages/es/about.json";
import w from "../messages/es/blog.json";
import T from "../messages/es/careers.json";
import E from "../messages/es/contact.json";
import D from "../messages/es/faq.json";
import O from "../messages/es/home.json";
import k from "../messages/es/pricing.json";
import A from "../messages/es/products.json";
import j from "../messages/es/route.json";
import M from "../messages/es/settings.json";
import N from "../messages/es/shared.json";
import P from "../messages/es/team.json";
import F from "../messages/de/about.json";
import I from "../messages/de/blog.json";
import L from "../messages/de/careers.json";
import R from "../messages/de/contact.json";
import z from "../messages/de/faq.json";
import ee from "../messages/de/home.json";
import te from "../messages/de/pricing.json";
import ne from "../messages/de/products.json";
import re from "../messages/de/route.json";
import ie from "../messages/de/settings.json";
import ae from "../messages/de/shared.json";
import oe from "../messages/de/team.json";
import se from "../messages/it/about.json";
import ce from "../messages/it/blog.json";
import le from "../messages/it/careers.json";
import ue from "../messages/it/contact.json";
...
import de from "../messages/it/route.json";
...
var W = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), G = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	if (typeof require < "u") return require.apply(this, arguments);
	throw Error("Calling `require` for \"" + e + "\" in an environment that doesn't expose the `require` function. See https://rolldown.rs/in-depth/bundling-cjs#require-external-modules for more details.");
}), xt = (e) => /^https?:\/\//.test(e ?? ""), K = ({ href: e, children: t, ...n }) => {
	let r = i().locale ?? "en", a = xt(e.toString());
	return c(s, {
...
function $() {
	let e = Z("theme-toggle"), [n, i] = r("auto");
	t(() => {
		let e = $t();
		i(e), Q(e);
	}, []), t(() => {
	...
	let o = e(n === "auto" ? "themeModeAutoSystemClick" : n === "light" ? "themeModeLightClick" : "themeModeDarkClick");
	return c("button", {
		type: "button",
		onClick: a,
		"aria-label": o,
		...
		children: e(n === "auto" ? "themeAuto" : n === "dark" ? "themeDark" : "themeLight")
	});
}
//#endregion
...
function an() {
	...
	rn("Header");
	let [n, o] = r(!1), s = i().locale ?? "en", d = a(), f = [
		{
			href: `/${s}/products`,
			label: e("products")
		},
			...
			children: [l("div", {
				...
				children: [c(K, {
					...
					children: [
						c(K, {
							href: `/${s}`,
							className: `nav-link${p(`/${s}`) || p(`/${s}/`) ? " is-active" : ""}`,
							children: e("home")
						}),
						c(K, {
							href: `/${s}/about`,
							className: `nav-link${((e) => d.startsWith(e))(`/${s}/about`) ? " is-active" : ""}`,
...
function cn({ children: n, locale: r }) {
	return t(() => {
