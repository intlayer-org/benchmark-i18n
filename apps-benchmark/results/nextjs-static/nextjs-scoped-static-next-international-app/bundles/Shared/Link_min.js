...
import a from "../messages/fr/about.json";
import o from "../messages/fr/blog.json";
import s from "../messages/fr/careers.json";
import c from "../messages/fr/contact.json";
import l from "../messages/fr/faq.json";
import u from "../messages/fr/home.json";
import d from "../messages/fr/pricing.json";
import f from "../messages/fr/products.json";
import p from "../messages/fr/route.json";
import m from "../messages/fr/settings.json";
import h from "../messages/fr/shared.json";
import g from "../messages/fr/team.json";
import _ from "../messages/es/about.json";
import v from "../messages/es/blog.json";
import y from "../messages/es/careers.json";
import b from "../messages/es/contact.json";
import x from "../messages/es/faq.json";
import S from "../messages/es/home.json";
import C from "../messages/es/pricing.json";
import w from "../messages/es/products.json";
import T from "../messages/es/route.json";
import E from "../messages/es/settings.json";
import D from "../messages/es/shared.json";
import O from "../messages/es/team.json";
import k from "../messages/de/about.json";
import A from "../messages/de/blog.json";
import j from "../messages/de/careers.json";
import M from "../messages/de/contact.json";
import N from "../messages/de/faq.json";
import P from "../messages/de/home.json";
import F from "../messages/de/pricing.json";
import I from "../messages/de/products.json";
import L from "../messages/de/route.json";
import R from "../messages/de/settings.json";
import z from "../messages/de/shared.json";
import ee from "../messages/de/team.json";
import te from "../messages/it/about.json";
import ne from "../messages/it/blog.json";
import re from "../messages/it/careers.json";
import ie from "../messages/it/contact.json";
import ae from "../messages/it/faq.json";
import oe from "../messages/it/home.json";
import se from "../messages/it/pricing.json";
import B from "../messages/it/products.json";
import V from "../messages/it/route.json";
import H from "../messages/it/settings.json";
import U from "../messages/it/shared.json";
import W from "../messages/it/team.json";
import G from "../messages/pt/about.json";
import K from "../messages/pt/blog.json";
import ce from "../messages/pt/careers.json";
import le from "../messages/pt/contact.json";
...
var q = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), J = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
}), ft = (e) => /^https?:\/\//.test(e ?? ""), pt = ({ href: e, children: t, ...a }) => {
	let o = n().locale ?? "en", s = ft(e.toString());
	return i(r, {
	...
	f(g, { createI18nClient: () => z }), t.exports = h(g), mt();
...
var Mt = Z("de"), Nt = Z("en"), Pt = Z("es"), Q = Z("fr"), Ft = Z("it"), It = Z("ja"), Lt = Z("ko"), Rt = Z("pt"), zt = Z("ru"), Bt = Z("zh"), $ = (0, ht.createI18nClient)({
	en: () => Promise.resolve({ default: Nt }),
	fr: () => Promise.resolve({ default: Q }),
	...
	ja: () => Promise.resolve({ default: It }),
	ko: () => Promise.resolve({ default: Lt }),
	ru: () => Promise.resolve({ default: zt })
});
$.useScopedI18n;
var { I18nProviderClient: Vt, useChangeLocale: Ht, useCurrentLocale: Ut } = $;
//#endregion
...
function Kt({ children: n, locale: r }) {
	return t(() => {
