...
import B from "../messages/it/team.json";
import V from "../messages/pt/about.json";
import H from "../messages/pt/blog.json";
import U from "../messages/pt/careers.json";
import W from "../messages/pt/contact.json";
import G from "../messages/pt/faq.json";
import le from "../messages/pt/home.json";
import ue from "../messages/pt/pricing.json";
import de from "../messages/pt/products.json";
import fe from "../messages/pt/route.json";
import pe from "../messages/pt/settings.json";
import me from "../messages/pt/shared.json";
import he from "../messages/pt/team.json";
import ge from "../messages/zh/about.json";
import _e from "../messages/zh/blog.json";
import ve from "../messages/zh/careers.json";
import ye from "../messages/zh/contact.json";
import be from "../messages/zh/faq.json";
import xe from "../messages/zh/home.json";
import Se from "../messages/zh/pricing.json";
import Ce from "../messages/zh/products.json";
import we from "../messages/zh/route.json";
import Te from "../messages/zh/settings.json";
import Ee from "../messages/zh/shared.json";
import De from "../messages/zh/team.json";
import Oe from "../messages/ja/about.json";
import ke from "../messages/ja/blog.json";
import Ae from "../messages/ja/careers.json";
import je from "../messages/ja/contact.json";
import Me from "../messages/ja/faq.json";
import Ne from "../messages/ja/home.json";
import Pe from "../messages/ja/pricing.json";
import Fe from "../messages/ja/products.json";
import Ie from "../messages/ja/route.json";
import Le from "../messages/ja/settings.json";
import Re from "../messages/ja/shared.json";
import ze from "../messages/ja/team.json";
import Be from "../messages/ko/about.json";
import Ve from "../messages/ko/blog.json";
import He from "../messages/ko/careers.json";
import Ue from "../messages/ko/contact.json";
import We from "../messages/ko/faq.json";
import Ge from "../messages/ko/home.json";
import Ke from "../messages/ko/pricing.json";
import qe from "../messages/ko/products.json";
import Je from "../messages/ko/route.json";
import Ye from "../messages/ko/settings.json";
import Xe from "../messages/ko/shared.json";
import Ze from "../messages/ko/team.json";
import Qe from "../messages/ru/about.json";
import $e from "../messages/ru/blog.json";
import et from "../messages/ru/careers.json";
import tt from "../messages/ru/contact.json";
import nt from "../messages/ru/faq.json";
import rt from "../messages/ru/home.json";
import it from "../messages/ru/pricing.json";
import at from "../messages/ru/products.json";
import ot from "../messages/ru/route.json";
import st from "../messages/ru/settings.json";
import ct from "../messages/ru/shared.json";
import lt from "../messages/ru/team.json";
...
var q = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), J = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	f(g, { createI18nClient: () => z }), t.exports = h(g), ut();
...
var Ot = Z("de"), kt = Z("en"), At = Z("es"), jt = Z("fr"), Mt = Z("it"), Nt = Z("ja"), Pt = Z("ko"), Q = Z("pt"), Ft = Z("ru"), It = Z("zh"), $ = (0, dt.createI18nClient)({
	en: () => Promise.resolve({ default: kt }),
	fr: () => Promise.resolve({ default: jt }),
	es: () => Promise.resolve({ default: At }),
	de: () => Promise.resolve({ default: Ot }),
	it: () => Promise.resolve({ default: Mt }),
	pt: () => Promise.resolve({ default: Q }),
	zh: () => Promise.resolve({ default: It }),
	ja: () => Promise.resolve({ default: Nt }),
	ko: () => Promise.resolve({ default: Pt }),
	ru: () => Promise.resolve({ default: Ft })
}), Lt = $.useScopedI18n, { I18nProviderClient: Rt, useChangeLocale: zt, useCurrentLocale: Bt } = $, Vt = () => K("div", {
	className: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground",
	children: Lt("mock-banner")("mockBanner")
});
//#endregion
...
function Wt({ children: n, locale: r }) {
	return t(() => {
