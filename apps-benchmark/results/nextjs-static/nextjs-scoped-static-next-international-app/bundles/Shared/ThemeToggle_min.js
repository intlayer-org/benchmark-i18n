...
}), zt = Q.useScopedI18n, { I18nProviderClient: Bt, useChangeLocale: Vt, useCurrentLocale: Ht } = Q;
//#endregion
...
function Wt() {
	let e = zt("theme-toggle"), [r, i] = n("auto");
	t(() => {
		let e = Ut();
		i(e), $(e);
	}, []), t(() => {
	...
	let o = e(r === "auto" ? "themeModeAutoSystemClick" : r === "light" ? "themeModeLightClick" : "themeModeDarkClick");
	return G("button", {
		type: "button",
		onClick: a,
		"aria-label": o,
		...
		children: e(r === "auto" ? "themeAuto" : r === "dark" ? "themeDark" : "themeLight")
	});
}
//#endregion
