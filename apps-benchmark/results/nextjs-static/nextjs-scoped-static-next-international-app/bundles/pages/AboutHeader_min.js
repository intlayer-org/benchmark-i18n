...
import { Fragment as dt, jsx as K, jsxs as ft } from "react/jsx-runtime";
...
var jt = Z("de"), Mt = Z("en"), Nt = Z("es"), Pt = Z("fr"), Ft = Z("it"), It = Z("ja"), Lt = Z("ko"), Rt = Z("pt"), zt = Z("ru"), Bt = Z("zh"), Q = (0, mt.createI18nClient)({
...
function Gt() {
	let e = $("about-header");
	return Wt("AboutHeader"), ft(dt, { children: [K("h1", {
...
function Jt({ children: n, locale: r }) {
	return t(() => {
