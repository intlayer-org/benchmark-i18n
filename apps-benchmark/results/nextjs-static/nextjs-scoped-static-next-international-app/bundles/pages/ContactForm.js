	...
	return jsxs("form", {
		...
		children: [
			...
			jsxs("div", { children: [jsx("label", {
				...
				children: [
					jsx("option", { children: scopedT("bugReport") }),
					jsx("option", { children: scopedT("newBenchmarkIdea") }),
					jsx("option", { children: scopedT("methodologyQuestion") }),
					jsx("option", { children: scopedT("contribution") }),
					jsx("option", { children: scopedT("other") })
				]
			})] }),
			jsxs("div", { children: [jsx("label", {
				htmlFor: messageId,
