...
var At = Z("de"), jt = Z("en"), Mt = Z("es"), Nt = Z("fr"), Pt = Z("it"), Q = Z("ja"), Ft = Z("ko"), It = Z("pt"), Lt = Z("ru"), Rt = Z("zh"), $ = (0, pt.createI18nClient)({
...
}), zt = $.useScopedI18n, { I18nProviderClient: Bt, useChangeLocale: Vt, useCurrentLocale: Ht } = $;
//#endregion
//#region components/pages/contact/ContactForm.tsx
function Ut() {
	let e = zt("contact-form"), t = n(), r = n(), i = n(), a = n();
	return K("form", {
		className: "space-y-6",
		children: [
			K("div", {
			...
			K("div", { children: [G("label", {
				...
				children: [
					G("option", { children: e("bugReport") }),
					G("option", { children: e("newBenchmarkIdea") }),
					G("option", { children: e("methodologyQuestion") }),
					G("option", { children: e("contribution") }),
					G("option", { children: e("other") })
				]
			})] }),
			K("div", { children: [G("label", {
				htmlFor: a,
