...
import m from "../../../messages/es/about.json";
import h from "../../../messages/es/blog.json";
import g from "../../../messages/es/careers.json";
import _ from "../../../messages/es/contact.json";
import v from "../../../messages/es/faq.json";
import y from "../../../messages/es/home.json";
import b from "../../../messages/es/pricing.json";
import x from "../../../messages/es/products.json";
import S from "../../../messages/es/route.json";
import C from "../../../messages/es/settings.json";
import w from "../../../messages/es/shared.json";
import T from "../../../messages/es/team.json";
import E from "../../../messages/de/about.json";
import D from "../../../messages/de/blog.json";
import O from "../../../messages/de/careers.json";
import k from "../../../messages/de/contact.json";
import A from "../../../messages/de/faq.json";
import j from "../../../messages/de/home.json";
import M from "../../../messages/de/pricing.json";
import N from "../../../messages/de/products.json";
import P from "../../../messages/de/route.json";
import F from "../../../messages/de/settings.json";
import I from "../../../messages/de/shared.json";
import L from "../../../messages/de/team.json";
import R from "../../../messages/it/about.json";
import z from "../../../messages/it/blog.json";
import ee from "../../../messages/it/careers.json";
import te from "../../../messages/it/contact.json";
import ne from "../../../messages/it/faq.json";
import re from "../../../messages/it/home.json";
import ie from "../../../messages/it/pricing.json";
import ae from "../../../messages/it/products.json";
import oe from "../../../messages/it/route.json";
import se from "../../../messages/it/settings.json";
import ce from "../../../messages/it/shared.json";
import le from "../../../messages/it/team.json";
import ue from "../../../messages/pt/about.json";
import B from "../../../messages/pt/blog.json";
import V from "../../../messages/pt/careers.json";
import H from "../../../messages/pt/contact.json";
import U from "../../../messages/pt/faq.json";
import de from "../../../messages/pt/home.json";
import fe from "../../../messages/pt/pricing.json";
import pe from "../../../messages/pt/products.json";
import me from "../../../messages/pt/route.json";
import he from "../../../messages/pt/settings.json";
import ge from "../../../messages/pt/shared.json";
import _e from "../../../messages/pt/team.json";
import ve from "../../../messages/zh/about.json";
import ye from "../../../messages/zh/blog.json";
import be from "../../../messages/zh/careers.json";
import xe from "../../../messages/zh/contact.json";
import Se from "../../../messages/zh/faq.json";
import Ce from "../../../messages/zh/home.json";
import we from "../../../messages/zh/pricing.json";
import Te from "../../../messages/zh/products.json";
import Ee from "../../../messages/zh/route.json";
import De from "../../../messages/zh/settings.json";
import Oe from "../../../messages/zh/shared.json";
import ke from "../../../messages/zh/team.json";
import Ae from "../../../messages/ja/about.json";
import je from "../../../messages/ja/blog.json";
import Me from "../../../messages/ja/careers.json";
import Ne from "../../../messages/ja/contact.json";
import Pe from "../../../messages/ja/faq.json";
import Fe from "../../../messages/ja/home.json";
import Ie from "../../../messages/ja/pricing.json";
import Le from "../../../messages/ja/products.json";
import Re from "../../../messages/ja/route.json";
import ze from "../../../messages/ja/settings.json";
import Be from "../../../messages/ja/shared.json";
import Ve from "../../../messages/ja/team.json";
import He from "../../../messages/ko/about.json";
import Ue from "../../../messages/ko/blog.json";
import We from "../../../messages/ko/careers.json";
import Ge from "../../../messages/ko/contact.json";
import Ke from "../../../messages/ko/faq.json";
import qe from "../../../messages/ko/home.json";
import Je from "../../../messages/ko/pricing.json";
import Ye from "../../../messages/ko/products.json";
import Xe from "../../../messages/ko/route.json";
import Ze from "../../../messages/ko/settings.json";
import Qe from "../../../messages/ko/shared.json";
import $e from "../../../messages/ko/team.json";
import et from "../../../messages/ru/about.json";
import tt from "../../../messages/ru/blog.json";
import nt from "../../../messages/ru/careers.json";
import rt from "../../../messages/ru/contact.json";
import it from "../../../messages/ru/faq.json";
import at from "../../../messages/ru/home.json";
import ot from "../../../messages/ru/pricing.json";
import st from "../../../messages/ru/products.json";
import ct from "../../../messages/ru/route.json";
import lt from "../../../messages/ru/settings.json";
import ut from "../../../messages/ru/shared.json";
import dt from "../../../messages/ru/team.json";
import { Fragment as ft, jsx as W, jsxs as G } from "react/jsx-runtime";
//#region \0rolldown/runtime.js
var K = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), q = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	f(g, { createI18nClient: () => z }), t.exports = h(g), pt();
	var _ = q("next/navigation"), v = m(q("react")), y = (e, t = "") => Object.entries(e).reduce((e, [n, r]) => d(d({}, e), typeof r == "string" ? { [t + n]: r } : y(r, `${t}${n}.`)), {});
	function b(e, t) {
	...
	var T = q("react"), E = q("react"), D = q("react");
	function O(e, t) {
	...
	var F = q("next/navigation"), I = q("react"), L = "locale";
	function R(e, t) {
		return function() {
...
function Y(e, t) {
	...
	for (let [e, r] of Object.entries(t)) {
		let t = n[e];
		typeof r == "object" && r && !Array.isArray(r) && typeof t == "object" && t && !Array.isArray(t) ? n[e] = Y(t, r) : n[e] = r;
	}
	return n;
}
function kt(e) {
...
var jt = X("de"), Mt = X("en"), Nt = X("es"), Pt = X("fr"), Ft = X("it"), Z = X("ja"), It = X("ko"), Lt = X("pt"), Rt = X("ru"), zt = X("zh"), Q = (0, mt.createI18nClient)({
	en: () => Promise.resolve({ default: Mt }),
	fr: () => Promise.resolve({ default: Pt }),
	es: () => Promise.resolve({ default: Nt }),
	de: () => Promise.resolve({ default: jt }),
	it: () => Promise.resolve({ default: Ft }),
	pt: () => Promise.resolve({ default: Lt }),
	zh: () => Promise.resolve({ default: zt }),
	ja: () => Promise.resolve({ default: Z }),
	ko: () => Promise.resolve({ default: It }),
	ru: () => Promise.resolve({ default: Rt })
}), $ = Q.useScopedI18n, { I18nProviderClient: Bt, useChangeLocale: Vt, useCurrentLocale: Ht } = Q, Ut = () => W("div", {
...
function Wt() {
	let e = $("contact-header");
	return G(ft, { children: [
		W(Ut, {}),
		W("h1", {
...
function qt({ children: n, locale: r }) {
	return t(() => {
...
//#endregion
//#region components/pages/contact/ContactHeader.wrapper.tsx
function Xt() {
	return W(Yt, { children: W(Wt, {}) });
}
//#endregion
