...
var K = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), q = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	f(g, { createI18nClient: () => z }), t.exports = h(g), ft();
...
var At = X("de"), jt = X("en"), Mt = X("es"), Nt = X("fr"), Pt = X("it"), Ft = X("ja"), Z = X("ko"), It = X("pt"), Lt = X("ru"), Rt = X("zh"), Q = (0, pt.createI18nClient)({
	en: () => Promise.resolve({ default: jt }),
	fr: () => Promise.resolve({ default: Nt }),
	es: () => Promise.resolve({ default: Mt }),
	de: () => Promise.resolve({ default: At }),
	it: () => Promise.resolve({ default: Pt }),
	pt: () => Promise.resolve({ default: It }),
	zh: () => Promise.resolve({ default: Rt }),
	ja: () => Promise.resolve({ default: Ft }),
	ko: () => Promise.resolve({ default: Z }),
	ru: () => Promise.resolve({ default: Lt })
}), $ = Q.useScopedI18n, { I18nProviderClient: zt, useChangeLocale: Bt, useCurrentLocale: Vt } = Q;
//#endregion
//#region components/pages/home/WhyItMatters.tsx
function Ht() {
	let e = $("why-it-matters"), t = $("results-table");
	return G("section", {
		className: "mb-16",
		children: [W("h2", {
...
function Gt({ children: n, locale: r }) {
	return t(() => {
