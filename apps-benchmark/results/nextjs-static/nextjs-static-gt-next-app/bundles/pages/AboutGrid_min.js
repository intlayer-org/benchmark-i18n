	...
	return /* @__PURE__ */ r("div", {
		...
		children: [/* @__PURE__ */ r("div", {
			...
			children: [/* @__PURE__ */ n("h2", {
				...
				children: /* @__PURE__ */ n(p.T, { children: "Why This Exists" })
			}), /* @__PURE__ */ n("p", {
				className: "text-sm text-muted-foreground",
				children: /* @__PURE__ */ n(p.T, { children: "Choosing an i18n library is an architectural decision with long-term consequences. Most comparisons focus on API ergonomics, but few measure the performance cost: how much weight does the library add to the bundle? How does it affect rendering when thousands of translation keys are loaded? Does lazy loading actually help or just shift the cost? This benchmark answers those questions with real data." })
			})]
		}), /* @__PURE__ */ r("div", {
			className: "rounded-lg border border-border bg-card p-6",
			children: [/* @__PURE__ */ n("h2", {
				className: "mb-3 text-xl font-semibold text-foreground",
				children: /* @__PURE__ */ n(p.T, { children: "Methodology" })
			}), /* @__PURE__ */ n("p", {
				className: "text-sm text-muted-foreground",
				children: /* @__PURE__ */ n(p.T, { children: "The same 10-page app is built once per library. We measure the production bundle (via rollup-plugin-visualizer), run Lighthouse audits for loading metrics, and use React Profiler to capture render times during locale switches. All tests run in CI on consistent hardware to ensure reproducible results." })
			})]
		})]
	});
}
