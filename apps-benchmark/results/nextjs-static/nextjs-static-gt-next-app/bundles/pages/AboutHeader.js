...
function AboutHeader() {
	...
	return jsxs(Fragment, { children: [jsx("h1", {
		...
		children: jsx(import_index_client.T, { children: "About This Benchmark" })
	}), jsx("p", {
		className: "mb-8 max-w-3xl text-muted-foreground",
		children: jsx(import_index_client.T, { children: "This is an open-source test application — not a product or a company. Its sole purpose is to provide a realistic, multi-page React app where different i18n libraries can be integrated and measured under identical conditions." })
	})] });
}
//#endregion
