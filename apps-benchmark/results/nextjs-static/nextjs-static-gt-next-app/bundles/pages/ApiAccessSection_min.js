...
function h() {
	...
	return i("section", {
		...
		children: [r("h2", {
			...
			children: r(m.T, { children: "API Access" })
		}), i("div", { children: [
			r("label", {
				htmlFor: e,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: r(m.T, { children: "API Key" })
			}),
			i("div", {
				...
				children: [r("input", {
					...
					children: r(m.T, { children: "Copy" })
				})]
			}),
			r("p", {
				className: "mt-1 text-xs text-muted-foreground",
				children: r(m.T, { children: "Use this key to access the benchmarking API programmatically." })
			})
		] })]
	});
}
