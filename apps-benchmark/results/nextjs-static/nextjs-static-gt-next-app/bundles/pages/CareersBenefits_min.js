...
function m() {
	return /* @__PURE__ */ n("div", {
		...
		children: [
			{
				label: /* @__PURE__ */ n(p.T, { children: "Remote-first" }),
				value: /* @__PURE__ */ n(p.T, { children: "Work from anywhere in the world" })
			},
			{
				label: /* @__PURE__ */ n(p.T, { children: "Competitive pay" }),
				value: /* @__PURE__ */ n(p.T, { children: "Top-of-market compensation" })
			},
			{
				label: /* @__PURE__ */ n(p.T, { children: "Open source time" }),
				value: /* @__PURE__ */ n(p.T, { children: "20% time for OSS contributions" })
			}
