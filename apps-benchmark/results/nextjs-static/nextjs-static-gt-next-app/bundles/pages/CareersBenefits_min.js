...
function m() {
	return n("div", {
		...
		children: [
			{
				label: n(p.T, { children: "Remote-first" }),
				value: n(p.T, { children: "Work from anywhere in the world" })
			},
			{
				label: n(p.T, { children: "Competitive pay" }),
				value: n(p.T, { children: "Top-of-market compensation" })
			},
			{
				label: n(p.T, { children: "Open source time" }),
				value: n(p.T, { children: "20% time for OSS contributions" })
			}
		].map((e) => r("div", {
