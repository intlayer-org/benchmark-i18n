...
function CareersHeader() {
	return jsxs(Fragment, { children: [
		...
		jsx("h1", {
			...
			children: jsx(import_index_client.T, { children: "Careers" })
		}),
		jsx("p", {
			className: "mb-4 text-muted-foreground",
			children: jsx(import_index_client.T, { children: "Join our mission to improve the internationalization ecosystem. We're a remote-first team that values impact, transparency, and continuous learning." })
		})
	] });
}
//#endregion
