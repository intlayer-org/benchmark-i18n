...
${e.join("\n")}`;
	...
	children: /* @__PURE__ */ r(m.T, { children: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." })
});
//#endregion
...
function g() {
	return /* @__PURE__ */ i(n, { children: [
		...
		/* @__PURE__ */ r("h1", {
			...
			children: /* @__PURE__ */ r(m.T, { children: "Careers" })
		}),
		/* @__PURE__ */ r("p", {
			className: "mb-4 text-muted-foreground",
			children: /* @__PURE__ */ r(m.T, { children: "Join our mission to improve the internationalization ecosystem. We're a remote-first team that values impact, transparency, and continuous learning." })
		})
	] });
}
//#endregion
...
function y({ children: n, locale: i }) {
	return t(() => {
...
function S() {
	return /* @__PURE__ */ r(x, { children: /* @__PURE__ */ r(g, {}) });
}
//#endregion
export { S as default };
