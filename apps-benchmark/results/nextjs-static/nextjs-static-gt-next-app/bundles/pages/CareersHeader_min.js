...
${e.join("\n")}`;
	...
	children: r(m.T, { children: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." })
});
//#endregion
...
function g() {
	return i(n, { children: [
		...
		r("h1", {
			...
			children: r(m.T, { children: "Careers" })
		}),
		r("p", {
			className: "mb-4 text-muted-foreground",
			children: r(m.T, { children: "Join our mission to improve the internationalization ecosystem. We're a remote-first team that values impact, transparency, and continuous learning." })
		})
	] });
}
//#endregion
