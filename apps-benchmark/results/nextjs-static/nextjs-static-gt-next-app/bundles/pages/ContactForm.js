		...
		children: [
			jsxs("div", {
				...
				children: [jsxs("div", { children: [jsx("label", {
					...
					children: jsx(import_index_client.T, { children: "Name" })
				}), jsx("input", {
					id: nameId,
					...
					htmlFor: emailId,
					className: "mb-1 block text-sm font-medium text-foreground",
					children: jsx(import_index_client.T, { children: "Email" })
				}), jsx("input", {
					id: emailId,
					type: "email",
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			jsxs("div", { children: [jsx("label", {
				htmlFor: topicId,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: jsx(import_index_client.T, { children: "Topic" })
			}), jsxs("select", {
				id: topicId,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				children: [
					jsx("option", { children: jsx(import_index_client.T, { children: "Bug Report" }) }),
					jsx("option", { children: jsx(import_index_client.T, { children: "New Benchmark Idea" }) }),
					jsx("option", { children: jsx(import_index_client.T, { children: "Methodology Question" }) }),
					jsx("option", { children: jsx(import_index_client.T, { children: "Contribution" }) }),
					jsx("option", { children: jsx(import_index_client.T, { children: "Other" }) })
				]
			})] }),
			jsxs("div", { children: [jsx("label", {
				htmlFor: messageId,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: jsx(import_index_client.T, { children: "Message" })
			}), jsx("textarea", {
				id: messageId,
				rows: 5,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			jsx("button", {
				...
				children: jsx(import_index_client.T, { children: "Send Message" })
			})
		]
	});
}
