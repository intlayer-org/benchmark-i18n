	...
	return i("form", {
		...
		children: [
			...
			i("div", { children: [r("label", {
				htmlFor: a,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: r(m.T, { children: "Topic" })
			}), i("select", {
				id: a,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				children: [
					r("option", { children: r(m.T, { children: "Bug Report" }) }),
					r("option", { children: r(m.T, { children: "New Benchmark Idea" }) }),
					r("option", { children: r(m.T, { children: "Methodology Question" }) }),
					r("option", { children: r(m.T, { children: "Contribution" }) }),
					r("option", { children: r(m.T, { children: "Other" }) })
				]
			})] }),
			i("div", { children: [r("label", {
				htmlFor: o,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: r(m.T, { children: "Message" })
			}), r("textarea", {
				id: o,
				rows: 5,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			r("button", {
				...
				children: r(m.T, { children: "Send Message" })
			})
		]
	});
}
