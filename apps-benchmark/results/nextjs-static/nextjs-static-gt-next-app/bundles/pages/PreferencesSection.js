...
function PreferencesSection() {
	...
	return jsxs("section", {
		...
		children: [jsx("h2", {
			...
			children: jsx(import_index_client.T, { children: "Preferences" })
		}), jsxs("div", {
			className: "space-y-4",
			children: [
				jsxs("div", {
					...
					children: [jsxs("div", { children: [jsx("p", {
						...
						children: jsx(import_index_client.T, { children: "Email Notifications" })
					}), jsx("p", {
						className: "text-xs text-muted-foreground",
						children: jsx(import_index_client.T, { children: "Receive weekly benchmark reports" })
					})] }), jsx("button", {
						type: "button",
				...
				jsxs("div", {
					...
					children: [jsxs("div", { children: [jsx("p", {
						className: "text-sm font-medium text-foreground",
						children: jsx(import_index_client.T, { children: "Dark Mode" })
					}), jsx("p", {
						className: "text-xs text-muted-foreground",
						children: jsx(import_index_client.T, { children: "Use dark color scheme" })
					})] }), jsx("button", {
						type: "button",
				...
				jsxs("div", { children: [jsx("label", {
					...
					children: jsx(import_index_client.T, { children: "Default Language" })
				}), jsxs("select", {
					id: languageId,
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
					children: [
						jsx("option", { children: jsx(import_index_client.T, { children: "English (en)" }) }),
						jsx("option", { children: jsx(import_index_client.T, { children: "French (fr)" }) }),
						jsx("option", { children: jsx(import_index_client.T, { children: "German (de)" }) }),
						jsx("option", { children: jsx(import_index_client.T, { children: "Spanish (es)" }) }),
						jsx("option", { children: jsx(import_index_client.T, { children: "Japanese (ja)" }) }),
						jsx("option", { children: jsx(import_index_client.T, { children: "Chinese Simplified (zh-CN)" }) }),
						jsx("option", { children: jsx(import_index_client.T, { children: "Arabic (ar)" }) })
					]
				})] })
			]
		})]
