...
function h() {
	...
	return /* @__PURE__ */ i("section", {
		...
		children: [/* @__PURE__ */ r("h2", {
			...
			children: /* @__PURE__ */ r(m.T, { children: "Preferences" })
		}), /* @__PURE__ */ i("div", {
			className: "space-y-4",
			children: [
				/* @__PURE__ */ i("div", {
					className: "flex items-center justify-between",
					children: [/* @__PURE__ */ i("div", { children: [/* @__PURE__ */ r("p", {
						className: "text-sm font-medium text-foreground",
						children: /* @__PURE__ */ r(m.T, { children: "Email Notifications" })
					}), /* @__PURE__ */ r("p", {
						className: "text-xs text-muted-foreground",
						children: /* @__PURE__ */ r(m.T, { children: "Receive weekly benchmark reports" })
					})] }), /* @__PURE__ */ r("button", {
						type: "button",
						className: "h-6 w-11 rounded-full bg-primary transition-colors",
						"aria-label": "Toggle notifications",
						children: /* @__PURE__ */ r("span", { className: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" })
					})]
				}),
				/* @__PURE__ */ i("div", {
					className: "flex items-center justify-between",
					children: [/* @__PURE__ */ i("div", { children: [/* @__PURE__ */ r("p", {
						className: "text-sm font-medium text-foreground",
						children: /* @__PURE__ */ r(m.T, { children: "Dark Mode" })
					}), /* @__PURE__ */ r("p", {
						className: "text-xs text-muted-foreground",
						children: /* @__PURE__ */ r(m.T, { children: "Use dark color scheme" })
					})] }), /* @__PURE__ */ r("button", {
						type: "button",
						className: "h-6 w-11 rounded-full bg-muted transition-colors",
						"aria-label": "Toggle dark mode",
						children: /* @__PURE__ */ r("span", { className: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" })
					})]
				}),
				/* @__PURE__ */ i("div", { children: [/* @__PURE__ */ r("label", {
					htmlFor: e,
					className: "mb-1 block text-sm font-medium text-foreground",
					children: /* @__PURE__ */ r(m.T, { children: "Default Language" })
				}), /* @__PURE__ */ i("select", {
					id: e,
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
					children: [
						/* @__PURE__ */ r("option", { children: /* @__PURE__ */ r(m.T, { children: "English (en)" }) }),
						/* @__PURE__ */ r("option", { children: /* @__PURE__ */ r(m.T, { children: "French (fr)" }) }),
						/* @__PURE__ */ r("option", { children: /* @__PURE__ */ r(m.T, { children: "German (de)" }) }),
						/* @__PURE__ */ r("option", { children: /* @__PURE__ */ r(m.T, { children: "Spanish (es)" }) }),
						/* @__PURE__ */ r("option", { children: /* @__PURE__ */ r(m.T, { children: "Japanese (ja)" }) }),
						/* @__PURE__ */ r("option", { children: /* @__PURE__ */ r(m.T, { children: "Chinese Simplified (zh-CN)" }) }),
						/* @__PURE__ */ r("option", { children: /* @__PURE__ */ r(m.T, { children: "Arabic (ar)" }) })
					]
				})] })
			]
		})]
