...
function h() {
	...
	return i("section", {
		...
		children: [r("h2", {
			...
			children: r(m.T, { children: "Preferences" })
		}), i("div", {
			className: "space-y-4",
			children: [
				i("div", {
					...
					children: [i("div", { children: [r("p", {
						...
						children: r(m.T, { children: "Email Notifications" })
					}), r("p", {
						className: "text-xs text-muted-foreground",
						children: r(m.T, { children: "Receive weekly benchmark reports" })
					})] }), r("button", {
						type: "button",
				...
				i("div", {
					...
					children: [i("div", { children: [r("p", {
						className: "text-sm font-medium text-foreground",
						children: r(m.T, { children: "Dark Mode" })
					}), r("p", {
						className: "text-xs text-muted-foreground",
						children: r(m.T, { children: "Use dark color scheme" })
					})] }), r("button", {
						type: "button",
				...
				i("div", { children: [r("label", {
					...
					children: r(m.T, { children: "Default Language" })
				}), i("select", {
					id: e,
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
					children: [
						r("option", { children: r(m.T, { children: "English (en)" }) }),
						r("option", { children: r(m.T, { children: "French (fr)" }) }),
						r("option", { children: r(m.T, { children: "German (de)" }) }),
						r("option", { children: r(m.T, { children: "Spanish (es)" }) }),
						r("option", { children: r(m.T, { children: "Japanese (ja)" }) }),
						r("option", { children: r(m.T, { children: "Chinese Simplified (zh-CN)" }) }),
						r("option", { children: r(m.T, { children: "Arabic (ar)" }) })
					]
				})] })
			]
		})]
