...
function g() {
	return i(n, { children: [r(h, {}), i("div", {
		className: "mb-12 text-center",
		children: [r("h1", {
			className: "mb-3 text-3xl font-bold text-foreground",
			children: r(m.T, { children: "Simple, Transparent Pricing" })
		}), r("p", {
			className: "text-muted-foreground",
			children: r(m.T, { children: "Choose the plan that fits your team. No hidden fees." })
		})]
	})] });
}
//#endregion
