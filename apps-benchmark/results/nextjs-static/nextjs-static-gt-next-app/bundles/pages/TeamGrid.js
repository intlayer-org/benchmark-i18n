...
function TeamGrid() {
	return jsx("div", {
		...
		children: [
			{
				name: jsx(import_index_client.T, { children: "Sarah Chen" }),
				role: jsx(import_index_client.T, { children: "Founder & Lead Engineer" }),
				bio: jsx(import_index_client.T, { children: "Former Google engineer with 10 years of experience building internationalization systems at scale." })
			},
			{
				name: jsx(import_index_client.T, { children: "Marcus Weber" }),
				role: jsx(import_index_client.T, { children: "Performance Engineer" }),
				bio: jsx(import_index_client.T, { children: "Specializes in JavaScript performance optimization and benchmarking methodology. Previously at Vercel." })
			},
			{
				name: jsx(import_index_client.T, { children: "Aisha Patel" }),
				role: jsx(import_index_client.T, { children: "Developer Advocate" }),
				bio: jsx(import_index_client.T, { children: "Passionate about developer experience and education. Speaker at React Conf, JSConf, and i18nNext." })
			},
			{
				name: jsx(import_index_client.T, { children: "Tomás Rodríguez" }),
				role: jsx(import_index_client.T, { children: "Full-Stack Developer" }),
				bio: jsx(import_index_client.T, { children: "Maintains the benchmarking infrastructure and CI/CD pipeline. Open source contributor to Lingui." })
			},
			{
				name: jsx(import_index_client.T, { children: "Yuki Tanaka" }),
				role: jsx(import_index_client.T, { children: "Data Analyst" }),
				bio: jsx(import_index_client.T, { children: "Ensures statistical rigor in all benchmark results. PhD in Applied Statistics from MIT." })
			},
			{
				name: jsx(import_index_client.T, { children: "Elena Kowalski" }),
				role: jsx(import_index_client.T, { children: "Community Manager" }),
				bio: jsx(import_index_client.T, { children: "Manages community contributions, partnerships, and events. Background in open source governance." })
			}
		].map((m, i) => jsxs("div", {
