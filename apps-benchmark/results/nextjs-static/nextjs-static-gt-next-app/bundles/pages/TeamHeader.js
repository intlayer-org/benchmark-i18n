...
var MockBanner = () => jsx("div", {
	...
	children: jsx(import_index_client.T, { children: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." })
});
//#endregion
...
function TeamHeader() {
	return jsxs(Fragment, { children: [
		...
		jsx("h1", {
			...
			children: jsx(import_index_client.T, { children: "Our Team" })
		}),
		jsx("p", {
			className: "mb-10 text-muted-foreground",
			children: jsx(import_index_client.T, { children: "Meet the people behind i18n Benchmark. A diverse team united by a shared passion for great developer tools." })
		})
	] });
}
//#endregion
