...
function g() {
	return i(n, { children: [
		...
		r("h1", {
			...
			children: r(m.T, { children: "Our Team" })
		}),
		r("p", {
			className: "mb-10 text-muted-foreground",
			children: r(m.T, { children: "Meet the people behind i18n Benchmark. A diverse team united by a shared passion for great developer tools." })
		})
	] });
}
//#endregion
