...
function m() {
	return /* @__PURE__ */ r("section", {
		...
		children: [/* @__PURE__ */ n("h2", {
			...
			children: /* @__PURE__ */ n(p.T, { children: "What We Measure" })
		}), /* @__PURE__ */ n("ul", {
			className: "space-y-4",
			children: [
				{
					metric: /* @__PURE__ */ n(p.T, { children: "Bundle size impact" }),
					desc: /* @__PURE__ */ n(p.T, { children: "The additional JavaScript bytes sent to users when the i18n library and its translation files are included. This directly affects download time on slow networks." })
				},
				{
					metric: /* @__PURE__ */ n(p.T, { children: "Rendering overhead" }),
					desc: /* @__PURE__ */ n(p.T, { children: "How much extra time the library adds to React's render cycle. Libraries that inject translations via a single context provider can cause unnecessary re-renders across the component tree." })
				},
				{
					metric: /* @__PURE__ */ n(p.T, { children: "Hydration cost" }),
					desc: /* @__PURE__ */ n(p.T, { children: "During SSR, translation data is serialized into HTML. Large dictionaries increase the HTML payload and slow down hydration — the moment the page becomes interactive." })
				},
				{
					metric: /* @__PURE__ */ n(p.T, { children: "Lazy loading effectiveness" }),
					desc: /* @__PURE__ */ n(p.T, { children: "Whether splitting translations by route or namespace actually reduces the initial load, and what trade-offs it introduces (waterfall requests, FOUC, cache complexity)." })
				},
				{
					metric: /* @__PURE__ */ n(p.T, { children: "Locale switch speed" }),
					desc: /* @__PURE__ */ n(p.T, { children: "How fast the app can switch from one language to another at runtime — including fetching new translations, re-rendering components, and updating the DOM." })
				}
			].map((e) => /* @__PURE__ */ r("li", {
