...
function m() {
	return r("section", {
		...
		children: [n("h2", {
			...
			children: n(p.T, { children: "Why These Metrics Matter" })
		}), r("div", {
			...
			children: [
				r("div", {
					...
					children: [n("h3", {
						...
						children: n(p.T, { children: "Bundle Size" })
					}), n("p", {
						className: "text-sm text-muted-foreground",
						children: n(p.T, { children: "The bundle is the data shipped to every user across the globe. A larger bundle means longer download times — especially on slow 3G connections common in many regions. i18n libraries vary dramatically in their weight: from a few kilobytes to tens of kilobytes of runtime code, plus the translation files themselves." })
					})]
				}),
				r("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [n("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: n(p.T, { children: "Rendering & Hydration" })
					}), n("p", {
						className: "text-sm text-muted-foreground",
						children: n(p.T, { children: "Connecting a large JSON dictionary to every component creates a hidden dependency: any change in the translation context can trigger re-renders across the entire tree. During SSR hydration, parsing and attaching massive translation objects adds latency before the page becomes interactive — directly impacting Time to Interactive (TTI)." })
					})]
				}),
				r("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [n("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: n(p.T, { children: "Dynamic Loading" })
					}), n("p", {
						className: "text-sm text-muted-foreground",
						children: n(p.T, { children: "Loading all translations upfront overloads the initial payload. Dynamic (lazy) loading splits translations by route or namespace, sending only what the current page needs. However, lazy loading introduces its own trade-offs: waterfall requests, flash of untranslated content, and caching complexity. Measuring both strategies is essential." })
					})]
				})
			]
		})]
