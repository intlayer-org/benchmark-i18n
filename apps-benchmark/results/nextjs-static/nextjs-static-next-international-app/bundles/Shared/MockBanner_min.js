...
}), y = g(r), b = g(i), x = g(a), S = g(o), C = g(s), w = g(c), T = g(l), E = g(u), D = (0, h.createI18nClient)({
...
var { useScopedI18n: k, I18nProviderClient: A, useChangeLocale: j, useCurrentLocale: M } = D, N = () => d("div", {
	className: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground",
	children: O()("mockBanner")
});
//#endregion
...
function I({ children: n, locale: r }) {
	return t(() => {
