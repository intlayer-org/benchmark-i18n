	...
	return p("form", {
		...
		children: [
			...
			p("div", { children: [f("label", {
				...
				children: [
					f("option", { children: e("contact.contact-form.bugReport") }),
					f("option", { children: e("contact.contact-form.newBenchmarkIdea") }),
					f("option", { children: e("contact.contact-form.methodologyQuestion") }),
					f("option", { children: e("header.contact") }),
					f("option", { children: e("contact.contact-form.topicOther") })
				]
			})] }),
			p("div", { children: [f("label", {
				htmlFor: a,
