	...
	return i("form", {
		...
		children: [
			...
			i("div", { children: [r("label", {
				...
				children: [
					r("option", { children: e("contact.contact-form.bugReport") }),
					r("option", { children: e("contact.contact-form.newBenchmarkIdea") }),
					r("option", { children: e("contact.contact-form.methodologyQuestion") }),
					r("option", { children: e("header.contact") }),
					r("option", { children: e("contact.contact-form.topicOther") })
				]
			})] }),
			i("div", { children: [r("label", {
				htmlFor: s,
