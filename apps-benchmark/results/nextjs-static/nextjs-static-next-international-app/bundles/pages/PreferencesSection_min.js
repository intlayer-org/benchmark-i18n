...
function F() {
	...
	return p("section", {
		...
		children: [f("h2", {
			...
			children: e("settings.preferences-section.preferences")
		}), p("div", {
			className: "space-y-4",
			children: [
				p("div", {
					className: "flex items-center justify-between",
					children: [p("div", { children: [f("p", {
						...
						children: f("span", { className: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" })
					})]
				}),
				p("div", {
					className: "flex items-center justify-between",
					children: [p("div", { children: [f("p", {
						...
						children: f("span", { className: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" })
					})]
				}),
				p("div", { children: [f("label", {
					...
					children: [
						f("option", { children: e("settings.preferences-section.englishEn") }),
						f("option", { children: e("settings.preferences-section.frenchFr") }),
						f("option", { children: e("settings.preferences-section.germanDe") }),
						f("option", { children: e("settings.preferences-section.spanishEs") }),
						f("option", { children: e("settings.preferences-section.japaneseJa") }),
						f("option", { children: e("settings.preferences-section.chineseSimplifiedZhCn") }),
						f("option", { children: e("settings.preferences-section.arabicAr") })
					]
				})] })
			]
		})]
...
function R({ children: n, locale: r }) {
	return t(() => {
