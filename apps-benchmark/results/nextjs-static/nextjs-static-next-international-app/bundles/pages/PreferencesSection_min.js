		...
		children: [r("h2", {
			...
			children: [
				...
				i("div", { children: [r("label", {
					...
					children: [
						r("option", { children: e("settings.preferences-section.englishEn") }),
						r("option", { children: e("settings.preferences-section.frenchFr") }),
						r("option", { children: e("settings.preferences-section.germanDe") }),
						r("option", { children: e("settings.preferences-section.spanishEs") }),
						r("option", { children: e("settings.preferences-section.japaneseJa") }),
						r("option", { children: e("settings.preferences-section.chineseSimplifiedZhCn") }),
						r("option", { children: e("settings.preferences-section.arabicAr") })
					]
				})] })
			]
		})]
