...
function P() {
	let e = k();
	return f("section", { children: [d("h2", {
		className: "mb-6 text-2xl font-bold text-foreground",
		children: e("home.results-table.sampleResults")
	}), d("div", {
			...
			children: [d("thead", {
				...
				children: f("tr", { children: [
					d("th", {
						...
						children: e("home.results-table.libraryColumn")
					}),
					d("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: e("home.results-table.bundleSize")
					}),
					d("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: e("home.results-table.lookupTime")
					}),
					d("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: e("home.results-table.lazyLoading")
					})
				] })
			}), d("tbody", { children: [
				{
