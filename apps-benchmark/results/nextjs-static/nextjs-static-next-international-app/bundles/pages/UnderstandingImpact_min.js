...
var p = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), m = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	var n = Object.create, r = Object.defineProperty, i = Object.getOwnPropertyDescriptor, a = Object.getOwnPropertyNames, o = Object.getOwnPropertySymbols, s = Object.getPrototypeOf, c = Object.prototype.hasOwnProperty, l = Object.prototype.propertyIsEnumerable, u = (e, t, n) => t in e ? r(e, t, {
		...
		return e;
	}, g = (e, t, i) => (i = e == null ? {} : n(s(e)), p(t || !e || !e.__esModule ? r(i, "default", {
		value: e,
		enumerable: !0
	}) : i, e)), _ = (e) => p(r({}, "__esModule", { value: !0 }), e), v = {};
	f(v, { createI18nClient: () => V }), t.exports = _(v), h();
	var y = m("next/navigation"), b = g(m("react")), x = (e, t = "") => Object.entries(e).reduce((e, [n, r]) => d(d({}, e), typeof r == "string" ? { [t + n]: r } : x(r, `${t}${n}.`)), {});
	function S(e, t) {
	...
	var D = m("react"), O = m("react"), k = m("react");
	function A(e, t) {
	...
	var L = m("next/navigation"), R = m("react"), z = "locale";
	function B(e, t) {
		return function() {
...
function _(e, t = "") {
	...
	for (let r in e) {
		let i = t ? `${t}.${r}` : r;
		typeof e[r] == "object" && e[r] !== null ? Object.assign(n, _(e[r], i)) : n[i] = String(e[r]);
	}
	return n;
}
//#endregion
...
}), b = _(r), x = _(i), S = _(a), C = _(o), w = _(s), T = _(c), E = _(l), D = _(u), O = (0, g.createI18nClient)({
	en: () => Promise.resolve({ default: y }),
	fr: () => Promise.resolve({ default: x }),
	es: () => Promise.resolve({ default: b }),
	de: () => Promise.resolve({ default: v }),
	it: () => Promise.resolve({ default: S }),
	pt: () => Promise.resolve({ default: T }),
	zh: () => Promise.resolve({ default: D }),
	ja: () => Promise.resolve({ default: C }),
	ko: () => Promise.resolve({ default: w }),
	ru: () => Promise.resolve({ default: E })
});
function k() {
	return O.useI18n();
}
var { useScopedI18n: A, I18nProviderClient: j, useChangeLocale: M, useCurrentLocale: N } = O;
//#endregion
	...
	return f("section", {
		...
		children: [
			d("h2", {
				...
				children: e("home.understanding-impact.understandingTheImpact")
			}),
			f("div", {
				...
				children: [
					d("h3", {
						...
						children: e("home.understanding-impact.whyASingleLargeJson")
					}),
					d("p", {
						className: "text-sm text-muted-foreground",
						children: e("home.understanding-impact.manyI18nLibrariesStoreTranslations")
					}),
					f("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							d("li", { children: e("home.understanding-impact.theJsonMustBeParsed") }),
							d("li", { children: e("home.understanding-impact.contextBasedArchitecturesCanCause") }),
							d("li", { children: e("home.understanding-impact.duringServerSideRenderingThe") })
						]
					})
				]
			}),
			f("div", {
				...
				children: [
					d("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: e("home.understanding-impact.theTradeOffsOfDynamic")
					}),
					d("p", {
						className: "text-sm text-muted-foreground",
						children: e("home.understanding-impact.splittingTranslationsIntoPerRoute")
					}),
					f("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							f("li", { children: [d("strong", {
								...
								children: e("home.understanding-impact.waterfallRequests")
							}), e("home.understanding-impact.waterfallRequestsDetail")] }),
							f("li", { children: [d("strong", {
								className: "text-foreground",
								children: e("home.understanding-impact.flashOfUntranslatedContentFouc")
							}), e("home.understanding-impact.flashOfUntranslatedContentDetail")] }),
							f("li", { children: [d("strong", {
								className: "text-foreground",
								children: e("home.understanding-impact.cacheInvalidation")
							}), e("home.understanding-impact.cacheInvalidationDetail")] })
						]
					})
				]
			}),
			f("div", {
				...
				children: [d("h3", {
					className: "mb-2 text-lg font-semibold text-foreground",
					children: e("home.understanding-impact.whatThisBenchmarkMeasures")
				}), d("p", {
					className: "text-sm text-muted-foreground",
					children: e("home.understanding-impact.thisTestAppProvidesA")
				})]
			})
		]
	});
