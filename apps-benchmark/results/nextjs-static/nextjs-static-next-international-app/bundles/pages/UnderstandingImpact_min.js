			...
			r("div", {
				...
				children: [
					...
					r("ul", {
						...
						children: [
							n("li", { children: e("home.understanding-impact.theJsonMustBeParsed") }),
							n("li", { children: e("home.understanding-impact.contextBasedArchitecturesCanCause") }),
							n("li", { children: e("home.understanding-impact.duringServerSideRenderingThe") })
						]
					})
				]
			}),
...
function g({ children: r, locale: i }) {
	return t(() => {
