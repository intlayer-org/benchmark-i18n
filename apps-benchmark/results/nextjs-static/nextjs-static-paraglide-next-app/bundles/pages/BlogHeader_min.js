...
var O = () => "Blog", k = () => "Blog", A = () => "Blog", j = () => "Blog", M = () => "Blog", N = () => "Blog", P = () => "博客", F = () => "ブログ", I = () => "블로그", L = () => "Блог", R = ((e = {}, t = {}) => {
	let n = t.locale ?? y();
	return n === "en" ? O(e) : n === "fr" ? k(e) : n === "es" ? A(e) : n === "de" ? j(e) : n === "it" ? M(e) : n === "pt" ? N(e) : n === "zh" ? P(e) : n === "ja" ? F(e) : n === "ko" ? I(e) : L(e);
}), z = () => "Insights, tutorials, and analysis from the i18n community.", B = () => "Aperçus, tutoriels et analyses de la communauté i18n.", V = () => "Información, tutoriales y análisis de la comunidad i18n.", H = () => "Einblicke, Tutorials und Analysen aus der i18n-Community.", te = () => "Approfondimenti, tutorial e analisi dalla comunità i18n.", U = () => "Insights, tutoriais e análises da comunidade i18n.", W = () => "来自 i18n 社区的见解、教程和分析。", G = () => "i18nコミュニティからの洞察、チュートリアル、分析。", K = () => "i18n 커뮤니티의 인사이트, 튜토리얼 및 분석.", q = () => "Инсайты, руководства и анализ от сообщества i18n.", J = ((e = {}, t = {}) => {
	let n = t.locale ?? y();
