...
var O = () => "Get in Touch", k = () => "Contactez-nous", A = () => "Ponte en contacto", j = () => "Kontakt aufnehmen", M = () => "Mettiti in contatto", N = () => "Entre em contato", P = () => "联系我们", F = () => "お問い合わせ", I = () => "연락하기", L = () => "Свяжитесь с нами", R = ((e = {}, t = {}) => {
	let n = t.locale ?? y();
	return n === "en" ? O(e) : n === "fr" ? k(e) : n === "es" ? A(e) : n === "de" ? j(e) : n === "it" ? M(e) : n === "pt" ? N(e) : n === "zh" ? P(e) : n === "ja" ? F(e) : n === "ko" ? I(e) : L(e);
}), z = () => "Have ideas, found a bug, or want to contribute a benchmark? Reach out to us at", B = () => "Vous avez des idées, trouvé un bug ou voulez proposer un benchmark ? Contactez-nous à", V = () => "¿Tienes ideas, has encontrado un bug o quieres contribuir con un benchmark? Contáctanos en", H = () => "Haben Sie Ideen, einen Fehler gefunden oder möchten Sie einen Benchmark beisteuern? Kontaktieren Sie uns unter", te = () => "Hai idee, hai trovato un bug o vuoi contribuire con un benchmark? Contattaci all'indirizzo", U = () => "Tem ideias, encontrou um bug ou quer contribuir com um benchmark? Entre em contato conosco em", W = () => "有想法、发现了 Bug 或想贡献基准测试？请联系我们：", G = () => "アイデアがある、バグを見つけた、またはベンチマークを提供したいですか？こちらまでご連絡ください：", K = () => "아이디어가 있거나 버그를 발견했나요? 아니면 벤치마크를 기여하고 싶으신가요? 다음 주소로 연락주세요.", q = () => "Есть идеи, нашли баг или хотите предложить бенчмарк? Свяжитесь с нами по адресу", J = ((e = {}, t = {}) => {
	let n = t.locale ?? y();
