...
var faq_header1_frequentlyaskedquestions2 = ((inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_faq_header1_frequentlyaskedquestions2(inputs);
	...
	return ru_faq_header1_frequentlyaskedquestions2(inputs);
});
...
var faq_header1_everythingyouneedtoknow4 = ((inputs = {}, options = {}) => {
	const locale = options.locale ?? getLocale();
	if (locale === "en") return en_faq_header1_everythingyouneedtoknow4(inputs);
	...
	return ru_faq_header1_everythingyouneedtoknow4(inputs);
});
var en_mockbanner1 = () => {
