...
var O = () => "Frequently Asked Questions", k = () => "Foire aux questions", A = () => "Preguntas frecuentes", j = () => "Häufig gestellte Fragen", M = () => "Domande frequenti", N = () => "Perguntas Frequentes", P = () => "常见问题", F = () => "よくある質問", I = () => "자주 묻는 질문", L = () => "Часто задаваемые вопросы", R = ((e = {}, t = {}) => {
	let n = t.locale ?? y();
	return n === "en" ? O(e) : n === "fr" ? k(e) : n === "es" ? A(e) : n === "de" ? j(e) : n === "it" ? M(e) : n === "pt" ? N(e) : n === "zh" ? P(e) : n === "ja" ? F(e) : n === "ko" ? I(e) : L(e);
}), z = () => "Everything you need to know about i18n Benchmark.", B = () => "Tout ce que vous devez savoir sur i18n Benchmark.", V = () => "Todo lo que necesitas saber sobre i18n Benchmark.", H = () => "Alles, was Sie über i18n Benchmark wissen müssen.", te = () => "Tutto quello che c'è da sapere su i18n Benchmark.", U = () => "Tudo o que você precisa saber sobre o i18n Benchmark.", W = () => "关于 i18n Benchmark 您需要了解的一切。", G = () => "i18n Benchmarkについて知っておくべきすべてのこと。", K = () => "i18n Benchmark에 대해 알아야 할 모든 것.", q = () => "Все, что вам нужно знать об i18n Benchmark.", J = ((e = {}, t = {}) => {
	let n = t.locale ?? y();
