...
var O = () => "Products", k = () => "Produits", A = () => "Productos", j = () => "Produkte", M = () => "Prodotti", N = () => "Produtos", P = () => "产品", F = () => "製品", I = () => "제품", L = () => "Продукты", R = ((e = {}, t = {}) => {
	let n = t.locale ?? y();
	return n === "en" ? O(e) : n === "fr" ? k(e) : n === "es" ? A(e) : n === "de" ? j(e) : n === "it" ? M(e) : n === "pt" ? N(e) : n === "zh" ? P(e) : n === "ja" ? F(e) : n === "ko" ? I(e) : L(e);
}), z = () => "Tools and services to streamline your internationalization workflow.", B = () => "Des outils et services pour rationaliser votre flux de travail d'internationalisation.", V = () => "Herramientas y servicios para agilizar tu flujo de trabajo de internacionalización.", H = () => "Tools und Services zur Optimierung Ihres Internationalisierungs-Worflows.", te = () => "Strumenti e servizi per snellire il flusso di lavoro dell'internazionalizzazione.", U = () => "Ferramentas e serviços para agilizar seu fluxo de trabalho de internacionalização.", W = () => "简化国际化工作流程的工具和服务。", G = () => "国際化ワークフローを合理化するためのツールとサービス。", K = () => "국제화 워크플로우를 간소화하기 위한 도구 및 서비스.", q = () => "Инструменты и услуги для оптимизации рабочего процесса интернационализации.", J = ((e = {}, t = {}) => {
	let n = t.locale ?? y();
