	...
	return a("form", {
		...
		children: [
			...
			a("div", { children: [i("label", {
				...
				children: [
					i("option", { children: e.formatMessage({ id: "contact-form.bugReport" }) }),
					i("option", { children: e.formatMessage({ id: "contact-form.newBenchmarkIdea" }) }),
					i("option", { children: e.formatMessage({ id: "contact-form.methodologyQuestion" }) }),
					i("option", { children: e.formatMessage({ id: "contact-form.contribution" }) }),
					i("option", { children: e.formatMessage({ id: "contact-form.other" }) })
				]
			})] }),
			a("div", { children: [i("label", {
				htmlFor: s,
