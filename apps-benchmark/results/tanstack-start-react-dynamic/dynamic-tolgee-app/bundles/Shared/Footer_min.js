...
var Ze = { useSuspense: !1 }, Qe, $e = () => (Qe ||= t.createContext(void 0), Qe), Z = void 0, et = ({ tolgee: e, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
...
var Q = (e) => {
	let n = st(e);
	return Array.isArray(n) ? n.map((e, n) => t.createElement(t.Fragment, { key: n }, lt(e))) : lt(n);
}, ut = (e) => {
	...
	let { t: n } = at();
	return t.createElement(ut, Object.assign({ t: n }, e));
}, ft = qe().use(Je()).use(Ee()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: {
...
function mt() {
	let { t: e } = pt(), t = u({ strict: !1 }).locale ?? "en", n = [
		{
			...
			children: [f("div", {
				...
				children: [
					...
					f("div", { children: [d("h3", {
						...
						className: "space-y-1",
						children: n.map((e) => d("li", { children: e.isInternal ? d(l, {
							to: e.to,
							params: { locale: t },
