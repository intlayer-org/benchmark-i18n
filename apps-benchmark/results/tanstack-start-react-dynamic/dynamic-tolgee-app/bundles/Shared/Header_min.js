...
var tt = { useSuspense: !1 }, nt, rt = () => (nt ||= t.createContext(void 0), nt), X = void 0, it = ({ tolgee: e, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
	...
	c = et(e, u, d, !!s);
	let [f, p] = l(!c.isLoaded()), m = Object.assign(Object.assign({}, tt), r), h = rt();
...
var st = () => {
	...
	let { tolgee: n, options: i } = st(), o = k(e), s = A(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = ct(), f = c([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
var Z = (e) => {
	let n = dt(e);
	return Array.isArray(n) ? n.map((e, n) => t.createElement(t.Fragment, { key: n }, pt(e))) : pt(n);
}, mt = (e) => {
	...
	let { t: n } = lt();
	return t.createElement(mt, Object.assign({ t: n }, e));
}, gt = Ze().use(Qe()).use(Ae()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: {
