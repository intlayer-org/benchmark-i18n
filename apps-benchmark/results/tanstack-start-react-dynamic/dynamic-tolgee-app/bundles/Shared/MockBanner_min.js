...
}, N = (e) => Object.fromEntries(ae(e).entries()), P = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function z(e, t) {
	let n = R(ce, t?.initialOptions, e);
	return n.apiUrl = D(n.apiUrl), e?.fetch && (n.fetch = A(e.fetch)), {
		initialOptions: n,
...
function le(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return b(s.onError, (e) => new ie("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return b(s.onError, (e) => new re("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function E(e) {
		e && l.backends.push(e);
	}
	...
	let k = Object.freeze({
		...
		setStoredLanguage(e) {
			return b(s.onError, (e) => new ie("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function fe({ options: e }) {
	let t = ne(), n = B(!1, () => o.isFetching(), t.onFetchingChange.emit), r = B(!1, () => D.isLoading(), t.onLoadingChange.emit), i = ue(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = le(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, b, f, t), o = oe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var me = () => {
	let e = {
		...
		init(t) {
			let n = pe(R(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, H = 0, U = 1, he = 2, ge = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var G = 0, K = 1, q = 2, J = 3, Y = 4, _e = new Set([
	q,
	K,
	G
]), X = "'", ve = new Set([
...
function be(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case G:
			...
			break;
		case K:
			ve.has(i) ? (n = n.slice(0, -1) + i, t = q) : (n += i, t = G);
			break;
		case q:
			i === X ? t = G : (n += i, t = q);
			break;
...
var Ce = () => (e, t) => (t.setFinalFormatter(Se()), e), we = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Z = {};
(function(e) {
	function t(e, t) {
		var n;
...
(g = console.assert) == null || g.call(console, Te), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ee(e, t) {
	let n = (n) => {
...
function De({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var ke = "tolgee-in-context-tools.umd.min.js", Ae = "@tolgee/in-context-tools", je = "InContextTools", Me = "https://cdn.jsdelivr.net/npm";
function Ne(e) {
...
var Pe = null;
function Fe(e) {
	return Pe ||= Ne(`${Me}/@tolgee/web@${e}/dist/${ke}`).then(() => window[Ae][je]), Pe;
}
...
var qe = { useSuspense: !1 }, Je, Ye = () => (Je ||= t.createContext(void 0), Je), Q = void 0, Xe = ({ tolgee: e, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
		Q?.run !== e.run && (Q && Q.stop(), Q = e, e.run().catch((e) => {
			console.error(e);
		}).finally(() => {
			p(!1);
		}));
...
var $e = () => {
	...
	let { tolgee: n, options: i } = $e(), o = C(e), c = w(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = et(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
var rt = (e) => {
	...
	return Object.entries(e || {}).forEach(([e, r]) => {
		if (typeof r == "function") n[e] = (e) => r($(e));
		else if (t.isValidElement(r)) {
			let i = r;
			n[e] = (e) => i.props.children === void 0 && e?.length ? t.cloneElement(i, {}, $(e)) : t.cloneElement(i);
		} else n[e] = r;
	}), n;
};
function it(e) {
...
var $ = (e) => {
	let n = nt(e);
	return Array.isArray(n) ? n.map((e, n) => t.createElement(t.Fragment, { key: n }, it(e))) : it(n);
}, at = (e) => {
	let n = e.keyName || e.children;
	n === void 0 && console.error("T component: keyName not defined");
	let r = e.defaultValue || (e.keyName ? e.children : void 0), i = $(e.t({
		key: n,
		params: rt(e.params),
		defaultValue: r,
		noWrap: e.noWrap,
	...
	let { t: n } = tt();
	return t.createElement(at, Object.assign({ t: n }, e));
}, st = Ue().use(We()).use(Ce()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: {
