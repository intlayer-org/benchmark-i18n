...
var Ye = { useSuspense: !1 }, Xe, Ze = () => (Xe ||= t.createContext(void 0), Xe), X = void 0, Qe = ({ tolgee: e, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
...
var tt = () => {
	...
	let { tolgee: n, options: i } = tt(), o = C(e), c = w(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = nt(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
