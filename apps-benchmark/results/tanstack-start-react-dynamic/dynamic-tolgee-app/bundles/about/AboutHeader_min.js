...
}, P = (e) => Object.fromEntries(se(e).entries()), F = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function B(e, t) {
	let n = z(ue, t?.initialOptions, e);
	return n.apiUrl = ee(n.apiUrl), e?.fetch && (n.fetch = A(e.fetch)), {
		initialOptions: n,
...
function de(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return C(s.onError, (e) => new N("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
	...
	let k = Object.freeze({
		...
		setStoredLanguage(e) {
			return C(s.onError, (e) => new N("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function me({ options: e }) {
	let t = ae(), n = V(!1, () => o.isFetching(), t.onFetchingChange.emit), r = V(!1, () => T.isLoading(), t.onLoadingChange.emit), i = fe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = de(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = ce(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var ge = () => {
	...
	return t;
}, U = 0, W = 1, _e = 2, ve = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var K = 0, q = 1, J = 2, Y = 3, X = 4, ye = new Set([
	J,
	q,
	K
]), Z = "'", be = new Set([
...
function Se(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case K:
			...
			break;
		case q:
			be.has(i) ? (n = n.slice(0, -1) + i, t = J) : (n += i, t = K);
			break;
		case J:
			i === Z ? t = K : (n += i, t = J);
			break;
...
(y = console.assert) == null || y.call(console, Oe), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function ke(e, t) {
	let n = (n) => {
...
var Xe = { useSuspense: !1 }, Ze, Qe = () => (Ze ||= t.createContext(void 0), Ze), Q = void 0, $e = ({ tolgee: e, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
	...
	c = Ye(e, u, d, !!s);
	let [f, p] = l(!c.isLoaded()), m = Object.assign(Object.assign({}, Xe), r), h = Qe();
...
var nt = () => {
	...
	let { tolgee: n, options: i } = nt(), o = E(e), s = D(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = rt(), f = c([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
