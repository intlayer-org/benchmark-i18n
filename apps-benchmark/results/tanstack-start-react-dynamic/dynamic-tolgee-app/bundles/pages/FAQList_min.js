...
function fe({ options: e }) {
	let t = re(), n = V(!1, () => o.isFetching(), t.onFetchingChange.emit), r = V(!1, () => E.isLoading(), t.onLoadingChange.emit), i = ue(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = le(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = oe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var G = 0, K = 1, q = 2, J = 3, Y = 4, ve = new Set([
	q,
	K,
	G
]), X = "'", ye = new Set([
...
function xe(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case G:
			...
			break;
		case K:
			ye.has(i) ? (n = n.slice(0, -1) + i, t = q) : (n += i, t = G);
			break;
		case q:
			i === X ? t = G : (n += i, t = q);
			break;
		case J:
			i === "}" ? (d(), t = G) : _e(i) ? r !== "" && (d(), t = Y) : (u(), t = J);
			break;
		case Y: i == "}" ? t = G : _e(i) ? t = Y : c(W);
	}
...
var we = () => (e, t) => (t.setFinalFormatter(Ce()), e), Te = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Z = {};
(function(e) {
	function t(e, t) {
		var n;
...
var Q = null;
function Fe(e) {
	return Q ||= Pe(`${Ne}/@tolgee/web@${e}/dist/${Ae}`).then(() => window[je][Me]), Q;
}
var Ie = "__tolgee_apiKey", Le = "__tolgee_apiUrl", Re = "__tolgee_branch";
function ze() {
	let e = sessionStorage.getItem(Ie) || void 0, t = sessionStorage.getItem(Le) || void 0, n = sessionStorage.getItem(Re) || void 0;
	if (!(!e || !t)) return g({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Be() {
	sessionStorage.removeItem(Ie), sessionStorage.removeItem(Le), sessionStorage.removeItem(Re);
}
function Ve(e) {
...
var qe = { useSuspense: !1 }, Je, Ye = () => (Je ||= t.createContext(void 0), Je), $ = void 0, Xe = ({ tolgee: e, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
	...
	l = Ke(e, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, qe), r), h = Ye();
...
var $e = () => {
	...
	let { tolgee: n, options: i } = $e(), o = w(e), c = T(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = et(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
	...
	let { t: n, isLoading: i } = tt(e, t);
	return {
		t: r((...e) => n(H(...e)), [n]),
		isLoading: i
	};
}, rt = Ue().use(We()).use(we()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: {
