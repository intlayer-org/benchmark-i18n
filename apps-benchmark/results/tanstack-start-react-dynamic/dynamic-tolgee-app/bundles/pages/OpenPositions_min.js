...
var Ye = { useSuspense: !1 }, Xe, Ze = () => (Xe ||= t.createContext(void 0), Xe), Q = void 0, Qe = ({ tolgee: e, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
...
var $ = (e) => {
	let n = at(e);
	return Array.isArray(n) ? n.map((e, n) => t.createElement(t.Fragment, { key: n }, st(e))) : st(n);
}, ct = (e) => {
	...
	let { t: n } = rt();
	return t.createElement(ct, Object.assign({ t: n }, e));
}, ut = Ge().use(Ke()).use(Te()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: {
