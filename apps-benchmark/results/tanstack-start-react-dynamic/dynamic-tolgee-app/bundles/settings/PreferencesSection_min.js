...
var Xe = { useSuspense: !1 }, Ze, Qe = () => (Ze ||= t.createContext(void 0), Ze), Z = void 0, $e = ({ tolgee: e, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
...
var nt = () => {
	...
	let { tolgee: n, options: i } = nt(), o = T(e), s = E(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = rt(), f = c([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
var Q = (e) => {
	let n = ot(e);
	return Array.isArray(n) ? n.map((e, n) => t.createElement(t.Fragment, { key: n }, ct(e))) : ct(n);
}, lt = (e) => {
	...
	let { t: n } = it();
	return t.createElement(lt, Object.assign({ t: n }, e));
}, dt = Ke().use(qe()).use(Te()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: {
