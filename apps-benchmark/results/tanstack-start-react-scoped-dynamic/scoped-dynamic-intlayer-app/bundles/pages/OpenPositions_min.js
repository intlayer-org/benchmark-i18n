...
//#region .intlayer/dynamic_dictionary/open-positions.mjs
var f = {
	de: () => import("../../../../.intlayer/dynamic_dictionary/json/open-positions/de.json").then((e) => e.default),
	en: () => import("./en-CegqIoQB.js").then((e) => e.default),
...
function ye() {
	...
	return /* @__PURE__ */ d(l, { children: [/* @__PURE__ */ u("h2", {
