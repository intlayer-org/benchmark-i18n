			...
			children: [jsxs("div", {
				...
				children: [
					jsxs("div", { children: [jsx("h3", {
						...
						children: jsx(MemoizedFormattedMessage, { id: "footer.anOpenSourceTestApplication" })
					})] }),
					jsxs("div", { children: [jsx("h3", {
						className: "mb-2 text-sm font-semibold text-foreground",
						children: jsx(MemoizedFormattedMessage, { id: "footer.resources" })
					}), jsx("ul", {
						className: "space-y-1",
						children: [
							{
							...
							children: jsx(MemoizedFormattedMessage, { id: linkEl.id })
						}) : jsx("a", {
							href: linkEl.href,
							target: "_blank",
							rel: "noreferrer",
					...
					jsxs("div", { children: [jsx("h3", {
						className: "mb-2 text-sm font-semibold text-foreground",
						children: jsx(MemoizedFormattedMessage, { id: "footer.contact" })
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
				...
				children: jsx(MemoizedFormattedMessage, { id: "footer.builtWith" })
			})]
		})
	});
}
