import e, { cloneElement as t, createContext as n, isValidElement as r, use as i, useContext as a, useEffect as o, useMemo as s, useState as c } from "react";
import { jsx as l } from "react/jsx-runtime";
//#region ../../../node_modules/.bun/@formatjs+fast-memoize@3.1.1/node_modules/@formatjs/fast-memoize/index.js
function u(e, t) {
	let n = t && t.cache ? t.cache : re, r = t && t.serializer ? t.serializer : g;
...
function b(e, t) {
	return ae(((...t) => new e(...t)), t);
}
function oe(e) {
	return {
		getDateTimeFormat: b(Intl.DateTimeFormat, e.dateTime),
		getNumberFormat: b(Intl.NumberFormat, e.number),
		getPluralRules: b(Intl.PluralRules, e.pluralRules),
		getRelativeTimeFormat: b(Intl.RelativeTimeFormat, e.relativeTime),
		getListFormat: b(Intl.ListFormat, e.list),
		getDisplayNames: b(Intl.DisplayNames, e.displayNames)
	};
}
//#endregion
...
var x = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, S = /^(@+)?(\+|#+)?[rs]?$/g, fe = /(\*)(0+)|(#+)(0+)|(0+)/g, C = /^(0+)$/;
function w(e) {
	let t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(S, function(e, n, r) {
	...
	for (let n of e) {
		switch (n.stem) {
			...
			case "integer-width":
				...
				n.options[0].replace(fe, function(e, n, r, i, a, o) {
		...
		if (x.test(n.stem)) {
			...
			n.stem.replace(x, function(e, n, r, i, a, o) {
...
var we = !!Object.fromEntries, Te = !!String.prototype.trimStart, Ee = !!String.prototype.trimEnd, z = we ? Object.fromEntries : function(e) {
	let t = {};
	...
	return e.replace(Ce, "");
}, B = /* @__PURE__ */ RegExp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
function ke(e, t) {
	return B.lastIndex = t, B.exec(e)[1] ?? "";
}
var Ae = class {
	message;
	position;
	...
	parseTag(e, t) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !V(this.char())) return this.error(F.INVALID_TAG, R(o, this.clonePosition()));
				let e = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					...
					err: null
				} : this.error(F.INVALID_TAG, R(o, this.clonePosition()))) : this.error(F.UNMATCHED_CLOSING_TAG, R(e, this.clonePosition()));
			} else return this.error(F.UNCLOSED_TAG, R(n, this.clonePosition()));
		} else return this.error(F.INVALID_TAG, R(n, this.clonePosition()));
	}
	parseTagName() {
		let e = this.offset();
	...
	parseArgument(e, t) {
		let n = this.clonePosition();
		if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(F.EXPECT_ARGUMENT_CLOSING_BRACE, R(n, this.clonePosition()));
		if (this.char() === 125) return this.bump(), this.error(F.EMPTY_ARGUMENT, R(n, this.clonePosition()));
		let r = this.parseIdentifierIfPossible().value;
		if (!r) return this.error(F.MALFORMED_ARGUMENT, R(n, this.clonePosition()));
		if (this.bumpSpace(), this.isEOF()) return this.error(F.EXPECT_ARGUMENT_CLOSING_BRACE, R(n, this.clonePosition()));
		switch (this.char()) {
			...
			case 44: return this.bump(), this.bumpSpace(), this.isEOF() ? this.error(F.EXPECT_ARGUMENT_CLOSING_BRACE, R(n, this.clonePosition())) : this.parseArgumentOptions(e, t, r, n);
			default: return this.error(F.MALFORMED_ARGUMENT, R(n, this.clonePosition()));
		}
	}
	...
	parseArgumentOptions(e, t, n, r) {
		...
		switch (a) {
			case "": return this.error(F.EXPECT_ARGUMENT_TYPE, R(i, o));
			case "number":
			case "date":
			case "time": {
				this.bumpSpace();
				...
				if (this.bumpIf(",")) {
					...
					if (n.err) return n;
					let r = Oe(n.val);
					if (r.length === 0) return this.error(F.EXPECT_ARGUMENT_STYLE, R(this.clonePosition(), this.clonePosition()));
					e = {
						style: r,
						styleLocation: R(t, this.clonePosition())
					};
				}
				let t = this.tryParseArgumentClose(r);
				if (t.err) return t;
				let i = R(r, this.clonePosition());
				if (e && e.style.startsWith("::")) {
					...
					if (a === "number") {
						...
						if (t.length === 0) return this.error(F.EXPECT_DATE_TIME_SKELETON, i);
						let r = t;
			...
			case "select": {
				...
				if (this.bumpSpace(), !this.bumpIf(",")) return this.error(F.EXPECT_SELECT_ARGUMENT_OPTIONS, R(i, { ...i }));
				this.bumpSpace();
				let o = this.parseIdentifierIfPossible(), s = 0;
				if (a !== "select" && o.value === "offset") {
					if (!this.bumpIf(":")) return this.error(F.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, R(this.clonePosition(), this.clonePosition()));
					this.bumpSpace();
					let e = this.tryParseDecimalInteger(F.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, F.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);
					if (e.err) return e;
			...
			default: return this.error(F.INVALID_ARGUMENT_TYPE, R(i, o));
		}
	}
	tryParseArgumentClose(e) {
		return this.isEOF() || this.char() !== 125 ? this.error(F.EXPECT_ARGUMENT_CLOSING_BRACE, R(e, this.clonePosition())) : (this.bump(), {
			val: !0,
			err: null
		});
	}
	parseSimpleArgStyleIfPossible() {
		...
		for (; !this.isEOF();) switch (this.char()) {
			case 39: {
				this.bump();
				let e = this.clonePosition();
				if (!this.bumpUntil("'")) return this.error(F.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, R(e, this.clonePosition()));
				this.bump();
				break;
			}
			case 123:
	...
	tryParsePluralOrSelectOptions(e, t, n, r) {
		...
		for (;;) {
			if (s.length === 0) {
				...
				if (t !== "select" && this.bumpIf("=")) {
					let t = this.tryParseDecimalInteger(F.EXPECT_PLURAL_ARGUMENT_SELECTOR, F.INVALID_PLURAL_ARGUMENT_SELECTOR);
					if (t.err) return t;
					c = R(e, this.clonePosition()), s = this.message.slice(e.offset, this.offset());
				} else break;
			}
			if (o.has(s)) return this.error(t === "select" ? F.DUPLICATE_SELECT_ARGUMENT_SELECTOR : F.DUPLICATE_PLURAL_ARGUMENT_SELECTOR, c);
			s === "other" && (i = !0), this.bumpSpace();
			let r = this.clonePosition();
			if (!this.bumpIf("{")) return this.error(t === "select" ? F.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT : F.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT, R(this.clonePosition(), this.clonePosition()));
		...
		return a.length === 0 ? this.error(t === "select" ? F.EXPECT_SELECT_ARGUMENT_SELECTOR : F.EXPECT_PLURAL_ARGUMENT_SELECTOR, R(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !i ? this.error(F.MISSING_OTHER_CLAUSE, R(this.clonePosition(), this.clonePosition())) : {
			val: a,
			err: null
		};
	}
...
function H(e) {
	e.forEach((e) => {
		if (delete e.location, j(e) || M(e)) for (let t in e.options) delete e.options[t].location, H(e.options[t].value);
		else k(e) && ye(e.style) || (A(e) || _e(e)) && P(e.style) ? delete e.style.location : N(e) && H(e.children);
	});
}
function Pe(e, t = {}) {
	t = {
	...
	if (n.err) {
		let e = SyntaxError(F[n.err.kind]);
...
function q(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (A(c)) {
			let e = typeof c.style == "string" ? r.date[c.style] : P(c.style) ? c.style.parsedOptions : void 0;
			s.push({
				type: K.literal,
		...
		if (_e(c)) {
			let e = typeof c.style == "string" ? r.time[c.style] : P(c.style) ? c.style.parsedOptions : r.time.medium;
			s.push({
				type: K.literal,
				value: n.getDateTimeFormat(t, e).format(l)
			});
		...
		if (N(c)) {
			...
			if (!Re(u)) throw new Fe(l, "function", o);
		...
		if (j(c)) {
			...
			if (!a) throw new G(c.value, l, Object.keys(c.options), o);
...
//#endregion
//#region ../../../node_modules/.bun/use-intl@4.9.1+3f10a4be4e334a9b/node_modules/use-intl/dist/esm/production/format-message/index.js
function He(...[e, t, n, i]) {
	if (Array.isArray(t)) throw new v(y.INVALID_MESSAGE, void 0);
	if (typeof t == "object") throw new v(y.INSUFFICIENT_PATH, void 0);
	if (typeof t == "string") {
		let e = function(e, t) {
	...
	try {
		...
		throw new v(y.INVALID_MESSAGE, void 0);
	}
	let f = d.format(n);
...
He.raw = !0;
//#endregion
//#region ../../../node_modules/.bun/use-intl@4.9.1+3f10a4be4e334a9b/node_modules/use-intl/dist/esm/production/initializeConfig-Brh10fyG.js
function X(...e) {
...
function Ge(e) {
	let n = function(e, t, n) {
		try {
			...
			return new v(y.MISSING_MESSAGE, e.message);
		}
	}(e.locale, e.messages, e.namespace);
	return function({ cache: e, formats: n, formatters: i, getMessageFallback: a = Ue, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		let d = s instanceof v;
		function f(e, t, n, r) {
			let i = new v(t, n);
			return l(i), r ?? a({
				error: i,
		...
		function p(p, m, ee, te) {
			...
			if (d) {
				...
				try {
					...
					if (!h) return f(p, y.MISSING_MESSAGE, e.message, h);
					g = h;
				}
			}
			try {
				return He(X(c, p), g, m && function(e) {
					let n = {};
				...
				let t, n;
				return e instanceof v ? (t = e.code, n = e.originalMessage) : (t = y.FORMATTING_ERROR, n = e.message), f(p, t, n, h);
			}
		}
		function m(e, t, n, r) {
			let i = p(e, t, n, r);
			return typeof i == "string" ? i : f(e, y.INVALID_MESSAGE, void 0);
		}
		return m.rich = p, m.markup = (e, t, n, r) => p(e, t, n, r), m.raw = (e) => {
			...
			try {
				...
				return f(e, y.MISSING_MESSAGE, t.message);
			}
		}, m.has = (e) => {
			if (d) return !1;
			try {
...
var qe = 86400;
7 * qe, 365 * qe;
function Je({ formats: e, getMessageFallback: t, messages: n, onError: r, ...i }) {
	return {
		...i,
		formats: e || void 0,
		messages: n || void 0,
		onError: r || We,
		getMessageFallback: t || Ue
	};
}
//#endregion
//#region ../../../node_modules/.bun/use-intl@4.9.1+3f10a4be4e334a9b/node_modules/use-intl/dist/esm/production/react.js
var Q = n(void 0);
function Ye({ children: e, formats: t, getMessageFallback: n, locale: r, messages: i, now: o, onError: c, timeZone: u }) {
	let d = a(Q), f = s((() => d?.cache || ie()), [r, d?.cache]), p = s((() => d?.formatters || oe(f)), [f, d?.formatters]), m = s((() => ({
		...Je({
			locale: r,
...
var Ze = !1, Qe = typeof window > "u";
function $e(e) {
	return function(e, t, n) {
		let { cache: r, formats: i, formatters: a, getMessageFallback: o, locale: c, onError: l, timeZone: u } = Xe(), d = e[n], f = Ke(t, n);
		return u || Ze || !Qe || (Ze = !0, l(new v(y.ENVIRONMENT_FALLBACK, void 0))), s((() => Ge({
			cache: r,
			formatters: a,
...
function tt() {
	let e = $e("theme-toggle"), [t, n] = c("auto");
	o(() => {
		let e = et();
		n(e), $(e);
	}, []), o(() => {
...
async function rt(e, t = ["shared", "route"]) {
	let n = {};
	for (let r of t) try {
		let t = await nt(Object.assign({
			"../messages/de/about.ts": () => import("./about-BsMjtSkV.js"),
			"../messages/de/blog.ts": () => import("./blog-B6DMV5pe.js"),
			"../messages/de/careers.ts": () => import("./careers-B_vQSbG_.js"),
			"../messages/de/contact.ts": () => import("./contact-ECODkqLL.js"),
			"../messages/de/faq.ts": () => import("./faq-BIzSFvPq.js"),
			"../messages/de/home.ts": () => import("./home-8Xl2ybay.js"),
			"../messages/de/pricing.ts": () => import("./pricing-D9iiIRVC.js"),
			"../messages/de/products.ts": () => import("./products-CEjeGwm1.js"),
			"../messages/de/route.ts": () => import("./route-CqGzJjiz.js"),
			"../messages/de/settings.ts": () => import("./settings-BKsvr93r.js"),
			"../messages/de/shared.ts": () => import("./shared-DD8fkaex.js"),
			"../messages/de/team.ts": () => import("./team-x0Fkd8cB.js"),
			"../messages/en/about-grid.ts": () => import("./about-grid-CFoZyphX.js"),
			"../messages/en/about-header.ts": () => import("./about-header-CT1EdKsV.js"),
			"../messages/en/about.ts": () => import("./about-kzxpdhTV.js"),
			"../messages/en/blog-header.ts": () => import("./blog-header-DhsdzqlN.js"),
			"../messages/en/blog-list.ts": () => import("./blog-list-D_WWkuFq.js"),
			"../messages/en/blog.ts": () => import("./blog-GdqMorXm.js"),
			"../messages/en/careers-benefits.ts": () => import("./careers-benefits-D9tj4Xh4.js"),
			"../messages/en/careers-header.ts": () => import("./careers-header-skaAv5MH.js"),
			"../messages/en/careers.ts": () => import("./careers-BqNLfJcd.js"),
			"../messages/en/contact-form.ts": () => import("./contact-form-DDYecjeT.js"),
			"../messages/en/contact-header.ts": () => import("./contact-header-Dxhz9Yqe.js"),
			"../messages/en/contact.ts": () => import("./contact-qENYWAkR.js"),
			"../messages/en/faq-header1.ts": () => import("./faq-header1-CUqRYsz3.js"),
			"../messages/en/faq-list.ts": () => import("./faq-list-73-6heoM.js"),
			"../messages/en/faq.ts": () => import("./faq-wTqIt7tI.js"),
			"../messages/en/footer.ts": () => import("./footer-DaKg1R-2.js"),
			"../messages/en/header.ts": () => import("./header-DC47Rs-a.js"),
			"../messages/en/hero.ts": () => import("./hero-C-m3LXAz.js"),
			"../messages/en/home.ts": () => import("./home-D3E1uMX7.js"),
			"../messages/en/open-positions.ts": () => import("./open-positions-B-dEBih9.js"),
			"../messages/en/pricing.ts": () => import("./pricing-DA7AhnkI.js"),
			"../messages/en/products.ts": () => import("./products-BknxcJs9.js"),
			"../messages/en/results-table.ts": () => import("./results-table-BV_xl-TK.js"),
			"../messages/en/route.ts": () => import("./route-CmLkRQF9.js"),
			"../messages/en/settings.ts": () => import("./settings-u3226YTE.js"),
			"../messages/en/shared.ts": () => import("./shared-D5u8MENU.js"),
			"../messages/en/team.ts": () => import("./team-CfkLO-Ws.js"),
			"../messages/en/theme-toggle.ts": () => import("./theme-toggle-B12C5eKa.js"),
			"../messages/en/understanding-impact.ts": () => import("./understanding-impact-CtPxNuUy.js"),
			"../messages/en/what-we-measure.ts": () => import("./what-we-measure-C2cT7eMy.js"),
			"../messages/en/why-it-matters.ts": () => import("./why-it-matters-Bc53Za95.js"),
			"../messages/es/about.ts": () => import("./about-CNUswcTK.js"),
			"../messages/es/blog.ts": () => import("./blog-RLj-jOVd.js"),
			"../messages/es/careers.ts": () => import("./careers-Kl7QK-f_.js"),
			"../messages/es/contact.ts": () => import("./contact-CwCeleJ7.js"),
			"../messages/es/faq.ts": () => import("./faq-Bb5FzfAk.js"),
			"../messages/es/home.ts": () => import("./home-2QVvrgID.js"),
			"../messages/es/pricing.ts": () => import("./pricing-D-zDHdMW.js"),
			"../messages/es/products.ts": () => import("./products-CR4vxNeL.js"),
			"../messages/es/route.ts": () => import("./route-BSxTkR-k.js"),
			"../messages/es/settings.ts": () => import("./settings-CXGCI0V-.js"),
			"../messages/es/shared.ts": () => import("./shared-COWDER4o.js"),
			"../messages/es/team.ts": () => import("./team-Bn1YvyoJ.js"),
			"../messages/fr/about.ts": () => import("./about-_LSogmpY.js"),
			"../messages/fr/blog.ts": () => import("./blog-BaD7WlN7.js"),
			"../messages/fr/careers.ts": () => import("./careers-BBzQHp0Y.js"),
			"../messages/fr/contact.ts": () => import("./contact-XzgnYJYc.js"),
			"../messages/fr/faq.ts": () => import("./faq-BTGwxhis.js"),
			"../messages/fr/home.ts": () => import("./home-BuuiRRlB.js"),
			"../messages/fr/pricing.ts": () => import("./pricing-CWlIjoMb.js"),
			"../messages/fr/products.ts": () => import("./products-CTERGPL1.js"),
			"../messages/fr/route.ts": () => import("./route-DPTS3w-n.js"),
			"../messages/fr/settings.ts": () => import("./settings-25D_uguX.js"),
			"../messages/fr/shared.ts": () => import("./shared-eI7Ttgh2.js"),
			"../messages/fr/team.ts": () => import("./team-D8RDq4Sj.js"),
			"../messages/it/about.ts": () => import("./about-Bo_Qv5FC.js"),
			"../messages/it/blog.ts": () => import("./blog-CjEWOzFn.js"),
			"../messages/it/careers.ts": () => import("./careers-DYnXoyrW.js"),
			"../messages/it/contact.ts": () => import("./contact-6E0L6sin.js"),
			"../messages/it/faq.ts": () => import("./faq-B0IRkLas.js"),
			"../messages/it/home.ts": () => import("./home-Fu1klOno.js"),
			"../messages/it/pricing.ts": () => import("./pricing-Ck38-fi_.js"),
			"../messages/it/products.ts": () => import("./products-CFWL1AEt.js"),
			"../messages/it/route.ts": () => import("./route-CQ4lGUO1.js"),
			"../messages/it/settings.ts": () => import("./settings-Bvd3PSeF.js"),
			"../messages/it/shared.ts": () => import("./shared--eQMSKEh.js"),
			"../messages/it/team.ts": () => import("./team-CQfQe3-m.js"),
			"../messages/ja/about.ts": () => import("./about-Dkc7gqcq.js"),
			"../messages/ja/blog.ts": () => import("./blog-DrDK8LJW.js"),
			"../messages/ja/careers.ts": () => import("./careers-B3XFlg57.js"),
			"../messages/ja/contact.ts": () => import("./contact-Xn64v5dN.js"),
			"../messages/ja/faq.ts": () => import("./faq-CSQLFVXG.js"),
			"../messages/ja/home.ts": () => import("./home-CXby7fCw.js"),
			"../messages/ja/pricing.ts": () => import("./pricing-BkVyjGm6.js"),
			"../messages/ja/products.ts": () => import("./products-WAO90fRZ.js"),
			"../messages/ja/route.ts": () => import("./route-Ccc-Bea-.js"),
			"../messages/ja/settings.ts": () => import("./settings-DOplRMfk.js"),
			"../messages/ja/shared.ts": () => import("./shared-DUDocGdH.js"),
			"../messages/ja/team.ts": () => import("./team-DBvjLZUw.js"),
			"../messages/ko/about.ts": () => import("./about-IWpZOMJE.js"),
			"../messages/ko/blog.ts": () => import("./blog-CfVgaEBA.js"),
			"../messages/ko/careers.ts": () => import("./careers-DyVS9_cL.js"),
			"../messages/ko/contact.ts": () => import("./contact-C77kwB6s.js"),
			"../messages/ko/faq.ts": () => import("./faq-BVrG0rss.js"),
			"../messages/ko/home.ts": () => import("./home-DdaCXL_P.js"),
			"../messages/ko/pricing.ts": () => import("./pricing-BDjtju8Q.js"),
			"../messages/ko/products.ts": () => import("./products-DZ1dAPEZ.js"),
			"../messages/ko/route.ts": () => import("./route-DrPyREM3.js"),
			"../messages/ko/settings.ts": () => import("./settings-Bg9_ImcR.js"),
			"../messages/ko/shared.ts": () => import("./shared-BTzZXoVU.js"),
			"../messages/ko/team.ts": () => import("./team-3yl0gh8Y.js"),
			"../messages/pt/about.ts": () => import("./about-DyHTlUnO.js"),
			"../messages/pt/blog.ts": () => import("./blog-Cv29cg46.js"),
			"../messages/pt/careers.ts": () => import("./careers-BeNV2XoC.js"),
			"../messages/pt/contact.ts": () => import("./contact-1QPQ7VaT.js"),
			"../messages/pt/faq.ts": () => import("./faq-BIophxlt.js"),
			"../messages/pt/home.ts": () => import("./home-BJifVlny.js"),
			"../messages/pt/pricing.ts": () => import("./pricing-SAEaGMiw.js"),
			"../messages/pt/products.ts": () => import("./products-DaokC1uU.js"),
			"../messages/pt/route.ts": () => import("./route-BX9DbgDH.js"),
			"../messages/pt/settings.ts": () => import("./settings-m4KWHk8b.js"),
			"../messages/pt/shared.ts": () => import("./shared-DttdVmLp.js"),
			"../messages/pt/team.ts": () => import("./team-BTZLAtBV.js"),
			"../messages/ru/about.ts": () => import("./about-JAmwaDaX.js"),
			"../messages/ru/blog.ts": () => import("./blog-D0hi_7en.js"),
			"../messages/ru/careers.ts": () => import("./careers-COc5Mh_f.js"),
			"../messages/ru/contact.ts": () => import("./contact-Dzc77zJi.js"),
			"../messages/ru/faq.ts": () => import("./faq-DlkNYLlF.js"),
			"../messages/ru/home.ts": () => import("./home-Bzo2Z3oQ.js"),
			"../messages/ru/pricing.ts": () => import("./pricing-CIjDHo0H.js"),
			"../messages/ru/products.ts": () => import("./products-B1izOfbR.js"),
			"../messages/ru/route.ts": () => import("./route-ChfNvOnQ.js"),
			"../messages/ru/settings.ts": () => import("./settings-Cb24Afm1.js"),
			"../messages/ru/shared.ts": () => import("./shared-CRVrD0zU.js"),
			"../messages/ru/team.ts": () => import("./team-smzgqNSP.js"),
			"../messages/zh/about.ts": () => import("./about-DvmzQ8uZ.js"),
			"../messages/zh/blog.ts": () => import("./blog-B0nkp9Z1.js"),
			"../messages/zh/careers.ts": () => import("./careers-C8M1lJwb.js"),
			"../messages/zh/contact.ts": () => import("./contact-Kc3BMp-O.js"),
			"../messages/zh/faq.ts": () => import("./faq-DtnRdg0Q.js"),
			"../messages/zh/home.ts": () => import("./home-7XPNQDKu.js"),
			"../messages/zh/pricing.ts": () => import("./pricing-CaFNB7IV.js"),
			"../messages/zh/products.ts": () => import("./products-Dl2sanLA.js"),
			"../messages/zh/route.ts": () => import("./route-CG03WjYD.js"),
			"../messages/zh/settings.ts": () => import("./settings-NQDSzo24.js"),
			"../messages/zh/shared.ts": () => import("./shared-pzKbRqP3.js"),
			"../messages/zh/team.ts": () => import("./team-CLKmS4J6.js")
		}), `../messages/${e}/${r}.ts`, 4);
...
//#region src/messages/it/about.ts
var e = {
	"about-header": {
...
//#endregion
export { e as default };
//#region src/messages/de/about.ts
var e = {
	"about-header": {
...
//#endregion
export { e as default };
//#region src/messages/es/about.ts
var e = {
	"about-header": {
...
//#endregion
export { e as default };
//#region src/messages/ja/about.ts
var e = {
	"about-header": {
...
//#endregion
export { e as default };
//#region src/messages/zh/about.ts
var e = {
	"about-header": {
...
//#endregion
export { e as default };
//#region src/messages/pt/about.ts
var e = {
	"about-header": {
		aboutThisBenchmark: "Sobre este benchmark",
...
//#endregion
export { e as default };
//#region src/messages/ko/about.ts
var e = {
	"about-header": {
...
//#endregion
export { e as default };
//#region src/messages/ru/about.ts
var e = {
	"about-header": {
...
//#endregion
export { e as default };
//#region src/messages/fr/about.ts
var e = {
	"about-header": {
...
//#endregion
export { e as default };
//#region src/messages/en/about-grid.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/about-header.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/about.ts
var e = {
	"about-header": {
		aboutThisBenchmark: "About This Benchmark",
		thisIsAnOpenSource: "This is an open-source test application — not a product or a company. Its sole purpose is to provide a realistic, multi-page React app where different i18n libraries can be integrated and measured under identical conditions."
...
//#endregion
export { e as default };
//#region src/messages/zh/blog.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/de/blog.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/fr/blog.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ko/blog.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/it/blog.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/pt/blog.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ru/blog.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ja/blog.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/blog.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/es/blog.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ja/careers.ts
var e = {
	"careers-header": {
		title: "採用",
...
//#endregion
export { e as default };
//#region src/messages/fr/careers.ts
var e = {
	"careers-header": {
		title: "Carrières",
...
//#endregion
export { e as default };
//#region src/messages/de/careers.ts
var e = {
	"careers-header": {
		title: "Karriere",
...
//#endregion
export { e as default };
//#region src/messages/pt/careers.ts
var e = {
	"careers-header": {
		title: "Carreiras",
...
//#endregion
export { e as default };
//#region src/messages/en/careers.ts
var e = {
	"careers-header": {
		title: "Careers",
...
//#endregion
export { e as default };
//#region src/messages/zh/careers.ts
var e = {
	"careers-header": {
		title: "招聘",
...
//#endregion
export { e as default };
//#region src/messages/ru/careers.ts
var e = {
	"careers-header": {
		title: "Карьера",
...
//#endregion
export { e as default };
//#region src/messages/it/careers.ts
var e = {
	"careers-header": {
		title: "Carriere",
...
//#endregion
export { e as default };
//#region src/messages/ko/careers.ts
var e = {
	"careers-header": {
		title: "채용",
...
//#endregion
export { e as default };
//#region src/messages/es/careers.ts
var e = {
	"careers-header": {
		title: "Carreras",
...
//#endregion
export { e as default };
//#region src/messages/en/careers-benefits.ts
var e = {
	workFromAnywhereInThe: "Work from anywhere in the world",
	competitivePay: "Competitive pay",
	topOfMarketCompensation: "Top-of-market compensation",
...
//#endregion
export { e as default };
//#region src/messages/en/careers-header.ts
var e = {
	title: "Careers",
	joinOurMissionToImprove: "Join our mission to improve the internationalization ecosystem. We're a remote-first team that values impact, transparency, and continuous learning."
};
//#endregion
export { e as default };
//#region src/messages/pt/contact.ts
var e = {
	"contact-header": {
...
//#endregion
export { e as default };
//#region src/messages/it/contact.ts
var e = {
	"contact-header": {
...
//#endregion
export { e as default };
//#region src/messages/ko/contact.ts
var e = {
	"contact-header": {
		getInTouch: "연락하기",
...
//#endregion
export { e as default };
//#region src/messages/es/contact.ts
var e = {
	"contact-header": {
...
//#endregion
export { e as default };
//#region src/messages/ru/contact.ts
var e = {
	"contact-header": {
...
//#endregion
export { e as default };
//#region src/messages/de/contact.ts
var e = {
	"contact-header": {
...
//#endregion
export { e as default };
//#region src/messages/zh/contact.ts
var e = {
	"contact-header": {
		getInTouch: "取得联系",
...
//#endregion
export { e as default };
//#region src/messages/ja/contact.ts
var e = {
	"contact-header": {
		getInTouch: "連絡を取る",
...
//#endregion
export { e as default };
//#region src/messages/fr/contact.ts
var e = {
	"contact-header": {
...
//#endregion
export { e as default };
//#region src/messages/en/contact-form.ts
var e = {
	yourName: "Your name",
...
//#endregion
export { e as default };
//#region src/messages/en/contact-header.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/contact.ts
var e = {
	"contact-header": {
		getInTouch: "Get in Touch",
		haveIdeasFoundABug: "Have ideas, found a bug, or want to contribute a benchmark? Reach out to us at"
...
//#endregion
export { e as default };
//#region src/messages/en/faq-header1.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/faq-list.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/footer.ts
var e = {
	resources: "Resources",
	contact: "Contact",
	github: "GitHub",
...
//#endregion
export { e as default };
//#region src/messages/en/header.ts
var e = {
	home: "Home",
	methodology: "Methodology",
...
//#endregion
export { e as default };
//#region src/messages/en/hero.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/es/home.ts
var e = {
	hero: {
...
//#endregion
export { e as default };
//#region src/messages/zh/home.ts
var e = {
	hero: {
...
//#endregion
export { e as default };
//#region src/messages/de/home.ts
var e = {
	hero: {
...
//#endregion
export { e as default };
//#region src/messages/pt/home.ts
var e = {
	hero: {
...
//#endregion
export { e as default };
//#region src/messages/fr/home.ts
var e = {
	hero: {
...
//#endregion
export { e as default };
//#region src/messages/ru/home.ts
var e = {
	hero: {
...
//#endregion
export { e as default };
//#region src/messages/ja/home.ts
var e = {
	hero: {
...
//#endregion
export { e as default };
//#region src/messages/en/home.ts
var e = {
	hero: {
		aTestApplicationDesignedTo: "A test application designed to measure the real-world impact of internationalization libraries on bundle size, loading performance, and rendering reactivity.",
		viewResults: "View Results"
...
//#endregion
export { e as default };
//#region src/messages/ko/home.ts
var e = {
	hero: {
...
//#endregion
export { e as default };
//#region src/messages/it/home.ts
var e = {
	hero: {
...
//#endregion
export { e as default };
//#region src/messages/en/open-positions.ts
var e = {
	seniorFrontendEngineer: "Senior Frontend Engineer",
	buildAndMaintainOurBenchmarking: "Build and maintain our benchmarking dashboard and developer tools using React, TypeScript, and Vite.",
	backendEngineer: "Backend Engineer",
...
//#endregion
export { e as default };
//#region src/messages/ko/pricing.ts
var e = {
	"pricing-header": {
...
//#endregion
export { e as default };
//#region src/messages/ja/pricing.ts
var e = {
	"pricing-header": {
...
//#endregion
export { e as default };
//#region src/messages/ru/pricing.ts
var e = {
	"pricing-header": {
...
//#endregion
export { e as default };
//#region src/messages/fr/pricing.ts
var e = {
	"pricing-header": {
...
//#endregion
export { e as default };
//#region src/messages/zh/pricing.ts
var e = {
	"pricing-header": {
...
//#endregion
export { e as default };
//#region src/messages/it/pricing.ts
var e = {
	"pricing-header": {
...
//#endregion
export { e as default };
//#region src/messages/es/pricing.ts
var e = {
	"pricing-header": {
...
//#endregion
export { e as default };
//#region src/messages/de/pricing.ts
var e = {
	"pricing-header": {
...
//#endregion
export { e as default };
//#region src/messages/en/pricing.ts
var e = {
	"pricing-header": {
...
//#endregion
export { e as default };
//#region src/messages/pt/pricing.ts
var e = {
	"pricing-header": {
...
//#endregion
export { e as default };
//#region src/messages/ru/products.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/products.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/de/products.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/it/products.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/es/products.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/fr/products.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ko/products.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/pt/products.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/zh/products.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ja/products.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/results-table.ts
var e = {
	sampleResults: "Sample Results",
	bundleSize: "Bundle Size",
	lookupTime: "Lookup Time",
...
//#endregion
export { e as default };
//#region src/messages/es/route.ts
var e = { route: {
...
//#endregion
export { e as default };
//#region src/messages/pt/route.ts
var e = { route: {
...
//#endregion
export { e as default };
//#region src/messages/zh/route.ts
var e = { route: {
...
//#endregion
export { e as default };
//#region src/messages/it/route.ts
var e = { route: {
...
//#endregion
export { e as default };
//#region src/messages/ja/route.ts
var e = { route: {
...
//#endregion
export { e as default };
//#region src/messages/ru/route.ts
var e = { route: {
...
//#endregion
export { e as default };
//#region src/messages/en/route.ts
var e = { route: {
...
//#endregion
export { e as default };
//#region src/messages/de/route.ts
var e = { route: {
...
//#endregion
export { e as default };
//#region src/messages/fr/route.ts
var e = { route: {
...
//#endregion
export { e as default };
//#region src/messages/ko/route.ts
var e = { route: {
...
//#endregion
export { e as default };
//#region src/messages/fr/settings.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/de/settings.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ko/settings.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/it/settings.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/es/settings.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ru/settings.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ja/settings.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/zh/settings.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/pt/settings.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/settings.ts
var e = {
...
//#endregion
export { e as default };
//#region src/messages/it/shared.ts
var e = {
	header: {
		home: "Home",
		methodology: "Metodologia",
...
//#endregion
export { e as default };
//#region src/messages/ko/shared.ts
var e = {
	header: {
		home: "홈",
		methodology: "방법론",
...
//#endregion
export { e as default };
//#region src/messages/es/shared.ts
var e = {
	header: {
		home: "Inicio",
		methodology: "Metodología",
...
//#endregion
export { e as default };
//#region src/messages/ru/shared.ts
var e = {
	header: {
		home: "Главная",
		methodology: "Методология",
...
//#endregion
export { e as default };
//#region src/messages/en/shared.ts
var e = {
	header: {
		home: "Home",
		methodology: "Methodology",
...
//#endregion
export { e as default };
//#region src/messages/de/shared.ts
var e = {
	header: {
		home: "Startseite",
		methodology: "Methodik",
...
//#endregion
export { e as default };
//#region src/messages/ja/shared.ts
var e = {
	header: {
		home: "ホーム",
		methodology: "方法論",
...
//#endregion
export { e as default };
//#region src/messages/pt/shared.ts
var e = {
	header: {
		home: "Início",
		methodology: "Metodologia",
...
//#endregion
export { e as default };
//#region src/messages/fr/shared.ts
var e = {
	header: {
		home: "Accueil",
		methodology: "Méthodologie",
...
//#endregion
export { e as default };
//#region src/messages/zh/shared.ts
var e = {
	header: {
		home: "首页",
		methodology: "方法论",
...
//#endregion
export { e as default };
//#region src/messages/ko/team.ts
var e = {
	"team-header": {
		ourTeam: "저희 팀",
...
//#endregion
export { e as default };
//#region src/messages/pt/team.ts
var e = {
	"team-header": {
...
//#endregion
export { e as default };
//#region src/messages/es/team.ts
var e = {
	"team-header": {
...
//#endregion
export { e as default };
//#region src/messages/zh/team.ts
var e = {
	"team-header": {
		ourTeam: "我们的团队",
...
//#endregion
export { e as default };
//#region src/messages/it/team.ts
var e = {
	"team-header": {
...
//#endregion
export { e as default };
//#region src/messages/en/team.ts
var e = {
	"team-header": {
		ourTeam: "Our Team",
...
//#endregion
export { e as default };
//#region src/messages/fr/team.ts
var e = {
	"team-header": {
...
//#endregion
export { e as default };
//#region src/messages/ja/team.ts
var e = {
	"team-header": {
		ourTeam: "私たちのチーム",
...
//#endregion
export { e as default };
//#region src/messages/ru/team.ts
var e = {
	"team-header": {
...
//#endregion
export { e as default };
//#region src/messages/de/team.ts
var e = {
	"team-header": {
		ourTeam: "Unser Team",
...
//#endregion
export { e as default };
//#region src/messages/en/theme-toggle.ts
var e = {
	themeModeAutoSystemClick: "Theme mode: auto (system). Click to switch to light mode.",
	themeModeLightClick: "Theme mode: light. Click to switch to dark mode.",
	themeModeDarkClick: "Theme mode: dark. Click to switch to auto (system) mode.",
...
//#endregion
export { e as default };
//#region src/messages/en/understanding-impact.ts
var e = {
	understandingTheImpact: "Understanding the Impact",
	whyASingleLargeJson: "Why a single large JSON can hurt performance",
	manyI18nLibrariesStoreTranslations: "Many i18n libraries store translations in a single JSON object provided via React context. When this object is large (thousands of keys), every component that consumes translations holds a reference to the entire dictionary. This means:",
...
//#endregion
export { e as default };
//#region src/messages/en/what-we-measure.ts
var e = {
	bundleSizeImpact: "Bundle size impact",
	theAdditionalJavascriptBytesSent: "The additional JavaScript bytes sent to users when the i18n library and its translation files are included. This directly affects download time on slow networks.",
	renderingOverhead: "Rendering overhead",
...
//#endregion
export { e as default };
//#region src/messages/en/why-it-matters.ts
var e = {
	whyTheseMetricsMatter: "Why These Metrics Matter",
	bundleSize: "Bundle Size",
	theBundleIsTheData: "The bundle is the data shipped to every user across the globe. A larger bundle means longer download times — especially on slow 3G connections common in many regions. i18n libraries vary dramatically in their weight: from a few kilobytes to tens of kilobytes of runtime code, plus the translation files themselves.",
