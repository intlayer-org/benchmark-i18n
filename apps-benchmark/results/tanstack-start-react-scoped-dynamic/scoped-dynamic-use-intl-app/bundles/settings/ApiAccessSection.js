import React, { cloneElement, createContext, isValidElement, use, useContext, useId, useMemo } from "react";
...
//#endregion
//#region ../../../node_modules/.bun/use-intl@4.9.1+3f10a4be4e334a9b/node_modules/use-intl/dist/esm/production/formatters-CJcico0N.js
...
function ApiAccessSection() {
	const t = E("api-access-section");
	const apiKeyId = useId();
	return jsxs("section", {
		className: "rounded-lg border border-border bg-card p-6",
		children: [jsx("h2", {
			className: "mb-4 text-lg font-semibold text-foreground",
			children: t("apiAccess")
		}), jsxs("div", { children: [
			jsx("label", {
				htmlFor: apiKeyId,
...
async function getMessages(locale, namespaces = ["shared", "route"]) {
	...
	for (const ns of namespaces) try {
		const messages = await _rolldown_dynamic_import_helper_default(Object.assign({
			"../messages/de/about.ts": () => import("./about-m-CyXbw_.js"),
			"../messages/de/blog.ts": () => import("./blog-B1pFXlLy.js"),
			"../messages/de/careers.ts": () => import("./careers-J7Pbelzd.js"),
			"../messages/de/contact.ts": () => import("./contact-HL8-qwls.js"),
			"../messages/de/faq.ts": () => import("./faq-Do1YTSTH.js"),
			"../messages/de/home.ts": () => import("./home-CVesrj4W.js"),
			"../messages/de/pricing.ts": () => import("./pricing-CtVChERu.js"),
			"../messages/de/products.ts": () => import("./products-DW9OcgeJ.js"),
			"../messages/de/route.ts": () => import("./route-CR0KYnCX.js"),
			"../messages/de/settings.ts": () => import("./settings-CBV2XNaY.js"),
			"../messages/de/shared.ts": () => import("./shared-CEapMj0H.js"),
			"../messages/de/team.ts": () => import("./team-C9YiXGFd.js"),
			"../messages/en/about-grid.ts": () => import("./about-grid-B_TxOT5I.js"),
			"../messages/en/about-header.ts": () => import("./about-header-DPMllEFu.js"),
			"../messages/en/about.ts": () => import("./about-CGzGzVim.js"),
			"../messages/en/blog-header.ts": () => import("./blog-header-C3mhO3td.js"),
			"../messages/en/blog-list.ts": () => import("./blog-list-CzhIAIix.js"),
			"../messages/en/blog.ts": () => import("./blog-Crucr2Xt.js"),
			"../messages/en/careers-benefits.ts": () => import("./careers-benefits-BdemggbW.js"),
			"../messages/en/careers-header.ts": () => import("./careers-header-BGbsxHd4.js"),
			"../messages/en/careers.ts": () => import("./careers-C_5mRq5c.js"),
			"../messages/en/contact-form.ts": () => import("./contact-form-BvVUdkuS.js"),
			"../messages/en/contact-header.ts": () => import("./contact-header-BDxYsG6v.js"),
			"../messages/en/contact.ts": () => import("./contact-BOxTrWYy.js"),
			"../messages/en/faq-header1.ts": () => import("./faq-header1-CKwJ5El5.js"),
			"../messages/en/faq-list.ts": () => import("./faq-list-CLfg_Ejm.js"),
			"../messages/en/faq.ts": () => import("./faq-nDPeZhMZ.js"),
			"../messages/en/footer.ts": () => import("./footer-BVDjPLTe.js"),
			"../messages/en/header.ts": () => import("./header-CO-iZq3j.js"),
			"../messages/en/hero.ts": () => import("./hero-C9A22_Eu.js"),
			"../messages/en/home.ts": () => import("./home-X77o77wR.js"),
			"../messages/en/open-positions.ts": () => import("./open-positions-BM8Lxfb_.js"),
			"../messages/en/pricing.ts": () => import("./pricing-Dm0G0vZG.js"),
			"../messages/en/products.ts": () => import("./products-CwmvcNoj.js"),
			"../messages/en/results-table.ts": () => import("./results-table-D2PR_Z0z.js"),
			"../messages/en/route.ts": () => import("./route-BbH_Lvsd.js"),
			"../messages/en/settings.ts": () => import("./settings-ax-RTjEH.js"),
			"../messages/en/shared.ts": () => import("./shared-BBOYOU1x.js"),
			"../messages/en/team.ts": () => import("./team-HhvAEibs.js"),
			"../messages/en/theme-toggle.ts": () => import("./theme-toggle-BaAyYFxU.js"),
			"../messages/en/understanding-impact.ts": () => import("./understanding-impact-BPUtG0um.js"),
			"../messages/en/what-we-measure.ts": () => import("./what-we-measure-BcmTYcOK.js"),
			"../messages/en/why-it-matters.ts": () => import("./why-it-matters-BQd1eg8f.js"),
			"../messages/es/about.ts": () => import("./about-Cd1-i0Et.js"),
			"../messages/es/blog.ts": () => import("./blog-Qp2Srtzh.js"),
			"../messages/es/careers.ts": () => import("./careers-CJzQ0dzl.js"),
			"../messages/es/contact.ts": () => import("./contact-DvCCJqVx.js"),
			"../messages/es/faq.ts": () => import("./faq-DEdEW5nW.js"),
			"../messages/es/home.ts": () => import("./home-GzFXyRoM.js"),
			"../messages/es/pricing.ts": () => import("./pricing-BMOH1JUB.js"),
			"../messages/es/products.ts": () => import("./products-CtLfkUuK.js"),
			"../messages/es/route.ts": () => import("./route-D2aXLKhr.js"),
			"../messages/es/settings.ts": () => import("./settings-CDKY4mgY.js"),
			"../messages/es/shared.ts": () => import("./shared-dngGLvCl.js"),
			"../messages/es/team.ts": () => import("./team-C7MK4zk_.js"),
			"../messages/fr/about.ts": () => import("./about-CASDacge.js"),
			"../messages/fr/blog.ts": () => import("./blog-mGXVuwy6.js"),
			"../messages/fr/careers.ts": () => import("./careers-DF-mMZE2.js"),
			"../messages/fr/contact.ts": () => import("./contact-DRc9odHP.js"),
			"../messages/fr/faq.ts": () => import("./faq-qjBWgHfU.js"),
			"../messages/fr/home.ts": () => import("./home-BkRJpt4B.js"),
			"../messages/fr/pricing.ts": () => import("./pricing-DhgvakXh.js"),
			"../messages/fr/products.ts": () => import("./products-BQcIIiw1.js"),
			"../messages/fr/route.ts": () => import("./route-D5-OWuA4.js"),
			"../messages/fr/settings.ts": () => import("./settings-c2vEC8OP.js"),
			"../messages/fr/shared.ts": () => import("./shared-D85rqWha.js"),
			"../messages/fr/team.ts": () => import("./team-hkSZzXsV.js"),
			"../messages/it/about.ts": () => import("./about-DPenNiaM.js"),
			"../messages/it/blog.ts": () => import("./blog-BsjmhejM.js"),
			"../messages/it/careers.ts": () => import("./careers-BwX7yKOn.js"),
			"../messages/it/contact.ts": () => import("./contact-D4Wmq0NV.js"),
			"../messages/it/faq.ts": () => import("./faq-DLUSPRzW.js"),
			"../messages/it/home.ts": () => import("./home-Keh1yUlB.js"),
			"../messages/it/pricing.ts": () => import("./pricing-0vIGXdYo.js"),
			"../messages/it/products.ts": () => import("./products-BOosYbbo.js"),
			"../messages/it/route.ts": () => import("./route-Cm3NmB8l.js"),
			"../messages/it/settings.ts": () => import("./settings-gxrMay4p.js"),
			"../messages/it/shared.ts": () => import("./shared-DhdUvpOa.js"),
			"../messages/it/team.ts": () => import("./team-CtyVpoPW.js"),
			"../messages/ja/about.ts": () => import("./about-BZTVnbu2.js"),
			"../messages/ja/blog.ts": () => import("./blog-DmgljpZP.js"),
			"../messages/ja/careers.ts": () => import("./careers-BBJ-Tsq4.js"),
			"../messages/ja/contact.ts": () => import("./contact-vd-T9n00.js"),
			"../messages/ja/faq.ts": () => import("./faq-BqGKqIDr.js"),
			"../messages/ja/home.ts": () => import("./home-CzGOKxAa.js"),
			"../messages/ja/pricing.ts": () => import("./pricing-B5eovize.js"),
			"../messages/ja/products.ts": () => import("./products-DEsLA9It.js"),
			"../messages/ja/route.ts": () => import("./route-j7pZKm1y.js"),
			"../messages/ja/settings.ts": () => import("./settings-Cx-oRDUO.js"),
			"../messages/ja/shared.ts": () => import("./shared-CN537p65.js"),
			"../messages/ja/team.ts": () => import("./team-CgvgR-WA.js"),
			"../messages/ko/about.ts": () => import("./about-DAGTcx05.js"),
			"../messages/ko/blog.ts": () => import("./blog-VhCbXGSQ.js"),
			"../messages/ko/careers.ts": () => import("./careers-Bu34H5wT.js"),
			"../messages/ko/contact.ts": () => import("./contact-DjGOeTJ1.js"),
			"../messages/ko/faq.ts": () => import("./faq-VST8mssD.js"),
			"../messages/ko/home.ts": () => import("./home-m5M9NnOr.js"),
			"../messages/ko/pricing.ts": () => import("./pricing-B_PSv43W.js"),
			"../messages/ko/products.ts": () => import("./products-D--q444Y.js"),
			"../messages/ko/route.ts": () => import("./route--3wfMtaF.js"),
			"../messages/ko/settings.ts": () => import("./settings-CDC5oUvk.js"),
			"../messages/ko/shared.ts": () => import("./shared-DEpBqAGi.js"),
			"../messages/ko/team.ts": () => import("./team-B_uHacdw.js"),
			"../messages/pt/about.ts": () => import("./about-Byl6MukE.js"),
			"../messages/pt/blog.ts": () => import("./blog-J6c-0uvU.js"),
			"../messages/pt/careers.ts": () => import("./careers-DY5L24DQ.js"),
			"../messages/pt/contact.ts": () => import("./contact-BIROv3yk.js"),
			"../messages/pt/faq.ts": () => import("./faq-D1pCnMSf.js"),
			"../messages/pt/home.ts": () => import("./home-BO-uovRx.js"),
			"../messages/pt/pricing.ts": () => import("./pricing-C24CUSHe.js"),
			"../messages/pt/products.ts": () => import("./products-D5_3tmit.js"),
			"../messages/pt/route.ts": () => import("./route-Dt-J0Kom.js"),
			"../messages/pt/settings.ts": () => import("./settings-Xd_ByusG.js"),
			"../messages/pt/shared.ts": () => import("./shared-8aRMgG0D.js"),
			"../messages/pt/team.ts": () => import("./team-O-cXXajb.js"),
			"../messages/ru/about.ts": () => import("./about-Bah2J1Ek.js"),
			"../messages/ru/blog.ts": () => import("./blog-D4DhWjxB.js"),
			"../messages/ru/careers.ts": () => import("./careers-DYOZsd4V.js"),
			"../messages/ru/contact.ts": () => import("./contact-BwU4SSII.js"),
			"../messages/ru/faq.ts": () => import("./faq-CXczI5JY.js"),
			"../messages/ru/home.ts": () => import("./home-CTIUjtER.js"),
			"../messages/ru/pricing.ts": () => import("./pricing-DT797RLf.js"),
			"../messages/ru/products.ts": () => import("./products-BBQimLkC.js"),
			"../messages/ru/route.ts": () => import("./route-DZBCivaV.js"),
			"../messages/ru/settings.ts": () => import("./settings-D9ai3tpA.js"),
			"../messages/ru/shared.ts": () => import("./shared-CfqjSqZw.js"),
			"../messages/ru/team.ts": () => import("./team-D3pTTTaR.js"),
			"../messages/zh/about.ts": () => import("./about-DM5KyfpM.js"),
			"../messages/zh/blog.ts": () => import("./blog-swcY7aU4.js"),
			"../messages/zh/careers.ts": () => import("./careers-qN6JUGT4.js"),
			"../messages/zh/contact.ts": () => import("./contact-CxDeVs0V.js"),
			"../messages/zh/faq.ts": () => import("./faq-Buh7QhXB.js"),
			"../messages/zh/home.ts": () => import("./home-BaxkLxYf.js"),
			"../messages/zh/pricing.ts": () => import("./pricing-9O4Qp0vq.js"),
			"../messages/zh/products.ts": () => import("./products-Cw3H6FsQ.js"),
			"../messages/zh/route.ts": () => import("./route-hyLZfgnM.js"),
			"../messages/zh/settings.ts": () => import("./settings-BzCAf5zv.js"),
			"../messages/zh/shared.ts": () => import("./shared-Bhf3SkTO.js"),
			"../messages/zh/team.ts": () => import("./team-Bvmzr_0J.js")
		}), `../messages/${locale}/${ns}.ts`, 4);
...
var blogHeader = { insightsTutorialsAndAnalysisFrom: "Insights, tutorials, and analysis from the i18n community." };
//#endregion
