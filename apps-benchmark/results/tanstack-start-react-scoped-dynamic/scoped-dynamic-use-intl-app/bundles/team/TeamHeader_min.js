...
var $ = n(void 0);
function Je({ children: e, formats: t, getMessageFallback: n, locale: r, messages: i, now: s, onError: l, timeZone: u }) {
	let d = a($), f = o((() => d?.cache || re()), [r, d?.cache]), p = o((() => d?.formatters || ae(f)), [f, d?.formatters]), m = o((() => ({
		...qe({
			locale: r,
...
function et() {
	...
	return l(s, { children: [
		...
		c("p", {
			...
			children: e("meetThePeopleBehindI18n")
		})
	] });
}
//#endregion
