...
function i(e = { c: [] }, t) {
	let i = e.c, a = (e) => {
		let t = i[e];
		return typeof t == "string" ? [t] : Array.isArray(t) ? t : [n(e, i)];
	}, o = (e, t = []) => r(a(e), t, 0);
	return o._ = e, o.l = t, o.c = a, o.x = r, o.t = (e, t, n) => {
		let r = a(t), i = [""], o = [];
		for (let e of r) {
			if (typeof e == "string") {
				i[i.length - 1] += e;
...
function c(e, t, n, r) {
	...
	for (let t of n) o[e].collection.set(t, s);
	return (t) => o[e].collection.get(t);
}
function l(e) {
	for (let t of Object.values(o)) for (let [n, r] of Object.entries(t.catalogs)) t.collection.set(n, i(r, e));
}
async function u(e, t = !0) {
	let n = [], r = [];
	for (let t of Object.values(o)) for (let i of Object.keys(t.catalogs)) n.push(t.load(i, e)), r.push([i, t]);
...
} }, f = c("shared", (e, t) => d[e][t](), ["shared"]), p = () => t("div", {
	className: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground",
	children: f("shared")(20)
}), m = { about: {
	en: () => import("./shared.shared.en.compiled-sq7QPJLR.js"),
	es: () => import("./shared.shared.es.compiled-UToT-QDX.js"),
	fr: () => import("./shared.shared.fr.compiled-DtQ_zypL.js"),
