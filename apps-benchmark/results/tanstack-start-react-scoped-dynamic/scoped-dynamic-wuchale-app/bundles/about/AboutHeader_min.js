...
function s(e = { c: [] }, t) {
	let n = e.c, r = (e) => {
		let t = n[e];
		return typeof t == "string" ? [t] : Array.isArray(t) ? t : [a(e, n)];
	}, i = (e, t = []) => o(r(e), t, 0);
	return i._ = e, i.l = t, i.c = r, i.x = o, i.t = (e, t, n) => {
		let i = r(t), a = [""], o = [];
		for (let e of i) {
			if (typeof e == "string") {
				a[a.length - 1] += e;
...
function d(e, t, n, r) {
	...
	for (let t of n) l[e].collection.set(t, u);
	return (t) => l[e].collection.get(t);
}
function f(e) {
	for (let t of Object.values(l)) for (let [n, r] of Object.entries(t.catalogs)) t.collection.set(n, s(r, e));
}
async function p(e, t = !0) {
	let n = [], r = [];
	for (let t of Object.values(l)) for (let i of Object.keys(t.catalogs)) n.push(t.load(i, e)), r.push([i, t]);
...
} }, h = d("about", (e, t) => m[e][t](), ["about"]);
//#endregion
//#region src/components/pages/about/AboutHeader.tsx
function g() {
	let e = h("about");
	return i(e(59)), r(t, { children: [n("h1", {
