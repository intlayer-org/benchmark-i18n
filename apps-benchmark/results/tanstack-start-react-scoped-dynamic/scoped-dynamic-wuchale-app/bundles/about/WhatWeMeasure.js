...
var getRuntimeRx = registerLoaders("about", loadCatalog$11, ["about"]);
//#endregion
//#region src/components/pages/about/WhatWeMeasure.tsx
function WhatWeMeasure() {
	const _w_runtime_ = getRuntimeRx("about");
	const metrics = [
		{
			metric: _w_runtime_(62),
			desc: _w_runtime_(63)
		},
		{
			metric: _w_runtime_(64),
			desc: _w_runtime_(65)
		},
		{
			metric: _w_runtime_(66),
			desc: _w_runtime_(67)
		},
		{
			metric: _w_runtime_(68),
			desc: _w_runtime_(69)
		},
		{
			metric: _w_runtime_(70),
			desc: _w_runtime_(71)
		}
	];
	return jsxs("section", {
...
registerLoaders("blog", loadCatalog$10, ["blog"]);
//#endregion
//#region src/locales/.wuchale/careers.proxy.js
var catalogs$9 = { careers: {
	en: () => import("./shared.shared.en.compiled-C0Z-FXZC.js"),
	es: () => import("./shared.shared.es.compiled-DYmFTojl.js"),
	fr: () => import("./shared.shared.fr.compiled-CdIynPSn.js"),
	de: () => import("./shared.shared.de.compiled-DN4AI_gT.js"),
...
registerLoaders("careers", loadCatalog$9, ["careers"]);
//#endregion
