...
} }, m = u("contact", (e, t) => p[e][t](), ["contact"]);
//#endregion
//#region src/components/pages/contact/ContactForm.tsx
function h() {
	let t = e(), i = e(), a = e(), o = e(), s = m("contact");
	return r("form", {
		className: "space-y-6",
		children: [
			r("div", {
			...
			r("div", { children: [n("label", {
				...
				children: [
					n("option", { children: s(91) }),
					n("option", { children: s(92) }),
					n("option", { children: s(93) }),
					n("option", { children: s(94) }),
					n("option", { children: s(95) })
				]
			})] }),
			r("div", { children: [n("label", {
				htmlFor: o,
