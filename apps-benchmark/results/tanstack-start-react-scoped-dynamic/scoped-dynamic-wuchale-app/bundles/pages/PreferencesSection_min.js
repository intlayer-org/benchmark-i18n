...
function o(e = { c: [] }, t) {
	let n = e.c, r = (e) => {
		let t = n[e];
		return typeof t == "string" ? [t] : Array.isArray(t) ? t : [i(e, n)];
	}, o = (e, t = []) => a(r(e), t, 0);
	return o._ = e, o.l = t, o.c = r, o.x = a, o.t = (e, t, n) => {
		let i = r(t), a = [""], o = [];
		for (let e of i) {
			if (typeof e == "string") {
				a[a.length - 1] += e;
...
function u(e, t, n, r) {
	...
	for (let t of n) c[e].collection.set(t, l);
	return (t) => c[e].collection.get(t);
}
function d(e) {
	for (let t of Object.values(c)) for (let [n, r] of Object.entries(t.catalogs)) t.collection.set(n, o(r, e));
}
async function f(e, t = !0) {
	let n = [], r = [];
	for (let t of Object.values(c)) for (let i of Object.keys(t.catalogs)) n.push(t.load(i, e)), r.push([i, t]);
...
//#endregion
//#region src/locales/.wuchale/settings.proxy.js
var p = { settings: {
	en: () => import("./shared.shared.en.compiled-sq7QPJLR.js"),
	es: () => import("./shared.shared.es.compiled-UToT-QDX.js"),
	fr: () => import("./shared.shared.fr.compiled-DtQ_zypL.js"),
	de: () => import("./shared.shared.de.compiled-ccIbN-x4.js"),
	it: () => import("./shared.shared.it.compiled-hqpHw1-Z.js"),
	pt: () => import("./shared.shared.pt.compiled-BYnMzdS-.js"),
	zh: () => import("./shared.shared.zh.compiled-Btzfqn0g.js"),
	ja: () => import("./shared.shared.ja.compiled-BXBCdhSO.js"),
	ko: () => import("./shared.shared.ko.compiled-B0kGbr-b.js"),
	ru: () => import("./shared.shared.ru.compiled-E9cXTxUY.js")
} }, m = u("settings", (e, t) => p[e][t](), ["settings"]);
//#endregion
//#region src/components/pages/settings/PreferencesSection.tsx
function h() {
	let t = e(), i = m("settings");
	return r("section", {
		...
		children: [n("h2", {
			...
			children: [
				...
				r("div", { children: [n("label", {
					...
					children: [
						n("option", { children: i(139) }),
						n("option", { children: i(140) }),
						n("option", { children: i(141) }),
						n("option", { children: i(142) }),
						n("option", { children: i(143) }),
						n("option", { children: i(144) }),
						n("option", { children: i(145) })
					]
				})] })
			]
		})]
...
//#endregion
//#region src/locales/.wuchale/about.proxy.js
var g = { about: {
	en: () => import("./shared.shared.en.compiled-sq7QPJLR.js"),
	es: () => import("./shared.shared.es.compiled-UToT-QDX.js"),
	fr: () => import("./shared.shared.fr.compiled-DtQ_zypL.js"),
...
u("about", (e, t) => g[e][t](), ["about"]);
//#endregion
//#region src/locales/.wuchale/blog.proxy.js
var _ = { blog: {
	en: () => import("./shared.shared.en.compiled-sq7QPJLR.js"),
	es: () => import("./shared.shared.es.compiled-UToT-QDX.js"),
	fr: () => import("./shared.shared.fr.compiled-DtQ_zypL.js"),
...
u("blog", (e, t) => _[e][t](), ["blog"]);
//#endregion
//#region src/locales/.wuchale/careers.proxy.js
var v = { careers: {
	en: () => import("./shared.shared.en.compiled-sq7QPJLR.js"),
	es: () => import("./shared.shared.es.compiled-UToT-QDX.js"),
	fr: () => import("./shared.shared.fr.compiled-DtQ_zypL.js"),
...
u("careers", (e, t) => v[e][t](), ["careers"]);
//#endregion
//#region src/locales/.wuchale/contact.proxy.js
var y = { contact: {
	en: () => import("./shared.shared.en.compiled-sq7QPJLR.js"),
	es: () => import("./shared.shared.es.compiled-UToT-QDX.js"),
	fr: () => import("./shared.shared.fr.compiled-DtQ_zypL.js"),
...
u("contact", (e, t) => y[e][t](), ["contact"]);
//#endregion
//#region src/locales/.wuchale/faq.proxy.js
var b = { faq: {
	en: () => import("./shared.shared.en.compiled-sq7QPJLR.js"),
	es: () => import("./shared.shared.es.compiled-UToT-QDX.js"),
	fr: () => import("./shared.shared.fr.compiled-DtQ_zypL.js"),
...
u("faq", (e, t) => b[e][t](), ["faq"]);
//#endregion
//#region src/locales/.wuchale/home.proxy.js
var x = { home: {
	en: () => import("./shared.shared.en.compiled-sq7QPJLR.js"),
	es: () => import("./shared.shared.es.compiled-UToT-QDX.js"),
	fr: () => import("./shared.shared.fr.compiled-DtQ_zypL.js"),
...
u("home", (e, t) => x[e][t](), ["home"]);
//#endregion
//#region src/locales/.wuchale/pricing.proxy.js
var S = { pricing: {
	en: () => import("./shared.shared.en.compiled-sq7QPJLR.js"),
	es: () => import("./shared.shared.es.compiled-UToT-QDX.js"),
	fr: () => import("./shared.shared.fr.compiled-DtQ_zypL.js"),
...
u("pricing", (e, t) => S[e][t](), ["pricing"]);
//#endregion
//#region src/locales/.wuchale/products.proxy.js
var C = { products: {
	en: () => import("./shared.shared.en.compiled-sq7QPJLR.js"),
	es: () => import("./shared.shared.es.compiled-UToT-QDX.js"),
	fr: () => import("./shared.shared.fr.compiled-DtQ_zypL.js"),
...
u("products", (e, t) => C[e][t](), ["products"]);
//#endregion
//#region src/locales/.wuchale/route.proxy.js
var w = { route: {
	en: () => import("./shared.shared.en.compiled-sq7QPJLR.js"),
	es: () => import("./shared.shared.es.compiled-UToT-QDX.js"),
	fr: () => import("./shared.shared.fr.compiled-DtQ_zypL.js"),
...
u("shared", (e, t) => T[e][t](), ["shared"]);
//#endregion
//#region src/locales/.wuchale/team.proxy.js
var E = { team: {
	en: () => import("./shared.shared.en.compiled-sq7QPJLR.js"),
	es: () => import("./shared.shared.es.compiled-UToT-QDX.js"),
	fr: () => import("./shared.shared.fr.compiled-DtQ_zypL.js"),
