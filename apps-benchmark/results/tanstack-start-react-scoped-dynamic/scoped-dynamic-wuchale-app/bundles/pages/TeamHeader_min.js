...
function a(e = { c: [] }, t) {
	let n = e.c, a = (e) => {
		let t = n[e];
		return typeof t == "string" ? [t] : Array.isArray(t) ? t : [r(e, n)];
	}, o = (e, t = []) => i(a(e), t, 0);
	return o._ = e, o.l = t, o.c = a, o.x = i, o.t = (e, t, n) => {
		let r = a(t), i = [""], o = [];
		for (let e of r) {
			if (typeof e == "string") {
				i[i.length - 1] += e;
		...
		return e(Object.assign(i, { raw: i }), ...o);
	}, o.p = (e) => n[e] ?? [], o;
}
//#endregion
...
function l(e, t, n, r) {
	...
	for (let t of n) s[e].collection.set(t, c);
	return (t) => s[e].collection.get(t);
}
function u(e) {
	for (let t of Object.values(s)) for (let [n, r] of Object.entries(t.catalogs)) t.collection.set(n, a(r, e));
}
async function d(e, t = !0) {
	let n = [], r = [];
	for (let t of Object.values(s)) for (let i of Object.keys(t.catalogs)) n.push(t.load(i, e)), r.push([i, t]);
...
} }, p = l("shared", (e, t) => f[e][t](), ["shared"]), m = () => t("div", {
	className: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground",
	children: p("shared")(20)
}), h = { team: {
	en: () => import("./shared.shared.en.compiled-sq7QPJLR.js"),
	es: () => import("./shared.shared.es.compiled-UToT-QDX.js"),
	fr: () => import("./shared.shared.fr.compiled-DtQ_zypL.js"),
...
l("settings", (e, t) => D[e][t](), ["settings"]), d("en");
