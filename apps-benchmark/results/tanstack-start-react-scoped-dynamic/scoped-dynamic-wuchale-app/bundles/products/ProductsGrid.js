...
var getRuntime$11 = registerLoaders("products", loadCatalog$11, ["products"]);
var getRuntimeRx = getRuntime$11;
//#endregion
//#region src/components/pages/products/ProductsGrid.tsx
function ProductsGrid() {
	const _w_runtime_ = getRuntimeRx("products");
	return jsx("div", {
		className: "grid gap-6 md:grid-cols-2 lg:grid-cols-3",
		children: [
			{
				name: _w_runtime_(157),
				desc: _w_runtime_(158),
				price: _w_runtime_(159)
			},
			{
				name: _w_runtime_(160),
				desc: _w_runtime_(161),
				price: "$29/mo"
			},
			{
				name: _w_runtime_(162),
				desc: _w_runtime_(163),
				price: _w_runtime_(164)
			},
			{
				name: _w_runtime_(165),
				desc: _w_runtime_(166),
				price: "$99 one-time"
			},
			{
				name: _w_runtime_(167),
				desc: _w_runtime_(168),
				price: "$19/mo"
			},
			{
				name: _w_runtime_(169),
				desc: _w_runtime_(170),
				price: "$49/mo"
			}
		].map((p) => {
			const _w_runtime_ = getRuntime$11("products");
			return jsxs("div", {
