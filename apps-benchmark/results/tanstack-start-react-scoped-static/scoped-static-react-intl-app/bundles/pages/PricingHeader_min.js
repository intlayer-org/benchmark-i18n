...
function Ft(t) {
	...
	return (!r.current || !Q(r.current, s)) && (r.current = s, a.current = At(s, n.current)), St(a.current), i(Et, {
		value: a.current,
		children: t.children
	});
}
...
var It = Ft, Lt = () => i("div", {
	...
	children: i(Nt, { id: "mockBanner" })
});
//#endregion
//#region src/components/pages/pricing/PricingHeader.tsx
function Rt() {
	let e = Dt();
	return a(r, { children: [i(Lt, {}), a("div", {
