	...
	return jsxs("section", {
		...
		children: [
			jsx("h2", {
				...
				children: jsx(MemoizedFormattedMessage, { id: "understanding-impact.understandingTheImpact" })
			}),
			jsxs("div", {
				...
				children: [
					jsx("h3", {
						...
						children: jsx(MemoizedFormattedMessage, { id: "understanding-impact.whyASingleLargeJson" })
					}),
					jsx("p", {
						className: "text-sm text-muted-foreground",
						children: jsx(MemoizedFormattedMessage, { id: "understanding-impact.manyI18nLibrariesStoreTranslations" })
					}),
					jsxs("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							jsx("li", { children: jsx(MemoizedFormattedMessage, { id: "understanding-impact.theJsonMustBeParsed" }) }),
							jsx("li", { children: jsx(MemoizedFormattedMessage, { id: "understanding-impact.contextBasedArchitecturesCanCause" }) }),
							jsx("li", { children: jsx(MemoizedFormattedMessage, { id: "understanding-impact.duringServerSideRenderingThe" }) })
						]
					})
				]
			}),
			jsxs("div", {
				...
				children: [
					jsx("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: jsx(MemoizedFormattedMessage, { id: "understanding-impact.theTradeOffsOfDynamic" })
					}),
					jsx("p", {
						className: "text-sm text-muted-foreground",
						children: jsx(MemoizedFormattedMessage, { id: "understanding-impact.splittingTranslationsIntoPerRoute" })
					}),
					jsxs("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							jsxs("li", { children: [
								jsx("strong", {
									...
									children: jsx(MemoizedFormattedMessage, { id: "understanding-impact.waterfallRequests" })
								}),
								" ",
								jsx(MemoizedFormattedMessage, { id: "understanding-impact.theAppMustFirstLoad" })
							] }),
							jsxs("li", { children: [
								jsx("strong", {
									className: "text-foreground",
									children: jsx(MemoizedFormattedMessage, { id: "understanding-impact.flashOfUntranslatedContentFouc" })
								}),
								" ",
								jsx(MemoizedFormattedMessage, { id: "understanding-impact.usersMayBrieflySee" })
							] }),
							jsxs("li", { children: [
								jsx("strong", {
									className: "text-foreground",
									children: jsx(MemoizedFormattedMessage, { id: "understanding-impact.cacheInvalidation" })
								}),
								" ",
								jsx(MemoizedFormattedMessage, { id: "understanding-impact.updatingTranslationsRequiresCacheBusting" })
							] })
						]
					})
				]
			...
			jsxs("div", {
				...
				children: [jsx("h3", {
					className: "mb-2 text-lg font-semibold text-foreground",
					children: jsx(MemoizedFormattedMessage, { id: "understanding-impact.whatThisBenchmarkMeasures" })
				}), jsx("p", {
					className: "text-sm text-muted-foreground",
					children: jsx(MemoizedFormattedMessage, { id: "understanding-impact.thisTestAppProvidesA" })
				})]
			})
		]
	});
...
async function getMessages(locale, namespaces = ["shared", "route"]) {
	...
	for (const ns of namespaces) try {
		const messages = await _rolldown_dynamic_import_helper_default(Object.assign({
			...
			"../messages/en/about.json": () => import("./about-Dvh-iXsN.js"),
			"../messages/en/blog.json": () => import("./blog-Xfk7IloM.js"),
			"../messages/en/careers.json": () => import("./careers-CjfcjYFn.js"),
			"../messages/en/contact.json": () => import("./contact-B2f2_Bc-.js"),
			"../messages/en/faq.json": () => import("./faq-D7Z91BkL.js"),
			"../messages/en/home.json": () => import("./home-Bj-qUnrx.js"),
			"../messages/en/pricing.json": () => import("./pricing-CONh7IpE.js"),
			"../messages/en/products.json": () => import("./products-DaOZRvN_.js"),
			"../messages/en/route.json": () => import("./route-C6C06DFk.js"),
			"../messages/en/settings.json": () => import("./settings-D9M0kijV.js"),
			"../messages/en/shared.json": () => import("./shared-I2VFwwIm.js"),
			"../messages/en/team.json": () => import("./team-CncX978C.js"),
