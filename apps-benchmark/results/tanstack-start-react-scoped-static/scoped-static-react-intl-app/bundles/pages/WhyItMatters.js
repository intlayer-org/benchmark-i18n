...
function WhyItMatters() {
	return jsxs("section", {
		...
		children: [jsx("h2", {
			...
			children: jsx(MemoizedFormattedMessage, { id: "why-it-matters.whyTheseMetricsMatter" })
		}), jsxs("div", {
			...
			children: [
				jsxs("div", {
					...
					children: [jsx("h3", {
						...
						children: jsx(MemoizedFormattedMessage, { id: "why-it-matters.bundleSize" })
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
						children: jsx(MemoizedFormattedMessage, { id: "why-it-matters.theBundleIsTheData" })
					})]
				}),
				jsxs("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [jsx("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: jsx(MemoizedFormattedMessage, { id: "why-it-matters.renderingHydration" })
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
						children: jsx(MemoizedFormattedMessage, { id: "why-it-matters.connectingALargeJsonDictionary" })
					})]
				}),
				jsxs("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [jsx("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: jsx(MemoizedFormattedMessage, { id: "why-it-matters.dynamicLoading" })
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
						children: jsx(MemoizedFormattedMessage, { id: "why-it-matters.loadingAllTranslationsUpfrontOverloads" })
					})]
				})
			]
		})]
