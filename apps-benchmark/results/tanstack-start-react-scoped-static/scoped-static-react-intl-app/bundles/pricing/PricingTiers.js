		...
		children: [
			{
				...
				features: [
					intl.formatMessage({ id: "pricing-tiers.benchmarkRunPerDay" }, { runs: 5 }),
					intl.formatMessage({ id: "pricing-tiers.librariesNumber" }, { libs: 3 }),
			...
			children: [
				...
				jsx("button", {
					...
					children: t.name === intl.formatMessage({ id: "pricing-tiers.enterprise" }) ? intl.formatMessage({ id: "pricing-tiers.contactSales" }) : intl.formatMessage({ id: "pricing-tiers.getStarted" })
				})
			]
		}, t.name))
	});
