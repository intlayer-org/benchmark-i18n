...
}, xt = (t) => e.Children.toArray(t).map((t, n) => e.isValidElement(t) ? r(e.Fragment, { children: t }, n) : t);
function St(e) {
	return function(t) {
		return e(xt(t));
	};
...
function jt(t) {
	...
	return (!i.current || !Ct(i.current, s)) && (i.current = s, a.current = kt(s, n.current)), yt(a.current), r(Tt, {
		value: a.current,
		children: t.children
	});
}
...
async function Ft(e, t = ["shared", "route"]) {
	...
	for (let r of t) try {
		let t = await Pt(Object.assign({
			...
			"../messages/en/about.json": () => import("./about-UM6HJIs1.js"),
			"../messages/en/blog.json": () => import("./blog-CTSI8IX-.js"),
			"../messages/en/careers.json": () => import("./careers-C1WtF6wU.js"),
			"../messages/en/contact.json": () => import("./contact-CKVvQEyR.js"),
			"../messages/en/faq.json": () => import("./faq-bP0ttjhB.js"),
			"../messages/en/home.json": () => import("./home-QgrgOnYZ.js"),
			"../messages/en/pricing.json": () => import("./pricing-CkVqm9t8.js"),
			"../messages/en/products.json": () => import("./products-Ch8FMsdl.js"),
			"../messages/en/route.json": () => import("./route-BDD-8iIL.js"),
			"../messages/en/settings.json": () => import("./settings-BrjzxNZC.js"),
			"../messages/en/shared.json": () => import("./shared-DPnuv6yZ.js"),
			"../messages/en/team.json": () => import("./team-B_XmCjKE.js"),
