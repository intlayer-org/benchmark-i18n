...
import ui from "../i18n/locales/ko/common.json";
...
function ls(e, t) {
	...
	return n.apiUrl = Zo(n.apiUrl), e?.fetch && (n.fetch = ts(e.fetch)), {
		initialOptions: n,
...
function fs(e, t, n) {
	let r = ls(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? N([t, ...Xo(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
var Uc = { useSuspense: !1 }, Wc, Gc = () => (Wc ||= e.createContext(void 0), Wc), Z = void 0, Kc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = Hc(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, Uc), r), h = Gc();
...
var Yc = () => {
	...
	let { tolgee: r, options: a } = Yc(), s = Yo(e), c = M(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Xc(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
var Q = (t) => {
	let n = $c(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, tl(t))) : tl(n);
}, nl = (t) => {
	...
	let { t: n } = Zc();
	return e.createElement(nl, Object.assign({ t: n }, t));
}, il = Bc.reduce((e, t) => (e[t] = zc(t), e), {}), al = Js().use(Ys()).use(Ds()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: il
...
function sl() {
	let { t: e } = ol(), t = l({ strict: !1 }).locale ?? "en", n = [
		{
			...
			children: [D("div", {
				...
				children: [
					...
					D("div", { children: [E("h3", {
						...
						className: "space-y-1",
						children: n.map((e) => E("li", { children: e.isInternal ? E(c, {
							to: e.to,
							params: { locale: t },
