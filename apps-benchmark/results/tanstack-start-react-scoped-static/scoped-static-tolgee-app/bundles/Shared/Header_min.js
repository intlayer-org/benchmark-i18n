...
var Jc = { useSuspense: !1 }, Yc, Xc = () => (Yc ||= e.createContext(void 0), Yc), X = void 0, Zc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = qc(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, Jc), r), h = Xc();
...
var el = () => {
	...
	let { tolgee: r, options: a } = el(), o = es(e), c = A(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = tl(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var Z = (t) => {
	let n = il(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, ol(t))) : ol(n);
}, sl = (t) => {
	...
	let { t: n } = nl();
	return e.createElement(sl, Object.assign({ t: n }, t));
}, ll = Wc.reduce((e, t) => (e[t] = Uc(t), e), {}), ul = Qs().use($s()).use(js()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: ll
