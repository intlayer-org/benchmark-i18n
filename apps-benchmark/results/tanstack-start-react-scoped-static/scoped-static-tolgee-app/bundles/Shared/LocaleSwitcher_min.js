...
function Js(e, t, a, o = !0) {
	let [s] = i(() => qs(e)), [c, l] = i(o);
	return n(() => {
		l(!1);
	}, []), r(() => {
...
var Ys = { useSuspense: !1 }, Xs, Zs = () => (Xs ||= e.createContext(void 0), Xs), $ = void 0, Qs = ({ tolgee: r, options: a, children: o, fallback: s, ssr: c }) => {
	n(() => {
	...
	l = Js(r, u, d, !!c);
	let [f, p] = i(!l.isLoaded()), m = Object.assign(Object.assign({}, Ys), a), h = Zs();
...
var Uc = Io.reduce((e, t) => (e[t] = Hc(t), e), {}), Wc = Gs().use(Ks()).use(Ts()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: Uc
