...
function os(e, t, n, r, i, a, o, s) {
	...
	function ee() {
		...
		let e = n();
		return k(s.onError, (e) => new es("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let w = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = Yo(e) || H, r = t().onFormatError, a = typeof r;
...
function cs(e, t, n) {
	let r = as(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? M([t, ...Jo(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
var ps = () => {
	...
	return t;
}, ms = 0, W = 1, hs = 2, gs = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === ms ? r = "Empty parameter" : e === W ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function _s(e) {
	return /\s/.test(e);
}
var G = 0, K = 1, q = 2, J = 3, Y = 4, vs = new Set([
	q,
	K,
	G
]), X = "'", ys = new Set([
...
function xs(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case G:
			...
			break;
		case K:
			ys.has(i) ? (n = n.slice(0, -1) + i, t = q) : (n += i, t = G);
			break;
		case q:
			i === X ? t = G : (n += i, t = q);
			break;
		case J:
			i === "}" ? (d(), t = G) : _s(i) ? r !== "" && (d(), t = Y) : (u(), t = J);
			break;
		case Y: i == "}" ? t = G : _s(i) ? t = Y : c(W);
	}
...
var Is = null;
function Ls(e) {
	return Is ||= Fs(`${Ps}/@tolgee/web@${e}/dist/${js}`).then(() => window[Ms][Ns]), Is;
}
var Rs = "__tolgee_apiKey", zs = "__tolgee_apiUrl", Bs = "__tolgee_branch";
function Vs() {
	let e = sessionStorage.getItem(Rs) || void 0, t = sessionStorage.getItem(zs) || void 0, n = sessionStorage.getItem(Bs) || void 0;
	if (!(!e || !t)) return Uo({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Hs() {
	sessionStorage.removeItem(Rs), sessionStorage.removeItem(zs), sessionStorage.removeItem(Bs);
}
function Us(e) {
...
var Gc = () => {
	...
	let { tolgee: r, options: a } = Gc(), s = qo(e), c = j(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Kc(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
}, $c = Ic.reduce((e, t) => (e[t] = Fc(t), e), {}), el = Gs().use(Ks()).use(ws()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: $c
