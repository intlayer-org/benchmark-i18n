...
var Vc = { useSuspense: !1 }, Hc, Uc = () => (Hc ||= e.createContext(void 0), Hc), X = void 0, Wc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
...
var qc = () => {
	...
	let { tolgee: r, options: a } = qc(), s = Jo(e), c = A(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Jc(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
}, nl = Rc.reduce((e, t) => (e[t] = Y(t), e), {}), rl = qs().use(Js()).use(Es()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: nl
