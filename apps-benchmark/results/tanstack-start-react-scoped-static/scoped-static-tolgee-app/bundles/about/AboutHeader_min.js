...
import { Fragment as zo, jsx as E, jsxs as Bo } from "react/jsx-runtime";
...
var Hc = { useSuspense: !1 }, Uc, Wc = () => (Uc ||= e.createContext(void 0), Uc), Q = void 0, Gc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
...
var Jc = () => {
	...
	let { tolgee: r, options: a } = Jc(), o = Xo(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Yc(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
}, nl = zc.reduce((e, t) => (e[t] = Z(t), e), {}), rl = Js().use(Ys()).use(Ds()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: nl
...
function ol() {
	return al("AboutHeader"), Bo(zo, { children: [E("h1", {
