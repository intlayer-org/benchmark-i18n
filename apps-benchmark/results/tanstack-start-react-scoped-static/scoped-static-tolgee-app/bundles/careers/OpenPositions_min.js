...
import { Fragment as Ro, jsx as E, jsxs as D } from "react/jsx-runtime";
...
var Vc = { useSuspense: !1 }, Hc, Uc = () => (Hc ||= e.createContext(void 0), Hc), Q = void 0, Wc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
...
var qc = () => {
	...
	let { tolgee: r, options: a } = qc(), s = Jo(e), c = M(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Jc(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
}, nl = Rc.reduce((e, t) => (e[t] = Lc(t), e), {}), rl = Ks().use(qs()).use(Ts()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: nl
