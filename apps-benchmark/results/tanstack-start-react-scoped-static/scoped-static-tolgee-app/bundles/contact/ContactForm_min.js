...
import T from "../../../i18n/locales/de/common.json";
...
function ls(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return A(s.onError, (e) => new I("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
	...
	let w = Object.freeze({
		...
		setStoredLanguage(e) {
			return A(s.onError, (e) => new I("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = Zo(e) || V, r = t().onFormatError, a = typeof r;
...
var Hc = { useSuspense: !1 }, Uc, Wc = () => (Uc ||= e.createContext(void 0), Uc), Z = void 0, Gc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = Vc(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, Hc), r), h = Wc();
...
var Jc = () => {
	...
	let { tolgee: r, options: a } = Jc(), o = Jo(e), c = M(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Yc(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var Q = (t) => {
	let n = Qc(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, el(t))) : el(n);
}, tl = (t) => {
	...
	let { t: n } = Xc();
	return e.createElement(tl, Object.assign({ t: n }, t));
}, rl = zc.reduce((e, t) => (e[t] = Rc(t), e), {}), il = qs().use(Js()).use(Es()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: rl
...
function ol() {
	let { t: e } = al(), t = a(), n = a(), r = a(), i = a();
	return D("form", {
		className: "space-y-6",
		children: [
			D("div", {
				className: "grid gap-4 md:grid-cols-2",
				children: [D("div", { children: [E("label", {
					htmlFor: t,
			...
			D("div", { children: [E("label", {
				...
				children: [
					E("option", { children: e("contactForm.bugReport", "Bug Report") }),
					E("option", { children: e("contactForm.newBenchmarkIdea", "New Benchmark Idea") }),
					E("option", { children: e("contactForm.methodologyQuestion", "Methodology Question") }),
					E("option", { children: e("contactForm.contribution", "Contribution") }),
					E("option", { children: e("contactForm.other", "Other") })
				]
			})] }),
			D("div", { children: [E("label", {
				htmlFor: i,
