...
var Vc = { useSuspense: !1 }, Hc, Uc = () => (Hc ||= e.createContext(void 0), Hc), Z = void 0, Wc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = Bc(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, Vc), r), h = Uc();
...
var qc = () => {
	...
	let { tolgee: r, options: a } = qc(), s = qo(e), c = M(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Jc(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
}, tl = Rc.reduce((e, t) => (e[t] = Lc(t), e), {}), nl = Ks().use(qs()).use(Ts()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: tl
