...
var hs = () => {
	...
	return t;
}, gs = 0, U = 1, _s = 2, vs = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === gs ? r = "Empty parameter" : e === U ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function ys(e) {
	return /\s/.test(e);
}
var W = 0, G = 1, K = 2, q = 3, J = 4, bs = new Set([
	K,
	G,
	W
]), Y = "'", xs = new Set([
...
function Cs(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case W:
			...
			break;
		case G:
			xs.has(i) ? (n = n.slice(0, -1) + i, t = K) : (n += i, t = W);
			break;
		case K:
			i === Y ? t = W : (n += i, t = K);
			break;
		case q:
			i === "}" ? (d(), t = W) : ys(i) ? r !== "" && (d(), t = J) : (u(), t = q);
			break;
		case J: i == "}" ? t = W : ys(i) ? t = J : c(U);
	}
...
}, tl = Rc.reduce((e, t) => (e[t] = Lc(t), e), {}), nl = Ks().use(qs()).use(Es()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: tl
