...
var zc = { useSuspense: !1 }, Bc, Vc = () => (Bc ||= e.createContext(void 0), Bc), $ = void 0, Hc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = Rc(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, zc), r), h = Vc();
...
var Gc = () => {
	...
	let { tolgee: r, options: a } = Gc(), s = Jo(e), c = j(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Kc(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
	...
	let { t: r, isLoading: i } = qc(e, t);
	return {
		t: n((...e) => r(W(...e)), [r]),
		isLoading: i
	};
}, Yc = Ic.reduce((e, t) => (e[t] = Fc(t), e), {}), Xc = Ws().use(Gs()).use(ws()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: Yc
