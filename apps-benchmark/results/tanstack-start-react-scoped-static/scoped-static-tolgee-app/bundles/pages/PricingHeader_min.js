...
import { Fragment as Ro, jsx as E, jsxs as zo } from "react/jsx-runtime";
...
var Hc = { useSuspense: !1 }, Uc, Wc = () => (Uc ||= e.createContext(void 0), Uc), Z = void 0, Gc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = Vc(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, Hc), r), h = Wc();
...
var Jc = () => {
	...
	let { tolgee: r, options: a } = Jc(), s = Yo(e), c = j(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Yc(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
var Q = (t) => {
	let n = Zc(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, $c(t))) : $c(n);
}, el = (t) => {
	...
	let { t: n } = Xc();
	return e.createElement(el, Object.assign({ t: n }, t));
}, nl = zc.reduce((e, t) => (e[t] = Rc(t), e), {}), rl = qs().use(Js()).use(Es()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: nl
...
function al() {
	return zo(Ro, { children: [E(il, {}), zo("div", {
