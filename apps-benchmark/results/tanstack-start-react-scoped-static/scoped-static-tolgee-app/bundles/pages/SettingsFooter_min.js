...
var Bc = { useSuspense: !1 }, Vc, Hc = () => (Vc ||= e.createContext(void 0), Vc), Q = void 0, Uc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
...
var Kc = () => {
	...
	let { tolgee: r, options: a } = Kc(), s = Jo(e), c = j(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = qc(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
}, el = Lc.reduce((e, t) => (e[t] = Z(t), e), {}), tl = Ks().use(qs()).use(Ts()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: el
