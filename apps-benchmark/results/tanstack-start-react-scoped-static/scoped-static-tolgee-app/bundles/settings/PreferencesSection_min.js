...
var Jc = () => {
	...
	let { tolgee: r, options: a } = Jc(), o = Yo(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Yc(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
		...
		children: [T("h2", {
			...
			children: [
				...
				E("div", { children: [T("label", {
					...
					children: [
						T("option", { children: e("preferencesSection.englishEn", "English (en)") }),
						T("option", { children: e("preferencesSection.frenchFr", "French (fr)") }),
						T("option", { children: e("preferencesSection.germanDe", "German (de)") }),
						T("option", { children: e("preferencesSection.spanishEs", "Spanish (es)") }),
						T("option", { children: e("preferencesSection.japaneseJa", "Japanese (ja)") }),
						T("option", { children: e("preferencesSection.chineseSimplifiedZhCn", "Chinese Simplified (zh-CN)") }),
						T("option", { children: e("preferencesSection.arabicAr", "Arabic (ar)") })
					]
				})] })
			]
		})]
