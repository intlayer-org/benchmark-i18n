import e, { cloneElement as t, createContext as n, isValidElement as r, use as i, useContext as a, useLayoutEffect as o, useMemo as s } from "react";
import { Fragment as c, jsx as l, jsxs as u } from "react/jsx-runtime";
//#region ../../../node_modules/.bun/@formatjs+fast-memoize@3.1.1/node_modules/@formatjs/fast-memoize/index.js
function d(e, t) {
	let n = t && t.cache ? t.cache : re, r = t && t.serializer ? t.serializer : te;
...
var S = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, C = /^(@+)?(\+|#+)?[rs]?$/g, fe = /(\*)(0+)|(#+)(0+)|(0+)/g, w = /^(0+)$/;
function T(e) {
	let t = {};
...
var we = !!Object.fromEntries, Te = !!String.prototype.trimStart, Ee = !!String.prototype.trimEnd, B = we ? Object.fromEntries : function(e) {
	let t = {};
...
function U(e) {
	e.forEach((e) => {
		...
		else ve(e) && P(e.style) || (k(e) || A(e)) && F(e.style) ? delete e.style.location : N(e) && U(e.children);
	});
}
function Pe(e, t = {}) {
	t = {
...
function Ge(e) {
	...
	return function({ cache: e, formats: n, formatters: i, getMessageFallback: a = Ue, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, h, ee) {
			...
			try {
				return He(Z(c, p), _, m && function(e) {
					let n = {};
...
function Ye({ children: e, formats: t, getMessageFallback: n, locale: r, messages: i, now: o, onError: c, timeZone: u }) {
	let d = a($), f = s((() => d?.cache || ie()), [r, d?.cache]), p = s((() => d?.formatters || oe(f)), [f, d?.formatters]), m = s((() => ({
		...Je({
			locale: r,
...
function $e(e) {
	return function(e, t, n) {
		...
		return u || Ze || !Qe || (Ze = !0, l(new y(b.ENVIRONMENT_FALLBACK, void 0))), s((() => Ge({
			cache: r,
			formatters: a,
...
function tt() {
	let e = $e("about-header");
	return et("AboutHeader"), u(c, { children: [l("h1", {
