...
var h = {
	...
	de,
	fe
].filter(Boolean), me = (e, t) => N(e, t, pe(t)), he = (e, t = g?.locales, n = g?.defaultLocale) => {
...
var ge = (e, t, n) => {
...
}, ye = 50, K = /* @__PURE__ */ new Map(), q = (e, t, n) => {
	let r = t ?? g?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = K.get(e);
	a || (a = /* @__PURE__ */ new Map(), K.set(e, a));
	let o = a.get(i);
	return o || (a.size > ye && a.clear(), o = new e(r, n), a.set(i, o)), o;
}, be = {
...
}, xe = (e, t = e) => new be.DisplayNames(t, { type: "language" }).of(e) ?? "Unknown locale", J = _e(G), Y = (e, t) => ve(e, {
	...G,
	isCookieEnabled: t
}), Se = () => {
	...
	let { locales: s, defaultLocale: c } = g ?? {}, [l, d] = u(e ?? J ?? t ?? c);
	o(() => {
		e && e !== l && d(e);
	}, [e]), o(() => {
		we();
	...
	let { defaultLocale: n, locales: r } = g ?? {}, { locale: o, setLocale: s, isCookieEnabled: c } = a(X) ?? {};
	return {
		locale: o,
		defaultLocale: n,
		availableLocales: r,
