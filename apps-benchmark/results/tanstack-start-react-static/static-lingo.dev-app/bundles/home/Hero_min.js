...
function et() {
	...
	return $e("Hero"), u("section", {
		className: "mb-16 text-center",
		children: [
			l("h1", {
				className: "mb-4 text-4xl font-bold tracking-tight text-foreground",
				children: e("4ccfa10a4fe6", "i18n Benchmark")
			}),
			l("p", {
				className: "mx-auto max-w-2xl text-lg text-muted-foreground",
				children: e("ac2276d78a33", "A test application designed to measure the real-world impact of internationalization libraries on bundle size, loading performance, and rendering reactivity.")
			}),
			u("div", {
				...
				children: [l("button", {
					...
					children: e("96c892835940", "View Results")
				}), l("button", {
					type: "button",
					className: "rounded-lg border border-border px-6 py-3 text-sm font-medium text-foreground hover:bg-accent transition-colors",
					children: e("f26d22d560e5", "Methodology")
				})]
			})
		]
	});
