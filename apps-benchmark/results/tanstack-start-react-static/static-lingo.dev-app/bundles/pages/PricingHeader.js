...
function PricingHeader() {
	const { t } = useTranslation(["6224437030b1", "fd52dee903fd"]);
	return jsxs(Fragment$1, { children: [jsx(MockBanner, {}), jsxs("div", {
		className: "mb-12 text-center",
		children: [jsx("h1", {
			className: "mb-3 text-3xl font-bold text-foreground",
			children: t("6224437030b1", "Simple, Transparent Pricing")
		}), jsx("p", {
			className: "text-muted-foreground",
			children: t("fd52dee903fd", "Choose the plan that fits your team. No hidden fees.")
		})]
	})] });
}
