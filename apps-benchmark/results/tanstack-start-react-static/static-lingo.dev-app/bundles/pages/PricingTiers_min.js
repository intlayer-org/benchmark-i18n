...
function Qe() {
	let { t: e } = Ze(/* @__PURE__ */ "2550c2870bff.56bebf34ba60.66f55ee3b688.1dd7953493e6.53386e07be0c.437794b05766.5d32d40b069b.8e7b2fc870af.424e5f386eaa.6ed0f915688c.a9323aa60f45.355864b504b6.fc8a87c47a5a.5684320a5519.60cde309e575.b9c4795f8d98.c6e5aa93f5a2.8e7b2fc870af.f54d6c587aae.2f6047fa3f52.70af845dd402.9b483606c88a.24b2c0362bb3.14c19d573256.ac25cb618886.521691fd2e2a.189a9d54e860.3b27114c3e68".split("."));
	return l("div", {
					...
					l("ul", {
						...
						children: [
							c("li", {
								...
								children: e("1dd7953493e6", "<span0>✓</span0> 5 benchmark runs/day", { span0: (e) => c("span", {
							...
							c("li", {
								className: "flex items-center gap-2 text-sm text-muted-foreground",
								children: e("53386e07be0c", "<span0>✓</span0> 3 libraries", { span0: (e) => c("span", {
									className: "text-primary",
									children: e
								}) })
							}),
							c("li", {
								className: "flex items-center gap-2 text-sm text-muted-foreground",
								children: e("437794b05766", "<span0>✓</span0> Community support", { span0: (e) => c("span", {
									className: "text-primary",
									children: e
								}) })
							}),
							c("li", {
								className: "flex items-center gap-2 text-sm text-muted-foreground",
								children: e("5d32d40b069b", "<span0>✓</span0> Public results", { span0: (e) => c("span", {
									className: "text-primary",
									children: e
								}) })
							})
				...
				children: [
					...
					l("ul", {
						...
						children: [
							c("li", {
								className: "flex items-center gap-2 text-sm text-muted-foreground",
								children: e("355864b504b6", "<span0>✓</span0> Unlimited runs", { span0: (e) => c("span", {
									className: "text-primary",
									children: e
								}) })
							}),
							c("li", {
								className: "flex items-center gap-2 text-sm text-muted-foreground",
								children: e("fc8a87c47a5a", "<span0>✓</span0> All libraries", { span0: (e) => c("span", {
									className: "text-primary",
									children: e
								}) })
							}),
							c("li", {
								className: "flex items-center gap-2 text-sm text-muted-foreground",
								children: e("5684320a5519", "<span0>✓</span0> Priority support", { span0: (e) => c("span", {
									className: "text-primary",
									children: e
								}) })
							}),
							c("li", {
								className: "flex items-center gap-2 text-sm text-muted-foreground",
								children: e("60cde309e575", "<span0>✓</span0> Private results", { span0: (e) => c("span", {
									className: "text-primary",
									children: e
								}) })
							}),
							c("li", {
								className: "flex items-center gap-2 text-sm text-muted-foreground",
								children: e("b9c4795f8d98", "<span0>✓</span0> CI integration", { span0: (e) => c("span", {
									className: "text-primary",
									children: e
								}) })
							}),
							c("li", {
								className: "flex items-center gap-2 text-sm text-muted-foreground",
								children: e("c6e5aa93f5a2", "<span0>✓</span0> Historical data", { span0: (e) => c("span", {
									className: "text-primary",
									children: e
								}) })
							})
			...
			l("div", {
				...
				children: [
					...
					l("div", {
						...
						}), c("span", { className: "text-sm text-muted-foreground" })]
					}),
					l("ul", {
						className: "mb-6 flex-1 space-y-2",
						children: [
							c("li", {
								className: "flex items-center gap-2 text-sm text-muted-foreground",
								children: e("70af845dd402", "<span0>✓</span0> Everything in Pro", { span0: (e) => c("span", {
									className: "text-primary",
									children: e
								}) })
							}),
							c("li", {
								className: "flex items-center gap-2 text-sm text-muted-foreground",
								children: e("9b483606c88a", "<span0>✓</span0> On-premise option", { span0: (e) => c("span", {
									className: "text-primary",
									children: e
								}) })
							}),
							c("li", {
								className: "flex items-center gap-2 text-sm text-muted-foreground",
								children: e("24b2c0362bb3", "<span0>✓</span0> SSO & SAML", { span0: (e) => c("span", {
									className: "text-primary",
									children: e
								}) })
							}),
							c("li", {
								className: "flex items-center gap-2 text-sm text-muted-foreground",
								children: e("14c19d573256", "<span0>✓</span0> Dedicated account manager", { span0: (e) => c("span", {
									className: "text-primary",
									children: e
								}) })
							}),
							c("li", {
								className: "flex items-center gap-2 text-sm text-muted-foreground",
								children: e("ac25cb618886", "<span0>✓</span0> Custom SLAs", { span0: (e) => c("span", {
									className: "text-primary",
									children: e
								}) })
							}),
							c("li", {
								className: "flex items-center gap-2 text-sm text-muted-foreground",
								children: e("521691fd2e2a", "<span0>✓</span0> Audit logs", { span0: (e) => c("span", {
									className: "text-primary",
									children: e
								}) })
							}),
							c("li", {
								className: "flex items-center gap-2 text-sm text-muted-foreground",
								children: e("189a9d54e860", "<span0>✓</span0> Training sessions", { span0: (e) => c("span", {
									className: "text-primary",
									children: e
								}) })
							})
