...
import _ from "../i18n/locales/de.json";
import v from "../i18n/locales/it.json";
import y from "../i18n/locales/pt.json";
import b from "../i18n/locales/zh.json";
import x from "../i18n/locales/ja.json";
import S from "../i18n/locales/ko.json";
import C from "../i18n/locales/ru.json";
//#region \0rolldown/runtime.js
var w = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), T = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	if (typeof require < "u") return require.apply(this, arguments);
	throw Error("Calling `require` for \"" + e + "\" in an environment that doesn't expose the `require` function. See https://rolldown.rs/in-depth/bundling-cjs#require-external-modules for more details.");
}), E = (e) => typeof e == "string", D = () => {
	let e, t, n = new Promise((n, r) => {
		e = n, t = r;
	});
	return n.resolve = e, n.reject = t, n;
}, O = (e) => e == null ? "" : String(e), k = (e, t, n) => {
	e.forEach((e) => {
		t[e] && (n[e] = t[e]);
	});
}, A = /###/g, j = (e) => e && e.includes("###") ? e.replace(A, ".") : e, M = (e) => !e || E(e), N = (e, t, n) => {
	let r = E(t) ? t.split(".") : t, i = 0;
	for (; i < r.length - 1;) {
		if (M(e)) return {};
		let t = j(r[i]);
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? E(e[r]) || e[r] instanceof String || E(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : re(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, F = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), ie = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, ae = (e) => E(e) ? e.replace(/[&<>"'\/]/g, (e) => ie[e]) : e, oe = class {
	constructor(e) {
	...
	t ||= "", n ||= "";
	let r = se.filter((e) => !t.includes(e) && !n.includes(e));
	...
	forward(e, t, n, r) {
		return r && !this.debug ? null : (E(e[0]) && (e[0] = `${n}${this.prefix} ${e[0]}`), this.logger[t](e));
	}
	create(t) {
	...
	getResource(e, t, n, r = {}) {
		...
		e.includes(".") ? o = e.split(".") : (o = [e, t], n && (Array.isArray(n) ? o.push(...n) : E(n) && i ? o.push(...n.split(i)) : o.push(n)));
		let s = P(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !E(n) ? s : I(this.data?.[e]?.[t], n, i);
	}
	addResource(e, t, n, r, i = { silent: !1 }) {
		let a = i.keySeparator === void 0 ? this.options.keySeparator : i.keySeparator, o = [e, t];
		n && (o = o.concat(a ? n.split(a) : n)), e.includes(".") && (o = e.split("."), r = t, t = o[1]), this.addNamespaces(t), ee(this.data, o, r), i.silent || this.emit("added", e, t, n, r);
	}
	addResources(e, t, n, r = { silent: !1 }) {
		for (let r in n) (E(n[r]) || Array.isArray(n[r])) && this.addResource(e, t, r, n[r], { silent: !0 });
	...
	addResourceBundle(e, t, n, r, i, a = {
		...
		a.skipCopy || (n = JSON.parse(JSON.stringify(n))), r ? re(s, n, i) : s = {
			...s,
			...n
		}, ee(this.data, o, s), a.silent || this.emit("added", e, t, n);
	}
...
}, H = Symbol("i18next/PATH_KEY");
function de() {
	let e = [], t = Object.create(null), n;
	return t.get = (r, i) => (n?.revoke?.(), i === H ? e : (e.push(i), n = Proxy.revocable(r, t), n.proxy)), Proxy.revocable(Object.create(null), t).proxy;
}
function U(e, t) {
	let { [H]: n } = e(de()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var W = (e) => !E(e) && typeof e != "boolean" && typeof e != "number", fe = class e extends z {
	constructor(e, t = {}) {
		super(), k([
			"resourceStore",
			"languageUtils",
	...
	extractFromKey(e, t) {
		...
		n === void 0 && (n = ":");
		let r = t.keySeparator === void 0 ? this.options.keySeparator : t.keySeparator, i = t.ns || this.options.defaultNS || [], a = n && e.includes(n), o = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !le(e, n, r);
		if (a && !o) {
	...
	translate(t, n, r) {
		...
		typeof t == "function" && (t = U(t, {
			...this.options,
			...i
		})), Array.isArray(t) || (t = [String(t)]), t = t.map((e) => typeof e == "function" ? U(e, {
			...this.options,
			...i
		}) : String(e));
		...
		let p = this.resolve(t, i), m = p?.res, h = p?.usedKey || s, g = p?.exactUsedKey || s, _ = [
			...
			"[object Function]",
			"[object RegExp]"
		], v = i.joinArrays === void 0 ? this.options.joinArrays : i.joinArrays, y = !this.i18nFormat || this.i18nFormat.handleAsObject, b = i.count !== void 0 && !E(i.count), x = e.hasDefaultValue(i), S = b ? this.pluralResolver.getSuffix(d, i.count, i) : "", C = i.ordinal && b ? this.pluralResolver.getSuffix(d, i.count, { ordinal: !1 }) : "", w = b && !i.ordinal && i.count === 0, T = w && i[`defaultValue${this.options.pluralSeparator}zero`] || i[`defaultValue${S}`] || i[`defaultValue${C}`] || i.defaultValue, D = m;
		y && !m && x && (D = T);
		let O = W(D), k = Object.prototype.toString.apply(D);
		if (y && D && O && !_.includes(k) && !(E(v) && Array.isArray(D))) {
		...
		} else if (y && E(v) && Array.isArray(m)) m = m.join(v), m &&= this.extendTranslation(m, t, i, r);
		else {
			let e = !1, n = !1;
	...
	extendTranslation(e, t, n, r, i) {
		if (this.i18nFormat?.parse) e = this.i18nFormat.parse(e, {
			...
			let a = E(e) && (n?.interpolation?.skipOnVariables === void 0 ? this.options.interpolation.skipOnVariables : n.interpolation.skipOnVariables), o;
			if (a) {
				let t = e.match(this.interpolator.nestingRegexp);
				o = t && t.length;
			}
			let s = n.replace && !E(n.replace) ? n.replace : n;
		...
		let a = n.postProcess || this.options.postProcess, o = E(a) ? [a] : a;
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return E(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? U(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
			...
			let u = t.count !== void 0 && !E(t.count), d = u && !t.ordinal && t.count === 0, f = t.context !== void 0 && (E(t.context) || typeof t.context == "number") && t.context !== "", p = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
			l.forEach((e) => {
	...
	getUsedParamsDetails(e = {}) {
		let t = [
			...
			"postProcess",
			"interpolation"
		], n = e.replace && !E(e.replace), r = n ? e.replace : e;
	...
	getFallbackCodes(e, t) {
		if (!e) return [];
		if (typeof e == "function" && (e = e(t)), E(e) && (e = [e]), Array.isArray(e)) return e;
	...
	toResolveHierarchy(e, t) {
		...
		return E(e) && (e.includes("-") || e.includes("_")) ? (this.options.load !== "languageOnly" && i(this.formatLanguageCode(e)), this.options.load !== "languageOnly" && this.options.load !== "currentOnly" && i(this.getScriptPartFromCode(e)), this.options.load !== "currentOnly" && i(this.getLanguagePartFromCode(e))) : E(e) && i(this.formatLanguageCode(e)), n.forEach((e) => {
	...
	let a = ne(e, t, n);
	return !a && i && E(n) && (a = I(e, n, r), a === void 0 && (a = I(t, n, r))), a;
}, G = (e) => e.replace(/\$/g, "$$$$"), ve = class {
	constructor(e = {}) {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? ae : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? F(i) : a || "{{", this.suffix = o ? F(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? F(d) : f || F("$t("), this.nestingSuffix = p ? F(p) : m || F(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			let s = [];
			a = { ...n }, a = a.replace && !E(a.replace) ? a.replace : a, a.applyPostProcessor = !1, delete a.defaultValue;
			let c = /{.*}/.test(r[1]) ? r[1].lastIndexOf("}") + 1 : r[1].indexOf(this.formatSeparator);
			if (c !== -1 && (s = r[1].slice(c).split(this.formatSeparator).map((e) => e.trim()).filter(Boolean), r[1] = r[1].slice(0, c)), i = t(o.call(this, r[1].trim(), a), a), i && r[0] === e && !E(i)) return i;
			E(i) || (i = O(i)), i ||= (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), ""), s.length && (i = s.reduce((e, t) => this.format(e, t, n.lng, {
				...n,
	...
	format(e, t, n, r = {}) {
		...
		return i.reduce((e, t) => {
			let { formatName: i, formatOptions: a } = ye(t);
			if (this.formats[i]) {
				let t = e;
				try {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			te(n.loaded, [i], a), Ce(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
	...
	prepareLoading(e, t, n = {}, r) {
		...
		E(e) && (e = this.languageUtils.toResolveHierarchy(e)), E(t) && (t = [t]);
	...
	overloadTranslationOptionHandler: (e) => {
		let t = {};
		if (typeof e[1] == "object" && (t = e[1]), E(e[1]) && (t.defaultValue = e[1]), E(e[2]) && (t.tDescription = e[2]), typeof e[2] == "object" || typeof e[3] == "object") {
			let n = e[3] || e[2];
...
}), Te = (e) => (E(e.ns) && (e.ns = [e.ns]), E(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), E(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), q = () => {}, Ee = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, J = class e extends z {
	constructor(e = {}, t) {
		if (super(), this.options = Te(e), this.services = {}, this.logger = R, this.modules = { external: [] }, Ee(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		this.isInitializing = !0, typeof e == "function" && (t = e, e = {}), e.defaultNS == null && e.ns && (E(e.ns) ? e.defaultNS = e.ns : e.ns.includes("translation") || (e.defaultNS = e.ns[0]));
		let n = K();
		this.options = {
			...n,
			...this.options,
		...
		if (!this.options.isClone) {
			...
			let n = this.services;
			n.logger = R, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new ge(t, { prepend: this.options.pluralSeparator }), e && (n.formatter = r(e), n.formatter.init && n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new ve(this.options), n.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }, n.backendConnector = new we(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (e, ...t) => {
				this.emit(e, ...t);
	...
	changeLanguage(e, t) {
		...
		let r = (e) => {
			...
			let n = E(t) ? t : t && t[0], a = this.store.hasLanguageSomeTranslations(n) ? n : this.services.languageUtils.getBestMatchFromCodes(E(t) ? [t] : t);
	...
	getFixedT(e, t, n) {
		let r = (e, t, ...i) => {
			...
			typeof a.keyPrefix == "function" && (a.keyPrefix = U(a.keyPrefix, o));
			let s = this.options.keySeparator || ".", c;
			return a.keyPrefix && Array.isArray(e) ? c = e.map((e) => (typeof e == "function" && (e = U(e, o)), `${a.keyPrefix}${s}${e}`)) : (typeof e == "function" && (e = U(e, o)), c = a.keyPrefix ? `${a.keyPrefix}${s}${e}` : e), this.t(c, a);
		};
		return E(e) ? r.lng = e : r.lngs = e, r.ns = t, r.keyPrefix = n, r;
	}
	t(...e) {
	...
	loadNamespaces(e, t) {
		let n = D();
		return this.options.ns ? (E(e) && (e = [e]), e.forEach((e) => {
			this.options.ns.includes(e) || this.options.ns.push(e);
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new pe(K());
	...
	cloneInstance(t = {}, n = q) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a.services.interpolator = new ve(n);
		}
...
var De = (e, t, n, r) => {
	...
	Z(n) && Oe[n] || (Z(n) && (Oe[n] = /* @__PURE__ */ new Date()), De(e, t, n, r));
}, ke = (e, t) => () => {
	...
	}), e.loadLanguages(t, ke(e, r));
}, je = (e, t, n = {}) => !t.languages || !t.languages.length ? (Y(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Z = (e) => typeof e == "string", Me = (e) => typeof e == "object" && !!e, Ne = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Pe = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	process.env.NODE_ENV !== "production" && (function() {
		...
		var a = T("react"), o = typeof Object.is == "function" ? Object.is : t, s = a.useState, c = a.useEffect, l = a.useLayoutEffect, u = a.useDebugValue, d = !1, f = !1, p = typeof window > "u" || window.document === void 0 || window.document.createElement === void 0 ? i : n;
	...
	process.env.NODE_ENV === "production" ? t.exports = We() : t.exports = Ge();
}))(), qe = {
	t: (e, t) => {
		if (Z(t)) return t;
		if (Me(t) && Z(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: a } = t, { i18n: l, defaultNS: u } = r(He) || {}, d = a || l || Be();
	d && !d.reportNamespaces && (d.reportNamespaces = new Ue()), d || Y(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = o(() => ({
		...Le(),
		...d?.options?.react,
		...t
	...
	let v = s(0), y = n((e) => {
		...
		if (!d) return qe;
		let e = !!(d.isInitialized || d.initializedStoreOnce) && _.every((e) => je(e, d, f)), n = t.lng || d.language, r = v.current, i = b.current;
		...
		f,
		t.lng
	]), [S, C] = c(0), { t: w, ready: T } = (0, Ke.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
			t.lng ? Ae(d, t.lng, _, e) : X(d, _, e);
		}
	}, [
		d,
		t.lng,
