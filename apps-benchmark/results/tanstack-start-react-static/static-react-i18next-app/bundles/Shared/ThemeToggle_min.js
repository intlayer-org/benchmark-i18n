...
import l from "../i18n/locales/fr.json";
import u from "../i18n/locales/es.json";
import d from "../i18n/locales/de.json";
import f from "../i18n/locales/it.json";
import p from "../i18n/locales/pt.json";
import m from "../i18n/locales/zh.json";
import h from "../i18n/locales/ja.json";
import g from "../i18n/locales/ko.json";
import _ from "../i18n/locales/ru.json";
//#region \0rolldown/runtime.js
var v = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), y = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	if (typeof require < "u") return require.apply(this, arguments);
	throw Error("Calling `require` for \"" + e + "\" in an environment that doesn't expose the `require` function. See https://rolldown.rs/in-depth/bundling-cjs#require-external-modules for more details.");
}), b = (e) => typeof e == "string", x = () => {
...
}, w = /###/g, T = (e) => e && e.includes("###") ? e.replace(w, ".") : e, E = (e) => !e || b(e), D = (e, t, n) => {
	let r = b(t) ? t.split(".") : t, i = 0;
	for (; i < r.length - 1;) {
		if (E(e)) return {};
		let t = T(r[i]);
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? b(e[r]) || e[r] instanceof String || b(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : te(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, j = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), ne = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, re = (e) => b(e) ? e.replace(/[&<>"'\/]/g, (e) => ne[e]) : e, ie = class {
	constructor(e) {
	...
	getResource(e, t, n, r = {}) {
		...
		e.includes(".") ? o = e.split(".") : (o = [e, t], n && (Array.isArray(n) ? o.push(...n) : b(n) && i ? o.push(...n.split(i)) : o.push(n)));
		let s = A(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !b(n) ? s : M(this.data?.[e]?.[t], n, i);
	}
	...
	addResources(e, t, n, r = { silent: !1 }) {
		for (let r in n) (b(n[r]) || Array.isArray(n[r])) && this.addResource(e, t, r, n[r], { silent: !0 });
...
function L(e, t) {
	let { [I]: n } = e(de()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var R = (e) => !b(e) && typeof e != "boolean" && typeof e != "number", z = class e extends F {
	constructor(e, t = {}) {
		super(), C([
			"resourceStore",
			"languageUtils",
	...
	translate(t, n, r) {
		...
		} else if (y && b(v) && Array.isArray(m)) m = m.join(v), m &&= this.extendTranslation(m, t, i, r);
		else {
			let e = !1, n = !1;
	...
	extendTranslation(e, t, n, r, i) {
		if (this.i18nFormat?.parse) e = this.i18nFormat.parse(e, {
			...
			let a = b(e) && (n?.interpolation?.skipOnVariables === void 0 ? this.options.interpolation.skipOnVariables : n.interpolation.skipOnVariables), o;
			if (a) {
				let t = e.match(this.interpolator.nestingRegexp);
				o = t && t.length;
			}
			let s = n.replace && !b(n.replace) ? n.replace : n;
		...
		let a = n.postProcess || this.options.postProcess, o = b(a) ? [a] : a;
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return b(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? L(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
			...
			let u = t.count !== void 0 && !b(t.count), d = u && !t.ordinal && t.count === 0, f = t.context !== void 0 && (b(t.context) || typeof t.context == "number") && t.context !== "", p = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
			l.forEach((e) => {
	...
	getUsedParamsDetails(e = {}) {
		let t = [
			...
			"postProcess",
			"interpolation"
		], n = e.replace && !b(e.replace), r = n ? e.replace : e;
	...
	toResolveHierarchy(e, t) {
		...
		return b(e) && (e.includes("-") || e.includes("_")) ? (this.options.load !== "languageOnly" && i(this.formatLanguageCode(e)), this.options.load !== "languageOnly" && this.options.load !== "currentOnly" && i(this.getScriptPartFromCode(e)), this.options.load !== "currentOnly" && i(this.getLanguagePartFromCode(e))) : b(e) && i(this.formatLanguageCode(e)), n.forEach((e) => {
	...
	let a = ee(e, t, n);
	return !a && i && b(n) && (a = M(e, n, r), a === void 0 && (a = M(t, n, r))), a;
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? re : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? j(i) : a || "{{", this.suffix = o ? j(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? j(d) : f || j("$t("), this.nestingSuffix = p ? j(p) : m || j(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				else !b(a) && !this.useRawValueToEscape && (a = S(a));
				let s = t.safeValue(a);
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			let s = [];
			a = { ...n }, a = a.replace && !b(a.replace) ? a.replace : a, a.applyPostProcessor = !1, delete a.defaultValue;
			let c = /{.*}/.test(r[1]) ? r[1].lastIndexOf("}") + 1 : r[1].indexOf(this.formatSeparator);
			if (c !== -1 && (s = r[1].slice(c).split(this.formatSeparator).map((e) => e.trim()).filter(Boolean), r[1] = r[1].slice(0, c)), i = t(o.call(this, r[1].trim(), a), a), i && r[0] === e && !b(i)) return i;
			b(i) || (i = S(i)), i ||= (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), ""), s.length && (i = s.reduce((e, t) => this.format(e, t, n.lng, {
				...n,
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			k(n.loaded, [i], a), _e(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
	...
	overloadTranslationOptionHandler: (e) => {
		let t = {};
		if (typeof e[1] == "object" && (t = e[1]), b(e[1]) && (t.defaultValue = e[1]), b(e[2]) && (t.tDescription = e[2]), typeof e[2] == "object" || typeof e[3] == "object") {
			let n = e[3] || e[2];
...
}), ye = (e) => (b(e.ns) && (e.ns = [e.ns]), b(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), b(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), q = () => {}, be = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, J = class e extends F {
	constructor(e = {}, t) {
		if (super(), this.options = ye(e), this.services = {}, this.logger = P, this.modules = { external: [] }, be(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		this.isInitializing = !0, typeof e == "function" && (t = e, e = {}), e.defaultNS == null && e.ns && (b(e.ns) ? e.defaultNS = e.ns : e.ns.includes("translation") || (e.defaultNS = e.ns[0]));
		let n = K();
		this.options = {
			...n,
			...this.options,
	...
	changeLanguage(e, t) {
		...
		let r = (e) => {
			...
			let n = b(t) ? t : t && t[0], a = this.store.hasLanguageSomeTranslations(n) ? n : this.services.languageUtils.getBestMatchFromCodes(b(t) ? [t] : t);
	...
	loadNamespaces(e, t) {
		let n = x();
		return this.options.ns ? (b(e) && (e = [e]), e.forEach((e) => {
			this.options.ns.includes(e) || this.options.ns.push(e);
...
var xe = (e, t, n, r) => {
	...
	Z(n) && Se[n] || (Z(n) && (Se[n] = /* @__PURE__ */ new Date()), xe(e, t, n, r));
}, Ce = (e, t) => () => {
	...
	e.loadNamespaces(t, Ce(e, n));
}, we = (e, t, n, r) => {
	if (Z(n) && (n = [n]), e.options.preload && e.options.preload.indexOf(t) > -1) return X(e, n, r);
	n.forEach((t) => {
		e.options.ns.indexOf(t) < 0 && e.options.ns.push(t);
	}), e.loadLanguages(t, Ce(e, r));
}, Te = (e, t, n = {}) => !t.languages || !t.languages.length ? (Y(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Z = (e) => typeof e == "string", Ee = (e) => typeof e == "object" && !!e, De = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Oe = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (Z(t)) return t;
		if (Ee(t) && Z(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: c } = t, { i18n: l, defaultNS: u } = r(Ie) || {}, d = c || l || Pe();
	d && !d.reportNamespaces && (d.reportNamespaces = new Le()), d || Y(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = a(() => ({
		...je(),
		...d?.options?.react,
		...t
	...
	let v = o(0), y = n((e) => {
		...
		if (!d) return Ve;
		let e = !!(d.isInitialized || d.initializedStoreOnce) && _.every((e) => Te(e, d, f)), n = t.lng || d.language, r = v.current, i = b.current;
		...
		f,
		t.lng
	]), [S, C] = s(0), { t: w, ready: T } = (0, Be.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
			t.lng ? we(d, t.lng, _, e) : X(d, _, e);
		}
	}, [
		d,
		t.lng,
