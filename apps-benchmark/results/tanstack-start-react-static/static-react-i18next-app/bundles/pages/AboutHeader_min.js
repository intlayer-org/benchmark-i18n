...
import f from "../../../i18n/locales/fr.json";
import p from "../../../i18n/locales/es.json";
import m from "../../../i18n/locales/de.json";
import h from "../../../i18n/locales/it.json";
import g from "../../../i18n/locales/pt.json";
...
function z(e, t) {
	let { [R]: n } = e(fe()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var B = (e) => !C(e) && typeof e != "boolean" && typeof e != "number", V = class e extends I {
	constructor(e, t = {}) {
		super(), E([
			"resourceStore",
			"languageUtils",
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return C(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? z(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			te(n.loaded, [i], a), ye(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), xe = (e) => (C(e.ns) && (e.ns = [e.ns]), C(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), C(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), J = () => {}, Se = (e) => {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new H(q());
...
var Ce = (e, t, n, r) => {
	...
	Q(n) && we[n] || (Q(n) && (we[n] = /* @__PURE__ */ new Date()), Ce(e, t, n, r));
}, Te = (e, t) => () => {
...
}, De = (e, t, n = {}) => !t.languages || !t.languages.length ? (X(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Q = (e) => typeof e == "string", Oe = (e) => typeof e == "object" && !!e, ke = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Ae = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (Q(t)) return t;
		if (Oe(t) && Q(t.defaultValue)) return t.defaultValue;
	...
	d && !d.reportNamespaces && (d.reportNamespaces = new ze()), d || X(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = o(() => ({
		...Ne(),
		...d?.options?.react,
		...t
...
function Je() {
	let { t: e } = Ge();
	return qe("AboutHeader"), d(l, { children: [u("h1", {
