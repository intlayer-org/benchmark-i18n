...
import u from "../../../i18n/locales/fr.json";
import d from "../../../i18n/locales/es.json";
import f from "../../../i18n/locales/de.json";
import p from "../../../i18n/locales/it.json";
import m from "../../../i18n/locales/pt.json";
import h from "../../../i18n/locales/zh.json";
import g from "../../../i18n/locales/ja.json";
import _ from "../../../i18n/locales/ko.json";
import v from "../../../i18n/locales/ru.json";
//#region \0rolldown/runtime.js
var y = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), b = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? x(e[r]) || e[r] instanceof String || x(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : ne(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, j = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), re = {
	"&": "&amp;",
	"<": "&lt;",
...
function L(e, t) {
	let { [I]: n } = e(fe()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var R = (e) => !x(e) && typeof e != "boolean" && typeof e != "number", z = class e extends F {
	constructor(e, t = {}) {
		super(), w([
			"resourceStore",
			"languageUtils",
	...
	init(e, t = { interpolation: {} }) {
		...
		let n = t.cacheInBuiltFormats ? K : he;
		this.formats = {
			number: n((e, t) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			ee(n.loaded, [i], a), _e(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), ye = (e) => (x(e.ns) && (e.ns = [e.ns]), x(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), x(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), J = () => {}, be = (e) => {
...
var xe = (e, t, n, r) => {
	...
	Q(n) && Se[n] || (Q(n) && (Se[n] = /* @__PURE__ */ new Date()), xe(e, t, n, r));
}, Ce = (e, t) => () => {
...
}, Te = (e, t, n = {}) => !t.languages || !t.languages.length ? (X(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Q = (e) => typeof e == "string", Ee = (e) => typeof e == "object" && !!e, De = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Oe = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (Q(t)) return t;
		if (Ee(t) && Q(t.defaultValue)) return t.defaultValue;
	...
	d && !d.reportNamespaces && (d.reportNamespaces = new Le()), d || X(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = a(() => ({
		...je(),
		...d?.options?.react,
		...t
