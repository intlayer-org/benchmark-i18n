...
var Ce = (e, t, n, r) => {
	...
	d && !d.reportNamespaces && (d.reportNamespaces = new ze()), d || Y(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = a(() => ({
		...Ne(),
		...d?.options?.react,
		...t
