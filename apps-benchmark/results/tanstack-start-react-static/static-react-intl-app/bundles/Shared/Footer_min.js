...
import c from "../messages/de.json";
import l from "../messages/es.json";
import u from "../messages/fr.json";
import d from "../messages/it.json";
import f from "../messages/ja.json";
import p from "../messages/ko.json";
import m from "../messages/pt.json";
import h from "../messages/ru.json";
import g from "../messages/zh.json";
...
var pe = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, x = /^(@+)?(\+|#+)?[rs]?$/g, me = /(\*)(0+)|(#+)(0+)|(0+)/g, he = /^(0+)$/;
function S(e) {
	let t = {};
...
var Ae = RegExp(`^${k.source}*`), je = RegExp(`${k.source}*$`);
function j(e, t) {
	return {
		start: e,
		end: t
...
var Me = !!Object.fromEntries, Ne = !!String.prototype.trimStart, Pe = !!String.prototype.trimEnd, M = Me ? Object.fromEntries : function(e) {
	let t = {};
...
function F(e) {
	e.forEach((e) => {
		if (delete e.location, Ce(e) || we(e)) for (let t in e.options) delete e.options[t].location, F(e.options[t].value);
		else be(e) && De(e.style) || (xe(e) || Se(e)) && D(e.style) ? delete e.style.location : Ee(e) && F(e.children);
	});
}
function He(e, t = {}) {
	t = {
...
function at(e = it()) {
	...
	return {
		getDateTimeFormat: i,
		getNumberFormat: a,
		getMessageFormat: _((e, t, n, r) => new Ze(e, t, n, {
			formatters: {
				getNumberFormat: a,
				getDateTimeFormat: i,
				getPluralRules: o
...
function st(e, t) {
	...
	return {
		...n,
		...e,
		date: ot(J(n.date, t), J(e.date || {}, t)),
		time: ot(J(n.time, t), J(e.time || {}, t))
	};
}
var Y = ({ locale: e, formats: t, messages: n, defaultLocale: r, defaultFormats: i, fallbackOnEmptyString: a, onError: o, timeZone: s, defaultRichTextElements: c }, l, u = { id: "" }, d, f) => {
	...
	nt(!!p, "[@formatjs/intl] An `id` must be provided to format a message. You can either:\n1. Configure your build toolchain with [babel-plugin-formatjs](https://formatjs.github.io/docs/tooling/babel-plugin)\nor [@formatjs/ts-transformer](https://formatjs.github.io/docs/tooling/ts-transformer) OR\n2. Configure your `eslint` config to include [eslint-plugin-formatjs](https://formatjs.github.io/docs/tooling/linter#enforce-id)\nto autofix this issue");
	let h = String(p), g = n && Object.prototype.hasOwnProperty.call(n, h) && n[h];
	if (Array.isArray(g) && g.length === 1 && g[0].type === T.literal) return g[0].value;
	if (d = {
		...c,
		...d
	}, t = st(t, s), i = st(i, s), !g) {
		if (a === !1 && g === "") return g;
		if ((!m || e && e.toLowerCase() !== r.toLowerCase()) && o(new tt(u, e)), m) try {
...
function jt(e, t) {
	...
	return i ? !Intl.NumberFormat.supportedLocalesOf(i).length && o ? o(new et(`Missing locale data for locale: "${i}" in Intl.NumberFormat. Using default locale: "${a}" as fallback. See https://formatjs.github.io/docs/react-intl#runtime-requirements for more details`)) : !Intl.DateTimeFormat.supportedLocalesOf(i).length && o && o(new et(`Missing locale data for locale: "${i}" in Intl.DateTimeFormat. Using default locale: "${a}" as fallback. See https://formatjs.github.io/docs/react-intl#runtime-requirements for more details`)) : (o && o(new $e(`"locale" was not configured, using "${a}" as fallback. See https://formatjs.github.io/docs/react-intl/api#intlshape for more details`)), r.locale = r.defaultLocale || "en"), At(r), {
		...r,
		formatters: n,
...
}, Ft = (t) => e.Children.toArray(t).map((t, n) => e.isValidElement(t) ? o(e.Fragment, { children: t }, n) : t);
function It(e) {
	return function(t) {
		return e(Ft(t));
	};
...
function Bt(e) {
	return e && Object.keys(e).reduce((t, n) => {
		let r = e[n];
		return t[n] = qe(r) ? It(r) : r, t;
	}, {});
}
var Vt = (e, t, n, r, ...i) => {
	let a = Y(e, t, n, Bt(r), ...i);
...
function Wt(t) {
	let { formatMessage: n, textComponent: r = e.Fragment } = zt(), { id: i, description: s, defaultMessage: c, values: l, children: u, tagName: d = r, ignoreTag: f } = t, p = n({
		id: i,
		description: s,
		defaultMessage: c
	}, l, { ignoreTag: f });
...
function Kt(t) {
	let n = e.useRef(it()), r = e.useRef(void 0), i = e.useRef(void 0), a = {};
	for (let e in t) t[e] !== void 0 && (a[e] = t[e]);
	let s = Gt({
		...Pt,
		...a
	});
	return (!r.current || !Q(r.current, s)) && (r.current = s, i.current = Ht(s, n.current)), Nt(i.current), o(Rt, {
		value: i.current,
		children: t.children
	});
}
