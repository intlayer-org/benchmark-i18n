...
function ie(e, t) {
	return y(e, this, te, t.cache.create(), t.serializer);
}
var ae = function() {
...
var Oe = RegExp(`^${j.source}*`), ke = RegExp(`${j.source}*$`);
function N(e, t) {
	return {
		start: e,
		end: t
...
var Ae = !!Object.fromEntries, je = !!String.prototype.trimStart, Me = !!String.prototype.trimEnd, P = Ae ? Object.fromEntries : function(e) {
	let t = {};
...
function L(e) {
	e.forEach((e) => {
		...
		else Se(e) && O(e.style) || (Ce(e) || we(e)) && k(e.style) ? delete e.style.location : D(e) && L(e.children);
	});
}
function Be(e, t = {}) {
	t = {
...
function rt(e = nt()) {
	...
	return {
		getDateTimeFormat: i,
		getNumberFormat: a,
		getMessageFormat: _((e, t, n, r) => new Ye(e, t, n, {
			formatters: {
				getNumberFormat: a,
				getDateTimeFormat: i,
				getPluralRules: o
...
function at(e, t) {
	...
	return {
		...n,
		...e,
		date: it(X(n.date, t), X(e.date || {}, t)),
		time: it(X(n.time, t), X(e.time || {}, t))
	};
}
...
function xt({ locale: e, formats: t, onError: n }, r, i = {}) {
	let { format: a } = i;
	return r(e, q(i, bt, !!a && Y(t, "relative", a, n) || {}));
}
...
function wt({ locale: e, formats: t, onError: n }, r, i = {}) {
	let { format: a } = i;
	return r(e, q(i, Ct, a && Y(t, "number", a, n) || {}));
}
function Tt(e, t, n, r = {}) {
	try {
...
}, Nt = (t) => e.Children.toArray(t).map((t, n) => e.isValidElement(t) ? a(e.Fragment, { children: t }, n) : t);
function Pt(e) {
	return function(t) {
		return e(Nt(t));
	};
...
function Vt(t) {
	let n = e.useRef(nt()), r = e.useRef(void 0), i = e.useRef(void 0), o = {};
	for (let e in t) t[e] !== void 0 && (o[e] = t[e]);
	let s = Bt({
		...Mt,
		...o
	});
	return (!r.current || !Ft(r.current, s)) && (r.current = s, i.current = zt(s, n.current)), jt(i.current), a(It, {
		value: i.current,
		children: t.children
	});
}
