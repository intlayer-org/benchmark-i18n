...
function te(e, t) {
	let n = e.length === 1 ? g : ee;
	return _(e, this, n, t.cache.create(), t.serializer);
}
function ne(e, t) {
	return _(e, this, ee, t.cache.create(), t.serializer);
}
function re(e, t) {
...
var y = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, b = /^(@+)?(\+|#+)?[rs]?$/g, fe = /(\*)(0+)|(#+)(0+)|(0+)/g, pe = /^(0+)$/;
function x(e) {
	let t = {};
...
function _e(e) {
	...
	for (let n of e) {
		...
		if (y.test(n.stem)) {
			...
			n.stem.replace(y, function(e, n, r, i, a, o) {
...
var Te = RegExp(`^${j.source}*`), Ee = RegExp(`${j.source}*$`);
function N(e, t) {
	return {
		start: e,
		end: t
...
var De = !!Object.fromEntries, Oe = !!String.prototype.trimStart, ke = !!String.prototype.trimEnd, P = De ? Object.fromEntries : function(e) {
	let t = {};
...
function L(e) {
	e.forEach((e) => {
		if (delete e.location, E(e) || xe(e)) for (let t in e.options) delete e.options[t].location, L(e.options[t].value);
		else be(e) && O(e.style) || (w(e) || T(e)) && k(e.style) ? delete e.style.location : D(e) && L(e.children);
	});
}
function Le(e, t = {}) {
	t = {
...
var Nt = e.createContext(null), Pt = Nt.Provider;
//#endregion
...
function It(e) {
	return e && Object.keys(e).reduce((t, n) => {
		let r = e[n];
		return t[n] = He(r) ? Mt(r) : r, t;
	}, {});
}
var Lt = (e, t, n, r, ...i) => {
	let a = Z(e, t, n, It(r), ...i);
	return Array.isArray(a) ? jt(a) : a;
}, Rt = ({ defaultRichTextElements: e, ...t }, n) => {
	let r = It(e), i = Dt({
		...At,
		...t,
	...
	return {
		...i,
		formatMessage: Lt.bind(null, a, i.formatters),
		$t: Lt.bind(null, a, i.formatters)
	};
};
//#endregion
...
function Bt(t) {
	let { formatMessage: n, textComponent: a = e.Fragment } = Ft(), { id: o, description: s, defaultMessage: c, values: l, children: u, tagName: d = a, ignoreTag: f } = t, p = n({
		id: o,
		description: s,
		defaultMessage: c
	}, l, { ignoreTag: f });
...
Bt.displayName = "FormattedMessage";
var Vt = e.memo(Bt, zt);
Vt.displayName = "MemoizedFormattedMessage";
//#endregion
...
function Ut(t) {
	...
	return (!r.current || !$(r.current, s)) && (r.current = s, a.current = Rt(s, n.current)), kt(a.current), i(Pt, {
		value: a.current,
		children: t.children
	});
}
Ut.displayName = "IntlProvider";
var Wt = Ut, Gt = () => i("div", {
	className: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground",
	children: i(Vt, { id: "mockBanner" })
}), Kt = {
	de: a,
	en: {
		"header.home": "Home",
