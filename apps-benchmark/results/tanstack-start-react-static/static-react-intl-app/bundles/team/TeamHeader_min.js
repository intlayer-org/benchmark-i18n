...
var b = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, fe = /^(@+)?(\+|#+)?[rs]?$/g, pe = /(\*)(0+)|(#+)(0+)|(0+)/g, me = /^(0+)$/;
function x(e) {
	let t = {};
...
var Oe = RegExp(`^${k.source}*`), ke = RegExp(`${k.source}*$`);
function j(e, t) {
	return {
		start: e,
		end: t
...
var Re = class {
	...
	parseTag(e, t) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !M(this.char())) return this.error(O.INVALID_TAG, j(o, this.clonePosition()));
				let e = this.clonePosition();
...
function N(e) {
	e.forEach((e) => {
		if (delete e.location, xe(e) || Se(e)) for (let t in e.options) delete e.options[t].location, N(e.options[t].value);
		else ve(e) && Te(e.style) || (ye(e) || be(e)) && D(e.style) ? delete e.style.location : we(e) && N(e.children);
	});
}
function He(e, t = {}) {
	t = {
...
function z(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (we(c)) {
			...
			if (!R(u)) throw new Ue(l, "function", o);
...
function tt(e = et()) {
	...
	return {
		getDateTimeFormat: i,
		getNumberFormat: a,
		getMessageFormat: h((e, t, n, r) => new V(e, t, n, {
			formatters: {
				getNumberFormat: a,
				getDateTimeFormat: i,
				getPluralRules: o
...
function rt(e, t) {
	...
	return {
		...n,
		...e,
		date: nt(X(n.date, t), X(e.date || {}, t)),
		time: nt(X(n.time, t), X(e.time || {}, t))
	};
}
...
var ft = ["type", "style"], pt = Date.now();
function mt(e) {
	return `${pt}_${e}_${pt}`;
}
function ht(e, t, n, r = {}) {
	let i = gt(e, t, n, r).reduce((e, t) => {
		let n = t.value;
		return typeof n == "string" && typeof e[e.length - 1] == "string" ? e[e.length - 1] += n : e.push(n), e;
	}, []);
	return i.length === 1 ? i[0] : i.length === 0 ? "" : i;
}
function gt({ locale: e, onError: t }, n, r, i = {}) {
...
function bt({ locale: e, formats: t, onError: n }, r, i = {}) {
	let { format: a } = i;
	return r(e, K(i, yt, !!a && Y(t, "relative", a, n) || {}));
}
...
function Ct({ locale: e, formats: t, onError: n }, r, i = {}) {
	let { format: a } = i;
	return r(e, K(i, St, a && Y(t, "number", a, n) || {}));
}
function wt(e, t, n, r = {}) {
	try {
		return Ct(e, t, r).format(n);
	} catch (t) {
...
function Tt(e, t, n, r = {}) {
	try {
		return Ct(e, t, r).formatToParts(n);
	} catch (t) {
		e.onError(new W("Error formatting number.", e.locale, t));
	}
	return [];
...
function Dt(e) {
	e.onWarn && e.defaultRichTextElements && Et(e.messages || {}) && e.onWarn("[@formatjs/intl] \"defaultRichTextElements\" was specified but \"message\" was not pre-compiled. \nPlease consider using \"@formatjs/cli\" to pre-compile your messages for performance.\nFor more details see https://formatjs.github.io/docs/getting-started/message-distribution");
}
function Ot(e, t) {
	let n = tt(t), r = {
		...q,
...
}, Mt = (t) => e.Children.toArray(t).map((t, n) => e.isValidElement(t) ? i(e.Fragment, { children: t }, n) : t);
function Nt(e) {
	return function(t) {
		return e(Mt(t));
	};
...
function Lt(e) {
	return e && Object.keys(e).reduce((t, n) => {
		let r = e[n];
		return t[n] = R(r) ? Nt(r) : r, t;
	}, {});
}
var Rt = (e, t, n, r, ...i) => {
	let a = Z(e, t, n, Lt(r), ...i);
	return Array.isArray(a) ? Mt(a) : a;
...
function Vt(t) {
	let { formatMessage: n, textComponent: a = e.Fragment } = It(), { id: o, description: s, defaultMessage: c, values: l, children: u, tagName: d = a, ignoreTag: f } = t, p = n({
		id: o,
		description: s,
		defaultMessage: c
	}, l, { ignoreTag: f });
...
Vt.displayName = "FormattedMessage";
var Ht = e.memo(Vt, Bt);
Ht.displayName = "MemoizedFormattedMessage";
//#endregion
...
function Wt(t) {
	let n = e.useRef(et()), r = e.useRef(void 0), a = e.useRef(void 0), o = {};
	for (let e in t) t[e] !== void 0 && (o[e] = t[e]);
	let s = Ut({
		...jt,
		...o
	});
	return (!r.current || !$(r.current, s)) && (r.current = s, a.current = zt(s, n.current)), At(a.current), i(Ft, {
		value: a.current,
		children: t.children
	});
}
