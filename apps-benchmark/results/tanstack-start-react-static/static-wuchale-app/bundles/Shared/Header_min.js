...
} }, b = (e, t) => y[e][t](), x = ["main"], S = "main", C = {}, w = {}, T = (e) => w[e];
g(S, b, x, {
	get: T,
	set: (e, t) => {
		w[e] = t, C[e]?.forEach((e) => {
...
var E = (t) => {
	...
	return e(() => {
		let e = (e) => i(() => e);
		return C[t] ??= /* @__PURE__ */ new Set(), C[t].add(e), () => C[t].delete(e);
	}, [t]), r;
};
//#endregion
...
function j() {
	...
	function i() {
		...
		r(e), A(e), window.localStorage.setItem("theme", e);
	}
	let a = E("main"), o = t === "auto" ? a(21) : a(22, [t]);
	return c("button", {
		type: "button",
		onClick: i,
		"aria-label": o,
