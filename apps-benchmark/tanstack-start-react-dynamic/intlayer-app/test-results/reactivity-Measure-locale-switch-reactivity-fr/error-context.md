  ...
  - generic [ref=e21]:
    ...
    - generic [ref=e62]:
      ...
      - table [ref=e65]:
        ...
        - rowgroup [ref=e72]:
          - 'row "react-i18next {val} kB {val}ms Yes" [ref=e73]':
            - cell "react-i18next" [ref=e74]
            - 'cell "{val} kB" [ref=e75]'
            - 'cell "{val}ms" [ref=e76]'
            - cell "Yes" [ref=e77]
          - 'row "react-intl {val} kB {val}ms Manual" [ref=e78]':
            - cell "react-intl" [ref=e79]
            - 'cell "{val} kB" [ref=e80]'
            - 'cell "{val}ms" [ref=e81]'
            - cell "Manual" [ref=e82]
          - 'row "lingui {val} kB {val}ms Yes" [ref=e83]':
            - cell "lingui" [ref=e84]
            - 'cell "{val} kB" [ref=e85]'
            - 'cell "{val}ms" [ref=e86]'
            - cell "Yes" [ref=e87]
          - 'row "typesafe-i18n {val} kB {val}ms Built-in" [ref=e88]':
