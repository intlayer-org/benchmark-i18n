  ...
  const tiers = [
    {
      ...
      features: [
        i18n._({ id: "pricing-tiers.benchmarkRunPerDay", message: "5 benchmark runs/day" }),
        i18n._({ id: "pricing-tiers.librariesNumber", message: "3 libraries" }),
    ...
    },
    {
      ...
      features: [
        ...
        i18n._({ id: "pricing-tiers.onPremiseOption", message: "On-premise option" }),
        i18n._({ id: "pricing-tiers.ssoSaml", message: "SSO & SAML" }),
        i18n._({ id: "pricing-tiers.dedicatedAccountManager", message: "Dedicated account manager" }),
