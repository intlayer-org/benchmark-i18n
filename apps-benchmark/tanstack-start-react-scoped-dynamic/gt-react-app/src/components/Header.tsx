...
export default function Header() {
  ...
  const mockPages = [
    { to: "/$locale/products" as const, label: <T>Products</T> },
    { to: "/$locale/pricing" as const, label: <T>Pricing</T> },
    { to: "/$locale/team" as const, label: <T>Team</T> },
    { to: "/$locale/blog" as const, label: <T>Blog</T> },
    { to: "/$locale/careers" as const, label: <T>Careers</T> },
    { to: "/$locale/faq" as const, label: <T>FAQ</T> },
    { to: "/$locale/contact" as const, label: <T>Contact</T> },
    { to: "/$locale/settings" as const, label: <T>Settings</T> },
  ];
