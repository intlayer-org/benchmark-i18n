...
export default function Header() {
  ...
  const mockPages = [
    { to: "/$locale/products" as const, label: content.products },
    { to: "/$locale/pricing" as const, label: content.pricing },
    { to: "/$locale/team" as const, label: content.team },
    { to: "/$locale/blog" as const, label: content.blog },
    { to: "/$locale/careers" as const, label: content.careers },
    { to: "/$locale/faq" as const, label: content.faq },
    { to: "/$locale/contact" as const, label: content.contact },
    { to: "/$locale/settings" as const, label: content.settings },
  ];
    ...
    <header className="sticky top-0 z-50 border-b border-border bg-card/80 backdrop-blur-lg">
      <nav className="container flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <span className="sr-only">{content.goToGithub}</span>
