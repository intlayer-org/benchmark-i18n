<div class="grid gap-8 md:grid-cols-2">
  <div class="rounded-lg border border-border bg-card p-6">
    <h2 class="mb-3 text-xl font-semibold text-foreground">Why This Exists</h2>
    <p class="text-sm text-muted-foreground">
      ...
      answers those questions with real data.
    </p>
  </div>
  <div class="rounded-lg border border-border bg-card p-6">
    <h2 class="mb-3 text-xl font-semibold text-foreground">Methodology</h2>
    <p class="text-sm text-muted-foreground">
      The same 10-page app is built once per library. We measure the production
