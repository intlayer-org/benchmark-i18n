...
const mockPages = computed(() => [
  { to: `/${currentLocale.value}/products`, label: "Products" },
  { to: `/${currentLocale.value}/pricing`, label: "Pricing" },
  { to: `/${currentLocale.value}/team`, label: "Team" },
  { to: `/${currentLocale.value}/blog`, label: "Blog" },
  { to: `/${currentLocale.value}/careers`, label: "Careers" },
  { to: `/${currentLocale.value}/faq`, label: "FAQ" },
  { to: `/${currentLocale.value}/contact`, label: "Contact" },
  { to: `/${currentLocale.value}/settings`, label: "Settings" },
]);
</script>
