...
export default function Header() {
  ...
  const mockPages = [
    { to: `/${currentLocale}/products`, label: "Products" },
    { to: `/${currentLocale}/pricing`, label: "Pricing" },
    { to: `/${currentLocale}/team`, label: "Team" },
    { to: `/${currentLocale}/blog`, label: "Blog" },
    { to: `/${currentLocale}/careers`, label: "Careers" },
    { to: `/${currentLocale}/faq`, label: "FAQ" },
    { to: `/${currentLocale}/contact`, label: "Contact" },
    { to: `/${currentLocale}/settings`, label: "Settings" },
  ];
