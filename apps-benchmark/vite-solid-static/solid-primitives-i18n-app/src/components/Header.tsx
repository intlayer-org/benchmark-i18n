...
export default function Header() {
  ...
  const mockPages = () => [
    { to: `/${currentLocale()}/products`, label: t("header.products") },
    { to: `/${currentLocale()}/pricing`, label: t("header.pricing") },
    { to: `/${currentLocale()}/team`, label: t("header.team") },
    { to: `/${currentLocale()}/blog`, label: t("header.blog") },
    { to: `/${currentLocale()}/careers`, label: t("header.careers") },
    { to: `/${currentLocale()}/faq`, label: t("header.faq") },
    { to: `/${currentLocale()}/contact`, label: t("header.contact") },
    { to: `/${currentLocale()}/settings`, label: t("header.settings") },
  ];
