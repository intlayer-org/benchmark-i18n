<section class="mx-auto mb-16 max-w-3xl space-y-6">
  <h2 class="text-2xl font-bold text-foreground">Understanding the Impact</h2>
  ...
  <div class="rounded-lg border border-border bg-card p-6">
    ...
    <p class="text-sm text-muted-foreground">
      Many i18n libraries store translations in a single JSON object provided via
    ...
    <ul class="mt-3 list-disc space-y-2 pl-5 text-sm text-muted-foreground">
      ...
      <li>
        During server-side rendering, the full dictionary is serialized into the
  ...
  <div class="rounded-lg border border-border bg-card p-6">
    ...
    <ul class="mt-3 list-disc space-y-2 pl-5 text-sm text-muted-foreground">
      ...
      <li>
        ...
        users may briefly see translation keys or a fallback language before the
        chunk arrives.
      </li>
      <li>
        <strong class="text-foreground">Cache invalidation:</strong>
        updating translations requires cache-busting strategies to ensure users
  ...
  <div class="rounded-lg border border-border bg-card p-6">
    ...
    <p class="text-sm text-muted-foreground">
      This test app provides a controlled environment — 10 pages with realistic
