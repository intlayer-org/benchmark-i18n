<script lang="ts">
  ...
  const mockPages = $derived([
    { to: `/${currentLocale}/products`, label: $header.products },
    { to: `/${currentLocale}/pricing`, label: $header.pricing },
    { to: `/${currentLocale}/team`, label: $header.team },
    { to: `/${currentLocale}/blog`, label: $header.blog },
    { to: `/${currentLocale}/careers`, label: $header.careers },
    { to: `/${currentLocale}/faq`, label: $header.faq },
    { to: `/${currentLocale}/contact`, label: $header.contact },
    { to: `/${currentLocale}/settings`, label: $header.settings },
  ]);
...
>
  <nav class="container flex h-16 items-center justify-between">
    ...
    <div class="flex items-center gap-4">
      ...
      >
        <span class="sr-only">{$header.goToGithub}</span>
