...
const careersHeaderContent = {
  ...
  content: {
    joinOurMissionToImprove: t({
      ...
      fr: 'Rejoignez notre mission d\'amélioration de l\'écosystème de l\'internationalisation. Nous sommes une équipe privilégiant le télétravail qui valorise l\'impact, la transparence et l\'apprentissage continu.',
      ...
      pt: 'Junte-se à nossa missão de melhorar o ecossistema de internacionalização. Somos uma equipe que prioriza o trabalho remoto que valoriza o impacto, a transparência e o aprendizado contínuo.',
      zh: '加入我们的使命，改善国际化生态系统。我们是一支远程优先的团队，重视影响力、透明度和持续学习。',
      ja: '国際化エコシステムを改善するという私たちの使命に参加してください。私たちは、影響力、透明性、および継続的な学習を重視するリモートファーストのチームです。',
      ko: '국제화 생태계를 개선하려는 우리의 사명에 동참하십시오. 우리는 영향력, 투명성 및 지속적인 학습을 중요하게 생각하는 원격 우선 팀입니다.',
