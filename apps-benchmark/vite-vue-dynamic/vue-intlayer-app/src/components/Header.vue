  ...
  >
    <nav class="container flex h-16 items-center justify-between">
      <div class="flex items-center gap-8">
        ...
        <div class="hidden items-center gap-6 text-sm font-medium md:flex">
          ...
          <div class="relative">
            ...
            >
              <div
                class="bg-card border border-border rounded-md shadow-lg overflow-hidden py-1"
              >
                <router-link
                  v-for="page in mockPagesList"
                  :key="page.to"
                  :to="page.to"
      ...
      <div class="flex items-center gap-4">
        ...
        >
          <span class="sr-only">{{ goToGithub }}</span>
