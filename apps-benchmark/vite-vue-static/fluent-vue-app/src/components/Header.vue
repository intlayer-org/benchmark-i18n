...
const mockPages = computed(() => [
  { to: `/${currentLocale.value}/products`, label: td("header.products") },
  { to: `/${currentLocale.value}/pricing`, label: td("header.pricing") },
  { to: `/${currentLocale.value}/team`, label: td("header.team") },
  { to: `/${currentLocale.value}/blog`, label: td("header.blog") },
  { to: `/${currentLocale.value}/careers`, label: td("header.careers") },
  { to: `/${currentLocale.value}/faq`, label: td("header.faq") },
  { to: `/${currentLocale.value}/contact`, label: td("header.contact") },
  { to: `/${currentLocale.value}/settings`, label: td("header.settings") },
]);
</script>
  ...
  <header class="sticky top-0 z-50 border-b border-border bg-card/80 backdrop-blur-lg">
    <nav class="container flex h-16 items-center justify-between">
      ...
      <div class="flex items-center gap-4">
        ...
        >
          <span class="sr-only">{{ td("shared.goToGithub") }}</span>
