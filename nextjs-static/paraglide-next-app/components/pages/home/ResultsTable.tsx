          ...
          <thead className="bg-muted">
            <tr>
              <th className="px-4 py-3 text-left font-medium text-muted-foreground">
                {m["results-table.library"] ? m["results-table.library"]() : "Library"}
              </th>
              <th className="px-4 py-3 text-left font-medium text-muted-foreground">
                {m["results-table.bundleSize"]()}
              </th>
              <th className="px-4 py-3 text-left font-medium text-muted-foreground">
                {m["results-table.lookupTime"]()}
              </th>
              <th className="px-4 py-3 text-left font-medium text-muted-foreground">
                {m["results-table.lazyLoading"]()}
              </th>
            </tr>
          </thead>
          <tbody>
