...
### `scoped-dynamic` — Route namespaces + lazy loading *(the gold standard)*
...
The translations and content strings that *belong* to the current page and locale — i.e. content that is legitimately needed. Detected via page fingerprint matching.
...
Translation strings that were bundled but *should not* have been on this page:
