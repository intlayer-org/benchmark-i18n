...
import ae from "../.intlayer/dictionary/settings-header.json";
import oe from "../.intlayer/dictionary/contact-form.json";
import se from "../.intlayer/dictionary/contact-header.json";
import ce from "../.intlayer/dictionary/about-grid.json";
import le from "../.intlayer/dictionary/pricing-tiers.json";
import ue from "../.intlayer/dictionary/mockBanner.json";
...
import me from "../.intlayer/dictionary/faq-header.json";
...
import xe from "../.intlayer/dictionary/products.json";
...
import { Fragment as p, jsx as m, jsxs as De } from "react/jsx-runtime";
var h = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/Link.tsx", Oe = (e) => /^https?:\/\//.test(e ?? "");
function ke(e, t) {
	return !e.startsWith("/") || e === `/${t}` || e.startsWith(`/${t}/`) ? e : `/${t}${e === "/" ? "" : e}`;
}
var Ae = ({ href: e, children: t, ...n }) => {
	let r = u().locale ?? "en";
...
}, Fe = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(Pe).join("") : String(e ?? ""), Ie = "translation", Le = "enumeration", _ = "plural", v = "insertion", Re = "object", ze = "array", Be = "markdown", y = "html", Ve = "gender", He = "select", b = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), x = (e, t) => {
...
})() }), Ye = (e) => b(_, e), Xe = (e, t) => b(He, e, { variable: t }), Ze = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, rt = 50, k = /* @__PURE__ */ new Map(), it = /* @__PURE__ */ new Set(), at = (e) => {
...
function A(e, t, n) {
	...
	if (!s) {
		...
		o.size > rt && o.clear(), s = new t(r, n), o.set(i, s);
	}
	return s;
}
var ct = (e, t, n) => e[A("PluralRules", n).select(t)] ?? e.other, lt = (e, t) => {
	...
	if (r.nodeType === "plural") {
		let e = r[_];
		return N(ct(e, Number(M(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[Le], i = ut.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[He], i = M(t, typeof r.variable == "string" ? r.variable : "value");
		return N(lt(e, String(i ?? "")), t, n);
	}
...
}, pt = (e) => (t, n = {}, r = "en") => P(typeof t == "string" ? e(t) : t, n, r), F = (e) => {
	...
	_(e, t, n) {
		...
		return (c.kind === "node" ? P(c.node, o, s) : mt(c.message, o, s)) ?? i;
	}
...
}, L = t(null), R = /* @__PURE__ */ new WeakMap(), z = 0, gt = (e) => {
	if (!e) return "base";
	let t = R.get(e);
	if (t) return t;
	z += 1;
	let n = `p${z}`;
	return R.set(e, n), n;
}, _t = 256, B = /* @__PURE__ */ new WeakMap(), V = (e) => typeof e == "object" && !!e, vt = (e, t, n) => `${e}_${t}_${gt(n)}`, yt = (e, t) => {
	if (!V(e)) return { hit: !1 };
	let n = B.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	if (!V(e)) return n;
	let r = B.get(e);
	return r || (r = /* @__PURE__ */ new Map(), B.set(e, r)), r.size >= _t && r.clear(), r.set(t, n), n;
}, bt = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), U = "default", xt = /[^A-Za-z0-9._&=-]/g, W = /[^A-Za-z0-9._-]/g, St = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, G = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, St);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, Ct = (e) => e === void 0 ? U : typeof e == "string" ? G(e, xt) : Object.keys(e).sort().map((t) => `${G(t, W)}=${G(String(e[t]), W)}`).join("&"), wt = (e) => Array.isArray(e) ? e.length === 0 ? [U] : e.map(Ct) : [Ct(e)], Tt = (e, t) => {
	...
	if (!Dt(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? U : Tt(wt(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Et(e, n, t, s)).map((t) => Ot(e, t));
...
}).join("|") : "", K = "\x1B[0m", Mt = "\x1B[34m", Nt = "\x1B[31m", Pt = "\x1B[32m", Ft = "\x1B[38;5;3m", It = (e) => e, Lt = (e, t) => {
...
}), q = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? K : n : K}` : e, zt = (e, t = Ft, n = K) => [e].flat().map((e) => q(e, t, n)).join(", ");
q("✗", Nt), q("✓", Pt), q("⏲", Mt);
var Bt = {
	header: f,
	"open-positions": ee,
	...
	let r = Vt()[e];
	return r ? ln(r, t, n) : (Wt.has(e) || (Rt({ log: nt })(typeof window > "u" ? `Dictionary ${zt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Wt.add(e)), Ut(e));
}, Kt = (e) => {
	...
	if (typeof e == "string") return e;
	if (J(e)) return e.nodeType === "html" ? e[y] : e[Be];
}, Xt = (e, t) => {
...
}, $t = Y, en = Y, tn = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? Y : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: v }], i = e[v], a = {
			...
			transform: (e, n, r) => {
				if (J(e)) return (i) => Zt(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
var an = (e) => Y, on = Y, sn = (e, t = !0) => [
	...
	let { locale: r, selector: i } = At(t), a = vt(r ?? D.defaultLocale, jt(i), n), o = yt(e, a);
	...
	let n = un(), r = e.indexOf("."), i = r === -1 ? e : e.slice(0, r), a = (e) => {
		try {
			return Gt(e, t);
		} catch {
			return;
...
var X = {
	...
	if (!gn) for (let t = 0; t < (O.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(O.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, vn = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !gn && O.storage.cookies) for (let n = 0; n < O.storage.cookies.length; n++) {
...
}, En = (e, t = D?.locales, n = D?.defaultLocale) => {
	...
	locale: yn ?? D?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), Dn = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: o, isCookieEnabled: s }) => {
	let { locales: l, defaultLocale: u } = D ?? {}, [d, f] = c(e ?? yn ?? t ?? u);
	i(() => {
		e && e !== d && f(e);
	}, [e]), i(() => {
		Tn();
...
}), { defaultLocale: kn, locales: Q } = D ?? {}, An = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
}), Pn = ({ id: e, message: t, values: n, components: r, render: i, component: a }, o, s) => {
	...
	let { i18n: t, defaultComponent: n } = jn();
	return Pn(e, t, n);
}, In = (e) => new I({
	...e,
	registry: pn()
...
In({ locale: "en" });
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/Footer.tsx";
function Ln() {
	let { i18n: e } = jn(), t = [
		{
			...
			children: [d("div", {
				...
				children: [
					...
					d("div", { children: [d("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => d("li", { children: e.isInternal ? d(Ae, {
							href: e.href,
...
var Vn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/AppProviders.tsx";
function Hn({ children: e, locale: t, messages: n }) {
	let r = o(() => Bn(t, n), [t, n]), [s] = c(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		zn("AppRoot", s);
	}, [s]), i(() => {
...
var Un = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
...
var Gn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/Footer.wrapper.tsx";
function Kn() {
	return d(Wn, { children: d(Ln, {}, void 0, !1, {
		fileName: Gn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
