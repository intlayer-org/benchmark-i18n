...
import { jsx as p, jsxs as ke } from "react/jsx-runtime";
var m = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/Link.tsx", Ae = (e) => /^https?:\/\//.test(e ?? "");
function h(e, t) {
...
}, v = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(Pe).join("") : String(e ?? ""), Fe = "translation", y = "enumeration", Ie = "plural", b = "insertion", Le = "object", Re = "array", ze = "markdown", x = "html", Be = "gender", Ve = "select", S = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), C = (e, t) => {
...
})() }), Je = (e) => S(Ie, e), Ye = (e, t) => S(Ve, e, { variable: t }), Xe = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
function j(e, t, n) {
	let r = t ?? k?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = rt.get(a);
...
var ct = (e, t, n) => e[j("PluralRules", n).select(t)] ?? e.other, lt = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return P(r[b], t, n);
	if (r.nodeType === "html") return P(r[x], t, n);
	if (r.nodeType === "plural") {
		let e = r[Ie];
		return P(ct(e, Number(N(t, "count") ?? 1), n), t, n);
	}
	...
	if (r.nodeType === "select") {
		let e = r[Ve], i = N(t, typeof r.variable == "string" ? r.variable : "value");
		return P(lt(e, String(i ?? "")), t, n);
	}
...
}, mt = ((e) => (t, n = {}, r = "en") => pt(typeof t == "string" ? e(t) : t, n, r))(Qe), ht = (e) => {
	let t = e.indexOf(".");
	return t === -1 ? {
		dictionaryKey: e,
		remainder: ""
...
}, F = e(null), I = /* @__PURE__ */ new WeakMap(), L = 0, _t = (e) => {
	if (!e) return "base";
	let t = I.get(e);
	if (t) return t;
	L += 1;
	let n = `p${L}`;
	return I.set(e, n), n;
}, vt = 256, R = /* @__PURE__ */ new WeakMap(), z = (e) => typeof e == "object" && !!e, yt = (e, t, n) => `${e}_${t}_${_t(n)}`, bt = (e, t) => {
	if (!z(e)) return { hit: !1 };
	let n = R.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	if (!z(e)) return n;
	let r = R.get(e);
	return r || (r = /* @__PURE__ */ new Map(), R.set(e, r)), r.size >= vt && r.clear(), r.set(t, n), n;
}, xt = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), V = "default", St = /[^A-Za-z0-9._&=-]/g, Ct = /[^A-Za-z0-9._-]/g, wt = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, H = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, wt);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, Tt = (e) => e === void 0 ? V : typeof e == "string" ? H(e, St) : Object.keys(e).sort().map((t) => `${H(t, Ct)}=${H(String(e[t]), Ct)}`).join("&"), Et = (e) => Array.isArray(e) ? e.length === 0 ? [V] : e.map(Tt) : [Tt(e)], Dt = (e, t) => {
	...
	if (!kt(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? V : Dt(Et(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Ot(e, n, t, s)).map((t) => At(e, t));
...
}).join("|") : "", U = "\x1B[0m", Pt = "\x1B[34m", Ft = "\x1B[31m", It = "\x1B[32m", Lt = "\x1B[38;5;3m", Rt = (e) => e, zt = (e, t) => {
...
}), W = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? U : n : U}` : e, Vt = (e, t = Lt, n = U) => [e].flat().map((e) => W(e, t, n)).join(", ");
W("✗", Ft), W("✓", It), W("⏲", Pt);
var Ht = {
	header: te,
	"open-positions": ne,
	...
	if (typeof e == "string") return e;
	if (G(e)) return e.nodeType === "html" ? e[x] : e[ze];
}, Qt = (e, t) => {
	if (typeof e == "string") return t;
	if (G(e)) {
		let n = e.nodeType === "html" ? x : ze;
		return {
			...e,
			[n]: t
		};
	...
	canHandle: () => !1,
	transform: (e) => e
}, en = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? K : {
...
}, tn = K, nn = K, rn = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? K : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: b }], i = e[b], a = {
			...
			transform: (e, n, r) => {
				if (G(e)) return (i) => $t(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
var sn = (e) => K, cn = K, ln = (e, t = !0) => [
	en(e ?? k.defaultLocale, t ? k.defaultLocale : void 0),
	tn,
	nn,
	rn,
	sn(e ?? k.defaultLocale),
	cn,
	an,
	on
], un = (e, t, n = []) => C(e, {
	...
	let { locale: r, selector: i } = Mt(t), a = yt(r ?? k.defaultLocale, Nt(i), n), o = bt(e, a);
	...
	let n = fn(), r = e.indexOf("."), i = r === -1 ? e : e.slice(0, r), a = (e) => {
		try {
			return qt(e, t);
		} catch {
			return;
...
var q = {
	...
	if (!vn) for (let t = 0; t < (A.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(A.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, bn = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !vn && A.storage.cookies) for (let n = 0; n < A.storage.cookies.length; n++) {
...
}, Dn = (e, t = k?.locales, n = k?.defaultLocale) => {
...
}), { defaultLocale: An, locales: X } = k ?? {}, jn = ({ isCookieEnabled: e, onLocaleChange: r } = {}) => {
	let { locale: i, setLocale: a, isCookieEnabled: o } = n(Y) ?? {};
	return {
		locale: i,
		defaultLocale: An,
		availableLocales: X,
		setLocale: t((t) => {
			if (!X?.map(String).includes(t)) {
...
Pn({ locale: "en" });
var Fn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/ThemeToggle.tsx";
function In() {
...
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/LocaleSwitcher.tsx";
function Vn() {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/Header.tsx";
function Un() {
	let { i18n: e } = Mn();
	Hn("Header");
...
function qn({ children: e, locale: t, messages: n }) {
	let o = a(() => Bn(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		Gn("AppRoot", c);
	}, [c]), r(() => {
...
var Xn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/Header.wrapper.tsx";
function Zn() {
	return f(Yn, { children: f(Un, {}, void 0, !1, {
		fileName: Xn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
