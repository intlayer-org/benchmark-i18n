...
}, h = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(Oe).join("") : String(e ?? ""), ke = "translation", g = "enumeration", _ = "plural", v = "insertion", Ae = "object", je = "array", y = "markdown", b = "html", x = "gender", S = "select", C = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), w = (e, t) => {
...
})() }), Le = (e) => C(_, e), Re = (e, t) => C(S, e, { variable: t }), ze = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, Ge = 50, N = /* @__PURE__ */ new Map(), P = /* @__PURE__ */ new Set(), Ke = (e) => {
...
var Ye = (e, t, n) => e[F("PluralRules", n).select(t)] ?? e.other, Xe = (e, t) => {
	...
	if (r.nodeType === "plural") {
		let e = r[_];
		return B(Ye(e, Number(z(t, "count") ?? 1), n), t, n);
	}
...
}, Qe = ((e) => (t, n = {}, r = "en") => V(typeof t == "string" ? e(t) : t, n, r))(Ve), $e = (e) => {
	let t = e.indexOf(".");
	return t === -1 ? {
		dictionaryKey: e,
		remainder: ""
	...
	lookupBoundDictionaries(e) {
		let { dictionaryKey: t, remainder: n } = $e(e), r = this._boundDictionaries[t];
		if (r !== void 0) {
			let e = m(r, n);
	...
	_(e, t, n) {
		...
		return (c.kind === "node" ? V(c.node, o, s) : Qe(c.message, o, s)) ?? i;
	}
...
}, et = e(null), tt = /* @__PURE__ */ new WeakMap(), nt = 0, rt = (e) => {
	if (!e) return "base";
	let t = tt.get(e);
	if (t) return t;
	nt += 1;
	let n = `p${nt}`;
	return tt.set(e, n), n;
}, it = 256, U = /* @__PURE__ */ new WeakMap(), at = (e) => typeof e == "object" && !!e, ot = (e, t, n) => `${e}_${t}_${rt(n)}`, st = (e, t) => {
	...
	if (!at(e)) return n;
	let r = U.get(e);
	return r || (r = /* @__PURE__ */ new Map(), U.set(e, r)), r.size >= it && r.clear(), r.set(t, n), n;
}, ct = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), G = "default", lt = /[^A-Za-z0-9._&=-]/g, ut = /[^A-Za-z0-9._-]/g, dt = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, K = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, dt);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, ft = (e) => e === void 0 ? G : typeof e == "string" ? K(e, lt) : Object.keys(e).sort().map((t) => `${K(t, ut)}=${K(String(e[t]), ut)}`).join("&"), pt = (e) => Array.isArray(e) ? e.length === 0 ? [G] : e.map(ft) : [ft(e)], mt = (e, t) => {
	...
	if (!gt(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? G : mt(pt(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => ht(e, n, t, s)).map((t) => _t(e, t));
...
}).join("|") : "", q = "\x1B[0m", xt = "\x1B[34m", St = "\x1B[31m", Ct = "\x1B[32m", wt = "\x1B[38;5;3m", Tt = (e) => e, Et = (e, t) => {
...
var kt = {
	...
	let r = At()[e];
	return r ? Zt(r, t, n) : (Nt.has(e) || (Dt({ log: We })(typeof window > "u" ? `Dictionary ${Ot(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Nt.add(e)), Mt(e));
}, Ft = (e) => {
	...
	if (typeof e == "string") return e;
	if (Y(e)) return e.nodeType === "html" ? e[b] : e[y];
}, zt = (e, t) => {
...
}, Ht = X, Ut = X, Wt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? X : {
	id: "insertion-plugin",
...
var qt = (e) => X, Jt = X, Yt = (e, t = !0) => [
	Vt(e ?? j.defaultLocale, t ? j.defaultLocale : void 0),
	Ht,
	Ut,
	Wt,
	qt(e ?? j.defaultLocale),
	Jt,
	Gt,
	Kt
], Xt = (e, t, n = []) => w(e, {
	...
	let { locale: r, selector: i } = yt(t), a = ot(r ?? j.defaultLocale, bt(i), n), o = st(e, a);
	if (o.hit) return o.content;
	let s = n ?? Yt(r), c = vt(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
	...
	let n = Qt(), r = e.indexOf("."), i = r === -1 ? e : e.slice(0, r), a = (e) => {
		try {
			return Pt(e, t);
		} catch {
			return;
...
var Z = {
	...
	if (!an) for (let t = 0; t < (M.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(M.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, sn = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !an && M.storage.cookies) for (let n = 0; n < M.storage.cookies.length; n++) {
...
}, hn = (e, t = j?.locales, n = j?.defaultLocale) => {
	...
	locale: cn ?? j?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), gn = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: a, disableEditor: o, isCookieEnabled: c }) => {
	let { locales: l, defaultLocale: ee } = j ?? {}, [u, d] = s(e ?? cn ?? t ?? ee);
	r(() => {
		e && e !== u && d(e);
	}, [e]), r(() => {
		mn();
...
}), { defaultLocale: vn, locales: $ } = j ?? {}, yn = ({ isCookieEnabled: e, onLocaleChange: r } = {}) => {
...
Sn({ locale: "en" });
var Cn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/MockBanner.tsx", wn = () => {
	let { i18n: e } = bn();
	return p("div", {
...
var Mn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/MockBanner.wrapper.tsx";
function Nn() {
