...
var rt = (e, t, n) => e[I("PluralRules", n).select(t)] ?? e.other, it = (e, t) => {
...
}, dt = e(null), ft = /* @__PURE__ */ new WeakMap(), pt = 0, mt = (e) => {
	if (!e) return "base";
	let t = ft.get(e);
	if (t) return t;
	pt += 1;
	let n = `p${pt}`;
	return ft.set(e, n), n;
}, ht = 256, H = /* @__PURE__ */ new WeakMap(), gt = (e) => typeof e == "object" && !!e, _t = (e, t, n) => `${e}_${t}_${mt(n)}`, vt = (e, t) => {
	...
	if (!gt(e)) return n;
	let r = H.get(e);
	return r || (r = /* @__PURE__ */ new Map(), H.set(e, r)), r.size >= ht && r.clear(), r.set(t, n), n;
}, yt = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), W = "default", bt = /[^A-Za-z0-9._&=-]/g, xt = /[^A-Za-z0-9._-]/g, St = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, G = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, St);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, Ct = (e) => e === void 0 ? W : typeof e == "string" ? G(e, bt) : Object.keys(e).sort().map((t) => `${G(t, xt)}=${G(String(e[t]), xt)}`).join("&"), wt = (e) => Array.isArray(e) ? e.length === 0 ? [W] : e.map(Ct) : [Ct(e)], Tt = (e, t) => {
...
var Bt = {
	...
	let r = Vt()[e];
	return r ? ln(r, t, n) : (Wt.has(e) || (Rt({ log: Qe })(typeof window > "u" ? `Dictionary ${zt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Wt.add(e)), Ut(e));
}, Kt = (e) => {
	...
	if (typeof e == "string") return e;
	if (J(e)) return e.nodeType === "html" ? e[v] : e[Me];
}, Xt = (e, t) => {
...
var Z = {
	...
	if (!X) for (let t = 0; t < (N.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(N.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, _n = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !X && N.storage.cookies) for (let n = 0; n < N.storage.cookies.length; n++) {
