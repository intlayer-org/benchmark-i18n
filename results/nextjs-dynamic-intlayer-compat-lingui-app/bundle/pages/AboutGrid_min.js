...
var Je = (e, t, n) => e[z("PluralRules", n).select(t)] ?? e.other, Ye = (e, t) => {
...
}, $e = (e) => (t, n = {}, r = "en") => Qe(typeof t == "string" ? e(t) : t, n, r), et = (e) => {
	...
	lookupBoundDictionaries(e) {
		let { dictionaryKey: t, remainder: n } = nt(e), r = this._boundDictionaries[t];
		if (r !== void 0) {
			let e = v(r, n);
	...
	_(e, t, n) {
		...
		return (c.kind === "node" ? Qe(c.node, o, s) : tt(c.message, o, s)) ?? i;
	}
...
var W = {
	...
	if (!ot) for (let t = 0; t < (I.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(I.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, ct = !1, lt, ut = () => typeof window > "u" ? st(W) : (ct ||= (lt = st(W), !0), lt), dt = (e, t) => {
	if (t?.isCookieEnabled !== !1 && (ct = !1, !ot && I.storage.cookies)) for (let n = 0; n < I.storage.cookies.length; n++) {
...
}, ft = /* @__PURE__ */ new WeakMap(), pt = 0, mt = (e) => {
	if (!e) return "base";
	let t = ft.get(e);
	if (t) return t;
	pt += 1;
	let n = `p${pt}`;
	return ft.set(e, n), n;
}, ht = 256, G = /* @__PURE__ */ new WeakMap(), gt = (e) => typeof e == "object" && !!e, _t = (e, t, n) => `${e}_${t}_${mt(n)}`, vt = (e, t) => {
	...
	if (!gt(e)) return n;
	let r = G.get(e);
	return r || (r = /* @__PURE__ */ new Map(), G.set(e, r)), r.size >= ht && r.clear(), r.set(t, n), n;
}, yt = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), q = "\x1B[0m", bt = "\x1B[34m", xt = "\x1B[31m", St = "\x1B[32m", Ct = "\x1B[38;5;3m", wt = (e) => e, Tt = (e, t) => {
...
}), J = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? q : n : q}` : e, Dt = (e, t = Ct, n = q) => [e].flat().map((e) => J(e, t, n)).join(", ");
J("✗", xt), J("✓", St), J("⏲", bt);
var Ot = {
	header: d,
	"open-positions": f,
	...
	let r = kt()[e];
	return r ? tn(r, t, n) : (Mt.has(e) || (Et({ log: Ue })(typeof window > "u" ? `Dictionary ${Dt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Mt.add(e)), jt(e));
}, Pt = (e) => {
...
}, Vt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? X : {
	id: "translation-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "translation",
	transform: (n, r, i) => {
		let a = It(n.translation ?? {}, e, t);
		return i(a, {
			...r,
			children: a,
			keyPath: [...r.keyPath, {
...
}, Ht = X, Ut = (e) => X, Wt = X, Gt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? X : {
	id: "insertion-plugin",
	...
	let i = e?.nodeType;
	if (typeof t != "function" || !i || !Kt.includes(i)) return t;
...
}, Jt = (e, t) => typeof t == "function" && Kt.includes(e?.nodeType ?? "") ? (n) => qt(e, t, n) : t, Yt = X, Xt = X;
process.env.INTLAYER_OPTIMIZED_NESTING;
var Zt = (e) => X, Qt = X, $t = (e, t = !0) => [
	Vt(e ?? F.defaultLocale, t ? F.defaultLocale : void 0),
	Ht,
	Ut(e ?? F.defaultLocale),
	Wt,
	Gt,
	...
	Yt,
	Xt
].filter((e) => e !== X), en = (e, t, n = []) => O(e, {
	...t,
	plugins: n
}), Z = /* @__PURE__ */ new WeakSet(), tn = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = _t(r ?? F.defaultLocale, "", n), o = vt(e, a);
...
}, on = (e, t = F?.locales, n = F?.defaultLocale) => {
	...
	get locale() {
		return nn() ?? F?.defaultLocale;
	},
	setLocale: () => null,
	isCookieEnabled: !0
}), cn = ({ locale: e, defaultLocale: t, variant: r, children: a, setLocale: c, disableEditor: u, isCookieEnabled: d }) => {
	let { locales: f, defaultLocale: p } = F ?? {}, [m, h] = s(() => e ?? nn() ?? t ?? p), [ee, te] = s(e);
	...
	return l(sn.Provider, {
		value: re,
		children: a
	});
}, ln = ({ children: e, ...t }) => u(cn, {
	...t,
	children: [
		!1,
		!1,
...
}), { defaultLocale: un, locales: Q } = F ?? {}, dn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { locale: i, setLocale: a, isCookieEnabled: o } = r(sn) ?? {};
	return {
		locale: i,
		defaultLocale: un,
		availableLocales: Q,
	...
	let { i18n: t, defaultComponent: n } = gn();
	return vn(e, t, n);
}, yn = (e) => new rt({
	...e,
	registry: hn()
...
function Tn({ children: e, locale: t, messages: n }) {
	let r = o(() => wn(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		Cn("AppRoot", c);
	}, [c]), i(() => {
