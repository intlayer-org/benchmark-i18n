...
var rt = (e, t, n) => e[A("PluralRules", n).select(t)] ?? e.other, it = (e, t) => {
...
}, bt = (e) => e === void 0 ? H : typeof e == "string" ? U(e, _t) : Object.keys(e).sort().map((t) => `${U(t, vt)}=${U(String(e[t]), vt)}`).join("&"), xt = (e) => Array.isArray(e) ? e.length === 0 ? [H] : e.map(bt) : [bt(e)], St = (e, t) => {
	...
	if (!wt(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? H : St(xt(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Ct(e, n, t, s)).map((t) => Tt(e, t));
...
}).join("|") : "", W = "\x1B[0m", kt = "\x1B[34m", At = "\x1B[31m", jt = "\x1B[32m", Mt = "\x1B[38;5;3m", Nt = (e) => e, Pt = (e, t) => {
...
}), G = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? W : n : W}` : e, It = (e, t = Mt, n = W) => [e].flat().map((e) => G(e, t, n)).join(", ");
G("✗", At), G("✓", jt), G("⏲", kt);
var Lt = {
	header: l,
	"open-positions": u,
	...
	yield e;
} : Bt(e ? `${e}.${String(n)}` : String(n)) }), K = /* @__PURE__ */ new Set(), Vt = (e, t, n) => {
	let r = Rt()[e];
	return r ? an(r, t, n) : (K.has(e) || (Ft({ log: Ze })(typeof window > "u" ? `Dictionary ${It(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), K.add(e)), Bt(e));
}, Ht = (e) => {
	...
	if (typeof e == "string") return e;
	if (q(e)) return e.nodeType === "html" ? e[y] : e[Fe];
}, Kt = (e, t) => {
...
var en = (e) => J, tn = J, nn = (e, t = !0) => [
	Jt(e ?? D.defaultLocale, t ? D.defaultLocale : void 0),
	Yt,
	Xt,
	Zt,
	en(e ?? D.defaultLocale),
	tn,
	Qt,
	$t
], rn = (e, t, n = []) => x(e, {
	...
	let { locale: r, selector: i } = Dt(t), a = mt(r ?? D.defaultLocale, Ot(i), n), o = ht(e, a);
	if (o.hit) return o.content;
	let s = n ?? nn(r), c = Et(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var Y = {
	...
	if (!fn) for (let t = 0; t < (O.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(O.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, mn = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !fn && O.storage.cookies) for (let n = 0; n < O.storage.cookies.length; n++) {
...
}, Sn = (e, t = D?.locales, n = D?.defaultLocale) => {
...
}), { defaultLocale: Tn, locales: Z } = D ?? {}, En = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/pages/blog/BlogHeader.tsx";
function Pn() {
	let { i18n: e } = Q();
...
var Hn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/pages/blog/BlogHeader.wrapper.tsx";
function Un() {
