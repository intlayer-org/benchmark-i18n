...
import { Fragment as h, jsx as g, jsxs as Se } from "react/jsx-runtime";
var Ce = class {
...
}, v = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(Ee).join("") : String(e ?? ""), De = "translation", Oe = "enumeration", ke = "plural", y = "insertion", Ae = "object", je = "array", b = "markdown", x = "html", S = "gender", C = "select", w = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), T = (e, t) => {
...
})() }), Ie = (e) => w(ke, e), Le = (e, t) => w(C, e, { variable: t }), Re = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
var it = (e, t, n) => e[L("PluralRules", n).select(t)] ?? e.other, at = (e, t) => {
	...
	if (r.nodeType === "enumeration") {
		let e = r[Oe], i = ot.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
var X = {
	...
	let { i18n: c, defaultComponent: l } = $(), u = c._(e, n ?? {}, { message: t }), d = r && Object.keys(r).length > 0, f;
	if (d) {
		let e = Fn(pt(u), r);
		f = g(h, { children: e });
	} else f = u;
