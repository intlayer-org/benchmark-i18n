...
var qt = (e) => Z, Jt = Z, Yt = (e, t = !0) => [
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), rn = ({ locale: e, defaultLocale: n, variant: i, children: a, setLocale: l, disableEditor: u, isCookieEnabled: d }) => {
	let { locales: f, defaultLocale: ee } = P ?? {}, [p, m] = s(() => e ?? Qt() ?? n ?? ee), [te, ne] = s(e);
...
function yn({ children: e, locale: t, messages: n }) {
	let i = o(() => vn(t, n), [t, n]), [l] = s(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		_n("AppRoot", l);
	}, [l]), r(() => {
