...
}, _ = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(Ee).join("") : String(e ?? ""), De = "translation", Oe = "enumeration", v = "plural", y = "insertion", ke = "object", Ae = "array", je = "markdown", b = "html", Me = "gender", Ne = "select", x = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), S = (e, t) => {
...
})() }), ze = (e) => x(v, e), Be = (e, t) => x(Ne, e, { variable: t }), Ve = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
var st = (e, t, n) => e[N("PluralRules", n).select(t)] ?? e.other, ct = (e, t) => {
	...
	if (r.nodeType === "enumeration") {
		let e = r[Oe], i = lt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[Ne], i = I(t, typeof r.variable == "string" ? r.variable : "value");
	...
	i18next: Ke,
	"vue-i18n": Ze
}, mt = (e, t = {}, n = "en", r = "icu") => ft(pt[r])(e, t, n), R = class extends Ce {
	_locale;
	_locales;
	_catalogs = {};
...
var Vt = {
	...
	let r = J()[e];
	return r ? ln(r, t, n) : (Wt.has(e) || (zt({ log: et })(typeof window > "u" ? `Dictionary ${Bt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Wt.add(e)), Ut(e));
}, Kt = (e) => {
	...
	if (typeof e == "string") return e;
	if (Y(e)) return e.nodeType === "html" ? e[b] : e[je];
}, Xt = (e, t) => {
	if (typeof e == "string") return t;
	if (Y(e)) {
		let n = e.nodeType === "html" ? b : je;
		return {
			...e,
			[n]: t
		};
...
var Z = {
	...
	let { locales: l, defaultLocale: u } = j ?? {}, [d, f] = s(e ?? yn ?? t ?? u);
	r(() => {
		e && e !== d && f(e);
	}, [e]), r(() => {
		Tn();
...
function zn({ children: e, locale: t, messages: n }) {
	let o = a(() => Rn(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		Ln("AppRoot", c);
	}, [c]), r(() => {
