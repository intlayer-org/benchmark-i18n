...
var Y = {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), vn = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: a, disableEditor: o, isCookieEnabled: c }) => {
	let { locales: l, defaultLocale: ee } = j ?? {}, [u, d] = s(e ?? X ?? t ?? ee);
	r(() => {
		e && e !== u && d(e);
	}, [e]), r(() => {
		gn();
...
wn({ locale: "en" });
var Tn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/MockBanner.tsx", En = () => {
	let { i18n: e } = Sn();
	return p("div", {
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/pages/contact/ContactHeader.tsx";
function Dn() {
	let { i18n: e } = Sn();
	return p(Te, { children: [
		p(En, {}, void 0, !1, {
			fileName: $,
			lineNumber: 11,
			columnNumber: 7
...
var jn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/AppProviders.tsx";
function Mn({ children: e, locale: t, messages: n }) {
	let o = a(() => An(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		kn("AppRoot", c);
	}, [c]), r(() => {
...
var Nn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
...
var Fn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/pages/contact/ContactHeader.wrapper.tsx";
function In() {
