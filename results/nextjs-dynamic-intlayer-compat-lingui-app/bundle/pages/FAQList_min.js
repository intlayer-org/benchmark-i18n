...
}, h = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(De).join("") : String(e ?? ""), Oe = "translation", ke = "enumeration", Ae = "plural", g = "insertion", je = "object", Me = "array", Ne = "markdown", _ = "html", Pe = "gender", v = "select", y = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), b = (e, t) => {
...
})() }), D = (e) => y(Ae, e), O = (e, t) => y(v, e, { variable: t }), ze = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
var rt = (e, t, n) => e[I("PluralRules", n).select(t)] ?? e.other, it = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return V(r[g], t, n);
	if (r.nodeType === "html") return V(r[_], t, n);
	if (r.nodeType === "plural") {
		let e = r[Ae];
		return V(rt(e, Number(B(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[ke], i = L.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[v], i = B(t, typeof r.variable == "string" ? r.variable : "value");
	...
	i18next: We,
	"vue-i18n": Ye
}, lt = (e, t = {}, n = "en", r = "icu") => st(ct[r])(e, t, n), ut = class extends Te {
	_locale;
	_locales;
	_catalogs = {};
...
var zt = {
	...
	if (typeof e == "string") return e;
	if (Y(e)) return e.nodeType === "html" ? e[_] : e[Ne];
}, Yt = (e, t) => {
	if (typeof e == "string") return t;
	if (Y(e)) {
		let n = e.nodeType === "html" ? _ : Ne;
		return {
			...e,
			[n]: t
		};
