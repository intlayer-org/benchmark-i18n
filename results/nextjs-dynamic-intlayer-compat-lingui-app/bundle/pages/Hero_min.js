...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/pages/home/Hero.tsx";
function Mn() {
	let { i18n: e } = Tn();
	return jn("Hero"), h("section", {
...
function Ln({ children: e, locale: t, messages: n }) {
	let r = o(() => Fn(t, n), [t, n]), [s] = c(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		Pn("AppRoot", s);
	}, [s]), i(() => {
...
var Bn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/pages/home/Hero.wrapper.tsx";
function Vn() {
