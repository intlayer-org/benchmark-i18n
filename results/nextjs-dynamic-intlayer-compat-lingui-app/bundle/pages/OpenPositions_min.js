...
}, g = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(De).join("") : String(e ?? ""), Oe = "translation", ke = "enumeration", _ = "plural", v = "insertion", Ae = "object", je = "array", Me = "markdown", y = "html", Ne = "gender", Pe = "select", b = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), x = (e, t) => {
...
})() }), ze = (e) => b(_, e), Be = (e, t) => b(Pe, e, { variable: t }), Ve = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
var st = (e, t, n) => e[N("PluralRules", n).select(t)] ?? e.other, ct = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return L(r[v], t, n);
...
}, K = (e) => e === void 0 ? W : typeof e == "string" ? G(e, xt) : Object.keys(e).sort().map((t) => `${G(t, St)}=${G(String(e[t]), St)}`).join("&"), wt = (e) => Array.isArray(e) ? e.length === 0 ? [W] : e.map(K) : [K(e)], Tt = (e, t) => {
	...
	if (!Dt(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? W : Tt(wt(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Et(e, n, t, s)).map((t) => Ot(e, t));
...
}).join("|") : "", q = "\x1B[0m", Mt = "\x1B[34m", Nt = "\x1B[31m", Pt = "\x1B[32m", Ft = "\x1B[38;5;3m", It = (e) => e, Lt = (e, t) => {
...
}), J = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? q : n : q}` : e, zt = (e, t = Ft, n = q) => [e].flat().map((e) => J(e, t, n)).join(", ");
J("✗", Nt), J("✓", Pt), J("⏲", Mt);
var Bt = {
	header: c,
	"open-positions": l,
	...
	"why-it-matters": xe,
	hero: Se
}, Vt = () => Bt, Ht = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), Ut = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Ht.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : Ut(e ? `${e}.${String(n)}` : String(n)) }), Wt = /* @__PURE__ */ new Set(), Gt = (e, t, n) => {
	let r = Vt()[e];
	return r ? ln(r, t, n) : (Wt.has(e) || (Rt({ log: et })(typeof window > "u" ? `Dictionary ${zt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Wt.add(e)), Ut(e));
}, Kt = (e) => {
	...
	if (typeof e == "string") return e;
	if (Y(e)) return e.nodeType === "html" ? e[y] : e[Me];
}, Xt = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, Qt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? X : {
...
}, $t = X, en = X, tn = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? X : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: v }], i = e[v], a = {
			...
			transform: (e, n, r) => {
				if (Y(e)) return (i) => Zt(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
var an = (e) => X, on = X, sn = (e, t = !0) => [
	Qt(e ?? j.defaultLocale, t ? j.defaultLocale : void 0),
	$t,
	en,
	tn,
	an(e ?? j.defaultLocale),
	on,
	nn,
	rn
], cn = (e, t, n = []) => x(e, {
	...
	let { locale: r, selector: i } = At(t), a = vt(r ?? j.defaultLocale, jt(i), n), o = yt(e, a);
	if (o.hit) return o.content;
	let s = n ?? sn(r), c = kt(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
}, gn = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false";
...
var Z = {
	...
	if (!gn) for (let t = 0; t < (M.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(M.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, vn = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !gn && M.storage.cookies) for (let n = 0; n < M.storage.cookies.length; n++) {
	...
	locale: yn ?? j?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), Dn = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: a, disableEditor: o, isCookieEnabled: c }) => {
	let { locales: l, defaultLocale: ee } = j ?? {}, [u, d] = s(e ?? yn ?? t ?? ee);
	r(() => {
		e && e !== u && d(e);
	}, [e]), r(() => {
		Tn();
...
function Rn({ children: e, locale: t, messages: n }) {
	let o = a(() => Ln(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		In("AppRoot", c);
	}, [c]), r(() => {
