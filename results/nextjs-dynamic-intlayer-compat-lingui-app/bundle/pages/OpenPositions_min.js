...
wn({ locale: "en" });
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/pages/careers/OpenPositions.tsx";
function Tn() {
	let { i18n: e } = Sn(), t = [{
		title: e._({
...
function An({ children: e, locale: t, messages: n }) {
	let o = a(() => On(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		Dn("AppRoot", c);
	}, [c]), r(() => {
...
var Nn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/pages/careers/OpenPositions.wrapper.tsx";
function Pn() {
