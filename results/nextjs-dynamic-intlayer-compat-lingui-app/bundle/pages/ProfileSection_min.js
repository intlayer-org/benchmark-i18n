...
import { Fragment as m, jsx as h, jsxs as we } from "react/jsx-runtime";
...
var Y = {
	...
	let { locales: c, defaultLocale: u } = D ?? {}, [d, f] = l(e ?? hn ?? t ?? u);
	i(() => {
		e && e !== d && f(e);
	}, [e]), i(() => {
		xn();
...
jn({ locale: "en" });
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/pages/settings/ProfileSection.tsx";
function Mn() {
	let { i18n: e } = Dn(), t = a(), n = a();
	return g("section", {
		...
		children: [g("h2", {
			...
			className: "space-y-4",
			children: [g("div", { children: [g("label", {
				htmlFor: t,
...
var Bn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-lingui-app/components/pages/settings/ProfileSection.wrapper.tsx";
function Vn() {
	return g(zn, { children: g(Mn, {}, void 0, !1, {
		fileName: Bn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
