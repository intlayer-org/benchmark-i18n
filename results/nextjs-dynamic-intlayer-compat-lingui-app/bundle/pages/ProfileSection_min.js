...
}, we = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(Ce).join("") : String(e ?? ""), Te = "translation", S = "enumeration", C = "plural", Ee = "condition", w = "insertion", De = "object", Oe = "array", T = "markdown", E = "html", D = "gender", O = "select", k = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), A = (e, t, n) => ({
...
})() }), Pe = (e) => k(C, e), Fe = (e, t) => k(O, e, { variable: t }), Ie = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
function B(e, t, n) {
	let r = t ?? R?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = Ue.get(a);
...
var Je = (e, t, n) => e[B("PluralRules", n).select(t)] ?? e.other, Ye = (e, t) => {
...
}, et = (e) => (t, n = {}, r = "en") => $e(typeof t == "string" ? e(t) : t, n, r), tt = (e) => {
	...
	lookupBoundDictionaries(e) {
		let { dictionaryKey: t, remainder: n } = rt(e), r = this._boundDictionaries[t];
		if (r !== void 0) {
			let e = x(r, n);
	...
	_(e, t, n) {
		...
		return (c.kind === "node" ? $e(c.node, o, s) : nt(c.message, o, s)) ?? i;
	}
...
var W = {
	...
	if (!st) for (let t = 0; t < (z.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(z.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, lt = !1, ut, dt = () => typeof window > "u" ? ct(W) : (lt ||= (ut = ct(W), !0), ut), ft = (e, t) => {
	if (t?.isCookieEnabled !== !1 && (lt = !1, !st && z.storage.cookies)) for (let n = 0; n < z.storage.cookies.length; n++) {
...
var kt = {
	...
	let r = At()[e];
	return r ? nn(r, t, n) : (Nt.has(e) || (Dt({ log: Ve })(typeof window > "u" ? `Dictionary ${Ot(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Nt.add(e)), Mt(e));
}, Ft = (e) => {
...
var Qt = (e) => X, $t = X, en = (e, t = !0) => [
	Ht(e ?? R.defaultLocale, t ? R.defaultLocale : void 0),
	Ut,
	Wt(e ?? R.defaultLocale),
	Gt,
	Kt,
	Qt(e ?? R.defaultLocale),
	$t,
	Xt,
	Zt
].filter((e) => e !== X), tn = (e, t, n = []) => j(e, {
	...t,
	plugins: n
	...
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = vt(r ?? R.defaultLocale, "", n), o = yt(e, a);
...
}, sn = (e, t = R?.locales, n = R?.defaultLocale) => {
...
}), { defaultLocale: dn, locales: Q } = R ?? {}, fn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
