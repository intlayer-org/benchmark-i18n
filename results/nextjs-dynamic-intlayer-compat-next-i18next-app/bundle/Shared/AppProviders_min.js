...
}, tn = ({ children: e, i18n: t }) => (t !== void 0 && S({ log: m })(`${C("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), u(Zt, { children: e }));
...
function cn({ children: e }) {
	...
	return a(() => {
		...
		i18n: on,
		children: [u(sn, { locale: t }), e]
	});
}
function ln({ children: e }) {
	return u(cn, { children: e });
}
function un() {
	return u(ln, { children: u(cn, {}) });
}
