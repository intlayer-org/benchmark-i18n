...
var d = {
	...
	let n = `p${h}`;
	return m.set(e, n), n;
}, _ = 256, v = /* @__PURE__ */ new WeakMap(), y = (e) => typeof e == "object" && !!e, ee = (e, t, n) => `${e}_${t}_${g(n)}`, te = (e, t) => {
	if (!y(e)) return { hit: !1 };
	let n = v.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, ne = "translation", re = "enumeration", ie = "plural", ae = "insertion", oe = "object", se = "array", ce = "html", le = "gender", ue = "select", x = (e, t) => {
...
}, fe = (e, t) => e[de(e, t) ?? "fallback"], S = "default", pe = /[^A-Za-z0-9._&=-]/g, me = /[^A-Za-z0-9._-]/g, he = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, C = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, he);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, w = (e) => e === void 0 ? S : typeof e == "string" ? C(e, pe) : Object.keys(e).sort().map((t) => `${C(t, me)}=${C(String(e[t]), me)}`).join("&"), T = (e) => Array.isArray(e) ? e.length === 0 ? [S] : e.map(w) : [w(e)], ge = (e, t) => {
	...
	if (!ve(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? S : ge(T(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => _e(e, n, t, s)).map((t) => ye(e, t));
...
}).join("|") : "", E = "\x1B[0m", Ce = "\x1B[34m", we = "\x1B[31m", Te = "\x1B[32m", Ee = "\x1B[35m", De = "\x1B[38;5;3m", D = "\x1B[36m", Oe = (e) => e, ke = (e, t) => {
...
}), k = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? E : n : E}` : e, Ae = (e, t = De, n = E) => [e].flat().map((e) => k(e, t, n)).join(", ");
k("✗", we), k("✓", Te), k("⏲", Ce);
var A = () => ({}), je = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), j = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : je.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : j(e ? `${e}.${String(n)}` : String(n)) }), M = /* @__PURE__ */ new Set(), N = (e, t, n) => {
	let r = A()[e];
	return r ? Ze(r, t, n) : (M.has(e) || (O({ log: p })(typeof window > "u" ? `Dictionary ${Ae(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), M.add(e)), j(e));
}, Me = 50, P = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Set(), Ne = (e) => {
...
function I(e, t, n) {
	let r = t ?? d?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = P.get(a);
...
var Ie = (e, t, n) => e[I("PluralRules", n).select(t)] ?? e.other, Le = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, Ve = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? L : {
...
}, He = L, Ue = L, We = L, Ge = L, Ke = L, qe = (e) => L, Je = L, Ye = (e, t = !0) => [
	Ve(e ?? d.defaultLocale, t ? d.defaultLocale : void 0),
	He,
	Ue,
	We,
	...
	let { locale: r, selector: i } = xe(t), a = ee(r ?? d.defaultLocale, Se(i), n), o = te(e, a);
	if (o.hit) return o.content;
	let s = n ?? Ye(r), c = be(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var B = {
	...
	if (t?.isCookieEnabled !== !1 && !z && f.storage.cookies) for (let n = 0; n < f.storage.cookies.length; n++) {
	...
	locale: V ?? d?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), ct = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: a, disableEditor: s, isCookieEnabled: l }) => {
	let { locales: u, defaultLocale: f } = d ?? {}, [p, m] = o(e ?? V ?? t ?? f);
	r(() => {
		e && e !== p && m(e);
	}, [e]), r(() => {
		ot();
...
var U = (e, t, n = ".") => {
	...
	let r = e;
	if (r.nodeType === "insertion") return J(r[ae], t, n);
	if (r.nodeType === "html") return J(r[ce], t, n);
	...
	let n = {};
	for (let [t, r] of Object.entries(e)) mt.has(t) || (n[t] = r);
	return n;
	...
	else if (m = _t(c, p), m === void 0 && c === t && c !== gt && (m = _t(gt, p)), m === void 0) return;
	let h;
	...
	O({ log: p })(`${k(e, D)}: the ${k("`resources`", D)} option is ignored when using ${k("@intlayer/i18next", Ee)} — translations are served from the compiled intlayer dictionaries instead. Remove the resource imports and the ${k("`resources`", D)} option to reduce your bundle size.`);
}, Q = (e = {}) => {
...
var bt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/AppProviders.tsx";
...
var St = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/scripts/Wrapper.tsx";
...
var wt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/AppProviders.wrapper.tsx";
function Tt() {
	return u(Ct, { children: u(xt, {}, void 0, !1, {
		fileName: wt,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
