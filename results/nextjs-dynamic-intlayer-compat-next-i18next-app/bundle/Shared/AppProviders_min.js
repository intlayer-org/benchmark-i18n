...
var ce = process.env.INTLAYER_EDITOR_ENABLED !== "false" && i?.enabled && typeof window < "u" && window.self !== window.top, le = 50, ue = /* @__PURE__ */ new Map(), de = /* @__PURE__ */ new Set(), fe = (e) => {
...
function T(e, t, n) {
	let r = t ?? o?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, s = ue.get(a);
	s || (s = /* @__PURE__ */ new Map(), ue.set(a, s));
	let c = s.get(i);
	if (!c) {
		let t = typeof e == "string" ? me(e) : e;
		if (typeof t != "function") throw Error(`[intlayer] \`Intl.${String(e)}\` is not available in this JavaScript engine and has no fallback. Load the matching polyfill before formatting.`);
		s.size > le && s.clear(), c = new t(r, n), s.set(i, c);
	}
	return c;
}
var he = (e, t, n) => e[T("PluralRules", n).select(t)] ?? e.other, ge = /* @__PURE__ */ new Set([
	"area",
	"base",
	"br",
	"col",
...
var j = {
	...
	if (n?.isCookieEnabled !== !1) {
		if (!O && e.storage.cookies) for (let r = 0; r < e.storage.cookies.length; r++) {
			...
			try {
				...
				try {
					n?.setCookieString && n.setCookieString(i, be(i, t, a));
				} catch {}
			}
		}
	...
	let { locale: e } = y(N) ?? {}, t = x(null);
	b(() => {
		if (process.env.INTLAYER_EDITOR_ENABLED !== "false" && ce) return import("./esm-B9OWu-GQ.js").then(({ initEditorClient: n }) => {
			let r = n();
...
}, Te = ({ children: e }) => (we(), e), Ee = process.env.INTLAYER_ANALYTICS_ENABLED !== "false" && s?.enabled === !0 && !!i?.clientId && typeof window < "u" && window.self === window.top && !ne(), De = () => {
	let { locale: e } = y(N) ?? {}, t = x(null);
	b(() => {
		if (process.env.INTLAYER_ANALYTICS_ENABLED === "false" || !Ee) return;
		let n = !1, r = !1;
...
}, Ae = (e, t = o?.locales, n = o?.defaultLocale) => {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), je = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: i, disableEditor: a, isCookieEnabled: s }) => {
	let { locales: c, defaultLocale: l } = o ?? {}, [u, d] = S(e ?? M ?? t ?? l);
	b(() => {
		e && e !== u && d(e);
	}, [e]), b(() => {
		ke();
...
var P = (e) => v(_, e), F = (e) => v(d, e), I = (e, t) => v(h, e, { tags: (() => {
	if (t) return t;
	if (typeof e == "string") {
		let { issues: t } = ve(e);
...
})() }), z = (e) => v(l, e), B = (e, t) => v(te, e, { variable: t }), Ie = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "select") {
		let e = r[te], i = G(t, typeof r.variable == "string" ? r.variable : "value");
	...
	let i = K(typeof e == "string" ? Ze[r](e) : e, t, n);
	...
	else if (m = et(c, p), m === void 0 && c === t && c !== J && (m = et(J, p)), m === void 0) return;
	let h;
	...
	let ee = Y(r), g = q(h, ee, r?.lng ?? e, "i18next");
	return o < $e && g.includes("$t(") && (g = g.replace(/\$t\(\s*([^),]+?)\s*(?:,[^)]*)?\)/g, (n, l) => {
		let u = X({
			locale: e,
			namespace: c,
			key: l.trim(),
	...
	let t = o, n = e.lng ?? t?.defaultLocale ?? "en", r = e.defaultNS ?? (Array.isArray(e.ns) ? e.ns[0] : e.ns) ?? "translation", i = /* @__PURE__ */ new Map(), a = !1, s = (e, ...t) => {
		...
		return typeof o == "string" ? q(o, Y(i), e, "i18next") : n;
	}, u = {
		get language() {
			return n;
		},
		...
		async init(e, t) {
			...
			i.resources !== void 0 && nt("i18next.init"), i.lng && (n = i.lng), i.defaultNS ? r = i.defaultNS : i.ns && (r = Array.isArray(i.ns) ? i.ns[0] : i.ns), a = !0, s("initialized", i);
			let o = u.t.bind(u);
		...
		t(e, t, i) {
			...
			return typeof s == "string" ? q(s, Y(a), n, "i18next") : s ?? (Array.isArray(e) ? e[e.length - 1] : e);
		},
...
var rt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/AppProviders.tsx";
...
var at = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/scripts/Wrapper.tsx";
function ot({ children: e }) {
	return w(it, { children: e }, void 0, !1, {
		fileName: at,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/AppProviders.wrapper.tsx";
function st() {
	return w(ot, { children: w(it, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
