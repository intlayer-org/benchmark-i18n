...
var Se = "translation", T = "enumeration", Ce = "plural", we = "insertion", Te = "object", Ee = "array", De = "html", Oe = "gender", E = "select", D = (e, t, n) => ({
	...
	yield e;
} : wt(e ? `${e}.${String(n)}` : String(n)) }), Tt = /* @__PURE__ */ new Set(), K = (e, t, n) => {
	let r = St()[e];
	return r ? zt(r, t, n) : (Tt.has(e) || (C({ log: v })(typeof window > "u" ? `Dictionary ${xe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Tt.add(e)), wt(e));
}, Et = (e) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, kt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? q : {
...
}, At = q, jt = q, Mt = q, Nt = q, Pt = q, Ft = (e) => q, It = q, Lt = (e, t = !0) => [
