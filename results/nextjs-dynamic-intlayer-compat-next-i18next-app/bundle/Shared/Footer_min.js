...
}, ge = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false", _e = process.env.INTLAYER_ROUTING_STORAGE_LOCALSTORAGE === "false", D = process.env.INTLAYER_ROUTING_STORAGE_SESSIONSTORAGE === "false";
...
var O = {
	...
	if (!_e) for (let n = 0; n < (e.storage.localStorage ?? []).length; n++) try {
		let i = t?.getLocaleStorage?.(e.storage.localStorage[n].name);
		if (r(i)) return i;
	} catch {}
	if (!D && e.storage.sessionStorage) for (let n = 0; n < e.storage.sessionStorage.length; n++) try {
	...
	if (n?.isCookieEnabled !== !1) {
		...
		if (!_e && e.storage.localStorage && n?.setLocaleStorage) for (let r = 0; r < e.storage.localStorage.length; r++) {
		...
		if (!D && e.storage.sessionStorage && n?.setSessionStorage) for (let r = 0; r < e.storage.sessionStorage.length; r++) {
...
}, Se = 50, k = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Set(), Ce = (e) => {
...
var M = (e) => v(ee, e), N = (e) => v(d, e), Ee = (e) => {
...
})() }), Ae = (e) => v(l, e), je = (e, t) => v(y, e, { variable: t }), Me = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}), Ue = (e, t, n) => e[j("PluralRules", n).select(t)] ?? e.other, H = [
	"__intlayer_icu_var",
	...
	return String(e);
}, Ge = (e, t = {}, n = "en") => e.replace(/\{\{\s*([^{}]+?)\s*\}\}/g, (e, n) => {
	let r = U(t, n);
	...
	if (r.nodeType === "plural") {
		let e = r[l];
		return G(Ue(e, Number(W(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[ee], i = H.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[y], i = W(t, typeof r.variable == "string" ? r.variable : "value");
	...
	let i = G(typeof e == "string" ? Ke[r](e) : e, t, n);
	...
	else if (m = Xe(c, p), m === void 0 && c === t && c !== Ye && (m = Xe(Ye, p)), m === void 0) return;
	let h;
	for (let t of Ze(l, r?.lng ?? e, u, d, f)) {
		let e = B(m, t, i);
		if (e != null) {
			h = e;
			break;
	...
	return o < Je && _.includes("$t(") && (_ = _.replace(/\$t\(\s*([^),]+?)\s*(?:,[^)]*)?\)/g, (n, l) => {
		let u = J({
			locale: e,
			namespace: c,
			key: l.trim(),
...
var $e = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	let o = (t, n) => J({
		locale: e,
		namespace: r,
		key: i ? `${i}.${t}` : t,
...
}, et = process.env.INTLAYER_EDITOR_ENABLED !== "false" && i?.enabled && typeof window < "u" && window.self !== window.top, tt = ve(O), nt = (e, t) => ye(e, {
	...O,
	isCookieEnabled: t
}), rt = () => {
	let { locale: e } = b(Z) ?? {}, t = se(null);
	x(() => {
		if (process.env.INTLAYER_EDITOR_ENABLED !== "false" && et) return import("./esm-D95LQG8s.js").then(({ initEditorClient: n }) => {
			let r = n();
...
}, it = ({ children: e }) => (rt(), e), at = process.env.INTLAYER_ANALYTICS_ENABLED !== "false" && s?.enabled === !0 && !!i?.clientId && typeof window < "u" && window.self === window.top && !te(), ot = () => {
	let { locale: e } = b(Z) ?? {}, t = se(null);
	x(() => {
		if (process.env.INTLAYER_ANALYTICS_ENABLED === "false" || !at) return;
		let n = !1, r = !1;
	...
	locale: tt ?? o?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), lt = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: i, disableEditor: a, isCookieEnabled: s }) => {
	let { locales: c, defaultLocale: l } = o ?? {}, [u, d] = ce(e ?? tt ?? t ?? l);
	x(() => {
		e && e !== u && d(e);
	}, [e]), x(() => {
		ct();
...
}), { defaultLocale: dt, locales: Q } = o ?? {}, ft = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = ft(), o = t?.keyPrefix, { translate: s, i18n: c } = oe(() => $e({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
var xt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/scripts/Wrapper.tsx";
function St({ children: e }) {
	return w(bt, { children: e }, void 0, !1, {
		fileName: xt,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var Ct = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/Footer.wrapper.tsx";
function wt() {
	return w(St, { children: w(ht, {}, void 0, !1, {
		fileName: Ct,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
