...
var E = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/Link.tsx", ue = (e) => /^https?:\/\//.test(e ?? "");
function de(e, t) {
	return !e.startsWith("/") || e === `/${t}` || e.startsWith(`/${t}/`) ? e : `/${t}${e === "/" ? "" : e}`;
}
var fe = ({ href: e, children: t, ...n }) => {
	let r = C().locale ?? "en";
...
}, ge = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false", D = process.env.INTLAYER_ROUTING_STORAGE_LOCALSTORAGE === "false", O = process.env.INTLAYER_ROUTING_STORAGE_SESSIONSTORAGE === "false";
...
var k = {
	...
	if (!ge) for (let n = 0; n < (e.storage.cookies ?? []).length; n++) try {
		let i = t?.getCookie?.(e.storage.cookies[n].name);
		if (r(i)) return i;
	} catch {}
	if (!D) for (let n = 0; n < (e.storage.localStorage ?? []).length; n++) try {
		let i = t?.getLocaleStorage?.(e.storage.localStorage[n].name);
		if (r(i)) return i;
	} catch {}
	if (!O && e.storage.sessionStorage) for (let n = 0; n < e.storage.sessionStorage.length; n++) try {
		let i = t?.getSessionStorage?.(e.storage.sessionStorage[n].name);
		if (r(i)) return i;
	} catch {}
}, ve = (t, n) => {
	if (n?.isCookieEnabled !== !1) {
		if (!ge && e.storage.cookies) for (let r = 0; r < e.storage.cookies.length; r++) {
			let { name: i, attributes: a } = e.storage.cookies[r];
			try {
				n?.setCookieStore && n.setCookieStore(i, t, {
					...a,
					expires: me(a.expires)
				});
			} catch {
				try {
					n?.setCookieString && n.setCookieString(i, he(i, t, a));
				} catch {}
			}
		}
		if (!D && e.storage.localStorage && n?.setLocaleStorage) for (let r = 0; r < e.storage.localStorage.length; r++) {
		...
		if (!O && e.storage.sessionStorage && n?.setSessionStorage) for (let r = 0; r < e.storage.sessionStorage.length; r++) {
...
}, xe = 50, A = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Set(), Se = (e) => {
...
function M(e, t, n) {
	let r = t ?? o?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, s = A.get(a);
	s || (s = /* @__PURE__ */ new Map(), A.set(a, s));
	let c = s.get(i);
	if (!c) {
...
var N = (e) => v(ee, e), P = (e) => v(d, e), Te = (e) => {
...
})() }), ke = (e) => v(l, e), Ae = (e, t) => v(y, e, { variable: t }), je = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}), He = (e, t, n) => e[M("PluralRules", n).select(t)] ?? e.other, U = [
	"__intlayer_icu_var",
	...
	if (r.nodeType === "enumeration") {
		let e = r[ee], i = U.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[y], i = G(t, typeof r.variable == "string" ? r.variable : "value");
		return K(u(e, String(i ?? "")), t, n);
	}
	...
	let i = K(typeof e == "string" ? Ge[r](e) : e, t, n);
	...
	else if (m = Ye(c, p), m === void 0 && c === t && c !== Je && (m = Ye(Je, p)), m === void 0) return;
	let h;
	for (let t of Xe(l, r?.lng ?? e, u, d, f)) {
		let e = V(m, t, i);
		if (e != null) {
			h = e;
			break;
	...
	e.resources !== void 0 && Ze("createInstance");
	let t = o, n = e.lng ?? t?.defaultLocale ?? "en", r = e.defaultNS ?? (Array.isArray(e.ns) ? e.ns[0] : e.ns) ?? "translation", i = /* @__PURE__ */ new Map(), a = !1, s = (e, ...t) => {
		...
		async init(e, t) {
			...
			i.resources !== void 0 && Ze("i18next.init"), i.lng && (n = i.lng), i.defaultNS ? r = i.defaultNS : i.ns && (r = Array.isArray(i.ns) ? i.ns[0] : i.ns), a = !0, s("initialized", i);
			let o = u.t.bind(u);
...
var Qe = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	let o = (t, n) => Y({
		locale: e,
		namespace: r,
		key: i ? `${i}.${t}` : t,
...
}, $e = process.env.INTLAYER_EDITOR_ENABLED !== "false" && i?.enabled && typeof window < "u" && window.self !== window.top, et = _e(k), tt = (e, t) => ve(e, {
	...k,
	isCookieEnabled: t
}), nt = () => {
	let { locale: e } = b(Q) ?? {}, t = se(null);
	x(() => {
		if (process.env.INTLAYER_EDITOR_ENABLED !== "false" && $e) return import("./esm-D95LQG8s.js").then(({ initEditorClient: n }) => {
			let r = n();
...
}, rt = ({ children: e }) => (nt(), e), it = process.env.INTLAYER_ANALYTICS_ENABLED !== "false" && s?.enabled === !0 && !!i?.clientId && typeof window < "u" && window.self === window.top && !te(), at = () => {
	let { locale: e } = b(Q) ?? {}, t = se(null);
	x(() => {
		if (process.env.INTLAYER_ANALYTICS_ENABLED === "false" || !it) return;
		let n = !1, r = !1;
	...
	locale: et ?? o?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), ct = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: i, disableEditor: a, isCookieEnabled: s }) => {
	let { locales: c, defaultLocale: l } = o ?? {}, [u, d] = ce(e ?? et ?? t ?? l);
	x(() => {
		e && e !== u && d(e);
	}, [e]), x(() => {
		st();
...
}), ut = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { defaultLocale: n, locales: r } = o ?? {}, { locale: i, setLocale: a, isCookieEnabled: s } = b(Q) ?? {};
	return {
		locale: i,
		defaultLocale: n,
		availableLocales: r,
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = ut(), o = t?.keyPrefix, { translate: s, i18n: c } = oe(() => Qe({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
var ft = {
	type: "3rdParty",
	init: (e) => {}
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/Footer.tsx";
function pt() {
	let { t: e } = dt(), t = [
		{
			...
			children: [w("div", {
				...
				children: [
					...
					w("div", { children: [w("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => w("li", { children: e.isInternal ? w(fe, {
							href: e.href,
...
function vt({ children: e }) {
	let t = C().locale ?? "en", [n] = ce(() => typeof performance < "u" ? performance.now() : 0);
	return ae(() => {
		gt("AppRoot", n);
	}, [n]), x(() => {
...
var xt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/Footer.wrapper.tsx";
function St() {
