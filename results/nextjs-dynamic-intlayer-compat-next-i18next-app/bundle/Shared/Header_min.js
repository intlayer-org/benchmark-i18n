...
var Ce = "translation", we = "enumeration", Te = "plural", Ee = "insertion", De = "object", Oe = "array", ke = "html", Ae = "gender", je = "select", D = (e, t, n) => ({
	...
	yield e;
} : Ot(e ? `${e}.${String(n)}` : String(n)) }), kt = /* @__PURE__ */ new Set(), G = (e, t, n) => {
	let r = Et()[e];
	return r ? Ut(r, t, n) : (kt.has(e) || (T({ log: b })(typeof window > "u" ? `Dictionary ${Se(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), kt.add(e)), Ot(e));
}, At = (e) => {
...
}, Pt = K, Ft = K, It = K, Lt = K, Rt = K, zt = (e) => K, Bt = K, Vt = (e, t = !0) => [
	Nt(e ?? v.defaultLocale, t ? v.defaultLocale : void 0),
	Pt,
	Ft,
	It,
	zt(e ?? v.defaultLocale),
	Bt,
	Lt,
	Rt
], Ht = (e, t, n = []) => O(e, {
	...
	"nsMode",
	"keyPrefix"
]), Gt = 5, Kt = "index", qt = (e, t) => {
	if (e in Et()) return G(e, t);
}, Jt = (e, t, n, r, i) => {
	...
	let n = {};
	for (let [t, r] of Object.entries(e)) Wt.has(t) || (n[t] = r);
	return n;
	...
	else if (m = qt(c, p), m === void 0 && c === t && c !== Kt && (m = qt(Kt, p)), m === void 0) return;
	let h;
	...
	return o < Gt && g.includes("$t(") && (g = g.replace(/\$t\(\s*([^),]+?)\s*(?:,[^)]*)?\)/g, (n, l) => {
		let u = J({
			locale: e,
			namespace: c,
			key: l.trim(),
...
var Xt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	locale: Zt ?? v?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), an = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: o, isCookieEnabled: s }) => {
	let { locales: l, defaultLocale: u } = v ?? {}, [d, f] = c(e ?? Zt ?? t ?? u);
	i(() => {
		e && e !== d && f(e);
	}, [e]), i(() => {
		rn();
...
}), { defaultLocale: sn, locales: Q } = v ?? {}, cn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = cn(), s = t?.keyPrefix, { translate: c, i18n: l } = o(() => Xt({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
}, ln = ({ children: e, i18n: t }) => (t !== void 0 && T({ log: b })(`${E("I18nextProvider", S)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), p(on, { children: e }));
...
function pn() {
	...
	i(() => {
		...
		if (t !== "auto") return;
		let e = window.matchMedia("(prefers-color-scheme: dark)"), n = () => fn("auto");
	...
	function r() {
		...
		n(e), fn(e), window.localStorage.setItem("theme", e);
	}
...
function Cn({ children: e }) {
	...
	return a(() => {
		...
		i18n: xn,
		children: [p(Sn, { locale: t }), e]
	});
}
function wn({ children: e }) {
	return p(Cn, { children: e });
}
function Tn() {
	return p(wn, { children: p(vn, {}) });
}
