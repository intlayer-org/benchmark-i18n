...
var ee = ({ href: e, children: t, ...n }) => {
	let r = u().locale ?? "en";
	return e == null || typeof e != "string" || m(e) ? d(l, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, y = "\x1B[0m", te = "\x1B[34m", ne = "\x1B[31m", re = "\x1B[32m", ie = "\x1B[35m", ae = "\x1B[38;5;3m", b = "\x1B[36m", oe = (e, t = g?.locales, n = g?.defaultLocale) => {
...
var x = {
	...
	if (!le) for (let t = 0; t < (_.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(_.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, de = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !le && _.storage.cookies) for (let n = 0; n < _.storage.cookies.length; n++) {
...
}, me = 50, he = /* @__PURE__ */ new Map(), S = /* @__PURE__ */ new Set(), ge = (e) => {
	S.has(e) || (S.add(e), console.warn(`[intlayer] \`Intl.${e}\` is not available in this JavaScript engine. A degraded fallback is used instead. On React Native, load a polyfill (e.g. \`@formatjs/intl-${e.toLowerCase()}/polyfill\`) before rendering your app.`));
}, _e = {
	DisplayNames: class {
		of(e) {
			return e;
...
function C(e, t, n) {
	let r = t ?? g?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = he.get(a);
...
}), T = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? y : n : y}` : e, xe = (e, t = ae, n = y) => [e].flat().map((e) => T(e, t, n)).join(", ");
T("✗", ne), T("✓", re), T("⏲", te);
var Se = "translation", Ce = "enumeration", E = "plural", we = "insertion", Te = "object", Ee = "array", D = "html", De = "gender", Oe = "select", O = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), k = (e, t) => {
...
})() }), Pe = (e) => O(E, e), Fe = (e, t) => O(Oe, e, { variable: t }), Ie = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, Ye = (e, t) => e[Je(e, t) ?? "fallback"], Xe = (e, t, n) => e[C("PluralRules", n).select(t)] ?? e.other, Ze = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return B(r[we], t, n);
	...
	if (r.nodeType === "enumeration") {
		let e = r[Ce], i = Qe.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
}, nt = (e) => (t, n = {}, r = "en") => tt(typeof t == "string" ? e(t) : t, n, r), rt = {
	icu: Re,
	i18next: Ve,
	"vue-i18n": qe
}, V = (e, t = {}, n = "en", r = "icu") => nt(rt[r])(e, t, n), it = /* @__PURE__ */ new WeakMap(), at = 0, ot = (e) => {
	if (!e) return "base";
	let t = it.get(e);
	if (t) return t;
	at += 1;
	let n = `p${at}`;
	return it.set(e, n), n;
}, st = 256, H = /* @__PURE__ */ new WeakMap(), ct = (e) => typeof e == "object" && !!e, lt = (e, t, n) => `${e}_${t}_${ot(n)}`, ut = (e, t) => {
	...
	if (!ct(e)) return n;
	let r = H.get(e);
	return r || (r = /* @__PURE__ */ new Map(), H.set(e, r)), r.size >= st && r.clear(), r.set(t, n), n;
}, W = "default", dt = /[^A-Za-z0-9._&=-]/g, ft = /[^A-Za-z0-9._-]/g, pt = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, G = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, pt);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, mt = (e) => e === void 0 ? W : typeof e == "string" ? G(e, dt) : Object.keys(e).sort().map((t) => `${G(t, ft)}=${G(String(e[t]), ft)}`).join("&"), ht = (e) => Array.isArray(e) ? e.length === 0 ? [W] : e.map(mt) : [mt(e)], gt = (e, t) => {
	...
	yield e;
} : Et(e ? `${e}.${String(n)}` : String(n)) }), Dt = /* @__PURE__ */ new Set(), K = (e, t, n) => {
	let r = wt()[e];
	return r ? Vt(r, t, n) : (Dt.has(e) || (w({ log: v })(typeof window > "u" ? `Dictionary ${xe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Dt.add(e)), Et(e));
}, Ot = (e) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, jt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? q : {
...
}, Mt = q, Nt = q, Pt = q, Ft = q, It = q;
process.env.INTLAYER_OPTIMIZED_NESTING;
var Lt = (e) => q, Rt = q, zt = (e, t = !0) => [
	...
	let { locale: r, selector: i } = xt(t), a = lt(r ?? g.defaultLocale, St(i), n), o = ut(e, a);
	...
	let ee = J(r), g = V(h, ee, r?.lng ?? e, "i18next");
	return o < Ut && g.includes("$t(") && (g = g.replace(/\$t\(\s*([^),]+?)\s*(?:,[^)]*)?\)/g, (n, l) => {
		let u = Y({
			locale: e,
			namespace: c,
			key: l.trim(),
	...
	w({ log: v })(`${T(e, b)}: the ${T("`resources`", b)} option is ignored when using ${T("@intlayer/i18next", ie)} — translations are served from the compiled intlayer dictionaries instead. Remove the resource imports and the ${T("`resources`", b)} option to reduce your bundle size.`);
}, X = (e = {}) => {
...
var Jt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let { locales: l, defaultLocale: u } = g ?? {}, [f, p] = c(e ?? Yt ?? t ?? u);
	i(() => {
		e && e !== f && p(e);
	}, [e]), i(() => {
		tn();
...
}), { defaultLocale: an, locales: $ } = g ?? {}, on = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
}, cn = ({ children: e, i18n: t }) => (t !== void 0 && w({ log: v })(`${T("I18nextProvider", b)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), d(rn, { children: e }));
...
function mn({ children: e }) {
	...
	return a(() => {
		...
		i18n: fn,
		children: [d(pn, { locale: t }), e]
	});
}
function hn({ children: e }) {
	return d(mn, { children: e });
}
function gn() {
	return d(hn, { children: d(ee, {}) });
}
