...
import { _ as l, a as u, f as d, i as f, m as p, o as m, p as h, r as ee, s as g, u as te, x as _, y as v } from "./getDictionary-lVOhO-o2.js";
import { n as ne } from "./isBot-CTlYFuov.js";
import * as re from "react";
import { createContext as ie, useContext as ae, useEffect as y, useLayoutEffect as oe, useRef as b, useState as x } from "react";
import S from "next/link";
import { useParams as C } from "next/navigation";
import { jsxDEV as w } from "react/jsx-dev-runtime";
import { jsx as T, jsxs as se } from "react/jsx-runtime";
var E = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/Link.tsx", ce = (e) => /^https?:\/\//.test(e ?? "");
function le(e, t) {
	return !e.startsWith("/") || e === `/${t}` || e.startsWith(`/${t}/`) ? e : `/${t}${e === "/" ? "" : e}`;
}
var ue = ({ href: e, children: t, ...n }) => {
	let r = C().locale ?? "en";
	return e == null || typeof e != "string" ? w(S, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, de = process.env.INTLAYER_EDITOR_ENABLED !== "false" && i?.enabled && typeof window < "u" && window.self !== window.top, fe = 50, pe = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Set(), me = (e) => {
...
function O(e, t, n) {
	let r = t ?? o?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, s = pe.get(a);
	s || (s = /* @__PURE__ */ new Map(), pe.set(a, s));
	let c = s.get(i);
	if (!c) {
		let t = typeof e == "string" ? ge(e) : e;
		if (typeof t != "function") throw Error(`[intlayer] \`Intl.${String(e)}\` is not available in this JavaScript engine and has no fallback. Load the matching polyfill before formatting.`);
		s.size > fe && s.clear(), c = new t(r, n), s.set(i, c);
	}
	return c;
}
var _e = (e, t, n) => e[O("PluralRules", n).select(t)] ?? e.other, ve = /* @__PURE__ */ new Set([
	"area",
	"base",
	"br",
	"col",
...
}, Ce = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false", we = process.env.INTLAYER_ROUTING_STORAGE_LOCALSTORAGE === "false", j = process.env.INTLAYER_ROUTING_STORAGE_SESSIONSTORAGE === "false";
...
var M = {
	...
	if (!Ce) for (let n = 0; n < (e.storage.cookies ?? []).length; n++) try {
		let i = t?.getCookie?.(e.storage.cookies[n].name);
		if (r(i)) return i;
	} catch {}
	if (!we) for (let n = 0; n < (e.storage.localStorage ?? []).length; n++) try {
		let i = t?.getLocaleStorage?.(e.storage.localStorage[n].name);
		if (r(i)) return i;
	} catch {}
	if (!j && e.storage.sessionStorage) for (let n = 0; n < e.storage.sessionStorage.length; n++) try {
		let i = t?.getSessionStorage?.(e.storage.sessionStorage[n].name);
		if (r(i)) return i;
	} catch {}
}, Ee = (t, n) => {
	if (n?.isCookieEnabled !== !1) {
		if (!Ce && e.storage.cookies) for (let r = 0; r < e.storage.cookies.length; r++) {
			...
			try {
				...
				try {
					n?.setCookieString && n.setCookieString(i, Se(i, t, a));
				} catch {}
			}
		}
		if (!we && e.storage.localStorage && n?.setLocaleStorage) for (let r = 0; r < e.storage.localStorage.length; r++) {
		...
		if (!j && e.storage.sessionStorage && n?.setSessionStorage) for (let r = 0; r < e.storage.sessionStorage.length; r++) {
	...
	let { locale: e } = ae(P) ?? {}, t = b(null);
	y(() => {
		if (process.env.INTLAYER_EDITOR_ENABLED !== "false" && de) return import("./esm-B9OWu-GQ.js").then(({ initEditorClient: n }) => {
			let r = n();
			t.current = r, e && r.currentLocale.set(e);
		}).catch(() => {}), () => {
			t.current = null, import("./esm-B9OWu-GQ.js").then(({ stopEditorClient: e }) => {
				e();
			}).catch(() => {});
		};
	}, []), y(() => {
...
}, ke = ({ children: e }) => (Oe(), e), Ae = process.env.INTLAYER_ANALYTICS_ENABLED !== "false" && s?.enabled === !0 && !!i?.clientId && typeof window < "u" && window.self === window.top && !ne(), je = () => {
	let { locale: e } = ae(P) ?? {}, t = b(null);
	y(() => {
		if (process.env.INTLAYER_ANALYTICS_ENABLED === "false" || !Ae) return;
		let n = !1, r = !1;
...
}, Pe = (e, t = o?.locales, n = o?.defaultLocale) => {
	...
	locale: N ?? o?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), Fe = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: i, disableEditor: a, isCookieEnabled: s }) => {
	let { locales: c, defaultLocale: l } = o ?? {}, [u, d] = x(e ?? N ?? t ?? l);
	y(() => {
		e && e !== u && d(e);
	}, [e]), y(() => {
		Ne();
...
var F = (e) => _(te, e), Be = (e) => _(d, e), I = (e, t) => _(h, e, { tags: (() => {
	if (t) return t;
	if (typeof e == "string") {
		let { issues: t } = be(e);
...
})() }), z = (e) => _(l, e), B = (e, t) => _(v, e, { variable: t }), Ve = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	return String(e);
}, $e = (e, t = {}, n = "en") => e.replace(/\{\{\s*([^{}]+?)\s*\}\}/g, (e, n) => {
	let r = K(t, n);
	...
	if (r.nodeType === "html") return J(r[h], t, n);
	if (r.nodeType === "plural") {
		let e = r[l];
		return J(_e(e, Number(q(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[te], i = G.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[v], i = q(t, typeof r.variable == "string" ? r.variable : "value");
	...
	let i = J(typeof e == "string" ? et[r](e) : e, t, n);
	...
	let ee = X(r), g = Y(h, ee, r?.lng ?? e, "i18next");
	return o < nt && g.includes("$t(") && (g = g.replace(/\$t\(\s*([^),]+?)\s*(?:,[^)]*)?\)/g, (n, l) => {
		let u = Z({
			locale: e,
			namespace: c,
			key: l.trim(),
	...
	let t = o, n = e.lng ?? t?.defaultLocale ?? "en", r = e.defaultNS ?? (Array.isArray(e.ns) ? e.ns[0] : e.ns) ?? "translation", i = /* @__PURE__ */ new Map(), a = !1, s = (e, ...t) => {
		...
		async init(e, t) {
			...
			i.resources !== void 0 && ot("i18next.init"), i.lng && (n = i.lng), i.defaultNS ? r = i.defaultNS : i.ns && (r = Array.isArray(i.ns) ? i.ns[0] : i.ns), a = !0, s("initialized", i);
			let o = u.t.bind(u);
		...
		t(e, t, i) {
			...
			return typeof s == "string" ? Y(s, X(a), n, "i18next") : s ?? (Array.isArray(e) ? e[e.length - 1] : e);
		},
...
$.dir.bind($), $.init.bind($), $.loadResources.bind($), $.reloadResources.bind($), $.use.bind($), $.changeLanguage.bind($), $.getFixedT.bind($), $.t.bind($), $.exists.bind($), $.setDefaultNamespace.bind($), $.hasLoadedNamespace.bind($), $.loadNamespaces.bind($), $.loadLanguages.bind($), re.createContext({ i18n: null }), $.use({
	type: "3rdParty",
	init: (e) => {}
}).init({
	lng: "en",
...
var st = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/AppProviders.tsx";
function ct({ children: e }) {
	let t = C().locale ?? "en", [n] = x(() => typeof performance < "u" ? performance.now() : 0);
	return oe(() => {
		ze("AppRoot", n);
	}, [n]), y(() => {
...
var lt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/scripts/Wrapper.tsx";
function ut({ children: e }) {
	return w(ct, { children: e }, void 0, !1, {
		fileName: lt,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var dt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/Link.wrapper.tsx";
function ft() {
	return w(ut, { children: w(ue, {}, void 0, !1, {
		fileName: dt,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
...
import { b as t, n, t as r } from "./getDictionary-lVOhO-o2.js";
...
var i = /* @__PURE__ */ new WeakMap(), a = 0, o = (e) => {
	if (!e) return "base";
	let t = i.get(e);
	if (t) return t;
	a += 1;
	let n = `p${a}`;
	return i.set(e, n), n;
}, s = 256, c = /* @__PURE__ */ new WeakMap(), l = (e) => typeof e == "object" && !!e, ee = (e, t, n) => `${e}_${t}_${o(n)}`, te = (e, t) => {
	if (!l(e)) return { hit: !1 };
	let n = c.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, f = "translation", p = "enumeration", m = "plural", h = "condition", g = "insertion", _ = "file", v = "object", y = "array", b = "nested", ne = "reactNode", x = "markdown", S = "html", C = "gender", w = "select", re = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), T = (e, t) => {
...
}, E = (e, t) => e[ie(e, t) ?? "fallback"], D = (e) => e === "m" || e === "male" ? "male" : e === "f" || e === "female" ? "female" : "fallback", O = (e, t) => {
	let n = Object.keys(e), r = n[n.length - 1];
	return e[D(t)] ?? e.fallback ?? e[r];
}, k = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), A = "default", ae = /[^A-Za-z0-9._&=-]/g, j = /[^A-Za-z0-9._-]/g, oe = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, M = (e, t) => {
	if (e === "") return "%";
...
}, le = (e) => typeof e == "object" && !!e && "qualifierTypes" in e && Array.isArray(e.qualifierTypes) && "content" in e, F = (e, t) => {
	let n = t.split("/"), r = {
		key: e.key,
		content: e.content[t]
	};
	...
	if (!le(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? A : se(P(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => ce(e, n, t, s)).map((t) => F(e, t));
...
}).join("|") : "", z = () => ({}), B = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), V = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : B.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : V(e ? `${e}.${String(n)}` : String(n)) }), H = /* @__PURE__ */ new Set(), U = (n, i, a) => {
	let o = z()[n];
	return o ? $(o, i, a) : (H.has(n) || (e({ log: t })(typeof window > "u" ? `Dictionary ${r(n)} was not found. Using fallback proxy.` : `Dictionary ${n} was not found. Using fallback proxy.`, { level: "warn" }), H.add(n)), V(n));
}, W = (e, t, n) => {
	let r = U(e, n?.locale, n?.plugins);
	if (typeof t == "string") {
		let e = t.split("."), n = r;
	...
	return typeof t == "string" ? ue(a, t) : a;
}, G = (e, t) => {
	let n = Object.keys(e), r = n[n.length - 1];
...
}, X = process.env.INTLAYER_NODE_TYPE_ENUMERATION === "false" ? Y : {
	...
	transform: (e, t, n) => {
		...
		return (e) => {
			let t = typeof e == "number" ? e : e.count, n = E(i, t);
			return typeof n == "function" && typeof e == "object" ? n(e) : n;
		};
	}
}, _e = process.env.INTLAYER_NODE_TYPE_CONDITION === "false" ? Y : {
	id: "condition-plugin",
...
}, ve = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? Y : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: g }], i = e[g], a = {
			...
			transform: (e, n, r) => {
				if (J(e)) return (i) => he(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, ye = process.env.INTLAYER_NODE_TYPE_GENDER === "false" ? Y : {
	id: "gender-plugin",
...
}, be = process.env.INTLAYER_NODE_TYPE_SELECT === "false" ? Y : {
	id: "select-plugin",
	...
	transform: (e, t, n) => {
		...
		return (e) => {
			let t = typeof e == "string" ? e : e?.value, n = G(i, t);
			return typeof n == "function" && typeof e == "object" ? n(e) : n;
		};
	}
}, xe = process.env.INTLAYER_OPTIMIZED_NESTING === "true" ? de : W, Se = (e) => process.env.INTLAYER_NODE_TYPE_NESTED === "false" ? Y : {
	id: "nested-plugin",
	canHandle: (e) => typeof e == "object" && (e?.nodeType === "nested" || e?.nodeType === "n"),
	transform: (t, n) => xe(t[b].dictionaryKey, t[b].path, {
		...n,
		locale: e ?? n.locale
	})
}, Ce = process.env.INTLAYER_NODE_TYPE_FILE === "false" ? Y : {
	id: "file-plugin",
	...
	ge(e ?? n.defaultLocale, t ? n.defaultLocale : void 0),
	X,
	_e,
	ve,
	...
	let { locale: i, selector: a } = L(t), o = ee(i ?? n.defaultLocale, R(a), r), s = te(e, o);
	if (s.hit) return s.content;
	let c = r ?? Z(i), l = I(e, a), d = (e) => {
		let t = {
			dictionaryKey: e.key,
	...
	return l === null ? u(e, o, null) : Array.isArray(l) ? u(e, o, l.map(d)) : u(e, o, d(l));
};
export { m as _, z as a, f as b, y as c, _ as d, C as f, v as g, x as h, U as i, h as l, g as m, Q as n, E as o, S as p, G as r, T as s, Z as t, p as u, ne as v, re as x, w as y };
var e = () => ({});
