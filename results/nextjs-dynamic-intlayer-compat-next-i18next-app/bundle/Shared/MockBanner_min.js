...
b("✗", ee), b("✓", te), b("⏲", _);
var se = /* @__PURE__ */ new WeakMap(), ce = 0, le = (e) => {
	if (!e) return "base";
	let t = se.get(e);
	if (t) return t;
	ce += 1;
...
}, Ce = (e, t) => e[Se(e, t) ?? "fallback"], T = "default", we = /[^A-Za-z0-9._&=-]/g, E = /[^A-Za-z0-9._-]/g, Te = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, D = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, Te);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, O = (e) => e === void 0 ? T : typeof e == "string" ? D(e, we) : Object.keys(e).sort().map((t) => `${D(t, E)}=${D(String(e[t]), E)}`).join("&"), k = (e) => Array.isArray(e) ? e.length === 0 ? [T] : e.map(O) : [O(e)], Ee = (e, t) => {
	...
	if (!Oe(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? T : Ee(k(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => De(e, n, t, s)).map((t) => ke(e, t));
	...
	yield e;
} : j(e ? `${e}.${String(n)}` : String(n)) }), Pe = /* @__PURE__ */ new Set(), M = (e, t, n) => {
	let r = A()[e];
	return r ? nt(r, t, n) : (Pe.has(e) || (y({ log: h })(typeof window > "u" ? `Dictionary ${oe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Pe.add(e)), j(e));
...
function N(e, t, n) {
	let r = t ?? p?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = Ie.get(a);
...
var Ve = (e, t, n) => e[N("PluralRules", n).select(t)] ?? e.other, He = (e, t) => {
	...
	let { locale: r, selector: i } = je(t), a = de(r ?? p.defaultLocale, Me(i), n), o = fe(e, a);
...
var L = {
	...
	let r = e;
	if (r.nodeType === "insertion") return q(r[ge], t, n);
	if (r.nodeType === "html") return q(r[ye], t, n);
	if (r.nodeType === "plural") {
		let e = r[he];
		return q(Ve(e, Number(K(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[me], i = U.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[xe], i = K(t, typeof r.variable == "string" ? r.variable : "value");
...
var Dt = {
	type: "3rdParty",
	init: (e) => {}
}, Ot = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/MockBanner.tsx", kt = () => {
	let { t: e } = Et();
	return d("div", {
