...
S("✗", ee), S("✓", te), S("⏲", _);
var xe = "translation", Se = "enumeration", Ce = "plural", we = "insertion", Te = "object", Ee = "array", De = "html", Oe = "gender", ke = "select", C = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), w = (e, t) => {
...
})() }), A = (e) => C(Ce, e), j = (e, t) => C(ke, e, { variable: t }), Fe = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "enumeration") {
		let e = r[Se], i = Xe.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
}, H = "default", lt = /[^A-Za-z0-9._&=-]/g, ut = /[^A-Za-z0-9._-]/g, dt = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, U = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, dt);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, W = (e) => e === void 0 ? H : typeof e == "string" ? U(e, lt) : Object.keys(e).sort().map((t) => `${U(t, ut)}=${U(String(e[t]), ut)}`).join("&"), ft = (e) => Array.isArray(e) ? e.length === 0 ? [H] : e.map(W) : [W(e)], pt = (e, t) => {
	...
	let r = xt()[e];
	return r ? Rt(r, t, n) : (wt.has(e) || (x({ log: h })(typeof window > "u" ? `Dictionary ${be(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), wt.add(e)), Ct(e));
}, Tt = (e) => {
...
var Pt = (e) => K, Ft = K, It = (e, t = !0) => [
	...
	let { locale: r, selector: i } = vt(t), a = st(r ?? p.defaultLocale, yt(i), n), o = ct(e, a);
...
}, an = ({ children: e, i18n: t }) => (t !== void 0 && x({ log: h })(`${S("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), u(en, { children: e }));
