...
var be = "translation", xe = "enumeration", Se = "plural", Ce = "insertion", we = "object", Te = "array", Ee = "html", De = "gender", Oe = "select", C = (e, t, n) => ({
	...
	yield e;
} : St(e ? `${e}.${String(n)}` : String(n)) }), Ct = /* @__PURE__ */ new Set(), W = (e, t, n) => {
	let r = bt()[e];
	return r ? Lt(r, t, n) : (Ct.has(e) || (x({ log: m })(typeof window > "u" ? `Dictionary ${ye(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Ct.add(e)), St(e));
}, wt = (e) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, Dt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? G : {
...
}, Ot = G, kt = G, At = G, jt = G, Mt = G, Nt = (e) => G, Pt = G, Ft = (e, t = !0) => [
	Dt(e ?? f.defaultLocale, t ? f.defaultLocale : void 0),
	Ot,
	kt,
	At,
...
var Wt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = en(), s = t?.keyPrefix, { translate: c, i18n: l } = o(() => Wt({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
function dn({ children: e }) {
	...
	return a(() => {
		...
		i18n: ln,
		children: [l(un, { locale: t }), e]
	});
}
function fn({ children: e }) {
	return l(dn, { children: e });
}
function pn() {
	return l(fn, { children: l(on, {}) });
}
