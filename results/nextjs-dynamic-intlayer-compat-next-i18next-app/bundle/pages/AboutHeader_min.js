...
var Gt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let { locales: l, defaultLocale: u } = m ?? {}, [f, p] = c(e ?? Kt ?? t ?? u);
	i(() => {
		e && e !== f && p(e);
	}, [e]), i(() => {
		Qt();
...
function cn() {
	let { t: e } = rn();
	return sn("AboutHeader"), f(u, { children: [d("h1", {
		className: "mb-4 text-3xl font-bold text-foreground",
		children: e("about.aboutHeader.aboutThisBenchmark")
	}), d("p", {
		className: "mb-8 max-w-3xl text-muted-foreground",
		children: e("about.aboutHeader.thisIsAnOpenSource")
	})] });
}
function ln() {
	if (!(typeof window > "u")) {
