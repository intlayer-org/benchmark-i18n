...
var le = /* @__PURE__ */ new WeakMap(), b = 0, ue = (e) => {
...
}, E = (e) => e === void 0 ? w : typeof e == "string" ? T(e, Ee) : Object.keys(e).sort().map((t) => `${T(t, De)}=${T(String(e[t]), De)}`).join("&"), D = (e) => Array.isArray(e) ? e.length === 0 ? [w] : e.map(E) : [E(e)], ke = (e, t) => {
	...
	if (!je(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? w : ke(D(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Ae(e, n, t, s)).map((t) => Me(e, t));
...
}).join("|") : "", O = () => ({}), Ie = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), k = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Ie.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : k(e ? `${e}.${String(n)}` : String(n)) }), A = /* @__PURE__ */ new Set(), j = (e, t, n) => {
	let r = O()[e];
	return r ? nt(r, t, n) : (A.has(e) || (se({ log: g })(typeof window > "u" ? `Dictionary ${ce(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), A.add(e)), k(e));
...
function P(e, t, n) {
	let r = t ?? m?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = M.get(a);
...
var Ve = (e, t, n) => e[P("PluralRules", n).select(t)] ?? e.other, He = (e, t) => {
	...
	let { locale: r, selector: i } = Pe(t), a = pe(r ?? m.defaultLocale, Fe(i), n), o = me(e, a);
...
function At() {
	let { t: e } = Dt();
	return kt("AboutHeader"), f(d, { children: [f("h1", {
...
var It = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/scripts/Wrapper.tsx";
function Lt({ children: e }) {
	return f(Ft, { children: e }, void 0, !1, {
		fileName: It,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var Rt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/about/AboutHeader.wrapper.tsx";
function zt() {
	return f(Lt, { children: f(At, {}, void 0, !1, {
		fileName: Rt,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
