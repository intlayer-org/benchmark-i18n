...
}, Pe = { index: c }, Fe = () => Pe, Ie = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
...
var ot = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let { locales: f, defaultLocale: m } = p ?? {}, [h, g] = s(() => e ?? st() ?? t ?? m), [_, v] = s(e);
	e !== _ && (v(e), e && e !== h && g(e)), i(() => {
		lt();
	}, []);
	let ee = n((e) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = mt(), s = t?.keyPrefix, { translate: c, i18n: l } = o(() => ot({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
function vt() {
	let { t: e } = $();
	return _t("AboutHeader"), d(l, { children: [u("h1", {
