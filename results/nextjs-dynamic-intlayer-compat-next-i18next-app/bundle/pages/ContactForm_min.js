	...
	return f("form", {
		...
		children: [
			...
			f("div", { children: [d("label", {
				...
				children: [
					d("option", { children: "Bug Report" }),
					d("option", { children: "New Benchmark Idea" }),
					d("option", { children: "Methodology Question" }),
					d("option", { children: "Contribution" }),
					d("option", { children: "Other" })
				]
			})] }),
			f("div", { children: [d("label", {
				htmlFor: i,
