...
C("✗", ee), C("✓", te), C("⏲", _);
var be = "translation", xe = "enumeration", Se = "plural", Ce = "insertion", we = "object", Te = "array", Ee = "html", w = "gender", T = "select", E = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), D = (e, t) => {
...
})() }), je = (e) => E(Se, e), Me = (e, t) => E(T, e, { variable: t }), Ne = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	let r = e;
	if (r.nodeType === "insertion") return B(r[Ce], t, n);
	if (r.nodeType === "html") return B(r[Ee], t, n);
	if (r.nodeType === "plural") {
		let e = r[Se];
		return B(qe(e, Number(z(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[xe], i = Ye.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	i18next: Re,
	"vue-i18n": We
}, V = (e, t = {}, n = "en", r = "icu") => Qe($e[r])(e, t, n), et = /* @__PURE__ */ new WeakMap(), tt = 0, nt = (e) => {
	if (!e) return "base";
	let t = et.get(e);
	if (t) return t;
	tt += 1;
	let n = `p${tt}`;
	return et.set(e, n), n;
}, rt = 256, H = /* @__PURE__ */ new WeakMap(), it = (e) => typeof e == "object" && !!e, at = (e, t, n) => `${e}_${t}_${nt(n)}`, ot = (e, t) => {
	...
	if (!it(e)) return n;
	let r = H.get(e);
	return r || (r = /* @__PURE__ */ new Map(), H.set(e, r)), r.size >= rt && r.clear(), r.set(t, n), n;
}, W = "default", st = /[^A-Za-z0-9._&=-]/g, ct = /[^A-Za-z0-9._-]/g, lt = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, G = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, lt);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, ut = (e) => e === void 0 ? W : typeof e == "string" ? G(e, st) : Object.keys(e).sort().map((t) => `${G(t, ct)}=${G(String(e[t]), ct)}`).join("&"), dt = (e) => Array.isArray(e) ? e.length === 0 ? [W] : e.map(ut) : [ut(e)], ft = (e, t) => {
	...
	if (!mt(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? W : ft(dt(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => pt(e, n, t, s)).map((t) => ht(e, t));
...
}).join("|") : "", yt = { index: l }, bt = () => yt, xt = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), St = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : xt.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : St(e ? `${e}.${String(n)}` : String(n)) }), Ct = /* @__PURE__ */ new Set(), K = (e, t, n) => {
	let r = bt()[e];
	return r ? Lt(r, t, n) : (Ct.has(e) || (S({ log: h })(typeof window > "u" ? `Dictionary ${ye(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Ct.add(e)), St(e));
}, wt = (e) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, Dt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? q : {
...
}, Ot = q, kt = q, At = q, jt = q, Mt = q;
process.env.INTLAYER_OPTIMIZED_NESTING;
var Nt = (e) => q, Pt = q, Ft = (e, t = !0) => [
	...
	let { locale: r, selector: i } = _t(t), a = at(r ?? p.defaultLocale, vt(i), n), o = ot(e, a);
	if (o.hit) return o.content;
	let s = n ?? Ft(r), c = gt(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
	...
	"nsMode",
	"keyPrefix"
]), zt = 5, Bt = "index", Vt = (e, t) => {
	if (e in bt()) return K(e, t);
}, Ht = (e, t, n, r, i) => {
	...
	else if (m = Vt(c, p), m === void 0 && c === t && c !== Bt && (m = Vt(Bt, p)), m === void 0) return;
	let h;
	...
	e.resources !== void 0 && Ut("createInstance");
	let t = p, n = e.lng ?? t?.defaultLocale ?? "en", r = e.defaultNS ?? (Array.isArray(e.ns) ? e.ns[0] : e.ns) ?? "translation", i = /* @__PURE__ */ new Map(), a = !1, o = (e, ...t) => {
		...
		async init(e, t) {
			...
			i.resources !== void 0 && Ut("i18next.init"), i.lng && (n = i.lng), i.defaultNS ? r = i.defaultNS : i.ns && (r = Array.isArray(i.ns) ? i.ns[0] : i.ns), a = !0, o("initialized", i);
			let s = l.t.bind(l);
...
var Wt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	let o = (t, n) => Y({
		locale: e,
		namespace: r,
		key: i ? `${i}.${t}` : t,
	...
	let { locales: l, defaultLocale: d } = p ?? {}, [f, m] = c(e ?? Gt ?? t ?? d);
	i(() => {
		e && e !== f && m(e);
	}, [e]), i(() => {
		Zt();
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = tn(), s = t?.keyPrefix, { translate: c, i18n: l } = o(() => Wt({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
function fn({ children: e }) {
	...
	return a(() => {
		...
		i18n: un,
		children: [u(dn, { locale: t }), e]
	});
}
function pn({ children: e }) {
	return u(fn, { children: e });
}
function mn() {
	return u(pn, { children: u(sn, {}) });
}
