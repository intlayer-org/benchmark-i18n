...
}, ye = 50, D = /* @__PURE__ */ new Map(), O = /* @__PURE__ */ new Set(), be = (e) => {
...
var A = (e) => v(ee, e), Ce = (e) => v(d, e), we = (e) => {
	let t = {};
...
}), Ve = (e, t, n) => e[k("PluralRules", n).select(t)] ?? e.other, z = [
	"__intlayer_icu_var",
...
}, Xe = process.env.INTLAYER_EDITOR_ENABLED !== "false" && i?.enabled && typeof window < "u" && window.self !== window.top, Ze = he(E), X = (e, t) => ge(e, {
	...E,
	isCookieEnabled: t
}), Qe = () => {
...
function gt({ children: e }) {
	let t = ce().locale ?? "en", [n] = C(() => typeof performance < "u" ? performance.now() : 0);
	return x(() => {
		mt("AppRoot", n);
	}, [n]), b(() => {
...
var yt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/home/Hero.wrapper.tsx";
function bt() {
