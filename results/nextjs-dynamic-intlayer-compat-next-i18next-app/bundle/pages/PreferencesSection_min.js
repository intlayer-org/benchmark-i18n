		...
		children: [d("h2", {
			...
			children: [
				...
				f("div", { children: [d("label", {
					...
					children: [
						d("option", { children: "English (en)" }),
						d("option", { children: "French (fr)" }),
						d("option", { children: "German (de)" }),
						d("option", { children: "Spanish (es)" }),
						d("option", { children: "Japanese (ja)" }),
						d("option", { children: "Chinese Simplified (zh-CN)" }),
						d("option", { children: "Arabic (ar)" })
					]
				})] })
			]
		})]
