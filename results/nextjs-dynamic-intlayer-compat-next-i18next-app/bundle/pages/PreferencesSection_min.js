...
import { createContext as re, useCallback as ie, useContext as b, useEffect as x, useId as ae, useLayoutEffect as oe, useMemo as se, useRef as S, useState as ce } from "react";
...
}, xe = 50, Se = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Set(), Ce = (e) => {
...
function D(e, t, n) {
	let r = t ?? o?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, s = Se.get(a);
	s || (s = /* @__PURE__ */ new Map(), Se.set(a, s));
	let c = s.get(i);
	if (!c) {
...
var Xe = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
...
}, Ze = process.env.INTLAYER_EDITOR_ENABLED !== "false" && i?.enabled && typeof window < "u" && window.self !== window.top, Qe = _e(T), X = (e, t) => ve(e, {
	...T,
	isCookieEnabled: t
}), $e = () => {
	let { locale: e } = b(Z) ?? {}, t = S(null);
	x(() => {
	...
	let { locales: c, defaultLocale: l } = o ?? {}, [u, d] = ce(e ?? Qe ?? t ?? l);
	x(() => {
		e && e !== u && d(e);
	}, [e]), x(() => {
		it();
...
var ut = {
	type: "3rdParty",
	init: (e) => {}
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/settings/PreferencesSection.tsx";
function dt() {
	let { t: e } = lt(), t = ae();
	return w("section", {
			...
			children: [
				w("div", {
					...
					children: [w("div", { children: [w("p", {
						...
						children: w("span", { className: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" }, void 0, !1, {
							fileName: $,
							lineNumber: 30,
							columnNumber: 13
						}, this)
				...
				w("div", {
					...
					children: [w("div", { children: [w("p", {
						...
						children: w("span", { className: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" }, void 0, !1, {
							fileName: $,
							lineNumber: 47,
							columnNumber: 13
						}, this)
				...
				w("div", { children: [w("label", {
					...
					children: [
						w("option", { children: "English (en)" }, void 0, !1, {
							fileName: $,
							lineNumber: 61,
							columnNumber: 13
						}, this),
						w("option", { children: "French (fr)" }, void 0, !1, {
							fileName: $,
							lineNumber: 62,
							columnNumber: 13
						}, this),
						w("option", { children: "German (de)" }, void 0, !1, {
							fileName: $,
							lineNumber: 63,
							columnNumber: 13
						}, this),
						w("option", { children: "Spanish (es)" }, void 0, !1, {
							fileName: $,
							lineNumber: 64,
							columnNumber: 13
						}, this),
						w("option", { children: "Japanese (ja)" }, void 0, !1, {
							fileName: $,
							lineNumber: 65,
							columnNumber: 13
						}, this),
						w("option", { children: "Chinese Simplified (zh-CN)" }, void 0, !1, {
							fileName: $,
							lineNumber: 66,
							columnNumber: 13
						}, this),
						w("option", { children: "Arabic (ar)" }, void 0, !1, {
							fileName: $,
							lineNumber: 67,
							columnNumber: 13
						}, this)
...
function vt({ children: e }) {
	return w(gt, { children: e }, void 0, !1, {
		fileName: _t,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var yt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/settings/PreferencesSection.wrapper.tsx";
function bt() {
	return w(vt, { children: w(dt, {}, void 0, !1, {
		fileName: yt,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
