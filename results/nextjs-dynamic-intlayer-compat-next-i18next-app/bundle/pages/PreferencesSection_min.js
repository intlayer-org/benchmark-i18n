...
S("✗", ee), S("✓", te), S("⏲", _);
var xe = "translation", Se = "enumeration", C = "plural", Ce = "insertion", we = "object", Te = "array", Ee = "html", De = "gender", Oe = "select", w = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), T = (e, t) => {
...
})() }), M = (e) => w(C, e), N = (e, t) => w(Oe, e, { variable: t }), Ne = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "plural") {
		let e = r[C];
		return B(Ke(e, Number(z(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[Se], i = Je.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	let r = yt()[e];
	return r ? It(r, t, n) : (St.has(e) || (x({ log: h })(typeof window > "u" ? `Dictionary ${be(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), St.add(e)), xt(e));
}, Ct = (e) => {
...
}, Dt = q, Ot = q, kt = q, At = q, jt = q, Mt = (e) => q, Nt = q, Pt = (e, t = !0) => [
...
var Ut = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
...
}), { defaultLocale: $t, locales: $ } = p ?? {}, en = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = en(), o = t?.keyPrefix, { translate: c, i18n: l } = s(() => Ut({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
}, nn = ({ children: e, i18n: t }) => (t !== void 0 && x({ log: h })(`${S("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), u(Qt, { children: e }));
