...
import { createContext as ne, useCallback as re, useContext as x, useEffect as S, useId as ie, useLayoutEffect as ae, useMemo as oe, useRef as C, useState as w } from "react";
import { jsx as T, jsxs as se } from "react/jsx-runtime";
import { jsxDEV as E } from "react/jsx-dev-runtime";
import { useParams as ce } from "next/navigation";
var le = (e, t = o?.locales, n = o?.defaultLocale) => {
...
}, fe = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false", pe = process.env.INTLAYER_ROUTING_STORAGE_LOCALSTORAGE === "false", me = process.env.INTLAYER_ROUTING_STORAGE_SESSIONSTORAGE === "false";
...
var D = {
	...
	if (!fe) for (let n = 0; n < (e.storage.cookies ?? []).length; n++) try {
		let i = t?.getCookie?.(e.storage.cookies[n].name);
		if (r(i)) return i;
	} catch {}
	if (!pe) for (let n = 0; n < (e.storage.localStorage ?? []).length; n++) try {
		let i = t?.getLocaleStorage?.(e.storage.localStorage[n].name);
		if (r(i)) return i;
	} catch {}
	if (!me && e.storage.sessionStorage) for (let n = 0; n < e.storage.sessionStorage.length; n++) try {
		let i = t?.getSessionStorage?.(e.storage.sessionStorage[n].name);
		if (r(i)) return i;
	} catch {}
}, ge = (t, n) => {
	if (n?.isCookieEnabled !== !1) {
		if (!fe && e.storage.cookies) for (let r = 0; r < e.storage.cookies.length; r++) {
			let { name: i, attributes: a } = e.storage.cookies[r];
			try {
				n?.setCookieStore && n.setCookieStore(i, t, {
					...a,
					expires: ue(a.expires)
				});
			} catch {
				try {
					n?.setCookieString && n.setCookieString(i, de(i, t, a));
				} catch {}
			}
		}
		if (!pe && e.storage.localStorage && n?.setLocaleStorage) for (let r = 0; r < e.storage.localStorage.length; r++) {
		...
		if (!me && e.storage.sessionStorage && n?.setSessionStorage) for (let r = 0; r < e.storage.sessionStorage.length; r++) {
	...
	try {
		...
		let n = t.maximize();
		return _e.includes(n.script ?? "") ? "rtl" : "ltr";
	} catch {
		return "ltr";
	}
}, ye = 50, O = /* @__PURE__ */ new Map(), k = /* @__PURE__ */ new Set(), be = (e) => {
...
function A(e, t, n) {
	...
	if (!c) {
		...
		s.size > ye && s.clear(), c = new t(r, n), s.set(i, c);
	}
	return c;
}
var j = (e) => y(v, e), M = (e) => y(d, e), Ce = (e) => {
	let t = {};
...
})() }), L = (e) => y(l, e), R = (e, t) => y(b, e, { variable: t }), De = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}), Re = (e, t, n) => e[A("PluralRules", n).select(t)] ?? e.other, ze = [
	"__intlayer_icu_var",
	...
	if (r.nodeType === "plural") {
		let e = r[l];
		return G(Re(e, Number(W(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[v], i = ze.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	let i = G(typeof e == "string" ? He[r](e) : e, t, n);
	...
	let n = {};
	for (let [t, r] of Object.entries(e)) Ue.has(t) || (n[t] = r);
	return n;
	...
	else if (m = Ke(c, p), m === void 0 && c === t && c !== Ge && (m = Ke(Ge, p)), m === void 0) return;
	let h;
	...
	return o < We && _.includes("$t(") && (_ = _.replace(/\$t\(\s*([^),]+?)\s*(?:,[^)]*)?\)/g, (n, l) => {
		let u = J({
			locale: e,
			namespace: c,
			key: l.trim(),
...
var Ye = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
...
}, Xe = process.env.INTLAYER_EDITOR_ENABLED !== "false" && i?.enabled && typeof window < "u" && window.self !== window.top, Ze = he(D), Qe = (e, t) => ge(e, {
	...D,
	isCookieEnabled: t
}), $e = () => {
...
}, et = ({ children: e }) => ($e(), e), tt = process.env.INTLAYER_ANALYTICS_ENABLED !== "false" && s?.enabled === !0 && !!i?.clientId && typeof window < "u" && window.self === window.top && !ee(), nt = () => {
	let { locale: e } = x(Z) ?? {}, t = C(null);
	S(() => {
		if (process.env.INTLAYER_ANALYTICS_ENABLED === "false" || !tt) return;
		let n = !1, r = !1;
	...
	locale: Ze ?? o?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), at = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: i, disableEditor: a, isCookieEnabled: s }) => {
	let { locales: c, defaultLocale: l } = o ?? {}, [u, d] = w(e ?? Ze ?? t ?? l);
	S(() => {
		e && e !== u && d(e);
	}, [e]), S(() => {
		it();
...
}), st = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
var lt = {
	type: "3rdParty",
	init: (e) => {}
}, Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/settings/PreferencesSection.tsx";
function ut() {
	let { t: e } = ct(), t = ie();
	return E("section", {
			...
			children: [
				E("div", {
					...
					children: [E("div", { children: [E("p", {
						...
						children: E("span", { className: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" }, void 0, !1, {
							fileName: Q,
							lineNumber: 30,
							columnNumber: 13
						}, this)
				...
				E("div", {
					...
					children: [E("div", { children: [E("p", {
						...
						children: E("span", { className: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" }, void 0, !1, {
							fileName: Q,
							lineNumber: 47,
							columnNumber: 13
						}, this)
				...
				E("div", { children: [E("label", {
					...
					children: [
						E("option", { children: "English (en)" }, void 0, !1, {
							fileName: Q,
							lineNumber: 61,
							columnNumber: 13
						}, this),
						E("option", { children: "French (fr)" }, void 0, !1, {
							fileName: Q,
							lineNumber: 62,
							columnNumber: 13
						}, this),
						E("option", { children: "German (de)" }, void 0, !1, {
							fileName: Q,
							lineNumber: 63,
							columnNumber: 13
						}, this),
						E("option", { children: "Spanish (es)" }, void 0, !1, {
							fileName: Q,
							lineNumber: 64,
							columnNumber: 13
						}, this),
						E("option", { children: "Japanese (ja)" }, void 0, !1, {
							fileName: Q,
							lineNumber: 65,
							columnNumber: 13
						}, this),
						E("option", { children: "Chinese Simplified (zh-CN)" }, void 0, !1, {
							fileName: Q,
							lineNumber: 66,
							columnNumber: 13
						}, this),
						E("option", { children: "Arabic (ar)" }, void 0, !1, {
							fileName: Q,
							lineNumber: 67,
							columnNumber: 13
						}, this)
...
var mt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/AppProviders.tsx";
function ht({ children: e }) {
	let t = ce().locale ?? "en", [n] = w(() => typeof performance < "u" ? performance.now() : 0);
	return ae(() => {
		pt("AppRoot", n);
	}, [n]), S(() => {
...
var gt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/scripts/Wrapper.tsx";
function _t({ children: e }) {
	return E(ht, { children: e }, void 0, !1, {
		fileName: gt,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/settings/PreferencesSection.wrapper.tsx";
function vt() {
	return E(_t, { children: E(ut, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
