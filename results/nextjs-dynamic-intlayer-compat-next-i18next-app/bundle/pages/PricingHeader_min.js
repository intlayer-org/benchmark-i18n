...
var Ft = (e) => K, It = K, Lt = (e, t = !0) => [
	...
	else if (m = Ut(c, p), m === void 0 && c === t && c !== Ht && (m = Ut(Ht, p)), m === void 0) return;
	let h;
...
var Kt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), en = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: o, isCookieEnabled: s }) => {
	let { locales: l, defaultLocale: u } = m ?? {}, [f, p] = c(e ?? qt ?? t ?? u);
	i(() => {
		e && e !== f && p(e);
	}, [e]), i(() => {
		$t();
...
}), { defaultLocale: nn, locales: Q } = m ?? {}, rn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = rn(), s = t?.keyPrefix, { translate: c, i18n: l } = o(() => Kt({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
}, an = ({ children: e, i18n: t }) => (t !== void 0 && S({ log: g })(`${C("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), d(tn, { children: e }));
...
function cn() {
	let { t: e } = $();
	return f(u, { children: [d(sn, {}), f("div", {
		className: "mb-12 text-center",
		children: [d("h1", {
			className: "mb-3 text-3xl font-bold text-foreground",
			children: e("pricing.pricingHeader.simpleTransparentPricing")
		}), d("p", {
			className: "text-muted-foreground",
			children: e("pricing.pricingHeader.chooseThePlanThatFits")
		})]
	})] });
}
function ln() {
...
function pn({ children: e }) {
	...
	return a(() => {
		...
		i18n: dn,
		children: [d(fn, { locale: t }), e]
	});
}
function mn({ children: e }) {
	return d(pn, { children: e });
}
function hn() {
	return d(mn, { children: d(cn, {}) });
}
