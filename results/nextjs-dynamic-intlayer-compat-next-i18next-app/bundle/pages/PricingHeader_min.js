...
import { createContext as ne, useCallback as re, useContext as x, useEffect as S, useLayoutEffect as ie, useMemo as ae, useRef as C, useState as oe } from "react";
...
}, be = 50, xe = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Set(), Se = (e) => {
...
function O(e, t, n) {
	let r = t ?? o?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, s = xe.get(a);
	s || (s = /* @__PURE__ */ new Map(), xe.set(a, s));
	let c = s.get(i);
	if (!c) {
...
var k = (e) => y(v, e), A = (e) => y(d, e), Te = (e) => {
...
})() }), F = (e) => y(l, e), I = (e, t) => y(b, e, { variable: t }), ke = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}), Ve = (e, t, n) => e[O("PluralRules", n).select(t)] ?? e.other, B = [
	"__intlayer_icu_var",
	...
	if (r.nodeType === "plural") {
		let e = r[l];
		return U(Ve(e, Number(H(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[v], i = B.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[b], i = H(t, typeof r.variable == "string" ? r.variable : "value");
	...
	let i = U(typeof e == "string" ? We[r](e) : e, t, n);
...
var Ye = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
...
}, Xe = process.env.INTLAYER_EDITOR_ENABLED !== "false" && i?.enabled && typeof window < "u" && window.self !== window.top, Ze = ge(E), Z = (e, t) => _e(e, {
	...E,
	isCookieEnabled: t
}), Qe = () => {
	let { locale: e } = x(Q) ?? {}, t = C(null);
	S(() => {
	...
	let { locales: c, defaultLocale: l } = o ?? {}, [u, d] = oe(e ?? Ze ?? t ?? l);
	S(() => {
		e && e !== u && d(e);
	}, [e]), S(() => {
		rt();
	...
	let { defaultLocale: n, locales: r } = o ?? {}, { locale: i, setLocale: a, isCookieEnabled: s } = x(Q) ?? {};
	return {
		locale: i,
		defaultLocale: n,
		availableLocales: r,
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = ot(), o = t?.keyPrefix, { translate: s, i18n: c } = ae(() => Ye({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
var ct = {
	type: "3rdParty",
	init: (e) => {}
}, lt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/MockBanner.tsx", ut = () => {
	let { t: e } = st();
	return T("div", {
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/pricing/PricingHeader.tsx";
function dt() {
	let { t: e } = st();
	return T(ce, { children: [T(ut, {}, void 0, !1, {
		fileName: $,
		lineNumber: 10,
		columnNumber: 7
	}, this), T("div", {
...
function gt({ children: e }) {
	let t = le().locale ?? "en", [n] = oe(() => typeof performance < "u" ? performance.now() : 0);
	return ie(() => {
		mt("AppRoot", n);
	}, [n]), S(() => {
...
var yt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/pricing/PricingHeader.wrapper.tsx";
function bt() {
