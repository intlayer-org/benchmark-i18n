...
S("✗", ee), S("✓", te), S("⏲", _);
var xe = "translation", C = "enumeration", Se = "plural", Ce = "insertion", we = "object", Te = "array", Ee = "html", De = "gender", Oe = "select", w = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), T = (e, t) => {
...
})() }), j = (e) => w(Se, e), M = (e, t) => w(Oe, e, { variable: t }), Pe = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "enumeration") {
		let e = r[C], i = Ye.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	yield e;
} : St(e ? `${e}.${String(n)}` : String(n)) }), Ct = /* @__PURE__ */ new Set(), G = (e, t, n) => {
	let r = bt()[e];
	return r ? Lt(r, t, n) : (Ct.has(e) || (x({ log: h })(typeof window > "u" ? `Dictionary ${be(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Ct.add(e)), St(e));
}, wt = (e) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, Dt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? K : {
...
}, Ot = K, kt = K, At = K, jt = K, Mt = K, Nt = (e) => K, Pt = K, Ft = (e, t = !0) => [
...
}), { defaultLocale: en, locales: Q } = p ?? {}, tn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
}, nn = ({ children: e, i18n: t }) => (t !== void 0 && x({ log: h })(`${S("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), u($t, { children: e }));
...
function on() {
	let { t: e } = $();
	return d(l, { children: [u(an, {}), d("div", {
