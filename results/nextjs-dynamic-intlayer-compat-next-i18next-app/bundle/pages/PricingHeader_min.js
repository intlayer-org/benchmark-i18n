...
import { createContext as re, useCallback as ie, useContext as b, useEffect as x, useLayoutEffect as ae, useMemo as oe, useRef as S, useState as se } from "react";
import { jsx as C, jsxs as ce } from "react/jsx-runtime";
import { Fragment as le, jsxDEV as w } from "react/jsx-dev-runtime";
...
var Xe = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let { locales: c, defaultLocale: l } = o ?? {}, [u, d] = se(e ?? Qe ?? t ?? l);
	x(() => {
		e && e !== u && d(e);
	}, [e]), x(() => {
		it();
...
function pt() {
	let { t: e } = lt();
	return w(le, { children: [w(ft, {}, void 0, !1, {
		fileName: $,
		lineNumber: 10,
		columnNumber: 7
	}, this), w("div", {
...
function vt({ children: e }) {
	let t = ue().locale ?? "en", [n] = se(() => typeof performance < "u" ? performance.now() : 0);
	return ae(() => {
		gt("AppRoot", n);
	}, [n]), x(() => {
...
function bt({ children: e }) {
	return w(vt, { children: e }, void 0, !1, {
		fileName: yt,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var xt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/pricing/PricingHeader.wrapper.tsx";
function St() {
	return w(bt, { children: w(pt, {}, void 0, !1, {
		fileName: xt,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
