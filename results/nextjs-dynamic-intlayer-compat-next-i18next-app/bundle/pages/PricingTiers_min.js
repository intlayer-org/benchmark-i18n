...
var ct = {
	type: "3rdParty",
	init: (e) => {}
}, Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/pricing/PricingTiers.tsx";
function lt() {
	let { t: e } = st(), t = [
		{
		...
		children: t.map((e) => E("div", {
			...
			children: [
				...
				E("ul", {
					...
					children: e.features.map((e) => E("li", {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/pricing/PricingTiers.wrapper.tsx";
function _t() {
