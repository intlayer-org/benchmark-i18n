...
import { createContext as ie, useCallback as ae, useContext as y, useEffect as b, useId as x, useLayoutEffect as oe, useMemo as se, useRef as S, useState as C } from "react";
...
var Xe = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = ct(), o = t?.keyPrefix, { translate: s, i18n: c } = se(() => Xe({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
var ut = {
	type: "3rdParty",
	init: (e) => {}
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/settings/ProfileSection.tsx";
function dt() {
	let { t: e } = lt(), t = x(), n = x();
	return T("section", {
...
var ht = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/AppProviders.tsx";
...
var _t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/scripts/Wrapper.tsx";
function vt({ children: e }) {
	return T(gt, { children: e }, void 0, !1, {
		fileName: _t,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var yt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/settings/ProfileSection.wrapper.tsx";
function bt() {
	return T(vt, { children: T(dt, {}, void 0, !1, {
		fileName: yt,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
