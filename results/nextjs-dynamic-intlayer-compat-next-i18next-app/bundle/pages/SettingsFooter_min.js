...
var ce = /* @__PURE__ */ new WeakMap(), le = 0, ue = (e) => {
	...
	let n = `p${le}`;
	return ce.set(e, n), n;
}, de = 256, b = /* @__PURE__ */ new WeakMap(), x = (e) => typeof e == "object" && !!e, fe = (e, t, n) => `${e}_${t}_${ue(n)}`, pe = (e, t) => {
	if (!x(e)) return { hit: !1 };
	let n = b.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	if (!x(e)) return n;
	let r = b.get(e);
	return r || (r = /* @__PURE__ */ new Map(), b.set(e, r)), r.size >= de && r.clear(), r.set(t, n), n;
}, me = "translation", he = "enumeration", ge = "plural", _e = "insertion", ve = "object", ye = "array", be = "html", xe = "gender", Se = "select", C = (e, t) => {
...
}, we = (e, t) => e[Ce(e, t) ?? "fallback"], w = "default", Te = /[^A-Za-z0-9._&=-]/g, Ee = /[^A-Za-z0-9._-]/g, De = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, T = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, De);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, Oe = (e) => e === void 0 ? w : typeof e == "string" ? T(e, Te) : Object.keys(e).sort().map((t) => `${T(t, Ee)}=${T(String(e[t]), Ee)}`).join("&"), E = (e) => Array.isArray(e) ? e.length === 0 ? [w] : e.map(Oe) : [Oe(e)], ke = (e, t) => {
	...
	if (!je(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? w : ke(E(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Ae(e, n, t, s)).map((t) => Me(e, t));
...
}).join("|") : "", D = () => ({}), Ie = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), O = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Ie.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : O(e ? `${e}.${String(n)}` : String(n)) }), k = /* @__PURE__ */ new Set(), A = (e, t, n) => {
	let r = D()[e];
	return r ? nt(r, t, n) : (k.has(e) || (oe({ log: h })(typeof window > "u" ? `Dictionary ${se(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), k.add(e)), O(e));
}, Le = 50, j = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Set(), Re = (e) => {
...
var Ve = (e, t, n) => e[N("PluralRules", n).select(t)] ?? e.other, He = (e, t) => {
	...
	let { locale: r, selector: i } = Pe(t), a = fe(r ?? p.defaultLocale, Fe(i), n), o = pe(e, a);
...
var L = {
	...
	if (!I) for (let t = 0; t < (m.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(m.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, at = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !I && m.storage.cookies) for (let n = 0; n < m.storage.cookies.length; n++) {
...
}, dt = (e, t = p?.locales, n = p?.defaultLocale) => {
...
}), { defaultLocale: gt, locales: V } = p ?? {}, _t = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return q(r[_e], t, n);
	if (r.nodeType === "html") return q(r[be], t, n);
	if (r.nodeType === "plural") {
		let e = r[ge];
		return q(Ve(e, Number(K(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[he], i = U.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
var Tt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = _t(), s = t?.keyPrefix, { translate: c, i18n: l } = o(() => Tt({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
var Dt = {
	type: "3rdParty",
	init: (e) => {}
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/settings/SettingsFooter.tsx";
function Ot() {
	let { t: e } = Et();
	return d("div", {
...
var It = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/settings/SettingsFooter.wrapper.tsx";
function Lt() {
