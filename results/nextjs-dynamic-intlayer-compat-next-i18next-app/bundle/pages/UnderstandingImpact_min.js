			...
			d("div", {
				...
				children: [
					...
					d("ul", {
						...
						children: [
							u("li", { children: e("home.understandingImpact.theJsonMustBeParsed") }),
							u("li", { children: e("home.understandingImpact.contextBasedArchitecturesCanCause") }),
							u("li", { children: e("home.understandingImpact.duringServerSideRenderingThe") })
						]
					})
				]
			}),
