...
}), y = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? g : n : g}` : e, se = (e, t = re, n = g) => [e].flat().map((e) => y(e, t, n)).join(", ");
y("✗", ee), y("✓", te), y("⏲", _);
var b = /* @__PURE__ */ new WeakMap(), ce = 0, le = (e) => {
	if (!e) return "base";
	let t = b.get(e);
	if (t) return t;
	ce += 1;
	let n = `p${ce}`;
	return b.set(e, n), n;
}, ue = 256, x = /* @__PURE__ */ new WeakMap(), S = (e) => typeof e == "object" && !!e, de = (e, t, n) => `${e}_${t}_${le(n)}`, fe = (e, t) => {
	if (!S(e)) return { hit: !1 };
	let n = x.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	if (!S(e)) return n;
	let r = x.get(e);
	return r || (r = /* @__PURE__ */ new Map(), x.set(e, r)), r.size >= ue && r.clear(), r.set(t, n), n;
}, pe = "translation", me = "enumeration", he = "plural", ge = "insertion", _e = "object", ve = "array", ye = "html", be = "gender", xe = "select", w = (e, t) => {
...
}, Ce = (e, t) => e[Se(e, t) ?? "fallback"], T = "default", we = /[^A-Za-z0-9._&=-]/g, Te = /[^A-Za-z0-9._-]/g, Ee = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, E = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, Ee);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, De = (e) => e === void 0 ? T : typeof e == "string" ? E(e, we) : Object.keys(e).sort().map((t) => `${E(t, Te)}=${E(String(e[t]), Te)}`).join("&"), Oe = (e) => Array.isArray(e) ? e.length === 0 ? [T] : e.map(De) : [De(e)], ke = (e, t) => {
	for (let n of e) if (t(n)) return n;
	return t("default") ? T : e[0] ?? "default";
}, Ae = (e, t, n, r) => {
	let i = e.split("/");
	return t.every((e, t) => e === "variant" ? i[t] === r : n?.item === void 0 || i[t] === String(n.item));
}, je = (e) => typeof e == "object" && !!e && "qualifierTypes" in e && Array.isArray(e.qualifierTypes) && "content" in e, Me = (e, t) => {
	let n = t.split("/"), r = {
		key: e.key,
		content: e.content[t]
	};
	...
	if (!je(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? T : ke(Oe(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Ae(e, n, t, s)).map((t) => Me(e, t));
	...
	let n = e[t];
	return `${t}:${t === "variant" ? Oe(n).join(",") : String(n)}`;
}).join("|") : "", Ie = () => ({}), Le = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), D = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Le.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : D(e ? `${e}.${String(n)}` : String(n)) }), O = /* @__PURE__ */ new Set(), k = (e, t, n) => {
	let r = Ie()[e];
	return r ? nt(r, t, n) : (O.has(e) || (oe({ log: h })(typeof window > "u" ? `Dictionary ${se(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), O.add(e)), D(e));
}, Re = 50, A = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Set(), ze = (e) => {
...
function M(e, t, n) {
	let r = t ?? p?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = A.get(a);
...
var He = (e, t, n) => e[M("PluralRules", n).select(t)] ?? e.other, Ue = (e, t) => {
...
}, qe = P, Je = P, Ye = P, Xe = P, Ze = P, Qe = (e) => P, $e = P, et = (e, t = !0) => [
	...
	let { locale: r, selector: i } = Pe(t), a = de(r ?? p.defaultLocale, Fe(i), n), o = fe(e, a);
	if (o.hit) return o.content;
	let s = n ?? et(r), c = Ne(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var I = {
	...
	if (!F) for (let t = 0; t < (m.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(m.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, ot = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !F && m.storage.cookies) for (let n = 0; n < m.storage.cookies.length; n++) {
...
}, ft = (e, t = p?.locales, n = p?.defaultLocale) => {
...
}), { defaultLocale: _t, locales: B } = p ?? {}, vt = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return K(r[ge], t, n);
	if (r.nodeType === "html") return K(r[ye], t, n);
	if (r.nodeType === "plural") {
		let e = r[he];
		return K(He(e, Number(G(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[me], i = H.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	oe({ log: h })(`${y(e, v)}: the ${y("`resources`", v)} option is ignored when using ${y("@intlayer/i18next", ne)} — translations are served from the compiled intlayer dictionaries instead. Remove the resource imports and the ${y("`resources`", v)} option to reduce your bundle size.`);
}, Z = (e = {}) => {
...
var Tt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	let o = (t, n) => Y({
		locale: e,
		namespace: r,
		key: i ? `${i}.${t}` : t,
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = vt(), s = t?.keyPrefix, { translate: c, i18n: l } = o(() => Tt({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
var Dt = {
	type: "3rdParty",
	init: (e) => {}
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/about/WhatWeMeasure.tsx";
function Ot() {
	let { t: e } = Et(), t = [
		{
...
var Pt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/scripts/Wrapper.tsx";
function Ft({ children: e }) {
	return d(Nt, { children: e }, void 0, !1, {
		fileName: Pt,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var It = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-i18next-app/components/pages/about/WhatWeMeasure.wrapper.tsx";
function Lt() {
	return d(Ft, { children: d(Ot, {}, void 0, !1, {
		fileName: It,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
