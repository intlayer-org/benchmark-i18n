...
var Ne = () => ({}), Pe = /* @__PURE__ */ new Set([
	...
	let r = Ne()[e];
	return r ? tt(r, t, n) : (M.has(e) || (je({ log: m })(typeof window > "u" ? `Dictionary ${Me(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), M.add(e)), j(e));
}, Fe = 50, P = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Set(), Ie = (e) => {
...
function I(e, t, n) {
	let r = t ?? f?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = P.get(a);
...
var ze = (e, t, n) => e[I("PluralRules", n).select(t)] ?? e.other, Be = (e, t) => {
	...
	if (z(e)) return e.nodeType === "html" ? e[x] : e[b];
}, Ue = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, Ge = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? B : {
...
}, Ke = B, qe = B, Je = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? B : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: y }], i = e[y], a = {
			...
			transform: (e, n, r) => {
				if (z(e)) return (i) => We(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, nt = ["en"], rt = (e) => /^[a-zA-Z][a-zA-Z\d+\-.]*:/.test(e), V = (e) => {
...
var U = {
	...
	if (t?.isCookieEnabled !== !1 && !H && p.storage.cookies) for (let n = 0; n < p.storage.cookies.length; n++) {
	...
	locales: e.locales ?? f?.locales ?? nt,
	rewrite: e.rewrite ?? p?.rewrite,
	domains: e.domains ?? p?.domains
}), G = (e, t) => !!e && (t ?? f.locales).includes(e), mt = (e, t = f?.locales, n = f?.defaultLocale) => {
	...
	locale: W ?? f?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), gt = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: a, disableEditor: o, isCookieEnabled: c }) => {
	let { locales: ee, defaultLocale: u } = f ?? {}, [d, p] = s(e ?? W ?? t ?? u);
	r(() => {
		e && e !== d && p(e);
	}, [e]), r(() => {
		ft();
	...
	let o = u(), s = p?.mode ?? "prefix-no-default", c = e ?? (s === "prefix-all" || s === "prefix-no-default" ? ht(o) : void 0);
	return l(_t, {
		locale: c,
		...a,
		children: t
	...
	if (r.nodeType === "plural") {
		let e = r[ce];
		return Q(ze(e, Number(Z(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[se], i = J.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[fe], i = Z(t, typeof r.variable == "string" ? r.variable : "value");
	...
	let i = St(t.children, n), a = n[t.tag];
	...
	return Et(e, (t) => Tt(e, n ?? "", i, t), (e) => t ? `${t}.${e}` : e);
}, Tt = (e, t, n, r) => {
	...
	return Object.assign((e, t) => r(e, t) ?? n(e), {
		...
		rich: (e, t) => {
			...
			return o === void 0 ? n(e) : l(c, { children: St($(o), a) });
		},
		markup: (e, t) => {
			let { scalarValues: i, renderers: a } = xt(t), o = r(e, i);
			return o === void 0 ? n(e) : Ct($(o), a);
		}
	});
}, Dt = ((e) => {
	let { locale: t } = n(K) ?? {};
	return a(() => wt(t, e), [t, e]);
}), Ot = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-intl-app/components/MockBanner.tsx", kt = () => {
	let e = Dt();
	return d("div", {
...
var Lt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-intl-app/components/MockBanner.wrapper.tsx";
function Rt() {
