...
var xt = (e, t, n) => e[M("PluralRules", n).select(t)] ?? e.other, St = (e, t) => {
	...
	if (F(e)) return e.nodeType === "html" ? e[b] : e[Ve];
}, Tt = (e, t) => {
...
var B = {
...
}, H = (e) => S(v, e), ln = (e) => S(He, e), U = (e, t) => S(b, e, { tags: (() => {
	if (t) return t;
	if (typeof e == "string") {
		let { issues: t } = Vt(e);
...
})() }), un = (e) => S(Re, e), dn = (e, t) => S(x, e, { variable: t }), fn = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "plural") {
		let e = r[Re];
		return Z(xt(e, Number(X(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[v], i = wn.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
function Hn({ children: e, locale: t }) {
