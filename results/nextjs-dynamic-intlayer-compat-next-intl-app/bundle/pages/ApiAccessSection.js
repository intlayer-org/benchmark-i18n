...
function ApiAccessSection() {
	...
	return jsxs("section", {
		...
		children: [jsx("h2", {
			...
			children: t("settings.api-access-section.apiAccess")
		}), jsxs("div", { children: [
			jsx("label", {
				htmlFor: apiKeyId,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: t("settings.api-access-section.apiKey")
			}),
			jsxs("div", {
			...
			jsx("p", {
				...
				children: t("settings.api-access-section.useThisKeyToAccess")
			})
		] })]
	});
}
