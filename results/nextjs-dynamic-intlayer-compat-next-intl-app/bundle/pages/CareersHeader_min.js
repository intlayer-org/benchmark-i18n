...
var j = () => ({}), Ne = /* @__PURE__ */ new Set([
	...
	let r = j()[e];
	return r ? ot(r, t, n) : (Fe.has(e) || (k({ log: p })(typeof window > "u" ? `Dictionary ${Me(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Fe.add(e)), Pe(e));
