...
var f = {
...
}, ae = "translation", oe = "enumeration", se = "plural", y = "insertion", ce = "object", le = "array", ue = "markdown", b = "html", x = "gender", S = "select", C = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), w = (e, t) => {
...
}, fe = (e, t) => e[de(e, t) ?? "fallback"], pe = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), T = "default", me = /[^A-Za-z0-9._&=-]/g, E = /[^A-Za-z0-9._-]/g, he = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, D = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, he);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, O = (e) => e === void 0 ? T : typeof e == "string" ? D(e, me) : Object.keys(e).sort().map((t) => `${D(t, E)}=${D(String(e[t]), E)}`).join("&"), ge = (e) => Array.isArray(e) ? e.length === 0 ? [T] : e.map(O) : [O(e)], _e = (e, t) => {
	...
	if (!ye(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? T : _e(ge(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => ve(e, n, t, s)).map((t) => be(e, t));
...
var j = () => ({}), Ne = /* @__PURE__ */ new Set([
	...
	let r = j()[e];
	return r ? ot(r, t, n) : (Fe.has(e) || (je({ log: m })(typeof window > "u" ? `Dictionary ${Me(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Fe.add(e)), Pe(e));
...
var Ue = (e, t, n) => e[M("PluralRules", n).select(t)] ?? e.other, We = (e, t) => {
	...
	let { locale: r, selector: i } = Se(t), a = re(r ?? f.defaultLocale, Ce(i), n), o = ie(e, a);
	if (o.hit) return o.content;
	let s = n ?? it(r), c = xe(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
}, U = (e) => C(oe, e), kt = (e) => C(x, e), W = (e, t) => C(b, e, { tags: (() => {
	if (t) return t;
	if (typeof e == "string") {
		let { issues: t } = ut(e);
...
})() }), At = (e) => C(se, e), jt = (e, t) => C(S, e, { variable: t }), Mt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
function on() {
	let e = rn(), t = rn("header");
	return an("Hero"), u("section", {
