...
var H = {
	...
	let { locales: u, defaultLocale: ee } = f ?? {}, [d, p] = s(e ?? U ?? t ?? ee);
	r(() => {
		e && e !== d && p(e);
	}, [e]), r(() => {
		pt();
	...
	let o = ee(), s = p?.mode ?? "prefix-no-default", c = e ?? (s === "prefix-all" || s === "prefix-no-default" ? gt(o) : void 0);
	return l(vt, {
		locale: c,
		...a,
		children: t
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-intl-app/components/pages/home/Hero.tsx";
function At() {
	let e = Ot(), t = Ot("header");
	return kt("Hero"), d("section", {
...
var Nt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-intl-app/components/AppProviders.tsx";
function Pt({ children: e, locale: t }) {
...
var Ft = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-intl-app/scripts/Wrapper.tsx", It = "en";
...
var Rt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/intlayer-compat-next-intl-app/components/pages/home/Hero.wrapper.tsx";
function zt() {
