...
var Et = (e) => G, Dt = G, Ot = (e, t = !0) => [
	...
	let r = e;
	if (r.nodeType === "insertion") return X(r[R], t, n);
	if (r.nodeType === "html") return X(r[z], t, n);
	if (r.nodeType === "plural") {
		let e = r[Ie];
		return X(st(e, Number(Y(t, "count") ?? 1), n), t, n);
	}
	...
	if (r.nodeType === "select") {
		let e = r[He], i = Y(t, typeof r.variable == "string" ? r.variable : "value");
		return X(ct(e, String(i ?? "")), t, n);
	}
	...
	return Object.assign((e, t) => r(e, t) ?? n(e), {
		...
		rich: (e, t) => {
			...
			return o === void 0 ? n(e) : l(c, { children: Jt(Z(o), a) });
		},
		markup: (e, t) => {
			let { scalarValues: i, renderers: a } = qt(t), o = r(e, i);
