...
var m = {
...
}, Le = "translation", Re = "enumeration", ze = "plural", v = "insertion", Be = "object", Ve = "array", He = "markdown", y = "html", b = "gender", x = "select", S = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), C = (e, t) => {
...
}, We = (e, t) => e[Ue(e, t) ?? "fallback"], Ge = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), w = "default", Ke = /[^A-Za-z0-9._&=-]/g, T = /[^A-Za-z0-9._-]/g, qe = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, E = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, qe);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, Je = (e) => e === void 0 ? w : typeof e == "string" ? E(e, Ke) : Object.keys(e).sort().map((t) => `${E(t, T)}=${E(String(e[t]), T)}`).join("&"), D = (e) => Array.isArray(e) ? e.length === 0 ? [w] : e.map(Je) : [Je(e)], Ye = (e, t) => {
	...
	if (!Ze(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? w : Ye(D(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Xe(e, n, t, s)).map((t) => Qe(e, t));
...
}).join("|") : "", O = "\x1B[0m", nt = "\x1B[34m", rt = "\x1B[31m", it = "\x1B[32m", at = "\x1B[38;5;3m", ot = "\x1B[36m", st = (e) => e, ct = (e, t) => {
...
}), k = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? O : n : O}` : e, ut = (e, t = at, n = O) => [e].flat().map((e) => k(e, t, n)).join(", ");
k("✗", rt), k("✓", it), k("⏲", nt);
var dt = {
	faq: d,
	header: f,
	...
	yield e;
} : mt(e ? `${e}.${String(n)}` : String(n)) }), ht = /* @__PURE__ */ new Set(), A = (e, t, n) => {
	let r = ft()[e];
	return r ? It(r, t, n) : (ht.has(e) || (lt({ log: ke })(typeof window > "u" ? `Dictionary ${ut(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), ht.add(e)), mt(e));
...
var bt = (e, t, n) => e[N("PluralRules", n).select(t)] ?? e.other, xt = (e, t) => {
	...
	if (I(e)) return e.nodeType === "html" ? e[y] : e[He];
}, wt = (e, t) => {
...
var Mt = (e) => L, Nt = L, Pt = (e, t = !0) => [
	...
	let { locale: r, selector: i } = et(t), a = Fe(r ?? m.defaultLocale, tt(i), n), o = Ie(e, a);
	if (o.hit) return o.content;
	let s = n ?? Pt(r), c = $e(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var V = {
	...
	let { locales: u, defaultLocale: d } = m ?? {}, [f, p] = s(e ?? Kt ?? t ?? d);
	r(() => {
		e && e !== f && p(e);
	}, [e]), r(() => {
		Qt();
	...
	n !== void 0 && lt({ log: ke })(`${k("NextIntlClientProvider", ot)} do not pass the messages prop with intlayer. Messages are loaded automatically under the hood for bundle optimization reason`);
...
}, U = (e) => S(Re, e), cn = (e) => S(b, e), W = (e, t) => S(y, e, { tags: (() => {
	if (t) return t;
	if (typeof e == "string") {
		let { issues: t } = Bt(e);
...
})() }), ln = (e) => S(ze, e), un = (e, t) => S(x, e, { variable: t }), dn = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "enumeration") {
		let e = r[Re], i = Cn.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
			...
			u("div", {
				...
				children: [
					...
					u("ul", {
						...
						children: [
							l("li", { children: e("understanding-impact.theJsonMustBeParsed") }),
							l("li", { children: e("understanding-impact.contextBasedArchitecturesCanCause") }),
							l("li", { children: e("understanding-impact.duringServerSideRenderingThe") })
						]
					})
				]
			}),
...
function Bn({ children: e, locale: t }) {
