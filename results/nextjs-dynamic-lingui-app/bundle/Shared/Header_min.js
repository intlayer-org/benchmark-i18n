...
function Oe({ children: e, locale: t, messages: o }) {
	let s = i(() => Se(t, o), [t, o]), [c] = a(() => typeof performance < "u" ? performance.now() : 0);
	return r(() => {
		De("AppRoot", c);
	}, [c]), n(() => {
