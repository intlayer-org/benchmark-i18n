...
var fe = e(null), pe = ({ i18n: e, defaultComponent: r, children: i }) => {
...
function ge({ children: e, locale: t, messages: a }) {
	let s = i(() => ue(t, a), [t, a]), [c] = o(() => typeof performance < "u" ? performance.now() : 0);
	return r(() => {
		he("AppRoot", c);
	}, [c]), n(() => {
