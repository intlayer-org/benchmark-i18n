import { createContext as e, useContext as t, useEffect as n, useId as r, useLayoutEffect as i, useMemo as a, useState as o } from "react";
...
var _ = (e, t) => ({
	...
	let r = a(() => v(e, t), [e, t]), i = (0, p.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
	return i.i18n.locale ? s(m.Provider, {
		value: i,
		children: n
...
}, b = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/lingui-app/components/pages/contact/ContactForm.tsx";
function x() {
	let { i18n: e } = g(), t = r(), n = r(), i = r(), a = r();
	return c("form", {
		className: "space-y-6",
		children: [
			c("div", {
				className: "grid gap-4 md:grid-cols-2",
				children: [c("div", { children: [c("label", {
					htmlFor: t,
			...
			c("div", { children: [c("label", {
				...
				children: [
					c("option", { children: e._("contact-form.bugReport") }, void 0, !1, {
						fileName: b,
						lineNumber: 56,
						columnNumber: 11
					}, this),
					c("option", { children: e._("contact-form.newBenchmarkIdea") }, void 0, !1, {
						fileName: b,
						lineNumber: 57,
						columnNumber: 11
					}, this),
					c("option", { children: e._("contact-form.methodologyQuestion") }, void 0, !1, {
						fileName: b,
						lineNumber: 58,
						columnNumber: 11
					}, this),
					c("option", { children: e._("contact-form.contribution") }, void 0, !1, {
						fileName: b,
						lineNumber: 59,
						columnNumber: 11
					}, this),
					c("option", { children: e._("contact-form.other") }, void 0, !1, {
						fileName: b,
						lineNumber: 60,
						columnNumber: 11
					}, this)
...
function Q({ children: e, locale: t, messages: r }) {
	let s = a(() => ge(t, r), [t, r]), [l] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		C("AppRoot", l);
	}, [l]), n(() => {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/lingui-app/components/pages/contact/ContactForm.wrapper.tsx";
function xe() {
	return c(be, { children: c(x, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
