	...
	return c("form", {
		...
		children: [
			...
			c("div", { children: [s("label", {
				...
				children: [
					s("option", { children: e._("contact-form.bugReport") }),
					s("option", { children: e._("contact-form.newBenchmarkIdea") }),
					s("option", { children: e._("contact-form.methodologyQuestion") }),
					s("option", { children: e._("contact-form.contribution") }),
					s("option", { children: e._("contact-form.other") })
				]
			})] }),
			c("div", { children: [s("label", {
				htmlFor: a,
...
function me({ children: e, locale: t, messages: r }) {
	let c = a(() => $(t, r), [t, r]), [l] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		S("AppRoot", l);
	}, [l]), n(() => {
