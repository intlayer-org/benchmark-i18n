...
var E = (e, t) => ({
	...
	let r = o(() => D(e, t), [e, t]), i = (0, h.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
...
var V = (e) => typeof e == "string", _e = (e) => typeof e == "function", H = /* @__PURE__ */ new Map(), U = "en";
function W(e) {
...
function G(e, t, n) {
	...
	return J(() => Y("date", r, n), () => new Intl.DateTimeFormat(r, i)).format(V(t) ? new Date(t) : t);
}
function ve(e, t, n) {
	let r;
...
function xe(e, t, n) {
	return (r = {}, i) => {
		...
		return V(s) && X.test(s) ? Z(s) : V(s) ? s : s ? String(s) : "";
	};
}
var Se = class {
	_events = {};
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(ge), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? U, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), V(s) && X.test(s) ? Z(s) : V(s) ? s : xe(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
