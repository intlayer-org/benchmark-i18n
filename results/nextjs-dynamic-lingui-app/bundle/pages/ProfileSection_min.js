...
var E = (e, t) => ({
	...
	let r = o(() => te(e, t), [e, t]), i = (0, h.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
...
var O = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/lingui-app/components/pages/settings/ProfileSection.tsx";
function k() {
...
function me(e, t) {
	switch (e.field) {
		...
		case "weekday": return { weekday: de(e, t) };
		case "period": return;
		case "hour": return fe(e);
		case "min": return { minute: M(e.width) };
		case "sec": return { second: M(e.width) };
		case "tz": return { timeZoneName: pe(e, t) };
		case "quarter":
		case "week":
		case "sec-frac":
...
function _e(e, t) {
	return /^::/.test(e) ? he(L(e.substring(2)), void 0, t) : e;
}
function ve(e, t = (e) => e) {
...
var De = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/lingui-app/components/AppProviders.tsx";
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/lingui-app/components/pages/settings/ProfileSection.wrapper.tsx";
function Me() {
	return u(je, { children: u(k, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
