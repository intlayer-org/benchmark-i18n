...
function Ce({ children: e, locale: t, messages: n }) {
	let s = a(() => Se(t, n), [t, n]), [l] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		O("AppRoot", l);
	}, [l]), r(() => {
