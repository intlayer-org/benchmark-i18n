...
var E = (e, t) => ({
	...
	let r = a(() => D(e, t), [e, t]), i = (0, m.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
...
var B = (e) => typeof e == "string", V = (e) => typeof e == "function", H = /* @__PURE__ */ new Map(), U = "en";
function W(e) {
	return [...Array.isArray(e) ? e : [e], U];
}
function G(e, t, n) {
	let r = W(e);
	n ||= "default";
	...
	return J(() => Y("date", r, n), () => new Intl.DateTimeFormat(r, i)).format(B(t) ? new Date(t) : t);
}
function ve(e, t, n) {
	let r;
...
function K(e, t, n) {
	let r = W(e);
	return J(() => Y("number", r, n), () => new Intl.NumberFormat(r, n)).format(t);
}
function q(e, t, n, { offset: r = 0, ...i }) {
	let a = W(e), o = t ? J(() => Y("plural-ordinal", a), () => new Intl.PluralRules(a, { type: "ordinal" })) : J(() => Y("plural-cardinal", a), () => new Intl.PluralRules(a, { type: "cardinal" }));
	return i[n] ?? i[o.select(n - r)] ?? i.other;
}
function J(e, t) {
	let n = e(), r = H.get(n);
	return r || (r = t(), H.set(n, r)), r;
}
function Y(e, t, n) {
	return `${e}-${t.join("-")}-${JSON.stringify(n)}`;
}
var X = /\\u[a-fA-F0-9]{4}|\\x[a-fA-F0-9]{2}/, Z = (e) => e.replace(/\\u([a-fA-F0-9]{4})|\\x([a-fA-F0-9]{2})/g, (e, t, n) => {
	if (t) {
		let e = parseInt(t, 16);
...
}), Q = "%__lingui_octothorpe__%", ye = (e, t, n = {}) => {
	let r = t || e, i = (e) => typeof e == "object" ? e : n[e], a = (e, t) => {
		let a = Object.keys(n).length ? i("number") : void 0, o = K(r, e, a);
		return t.replace(new RegExp(Q, "g"), o);
	};
	return {
		plural: (e, t) => {
			let { offset: n = 0 } = t, i = q(r, !1, e, t);
			return a(e - n, i);
		},
		selectordinal: (e, t) => {
			let { offset: n = 0 } = t, i = q(r, !0, e, t);
			return a(e - n, i);
		},
		select: be,
		number: (e, t) => K(r, e, i(t) || { style: t }),
		date: (e, t) => G(r, e, i(t) || t),
...
function xe(e, t, n) {
	return (r = {}, i) => {
		...
		return B(s) && X.test(s) ? Z(s) : B(s) ? s : s ? String(s) : "";
	};
}
var Se = class {
	_events = {};
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(_e), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? U, e.locales);
	}
	get locale() {
		return this._locale;
	}
	...
	_(e, t, n) {
		...
		if (o && a) return V(o) ? o(this._locale, e) : o;
		a && this.emit("missing", {
			id: e,
			locale: this._locale
		});
...
`)), B(s) && X.test(s) ? Z(s) : B(s) ? s : xe(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
