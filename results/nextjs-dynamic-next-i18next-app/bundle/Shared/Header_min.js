...
var nt = (e, t, n) => {
	...
	return !(typeof e != "string" || e.length > 128 || rt.indexOf(e) > -1 || e.indexOf("..") > -1 || e.indexOf("\\") > -1 || !t && e.indexOf("/") > -1 || /[\x00-\x1F\x7F]/.test(e));
};
q.use(Le).use(function(e) {
	return {
		type: "backend",
		init: function(e, t, n) {},
		read: function(t, n, r) {
			if (!it(t, !1) || !it(n, !0)) return r(/* @__PURE__ */ Error("i18next-resources-to-backend: unsafe language/namespace value"), !1);
...
function ot({ children: e }) {
	return p(at, { children: e });
}
function st() {
	return p(ot, { children: p($e, {}) });
}
