...
var g = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), _ = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
var b = ({ href: e, children: t, ...n }) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? x(e[r]) || e[r] instanceof String || x(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : M(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, N = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), te = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, ne = (e) => x(e) ? e.replace(/[&<>"'\/]/g, (e) => te[e]) : e, re = class {
	constructor(e) {
	...
	"!",
	";"
], ae = new re(20), oe = (e, t, n) => {
	t ||= "", n ||= "";
	let r = ie.filter((e) => !t.includes(e) && !n.includes(e));
	if (r.length === 0) return !0;
	let i = ae.getRegExp(`(${r.map((e) => e === "?" ? "\\?" : e).join("|")})`), a = !i.test(e);
	if (!a) {
		let t = e.indexOf(n);
	...
	getResource(e, t, n, r = {}) {
		...
		let s = j(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !x(n) ? s : P(this.data?.[e]?.[t], n, i);
	}
...
function V(e, t) {
	let { [B]: n } = e(ce()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var H = (e) => !x(e) && typeof e != "boolean" && typeof e != "number", U = class e extends L {
	constructor(e, t = {}) {
		super(), w([
			"resourceStore",
			"languageUtils",
	...
	extractFromKey(e, t) {
		...
		n === void 0 && (n = ":");
		let r = t.keySeparator === void 0 ? this.options.keySeparator : t.keySeparator, i = t.ns || this.options.defaultNS || [], a = n && e.includes(n), o = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !oe(e, n, r);
		if (a && !o) {
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return x(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? V(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	let a = ee(e, t, n);
	return !a && i && x(n) && (a = P(e, n, r), a === void 0 && (a = P(t, n, r))), a;
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? ne : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? N(i) : a || "{{", this.suffix = o ? N(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? N(d) : f || N("$t("), this.nestingSuffix = p ? N(p) : m || N(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new le(G());
...
var Ce = (e, t, n, r) => {
	...
	d && !d.reportNamespaces && (d.reportNamespaces = new ze()), d || J(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = o(() => ({
		...Ne(),
		...d?.options?.react,
		...t
...
function it({ children: e }) {
	return p(rt, { children: e });
}
function at() {
	return p(it, { children: p($e, {}) });
}
