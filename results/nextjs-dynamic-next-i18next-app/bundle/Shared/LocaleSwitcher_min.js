...
var xe = (e, t, n) => {
	...
	return !(typeof e != "string" || e.length > 128 || Se.indexOf(e) > -1 || e.indexOf("..") > -1 || e.indexOf("\\") > -1 || !t && e.indexOf("/") > -1 || /[\x00-\x1F\x7F]/.test(e));
};
X.use(ge).use(function(e) {
	return {
		type: "backend",
		init: function(e, t, n) {},
		read: function(t, n, r) {
...
function we({ children: e }) {
	return l(Ce, { children: e });
}
function Te() {
	return l(we, { children: l(f, {}) });
}
