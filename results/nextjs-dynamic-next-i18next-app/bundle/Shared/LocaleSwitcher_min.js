...
var f = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-i18next-app/components/LocaleSwitcher.tsx";
function p() {
...
var R = (e) => !m(e) && typeof e != "boolean" && typeof e != "number", z = class e extends N {
	...
	init(e, t = { interpolation: {} }) {
		...
		let n = t.cacheInBuiltFormats ? K : ce;
		this.formats = {
			number: n((e, t) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			C(n.loaded, [i], a), ue(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), J = (e) => (m(e.ns) && (e.ns = [e.ns]), m(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), m(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), Y = () => {}, fe = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, X = class e extends N {
	constructor(e = {}, t) {
		if (super(), this.options = J(e), this.services = {}, this.logger = M, this.modules = { external: [] }, fe(this), t && !this.isInitialized && !e.isClone) {
...
function ye({ i18n: e, defaultNS: n, children: r }) {
	let a = i(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
	return t(ve.Provider, { value: a }, r);
}
function be() {
	if (!(typeof window > "u")) {
...
var Se = (e, t, n) => {
	...
	return !(typeof e != "string" || e.length > 128 || Ce.indexOf(e) > -1 || e.indexOf("..") > -1 || e.indexOf("\\") > -1 || !t && e.indexOf("/") > -1 || /[\x00-\x1F\x7F]/.test(e));
};
X.use(_e).use(function(e) {
	return {
		type: "backend",
		init: function(e, t, n) {},
		read: function(t, n, r) {
...
var $ = X, we = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-i18next-app/components/AppProviders.tsx";
...
var Ee = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-i18next-app/scripts/Wrapper.tsx";
function De({ children: e }) {
	return l(Te, { children: e }, void 0, !1, {
		fileName: Ee,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var Oe = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-i18next-app/components/LocaleSwitcher.wrapper.tsx";
function ke() {
	return l(De, { children: l(p, {}, void 0, !1, {
		fileName: Oe,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
