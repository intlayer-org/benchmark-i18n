...
var F = (e) => !h(e) && typeof e != "boolean" && typeof e != "number", I = class e extends N {
	constructor(e, t = {}) {
		super(), v([
			"resourceStore",
			"languageUtils",
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			}), i.trim())), e = e.replace(r[0], V(_(i))), this.regexp.lastIndex = 0;
		}
		return e;
	}
}, de = (e) => {
	...
	init(e, t = { interpolation: {} }) {
		...
		let n = t.cacheInBuiltFormats ? U : fe;
		this.formats = {
			number: n((e, t) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			w(n.loaded, [i], a), me(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), G = (e) => (h(e.ns) && (e.ns = [e.ns]), h(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), h(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), K = () => {}, ge = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, q = class e extends N {
	constructor(e = {}, t) {
		if (super(), this.options = G(e), this.services = {}, this.logger = M, this.modules = { external: [] }, ge(this), t && !this.isInitialized && !e.isClone) {
...
var _e = (e, t, n, r) => {
	...
	Z(n) && J[n] || (Z(n) && (J[n] = /* @__PURE__ */ new Date()), _e(e, t, n, r));
}, ve = (e, t) => () => {
...
function qe({ children: e }) {
	return u(Ke, { children: e });
}
function Je() {
	return u(qe, { children: u(Be, {}) });
}
