...
var p = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), m = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, A = (e) => h(e) ? e.replace(/[&<>"'\/]/g, (e) => k[e]) : e, ee = class {
	constructor(e) {
...
var I = (e) => !h(e) && typeof e != "boolean" && typeof e != "number", L = class e extends P {
	constructor(e, t = {}) {
		super(), v([
			"resourceStore",
			"languageUtils",
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return h(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? F(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? A : t, this.escapeValue = n === void 0 || n, this.useRawValueToEscape = r !== void 0 && r, this.prefix = i ? O(i) : a || "{{", this.suffix = o ? O(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u ? O(u) : "-", this.unescapeSuffix = this.unescapePrefix ? "" : l ? O(l) : "", this.nestingPrefix = d ? O(d) : f || O("$t("), this.nestingSuffix = p ? O(p) : m || O(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ !== void 0 && _, this.resetRegExp();
	}
	reset() {
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			}), i.trim())), e = e.replace(r[0], H(_(i))), this.regexp.lastIndex = 0;
		}
		return e;
	}
}, ue = (e) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			w(n.loaded, [i], a), pe(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), K = (e) => (h(e.ns) && (e.ns = [e.ns]), h(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), h(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), q = () => {}, he = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, J = class e extends P {
	constructor(e = {}, t) {
		if (super(), this.options = K(e), this.services = {}, this.logger = N, this.modules = { external: [] }, he(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		...
		if (!this.options.isClone) {
			...
			let n = this.services;
			n.logger = N, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new le(t, { prepend: this.options.pluralSeparator }), e && (n.formatter = r(e), n.formatter.init && n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new U(this.options), n.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }, n.backendConnector = new me(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (e, ...t) => {
				this.emit(e, ...t);
