...
var je = class {
	...
	parseTag(e, t) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !V(this.char())) return this.error(I.INVALID_TAG, z(o, this.clonePosition()));
				let e = this.clonePosition();
...
function H(e) {
	e.forEach((e) => {
		...
		else O(e) && P(e.style) || (k(e) || A(e)) && F(e.style) ? delete e.style.location : N(e) && H(e.children);
	});
}
function Fe(e, t = {}) {
	t = {
