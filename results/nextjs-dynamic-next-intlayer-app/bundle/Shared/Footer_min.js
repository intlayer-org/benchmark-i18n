...
var g = (e, t, n) => {
	...
	D(e ?? _.defaultLocale, t ? _.defaultLocale : void 0),
	O,
	k,
	ce,
	j(e ?? _.defaultLocale),
...
}, fe = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", N = /\{\{\s*(.*?)\s*\}\}/g, P = (e, t = {}) => {
...
}, pe = E, me = E, H = /* @__PURE__ */ new Map(), he = (e, t = !0) => {
	...
	return H.set(n, r), r;
}, ge = (e, t) => de(e, t, he(t)), U = (e) => /^[a-zA-Z][a-zA-Z\d+\-.]*:/.test(e), W = (e, t = _?.locales) => {
	let n = U(e), r = e;
	...
	defaultLocale: _?.defaultLocale ?? "en",
	mode: v?.mode ?? "prefix-no-default",
	locales: _?.locales ?? _e,
	rewrite: v?.rewrite,
	domains: v?.domains,
	...e
}), ve = (e, t = {}) => {
	let { defaultLocale: n, mode: r, locales: i, domains: a } = G(t);
	...
	path: e,
	isRewritten: !1
}), K = (e, t = _?.defaultLocale, n = {}) => {
	let { defaultLocale: r, mode: i, locales: a, rewrite: o, domains: s, currentDomain: c } = G(n), l = W(e, a), u = U(l), d = u ? new URL(l) : new URL(l, "http://example.com"), f = be(ye(d.pathname, void 0, void 0), t, void 0).path, p = u ? `${d.protocol}//${d.host}` : "", { prefix: m } = ve(t, {
		defaultLocale: r,
		mode: i,
		locales: a,
		domains: s
...
}, xe = (e, t = _?.locales, n = _?.defaultLocale) => {
...
var Se = (e, t, n) => {
	...
	if (!q) for (let t = 0; t < (v.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(v.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, we = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !q && v.storage.cookies) for (let n = 0; n < v.storage.cookies.length; n++) {
...
}, Ee = ({ children: e }) => (Te(), e), De = () => {
	typeof window < "u" && (window.intlayer = { enabled: !0 });
}, Z = t({
	locale: Y ?? _?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), Oe = ({ locale: e, defaultLocale: t, children: n, setLocale: r, disableEditor: i, isCookieEnabled: a }) => {
	let { locales: s, defaultLocale: c } = _ ?? {}, [l, d] = u(e ?? Y ?? t ?? c);
	o(() => {
		e && e !== l && d(e);
	}, [e]), o(() => {
		De();
...
}, Q = /* @__PURE__ */ new Map(), Me = (e, t) => (Q.has(e) || Q.set(e, je(t)), Q.get(e).read()), Ne = (e, t, n) => {
	let { locale: r } = a(Z) ?? {}, i = c(() => n ?? r ?? _.defaultLocale, [r, n]);
	return Ae(Me(`${String(t)}.${i}`, e[i]?.()), i);
}, Pe = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { defaultLocale: n, locales: r } = _ ?? {}, { locale: o, setLocale: s, isCookieEnabled: c } = a(Z) ?? {};
	return {
		locale: o,
		defaultLocale: n,
		availableLocales: r,
...
}, Le = ({ onChange: e = "replace" } = {}) => {
	let { replace: t, push: n } = h(), r = Ie();
	return {
		...Pe({ onLocaleChange: i((i) => {
			if (!e) return;
			let a = K(r, i, { currentDomain: void 0 });
...
}, $ = (e) => /^https?:\/\//.test(e ?? ""), Re = ({ href: e, children: t, ...n }) => {
	let { locale: r } = Le(), i = $(e.toString());
	return f(ee, {
		href: e && !i ? K(e.toString(), r) : e,
		prefetch: !1,
		...n,
		children: t
	});
			...
			children: [p("div", {
				...
				children: [
					...
					p("div", { children: [f("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => f("li", { children: e.isInternal ? f(Re, {
							href: e.href,
...
function He({ children: e, locale: t }) {
