...
var h = {
	...
	en: () => import("./intlayer-MockBanner-wrapper-afl12a-en-B_r18Jb7.js").then((e) => e.t).then((e) => e.default),
...
var ue = (e) => {
...
}, C = /* @__PURE__ */ new Map(), de = (e, t) => (C.has(e) || C.set(e, ue(t)), C.get(e).read()), w = /* @__PURE__ */ new Map(), fe = (e, t) => Object.create(new Proxy(e, {
	get: (e, t, n) => {
...
}), pe = (e, t = Object.prototype) => {
	let n = typeof e, r = e == null ? null : n === "object" || n === "function" ? Object.getPrototypeOf(e) : n, i = w.get(t);
	i || (i = /* @__PURE__ */ new Map(), w.set(t, i));
	let a = i.get(r);
	return a || (a = fe(t, r === null ? null : Object.getPrototypeOf(Object(e))), i.set(r, a)), a;
}, me = ({ children: e, value: t, additionalProps: n }) => Object.setPrototypeOf({
	...r(e) ? e : l(c, { children: e }),
	value: t,
	...n
}, pe(t)), T = /* @__PURE__ */ new WeakMap(), E = 0, he = (e) => {
	if (!e) return "base";
	let t = T.get(e);
	if (t) return t;
	E += 1;
...
}, ye = "translation", be = "enumeration", xe = "plural", Se = "condition", A = "insertion", Ce = "object", we = "array", j = "markdown", M = "html", Te = "gender", Ee = "select", N = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), P = (e, t) => {
...
}, H = B, U = (e) => B, W = B, je = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? B : {
	id: "insertion-plugin",
...
}, K = (e, t) => typeof t == "function" && G.includes(e?.nodeType ?? "") ? (n) => Me(e, t, n) : t, q = B, J = B, Y = (e) => B, X = B, Ne = (e, t = !0) => [
	...
	q,
	J
].filter((e) => e !== B), Pe = (e, t, n = []) => P(e, {
	...t,
	plugins: n
}), Z = /* @__PURE__ */ new WeakSet(), Fe = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = _e(r ?? d.defaultLocale, "", n), o = ve(e, a);
...
}, Le = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", Q = /\{\{\s*(.*?)\s*\}\}/g, Re = (e, t = {}) => {
...
}, He = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? B : {
	id: "insertion-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "insertion",
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: A }], i = e[A], a = {
...
}, Ue = B, We = B, $ = /* @__PURE__ */ new Map(), Ge = (e, t = !0) => {
	...
	return $.set(n, r), r;
}, Ke = (e, t) => Fe(e, t, Ge(typeof t == "object" && t ? t.locale : t)), qe = oe, Je = t({
	get locale() {
		return qe() ?? d?.defaultLocale;
	},
	setLocale: () => null,
	isCookieEnabled: !0
}), Ye = (e, t, n) => {
	...
	if (l) return Ke(l, c);
	let u = e;
	return Ke(de(`${String(t)}.${c}`, u[c]?.()), c);
}, Xe = () => {
	let e = Ye(b, "mock-banner");
	return l("div", {
