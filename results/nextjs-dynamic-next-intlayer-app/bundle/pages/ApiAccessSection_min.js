...
var x = {
	...
	en: () => import("./intlayer-ApiAccessSection-wrapper-ny5req-en-65duzx_x.js").then((e) => e.t).then((e) => e.default),
...
}, lt = (e) => u(st, { ...e }), $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/settings/ApiAccessSection.tsx";
function ut() {
	let e = ct(C, "api-access-section"), t = "api-key";
	return f("section", {
...
var _t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/settings/ApiAccessSection.wrapper.tsx";
function vt() {
