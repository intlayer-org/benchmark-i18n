...
var x = {
	...
	en: () => import("./intlayer-BlogList-wrapper-yhhiqc-en-C2i0qWN9.js").then((e) => e.t).then((e) => e.default),
...
}, lt = (e) => u(st, { ...e }), $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/blog/BlogList.tsx";
function ut() {
	let e = ct(C, "blog-list"), t = [
		{
			title: e.g.value,
			date: e.m.value,
			excerpt: e.w.value,
...
var _t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/blog/BlogList.wrapper.tsx";
function vt() {
