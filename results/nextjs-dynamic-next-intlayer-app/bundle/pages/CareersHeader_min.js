...
var v = {
	...
	en: () => import("./intlayer-CareersHeader-wrapper-1vkbav-en-BOTmEp8Q.js").then((e) => e.n).then((e) => e.default),
...
var me = (e) => {
	...
	en: () => import("./intlayer-CareersHeader-wrapper-1vkbav-en-BOTmEp8Q.js").then((e) => e.t).then((e) => e.default),
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/careers/CareersHeader.tsx";
function gt() {
	let e = dt(C, "careers-header");
	return p(f, { children: [
		p(ht, {}, void 0, !1, {
			fileName: $,
			lineNumber: 11,
...
var Ct = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/careers/CareersHeader.wrapper.tsx";
function wt() {
