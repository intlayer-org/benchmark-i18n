...
var x = {
	...
	en: () => import("./intlayer-ContactForm-wrapper-lsx4gs-en-DyOKHRru.js").then((e) => e.t).then((e) => e.default),
...
}, lt = (e) => u(st, { ...e }), $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/contact/ContactForm.tsx";
function ut() {
	let e = ct(C, "contact-form"), t = "name", n = "email", r = "topic", i = "message";
	return f("form", {
		className: "space-y-6",
		children: [
			f("div", {
...
var _t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/contact/ContactForm.wrapper.tsx";
function vt() {
