...
var v = {
	...
	en: () => import("./intlayer-FAQHeader-wrapper-95g355-en-C6KWPLyJ.js").then((e) => e.n).then((e) => e.default),
...
var me = (e) => {
	...
	en: () => import("./intlayer-FAQHeader-wrapper-95g355-en-C6KWPLyJ.js").then((e) => e.t).then((e) => e.default),
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/faq/FAQHeader.tsx";
function gt() {
	let e = dt(C, "faq-header1");
	return p(f, { children: [
		p(ht, {}, void 0, !1, {
			fileName: $,
			lineNumber: 11,
...
var Ct = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/faq/FAQHeader.wrapper.tsx";
function wt() {
