...
var x = {
	...
	en: () => import("./intlayer-FAQList-wrapper-1yc0lz-en-C3GIgddm.js").then((e) => e.t).then((e) => e.default),
...
}, lt = (e) => u(st, { ...e }), $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/faq/FAQList.tsx";
function ut() {
	let e = ct(C, "faq-list"), t = [
		{
			q: e.m.value,
			a: e.f.value
		},
...
var _t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/faq/FAQList.wrapper.tsx";
function vt() {
