...
var h = {
	...
	return (v === void 0 || ue !== e) && (ue = e, v = le()), v;
}, b = {
...
var de = (e) => {
	...
	let n = `p${E}`;
	return T.set(e, n), n;
}, _e = 256, D = /* @__PURE__ */ new WeakMap(), ve = (e) => typeof e == "object" && !!e, ye = (e, t, n) => `${e}_${t}_${ge(n)}`, be = (e, t) => {
	...
	return Q.set(n, r), r;
}, Je = (e, t) => Le(e, t, qe(typeof t == "object" && t ? t.locale : t)), Ye = se, Xe = t({
	get locale() {
...
function tt() {
	let e = Ze(b, "pricing-header");
	return u(c, { children: [l(et, {}), u("div", {
