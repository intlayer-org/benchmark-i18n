...
var x = {
	...
	en: () => import("./intlayer-PricingTiers-wrapper-snxpv3-en-B2Z8CWox.js").then((e) => e.t).then((e) => e.default),
...
}, lt = (e) => u(st, { ...e }), $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/pricing/PricingTiers.tsx";
function ut() {
	let e = ct(C, "pricing-tiers"), t = [
		{
			name: e.y,
			price: e.r,
			period: e.l,
...
var _t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/pricing/PricingTiers.wrapper.tsx";
function vt() {
