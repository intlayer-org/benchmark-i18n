...
var x = {
	...
	en: () => import("./intlayer-ProductsGrid-wrapper-ua651a-en-C9GIQdIp.js").then((e) => e.t).then((e) => e.default),
...
}, lt = (e) => u(st, { ...e }), $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/products/ProductsGrid.tsx";
function ut() {
	let e = ct(C, "products-grid"), t = [
		{
			name: e.e.value,
			desc: e.r.value,
			price: e.j.value
...
var _t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/products/ProductsGrid.wrapper.tsx";
function vt() {
