...
var p = (e, t, n) => {
	...
	return n;
}, re = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), S = (e) => {
...
}, ae = process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false", w = process.env.INTLAYER_NODE_TYPE_INSERTION === "false", T = {
	id: "fallback-plugin",
	canHandle: () => !1,
	transform: (e) => e
}, E = (e, t) => ae ? T : {
...
}, W = T, G = T, K = /* @__PURE__ */ new Map(), ce = (e, t = !0) => {
	...
	return K.set(n, r), r;
}, le = (e, t) => N(e, t, ce(t)), ue = (e, t = h?.locales, n = h?.defaultLocale) => {
...
var de = (e, t, n) => {
	...
	let { locale: e } = i(X) ?? {}, t = c(null);
	a(() => {}, []), a(() => {
		!e || !t.current || t.current.currentLocale.set(e);
	}, [e]);
}, ge = ({ children: e }) => (he(), e), _e = () => {
	typeof window < "u" && (window.intlayer = { enabled: !0 });
}, X = t({
	locale: Y ?? h?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), ve = ({ locale: e, defaultLocale: t, children: n, setLocale: r, disableEditor: i, isCookieEnabled: o }) => {
...
}, Z = /* @__PURE__ */ new Map(), Q = (e, t) => (Z.has(e) || Z.set(e, xe(t)), Z.get(e).read()), $ = (e, t, n) => {
	let { locale: r } = i(X) ?? {}, a = s(() => n ?? r ?? h.defaultLocale, [r, n]);
	return be(Q(`${String(t)}.${a}`, e[a]?.()), a);
}, Se = (e) => d(ye, { ...e }), Ce = m("mock-banner"), we = () => d("div", {
	className: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground",
	children: $(Ce, "mock-banner").a
});
function Te() {
	let e = $(ee, "products-header");
	return f(u, { children: [
		d(we, {}),
		d("h1", {
...
function Oe({ children: e, locale: t }) {
