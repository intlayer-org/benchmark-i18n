...
var x = {
	...
	en: () => import("./intlayer-TeamGrid-wrapper-1n7uao-en-gPvSFFpR.js").then((e) => e.t).then((e) => e.default),
...
}, lt = (e) => u(st, { ...e }), $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/team/TeamGrid.tsx";
function ut() {
	let e = ct(C, "team-grid"), t = [
		{
			name: e.o.value,
			role: e.h.value,
			bio: e.g.value
...
var _t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/team/TeamGrid.wrapper.tsx";
function vt() {
