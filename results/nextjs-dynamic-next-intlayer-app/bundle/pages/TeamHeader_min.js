...
var v = {
	...
	en: () => import("./intlayer-TeamHeader-wrapper-1q5btl-en-Q6Z5YGLj.js").then((e) => e.t).then((e) => e.default),
...
var me = (e) => {
	...
	en: () => import("./intlayer-TeamHeader-wrapper-1q5btl-en-Q6Z5YGLj.js").then((e) => e.n).then((e) => e.default),
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/team/TeamHeader.tsx";
function gt() {
	let e = dt(C, "team-header");
	return p(f, { children: [
		p(ht, {}, void 0, !1, {
			fileName: $,
			lineNumber: 11,
...
var Ct = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-dynamic/next-intlayer-app/src/components/pages/team/TeamHeader.wrapper.tsx";
function wt() {
