...
function D(e) {
	var t = e.config, n = e.allNamespaces, r = e.pluralRules, i = e.lang, a = t.logger, o = a === void 0 ? M : a, s = t.allowEmptyStrings, c = s === void 0 || s, l = function(e, n) {
...
function ee({ children: e }) {
	...
	return r(() => {
		(async () => {
			try {
				let e = await X.loadLocaleFrom?.("en", "common");
				n(e ?? {}), a(!0);
			} catch (e) {
