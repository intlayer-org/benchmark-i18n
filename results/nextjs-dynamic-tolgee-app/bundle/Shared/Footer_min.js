...
var v = ({ href: e, children: t, ...n }) => {
	let r = u().locale ?? "en";
	return e == null || typeof e != "string" || g(e) ? f(l, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, y = Object.defineProperty, b = Object.defineProperties, x = Object.getOwnPropertyDescriptors, S = Object.getOwnPropertySymbols, ee = Object.prototype.hasOwnProperty, te = Object.prototype.propertyIsEnumerable, ne = (e, t, n) => t in e ? y(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
	...
	if (S) for (var n of S(t)) te.call(t, n) && ne(e, n, t[n]);
	return e;
}, w = (e, t) => b(e, x(t)), re;
function ie(e, t) {
...
function Te(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return D(s.onError, (e) => new ye("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
		if (!l.languageDetector) return;
		let e = n();
		return D(s.onError, (e) => new ve("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let w = Object.freeze({
		...
		setStoredLanguage(e) {
			return D(s.onError, (e) => new ye("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
(re = console.assert) == null || re.call(console, Ke), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function qe(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
function Wt() {
	...
	if (i && r) return w(C({}, a), { transport: ft() });
}
function Gt() {
	let e = [];
			...
			children: [p("div", {
				...
				children: [
					...
					p("div", { children: [f("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => f("li", { children: e.isInternal ? f(v, {
							href: e.href,
					...
					p("div", { children: [f("h3", {
						...
						className: "text-sm text-muted-foreground",
						children: f($, { keyName: "footer.contactEmail" })
					})] })
				]
			}), f("div", {
...
function _n() {
	return Yt().use(He()).updateDefaults({ staticData: Object.fromEntries(gn.map((e) => [e, () => hn(e)])) });
}
var vn = _n().init(), yn = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
		let { unsubscribe: e } = vn.on("permanentChange", () => {
			r.refresh();
		});
		return () => {
			e();
...
}, Hn = "Cancel", Un = "Copy", Wn = { mockBanner: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." }, Gn = "Read More", Kn = "Save Changes", qn = {
