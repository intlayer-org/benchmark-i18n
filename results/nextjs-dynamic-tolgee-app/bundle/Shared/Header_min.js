...
}, x = Object.defineProperty, S = Object.defineProperties, ee = Object.getOwnPropertyDescriptors, te = Object.getOwnPropertySymbols, ne = Object.prototype.hasOwnProperty, re = Object.prototype.propertyIsEnumerable, C = (e, t, n) => t in e ? x(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, w = (e, t) => {
	for (var n in t ||= {}) ne.call(t, n) && C(e, n, t[n]);
	if (te) for (var n of te(t)) re.call(t, n) && C(e, n, t[n]);
	return e;
}, ie = (e, t) => S(e, ee(t)), ae;
function oe(e, t) {
...
}, j = (e) => Object.fromEntries(ge(e).entries()), M = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function De(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return D(s.onError, (e) => new xe("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
		if (!l.languageDetector) return;
		let e = n();
		return D(s.onError, (e) => new be("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let C = Object.freeze({
		...
		setStoredLanguage(e) {
			return D(s.onError, (e) => new xe("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = de(e) || F, r = t().onFormatError, a = typeof r;
...
function ke(e, t, n) {
	let r = Ee(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? A([t, ...le(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
var Ne = () => {
	...
	return t;
}, Pe = 0, R = 1, Fe = 2, Ie = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Pe ? r = "Empty parameter" : e === R ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Le(e) {
	return /\s/.test(e);
}
var z = 0, B = 1, V = 2, H = 3, U = 4, Re = /* @__PURE__ */ new Set([
	V,
	B,
	z
]), W = "'", ze = /* @__PURE__ */ new Set([
	"{",
	"}",
	W
...
function Ve(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case z:
			...
			break;
		case B:
			ze.has(i) ? (n = n.slice(0, -1) + i, t = V) : (n += i, t = z);
			break;
		case V:
			i === W ? t = z : (n += i, t = V);
			break;
		case H:
			i === "}" ? (d(), t = z) : Le(i) ? r !== "" && (d(), t = U) : (u(), t = H);
			break;
		case U: i == "}" ? t = z : Le(i) ? t = U : c(R);
	}
...
var We = () => (e, t) => (t.setFinalFormatter(Ue()), e);
function Ge() {
	return globalThis.window?.document?.createElement === void 0;
}
var Ke = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, qe = {};
(function(e) {
	function t(e, t) {
...
(ae = console.assert) == null || ae.call(console, Je), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ye(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, it = 3e3, at = 200, ot = 0, q = /* @__PURE__ */ new Map(), st = !1, J, Y;
...
var lt = (e) => new K("unavailable", `the Tolgee browser extension did not answer ${e} in time`), ut = () => `${Date.now()}-${ot++}-${Math.random()}`;
function dt() {
...
function ft(e) {
	return J ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: tt }, window.origin), i = () => {
			clearInterval(a), pt(), Y = void 0, n(new K("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var X = "__tolgee_", At = `${X}apiKey`, jt = `${X}apiUrl`, Mt = `${X}branch`, Nt = `${X}projectId`, Pt = `${X}session`, Ft = "tolgee-in-context-tools.umd.min.js", It = "@tolgee/in-context-tools", Lt = "InContextTools", Rt = "https://cdn.jsdelivr.net/npm", zt = null;
function Bt(e) {
...
function Kt() {
	...
	if (e) return ie(w({}, a), { apiKey: e });
	if (i && r) return ie(w({}, a), { transport: mt() });
}
function qt() {
	let e = [];
...
var en = { useSuspense: !1 }, tn, nn = () => (tn ||= e.createContext(void 0), tn), Z = void 0, rn = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = $t(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, en), r), h = nn();
	...
	let { tolgee: r, options: a } = an(), o = ce(e), c = k(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = on(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var Q = (t) => {
	let n = ln(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, dn(t))) : dn(n);
}, fn = (t) => {
	...
	let { t: n } = sn();
	return e.createElement(fn, Object.assign({ t: n }, t));
}, mn = (e) => {
	let { tolgee: t } = an(), { rerender: n } = on();
	return i(() => {
...
function vn() {
	let { t: e } = hn(), [t, n] = c("auto");
	i(() => {
		let e = gn();
		n(e), _n(e);
	}, []), i(() => {
		if (t !== "auto") return;
		let e = window.matchMedia("(prefers-color-scheme: dark)"), n = () => _n("auto");
	...
	function r() {
		...
		n(e), _n(e), window.localStorage.setItem("theme", e);
	}
...
function xn() {
	let e = mn(["language"]), t = e.getLanguage() || "en", n = f(), r = d(), i = (t) => {
		e.changeLanguage(t);
		let i = r.split("/");
		i[1] = t;
		let a = i.join("/") || `/${t}`;
			...
			children: [m("div", {
				...
				children: [p(b, {
					...
					children: [
						p(b, {
							href: "/",
							className: `nav-link${((e) => r === y(e, i))("/") ? " is-active" : ""}`,
...
var wn = (e, t, n) => {
	...
	try {
		return (await wn(Object.assign({
			"./locales/de.json": () => import("../i18n/locales/de.json"),
			"./locales/en.json": () => Promise.resolve().then(() => Nn),
		...
		return (await Promise.resolve().then(() => Nn)).default;
	}
}, En = [
	"en",
	"fr",
...
function Dn() {
	return Zt().use(We()).updateDefaults({ staticData: Object.fromEntries(En.map((e) => [e, () => Tn(e)])) });
}
var On = Dn().init(), kn = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
...
}, Qn = "Cancel", $n = "Copy", er = { mockBanner: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." }, tr = "Read More", nr = "Save Changes", rr = {
