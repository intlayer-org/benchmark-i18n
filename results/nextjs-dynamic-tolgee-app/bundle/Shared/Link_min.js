...
var m = ({ href: e, children: t, ...n }) => {
	let r = s().locale ?? "en";
	return e == null || typeof e != "string" || f(e) ? l(o, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
function be(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return D(s.onError, (e) => new me("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function C() {
		if (!l.languageDetector) return;
		let e = n();
		return D(s.onError, (e) => new pe("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function w(e) {
		e && l.backends.push(e);
	}
	...
	let O = Object.freeze({
		...
		setStoredLanguage(e) {
			return D(s.onError, (e) => new me("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function qt(e, t, r, o = !0) {
	let [s] = a(() => Kt(e)), [c, l] = a(o);
	return n(() => {
		l(!1);
	}, []), i(() => {
...
var Jt = { useSuspense: !1 }, Yt, Xt = () => (Yt ||= e.createContext(void 0), Yt), Z = void 0, Zt = ({ tolgee: r, options: i, children: o, fallback: s, ssr: c }) => {
	n(() => {
	...
	l = qt(r, u, d, !!c);
	let [f, p] = a(!l.isLoaded()), m = Object.assign(Object.assign({}, Jt), i), h = Xt();
	...
	try {
		return (await Qt(Object.assign({
			"./locales/de.json": () => import("../i18n/locales/de.json"),
			"./locales/en.json": () => Promise.resolve().then(() => cn),
		...
		return (await Promise.resolve().then(() => cn)).default;
	}
}, en = [
	"en",
	"fr",
...
function tn() {
	return Gt().use(Re()).updateDefaults({ staticData: Object.fromEntries(en.map((e) => [e, () => $t(e)])) });
}
var nn = tn().init(), rn = ({ language: e, staticData: t, children: r }) => {
	let i = c();
	return n(() => {
...
function sn({ children: e, locale: t, staticData: i }) {
...
}, Dn = "Cancel", On = "Copy", kn = { mockBanner: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." }, An = "Read More", jn = "Save Changes", Mn = {
