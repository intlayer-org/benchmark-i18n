...
var on = () => l("div", {
	...
	children: l(an, { keyName: "common.mockBanner" })
}), sn = (e, t, n) => {
	...
	try {
		return (await sn(Object.assign({
			...
			"./locales/en.json": () => Promise.resolve().then(() => gn),
		...
		return (await Promise.resolve().then(() => gn)).default;
	}
}, ln = [
	"en",
	"fr",
...
function un() {
	return Ut().use(Ie()).updateDefaults({ staticData: Object.fromEntries(ln.map((e) => [e, () => cn(e)])) });
}
...
}, Fn = "Cancel", In = "Copy", Ln = { mockBanner: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." }, Rn = "Read More", zn = "Save Changes", Bn = {
