		...
		children: [
			jsxs("div", {
				...
				children: [jsxs("div", { children: [jsx("label", {
					...
					children: jsx(T, { keyName: "contactForm.name" })
				}), jsx("input", {
					id: nameId,
					...
					htmlFor: emailId,
					className: "mb-1 block text-sm font-medium text-foreground",
					children: jsx(T, { keyName: "contactForm.email" })
				}), jsx("input", {
					id: emailId,
					type: "email",
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			jsxs("div", { children: [jsx("label", {
				htmlFor: topicId,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: jsx(T, { keyName: "contactForm.topic" })
			}), jsxs("select", {
				id: topicId,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				children: [
					jsx("option", { children: t("contactForm.bugReport") }),
					jsx("option", { children: t("contactForm.newBenchmarkIdea") }),
					jsx("option", { children: t("contactForm.methodologyQuestion") }),
					jsx("option", { children: t("contactForm.contribution") }),
					jsx("option", { children: t("contactForm.other") })
				]
			})] }),
			jsxs("div", { children: [jsx("label", {
				htmlFor: messageId,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: jsx(T, { keyName: "contactForm.message" })
			}), jsx("textarea", {
				id: messageId,
				rows: 5,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			jsx("button", {
				...
				children: jsx(T, { keyName: "contactForm.sendMessage" })
			})
		]
	});
}
...
var getMessages = async (locale) => {
	try {
		return (await _rolldown_dynamic_import_helper_default(Object.assign({
			...
			"./locales/en.json": () => Promise.resolve().then(() => en_exports),
		...
		return (await Promise.resolve().then(() => en_exports)).default;
	}
};
var ALL_LOCALES = [
	"en",
...
function TolgeeBase() {
	return Tolgee().use(FormatSimple()).updateDefaults({ staticData: Object.fromEntries(ALL_LOCALES.map((locale) => [locale, () => getMessages(locale)])) });
}
...
var cancel = "Cancel";
var copy = "Copy";
var mockBanner = { "mockBanner": "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." };
