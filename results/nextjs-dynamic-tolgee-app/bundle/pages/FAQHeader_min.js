...
}, h = Object.defineProperty, g = Object.defineProperties, _ = Object.getOwnPropertyDescriptors, v = Object.getOwnPropertySymbols, y = Object.prototype.hasOwnProperty, b = Object.prototype.propertyIsEnumerable, x = (e, t, n) => t in e ? h(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function Vt() {
	...
	if (i && r) return C(S({}, a), { transport: lt() });
}
function Ht() {
	let e = [];
...
var Yt = { useSuspense: !1 }, Xt, Zt = () => (Xt ||= e.createContext(void 0), Xt), X = void 0, Qt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	let { tolgee: r, options: a } = $t(), o = ne(e), c = k(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = en(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var cn = () => u("div", {
	...
	children: u(Q, { keyName: "common.mockBanner" })
});
function ln() {
	return d(l, { children: [
		u(cn, {}),
...
var un = (e, t, n) => {
	...
	try {
		return (await un(Object.assign({
			"./locales/de.json": () => import("../../../i18n/locales/de.json"),
			"./locales/en.json": () => Promise.resolve().then(() => yn),
		...
		return (await Promise.resolve().then(() => yn)).default;
	}
}, fn = [
	"en",
	"fr",
...
function pn() {
	return Kt().use(ze()).updateDefaults({ staticData: Object.fromEntries(fn.map((e) => [e, () => dn(e)])) });
}
var mn = pn().init(), hn = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
		let { unsubscribe: e } = mn.on("permanentChange", () => {
			r.refresh();
		});
		return () => {
			e();
...
function vn({ children: e, locale: t, staticData: n }) {
...
}, Rn = "Cancel", zn = "Copy", Bn = { mockBanner: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." }, Vn = "Read More", Hn = "Save Changes", Un = {
