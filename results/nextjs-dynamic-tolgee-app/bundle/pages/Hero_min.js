	...
	return sn("Hero"), u("section", {
		...
		children: [
			l("h1", {
				...
				children: l(Q, { keyName: "hero.title" })
			}),
			l("p", {
				className: "mx-auto max-w-2xl text-lg text-muted-foreground",
				children: l(Q, { keyName: "hero.aTestApplicationDesignedTo" })
			}),
			u("div", {
				...
				children: [l("button", {
					...
					children: l(Q, { keyName: "hero.viewResults" })
				}), l("button", {
					type: "button",
					className: "rounded-lg border border-border px-6 py-3 text-sm font-medium text-foreground hover:bg-accent transition-colors",
					children: l(Q, { keyName: "header.methodology" })
				})]
			})
		]
	});
...
function fn() {
	return Gt().use(Re()).updateDefaults({ staticData: Object.fromEntries(dn.map((e) => [e, () => un(e)])) });
}
