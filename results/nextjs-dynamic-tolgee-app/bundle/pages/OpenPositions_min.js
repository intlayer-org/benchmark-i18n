...
function un() {
	...
	return d(l, { children: [u("h2", {
		...
		children: u(ln, { keyName: "openPositions.openPositions" })
	}), u("div", {
		className: "space-y-4",
		children: t.map((e) => d("div", {
			...
			children: [d("div", { children: [
				...
				children: u(ln, { keyName: "openPositions.applyNow" })
			})]
		}, e.title))
	})] });
}
var dn = (e, t, n) => {
	...
	try {
		return (await dn(Object.assign({
			"./locales/de.json": () => import("../../../i18n/locales/de.json"),
			"./locales/en.json": () => Promise.resolve().then(() => bn),
		...
		return (await Promise.resolve().then(() => bn)).default;
	}
}, pn = [
	"en",
	"fr",
...
function mn() {
	return Gt().use(Re()).updateDefaults({ staticData: Object.fromEntries(pn.map((e) => [e, () => fn(e)])) });
}
var hn = mn().init(), gn = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
...
}, zn = "Cancel", Bn = "Copy", Vn = { mockBanner: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." }, Hn = "Read More", Un = "Save Changes", Wn = {
