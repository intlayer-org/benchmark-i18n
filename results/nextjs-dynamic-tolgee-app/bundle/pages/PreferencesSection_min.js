...
var Jt = { useSuspense: !1 }, Yt, Xt = () => (Yt ||= e.createContext(void 0), Yt), Z = void 0, Zt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	...
	c = qt(n, u, d, !!s);
	let [f, p] = l(!c.isLoaded()), m = Object.assign(Object.assign({}, Jt), r), h = Xt();
	...
	let { tolgee: r, options: a } = Qt(), o = ne(e), s = k(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = $t(), f = c([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function ln() {
	...
	return d("section", {
		...
		children: [u("h2", {
			...
			children: u($, { keyName: "preferencesSection.preferences" })
		}), d("div", {
			className: "space-y-4",
			children: [
				d("div", {
					...
					children: [d("div", { children: [u("p", {
						...
						children: u($, { keyName: "preferencesSection.emailNotifications" })
					}), u("p", {
						className: "text-xs text-muted-foreground",
						children: u($, { keyName: "preferencesSection.receiveWeeklyBenchmark" })
					})] }), u("button", {
						type: "button",
				...
				d("div", {
					...
					children: [d("div", { children: [u("p", {
						className: "text-sm font-medium text-foreground",
						children: u($, { keyName: "preferencesSection.darkMode" })
					}), u("p", {
						className: "text-xs text-muted-foreground",
						children: u($, { keyName: "preferencesSection.useDarkColorScheme" })
					})] }), u("button", {
						type: "button",
				...
				d("div", { children: [u("label", {
					...
					children: u($, { keyName: "preferencesSection.defaultLanguage" })
				}), d("select", {
					id: t,
...
function pn() {
	return Gt().use(Re()).updateDefaults({ staticData: Object.fromEntries(fn.map((e) => [e, () => dn(e)])) });
}
