...
var Yt = { useSuspense: !1 }, Xt, Zt = () => (Xt ||= e.createContext(void 0), Xt), X = void 0, Qt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	...
	c = Jt(n, u, d, !!s);
	let [f, p] = l(!c.isLoaded()), m = Object.assign(Object.assign({}, Yt), r), h = Zt();
	...
	let { tolgee: r, options: a } = $t(), o = ne(e), s = k(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = en(), f = c([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function cn() {
	...
	return d("section", {
		...
		children: [u("h2", {
			...
			children: u(Q, { keyName: "profileSection.profile" })
		}), d("div", {
			className: "space-y-4",
			children: [d("div", { children: [u("label", {
				htmlFor: e,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: u(Q, { keyName: "profileSection.displayName" })
			}), u("input", {
				id: e,
				...
				htmlFor: t,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: u(Q, { keyName: "profileSection.email" })
			}), u("input", {
				id: t,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring"
			})] })]
...
function fn() {
	return Kt().use(ze()).updateDefaults({ staticData: Object.fromEntries(dn.map((e) => [e, () => un(e)])) });
}
