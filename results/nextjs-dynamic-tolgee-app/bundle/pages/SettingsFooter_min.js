...
function sn() {
	return u("div", {
		...
		children: [l("button", {
			...
			children: l(on, { keyName: "common.cancel" })
		}), l("button", {
			type: "submit",
			className: "rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity",
			children: l(on, { keyName: "common.saveChanges" })
		})]
	});
}
var cn = (e, t, n) => {
...
function dn() {
	return Wt().use(Le()).updateDefaults({ staticData: Object.fromEntries(un.map((e) => [e, () => ln(e)])) });
}
