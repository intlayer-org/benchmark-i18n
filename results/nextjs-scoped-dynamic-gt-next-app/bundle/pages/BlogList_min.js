...
function _s() {
	return g("div", {
		...
		children: [
			{
				title: g(X, { children: "Comparing i18n Libraries in 2026: A Deep Dive" }),
				date: g(X, { children: "March 15, 2026" }),
				excerpt: g(X, { children: "We tested 12 different internationalization libraries across performance, bundle size, and DX. Here are the surprising results." }),
				category: g(X, { children: "Benchmark" })
			},
			{
				title: g(X, { children: "How to Reduce Your i18n Bundle by 60%" }),
				date: g(X, { children: "March 8, 2026" }),
				excerpt: g(X, { children: "Practical strategies for optimizing translation bundles including lazy loading, code splitting, and compile-time optimizations." }),
				category: g(X, { children: "Tutorial" })
			},
			{
				title: g(X, { children: "The State of Internationalization in React" }),
				date: g(X, { children: "February 28, 2026" }),
				excerpt: g(X, { children: "An overview of the current i18n ecosystem in React, covering trends, emerging patterns, and community preferences." }),
				category: g(X, { children: "Analysis" })
			},
			{
				title: g(X, { children: "Migrating from react-i18next to Lingui" }),
				date: g(X, { children: "February 15, 2026" }),
				excerpt: g(X, { children: "A step-by-step guide on migrating a production app with 50,000 translation keys from react-i18next to Lingui." }),
				category: g(X, { children: "Tutorial" })
			},
			{
				title: g(X, { children: "Server Components and i18n: What Changes?" }),
				date: g(X, { children: "February 1, 2026" }),
				excerpt: g(X, { children: "React Server Components introduce new patterns for internationalization. We explore the implications and best practices." }),
				category: g(X, { children: "Analysis" })
			},
			{
				title: g(X, { children: "Benchmark Methodology: How We Test" }),
				date: g(X, { children: "January 20, 2026" }),
				excerpt: g(X, { children: "A transparent look at our benchmarking methodology, including test environments, statistical methods, and reproducibility." }),
				category: g(X, { children: "Meta" })
			}
		].map((e, t) => _("article", {
			...
			children: [
				...
				g("button", {
					...
					children: g(X, { children: "Read More →" })
				})
			]
		}, t))
	});
