...
function _s() {
	return g("div", {
		...
		children: [
			{
				label: g(X, { children: "Remote-first" }),
				value: g(X, { children: "Work from anywhere in the world" })
			},
			{
				label: g(X, { children: "Competitive pay" }),
				value: g(X, { children: "Top-of-market compensation" })
			},
			{
				label: g(X, { children: "Open source time" }),
				value: g(X, { children: "20% time for OSS contributions" })
			}
		].map((e) => _("div", {
