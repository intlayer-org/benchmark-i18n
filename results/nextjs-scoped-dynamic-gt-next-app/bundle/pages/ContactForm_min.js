	...
	return v("form", {
		...
		children: [
			...
			v("div", { children: [_("label", {
				htmlFor: n,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: _(X, { children: "Topic" })
			}), v("select", {
				id: n,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				children: [
					_("option", { children: _(X, { children: "Bug Report" }) }),
					_("option", { children: _(X, { children: "New Benchmark Idea" }) }),
					_("option", { children: _(X, { children: "Methodology Question" }) }),
					_("option", { children: _(X, { children: "Contribution" }) }),
					_("option", { children: _(X, { children: "Other" }) })
				]
			})] }),
			v("div", { children: [_("label", {
				htmlFor: r,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: _(X, { children: "Message" })
			}), _("textarea", {
				id: r,
				rows: 5,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			_("button", {
				...
				children: _(X, { children: "Send Message" })
			})
		]
	});
}
