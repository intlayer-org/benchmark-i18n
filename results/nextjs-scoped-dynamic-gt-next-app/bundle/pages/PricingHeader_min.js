...
function vs() {
	return _(h, { children: [g(_s, {}), _("div", {
		className: "mb-12 text-center",
		children: [g("h1", {
			className: "mb-3 text-3xl font-bold text-foreground",
			children: g(X, { children: "Simple, Transparent Pricing" })
		}), g("p", {
			className: "text-muted-foreground",
			children: g(X, { children: "Choose the plan that fits your team. No hidden fees." })
		})]
	})] });
}
function ys() {
