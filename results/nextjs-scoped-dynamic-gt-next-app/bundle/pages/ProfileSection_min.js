...
var Ya = class {
	...
	subscribeToTranslate = (e, t) => {
		let n = oa(e);
		return q(this.translateListeners, (e) => {
			oa(e) === n && t();
		});
	};
	subscribeToTranslationEvents = (e) => q(this.translateListeners, e);
	subscribeToDictionaryEntryEvents = (e) => q(this.dictionaryEntryListeners, e);
	subscribeToDictionaryObjectEvents = (e) => q(this.dictionaryObjectListeners, e);
...
function Xa({ i18nConfigParams: e, nextI18nCacheParams: t } = ln()) {
	za({
		...e,
		...t,
...
function Oo(e) {
	let t = io(), n = ao(), r = uo(), i = h((n) => t.subscribeToTranslate(e, n), () => t.getTranslateSnapshot(e, n), () => t.getTranslateSnapshot(e, n));
	return process.env.NODE_ENV !== "production" && i == null && B().isDevHotReloadEnabled() && r(e), i;
}
var { renderVariable: ko, renderDefaultChildren: Ao, renderTranslatedChildren: jo, renderPreparedT: Mo } = La({
	Currency: ho,
	...
	let r = n, i = (e) => {
		...
		if (a) {
			...
			if ((e[1] === "automatic" || e[2] === "automatic") && (i.injectionType = "automatic"), e[0] === "translate" && (e[0] = "fragment"), e[0] === "variable" && (i.variableType = e?.[1] || "variable"), e[0] === "plural") {
				let e = Object.entries(n).reduce((e, [t, n]) => ($t(t) && (e[t] = No(n, r)), e), {});
...
function Fo(e, t) {
	...
	if (a) {
		...
		if (n === "plural") return r(e, { ...Object.entries(i).reduce((e, [n, r]) => (e[n] = $t(n) || n === "children" ? Io(r, t) : r, e), {}) });
...
Qo._gtt = "translate-client";
function $o({ children: e, _locale: t, _enableI18n: n, _renderPreparedT: r = Mo, ...i }) {
...
Xa();
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/gt-next-app/components/pages/settings/ProfileSection.tsx";
function ys() {
	let e = u(), t = u();
	return v("section", {
		...
		children: [v("h2", {
			...
			children: v(Qo, { children: "Profile" }, void 0, !1, {
				fileName: $,
				lineNumber: 11,
				columnNumber: 9
			}, this)
			...
			children: [v("div", { children: [v("label", {
				...
				children: v(Qo, { children: "Display Name" }, void 0, !1, {
					fileName: $,
					lineNumber: 19,
					columnNumber: 13
				}, this)
				...
				htmlFor: t,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: v(Qo, { children: "Email" }, void 0, !1, {
					fileName: $,
					lineNumber: 32,
					columnNumber: 13
				}, this)
...
var Ds = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/gt-next-app/components/pages/settings/ProfileSection.wrapper.tsx";
function Os() {
