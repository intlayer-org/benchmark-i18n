...
var _s = () => g("div", {
	...
	children: g(X, { children: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." })
});
function vs() {
	return _(h, { children: [
		g(_s, {}),
		g("h1", {
			...
			children: g(X, { children: "Our Team" })
		}),
		g("p", {
			className: "mb-10 text-muted-foreground",
			children: g(X, { children: "Meet the people behind i18n Benchmark. A diverse team united by a shared passion for great developer tools." })
		})
	] });
}
function ys() {
