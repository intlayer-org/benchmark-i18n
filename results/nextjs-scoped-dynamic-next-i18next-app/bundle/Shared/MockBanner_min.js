...
var me = (e, t, n, r) => {
	...
	d && !d.reportNamespaces && (d.reportNamespaces = new Ae()), d || Y(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = o(() => ({
		...we(),
		...d?.options?.react,
		...t
...
var $ = J;
function He({ children: e, initialResources: t }) {
