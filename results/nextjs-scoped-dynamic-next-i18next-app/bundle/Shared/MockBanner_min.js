...
var z = (e) => !p(e) && typeof e != "boolean" && typeof e != "number", B = class e extends P {
	...
	constructor(e = {}, t) {
		if (super(), this.options = W(e), this.services = {}, this.logger = N, this.modules = { external: [] }, he(this), t && !this.isInitialized && !e.isClone) {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new ie(U());
...
var ge = (e, t, n, r) => {
	...
	Z(n) && q[n] || (Z(n) && (q[n] = /* @__PURE__ */ new Date()), ge(e, t, n, r));
}, Y = (e, t) => () => {
...
var Re = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-i18next-app/components/MockBanner.tsx", ze = () => {
	let { t: e } = Ie("shared");
	return l("div", {
...
var $ = K, qe = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-i18next-app/components/AppProviders.tsx";
...
var Ze = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-i18next-app/components/MockBanner.wrapper.tsx";
function Qe() {
