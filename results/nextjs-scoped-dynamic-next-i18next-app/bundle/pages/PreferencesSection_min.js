...
var I = (e) => !m(e) && typeof e != "boolean" && typeof e != "number", ce = class e extends N {
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			}), i.trim())), e = e.replace(r[0], B(g(i))), this.regexp.lastIndex = 0;
		}
		return e;
	}
}, de = (e) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			C(n.loaded, [i], a), me(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), W = (e) => (m(e.ns) && (e.ns = [e.ns]), m(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), m(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), G = () => {}, ge = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, K = class e extends N {
	constructor(e = {}, t) {
		if (super(), this.options = W(e), this.services = {}, this.logger = M, this.modules = { external: [] }, ge(this), t && !this.isInitialized && !e.isClone) {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new le(U());
...
var _e = (e, t, n, r) => {
	...
	X(n) && q[n] || (X(n) && (q[n] = /* @__PURE__ */ new Date()), _e(e, t, n, r));
}, ve = (e, t) => () => {
...
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-i18next-app/components/pages/settings/PreferencesSection.tsx";
function Be() {
	let { t: e } = Re("settings"), t = a();
	return u("section", {
		...
		children: [u("h2", {
			...
			children: [
				...
				u("div", { children: [u("label", {
					...
					children: [
						u("option", { children: "English (en)" }, void 0, !1, {
							fileName: Q,
							lineNumber: 61,
							columnNumber: 13
						}, this),
						u("option", { children: "French (fr)" }, void 0, !1, {
							fileName: Q,
							lineNumber: 62,
							columnNumber: 13
						}, this),
						u("option", { children: "German (de)" }, void 0, !1, {
							fileName: Q,
							lineNumber: 63,
							columnNumber: 13
						}, this),
						u("option", { children: "Spanish (es)" }, void 0, !1, {
							fileName: Q,
							lineNumber: 64,
							columnNumber: 13
						}, this),
						u("option", { children: "Japanese (ja)" }, void 0, !1, {
							fileName: Q,
							lineNumber: 65,
							columnNumber: 13
						}, this),
						u("option", { children: "Chinese Simplified (zh-CN)" }, void 0, !1, {
							fileName: Q,
							lineNumber: 66,
							columnNumber: 13
						}, this),
						u("option", { children: "Arabic (ar)" }, void 0, !1, {
							fileName: Q,
							lineNumber: 67,
							columnNumber: 13
						}, this)
...
var $ = K, Je = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-i18next-app/components/AppProviders.tsx";
function Ye({ children: e, initialResources: t }) {
	let n = d().locale ?? "en", [r] = l(() => typeof performance < "u" ? performance.now() : 0);
	return l(() => {
...
var Xe = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-i18next-app/scripts/Wrapper.tsx";
function Ze({ children: e }) {
	return u(Ye, { children: e }, void 0, !1, {
		fileName: Xe,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var Qe = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-i18next-app/components/pages/settings/PreferencesSection.wrapper.tsx";
function $e() {
	return u(Ze, { children: u(Be, {}, void 0, !1, {
		fileName: Qe,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
