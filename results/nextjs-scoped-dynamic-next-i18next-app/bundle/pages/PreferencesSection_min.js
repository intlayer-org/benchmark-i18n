...
function F(e, t) {
	let { [se]: n } = e(ce()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var I = (e) => !h(e) && typeof e != "boolean" && typeof e != "number", le = class e extends N {
	constructor(e, t = {}) {
		super(), v([
			"resourceStore",
			"languageUtils",
	...
	cloneInstance(t = {}, n = K) {
		...
		return a.translator = new le(a.services, i), a.translator.on("*", (e, ...t) => {
			a.emit(e, ...t);
...
var _e = (e, t, n, r) => {
	...
	d && !d.reportNamespaces && (d.reportNamespaces = new Me()), d || Y(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = s(() => ({
		...Ee(),
		...d?.options?.react,
		...t
...
var $ = q;
function We({ children: e, initialResources: t }) {
