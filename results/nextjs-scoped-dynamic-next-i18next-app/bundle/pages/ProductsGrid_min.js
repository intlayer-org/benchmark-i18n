...
function F(e, t) {
	let { [ae]: n } = e(oe()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":", a = t?.enableSelector === "strict";
	if (n.length > 1 && i) {
...
var I = (e) => !p(e) && typeof e != "boolean" && typeof e != "number", se = class e extends P {
	constructor(e, t = {}) {
		super(), g([
			"resourceStore",
			"languageUtils",
	...
	extendTranslation(e, t, n, r, i) {
		...
		return e != null && o?.length && n.applyPostProcessor !== !1 && (e = ie.handle(o, e, t, this.options && this.options.postProcessPassResolved ? {
			i18nResolved: {
				...r,
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return p(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? F(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	constructor(e = {}, t) {
		if (super(), this.options = G(e), this.services = {}, this.logger = N, this.modules = { external: [] }, me(this), t && !this.isInitialized && !e.isClone) {
	...
	cloneInstance(t = {}, n = K) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a[e] = this[e];
		}), a.services = { ...this.services }, a.services.utils = { hasLoadedNamespace: a.hasLoadedNamespace.bind(a) }, r && (a.store = new re(Object.keys(this.store.data).reduce((e, t) => (e[t] = { ...this.store.data[t] }, e[t] = Object.keys(e[t]).reduce((n, r) => (n[r] = { ...e[t][r] }, n), e[t]), e), {}), i), a.services.resourceStore = a.store), t.interpolation) {
			let e = {
				...W().interpolation,
				...this.options.interpolation,
				...t.interpolation
...
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-i18next-app/components/pages/products/ProductsGrid.tsx";
function ze() {
	let { t: e } = Le("products"), t = [
		{
			name: e("products.benchmarkCLI"),
			desc: e("products.benchmarkCLIDesc"),
			price: e("products.benchmarkCLIPrice")
		},
		{
			name: e("products.benchmarkCloud"),
			desc: e("products.benchmarkCloudDesc"),
			price: e("products.benchmarkCloudPrice")
		},
		{
			name: e("products.benchmarkEnterprise"),
			desc: e("products.benchmarkEnterpriseDesc"),
			price: e("products.benchmarkEnterprisePrice")
		},
		{
			name: e("products.migrationAssistant"),
			desc: e("products.migrationAssistantDesc"),
			price: e("products.migrationAssistantPrice")
		},
		{
			name: e("products.translationQA"),
			desc: e("products.translationQADesc"),
			price: e("products.translationQAPrice")
		},
		{
			name: e("products.bundleOptimizer"),
			desc: e("products.bundleOptimizerDesc"),
			price: e("products.bundleOptimizerPrice")
		}
	];
	return l("div", {
...
var Ze = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-i18next-app/components/pages/products/ProductsGrid.wrapper.tsx";
function Qe() {
