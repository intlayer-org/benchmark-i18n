...
var _jsxFileName$4 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-i18next-app/components/MockBanner.tsx";
var MockBanner = () => {
...
var _jsxFileName$3 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-i18next-app/components/pages/settings/SettingsHeader.tsx";
...
}((language, namespace) => _rolldown_dynamic_import_helper_default(Object.assign({
...
function AppProviders({ children, initialResources }) {
	...
	useState(() => {
		if (initialResources) Object.entries(initialResources).forEach(([ns, bundle]) => {
			if (!i18n_default.hasResourceBundle(locale, ns)) i18n_default.addResourceBundle(locale, ns, bundle, true, true);
		});
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-i18next-app/components/pages/settings/SettingsHeader.wrapper.tsx";
function Wrapped() {
