...
var t = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), n = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	var i = Object.create, a = Object.defineProperty, o = Object.getOwnPropertyDescriptor, s = Object.getOwnPropertyNames, c = Object.getOwnPropertySymbols, l = Object.getPrototypeOf, u = Object.prototype.hasOwnProperty, d = Object.prototype.propertyIsEnumerable, f = (e, t, n) => t in e ? a(e, t, {
		enumerable: !0,
		configurable: !0,
		writable: !0,
		value: n
		...
		if (t && typeof t == "object" || typeof t == "function") for (let i of s(t)) !u.call(e, i) && i !== n && a(e, i, {
			get: () => t[i],
			enumerable: !(r = o(t, i)) || r.enumerable
		});
		return e;
	}, g = (e, t, n) => (n = e == null ? {} : i(l(e)), h(t || !e || !e.__esModule ? a(n, "default", {
		value: e,
		enumerable: !0
	}) : n, e)), _ = (e) => h(a({}, "__esModule", { value: !0 }), e), v = {};
	m(v, { createI18nClient: () => V }), t.exports = _(v), r();
	var y = n("next/navigation"), b = g(n("react")), x = (e, t = "") => Object.entries(e).reduce((e, [n, r]) => p(p({}, e), typeof r == "string" ? { [t + n]: r } : x(r, `${t}${n}.`)), {});
	function S(e, t) {
	...
	var D = n("react"), O = n("react"), k = n("react");
	function A(e, t) {
	...
	var L = n("next/navigation"), R = n("react"), z = "locale";
	function B(e, t) {
		return function() {
...
}), a = i.useScopedI18n, { I18nProviderClient: o, useChangeLocale: s, useCurrentLocale: c } = i, l = () => (a("header"), null);
function u() {
	return e(o, {
		locale: c(),
		children: e(l, {})
