...
}), u = l.useScopedI18n, { I18nProviderClient: d, useChangeLocale: f, useCurrentLocale: p } = l, m = () => i("div", {
	className: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground",
	children: u("mock-banner")("mockBanner")
});
function h() {
	let e = u("header"), t = u("products-header");
	return a(r, { children: [
		i(m, {}),
		i("h1", {
