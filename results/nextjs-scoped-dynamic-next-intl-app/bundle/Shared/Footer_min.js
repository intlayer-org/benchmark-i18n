...
async function pt(e, t) {
	return (await (ft[e]?.[t] ?? ft.en[t])()).default;
}
function mt(e) {
	let t = {};
...
function ht(e, t) {
	...
	for (let [e, r] of Object.entries(t)) {
		let t = n[e];
		n[e] = typeof r == "object" && r && !Array.isArray(r) && typeof t == "object" && t && !Array.isArray(t) ? ht(t, r) : r;
	}
	return n;
}
function gt(e) {
	return e.reduce((e, t) => ht(e, t), {});
}
