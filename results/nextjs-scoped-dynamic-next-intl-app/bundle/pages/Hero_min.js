...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-intl-app/components/pages/home/Hero.tsx";
function mt() {
	let e = dt(), t = dt("header");
	return pt("Hero"), l("section", {
...
async function xt(e, t) {
	return (await (bt[e]?.[t] ?? bt.en[t])()).default;
}
function St(e) {
	let t = {};
...
function Ct(e, t) {
	...
	for (let [e, r] of Object.entries(t)) {
		let t = n[e];
		n[e] = typeof r == "object" && r && !Array.isArray(r) && typeof t == "object" && t && !Array.isArray(t) ? Ct(t, r) : r;
	}
	return n;
}
function wt(e) {
	return e.reduce((e, t) => Ct(e, t), {});
}
...
var Dt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-intl-app/scripts/Wrapper.tsx", Ot = "en";
async function kt({ children: e }) {
	let t = await Et(Ot);
	return l(vt, {
		locale: Ot,
		messages: t,
...
var At = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-intl-app/components/pages/home/Hero.wrapper.tsx";
function jt() {
	return l(kt, { children: l(mt, {}, void 0, !1, {
		fileName: At,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
