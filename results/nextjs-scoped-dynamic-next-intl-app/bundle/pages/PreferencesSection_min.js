...
function U(e) {
	e.forEach((e) => {
		if (delete e.location, ve(e) || M(e)) for (let t in e.options) delete e.options[t].location, U(e.options[t].value);
		else _e(e) && P(e.style) || (A(e) || j(e)) && F(e.style) ? delete e.style.location : N(e) && U(e.children);
	});
}
function Pe(e, t = {}) {
	t = {
