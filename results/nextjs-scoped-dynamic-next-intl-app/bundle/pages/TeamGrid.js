...
var _jsxFileName$3 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-intl-app/components/pages/team/TeamGrid.tsx";
function TeamGrid() {
		...
		children: members.map((m) => jsxDEV("div", {
			...
			children: [
				jsxDEV("div", {
					...
					children: m.name.split(/\s+/).map((n) => n[0]).join("")
				}, void 0, false, {
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-intl-app/components/pages/team/TeamGrid.wrapper.tsx";
function Wrapped() {
