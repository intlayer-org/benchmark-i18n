...
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-intl-app/components/pages/team/TeamGrid.tsx";
function mt() {
	let e = ft(), t = [
		{
			name: e("team-grid.sarahChen"),
			role: e("team-grid.founderLeadEngineer"),
			bio: e("team-grid.formerGoogleEngineerWith10")
		},
		{
			name: e("team-grid.marcusWeber"),
			role: e("team-grid.performanceEngineer"),
			bio: e("team-grid.specializesInJavascriptPerformanceOptimization")
		},
		{
			name: e("team-grid.aishaPatel"),
			role: e("team-grid.developerAdvocate"),
			bio: e("team-grid.passionateAboutDeveloperExperienceAnd")
		},
		{
			name: e("team-grid.tomasRodriguez"),
			role: e("team-grid.fullStackDeveloper"),
			bio: e("team-grid.maintainsTheBenchmarkingInfrastructureAnd")
		},
		{
			name: e("team-grid.yukiTanaka"),
			role: e("team-grid.dataAnalyst"),
			bio: e("team-grid.ensuresStatisticalRigorInAll")
		},
		{
			name: e("team-grid.elenaKowalski"),
			role: e("team-grid.communityManager"),
			bio: e("team-grid.managesCommunityContributionsPartnershipsAnd")
		}
	];
	return l("div", {
		...
		children: t.map((e) => l("div", {
			...
			children: [
				l("div", {
					...
					children: e.name.split(/\s+/).map((e) => e[0]).join("")
				}, void 0, !1, {
					fileName: Q,
					lineNumber: 48,
					columnNumber: 11
...
var kt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-intl-app/components/pages/team/TeamGrid.wrapper.tsx";
function At() {
