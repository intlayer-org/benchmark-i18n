...
async function ct(e, t) {
	return (await (st[e]?.[t] ?? st.en[t])()).default;
}
function lt(e) {
	let t = {};
...
function ut(e, t) {
	...
	for (let [e, r] of Object.entries(t)) {
		let t = n[e];
		n[e] = typeof r == "object" && r && !Array.isArray(r) && typeof t == "object" && t && !Array.isArray(t) ? ut(t, r) : r;
	}
	return n;
}
function dt(e) {
	return e.reduce((e, t) => ut(e, t), {});
}
