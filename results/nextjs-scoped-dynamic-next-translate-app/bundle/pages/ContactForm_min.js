...
var k = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-translate-app/components/pages/contact/ContactForm.tsx";
function A() {
	let { t: e } = O("contact"), t = i(), n = i(), r = i(), a = i();
	return l("form", {
		className: "space-y-6",
		children: [
			l("div", {
			...
			l("div", { children: [l("label", {
				...
				children: [
					l("option", { children: "Bug Report" }, void 0, !1, {
						fileName: k,
						lineNumber: 55,
						columnNumber: 11
					}, this),
					l("option", { children: "New Benchmark Idea" }, void 0, !1, {
						fileName: k,
						lineNumber: 56,
						columnNumber: 11
					}, this),
					l("option", { children: "Methodology Question" }, void 0, !1, {
						fileName: k,
						lineNumber: 57,
						columnNumber: 11
					}, this),
					l("option", { children: "Contribution" }, void 0, !1, {
						fileName: k,
						lineNumber: 58,
						columnNumber: 11
					}, this),
...
function N(t) {
	var r = t.lang, i = t.namespaces, a = i === void 0 ? {} : i, s = t.children, c = t.config, l = c === void 0 ? {} : c, d = O().lang, f = u() || {}, p = f.locale, h = f.defaultLocale, _ = n(M), v = j(j(j({}, P()), _.ns), a), b = r || d || p || h || "", x = j(j({}, _.config), l), S = x.localesToIgnore || ["default"], C = !b || S.includes(b), w = o(function() {
		return g(C ? void 0 : b);
	}, [C, b]), T = o(function() {
		return y({
			config: x,
...
var z = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-translate-app/components/AppProviders.tsx";
function B({ children: e, locale: t }) {
...
var V = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-translate-app/scripts/Wrapper.tsx", H = [
	"about",
	"blog",
	"careers",
	"contact",
...
function U({ children: e }) {
	...
	return r(() => {
		(async () => {
			try {
				let e = await Promise.all(H.map(async (e) => [e, await I.loadLocaleFrom?.("en", e) ?? {}]));
...
var W = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-translate-app/components/pages/contact/ContactForm.wrapper.tsx";
function G() {
	return l(U, { children: l(A, {}, void 0, !1, {
		fileName: W,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
