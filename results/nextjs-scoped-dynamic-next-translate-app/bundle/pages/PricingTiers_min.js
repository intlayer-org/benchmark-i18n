...
var O = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-translate-app/components/pages/pricing/PricingTiers.tsx";
function k() {
	let { t: e } = D("pricing"), t = [
		{
			name: e("pricingTiers.starterTier"),
			price: e("pricingTiers.starterPrice"),
			period: e("pricingTiers.forever"),
			features: [
				e("pricingTiers.runsPerDay"),
				e("pricingTiers.libraries3"),
				e("pricingTiers.communitySupport"),
				e("pricingTiers.publicResults")
			],
			buttonText: e("pricingTiers.getStarted")
		},
		{
			name: e("pricingTiers.proTier"),
			price: e("pricingTiers.proPrice"),
			period: e("pricingTiers.perMonth"),
			features: [
				e("pricingTiers.unlimitedRuns"),
				e("pricingTiers.allLibraries"),
				e("pricingTiers.prioritySupport"),
				e("pricingTiers.privateResults"),
				e("pricingTiers.ciIntegration"),
				e("pricingTiers.historicalData")
			],
			buttonText: e("pricingTiers.getStarted"),
			highlighted: !0
		},
		{
			...
			period: "",
			features: [
				e("pricingTiers.everythingInPro"),
				e("pricingTiers.onPremiseOption"),
				e("pricingTiers.ssoSaml"),
				e("pricingTiers.dedicatedAccountManager"),
				e("pricingTiers.customSLAs"),
				e("pricingTiers.auditLogs"),
				e("pricingTiers.trainingSessions")
			],
		...
		children: t.map((e) => c("div", {
			...
			children: [
				...
				c("ul", {
					...
					children: e.features.map((e) => c("li", {
...
var U = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-translate-app/components/pages/pricing/PricingTiers.wrapper.tsx";
function W() {
