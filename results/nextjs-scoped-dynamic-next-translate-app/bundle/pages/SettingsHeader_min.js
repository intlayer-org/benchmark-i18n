...
}, A = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-translate-app/components/pages/settings/SettingsHeader.tsx";
function j() {
	let { t: e } = D("settings");
	return c(s, { children: [
		c(k, {}, void 0, !1, {
...
var B = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-translate-app/components/AppProviders.tsx";
...
var H = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-translate-app/scripts/Wrapper.tsx", U = [
	"about",
	"blog",
	"careers",
	"contact",
...
function W({ children: e }) {
	...
	return r(() => {
		(async () => {
			try {
				let e = await Promise.all(U.map(async (e) => [e, await L.loadLocaleFrom?.("en", e) ?? {}]));
...
var G = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-dynamic/next-translate-app/components/pages/settings/SettingsHeader.wrapper.tsx";
function K() {
	return c(W, { children: c(j, {}, void 0, !1, {
		fileName: G,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
