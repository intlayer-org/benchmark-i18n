...
function se(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return v(s.onError, (e) => new j("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
	...
	let A = Object.freeze({
		...
		setStoredLanguage(e) {
			return v(s.onError, (e) => new j("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = E(e) || L, r = t().onFormatError, a = typeof r;
...
function ue({ options: e }) {
	let t = te(), n = B(!1, () => o.isFetching(), t.onFetchingChange.emit), r = B(!1, () => D.isLoading(), t.onLoadingChange.emit), i = ce(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = se(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, b, x, f, t), o = ie(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var fe = () => {
	...
	return t;
}, H = 0, U = 1, pe = 2, me = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var G = 0, K = 1, q = 2, J = 3, Y = 4, he = new Set([
	q,
	K,
	G
]), X = "'", ge = new Set([
...
function ve(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case G:
			...
			break;
		case K:
			ge.has(i) ? (n = n.slice(0, -1) + i, t = q) : (n += i, t = G);
			break;
		case q:
			i === X ? t = G : (n += i, t = q);
			break;
...
var xe = () => (e, t) => (t.setFinalFormatter(be()), e), Se = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Z = {};
(function(e) {
	function t(e, t) {
		var n;
...
(m = console.assert) == null || m.call(console, Ce), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function we(e, t) {
	let n = (n) => {
...
function Te({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var De = "tolgee-in-context-tools.umd.min.js", Oe = "@tolgee/in-context-tools", ke = "InContextTools", Ae = "https://cdn.jsdelivr.net/npm";
function je(e) {
...
var Me = null;
function Ne(e) {
	return Me ||= je(`${Ae}/@tolgee/web@${e}/dist/${De}`).then(() => window[Oe][ke]), Me;
}
...
function Ue(e, t, r, o = !0) {
	let [s] = a(() => He(e)), [c, l] = a(o);
	return n(() => {
		l(!1);
	}, []), i(() => {
...
var We = { useSuspense: !1 }, Ge, Ke = () => (Ge ||= e.createContext(void 0), Ge), Q = void 0, qe = ({ tolgee: r, options: i, children: o, fallback: s, ssr: c }) => {
	n(() => {
	...
	l = Ue(r, u, d, !!c);
	let [f, p] = a(!l.isLoaded()), m = Object.assign(Object.assign({}, We), i), h = Ke();
...
var $ = Je().init(), Ye = ({ language: e, staticData: t, children: r }) => {
	let i = o();
	return n(() => {
...
function Qe({ children: e, locale: t, staticData: i }) {
...
async function nt(e, t) {
	...
	try {
		...
		return n === "en" ? {} : (await $e(Object.assign({
			"./locales/en/about.json": () => import("./about-CYSxSXDm.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-D4vPffNV.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-D1fuBqnE.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-ByHxIFcg.js"),
...
async function rt(e) {
	...
	if (n) return n;
	let r = await Promise.all(et.map(async (e) => [e, await nt(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return tt.set(t, o), o;
...
async function at({ children: e }) {
	return s(Qe, {
		locale: it,
		staticData: await rt(it),
		children: e
	});
}
function ot() {
	return s(at, { children: s(Qe, {}) });
}
