...
var Pe = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, W = {};
(function(e) {
	function t(e, t) {
...
function Bt(e, t, r, o = !0) {
	let [s] = a(() => zt(e)), [c, l] = a(o);
	return n(() => {
		l(!1);
	}, []), i(() => {
...
var Vt = { useSuspense: !1 }, Ht, Ut = () => (Ht ||= e.createContext(void 0), Ht), Z = void 0, Wt = ({ tolgee: r, options: i, children: o, fallback: s, ssr: c }) => {
	n(() => {
	...
	l = Bt(r, u, d, !!c);
	let [f, p] = a(!l.isLoaded()), m = Object.assign(Object.assign({}, Vt), i), h = Ut();
...
var $ = Gt().init(), qt = ({ language: e, staticData: t, children: r }) => {
	let a = o(), c = i(() => ({ [e]: Kt(e, t[e] ?? {}) }), [e, t]);
	return n(() => {
...
function Xt({ children: e, locale: t, staticData: i }) {
...
async function $t(e, t = ["common"]) {
	let n = e || "en", r = await Promise.all(t.map(async (e) => [e, await Qt(n, e)]));
	return Object.fromEntries(r);
}
var en = "en";
async function tn({ children: e }) {
	let t = await $t(en);
	return s(Xt, {
		locale: en,
		staticData: t,
