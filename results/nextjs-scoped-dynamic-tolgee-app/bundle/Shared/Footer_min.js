...
}, _ = Object.defineProperty, v = Object.getOwnPropertySymbols, y = Object.prototype.hasOwnProperty, b = Object.prototype.propertyIsEnumerable, x = (e, t, n) => t in e ? _(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function L(e, t) {
	...
	return n.apiUrl = re(n.apiUrl), e?.fetch && (n.fetch = se(e.fetch)), {
		initialOptions: n,
...
function xe({ options: e }) {
	let t = le(), n = R(!1, () => o.isFetching(), t.onFetchingChange.emit), r = R(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ye(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ve(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = me(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Ce = () => {
	...
	return t;
}, B = 0, V = 1, we = 2, Te = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var H = 0, U = 1, W = 2, G = 3, K = 4, De = new Set([
	W,
	U,
	H
]), q = "'", Oe = new Set([
...
function Ae(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case H:
			...
			break;
		case U:
			Oe.has(i) ? (n = n.slice(0, -1) + i, t = W) : (n += i, t = H);
			break;
		case W:
			i === q ? t = H : (n += i, t = W);
			break;
		case G:
			i === "}" ? (d(), t = H) : Ee(i) ? r !== "" && (d(), t = K) : (u(), t = G);
			break;
		case K: i == "}" ? t = H : Ee(i) ? t = K : c(V);
	}
...
var rt = { useSuspense: !1 }, it, at = () => (it ||= e.createContext(void 0), it), J = void 0, ot = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
...
var lt = () => {
	...
	let { tolgee: r, options: a } = lt(), o = te(e), c = k(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = ut(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var mt = (t) => {
	...
	return Object.entries(t || {}).forEach(([t, r]) => {
		if (typeof r == "function") n[t] = (e) => r(Y(e));
		else if (e.isValidElement(r)) {
			let i = r;
			n[t] = (t) => i.props.children === void 0 && t?.length ? e.cloneElement(i, {}, Y(t)) : e.cloneElement(i);
		} else n[t] = r;
	}), n;
};
function ht(e) {
...
var Y = (t) => {
	let n = pt(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, ht(t))) : ht(n);
}, gt = (t) => {
	let n = t.keyName || t.children;
	n === void 0 && console.error("T component: keyName not defined");
	let r = t.defaultValue || (t.keyName ? t.children : void 0), i = Y(t.t({
		key: n,
		params: mt(t.params),
		defaultValue: r,
		noWrap: t.noWrap,
	...
	let { t: n } = dt();
	return e.createElement(gt, Object.assign({ t: n }, t));
};
function vt() {
	let { t: e, ...t } = ft();
	return {
...
var Z = bt().init(), xt = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
		let { unsubscribe: e } = Z.on("permanentChange", () => {
			r.refresh();
		}), { unsubscribe: t } = Z.on("language", ({ value: e }) => {
...
}, Et = /* @__PURE__ */ "route.header.footer.themeToggle.hero.whyItMatters.understandingImpact.resultsTable.aboutHeader.aboutGrid.whatWeMeasure.blogHeader.blogList.careersHeader.careersBenefits.openPositions.contactHeader.contactForm.faqHeader.faqList.pricingHeader.pricingTiers.productsHeader.productsGrid.settingsHeader.profileSection.preferencesSection.apiAccessSection.settingsFooter.teamHeader.teamGrid.common.home.about.blog.careers.contact.faq.pricing.products.settings.team".split("."), Q = /* @__PURE__ */ new Map();
async function Dt(e, t) {
	...
	try {
		...
		return n === "en" ? {} : (await Tt(Object.assign({
			"./locales/en/about.json": () => import("./about-CYSxSXDm.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-D4vPffNV.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-D1fuBqnE.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-ByHxIFcg.js"),
...
async function Ot(e) {
	let t = e || "en", n = Q.get(t);
	if (n) return n;
	let r = await Promise.all(Et.map(async (e) => [e, await Dt(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return Q.set(t, o), o;
