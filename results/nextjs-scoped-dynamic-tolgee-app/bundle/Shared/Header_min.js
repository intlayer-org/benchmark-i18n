...
}, y = Object.defineProperty, b = Object.getOwnPropertySymbols, x = Object.prototype.hasOwnProperty, S = Object.prototype.propertyIsEnumerable, C = (e, t, n) => t in e ? y(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function _e(e, t) {
	let n = z(ge, t?.initialOptions, e);
	return n.apiUrl = ie(n.apiUrl), e?.fetch && (n.fetch = ce(e.fetch)), {
		initialOptions: n,
	...
	let T = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ae(e) || R, r = t().onFormatError, a = typeof r;
...
var H = 0, U = 1, W = 2, G = 3, K = 4, ke = new Set([
	W,
	U,
	H
]), q = "'", Ae = new Set([
...
(w = console.assert) == null || w.call(console, Re), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function ze(e, t) {
	let n = (n) => {
...
var at = { useSuspense: !1 }, ot, st = () => (ot ||= e.createContext(void 0), ot), J = void 0, ct = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
...
var dt = () => {
	...
	let { tolgee: r, options: a } = dt(), o = k(e), c = A(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = ft(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function Tt() {
	let e = yt(["language"]), t = f(), n = d(), r = e.getLanguage() || "en", i = (r) => {
...
var $ = Ot().init(), kt = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
...
async function Lt(e) {
	...
	if (n) return n;
	let r = await Promise.all(Pt.map(async (e) => [e, await It(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return Ft.set(t, o), o;
...
var Rt = "en";
async function zt({ children: e }) {
	return p(Mt, {
		locale: Rt,
		staticData: await Lt(Rt),
		children: e
	});
}
function Bt() {
	return p(zt, { children: p(Dt, {}) });
}
