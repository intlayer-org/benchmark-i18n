...
var B = 0, Fe = 1, V = 2, H = 3, U = 4, Ie = /* @__PURE__ */ new Set([
	V,
	Fe,
	B
...
function ze(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case B:
			i === W ? (n += i, t = Fe) : i === "{" ? (l(), t = H) : (n += i, t = B);
			break;
		case Fe:
			Le.has(i) ? (n = n.slice(0, -1) + i, t = V) : (n += i, t = B);
			break;
		case V:
			i === W ? t = B : (n += i, t = V);
			break;
		case H:
			i === "}" ? (d(), t = B) : Pe(i) ? r !== "" && (d(), t = U) : (u(), t = H);
			break;
		case U: i == "}" ? t = B : Pe(i) ? t = U : c(z);
	}
	return Ie.has(t) || c(Me), l(), [a, o];
}
function Be(e, t) {
	let [n, r] = ze(e), i = [n[0]];
...
var Qt = { useSuspense: !1 }, $t, en = () => ($t ||= e.createContext(void 0), $t), Z = void 0, tn = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	...
	let { tolgee: r, options: a } = nn(), o = ae(e), c = A(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = rn(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function yn() {
	let e = fn(["language"]), t = f(), n = d(), r = e.getLanguage() || "en", i = (r) => {
...
var Tn = Sn().init(), En = ({ language: e, staticData: t, children: n }) => {
	let r = f(), a = o(() => ({ [e]: wn(e, t[e] ?? {}) }), [e, t]);
	return i(() => {
...
function kn({ children: e, locale: t, staticData: n }) {
...
async function Mn(e, t = ["common"]) {
	let n = e || "en", r = await Promise.all(t.map(async (e) => [e, await jn(n, e)]));
	return Object.fromEntries(r);
}
var Nn = "en";
async function Pn({ children: e }) {
	let t = await Mn(Nn);
	return p(kn, {
		locale: Nn,
		staticData: t,
