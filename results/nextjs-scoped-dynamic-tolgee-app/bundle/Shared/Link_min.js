...
}, p = Object.defineProperty, m = Object.getOwnPropertySymbols, h = Object.prototype.hasOwnProperty, g = Object.prototype.propertyIsEnumerable, _ = (e, t, n) => t in e ? p(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function fe(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return C(s.onError, (e) => new M("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
	...
	let O = Object.freeze({
		...
		setStoredLanguage(e) {
			return C(s.onError, (e) => new M("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ne(e) || L, r = t().onFormatError, a = typeof r;
...
function he({ options: e }) {
	let t = oe(), n = B(!1, () => o.isFetching(), t.onFetchingChange.emit), r = B(!1, () => T.isLoading(), t.onLoadingChange.emit), i = pe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = fe(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = le(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var G = 0, K = 1, q = 2, J = 3, Y = 4, be = new Set([
	q,
	K,
	G
]), X = "'", xe = new Set([
...
function Ce(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case G:
			...
			break;
		case K:
			xe.has(i) ? (n = n.slice(0, -1) + i, t = q) : (n += i, t = G);
			break;
		case q:
			i === X ? t = G : (n += i, t = q);
			break;
...
function Ye(e, t, r, o = !0) {
	let [s] = a(() => Je(e)), [c, l] = a(o);
	return n(() => {
		l(!1);
	}, []), i(() => {
...
var Xe = { useSuspense: !1 }, Ze, Qe = () => (Ze ||= e.createContext(void 0), Ze), Z = void 0, $e = ({ tolgee: r, options: i, children: o, fallback: s, ssr: c }) => {
	n(() => {
		Z?.run !== r.run && (Z && Z.stop(), Z = r, r.run().catch((e) => {
			console.error(e);
		}).finally(() => {
			p(!1);
		}));
	...
	l = Ye(r, u, d, !!c);
	let [f, p] = a(!l.isLoaded()), m = Object.assign(Object.assign({}, Xe), i), h = Qe();
...
var Q = et().init(), tt = ({ language: e, staticData: t, children: r }) => {
	let i = c();
	return n(() => {
...
function it({ children: e, locale: t, staticData: i }) {
...
}, ot = /* @__PURE__ */ "route.header.footer.themeToggle.hero.whyItMatters.understandingImpact.resultsTable.aboutHeader.aboutGrid.whatWeMeasure.blogHeader.blogList.careersHeader.careersBenefits.openPositions.contactHeader.contactForm.faqHeader.faqList.pricingHeader.pricingTiers.productsHeader.productsGrid.settingsHeader.profileSection.preferencesSection.apiAccessSection.settingsFooter.teamHeader.teamGrid.common.home.about.blog.careers.contact.faq.pricing.products.settings.team".split("."), st = /* @__PURE__ */ new Map();
async function ct(e, t) {
	let n = e || "en";
	try {
		return (await at(Object.assign({
		...
		return n === "en" ? {} : (await at(Object.assign({
			"./locales/en/about.json": () => import("./about-CYSxSXDm.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-D4vPffNV.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-D1fuBqnE.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-ByHxIFcg.js"),
...
async function lt(e) {
	let t = e || "en", n = st.get(t);
	if (n) return n;
	let r = await Promise.all(ot.map(async (e) => [e, await ct(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return st.set(t, o), o;
