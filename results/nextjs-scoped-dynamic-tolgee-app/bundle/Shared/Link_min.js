...
import { useParams as s, useRouter as c } from "next/navigation";
...
var f = ({ href: e, children: t, ...n }) => {
	let r = s().locale ?? "en";
	return e == null || typeof e != "string" || u(e) ? l(o, {
		href: e,
		prefetch: !1,
		...n,
		children: t
	...
	let D = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ie(e) || I, r = t().onFormatError, a = typeof r;
...
function Wt(e, t, r, o = !0) {
	let [s] = a(() => Ut(e)), [c, l] = a(o);
	return n(() => {
		l(!1);
	}, []), i(() => {
...
var Gt = { useSuspense: !1 }, Kt, qt = () => (Kt ||= e.createContext(void 0), Kt), Q = void 0, Jt = ({ tolgee: r, options: i, children: o, fallback: s, ssr: c }) => {
	n(() => {
	...
	l = Wt(r, u, d, !!c);
	let [f, p] = a(!l.isLoaded()), m = Object.assign(Object.assign({}, Gt), i), h = qt();
...
var Zt = Yt().init(), Qt = ({ language: e, staticData: t, children: r }) => {
	let a = c(), o = i(() => ({ [e]: Xt(e, t[e] ?? {}) }), [e, t]);
	return n(() => {
		let { unsubscribe: e } = Zt.on("permanentChange", () => {
			a.refresh();
		});
		return () => {
			e();
...
function tn({ children: e, locale: t, staticData: i }) {
...
async function an(e, t = ["common"]) {
	let n = e || "en", r = await Promise.all(t.map(async (e) => [e, await rn(n, e)]));
	return Object.fromEntries(r);
}
var on = "en";
async function sn({ children: e }) {
	let t = await an(on);
	return l(tn, {
		locale: on,
		staticData: t,
