...
var Ie = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, G = {};
(function(e) {
	function t(e, t) {
...
function tt(e) {
	return Y ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: We }, window.origin), i = () => {
			clearInterval(a), nt(), X = void 0, n(new q("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Ut = { useSuspense: !1 }, Wt, Gt = () => (Wt ||= e.createContext(void 0), Wt), Q = void 0, Kt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
...
function Qt() {
	let e = Yt(["language"]), t = l(), n = c(), r = e.getLanguage() || "en", i = (r) => {
...
var tn = $t().init(), nn = ({ language: e, staticData: t, children: n }) => {
	let r = l(), a = o(() => ({ [e]: en(e, t[e] ?? {}) }), [e, t]);
	return i(() => {
		let { unsubscribe: e } = tn.on("permanentChange", () => {
			r.refresh();
		});
		return () => {
			e();
...
function on({ children: e, locale: t, staticData: n }) {
...
async function ln(e, t = ["common"]) {
	let n = e || "en", r = await Promise.all(t.map(async (e) => [e, await cn(n, e)]));
	return Object.fromEntries(r);
}
var un = "en";
async function dn({ children: e }) {
	let t = await ln(un);
	return u(on, {
		locale: un,
		staticData: t,
