...
var rn = () => l("div", {
	...
	children: l(nn, { keyName: "mockBanner.mockBanner" })
});
function an() {
	return Ht().use(Fe());
}
...
var sn = an().init(), cn = ({ language: e, staticData: t, children: n }) => {
	let r = u(), a = o(() => ({ [e]: on(e, t[e] ?? {}) }), [e, t]);
	return i(() => {
...
async function mn(e, t = ["common"]) {
	let n = e || "en", r = await Promise.all(t.map(async (e) => [e, await pn(n, e)]));
	return Object.fromEntries(r);
}
var hn = "en";
async function gn({ children: e }) {
	let t = await mn(hn);
	return l(dn, {
		locale: hn,
		staticData: t,
