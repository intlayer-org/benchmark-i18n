...
function de(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return x(s.onError, (e) => new se("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
	...
	let k = Object.freeze({
		...
		setStoredLanguage(e) {
			return x(s.onError, (e) => new se("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function me({ options: e }) {
	let t = ie(), n = z(!1, () => o.isFetching(), t.onFetchingChange.emit), r = z(!1, () => E.isLoading(), t.onLoadingChange.emit), i = fe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = de(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = ce(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var ge = () => {
	let e = {
		...
		init(t) {
			let n = he(L(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, V = 0, H = 1, _e = 2, ve = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var U = 0, W = 1, G = 2, K = 3, q = 4, be = new Set([
	G,
	W,
	U
]), J = "'", xe = new Set([
...
function Ce(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case U:
			...
			break;
		case W:
			xe.has(i) ? (n = n.slice(0, -1) + i, t = G) : (n += i, t = U);
			break;
		case G:
			i === J ? t = U : (n += i, t = G);
			break;
		case K:
			i === "}" ? (d(), t = U) : ye(i) ? r !== "" && (d(), t = q) : (u(), t = K);
			break;
		case q: i == "}" ? t = U : ye(i) ? t = q : c(H);
	}
...
var Ee = () => (e, t) => (t.setFinalFormatter(Te()), e), De = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Y = {};
(function(e) {
	function t(e, t) {
		var n;
...
(_ = console.assert) == null || _.call(console, Oe), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function ke(e, t) {
	let n = (n) => {
...
var X = null;
function Le(e) {
	return X ||= Ie(`${Fe}/@tolgee/web@${e}/dist/${Me}`).then(() => window[Ne][Pe]), X;
}
...
var Je = { useSuspense: !1 }, Ye, Xe = () => (Ye ||= e.createContext(void 0), Ye), Z = void 0, Ze = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
...
var et = () => {
	...
	let { tolgee: r, options: a } = et(), o = w(e), c = T(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = tt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var Q = (t) => {
	let n = rt(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, at(t))) : at(n);
}, ot = (t) => {
	...
	let { t: n } = nt();
	return e.createElement(ot, Object.assign({ t: n }, t));
};
function ct(e) {
	return l(st, { ...e });
}
...
var $ = ut().init(), dt = ({ language: e, staticData: t, children: n }) => {
	let r = u();
	return i(() => {
...
function mt({ children: e, locale: t, staticData: n }) {
...
}, gt = /* @__PURE__ */ "route.header.footer.themeToggle.hero.whyItMatters.understandingImpact.resultsTable.aboutHeader.aboutGrid.whatWeMeasure.blogHeader.blogList.careersHeader.careersBenefits.openPositions.contactHeader.contactForm.faqHeader.faqList.pricingHeader.pricingTiers.productsHeader.productsGrid.settingsHeader.profileSection.preferencesSection.apiAccessSection.settingsFooter.teamHeader.teamGrid.common.home.about.blog.careers.contact.faq.pricing.products.settings.team".split("."), _t = /* @__PURE__ */ new Map();
async function vt(e, t) {
	...
	try {
		...
		return n === "en" ? {} : (await ht(Object.assign({
			"./locales/en/about.json": () => import("./about-CYSxSXDm.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-D4vPffNV.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-D1fuBqnE.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-ByHxIFcg.js"),
...
async function yt(e) {
	let t = e || "en", n = _t.get(t);
	if (n) return n;
	let r = await Promise.all(gt.map(async (e) => [e, await vt(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return _t.set(t, o), o;
...
var bt = "en";
async function xt({ children: e }) {
	return l(mt, {
		locale: bt,
		staticData: await yt(bt),
		children: e
	});
}
function St() {
	return l(xt, { children: l(lt, {}) });
}
