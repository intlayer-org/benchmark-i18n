...
function ge({ options: e }) {
	let t = ie(), n = L(!1, () => o.isFetching(), t.onFetchingChange.emit), r = L(!1, () => E.isLoading(), t.onLoadingChange.emit), i = me(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = pe(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = ce(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var ve = () => {
	...
	return t;
}, ye = 0, z = 1, be = 2, xe = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === ye ? r = "Empty parameter" : e === z ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Se(e) {
	return /\s/.test(e);
}
var B = 0, V = 1, H = 2, U = 3, W = 4, Ce = new Set([
	H,
	V,
	B
]), G = "'", we = new Set([
...
function Ee(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		...
		case H:
			...
			break;
		case U:
			i === "}" ? (d(), t = B) : Se(i) ? r !== "" && (d(), t = W) : (u(), t = U);
			break;
		case W: i == "}" ? t = B : Se(i) ? t = W : c(z);
	}
...
var ke = () => (e, t) => (t.setFinalFormatter(Oe()), e), Ae = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, K = {};
(function(e) {
	function t(e, t) {
		var n;
...
(_ = console.assert) == null || _.call(console, je), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Me(e, t) {
	let n = (n) => {
...
var q = null;
function Be(e) {
	return q ||= ze(`${Re}/@tolgee/web@${e}/dist/${Fe}`).then(() => window[Ie][Le]), q;
}
...
var Ze = { useSuspense: !1 }, Qe, $e = () => (Qe ||= e.createContext(void 0), Qe), J = void 0, et = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
...
var rt = () => {
	...
	let { tolgee: r, options: a } = rt(), o = w(e), c = T(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = it(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var Q = ht().init(), gt = ({ language: e, staticData: t, children: n }) => {
	let r = u();
	return i(() => {
...
function yt({ children: e, locale: t, staticData: n }) {
...
}, xt = /* @__PURE__ */ "route.header.footer.themeToggle.hero.whyItMatters.understandingImpact.resultsTable.aboutHeader.aboutGrid.whatWeMeasure.blogHeader.blogList.careersHeader.careersBenefits.openPositions.contactHeader.contactForm.faqHeader.faqList.pricingHeader.pricingTiers.productsHeader.productsGrid.settingsHeader.profileSection.preferencesSection.apiAccessSection.settingsFooter.teamHeader.teamGrid.common.home.about.blog.careers.contact.faq.pricing.products.settings.team".split("."), $ = /* @__PURE__ */ new Map();
async function St(e, t) {
	...
	try {
		...
		return n === "en" ? {} : (await bt(Object.assign({
			"./locales/en/about.json": () => import("./about-CYSxSXDm.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-D4vPffNV.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-D1fuBqnE.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-ByHxIFcg.js"),
...
async function Ct(e) {
	let t = e || "en", n = $.get(t);
	if (n) return n;
	let r = await Promise.all(xt.map(async (e) => [e, await St(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return $.set(t, o), o;
