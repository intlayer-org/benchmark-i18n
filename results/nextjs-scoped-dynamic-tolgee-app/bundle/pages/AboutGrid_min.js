...
}, N = ({ language: e, namespace: t }) => t ? `${e}:${t}` : e;
...
function me(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return S(s.onError, (e) => new ce("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return S(s.onError, (e) => new se("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function E(e) {
		e && l.backends.push(e);
	}
	...
	let k = Object.freeze({
		...
		setStoredLanguage(e) {
			return S(s.onError, (e) => new ce("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function _e({ options: e }) {
	let t = ae(), n = L(!1, () => o.isFetching(), t.onFetchingChange.emit), r = L(!1, () => T.isLoading(), t.onLoadingChange.emit), i = he(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = me(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = ue(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var ye = () => {
	let e = {
		...
		init(t) {
			let n = ve(F(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, z = 0, B = 1, be = 2, xe = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var H = 0, U = 1, W = 2, G = 3, K = 4, Se = new Set([
	W,
	U,
	H
]), q = "'", Ce = new Set([
...
function Te(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case H:
			...
			break;
		case U:
			Ce.has(i) ? (n = n.slice(0, -1) + i, t = W) : (n += i, t = H);
			break;
		case W:
			i === q ? t = H : (n += i, t = W);
			break;
		case G:
			i === "}" ? (d(), t = H) : V(i) ? r !== "" && (d(), t = K) : (u(), t = G);
			break;
		case K: i == "}" ? t = H : V(i) ? t = K : c(B);
	}
...
var Oe = () => (e, t) => (t.setFinalFormatter(De()), e), ke = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Ae = {};
(function(e) {
	function t(e, t) {
		var n;
...
(v = console.assert) == null || v.call(console, je), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Me(e, t) {
	let n = (n) => {
...
var Qe = { useSuspense: !1 }, $e, et = () => ($e ||= e.createContext(void 0), $e), J = void 0, tt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
...
var it = () => {
	...
	let { tolgee: r, options: a } = it(), o = T(e), c = E(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = at(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var X = (t) => {
	let n = st(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, Y(t))) : Y(n);
}, lt = (t) => {
...
var Q = ft().init(), pt = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
