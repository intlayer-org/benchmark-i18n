...
var Ee = () => {
	...
	return t;
}, De = 0, I = 1, Oe = 2, ke = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === De ? r = "Empty parameter" : e === I ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Ae(e) {
	return /\s/.test(e);
}
var L = 0, R = 1, z = 2, B = 3, V = 4, je = /* @__PURE__ */ new Set([
	z,
	R,
	L
]), H = "'", Me = /* @__PURE__ */ new Set([
	"{",
	"}",
	H
...
function Pe(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case L:
			...
			break;
		case R:
			Me.has(i) ? (n = n.slice(0, -1) + i, t = z) : (n += i, t = L);
			break;
		case z:
			i === H ? t = L : (n += i, t = z);
			break;
		case B:
			i === "}" ? (d(), t = L) : Ae(i) ? r !== "" && (d(), t = V) : (u(), t = B);
			break;
		case V: i == "}" ? t = L : Ae(i) ? t = V : c(I);
	}
...
var ze = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, U = {};
(function(e) {
	function t(e, t) {
	...
	return u("div", {
		...
		children: [u("div", {
			...
			children: [l("h2", {
				...
				children: l(Q, { keyName: "aboutGrid.whyThisExists" })
			}), l("p", {
				className: "text-sm text-muted-foreground",
				children: l(Q, { keyName: "aboutGrid.choosingAnI18nLibrary" })
			})]
		}), u("div", {
			className: "rounded-lg border border-border bg-card p-6",
			children: [l("h2", {
				className: "mb-3 text-xl font-semibold text-foreground",
				children: l(Q, { keyName: "aboutGrid.methodology" })
			}), l("p", {
				className: "text-sm text-muted-foreground",
				children: l(Q, { keyName: "aboutGrid.theSame10PageApp" })
			})]
		})]
	});
}
