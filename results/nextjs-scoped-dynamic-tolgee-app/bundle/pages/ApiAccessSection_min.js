...
function R(e, t) {
	...
	return n.apiUrl = k(n.apiUrl), e?.fetch && (n.fetch = ie(e.fetch)), {
		initialOptions: n,
...
var $ = ft().init(), pt = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
...
function gt({ children: e, locale: t, staticData: n }) {
...
}, vt = /* @__PURE__ */ "route.header.footer.themeToggle.hero.whyItMatters.understandingImpact.resultsTable.aboutHeader.aboutGrid.whatWeMeasure.blogHeader.blogList.careersHeader.careersBenefits.openPositions.contactHeader.contactForm.faqHeader.faqList.pricingHeader.pricingTiers.productsHeader.productsGrid.settingsHeader.profileSection.preferencesSection.apiAccessSection.settingsFooter.teamHeader.teamGrid.common.home.about.blog.careers.contact.faq.pricing.products.settings.team".split("."), yt = /* @__PURE__ */ new Map();
async function bt(e, t) {
	let n = e || "en";
	try {
		return (await _t(Object.assign({
		...
		return n === "en" ? {} : (await _t(Object.assign({
			"./locales/en/about.json": () => import("./about-CYSxSXDm.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-D4vPffNV.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-D1fuBqnE.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-ByHxIFcg.js"),
...
async function xt(e) {
	let t = e || "en", n = yt.get(t);
	if (n) return n;
	let r = await Promise.all(vt.map(async (e) => [e, await bt(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return yt.set(t, o), o;
...
var St = "en";
async function Ct({ children: e }) {
	return u(gt, {
		locale: St,
		staticData: await xt(St),
		children: e
	});
}
function wt() {
	return u(Ct, { children: u(dt, {}) });
}
