...
function on() {
	...
	return d("section", {
		...
		children: [u("h2", {
			...
			children: u(Q, { keyName: "apiAccessSection.apiAccess" })
		}), d("div", { children: [
			u("label", {
				htmlFor: e,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: u(Q, { keyName: "apiAccessSection.apiKey" })
			}),
			d("div", {
				...
				children: [u("input", {
					...
					children: u(Q, { keyName: "common.copy" })
				})]
			}),
			u("p", {
				className: "mt-1 text-xs text-muted-foreground",
				children: u(Q, { keyName: "apiAccessSection.useThisKeyTo" })
			})
		] })]
	});
}
...
var ln = sn().init(), un = ({ language: e, staticData: t, children: n }) => {
	let r = f(), a = s(() => ({ [e]: cn(e, t[e] ?? {}) }), [e, t]);
	return i(() => {
...
async function gn(e, t = ["common"]) {
	let n = e || "en", r = await Promise.all(t.map(async (e) => [e, await hn(n, e)]));
	return Object.fromEntries(r);
}
var _n = "en";
async function vn({ children: e }) {
	let t = await gn(_n);
	return u(pn, {
		locale: _n,
		staticData: t,
