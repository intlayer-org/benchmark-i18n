...
function Te(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		...
		case G:
			...
			break;
		case K:
			i === "}" ? (d(), t = U) : xe(i) ? r !== "" && (d(), t = q) : (u(), t = K);
			break;
		case q: i == "}" ? t = U : xe(i) ? t = q : c(H);
	}
...
var Ze = { useSuspense: !1 }, Qe, $e = () => (Qe ||= e.createContext(void 0), Qe), X = void 0, et = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
...
var rt = () => {
	...
	let { tolgee: r, options: a } = rt(), o = E(e), s = D(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = it(), f = c([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var $ = mt().init(), ht = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
...
async function Tt({ children: e }) {
	return u(vt, {
		locale: wt,
		staticData: await Ct(wt),
		children: e
	});
}
function Et() {
	return u(Tt, { children: u(pt, {}) });
}
