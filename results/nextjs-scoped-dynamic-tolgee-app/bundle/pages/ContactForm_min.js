...
var qt = { useSuspense: !1 }, Jt, Yt = () => (Jt ||= e.createContext(void 0), Jt), X = void 0, Xt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	...
	c = Kt(n, u, d, !!s);
	let [f, p] = l(!c.isLoaded()), m = Object.assign(Object.assign({}, qt), r), h = Yt();
	...
	let { tolgee: r, options: a } = Zt(), o = D(e), s = O(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Qt(), f = c([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
		...
		children: [
			d("div", {
				...
				children: [d("div", { children: [u("label", {
					...
					children: u(Q, { keyName: "contactForm.name" })
				}), u("input", {
					id: t,
					...
					htmlFor: n,
					className: "mb-1 block text-sm font-medium text-foreground",
					children: u(Q, { keyName: "contactForm.email" })
				}), u("input", {
					id: n,
					type: "email",
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			d("div", { children: [u("label", {
				htmlFor: r,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: u(Q, { keyName: "contactForm.topic" })
			}), d("select", {
				id: r,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				children: [
					u("option", { children: e("contactForm.bugReport") }),
					u("option", { children: e("contactForm.newBenchmarkIdea") }),
					u("option", { children: e("contactForm.methodologyQuestion") }),
					u("option", { children: e("contactForm.contribution") }),
					u("option", { children: e("contactForm.other") })
				]
			})] }),
			d("div", { children: [u("label", {
				htmlFor: i,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: u(Q, { keyName: "contactForm.message" })
			}), u("textarea", {
				id: i,
				rows: 5,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			u("button", {
				...
				children: u(Q, { keyName: "contactForm.sendMessage" })
			})
		]
	});
}
...
var dn = ln().init(), fn = ({ language: e, staticData: t, children: n }) => {
	let r = f(), a = s(() => ({ [e]: un(e, t[e] ?? {}) }), [e, t]);
	return i(() => {
...
async function vn(e, t = ["common"]) {
	let n = e || "en", r = await Promise.all(t.map(async (e) => [e, await _n(n, e)]));
	return Object.fromEntries(r);
}
var yn = "en";
async function bn({ children: e }) {
	let t = await vn(yn);
	return u(hn, {
		locale: yn,
		staticData: t,
