	...
	const faqs = [
		{
			...
			a: t("faqList.i18nBenchmarkIsAnOpenSource")
		},
		{
			q: t("faqList.howAreBenchmarksConducted"),
			a: t("faqList.weRunStandardizedTestsInIsolated")
		},
		{
			q: t("faqList.whichLibrariesAreCurrentlySupported"),
			a: t("faqList.weSupportReactI18nextReactIntl")
		},
		{
			q: t("faqList.canISubmitMyOwnBenchmarks"),
			a: t("faqList.yesCommunityBenchmarkSubmissionsAre")
		},
		{
			q: t("faqList.howOftenAreBenchmarksUpdated"),
			a: t("faqList.weReRunAllBenchmarksWeekly")
		},
		{
			q: t("faqList.isTheDataReliable"),
			a: t("faqList.weFollowRigorousStatisticalMethodologyIncluding")
		},
		{
			q: t("faqList.doYouOfferConsultingServices"),
			a: t("faqList.yesOurEnterprisePlanIncludesConsulting")
		},
		{
			q: t("faqList.howCanIContribute"),
			a: t("faqList.thereAreManyWaysToContribute")
		}
	];
	return jsx("div", {
...
var TolgeeNextProvider = ({ language, staticData, children }) => {
	...
	const mergedStaticData = useMemo(() => ({ [language]: mergeMessages(language, staticData[language] ?? {}) }), [language, staticData]);
	useEffect(() => {
...
async function loadNamespace(locale, namespace) {
	...
	try {
		return (await _rolldown_dynamic_import_helper_default(Object.assign({
			...
			"./locales/en/about.json": () => import("./about-C2CJsMsx.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-CB4QbfhP.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-DEdVRXLR.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-Cd9IXRal.js"),
			"./locales/en/blog.json": () => import("./blog-MwoDL-Jg.js"),
			"./locales/en/blogHeader.json": () => import("./blogHeader-Z9saW9R3.js"),
			"./locales/en/blogList.json": () => import("./blogList-DTf1cSna.js"),
			"./locales/en/careers.json": () => import("./careers-BD9pVlRB.js"),
			"./locales/en/careersBenefits.json": () => import("./careersBenefits-DPVCab8z.js"),
			"./locales/en/careersHeader.json": () => import("./careersHeader-CMdJ8nRv.js"),
			"./locales/en/common.json": () => import("./common-DBT57opg.js"),
			"./locales/en/contact.json": () => import("./contact-D_bAPWhd.js"),
			"./locales/en/contactForm.json": () => import("./contactForm-Co6Dm0XG.js"),
			"./locales/en/contactHeader.json": () => import("./contactHeader-DBmitQ6y.js"),
			"./locales/en/faq.json": () => import("./faq-BYEFfeR5.js"),
			"./locales/en/faqHeader.json": () => import("./faqHeader-C9bJH8XZ.js"),
			"./locales/en/faqList.json": () => import("./faqList-BMnZ84QT.js"),
			"./locales/en/footer.json": () => import("./footer-kOzUm6PR.js"),
			"./locales/en/header.json": () => import("./header-CgJhEPf1.js"),
			"./locales/en/hero.json": () => import("./hero-Bd2O-PG4.js"),
			"./locales/en/home.json": () => import("./home-kxjDXcGK.js"),
			"./locales/en/mockBanner.json": () => import("./mockBanner-9ci5abKE.js"),
			"./locales/en/openPositions.json": () => import("./openPositions-D1laUnxx.js"),
			"./locales/en/preferencesSection.json": () => import("./preferencesSection-Bbqn_qyE.js"),
			"./locales/en/pricing.json": () => import("./pricing-AooD5teS.js"),
			"./locales/en/pricingHeader.json": () => import("./pricingHeader-ChwR2ik6.js"),
			"./locales/en/pricingTiers.json": () => import("./pricingTiers-BNYkanwx.js"),
			"./locales/en/products.json": () => import("./products-D02t9oUv.js"),
			"./locales/en/productsGrid.json": () => import("./productsGrid-BhaiVe-z.js"),
			"./locales/en/productsHeader.json": () => import("./productsHeader-BZf4PzD-.js"),
			"./locales/en/profileSection.json": () => import("./profileSection-DhB6siQ-.js"),
			"./locales/en/resultsTable.json": () => import("./resultsTable-D0rxM04D.js"),
			"./locales/en/route.json": () => import("./route-C05OgSmu.js"),
			"./locales/en/settings.json": () => import("./settings-B2XRGrMf.js"),
			"./locales/en/settingsFooter.json": () => import("./settingsFooter-CdEIeN8a.js"),
			"./locales/en/settingsHeader.json": () => import("./settingsHeader-BWAGqcxP.js"),
			"./locales/en/team.json": () => import("./team-SCtZeXBa.js"),
			"./locales/en/teamGrid.json": () => import("./teamGrid-DI3XyzZp.js"),
			"./locales/en/teamHeader.json": () => import("./teamHeader-BMqah4T3.js"),
			"./locales/en/themeToggle.json": () => import("./themeToggle-CvFkTPnz.js"),
			"./locales/en/understandingImpact.json": () => import("./understandingImpact-Dh5tlQz3.js"),
			"./locales/en/whatWeMeasure.json": () => import("./whatWeMeasure-BTsgdvls.js"),
			"./locales/en/whyItMatters.json": () => import("./whyItMatters-CgC9ROZm.js"),
...
async function getMessages(locale, namespaces = ["common"]) {
	const safeLocale = locale || "en";
...
async function Wrapper({ children }) {
	const staticData = await getMessages(locale);
