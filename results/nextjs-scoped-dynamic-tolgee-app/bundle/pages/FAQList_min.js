...
var Le = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, G = {};
(function(e) {
	function t(e, t) {
...
(x = console.assert) == null || x.call(console, Re), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function ze(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, Je = 3e3, Ye = 200, Xe = 0, J = /* @__PURE__ */ new Map(), Ze = !1, Y, X;
...
var $e = (e) => new q("unavailable", `the Tolgee browser extension did not answer ${e} in time`), et = () => `${Date.now()}-${Xe++}-${Math.random()}`;
function tt() {
...
function nt(e) {
	return Y ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Ge }, window.origin), i = () => {
			clearInterval(a), rt(), X = void 0, n(new q("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Z = "__tolgee_", bt = `${Z}apiKey`, xt = `${Z}apiUrl`, St = `${Z}branch`, Ct = `${Z}projectId`, wt = `${Z}session`, Tt = "tolgee-in-context-tools.umd.min.js", Et = "@tolgee/in-context-tools", Dt = "InContextTools", Ot = "https://cdn.jsdelivr.net/npm", kt = null;
function At(e) {
...
function It() {
	...
	if (i && r) return b(y({}, a), { transport: it() });
}
function Lt() {
	let e = [];
...
var Wt = { useSuspense: !1 }, Gt, Kt = () => (Gt ||= e.createContext(void 0), Gt), Q = void 0, qt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = Ut(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, Wt), r), h = Kt();
	...
	let { tolgee: r, options: a } = Jt(), o = D(e), c = O(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Yt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function $t() {
	let { t: e } = Qt(), t = [
		{
			q: e("faqList.whatIsI18nBenchmark"),
			a: e("faqList.i18nBenchmarkIsAnOpenSource")
		},
		{
			q: e("faqList.howAreBenchmarksConducted"),
			a: e("faqList.weRunStandardizedTestsInIsolated")
		},
		{
			q: e("faqList.whichLibrariesAreCurrentlySupported"),
			a: e("faqList.weSupportReactI18nextReactIntl")
		},
		{
			q: e("faqList.canISubmitMyOwnBenchmarks"),
			a: e("faqList.yesCommunityBenchmarkSubmissionsAre")
		},
		{
			q: e("faqList.howOftenAreBenchmarksUpdated"),
			a: e("faqList.weReRunAllBenchmarksWeekly")
		},
		{
			q: e("faqList.isTheDataReliable"),
			a: e("faqList.weFollowRigorousStatisticalMethodologyIncluding")
		},
		{
			q: e("faqList.doYouOfferConsultingServices"),
			a: e("faqList.yesOurEnterprisePlanIncludesConsulting")
		},
		{
			q: e("faqList.howCanIContribute"),
			a: e("faqList.thereAreManyWaysToContribute")
		}
	];
	return l("div", {
		className: "mx-auto max-w-3xl space-y-4",
		children: t.map((e) => u("details", {
...
var nn = en().init(), rn = ({ language: e, staticData: t, children: n }) => {
	let r = d(), a = o(() => ({ [e]: tn(e, t[e] ?? {}) }), [e, t]);
	return i(() => {
...
async function un(e, t = ["common"]) {
	let n = e || "en", r = await Promise.all(t.map(async (e) => [e, await ln(n, e)]));
	return Object.fromEntries(r);
}
var dn = "en";
async function fn({ children: e }) {
	let t = await un(dn);
	return l(sn, {
		locale: dn,
		staticData: t,
