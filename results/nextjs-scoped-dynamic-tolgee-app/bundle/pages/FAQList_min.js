...
function me({ options: e }) {
	let t = ie(), n = de(!1, () => o.isFetching(), t.onFetchingChange.emit), r = de(!1, () => T.isLoading(), t.onLoadingChange.emit), i = fe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ue(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = se(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Je = { useSuspense: !1 }, Ye, Xe = () => (Ye ||= e.createContext(void 0), Ye), Q = void 0, Ze = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = qe(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, Je), r), h = Xe();
...
var et = () => {
	...
	let { tolgee: r, options: a } = et(), o = T(e), c = E(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = tt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function at() {
	...
	return l("div", {
		...
		children: [
			{
				q: e("faqList.whatIsI18nBenchmark", "What is i18n Benchmark?"),
				a: e("faqList.i18nBenchmarkIsAnOpenSource", "i18n Benchmark is an open-source benchmarking suite that measures and compares the performance, bundle size, and developer experience of internationalization libraries for JavaScript and React applications.")
			},
			{
				q: e("faqList.howAreBenchmarksConducted", "How are benchmarks conducted?"),
				a: e("faqList.weRunStandardizedTestsInIsolated", "We run standardized tests in isolated environments using consistent hardware. Each benchmark is repeated multiple times to ensure statistical significance. All test configurations are publicly available in our GitHub repository.")
			},
			{
				q: e("faqList.whichLibrariesAreCurrentlySupported", "Which libraries are currently supported?"),
				a: e("faqList.weSupportReactI18nextReactIntl", "We support react-i18next, react-intl (FormatJS), Lingui, typesafe-i18n, next-intl, Paraglide, Rosetta, i18n-js, Polyglot.js, vue-i18n, @fluent/react, and Tolgee.")
			},
			{
				q: e("faqList.canISubmitMyOwnBenchmarks", "Can I submit my own benchmarks?"),
				a: e("faqList.yesCommunityBenchmarkSubmissionsAre", "Yes! Community benchmark submissions are welcome. Fork our repository, add your benchmark following our contribution guide, and submit a pull request. Our team will review and merge qualifying submissions.")
			},
			{
				q: e("faqList.howOftenAreBenchmarksUpdated", "How often are benchmarks updated?"),
				a: e("faqList.weReRunAllBenchmarksWeekly", "We re-run all benchmarks weekly against the latest stable versions of each library. Major version releases trigger an immediate re-benchmark cycle.")
			},
			{
				q: e("faqList.isTheDataReliable", "Is the data reliable?"),
				a: e("faqList.weFollowRigorousStatisticalMethodologyIncluding", "We follow rigorous statistical methodology including warm-up runs, outlier detection, and confidence intervals. All raw data is published alongside our analysis for full transparency.")
			},
			{
				q: e("faqList.doYouOfferConsultingServices", "Do you offer consulting services?"),
				a: e("faqList.yesOurEnterprisePlanIncludesConsulting", "Yes, our Enterprise plan includes consulting hours for teams evaluating i18n solutions. We can provide tailored recommendations based on your specific use case, scale, and constraints.")
			},
			{
				q: e("faqList.howCanIContribute", "How can I contribute?"),
				a: e("faqList.thereAreManyWaysToContribute", "There are many ways to contribute: submit benchmarks, improve documentation, report bugs, suggest new metrics, or sponsor the project. Visit our GitHub repository for more details.")
			}
		].map((e) => u("details", {
...
var $ = ot().init(), st = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
...
function ut({ children: e, locale: t, staticData: n }) {
