...
var qt = { useSuspense: !1 }, Jt, Yt = () => (Jt ||= e.createContext(void 0), Jt), X = void 0, Xt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	...
	let { tolgee: r, options: a } = Zt(), o = O(e), c = k(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Qt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var on = () => u("div", {
	...
	children: u(Q, { keyName: "mockBanner.mockBanner" })
});
function sn() {
	return d(l, { children: [u(on, {}), d("div", {
		className: "mb-12 text-center",
		children: [u("h1", {
			className: "mb-3 text-3xl font-bold text-foreground",
			children: u(Q, { keyName: "pricingHeader.pricing" })
		}), u("p", {
			className: "text-muted-foreground",
			children: u(Q, { keyName: "pricingHeader.transparentPricingForEvery" })
		})]
	})] });
}
function cn() {
