...
var H = 0, U = 1, W = 2, G = 3, K = 4, Ce = new Set([
	W,
	U,
	H
]), q = "'", we = new Set([
...
function Ee(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case H:
			...
			break;
		case U:
			we.has(i) ? (n = n.slice(0, -1) + i, t = W) : (n += i, t = H);
			break;
		case W:
			i === q ? t = H : (n += i, t = W);
			break;
		case G:
			i === "}" ? (d(), t = H) : Se(i) ? r !== "" && (d(), t = K) : (u(), t = G);
			break;
		case K: i == "}" ? t = H : Se(i) ? t = K : c(V);
	}
...
var ke = () => (e, t) => (t.setFinalFormatter(Oe()), e), Ae = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, J = {};
(function(e) {
	function t(e, t) {
		var n;
...
(y = console.assert) == null || y.call(console, je), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Me(e, t) {
	let n = (n) => {
...
function Ne({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var Fe = "tolgee-in-context-tools.umd.min.js", Ie = "@tolgee/in-context-tools", Le = "InContextTools", Re = "https://cdn.jsdelivr.net/npm";
function ze(e) {
...
var Be = null;
function Ve(e) {
	return Be ||= ze(`${Re}/@tolgee/web@${e}/dist/${Fe}`).then(() => window[Ie][Le]), Be;
}
var He = "__tolgee_apiKey", Ue = "__tolgee_apiUrl", We = "__tolgee_branch";
function Ge() {
	let e = sessionStorage.getItem(He) || void 0, t = sessionStorage.getItem(Ue) || void 0, n = sessionStorage.getItem(We) || void 0;
	if (!(!e || !t)) return v({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Ke() {
	sessionStorage.removeItem(He), sessionStorage.removeItem(Ue), sessionStorage.removeItem(We);
}
function qe(e) {
...
var Qe = { useSuspense: !1 }, $e, et = () => ($e ||= e.createContext(void 0), $e), Y = void 0, tt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
...
var it = () => {
	...
	let { tolgee: r, options: a } = it(), o = E(e), c = D(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = at(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var $ = pt().init(), mt = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
...
function _t({ children: e, locale: t, staticData: n }) {
...
}, yt = /* @__PURE__ */ "route.header.footer.themeToggle.hero.whyItMatters.understandingImpact.resultsTable.aboutHeader.aboutGrid.whatWeMeasure.blogHeader.blogList.careersHeader.careersBenefits.openPositions.contactHeader.contactForm.faqHeader.faqList.pricingHeader.pricingTiers.productsHeader.productsGrid.settingsHeader.profileSection.preferencesSection.apiAccessSection.settingsFooter.teamHeader.teamGrid.common.home.about.blog.careers.contact.faq.pricing.products.settings.team".split("."), bt = /* @__PURE__ */ new Map();
async function xt(e, t) {
	...
	try {
		...
		return n === "en" ? {} : (await vt(Object.assign({
			"./locales/en/about.json": () => import("./about-CYSxSXDm.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-D4vPffNV.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-D1fuBqnE.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-ByHxIFcg.js"),
...
async function St(e) {
	let t = e || "en", n = bt.get(t);
	if (n) return n;
	let r = await Promise.all(yt.map(async (e) => [e, await xt(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return bt.set(t, o), o;
...
async function wt({ children: e }) {
	return u(_t, {
		locale: Ct,
		staticData: await St(Ct),
		children: e
	});
}
function Tt() {
	return u(wt, { children: u(ft, {}) });
}
