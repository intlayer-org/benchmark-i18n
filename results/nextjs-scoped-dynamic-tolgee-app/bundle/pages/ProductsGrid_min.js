...
var Re = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, W = {};
(function(e) {
	function t(e, t) {
		...
		children: t.map((e) => u("div", {
			...
			children: [u("div", { children: [l("h3", {
				...
				children: [l("span", {
					...
					children: l(on, { keyName: "productsGrid.learnMore" })
				})]
			})]
		}, e.name))
	});
...
var un = cn().init(), dn = ({ language: e, staticData: t, children: n }) => {
	let r = d(), a = o(() => ({ [e]: ln(e, t[e] ?? {}) }), [e, t]);
	return i(() => {
		let { unsubscribe: e } = un.on("permanentChange", () => {
			r.refresh();
		});
		return () => {
			e();
...
function mn({ children: e, locale: t, staticData: n }) {
...
async function _n(e, t = ["common"]) {
	let n = e || "en", r = await Promise.all(t.map(async (e) => [e, await gn(n, e)]));
	return Object.fromEntries(r);
}
var vn = "en";
async function yn({ children: e }) {
	let t = await _n(vn);
	return l(mn, {
		locale: vn,
		staticData: t,
