...
function ge({ options: e }) {
	let t = ae(), n = R(!1, () => o.isFetching(), t.onFetchingChange.emit), r = R(!1, () => T.isLoading(), t.onLoadingChange.emit), i = me(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = pe(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = le(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var ve = () => {
	let e = {
		...
		init(t) {
			let n = _e(I(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, B = 0, V = 1, ye = 2, be = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var U = 0, W = 1, G = 2, K = 3, q = 4, xe = new Set([
	G,
	W,
	U
]), J = "'", Se = new Set([
...
function we(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case U:
			...
			break;
		case W:
			Se.has(i) ? (n = n.slice(0, -1) + i, t = G) : (n += i, t = U);
			break;
		case G:
			i === J ? t = U : (n += i, t = G);
			break;
...
var De = () => (e, t) => (t.setFinalFormatter(Ee()), e), Oe = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Y = {};
(function(e) {
	function t(e, t) {
		var n;
...
(v = console.assert) == null || v.call(console, ke), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ae(e, t) {
	let n = (n) => {
...
var Xe = { useSuspense: !1 }, Ze, Qe = () => (Ze ||= e.createContext(void 0), Ze), X = void 0, $e = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
...
var nt = () => {
	...
	let { tolgee: r, options: a } = nt(), o = T(e), c = E(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = rt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function pt() {
	...
	return l("div", {
		...
		children: [
			{
				name: e("productsGrid.benchmarkDashboard", "Benchmark Dashboard"),
				desc: e("productsGrid.interactiveChartsAndTables", "Interactive charts and tables comparing i18n libraries across bundle size, render time, and hydration cost."),
				price: e("pricingTiers.free", "Free")
			},
			{
				name: e("productsGrid.bundleAnalyzer", "Bundle Analyzer"),
				desc: e("productsGrid.uploadYourBuildOutput", "Upload your build output and get a detailed breakdown of how much of your bundle is i18n overhead."),
				price: "$29/mo"
			},
			{
				name: e("productsGrid.migrationAssistant", "Migration Assistant"),
				desc: e("productsGrid.automatedCodemodsAndGuides", "Automated codemods and guides for migrating between i18n libraries with minimal disruption."),
				price: e("pricingTiers.custom", "Custom")
			},
			{
				name: e("productsGrid.performanceMonitor", "Performance Monitor"),
				desc: e("productsGrid.continuousPerformanceTrackingFor", "Continuous performance tracking for your i18n implementation. Get alerts when translation loading degrades."),
				price: "$49/mo"
			}
		].map((e) => u("div", {
...
var Q = mt().init(), ht = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
...
function vt({ children: e, locale: t, staticData: n }) {
...
}, bt = /* @__PURE__ */ "route.header.footer.themeToggle.hero.whyItMatters.understandingImpact.resultsTable.aboutHeader.aboutGrid.whatWeMeasure.blogHeader.blogList.careersHeader.careersBenefits.openPositions.contactHeader.contactForm.faqHeader.faqList.pricingHeader.pricingTiers.productsHeader.productsGrid.settingsHeader.profileSection.preferencesSection.apiAccessSection.settingsFooter.teamHeader.teamGrid.common.home.about.blog.careers.contact.faq.pricing.products.settings.team".split("."), xt = /* @__PURE__ */ new Map();
async function St(e, t) {
	let n = e || "en";
	try {
		return (await yt(Object.assign({
		...
		return n === "en" ? {} : (await yt(Object.assign({
			"./locales/en/about.json": () => import("./about-CYSxSXDm.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-D4vPffNV.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-D1fuBqnE.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-ByHxIFcg.js"),
...
async function Ct(e) {
	let t = e || "en", n = xt.get(t);
	if (n) return n;
	let r = await Promise.all(bt.map(async (e) => [e, await St(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return xt.set(t, o), o;
