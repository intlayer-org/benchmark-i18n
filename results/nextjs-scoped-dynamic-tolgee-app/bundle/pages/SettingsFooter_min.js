...
var Q = (t) => {
	...
	let { t: n } = it();
	return e.createElement(st, Object.assign({ t: n }, t));
};
function lt(e) {
	return l(ct, { ...e });
}
...
var $ = dt().init(), ft = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
...
function ht({ children: e, locale: t, staticData: n }) {
...
}, _t = /* @__PURE__ */ "route.header.footer.themeToggle.hero.whyItMatters.understandingImpact.resultsTable.aboutHeader.aboutGrid.whatWeMeasure.blogHeader.blogList.careersHeader.careersBenefits.openPositions.contactHeader.contactForm.faqHeader.faqList.pricingHeader.pricingTiers.productsHeader.productsGrid.settingsHeader.profileSection.preferencesSection.apiAccessSection.settingsFooter.teamHeader.teamGrid.common.home.about.blog.careers.contact.faq.pricing.products.settings.team".split("."), vt = /* @__PURE__ */ new Map();
async function yt(e, t) {
	let n = e || "en";
	try {
		return (await gt(Object.assign({
		...
		return n === "en" ? {} : (await gt(Object.assign({
			"./locales/en/about.json": () => import("./about-CYSxSXDm.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-D4vPffNV.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-D1fuBqnE.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-ByHxIFcg.js"),
...
async function bt(e) {
	let t = e || "en", n = vt.get(t);
	if (n) return n;
	let r = await Promise.all(_t.map(async (e) => [e, await yt(t, e)])), i = Object.fromEntries(r), a = i.common ?? {}, o = {
		...i,
		...a
	};
	return vt.set(t, o), o;
...
async function St({ children: e }) {
	return l(ht, {
		locale: xt,
		staticData: await bt(xt),
		children: e
	});
}
function Ct() {
	return l(St, { children: l(ut, {}) });
}
