...
var Te = () => {
	...
	return t;
}, Ee = 0, L = 1, De = 2, Oe = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Ee ? r = "Empty parameter" : e === L ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function ke(e) {
	return /\s/.test(e);
}
var R = 0, z = 1, B = 2, V = 3, H = 4, Ae = /* @__PURE__ */ new Set([
	B,
	z,
	R
]), U = "'", je = /* @__PURE__ */ new Set([
	"{",
	"}",
	U
...
function Ne(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case R:
			...
			break;
		case z:
			je.has(i) ? (n = n.slice(0, -1) + i, t = B) : (n += i, t = R);
			break;
		case B:
			i === U ? t = R : (n += i, t = B);
			break;
		case V:
			i === "}" ? (d(), t = R) : ke(i) ? r !== "" && (d(), t = H) : (u(), t = V);
			break;
		case H: i == "}" ? t = R : ke(i) ? t = H : c(L);
	}
...
(x = console.assert) == null || x.call(console, Be), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ve(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, Xe = 3e3, Ze = 200, Qe = 0, K = /* @__PURE__ */ new Map(), $e = !1, q, J;
...
var tt = (e) => new G("unavailable", `the Tolgee browser extension did not answer ${e} in time`), nt = () => `${Date.now()}-${Qe++}-${Math.random()}`;
function rt() {
...
function it(e) {
	return q ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: qe }, window.origin), i = () => {
			clearInterval(a), at(), J = void 0, n(new G("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Y = "__tolgee_", St = `${Y}apiKey`, Ct = `${Y}apiUrl`, wt = `${Y}branch`, Tt = `${Y}projectId`, Et = `${Y}session`, Dt = "tolgee-in-context-tools.umd.min.js", Ot = "@tolgee/in-context-tools", kt = "InContextTools", At = "https://cdn.jsdelivr.net/npm", jt = null;
function Mt(e) {
...
function Rt() {
	...
	if (i && r) return b(y({}, a), { transport: ot() });
}
function zt() {
	let e = [];
...
var Kt = { useSuspense: !1 }, qt, Jt = () => (qt ||= e.createContext(void 0), qt), X = void 0, Yt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	return u("section", {
		...
		children: [
			l("h2", {
				...
				children: l(Q, { keyName: "understandingImpact.understandingTheImpact" })
			}),
			u("div", {
				...
				children: [
					l("h3", {
						...
						children: l(Q, { keyName: "understandingImpact.whyASingleLargeJson" })
					}),
					l("p", {
						className: "text-sm text-muted-foreground",
						children: l(Q, { keyName: "understandingImpact.manyI18nLibrariesStore" })
					}),
					u("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							l("li", { children: l(Q, { keyName: "understandingImpact.theJsonMustBeParsed" }) }),
							l("li", { children: l(Q, { keyName: "understandingImpact.contextBasedArchitecturesCan" }) }),
							l("li", { children: l(Q, { keyName: "understandingImpact.duringServerSideRenderingThe" }) })
						]
					})
				]
			}),
			u("div", {
				...
				children: [
					l("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: l(Q, { keyName: "understandingImpact.theTradeOffsOfDynamic" })
					}),
					l("p", {
						className: "text-sm text-muted-foreground",
						children: l(Q, { keyName: "understandingImpact.splittingTranslationsIntoPerRoute" })
					}),
					u("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							u("li", { children: [
								l("strong", {
									...
									children: l(Q, { keyName: "understandingImpact.waterfallRequests" })
								}),
								" ",
								l(Q, { keyName: "understandingImpact.theAppMustFirstLoad" })
							] }),
							u("li", { children: [
								l("strong", {
									className: "text-foreground",
									children: l(Q, { keyName: "understandingImpact.flashOfUntranslatedContent" })
								}),
								" ",
								l(Q, { keyName: "understandingImpact.usersMayBrieflySeeTranslation" })
							] }),
							u("li", { children: [
								l("strong", {
									className: "text-foreground",
									children: l(Q, { keyName: "understandingImpact.cacheInvalidation" })
								}),
								" ",
								l(Q, { keyName: "understandingImpact.updatingTranslationsRequiresCache" })
							] })
						]
					})
				]
			...
			u("div", {
				...
				children: [l("h3", {
					className: "mb-2 text-lg font-semibold text-foreground",
					children: l(Q, { keyName: "understandingImpact.whatThisBenchmarkMeasures" })
				}), l("p", {
					className: "text-sm text-muted-foreground",
					children: l(Q, { keyName: "understandingImpact.thisTestAppProvidesA" })
				})]
			})
		]
	});
...
var cn = on().init(), ln = ({ language: e, staticData: t, children: n }) => {
	let r = d(), a = o(() => ({ [e]: sn(e, t[e] ?? {}) }), [e, t]);
	return i(() => {
		let { unsubscribe: e } = cn.on("permanentChange", () => {
			r.refresh();
		});
		return () => {
			e();
...
function fn({ children: e, locale: t, staticData: n }) {
...
async function mn(e, t) {
	...
	try {
		return (await pn(Object.assign({
			...
			"./locales/en/about.json": () => import("./about-5imwar27.js"),
			"./locales/en/aboutGrid.json": () => import("./aboutGrid-D0ch0d1U.js"),
			"./locales/en/aboutHeader.json": () => import("./aboutHeader-XgMOjWKN.js"),
			"./locales/en/apiAccessSection.json": () => import("./apiAccessSection-9iiMnqMQ.js"),
			"./locales/en/blog.json": () => import("./blog-Btsrcajj.js"),
			"./locales/en/blogHeader.json": () => import("./blogHeader-BorXaaA1.js"),
			"./locales/en/blogList.json": () => import("./blogList-DD3QkOUN.js"),
			"./locales/en/careers.json": () => import("./careers-CeE7nCbI.js"),
			"./locales/en/careersBenefits.json": () => import("./careersBenefits-DckUqrTL.js"),
			"./locales/en/careersHeader.json": () => import("./careersHeader-DP4mAwtf.js"),
			"./locales/en/common.json": () => import("./common-DU1y4bDy.js"),
			"./locales/en/contact.json": () => import("./contact-EN6Ks949.js"),
			"./locales/en/contactForm.json": () => import("./contactForm-0_Ggrjce.js"),
			"./locales/en/contactHeader.json": () => import("./contactHeader-xZwhz1YQ.js"),
			"./locales/en/faq.json": () => import("./faq-CKGm0twQ.js"),
			"./locales/en/faqHeader.json": () => import("./faqHeader-jxnlqMjA.js"),
			"./locales/en/faqList.json": () => import("./faqList-CEsi_Zym.js"),
			"./locales/en/footer.json": () => import("./footer-vpxWCQ2J.js"),
			"./locales/en/header.json": () => import("./header-Ef70-Wt9.js"),
			"./locales/en/hero.json": () => import("./hero-DojolOut.js"),
			"./locales/en/home.json": () => import("./home-XcP9fIjD.js"),
			"./locales/en/mockBanner.json": () => import("./mockBanner-B9ls9j9y.js"),
			"./locales/en/openPositions.json": () => import("./openPositions-DcvLNfbf.js"),
			"./locales/en/preferencesSection.json": () => import("./preferencesSection-C2ZFdq4U.js"),
			"./locales/en/pricing.json": () => import("./pricing-CIELH6yi.js"),
			"./locales/en/pricingHeader.json": () => import("./pricingHeader-QD_lBb1T.js"),
			"./locales/en/pricingTiers.json": () => import("./pricingTiers-5YLP9chI.js"),
			"./locales/en/products.json": () => import("./products-haBQH7AV.js"),
			"./locales/en/productsGrid.json": () => import("./productsGrid-fMYSi9v_.js"),
			"./locales/en/productsHeader.json": () => import("./productsHeader-D7uaAXp0.js"),
			"./locales/en/profileSection.json": () => import("./profileSection-CYXOIR2X.js"),
			"./locales/en/resultsTable.json": () => import("./resultsTable-BXJA82t9.js"),
			"./locales/en/route.json": () => import("./route-oX8KrxCA.js"),
			"./locales/en/settings.json": () => import("./settings-BdxPpq-N.js"),
			"./locales/en/settingsFooter.json": () => import("./settingsFooter-ChM304JE.js"),
			"./locales/en/settingsHeader.json": () => import("./settingsHeader-sKm0ePBl.js"),
			"./locales/en/team.json": () => import("./team-Bg-FVBQV.js"),
			"./locales/en/teamGrid.json": () => import("./teamGrid-BX5JG97G.js"),
			"./locales/en/teamHeader.json": () => import("./teamHeader-BeoPnrT9.js"),
			"./locales/en/themeToggle.json": () => import("./themeToggle-DIh2jSzO.js"),
			"./locales/en/understandingImpact.json": () => import("./understandingImpact-_8BDIjgH.js"),
			"./locales/en/whatWeMeasure.json": () => import("./whatWeMeasure-OWt-WY2u.js"),
			"./locales/en/whyItMatters.json": () => import("./whyItMatters-BdA9Urzf.js"),
...
async function hn(e, t = ["common"]) {
	let n = e || "en", r = await Promise.all(t.map(async (e) => [e, await mn(n, e)]));
	return Object.fromEntries(r);
}
var gn = "en";
async function _n({ children: e }) {
	let t = await hn(gn);
	return l(fn, {
		locale: gn,
		staticData: t,
