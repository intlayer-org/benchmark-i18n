	...
	const metrics = [
		{
			...
			desc: t("whatWeMeasure.theAdditionalJavascriptBytes")
		},
		{
			metric: t("whatWeMeasure.renderingOverhead"),
			desc: t("whatWeMeasure.howMuchExtraTimeTheLibraryAdds")
		},
		{
			metric: t("whatWeMeasure.hydrationCost"),
			desc: t("whatWeMeasure.duringSsrTranslationDataIsSerialized")
		},
		{
		...
		},
		{
			...
			desc: t("whatWeMeasure.howFastTheAppCanSwitchFromOne")
		}
	];
	return jsxs("section", {
		...
		children: [jsx("h2", {
			...
			children: jsx(T, { keyName: "whatWeMeasure.whatWeMeasure" })
		}), jsx("ul", {
			className: "space-y-4",
