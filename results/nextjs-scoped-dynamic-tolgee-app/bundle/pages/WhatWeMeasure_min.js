	...
	let { t: e } = an(), t = [
		{
			...
			desc: e("whatWeMeasure.theAdditionalJavascriptBytes")
		},
		{
			metric: e("whatWeMeasure.renderingOverhead"),
			desc: e("whatWeMeasure.howMuchExtraTimeTheLibraryAdds")
		},
		{
			metric: e("whatWeMeasure.hydrationCost"),
			desc: e("whatWeMeasure.duringSsrTranslationDataIsSerialized")
		},
		{
		...
		},
		{
			...
			desc: e("whatWeMeasure.howFastTheAppCanSwitchFromOne")
		}
	];
	return u("section", {
		...
		children: [l("h2", {
			...
			children: l(on, { keyName: "whatWeMeasure.whatWeMeasure" })
		}), l("ul", {
			className: "space-y-4",
