...
function l({ children: a, locale: o }) {
	let [l] = n(() => typeof performance < "u" ? performance.now() : 0);
	return t(() => {
		c("AppRoot", l);
	}, [l]), e(() => {
...
var u = a(((e, t) => {
  ...
  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
	...
	var t = o("react/jsx-runtime"), n = o("react"), r = d(), i = f();
	function a(e) {
	...
	var t = o("react/jsx-runtime"), n = o("react"), r = d(), i = p();
	function a(e) {
		var t = Object.create(null);
		return e && Object.keys(e).forEach(function(n) {
			if (n !== "default") {
