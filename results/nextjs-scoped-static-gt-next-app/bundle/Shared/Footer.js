			...
			children: [jsxs("div", {
				...
				children: [
					jsxs("div", { children: [jsx("h3", {
						...
						children: jsx(import_index_client.T, { children: "i18n Benchmark" })
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
						children: jsx(import_index_client.T, { children: "An open-source test application for measuring the real-world impact of internationalization libraries on bundle size, loading time, and app reactivity." })
					})] }),
					jsxs("div", { children: [jsx("h3", {
						className: "mb-2 text-sm font-semibold text-foreground",
						children: jsx(import_index_client.T, { children: "Resources" })
					}), jsx("ul", {
						className: "space-y-1",
						children: [
							{
								label: jsx(import_index_client.T, { children: "GitHub" }),
								href: "https://github.com/intlayer-org/benchmark-i18n",
								isInternal: false
							},
							{
								label: jsx(import_index_client.T, { children: "Methodology" }),
								href: "/about",
								isInternal: true
							},
							{
								label: jsx(import_index_client.T, { children: "Contributing" }),
								href: "/contact",
								isInternal: true
							}
					...
					jsxs("div", { children: [jsx("h3", {
						className: "mb-2 text-sm font-semibold text-foreground",
						children: jsx(import_index_client.T, { children: "Contact" })
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
				...
				children: jsx(import_index_client.T, { children: "i18n Benchmark — Open-source project. Built with Next.js." })
			})]
		})
	});
}
