...
var f = ({ href: e, children: t, ...n }) => {
	let a = i().locale ?? "en";
	return e == null || typeof e != "string" || u(e) ? o(r, {
		href: e,
		prefetch: !1,
		...n,
		children: t
  ...
  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
	...
	var t = l("react/jsx-runtime"), n = l("react"), r = m(), i = h();
	function a(e) {
	...
	var t = l("react/jsx-runtime"), n = l("react"), r = m(), i = g();
	function a(e) {
		var t = Object.create(null);
		return e && Object.keys(e).forEach(function(n) {
			if (n !== "default") {
			...
			children: [s("div", {
				...
				children: [
					s("div", { children: [o("h3", {
						...
						children: o(b.T, { children: "i18n Benchmark" })
					}), o("p", {
						className: "text-sm text-muted-foreground",
						children: o(b.T, { children: "An open-source test application for measuring the real-world impact of internationalization libraries on bundle size, loading time, and app reactivity." })
					})] }),
					s("div", { children: [o("h3", {
						className: "mb-2 text-sm font-semibold text-foreground",
						children: o(b.T, { children: "Resources" })
					}), o("ul", {
						className: "space-y-1",
						children: [
							{
								label: o(b.T, { children: "GitHub" }),
								href: "https://github.com/intlayer-org/benchmark-i18n",
								isInternal: !1
							},
							{
								label: o(b.T, { children: "Methodology" }),
								href: "/about",
								isInternal: !0
							},
							{
								label: o(b.T, { children: "Contributing" }),
								href: "/contact",
								isInternal: !0
							}
						].map((e) => o("li", { children: e.isInternal ? o(f, {
							href: e.href,
					...
					s("div", { children: [o("h3", {
						className: "mb-2 text-sm font-semibold text-foreground",
						children: o(b.T, { children: "Contact" })
					}), o("p", {
						className: "text-sm text-muted-foreground",
				...
				children: o(b.T, { children: "i18n Benchmark — Open-source project. Built with Next.js." })
			})]
		})
	});
}
...
function w({ children: r, locale: i }) {
