...
var h = ({ href: e, children: t, ...n }) => {
	let a = i().locale ?? "en";
	return e == null || typeof e != "string" || p(e) ? c(r, {
		href: e,
		prefetch: !1,
		...n,
		children: t
	...
	function k(e) {
		...
		var t = {};
		if (e != null) for (var n = O(e), r = 0; r < n.length; r++) n[r] !== "default" && m(t, e, n[r]);
		return D(t, e), t;
	}
	function A(e) {
  ...
  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
	...
	function xi(e, t, n, i) {
		return f(this, void 0, void 0, function() {
			var a, o, s, c, l, u, d, f, m, h, g, _, v, y;
			return p(this, function(p) {
				switch (p.label) {
					case 0:
						for (a = Array.isArray(e), o = a ? [] : void 0, s = {}, c = a ? e.map(function(e) {
							return [void 0, e];
						}) : Object.entries(e), l = 0, u = c; l < u.length; l++) d = u[l], f = d[0], m = d[1], g = (h = typeof m == "string" ? { source: m } : m).source, _ = h.metadata, v = f ?? _?.hash ?? vi(r({
							source: g,
					...
					case 1: return y = p.sent(), o ? [2, o.map(function(e) {
						return y[e] ?? {
							success: !1,
	...
	function wi(e, t) {
		return f(this, arguments, void 0, function(e, t, n) {
			var r, i, a, o, s, c, l, u, d, f, m, h, g;
			return n === void 0 && (n = {}), p(this, function(p) {
				switch (p.label) {
					...
					case 1:
						for (l = p.sent(), u = 0, d = l; u < d.length; u++) (g = d[u]) && c.push.apply(c, g);
						return [3, 6];
					case 2: f = 0, m = s, p.label = 3;
					case 3: return f < m.length ? (h = m[f], [4, t(h)]) : [3, 6];
					case 4: (g = p.sent()) && c.push.apply(c, g), p.label = 5;
					case 5: return f++, [3, 3];
					case 6: return [2, {
						data: c,
						count: c.length,
	...
	function Oi(e, t) {
		return f(this, arguments, void 0, function(e, t, n) {
			var r = this;
			return n === void 0 && (n = {}), p(this, function(i) {
				switch (i.label) {
			...
			return p(this, function(p) {
				switch (p.label) {
					case 0:
						...
						})), l = new Set(o), p.label = 1;
					case 1: return l.size > 0 ? [4, Ii(Array.from(l), n)] : [3, 4];
					case 2:
						for (u = p.sent(), d = 0, f = u; d < f.length; d++) (m = f[d]).status === "completed" || m.status === "failed" || m.status === "unknown" ? (c.set(m.jobId, r({
							jobId: m.jobId,
							status: m.status
						}, m.error ? { error: m.error } : {})), l.delete(m.jobId)) : c.set(m.jobId, {
							jobId: m.jobId,
							status: m.status
						});
	...
	function Ri(e) {
		return f(this, arguments, void 0, function(e, t, n) {
			var r;
			return t === void 0 && (t = {}), p(this, function(i) {
				return r = {
	...
	function Hi(e, t) {
		return f(this, arguments, void 0, function(e, t, n, r) {
	...
	var Wi = function() {
		...
		return e.prototype.setConfig = function(e) {
			...
			return f(this, arguments, void 0, function(e, t) {
				return t === void 0 && (t = {}), p(this, function(n) {
					switch (n.label) {
			...
			return f(this, arguments, void 0, function(e, t, n) {
				return n === void 0 && (n = {}), p(this, function(r) {
					switch (r.label) {
			...
			return f(this, arguments, void 0, function(e, t) {
				var n, i = this;
				return t === void 0 && (t = {}), p(this, function(a) {
					switch (a.label) {
			...
			return f(this, arguments, void 0, function(e, t) {
				var n;
				return t === void 0 && (t = {}), p(this, function(r) {
					switch (r.label) {
	...
	var t = f("react/jsx-runtime"), n = f("react"), r = _(), i = v();
	function a(e) {
	...
	function c(e = {}, t) {
		return e.name ? e.name : `_gt_${s[t] || "value"}_${e["data-_gt"]?.id}`;
	}
	var l = function(e, t) {
		...
		for (var t = {}, n = 0, r = e; n < r.length; n++) {
			...
			switch (i.stem) {
				...
				case "KK":
					...
					continue;
				case "scientific":
					t = d(d(d({}, t), { notation: "scientific" }), i.options.reduce(function(e, t) {
						return d(d({}, e), ve(t));
					}, {}));
					continue;
				case "engineering":
					t = d(d(d({}, t), { notation: "engineering" }), i.options.reduce(function(e, t) {
						return d(d({}, e), ve(t));
					}, {}));
					continue;
				case "notation-simple":
			...
			if (me.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
				...
				var a = i.options[0];
				a === "w" ? t = d(d({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = d(d({}, t), he(a)));
			} else if (fe.test(i.stem)) t = d(d({}, t), he(i.stem));
			else {
				var o = ge(i.stem);
				o && (t = d(d({}, t), o));
				var s = _e(i.stem);
			...
			switch (a) {
				...
				case "time":
					...
					if (this.bumpIf(",")) {
						...
						if ((_ = this.parseSimpleArgStyleIfPossible()).err) return _;
						if ((p = Fe(_.val)).length === 0) return this.error(H.EXPECT_ARGUMENT_STYLE, J(this.clonePosition(), this.clonePosition()));
						s = {
							style: p,
					...
					if (s && Ae(s?.style, "::", 0)) {
						...
						var p = {
							...
							parsedOptions: this.shouldParseSkeletons ? ce(f) : {}
						};
						return {
							val: {
				...
				case "select":
					var m = this.clonePosition();
					if (this.bumpSpace(), !this.bumpIf(",")) return this.error(H.EXPECT_SELECT_ARGUMENT_OPTIONS, J(m, d({}, m)));
					this.bumpSpace();
					var h = this.parseIdentifierIfPossible(), g = 0;
	...
	var zr = {
		...
		if (t["data-_gt"]) {
			...
			if (r === "variable") {
				let n = e.variableType || "variable", r = c(t, n), i = rr(n);
				return {
					i: e.id,
					k: r,
					v: i
	...
	var Ui;
	try {
		Ui = Function("o", "k", "return o[k]")(o, "use");
	} catch {}
	var Wi = Ui;
	...
	var t = f("react/jsx-runtime"), n = f("react"), r = _(), i = y();
	function a(e) {
		var t = Object.create(null);
		return e && Object.keys(e).forEach(function(n) {
			if (n !== "default") {
	...
	function c(e, t) {
		...
		s(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
	}
	var l = function() {
		...
		for (var t = {}, n = 0, r = e; n < r.length; n++) {
			...
			switch (i.stem) {
				...
				case "KK":
					...
					continue;
				case "scientific":
					t = l(l(l({}, t), { notation: "scientific" }), i.options.reduce(function(e, t) {
						return l(l({}, e), _e(t));
					}, {}));
					continue;
				case "engineering":
					t = l(l(l({}, t), { notation: "engineering" }), i.options.reduce(function(e, t) {
						return l(l({}, e), _e(t));
					}, {}));
					continue;
				case "notation-simple":
			...
			if (pe.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
				...
				var a = i.options[0];
				a === "w" ? t = l(l({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = l(l({}, t), me(a)));
			} else if (de.test(i.stem)) t = l(l({}, t), me(i.stem));
			else {
				var o = he(i.stem);
				o && (t = l(l({}, t), o));
				var s = ge(i.stem);
		...
		return e.prototype.parse = function() {
			...
			switch (a) {
				...
				case "time":
					...
					if (s && ke(s?.style, "::", 0)) {
						var d = Ne(s.style.slice(2));
						if (a === "number") return (_ = this.parseNumberSkeletonFromString(d, s.styleLocation)).err ? _ : {
							val: {
								type: V.number,
								value: n,
								location: u,
						...
						if (d.length === 0) return this.error(B.EXPECT_DATE_TIME_SKELETON, u);
						var f = d;
						this.locale && (f = function(e, t) {
							for (var n = "", r = 0; r < e.length; r++) {
								var i = e.charAt(r);
						...
						var p = {
							...
							pattern: f,
							location: s.styleLocation,
							parsedOptions: this.shouldParseSkeletons ? se(f) : {}
						};
						return {
							val: {
				...
				case "select":
					var m = this.clonePosition();
					if (this.bumpSpace(), !this.bumpIf(",")) return this.error(B.EXPECT_SELECT_ARGUMENT_OPTIONS, q(m, l({}, m)));
					this.bumpSpace();
					var h = this.parseIdentifierIfPossible(), g = 0;
					if (a !== "select" && h.value === "offset") {
	...
	(function(e) {
	...
	}), e.ClientProvider = function({ children: e, dictionary: a, dictionaryTranslations: s, translations: c, locale: l, region: u, _versionId: d, defaultLocale: f, translationRequired: p, dialectTranslationRequired: m, locales: h = [], renderSettings: g, projectId: _, devApiKey: v, runtimeUrl: y, developmentApiEnabled: b, resetLocaleCookieName: x, localeCookieName: S = "generaltranslation.locale", regionCookieName: C = "generaltranslation.region", customMapping: w, environment: T, reloadServer: E }) {
		...
		let [M, N] = n.useState(s || {}), [P, F] = n.useState(a || {});
		n.useEffect(() => {
			D.current && N(s);
		}, [s]), n.useEffect(() => {
			D.current && F(a);
...
function E() {
	...
	let a = t === "auto" ? "Theme mode: auto (system). Click to switch to light mode." : `Theme mode: ${t}. Click to switch mode.`;
	return c("button", {
		type: "button",
		onClick: i,
		"aria-label": a,
		...
		children: t === "auto" ? c(C.T, { children: "Theme: Auto" }) : t === "dark" ? c(C.T, { children: "Theme: Dark" }) : c(C.T, { children: "Theme: Light" })
	});
}
var D = [
	"en",
...
function A() {
	...
	let [e, t] = n(!1), r = i(), o = a(), s = r.locale ?? "en", d = [
		{
			href: "/products",
			label: c(C.T, { children: "Products" })
		},
		{
			href: "/pricing",
			label: c(C.T, { children: "Pricing" })
		},
		{
			href: "/team",
			label: c(C.T, { children: "Team" })
		},
		{
			href: "/blog",
			label: c(C.T, { children: "Blog" })
		},
		{
			href: "/careers",
			label: c(C.T, { children: "Careers" })
		},
		{
			href: "/faq",
			label: c(C.T, { children: "FAQ" })
		},
		{
			href: "/contact",
			label: c(C.T, { children: "Contact" })
		},
		{
			href: "/settings",
			label: c(C.T, { children: "Settings" })
		}
	];
	return c("header", {
			...
			children: [l("div", {
				...
				children: [c(h, {
					...
					children: [
						c(h, {
							href: "/",
							className: `nav-link${((e) => o === m(e, s))("/") ? " is-active" : ""}`,
							children: c(C.T, { children: "Home" })
						}),
						c(h, {
							href: "/about",
							...
							children: c(C.T, { children: "Methodology" })
						}),
						l("div", {
							className: "relative",
							children: [l("button", {
								...
								onMouseLeave: () => t(!1),
								onClick: () => t(!e),
								children: [c(C.T, { children: "Mock Pages" }), c(u, {
									size: 14,
