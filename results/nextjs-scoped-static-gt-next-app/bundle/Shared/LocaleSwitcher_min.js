...
var c = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), l = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
var h = c(((e, t) => {
  ...
  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
	...
	var t = l("react/jsx-runtime"), n = l("react"), r = g(), i = _();
	function a(e) {
	...
	function K(e) {
		for (var t = {}, n = 0, r = e; n < r.length; n++) {
			...
			if (me.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
				...
				var a = i.options[0];
				a === "w" ? t = f(f({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = f(f({}, t), he(a)));
			} else if (fe.test(i.stem)) t = f(f({}, t), he(i.stem));
			else {
				var o = ge(i.stem);
				o && (t = f(f({}, t), o));
				var s = _e(i.stem);
	...
	var Re = function() {
		...
		return e.prototype.parse = function() {
			...
			switch (a) {
				...
				case "select":
					var m = this.clonePosition();
					if (this.bumpSpace(), !this.bumpIf(",")) return this.error(H.EXPECT_SELECT_ARGUMENT_OPTIONS, J(m, f({}, m)));
					this.bumpSpace();
					var h = this.parseIdentifierIfPossible(), g = 0;
	...
	var t = l("react/jsx-runtime"), n = l("react"), r = g(), i = v();
	function a(e) {
		var t = Object.create(null);
		return e && Object.keys(e).forEach(function(n) {
			if (n !== "default") {
		...
		for (var t = {}, n = 0, r = e; n < r.length; n++) {
			...
			switch (i.stem) {
				...
				case "KK":
					...
					continue;
				case "scientific":
					t = u(u(u({}, t), { notation: "scientific" }), i.options.reduce(function(e, t) {
						return u(u({}, e), _e(t));
					}, {}));
					continue;
				case "engineering":
					t = u(u(u({}, t), { notation: "engineering" }), i.options.reduce(function(e, t) {
						return u(u({}, e), _e(t));
					}, {}));
					continue;
				case "notation-simple":
			...
			if (pe.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
				...
				var a = i.options[0];
				a === "w" ? t = u(u({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = u(u({}, t), me(a)));
			} else if (de.test(i.stem)) t = u(u({}, t), me(i.stem));
			else {
				var o = he(i.stem);
				o && (t = u(u({}, t), o));
				var s = ge(i.stem);
			...
			switch (a) {
				...
				case "time":
					...
					if (s && ke(s?.style, "::", 0)) {
						...
						if (d.length === 0) return this.error(B.EXPECT_DATE_TIME_SKELETON, l);
						var f = d;
						this.locale && (f = function(e, t) {
							for (var n = "", r = 0; r < e.length; r++) {
								var i = e.charAt(r);
				...
				case "select":
					var m = this.clonePosition();
					if (this.bumpSpace(), !this.bumpIf(",")) return this.error(B.EXPECT_SELECT_ARGUMENT_OPTIONS, q(m, u({}, m)));
					this.bumpSpace();
					var h = this.parseIdentifierIfPossible(), g = 0;
					if (a !== "select" && h.value === "offset") {
