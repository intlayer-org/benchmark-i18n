...
${e.join("\n")}`;
	...
	children: i(m.T, { children: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." })
});
function g() {
	if (!(typeof window > "u")) {
...
function v({ children: a, locale: o }) {
