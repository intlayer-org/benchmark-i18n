...
function _() {
	...
	let o = t === "auto" ? "Theme mode: auto (system). Click to switch to light mode." : `Theme mode: ${t}. Click to switch mode.`;
	return i("button", {
		type: "button",
		onClick: a,
		"aria-label": o,
		...
		children: t === "auto" ? i(m.T, { children: "Theme: Auto" }) : t === "dark" ? i(m.T, { children: "Theme: Dark" }) : i(m.T, { children: "Theme: Light" })
	});
}
function v() {
	if (!(typeof window > "u")) {
