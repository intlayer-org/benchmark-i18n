...
function ApiAccessSection() {
	...
	return jsxs("section", {
		...
		children: [jsx("h2", {
			...
			children: jsx(import_index_client.T, { children: "API Access" })
		}), jsxs("div", { children: [
			jsx("label", {
				htmlFor: apiKeyId,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: jsx(import_index_client.T, { children: "API Key" })
			}),
			jsxs("div", {
				...
				children: [jsx("input", {
					...
					children: jsx(import_index_client.T, { children: "Copy" })
				})]
			}),
			jsx("p", {
				className: "mt-1 text-xs text-muted-foreground",
				children: jsx(import_index_client.T, { children: "Use this key to access the benchmarking API programmatically." })
			})
		] })]
	});
}
