...
var s = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), c = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
  ...
  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
	...
	var t = c("react/jsx-runtime"), n = c("react"), r = u(), i = d();
	function a(e) {
	...
	var t = c("react/jsx-runtime"), n = c("react"), r = u(), i = f();
	function a(e) {
		var t = Object.create(null);
		return e && Object.keys(e).forEach(function(n) {
			if (n !== "default") {
	...
	function ve(e) {
		for (var t = {}, n = 0, r = e; n < r.length; n++) {
			...
			if (pe.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
				...
				var a = i.options[0];
				a === "w" ? t = d(d({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = d(d({}, t), me(a)));
			} else if (de.test(i.stem)) t = d(d({}, t), me(i.stem));
			else {
				var o = he(i.stem);
				o && (t = d(d({}, t), o));
				var s = ge(i.stem);
	...
	var Le = function() {
		...
		return e.prototype.parse = function() {
			...
			switch (a) {
				...
				case "select":
					var m = this.clonePosition();
					if (this.bumpSpace(), !this.bumpIf(",")) return this.error(B.EXPECT_SELECT_ARGUMENT_OPTIONS, q(m, d({}, m)));
					this.bumpSpace();
					var h = this.parseIdentifierIfPossible(), g = 0;
					if (a !== "select" && h.value === "offset") {
...
function _() {
	...
	return o("section", {
		...
		children: [a("h2", {
			...
			children: a(g.T, { children: "API Access" })
		}), o("div", { children: [
			a("label", {
				htmlFor: e,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: a(g.T, { children: "API Key" })
			}),
			o("div", {
				...
				children: [a("input", {
					...
					children: a(g.T, { children: "Copy" })
				})]
			}),
			a("p", {
				className: "mt-1 text-xs text-muted-foreground",
				children: a(g.T, { children: "Use this key to access the benchmarking API programmatically." })
			})
		] })]
	});
}
...
function b({ children: t, locale: o }) {
	let [s] = r(() => typeof performance < "u" ? performance.now() : 0);
	return n(() => {
		y("AppRoot", s);
	}, [s]), e(() => {
