...
function g() {
	return i("div", {
		...
		children: [
			{
				title: i(h.T, { children: "Comparing i18n Libraries in 2026: A Deep Dive" }),
				date: i(h.T, { children: "March 15, 2026" }),
				excerpt: i(h.T, { children: "We tested 12 different internationalization libraries across performance, bundle size, and DX. Here are the surprising results." }),
				category: i(h.T, { children: "Benchmark" })
			},
			{
				title: i(h.T, { children: "How to Reduce Your i18n Bundle by 60%" }),
				date: i(h.T, { children: "March 8, 2026" }),
				excerpt: i(h.T, { children: "Practical strategies for optimizing translation bundles including lazy loading, code splitting, and compile-time optimizations." }),
				category: i(h.T, { children: "Tutorial" })
			},
			{
				title: i(h.T, { children: "The State of Internationalization in React" }),
				date: i(h.T, { children: "February 28, 2026" }),
				excerpt: i(h.T, { children: "An overview of the current i18n ecosystem in React, covering trends, emerging patterns, and community preferences." }),
				category: i(h.T, { children: "Analysis" })
			},
			{
				title: i(h.T, { children: "Migrating from react-i18next to Lingui" }),
				date: i(h.T, { children: "February 15, 2026" }),
				excerpt: i(h.T, { children: "A step-by-step guide on migrating a production app with 50,000 translation keys from react-i18next to Lingui." }),
				category: i(h.T, { children: "Tutorial" })
			},
			{
				title: i(h.T, { children: "Server Components and i18n: What Changes?" }),
				date: i(h.T, { children: "February 1, 2026" }),
				excerpt: i(h.T, { children: "React Server Components introduce new patterns for internationalization. We explore the implications and best practices." }),
				category: i(h.T, { children: "Analysis" })
			},
			{
				title: i(h.T, { children: "Benchmark Methodology: How We Test" }),
				date: i(h.T, { children: "January 20, 2026" }),
				excerpt: i(h.T, { children: "A transparent look at our benchmarking methodology, including test environments, statistical methods, and reproducibility." }),
				category: i(h.T, { children: "Meta" })
			}
		].map((e, t) => a("article", {
			...
			children: [
				...
				i("button", {
					...
					children: i(h.T, { children: "Read More →" })
				})
			]
		}, t))
	});
