...
function CareersBenefits() {
	return jsx("div", {
		...
		children: [
			{
				label: jsx(import_index_client.T, { children: "Remote-first" }),
				value: jsx(import_index_client.T, { children: "Work from anywhere in the world" })
			},
			{
				label: jsx(import_index_client.T, { children: "Competitive pay" }),
				value: jsx(import_index_client.T, { children: "Top-of-market compensation" })
			},
			{
				label: jsx(import_index_client.T, { children: "Open source time" }),
				value: jsx(import_index_client.T, { children: "20% time for OSS contributions" })
			}
		].map((b) => jsxs("div", {
