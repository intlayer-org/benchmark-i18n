...
function g() {
	return i("div", {
		...
		children: [
			{
				label: i(h.T, { children: "Remote-first" }),
				value: i(h.T, { children: "Work from anywhere in the world" })
			},
			{
				label: i(h.T, { children: "Competitive pay" }),
				value: i(h.T, { children: "Top-of-market compensation" })
			},
			{
				label: i(h.T, { children: "Open source time" }),
				value: i(h.T, { children: "20% time for OSS contributions" })
			}
		].map((e) => a("div", {
