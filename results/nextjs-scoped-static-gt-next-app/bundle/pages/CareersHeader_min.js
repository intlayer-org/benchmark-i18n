...
${e.join("\n")}`;
	...
	children: i(h.T, { children: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." })
});
function _() {
	return a(r, { children: [
		i(g, {}),
		i("h1", {
			...
			children: i(h.T, { children: "Careers" })
		}),
		i("p", {
			className: "mb-4 text-muted-foreground",
			children: i(h.T, { children: "Join our mission to improve the internationalization ecosystem. We're a remote-first team that values impact, transparency, and continuous learning." })
		})
	] });
}
function v() {
...
function b({ children: a, locale: o }) {
