	...
	return o("form", {
		...
		children: [
			...
			o("div", { children: [a("label", {
				htmlFor: r,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: a(g.T, { children: "Topic" })
			}), o("select", {
				id: r,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				children: [
					a("option", { children: a(g.T, { children: "Bug Report" }) }),
					a("option", { children: a(g.T, { children: "New Benchmark Idea" }) }),
					a("option", { children: a(g.T, { children: "Methodology Question" }) }),
					a("option", { children: a(g.T, { children: "Contribution" }) }),
					a("option", { children: a(g.T, { children: "Other" }) })
				]
			})] }),
			o("div", { children: [a("label", {
				htmlFor: i,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: a(g.T, { children: "Message" })
			}), a("textarea", {
				id: i,
				rows: 5,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			a("button", {
				...
				children: a(g.T, { children: "Send Message" })
			})
		]
	});
}
