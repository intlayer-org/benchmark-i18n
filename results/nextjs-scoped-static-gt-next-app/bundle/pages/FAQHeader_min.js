...
var _s = () => g("div", {
	...
	children: g(Xo, { children: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." })
});
function vs() {
	return _(h, { children: [g(_s, {}), _(Xo, { children: [g("h1", {
