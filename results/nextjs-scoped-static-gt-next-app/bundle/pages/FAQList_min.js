...
function g() {
	return i("div", {
		...
		children: [
			{
				q: i(h.T, { children: "What is i18n Benchmark?" }),
				a: i(h.T, { children: "i18n Benchmark is an open-source benchmarking suite that measures and compares the performance, bundle size, and developer experience of internationalization libraries for JavaScript and React applications." })
			},
			{
				q: i(h.T, { children: "How are benchmarks conducted?" }),
				a: i(h.T, { children: "We run standardized tests in isolated environments using consistent hardware. Each benchmark is repeated multiple times to ensure statistical significance. All test configurations are publicly available in our GitHub repository." })
			},
			{
				q: i(h.T, { children: "Which libraries are currently supported?" }),
				a: i(h.T, { children: "We support react-i18next, react-intl (FormatJS), Lingui, typesafe-i18n, next-intl, Paraglide, Rosetta, i18n-js, Polyglot.js, vue-i18n, @fluent/react, and Tolgee." })
			},
			{
				q: i(h.T, { children: "Can I submit my own benchmarks?" }),
				a: i(h.T, { children: "Yes! Community benchmark submissions are welcome. Fork our repository, add your benchmark following our contribution guide, and submit a pull request. Our team will review and merge qualifying submissions." })
			},
			{
				q: i(h.T, { children: "How often are benchmarks updated?" }),
				a: i(h.T, { children: "We re-run all benchmarks weekly against the latest stable versions of each library. Major version releases trigger an immediate re-benchmark cycle." })
			},
			{
				q: i(h.T, { children: "Is the data reliable?" }),
				a: i(h.T, { children: "We follow rigorous statistical methodology including warm-up runs, outlier detection, and confidence intervals. All raw data is published alongside our analysis for full transparency." })
			},
			{
				q: i(h.T, { children: "Do you offer consulting services?" }),
				a: i(h.T, { children: "Yes, our Enterprise plan includes consulting hours for teams evaluating i18n solutions. We can provide tailored recommendations based on your specific use case, scale, and constraints." })
			},
			{
				q: i(h.T, { children: "How can I contribute?" }),
				a: i(h.T, { children: "There are many ways to contribute: submit benchmarks, improve documentation, report bugs, suggest new metrics, or sponsor the project. Visit our GitHub repository for more details." })
			}
		].map((e, t) => a("details", {
