	...
	return jsxs("section", {
		...
		children: [
			...
			jsx("p", {
				...
				children: jsx(import_index_client.T, { children: "A test application designed to measure the real-world impact of internationalization libraries on bundle size, loading performance, and rendering reactivity." })
			}),
			jsxs("div", {
				...
				children: [jsx("button", {
					...
					children: jsx(import_index_client.T, { children: "View Results" })
				}), jsx("button", {
					type: "button",
