	...
	return g("Hero"), a("section", {
		...
		children: [
			i("h1", {
				...
				children: i(h.T, { children: "i18n Benchmark" })
			}),
			i("p", {
				className: "mx-auto max-w-2xl text-lg text-muted-foreground",
				children: i(h.T, { children: "A test application designed to measure the real-world impact of internationalization libraries on bundle size, loading performance, and rendering reactivity." })
			}),
			a("div", {
				...
				children: [i("button", {
					...
					children: i(h.T, { children: "View Results" })
				}), i("button", {
					type: "button",
