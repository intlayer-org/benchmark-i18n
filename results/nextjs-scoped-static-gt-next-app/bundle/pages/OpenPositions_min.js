...
Ya();
function _s() {
	return _(h, { children: [g("h2", {
		className: "mb-6 text-2xl font-bold text-foreground",
		children: g(X, { children: "Open Positions" })
	}), g("div", {
		className: "space-y-4",
		children: [
			{
				title: g(X, { children: "Senior Frontend Engineer" }),
				location: g(X, { children: "Remote" }),
				type: g(X, { children: "Full-time" }),
				dept: g(X, { children: "Engineering" }),
				desc: g(X, { children: "Build and maintain our benchmarking dashboard and developer tools using React, TypeScript, and Vite." })
			},
			{
				title: g(X, { children: "Backend Engineer" }),
				location: g(X, { children: "Remote" }),
				type: g(X, { children: "Full-time" }),
				dept: g(X, { children: "Engineering" }),
				desc: g(X, { children: "Design and scale our cloud benchmarking infrastructure handling thousands of automated runs daily." })
			},
			{
				title: g(X, { children: "Technical Writer" }),
				location: g(X, { children: "Remote" }),
				type: g(X, { children: "Part-time" }),
				dept: g(X, { children: "Documentation" }),
				desc: g(X, { children: "Create comprehensive guides, API references, and tutorials for our benchmarking platform." })
			},
			{
				title: g(X, { children: "DevRel Engineer" }),
				location: g(X, { children: "San Francisco / Remote" }),
				type: g(X, { children: "Full-time" }),
				dept: g(X, { children: "Community" }),
				desc: g(X, { children: "Engage with the i18n community through talks, workshops, blog posts, and open source contributions." })
			},
			{
				title: g(X, { children: "QA Engineer" }),
				location: g(X, { children: "Remote" }),
				type: g(X, { children: "Full-time" }),
				dept: g(X, { children: "Engineering" }),
				desc: g(X, { children: "Ensure the accuracy and reliability of benchmark results through rigorous testing and validation." })
			}
		].map((e) => _("div", {
			...
			children: [_("div", { children: [
				...
				children: g(X, { children: "Apply Now" })
			})]
		}, e.title?.toString() || ""))
	})] });
}
