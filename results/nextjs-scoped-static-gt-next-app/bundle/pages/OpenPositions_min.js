...
function g() {
	return a(r, { children: [i("h2", {
		...
		children: i(h.T, { children: "Open Positions" })
	}), i("div", {
		className: "space-y-4",
		children: [
			{
				title: i(h.T, { children: "Senior Frontend Engineer" }),
				location: i(h.T, { children: "Remote" }),
				type: i(h.T, { children: "Full-time" }),
				dept: i(h.T, { children: "Engineering" }),
				desc: i(h.T, { children: "Build and maintain our benchmarking dashboard and developer tools using React, TypeScript, and Vite." })
			},
			{
				title: i(h.T, { children: "Backend Engineer" }),
				location: i(h.T, { children: "Remote" }),
				type: i(h.T, { children: "Full-time" }),
				dept: i(h.T, { children: "Engineering" }),
				desc: i(h.T, { children: "Design and scale our cloud benchmarking infrastructure handling thousands of automated runs daily." })
			},
			{
				title: i(h.T, { children: "Technical Writer" }),
				location: i(h.T, { children: "Remote" }),
				type: i(h.T, { children: "Part-time" }),
				dept: i(h.T, { children: "Documentation" }),
				desc: i(h.T, { children: "Create comprehensive guides, API references, and tutorials for our benchmarking platform." })
			},
			{
				title: i(h.T, { children: "DevRel Engineer" }),
				location: i(h.T, { children: "San Francisco / Remote" }),
				type: i(h.T, { children: "Full-time" }),
				dept: i(h.T, { children: "Community" }),
				desc: i(h.T, { children: "Engage with the i18n community through talks, workshops, blog posts, and open source contributions." })
			},
			{
				title: i(h.T, { children: "QA Engineer" }),
				location: i(h.T, { children: "Remote" }),
				type: i(h.T, { children: "Full-time" }),
				dept: i(h.T, { children: "Engineering" }),
				desc: i(h.T, { children: "Ensure the accuracy and reliability of benchmark results through rigorous testing and validation." })
			}
		].map((e) => a("div", {
			...
			children: [a("div", { children: [
				...
				children: i(h.T, { children: "Apply Now" })
			})]
		}, e.title?.toString() || ""))
	})] });
}
