...
function _() {
	...
	return o("section", {
		...
		children: [a("h2", {
			...
			children: a(g.T, { children: "Preferences" })
		}), o("div", {
			className: "space-y-4",
			children: [
				o("div", {
					...
					children: [o("div", { children: [a("p", {
						...
						children: a(g.T, { children: "Email Notifications" })
					}), a("p", {
						className: "text-xs text-muted-foreground",
						children: a(g.T, { children: "Receive weekly benchmark reports" })
					})] }), a("button", {
						type: "button",
				...
				o("div", {
					...
					children: [o("div", { children: [a("p", {
						className: "text-sm font-medium text-foreground",
						children: a(g.T, { children: "Dark Mode" })
					}), a("p", {
						className: "text-xs text-muted-foreground",
						children: a(g.T, { children: "Use dark color scheme" })
					})] }), a("button", {
						type: "button",
				...
				o("div", { children: [a("label", {
					...
					children: a(g.T, { children: "Default Language" })
				}), o("select", {
					id: e,
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
					children: [
						a("option", { children: a(g.T, { children: "English (en)" }) }),
						a("option", { children: a(g.T, { children: "French (fr)" }) }),
						a("option", { children: a(g.T, { children: "German (de)" }) }),
						a("option", { children: a(g.T, { children: "Spanish (es)" }) }),
						a("option", { children: a(g.T, { children: "Japanese (ja)" }) }),
						a("option", { children: a(g.T, { children: "Chinese Simplified (zh-CN)" }) }),
						a("option", { children: a(g.T, { children: "Arabic (ar)" }) })
					]
				})] })
			]
		})]
