...
function PricingHeader() {
	return jsxs(Fragment, { children: [jsx(MockBanner, {}), jsxs("div", {
		...
		children: [jsx("h1", {
			...
			children: jsx(import_index_client.T, { children: "Simple, Transparent Pricing" })
		}), jsx("p", {
			className: "text-muted-foreground",
			children: jsx(import_index_client.T, { children: "Choose the plan that fits your team. No hidden fees." })
		})]
	})] });
}
