...
function _() {
	return a(r, { children: [i(g, {}), a("div", {
		className: "mb-12 text-center",
		children: [i("h1", {
			className: "mb-3 text-3xl font-bold text-foreground",
			children: i(h.T, { children: "Simple, Transparent Pricing" })
		}), i("p", {
			className: "text-muted-foreground",
			children: i(h.T, { children: "Choose the plan that fits your team. No hidden fees." })
		})]
	})] });
}
function v() {
