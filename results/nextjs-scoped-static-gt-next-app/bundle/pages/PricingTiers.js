...
function PricingTiers() {
	return jsx("div", {
		...
		children: [
			{
				name: jsx(import_index_client.T, { children: "Starter" }),
				price: jsx(import_index_client.T, { children: "$0" }),
				period: jsx(import_index_client.T, { children: "forever" }),
				features: [
					jsx(import_index_client.T, { children: "5 benchmark runs/day" }, "f1"),
					jsx(import_index_client.T, { children: "3 libraries" }, "f2"),
					jsx(import_index_client.T, { children: "Community support" }, "f3"),
					jsx(import_index_client.T, { children: "Public results" }, "f4")
				]
			},
			{
				name: jsx(import_index_client.T, { children: "Pro" }),
				price: jsx(import_index_client.T, { children: "$29" }),
				period: jsx(import_index_client.T, { children: "/month" }),
				features: [
					jsx(import_index_client.T, { children: "Unlimited runs" }, "f1"),
					jsx(import_index_client.T, { children: "All libraries" }, "f2"),
					jsx(import_index_client.T, { children: "Priority support" }, "f3"),
					jsx(import_index_client.T, { children: "Private results" }, "f4"),
					jsx(import_index_client.T, { children: "CI integration" }, "f5"),
					jsx(import_index_client.T, { children: "Historical data" }, "f6")
				],
				highlighted: true
			},
			{
				name: jsx(import_index_client.T, { children: "Enterprise" }),
				price: jsx(import_index_client.T, { children: "Custom" }),
				period: jsx(import_index_client.T, { children: "" }),
				features: [
					jsx(import_index_client.T, { children: "Everything in Pro" }, "f1"),
					jsx(import_index_client.T, { children: "On-premise option" }, "f2"),
					jsx(import_index_client.T, { children: "SSO & SAML" }, "f3"),
					jsx(import_index_client.T, { children: "Dedicated account manager" }, "f4"),
					jsx(import_index_client.T, { children: "Custom SLAs" }, "f5"),
					jsx(import_index_client.T, { children: "Audit logs" }, "f6"),
					jsx(import_index_client.T, { children: "Training sessions" }, "f7")
				],
				isEnterprise: true
			}
		].map((t, i) => jsxs("div", {
			...
			children: [
				...
				jsx("button", {
					...
					children: t.isEnterprise ? jsx(import_index_client.T, { children: "Contact Sales" }) : jsx(import_index_client.T, { children: "Get Started" })
				})
			]
		}, i))
	});
