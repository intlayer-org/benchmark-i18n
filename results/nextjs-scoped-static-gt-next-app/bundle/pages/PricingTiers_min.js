...
function g() {
	return i("div", {
		...
		children: [
			{
				name: i(h.T, { children: "Starter" }),
				price: i(h.T, { children: "$0" }),
				period: i(h.T, { children: "forever" }),
				features: [
					i(h.T, { children: "5 benchmark runs/day" }, "f1"),
					i(h.T, { children: "3 libraries" }, "f2"),
					i(h.T, { children: "Community support" }, "f3"),
					i(h.T, { children: "Public results" }, "f4")
				]
			},
			{
				name: i(h.T, { children: "Pro" }),
				price: i(h.T, { children: "$29" }),
				period: i(h.T, { children: "/month" }),
				features: [
					i(h.T, { children: "Unlimited runs" }, "f1"),
					i(h.T, { children: "All libraries" }, "f2"),
					i(h.T, { children: "Priority support" }, "f3"),
					i(h.T, { children: "Private results" }, "f4"),
					i(h.T, { children: "CI integration" }, "f5"),
					i(h.T, { children: "Historical data" }, "f6")
				],
				highlighted: !0
			},
			{
				name: i(h.T, { children: "Enterprise" }),
				price: i(h.T, { children: "Custom" }),
				period: i(h.T, { children: "" }),
				features: [
					i(h.T, { children: "Everything in Pro" }, "f1"),
					i(h.T, { children: "On-premise option" }, "f2"),
					i(h.T, { children: "SSO & SAML" }, "f3"),
					i(h.T, { children: "Dedicated account manager" }, "f4"),
					i(h.T, { children: "Custom SLAs" }, "f5"),
					i(h.T, { children: "Audit logs" }, "f6"),
					i(h.T, { children: "Training sessions" }, "f7")
				],
				isEnterprise: !0
			}
		].map((e, t) => a("div", {
			...
			children: [
				...
				i("ul", {
					...
					children: e.features.map((e, t) => a("li", {
				...
				i("button", {
					...
					children: e.isEnterprise ? i(h.T, { children: "Contact Sales" }) : i(h.T, { children: "Get Started" })
				})
			]
		}, t))
	});
