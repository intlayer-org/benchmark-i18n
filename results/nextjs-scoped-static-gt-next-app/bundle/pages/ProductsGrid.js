...
function ProductsGrid() {
	return jsx("div", {
		...
		children: [
			{
				name: jsx(import_index_client.T, { children: "Benchmark CLI" }),
				desc: jsx(import_index_client.T, { children: "Run benchmarks locally from your terminal. Supports custom configurations and CI integration." }),
				price: jsx(import_index_client.T, { children: "Free" })
			},
			{
				name: jsx(import_index_client.T, { children: "Benchmark Cloud" }),
				desc: jsx(import_index_client.T, { children: "Automated cloud-based benchmarking with historical tracking, alerts, and team dashboards." }),
				price: "$29/mo"
			},
			{
				name: jsx(import_index_client.T, { children: "Benchmark Enterprise" }),
				desc: jsx(import_index_client.T, { children: "On-premise deployment with SSO, audit logs, custom SLAs, and dedicated support." }),
				price: jsx(import_index_client.T, { children: "Contact Us" })
			},
			{
				name: jsx(import_index_client.T, { children: "Migration Assistant" }),
				desc: jsx(import_index_client.T, { children: "AI-powered tool that helps migrate your codebase between i18n libraries with zero downtime." }),
				price: jsx(import_index_client.T, { children: "$99 one-time" })
			},
			{
				name: jsx(import_index_client.T, { children: "Translation QA" }),
				desc: jsx(import_index_client.T, { children: "Automated quality checks for missing translations, pluralization issues, and context errors." }),
				price: "$19/mo"
			},
			{
				name: jsx(import_index_client.T, { children: "Bundle Optimizer" }),
				desc: jsx(import_index_client.T, { children: "Analyzes and optimizes your i18n bundle for production with tree-shaking and code splitting." }),
				price: "$49/mo"
			}
		].map((p) => jsxs("div", {
			...
			children: [jsxs("div", { children: [jsx("h3", {
				...
				children: [jsx("span", {
					...
					children: jsx(import_index_client.T, { children: "Learn More" })
				})]
			})]
		}, p.name?.toString() || ""))
	});
