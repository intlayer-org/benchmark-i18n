...
function g() {
	return i("div", {
		...
		children: [
			{
				name: i(h.T, { children: "Benchmark CLI" }),
				desc: i(h.T, { children: "Run benchmarks locally from your terminal. Supports custom configurations and CI integration." }),
				price: i(h.T, { children: "Free" })
			},
			{
				name: i(h.T, { children: "Benchmark Cloud" }),
				desc: i(h.T, { children: "Automated cloud-based benchmarking with historical tracking, alerts, and team dashboards." }),
				price: "$29/mo"
			},
			{
				name: i(h.T, { children: "Benchmark Enterprise" }),
				desc: i(h.T, { children: "On-premise deployment with SSO, audit logs, custom SLAs, and dedicated support." }),
				price: i(h.T, { children: "Contact Us" })
			},
			{
				name: i(h.T, { children: "Migration Assistant" }),
				desc: i(h.T, { children: "AI-powered tool that helps migrate your codebase between i18n libraries with zero downtime." }),
				price: i(h.T, { children: "$99 one-time" })
			},
			{
				name: i(h.T, { children: "Translation QA" }),
				desc: i(h.T, { children: "Automated quality checks for missing translations, pluralization issues, and context errors." }),
				price: "$19/mo"
			},
			{
				name: i(h.T, { children: "Bundle Optimizer" }),
				desc: i(h.T, { children: "Analyzes and optimizes your i18n bundle for production with tree-shaking and code splitting." }),
				price: "$49/mo"
			}
		].map((e) => a("div", {
			...
			children: [a("div", { children: [i("h3", {
				...
				children: [i("span", {
					...
					children: i(h.T, { children: "Learn More" })
				})]
			})]
		}, e.name?.toString() || ""))
	});
