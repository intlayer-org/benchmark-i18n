...
function ProductsHeader() {
	return jsxs(Fragment, { children: [
		...
		jsx("h1", {
			...
			children: jsx(import_index_client.T, { children: "Products" })
		}),
		jsx("p", {
			className: "mb-10 text-muted-foreground",
			children: jsx(import_index_client.T, { children: "Tools and services to streamline your internationalization workflow." })
		})
	] });
}
