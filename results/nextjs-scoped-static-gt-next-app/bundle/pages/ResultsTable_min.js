...
function g() {
	return a("section", { children: [i("h2", {
		...
		children: i(h.T, { children: "Sample Results" })
	}), i("div", {
			...
			children: [i("thead", {
				...
				children: a("tr", { children: [
					i("th", {
						...
						children: i(h.T, { children: "Library" })
					}),
					i("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
					...
					i("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: i(h.T, { children: "Lookup Time" })
					}),
					i("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: i(h.T, { children: "Lazy Loading" })
					})
				] })
			}), i("tbody", { children: [
				{
					...
					size: "42.3 kB",
					time: "0.12ms",
					lazy: i(h.T, { children: "Yes" })
				},
				{
					lib: "react-intl",
					size: "38.1 kB",
					time: "0.15ms",
					lazy: i(h.T, { children: "Manual" })
				},
				{
					lib: "lingui",
					size: "12.8 kB",
