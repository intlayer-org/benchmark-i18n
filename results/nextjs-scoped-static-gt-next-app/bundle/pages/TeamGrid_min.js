...
function g() {
	return i("div", {
		...
		children: [
			{
				name: i(h.T, { children: "Sarah Chen" }),
				role: i(h.T, { children: "Founder & Lead Engineer" }),
				bio: i(h.T, { children: "Former Google engineer with 10 years of experience building internationalization systems at scale." })
			},
			{
				name: i(h.T, { children: "Marcus Weber" }),
				role: i(h.T, { children: "Performance Engineer" }),
				bio: i(h.T, { children: "Specializes in JavaScript performance optimization and benchmarking methodology. Previously at Vercel." })
			},
			{
				name: i(h.T, { children: "Aisha Patel" }),
				role: i(h.T, { children: "Developer Advocate" }),
				bio: i(h.T, { children: "Passionate about developer experience and education. Speaker at React Conf, JSConf, and i18nNext." })
			},
			{
				name: i(h.T, { children: "Tomás Rodríguez" }),
				role: i(h.T, { children: "Full-Stack Developer" }),
				bio: i(h.T, { children: "Maintains the benchmarking infrastructure and CI/CD pipeline. Open source contributor to Lingui." })
			},
			{
				name: i(h.T, { children: "Yuki Tanaka" }),
				role: i(h.T, { children: "Data Analyst" }),
				bio: i(h.T, { children: "Ensures statistical rigor in all benchmark results. PhD in Applied Statistics from MIT." })
			},
			{
				name: i(h.T, { children: "Elena Kowalski" }),
				role: i(h.T, { children: "Community Manager" }),
				bio: i(h.T, { children: "Manages community contributions, partnerships, and events. Background in open source governance." })
			}
		].map((e, t) => a("div", {
