...
function _() {
	return a(r, { children: [
		...
		i("h1", {
			...
			children: i(h.T, { children: "Our Team" })
		}),
		i("p", {
			className: "mb-10 text-muted-foreground",
			children: i(h.T, { children: "Meet the people behind i18n Benchmark. A diverse team united by a shared passion for great developer tools." })
		})
	] });
}
function v() {
