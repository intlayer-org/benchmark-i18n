...
var o = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), s = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	function Y() {
		return q || (q = 1, J.exports = function() {
			var e = e || function(e, t) {
				...
				}, m = o.BufferedBlockAlgorithm = s.extend({
					reset: function() {
  ...
  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
	...
	var t = s("react/jsx-runtime"), n = s("react"), r = l(), i = u();
	function a(e) {
	...
	function d(e = {}, t) {
		return e.name ? e.name : `_gt_${c[t] || "value"}_${e["data-_gt"]?.id}`;
	}
	var f = function(e, t) {
	...
	var t = s("react/jsx-runtime"), n = s("react"), r = l(), i = d();
	function a(e) {
		var t = Object.create(null);
		return e && Object.keys(e).forEach(function(n) {
			if (n !== "default") {
	...
	function u(e, t) {
		...
		c(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
	}
	var f = function() {
	...
	return a("section", {
		...
		children: [
			i("h2", {
				...
				children: i(h.T, { children: "Understanding the Impact" })
			}),
			a("div", {
				...
				children: [
					i("h3", {
						...
						children: i(h.T, { children: "Why a single large JSON can hurt performance" })
					}),
					i("p", {
						className: "text-sm text-muted-foreground",
						children: i(h.T, { children: "Many i18n libraries store translations in a single JSON object provided via React context. When this object is large (thousands of keys), every component that consumes translations holds a reference to the entire dictionary. This means:" })
					}),
					a("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							i("li", { children: i(h.T, { children: "The JSON must be parsed on every page load — blocking the main thread." }) }),
							i("li", { children: i(h.T, { children: "Context-based architectures can cause cascading re-renders when the locale changes, because every consumer is notified even if their specific keys didn't change." }) }),
							i("li", { children: i(h.T, { children: "During server-side rendering, the full dictionary is serialized into the HTML payload, increasing the document size that must be downloaded and hydrated." }) })
						]
					})
				]
			}),
			a("div", {
				...
				children: [
					i("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: i(h.T, { children: "The trade-offs of dynamic loading" })
					}),
					i("p", {
						className: "text-sm text-muted-foreground",
						children: i(h.T, { children: "Splitting translations into per-route or per-namespace chunks can dramatically reduce the initial payload. But it introduces new challenges:" })
					}),
					a("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							a("li", { children: [
								i("strong", {
									...
									children: i(h.T, { children: "Waterfall requests:" })
								}),
								" ",
								i(h.T, { children: "the app must first load, determine the locale, then fetch the right chunk — adding network round-trips." })
							] }),
							a("li", { children: [
								i("strong", {
									className: "text-foreground",
									children: i(h.T, { children: "Flash of untranslated content (FOUC):" })
								}),
								" ",
								i(h.T, { children: "users may briefly see translation keys or a fallback language before the chunk arrives." })
							] }),
							a("li", { children: [
								i("strong", {
									className: "text-foreground",
									children: i(h.T, { children: "Cache invalidation:" })
								}),
								" ",
								i(h.T, { children: "updating translations requires cache-busting strategies to ensure users get fresh content without re-downloading unchanged chunks." })
							] })
						]
					})
				]
			...
			a("div", {
				...
				children: [i("h3", {
					className: "mb-2 text-lg font-semibold text-foreground",
					children: i(h.T, { children: "What this benchmark measures" })
				}), i("p", {
					className: "text-sm text-muted-foreground",
					children: i(h.T, { children: "This test app provides a controlled environment — 10 pages with realistic content — to compare i18n libraries across three axes: the weight they add to your JavaScript bundle, the time spent parsing and rendering translated content, and the effectiveness of their code-splitting and lazy-loading strategies. Each library is integrated into the same app so results are directly comparable." })
				})]
			})
		]
	});
...
function y({ children: a, locale: o }) {
