...
function WhyItMatters() {
	return jsxs("section", {
		...
		children: [jsx("h2", {
			...
			children: jsx(import_index_client.T, { children: "Why These Metrics Matter" })
		}), jsxs("div", {
			...
			children: [
				...
				jsxs("div", {
					...
					children: [jsx("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: jsx(import_index_client.T, { children: "Rendering & Hydration" })
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
						children: jsx(import_index_client.T, { children: "Connecting a large JSON dictionary to every component creates a hidden dependency: any change in the translation context can trigger re-renders across the entire tree. During SSR hydration, parsing and attaching massive translation objects adds latency before the page becomes interactive — directly impacting Time to Interactive (TTI)." })
					})]
				}),
				jsxs("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [jsx("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: jsx(import_index_client.T, { children: "Dynamic Loading" })
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
						children: jsx(import_index_client.T, { children: "Loading all translations upfront overloads the initial payload. Dynamic (lazy) loading splits translations by route or namespace, sending only what the current page needs. However, lazy loading introduces its own trade-offs: waterfall requests, flash of untranslated content, and caching complexity. Measuring both strategies is essential." })
					})]
				})
			]
		})]
