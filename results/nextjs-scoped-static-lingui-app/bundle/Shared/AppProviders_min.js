...
var c = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), l = e(null), u = ({ i18n: e, defaultComponent: r, children: i }) => {
...
}, _ = (e) => e < 4 ? "short" : e === 4 ? "long" : "narrow", v = (e) => e % 2 == 0 ? "2-digit" : "numeric";
function y(e, t) {
	switch (e.char) {
		case "y": return { year: v(e.width) };
		case "r": return {
			calendar: "gregory",
			year: "numeric"
		};
		default: return t(`${e.desc} is not supported; falling back to year:numeric`, g.WARNING), { year: "numeric" };
	}
}
function b(e, t) {
	switch (e.width) {
...
function S(e, t) {
	let { char: n, desc: r, width: i } = e;
	return (n === "c" || n === "e") && i < 3 && t(`Numeric value is not supported for ${r}; falling back to weekday:short`, g.WARNING), _(i);
}
function C(e) {
	let t = v(e.width), n;
	switch (e.char) {
...
function T(e, t) {
	switch (e.field) {
		case "era": return { era: _(e.width) };
		case "year": return y(e, t);
		case "month": return { month: b(e, t) };
		case "day": return { day: x(e, t) };
		case "weekday": return { weekday: S(e, t) };
		case "period": return;
		case "hour": return C(e);
		case "min": return { minute: v(e.width) };
		case "sec": return { second: v(e.width) };
		case "tz": return { timeZoneName: w(e, t) };
		case "quarter":
		case "week":
		case "sec-frac":
...
function E(e, t, n = (e) => {
	...
	for (let t of e) {
		...
		if (e) {
			let r = new g(e.message, t);
			r.stack = e.stack, n(r);
		}
		o && n(new g(`Ignoring string part: ${o}`, t, g.WARNING)), a && (i.indexOf(a) === -1 ? i.push(a) : n(new g(`Duplicate ${a} token`, t)));
		let s = T(t, (e, r) => n(new g(e, t, r)));
		s && Object.assign(r, s);
	}
	return r;
}
...
function A(e, t) {
	return /^::/.test(e) ? E(re(e.substring(2)), void 0, t) : e;
}
function j(e, t = (e) => e) {
	return k((0, h.parse)(e), t);
}
function M(e, t = (e) => e) {
	try {
		return j(e, t);
...
var Y = Object.defineProperty, X = (e, t, n) => t in e ? Y(e, t, {
	...
	writable: !0,
	value: n
}) : e[t] = n, ae = (e, t, n) => (X(e, typeof t == "symbol" ? t : t + "", n), n), oe = class {
	constructor() {
		ae(this, "_events", {});
	}
	on(e, t) {
	...
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (ce(e, typeof t == "symbol" ? t : t + "", n), n), le = class extends oe {
	constructor(e) {
...
function $({ children: e, locale: t, messages: a }) {
	let c = i(() => ue(t, a), [t, a]), [l] = o(() => typeof performance < "u" ? performance.now() : 0);
	return r(() => {
		f("AppRoot", l);
	}, [l]), n(() => {
