...
var s = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), c = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	let i = r(() => m(e, t), [e, t]), o = (0, d.useSyncExternalStore)(i.subscribe, i.getSnapshot, i.getSnapshot);
	return o.i18n.locale ? a(f.Provider, {
		value: o,
		children: n
...
function I(e, t) {
	return /^::/.test(e) ? k(P(e.substring(2)), void 0, t) : e;
}
function re(e, t = (e) => e) {
...
var le = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(ie), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? z, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
var fe = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/AppProviders.tsx";
function Z({ children: e, locale: a, messages: s }) {
	let c = r(() => de(a, s), [a, s]), [l] = i(() => typeof performance < "u" ? performance.now() : 0);
	return n(() => {
		_("AppRoot", l);
	}, [l]), t(() => {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/AppProviders.wrapper.tsx";
function De() {
	return o(Ee, { children: o(Z, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
