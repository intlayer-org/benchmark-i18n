...
}), m = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/Link.tsx", h = (e) => /^https?:\/\//.test(e ?? "");
function g(e, t) {
...
var k = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/Footer.tsx";
function se() {
	let { i18n: e } = re(), t = [
		{
...
function P(e, t) {
	switch (e.field) {
		...
		case "year": return pe(e, t);
		case "month": return { month: me(e, t) };
		case "day": return { day: he(e, t) };
		case "weekday": return { weekday: ge(e, t) };
		case "period": return;
		case "hour": return _e(e);
...
function Se(e, t) {
	return /^::/.test(e) ? F(xe(e.substring(2)), void 0, t) : e;
}
function Ce(e, t = (e) => e) {
	return R((0, fe.parse)(e), t);
}
function we(e, t = (e) => e) {
	try {
		return Ce(e, t);
...
var z = (e) => typeof e == "string", Te = (e) => typeof e == "function", B = /* @__PURE__ */ new Map(), V = "en";
function H(e) {
...
var J = /\\u[a-fA-F0-9]{4}|\\x[a-fA-F0-9]{2}/, Y = (e) => e.replace(/\\u([a-fA-F0-9]{4})|\\x([a-fA-F0-9]{2})/g, (e, t, n) => {
...
}), X = "%__lingui_octothorpe__%", De = (e, t, n = {}) => {
	...
	return {
		...
		time: (e, t) => Ee(r, e, i(t) || t)
	};
}, Oe = (e, t) => t[e] ?? t.other;
function ke(e, t, n) {
	return (r = {}, i) => {
		let a = De(t, n, i), o = (e, t = !1) => Array.isArray(e) ? e.reduce((e, n) => {
			if (n === "#" && t) return e + X;
			if (z(n)) return e + n;
			let [i, s, c] = n, l = {};
...
var Ae = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(we), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? V, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), z(s) && J.test(s) ? Y(s) : z(s) ? s : ke(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
function Pe({ children: e, locale: t, messages: n }) {
	let s = a(() => Me(t, n), [t, n]), [c] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		le("AppRoot", c);
	}, [c]), r(() => {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/Footer.wrapper.tsx";
function Ye() {
	return l(Je, { children: l(se, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
