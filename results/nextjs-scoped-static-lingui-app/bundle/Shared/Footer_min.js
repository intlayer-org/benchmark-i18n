...
function P(e, t) {
	switch (e.field) {
		...
		case "year": return de(e, t);
		case "month": return { month: fe(e, t) };
		case "day": return { day: pe(e, t) };
		case "weekday": return { weekday: me(e, t) };
		case "period": return;
		case "hour": return he(e);
...
function ye(e, t) {
	return /^::/.test(e) ? F(ve(e.substring(2)), void 0, t) : e;
}
function be(e, t = (e) => e) {
	return z((0, ue.parse)(e), t);
}
function xe(e, t = (e) => e) {
	try {
		return be(e, t);
...
var B = (e) => typeof e == "string", Se = (e) => typeof e == "function", V = /* @__PURE__ */ new Map(), H = "en";
function U(e) {
...
}), Z = "%__lingui_octothorpe__%", we = (e, t, n = {}) => {
...
var De = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(xe), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? H, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), B(s) && Y.test(s) ? X(s) : B(s) ? s : Ee(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
function Ae({ children: e, locale: t, messages: n }) {
	let s = a(() => ke(t, n), [t, n]), [c] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		se("AppRoot", c);
	}, [c]), r(() => {
