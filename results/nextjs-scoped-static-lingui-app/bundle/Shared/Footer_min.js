import { cloneElement as e, createContext as t, useCallback as n, useContext as r, useEffect as i, useLayoutEffect as a, useMemo as o, useRef as s, useState as c } from "react";
import l from "next/link";
import { useParams as u } from "next/navigation";
import { Fragment as d, jsx as f, jsxs as p } from "react/jsx-runtime";
var m = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), h = (e) => /^https?:\/\//.test(e ?? "");
function g(e, t) {
	return !e.startsWith("/") || e === `/${t}` || e.startsWith(`/${t}/`) ? e : `/${t}${e === "/" ? "" : e}`;
}
var _ = ({ href: e, children: t, ...n }) => {
	let r = u().locale ?? "en";
	return e == null || typeof e != "string" || h(e) ? f(l, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
function b(t, n = {}) {
	...
	let i = S(0, "$lingui$"), a = [], o = r.shift();
	o && a.push(o);
	for (let [t, o, s] of x(r)) {
		let r = t === void 0 ? void 0 : n[t];
		(!r || y[r.type] && o) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${t}' as it is not declared in the original translation`), r = f(d, {})), Array.isArray(r) && (r = f(d, { children: r })), a.push(e(r, { key: i() }, o ? b(o, n) : r.props.children)), s && a.push(s);
	}
...
function x(e) {
	...
	return [[
		...
		n || "",
		i
	]].concat(x(e.slice(4, e.length)));
}
var S = (e = 0, t = "") => () => `${t}_${e++}`;
function C(e) {
	let { render: t, component: n, id: r, message: i, formats: a, lingui: { i18n: o, defaultComponent: s } } = e, { values: c, components: l } = T(e), u = o && typeof o._ == "function" ? o._(r, c, {
		message: i,
		formats: a
	}) : r, d = u ? b(u, l) : null;
	...
	else if (n && typeof n != "function") return console.error(`Invalid value supplied to prop \`component\`. It must be a React component, provided ${n}`), f(p, {
		...m,
		children: d
	});
	return typeof t == "function" ? t(m) : f(n || p, {
		...m,
		children: d
	});
}
var w = ({ children: e }) => e, T = (e) => {
	if (!e.values) return {
		values: void 0,
...
var te = ({ i18n: e, defaultComponent: t, children: r }) => {
	let a = s(e.locale), o = n(() => ({
		i18n: e,
		defaultComponent: t,
		_: e.t.bind(e)
	}), [e, t]), [l, u] = c(o());
	return i(() => {
		let t = () => {
			a.current = e.locale, u(o());
		}, n = e.on("change", t);
		return a.current !== e.locale && t(), n;
	}, [e, o]), a.current ? f(E.Provider, {
		value: l,
		children: r
			...
			children: [p("div", {
				...
				children: [
					...
					p("div", { children: [f("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => f("li", { children: e.isInternal ? f(_, {
							href: e.href,
...
function ge(e, t) {
	return /^::/.test(e) ? me(L(e.substring(2)), void 0, t) : e;
}
function _e(e, t = (e) => e) {
	return R((0, oe.parse)(e), t);
}
function ve(e, t = (e) => e) {
	try {
		return _e(e, t);
...
var z = (e) => typeof e == "string", ye = (e) => typeof e == "function", B = /* @__PURE__ */ new Map(), V = "en";
function H(e) {
...
}), X = "%__lingui_octothorpe__%", xe = (e, t, n = {}) => {
...
var we = Object.defineProperty, Te = (e, t, n) => t in e ? we(e, t, {
	...
	writable: !0,
	value: n
}) : e[t] = n, Ee = (e, t, n) => (Te(e, typeof t == "symbol" ? t : t + "", n), n), De = class {
	constructor() {
		Ee(this, "_events", {});
	}
	on(e, t) {
	...
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (ke(e, typeof t == "symbol" ? t : t + "", n), n), Ae = class extends De {
	constructor(e) {
		super(), Z(this, "_locale", ""), Z(this, "_locales"), Z(this, "_localeData", {}), Z(this, "_messages", {}), Z(this, "_missing"), Z(this, "_messageCompiler"), Z(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(ve), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? V, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), z(s) && J.test(s) ? Y(s) : z(s) ? s : Ce(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
function Me({ children: e, locale: t, messages: n }) {
	let r = o(() => je(t, n), [t, n]), [s] = c(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		re("AppRoot", s);
	}, [s]), i(() => {
