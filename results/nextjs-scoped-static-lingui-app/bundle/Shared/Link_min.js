import { createContext as e, useEffect as t, useLayoutEffect as n, useMemo as r, useState as i } from "react";
import a from "next/link";
import { useParams as o } from "next/navigation";
import { jsx as s } from "react/jsx-runtime";
var c = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), l = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
var f = ({ href: e, children: t, ...n }) => {
	let r = o().locale ?? "en";
	return e == null || typeof e != "string" || u(e) ? s(a, {
		href: e,
		prefetch: !1,
		...n,
		children: t
	...
	let i = r(() => v(e, t), [e, t]), a = (0, h.useSyncExternalStore)(i.subscribe, i.getSnapshot, i.getSnapshot);
	return a.i18n.locale ? s(g.Provider, {
		value: a,
		children: n
...
function oe(e, t) {
	return /^::/.test(e) ? N(ae(e.substring(2)), void 0, t) : e;
}
function se(e, t = (e) => e) {
	return I((0, w.parse)(e), t);
}
function L(e, t = (e) => e) {
	try {
		return se(e, t);
...
}), Z = "%__lingui_octothorpe__%", ce = (e, t, n = {}) => {
...
var de = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(L), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? V, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), R(s) && Y.test(s) ? X(s) : R(s) ? s : ue(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
function me({ children: e, locale: a, messages: o }) {
	let c = r(() => pe(a, o), [a, o]), [l] = i(() => typeof performance < "u" ? performance.now() : 0);
	return n(() => {
		x("AppRoot", l);
	}, [l]), t(() => {
