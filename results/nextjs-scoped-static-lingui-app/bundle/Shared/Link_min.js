import { createContext as e, useCallback as t, useEffect as n, useLayoutEffect as r, useMemo as i, useRef as a, useState as o } from "react";
import s from "next/link";
import { useParams as c } from "next/navigation";
import { jsx as l } from "react/jsx-runtime";
var u = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), d = (e) => /^https?:\/\//.test(e ?? "");
function f(e, t) {
	return !e.startsWith("/") || e === `/${t}` || e.startsWith(`/${t}/`) ? e : `/${t}${e === "/" ? "" : e}`;
}
var p = ({ href: e, children: t, ...n }) => {
	let r = c().locale ?? "en";
	return e == null || typeof e != "string" || d(e) ? l(s, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, m = e(null), h = ({ i18n: e, defaultComponent: r, children: i }) => {
	let s = a(e.locale), c = t(() => ({
		i18n: e,
		defaultComponent: r,
		_: e.t.bind(e)
	}), [e, r]), [u, d] = o(c());
	return n(() => {
		let t = () => {
			s.current = e.locale, d(c());
		}, n = e.on("change", t);
		return s.current !== e.locale && t(), n;
	}, [e, c]), s.current ? l(m.Provider, {
		value: u,
		children: i
...
function I(e, t) {
	return /^::/.test(e) ? A(P(e.substring(2)), void 0, t) : e;
}
function L(e, t = (e) => e) {
	return F((0, b.parse)(e), t);
}
function re(e, t = (e) => e) {
	try {
		return L(e, t);
...
var R = (e) => typeof e == "string", ie = (e) => typeof e == "function", z = /* @__PURE__ */ new Map(), B = "en";
function V(e) {
...
var se = Object.defineProperty, ce = (e, t, n) => t in e ? se(e, t, {
	...
	writable: !0,
	value: n
}) : e[t] = n, le = (e, t, n) => (ce(e, typeof t == "symbol" ? t : t + "", n), n), ue = class {
	constructor() {
		le(this, "_events", {});
	}
	on(e, t) {
...
}, de = Object.defineProperty, fe = (e, t, n) => t in e ? de(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Q = (e, t, n) => (fe(e, typeof t == "symbol" ? t : t + "", n), n), pe = class extends ue {
	constructor(e) {
		super(), Q(this, "_locale", ""), Q(this, "_locales"), Q(this, "_localeData", {}), Q(this, "_messages", {}), Q(this, "_missing"), Q(this, "_messageCompiler"), Q(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(re), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? B, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), R(s) && J.test(s) ? Y(s) : R(s) ? s : Z(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
function he({ children: e, locale: t, messages: a }) {
	let s = i(() => me(t, a), [t, a]), [c] = o(() => typeof performance < "u" ? performance.now() : 0);
	return r(() => {
		_("AppRoot", c);
	}, [c]), n(() => {
