...
}), d = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/Link.tsx", f = (e) => /^https?:\/\//.test(e ?? "");
function p(e, t) {
	return !e.startsWith("/") || e === `/${t}` || e.startsWith(`/${t}/`) ? e : `/${t}${e === "/" ? "" : e}`;
}
var m = ({ href: e, children: t, ...n }) => {
	let r = o().locale ?? "en";
	return e == null || typeof e != "string" ? s(a, {
		href: e,
		prefetch: !1,
		...n,
		children: t
	...
	let i = r(() => b(e, t), [e, t]), a = (0, _.useSyncExternalStore)(i.subscribe, i.getSnapshot, i.getSnapshot);
	return a.i18n.locale ? c(v.Provider, {
		value: a,
		children: n
...
function ve({ children: e, locale: a, messages: o }) {
	let c = r(() => ge(a, o), [a, o]), [l] = i(() => typeof performance < "u" ? performance.now() : 0);
	return n(() => {
		C("AppRoot", l);
	}, [l]), t(() => {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/Link.wrapper.tsx";
function Ne() {
	return s(Me, { children: s(m, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
