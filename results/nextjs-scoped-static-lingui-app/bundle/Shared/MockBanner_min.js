...
var se = Object.defineProperty, ce = (e, t, n) => t in e ? se(e, t, {
	...
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (fe(e, typeof t == "symbol" ? t : t + "", n), n), pe = class extends ue {
	constructor(e) {
		super(), Z(this, "_locale", ""), Z(this, "_locales"), Z(this, "_localeData", {}), Z(this, "_messages", {}), Z(this, "_missing"), Z(this, "_messageCompiler"), Z(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(ne), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? B, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
function he({ children: e, locale: t, messages: n }) {
	let o = a(() => me(t, n), [t, n]), [l] = s(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		g("AppRoot", l);
	}, [l]), r(() => {
