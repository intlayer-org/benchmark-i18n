...
function v(t, n = {}) {
	...
	o && a.push(o);
	for (let [t, o, l] of y(r)) {
		let r = t === void 0 ? void 0 : n[t];
		(!r || _[r.type] && o) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${t}' as it is not declared in the original translation`), r = c(s, {})), Array.isArray(r) && (r = c(s, { children: r })), a.push(e(r, { key: i() }, o ? v(o, n) : r.props.children)), l && a.push(l);
	}
...
var b = (e = 0, t = "") => () => `${t}_${e++}`;
function x(e) {
	let { render: t, component: n, id: r, message: i, formats: a, lingui: { i18n: o, defaultComponent: s } } = e, { values: l, components: u } = C(e), d = o && typeof o._ == "function" ? o._(r, l, {
		message: i,
		formats: a
	}) : r, f = d ? v(d, u) : null;
...
var E = (e, t) => ({
	...
	let r = a(() => D(e, t), [e, t]), i = (0, h.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
	return i.i18n.locale ? c(w.Provider, {
		value: i,
		children: n
...
var k = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/pages/about/AboutHeader.tsx";
function re() {
	let { i18n: e } = ee();
	return ne("AboutHeader"), u(l, { children: [u("h1", {
...
function ve(e, t) {
	return /^::/.test(e) ? ge(_e(e.substring(2)), void 0, t) : e;
}
function ye(e, t = (e) => e) {
...
var z = (e) => typeof e == "string", xe = (e) => typeof e == "function", B = /* @__PURE__ */ new Map(), V = "en";
function H(e) {
...
var Ee = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(be), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? V, e.locales);
	}
	get locale() {
		return this._locale;
	}
	...
	_(e, t, n) {
		...
		if (o && a) return xe(o) ? o(this._locale, e) : o;
		a && this.emit("missing", {
			id: e,
			locale: this._locale
		});
...
`)), z(s) && J.test(s) ? Y(s) : z(s) ? s : Te(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
var ke = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/AppProviders.tsx";
function Ae({ children: e, locale: t, messages: n }) {
	let s = a(() => Oe(t, n), [t, n]), [c] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		ae("AppRoot", c);
	}, [c]), r(() => {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/pages/about/AboutHeader.wrapper.tsx";
function Ge() {
	return u(We, { children: u(re, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
