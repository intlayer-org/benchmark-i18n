...
function _(t, n = {}) {
	...
	let i = y(0, "$lingui$"), a = [], o = r.shift();
	o && a.push(o);
	for (let [t, o, l] of v(r)) {
		let r = t === void 0 ? void 0 : n[t];
		(!r || g[r.type] && o) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${t}' as it is not declared in the original translation`), r = c(s, {})), Array.isArray(r) && (r = c(s, { children: r })), a.push(e(r, { key: i() }, o ? _(o, n) : r.props.children)), l && a.push(l);
	}
...
function v(e) {
	...
	return [[
		...
		n || "",
		i
	]].concat(v(e.slice(4, e.length)));
}
var y = (e = 0, t = "") => () => `${t}_${e++}`;
function b(e) {
	let { render: t, component: n, id: r, message: i, formats: a, lingui: { i18n: o, defaultComponent: s } } = e, { values: l, components: u } = S(e), d = o && typeof o._ == "function" ? o._(r, l, {
		message: i,
		formats: a
	}) : r, f = d ? _(d, u) : null;
	...
	else if (n && typeof n != "function") return console.error(`Invalid value supplied to prop \`component\`. It must be a React component, provided ${n}`), c(p, {
		...m,
		children: f
	});
	return typeof t == "function" ? t(m) : c(n || p, {
		...m,
		children: f
	});
}
var x = ({ children: e }) => e, S = (e) => {
	if (!e.values) return {
		values: void 0,
...
var E = (e, t) => ({
	...
	let r = a(() => ee(e, t), [e, t]), i = (0, m.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
	return i.i18n.locale ? c(C.Provider, {
		value: i,
		children: n
...
function O() {
	let { i18n: e } = T();
	return ne("AboutHeader"), l(s, { children: [c("h1", {
...
function pe(e, t) {
	switch (e.field) {
		...
		case "year": return se(e, t);
		case "month": return { month: ce(e, t) };
		case "day": return { day: le(e, t) };
		case "weekday": return { weekday: ue(e, t) };
		case "period": return;
...
function he(e, t) {
	return /^::/.test(e) ? me(R(e.substring(2)), void 0, t) : e;
}
function ge(e, t = (e) => e) {
	return z((0, oe.parse)(e), t);
}
function _e(e, t = (e) => e) {
	try {
		return ge(e, t);
...
var B = (e) => typeof e == "string", ve = (e) => typeof e == "function", V = /* @__PURE__ */ new Map(), H = "en";
function U(e) {
	return [...Array.isArray(e) ? e : [e], H];
}
function W(e, t, n) {
	let r = U(e);
	n ||= "default";
	...
	return q(() => J("date", r, n), () => new Intl.DateTimeFormat(r, i)).format(B(t) ? new Date(t) : t);
}
function ye(e, t, n) {
	let r;
...
function K(e, t, n, { offset: r = 0, ...i }) {
	let a = U(e), o = t ? q(() => J("plural-ordinal", a), () => new Intl.PluralRules(a, { type: "ordinal" })) : q(() => J("plural-cardinal", a), () => new Intl.PluralRules(a, { type: "cardinal" }));
...
var Y = /\\u[a-fA-F0-9]{4}|\\x[a-fA-F0-9]{2}/, X = (e) => e.replace(/\\u([a-fA-F0-9]{4})|\\x([a-fA-F0-9]{2})/g, (e, t, n) => {
...
}), Z = "%__lingui_octothorpe__%", be = (e, t, n = {}) => {
	...
	return {
		...
		date: (e, t) => W(r, e, i(t) || t),
		time: (e, t) => ye(r, e, i(t) || t)
	};
}, xe = (e, t) => t[e] ?? t.other;
function Se(e, t, n) {
	return (r = {}, i) => {
		let a = be(t, n, i), o = (e, t = !1) => Array.isArray(e) ? e.reduce((e, n) => {
			if (n === "#" && t) return e + Z;
			if (B(n)) return e + n;
			let [i, s, c] = n, l = {};
		...
		return B(s) && Y.test(s) ? X(s) : B(s) ? s : s ? String(s) : "";
	};
}
var Ce = class {
	_events = {};
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(_e), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? H, e.locales);
	}
	get locale() {
		return this._locale;
	}
	...
	_(e, t, n) {
		...
		let r = n?.message;
		e ||= "", B(e) || (t = e.values || t, r = e.message, e = e.id);
		let i = this.messages[e], a = i === void 0, o = this._missing;
		if (o && a) return ve(o) ? o(this._locale, e) : o;
		a && this.emit("missing", {
			id: e,
			locale: this._locale
		});
		let s = i || r || e;
		return B(s) && (this._messageCompiler ? s = this._messageCompiler(s) : console.warn(`Uncompiled message detected! Message:
...
`)), B(s) && Y.test(s) ? X(s) : B(s) ? s : Se(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
function Ee({ children: e, locale: t, messages: n }) {
	let s = a(() => Te(t, n), [t, n]), [l] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		re("AppRoot", l);
	}, [l]), r(() => {
