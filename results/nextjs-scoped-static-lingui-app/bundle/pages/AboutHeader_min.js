...
var f = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), p = /<([a-zA-Z0-9]+)>([\s\S]*?)<\/\1>|<([a-zA-Z0-9]+)\/>/, m = {
	area: !0,
	base: !0,
	br: !0,
	col: !0,
...
function h(t, n = {}) {
	...
	let i = _(0, "$lingui$"), a = [], o = r.shift();
	o && a.push(o);
	for (let [t, o, s] of g(r)) {
		let r = t === void 0 ? void 0 : n[t];
		(!r || m[r.type] && o) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${t}' as it is not declared in the original translation`), r = u(l, {})), Array.isArray(r) && (r = u(l, { children: r })), a.push(e(r, { key: i() }, o ? h(o, n) : r.props.children)), s && a.push(s);
	}
...
function g(e) {
	...
	return [[
		...
		n || "",
		i
	]].concat(g(e.slice(4, e.length)));
}
var _ = (e = 0, t = "") => () => `${t}_${e++}`;
function v(e) {
	let { render: t, component: n, id: r, message: i, formats: a, lingui: { i18n: o, defaultComponent: s } } = e, { values: c, components: l } = b(e), d = o && typeof o._ == "function" ? o._(r, c, {
		message: i,
		formats: a
	}) : r, f = d ? h(d, l) : null;
...
var w = ({ i18n: e, defaultComponent: t, children: r }) => {
...
function te() {
	let { i18n: e } = C();
	return ee("AboutHeader"), d(l, { children: [u("h1", {
...
function de(e, t) {
	switch (e.field) {
		...
		case "year": return ae(e, t);
		case "month": return { month: oe(e, t) };
		case "day": return { day: se(e, t) };
		case "weekday": return { weekday: ce(e, t) };
		case "period": return;
		case "hour": return le(e);
		case "min": return { minute: A(e.width) };
		case "sec": return { second: A(e.width) };
		case "tz": return { timeZoneName: ue(e, t) };
		case "quarter":
		case "week":
		case "sec-frac":
...
function I(e, t) {
	return /^::/.test(e) ? fe(P(e.substring(2)), void 0, t) : e;
}
function L(e, t = (e) => e) {
	return F((0, ie.parse)(e), t);
}
function R(e, t = (e) => e) {
	try {
		return L(e, t);
...
var z = (e) => typeof e == "string", he = (e) => typeof e == "function", B = /* @__PURE__ */ new Map(), V = "en";
function H(e) {
...
var J = /\\u[a-fA-F0-9]{4}|\\x[a-fA-F0-9]{2}/, Y = (e) => e.replace(/\\u([a-fA-F0-9]{4})|\\x([a-fA-F0-9]{2})/g, (e, t, n) => {
...
}), X = "%__lingui_octothorpe__%", _e = (e, t, n = {}) => {
	...
	return {
		...
		time: (e, t) => ge(r, e, i(t) || t)
	};
}, ve = (e, t) => t[e] ?? t.other;
function ye(e, t, n) {
	return (r = {}, i) => {
		let a = _e(t, n, i), o = (e, t = !1) => Array.isArray(e) ? e.reduce((e, n) => {
			if (n === "#" && t) return e + X;
			if (z(n)) return e + n;
			let [i, s, c] = n, l = {};
...
var be = Object.defineProperty, xe = (e, t, n) => t in e ? be(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Se = (e, t, n) => (xe(e, typeof t == "symbol" ? t : t + "", n), n), Ce = class {
	constructor() {
		Se(this, "_events", {});
	}
	on(e, t) {
	...
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (Te(e, typeof t == "symbol" ? t : t + "", n), n), Ee = class extends Ce {
	constructor(e) {
		super(), Z(this, "_locale", ""), Z(this, "_locales"), Z(this, "_localeData", {}), Z(this, "_messages", {}), Z(this, "_missing"), Z(this, "_messageCompiler"), Z(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(R), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? V, e.locales);
	}
	get locale() {
		return this._locale;
	}
	...
	_(e, t, n) {
		...
		if (o && a) return he(o) ? o(this._locale, e) : o;
		a && this.emit("missing", {
			id: e,
			locale: this._locale
		});
...
`)), z(s) && J.test(s) ? Y(s) : z(s) ? s : ye(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
function Oe({ children: e, locale: t, messages: n }) {
	let r = o(() => De(t, n), [t, n]), [s] = c(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		re("AppRoot", s);
	}, [s]), i(() => {
