import { cloneElement as e, createContext as t, useCallback as n, useContext as r, useEffect as i, useId as a, useLayoutEffect as o, useMemo as s, useRef as c, useState as l } from "react";
import { Fragment as u, jsx as d, jsxs as f } from "react/jsx-runtime";
var p = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), m = /<([a-zA-Z0-9]+)>([\s\S]*?)<\/\1>|<([a-zA-Z0-9]+)\/>/, h = {
	area: !0,
	base: !0,
	br: !0,
	col: !0,
...
function g(t, n = {}) {
	...
	let i = v(0, "$lingui$"), a = [], o = r.shift();
	o && a.push(o);
	for (let [t, o, s] of _(r)) {
		let r = t === void 0 ? void 0 : n[t];
		(!r || h[r.type] && o) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${t}' as it is not declared in the original translation`), r = d(u, {})), Array.isArray(r) && (r = d(u, { children: r })), a.push(e(r, { key: i() }, o ? g(o, n) : r.props.children)), s && a.push(s);
	}
...
var v = (e = 0, t = "") => () => `${t}_${e++}`;
function y(e) {
	let { render: t, component: n, id: r, message: i, formats: a, lingui: { i18n: o, defaultComponent: s } } = e, { values: c, components: l } = x(e), u = o && typeof o._ == "function" ? o._(r, c, {
		message: i,
		formats: a
	}) : r, f = u ? g(u, l) : null;
...
var b = ({ children: e }) => e, x = (e) => {
	...
	return t;
}, w = ({ i18n: e, defaultComponent: t, children: r }) => {
	let a = c(e.locale), o = n(() => ({
		i18n: e,
		defaultComponent: t,
		_: e.t.bind(e)
	}), [e, t]), [s, u] = l(o());
...
function F(e, t) {
	return /^::/.test(e) ? de(N(e.substring(2)), void 0, t) : e;
}
function I(e, t = (e) => e) {
...
}), X = "%__lingui_octothorpe__%", ge = (e, t, n = {}) => {
...
var ye = Object.defineProperty, be = (e, t, n) => t in e ? ye(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, xe = (e, t, n) => (be(e, typeof t == "symbol" ? t : t + "", n), n), Se = class {
	constructor() {
		xe(this, "_events", {});
	}
	on(e, t) {
...
}, Ce = Object.defineProperty, we = (e, t, n) => t in e ? Ce(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (we(e, typeof t == "symbol" ? t : t + "", n), n), Te = class extends Se {
	constructor(e) {
		super(), Z(this, "_locale", ""), Z(this, "_locales"), Z(this, "_localeData", {}), Z(this, "_messages", {}), Z(this, "_missing"), Z(this, "_messageCompiler"), Z(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(L), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? V, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), R(s) && J.test(s) ? Y(s) : R(s) ? s : ve(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
function De({ children: e, locale: t, messages: n }) {
	let r = s(() => Ee(t, n), [t, n]), [a] = l(() => typeof performance < "u" ? performance.now() : 0);
	return o(() => {
		ne("AppRoot", a);
	}, [a]), i(() => {
