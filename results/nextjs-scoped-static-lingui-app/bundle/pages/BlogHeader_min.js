...
}, O = ({ i18n: e, defaultComponent: t, children: n }) => {
	let r = a(() => ee(e, t), [e, t]), i = (0, h.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
...
var te = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/MockBanner.tsx", ne = () => {
	let { i18n: e } = E();
	return u("div", {
...
}, A = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/pages/blog/BlogHeader.tsx";
function re() {
	let { i18n: e } = E();
	return u(l, { children: [
		u(ne, {}, void 0, !1, {
...
}, M = (e) => e < 4 ? "short" : e === 4 ? "long" : "narrow", N = (e) => e % 2 == 0 ? "2-digit" : "numeric";
function le(e, t) {
	switch (e.char) {
		case "y": return { year: N(e.width) };
		case "r": return {
			calendar: "gregory",
			year: "numeric"
		};
		default: return t(`${e.desc} is not supported; falling back to year:numeric`, j.WARNING), { year: "numeric" };
	}
}
function ue(e, t) {
	switch (e.width) {
...
function fe(e, t) {
	let { char: n, desc: r, width: i } = e;
	return (n === "c" || n === "e") && i < 3 && t(`Numeric value is not supported for ${r}; falling back to weekday:short`, j.WARNING), M(i);
}
function pe(e) {
	let t = N(e.width), n;
	switch (e.char) {
...
function he(e, t) {
	switch (e.field) {
		...
		case "min": return { minute: N(e.width) };
		case "sec": return { second: N(e.width) };
...
function ge(e, t, n = (e) => {
	...
	for (let t of e) {
		...
		if (e) {
			let r = new j(e.message, t);
			r.stack = e.stack, n(r);
		}
		o && n(new j(`Ignoring string part: ${o}`, t, j.WARNING)), a && (i.indexOf(a) === -1 ? i.push(a) : n(new j(`Duplicate ${a} token`, t)));
		let s = he(t, (e, r) => n(new j(e, t, r)));
		s && Object.assign(r, s);
	}
	return r;
}
...
var z = (e) => typeof e == "string", Se = (e) => typeof e == "function", B = /* @__PURE__ */ new Map(), V = "en";
function H(e) {
...
}), X = "%__lingui_octothorpe__%", we = (e, t, n = {}) => {
...
var De = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(xe), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? V, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), z(s) && J.test(s) ? Y(s) : z(s) ? s : Ee(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
var Ae = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/AppProviders.tsx";
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/pages/blog/BlogHeader.wrapper.tsx";
function Ke() {
	return u(Ge, { children: u(re, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
