...
var _ = (e, t) => ({
	...
	return a.i18n.locale ? o(m.Provider, {
		value: a,
		children: n
...
}, b = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/pages/careers/OpenPositions.tsx";
function x() {
	let { i18n: e } = g(), t = [{
		title: e._({
...
function le(e, t) {
	return /^::/.test(e) ? M(ce(e.substring(2)), void 0, t) : e;
}
function ue(e, t = (e) => e) {
	return F((0, E.parse)(e), t);
}
function I(e, t = (e) => e) {
	try {
		return ue(e, t);
...
var me = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(I), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? B, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), L(s) && J.test(s) ? Y(s) : L(s) ? s : pe(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
var _e = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/AppProviders.tsx";
function ve({ children: e, locale: t, messages: o }) {
	let s = i(() => ge(t, o), [t, o]), [l] = a(() => typeof performance < "u" ? performance.now() : 0);
	return r(() => {
		C("AppRoot", l);
	}, [l]), n(() => {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/pages/careers/OpenPositions.wrapper.tsx";
function Ne() {
	return c(Me, { children: c(x, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
