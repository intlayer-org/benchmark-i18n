...
var l = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), u = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	t.exports = process.env.NODE_ENV === "production" ? d() : f();
}))(), m = e(null), h = (e) => {
	let n = t(m);
...
var _ = (e, t) => ({
	...
	let r = i(() => v(e, t), [e, t]), a = (0, p.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
	return a.i18n.locale ? s(m.Provider, {
		value: a,
		children: n
...
}), Z = "%__lingui_octothorpe__%", le = (e, t, n = {}) => {
...
`)), R(s) && Y.test(s) ? X(s) : R(s) ? s : de(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
function he({ children: e, locale: t, messages: o }) {
	let c = i(() => me(t, o), [t, o]), [l] = a(() => typeof performance < "u" ? performance.now() : 0);
	return r(() => {
		S("AppRoot", l);
	}, [l]), n(() => {
