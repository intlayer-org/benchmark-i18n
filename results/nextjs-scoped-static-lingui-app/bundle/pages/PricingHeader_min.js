...
}, ne = ({ i18n: e, defaultComponent: t, children: n }) => {
	let r = a(() => te(e, t), [e, t]), i = (0, h.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
...
var re = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/MockBanner.tsx", O = () => {
	let { i18n: e } = ee();
	return u("div", {
...
}, k = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/pages/pricing/PricingHeader.tsx";
function ie() {
	return u(l, { children: [u(O, {}, void 0, !1, {
		fileName: k,
		lineNumber: 9,
		columnNumber: 7
	}, this), u("div", {
...
function ge(e, t) {
	switch (e.field) {
		...
		case "year": return ue(e, t);
		case "month": return { month: de(e, t) };
		case "day": return { day: fe(e, t) };
		case "weekday": return { weekday: pe(e, t) };
		case "period": return;
		case "hour": return me(e);
		case "min": return { minute: M(e.width) };
		case "sec": return { second: M(e.width) };
		case "tz": return { timeZoneName: he(e, t) };
		case "quarter":
		case "week":
		case "sec-frac":
...
function ye(e, t) {
	return /^::/.test(e) ? N(ve(e.substring(2)), void 0, t) : e;
}
function be(e, t = (e) => e) {
	return R((0, le.parse)(e), t);
}
function xe(e, t = (e) => e) {
	try {
		return be(e, t);
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/pages/pricing/PricingHeader.wrapper.tsx";
function Ke() {
	return u(Ge, { children: u(ie, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
