...
function z(e, t) {
	return /^::/.test(e) ? pe(L(e.substring(2)), void 0, t) : e;
}
function he(e, t = (e) => e) {
	return R((0, ae.parse)(e), t);
}
function ge(e, t = (e) => e) {
	try {
		return he(e, t);
...
var B = (e) => typeof e == "string", _e = (e) => typeof e == "function", V = /* @__PURE__ */ new Map(), H = "en";
function U(e) {
...
var Y = /\\u[a-fA-F0-9]{4}|\\x[a-fA-F0-9]{2}/, X = (e) => e.replace(/\\u([a-fA-F0-9]{4})|\\x([a-fA-F0-9]{2})/g, (e, t, n) => {
...
}), Z = "%__lingui_octothorpe__%", ye = (e, t, n = {}) => {
	...
	return {
		...
		time: (e, t) => ve(r, e, i(t) || t)
	};
}, be = (e, t) => t[e] ?? t.other;
function xe(e, t, n) {
	return (r = {}, i) => {
		let a = ye(t, n, i), o = (e, t = !1) => Array.isArray(e) ? e.reduce((e, n) => {
			if (n === "#" && t) return e + Z;
			if (B(n)) return e + n;
			let [i, s, c] = n, l = {};
...
var Se = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(ge), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? H, e.locales);
	}
	get locale() {
		return this._locale;
	}
	...
	_(e, t, n) {
		...
		if (o && a) return _e(o) ? o(this._locale, e) : o;
		a && this.emit("missing", {
			id: e,
			locale: this._locale
		});
...
`)), B(s) && Y.test(s) ? X(s) : B(s) ? s : xe(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
function Te({ children: e, locale: t, messages: n }) {
	let s = a(() => we(t, n), [t, n]), [l] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		k("AppRoot", l);
	}, [l]), r(() => {
