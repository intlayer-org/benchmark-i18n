...
var D = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/pages/settings/SettingsFooter.tsx";
function ne() {
	return l("div", {
...
function R(e, t) {
	return /^::/.test(e) ? me(I(e.substring(2)), void 0, t) : e;
}
function ge(e, t = (e) => e) {
	return L((0, oe.parse)(e), t);
}
function _e(e, t = (e) => e) {
	try {
		return ge(e, t);
...
var z = (e) => typeof e == "string", ve = (e) => typeof e == "function", B = /* @__PURE__ */ new Map(), V = "en";
function H(e) {
...
}), X = "%__lingui_octothorpe__%", be = (e, t, n = {}) => {
...
var Ce = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(_e), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? V, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), z(s) && J.test(s) ? Y(s) : z(s) ? s : Se(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
var Ee = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/AppProviders.tsx";
function De({ children: e, locale: t, messages: n }) {
	let s = a(() => Te(t, n), [t, n]), [c] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		O("AppRoot", c);
	}, [c]), r(() => {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/lingui-app/components/pages/settings/SettingsFooter.wrapper.tsx";
function He() {
	return l(Ve, { children: l(ne, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
