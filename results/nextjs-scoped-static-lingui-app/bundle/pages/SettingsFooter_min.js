...
var y = ({ children: e }) => e, b = (e) => {
	...
	return t;
}, C = ({ i18n: e, defaultComponent: t, children: r }) => {
...
function ce(e, t) {
	switch (e.field) {
		...
		case "weekday": return { weekday: ae(e, t) };
		case "period": return;
		case "hour": return oe(e);
		case "min": return { minute: j(e.width) };
		case "sec": return { second: j(e.width) };
		case "tz": return { timeZoneName: se(e, t) };
		case "quarter":
		case "week":
		case "sec-frac":
...
function F(e, t) {
	return /^::/.test(e) ? le(N(e.substring(2)), void 0, t) : e;
}
function I(e, t = (e) => e) {
	return P((0, O.parse)(e), t);
}
function L(e, t = (e) => e) {
	try {
		return I(e, t);
...
}), X = "%__lingui_octothorpe__%", he = (e, t, n = {}) => {
...
var ve = Object.defineProperty, ye = (e, t, n) => t in e ? ve(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, be = (e, t, n) => (ye(e, typeof t == "symbol" ? t : t + "", n), n), xe = class {
	constructor() {
		be(this, "_events", {});
	}
	on(e, t) {
	...
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (Ce(e, typeof t == "symbol" ? t : t + "", n), n), we = class extends xe {
	constructor(e) {
...
`)), R(s) && J.test(s) ? Y(s) : R(s) ? s : _e(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
function Ee({ children: e, locale: t, messages: n }) {
	let r = o(() => Te(t, n), [t, n]), [s] = c(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		D("AppRoot", s);
	}, [s]), i(() => {
