...
function fe(e, t) {
	switch (e.field) {
		...
		case "year": return oe(e, t);
		case "month": return { month: se(e, t) };
		case "day": return { day: ce(e, t) };
		case "weekday": return { weekday: le(e, t) };
		case "period": return;
		case "hour": return ue(e);
		case "min": return { minute: j(e.width) };
		case "sec": return { second: j(e.width) };
		case "tz": return { timeZoneName: de(e, t) };
		case "quarter":
		case "week":
		case "sec-frac":
...
function R(e, t) {
	return /^::/.test(e) ? pe(I(e.substring(2)), void 0, t) : e;
}
function z(e, t = (e) => e) {
	return L((0, ae.parse)(e), t);
}
function he(e, t = (e) => e) {
	try {
		return z(e, t);
...
var B = (e) => typeof e == "string", ge = (e) => typeof e == "function", V = /* @__PURE__ */ new Map(), H = "en";
function U(e) {
...
var Y = /\\u[a-fA-F0-9]{4}|\\x[a-fA-F0-9]{2}/, X = (e) => e.replace(/\\u([a-fA-F0-9]{4})|\\x([a-fA-F0-9]{2})/g, (e, t, n) => {
...
}), Z = "%__lingui_octothorpe__%", ve = (e, t, n = {}) => {
	...
	return {
		...
		time: (e, t) => _e(r, e, i(t) || t)
	};
}, ye = (e, t) => t[e] ?? t.other;
function be(e, t, n) {
	return (r = {}, i) => {
		let a = ve(t, n, i), o = (e, t = !1) => Array.isArray(e) ? e.reduce((e, n) => {
			if (n === "#" && t) return e + Z;
			if (B(n)) return e + n;
			let [i, s, c] = n, l = {};
...
var xe = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(he), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? H, e.locales);
	}
	get locale() {
		return this._locale;
	}
	...
	_(e, t, n) {
		...
		if (o && a) return ge(o) ? o(this._locale, e) : o;
		a && this.emit("missing", {
			id: e,
			locale: this._locale
		});
...
`)), B(s) && Y.test(s) ? X(s) : B(s) ? s : be(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
function we({ children: e, locale: t, messages: n }) {
	let s = a(() => Ce(t, n), [t, n]), [l] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		O("AppRoot", l);
	}, [l]), r(() => {
