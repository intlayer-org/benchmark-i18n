...
import s from "../i18n/locales/de/about.json";
import c from "../i18n/locales/de/blog.json";
import l from "../i18n/locales/de/careers.json";
import u from "../i18n/locales/de/contact.json";
import d from "../i18n/locales/de/faq.json";
import f from "../i18n/locales/de/home.json";
import p from "../i18n/locales/de/pricing.json";
import m from "../i18n/locales/de/products.json";
import h from "../i18n/locales/de/route.json";
import g from "../i18n/locales/de/settings.json";
import _ from "../i18n/locales/de/shared.json";
import v from "../i18n/locales/de/team.json";
import y from "../i18n/locales/es/about.json";
import b from "../i18n/locales/es/blog.json";
import x from "../i18n/locales/es/careers.json";
import ee from "../i18n/locales/es/contact.json";
import S from "../i18n/locales/es/faq.json";
import C from "../i18n/locales/es/home.json";
import w from "../i18n/locales/es/pricing.json";
import T from "../i18n/locales/es/products.json";
import E from "../i18n/locales/es/route.json";
import D from "../i18n/locales/es/settings.json";
import te from "../i18n/locales/es/shared.json";
import ne from "../i18n/locales/es/team.json";
import re from "../i18n/locales/fr/about.json";
import ie from "../i18n/locales/fr/blog.json";
import ae from "../i18n/locales/fr/careers.json";
import oe from "../i18n/locales/fr/contact.json";
import se from "../i18n/locales/fr/faq.json";
import ce from "../i18n/locales/fr/home.json";
import le from "../i18n/locales/fr/pricing.json";
import ue from "../i18n/locales/fr/products.json";
import de from "../i18n/locales/fr/route.json";
import fe from "../i18n/locales/fr/settings.json";
import pe from "../i18n/locales/fr/shared.json";
import me from "../i18n/locales/fr/team.json";
import he from "../i18n/locales/it/about.json";
import ge from "../i18n/locales/it/blog.json";
import _e from "../i18n/locales/it/careers.json";
import ve from "../i18n/locales/it/contact.json";
import ye from "../i18n/locales/it/faq.json";
import be from "../i18n/locales/it/home.json";
import xe from "../i18n/locales/it/pricing.json";
import Se from "../i18n/locales/it/products.json";
import Ce from "../i18n/locales/it/route.json";
import we from "../i18n/locales/it/settings.json";
import Te from "../i18n/locales/it/shared.json";
import Ee from "../i18n/locales/it/team.json";
import De from "../i18n/locales/ja/about.json";
import Oe from "../i18n/locales/ja/blog.json";
import ke from "../i18n/locales/ja/careers.json";
import Ae from "../i18n/locales/ja/contact.json";
import je from "../i18n/locales/ja/faq.json";
import Me from "../i18n/locales/ja/home.json";
import Ne from "../i18n/locales/ja/pricing.json";
import Pe from "../i18n/locales/ja/products.json";
import Fe from "../i18n/locales/ja/route.json";
import Ie from "../i18n/locales/ja/settings.json";
import Le from "../i18n/locales/ja/shared.json";
import Re from "../i18n/locales/ja/team.json";
import ze from "../i18n/locales/ko/about.json";
import Be from "../i18n/locales/ko/blog.json";
import Ve from "../i18n/locales/ko/careers.json";
import He from "../i18n/locales/ko/contact.json";
import Ue from "../i18n/locales/ko/faq.json";
import We from "../i18n/locales/ko/home.json";
import Ge from "../i18n/locales/ko/pricing.json";
import Ke from "../i18n/locales/ko/products.json";
import qe from "../i18n/locales/ko/route.json";
import Je from "../i18n/locales/ko/settings.json";
import Ye from "../i18n/locales/ko/shared.json";
import Xe from "../i18n/locales/ko/team.json";
import Ze from "../i18n/locales/pt/about.json";
import Qe from "../i18n/locales/pt/blog.json";
import $e from "../i18n/locales/pt/careers.json";
import et from "../i18n/locales/pt/contact.json";
import tt from "../i18n/locales/pt/faq.json";
import nt from "../i18n/locales/pt/home.json";
import rt from "../i18n/locales/pt/pricing.json";
import it from "../i18n/locales/pt/products.json";
import at from "../i18n/locales/pt/route.json";
import ot from "../i18n/locales/pt/settings.json";
import st from "../i18n/locales/pt/shared.json";
import ct from "../i18n/locales/pt/team.json";
import lt from "../i18n/locales/ru/about.json";
import ut from "../i18n/locales/ru/blog.json";
import dt from "../i18n/locales/ru/careers.json";
import ft from "../i18n/locales/ru/contact.json";
import pt from "../i18n/locales/ru/faq.json";
import mt from "../i18n/locales/ru/home.json";
import ht from "../i18n/locales/ru/pricing.json";
import gt from "../i18n/locales/ru/products.json";
import _t from "../i18n/locales/ru/route.json";
import vt from "../i18n/locales/ru/settings.json";
import yt from "../i18n/locales/ru/shared.json";
import bt from "../i18n/locales/ru/team.json";
import xt from "../i18n/locales/zh/about.json";
import St from "../i18n/locales/zh/blog.json";
import Ct from "../i18n/locales/zh/careers.json";
import wt from "../i18n/locales/zh/contact.json";
import Tt from "../i18n/locales/zh/faq.json";
import Et from "../i18n/locales/zh/home.json";
import Dt from "../i18n/locales/zh/pricing.json";
import Ot from "../i18n/locales/zh/products.json";
import kt from "../i18n/locales/zh/route.json";
import At from "../i18n/locales/zh/settings.json";
import jt from "../i18n/locales/zh/shared.json";
import Mt from "../i18n/locales/zh/team.json";
import { jsx as O } from "react/jsx-runtime";
var k = (e) => typeof e == "string", A = () => {
	let e, t, n = new Promise((n, r) => {
		e = n, t = r;
	});
	return n.resolve = e, n.reject = t, n;
}, j = (e) => e == null ? "" : String(e), Nt = (e, t, n) => {
	e.forEach((e) => {
		t[e] && (n[e] = t[e]);
	});
}, Pt = /###/g, M = (e) => e && e.includes("###") ? e.replace(Pt, ".") : e, Ft = (e) => !e || k(e), N = (e, t, n) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? k(e[r]) || e[r] instanceof String || k(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : F(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, I = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), zt = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, Bt = (e) => k(e) ? e.replace(/[&<>"'\/]/g, (e) => zt[e]) : e, Vt = class {
	constructor(e) {
	...
	"!",
	";"
], Ut = new Vt(20), Wt = (e, t, n) => {
	t ||= "", n ||= "";
	let r = Ht.filter((e) => !t.includes(e) && !n.includes(e));
	if (r.length === 0) return !0;
	let i = Ut.getRegExp(`(${r.map((e) => e === "?" ? "\\?" : e).join("|")})`), a = !i.test(e);
	if (!a) {
		let t = e.indexOf(n);
	...
	getResource(e, t, n, r = {}) {
		...
		e.includes(".") ? o = e.split(".") : (o = [e, t], n && (Array.isArray(n) ? o.push(...n) : k(n) && i ? o.push(...n.split(i)) : o.push(n)));
		let s = P(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !k(n) ? s : L(this.data?.[e]?.[t], n, i);
	}
	addResource(e, t, n, r, i = { silent: !1 }) {
		let a = i.keySeparator === void 0 ? this.options.keySeparator : i.keySeparator, o = [e, t];
		n && (o = o.concat(a ? n.split(a) : n)), e.includes(".") && (o = e.split("."), r = t, t = o[1]), this.addNamespaces(t), It(this.data, o, r), i.silent || this.emit("added", e, t, n, r);
	}
	...
	addResourceBundle(e, t, n, r, i, a = {
		...
		a.skipCopy || (n = JSON.parse(JSON.stringify(n))), r ? F(s, n, i) : s = {
			...s,
			...n
		}, It(this.data, o, s), a.silent || this.emit("added", e, t, n);
	}
...
}, U = Symbol("i18next/PATH_KEY");
function Kt() {
	let e = [], t = Object.create(null), n;
	return t.get = (r, i) => (n?.revoke?.(), i === U ? e : (e.push(i), n = Proxy.revocable(r, t), n.proxy)), Proxy.revocable(Object.create(null), t).proxy;
}
function W(e, t) {
	let { [U]: n } = e(Kt()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var G = (e) => !k(e) && typeof e != "boolean" && typeof e != "number", K = class e extends B {
	constructor(e, t = {}) {
		super(), Nt([
			"resourceStore",
			"languageUtils",
	...
	extractFromKey(e, t) {
		...
		n === void 0 && (n = ":");
		let r = t.keySeparator === void 0 ? this.options.keySeparator : t.keySeparator, i = t.ns || this.options.defaultNS || [], a = n && e.includes(n), o = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !Wt(e, n, r);
		if (a && !o) {
	...
	translate(t, n, r) {
		...
		typeof t == "function" && (t = W(t, {
			...this.options,
			...i
		})), Array.isArray(t) || (t = [String(t)]), t = t.map((e) => typeof e == "function" ? W(e, {
			...this.options,
			...i
		}) : String(e));
		...
		y && !m && x && (T = w);
		let E = G(T), D = Object.prototype.toString.apply(T);
		if (y && T && E && !_.includes(D) && !(k(v) && Array.isArray(T))) {
	...
	extendTranslation(e, t, n, r, i) {
		...
		return e != null && o?.length && n.applyPostProcessor !== !1 && (e = H.handle(o, e, t, this.options && this.options.postProcessPassResolved ? {
			i18nResolved: {
				...r,
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return k(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? W(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	toResolveHierarchy(e, t) {
		...
		return k(e) && (e.includes("-") || e.includes("_")) ? (this.options.load !== "languageOnly" && i(this.formatLanguageCode(e)), this.options.load !== "languageOnly" && this.options.load !== "currentOnly" && i(this.getScriptPartFromCode(e)), this.options.load !== "currentOnly" && i(this.getLanguagePartFromCode(e))) : k(e) && i(this.formatLanguageCode(e)), n.forEach((e) => {
	...
	getRule(e, t = {}) {
		...
		try {
			...
			if (typeof Intl > "u") return this.logger.error("No Intl support, please use an Intl polyfill!"), qt;
			if (!e.match(/-|_/)) return qt;
	...
	getSuffixes(e, t = {}) {
		let n = this.getRule(e, t);
		return n ||= this.getRule("dev", t), n ? n.resolvedOptions().pluralCategories.sort((e, t) => J[e] - J[t]).map((e) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${e}`) : [];
	}
	getSuffix(e, t, n = {}) {
	...
	let a = Rt(e, t, n);
	return !a && i && k(n) && (a = L(e, n, r), a === void 0 && (a = L(t, n, r))), a;
}, Y = (e) => e.replace(/\$/g, "$$$$"), Xt = class {
	constructor(e = {}) {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? Bt : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? I(i) : a || "{{", this.suffix = o ? I(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? I(d) : f || I("$t("), this.nestingSuffix = p ? I(p) : m || I(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		let i, a, o, s = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (e) => {
			if (!e.includes(this.formatSeparator)) {
				let i = Yt(t, s, e, this.options.keySeparator, this.options.ignoreJSONStructure);
			...
			return this.format(Yt(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
				...r,
				...t,
				interpolationkey: a
			});
		...
		return [{
			...
			regex: this.regexp,
			safeValue: (e) => this.escapeValue ? Y(this.escape(e)) : Y(e)
		}].forEach((t) => {
			for (o = 0; i = t.regex.exec(e);) {
				...
				else !k(a) && !this.useRawValueToEscape && (a = j(a));
				let s = t.safeValue(a);
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			k(i) || (i = j(i)), i ||= (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), ""), s.length && (i = s.reduce((e, t) => this.format(e, t, n.lng, {
				...n,
	...
	addCached(e, t) {
		this.formats[e.toLowerCase().trim()] = Qt(t);
	}
	format(e, t, n, r = {}) {
		...
		return i.reduce((e, t) => {
			let { formatName: i, formatOptions: a } = Zt(t);
			if (this.formats[i]) {
				let t = e;
				try {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			Lt(n.loaded, [i], a), tn(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), rn = (e) => (k(e.ns) && (e.ns = [e.ns]), k(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), k(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), Z = () => {}, an = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Q = class e extends B {
	constructor(e = {}, t) {
		if (super(), this.options = rn(e), this.services = {}, this.logger = z, this.modules = { external: [] }, an(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		this.isInitializing = !0, typeof e == "function" && (t = e, e = {}), e.defaultNS == null && e.ns && (k(e.ns) ? e.defaultNS = e.ns : e.ns.includes("translation") || (e.defaultNS = e.ns[0]));
		let n = X();
		this.options = {
			...n,
			...this.options,
		...
		if (!this.options.isClone) {
			...
			let e;
			e = this.modules.formatter ? this.modules.formatter : en;
			let t = new q(this.options);
			this.store = new V(this.options.resources, this.options);
			let n = this.services;
			n.logger = z, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new Jt(t, { prepend: this.options.pluralSeparator }), e && (n.formatter = r(e), n.formatter.init && n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new Xt(this.options), n.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }, n.backendConnector = new nn(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (e, ...t) => {
				this.emit(e, ...t);
	...
	use(e) {
		...
		return e.type === "backend" && (this.modules.backend = e), (e.type === "logger" || e.log && e.warn && e.error) && (this.modules.logger = e), e.type === "languageDetector" && (this.modules.languageDetector = e), e.type === "i18nFormat" && (this.modules.i18nFormat = e), e.type === "postProcessor" && H.addPostProcessor(e), e.type === "formatter" && (this.modules.formatter = e), e.type === "3rdParty" && this.modules.external.push(e), this;
	}
	...
	getFixedT(e, t, n) {
		let r = (e, t, ...i) => {
			...
			typeof a.keyPrefix == "function" && (a.keyPrefix = W(a.keyPrefix, o));
			let s = this.options.keySeparator || ".", c;
			return a.keyPrefix && Array.isArray(e) ? c = e.map((e) => (typeof e == "function" && (e = W(e, o)), `${a.keyPrefix}${s}${e}`)) : (typeof e == "function" && (e = W(e, o)), c = a.keyPrefix ? `${a.keyPrefix}${s}${e}` : e), this.t(c, a);
		};
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new q(X());
	...
	cloneInstance(t = {}, n = Z) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a[e] = this[e];
		}), a.services = { ...this.services }, a.services.utils = { hasLoadedNamespace: a.hasLoadedNamespace.bind(a) }, r && (a.store = new V(Object.keys(this.store.data).reduce((e, t) => (e[t] = { ...this.store.data[t] }, e[t] = Object.keys(e[t]).reduce((n, r) => (n[r] = { ...e[t][r] }, n), e[t]), e), {}), i), a.services.resourceStore = a.store), t.interpolation) {
			let e = {
				...X().interpolation,
				...this.options.interpolation,
				...t.interpolation
			...
			a.services.interpolator = new Xt(n);
		}
		return a.translator = new K(a.services, i), a.translator.on("*", (e, ...t) => {
			a.emit(e, ...t);
...
var on = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, sn = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
...
function pn({ i18n: e, defaultNS: n, children: r }) {
	let a = i(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
	return t(fn.Provider, { value: a }, r);
}
function mn() {
	if (!(typeof window > "u")) {
...
function Mn({ children: e }) {
	return O(jn, { children: e });
}
function Nn() {
	return O(Mn, { children: O(jn, {}) });
}
