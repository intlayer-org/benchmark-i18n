...
var c = (e) => typeof e == "string", l = () => {
...
}, u = (e) => e == null ? "" : String(e), d = (e, t, n) => {
	e.forEach((e) => {
		t[e] && (n[e] = t[e]);
	});
}, f = /###/g, p = (e) => e && e.includes("###") ? e.replace(f, ".") : e, m = (e) => !e || c(e), h = (e, t, n) => {
	let r = c(t) ? t.split(".") : t, i = 0;
	for (; i < r.length - 1;) {
		if (m(e)) return {};
		let t = p(r[i]);
	...
	let a = t[t.length - 1], o = t.slice(0, t.length - 1), s = h(e, o, Object);
	for (; s.obj === void 0 && o.length;) a = `${o[o.length - 1]}.${a}`, o = o.slice(0, o.length - 1), s = h(e, o, Object), s?.obj && s.obj[`${s.k}.${a}`] !== void 0 && (s.obj = void 0);
	s.obj[`${s.k}.${a}`] = n;
}, _ = (e, t, n, r) => {
	let { obj: i, k: a } = h(e, t, Object);
	i[a] = i[a] || [], i[a].push(n);
}, v = (e, t) => {
	let { obj: n, k: r } = h(e, t);
	...
	let r = v(e, n);
	return r === void 0 ? v(t, n) : r;
}, b = (e, t, n) => {
	for (let r in t) r !== "__proto__" && r !== "constructor" && (Object.prototype.hasOwnProperty.call(e, r) ? c(e[r]) || e[r] instanceof String || c(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : b(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, x = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), S = {
	"&": "&amp;",
	"<": "&lt;",
	...
	forward(e, t, n, r) {
		return r && !this.debug ? null : (e = e.map((e) => c(e) ? e.replace(/[\r\n\x00-\x1F\x7F]/g, " ") : e), c(e[0]) && (e[0] = `${n}${this.prefix} ${e[0]}`), this.logger[t](e));
	}
	create(t) {
	...
	addResource(e, t, n, r, i = { silent: !1 }) {
		...
		n && (o = o.concat(a ? n.split(a) : n)), e.includes(".") && (o = e.split("."), r = t, t = o[1]), this.addNamespaces(t), g(this.data, o, r), i.silent || this.emit("added", e, t, n, r);
	}
	addResources(e, t, n, r = { silent: !1 }) {
		for (let r in n) (c(n[r]) || Array.isArray(n[r])) && this.addResource(e, t, r, n[r], { silent: !0 });
	...
	addResourceBundle(e, t, n, r, i, a = {
		...
		a.skipCopy || (n = JSON.parse(JSON.stringify(n))), r ? b(s, n, i) : s = {
			...s,
			...n
		}, g(this.data, o, s), a.silent || this.emit("added", e, t, n);
	}
...
var I = (e) => !c(e) && typeof e != "boolean" && typeof e != "number", L = class e extends j {
	...
	translate(t, n, r) {
		...
		let a = i.returnDetails === void 0 ? this.options.returnDetails : i.returnDetails, o = i.keySeparator === void 0 ? this.options.keySeparator : i.keySeparator, { key: s, namespaces: l } = this.extractFromKey(t[t.length - 1], i), u = l[l.length - 1], d = i.nsSeparator === void 0 ? this.options.nsSeparator : i.nsSeparator;
		d === void 0 && (d = ":");
		...
		if (b && D && O && !v.includes(k) && !(c(y) && Array.isArray(D))) {
			...
			if (n || e || c) {
				...
				let n = (e, t, n) => {
					let r = S && n !== h ? n : a;
					this.options.missingKeyHandler ? this.options.missingKeyHandler(e, u, t, r, c, i) : this.backendConnector?.saveMissing && this.backendConnector.saveMissing(e, u, t, r, c, i), this.emit("missingKey", e, u, t, h);
				};
	...
	extendTranslation(e, t, n, r, i) {
		if (this.i18nFormat?.parse) e = this.i18nFormat.parse(e, {
			...
			let a = c(e) && (n?.interpolation?.skipOnVariables === void 0 ? this.options.interpolation.skipOnVariables : n.interpolation.skipOnVariables), o;
			if (a) {
				let t = e.match(this.interpolator.nestingRegexp);
				o = t && t.length;
			}
			let s = n.replace && !c(n.replace) ? n.replace : n;
	...
	resolve(e, t = {}) {
		...
		return c(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? F(e, {
			...
			let s = this.extractFromKey(e, t), l = s.key;
			r = l;
			let u = s.namespaces;
			this.options.fallbackNS && (u = u.concat(this.options.fallbackNS));
			let d = t.count !== void 0 && !c(t.count), f = d && !t.ordinal && t.count === 0, p = t.context !== void 0 && (c(t.context) || typeof t.context == "number") && t.context !== "", m = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
			u.forEach((e) => {
	...
	getUsedParamsDetails(e = {}) {
		let t = [
			...
			"postProcess",
			"interpolation"
		], n = e.replace && !c(e.replace), r = n ? e.replace : e;
	...
	toResolveHierarchy(e, t) {
		...
		let i = t === void 0 || t === !1 || c(t), a = t === void 0 && typeof this.options.fallbackLng == "function", o = c(e) && i && !a, s = null;
		if (o) {
			let n;
		...
		return c(e) && (e.includes("-") || e.includes("_")) ? (this.options.load !== "languageOnly" && d(this.formatLanguageCode(e)), this.options.load !== "languageOnly" && this.options.load !== "currentOnly" && d(this.getScriptPartFromCode(e)), this.options.load !== "currentOnly" && d(this.getLanguagePartFromCode(e))) : c(e) && d(this.formatLanguageCode(e)), l.forEach((e) => {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? C : t, this.escapeValue = n === void 0 || n, this.useRawValueToEscape = r !== void 0 && r, this.prefix = i ? x(i) : a || "{{", this.suffix = o ? x(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u ? x(u) : "-", this.unescapeSuffix = this.unescapePrefix ? "" : l ? x(l) : "", this.nestingPrefix = d ? x(d) : f || x("$t("), this.nestingSuffix = p ? x(p) : m || x(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ !== void 0 && _, this.resetRegExp();
	}
	reset() {
	...
	nest(e, t, n = {}) {
		let r, i, a, o = (e, t) => {
			...
			let r = e.split(RegExp(`${x(n)}[ ]*{`)), i = `{${r[1]}`;
		...
		for (; r = this.nestingRegexp.exec(e);) {
			let s = [];
			a = { ...n }, a = a.replace && !c(a.replace) ? a.replace : a, a.applyPostProcessor = !1, delete a.defaultValue;
			let l = /{.*}/s.test(r[1]) ? r[1].lastIndexOf("}") + 1 : r[1].indexOf(this.formatSeparator);
			if (l !== -1 && (s = r[1].slice(l).split(this.formatSeparator).map((e) => e.trim()).filter(Boolean), r[1] = r[1].slice(0, l)), i = t(o.call(this, r[1].trim(), a), a), i && r[0] === e && !c(i)) return i;
	...
	overloadTranslationOptionHandler: (e) => {
		let t = {};
		if (typeof e[1] == "object" && (t = e[1]), c(e[1]) && (t.defaultValue = e[1]), c(e[2]) && (t.tDescription = e[2]), typeof e[2] == "object" || typeof e[3] == "object") {
			let n = e[3] || e[2];
	...
	changeLanguage(e, t) {
		...
		let r = (e) => {
			...
			let n = c(t) ? t : t && t[0], a = this.store.hasLanguageSomeTranslations(n) ? n : this.services.languageUtils.getBestMatchFromCodes(c(t) ? [t] : t);
	...
	loadNamespaces(e, t) {
		let n = l();
		return this.options.ns ? (c(e) && (e = [e]), e.forEach((e) => {
			this.options.ns.includes(e) || this.options.ns.push(e);
...
var Z = J, Nn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/components/AppProviders.tsx";
...
var Pn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/scripts/Wrapper.tsx";
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/components/AppProviders.wrapper.tsx";
function In() {
	return s(Fn, { children: s(Q, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
