...
var Vt = ({ href: e, children: t, ...n }) => {
	let r = u().locale ?? "en";
	return e == null || typeof e != "string" || zt(e) ? d(l, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, Ht = (e) => e == null ? "" : String(e), Ut = (e, t, n) => {
	e.forEach((e) => {
		t[e] && (n[e] = t[e]);
	});
}, Wt = /###/g, Gt = (e) => e && e.includes("###") ? e.replace(Wt, ".") : e, Kt = (e) => !e || A(e), M = (e, t, n) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? A(e[r]) || e[r] instanceof String || A(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : Xt(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, P = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), Zt = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, Qt = (e) => A(e) ? e.replace(/[&<>"'\/]/g, (e) => Zt[e]) : e, $t = class {
	constructor(e) {
	...
	addResource(e, t, n, r, i = { silent: !1 }) {
		...
		n && (o = o.concat(a ? n.split(a) : n)), e.includes(".") && (o = e.split("."), r = t, t = o[1]), this.addNamespaces(t), qt(this.data, o, r), i.silent || this.emit("added", e, t, n, r);
	}
	...
	addResourceBundle(e, t, n, r, i, a = {
		...
		a.skipCopy || (n = JSON.parse(JSON.stringify(n))), r ? Xt(s, n, i) : s = {
			...s,
			...n
		}, qt(this.data, o, s), a.silent || this.emit("added", e, t, n);
	}
...
var B = (e) => !A(e) && typeof e != "boolean" && typeof e != "number", V = class e extends R {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? Qt : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? P(i) : a || "{{", this.suffix = o ? P(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? P(d) : f || P("$t("), this.nestingSuffix = p ? P(p) : m || P(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				else !A(a) && !this.useRawValueToEscape && (a = Ht(a));
				let s = t.safeValue(a);
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			A(i) || (i = Ht(i)), i ||= (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), ""), s.length && (i = s.reduce((e, t) => this.format(e, t, n.lng, {
				...n,
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			Jt(n.loaded, [i], a), _n(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), yn = (e) => (A(e.ns) && (e.ns = [e.ns]), A(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), A(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), K = () => {}, bn = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, q = class e extends R {
	constructor(e = {}, t) {
		if (super(), this.options = yn(e), this.services = {}, this.logger = L, this.modules = { external: [] }, bn(this), t && !this.isInitialized && !e.isClone) {
...
var xn = (e, t, n, r) => {
	...
	Z(n) && Sn[n] || (Z(n) && (Sn[n] = /* @__PURE__ */ new Date()), xn(e, t, n, r));
}, Cn = (e, t) => () => {
...
}, wn = (e, t, n = {}) => !t.languages || !t.languages.length ? (J(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Z = (e) => typeof e == "string", Tn = (e) => typeof e == "object" && !!e, En = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Dn = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (Z(t)) return t;
		if (Tn(t) && Z(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: a } = t, { i18n: l, defaultNS: u } = r(Fn) || {}, d = a || l || Nn();
	d && !d.reportNamespaces && (d.reportNamespaces = new In()), d || J(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = o(() => ({
		...An(),
		...d?.options?.react,
		...t
	...
	let v = s(0), y = n((e) => {
		...
		if (!d) return Bn;
		let e = !!(d.isInitialized || d.initializedStoreOnce) && _.every((e) => wn(e, d, f)), n = t.lng || d.language, r = v.current, i = b.current;
...
function Un({ i18n: e, defaultNS: n, children: r }) {
	let i = o(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
	return t(Fn.Provider, { value: i }, r);
}
function Wn() {
	let { t: e } = Hn("shared"), t = [
		{
...
function lr({ children: e }) {
	return d(cr, { children: e });
}
function ur() {
	return d(lr, { children: d(Wn, {}) });
}
