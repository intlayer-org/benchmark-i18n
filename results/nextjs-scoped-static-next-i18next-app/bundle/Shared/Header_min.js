...
import g from "../i18n/locales/de/about.json";
import _ from "../i18n/locales/de/blog.json";
import v from "../i18n/locales/de/careers.json";
import y from "../i18n/locales/de/contact.json";
import b from "../i18n/locales/de/faq.json";
import x from "../i18n/locales/de/home.json";
import S from "../i18n/locales/de/pricing.json";
import C from "../i18n/locales/de/products.json";
import w from "../i18n/locales/de/route.json";
import T from "../i18n/locales/de/settings.json";
import E from "../i18n/locales/de/shared.json";
import D from "../i18n/locales/de/team.json";
import O from "../i18n/locales/es/about.json";
import ee from "../i18n/locales/es/blog.json";
import te from "../i18n/locales/es/careers.json";
import ne from "../i18n/locales/es/contact.json";
import re from "../i18n/locales/es/faq.json";
import ie from "../i18n/locales/es/home.json";
import ae from "../i18n/locales/es/pricing.json";
import oe from "../i18n/locales/es/products.json";
import se from "../i18n/locales/es/route.json";
import ce from "../i18n/locales/es/settings.json";
import le from "../i18n/locales/es/shared.json";
import ue from "../i18n/locales/es/team.json";
import de from "../i18n/locales/fr/about.json";
import fe from "../i18n/locales/fr/blog.json";
import pe from "../i18n/locales/fr/careers.json";
import me from "../i18n/locales/fr/contact.json";
import he from "../i18n/locales/fr/faq.json";
import ge from "../i18n/locales/fr/home.json";
import _e from "../i18n/locales/fr/pricing.json";
import ve from "../i18n/locales/fr/products.json";
import ye from "../i18n/locales/fr/route.json";
import be from "../i18n/locales/fr/settings.json";
import xe from "../i18n/locales/fr/shared.json";
import Se from "../i18n/locales/fr/team.json";
import Ce from "../i18n/locales/it/about.json";
import we from "../i18n/locales/it/blog.json";
import Te from "../i18n/locales/it/careers.json";
import Ee from "../i18n/locales/it/contact.json";
import De from "../i18n/locales/it/faq.json";
import Oe from "../i18n/locales/it/home.json";
import ke from "../i18n/locales/it/pricing.json";
import Ae from "../i18n/locales/it/products.json";
import je from "../i18n/locales/it/route.json";
import Me from "../i18n/locales/it/settings.json";
import Ne from "../i18n/locales/it/shared.json";
import Pe from "../i18n/locales/it/team.json";
import Fe from "../i18n/locales/ja/about.json";
import Ie from "../i18n/locales/ja/blog.json";
import Le from "../i18n/locales/ja/careers.json";
import Re from "../i18n/locales/ja/contact.json";
import ze from "../i18n/locales/ja/faq.json";
import Be from "../i18n/locales/ja/home.json";
import Ve from "../i18n/locales/ja/pricing.json";
import He from "../i18n/locales/ja/products.json";
import Ue from "../i18n/locales/ja/route.json";
import We from "../i18n/locales/ja/settings.json";
import Ge from "../i18n/locales/ja/shared.json";
import Ke from "../i18n/locales/ja/team.json";
import qe from "../i18n/locales/ko/about.json";
import Je from "../i18n/locales/ko/blog.json";
import Ye from "../i18n/locales/ko/careers.json";
import Xe from "../i18n/locales/ko/contact.json";
import Ze from "../i18n/locales/ko/faq.json";
import Qe from "../i18n/locales/ko/home.json";
import $e from "../i18n/locales/ko/pricing.json";
import et from "../i18n/locales/ko/products.json";
import tt from "../i18n/locales/ko/route.json";
import nt from "../i18n/locales/ko/settings.json";
import rt from "../i18n/locales/ko/shared.json";
import it from "../i18n/locales/ko/team.json";
import at from "../i18n/locales/pt/about.json";
import ot from "../i18n/locales/pt/blog.json";
import st from "../i18n/locales/pt/careers.json";
import ct from "../i18n/locales/pt/contact.json";
import lt from "../i18n/locales/pt/faq.json";
import ut from "../i18n/locales/pt/home.json";
import dt from "../i18n/locales/pt/pricing.json";
import ft from "../i18n/locales/pt/products.json";
import pt from "../i18n/locales/pt/route.json";
import mt from "../i18n/locales/pt/settings.json";
import ht from "../i18n/locales/pt/shared.json";
import gt from "../i18n/locales/pt/team.json";
import _t from "../i18n/locales/ru/about.json";
import vt from "../i18n/locales/ru/blog.json";
import yt from "../i18n/locales/ru/careers.json";
import bt from "../i18n/locales/ru/contact.json";
import xt from "../i18n/locales/ru/faq.json";
import St from "../i18n/locales/ru/home.json";
import Ct from "../i18n/locales/ru/pricing.json";
import wt from "../i18n/locales/ru/products.json";
import Tt from "../i18n/locales/ru/route.json";
import Et from "../i18n/locales/ru/settings.json";
import Dt from "../i18n/locales/ru/shared.json";
import Ot from "../i18n/locales/ru/team.json";
import kt from "../i18n/locales/zh/about.json";
import At from "../i18n/locales/zh/blog.json";
import jt from "../i18n/locales/zh/careers.json";
import Mt from "../i18n/locales/zh/contact.json";
import Nt from "../i18n/locales/zh/faq.json";
import Pt from "../i18n/locales/zh/home.json";
import Ft from "../i18n/locales/zh/pricing.json";
import It from "../i18n/locales/zh/products.json";
import Lt from "../i18n/locales/zh/route.json";
import Rt from "../i18n/locales/zh/settings.json";
import zt from "../i18n/locales/zh/shared.json";
import Bt from "../i18n/locales/zh/team.json";
var k = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), Vt = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
var j = ({ href: e, children: t, ...n }) => {
	let r = u().locale ?? "en";
	return e == null || typeof e != "string" || Ht(e) ? p(l, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, M = (e) => typeof e == "string", N = () => {
	let e, t, n = new Promise((n, r) => {
		e = n, t = r;
	});
	return n.resolve = e, n.reject = t, n;
}, Ut = (e) => e == null ? "" : String(e), Wt = (e, t, n) => {
	e.forEach((e) => {
		t[e] && (n[e] = t[e]);
	});
}, Gt = /###/g, Kt = (e) => e && e.includes("###") ? e.replace(Gt, ".") : e, qt = (e) => !e || M(e), P = (e, t, n) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? M(e[r]) || e[r] instanceof String || M(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : Xt(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, L = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), Zt = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, Qt = (e) => M(e) ? e.replace(/[&<>"'\/]/g, (e) => Zt[e]) : e, $t = class {
	constructor(e) {
	...
	"!",
	";"
], tn = new $t(20), nn = (e, t, n) => {
	t ||= "", n ||= "";
	let r = en.filter((e) => !t.includes(e) && !n.includes(e));
	if (r.length === 0) return !0;
	let i = tn.getRegExp(`(${r.map((e) => e === "?" ? "\\?" : e).join("|")})`), a = !i.test(e);
	if (!a) {
		let t = e.indexOf(n);
	...
	getResource(e, t, n, r = {}) {
		...
		let s = I(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !M(n) ? s : R(this.data?.[e]?.[t], n, i);
	}
	addResource(e, t, n, r, i = { silent: !1 }) {
		let a = i.keySeparator === void 0 ? this.options.keySeparator : i.keySeparator, o = [e, t];
		n && (o = o.concat(a ? n.split(a) : n)), e.includes(".") && (o = e.split("."), r = t, t = o[1]), this.addNamespaces(t), F(this.data, o, r), i.silent || this.emit("added", e, t, n, r);
	}
	...
	addResourceBundle(e, t, n, r, i, a = {
		...
		let s = I(this.data, o) || {};
		a.skipCopy || (n = JSON.parse(JSON.stringify(n))), r ? Xt(s, n, i) : s = {
			...s,
			...n
		}, F(this.data, o, s), a.silent || this.emit("added", e, t, n);
	}
...
function cn() {
	...
	return t.get = (r, i) => (n?.revoke?.(), i === sn ? e : (e.push(i), n = Proxy.revocable(r, t), n.proxy)), Proxy.revocable(Object.create(null), t).proxy;
}
function H(e, t) {
	let { [sn]: n } = e(cn()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var U = (e) => !M(e) && typeof e != "boolean" && typeof e != "number", ln = class e extends V {
	constructor(e, t = {}) {
		super(), Wt([
			"resourceStore",
			"languageUtils",
			...
			"i18nFormat",
			"utils"
		], e, this), this.options = t, this.options.keySeparator === void 0 && (this.options.keySeparator = "."), this.logger = B.create("translator"), this.checkedLoadedFor = {};
	}
	changeLanguage(e) {
		e && (this.language = e);
	}
	...
	extractFromKey(e, t) {
		...
		n === void 0 && (n = ":");
		let r = t.keySeparator === void 0 ? this.options.keySeparator : t.keySeparator, i = t.ns || this.options.defaultNS || [], a = n && e.includes(n), o = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !nn(e, n, r);
		if (a && !o) {
	...
	translate(t, n, r) {
		...
		let p = this.resolve(t, i), m = p?.res, h = p?.usedKey || s, g = p?.exactUsedKey || s, _ = [
			...
			"[object Function]",
			"[object RegExp]"
		], v = i.joinArrays === void 0 ? this.options.joinArrays : i.joinArrays, y = !this.i18nFormat || this.i18nFormat.handleAsObject, b = i.count !== void 0 && !M(i.count), x = e.hasDefaultValue(i), S = b ? this.pluralResolver.getSuffix(d, i.count, i) : "", C = i.ordinal && b ? this.pluralResolver.getSuffix(d, i.count, { ordinal: !1 }) : "", w = b && !i.ordinal && i.count === 0, T = w && i[`defaultValue${this.options.pluralSeparator}zero`] || i[`defaultValue${S}`] || i[`defaultValue${C}`] || i.defaultValue, E = m;
		y && !m && x && (E = T);
		let D = U(E), O = Object.prototype.toString.apply(E);
		if (y && E && D && !_.includes(O) && !(M(v) && Array.isArray(E))) {
		...
		} else if (y && M(v) && Array.isArray(m)) m = m.join(v), m &&= this.extendTranslation(m, t, i, r);
		else {
			let e = !1, n = !1;
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return M(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? H(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	getScriptPartFromCode(e) {
		if (e = z(e), !e || !e.includes("-")) return null;
		let t = e.split("-");
		return t.length === 2 || (t.pop(), t[t.length - 1].toLowerCase() === "x") ? null : this.formatLanguageCode(t.join("-"));
	}
	getLanguagePartFromCode(e) {
		if (e = z(e), !e || !e.includes("-")) return e;
		let t = e.split("-");
	...
	getRule(e, t = {}) {
		let n = z(e === "dev" ? "en" : e), r = t.ordinal ? "ordinal" : "cardinal", i = JSON.stringify({
			cleanedCode: n,
			type: r
		});
		...
		try {
			...
			if (typeof Intl > "u") return this.logger.error("No Intl support, please use an Intl polyfill!"), fn;
	...
	getSuffixes(e, t = {}) {
		let n = this.getRule(e, t);
		return n ||= this.getRule("dev", t), n ? n.resolvedOptions().pluralCategories.sort((e, t) => dn[e] - dn[t]).map((e) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${e}`) : [];
	}
	getSuffix(e, t, n = {}) {
	...
	let a = Yt(e, t, n);
	return !a && i && M(n) && (a = R(e, n, r), a === void 0 && (a = R(t, n, r))), a;
}, W = (e) => e.replace(/\$/g, "$$$$"), hn = class {
	constructor(e = {}) {
		this.logger = B.create("interpolator"), this.options = e, this.format = e?.interpolation?.format || ((e) => e), this.init(e);
	}
	init(e = {}) {
		...
		this.escape = t === void 0 ? Qt : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? L(i) : a || "{{", this.suffix = o ? L(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? L(d) : f || L("$t("), this.nestingSuffix = p ? L(p) : m || L(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				else !M(a) && !this.useRawValueToEscape && (a = Ut(a));
				let s = t.safeValue(a);
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			M(i) || (i = Ut(i)), i ||= (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), ""), s.length && (i = s.reduce((e, t) => this.format(e, t, n.lng, {
				...n,
	...
	return (n, r, i) => {
		...
		return s || (s = e(z(r), i), t[o] = s), s(n);
	};
}, vn = (e) => (t, n, r) => e(z(n), r)(t), yn = class {
	constructor(e = {}) {
		this.logger = B.create("formatter"), this.options = e, this.init(e);
	}
	init(e, t = { interpolation: {} }) {
		this.formatSeparator = t.interpolation.formatSeparator || ",";
		let n = t.cacheInBuiltFormats ? _n : vn;
		this.formats = {
			number: n((e, t) => {
	...
	format(e, t, n, r = {}) {
		...
		return i.reduce((e, t) => {
			let { formatName: i, formatOptions: a } = gn(t);
			if (this.formats[i]) {
				let t = e;
				try {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			Jt(n.loaded, [i], a), bn(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), Sn = (e) => (M(e.ns) && (e.ns = [e.ns]), M(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), M(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), K = () => {}, Cn = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, q = class e extends V {
	constructor(e = {}, t) {
		if (super(), this.options = Sn(e), this.services = {}, this.logger = B, this.modules = { external: [] }, Cn(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		...
		if (!this.options.isClone) {
			...
			let e;
			e = this.modules.formatter ? this.modules.formatter : yn;
			let t = new un(this.options);
			this.store = new an(this.options.resources, this.options);
			let n = this.services;
			n.logger = B, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new pn(t, { prepend: this.options.pluralSeparator }), e && (n.formatter = r(e), n.formatter.init && n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new hn(this.options), n.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }, n.backendConnector = new xn(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (e, ...t) => {
				this.emit(e, ...t);
			}), this.modules.languageDetector && (n.languageDetector = r(this.modules.languageDetector), n.languageDetector.init && n.languageDetector.init(n, this.options.detection, this.options)), this.modules.i18nFormat && (n.i18nFormat = r(this.modules.i18nFormat), n.i18nFormat.init && n.i18nFormat.init(this)), this.translator = new ln(this.services, this.options), this.translator.on("*", (e, ...t) => {
				this.emit(e, ...t);
	...
	use(e) {
		...
		return e.type === "backend" && (this.modules.backend = e), (e.type === "logger" || e.log && e.warn && e.error) && (this.modules.logger = e), e.type === "languageDetector" && (this.modules.languageDetector = e), e.type === "i18nFormat" && (this.modules.i18nFormat = e), e.type === "postProcessor" && on.addPostProcessor(e), e.type === "formatter" && (this.modules.formatter = e), e.type === "3rdParty" && this.modules.external.push(e), this;
	}
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new un(G());
	...
	cloneInstance(t = {}, n = K) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a[e] = this[e];
		}), a.services = { ...this.services }, a.services.utils = { hasLoadedNamespace: a.hasLoadedNamespace.bind(a) }, r && (a.store = new an(Object.keys(this.store.data).reduce((e, t) => (e[t] = { ...this.store.data[t] }, e[t] = Object.keys(e[t]).reduce((n, r) => (n[r] = { ...e[t][r] }, n), e[t]), e), {}), i), a.services.resourceStore = a.store), t.interpolation) {
			let e = {
				...G().interpolation,
				...this.options.interpolation,
				...t.interpolation
			...
			a.services.interpolator = new hn(n);
		}
		return a.translator = new ln(a.services, i), a.translator.on("*", (e, ...t) => {
			a.emit(e, ...t);
...
var wn = (e, t, n, r) => {
	...
	X(n) && Tn[n] || (X(n) && (Tn[n] = /* @__PURE__ */ new Date()), wn(e, t, n, r));
}, En = (e, t) => () => {
	...
	e.loadNamespaces(t, En(e, n));
}, Dn = (e, t, n, r) => {
	if (X(n) && (n = [n]), e.options.preload && e.options.preload.indexOf(t) > -1) return Y(e, n, r);
	n.forEach((t) => {
		e.options.ns.indexOf(t) < 0 && e.options.ns.push(t);
	}), e.loadLanguages(t, En(e, r));
}, On = (e, t, n = {}) => !t.languages || !t.languages.length ? (J(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), X = (e) => typeof e == "string", kn = (e) => typeof e == "object" && !!e, An = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, jn = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	process.env.NODE_ENV !== "production" && (function() {
		...
		var a = Vt("react"), o = typeof Object.is == "function" ? Object.is : t, s = a.useState, c = a.useEffect, l = a.useLayoutEffect, u = a.useDebugValue, d = !1, f = !1, p = typeof window > "u" || window.document === void 0 || window.document.createElement === void 0 ? i : n;
	...
	process.env.NODE_ENV === "production" ? t.exports = Vn() : t.exports = Hn();
}))(), Wn = {
	t: (e, t) => {
		if (X(t)) return t;
		if (kn(t) && X(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: a } = t, { i18n: l, defaultNS: u } = r(zn) || {}, d = a || l || Ln();
	d && !d.reportNamespaces && (d.reportNamespaces = new Bn()), d || J(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = o(() => ({
		...Pn(),
		...d?.options?.react,
		...t
	...
	let v = s(0), y = n((e) => {
		...
		if (!d) return Wn;
		let e = !!(d.isInitialized || d.initializedStoreOnce) && _.every((e) => On(e, d, f)), n = t.lng || d.language, r = v.current, i = b.current;
		...
		f,
		t.lng
	]), [S, C] = c(0), { t: w, ready: T } = (0, Un.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
			t.lng ? Dn(d, t.lng, _, e) : Y(d, _, e);
		}
	}, [
		d,
		t.lng,
	...
	if (d && p && !T) throw new Promise((e) => {
		let n = () => e();
		t.lng ? Dn(d, t.lng, _, n) : Y(d, _, n);
	});
	return te;
};
function qn({ i18n: e, defaultNS: n, children: r }) {
	let i = o(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
	return t(zn.Provider, { value: i }, r);
}
function Jn() {
			...
			children: [m("div", {
				...
				children: [p(j, {
					...
					children: [
						p(j, {
							href: "/",
							className: `nav-link${((e) => i === A(e, a))("/") ? " is-active" : ""}`,
