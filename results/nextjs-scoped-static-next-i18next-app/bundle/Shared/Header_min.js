...
var h = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), g = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	if (typeof require < "u") return require.apply(this, arguments);
	throw Error("Calling `require` for \"" + e + "\" in an environment that doesn't expose the `require` function. See https://rolldown.rs/in-depth/bundling-cjs#require-external-modules for more details.");
}), _ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/components/Link.tsx", v = (e) => /^https?:\/\//.test(e ?? "");
function y(e, t) {
...
var b = ({ href: e, children: t, ...n }) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (Object.prototype.hasOwnProperty.call(e, r) ? x(e[r]) || e[r] instanceof String || x(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : ne(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, j = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), re = {
	"&": "&amp;",
	"<": "&lt;",
	...
	addResourceBundle(e, t, n, r, i, a = {
		...
		let s = A(this.data, o) || {};
		a.skipCopy || (n = JSON.parse(JSON.stringify(n))), r ? ne(s, n, i) : s = {
			...s,
			...n
...
var R = (e) => !x(e) && typeof e != "boolean" && typeof e != "number", pe = class e extends F {
	constructor(e, t = {}) {
		super(), w([
			"resourceStore",
			"languageUtils",
	...
	constructor(e) {
		this.options = e, this.supportedLngs = this.options.supportedLngs || !1, this.logger = P.create("languageUtils"), this.resolveHierarchyCache = {};
	}
	clearCache() {
	...
	toResolveHierarchy(e, t) {
		...
		let i = t === void 0 || t === !1 || x(t), a = t === void 0 && typeof this.options.fallbackLng == "function", o = x(e) && i && !a, s = null;
		if (o) {
			let n;
		...
		return x(e) && (e.includes("-") || e.includes("_")) ? (this.options.load !== "languageOnly" && u(this.formatLanguageCode(e)), this.options.load !== "languageOnly" && this.options.load !== "currentOnly" && u(this.getScriptPartFromCode(e)), this.options.load !== "currentOnly" && u(this.getLanguagePartFromCode(e))) : x(e) && u(this.formatLanguageCode(e)), c.forEach((e) => {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? ie : t, this.escapeValue = n === void 0 || n, this.useRawValueToEscape = r !== void 0 && r, this.prefix = i ? j(i) : a || "{{", this.suffix = o ? j(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u ? j(u) : "-", this.unescapeSuffix = this.unescapePrefix ? "" : l ? j(l) : "", this.nestingPrefix = d ? j(d) : f || j("$t("), this.nestingSuffix = p ? j(p) : m || j(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ !== void 0 && _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				let s = t.safeValue(a);
				if (e = e.replace(i[0], he(s)), u ? (t.regex.lastIndex += s.length, t.regex.lastIndex -= i[0].length) : t.regex.lastIndex = 0, o++, o >= this.maxReplaces) break;
			}
		}), e;
	}
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			}), i.trim())), e = e.replace(r[0], he(C(i))), this.regexp.lastIndex = 0;
		}
		return e;
	}
}, _e = (e) => {
	...
	format(e, t, n, r = {}) {
		...
		return a.reduce((e, t) => {
			let { formatName: i, formatOptions: a } = _e(t);
			if (this.formats[i]) {
				let t = e;
				try {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			ee(n.loaded, [i], a), xe(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), Ce = (e) => (x(e.ns) && (e.ns = [e.ns]), x(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), x(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), W = () => {}, we = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, G = class e extends F {
	constructor(e = {}, t) {
		if (super(), this.options = Ce(e), this.services = {}, this.logger = P, this.modules = { external: [] }, we(this), t && !this.isInitialized && !e.isClone) {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new z(U());
	...
	cloneInstance(t = {}, n = W) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a[e] = this[e];
		}), a.services = { ...this.services }, a.services.utils = { hasLoadedNamespace: a.hasLoadedNamespace.bind(a) }, r && (a.store = new ue(Object.keys(this.store.data).reduce((e, t) => (e[t] = { ...this.store.data[t] }, e[t] = Object.keys(e[t]).reduce((n, r) => (n[r] = { ...e[t][r] }, n), e[t]), e), {}), i), a.services.resourceStore = a.store), t.interpolation) {
			let e = {
				...U().interpolation,
				...this.options.interpolation,
				...t.interpolation
			...
			a.services.interpolator = new ge(n);
		}
		return a.translator = new pe(a.services, i), a.translator.on("*", (e, ...t) => {
			a.emit(e, ...t);
...
var Te = (e, t, n, r) => {
	...
	J(i[0]) && (i[0] = `react-i18next:: ${i[0]}`), e?.services?.logger?.warn ? e.services.logger.warn(...i) : console?.warn && console.warn(...i);
}, Ee = {}, K = (e, t, n, r) => {
	J(n) && Ee[n] || (J(n) && (Ee[n] = /* @__PURE__ */ new Date()), Te(e, t, n, r));
}, De = (e, t) => () => {
	...
	e.loadNamespaces(t, De(e, n));
}, Oe = (e, t, n, r) => {
	if (J(n) && (n = [n]), e.options.preload && e.options.preload.indexOf(t) > -1) return q(e, n, r);
	n.forEach((t) => {
		e.options.ns.indexOf(t) < 0 && e.options.ns.push(t);
	}), e.loadLanguages(t, De(e, r));
}, ke = (e, t, n = {}) => !t.languages || !t.languages.length ? (K(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), J = (e) => typeof e == "string", Ae = (e) => typeof e == "object" && !!e, je = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Me = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t.exports = process.env.NODE_ENV === "production" ? He() : Ue();
}))(), Ge = {
	t: (e, t) => {
		if (J(t)) return t;
		if (Ae(t) && J(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: a } = t, { i18n: l, defaultNS: u } = r(Be) || {}, d = a || l || Re();
	d && !d.reportNamespaces && (d.reportNamespaces = new Ve()), d || K(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next or by passing it via props or context. In monorepo setups, make sure there is only one instance of react-i18next.");
	let f = o(() => ({
		...Fe(),
		...d?.options?.react,
		...t
	}), [d, t]), { useSuspense: p, keyPrefix: m } = f, h = e || u || d?.options?.defaultNS, g = J(h) ? [h] : h || ["translation"], _ = o(() => g, g);
	...
	let v = s(0), y = n((e) => {
		...
		if (!d) return Ge;
		let e = !!(d.isInitialized || d.initializedStoreOnce) && _.every((e) => ke(e, d, f)), n = t.lng || d.language, r = v.current, i = b.current;
		...
		f,
		t.lng
	]), [S, C] = c(0), { t: w, ready: T } = (0, We.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
			t.lng ? Oe(d, t.lng, _, e) : q(d, _, e);
		}
	}, [
		d,
		t.lng,
	...
	let E = d || {}, D = s(null), O = s(), k = (e) => {
		...
		let r = !T && !p ? (...e) => (K(d, "USE_T_BEFORE_READY", "useTranslation: t was called before ready. When using useSuspense: false, make sure to check the ready flag before using t."), w(...e)) : w, i = [
			r,
			n,
			T
		];
	...
	if (d && p && !T) {
		...
		throw e && K(d, "SUSPENDED_WHILE_LOADING", "useTranslation: suspended while translations are loading (useSuspense is true by default). Add a <Suspense> boundary above this component, or set react.useSuspense: false in the i18next init options. https://react.i18next.com/latest/usetranslation-hook"), new Promise((e) => {
			let n = () => e();
			t.lng ? Oe(d, t.lng, _, n) : q(d, _, n);
		});
	}
	return ee;
};
function Je({ i18n: e, defaultNS: n, children: r }) {
	let i = o(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
	return t(Be.Provider, { value: i }, r);
}
var Ye = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/components/ThemeToggle.tsx";
function Xe() {
...
var Z = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/components/LocaleSwitcher.tsx";
function et() {
...
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/components/Header.tsx";
function nt() {
	let { t: e } = qe("shared");
	tt("Header");
					...
					children: [
						...
						p("div", {
							...
							children: [p("button", {
								...
								onMouseLeave: () => n(!1),
								onClick: () => n(!t),
								children: [e("header.mockPages"), p(m, {
									size: 14,
...
var at = {
	...
	"pricingTiers.starterTier": "Kostenlose Stufe",
	"pricingTiers.starterPrice": "$0",
	"pricingTiers.forever": "forever",
	"pricingTiers.runsPerDay": "Öffentliches Benchmark-Dashboard",
	"pricingTiers.libraries3": "Einfache Bibliotheksvergleiche",
	"pricingTiers.communitySupport": "Zugang zum Community-Forum",
	"pricingTiers.publicResults": "Monatliche Ergebniszusammenfassung",
	"pricingTiers.proPrice": "$29",
	"pricingTiers.unlimitedRuns": "Benutzerdefinierte Benchmark-Konfigurationen",
	"pricingTiers.allLibraries": "Alle kostenlosen Funktionen",
	"pricingTiers.privateResults": "Privates Ergebnis-Dashboard",
	"pricingTiers.ciIntegration": "Slack-Integration",
	"pricingTiers.historicalData": "API-Zugriff (1.000 Anfragen/Tag)",
	"pricingTiers.everythingInPro": "Alle Pro-Funktionen",
	"pricingTiers.onPremiseOption": "Dedizierte Benchmark-Infrastruktur",
	"pricingTiers.ssoSaml": "Benutzerdefinierte Bibliotheksintegrationen",
	"pricingTiers.dedicatedAccountManager": "SLA-Garantien",
	...
	"careersBenefits.topOfMarket": "Compensación al nivel del mercado",
	"careersBenefits.openSourceTime": "Tiempo para código abierto",
	"careersBenefits.twentyPercentTime": "20% del tiempo para OSS",
	"careersPositions.seniorFrontendEngineer": "Ingeniero Frontend Senior",
	"careersPositions.seniorFrontendEngineerDesc": "Construye y mantiene nuestro panel de benchmarks y herramientas para desarrolladores con React, TypeScript y Vite.",
	...
	"pricingTiers.communitySupport": "Soporte de la comunidad",
	...
	"pricingTiers.enterpriseTier": "Nivel Empresarial",
	"pricingTiers.custom": "Personalizado",
	"pricingTiers.everythingInPro": "Todo lo de Pro",
	"pricingTiers.onPremiseOption": "Opción local (on-premise)",
	"pricingTiers.ssoSaml": "SSO y SAML",
	"pricingTiers.dedicatedAccountManager": "Gestor de cuenta dedicado",
	"pricingTiers.customSLAs": "SLA personalizados",
	...
	"products.benchmarkCloud": "Benchmark Cloud",
	"products.benchmarkCloudDesc": "Benchmarking automatizado en la nube con historial, alertas y paneles de equipo.",
	"products.benchmarkCloudPrice": "$29/mes",
	"products.benchmarkEnterprise": "Benchmark Enterprise",
	"products.benchmarkEnterpriseDesc": "Despliegue on-premise con SSO, registros de auditoría, SLA personalizados y soporte dedicado.",
	"products.benchmarkEnterprisePrice": "Contáctanos",
	"products.migrationAssistant": "Asistente de migración",
	"products.migrationAssistantDesc": "Herramienta con IA que te ayuda a migrar tu código entre bibliotecas i18n sin tiempo de inactividad.",
	"products.migrationAssistantPrice": "$99 pago único",
	"products.translationQA": "QA de traducciones",
	"products.translationQADesc": "Comprobaciones automáticas de calidad para traducciones faltantes, problemas de pluralización y errores de contexto.",
	"products.translationQAPrice": "$19/mes",
	"products.bundleOptimizer": "Optimizador de bundle",
	"products.bundleOptimizerDesc": "Analiza y optimiza tu bundle i18n para producción con tree-shaking y code splitting.",
	"products.bundleOptimizerPrice": "$49/mes",
	...
	"pricingTiers.starterTier": "Piano Gratuito",
	"pricingTiers.starterPrice": "$0",
	"pricingTiers.forever": "forever",
	"pricingTiers.runsPerDay": "Dashboard pubblica dei benchmark",
	"pricingTiers.libraries3": "Confronti base tra librerie",
	"pricingTiers.communitySupport": "Accesso al forum della comunità",
	"pricingTiers.publicResults": "Riepilogo mensile dei risultati",
	"pricingTiers.proPrice": "$29",
	"pricingTiers.unlimitedRuns": "Configurazioni di benchmark personalizzate",
	"pricingTiers.allLibraries": "Tutte le funzioni del piano gratuito",
	"pricingTiers.privateResults": "Dashboard dei risultati privata",
	"pricingTiers.ciIntegration": "Integrazione Slack",
	"pricingTiers.historicalData": "Accesso API (1.000 richieste/giorno)",
	"pricingTiers.everythingInPro": "Tutte le funzioni del piano Pro",
	"pricingTiers.onPremiseOption": "Infrastruttura di benchmark dedicata",
	"pricingTiers.ssoSaml": "Integrazioni librerie personalizzate",
	"pricingTiers.dedicatedAccountManager": "Garanzie SLA",
	"pricingTiers.customSLAs": "Custom SLAs",
	"pricingTiers.auditLogs": "Audit logs",
	"pricingTiers.trainingSessions": "Training sessions"
}, sn = {
	...
	"pricingTiers.starterTier": "無料プラン",
	"pricingTiers.starterPrice": "$0",
	"pricingTiers.forever": "forever",
	"pricingTiers.runsPerDay": "公開ベンチマークダッシュボード",
	"pricingTiers.libraries3": "基本的なライブラリ比較",
	"pricingTiers.communitySupport": "コミュニティフォーラムへのアクセス",
	"pricingTiers.publicResults": "月次結果ダイジェスト",
	"pricingTiers.proPrice": "$29",
	"pricingTiers.unlimitedRuns": "カスタムベンチマーク設定",
	"pricingTiers.allLibraries": "無料プランの全機能",
	"pricingTiers.privateResults": "プライベート結果ダッシュボード",
	"pricingTiers.ciIntegration": "Slack統合",
	"pricingTiers.historicalData": "APIアクセス（1日1,000リクエスト）",
	"pricingTiers.everythingInPro": "Proプランの全機能",
	"pricingTiers.onPremiseOption": "専用ベンチマークインフラ",
	"pricingTiers.ssoSaml": "カスタムライブラリ統合",
	"pricingTiers.dedicatedAccountManager": "SLA保証",
	"pricingTiers.customSLAs": "Custom SLAs",
	"pricingTiers.auditLogs": "Audit logs",
	"pricingTiers.trainingSessions": "Training sessions"
}, yn = {
	...
	"pricingTiers.starterTier": "무료 티어",
	"pricingTiers.starterPrice": "$0",
	"pricingTiers.forever": "forever",
	"pricingTiers.runsPerDay": "공개 벤치마크 대시보드",
	"pricingTiers.libraries3": "기본 라이브러리 비교",
	"pricingTiers.communitySupport": "커뮤니티 포럼 액세스",
	"pricingTiers.publicResults": "월간 결과 요약",
	"pricingTiers.proPrice": "$29",
	"pricingTiers.unlimitedRuns": "맞춤형 벤치마크 구성",
	"pricingTiers.allLibraries": "모든 무료 기능 포함",
	"pricingTiers.privateResults": "비공개 결과 대시보드",
	"pricingTiers.ciIntegration": "Slack 연동",
	"pricingTiers.historicalData": "API 액세스(일일 1,000건)",
	"pricingTiers.everythingInPro": "모든 프로 기능 포함",
	"pricingTiers.onPremiseOption": "전용 벤치마크 인프라",
	"pricingTiers.ssoSaml": "맞춤형 라이브러리 통합",
	"pricingTiers.dedicatedAccountManager": "SLA 보장",
	"pricingTiers.customSLAs": "Custom SLAs",
	"pricingTiers.auditLogs": "Audit logs",
	"pricingTiers.trainingSessions": "Training sessions"
}, jn = {
	...
	"careersBenefits.topOfMarket": "Remuneração no topo do mercado",
	"careersBenefits.openSourceTime": "Tempo para open source",
	"careersBenefits.twentyPercentTime": "20% do tempo para OSS",
	"careersPositions.seniorFrontendEngineer": "Engenheiro Frontend Sênior",
	"careersPositions.seniorFrontendEngineerDesc": "Construa e mantenha nosso dashboard de benchmark e ferramentas para desenvolvedores usando React, TypeScript e Vite.",
	...
	"pricingTiers.enterpriseTier": "Nível Empresarial",
	"pricingTiers.custom": "Personalizado",
	"pricingTiers.everythingInPro": "Tudo do Pro",
	"pricingTiers.onPremiseOption": "Opção local (on-premise)",
	...
	"products.benchmarkCloud": "Benchmark Cloud",
	"products.benchmarkCloudDesc": "Benchmarking automatizado na nuvem com histórico, alertas e dashboards de equipe.",
	"products.benchmarkCloudPrice": "$29/mês",
	"products.benchmarkEnterprise": "Benchmark Enterprise",
	"products.benchmarkEnterpriseDesc": "Implantação on-premise com SSO, logs de auditoria, SLAs personalizados e suporte dedicado.",
	"products.benchmarkEnterprisePrice": "Fale conosco",
	"products.migrationAssistant": "Assistente de migração",
	"products.migrationAssistantDesc": "Ferramenta com IA que ajuda a migrar sua base de código entre bibliotecas i18n sem downtime.",
	"products.migrationAssistantPrice": "$99 pagamento único",
	"products.translationQA": "QA de tradução",
	"products.translationQADesc": "Verificações automáticas de qualidade para traduções ausentes, problemas de pluralização e erros de contexto.",
	"products.translationQAPrice": "$19/mês",
	"products.bundleOptimizer": "Otimizador de bundle",
	"products.bundleOptimizerDesc": "Analisa e otimiza seu bundle i18n para produção com tree-shaking e code splitting.",
	"products.bundleOptimizerPrice": "$49/mês",
	...
	"pricingTiers.starterTier": "Бесплатный уровень",
	"pricingTiers.starterPrice": "$0",
	"pricingTiers.forever": "forever",
	"pricingTiers.runsPerDay": "Публичный дашборд бенчмарков",
	"pricingTiers.libraries3": "Базовые сравнения библиотек",
	"pricingTiers.communitySupport": "Доступ к форуму сообщества",
	"pricingTiers.publicResults": "Ежемесячный дайджест результатов",
	"pricingTiers.proPrice": "$29",
	"pricingTiers.unlimitedRuns": "Собственные конфигурации бенчмарков",
	"pricingTiers.allLibraries": "Все функции бесплатного уровня",
	"pricingTiers.privateResults": "Приватный дашборд результатов",
	"pricingTiers.ciIntegration": "Интеграция со Slack",
	"pricingTiers.historicalData": "Доступ к API (1000 запросов/день)",
	"pricingTiers.everythingInPro": "Все функции уровня Pro",
	"pricingTiers.onPremiseOption": "Выделенная инфраструктура для бенчмарков",
	"pricingTiers.ssoSaml": "Индивидуальные интеграции библиотек",
	"pricingTiers.dedicatedAccountManager": "Гарантии SLA",
	"pricingTiers.customSLAs": "Custom SLAs",
	"pricingTiers.auditLogs": "Audit logs",
	"pricingTiers.trainingSessions": "Training sessions"
}, tr = {
	...
	"pricingTiers.starterTier": "免费版",
	"pricingTiers.starterPrice": "$0",
	"pricingTiers.forever": "forever",
	"pricingTiers.runsPerDay": "公共基准测试仪表板",
	"pricingTiers.libraries3": "基本库比较",
	"pricingTiers.communitySupport": "社区论坛访问权限",
	"pricingTiers.publicResults": "每月结果摘要",
	"pricingTiers.proPrice": "$29",
	"pricingTiers.unlimitedRuns": "自定义基准测试配置",
	"pricingTiers.allLibraries": "包含所有免费版功能",
	"pricingTiers.privateResults": "私人结果仪表板",
	"pricingTiers.ciIntegration": "Slack 集成",
	"pricingTiers.historicalData": "API 访问（1,000 次请求/天）",
	"pricingTiers.everythingInPro": "包含所有专业版功能",
	"pricingTiers.onPremiseOption": "专用基准测试基础设施",
	"pricingTiers.ssoSaml": "自定义库集成",
	"pricingTiers.dedicatedAccountManager": "SLA 保证",
	"pricingTiers.customSLAs": "Custom SLAs",
	"pricingTiers.auditLogs": "Audit logs",
	"pricingTiers.trainingSessions": "Training sessions"
}, pr = {
...
var $ = G, xr = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/components/AppProviders.tsx";
...
var Cr = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/scripts/Wrapper.tsx";
function wr({ children: e }) {
	return p(Sr, { children: e }, void 0, !1, {
		fileName: Cr,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var Tr = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/components/Header.wrapper.tsx";
function Er() {
	return p(wr, { children: p(nt, {}, void 0, !1, {
		fileName: Tr,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
