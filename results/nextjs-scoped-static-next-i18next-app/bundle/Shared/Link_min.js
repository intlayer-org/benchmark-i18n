...
import l from "../i18n/locales/de/about.json";
import u from "../i18n/locales/de/blog.json";
import d from "../i18n/locales/de/careers.json";
import f from "../i18n/locales/de/contact.json";
import p from "../i18n/locales/de/faq.json";
import m from "../i18n/locales/de/home.json";
import h from "../i18n/locales/de/pricing.json";
import g from "../i18n/locales/de/products.json";
import _ from "../i18n/locales/de/route.json";
import v from "../i18n/locales/de/settings.json";
import y from "../i18n/locales/de/shared.json";
import b from "../i18n/locales/de/team.json";
import x from "../i18n/locales/es/about.json";
import ee from "../i18n/locales/es/blog.json";
import te from "../i18n/locales/es/careers.json";
import S from "../i18n/locales/es/contact.json";
import C from "../i18n/locales/es/faq.json";
import w from "../i18n/locales/es/home.json";
import T from "../i18n/locales/es/pricing.json";
import E from "../i18n/locales/es/products.json";
import ne from "../i18n/locales/es/route.json";
import re from "../i18n/locales/es/settings.json";
import ie from "../i18n/locales/es/shared.json";
import ae from "../i18n/locales/es/team.json";
import oe from "../i18n/locales/fr/about.json";
import se from "../i18n/locales/fr/blog.json";
import ce from "../i18n/locales/fr/careers.json";
import le from "../i18n/locales/fr/contact.json";
import ue from "../i18n/locales/fr/faq.json";
import de from "../i18n/locales/fr/home.json";
import fe from "../i18n/locales/fr/pricing.json";
import pe from "../i18n/locales/fr/products.json";
import me from "../i18n/locales/fr/route.json";
import he from "../i18n/locales/fr/settings.json";
import ge from "../i18n/locales/fr/shared.json";
import _e from "../i18n/locales/fr/team.json";
import ve from "../i18n/locales/it/about.json";
import ye from "../i18n/locales/it/blog.json";
import be from "../i18n/locales/it/careers.json";
import xe from "../i18n/locales/it/contact.json";
import Se from "../i18n/locales/it/faq.json";
import Ce from "../i18n/locales/it/home.json";
import we from "../i18n/locales/it/pricing.json";
import Te from "../i18n/locales/it/products.json";
import Ee from "../i18n/locales/it/route.json";
import De from "../i18n/locales/it/settings.json";
import Oe from "../i18n/locales/it/shared.json";
import ke from "../i18n/locales/it/team.json";
import Ae from "../i18n/locales/ja/about.json";
import je from "../i18n/locales/ja/blog.json";
import Me from "../i18n/locales/ja/careers.json";
import Ne from "../i18n/locales/ja/contact.json";
import Pe from "../i18n/locales/ja/faq.json";
import Fe from "../i18n/locales/ja/home.json";
import Ie from "../i18n/locales/ja/pricing.json";
import Le from "../i18n/locales/ja/products.json";
import Re from "../i18n/locales/ja/route.json";
import ze from "../i18n/locales/ja/settings.json";
import Be from "../i18n/locales/ja/shared.json";
import Ve from "../i18n/locales/ja/team.json";
import He from "../i18n/locales/ko/about.json";
import Ue from "../i18n/locales/ko/blog.json";
import We from "../i18n/locales/ko/careers.json";
import Ge from "../i18n/locales/ko/contact.json";
import Ke from "../i18n/locales/ko/faq.json";
import qe from "../i18n/locales/ko/home.json";
import Je from "../i18n/locales/ko/pricing.json";
import Ye from "../i18n/locales/ko/products.json";
import Xe from "../i18n/locales/ko/route.json";
import Ze from "../i18n/locales/ko/settings.json";
import Qe from "../i18n/locales/ko/shared.json";
import $e from "../i18n/locales/ko/team.json";
import et from "../i18n/locales/pt/about.json";
import tt from "../i18n/locales/pt/blog.json";
import nt from "../i18n/locales/pt/careers.json";
import rt from "../i18n/locales/pt/contact.json";
import it from "../i18n/locales/pt/faq.json";
import at from "../i18n/locales/pt/home.json";
import ot from "../i18n/locales/pt/pricing.json";
import st from "../i18n/locales/pt/products.json";
import ct from "../i18n/locales/pt/route.json";
import lt from "../i18n/locales/pt/settings.json";
import ut from "../i18n/locales/pt/shared.json";
import dt from "../i18n/locales/pt/team.json";
import ft from "../i18n/locales/ru/about.json";
import pt from "../i18n/locales/ru/blog.json";
import mt from "../i18n/locales/ru/careers.json";
import ht from "../i18n/locales/ru/contact.json";
import gt from "../i18n/locales/ru/faq.json";
import _t from "../i18n/locales/ru/home.json";
import vt from "../i18n/locales/ru/pricing.json";
import yt from "../i18n/locales/ru/products.json";
import bt from "../i18n/locales/ru/route.json";
import xt from "../i18n/locales/ru/settings.json";
import St from "../i18n/locales/ru/shared.json";
import Ct from "../i18n/locales/ru/team.json";
import wt from "../i18n/locales/zh/about.json";
import Tt from "../i18n/locales/zh/blog.json";
import Et from "../i18n/locales/zh/careers.json";
import Dt from "../i18n/locales/zh/contact.json";
import Ot from "../i18n/locales/zh/faq.json";
import kt from "../i18n/locales/zh/home.json";
import At from "../i18n/locales/zh/pricing.json";
import jt from "../i18n/locales/zh/products.json";
import Mt from "../i18n/locales/zh/route.json";
import Nt from "../i18n/locales/zh/settings.json";
import Pt from "../i18n/locales/zh/shared.json";
import Ft from "../i18n/locales/zh/team.json";
var It = (e) => /^https?:\/\//.test(e ?? "");
function Lt(e, t) {
	return !e.startsWith("/") || e === `/${t}` || e.startsWith(`/${t}/`) ? e : `/${t}${e === "/" ? "" : e}`;
}
var Rt = ({ href: e, children: t, ...n }) => {
	let r = s().locale ?? "en";
	return e == null || typeof e != "string" || It(e) ? c(o, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, k = (e) => e == null ? "" : String(e), zt = (e, t, n) => {
	e.forEach((e) => {
		t[e] && (n[e] = t[e]);
	});
}, Bt = /###/g, A = (e) => e && e.includes("###") ? e.replace(Bt, ".") : e, j = (e) => !e || D(e), M = (e, t, n) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? D(e[r]) || e[r] instanceof String || D(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : P(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, F = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), Wt = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, Gt = (e) => D(e) ? e.replace(/[&<>"'\/]/g, (e) => Wt[e]) : e, Kt = class {
	constructor(e) {
	...
	getResource(e, t, n, r = {}) {
		...
		let s = N(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !D(n) ? s : I(this.data?.[e]?.[t], n, i);
	}
...
function U(e, t) {
	let { [H]: n } = e(Zt()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var W = (e) => !D(e) && typeof e != "boolean" && typeof e != "number", G = class e extends z {
	constructor(e, t = {}) {
		super(), zt([
			"resourceStore",
			"languageUtils",
	...
	translate(t, n, r) {
		...
		let p = this.resolve(t, i), m = p?.res, h = p?.usedKey || s, g = p?.exactUsedKey || s, _ = [
			...
			"[object Function]",
			"[object RegExp]"
		], v = i.joinArrays === void 0 ? this.options.joinArrays : i.joinArrays, y = !this.i18nFormat || this.i18nFormat.handleAsObject, b = i.count !== void 0 && !D(i.count), x = e.hasDefaultValue(i), ee = b ? this.pluralResolver.getSuffix(d, i.count, i) : "", te = i.ordinal && b ? this.pluralResolver.getSuffix(d, i.count, { ordinal: !1 }) : "", S = b && !i.ordinal && i.count === 0, C = S && i[`defaultValue${this.options.pluralSeparator}zero`] || i[`defaultValue${ee}`] || i[`defaultValue${te}`] || i.defaultValue, w = m;
		y && !m && x && (w = C);
		let T = W(w), E = Object.prototype.toString.apply(w);
		if (y && w && T && !_.includes(E) && !(D(v) && Array.isArray(w))) {
			...
			if (n || e || c) {
				...
				this.options.saveMissing && (this.options.saveMissingPlurals && b ? e.forEach((e) => {
					...
					S && i[`defaultValue${this.options.pluralSeparator}zero`] && !t.includes(`${this.options.pluralSeparator}zero`) && t.push(`${this.options.pluralSeparator}zero`), t.forEach((t) => {
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return D(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? U(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	getRule(e, t = {}) {
		...
		try {
			...
			if (typeof Intl > "u") return this.logger.error("No Intl support, please use an Intl polyfill!"), J;
	...
	getSuffixes(e, t = {}) {
		let n = this.getRule(e, t);
		return n ||= this.getRule("dev", t), n ? n.resolvedOptions().pluralCategories.sort((e, t) => q[e] - q[t]).map((e) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${e}`) : [];
	}
	getSuffix(e, t, n = {}) {
	...
	let a = Ut(e, t, n);
	return !a && i && D(n) && (a = I(e, n, r), a === void 0 && (a = I(t, n, r))), a;
}, Y = (e) => e.replace(/\$/g, "$$$$"), en = class {
	constructor(e = {}) {
	...
	interpolate(e, t, n, r) {
		let i, a, o, s = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (e) => {
			if (!e.includes(this.formatSeparator)) {
				let i = $t(t, s, e, this.options.keySeparator, this.options.ignoreJSONStructure);
			...
			return this.format($t(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
				...r,
				...t,
				interpolationkey: a
			});
	...
	addCached(e, t) {
		this.formats[e.toLowerCase().trim()] = nn(t);
	}
	format(e, t, n, r = {}) {
		...
		return i.reduce((e, t) => {
			let { formatName: i, formatOptions: a } = tn(t);
			if (this.formats[i]) {
				let t = e;
				try {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			Ht(n.loaded, [i], a), on(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), cn = (e) => (D(e.ns) && (e.ns = [e.ns]), D(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), D(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), Z = () => {}, ln = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Q = class e extends z {
	constructor(e = {}, t) {
		if (super(), this.options = cn(e), this.services = {}, this.logger = R, this.modules = { external: [] }, ln(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		...
		if (!this.options.isClone) {
			...
			let e;
			e = this.modules.formatter ? this.modules.formatter : an;
			let t = new K(this.options);
			this.store = new B(this.options.resources, this.options);
			let n = this.services;
			n.logger = R, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new Qt(t, { prepend: this.options.pluralSeparator }), e && (n.formatter = r(e), n.formatter.init && n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new en(this.options), n.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }, n.backendConnector = new sn(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (e, ...t) => {
				this.emit(e, ...t);
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new K(X());
	...
	cloneInstance(t = {}, n = Z) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a.services.interpolator = new en(n);
		}
...
var un = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, dn = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
...
function _n({ i18n: e, defaultNS: n, children: r }) {
	let a = i(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
	return t(gn.Provider, { value: a }, r);
}
function vn() {
	if (!(typeof window > "u")) {
...
function In({ children: e }) {
	return c(Fn, { children: e });
}
function Ln() {
	return c(In, { children: c(Rt, {}) });
}
