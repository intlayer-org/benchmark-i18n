...
import ee from "../i18n/locales/es/about.json";
import te from "../i18n/locales/es/blog.json";
import S from "../i18n/locales/es/careers.json";
import C from "../i18n/locales/es/contact.json";
import w from "../i18n/locales/es/faq.json";
import T from "../i18n/locales/es/home.json";
import E from "../i18n/locales/es/pricing.json";
...
var D = (e) => typeof e == "string", O = () => {
	let e, t, n = new Promise((n, r) => {
		e = n, t = r;
	});
	return n.resolve = e, n.reject = t, n;
}, k = (e) => e == null ? "" : String(e), Bt = (e, t, n) => {
	e.forEach((e) => {
		t[e] && (n[e] = t[e]);
	});
}, Vt = /###/g, A = (e) => e && e.includes("###") ? e.replace(Vt, ".") : e, j = (e) => !e || D(e), M = (e, t, n) => {
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, Kt = (e) => D(e) ? e.replace(/[&<>"'\/]/g, (e) => Gt[e]) : e, qt = class {
	constructor(e) {
...
function U(e, t) {
	let { [H]: n } = e(Qt()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var W = (e) => !D(e) && typeof e != "boolean" && typeof e != "number", G = class e extends z {
	...
	interpolate(e, t, n, r) {
		let i, a, o, s = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (e) => {
			...
			return this.format(en(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
				...r,
				...t,
				interpolationkey: a
			});
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			Ut(n.loaded, [i], a), sn(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), ln = (e) => (D(e.ns) && (e.ns = [e.ns]), D(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), D(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), Z = () => {}, un = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Q = class e extends z {
	constructor(e = {}, t) {
		if (super(), this.options = ln(e), this.services = {}, this.logger = R, this.modules = { external: [] }, un(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		...
		if (!this.options.isClone) {
			...
			let e;
			e = this.modules.formatter ? this.modules.formatter : on;
			let t = new K(this.options);
			this.store = new B(this.options.resources, this.options);
			let n = this.services;
			n.logger = R, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new $t(t, { prepend: this.options.pluralSeparator }), e && (n.formatter = r(e), n.formatter.init && n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new tn(this.options), n.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }, n.backendConnector = new cn(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (e, ...t) => {
				this.emit(e, ...t);
	...
	cloneInstance(t = {}, n = Z) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a.services.interpolator = new tn(n);
		}
...
var dn = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, fn = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
...
function vn({ i18n: e, defaultNS: n, children: r }) {
	let a = i(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
	return t(_n.Provider, { value: a }, r);
}
function yn() {
	if (!(typeof window > "u")) {
...
function Ln({ children: e }) {
	return l(In, { children: e });
}
function Rn() {
	return l(Ln, { children: l(zt, {}) });
}
