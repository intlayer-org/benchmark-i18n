...
import d from "../i18n/locales/de/about.json";
import f from "../i18n/locales/de/blog.json";
import p from "../i18n/locales/de/careers.json";
import m from "../i18n/locales/de/contact.json";
import h from "../i18n/locales/de/faq.json";
import g from "../i18n/locales/de/home.json";
import _ from "../i18n/locales/de/pricing.json";
import v from "../i18n/locales/de/products.json";
import y from "../i18n/locales/de/route.json";
import b from "../i18n/locales/de/settings.json";
import x from "../i18n/locales/de/shared.json";
import S from "../i18n/locales/de/team.json";
import C from "../i18n/locales/es/about.json";
import w from "../i18n/locales/es/blog.json";
import T from "../i18n/locales/es/careers.json";
import E from "../i18n/locales/es/contact.json";
import D from "../i18n/locales/es/faq.json";
import O from "../i18n/locales/es/home.json";
import k from "../i18n/locales/es/pricing.json";
import A from "../i18n/locales/es/products.json";
import ee from "../i18n/locales/es/route.json";
import te from "../i18n/locales/es/settings.json";
import ne from "../i18n/locales/es/shared.json";
import re from "../i18n/locales/es/team.json";
import ie from "../i18n/locales/fr/about.json";
import ae from "../i18n/locales/fr/blog.json";
import oe from "../i18n/locales/fr/careers.json";
import se from "../i18n/locales/fr/contact.json";
import ce from "../i18n/locales/fr/faq.json";
import le from "../i18n/locales/fr/home.json";
import ue from "../i18n/locales/fr/pricing.json";
import de from "../i18n/locales/fr/products.json";
import fe from "../i18n/locales/fr/route.json";
import pe from "../i18n/locales/fr/settings.json";
import me from "../i18n/locales/fr/shared.json";
import he from "../i18n/locales/fr/team.json";
import ge from "../i18n/locales/it/about.json";
import _e from "../i18n/locales/it/blog.json";
import ve from "../i18n/locales/it/careers.json";
import ye from "../i18n/locales/it/contact.json";
import be from "../i18n/locales/it/faq.json";
import xe from "../i18n/locales/it/home.json";
import Se from "../i18n/locales/it/pricing.json";
import Ce from "../i18n/locales/it/products.json";
import we from "../i18n/locales/it/route.json";
import Te from "../i18n/locales/it/settings.json";
import Ee from "../i18n/locales/it/shared.json";
import De from "../i18n/locales/it/team.json";
import Oe from "../i18n/locales/ja/about.json";
import ke from "../i18n/locales/ja/blog.json";
import Ae from "../i18n/locales/ja/careers.json";
import je from "../i18n/locales/ja/contact.json";
import Me from "../i18n/locales/ja/faq.json";
import Ne from "../i18n/locales/ja/home.json";
import Pe from "../i18n/locales/ja/pricing.json";
import Fe from "../i18n/locales/ja/products.json";
import Ie from "../i18n/locales/ja/route.json";
import Le from "../i18n/locales/ja/settings.json";
import Re from "../i18n/locales/ja/shared.json";
import ze from "../i18n/locales/ja/team.json";
import Be from "../i18n/locales/ko/about.json";
import Ve from "../i18n/locales/ko/blog.json";
import He from "../i18n/locales/ko/careers.json";
import Ue from "../i18n/locales/ko/contact.json";
import We from "../i18n/locales/ko/faq.json";
import Ge from "../i18n/locales/ko/home.json";
import Ke from "../i18n/locales/ko/pricing.json";
import qe from "../i18n/locales/ko/products.json";
import Je from "../i18n/locales/ko/route.json";
import Ye from "../i18n/locales/ko/settings.json";
import Xe from "../i18n/locales/ko/shared.json";
import Ze from "../i18n/locales/ko/team.json";
import Qe from "../i18n/locales/pt/about.json";
import $e from "../i18n/locales/pt/blog.json";
import et from "../i18n/locales/pt/careers.json";
import tt from "../i18n/locales/pt/contact.json";
import nt from "../i18n/locales/pt/faq.json";
import rt from "../i18n/locales/pt/home.json";
import it from "../i18n/locales/pt/pricing.json";
import at from "../i18n/locales/pt/products.json";
import ot from "../i18n/locales/pt/route.json";
import st from "../i18n/locales/pt/settings.json";
import ct from "../i18n/locales/pt/shared.json";
import lt from "../i18n/locales/pt/team.json";
import ut from "../i18n/locales/ru/about.json";
import dt from "../i18n/locales/ru/blog.json";
import ft from "../i18n/locales/ru/careers.json";
import pt from "../i18n/locales/ru/contact.json";
import mt from "../i18n/locales/ru/faq.json";
import ht from "../i18n/locales/ru/home.json";
import gt from "../i18n/locales/ru/pricing.json";
import _t from "../i18n/locales/ru/products.json";
import vt from "../i18n/locales/ru/route.json";
import yt from "../i18n/locales/ru/settings.json";
import bt from "../i18n/locales/ru/shared.json";
import xt from "../i18n/locales/ru/team.json";
import St from "../i18n/locales/zh/about.json";
import Ct from "../i18n/locales/zh/blog.json";
import wt from "../i18n/locales/zh/careers.json";
import Tt from "../i18n/locales/zh/contact.json";
import Et from "../i18n/locales/zh/faq.json";
import Dt from "../i18n/locales/zh/home.json";
import Ot from "../i18n/locales/zh/pricing.json";
import kt from "../i18n/locales/zh/products.json";
import At from "../i18n/locales/zh/route.json";
import jt from "../i18n/locales/zh/settings.json";
import Mt from "../i18n/locales/zh/shared.json";
import Nt from "../i18n/locales/zh/team.json";
var j = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), M = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
}, Pt = (e) => e == null ? "" : String(e), Ft = (e, t, n) => {
	e.forEach((e) => {
		t[e] && (n[e] = t[e]);
	});
}, It = /###/g, Lt = (e) => e && e.includes("###") ? e.replace(It, ".") : e, Rt = (e) => !e || N(e), F = (e, t, n) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? N(e[r]) || e[r] instanceof String || N(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : Ht(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, L = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), Ut = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, Wt = (e) => N(e) ? e.replace(/[&<>"'\/]/g, (e) => Ut[e]) : e, Gt = class {
	constructor(e) {
	...
	"!",
	";"
], qt = new Gt(20), Jt = (e, t, n) => {
	t ||= "", n ||= "";
	let r = Kt.filter((e) => !t.includes(e) && !n.includes(e));
	...
	getResource(e, t, n, r = {}) {
		...
		e.includes(".") ? o = e.split(".") : (o = [e, t], n && (Array.isArray(n) ? o.push(...n) : N(n) && i ? o.push(...n.split(i)) : o.push(n)));
		let s = I(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !N(n) ? s : R(this.data?.[e]?.[t], n, i);
	}
	addResource(e, t, n, r, i = { silent: !1 }) {
		let a = i.keySeparator === void 0 ? this.options.keySeparator : i.keySeparator, o = [e, t];
		n && (o = o.concat(a ? n.split(a) : n)), e.includes(".") && (o = e.split("."), r = t, t = o[1]), this.addNamespaces(t), zt(this.data, o, r), i.silent || this.emit("added", e, t, n, r);
	}
	...
	addResourceBundle(e, t, n, r, i, a = {
		...
		let s = I(this.data, o) || {};
		a.skipCopy || (n = JSON.parse(JSON.stringify(n))), r ? Ht(s, n, i) : s = {
			...s,
			...n
		}, zt(this.data, o, s), a.silent || this.emit("added", e, t, n);
	}
...
}, Qt = Symbol("i18next/PATH_KEY");
function $t() {
	let e = [], t = Object.create(null), n;
	return t.get = (r, i) => (n?.revoke?.(), i === Qt ? e : (e.push(i), n = Proxy.revocable(r, t), n.proxy)), Proxy.revocable(Object.create(null), t).proxy;
}
function H(e, t) {
	let { [Qt]: n } = e($t()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var U = (e) => !N(e) && typeof e != "boolean" && typeof e != "number", en = class e extends V {
	constructor(e, t = {}) {
		super(), Ft([
			"resourceStore",
			"languageUtils",
	...
	extractFromKey(e, t) {
		...
		n === void 0 && (n = ":");
		let r = t.keySeparator === void 0 ? this.options.keySeparator : t.keySeparator, i = t.ns || this.options.defaultNS || [], a = n && e.includes(n), o = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !Jt(e, n, r);
		if (a && !o) {
	...
	translate(t, n, r) {
		...
		if (y && E && D && !_.includes(O) && !(N(v) && Array.isArray(E))) {
	...
	extendTranslation(e, t, n, r, i) {
		...
		return e != null && o?.length && n.applyPostProcessor !== !1 && (e = Zt.handle(o, e, t, this.options && this.options.postProcessPassResolved ? {
			i18nResolved: {
				...r,
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return N(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? H(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	toResolveHierarchy(e, t) {
		...
		return N(e) && (e.includes("-") || e.includes("_")) ? (this.options.load !== "languageOnly" && i(this.formatLanguageCode(e)), this.options.load !== "languageOnly" && this.options.load !== "currentOnly" && i(this.getScriptPartFromCode(e)), this.options.load !== "currentOnly" && i(this.getLanguagePartFromCode(e))) : N(e) && i(this.formatLanguageCode(e)), n.forEach((e) => {
	...
	getRule(e, t = {}) {
		...
		try {
			...
			if (typeof Intl > "u") return this.logger.error("No Intl support, please use an Intl polyfill!"), rn;
			if (!e.match(/-|_/)) return rn;
	...
	getSuffixes(e, t = {}) {
		let n = this.getRule(e, t);
		return n ||= this.getRule("dev", t), n ? n.resolvedOptions().pluralCategories.sort((e, t) => nn[e] - nn[t]).map((e) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${e}`) : [];
	}
	getSuffix(e, t, n = {}) {
	...
	let a = Vt(e, t, n);
	return !a && i && N(n) && (a = R(e, n, r), a === void 0 && (a = R(t, n, r))), a;
}, W = (e) => e.replace(/\$/g, "$$$$"), sn = class {
	constructor(e = {}) {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? Wt : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? L(i) : a || "{{", this.suffix = o ? L(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? L(d) : f || L("$t("), this.nestingSuffix = p ? L(p) : m || L(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		let i, a, o, s = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (e) => {
			if (!e.includes(this.formatSeparator)) {
				let i = on(t, s, e, this.options.keySeparator, this.options.ignoreJSONStructure);
			...
			return this.format(on(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
				...r,
				...t,
				interpolationkey: a
			});
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				else !N(a) && !this.useRawValueToEscape && (a = Pt(a));
				let s = t.safeValue(a);
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			N(i) || (i = Pt(i)), i ||= (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), ""), s.length && (i = s.reduce((e, t) => this.format(e, t, n.lng, {
				...n,
	...
	addCached(e, t) {
		this.formats[e.toLowerCase().trim()] = ln(t);
	}
	format(e, t, n, r = {}) {
		...
		return i.reduce((e, t) => {
			let { formatName: i, formatOptions: a } = cn(t);
			if (this.formats[i]) {
				let t = e;
				try {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			Bt(n.loaded, [i], a), fn(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), mn = (e) => (N(e.ns) && (e.ns = [e.ns]), N(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), N(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), K = () => {}, hn = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, q = class e extends V {
	constructor(e = {}, t) {
		if (super(), this.options = mn(e), this.services = {}, this.logger = B, this.modules = { external: [] }, hn(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		...
		if (!this.options.isClone) {
			...
			let e;
			e = this.modules.formatter ? this.modules.formatter : dn;
			let t = new tn(this.options);
			this.store = new Xt(this.options.resources, this.options);
			let n = this.services;
			n.logger = B, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new an(t, { prepend: this.options.pluralSeparator }), e && (n.formatter = r(e), n.formatter.init && n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new sn(this.options), n.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }, n.backendConnector = new pn(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (e, ...t) => {
				this.emit(e, ...t);
			}), this.modules.languageDetector && (n.languageDetector = r(this.modules.languageDetector), n.languageDetector.init && n.languageDetector.init(n, this.options.detection, this.options)), this.modules.i18nFormat && (n.i18nFormat = r(this.modules.i18nFormat), n.i18nFormat.init && n.i18nFormat.init(this)), this.translator = new en(this.services, this.options), this.translator.on("*", (e, ...t) => {
				this.emit(e, ...t);
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new tn(G());
	...
	cloneInstance(t = {}, n = K) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a[e] = this[e];
		}), a.services = { ...this.services }, a.services.utils = { hasLoadedNamespace: a.hasLoadedNamespace.bind(a) }, r && (a.store = new Xt(Object.keys(this.store.data).reduce((e, t) => (e[t] = { ...this.store.data[t] }, e[t] = Object.keys(e[t]).reduce((n, r) => (n[r] = { ...e[t][r] }, n), e[t]), e), {}), i), a.services.resourceStore = a.store), t.interpolation) {
			let e = {
				...G().interpolation,
				...this.options.interpolation,
				...t.interpolation
			...
			a.services.interpolator = new sn(n);
		}
		return a.translator = new en(a.services, i), a.translator.on("*", (e, ...t) => {
			a.emit(e, ...t);
...
var gn = (e, t, n, r) => {
	...
	X(n) && _n[n] || (X(n) && (_n[n] = /* @__PURE__ */ new Date()), gn(e, t, n, r));
}, vn = (e, t) => () => {
...
}), X = (e) => typeof e == "string", xn = (e) => typeof e == "object" && !!e, Sn = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Cn = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	process.env.NODE_ENV === "production" ? t.exports = Mn() : t.exports = Nn();
}))(), Fn = {
	t: (e, t) => {
		if (X(t)) return t;
		if (xn(t) && X(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: a } = t, { i18n: l, defaultNS: u } = r(Q) || {}, d = a || l || kn();
	d && !d.reportNamespaces && (d.reportNamespaces = new jn()), d || J(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = o(() => ({
		...En(),
		...d?.options?.react,
		...t
	...
	let v = s(0), y = n((e) => {
		...
		f,
		t.lng
	]), [S, C] = c(0), { t: w, ready: T } = (0, Pn.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
			t.lng ? yn(d, t.lng, _, e) : Y(d, _, e);
		}
	}, [
		d,
		t.lng,
	...
	if (d && p && !T) throw new Promise((e) => {
		let n = () => e();
		t.lng ? yn(d, t.lng, _, n) : Y(d, _, n);
	});
	return A;
};
function Rn({ i18n: e, defaultNS: n, children: r }) {
	let i = o(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
