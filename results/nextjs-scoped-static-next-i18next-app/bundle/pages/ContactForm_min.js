import { createContext as e, createElement as t, useCallback as n, useContext as r, useEffect as i, useId as a, useLayoutEffect as o, useMemo as s, useRef as c, useState as l } from "react";
...
var f = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), p = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (Object.prototype.hasOwnProperty.call(e, r) ? m(e[r]) || e[r] instanceof String || m(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : E(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, D = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), O = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, k = (e) => m(e) ? e.replace(/[&<>"'\/]/g, (e) => O[e]) : e, A = class {
	constructor(e) {
	...
	"!",
	";"
], te = new A(20), ne = (e, t, n) => {
	t ||= "", n ||= "";
	let r = ee.filter((e) => !t.includes(e) && !n.includes(e));
	if (r.length === 0) return !0;
	let i = te.getRegExp(`(${r.map((e) => e === "?" ? "\\?" : e).join("|")})`), a = !i.test(e);
	if (!a) {
		let t = e.indexOf(n);
	...
	forward(e, t, n, r) {
		return r && !this.debug ? null : (e = e.map((e) => m(e) ? e.replace(/[\r\n\x00-\x1F\x7F]/g, " ") : e), m(e[0]) && (e[0] = `${n}${this.prefix} ${e[0]}`), this.logger[t](e));
	}
	create(t) {
	...
	getResource(e, t, n, r = {}) {
		...
		let s = w(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !m(n) ? s : j(this.data?.[e]?.[t], n, i);
	}
...
function F(e, t) {
	let { [oe]: n } = e(se()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":", a = t?.enableSelector === "strict";
	if (n.length > 1 && i) {
...
var I = (e) => !m(e) && typeof e != "boolean" && typeof e != "number", L = class e extends P {
	constructor(e, t = {}) {
		super(), _([
			"resourceStore",
			"languageUtils",
	...
	extractFromKey(e, t) {
		...
		n === void 0 && (n = ":");
		let r = t.keySeparator === void 0 ? this.options.keySeparator : t.keySeparator, i = t.ns || this.options.defaultNS || [], a = n && e.includes(n), o = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !ne(e, n, r);
		if (a && !o) {
	...
	translate(t, n, r) {
		...
		if (b && D && O && !v.includes(k) && !(m(y) && Array.isArray(D))) {
			...
			if (n || e || c) {
				if (this.logger.log(c ? "updateKey" : "missingKey", d, l, x && !c ? `${s}${this.pluralResolver.getSuffix(d, i.count, i)}` : s, c ? E : h), o) {
	...
	constructor(e) {
		this.options = e, this.supportedLngs = this.options.supportedLngs || !1, this.logger = N.create("languageUtils"), this.resolveHierarchyCache = {};
	}
	clearCache() {
	...
	toResolveHierarchy(e, t) {
		...
		let i = t === void 0 || t === !1 || m(t), a = t === void 0 && typeof this.options.fallbackLng == "function", o = m(e) && i && !a, s = null;
		if (o) {
			let n;
		...
		return m(e) && (e.includes("-") || e.includes("_")) ? (this.options.load !== "languageOnly" && u(this.formatLanguageCode(e)), this.options.load !== "languageOnly" && this.options.load !== "currentOnly" && u(this.getScriptPartFromCode(e)), this.options.load !== "currentOnly" && u(this.getLanguagePartFromCode(e))) : m(e) && u(this.formatLanguageCode(e)), c.forEach((e) => {
	...
	let a = T(e, t, n);
	return !a && i && m(n) && (a = j(e, n, r), a === void 0 && (a = j(t, n, r))), a;
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? k : t, this.escapeValue = n === void 0 || n, this.useRawValueToEscape = r !== void 0 && r, this.prefix = i ? D(i) : a || "{{", this.suffix = o ? D(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u ? D(u) : "-", this.unescapeSuffix = this.unescapePrefix ? "" : l ? D(l) : "", this.nestingPrefix = d ? D(d) : f || D("$t("), this.nestingSuffix = p ? D(p) : m || D(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ !== void 0 && _, this.resetRegExp();
	}
	reset() {
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			}), i.trim())), e = e.replace(r[0], H(g(i))), this.regexp.lastIndex = 0;
		}
		return e;
	}
}, le = (e) => {
...
}), me = (e) => (m(e.ns) && (e.ns = [e.ns]), m(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), m(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), K = () => {}, he = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, q = class e extends P {
	constructor(e = {}, t) {
		if (super(), this.options = me(e), this.services = {}, this.logger = N, this.modules = { external: [] }, he(this), t && !this.isInitialized && !e.isClone) {
	...
	cloneInstance(t = {}, n = K) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a[e] = this[e];
		}), a.services = { ...this.services }, a.services.utils = { hasLoadedNamespace: a.hasLoadedNamespace.bind(a) }, r && (a.store = new ie(Object.keys(this.store.data).reduce((e, t) => (e[t] = { ...this.store.data[t] }, e[t] = Object.keys(e[t]).reduce((n, r) => (n[r] = { ...e[t][r] }, n), e[t]), e), {}), i), a.services.resourceStore = a.store), t.interpolation) {
			let e = {
				...G().interpolation,
				...this.options.interpolation,
				...t.interpolation
...
var ge = (e, t, n, r) => {
	...
	X(i[0]) && (i[0] = `react-i18next:: ${i[0]}`), e?.services?.logger?.warn ? e.services.logger.warn(...i) : console?.warn && console.warn(...i);
}, _e = {}, J = (e, t, n, r) => {
	X(n) && _e[n] || (X(n) && (_e[n] = /* @__PURE__ */ new Date()), ge(e, t, n, r));
}, ve = (e, t) => () => {
	...
	if (X(n) && (n = [n]), e.options.preload && e.options.preload.indexOf(t) > -1) return Y(e, n, r);
	n.forEach((t) => {
		e.options.ns.indexOf(t) < 0 && e.options.ns.push(t);
	}), e.loadLanguages(t, ve(e, r));
}, be = (e, t, n = {}) => !t.languages || !t.languages.length ? (J(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), X = (e) => typeof e == "string", xe = (e) => typeof e == "object" && !!e, Se = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Ce = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t.exports = process.env.NODE_ENV === "production" ? Ne() : Pe();
}))(), Ie = {
	t: (e, t) => {
		if (X(t)) return t;
		if (xe(t) && X(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: a } = t, { i18n: o, defaultNS: u } = r(je) || {}, d = a || o || ke();
	d && !d.reportNamespaces && (d.reportNamespaces = new Me()), d || J(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next or by passing it via props or context. In monorepo setups, make sure there is only one instance of react-i18next.");
	let f = s(() => ({
		...Ee(),
		...d?.options?.react,
		...t
	}), [d, t]), { useSuspense: p, keyPrefix: m } = f, h = e || u || d?.options?.defaultNS, g = X(h) ? [h] : h || ["translation"], _ = s(() => g, g);
	...
	let v = c(0), y = n((e) => {
		...
		if (!d) return Ie;
		let e = !!(d.isInitialized || d.initializedStoreOnce) && _.every((e) => be(e, d, f)), n = t.lng || d.language, r = v.current, i = b.current;
		...
		f,
		t.lng
	]), [S, C] = l(0), { t: w, ready: T } = (0, Fe.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
			t.lng ? ye(d, t.lng, _, e) : Y(d, _, e);
		}
	}, [
		d,
		t.lng,
	...
	let E = d || {}, D = c(null), O = c(), k = (e) => {
		...
		let r = !T && !p ? (...e) => (J(d, "USE_T_BEFORE_READY", "useTranslation: t was called before ready. When using useSuspense: false, make sure to check the ready flag before using t."), w(...e)) : w, i = [
			r,
			n,
			T
		];
	...
	if (d && p && !T) {
		...
		throw e && J(d, "SUSPENDED_WHILE_LOADING", "useTranslation: suspended while translations are loading (useSuspense is true by default). Add a <Suspense> boundary above this component, or set react.useSuspense: false in the i18next init options. https://react.i18next.com/latest/usetranslation-hook"), new Promise((e) => {
			let n = () => e();
			t.lng ? ye(d, t.lng, _, n) : Y(d, _, n);
		});
	}
	return A;
};
function ze({ i18n: e, defaultNS: n, children: r }) {
	let i = s(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
	return t(je.Provider, { value: i }, r);
}
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/components/pages/contact/ContactForm.tsx";
function Be() {
	let { t: e } = Re("contact"), t = a(), n = a(), r = a(), i = a();
	return u("form", {
		className: "space-y-6",
		children: [
			u("div", {
				className: "grid gap-4 md:grid-cols-2",
				children: [u("div", { children: [u("label", {
					htmlFor: t,
					className: "mb-1 block text-sm font-medium text-foreground",
					children: e("contactForm.name")
				}, void 0, !1, {
					fileName: Q,
					lineNumber: 17,
					columnNumber: 11
					...
					placeholder: e("contactForm.name")
				}, void 0, !1, {
					fileName: Q,
					lineNumber: 23,
					columnNumber: 11
					...
					lineNumber: 16,
					columnNumber: 9
				}, this), u("div", { children: [u("label", {
					htmlFor: n,
					className: "mb-1 block text-sm font-medium text-foreground",
					children: e("contactForm.email")
				}, void 0, !1, {
					fileName: Q,
					lineNumber: 30,
					columnNumber: 11
			...
			u("div", { children: [u("label", {
				htmlFor: r,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: e("contactForm.subject")
			}, void 0, !1, {
				fileName: Q,
				lineNumber: 45,
				columnNumber: 9
				...
				children: [
					u("option", { children: "Bug Report" }, void 0, !1, {
						fileName: Q,
						lineNumber: 55,
						columnNumber: 11
					}, this),
					u("option", { children: "New Benchmark Idea" }, void 0, !1, {
						fileName: Q,
						lineNumber: 56,
						columnNumber: 11
					}, this),
					u("option", { children: "Methodology Question" }, void 0, !1, {
						fileName: Q,
						lineNumber: 57,
						columnNumber: 11
					}, this),
					u("option", { children: "Contribution" }, void 0, !1, {
						fileName: Q,
						lineNumber: 58,
						columnNumber: 11
					}, this),
					u("option", { children: "Other" }, void 0, !1, {
						fileName: Q,
						lineNumber: 59,
						columnNumber: 11
					}, this)
			...
			u("div", { children: [u("label", {
				htmlFor: i,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: e("contactForm.message")
			}, void 0, !1, {
				fileName: Q,
				lineNumber: 63,
				columnNumber: 9
				...
				rows: 5,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: e("contactForm.message")
			}, void 0, !1, {
				fileName: Q,
				lineNumber: 69,
				columnNumber: 9
			...
			u("button", {
				...
				children: e("contactForm.sendMessage")
			}, void 0, !1, {
				fileName: Q,
				lineNumber: 76,
				columnNumber: 7
			...
			u("p", {
				...
				children: e("contactForm.wellGetBackTo")
			}, void 0, !1, {
				fileName: Q,
				lineNumber: 82,
				columnNumber: 7
...
var $ = q, ar = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/components/AppProviders.tsx";
...
var sr = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/scripts/Wrapper.tsx";
function cr({ children: e }) {
	return u(or, { children: e }, void 0, !1, {
		fileName: sr,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var lr = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/components/pages/contact/ContactForm.wrapper.tsx";
function ur() {
	return u(cr, { children: u(Be, {}, void 0, !1, {
		fileName: lr,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
