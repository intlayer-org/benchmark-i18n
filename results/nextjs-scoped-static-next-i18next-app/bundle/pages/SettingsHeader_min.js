...
}, V = Symbol("i18next/PATH_KEY");
function tn() {
	let e = [], t = Object.create(null), n;
	return t.get = (r, i) => (n?.revoke?.(), i === V ? e : (e.push(i), n = Proxy.revocable(r, t), n.proxy)), Proxy.revocable(Object.create(null), t).proxy;
}
function H(e, t) {
	let { [V]: n } = e(tn()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var U = (e) => !A(e) && typeof e != "boolean" && typeof e != "number", nn = class e extends R {
	constructor(e, t = {}) {
		super(), Bt([
			"resourceStore",
			"languageUtils",
	...
	translate(t, n, r) {
		...
		typeof t == "function" && (t = H(t, {
			...this.options,
			...i
		})), Array.isArray(t) || (t = [String(t)]), t = t.map((e) => typeof e == "function" ? H(e, {
			...this.options,
			...i
		}) : String(e));
		...
		y && !m && x && (E = T);
		let D = U(E), O = Object.prototype.toString.apply(E);
	...
	extendTranslation(e, t, n, r, i) {
		...
		return e != null && o?.length && n.applyPostProcessor !== !1 && (e = B.handle(o, e, t, this.options && this.options.postProcessPassResolved ? {
			i18nResolved: {
				...r,
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return A(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? H(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	getSuffixes(e, t = {}) {
		let n = this.getRule(e, t);
		return n ||= this.getRule("dev", t), n ? n.resolvedOptions().pluralCategories.sort((e, t) => an[e] - an[t]).map((e) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${e}`) : [];
	}
	getSuffix(e, t, n = {}) {
...
}), K = (e) => (A(e.ns) && (e.ns = [e.ns]), A(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), A(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), q = () => {}, gn = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, J = class e extends R {
	constructor(e = {}, t) {
		if (super(), this.options = K(e), this.services = {}, this.logger = L, this.modules = { external: [] }, gn(this), t && !this.isInitialized && !e.isClone) {
	...
	use(e) {
		...
		return e.type === "backend" && (this.modules.backend = e), (e.type === "logger" || e.log && e.warn && e.error) && (this.modules.logger = e), e.type === "languageDetector" && (this.modules.languageDetector = e), e.type === "i18nFormat" && (this.modules.i18nFormat = e), e.type === "postProcessor" && B.addPostProcessor(e), e.type === "formatter" && (this.modules.formatter = e), e.type === "3rdParty" && this.modules.external.push(e), this;
	}
	...
	getFixedT(e, t, n) {
		let r = (e, t, ...i) => {
			...
			typeof a.keyPrefix == "function" && (a.keyPrefix = H(a.keyPrefix, o));
			let s = this.options.keySeparator || ".", c;
			return a.keyPrefix && Array.isArray(e) ? c = e.map((e) => (typeof e == "function" && (e = H(e, o)), `${a.keyPrefix}${s}${e}`)) : (typeof e == "function" && (e = H(e, o)), c = a.keyPrefix ? `${a.keyPrefix}${s}${e}` : e), this.t(c, a);
		};
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new rn(G());
	...
	cloneInstance(t = {}, n = q) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a[e] = this[e];
		}), a.services = { ...this.services }, a.services.utils = { hasLoadedNamespace: a.hasLoadedNamespace.bind(a) }, r && (a.store = new z(Object.keys(this.store.data).reduce((e, t) => (e[t] = { ...this.store.data[t] }, e[t] = Object.keys(e[t]).reduce((n, r) => (n[r] = { ...e[t][r] }, n), e[t]), e), {}), i), a.services.resourceStore = a.store), t.interpolation) {
			let e = {
				...G().interpolation,
				...this.options.interpolation,
				...t.interpolation
		...
		return a.translator = new nn(a.services, i), a.translator.on("*", (e, ...t) => {
			a.emit(e, ...t);
...
var _n = (e, t, n, r) => {
	...
	Z(n) && vn[n] || (Z(n) && (vn[n] = /* @__PURE__ */ new Date()), _n(e, t, n, r));
}, yn = (e, t) => () => {
...
}, xn = (e, t, n = {}) => !t.languages || !t.languages.length ? (Y(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
	...
	let { i18n: a } = t, { i18n: l, defaultNS: u } = r(Mn) || {}, d = a || l || An();
	d && !d.reportNamespaces && (d.reportNamespaces = new Nn()), d || Y(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = o(() => ({
		...Dn(),
		...d?.options?.react,
		...t
	...
	let v = s(0), y = n((e) => {
		...
		f,
		t.lng
	]), [S, C] = c(0), { t: w, ready: T } = (0, In.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
			t.lng ? bn(d, t.lng, _, e) : X(d, _, e);
		}
	}, [
		d,
		t.lng,
...
function sr({ children: e }) {
	return u(or, { children: e });
}
function cr() {
	return u(sr, { children: u(Hn, {}) });
}
