...
var d = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), f = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (Object.prototype.hasOwnProperty.call(e, r) ? p(e[r]) || e[r] instanceof String || p(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : T(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, E = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), D = {
	"&": "&amp;",
	"<": "&lt;",
	...
	forward(e, t, n, r) {
		return r && !this.debug ? null : (e = e.map((e) => p(e) ? e.replace(/[\r\n\x00-\x1F\x7F]/g, " ") : e), p(e[0]) && (e[0] = `${n}${this.prefix} ${e[0]}`), this.logger[t](e));
	}
	create(t) {
...
function R(e, t) {
	let { [L]: n } = e(re()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":", a = t?.enableSelector === "strict";
	if (n.length > 1 && i) {
...
var z = (e) => !p(e) && typeof e != "boolean" && typeof e != "number", ie = class e extends P {
	constructor(e, t = {}) {
		super(), g([
			"resourceStore",
			"languageUtils",
	...
	toResolveHierarchy(e, t) {
		...
		let i = t === void 0 || t === !1 || p(t), a = t === void 0 && typeof this.options.fallbackLng == "function", o = p(e) && i && !a, s = null;
		if (o) {
			let n;
		...
		return p(e) && (e.includes("-") || e.includes("_")) ? (this.options.load !== "languageOnly" && u(this.formatLanguageCode(e)), this.options.load !== "languageOnly" && this.options.load !== "currentOnly" && u(this.getScriptPartFromCode(e)), this.options.load !== "currentOnly" && u(this.getLanguagePartFromCode(e))) : p(e) && u(this.formatLanguageCode(e)), c.forEach((e) => {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? O : t, this.escapeValue = n === void 0 || n, this.useRawValueToEscape = r !== void 0 && r, this.prefix = i ? E(i) : a || "{{", this.suffix = o ? E(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u ? E(u) : "-", this.unescapeSuffix = this.unescapePrefix ? "" : l ? E(l) : "", this.nestingPrefix = d ? E(d) : f || E("$t("), this.nestingSuffix = p ? E(p) : m || E(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ !== void 0 && _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				let s = t.safeValue(a);
				if (e = e.replace(i[0], ue(s)), u ? (t.regex.lastIndex += s.length, t.regex.lastIndex -= i[0].length) : t.regex.lastIndex = 0, o++, o >= this.maxReplaces) break;
			}
		}), e;
	}
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			}), i.trim())), e = e.replace(r[0], ue(h(i))), this.regexp.lastIndex = 0;
		}
		return e;
	}
}, fe = (e) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			S(n.loaded, [i], a), he(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), H = (e) => (p(e.ns) && (e.ns = [e.ns]), p(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), p(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), U = () => {}, _e = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, W = class e extends P {
	constructor(e = {}, t) {
		if (super(), this.options = H(e), this.services = {}, this.logger = N, this.modules = { external: [] }, _e(this), t && !this.isInitialized && !e.isClone) {
	...
	getFixedT(e, t, n, r) {
		let i = r?.scopeNs, a = (e, t, ...r) => {
			...
			Array.isArray(i) && !s && (c.ns = i), typeof o.keyPrefix == "function" && (o.keyPrefix = R(o.keyPrefix, c));
			let l = this.options.keySeparator || ".", u;
			return o.keyPrefix && Array.isArray(e) ? u = e.map((e) => (typeof e == "function" && (e = R(e, c)), `${o.keyPrefix}${l}${e}`)) : (typeof e == "function" && (e = R(e, c)), u = o.keyPrefix ? `${o.keyPrefix}${l}${e}` : e), this.t(u, o);
		};
		return p(e) ? a.lng = e : a.lngs = e, a.ns = t, a.keyPrefix = n, a;
	}
	t(...e) {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new ae(V());
...
W.createInstance, W.dir, W.init, W.loadResources, W.reloadResources, W.use, W.changeLanguage, W.getFixedT, W.t, W.exists, W.setDefaultNamespace, W.hasLoadedNamespace, W.loadNamespaces, W.loadLanguages;
var ve = (e, t, n, r) => {
	let i = [n, {
		code: t,
		...r || {}
	...
	X(n) && G[n] || (X(n) && (G[n] = /* @__PURE__ */ new Date()), ve(e, t, n, r));
}, q = (e, t) => () => {
	...
	e.loadNamespaces(t, q(e, n));
}, Y = (e, t, n, r) => {
	if (X(n) && (n = [n]), e.options.preload && e.options.preload.indexOf(t) > -1) return J(e, n, r);
	n.forEach((t) => {
		e.options.ns.indexOf(t) < 0 && e.options.ns.push(t);
	}), e.loadLanguages(t, q(e, r));
}, ye = (e, t, n = {}) => !t.languages || !t.languages.length ? (K(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), X = (e) => typeof e == "string", be = (e) => typeof e == "object" && !!e, xe = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Se = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (X(t)) return t;
		if (be(t) && X(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: a } = t, { i18n: l, defaultNS: u } = r(Ae) || {}, d = a || l || Oe();
	d && !d.reportNamespaces && (d.reportNamespaces = new je()), d || K(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next or by passing it via props or context. In monorepo setups, make sure there is only one instance of react-i18next.");
	let f = o(() => ({
		...Te(),
		...d?.options?.react,
		...t
	...
	let v = s(0), y = n((e) => {
		...
		if (!d) return Fe;
		let e = !!(d.isInitialized || d.initializedStoreOnce) && _.every((e) => ye(e, d, f)), n = t.lng || d.language, r = v.current, i = b.current;
		...
		f,
		t.lng
	]), [S, C] = c(0), { t: w, ready: T } = (0, Pe.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
			t.lng ? Y(d, t.lng, _, e) : J(d, _, e);
		}
	}, [
		d,
		t.lng,
	...
	if (d && p && !T) {
		...
		throw e && K(d, "SUSPENDED_WHILE_LOADING", "useTranslation: suspended while translations are loading (useSuspense is true by default). Add a <Suspense> boundary above this component, or set react.useSuspense: false in the i18next init options. https://react.i18next.com/latest/usetranslation-hook"), new Promise((e) => {
			let n = () => e();
			t.lng ? Y(d, t.lng, _, n) : J(d, _, n);
		});
	}
	return A;
};
function Re({ i18n: e, defaultNS: n, children: r }) {
	let i = o(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
...
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/components/pages/team/TeamGrid.tsx";
function ze() {
	let { t: e } = Le("team"), t = [
		{
			name: e("teamGrid.sarahChen"),
			role: e("teamGrid.founderLeadEngineer"),
			bio: e("teamGrid.formerGoogleEngineerWith10")
		},
		{
			name: e("teamGrid.marcusWeber"),
			role: e("teamGrid.performanceEngineer"),
			bio: e("teamGrid.specializesInJavascriptPerformanceOptimization")
		},
		{
			name: e("teamGrid.aishaPatel"),
			role: e("teamGrid.developerAdvocate"),
			bio: e("teamGrid.passionateAboutDeveloperExperienceAnd")
		},
		{
			name: e("teamGrid.tomasRodriguez"),
			role: e("teamGrid.fullStackDeveloper"),
			bio: e("teamGrid.maintainsTheBenchmarkingInfrastructureAnd")
		},
		{
			name: e("teamGrid.yukiTanaka"),
			role: e("teamGrid.dataAnalyst"),
			bio: e("teamGrid.ensuresStatisticalRigorInAll")
		},
		{
			name: e("teamGrid.elenaKowalski"),
			role: e("teamGrid.communityManager"),
			bio: e("teamGrid.managesCommunityContributionsPartnershipsAnd")
		}
	];
	return l("div", {
...
var $ = W, ir = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/components/AppProviders.tsx";
...
var cr = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-i18next-app/components/pages/team/TeamGrid.wrapper.tsx";
function lr() {
