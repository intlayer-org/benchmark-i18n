"use client";
import "react";
import e from "../messages/fr/about.json";
import t from "../messages/fr/blog.json";
import n from "../messages/fr/careers.json";
import r from "../messages/fr/contact.json";
import i from "../messages/fr/faq.json";
import a from "../messages/fr/home.json";
import o from "../messages/fr/pricing.json";
import s from "../messages/fr/products.json";
import c from "../messages/fr/route.json";
import l from "../messages/fr/settings.json";
import u from "../messages/fr/shared.json";
import d from "../messages/fr/team.json";
import f from "../messages/es/about.json";
import p from "../messages/es/blog.json";
import m from "../messages/es/careers.json";
...
import ee from "../messages/it/faq.json";
import te from "../messages/it/home.json";
import ne from "../messages/it/pricing.json";
import re from "../messages/it/products.json";
import ie from "../messages/it/route.json";
import ae from "../messages/it/settings.json";
import oe from "../messages/it/shared.json";
import se from "../messages/it/team.json";
...
import W from "../messages/pt/home.json";
import G from "../messages/pt/pricing.json";
import le from "../messages/pt/products.json";
import ue from "../messages/pt/route.json";
import de from "../messages/pt/settings.json";
import fe from "../messages/pt/shared.json";
import pe from "../messages/pt/team.json";
import me from "../messages/zh/about.json";
import he from "../messages/zh/blog.json";
import ge from "../messages/zh/careers.json";
import _e from "../messages/zh/contact.json";
import ve from "../messages/zh/faq.json";
import ye from "../messages/zh/home.json";
import be from "../messages/zh/pricing.json";
import xe from "../messages/zh/products.json";
import Se from "../messages/zh/route.json";
import Ce from "../messages/zh/settings.json";
import we from "../messages/zh/shared.json";
import Te from "../messages/zh/team.json";
import Ee from "../messages/ja/about.json";
import De from "../messages/ja/blog.json";
import Oe from "../messages/ja/careers.json";
import ke from "../messages/ja/contact.json";
import Ae from "../messages/ja/faq.json";
import je from "../messages/ja/home.json";
import Me from "../messages/ja/pricing.json";
import Ne from "../messages/ja/products.json";
import Pe from "../messages/ja/route.json";
import Fe from "../messages/ja/settings.json";
import Ie from "../messages/ja/shared.json";
import Le from "../messages/ja/team.json";
import Re from "../messages/ko/about.json";
import ze from "../messages/ko/blog.json";
import Be from "../messages/ko/careers.json";
import Ve from "../messages/ko/contact.json";
import He from "../messages/ko/faq.json";
import Ue from "../messages/ko/home.json";
import We from "../messages/ko/pricing.json";
import Ge from "../messages/ko/products.json";
import Ke from "../messages/ko/route.json";
import qe from "../messages/ko/settings.json";
import Je from "../messages/ko/shared.json";
import Ye from "../messages/ko/team.json";
import Xe from "../messages/ru/about.json";
import Ze from "../messages/ru/blog.json";
import Qe from "../messages/ru/careers.json";
import $e from "../messages/ru/contact.json";
import et from "../messages/ru/faq.json";
import tt from "../messages/ru/home.json";
import nt from "../messages/ru/pricing.json";
import rt from "../messages/ru/products.json";
import it from "../messages/ru/route.json";
import at from "../messages/ru/settings.json";
import ot from "../messages/ru/shared.json";
import st from "../messages/ru/team.json";
...
var q = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), J = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	f(g, { createI18nClient: () => z }), t.exports = h(g), ct();
...
var Et = Z("de"), Dt = Z("en"), Ot = Z("es"), kt = Z("fr"), At = Z("it"), jt = Z("ja"), Mt = Z("ko"), Nt = Z("pt"), Q = Z("ru"), Pt = Z("zh"), $ = (0, lt.createI18nClient)({
	en: () => Promise.resolve({ default: Dt }),
	fr: () => Promise.resolve({ default: kt }),
	es: () => Promise.resolve({ default: Ot }),
	de: () => Promise.resolve({ default: Et }),
	it: () => Promise.resolve({ default: At }),
	pt: () => Promise.resolve({ default: Nt }),
	zh: () => Promise.resolve({ default: Pt }),
	ja: () => Promise.resolve({ default: jt }),
	ko: () => Promise.resolve({ default: Mt }),
	ru: () => Promise.resolve({ default: Q })
}), Ft = $.useScopedI18n, { I18nProviderClient: It, useChangeLocale: Lt, useCurrentLocale: Rt } = $, zt = () => (Ft("header"), null);
function Bt() {
	return K(It, {
		locale: Rt(),
		children: K(zt, {})
