...
var kt = Z("de"), At = Z("en"), jt = Z("es"), Mt = Z("fr"), Nt = Z("it"), Pt = Z("ja"), Ft = Z("ko"), It = Z("pt"), Lt = Z("ru"), Rt = Z("zh"), Q = (0, s.createI18nClient)({
