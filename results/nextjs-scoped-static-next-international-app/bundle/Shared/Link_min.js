...
var d = ({ href: e, children: t, ...n }) => {
	...
	var S = (e) => x("warn", e), C = (e) => x("error", e), w = /* @__PURE__ */ new Map();
	function T(e, t, n) {
		function r({ locale: t, importLocale: r, children: i }) {
			let a = w.get(t) ?? (0, y.use)(r).default;
			w.has(t) || w.set(t, a);
			let o = (0, y.useMemo)(() => ({
				localeContent: b(a),
		...
		return function({ locale: e, fallback: n, children: i }) {
			let a = t[e];
			return a || (C(`The locale '${e}' is not supported. Defined locales are: [${Object.keys(t).join(", ")}].`), (0, v.notFound)()), y.default.createElement(y.Suspense, { fallback: n }, y.default.createElement(r, {
				locale: e,
				importLocale: a()
			}, i));
		};
	...
	function k(e, t) {
		...
		function c(e, ...n) {
			...
			let l = !0, u = c?.split(/({[^}]*})/).map((e, t) => {
				...
				if (n) {
					let e = n[1], i = r[e];
					return (0, O.isValidElement)(i) ? (l = !1, (0, O.cloneElement)(i, { key: `${String(e)}-${t}` })) : i;
				}
				return e;
			});
			return l ? u?.join("") : u;
	...
	function P(e, t, n) {
		return function(r) {
			...
			return n.basePath && (u = u.replace(n.basePath, "")), u.startsWith(`/${o}/`) ? u = u.replace(`/${o}/`, "/") : u === `/${o}` && (u = "/"), function(e) {
				...
				let n = t[e];
				if (!n) {
					S(`The locale '${e}' is not supported. Defined locales are: [${Object.keys(t).join(", ")}].`);
					return;
				}
				n().then((t) => {
					w.set(e, t.default), i(`/${e}${u}${l}`), a();
				});
			};
		};
	}
	...
	function z(e, t) {
		return function() {
			...
			return (0, L.useMemo)(() => {
				...
				C(`Locale "${n}" not found in locales (${e.join(", ")}), returning "notFound()"`), (0, I.notFound)();
			}, [n]);
		};
	}
	function B(e, t = {}) {
		let n = Object.keys(e), r = (0, E.createContext)(null), i = z(n, t), a = T(r, e, t.fallbackLocale);
		return {
			useI18n: A(r),
			useScopedI18n: M(r),
			I18nProviderClient: a,
			I18nClientContext: r,
			useChangeLocale: P(i, e, t),
			defineLocale: F(),
			useCurrentLocale: i
		};
	}
	0 && (t.exports = { createI18nClient: B });
}))(), p = {
...
var It = X("de"), Lt = X("en"), Rt = X("es"), zt = X("fr"), Bt = X("it"), Vt = X("ja"), Ht = X("ko"), Z = X("pt"), Ut = X("ru"), Wt = X("zh"), Q = (0, f.createI18nClient)({
	en: () => Promise.resolve({ default: Lt }),
	fr: () => Promise.resolve({ default: zt }),
	es: () => Promise.resolve({ default: Rt }),
	de: () => Promise.resolve({ default: It }),
	it: () => Promise.resolve({ default: Bt }),
	pt: () => Promise.resolve({ default: Z }),
	zh: () => Promise.resolve({ default: Wt }),
	ja: () => Promise.resolve({ default: Vt }),
	ko: () => Promise.resolve({ default: Ht }),
	ru: () => Promise.resolve({ default: Ut })
});
Q.useScopedI18n;
var { I18nProviderClient: Gt, useChangeLocale: Kt, useCurrentLocale: qt } = Q;
function Jt() {
	if (!(typeof window > "u")) {
...
var Xt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-international-app/components/AppProviders.tsx";
...
var Qt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-international-app/scripts/Wrapper.tsx", $t = "en";
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-international-app/components/Link.wrapper.tsx";
function tn() {
	return a(en, { children: a(d, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
