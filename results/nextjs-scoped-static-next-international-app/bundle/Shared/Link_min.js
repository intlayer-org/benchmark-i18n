...
var ht = ({ href: e, children: t, ...n }) => {
	let o = i().locale ?? "en";
	return e == null || typeof e != "string" || pt(e) ? a(r, {
		href: e,
		prefetch: !1,
		...n,
		children: t
	...
	f(g, { createI18nClient: () => z }), t.exports = h(g), gt();
...
var Pt = Z("de"), Ft = Z("en"), It = Z("es"), Lt = Z("fr"), Rt = Z("it"), zt = Z("ja"), Bt = Z("ko"), Vt = Z("pt"), Q = Z("ru"), Ht = Z("zh"), $ = (0, _t.createI18nClient)({
	en: () => Promise.resolve({ default: Ft }),
	fr: () => Promise.resolve({ default: Lt }),
	es: () => Promise.resolve({ default: It }),
	de: () => Promise.resolve({ default: Pt }),
	it: () => Promise.resolve({ default: Rt }),
	pt: () => Promise.resolve({ default: Vt }),
	zh: () => Promise.resolve({ default: Ht }),
	ja: () => Promise.resolve({ default: zt }),
	ko: () => Promise.resolve({ default: Bt }),
	ru: () => Promise.resolve({ default: Q })
});
$.useScopedI18n;
var { I18nProviderClient: Ut, useChangeLocale: Wt, useCurrentLocale: Gt } = $;
function Kt() {
	if (!(typeof window > "u")) {
...
function Jt({ children: r, locale: i }) {
