...
var At = X("de"), jt = X("en"), Mt = X("es"), Nt = X("fr"), Pt = X("it"), Z = X("ja"), Ft = X("ko"), It = X("pt"), Lt = X("ru"), Rt = X("zh"), Q = (0, s.createI18nClient)({
...
}), zt = Q.useScopedI18n, { I18nProviderClient: Bt, useChangeLocale: Vt, useCurrentLocale: Ht } = Q, Ut = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-international-app/components/MockBanner.tsx", Wt = () => {
	let e = zt("mock-banner");
	return r("div", {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-international-app/components/MockBanner.wrapper.tsx";
function Qt() {
