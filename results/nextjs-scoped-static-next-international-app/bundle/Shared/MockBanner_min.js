...
var kt = Z("de"), At = Z("en"), jt = Z("es"), Mt = Z("fr"), Nt = Z("it"), Pt = Z("ja"), Q = Z("ko"), Ft = Z("pt"), It = Z("ru"), Lt = Z("zh"), $ = (0, s.createI18nClient)({
...
}), Rt = $.useScopedI18n, { I18nProviderClient: zt, useChangeLocale: Bt, useCurrentLocale: Vt } = $, Ht = () => {
	let e = Rt("mock-banner");
	return r("div", {
...
function Gt({ children: i, locale: a }) {
