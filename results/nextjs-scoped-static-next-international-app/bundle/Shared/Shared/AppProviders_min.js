...
var kt = Z("de"), At = Z("en"), jt = Z("es"), Mt = Z("fr"), Nt = Z("it"), Pt = Z("ja"), Ft = Z("ko"), It = Z("pt"), Lt = Z("ru"), Rt = Z("zh"), Q = (0, pt.createI18nClient)({
	...
	ko: () => Promise.resolve({ default: Ft }),
	ru: () => Promise.resolve({ default: Lt })
});
Q.useScopedI18n;
var { I18nProviderClient: zt, useChangeLocale: Bt, useCurrentLocale: Vt } = Q;
function Ht() {
	if (!(typeof window > "u")) {
