...
import y from "../messages/fr/settings.json";
import b from "../messages/fr/shared.json";
import x from "../messages/fr/team.json";
import S from "../messages/es/about.json";
import C from "../messages/es/blog.json";
import w from "../messages/es/careers.json";
import T from "../messages/es/contact.json";
import E from "../messages/es/faq.json";
import D from "../messages/es/home.json";
import O from "../messages/es/pricing.json";
import k from "../messages/es/products.json";
import A from "../messages/es/route.json";
import j from "../messages/es/settings.json";
import M from "../messages/es/shared.json";
import N from "../messages/es/team.json";
import P from "../messages/de/about.json";
import F from "../messages/de/blog.json";
import I from "../messages/de/careers.json";
import L from "../messages/de/contact.json";
import R from "../messages/de/faq.json";
import z from "../messages/de/home.json";
import ee from "../messages/de/pricing.json";
import te from "../messages/de/products.json";
import ne from "../messages/de/route.json";
import re from "../messages/de/settings.json";
import ie from "../messages/de/shared.json";
import ae from "../messages/de/team.json";
import oe from "../messages/it/about.json";
import se from "../messages/it/blog.json";
import ce from "../messages/it/careers.json";
import le from "../messages/it/contact.json";
import ue from "../messages/it/faq.json";
import de from "../messages/it/home.json";
import B from "../messages/it/pricing.json";
import V from "../messages/it/products.json";
import H from "../messages/it/route.json";
import fe from "../messages/it/settings.json";
import pe from "../messages/it/shared.json";
import me from "../messages/it/team.json";
import he from "../messages/pt/about.json";
import ge from "../messages/pt/blog.json";
import _e from "../messages/pt/careers.json";
import ve from "../messages/pt/contact.json";
import ye from "../messages/pt/faq.json";
import be from "../messages/pt/home.json";
import xe from "../messages/pt/pricing.json";
import Se from "../messages/pt/products.json";
import Ce from "../messages/pt/route.json";
import we from "../messages/pt/settings.json";
import Te from "../messages/pt/shared.json";
import Ee from "../messages/pt/team.json";
import De from "../messages/zh/about.json";
import Oe from "../messages/zh/blog.json";
import ke from "../messages/zh/careers.json";
import Ae from "../messages/zh/contact.json";
import je from "../messages/zh/faq.json";
import Me from "../messages/zh/home.json";
import Ne from "../messages/zh/pricing.json";
import Pe from "../messages/zh/products.json";
import Fe from "../messages/zh/route.json";
import Ie from "../messages/zh/settings.json";
import Le from "../messages/zh/shared.json";
import Re from "../messages/zh/team.json";
import ze from "../messages/ja/about.json";
import Be from "../messages/ja/blog.json";
import Ve from "../messages/ja/careers.json";
import He from "../messages/ja/contact.json";
import Ue from "../messages/ja/faq.json";
import We from "../messages/ja/home.json";
import Ge from "../messages/ja/pricing.json";
import Ke from "../messages/ja/products.json";
import qe from "../messages/ja/route.json";
import Je from "../messages/ja/settings.json";
import Ye from "../messages/ja/shared.json";
import Xe from "../messages/ja/team.json";
import Ze from "../messages/ko/about.json";
import Qe from "../messages/ko/blog.json";
import $e from "../messages/ko/careers.json";
import et from "../messages/ko/contact.json";
import tt from "../messages/ko/faq.json";
import nt from "../messages/ko/home.json";
import rt from "../messages/ko/pricing.json";
import it from "../messages/ko/products.json";
import at from "../messages/ko/route.json";
import ot from "../messages/ko/settings.json";
import st from "../messages/ko/shared.json";
import ct from "../messages/ko/team.json";
import lt from "../messages/ru/about.json";
import ut from "../messages/ru/blog.json";
import dt from "../messages/ru/careers.json";
import ft from "../messages/ru/contact.json";
import pt from "../messages/ru/faq.json";
import mt from "../messages/ru/home.json";
import ht from "../messages/ru/pricing.json";
import gt from "../messages/ru/products.json";
import _t from "../messages/ru/route.json";
import vt from "../messages/ru/settings.json";
import yt from "../messages/ru/shared.json";
import bt from "../messages/ru/team.json";
var U = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), W = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
var K = ({ href: e, children: t, ...n }) => {
	let a = i().locale ?? "en";
	return e == null || typeof e != "string" || xt(e) ? s(r, {
		href: e,
		...n,
		children: t
	}) : s(r, {
	...
	f(g, { createI18nClient: () => z }), t.exports = h(g), St();
	var _ = W("next/navigation"), v = m(W("react")), y = (e, t = "") => Object.entries(e).reduce((e, [n, r]) => d(d({}, e), typeof r == "string" ? { [t + n]: r } : y(r, `${t}${n}.`)), {});
	function b(e, t) {
	...
	var T = W("react"), E = W("react"), D = W("react");
	function O(e, t) {
	...
	var F = W("next/navigation"), I = W("react"), L = "locale";
	function R(e, t) {
		return function() {
...
function J(e, t) {
	...
	for (let [e, r] of Object.entries(t)) {
		let t = n[e];
		typeof r == "object" && r && !Array.isArray(r) && typeof t == "object" && t && !Array.isArray(t) ? n[e] = J(t, r) : n[e] = r;
	}
	return n;
}
function Rt(e) {
...
var Bt = Y("de"), Vt = Y("en"), Ht = Y("es"), Ut = Y("fr"), Wt = Y("it"), Gt = Y("ja"), Kt = Y("ko"), qt = Y("pt"), Jt = Y("ru"), Yt = Y("zh"), X = (0, Ct.createI18nClient)({
	en: () => Promise.resolve({ default: Vt }),
	fr: () => Promise.resolve({ default: Ut }),
	es: () => Promise.resolve({ default: Ht }),
	de: () => Promise.resolve({ default: Bt }),
	it: () => Promise.resolve({ default: Wt }),
	pt: () => Promise.resolve({ default: qt }),
	zh: () => Promise.resolve({ default: Yt }),
	ja: () => Promise.resolve({ default: Gt }),
	ko: () => Promise.resolve({ default: Kt }),
	ru: () => Promise.resolve({ default: Jt })
}), Z = X.useScopedI18n, { I18nProviderClient: Xt, useChangeLocale: Zt, useCurrentLocale: Qt } = X;
function $t() {
...
function $() {
	let t = Z("theme-toggle"), [r, i] = n("auto");
	e(() => {
		let e = $t();
		i(e), Q(e);
	}, []), e(() => {
...
function an() {
	let e = Z("header"), t = Z("footer");
	rn("Header");
	let [r, o] = n(!1), u = i(), d = a(), f = u.locale ?? "en", p = [
		{
			href: "/products",
			label: e("products")
		},
			...
			children: [c("div", {
				...
				children: [s(K, {
					...
					children: [
						s(K, {
							href: "/",
							className: `nav-link${((e) => d === G(e, f))("/") ? " is-active" : ""}`,
							children: e("home")
						}),
						s(K, {
							href: "/about",
...
function cn({ children: r, locale: i }) {
