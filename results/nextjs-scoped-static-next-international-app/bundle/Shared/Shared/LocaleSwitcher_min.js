...
import h from "../messages/fr/route.json";
import g from "../messages/fr/settings.json";
import _ from "../messages/fr/shared.json";
import v from "../messages/fr/team.json";
import y from "../messages/es/about.json";
import b from "../messages/es/blog.json";
import x from "../messages/es/careers.json";
import S from "../messages/es/contact.json";
import C from "../messages/es/faq.json";
import w from "../messages/es/home.json";
import T from "../messages/es/pricing.json";
import E from "../messages/es/products.json";
import D from "../messages/es/route.json";
import O from "../messages/es/settings.json";
import k from "../messages/es/shared.json";
import A from "../messages/es/team.json";
import j from "../messages/de/about.json";
import M from "../messages/de/blog.json";
import N from "../messages/de/careers.json";
import P from "../messages/de/contact.json";
import F from "../messages/de/faq.json";
import I from "../messages/de/home.json";
import L from "../messages/de/pricing.json";
import R from "../messages/de/products.json";
import z from "../messages/de/route.json";
import ee from "../messages/de/settings.json";
import te from "../messages/de/shared.json";
import ne from "../messages/de/team.json";
import re from "../messages/it/about.json";
import ie from "../messages/it/blog.json";
import ae from "../messages/it/careers.json";
import oe from "../messages/it/contact.json";
import se from "../messages/it/faq.json";
...
import G from "../messages/it/shared.json";
import K from "../messages/it/team.json";
import ce from "../messages/pt/about.json";
import le from "../messages/pt/blog.json";
import ue from "../messages/pt/careers.json";
import de from "../messages/pt/contact.json";
import fe from "../messages/pt/faq.json";
import pe from "../messages/pt/home.json";
import me from "../messages/pt/pricing.json";
import he from "../messages/pt/products.json";
import ge from "../messages/pt/route.json";
import _e from "../messages/pt/settings.json";
import ve from "../messages/pt/shared.json";
import ye from "../messages/pt/team.json";
import be from "../messages/zh/about.json";
import xe from "../messages/zh/blog.json";
import Se from "../messages/zh/careers.json";
import Ce from "../messages/zh/contact.json";
import we from "../messages/zh/faq.json";
import Te from "../messages/zh/home.json";
import Ee from "../messages/zh/pricing.json";
import De from "../messages/zh/products.json";
import Oe from "../messages/zh/route.json";
import ke from "../messages/zh/settings.json";
import Ae from "../messages/zh/shared.json";
import je from "../messages/zh/team.json";
import Me from "../messages/ja/about.json";
import Ne from "../messages/ja/blog.json";
import Pe from "../messages/ja/careers.json";
import Fe from "../messages/ja/contact.json";
import Ie from "../messages/ja/faq.json";
import Le from "../messages/ja/home.json";
import Re from "../messages/ja/pricing.json";
import ze from "../messages/ja/products.json";
import Be from "../messages/ja/route.json";
import Ve from "../messages/ja/settings.json";
import He from "../messages/ja/shared.json";
import Ue from "../messages/ja/team.json";
import We from "../messages/ko/about.json";
import Ge from "../messages/ko/blog.json";
import Ke from "../messages/ko/careers.json";
import qe from "../messages/ko/contact.json";
import Je from "../messages/ko/faq.json";
import Ye from "../messages/ko/home.json";
import Xe from "../messages/ko/pricing.json";
import Ze from "../messages/ko/products.json";
import Qe from "../messages/ko/route.json";
import $e from "../messages/ko/settings.json";
import et from "../messages/ko/shared.json";
import tt from "../messages/ko/team.json";
import nt from "../messages/ru/about.json";
import rt from "../messages/ru/blog.json";
import it from "../messages/ru/careers.json";
import at from "../messages/ru/contact.json";
import ot from "../messages/ru/faq.json";
import st from "../messages/ru/home.json";
import ct from "../messages/ru/pricing.json";
import lt from "../messages/ru/products.json";
import ut from "../messages/ru/route.json";
import dt from "../messages/ru/settings.json";
import ft from "../messages/ru/shared.json";
import pt from "../messages/ru/team.json";
...
var _t = q((() => {})), vt = q(((e, t) => {
	...
	f(g, { createI18nClient: () => z }), t.exports = h(g), _t();
...
var Ft = Z("de"), It = Z("en"), Lt = Z("es"), Rt = Z("fr"), zt = Z("it"), Bt = Z("ja"), Vt = Z("ko"), Q = Z("pt"), Ht = Z("ru"), Ut = Z("zh"), $ = (0, vt.createI18nClient)({
...
$.useScopedI18n;
var { I18nProviderClient: Wt, useChangeLocale: Gt, useCurrentLocale: Kt } = $;
function qt() {
	if (!(typeof window > "u")) {
