...
var At = X("de"), jt = X("en"), Mt = X("es"), Nt = X("fr"), Pt = X("it"), Ft = X("ja"), Z = X("ko"), It = X("pt"), Lt = X("ru"), Rt = X("zh"), Q = (0, s.createI18nClient)({
...
function Wt() {
	let t = zt("theme-toggle"), [i, a] = n("auto");
	e(() => {
		let e = Ut();
		a(e), $(e);
	}, []), e(() => {
	...
	function o() {
		...
		a(e), $(e), window.localStorage.setItem("theme", e);
	}
