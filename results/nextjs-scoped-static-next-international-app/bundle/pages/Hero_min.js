...
var jt = X("de"), Mt = X("en"), Nt = X("es"), Pt = X("fr"), Ft = X("it"), Z = X("ja"), It = X("ko"), Lt = X("pt"), Rt = X("ru"), zt = X("zh"), Q = (0, c.createI18nClient)({
...
function qt({ children: i, locale: a }) {
