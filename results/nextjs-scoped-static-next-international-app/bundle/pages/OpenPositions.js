...
function OpenPositions() {
	...
	const openings = [{
		title: scopedT("seniorFrontendEngineer"),
		location: scopedT("remote"),
		type: scopedT("fullTime"),
		dept: scopedT("engineering"),
		description: scopedT("buildAndMaintainOurBenchmarking")
	}, {
		title: scopedT("backendEngineer"),
		location: scopedT("remote"),
		type: scopedT("fullTime"),
		dept: scopedT("engineering"),
