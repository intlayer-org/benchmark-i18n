...
function Wt() {
	let e = Bt("preferences-section"), n = t();
	return K("section", {
		...
		children: [G("h2", {
			...
			children: [
				...
				K("div", { children: [G("label", {
					...
					children: [
						G("option", { children: e("englishEn") }),
						G("option", { children: e("frenchFr") }),
						G("option", { children: e("germanDe") }),
						G("option", { children: e("spanishEs") }),
						G("option", { children: e("japaneseJa") }),
						G("option", { children: e("chineseSimplifiedZhCn") }),
						G("option", { children: e("arabicAr") })
					]
				})] })
			]
		})]
