...
var Mt = X("de"), Nt = X("en"), Pt = X("es"), Ft = X("fr"), It = X("it"), Lt = X("ja"), Rt = X("ko"), zt = X("pt"), Bt = X("ru"), Vt = X("zh"), Z = (0, l.createI18nClient)({
...
}), Q = Z.useScopedI18n, { I18nProviderClient: Ht, useChangeLocale: Ut, useCurrentLocale: Wt } = Z, Gt = () => {
	let e = Q("mock-banner");
	return i("div", {
...
function Kt() {
	...
	return a(r, { children: [i(Gt, {}), a("div", {
...
function Jt({ children: r, locale: a }) {
