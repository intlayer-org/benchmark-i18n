...
var jt = Z("de"), Mt = Z("en"), Nt = Z("es"), Pt = Z("fr"), Ft = Z("it"), It = Z("ja"), Lt = Z("ko"), Rt = Z("pt"), zt = Z("ru"), Bt = Z("zh"), Q = (0, l.createI18nClient)({
...
}), Vt = Q.useScopedI18n, { I18nProviderClient: $, useChangeLocale: Ht, useCurrentLocale: Ut } = Q;
function Wt() {
	let e = Vt("profile-section"), n = t(), r = t();
	return a("section", {
...
function qt({ children: t, locale: a }) {
