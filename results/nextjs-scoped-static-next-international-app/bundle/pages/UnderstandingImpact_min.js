			...
			K("div", {
				...
				children: [
					...
					K("ul", {
						...
						children: [
							G("li", { children: e("theJsonMustBeParsed") }),
							G("li", { children: e("contextBasedArchitecturesCanCause") }),
							G("li", { children: e("duringServerSideRenderingThe") })
						]
					})
				]
			}),
					...
					K("ul", {
						...
						children: [
							...
							K("li", { children: [
								...
								" ",
								e("updatingTranslationsRequiresCacheBusting")
							] })
						]
					})
				]
...
function Kt({ children: r, locale: i }) {
