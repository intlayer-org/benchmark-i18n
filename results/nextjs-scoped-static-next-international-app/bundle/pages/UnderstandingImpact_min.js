...
var At = Z("de"), jt = Z("en"), Mt = Z("es"), Nt = Z("fr"), Pt = Z("it"), Q = Z("ja"), Ft = Z("ko"), It = Z("pt"), Lt = Z("ru"), Rt = Z("zh"), $ = (0, c.createI18nClient)({
			...
			i("div", {
				...
				children: [
					...
					i("ul", {
						...
						children: [
							r("li", { children: e("theJsonMustBeParsed") }),
							r("li", { children: e("contextBasedArchitecturesCanCause") }),
							r("li", { children: e("duringServerSideRenderingThe") })
						]
					})
				]
			}),
...
function Kt({ children: i, locale: a }) {
