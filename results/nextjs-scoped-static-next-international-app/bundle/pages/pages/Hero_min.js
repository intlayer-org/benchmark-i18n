...
import B from "../../../messages/pt/about.json";
import V from "../../../messages/pt/blog.json";
import H from "../../../messages/pt/careers.json";
import U from "../../../messages/pt/contact.json";
...
}), $ = Q.useScopedI18n, { I18nProviderClient: Bt, useChangeLocale: Vt, useCurrentLocale: Ht } = Q;
function Ut(e) {
...
function qt({ children: r, locale: i }) {
