...
import { Fragment as pt, jsx as W, jsxs as G } from "react/jsx-runtime";
...
}), Q = Z.useScopedI18n, { I18nProviderClient: Ht, useChangeLocale: Ut, useCurrentLocale: Wt } = Z, Gt = () => W("div", {
	className: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground",
	children: Q("mock-banner")("mockBanner")
});
function Kt() {
	let e = Q("pricing-header");
	return G(pt, { children: [W(Gt, {}), G("div", {
