...
import { Fragment as ft, jsx as G, jsxs as pt } from "react/jsx-runtime";
...
var Mt = X("de"), Nt = X("en"), Pt = X("es"), Ft = X("fr"), It = X("it"), Lt = X("ja"), Rt = X("ko"), zt = X("pt"), Bt = X("ru"), Vt = X("zh"), Z = (0, ht.createI18nClient)({
	...
	pt: () => Promise.resolve({ default: zt }),
	zh: () => Promise.resolve({ default: Vt }),
	ja: () => Promise.resolve({ default: Lt }),
	ko: () => Promise.resolve({ default: Rt }),
	ru: () => Promise.resolve({ default: Bt })
}), Q = Z.useScopedI18n, { I18nProviderClient: Ht, useChangeLocale: Ut, useCurrentLocale: Wt } = Z, Gt = () => G("div", {
	className: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground",
	children: Q("mock-banner")("mockBanner")
});
function Kt() {
	let e = Q("header"), t = Q("settings-header");
	return pt(ft, { children: [
		G(Gt, {}),
		G("h1", {
