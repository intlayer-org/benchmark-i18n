...
import s from "../messages/fr/about.json";
import c from "../messages/fr/blog.json";
import l from "../messages/fr/careers.json";
import u from "../messages/fr/contact.json";
import d from "../messages/fr/faq.json";
import f from "../messages/fr/home.json";
import p from "../messages/fr/pricing.json";
import m from "../messages/fr/products.json";
...
import h from "../messages/es/products.json";
import g from "../messages/es/route.json";
import _ from "../messages/es/settings.json";
import v from "../messages/es/shared.json";
import y from "../messages/es/team.json";
import b from "../messages/de/about.json";
import x from "../messages/de/blog.json";
import S from "../messages/de/careers.json";
import C from "../messages/de/contact.json";
import w from "../messages/de/faq.json";
import T from "../messages/de/home.json";
import E from "../messages/de/pricing.json";
import D from "../messages/de/products.json";
import O from "../messages/de/route.json";
import k from "../messages/de/settings.json";
import A from "../messages/de/shared.json";
import j from "../messages/de/team.json";
import M from "../messages/it/about.json";
import N from "../messages/it/blog.json";
import P from "../messages/it/careers.json";
import F from "../messages/it/contact.json";
import I from "../messages/it/faq.json";
import L from "../messages/it/home.json";
import R from "../messages/it/pricing.json";
import z from "../messages/it/products.json";
import B from "../messages/it/route.json";
import V from "../messages/it/settings.json";
import H from "../messages/it/shared.json";
import U from "../messages/it/team.json";
...
function _t(e, t) {
	let n = t && t.cache ? t.cache : wt, r = t && t.serializer ? t.serializer : St;
	return (t && t.strategy ? t.strategy : yt)(e, {
		cache: n,
		serializer: r
	});
}
...
function Nt({ formats: e, getMessageFallback: t, messages: n, onError: r, ...i }) {
	return {
		...
		messages: n || void 0,
		onError: r || Mt,
		getMessageFallback: t || jt
	};
}
var Y = e(void 0);
function Pt({ children: e, formats: n, getMessageFallback: r, locale: a, messages: s, now: c, onError: l, timeZone: u }) {
	let d = t(Y), f = i((() => d?.cache || Dt()), [a, d?.cache]), p = i((() => d?.formatters || kt(f)), [f, d?.formatters]), m = i((() => ({
		...Nt({
			locale: a,
...
function X({ children: e, locale: t, messages: i }) {
