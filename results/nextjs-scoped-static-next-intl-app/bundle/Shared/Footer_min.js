...
import f from "../messages/fr/about.json";
import p from "../messages/fr/blog.json";
import m from "../messages/fr/careers.json";
import h from "../messages/fr/contact.json";
import g from "../messages/fr/faq.json";
import _ from "../messages/fr/home.json";
import v from "../messages/fr/pricing.json";
import ee from "../messages/fr/products.json";
import te from "../messages/fr/route.json";
import ne from "../messages/fr/settings.json";
import re from "../messages/fr/shared.json";
import ie from "../messages/fr/team.json";
import ae from "../messages/es/about.json";
import oe from "../messages/es/blog.json";
import se from "../messages/es/careers.json";
import ce from "../messages/es/contact.json";
import le from "../messages/es/faq.json";
import ue from "../messages/es/home.json";
import de from "../messages/es/pricing.json";
import fe from "../messages/es/products.json";
import pe from "../messages/es/route.json";
import me from "../messages/es/settings.json";
import he from "../messages/es/shared.json";
import ge from "../messages/es/team.json";
import _e from "../messages/de/about.json";
import ve from "../messages/de/blog.json";
import ye from "../messages/de/careers.json";
import be from "../messages/de/contact.json";
import xe from "../messages/de/faq.json";
import Se from "../messages/de/home.json";
import Ce from "../messages/de/pricing.json";
import we from "../messages/de/products.json";
import Te from "../messages/de/route.json";
import Ee from "../messages/de/settings.json";
import De from "../messages/de/shared.json";
import Oe from "../messages/de/team.json";
import ke from "../messages/it/about.json";
import Ae from "../messages/it/blog.json";
import je from "../messages/it/careers.json";
import Me from "../messages/it/contact.json";
import Ne from "../messages/it/faq.json";
import Pe from "../messages/it/home.json";
import Fe from "../messages/it/pricing.json";
import Ie from "../messages/it/products.json";
import Le from "../messages/it/route.json";
import Re from "../messages/it/settings.json";
import ze from "../messages/it/shared.json";
import Be from "../messages/it/team.json";
import Ve from "../messages/pt/about.json";
import He from "../messages/pt/blog.json";
import Ue from "../messages/pt/careers.json";
import We from "../messages/pt/contact.json";
import Ge from "../messages/pt/faq.json";
import Ke from "../messages/pt/home.json";
import qe from "../messages/pt/pricing.json";
import Je from "../messages/pt/products.json";
import Ye from "../messages/pt/route.json";
import Xe from "../messages/pt/settings.json";
import Ze from "../messages/pt/shared.json";
import Qe from "../messages/pt/team.json";
import $e from "../messages/zh/about.json";
import et from "../messages/zh/blog.json";
import tt from "../messages/zh/careers.json";
import nt from "../messages/zh/contact.json";
import rt from "../messages/zh/faq.json";
import it from "../messages/zh/home.json";
import at from "../messages/zh/pricing.json";
import ot from "../messages/zh/products.json";
import st from "../messages/zh/route.json";
import ct from "../messages/zh/settings.json";
import lt from "../messages/zh/shared.json";
import ut from "../messages/zh/team.json";
import dt from "../messages/ja/about.json";
import ft from "../messages/ja/blog.json";
import pt from "../messages/ja/careers.json";
import mt from "../messages/ja/contact.json";
import ht from "../messages/ja/faq.json";
import gt from "../messages/ja/home.json";
import _t from "../messages/ja/pricing.json";
import vt from "../messages/ja/products.json";
import yt from "../messages/ja/route.json";
import bt from "../messages/ja/settings.json";
import xt from "../messages/ja/shared.json";
import St from "../messages/ja/team.json";
import Ct from "../messages/ko/about.json";
import wt from "../messages/ko/blog.json";
import Tt from "../messages/ko/careers.json";
import Et from "../messages/ko/contact.json";
import Dt from "../messages/ko/faq.json";
import Ot from "../messages/ko/home.json";
import kt from "../messages/ko/pricing.json";
import At from "../messages/ko/products.json";
import jt from "../messages/ko/route.json";
import Mt from "../messages/ko/settings.json";
import Nt from "../messages/ko/shared.json";
import Pt from "../messages/ko/team.json";
import Ft from "../messages/ru/about.json";
import It from "../messages/ru/blog.json";
import Lt from "../messages/ru/careers.json";
import Rt from "../messages/ru/contact.json";
import zt from "../messages/ru/faq.json";
import Bt from "../messages/ru/home.json";
import Vt from "../messages/ru/pricing.json";
import Ht from "../messages/ru/products.json";
import Ut from "../messages/ru/route.json";
import Wt from "../messages/ru/settings.json";
import Gt from "../messages/ru/shared.json";
import Kt from "../messages/ru/team.json";
var qt = (e) => /^https?:\/\//.test(e ?? "");
function Jt(e, t) {
	return !e.startsWith("/") || e === `/${t}` || e.startsWith(`/${t}/`) ? e : `/${t}${e === "/" ? "" : e}`;
}
var Yt = ({ href: e, children: t, ...n }) => {
	let r = l().locale ?? "en";
	return e == null || typeof e != "string" || qt(e) ? u(c, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
function y(e, t) {
	let n = t && t.cache ? t.cache : nn, r = t && t.serializer ? t.serializer : en;
	return (t && t.strategy ? t.strategy : Zt)(e, {
		cache: n,
		serializer: r
	});
}
...
var on = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function sn(e) {
	let t = {};
	return e.replace(on, (e) => {
		let n = e.length;
		switch (e[0]) {
			case "G":
...
function ln(e) {
	...
	let t = e.split(cn).filter((e) => e.length > 0), n = [];
	for (let e of t) {
		let t = e.split("/");
...
var O = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, dn = /^(@+)?(\+|#+)?[rs]?$/g, fn = /(\*)(0+)|(#+)(0+)|(0+)/g, pn = /^(0+)$/;
function mn(e) {
	let t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(dn, function(e, n, r) {
...
function gn(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		let n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !pn.test(e)) throw Error("Malformed concise eng/scientific notation");
...
function Tn(e, t) {
	...
	for (let r = 0; r < e.length; r++) {
		...
		if (i === "j") {
			...
			let o = 1 + (a & 1), s = a < 2 ? 1 : 3 + (a >> 1), c = En(t);
...
var Dn = RegExp(`^${L.source}*`), On = RegExp(`${L.source}*$`);
function z(e, t) {
	return {
		start: e,
		end: t
...
var kn = !!Object.fromEntries, An = !!String.prototype.trimStart, jn = !!String.prototype.trimEnd, B = kn ? Object.fromEntries : function(e) {
	let t = {};
...
var Fn = class {
	...
	tryParseLeftAngleBracket() {
		return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !In(this.peek() || 0)) ? (this.bump(), "<") : null;
	}
	tryParseQuote(e) {
	...
	parseIdentifierIfPossible() {
		let e = this.clonePosition(), t = this.offset(), n = Pn(this.message, t), r = t + n.length;
			...
			case "time": {
				...
				if (e && e.style.startsWith("::")) {
					...
					if (a === "number") {
						...
						let r = t;
						this.locale && (r = Tn(t, this.locale));
						let o = {
							type: A.dateTime,
							pattern: r,
...
function U(e) {
	e.forEach((e) => {
		if (delete e.location, xn(e) || Sn(e)) for (let t in e.options) delete e.options[t].location, U(e.options[t].value);
		else M(e) && P(e.style) || (N(e) || bn(e)) && F(e.style) ? delete e.style.location : wn(e) && U(e.children);
	});
}
function zn(e, t = {}) {
	t = {
...
function q(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (wn(c)) {
			...
			if (!Wn(u)) throw new Vn(l, "function", o);
		...
		if (xn(c)) {
			...
			if (!a) throw new Bn(c.value, l, Object.keys(c.options), o);
...
function Kn(e, t) {
	return t ? Object.keys(e).reduce((n, r) => (n[r] = Gn(e[r], t[r]), n), { ...e }) : e;
}
function J(e) {
	return { create() {
		return {
...
var Y = class e {
	...
	constructor(t, n = e.defaultLocale, r, i) {
		...
		this.formats = Kn(e.formats, r), this.formatters = i && i.formatters || qn(this.formatterCache);
	}
	format = (e) => {
...
function Xn(t) {
	...
	return function({ cache: t, formats: r, formatters: i, getMessageFallback: a = Z, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, h, g) {
			...
			try {
				return Jn(X(c, p), v, m && function(t) {
					let r = {};
...
var $ = t(void 0);
function er({ children: e, formats: t, getMessageFallback: n, locale: i, messages: a, now: s, onError: c, timeZone: l }) {
	let d = r($), f = o((() => d?.cache || rn()), [i, d?.cache]), p = o((() => d?.formatters || an(f)), [f, d?.formatters]), m = o((() => ({
		...$n({
			locale: i,
...
var nr = !1, rr = typeof window > "u";
function ir(e) {
	return function(e, t, n) {
		let { cache: r, formats: i, formatters: a, getMessageFallback: s, locale: c, onError: l, timeZone: u } = tr(), d = e[n], f = Zn(t, n);
		return u || nr || !rr || (nr = !0, l(new w(T.ENVIRONMENT_FALLBACK, void 0))), o((() => Xn({
			cache: r,
			formatters: a,
			...
			children: [d("div", {
				...
				children: [
					...
					d("div", { children: [u("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => u("li", { children: e.isInternal ? u(Yt, {
							href: e.href,
...
function dr({ children: e, locale: t, messages: n }) {
...
function Dr(e, t) {
	...
	for (let [e, r] of Object.entries(t)) {
		let t = n[e];
		typeof r == "object" && r && !Array.isArray(r) && typeof t == "object" && t && !Array.isArray(t) ? n[e] = Dr(t, r) : n[e] = r;
	}
	return n;
}
function Or(e) {
