...
import ee from "../messages/fr/faq.json";
import te from "../messages/fr/home.json";
import ne from "../messages/fr/pricing.json";
import re from "../messages/fr/products.json";
import ie from "../messages/fr/route.json";
import ae from "../messages/fr/settings.json";
import oe from "../messages/fr/shared.json";
import se from "../messages/fr/team.json";
import ce from "../messages/es/about.json";
import le from "../messages/es/blog.json";
import ue from "../messages/es/careers.json";
import de from "../messages/es/contact.json";
import fe from "../messages/es/faq.json";
import pe from "../messages/es/home.json";
import me from "../messages/es/pricing.json";
import he from "../messages/es/products.json";
import ge from "../messages/es/route.json";
import _e from "../messages/es/settings.json";
import ve from "../messages/es/shared.json";
import ye from "../messages/es/team.json";
import be from "../messages/de/about.json";
import xe from "../messages/de/blog.json";
import Se from "../messages/de/careers.json";
import Ce from "../messages/de/contact.json";
import we from "../messages/de/faq.json";
import Te from "../messages/de/home.json";
import Ee from "../messages/de/pricing.json";
import De from "../messages/de/products.json";
import Oe from "../messages/de/route.json";
import ke from "../messages/de/settings.json";
import Ae from "../messages/de/shared.json";
import je from "../messages/de/team.json";
import Me from "../messages/it/about.json";
import Ne from "../messages/it/blog.json";
import Pe from "../messages/it/careers.json";
import Fe from "../messages/it/contact.json";
import Ie from "../messages/it/faq.json";
import Le from "../messages/it/home.json";
import Re from "../messages/it/pricing.json";
import ze from "../messages/it/products.json";
import Be from "../messages/it/route.json";
import Ve from "../messages/it/settings.json";
import He from "../messages/it/shared.json";
import Ue from "../messages/it/team.json";
import We from "../messages/pt/about.json";
import Ge from "../messages/pt/blog.json";
import Ke from "../messages/pt/careers.json";
import qe from "../messages/pt/contact.json";
import Je from "../messages/pt/faq.json";
import Ye from "../messages/pt/home.json";
import Xe from "../messages/pt/pricing.json";
import Ze from "../messages/pt/products.json";
import Qe from "../messages/pt/route.json";
import $e from "../messages/pt/settings.json";
import et from "../messages/pt/shared.json";
import tt from "../messages/pt/team.json";
import nt from "../messages/zh/about.json";
import rt from "../messages/zh/blog.json";
import it from "../messages/zh/careers.json";
import at from "../messages/zh/contact.json";
import ot from "../messages/zh/faq.json";
import st from "../messages/zh/home.json";
import ct from "../messages/zh/pricing.json";
import lt from "../messages/zh/products.json";
import ut from "../messages/zh/route.json";
import dt from "../messages/zh/settings.json";
import ft from "../messages/zh/shared.json";
import pt from "../messages/zh/team.json";
import mt from "../messages/ja/about.json";
import ht from "../messages/ja/blog.json";
import gt from "../messages/ja/careers.json";
import _t from "../messages/ja/contact.json";
import vt from "../messages/ja/faq.json";
import yt from "../messages/ja/home.json";
import bt from "../messages/ja/pricing.json";
import xt from "../messages/ja/products.json";
import St from "../messages/ja/route.json";
import Ct from "../messages/ja/settings.json";
import wt from "../messages/ja/shared.json";
import Tt from "../messages/ja/team.json";
import Et from "../messages/ko/about.json";
import Dt from "../messages/ko/blog.json";
import Ot from "../messages/ko/careers.json";
import kt from "../messages/ko/contact.json";
import At from "../messages/ko/faq.json";
import jt from "../messages/ko/home.json";
import Mt from "../messages/ko/pricing.json";
import Nt from "../messages/ko/products.json";
import Pt from "../messages/ko/route.json";
import Ft from "../messages/ko/settings.json";
import It from "../messages/ko/shared.json";
import Lt from "../messages/ko/team.json";
import Rt from "../messages/ru/about.json";
import zt from "../messages/ru/blog.json";
import Bt from "../messages/ru/careers.json";
import Vt from "../messages/ru/contact.json";
import Ht from "../messages/ru/faq.json";
import Ut from "../messages/ru/home.json";
import Wt from "../messages/ru/pricing.json";
import Gt from "../messages/ru/products.json";
import Kt from "../messages/ru/route.json";
import qt from "../messages/ru/settings.json";
import Jt from "../messages/ru/shared.json";
import Yt from "../messages/ru/team.json";
var Xt = (e) => /^https?:\/\//.test(e ?? "");
function y(e, t) {
	return !e.startsWith("/") || e === `/${t}` || e.startsWith(`/${t}/`) ? e : `/${t}${e === "/" ? "" : e}`;
}
var b = ({ href: e, children: t, ...n }) => {
	let r = l().locale ?? "en";
	return e == null || typeof e != "string" || Xt(e) ? f(c, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
function x(e, t) {
	let n = t && t.cache ? t.cache : rn, r = t && t.serializer ? t.serializer : tn;
...
var sn = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function cn(e) {
	let t = {};
	return e.replace(sn, (e) => {
		let n = e.length;
		switch (e[0]) {
			case "G":
...
function un(e) {
	...
	let t = e.split(ln).filter((e) => e.length > 0), n = [];
	for (let e of t) {
		let t = e.split("/");
...
var A = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, j = /^(@+)?(\+|#+)?[rs]?$/g, fn = /(\*)(0+)|(#+)(0+)|(0+)/g, M = /^(0+)$/;
function N(e) {
	let t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(j, function(e, n, r) {
	...
	for (let n of e) {
		switch (n.stem) {
			...
			case "integer-width":
				...
				n.options[0].replace(fn, function(e, n, r, i, a, o) {
		...
		if (A.test(n.stem)) {
			...
			n.stem.replace(A, function(e, n, r, i, a, o) {
...
function Dn(e, t) {
	...
	for (let r = 0; r < e.length; r++) {
		...
		if (i === "j") {
			...
			let o = 1 + (a & 1), s = a < 2 ? 1 : 3 + (a >> 1), c = On(t);
...
var kn = RegExp(`^${En.source}*`), An = RegExp(`${En.source}*$`);
function B(e, t) {
	return {
		start: e,
		end: t
...
var jn = !!Object.fromEntries, Mn = !!String.prototype.trimStart, Nn = !!String.prototype.trimEnd, Pn = jn ? Object.fromEntries : function(e) {
	let t = {};
	...
	return e.replace(An, "");
}, Ln = /* @__PURE__ */ RegExp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
function Rn(e, t) {
	return Ln.lastIndex = t, Ln.exec(e)[1] ?? "";
}
var zn = class {
	message;
	position;
	...
	parseTagName() {
		let e = this.offset();
		for (this.bump(); !this.isEOF() && Vn(this.char());) this.bump();
	...
	tryParseLeftAngleBracket() {
		return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !Bn(this.peek() || 0)) ? (this.bump(), "<") : null;
	}
	tryParseQuote(e) {
	...
	parseIdentifierIfPossible() {
		let e = this.clonePosition(), t = this.offset(), n = Rn(this.message, t), r = t + n.length;
			...
			case "time": {
				...
				if (e && e.style.startsWith("::")) {
					...
					if (a === "number") {
						...
						let r = t;
						this.locale && (r = Dn(t, this.locale));
						let o = {
							type: I.dateTime,
							pattern: r,
...
function H(e) {
	e.forEach((e) => {
		if (delete e.location, xn(e) || Sn(e)) for (let t in e.options) delete e.options[t].location, H(e.options[t].value);
		else vn(e) && Tn(e.style) || (yn(e) || bn(e)) && L(e.style) ? delete e.style.location : wn(e) && H(e.children);
	});
}
function Un(e, t = {}) {
	t = {
...
function K(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (vn(c)) {
			let e = typeof c.style == "string" ? r.number[c.style] : Tn(c.style) ? c.style.parsedOptions : void 0;
			if (e && e.scale) {
				let t = e.scale || 1;
				if (typeof l == "bigint") {
		...
		if (wn(c)) {
			...
			if (!Jn(u)) throw new Gn(l, "function", o);
		...
		if (xn(c)) {
			...
			if (!a) throw new Wn(c.value, l, Object.keys(c.options), o);
...
function Xn(e, t) {
	return t ? Object.keys(e).reduce((n, r) => (n[r] = Yn(e[r], t[r]), n), { ...e }) : e;
}
function q(e) {
	return { create() {
		return {
...
function Zn(e = {
	...
	return {
		getNumberFormat: x((...e) => new Intl.NumberFormat(...e), {
			cache: q(e.number),
			strategy: T.variadic
		}),
		getDateTimeFormat: x((...e) => new Intl.DateTimeFormat(...e), {
			cache: q(e.dateTime),
			strategy: T.variadic
		}),
		getPluralRules: x((...e) => new Intl.PluralRules(...e), {
...
var J = class e {
	...
	constructor(t, n = e.defaultLocale, r, i) {
		...
		this.formats = Xn(e.formats, r), this.formatters = i && i.formatters || Zn(this.formatterCache);
	}
	format = (e) => {
...
function Qn(...[e, t, r, i]) {
	if (Array.isArray(t)) throw new E(D.INVALID_MESSAGE, void 0);
	if (typeof t == "object") throw new E(D.INSUFFICIENT_PATH, void 0);
	if (typeof t == "string") {
		let e = function(e, t) {
	...
	try {
		...
		throw new E(D.INVALID_MESSAGE, void 0);
	}
	let f = d.format(r);
...
function tr(t) {
	let r = function(e, t, n) {
		try {
			...
			return new E(D.MISSING_MESSAGE, e.message);
		}
	}(t.locale, t.messages, t.namespace);
	return function({ cache: t, formats: r, formatters: i, getMessageFallback: a = $n, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		let d = s instanceof E;
		function f(e, t, n, r) {
			let i = new E(t, n);
			return l(i), r ?? a({
				error: i,
		...
		function p(p, m, h, g) {
			...
			if (d) {
				...
				try {
					...
					if (!_) return f(p, D.MISSING_MESSAGE, e.message, _);
					v = _;
				}
			}
			try {
				return Qn(Y(c, p), v, m && function(t) {
					let r = {};
				...
				let t, n;
				return e instanceof E ? (t = e.code, n = e.originalMessage) : (t = D.FORMATTING_ERROR, n = e.message), f(p, t, n, _);
			}
		}
		function m(e, t, n, r) {
			let i = p(e, t, n, r);
			return typeof i == "string" ? i : f(e, D.INVALID_MESSAGE, void 0);
		}
		return m.rich = p, m.markup = (e, t, n, r) => p(e, t, n, r), m.raw = (e) => {
			...
			try {
				...
				return f(e, D.MISSING_MESSAGE, t.message);
			}
		}, m.has = (e) => {
			if (d) return !1;
			try {
...
var rr = 86400;
7 * rr, 365 * rr;
function ir({ formats: e, getMessageFallback: t, messages: n, onError: r, ...i }) {
	return {
		...i,
		formats: e || void 0,
		messages: n || void 0,
...
var Z = t(void 0);
function ar({ children: e, formats: t, getMessageFallback: n, locale: i, messages: a, now: s, onError: c, timeZone: l }) {
	let u = r(Z), d = o((() => u?.cache || an()), [i, u?.cache]), p = o((() => u?.formatters || on(d)), [d, u?.formatters]), m = o((() => ({
		...ir({
			locale: i,
...
var sr = !1, cr = typeof window > "u";
function lr(e) {
	return function(e, t, n) {
		let { cache: r, formats: i, formatters: a, getMessageFallback: s, locale: c, onError: l, timeZone: u } = or(), d = e[n], f = nr(t, n);
		return u || sr || !cr || (sr = !0, l(new E(D.ENVIRONMENT_FALLBACK, void 0))), o((() => tr({
			cache: r,
			formatters: a,
...
function Sr({ children: e, locale: t, messages: n }) {
