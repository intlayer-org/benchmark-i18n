...
var h = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/Link.tsx", g = (e) => /^https?:\/\//.test(e ?? "");
function _(e, t) {
...
function y(e, t) {
	let n = t && t.cache ? t.cache : se, r = t && t.serializer ? t.serializer : ae;
...
function ne(e, t) {
	let n = e.length === 1 ? b : te;
	return x(e, this, n, t.cache.create(), t.serializer);
}
function re(e, t) {
	return x(e, this, te, t.cache.create(), t.serializer);
}
function ie(e, t) {
	return x(e, this, b, t.cache.create(), t.serializer);
}
var ae = function() {
...
var de = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function fe(e) {
	let t = {};
	return e.replace(de, (e) => {
		let n = e.length;
		switch (e[0]) {
			case "G":
...
function me(e) {
	...
	let t = e.split(pe).filter((e) => e.length > 0), n = [];
	for (let e of t) {
		let t = e.split("/");
...
function we(e) {
	...
	for (let n of e) {
		switch (n.stem) {
			...
			case "measure-unit":
			case "unit":
				t.style = "unit", t.unit = he(n.options[0]);
				continue;
			case "compact-short":
			case "K":
			...
			case "integer-width":
				...
				n.options[0].replace(ve, function(e, n, r, i, a, o) {
		...
		if (ge.test(n.stem)) {
			...
			n.stem.replace(ge, function(e, n, r, i, a, o) {
...
var Ue = class {
	...
	parseMessage(e, t, n) {
		...
		for (; !this.isEOF();) {
			...
			if (i === 123) {
				...
				if (n) break;
				return this.error(D.UNMATCHED_CLOSING_TAG, F(this.clonePosition(), this.clonePosition()));
	...
	parseTag(e, t) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !R(this.char())) return this.error(D.INVALID_TAG, F(o, this.clonePosition()));
				let e = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					...
					err: null
				} : this.error(D.INVALID_TAG, F(o, this.clonePosition()))) : this.error(D.UNMATCHED_CLOSING_TAG, F(e, this.clonePosition()));
			}
			return this.error(D.UNCLOSED_TAG, F(n, this.clonePosition()));
		}
	...
	tryParseLeftAngleBracket() {
		return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !We(this.peek() || 0)) ? (this.bump(), "<") : null;
	}
	tryParseQuote(e) {
	...
	parseArgument(e, t) {
		let n = this.clonePosition();
		if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(D.EXPECT_ARGUMENT_CLOSING_BRACE, F(n, this.clonePosition()));
		if (this.char() === 125) return this.bump(), this.error(D.EMPTY_ARGUMENT, F(n, this.clonePosition()));
		let r = this.parseIdentifierIfPossible().value;
		if (!r) return this.error(D.MALFORMED_ARGUMENT, F(n, this.clonePosition()));
		if (this.bumpSpace(), this.isEOF()) return this.error(D.EXPECT_ARGUMENT_CLOSING_BRACE, F(n, this.clonePosition()));
		switch (this.char()) {
			...
			case 44: return this.bump(), this.bumpSpace(), this.isEOF() ? this.error(D.EXPECT_ARGUMENT_CLOSING_BRACE, F(n, this.clonePosition())) : this.parseArgumentOptions(e, t, r, n);
			default: return this.error(D.MALFORMED_ARGUMENT, F(n, this.clonePosition()));
		}
	}
	parseIdentifierIfPossible() {
		let e = this.clonePosition(), t = this.offset(), n = He(this.message, t), r = t + n.length;
	...
	parseArgumentOptions(e, t, n, r) {
		...
		switch (a) {
			case "": return this.error(D.EXPECT_ARGUMENT_TYPE, F(i, o));
			case "number":
			case "date":
			case "time": {
				this.bumpSpace();
				...
				if (this.bumpIf(",")) {
					...
					if (n.err) return n;
					let r = Ve(n.val);
					if (r.length === 0) return this.error(D.EXPECT_ARGUMENT_STYLE, F(this.clonePosition(), this.clonePosition()));
					e = {
						style: r,
				...
				if (e && e.style.startsWith("::")) {
					...
					}
					{
						...
						let o = {
							...
							parsedOptions: this.shouldParseSkeletons ? fe(r) : {}
						};
						return {
							val: {
			...
			case "select": {
				...
				if (this.bumpSpace(), !this.bumpIf(",")) return this.error(D.EXPECT_SELECT_ARGUMENT_OPTIONS, F(i, { ...i }));
				this.bumpSpace();
				let o = this.parseIdentifierIfPossible(), s = 0;
				if (a !== "select" && o.value === "offset") {
					if (!this.bumpIf(":")) return this.error(D.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, F(this.clonePosition(), this.clonePosition()));
					this.bumpSpace();
			...
			default: return this.error(D.INVALID_ARGUMENT_TYPE, F(i, o));
		}
	}
	tryParseArgumentClose(e) {
		return this.isEOF() || this.char() !== 125 ? this.error(D.EXPECT_ARGUMENT_CLOSING_BRACE, F(e, this.clonePosition())) : (this.bump(), {
			val: !0,
			err: null
		});
	}
	parseSimpleArgStyleIfPossible() {
		...
		for (; !this.isEOF();) switch (this.char()) {
			case 39: {
				this.bump();
				let e = this.clonePosition();
				if (!this.bumpUntil("'")) return this.error(D.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, F(e, this.clonePosition()));
				this.bump();
				break;
			}
			case 123:
	...
	tryParsePluralOrSelectOptions(e, t, n, r) {
		...
		for (;;) {
			...
			if (!this.bumpIf("{")) return this.error(t === "select" ? D.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT : D.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT, F(this.clonePosition(), this.clonePosition()));
		...
		return a.length === 0 ? this.error(t === "select" ? D.EXPECT_SELECT_ARGUMENT_SELECTOR : D.EXPECT_PLURAL_ARGUMENT_SELECTOR, F(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !i ? this.error(D.MISSING_OTHER_CLAUSE, F(this.clonePosition(), this.clonePosition())) : {
			val: a,
			err: null
		};
	}
...
function z(e) {
	e.forEach((e) => {
		if (delete e.location, M(e) || Oe(e)) for (let t in e.options) delete e.options[t].location, z(e.options[t].value);
		else De(e) && je(e.style) || (A(e) || j(e)) && N(e.style) ? delete e.style.location : Ae(e) && z(e.children);
	});
}
function qe(e, t = {}) {
	t = {
...
function U(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (Ae(c)) {
			...
			if (!Qe(u)) throw new Ye(l, "function", o);
		...
		if (M(c)) {
			...
			if (!a) throw new Je(c.value, l, Object.keys(c.options), o);
...
var G = class e {
	constructor(t, n = e.defaultLocale, r, i) {
		...
		this.formats = et(e.formats, r), this.formatters = i && i.formatters || tt(this.formatterCache);
	}
	static {
...
function K(...[e, t, r, i]) {
	if (Array.isArray(t)) throw new C(w.INVALID_MESSAGE, `Message at \`${e}\` resolved to an array, but only strings are supported. See https://next-intl.dev/docs/usage/translations#arrays-of-messages`);
	if (typeof t == "object") throw new C(w.INSUFFICIENT_PATH, `Message at \`${e}\` resolved to \`${typeof t}\`, but only strings are supported. Use a \`.\` to retrieve nested messages. See https://next-intl.dev/docs/usage/translations#structuring-messages`);
	if (typeof t == "string") {
		let e = it(t, r);
		if (e) return e;
	}
	let { cache: a, formats: o, formatters: s, globalFormats: c, locale: l, timeZone: u } = i;
	s.getMessageFormat ||= rt(a, s);
	let d;
	try {
		d = s.getMessageFormat(t, l, nt(c, o, u), { formatters: {
			...s,
		...
		throw new C(w.INVALID_MESSAGE, `${e.message} (${e.originalMessage})`);
	}
	let f = d.format(r);
...
function ct(e, t, n) {
	try {
		...
		return new C(w.MISSING_MESSAGE, e.message);
	}
}
function lt(e) {
	let t = ct(e.locale, e.messages, e.namespace);
	return ut({
		...e,
		messagesOrError: t
	});
}
function ut({ cache: e, formats: t, formatters: n, getMessageFallback: r = at, locale: i, messagesOrError: a, namespace: o, onError: s, timeZone: c }) {
	let l = a instanceof C;
	function u(e, t, n, i) {
		let a = new C(t, n);
		return s(a), i ?? r({
			error: a,
	...
	function d(d, f, p, m) {
		...
		if (l) {
			...
			try {
				...
				if (h) g = h;
				else return u(d, w.MISSING_MESSAGE, e.message, h);
			}
		}
		try {
			return K(q(o, d), g, f && st(f), {
				cache: e,
				formatters: n,
				globalFormats: t,
				formats: p,
			...
			let t, n;
			return e instanceof C ? (t = e.code, n = e.originalMessage) : (t = w.FORMATTING_ERROR, n = e.message), u(d, t, n, h);
		}
	}
	function f(e, t, n, r) {
		let i = d(e, t, n, r);
		return typeof i == "string" ? i : u(e, w.INVALID_MESSAGE, `The message \`${e}\` in ${o ? `namespace \`${o}\`` : "messages"} didn't resolve to a string. If you want to format rich text, use \`t.rich\` instead.`);
	}
	return f.rich = d, f.markup = (e, t, n, i) => {
		let a = d(e, t, n, i);
		if (typeof a != "string") {
			let t = new C(w.FORMATTING_ERROR, "`t.markup` only accepts functions for formatting that receive and return strings.\n\nE.g. t.markup('markup', {b: (chunks) => `<b>${chunks}</b>`})");
			return s(t), r({
				error: t,
				key: e,
				namespace: o
		...
		try {
			...
			return u(e, w.MISSING_MESSAGE, t.message);
		}
	}, f.has = (e) => {
		if (l) return !1;
		try {
...
function ft(e, t, n) {
	Object.entries(e).forEach(([e, r]) => {
		...
		typeof r == "object" && r && ft(r, t, q(n, e));
	});
}
function pt(e, t) {
	let n = [];
	ft(e, n), n.length > 0 && t(new C(w.INVALID_KEY, `Namespace keys cannot contain the character "." as this is used to express nesting. Please remove it or replace it with another character.
...
var X = t(void 0);
function ht({ children: e, formats: t, getMessageFallback: n, locale: i, messages: a, now: s, onError: c, timeZone: l }) {
	let u = r(X), d = o(() => u?.cache || ce(), [i, u?.cache]), f = o(() => u?.formatters || ue(d), [d, u?.formatters]), p = o(() => ({
		...mt({
			locale: i,
...
var _t = !1, vt = typeof window > "u";
function yt(e, t, n) {
	let { cache: r, formats: i, formatters: a, getMessageFallback: s, locale: c, onError: l, timeZone: u } = gt(), d = e[n], f = dt(t, n);
	return !u && !_t && vt && (_t = !0, l(new C(w.ENVIRONMENT_FALLBACK, "There is no `timeZone` configured, this can lead to markup mismatches caused by environment differences. Consider adding a global default: https://next-intl.dev/docs/configuration#time-zone"))), o(() => lt({
		cache: r,
		formatters: a,
...
var St = xt("useTranslations", bt);
function Ct({ locale: e, ...t }) {
...
var wt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/ThemeToggle.tsx";
function Tt() {
...
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/LocaleSwitcher.tsx";
function kt() {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/Header.tsx";
function jt() {
	let e = St();
	At("Header");
...
var Pt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/AppProviders.tsx";
function Ft({ children: e, locale: t, messages: n }) {
...
function Qr(e, t) {
	...
	for (let [e, r] of Object.entries(t)) {
		let t = n[e];
		n[e] = typeof r == "object" && r && !Array.isArray(r) && typeof t == "object" && t && !Array.isArray(t) ? Qr(t, r) : r;
	}
	return n;
}
function $r(e) {
	return e.reduce((e, t) => Qr(e, t), {});
}
function ei(e, t) {
...
var ni = ti("en"), ri = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/scripts/Wrapper.tsx", ii = "en";
...
var oi = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/Header.wrapper.tsx";
function si() {
	return f(ai, { children: f(jt, {}, void 0, !1, {
		fileName: oi,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
