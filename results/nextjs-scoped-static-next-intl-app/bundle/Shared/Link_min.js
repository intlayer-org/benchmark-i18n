...
var vt = (e) => /^https?:\/\//.test(e ?? "");
function yt(e, t) {
	return !e.startsWith("/") || e === `/${t}` || e.startsWith(`/${t}/`) ? e : `/${t}${e === "/" ? "" : e}`;
}
var bt = ({ href: e, children: t, ...n }) => {
	let r = s().locale ?? "en";
	return e == null || typeof e != "string" || vt(e) ? c(o, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
var X = e(void 0);
function Rt({ children: e, formats: n, getMessageFallback: r, locale: a, messages: o, now: s, onError: l, timeZone: u }) {
	let d = t(X), f = i((() => d?.cache || jt()), [a, d?.cache]), p = i((() => d?.formatters || Nt(f)), [f, d?.formatters]), m = i((() => ({
		...Lt({
			locale: a,
...
function Ht({ children: e, locale: t, messages: i }) {
