...
var k = 86400;
7 * k, 365 * k;
function A({ formats: e, getMessageFallback: t, messages: n, onError: r, ...i }) {
	return {
		...i,
		formats: e || void 0,
		messages: n || void 0,
		onError: r || O,
		getMessageFallback: t || D
	};
}
var j = e(void 0);
function M({ children: e, formats: n, getMessageFallback: r, locale: a, messages: o, now: s, onError: c, timeZone: u }) {
	let d = t(j), f = i((() => d?.cache || S()), [a, d?.cache]), p = i((() => d?.formatters || T(f)), [f, d?.formatters]), m = i((() => ({
		...A({
			locale: a,
...
function I({ children: e, locale: t, messages: i }) {
