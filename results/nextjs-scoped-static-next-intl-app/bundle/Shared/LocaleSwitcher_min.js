...
var p = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/LocaleSwitcher.tsx";
function m() {
...
function h(e, t) {
	let n = t && t.cache ? t.cache : ne, r = t && t.serializer ? t.serializer : S;
...
function N(e, t, n) {
	Object.entries(e).forEach(([e, r]) => {
		...
		typeof r == "object" && r && N(r, t, k(n, e));
	});
}
function P(e, t) {
	let n = [];
	N(e, n), n.length > 0 && t(new ie(C.INVALID_KEY, `Namespace keys cannot contain the character "." as this is used to express nesting. Please remove it or replace it with another character.
...
function F({ formats: e, getMessageFallback: t, messages: n, onError: r, ...i }) {
	let a = r || j, o = t || A;
	return n && P(n, a), {
		...i,
		formats: e || void 0,
...
var I = e(void 0);
function L({ children: e, formats: n, getMessageFallback: r, locale: a, messages: o, now: s, onError: c, timeZone: l }) {
	let d = t(I), f = i(() => d?.cache || w(), [a, d?.cache]), p = i(() => d?.formatters || O(f), [f, d?.formatters]), m = i(() => ({
		...F({
			locale: a,
...
var V = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/AppProviders.tsx";
function H({ children: e, locale: t, messages: i }) {
...
var hn = mn("en"), gn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/scripts/Wrapper.tsx", _n = "en";
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/LocaleSwitcher.wrapper.tsx";
function yn() {
	return l(vn, { children: l(m, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
