...
function Gn(t) {
	...
	return function({ cache: t, formats: r, formatters: i, getMessageFallback: a = Un, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, h, g) {
			...
			try {
				return Hn(X(c, p), v, m && function(t) {
					let r = {};
...
var Q = t(void 0);
function Yn({ children: e, formats: t, getMessageFallback: n, locale: i, messages: a, now: s, onError: l, timeZone: u }) {
	let d = r(Q), f = o((() => d?.cache || Zt()), [i, d?.cache]), p = o((() => d?.formatters || Qt(f)), [f, d?.formatters]), m = o((() => ({
		...Jn({
			locale: i,
...
var rr = () => c("div", {
	...
	children: tr()("mock-banner.mockBanner")
});
function ir() {
	if (!(typeof window > "u")) {
...
function or({ children: e, locale: t, messages: n }) {
