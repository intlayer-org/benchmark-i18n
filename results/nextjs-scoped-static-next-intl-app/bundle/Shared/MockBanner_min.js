...
function B(e) {
	e.forEach((e) => {
		if (delete e.location, N(e) || ve(e)) for (let t in e.options) delete e.options[t].location, B(e.options[t].value);
		else A(e) && xe(e.style) || (j(e) || M(e)) && P(e.style) ? delete e.style.location : be(e) && B(e.children);
	});
}
function Le(e, t = {}) {
	t = {
...
var Q = t(void 0);
function it({ children: e, formats: t, getMessageFallback: n, locale: i, messages: a, now: s, onError: l, timeZone: u }) {
	let d = r(Q), f = o(() => d?.cache || ie(), [i, d?.cache]), p = o(() => d?.formatters || oe(f), [f, d?.formatters]), m = o(() => ({
		...rt({
			locale: i,
...
var pt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/MockBanner.tsx", mt = () => {
	let e = dt();
	return l("div", {
...
var Hr = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/MockBanner.wrapper.tsx";
function Ur() {
	return l(Vr, { children: l(mt, {}, void 0, !1, {
		fileName: Hr,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
