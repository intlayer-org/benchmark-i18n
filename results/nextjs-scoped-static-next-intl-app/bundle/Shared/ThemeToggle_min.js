...
function H(e) {
	e.forEach((e) => {
		...
		else j(e) && ve(e.style) || (he(e) || M(e)) && F(e.style) ? delete e.style.location : _e(e) && H(e.children);
	});
}
function Ne(e, t = {}) {
	t = {
...
function We(t) {
	...
	return function({ cache: t, formats: r, formatters: i, getMessageFallback: a = He, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, ee, te) {
			...
			try {
				return Ve(X(c, p), g, m && function(t) {
					let r = {};
...
function Je({ children: e, formats: t, getMessageFallback: n, locale: i, messages: a, now: s, onError: l, timeZone: u }) {
	let d = r(Q), f = o((() => d?.cache || re()), [i, d?.cache]), p = o((() => d?.formatters || ae(f)), [f, d?.formatters]), m = o((() => ({
		...qe({
			locale: i,
