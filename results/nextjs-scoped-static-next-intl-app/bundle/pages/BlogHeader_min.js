...
var de = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, C = /^(@+)?(\+|#+)?[rs]?$/g, fe = /(\*)(0+)|(#+)(0+)|(0+)/g, w = /^(0+)$/;
function T(e) {
	let t = {};
...
function H(e) {
	e.forEach((e) => {
		...
		else j(e) && ye(e.style) || (M(e) || _e(e)) && I(e.style) ? delete e.style.location : F(e) && H(e.children);
	});
}
function Fe(e, t = {}) {
	t = {
...
function Ke(t) {
	...
	return function({ cache: t, formats: r, formatters: i, getMessageFallback: a = We, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, h, ee) {
			...
			try {
				return Ue(X(c, p), _, m && function(t) {
					let r = {};
...
var Q = t(void 0);
function Xe({ children: e, formats: t, getMessageFallback: n, locale: i, messages: a, now: s, onError: c, timeZone: u }) {
	let d = r(Q), f = o((() => d?.cache || ie()), [i, d?.cache]), p = o((() => d?.formatters || ae(f)), [f, d?.formatters]), m = o((() => ({
		...Ye({
			locale: i,
...
function et(e) {
	return function(e, t, n) {
		...
		return u || Qe || !$e || (Qe = !0, l(new y(b.ENVIRONMENT_FALLBACK, void 0))), o((() => Ke({
			cache: r,
			formatters: a,
...
function wr(e, t) {
	...
	for (let [e, r] of Object.entries(t)) {
		let t = n[e];
		n[e] = typeof r == "object" && r && !Array.isArray(r) && typeof t == "object" && t && !Array.isArray(t) ? wr(t, r) : r;
	}
	return n;
}
function Tr(e) {
