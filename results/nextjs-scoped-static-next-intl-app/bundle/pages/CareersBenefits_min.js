...
function z(e) {
	e.forEach((e) => {
		if (delete e.location, A(e) || j(e)) for (let t in e.options) delete e.options[t].location, z(e.options[t].value);
		else D(e) && N(e.style) || (O(e) || k(e)) && P(e.style) ? delete e.style.location : M(e) && z(e.children);
	});
}
function Re(e, t = {}) {
	t = {
...
function ct(e, t, n) {
	let { cache: r, formats: i, formatters: a, getMessageFallback: s, locale: c, onError: l, timeZone: u } = Q(), d = e[n], f = tt(t, n);
	return !u && !ot && st && (ot = !0, l(new v(y.ENVIRONMENT_FALLBACK, "There is no `timeZone` configured, this can lead to markup mismatches caused by environment differences. Consider adding a global default: https://next-intl.dev/docs/configuration#time-zone"))), o(() => $e({
		cache: r,
		formatters: a,
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/pages/careers/CareersBenefits.tsx";
function pt() {
	let e = dt(), t = [
		{
			label: e("careers-benefits.workFromAnywhereInThe"),
			value: e("open-positions.remote")
		},
		{
			label: e("careers-benefits.competitivePay"),
			value: e("careers-benefits.topOfMarketCompensation")
		},
		{
			label: e("careers-benefits.openSourceTime"),
			value: e("careers-benefits.twentyPercentTime")
		}
	];
	return l("div", {
...
var Hr = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/pages/careers/CareersBenefits.wrapper.tsx";
function Ur() {
