...
var Pe = class {
	...
	parseTag(e, t) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !z(this.char())) return this.error(T.INVALID_TAG, L(o, this.clonePosition()));
				let e = this.clonePosition();
...
function B(e) {
	e.forEach((e) => {
		if (delete e.location, xe(e) || j(e)) for (let t in e.options) delete e.options[t].location, B(e.options[t].value);
		else k(e) && N(e.style) || (A(e) || be(e)) && P(e.style) ? delete e.style.location : M(e) && B(e.children);
	});
}
function Re(e, t = {}) {
	t = {
...
function at({ children: e, formats: t, getMessageFallback: n, locale: i, messages: a, now: s, onError: l, timeZone: u }) {
	let d = r(Q), f = o(() => d?.cache || ae(), [i, d?.cache]), p = o(() => d?.formatters || se(f), [f, d?.formatters]), m = o(() => ({
		...it({
			locale: i,
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/pages/careers/CareersHeader.tsx";
function gt() {
	let e = ft();
	return u(l, { children: [
		u(ht, {}, void 0, !1, {
...
var Gr = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/pages/careers/CareersHeader.wrapper.tsx";
function Kr() {
