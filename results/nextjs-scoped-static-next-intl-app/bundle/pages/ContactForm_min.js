	...
	return u("form", {
		...
		children: [
			...
			u("div", { children: [l("label", {
				...
				children: [
					l("option", { children: e("contact-form.bugReport") }),
					l("option", { children: e("contact-form.newBenchmarkIdea") }),
					l("option", { children: e("contact-form.methodologyQuestion") }),
					l("option", { children: e("contact-form.contribution") }),
					l("option", { children: e("contact-form.other") })
				]
			})] }),
			u("div", { children: [l("label", {
				htmlFor: i,
