		...
		children: [jsx("h2", {
			...
			children: [
				...
				jsxs("div", { children: [jsx("label", {
					...
					children: [
						jsx("option", { children: t("preferences-section.englishEn") }),
						jsx("option", { children: t("preferences-section.frenchFr") }),
						jsx("option", { children: t("preferences-section.germanDe") }),
						jsx("option", { children: t("preferences-section.spanishEs") }),
						jsx("option", { children: t("preferences-section.japaneseJa") }),
						jsx("option", { children: t("preferences-section.chineseSimplifiedZhCn") }),
						jsx("option", { children: t("preferences-section.arabicAr") })
					]
				})] })
			]
		})]
