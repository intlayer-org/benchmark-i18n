...
var $ = t(void 0);
function Xn({ children: e, formats: t, getMessageFallback: n, locale: i, messages: a, now: o, onError: c, timeZone: u }) {
	let d = r($), f = s((() => d?.cache || $t()), [i, d?.cache]), p = s((() => d?.formatters || en(f)), [f, d?.formatters]), m = s((() => ({
		...Yn({
			locale: i,
...
function Cr(e, t) {
	...
	for (let [e, r] of Object.entries(t)) {
		let t = n[e];
		typeof r == "object" && r && !Array.isArray(r) && typeof t == "object" && t && !Array.isArray(t) ? n[e] = Cr(t, r) : n[e] = r;
	}
	return n;
}
function wr(e) {
