...
var Ae = class {
	...
	parseTag(e, t) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !H(this.char())) return this.error(O.INVALID_TAG, z(o, this.clonePosition()));
				let e = this.clonePosition();
...
function U(e) {
	e.forEach((e) => {
		if (delete e.location, N(e) || P(e)) for (let t in e.options) delete e.options[t].location, U(e.options[t].value);
		else j(e) && ye(e.style) || (M(e) || _e(e)) && I(e.style) ? delete e.style.location : F(e) && U(e.children);
	});
}
function Pe(e, t = {}) {
	t = {
...
function Ye({ children: e, formats: t, getMessageFallback: n, locale: i, messages: a, now: o, onError: c, timeZone: u }) {
	let d = r($), f = s((() => d?.cache || ie()), [i, d?.cache]), p = s((() => d?.formatters || ae(f)), [f, d?.formatters]), m = s((() => ({
		...Je({
			locale: i,
		...
		children: [l("h2", {
			...
			children: [
				...
				u("div", { children: [l("label", {
					...
					children: [
						l("option", { children: e("preferences-section.englishEn") }),
						l("option", { children: e("preferences-section.frenchFr") }),
						l("option", { children: e("preferences-section.germanDe") }),
						l("option", { children: e("preferences-section.spanishEs") }),
						l("option", { children: e("preferences-section.japaneseJa") }),
						l("option", { children: e("preferences-section.chineseSimplifiedZhCn") }),
						l("option", { children: e("preferences-section.arabicAr") })
					]
				})] })
			]
		})]
...
function Cr(e, t) {
	...
	for (let [e, r] of Object.entries(t)) {
		let t = n[e];
		n[e] = typeof r == "object" && r && !Array.isArray(r) && typeof t == "object" && t && !Array.isArray(t) ? Cr(t, r) : r;
	}
	return n;
}
function wr(e) {
	return e.reduce((e, t) => Cr(e, t), {});
}
function Tr(e, t) {
