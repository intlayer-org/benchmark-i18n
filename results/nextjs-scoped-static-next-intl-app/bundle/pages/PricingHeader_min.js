...
function lt(e, t, n) {
	let { cache: r, formats: i, formatters: a, getMessageFallback: s, locale: c, onError: l, timeZone: u } = Q(), d = e[n], f = nt(t, n);
	return !u && !st && ct && (st = !0, l(new v(y.ENVIRONMENT_FALLBACK, "There is no `timeZone` configured, this can lead to markup mismatches caused by environment differences. Consider adding a global default: https://next-intl.dev/docs/configuration#time-zone"))), o(() => et({
		cache: r,
		formatters: a,
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/pages/pricing/PricingHeader.tsx";
function gt() {
	let e = ft();
...
var Gr = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-intl-app/components/pages/pricing/PricingHeader.wrapper.tsx";
function Kr() {
