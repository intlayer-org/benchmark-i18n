...
function Kn(t) {
	...
	return function({ cache: t, formats: r, formatters: i, getMessageFallback: a = Wn, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, h, g) {
			...
			try {
				return Un(X(c, p), v, m && function(t) {
					let r = {};
...
var Q = t(void 0);
function Xn({ children: e, formats: t, getMessageFallback: n, locale: i, messages: a, now: s, onError: l, timeZone: u }) {
	let d = r(Q), f = o((() => d?.cache || Qt()), [i, d?.cache]), p = o((() => d?.formatters || $t(f)), [f, d?.formatters]), m = o((() => ({
		...Yn({
			locale: i,
