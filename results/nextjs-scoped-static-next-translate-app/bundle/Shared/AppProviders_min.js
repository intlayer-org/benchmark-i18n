...
function te(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, u = c === void 0 ? {} : c, d = ee().lang, f = l() || {}, p = f.locale, g = f.defaultLocale, _ = n(j), y = A(A(A({}, ne()), _.ns), o), b = r || d || p || g || "", x = A(A({}, _.config), u), S = x.localesToIgnore || ["default"], C = !b || S.includes(b), w = a(function() {
		return h(C ? void 0 : b);
	}, [C, b]), T = a(function() {
		return v({
			config: x,
