...
var f = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-translate-app/components/AppProviders.tsx";
...
function te(e) {
	return (globalThis.__NEXT_TRANSLATE__?.config ? O : ee)(e);
}
var A = function() {
...
function ne(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, u = c === void 0 ? {} : c, d = te().lang, f = l() || {}, p = f.locale, m = f.defaultLocale, _ = n(j), v = A(A(A({}, re()), _.ns), o), b = r || d || p || m || "", x = A(A({}, _.config), u), S = x.localesToIgnore || ["default"], C = !b || S.includes(b), w = a(function() {
		return g(C ? void 0 : b);
	}, [C, b]), T = a(function() {
		return y({
			config: x,
...
}, Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-translate-app/scripts/Wrapper.tsx";
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-translate-app/components/AppProviders.wrapper.tsx";
function en() {
	return c($t, { children: c(p, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
