...
var f = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-translate-app/components/Link.tsx", p = (e) => /^https?:\/\//.test(e ?? "");
function m(e, t) {
...
function w(e) {
	var t = e.config, n = e.allNamespaces, r = e.pluralRules, i = e.lang, a = t.logger, o = a === void 0 ? O : a, s = t.allowEmptyStrings, c = s === void 0 || s, l = function(e, n) {
		...
		e === void 0 && (e = "");
		var s = Array.isArray(e) ? e[0] : e, d = t.nsSeparator, f = d === void 0 ? ":" : d, p = t.loggerEnvironment, m = p === void 0 ? "browser" : p, h = C(s, f), g = h.i18nKey, _ = h.namespace, v = _ === void 0 ? a?.ns ?? t.defaultNS : _, y = v && n[v] || {}, b = T(y, ee(r, y, g, t, i, a), t, a), x = typeof b == "object" ? JSON.parse(JSON.stringify(b)) : b, w = x === void 0 || typeof x == "object" && !Object.keys(x).length || x === "" && !c, E = typeof a?.fallback == "string" ? [a.fallback] : a?.fallback || [];
		if (w && (m === "both" || m === (typeof window > "u" ? "node" : "browser")) && o({
			namespace: v,
			i18nKey: g
		}), w && Array.isArray(E) && E.length) {
			var D = E[0], O = E.slice(1);
			if (typeof D == "string") return u(D, i, S(S({}, a), { fallback: O }));
		}
		return w && a && a.hasOwnProperty("default") && !E?.length ? a.default ? l(a.default, i) : a.default : w ? s : l(x, i);
	};
	return u;
}
function T(e, t, n, r) {
...
function ne(e) {
	var t = n(y);
	return a(function() {
		return k(k({}, t), { t: _(t.t, e) });
	}, [t, e]);
}
function A(e) {
	return (globalThis.__NEXT_TRANSLATE__?.config ? te : ne)(e);
}
var j = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-translate-app/components/Footer.tsx";
function re() {
	let { t: e } = A("common"), t = [
		{
...
function ie(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, l = c === void 0 ? {} : c, u = A().lang, f = d() || {}, p = f.locale, m = f.defaultLocale, h = n(N), g = M(M(M({}, ae()), h.ns), o), _ = r || u || p || m || "", v = M(M({}, h.config), l), b = v.localesToIgnore || ["default"], S = !_ || b.includes(_), C = a(function() {
		return x(S ? void 0 : _);
	}, [S, _]), T = a(function() {
		return w({
			config: v,
...
var on = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-translate-app/components/AppProviders.tsx";
...
function cn({ children: e }) {
	...
	return r(() => {
		(async () => {
			try {
				let e = await nn.loadLocaleFrom?.("en", "common");
				n(e ?? {}), a(!0);
			} catch (e) {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-translate-app/components/Footer.wrapper.tsx";
function ln() {
	return u(cn, { children: u(re, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
