...
function N(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, l = c === void 0 ? {} : c, u = A().lang, d = f() || {}, p = d.locale, m = d.defaultLocale, h = n(M), g = j(j(j({}, P()), h.ns), o), _ = r || u || p || m || "", v = j(j({}, h.config), l), b = v.localesToIgnore || ["default"], S = !_ || b.includes(_), C = a(function() {
		return x(S ? void 0 : _);
	}, [S, _]), T = a(function() {
		return w({
			config: v,
...
function rn({ children: e }) {
	...
	return r(() => {
		(async () => {
			try {
				let e = await $t.loadLocaleFrom?.("en", "common");
				n(e ?? {}), a(!0);
			} catch (e) {
