...
import L from "../locales/it/pricing.json";
import _e from "../locales/it/products.json";
...
var Ot = (e) => /^https?:\/\//.test(e ?? "");
function kt(e, t) {
	return !e.startsWith("/") || e === `/${t}` || e.startsWith(`/${t}/`) ? e : `/${t}${e === "/" ? "" : e}`;
}
var At = ({ href: e, children: t, ...n }) => {
	let r = c().lang ?? "en";
	return e == null || typeof e != "string" || Ot(e) ? u(s, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
function H(e) {
	var t = e.config, n = e.allNamespaces, r = e.pluralRules, i = e.lang, a = t.logger, o = a === void 0 ? Nt : a, s = t.allowEmptyStrings, c = s === void 0 ? !0 : s, l = function(e, n) {
		...
		e === void 0 && (e = "");
		var s = Array.isArray(e) ? e[0] : e, d = t.nsSeparator, f = d === void 0 ? ":" : d, p = t.loggerEnvironment, m = p === void 0 ? "browser" : p, h = jt(s, f), g = h.i18nKey, _ = h.namespace, v = _ === void 0 ? a?.ns ?? t.defaultNS : _, y = v && n[v] || {}, b = U(y, Mt(r, y, g, t, i, a), t, a), x = typeof b == "object" ? JSON.parse(JSON.stringify(b)) : b, S = x === void 0 || typeof x == "object" && !Object.keys(x).length || x === "" && !c, C = typeof a?.fallback == "string" ? [a.fallback] : a?.fallback || [];
...
function Lt(e) {
	return (globalThis.__NEXT_TRANSLATE__?.config ? Ft : It)(e);
}
var Y = function() {
...
function Rt(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, l = c === void 0 ? {} : c, u = Lt().lang, f = d() || {}, p = f.locale, m = f.defaultLocale, h = n(X), g = Y(Y(Y({}, zt()), h.ns), o), _ = r || u || p || m || "", v = Y(Y({}, h.config), l), y = v.localesToIgnore || ["default"], b = !_ || y.includes(_), x = a(function() {
		return B(b ? void 0 : _);
	}, [b, _]), S = a(function() {
		return H({
			config: v,
...
function tn({ children: e }) {
	...
	return r(() => {
		(async () => {
			try {
				n(await Zt.loadLocaleFrom?.("en", "common") ?? {}), a(!0);
			} catch (e) {
