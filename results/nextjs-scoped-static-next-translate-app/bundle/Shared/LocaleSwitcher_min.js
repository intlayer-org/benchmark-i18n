...
import E from "../locales/de/pricing.json";
import D from "../locales/de/products.json";
import O from "../locales/de/route.json";
import k from "../locales/de/settings.json";
import A from "../locales/de/shared.json";
import j from "../locales/de/team.json";
import M from "../locales/it/about.json";
import N from "../locales/it/blog.json";
import P from "../locales/it/careers.json";
import F from "../locales/it/contact.json";
import I from "../locales/it/faq.json";
import L from "../locales/it/home.json";
import _e from "../locales/it/pricing.json";
...
function H(e) {
	var t = e.config, n = e.allNamespaces, r = e.pluralRules, i = e.lang, a = t.logger, o = a === void 0 ? Pt : a, s = t.allowEmptyStrings, c = s === void 0 ? !0 : s, l = function(e, n) {
		...
		e === void 0 && (e = "");
		var s = Array.isArray(e) ? e[0] : e, d = t.nsSeparator, f = d === void 0 ? ":" : d, p = t.loggerEnvironment, m = p === void 0 ? "browser" : p, h = Mt(s, f), g = h.i18nKey, _ = h.namespace, v = _ === void 0 ? a?.ns ?? t.defaultNS : _, y = v && n[v] || {}, b = U(y, Nt(r, y, g, t, i, a), t, a), x = typeof b == "object" ? JSON.parse(JSON.stringify(b)) : b, S = x === void 0 || typeof x == "object" && !Object.keys(x).length || x === "" && !c, C = typeof a?.fallback == "string" ? [a.fallback] : a?.fallback || [];
...
function Rt(e) {
	return (globalThis.__NEXT_TRANSLATE__?.config ? It : Lt)(e);
}
var Y = function() {
...
function zt(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, l = c === void 0 ? {} : c, u = Rt().lang, d = f() || {}, p = d.locale, m = d.defaultLocale, h = n(X), g = Y(Y(Y({}, Bt()), h.ns), o), _ = r || u || p || m || "", v = Y(Y({}, h.config), l), y = v.localesToIgnore || ["default"], b = !_ || y.includes(_), x = a(function() {
		return B(b ? void 0 : _);
	}, [b, _]), S = a(function() {
		return H({
			config: v,
