...
import u from "../locales/fr/about.json";
import d from "../locales/fr/blog.json";
import f from "../locales/fr/careers.json";
import p from "../locales/fr/contact.json";
import m from "../locales/fr/faq.json";
import h from "../locales/fr/home.json";
import g from "../locales/fr/pricing.json";
import _ from "../locales/fr/products.json";
import v from "../locales/fr/route.json";
import y from "../locales/fr/settings.json";
import b from "../locales/fr/shared.json";
import x from "../locales/fr/team.json";
import S from "../locales/es/about.json";
import C from "../locales/es/blog.json";
import w from "../locales/es/careers.json";
import T from "../locales/es/contact.json";
import ee from "../locales/es/faq.json";
import te from "../locales/es/home.json";
import ne from "../locales/es/pricing.json";
import re from "../locales/es/products.json";
import ie from "../locales/es/route.json";
import ae from "../locales/es/settings.json";
import oe from "../locales/es/shared.json";
import se from "../locales/es/team.json";
import ce from "../locales/de/about.json";
import le from "../locales/de/blog.json";
import ue from "../locales/de/careers.json";
import de from "../locales/de/contact.json";
import fe from "../locales/de/faq.json";
import pe from "../locales/de/home.json";
import me from "../locales/de/pricing.json";
import he from "../locales/de/products.json";
import ge from "../locales/de/route.json";
import _e from "../locales/de/settings.json";
import E from "../locales/de/shared.json";
import D from "../locales/de/team.json";
import O from "../locales/it/about.json";
import k from "../locales/it/blog.json";
import A from "../locales/it/careers.json";
import j from "../locales/it/contact.json";
import M from "../locales/it/faq.json";
import N from "../locales/it/home.json";
import P from "../locales/it/pricing.json";
import F from "../locales/it/products.json";
import I from "../locales/it/route.json";
import ve from "../locales/it/settings.json";
import ye from "../locales/it/shared.json";
import be from "../locales/it/team.json";
import xe from "../locales/pt/about.json";
import Se from "../locales/pt/blog.json";
import Ce from "../locales/pt/careers.json";
import we from "../locales/pt/contact.json";
import Te from "../locales/pt/faq.json";
import Ee from "../locales/pt/home.json";
import De from "../locales/pt/pricing.json";
import Oe from "../locales/pt/products.json";
import ke from "../locales/pt/route.json";
import Ae from "../locales/pt/settings.json";
import je from "../locales/pt/shared.json";
import Me from "../locales/pt/team.json";
import Ne from "../locales/zh/about.json";
import Pe from "../locales/zh/blog.json";
import Fe from "../locales/zh/careers.json";
import Ie from "../locales/zh/contact.json";
import Le from "../locales/zh/faq.json";
import Re from "../locales/zh/home.json";
import ze from "../locales/zh/pricing.json";
import Be from "../locales/zh/products.json";
import Ve from "../locales/zh/route.json";
import He from "../locales/zh/settings.json";
import Ue from "../locales/zh/shared.json";
import We from "../locales/zh/team.json";
import Ge from "../locales/ja/about.json";
import Ke from "../locales/ja/blog.json";
import qe from "../locales/ja/careers.json";
import Je from "../locales/ja/contact.json";
import Ye from "../locales/ja/faq.json";
import Xe from "../locales/ja/home.json";
import Ze from "../locales/ja/pricing.json";
import Qe from "../locales/ja/products.json";
import $e from "../locales/ja/route.json";
import et from "../locales/ja/settings.json";
import tt from "../locales/ja/shared.json";
import nt from "../locales/ja/team.json";
import rt from "../locales/ko/about.json";
import it from "../locales/ko/blog.json";
import at from "../locales/ko/careers.json";
import ot from "../locales/ko/contact.json";
import st from "../locales/ko/faq.json";
import ct from "../locales/ko/home.json";
import lt from "../locales/ko/pricing.json";
import ut from "../locales/ko/products.json";
import dt from "../locales/ko/route.json";
import ft from "../locales/ko/settings.json";
import pt from "../locales/ko/shared.json";
import mt from "../locales/ko/team.json";
import ht from "../locales/ru/about.json";
import gt from "../locales/ru/blog.json";
import _t from "../locales/ru/careers.json";
import vt from "../locales/ru/contact.json";
import yt from "../locales/ru/faq.json";
import bt from "../locales/ru/home.json";
import xt from "../locales/ru/pricing.json";
import St from "../locales/ru/products.json";
import Ct from "../locales/ru/route.json";
import wt from "../locales/ru/settings.json";
import Tt from "../locales/ru/shared.json";
import Et from "../locales/ru/team.json";
var L = function() {
...
function U(e) {
	var t = e.config, n = e.allNamespaces, r = e.pluralRules, i = e.lang, a = t.logger, o = a === void 0 ? At : a, s = t.allowEmptyStrings, c = s === void 0 ? !0 : s, l = function(e, n) {
		...
		e === void 0 && (e = "");
		var s = Array.isArray(e) ? e[0] : e, d = t.nsSeparator, f = d === void 0 ? ":" : d, p = t.loggerEnvironment, m = p === void 0 ? "browser" : p, h = Ot(s, f), g = h.i18nKey, _ = h.namespace, v = _ === void 0 ? a?.ns ?? t.defaultNS : _, y = v && n[v] || {}, b = W(y, kt(r, y, g, t, i, a), t, a), x = typeof b == "object" ? JSON.parse(JSON.stringify(b)) : b, S = x === void 0 || typeof x == "object" && !Object.keys(x).length || x === "" && !c, C = typeof a?.fallback == "string" ? [a.fallback] : a?.fallback || [];
...
function J(e) {
	return (globalThis.__NEXT_TRANSLATE__?.config ? jt : Mt)(e);
}
var Nt = () => {
	let { t: e } = J("common");
	return c("div", {
...
function Pt(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, u = c === void 0 ? {} : c, d = J().lang, f = l() || {}, p = f.locale, m = f.defaultLocale, h = n(X), g = Y(Y(Y({}, Ft()), h.ns), o), _ = r || d || p || m || "", v = Y(Y({}, h.config), u), y = v.localesToIgnore || ["default"], b = !_ || y.includes(_), x = a(function() {
		return V(b ? void 0 : _);
	}, [b, _]), S = a(function() {
		return U({
			config: v,
...
function Zt({ children: e }) {
	...
	return r(() => {
		(async () => {
			try {
				n(await qt.loadLocaleFrom?.("en", "common") ?? {}), a(!0);
			} catch (e) {
