...
function ee(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, u = c === void 0 ? {} : c, d = D().lang, f = l() || {}, m = f.locale, g = f.defaultLocale, _ = n(A), y = k(k(k({}, te()), _.ns), o), b = r || d || m || g || "", x = k(k({}, _.config), u), S = x.localesToIgnore || ["default"], C = !b || S.includes(b), w = a(function() {
		return h(C ? void 0 : b);
	}, [C, b]), T = a(function() {
		return v({
			config: x,
