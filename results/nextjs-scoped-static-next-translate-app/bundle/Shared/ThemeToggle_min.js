...
import ve from "../locales/de/shared.json";
import E from "../locales/de/team.json";
import D from "../locales/it/about.json";
import O from "../locales/it/blog.json";
import k from "../locales/it/careers.json";
import A from "../locales/it/contact.json";
import j from "../locales/it/faq.json";
import M from "../locales/it/home.json";
import N from "../locales/it/pricing.json";
import P from "../locales/it/products.json";
import F from "../locales/it/route.json";
...
function It(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, u = c === void 0 ? {} : c, d = q().lang, f = l() || {}, p = f.locale, m = f.defaultLocale, h = n(X), g = Y(Y(Y({}, Lt()), h.ns), o), _ = r || d || p || m || "", v = Y(Y({}, h.config), u), y = v.localesToIgnore || ["default"], b = !_ || y.includes(_), x = a(function() {
		return B(b ? void 0 : _);
	}, [b, _]), S = a(function() {
		return H({
			config: v,
