...
function d(e, t) {
	return typeof t == "string" ? function(n, r, i) {
		return e(n, r, u({ ns: t }, i));
	} : e;
}
var f;
typeof e.createContext == "function" && (f = e.createContext({
	t: function(e) {
...
function E(e) {
	var t = n(p);
	return a(function() {
		return T(T({}, t), { t: d(t.t, e) });
	}, [t, e]);
}
function D(e) {
	return (globalThis.__NEXT_TRANSLATE__?.config ? w : E)(e);
}
var O = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-translate-app/components/pages/about/AboutGrid.tsx";
function k() {
	let { t: e } = D("common");
	return c("div", {
...
function ee(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, u = c === void 0 ? {} : c, d = D().lang, f = l() || {}, m = f.locale, g = f.defaultLocale, _ = n(j), y = A(A(A({}, te()), _.ns), o), b = r || d || m || g || "", x = A(A({}, _.config), u), S = x.localesToIgnore || ["default"], C = !b || S.includes(b), w = a(function() {
		return h(C ? void 0 : b);
	}, [C, b]), T = a(function() {
		return v({
			config: x,
...
var $t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-translate-app/components/AppProviders.tsx";
function en({ children: e, locale: t }) {
...
function tn({ children: e }) {
	...
	return r(() => {
		(async () => {
			try {
				let e = await Xt.loadLocaleFrom?.("en", "common");
				n(e ?? {}), a(!0);
			} catch (e) {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-translate-app/components/pages/about/AboutGrid.wrapper.tsx";
function nn() {
	return c(tn, { children: c(k, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
