...
function It(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, l = c === void 0 ? {} : c, d = J().lang, f = u() || {}, p = f.locale, m = f.defaultLocale, h = n(X), g = Y(Y(Y({}, Lt()), h.ns), o), _ = r || d || p || m || "", v = Y(Y({}, h.config), l), y = v.localesToIgnore || ["default"], b = !_ || y.includes(_), x = a(function() {
		return V(b ? void 0 : _);
	}, [b, _]), S = a(function() {
		return U({
			config: v,
