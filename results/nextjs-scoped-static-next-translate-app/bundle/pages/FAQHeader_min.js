...
function te(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, l = c === void 0 ? {} : c, d = O().lang, f = u() || {}, p = f.locale, h = f.defaultLocale, _ = n(j), v = A(A(A({}, ne()), _.ns), o), b = r || d || p || h || "", x = A(A({}, _.config), l), S = x.localesToIgnore || ["default"], C = !b || S.includes(b), w = a(function() {
		return g(C ? void 0 : b);
	}, [C, b]), T = a(function() {
		return y({
			config: x,
