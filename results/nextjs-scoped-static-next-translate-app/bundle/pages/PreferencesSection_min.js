...
var k = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-translate-app/components/pages/settings/PreferencesSection.tsx";
function ee() {
...
function te(t) {
	var r = t.lang, i = t.namespaces, a = i === void 0 ? {} : i, s = t.children, c = t.config, l = c === void 0 ? {} : c, d = O().lang, f = u() || {}, p = f.locale, h = f.defaultLocale, _ = n(j), v = A(A(A({}, ne()), _.ns), a), b = r || d || p || h || "", x = A(A({}, _.config), l), S = x.localesToIgnore || ["default"], C = !b || S.includes(b), w = o(function() {
		return g(C ? void 0 : b);
	}, [C, b]), T = o(function() {
		return y({
			config: x,
...
var en = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-translate-app/components/AppProviders.tsx";
...
function nn({ children: e }) {
	...
	return r(() => {
		(async () => {
			try {
				let e = await Zt.loadLocaleFrom?.("en", "common");
				n(e ?? {}), a(!0);
			} catch (e) {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-scoped-static/next-translate-app/components/pages/settings/PreferencesSection.wrapper.tsx";
function rn() {
	return l(nn, { children: l(ee, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
