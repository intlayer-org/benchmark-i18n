...
import d from "../../../locales/fr/about.json";
import f from "../../../locales/fr/blog.json";
import p from "../../../locales/fr/careers.json";
import m from "../../../locales/fr/contact.json";
import h from "../../../locales/fr/faq.json";
import g from "../../../locales/fr/home.json";
import _ from "../../../locales/fr/pricing.json";
import v from "../../../locales/fr/products.json";
import y from "../../../locales/fr/route.json";
import b from "../../../locales/fr/settings.json";
import x from "../../../locales/fr/shared.json";
import S from "../../../locales/fr/team.json";
import C from "../../../locales/es/about.json";
import w from "../../../locales/es/blog.json";
import T from "../../../locales/es/careers.json";
import ee from "../../../locales/es/contact.json";
import te from "../../../locales/es/faq.json";
import ne from "../../../locales/es/home.json";
import re from "../../../locales/es/pricing.json";
import ie from "../../../locales/es/products.json";
import ae from "../../../locales/es/route.json";
import oe from "../../../locales/es/settings.json";
import se from "../../../locales/es/shared.json";
import ce from "../../../locales/es/team.json";
import le from "../../../locales/de/about.json";
import ue from "../../../locales/de/blog.json";
import de from "../../../locales/de/careers.json";
import fe from "../../../locales/de/contact.json";
import pe from "../../../locales/de/faq.json";
import me from "../../../locales/de/home.json";
import he from "../../../locales/de/pricing.json";
import ge from "../../../locales/de/products.json";
import _e from "../../../locales/de/route.json";
import E from "../../../locales/de/settings.json";
import D from "../../../locales/de/shared.json";
import O from "../../../locales/de/team.json";
import k from "../../../locales/it/about.json";
import A from "../../../locales/it/blog.json";
import j from "../../../locales/it/careers.json";
import M from "../../../locales/it/contact.json";
import N from "../../../locales/it/faq.json";
import P from "../../../locales/it/home.json";
import F from "../../../locales/it/pricing.json";
import I from "../../../locales/it/products.json";
import ve from "../../../locales/it/route.json";
import ye from "../../../locales/it/settings.json";
import be from "../../../locales/it/shared.json";
import xe from "../../../locales/it/team.json";
import Se from "../../../locales/pt/about.json";
import Ce from "../../../locales/pt/blog.json";
import we from "../../../locales/pt/careers.json";
import Te from "../../../locales/pt/contact.json";
import Ee from "../../../locales/pt/faq.json";
import De from "../../../locales/pt/home.json";
import Oe from "../../../locales/pt/pricing.json";
import ke from "../../../locales/pt/products.json";
import Ae from "../../../locales/pt/route.json";
import je from "../../../locales/pt/settings.json";
import Me from "../../../locales/pt/shared.json";
import Ne from "../../../locales/pt/team.json";
import Pe from "../../../locales/zh/about.json";
import Fe from "../../../locales/zh/blog.json";
import Ie from "../../../locales/zh/careers.json";
import Le from "../../../locales/zh/contact.json";
import Re from "../../../locales/zh/faq.json";
import ze from "../../../locales/zh/home.json";
import Be from "../../../locales/zh/pricing.json";
import Ve from "../../../locales/zh/products.json";
import He from "../../../locales/zh/route.json";
import Ue from "../../../locales/zh/settings.json";
import We from "../../../locales/zh/shared.json";
import Ge from "../../../locales/zh/team.json";
import Ke from "../../../locales/ja/about.json";
import qe from "../../../locales/ja/blog.json";
import Je from "../../../locales/ja/careers.json";
import Ye from "../../../locales/ja/contact.json";
import Xe from "../../../locales/ja/faq.json";
import Ze from "../../../locales/ja/home.json";
import Qe from "../../../locales/ja/pricing.json";
import $e from "../../../locales/ja/products.json";
import et from "../../../locales/ja/route.json";
import tt from "../../../locales/ja/settings.json";
import nt from "../../../locales/ja/shared.json";
import rt from "../../../locales/ja/team.json";
import it from "../../../locales/ko/about.json";
import at from "../../../locales/ko/blog.json";
import ot from "../../../locales/ko/careers.json";
import st from "../../../locales/ko/contact.json";
import ct from "../../../locales/ko/faq.json";
import lt from "../../../locales/ko/home.json";
import ut from "../../../locales/ko/pricing.json";
import dt from "../../../locales/ko/products.json";
import ft from "../../../locales/ko/route.json";
import pt from "../../../locales/ko/settings.json";
import mt from "../../../locales/ko/shared.json";
import ht from "../../../locales/ko/team.json";
import gt from "../../../locales/ru/about.json";
import _t from "../../../locales/ru/blog.json";
import vt from "../../../locales/ru/careers.json";
import yt from "../../../locales/ru/contact.json";
import bt from "../../../locales/ru/faq.json";
import xt from "../../../locales/ru/home.json";
import St from "../../../locales/ru/pricing.json";
import Ct from "../../../locales/ru/products.json";
import wt from "../../../locales/ru/route.json";
import Tt from "../../../locales/ru/settings.json";
import Et from "../../../locales/ru/shared.json";
import Dt from "../../../locales/ru/team.json";
var L = function() {
...
function U(e) {
	var t = e.config, n = e.allNamespaces, r = e.pluralRules, i = e.lang, a = t.logger, o = a === void 0 ? jt : a, s = t.allowEmptyStrings, c = s === void 0 ? !0 : s, l = function(e, n) {
		...
		e === void 0 && (e = "");
		var s = Array.isArray(e) ? e[0] : e, d = t.nsSeparator, f = d === void 0 ? ":" : d, p = t.loggerEnvironment, m = p === void 0 ? "browser" : p, h = kt(s, f), g = h.i18nKey, _ = h.namespace, v = _ === void 0 ? a?.ns ?? t.defaultNS : _, y = v && n[v] || {}, b = W(y, At(r, y, g, t, i, a), t, a), x = typeof b == "object" ? JSON.parse(JSON.stringify(b)) : b, S = x === void 0 || typeof x == "object" && !Object.keys(x).length || x === "" && !c, C = typeof a?.fallback == "string" ? [a.fallback] : a?.fallback || [];
...
function J(e) {
	return (globalThis.__NEXT_TRANSLATE__?.config ? Mt : Nt)(e);
}
function Pt() {
	let { t: e } = J("common"), t = [
		{
...
function Ft(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, l = c === void 0 ? {} : c, d = J().lang, f = u() || {}, p = f.locale, m = f.defaultLocale, h = n(X), g = Y(Y(Y({}, It()), h.ns), o), _ = r || d || p || m || "", v = Y(Y({}, h.config), l), y = v.localesToIgnore || ["default"], b = !_ || y.includes(_), x = a(function() {
		return V(b ? void 0 : _);
	}, [b, _]), S = a(function() {
		return U({
			config: v,
...
function Qt({ children: e }) {
	...
	return r(() => {
		(async () => {
			try {
				n(await Jt.loadLocaleFrom?.("en", "common") ?? {}), a(!0);
			} catch (e) {
