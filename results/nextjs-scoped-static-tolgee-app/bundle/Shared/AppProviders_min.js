...
}, j = (e) => Object.fromEntries(re(e).entries()), M = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function pe(e, t) {
	let n = I(fe, t?.initialOptions, e);
	return n.apiUrl = O(n.apiUrl), e?.fetch && (n.fetch = A(e.fetch)), {
		initialOptions: n,
...
function me(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return x(s.onError, (e) => new ce("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return x(s.onError, (e) => new se("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function E(e) {
		e && l.backends.push(e);
	}
	...
	let k = Object.freeze({
		...
		setStoredLanguage(e) {
			return x(s.onError, (e) => new ce("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
var L = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, _e(r)), n)), n;
};
function ve({ options: e }) {
	let t = ae(), n = he(!1, () => o.isFetching(), t.onFetchingChange.emit), r = he(!1, () => E.isLoading(), t.onLoadingChange.emit), i = ge(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = me(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = le(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Ne = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, G = {};
(function(e) {
	function t(e, t) {
...
(_ = console.assert) == null || _.call(console, Pe), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Fe(e, t) {
	return t ? `${t}: ${e}` : e;
}
var K = class e extends Error {
	constructor(t, n, r) {
		super(Fe(t, n)), this.code = t, this.status = n, this.params = r, Object.setPrototypeOf(this, e.prototype);
	}
};
function Ie(e) {
	return e instanceof Error && typeof e.code == "string";
}
var Le = 2, Re = 35e3, ze = "TOLGEE_API_REQUEST", Be = "TOLGEE_API_RESPONSE", Ve = "TOLGEE_PROXY_PING", He = "TOLGEE_PROXY_PONG";
function Ue(e) {
...
}, We = 3e3, Ge = 200, Ke = 0, J = /* @__PURE__ */ new Map(), qe = !1, Y, X;
async function Je({ type: e, replyType: t, payload: n, timeoutMs: r = Re, progressType: i, onProgress: a }) {
	Ze();
	let o = Date.now() + r;
	await Qe(Math.min(o, Date.now() + We));
	let s = o - Date.now();
	if (s <= 0) throw Ye(e);
	let c = Xe();
...
var Ye = (e) => new q("unavailable", `the Tolgee browser extension did not answer ${e} in time`), Xe = () => `${Date.now()}-${Ke++}-${Math.random()}`;
function Ze() {
...
function Qe(e) {
	return Y ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Ve }, window.origin), i = () => {
			clearInterval(a), $e(), X = void 0, n(new q("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var at = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
function ot(e) {
	let t = at.indexOf(e);
...
function ct(e) {
	...
	for (let o = 0; o < t; o++) r = r << 5 | ot(e[o]), n += 5, n >= 8 && (a[i++] = r >>> n - 8 & 255, n -= 8);
	return st(a.buffer);
}
function lt(e) {
	if (e) try {
...
function dt(e) {
	...
	return r ? {
		...
		hasCredential: !!t,
		projectId: lt(t) ?? n,
		requiresExplicitProject: ut(t) === "tgpat"
	};
}
function ft(e) {
...
var Z = "__tolgee_", gt = `${Z}apiKey`, _t = `${Z}apiUrl`, vt = `${Z}branch`, yt = `${Z}projectId`, bt = `${Z}session`, xt = "tolgee-in-context-tools.umd.min.js", St = "@tolgee/in-context-tools", Ct = "InContextTools", wt = "https://cdn.jsdelivr.net/npm", Tt = null;
function Et(e) {
	return Tt ||= jt(Dt(e)).then(() => window[St][Ct]), Tt;
}
function Dt(e) {
	return Ot() || `${wt}/@tolgee/web@${e}/dist/${xt}`;
}
function Ot() {
	if (Me()) return;
	let e = window.__TOLGEE_IN_CONTEXT_URL__;
	return At(e, window.location) ? e : void 0;
}
var kt = (e) => e === "localhost" || e === "127.0.0.1" || e === "::1" || e === "[::1]";
function At(e, t) {
	if (!e || !kt(t.hostname)) return !1;
	try {
		let n = new URL(e, t.href);
		return n.origin === t.origin || kt(n.hostname);
	} catch {
		return !1;
	}
}
...
function Mt() {
	let e = sessionStorage.getItem(gt) || void 0, t = sessionStorage.getItem(_t) || void 0, n = sessionStorage.getItem(vt) || void 0, r = sessionStorage.getItem(yt) || void 0, i = Ue(sessionStorage.getItem(bt));
	if (!t) return;
	let a = h(h({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return g(h({}, a), { apiKey: e });
	if (i && r) return g(h({}, a), { transport: et() });
}
function Nt() {
	let e = [];
...
(() => {
	...
	return Pt(e), e.on("running", ({ value: e }) => {
		e && Ft(() => {
			t.update(n()).catch(Nt);
		});
	}), Mt() && (async () => {
		let e = await Et("prerelease");
		return (t) => {
			let n = Mt();
...
function zt(e, t, r, o = !0) {
	let [s] = a(() => Rt(e)), [c, l] = a(o);
	return n(() => {
		l(!1);
	}, []), i(() => {
...
var Bt = { useSuspense: !1 }, Vt, Ht = () => (Vt ||= e.createContext(void 0), Vt), Q = void 0, Ut = ({ tolgee: r, options: i, children: o, fallback: s, ssr: c }) => {
	n(() => {
	...
	l = zt(r, u, d, !!c);
	let [f, p] = a(!l.isLoaded()), m = Object.assign(Object.assign({}, Bt), i), h = Ht();
...
function Il() {
	return Lt().use(je()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(Fl.map((e) => [e, () => Promise.resolve(Pl(e))]))
	});
}
var Ll = Il().init(), Rl = ({ language: e, staticData: t, children: r }) => {
	let i = o();
	return n(() => {
		let { unsubscribe: e } = Ll.on("permanentChange", () => {
			i.refresh();
		});
		return () => {
			e();
...
function Vl({ children: e, locale: t, staticData: i }) {
