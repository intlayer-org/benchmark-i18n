...
import s from "../i18n/locales/de/route.json";
import c from "../i18n/locales/de/header.json";
import l from "../i18n/locales/de/footer.json";
import u from "../i18n/locales/de/themeToggle.json";
import d from "../i18n/locales/de/hero.json";
import f from "../i18n/locales/de/whyItMatters.json";
import p from "../i18n/locales/de/understandingImpact.json";
import m from "../i18n/locales/de/resultsTable.json";
import h from "../i18n/locales/de/aboutHeader.json";
import g from "../i18n/locales/de/aboutGrid.json";
import _ from "../i18n/locales/de/whatWeMeasure.json";
import v from "../i18n/locales/de/blogHeader.json";
import y from "../i18n/locales/de/blogList.json";
import b from "../i18n/locales/de/careersHeader.json";
import x from "../i18n/locales/de/careersBenefits.json";
import S from "../i18n/locales/de/openPositions.json";
import ee from "../i18n/locales/de/contactHeader.json";
import te from "../i18n/locales/de/contactForm.json";
import ne from "../i18n/locales/de/faqHeader.json";
import re from "../i18n/locales/de/faqList.json";
import C from "../i18n/locales/de/pricingHeader.json";
...
import ci from "../i18n/locales/ko/home.json";
import li from "../i18n/locales/ko/about.json";
import ui from "../i18n/locales/ko/blog.json";
import di from "../i18n/locales/ko/careers.json";
import fi from "../i18n/locales/ko/contact.json";
import pi from "../i18n/locales/ko/faq.json";
import mi from "../i18n/locales/ko/pricing.json";
import hi from "../i18n/locales/ko/products.json";
import gi from "../i18n/locales/ko/settings.json";
import _i from "../i18n/locales/ko/team.json";
import vi from "../i18n/locales/pt/route.json";
import yi from "../i18n/locales/pt/header.json";
import bi from "../i18n/locales/pt/footer.json";
import xi from "../i18n/locales/pt/themeToggle.json";
import Si from "../i18n/locales/pt/hero.json";
import Ci from "../i18n/locales/pt/whyItMatters.json";
import wi from "../i18n/locales/pt/understandingImpact.json";
import Ti from "../i18n/locales/pt/resultsTable.json";
import Ei from "../i18n/locales/pt/aboutHeader.json";
import Di from "../i18n/locales/pt/aboutGrid.json";
import Oi from "../i18n/locales/pt/whatWeMeasure.json";
import ki from "../i18n/locales/pt/blogHeader.json";
import Ai from "../i18n/locales/pt/blogList.json";
import ji from "../i18n/locales/pt/careersHeader.json";
import Mi from "../i18n/locales/pt/careersBenefits.json";
import Ni from "../i18n/locales/pt/openPositions.json";
import Pi from "../i18n/locales/pt/contactHeader.json";
import Fi from "../i18n/locales/pt/contactForm.json";
import Ii from "../i18n/locales/pt/faqHeader.json";
import Li from "../i18n/locales/pt/faqList.json";
import Ri from "../i18n/locales/pt/pricingHeader.json";
import zi from "../i18n/locales/pt/pricingTiers.json";
import Bi from "../i18n/locales/pt/productsHeader.json";
import Vi from "../i18n/locales/pt/productsGrid.json";
import Hi from "../i18n/locales/pt/settingsHeader.json";
import Ui from "../i18n/locales/pt/profileSection.json";
import Wi from "../i18n/locales/pt/preferencesSection.json";
import Gi from "../i18n/locales/pt/apiAccessSection.json";
import Ki from "../i18n/locales/pt/settingsFooter.json";
import qi from "../i18n/locales/pt/teamHeader.json";
import Ji from "../i18n/locales/pt/teamGrid.json";
import E from "../i18n/locales/pt/common.json";
import Yi from "../i18n/locales/pt/home.json";
import Xi from "../i18n/locales/pt/about.json";
import Zi from "../i18n/locales/pt/blog.json";
import Qi from "../i18n/locales/pt/careers.json";
import $i from "../i18n/locales/pt/contact.json";
import ea from "../i18n/locales/pt/faq.json";
import ta from "../i18n/locales/pt/pricing.json";
import na from "../i18n/locales/pt/products.json";
import ra from "../i18n/locales/pt/settings.json";
import ia from "../i18n/locales/pt/team.json";
import aa from "../i18n/locales/ru/route.json";
import oa from "../i18n/locales/ru/header.json";
import sa from "../i18n/locales/ru/footer.json";
import ca from "../i18n/locales/ru/themeToggle.json";
import la from "../i18n/locales/ru/hero.json";
import ua from "../i18n/locales/ru/whyItMatters.json";
import da from "../i18n/locales/ru/understandingImpact.json";
import fa from "../i18n/locales/ru/resultsTable.json";
import pa from "../i18n/locales/ru/aboutHeader.json";
import ma from "../i18n/locales/ru/aboutGrid.json";
import ha from "../i18n/locales/ru/whatWeMeasure.json";
import ga from "../i18n/locales/ru/blogHeader.json";
import _a from "../i18n/locales/ru/blogList.json";
import va from "../i18n/locales/ru/careersHeader.json";
import ya from "../i18n/locales/ru/careersBenefits.json";
import ba from "../i18n/locales/ru/openPositions.json";
import xa from "../i18n/locales/ru/contactHeader.json";
import Sa from "../i18n/locales/ru/contactForm.json";
import Ca from "../i18n/locales/ru/faqHeader.json";
import wa from "../i18n/locales/ru/faqList.json";
import Ta from "../i18n/locales/ru/pricingHeader.json";
import Ea from "../i18n/locales/ru/pricingTiers.json";
import Da from "../i18n/locales/ru/productsHeader.json";
import Oa from "../i18n/locales/ru/productsGrid.json";
import ka from "../i18n/locales/ru/settingsHeader.json";
import Aa from "../i18n/locales/ru/profileSection.json";
import ja from "../i18n/locales/ru/preferencesSection.json";
import Ma from "../i18n/locales/ru/apiAccessSection.json";
import Na from "../i18n/locales/ru/settingsFooter.json";
import Pa from "../i18n/locales/ru/teamHeader.json";
import Fa from "../i18n/locales/ru/teamGrid.json";
import Ia from "../i18n/locales/ru/common.json";
import La from "../i18n/locales/ru/home.json";
import Ra from "../i18n/locales/ru/about.json";
import za from "../i18n/locales/ru/blog.json";
import Ba from "../i18n/locales/ru/careers.json";
import Va from "../i18n/locales/ru/contact.json";
import Ha from "../i18n/locales/ru/faq.json";
import Ua from "../i18n/locales/ru/pricing.json";
import Wa from "../i18n/locales/ru/products.json";
import Ga from "../i18n/locales/ru/settings.json";
import Ka from "../i18n/locales/ru/team.json";
import qa from "../i18n/locales/zh/route.json";
import Ja from "../i18n/locales/zh/header.json";
import Ya from "../i18n/locales/zh/footer.json";
import Xa from "../i18n/locales/zh/themeToggle.json";
import Za from "../i18n/locales/zh/hero.json";
import Qa from "../i18n/locales/zh/whyItMatters.json";
import $a from "../i18n/locales/zh/understandingImpact.json";
import eo from "../i18n/locales/zh/resultsTable.json";
import to from "../i18n/locales/zh/aboutHeader.json";
import no from "../i18n/locales/zh/aboutGrid.json";
import ro from "../i18n/locales/zh/whatWeMeasure.json";
import io from "../i18n/locales/zh/blogHeader.json";
import ao from "../i18n/locales/zh/blogList.json";
import oo from "../i18n/locales/zh/careersHeader.json";
import so from "../i18n/locales/zh/careersBenefits.json";
import co from "../i18n/locales/zh/openPositions.json";
import lo from "../i18n/locales/zh/contactHeader.json";
import uo from "../i18n/locales/zh/contactForm.json";
import fo from "../i18n/locales/zh/faqHeader.json";
import po from "../i18n/locales/zh/faqList.json";
import mo from "../i18n/locales/zh/pricingHeader.json";
import ho from "../i18n/locales/zh/pricingTiers.json";
import go from "../i18n/locales/zh/productsHeader.json";
import _o from "../i18n/locales/zh/productsGrid.json";
import vo from "../i18n/locales/zh/settingsHeader.json";
import yo from "../i18n/locales/zh/profileSection.json";
import bo from "../i18n/locales/zh/preferencesSection.json";
import xo from "../i18n/locales/zh/apiAccessSection.json";
import So from "../i18n/locales/zh/settingsFooter.json";
import Co from "../i18n/locales/zh/teamHeader.json";
import wo from "../i18n/locales/zh/teamGrid.json";
import To from "../i18n/locales/zh/common.json";
import Eo from "../i18n/locales/zh/home.json";
import Do from "../i18n/locales/zh/about.json";
import Oo from "../i18n/locales/zh/blog.json";
import ko from "../i18n/locales/zh/careers.json";
import Ao from "../i18n/locales/zh/contact.json";
import jo from "../i18n/locales/zh/faq.json";
import Mo from "../i18n/locales/zh/pricing.json";
import No from "../i18n/locales/zh/products.json";
import Po from "../i18n/locales/zh/settings.json";
import Fo from "../i18n/locales/zh/team.json";
import { jsx as D } from "react/jsx-runtime";
var Io = Object.defineProperty, Lo = Object.getOwnPropertySymbols, Ro = Object.prototype.hasOwnProperty, zo = Object.prototype.propertyIsEnumerable, Bo = (e, t, n) => t in e ? Io(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function is(e, t) {
	let n = U(rs, t?.initialOptions, e);
	return n.apiUrl = qo(n.apiUrl), e?.fetch && (n.fetch = P(e.fetch)), {
		initialOptions: n,
...
function as(e, t, n, r, i, a, o, s) {
	...
	function ee() {
		...
		let e = n();
		return A(s.onError, (e) => new $o("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let C = Object.freeze({
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = ts(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = Jo(e) || H, r = t().onFormatError, a = typeof r;
...
function ss(e, t, n) {
	let r = is(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? N([t, ...Ko(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
		...
		overrideCredentials(e) {
			i = e ? Object.assign(Object.assign({}, e), { apiUrl: qo(e.apiUrl) }) : void 0;
		}
	});
	return a;
}
function cs(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = ts(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
var ls = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, cs(r)), n)), n;
};
function us({ options: e }) {
	let t = Qo(), n = os(!1, () => o.isFetching(), t.onFetchingChange.emit), r = os(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ss(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = as(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = es(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var fs = () => {
	let e = {
		...
		init(t) {
			let n = ds(U(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, ps = 0, W = 1, ms = 2, hs = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === ps ? r = "Empty parameter" : e === W ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function gs(e) {
	return /\s/.test(e);
}
var G = 0, K = 1, q = 2, J = 3, Y = 4, _s = new Set([
	q,
	K,
	G
]), X = "'", vs = new Set([
...
function bs(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case G:
			...
			break;
		case K:
			vs.has(i) ? (n = n.slice(0, -1) + i, t = q) : (n += i, t = G);
			break;
		case q:
			i === X ? t = G : (n += i, t = q);
			break;
		case J:
			i === "}" ? (d(), t = G) : gs(i) ? r !== "" && (d(), t = Y) : (u(), t = J);
			break;
		case Y: i == "}" ? t = G : gs(i) ? t = Y : c(W);
	}
	return _s.has(t) || c(ms), l(), [a, o];
}
function xs(e, t) {
	let [n, r] = bs(e), i = [n[0]];
...
function Ss() {
	return { format: ({ translation: e, params: t }) => xs(e, t) };
}
var Cs = () => (e, t) => (t.setFinalFormatter(Ss()), e), ws = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Ts = {};
(function(e) {
	function t(e, t) {
		var n;
...
(Ho = console.assert) == null || Ho.call(console, Es), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ds(e, t) {
	let n = (n) => {
...
function Os({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var As = "tolgee-in-context-tools.umd.min.js", js = "@tolgee/in-context-tools", Ms = "InContextTools", Ns = "https://cdn.jsdelivr.net/npm";
function Ps(e) {
...
var Fs = null;
function Is(e) {
	return Fs ||= Ps(`${Ns}/@tolgee/web@${e}/dist/${As}`).then(() => window[js][Ms]), Fs;
}
...
function Gs(e, t, r, o = !0) {
	let [s] = a(() => Ws(e)), [c, l] = a(o);
	return n(() => {
		l(!1);
	}, []), i(() => {
...
var Ks = { useSuspense: !1 }, qs, Js = () => (qs ||= e.createContext(void 0), qs), Q = void 0, Ys = ({ tolgee: r, options: i, children: o, fallback: s, ssr: c }) => {
	n(() => {
	...
	l = Gs(r, u, d, !!c);
	let [f, p] = a(!l.isLoaded()), m = Object.assign(Object.assign({}, Ks), i), h = Js();
...
function Vc() {
	return Us().use(Cs()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(Bc.map((e) => [e, () => Promise.resolve(zc(e))]))
	});
}
var $ = Vc().init(), Hc = ({ language: e, staticData: t, children: r }) => {
	let i = o();
	return n(() => {
		let { unsubscribe: e } = $.on("permanentChange", () => {
			i.refresh();
		}), { unsubscribe: t } = $.on("language", ({ value: e }) => {
			document.documentElement.lang = e, i.refresh();
		});
		return () => {
			e(), t();
		};
...
function Gc({ children: e, locale: t, staticData: i }) {
