...
}, _ = Object.defineProperty, v = Object.defineProperties, y = Object.getOwnPropertyDescriptors, b = Object.getOwnPropertySymbols, x = Object.prototype.hasOwnProperty, S = Object.prototype.propertyIsEnumerable, ee = (e, t, n) => t in e ? _(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, C = (e, t) => {
	for (var n in t ||= {}) x.call(t, n) && ee(e, n, t[n]);
	if (b) for (var n of b(t)) S.call(t, n) && ee(e, n, t[n]);
	return e;
}, w = (e, t) => v(e, y(t)), T;
function E(e, t) {
...
function Se(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return te(s.onError, (e) => new ge("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
		if (!l.languageDetector) return;
		let e = n();
		return te(s.onError, (e) => new he("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function C(e) {
		e && l.backends.push(e);
	}
	...
	let E = Object.freeze({
		...
		setStoredLanguage(e) {
			return te(s.onError, (e) => new ge("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
(T = console.assert) == null || T.call(console, Ue), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function We(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
function Vt() {
	...
	if (i && r) return w(C({}, a), { transport: lt() });
}
function Ht() {
	let e = [];
			...
			children: [p("div", {
				...
				children: [
					p("div", { children: [f("h3", {
						...
						children: f($, { keyName: "footer.anOpenSourceTestApplication" })
					})] }),
					p("div", { children: [f("h3", {
						className: "mb-2 text-sm font-semibold text-foreground",
						children: f($, { keyName: "footer.resources" })
					}), f("ul", {
						className: "space-y-1",
					...
					p("div", { children: [f("h3", {
						className: "mb-2 text-sm font-semibold text-foreground",
						children: f($, { keyName: "footer.contact" })
					}), f("p", {
						className: "text-sm text-muted-foreground",
				...
				children: f($, { keyName: "footer.builtWith" })
			})]
		})
	});
}
...
function iu() {
	return Kt().use(ze()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(ru.map((e) => [e, () => Promise.resolve(nu(e))]))
	});
}
var au = iu().init(), ou = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
		let { unsubscribe: e } = au.on("permanentChange", () => {
			r.refresh();
		});
		return () => {
			e();
...
function lu({ children: e, locale: t, staticData: n }) {
