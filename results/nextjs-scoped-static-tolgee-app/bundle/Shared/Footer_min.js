...
import { useParams as u, useRouter as d } from "next/navigation";
import { jsx as f, jsxs as p } from "react/jsx-runtime";
import m from "../i18n/locales/de/route.json";
import h from "../i18n/locales/de/header.json";
import g from "../i18n/locales/de/footer.json";
import _ from "../i18n/locales/de/themeToggle.json";
import v from "../i18n/locales/de/hero.json";
import y from "../i18n/locales/de/whyItMatters.json";
import b from "../i18n/locales/de/understandingImpact.json";
import x from "../i18n/locales/de/resultsTable.json";
import S from "../i18n/locales/de/aboutHeader.json";
import ee from "../i18n/locales/de/aboutGrid.json";
import te from "../i18n/locales/de/whatWeMeasure.json";
import ne from "../i18n/locales/de/blogHeader.json";
import re from "../i18n/locales/de/blogList.json";
import C from "../i18n/locales/de/careersHeader.json";
import ie from "../i18n/locales/de/careersBenefits.json";
import ae from "../i18n/locales/de/openPositions.json";
import oe from "../i18n/locales/de/contactHeader.json";
import se from "../i18n/locales/de/contactForm.json";
import ce from "../i18n/locales/de/faqHeader.json";
import le from "../i18n/locales/de/faqList.json";
import ue from "../i18n/locales/de/pricingHeader.json";
import de from "../i18n/locales/de/pricingTiers.json";
import fe from "../i18n/locales/de/productsHeader.json";
import pe from "../i18n/locales/de/productsGrid.json";
import me from "../i18n/locales/de/settingsHeader.json";
import he from "../i18n/locales/de/profileSection.json";
import ge from "../i18n/locales/de/preferencesSection.json";
import _e from "../i18n/locales/de/apiAccessSection.json";
import ve from "../i18n/locales/de/settingsFooter.json";
import ye from "../i18n/locales/de/teamHeader.json";
import be from "../i18n/locales/de/teamGrid.json";
import xe from "../i18n/locales/de/common.json";
import Se from "../i18n/locales/de/home.json";
import Ce from "../i18n/locales/de/about.json";
import we from "../i18n/locales/de/blog.json";
import Te from "../i18n/locales/de/careers.json";
import Ee from "../i18n/locales/de/contact.json";
import De from "../i18n/locales/de/faq.json";
import Oe from "../i18n/locales/de/pricing.json";
import ke from "../i18n/locales/de/products.json";
import Ae from "../i18n/locales/de/settings.json";
import je from "../i18n/locales/de/team.json";
import Me from "../i18n/locales/es/route.json";
import Ne from "../i18n/locales/es/header.json";
import Pe from "../i18n/locales/es/footer.json";
import Fe from "../i18n/locales/es/themeToggle.json";
import Ie from "../i18n/locales/es/hero.json";
import Le from "../i18n/locales/es/whyItMatters.json";
import Re from "../i18n/locales/es/understandingImpact.json";
import ze from "../i18n/locales/es/resultsTable.json";
import Be from "../i18n/locales/es/aboutHeader.json";
import Ve from "../i18n/locales/es/aboutGrid.json";
import He from "../i18n/locales/es/whatWeMeasure.json";
import Ue from "../i18n/locales/es/blogHeader.json";
import We from "../i18n/locales/es/blogList.json";
import Ge from "../i18n/locales/es/careersHeader.json";
import Ke from "../i18n/locales/es/careersBenefits.json";
import qe from "../i18n/locales/es/openPositions.json";
import Je from "../i18n/locales/es/contactHeader.json";
import Ye from "../i18n/locales/es/contactForm.json";
import Xe from "../i18n/locales/es/faqHeader.json";
import Ze from "../i18n/locales/es/faqList.json";
import Qe from "../i18n/locales/es/pricingHeader.json";
import $e from "../i18n/locales/es/pricingTiers.json";
import et from "../i18n/locales/es/productsHeader.json";
import tt from "../i18n/locales/es/productsGrid.json";
import nt from "../i18n/locales/es/settingsHeader.json";
import rt from "../i18n/locales/es/profileSection.json";
import it from "../i18n/locales/es/preferencesSection.json";
import at from "../i18n/locales/es/apiAccessSection.json";
import ot from "../i18n/locales/es/settingsFooter.json";
import st from "../i18n/locales/es/teamHeader.json";
import ct from "../i18n/locales/es/teamGrid.json";
import lt from "../i18n/locales/es/common.json";
import ut from "../i18n/locales/es/home.json";
import dt from "../i18n/locales/es/about.json";
import ft from "../i18n/locales/es/blog.json";
import pt from "../i18n/locales/es/careers.json";
import mt from "../i18n/locales/es/contact.json";
import ht from "../i18n/locales/es/faq.json";
import gt from "../i18n/locales/es/pricing.json";
import _t from "../i18n/locales/es/products.json";
import vt from "../i18n/locales/es/settings.json";
import yt from "../i18n/locales/es/team.json";
import bt from "../i18n/locales/fr/route.json";
import xt from "../i18n/locales/fr/header.json";
import St from "../i18n/locales/fr/footer.json";
import Ct from "../i18n/locales/fr/themeToggle.json";
import wt from "../i18n/locales/fr/hero.json";
import Tt from "../i18n/locales/fr/whyItMatters.json";
import Et from "../i18n/locales/fr/understandingImpact.json";
import Dt from "../i18n/locales/fr/resultsTable.json";
import Ot from "../i18n/locales/fr/aboutHeader.json";
import kt from "../i18n/locales/fr/aboutGrid.json";
import At from "../i18n/locales/fr/whatWeMeasure.json";
import jt from "../i18n/locales/fr/blogHeader.json";
import Mt from "../i18n/locales/fr/blogList.json";
import Nt from "../i18n/locales/fr/careersHeader.json";
import Pt from "../i18n/locales/fr/careersBenefits.json";
import Ft from "../i18n/locales/fr/openPositions.json";
import It from "../i18n/locales/fr/contactHeader.json";
import Lt from "../i18n/locales/fr/contactForm.json";
import Rt from "../i18n/locales/fr/faqHeader.json";
import zt from "../i18n/locales/fr/faqList.json";
import Bt from "../i18n/locales/fr/pricingHeader.json";
import Vt from "../i18n/locales/fr/pricingTiers.json";
import Ht from "../i18n/locales/fr/productsHeader.json";
import Ut from "../i18n/locales/fr/productsGrid.json";
import Wt from "../i18n/locales/fr/settingsHeader.json";
import Gt from "../i18n/locales/fr/profileSection.json";
import Kt from "../i18n/locales/fr/preferencesSection.json";
import qt from "../i18n/locales/fr/apiAccessSection.json";
import Jt from "../i18n/locales/fr/settingsFooter.json";
import Yt from "../i18n/locales/fr/teamHeader.json";
import Xt from "../i18n/locales/fr/teamGrid.json";
import Zt from "../i18n/locales/fr/common.json";
import Qt from "../i18n/locales/fr/home.json";
import $t from "../i18n/locales/fr/about.json";
import en from "../i18n/locales/fr/blog.json";
import tn from "../i18n/locales/fr/careers.json";
import nn from "../i18n/locales/fr/contact.json";
import rn from "../i18n/locales/fr/faq.json";
import an from "../i18n/locales/fr/pricing.json";
import on from "../i18n/locales/fr/products.json";
import sn from "../i18n/locales/fr/settings.json";
import cn from "../i18n/locales/fr/team.json";
import ln from "../i18n/locales/it/route.json";
import un from "../i18n/locales/it/header.json";
import dn from "../i18n/locales/it/footer.json";
import fn from "../i18n/locales/it/themeToggle.json";
import pn from "../i18n/locales/it/hero.json";
import mn from "../i18n/locales/it/whyItMatters.json";
import hn from "../i18n/locales/it/understandingImpact.json";
import gn from "../i18n/locales/it/resultsTable.json";
import _n from "../i18n/locales/it/aboutHeader.json";
import vn from "../i18n/locales/it/aboutGrid.json";
import yn from "../i18n/locales/it/whatWeMeasure.json";
import bn from "../i18n/locales/it/blogHeader.json";
import xn from "../i18n/locales/it/blogList.json";
import Sn from "../i18n/locales/it/careersHeader.json";
import Cn from "../i18n/locales/it/careersBenefits.json";
import wn from "../i18n/locales/it/openPositions.json";
import Tn from "../i18n/locales/it/contactHeader.json";
import En from "../i18n/locales/it/contactForm.json";
import Dn from "../i18n/locales/it/faqHeader.json";
import On from "../i18n/locales/it/faqList.json";
import kn from "../i18n/locales/it/pricingHeader.json";
import An from "../i18n/locales/it/pricingTiers.json";
import jn from "../i18n/locales/it/productsHeader.json";
import Mn from "../i18n/locales/it/productsGrid.json";
import Nn from "../i18n/locales/it/settingsHeader.json";
import Pn from "../i18n/locales/it/profileSection.json";
import Fn from "../i18n/locales/it/preferencesSection.json";
import In from "../i18n/locales/it/apiAccessSection.json";
import Ln from "../i18n/locales/it/settingsFooter.json";
import Rn from "../i18n/locales/it/teamHeader.json";
import zn from "../i18n/locales/it/teamGrid.json";
import Bn from "../i18n/locales/it/common.json";
import Vn from "../i18n/locales/it/home.json";
import Hn from "../i18n/locales/it/about.json";
import Un from "../i18n/locales/it/blog.json";
import Wn from "../i18n/locales/it/careers.json";
import Gn from "../i18n/locales/it/contact.json";
import Kn from "../i18n/locales/it/faq.json";
import qn from "../i18n/locales/it/pricing.json";
import Jn from "../i18n/locales/it/products.json";
import Yn from "../i18n/locales/it/settings.json";
import Xn from "../i18n/locales/it/team.json";
import Zn from "../i18n/locales/ja/route.json";
import Qn from "../i18n/locales/ja/header.json";
import $n from "../i18n/locales/ja/footer.json";
import er from "../i18n/locales/ja/themeToggle.json";
import tr from "../i18n/locales/ja/hero.json";
import nr from "../i18n/locales/ja/whyItMatters.json";
import rr from "../i18n/locales/ja/understandingImpact.json";
import ir from "../i18n/locales/ja/resultsTable.json";
import ar from "../i18n/locales/ja/aboutHeader.json";
import or from "../i18n/locales/ja/aboutGrid.json";
import sr from "../i18n/locales/ja/whatWeMeasure.json";
import cr from "../i18n/locales/ja/blogHeader.json";
import lr from "../i18n/locales/ja/blogList.json";
import ur from "../i18n/locales/ja/careersHeader.json";
import dr from "../i18n/locales/ja/careersBenefits.json";
import fr from "../i18n/locales/ja/openPositions.json";
import pr from "../i18n/locales/ja/contactHeader.json";
import mr from "../i18n/locales/ja/contactForm.json";
import hr from "../i18n/locales/ja/faqHeader.json";
import gr from "../i18n/locales/ja/faqList.json";
import _r from "../i18n/locales/ja/pricingHeader.json";
import vr from "../i18n/locales/ja/pricingTiers.json";
import yr from "../i18n/locales/ja/productsHeader.json";
import br from "../i18n/locales/ja/productsGrid.json";
import xr from "../i18n/locales/ja/settingsHeader.json";
import Sr from "../i18n/locales/ja/profileSection.json";
import Cr from "../i18n/locales/ja/preferencesSection.json";
import wr from "../i18n/locales/ja/apiAccessSection.json";
import Tr from "../i18n/locales/ja/settingsFooter.json";
import Er from "../i18n/locales/ja/teamHeader.json";
import Dr from "../i18n/locales/ja/teamGrid.json";
...
import hi from "../i18n/locales/ko/home.json";
import gi from "../i18n/locales/ko/about.json";
import _i from "../i18n/locales/ko/blog.json";
import vi from "../i18n/locales/ko/careers.json";
import yi from "../i18n/locales/ko/contact.json";
import bi from "../i18n/locales/ko/faq.json";
import xi from "../i18n/locales/ko/pricing.json";
import Si from "../i18n/locales/ko/products.json";
import Ci from "../i18n/locales/ko/settings.json";
import wi from "../i18n/locales/ko/team.json";
import Ti from "../i18n/locales/pt/route.json";
import Ei from "../i18n/locales/pt/header.json";
import Di from "../i18n/locales/pt/footer.json";
import Oi from "../i18n/locales/pt/themeToggle.json";
import ki from "../i18n/locales/pt/hero.json";
import Ai from "../i18n/locales/pt/whyItMatters.json";
import ji from "../i18n/locales/pt/understandingImpact.json";
import Mi from "../i18n/locales/pt/resultsTable.json";
import Ni from "../i18n/locales/pt/aboutHeader.json";
import Pi from "../i18n/locales/pt/aboutGrid.json";
import Fi from "../i18n/locales/pt/whatWeMeasure.json";
import Ii from "../i18n/locales/pt/blogHeader.json";
import Li from "../i18n/locales/pt/blogList.json";
import Ri from "../i18n/locales/pt/careersHeader.json";
import zi from "../i18n/locales/pt/careersBenefits.json";
import Bi from "../i18n/locales/pt/openPositions.json";
import Vi from "../i18n/locales/pt/contactHeader.json";
import Hi from "../i18n/locales/pt/contactForm.json";
import Ui from "../i18n/locales/pt/faqHeader.json";
import Wi from "../i18n/locales/pt/faqList.json";
import Gi from "../i18n/locales/pt/pricingHeader.json";
import Ki from "../i18n/locales/pt/pricingTiers.json";
import qi from "../i18n/locales/pt/productsHeader.json";
import Ji from "../i18n/locales/pt/productsGrid.json";
import Yi from "../i18n/locales/pt/settingsHeader.json";
import Xi from "../i18n/locales/pt/profileSection.json";
import Zi from "../i18n/locales/pt/preferencesSection.json";
import Qi from "../i18n/locales/pt/apiAccessSection.json";
import $i from "../i18n/locales/pt/settingsFooter.json";
import ea from "../i18n/locales/pt/teamHeader.json";
import ta from "../i18n/locales/pt/teamGrid.json";
import na from "../i18n/locales/pt/common.json";
import ra from "../i18n/locales/pt/home.json";
import ia from "../i18n/locales/pt/about.json";
import aa from "../i18n/locales/pt/blog.json";
import oa from "../i18n/locales/pt/careers.json";
import sa from "../i18n/locales/pt/contact.json";
import ca from "../i18n/locales/pt/faq.json";
import la from "../i18n/locales/pt/pricing.json";
import ua from "../i18n/locales/pt/products.json";
import da from "../i18n/locales/pt/settings.json";
import fa from "../i18n/locales/pt/team.json";
import pa from "../i18n/locales/ru/route.json";
import ma from "../i18n/locales/ru/header.json";
import ha from "../i18n/locales/ru/footer.json";
import ga from "../i18n/locales/ru/themeToggle.json";
import _a from "../i18n/locales/ru/hero.json";
import va from "../i18n/locales/ru/whyItMatters.json";
import ya from "../i18n/locales/ru/understandingImpact.json";
import ba from "../i18n/locales/ru/resultsTable.json";
import xa from "../i18n/locales/ru/aboutHeader.json";
import Sa from "../i18n/locales/ru/aboutGrid.json";
import Ca from "../i18n/locales/ru/whatWeMeasure.json";
import wa from "../i18n/locales/ru/blogHeader.json";
import Ta from "../i18n/locales/ru/blogList.json";
import Ea from "../i18n/locales/ru/careersHeader.json";
import Da from "../i18n/locales/ru/careersBenefits.json";
import Oa from "../i18n/locales/ru/openPositions.json";
import ka from "../i18n/locales/ru/contactHeader.json";
import Aa from "../i18n/locales/ru/contactForm.json";
import ja from "../i18n/locales/ru/faqHeader.json";
import Ma from "../i18n/locales/ru/faqList.json";
import Na from "../i18n/locales/ru/pricingHeader.json";
import Pa from "../i18n/locales/ru/pricingTiers.json";
import Fa from "../i18n/locales/ru/productsHeader.json";
import Ia from "../i18n/locales/ru/productsGrid.json";
import La from "../i18n/locales/ru/settingsHeader.json";
import Ra from "../i18n/locales/ru/profileSection.json";
import za from "../i18n/locales/ru/preferencesSection.json";
import Ba from "../i18n/locales/ru/apiAccessSection.json";
import Va from "../i18n/locales/ru/settingsFooter.json";
import Ha from "../i18n/locales/ru/teamHeader.json";
import Ua from "../i18n/locales/ru/teamGrid.json";
import Wa from "../i18n/locales/ru/common.json";
import Ga from "../i18n/locales/ru/home.json";
import Ka from "../i18n/locales/ru/about.json";
import qa from "../i18n/locales/ru/blog.json";
import Ja from "../i18n/locales/ru/careers.json";
import Ya from "../i18n/locales/ru/contact.json";
import Xa from "../i18n/locales/ru/faq.json";
import Za from "../i18n/locales/ru/pricing.json";
import Qa from "../i18n/locales/ru/products.json";
import $a from "../i18n/locales/ru/settings.json";
import eo from "../i18n/locales/ru/team.json";
import to from "../i18n/locales/zh/route.json";
import no from "../i18n/locales/zh/header.json";
import ro from "../i18n/locales/zh/footer.json";
import io from "../i18n/locales/zh/themeToggle.json";
import ao from "../i18n/locales/zh/hero.json";
import oo from "../i18n/locales/zh/whyItMatters.json";
import so from "../i18n/locales/zh/understandingImpact.json";
import co from "../i18n/locales/zh/resultsTable.json";
import lo from "../i18n/locales/zh/aboutHeader.json";
import uo from "../i18n/locales/zh/aboutGrid.json";
import fo from "../i18n/locales/zh/whatWeMeasure.json";
import po from "../i18n/locales/zh/blogHeader.json";
import mo from "../i18n/locales/zh/blogList.json";
import ho from "../i18n/locales/zh/careersHeader.json";
import go from "../i18n/locales/zh/careersBenefits.json";
import _o from "../i18n/locales/zh/openPositions.json";
import vo from "../i18n/locales/zh/contactHeader.json";
import yo from "../i18n/locales/zh/contactForm.json";
import bo from "../i18n/locales/zh/faqHeader.json";
import xo from "../i18n/locales/zh/faqList.json";
import So from "../i18n/locales/zh/pricingHeader.json";
import Co from "../i18n/locales/zh/pricingTiers.json";
import wo from "../i18n/locales/zh/productsHeader.json";
import To from "../i18n/locales/zh/productsGrid.json";
import Eo from "../i18n/locales/zh/settingsHeader.json";
import Do from "../i18n/locales/zh/profileSection.json";
import Oo from "../i18n/locales/zh/preferencesSection.json";
import ko from "../i18n/locales/zh/apiAccessSection.json";
import Ao from "../i18n/locales/zh/settingsFooter.json";
import jo from "../i18n/locales/zh/teamHeader.json";
import Mo from "../i18n/locales/zh/teamGrid.json";
import No from "../i18n/locales/zh/common.json";
import Po from "../i18n/locales/zh/home.json";
import Fo from "../i18n/locales/zh/about.json";
import Io from "../i18n/locales/zh/blog.json";
import Lo from "../i18n/locales/zh/careers.json";
import Ro from "../i18n/locales/zh/contact.json";
import zo from "../i18n/locales/zh/faq.json";
import Bo from "../i18n/locales/zh/pricing.json";
import Vo from "../i18n/locales/zh/products.json";
import Ho from "../i18n/locales/zh/settings.json";
import Uo from "../i18n/locales/zh/team.json";
var Wo = (e) => /^https?:\/\//.test(e ?? "");
function Go(e, t) {
	return !e.startsWith("/") || e === `/${t}` || e.startsWith(`/${t}/`) ? e : `/${t}${e === "/" ? "" : e}`;
}
var Ko = ({ href: e, children: t, ...n }) => {
	let r = u().locale ?? "en";
	return e == null || typeof e != "string" || Wo(e) ? f(l, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, qo = Object.defineProperty, Jo = Object.getOwnPropertySymbols, Yo = Object.prototype.hasOwnProperty, Xo = Object.prototype.propertyIsEnumerable, Zo = (e, t, n) => t in e ? qo(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Qo = (e, t) => {
	for (var n in t ||= {}) Yo.call(t, n) && Zo(e, n, t[n]);
	if (Jo) for (var n of Jo(t)) Xo.call(t, n) && Zo(e, n, t[n]);
	return e;
}, $o;
function es(e, t) {
...
function gs(e, t) {
	let n = B(hs, t?.initialOptions, e);
	return n.apiUrl = is(n.apiUrl), e?.fetch && (n.fetch = cs(e.fetch)), {
		initialOptions: n,
...
function _s(e, t, n, r, i, a, o, s) {
	...
	function ee() {
		...
		let e = n();
		return O(s.onError, (e) => new ds("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let C = Object.freeze({
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = ps(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = as(e) || z, r = t().onFormatError, a = typeof r;
...
function ys(e, t, n) {
	let r = gs(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? j([t, ...rs(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
		...
		overrideCredentials(e) {
			i = e ? Object.assign(Object.assign({}, e), { apiUrl: is(e.apiUrl) }) : void 0;
		}
	});
	return a;
}
function bs(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = ps(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
var V = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, bs(r)), n)), n;
};
function xs({ options: e }) {
	let t = us(), n = vs(!1, () => o.isFetching(), t.onFetchingChange.emit), r = vs(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ys(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = _s(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = fs(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Cs = () => {
	let e = {
		...
		init(t) {
			let n = Ss(B(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, ws = 0, H = 1, Ts = 2, Es = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === ws ? r = "Empty parameter" : e === H ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Ds(e) {
	return /\s/.test(e);
}
var U = 0, W = 1, G = 2, K = 3, q = 4, Os = new Set([
	G,
	W,
	U
]), J = "'", ks = new Set([
...
function js(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case U:
			...
			break;
		case W:
			ks.has(i) ? (n = n.slice(0, -1) + i, t = G) : (n += i, t = U);
			break;
		case G:
			i === J ? t = U : (n += i, t = G);
			break;
		case K:
			i === "}" ? (d(), t = U) : Ds(i) ? r !== "" && (d(), t = q) : (u(), t = K);
			break;
		case q: i == "}" ? t = U : Ds(i) ? t = q : c(H);
	}
	return Os.has(t) || c(Ts), l(), [a, o];
}
function Ms(e, t) {
	let [n, r] = js(e), i = [n[0]];
...
function Ns() {
	return { format: ({ translation: e, params: t }) => Ms(e, t) };
}
var Ps = () => (e, t) => (t.setFinalFormatter(Ns()), e), Fs = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Is = {};
(function(e) {
	function t(e, t) {
		var n;
...
})(typeof window < "u" ? window : Fs);
var Ls = es({
	__proto__: null,
	default: Is
}, [Is]);
($o = console.assert) == null || $o.call(console, Ls), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Rs(e, t) {
	let n = (n) => {
...
function zs({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var Vs = "tolgee-in-context-tools.umd.min.js", Hs = "@tolgee/in-context-tools", Us = "InContextTools", Ws = "https://cdn.jsdelivr.net/npm";
function Gs(e) {
...
var Ks = null;
function qs(e) {
	return Ks ||= Gs(`${Ws}/@tolgee/web@${e}/dist/${Vs}`).then(() => window[Hs][Us]), Ks;
}
var Js = "__tolgee_apiKey", Ys = "__tolgee_apiUrl", Xs = "__tolgee_branch";
function Zs() {
	let e = sessionStorage.getItem(Js) || void 0, t = sessionStorage.getItem(Ys) || void 0, n = sessionStorage.getItem(Xs) || void 0;
	if (!(!e || !t)) return Qo({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Qs() {
	sessionStorage.removeItem(Js), sessionStorage.removeItem(Ys), sessionStorage.removeItem(Xs);
}
function $s(e) {
...
var ic = { useSuspense: !1 }, ac, oc = () => (ac ||= e.createContext(void 0), ac), Y = void 0, sc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = rc(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, ic), r), h = oc();
...
var uc = () => {
	...
	let { tolgee: r, options: a } = uc(), o = ns(e), c = A(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = dc(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var Z = (t) => {
	let n = pc(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, hc(t))) : hc(n);
}, gc = (t) => {
	...
	let { t: n } = X();
	return e.createElement(gc, Object.assign({ t: n }, t));
};
function vc() {
	let { t: e, ...t } = fc();
	return {
...
function yc() {
	let { t: e } = vc(), t = [
		{
			label: e("footer.github", "GitHub"),
			href: "https://github.com/intlayer-org/benchmark-i18n",
			isInternal: !1
		},
		{
			label: e("footer.methodology", "Methodology"),
			href: "/about",
			isInternal: !0
		},
		{
			label: e("footer.contributing", "Contributing"),
			href: "/contact",
			isInternal: !0
		}
	];
			...
			children: [p("div", {
				...
				children: [
					...
					p("div", { children: [f("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => f("li", { children: e.isInternal ? f(Ko, {
							href: e.href,
...
function dl() {
	return tc().use(Ps()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(ul.map((e) => [e, () => Promise.resolve(ll(e))]))
	});
}
var $ = dl().init(), fl = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
...
function hl({ children: e, locale: t, staticData: n }) {
