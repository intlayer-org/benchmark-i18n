...
import g from "../i18n/locales/de/route.json";
import _ from "../i18n/locales/de/header.json";
import v from "../i18n/locales/de/footer.json";
import y from "../i18n/locales/de/themeToggle.json";
import b from "../i18n/locales/de/hero.json";
import x from "../i18n/locales/de/whyItMatters.json";
import S from "../i18n/locales/de/understandingImpact.json";
import ee from "../i18n/locales/de/resultsTable.json";
import te from "../i18n/locales/de/aboutHeader.json";
import ne from "../i18n/locales/de/aboutGrid.json";
import re from "../i18n/locales/de/whatWeMeasure.json";
import C from "../i18n/locales/de/blogHeader.json";
import ie from "../i18n/locales/de/blogList.json";
import ae from "../i18n/locales/de/careersHeader.json";
import oe from "../i18n/locales/de/careersBenefits.json";
import se from "../i18n/locales/de/openPositions.json";
import ce from "../i18n/locales/de/contactHeader.json";
import le from "../i18n/locales/de/contactForm.json";
import ue from "../i18n/locales/de/faqHeader.json";
import de from "../i18n/locales/de/faqList.json";
import fe from "../i18n/locales/de/pricingHeader.json";
import pe from "../i18n/locales/de/pricingTiers.json";
import me from "../i18n/locales/de/productsHeader.json";
import he from "../i18n/locales/de/productsGrid.json";
import ge from "../i18n/locales/de/settingsHeader.json";
import _e from "../i18n/locales/de/profileSection.json";
import ve from "../i18n/locales/de/preferencesSection.json";
import ye from "../i18n/locales/de/apiAccessSection.json";
import be from "../i18n/locales/de/settingsFooter.json";
import xe from "../i18n/locales/de/teamHeader.json";
import Se from "../i18n/locales/de/teamGrid.json";
import Ce from "../i18n/locales/de/common.json";
import we from "../i18n/locales/de/home.json";
import Te from "../i18n/locales/de/about.json";
import Ee from "../i18n/locales/de/blog.json";
import De from "../i18n/locales/de/careers.json";
import Oe from "../i18n/locales/de/contact.json";
import ke from "../i18n/locales/de/faq.json";
import Ae from "../i18n/locales/de/pricing.json";
import je from "../i18n/locales/de/products.json";
import Me from "../i18n/locales/de/settings.json";
import Ne from "../i18n/locales/de/team.json";
import Pe from "../i18n/locales/es/route.json";
import Fe from "../i18n/locales/es/header.json";
import Ie from "../i18n/locales/es/footer.json";
import Le from "../i18n/locales/es/themeToggle.json";
import Re from "../i18n/locales/es/hero.json";
import ze from "../i18n/locales/es/whyItMatters.json";
import Be from "../i18n/locales/es/understandingImpact.json";
import Ve from "../i18n/locales/es/resultsTable.json";
import He from "../i18n/locales/es/aboutHeader.json";
import Ue from "../i18n/locales/es/aboutGrid.json";
import We from "../i18n/locales/es/whatWeMeasure.json";
import Ge from "../i18n/locales/es/blogHeader.json";
import Ke from "../i18n/locales/es/blogList.json";
import qe from "../i18n/locales/es/careersHeader.json";
import Je from "../i18n/locales/es/careersBenefits.json";
import Ye from "../i18n/locales/es/openPositions.json";
import Xe from "../i18n/locales/es/contactHeader.json";
import Ze from "../i18n/locales/es/contactForm.json";
import Qe from "../i18n/locales/es/faqHeader.json";
import $e from "../i18n/locales/es/faqList.json";
import et from "../i18n/locales/es/pricingHeader.json";
import tt from "../i18n/locales/es/pricingTiers.json";
import nt from "../i18n/locales/es/productsHeader.json";
import rt from "../i18n/locales/es/productsGrid.json";
import it from "../i18n/locales/es/settingsHeader.json";
import at from "../i18n/locales/es/profileSection.json";
import ot from "../i18n/locales/es/preferencesSection.json";
import st from "../i18n/locales/es/apiAccessSection.json";
import ct from "../i18n/locales/es/settingsFooter.json";
import lt from "../i18n/locales/es/teamHeader.json";
import ut from "../i18n/locales/es/teamGrid.json";
import dt from "../i18n/locales/es/common.json";
...
var Jo = (e) => /^https?:\/\//.test(e ?? "");
function w(e, t) {
	return !e.startsWith("/") || e === `/${t}` || e.startsWith(`/${t}/`) ? e : `/${t}${e === "/" ? "" : e}`;
}
var T = ({ href: e, children: t, ...n }) => {
	let r = u().locale ?? "en";
	return e == null || typeof e != "string" || Jo(e) ? p(l, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, Yo = Object.defineProperty, Xo = Object.getOwnPropertySymbols, Zo = Object.prototype.hasOwnProperty, Qo = Object.prototype.propertyIsEnumerable, $o = (e, t, n) => t in e ? Yo(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function ys(e, t) {
	let n = z(vs, t?.initialOptions, e);
	return n.apiUrl = os(n.apiUrl), e?.fetch && (n.fetch = us(e.fetch)), {
		initialOptions: n,
...
function bs(e, t, n, r, i, a, o, s) {
	...
	function ee() {
		...
		let e = n();
		return O(s.onError, (e) => new ms("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let C = Object.freeze({
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = gs(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = ss(e) || R, r = t().onFormatError, a = typeof r;
...
function Ss(e, t, n) {
	let r = ys(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? j([t, ...as(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
		...
		overrideCredentials(e) {
			i = e ? Object.assign(Object.assign({}, e), { apiUrl: os(e.apiUrl) }) : void 0;
		}
	});
	return a;
}
function Cs(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = gs(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
function ws({ options: e }) {
	let t = fs(), n = xs(!1, () => o.isFetching(), t.onFetchingChange.emit), r = xs(!1, () => S.isLoading(), t.onLoadingChange.emit), i = Ss(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = bs(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = hs(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Es = () => {
	let e = {
		...
		init(t) {
			let n = Ts(z(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, Ds = 0, V = 1, Os = 2, ks = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Ds ? r = "Empty parameter" : e === V ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function As(e) {
	return /\s/.test(e);
}
var H = 0, U = 1, W = 2, G = 3, K = 4, js = new Set([
	W,
	U,
	H
]), q = "'", Ms = new Set([
...
function Ps(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case H:
			...
			break;
		case U:
			Ms.has(i) ? (n = n.slice(0, -1) + i, t = W) : (n += i, t = H);
			break;
		case W:
			i === q ? t = H : (n += i, t = W);
			break;
		case G:
			i === "}" ? (d(), t = H) : As(i) ? r !== "" && (d(), t = K) : (u(), t = G);
			break;
		case K: i == "}" ? t = H : As(i) ? t = K : c(V);
	}
	return js.has(t) || c(Os), l(), [a, o];
}
function Fs(e, t) {
	let [n, r] = Ps(e), i = [n[0]];
...
function Is() {
	return { format: ({ translation: e, params: t }) => Fs(e, t) };
}
var Ls = () => (e, t) => (t.setFinalFormatter(Is()), e), Rs = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, zs = {};
(function(e) {
	function t(e, t) {
		var n;
...
(ts = console.assert) == null || ts.call(console, Bs), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Vs(e, t) {
	let n = (n) => {
...
function Hs({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var Ws = "tolgee-in-context-tools.umd.min.js", Gs = "@tolgee/in-context-tools", Ks = "InContextTools", qs = "https://cdn.jsdelivr.net/npm";
function Js(e) {
...
var Ys = null;
function Xs(e) {
	return Ys ||= Js(`${qs}/@tolgee/web@${e}/dist/${Ws}`).then(() => window[Gs][Ks]), Ys;
}
var Zs = "__tolgee_apiKey", Qs = "__tolgee_apiUrl", $s = "__tolgee_branch";
function ec() {
	let e = sessionStorage.getItem(Zs) || void 0, t = sessionStorage.getItem(Qs) || void 0, n = sessionStorage.getItem($s) || void 0;
	if (!(!e || !t)) return es({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function tc() {
	sessionStorage.removeItem(Zs), sessionStorage.removeItem(Qs), sessionStorage.removeItem($s);
}
function nc(e) {
...
var sc = { useSuspense: !1 }, cc, lc = () => (cc ||= e.createContext(void 0), cc), J = void 0, uc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = oc(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, sc), r), h = lc();
...
var pc = () => {
	...
	let { tolgee: r, options: a } = pc(), o = is(e), c = A(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = mc(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var Y = (t) => {
	let n = _c(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, yc(t))) : yc(n);
}, bc = (t) => {
	...
	let { t: n } = hc();
	return e.createElement(bc, Object.assign({ t: n }, t));
};
function Sc() {
	let { t: e, ...t } = gc();
	return {
			...
			children: [m("div", {
				...
				children: [p(T, {
					...
					children: [
						p(T, {
							href: "/",
							className: `nav-link${((e) => r === w(e, i))("/") ? " is-active" : ""}`,
							children: p(X, {
								keyName: "header.home",
								defaultValue: "Home"
							})
...
function bl() {
	return ic().use(Ls()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(yl.map((e) => [e, () => Promise.resolve(Q(e))]))
	});
}
var $ = bl().init(), xl = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
...
function wl({ children: e, locale: t, staticData: n }) {
