...
var Ro = (e) => /^https?:\/\//.test(e ?? "");
function zo(e, t) {
	return !e.startsWith("/") || e === `/${t}` || e.startsWith(`/${t}/`) ? e : `/${t}${e === "/" ? "" : e}`;
}
var Bo = ({ href: e, children: t, ...n }) => {
	let r = s().locale ?? "en";
	return e == null || typeof e != "string" || Ro(e) ? l(o, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, Vo = Object.defineProperty, Ho = Object.getOwnPropertySymbols, Uo = Object.prototype.hasOwnProperty, Wo = Object.prototype.propertyIsEnumerable, Go = (e, t, n) => t in e ? Vo(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function us(e, t, n, r, i, a, o, s) {
	...
	function ee() {
		...
		let e = n();
		return A(s.onError, (e) => new is("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let T = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = $o(e) || H, r = t().onFormatError, a = typeof r;
...
var _s = () => {
	let e = {
		...
		init(t) {
			let n = gs(U(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, vs = 0, W = 1, ys = 2, bs = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === vs ? r = "Empty parameter" : e === W ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function xs(e) {
	return /\s/.test(e);
}
var G = 0, K = 1, q = 2, J = 3, Y = 4, Ss = new Set([
	q,
	K,
	G
]), X = "'", Cs = new Set([
...
function Ts(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case G:
			...
			break;
		case K:
			Cs.has(i) ? (n = n.slice(0, -1) + i, t = q) : (n += i, t = G);
			break;
		case q:
			i === X ? t = G : (n += i, t = q);
			break;
		case J:
			i === "}" ? (d(), t = G) : xs(i) ? r !== "" && (d(), t = Y) : (u(), t = J);
			break;
		case Y: i == "}" ? t = G : xs(i) ? t = Y : c(W);
	}
...
var Z = null;
function Bs(e) {
	return Z ||= zs(`${Rs}/@tolgee/web@${e}/dist/${Fs}`).then(() => window[Is][Ls]), Z;
}
...
var Zs = { useSuspense: !1 }, Qs, $s = () => (Qs ||= e.createContext(void 0), Qs), Q = void 0, ec = ({ tolgee: r, options: i, children: o, fallback: s, ssr: c }) => {
	n(() => {
...
function Kc() {
	return Js().use(Os()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(Gc.map((e) => [e, () => Promise.resolve(Wc(e))]))
	});
}
var $ = Kc().init(), qc = ({ language: e, staticData: t, children: r }) => {
	let i = c();
	return n(() => {
...
function Xc({ children: e, locale: t, staticData: i }) {
