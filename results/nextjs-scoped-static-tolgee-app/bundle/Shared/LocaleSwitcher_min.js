...
function _e(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return T(s.onError, (e) => new F("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
	...
	let D = Object.freeze({
		...
		setStoredLanguage(e) {
			return T(s.onError, (e) => new F("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function Se({ options: e }) {
	let t = ue(), n = ve(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ve(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ye(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = _e(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = pe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
function Vl() {
	return Ht().use(Fe()).updateDefaults({
		...
		staticData: Object.fromEntries(Bl.map((e) => [e, () => Promise.resolve(zl(e))]))
	});
}
var Hl = Vl().init(), Ul = ({ language: e, staticData: t, children: r }) => {
	let i = c();
	return n(() => {
		let { unsubscribe: e } = Hl.on("permanentChange", () => {
			i.refresh();
		});
		return () => {
			e();
...
function Kl({ children: e, locale: t, staticData: i }) {
