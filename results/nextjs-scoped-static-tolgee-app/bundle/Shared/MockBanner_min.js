...
import d from "../i18n/locales/de/route.json";
import f from "../i18n/locales/de/header.json";
import p from "../i18n/locales/de/footer.json";
import m from "../i18n/locales/de/themeToggle.json";
import h from "../i18n/locales/de/hero.json";
import g from "../i18n/locales/de/whyItMatters.json";
import _ from "../i18n/locales/de/understandingImpact.json";
import v from "../i18n/locales/de/resultsTable.json";
import y from "../i18n/locales/de/aboutHeader.json";
import b from "../i18n/locales/de/aboutGrid.json";
import x from "../i18n/locales/de/whatWeMeasure.json";
import S from "../i18n/locales/de/blogHeader.json";
import ee from "../i18n/locales/de/blogList.json";
import te from "../i18n/locales/de/careersHeader.json";
import ne from "../i18n/locales/de/careersBenefits.json";
import re from "../i18n/locales/de/openPositions.json";
import C from "../i18n/locales/de/contactHeader.json";
import ie from "../i18n/locales/de/contactForm.json";
import ae from "../i18n/locales/de/faqHeader.json";
import oe from "../i18n/locales/de/faqList.json";
import se from "../i18n/locales/de/pricingHeader.json";
import ce from "../i18n/locales/de/pricingTiers.json";
import le from "../i18n/locales/de/productsHeader.json";
import ue from "../i18n/locales/de/productsGrid.json";
import de from "../i18n/locales/de/settingsHeader.json";
import fe from "../i18n/locales/de/profileSection.json";
import pe from "../i18n/locales/de/preferencesSection.json";
import me from "../i18n/locales/de/apiAccessSection.json";
import he from "../i18n/locales/de/settingsFooter.json";
import ge from "../i18n/locales/de/teamHeader.json";
import _e from "../i18n/locales/de/teamGrid.json";
import ve from "../i18n/locales/de/common.json";
import ye from "../i18n/locales/de/home.json";
import be from "../i18n/locales/de/about.json";
import xe from "../i18n/locales/de/blog.json";
import Se from "../i18n/locales/de/careers.json";
import Ce from "../i18n/locales/de/contact.json";
import we from "../i18n/locales/de/faq.json";
import Te from "../i18n/locales/de/pricing.json";
import Ee from "../i18n/locales/de/products.json";
import De from "../i18n/locales/de/settings.json";
import Oe from "../i18n/locales/de/team.json";
import ke from "../i18n/locales/es/route.json";
import Ae from "../i18n/locales/es/header.json";
import je from "../i18n/locales/es/footer.json";
import Me from "../i18n/locales/es/themeToggle.json";
import Ne from "../i18n/locales/es/hero.json";
import Pe from "../i18n/locales/es/whyItMatters.json";
import Fe from "../i18n/locales/es/understandingImpact.json";
import Ie from "../i18n/locales/es/resultsTable.json";
import Le from "../i18n/locales/es/aboutHeader.json";
import Re from "../i18n/locales/es/aboutGrid.json";
import ze from "../i18n/locales/es/whatWeMeasure.json";
import Be from "../i18n/locales/es/blogHeader.json";
import Ve from "../i18n/locales/es/blogList.json";
import He from "../i18n/locales/es/careersHeader.json";
import Ue from "../i18n/locales/es/careersBenefits.json";
import We from "../i18n/locales/es/openPositions.json";
import Ge from "../i18n/locales/es/contactHeader.json";
import Ke from "../i18n/locales/es/contactForm.json";
import qe from "../i18n/locales/es/faqHeader.json";
import Je from "../i18n/locales/es/faqList.json";
import Ye from "../i18n/locales/es/pricingHeader.json";
import Xe from "../i18n/locales/es/pricingTiers.json";
import Ze from "../i18n/locales/es/productsHeader.json";
import Qe from "../i18n/locales/es/productsGrid.json";
import $e from "../i18n/locales/es/settingsHeader.json";
import et from "../i18n/locales/es/profileSection.json";
import tt from "../i18n/locales/es/preferencesSection.json";
import nt from "../i18n/locales/es/apiAccessSection.json";
import rt from "../i18n/locales/es/settingsFooter.json";
import it from "../i18n/locales/es/teamHeader.json";
import at from "../i18n/locales/es/teamGrid.json";
import ot from "../i18n/locales/es/common.json";
import st from "../i18n/locales/es/home.json";
import ct from "../i18n/locales/es/about.json";
import lt from "../i18n/locales/es/blog.json";
import ut from "../i18n/locales/es/careers.json";
import dt from "../i18n/locales/es/contact.json";
import ft from "../i18n/locales/es/faq.json";
import pt from "../i18n/locales/es/pricing.json";
import mt from "../i18n/locales/es/products.json";
import ht from "../i18n/locales/es/settings.json";
import gt from "../i18n/locales/es/team.json";
import _t from "../i18n/locales/fr/route.json";
import vt from "../i18n/locales/fr/header.json";
import yt from "../i18n/locales/fr/footer.json";
import bt from "../i18n/locales/fr/themeToggle.json";
import xt from "../i18n/locales/fr/hero.json";
import St from "../i18n/locales/fr/whyItMatters.json";
import Ct from "../i18n/locales/fr/understandingImpact.json";
import wt from "../i18n/locales/fr/resultsTable.json";
import Tt from "../i18n/locales/fr/aboutHeader.json";
import Et from "../i18n/locales/fr/aboutGrid.json";
import Dt from "../i18n/locales/fr/whatWeMeasure.json";
import Ot from "../i18n/locales/fr/blogHeader.json";
import kt from "../i18n/locales/fr/blogList.json";
import At from "../i18n/locales/fr/careersHeader.json";
import jt from "../i18n/locales/fr/careersBenefits.json";
import Mt from "../i18n/locales/fr/openPositions.json";
import Nt from "../i18n/locales/fr/contactHeader.json";
import Pt from "../i18n/locales/fr/contactForm.json";
import Ft from "../i18n/locales/fr/faqHeader.json";
import It from "../i18n/locales/fr/faqList.json";
import Lt from "../i18n/locales/fr/pricingHeader.json";
import Rt from "../i18n/locales/fr/pricingTiers.json";
import zt from "../i18n/locales/fr/productsHeader.json";
import Bt from "../i18n/locales/fr/productsGrid.json";
import Vt from "../i18n/locales/fr/settingsHeader.json";
import Ht from "../i18n/locales/fr/profileSection.json";
import Ut from "../i18n/locales/fr/preferencesSection.json";
import Wt from "../i18n/locales/fr/apiAccessSection.json";
import Gt from "../i18n/locales/fr/settingsFooter.json";
import Kt from "../i18n/locales/fr/teamHeader.json";
import qt from "../i18n/locales/fr/teamGrid.json";
import Jt from "../i18n/locales/fr/common.json";
import Yt from "../i18n/locales/fr/home.json";
import Xt from "../i18n/locales/fr/about.json";
import Zt from "../i18n/locales/fr/blog.json";
import Qt from "../i18n/locales/fr/careers.json";
import $t from "../i18n/locales/fr/contact.json";
import en from "../i18n/locales/fr/faq.json";
import tn from "../i18n/locales/fr/pricing.json";
import nn from "../i18n/locales/fr/products.json";
import rn from "../i18n/locales/fr/settings.json";
import an from "../i18n/locales/fr/team.json";
import on from "../i18n/locales/it/route.json";
import sn from "../i18n/locales/it/header.json";
import cn from "../i18n/locales/it/footer.json";
import ln from "../i18n/locales/it/themeToggle.json";
import un from "../i18n/locales/it/hero.json";
import dn from "../i18n/locales/it/whyItMatters.json";
import fn from "../i18n/locales/it/understandingImpact.json";
import pn from "../i18n/locales/it/resultsTable.json";
import mn from "../i18n/locales/it/aboutHeader.json";
import hn from "../i18n/locales/it/aboutGrid.json";
import gn from "../i18n/locales/it/whatWeMeasure.json";
import _n from "../i18n/locales/it/blogHeader.json";
import vn from "../i18n/locales/it/blogList.json";
import yn from "../i18n/locales/it/careersHeader.json";
import bn from "../i18n/locales/it/careersBenefits.json";
import xn from "../i18n/locales/it/openPositions.json";
import Sn from "../i18n/locales/it/contactHeader.json";
import Cn from "../i18n/locales/it/contactForm.json";
import wn from "../i18n/locales/it/faqHeader.json";
import Tn from "../i18n/locales/it/faqList.json";
import En from "../i18n/locales/it/pricingHeader.json";
import Dn from "../i18n/locales/it/pricingTiers.json";
import On from "../i18n/locales/it/productsHeader.json";
import kn from "../i18n/locales/it/productsGrid.json";
import An from "../i18n/locales/it/settingsHeader.json";
import jn from "../i18n/locales/it/profileSection.json";
import Mn from "../i18n/locales/it/preferencesSection.json";
import Nn from "../i18n/locales/it/apiAccessSection.json";
import Pn from "../i18n/locales/it/settingsFooter.json";
import Fn from "../i18n/locales/it/teamHeader.json";
import In from "../i18n/locales/it/teamGrid.json";
import w from "../i18n/locales/it/common.json";
import Ln from "../i18n/locales/it/home.json";
import Rn from "../i18n/locales/it/about.json";
import zn from "../i18n/locales/it/blog.json";
import Bn from "../i18n/locales/it/careers.json";
import Vn from "../i18n/locales/it/contact.json";
import Hn from "../i18n/locales/it/faq.json";
import Un from "../i18n/locales/it/pricing.json";
import Wn from "../i18n/locales/it/products.json";
import Gn from "../i18n/locales/it/settings.json";
import Kn from "../i18n/locales/it/team.json";
import qn from "../i18n/locales/ja/route.json";
import Jn from "../i18n/locales/ja/header.json";
import Yn from "../i18n/locales/ja/footer.json";
import Xn from "../i18n/locales/ja/themeToggle.json";
import Zn from "../i18n/locales/ja/hero.json";
import Qn from "../i18n/locales/ja/whyItMatters.json";
import $n from "../i18n/locales/ja/understandingImpact.json";
import er from "../i18n/locales/ja/resultsTable.json";
import tr from "../i18n/locales/ja/aboutHeader.json";
import nr from "../i18n/locales/ja/aboutGrid.json";
import rr from "../i18n/locales/ja/whatWeMeasure.json";
import ir from "../i18n/locales/ja/blogHeader.json";
import ar from "../i18n/locales/ja/blogList.json";
import or from "../i18n/locales/ja/careersHeader.json";
import sr from "../i18n/locales/ja/careersBenefits.json";
import cr from "../i18n/locales/ja/openPositions.json";
import lr from "../i18n/locales/ja/contactHeader.json";
import ur from "../i18n/locales/ja/contactForm.json";
import dr from "../i18n/locales/ja/faqHeader.json";
import fr from "../i18n/locales/ja/faqList.json";
import pr from "../i18n/locales/ja/pricingHeader.json";
import mr from "../i18n/locales/ja/pricingTiers.json";
import hr from "../i18n/locales/ja/productsHeader.json";
import gr from "../i18n/locales/ja/productsGrid.json";
import _r from "../i18n/locales/ja/settingsHeader.json";
import vr from "../i18n/locales/ja/profileSection.json";
import yr from "../i18n/locales/ja/preferencesSection.json";
import br from "../i18n/locales/ja/apiAccessSection.json";
import xr from "../i18n/locales/ja/settingsFooter.json";
import Sr from "../i18n/locales/ja/teamHeader.json";
import Cr from "../i18n/locales/ja/teamGrid.json";
import T from "../i18n/locales/ja/common.json";
import wr from "../i18n/locales/ja/home.json";
import Tr from "../i18n/locales/ja/about.json";
import Er from "../i18n/locales/ja/blog.json";
import Dr from "../i18n/locales/ja/careers.json";
import Or from "../i18n/locales/ja/contact.json";
import kr from "../i18n/locales/ja/faq.json";
import Ar from "../i18n/locales/ja/pricing.json";
import jr from "../i18n/locales/ja/products.json";
import Mr from "../i18n/locales/ja/settings.json";
import Nr from "../i18n/locales/ja/team.json";
import Pr from "../i18n/locales/ko/route.json";
import Fr from "../i18n/locales/ko/header.json";
import Ir from "../i18n/locales/ko/footer.json";
import Lr from "../i18n/locales/ko/themeToggle.json";
import Rr from "../i18n/locales/ko/hero.json";
import zr from "../i18n/locales/ko/whyItMatters.json";
import Br from "../i18n/locales/ko/understandingImpact.json";
import Vr from "../i18n/locales/ko/resultsTable.json";
import Hr from "../i18n/locales/ko/aboutHeader.json";
import Ur from "../i18n/locales/ko/aboutGrid.json";
import Wr from "../i18n/locales/ko/whatWeMeasure.json";
import Gr from "../i18n/locales/ko/blogHeader.json";
import Kr from "../i18n/locales/ko/blogList.json";
import qr from "../i18n/locales/ko/careersHeader.json";
import Jr from "../i18n/locales/ko/careersBenefits.json";
import Yr from "../i18n/locales/ko/openPositions.json";
import Xr from "../i18n/locales/ko/contactHeader.json";
import Zr from "../i18n/locales/ko/contactForm.json";
import Qr from "../i18n/locales/ko/faqHeader.json";
import $r from "../i18n/locales/ko/faqList.json";
import ei from "../i18n/locales/ko/pricingHeader.json";
import ti from "../i18n/locales/ko/pricingTiers.json";
import ni from "../i18n/locales/ko/productsHeader.json";
import ri from "../i18n/locales/ko/productsGrid.json";
import ii from "../i18n/locales/ko/settingsHeader.json";
import ai from "../i18n/locales/ko/profileSection.json";
import oi from "../i18n/locales/ko/preferencesSection.json";
import si from "../i18n/locales/ko/apiAccessSection.json";
import ci from "../i18n/locales/ko/settingsFooter.json";
import li from "../i18n/locales/ko/teamHeader.json";
import ui from "../i18n/locales/ko/teamGrid.json";
import E from "../i18n/locales/ko/common.json";
import di from "../i18n/locales/ko/home.json";
import fi from "../i18n/locales/ko/about.json";
import pi from "../i18n/locales/ko/blog.json";
import mi from "../i18n/locales/ko/careers.json";
import hi from "../i18n/locales/ko/contact.json";
import gi from "../i18n/locales/ko/faq.json";
import _i from "../i18n/locales/ko/pricing.json";
import vi from "../i18n/locales/ko/products.json";
import yi from "../i18n/locales/ko/settings.json";
import bi from "../i18n/locales/ko/team.json";
import xi from "../i18n/locales/pt/route.json";
import Si from "../i18n/locales/pt/header.json";
import Ci from "../i18n/locales/pt/footer.json";
import wi from "../i18n/locales/pt/themeToggle.json";
import Ti from "../i18n/locales/pt/hero.json";
import Ei from "../i18n/locales/pt/whyItMatters.json";
import Di from "../i18n/locales/pt/understandingImpact.json";
import Oi from "../i18n/locales/pt/resultsTable.json";
import ki from "../i18n/locales/pt/aboutHeader.json";
import Ai from "../i18n/locales/pt/aboutGrid.json";
import ji from "../i18n/locales/pt/whatWeMeasure.json";
import Mi from "../i18n/locales/pt/blogHeader.json";
import Ni from "../i18n/locales/pt/blogList.json";
import Pi from "../i18n/locales/pt/careersHeader.json";
import Fi from "../i18n/locales/pt/careersBenefits.json";
import Ii from "../i18n/locales/pt/openPositions.json";
import Li from "../i18n/locales/pt/contactHeader.json";
import Ri from "../i18n/locales/pt/contactForm.json";
import zi from "../i18n/locales/pt/faqHeader.json";
import Bi from "../i18n/locales/pt/faqList.json";
import Vi from "../i18n/locales/pt/pricingHeader.json";
import Hi from "../i18n/locales/pt/pricingTiers.json";
import Ui from "../i18n/locales/pt/productsHeader.json";
import Wi from "../i18n/locales/pt/productsGrid.json";
import Gi from "../i18n/locales/pt/settingsHeader.json";
import Ki from "../i18n/locales/pt/profileSection.json";
import qi from "../i18n/locales/pt/preferencesSection.json";
import Ji from "../i18n/locales/pt/apiAccessSection.json";
import Yi from "../i18n/locales/pt/settingsFooter.json";
import Xi from "../i18n/locales/pt/teamHeader.json";
import Zi from "../i18n/locales/pt/teamGrid.json";
import Qi from "../i18n/locales/pt/common.json";
import $i from "../i18n/locales/pt/home.json";
import ea from "../i18n/locales/pt/about.json";
import ta from "../i18n/locales/pt/blog.json";
import na from "../i18n/locales/pt/careers.json";
import ra from "../i18n/locales/pt/contact.json";
import ia from "../i18n/locales/pt/faq.json";
import aa from "../i18n/locales/pt/pricing.json";
import oa from "../i18n/locales/pt/products.json";
import sa from "../i18n/locales/pt/settings.json";
import ca from "../i18n/locales/pt/team.json";
import la from "../i18n/locales/ru/route.json";
import ua from "../i18n/locales/ru/header.json";
import da from "../i18n/locales/ru/footer.json";
import fa from "../i18n/locales/ru/themeToggle.json";
import pa from "../i18n/locales/ru/hero.json";
import ma from "../i18n/locales/ru/whyItMatters.json";
import ha from "../i18n/locales/ru/understandingImpact.json";
import ga from "../i18n/locales/ru/resultsTable.json";
import _a from "../i18n/locales/ru/aboutHeader.json";
import va from "../i18n/locales/ru/aboutGrid.json";
import ya from "../i18n/locales/ru/whatWeMeasure.json";
import ba from "../i18n/locales/ru/blogHeader.json";
import xa from "../i18n/locales/ru/blogList.json";
import Sa from "../i18n/locales/ru/careersHeader.json";
import Ca from "../i18n/locales/ru/careersBenefits.json";
import wa from "../i18n/locales/ru/openPositions.json";
import Ta from "../i18n/locales/ru/contactHeader.json";
import Ea from "../i18n/locales/ru/contactForm.json";
import Da from "../i18n/locales/ru/faqHeader.json";
import Oa from "../i18n/locales/ru/faqList.json";
import ka from "../i18n/locales/ru/pricingHeader.json";
import Aa from "../i18n/locales/ru/pricingTiers.json";
import ja from "../i18n/locales/ru/productsHeader.json";
import Ma from "../i18n/locales/ru/productsGrid.json";
import Na from "../i18n/locales/ru/settingsHeader.json";
import Pa from "../i18n/locales/ru/profileSection.json";
import Fa from "../i18n/locales/ru/preferencesSection.json";
import Ia from "../i18n/locales/ru/apiAccessSection.json";
import La from "../i18n/locales/ru/settingsFooter.json";
import Ra from "../i18n/locales/ru/teamHeader.json";
import za from "../i18n/locales/ru/teamGrid.json";
import Ba from "../i18n/locales/ru/common.json";
import Va from "../i18n/locales/ru/home.json";
import Ha from "../i18n/locales/ru/about.json";
import Ua from "../i18n/locales/ru/blog.json";
import Wa from "../i18n/locales/ru/careers.json";
import Ga from "../i18n/locales/ru/contact.json";
import Ka from "../i18n/locales/ru/faq.json";
import qa from "../i18n/locales/ru/pricing.json";
import Ja from "../i18n/locales/ru/products.json";
import Ya from "../i18n/locales/ru/settings.json";
import Xa from "../i18n/locales/ru/team.json";
import Za from "../i18n/locales/zh/route.json";
import Qa from "../i18n/locales/zh/header.json";
import $a from "../i18n/locales/zh/footer.json";
import eo from "../i18n/locales/zh/themeToggle.json";
import to from "../i18n/locales/zh/hero.json";
import no from "../i18n/locales/zh/whyItMatters.json";
import ro from "../i18n/locales/zh/understandingImpact.json";
import io from "../i18n/locales/zh/resultsTable.json";
import ao from "../i18n/locales/zh/aboutHeader.json";
import oo from "../i18n/locales/zh/aboutGrid.json";
import so from "../i18n/locales/zh/whatWeMeasure.json";
import co from "../i18n/locales/zh/blogHeader.json";
import lo from "../i18n/locales/zh/blogList.json";
import uo from "../i18n/locales/zh/careersHeader.json";
import fo from "../i18n/locales/zh/careersBenefits.json";
import po from "../i18n/locales/zh/openPositions.json";
import mo from "../i18n/locales/zh/contactHeader.json";
import ho from "../i18n/locales/zh/contactForm.json";
import go from "../i18n/locales/zh/faqHeader.json";
import _o from "../i18n/locales/zh/faqList.json";
import vo from "../i18n/locales/zh/pricingHeader.json";
import yo from "../i18n/locales/zh/pricingTiers.json";
import bo from "../i18n/locales/zh/productsHeader.json";
import xo from "../i18n/locales/zh/productsGrid.json";
import So from "../i18n/locales/zh/settingsHeader.json";
import Co from "../i18n/locales/zh/profileSection.json";
import wo from "../i18n/locales/zh/preferencesSection.json";
import To from "../i18n/locales/zh/apiAccessSection.json";
import Eo from "../i18n/locales/zh/settingsFooter.json";
import Do from "../i18n/locales/zh/teamHeader.json";
import Oo from "../i18n/locales/zh/teamGrid.json";
import ko from "../i18n/locales/zh/common.json";
import Ao from "../i18n/locales/zh/home.json";
import jo from "../i18n/locales/zh/about.json";
import Mo from "../i18n/locales/zh/blog.json";
import No from "../i18n/locales/zh/careers.json";
import Po from "../i18n/locales/zh/contact.json";
import Fo from "../i18n/locales/zh/faq.json";
import Io from "../i18n/locales/zh/pricing.json";
import Lo from "../i18n/locales/zh/products.json";
import Ro from "../i18n/locales/zh/settings.json";
import zo from "../i18n/locales/zh/team.json";
var Bo = Object.defineProperty, Vo = Object.getOwnPropertySymbols, Ho = Object.prototype.hasOwnProperty, Uo = Object.prototype.propertyIsEnumerable, Wo = (e, t, n) => t in e ? Bo(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function cs(e, t) {
	let n = H(ss, t?.initialOptions, e);
	return n.apiUrl = Zo(n.apiUrl), e?.fetch && (n.fetch = N(e.fetch)), {
		initialOptions: n,
	...
	let C = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = Qo(e) || V, r = t().onFormatError, a = typeof r;
...
function ds(e, t, n) {
	let r = cs(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? M([t, ...Xo(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
		...
		overrideCredentials(e) {
			i = e ? Object.assign(Object.assign({}, e), { apiUrl: Zo(e.apiUrl) }) : void 0;
		}
	});
	return a;
}
...
var gs = () => {
	let e = {
		...
		init(t) {
			let n = hs(H(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, _s = 0, U = 1, vs = 2, ys = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === _s ? r = "Empty parameter" : e === U ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function bs(e) {
	return /\s/.test(e);
}
var W = 0, G = 1, K = 2, q = 3, J = 4, xs = new Set([
	K,
	G,
	W
]), Y = "'", Ss = new Set([
...
function ws(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case W:
			...
			break;
		case G:
			Ss.has(i) ? (n = n.slice(0, -1) + i, t = K) : (n += i, t = W);
			break;
		case K:
			i === Y ? t = W : (n += i, t = K);
			break;
		case q:
			i === "}" ? (d(), t = W) : bs(i) ? r !== "" && (d(), t = J) : (u(), t = q);
			break;
		case J: i == "}" ? t = W : bs(i) ? t = J : c(U);
	}
...
(Ko = console.assert) == null || Ko.call(console, As), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function js(e, t) {
	let n = (n) => {
...
var zs = null;
function Bs(e) {
	return zs ||= Rs(`${Ls}/@tolgee/web@${e}/dist/${Ps}`).then(() => window[Fs][Is]), zs;
}
var Vs = "__tolgee_apiKey", Hs = "__tolgee_apiUrl", Us = "__tolgee_branch";
function Ws() {
	let e = sessionStorage.getItem(Vs) || void 0, t = sessionStorage.getItem(Hs) || void 0, n = sessionStorage.getItem(Us) || void 0;
	if (!(!e || !t)) return Go({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Gs() {
	sessionStorage.removeItem(Vs), sessionStorage.removeItem(Hs), sessionStorage.removeItem(Us);
}
function Ks(e) {
...
var Zs = { useSuspense: !1 }, Qs, $s = () => (Qs ||= e.createContext(void 0), Qs), X = void 0, ec = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = Xs(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, Zs), r), h = $s();
...
var rc = () => {
	...
	let { tolgee: r, options: a } = rc(), o = Yo(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = ic(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var Q = (t) => {
	...
	let { t: n } = ac();
	return e.createElement(cc, Object.assign({ t: n }, t));
};
function uc(e) {
	return l(lc, { ...e });
}
...
function rl() {
	return Js().use(Ds()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(nl.map((e) => [e, () => Promise.resolve(tl(e))]))
	});
}
var $ = rl().init(), il = ({ language: e, staticData: t, children: n }) => {
	let r = u();
	return i(() => {
...
function sl({ children: e, locale: t, staticData: n }) {
