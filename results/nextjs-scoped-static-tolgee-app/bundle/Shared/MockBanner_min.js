...
}, j = (e) => Object.fromEntries(oe(e).entries()), M = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function ge(e, t) {
	...
	return n.apiUrl = ee(n.apiUrl), e?.fetch && (n.fetch = ae(e.fetch)), {
		initialOptions: n,
	...
	let k = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = te(e) || F, r = t().onFormatError, a = typeof r;
...
function ye(e, t, n) {
	let r = ge(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? A([t, ...k(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
		...
		overrideCredentials(e) {
			i = e ? Object.assign(Object.assign({}, e), { apiUrl: ee(e.apiUrl) }) : void 0;
		}
	});
	return a;
}
...
function Se({ options: e }) {
	let t = ce(), n = ve(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ve(!1, () => w.isLoading(), t.onLoadingChange.emit), i = ye(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = _e(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = fe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
	...
	function d(e) {
		return A([...O(e ?? l()), ...i.getRequiredNamespaces()]);
	}
	function f(e, t, n) {
...
var Ut = { useSuspense: !1 }, Wt, Gt = () => (Wt ||= e.createContext(void 0), Wt), Q = void 0, Kt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
...
var nn = () => l("div", {
	...
	children: l(tn, { keyName: "mockBanner" })
}), rn = {
...
function Xl() {
	return Bt().use(Pe()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(Yl.map((e) => [e, () => Promise.resolve(Jl(e))]))
	});
}
var Zl = Xl().init(), Ql = ({ language: e, staticData: t, children: n }) => {
	let r = u();
	return i(() => {
		let { unsubscribe: e } = Zl.on("permanentChange", () => {
			r.refresh();
		});
		return () => {
			e();
...
function tu({ children: e, locale: t, staticData: n }) {
