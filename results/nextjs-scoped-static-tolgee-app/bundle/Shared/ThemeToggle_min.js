...
function fs(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return O(s.onError, (e) => new N("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
		if (!l.languageDetector) return;
		let e = n();
		return O(s.onError, (e) => new os("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let C = Object.freeze({
		...
		setStoredLanguage(e) {
			return O(s.onError, (e) => new N("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = cs(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = $o(e) || R, r = t().onFormatError, a = typeof r;
...
function hs(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = cs(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
var B = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, hs(r)), n)), n;
};
function gs({ options: e }) {
	let t = is(), n = ps(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ps(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ms(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = fs(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = ss(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var vs = () => {
	let e = {
		...
		init(t) {
			let n = _s(z(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, ys = 0, V = 1, bs = 2, xs = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === ys ? r = "Empty parameter" : e === V ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Ss(e) {
	return /\s/.test(e);
}
var H = 0, U = 1, W = 2, G = 3, K = 4, Cs = new Set([
	W,
	U,
	H
]), q = "'", ws = new Set([
...
function Es(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case H:
			...
			break;
		case U:
			ws.has(i) ? (n = n.slice(0, -1) + i, t = W) : (n += i, t = H);
			break;
		case W:
			i === q ? t = H : (n += i, t = W);
			break;
		case G:
			i === "}" ? (d(), t = H) : Ss(i) ? r !== "" && (d(), t = K) : (u(), t = G);
			break;
		case K: i == "}" ? t = H : Ss(i) ? t = K : c(V);
	}
...
(qo = console.assert) == null || qo.call(console, Ms), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ns(e, t) {
	let n = (n) => {
...
var $s = { useSuspense: !1 }, ec, tc = () => (ec ||= e.createContext(void 0), ec), J = void 0, nc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
		J?.run !== n.run && (J && J.stop(), J = n, n.run().catch((e) => {
			console.error(e);
		}).finally(() => {
			p(!1);
		}));
...
var ac = () => {
	...
	let { tolgee: r, options: a } = ac(), o = Xo(e), c = A(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = oc(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function sl() {
	return Xs().use(ks()).updateDefaults({
