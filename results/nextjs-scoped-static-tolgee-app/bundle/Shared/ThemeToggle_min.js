...
var Gt = { useSuspense: !1 }, Kt, qt = () => (Kt ||= e.createContext(void 0), Kt), X = void 0, Jt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	let { tolgee: r, options: a } = Yt(), o = E(e), c = D(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Xt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function sn() {
	...
	return l("button", {
		...
		children: t === "auto" ? l(Q, { keyName: "themeToggle.themeAuto" }) : t === "dark" ? l(Q, { keyName: "themeToggle.themeDark" }) : l(Q, { keyName: "themeToggle.themeLight" })
	});
}
var cn = {
...
function eu() {
	return Ht().use(Fe()).updateDefaults({
