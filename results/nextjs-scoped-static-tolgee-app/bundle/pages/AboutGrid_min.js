...
var vs = () => {
	...
	return t;
}, ys = 0, H = 1, bs = 2, xs = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === ys ? r = "Empty parameter" : e === H ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Ss(e) {
	return /\s/.test(e);
}
var U = 0, W = 1, G = 2, K = 3, q = 4, Cs = new Set([
	G,
	W,
	U
]), J = "'", ws = new Set([
...
function Es(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case U:
			...
			break;
		case W:
			ws.has(i) ? (n = n.slice(0, -1) + i, t = G) : (n += i, t = U);
			break;
		case G:
			i === J ? t = U : (n += i, t = G);
			break;
		case K:
			i === "}" ? (d(), t = U) : Ss(i) ? r !== "" && (d(), t = q) : (u(), t = K);
			break;
		case q: i == "}" ? t = U : Ss(i) ? t = q : c(H);
	}
...
var $s = { useSuspense: !1 }, ec, tc = () => (ec ||= e.createContext(void 0), ec), Y = void 0, nc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
...
var ac = () => {
	...
	let { tolgee: r, options: a } = ac(), o = Xo(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = oc(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var $ = il().init(), al = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
...
function cl({ children: e, locale: t, staticData: n }) {
