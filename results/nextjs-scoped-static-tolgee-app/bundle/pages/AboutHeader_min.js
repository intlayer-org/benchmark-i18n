...
function sn() {
	return on("AboutHeader"), d(l, { children: [u("h1", {
		className: "mb-4 text-3xl font-bold text-foreground",
		children: u(an, { keyName: "aboutHeader.aboutThisBenchmark" })
	}), u("p", {
		className: "mb-8 max-w-3xl text-muted-foreground",
		children: u(an, { keyName: "aboutHeader.thisIsAnOpenSource" })
	})] });
}
var cn = {
...
function $l() {
	return Ut().use(Ie()).updateDefaults({
		...
		staticData: Object.fromEntries(Ql.map((e) => [e, () => Promise.resolve(Zl(e))]))
	});
}
var eu = $l().init(), tu = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
		let { unsubscribe: e } = eu.on("permanentChange", () => {
			r.refresh();
		});
		return () => {
			e();
...
function iu({ children: e, locale: t, staticData: n }) {
