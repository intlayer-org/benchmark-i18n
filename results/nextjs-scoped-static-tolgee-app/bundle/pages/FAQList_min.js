...
function Kl() {
	return Vt().use(Fe()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(Gl.map((e) => [e, () => Promise.resolve(Wl(e))]))
	});
}
var ql = Kl().init(), Jl = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
...
function Zl({ children: e, locale: t, staticData: n }) {
