...
function ls(e, t) {
	let n = H(cs, t?.initialOptions, e);
	return n.apiUrl = Qo(n.apiUrl), e?.fetch && (n.fetch = N(e.fetch)), {
		initialOptions: n,
...
function us(e, t, n, r, i, a, o, s) {
	...
	function ee() {
		...
		let e = n();
		return k(s.onError, (e) => new is("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let C = Object.freeze({
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = os(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = $o(e) || V, r = t().onFormatError, a = typeof r;
...
function ps(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = os(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
var U = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, ps(r)), n)), n;
};
function ms({ options: e }) {
	let t = rs(), n = ds(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ds(!1, () => S.isLoading(), t.onLoadingChange.emit), i = fs(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = us(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = as(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var gs = () => {
	...
	return t;
}, _s = 0, W = 1, vs = 2, ys = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === _s ? r = "Empty parameter" : e === W ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function bs(e) {
	return /\s/.test(e);
}
var G = 0, K = 1, q = 2, J = 3, Y = 4, xs = new Set([
	q,
	K,
	G
]), X = "'", Ss = new Set([
...
function ws(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case G:
			...
			break;
		case K:
			Ss.has(i) ? (n = n.slice(0, -1) + i, t = q) : (n += i, t = G);
			break;
		case q:
			i === X ? t = G : (n += i, t = q);
			break;
		case J:
			i === "}" ? (d(), t = G) : bs(i) ? r !== "" && (d(), t = Y) : (u(), t = J);
			break;
		case Y: i == "}" ? t = G : bs(i) ? t = Y : c(W);
	}
...
var Xs = { useSuspense: !1 }, Zs, Qs = () => (Zs ||= e.createContext(void 0), Zs), Q = void 0, $s = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
...
var nc = () => {
	...
	let { tolgee: r, options: a } = nc(), o = Xo(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = rc(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function $c() {
	return qs().use(Ds()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(Qc.map((e) => [e, () => Promise.resolve(Zc(e))]))
	});
}
var $ = $c().init(), el = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
...
function rl({ children: e, locale: t, staticData: n }) {
