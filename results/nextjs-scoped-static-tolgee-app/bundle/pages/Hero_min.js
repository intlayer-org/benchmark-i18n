...
function Ql() {
	return Ut().use(Le()).updateDefaults({
		...
		staticData: Object.fromEntries(Zl.map((e) => [e, () => Promise.resolve(Xl(e))]))
	});
}
var $l = Ql().init(), eu = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
		let { unsubscribe: e } = $l.on("permanentChange", () => {
			r.refresh();
		});
		return () => {
			e();
...
function ru({ children: e, locale: t, staticData: n }) {
