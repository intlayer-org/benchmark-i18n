...
var $s = { useSuspense: !1 }, ec, tc = () => (ec ||= e.createContext(void 0), ec), X = void 0, nc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
...
var ac = () => {
	...
	let { tolgee: r, options: a } = ac(), o = Zo(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = oc(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
