...
}, j = (e) => Object.fromEntries(ce(e).entries()), M = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function xe(e, t, n) {
	let r = ve(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? A([t, ...te(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
var Kt = { useSuspense: !1 }, qt, Jt = () => (qt ||= e.createContext(void 0), qt), Z = void 0, Yt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	...
	let { tolgee: r, options: a } = Xt(), o = O(e), c = k(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Zt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function eu() {
	return Ut().use(Ie()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries($l.map((e) => [e, () => Promise.resolve(Ql(e))]))
	});
}
var tu = eu().init(), nu = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
		let { unsubscribe: e } = tu.on("permanentChange", () => {
			r.refresh();
		});
		return () => {
			e();
...
function au({ children: e, locale: t, staticData: n }) {
