...
}, L = (e) => Object.fromEntries(I(e).entries()), R = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function ds(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return k(s.onError, (e) => new F("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
	...
	let C = Object.freeze({
		...
		setStoredLanguage(e) {
			return k(s.onError, (e) => new F("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = $o(e) || B, r = t().onFormatError, a = typeof r;
...
var _s = () => {
	let e = {
		...
		init(t) {
			let n = gs(V(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, vs = 0, U = 1, ys = 2, bs = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === vs ? r = "Empty parameter" : e === U ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function xs(e) {
	return /\s/.test(e);
}
var W = 0, G = 1, K = 2, q = 3, J = 4, Ss = new Set([
	K,
	G,
	W
]), Y = "'", Cs = new Set([
...
function Ts(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case W:
			...
			break;
		case G:
			Cs.has(i) ? (n = n.slice(0, -1) + i, t = K) : (n += i, t = W);
			break;
		case K:
			i === Y ? t = W : (n += i, t = K);
			break;
		case q:
			i === "}" ? (d(), t = W) : xs(i) ? r !== "" && (d(), t = J) : (u(), t = q);
			break;
		case J: i == "}" ? t = W : xs(i) ? t = J : c(U);
	}
...
var Qs = { useSuspense: !1 }, $s, ec = () => ($s ||= e.createContext(void 0), $s), X = void 0, tc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = Zs(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, Qs), r), h = ec();
...
var ic = () => {
	...
	let { tolgee: r, options: a } = ic(), o = Xo(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = ac(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var Q = (t) => {
	let n = sc(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, lc(t))) : lc(n);
}, uc = (t) => {
	...
	let { t: n } = Z();
	return e.createElement(uc, Object.assign({ t: n }, t));
};
function fc() {
	let { t: e, ...t } = oc();
	return {
...
function ol() {
	return Ys().use(Os()).updateDefaults({
		apiKey: process.env.NEXT_PUBLIC_TOLGEE_API_KEY,
		apiUrl: process.env.NEXT_PUBLIC_TOLGEE_API_URL,
		staticData: Object.fromEntries(al.map((e) => [e, () => Promise.resolve(il(e))]))
	});
}
var $ = ol().init(), sl = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
...
function ul({ children: e, locale: t, staticData: n }) {
