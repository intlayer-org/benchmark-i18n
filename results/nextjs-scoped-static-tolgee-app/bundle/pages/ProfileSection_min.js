...
var oc = () => {
	...
	let { tolgee: r, options: a } = oc(), o = Zo(e), s = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = sc(), f = c([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var $ = al().init(), ol = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
...
function ll({ children: e, locale: t, staticData: n }) {
