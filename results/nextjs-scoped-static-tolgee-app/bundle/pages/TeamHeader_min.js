...
function ds(e, t) {
	let n = V(us, t?.initialOptions, e);
	return n.apiUrl = $o(n.apiUrl), e?.fetch && (n.fetch = rs(e.fetch)), {
		initialOptions: n,
...
function fs(e, t, n, r, i, a, o, s) {
	...
	function ee() {
		...
		let e = n();
		return k(s.onError, (e) => new os("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let C = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = es(e) || B, r = t().onFormatError, a = typeof r;
...
function _s({ options: e }) {
	let t = as(), n = ps(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ps(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ms(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = fs(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = ss(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
(Jo = console.assert) == null || Jo.call(console, Ns), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ps(e, t) {
	let n = (n) => {
...
var oc = () => {
	...
	let { tolgee: r, options: a } = oc(), o = Zo(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = sc(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
