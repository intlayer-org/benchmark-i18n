...
function an() {
	return u("section", {
		...
		children: [l("h2", {
			...
			children: l(Q, { keyName: "whyItMatters.whyTheseMetricsMatter" })
		}), u("div", {
			...
			children: [
				u("div", {
					...
					children: [l("h3", {
						...
						children: l(Q, { keyName: "whyItMatters.bundleSize" })
					}), l("p", {
						className: "text-sm text-muted-foreground",
						children: l(Q, { keyName: "whyItMatters.theBundleIsTheData" })
					})]
				}),
				u("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [l("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: l(Q, { keyName: "whyItMatters.renderingHydration" })
					}), l("p", {
						className: "text-sm text-muted-foreground",
						children: l(Q, { keyName: "whyItMatters.connectingALargeJson" })
					})]
				}),
				u("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [l("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: l(Q, { keyName: "whyItMatters.dynamicLoading" })
					}), l("p", {
						className: "text-sm text-muted-foreground",
						children: l(Q, { keyName: "whyItMatters.loadingAllTranslationsUpfront" })
					})]
				})
			]
		})]
