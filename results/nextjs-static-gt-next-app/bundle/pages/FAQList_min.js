...
function _s() {
	return g("div", {
		...
		children: [
			{
				q: g(X, { children: "What is i18n Benchmark?" }),
				a: g(X, { children: "i18n Benchmark is an open-source benchmarking suite that measures and compares the performance, bundle size, and developer experience of internationalization libraries for JavaScript and React applications." })
			},
			{
				q: g(X, { children: "How are benchmarks conducted?" }),
				a: g(X, { children: "We run standardized tests in isolated environments using consistent hardware. Each benchmark is repeated multiple times to ensure statistical significance. All test configurations are publicly available in our GitHub repository." })
			},
			{
				q: g(X, { children: "Which libraries are currently supported?" }),
				a: g(X, { children: "We support react-i18next, react-intl (FormatJS), Lingui, typesafe-i18n, next-intl, Paraglide, Rosetta, i18n-js, Polyglot.js, vue-i18n, @fluent/react, and Tolgee." })
			},
			{
				q: g(X, { children: "Can I submit my own benchmarks?" }),
				a: g(X, { children: "Yes! Community benchmark submissions are welcome. Fork our repository, add your benchmark following our contribution guide, and submit a pull request. Our team will review and merge qualifying submissions." })
			},
			{
				q: g(X, { children: "How often are benchmarks updated?" }),
				a: g(X, { children: "We re-run all benchmarks weekly against the latest stable versions of each library. Major version releases trigger an immediate re-benchmark cycle." })
			},
			{
				q: g(X, { children: "Is the data reliable?" }),
				a: g(X, { children: "We follow rigorous statistical methodology including warm-up runs, outlier detection, and confidence intervals. All raw data is published alongside our analysis for full transparency." })
			},
			{
				q: g(X, { children: "Do you offer consulting services?" }),
				a: g(X, { children: "Yes, our Enterprise plan includes consulting hours for teams evaluating i18n solutions. We can provide tailored recommendations based on your specific use case, scale, and constraints." })
			},
			{
				q: g(X, { children: "How can I contribute?" }),
				a: g(X, { children: "There are many ways to contribute: submit benchmarks, improve documentation, report bugs, suggest new metrics, or sponsor the project. Visit our GitHub repository for more details." })
			}
		].map((e, t) => _("details", {
