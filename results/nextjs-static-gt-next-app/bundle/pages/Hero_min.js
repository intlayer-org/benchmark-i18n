...
function vs() {
	return _s("Hero"), _("section", {
		className: "mb-16 text-center",
		children: [
			g("h1", {
				className: "mb-4 text-4xl font-bold tracking-tight text-foreground",
				children: g(X, { children: "i18n Benchmark" })
			}),
			g("p", {
				className: "mx-auto max-w-2xl text-lg text-muted-foreground",
				children: g(X, { children: "A test application designed to measure the real-world impact of internationalization libraries on bundle size, loading performance, and rendering reactivity." })
			}),
			_("div", {
				...
				children: [g("button", {
					...
					children: g(X, { children: "View Results" })
				}), g("button", {
					type: "button",
					className: "rounded-lg border border-border px-6 py-3 text-sm font-medium text-foreground hover:bg-accent transition-colors",
					children: g(X, { children: "Methodology" })
				})]
			})
		]
	});
