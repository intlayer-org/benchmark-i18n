...
function _s() {
	return g("div", {
		...
		children: [
			{
				name: g(X, { children: "Starter" }),
				price: g(X, { children: "$0" }),
				period: g(X, { children: "forever" }),
				features: [
					g(X, { children: "5 benchmark runs/day" }, "f1"),
					g(X, { children: "3 libraries" }, "f2"),
					g(X, { children: "Community support" }, "f3"),
					g(X, { children: "Public results" }, "f4")
				]
			},
			{
				name: g(X, { children: "Pro" }),
				price: g(X, { children: "$29" }),
				period: g(X, { children: "/month" }),
				features: [
					g(X, { children: "Unlimited runs" }, "f1"),
					g(X, { children: "All libraries" }, "f2"),
					g(X, { children: "Priority support" }, "f3"),
					g(X, { children: "Private results" }, "f4"),
					g(X, { children: "CI integration" }, "f5"),
					g(X, { children: "Historical data" }, "f6")
				],
				highlighted: !0
			},
			{
				name: g(X, { children: "Enterprise" }),
				price: g(X, { children: "Custom" }),
				period: g(X, { children: "" }),
				features: [
					g(X, { children: "Everything in Pro" }, "f1"),
					g(X, { children: "On-premise option" }, "f2"),
					g(X, { children: "SSO & SAML" }, "f3"),
					g(X, { children: "Dedicated account manager" }, "f4"),
					g(X, { children: "Custom SLAs" }, "f5"),
					g(X, { children: "Audit logs" }, "f6"),
					g(X, { children: "Training sessions" }, "f7")
				],
				isEnterprise: !0
			}
		].map((e, t) => _("div", {
			...
			children: [
				...
				g("button", {
					...
					children: e.isEnterprise ? g(X, { children: "Contact Sales" }) : g(X, { children: "Get Started" })
				})
			]
		}, t))
	});
