...
function _s() {
	return g("div", {
		...
		children: [
			{
				name: g(X, { children: "Benchmark CLI" }),
				desc: g(X, { children: "Run benchmarks locally from your terminal. Supports custom configurations and CI integration." }),
				price: g(X, { children: "Free" })
			},
			{
				name: g(X, { children: "Benchmark Cloud" }),
				desc: g(X, { children: "Automated cloud-based benchmarking with historical tracking, alerts, and team dashboards." }),
				price: "$29/mo"
			},
			{
				name: g(X, { children: "Benchmark Enterprise" }),
				desc: g(X, { children: "On-premise deployment with SSO, audit logs, custom SLAs, and dedicated support." }),
				price: g(X, { children: "Contact Us" })
			},
			{
				name: g(X, { children: "Migration Assistant" }),
				desc: g(X, { children: "AI-powered tool that helps migrate your codebase between i18n libraries with zero downtime." }),
				price: g(X, { children: "$99 one-time" })
			},
			{
				name: g(X, { children: "Translation QA" }),
				desc: g(X, { children: "Automated quality checks for missing translations, pluralization issues, and context errors." }),
				price: "$19/mo"
			},
			{
				name: g(X, { children: "Bundle Optimizer" }),
				desc: g(X, { children: "Analyzes and optimizes your i18n bundle for production with tree-shaking and code splitting." }),
				price: "$49/mo"
			}
		].map((e) => _("div", {
			className: "flex flex-col justify-between rounded-lg border border-border bg-card p-6",
			children: [_("div", { children: [g("h3", {
				...
				children: [g("span", {
					...
					children: g(X, { children: "Learn More" })
				})]
			})]
		}, e.name?.toString() || ""))
	});
