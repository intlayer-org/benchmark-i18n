...
function _s() {
	return g("div", {
		...
		children: [
			{
				name: g(X, { children: "Sarah Chen" }),
				role: g(X, { children: "Founder & Lead Engineer" }),
				bio: g(X, { children: "Former Google engineer with 10 years of experience building internationalization systems at scale." })
			},
			{
				name: g(X, { children: "Marcus Weber" }),
				role: g(X, { children: "Performance Engineer" }),
				bio: g(X, { children: "Specializes in JavaScript performance optimization and benchmarking methodology. Previously at Vercel." })
			},
			{
				name: g(X, { children: "Aisha Patel" }),
				role: g(X, { children: "Developer Advocate" }),
				bio: g(X, { children: "Passionate about developer experience and education. Speaker at React Conf, JSConf, and i18nNext." })
			},
			{
				name: g(X, { children: "Tomás Rodríguez" }),
				role: g(X, { children: "Full-Stack Developer" }),
				bio: g(X, { children: "Maintains the benchmarking infrastructure and CI/CD pipeline. Open source contributor to Lingui." })
			},
			{
				name: g(X, { children: "Yuki Tanaka" }),
				role: g(X, { children: "Data Analyst" }),
				bio: g(X, { children: "Ensures statistical rigor in all benchmark results. PhD in Applied Statistics from MIT." })
			},
			{
				name: g(X, { children: "Elena Kowalski" }),
				role: g(X, { children: "Community Manager" }),
				bio: g(X, { children: "Manages community contributions, partnerships, and events. Background in open source governance." })
			}
		].map((e, t) => _("div", {
