...
}, ee = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(h).join("") : String(e ?? ""), te = "translation", ne = "enumeration", re = "plural", g = "insertion", ie = "object", ae = "array", _ = "markdown", v = "html", y = "gender", oe = "select", b = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), x = (e, t) => {
...
})() }), pe = (e) => b(re, e), me = (e, t) => b(oe, e, { variable: t }), he = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, xe = 50, k = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Set(), Se = (e) => {
...
var Te = (e, t, n) => e[j("PluralRules", n).select(t)] ?? e.other, Ee = (e, t) => {
	...
	if (r.nodeType === "plural") {
		let e = r[re];
		return F(Te(e, Number(P(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[ne], i = De.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[oe], i = P(t, typeof r.variable == "string" ? r.variable : "value");
		return F(Ee(e, String(i ?? "")), t, n);
	}
...
}, ke = ((e) => (t, n = {}, r = "en") => I(typeof t == "string" ? e(t) : t, n, r))(_e), Ae = (e) => {
	let t = e.indexOf(".");
	return t === -1 ? {
		dictionaryKey: e,
		remainder: ""
	...
	_(e, t, n) {
		...
		return (c.kind === "node" ? I(c.node, o, s) : ke(c.message, o, s)) ?? i;
	}
...
}, Me = e(null), L = /* @__PURE__ */ new WeakMap(), R = 0, Ne = (e) => {
	if (!e) return "base";
	let t = L.get(e);
	if (t) return t;
	R += 1;
...
}, K = (e) => e === void 0 ? U : typeof e == "string" ? G(e, Le) : Object.keys(e).sort().map((t) => `${G(t, W)}=${G(String(e[t]), W)}`).join("&"), ze = (e) => Array.isArray(e) ? e.length === 0 ? [U] : e.map(K) : [K(e)], Be = (e, t) => {
	...
	if (!He(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? U : Be(ze(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Ve(e, n, t, s)).map((t) => Ue(e, t));
...
}).join("|") : "", q = "\x1B[0m", qe = "\x1B[34m", Je = "\x1B[31m", Ye = "\x1B[32m", Xe = "\x1B[38;5;3m", Ze = (e) => e, Qe = (e, t) => {
...
}), J = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? q : n : q}` : e, et = (e, t = Xe, n = q) => [e].flat().map((e) => J(e, t, n)).join(", ");
J("✗", Je), J("✓", Ye), J("⏲", qe);
var tt = {
	header: {
		key: "header",
	...
	let r = nt()[e];
	return r ? Ct(r, t, n) : (at.has(e) || ($e({ log: be })(typeof window > "u" ? `Dictionary ${et(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), at.add(e)), it(e));
}, st = (e) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, pt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? X : {
...
}, mt = X, ht = X, gt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? X : {
	id: "insertion-plugin",
...
var yt = (e) => X, bt = X, xt = (e, t = !0) => [
	...
	let { locale: r, selector: i } = Ge(t), a = Fe(r ?? D.defaultLocale, Ke(i), n), o = Ie(e, a);
	if (o.hit) return o.content;
	let s = n ?? xt(r), c = We(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var Z = {
...
}, Bt = (e, t = D?.locales, n = D?.defaultLocale) => {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), Vt = ({ locale: e, defaultLocale: t, variant: r, children: i, setLocale: a, disableEditor: s, isCookieEnabled: l }) => {
...
}), Ut = ({ i18n: e, defaultComponent: t, children: r }) => {
	let i = (e) => ({
		i18n: e,
		_: e._.bind(e),
		defaultComponent: t
...
var Yt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/AppProviders.tsx";
function Xt({ children: e }) {
	let t = s().locale ?? "en", a = i(() => qt(t), [t]), c = i(() => Jt(t, a), [t, a]), [l] = o(() => typeof performance < "u" ? performance.now() : 0);
	return r(() => {
		Kt("AppRoot", l);
	}, [l]), n(() => {
...
var Zt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
function Qt({ children: e }) {
	return u(Xt, { children: e }, void 0, !1, {
		fileName: Zt,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/AppProviders.wrapper.tsx";
function $t() {
	return u(Qt, { children: u(Xt, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
