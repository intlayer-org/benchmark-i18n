...
var h = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/Link.tsx", ee = (e) => /^https?:\/\//.test(e ?? "");
function te(e, t) {
...
}, se = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(oe).join("") : String(e ?? ""), ce = "translation", _ = "enumeration", v = "plural", y = "insertion", le = "object", ue = "array", b = "markdown", x = "html", de = "gender", fe = "select", S = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), C = (e, t) => {
...
})() }), ye = (e) => S(v, e), be = (e, t) => S(fe, e, { variable: t }), xe = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
var je = (e, t, n) => e[N("PluralRules", n).select(t)] ?? e.other, Me = (e, t) => {
	...
	if (r.nodeType === "html") return R(r[x], t, n);
	if (r.nodeType === "plural") {
		let e = r[v];
		return R(je(e, Number(L(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[_], i = P.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
}, Pe = (e) => (t, n = {}, r = "en") => z(typeof t == "string" ? e(t) : t, n, r), B = (e) => {
	...
	_(e, t, n) {
		...
		return (c.kind === "node" ? z(c.node, o, s) : Fe(c.message, o, s)) ?? i;
	}
...
}, Re = t(null), ze = /* @__PURE__ */ new WeakMap(), Be = 0, Ve = (e) => {
	if (!e) return "base";
	let t = ze.get(e);
	if (t) return t;
	Be += 1;
...
}, Ke = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), U = "default", qe = /[^A-Za-z0-9._&=-]/g, Je = /[^A-Za-z0-9._-]/g, Ye = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, W = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, Ye);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, Xe = (e) => e === void 0 ? U : typeof e == "string" ? W(e, qe) : Object.keys(e).sort().map((t) => `${W(t, Je)}=${W(String(e[t]), Je)}`).join("&"), G = (e) => Array.isArray(e) ? e.length === 0 ? [U] : e.map(Xe) : [Xe(e)], Ze = (e, t) => {
	...
	if (!$e(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? U : Ze(G(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Qe(e, n, t, s)).map((t) => et(e, t));
...
}).join("|") : "", K = "\x1B[0m", it = "\x1B[34m", at = "\x1B[31m", ot = "\x1B[32m", st = "\x1B[38;5;3m", ct = (e) => e, lt = (e, t) => {
...
}), q = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? K : n : K}` : e, dt = (e, t = st, n = K) => [e].flat().map((e) => q(e, t, n)).join(", ");
q("✗", at), q("✓", ot), q("⏲", it);
var ft = {
	header: {
		key: "header",
	...
	let r = pt()[e];
	return r ? Pt(r, t, n) : (gt.has(e) || (ut({ log: Ee })(typeof window > "u" ? `Dictionary ${dt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), gt.add(e)), ht(e));
}, vt = (e) => {
...
var X = {
	...
	let { locales: l, defaultLocale: u } = k ?? {}, [d, f] = c(e ?? Wt ?? t ?? u);
	i(() => {
		e && e !== d && f(e);
	}, [e]), i(() => {
		Xt();
...
}), { defaultLocale: en, locales: Q } = k ?? {}, tn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let { i18n: t, defaultComponent: n } = nn();
	return on(e, t, n);
}, cn = (e) => new Le({
	...e,
	registry: Rt()
...
cn({ locale: "en" });
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/Footer.tsx";
function ln() {
	let { i18n: e } = nn(), t = [
		{
...
var mn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/AppProviders.tsx";
function hn({ children: e }) {
	let t = u().locale ?? "en", n = o(() => fn(t), [t]), r = o(() => pn(t, n), [t, n]), [s] = c(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		dn("AppRoot", s);
	}, [s]), i(() => {
...
var gn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
function _n({ children: e }) {
	return d(hn, { children: e }, void 0, !1, {
		fileName: gn,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var vn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/Footer.wrapper.tsx";
function yn() {
	return d(_n, { children: d(ln, {}, void 0, !1, {
		fileName: vn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
