...
}, v = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(re).join("") : String(e ?? ""), ie = "translation", ae = "enumeration", oe = "plural", y = "insertion", se = "object", ce = "array", b = "markdown", x = "html", S = "gender", C = "select", w = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), T = (e, t) => {
...
})() }), me = (e) => w(oe, e), he = (e, t) => w(C, e, { variable: t }), ge = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, Ae = 50, I = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Set(), je = (e) => {
...
var Pe = (e, t, n) => e[R("PluralRules", n).select(t)] ?? e.other, Fe = (e, t) => {
	...
	if (r.nodeType === "plural") {
		let e = r[oe];
		return V(Pe(e, Number(B(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[ae], i = Ie.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	i18next: xe,
	"vue-i18n": Ee
}, He = (e, t = {}, n = "en", r = "icu") => Be(Ve[r])(e, t, n), Ue = (e) => {
	...
	get messages() {
		...
		return this._dictionaryContent !== void 0 && Object.assign(e, ne(this._dictionaryContent)), {
...
}, Ge = t(null), Ke = /* @__PURE__ */ new WeakMap(), qe = 0, Je = (e) => {
	if (!e) return "base";
	let t = Ke.get(e);
	if (t) return t;
	qe += 1;
	let n = `p${qe}`;
	return Ke.set(e, n), n;
}, Ye = 256, H = /* @__PURE__ */ new WeakMap(), Xe = (e) => typeof e == "object" && !!e, Ze = (e, t, n) => `${e}_${t}_${Je(n)}`, Qe = (e, t) => {
	...
	if (!Xe(e)) return n;
	let r = H.get(e);
	return r || (r = /* @__PURE__ */ new Map(), H.set(e, r)), r.size >= Ye && r.clear(), r.set(t, n), n;
}, $e = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), W = "default", et = /[^A-Za-z0-9._&=-]/g, tt = /[^A-Za-z0-9._-]/g, nt = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, G = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, nt);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, rt = (e) => e === void 0 ? W : typeof e == "string" ? G(e, et) : Object.keys(e).sort().map((t) => `${G(t, tt)}=${G(String(e[t]), tt)}`).join("&"), it = (e) => Array.isArray(e) ? e.length === 0 ? [W] : e.map(rt) : [rt(e)], at = (e, t) => {
	...
	if (!st(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? W : at(it(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => ot(e, n, t, s)).map((t) => ct(e, t));
	return i ? c.sort((e, t) => (e.item ?? 0) - (t.item ?? 0)) : c[0] ?? null;
}, ut = (e) => typeof e == "object" && e ? {
	locale: e.locale,
	selector: e
} : { locale: e }, dt = (e) => e ? Object.keys(e).filter((e) => e !== "locale").sort().map((t) => {
	let n = e[t];
	return `${t}:${t === "variant" ? it(n).join(",") : String(n)}`;
}).join("|") : "", K = "\x1B[0m", ft = "\x1B[34m", pt = "\x1B[31m", mt = "\x1B[32m", ht = "\x1B[38;5;3m", gt = (e) => e, _t = (e, t) => {
...
}), q = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? K : n : K}` : e, yt = (e, t = ht, n = K) => [e].flat().map((e) => q(e, t, n)).join(", ");
q("✗", pt), q("✓", mt), q("⏲", ft);
var bt = {
	header: {
		key: "header",
	...
	yield e;
} : Ct(e ? `${e}.${String(n)}` : String(n)) }), wt = /* @__PURE__ */ new Set(), Tt = (e, t, n) => {
	let r = xt()[e];
	return r ? Ht(r, t, n) : (wt.has(e) || (vt({ log: ke })(typeof window > "u" ? `Dictionary ${yt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), wt.add(e)), Ct(e));
}, Et = (e) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, Mt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? Y : {
...
}, Nt = Y, Pt = Y, Ft = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? Y : {
	id: "insertion-plugin",
...
var Rt = (e) => Y, zt = Y, Bt = (e, t = !0) => [
	...
	let { locale: r, selector: i } = ut(t), a = Ze(r ?? P.defaultLocale, dt(i), n), o = Qe(e, a);
	if (o.hit) return o.content;
	let s = n ?? Bt(r), c = lt(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var X = {
	...
	if (!Yt) for (let t = 0; t < (F.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(F.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, Zt = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !Yt && F.storage.cookies) for (let n = 0; n < F.storage.cookies.length; n++) {
...
}, on = (e, t = P?.locales, n = P?.defaultLocale) => {
	...
	let { locales: l, defaultLocale: u } = P ?? {}, [d, p] = c(e ?? Qt ?? t ?? u);
	i(() => {
		e && e !== d && p(e);
	}, [e]), i(() => {
		an();
...
}), { defaultLocale: ln, locales: Q } = P ?? {}, un = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let i = pn(t.children, n), a = n[t.tag];
...
}), mn = ({ id: e, message: t, values: n, components: r, formats: i, comment: a, render: o, component: s }) => {
	let { i18n: c, defaultComponent: l } = dn(), u = c._(e, n ?? {}, { message: t }), p = r && Object.keys(r).length > 0, m;
	if (p) {
		let e = pn(Ue(u), r);
		m = f(d, { children: e });
	} else m = u;
...
function bn({ children: e }) {
	let t = u().locale ?? "en", n = o(() => vn(t), [t]), r = o(() => yn(t, n), [t, n]), [s] = c(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		_n("AppRoot", s);
	}, [s]), i(() => {
...
function xn({ children: e }) {
	return f(bn, { children: e });
}
function Sn() {
	return f(xn, { children: f(hn, {}) });
}
