...
var h = ({ href: e, children: t, ...n }) => {
	let r = l().locale ?? "en";
	return e == null || typeof e != "string" || p(e) ? d(c, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, b = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(te).join("") : String(e ?? ""), ne = "translation", x = "enumeration", S = "plural", re = "condition", C = "insertion", ie = "object", ae = "array", oe = "markdown", w = "html", T = "gender", E = "select", D = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), O = (e, t, n) => ({
...
})() }), pe = (e) => D(S, e), me = (e, t) => D(E, e, { variable: t }), he = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, xe = 50, L = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Set(), Se = (e) => {
...
var Te = (e, t, n) => e[z("PluralRules", n).select(t)] ?? e.other, Ee = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return U(r[C], t, n);
	if (r.nodeType === "html") return U(r[w], t, n);
	if (r.nodeType === "plural") {
		let e = r[S];
		return U(Te(e, Number(H(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[x], i = B.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[E], i = H(t, typeof r.variable == "string" ? r.variable : "value");
		return U(Ee(e, String(i ?? "")), t, n);
	}
	...
	get messages() {
		...
		for (let t of Object.values(this._boundDictionaries)) Object.assign(e, v(t));
		return {
...
var W = {
	...
	if (!Le) for (let t = 0; t < (I.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(I.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, ze = !1, Be, Ve = () => typeof window > "u" ? Re(W) : (ze ||= (Be = Re(W), !0), Be), He = (e, t) => {
	if (t?.isCookieEnabled !== !1 && (ze = !1, !Le && I.storage.cookies)) for (let n = 0; n < I.storage.cookies.length; n++) {
...
}, Ue = /* @__PURE__ */ new WeakMap(), We = 0, Ge = (e) => {
	if (!e) return "base";
	let t = Ue.get(e);
	if (t) return t;
	We += 1;
	let n = `p${We}`;
	return Ue.set(e, n), n;
}, Ke = 256, G = /* @__PURE__ */ new WeakMap(), qe = (e) => typeof e == "object" && !!e, Je = (e, t, n) => `${e}_${t}_${Ge(n)}`, Ye = (e, t) => {
...
}, Xe = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), q = "\x1B[0m", Ze = "\x1B[34m", Qe = "\x1B[31m", $e = "\x1B[32m", et = "\x1B[38;5;3m", tt = (e) => e, nt = (e, t) => {
...
}), J = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? q : n : q}` : e, it = (e, t = et, n = q) => [e].flat().map((e) => J(e, t, n)).join(", ");
J("✗", Qe), J("✓", $e), J("⏲", Ze);
var at = {
	header: {
		key: "header",
	...
	let r = ot()[e];
	return r ? Mt(r, t, n) : (lt.has(e) || (rt({ log: be })(typeof window > "u" ? `Dictionary ${it(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), lt.add(e)), ct(e));
}, dt = (e) => {
	...
	if (typeof e == "string") return e;
	if (Y(e)) return e.nodeType === "html" ? e[w] : e[oe];
}, ht = (e, t) => {
	if (typeof e == "string") return t;
	if (Y(e)) {
		let n = e.nodeType === "html" ? w : oe;
		return {
			...e,
			[n]: t
		};
...
}, yt = X, bt = (e) => X, xt = X, St = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? X : {
	id: "insertion-plugin",
...
}, Tt = (e, t) => typeof t == "function" && Ct.includes(e?.nodeType ?? "") ? (n) => wt(e, t, n) : t, Et = X, Dt = X;
process.env.INTLAYER_OPTIMIZED_NESTING;
var Ot = (e) => X, kt = X, At = (e, t = !0) => [
	vt(e ?? F.defaultLocale, t ? F.defaultLocale : void 0),
	yt,
	bt(e ?? F.defaultLocale),
	xt,
	St,
	Ot(e ?? F.defaultLocale),
	kt,
	Et,
	Dt
].filter((e) => e !== X), jt = (e, t, n = []) => k(e, {
	...t,
	plugins: n
}), Z = /* @__PURE__ */ new WeakSet(), Mt = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = Je(r ?? F.defaultLocale, "", n), o = Ye(e, a);
	...
	get locale() {
		return Nt() ?? F?.defaultLocale;
	},
	setLocale: () => null,
	isCookieEnabled: !0
}), Lt = ({ locale: e, defaultLocale: t, variant: r, children: a, setLocale: c, disableEditor: l, isCookieEnabled: u }) => {
	let { locales: f, defaultLocale: p } = F ?? {}, [m, h] = s(() => e ?? Nt() ?? t ?? p), [g, ee] = s(e);
...
}), { defaultLocale: zt, locales: $ } = F ?? {}, Bt = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { locale: i, setLocale: a, isCookieEnabled: o } = r(It) ?? {};
	return {
		locale: i,
		defaultLocale: zt,
		availableLocales: $,
...
}), qt = ({ id: e, message: t, values: n, components: r, render: i, component: a }, o, s) => {
	...
	let { i18n: t, defaultComponent: n } = Gt();
	return qt(e, t, n);
}, Yt = (e) => new Pe({
	...e,
	registry: Wt()
...
Yt({ locale: "en" });
var Xt = ({ i18n: e, defaultComponent: t, children: n }) => {
	let r = (e) => ({
		i18n: e,
		_: e._.bind(e),
		defaultComponent: t
			...
			children: [f("div", {
				...
				children: [
					...
					f("div", { children: [d("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => d("li", { children: e.isInternal ? d(h, {
							href: e.href,
...
function nn({ children: e }) {
	let t = l().locale ?? "en", n = o(() => en(t), [t]), r = o(() => tn(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		$t("AppRoot", c);
	}, [c]), i(() => {
...
function rn({ children: e }) {
	return d(nn, { children: e });
}
function an() {
	return d(rn, { children: d(Zt, {}) });
}
