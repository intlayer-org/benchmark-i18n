...
var m = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/Link.tsx", ne = (e) => /^https?:\/\//.test(e ?? "");
function h(e, t) {
...
}, v = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(oe).join("") : String(e ?? ""), se = "translation", y = "enumeration", ce = "plural", b = "insertion", le = "object", ue = "array", de = "markdown", x = "html", fe = "gender", pe = "select", S = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), C = (e, t) => {
...
})() }), be = (e) => S(ce, e), xe = (e, t) => S(pe, e, { variable: t }), Se = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
var Pe = (e, t, n) => e[j("PluralRules", n).select(t)] ?? e.other, Fe = (e, t) => {
	...
	if (r.nodeType === "enumeration") {
		let e = r[y], i = Ie.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[pe], i = N(t, typeof r.variable == "string" ? r.variable : "value");
	...
	get messages() {
		...
		for (let t of Object.values(this._boundDictionaries)) Object.assign(e, ae(t));
		return {
...
}, F = e(null), I = /* @__PURE__ */ new WeakMap(), L = 0, Ue = (e) => {
	if (!e) return "base";
	let t = I.get(e);
	if (t) return t;
	L += 1;
	let n = `p${L}`;
	return I.set(e, n), n;
}, We = 256, R = /* @__PURE__ */ new WeakMap(), z = (e) => typeof e == "object" && !!e, Ge = (e, t, n) => `${e}_${t}_${Ue(n)}`, Ke = (e, t) => {
	if (!z(e)) return { hit: !1 };
	let n = R.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	if (!z(e)) return n;
	let r = R.get(e);
	return r || (r = /* @__PURE__ */ new Map(), R.set(e, r)), r.size >= We && r.clear(), r.set(t, n), n;
}, qe = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), V = "default", Je = /[^A-Za-z0-9._&=-]/g, Ye = /[^A-Za-z0-9._-]/g, Xe = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, H = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, Xe);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, Ze = (e) => e === void 0 ? V : typeof e == "string" ? H(e, Je) : Object.keys(e).sort().map((t) => `${H(t, Ye)}=${H(String(e[t]), Ye)}`).join("&"), Qe = (e) => Array.isArray(e) ? e.length === 0 ? [V] : e.map(Ze) : [Ze(e)], $e = (e, t) => {
	...
	if (!tt(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? V : $e(Qe(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => et(e, n, t, s)).map((t) => nt(e, t));
...
}).join("|") : "", U = "\x1B[0m", ot = "\x1B[34m", st = "\x1B[31m", ct = "\x1B[32m", lt = "\x1B[38;5;3m", ut = (e) => e, dt = (e, t) => {
...
}), W = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? U : n : U}` : e, pt = (e, t = lt, n = U) => [e].flat().map((e) => W(e, t, n)).join(", ");
W("✗", st), W("✓", ct), W("⏲", ot);
var mt = {
	header: {
		key: "header",
	...
	let r = ht()[e];
	return r ? It(r, t, n) : (vt.has(e) || (ft({ log: De })(typeof window > "u" ? `Dictionary ${pt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), vt.add(e)), _t(e));
}, bt = (e) => {
	...
	if (typeof e == "string") return e;
	if (G(e)) return e.nodeType === "html" ? e[x] : e[de];
}, wt = (e, t) => {
...
}, Dt = K, Ot = K, kt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? K : {
	id: "insertion-plugin",
...
var Mt = (e) => K, Nt = K, Pt = (e, t = !0) => [
	Et(e ?? k.defaultLocale, t ? k.defaultLocale : void 0),
	Dt,
	Ot,
	kt,
	...
	let { locale: r, selector: i } = it(t), a = Ge(r ?? k.defaultLocale, at(i), n), o = Ke(e, a);
	if (o.hit) return o.content;
	let s = n ?? Pt(r), c = rt(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var q = {
	...
	if (!Ut) for (let t = 0; t < (A.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(A.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, Gt = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !Ut && A.storage.cookies) for (let n = 0; n < A.storage.cookies.length; n++) {
...
}, Qt = (e, t = k?.locales, n = k?.defaultLocale) => {
	...
	locale: Kt ?? k?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), $t = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: a, disableEditor: o, isCookieEnabled: c }) => {
	let { locales: l, defaultLocale: u } = k ?? {}, [d, f] = s(e ?? Kt ?? t ?? u);
	r(() => {
		e && e !== d && f(e);
	}, [e]), r(() => {
		Zt();
...
}), { defaultLocale: tn, locales: X } = k ?? {}, nn = ({ isCookieEnabled: e, onLocaleChange: r } = {}) => {
...
on({ locale: "en" });
var sn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/ThemeToggle.tsx";
function cn() {
...
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/LocaleSwitcher.tsx";
function mn() {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/Header.tsx";
function gn() {
	let { i18n: e } = rn();
	hn("Header");
...
var yn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/AppProviders.tsx";
function bn({ children: e }) {
	let t = l().locale ?? "en", n = a(() => fn(t), [t]), o = a(() => pn(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		vn("AppRoot", c);
	}, [c]), r(() => {
...
var xn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
function Sn({ children: e }) {
	return f(bn, { children: e }, void 0, !1, {
		fileName: xn,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var Cn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/Header.wrapper.tsx";
function wn() {
	return f(Sn, { children: f(gn, {}, void 0, !1, {
		fileName: Cn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
