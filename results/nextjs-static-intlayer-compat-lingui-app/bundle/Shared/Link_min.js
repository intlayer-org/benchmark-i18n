...
var d = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/Link.tsx", f = (e) => /^https?:\/\//.test(e ?? "");
function p(e, t) {
...
}, g = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(ie).join("") : String(e ?? ""), ae = "translation", _ = "enumeration", v = "plural", y = "insertion", oe = "object", se = "array", ce = "markdown", b = "html", x = "gender", le = "select", S = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), C = (e, t) => {
...
})() }), ge = (e) => S(v, e), _e = (e, t) => S(le, e, { variable: t }), ve = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, we = 50, j = /* @__PURE__ */ new Map(), Te = /* @__PURE__ */ new Set(), Ee = (e) => {
	Te.has(e) || (Te.add(e), console.warn(`[intlayer] \`Intl.${e}\` is not available in this JavaScript engine. A degraded fallback is used instead. On React Native, load a polyfill (e.g. \`@formatjs/intl-${e.toLowerCase()}/polyfill\`) before rendering your app.`));
}, De = {
	DisplayNames: class {
		of(e) {
			return e;
...
var ke = (e, t, n) => e[M("PluralRules", n).select(t)] ?? e.other, Ae = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return I(r[y], t, n);
	if (r.nodeType === "html") return I(r[b], t, n);
	if (r.nodeType === "plural") {
		let e = r[v];
		return I(ke(e, Number(F(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[_], i = je.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[le], i = F(t, typeof r.variable == "string" ? r.variable : "value");
		return I(Ae(e, String(i ?? "")), t, n);
	}
...
}, Ne = ((e) => (t, n = {}, r = "en") => L(typeof t == "string" ? e(t) : t, n, r))(be), Pe = (e) => {
	let t = e.indexOf(".");
	return t === -1 ? {
		dictionaryKey: e,
		remainder: ""
	...
	_(e, t, n) {
		...
		return (c.kind === "node" ? L(c.node, o, s) : Ne(c.message, o, s)) ?? i;
	}
...
}, Ie = e(null), R = /* @__PURE__ */ new WeakMap(), z = 0, Le = (e) => {
	if (!e) return "base";
	let t = R.get(e);
	if (t) return t;
	z += 1;
	let n = `p${z}`;
	return R.set(e, n), n;
}, Re = 256, B = /* @__PURE__ */ new WeakMap(), V = (e) => typeof e == "object" && !!e, ze = (e, t, n) => `${e}_${t}_${Le(n)}`, Be = (e, t) => {
	if (!V(e)) return { hit: !1 };
	let n = B.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, U = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), W = "default", Ve = /[^A-Za-z0-9._&=-]/g, G = /[^A-Za-z0-9._-]/g, He = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, K = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, He);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, q = (e) => e === void 0 ? W : typeof e == "string" ? K(e, Ve) : Object.keys(e).sort().map((t) => `${K(t, G)}=${K(String(e[t]), G)}`).join("&"), Ue = (e) => Array.isArray(e) ? e.length === 0 ? [W] : e.map(q) : [q(e)], We = (e, t) => {
	...
	if (!Ke(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? W : We(Ue(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Ge(e, n, t, s)).map((t) => qe(e, t));
...
}).join("|") : "", J = "\x1B[0m", Ze = "\x1B[34m", Qe = "\x1B[31m", $e = "\x1B[32m", et = "\x1B[38;5;3m", tt = (e) => e, nt = (e, t) => {
...
}), Y = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? J : n : J}` : e, it = (e, t = et, n = J) => [e].flat().map((e) => Y(e, t, n)).join(", ");
Y("✗", Qe), Y("✓", $e), Y("⏲", Ze);
var at = {
	header: {
		key: "header",
	...
	let r = ot()[e];
	return r ? Dt(r, t, n) : (lt.has(e) || (rt({ log: Ce })(typeof window > "u" ? `Dictionary ${it(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), lt.add(e)), ct(e));
}, dt = (e) => {
	...
	if (typeof e == "string") return e;
	if (X(e)) return e.nodeType === "html" ? e[b] : e[ce];
}, ht = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, _t = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? Z : {
...
}, vt = Z, yt = Z, bt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? Z : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: y }], i = e[y], a = {
			...
			transform: (e, n, r) => {
				if (X(e)) return (i) => gt(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
var Ct = (e) => Z, wt = Z, Tt = (e, t = !0) => [
	_t(e ?? k.defaultLocale, t ? k.defaultLocale : void 0),
	vt,
	yt,
	bt,
	Ct(e ?? k.defaultLocale),
	wt,
	xt,
	St
], Et = (e, t, n = []) => C(e, {
	...
	let { locale: r, selector: i } = Ye(t), a = ze(r ?? k.defaultLocale, Xe(i), n), o = Be(e, a);
	if (o.hit) return o.content;
	let s = n ?? Tt(r), c = Je(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
	...
	let n = Ot(), r = e.indexOf("."), i = r === -1 ? e : e.slice(0, r), a = (e) => {
		try {
			return ut(e, t);
		} catch {
			return;
...
var Q = {
	...
	if (!Pt) for (let t = 0; t < (A.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(A.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, It = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !Pt && A.storage.cookies) for (let n = 0; n < A.storage.cookies.length; n++) {
...
}, Wt = (e, t = k?.locales, n = k?.defaultLocale) => {
	...
	locale: Lt ?? k?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), Gt = ({ locale: e, defaultLocale: t, variant: r, children: i, setLocale: a, disableEditor: s, isCookieEnabled: c }) => {
	let { locales: l, defaultLocale: ee } = k ?? {}, [d, f] = o(e ?? Lt ?? t ?? ee);
	n(() => {
		e && e !== d && f(e);
	}, [e]), n(() => {
		Ut();
...
var $t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/AppProviders.tsx";
function en({ children: e }) {
	let t = c().locale ?? "en", a = i(() => Zt(t), [t]), s = i(() => Qt(t, a), [t, a]), [u] = o(() => typeof performance < "u" ? performance.now() : 0);
	return r(() => {
		Xt("AppRoot", u);
	}, [u]), n(() => {
...
var tn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
function nn({ children: e }) {
	return l(en, { children: e }, void 0, !1, {
		fileName: tn,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var rn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/Link.wrapper.tsx";
function an() {
	return l(nn, { children: l(m, {}, void 0, !1, {
		fileName: rn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
