...
})() }), le = (e) => T(y, e), ue = (e, t) => T(w, e, { variable: t }), de = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, _e = 50, I = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Set(), ve = (e) => {
...
var xe = (e, t, n) => e[R("PluralRules", n).select(t)] ?? e.other, Se = (e, t) => {
	...
	let o = B(t, r);
	return o === void 0 ? e : i ? V(o, i, a, n) : String(o);
}).replace(/\{\s*([\w.]+)\s*,\s*(\w+)\s*(?:,\s*([^}]+?)\s*)?\}/g, (e, r, i, a) => {
	let o = B(t, r);
	return o === void 0 ? e : V(o, i, a, n);
}).replace(/\{\s*([\w.]+)\s*\}/g, (e, n) => {
	let r = B(t, n);
	...
	let r = e;
	if (r.nodeType === "insertion") return U(r[b], t, n);
	if (r.nodeType === "html") return U(r[S], t, n);
	if (r.nodeType === "plural") {
		let e = r[y];
		return U(xe(e, Number(H(t, "count") ?? 1), n), t, n);
	}
	...
	if (r.nodeType === "select") {
		let e = r[w], i = H(t, typeof r.variable == "string" ? r.variable : "value");
		return U(Se(e, String(i ?? "")), t, n);
	}
...
}, Te = ((e) => (t, n = {}, r = "en") => we(typeof t == "string" ? e(t) : t, n, r))(pe), Ee = (e) => {
	let t = e.indexOf(".");
	return t === -1 ? {
		dictionaryKey: e,
		remainder: ""
	...
	lookupBoundDictionaries(e) {
		let { dictionaryKey: t, remainder: n } = Ee(e), r = this._boundDictionaries[t];
		if (r !== void 0) {
			let e = h(r, n);
	...
	_(e, t, n) {
		...
		return (c.kind === "node" ? we(c.node, o, s) : Te(c.message, o, s)) ?? i;
	}
...
var W = {
...
}, je = !1, Me, Ne = () => typeof window > "u" ? G(W) : (je ||= (Me = G(W), !0), Me), Pe = (e, t) => {
	if (t?.isCookieEnabled !== !1 && (je = !1, !Ae && F.storage.cookies)) for (let n = 0; n < F.storage.cookies.length; n++) {
	...
	let n = `p${Ie}`;
	return Fe.set(e, n), n;
}, Re = 256, K = /* @__PURE__ */ new WeakMap(), ze = (e) => typeof e == "object" && !!e, Be = (e, t, n) => `${e}_${t}_${Le(n)}`, Ve = (e, t) => {
...
}, He = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), J = "\x1B[0m", Ue = "\x1B[34m", We = "\x1B[31m", Ge = "\x1B[32m", Ke = "\x1B[38;5;3m", qe = (e) => e, Je = (e, t) => {
...
}), Y = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? J : n : J}` : e, Xe = (e, t = Ke, n = J) => [e].flat().map((e) => Y(e, t, n)).join(", ");
Y("✗", We), Y("✓", Ge), Y("⏲", Ue);
var Ze = {
	header: {
		key: "header",
...
}, Qe = () => Ze, $e = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), et = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : $e.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : et(e ? `${e}.${String(n)}` : String(n)) }), tt = /* @__PURE__ */ new Set(), nt = (e, t, n) => {
	let r = Qe()[e];
	return r ? wt(r, t, n) : (tt.has(e) || (Ye({ log: ge })(typeof window > "u" ? `Dictionary ${Xe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), tt.add(e)), et(e));
}, rt = (e) => {
	...
	if (typeof e == "string") return e;
	if (X(e)) return e.nodeType === "html" ? e[S] : e[x];
}, st = (e, t) => {
...
}, ut = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? Z : {
...
}, dt = Z, ft = (e) => Z, pt = Z, mt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? Z : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: b }], i = e[b], a = {
			...
			transform: (e, n, r) => {
				if (X(e)) return (i) => ct(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, _t = (e, t) => typeof t == "function" && ht.includes(e?.nodeType ?? "") ? (n) => gt(e, t, n) : t, vt = Z, yt = Z;
process.env.INTLAYER_OPTIMIZED_NESTING;
var bt = (e) => Z, xt = Z, St = (e, t = !0) => [
	ut(e ?? P.defaultLocale, t ? P.defaultLocale : void 0),
	dt,
	ft(e ?? P.defaultLocale),
	pt,
	mt,
	...
	vt,
	yt
].filter((e) => e !== Z), Ct = (e, t, n = []) => D(e, {
	...t,
	plugins: n
}), Q = /* @__PURE__ */ new WeakSet(), wt = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = Be(r ?? P.defaultLocale, "", n), o = Ve(e, a);
...
}, Ot = (e, t = P?.locales, n = P?.defaultLocale) => {
	...
	get locale() {
		return Tt() ?? P?.defaultLocale;
	},
	setLocale: () => null,
	isCookieEnabled: !0
}), At = ({ locale: e, defaultLocale: r, variant: o, children: s, setLocale: c, disableEditor: u, isCookieEnabled: d }) => {
	let { locales: f, defaultLocale: p } = P ?? {}, [m, h] = a(() => e ?? Tt() ?? r ?? p), [ee, g] = a(e);
...
$({ locale: "en" });
var It = ({ i18n: e, defaultComponent: t, children: r }) => {
	let i = (e) => ({
		i18n: e,
		_: e._.bind(e),
		defaultComponent: t
...
function Wt({ children: e }) {
	let t = o().locale ?? "en", s = i(() => zt(t), [t]), c = i(() => Bt(t, s), [t, s]), [u] = a(() => typeof performance < "u" ? performance.now() : 0);
	return r(() => {
		Ut("AppRoot", u);
	}, [u]), n(() => {
...
function Gt({ children: e }) {
	return l(Wt, { children: e });
}
function Kt() {
	return l(Gt, { children: l(Vt, {}) });
}
