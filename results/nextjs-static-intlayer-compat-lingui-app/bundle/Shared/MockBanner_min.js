...
}, P = e(null), F = /* @__PURE__ */ new WeakMap(), I = 0, Ie = (e) => {
	if (!e) return "base";
	let t = F.get(e);
	if (t) return t;
	I += 1;
...
}).join("|") : "", K = "\x1B[0m", Ye = "\x1B[34m", Xe = "\x1B[31m", Ze = "\x1B[32m", Qe = "\x1B[38;5;3m", $e = (e) => e, et = (e, t) => {
...
var rt = {
	...
	let r = it()[e];
	return r ? Tt(r, t, n) : (st.has(e) || (tt({ log: be })(typeof window > "u" ? `Dictionary ${nt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), st.add(e)), ot(e));
}, lt = (e) => {
	...
	if (typeof e == "string") return e;
	if (J(e)) return e.nodeType === "html" ? e[v] : e[oe];
}, pt = (e, t) => {
...
}, gt = Y, _t = Y, vt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? Y : {
	id: "insertion-plugin",
...
var X = {
...
}, Vt = (e, t = O?.locales, n = O?.defaultLocale) => {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), Ht = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: a, disableEditor: o, isCookieEnabled: l }) => {
	let { locales: u, defaultLocale: ee } = O ?? {}, [d, f] = s(e ?? Z ?? t ?? ee);
	r(() => {
		e && e !== d && f(e);
	}, [e]), r(() => {
		Bt();
...
}), { defaultLocale: Wt, locales: $ } = O ?? {}, Gt = ({ isCookieEnabled: e, onLocaleChange: r } = {}) => {
...
Jt({ locale: "en" });
var Yt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/MockBanner.tsx", Xt = () => {
	let { i18n: e } = Kt();
	return u("div", {
...
var on = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/MockBanner.wrapper.tsx";
function sn() {
