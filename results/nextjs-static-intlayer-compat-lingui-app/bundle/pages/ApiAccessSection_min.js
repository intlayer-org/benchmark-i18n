...
var Y = {
...
}, nn = (e, t = N?.locales, n = N?.defaultLocale) => {
...
}), { defaultLocale: on, locales: Q } = N ?? {}, sn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let { i18n: c, defaultComponent: l } = cn(), f = c._(e, n ?? {}, { message: t }), p = r && Object.keys(r).length > 0, m;
	if (p) {
		let e = un(Ve(f), r);
		m = d(u, { children: e });
	} else m = f;
