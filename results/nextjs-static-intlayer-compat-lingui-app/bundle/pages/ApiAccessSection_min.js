...
var U = {
	...
	if (!Fe) for (let t = 0; t < (I.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(I.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, Le = !1, Re, ze = () => typeof window > "u" ? Ie(U) : (Le ||= (Re = Ie(U), !0), Re), Be = (e, t) => {
	if (t?.isCookieEnabled !== !1 && (Le = !1, !Fe && I.storage.cookies)) for (let n = 0; n < I.storage.cookies.length; n++) {
...
var rt = {
	...
	let r = it()[e];
	return r ? At(r, t, n) : (st.has(e) || (tt({ log: _e })(typeof window > "u" ? `Dictionary ${nt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), st.add(e)), ot(e));
}, lt = (e) => {
...
var Et = (e) => Y, Dt = Y, Ot = (e, t = !0) => [
	gt(e ?? F.defaultLocale, t ? F.defaultLocale : void 0),
	_t,
	vt(e ?? F.defaultLocale),
	yt,
	bt,
	Et(e ?? F.defaultLocale),
	Dt,
	wt,
	Tt
	...
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = Ke(r ?? F.defaultLocale, "", n), o = qe(e, a);
...
}, Pt = (e, t = F?.locales, n = F?.defaultLocale) => {
...
}), { defaultLocale: Lt, locales: Q } = F ?? {}, Rt = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
