...
var J = {
	...
	let { locales: l, defaultLocale: d } = O ?? {}, [f, p] = c(e ?? Y ?? t ?? d);
	i(() => {
		e && e !== f && p(e);
	}, [e]), i(() => {
		qt();
	...
	let { i18n: t, defaultComponent: n } = Q();
	return tn(e, t, n);
}, rn = (e) => new P({
	...e,
	registry: It()
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/pages/careers/CareersHeader.tsx";
function sn() {
	let { i18n: e } = Q();
	return p(f, { children: [
		p(on, {}, void 0, !1, {
...
var gn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/pages/careers/CareersHeader.wrapper.tsx";
function _n() {
