...
}, _ = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(ee).join("") : String(e ?? ""), v = "translation", y = "enumeration", b = "plural", te = "condition", x = "insertion", ne = "object", re = "array", S = "markdown", C = "html", w = "gender", T = "select", E = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), D = (e, t, n) => ({
...
})() }), ue = (e) => E(b, e), de = (e, t) => E(T, e, { variable: t }), fe = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
var we = (e, t, n) => e[I("PluralRules", n).select(t)] ?? e.other, Te = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return z(r[x], t, n);
	if (r.nodeType === "html") return z(r[C], t, n);
	if (r.nodeType === "plural") {
		let e = r[b];
		return z(we(e, Number(R(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[y], i = Ee.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
}, Ae = (e) => (t, n = {}, r = "en") => ke(typeof t == "string" ? e(t) : t, n, r), je = (e) => {
	...
	_(e, t, n) {
		...
		return (c.kind === "node" ? ke(c.node, o, s) : Me(c.message, o, s)) ?? i;
	}
...
var H = {
	...
	if (!V) for (let t = 0; t < (F.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(F.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, Ie = !1, Le, Re = () => typeof window > "u" ? U(H) : (Ie ||= (Le = U(H), !0), Le), ze = (e, t) => {
	if (t?.isCookieEnabled !== !1 && (Ie = !1, !V && F.storage.cookies)) for (let n = 0; n < F.storage.cookies.length; n++) {
...
var nt = {
	...
	"toLocaleString"
]), J = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : it.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : J(e ? `${e}.${String(n)}` : String(n)) }), at = /* @__PURE__ */ new Set(), ot = (e, t, n) => {
	let r = rt()[e];
	return r ? Ot(r, t, n) : (at.has(e) || (et({ log: _e })(typeof window > "u" ? `Dictionary ${tt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), at.add(e)), J(e));
}, st = (e) => {
...
}, mt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? X : {
...
}, ht = X, gt = (e) => X, _t = X, vt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? X : {
	id: "insertion-plugin",
...
}, xt = (e, t) => typeof t == "function" && yt.includes(e?.nodeType ?? "") ? (n) => bt(e, t, n) : t, St = X, Ct = X;
process.env.INTLAYER_OPTIMIZED_NESTING;
var wt = (e) => X, Tt = X, Et = (e, t = !0) => [
	mt(e ?? P.defaultLocale, t ? P.defaultLocale : void 0),
	ht,
	gt(e ?? P.defaultLocale),
	_t,
	vt,
	wt(e ?? P.defaultLocale),
	Tt,
	St,
	Ct
].filter((e) => e !== X), Dt = (e, t, n = []) => O(e, {
	...t,
	plugins: n
}), Z = /* @__PURE__ */ new WeakSet(), Ot = (e, t, n) => {
...
}, Mt = (e, t = P?.locales, n = P?.defaultLocale) => {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), Pt = ({ locale: e, defaultLocale: t, variant: r, children: a, setLocale: c, disableEditor: u, isCookieEnabled: d }) => {
	let { locales: f, defaultLocale: p } = P ?? {}, [m, h] = s(() => e ?? kt() ?? t ?? p), [g, ee] = s(e);
	e !== g && (ee(e), e && e !== m && h(e)), i(() => {
		jt();
	}, []);
	let _ = n((e) => {
	...
	return l(Nt.Provider, {
		value: b,
		children: a
	});
}, Ft = ({ children: e, ...t }) => u(Pt, {
	...t,
	children: [
		!1,
		!1,
...
}), { defaultLocale: It, locales: Q } = P ?? {}, Lt = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { locale: i, setLocale: a, isCookieEnabled: o } = r(Nt) ?? {};
	return {
		locale: i,
		defaultLocale: It,
		availableLocales: Q,
...
}), Ut = ({ id: e, message: t, values: n, components: r, render: i, component: a }, o, s) => {
...
function $t({ children: e }) {
	let t = d().locale ?? "en", n = o(() => Zt(t), [t]), r = o(() => Qt(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		Xt("AppRoot", c);
	}, [c]), i(() => {
...
function en({ children: e }) {
	return l($t, { children: e });
}
function tn() {
	return l(en, { children: l(Jt, {}) });
}
