...
var je = (e, t, n) => e[L("PluralRules", n).select(t)] ?? e.other, Me = (e, t) => {
...
}, Le = (e) => (t, n = {}, r = "en") => Ie(typeof t == "string" ? e(t) : t, n, r), Re = {
	icu: he,
	i18next: ve,
	"vue-i18n": Ce
}, ze = (e, t = {}, n = "en", r = "icu") => Le(Re[r])(e, t, n), Be = (e) => {
...
}, He = t(null), Ue = /* @__PURE__ */ new WeakMap(), We = 0, Ge = (e) => {
	if (!e) return "base";
	let t = Ue.get(e);
	if (t) return t;
	We += 1;
	let n = `p${We}`;
	return Ue.set(e, n), n;
}, Ke = 256, V = /* @__PURE__ */ new WeakMap(), qe = (e) => typeof e == "object" && !!e, Je = (e, t, n) => `${e}_${t}_${Ge(n)}`, Ye = (e, t) => {
	...
	if (!qe(e)) return n;
	let r = V.get(e);
	return r || (r = /* @__PURE__ */ new Map(), V.set(e, r)), r.size >= Ke && r.clear(), r.set(t, n), n;
}, Xe = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), U = "default", Ze = /[^A-Za-z0-9._&=-]/g, W = /[^A-Za-z0-9._-]/g, Qe = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, G = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, Qe);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, $e = (e) => e === void 0 ? U : typeof e == "string" ? G(e, Ze) : Object.keys(e).sort().map((t) => `${G(t, W)}=${G(String(e[t]), W)}`).join("&"), et = (e) => Array.isArray(e) ? e.length === 0 ? [U] : e.map($e) : [$e(e)], tt = (e, t) => {
	...
	if (!rt(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? U : tt(et(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => nt(e, n, t, s)).map((t) => it(e, t));
...
}).join("|") : "", K = "\x1B[0m", ct = "\x1B[34m", lt = "\x1B[31m", ut = "\x1B[32m", dt = "\x1B[38;5;3m", ft = (e) => e, pt = (e, t) => {
...
}), q = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? K : n : K}` : e, ht = (e, t = dt, n = K) => [e].flat().map((e) => q(e, t, n)).join(", ");
q("✗", lt), q("✓", ut), q("⏲", ct);
var gt = {
	header: {
		key: "header",
	...
	let r = _t()[e];
	return r ? Rt(r, t, n) : (bt.has(e) || (mt({ log: Ee })(typeof window > "u" ? `Dictionary ${ht(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), bt.add(e)), yt(e));
}, St = (e) => {
...
}, kt = Y, At = Y, jt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? Y : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: b }], i = e[b], a = {
			...
			transform: (e, n, r) => {
				if (J(e)) return (i) => Dt(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
var Pt = (e) => Y, Ft = Y, It = (e, t = !0) => [
	Ot(e ?? N.defaultLocale, t ? N.defaultLocale : void 0),
	kt,
	At,
	jt,
	Pt(e ?? N.defaultLocale),
	Ft,
	Mt,
	Nt
], Lt = (e, t, n = []) => C(e, {
	...
	let { locale: r, selector: i } = ot(t), a = Je(r ?? N.defaultLocale, st(i), n), o = Ye(e, a);
	if (o.hit) return o.content;
	let s = n ?? It(r), c = at(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var X = {
	...
	if (!Gt) for (let t = 0; t < (P.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(P.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, qt = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !Gt && P.storage.cookies) for (let n = 0; n < P.storage.cookies.length; n++) {
...
}, tn = (e, t = N?.locales, n = N?.defaultLocale) => {
...
}), { defaultLocale: an, locales: Q } = N ?? {}, on = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let { i18n: c, defaultComponent: d } = $(), f = c._(e, n ?? {}, { message: t }), p = r && Object.keys(r).length > 0, m;
	if (p) {
		let e = cn(Be(f), r);
		m = u(l, { children: e });
	} else m = f;
