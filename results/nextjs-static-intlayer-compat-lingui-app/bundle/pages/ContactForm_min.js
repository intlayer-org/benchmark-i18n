...
}, _ = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(ee).join("") : String(e ?? ""), te = "translation", ne = "enumeration", re = "plural", v = "insertion", ie = "object", ae = "array", y = "markdown", b = "html", x = "gender", oe = "select", S = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), C = (e, t) => {
...
})() }), pe = (e) => S(re, e), me = (e, t) => S(oe, e, { variable: t }), he = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (e.length === 1) {
		...
		if (t.type === "plural") {
			...
			if (n) {
				...
				return e.__intlayer_icu_var = t.name, se(e);
			}
		...
		if (t.type === "selectordinal") {
			...
			return e.__intlayer_icu_var = t.name, e.__intlayer_icu_ordinal = !0, se(e);
		}
	}
	return e.map((e) => O([e]));
}, ge = {
...
}, xe = 50, j = /* @__PURE__ */ new Map(), Se = /* @__PURE__ */ new Set(), Ce = (e) => {
...
var Ee = (e, t, n) => e[M("PluralRules", n).select(t)] ?? e.other, De = (e, t) => {
	...
	if (r.nodeType === "html") return I(r[b], t, n);
	if (r.nodeType === "plural") {
		let e = r[re];
		return I(Ee(e, Number(F(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[ne], i = N.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
}, je = ((e) => (t, n = {}, r = "en") => Ae(typeof t == "string" ? e(t) : t, n, r))(_e), Me = (e) => {
	let t = e.indexOf(".");
	return t === -1 ? {
		dictionaryKey: e,
		remainder: ""
	...
	lookupBoundDictionaries(e) {
		let { dictionaryKey: t, remainder: n } = Me(e), r = this._boundDictionaries[t];
		if (r !== void 0) {
			let e = g(r, n);
	...
	_(e, t, n) {
		...
		return (c.kind === "node" ? Ae(c.node, o, s) : je(c.message, o, s)) ?? i;
	}
...
}, Pe = e(null), Fe = /* @__PURE__ */ new WeakMap(), L = 0, Ie = (e) => {
	if (!e) return "base";
	let t = Fe.get(e);
	if (t) return t;
	L += 1;
	let n = `p${L}`;
	return Fe.set(e, n), n;
}, Le = 256, R = /* @__PURE__ */ new WeakMap(), z = (e) => typeof e == "object" && !!e, Re = (e, t, n) => `${e}_${t}_${Ie(n)}`, ze = (e, t) => {
	if (!z(e)) return { hit: !1 };
	let n = R.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	if (!z(e)) return n;
	let r = R.get(e);
	return r || (r = /* @__PURE__ */ new Map(), R.set(e, r)), r.size >= Le && r.clear(), r.set(t, n), n;
}, V = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), H = "default", Be = /[^A-Za-z0-9._&=-]/g, U = /[^A-Za-z0-9._-]/g, Ve = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, W = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, Ve);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, G = (e) => e === void 0 ? H : typeof e == "string" ? W(e, Be) : Object.keys(e).sort().map((t) => `${W(t, U)}=${W(String(e[t]), U)}`).join("&"), He = (e) => Array.isArray(e) ? e.length === 0 ? [H] : e.map(G) : [G(e)], Ue = (e, t) => {
	...
	if (!Ge(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? H : Ue(He(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => We(e, n, t, s)).map((t) => Ke(e, t));
...
}).join("|") : "", K = "\x1B[0m", Xe = "\x1B[34m", Ze = "\x1B[31m", Qe = "\x1B[32m", $e = "\x1B[38;5;3m", et = (e) => e, tt = (e, t) => {
...
}), q = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? K : n : K}` : e, rt = (e, t = $e, n = K) => [e].flat().map((e) => q(e, t, n)).join(", ");
q("✗", Ze), q("✓", Qe), q("⏲", Xe);
var it = {
	header: {
		key: "header",
	...
	let r = at()[e];
	return r ? Et(r, t, n) : (ct.has(e) || (nt({ log: be })(typeof window > "u" ? `Dictionary ${rt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), ct.add(e)), st(e));
}, ut = (e) => {
	...
	if (typeof e == "string") return e;
	if (J(e)) return e.nodeType === "html" ? e[b] : e[y];
}, mt = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, gt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? Y : {
...
}, _t = Y, vt = Y, yt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? Y : {
	id: "insertion-plugin",
...
var St = (e) => Y, Ct = Y, wt = (e, t = !0) => [
	gt(e ?? k.defaultLocale, t ? k.defaultLocale : void 0),
	_t,
	vt,
	yt,
	...
	let { locale: r, selector: i } = Je(t), a = Re(r ?? k.defaultLocale, Ye(i), n), o = ze(e, a);
	if (o.hit) return o.content;
	let s = n ?? wt(r), c = qe(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
	...
	let n = Dt(), r = e.indexOf("."), i = r === -1 ? e : e.slice(0, r), a = (e) => {
		try {
			return lt(e, t);
		} catch {
			return;
...
var X = {
	...
	if (!Nt) for (let t = 0; t < (A.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(A.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, Ft = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !Nt && A.storage.cookies) for (let n = 0; n < A.storage.cookies.length; n++) {
...
}, Ut = (e, t = k?.locales, n = k?.defaultLocale) => {
	...
	locale: It ?? k?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), Wt = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: a, disableEditor: o, isCookieEnabled: s }) => {
	let { locales: u, defaultLocale: d } = k ?? {}, [f, p] = c(e ?? It ?? t ?? d);
	r(() => {
		e && e !== f && p(e);
	}, [e]), r(() => {
		Ht();
...
}), { defaultLocale: Kt, locales: Q } = k ?? {}, qt = ({ isCookieEnabled: e, onLocaleChange: r } = {}) => {
	...
	return e || r;
}, Yt = ({ i18n: e, defaultComponent: t, children: n }) => {
	let i = (e) => ({
		i18n: e,
		_: e._.bind(e),
		defaultComponent: t
	}), [a, o] = c(() => i(e)), [s, u] = c(e.locale);
...
Xt({ locale: "en" });
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/pages/contact/ContactForm.tsx";
function Zt() {
	let { i18n: e } = Jt(), t = i(), n = i(), r = i(), a = i();
	return d("form", {
		className: "space-y-6",
		children: [
			d("div", {
			...
			d("div", { children: [d("label", {
				...
				children: [
					d("option", { children: e._("contact-form.bugReport") }, void 0, !1, {
						fileName: $,
						lineNumber: 56,
						columnNumber: 11
					}, this),
					d("option", { children: e._("contact-form.newBenchmarkIdea") }, void 0, !1, {
						fileName: $,
						lineNumber: 57,
						columnNumber: 11
					}, this),
					d("option", { children: e._("contact-form.methodologyQuestion") }, void 0, !1, {
						fileName: $,
						lineNumber: 58,
						columnNumber: 11
					}, this),
					d("option", { children: e._("contact-form.contribution") }, void 0, !1, {
						fileName: $,
						lineNumber: 59,
						columnNumber: 11
					}, this),
					d("option", { children: e._("contact-form.other") }, void 0, !1, {
						fileName: $,
						lineNumber: 60,
						columnNumber: 11
					}, this)
...
var nn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/AppProviders.tsx";
function rn({ children: e }) {
	let t = f().locale ?? "en", n = o(() => en(t), [t]), i = o(() => tn(t, n), [t, n]), [s] = c(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		$t("AppRoot", s);
	}, [s]), r(() => {
...
var an = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
function on({ children: e }) {
	return d(rn, { children: e }, void 0, !1, {
		fileName: an,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var sn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/pages/contact/ContactForm.wrapper.tsx";
function cn() {
	return d(on, { children: d(Zt, {}, void 0, !1, {
		fileName: sn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
