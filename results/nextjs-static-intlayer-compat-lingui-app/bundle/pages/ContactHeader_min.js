...
}, te = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(ee).join("") : String(e ?? ""), ne = "translation", re = "enumeration", _ = "plural", v = "insertion", ie = "object", ae = "array", oe = "markdown", y = "html", b = "gender", se = "select", x = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), S = (e, t) => {
...
})() }), me = (e) => x(_, e), he = (e, t) => x(se, e, { variable: t }), ge = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, Se = 50, A = /* @__PURE__ */ new Map(), Ce = /* @__PURE__ */ new Set(), we = (e) => {
...
var De = (e, t, n) => e[j("PluralRules", n).select(t)] ?? e.other, Oe = (e, t) => {
	...
	if (r.nodeType === "plural") {
		let e = r[_];
		return I(De(e, Number(F(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[re], i = M.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[se], i = F(t, typeof r.variable == "string" ? r.variable : "value");
		return I(Oe(e, String(i ?? "")), t, n);
	}
...
}, je = ((e) => (t, n = {}, r = "en") => Ae(typeof t == "string" ? e(t) : t, n, r))(ve), Me = (e) => {
	let t = e.indexOf(".");
	return t === -1 ? {
		dictionaryKey: e,
		remainder: ""
...
var it = {
	...
	let r = at()[e];
	return r ? Et(r, t, n) : (ct.has(e) || (nt({ log: xe })(typeof window > "u" ? `Dictionary ${rt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), ct.add(e)), st(e));
}, ut = (e) => {
	...
	if (typeof e == "string") return e;
	if (J(e)) return e.nodeType === "html" ? e[y] : e[oe];
}, mt = (e, t) => {
	if (typeof e == "string") return t;
	if (J(e)) {
		let n = e.nodeType === "html" ? y : oe;
		return {
			...e,
			[n]: t
		};
...
var St = (e) => Y, Ct = Y, wt = (e, t = !0) => [
	...
	let { locale: r, selector: i } = Je(t), a = Re(r ?? O.defaultLocale, Ye(i), n), o = ze(e, a);
...
}, Ut = (e, t = O?.locales, n = O?.defaultLocale) => {
...
}), { defaultLocale: Kt, locales: Q } = O ?? {}, qt = ({ isCookieEnabled: e, onLocaleChange: r } = {}) => {
...
Xt({ locale: "en" });
var Zt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/MockBanner.tsx", Qt = () => {
	let { i18n: e } = Jt();
	return d("div", {
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/pages/contact/ContactHeader.tsx";
function $t() {
	let { i18n: e } = Jt();
	return d(u, { children: [
		d(Qt, {}, void 0, !1, {
...
var an = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/AppProviders.tsx";
function on({ children: e }) {
	let t = f().locale ?? "en", n = a(() => nn(t), [t]), o = a(() => rn(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		tn("AppRoot", c);
	}, [c]), r(() => {
...
var sn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
function cn({ children: e }) {
	return d(on, { children: e }, void 0, !1, {
		fileName: sn,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var ln = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/pages/contact/ContactHeader.wrapper.tsx";
function un() {
	return d(cn, { children: d($t, {}, void 0, !1, {
		fileName: ln,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
