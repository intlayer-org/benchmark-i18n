...
var X = {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), Wt = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: a, disableEditor: o, isCookieEnabled: l }) => {
	let { locales: u, defaultLocale: d } = k ?? {}, [f, p] = s(e ?? It ?? t ?? d);
	r(() => {
		e && e !== f && p(e);
	}, [e]), r(() => {
		Ht();
...
Xt({ locale: "en" });
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/pages/careers/OpenPositions.tsx";
function Zt() {
	let { i18n: e } = Jt(), t = [{
		title: e._({
...
function rn({ children: e }) {
	let t = f().locale ?? "en", n = a(() => en(t), [t]), o = a(() => tn(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		$t("AppRoot", c);
	}, [c]), r(() => {
...
var sn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/pages/careers/OpenPositions.wrapper.tsx";
function cn() {
