...
var Z = {
	...
	let { locales: u, defaultLocale: ee } = k ?? {}, [d, f] = s(e ?? Gt ?? t ?? ee);
	r(() => {
		e && e !== d && f(e);
	}, [e]), r(() => {
		Zt();
...
function fn({ children: e }) {
	let t = ee().locale ?? "en", n = a(() => un(t), [t]), o = a(() => dn(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		ln("AppRoot", c);
	}, [c]), r(() => {
