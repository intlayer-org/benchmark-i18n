...
import { useParams as m } from "next/navigation";
var ee = class {
...
}, re = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(ne).join("") : String(e ?? ""), ie = "translation", ae = "enumeration", _ = "plural", v = "insertion", oe = "object", se = "array", y = "markdown", b = "html", ce = "gender", le = "select", x = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), S = (e, t) => {
...
})() }), ge = (e) => x(_, e), _e = (e, t) => x(le, e, { variable: t }), ve = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
function A(e, t, n) {
	let r = t ?? O?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = Te.get(a);
...
var Ae = (e, t, n) => e[A("PluralRules", n).select(t)] ?? e.other, je = (e, t) => {
	...
	if (r.nodeType === "html") return N(r[b], t, n);
...
}, Ie = (e) => (t, n = {}, r = "en") => Fe(typeof t == "string" ? e(t) : t, n, r), P = (e) => {
	...
	lookupBoundDictionaries(e) {
		let { dictionaryKey: t, remainder: n } = Re(e), r = this._boundDictionaries[t];
		if (r !== void 0) {
			let e = g(r, n);
	...
	_(e, t, n) {
		...
		return (c.kind === "node" ? Fe(c.node, o, s) : Le(c.message, o, s)) ?? i;
	}
...
}, I = t(null), L = /* @__PURE__ */ new WeakMap(), R = 0, ze = (e) => {
	if (!e) return "base";
	let t = L.get(e);
	if (t) return t;
	R += 1;
	let n = `p${R}`;
	return L.set(e, n), n;
}, Be = 256, z = /* @__PURE__ */ new WeakMap(), B = (e) => typeof e == "object" && !!e, Ve = (e, t, n) => `${e}_${t}_${ze(n)}`, He = (e, t) => {
	if (!B(e)) return { hit: !1 };
	let n = z.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	if (!B(e)) return n;
	let r = z.get(e);
	return r || (r = /* @__PURE__ */ new Map(), z.set(e, r)), r.size >= Be && r.clear(), r.set(t, n), n;
}, H = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), U = "default", Ue = /[^A-Za-z0-9._&=-]/g, We = /[^A-Za-z0-9._-]/g, Ge = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, W = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, Ge);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, Ke = (e) => e === void 0 ? U : typeof e == "string" ? W(e, Ue) : Object.keys(e).sort().map((t) => `${W(t, We)}=${W(String(e[t]), We)}`).join("&"), qe = (e) => Array.isArray(e) ? e.length === 0 ? [U] : e.map(Ke) : [Ke(e)], Je = (e, t) => {
	...
	if (!Xe(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? U : Je(qe(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Ye(e, n, t, s)).map((t) => Ze(e, t));
...
var lt = {
	...
	let r = ut()[e];
	return r ? jt(r, t, n) : (pt.has(e) || (st({ log: Ce })(typeof window > "u" ? `Dictionary ${ct(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), pt.add(e)), ft(e));
}, ht = (e) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, xt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? J : {
...
}, St = J, Ct = J, wt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? J : {
	id: "insertion-plugin",
...
var Dt = (e) => J, Ot = J, kt = (e, t = !0) => [
	xt(e ?? O.defaultLocale, t ? O.defaultLocale : void 0),
	St,
	Ct,
	wt,
	Dt(e ?? O.defaultLocale),
	Ot,
	Tt,
	Et
], At = (e, t, n = []) => S(e, {
	...
	let { locale: r, selector: i } = $e(t), a = Ve(r ?? O.defaultLocale, et(i), n), o = He(e, a);
...
var Y = {
	...
	if (!Rt) for (let t = 0; t < (k.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(k.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, Bt = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !Rt && k.storage.cookies) for (let n = 0; n < k.storage.cookies.length; n++) {
...
}, qt = (e, t = O?.locales, n = O?.defaultLocale) => {
	...
	let { locales: l, defaultLocale: d } = O ?? {}, [f, p] = c(e ?? X ?? t ?? d);
	i(() => {
		e && e !== f && p(e);
	}, [e]), i(() => {
		Kt();
...
}), { defaultLocale: Xt, locales: Q } = O ?? {}, Zt = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
rn({ locale: "en" });
var an = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/MockBanner.tsx", on = () => {
	let { i18n: e } = Qt();
	return p("div", {
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/pages/pricing/PricingHeader.tsx";
function sn() {
	return p(f, { children: [p(on, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 7
	}, this), p("div", {
...
var fn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/AppProviders.tsx";
function pn({ children: e }) {
	let t = m().locale ?? "en", n = o(() => un(t), [t]), r = o(() => dn(t, n), [t, n]), [s] = c(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		ln("AppRoot", s);
	}, [s]), i(() => {
...
var mn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
function hn({ children: e }) {
	return p(pn, { children: e }, void 0, !1, {
		fileName: mn,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var gn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/pages/pricing/PricingHeader.wrapper.tsx";
function _n() {
	return p(hn, { children: p(sn, {}, void 0, !1, {
		fileName: gn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
