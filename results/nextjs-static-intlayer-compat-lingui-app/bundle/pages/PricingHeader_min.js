...
var U = {
...
}, Fe = !1, Ie, Le = () => typeof window > "u" ? W(U) : (Fe ||= (Ie = W(U), !0), Ie), Re = (e, t) => {
	if (t?.isCookieEnabled !== !1 && (Fe = !1, !H && F.storage.cookies)) for (let n = 0; n < F.storage.cookies.length; n++) {
...
}, ze = /* @__PURE__ */ new WeakMap(), Be = 0, Ve = (e) => {
	if (!e) return "base";
	let t = ze.get(e);
	if (t) return t;
	Be += 1;
	let n = `p${Be}`;
	return ze.set(e, n), n;
}, He = 256, G = /* @__PURE__ */ new WeakMap(), Ue = (e) => typeof e == "object" && !!e, We = (e, t, n) => `${e}_${t}_${Ve(n)}`, Ge = (e, t) => {
	...
	if (!Ue(e)) return n;
	let r = G.get(e);
	return r || (r = /* @__PURE__ */ new Map(), G.set(e, r)), r.size >= He && r.clear(), r.set(t, n), n;
}, Ke = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), q = "\x1B[0m", qe = "\x1B[34m", Je = "\x1B[31m", Ye = "\x1B[32m", Xe = "\x1B[38;5;3m", Ze = (e) => e, Qe = (e, t) => {
...
var tt = {
	...
	let r = Y()[e];
	return r ? Dt(r, t, n) : (it.has(e) || ($e({ log: _e })(typeof window > "u" ? `Dictionary ${et(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), it.add(e)), rt(e));
}, ot = (e) => {
...
var Ct = (e) => Z, wt = Z, Tt = (e, t = !0) => [
	...
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = We(r ?? P.defaultLocale, "", n), o = Ge(e, a);
...
}), { defaultLocale: Ft, locales: $ } = P ?? {}, It = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
function Jt() {
	return u(c, { children: [l(qt, {}), u("div", {
