...
Yt({ locale: "en" });
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/pages/pricing/PricingTiers.tsx";
function Xt() {
	let { i18n: e } = qt(), t = [
		{
			name: e._({
		...
		children: t.map((e) => u("div", {
			...
			children: [
				...
				u("ul", {
					...
					children: e.features.map((e, t) => u("li", {
...
var on = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/pages/pricing/PricingTiers.wrapper.tsx";
function sn() {
