...
}, F = t(null), I = /* @__PURE__ */ new WeakMap(), L = 0, ze = (e) => {
	if (!e) return "base";
	let t = I.get(e);
	if (t) return t;
	L += 1;
...
var ct = {
	...
	let r = lt()[e];
	return r ? At(r, t, n) : (ft.has(e) || (ot({ log: xe })(typeof window > "u" ? `Dictionary ${st(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), ft.add(e)), dt(e));
}, mt = (e) => {
...
}, xt = J, St = J, Ct = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? J : {
	id: "insertion-plugin",
...
var Et = (e) => J, Dt = J, Ot = (e, t = !0) => [
	...
	let { locale: r, selector: i } = Qe(t), a = Ve(r ?? k.defaultLocale, $e(i), n), o = He(e, a);
...
var Y = {
	...
	if (!Lt) for (let t = 0; t < (A.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(A.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, zt = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !Lt && A.storage.cookies) for (let n = 0; n < A.storage.cookies.length; n++) {
...
}, Kt = (e, t = k?.locales, n = k?.defaultLocale) => {
...
}), { defaultLocale: Yt, locales: Q } = k ?? {}, Xt = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
}), en = ({ id: e, message: t, values: n, components: r, render: i, component: a }, o, s) => {
	...
	let { i18n: t, defaultComponent: n } = Zt();
	return en(e, t, n);
}, nn = (e) => new Re({
	...e,
	registry: Pt()
...
nn({ locale: "en" });
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/pages/home/ResultsTable.tsx";
function rn() {
	let { i18n: e } = Zt();
...
var pn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/pages/home/ResultsTable.wrapper.tsx";
function mn() {
