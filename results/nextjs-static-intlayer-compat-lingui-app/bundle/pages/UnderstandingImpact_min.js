...
}, v = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(_).join("") : String(e ?? ""), y = "translation", b = "enumeration", x = "plural", ee = "condition", S = "insertion", te = "object", ne = "array", C = "markdown", w = "html", T = "gender", E = "select", D = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), O = (e, t, n) => ({
...
})() }), le = (e) => D(x, e), ue = (e, t) => D(E, e, { variable: t }), de = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, _e = 50, L = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Set(), ve = (e) => {
...
var xe = (e, t, n) => e[z("PluralRules", n).select(t)] ?? e.other, Se = (e, t) => {
	...
	if (r.nodeType === "html") return H(r[w], t, n);
	if (r.nodeType === "plural") {
		let e = r[x];
		return H(xe(e, Number(V(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[b], i = Ce.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[E], i = V(t, typeof r.variable == "string" ? r.variable : "value");
		return H(Se(e, String(i ?? "")), t, n);
	}
...
var U = {
	...
	if (!Pe) for (let t = 0; t < (I.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(I.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, Ie = !1, Le, Re = () => typeof window > "u" ? Fe(U) : (Ie ||= (Le = Fe(U), !0), Le), ze = (e, t) => {
	if (t?.isCookieEnabled !== !1 && (Ie = !1, !Pe && I.storage.cookies)) for (let n = 0; n < I.storage.cookies.length; n++) {
...
var nt = {
	...
	let r = rt()[e];
	return r ? kt(r, t, n) : (ot.has(e) || (et({ log: ge })(typeof window > "u" ? `Dictionary ${tt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), ot.add(e)), at(e));
}, ct = (e) => {
...
var Tt = (e) => Y, Et = Y, Dt = (e, t = !0) => [
	ht(e ?? F.defaultLocale, t ? F.defaultLocale : void 0),
	gt,
	_t(e ?? F.defaultLocale),
	vt,
	yt,
	Tt(e ?? F.defaultLocale),
	Et,
	Ct,
	wt
].filter((e) => e !== Y), Ot = (e, t, n = []) => k(e, {
	...t,
	plugins: n
	...
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = Ge(r ?? F.defaultLocale, "", n), o = Ke(e, a);
...
}, Nt = (e, t = F?.locales, n = F?.defaultLocale) => {
	...
	let { locales: f, defaultLocale: p } = F ?? {}, [m, h] = s(() => e ?? At() ?? t ?? p), [g, _] = s(e);
	e !== g && (_(e), e && e !== m && h(e)), i(() => {
		Mt();
	}, []);
	let v = n((e) => {
...
}), { defaultLocale: Lt, locales: Z } = F ?? {}, Rt = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
