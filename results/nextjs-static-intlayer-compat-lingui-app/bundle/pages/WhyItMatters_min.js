...
}, v = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(_).join("") : String(e ?? ""), y = "translation", b = "enumeration", x = "plural", ee = "condition", S = "insertion", te = "object", ne = "array", re = "markdown", C = "html", w = "gender", T = "select", E = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), D = (e, t, n) => ({
...
})() }), ue = (e) => E(x, e), de = (e, t) => E(T, e, { variable: t }), fe = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, ve = 50, I = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Set(), ye = (e) => {
...
var Se = (e, t, n) => e[R("PluralRules", n).select(t)] ?? e.other, Ce = (e, t) => {
	...
	return String(e);
}, Te = (e, t = {}, n = "en") => e.replace(/\{\{\s*([^{},]+?)\s*(?:,\s*(\w+)\s*(?:,\s*([^{}]+?)\s*)?)?\}\}/g, (e, r, i, a) => {
	let o = B(t, r);
	...
	if (e == null) return e;
	if (typeof e == "string") return Te(e, t, n);
	...
	let r = e;
	if (r.nodeType === "insertion") return H(r[S], t, n);
	if (r.nodeType === "html") return H(r[C], t, n);
	if (r.nodeType === "plural") {
		let e = r[x];
		return H(Se(e, Number(V(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[b], i = z.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[T], i = V(t, typeof r.variable == "string" ? r.variable : "value");
...
}, De = (e) => (t, n = {}, r = "en") => Ee(typeof t == "string" ? e(t) : t, n, r), Oe = (e) => {
	...
	_(e, t, n) {
		...
		return (c.kind === "node" ? Ee(c.node, o, s) : ke(c.message, o, s)) ?? i;
	}
...
var U = {
	...
	if (!Pe) for (let t = 0; t < (F.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(F.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, Ie = !1, Le, Re = () => typeof window > "u" ? Fe(U) : (Ie ||= (Le = Fe(U), !0), Le), ze = (e, t) => {
	if (t?.isCookieEnabled !== !1 && (Ie = !1, !Pe && F.storage.cookies)) for (let n = 0; n < F.storage.cookies.length; n++) {
...
}, Be = /* @__PURE__ */ new WeakMap(), Ve = 0, He = (e) => {
	if (!e) return "base";
	let t = Be.get(e);
	if (t) return t;
	Ve += 1;
	let n = `p${Ve}`;
	return Be.set(e, n), n;
}, Ue = 256, W = /* @__PURE__ */ new WeakMap(), We = (e) => typeof e == "object" && !!e, Ge = (e, t, n) => `${e}_${t}_${He(n)}`, Ke = (e, t) => {
	...
	if (!We(e)) return n;
	let r = W.get(e);
	return r || (r = /* @__PURE__ */ new Map(), W.set(e, r)), r.size >= Ue && r.clear(), r.set(t, n), n;
}, qe = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), K = "\x1B[0m", Je = "\x1B[34m", Ye = "\x1B[31m", Xe = "\x1B[32m", Ze = "\x1B[38;5;3m", Qe = (e) => e, $e = (e, t) => {
...
}), q = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? K : n : K}` : e, tt = (e, t = Ze, n = K) => [e].flat().map((e) => q(e, t, n)).join(", ");
q("✗", Ye), q("✓", Xe), q("⏲", Je);
var nt = {
	header: {
		key: "header",
...
}, rt = () => nt, it = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), at = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : it.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : at(e ? `${e}.${String(n)}` : String(n)) }), ot = /* @__PURE__ */ new Set(), st = (e, t, n) => {
	let r = rt()[e];
	return r ? kt(r, t, n) : (ot.has(e) || (et({ log: _e })(typeof window > "u" ? `Dictionary ${tt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), ot.add(e)), at(e));
}, ct = (e) => {
	...
	if (typeof e == "string") return e;
	if (J(e)) return e.nodeType === "html" ? e[C] : e[re];
}, ft = (e, t) => {
...
}, gt = Y, _t = (e) => Y, vt = Y, yt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? Y : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: S }], i = e[S], a = {
			...
			transform: (e, n, r) => {
				if (J(e)) return (i) => pt(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, St = (e, t) => typeof t == "function" && bt.includes(e?.nodeType ?? "") ? (n) => xt(e, t, n) : t, Ct = Y, wt = Y;
process.env.INTLAYER_OPTIMIZED_NESTING;
var Tt = (e) => Y, Et = Y, Dt = (e, t = !0) => [
	ht(e ?? P.defaultLocale, t ? P.defaultLocale : void 0),
	gt,
	_t(e ?? P.defaultLocale),
	vt,
	yt,
	...
	Ct,
	wt
].filter((e) => e !== Y), Ot = (e, t, n = []) => O(e, {
	...t,
	plugins: n
}), X = /* @__PURE__ */ new WeakSet(), kt = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = Ge(r ?? P.defaultLocale, "", n), o = Ke(e, a);
...
}, Nt = (e, t = P?.locales, n = P?.defaultLocale) => {
	...
	get locale() {
		return At() ?? P?.defaultLocale;
	},
	setLocale: () => null,
	isCookieEnabled: !0
}), Ft = ({ locale: e, defaultLocale: t, variant: r, children: a, setLocale: c, disableEditor: u, isCookieEnabled: d }) => {
	let { locales: f, defaultLocale: p } = P ?? {}, [m, h] = s(() => e ?? At() ?? t ?? p), [g, _] = s(e);
	e !== g && (_(e), e && e !== m && h(e)), i(() => {
		Mt();
	}, []);
	let v = n((e) => {
	...
	return l(Pt.Provider, {
		value: x,
		children: a
	});
}, It = ({ children: e, ...t }) => u(Ft, {
	...t,
	children: [
		!1,
		!1,
...
}), { defaultLocale: Lt, locales: Z } = P ?? {}, Rt = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let n = Q(), r = e.indexOf("."), i = r === -1 ? e : e.slice(0, r), a = (e) => {
		try {
			return st(e, t);
		} catch {
			return;
	...
	let i = Ut(t.children, n), a = n[t.tag];
...
}), Wt = ({ id: e, message: t, values: n, components: r, render: i, component: a }, o, s) => {
	...
	let { i18n: t, defaultComponent: n } = Ht();
	return Wt(e, t, n);
}, Gt = (e) => new je({
	...e,
	registry: Vt()
...
Gt({ locale: "en" });
var Kt = ({ i18n: e, defaultComponent: t, children: n }) => {
	let r = (e) => ({
		i18n: e,
		_: e._.bind(e),
		defaultComponent: t
...
function Qt({ children: e }) {
	let t = d().locale ?? "en", n = o(() => Xt(t), [t]), r = o(() => Zt(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		Yt("AppRoot", c);
	}, [c]), i(() => {
...
function $t({ children: e }) {
	return l(Qt, { children: e });
}
function en() {
	return l($t, { children: l(qt, {}) });
}
