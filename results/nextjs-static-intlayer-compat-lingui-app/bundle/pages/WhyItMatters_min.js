...
}, ne = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(te).join("") : String(e ?? ""), re = "translation", _ = "enumeration", ie = "plural", v = "insertion", ae = "object", oe = "array", se = "markdown", y = "html", b = "gender", x = "select", S = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), C = (e, t) => {
...
})() }), me = (e) => S(ie, e), he = (e, t) => S(x, e, { variable: t }), ge = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
function j(e, t, n) {
	let r = t ?? k?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = Ce.get(a);
...
var Oe = (e, t, n) => e[j("PluralRules", n).select(t)] ?? e.other, ke = (e, t) => {
	...
	if (r.nodeType === "plural") {
		let e = r[ie];
		return P(Oe(e, Number(N(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[_], i = Ae.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
}, Pe = (e) => (t, n = {}, r = "en") => Ne(typeof t == "string" ? e(t) : t, n, r), Fe = (e) => {
	...
	_(e, t, n) {
		...
		return (c.kind === "node" ? Ne(c.node, o, s) : Ie(c.message, o, s)) ?? i;
	}
...
}, ze = t(null), F = /* @__PURE__ */ new WeakMap(), I = 0, Be = (e) => {
	if (!e) return "base";
	let t = F.get(e);
	if (t) return t;
	I += 1;
	let n = `p${I}`;
	return F.set(e, n), n;
}, Ve = 256, L = /* @__PURE__ */ new WeakMap(), R = (e) => typeof e == "object" && !!e, He = (e, t, n) => `${e}_${t}_${Be(n)}`, Ue = (e, t) => {
	if (!R(e)) return { hit: !1 };
	let n = L.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	if (!R(e)) return n;
	let r = L.get(e);
	return r || (r = /* @__PURE__ */ new Map(), L.set(e, r)), r.size >= Ve && r.clear(), r.set(t, n), n;
}, B = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), V = "default", We = /[^A-Za-z0-9._&=-]/g, H = /[^A-Za-z0-9._-]/g, Ge = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, U = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, Ge);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, Ke = (e) => e === void 0 ? V : typeof e == "string" ? U(e, We) : Object.keys(e).sort().map((t) => `${U(t, H)}=${U(String(e[t]), H)}`).join("&"), qe = (e) => Array.isArray(e) ? e.length === 0 ? [V] : e.map(Ke) : [Ke(e)], Je = (e, t) => {
	...
	if (!Xe(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? V : Je(qe(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Ye(e, n, t, s)).map((t) => Ze(e, t));
...
}).join("|") : "", W = "\x1B[0m", tt = "\x1B[34m", nt = "\x1B[31m", rt = "\x1B[32m", it = "\x1B[38;5;3m", at = (e) => e, ot = (e, t) => {
...
}), G = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? W : n : W}` : e, ct = (e, t = it, n = W) => [e].flat().map((e) => G(e, t, n)).join(", ");
G("✗", nt), G("✓", rt), G("⏲", tt);
var lt = {
	header: {
		key: "header",
	...
	let r = ut()[e];
	return r ? jt(r, t, n) : (pt.has(e) || (st({ log: xe })(typeof window > "u" ? `Dictionary ${ct(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), pt.add(e)), ft(e));
}, ht = (e) => {
	...
	if (typeof e == "string") return e;
	if (K(e)) return e.nodeType === "html" ? e[y] : e[se];
}, yt = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, xt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? q : {
...
}, St = q, Ct = q, wt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? q : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: v }], i = e[v], a = {
			...
			transform: (e, n, r) => {
				if (K(e)) return (i) => bt(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
var Dt = (e) => q, Ot = q, kt = (e, t = !0) => [
	xt(e ?? k.defaultLocale, t ? k.defaultLocale : void 0),
	St,
	Ct,
	wt,
	...
	let { locale: r, selector: i } = $e(t), a = He(r ?? k.defaultLocale, et(i), n), o = Ue(e, a);
	...
	let n = Mt(), r = e.indexOf("."), i = r === -1 ? e : e.slice(0, r), a = (e) => {
		try {
			return mt(e, t);
		} catch {
			return;
...
var J = {
	...
	if (!Rt) for (let t = 0; t < (A.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(A.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, Bt = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !Rt && A.storage.cookies) for (let n = 0; n < A.storage.cookies.length; n++) {
	...
	locale: Vt ?? k?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), Jt = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: o, isCookieEnabled: s }) => {
	let { locales: l, defaultLocale: d } = k ?? {}, [f, p] = c(e ?? Vt ?? t ?? d);
	i(() => {
		e && e !== f && p(e);
	}, [e]), i(() => {
		Kt();
...
}), { defaultLocale: Xt, locales: Z } = k ?? {}, Zt = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	return e || n;
}, $t = ({ i18n: e, defaultComponent: t, children: n }) => {
	let r = (e) => ({
		i18n: e,
		_: e._.bind(e),
		defaultComponent: t
...
}), tn = ({ id: e, message: t, values: n, components: r, render: i, component: a }, o, s) => {
	...
	let { i18n: t, defaultComponent: n } = Qt();
	return tn(e, t, n);
}, nn = (e) => new Re({
	...e,
	registry: Ft()
...
nn({ locale: "en" });
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/pages/home/WhyItMatters.tsx";
function rn() {
	let { i18n: e } = Qt();
	return f("section", {
		className: "mb-16",
...
var ln = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/AppProviders.tsx";
function un({ children: e }) {
	let t = p().locale ?? "en", n = o(() => sn(t), [t]), r = o(() => cn(t, n), [t, n]), [s] = c(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		on("AppRoot", s);
	}, [s]), i(() => {
...
var dn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
function fn({ children: e }) {
	return f(un, { children: e }, void 0, !1, {
		fileName: dn,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var pn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-lingui-app/components/pages/home/WhyItMatters.wrapper.tsx";
function mn() {
	return f(fn, { children: f(rn, {}, void 0, !1, {
		fileName: pn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
