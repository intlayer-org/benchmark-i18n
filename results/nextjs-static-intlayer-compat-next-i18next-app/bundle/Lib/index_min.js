...
}, ae = "translation", oe = "enumeration", se = "plural", ce = "insertion", le = "object", ue = "array", de = "html", fe = "gender", pe = "select", x = (e, t) => {
...
}, he = (e, t) => e[me(e, t) ?? "fallback"], S = "default", ge = /[^A-Za-z0-9._&=-]/g, C = /[^A-Za-z0-9._-]/g, _e = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, w = (e, t) => {
	if (e === "") return "%";
...
}).join("|") : "", T = "\x1B[0m", De = "\x1B[34m", Oe = "\x1B[31m", ke = "\x1B[32m", Ae = "\x1B[35m", je = "\x1B[38;5;3m", E = "\x1B[36m", Me = (e) => e, Ne = (e, t) => {
...
}), O = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? T : n : T}` : e, Pe = (e, t = je, n = T) => [e].flat().map((e) => O(e, t, n)).join(", ");
O("✗", Oe), O("✓", ke), O("⏲", De);
var k = () => ({}), Fe = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	...
	yield e;
} : A(e ? `${e}.${String(n)}` : String(n)) }), Ie = /* @__PURE__ */ new Set(), j = (e, t, n) => {
	let r = k()[e];
	return r ? it(r, t, n) : (Ie.has(e) || (D({ log: g })(typeof window > "u" ? `Dictionary ${Pe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Ie.add(e)), A(e));
...
function M(e, t, n) {
	let r = t ?? m?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = Re.get(a);
...
var Ue = (e, t, n) => e[M("PluralRules", n).select(t)] ?? e.other, We = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, Je = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? N : {
...
}, Ye = N, Xe = N, Ze = N, Qe = N, $e = N, et = (e) => N, tt = N, nt = (e, t = !0) => [
	...
	let { locale: r, selector: i } = Te(t), a = re(r ?? m.defaultLocale, Ee(i), n), o = ie(e, a);
	if (o.hit) return o.content;
	let s = n ?? nt(r), c = we(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var F = {
...
}, mt = (e, t = m?.locales, n = m?.defaultLocale) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return K(r[ce], t, n);
	if (r.nodeType === "html") return K(r[de], t, n);
	if (r.nodeType === "plural") {
		let e = r[se];
		return K(Ue(e, Number(G(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[oe], i = H.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[pe], i = G(t, typeof r.variable == "string" ? r.variable : "value");
	...
	D({ log: g })(`${O(e, E)}: the ${O("`resources`", E)} option is ignored when using ${O("@intlayer/i18next", Ae)} — translations are served from the compiled intlayer dictionaries instead. Remove the resource imports and the ${O("`resources`", E)} option to reduce your bundle size.`);
}, Z = (e = {}) => {
...
var Dt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = bt(), s = t?.keyPrefix, { translate: c, i18n: l } = o(() => Dt({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
var kt = {
	type: "3rdParty",
	init: (e) => {}
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-next-i18next-app/scripts/EmptyComponent.tsx", At = () => {
	let { i18n: e, t } = Ot();
...
var Rt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-next-i18next-app/scripts/EmptyComponent.wrapper.tsx";
function zt() {
	return f(Lt, { children: f(jt, {}, void 0, !1, {
		fileName: Rt,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
