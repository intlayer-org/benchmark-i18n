...
var h = ({ href: e, children: t, ...n }) => {
	let r = u().locale ?? "en";
	return e == null || typeof e != "string" || p(e) ? d(l, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
w("✗", te), w("✓", ne), w("⏲", ee);
var Se = "translation", T = "enumeration", Ce = "plural", we = "insertion", Te = "object", Ee = "array", De = "html", Oe = "gender", E = "select", D = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), O = (e, t) => {
...
})() }), Pe = (e) => D(Ce, e), Fe = (e, t) => D(E, e, { variable: t }), Ie = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, Ye = (e, t) => e[Je(e, t) ?? "fallback"], Xe = (e, t, n) => e[S("PluralRules", n).select(t)] ?? e.other, Ze = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return z(r[we], t, n);
	if (r.nodeType === "html") return z(r[De], t, n);
	if (r.nodeType === "plural") {
		let e = r[Ce];
		return z(Xe(e, Number(R(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[T], i = Qe.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[E], i = R(t, typeof r.variable == "string" ? r.variable : "value");
	...
	i18next: Ve,
	"vue-i18n": qe
}, B = (e, t = {}, n = "en", r = "icu") => nt(rt[r])(e, t, n), it = /* @__PURE__ */ new WeakMap(), at = 0, ot = (e) => {
	if (!e) return "base";
	let t = it.get(e);
	if (t) return t;
	at += 1;
...
}, U = "default", dt = /[^A-Za-z0-9._&=-]/g, W = /[^A-Za-z0-9._-]/g, ft = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, G = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, ft);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, pt = (e) => e === void 0 ? U : typeof e == "string" ? G(e, dt) : Object.keys(e).sort().map((t) => `${G(t, W)}=${G(String(e[t]), W)}`).join("&"), mt = (e) => Array.isArray(e) ? e.length === 0 ? [U] : e.map(pt) : [pt(e)], ht = (e, t) => {
	...
	yield e;
} : Tt(e ? `${e}.${String(n)}` : String(n)) }), Et = /* @__PURE__ */ new Set(), K = (e, t, n) => {
	let r = Ct()[e];
	return r ? Bt(r, t, n) : (Et.has(e) || (C({ log: v })(typeof window > "u" ? `Dictionary ${xe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Et.add(e)), Tt(e));
}, Dt = (e) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, At = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? q : {
...
}, jt = q, Mt = q, Nt = q, Pt = q, Ft = q;
process.env.INTLAYER_OPTIMIZED_NESTING;
var It = (e) => q, Lt = q, Rt = (e, t = !0) => [
	At(e ?? g.defaultLocale, t ? g.defaultLocale : void 0),
	jt,
	Mt,
	Nt,
	It(e ?? g.defaultLocale),
	Lt,
	Pt,
	Ft
], zt = (e, t, n = []) => O(e, {
	...
	let { locale: r, selector: i } = bt(t), a = lt(r ?? g.defaultLocale, xt(i), n), o = ut(e, a);
...
}), { defaultLocale: rn, locales: $ } = g ?? {}, an = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
}, sn = ({ children: e, i18n: t }) => (t !== void 0 && C({ log: v })(`${w("I18nextProvider", b)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), d(nn, { children: e }));
