...
var _ = ({ href: e, children: t, ...n }) => {
	let r = u().locale ?? "en";
	return e == null || typeof e != "string" || ee(e) ? p(l, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, x = "\x1B[0m", te = "\x1B[34m", ne = "\x1B[31m", re = "\x1B[32m", ie = "\x1B[35m", ae = "\x1B[38;5;3m", S = "\x1B[36m", oe = (e, t = v?.locales, n = v?.defaultLocale) => {
...
var C = {
	...
	if (!le) for (let t = 0; t < (y.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(y.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, de = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !le && y.storage.cookies) for (let n = 0; n < y.storage.cookies.length; n++) {
...
}), E = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? x : n : x}` : e, Se = (e, t = ae, n = x) => [e].flat().map((e) => E(e, t, n)).join(", ");
E("✗", ne), E("✓", re), E("⏲", te);
var Ce = "translation", we = "enumeration", Te = "plural", Ee = "insertion", De = "object", Oe = "array", ke = "html", Ae = "gender", je = "select", D = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), O = (e, t) => {
...
})() }), Le = (e) => D(Te, e), Re = (e, t) => D(je, e, { variable: t }), ze = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, Qe = (e, t) => e[Ze(e, t) ?? "fallback"], $e = (e, t, n) => e[w("PluralRules", n).select(t)] ?? e.other, et = (e, t) => {
	...
	if (r.nodeType === "plural") {
		let e = r[Te];
		return z($e(e, Number(R(t, "count") ?? 1), n), t, n);
	}
	...
	if (r.nodeType === "select") {
		let e = r[je], i = R(t, typeof r.variable == "string" ? r.variable : "value");
	...
	i18next: We,
	"vue-i18n": Xe
}, B = (e, t = {}, n = "en", r = "icu") => at(ot[r])(e, t, n), st = /* @__PURE__ */ new WeakMap(), ct = 0, lt = (e) => {
	if (!e) return "base";
	let t = st.get(e);
	if (t) return t;
	ct += 1;
...
}, U = "default", mt = /[^A-Za-z0-9._&=-]/g, ht = /[^A-Za-z0-9._-]/g, gt = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, W = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, gt);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, _t = (e) => e === void 0 ? U : typeof e == "string" ? W(e, mt) : Object.keys(e).sort().map((t) => `${W(t, ht)}=${W(String(e[t]), ht)}`).join("&"), vt = (e) => Array.isArray(e) ? e.length === 0 ? [U] : e.map(_t) : [_t(e)], yt = (e, t) => {
	...
	if (!xt(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? U : yt(vt(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => bt(e, n, t, s)).map((t) => St(e, t));
	...
	yield e;
} : kt(e ? `${e}.${String(n)}` : String(n)) }), At = /* @__PURE__ */ new Set(), G = (e, t, n) => {
	let r = Dt()[e];
	return r ? Wt(r, t, n) : (At.has(e) || (T({ log: b })(typeof window > "u" ? `Dictionary ${Se(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), At.add(e)), kt(e));
}, jt = (e) => {
...
}, Ft = K, It = K, Lt = K, Rt = K, zt = K;
process.env.INTLAYER_OPTIMIZED_NESTING;
var Bt = (e) => K, Vt = K, Ht = (e, t = !0) => [
	Pt(e ?? v.defaultLocale, t ? v.defaultLocale : void 0),
	Ft,
	It,
	Lt,
	Bt(e ?? v.defaultLocale),
	Vt,
	Rt,
	zt
], Ut = (e, t, n = []) => O(e, {
	...
	let { locale: r, selector: i } = wt(t), a = ft(r ?? v.defaultLocale, Tt(i), n), o = pt(e, a);
	if (o.hit) return o.content;
	let s = n ?? Ht(r), c = Ct(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
	...
	"nsMode",
	"keyPrefix"
]), Kt = 5, qt = "index", Jt = (e, t) => {
	if (e in Dt()) return G(e, t);
}, Yt = (e, t, n, r, i) => {
	...
	else if (m = Jt(c, p), m === void 0 && c === t && c !== qt && (m = Jt(qt, p)), m === void 0) return;
	let h;
	for (let t of Yt(l, r?.lng ?? e, u, d, f)) {
		let e = Ge(m, t, i);
		if (e != null) {
			h = e;
			break;
	...
	return o < Kt && g.includes("$t(") && (g = g.replace(/\$t\(\s*([^),]+?)\s*(?:,[^)]*)?\)/g, (n, l) => {
		let u = J({
			locale: e,
			namespace: c,
			key: l.trim(),
	...
	T({ log: b })(`${E(e, S)}: the ${E("`resources`", S)} option is ignored when using ${E("@intlayer/i18next", ie)} — translations are served from the compiled intlayer dictionaries instead. Remove the resource imports and the ${E("`resources`", S)} option to reduce your bundle size.`);
}, Y = (e = {}) => {
	e.resources !== void 0 && Xt("createInstance");
	let t = v, n = e.lng ?? t?.defaultLocale ?? "en", r = e.defaultNS ?? (Array.isArray(e.ns) ? e.ns[0] : e.ns) ?? "translation", i = /* @__PURE__ */ new Map(), a = !1, o = (e, ...t) => {
		i.get(e)?.forEach((e) => {
			e(...t);
		});
	}, s = () => ({
		...
		async init(e, t) {
			...
			i.resources !== void 0 && Xt("i18next.init"), i.lng && (n = i.lng), i.defaultNS ? r = i.defaultNS : i.ns && (r = Array.isArray(i.ns) ? i.ns[0] : i.ns), a = !0, o("initialized", i);
			let s = l.t.bind(l);
...
var Zt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	let o = (t, n) => J({
		locale: e,
		namespace: r,
		key: i ? `${i}.${t}` : t,
	...
	locale: Qt ?? v?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), on = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: o, isCookieEnabled: s }) => {
	let { locales: l, defaultLocale: u } = v ?? {}, [d, f] = c(e ?? Qt ?? t ?? u);
	i(() => {
		e && e !== d && f(e);
	}, [e]), i(() => {
		an();
...
}), { defaultLocale: cn, locales: Q } = v ?? {}, ln = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = ln(), s = t?.keyPrefix, { translate: c, i18n: l } = o(() => Zt({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
}, un = ({ children: e, i18n: t }) => (t !== void 0 && T({ log: b })(`${E("I18nextProvider", S)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), p(sn, { children: e }));
			...
			children: [m("div", {
				...
				children: [p(_, {
					...
					children: [
						p(_, {
							href: "/",
							className: `nav-link${((e) => i === g(e, a))("/") ? " is-active" : ""}`,
...
function wn({ children: e }) {
	...
	return a(() => {
		...
		i18n: Sn,
		children: [p(Cn, { locale: t }), e]
	});
}
function Tn({ children: e }) {
	return p(wn, { children: e });
}
function En() {
	return p(Tn, { children: p(yn, {}) });
}
