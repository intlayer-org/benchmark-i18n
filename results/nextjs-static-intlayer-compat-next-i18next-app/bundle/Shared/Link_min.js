...
var Se = "translation", T = "enumeration", Ce = "plural", we = "insertion", Te = "object", Ee = "array", De = "html", Oe = "gender", E = "select", D = (e, t, n) => ({
...
}, U = "default", dt = /[^A-Za-z0-9._&=-]/g, ft = /[^A-Za-z0-9._-]/g, pt = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, W = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, pt);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, mt = (e) => e === void 0 ? U : typeof e == "string" ? W(e, dt) : Object.keys(e).sort().map((t) => `${W(t, ft)}=${W(String(e[t]), ft)}`).join("&"), ht = (e) => Array.isArray(e) ? e.length === 0 ? [U] : e.map(mt) : [mt(e)], gt = (e, t) => {
	...
	if (!vt(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? U : gt(ht(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => _t(e, n, t, s)).map((t) => yt(e, t));
...
}, jt = K, Mt = K, Nt = K, Pt = K, Ft = K, It = (e) => K, Lt = K, Rt = (e, t = !0) => [
	...
	e.resources !== void 0 && Y("createInstance");
	let t = g, n = e.lng ?? t?.defaultLocale ?? "en", r = e.defaultNS ?? (Array.isArray(e.ns) ? e.ns[0] : e.ns) ?? "translation", i = /* @__PURE__ */ new Map(), a = !1, o = (e, ...t) => {
		...
		async init(e, t) {
			...
			i.resources !== void 0 && Y("i18next.init"), i.lng && (n = i.lng), i.defaultNS ? r = i.defaultNS : i.ns && (r = Array.isArray(i.ns) ? i.ns[0] : i.ns), a = !0, o("initialized", i);
			let s = l.t.bind(l);
...
var Kt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let { locales: l, defaultLocale: u } = g ?? {}, [f, p] = c(e ?? qt ?? t ?? u);
	i(() => {
		e && e !== f && p(e);
	}, [e]), i(() => {
		$t();
...
}), { defaultLocale: nn, locales: $ } = g ?? {}, rn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
}, on = ({ children: e, i18n: t }) => (t !== void 0 && C({ log: v })(`${w("I18nextProvider", b)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), d(tn, { children: e }));
