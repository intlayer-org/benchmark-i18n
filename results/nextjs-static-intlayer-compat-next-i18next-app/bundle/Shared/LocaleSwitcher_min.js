...
import { _ as l, a as u, f as d, i as f, m as p, o as m, p as h, r as ee, s as g, u as _, x as v, y as te } from "./getDictionary-lVOhO-o2.js";
import { n as ne } from "./isBot-CTlYFuov.js";
import * as re from "react";
import { createContext as ie, useContext as y, useEffect as b, useLayoutEffect as ae, useRef as x, useState as S } from "react";
import { useParams as oe, usePathname as se, useRouter as ce } from "next/navigation";
...
var T = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-next-i18next-app/components/LocaleSwitcher.tsx";
function fe() {
	let e = oe().locale ?? "en", t = se(), n = ce(), r = (r) => {
		let i = t.replace(`/${e}`, `/${r}`);
		n.push(i);
	};
	return C("div", {
...
var pe = process.env.INTLAYER_EDITOR_ENABLED !== "false" && i?.enabled && typeof window < "u" && window.self !== window.top, me = 50, he = /* @__PURE__ */ new Map(), ge = /* @__PURE__ */ new Set(), _e = (e) => {
...
function E(e, t, n) {
	let r = t ?? o?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, s = he.get(a);
	s || (s = /* @__PURE__ */ new Map(), he.set(a, s));
	let c = s.get(i);
	if (!c) {
		let t = typeof e == "string" ? ye(e) : e;
		if (typeof t != "function") throw Error(`[intlayer] \`Intl.${String(e)}\` is not available in this JavaScript engine and has no fallback. Load the matching polyfill before formatting.`);
		s.size > me && s.clear(), c = new t(r, n), s.set(i, c);
	}
	return c;
}
var be = (e, t, n) => e[E("PluralRules", n).select(t)] ?? e.other, xe = /* @__PURE__ */ new Set([
	"area",
	"base",
	"br",
	"col",
...
}, k = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false", A = process.env.INTLAYER_ROUTING_STORAGE_LOCALSTORAGE === "false", j = process.env.INTLAYER_ROUTING_STORAGE_SESSIONSTORAGE === "false";
...
var M = {
	...
	if (!k) for (let n = 0; n < (e.storage.cookies ?? []).length; n++) try {
		let i = t?.getCookie?.(e.storage.cookies[n].name);
		if (r(i)) return i;
	} catch {}
	if (!A) for (let n = 0; n < (e.storage.localStorage ?? []).length; n++) try {
	...
	if (n?.isCookieEnabled !== !1) {
		if (!k && e.storage.cookies) for (let r = 0; r < e.storage.cookies.length; r++) {
			...
			try {
				...
				try {
					n?.setCookieString && n.setCookieString(i, Te(i, t, a));
				} catch {}
			}
		}
		if (!A && e.storage.localStorage && n?.setLocaleStorage) for (let r = 0; r < e.storage.localStorage.length; r++) {
	...
	let { locale: e } = y(P) ?? {}, t = x(null);
	b(() => {
		if (process.env.INTLAYER_EDITOR_ENABLED !== "false" && pe) return import("./esm-B9OWu-GQ.js").then(({ initEditorClient: n }) => {
			let r = n();
...
}, Ae = ({ children: e }) => (ke(), e), je = process.env.INTLAYER_ANALYTICS_ENABLED !== "false" && s?.enabled === !0 && !!i?.clientId && typeof window < "u" && window.self === window.top && !ne(), Me = () => {
	let { locale: e } = y(P) ?? {}, t = x(null);
	b(() => {
		if (process.env.INTLAYER_ANALYTICS_ENABLED === "false" || !je) return;
		let n = !1, r = !1;
...
}, Ne = ({ children: e }) => (Me(), e), Pe = () => {
	typeof window < "u" && (window.intlayer = { enabled: !0 });
}, Fe = (e, t = o?.locales, n = o?.defaultLocale) => {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), Ie = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: i, disableEditor: a, isCookieEnabled: s }) => {
	let { locales: c, defaultLocale: l } = o ?? {}, [u, d] = S(e ?? N ?? t ?? l);
	b(() => {
		e && e !== u && d(e);
	}, [e]), b(() => {
		Pe();
...
var F = (e) => v(_, e), I = (e) => v(d, e), L = (e, t) => v(h, e, { tags: (() => {
	if (t) return t;
	if (typeof e == "string") {
		let { issues: t } = Ce(e);
...
})() }), B = (e) => v(l, e), V = (e, t) => v(te, e, { variable: t }), Ve = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	return String(e);
}, tt = (e, t = {}, n = "en") => e.replace(/\{\{\s*([^{}]+?)\s*\}\}/g, (e, n) => {
	let r = G(t, n);
	...
	let r = e;
	if (r.nodeType === "insertion") return q(r[p], t, n);
	if (r.nodeType === "html") return q(r[h], t, n);
	if (r.nodeType === "plural") {
		let e = r[l];
		return q(be(e, Number(K(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[_], i = $e.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[te], i = K(t, typeof r.variable == "string" ? r.variable : "value");
		return q(ee(e, String(i ?? "")), t, n);
	}
	...
	let i = q(typeof e == "string" ? nt[r](e) : e, t, n);
	...
	let ee = Y(r), g = J(h, ee, r?.lng ?? e, "i18next");
	return o < it && g.includes("$t(") && (g = g.replace(/\$t\(\s*([^),]+?)\s*(?:,[^)]*)?\)/g, (n, l) => {
		let u = X({
			locale: e,
			namespace: c,
			key: l.trim(),
	...
	let t = o, n = e.lng ?? t?.defaultLocale ?? "en", r = e.defaultNS ?? (Array.isArray(e.ns) ? e.ns[0] : e.ns) ?? "translation", i = /* @__PURE__ */ new Map(), a = !1, s = (e, ...t) => {
		...
		return typeof o == "string" ? J(o, Y(i), e, "i18next") : n;
	}, u = {
		get language() {
			return n;
		},
		...
		async init(e, t) {
			...
			i.resources !== void 0 && ct("i18next.init"), i.lng && (n = i.lng), i.defaultNS ? r = i.defaultNS : i.ns && (r = Array.isArray(i.ns) ? i.ns[0] : i.ns), a = !0, s("initialized", i);
			let o = u.t.bind(u);
		...
		t(e, t, i) {
			...
			return typeof s == "string" ? J(s, Y(a), n, "i18next") : s ?? (Array.isArray(e) ? e[e.length - 1] : e);
		},
...
Q.dir.bind(Q), Q.init.bind(Q), Q.loadResources.bind(Q), Q.reloadResources.bind(Q), Q.use.bind(Q), Q.changeLanguage.bind(Q), Q.getFixedT.bind(Q), Q.t.bind(Q), Q.exists.bind(Q), Q.setDefaultNamespace.bind(Q), Q.hasLoadedNamespace.bind(Q), Q.loadNamespaces.bind(Q), Q.loadLanguages.bind(Q), re.createContext({ i18n: null }), Q.use({
	type: "3rdParty",
	init: (e) => {}
}).init({
	lng: "en",
...
function ut({ children: e }) {
	let t = oe().locale ?? "en", [n] = S(() => typeof performance < "u" ? performance.now() : 0);
	return ae(() => {
		Be("AppRoot", n);
	}, [n]), b(() => {
...
function ft({ children: e }) {
	return C(ut, { children: e }, void 0, !1, {
		fileName: dt,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-next-i18next-app/components/LocaleSwitcher.wrapper.tsx";
function pt() {
	return C(ft, { children: C(fe, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
