...
S("✗", _), S("✓", ee), S("⏲", g);
var be = "translation", xe = "enumeration", Se = "plural", Ce = "insertion", we = "object", Te = "array", Ee = "html", De = "gender", Oe = "select", C = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), w = (e, t) => {
...
})() }), Ne = (e) => C(Se, e), Pe = (e, t) => C(Oe, e, { variable: t }), Fe = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "plural") {
		let e = r[Se];
		return I(Ye(e, Number(F(t, "count") ?? 1), n), t, n);
	}
	...
	i18next: Be,
	"vue-i18n": Ke
}, L = (e, t = {}, n = "en", r = "icu") => tt(nt[r])(e, t, n), R = /* @__PURE__ */ new WeakMap(), z = 0, rt = (e) => {
	if (!e) return "base";
	let t = R.get(e);
	if (t) return t;
	z += 1;
...
}, H = "default", ct = /[^A-Za-z0-9._&=-]/g, lt = /[^A-Za-z0-9._-]/g, ut = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, U = (e, t) => {
	if (e === "") return "%";
	...
	let r = xt()[e];
	return r ? Rt(r, t, n) : (wt.has(e) || (x({ log: m })(typeof window > "u" ? `Dictionary ${ye(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), wt.add(e)), Ct(e));
}, Tt = (e) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, Ot = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? G : {
...
}, kt = G, At = G, jt = G, Mt = G, Nt = G;
process.env.INTLAYER_OPTIMIZED_NESTING;
var Pt = (e) => G, Ft = G, It = (e, t = !0) => [
	Ot(e ?? f.defaultLocale, t ? f.defaultLocale : void 0),
	kt,
	At,
	jt,
	Pt(e ?? f.defaultLocale),
	Ft,
	Mt,
	Nt
], Lt = (e, t, n = []) => w(e, {
	...
	let { locale: r, selector: i } = vt(t), a = ot(r ?? f.defaultLocale, yt(i), n), o = st(e, a);
	...
	let g = K(r), _ = L(h, g, r?.lng ?? e, "i18next");
	...
	let t = f, n = e.lng ?? t?.defaultLocale ?? "en", r = e.defaultNS ?? (Array.isArray(e.ns) ? e.ns[0] : e.ns) ?? "translation", i = /* @__PURE__ */ new Map(), a = !1, o = (e, ...t) => {
		...
		return typeof o == "string" ? L(o, K(i), e, "i18next") : n;
	}, l = {
		get language() {
			return n;
		},
		...
		t(e, t, i) {
			...
			return typeof c == "string" ? L(c, K(a), n, "i18next") : c ?? (Array.isArray(e) ? e[e.length - 1] : e);
		},
...
var Gt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	let o = (t, n) => q({
		...
		return typeof s == "string" ? L(s, K(i), e, "i18next") : a[a.length - 1];
	};
	return {
		translate: s,
		i18n: {
...
}, rn = ({ children: e, i18n: t }) => (t !== void 0 && x({ log: m })(`${S("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), l($t, { children: e }));
