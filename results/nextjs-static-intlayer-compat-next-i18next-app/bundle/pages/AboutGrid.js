	...
	return jsxs("div", {
		...
		children: [jsxs("div", {
			...
			children: [jsx("h2", {
				...
				children: t("about.aboutGrid.whyThisExists")
			}), jsx("p", {
				className: "text-sm text-muted-foreground",
				children: t("about.aboutGrid.choosingAnI18nLibraryIs")
			})]
		}), jsxs("div", {
			className: "rounded-lg border border-border bg-card p-6",
			children: [jsx("h2", {
				className: "mb-3 text-xl font-semibold text-foreground",
				children: t("about.aboutGrid.methodology")
			}), jsx("p", {
				className: "text-sm text-muted-foreground",
				children: t("about.aboutGrid.theSame10PageApp")
			})]
		})]
	});
}
