	...
	return u("div", {
		...
		children: [u("div", {
			...
			children: [l("h2", {
				...
				children: e("about.aboutGrid.whyThisExists")
			}), l("p", {
				className: "text-sm text-muted-foreground",
				children: e("about.aboutGrid.choosingAnI18nLibraryIs")
			})]
		}), u("div", {
			className: "rounded-lg border border-border bg-card p-6",
			children: [l("h2", {
				className: "mb-3 text-xl font-semibold text-foreground",
				children: e("about.aboutGrid.methodology")
			}), l("p", {
				className: "text-sm text-muted-foreground",
				children: e("about.aboutGrid.theSame10PageApp")
			})]
		})]
	});
}
