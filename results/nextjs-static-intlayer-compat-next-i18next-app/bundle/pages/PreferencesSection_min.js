...
var Gt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let { locales: c, defaultLocale: d } = p ?? {}, [f, m] = l(e ?? Kt ?? t ?? d);
	i(() => {
		e && e !== f && m(e);
	}, [e]), i(() => {
		Zt();
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = tn(), o = t?.keyPrefix, { translate: c, i18n: l } = s(() => Gt({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
