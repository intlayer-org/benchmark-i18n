...
var L = {
	...
	let { locales: c, defaultLocale: d } = m ?? {}, [f, p] = l(e ?? R ?? t ?? d);
	i(() => {
		e && e !== f && p(e);
	}, [e]), i(() => {
		dt();
...
var Et = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = vt(), o = t?.keyPrefix, { translate: c, i18n: l } = s(() => Et({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
var Nt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-next-i18next-app/components/AppProviders.tsx";
...
var Ft = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-next-i18next-app/scripts/Wrapper.tsx";
...
var Lt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-next-i18next-app/components/pages/settings/PreferencesSection.wrapper.tsx";
function Rt() {
