...
C("✗", ee), C("✓", te), C("⏲", _);
var be = "translation", xe = "enumeration", Se = "plural", Ce = "insertion", we = "object", Te = "array", Ee = "html", De = "gender", w = "select", T = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), E = (e, t) => {
...
})() }), Me = (e) => T(Se, e), Ne = (e, t) => T(w, e, { variable: t }), Pe = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "select") {
		let e = r[w], i = R(t, typeof r.variable == "string" ? r.variable : "value");
...
var Gt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
...
}), { defaultLocale: tn, locales: Q } = p ?? {}, nn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = nn(), s = t?.keyPrefix, { translate: c, i18n: l } = o(() => Gt({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
}, rn = ({ children: e, i18n: t }) => (t !== void 0 && S({ log: h })(`${C("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), u(en, { children: e }));
