...
}), j = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? k : n : k}` : e, je = (e, t = De, n = k) => [e].flat().map((e) => j(e, t, n)).join(", ");
j("✗", Te), j("✓", Ee), j("⏲", we);
var Me = () => ({}), Ne = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	...
	yield e;
} : Pe(e ? `${e}.${String(n)}` : String(n)) }), M = /* @__PURE__ */ new Set(), N = (e, t, n) => {
	let r = Me()[e];
	return r ? tt(r, t, n) : (M.has(e) || (A({ log: m })(typeof window > "u" ? `Dictionary ${je(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), M.add(e)), Pe(e));
...
var U = {
	...
	let { locales: u, defaultLocale: ee } = f ?? {}, [d, p] = s(e ?? W ?? t ?? ee);
	r(() => {
		e && e !== d && p(e);
	}, [e]), r(() => {
		ft();
	...
	n !== void 0 && A({ log: m })(`${j("NextIntlClientProvider", Oe)} do not pass the messages prop with intlayer. Messages are loaded automatically under the hood for bundle optimization reason`);
	let o = ee(), s = p?.mode ?? "prefix-no-default", c = e ?? (s === "prefix-all" || s === "prefix-no-default" ? ht(o) : void 0);
	return l(_t, {
		locale: c,
		...a,
		children: t
	...
	if (r.nodeType === "enumeration") {
		let e = r[se], i = Y.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	let { locale: t } = n(K) ?? {};
	return a(() => wt(t, e), [t, e]);
}), Ot = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-next-intl-app/scripts/EmptyComponent.tsx", kt = () => (Dt(), null);
function At() {
	return d(q, {
		locale: "en",
		messages: {},
		timeZone: "UTC",
		children: d(kt, {}, void 0, !1, {
			fileName: Ot,
			lineNumber: 13,
			columnNumber: 7
		}, this)
...
var Nt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-next-intl-app/components/AppProviders.tsx";
...
var Ft = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-next-intl-app/scripts/Wrapper.tsx", It = "en";
...
var Rt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-next-intl-app/scripts/EmptyComponent.wrapper.tsx";
function zt() {
