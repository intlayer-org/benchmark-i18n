...
var f = {
...
}, fe = (e, t) => e[de(e, t) ?? "fallback"], T = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), E = "default", pe = /[^A-Za-z0-9._&=-]/g, D = /[^A-Za-z0-9._-]/g, me = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, O = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, me);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, he = (e) => e === void 0 ? E : typeof e == "string" ? O(e, pe) : Object.keys(e).sort().map((t) => `${O(t, D)}=${O(String(e[t]), D)}`).join("&"), ge = (e) => Array.isArray(e) ? e.length === 0 ? [E] : e.map(he) : [he(e)], _e = (e, t) => {
	...
	if (!ye(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? E : _e(ge(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => ve(e, n, t, s)).map((t) => be(e, t));
...
var Ne = () => ({}), Pe = /* @__PURE__ */ new Set([
	...
	let r = Ne()[e];
	return r ? ot(r, t, n) : (Ie.has(e) || (je({ log: m })(typeof window > "u" ? `Dictionary ${Me(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Ie.add(e)), Fe(e));
