...
import { usePathname as te } from "next/navigation";
var u = {
	locales: [
		"en",
		"fr",
...
}, p = /* @__PURE__ */ new WeakMap(), m = 0, ne = (e) => {
	if (!e) return "base";
	let t = p.get(e);
	if (t) return t;
	m += 1;
	let n = `p${m}`;
	return p.set(e, n), n;
}, re = 256, h = /* @__PURE__ */ new WeakMap(), g = (e) => typeof e == "object" && !!e, ie = (e, t, n) => `${e}_${t}_${ne(n)}`, ae = (e, t) => {
	if (!g(e)) return { hit: !1 };
	let n = h.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, oe = "translation", se = "enumeration", ce = "plural", v = "insertion", le = "object", ue = "array", de = "markdown", y = "html", fe = "gender", pe = "select", b = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), x = (e, t) => {
...
}, he = (e, t) => e[me(e, t) ?? "fallback"], S = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), C = "default", ge = /[^A-Za-z0-9._&=-]/g, _e = /[^A-Za-z0-9._-]/g, ve = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, w = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, ve);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, T = (e) => e === void 0 ? C : typeof e == "string" ? w(e, ge) : Object.keys(e).sort().map((t) => `${w(t, _e)}=${w(String(e[t]), _e)}`).join("&"), ye = (e) => Array.isArray(e) ? e.length === 0 ? [C] : e.map(T) : [T(e)], be = (e, t) => {
...
}).join("|") : "", E = "\x1B[0m", De = "\x1B[34m", Oe = "\x1B[31m", ke = "\x1B[32m", Ae = "\x1B[38;5;3m", je = "\x1B[36m", Me = (e) => e, Ne = (e, t) => {
...
}), D = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? E : n : E}` : e, Fe = (e, t = Ae, n = E) => [e].flat().map((e) => D(e, t, n)).join(", ");
D("✗", Oe), D("✓", ke), D("⏲", De);
var Ie = {
	faq: {
		key: "faq",
	...
	yield e;
} : ze(e ? `${e}.${String(n)}` : String(n)) }), Be = /* @__PURE__ */ new Set(), O = (e, t, n) => {
	let r = Le()[e];
	return r ? st(r, t, n) : (Be.has(e) || (Pe({ log: f })(typeof window > "u" ? `Dictionary ${Fe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Be.add(e)), ze(e));
}, Ve = 50, k = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Set(), He = (e) => {
...
function j(e, t, n) {
	let r = t ?? u?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = k.get(a);
...
var rt = (e) => F, it = F, at = (e, t = !0) => [
	Ze(e ?? u.defaultLocale, t ? u.defaultLocale : void 0),
	Qe,
	$e,
	et,
	...
	let { locale: r, selector: i } = Te(t), a = ie(r ?? u.defaultLocale, Ee(i), n), o = ae(e, a);
	if (o.hit) return o.content;
	let s = n ?? at(r), c = we(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var z = {
	...
	if (t?.isCookieEnabled !== !1 && !R && d.storage.cookies) for (let n = 0; n < d.storage.cookies.length; n++) {
	...
	locales: e.locales ?? u?.locales ?? ct,
	rewrite: e.rewrite ?? d?.rewrite,
	domains: e.domains ?? d?.domains
}), Tt = (e, t) => !!e && (t ?? u.locales).includes(e), Et = (e, t = u?.locales, n = u?.defaultLocale) => {
	...
	locale: _t ?? u?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), Ot = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: a, disableEditor: o, isCookieEnabled: c }) => {
	let { locales: ee, defaultLocale: te } = u ?? {}, [d, f] = s(e ?? _t ?? t ?? te);
	r(() => {
		e && e !== d && f(e);
	}, [e]), r(() => {
		Ct();
...
}), At = (e) => l(kt, { ...e }), jt = ({ locale: e, children: t, messages: n, timeZone: r, now: i, ...a }) => {
	n !== void 0 && Pe({ log: f })(`${D("NextIntlClientProvider", je)} do not pass the messages prop with intlayer. Messages are loaded automatically under the hood for bundle optimization reason`);
	let o = te(), s = d?.mode ?? "prefix-no-default", c = e ?? (s === "prefix-all" || s === "prefix-no-default" ? Dt(o) : void 0);
	return l(At, {
		locale: c,
		...a,
		children: t
	}, String(c));
}, V = (e) => b(se, e), Mt = (e) => b(fe, e), H = (e, t) => b(y, e, { tags: (() => {
	if (t) return t;
	if (typeof e == "string") {
		let { issues: t } = dt(e);
...
})() }), Nt = (e) => b(ce, e), Pt = (e, t) => b(pe, e, { variable: t }), Ft = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "enumeration") {
		let e = r[se], i = qt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[pe], i = X(t, typeof r.variable == "string" ? r.variable : "value");
...
function dn({ children: e, locale: t }) {
