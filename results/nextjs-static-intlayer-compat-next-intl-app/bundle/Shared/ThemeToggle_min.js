...
var R = {
...
}), B = (e, t) => !!e && (t ?? d.locales).includes(e), wt = (e, t = d?.locales, n = d?.defaultLocale) => {
...
}, H = (e) => S(se, e), At = (e) => S(b, e), U = (e, t) => S(y, e, { tags: (() => {
	if (t) return t;
	if (typeof e == "string") {
		let { issues: t } = dt(e);
	...
	if (r.nodeType === "plural") {
		let e = r[ce];
		return Z(We(e, Number(X(t, "count") ?? 1), n), t, n);
	}
	...
	i18next: Rt,
	"vue-i18n": Wt
}, Zt = (e, t = {}, n = "en", r = "icu") => Yt(Xt[r])(e, t, n), Q = (e) => {
	...
	return Object.assign((e, t) => r(e, t) ?? n(e), {
		...
		rich: (e, t) => {
			...
			return o === void 0 ? n(e) : l(c, { children: $t(Q(o), a) });
		},
		markup: (e, t) => {
			let { scalarValues: i, renderers: a } = Qt(t), o = r(e, i);
			return o === void 0 ? n(e) : en(Q(o), a);
		}
	});
}, an = ((e) => {
	let { locale: t } = n(V) ?? {};
