...
var p = {
...
}, oe = "translation", se = "enumeration", y = "plural", b = "insertion", ce = "object", le = "array", x = "markdown", S = "html", ue = "gender", de = "select", C = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), w = (e, t) => {
...
}, pe = (e, t) => e[fe(e, t) ?? "fallback"], me = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), T = "default", he = /[^A-Za-z0-9._&=-]/g, ge = /[^A-Za-z0-9._-]/g, _e = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, E = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, _e);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, ve = (e) => e === void 0 ? T : typeof e == "string" ? E(e, he) : Object.keys(e).sort().map((t) => `${E(t, ge)}=${E(String(e[t]), ge)}`).join("&"), ye = (e) => Array.isArray(e) ? e.length === 0 ? [T] : e.map(ve) : [ve(e)], be = (e, t) => {
	...
	if (!Se(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? T : be(ye(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => xe(e, n, t, s)).map((t) => Ce(e, t));
...
}), O = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? D : n : D}` : e, Fe = (e, t = Ae, n = D) => [e].flat().map((e) => O(e, t, n)).join(", ");
O("✗", Oe), O("✓", ke), O("⏲", De);
var k = () => ({}), Ie = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), A = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Ie.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : A(e ? `${e}.${String(n)}` : String(n)) }), Le = /* @__PURE__ */ new Set(), j = (e, t, n) => {
	let r = k()[e];
	return r ? ot(r, t, n) : (Le.has(e) || (Pe({ log: h })(typeof window > "u" ? `Dictionary ${Fe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Le.add(e)), A(e));
...
var We = (e, t, n) => e[M("PluralRules", n).select(t)] ?? e.other, Ge = (e, t) => {
	...
	if (F(e)) return e.nodeType === "html" ? e[S] : e[x];
}, Je = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, Xe = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? I : {
...
}, Ze = I, Qe = I, $e = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? I : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: b }], i = e[b], a = {
			...
			transform: (e, n, r) => {
				if (F(e)) return (i) => Ye(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, et = I, tt = I, nt = (e) => I, rt = I, it = (e, t = !0) => [
	Xe(e ?? p.defaultLocale, t ? p.defaultLocale : void 0),
	Ze,
	Qe,
	$e,
	nt(e ?? p.defaultLocale),
	rt,
	et,
	tt
], at = (e, t, n = []) => w(e, {
...
}, ft = (e) => /^[a-zA-Z][a-zA-Z\d+\-.]*:/.test(e), R = (e) => {
...
var B = {
	...
	if (!z) for (let t = 0; t < (m.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(m.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, ht = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !z && m.storage.cookies) for (let n = 0; n < m.storage.cookies.length; n++) {
	...
	locales: e.locales ?? p?.locales ?? st,
	rewrite: e.rewrite ?? m?.rewrite,
	domains: e.domains ?? m?.domains
}), Ct = (e, t) => !!e && (t ?? p.locales).includes(e), wt = (e, t = p?.locales, n = p?.defaultLocale) => {
	...
	locale: V ?? p?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), Et = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: a, disableEditor: o, isCookieEnabled: s }) => {
	let { locales: l, defaultLocale: d } = p ?? {}, [f, m] = c(e ?? V ?? t ?? d);
	r(() => {
		e && e !== f && m(e);
	}, [e]), r(() => {
		xt();
...
}), Ot = (e) => u(Dt, { ...e }), kt = ({ locale: e, children: t, messages: n, timeZone: r, now: i, ...a }) => {
	n !== void 0 && Pe({ log: h })(`${O("NextIntlClientProvider", je)} do not pass the messages prop with intlayer. Messages are loaded automatically under the hood for bundle optimization reason`);
	let o = f(), s = m?.mode ?? "prefix-no-default", c = e ?? (s === "prefix-all" || s === "prefix-no-default" ? Tt(o) : void 0);
	return u(Ot, {
		locale: c,
		...a,
		children: t
	}, String(c));
}, U = (e) => C(se, e), At = (e) => C(ue, e), W = (e, t) => C(S, e, { tags: (() => {
	if (t) return t;
	if (typeof e == "string") {
		let { issues: t } = ut(e);
...
})() }), jt = (e) => C(y, e), Mt = (e, t) => C(de, e, { variable: t }), Nt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "html") return Q(r[S], t, n);
	...
	if (r.nodeType === "select") {
		let e = r[de], i = Z(t, typeof r.variable == "string" ? r.variable : "value");
	...
	return Object.assign((e, t) => r(e, t) ?? n(e), {
		...
		rich: (e, t) => {
			...
			return o === void 0 ? n(e) : u(l, { children: $t($(o), a) });
		},
		markup: (e, t) => {
			let { scalarValues: i, renderers: a } = Qt(t), o = r(e, i);
