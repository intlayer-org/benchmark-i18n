...
var te = (e) => /^[a-zA-Z][a-zA-Z\d+\-.]*:/.test(e), S = (e) => {
...
var C = {
...
}, w = !1, T, ae = () => typeof window > "u" ? ie(C) : (w ||= (T = ie(C), !0), T), oe = (e, t) => {
	if (t?.isCookieEnabled !== !1 && (w = !1, !re && m.storage.cookies)) for (let n = 0; n < m.storage.cookies.length; n++) {
...
}, E = /* @__PURE__ */ new WeakMap(), D = 0, se = (e) => {
	if (!e) return "base";
	let t = E.get(e);
	if (t) return t;
	D += 1;
	let n = `p${D}`;
	return E.set(e, n), n;
}, ce = 256, O = /* @__PURE__ */ new WeakMap(), k = (e) => typeof e == "object" && !!e, le = (e, t, n) => `${e}_${t}_${se(n)}`, ue = (e, t) => {
	if (!k(e)) return { hit: !1 };
	let n = O.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	if (!k(e)) return n;
	let r = O.get(e);
	return r || (r = /* @__PURE__ */ new Map(), O.set(e, r)), r.size >= ce && r.clear(), r.set(t, n), n;
}, de = "translation", fe = "enumeration", pe = "plural", me = "condition", j = "insertion", he = "object", ge = "array", _e = "markdown", M = "html", ve = "gender", N = "select", P = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), F = (e, t) => {
...
}, be = (e, t) => e[ye(e, t) ?? "fallback"], I = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), L = "\x1B[0m", xe = "\x1B[34m", Se = "\x1B[31m", Ce = "\x1B[32m", we = "\x1B[38;5;3m", Te = "\x1B[36m", Ee = (e) => e, De = (e, t) => {
...
}), z = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? L : n : L}` : e, Oe = (e, t = we, n = L) => [e].flat().map((e) => z(e, t, n)).join(", ");
z("✗", Se), z("✓", Ce), z("⏲", xe);
var ke = {
	faq: {
		key: "faq",
...
}, B = () => ke, Ae = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), V = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Ae.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : V(e ? `${e}.${String(n)}` : String(n)) }), H = /* @__PURE__ */ new Set(), U = (e, t, n) => {
	let r = B()[e];
	return r ? Qe(r, t, n) : (H.has(e) || (R({ log: h })(typeof window > "u" ? `Dictionary ${Oe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), H.add(e)), V(e));
}, je = (e, t, n) => e[x("PluralRules", n).select(t)] ?? e.other, Me = (e, t) => {
	...
	if (K(e)) return e.nodeType === "html" ? e[M] : e[_e];
}, Fe = (e, t) => {
	if (typeof e == "string") return t;
	if (K(e)) {
		let n = e.nodeType === "html" ? M : _e;
		return {
			...e,
			[n]: t
		};
...
}, Re = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? q : {
...
}, ze = q, Be = (e) => q, Ve = q, He = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? q : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: j }], i = e[j], a = {
			...
			transform: (e, n, r) => {
				if (K(e)) return (i) => Ie(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, Ge = (e, t) => typeof t == "function" && Ue.includes(e?.nodeType ?? "") ? (n) => We(e, t, n) : t, Ke = q, qe = q;
process.env.INTLAYER_OPTIMIZED_NESTING;
var Je = (e) => q, Ye = q, Xe = (e, t = !0) => [
	Re(e ?? p.defaultLocale, t ? p.defaultLocale : void 0),
	ze,
	Be(e ?? p.defaultLocale),
	Ve,
	He,
	...
	Ke,
	qe
].filter((e) => e !== q), Ze = (e, t, n = []) => F(e, {
	...t,
	plugins: n
}), J = /* @__PURE__ */ new WeakSet(), Qe = (e, t, n) => {
	...
	locales: e.locales ?? p?.locales ?? $e,
	rewrite: e.rewrite ?? m?.rewrite,
	domains: e.domains ?? m?.domains
}), it = (e, t) => !!e && (t ?? p.locales).includes(e), at = (e, t = p?.locales, n = p?.defaultLocale) => {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), ct = ({ locale: e, defaultLocale: t, variant: r, children: a, setLocale: o, disableEditor: l, isCookieEnabled: d }) => {
	...
	return u(st.Provider, {
		value: x,
		children: a
	});
}, lt = ({ children: e, ...t }) => d(ct, {
	...t,
	children: [
		!1,
		!1,
	...
	n !== void 0 && R({ log: h })(`${z("NextIntlClientProvider", Te)} do not pass the messages prop with intlayer. Messages are loaded automatically under the hood for bundle optimization reason`);
	let o = f(), s = m?.mode ?? "prefix-no-default", c = e ?? (s === "prefix-all" || s === "prefix-no-default" ? ot(o) : void 0);
	return u(lt, {
		locale: c,
		...a,
		children: t
	...
	let r = e;
	if (r.nodeType === "insertion") return Q(r[j], t, n);
	...
	if (r.nodeType === "enumeration") {
		let e = r[fe], i = Y.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	return Object.assign((e, t) => r(e, t) ?? n(e), {
		...
		rich: (e, t) => {
			...
			return o === void 0 ? n(e) : u(l, { children: gt($(o), a) });
		},
		markup: (e, t) => {
			let { scalarValues: i, renderers: a } = ht(t), o = r(e, i);
			return o === void 0 ? n(e) : _t($(o), a);
		}
	});
}, xt = ((e) => {
	let { locale: t } = r(st) ?? {};
