...
}, g = /* @__PURE__ */ new WeakMap(), ee = 0, te = (e) => {
	if (!e) return "base";
	let t = g.get(e);
	if (t) return t;
	ee += 1;
...
}, oe = "translation", y = "enumeration", se = "plural", b = "insertion", ce = "object", le = "array", ue = "markdown", x = "html", de = "gender", fe = "select", S = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), C = (e, t) => {
...
}, me = (e, t) => e[pe(e, t) ?? "fallback"], he = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), w = "default", ge = /[^A-Za-z0-9._&=-]/g, _e = /[^A-Za-z0-9._-]/g, ve = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, T = (e, t) => {
	if (e === "") return "%";
...
}).join("|") : "", D = "\x1B[0m", De = "\x1B[34m", Oe = "\x1B[31m", ke = "\x1B[32m", Ae = "\x1B[38;5;3m", je = "\x1B[36m", Me = (e) => e, Ne = (e, t) => {
...
}), k = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? D : n : D}` : e, Pe = (e, t = Ae, n = D) => [e].flat().map((e) => k(e, t, n)).join(", ");
k("✗", Oe), k("✓", ke), k("⏲", De);
var Fe = {
	faq: {
		key: "faq",
...
}, A = () => Fe, Ie = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), j = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Ie.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : j(e ? `${e}.${String(n)}` : String(n)) }), M = /* @__PURE__ */ new Set(), N = (e, t, n) => {
	let r = A()[e];
	return r ? at(r, t, n) : (M.has(e) || (O({ log: h })(typeof window > "u" ? `Dictionary ${Pe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), M.add(e)), j(e));
}, Le = 50, P = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Set(), Re = (e) => {
...
function I(e, t, n) {
	let r = t ?? p?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = P.get(a);
...
var Ve = (e, t, n) => e[I("PluralRules", n).select(t)] ?? e.other, He = (e, t) => {
	...
	if (L(e)) return e.nodeType === "html" ? e[x] : e[ue];
}, qe = (e, t) => {
	if (typeof e == "string") return t;
	if (L(e)) {
		let n = e.nodeType === "html" ? x : ue;
		return {
			...e,
			[n]: t
		};
	...
	canHandle: () => !1,
	transform: (e) => e
}, Ye = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? R : {
...
}, Xe = R, Ze = R, Qe = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? R : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: b }], i = e[b], a = {
			...
			transform: (e, n, r) => {
				if (L(e)) return (i) => Je(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
var tt = (e) => R, nt = R, rt = (e, t = !0) => [
	...
	let { locale: r, selector: i } = Te(t), a = ie(r ?? p.defaultLocale, Ee(i), n), o = ae(e, a);
	if (o.hit) return o.content;
	let s = n ?? rt(r), c = we(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
}, dt = (e) => /^[a-zA-Z][a-zA-Z\d+\-.]*:/.test(e), ft = (e) => {
...
var B = {
	...
	if (!mt) for (let t = 0; t < (m.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(m.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, gt = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !mt && m.storage.cookies) for (let n = 0; n < m.storage.cookies.length; n++) {
	...
	locales: e.locales ?? p?.locales ?? ot,
	rewrite: e.rewrite ?? m?.rewrite,
	domains: e.domains ?? m?.domains
}), Tt = (e, t) => !!e && (t ?? p.locales).includes(e), Et = (e, t = p?.locales, n = p?.defaultLocale) => {
	...
	let { defaultLocale: n, locales: r, mode: i } = wt(t);
	if (!n || !r) return n;
	let a = dt(e), o = e?.endsWith("/") && e.length > 1 ? e.slice(0, -1) : e, s = a ? new URL(o) : new URL(o, "http://e.com");
	if (i === "search-params") {
	...
	locale: _t ?? p?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), Ot = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: a, disableEditor: o, isCookieEnabled: s }) => {
	let { locales: l, defaultLocale: d } = p ?? {}, [f, m] = c(e ?? _t ?? t ?? d);
	r(() => {
		e && e !== f && m(e);
	}, [e]), r(() => {
		Ct();
...
}), At = (e) => u(kt, { ...e }), jt = ({ locale: e, children: t, messages: n, timeZone: r, now: i, ...a }) => {
	n !== void 0 && O({ log: h })(`${k("NextIntlClientProvider", je)} do not pass the messages prop with intlayer. Messages are loaded automatically under the hood for bundle optimization reason`);
	let o = f(), s = m?.mode ?? "prefix-no-default", c = e ?? (s === "prefix-all" || s === "prefix-no-default" ? Dt(o) : void 0);
	return u(At, {
		locale: c,
		...a,
		children: t
	}, String(c));
}, H = (e) => S(y, e), Mt = (e) => S(de, e), U = (e, t) => S(x, e, { tags: (() => {
	if (t) return t;
	if (typeof e == "string") {
		let { issues: t } = lt(e);
...
})() }), Nt = (e) => S(se, e), Pt = (e, t) => S(fe, e, { variable: t }), Ft = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "plural") {
		let e = r[se];
		return Z(Ve(e, Number(X(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[y], i = qt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
}, Zt = (e) => (t, n = {}, r = "en") => Xt(typeof t == "string" ? e(t) : t, n, r), Qt = {
	icu: Lt,
	i18next: Bt,
	"vue-i18n": Kt
}, $t = (e, t = {}, n = "en", r = "icu") => Zt(Qt[r])(e, t, n), Q = (e) => {
	...
	let i = en(t.children, n), a = n[t.tag];
	return typeof a == "function" ? u(e, { children: a(i) }, r) : u(e, { children: i }, r);
}), tn = (e, t) => e.map((e) => {
	if (typeof e == "string") return e;
	let n = tn(e.children, t), r = t[e.tag];
	...
	return Object.assign((e, t) => r(e, t) ?? n(e), {
		...
		raw: (e) => t(e),
		rich: (e, t) => {
			let { scalarValues: i, renderers: a } = $(t), o = r(e, i);
			return o === void 0 ? n(e) : u(l, { children: en(Q(o), a) });
		},
		markup: (e, t) => {
			let { scalarValues: i, renderers: a } = $(t), o = r(e, i);
			return o === void 0 ? n(e) : tn(Q(o), a);
		}
	});
}, on = ((e) => {
	let { locale: t } = n(V) ?? {};
...
function sn() {
	...
	return d("section", {
		...
		children: [u("h2", {
			...
			children: e("settings.api-access-section.apiAccess")
		}), d("div", { children: [
			u("label", {
				htmlFor: t,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: e("settings.api-access-section.apiKey")
			}),
			d("div", {
			...
			u("p", {
				...
				children: e("settings.api-access-section.useThisKeyToAccess")
			})
		] })]
	});
}
...
function un({ children: e, locale: t }) {
