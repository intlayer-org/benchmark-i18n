...
var Ne = {
	...
	let r = Pe()[e];
	return r ? ct(r, t, n) : (Le.has(e) || (k({ log: p })(typeof window > "u" ? `Dictionary ${Me(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Le.add(e)), Ie(e));
...
var R = {
	...
	if (!L) for (let t = 0; t < (f.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(f.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, _t = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !L && f.storage.cookies) for (let n = 0; n < f.storage.cookies.length; n++) {
	...
	locales: e.locales ?? d?.locales ?? lt,
	rewrite: e.rewrite ?? f?.rewrite,
	domains: e.domains ?? f?.domains
}), B = (e, t) => !!e && (t ?? d.locales).includes(e), Tt = (e, t = d?.locales, n = d?.defaultLocale) => {
	...
	let { locales: u, defaultLocale: ee } = d ?? {}, [f, p] = s(e ?? z ?? t ?? ee);
	r(() => {
		e && e !== f && p(e);
	}, [e]), r(() => {
		Ct();
	...
	let o = ee(), s = f?.mode ?? "prefix-no-default", c = e ?? (s === "prefix-all" || s === "prefix-no-default" ? Et(o) : void 0);
	return l(kt, {
		locale: c,
		...a,
		children: t
	}, String(c));
}, H = (e) => S(se, e), jt = (e) => S(b, e), U = (e, t) => S(y, e, { tags: (() => {
	if (t) return t;
	if (typeof e == "string") {
		let { issues: t } = ft(e);
...
})() }), Mt = (e) => S(ce, e), Nt = (e, t) => S(x, e, { variable: t }), Pt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "plural") {
		let e = r[ce];
		return Z(Ge(e, Number(X(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[se], i = Kt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[x], i = X(t, typeof r.variable == "string" ? r.variable : "value");
		return Z(Ke(e, String(i ?? "")), t, n);
	}
...
}, Xt = (e) => (t, n = {}, r = "en") => Yt(typeof t == "string" ? e(t) : t, n, r), Zt = {
	icu: It,
	i18next: zt,
	"vue-i18n": Gt
}, Qt = (e, t = {}, n = "en", r = "icu") => Xt(Zt[r])(e, t, n), Q = (e) => {
	...
	let r = (n, r = {}) => {
		let i = t(n);
		if (i != null) return Qt(i, r, e, "icu");
	};
	return Object.assign((e, t) => r(e, t) ?? n(e), {
		has: (e) => t(e) !== void 0,
		raw: (e) => t(e),
		rich: (e, t) => {
			let { scalarValues: i, renderers: a } = $t(t), o = r(e, i);
			return o === void 0 ? n(e) : l(c, { children: en(Q(o), a) });
		},
		markup: (e, t) => {
			let { scalarValues: i, renderers: a } = $t(t), o = r(e, i);
