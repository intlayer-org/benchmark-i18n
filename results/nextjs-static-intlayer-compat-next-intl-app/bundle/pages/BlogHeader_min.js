...
}, C = !1, w, ae = () => typeof window > "u" ? S(x) : (C ||= (w = S(x), !0), w), oe = (e, t) => {
	if (t?.isCookieEnabled !== !1 && (C = !1, !ie && p.storage.cookies)) for (let n = 0; n < p.storage.cookies.length; n++) {
...
}, T = /* @__PURE__ */ new WeakMap(), E = 0, se = (e) => {
	if (!e) return "base";
	let t = T.get(e);
	if (t) return t;
	E += 1;
...
var ke = {
	...
	let r = z()[e];
	return r ? Qe(r, t, n) : (V.has(e) || (L({ log: m })(typeof window > "u" ? `Dictionary ${Oe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), V.add(e)), B(e));
...
}, Ge = (e, t) => typeof t == "function" && Ue.includes(e?.nodeType ?? "") ? (n) => We(e, t, n) : t, Ke = K, qe = K;
...
var Je = (e) => K, Ye = K, Xe = (e, t = !0) => [
	...
	locales: e.locales ?? f?.locales ?? $e,
	rewrite: e.rewrite ?? p?.rewrite,
	domains: e.domains ?? p?.domains
}), it = (e, t) => !!e && (t ?? f.locales).includes(e), at = (e, t = f?.locales, n = f?.defaultLocale) => {
	...
	get locale() {
		return et() ?? f?.defaultLocale;
	},
	setLocale: () => null,
	isCookieEnabled: !0
}), ct = ({ locale: e, defaultLocale: t, variant: r, children: a, setLocale: c, disableEditor: u, isCookieEnabled: d }) => {
	let { locales: p, defaultLocale: m } = f ?? {}, [h, g] = s(() => e ?? et() ?? t ?? m), [_, v] = s(e);
	e !== _ && (v(e), e && e !== h && g(e)), i(() => {
		nt();
	}, []);
	let ee = n((e) => {
	...
	return l(st.Provider, {
		value: te,
		children: a
	});
}, lt = ({ children: e, ...t }) => u(ct, {
	...t,
	children: [
		!1,
		!1,
...
}), ut = ({ locale: e, children: t, messages: n, timeZone: r, now: i, ...a }) => {
	...
	let o = d(), s = p?.mode ?? "prefix-no-default", c = e ?? (s === "prefix-all" || s === "prefix-no-default" ? ot(o) : void 0);
	return l(lt, {
		locale: c,
		...a,
		children: t
	...
	return String(e);
}, pt = (e, t = {}, n = "en") => e.replace(/\{\{\s*([^{},]+?)\s*(?:,\s*(\w+)\s*(?:,\s*([^{}]+?)\s*)?)?\}\}/g, (e, r, i, a) => {
	let o = Y(t, r);
	return o === void 0 ? e : i ? ft(o, i, a, n) : String(o);
	...
	let r = e;
	if (r.nodeType === "insertion") return Z(r[k], t, n);
	if (r.nodeType === "html") return Z(r[A], t, n);
	if (r.nodeType === "plural") {
		let e = r[me];
		return Z(je(e, Number(X(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[pe], i = J.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
		for (let [t, n] of Object.entries(e)) J.includes(t) || (o[t] = n);
		let s = X(t, i), c;
	...
	if (r.nodeType === "select") {
		let e = r[M], i = X(t, typeof r.variable == "string" ? r.variable : "value");
		return Z(Me(e, String(i ?? "")), t, n);
	}
	...
	let i = gt(t.children, n), a = n[t.tag];
	return typeof a == "function" ? l(e, { children: a(i) }, r) : l(e, { children: i }, r);
}), _t = (e, t) => e.map((e) => {
	if (typeof e == "string") return e;
	let n = _t(e.children, t), r = t[e.tag];
	return typeof r == "function" ? r(n) : n;
}).join(""), vt = (e, t) => {
	let [n, ...r] = (t ?? "").split("."), i = r.join(".");
	return bt(e, (t) => yt(e, n ?? "", i, t), (e) => t ? `${t}.${e}` : e);
}, yt = (e, t, n, r) => {
	...
	let r = (n, r = {}) => {
		let i = t(n);
		if (i != null) return mt(i, r, e);
	};
	return Object.assign((e, t) => r(e, t) ?? n(e), {
		has: (e) => t(e) !== void 0,
		raw: (e) => t(e),
		rich: (e, t) => {
			let { scalarValues: i, renderers: a } = ht(t), o = r(e, i);
			return o === void 0 ? n(e) : l(c, { children: gt(Q(o), a) });
		},
		markup: (e, t) => {
			let { scalarValues: i, renderers: a } = ht(t), o = r(e, i);
			return o === void 0 ? n(e) : _t(Q(o), a);
		}
	});
}, $ = ((e) => {
	let { locale: t } = r(st) ?? {};
