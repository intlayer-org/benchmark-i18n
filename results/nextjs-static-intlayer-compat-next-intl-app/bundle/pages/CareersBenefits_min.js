...
var Ne = () => ({}), Pe = /* @__PURE__ */ new Set([
	...
	let r = Ne()[e];
	return r ? nt(r, t, n) : (j.has(e) || (k({ log: p })(typeof window > "u" ? `Dictionary ${Me(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), j.add(e)), Fe(e));
...
function F(e, t, n) {
	let r = t ?? d?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = N.get(a);
...
var Be = (e, t, n) => e[F("PluralRules", n).select(t)] ?? e.other, Ve = (e, t) => {
	...
	if (R(e)) return e.nodeType === "html" ? e[b] : e[y];
}, We = (e, t) => {
	...
	Ke(e ?? d.defaultLocale, t ? d.defaultLocale : void 0),
	qe,
	Je,
	Ye,
	...
	let { locale: r, selector: i } = Ce(t), a = ae(r ?? d.defaultLocale, we(i), n), o = oe(e, a);
...
var H = {
	...
	if (t?.isCookieEnabled !== !1 && !V && f.storage.cookies) for (let n = 0; n < f.storage.cookies.length; n++) {
	...
	locales: e.locales ?? d?.locales ?? rt,
	rewrite: e.rewrite ?? f?.rewrite,
	domains: e.domains ?? f?.domains
}), W = (e, t) => !!e && (t ?? d.locales).includes(e), ht = (e, t = d?.locales, n = d?.defaultLocale) => {
	...
	let o = te(), s = f?.mode ?? "prefix-no-default", c = e ?? (s === "prefix-all" || s === "prefix-no-default" ? gt(o) : void 0);
	return l(vt, {
		locale: c,
		...a,
		children: t
	...
	if (r.nodeType === "enumeration") {
		let e = r[ce], i = q.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	let { locale: t } = n(G) ?? {};
	return a(() => Tt(t, e), [t, e]);
}), $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-next-intl-app/components/pages/careers/CareersBenefits.tsx";
function kt() {
	let e = Ot(), t = [
		{
			label: "Remote-first",
			value: e("careers-benefits.workFromAnywhereInThe")
		},
		{
...
var Lt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-next-intl-app/components/pages/careers/CareersBenefits.wrapper.tsx";
function Rt() {
	return u(It, { children: u(kt, {}, void 0, !1, {
		fileName: Lt,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
