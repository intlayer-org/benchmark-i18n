...
var Ne = {
	...
	let r = j()[e];
	return r ? st(r, t, n) : (Ie.has(e) || (k({ log: p })(typeof window > "u" ? `Dictionary ${Me(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Ie.add(e)), Fe(e));
...
var rt = (e) => F, it = F, at = (e, t = !0) => [
	Ze(e ?? d.defaultLocale, t ? d.defaultLocale : void 0),
	Qe,
	$e,
	et,
...
var z = {
	...
	locales: e.locales ?? d?.locales ?? ct,
	rewrite: e.rewrite ?? f?.rewrite,
	domains: e.domains ?? f?.domains
}), V = (e, t) => !!e && (t ?? d.locales).includes(e), wt = (e, t = d?.locales, n = d?.defaultLocale) => {
	...
	let o = ee(), s = f?.mode ?? "prefix-no-default", c = e ?? (s === "prefix-all" || s === "prefix-no-default" ? Tt(o) : void 0);
	return l(Ot, {
		locale: c,
		...a,
		children: t
	}, String(c));
}, U = (e) => S(se, e), At = (e) => S(b, e), W = (e, t) => S(y, e, { tags: (() => {
	if (t) return t;
	if (typeof e == "string") {
		let { issues: t } = dt(e);
...
})() }), jt = (e) => S(ce, e), Mt = (e, t) => S(x, e, { variable: t }), Nt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "enumeration") {
		let e = r[se], i = Gt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
