import { Fragment, createContext, useCallback, useContext, useEffect, useId, useLayoutEffect, useMemo, useState } from "react";
	...
	return jsxs("form", {
		...
		children: [
			...
			jsxs("div", { children: [jsx("label", {
				...
				children: [
					jsx("option", { children: t("contact-form.bugReport") }),
					jsx("option", { children: t("contact-form.newBenchmarkIdea") }),
					jsx("option", { children: t("contact-form.methodologyQuestion") }),
					jsx("option", { children: tHeader("contact") }),
