...
}, oe = "translation", y = "enumeration", b = "plural", x = "insertion", se = "object", ce = "array", le = "markdown", S = "html", ue = "gender", de = "select", C = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), w = (e, t) => {
...
var Ve = (e, t, n) => e[I("PluralRules", n).select(t)] ?? e.other, He = (e, t) => {
	...
	if (L(e)) return e.nodeType === "html" ? e[S] : e[le];
}, qe = (e, t) => {
	if (typeof e == "string") return t;
	if (L(e)) {
		let n = e.nodeType === "html" ? S : le;
		return {
			...e,
			[n]: t
		};
...
var B = {
...
}, H = (e) => C(y, e), Mt = (e) => C(ue, e), U = (e, t) => C(S, e, { tags: (() => {
	if (t) return t;
	if (typeof e == "string") {
		let { issues: t } = lt(e);
...
})() }), Nt = (e) => C(b, e), Pt = (e, t) => C(de, e, { variable: t }), Ft = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "html") return Z(r[S], t, n);
	...
	if (r.nodeType === "select") {
		let e = r[de], i = X(t, typeof r.variable == "string" ? r.variable : "value");
...
function sn() {
	let e = on(), t = on("header"), n = i(), r = i(), a = i(), o = i();
	return d("form", {
		className: "space-y-6",
		children: [
			d("div", {
