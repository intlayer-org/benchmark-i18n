...
var k = () => ({}), Ie = /* @__PURE__ */ new Set([
	...
	let r = k()[e];
	return r ? st(r, t, n) : (Le.has(e) || (Pe({ log: h })(typeof window > "u" ? `Dictionary ${Fe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Le.add(e)), A(e));
...
var We = (e, t, n) => e[M("PluralRules", n).select(t)] ?? e.other, Ge = (e, t) => {
	...
	if (P(e)) return e.nodeType === "html" ? e[S] : e[x];
}, Ye = (e, t) => {
...
}, tt = F, nt = F, rt = (e) => F, it = F, at = (e, t = !0) => [
	Ze(e ?? p.defaultLocale, t ? p.defaultLocale : void 0),
	Qe,
	$e,
	et,
...
var z = {
	...
	if (!R) for (let t = 0; t < (m.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(m.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, gt = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !R && m.storage.cookies) for (let n = 0; n < m.storage.cookies.length; n++) {
	...
	locales: e.locales ?? p?.locales ?? ct,
	rewrite: e.rewrite ?? m?.rewrite,
	domains: e.domains ?? m?.domains
}), V = (e, t) => !!e && (t ?? p.locales).includes(e), wt = (e, t = p?.locales, n = p?.defaultLocale) => {
...
function on() {
	let e = an(), t = an("header"), n = i(), r = i(), a = i(), o = i();
	return d("form", {
		className: "space-y-6",
		children: [
			d("div", {
			...
			d("div", { children: [u("label", {
				...
				children: [
					u("option", { children: e("contact-form.bugReport") }),
					u("option", { children: e("contact-form.newBenchmarkIdea") }),
					u("option", { children: e("contact-form.methodologyQuestion") }),
					u("option", { children: t("contact") }),
