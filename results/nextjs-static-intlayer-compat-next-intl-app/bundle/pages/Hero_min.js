...
var Ne = {
	...
	let r = j()[e];
	return r ? st(r, t, n) : (Ie.has(e) || (je({ log: m })(typeof window > "u" ? `Dictionary ${Me(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Ie.add(e)), Fe(e));
...
}, U = (e) => C(oe, e), At = (e) => C(x, e), W = (e, t) => C(b, e, { tags: (() => {
	if (t) return t;
	if (typeof e == "string") {
		let { issues: t } = dt(e);
...
})() }), jt = (e) => C(se, e), Mt = (e, t) => C(S, e, { variable: t }), Nt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
function sn() {
	let e = an(), t = an("header");
	return on("Hero"), u("section", {
