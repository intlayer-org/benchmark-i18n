...
var G = {
	...
	let o = d(), s = h?.mode ?? "prefix-no-default", c = e ?? (s === "prefix-all" || s === "prefix-no-default" ? ht(o) : void 0);
	return l(_t, {
		locale: c,
		...a,
		children: t
	...
	let r = e;
	if (r.nodeType === "insertion") return X(r[b], t, n);
	if (r.nodeType === "html") return X(r[x], t, n);
	if (r.nodeType === "plural") {
		let e = r[ce];
		return X(Re(e, Number(Y(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[se], i = bt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	return Object.assign((e, t) => r(e, t) ?? n(e), {
		...
		rich: (e, t) => {
			...
			return o === void 0 ? n(e) : l(c, { children: Tt(Z(o), a) });
		},
		markup: (e, t) => {
			let { scalarValues: i, renderers: a } = wt(t), o = r(e, i);
	...
	let { locale: t } = n(q) ?? {};
	return a(() => Dt(t, e), [t, e]);
}), Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-next-intl-app/components/pages/careers/OpenPositions.tsx";
function jt() {
	let e = At(), t = [
		{
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/intlayer-compat-next-intl-app/components/pages/careers/OpenPositions.wrapper.tsx";
function zt() {
