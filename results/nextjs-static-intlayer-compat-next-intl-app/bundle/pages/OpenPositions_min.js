...
var Ne = {
	...
	yield e;
} : Ie(e ? `${e}.${String(n)}` : String(n)) }), Le = /* @__PURE__ */ new Set(), Re = (e, t, n) => {
	let r = Pe()[e];
	return r ? ct(r, t, n) : (Le.has(e) || (k({ log: m })(typeof window > "u" ? `Dictionary ${Me(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Le.add(e)), Ie(e));
}, ze = 50, Be = /* @__PURE__ */ new Map(), Ve = /* @__PURE__ */ new Set(), He = (e) => {
...
function j(e, t, n) {
	let r = t ?? f?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = Be.get(a);
...
var Ge = (e, t, n) => e[j("PluralRules", n).select(t)] ?? e.other, Ke = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, Qe = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? P : {
...
}, $e = P, et = P, tt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? P : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: y }], i = e[y], a = {
			...
			transform: (e, n, r) => {
				if (N(e)) return (i) => Ze(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, mt = (e) => /^[a-zA-Z][a-zA-Z\d+\-.]*:/.test(e), I = (e) => {
...
var R = {
	...
	locales: e.locales ?? f?.locales ?? lt,
	rewrite: e.rewrite ?? p?.rewrite,
	domains: e.domains ?? p?.domains
}), B = (e, t) => !!e && (t ?? f.locales).includes(e), Tt = (e, t = f?.locales, n = f?.defaultLocale) => {
	...
	if (!n || !r) return n;
	let a = mt(e), o = e?.endsWith("/") && e.length > 1 ? e.slice(0, -1) : e, s = a ? new URL(o) : new URL(o, "http://e.com");
	if (i === "search-params") {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), Dt = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: a, disableEditor: o, isCookieEnabled: c }) => {
...
}), kt = (e) => l(Ot, { ...e }), At = ({ locale: e, children: t, messages: n, timeZone: r, now: i, ...a }) => {
	...
	let o = d(), s = p?.mode ?? "prefix-no-default", c = e ?? (s === "prefix-all" || s === "prefix-no-default" ? Et(o) : void 0);
	return l(kt, {
		locale: c,
		...a,
		children: t
	}, String(c));
}, H = (e) => S(oe, e), jt = (e) => S(de, e), U = (e, t) => S(b, e, { tags: (() => {
	if (t) return t;
	if (typeof e == "string") {
		let { issues: t } = ft(e);
...
})() }), Mt = (e) => S(se, e), Nt = (e, t) => S(x, e, { variable: t }), Pt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "plural") {
		let e = r[se];
		return Q(Ge(e, Number(Z(t, "count") ?? 1), n), t, n);
	}
	...
	i18next: zt,
	"vue-i18n": Gt
}, Zt = (e, t = {}, n = "en", r = "icu") => Yt(Xt[r])(e, t, n), $ = (e) => {
	...
	let i = $t(t.children, n), a = n[t.tag];
	...
	return rn(e, (t) => nn(e, n ?? "", i, t), (e) => t ? `${t}.${e}` : e);
}, nn = (e, t, n, r) => {
	let i = t, a = n ? `${n}.${r}` : r, o = Pe();
	if (!i) {
		let [t, ...n] = r.split(".");
	...
	return Object.assign((e, t) => r(e, t) ?? n(e), {
		...
		rich: (e, t) => {
			...
			return o === void 0 ? n(e) : l(c, { children: $t($(o), a) });
		},
		markup: (e, t) => {
			let { scalarValues: i, renderers: a } = Qt(t), o = r(e, i);
			return o === void 0 ? n(e) : en($(o), a);
		}
	});
}, an = ((e) => {
	let { locale: t } = n(V) ?? {};
...
function ln({ children: e, locale: t }) {
