		...
		children: t.map((t) => u("div", {
			...
			children: [
				...
				l("ul", {
					...
					children: t.features.map((e) => u("li", {
				...
				l("button", {
					...
					children: t.name === e("pricing.pricing-tiers.enterprise") ? e("pricing.pricing-tiers.contactSales") : e("pricing.pricing-tiers.getStarted")
				})
			]
		}, t.name))
	});
