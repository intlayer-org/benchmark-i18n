...
var j = () => ({}), Ne = /* @__PURE__ */ new Set([
	...
	let r = j()[e];
	return r ? ot(r, t, n) : (Fe.has(e) || (k({ log: m })(typeof window > "u" ? `Dictionary ${Me(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Fe.add(e)), Pe(e));
...
function M(e, t, n) {
	let r = t ?? f?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = Re.get(a);
...
var Ue = (e, t, n) => e[M("PluralRules", n).select(t)] ?? e.other, We = (e, t) => {
	...
	Xe(e ?? f.defaultLocale, t ? f.defaultLocale : void 0),
	Ze,
	Qe,
	$e,
	nt(e ?? f.defaultLocale),
	rt,
	et,
	tt
], at = (e, t, n = []) => C(e, {
...
var z = {
	...
	locales: e.locales ?? f?.locales ?? st,
	rewrite: e.rewrite ?? p?.rewrite,
	domains: e.domains ?? p?.domains
}), V = (e, t) => !!e && (t ?? f.locales).includes(e), Ct = (e, t = f?.locales, n = f?.defaultLocale) => {
	...
	let o = d(), s = p?.mode ?? "prefix-no-default", c = e ?? (s === "prefix-all" || s === "prefix-no-default" ? wt(o) : void 0);
	return l(Dt, {
		locale: c,
		...a,
		children: t
	}, String(c));
}, U = (e) => S(oe, e), kt = (e) => S(de, e), W = (e, t) => S(b, e, { tags: (() => {
	if (t) return t;
	if (typeof e == "string") {
		let { issues: t } = ut(e);
...
})() }), At = (e) => S(se, e), jt = (e, t) => S(x, e, { variable: t }), Mt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "plural") {
		let e = r[se];
		return Q(Ue(e, Number(Z(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[oe], i = Wt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
