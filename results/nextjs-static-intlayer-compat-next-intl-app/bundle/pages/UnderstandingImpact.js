	...
	return jsxs("section", {
		...
		children: [
			jsx("h2", {
				...
				children: t("understanding-impact.understandingTheImpact")
			}),
			jsxs("div", {
				...
				children: [
					jsx("h3", {
						...
						children: t("understanding-impact.whyASingleLargeJson")
					}),
					jsx("p", {
						className: "text-sm text-muted-foreground",
						children: t("understanding-impact.manyI18nLibrariesStoreTranslations")
					}),
					jsxs("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							jsx("li", { children: t("understanding-impact.theJsonMustBeParsed") }),
							jsx("li", { children: t("understanding-impact.contextBasedArchitecturesCanCause") }),
							jsx("li", { children: t("understanding-impact.duringServerSideRenderingThe") })
						]
					})
				]
			}),
			jsxs("div", {
				...
				children: [
					jsx("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: t("understanding-impact.theTradeOffsOfDynamic")
					}),
					jsx("p", {
						className: "text-sm text-muted-foreground",
						children: t("understanding-impact.splittingTranslationsIntoPerRoute")
					}),
					jsxs("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
			...
			jsxs("div", {
				...
				children: [jsx("h3", {
					className: "mb-2 text-lg font-semibold text-foreground",
					children: t("understanding-impact.whatThisBenchmarkMeasures")
				}), jsx("p", {
					className: "text-sm text-muted-foreground",
					children: t("understanding-impact.thisTestAppProvidesA")
				})]
			})
		]
	});
