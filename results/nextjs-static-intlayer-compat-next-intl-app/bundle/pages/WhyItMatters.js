...
function WhyItMatters() {
	...
	return jsxs("section", {
		...
		children: [jsx("h2", {
			...
			children: t("home.why-it-matters.whyTheseMetricsMatter")
		}), jsxs("div", {
			...
			children: [
				jsxs("div", {
					...
					children: [jsx("h3", {
						...
						children: t("results-table.bundleSize")
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
						children: t("home.why-it-matters.theBundleIsTheData")
					})]
				}),
				jsxs("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [jsx("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: t("home.why-it-matters.renderingHydration")
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
						children: t("why-it-matters.connectingALargeJsonDictionary")
					})]
				}),
				jsxs("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [jsx("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: t("home.why-it-matters.dynamicLoading")
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
						children: t("why-it-matters.loadingAllTranslationsUpfrontOverloads")
					})]
				})
			]
		})]
