...
function ie(e, t) {
	return /^::/.test(e) ? w(re(e.substring(2)), void 0, t) : e;
}
function O(e, t = (e) => e) {
	return D((0, p.parse)(e), t);
}
function ae(e, t = (e) => e) {
	try {
		return O(e, t);
...
var k = (e) => typeof e == "string", oe = (e) => typeof e == "function", A = /* @__PURE__ */ new Map(), j = "en";
function M(e) {
	return [...Array.isArray(e) ? e : [e], j];
}
function N(e, t, n) {
	let r = M(e);
	n ||= "default";
...
function I(e, t, n, { offset: r = 0, ...i }) {
	let a = M(e), o = t ? L(() => R("plural-ordinal", a), () => new Intl.PluralRules(a, { type: "ordinal" })) : L(() => R("plural-cardinal", a), () => new Intl.PluralRules(a, { type: "cardinal" }));
	return i[n] ?? i[o.select(n - r)] ?? i.other;
}
function L(e, t) {
	let n = e(), r = A.get(n);
	return r || (r = t(), A.set(n, r)), r;
}
function R(e, t, n) {
...
var z = /\\u[a-fA-F0-9]{4}|\\x[a-fA-F0-9]{2}/, B = (e) => e.replace(/\\u([a-fA-F0-9]{4})|\\x([a-fA-F0-9]{2})/g, (e, t, n) => {
...
}), V = "%__lingui_octothorpe__%", H = (e, t, n = {}) => {
	...
	return {
		...
		date: (e, t) => N(r, e, i(t) || t),
		time: (e, t) => P(r, e, i(t) || t)
	};
}, U = (e, t) => t[e] ?? t.other;
function W(e, t, n) {
	return (r = {}, i) => {
		let a = H(t, n, i), o = (e, t = !1) => Array.isArray(e) ? e.reduce((e, n) => {
			if (n === "#" && t) return e + V;
			if (k(n)) return e + n;
			let [i, s, c] = n, l = {};
...
var G = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(ae), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? j, e.locales);
	}
	get locale() {
		return this._locale;
	}
	...
	_(e, t, n) {
		...
		if (o && a) return oe(o) ? o(this._locale, e) : o;
		a && this.emit("missing", {
			id: e,
			locale: this._locale
		});
...
`)), k(s) && z.test(s) ? B(s) : k(s) ? s : W(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
var Y = (e, t) => ({
	...
	let r = i(() => fe(e, t), [e, t]), a = (0, le.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
	return a.i18n.locale ? o(J.Provider, {
		value: a,
		children: n
...
}, Z = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/scripts/EmptyComponent.tsx", pe = () => {
	let { _: e, i18n: t } = de();
	return t.locale, null;
};
function me() {
	let e = q();
	return e.load("en", {}), e.activate("en"), s(X, {
		i18n: e,
		children: s(pe, {}, void 0, !1, {
			fileName: Z,
			lineNumber: 21,
			columnNumber: 7
		}, this)
...
var ye = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/AppProviders.tsx";
function be({ children: e }) {
	let t = c().locale ?? "en", o = i(() => _e(t), [t]), l = i(() => ve(t, o), [t, o]), [u] = a(() => typeof performance < "u" ? performance.now() : 0);
	return r(() => {
		ge("AppRoot", u);
	}, [u]), n(() => {
...
var xe = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/scripts/Wrapper.tsx";
function Se({ children: e }) {
	return s(be, { children: e }, void 0, !1, {
		fileName: xe,
		lineNumber: 9,
		columnNumber: 10
	}, this);
...
function Ce() {
	return s(Se, { children: s(me, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
