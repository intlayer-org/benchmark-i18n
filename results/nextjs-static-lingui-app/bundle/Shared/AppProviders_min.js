...
var s = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), c = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	let i = r(() => m(e, t), [e, t]), a = (0, d.useSyncExternalStore)(i.subscribe, i.getSnapshot, i.getSnapshot);
...
function $({ children: e }) {
	let s = a().locale ?? "en", c = r(() => ue(s), [s]), l = r(() => de(s, c), [s, c]), [u] = i(() => typeof performance < "u" ? performance.now() : 0);
	return n(() => {
		_("AppRoot", u);
	}, [u]), t(() => {
