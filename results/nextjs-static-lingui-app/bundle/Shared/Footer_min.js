...
function N(e, t) {
	switch (e.field) {
		...
		case "tz": return { timeZoneName: ge(e, t) };
		case "quarter":
		case "week":
		case "sec-frac":
...
function be(e, t) {
	return /^::/.test(e) ? P(ye(e.substring(2)), void 0, t) : e;
}
function xe(e, t = (e) => e) {
	return R((0, ue.parse)(e), t);
}
function Se(e, t = (e) => e) {
	try {
		return xe(e, t);
...
var z = (e) => typeof e == "string", Ce = (e) => typeof e == "function", B = /* @__PURE__ */ new Map(), V = "en";
function H(e) {
...
}), X = "%__lingui_octothorpe__%", Te = (e, t, n = {}) => {
...
var Oe = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(Se), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? V, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), z(s) && J.test(s) ? Y(s) : z(s) ? s : De(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
function je({ children: e }) {
	let t = c().locale ?? "en", n = a(() => Ae(t), [t]), s = a(() => $(t, n), [t, n]), [l] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		se("AppRoot", l);
	}, [l]), r(() => {
