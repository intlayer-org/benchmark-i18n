...
function _e(e, t) {
	return /^::/.test(e) ? he(I(e.substring(2)), void 0, t) : e;
}
function ve(e, t = (e) => e) {
...
var R = (e) => typeof e == "string", be = (e) => typeof e == "function", z = /* @__PURE__ */ new Map(), B = "en";
function V(e) {
...
var Te = Object.defineProperty, Ee = (e, t, n) => t in e ? Te(e, t, {
	...
	writable: !0,
	value: n
}) : e[t] = n, De = (e, t, n) => (Ee(e, typeof t == "symbol" ? t : t + "", n), n), X = class {
	constructor() {
		De(this, "_events", {});
	}
	on(e, t) {
	...
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (ke(e, typeof t == "symbol" ? t : t + "", n), n), Ae = class extends X {
	constructor(e) {
		super(), Z(this, "_locale", ""), Z(this, "_locales"), Z(this, "_localeData", {}), Z(this, "_messages", {}), Z(this, "_missing"), Z(this, "_messageCompiler"), Z(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(ye), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? B, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), R(s) && q.test(s) ? J(s) : R(s) ? s : we(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
function Ne({ children: e }) {
	let t = u().locale ?? "en", n = o(() => je(t), [t]), r = o(() => Me(t, n), [t, n]), [s] = c(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		ae("AppRoot", s);
	}, [s]), i(() => {
...
function Pe({ children: e }) {
	return f(Ne, { children: e });
}
function Fe() {
	return f(Pe, { children: f(re, {}) });
}
