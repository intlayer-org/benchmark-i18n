...
}), m = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/Link.tsx", h = (e) => /^https?:\/\//.test(e ?? "");
function g(e, t) {
...
var k = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/Footer.tsx";
function se() {
	let { i18n: e } = re(), t = [
		{
...
function N(e, t) {
	switch (e.field) {
		...
		case "tz": return { timeZoneName: ve(e, t) };
		case "quarter":
		case "week":
		case "sec-frac":
...
function Ce(e, t) {
	return /^::/.test(e) ? P(Se(e.substring(2)), void 0, t) : e;
}
function we(e, t = (e) => e) {
	return L((0, fe.parse)(e), t);
}
function Te(e, t = (e) => e) {
	try {
		return we(e, t);
...
var R = (e) => typeof e == "string", Ee = (e) => typeof e == "function", z = /* @__PURE__ */ new Map(), B = "en";
function V(e) {
...
var je = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(Te), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? B, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), R(s) && q.test(s) ? J(s) : R(s) ? s : Ae(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
var Pe = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/AppProviders.tsx";
function Fe({ children: e }) {
	let t = c().locale ?? "en", n = a(() => Q(t), [t]), s = a(() => Ne(t, n), [t, n]), [u] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		le("AppRoot", u);
	}, [u]), r(() => {
...
var Ie = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/scripts/Wrapper.tsx";
function Le({ children: e }) {
	return l(Fe, { children: e }, void 0, !1, {
		fileName: Ie,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/Footer.wrapper.tsx";
function Re() {
	return l(Le, { children: l(se, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
