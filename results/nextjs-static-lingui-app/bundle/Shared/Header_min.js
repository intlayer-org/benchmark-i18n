...
var ge = Object.defineProperty, _e = (e, t, n) => t in e ? ge(e, t, {
	...
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (xe(e, typeof t == "symbol" ? t : t + "", n), n), Se = class extends ye {
	constructor(e) {
...
function He({ children: e }) {
	let t = l().locale ?? "en", n = a(() => Fe(t), [t]), o = a(() => Ie(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		Ve("AppRoot", c);
	}, [c]), r(() => {
...
function Ue({ children: e }) {
	return f(He, { children: e });
}
function We() {
	return f(Ue, { children: f(ze, {}) });
}
