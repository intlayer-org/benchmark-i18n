...
}), h = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/Link.tsx", g = (e) => /^https?:\/\//.test(e ?? "");
function _(e, t) {
...
}, ne = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/ThemeToggle.tsx";
function re() {
...
function P(e, t) {
	return /^::/.test(e) ? me(M(e.substring(2)), void 0, t) : e;
}
function F(e, t = (e) => e) {
	return N((0, se.parse)(e), t);
}
function ye(e, t = (e) => e) {
	try {
		return F(e, t);
...
var I = (e) => typeof e == "string", be = (e) => typeof e == "function", L = /* @__PURE__ */ new Map(), R = "en";
function z(e) {
...
function B(e, t, n) {
	...
	return U(() => W("date", r, n), () => new Intl.DateTimeFormat(r, i)).format(I(t) ? new Date(t) : t);
}
function xe(e, t, n) {
	let r;
...
function H(e, t, n, { offset: r = 0, ...i }) {
	let a = z(e), o = t ? U(() => W("plural-ordinal", a), () => new Intl.PluralRules(a, { type: "ordinal" })) : U(() => W("plural-cardinal", a), () => new Intl.PluralRules(a, { type: "cardinal" }));
...
}), q = "%__lingui_octothorpe__%", Se = (e, t, n = {}) => {
...
function we(e, t, n) {
	return (r = {}, i) => {
		...
		return I(s) && G.test(s) ? K(s) : I(s) ? s : s ? String(s) : "";
	};
}
var Te = class {
	_events = {};
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(ye), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? R, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), I(s) && G.test(s) ? K(s) : I(s) ? s : we(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
var Z = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/LocaleSwitcher.tsx";
function Be() {
...
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/Header.tsx";
function He() {
	let { i18n: e } = w();
	Ve("Header");
...
var Ge = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/AppProviders.tsx";
function Ke({ children: e }) {
	let t = s().locale ?? "en", o = i(() => Re(t), [t]), c = i(() => ze(t, o), [t, o]), [l] = a(() => typeof performance < "u" ? performance.now() : 0);
	return r(() => {
		We("AppRoot", l);
	}, [l]), n(() => {
...
var qe = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/scripts/Wrapper.tsx";
function Je({ children: e }) {
	return u(Ke, { children: e }, void 0, !1, {
		fileName: qe,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/Header.wrapper.tsx";
function Ye() {
	return u(Je, { children: u(He, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
