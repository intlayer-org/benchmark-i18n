...
function I(e, t) {
	return /^::/.test(e) ? de(P(e.substring(2)), void 0, t) : e;
}
function L(e, t = (e) => e) {
	return F((0, O.parse)(e), t);
}
function R(e, t = (e) => e) {
	try {
		return L(e, t);
...
function Be({ children: e }) {
	let t = s().locale ?? "en", o = i(() => Pe(t), [t]), c = i(() => $(t, o), [t, o]), [l] = a(() => typeof performance < "u" ? performance.now() : 0);
	return r(() => {
		ze("AppRoot", l);
	}, [l]), n(() => {
...
function Ve({ children: e }) {
	return u(Be, { children: e });
}
function He() {
	return u(Ve, { children: u(Le, {}) });
}
