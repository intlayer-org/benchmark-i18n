...
}), d = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/Link.tsx", f = (e) => /^https?:\/\//.test(e ?? "");
function p(e, t) {
...
function ye({ children: e }) {
	let a = o().locale ?? "en", c = r(() => _e(a), [a]), l = r(() => Q(a, c), [a, c]), [u] = i(() => typeof performance < "u" ? performance.now() : 0);
	return n(() => {
		C("AppRoot", u);
	}, [u]), t(() => {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/Link.wrapper.tsx";
function Se() {
	return s(xe, { children: s(m, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
