...
var A = (e) => typeof e == "string", oe = (e) => typeof e == "function", j = /* @__PURE__ */ new Map(), M = "en";
function N(e) {
...
function P(e, t, n) {
	...
	return R(() => z("date", r, n), () => new Intl.DateTimeFormat(r, i)).format(A(t) ? new Date(t) : t);
}
function F(e, t, n) {
	let r;
...
var B = /\\u[a-fA-F0-9]{4}|\\x[a-fA-F0-9]{2}/, V = (e) => e.replace(/\\u([a-fA-F0-9]{4})|\\x([a-fA-F0-9]{2})/g, (e, t, n) => {
	...
	let r = t || e, i = (e) => typeof e == "object" ? e : n[e], a = (e, t) => {
		let a = Object.keys(n).length ? i("number") : void 0, o = I(r, e, a);
		return t.replace(new RegExp(H, "g"), o);
	};
	return {
		plural: (e, t) => {
...
function G(e, t, n) {
	return (r = {}, i) => {
		...
		return A(s) && B.test(s) ? V(s) : A(s) ? s : s ? String(s) : "";
	};
}
var K = class {
	_events = {};
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(ae), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? M, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), A(s) && B.test(s) ? V(s) : A(s) ? s : G(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
var xe = u(((e) => {
	...
	t.exports = process.env.NODE_ENV === "production" ? xe() : Se();
}))(), we = e(null), Q = (e, t) => ({
	i18n: new Proxy(e, {}),
	defaultComponent: t,
	_: e.t.bind(e)
	...
	let i = r(() => Te(e, t), [e, t]), a = (0, Ce.useSyncExternalStore)(i.subscribe, i.getSnapshot, i.getSnapshot);
	return a.i18n.locale ? l(we.Provider, {
		value: a,
		children: n
...
function Ae({ children: e }) {
	let o = a().locale ?? "en", s = r(() => ve(o), [o]), l = r(() => ye(o, s), [o, s]), [u] = i(() => typeof performance < "u" ? performance.now() : 0);
	return n(() => {
		Oe("AppRoot", u);
	}, [u]), t(() => {
...
function Me({ children: e }) {
	return c(Ae, { children: e }, void 0, !1, {
		fileName: je,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/LocaleSwitcher.wrapper.tsx";
function Ne() {
	return c(Me, { children: c(be, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
