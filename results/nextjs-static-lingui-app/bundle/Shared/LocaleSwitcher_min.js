...
var M = (e) => typeof e == "string", re = (e) => typeof e == "function", N = /* @__PURE__ */ new Map(), P = "en";
function F(e) {
...
var J = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(j), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? P, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
var ye = l(((e) => {
	...
	t.exports = process.env.NODE_ENV === "production" ? ye() : Q();
}))(), xe = e(null), $ = (e, t) => ({
	i18n: new Proxy(e, {}),
	defaultComponent: t,
	_: e.t.bind(e)
...
}, Ce = ({ i18n: e, defaultComponent: t, children: n }) => {
	let i = r(() => Se(e, t), [e, t]), a = (0, be.useSyncExternalStore)(i.subscribe, i.getSnapshot, i.getSnapshot);
	return a.i18n.locale ? c(xe.Provider, {
		value: a,
		children: n
...
function Ee({ children: e }) {
	let o = a().locale ?? "en", s = r(() => ge(o), [o]), l = r(() => _e(o, s), [o, s]), [u] = i(() => typeof performance < "u" ? performance.now() : 0);
	return n(() => {
		Te("AppRoot", u);
	}, [u]), t(() => {
