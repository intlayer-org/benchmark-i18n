...
var M = (e) => typeof e == "string", ie = (e) => typeof e == "function", N = /* @__PURE__ */ new Map(), P = "en";
function F(e) {
	return [...Array.isArray(e) ? e : [e], P];
}
function I(e, t, n) {
	let r = F(e);
	n ||= "default";
	...
	return B(() => V("date", r, n), () => new Intl.DateTimeFormat(r, i)).format(M(t) ? new Date(t) : t);
}
function L(e, t, n) {
	let r;
...
function z(e, t, n, { offset: r = 0, ...i }) {
	let a = F(e), o = t ? B(() => V("plural-ordinal", a), () => new Intl.PluralRules(a, { type: "ordinal" })) : B(() => V("plural-cardinal", a), () => new Intl.PluralRules(a, { type: "cardinal" }));
	return i[n] ?? i[o.select(n - r)] ?? i.other;
}
function B(e, t) {
	let n = e(), r = N.get(n);
	return r || (r = t(), N.set(n, r)), r;
}
function V(e, t, n) {
...
}), W = "%__lingui_octothorpe__%", G = (e, t, n = {}) => {
	let r = t || e, i = (e) => typeof e == "object" ? e : n[e], a = (e, t) => {
		let a = R(r, e, Object.keys(n).length ? i("number") : void 0);
		return t.replace(new RegExp(W, "g"), a);
	};
	return {
		plural: (e, t) => {
		...
		date: (e, t) => I(r, e, i(t) || t),
		time: (e, t) => L(r, e, i(t) || t)
	};
}, K = (e, t) => t[e] ?? t.other;
function q(e, t, n) {
	return (r = {}, i) => {
		let a = G(t, n, i), o = (e, t = !1) => Array.isArray(e) ? e.reduce((e, n) => {
			if (n === "#" && t) return e + W;
			if (M(n)) return e + n;
			let [i, s, c] = n, l = {};
		...
		return M(s) && H.test(s) ? U(s) : M(s) ? s : s ? String(s) : "";
	};
}
var J = Object.defineProperty, Y = (e, t, n) => t in e ? J(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, ae = (e, t, n) => (Y(e, typeof t == "symbol" ? t : t + "", n), n), oe = class {
	constructor() {
		ae(this, "_events", {});
	}
	on(e, t) {
...
}, se = Object.defineProperty, X = (e, t, n) => t in e ? se(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (X(e, typeof t == "symbol" ? t : t + "", n), n), ce = class extends oe {
	constructor(e) {
		super(), Z(this, "_locale", ""), Z(this, "_locales"), Z(this, "_localeData", {}), Z(this, "_messages", {}), Z(this, "_missing"), Z(this, "_messageCompiler"), Z(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(re), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? P, e.locales);
	}
	get locale() {
		return this._locale;
	}
	...
	_(e, t, n) {
		...
		let r = n?.message;
		e ||= "", M(e) || (t = e.values || t, r = e.message, e = e.id);
		...
		let s = i || r || e;
		return M(s) && (this._messageCompiler ? s = this._messageCompiler(s) : console.warn(`Uncompiled message detected! Message:
...
`)), M(s) && H.test(s) ? U(s) : M(s) ? s : q(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
var we = e(null), Te = ({ i18n: e, defaultComponent: r, children: i }) => {
...
function Oe({ children: e }) {
	let t = s().locale ?? "en", a = i(() => xe(t), [t]), c = i(() => Se(t, a), [t, a]), [l] = o(() => typeof performance < "u" ? performance.now() : 0);
	return r(() => {
		De("AppRoot", l);
	}, [l]), n(() => {
