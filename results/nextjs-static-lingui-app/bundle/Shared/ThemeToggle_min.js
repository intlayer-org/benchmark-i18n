...
function _() {
	let { i18n: e } = p(), [t, n] = s("auto");
	r(() => {
		let e = h();
		n(e), g(e);
	}, []), r(() => {
		if (t !== "auto") return;
		let e = window.matchMedia("(prefers-color-scheme: dark)"), n = () => g("auto");
	...
	function i() {
		...
		n(e), g(e), window.localStorage.setItem("theme", e);
	}
...
function ye({ children: e }) {
	let t = l().locale ?? "en", n = a(() => _e(t), [t]), o = a(() => ve(t, n), [t, n]), [u] = s(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		y("AppRoot", u);
	}, [u]), r(() => {
