...
function g(t, n = {}) {
	...
	for (let [t, o, s] of _(r)) {
		...
		(!r || h[r.type] && o) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${t}' as it is not declared in the original translation`), r = u(l, {})), Array.isArray(r) && (r = u(l, { children: r })), a.push(e(r, { key: i() }, o ? g(o, n) : r.props.children)), s && a.push(s);
	}
...
var v = (e = 0, t = "") => () => `${t}_${e++}`;
function y(e) {
	let { render: t, component: n, id: r, message: i, formats: a, lingui: { i18n: o, defaultComponent: s } } = e, { values: c, components: l } = x(e), d = o && typeof o._ == "function" ? o._(r, c, {
		message: i,
		formats: a
	}) : r, f = d ? g(d, l) : null;
...
function Ae({ children: e }) {
	let t = f().locale ?? "en", n = o(() => Oe(t), [t]), r = o(() => ke(t, n), [t, n]), [s] = c(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		re("AppRoot", s);
	}, [s]), i(() => {
...
function je({ children: e }) {
	return u(Ae, { children: e });
}
function Me() {
	return u(je, { children: u(te, {}) });
}
