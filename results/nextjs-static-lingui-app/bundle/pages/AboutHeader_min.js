...
var D = (e, t) => ({
	...
	let r = a(() => O(e, t), [e, t]), i = (0, g.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
...
var A = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/pages/about/AboutHeader.tsx";
function re() {
	let { i18n: e } = ee();
...
function be(e, t) {
	return /^::/.test(e) ? ge(ye(e.substring(2)), void 0, t) : e;
}
function xe(e, t = (e) => e) {
...
var R = (e) => typeof e == "string", Ce = (e) => typeof e == "function", z = /* @__PURE__ */ new Map(), B = "en";
function V(e) {
...
var q = /\\u[a-fA-F0-9]{4}|\\x[a-fA-F0-9]{2}/, J = (e) => e.replace(/\\u([a-fA-F0-9]{4})|\\x([a-fA-F0-9]{2})/g, (e, t, n) => {
...
}), Y = "%__lingui_octothorpe__%", Te = (e, t, n = {}) => {
	...
	return {
		...
		time: (e, t) => we(r, e, i(t) || t)
	};
}, Ee = (e, t) => t[e] ?? t.other;
function De(e, t, n) {
	return (r = {}, i) => {
		let a = Te(t, n, i), o = (e, t = !1) => Array.isArray(e) ? e.reduce((e, n) => {
			if (n === "#" && t) return e + Y;
			if (R(n)) return e + n;
			let [i, s, c] = n, l = {};
...
var Oe = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(Se), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? B, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), R(s) && q.test(s) ? J(s) : R(s) ? s : De(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/AppProviders.tsx";
function Me({ children: e }) {
	let t = d().locale ?? "en", n = a(() => Ae(t), [t]), s = a(() => je(t, n), [t, n]), [c] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		ae("AppRoot", c);
	}, [c]), r(() => {
...
var Ne = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/scripts/Wrapper.tsx";
function Pe({ children: e }) {
	return u(Me, { children: e }, void 0, !1, {
		fileName: Ne,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/pages/about/AboutHeader.wrapper.tsx";
function Fe() {
	return u(Pe, { children: u(re, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
