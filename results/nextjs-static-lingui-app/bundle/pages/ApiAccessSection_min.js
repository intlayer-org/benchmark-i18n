...
function y(t, n = {}) {
	...
	o && a.push(o);
	for (let [t, o, s] of b(r)) {
		let r = t === void 0 ? void 0 : n[t];
		(!r || v[r.type] && o) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${t}' as it is not declared in the original translation`), r = l(c, {})), Array.isArray(r) && (r = l(c, { children: r })), a.push(e(r, { key: i() }, o ? y(o, n) : r.props.children)), s && a.push(s);
	}
...
var x = (e = 0, t = "") => () => `${t}_${e++}`;
function S(e) {
	let { render: t, component: n, id: r, message: i, formats: a, lingui: { i18n: o, defaultComponent: s } } = e, { values: c, components: u } = w(e), d = o && typeof o._ == "function" ? o._(r, c, {
		message: i,
		formats: a
	}) : r, f = d ? y(d, u) : null;
...
var C = ({ children: e }) => e, w = (e) => {
	...
	let r = o(() => D(e, t), [e, t]), i = (0, g.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
	return i.i18n.locale ? l(T.Provider, {
		value: i,
		children: n
...
function he(e, t) {
	return /^::/.test(e) ? pe(R(e.substring(2)), void 0, t) : e;
}
function ge(e, t = (e) => e) {
...
function De({ children: e }) {
	let t = d().locale ?? "en", n = o(() => Te(t), [t]), i = o(() => Ee(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		re("AppRoot", c);
	}, [c]), r(() => {
...
function Oe({ children: e }) {
	return l(De, { children: e });
}
function ke() {
	return l(Oe, { children: l(k, {}) });
}
