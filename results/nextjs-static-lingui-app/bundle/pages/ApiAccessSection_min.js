...
var x = ({ children: e }) => e, S = (e) => {
	...
	return t;
}, T = ({ i18n: e, defaultComponent: t, children: r }) => {
...
var xe = Object.defineProperty, Se = (e, t, n) => t in e ? xe(e, t, {
	...
	writable: !0,
	value: n
}) : e[t] = n, Ce = (e, t, n) => (Se(e, typeof t == "symbol" ? t : t + "", n), n), X = class {
	constructor() {
		Ce(this, "_events", {});
	}
	on(e, t) {
	...
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (Te(e, typeof t == "symbol" ? t : t + "", n), n), Ee = class extends X {
	constructor(e) {
...
function ke({ children: e }) {
	let t = p().locale ?? "en", n = s(() => De(t), [t]), r = s(() => Oe(t, n), [t, n]), [a] = l(() => typeof performance < "u" ? performance.now() : 0);
	return o(() => {
		ne("AppRoot", a);
	}, [a]), i(() => {
