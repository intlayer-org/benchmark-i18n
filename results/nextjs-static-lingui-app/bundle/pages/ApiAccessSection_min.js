...
var O = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/pages/settings/ApiAccessSection.tsx";
function re() {
	let e = i();
	return u("section", {
...
function ve(e, t) {
	return /^::/.test(e) ? ge(I(e.substring(2)), void 0, t) : e;
}
function ye(e, t = (e) => e) {
...
var R = (e) => typeof e == "string", xe = (e) => typeof e == "function", z = /* @__PURE__ */ new Map(), B = "en";
function V(e) {
...
}), Y = "%__lingui_octothorpe__%", Ce = (e, t, n = {}) => {
...
var Ee = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(be), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? B, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), R(s) && q.test(s) ? J(s) : R(s) ? s : Te(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
function Ae({ children: e }) {
	let t = d().locale ?? "en", n = o(() => Oe(t), [t]), i = o(() => Q(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		ae("AppRoot", c);
	}, [c]), r(() => {
...
function Me({ children: e }) {
	return u(Ae, { children: e }, void 0, !1, {
		fileName: je,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/pages/settings/ApiAccessSection.wrapper.tsx";
function Ne() {
	return u(Me, { children: u(re, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
