...
function ve({ children: e }) {
	let t = u().locale ?? "en", n = a(() => ge(t), [t]), o = a(() => _e(t, n), [t, n]), [l] = s(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		v("AppRoot", l);
	}, [l]), r(() => {
...
function ye({ children: e }) {
	return c(ve, { children: e });
}
function be() {
	return c(ye, { children: c(g, {}) });
}
