...
}, k = ({ i18n: e, defaultComponent: t, children: n }) => {
	let r = a(() => ee(e, t), [e, t]), i = (0, g.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
...
var te = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/MockBanner.tsx", ne = () => {
	let { i18n: e } = D();
	return u("div", {
...
}, j = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/pages/careers/CareersHeader.tsx";
function re() {
	let { i18n: e } = D();
	return u(l, { children: [
		u(ne, {}, void 0, !1, {
...
}, N = (e) => e < 4 ? "short" : e === 4 ? "long" : "narrow", P = (e) => e % 2 == 0 ? "2-digit" : "numeric";
function le(e, t) {
	switch (e.char) {
...
function fe(e, t) {
	let { char: n, desc: r, width: i } = e;
	return (n === "c" || n === "e") && i < 3 && t(`Numeric value is not supported for ${r}; falling back to weekday:short`, M.WARNING), N(i);
}
function pe(e) {
	let t = P(e.width), n;
	switch (e.char) {
...
function xe(e, t) {
	return /^::/.test(e) ? ge(be(e.substring(2)), void 0, t) : e;
}
function Se(e, t = (e) => e) {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/pages/careers/CareersHeader.wrapper.tsx";
function Ie() {
	return u(Fe, { children: u(re, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
