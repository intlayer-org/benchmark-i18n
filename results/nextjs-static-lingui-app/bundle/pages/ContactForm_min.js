...
var v = (e, t) => ({
	...
	let r = a(() => y(e, t), [e, t]), i = (0, m.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
	return i.i18n.locale ? s(h.Provider, {
		value: i,
		children: n
...
}, x = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/pages/contact/ContactForm.tsx";
function S() {
	let { i18n: e } = _(), t = r(), n = r(), i = r(), a = r();
	return c("form", {
		className: "space-y-6",
		children: [
			c("div", {
...
function be({ children: e }) {
	let t = l().locale ?? "en", r = a(() => _e(t), [t]), s = a(() => ve(t, r), [t, r]), [u] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		w("AppRoot", u);
	}, [u]), n(() => {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/pages/contact/ContactForm.wrapper.tsx";
function Ce() {
