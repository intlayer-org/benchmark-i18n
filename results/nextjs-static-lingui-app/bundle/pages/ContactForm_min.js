...
function ye({ children: e }) {
	let t = d().locale ?? "en", n = o(() => _e(t), [t]), i = o(() => ve(t, n), [t, n]), [s] = c(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		y("AppRoot", s);
	}, [s]), r(() => {
