...
var f = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), p = e(null), m = (e) => {
	let t = n(p);
...
var g = ({ i18n: e, defaultComponent: n, children: i }) => {
...
var fe = Object.defineProperty, pe = (e, t, n) => t in e ? fe(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
}, ge = Object.defineProperty, X = (e, t, n) => t in e ? ge(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (X(e, typeof t == "symbol" ? t : t + "", n), n), _e = class extends he {
	constructor(e) {
		super(), Z(this, "_locale", ""), Z(this, "_locales"), Z(this, "_localeData", {}), Z(this, "_messages", {}), Z(this, "_missing"), Z(this, "_messageCompiler"), Z(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(ce), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? z, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
function be({ children: e }) {
	let t = d().locale ?? "en", n = a(() => ve(t), [t]), o = a(() => ye(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		b("AppRoot", c);
	}, [c]), r(() => {
...
function xe({ children: e }) {
	return l(be, { children: e });
}
function Se() {
	return l(xe, { children: l(v, {}) });
}
