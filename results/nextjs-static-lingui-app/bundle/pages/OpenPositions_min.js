...
function ie(e, t) {
	return /^::/.test(e) ? te(F(e.substring(2)), void 0, t) : e;
}
function ae(e, t = (e) => e) {
...
var ue = Object.defineProperty, de = (e, t, n) => t in e ? ue(e, t, {
	...
	constructor(e) {
		super(), Z(this, "_locale", ""), Z(this, "_locales"), Z(this, "_localeData", {}), Z(this, "_messages", {}), Z(this, "_missing"), Z(this, "_messageCompiler"), Z(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(oe), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? B, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
function ye({ children: e }) {
	let t = d().locale ?? "en", n = a(() => _e(t), [t]), o = a(() => ve(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		y("AppRoot", c);
	}, [c]), r(() => {
...
function be({ children: e }) {
	return l(ye, { children: e });
}
function xe() {
	return l(be, { children: l(_, {}) });
}
