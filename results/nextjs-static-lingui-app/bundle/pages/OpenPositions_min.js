...
var v = (e, t) => ({
	...
	return a.i18n.locale ? s(h.Provider, {
		value: a,
		children: n
...
function _e({ children: e }) {
	let t = l().locale ?? "en", o = i(() => ge(t), [t]), c = i(() => $(t, o), [t, o]), [u] = a(() => typeof performance < "u" ? performance.now() : 0);
	return r(() => {
		C("AppRoot", u);
	}, [u]), n(() => {
...
function ve({ children: e }) {
	return s(_e, { children: e });
}
function ye() {
	return s(ve, { children: s(x, {}) });
}
