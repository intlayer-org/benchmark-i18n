...
var m = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), h = /<([a-zA-Z0-9]+)>([\s\S]*?)<\/\1>|<([a-zA-Z0-9]+)\/>/, g = {
	area: !0,
	base: !0,
	br: !0,
	col: !0,
...
function _(t, n = {}) {
	...
	o && a.push(o);
	for (let [t, o, s] of v(r)) {
		let r = t === void 0 ? void 0 : n[t];
		(!r || g[r.type] && o) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${t}' as it is not declared in the original translation`), r = d(u, {})), Array.isArray(r) && (r = d(u, { children: r })), a.push(e(r, { key: i() }, o ? _(o, n) : r.props.children)), s && a.push(s);
	}
...
var y = (e = 0, t = "") => () => `${t}_${e++}`;
function b(e) {
	let { render: t, component: n, id: r, message: i, formats: a, lingui: { i18n: o, defaultComponent: s } } = e, { values: c, components: l } = S(e), u = o && typeof o._ == "function" ? o._(r, c, {
		message: i,
		formats: a
	}) : r, f = u ? _(u, l) : null;
...
var ee = ({ i18n: e, defaultComponent: t, children: r }) => {
...
function F(e, t) {
	return /^::/.test(e) ? pe(N(e.substring(2)), void 0, t) : e;
}
function I(e, t = (e) => e) {
	return P((0, ae.parse)(e), t);
}
function L(e, t = (e) => e) {
	try {
		return I(e, t);
...
var R = (e) => typeof e == "string", _e = (e) => typeof e == "function", z = /* @__PURE__ */ new Map(), B = "en";
function V(e) {
...
}), Y = "%__lingui_octothorpe__%", ye = (e, t, n = {}) => {
...
var Se = Object.defineProperty, Ce = (e, t, n) => t in e ? Se(e, t, {
	...
	writable: !0,
	value: n
}) : e[t] = n, X = (e, t, n) => (Ce(e, typeof t == "symbol" ? t : t + "", n), n), we = class {
	constructor() {
		X(this, "_events", {});
	}
	on(e, t) {
...
}, Te = Object.defineProperty, Ee = (e, t, n) => t in e ? Te(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (Ee(e, typeof t == "symbol" ? t : t + "", n), n), De = class extends we {
	constructor(e) {
		super(), Z(this, "_locale", ""), Z(this, "_locales"), Z(this, "_localeData", {}), Z(this, "_messages", {}), Z(this, "_missing"), Z(this, "_messageCompiler"), Z(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(L), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? B, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), R(s) && q.test(s) ? J(s) : R(s) ? s : xe(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
function Ae({ children: e }) {
	let t = p().locale ?? "en", n = s(() => Oe(t), [t]), r = s(() => ke(t, n), [t, n]), [a] = l(() => typeof performance < "u" ? performance.now() : 0);
	return o(() => {
		re("AppRoot", a);
	}, [a]), i(() => {
...
function je({ children: e }) {
	return d(Ae, { children: e });
}
function Me() {
	return d(je, { children: d(te, {}) });
}
