		...
		children: [l("h2", {
			...
			children: [
				...
				u("div", { children: [l("label", {
					...
					children: [
						l("option", { children: t._("settings.preferences.english") }),
						l("option", { children: t._("settings.preferences.french") }),
						l("option", { children: t._("settings.preferences.german") }),
						l("option", { children: t._("settings.preferences.spanish") }),
						l("option", { children: t._("settings.preferences.japanese") }),
						l("option", { children: t._("settings.preferences.chinese") }),
						l("option", { children: t._("settings.preferences.arabic") })
					]
				})] })
			]
		})]
...
function Oe({ children: e }) {
	let t = d().locale ?? "en", n = o(() => Ee(t), [t]), i = o(() => De(t, n), [t, n]), [c] = s(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		ie("AppRoot", c);
	}, [c]), r(() => {
...
function ke({ children: e }) {
	return l(Oe, { children: e });
}
function Ae() {
	return l(ke, { children: l(k, {}) });
}
