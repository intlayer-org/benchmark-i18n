...
var z = (e) => typeof e == "string", B = (e) => typeof e == "function", V = /* @__PURE__ */ new Map(), H = "en";
function U(e) {
...
var Ce = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(ve), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? H, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), z(s) && Y.test(s) ? X(s) : z(s) ? s : Se(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
function De({ children: e }) {
	let t = u().locale ?? "en", n = a(() => Te(t), [t]), s = a(() => Ee(t, n), [t, n]), [l] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		ie("AppRoot", l);
	}, [l]), r(() => {
...
function Oe({ children: e }) {
	return c(De, { children: e });
}
function ke() {
	return c(Oe, { children: c(ne, {}) });
}
