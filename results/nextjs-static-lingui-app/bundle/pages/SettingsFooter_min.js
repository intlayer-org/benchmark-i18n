...
function P(e, t) {
	return /^::/.test(e) ? de(M(e.substring(2)), void 0, t) : e;
}
function F(e, t = (e) => e) {
	return N((0, D.parse)(e), t);
}
function I(e, t = (e) => e) {
	try {
		return F(e, t);
...
}), Y = "%__lingui_octothorpe__%", _e = (e, t, n = {}) => {
...
}, X = Object.defineProperty, we = (e, t, n) => t in e ? X(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (we(e, typeof t == "symbol" ? t : t + "", n), n), Te = class extends Ce {
	constructor(e) {
...
`)), L(s) && q.test(s) ? J(s) : L(s) ? s : ye(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
function Oe({ children: e }) {
	let t = f().locale ?? "en", n = o(() => Ee(t), [t]), r = o(() => De(t, n), [t, n]), [s] = c(() => typeof performance < "u" ? performance.now() : 0);
	return a(() => {
		ne("AppRoot", s);
	}, [s]), i(() => {
...
function ke({ children: e }) {
	return u(Oe, { children: e });
}
function Ae() {
	return u(ke, { children: u(ee, {}) });
}
