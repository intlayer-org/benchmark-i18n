...
function U(e, t, n) {
	...
	return q(() => J("date", r, n), () => new Intl.DateTimeFormat(r, i)).format(z(t) ? new Date(t) : t);
}
function W(e, t, n) {
	let r;
...
function xe(e, t, n) {
	return (r = {}, i) => {
		...
		return z(s) && Y.test(s) ? X(s) : z(s) ? s : s ? String(s) : "";
	};
}
var Se = class {
	_events = {};
...
`)), z(s) && Y.test(s) ? X(s) : z(s) ? s : xe(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
function Ee({ children: e }) {
	let t = u().locale ?? "en", n = a(() => we(t), [t]), s = a(() => Te(t, n), [t, n]), [l] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		ie("AppRoot", l);
	}, [l]), r(() => {
