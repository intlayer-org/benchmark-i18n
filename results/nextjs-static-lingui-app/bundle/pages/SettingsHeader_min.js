...
var f = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), p = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	t.exports = process.env.NODE_ENV === "production" ? m() : h();
}))(), _ = /<([a-zA-Z0-9]+)>([\s\S]*?)<\/\1>|<([a-zA-Z0-9]+)\/>/, v = {
	area: !0,
	base: !0,
	br: !0,
	col: !0,
...
function y(t, n = {}) {
	...
	let i = x(0, "$lingui$"), a = [], o = r.shift();
	o && a.push(o);
	for (let [t, o, l] of b(r)) {
		let r = t === void 0 ? void 0 : n[t];
		(!r || v[r.type] && o) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${t}' as it is not declared in the original translation`), r = c(s, {})), Array.isArray(r) && (r = c(s, { children: r })), a.push(e(r, { key: i() }, o ? y(o, n) : r.props.children)), l && a.push(l);
	}
...
function b(e) {
	...
	return [[
		...
		n || "",
		i
	]].concat(b(e.slice(4, e.length)));
}
var x = (e = 0, t = "") => () => `${t}_${e++}`;
function S(e) {
	let { render: t, component: n, id: r, message: i, formats: a, lingui: { i18n: o, defaultComponent: s } } = e, { values: l, components: u } = w(e), d = o && typeof o._ == "function" ? o._(r, l, {
		message: i,
		formats: a
	}) : r, f = d ? y(d, u) : null;
...
var D = (e, t) => ({
	...
	let r = a(() => te(e, t), [e, t]), i = (0, g.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
	return i.i18n.locale ? c(T.Provider, {
		value: i,
		children: n
...
var re = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/MockBanner.tsx", k = () => {
	let { i18n: e } = ee();
	return u("div", {
...
}, A = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/pages/settings/SettingsHeader.tsx";
function ie() {
	return u(l, { children: [
		u(k, {}, void 0, !1, {
			fileName: A,
...
function xe(e, t) {
	return /^::/.test(e) ? _e(be(e.substring(2)), void 0, t) : e;
}
function Se(e, t = (e) => e) {
	return L((0, le.parse)(e), t);
}
function Ce(e, t = (e) => e) {
	try {
		return Se(e, t);
...
var R = (e) => typeof e == "string", we = (e) => typeof e == "function", z = /* @__PURE__ */ new Map(), B = "en";
function V(e) {
...
}), Y = "%__lingui_octothorpe__%", Ee = (e, t, n = {}) => {
...
var ke = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(Ce), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? B, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), R(s) && q.test(s) ? J(s) : R(s) ? s : Oe(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
var Me = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/AppProviders.tsx";
function Ne({ children: e }) {
	let t = d().locale ?? "en", n = a(() => je(t), [t]), s = a(() => Q(t, n), [t, n]), [c] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		oe("AppRoot", c);
	}, [c]), r(() => {
...
var Pe = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/scripts/Wrapper.tsx";
function Fe({ children: e }) {
	return u(Ne, { children: e }, void 0, !1, {
		fileName: Pe,
		lineNumber: 9,
		columnNumber: 10
	}, this);
}
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/pages/settings/SettingsHeader.wrapper.tsx";
function Ie() {
	return u(Fe, { children: u(ie, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
