...
var O = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/pages/home/UnderstandingImpact.tsx";
function ne() {
	return l("section", {
...
var Te = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(ye), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? B, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
function ke({ children: e }) {
	let t = u().locale ?? "en", n = a(() => Q(t), [t]), s = a(() => De(t, n), [t, n]), [c] = o(() => typeof performance < "u" ? performance.now() : 0);
	return i(() => {
		ie("AppRoot", c);
	}, [c]), r(() => {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/lingui-app/components/pages/home/UnderstandingImpact.wrapper.tsx";
function Me() {
