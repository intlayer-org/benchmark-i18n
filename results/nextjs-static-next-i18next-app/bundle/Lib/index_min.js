...
}.createInstance(), pe = J.createInstance;
...
var me = (e, t, n, r) => {
	...
	Q(n) && Y[n] || (Q(n) && (Y[n] = /* @__PURE__ */ new Date()), me(e, t, n, r));
}, he = (e, t) => () => {
...
function Re({ children: e, language: t, resources: n, supportedLngs: r, defaultNS: a = "common", fallbackLng: o, localePath: c = "/locales", localeStructure: u = "{{lng}}/{{ns}}", localeExtension: d = "json", use: f = [], i18nextOptions: p = {} }) {
	let [m] = s(() => {
		let e = pe();
		e.use(De);
		let i = f.some((e) => e.type === "backend"), s = n ? new Set(Object.values(n).flatMap((e) => Object.keys(e))) : /* @__PURE__ */ new Set(), l = s.size > 0 ? [...s] : [a];
		i || e.use(Le((e, t) => {
			if (s.has(t)) return {};
			let n = `${c}/${u.replace("{{lng}}", e).replace("{{ns}}", t)}.${d}`;
	...
	return i(() => {
		m.language !== t && m.changeLanguage(t);
	}, [m, t]), l(Ie, {
		i18n: m,
		children: e
	});
