...
import s from "../i18n/locales/de.json";
import c from "../i18n/locales/es.json";
import l from "../i18n/locales/fr.json";
import u from "../i18n/locales/it.json";
import d from "../i18n/locales/ja.json";
import f from "../i18n/locales/ko.json";
import p from "../i18n/locales/pt.json";
import m from "../i18n/locales/ru.json";
import h from "../i18n/locales/zh.json";
import { jsx as g } from "react/jsx-runtime";
var _ = (e) => typeof e == "string", v = () => {
...
var z = (e) => !_(e) && typeof e != "boolean" && typeof e != "number", B = class e extends P {
	...
	init(e, t = { interpolation: {} }) {
		...
		let n = t.cacheInBuiltFormats ? q : ue;
		this.formats = {
			number: n((e, t) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			E(n.loaded, [i], a), fe(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), Y = (e) => (_(e.ns) && (e.ns = [e.ns]), _(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), _(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), X = () => {}, me = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Z = class e extends P {
	constructor(e = {}, t) {
		if (super(), this.options = Y(e), this.services = {}, this.logger = N, this.modules = { external: [] }, me(this), t && !this.isInitialized && !e.isClone) {
...
function Te({ children: e }) {
	return g(we, { children: e });
}
function Ee() {
	return g(Te, { children: g(we, {}) });
}
