...
var E = ({ href: e, children: t, ...n }) => {
	let r = u().locale ?? "en";
	return e == null || typeof e != "string" || w(e) ? d(l, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, D = (e) => typeof e == "string", O = () => {
	let e, t, n = new Promise((n, r) => {
		e = n, t = r;
	});
	return n.resolve = e, n.reject = t, n;
}, k = (e) => e == null ? "" : String(e), ee = (e, t, n) => {
	e.forEach((e) => {
		t[e] && (n[e] = t[e]);
	});
}, te = /###/g, ne = (e) => e && e.includes("###") ? e.replace(te, ".") : e, re = (e) => !e || D(e), A = (e, t, n) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? D(e[r]) || e[r] instanceof String || D(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : oe(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, N = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), se = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, ce = (e) => D(e) ? e.replace(/[&<>"'\/]/g, (e) => se[e]) : e, le = class {
	constructor(e) {
	...
	"!",
	";"
], de = new le(20), fe = (e, t, n) => {
	t ||= "", n ||= "";
	let r = ue.filter((e) => !t.includes(e) && !n.includes(e));
	if (r.length === 0) return !0;
	let i = de.getRegExp(`(${r.map((e) => e === "?" ? "\\?" : e).join("|")})`), a = !i.test(e);
	if (!a) {
		let t = e.indexOf(n);
	...
	getResource(e, t, n, r = {}) {
		...
		let s = M(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !D(n) ? s : P(this.data?.[e]?.[t], n, i);
	}
	addResource(e, t, n, r, i = { silent: !1 }) {
		let a = i.keySeparator === void 0 ? this.options.keySeparator : i.keySeparator, o = [e, t];
		n && (o = o.concat(a ? n.split(a) : n)), e.includes(".") && (o = e.split("."), r = t, t = o[1]), this.addNamespaces(t), j(this.data, o, r), i.silent || this.emit("added", e, t, n, r);
	}
	...
	addResourceBundle(e, t, n, r, i, a = {
		...
		let s = M(this.data, o) || {};
		a.skipCopy || (n = JSON.parse(JSON.stringify(n))), r ? oe(s, n, i) : s = {
			...s,
			...n
		}, j(this.data, o, s), a.silent || this.emit("added", e, t, n);
	}
...
function V(e, t) {
	let { [B]: n } = e(me()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var H = (e) => !D(e) && typeof e != "boolean" && typeof e != "number", U = class e extends L {
	constructor(e, t = {}) {
		super(), ee([
			"resourceStore",
			"languageUtils",
	...
	extractFromKey(e, t) {
		...
		n === void 0 && (n = ":");
		let r = t.keySeparator === void 0 ? this.options.keySeparator : t.keySeparator, i = t.ns || this.options.defaultNS || [], a = n && e.includes(n), o = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !fe(e, n, r);
		if (a && !o) {
	...
	translate(t, n, r) {
		...
		let p = this.resolve(t, i), m = p?.res, h = p?.usedKey || s, g = p?.exactUsedKey || s, _ = [
			...
			"[object Function]",
			"[object RegExp]"
		], v = i.joinArrays === void 0 ? this.options.joinArrays : i.joinArrays, y = !this.i18nFormat || this.i18nFormat.handleAsObject, b = i.count !== void 0 && !D(i.count), x = e.hasDefaultValue(i), S = b ? this.pluralResolver.getSuffix(d, i.count, i) : "", C = i.ordinal && b ? this.pluralResolver.getSuffix(d, i.count, { ordinal: !1 }) : "", w = b && !i.ordinal && i.count === 0, T = w && i[`defaultValue${this.options.pluralSeparator}zero`] || i[`defaultValue${S}`] || i[`defaultValue${C}`] || i.defaultValue, E = m;
		y && !m && x && (E = T);
		let O = H(E), k = Object.prototype.toString.apply(E);
		if (y && E && O && !_.includes(k) && !(D(v) && Array.isArray(E))) {
		...
		} else if (y && D(v) && Array.isArray(m)) m = m.join(v), m &&= this.extendTranslation(m, t, i, r);
		else {
			let e = !1, n = !1;
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return D(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? V(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
			...
			let u = t.count !== void 0 && !D(t.count), d = u && !t.ordinal && t.count === 0, f = t.context !== void 0 && (D(t.context) || typeof t.context == "number") && t.context !== "", p = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
			l.forEach((e) => {
	...
	let a = ae(e, t, n);
	return !a && i && D(n) && (a = P(e, n, r), a === void 0 && (a = P(t, n, r))), a;
}, G = (e) => e.replace(/\$/g, "$$$$"), ye = class {
	constructor(e = {}) {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? ce : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? N(i) : a || "{{", this.suffix = o ? N(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? N(d) : f || N("$t("), this.nestingSuffix = p ? N(p) : m || N(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				else !D(a) && !this.useRawValueToEscape && (a = k(a));
				let s = t.safeValue(a);
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			D(i) || (i = k(i)), i ||= (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), ""), s.length && (i = s.reduce((e, t) => this.format(e, t, n.lng, {
				...n,
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			ie(n.loaded, [i], a), we(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), Ee = (e) => (D(e.ns) && (e.ns = [e.ns]), D(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), D(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), q = () => {}, De = (e) => {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new he(K());
...
var Oe = (e, t, n, r) => {
	...
	Z(n) && ke[n] || (Z(n) && (ke[n] = /* @__PURE__ */ new Date()), Oe(e, t, n, r));
}, Ae = (e, t) => () => {
	...
	e.loadNamespaces(t, Ae(e, n));
}, je = (e, t, n, r) => {
	if (Z(n) && (n = [n]), e.options.preload && e.options.preload.indexOf(t) > -1) return X(e, n, r);
	n.forEach((t) => {
		e.options.ns.indexOf(t) < 0 && e.options.ns.push(t);
	}), e.loadLanguages(t, Ae(e, r));
}, Me = (e, t, n = {}) => !t.languages || !t.languages.length ? (Y(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Z = (e) => typeof e == "string", Ne = (e) => typeof e == "object" && !!e, Pe = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Fe = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (Z(t)) return t;
		if (Ne(t) && Z(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: a } = t, { i18n: l, defaultNS: u } = r(Ue) || {}, d = a || l || Ve();
	d && !d.reportNamespaces && (d.reportNamespaces = new We()), d || Y(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = o(() => ({
		...Re(),
		...d?.options?.react,
		...t
	...
	let v = s(0), y = n((e) => {
		...
		if (!d) return Je;
		let e = !!(d.isInitialized || d.initializedStoreOnce) && _.every((e) => Me(e, d, f)), n = t.lng || d.language, r = v.current, i = b.current;
		...
		f,
		t.lng
	]), [S, C] = c(0), { t: w, ready: T } = (0, qe.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
			t.lng ? je(d, t.lng, _, e) : X(d, _, e);
		}
	}, [
		d,
		t.lng,
...
function Ze({ i18n: e, defaultNS: n, children: r }) {
	...
	return t(Ue.Provider, { value: i }, r);
}
function Qe() {
	let { t: e } = Xe(), t = [
		{
			...
			children: [f("div", {
				...
				children: [
					...
					f("div", { children: [d("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => d("li", { children: e.isInternal ? d(E, {
							href: e.href,
