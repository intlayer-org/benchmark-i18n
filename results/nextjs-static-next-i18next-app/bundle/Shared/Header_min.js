...
import g from "../i18n/locales/de.json";
import _ from "../i18n/locales/es.json";
import v from "../i18n/locales/fr.json";
import y from "../i18n/locales/it.json";
import b from "../i18n/locales/ja.json";
import x from "../i18n/locales/ko.json";
import S from "../i18n/locales/pt.json";
import C from "../i18n/locales/ru.json";
import w from "../i18n/locales/zh.json";
var T = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), E = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
var k = ({ href: e, children: t, ...n }) => {
	let r = u().locale ?? "en";
	return e == null || typeof e != "string" || D(e) ? p(l, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, M = (e) => e == null ? "" : String(e), ee = (e, t, n) => {
	e.forEach((e) => {
		t[e] && (n[e] = t[e]);
	});
}, te = /###/g, N = (e) => e && e.includes("###") ? e.replace(te, ".") : e, ne = (e) => !e || A(e), P = (e, t, n) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? A(e[r]) || e[r] instanceof String || A(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : I(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, L = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), oe = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, se = (e) => A(e) ? e.replace(/[&<>"'\/]/g, (e) => oe[e]) : e, ce = class {
	constructor(e) {
	...
	"!",
	";"
], ue = new ce(20), de = (e, t, n) => {
	t ||= "", n ||= "";
	let r = le.filter((e) => !t.includes(e) && !n.includes(e));
	if (r.length === 0) return !0;
	let i = ue.getRegExp(`(${r.map((e) => e === "?" ? "\\?" : e).join("|")})`), a = !i.test(e);
	if (!a) {
		let t = e.indexOf(n);
	...
	getResource(e, t, n, r = {}) {
		...
		let s = F(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !A(n) ? s : R(this.data?.[e]?.[t], n, i);
	}
	addResource(e, t, n, r, i = { silent: !1 }) {
		let a = i.keySeparator === void 0 ? this.options.keySeparator : i.keySeparator, o = [e, t];
		n && (o = o.concat(a ? n.split(a) : n)), e.includes(".") && (o = e.split("."), r = t, t = o[1]), this.addNamespaces(t), re(this.data, o, r), i.silent || this.emit("added", e, t, n, r);
	}
	...
	addResourceBundle(e, t, n, r, i, a = {
		...
		let s = F(this.data, o) || {};
		a.skipCopy || (n = JSON.parse(JSON.stringify(n))), r ? I(s, n, i) : s = {
			...s,
			...n
		}, re(this.data, o, s), a.silent || this.emit("added", e, t, n);
	}
...
var U = (e) => !A(e) && typeof e != "boolean" && typeof e != "number", _e = class e extends V {
	constructor(e, t = {}) {
		super(), ee([
			"resourceStore",
			"languageUtils",
	...
	extractFromKey(e, t) {
		...
		n === void 0 && (n = ":");
		let r = t.keySeparator === void 0 ? this.options.keySeparator : t.keySeparator, i = t.ns || this.options.defaultNS || [], a = n && e.includes(n), o = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !de(e, n, r);
		if (a && !o) {
	...
	getRule(e, t = {}) {
		...
		try {
			...
			if (typeof Intl > "u") return this.logger.error("No Intl support, please use an Intl polyfill!"), be;
	...
	getSuffixes(e, t = {}) {
		let n = this.getRule(e, t);
		return n ||= this.getRule("dev", t), n ? n.resolvedOptions().pluralCategories.sort((e, t) => ye[e] - ye[t]).map((e) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${e}`) : [];
	}
	getSuffix(e, t, n = {}) {
	...
	let a = ae(e, t, n);
	return !a && i && A(n) && (a = R(e, n, r), a === void 0 && (a = R(t, n, r))), a;
}, W = (e) => e.replace(/\$/g, "$$$$"), Ce = class {
	constructor(e = {}) {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? se : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? L(i) : a || "{{", this.suffix = o ? L(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? L(d) : f || L("$t("), this.nestingSuffix = p ? L(p) : m || L(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		let i, a, o, s = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (e) => {
			if (!e.includes(this.formatSeparator)) {
				let i = Se(t, s, e, this.options.keySeparator, this.options.ignoreJSONStructure);
			...
			return this.format(Se(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
				...r,
				...t,
				interpolationkey: a
			});
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				else !A(a) && !this.useRawValueToEscape && (a = M(a));
				let s = t.safeValue(a);
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			A(i) || (i = M(i)), i ||= (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), ""), s.length && (i = s.reduce((e, t) => this.format(e, t, n.lng, {
				...n,
	...
	format(e, t, n, r = {}) {
		...
		return i.reduce((e, t) => {
			let { formatName: i, formatOptions: a } = we(t);
			if (this.formats[i]) {
				let t = e;
				try {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			ie(n.loaded, [i], a), Oe(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), Ae = (e) => (A(e.ns) && (e.ns = [e.ns]), A(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), A(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), K = () => {}, je = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, q = class e extends V {
	constructor(e = {}, t) {
		if (super(), this.options = Ae(e), this.services = {}, this.logger = B, this.modules = { external: [] }, je(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		...
		if (!this.options.isClone) {
			...
			let t = new ve(this.options);
			this.store = new pe(this.options.resources, this.options);
			let n = this.services;
			n.logger = B, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new xe(t, { prepend: this.options.pluralSeparator }), e && (n.formatter = r(e), n.formatter.init && n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new Ce(this.options), n.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }, n.backendConnector = new ke(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (e, ...t) => {
				this.emit(e, ...t);
			}), this.modules.languageDetector && (n.languageDetector = r(this.modules.languageDetector), n.languageDetector.init && n.languageDetector.init(n, this.options.detection, this.options)), this.modules.i18nFormat && (n.i18nFormat = r(this.modules.i18nFormat), n.i18nFormat.init && n.i18nFormat.init(this)), this.translator = new _e(this.services, this.options), this.translator.on("*", (e, ...t) => {
				this.emit(e, ...t);
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new ve(G());
	...
	cloneInstance(t = {}, n = K) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a.services.interpolator = new Ce(n);
		}
		return a.translator = new _e(a.services, i), a.translator.on("*", (e, ...t) => {
			a.emit(e, ...t);
...
var Me = (e, t, n, r) => {
	...
	X(n) && Ne[n] || (X(n) && (Ne[n] = /* @__PURE__ */ new Date()), Me(e, t, n, r));
}, Pe = (e, t) => () => {
...
}, Ie = (e, t, n = {}) => !t.languages || !t.languages.length ? (J(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), X = (e) => typeof e == "string", Le = (e) => typeof e == "object" && !!e, Re = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, ze = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (X(t)) return t;
		if (Le(t) && X(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: a } = t, { i18n: l, defaultNS: u } = r(qe) || {}, d = a || l || Ge();
	d && !d.reportNamespaces && (d.reportNamespaces = new Je()), d || J(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = o(() => ({
		...He(),
		...d?.options?.react,
		...t
	...
	let v = s(0), y = n((e) => {
		...
		if (!d) return Qe;
		let e = !!(d.isInitialized || d.initializedStoreOnce) && _.every((e) => Ie(e, d, f)), n = t.lng || d.language, r = v.current, i = b.current;
	...
	if (d && p && !T) throw new Promise((e) => {
		let n = () => e();
		t.lng ? Fe(d, t.lng, _, n) : Y(d, _, n);
	});
	return A;
};
function tt({ i18n: e, defaultNS: n, children: r }) {
	let i = o(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
	return t(qe.Provider, { value: i }, r);
}
function nt() {
			...
			children: [m("div", {
				...
				children: [p(k, {
					...
					children: [
						p(k, {
							href: "/",
							className: `nav-link${((e) => i === O(e, a))("/") ? " is-active" : ""}`,
...
function ft({ children: e }) {
	return p(dt, { children: e });
}
function pt() {
	return p(ft, { children: p(ct, {}) });
}
