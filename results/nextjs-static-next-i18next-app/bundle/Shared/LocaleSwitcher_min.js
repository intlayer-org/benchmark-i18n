...
var H = (e) => !S(e) && typeof e != "boolean" && typeof e != "number", ue = class e extends L {
	constructor(e, t = {}) {
		super(), T([
			"resourceStore",
			"languageUtils",
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			ee(n.loaded, [i], a), ge(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), X = (e) => (S(e.ns) && (e.ns = [e.ns]), S(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), S(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), Z = () => {}, ve = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Q = class e extends L {
	constructor(e = {}, t) {
		if (super(), this.options = X(e), this.services = {}, this.logger = I, this.modules = { external: [] }, ve(this), t && !this.isInitialized && !e.isClone) {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new de(Y());
...
function Ee({ i18n: e, defaultNS: n, children: r }) {
	let a = i(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
	return t(Te.Provider, { value: a }, r);
}
function De() {
	if (!(typeof window > "u")) {
...
function Ae({ children: e }) {
	return l(ke, { children: e });
}
function je() {
	return l(Ae, { children: l(x, {}) });
}
