...
import m from "../../../i18n/locales/es.json";
import h from "../../../i18n/locales/fr.json";
import g from "../../../i18n/locales/it.json";
import _ from "../../../i18n/locales/ja.json";
import v from "../../../i18n/locales/ko.json";
import y from "../../../i18n/locales/pt.json";
import b from "../../../i18n/locales/ru.json";
import x from "../../../i18n/locales/zh.json";
var S = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), C = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
}), w = (e) => typeof e == "string", T = () => {
	let e, t, n = new Promise((n, r) => {
		e = n, t = r;
	});
	return n.resolve = e, n.reject = t, n;
}, E = (e) => e == null ? "" : String(e), D = (e, t, n) => {
	e.forEach((e) => {
		t[e] && (n[e] = t[e]);
	});
}, O = /###/g, k = (e) => e && e.includes("###") ? e.replace(O, ".") : e, A = (e) => !e || w(e), j = (e, t, n) => {
	let r = w(t) ? t.split(".") : t, i = 0;
	for (; i < r.length - 1;) {
		if (A(e)) return {};
		let t = k(r[i]);
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? w(e[r]) || e[r] instanceof String || w(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : ne(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, P = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), re = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, ie = (e) => w(e) ? e.replace(/[&<>"'\/]/g, (e) => re[e]) : e, ae = class {
	constructor(e) {
	...
	forward(e, t, n, r) {
		return r && !this.debug ? null : (w(e[0]) && (e[0] = `${n}${this.prefix} ${e[0]}`), this.logger[t](e));
	}
	create(t) {
	...
	getResource(e, t, n, r = {}) {
		...
		e.includes(".") ? o = e.split(".") : (o = [e, t], n && (Array.isArray(n) ? o.push(...n) : w(n) && i ? o.push(...n.split(i)) : o.push(n)));
		let s = N(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !w(n) ? s : F(this.data?.[e]?.[t], n, i);
	}
	...
	addResources(e, t, n, r = { silent: !1 }) {
		for (let r in n) (w(n[r]) || Array.isArray(n[r])) && this.addResource(e, t, r, n[r], { silent: !0 });
...
function H(e, t) {
	let { [V]: n } = e(ue()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var U = (e) => !w(e) && typeof e != "boolean" && typeof e != "number", W = class e extends R {
	constructor(e, t = {}) {
		super(), D([
			"resourceStore",
			"languageUtils",
	...
	translate(t, n, r) {
		...
		let p = this.resolve(t, i), m = p?.res, h = p?.usedKey || s, g = p?.exactUsedKey || s, _ = [
			...
			"[object Function]",
			"[object RegExp]"
		], v = i.joinArrays === void 0 ? this.options.joinArrays : i.joinArrays, y = !this.i18nFormat || this.i18nFormat.handleAsObject, b = i.count !== void 0 && !w(i.count), x = e.hasDefaultValue(i), S = b ? this.pluralResolver.getSuffix(d, i.count, i) : "", C = i.ordinal && b ? this.pluralResolver.getSuffix(d, i.count, { ordinal: !1 }) : "", T = b && !i.ordinal && i.count === 0, E = T && i[`defaultValue${this.options.pluralSeparator}zero`] || i[`defaultValue${S}`] || i[`defaultValue${C}`] || i.defaultValue, D = m;
		y && !m && x && (D = E);
		let O = U(D), k = Object.prototype.toString.apply(D);
		if (y && D && O && !_.includes(k) && !(w(v) && Array.isArray(D))) {
		...
		} else if (y && w(v) && Array.isArray(m)) m = m.join(v), m &&= this.extendTranslation(m, t, i, r);
		else {
			let e = !1, n = !1;
	...
	extendTranslation(e, t, n, r, i) {
		if (this.i18nFormat?.parse) e = this.i18nFormat.parse(e, {
			...
			let a = w(e) && (n?.interpolation?.skipOnVariables === void 0 ? this.options.interpolation.skipOnVariables : n.interpolation.skipOnVariables), o;
			if (a) {
				let t = e.match(this.interpolator.nestingRegexp);
				o = t && t.length;
			}
		...
		let a = n.postProcess || this.options.postProcess, o = w(a) ? [a] : a;
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return w(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? H(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
			...
			let u = t.count !== void 0 && !w(t.count), d = u && !t.ordinal && t.count === 0, f = t.context !== void 0 && (w(t.context) || typeof t.context == "number") && t.context !== "", p = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
			l.forEach((e) => {
	...
	getUsedParamsDetails(e = {}) {
		let t = [
			...
			"postProcess",
			"interpolation"
		], n = e.replace && !w(e.replace), r = n ? e.replace : e;
	...
	toResolveHierarchy(e, t) {
		...
		return w(e) && (e.includes("-") || e.includes("_")) ? (this.options.load !== "languageOnly" && i(this.formatLanguageCode(e)), this.options.load !== "languageOnly" && this.options.load !== "currentOnly" && i(this.getScriptPartFromCode(e)), this.options.load !== "currentOnly" && i(this.getLanguagePartFromCode(e))) : w(e) && i(this.formatLanguageCode(e)), n.forEach((e) => {
	...
	getRule(e, t = {}) {
		...
		try {
			...
			if (typeof Intl > "u") return this.logger.error("No Intl support, please use an Intl polyfill!"), pe;
	...
	getSuffixes(e, t = {}) {
		let n = this.getRule(e, t);
		return n ||= this.getRule("dev", t), n ? n.resolvedOptions().pluralCategories.sort((e, t) => fe[e] - fe[t]).map((e) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${e}`) : [];
	}
	getSuffix(e, t, n = {}) {
	...
	let a = te(e, t, n);
	return !a && i && w(n) && (a = F(e, n, r), a === void 0 && (a = F(t, n, r))), a;
}, G = (e) => e.replace(/\$/g, "$$$$"), ge = class {
	constructor(e = {}) {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? ie : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? P(i) : a || "{{", this.suffix = o ? P(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? P(d) : f || P("$t("), this.nestingSuffix = p ? P(p) : m || P(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		let i, a, o, s = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (e) => {
			if (!e.includes(this.formatSeparator)) {
				let i = he(t, s, e, this.options.keySeparator, this.options.ignoreJSONStructure);
			...
			return this.format(he(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
				...r,
				...t,
				interpolationkey: a
			});
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				else !w(a) && !this.useRawValueToEscape && (a = E(a));
				let s = t.safeValue(a);
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			let s = [];
			a = { ...n }, a = a.replace && !w(a.replace) ? a.replace : a, a.applyPostProcessor = !1, delete a.defaultValue;
			let c = /{.*}/.test(r[1]) ? r[1].lastIndexOf("}") + 1 : r[1].indexOf(this.formatSeparator);
			if (c !== -1 && (s = r[1].slice(c).split(this.formatSeparator).map((e) => e.trim()).filter(Boolean), r[1] = r[1].slice(0, c)), i = t(o.call(this, r[1].trim(), a), a), i && r[0] === e && !w(i)) return i;
			w(i) || (i = E(i)), i ||= (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), ""), s.length && (i = s.reduce((e, t) => this.format(e, t, n.lng, {
				...n,
	...
	overloadTranslationOptionHandler: (e) => {
		let t = {};
		if (typeof e[1] == "object" && (t = e[1]), w(e[1]) && (t.defaultValue = e[1]), w(e[2]) && (t.tDescription = e[2]), typeof e[2] == "object" || typeof e[3] == "object") {
			let n = e[3] || e[2];
...
}), Ce = (e) => (w(e.ns) && (e.ns = [e.ns]), w(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), w(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), q = () => {}, we = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, J = class e extends R {
	constructor(e = {}, t) {
		if (super(), this.options = Ce(e), this.services = {}, this.logger = L, this.modules = { external: [] }, we(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		this.isInitializing = !0, typeof e == "function" && (t = e, e = {}), e.defaultNS == null && e.ns && (w(e.ns) ? e.defaultNS = e.ns : e.ns.includes("translation") || (e.defaultNS = e.ns[0]));
		let n = K();
		this.options = {
			...n,
			...this.options,
	...
	changeLanguage(e, t) {
		...
		let r = (e) => {
			...
			let n = w(t) ? t : t && t[0], a = this.store.hasLanguageSomeTranslations(n) ? n : this.services.languageUtils.getBestMatchFromCodes(w(t) ? [t] : t);
	...
	loadNamespaces(e, t) {
		let n = T();
		return this.options.ns ? (w(e) && (e = [e]), e.forEach((e) => {
			this.options.ns.includes(e) || this.options.ns.push(e);
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new de(K());
	...
	cloneInstance(t = {}, n = q) {
		...
		return a.translator = new W(a.services, i), a.translator.on("*", (e, ...t) => {
			a.emit(e, ...t);
...
var Te = (e, t, n, r) => {
	...
	Z(n) && Ee[n] || (Z(n) && (Ee[n] = /* @__PURE__ */ new Date()), Te(e, t, n, r));
}, De = (e, t) => () => {
...
}, ke = (e, t, n = {}) => !t.languages || !t.languages.length ? (Y(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Z = (e) => typeof e == "string", Ae = (e) => typeof e == "object" && !!e, je = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Me = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	process.env.NODE_ENV !== "production" && (function() {
		...
		var a = C("react"), o = typeof Object.is == "function" ? Object.is : t, s = a.useState, c = a.useEffect, l = a.useLayoutEffect, u = a.useDebugValue, d = !1, f = !1, p = typeof window > "u" || window.document === void 0 || window.document.createElement === void 0 ? i : n;
	...
	t: (e, t) => {
		if (Z(t)) return t;
		if (Ae(t) && Z(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: a } = t, { i18n: o, defaultNS: u } = r(Be) || {}, d = a || o || Re();
	d && !d.reportNamespaces && (d.reportNamespaces = new Ve()), d || Y(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = s(() => ({
		...Fe(),
		...d?.options?.react,
		...t
	...
	let v = c(0), y = n((e) => {
		...
		f,
		t.lng
	]), [S, C] = l(0), { t: w, ready: T } = (0, We.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
			t.lng ? Oe(d, t.lng, _, e) : X(d, _, e);
		}
	}, [
		d,
		t.lng,
		...
		children: [u("h2", {
			...
			children: [
				...
				d("div", { children: [u("label", {
					...
					children: [
						u("option", { children: "English (en)" }),
						u("option", { children: "French (fr)" }),
						u("option", { children: "German (de)" }),
						u("option", { children: "Spanish (es)" }),
						u("option", { children: "Japanese (ja)" }),
						u("option", { children: "Chinese Simplified (zh-CN)" }),
						u("option", { children: "Arabic (ar)" })
					]
				})] })
			]
		})]
...
function $e({ children: e }) {
	return u(Qe, { children: e });
}
function et() {
	return u($e, { children: u(Ye, {}) });
}
