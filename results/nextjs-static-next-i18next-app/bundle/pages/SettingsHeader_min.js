...
var _e = (e, t, n, r) => {
	...
	X(n) && ve[n] || (X(n) && (ve[n] = /* @__PURE__ */ new Date()), _e(e, t, n, r));
}, ye = (e, t) => () => {
...
}, xe = (e, t, n = {}) => !t.languages || !t.languages.length ? (J(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
	...
	let { i18n: a } = t, { i18n: l, defaultNS: u } = r(Q) || {}, d = a || l || Ae();
...
function Ge({ children: e }) {
	return u(We, { children: e });
}
function Ke() {
	return u(Ge, { children: u(Ve, {}) });
}
