...
var S = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), C = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? w(e[r]) || e[r] instanceof String || w(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : re(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, N = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), ie = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, ae = (e) => w(e) ? e.replace(/[&<>"'\/]/g, (e) => ie[e]) : e, oe = class {
	constructor(e) {
	...
	getResource(e, t, n, r = {}) {
		...
		let s = M(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !w(n) ? s : P(this.data?.[e]?.[t], n, i);
	}
...
function z(e, t) {
	let { [R]: n } = e(pe()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var B = (e) => !w(e) && typeof e != "boolean" && typeof e != "number", me = class e extends L {
	constructor(e, t = {}) {
		super(), D([
			"resourceStore",
			"languageUtils",
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return w(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? z(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	let a = ne(e, t, n);
	return !a && i && w(n) && (a = P(e, n, r), a === void 0 && (a = P(t, n, r))), a;
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? ae : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? N(i) : a || "{{", this.suffix = o ? N(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? N(d) : f || N("$t("), this.nestingSuffix = p ? N(p) : m || N(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
...
}), G = (e) => (w(e.ns) && (e.ns = [e.ns]), w(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), w(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), K = () => {}, Te = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, q = class e extends L {
	constructor(e = {}, t) {
		if (super(), this.options = G(e), this.services = {}, this.logger = I, this.modules = { external: [] }, Te(this), t && !this.isInitialized && !e.isClone) {
...
var Ee = (e, t, n, r) => {
	...
	X(n) && De[n] || (X(n) && (De[n] = /* @__PURE__ */ new Date()), Ee(e, t, n, r));
}, Oe = (e, t) => () => {
	...
	e.loadNamespaces(t, Oe(e, n));
}, ke = (e, t, n, r) => {
	if (X(n) && (n = [n]), e.options.preload && e.options.preload.indexOf(t) > -1) return Y(e, n, r);
	n.forEach((t) => {
		e.options.ns.indexOf(t) < 0 && e.options.ns.push(t);
	}), e.loadLanguages(t, Oe(e, r));
}, Ae = (e, t, n = {}) => !t.languages || !t.languages.length ? (J(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), X = (e) => typeof e == "string", je = (e) => typeof e == "object" && !!e, Me = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Ne = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (X(t)) return t;
		if (je(t) && X(t.defaultValue)) return t.defaultValue;
	...
	d && !d.reportNamespaces && (d.reportNamespaces = new Ve()), d || J(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = o(() => ({
		...Ie(),
		...d?.options?.react,
		...t
	...
	let v = s(0), y = n((e) => {
		...
		if (!d) return Ge;
		let e = !!(d.isInitialized || d.initializedStoreOnce) && _.every((e) => Ae(e, d, f)), n = t.lng || d.language, r = v.current, i = b.current;
...
function et({ children: e }) {
	return u($e, { children: e });
}
function tt() {
	return u(et, { children: u(Xe, {}) });
}
