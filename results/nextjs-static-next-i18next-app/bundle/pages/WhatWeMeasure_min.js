...
var x = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), S = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	if (typeof require < "u") return require.apply(this, arguments);
	throw Error("Calling `require` for \"" + e + "\" in an environment that doesn't expose the `require` function. See https://rolldown.rs/in-depth/bundling-cjs#require-external-modules for more details.");
}), C = (e) => typeof e == "string", w = () => {
	let e, t, n = new Promise((n, r) => {
		e = n, t = r;
	});
	return n.resolve = e, n.reject = t, n;
}, T = (e) => e == null ? "" : String(e), E = (e, t, n) => {
	e.forEach((e) => {
		t[e] && (n[e] = t[e]);
	});
}, D = /###/g, O = (e) => e && e.includes("###") ? e.replace(D, ".") : e, k = (e) => !e || C(e), A = (e, t, n) => {
	...
	let { obj: r, k: i } = A(e, t, Object);
	if (r !== void 0 || t.length === 1) {
		r[i] = n;
		return;
	}
	let a = t[t.length - 1], o = t.slice(0, t.length - 1), s = A(e, o, Object);
	for (; s.obj === void 0 && o.length;) a = `${o[o.length - 1]}.${a}`, o = o.slice(0, o.length - 1), s = A(e, o, Object), s?.obj && s.obj[`${s.k}.${a}`] !== void 0 && (s.obj = void 0);
	s.obj[`${s.k}.${a}`] = n;
}, te = (e, t, n, r) => {
	let { obj: i, k: a } = A(e, t, Object);
	i[a] = i[a] || [], i[a].push(n);
}, j = (e, t) => {
	let { obj: n, k: r } = A(e, t);
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? C(e[r]) || e[r] instanceof String || C(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : re(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, M = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), ie = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, ae = (e) => C(e) ? e.replace(/[&<>"'\/]/g, (e) => ie[e]) : e, oe = class {
	constructor(e) {
	...
	forward(e, t, n, r) {
		return r && !this.debug ? null : (C(e[0]) && (e[0] = `${n}${this.prefix} ${e[0]}`), this.logger[t](e));
	}
	create(t) {
	...
	getResource(e, t, n, r = {}) {
		...
		let s = j(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !C(n) ? s : N(this.data?.[e]?.[t], n, i);
	}
...
function R(e, t) {
	let { [L]: n } = e(pe()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var z = (e) => !C(e) && typeof e != "boolean" && typeof e != "number", B = class e extends I {
	constructor(e, t = {}) {
		super(), E([
			"resourceStore",
			"languageUtils",
	...
	translate(t, n, r) {
		...
		let p = this.resolve(t, i), m = p?.res, h = p?.usedKey || s, g = p?.exactUsedKey || s, _ = [
			...
			"[object Function]",
			"[object RegExp]"
		], v = i.joinArrays === void 0 ? this.options.joinArrays : i.joinArrays, y = !this.i18nFormat || this.i18nFormat.handleAsObject, b = i.count !== void 0 && !C(i.count), x = e.hasDefaultValue(i), S = b ? this.pluralResolver.getSuffix(d, i.count, i) : "", w = i.ordinal && b ? this.pluralResolver.getSuffix(d, i.count, { ordinal: !1 }) : "", T = b && !i.ordinal && i.count === 0, E = T && i[`defaultValue${this.options.pluralSeparator}zero`] || i[`defaultValue${S}`] || i[`defaultValue${w}`] || i.defaultValue, D = m;
		y && !m && x && (D = E);
		let O = z(D), k = Object.prototype.toString.apply(D);
		if (y && D && O && !_.includes(k) && !(C(v) && Array.isArray(D))) {
		...
		} else if (y && C(v) && Array.isArray(m)) m = m.join(v), m &&= this.extendTranslation(m, t, i, r);
		else {
			let e = !1, n = !1;
	...
	extendTranslation(e, t, n, r, i) {
		...
		return e != null && o?.length && n.applyPostProcessor !== !1 && (e = fe.handle(o, e, t, this.options && this.options.postProcessPassResolved ? {
			i18nResolved: {
				...r,
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return C(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? R(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
			...
			let u = t.count !== void 0 && !C(t.count), d = u && !t.ordinal && t.count === 0, f = t.context !== void 0 && (C(t.context) || typeof t.context == "number") && t.context !== "", p = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
			l.forEach((e) => {
	...
	toResolveHierarchy(e, t) {
		...
		return C(e) && (e.includes("-") || e.includes("_")) ? (this.options.load !== "languageOnly" && i(this.formatLanguageCode(e)), this.options.load !== "languageOnly" && this.options.load !== "currentOnly" && i(this.getScriptPartFromCode(e)), this.options.load !== "currentOnly" && i(this.getLanguagePartFromCode(e))) : C(e) && i(this.formatLanguageCode(e)), n.forEach((e) => {
	...
	let a = ne(e, t, n);
	return !a && i && C(n) && (a = N(e, n, r), a === void 0 && (a = N(t, n, r))), a;
}, G = (e) => e.replace(/\$/g, "$$$$"), he = class {
	constructor(e = {}) {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? ae : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? M(i) : a || "{{", this.suffix = o ? M(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? M(d) : f || M("$t("), this.nestingSuffix = p ? M(p) : m || M(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				else !C(a) && !this.useRawValueToEscape && (a = T(a));
				let s = t.safeValue(a);
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			if (c !== -1 && (s = r[1].slice(c).split(this.formatSeparator).map((e) => e.trim()).filter(Boolean), r[1] = r[1].slice(0, c)), i = t(o.call(this, r[1].trim(), a), a), i && r[0] === e && !C(i)) return i;
			C(i) || (i = T(i)), i ||= (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), ""), s.length && (i = s.reduce((e, t) => this.format(e, t, n.lng, {
				...n,
	...
	addCached(e, t) {
		this.formats[e.toLowerCase().trim()] = _e(t);
	}
	format(e, t, n, r = {}) {
		...
		return i.reduce((e, t) => {
			let { formatName: i, formatOptions: a } = ge(t);
			if (this.formats[i]) {
				let t = e;
				try {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			te(n.loaded, [i], a), be(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), Se = (e) => (C(e.ns) && (e.ns = [e.ns]), C(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), C(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), q = () => {}, Ce = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, J = class e extends I {
	constructor(e = {}, t) {
		if (super(), this.options = Se(e), this.services = {}, this.logger = F, this.modules = { external: [] }, Ce(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		...
		if (!this.options.isClone) {
			...
			let e;
			e = this.modules.formatter ? this.modules.formatter : ye;
			let t = new V(this.options);
			this.store = new de(this.options.resources, this.options);
			let n = this.services;
			n.logger = F, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new me(t, { prepend: this.options.pluralSeparator }), e && (n.formatter = r(e), n.formatter.init && n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new he(this.options), n.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }, n.backendConnector = new xe(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (e, ...t) => {
				this.emit(e, ...t);
	...
	getFixedT(e, t, n) {
		...
		return C(e) ? r.lng = e : r.lngs = e, r.ns = t, r.keyPrefix = n, r;
	}
	t(...e) {
	...
	cloneInstance(t = {}, n = q) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a.services.interpolator = new he(n);
		}
...
var we = (e, t, n, r) => {
	...
	Z(n) && Te[n] || (Z(n) && (Te[n] = /* @__PURE__ */ new Date()), we(e, t, n, r));
}, Ee = (e, t) => () => {
	...
	}), e.loadLanguages(t, Ee(e, r));
}, Oe = (e, t, n = {}) => !t.languages || !t.languages.length ? (Y(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Z = (e) => typeof e == "string", ke = (e) => typeof e == "object" && !!e, Ae = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, je = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	process.env.NODE_ENV !== "production" && (function() {
		...
		var a = S("react"), o = typeof Object.is == "function" ? Object.is : t, s = a.useState, c = a.useEffect, l = a.useLayoutEffect, u = a.useDebugValue, d = !1, f = !1, p = typeof window > "u" || window.document === void 0 || window.document.createElement === void 0 ? i : n;
	...
	process.env.NODE_ENV === "production" ? t.exports = Ve() : t.exports = He();
}))(), We = {
	t: (e, t) => {
		if (Z(t)) return t;
		if (ke(t) && Z(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: a } = t, { i18n: l, defaultNS: u } = r(ze) || {}, d = a || l || Le();
	d && !d.reportNamespaces && (d.reportNamespaces = new Be()), d || Y(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = o(() => ({
		...Pe(),
		...d?.options?.react,
		...t
	...
	let v = s(0), y = n((e) => {
		...
		if (!d) return We;
		let e = !!(d.isInitialized || d.initializedStoreOnce) && _.every((e) => Oe(e, d, f)), n = t.lng || d.language, r = v.current, i = b.current;
		...
		f,
		t.lng
	]), [S, C] = c(0), { t: w, ready: T } = (0, Ue.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
			t.lng ? De(d, t.lng, _, e) : X(d, _, e);
		}
	}, [
		d,
		t.lng,
...
function qe({ i18n: e, defaultNS: n, children: r }) {
	...
	return t(ze.Provider, { value: i }, r);
}
function Je() {
	let { t: e } = Ke(), t = [
		{
...
function Qe({ children: e }) {
	return l(Ze, { children: e });
}
function $e() {
	return l(Qe, { children: l(Je, {}) });
}
export { $e as default };
