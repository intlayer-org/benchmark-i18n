import "react";
import e from "../messages/de.json";
import t from "../messages/es.json";
import n from "../messages/fr.json";
import r from "../messages/it.json";
import i from "../messages/ja.json";
import a from "../messages/ko.json";
import o from "../messages/pt.json";
import s from "../messages/ru.json";
import c from "../messages/zh.json";
...
var u = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), d = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	var y = d("next/navigation"), b = g(d("react")), x = (e, t = "") => Object.entries(e).reduce((e, [n, r]) => p(p({}, e), typeof r == "string" ? { [t + n]: r } : x(r, `${t}${n}.`)), {});
	function S(e, t) {
...
}), _ = m(t), v = m(n), y = m(r), b = m(i), x = m(a), S = m(o), C = m(s), w = m(c), T = (0, p.createI18nClient)({
...
var { useScopedI18n: D, I18nProviderClient: O, useChangeLocale: k, useCurrentLocale: A } = T, j = () => (E(), null);
function M() {
	return l(O, {
		locale: "en",
		children: l(j, {})
