...
var g = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), _ = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	f(g, { createI18nClient: () => V }), t.exports = h(g), v();
	var y = _("next/navigation"), b = m(_("react")), x = (e, t = "") => Object.entries(e).reduce((e, [n, r]) => d(d({}, e), typeof r == "string" ? { [t + n]: r } : x(r, `${t}${n}.`)), {});
	function S(e, t) {
...
function b(e, t = "") {
	...
	for (let r in e) {
		let i = t ? `${t}.${r}` : r;
		typeof e[r] == "object" && e[r] !== null ? Object.assign(n, b(e[r], i)) : n[i] = String(e[r]);
	}
	return n;
}
var x = b(a), S = b({
...
}), C = b(o), w = b(s), T = b(c), E = b(l), D = b(u), O = b(d), k = b(f), A = b(p), j = (0, y.createI18nClient)({
	en: () => Promise.resolve({ default: S }),
	fr: () => Promise.resolve({ default: w }),
	es: () => Promise.resolve({ default: C }),
	de: () => Promise.resolve({ default: x }),
	it: () => Promise.resolve({ default: T }),
	pt: () => Promise.resolve({ default: O }),
	zh: () => Promise.resolve({ default: A }),
	ja: () => Promise.resolve({ default: E }),
	ko: () => Promise.resolve({ default: D }),
	ru: () => Promise.resolve({ default: k })
});
function M() {
	return j.useI18n();
}
var { useScopedI18n: N, I18nProviderClient: P, useChangeLocale: F, useCurrentLocale: I } = j;
function L() {
	let e = M(), t = i().locale ?? "en", n = [
		{
			...
			children: [h("div", {
				...
				children: [
					...
					h("div", { children: [m("h3", {
						...
						className: "space-y-1",
						children: n.map((e) => m("li", { children: e.isInternal ? m(r, {
							href: e.href,
							prefetch: !1,
