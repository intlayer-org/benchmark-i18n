...
import u from "../messages/de.json";
import d from "../messages/es.json";
import f from "../messages/fr.json";
import p from "../messages/it.json";
import m from "../messages/ja.json";
import h from "../messages/ko.json";
import g from "../messages/pt.json";
import _ from "../messages/ru.json";
import v from "../messages/zh.json";
...
var C = ({ href: e, children: t, ...n }) => {
	let a = i().locale ?? "en";
	return e == null || typeof e != "string" || x(e) ? s(r, {
		href: e,
		prefetch: !1,
		...n,
		children: t
	...
	f(g, { createI18nClient: () => V }), t.exports = h(g), w();
	var _ = b("next/navigation"), v = m(b("react")), y = (e, t = "") => Object.entries(e).reduce((e, [n, r]) => d(d({}, e), typeof r == "string" ? { [t + n]: r } : y(r, `${t}${n}.`)), {});
	function x(e, t) {
		return process.env.NODE_ENV !== "production" && console[e](`[next-international] ${t}`), null;
	}
	var S = (e) => x("warn", e), C = (e) => x("error", e), T = /* @__PURE__ */ new Map();
	function E(e, t, n) {
		...
		return function({ locale: e, fallback: n, children: i }) {
			let a = t[e];
			return a || (C(`The locale '${e}' is not supported. Defined locales are: [${Object.keys(t).join(", ")}].`), (0, _.notFound)()), v.default.createElement(v.Suspense, { fallback: n }, v.default.createElement(r, {
				locale: e,
				importLocale: a()
			}, i));
		};
	}
	var D = b("react"), O = b("react"), k = b("react");
	function A(e, t) {
	...
	var L = b("next/navigation"), R = b("react"), z = "locale";
	function B(e, t) {
		return function() {
			let n = (0, L.useParams)()[t.segmentName ?? z];
			return (0, R.useMemo)(() => {
				for (let t of e) if (n === t) return t;
				C(`Locale "${n}" not found in locales (${e.join(", ")}), returning "notFound()"`), (0, L.notFound)();
			}, [n]);
		};
	}
	function V(e, t = {}) {
...
function E(e, t = "") {
	...
	for (let r in e) {
		let i = t ? `${t}.${r}` : r;
		typeof e[r] == "object" && e[r] !== null ? Object.assign(n, E(e[r], i)) : n[i] = String(e[r]);
	}
	return n;
}
var D = E(u), O = E({
...
}), k = E(d), A = E(f), j = E(p), M = E(m), N = E(h), P = E(g), F = E(_), I = E(v), L = (0, T.createI18nClient)({
	en: () => Promise.resolve({ default: O }),
	fr: () => Promise.resolve({ default: A }),
	es: () => Promise.resolve({ default: k }),
	de: () => Promise.resolve({ default: D }),
	it: () => Promise.resolve({ default: j }),
	pt: () => Promise.resolve({ default: P }),
	zh: () => Promise.resolve({ default: I }),
	ja: () => Promise.resolve({ default: M }),
	ko: () => Promise.resolve({ default: N }),
	ru: () => Promise.resolve({ default: F })
});
function R() {
	return L.useI18n();
}
var { useScopedI18n: z, I18nProviderClient: B, useChangeLocale: V, useCurrentLocale: ee } = L;
function H() {
...
function W() {
	...
	e(() => {
		...
		if (r !== "auto") return;
		let e = window.matchMedia("(prefers-color-scheme: dark)"), t = () => U("auto");
	...
	function a() {
		...
		i(e), U(e), window.localStorage.setItem("theme", e);
	}
			...
			children: [c("div", {
				...
				children: [s(C, {
					...
					children: [
						s(C, {
							href: "/",
							className: `nav-link${((e) => u === S(e, d))("/") ? " is-active" : ""}`,
...
function Q({ children: r, locale: i }) {
