...
var x = g((() => {})), S = g(((e, t) => {
	...
	f(g, { createI18nClient: () => V }), t.exports = h(g), x();
	var v = _("next/navigation"), y = m(_("react")), b = (e, t = "") => Object.entries(e).reduce((e, [n, r]) => d(d({}, e), typeof r == "string" ? { [t + n]: r } : b(r, `${t}${n}.`)), {});
	function S(e, t) {
	...
	var D = _("react"), O = _("react"), k = _("react");
	function A(e, t) {
	...
	var L = _("next/navigation"), R = _("react"), z = "locale";
	function B(e, t) {
		return function() {
...
function C(e, t = "") {
	...
	for (let r in e) {
		let i = t ? `${t}.${r}` : r;
		typeof e[r] == "object" && e[r] !== null ? Object.assign(n, C(e[r], i)) : n[i] = String(e[r]);
	}
	return n;
}
var w = C(s), T = C({
...
}), E = C(c), D = C(l), O = C(u), k = C(d), A = C(f), j = C(p), M = C(m), N = C(h), { useScopedI18n: P, I18nProviderClient: F, useChangeLocale: I, useCurrentLocale: L } = (0, S.createI18nClient)({
	en: () => Promise.resolve({ default: T }),
	fr: () => Promise.resolve({ default: D }),
	es: () => Promise.resolve({ default: E }),
	de: () => Promise.resolve({ default: w }),
	it: () => Promise.resolve({ default: O }),
	pt: () => Promise.resolve({ default: j }),
	zh: () => Promise.resolve({ default: N }),
	ja: () => Promise.resolve({ default: k }),
	ko: () => Promise.resolve({ default: A }),
	ru: () => Promise.resolve({ default: M })
});
function R() {
	if (!(typeof window > "u")) {
