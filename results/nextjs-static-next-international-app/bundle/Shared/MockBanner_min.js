...
var { useScopedI18n: A, I18nProviderClient: j, useChangeLocale: M, useCurrentLocale: N } = O, P = () => f("div", {
	className: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground",
	children: k()("mockBanner")
});
function F() {
	if (!(typeof window > "u")) {
...
function L({ children: r, locale: i }) {
