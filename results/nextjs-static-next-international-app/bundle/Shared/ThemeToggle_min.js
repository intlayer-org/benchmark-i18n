...
}), b = _(i), x = _(a), S = _(o), C = _(s), w = _(c), T = _(l), E = _(u), D = _(d), O = (0, g.createI18nClient)({
...
function I() {
	...
	e(() => {
		...
		if (r !== "auto") return;
		let e = window.matchMedia("(prefers-color-scheme: dark)"), t = () => F("auto");
	...
	function a() {
		...
		i(e), F(e), window.localStorage.setItem("theme", e);
	}
