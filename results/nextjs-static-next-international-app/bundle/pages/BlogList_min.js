...
function l(e, t = "") {
	...
	for (let r in e) {
		let i = t ? `${t}.${r}` : r;
		typeof e[r] == "object" && e[r] !== null ? Object.assign(n, l(e[r], i)) : n[i] = String(e[r]);
	}
	return n;
}
var u = l(c), d = l({
	...
	careers: {
		...
		"careers-benefits": {
			remoteFirstLabel: "Prioridad al trabajo remoto",
			...
			ossTimeValue: "20% del tiempo para contribuciones de código abierto"
		},
		"open-positions": {
	...
	home: {
		...
		"understanding-impact": {
			...
			waterfallRequestsDetail: " la aplicación debe cargarse primero, determinar el idioma y luego obtener el fragmento correcto, lo que añade idas y vueltas de red.",
			flashOfUntranslatedContentFouc: "Parpadeo de contenido no traducido (FOUC):",
			flashOfUntranslatedContentDetail: " el usuario puede ver brevemente claves de traducción o un idioma de reserva antes de que llegue el fragmento.",
			cacheInvalidation: "Invalidación de la caché:",
			cacheInvalidationDetail: " actualizar las traducciones requiere estrategias de invalidación de caché para que los usuarios reciban contenido nuevo sin volver a descargar fragmentos sin cambios.",
...
}), b = (0, s.createI18nClient)({
	en: () => Promise.resolve({ default: d }),
	fr: () => Promise.resolve({ default: p }),
	es: () => Promise.resolve({ default: f }),
	de: () => Promise.resolve({ default: u }),
	it: () => Promise.resolve({ default: m }),
	pt: () => Promise.resolve({ default: _ }),
	zh: () => Promise.resolve({ default: y }),
	ja: () => Promise.resolve({ default: h }),
	ko: () => Promise.resolve({ default: g }),
	ru: () => Promise.resolve({ default: v })
});
function x() {
	return b.useI18n();
}
var { useScopedI18n: S, I18nProviderClient: C, useChangeLocale: w, useCurrentLocale: T } = b, E = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-international-app/components/pages/blog/BlogList.tsx";
function D() {
	let e = x(), t = [
		{
			title: e("blog.blog-list.comparingI18nLibrariesIn2026"),
			date: e("blog.blog-list.march82026"),
			excerpt: e("blog.blog-list.weTested12DifferentInternationalization"),
			category: e("blog.blog-list.categoryBenchmark")
		},
		{
			title: e("blog.blog-list.howToReduceYourI18n"),
			date: e("blog.blog-list.march82026"),
			excerpt: e("blog.blog-list.practicalStrategiesForOptimizingTranslation"),
			category: e("blog.blog-list.categoryTutorial")
		},
		{
			title: e("blog.blog-list.theStateOfInternationalizationIn"),
			date: e("blog.blog-list.february282026"),
			excerpt: e("blog.blog-list.anOverviewOfTheCurrent"),
			category: e("blog.blog-list.categoryAnalysis")
		},
		{
			title: e("blog.blog-list.migratingFromReactI18nextTo"),
			date: e("blog.blog-list.february152026"),
			excerpt: e("blog.blog-list.aStepByStepGuide"),
			category: e("blog.blog-list.categoryTutorial")
		},
		{
			title: e("blog.blog-list.serverComponentsAndI18nWhat"),
			date: e("blog.blog-list.february12026"),
			excerpt: e("blog.blog-list.reactServerComponentsIntroduceNew"),
			category: e("blog.blog-list.categoryAnalysis")
		},
		{
			title: e("blog.blog-list.benchmarkMethodologyHowWeTest"),
			date: e("blog.blog-list.january202026"),
			excerpt: e("blog.blog-list.aTransparentLookAtOur"),
			category: e("blog.blog-list.categoryMeta")
		}
	];
	return r("div", {
		...
		children: t.map((t) => r("article", {
			...
			children: [
				...
				r("button", {
					...
					children: e("blog.blog-list.readMore")
				}, void 0, !1, {
					fileName: E,
					lineNumber: 64,
					columnNumber: 11
...
var F = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-international-app/components/pages/blog/BlogList.wrapper.tsx";
function I() {
