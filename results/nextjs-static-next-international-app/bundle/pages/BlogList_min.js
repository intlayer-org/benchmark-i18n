...
var { useScopedI18n: C, I18nProviderClient: w, useChangeLocale: T, useCurrentLocale: E } = x;
function D() {
	let e = S(), t = [
		{
...
function A({ children: i, locale: a }) {
