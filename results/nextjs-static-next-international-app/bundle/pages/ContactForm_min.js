...
import i from "../../../messages/de.json";
...
}), S = y(a), C = y(o), w = y(s), T = y(c), E = y(l), D = y(u), O = y(d), k = y(f), A = (0, v.createI18nClient)({
	...
	return m("form", {
		...
		children: [
			...
			m("div", { children: [p("label", {
				...
				children: [
					p("option", { children: e("contact.contact-form.bugReport") }),
					p("option", { children: e("contact.contact-form.newBenchmarkIdea") }),
					p("option", { children: e("contact.contact-form.methodologyQuestion") }),
					p("option", { children: e("header.contact") }),
					p("option", { children: e("contact.contact-form.topicOther") })
				]
			})] }),
			m("div", { children: [p("label", {
				htmlFor: a,
...
function z({ children: t, locale: i }) {
