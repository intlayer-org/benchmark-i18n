...
var { useScopedI18n: w, I18nProviderClient: T, useChangeLocale: E, useCurrentLocale: D } = S;
function O() {
	let e = C(), n = t(), r = t(), o = t(), s = t();
	return a("form", {
		className: "space-y-6",
		children: [
			a("div", {
				className: "grid gap-4 md:grid-cols-2",
				children: [a("div", { children: [i("label", {
					htmlFor: n,
			...
			a("div", { children: [i("label", {
				...
				children: [
					i("option", { children: e("contact.contact-form.bugReport") }),
					i("option", { children: e("contact.contact-form.newBenchmarkIdea") }),
					i("option", { children: e("contact.contact-form.methodologyQuestion") }),
					i("option", { children: e("header.contact") }),
					i("option", { children: e("contact.contact-form.topicOther") })
				]
			})] }),
			a("div", { children: [i("label", {
				htmlFor: s,
...
function j({ children: t, locale: a }) {
