		...
		children: [p("h2", {
			...
			children: [
				...
				m("div", { children: [p("label", {
					...
					children: [
						p("option", { children: e("settings.preferences-section.englishEn") }),
						p("option", { children: e("settings.preferences-section.frenchFr") }),
						p("option", { children: e("settings.preferences-section.germanDe") }),
						p("option", { children: e("settings.preferences-section.spanishEs") }),
						p("option", { children: e("settings.preferences-section.japaneseJa") }),
						p("option", { children: e("settings.preferences-section.chineseSimplifiedZhCn") }),
						p("option", { children: e("settings.preferences-section.arabicAr") })
					]
				})] })
			]
		})]
