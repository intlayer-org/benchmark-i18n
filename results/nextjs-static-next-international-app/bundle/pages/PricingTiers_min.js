...
var { useScopedI18n: S, I18nProviderClient: C, useChangeLocale: w, useCurrentLocale: T } = b, E = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-international-app/components/pages/pricing/PricingTiers.tsx";
function D() {
	let e = x(), t = [
		{
		...
		children: t.map((t) => r("div", {
			...
			children: [
				...
				r("ul", {
					...
					children: t.features.map((e) => r("li", {
...
var F = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-international-app/components/pages/pricing/PricingTiers.wrapper.tsx";
function I() {
