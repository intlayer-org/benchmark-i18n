			...
			p("div", {
				...
				children: [
					...
					p("ul", {
						...
						children: [
							f("li", { children: e("home.understanding-impact.theJsonMustBeParsed") }),
							f("li", { children: e("home.understanding-impact.contextBasedArchitecturesCanCause") }),
							f("li", { children: e("home.understanding-impact.duringServerSideRenderingThe") })
						]
					})
				]
			}),
