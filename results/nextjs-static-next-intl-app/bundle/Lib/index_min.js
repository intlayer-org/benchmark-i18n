import { cloneElement as e, createContext as t, isValidElement as n, useContext as r, useMemo as i } from "react";
import { jsx as a } from "react/jsx-runtime";
function o(e, t) {
	let n = t && t.cache ? t.cache : h, r = t && t.serializer ? t.serializer : m;
...
var ne = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function re(e) {
	let t = {};
...
var S = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, se = /^(@+)?(\+|#+)?[rs]?$/g, ce = /(\*)(0+)|(#+)(0+)|(0+)/g, C = /^(0+)$/;
function w(e) {
	let t = {};
...
var ve = RegExp(`^${I.source}*`), ye = RegExp(`${I.source}*$`);
function R(e, t) {
	return {
		start: e,
		end: t
...
var be = !!Object.fromEntries, xe = !!String.prototype.trimStart, Se = !!String.prototype.trimEnd, z = be ? Object.fromEntries : function(e) {
	let t = {};
...
function H(e) {
	e.forEach((e) => {
		if (delete e.location, N(e) || fe(e)) for (let t in e.options) delete e.options[t].location, H(e.options[t].value);
		else A(e) && he(e.style) || (j(e) || M(e)) && P(e.style) ? delete e.style.location : me(e) && H(e.children);
	});
}
function Ae(e, t = {}) {
	t = {
...
function q(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (A(c)) {
			let e = typeof c.style == "string" ? r.number[c.style] : he(c.style) ? c.style.parsedOptions : void 0;
			if (e && e.scale) {
				let t = e.scale || 1;
				if (typeof l == "bigint") {
		...
		if (me(c)) {
			...
			if (!Pe(u)) throw new je(l, "function", o);
...
function Re(...[e, t, r, i]) {
	if (Array.isArray(t)) throw new _(v.INVALID_MESSAGE, void 0);
	if (typeof t == "object") throw new _(v.INSUFFICIENT_PATH, void 0);
	if (typeof t == "string") {
		let e = function(e, t) {
	...
	try {
		...
		throw new _(v.INVALID_MESSAGE, void 0);
	}
	let f = d.format(r);
...
function Be(t) {
	let r = function(e, t, n) {
		try {
			...
			return new _(v.MISSING_MESSAGE, e.message);
		}
	...
	return function({ cache: t, formats: r, formatters: i, getMessageFallback: a = Z, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, ee, h) {
			...
			if (d) {
				...
				try {
					...
					if (!g) return f(p, v.MISSING_MESSAGE, e.message, g);
					y = g;
				}
			}
			try {
				return Re(X(c, p), y, m && function(t) {
					let r = {};
				...
				let t, n;
				return e instanceof _ ? (t = e.code, n = e.originalMessage) : (t = v.FORMATTING_ERROR, n = e.message), f(p, t, n, g);
			}
		}
		function m(e, t, n, r) {
			let i = p(e, t, n, r);
			return typeof i == "string" ? i : f(e, v.INVALID_MESSAGE, void 0);
		}
		return m.rich = p, m.markup = (e, t, n, r) => p(e, t, n, r), m.raw = (e) => {
			...
			try {
				...
				return f(e, v.MISSING_MESSAGE, t.message);
			}
		}, m.has = (e) => {
			if (d) return !1;
			try {
...
var He = 86400;
7 * He, 365 * He;
function Ue({ formats: e, getMessageFallback: t, messages: n, onError: r, ...i }) {
	return {
		...i,
		formats: e || void 0,
		messages: n || void 0,
...
var $ = t(void 0);
function We({ children: e, formats: t, getMessageFallback: n, locale: o, messages: s, now: c, onError: l, timeZone: u }) {
	let d = r($), f = i((() => d?.cache || y()), [o, d?.cache]), p = i((() => d?.formatters || te(f)), [f, d?.formatters]), m = i((() => ({
		...Ue({
			locale: o,
...
var Ke = !1, qe = typeof window > "u";
function Je(e) {
	return function(e, t, n) {
		let { cache: r, formats: a, formatters: o, getMessageFallback: s, locale: c, onError: l, timeZone: u } = Ge(), d = e[n], f = Ve(t, n);
		return u || Ke || !qe || (Ke = !0, l(new _(v.ENVIRONMENT_FALLBACK, void 0))), i((() => Be({
			cache: r,
			formatters: o,
