...
import u from "../messages/en.json";
function d(e, t) {
...
var De = !!Object.fromEntries, Oe = !!String.prototype.trimStart, ke = !!String.prototype.trimEnd, R = De ? Object.fromEntries : function(e) {
	let t = {};
...
var Ne = class {
	...
	parseTag(e, t) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !B(this.char())) return this.error(T.INVALID_TAG, L(o, this.clonePosition()));
				let e = this.clonePosition();
			...
			} else return this.error(T.UNCLOSED_TAG, L(n, this.clonePosition()));
		} else return this.error(T.INVALID_TAG, L(n, this.clonePosition()));
	}
	parseTagName() {
		let e = this.offset();
...
function V(e) {
	e.forEach((e) => {
		...
		else xe(e) && N(e.style) || (O(e) || k(e)) && P(e.style) ? delete e.style.location : M(e) && V(e.children);
	});
}
function Le(e, t = {}) {
	t = {
...
var mt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intl-app/scripts/EmptyComponent.tsx", ht = () => (ft(), null);
function gt() {
	return l(pt, {
		locale: "en",
		messages: {},
		timeZone: "UTC",
		children: l(ht, {}, void 0, !1, {
			fileName: mt,
			lineNumber: 13,
			columnNumber: 7
		}, this)
...
var xt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intl-app/scripts/Wrapper.tsx", St = "en";
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intl-app/scripts/EmptyComponent.wrapper.tsx";
function wt() {
	return l(Ct, { children: l(gt, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
