...
function H(e) {
	e.forEach((e) => {
		if (delete e.location, N(e) || we(e)) for (let t in e.options) delete e.options[t].location, H(e.options[t].value);
		else Ce(e) && De(e.style) || (j(e) || M(e)) && P(e.style) ? delete e.style.location : Ee(e) && H(e.children);
	});
}
function He(e, t = {}) {
	t = {
