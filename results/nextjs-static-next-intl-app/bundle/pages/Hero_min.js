...
var Pe = class {
	...
	parseTag(e, t) {
		...
		if (this.bumpIf(">")) {
			...
			} else return this.error(C.UNCLOSED_TAG, I(n, this.clonePosition()));
		} else return this.error(C.INVALID_TAG, I(n, this.clonePosition()));
	}
	parseTagName() {
		let e = this.offset();
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intl-app/components/pages/home/Hero.tsx";
function mt() {
...
var Ct = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intl-app/components/pages/home/Hero.wrapper.tsx";
function wt() {
