...
function Ge(t) {
	...
	return function({ cache: t, formats: r, formatters: i, getMessageFallback: a = Ue, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, h, g) {
			...
			try {
				return He(Z(c, p), v, m && function(t) {
					let r = {};
...
var $ = t(void 0);
function Ye({ children: e, formats: t, getMessageFallback: n, locale: i, messages: a, now: s, onError: c, timeZone: u }) {
	let d = r($), f = o((() => d?.cache || re()), [i, d?.cache]), p = o((() => d?.formatters || ae(f)), [f, d?.formatters]), m = o((() => ({
		...Je({
			locale: i,
...
function $e(e) {
	return function(e, t, n) {
		...
		return u || Ze || !Qe || (Ze = !0, l(new b(x.ENVIRONMENT_FALLBACK, void 0))), o((() => Ge({
			cache: r,
			formatters: a,
...
function ot({ children: e, locale: t, messages: n }) {
