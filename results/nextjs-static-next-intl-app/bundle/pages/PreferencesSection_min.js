...
var Q = t(void 0);
function at({ children: e, formats: t, getMessageFallback: n, locale: i, messages: a, now: o, onError: c, timeZone: u }) {
	let d = r(Q), f = s(() => d?.cache || ae(), [i, d?.cache]), p = s(() => d?.formatters || ce(f), [f, d?.formatters]), m = s(() => ({
		...it({
			locale: i,
...
function lt(e, t, n) {
	let { cache: r, formats: i, formatters: a, getMessageFallback: o, locale: c, onError: l, timeZone: u } = ot(), d = e[n], f = tt(t, n);
	return !u && !st && ct && (st = !0, l(new v(y.ENVIRONMENT_FALLBACK, "There is no `timeZone` configured, this can lead to markup mismatches caused by environment differences. Consider adding a global default: https://next-intl.dev/docs/configuration#time-zone"))), s(() => $e({
		cache: r,
		formatters: a,
		getMessageFallback: o,
		messages: d,
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intl-app/components/pages/settings/PreferencesSection.tsx";
function mt() {
	let e = ft(), t = a();
	return u("section", {
		...
		children: [u("h2", {
			...
			children: [
				...
				u("div", { children: [u("label", {
					...
					children: [
						u("option", { children: e("settings.preferences-section.englishEn") }, void 0, !1, {
							fileName: $,
							lineNumber: 61,
							columnNumber: 13
						}, this),
						u("option", { children: e("settings.preferences-section.frenchFr") }, void 0, !1, {
							fileName: $,
							lineNumber: 62,
							columnNumber: 13
						}, this),
						u("option", { children: e("settings.preferences-section.germanDe") }, void 0, !1, {
							fileName: $,
							lineNumber: 63,
							columnNumber: 13
						}, this),
						u("option", { children: e("settings.preferences-section.spanishEs") }, void 0, !1, {
							fileName: $,
							lineNumber: 64,
							columnNumber: 13
						}, this),
						u("option", { children: e("settings.preferences-section.japaneseJa") }, void 0, !1, {
							fileName: $,
							lineNumber: 65,
							columnNumber: 13
						}, this),
						u("option", { children: e("settings.preferences-section.chineseSimplifiedZhCn") }, void 0, !1, {
							fileName: $,
							lineNumber: 66,
							columnNumber: 13
						}, this),
						u("option", { children: e("settings.preferences-section.arabicAr") }, void 0, !1, {
							fileName: $,
							lineNumber: 67,
							columnNumber: 13
						}, this)
...
var Ct = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intl-app/components/pages/settings/PreferencesSection.wrapper.tsx";
function wt() {
