...
function Ye({ children: e, formats: t, getMessageFallback: n, locale: i, messages: a, now: o, onError: c, timeZone: u }) {
	let d = r($), f = s((() => d?.cache || ie()), [i, d?.cache]), p = s((() => d?.formatters || oe(f)), [f, d?.formatters]), m = s((() => ({
		...Je({
			locale: i,
		...
		children: [l("h2", {
			...
			children: [
				...
				u("div", { children: [l("label", {
					...
					children: [
						l("option", { children: e("settings.preferences-section.englishEn") }),
						l("option", { children: e("settings.preferences-section.frenchFr") }),
						l("option", { children: e("settings.preferences-section.germanDe") }),
						l("option", { children: e("settings.preferences-section.spanishEs") }),
						l("option", { children: e("settings.preferences-section.japaneseJa") }),
						l("option", { children: e("settings.preferences-section.chineseSimplifiedZhCn") }),
						l("option", { children: e("settings.preferences-section.arabicAr") })
					]
				})] })
			]
		})]
