...
var De = !!Object.fromEntries, Oe = !!String.prototype.trimStart, ke = !!String.prototype.trimEnd, L = De ? Object.fromEntries : function(e) {
	let t = {};
	...
	return e.replace(Ee, "");
}, Me = /* @__PURE__ */ RegExp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
function Ne(e, t) {
	return Me.lastIndex = t, Me.exec(e)[1] ?? "";
}
var Pe = class {
	constructor(e, t = {}) {
	...
	parseTag(e, t) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !R(this.char())) return this.error(S.INVALID_TAG, I(o, this.clonePosition()));
				let e = this.clonePosition();
...
function z(e) {
	e.forEach((e) => {
		...
		else E(e) && M(e.style) || (D(e) || O(e)) && N(e.style) ? delete e.style.location : j(e) && z(e.children);
	});
}
function Re(e, t = {}) {
	t = {
...
function rt(e, t, n) {
	Object.entries(e).forEach(([e, r]) => {
		...
		typeof r == "object" && r && rt(r, t, q(n, e));
	});
}
function it(e, t) {
	let n = [];
...
function ot({ children: e, formats: t, getMessageFallback: n, locale: i, messages: a, now: s, onError: l, timeZone: u }) {
	let d = r(X), f = o(() => d?.cache || ie(), [i, d?.cache]), p = o(() => d?.formatters || oe(f), [f, d?.formatters]), m = o(() => ({
		...at({
			locale: i,
...
function lt(e, t, n) {
	let { cache: r, formats: i, formatters: a, getMessageFallback: s, locale: c, onError: l, timeZone: u } = Z(), d = e[n], f = nt(t, n);
...
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intl-app/components/pages/home/UnderstandingImpact.tsx";
function mt() {
	let e = ft();
	return l("section", {
...
var _t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intl-app/components/AppProviders.tsx";
...
}, bt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intl-app/scripts/Wrapper.tsx", xt = "en";
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intl-app/components/pages/home/UnderstandingImpact.wrapper.tsx";
function Ct() {
	return l(St, { children: l(mt, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
