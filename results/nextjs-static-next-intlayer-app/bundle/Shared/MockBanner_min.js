...
var m = {
...
}, Ce = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", K = /\{\{\s*(.*?)\s*\}\}/g, we = (e, t = {}) => {
...
}, ke = L, Ae = L, q = /* @__PURE__ */ new Map(), je = (e, t = !0) => {
	...
	return q.set(n, r), r;
}, Me = (e, t) => G(e, t, je(typeof t == "object" && t ? t.locale : t)), J = (e) => {
...
var X = {
...
}, He = (e, t = h?.locales, n = h?.defaultLocale) => {
	...
	let { locales: c, defaultLocale: u } = h ?? {}, [f, p] = l(e ?? Z ?? t ?? u);
	a(() => {
		e && e !== f && p(e);
	}, [e]), a(() => {
		Ve();
	...
	let { locale: n, variant: r } = i(Q) ?? {}, a = t ?? n, o = typeof a == "object" && a ? `${a.locale ?? ""}|${M(a)}` : a;
	return s(() => Me(e, a), [e.key, o]);
}, Ke = (e) => d(We, { ...e }), qe = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intlayer-app/src/components/MockBanner.tsx", Je = () => {
	let e = Ge(m);
	return p("div", {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intlayer-app/src/components/MockBanner.wrapper.tsx";
function tt() {
