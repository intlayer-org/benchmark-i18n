...
}, qe = (e) => d(Ge, { ...e }), Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intlayer-app/src/components/pages/pricing/PricingTiers.tsx";
function Je() {
	let e = Ke(m), t = [
		{
			name: e.y,
		...
		children: t.map((t) => p("div", {
			...
			children: [
				...
				p("ul", {
					...
					children: t.features.map((e, t) => p("li", {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intlayer-app/src/components/pages/pricing/PricingTiers.wrapper.tsx";
function tt() {
