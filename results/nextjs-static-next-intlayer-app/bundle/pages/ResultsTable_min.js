...
}, qe = (e) => d(Ge, { ...e }), Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intlayer-app/src/components/pages/home/ResultsTable.tsx";
function Je() {
	let e = Ke(m), t = [
		{
			lib: "react-i18next",
	...
	return p("section", { children: [p("h2", {
		...
		children: p("table", {
			...
			children: [p("thead", {
				...
				lineNumber: 40,
				columnNumber: 11
			}, this), p("tbody", { children: t.map((e) => p("tr", {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/next-intlayer-app/src/components/pages/home/ResultsTable.wrapper.tsx";
function tt() {
