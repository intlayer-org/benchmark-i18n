...
import u from "../locales/fr.json";
import d from "../locales/es.json";
import f from "../locales/de.json";
import p from "../locales/it.json";
import m from "../locales/pt.json";
import h from "../locales/zh.json";
import g from "../locales/ja.json";
import _ from "../locales/ko.json";
import v from "../locales/ru.json";
function y() {
	if (!(typeof window > "u")) {
...
function R(e) {
	var t = n(C);
	return a(function() {
		return L(L({}, t), { t: P(t.t, e) });
	}, [t, e]);
}
function z(e) {
	return (globalThis.__NEXT_TRANSLATE__?.config ? I : R)(e);
}
var B = function() {
...
function H(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, u = c === void 0 ? {} : c, d = z().lang, f = l() || {}, p = f.locale, m = f.defaultLocale, h = n(V), g = B(B(B({}, U()), h.ns), o), _ = r || d || p || m || "", v = B(B({}, h.config), u), y = v.localesToIgnore || ["default"], b = !_ || y.includes(_), x = a(function() {
		return w(b ? void 0 : _);
	}, [b, _]), S = a(function() {
		return D({
			config: v,
