...
var w = ({ href: e, children: t, ...n }) => {
	let r = c().lang ?? "en";
	return e == null || typeof e != "string" || S(e) ? u(s, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
function N(e) {
	var t = e.config, n = e.allNamespaces, r = e.pluralRules, i = e.lang, a = t.logger, o = a === void 0 ? R : a, s = t.allowEmptyStrings, c = s === void 0 ? !0 : s, l = function(e, n) {
		return Array.isArray(e) ? e.map(function(e) {
			return l(e, n);
		}) : e instanceof Object ? L({
			obj: e,
			query: n,
			config: t,
			lang: i
		...
		e === void 0 && (e = "");
		var s = Array.isArray(e) ? e[0] : e, d = t.nsSeparator, f = d === void 0 ? ":" : d, p = t.loggerEnvironment, m = p === void 0 ? "browser" : p, h = M(s, f), g = h.i18nKey, _ = h.namespace, v = _ === void 0 ? a?.ns ?? t.defaultNS : _, y = v && n[v] || {}, b = P(y, F(r, y, g, t, i, a), t, a), x = typeof b == "object" ? JSON.parse(JSON.stringify(b)) : b, S = x === void 0 || typeof x == "object" && !Object.keys(x).length || x === "" && !c, C = typeof a?.fallback == "string" ? [a.fallback] : a?.fallback || [];
		if (S && (m === "both" || m === (typeof window > "u" ? "node" : "browser")) && o({
			namespace: v,
			i18nKey: g
		}), S && Array.isArray(C) && C.length) {
			var w = C[0], T = C.slice(1);
			if (typeof w == "string") return u(w, i, j(j({}, a), { fallback: T }));
		}
...
function L(e) {
	...
	return !n || Object.keys(n).length === 0 || Object.keys(t).forEach(function(e) {
		t[e] instanceof Object && L({
			obj: t[e],
			query: n,
			config: r,
			lang: i
		}), typeof t[e] == "string" && (t[e] = I({
			text: t[e],
			query: n,
			config: r,
			lang: i
			...
			children: [d("div", {
				...
				children: [
					...
					d("div", { children: [u("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => u("li", { children: e.isInternal ? u(w, {
							href: e.href,
...
function K(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, l = c === void 0 ? {} : c, u = H().lang, d = f() || {}, p = d.locale, m = d.defaultLocale, h = n(G), g = W(W(W({}, q()), h.ns), o), _ = r || u || p || m || "", v = W(W({}, h.config), l), y = v.localesToIgnore || ["default"], b = !_ || y.includes(_), x = a(function() {
		return A(b ? void 0 : _);
	}, [b, _]), S = a(function() {
		return N({
			config: v,
	...
	return e.createElement(O.Provider, { value: {
		lang: _,
		t: S
	} }, e.createElement(G.Provider, { value: {
		ns: g,
		config: v
	} }, s));
}
...
function $({ children: e }) {
	...
	return r(() => {
		(async () => {
			try {
				n(await Y.loadLocaleFrom?.("en", "common") ?? {}), a(!0);
			} catch (e) {
