...
typeof e.createContext == "function" && (w = e.createContext({
	t: function(e) {
...
function B(e) {
	var t = n(T);
	return a(function() {
		return z(z({}, t), { t: I(t.t, e) });
	}, [t, e]);
}
function V(e) {
	return (globalThis.__NEXT_TRANSLATE__?.config ? R : B)(e);
}
var H = function() {
...
function W(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, l = c === void 0 ? {} : c, u = V().lang, f = d() || {}, p = f.locale, m = f.defaultLocale, h = n(U), g = H(H(H({}, G()), h.ns), o), _ = r || u || p || m || "", v = H(H({}, h.config), l), y = v.localesToIgnore || ["default"], b = !_ || y.includes(_), x = a(function() {
		return E(b ? void 0 : _);
	}, [b, _]), S = a(function() {
		return k({
			config: v,
	...
	return e.createElement(T.Provider, { value: {
		lang: _,
		t: S
...
function Z({ children: e }) {
	...
	return r(() => {
		(async () => {
			try {
				n(await q.loadLocaleFrom?.("en", "common") ?? {}), a(!0);
			} catch (e) {
