...
import p from "../locales/fr.json";
import m from "../locales/es.json";
import h from "../locales/de.json";
import g from "../locales/it.json";
import _ from "../locales/pt.json";
import v from "../locales/zh.json";
import y from "../locales/ja.json";
import b from "../locales/ko.json";
import x from "../locales/ru.json";
var S = [
	"en",
	"fr",
	"es",
...
var T;
typeof e.createContext == "function" && (T = e.createContext({
	t: function(e) {
...
function A(e) {
	var t = e.config, n = e.allNamespaces, r = e.pluralRules, i = e.lang, a = t.logger, o = a === void 0 ? F : a, s = t.allowEmptyStrings, c = s === void 0 ? !0 : s, l = function(e, n) {
		return Array.isArray(e) ? e.map(function(e) {
			return l(e, n);
		}) : e instanceof Object ? P({
			obj: e,
			query: n,
			config: t,
			lang: i
		...
		e === void 0 && (e = "");
		var s = Array.isArray(e) ? e[0] : e, d = t.nsSeparator, f = d === void 0 ? ":" : d, p = t.loggerEnvironment, m = p === void 0 ? "browser" : p, h = k(s, f), g = h.i18nKey, _ = h.namespace, v = _ === void 0 ? a?.ns ?? t.defaultNS : _, y = v && n[v] || {}, b = j(y, M(r, y, g, t, i, a), t, a), x = typeof b == "object" ? JSON.parse(JSON.stringify(b)) : b, S = x === void 0 || typeof x == "object" && !Object.keys(x).length || x === "" && !c, C = typeof a?.fallback == "string" ? [a.fallback] : a?.fallback || [];
		if (S && (m === "both" || m === (typeof window > "u" ? "node" : "browser")) && o({
			namespace: v,
			i18nKey: g
		}), S && Array.isArray(C) && C.length) {
			var w = C[0], T = C.slice(1);
			if (typeof w == "string") return u(w, i, O(O({}, a), { fallback: T }));
		}
...
function M(e, t, n, r, i, a) {
	...
	var o = `${n}_${i.count}`;
	if (j(t, o, r, a) !== void 0) return o;
	var s = `${n}_${e.select(i.count)}`;
	if (j(t, s, r, a) !== void 0) return s;
	var c = `${n}.${i.count}`;
	if (j(t, c, r, a) !== void 0) return c;
	var l = `${n}.${e.select(i.count)}`;
	return j(t, l, r, a) === void 0 ? n : l;
}
function N(e) {
...
function P(e) {
	...
	return !n || Object.keys(n).length === 0 || Object.keys(t).forEach(function(e) {
		t[e] instanceof Object && P({
			obj: t[e],
			query: n,
			config: r,
			lang: i
		}), typeof t[e] == "string" && (t[e] = N({
			text: t[e],
			query: n,
			config: r,
			lang: i
...
function V(e) {
	var t = n(E);
	return a(function() {
		return B(B({}, t), { t: L(t.t, e) });
	}, [t, e]);
}
function H(e) {
	return (globalThis.__NEXT_TRANSLATE__?.config ? z : V)(e);
}
var U = function() {
...
function G(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, l = c === void 0 ? {} : c, u = H().lang, d = f() || {}, p = d.locale, m = d.defaultLocale, h = n(W), g = U(U(U({}, K()), h.ns), o), _ = r || u || p || m || "", v = U(U({}, h.config), l), y = v.localesToIgnore || ["default"], b = !_ || y.includes(_), x = a(function() {
		return D(b ? void 0 : _);
	}, [b, _]), S = a(function() {
		return A({
			config: v,
	...
	return e.createElement(E.Provider, { value: {
		lang: _,
		t: S
	} }, e.createElement(W.Provider, { value: {
		ns: g,
		config: v
	} }, s));
}
...
function Q({ children: e }) {
	...
	return r(() => {
		(async () => {
			try {
				n(await J.loadLocaleFrom?.("en", "common") ?? {}), a(!0);
			} catch (e) {
