...
function B(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, u = c === void 0 ? {} : c, d = I().lang, f = l() || {}, p = f.locale, m = f.defaultLocale, h = n(z), g = R(R(R({}, V()), h.ns), o), _ = r || d || p || m || "", v = R(R({}, h.config), u), y = v.localesToIgnore || ["default"], b = !_ || y.includes(_), x = a(function() {
		return w(b ? void 0 : _);
	}, [b, _]), C = a(function() {
		return D({
			config: v,
...
function q({ children: e }) {
	...
	return r(() => {
		(async () => {
			try {
				n(await U.loadLocaleFrom?.("en", "common") ?? {}), a(!0);
			} catch (e) {
