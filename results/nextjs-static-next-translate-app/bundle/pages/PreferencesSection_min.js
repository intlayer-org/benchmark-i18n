...
import f from "../../../locales/fr.json";
import p from "../../../locales/es.json";
import m from "../../../locales/de.json";
import h from "../../../locales/it.json";
import g from "../../../locales/pt.json";
import _ from "../../../locales/zh.json";
import v from "../../../locales/ja.json";
import y from "../../../locales/ko.json";
import b from "../../../locales/ru.json";
var x = function() {
...
function k(e) {
	var t = e.config, n = e.allNamespaces, r = e.pluralRules, i = e.lang, a = t.logger, o = a === void 0 ? P : a, s = t.allowEmptyStrings, c = s === void 0 ? !0 : s, l = function(e, n) {
		return Array.isArray(e) ? e.map(function(e) {
			return l(e, n);
		}) : e instanceof Object ? N({
			obj: e,
			query: n,
			config: t,
			lang: i
		...
		e === void 0 && (e = "");
		var s = Array.isArray(e) ? e[0] : e, d = t.nsSeparator, f = d === void 0 ? ":" : d, p = t.loggerEnvironment, m = p === void 0 ? "browser" : p, h = O(s, f), g = h.i18nKey, _ = h.namespace, v = _ === void 0 ? a?.ns ?? t.defaultNS : _, y = v && n[v] || {}, b = A(y, j(r, y, g, t, i, a), t, a), x = typeof b == "object" ? JSON.parse(JSON.stringify(b)) : b, S = x === void 0 || typeof x == "object" && !Object.keys(x).length || x === "" && !c, C = typeof a?.fallback == "string" ? [a.fallback] : a?.fallback || [];
		if (S && (m === "both" || m === (typeof window > "u" ? "node" : "browser")) && o({
			namespace: v,
			i18nKey: g
		}), S && Array.isArray(C) && C.length) {
			var w = C[0], T = C.slice(1);
			if (typeof w == "string") return u(w, i, D(D({}, a), { fallback: T }));
		}
...
function j(e, t, n, r, i, a) {
	...
	var o = `${n}_${i.count}`;
	if (A(t, o, r, a) !== void 0) return o;
	var s = `${n}_${e.select(i.count)}`;
	if (A(t, s, r, a) !== void 0) return s;
	var c = `${n}.${i.count}`;
	if (A(t, c, r, a) !== void 0) return c;
	var l = `${n}.${e.select(i.count)}`;
	return A(t, l, r, a) === void 0 ? n : l;
}
function M(e) {
...
function L(e) {
	var t = n(w);
	return o(function() {
		return I(I({}, t), { t: S(t.t, e) });
	}, [t, e]);
}
function R(e) {
	return (globalThis.__NEXT_TRANSLATE__?.config ? F : L)(e);
}
function z() {
	let { t: e } = R("common"), t = i();
	return u("section", {
...
function H(t) {
	var r = t.lang, i = t.namespaces, a = i === void 0 ? {} : i, s = t.children, c = t.config, l = c === void 0 ? {} : c, u = R().lang, f = d() || {}, p = f.locale, m = f.defaultLocale, h = n(V), g = B(B(B({}, U()), h.ns), a), _ = r || u || p || m || "", v = B(B({}, h.config), l), y = v.localesToIgnore || ["default"], b = !_ || y.includes(_), x = o(function() {
		return E(b ? void 0 : _);
	}, [b, _]), S = o(function() {
		return k({
			config: v,
	...
	return e.createElement(w.Provider, { value: {
		lang: _,
		t: S
