...
function V(t) {
	var r = t.lang, i = t.namespaces, o = i === void 0 ? {} : i, s = t.children, c = t.config, l = c === void 0 ? {} : c, d = L().lang, f = u() || {}, p = f.locale, m = f.defaultLocale, h = n(B), g = z(z(z({}, H()), h.ns), o), _ = r || d || p || m || "", v = z(z({}, h.config), l), y = v.localesToIgnore || ["default"], b = !_ || y.includes(_), x = a(function() {
		return T(b ? void 0 : _);
	}, [b, _]), S = a(function() {
		return O({
			config: v,
	...
	return e.createElement(C.Provider, { value: {
		lang: _,
		t: S
	} }, e.createElement(B.Provider, { value: {
		ns: g,
		config: v
	} }, s));
}
...
function J({ children: e }) {
	...
	return r(() => {
		(async () => {
			try {
				n(await W.loadLocaleFrom?.("en", "common") ?? {}), a(!0);
			} catch (e) {
