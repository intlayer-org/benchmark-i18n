...
var about_grid_choosingani18nlibraryis4 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_about_grid_choosingani18nlibraryis4(inputs);
	return en_about_grid_choosingani18nlibraryis4(inputs);
});
...
var about_grid_methodology = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_about_grid_methodology(inputs);
	return en_about_grid_methodology(inputs);
});
...
var about_grid_thesame10pageapp3 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_about_grid_thesame10pageapp3(inputs);
	return en_about_grid_thesame10pageapp3(inputs);
});
...
var about_grid_whythisexists2 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_about_grid_whythisexists2(inputs);
	return en_about_grid_whythisexists2(inputs);
});
var _jsxFileName$3 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/paraglide-next-app/components/pages/about/AboutGrid.tsx";
function AboutGrid() {
	return jsxDEV("div", {
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/paraglide-next-app/components/pages/about/AboutGrid.wrapper.tsx";
function Wrapped() {
