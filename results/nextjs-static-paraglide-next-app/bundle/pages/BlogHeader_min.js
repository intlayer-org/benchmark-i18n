...
var I = () => "Insights, tutorials, and analysis from the i18n community.", L = () => "Aperçus, tutoriels et analyses de la communauté i18n.", R = () => "Información, tutoriales y análisis de la comunidad i18n.", z = () => "Einblicke, Tutorials und Analysen aus der i18n-Community.", B = () => "Approfondimenti, tutorial e analisi dalla comunità i18n.", V = () => "Insights, tutoriais e análises da comunidade i18n.", H = () => "来自 i18n 社区的见解、教程和分析。", U = () => "i18nコミュニティからの洞察、チュートリアル、分析。", W = () => "i18n 커뮤니티의 인사이트, 튜토리얼 및 분석.", G = () => "Инсайты, руководства и анализ от сообщества i18n.", K = ((e = {}, t = {}) => {
	let n = t.locale ?? m();
	return n === "fr" ? L(e) : n === "es" ? R(e) : n === "de" ? z(e) : n === "it" ? B(e) : n === "pt" ? V(e) : n === "zh" ? H(e) : n === "ja" ? U(e) : n === "ko" ? W(e) : n === "ru" ? G(e) : I(e);
}), q = () => "Blog", J = () => "Blog", Y = () => "Blog", re = () => "Blog", X = () => "Blog", ie = () => "Blog", ae = () => "博客", oe = () => "ブログ", se = () => "블로그", ce = () => "Блог", le = ((e = {}, t = {}) => {
	let n = t.locale ?? m();
	...
	lineNumber: 6,
	columnNumber: 3
}, void 0), Z = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/paraglide-next-app/components/pages/blog/BlogHeader.tsx";
function Ce() {
	return i(r, { children: [
		i(Se, {}, void 0, !1, {
			fileName: Z,
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/paraglide-next-app/components/pages/blog/BlogHeader.wrapper.tsx";
function ke() {
