...
var z = () => "Insights, tutorials, and analysis from the i18n community.", B = () => "Aperçus, tutoriels et analyses de la communauté i18n.", V = () => "Información, tutoriales y análisis de la comunidad i18n.", H = () => "Einblicke, Tutorials und Analysen aus der i18n-Community.", U = () => "Approfondimenti, tutorial e analisi dalla comunità i18n.", W = () => "Insights, tutoriais e análises da comunidade i18n.", G = () => "来自 i18n 社区的见解、教程和分析。", K = () => "i18nコミュニティからの洞察、チュートリアル、分析。", q = () => "i18n 커뮤니티의 인사이트, 튜토리얼 및 분석.", J = () => "Инсайты, руководства и анализ от сообщества i18n.", Y = ((e = {}, t = {}) => {
	let n = t.locale ?? h();
	return n === "fr" ? B(e) : n === "es" ? V(e) : n === "de" ? H(e) : n === "it" ? U(e) : n === "pt" ? W(e) : n === "zh" ? G(e) : n === "ja" ? K(e) : n === "ko" ? q(e) : n === "ru" ? J(e) : z(e);
}), X = () => "Blog", te = () => "Blog", Z = () => "Blog", Q = () => "Blog", ne = () => "Blog", re = () => "Blog", ie = () => "博客", ae = () => "ブログ", oe = () => "블로그", se = () => "Блог", ce = ((e = {}, t = {}) => {
	let n = t.locale ?? h();
