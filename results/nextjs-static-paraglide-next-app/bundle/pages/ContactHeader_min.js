...
var k = () => "Get in Touch", A = () => "Contactez-nous", j = () => "Ponte en contacto", M = () => "Kontakt aufnehmen", N = () => "Mettiti in contatto", P = () => "Entre em contato", F = () => "联系我们", I = () => "お問い合わせ", L = () => "연락하기", R = () => "Свяжитесь с нами", z = ((e = {}, t = {}) => {
	let n = t.locale ?? b();
	return n === "en" ? k(e) : n === "fr" ? A(e) : n === "es" ? j(e) : n === "de" ? M(e) : n === "it" ? N(e) : n === "pt" ? P(e) : n === "zh" ? F(e) : n === "ja" ? I(e) : n === "ko" ? L(e) : R(e);
}), B = () => "Have ideas, found a bug, or want to contribute a benchmark? Reach out to us at", V = () => "Vous avez des idées, trouvé un bug ou voulez proposer un benchmark ? Contactez-nous à", H = () => "¿Tienes ideas, has encontrado un bug o quieres contribuir con un benchmark? Contáctanos en", U = () => "Haben Sie Ideen, einen Fehler gefunden oder möchten Sie einen Benchmark beisteuern? Kontaktieren Sie uns unter", te = () => "Hai idee, hai trovato un bug o vuoi contribuire con un benchmark? Contattaci all'indirizzo", W = () => "Tem ideias, encontrou um bug ou quer contribuir com um benchmark? Entre em contato conosco em", G = () => "有想法、发现了 Bug 或想贡献基准测试？请联系我们：", K = () => "アイデアがある、バグを見つけた、またはベンチマークを提供したいですか？こちらまでご連絡ください：", q = () => "아이디어가 있거나 버그를 발견했나요? 아니면 벤치마크를 기여하고 싶으신가요? 다음 주소로 연락주세요.", J = () => "Есть идеи, нашли баг или хотите предложить бенчмарк? Свяжитесь с нами по адресу", Y = ((e = {}, t = {}) => {
	let n = t.locale ?? b();
