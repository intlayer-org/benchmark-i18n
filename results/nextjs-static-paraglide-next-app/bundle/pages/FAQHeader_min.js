...
var k = () => "Frequently Asked Questions", A = () => "Foire aux questions", j = () => "Preguntas frecuentes", M = () => "Häufig gestellte Fragen", N = () => "Domande frequenti", P = () => "Perguntas Frequentes", F = () => "常见问题", I = () => "よくある質問", L = () => "자주 묻는 질문", R = () => "Часто задаваемые вопросы", z = ((e = {}, t = {}) => {
	let n = t.locale ?? b();
	return n === "en" ? k(e) : n === "fr" ? A(e) : n === "es" ? j(e) : n === "de" ? M(e) : n === "it" ? N(e) : n === "pt" ? P(e) : n === "zh" ? F(e) : n === "ja" ? I(e) : n === "ko" ? L(e) : R(e);
}), B = () => "Everything you need to know about i18n Benchmark.", V = () => "Tout ce que vous devez savoir sur i18n Benchmark.", H = () => "Todo lo que necesitas saber sobre i18n Benchmark.", U = () => "Alles, was Sie über i18n Benchmark wissen müssen.", te = () => "Tutto quello che c'è da sapere su i18n Benchmark.", W = () => "Tudo o que você precisa saber sobre o i18n Benchmark.", G = () => "关于 i18n Benchmark 您需要了解的一切。", K = () => "i18n Benchmarkについて知っておくべきすべてのこと。", q = () => "i18n Benchmark에 대해 알아야 할 모든 것.", J = () => "Все, что вам нужно знать об i18n Benchmark.", Y = ((e = {}, t = {}) => {
	let n = t.locale ?? b();
