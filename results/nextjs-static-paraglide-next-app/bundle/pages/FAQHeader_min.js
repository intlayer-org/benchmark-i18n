...
var z = () => "Everything you need to know about i18n Benchmark.", B = () => "Tout ce que vous devez savoir sur i18n Benchmark.", V = () => "Todo lo que necesitas saber sobre i18n Benchmark.", H = () => "Alles, was Sie über i18n Benchmark wissen müssen.", U = () => "Tutto quello che c'è da sapere su i18n Benchmark.", W = () => "Tudo o que você precisa saber sobre o i18n Benchmark.", G = () => "关于 i18n Benchmark 您需要了解的一切。", K = () => "i18n Benchmarkについて知っておくべきすべてのこと。", q = () => "i18n Benchmark에 대해 알아야 할 모든 것.", J = () => "Все, что вам нужно знать об i18n Benchmark.", Y = ((e = {}, t = {}) => {
	let n = t.locale ?? h();
	return n === "fr" ? B(e) : n === "es" ? V(e) : n === "de" ? H(e) : n === "it" ? U(e) : n === "pt" ? W(e) : n === "zh" ? G(e) : n === "ja" ? K(e) : n === "ko" ? q(e) : n === "ru" ? J(e) : z(e);
}), X = () => "Frequently Asked Questions", te = () => "Foire aux questions", Z = () => "Preguntas frecuentes", Q = () => "Häufig gestellte Fragen", ne = () => "Domande frequenti", re = () => "Perguntas Frequentes", ie = () => "常见问题", ae = () => "よくある質問", oe = () => "자주 묻는 질문", se = () => "Часто задаваемые вопросы", ce = ((e = {}, t = {}) => {
	let n = t.locale ?? h();
