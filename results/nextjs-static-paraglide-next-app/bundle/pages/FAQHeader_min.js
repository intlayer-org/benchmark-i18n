...
var I = () => "Everything you need to know about i18n Benchmark.", L = () => "Tout ce que vous devez savoir sur i18n Benchmark.", R = () => "Todo lo que necesitas saber sobre i18n Benchmark.", z = () => "Alles, was Sie über i18n Benchmark wissen müssen.", B = () => "Tutto quello che c'è da sapere su i18n Benchmark.", V = () => "Tudo o que você precisa saber sobre o i18n Benchmark.", H = () => "关于 i18n Benchmark 您需要了解的一切。", U = () => "i18n Benchmarkについて知っておくべきすべてのこと。", W = () => "i18n Benchmark에 대해 알아야 할 모든 것.", G = () => "Все, что вам нужно знать об i18n Benchmark.", K = ((e = {}, t = {}) => {
	let n = t.locale ?? m();
	return n === "fr" ? L(e) : n === "es" ? R(e) : n === "de" ? z(e) : n === "it" ? B(e) : n === "pt" ? V(e) : n === "zh" ? H(e) : n === "ja" ? U(e) : n === "ko" ? W(e) : n === "ru" ? G(e) : I(e);
}), q = () => "Frequently Asked Questions", J = () => "Foire aux questions", Y = () => "Preguntas frecuentes", re = () => "Häufig gestellte Fragen", X = () => "Domande frequenti", ie = () => "Perguntas Frequentes", ae = () => "常见问题", oe = () => "よくある質問", se = () => "자주 묻는 질문", ce = () => "Часто задаваемые вопросы", le = ((e = {}, t = {}) => {
	let n = t.locale ?? m();
	...
	lineNumber: 6,
	columnNumber: 3
}, void 0), Z = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/paraglide-next-app/components/pages/faq/FAQHeader.tsx";
function Ce() {
	return i(r, { children: [
		i(Se, {}, void 0, !1, {
			fileName: Z,
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/paraglide-next-app/components/pages/faq/FAQHeader.wrapper.tsx";
function ke() {
