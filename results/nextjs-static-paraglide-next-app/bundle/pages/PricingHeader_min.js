...
}), X = () => "Choose the plan that fits your team. No hidden fees.", te = () => "Choisissez l'offre qui convient à votre équipe. Pas de frais cachés.", Z = () => "Elige el plan que se adapte a tu equipo. Sin cargos ocultos.", Q = () => "Wählen Sie den Plan, der zu Ihrem Team passt. Keine versteckten Gebühren.", ne = () => "Scegli il piano adatto al tuo team. Nessun costo nascosto.", re = () => "Escolha o plano que se adapta à sua equipe. Sem taxas ocultas.", ie = () => "选择适合您团队的计划。无隐藏费用。", ae = () => "チームに最適なプランをお選びください。隠れた費用はありません。", oe = () => "팀에 맞는 플랜을 선택하세요. 숨겨진 수수료는 없습니다.", se = () => "Выберите план, который подходит вашей команде. Никаких скрытых комиссий.", ce = ((e = {}, t = {}) => {
	let n = t.locale ?? h();
	return n === "fr" ? te(e) : n === "es" ? Z(e) : n === "de" ? Q(e) : n === "it" ? ne(e) : n === "pt" ? re(e) : n === "zh" ? ie(e) : n === "ja" ? ae(e) : n === "ko" ? oe(e) : n === "ru" ? se(e) : X(e);
}), le = () => "Simple, Transparent Pricing", ue = () => "Une tarification simple et transparente", de = () => "Precios simples y transparentes", fe = () => "Einfache, transparente Preisgestaltung", pe = () => "Prezzi Semplici e Trasparenti", me = () => "Preços Simples e Trasparentes", he = () => "简单透明的定价", ge = () => "シンプルで透明な価格設定", _e = () => "심플하고 투명한 요금제", ve = () => "Простое и прозрачное ценообразование", ye = ((e = {}, t = {}) => {
	let n = t.locale ?? h();
...
function $() {
	return a(r, { children: [i(be, {}), a("div", {
