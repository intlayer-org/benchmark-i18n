...
var z = () => "Products", B = () => "Produits", V = () => "Productos", H = () => "Produkte", U = () => "Prodotti", W = () => "Produtos", G = () => "产品", K = () => "製品", q = () => "제품", J = () => "Продукты", Y = ((e = {}, t = {}) => {
	let n = t.locale ?? h();
...
}), le = () => "Tools and services to streamline your internationalization workflow.", ue = () => "Des outils et services pour rationaliser votre flux de travail d'internationalisation.", de = () => "Herramientas y servicios para agilizar tu flujo de trabajo de internacionalización.", fe = () => "Tools und Services zur Optimierung Ihres Internationalisierungs-Worflows.", pe = () => "Strumenti e servizi per snellire il flusso di lavoro dell'internazionalizzazione.", me = () => "Ferramentas e serviços para agilizar seu fluxo de trabalho de internacionalização.", he = () => "简化国际化工作流程的工具和服务。", ge = () => "国際化ワークフローを合理化するためのツールとサービス。", _e = () => "국제화 워크플로우를 간소화하기 위한 도구 및 서비스.", ve = () => "Инструменты и услуги для оптимизации рабочего процесса интернационализации.", ye = ((e = {}, t = {}) => {
	let n = t.locale ?? h();
