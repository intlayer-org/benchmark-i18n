...
var I = () => "Products", L = () => "Produits", R = () => "Productos", z = () => "Produkte", B = () => "Prodotti", V = () => "Produtos", H = () => "产品", U = () => "製品", W = () => "제품", G = () => "Продукты", K = ((e = {}, t = {}) => {
	let n = t.locale ?? m();
...
}), ue = () => "Tools and services to streamline your internationalization workflow.", de = () => "Des outils et services pour rationaliser votre flux de travail d'internationalisation.", fe = () => "Herramientas y servicios para agilizar tu flujo de trabajo de internacionalización.", pe = () => "Tools und Services zur Optimierung Ihres Internationalisierungs-Worflows.", me = () => "Strumenti e servizi per snellire il flusso di lavoro dell'internazionalizzazione.", he = () => "Ferramentas e serviços para agilizar seu fluxo de trabalho de internacionalização.", ge = () => "简化国际化工作流程的工具和服务。", _e = () => "国際化ワークフローを合理化するためのツールとサービス。", ve = () => "국제화 워크플로우를 간소화하기 위한 도구 및 서비스.", ye = () => "Инструменты и услуги для оптимизации рабочего процесса интернационализации.", be = ((e = {}, t = {}) => {
	let n = t.locale ?? m();
	...
	lineNumber: 6,
	columnNumber: 3
}, void 0), Z = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/paraglide-next-app/components/pages/products/ProductsHeader.tsx";
function Ce() {
	return i(r, { children: [
		i(Se, {}, void 0, !1, {
			fileName: Z,
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/paraglide-next-app/components/pages/products/ProductsHeader.wrapper.tsx";
function ke() {
