...
var k = () => "Products", A = () => "Produits", j = () => "Productos", M = () => "Produkte", N = () => "Prodotti", P = () => "Produtos", F = () => "产品", I = () => "製品", L = () => "제품", R = () => "Продукты", z = ((e = {}, t = {}) => {
	let n = t.locale ?? b();
	return n === "en" ? k(e) : n === "fr" ? A(e) : n === "es" ? j(e) : n === "de" ? M(e) : n === "it" ? N(e) : n === "pt" ? P(e) : n === "zh" ? F(e) : n === "ja" ? I(e) : n === "ko" ? L(e) : R(e);
}), B = () => "Tools and services to streamline your internationalization workflow.", V = () => "Des outils et services pour rationaliser votre flux de travail d'internationalisation.", H = () => "Herramientas y servicios para agilizar tu flujo de trabajo de internacionalización.", U = () => "Tools und Services zur Optimierung Ihres Internationalisierungs-Worflows.", te = () => "Strumenti e servizi per snellire il flusso di lavoro dell'internazionalizzazione.", W = () => "Ferramentas e serviços para agilizar seu fluxo de trabalho de internacionalização.", G = () => "简化国际化工作流程的工具和服务。", K = () => "国際化ワークフローを合理化するためのツールとサービス。", q = () => "국제화 워크플로우를 간소화하기 위한 도구 및 서비스.", J = () => "Инструменты и услуги для оптимизации рабочего процесса интернационализации.", Y = ((e = {}, t = {}) => {
	let n = t.locale ?? b();
