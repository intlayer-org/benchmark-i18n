...
var z = () => "Cancel", B = () => "Annuler", V = () => "Cancelar", H = () => "Abbrechen", U = () => "Annulla", W = () => "Cancelar", G = () => "取消", K = () => "キャンセル", te = () => "취소", q = () => "Отмена", J = ((e = {}, t = {}) => {
	let n = t.locale ?? h();
	return n === "fr" ? B(e) : n === "es" ? V(e) : n === "de" ? H(e) : n === "it" ? U(e) : n === "pt" ? W(e) : n === "zh" ? G(e) : n === "ja" ? K(e) : n === "ko" ? te(e) : n === "ru" ? q(e) : z(e);
}), Y = () => "Save Changes", X = () => "Enregistrer les modifications", Z = () => "Guardar cambios", Q = () => "Änderungen speichern", ne = () => "Salva modifiche", re = () => "Salvar alterações", ie = () => "保存更改", ae = () => "変更を保存", oe = () => "변경 사항 저장", $ = () => "Сохранить изменения", se = ((e = {}, t = {}) => {
	let n = t.locale ?? h();
	return n === "fr" ? X(e) : n === "es" ? Z(e) : n === "de" ? Q(e) : n === "it" ? ne(e) : n === "pt" ? re(e) : n === "zh" ? ie(e) : n === "ja" ? ae(e) : n === "ko" ? oe(e) : n === "ru" ? $(e) : Y(e);
});
function ce() {
	return a("div", {
...
function fe({ children: e }) {
	return i(de, { children: e });
}
function pe() {
	return i(fe, { children: i(ce, {}) });
}
