...
var k = () => "Settings", A = () => "Paramètres", j = () => "Ajustes", M = () => "Einstellungen", N = () => "Impostazioni", P = () => "Configurações", F = () => "设置", I = () => "設定", L = () => "설정", R = () => "Настройки", z = ((e = {}, t = {}) => {
	let n = t.locale ?? b();
	return n === "en" ? k(e) : n === "fr" ? A(e) : n === "es" ? j(e) : n === "de" ? M(e) : n === "it" ? N(e) : n === "pt" ? P(e) : n === "zh" ? F(e) : n === "ja" ? I(e) : n === "ko" ? L(e) : R(e);
}), B = () => "Manage your account preferences and configuration.", V = () => "Gérez vos préférences de compte et votre configuration.", H = () => "Gestiona las preferencias y la configuración de tu cuenta.", U = () => "Verwalten Sie Ihre Kontoeinstellungen und Konfigurationen.", te = () => "Gestisci le preferenze del tuo account e la configurazione.", W = () => "Gerencie as preferências de sua conta e a configuração.", G = () => "管理您的账户偏好和配置。", K = () => "アカウントの優先設定と構成を管理します。", q = () => "계정 기본 설정 및 구성을 관리합니다.", J = () => "Управляйте настройками и конфигурацией своего аккаунта.", Y = ((e = {}, t = {}) => {
	let n = t.locale ?? b();
