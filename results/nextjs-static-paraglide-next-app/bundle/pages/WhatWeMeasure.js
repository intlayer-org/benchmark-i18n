...
var what_we_measure_bundlesizeimpact2 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_what_we_measure_bundlesizeimpact2(inputs);
	return en_what_we_measure_bundlesizeimpact2(inputs);
});
...
var what_we_measure_duringssrtranslationdatais4 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_what_we_measure_duringssrtranslationdatais4(inputs);
	return en_what_we_measure_duringssrtranslationdatais4(inputs);
});
...
var what_we_measure_howfasttheappcan4 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_what_we_measure_howfasttheappcan4(inputs);
	return en_what_we_measure_howfasttheappcan4(inputs);
});
...
var what_we_measure_howmuchextratimethe4 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_what_we_measure_howmuchextratimethe4(inputs);
	return en_what_we_measure_howmuchextratimethe4(inputs);
});
...
var what_we_measure_hydrationcost1 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_what_we_measure_hydrationcost1(inputs);
	return en_what_we_measure_hydrationcost1(inputs);
});
...
var what_we_measure_lazyloadingeffectiveness2 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_what_we_measure_lazyloadingeffectiveness2(inputs);
	return en_what_we_measure_lazyloadingeffectiveness2(inputs);
});
...
var what_we_measure_localeswitchspeed2 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_what_we_measure_localeswitchspeed2(inputs);
	return en_what_we_measure_localeswitchspeed2(inputs);
});
...
var what_we_measure_renderingoverhead1 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_what_we_measure_renderingoverhead1(inputs);
	return en_what_we_measure_renderingoverhead1(inputs);
});
...
var what_we_measure_theadditionaljavascriptbytessent4 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_what_we_measure_theadditionaljavascriptbytessent4(inputs);
	return en_what_we_measure_theadditionaljavascriptbytessent4(inputs);
});
...
var what_we_measure_whatwemeasure2 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_what_we_measure_whatwemeasure2(inputs);
	return en_what_we_measure_whatwemeasure2(inputs);
});
...
var what_we_measure_whethersplittingtranslationsbyroute4 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_what_we_measure_whethersplittingtranslationsbyroute4(inputs);
	return en_what_we_measure_whethersplittingtranslationsbyroute4(inputs);
});
var _jsxFileName$3 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/paraglide-next-app/components/pages/about/WhatWeMeasure.tsx";
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/nextjs-static/paraglide-next-app/components/pages/about/WhatWeMeasure.wrapper.tsx";
function Wrapped() {
