...
import f from "../i18n/locales/en.json";
...
var x = Object.defineProperty, S = Object.defineProperties, ee = Object.getOwnPropertyDescriptors, C = Object.getOwnPropertySymbols, te = Object.prototype.hasOwnProperty, ne = Object.prototype.propertyIsEnumerable, w = (e, t, n) => t in e ? x(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, T = (e, t) => {
	for (var n in t ||= {}) te.call(t, n) && w(e, n, t[n]);
	if (C) for (var n of C(t)) ne.call(t, n) && w(e, n, t[n]);
	return e;
}, re = (e, t) => S(e, ee(t)), ie;
function ae(e, t) {
...
var pe = () => ({
	...
	let r = fe(n?.headers);
	return r["x-api-key"] && (r = Object.assign(Object.assign({}, pe()), r)), e(t, Object.assign(Object.assign({}, n), { headers: r }));
}, he = (e) => {
...
}, M = (e) => Object.fromEntries(he(e).entries()), N = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function Te(e, t) {
	let n = L(we, t?.initialOptions, e);
	return n.apiUrl = le(n.apiUrl), e?.fetch && (n.fetch = me(e.fetch)), {
		initialOptions: n,
...
function Ee(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return O(s.onError, (e) => new be("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
		if (!l.languageDetector) return;
		let e = n();
		return O(s.onError, (e) => new ye("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function C(e) {
		e && l.backends.push(e);
	}
	...
	let w = Object.freeze({
		...
		setStoredLanguage(e) {
			return O(s.onError, (e) => new be("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ue(e) || I, r = t().onFormatError, a = typeof r;
...
function Oe(e, t, n) {
	let r = Te(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? j([t, ...ce(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
		...
		overrideCredentials(e) {
			i = e ? Object.assign(Object.assign({}, e), { apiUrl: le(e.apiUrl) }) : void 0;
		}
	});
	return a;
}
...
var R = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, ke(r)), n)), n;
};
function Ae({ options: e }) {
	let t = _e(), n = De(!1, () => o.isFetching(), t.onFetchingChange.emit), r = De(!1, () => S.isLoading(), t.onLoadingChange.emit), i = Oe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = Ee(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = xe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Me = () => {
	let e = {
		...
		init(t) {
			let n = je(L(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, Ne = 0, z = 1, Pe = 2, Fe = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Ne ? r = "Empty parameter" : e === z ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Ie(e) {
	return /\s/.test(e);
}
var B = 0, V = 1, H = 2, U = 3, W = 4, Le = /* @__PURE__ */ new Set([
	H,
	V,
	B
]), G = "'", Re = /* @__PURE__ */ new Set([
	"{",
	"}",
	G
...
function Be(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case B:
			...
			break;
		case V:
			Re.has(i) ? (n = n.slice(0, -1) + i, t = H) : (n += i, t = B);
			break;
		case H:
			i === G ? t = B : (n += i, t = H);
			break;
		case U:
			i === "}" ? (d(), t = B) : Ie(i) ? r !== "" && (d(), t = W) : (u(), t = U);
			break;
		case W: i == "}" ? t = B : Ie(i) ? t = W : c(z);
	}
...
(ie = console.assert) == null || ie.call(console, qe), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Je(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, rt = 3e3, it = 200, at = 0, J = /* @__PURE__ */ new Map(), ot = !1, Y, X;
...
var ct = (e) => new q("unavailable", `the Tolgee browser extension did not answer ${e} in time`), lt = () => `${Date.now()}-${at++}-${Math.random()}`;
function ut() {
...
function dt(e) {
	return Y ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: et }, window.origin), i = () => {
			clearInterval(a), ft(), X = void 0, n(new q("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Z = "__tolgee_", kt = `${Z}apiKey`, At = `${Z}apiUrl`, jt = `${Z}branch`, Mt = `${Z}projectId`, Nt = `${Z}session`, Pt = "tolgee-in-context-tools.umd.min.js", Ft = "@tolgee/in-context-tools", It = "InContextTools", Lt = "https://cdn.jsdelivr.net/npm", Rt = null;
function zt(e) {
...
function Gt() {
	...
	if (e) return re(T({}, a), { apiKey: e });
	if (i && r) return re(T({}, a), { transport: pt() });
}
function Kt() {
	let e = [];
...
var $t = { useSuspense: !1 }, en, tn = () => (en ||= e.createContext(void 0), en), Q = void 0, nn = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = Qt(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, $t), r), h = tn();
	...
	let { tolgee: r, options: a } = $(), o = se(e), c = A(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = rn(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
}, cn = Xt().use(Ue()).init({ language: "en" }), ln = () => {
	let e = sn(), { t } = on();
...
function mn() {
	return Xt().use(Ue()).updateDefaults({ staticData: Object.fromEntries(pn.map((e) => [e, () => Promise.resolve(fn(e))])) });
}
