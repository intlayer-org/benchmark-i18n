...
function Kt() {
	return Lt().use(je()).updateDefaults({ staticData: Object.fromEntries(Gt.map((e) => [e, () => Promise.resolve($(e))])) });
}
var qt = Kt().init(), Jt = ({ language: e, staticData: t, children: r }) => {
	let i = o();
	return n(() => {
