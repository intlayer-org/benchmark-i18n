...
}, P = (e) => Object.fromEntries(de(e).entries()), F = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function B(e, t) {
	let n = z(me, t?.initialOptions, e);
	return n.apiUrl = j(n.apiUrl), e?.fetch && (n.fetch = M(e.fetch)), {
		initialOptions: n,
...
function he(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return E(s.onError, (e) => new ue("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function C() {
		if (!l.languageDetector) return;
		let e = n();
		return E(s.onError, (e) => new le("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function ee(e) {
		e && l.backends.push(e);
	}
	...
	let O = Object.freeze({
		...
		setStoredLanguage(e) {
			return E(s.onError, (e) => new ue("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = re(e) || R, r = t().onFormatError, a = typeof r;
...
function ve({ options: e }) {
	let t = se(), n = V(!1, () => o.isFetching(), t.onFetchingChange.emit), r = V(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ge(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = he(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = fe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
function Qe(e, t, r, o = !0) {
	let [s] = a(() => Ze(e)), [c, l] = a(o);
	return n(() => {
		l(!1);
	}, []), i(() => {
...
var $e = { useSuspense: !1 }, et, tt = () => (et ||= e.createContext(void 0), et), Q = void 0, nt = ({ tolgee: r, options: i, children: o, fallback: s, ssr: c }) => {
	n(() => {
	...
	l = Qe(r, u, d, !!c);
	let [f, p] = a(!l.isLoaded()), m = Object.assign(Object.assign({}, $e), i), h = tt();
...
function ot() {
	return Xe().use(ke()).updateDefaults({ staticData: Object.fromEntries(at.map((e) => [e, () => Promise.resolve(it(e))])) });
}
var $ = ot().init(), st = ({ language: e, staticData: t, children: r }) => {
	let i = o();
	return n(() => {
...
function ut({ children: e, locale: t, staticData: i }) {
