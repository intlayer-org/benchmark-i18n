...
var ne = ({ href: e, children: t, ...n }) => {
	let r = u().locale ?? "en";
	return e == null || typeof e != "string" || ee(e) ? f(l, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, re = Object.defineProperty, C = Object.getOwnPropertySymbols, ie = Object.prototype.hasOwnProperty, ae = Object.prototype.propertyIsEnumerable, oe = (e, t, n) => t in e ? re(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
	...
	if (C) for (var n of C(t)) ae.call(t, n) && oe(e, n, t[n]);
	return e;
}, w;
function ce(e, t) {
...
}, N = (e) => Object.fromEntries(xe(e).entries()), P = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function Ee(e, t) {
	let n = L(Te, t?.initialOptions, e);
	return n.apiUrl = j(n.apiUrl), e?.fetch && (n.fetch = he(e.fetch)), {
		initialOptions: n,
...
function De(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return D(s.onError, (e) => new be("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
		if (!l.languageDetector) return;
		let e = n();
		return D(s.onError, (e) => new ye("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let C = Object.freeze({
		...
		setStoredLanguage(e) {
			return D(s.onError, (e) => new be("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function Oe(e, t, n) {
	let r = Ee(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? A([t, ...de(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
function Ae({ options: e }) {
	let t = _e(), n = R(!1, () => o.isFetching(), t.onFetchingChange.emit), r = R(!1, () => S.isLoading(), t.onLoadingChange.emit), i = Oe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = De(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = Se(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Me = () => {
	...
	return t;
}, B = 0, V = 1, Ne = 2, Pe = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var U = 0, W = 1, G = 2, K = 3, q = 4, Fe = new Set([
	G,
	W,
	U
]), J = "'", Ie = new Set([
...
function Re(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case U:
			...
			break;
		case W:
			Ie.has(i) ? (n = n.slice(0, -1) + i, t = G) : (n += i, t = U);
			break;
		case G:
			i === J ? t = U : (n += i, t = G);
			break;
...
var Ve = () => (e, t) => (t.setFinalFormatter(Be()), e), He = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Ue = {};
(function(e) {
	function t(e, t) {
		var n;
...
(w = console.assert) == null || w.call(console, We), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ge(e, t) {
	let n = (n) => {
...
var Je = "tolgee-in-context-tools.umd.min.js", Ye = "@tolgee/in-context-tools", Xe = "InContextTools", Ze = "https://cdn.jsdelivr.net/npm";
function Qe(e) {
...
var $e = null;
function et(e) {
	return $e ||= Qe(`${Ze}/@tolgee/web@${e}/dist/${Je}`).then(() => window[Ye][Xe]), $e;
}
var tt = "__tolgee_apiKey", nt = "__tolgee_apiUrl", rt = "__tolgee_branch";
function it() {
	let e = sessionStorage.getItem(tt) || void 0, t = sessionStorage.getItem(nt) || void 0, n = sessionStorage.getItem(rt) || void 0;
	if (!(!e || !t)) return se({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function at() {
	sessionStorage.removeItem(tt), sessionStorage.removeItem(nt), sessionStorage.removeItem(rt);
}
function ot(e) {
...
var dt = { useSuspense: !1 }, Y, ft = () => (Y ||= e.createContext(void 0), Y), X = void 0, pt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = ut(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, dt), r), h = ft();
...
var gt = () => {
	...
	let { tolgee: r, options: a } = gt(), o = ue(e), c = k(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = _t(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function At() {
	return ct().use(Ve()).updateDefaults({ staticData: Object.fromEntries(kt.map((e) => [e, () => Promise.resolve(Ot(e))])) });
}
var $ = At().init(), jt = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
...
function Pt({ children: e, locale: t, staticData: n }) {
