...
function ThemeToggle() {
	...
	return jsx("button", {
		...
		children: mode === "auto" ? jsx(T, { keyName: "themeToggle.themeAuto" }) : mode === "dark" ? jsx(T, { keyName: "themeToggle.themeDark" }) : jsx(T, { keyName: "themeToggle.themeLight" })
	});
}
var locales$1 = [
	"en",
		...
		children: jsxs("nav", {
			...
			children: [jsxs("div", {
				...
				children: [jsx(Link, {
					...
					children: jsx(T, { keyName: "header.brandShort" })
				}), jsxs("div", {
					...
					children: [
						jsx(Link, {
							...
							children: jsx(T, { keyName: "header.home" })
						}),
						jsx(Link, {
							href: "/about",
						...
						jsxs("div", {
							...
							children: [jsxs("button", {
								...
								children: [jsx(T, { keyName: "header.mockPages" }), jsx(ChevronDown, {
									size: 14,
				...
				children: [
					jsxs("a", {
						...
						children: [jsx("span", {
							className: "sr-only",
							children: jsx(T, { keyName: "header.goToGithub" })
						}), jsx("svg", {
							viewBox: "0 0 16 16",
							"aria-hidden": "true",
							width: "20",
