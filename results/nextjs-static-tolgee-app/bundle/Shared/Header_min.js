...
}, y = Object.defineProperty, b = Object.defineProperties, x = Object.getOwnPropertyDescriptors, S = Object.getOwnPropertySymbols, ee = Object.prototype.hasOwnProperty, te = Object.prototype.propertyIsEnumerable, C = (e, t, n) => t in e ? y(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
var fe = () => ({
	...
	let r = de(n?.headers);
	return r["x-api-key"] && (r = Object.assign(Object.assign({}, fe()), r)), e(t, Object.assign(Object.assign({}, n), { headers: r }));
}, me = (e) => {
...
}, j = (e) => Object.fromEntries(me(e).entries()), M = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function we(e, t) {
	let n = I(Ce, t?.initialOptions, e);
	return n.apiUrl = ce(n.apiUrl), e?.fetch && (n.fetch = pe(e.fetch)), {
		initialOptions: n,
...
function Te(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return ie(s.onError, (e) => new ye("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
		if (!l.languageDetector) return;
		let e = n();
		return ie(s.onError, (e) => new ve("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let T = Object.freeze({
		...
		setStoredLanguage(e) {
			return ie(s.onError, (e) => new ye("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = xe(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = le(e) || F, r = t().onFormatError, a = typeof r;
...
function De(e, t, n) {
	let r = we(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? A([t, ...se(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
function Oe(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = xe(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
var L = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, Oe(r)), n)), n;
};
function ke({ options: e }) {
	let t = ge(), n = Ee(!1, () => o.isFetching(), t.onFetchingChange.emit), r = Ee(!1, () => S.isLoading(), t.onLoadingChange.emit), i = De(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = Te(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = be(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var je = () => {
	let e = {
		...
		init(t) {
			let n = Ae(I(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, Me = 0, R = 1, Ne = 2, Pe = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Me ? r = "Empty parameter" : e === R ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Fe(e) {
	return /\s/.test(e);
}
var z = 0, B = 1, V = 2, H = 3, U = 4, Ie = /* @__PURE__ */ new Set([
	V,
	B,
	z
]), W = "'", Le = /* @__PURE__ */ new Set([
	"{",
	"}",
	W
]), Re = (e) => /[0-9a-zA-Z_]/.test(e);
function ze(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case z:
			...
			break;
		case B:
			Le.has(i) ? (n = n.slice(0, -1) + i, t = V) : (n += i, t = z);
			break;
		case V:
			i === W ? t = z : (n += i, t = V);
			break;
		case H:
			i === "}" ? (d(), t = z) : Fe(i) ? r !== "" && (d(), t = U) : (u(), t = H);
			break;
		case U: i == "}" ? t = z : Fe(i) ? t = U : c(R);
	}
	return Ie.has(t) || c(Ne), l(), [a, o];
}
function Be(e, t) {
	let [n, r] = ze(e), i = [n[0]];
...
function Ve() {
	return { format: ({ translation: e, params: t }) => Be(e, t) };
}
var He = () => (e, t) => (t.setFinalFormatter(Ve()), e);
function Ue() {
	return globalThis.window?.document?.createElement === void 0;
}
var We = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Ge = {};
(function(e) {
	function t(e, t) {
...
(ne = console.assert) == null || ne.call(console, Ke), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function qe(e, t) {
	return t ? `${t}: ${e}` : e;
}
var G = class e extends Error {
	constructor(t, n, r) {
		super(qe(t, n)), this.code = t, this.status = n, this.params = r, Object.setPrototypeOf(this, e.prototype);
	}
};
function Je(e) {
	return e instanceof Error && typeof e.code == "string";
}
var Ye = 2, Xe = 35e3, Ze = "TOLGEE_API_REQUEST", Qe = "TOLGEE_API_RESPONSE", $e = "TOLGEE_PROXY_PING", et = "TOLGEE_PROXY_PONG";
function tt(e) {
...
}, nt = 3e3, rt = 200, it = 0, q = /* @__PURE__ */ new Map(), at = !1, J, Y;
async function ot({ type: e, replyType: t, payload: n, timeoutMs: r = Xe, progressType: i, onProgress: a }) {
	lt();
	let o = Date.now() + r;
	await ut(Math.min(o, Date.now() + nt));
	let s = o - Date.now();
	if (s <= 0) throw st(e);
	let c = ct();
	return new Promise((r, o) => {
		let l = setTimeout(() => {
			q.delete(c), dt(), o(st(e));
		}, s);
		q.set(c, {
			replyType: t,
			progressType: i,
...
var st = (e) => new K("unavailable", `the Tolgee browser extension did not answer ${e} in time`), ct = () => `${Date.now()}-${it++}-${Math.random()}`;
function lt() {
	at || (at = !0, window.addEventListener("message", (e) => {
		var t;
...
function ut(e) {
	return J ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: $e }, window.origin), i = () => {
			clearInterval(a), dt(), Y = void 0, n(new K("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var _t = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
function vt(e) {
	let t = _t.indexOf(e);
...
function bt(e) {
	...
	for (let o = 0; o < t; o++) r = r << 5 | vt(e[o]), n += 5, n >= 8 && (a[i++] = r >>> n - 8 & 255, n -= 8);
	return yt(a.buffer);
}
function xt(e) {
	if (e) try {
...
function Ct(e) {
	...
	return r ? {
		...
		hasCredential: !!t,
		projectId: xt(t) ?? n,
		requiresExplicitProject: St(t) === "tgpat"
	};
}
function wt(e) {
...
function Et({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var X = "__tolgee_", Ot = `${X}apiKey`, kt = `${X}apiUrl`, At = `${X}branch`, jt = `${X}projectId`, Mt = `${X}session`, Nt = "tolgee-in-context-tools.umd.min.js", Pt = "@tolgee/in-context-tools", Ft = "InContextTools", It = "https://cdn.jsdelivr.net/npm", Lt = null;
function Rt(e) {
	return Lt ||= Ut(zt(e)).then(() => window[Pt][Ft]), Lt;
}
function zt(e) {
	return Bt() || `${It}/@tolgee/web@${e}/dist/${Nt}`;
}
function Bt() {
	if (Ue()) return;
	let e = window.__TOLGEE_IN_CONTEXT_URL__;
	return Ht(e, window.location) ? e : void 0;
}
var Vt = (e) => e === "localhost" || e === "127.0.0.1" || e === "::1" || e === "[::1]";
function Ht(e, t) {
	if (!e || !Vt(t.hostname)) return !1;
	try {
		let n = new URL(e, t.href);
		return n.origin === t.origin || Vt(n.hostname);
	} catch {
		return !1;
	}
}
...
function Wt() {
	let e = sessionStorage.getItem(Ot) || void 0, t = sessionStorage.getItem(kt) || void 0, n = sessionStorage.getItem(At) || void 0, r = sessionStorage.getItem(jt) || void 0, i = tt(sessionStorage.getItem(Mt));
	if (!t) return;
	let a = w(w({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return T(w({}, a), { apiKey: e });
	if (i && r) return T(w({}, a), { transport: ft() });
}
function Gt() {
	let e = [];
...
function Kt(e) {
	if (!e.isDev()) return;
	let { requiresExplicitProject: t, projectId: n } = Ct(e.getInitialOptions());
...
(() => {
	...
	return Kt(e), e.on("running", ({ value: e }) => {
		e && qt(() => {
			t.update(n()).catch(Gt);
		});
	}), Wt() && (async () => {
		let e = await Rt("prerelease");
		return (t) => {
			let n = Wt();
...
var Qt = { useSuspense: !1 }, $t, en = () => ($t ||= e.createContext(void 0), $t), Z = void 0, tn = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = Zt(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, Qt), r), h = en();
	...
	let { tolgee: r, options: a } = nn(), o = oe(e), c = k(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = rn(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var Q = (t) => {
	let n = sn(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, ln(t))) : ln(n);
}, un = (t) => {
...
function gn() {
	...
	i(() => {
		...
		if (t !== "auto") return;
		let e = window.matchMedia("(prefers-color-scheme: dark)"), n = () => hn("auto");
	...
	function r() {
		...
		n(e), hn(e), window.localStorage.setItem("theme", e);
	}
...
function yn() {
	let e = fn(["language"]), t = e.getLanguage() || "en", n = f(), r = d(), i = (t) => {
		e.changeLanguage(t);
		let i = r.split("/");
		i[1] = t;
		let a = i.join("/") || `/${t}`;
...
function xn() {
	let { t: e } = pn();
	bn("Header");
	let [t, n] = c(!1), r = d(), i = u().locale ?? "en", a = [
		{
			href: "/products",
		...
		children: m("nav", {
			...
			children: [m("div", {
				...
				children: [p(v, {
					...
					children: p($, { keyName: "header.brandShort" })
				}), m("div", {
					className: "hidden items-center gap-6 text-sm font-medium md:flex",
					children: [
						p(v, {
							href: "/",
							className: `nav-link${((e) => r === _(e, i))("/") ? " is-active" : ""}`,
						...
						m("div", {
							...
							children: [m("button", {
								...
								onMouseLeave: () => n(!1),
								onClick: () => n(!t),
								children: [p($, { keyName: "header.mockPages" }), p(h, {
									size: 14,
...
var Sn = {
	de: {
		metadata: {
			...
			description: "Ein Open-Source-Benchmark zur Messung der realen Auswirkungen von Internationalisierungsbibliotheken."
		},
		productsGrid: {
		...
		"header.settings": "Einstellungen",
		"header.team": "Team",
		mockBanner: { mockBanner: "⚠️ Diese Seite enthält fiktive Daten, die nur Benchmark-Zwecken dienen. Sie stehen in keinem Zusammenhang mit realen Unternehmen oder Dienstleistungen." },
		readMore: "Read More",
		saveChanges: "Save Changes",
		"themeToggle.themeAuto": "Thema: Auto",
		"themeToggle.themeDark": "Thema: Dunkel",
	...
	es: {
		metadata: {
			title: "i18n Benchmark",
			description: "Un benchmark de código abierto para medir el impacto real de las bibliotecas de internacionalización."
		},
		productsGrid: {
		...
		"header.settings": "Configuración",
		"header.team": "Equipo",
		mockBanner: { mockBanner: "⚠️ Esta página contiene datos simulados solo para fines de benchmarking. No está relacionada con ningún negocio o servicio real." },
		readMore: "Read More",
		saveChanges: "Save Changes",
		"themeToggle.themeAuto": "Tema: Auto",
		"themeToggle.themeDark": "Tema: Oscuro",
	...
	fr: {
		metadata: {
			title: "i18n Benchmark",
			description: "Un benchmark open source pour mesurer l'impact réel des bibliothèques d'internationalisation."
		},
		productsGrid: {
		...
		faq: {
			"faqHeader.frequentlyAskedQuestions": "Questions fréquentes",
			"faqHeader.everythingYouNeedTo": "Tout ce que vous devez savoir sur i18n Benchmark.",
			...
			"faqList.whatLibrariesAreCurrently": "Quelles bibliothèques sont actuellement testées ?",
		...
		faqList: {
			...
			i18nBenchmarkIsAnOpenSource: "i18n Benchmark est un projet open source dédié à mesurer l'impact réel sur les performances des bibliothèques d'internationalisation.",
			isTheDataReliable: "Les données sont-elles fiables ?",
			thereAreManyWaysToContribute: "Il existe de nombreuses façons de contribuer : soumettre des benchmarks, améliorer la documentation, signaler des bugs, proposer de nouvelles métriques ou sponsoriser le projet. Consultez notre dépôt GitHub pour plus de détails.",
			...
			weFollowRigorousStatisticalMethodologyIncluding: "Nous suivons une méthodologie statistique rigoureuse, avec détection des valeurs aberrantes et plusieurs séries de mesures pour garantir la précision. Toutes les données brutes sont publiées avec nos analyses pour une transparence totale.",
			weReRunAllBenchmarksWeekly: "Nous réexécutons tous les benchmarks chaque semaine sur les dernières versions stables de chaque bibliothèque. Les sorties de versions majeures déclenchent immédiatement un nouveau cycle de benchmark.",
			weRunStandardizedTestsInIsolated: "Nous exécutons des tests standardisés dans des environnements isolés et sur un matériel homogène. Chaque benchmark est répété plusieurs fois pour assurer la significativité statistique. Toutes les configurations sont disponibles publiquement sur notre dépôt GitHub.",
			weSupportReactI18nextReactIntl: "Nous prenons en charge react-i18next, react-intl, Lingui, Tolgee, ainsi que d'autres solutions React i18n courantes.",
			...
			yesCommunityBenchmarkSubmissionsAre: "Oui ! Les soumissions de benchmarks par la communauté sont les bienvenues. Forkez le dépôt, ajoutez votre benchmark en suivant notre guide de contribution et ouvrez une pull request. Notre équipe examinera et fusionnera les contributions acceptées.",
			yesOurEnterprisePlanIncludesConsulting: "Oui, l'offre Enterprise inclut des heures de conseil pour les équipes qui évaluent des solutions i18n. Nous pouvons fournir des recommandations adaptées à votre contexte, votre charge et vos contraintes.",
		...
		openPositions: {
			...
			buildAndMaintainOur: "Concevoir et maintenir notre suite de benchmarking et l'infrastructure applicative centrale.",
			...
			createComprehensiveGuidesApi: "Rédiger des guides complets, des références API et des tutoriels pour la communauté.",
			...
			designAndScaleOur: "Concevoir et faire évoluer nos pipelines d'ingestion de données et nos moteurs d'analyse statistique.",
			devOpsEngineer: "Ingénieur DevOps",
			devrelEngineer: "Ingénieur DevRel",
			documentation: "Documentation",
			engageWithTheI18n: "S'impliquer dans la communauté i18n : conférences, ateliers, articles de blog et contributions open source.",
			engineering: "Ingénierie",
			ensureTheAccuracyAnd: "Garantir l'exactitude et la fiabilité des résultats des benchmarks grâce à des tests et une validation rigoureux.",
		...
		careersHeader: {
			careers: "Carrières",
			joinOurMission: "Rejoignez notre mission pour rendre l'internationalisation rapide, simple et performante pour tous.",
		...
		teamGrid: {
			...
			developerAdvocate: "Évangéliste développeur",
			elenaKowalski: "Elena Kowalski",
			ensuresStatisticalRigorIn: "Garantit la rigueur statistique de la collecte et de l'analyse des données.",
			...
			formerGoogleEngineerWith: "Ancienne ingénieure Google, passionnée par les performances web et l'open source.",
			...
			founderLeadEngineer: "Fondatrice et ingénieure principale",
			fullStackDeveloper: "Développeur full-stack",
			maintainsTheBenchmarkingInfrastructure: "Maintient l'infrastructure de benchmark et les pipelines CI/CD.",
			...
			managesCommunityContributions: "Pilote les contributions communautaires et la visibilité open source.",
			...
			marcusWeber: "Marcus Weber",
			passionateAboutDeveloperExperience: "Passionnée par l'expérience développeur et la conception d'API intuitives.",
			...
			sarahChen: "Sarah Chen",
			specializesInJavascriptPerformance: "Spécialisé dans l'optimisation des performances JavaScript et le fonctionnement interne de React.",
		...
		"header.settings": "Paramètres",
		"header.team": "Équipe",
		mockBanner: { mockBanner: "⚠️ Cette page contient des données factices à des fins de benchmarking uniquement. Elle n'est liée à aucune entreprise ou service réel." },
		readMore: "Read More",
		saveChanges: "Save Changes",
		"themeToggle.themeAuto": "Thème : Auto",
		"themeToggle.themeDark": "Thème : Sombre",
		...
		careers: {
			...
			"careersBenefits.topOfMarket": "Rémunération au plus haut du marché",
			"careersBenefits.openSourceTime": "Temps consacré à l'open source",
			"careersBenefits.twentyPercentTime": "20 % du temps pour des contributions open source",
			"careersPositions.seniorFrontendEngineer": "Ingénieur frontend senior",
			"careersPositions.seniorFrontendEngineerDesc": "Concevoir et maintenir notre suite de benchmarking et l'infrastructure applicative centrale.",
			"openPositions.openPositions": "Postes ouverts",
			"openPositions.remote": "Télétravail",
			"openPositions.fullTime": "Temps plein",
			"openPositions.engineering": "Ingénierie",
			"openPositions.applyNow": "Postuler"
		},
		pricingHeader: {
			pricing: "Tarifs",
		...
		careersBenefits: {
			...
			impactful: "Impactant",
			openSource: "Open source",
			openSourceTime: "Temps consacré à l'open source",
			percentTimeForOss: "20 % du temps pour des contributions open source",
			remoteFirst: "Télétravail d'abord",
			topOfMarketCompensation: "Rémunération au plus haut du marché",
			whyJoinUs: "Pourquoi nous rejoindre ?",
			workFromAnywhere: "Travaillez depuis n'importe où dans le monde",
		...
		whatWeMeasure: {
			...
			duringSsrTranslationDataIsSerialized: "Pendant le SSR, les données de traduction sont sérialisées dans le HTML. Nous mesurons la taille de ce chargement utile et son effet sur le délai d'interactivité (TTI).",
			...
			howFastTheAppCanSwitchFromOne: "À quelle vitesse l'application peut passer d'une langue à l'autre. Nous mesurons le temps de re-rendu et les éventuels délais réseau pour les langues chargées à la demande.",
			...
			howMuchExtraTimeTheLibraryAdds: "Le temps supplémentaire que la bibliothèque ajoute au chargement initial de la page, y compris l'exécution des scripts et le temps de récupération et d'analyse des données de traduction.",
			...
			theAdditionalJavascriptBytes: "Les octets JavaScript supplémentaires que la bibliothèque ajoute à votre build de production. Nous mesurons la bibliothèque elle-même et ses dépendances obligatoires.",
		...
		team: {
			...
			"teamGrid.sarahChen": "Sarah Chen",
			"teamGrid.founderLeadEngineer": "Fondatrice et ingénieure principale",
			...
			"teamGrid.aishaPatel": "Aisha Patel",
			"teamGrid.developerAdvocate": "Évangéliste développeur",
	...
	it: {
		metadata: {
			title: "i18n Benchmark",
			description: "Un benchmark open source per misurare l'impatto reale delle librerie di internazionalizzazione."
		},
		productsGrid: {
		...
		"header.settings": "Impostazioni",
		"header.team": "Team",
		mockBanner: { mockBanner: "⚠️ Questa pagina contiene dati fittizi solo a scopo di benchmarking. Non è correlata ad alcuna attività o servizio reale." },
		readMore: "Read More",
		saveChanges: "Save Changes",
		"themeToggle.themeAuto": "Tema: Auto",
		"themeToggle.themeDark": "Tema: Scuro",
	...
	ja: {
		metadata: {
			title: "i18n Benchmark",
			description: "国際化ライブラリの実世界への影響を測定するオープンソースベンチマーク。"
		},
		productsGrid: {
		...
		"header.settings": "設定",
		"header.team": "チーム",
		mockBanner: { mockBanner: "⚠️ このページにはベンチマークのみを目的とした模擬データが含まれています。実際のビジネスやサービスとは関係ありません。" },
		readMore: "Read More",
		saveChanges: "Save Changes",
		"themeToggle.themeAuto": "テーマ：自動",
		"themeToggle.themeDark": "テーマ：ダーク",
	...
	ko: {
		metadata: {
			title: "i18n Benchmark",
			description: "국제화 라이브러리의 실제 영향을 측정하는 오픈 소스 벤치마크입니다."
		},
		productsGrid: {
		...
		"header.settings": "설정",
		"header.team": "팀",
		mockBanner: { mockBanner: "⚠️ 이 페이지는 벤치마킹 목적으로만 사용되는 모의 데이터를 포함하고 있습니다. 실제 비즈니스나 서비스와는 관련이 없습니다." },
		readMore: "Read More",
		saveChanges: "Save Changes",
		"themeToggle.themeAuto": "테마: 자동",
		"themeToggle.themeDark": "테마: 다크",
	...
	pt: {
		metadata: {
			title: "i18n Benchmark",
			description: "Um benchmark de código aberto para medir o impacto real das bibliotecas de internacionalização."
		},
		productsGrid: {
		...
		"header.settings": "Configurações",
		"header.team": "Equipe",
		mockBanner: { mockBanner: "⚠️ Esta página contém dados fictícios apenas para fins de benchmarking. Não está relacionada com qualquer negócio ou serviço real." },
		readMore: "Read More",
		saveChanges: "Save Changes",
		"themeToggle.themeAuto": "Tema: Auto",
		"themeToggle.themeDark": "Tema: Escuro",
	...
	ru: {
		metadata: {
			title: "i18n Benchmark",
			description: "Открытый бенчмарк для измерения реального влияния библиотек интернационализации."
		},
		productsGrid: {
		...
		"header.settings": "Настройки",
		"header.team": "Команда",
		mockBanner: { mockBanner: "⚠️ Эта страница содержит фиктивные данные только для целей тестирования производительности. Она не связана с каким-либо реальным бизнесом или услугой." },
		readMore: "Read More",
		saveChanges: "Save Changes",
		"themeToggle.themeAuto": "Тема: Авто",
		"themeToggle.themeDark": "Тема: Темная",
	...
	zh: {
		metadata: {
			title: "i18n Benchmark",
			description: "用于衡量国际化库实际影响的开源基准测试。"
		},
		productsGrid: {
		...
		"header.settings": "设置",
		"header.team": "团队",
		mockBanner: { mockBanner: "⚠️ 此页面仅包含用于基准测试的模拟数据。它与任何真实的业务或服务无关。" },
		readMore: "Read More",
		saveChanges: "Save Changes",
		"themeToggle.themeAuto": "主题：自动",
		"themeToggle.themeDark": "主题：深色",
...
function Tn() {
	return Yt().use(He()).updateDefaults({ staticData: Object.fromEntries(wn.map((e) => [e, () => Promise.resolve(Cn(e))])) });
}
var En = Tn().init(), Dn = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
		let { unsubscribe: e } = En.on("permanentChange", () => {
			r.refresh();
		});
		return () => {
			e();
...
function An({ children: e, locale: t, staticData: n }) {
