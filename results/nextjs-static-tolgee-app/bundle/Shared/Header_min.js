...
import ee from "../i18n/locales/ru.json";
import te from "../i18n/locales/zh.json";
var ne = (e) => /^https?:\/\//.test(e ?? "");
function C(e, t) {
	return !e.startsWith("/") || e === `/${t}` || e.startsWith(`/${t}/`) ? e : `/${t}${e === "/" ? "" : e}`;
}
var w = ({ href: e, children: t, ...n }) => {
	let r = u().locale ?? "en";
	return e == null || typeof e != "string" || ne(e) ? p(l, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, re = Object.defineProperty, ie = Object.getOwnPropertySymbols, ae = Object.prototype.hasOwnProperty, oe = Object.prototype.propertyIsEnumerable, se = (e, t, n) => t in e ? re(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function R(e, t) {
	...
	return n.apiUrl = j(n.apiUrl), e?.fetch && (n.fetch = _e(e.fetch)), {
		initialOptions: n,
...
function Oe(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return D(s.onError, (e) => new Se("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
		if (!l.languageDetector) return;
		let e = n();
		return D(s.onError, (e) => new xe("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let w = Object.freeze({
		...
		setStoredLanguage(e) {
			return D(s.onError, (e) => new Se("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = Te(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = me(e) || I, r = t().onFormatError, a = typeof r;
...
function ke(e, t, n) {
	let r = R(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? A([t, ...pe(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
function Ae(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = Te(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
function je({ options: e }) {
	let t = ye(), n = z(!1, () => o.isFetching(), t.onFetchingChange.emit), r = z(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ke(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = Oe(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = we(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Ne = () => {
	let e = {
		...
		init(t) {
			let n = Me(L(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, Pe = 0, V = 1, Fe = 2, Ie = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Pe ? r = "Empty parameter" : e === V ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Le(e) {
	return /\s/.test(e);
}
var H = 0, U = 1, W = 2, G = 3, K = 4, Re = new Set([
	W,
	U,
	H
]), q = "'", ze = new Set([
...
function Ve(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case H:
			...
			break;
		case U:
			ze.has(i) ? (n = n.slice(0, -1) + i, t = W) : (n += i, t = H);
			break;
		case W:
			i === q ? t = H : (n += i, t = W);
			break;
		case G:
			i === "}" ? (d(), t = H) : Le(i) ? r !== "" && (d(), t = K) : (u(), t = G);
			break;
		case K: i == "}" ? t = H : Le(i) ? t = K : c(V);
	}
	return Re.has(t) || c(Fe), l(), [a, o];
}
function He(e, t) {
	let [n, r] = Ve(e), i = [n[0]];
...
function Ue() {
	return { format: ({ translation: e, params: t }) => He(e, t) };
}
var We = () => (e, t) => (t.setFinalFormatter(Ue()), e), Ge = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Ke = {};
(function(e) {
	function t(e, t) {
		var n;
...
function Ye({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var Ze = "tolgee-in-context-tools.umd.min.js", Qe = "@tolgee/in-context-tools", $e = "InContextTools", et = "https://cdn.jsdelivr.net/npm";
function tt(e) {
...
var nt = null;
function rt(e) {
	return nt ||= tt(`${et}/@tolgee/web@${e}/dist/${Ze}`).then(() => window[Qe][$e]), nt;
}
var it = "__tolgee_apiKey", J = "__tolgee_apiUrl", at = "__tolgee_branch";
function ot() {
	let e = sessionStorage.getItem(it) || void 0, t = sessionStorage.getItem(J) || void 0, n = sessionStorage.getItem(at) || void 0;
	if (!(!e || !t)) return ce({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function st() {
	sessionStorage.removeItem(it), sessionStorage.removeItem(J), sessionStorage.removeItem(at);
}
function ct(e) {
...
var pt = { useSuspense: !1 }, mt, ht = () => (mt ||= e.createContext(void 0), mt), Y = void 0, gt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = ft(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, pt), r), h = ht();
...
var yt = () => {
	...
	let { tolgee: r, options: a } = yt(), o = fe(e), c = k(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = bt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var X = (t) => {
	let n = Ct(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, Tt(t))) : Tt(n);
}, Et = (t) => {
	...
	let { t: n } = xt();
	return e.createElement(Et, Object.assign({ t: n }, t));
}, Ot = (e) => {
	let { tolgee: t } = yt(), { rerender: n } = bt();
	return i(() => {
...
function Pt() {
	let e = Ot(["language"]), t = e.getLanguage() || "en", n = f(), r = d(), i = (t) => {
		document.cookie = `NEXT_LOCALE=${t}; path=/; max-age=31536000`, e.changeLanguage(t);
		let i = r.split("/");
		i[1] = t;
		let a = i.join("/") || `/${t}`;
		console.log("newPath", a), n.push(a);
	};
	return p("div", {
		...
		children: m("nav", {
			...
			children: [m("div", {
				...
				children: [p(w, {
					...
					children: p(Z, {
						keyName: "header.brandShort",
						defaultValue: "i18n Bench"
					})
				}), m("div", {
					...
					children: [
						p(w, {
							href: "/",
							className: `nav-link${((e) => r === C(e, i))("/") ? " is-active" : ""}`,
							children: p(Z, {
								keyName: "header.home",
								defaultValue: "Home"
							})
...
function Bt() {
	return ut().use(We()).updateDefaults({ staticData: Object.fromEntries(zt.map((e) => [e, () => Promise.resolve(Rt(e))])) });
}
var $ = Bt().init(), Vt = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
...
function Wt({ children: e, locale: t, staticData: n }) {
