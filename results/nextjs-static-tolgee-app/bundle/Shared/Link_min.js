...
function Se({ options: e }) {
	let t = de(), n = ve(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ve(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ye(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = _e(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = pe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Wt = { useSuspense: !1 }, Gt, Kt = () => (Gt ||= e.createContext(void 0), Gt), $ = void 0, qt = ({ tolgee: r, options: i, children: o, fallback: s, ssr: c }) => {
	n(() => {
	...
	l = Ut(r, u, d, !!c);
	let [f, p] = a(!l.isLoaded()), m = Object.assign(Object.assign({}, Wt), i), h = Kt();
...
function Zt() {
	return Vt().use(Fe()).updateDefaults({ staticData: Object.fromEntries(Xt.map((e) => [e, () => Promise.resolve(Yt(e))])) });
}
var Qt = Zt().init(), $t = ({ language: e, staticData: t, children: r }) => {
	let i = c();
	return n(() => {
		let { unsubscribe: e } = Qt.on("permanentChange", () => {
			i.refresh();
		});
		return () => {
			e();
...
function nn({ children: e, locale: t, staticData: i }) {
