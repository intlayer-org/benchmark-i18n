...
var y = (e) => /^https?:\/\//.test(e ?? "");
function b(e, t) {
	return !e.startsWith("/") || e === `/${t}` || e.startsWith(`/${t}/`) ? e : `/${t}${e === "/" ? "" : e}`;
}
var x = ({ href: e, children: t, ...n }) => {
	let r = s().locale ?? "en";
	return e == null || typeof e != "string" || y(e) ? l(o, {
		href: e,
		prefetch: !1,
		...n,
		children: t
...
}, S = Object.defineProperty, C = Object.getOwnPropertySymbols, ee = Object.prototype.hasOwnProperty, te = Object.prototype.propertyIsEnumerable, w = (e, t, n) => t in e ? S(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function ye(e, t) {
	let n = B(ve, t?.initialOptions, e);
	return n.apiUrl = se(n.apiUrl), e?.fetch && (n.fetch = M(e.fetch)), {
		initialOptions: n,
	...
	let T = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ce(e) || z, r = t().onFormatError, a = typeof r;
...
function Ce({ options: e }) {
	let t = fe(), n = V(!1, () => o.isFetching(), t.onFetchingChange.emit), r = V(!1, () => S.isLoading(), t.onLoadingChange.emit), i = xe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = be(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = he(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Te = () => {
	let e = {
		...
		init(t) {
			let n = we(B(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, U = 0, W = 1, Ee = 2, De = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var K = 0, q = 1, J = 2, Y = 3, X = 4, Oe = new Set([
	J,
	q,
	K
]), Z = "'", ke = new Set([
...
function je(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case K:
			...
			break;
		case q:
			ke.has(i) ? (n = n.slice(0, -1) + i, t = J) : (n += i, t = K);
			break;
		case J:
			i === Z ? t = K : (n += i, t = J);
			break;
...
(ne = console.assert) == null || ne.call(console, Le), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Re(e, t) {
	let n = (n) => {
...
var Je = "__tolgee_apiKey", Ye = "__tolgee_apiUrl", Xe = "__tolgee_branch";
function Ze() {
	let e = sessionStorage.getItem(Je) || void 0, t = sessionStorage.getItem(Ye) || void 0, n = sessionStorage.getItem(Xe) || void 0;
	if (!(!e || !t)) return T({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Qe() {
	sessionStorage.removeItem(Je), sessionStorage.removeItem(Ye), sessionStorage.removeItem(Xe);
}
function $e(e) {
...
function rt(e, t, r, o = !0) {
	let [s] = a(() => nt(e)), [c, l] = a(o);
	return n(() => {
		l(!1);
	}, []), i(() => {
...
var it = { useSuspense: !1 }, at, ot = () => (at ||= e.createContext(void 0), at), Q = void 0, st = ({ tolgee: r, options: i, children: o, fallback: s, ssr: c }) => {
	n(() => {
	...
	l = rt(r, u, d, !!c);
	let [f, p] = a(!l.isLoaded()), m = Object.assign(Object.assign({}, it), i), h = ot();
...
function dt() {
	return tt().use(Pe()).updateDefaults({ staticData: Object.fromEntries(ut.map((e) => [e, () => Promise.resolve(lt(e))])) });
}
var $ = dt().init(), ft = ({ language: e, staticData: t, children: r }) => {
	let i = c();
	return n(() => {
...
function ht({ children: e, locale: t, staticData: i }) {
