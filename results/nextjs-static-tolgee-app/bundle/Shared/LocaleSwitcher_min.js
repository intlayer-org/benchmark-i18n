...
var b = Object.defineProperty, x = Object.getOwnPropertySymbols, S = Object.prototype.hasOwnProperty, C = Object.prototype.propertyIsEnumerable, w = (e, t, n) => t in e ? b(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function ve(e, t) {
	...
	return n.apiUrl = N(n.apiUrl), e?.fetch && (n.fetch = se(e.fetch)), {
		initialOptions: n,
...
function ye(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return k(s.onError, (e) => new fe("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function C() {
		if (!l.languageDetector) return;
		let e = n();
		return k(s.onError, (e) => new de("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function w(e) {
		e && l.backends.push(e);
	}
	...
	let E = Object.freeze({
		...
		setStoredLanguage(e) {
			return k(s.onError, (e) => new fe("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function be(e, t, n) {
	let r = ve(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? M([t, ...re(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
function Se({ options: e }) {
	let t = le(), n = B(!1, () => o.isFetching(), t.onFetchingChange.emit), r = B(!1, () => S.isLoading(), t.onLoadingChange.emit), i = be(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ye(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = me(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var we = () => {
	let e = {
		...
		init(t) {
			let n = Ce(z(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, H = 0, U = 1, Te = 2, Ee = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var G = 0, K = 1, q = 2, J = 3, Y = 4, De = new Set([
	q,
	K,
	G
]), X = "'", Oe = new Set([
...
function Ae(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case G:
			...
			break;
		case K:
			Oe.has(i) ? (n = n.slice(0, -1) + i, t = q) : (n += i, t = G);
			break;
		case q:
			i === X ? t = G : (n += i, t = q);
			break;
...
var nt = { useSuspense: !1 }, rt, it = () => (rt ||= e.createContext(void 0), rt), Q = void 0, at = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
...
function pt() {
	let e = ut(["language"]), t = e.getLanguage() || "en", n = l(), r = c(), i = (t) => {
...
function _t() {
	return $e().use(Ne()).updateDefaults({ staticData: Object.fromEntries(gt.map((e) => [e, () => Promise.resolve(ht(e))])) });
}
var $ = _t().init(), vt = ({ language: e, staticData: t, children: n }) => {
	let r = l();
	return i(() => {
...
function xt({ children: e, locale: t, staticData: n }) {
