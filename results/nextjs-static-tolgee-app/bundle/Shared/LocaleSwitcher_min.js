...
var Fe = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, K = {};
(function(e) {
	function t(e, t) {
...
(b = console.assert) == null || b.call(console, Ie), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Le(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, Ke = 3e3, qe = 200, Je = 0, Y = /* @__PURE__ */ new Map(), Ye = !1, X, Z;
...
var Ze = (e) => new J("unavailable", `the Tolgee browser extension did not answer ${e} in time`), Qe = () => `${Date.now()}-${Je++}-${Math.random()}`;
function $e() {
...
function et(e) {
	return X ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Ue }, window.origin), i = () => {
			clearInterval(a), tt(), Z = void 0, n(new J("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Ht = { useSuspense: !1 }, Ut, Wt = () => (Ut ||= e.createContext(void 0), Ut), $ = void 0, Gt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = Vt(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, Ht), r), h = Wt();
...
function Zt() {
	let e = Jt(["language"]), t = e.getLanguage() || "en", n = l(), r = c(), i = (t) => {
		e.changeLanguage(t);
		let i = r.split("/");
		i[1] = t;
		let a = i.join("/") || `/${t}`;
...
function tn() {
	return zt().use(Ne()).updateDefaults({ staticData: Object.fromEntries(en.map((e) => [e, () => Promise.resolve($t(e))])) });
}
var nn = tn().init(), rn = ({ language: e, staticData: t, children: n }) => {
	let r = l();
	return i(() => {
		let { unsubscribe: e } = nn.on("permanentChange", () => {
			r.refresh();
		});
		return () => {
			e();
...
function sn({ children: e, locale: t, staticData: n }) {
