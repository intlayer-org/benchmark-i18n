...
var Wt = { useSuspense: !1 }, Gt, Z = () => (Gt ||= e.createContext(void 0), Gt), Q = void 0, Kt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = Ut(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, Wt), r), h = Z();
	...
	let { tolgee: r, options: a } = qt(), o = E(e), c = D(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Jt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var nn = () => l("div", {
	...
	children: l(tn, { keyName: "common.mockBanner" })
}), rn = {
	de: {
		metadata: {
...
function sn() {
	return Vt().use(Pe()).updateDefaults({ staticData: Object.fromEntries(on.map((e) => [e, () => Promise.resolve(an(e))])) });
}
var cn = sn().init(), ln = ({ language: e, staticData: t, children: n }) => {
	let r = u();
	return i(() => {
