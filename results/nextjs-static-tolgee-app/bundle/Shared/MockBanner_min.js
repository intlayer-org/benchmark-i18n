...
function St() {
	return et().use(Ne()).updateDefaults({ staticData: Object.fromEntries(xt.map((e) => [e, () => Promise.resolve(bt(e))])) });
}
var $ = St().init(), Ct = ({ language: e, staticData: t, children: n }) => {
	let r = u();
	return i(() => {
...
function Et({ children: e, locale: t, staticData: n }) {
