...
}, P = (e) => Object.fromEntries(me(e).entries()), F = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function we({ options: e }) {
	let t = ue(), n = xe(!1, () => o.isFetching(), t.onFetchingChange.emit), r = xe(!1, () => S.isLoading(), t.onLoadingChange.emit), i = Se(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = be(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = he(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Ee = () => {
	let e = {
		...
		init(t) {
			let n = Te(R(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, De = 0, B = 1, Oe = 2, ke = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === De ? r = "Empty parameter" : e === B ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function V(e) {
	return /\s/.test(e);
}
var H = 0, U = 1, W = 2, G = 3, K = 4, Ae = new Set([
	W,
	U,
	H
]), q = "'", je = new Set([
...
var ot = { useSuspense: !1 }, st, ct = () => (st ||= e.createContext(void 0), st), J = void 0, lt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
...
var ft = () => {
	...
	let { tolgee: r, options: a } = ft(), o = re(e), c = A(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = pt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
