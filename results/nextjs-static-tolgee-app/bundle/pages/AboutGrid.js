	...
	return jsxs("div", {
		...
		children: [jsxs("div", {
			...
			children: [jsx("h2", {
				...
				children: jsx(T, { keyName: "aboutGrid.whyThisExists" })
			}), jsx("p", {
				className: "text-sm text-muted-foreground",
				children: jsx(T, { keyName: "aboutGrid.choosingAnI18nLibrary" })
			})]
		}), jsxs("div", {
			className: "rounded-lg border border-border bg-card p-6",
			children: [jsx("h2", {
				className: "mb-3 text-xl font-semibold text-foreground",
				children: jsx(T, { keyName: "aboutGrid.methodology" })
			}), jsx("p", {
				className: "text-sm text-muted-foreground",
				children: jsx(T, { keyName: "aboutGrid.theSame10PageApp" })
			})]
		})]
	});
}
