...
var Ee = () => {
	...
	return t;
}, I = 0, L = 1, De = 2, Oe = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
	...
	return u("div", {
		...
		children: [u("div", {
			...
			children: [l("h2", {
				...
				children: l($, { keyName: "aboutGrid.whyThisExists" })
			}), l("p", {
				className: "text-sm text-muted-foreground",
				children: l($, { keyName: "aboutGrid.choosingAnI18nLibrary" })
			})]
		}), u("div", {
			className: "rounded-lg border border-border bg-card p-6",
			children: [l("h2", {
				className: "mb-3 text-xl font-semibold text-foreground",
				children: l($, { keyName: "aboutGrid.methodology" })
			}), l("p", {
				className: "text-sm text-muted-foreground",
				children: l($, { keyName: "aboutGrid.theSame10PageApp" })
			})]
		})]
	});
}
...
function cn() {
	return Ht().use(Ie()).updateDefaults({ staticData: Object.fromEntries(sn.map((e) => [e, () => Promise.resolve(on(e))])) });
}
