...
(te = console.assert) == null || te.call(console, ze), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Be(e, t) {
	let n = (n) => {
...
var dt = () => {
	...
	let { tolgee: r, options: a } = dt(), o = ie(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = ft(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function xt() {
	return bt("AboutHeader"), d(l, { children: [u("h1", {
