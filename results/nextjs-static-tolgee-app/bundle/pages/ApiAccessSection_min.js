	...
	let O = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = re(e) || I, r = t().onFormatError, a = typeof r;
...
var Kt = { useSuspense: !1 }, qt, Jt = () => (qt ||= e.createContext(void 0), qt), Z = void 0, Yt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	...
	let { tolgee: r, options: a } = Xt(), o = O(e), s = k(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Zt(), f = c([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function an() {
	...
	return d("section", {
		...
		children: [u("h2", {
			...
			children: u($, { keyName: "apiAccessSection.apiAccess" })
		}), d("div", { children: [
			u("label", {
				htmlFor: e,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: u($, { keyName: "apiAccessSection.apiKey" })
			}),
			d("div", {
				...
				children: [u("input", {
					...
					children: u($, { keyName: "common.copy" })
				})]
			}),
			u("p", {
				className: "mt-1 text-xs text-muted-foreground",
				children: u($, { keyName: "apiAccessSection.useThisKeyTo" })
			})
		] })]
	});
}
...
function ln() {
	return Ut().use(Ie()).updateDefaults({ staticData: Object.fromEntries(cn.map((e) => [e, () => Promise.resolve(sn(e))])) });
}
