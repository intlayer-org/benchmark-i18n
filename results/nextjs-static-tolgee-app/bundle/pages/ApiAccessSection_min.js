...
var ft = () => {
	...
	let { tolgee: r, options: a } = ft(), o = ie(e), s = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = pt(), f = c([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function wt() {
	return it().use(Le()).updateDefaults({ staticData: Object.fromEntries(Ct.map((e) => [e, () => Promise.resolve(St(e))])) });
}
var $ = wt().init(), Tt = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
