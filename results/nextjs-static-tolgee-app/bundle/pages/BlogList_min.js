...
var Te = () => {
	...
	return t;
}, H = 0, U = 1, Ee = 2, De = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var W = 0, G = 1, K = 2, q = 3, J = 4, ke = new Set([
	K,
	G,
	W
]), Y = "'", Ae = new Set([
...
function Me(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case W:
			...
			break;
		case G:
			Ae.has(i) ? (n = n.slice(0, -1) + i, t = K) : (n += i, t = W);
			break;
		case K:
			i === Y ? t = W : (n += i, t = K);
			break;
		case q:
			i === "}" ? (d(), t = W) : Oe(i) ? r !== "" && (d(), t = J) : (u(), t = q);
			break;
		case J: i == "}" ? t = W : Oe(i) ? t = J : c(U);
	}
...
var Fe = () => (e, t) => (t.setFinalFormatter(Pe()), e), Ie = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Le = {};
(function(e) {
	function t(e, t) {
		var n;
...
(T = console.assert) == null || T.call(console, Re), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function ze(e, t) {
	let n = (n) => {
...
function Be({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var He = "tolgee-in-context-tools.umd.min.js", Ue = "@tolgee/in-context-tools", We = "InContextTools", Ge = "https://cdn.jsdelivr.net/npm";
function Ke(e) {
...
var qe = null;
function Je(e) {
	return qe ||= Ke(`${Ge}/@tolgee/web@${e}/dist/${He}`).then(() => window[Ue][We]), qe;
}
var Ye = "__tolgee_apiKey", Xe = "__tolgee_apiUrl", Ze = "__tolgee_branch";
function Qe() {
	let e = sessionStorage.getItem(Ye) || void 0, t = sessionStorage.getItem(Xe) || void 0, n = sessionStorage.getItem(Ze) || void 0;
	if (!(!e || !t)) return te({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function $e() {
	sessionStorage.removeItem(Ye), sessionStorage.removeItem(Xe), sessionStorage.removeItem(Ze);
}
function et(e) {
...
var at = { useSuspense: !1 }, ot, st = () => (ot ||= e.createContext(void 0), ot), X = void 0, ct = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = it(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, at), r), h = st();
...
var dt = () => {
	...
	let { tolgee: r, options: a } = dt(), o = A(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = ft(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function Et() {
	return nt().use(Fe()).updateDefaults({ staticData: Object.fromEntries(Tt.map((e) => [e, () => Promise.resolve(wt(e))])) });
}
var Q = Et().init(), Dt = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
...
function At({ children: e, locale: t, staticData: n }) {
