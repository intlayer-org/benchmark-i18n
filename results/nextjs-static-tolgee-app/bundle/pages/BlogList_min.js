...
function ve(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return T(s.onError, (e) => new pe("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function C() {
		if (!l.languageDetector) return;
		let e = n();
		return T(s.onError, (e) => new fe("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function E(e) {
		e && l.backends.push(e);
	}
	...
	let O = Object.freeze({
		...
		setStoredLanguage(e) {
			return T(s.onError, (e) => new pe("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = re(e) || P, r = t().onFormatError, a = typeof r;
...
var we = () => {
	...
	return t;
}, Te = 0, R = 1, Ee = 2, De = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Te ? r = "Empty parameter" : e === R ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Oe(e) {
	return /\s/.test(e);
		...
		children: t.map((e) => u("article", {
			...
			children: [
				...
				u("button", {
					...
					children: [l(on, { keyName: "common.readMore" }), " →"]
				})
			]
		}, e.title))
	});
...
function un() {
	return Ht().use(Fe()).updateDefaults({ staticData: Object.fromEntries(ln.map((e) => [e, () => Promise.resolve(cn(e))])) });
}
