		...
		children: [
			d("div", {
				...
				children: [d("div", { children: [u("label", {
					...
					children: u($, { keyName: "contactForm.name" })
				}), u("input", {
					id: t,
					...
					htmlFor: n,
					className: "mb-1 block text-sm font-medium text-foreground",
					children: u($, { keyName: "contactForm.email" })
				}), u("input", {
					id: n,
					type: "email",
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			d("div", { children: [u("label", {
				htmlFor: r,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: u($, { keyName: "contactForm.topic" })
			}), d("select", {
				id: r,
			...
			d("div", { children: [u("label", {
				htmlFor: i,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: u($, { keyName: "contactForm.message" })
			}), u("textarea", {
				id: i,
				rows: 5,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			u("button", {
				...
				children: u($, { keyName: "contactForm.sendMessage" })
			})
		]
	});
}
