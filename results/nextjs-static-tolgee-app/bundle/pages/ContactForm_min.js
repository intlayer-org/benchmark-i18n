...
(ne = console.assert) == null || ne.call(console, Be), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ve(e, t) {
	let n = (n) => {
...
var st = { useSuspense: !1 }, ct, Y = () => (ct ||= e.createContext(void 0), ct), X = void 0, lt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	...
	c = ot(n, u, d, !!s);
	let [f, p] = l(!c.isLoaded()), m = Object.assign(Object.assign({}, st), r), h = Y();
...
var ft = () => {
	...
	let { tolgee: r, options: a } = ft(), o = ae(e), s = A(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = pt(), f = c([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function Et() {
	return it().use(Le()).updateDefaults({ staticData: Object.fromEntries(Tt.map((e) => [e, () => Promise.resolve(wt(e))])) });
}
