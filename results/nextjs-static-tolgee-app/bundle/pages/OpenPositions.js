	...
	const openings = [
		{
			...
			desc: t("openPositions.buildAndMaintainOur")
		},
		{
			...
			type: t("openPositions.fullTime"),
			dept: t("openPositions.engineering"),
			desc: t("openPositions.designAndScaleOur")
		},
		{
			...
			desc: t("openPositions.createComprehensiveGuidesApi")
		},
		{
			...
			desc: t("openPositions.engageWithTheI18n")
		},
		{
			...
			type: t("openPositions.fullTime"),
			dept: t("openPositions.engineering"),
			desc: t("openPositions.ensureTheAccuracyAnd")
		}
	];
	return jsxs(Fragment, { children: [jsx("h2", {
		className: "mb-6 text-2xl font-bold text-foreground",
		children: jsx(T, { keyName: "openPositions.openPositions" })
	}), jsx("div", {
		className: "space-y-4",
		children: openings.map((o) => jsxs("div", {
			...
			children: [jsxs("div", { children: [
				...
				children: jsx(T, { keyName: "openPositions.applyNow" })
			})]
		}, o.title))
	})] });
}
