...
var S = Object.defineProperty, C = Object.getOwnPropertySymbols, ee = Object.prototype.hasOwnProperty, te = Object.prototype.propertyIsEnumerable, w = (e, t, n) => t in e ? S(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
	...
	if (C) for (var n of C(t)) te.call(t, n) && w(e, n, t[n]);
	return e;
}, ne;
function re(e, t) {
...
function be(e, t) {
	...
	return n.apiUrl = se(n.apiUrl), e?.fetch && (n.fetch = de(e.fetch)), {
		initialOptions: n,
...
function xe(e, t, n, r, i, a, o, s) {
	...
	function C() {
		...
		let e = n();
		return O(s.onError, (e) => new me("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function ee(e) {
		e && l.backends.push(e);
	}
	...
	let T = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ce(e) || R, r = t().onFormatError, a = typeof r;
...
var De = () => {
	...
	return t;
}, V = 0, H = 1, Oe = 2, ke = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var W = 0, G = 1, K = 2, q = 3, J = 4, Ae = new Set([
	K,
	G,
	W
]), Y = "'", je = new Set([
...
function Ne(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case W:
			...
			break;
		case G:
			je.has(i) ? (n = n.slice(0, -1) + i, t = K) : (n += i, t = W);
			break;
		case K:
			i === Y ? t = W : (n += i, t = K);
			break;
...
(ne = console.assert) == null || ne.call(console, ze), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Be(e, t) {
	let n = (n) => {
...
var ot = { useSuspense: !1 }, st, X = () => (st ||= e.createContext(void 0), st), Z = void 0, ct = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = at(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, ot), r), h = X();
...
var dt = () => {
	...
	let { tolgee: r, options: a } = dt(), o = ae(e), c = A(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = ft(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function Et() {
	return rt().use(Ie()).updateDefaults({ staticData: Object.fromEntries(Tt.map((e) => [e, () => Promise.resolve(wt(e))])) });
}
var $ = Et().init(), Dt = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
