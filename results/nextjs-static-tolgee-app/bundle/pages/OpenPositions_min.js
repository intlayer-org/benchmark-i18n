...
function ye(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return T(s.onError, (e) => new P("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
	...
	let D = Object.freeze({
		...
		setStoredLanguage(e) {
			return T(s.onError, (e) => new P("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
var Kt = { useSuspense: !1 }, qt, Jt = () => (qt ||= e.createContext(void 0), qt), Z = void 0, Yt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	...
	let { tolgee: r, options: a } = Xt(), o = D(e), c = O(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Zt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function cn() {
	...
	return d(l, { children: [u("h2", {
		...
		children: u(sn, { keyName: "openPositions.openPositions" })
	}), u("div", {
		className: "space-y-4",
		children: t.map((e) => d("div", {
			...
			children: [d("div", { children: [
				...
				children: u(sn, { keyName: "openPositions.applyNow" })
			})]
		}, e.title))
	})] });
}
...
function fn() {
	return Ut().use(Ie()).updateDefaults({ staticData: Object.fromEntries(dn.map((e) => [e, () => Promise.resolve(un(e))])) });
}
