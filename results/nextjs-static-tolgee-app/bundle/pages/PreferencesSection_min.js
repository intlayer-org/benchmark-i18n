...
var Kt = { useSuspense: !1 }, qt, Jt = () => (qt ||= e.createContext(void 0), qt), Z = void 0, Yt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	...
	c = Gt(n, u, d, !!s);
	let [f, p] = l(!c.isLoaded()), m = Object.assign(Object.assign({}, Kt), r), h = Jt();
	...
	let { tolgee: r, options: a } = Xt(), o = D(e), s = O(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Zt(), f = c([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function dn() {
	return Ut().use(Ie()).updateDefaults({ staticData: Object.fromEntries(un.map((e) => [e, () => Promise.resolve(ln(e))])) });
}
