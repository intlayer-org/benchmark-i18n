...
}, A = (e) => Object.fromEntries(ce(e).entries()), j = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function Se({ options: e }) {
	let t = ue(), n = ye(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ye(!1, () => S.isLoading(), t.onLoadingChange.emit), i = be(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ve(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = pe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var we = () => {
	...
	return t;
}, R = 0, z = 1, Te = 2, Ee = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var B = 0, V = 1, H = 2, U = 3, W = 4, Oe = /* @__PURE__ */ new Set([
	H,
	V,
	B
]), G = "'", ke = /* @__PURE__ */ new Set([
	"{",
	"}",
	G
...
function je(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case B:
			...
			break;
		case V:
			ke.has(i) ? (n = n.slice(0, -1) + i, t = H) : (n += i, t = B);
			break;
		case H:
			i === G ? t = B : (n += i, t = H);
			break;
		case U:
			i === "}" ? (d(), t = B) : De(i) ? r !== "" && (d(), t = W) : (u(), t = U);
			break;
		case W: i == "}" ? t = B : De(i) ? t = W : c(z);
	}
...
var Ie = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, K = {};
(function(e) {
	function t(e, t) {
...
(x = console.assert) == null || x.call(console, Le), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Re(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, qe = 3e3, Je = 200, Ye = 0, Y = /* @__PURE__ */ new Map(), Xe = !1, X, Z;
...
var Qe = (e) => new J("unavailable", `the Tolgee browser extension did not answer ${e} in time`), $e = () => `${Date.now()}-${Ye++}-${Math.random()}`;
function et() {
...
function tt(e) {
	return X ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: We }, window.origin), i = () => {
			clearInterval(a), nt(), Z = void 0, n(new J("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Q = "__tolgee_", yt = `${Q}apiKey`, bt = `${Q}apiUrl`, xt = `${Q}branch`, St = `${Q}projectId`, Ct = `${Q}session`, wt = "tolgee-in-context-tools.umd.min.js", Tt = "@tolgee/in-context-tools", Et = "InContextTools", Dt = "https://cdn.jsdelivr.net/npm", Ot = null;
function kt(e) {
...
function Ft() {
	let e = sessionStorage.getItem(yt) || void 0, t = sessionStorage.getItem(bt) || void 0, n = sessionStorage.getItem(xt) || void 0, r = sessionStorage.getItem(St) || void 0, i = Ke(sessionStorage.getItem(Ct));
	if (!t) return;
	let a = y(y({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return b(y({}, a), { apiKey: e });
	if (i && r) return b(y({}, a), { transport: rt() });
}
function It() {
	let e = [];
...
var Ut = { useSuspense: !1 }, Wt, Gt = () => (Wt ||= e.createContext(void 0), Wt), $ = void 0, Kt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = Ht(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, Ut), r), h = Gt();
	...
	let { tolgee: r, options: a } = qt(), o = D(e), c = O(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Jt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
		...
		children: t.map((e) => u("div", {
			...
			children: [
				...
				l("ul", {
					...
					children: e.features.map((e) => u("li", {
...
function nn() {
	return Bt().use(Pe()).updateDefaults({ staticData: Object.fromEntries(tn.map((e) => [e, () => Promise.resolve(en(e))])) });
}
var rn = nn().init(), an = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
		let { unsubscribe: e } = rn.on("permanentChange", () => {
			r.refresh();
		});
		return () => {
			e();
...
function cn({ children: e, locale: t, staticData: n }) {
