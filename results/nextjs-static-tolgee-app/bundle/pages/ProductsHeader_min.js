...
var p = Object.defineProperty, m = Object.defineProperties, h = Object.getOwnPropertyDescriptors, g = Object.getOwnPropertySymbols, _ = Object.prototype.hasOwnProperty, v = Object.prototype.propertyIsEnumerable, y = (e, t, n) => t in e ? p(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
}, M = (e) => Object.fromEntries(se(e).entries()), N = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function ve(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return E(s.onError, (e) => new fe("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function C() {
		if (!l.languageDetector) return;
		let e = n();
		return E(s.onError, (e) => new de("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function w(e) {
		e && l.backends.push(e);
	}
	...
	let k = Object.freeze({
		...
		setStoredLanguage(e) {
			return E(s.onError, (e) => new fe("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		getBackendDevRecord: async ({ language: e, namespace: n }) => {
			...
			if ((r || i) && a && k.hasDevBackend()) return l.devBackend?.getRecord(Object.assign({
				apiKey: r,
				transport: i,
				apiUrl: a,
				projectId: o,
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ne(e) || I, r = t().onFormatError, a = typeof r;
...
function Ce({ options: e }) {
	let t = le(), n = ye(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ye(!1, () => S.isLoading(), t.onLoadingChange.emit), i = be(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ve(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = pe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Te = () => {
	let e = {
		...
		init(t) {
			let n = we(L(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, Ee = 0, R = 1, De = 2, Oe = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Ee ? r = "Empty parameter" : e === R ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function ke(e) {
	return /\s/.test(e);
}
var z = 0, B = 1, V = 2, H = 3, U = 4, Ae = /* @__PURE__ */ new Set([
	V,
	B,
	z
]), W = "'", je = /* @__PURE__ */ new Set([
	"{",
	"}",
	W
...
function Ne(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case z:
			...
			break;
		case B:
			je.has(i) ? (n = n.slice(0, -1) + i, t = V) : (n += i, t = z);
			break;
		case V:
			i === W ? t = z : (n += i, t = V);
			break;
		case H:
			i === "}" ? (d(), t = z) : ke(i) ? r !== "" && (d(), t = U) : (u(), t = H);
			break;
		case U: i == "}" ? t = z : ke(i) ? t = U : c(R);
	}
...
var Ie = () => (e, t) => (t.setFinalFormatter(Fe()), e);
function Le() {
	return globalThis.window?.document?.createElement === void 0;
}
var Re = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, ze = {};
(function(e) {
	function t(e, t) {
...
(S = console.assert) == null || S.call(console, Be), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ve(e, t) {
	return t ? `${t}: ${e}` : e;
}
var G = class e extends Error {
	constructor(t, n, r) {
		super(Ve(t, n)), this.code = t, this.status = n, this.params = r, Object.setPrototypeOf(this, e.prototype);
	}
};
function He(e) {
	return e instanceof Error && typeof e.code == "string";
}
var Ue = 2, We = 35e3, Ge = "TOLGEE_API_REQUEST", Ke = "TOLGEE_API_RESPONSE", qe = "TOLGEE_PROXY_PING", Je = "TOLGEE_PROXY_PONG";
function Ye(e) {
...
}, Xe = 3e3, Ze = 200, Qe = 0, q = /* @__PURE__ */ new Map(), $e = !1, J, Y;
async function et({ type: e, replyType: t, payload: n, timeoutMs: r = We, progressType: i, onProgress: a }) {
	rt();
	let o = Date.now() + r;
	await it(Math.min(o, Date.now() + Xe));
	let s = o - Date.now();
	if (s <= 0) throw tt(e);
	let c = nt();
	return new Promise((r, o) => {
		let l = setTimeout(() => {
			q.delete(c), at(), o(tt(e));
		}, s);
		q.set(c, {
			replyType: t,
			progressType: i,
...
var tt = (e) => new K("unavailable", `the Tolgee browser extension did not answer ${e} in time`), nt = () => `${Date.now()}-${Qe++}-${Math.random()}`;
function rt() {
	$e || ($e = !0, window.addEventListener("message", (e) => {
		var t;
...
function it(e) {
	return J ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: qe }, window.origin), i = () => {
			clearInterval(a), at(), Y = void 0, n(new K("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var dt = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
function ft(e) {
	let t = dt.indexOf(e);
...
function mt(e) {
	...
	for (let o = 0; o < t; o++) r = r << 5 | ft(e[o]), n += 5, n >= 8 && (a[i++] = r >>> n - 8 & 255, n -= 8);
	return pt(a.buffer);
}
function ht(e) {
	if (e) try {
...
function _t(e) {
	...
	return r ? {
		...
		hasCredential: !!t,
		projectId: ht(t) ?? n,
		requiresExplicitProject: gt(t) === "tgpat"
	};
}
function vt(e) {
...
function bt({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var X = "__tolgee_", St = `${X}apiKey`, Ct = `${X}apiUrl`, wt = `${X}branch`, Tt = `${X}projectId`, Et = `${X}session`, Dt = "tolgee-in-context-tools.umd.min.js", Ot = "@tolgee/in-context-tools", kt = "InContextTools", At = "https://cdn.jsdelivr.net/npm", jt = null;
function Mt(e) {
	return jt ||= Lt(Nt(e)).then(() => window[Ot][kt]), jt;
}
function Nt(e) {
	return Pt() || `${At}/@tolgee/web@${e}/dist/${Dt}`;
}
function Pt() {
	if (Le()) return;
	let e = window.__TOLGEE_IN_CONTEXT_URL__;
	return It(e, window.location) ? e : void 0;
}
var Ft = (e) => e === "localhost" || e === "127.0.0.1" || e === "::1" || e === "[::1]";
function It(e, t) {
	if (!e || !Ft(t.hostname)) return !1;
	try {
		let n = new URL(e, t.href);
		return n.origin === t.origin || Ft(n.hostname);
	} catch {
		return !1;
	}
}
...
function Rt() {
	let e = sessionStorage.getItem(St) || void 0, t = sessionStorage.getItem(Ct) || void 0, n = sessionStorage.getItem(wt) || void 0, r = sessionStorage.getItem(Tt) || void 0, i = Ye(sessionStorage.getItem(Et));
	if (!t) return;
	let a = b(b({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return x(b({}, a), { apiKey: e });
	if (i && r) return x(b({}, a), { transport: ot() });
}
function zt() {
	let e = [];
...
function Bt(e) {
	if (!e.isDev()) return;
	let { requiresExplicitProject: t, projectId: n } = _t(e.getInitialOptions());
...
(() => {
	...
	return Bt(e), e.on("running", ({ value: e }) => {
		e && Vt(() => {
			t.update(n()).catch(zt);
		});
	}), Rt() && (async () => {
		let e = await Mt("prerelease");
		return (t) => {
			let n = Rt();
...
var Kt = { useSuspense: !1 }, qt, Jt = () => (qt ||= e.createContext(void 0), qt), Z = void 0, Yt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = Gt(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, Kt), r), h = Jt();
	...
	let { tolgee: r, options: a } = Xt(), o = k(e), c = A(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Zt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var an = () => u("div", {
	...
	children: u($, { keyName: "common.mockBanner" })
});
function on() {
	return d(l, { children: [
		u(an, {}),
		u("h1", {
			...
			children: u($, { keyName: "productsHeader.products" })
		}),
		u("p", {
			className: "mb-10 text-muted-foreground",
			children: u($, { keyName: "productsHeader.toolsAndServicesTo" })
		})
	] });
}
var sn = {
...
function un() {
	return Ut().use(Ie()).updateDefaults({ staticData: Object.fromEntries(ln.map((e) => [e, () => Promise.resolve(cn(e))])) });
}
var dn = un().init(), fn = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
		let { unsubscribe: e } = dn.on("permanentChange", () => {
			r.refresh();
		});
		return () => {
			e();
...
function hn({ children: e, locale: t, staticData: n }) {
