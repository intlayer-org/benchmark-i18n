...
function ye(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return E(s.onError, (e) => new pe("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function C() {
		if (!l.languageDetector) return;
		let e = n();
		return E(s.onError, (e) => new fe("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function w(e) {
		e && l.backends.push(e);
	}
	...
	let O = Object.freeze({
		...
		setStoredLanguage(e) {
			return E(s.onError, (e) => new pe("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
var qt = { useSuspense: !1 }, Jt, Yt = () => (Jt ||= e.createContext(void 0), Jt), X = void 0, Xt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	...
	let { tolgee: r, options: a } = Zt(), o = O(e), s = k(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Qt(), f = c([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function ln() {
	return Wt().use(Le()).updateDefaults({ staticData: Object.fromEntries(cn.map((e) => [e, () => Promise.resolve(sn(e))])) });
}
var un = ln().init(), dn = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
