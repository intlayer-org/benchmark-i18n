...
function ResultsTable() {
	...
	return jsxs("section", { children: [jsx("h2", {
		...
		children: jsx(T, { keyName: "resultsTable.sampleResults" })
	}), jsx("div", {
			...
			children: [jsx("thead", {
				...
				children: jsxs("tr", { children: [
					jsx("th", {
						...
						children: jsx(T, { keyName: "resultsTable.library" })
					}),
					jsx("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: jsx(T, { keyName: "resultsTable.bundleSize" })
					}),
					jsx("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: jsx(T, { keyName: "resultsTable.lookupTime" })
					}),
					jsx("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: jsx(T, { keyName: "resultsTable.lazyLoading" })
					})
				] })
