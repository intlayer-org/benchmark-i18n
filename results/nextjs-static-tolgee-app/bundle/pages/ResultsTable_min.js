...
function Ce({ options: e }) {
	let t = fe(), n = B(!1, () => o.isFetching(), t.onFetchingChange.emit), r = B(!1, () => S.isLoading(), t.onLoadingChange.emit), i = xe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = be(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = _e(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var ft = () => {
	...
	let { tolgee: r, options: a } = ft(), o = ie(e), c = A(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = pt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var X = (t) => {
	let n = gt(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, vt(t))) : vt(n);
}, yt = (t) => {
	...
	let { t: n } = mt();
	return e.createElement(yt, Object.assign({ t: n }, t));
};
function xt() {
	let { t: e, ...t } = ht();
	return {
	...
	let { t: e } = xt(), t = [
		{
			...
			size: "42.3 kB",
			time: "0.12ms",
			lazy: e("resultsTable.lazyYes", "Yes")
		},
		{
			lib: "react-intl",
			size: "38.1 kB",
			time: "0.15ms",
			lazy: e("resultsTable.lazyManual", "Manual")
		},
		{
			lib: "lingui",
			size: "12.8 kB",
		...
		},
		{
			...
			size: "5.2 kB",
			time: "0.05ms",
			lazy: e("resultsTable.lazyBuiltIn", "Built-in")
		}
	];
