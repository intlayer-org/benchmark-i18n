...
function sn() {
	...
	return u("section", { children: [l("h2", {
		...
		children: l(Q, { keyName: "resultsTable.sampleResults" })
	}), l("div", {
			...
			children: [l("thead", {
				...
				children: u("tr", { children: [
					l("th", {
						...
						children: l(Q, { keyName: "resultsTable.library" })
					}),
					l("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: l(Q, { keyName: "resultsTable.bundleSize" })
					}),
					l("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: l(Q, { keyName: "resultsTable.lookupTime" })
					}),
					l("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: l(Q, { keyName: "resultsTable.lazyLoading" })
					})
				] })
