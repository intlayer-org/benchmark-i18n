...
function rn() {
	return u("div", {
		...
		children: [l("button", {
			...
			children: l(nn, { keyName: "common.cancel" })
		}), l("button", {
			type: "submit",
			className: "rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity",
			children: l(nn, { keyName: "common.saveChanges" })
		})]
	});
}
var an = {
...
function cn() {
	return Vt().use(Fe()).updateDefaults({ staticData: Object.fromEntries(sn.map((e) => [e, () => Promise.resolve(on(e))])) });
}
