...
var S = Object.defineProperty, C = Object.getOwnPropertySymbols, w = Object.prototype.hasOwnProperty, ee = Object.prototype.propertyIsEnumerable, T = (e, t, n) => t in e ? S(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, E = (e, t) => {
	for (var n in t ||= {}) w.call(t, n) && T(e, n, t[n]);
	if (C) for (var n of C(t)) ee.call(t, n) && T(e, n, t[n]);
	return e;
}, te;
function ne(e, t) {
...
}, F = (e) => Object.fromEntries(he(e).entries()), I = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function be(e, t) {
	...
	return n.apiUrl = oe(n.apiUrl), e?.fetch && (n.fetch = ue(e.fetch)), {
		initialOptions: n,
...
function xe(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return k(s.onError, (e) => new me("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function C() {
		if (!l.languageDetector) return;
		let e = n();
		return k(s.onError, (e) => new pe("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function w(e) {
		e && l.backends.push(e);
	}
	...
	let E = Object.freeze({
		...
		setStoredLanguage(e) {
			return k(s.onError, (e) => new me("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		getBackendDevRecord: async ({ language: e, namespace: n }) => {
			...
			if (!(!r || !i || !E.hasDevBackend())) return l.devBackend?.getRecord(Object.assign({
				apiKey: r,
				apiUrl: i,
				projectId: a,
				branch: o,
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = se(e) || R, r = t().onFormatError, a = typeof r;
...
var Oe = () => {
	...
	return t;
}, B = 0, V = 1, ke = 2, Ae = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var U = 0, W = 1, G = 2, K = 3, q = 4, je = new Set([
	G,
	W,
	U
]), J = "'", Me = new Set([
...
function Pe(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case U:
			...
			break;
		case W:
			Me.has(i) ? (n = n.slice(0, -1) + i, t = G) : (n += i, t = U);
			break;
		case G:
			i === J ? t = U : (n += i, t = G);
			break;
...
var Le = () => (e, t) => (t.setFinalFormatter(Ie()), e), Re = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, ze = {};
(function(e) {
	function t(e, t) {
		var n;
...
(te = console.assert) == null || te.call(console, Be), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ve(e, t) {
	let n = (n) => {
...
function He({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var We = "tolgee-in-context-tools.umd.min.js", Ge = "@tolgee/in-context-tools", Ke = "InContextTools", qe = "https://cdn.jsdelivr.net/npm";
function Je(e) {
...
var Ye = null;
function Xe(e) {
	return Ye ||= Je(`${qe}/@tolgee/web@${e}/dist/${We}`).then(() => window[Ge][Ke]), Ye;
}
var Ze = "__tolgee_apiKey", Qe = "__tolgee_apiUrl", $e = "__tolgee_branch";
function et() {
	let e = sessionStorage.getItem(Ze) || void 0, t = sessionStorage.getItem(Qe) || void 0, n = sessionStorage.getItem($e) || void 0;
	if (!(!e || !t)) return E({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function tt() {
	sessionStorage.removeItem(Ze), sessionStorage.removeItem(Qe), sessionStorage.removeItem($e);
}
function nt(e) {
...
var st = { useSuspense: !1 }, ct, Y = () => (ct ||= e.createContext(void 0), ct), X = void 0, lt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = ot(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, st), r), h = Y();
...
var ft = () => {
	...
	let { tolgee: r, options: a } = ft(), o = ie(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = pt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function Tt() {
	return it().use(Le()).updateDefaults({ staticData: Object.fromEntries(wt.map((e) => [e, () => Promise.resolve(Ct(e))])) });
}
var $ = Tt().init(), Et = ({ language: e, staticData: t, children: n }) => {
	let r = f();
	return i(() => {
