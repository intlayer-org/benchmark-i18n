	...
	return jsxs("section", {
		...
		children: [
			jsx("h2", {
				...
				children: jsx(T, { keyName: "understandingImpact.understandingTheImpact" })
			}),
			jsxs("div", {
				...
				children: [
					jsx("h3", {
						...
						children: jsx(T, { keyName: "understandingImpact.whyASingleLargeJson" })
					}),
					jsx("p", {
						className: "text-sm text-muted-foreground",
						children: jsx(T, { keyName: "understandingImpact.manyI18nLibrariesStore" })
					}),
					jsxs("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							jsx("li", { children: jsx(T, { keyName: "understandingImpact.theJsonMustBeParsed" }) }),
							jsx("li", { children: jsx(T, { keyName: "understandingImpact.contextBasedArchitecturesCan" }) }),
							jsx("li", { children: jsx(T, { keyName: "understandingImpact.duringServerSideRenderingThe" }) })
						]
					})
				]
			}),
			jsxs("div", {
				...
				children: [
					jsx("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: jsx(T, { keyName: "understandingImpact.theTradeOffsOfDynamic" })
					}),
					jsx("p", {
						className: "text-sm text-muted-foreground",
						children: jsx(T, { keyName: "understandingImpact.splittingTranslationsIntoPerRoute" })
					}),
					jsxs("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							jsxs("li", { children: [
								jsx("strong", {
									...
									children: jsx(T, { keyName: "understandingImpact.waterfallRequests" })
								}),
								" ",
								jsx(T, { keyName: "understandingImpact.theAppMustFirstLoad" })
							] }),
							jsxs("li", { children: [
								jsx("strong", {
									className: "text-foreground",
									children: jsx(T, { keyName: "understandingImpact.flashOfUntranslatedContent" })
								}),
								" ",
								jsx(T, { keyName: "understandingImpact.usersMayBrieflySeeTranslation" })
							] }),
							jsxs("li", { children: [
								jsx("strong", {
									className: "text-foreground",
									children: jsx(T, { keyName: "understandingImpact.cacheInvalidation" })
								}),
								" ",
								jsx(T, { keyName: "understandingImpact.updatingTranslationsRequiresCache" })
							] })
						]
					})
				]
			...
			jsxs("div", {
				...
				children: [jsx("h3", {
					className: "mb-2 text-lg font-semibold text-foreground",
					children: jsx(T, { keyName: "understandingImpact.whatThisBenchmarkMeasures" })
				}), jsx("p", {
					className: "text-sm text-muted-foreground",
					children: jsx(T, { keyName: "understandingImpact.thisTestAppProvidesA" })
				})]
			})
		]
	});
...
function TolgeeBase() {
	return Tolgee().use(FormatSimple()).updateDefaults({ staticData: Object.fromEntries(ALL_LOCALES.map((locale) => [locale, () => Promise.resolve(getMessages(locale))])) });
}
