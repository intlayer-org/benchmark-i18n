	...
	return u("section", {
		...
		children: [
			l("h2", {
				...
				children: l($, { keyName: "understandingImpact.understandingTheImpact" })
			}),
			u("div", {
				...
				children: [
					l("h3", {
						...
						children: l($, { keyName: "understandingImpact.whyASingleLargeJson" })
					}),
					l("p", {
						className: "text-sm text-muted-foreground",
						children: l($, { keyName: "understandingImpact.manyI18nLibrariesStore" })
					}),
					u("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							l("li", { children: l($, { keyName: "understandingImpact.theJsonMustBeParsed" }) }),
							l("li", { children: l($, { keyName: "understandingImpact.contextBasedArchitecturesCan" }) }),
							l("li", { children: l($, { keyName: "understandingImpact.duringServerSideRenderingThe" }) })
						]
					})
				]
			}),
			u("div", {
				...
				children: [
					l("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: l($, { keyName: "understandingImpact.theTradeOffsOfDynamic" })
					}),
					l("p", {
						className: "text-sm text-muted-foreground",
						children: l($, { keyName: "understandingImpact.splittingTranslationsIntoPerRoute" })
					}),
					u("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							u("li", { children: [
								l("strong", {
									...
									children: l($, { keyName: "understandingImpact.waterfallRequests" })
								}),
								" ",
								l($, { keyName: "understandingImpact.theAppMustFirstLoad" })
							] }),
							u("li", { children: [
								l("strong", {
									className: "text-foreground",
									children: l($, { keyName: "understandingImpact.flashOfUntranslatedContent" })
								}),
								" ",
								l($, { keyName: "understandingImpact.usersMayBrieflySeeTranslation" })
							] }),
							u("li", { children: [
								l("strong", {
									className: "text-foreground",
									children: l($, { keyName: "understandingImpact.cacheInvalidation" })
								}),
								" ",
								l($, { keyName: "understandingImpact.updatingTranslationsRequiresCache" })
							] })
						]
					})
				]
			...
			u("div", {
				...
				children: [l("h3", {
					className: "mb-2 text-lg font-semibold text-foreground",
					children: l($, { keyName: "understandingImpact.whatThisBenchmarkMeasures" })
				}), l("p", {
					className: "text-sm text-muted-foreground",
					children: l($, { keyName: "understandingImpact.thisTestAppProvidesA" })
				})]
			})
		]
	});
