...
function wt() {
	return rt().use(Ie()).updateDefaults({ staticData: Object.fromEntries(Ct.map((e) => [e, () => Promise.resolve(St(e))])) });
}
var Q = wt().init(), Tt = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
...
function Ot({ children: e, locale: t, staticData: n }) {
