...
}, j = (e) => Object.fromEntries(A(e).entries()), M = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function ve(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return T(s.onError, (e) => new fe("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function C() {
		if (!l.languageDetector) return;
		let e = n();
		return T(s.onError, (e) => new de("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function E(e) {
		e && l.backends.push(e);
	}
	...
	let O = Object.freeze({
		...
		getInitialLanguage() {
			let e = n();
			return w(S(), (t) => (!e || e.includes(t)) && t ? t : C());
		},
		setStoredLanguage(e) {
			return T(s.onError, (e) => new fe("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = re(e) || F, r = t().onFormatError, a = typeof r;
...
function be(e, t, n) {
	let r = _e(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? k([t, ...te(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
var Te = () => {
	...
	return t;
}, L = 0, R = 1, Ee = 2, De = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var z = 0, B = 1, V = 2, H = 3, U = 4, ke = /* @__PURE__ */ new Set([
	V,
	B,
	z
]), W = "'", Ae = /* @__PURE__ */ new Set([
	"{",
	"}",
	W
...
function Me(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case z:
			...
			break;
		case B:
			Ae.has(i) ? (n = n.slice(0, -1) + i, t = V) : (n += i, t = z);
			break;
		case V:
			i === W ? t = z : (n += i, t = V);
			break;
		case H:
			i === "}" ? (d(), t = z) : Oe(i) ? r !== "" && (d(), t = U) : (u(), t = H);
			break;
		case U: i == "}" ? t = z : Oe(i) ? t = U : c(R);
	}
...
(x = console.assert) == null || x.call(console, ze), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Be(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, Ye = 3e3, Xe = 200, Ze = 0, q = /* @__PURE__ */ new Map(), Qe = !1, J, Y;
...
var et = (e) => new K("unavailable", `the Tolgee browser extension did not answer ${e} in time`), tt = () => `${Date.now()}-${Ze++}-${Math.random()}`;
function nt() {
...
function rt(e) {
	return J ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Ke }, window.origin), i = () => {
			clearInterval(a), it(), Y = void 0, n(new K("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var X = "__tolgee_", xt = `${X}apiKey`, St = `${X}apiUrl`, Ct = `${X}branch`, wt = `${X}projectId`, Tt = `${X}session`, Et = "tolgee-in-context-tools.umd.min.js", Dt = "@tolgee/in-context-tools", Ot = "InContextTools", kt = "https://cdn.jsdelivr.net/npm", At = null;
function jt(e) {
...
function Lt() {
	...
	if (!t) return;
	let a = y(y({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return b(y({}, a), { apiKey: e });
	if (i && r) return b(y({}, a), { transport: at() });
}
function Rt() {
	let e = [];
...
var Gt = { useSuspense: !1 }, Kt, qt = () => (Kt ||= e.createContext(void 0), Kt), Z = void 0, Jt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = Wt(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, Gt), r), h = qt();
	...
	let { tolgee: r, options: a } = Yt(), o = D(e), c = O(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Xt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var Q = (t) => {
	let n = Qt(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, en(t))) : en(n);
}, tn = (t) => {
	...
	let { t: n } = Zt();
	return e.createElement(tn, Object.assign({ t: n }, t));
};
function $(e) {
	return l(nn, { ...e });
}
function rn() {
	return u("section", {
		...
		children: [l("h2", {
			...
			children: l($, { keyName: "whyItMatters.whyTheseMetricsMatter" })
		}), u("div", {
			...
			children: [
				u("div", {
					...
					children: [l("h3", {
						...
						children: l($, { keyName: "whyItMatters.bundleSize" })
					}), l("p", {
						className: "text-sm text-muted-foreground",
						children: l($, { keyName: "whyItMatters.theBundleIsTheData" })
					})]
				}),
				u("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [l("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: l($, { keyName: "whyItMatters.renderingHydration" })
					}), l("p", {
						className: "text-sm text-muted-foreground",
						children: l($, { keyName: "whyItMatters.connectingALargeJson" })
					})]
				}),
				u("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [l("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: l($, { keyName: "whyItMatters.dynamicLoading" })
					}), l("p", {
						className: "text-sm text-muted-foreground",
						children: l($, { keyName: "whyItMatters.loadingAllTranslationsUpfront" })
					})]
				})
			]
		})]
...
function cn() {
	return Ht().use(Fe()).updateDefaults({ staticData: Object.fromEntries(sn.map((e) => [e, () => Promise.resolve(on(e))])) });
}
var ln = cn().init(), un = ({ language: e, staticData: t, children: n }) => {
	let r = d();
	return i(() => {
		let { unsubscribe: e } = ln.on("permanentChange", () => {
			r.refresh();
		});
		return () => {
			e();
...
function pn({ children: e, locale: t, staticData: n }) {
