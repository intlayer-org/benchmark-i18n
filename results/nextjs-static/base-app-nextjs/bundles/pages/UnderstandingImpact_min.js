			...
			/* @__PURE__ */ t("div", {
				...
				children: [
					...
					/* @__PURE__ */ t("ul", {
						...
						children: [
							/* @__PURE__ */ e("li", { children: "The JSON must be parsed on every page load — blocking the main thread." }),
							/* @__PURE__ */ e("li", { children: "Context-based architectures can cause cascading re-renders when the locale changes, because every consumer is notified even if their specific keys didn't change." }),
							/* @__PURE__ */ e("li", { children: "During server-side rendering, the full dictionary is serialized into the HTML payload, increasing the document size that must be downloaded and hydrated." })
						]
					})
				]
			}),
			/* @__PURE__ */ t("div", {
				...
				children: [
					...
					/* @__PURE__ */ t("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							/* @__PURE__ */ t("li", { children: [/* @__PURE__ */ e("strong", {
