...
var u = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), d = /* @__PURE__ */ ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
}), f = (e) => /^https?:\/\//.test(e ?? ""), p = ({ href: t, children: n, ...a }) => {
	let o = e().locale ?? "en", s = f(t.toString());
	return /* @__PURE__ */ i(r, {
  ...
  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
	...
	var t = d("react/jsx-runtime"), n = d("react"), r = h(), i = g();
	function a(e) {
	...
	var t = d("react/jsx-runtime"), n = d("react"), r = h(), i = _();
	function a(e) {
		var t = Object.create(null);
		return e && Object.keys(e).forEach(function(n) {
			if (n !== "default") {
...
function w() {
	...
	return /* @__PURE__ */ i("button", {
		...
		children: e === "auto" ? /* @__PURE__ */ i(x.T, { children: "Theme: Auto" }) : e === "dark" ? /* @__PURE__ */ i(x.T, { children: "Theme: Dark" }) : /* @__PURE__ */ i(x.T, { children: "Theme: Light" })
	});
}
//#endregion
...
function E() {
	...
	return /* @__PURE__ */ i("div", {
		...
		children: /* @__PURE__ */ i("select", {
			...
			children: T.map((e) => /* @__PURE__ */ i("option", {
				value: e,
				children: s(e)
			}, e))
		})
...
function O() {
	D("Header");
	let [n, r] = c(!1), o = e().locale ?? "en", s = t(), u = [
		{
			href: "/products",
			label: /* @__PURE__ */ i(x.T, { children: "Products" })
		},
		{
			href: "/pricing",
			label: /* @__PURE__ */ i(x.T, { children: "Pricing" })
		},
		{
			href: "/team",
			label: /* @__PURE__ */ i(x.T, { children: "Team" })
		},
		{
			href: "/blog",
			label: /* @__PURE__ */ i(x.T, { children: "Blog" })
		},
		{
			href: "/careers",
			label: /* @__PURE__ */ i(x.T, { children: "Careers" })
		},
		{
			href: "/faq",
			label: /* @__PURE__ */ i(x.T, { children: "FAQ" })
		},
		{
			href: "/contact",
			label: /* @__PURE__ */ i(x.T, { children: "Contact" })
		},
		{
			href: "/settings",
			label: /* @__PURE__ */ i(x.T, { children: "Settings" })
		}
	];
			...
			children: [/* @__PURE__ */ a("div", {
				...
				children: [/* @__PURE__ */ i(p, {
					...
					children: [
						/* @__PURE__ */ i(p, {
							href: "/",
							className: `nav-link${((e) => s === e)(`/${o}`) ? " is-active" : ""}`,
							children: /* @__PURE__ */ i(x.T, { children: "Home" })
						}),
						/* @__PURE__ */ i(p, {
							href: "/about",
							className: `nav-link${((e) => s.startsWith(e))(`/${o}/about`) ? " is-active" : ""}`,
							children: /* @__PURE__ */ i(x.T, { children: "Methodology" })
						}),
						/* @__PURE__ */ a("div", {
							className: "relative",
							children: [/* @__PURE__ */ a("button", {
								...
								onMouseLeave: () => r(!1),
								onClick: () => r(!n),
								children: [/* @__PURE__ */ i(x.T, { children: "Mock Pages" }), /* @__PURE__ */ i(l, {
									size: 14,
