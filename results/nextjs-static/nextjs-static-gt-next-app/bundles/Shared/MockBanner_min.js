...
var t = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), n = /* @__PURE__ */ ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	function gn(e, t) {
		if (t) {
			for (var n = {}, r = 0, a = e; r < a.length; r++) {
				var o = t[a[r]];
				o && (typeof o == "string" ? n.name ||= o : o && (n = i(i({}, o), n)));
			}
			return n;
		}
	}
	...
	function vn(e, t, n) {
		...
		for (var r = function(e) {
			var n = t.filter(function(t) {
				...
				return null;
			}, o = _n(e), s = o.languageCode, c = a(o, ["languageCode"]), l = r(i({
				locale: e,
				languageCode: s
			}, c)) || r(i({ locale: s }, _n(s)));
			if (l) return { value: l };
		...
		for (var t = {}, n = 0, r = e; n < r.length; n++) {
			...
			switch (a.stem) {
				...
				case "KK":
					...
					continue;
				case "scientific":
					t = i(i(i({}, t), { notation: "scientific" }), a.options.reduce(function(e, t) {
						return i(i({}, e), $n(t));
					}, {}));
					continue;
				case "engineering":
					t = i(i(i({}, t), { notation: "engineering" }), a.options.reduce(function(e, t) {
						return i(i({}, e), $n(t));
					}, {}));
					continue;
			...
			if (Yn.test(a.stem)) t.minimumIntegerDigits = a.stem.length;
				...
				var o = a.options[0];
				o === "w" ? t = i(i({}, t), { trailingZeroDisplay: "stripIfInteger" }) : o && (t = i(i({}, t), Xn(o)));
			} else if (qn.test(a.stem)) t = i(i({}, t), Xn(a.stem));
			else {
				var s = Zn(a.stem);
				s && (t = i(i({}, t), s));
				var c = Qn(a.stem);
		...
		return e.prototype.parse = function() {
			...
			switch (o) {
				...
				case "select":
					...
					if (this.bumpSpace(), !this.bumpIf(",")) return this.error(Q.EXPECT_SELECT_ARGUMENT_OPTIONS, $(m, i({}, m)));
					this.bumpSpace();
	...
	function Lr(e, t) {
		return t ? Object.keys(e).reduce(function(n, r) {
			var a, o;
			return n[r] = (a = e[r], (o = t[r]) ? i(i(i({}, a || {}), o || {}), Object.keys(a).reduce(function(e, t) {
				return e[t] = i(i({}, a[t]), o[t] || {}), e;
			}, {})) : a), n;
		}, i({}, e)) : e;
	}
	function Rr(e) {
	...
	var zr = function() {
		function e(t, n, r, o) {
			...
			if (this.formatterCache = {
				...
				var l = o || {};
				l.formatters;
				var u = a(l, ["formatters"]);
				this.ast = e.__parse(t, i(i({}, u), { locale: this.resolvedLocale }));
			} else this.ast = t;
			if (!Array.isArray(this.ast)) throw TypeError("A message must be provided as a String or AST.");
			this.formats = Lr(e.formats, r), this.formatters = o && o.formatters || ((s = this.formatterCache) === void 0 && (s = {
				number: {},
				dateTime: {},
				pluralRules: {}
			}), {
  ...
  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
	...
	function Yr(e) {
		var t = e.value, n = e.locales, r = n === void 0 ? [z] : n, a = e.options, o = a === void 0 ? {} : a;
		return G.get("ListFormat", r, i({
			type: "conjunction",
			style: "long"
		}, o)).format(t);
	}
	function Xr(e) {
		var t = e.value, n = e.locales, r = n === void 0 ? [z] : n, a = e.options, o = a === void 0 ? {} : a, s = G.get("ListFormat", r, i({
			type: "conjunction",
			style: "long"
	...
	function Qr(e) {
		var t = e.value, n = e.unit, r = e.locales, a = r === void 0 ? [z] : r, o = e.options, s = o === void 0 ? {} : o;
		return G.get("RelativeTimeFormat", a, i({
			style: "long",
			numeric: "auto"
		}, s)).format(t, n);
	}
	...
	function ci(e, t, n) {
		return p(this, void 0, void 0, function() {
			...
			return m(this, function(c) {
				switch (c.label) {
					case 0: r = new AbortController(), a = r.signal, o = (n ||= B) ? setTimeout(function() {
						return r.abort();
					}, n) : null, c.label = 1;
	...
	function pi(e, t) {
		t === void 0 && (t = !1);
		var n = i(i({}, !t && { "Content-Type": "application/json" }), { "x-gt-project-id": e.projectId });
	...
	function vi(e, t) {
		var n, r = e.source, a = e.context, o = e.id, s = e.maxChars, c = e.dataFormat;
		t === void 0 && (t = _i), n = c === "JSX" ? bi(r) : r;
		var l = i(i(i(i({ source: n }, o && { id: o }), a && { context: a }), s != null && { maxChars: Math.abs(s) }), c && { dataFormat: c });
		return t(be(l));
	}
	var yi = function(e) {
				...
				switch (m.label) {
					case 0:
						for (a = Array.isArray(e), o = a ? [] : void 0, s = {}, c = a ? e.map(function(e) {
							return [void 0, e];
						}) : Object.entries(e), l = 0, u = c; l < u.length; l++) d = u[l], f = d[0], p = d[1], g = (h = typeof p == "string" ? { source: p } : p).source, _ = h.metadata, v = f ?? _?.hash ?? vi(i({
							source: g,
						...
						return [4, gi(i(i({}, n), { baseUrl: n.baseUrl || "https://runtime2.gtx.dev" }), "/v2/translate", {
							body: {
								requests: s,
	...
	function Ei(e, t) {
		return p(this, void 0, void 0, function() {
			return m(this, function(n) {
				switch (n.label) {
					case 0: return [4, gi(t, "/v2/project/tags/create", { body: i({
						tagId: e.tagId,
						files: e.files
					...
					return p(r, void 0, void 0, function() {
						...
						return m(this, function(a) {
							switch (a.label) {
								...
								case 1: return r = a.sent(), [2, r.files.map(function(e) {
									return i(i({}, e), { data: le(e.data) });
								})];
							}
						});
					});
	...
	function ki(e, t, n) {
		t === void 0 && (t = z), t ||= z;
		try {
			var r = G.get("DisplayNames", [t, z], { type: "region" });
			return i({
				code: e,
				name: r.of(e) || e,
				emoji: hn[e] || pn
	...
	function Li(e, t, n) {
		return p(this, void 0, void 0, function() {
			var r, a, o, s, c, l, u, d, f, p;
			return m(this, function(m) {
				switch (m.label) {
					case 0:
						if (r = 1e3 * (t?.pollingIntervalSeconds ?? 5), a = t?.timeoutSeconds === void 0 ? 6e5 : 1e3 * t.timeoutSeconds, (o = Object.keys(e.jobData)).length === 0) return [2, {
							complete: !0,
							jobs: []
						}];
					...
					case 2:
						for (u = m.sent(), d = 0, f = u; d < f.length; d++) (p = f[d]).status === "completed" || p.status === "failed" || p.status === "unknown" ? (c.set(p.jobId, i({
							jobId: p.jobId,
							status: p.status
	...
	var Wi = function() {
		...
		return e.prototype.setConfig = function(e) {
			...
			return p(this, void 0, void 0, function() {
				...
				return m(this, function(r) {
					switch (r.label) {
						case 0: return this._validateAuth("setupProject"), t = i(i({}, t), { locales: (t?.locales)?.map(function(e) {
			...
			return p(this, void 0, void 0, function() {
				...
				return m(this, function(o) {
					switch (o.label) {
						case 0:
							if (this._validateAuth("enqueueFiles"), !(n = i(i({}, t), {
								sourceLocale: t.sourceLocale ?? this.sourceLocale,
								targetLocales: t.targetLocales ?? [this.targetLocale]
							})).sourceLocale) throw r = oi("enqueueFiles"), Jr.error(r), Error(r);
							if (!n.targetLocales || n.targetLocales.length === 0) throw r = ai("enqueueFiles"), Jr.error(r), Error(r);
							return n = i(i({}, n), { targetLocales: n.targetLocales.map(function(e) {
			...
			return p(this, void 0, void 0, function() {
				...
				return m(this, function(n) {
					switch (n.label) {
						case 0: return this._validateAuth("submitUserEditDiffs"), [4, Oi(i(i({}, e), { diffs: (e.diffs || []).map(function(e) {
							return i(i({}, e), { locale: t.resolveCanonicalLocale(e.locale) });
				...
				return t === void 0 && (t = {}), m(this, function(a) {
					switch (a.label) {
						case 0: return this._validateAuth("queryFileData"), e.translatedFiles = e.translatedFiles?.map(function(e) {
							return i(i({}, e), { locale: r.resolveCanonicalLocale(e.locale) });
						}), [4, Ri(e, t, this._getTranslationConfig())];
						case 1: return (n = a.sent()).translatedFiles = n.translatedFiles?.map(function(e) {
							return i(i({}, e), e.locale && { locale: r.resolveAliasLocale(e.locale) });
						}), n.sourceFiles = n.sourceFiles?.map(function(e) {
							return i(i(i({}, e), e.sourceLocale && { sourceLocale: r.resolveAliasLocale(e.sourceLocale) }), { locales: e.locales.map(function(e) {
				...
				return t === void 0 && (t = {}), m(this, function(a) {
					switch (a.label) {
						case 0: return this._validateAuth("downloadFileBatch"), [4, Di(e = e.map(function(e) {
							return i(i({}, e), { locale: e.locale ? r.resolveCanonicalLocale(e.locale) : void 0 });
						}), t, this._getTranslationConfig())];
						case 1: return [2, {
			...
			return p(this, void 0, void 0, function() {
				...
				return m(this, function(s) {
					switch (s.label) {
						case 0:
							if (typeof t == "string" && (t = { targetLocale: t }), this._validateAuth("translate"), !(r = t?.targetLocale || this.targetLocale)) throw a = ai("translate"), Jr.error(a), Error(a);
							return r = this.resolveCanonicalLocale(r), o = this.resolveCanonicalLocale(t?.sourceLocale || this.sourceLocale || z), [4, xi([e], i(i({}, t), {
								targetLocale: r,
								sourceLocale: o
			...
			return p(this, void 0, void 0, function() {
				...
				return m(this, function(s) {
					switch (s.label) {
						case 0:
							if (typeof t == "string" && (t = { targetLocale: t }), this._validateAuth("translateMany"), !(r = t?.targetLocale || this.targetLocale)) throw a = ai("translateMany"), Jr.error(a), Error(a);
							return r = this.resolveCanonicalLocale(r), o = this.resolveCanonicalLocale(t?.sourceLocale || this.sourceLocale || z), [4, xi(e, i(i({}, t), {
								targetLocale: r,
								sourceLocale: o
							}), this._getTranslationConfig(), n)];
			...
			return p(this, void 0, void 0, function() {
				...
				return m(this, function(o) {
					switch (o.label) {
						case 0: return this._validateAuth("uploadSourceFiles"), n = i(i({}, t), { sourceLocale: this.resolveCanonicalLocale(t.sourceLocale ?? this.sourceLocale ?? z) }), [4, Mi(e = e.map(function(e) {
							return i(i({}, e), { source: i(i({}, e.source), { locale: a.resolveCanonicalLocale(e.source.locale) }) });
						}), n, this._getTranslationConfig())];
						case 1: return [2, {
							uploadedFiles: (r = o.sent()).data,
							count: r.count,
			...
			return p(this, void 0, void 0, function() {
				...
				return m(this, function(s) {
					switch (s.label) {
						case 0:
							if (this._validateAuth("uploadTranslations"), !(n = i(i({}, t), { sourceLocale: t.sourceLocale ?? this.sourceLocale })).sourceLocale) throw r = oi("uploadTranslations"), Jr.error(r), Error(r);
							return [4, Ni(e.map(function(e) {
								return i(i({}, e), { translations: e.translations.map(function(e) {
									return i(i({}, e), { locale: o.resolveCanonicalLocale(e.locale) });
								}) });
							}), n, this._getTranslationConfig())];
						case 1: return [2, {
			...
			return Gi(e, i({ locales: this._renderingLocales }, t));
		}, e.prototype.formatMessage = function(e, t) {
			return Ki(e, i({ locales: this._renderingLocales }, t));
		}, e.prototype.formatNum = function(e, t) {
			return qi(e, i({ locales: this._renderingLocales }, t));
		}, e.prototype.formatDateTime = function(e, t) {
			return Ji(e, i({ locales: this._renderingLocales }, t));
		}, e.prototype.formatCurrency = function(e, t, n) {
			return Yi(e, t, i({ locales: this._renderingLocales }, n));
			...
			return Xi(e, t, i({ locales: this._renderingLocales }, n));
		}, e.prototype.formatRelativeTimeFromDate = function(e, t) {
			return Zi(e, i({ locales: this._renderingLocales }, t));
			...
			if (e === void 0 && (e = this.getLocaleProperties().regionCode), !t) {
				if (this.customMapping && !this.customRegionMapping) {
					for (var n = {}, r = 0, a = Object.entries(this.customMapping); r < a.length; r++) {
						var o = a[r], s = o[0], c = o[1];
						if (c && typeof c == "object" && c.regionCode && !n[c.regionCode]) {
							var l = c.regionName, u = c.emoji;
							n[c.regionCode] = i(i({ locale: s }, l && { name: l }), u && { emoji: u });
						}
					}
	...
	function qi(e, t) {
		return function(e) {
			var t = e.value, n = e.locales, r = n === void 0 ? [z] : n, a = e.options, o = a === void 0 ? {} : a;
			return G.get("NumberFormat", r, i({ numberingSystem: "latn" }, o)).format(t);
		}({
			value: e,
			locales: t.locales,
			options: t
	...
	function Ji(e, t) {
		return function(e) {
			var t = e.value, n = e.locales, r = n === void 0 ? [z] : n, a = e.options, o = a === void 0 ? {} : a;
			return G.get("DateTimeFormat", r, i({
				calendar: "gregory",
	...
	function Yi(e, t, n) {
		return function(e) {
			var t = e.value, n = e.locales, r = n === void 0 ? [z] : n, a = e.currency, o = a === void 0 ? "USD" : a, s = e.options, c = s === void 0 ? {} : s;
			return G.get("NumberFormat", r, i({
				style: "currency",
				currency: o,
				numberingSystem: "latn"
			}, c)).format(t);
	...
	function Zi(e, t) {
		var n = t.locales, r = t.baseDate, i = a(t, ["locales", "baseDate"]);
		return Zr({
			date: e,
	...
	var t = n("react/jsx-runtime"), r = n("react"), o = i(), s = a();
	function c(e) {
	...
	function br({ children: e, defaultLocale: t = Gn, renderVariable: n }) {
		let i = (e) => r.isValidElement(e) ? ((e) => {
			let i = yr(e);
			if (gr(e.props)) {
				let { variableType: r, variableValue: i, variableOptions: a, injectionType: o } = _r(e.props);
				return n({
					variableType: r,
					variableValue: i,
					variableOptions: a,
			...
			return i?.transformation === "fragment" ? r.createElement(r.Fragment, {
				key: e.props.key,
				children: a(e.props.children)
			}) : e.props.children ? r.cloneElement(e, {
				...e.props,
				"data-_gt": void 0,
				children: a(e.props.children)
			}) : r.cloneElement(e, {
		...
		})(e) : e, a = (e) => Array.isArray(e) ? r.Children.map(e, i) : i(e);
		return a(e);
	}
	function xr(e, t) {
	...
	function Cr(e, t = 0) {
		let n = t, i = (e) => {
			...
			if (a) {
				...
				if (e[1] !== "automatic" && e[2] !== "automatic" || (i.injectionType = "automatic"), e[0] === "translate" && (e[0] = "fragment"), e[0] === "variable" && (i.variableType = e?.[1] || "variable"), e[0] === "plural") {
					let e = Object.entries(r).reduce((e, [t, r]) => (function(e) {
						return Kn.includes(e);
					}(t) && (e[t] = Cr(r, n)), e), {});
					Object.keys(e).length && (i.branches = e);
				}
				if (e[0] === "branch") {
					let { children: e, branch: t, ...a } = r, o = Object.fromEntries(Object.entries(a).filter(([e]) => !e.startsWith("data-"))), s = Object.entries(o).reduce((e, [t, r]) => (e[t] = Cr(r, n), e), {});
		...
		function a(e) {
			return r.isValidElement(e) ? function(e) {
				let { props: t } = e, n = i(e), a = {
					...t,
					"data-_gt": n
				};
				return t.children && !n.variableType && (a.children = o(t.children)), e.type === r.Fragment && (a["data-_gt"].transformation = "fragment"), r.cloneElement(e, a);
			}(e) : e;
		}
		function o(e) {
			return Array.isArray(e) ? r.Children.map(e, a) : a(e);
		}
		return o(e);
	}
	...
	var zr = {
		...
		return t = e, r.isValidElement(t) ? Vr(e) : typeof e == "number" ? e.toString() : e;
		var t;
	};
	function Ur(e) {
	...
	function qr({ sourceElement: e, targetElement: t, locales: n = [Gn], renderVariable: i }) {
		...
		if (c && Object.entries(zr).forEach(([e, t]) => {
			...
			let r = e.props.n;
			return Jr({
				source: vr(r, n, o.branches || {}) || e.props.children,
				target: vr(r, n, t.d?.b || {}) || t.c,
				locales: n,
				renderVariable: i
			});
		}
		if (s === "branch") {
			let { branch: e, children: r } = a;
			return Jr({
				source: (o.branches || {})[e] || r,
				target: (t.d?.b || {})[e] || t.c,
				locales: n,
				renderVariable: i
			});
		}
		return s === "fragment" && t.c ? r.createElement(r.Fragment, {
			key: e.props.key,
			children: Jr({
				source: a.children,
				target: t.c,
		...
		}) : a?.children && t?.c ? r.cloneElement(e, {
			...a,
			...l,
			"data-_gt": void 0,
			children: Jr({
	...
	function Jr({ source: e, target: n, locales: i = [Gn], renderVariable: a }) {
		if (n == null && e) return br({
			children: e,
			defaultLocale: i[0],
			renderVariable: a
		});
		...
		if (Array.isArray(n) && !Array.isArray(e) && e && (e = [e]), Array.isArray(e) && Array.isArray(n)) {
			...
			return n.map((e, n) => {
				if (typeof e == "string") return t.jsx(r.Fragment, { children: e }, `string_${n}`);
				if (tr(e)) return t.jsx(r.Fragment, { children: a({
					variableType: e.v || "v",
					variableValue: o[e.k],
				...
				let l = u(e);
				return l ? t.jsx(r.Fragment, { children: qr({
					sourceElement: l,
					targetElement: e,
					locales: i,
					renderVariable: a
	...
	var Ei = r.createContext(void 0);
	function Di(e = "useGTContext() must be used within a <GTProvider>!") {
		let t = r.useContext(Ei);
		if (t === void 0) throw Error(e);
		return t;
	}
	function Oi({ children: e, locales: n, options: i = {} }) {
		let a = r.useContext(Ei);
		if (e == null) return null;
		let s = a?.gt || new o.GT(), c = typeof e == "string" ? parseFloat(e) : e;
		return typeof c == "number" && (n || (n ||= [], a?.locale && n.push(a.locale), a?.defaultLocale && n.push(a.defaultLocale)), c = s.formatNum(c, {
			locales: n,
			...i
	...
	function Ai({ children: e, currency: n = "USD", locales: i, options: a = {} }) {
		let s = r.useContext(Ei);
		if (e == null) return null;
		let c = s?.gt || new o.GT(), l = typeof e == "string" ? parseFloat(e) : e;
		return typeof l == "number" && (i || (i ||= [], s?.locale && i.push(s.locale), s?.defaultLocale && i.push(s.defaultLocale)), l = c.formatCurrency(l, n, {
			locales: i,
			...a
		})), t.jsx(t.Fragment, { children: l });
	}
	function ji({ children: e, locales: n, options: i = {} }) {
		let a = r.useContext(Ei);
		if (e == null) return null;
		let s = a?.gt || new o.GT();
		n || (n = [], a?.locale && n.push(a.locale), a?.defaultLocale && n.push(a.defaultLocale));
	...
	function Mi({ date: e, children: n, value: i, unit: a, baseDate: s, locales: c, options: l = {} }) {
		let u = r.useContext(Ei), d = u?.gt || new o.GT();
		c || (c = [], u?.locale && c.push(u.locale), u?.defaultLocale && c.push(u.defaultLocale));
		let f = e ?? n, p;
		if (process.env.NODE_ENV !== "development" || i === void 0 || a || console.warn("<RelativeTime>: `value` was provided without `unit`. The `value` prop will be ignored."), i !== void 0 && a) p = d.formatRelativeTime(i, a, {
			locales: c,
			numeric: l.numeric,
			style: l.style,
	...
	function Li(e, t) {
		var n;
		if (!e) return e;
		var r = t.$_fallback, i = function(e) {
		...
		try {
			...
			}(Object.keys(a).length ? hr(e) : e, Pi(Pi(Pi({}, i), a), ((n = {})[ar] = "other", n)), t.$locale ?? t.$_locales, t.$format);
			return o.formatCutoff(s, { maxChars: t.$maxChars });
		} catch {
			return Fi(Ii(e)), t.$_fallback == null ? o.formatCutoff(e, { maxChars: t.$maxChars }) : Li(t.$_fallback, Pi(Pi({}, t), { $_fallback: void 0 }));
		}
	}
	...
	var Ui;
	try {
		Ui = Function("o", "k", "return o[k]")(l, "use");
	} catch {}
	var Wi = Ui;
	function Gi({ children: e, id: n, context: i, _hash: a, ...o }) {
		if (!e) return;
		n ??= o?.$id, i ??= o?.$context;
		let s = o?.$maxChars, { translations: c, translationRequired: l, developmentApiEnabled: u, dialectTranslationRequired: d, registerJsxForTranslation: f, renderSettings: p, locale: m, defaultLocale: h } = Di("<T> used on the client-side outside of <GTProvider>"), g = r.useMemo(() => Cr(e), [e]), _;
		n && (_ = c?.[n]), _ === void 0 && a && (_ = c?.[a]);
		let [v, y] = r.useMemo(() => {
		...
		let C;
		return C = p.method === "skeleton" ? "" : p.method === "replace" || d ? b() : "", t.jsx(r.Suspense, {
			fallback: C,
			children: S()
		});
	}
	Gi._gtt = "translate-client";
	function Ki({ gt: e, locale: t, versionId: n, defaultLocale: i, runtimeUrl: a, renderSettings: o, setTranslations: s, environment: c, ...l }) {
		...
		let f = r.useRef(!1), p = r.useRef(null), [m, h] = r.useState(0), g = r.useCallback((e) => {
			s((t) => {
				let n = Object.keys(e);
		...
		let v = r.useRef(0), y = r.useRef(/* @__PURE__ */ new Map()), b = r.useRef(/* @__PURE__ */ new Map()), x = r.useCallback(async (e) => {
			if (e.size === 0) return {};
			v.current += 1;
			...
			return o;
		}, []), S = r.useRef(null), C = r.useRef(async () => {}), w = r.useCallback((e) => {
		...
		}, [E]), O = r.useMemo(() => D("ICU"), [D]), k = r.useMemo(() => D("JSX"), [D]);
		return r.useEffect(() => () => {
	...
	function Ji(e, t, n, i, a, o, s, c, l, u, d) {
		return r.useCallback((r, c = {}) => {
			if (!t) return "";
			let f = Gr(t, r);
			if (!f) return console.warn(Nr(r)), "";
			if (!Wr(f)) return console.warn(((e) => `${wr} Warning: Invalid dictionary entry found for id: "${e}"`)(r)), "";
			let { entry: p, metadata: m } = Kr(f);
			if (!p || typeof p != "string") return "";
			let { $format: h, ...g } = c, _ = (t, n, i) => {
				try {
					let r = mr(i || ""), a = e.formatMessage(Object.keys(r).length ? hr(t) : t, {
						locales: n,
						variables: {
							...g,
							...r,
					...
					if (d === "production") console.warn(((e) => `${wr} Warning: Invalid ICU string dictionary entry found for id: "${e}"`)(r), "Error: ", a);
					else {
						if (!i) throw Error(`${jr(r)} Error: ${a}`);
						console.error(jr(r), "Error: ", a);
					}
					return i ? _(i, n) : e.formatCutoff(t, { maxChars: m?.$maxChars ?? c.$maxChars });
				}
			};
			if (!s) return _(p, [o]);
			let v = Gr(n || {}, r);
	...
	function Yi({ _locale: e, defaultLocale: t, locales: n, ssr: i, localeCookieName: a, customMapping: s, useDetermineLocale: c, enableI18n: l, reloadOnLocaleUpdate: u }) {
		let d = r.useMemo(() => Array.from(new Set([t, ...l ? n : []])), [
			t,
			n,
			l
		]), [f, p] = c({
			...
			let e = o.requiresTranslation(t, f, d, s), n = e && o.isSameLanguage(t, f);
			if (!s) {
				let e = [];
				if (d.forEach((t) => {
					o.isValidLocale(t) || e.push(t);
	...
	function Xi({ devApiKey: e, projectId: t, runtimeUrl: n, loadTranslationsType: i, cacheUrl: a, locales: c, environment: l }) {
		r.useEffect(() => {
			if (l === "production" && e) throw Error(Tr);
			if (i === "custom" || !a && !n || t || l !== "development" || console.warn(Mr), t && n && i !== "custom" && !e && l === "development" && console.warn(Pr), n === Wn || a === Un && i === "default") {
				let e = c.filter((e) => !s.getSupportedLocale(e));
				e.length && console.warn(((e) => `${wr} Warning: The following locales are currently unsupported by our service: ${e.map((e) => {
					let { name: t } = o.getLocaleProperties(e);
					return `${e} (${t})`;
				}).join(", ")}`)(e));
			}
		}, [
	...
	async function Zi(e, t) {
		let n = Array.from(new Set([e, o.getLocaleProperties(e).languageCode]));
		for (let e of n) try {
			let n = await t(e);
			if (n) return n;
		} catch {}
	...
	function Qi({ _translations: e, translationRequired: t, loadTranslationsType: n, loadTranslations: i, locale: a, cacheUrl: o, projectId: s, _versionId: c, gt: l }) {
		let [u, d] = r.useState(e || (t && n !== "disabled" ? null : {})), f = r.useRef(!1);
		return r.useEffect(() => {
			f.current ? d(t && n !== "disabled" ? null : {}) : f.current = !0;
		}, [a, n]), r.useEffect(() => {
			if (u || !t || n === "disabled") return;
			let e = !0;
			return (async () => {
				let t;
				switch (n) {
	...
	function $i(e, t, n, i, a, o, s, c, l, u, d, f) {
		return r.useCallback((r, s, l = {}) => {
	...
	function ia({ children: e, n, locales: i, ...a }) {
		let o = r.useContext(Ei), s;
		o && (i ||= o.locale, s ||= o.defaultLocale);
		let c = [...i ? [i] : [], s || Gn];
		if (typeof n != "number") throw Error(((e) => `${wr} Error: <Plural> component with children "${e}" requires "n" option.`)(e));
		return t.jsx(t.Fragment, { children: vr(n, c, a) || e });
	}
	...
	ia._gtt = "plural", aa._gtt = "branch", e.Branch = aa, e.Currency = Ai, e.DateTime = ji, e.Derive = wi, e.GTContext = Ei, e.GTProvider = function({ children: e, config: n, environment: i = "production", projectId: a = n?.projectId || "", devApiKey: s = n?.devApiKey || "", _versionId: c = n?._versionId, dictionary: l = n?.dictionary || {}, locales: u = n?.locales || [], defaultLocale: d = n?.defaultLocale || Gn, cacheUrl: f = n?.cacheUrl || Un, runtimeUrl: p = n?.runtimeUrl || Wn, renderSettings: m = n?.renderSettings || Yr(i), ssr: h = n?.ssr || ta(), localeCookieName: g = n?.localeCookieName || "generaltranslation.locale", locale: _ = "", region: v, loadDictionary: y, loadTranslations: b, fallback: x, translations: S = null, customMapping: C = n?.customMapping, enableI18n: w = n?.enableI18n === void 0 || n.enableI18n, enableI18nLoaded: T, reloadOnLocaleUpdate: E, useEnableI18n: D = ea, readAuthFromEnv: O = Rr, useDetermineLocale: k = na, useRegionState: A = ra, ...j }) {
		_ &&= o.resolveAliasLocale(_, C);
		let { projectId: M, devApiKey: N } = O({
			...
			p,
			C
		]), ie = r.useMemo(() => (b ? "custom" : f && M && "default") || "disabled", [
			b,
			f,
			M
		]), { dictionary: ae, setDictionary: z, dictionaryTranslations: B, setDictionaryTranslations: V } = function({ _dictionary: e, _dictionaryTranslations: t = {}, loadDictionary: n, locale: i, defaultLocale: a }) {
			let [o, s] = r.useState(e), [c, l] = r.useState(t);
			return r.useEffect(() => {
				if (!n) return;
				let e = !0;
				return (async () => {
					let t = await Zi(a, n) || {}, r = await Zi(i, n) || {};
					e && s(t || {}), e && l(r || {});
				})(), () => {
					e = !1;
				};
		...
		let { translations: H, setTranslations: U } = Qi({
			...
			environment: i
		}), de = Ji(re, ae, B, H, F, d, R, ee, G, W, i), fe = $i(ae || {}, B || {}, z, V, H, F, d, R, ee, G, W, de), pe = !(R && !H || !F);
		...
		try {
			a = o.formatMessage(t, {
				locales: [Gn],
				variables: mi(mi({}, i), (r = {}, r[ar] = "other", r))
			});
		} catch {
			return function(e) {
				console.warn(e);
		...
		let { developmentApiEnabled: t, translationRequired: n, _preloadMessages: i, _filterMessagesForPreload: a, _gtFunction: o, locale: s } = Di("useGT(): No context provided. You're trying to get the gt() function from the useGT() hook, which can be called within a <GTProvider>."), c;
		if (e && Wi && t && n) {
			let t = a(e);
			t.length > 0 && (c = Wi(Hi([
				"_preloadMessages",
		...
		let { locales: t, locale: n, setLocale: i, gt: a } = Di(), o = r.useMemo(() => !t || t.length === 0 ? [] : t.sort((e, t) => new Intl.Collator().compare(a.getLocaleProperties(e).nativeNameWithRegionCode, a.getLocaleProperties(t).nativeNameWithRegionCode)), [t]), s = r.useCallback((e) => a.getLocaleProperties(e), [a]);
		return {
			locale: n,
			locales: e || o,
			setLocale: i,
		...
		let { developmentApiEnabled: t, translationRequired: n, _preloadMessages: i, _filterMessagesForPreload: a, _mFunction: o, locale: s } = Di("useMessages(): No context provided. You're trying to get the m() function from the useMessages() hook, which can be called within a <GTProvider>."), c;
		if (e && Wi && t && n) {
			let t = a(e);
			t.length > 0 && (c = Wi(Hi([
				"_preloadMessages",
	...
	}, e.useRegionSelector = function({ regions: e, customMapping: t, prioritizeCurrentLocaleRegion: n = !0, sortRegionsAlphabetically: i = !0 } = {
		prioritizeCurrentLocaleRegion: !0,
		sortRegionsAlphabetically: !0
	}) {
		let { locales: a, locale: s, setLocale: c, gt: l, region: u, setRegion: d } = Di(), { regionCode: f } = l.getLocaleProperties(s), [p, m] = r.useMemo(() => {
			let r = new Map(a.map((e) => {
				let t = o.getLocaleProperties(e, s, l.customMapping);
				return [t.regionCode, t];
			})), c = e ? [...e] : Array.from(r?.keys() || [f]), u = new Map(c.map((e) => [e, {
				locale: r?.get(e)?.code || s,
				...l.getRegionProperties(e),
				...typeof t?.[e] == "string" ? { name: t?.[e] } : t?.[e]
			}]));
			if (i && c.sort((e, t) => new Intl.Collator().compare(u.get(e).name, u.get(t).name)), n) {
				let e = c.indexOf(f);
	...
	var t = n("react/jsx-runtime"), r = n("react"), a = i(), s = o();
	function c(e) {
		var t = Object.create(null);
		return e && Object.keys(e).forEach(function(n) {
			if (n !== "default") {
	...
	function d(e, t) {
		...
		u(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
	}
	var f = function() {
	...
	(function(e) {
		...
		enumerable: !0,
		get: function() {
			return s.useRegionSelector;
		}
	}), Object.defineProperty(e, "useSetLocale", {
		enumerable: !0,
		get: function() {
			return s.useSetLocale;
		}
	}), Object.defineProperty(e, "useTranslations", {
		enumerable: !0,
		get: function() {
			return s.useTranslations;
		}
	}), Object.defineProperty(e, "useVersionId", {
		enumerable: !0,
		get: function() {
			return s.useVersionId;
		}
	}), e.ClientProvider = function({ children: e, dictionary: n, dictionaryTranslations: i, translations: o, locale: c, region: u, _versionId: d, defaultLocale: f, translationRequired: p, dialectTranslationRequired: m, locales: h = [], renderSettings: g, projectId: _, devApiKey: v, runtimeUrl: y, developmentApiEnabled: b, resetLocaleCookieName: x, localeCookieName: S = "generaltranslation.locale", regionCookieName: C = "generaltranslation.region", customMapping: w, environment: T, reloadServer: E }) {
		let D = r.useRef(!1), [O, k] = r.useState(o);
		r.useEffect(() => {
			D.current && k(o);
		}, [o]);
		let [A, j] = r.useState(c && a.determineLocale(c, h, w) || "");
		r.useEffect(() => {
			let e = document.cookie.split("; ").find((e) => e.startsWith(`${S}=`))?.split("=")[1];
			e &&= R.resolveAliasLocale(e), A && e && e !== A && (document.cookie = `${S}=;path=/`);
		}, [A, S]);
		let [M, N] = r.useState(i || {}), [P, F] = r.useState(n || {});
		r.useEffect(() => {
			D.current && N(i);
		}, [i]), r.useEffect(() => {
			D.current && F(n);
		}, [n]);
		let [I, L] = r.useState(u);
		r.useEffect(() => {
			let e = document.cookie.split("; ").find((e) => e.startsWith(`${C}=`))?.split("=")[1];
			I && e && e !== I && (document.cookie = `${C}=;path=/`);
		}, [I, C]);
		let R = r.useMemo(() => new a.GT({
			devApiKey: v,
			sourceLocale: f,
			targetLocale: A,
			projectId: _,
			...
			y,
			w
		]), { registerIcuForTranslation: ee, registerJsxForTranslation: te } = s.useRuntimeTranslation({
			gt: R,
			locale: A,
			versionId: d,
			runtimeUrl: y,
			...
			environment: T
		}), { _gtFunction: ne, _mFunction: re, _filterMessagesForPreload: ie, _preloadMessages: ae } = s.useCreateInternalUseGTFunction({
			gt: R,
			translations: O,
			locale: A,
			defaultLocale: f,
			...
			environment: T
		}), z = s.useCreateInternalUseTranslationsFunction(R, P, M, O, A, f, p, m, b, ee, T), B = s.useCreateInternalUseTranslationsObjFunction(P, M, F, N, O, A, f, p, m, b, ee, z), V = !(p && !O) && A;
		return r.useEffect(() => {
			D.current = !0;
		}, []), t.jsx(s.GTContext.Provider, {
			value: {
				gt: R,
				registerIcuForTranslation: ee,
				registerJsxForTranslation: te,
				setLocale: (e) => {
					e = a.determineLocale(e, h, w) || A || f, e = R.resolveAliasLocale(e), document.cookie = `${S}=${e};path=/`, document.cookie = `${x}=true;path=/`, j(e), E();
				},
				_gtFunction: ne,
				_mFunction: re,
		...
		let { locale: i, locales: a, setLocale: o, getLocaleProperties: c } = s.useLocaleSelector(n);
		...
		var { regions: n, placeholder: r, customMapping: i, prioritizeCurrentLocaleRegion: a, sortRegionsAlphabetically: o, asLocaleSelector: c = !1 } = e, l = Yn(e, [
			"regions",
			"placeholder",
			"customMapping",
		...
		let { region: u, setRegion: d, regions: f, regionData: p, locale: m, setLocale: h } = s.useRegionSelector({
			regions: n,
			customMapping: i,
			prioritizeCurrentLocaleRegion: a,
			sortRegionsAlphabetically: o
		});
...
${e.join("\n")}`;
	...
	children: /* @__PURE__ */ e(u.T, { children: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." })
});
//#endregion
export { d as default };
