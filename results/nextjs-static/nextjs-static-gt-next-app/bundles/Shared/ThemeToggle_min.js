...
function h() {
	...
	let o = r === "auto" ? "Theme mode: auto (system). Click to switch to light mode." : `Theme mode: ${r}. Click to switch mode.`;
	return /* @__PURE__ */ n("button", {
		...
		children: r === "auto" ? /* @__PURE__ */ n(f.T, { children: "Theme: Auto" }) : r === "dark" ? /* @__PURE__ */ n(f.T, { children: "Theme: Dark" }) : /* @__PURE__ */ n(f.T, { children: "Theme: Light" })
	});
}
//#endregion
export { h as default };
