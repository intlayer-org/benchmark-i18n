...
function h() {
	return m("AboutHeader"), /* @__PURE__ */ n(e, { children: [/* @__PURE__ */ t("h1", {
		className: "mb-4 text-3xl font-bold text-foreground",
		children: /* @__PURE__ */ t(p.T, { children: "About This Benchmark" })
	}), /* @__PURE__ */ t("p", {
		className: "mb-8 max-w-3xl text-muted-foreground",
		children: /* @__PURE__ */ t(p.T, { children: "This is an open-source test application — not a product or a company. Its sole purpose is to provide a realistic, multi-page React app where different i18n libraries can be integrated and measured under identical conditions." })
	})] });
}
//#endregion
export { h as default };
