...
function p() {
	...
	return /* @__PURE__ */ n("section", {
		...
		children: [/* @__PURE__ */ t("h2", {
			...
			children: /* @__PURE__ */ t(f.T, { children: "API Access" })
		}), /* @__PURE__ */ n("div", { children: [
			/* @__PURE__ */ t("label", {
				htmlFor: r,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: /* @__PURE__ */ t(f.T, { children: "API Key" })
			}),
			/* @__PURE__ */ n("div", {
				...
				children: [/* @__PURE__ */ t("input", {
					...
					children: /* @__PURE__ */ t(f.T, { children: "Copy" })
				})]
			}),
			/* @__PURE__ */ t("p", {
				className: "mt-1 text-xs text-muted-foreground",
				children: /* @__PURE__ */ t(f.T, { children: "Use this key to access the benchmarking API programmatically." })
			})
		] })]
	});
}
