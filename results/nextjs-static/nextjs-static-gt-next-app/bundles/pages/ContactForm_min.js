		...
		children: [
			/* @__PURE__ */ n("div", {
				...
				children: [/* @__PURE__ */ n("div", { children: [/* @__PURE__ */ t("label", {
					...
					children: /* @__PURE__ */ t(f.T, { children: "Name" })
				}), /* @__PURE__ */ t("input", {
					id: r,
					...
					htmlFor: i,
					className: "mb-1 block text-sm font-medium text-foreground",
					children: /* @__PURE__ */ t(f.T, { children: "Email" })
				}), /* @__PURE__ */ t("input", {
					id: i,
					type: "email",
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			/* @__PURE__ */ n("div", { children: [/* @__PURE__ */ t("label", {
				htmlFor: a,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: /* @__PURE__ */ t(f.T, { children: "Topic" })
			}), /* @__PURE__ */ n("select", {
				id: a,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				children: [
					/* @__PURE__ */ t("option", { children: /* @__PURE__ */ t(f.T, { children: "Bug Report" }) }),
					/* @__PURE__ */ t("option", { children: /* @__PURE__ */ t(f.T, { children: "New Benchmark Idea" }) }),
					/* @__PURE__ */ t("option", { children: /* @__PURE__ */ t(f.T, { children: "Methodology Question" }) }),
					/* @__PURE__ */ t("option", { children: /* @__PURE__ */ t(f.T, { children: "Contribution" }) }),
					/* @__PURE__ */ t("option", { children: /* @__PURE__ */ t(f.T, { children: "Other" }) })
				]
			})] }),
			/* @__PURE__ */ n("div", { children: [/* @__PURE__ */ t("label", {
				htmlFor: o,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: /* @__PURE__ */ t(f.T, { children: "Message" })
			}), /* @__PURE__ */ t("textarea", {
				id: o,
				rows: 5,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			/* @__PURE__ */ t("button", {
				...
				children: /* @__PURE__ */ t(f.T, { children: "Send Message" })
			})
		]
	});
}
