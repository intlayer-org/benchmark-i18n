...
var r = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), i = /* @__PURE__ */ ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
  ...
  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
	...
	function Xi({ devApiKey: e, projectId: t, runtimeUrl: i, loadTranslationsType: o, cacheUrl: s, locales: c, environment: l }) {
		n.useEffect(() => {
			if (l === "production" && e) throw Error(Tr);
			if (o === "custom" || !s && !i || t || l !== "development" || console.warn(Mr), t && i && o !== "custom" && !e && l === "development" && console.warn(Pr), i === Wn || s === Un && o === "default") {
				let e = c.filter((e) => !a.getSupportedLocale(e));
	...
	(function(e) {
		...
		let R = n.useMemo(() => new r.GT({
			...
			y,
			w
		]), { registerIcuForTranslation: ee, registerJsxForTranslation: te } = a.useRuntimeTranslation({
			gt: R,
			locale: A,
			versionId: d,
			runtimeUrl: y,
			...
			environment: T
		}), { _gtFunction: ne, _mFunction: re, _filterMessagesForPreload: ie, _preloadMessages: ae } = a.useCreateInternalUseGTFunction({
			gt: R,
			translations: O,
			locale: A,
			defaultLocale: f,
			...
			environment: T
		}), z = a.useCreateInternalUseTranslationsFunction(R, P, M, O, A, f, p, m, b, ee, T), B = a.useCreateInternalUseTranslationsObjFunction(P, M, F, N, O, A, f, p, m, b, ee, z), V = !(p && !O) && A;
		return n.useEffect(() => {
			D.current = !0;
		}, []), t.jsx(a.GTContext.Provider, {
			value: {
				gt: R,
				registerIcuForTranslation: ee,
		...
		let { locale: i, locales: o, setLocale: s, getLocaleProperties: c } = a.useLocaleSelector(n);
		...
		var { regions: n, placeholder: r, customMapping: i, prioritizeCurrentLocaleRegion: o, sortRegionsAlphabetically: s, asLocaleSelector: c = !1 } = e, l = Yn(e, [
			"regions",
			"placeholder",
			"customMapping",
		...
		let { region: u, setRegion: d, regions: f, regionData: p, locale: m, setLocale: h } = a.useRegionSelector({
			regions: n,
			customMapping: i,
...
function p() {
	return /* @__PURE__ */ n(e, { children: [/* @__PURE__ */ t("h2", {
		...
		children: /* @__PURE__ */ t(f.T, { children: "Open Positions" })
	}), /* @__PURE__ */ t("div", {
		className: "space-y-4",
		children: [
			{
				title: /* @__PURE__ */ t(f.T, { children: "Senior Frontend Engineer" }),
				location: /* @__PURE__ */ t(f.T, { children: "Remote" }),
				type: /* @__PURE__ */ t(f.T, { children: "Full-time" }),
				dept: /* @__PURE__ */ t(f.T, { children: "Engineering" }),
				desc: /* @__PURE__ */ t(f.T, { children: "Build and maintain our benchmarking dashboard and developer tools using React, TypeScript, and Vite." })
			},
			{
				title: /* @__PURE__ */ t(f.T, { children: "Backend Engineer" }),
				location: /* @__PURE__ */ t(f.T, { children: "Remote" }),
				type: /* @__PURE__ */ t(f.T, { children: "Full-time" }),
				dept: /* @__PURE__ */ t(f.T, { children: "Engineering" }),
				desc: /* @__PURE__ */ t(f.T, { children: "Design and scale our cloud benchmarking infrastructure handling thousands of automated runs daily." })
			},
			{
				title: /* @__PURE__ */ t(f.T, { children: "Technical Writer" }),
				location: /* @__PURE__ */ t(f.T, { children: "Remote" }),
				type: /* @__PURE__ */ t(f.T, { children: "Part-time" }),
				dept: /* @__PURE__ */ t(f.T, { children: "Documentation" }),
				desc: /* @__PURE__ */ t(f.T, { children: "Create comprehensive guides, API references, and tutorials for our benchmarking platform." })
			},
			{
				title: /* @__PURE__ */ t(f.T, { children: "DevRel Engineer" }),
				location: /* @__PURE__ */ t(f.T, { children: "San Francisco / Remote" }),
				type: /* @__PURE__ */ t(f.T, { children: "Full-time" }),
				dept: /* @__PURE__ */ t(f.T, { children: "Community" }),
				desc: /* @__PURE__ */ t(f.T, { children: "Engage with the i18n community through talks, workshops, blog posts, and open source contributions." })
			},
			{
				title: /* @__PURE__ */ t(f.T, { children: "QA Engineer" }),
				location: /* @__PURE__ */ t(f.T, { children: "Remote" }),
				type: /* @__PURE__ */ t(f.T, { children: "Full-time" }),
				dept: /* @__PURE__ */ t(f.T, { children: "Engineering" }),
				desc: /* @__PURE__ */ t(f.T, { children: "Ensure the accuracy and reliability of benchmark results through rigorous testing and validation." })
			}
			...
			children: [/* @__PURE__ */ n("div", { children: [
				...
				children: /* @__PURE__ */ t(f.T, { children: "Apply Now" })
			})]
		}, e.title?.toString() || ""))
	})] });
}
