...
function p() {
	...
	return /* @__PURE__ */ n("section", {
		...
		children: [/* @__PURE__ */ t("h2", {
			...
			children: /* @__PURE__ */ t(f.T, { children: "Preferences" })
		}), /* @__PURE__ */ n("div", {
			className: "space-y-4",
			children: [
				/* @__PURE__ */ n("div", {
					...
					children: [/* @__PURE__ */ n("div", { children: [/* @__PURE__ */ t("p", {
						...
						children: /* @__PURE__ */ t(f.T, { children: "Email Notifications" })
					}), /* @__PURE__ */ t("p", {
						className: "text-xs text-muted-foreground",
						children: /* @__PURE__ */ t(f.T, { children: "Receive weekly benchmark reports" })
					})] }), /* @__PURE__ */ t("button", {
						type: "button",
				...
				/* @__PURE__ */ n("div", {
					...
					children: [/* @__PURE__ */ n("div", { children: [/* @__PURE__ */ t("p", {
						className: "text-sm font-medium text-foreground",
						children: /* @__PURE__ */ t(f.T, { children: "Dark Mode" })
					}), /* @__PURE__ */ t("p", {
						className: "text-xs text-muted-foreground",
						children: /* @__PURE__ */ t(f.T, { children: "Use dark color scheme" })
					})] }), /* @__PURE__ */ t("button", {
						type: "button",
				...
				/* @__PURE__ */ n("div", { children: [/* @__PURE__ */ t("label", {
					...
					children: /* @__PURE__ */ t(f.T, { children: "Default Language" })
				}), /* @__PURE__ */ n("select", {
					id: r,
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
					children: [
						/* @__PURE__ */ t("option", { children: /* @__PURE__ */ t(f.T, { children: "English (en)" }) }),
						/* @__PURE__ */ t("option", { children: /* @__PURE__ */ t(f.T, { children: "French (fr)" }) }),
						/* @__PURE__ */ t("option", { children: /* @__PURE__ */ t(f.T, { children: "German (de)" }) }),
						/* @__PURE__ */ t("option", { children: /* @__PURE__ */ t(f.T, { children: "Spanish (es)" }) }),
						/* @__PURE__ */ t("option", { children: /* @__PURE__ */ t(f.T, { children: "Japanese (ja)" }) }),
						/* @__PURE__ */ t("option", { children: /* @__PURE__ */ t(f.T, { children: "Chinese Simplified (zh-CN)" }) }),
						/* @__PURE__ */ t("option", { children: /* @__PURE__ */ t(f.T, { children: "Arabic (ar)" }) })
					]
				})] })
			]
		})]
