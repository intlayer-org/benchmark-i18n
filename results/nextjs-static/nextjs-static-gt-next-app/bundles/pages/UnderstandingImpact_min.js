...
var n = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), r = /* @__PURE__ */ ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	function vn(e, t, n) {
		...
		for (var i = function(e) {
			var n = t.filter(function(t) {
				...
				return null;
			}, o = _n(e), s = o.languageCode, c = a(o, ["languageCode"]), l = i(r({
				locale: e,
				languageCode: s
			}, c)) || i(r({ locale: s }, _n(s)));
			if (l) return { value: l };
	...
	var zr = function() {
		function e(t, n, i, o) {
			...
			this.formats = Lr(e.formats, i), this.formatters = o && o.formatters || ((s = this.formatterCache) === void 0 && (s = {
				number: {},
				dateTime: {},
				pluralRules: {}
			}), {
  ...
  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
	...
	var t = r("react/jsx-runtime"), n = r("react"), i = a(), s = o();
	function c(e) {
	...
	function Oi({ children: e, locales: r, options: a = {} }) {
		let o = n.useContext(Ei);
		if (e == null) return null;
		let s = o?.gt || new i.GT(), c = typeof e == "string" ? parseFloat(e) : e;
		return typeof c == "number" && (r || (r ||= [], o?.locale && r.push(o.locale), o?.defaultLocale && r.push(o.defaultLocale)), c = s.formatNum(c, {
			locales: r,
			...a
	...
	function Ai({ children: e, currency: r = "USD", locales: a, options: o = {} }) {
		let s = n.useContext(Ei);
		if (e == null) return null;
		let c = s?.gt || new i.GT(), l = typeof e == "string" ? parseFloat(e) : e;
		return typeof l == "number" && (a || (a ||= [], s?.locale && a.push(s.locale), s?.defaultLocale && a.push(s.defaultLocale)), l = c.formatCurrency(l, r, {
			locales: a,
			...o
		})), t.jsx(t.Fragment, { children: l });
	}
	function ji({ children: e, locales: r, options: a = {} }) {
		let o = n.useContext(Ei);
		if (e == null) return null;
		let s = o?.gt || new i.GT();
		r || (r = [], o?.locale && r.push(o.locale), o?.defaultLocale && r.push(o.defaultLocale));
	...
	function Mi({ date: e, children: r, value: a, unit: o, baseDate: s, locales: c, options: l = {} }) {
		let u = n.useContext(Ei), d = u?.gt || new i.GT();
	...
	function Li(e, t) {
		var n;
		if (!e) return e;
		var r = t.$_fallback, a = function(e) {
		...
		try {
			var o = mr(r || ""), s = function(e, t, n, r) {
				try {
					return i.formatMessage(e, {
						variables: t,
						locales: n,
						dataFormat: r
					});
			...
			return i.formatCutoff(s, { maxChars: t.$maxChars });
		} catch {
			return Fi(Ii(e)), t.$_fallback == null ? i.formatCutoff(e, { maxChars: t.$maxChars }) : Li(t.$_fallback, Pi(Pi({}, t), { $_fallback: void 0 }));
		}
	}
	...
	function Yi({ _locale: e, defaultLocale: t, locales: r, ssr: a, localeCookieName: o, customMapping: s, useDetermineLocale: c, enableI18n: l, reloadOnLocaleUpdate: u }) {
		let d = n.useMemo(() => Array.from(new Set([t, ...l ? r : []])), [
			t,
			r,
			l
		]), [f, p] = c({
			...
			let e = i.requiresTranslation(t, f, d, s), n = e && i.isSameLanguage(t, f);
			if (!s) {
				let e = [];
				if (d.forEach((t) => {
					i.isValidLocale(t) || e.push(t);
	...
	function Xi({ devApiKey: e, projectId: t, runtimeUrl: r, loadTranslationsType: a, cacheUrl: o, locales: c, environment: l }) {
		n.useEffect(() => {
			if (l === "production" && e) throw Error(Tr);
			if (a === "custom" || !o && !r || t || l !== "development" || console.warn(Mr), t && r && a !== "custom" && !e && l === "development" && console.warn(Pr), r === Wn || o === Un && a === "default") {
				...
				e.length && console.warn(((e) => `${wr} Warning: The following locales are currently unsupported by our service: ${e.map((e) => {
					let { name: t } = i.getLocaleProperties(e);
					return `${e} (${t})`;
				}).join(", ")}`)(e));
			}
		}, [
	...
	async function Zi(e, t) {
		let n = Array.from(new Set([e, i.getLocaleProperties(e).languageCode]));
		for (let e of n) try {
			let n = await t(e);
			if (n) return n;
		} catch {}
	...
	ia._gtt = "plural", aa._gtt = "branch", e.Branch = aa, e.Currency = Ai, e.DateTime = ji, e.Derive = wi, e.GTContext = Ei, e.GTProvider = function({ children: e, config: r, environment: a = "production", projectId: o = r?.projectId || "", devApiKey: s = r?.devApiKey || "", _versionId: c = r?._versionId, dictionary: l = r?.dictionary || {}, locales: u = r?.locales || [], defaultLocale: d = r?.defaultLocale || Gn, cacheUrl: f = r?.cacheUrl || Un, runtimeUrl: p = r?.runtimeUrl || Wn, renderSettings: m = r?.renderSettings || Yr(a), ssr: h = r?.ssr || ta(), localeCookieName: g = r?.localeCookieName || "generaltranslation.locale", locale: _ = "", region: v, loadDictionary: y, loadTranslations: b, fallback: x, translations: S = null, customMapping: C = r?.customMapping, enableI18n: w = r?.enableI18n === void 0 || r.enableI18n, enableI18nLoaded: T, reloadOnLocaleUpdate: E, useEnableI18n: D = ea, readAuthFromEnv: O = Rr, useDetermineLocale: k = na, useRegionState: A = ra, ...j }) {
		_ &&= i.resolveAliasLocale(_, C);
		...
		try {
			o = i.formatMessage(t, {
				locales: [Gn],
				variables: mi(mi({}, a), (r = {}, r[ar] = "other", r))
			});
		} catch {
			return function(e) {
				console.warn(e);
	...
	}, e.useRegionSelector = function({ regions: e, customMapping: t, prioritizeCurrentLocaleRegion: r = !0, sortRegionsAlphabetically: a = !0 } = {
		...
		let { locales: o, locale: s, setLocale: c, gt: l, region: u, setRegion: d } = Di(), { regionCode: f } = l.getLocaleProperties(s), [p, m] = n.useMemo(() => {
			let n = new Map(o.map((e) => {
				let t = i.getLocaleProperties(e, s, l.customMapping);
			...
			if (a && c.sort((e, t) => new Intl.Collator().compare(u.get(e).name, u.get(t).name)), r) {
				let e = c.indexOf(f);
	...
	var t = r("react/jsx-runtime"), n = r("react"), i = a(), o = s();
	function c(e) {
		var t = Object.create(null);
		return e && Object.keys(e).forEach(function(n) {
			if (n !== "default") {
	...
	(function(e) {
		...
		enumerable: !0,
		get: function() {
			return o.useRegionSelector;
		}
	}), Object.defineProperty(e, "useSetLocale", {
		enumerable: !0,
		get: function() {
			return o.useSetLocale;
		}
	}), Object.defineProperty(e, "useTranslations", {
		enumerable: !0,
		get: function() {
			return o.useTranslations;
		}
	}), Object.defineProperty(e, "useVersionId", {
		enumerable: !0,
		get: function() {
			return o.useVersionId;
		}
	}), e.ClientProvider = function({ children: e, dictionary: r, dictionaryTranslations: a, translations: s, locale: c, region: u, _versionId: d, defaultLocale: f, translationRequired: p, dialectTranslationRequired: m, locales: h = [], renderSettings: g, projectId: _, devApiKey: v, runtimeUrl: y, developmentApiEnabled: b, resetLocaleCookieName: x, localeCookieName: S = "generaltranslation.locale", regionCookieName: C = "generaltranslation.region", customMapping: w, environment: T, reloadServer: E }) {
		let D = n.useRef(!1), [O, k] = n.useState(s);
		n.useEffect(() => {
			D.current && k(s);
		}, [s]);
		let [A, j] = n.useState(c && i.determineLocale(c, h, w) || "");
		n.useEffect(() => {
			let e = document.cookie.split("; ").find((e) => e.startsWith(`${S}=`))?.split("=")[1];
			e &&= R.resolveAliasLocale(e), A && e && e !== A && (document.cookie = `${S}=;path=/`);
		}, [A, S]);
		let [M, N] = n.useState(a || {}), [P, F] = n.useState(r || {});
		n.useEffect(() => {
			D.current && N(a);
		}, [a]), n.useEffect(() => {
			D.current && F(r);
		...
		let R = n.useMemo(() => new i.GT({
			...
			y,
			w
		]), { registerIcuForTranslation: ee, registerJsxForTranslation: te } = o.useRuntimeTranslation({
			gt: R,
			locale: A,
			versionId: d,
			runtimeUrl: y,
			...
			environment: T
		}), { _gtFunction: ne, _mFunction: re, _filterMessagesForPreload: ie, _preloadMessages: ae } = o.useCreateInternalUseGTFunction({
			gt: R,
			translations: O,
			locale: A,
			defaultLocale: f,
			...
			environment: T
		}), z = o.useCreateInternalUseTranslationsFunction(R, P, M, O, A, f, p, m, b, ee, T), B = o.useCreateInternalUseTranslationsObjFunction(P, M, F, N, O, A, f, p, m, b, ee, z), V = !(p && !O) && A;
		return n.useEffect(() => {
			D.current = !0;
		}, []), t.jsx(o.GTContext.Provider, {
			value: {
				gt: R,
				registerIcuForTranslation: ee,
				registerJsxForTranslation: te,
				setLocale: (e) => {
					e = i.determineLocale(e, h, w) || A || f, e = R.resolveAliasLocale(e), document.cookie = `${S}=${e};path=/`, document.cookie = `${x}=true;path=/`, j(e), E();
				},
				_gtFunction: ne,
				_mFunction: re,
		...
		let { locale: i, locales: a, setLocale: s, getLocaleProperties: c } = o.useLocaleSelector(n);
		...
		var { regions: n, placeholder: r, customMapping: i, prioritizeCurrentLocaleRegion: a, sortRegionsAlphabetically: s, asLocaleSelector: c = !1 } = e, l = Yn(e, [
			"regions",
			"placeholder",
			"customMapping",
		...
		let { region: u, setRegion: d, regions: f, regionData: p, locale: m, setLocale: h } = o.useRegionSelector({
			regions: n,
			customMapping: i,
	...
	return /* @__PURE__ */ t("section", {
		...
		children: [
			/* @__PURE__ */ e("h2", {
				...
				children: /* @__PURE__ */ e(d.T, { children: "Understanding the Impact" })
			}),
			/* @__PURE__ */ t("div", {
				...
				children: [
					/* @__PURE__ */ e("h3", {
						...
						children: /* @__PURE__ */ e(d.T, { children: "Why a single large JSON can hurt performance" })
					}),
					/* @__PURE__ */ e("p", {
						className: "text-sm text-muted-foreground",
						children: /* @__PURE__ */ e(d.T, { children: "Many i18n libraries store translations in a single JSON object provided via React context. When this object is large (thousands of keys), every component that consumes translations holds a reference to the entire dictionary. This means:" })
					}),
					/* @__PURE__ */ t("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							/* @__PURE__ */ e("li", { children: /* @__PURE__ */ e(d.T, { children: "The JSON must be parsed on every page load — blocking the main thread." }) }),
							/* @__PURE__ */ e("li", { children: /* @__PURE__ */ e(d.T, { children: "Context-based architectures can cause cascading re-renders when the locale changes, because every consumer is notified even if their specific keys didn't change." }) }),
							/* @__PURE__ */ e("li", { children: /* @__PURE__ */ e(d.T, { children: "During server-side rendering, the full dictionary is serialized into the HTML payload, increasing the document size that must be downloaded and hydrated." }) })
						]
					})
				]
			}),
			/* @__PURE__ */ t("div", {
				...
				children: [
					/* @__PURE__ */ e("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: /* @__PURE__ */ e(d.T, { children: "The trade-offs of dynamic loading" })
					}),
					/* @__PURE__ */ e("p", {
						className: "text-sm text-muted-foreground",
						children: /* @__PURE__ */ e(d.T, { children: "Splitting translations into per-route or per-namespace chunks can dramatically reduce the initial payload. But it introduces new challenges:" })
					}),
					/* @__PURE__ */ t("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							/* @__PURE__ */ t("li", { children: [
								/* @__PURE__ */ e("strong", {
									...
									children: /* @__PURE__ */ e(d.T, { children: "Waterfall requests:" })
								}),
								" ",
								/* @__PURE__ */ e(d.T, { children: "the app must first load, determine the locale, then fetch the right chunk — adding network round-trips." })
							] }),
							/* @__PURE__ */ t("li", { children: [
								/* @__PURE__ */ e("strong", {
									className: "text-foreground",
									children: /* @__PURE__ */ e(d.T, { children: "Flash of untranslated content (FOUC):" })
								}),
								" ",
								/* @__PURE__ */ e(d.T, { children: "users may briefly see translation keys or a fallback language before the chunk arrives." })
							] }),
							/* @__PURE__ */ t("li", { children: [
								/* @__PURE__ */ e("strong", {
									className: "text-foreground",
									children: /* @__PURE__ */ e(d.T, { children: "Cache invalidation:" })
								}),
								" ",
								/* @__PURE__ */ e(d.T, { children: "updating translations requires cache-busting strategies to ensure users get fresh content without re-downloading unchanged chunks." })
							] })
						]
					})
				]
			...
			/* @__PURE__ */ t("div", {
				...
				children: [/* @__PURE__ */ e("h3", {
					className: "mb-2 text-lg font-semibold text-foreground",
					children: /* @__PURE__ */ e(d.T, { children: "What this benchmark measures" })
				}), /* @__PURE__ */ e("p", {
					className: "text-sm text-muted-foreground",
					children: /* @__PURE__ */ e(d.T, { children: "This test app provides a controlled environment — 10 pages with realistic content — to compare i18n libraries across three axes: the weight they add to your JavaScript bundle, the time spent parsing and rendering translated content, and the effectiveness of their code-splitting and lazy-loading strategies. Each library is integrated into the same app so results are directly comparable." })
				})]
			})
		]
	});
