...
function f() {
	return /* @__PURE__ */ t("section", {
		...
		children: [/* @__PURE__ */ e("h2", {
			...
			children: /* @__PURE__ */ e(d.T, { children: "Why These Metrics Matter" })
		}), /* @__PURE__ */ t("div", {
			...
			children: [
				/* @__PURE__ */ t("div", {
					...
					children: [/* @__PURE__ */ e("h3", {
						...
						children: /* @__PURE__ */ e(d.T, { children: "Bundle Size" })
					}), /* @__PURE__ */ e("p", {
						className: "text-sm text-muted-foreground",
						children: /* @__PURE__ */ e(d.T, { children: "The bundle is the data shipped to every user across the globe. A larger bundle means longer download times — especially on slow 3G connections common in many regions. i18n libraries vary dramatically in their weight: from a few kilobytes to tens of kilobytes of runtime code, plus the translation files themselves." })
					})]
				}),
				/* @__PURE__ */ t("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [/* @__PURE__ */ e("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: /* @__PURE__ */ e(d.T, { children: "Rendering & Hydration" })
					}), /* @__PURE__ */ e("p", {
						className: "text-sm text-muted-foreground",
						children: /* @__PURE__ */ e(d.T, { children: "Connecting a large JSON dictionary to every component creates a hidden dependency: any change in the translation context can trigger re-renders across the entire tree. During SSR hydration, parsing and attaching massive translation objects adds latency before the page becomes interactive — directly impacting Time to Interactive (TTI)." })
					})]
				}),
				/* @__PURE__ */ t("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [/* @__PURE__ */ e("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: /* @__PURE__ */ e(d.T, { children: "Dynamic Loading" })
					}), /* @__PURE__ */ e("p", {
						className: "text-sm text-muted-foreground",
						children: /* @__PURE__ */ e(d.T, { children: "Loading all translations upfront overloads the initial payload. Dynamic (lazy) loading splits translations by route or namespace, sending only what the current page needs. However, lazy loading introduces its own trade-offs: waterfall requests, flash of untranslated content, and caching complexity. Measuring both strategies is essential." })
					})]
				})
			]
		})]
