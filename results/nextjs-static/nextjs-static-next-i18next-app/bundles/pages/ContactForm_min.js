	...
	return /* @__PURE__ */ l("form", {
		...
		children: [
			...
			/* @__PURE__ */ l("div", { children: [/* @__PURE__ */ c("label", {
				...
				children: [
					/* @__PURE__ */ c("option", { children: "Bug Report" }),
					/* @__PURE__ */ c("option", { children: "New Benchmark Idea" }),
					/* @__PURE__ */ c("option", { children: "Methodology Question" }),
