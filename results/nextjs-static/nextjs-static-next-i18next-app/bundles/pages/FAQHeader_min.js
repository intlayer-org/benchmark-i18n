...
var u = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), d = /* @__PURE__ */ ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	let { i18n: c } = s, { i18n: l, defaultNS: u } = n(O) || {}, d = c || l || D();
	...
	let f = i(() => ({
		...
		...d?.options?.react,
		...s
	}), [d, s]), { useSuspense: p, keyPrefix: h } = f, b = e || u || d?.options?.defaultNS, x = y(b) ? [b] : b || ["translation"], S = i(() => x, x);
	...
	let C = a(0), w = t((e) => {
		...
		if (!d) return N;
		let e = !!(d.isInitialized || d.initializedStoreOnce) && S.every((e) => v(e, d, f)), t = s.lng || d.language, n = C.current, r = E.current;
		...
		f,
		s.lng
	]), [j, F] = o(0), { t: I, ready: L } = (0, M.useSyncExternalStore)(w, A, A);
	r(() => {
		if (d && !L && !p) {
			let e = () => F((e) => e + 1);
			s.lng ? _(d, s.lng, S, e) : g(d, S, e);
		}
	}, [
		d,
		s.lng,
