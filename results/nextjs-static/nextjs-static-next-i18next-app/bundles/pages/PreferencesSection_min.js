		...
		children: [/* @__PURE__ */ c("h2", {
			...
			children: [
				...
				/* @__PURE__ */ l("div", { children: [/* @__PURE__ */ c("label", {
					...
					children: [
						/* @__PURE__ */ c("option", { children: "English (en)" }),
						/* @__PURE__ */ c("option", { children: "French (fr)" }),
						/* @__PURE__ */ c("option", { children: "German (de)" }),
						/* @__PURE__ */ c("option", { children: "Spanish (es)" }),
						/* @__PURE__ */ c("option", { children: "Japanese (ja)" }),
						/* @__PURE__ */ c("option", { children: "Chinese Simplified (zh-CN)" }),
						/* @__PURE__ */ c("option", { children: "Arabic (ar)" })
					]
				})] })
			]
		})]
