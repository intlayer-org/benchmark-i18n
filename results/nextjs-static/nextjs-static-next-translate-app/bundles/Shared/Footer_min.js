...
import i, { useContext as a, useMemo as o } from "react";
//#region components/Link.tsx
var s = (e) => /^https?:\/\//.test(e ?? ""), c = ({ href: r, children: i, ...a }) => {
	let o = e().lang ?? "en", c = s(r.toString());
	return /* @__PURE__ */ n(t, {
		href: r && !c && !r.toString().startsWith(`/${o}`) ? `/${o}${r}` : r,
		...a,
		children: i
	});
}, l = function() {
...
var d;
typeof i.createContext == "function" && (d = i.createContext({
	t: function(e) {
			...
			children: [/* @__PURE__ */ r("div", {
				...
				children: [
					...
					/* @__PURE__ */ r("div", { children: [/* @__PURE__ */ n("h3", {
						...
						className: "space-y-1",
						children: t.map((e) => /* @__PURE__ */ n("li", { children: e.isInternal ? /* @__PURE__ */ n(c, {
							href: e.href,
