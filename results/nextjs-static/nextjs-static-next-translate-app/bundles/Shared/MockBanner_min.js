...
function a(e, t) {
	return typeof t == "string" ? function(n, r, a) {
		return e(n, r, i({ ns: t }, a));
	} : e;
}
//#endregion
...
function f(e) {
	var t = e.config, n = e.allNamespaces, r = e.pluralRules, i = e.lang, a = t.logger, o = a === void 0 ? _ : a, s = t.allowEmptyStrings, c = s === void 0 ? !0 : s, l = function(e, n) {
		...
		e === void 0 && (e = "");
		var s = Array.isArray(e) ? e[0] : e, h = t.nsSeparator, g = h === void 0 ? ":" : h, _ = t.loggerEnvironment, v = _ === void 0 ? "browser" : _, y = d(s, g), b = y.i18nKey, x = y.namespace, S = x === void 0 ? a?.ns ?? t.defaultNS : x, C = S && n[S] || {}, w = p(C, m(r, C, b, t, i, a), t, a), T = typeof w == "object" ? JSON.parse(JSON.stringify(w)) : w, E = T === void 0 || typeof T == "object" && !Object.keys(T).length || T === "" && !c, D = typeof a?.fallback == "string" ? [a.fallback] : a?.fallback || [];
		if (E && (v === "both" || v === (typeof window > "u" ? "node" : "browser")) && o({
			namespace: S,
			i18nKey: b
		}), E && Array.isArray(D) && D.length) {
			var O = D[0], k = D.slice(1);
			if (typeof O == "string") return f(O, i, u(u({}, a), { fallback: k }));
		}
...
function m(e, t, n, r, i, a) {
	...
	var o = `${n}_${i.count}`;
	if (p(t, o, r, a) !== void 0) return o;
	var s = `${n}_${e.select(i.count)}`;
	if (p(t, s, r, a) !== void 0) return s;
	var c = `${n}.${i.count}`;
	if (p(t, c, r, a) !== void 0) return c;
	var l = `${n}.${e.select(i.count)}`;
	return p(t, l, r, a) === void 0 ? n : l;
}
function h(e) {
...
function v(e) {
	var t = globalThis.__NEXT_TRANSLATE__ ?? {}, r = t.lang, i = t.namespaces, o = t.config, s = o.localesToIgnore || ["default"], u = !r || s.includes(r), d = function() {
		return a(f({
			config: o,
			allNamespaces: i,
			pluralRules: l(u ? void 0 : r),
			lang: r
		}), e);
	};
	return {
...
function b(e) {
	var r = t(s);
	return n(function() {
		return y(y({}, r), { t: a(r.t, e) });
	}, [r, e]);
}
function x(e) {
	return (globalThis.__NEXT_TRANSLATE__?.config ? v : b)(e);
}
//#endregion
