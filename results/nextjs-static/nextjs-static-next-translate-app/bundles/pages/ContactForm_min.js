...
function w() {
	let { t: e } = C("common"), t = n(), r = n(), o = n(), s = n();
	return /* @__PURE__ */ a("form", {
		...
		children: [
			...
			/* @__PURE__ */ a("div", { children: [/* @__PURE__ */ i("label", {
				...
				children: [
					/* @__PURE__ */ i("option", { children: "Bug Report" }),
					/* @__PURE__ */ i("option", { children: "New Benchmark Idea" }),
					/* @__PURE__ */ i("option", { children: "Methodology Question" }),
					/* @__PURE__ */ i("option", { children: "Contribution" }),
					/* @__PURE__ */ i("option", { children: "Other" })
				]
			})] }),
			/* @__PURE__ */ a("div", { children: [/* @__PURE__ */ i("label", {
				htmlFor: s,
