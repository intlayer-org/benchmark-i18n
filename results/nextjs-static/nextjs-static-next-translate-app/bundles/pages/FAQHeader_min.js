...
function b(e) {
	var t = globalThis.__NEXT_TRANSLATE__ ?? {}, r = t.lang, i = t.namespaces, a = t.config, o = a.localesToIgnore || ["default"], c = !r || o.includes(r), l = function() {
		return s(m({
			config: a,
			allNamespaces: i,
			pluralRules: d(c ? void 0 : r),
			lang: r
		}), e);
	};
	return {
