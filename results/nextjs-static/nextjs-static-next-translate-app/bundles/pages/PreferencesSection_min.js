"use client";
import e, { useContext as t, useId as n, useMemo as r } from "react";
		...
		children: [/* @__PURE__ */ i("h2", {
			...
			children: [
				...
				/* @__PURE__ */ a("div", { children: [/* @__PURE__ */ i("label", {
					...
					children: [
						/* @__PURE__ */ i("option", { children: "English (en)" }),
						/* @__PURE__ */ i("option", { children: "French (fr)" }),
						/* @__PURE__ */ i("option", { children: "German (de)" }),
						/* @__PURE__ */ i("option", { children: "Spanish (es)" }),
						/* @__PURE__ */ i("option", { children: "Japanese (ja)" }),
						/* @__PURE__ */ i("option", { children: "Chinese Simplified (zh-CN)" }),
						/* @__PURE__ */ i("option", { children: "Arabic (ar)" })
					]
				})] })
			]
		})]
