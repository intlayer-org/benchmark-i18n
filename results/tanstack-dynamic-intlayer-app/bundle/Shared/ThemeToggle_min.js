...
var f = {
	...
	en: () => import("./en-CZhSBeSE.js").then((e) => e.default),
...
}, P = process.env.INTLAYER_NODE_TYPE_INTLAYER_NODE === "false", F = process.env.INTLAYER_NODE_TYPE_REACT_NODE === "false", I = process.env.INTLAYER_NODE_TYPE_INSERTION === "false", L = P ? C : {
...
}, V = C, H = C, U = /* @__PURE__ */ new Map(), W = (e, t = !0) => {
	...
	return U.set(n, r), r;
}, G = (e, t) => A(e, t, W(t)), K = (e, t = p?.locales, n = p?.defaultLocale) => {
...
var ce = (e, t, n) => {
	...
	let { locales: s, defaultLocale: l } = p ?? {}, [d, f] = c(e ?? Y ?? t ?? l);
	a(() => {
		e && e !== d && f(e);
	}, [e]), a(() => {
		me();
	...
	let { locale: r } = i(X) ?? {}, a = o(() => n ?? r ?? p.defaultLocale, [r, n]);
...
function xe() {
	let e = ye(f, "theme-toggle"), [t, n] = c("auto");
	a(() => {
		let e = be();
		n(e), $(e);
	}, []), a(() => {
