...
var w = {
	...
	en: () => import("./intlayer-AboutHeader-wrapper-1iq9at-en-q-YQafED.js").then((e) => e.t).then((e) => e.default),
...
function ct() {
	let e = ot(A, "about-header");
	return st("AboutHeader"), f(u, { children: [d("h1", {
