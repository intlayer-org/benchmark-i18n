...
var y = {
	...
	en: () => import("./intlayer-ResultsTable-wrapper-7osmmz-en-Dt7Oe46H.js").then((e) => e.t).then((e) => e.default),
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-app/src/components/pages/home/ResultsTable.tsx";
function ct() {
	let e = st(C, "results-table"), t = [
		{
			lib: "react-i18next",
			size: e.c({ val: "42.3" }),
			time: e.h({ val: "0.12" }),
	...
	return d("section", { children: [d("h2", {
		...
		children: d("table", {
			...
			children: [d("thead", {
				...
				lineNumber: 37,
				columnNumber: 11
			}, this), d("tbody", { children: t.map((e) => d("tr", {
...
var dt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-app/src/components/pages/home/ResultsTable.wrapper.tsx";
function ft() {
