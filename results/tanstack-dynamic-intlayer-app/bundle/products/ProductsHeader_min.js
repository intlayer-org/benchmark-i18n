...
var b = {
	...
	en: () => import("./intlayer-ProductsHeader-wrapper-15vjib-en-Dtef3jty.js").then((e) => e.t).then((e) => e.default),
...
var de = (e) => {
	...
	en: () => import("./intlayer-ProductsHeader-wrapper-15vjib-en-Dtef3jty.js").then((e) => e.n).then((e) => e.default),
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-app/src/components/pages/products/ProductsHeader.tsx";
function mt() {
	let e = lt(C, "products-header");
	return f(d, { children: [
		f(pt, {}, void 0, !1, {
			fileName: $,
			lineNumber: 9,
...
var _t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-app/src/components/pages/products/ProductsHeader.wrapper.tsx";
function vt() {
