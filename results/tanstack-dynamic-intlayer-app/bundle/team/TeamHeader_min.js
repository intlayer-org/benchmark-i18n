...
var b = {
	...
	en: () => import("./intlayer-TeamHeader-wrapper-1stt4z-en-Q6Z5YGLj.js").then((e) => e.t).then((e) => e.default),
...
var de = (e) => {
	...
	en: () => import("./intlayer-TeamHeader-wrapper-1stt4z-en-Q6Z5YGLj.js").then((e) => e.n).then((e) => e.default),
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-app/src/components/pages/team/TeamHeader.tsx";
function mt() {
	let e = lt(C, "team-header");
	return f(d, { children: [
		f(pt, {}, void 0, !1, {
			fileName: $,
			lineNumber: 9,
...
var _t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-app/src/components/pages/team/TeamHeader.wrapper.tsx";
function vt() {
