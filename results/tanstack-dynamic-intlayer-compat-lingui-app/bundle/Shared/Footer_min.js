...
import { Fragment as f, jsx as p, jsxs as ee } from "react/jsx-runtime";
...
var Ne = class {
	...
	let { locales: c, defaultLocale: u } = h ?? {}, [d, f] = l(e ?? Dn ?? t ?? u);
	o(() => {
		e && e !== d && f(e);
	}, [e]), o(() => {
		Nn();
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/Footer.tsx";
function Vn() {
	let { i18n: e } = Bn(S, "footer"), t = (t) => e._(`${t}`), n = d({ strict: !1 }).locale ?? "en", r = [
		{
			label: t("github"),
			...
			children: [m("div", {
				...
				children: [
					...
					m("div", { children: [m("h3", {
						...
						className: "space-y-1",
						children: r.map((e) => m("li", { children: e.isInternal ? m(u, {
							preload: !1,
							to: e.to,
							params: { locale: n },
...
var Gn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/Footer.wrapper.tsx";
function Kn() {
	return m(Wn, { children: m(Vn, {}, void 0, !1, {
		fileName: Gn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
