...
var Z = {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), Xt = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: a, disableEditor: s, isCookieEnabled: c }) => {
...
function nn() {
	let { i18n: e } = $t(), t = (t) => e._(`footer.${t}`), n = c({ strict: !1 }).locale ?? "en", r = [
		{
			label: t("github"),
			...
			children: [d("div", {
				...
				children: [
					...
					d("div", { children: [d("h3", {
						...
						className: "space-y-1",
						children: r.map((e) => d("li", { children: e.isInternal ? d(s, {
							preload: !1,
							to: e.to,
							params: { locale: n },
...
var sn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/Footer.wrapper.tsx";
function cn() {
	return d(on, { children: d(nn, {}, void 0, !1, {
		fileName: sn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
