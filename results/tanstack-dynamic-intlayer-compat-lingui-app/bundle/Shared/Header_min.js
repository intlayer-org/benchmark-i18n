...
sn({ locale: "en" });
var cn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/ThemeToggle.tsx";
function ln() {
...
function un() {
	let { i18n: e } = an(), t = (t) => e._(`theme-toggle.${t}`), [n, i] = s("auto");
	r(() => {
		let e = ln();
		i(e), Z(e);
	}, []), r(() => {
	...
	function a() {
		...
		i(e), Z(e), window.localStorage.setItem("theme", e);
	}
...
function gn() {
	let { i18n: e } = an(), t = (t) => e._(`header.${t}`);
	hn("Header");
...
var _n = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
...
var yn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/Header.wrapper.tsx";
function bn() {
