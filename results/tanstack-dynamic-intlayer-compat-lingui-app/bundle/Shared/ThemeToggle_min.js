...
Mn({ locale: "en" });
var Nn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/ThemeToggle.tsx";
function Pn() {
...
function Fn() {
	let { i18n: e } = jn([x, "theme-toggle"]), t = (t) => e._(`theme-toggle.${t}`), [n, r] = l("auto");
	o(() => {
		let e = Pn();
		r(e), $(e);
	}, []), o(() => {
...
var zn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/ThemeToggle.wrapper.tsx";
function Bn() {
	return f(Rn, { children: f(Fn, {}, void 0, !1, {
		fileName: zn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
