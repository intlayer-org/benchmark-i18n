...
}, re = ["en"], g = "\x1B[0m", _ = "\x1B[34m", v = "\x1B[31m", ie = "\x1B[32m", ae = "\x1B[38;5;3m", oe = "__intlayerPreloaded", se = (e = {}) => ({
	...e,
	defaultLocale: e.defaultLocale ?? p?.defaultLocale ?? "en",
	mode: e.mode ?? m?.mode ?? "prefix-no-default",
	locales: e.locales ?? p?.locales ?? re,
...
}), S = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? g : n : g}` : e, De = (e, t = ae, n = g) => [e].flat().map((e) => S(e, t, n)).join(", ");
S("✗", v), S("✓", ie), S("⏲", _);
var Oe = (e) => {
...
var je = t(null), Me = class {
...
}, Ie = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(Fe).join("") : String(e ?? ""), Le = "translation", O = "enumeration", k = "plural", Re = "condition", A = "insertion", ze = "object", Be = "array", Ve = "markdown", j = "html", M = "gender", N = "select", P = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), F = (e, t, n) => ({
...
})() }), Je = (e) => P(k, e), Ye = (e, t) => P(N, e, { variable: t }), Xe = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, et = (e, t) => e[$e(e, t) ?? "fallback"], tt = (e, t, n) => e[x("PluralRules", n).select(t)] ?? e.other, nt = (e, t) => {
	...
	if (r.nodeType === "plural") {
		let e = r[k];
		return W(tt(e, Number(U(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[O], i = rt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
}, K = /* @__PURE__ */ new Map(), ut = (e, t) => (K.has(e) || K.set(e, lt(t)), K.get(e).read()), dt = /* @__PURE__ */ new Map(), ft = (e, t) => Object.create(new Proxy(e, {
	get: (e, t, n) => {
	...
	let n = `p${gt}`;
	return ht.set(e, n), n;
}, vt = 256, q = /* @__PURE__ */ new WeakMap(), yt = (e) => typeof e == "object" && !!e, bt = (e, t, n) => `${e}_${t}_${_t(n)}`, xt = (e, t) => {
	...
	if (!yt(e)) return n;
	let r = q.get(e);
	return r || (r = /* @__PURE__ */ new Map(), q.set(e, r)), r.size >= vt && r.clear(), r.set(t, n), n;
	...
	let r = Ct()[e];
	return r ? Yt(r, t, n) : (Et.has(e) || (Ee({ log: h })(typeof window > "u" ? `Dictionary ${De(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Et.add(e)), Tt(e));
}, Ot = (e) => {
	...
	if (typeof e == "string") return e;
	if (Y(e)) return e.nodeType === "html" ? e[j] : e[Ve];
}, Mt = (e, t) => {
	if (typeof e == "string") return t;
	if (Y(e)) {
		let n = e.nodeType === "html" ? j : Ve;
		return {
			...e,
			[n]: t
		};
...
}, Ft = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? X : {
...
}, It = X, Lt = (e) => X, Rt = X, zt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? X : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: A }], i = e[A], a = {
			...
			transform: (e, n, r) => {
				if (Y(e)) return (i) => Nt(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, Ht = (e, t) => typeof t == "function" && Bt.includes(e?.nodeType ?? "") ? (n) => Vt(e, t, n) : t, Ut = X, Wt = X, Gt = (e) => X, Kt = X, qt = (e, t = !0) => [
	...
	Ut,
	Wt
].filter((e) => e !== X), Jt = (e, t, n = []) => I(e, {
	...t,
	plugins: n
}), Z = /* @__PURE__ */ new WeakSet(), Yt = (e, t, n) => {
...
}, rn = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? X : {
	id: "insertion-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "insertion",
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: A }], i = e[A], a = {
...
}, an = X, on = X, Q = /* @__PURE__ */ new Map(), sn = (e, t = !0) => {
	...
	return Q.set(n, r), r;
}, cn = (e, t) => Yt(e, t, sn(typeof t == "object" && t ? t.locale : t)), ln = he, un = (e, t) => ge(e, {
	...y,
	isCookieEnabled: t
}), dn = () => {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), pn = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: s, isCookieEnabled: u }) => {
	let { locales: f, defaultLocale: ee } = p ?? {}, [m, h] = l(() => e ?? ln() ?? t ?? ee), [te, ne] = l(e);
	e !== te && (ne(e), e && e !== m && h(e)), o(() => {
		dn();
	}, []);
	let re = i((e) => {
...
}), { defaultLocale: hn, locales: $ } = p ?? {}, gn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let n = new G({ locale: e }).bindDictionaries(t);
	return {
		i18n: n,
		_: n._.bind(n)
	};
}, vn = ([e, t], n) => cn(Xt(e, n) ?? ut(`${t}.${n}`, e[n]?.()), n), yn = (...e) => {
	let { locale: t } = gn(), n = t ?? p.defaultLocale, r = e.map(([, e]) => e).join("\0");
	return c(() => _n(n, Object.fromEntries(e.map((e) => [e[1], vn(e, n)]))), [n, r]);
}, bn = () => {
	try {
...
function Dn() {
	let { i18n: e } = yn([w, "about-header"]), t = (t) => e._(`about-header.${t}`);
