...
var Ae = (e) => {
	...
	en: () => import("./intlayer-BlogList-wrapper-3drhlu-en-5IJo5s7-.js").then((e) => e.t).then((e) => e.default),
...
function Nn() {
	let { i18n: e } = jn([x, "blog-list"]), t = (t) => e._(`blog-list.${t}`), n = [
		{
...
var Ln = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/blog/BlogList.wrapper.tsx";
function Rn() {
