...
var content = {
	...
	"en": () => import("./intlayer-CareersBenefits-wrapper-1m1elv-en-C0AAvG0b.js").then((n) => n.t).then((m) => m.default),
...
setupI18n({ locale: "en" });
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/careers/CareersBenefits.tsx";
function CareersBenefits() {
	const { i18n } = useDictionaryDynamic([content, "careers-benefits"]);
	const benefits = [{
		label: i18n._({
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/careers/CareersBenefits.wrapper.tsx";
function Wrapped() {
