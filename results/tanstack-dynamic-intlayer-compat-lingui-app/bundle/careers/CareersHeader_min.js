...
function rn() {
	let { i18n: e } = $t(), t = (t) => e._(`careers-header.${t}`);
	return u(l, { children: [
		u(nn, {}, void 0, !1, {
			fileName: $,
			lineNumber: 10,
...
var cn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/careers/CareersHeader.wrapper.tsx";
function ln() {
