...
var content$1 = {
	...
	"en": () => import("./intlayer-ContactHeader-wrapper-bb5lr-en-CCT8vm8j.js").then((n) => n.n).then((m) => m.default),
...
var content = {
	...
	"en": () => import("./intlayer-ContactHeader-wrapper-bb5lr-en-CCT8vm8j.js").then((n) => n.t).then((m) => m.default),
...
function ContactHeader() {
	const { i18n } = useDictionaryDynamic(content$1, "contact-header");
