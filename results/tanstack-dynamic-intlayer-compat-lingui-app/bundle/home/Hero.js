...
var content$1 = {
	...
	"en": () => import("./intlayer-Hero-wrapper-12fequ-en-q_nZeKz-.js").then((n) => n.t).then((m) => m.default),
...
var content = {
	...
	"en": () => import("./intlayer-Hero-wrapper-12fequ-en-q_nZeKz-.js").then((n) => n.n).then((m) => m.default),
...
function Hero() {
	const { i18n } = useDictionaryDynamic([content$1, "hero"], [content, "header"]);
