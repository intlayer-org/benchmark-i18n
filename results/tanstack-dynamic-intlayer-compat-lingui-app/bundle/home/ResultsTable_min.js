...
var Ae = (e) => {
	...
	en: () => import("./intlayer-ResultsTable-wrapper-b4waxt-en-BXLDRvPX.js").then((e) => e.t).then((e) => e.default),
...
Mn({ locale: "en" });
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/home/ResultsTable.tsx";
function Nn() {
	let { i18n: e } = jn([x, "results-table"]), t = (t) => e._(`results-table.${t}`);
...
var Ln = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/home/ResultsTable.wrapper.tsx";
function Rn() {
