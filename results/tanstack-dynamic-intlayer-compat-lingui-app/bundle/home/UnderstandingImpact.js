...
var content = {
	...
	"en": () => import("./intlayer-UnderstandingImpact-wrapper-8tdyxn-en-7VWWwoy7.js").then((n) => n.t).then((m) => m.default),
...
function UnderstandingImpact() {
	const { i18n } = useDictionaryDynamic([content, "understanding-impact"]);
