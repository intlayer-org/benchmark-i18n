...
function en() {
	let { i18n: e } = Zt(), t = (t) => e._(`understanding-impact.${t}`);
	return l("section", {
			...
			l("div", {
				...
				children: [
					...
					l("ul", {
						...
						children: [
							l("li", { children: t("theJsonMustBeParsed") }, void 0, !1, {
								fileName: $,
								lineNumber: 21,
								columnNumber: 11
							}, this),
							l("li", { children: t("contextBasedArchitecturesCanCause") }, void 0, !1, {
								fileName: $,
								lineNumber: 22,
								columnNumber: 11
							}, this),
							l("li", { children: t("duringServerSideRenderingThe") }, void 0, !1, {
								fileName: $,
								lineNumber: 23,
								columnNumber: 11
							}, this)
...
var an = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/home/UnderstandingImpact.wrapper.tsx";
function on() {
