...
function Tn() {
	let { i18n: e } = vn([T, "understanding-impact"]), t = (t) => e._(`understanding-impact.${t}`);
	return d("section", {
			...
			d("div", {
				...
				children: [
					...
					d("ul", {
						...
						children: [
							u("li", { children: t("theJsonMustBeParsed") }),
							u("li", { children: t("contextBasedArchitecturesCanCause") }),
							u("li", { children: t("duringServerSideRenderingThe") })
						]
					})
				]
			}),
