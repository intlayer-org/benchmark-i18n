...
var content = {
	"de": () => import("../../../../.intlayer/dynamic_dictionary/json/why-it-matters/de.json").then((m) => m.default),
	"en": () => import("./intlayer-WhyItMatters-wrapper-1s5uvk-en-C2VPbTNp.js").then((n) => n.t).then((m) => m.default),
	"es": () => import("../../../../.intlayer/dynamic_dictionary/json/why-it-matters/es.json").then((m) => m.default),
	"fr": () => import("../../../../.intlayer/dynamic_dictionary/json/why-it-matters/fr.json").then((m) => m.default),
	"it": () => import("../../../../.intlayer/dynamic_dictionary/json/why-it-matters/it.json").then((m) => m.default),
	"ja": () => import("../../../../.intlayer/dynamic_dictionary/json/why-it-matters/ja.json").then((m) => m.default),
	"ko": () => import("../../../../.intlayer/dynamic_dictionary/json/why-it-matters/ko.json").then((m) => m.default),
	"pt": () => import("../../../../.intlayer/dynamic_dictionary/json/why-it-matters/pt.json").then((m) => m.default),
	"ru": () => import("../../../../.intlayer/dynamic_dictionary/json/why-it-matters/ru.json").then((m) => m.default),
	"zh": () => import("../../../../.intlayer/dynamic_dictionary/json/why-it-matters/zh.json").then((m) => m.default)
};
...
setupI18n({ locale: "en" });
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/home/WhyItMatters.tsx";
function WhyItMatters() {
	const { i18n } = useDictionaryDynamic([content, "why-it-matters"]);
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/home/WhyItMatters.wrapper.tsx";
function Wrapped() {
