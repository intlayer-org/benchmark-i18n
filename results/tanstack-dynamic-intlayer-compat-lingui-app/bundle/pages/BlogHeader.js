...
var content$2 = {
	...
	"en": () => import("./intlayer-BlogHeader-wrapper-1bq6ml-en-Bq2cmay1.js").then((n) => n.r).then((m) => m.default),
...
var content$1 = {
	...
	"en": () => import("./intlayer-BlogHeader-wrapper-1bq6ml-en-Bq2cmay1.js").then((n) => n.n).then((m) => m.default),
...
var content = {
	...
	"en": () => import("./intlayer-BlogHeader-wrapper-1bq6ml-en-Bq2cmay1.js").then((n) => n.t).then((m) => m.default),
...
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/blog/BlogHeader.tsx";
function BlogHeader() {
	const { i18n } = useDictionaryDynamic(content$2, "blog-header"), { i18n: _header } = useDictionaryDynamic(content$1, "header");
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/blog/BlogHeader.wrapper.tsx";
function Wrapped() {
...
var key$2 = "blog-header";
var content$2 = { "insightsTutorialsAndAnalysisFrom": "Insights, tutorials, and analysis from the i18n community." };
var en_default$2 = {
	key: key$2,
	content: content$2
};
