...
var content$1 = {
	...
	"en": () => import("./intlayer-CareersHeader-wrapper-f709e9-en-JQzHsMS7.js").then((n) => n.n).then((m) => m.default),
...
var content = {
	...
	"en": () => import("./intlayer-CareersHeader-wrapper-f709e9-en-JQzHsMS7.js").then((n) => n.t).then((m) => m.default),
...
function CareersHeader() {
	const { i18n } = useDictionaryDynamic([content$1, "careers-header"]);
