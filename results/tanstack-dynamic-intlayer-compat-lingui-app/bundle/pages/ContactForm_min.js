...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/contact/ContactForm.tsx";
function Bn() {
	let { i18n: e } = zn(C, "contact-form"), t = (t) => e._(`${t}`), n = s(), r = s(), i = s(), a = s();
	return m("form", {
		className: "space-y-6",
		children: [
			m("div", {
...
var Wn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/contact/ContactForm.wrapper.tsx";
function Gn() {
