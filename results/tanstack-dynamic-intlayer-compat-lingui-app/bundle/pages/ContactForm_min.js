...
function En() {
	let { i18n: e } = yn([E, "contact-form"]), t = (t) => e._(`contact-form.${t}`), n = s(), r = s(), i = s(), a = s();
	return f("form", {
		className: "space-y-6",
		children: [
			f("div", {
			...
			f("div", { children: [d("label", {
				...
				children: [
					d("option", { children: t("bugReport") }),
					d("option", { children: t("newBenchmarkIdea") }),
					d("option", { children: t("methodologyQuestion") }),
