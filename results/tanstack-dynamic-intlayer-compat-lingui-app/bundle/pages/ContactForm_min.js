...
nn({ locale: "en" });
function rn() {
	let { i18n: e } = en(), t = (t) => e._(`contact-form.${t}`), n = i(), r = i(), a = i(), o = i();
	return l("form", {
		className: "space-y-6",
		children: [
			l("div", {
			...
			l("div", { children: [c("label", {
				...
				children: [
					c("option", { children: t("bugReport") }),
					c("option", { children: t("newBenchmarkIdea") }),
					c("option", { children: t("methodologyQuestion") }),
					c("option", { children: "Contribution" }),
