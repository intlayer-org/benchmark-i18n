...
function tn() {
	let { i18n: e } = $t(), t = (t) => e._(`contact-form.${t}`), n = i(), r = i(), a = i(), o = i();
	return u("form", {
		className: "space-y-6",
		children: [
			u("div", {
			...
			u("div", { children: [u("label", {
				...
				children: [
					u("option", { children: t("bugReport") }, void 0, !1, {
						fileName: $,
						lineNumber: 55,
						columnNumber: 11
					}, this),
					u("option", { children: t("newBenchmarkIdea") }, void 0, !1, {
						fileName: $,
						lineNumber: 56,
						columnNumber: 11
					}, this),
					u("option", { children: t("methodologyQuestion") }, void 0, !1, {
						fileName: $,
						lineNumber: 57,
						columnNumber: 11
					}, this),
...
var on = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/contact/ContactForm.wrapper.tsx";
function sn() {
