...
var Ae = (e) => {
	...
	en: () => import("./intlayer-ContactHeader-wrapper-bb5lr-en-Dk-w8mVr.js").then((e) => e.n).then((e) => e.default),
...
var X = {
	...
	en: () => import("./intlayer-ContactHeader-wrapper-bb5lr-en-Dk-w8mVr.js").then((e) => e.t).then((e) => e.default),
...
}, Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/contact/ContactHeader.tsx";
function Bn() {
	let { i18n: e } = Fn([C, "contact-header"]), t = (t) => e._(`contact-header.${t}`);
	return p(f, { children: [
		p(zn, {}, void 0, !1, {
			fileName: Q,
			lineNumber: 10,
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/contact/ContactHeader.wrapper.tsx";
function Wn() {
