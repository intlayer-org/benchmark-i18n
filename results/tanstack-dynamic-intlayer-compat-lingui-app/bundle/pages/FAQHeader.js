...
var content$1 = {
	"de": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/de.json").then((m) => m.default),
	"en": () => import("./intlayer-FAQHeader-wrapper-1d2u3z-en-DjGT9qnr.js").then((n) => n.n).then((m) => m.default),
	"es": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/es.json").then((m) => m.default),
	"fr": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/fr.json").then((m) => m.default),
	"it": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/it.json").then((m) => m.default),
	"ja": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/ja.json").then((m) => m.default),
	"ko": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/ko.json").then((m) => m.default),
	"pt": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/pt.json").then((m) => m.default),
	"ru": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/ru.json").then((m) => m.default),
	"zh": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/zh.json").then((m) => m.default)
};
...
var content = {
	...
	"en": () => import("./intlayer-FAQHeader-wrapper-1d2u3z-en-DjGT9qnr.js").then((n) => n.t).then((m) => m.default),
...
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/faq/FAQHeader.tsx";
function FAQHeader() {
	const { i18n } = useDictionaryDynamic([content$1, "faq-header1"]);
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/faq/FAQHeader.wrapper.tsx";
function Wrapped() {
...
var key = "mockBanner";
var content = "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service.";
var en_default = {
	key,
	content
};
