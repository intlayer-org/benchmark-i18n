...
var content = {
	...
	"en": () => import("./intlayer-FAQList-wrapper-12lsq7-en-AxbEK1QI.js").then((n) => n.t).then((m) => m.default),
...
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/faq/FAQList.tsx";
function FAQList() {
	const { i18n } = useDictionaryDynamic(content, "faq-list");
	const faqs = [
		{
			q: i18n._({
				id: "whatIsI18nBenchmark",
				message: "What is i18n Benchmark?"
			}),
			a: i18n._({
				id: "whatIsI18nBenchmarkAnswer",
		...
		{
			q: i18n._({
				id: "howAreBenchmarksConducted",
				message: "How are benchmarks conducted?"
			}),
			a: i18n._({
				id: "weRunStandardizedTestsIn",
		...
		{
			q: i18n._({
				id: "whichLibrariesAreCurrentlySupported",
				message: "Which libraries are currently supported?"
			}),
			a: i18n._({
				id: "weSupportReactI18nextReact",
		...
		},
		{
			...
			a: i18n._({
				id: "yesCommunityBenchmarkSubmissionsAre",
		...
		{
			q: i18n._({
				id: "howOftenAreBenchmarksUpdated",
				message: "How often are benchmarks updated?"
			}),
			a: i18n._({
				id: "weReRunAllBenchmarks",
		...
		{
			q: i18n._({
				id: "isTheDataReliable",
				message: "Is the data reliable?"
			}),
			a: i18n._({
				id: "weFollowRigorousStatisticalMethodology",
		...
		{
			q: i18n._({
				id: "doYouOfferConsultingServices",
				message: "Do you offer consulting services?"
			}),
			a: i18n._({
				id: "yesOurEnterprisePlanIncludes",
		...
		{
			q: i18n._({
				id: "howCanIContribute",
				message: "How can I contribute?"
			}),
			a: i18n._({
				id: "thereAreManyWaysTo",
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/faq/FAQList.wrapper.tsx";
function Wrapped() {
