...
var Me = class {
...
}, O = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(Ne).join("") : String(e ?? ""), Pe = "translation", k = "enumeration", Fe = "plural", A = "insertion", Ie = "object", Le = "array", Re = "markdown", j = "html", ze = "gender", Be = "select", M = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), N = (e, t) => {
...
}, $e = (e, t) => e[Qe(e, t) ?? "fallback"], et = (e, t, n) => e[v("PluralRules", n).select(t)] ?? e.other, tt = (e, t) => {
	...
	if (r.nodeType === "enumeration") {
		let e = r[k], i = nt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	let r = kt()[e];
	return r ? Zt(r, t, n) : (Mt.has(e) || (Oe({ log: ne })(typeof window > "u" ? `Dictionary ${ke(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Mt.add(e)), jt(e));
}, Pt = (e) => {
	...
	let { locale: r, selector: i } = Dt(t), a = ht(r ?? m.defaultLocale, Ot(i), n), o = gt(e, a);
	...
	return X.set(n, r), r;
}, _n = (e, t) => Zt(e, t, gn(typeof t == "object" && t ? t.locale : t)), vn = _e(_), yn = (e, t) => ve(e, {
	..._,
	isCookieEnabled: t
}), bn = () => {
	...
	let { locales: c, defaultLocale: ee } = m ?? {}, [d, f] = l(e ?? vn ?? t ?? ee);
	o(() => {
		e && e !== d && f(e);
	}, [e]), o(() => {
		wn();
...
}), { defaultLocale: Dn, locales: Q } = m ?? {}, On = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let { locale: t } = On(), n = t ?? m.defaultLocale, r = e.map(([, e]) => e).join("\0");
	return s(() => An(n, Object.fromEntries(e.map((e) => [e[1], jn(e, n)]))), [n, r]);
}, Nn = (e) => new ct({
	...e,
	registry: on()
});
Nn({ locale: "en" });
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/careers/OpenPositions.tsx";
function Pn() {
	let { i18n: e } = Mn([S, "open-positions"]), t = [
		{
			title: e._({
...
var Rn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/careers/OpenPositions.wrapper.tsx";
function zn() {
	return p(Ln, { children: p(Pn, {}, void 0, !1, {
		fileName: Rn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
