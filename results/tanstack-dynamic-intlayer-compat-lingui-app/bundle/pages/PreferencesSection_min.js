...
var Oe = (e) => {
	...
	en: () => import("./intlayer-PreferencesSection-wrapper-14fy5l-en-CvbyTym8.js").then((e) => e.t).then((e) => e.default),
...
var Ne = class {
	...
	let r = Rt()[e];
	return r ? on(r, t, n) : (Vt.has(e) || (Ee({ log: te })(typeof window > "u" ? `Dictionary ${De(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Vt.add(e)), Bt(e));
}, q = (e) => {
	...
	let { locales: c, defaultLocale: l } = h ?? {}, [d, p] = u(e ?? En ?? t ?? l);
	o(() => {
		e && e !== d && p(e);
	}, [e]), o(() => {
		Mn();
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/settings/PreferencesSection.tsx";
function Bn() {
	let { i18n: e } = zn(C, "preferences-section"), t = s();
	return m("section", {
			...
			children: [
				m("div", {
					...
					children: [m("div", { children: [m("p", {
						...
						children: e._({
							id: "receiveWeeklyBenchmarkReports",
						...
						children: m("span", { className: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" }, void 0, !1, {
							fileName: $,
							lineNumber: 28,
							columnNumber: 13
						}, this)
				...
				m("div", {
					...
					children: [m("div", { children: [m("p", {
						...
						children: m("span", { className: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" }, void 0, !1, {
							fileName: $,
							lineNumber: 45,
							columnNumber: 13
						}, this)
...
var Wn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/settings/PreferencesSection.wrapper.tsx";
function Gn() {
