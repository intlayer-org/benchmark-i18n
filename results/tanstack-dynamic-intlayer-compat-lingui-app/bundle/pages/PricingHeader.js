...
var content$1 = {
	...
	"en": () => import("./intlayer-PricingHeader-wrapper-a94lsv-en-DXAaZ3-z.js").then((n) => n.t).then((m) => m.default),
...
var content = {
	...
	"en": () => import("./intlayer-PricingHeader-wrapper-a94lsv-en-DXAaZ3-z.js").then((n) => n.n).then((m) => m.default),
...
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/pricing/PricingHeader.tsx";
function PricingHeader() {
	const { i18n } = useDictionaryDynamic(content$1, "pricing-header");
	const t = (id) => i18n._(`${id}`);
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/pricing/PricingHeader.wrapper.tsx";
function Wrapped() {
