...
var ke = (e) => {
	...
	en: () => import("./intlayer-PricingTiers-wrapper-1j25iy-en-DMBxXzru.js").then((e) => e.t).then((e) => e.default),
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/pricing/PricingTiers.tsx";
function zn() {
	let { i18n: e } = Rn(x, "pricing-tiers"), t = [
		{
			name: e._({
				id: "starter",
				message: "Starter"
		...
		children: t.map((e) => p("div", {
			...
			children: [
				...
				p("ul", {
					...
					children: e.features.map((e, t) => p("li", {
...
var Un = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/pricing/PricingTiers.wrapper.tsx";
function Wn() {
