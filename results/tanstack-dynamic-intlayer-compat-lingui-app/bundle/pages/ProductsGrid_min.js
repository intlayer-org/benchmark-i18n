...
}, p = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(ee).join("") : String(e ?? ""), m = "translation", h = "enumeration", g = "plural", _ = "condition", v = "insertion", y = "object", te = "array", ne = "markdown", b = "html", x = "gender", S = "select", C = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), w = (e, t, n) => ({
...
})() }), le = (e) => C(g, e), ue = (e, t) => C(S, e, { variable: t }), de = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, _e = 50, ve = /* @__PURE__ */ new Map(), N = /* @__PURE__ */ new Set(), ye = (e) => {
...
function P(e, t, n) {
	let r = t ?? j?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = ve.get(a);
...
var Se = (e, t, n) => e[P("PluralRules", n).select(t)] ?? e.other, Ce = (e, t) => {
	...
	if (r.nodeType === "plural") {
		let e = r[g];
		return L(Se(e, Number(I(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[h], i = we.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[S], i = I(t, typeof r.variable == "string" ? r.variable : "value");
		return L(Ce(e, String(i ?? "")), t, n);
	}
...
}, De = ((e) => (t, n = {}, r = "en") => R(typeof t == "string" ? e(t) : t, n, r))(pe), Oe = (e) => {
	let t = e.indexOf(".");
	return t === -1 ? {
		dictionaryKey: e,
		remainder: ""
	...
	_(e, t, n) {
		...
		return (c.kind === "node" ? R(c.node, o, s) : De(c.message, o, s)) ?? i;
	}
...
}, W = !1, Ae, je = () => typeof window > "u" ? U(H) : (W ||= (Ae = U(H), !0), Ae), Me = (e, t) => {
	if (t?.isCookieEnabled !== !1 && (W = !1, !V && M.storage.cookies)) for (let n = 0; n < M.storage.cookies.length; n++) {
...
var Ye = () => ({}), Xe = /* @__PURE__ */ new Set([
	...
	if (typeof e == "string") return e;
	if (Y(e)) return e.nodeType === "html" ? e[b] : e[ne];
}, it = (e, t) => {
	...
	st(e ?? j.defaultLocale, t ? j.defaultLocale : void 0),
	ct,
	lt(e ?? j.defaultLocale),
	ut,
	dt,
	_t(e ?? j.defaultLocale),
	vt,
	ht,
	gt
].filter((e) => e !== X), bt = (e, t, n = []) => T(e, {
	...t,
	plugins: n
	...
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = Re(r ?? j.defaultLocale, "", n), o = ze(e, a);
...
}, Tt = (e, t = j?.locales, n = j?.defaultLocale) => {
...
}), { defaultLocale: kt, locales: Q } = j ?? {}, At = ({ isCookieEnabled: e, onLocaleChange: r } = {}) => {
