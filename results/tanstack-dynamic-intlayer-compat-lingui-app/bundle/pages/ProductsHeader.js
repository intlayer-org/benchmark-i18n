...
var content$2 = {
	...
	"en": () => import("./intlayer-ProductsHeader-wrapper-pky9jj-en-C7yUkJQN.js").then((n) => n.r).then((m) => m.default),
...
var content$1 = {
	...
	"en": () => import("./intlayer-ProductsHeader-wrapper-pky9jj-en-C7yUkJQN.js").then((n) => n.t).then((m) => m.default),
...
var content = {
	...
	"en": () => import("./intlayer-ProductsHeader-wrapper-pky9jj-en-C7yUkJQN.js").then((n) => n.n).then((m) => m.default),
...
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/products/ProductsHeader.tsx";
function ProductsHeader() {
	const { i18n } = useDictionaryDynamic(content$2, "header"), { i18n: _productsHeader } = useDictionaryDynamic(content$1, "products-header");
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/products/ProductsHeader.wrapper.tsx";
function Wrapped() {
...
var content = { "toolsAndServicesToStreamline": "Tools and services to streamline your internationalization workflow." };
var en_default = {
	key,
	content
};
