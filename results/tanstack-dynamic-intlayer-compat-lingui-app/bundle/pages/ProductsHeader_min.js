...
var Me = class {
...
}, Ie = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(Fe).join("") : String(e ?? ""), Le = "translation", Re = "enumeration", ze = "plural", k = "insertion", Be = "object", Ve = "array", He = "markdown", A = "html", Ue = "gender", We = "select", j = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), M = (e, t) => {
...
})() }), Ze = (e) => j(ze, e), Qe = (e, t) => j(We, e, { variable: t }), $e = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, rt = (e, t) => e[nt(e, t) ?? "fallback"], it = (e, t, n) => e[y("PluralRules", n).select(t)] ?? e.other, at = (e, t) => {
	...
	if (r.nodeType === "html") return B(r[A], t, n);
	if (r.nodeType === "plural") {
		let e = r[ze];
		return B(it(e, Number(z(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[Re], i = ot.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[We], i = z(t, typeof r.variable == "string" ? r.variable : "value");
...
}, lt = ((e) => (t, n = {}, r = "en") => V(typeof t == "string" ? e(t) : t, n, r))(tt), ut = (e) => {
	let t = e.indexOf(".");
	return t === -1 ? {
		dictionaryKey: e,
		remainder: ""
	...
	_(e, t, n) {
		...
		return (c.kind === "node" ? V(c.node, o, s) : lt(c.message, o, s)) ?? i;
	}
...
}, ft = t(null), pt = /* @__PURE__ */ new WeakMap(), mt = 0, ht = (e) => {
	if (!e) return "base";
	let t = pt.get(e);
	if (t) return t;
	mt += 1;
	...
	let r = Nt()[e];
	return r ? tn(r, t, n) : (It.has(e) || (De({ log: te })(typeof window > "u" ? `Dictionary ${Oe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), It.add(e)), Ft(e));
}, Rt = (e) => {
	...
	if (typeof e == "string") return e;
	if (K(e)) return e.nodeType === "html" ? e[A] : e[He];
}, Ht = (e, t) => {
	if (typeof e == "string") return t;
	if (K(e)) {
		let n = e.nodeType === "html" ? A : He;
		return {
			...e,
			[n]: t
		};
	...
	canHandle: () => !1,
	transform: (e) => e
}, Wt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? q : {
...
}, Gt = q, Kt = (e) => q, qt = q, Jt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? q : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: k }], i = e[k], a = {
			...
			transform: (e, n, r) => {
				if (K(e)) return (i) => Ut(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, Yt = q, Xt = q, Zt = (e) => q, Qt = q, $t = (e, t = !0) => [
	Wt(e ?? h.defaultLocale, t ? h.defaultLocale : void 0),
	Gt,
	qt,
	Jt,
	...
	let { locale: r, selector: i } = jt(t), a = vt(r ?? h.defaultLocale, Mt(i), n), o = yt(e, a);
	if (o.hit) return o.content;
	let s = n ?? $t(r), c = At(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
}, rn = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", an = /\{\{\s*(.*?)\s*\}\}/g, on = (e, t = {}) => {
	if (!Object.values(t).some(rn)) return {
		isSimple: !0,
		parts: e.replace(an, (e, n) => (t[n.trim()] ?? "").toString())
	};
	let n = e.split(an), r = [];
...
}, J = /* @__PURE__ */ new Map(), fn = (e, t) => (J.has(e) || J.set(e, dn(t)), J.get(e).read()), pn = ({ children: e, value: t, additionalProps: n }) => {
...
}, _n = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? q : {
	id: "insertion-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "insertion",
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: k }], i = e[k], a = {
...
}, vn = q, yn = q, Y = /* @__PURE__ */ new Map(), bn = (e, t = !0) => {
	let n = `${e ?? h.defaultLocale}_${t}`;
	if (Y.has(n)) return Y.get(n);
	let r = [
		Wt(e ?? h.defaultLocale, t ? h.defaultLocale : void 0),
		Gt,
		Kt(e ?? h.defaultLocale),
		qt,
		Zt(e ?? h.defaultLocale),
		Qt,
		Yt,
	...
	return Y.set(n, r), r;
}, xn = (e, t) => tn(e, t, bn(typeof t == "object" && t ? t.locale : t)), Sn = ge(v), Cn = (e, t) => _e(e, {
	...v,
	isCookieEnabled: t
}), wn = () => {
	...
	locale: Sn ?? h?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), kn = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: i, disableEditor: a, isCookieEnabled: s }) => {
	let { locales: c, defaultLocale: u } = h ?? {}, [f, p] = l(e ?? Sn ?? t ?? u);
	o(() => {
		e && e !== f && p(e);
	}, [e]), o(() => {
		On();
...
}), { defaultLocale: jn, locales: Z } = h ?? {}, Mn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
}, Fn = ([e, t], n) => xn(nn(e, n) ?? fn(`${t}.${n}`, e[n]?.()), n), In = (...e) => {
	let { locale: t } = Mn(), n = t ?? h.defaultLocale, r = e.map(([, e]) => e).join("\0");
	return s(() => Pn(n, Object.fromEntries(e.map((e) => [e[1], Fn(e, n)]))), [n, r]);
}, Ln = (e) => new dt({
	...e,
	registry: un()
});
...
typeof window < "u" && typeof zn == "function" && zn().then((e) => {
	Q.__intlayerPreloaded = {
		locale: Rn,
		dictionary: e
	};
}, () => void 0);
var Bn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/MockBanner.tsx", Vn = () => {
	let { i18n: e } = In([Q, "mockBanner"]);
	return m("div", {
...
function Hn() {
	let { i18n: e } = In([C, "header"], [E, "products-header"]);
	return m(p, { children: [
		m(Vn, {}, void 0, !1, {
			fileName: $,
			lineNumber: 8,
...
var Kn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/products/ProductsHeader.wrapper.tsx";
function qn() {
