import { Fragment, createContext, createElement, isValidElement, useCallback, useContext, useEffect, useId, useMemo, useRef, useState } from "react";
...
var content = {
	...
	"en": () => import("./intlayer-ProfileSection-wrapper-1yyk8z-en-DH7-F0Ic.js").then((n) => n.t).then((m) => m.default),
...
setupI18n({ locale: "en" });
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/settings/ProfileSection.tsx";
function ProfileSection() {
	const { i18n } = useDictionaryDynamic([content, "profile-section"]);
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/settings/ProfileSection.wrapper.tsx";
function Wrapped() {
...
var content = { "displayName": "Display Name" };
var en_default = {
	key,
	content
};
