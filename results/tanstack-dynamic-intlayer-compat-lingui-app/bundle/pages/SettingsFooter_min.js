...
var ke = (e) => {
	...
	en: () => import("./intlayer-SettingsFooter-wrapper-1rfzcy-en-BzWMKWSf.js").then((e) => e.t).then((e) => e.default),
...
var Pe = class {
	...
	let r = Lt()[e];
	return r ? on(r, t, n) : (Bt.has(e) || (De({ log: te })(typeof window > "u" ? `Dictionary ${Oe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Bt.add(e)), zt(e));
}, Ht = (e) => {
	...
	return X.set(n, r), r;
}, Z = (e, t) => on(e, t, wn(typeof t == "object" && t ? t.locale : t)), Tn = ge(_), En = (e, t) => _e(e, {
	..._,
	isCookieEnabled: t
}), Dn = () => {
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/settings/SettingsFooter.tsx";
function zn() {
	let { i18n: e } = Rn(x, "settings-footer");
	return p("div", {
...
var Un = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/settings/SettingsFooter.wrapper.tsx";
function Wn() {
...
var e = Object.defineProperty, t = ((t, n) => {
	...
	default: () => i,
	key: () => n
}), n = "settings-footer", r = { saveChanges: "Save Changes" }, i = {
	key: n,
	content: r
};
export { t };
