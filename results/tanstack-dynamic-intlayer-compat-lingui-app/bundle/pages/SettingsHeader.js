...
var content$2 = {
	...
	"en": () => import("./intlayer-SettingsHeader-wrapper-a91z55-en-CZGaFRCO.js").then((n) => n.r).then((m) => m.default),
...
var content$1 = {
	...
	"en": () => import("./intlayer-SettingsHeader-wrapper-a91z55-en-CZGaFRCO.js").then((n) => n.t).then((m) => m.default),
...
var content = {
	...
	"en": () => import("./intlayer-SettingsHeader-wrapper-a91z55-en-CZGaFRCO.js").then((n) => n.n).then((m) => m.default),
...
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/settings/SettingsHeader.tsx";
function SettingsHeader() {
	const { i18n } = useDictionaryDynamic([content$2, "header"], [content$1, "settings-header"]);
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/settings/SettingsHeader.wrapper.tsx";
function Wrapped() {
...
var content = { "manageYourAccountPreferencesAnd": "Manage your account preferences and configuration." };
var en_default = {
	key,
	content
};
