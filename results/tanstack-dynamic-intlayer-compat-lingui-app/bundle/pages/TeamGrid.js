...
var content = {
	...
	"en": () => import("./intlayer-TeamGrid-wrapper-s449jm-en-DnQZf6UP.js").then((n) => n.t).then((m) => m.default),
...
setupI18n({ locale: "en" });
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/team/TeamGrid.tsx";
function TeamGrid() {
	const { i18n } = useDictionaryDynamic([content, "team-grid"]);
	const members = [
		{
			name: i18n._({
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/team/TeamGrid.wrapper.tsx";
function Wrapped() {
