...
function getCachedIntl(intlConstructor, locale, options) {
	...
	let ctorCache = cache$1.get(cacheKey);
	if (!ctorCache) {
		ctorCache = /* @__PURE__ */ new Map();
		cache$1.set(cacheKey, ctorCache);
	}
...
var content$1 = {
	"de": () => import("../../../../.intlayer/dynamic_dictionary/json/team-header/de.json").then((m) => m.default),
	"en": () => import("./intlayer-TeamHeader-wrapper-18hwph-en-Cv9n11xR.js").then((n) => n.t).then((m) => m.default),
	"es": () => import("../../../../.intlayer/dynamic_dictionary/json/team-header/es.json").then((m) => m.default),
	"fr": () => import("../../../../.intlayer/dynamic_dictionary/json/team-header/fr.json").then((m) => m.default),
	"it": () => import("../../../../.intlayer/dynamic_dictionary/json/team-header/it.json").then((m) => m.default),
	"ja": () => import("../../../../.intlayer/dynamic_dictionary/json/team-header/ja.json").then((m) => m.default),
	"ko": () => import("../../../../.intlayer/dynamic_dictionary/json/team-header/ko.json").then((m) => m.default),
	"pt": () => import("../../../../.intlayer/dynamic_dictionary/json/team-header/pt.json").then((m) => m.default),
	"ru": () => import("../../../../.intlayer/dynamic_dictionary/json/team-header/ru.json").then((m) => m.default),
	"zh": () => import("../../../../.intlayer/dynamic_dictionary/json/team-header/zh.json").then((m) => m.default)
};
...
var readDynamicDictionary = ([loaders, key], locale) => {
	return getDictionary(getPreloadedDictionary(loaders, locale) ?? useLoadDynamic(`${key}.${locale}`, loaders[locale]?.()), locale);
};
var useDictionaryDynamic = (...entries) => {
	const { locale } = useLocale();
	const localeTarget = locale ?? internationalization.defaultLocale;
	const dictionaryKeysIdentity = entries.map(([, key]) => key).join("\0");
	return useMemo(() => createBoundLinguiContext(localeTarget, Object.fromEntries(entries.map((entry) => [entry[1], readDynamicDictionary(entry, localeTarget)]))), [localeTarget, dictionaryKeysIdentity]);
};
...
setupI18n({ locale: "en" });
var content = {
	"de": () => import("../../../../.intlayer/dynamic_dictionary/json/mockBanner/de.json").then((m) => m.default),
	"en": () => import("./intlayer-TeamHeader-wrapper-18hwph-en-Cv9n11xR.js").then((n) => n.n).then((m) => m.default),
	"es": () => import("../../../../.intlayer/dynamic_dictionary/json/mockBanner/es.json").then((m) => m.default),
	"fr": () => import("../../../../.intlayer/dynamic_dictionary/json/mockBanner/fr.json").then((m) => m.default),
	"it": () => import("../../../../.intlayer/dynamic_dictionary/json/mockBanner/it.json").then((m) => m.default),
	"ja": () => import("../../../../.intlayer/dynamic_dictionary/json/mockBanner/ja.json").then((m) => m.default),
	"ko": () => import("../../../../.intlayer/dynamic_dictionary/json/mockBanner/ko.json").then((m) => m.default),
	"pt": () => import("../../../../.intlayer/dynamic_dictionary/json/mockBanner/pt.json").then((m) => m.default),
	"ru": () => import("../../../../.intlayer/dynamic_dictionary/json/mockBanner/ru.json").then((m) => m.default),
	"zh": () => import("../../../../.intlayer/dynamic_dictionary/json/mockBanner/zh.json").then((m) => m.default)
};
...
var _jsxFileName$3 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/MockBanner.tsx";
var MockBanner = () => {
	const { i18n } = useDictionaryDynamic([content, "mockBanner"]);
	return jsxDEV("div", {
...
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/team/TeamHeader.tsx";
function TeamHeader() {
	const { i18n } = useDictionaryDynamic([content$1, "team-header"]);
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/team/TeamHeader.wrapper.tsx";
function Wrapped() {
...
var key$1 = "mockBanner";
var content$1 = "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service.";
var en_default$1 = {
	key: key$1,
	content: content$1
};
