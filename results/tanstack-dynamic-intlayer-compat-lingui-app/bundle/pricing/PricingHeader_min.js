...
var Me = class {
...
}, E = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(Fe).join("") : String(e ?? ""), Ie = "translation", Le = "enumeration", Re = "plural", D = "insertion", ze = "object", Be = "array", Ve = "markdown", O = "html", He = "gender", Ue = "select", k = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), A = (e, t) => {
...
})() }), Ye = (e) => k(Re, e), Xe = (e, t) => k(Ue, e, { variable: t }), Ze = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "plural") {
		let e = r[Re];
		return V(ut(e, Number(B(t, "count") ?? 1), n), t, n);
	}
	...
	let i = V(typeof e == "string" ? ht[r](e) : e, t, n);
...
}, vt = t(null), yt = /* @__PURE__ */ new WeakMap(), H = 0, bt = (e) => {
	if (!e) return "base";
	let t = yt.get(e);
	if (t) return t;
	H += 1;
	...
	let r = Rt()[e];
	return r ? sn(r, t, n) : (Vt.has(e) || (De({ log: te })(typeof window > "u" ? `Dictionary ${Oe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Vt.add(e)), Bt(e));
}, Ut = (e) => {
	...
	if (typeof e == "string") return e;
	if (q(e)) return e.nodeType === "html" ? e[O] : e[Ve];
}, qt = (e, t) => {
	if (typeof e == "string") return t;
	if (q(e)) {
		let n = e.nodeType === "html" ? O : Ve;
		return {
			...e,
			[n]: t
		};
...
}, Xt = J, Zt = (e) => J, Qt = J, $t = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? J : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: D }], i = e[D], a = {
			...
			transform: (e, n, r) => {
				if (q(e)) return (i) => Jt(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, en = J, tn = J, nn = (e) => J, rn = J, an = (e, t = !0) => [
...
}, Y = /* @__PURE__ */ new Map(), _n = (e, t) => (Y.has(e) || Y.set(e, gn(t)), Y.get(e).read()), vn = ({ children: e, value: t, additionalProps: n }) => {
...
}, Sn = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? J : {
	id: "insertion-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "insertion",
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: D }], i = e[D], a = {
...
}, Cn = J, wn = J, X = /* @__PURE__ */ new Map(), Tn = (e, t = !0) => {
	...
	return X.set(n, r), r;
}, En = (e, t) => sn(e, t, Tn(typeof t == "object" && t ? t.locale : t)), Dn = ge(v), On = (e, t) => _e(e, {
	...v,
	isCookieEnabled: t
}), kn = () => {
	...
	let { locales: c, defaultLocale: u } = h ?? {}, [f, p] = l(e ?? Dn ?? t ?? u);
	o(() => {
		e && e !== f && p(e);
	}, [e]), o(() => {
		Nn();
	...
	let { defaultLocale: n, locales: r } = h ?? {}, { locale: o, setLocale: s, isCookieEnabled: c } = a(Z) ?? {};
	return {
		locale: o,
		defaultLocale: n,
		availableLocales: r,
...
typeof window < "u" && typeof Hn == "function" && Hn().then((e) => {
	Q.__intlayerPreloaded = {
		locale: Vn,
		dictionary: e
	};
}, () => void 0);
var Un = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/MockBanner.tsx", Wn = () => {
	let { i18n: e } = Bn(Q, "mockBanner");
	return m("div", {
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/pricing/PricingHeader.tsx";
function Gn() {
	let { i18n: e } = Bn(S, "pricing-header"), t = (t) => e._(`${t}`);
	return m(p, { children: [m(Wn, {}, void 0, !1, {
		fileName: $,
		lineNumber: 10,
		columnNumber: 7
	}, this), m("div", {
...
var qn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
...
var Yn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/pricing/PricingHeader.wrapper.tsx";
function Xn() {
	return m(Jn, { children: m(Gn, {}, void 0, !1, {
		fileName: Yn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
