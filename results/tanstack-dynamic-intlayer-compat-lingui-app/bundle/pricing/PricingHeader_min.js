...
var te = (e) => /^[a-zA-Z][a-zA-Z\d+\-.]*:/.test(e), m = {
	locales: [
		"en",
		"fr",
		"es",
...
}, ae = "__intlayerPreloaded", oe = ["en"], g = "\x1B[0m", se = "\x1B[34m", ce = "\x1B[31m", le = "\x1B[32m", ue = "\x1B[38;5;3m", de = (e = {}) => ({
	...e,
...
}), y = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? g : n : g}` : e, ke = (e, t = ue, n = g) => [e].flat().map((e) => y(e, t, n)).join(", ");
y("✗", ce), y("✓", le), y("⏲", se);
var Ae = (e) => {
	...
	return (x === void 0 || b !== e) && (b = e, x = Ae()), x;
}, C = {
	de: () => import("../../../../.intlayer/dynamic_dictionary/json/pricing-header/de.json").then((e) => e.default),
	en: () => import("./intlayer-PricingHeader-wrapper-a94lsv-en-Bu0kr8Qw.js").then((e) => e.t).then((e) => e.default),
...
var Me = class {
...
}, Pe = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(Ne).join("") : String(e ?? ""), Fe = "translation", Ie = "enumeration", Le = "plural", O = "insertion", Re = "object", ze = "array", Be = "markdown", k = "html", Ve = "gender", He = "select", A = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), j = (e, t) => {
...
})() }), Ye = (e) => A(Le, e), Xe = (e, t) => A(He, e, { variable: t }), Ze = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, tt = (e, t) => e[et(e, t) ?? "fallback"], nt = (e, t, n) => e[v("PluralRules", n).select(t)] ?? e.other, rt = (e, t) => {
	...
	if (r.nodeType === "plural") {
		let e = r[Le];
		return z(nt(e, Number(R(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[Ie], i = it.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[He], i = R(t, typeof r.variable == "string" ? r.variable : "value");
		return z(rt(e, String(i ?? "")), t, n);
	}
...
}, dt = t(null), ft = /* @__PURE__ */ new WeakMap(), pt = 0, mt = (e) => {
	if (!e) return "base";
	let t = ft.get(e);
	if (t) return t;
	pt += 1;
	let n = `p${pt}`;
	return ft.set(e, n), n;
}, ht = 256, B = /* @__PURE__ */ new WeakMap(), gt = (e) => typeof e == "object" && !!e, _t = (e, t, n) => `${e}_${t}_${mt(n)}`, vt = (e, t) => {
	if (!gt(e)) return { hit: !1 };
	let n = B.get(e);
	return n?.has(t) ? {
		hit: !0,
		content: n.get(t)
	...
	if (!gt(e)) return n;
	let r = B.get(e);
	return r || (r = /* @__PURE__ */ new Map(), B.set(e, r)), r.size >= ht && r.clear(), r.set(t, n), n;
}, yt = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), H = "default", bt = /[^A-Za-z0-9._&=-]/g, xt = /[^A-Za-z0-9._-]/g, St = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, U = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, St);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, Ct = (e) => e === void 0 ? H : typeof e == "string" ? U(e, bt) : Object.keys(e).sort().map((t) => `${U(t, xt)}=${U(String(e[t]), xt)}`).join("&"), wt = (e) => Array.isArray(e) ? e.length === 0 ? [H] : e.map(Ct) : [Ct(e)], Tt = (e, t) => {
	for (let n of e) if (t(n)) return n;
	return t("default") ? H : e[0] ?? "default";
}, Et = (e, t, n, r) => {
	let i = e.split("/");
	return t.every((e, t) => e === "variant" ? i[t] === r : n?.item === void 0 || i[t] === String(n.item));
}, Dt = (e) => typeof e == "object" && !!e && "qualifierTypes" in e && Array.isArray(e.qualifierTypes) && "content" in e, Ot = (e, t) => {
	let n = t.split("/"), r = {
		key: e.key,
		content: e.content[t]
	};
	...
	if (!Dt(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? H : Tt(wt(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Et(e, n, t, s)).map((t) => Ot(e, t));
	return i ? c.sort((e, t) => (e.item ?? 0) - (t.item ?? 0)) : c[0] ?? null;
}, At = (e) => typeof e == "object" && e ? {
	locale: e.locale,
	selector: e
} : { locale: e }, jt = (e) => e ? Object.keys(e).filter((e) => e !== "locale").sort().map((t) => {
	let n = e[t];
	return `${t}:${t === "variant" ? wt(n).join(",") : String(n)}`;
}).join("|") : "", Mt = () => ({}), Nt = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	...
	let r = Mt()[e];
	return r ? en(r, t, n) : (Ft.has(e) || (Oe({ log: ne })(typeof window > "u" ? `Dictionary ${ke(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Ft.add(e)), Pt(e));
}, Lt = (e) => {
	...
	if (typeof e == "string") return e;
	if (W(e)) return e.nodeType === "html" ? e[k] : e[Be];
}, Vt = (e, t) => {
	if (typeof e == "string") return t;
	if (W(e)) {
		let n = e.nodeType === "html" ? k : Be;
		return {
			...e,
			[n]: t
		};
	...
	canHandle: () => !1,
	transform: (e) => e
}, Ut = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? G : {
...
}, Wt = G, Gt = (e) => G, Kt = G, qt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? G : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: O }], i = e[O], a = {
			...
			transform: (e, n, r) => {
				if (W(e)) return (i) => Ht(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, Jt = G, Yt = G, Xt = (e) => G, Zt = G, Qt = (e, t = !0) => [
	Ut(e ?? m.defaultLocale, t ? m.defaultLocale : void 0),
	Wt,
	Kt,
	qt,
	...
	let { locale: r, selector: i } = At(t), a = _t(r ?? m.defaultLocale, jt(i), n), o = vt(e, a);
	if (o.hit) return o.content;
	let s = n ?? Qt(r), c = kt(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
}, nn = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", rn = /\{\{\s*(.*?)\s*\}\}/g, an = (e, t = {}) => {
	if (!Object.values(t).some(nn)) return {
		isSimple: !0,
		parts: e.replace(rn, (e, n) => (t[n.trim()] ?? "").toString())
	};
	let n = e.split(rn), r = [];
...
}, K = /* @__PURE__ */ new Map(), dn = (e, t) => (K.has(e) || K.set(e, un(t)), K.get(e).read()), fn = ({ children: e, value: t, additionalProps: n }) => {
...
}, gn = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? G : {
	id: "insertion-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "insertion",
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: O }], i = e[O], a = {
...
}, _n = G, vn = G, q = /* @__PURE__ */ new Map(), yn = (e, t = !0) => {
	...
	return q.set(n, r), r;
}, bn = (e, t) => en(e, t, yn(typeof t == "object" && t ? t.locale : t)), xn = _e(_), Sn = (e, t) => ve(e, {
	..._,
	isCookieEnabled: t
}), Cn = () => {
...
}), { defaultLocale: An, locales: Y } = m ?? {}, jn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { locale: n, setLocale: r, isCookieEnabled: o } = a(J) ?? {};
	return {
		locale: n,
		defaultLocale: An,
		availableLocales: Y,
...
}, Pn = ([e, t], n) => bn(tn(e, n) ?? dn(`${t}.${n}`, e[n]?.()), n), Fn = (...e) => {
	let { locale: t } = jn(), n = t ?? m.defaultLocale, r = e.map(([, e]) => e).join("\0");
	return s(() => Nn(n, Object.fromEntries(e.map((e) => [e[1], Pn(e, n)]))), [n, r]);
}, In = (e) => new ut({
	...e,
	registry: ln()
});
...
var X = {
	...
	en: () => import("./intlayer-PricingHeader-wrapper-a94lsv-en-Bu0kr8Qw.js").then((e) => e.n).then((e) => e.default),
...
typeof window < "u" && typeof Z == "function" && Z().then((e) => {
	X.__intlayerPreloaded = {
		locale: Ln,
		dictionary: e
	};
}, () => void 0);
var Rn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/MockBanner.tsx", zn = () => {
	let { i18n: e } = Fn([X, "mockBanner"]);
	return p("div", {
...
}, Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/pricing/PricingHeader.tsx";
function Bn() {
	let { i18n: e } = Fn([C, "pricing-header"]), t = (t) => e._(`pricing-header.${t}`);
	return p(f, { children: [p(zn, {}, void 0, !1, {
		fileName: Q,
		lineNumber: 10,
		columnNumber: 7
	}, this), p("div", {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/pricing/PricingHeader.wrapper.tsx";
function Wn() {
	return p(Un, { children: p(Bn, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
...
var e = Object.defineProperty, t = (t, n) => {
	...
	default: () => a,
	key: () => r
}), r = "mockBanner", i = "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service.", a = {
	key: r,
	content: i
}, o = t({
	content: () => c,
