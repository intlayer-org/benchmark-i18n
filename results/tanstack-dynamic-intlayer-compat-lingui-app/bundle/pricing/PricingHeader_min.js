...
var X = {
	...
	let { locales: u, defaultLocale: ee } = M ?? {}, [d, f] = o(e ?? Ht ?? t ?? ee);
	r(() => {
		e && e !== d && f(e);
	}, [e]), r(() => {
		Jt();
...
Q({ locale: "en" });
var tn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/MockBanner.tsx", nn = () => {
	let { i18n: e } = $t();
	return u("div", {
...
function rn() {
	let { i18n: e } = $t(), t = (t) => e._(`pricing-header.${t}`);
	return u(l, { children: [u(nn, {}, void 0, !1, {
		fileName: $,
		lineNumber: 10,
		columnNumber: 7
	}, this), u("div", {
...
var cn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/pricing/PricingHeader.wrapper.tsx";
function ln() {
	return u(sn, { children: u(rn, {}, void 0, !1, {
		fileName: cn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
