...
$t({ locale: "en" });
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/pricing/PricingTiers.tsx";
function en() {
	let { i18n: e } = Zt(), t = [
		{
			name: e._({
		...
		children: t.map((e) => l("div", {
			...
			children: [
				...
				l("ul", {
					...
					children: e.features.map((e, t) => l("li", {
...
var an = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/pricing/PricingTiers.wrapper.tsx";
function on() {
