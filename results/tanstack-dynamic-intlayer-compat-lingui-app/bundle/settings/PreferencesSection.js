...
var content = {
	...
	"en": () => import("./intlayer-PreferencesSection-wrapper-14fy5l-en-DZM9bQG1.js").then((n) => n.t).then((m) => m.default),
...
function PreferencesSection() {
	const { i18n } = useDictionaryDynamic(content, "preferences-section");
