...
}, pe = !1, x, me = () => typeof window > "u" ? b(y) : (pe ||= (x = b(y), !0), x), he = (e, t) => {
...
}), C = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? _ : n : _}` : e, Ee = (e, t = ae, n = _) => [e].flat().map((e) => C(e, t, n)).join(", ");
C("✗", re), C("✓", ie), C("⏲", v);
var De = (e) => {
	...
	en: () => import("./intlayer-ProfileSection-wrapper-1yyk8z-en-GwtnxnWa.js").then((e) => e.t).then((e) => e.default),
...
var je = t(null), Me = class {
...
}, G = /* @__PURE__ */ new Map(), dt = (e, t) => (G.has(e) || G.set(e, ut(t)), G.get(e).read()), ft = /* @__PURE__ */ new Map(), pt = (e, t) => Object.create(new Proxy(e, {
	get: (e, t, n) => {
	...
	value: t,
	...n
}, mt(t)), K = /* @__PURE__ */ new WeakMap(), gt = 0, _t = (e) => {
	if (!e) return "base";
	let t = K.get(e);
	if (t) return t;
	gt += 1;
	...
	let r = Ct()[e];
	return r ? Yt(r, t, n) : (Et.has(e) || (Te({ log: h })(typeof window > "u" ? `Dictionary ${Ee(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Et.add(e)), Tt(e));
}, Ot = (e) => {
	...
	return Q.set(n, r), r;
}, cn = (e, t) => Yt(e, t, sn(typeof t == "object" && t ? t.locale : t)), ln = me, un = (e, t) => he(e, {
	...y,
	isCookieEnabled: t
}), dn = () => {
	...
	let { locales: f, defaultLocale: ee } = p ?? {}, [m, h] = l(() => e ?? ln() ?? t ?? ee), [g, te] = l(e);
...
}, vn = ([e, t], n) => cn(Xt(e, n) ?? dt(`${t}.${n}`, e[n]?.()), n), yn = (...e) => {
...
function En() {
	let { i18n: e } = yn([E, "profile-section"]), t = s(), n = s();
	return f("section", {
...
var e = Object.defineProperty, t = ((t, n) => {
	...
	default: () => i,
	key: () => n
}), n = "profile-section", r = { displayName: "Display Name" }, i = {
	key: n,
	content: r
};
export { t };
