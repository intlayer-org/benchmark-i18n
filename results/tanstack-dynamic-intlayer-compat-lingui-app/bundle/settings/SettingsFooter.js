...
var content = {
	...
	"en": () => import("./intlayer-SettingsFooter-wrapper-1rfzcy-en-F9puURQP.js").then((n) => n.t).then((m) => m.default),
...
setupI18n({ locale: "en" });
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/settings/SettingsFooter.tsx";
function SettingsFooter() {
	const { i18n } = useDictionaryDynamic([content, "settings-footer"]);
	return jsxDEV("div", {
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/settings/SettingsFooter.wrapper.tsx";
function Wrapped() {
...
var content = { "saveChanges": "Save Changes" };
var en_default = {
	key,
	content
};
