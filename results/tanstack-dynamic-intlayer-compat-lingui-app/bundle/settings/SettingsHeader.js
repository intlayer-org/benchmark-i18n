...
function SettingsHeader() {
	const { i18n } = useDictionaryDynamic(content$2, "header"), { i18n: _settingsHeader } = useDictionaryDynamic(content$1, "settings-header");
	return jsxDEV(Fragment$2, { children: [
		...
		jsxDEV("p", {
			...
			children: _settingsHeader._({
				id: "manageYourAccountPreferencesAnd",
