...
var ke = (e) => {
	...
	en: () => import("./intlayer-SettingsHeader-wrapper-a91z55-en-BfMCmQJS.js").then((e) => e.r).then((e) => e.default),
...
var w = {
	...
	en: () => import("./intlayer-SettingsHeader-wrapper-a91z55-en-BfMCmQJS.js").then((e) => e.t).then((e) => e.default),
...
var Z = (e, t) => {
	...
	en: () => import("./intlayer-SettingsHeader-wrapper-a91z55-en-BfMCmQJS.js").then((e) => e.n).then((e) => e.default),
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/settings/SettingsHeader.tsx";
function Jn() {
	let { i18n: e } = Z(C, "header"), { i18n: t } = Z(w, "settings-header");
	return m(p, { children: [
		m(qn, {}, void 0, !1, {
			fileName: $,
			lineNumber: 8,
...
var Qn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-lingui-app/src/components/pages/settings/SettingsHeader.wrapper.tsx";
function $n() {
...
var e = Object.defineProperty, t = (t, n) => {
	...
	default: () => p,
	key: () => d
}), d = "settings-header", f = { manageYourAccountPreferencesAnd: "Manage your account preferences and configuration." }, p = {
	key: d,
	content: f
};
