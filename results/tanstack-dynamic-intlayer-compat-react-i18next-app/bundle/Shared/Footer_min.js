...
}).join("|") : "", bt = { index: u }, xt = () => bt, St = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
...
var Gt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let { locales: l, defaultLocale: u } = p ?? {}, [f, m] = s(e ?? Kt ?? t ?? u);
	i(() => {
		e && e !== f && m(e);
	}, [e]), i(() => {
		Zt();
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: o } = tn(), s = t?.keyPrefix, { translate: c, i18n: l } = a(() => Gt({
		locale: r,
		setLocale: i,
		availableLocales: o ?? [],
		namespace: n,
...
}, rn = ({ children: e, i18n: t }) => (t !== void 0 && S({ log: h })(`${C("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), d($t, { children: e }));
...
function on() {
	let { t: e } = nn(), t = l({ strict: !1 }).locale ?? "en", n = [
		{
