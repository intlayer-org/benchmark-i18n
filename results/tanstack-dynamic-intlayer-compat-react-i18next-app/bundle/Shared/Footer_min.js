...
b("✗", te), b("✓", ne), b("⏲", ee);
var x = /* @__PURE__ */ new WeakMap(), ce = 0, le = (e) => {
	if (!e) return "base";
	let t = x.get(e);
	if (t) return t;
	ce += 1;
	let n = `p${ce}`;
	return x.set(e, n), n;
}, ue = 256, S = /* @__PURE__ */ new WeakMap(), de = (e) => typeof e == "object" && !!e, fe = (e, t, n) => `${e}_${t}_${le(n)}`, pe = (e, t) => {
	...
	if (!de(e)) return n;
	let r = S.get(e);
	return r || (r = /* @__PURE__ */ new Map(), S.set(e, r)), r.size >= ue && r.clear(), r.set(t, n), n;
}, me = "translation", he = "enumeration", ge = "plural", _e = "insertion", ve = "object", ye = "array", be = "html", xe = "gender", Se = "select", w = (e, t) => {
...
}, we = (e, t) => e[Ce(e, t) ?? "fallback"], T = "default", Te = /[^A-Za-z0-9._&=-]/g, E = /[^A-Za-z0-9._-]/g, Ee = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, D = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, Ee);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, O = (e) => e === void 0 ? T : typeof e == "string" ? D(e, Te) : Object.keys(e).sort().map((t) => `${D(t, E)}=${D(String(e[t]), E)}`).join("&"), k = (e) => Array.isArray(e) ? e.length === 0 ? [T] : e.map(O) : [O(e)], De = (e, t) => {
	...
	if (!ke(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? T : De(k(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Oe(e, n, t, s)).map((t) => Ae(e, t));
...
}).join("|") : "", Pe = { index: f }, A = () => Pe, Fe = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), j = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Fe.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : j(e ? `${e}.${String(n)}` : String(n)) }), M = /* @__PURE__ */ new Set(), N = (e, t, n) => {
	let r = A()[e];
	return r ? $e(r, t, n) : (M.has(e) || (y({ log: g })(typeof window > "u" ? `Dictionary ${se(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), M.add(e)), j(e));
}, Ie = 50, P = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Set(), Le = (e) => {
...
var Be = (e, t, n) => e[I("PluralRules", n).select(t)] ?? e.other, Ve = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, Ue = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? z : {
...
}, We = z, Ge = z, Ke = z, qe = z, Je = z;
process.env.INTLAYER_OPTIMIZED_NESTING;
var Ye = (e) => z, Xe = z, Ze = (e, t = !0) => [
	...
	let { locale: r, selector: i } = Me(t), a = fe(r ?? m.defaultLocale, Ne(i), n), o = pe(e, a);
	if (o.hit) return o.content;
	let s = n ?? Ze(r), c = je(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var V = {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), mt = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: o, isCookieEnabled: c }) => {
	let { locales: l, defaultLocale: d } = m ?? {}, [f, p] = s(e ?? it ?? t ?? d);
	i(() => {
		e && e !== f && p(e);
	}, [e]), i(() => {
		ut();
...
}), { defaultLocale: gt, locales: U } = m ?? {}, _t = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
}, vt = ({ children: e, i18n: t }) => (t !== void 0 && y({ log: g })(`${b("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), u(ht, { children: e })), yt = (e, t, n = ".") => {
	if (!t) return e;
	...
	if (r.nodeType === "enumeration") {
		let e = r[he], i = bt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	"nsMode",
	"keyPrefix"
]), wt = 5, Tt = "index", Et = (e, t) => {
	if (e in A()) return N(e, t);
}, Dt = (e, t, n, r, i) => {
	...
	else if (m = Et(c, p), m === void 0 && c === t && c !== Tt && (m = Et(Tt, p)), m === void 0) return;
	let h;
...
var kt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	let o = (t, n) => Y({
		locale: e,
		namespace: r,
		key: i ? `${i}.${t}` : t,
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: o } = _t(), s = t?.keyPrefix, { translate: c, i18n: l } = a(() => kt({
		locale: r,
		setLocale: i,
		availableLocales: o ?? [],
		namespace: n,
...
var jt = {
	type: "3rdParty",
	init: (e) => {}
}, Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-react-i18next-app/src/components/Footer.tsx";
function Mt() {
	let { t: e } = At(), t = l({ strict: !1 }).locale ?? "en", n = [
		{
...
var Nt = Z, Pt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-react-i18next-app/scripts/Wrapper.tsx";
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-react-i18next-app/src/components/Footer.wrapper.tsx";
function It() {
	return p(Ft, { children: p(Mt, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
