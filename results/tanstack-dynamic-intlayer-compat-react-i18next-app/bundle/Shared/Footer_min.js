...
}, Le = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), Re = { index: l }, U = () => Re, ze = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
...
var gt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), bt = ({ locale: e, defaultLocale: t, variant: r, children: s, setLocale: c, disableEditor: l, isCookieEnabled: d }) => {
	let { locales: p, defaultLocale: m } = f ?? {}, [h, g] = o(() => e ?? _t() ?? t ?? m), [_, ee] = o(e);
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: o } = Ct(), s = t?.keyPrefix, { translate: c, i18n: l } = a(() => gt({
		locale: r,
		setLocale: i,
		availableLocales: o ?? [],
		namespace: n,
...
function Dt() {
	let { t: e } = wt(), t = c({ strict: !1 }).locale ?? "en", n = [
		{
