...
var m = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-react-i18next-app/src/components/LocaleSwitcher.tsx";
function h() {
...
}, y = "\x1B[0m", ee = "\x1B[34m", te = "\x1B[31m", ne = "\x1B[32m", re = "\x1B[35m", ie = "\x1B[38;5;3m", b = "\x1B[36m", ae = (e) => e, oe = (e, t) => {
...
}), S = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? y : n : y}` : e, se = (e, t = ie, n = y) => [e].flat().map((e) => S(e, t, n)).join(", ");
S("✗", te), S("✓", ne), S("⏲", ee);
var C = /* @__PURE__ */ new WeakMap(), w = 0, ce = (e) => {
	if (!e) return "base";
	let t = C.get(e);
	if (t) return t;
	w += 1;
	let n = `p${w}`;
	return C.set(e, n), n;
}, le = 256, T = /* @__PURE__ */ new WeakMap(), ue = (e) => typeof e == "object" && !!e, de = (e, t, n) => `${e}_${t}_${ce(n)}`, fe = (e, t) => {
	...
	if (!ue(e)) return n;
	let r = T.get(e);
	return r || (r = /* @__PURE__ */ new Map(), T.set(e, r)), r.size >= le && r.clear(), r.set(t, n), n;
}, pe = "translation", me = "enumeration", he = "plural", ge = "insertion", _e = "object", ve = "array", ye = "html", be = "gender", xe = "select", D = (e, t) => {
...
}, Ce = (e, t) => e[Se(e, t) ?? "fallback"], O = "default", we = /[^A-Za-z0-9._&=-]/g, k = /[^A-Za-z0-9._-]/g, Te = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, A = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, Te);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, Ee = (e) => e === void 0 ? O : typeof e == "string" ? A(e, we) : Object.keys(e).sort().map((t) => `${A(t, k)}=${A(String(e[t]), k)}`).join("&"), De = (e) => Array.isArray(e) ? e.length === 0 ? [O] : e.map(Ee) : [Ee(e)], Oe = (e, t) => {
	...
	if (!Ae(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? O : Oe(De(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => ke(e, n, t, s)).map((t) => je(e, t));
	...
	yield e;
} : Re(e ? `${e}.${String(n)}` : String(n)) }), ze = /* @__PURE__ */ new Set(), j = (e, t, n) => {
	let r = Ie()[e];
	return r ? rt(r, t, n) : (ze.has(e) || (x({ log: v })(typeof window > "u" ? `Dictionary ${se(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), ze.add(e)), Re(e));
}, Be = 50, M = /* @__PURE__ */ new Map(), N = /* @__PURE__ */ new Set(), Ve = (e) => {
...
function P(e, t, n) {
	let r = t ?? g?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = M.get(a);
...
var We = (e, t, n) => e[P("PluralRules", n).select(t)] ?? e.other, Ge = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, qe = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? L : {
...
}, Je = L, Ye = L, Xe = L, Ze = L, Qe = L;
process.env.INTLAYER_OPTIMIZED_NESTING;
var $e = (e) => L, et = L, tt = (e, t = !0) => [
	qe(e ?? g.defaultLocale, t ? g.defaultLocale : void 0),
	Je,
	Ye,
	Xe,
	$e(e ?? g.defaultLocale),
	...
	let { locale: r, selector: i } = Ne(t), a = de(r ?? g.defaultLocale, Pe(i), n), o = fe(e, a);
	if (o.hit) return o.content;
	let s = n ?? tt(r), c = Me(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var B = {
...
}, pt = (e, t = g?.locales, n = g?.defaultLocale) => {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), mt = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: o, disableEditor: s, isCookieEnabled: c }) => {
	let { locales: u, defaultLocale: d } = g ?? {}, [f, p] = a(e ?? V ?? t ?? d);
	r(() => {
		e && e !== f && p(e);
	}, [e]), r(() => {
		ft();
...
}), gt = ({ children: e, i18n: t }) => (t !== void 0 && x({ log: v })(`${S("I18nextProvider", b)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), l(ht, { children: e })), U = (e, t, n = ".") => {
	if (!t) return e;
	...
	return String(e);
}, _t = (e, t = {}, n = "en") => e.replace(/\{\{\s*([^{},]+?)\s*(?:,\s*(\w+)\s*(?:,\s*([^{}]+?)\s*)?)?\}\}/g, (e, r, i, a) => {
	let o = G(t, r);
	...
	let r = e;
	if (r.nodeType === "insertion") return J(r[ge], t, n);
	if (r.nodeType === "html") return J(r[ye], t, n);
	if (r.nodeType === "plural") {
		let e = r[he];
		return J(We(e, Number(q(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[me], i = W.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[xe], i = q(t, typeof r.variable == "string" ? r.variable : "value");
		return J(Ge(e, String(i ?? "")), t, n);
	}
	...
	"nsMode",
	"keyPrefix"
]), yt = 5, bt = "index", xt = (e, t) => {
	if (e in Ie()) return j(e, t);
}, St = (e, t, n, r, i) => {
	...
	let n = {};
	for (let [t, r] of Object.entries(e)) vt.has(t) || (n[t] = r);
	return n;
	...
	else if (m = xt(c, p), m === void 0 && c === t && c !== bt && (m = xt(bt, p)), m === void 0) return;
	let h;
	...
	return o < yt && _.includes("$t(") && (_ = _.replace(/\$t\(\s*([^),]+?)\s*(?:,[^)]*)?\)/g, (n, l) => {
		let u = Z({
			locale: e,
			namespace: c,
			key: l.trim(),
	...
	x({ log: v })(`${S(e, b)}: the ${S("`resources`", b)} option is ignored when using ${S("@intlayer/i18next", re)} — translations are served from the compiled intlayer dictionaries instead. Remove the resource imports and the ${S("`resources`", b)} option to reduce your bundle size.`);
}, Q = (e = {}) => {
	...
	let t = g, n = e.lng ?? t?.defaultLocale ?? "en", r = e.defaultNS ?? (Array.isArray(e.ns) ? e.ns[0] : e.ns) ?? "translation", i = /* @__PURE__ */ new Map(), a = !1, o = (e, ...t) => {
		...
		hasLoadedNamespace(e) {
			try {
				return j(Array.isArray(e) ? e[0] : e, n), !0;
			} catch {
				return !1;
			}
		},
...
var wt = $, Tt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-react-i18next-app/scripts/Wrapper.tsx";
...
var Dt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-react-i18next-app/src/components/LocaleSwitcher.wrapper.tsx";
function Ot() {
	return c(Et, { children: c(h, {}, void 0, !1, {
		fileName: Dt,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
