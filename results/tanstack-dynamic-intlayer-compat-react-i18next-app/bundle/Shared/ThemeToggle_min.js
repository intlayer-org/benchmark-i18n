...
}, nn = ({ children: e, i18n: t }) => (t !== void 0 && S({ log: p })(`${C("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), l(Qt, { children: e }));
