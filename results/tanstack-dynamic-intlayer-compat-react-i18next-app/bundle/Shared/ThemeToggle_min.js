...
b("✗", _), b("✓", ee), b("⏲", g);
var oe = /* @__PURE__ */ new WeakMap(), se = 0, ce = (e) => {
	if (!e) return "base";
	let t = oe.get(e);
	if (t) return t;
	se += 1;
	let n = `p${se}`;
	return oe.set(e, n), n;
}, le = 256, x = /* @__PURE__ */ new WeakMap(), S = (e) => typeof e == "object" && !!e, ue = (e, t, n) => `${e}_${t}_${ce(n)}`, de = (e, t) => {
	if (!S(e)) return { hit: !1 };
	let n = x.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, Ee = (e) => e === void 0 ? T : typeof e == "string" ? E(e, Ce) : Object.keys(e).sort().map((t) => `${E(t, we)}=${E(String(e[t]), we)}`).join("&"), D = (e) => Array.isArray(e) ? e.length === 0 ? [T] : e.map(Ee) : [Ee(e)], De = (e, t) => {
	...
	if (!ke(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? T : De(D(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Oe(e, n, t, s)).map((t) => Ae(e, t));
...
}).join("|") : "", Pe = { index: u }, O = () => Pe, Fe = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	...
	yield e;
} : k(e ? `${e}.${String(n)}` : String(n)) }), A = /* @__PURE__ */ new Set(), j = (e, t, n) => {
	let r = O()[e];
	return r ? tt(r, t, n) : (A.has(e) || (y({ log: m })(typeof window > "u" ? `Dictionary ${ae(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), A.add(e)), k(e));
}, Ie = 50, M = /* @__PURE__ */ new Map(), N = /* @__PURE__ */ new Set(), Le = (e) => {
...
var Be = (e, t, n) => e[P("PluralRules", n).select(t)] ?? e.other, Ve = (e, t) => {
	...
	if (He(e) && He(t)) {
		let n = { ...e };
		for (let r of Object.keys(t)) r !== "__proto__" && r !== "constructor" && t[r] !== void 0 && (n[r] = e[r] === void 0 ? t[r] : Ue(e[r], t[r]));
		return n;
	}
	return e;
}, We = (e, t, n) => {
	...
	if (s.length !== 0) return s.length === 1 || Array.isArray(s[0]) ? s[0] : s.reduce((e, t) => Ue(e, t));
}, F = {
	id: "fallback-plugin",
	canHandle: () => !1,
	transform: (e) => e
}, Ge = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? F : {
...
}, Ke = F, qe = F, Je = F, Ye = F, Xe = F;
process.env.INTLAYER_OPTIMIZED_NESTING;
var Ze = (e) => F, Qe = F, $e = (e, t = !0) => [
	Ge(e ?? f.defaultLocale, t ? f.defaultLocale : void 0),
	Ke,
	qe,
	Je,
	...
	let { locale: r, selector: i } = Me(t), a = ue(r ?? f.defaultLocale, Ne(i), n), o = de(e, a);
	if (o.hit) return o.content;
	let s = n ?? $e(r), c = je(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var L = {
	...
	if (!I) for (let t = 0; t < (p.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(p.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, at = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !I && p.storage.cookies) for (let n = 0; n < p.storage.cookies.length; n++) {
		let { name: r, attributes: i } = p.storage.cookies[n];
		try {
			t?.setCookieStore && t.setCookieStore(r, e, {
				...i,
				expires: nt(i.expires)
			});
		} catch {
			try {
...
}, dt = (e, t = f?.locales, n = f?.defaultLocale) => {
	...
	locale: R ?? f?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), mt = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: o, isCookieEnabled: l }) => {
	let { locales: u, defaultLocale: d } = f ?? {}, [p, m] = s(e ?? R ?? t ?? d);
	i(() => {
		e && e !== p && m(e);
	}, [e]), i(() => {
		ut();
...
}), { defaultLocale: gt, locales: V } = f ?? {}, _t = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
}, vt = ({ children: e, i18n: t }) => (t !== void 0 && y({ log: m })(`${b("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), c(ht, { children: e })), H = (e, t, n = ".") => {
	if (!t) return e;
	...
	let r = e;
	if (r.nodeType === "insertion") return q(r[he], t, n);
	if (r.nodeType === "html") return q(r[ve], t, n);
	if (r.nodeType === "plural") {
		let e = r[me];
		return q(Be(e, Number(K(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[pe], i = U.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[be], i = K(t, typeof r.variable == "string" ? r.variable : "value");
...
var Et = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: o } = _t(), s = t?.keyPrefix, { translate: c, i18n: l } = a(() => Et({
		locale: r,
		setLocale: i,
		availableLocales: o ?? [],
		namespace: n,
...
var Ot = {
	type: "3rdParty",
	init: (e) => {}
}, kt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-react-i18next-app/src/components/ThemeToggle.tsx";
function At() {
...
var Ft = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-react-i18next-app/src/components/ThemeToggle.wrapper.tsx";
function It() {
