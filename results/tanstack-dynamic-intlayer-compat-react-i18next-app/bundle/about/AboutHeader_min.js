...
}).join("|") : "", Ct = { index: l }, wt = () => Ct, Tt = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
...
var Xt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let { locales: l, defaultLocale: u } = p ?? {}, [f, m] = c(e ?? Zt ?? t ?? u);
	i(() => {
		e && e !== f && m(e);
	}, [e]), i(() => {
		rn();
...
function pn() {
	let { t: e } = ln();
	return fn("AboutHeader"), f(u, { children: [d("h1", {
