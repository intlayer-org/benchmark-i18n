...
}).join("|") : "", Pe = { index: d }, A = () => Pe, Fe = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
...
}, vt = ({ children: e, i18n: t }) => (t !== void 0 && y({ log: g })(`${b("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), l(ht, { children: e })), yt = (e, t, n = ".") => {
	if (!t) return e;
...
var kt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = _t(), s = t?.keyPrefix, { translate: c, i18n: l } = o(() => kt({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-react-i18next-app/src/components/pages/about/AboutHeader.tsx";
function Nt() {
	let { t: e } = At();
	return Mt("AboutHeader"), p(f, { children: [p("h1", {
...
var Pt = Z, Ft = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-react-i18next-app/scripts/Wrapper.tsx";
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-react-i18next-app/src/components/pages/about/AboutHeader.wrapper.tsx";
function Lt() {
	return p(It, { children: p(Nt, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
