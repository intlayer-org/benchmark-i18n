...
function un() {
	let { t: e } = sn(), t = [
		{
			name: e("pricingTiers.starter"),
			price: e("pricingTiers.price0"),
			period: e("pricingTiers.forever"),
			features: [
				e("pricingTiers.benchmarkRunPerDay", { runs: 5 }),
				e("pricingTiers.librariesNumber", { libs: 3 }),
				e("pricingTiers.communitySupport"),
				e("pricingTiers.publicResults")
			]
		},
		{
			name: e("pricingTiers.pro"),
			price: e("pricingTiers.price29"),
			period: e("pricingTiers.month"),
			features: [
		...
		{
			name: e("pricingTiers.enterprise"),
			price: e("pricingTiers.customPrice"),
			period: "",
			features: [
		...
		children: t.map((t) => u("div", {
			...
			children: [
				...
				l("button", {
					...
					children: t.name === e("pricingTiers.enterprise") ? e("pricingTiers.contactSales") : e("pricingTiers.getStarted")
				})
			]
		}, t.name))
	});
