...
}).join("|") : "", Fe = { index: u }, Ie = () => Fe, Le = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
...
var I = {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), gt = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: o, isCookieEnabled: l }) => {
	let { locales: u, defaultLocale: d } = p ?? {}, [f, m] = s(e ?? L ?? t ?? d);
	i(() => {
		e && e !== f && m(e);
	}, [e]), i(() => {
		ft();
...
}, bt = ({ children: e, i18n: t }) => (t !== void 0 && y({ log: h })(`${b("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), c(_t, { children: e })), V = (e, t, n = ".") => {
	if (!t) return e;
...
var kt = {
	type: "3rdParty",
	init: (e) => {}
}, At = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-react-i18next-app/src/components/MockBanner.tsx", jt = () => {
	let { t: e } = Ot();
	return f("div", {
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-react-i18next-app/src/components/pages/settings/SettingsHeader.tsx";
function Mt() {
	let { t: e } = Ot();
	return f(d, { children: [
		f(jt, {}, void 0, !1, {
...
var Nt = Q, Pt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-react-i18next-app/scripts/Wrapper.tsx";
...
var It = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-react-i18next-app/src/components/pages/settings/SettingsHeader.wrapper.tsx";
function Lt() {
	return f(Ft, { children: f(Mt, {}, void 0, !1, {
		fileName: It,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
