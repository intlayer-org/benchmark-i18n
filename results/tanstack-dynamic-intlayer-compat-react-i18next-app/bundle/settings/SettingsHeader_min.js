...
}, W = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), Fe = { index: s }, Ie = () => Fe, Le = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
...
var mt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), yt = ({ locale: e, defaultLocale: t, variant: r, children: s, setLocale: c, disableEditor: u, isCookieEnabled: f }) => {
	let { locales: p, defaultLocale: m } = d ?? {}, [h, g] = o(() => e ?? ht() ?? t ?? m), [_, v] = o(e);
	e !== _ && (v(e), e && e !== h && g(e)), i(() => {
		_t();
	}, []);
	let ee = n((e) => {
