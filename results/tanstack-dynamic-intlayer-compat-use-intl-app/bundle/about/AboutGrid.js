import React, { Fragment, createContext, createElement, isValidElement, useContext, useEffect, useRef, useState } from "react";
...
var content = {
	"de": () => import("../../../../.intlayer/dynamic_dictionary/json/about-grid/de.json").then((m) => m.default),
	"en": () => import("./intlayer-AboutGrid-wrapper-190k01-en-DuBKMFup.js").then((n) => n.t).then((m) => m.default),
	"es": () => import("../../../../.intlayer/dynamic_dictionary/json/about-grid/es.json").then((m) => m.default),
	"fr": () => import("../../../../.intlayer/dynamic_dictionary/json/about-grid/fr.json").then((m) => m.default),
	"it": () => import("../../../../.intlayer/dynamic_dictionary/json/about-grid/it.json").then((m) => m.default),
	"ja": () => import("../../../../.intlayer/dynamic_dictionary/json/about-grid/ja.json").then((m) => m.default),
	"ko": () => import("../../../../.intlayer/dynamic_dictionary/json/about-grid/ko.json").then((m) => m.default),
	"pt": () => import("../../../../.intlayer/dynamic_dictionary/json/about-grid/pt.json").then((m) => m.default),
	"ru": () => import("../../../../.intlayer/dynamic_dictionary/json/about-grid/ru.json").then((m) => m.default),
	"zh": () => import("../../../../.intlayer/dynamic_dictionary/json/about-grid/zh.json").then((m) => m.default)
};
...
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-use-intl-app/src/components/pages/about/AboutGrid.tsx";
function AboutGrid() {
	const t = useDictionaryDynamic(content, "about-grid");
	return jsxDEV("div", {
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-use-intl-app/src/components/pages/about/AboutGrid.wrapper.tsx";
function Wrapped() {
