...
var content$1 = {
	...
	"en": () => import("./intlayer-BlogHeader-wrapper-102lty-en-WWcJwwec.js").then((n) => n.t).then((m) => m.default),
...
var content = {
	...
	"en": () => import("./intlayer-BlogHeader-wrapper-102lty-en-WWcJwwec.js").then((n) => n.n).then((m) => m.default),
...
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-use-intl-app/src/components/pages/blog/BlogHeader.tsx";
function BlogHeader() {
	const tHeader = useDictionaryDynamic(content$1, "header");
	const tBlog = useDictionaryDynamic(content, "blog-header");
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-use-intl-app/src/components/pages/blog/BlogHeader.wrapper.tsx";
function Wrapped() {
...
var content$1 = { "insightsTutorialsAndAnalysisFrom": "Insights, tutorials, and analysis from the i18n community." };
var en_default$1 = {
	key: key$1,
	content: content$1
};
