...
var D = /* @__PURE__ */ new WeakMap(), O = 0, Oe = (e) => {
	...
	return Object.assign((e, t) => r(e, t) ?? n(e), {
		...
		rich: (e, t) => {
			...
			return o === void 0 ? n(e) : u(l, { children: wt(Y(o), a) });
		},
		markup: (e, t) => {
			let { scalarValues: i, renderers: a } = Ct(t), o = r(e, i);
	...
	let { locales: l, defaultLocale: ee } = m ?? {}, [d, f] = c(e ?? zt ?? t ?? ee);
	o(() => {
		e && e !== d && f(e);
	}, [e]), o(() => {
		Gt();
...
}), Xt = ({ locale: e, children: t, messages: n, formats: r, now: i, timeZone: a, onError: o, getMessageFallback: s }) => (n !== void 0 && Te({ log: te })(`${x("IntlProvider", le)} do not pass the messages prop with intlayer. Messages are loaded automatically under the hood for bundle optimization reason`), u(qt, {
	locale: e,
	children: t
...
var en = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-use-intl-app/src/components/pages/careers/OpenPositions.wrapper.tsx";
function tn() {
	return f($t, { children: f(Zt, {}, void 0, !1, {
		fileName: en,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
