...
var content$1 = {
	...
	"en": () => import("./intlayer-ContactForm-wrapper-10qdvo-en-C3FtfXmN.js").then((n) => n.n).then((m) => m.default),
...
var content = {
	...
	"en": () => import("./intlayer-ContactForm-wrapper-10qdvo-en-C3FtfXmN.js").then((n) => n.t).then((m) => m.default),
...
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-use-intl-app/src/components/pages/contact/ContactForm.tsx";
function ContactForm() {
	const t = useDictionaryDynamic(content$1, "contact-form");
	const tHeader = useDictionaryDynamic(content, "header");
	const nameId = useId();
	const emailId = useId();
	const topicId = useId();
		...
		children: [
			...
			jsxDEV("div", { children: [jsxDEV("label", {
				...
				children: [
					...
					jsxDEV("option", { children: tHeader("contact") }, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 57,
						columnNumber: 11
					}, this),
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-use-intl-app/src/components/pages/contact/ContactForm.wrapper.tsx";
function Wrapped() {
