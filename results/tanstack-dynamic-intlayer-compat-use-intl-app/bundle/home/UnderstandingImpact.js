...
var content = {
	...
	"en": () => import("./intlayer-UnderstandingImpact-wrapper-1uw97w-en-C9KE4TZa.js").then((n) => n.t).then((m) => m.default),
...
function UnderstandingImpact() {
	const t = useDictionaryDynamic(content, "understanding-impact");
	return jsxs("section", {
