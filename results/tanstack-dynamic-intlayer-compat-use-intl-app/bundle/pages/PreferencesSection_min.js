...
function Gt() {
	let e = Ut(k, "preferences-section"), t = c();
	return p("section", {
		...
		children: [f("h2", {
			...
			children: [
				...
				p("div", { children: [f("label", {
					...
					children: [
						f("option", { children: e("englishEn") }),
						f("option", { children: e("frenchFr") }),
						f("option", { children: e("germanDe") }),
						f("option", { children: e("spanishEs") }),
						f("option", { children: e("japaneseJa") }),
						f("option", { children: e("chineseSimplifiedZhCn") }),
						f("option", { children: e("arabicAr") })
					]
				})] })
			]
		})]
