...
var content = {
	...
	"en": () => import("./intlayer-ProductsGrid-wrapper-mj97kl-en-2riX5mSh.js").then((n) => n.t).then((m) => m.default),
...
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-use-intl-app/src/components/pages/products/ProductsGrid.tsx";
function ProductsGrid() {
	const t = useDictionaryDynamic(content, "products-grid");
	const products = [
		{
			name: t("benchmarkCli"),
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-use-intl-app/src/components/pages/products/ProductsGrid.wrapper.tsx";
function Wrapped() {
