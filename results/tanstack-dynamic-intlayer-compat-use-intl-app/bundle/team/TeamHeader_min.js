...
}, re = "__intlayerPreloaded", ie = ["en"], v = "\x1B[0m", ae = "\x1B[34m", oe = "\x1B[31m", se = "\x1B[32m", ce = "\x1B[38;5;3m", le = "\x1B[36m", y = (e = {}) => ({
	...e,
...
}), C = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? v : n : v}` : e, Ee = (e, t = ce, n = v) => [e].flat().map((e) => C(e, t, n)).join(", ");
C("✗", oe), C("✓", se), C("⏲", ae);
var De = (e) => {
	...
	return (T === void 0 || w !== e) && (w = e, T = De()), T;
}, E = {
	de: () => import("../../../../.intlayer/dynamic_dictionary/json/team-header/de.json").then((e) => e.default),
	en: () => import("./intlayer-TeamHeader-wrapper-1om161-en-rZaE8twS.js").then((e) => e.t).then((e) => e.default),
...
var k = /* @__PURE__ */ new WeakMap(), A = 0, ke = (e) => {
...
}, Ne = "translation", Pe = "enumeration", Fe = "plural", P = "insertion", Ie = "object", Le = "array", F = "markdown", I = "html", Re = "gender", ze = "select", L = (e, t) => {
	for (let n of t.plugins ?? []) if (n.canHandle(e)) return n.transform(e, t, (e, t) => L(e, t));
	if (typeof e != "object" || !e || e.$$typeof !== void 0 || e.__v_isVNode !== void 0 || e._isVNode !== void 0 || e.isJSX !== void 0 || typeof e == "function") return e;
	if (Array.isArray(e)) return e.map((e, n) => L(e, {
		...t,
		children: e,
		keyPath: [...t.keyPath, {
			type: Le,
...
}, Ve = (e, t) => e[Be(e, t) ?? "fallback"], R = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), z = "default", He = /[^A-Za-z0-9._&=-]/g, B = /[^A-Za-z0-9._-]/g, Ue = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, V = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, Ue);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, We = (e) => e === void 0 ? z : typeof e == "string" ? V(e, He) : Object.keys(e).sort().map((t) => `${V(t, B)}=${V(String(e[t]), B)}`).join("&"), Ge = (e) => Array.isArray(e) ? e.length === 0 ? [z] : e.map(We) : [We(e)], Ke = (e, t) => {
	...
	if (!Je(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? z : Ke(Ge(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => qe(e, n, t, s)).map((t) => Ye(e, t));
	...
	"toLocaleString"
]), tt = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : et.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : tt(e ? `${e}.${String(n)}` : String(n)) }), nt = /* @__PURE__ */ new Set(), rt = (e, t, n) => {
	let r = $e()[e];
	return r ? Ct(r, t, n) : (nt.has(e) || (S({ log: ee })(typeof window > "u" ? `Dictionary ${Ee(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), nt.add(e)), tt(e));
}, it = (e, t, n) => e[x("PluralRules", n).select(t)] ?? e.other, at = (e, t) => {
	...
	if (H(e)) return e.nodeType === "html" ? e[I] : e[F];
}, ut = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, ft = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? U : {
...
}, pt = U, mt = (e) => U, ht = U, gt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? U : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: P }], i = e[P], a = {
			...
			transform: (e, n, r) => {
				if (H(e)) return (i) => dt(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, _t = U, vt = U, yt = (e) => U, bt = U, xt = (e, t = !0) => [
	ft(e ?? g.defaultLocale, t ? g.defaultLocale : void 0),
	pt,
	ht,
	gt,
	yt(e ?? g.defaultLocale),
	bt,
	_t,
	vt
], St = (e, t, n = []) => L(e, {
	...
	let { locale: r, selector: i } = Ze(t), a = je(r ?? g.defaultLocale, Qe(i), n), o = Me(e, a);
	if (o.hit) return o.content;
	let s = n ?? xt(r), c = Xe(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
}, Tt = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", Et = /\{\{\s*(.*?)\s*\}\}/g, Dt = (e, t = {}) => {
	if (!Object.values(t).some(Tt)) return {
		isSimple: !0,
		parts: e.replace(Et, (e, n) => (t[n.trim()] ?? "").toString())
	};
	let n = e.split(Et), r = [];
	...
	if (r.nodeType === "html") return q(r[I], t, n);
	if (r.nodeType === "plural") {
		let e = r[Fe];
		return q(it(e, Number(K(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[Pe], i = Ot.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[ze], i = K(t, typeof r.variable == "string" ? r.variable : "value");
		return q(at(e, String(i ?? "")), t, n);
	}
	...
	return Rt(e, (t) => It(e, n ?? "", i, t), (e) => t ? `${t}.${e}` : e);
}, It = (e, t, n, r) => {
	let i = t, a = n ? `${n}.${r}` : r, o = $e();
	if (!i) {
		let [t, ...n] = r.split(".");
...
}, Y = /* @__PURE__ */ new Map(), Bt = (e, t) => (Y.has(e) || Y.set(e, zt(t)), Y.get(e).read()), Vt = ({ children: e, value: t, additionalProps: n }) => {
...
}, Gt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? U : {
	id: "insertion-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "insertion",
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: P }], i = e[P], a = {
...
}, Kt = U, qt = U, X = /* @__PURE__ */ new Map(), Jt = (e, t = !0) => {
	let n = `${e ?? g.defaultLocale}_${t}`;
	if (X.has(n)) return X.get(n);
	let r = [
		ft(e ?? g.defaultLocale, t ? g.defaultLocale : void 0),
		pt,
		mt(e ?? g.defaultLocale),
		ht,
		yt(e ?? g.defaultLocale),
		bt,
		_t,
	...
	return X.set(n, r), r;
}, Z = (e, t) => Ct(e, t, Jt(typeof t == "object" && t ? t.locale : t)), Yt = he(b), Xt = (e, t) => ge(e, {
	...b,
	isCookieEnabled: t
}), Zt = () => {
	...
	let { locales: c, defaultLocale: u } = g ?? {}, [f, p] = l(e ?? Yt ?? t ?? u);
	o(() => {
		e && e !== f && p(e);
	}, [e]), o(() => {
		tn();
	...
	let { locale: r, variant: i } = a(Q) ?? {}, { locale: o, selector: s } = {
		locale: n,
		selector: void 0
	}, c = o ?? r ?? g.defaultLocale, l = wt(e, c);
	if (l) return Z(l, c);
	let u = e;
	return Z(Bt(`${String(t)}.${c}`, u[c]?.()), c);
}, on = ((e, t, n) => {
	let { locale: r } = a(Q) ?? {};
	return Lt(r, an(e, t), n);
}), sn = ({ locale: e, children: t, messages: n, formats: r, now: i, timeZone: a, onError: o, getMessageFallback: s }) => (n !== void 0 && S({ log: ee })(`${C("IntlProvider", le)} do not pass the messages prop with intlayer. Messages are loaded automatically under the hood for bundle optimization reason`), d(rn, {
	locale: e,
	children: t
}, String(e))), cn = ((e) => {
	let { locale: t } = a(Q) ?? {};
	return s(() => Ft(t, e), [t, e]);
}), ln = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-use-intl-app/src/components/MockBanner.tsx", un = () => {
	let e = cn();
	return m("div", {
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-use-intl-app/src/components/pages/team/TeamHeader.tsx";
function dn() {
	let e = on(E, "team-header");
	return m(p, { children: [
		m(un, {}, void 0, !1, {
			fileName: $,
			lineNumber: 8,
...
var fn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-use-intl-app/scripts/Wrapper.tsx";
...
var mn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/intlayer-compat-use-intl-app/src/components/pages/team/TeamHeader.wrapper.tsx";
function hn() {
	return m(pn, { children: m(dn, {}, void 0, !1, {
		fileName: mn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
