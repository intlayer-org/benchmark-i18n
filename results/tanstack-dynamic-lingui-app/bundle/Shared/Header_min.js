...
import { Link as o, useNavigate as s, useParams as c } from "@tanstack/react-router";
...
}, x = ({ i18n: e, defaultComponent: t, children: n }) => {
	let r = i(() => b(e, t), [e, t]), a = (0, h.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
	return a.i18n.locale ? u(g.Provider, {
		value: a,
		children: n
...
}, S = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/src/components/ThemeToggle.tsx";
function C() {
...
function T() {
	let { i18n: e } = v(), t = (t) => e._(`theme-toggle.${t}`), [r, i] = a("auto");
	n(() => {
		let e = C();
		i(e), w(e);
	}, []), n(() => {
		if (r !== "auto") return;
		let e = window.matchMedia("(prefers-color-scheme: dark)"), t = () => w("auto");
	...
	function o() {
		...
		i(e), w(e), window.localStorage.setItem("theme", e);
	}
	let s = t(r === "auto" ? "themeModeAutoSystemClick" : r === "light" ? "themeModeLightClick" : "themeModeDarkClick");
	return d("button", {
		type: "button",
		onClick: o,
		"aria-label": s,
...
function me(e, t) {
	return /^::/.test(e) ? ce(pe(e.substring(2)), void 0, t) : e;
}
function P(e, t = (e) => e) {
	return N((0, te.parse)(e), t);
}
function F(e, t = (e) => e) {
	try {
		return P(e, t);
...
function U(e, t, n, { offset: r = 0, ...i }) {
	let a = B(e), o = t ? W(() => G("plural-ordinal", a), () => new Intl.PluralRules(a, { type: "ordinal" })) : W(() => G("plural-cardinal", a), () => new Intl.PluralRules(a, { type: "cardinal" }));
...
}), J = "%__lingui_octothorpe__%", ge = (e, t, n = {}) => {
	let r = t || e, i = (e) => typeof e == "object" ? e : n[e], a = (e, t) => {
		let a = Object.keys(n).length ? i("number") : void 0, o = H(r, e, a);
		return t.replace(new RegExp(J, "g"), o);
	};
	return {
		plural: (e, t) => {
...
var ye = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), this.setMessagesCompiler(F), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? z, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), I(s) && K.test(s) ? q(s) : I(s) ? s : ve(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
async function Ce(e, t = ["shared", "route"]) {
	let n = {};
	return await Promise.all(t.map(async (t) => {
		try {
			let r = await ee(Object.assign({
...
var X = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/src/components/LocaleSwitcher.tsx";
function Te() {
	let e = c({ strict: !1 }).locale ?? "en", t = s(), n = (e) => {
		t({ params: (t) => ({
			...t,
			locale: e
		}) });
...
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/src/components/Header.tsx";
function Ee() {
	let { i18n: e } = v(), t = (t) => e._(`header.${t}`);
	Z("Header");
	let [n, r] = a(!1), i = c({ strict: !1 }).locale ?? "en", s = [
		{
			to: "/$locale/products",
			label: t("products")
		},
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/src/components/Header.wrapper.tsx";
function ke() {
	return d(Oe, { children: d(Ee, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
