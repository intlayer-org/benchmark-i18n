...
}, p = (e) => e < 4 ? "short" : e === 4 ? "long" : "narrow", m = (e) => e % 2 == 0 ? "2-digit" : "numeric";
function h(e, t) {
	switch (e.char) {
		...
		default: return t(`${e.desc} is not supported; falling back to year:numeric`, f.WARNING), { year: "numeric" };
	}
}
function g(e, t) {
	switch (e.width) {
...
function v(e, t) {
	let { char: n, desc: r, width: i } = e;
	return (n === "c" || n === "e") && i < 3 && t(`Numeric value is not supported for ${r}; falling back to weekday:short`, f.WARNING), p(i);
}
function y(e) {
	let t = m(e.width), n;
	switch (e.char) {
...
function x(e, t) {
	switch (e.field) {
		case "era": return { era: p(e.width) };
		case "year": return h(e, t);
		case "month": return { month: g(e, t) };
		case "day": return { day: _(e, t) };
		case "weekday": return { weekday: v(e, t) };
		case "period": return;
		case "hour": return y(e);
		case "min": return { minute: m(e.width) };
		case "sec": return { second: m(e.width) };
		case "tz": return { timeZoneName: b(e, t) };
		case "quarter":
		case "week":
		case "sec-frac":
...
function S(e, t, n = (e) => {
	...
	for (let t of e) {
		...
		if (e) {
			let r = new f(e.message, t);
			r.stack = e.stack, n(r);
		}
		o && n(new f(`Ignoring string part: ${o}`, t, f.WARNING)), a && (i.indexOf(a) === -1 ? i.push(a) : n(new f(`Duplicate ${a} token`, t)));
		let s = x(t, (e, r) => n(new f(e, t, r)));
		s && Object.assign(r, s);
	}
	return r;
}
...
function O(e, t) {
	return /^::/.test(e) ? S(te(e.substring(2)), void 0, t) : e;
}
function k(e, t = (e) => e) {
	return D((0, d.parse)(e), t);
}
function ne(e, t = (e) => e) {
	try {
		return k(e, t);
...
var A = (e) => typeof e == "string", re = (e) => typeof e == "function", j = /* @__PURE__ */ new Map(), M = "en";
function N(e) {
...
var K = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), this.setMessagesCompiler(ne), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? M, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
async function ae(e, t = ["shared", "route"]) {
	let n = {};
	return await Promise.all(t.map(async (t) => {
		try {
			let r = await c(Object.assign({
...
}, de = ({ i18n: e, defaultComponent: n, children: r }) => {
	let i = t(() => ue(e, n), [e, n]), o = (0, Z.useSyncExternalStore)(i.subscribe, i.getSnapshot, i.getSnapshot);
	return o.i18n.locale ? a(le.Provider, {
		value: o,
		children: r
...
}, fe = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/scripts/Wrapper.tsx";
function pe({ children: e }) {
	let n = t(() => ae("en"), []), r = t(() => oe("en", n), [n]);
	return i(de, {
		i18n: r,
		children: e
	}, void 0, !1, {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/src/components/LocaleSwitcher.wrapper.tsx";
function me() {
	return i(pe, { children: i(se, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
