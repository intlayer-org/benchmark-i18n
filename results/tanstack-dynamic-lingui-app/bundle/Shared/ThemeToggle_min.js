...
}, g = ({ i18n: e, defaultComponent: t, children: n }) => {
	let i = r(() => h(e, t), [e, t]), o = (0, u.useSyncExternalStore)(i.subscribe, i.getSnapshot, i.getSnapshot);
	return o.i18n.locale ? a(d.Provider, {
		value: o,
		children: n
...
}, _ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/src/components/ThemeToggle.tsx";
function v() {
...
function b() {
	let { i18n: e } = p(), t = (t) => e._(`theme-toggle.${t}`), [r, a] = i("auto");
	n(() => {
		let e = v();
		a(e), y(e);
	}, []), n(() => {
		if (r !== "auto") return;
		let e = window.matchMedia("(prefers-color-scheme: dark)"), t = () => y("auto");
	...
	function s() {
		...
		a(e), y(e), window.localStorage.setItem("theme", e);
	}
	let c = t(r === "auto" ? "themeModeAutoSystemClick" : r === "light" ? "themeModeLightClick" : "themeModeDarkClick");
	return o("button", {
		type: "button",
		onClick: s,
		"aria-label": c,
...
}, E = (e) => e < 4 ? "short" : e === 4 ? "long" : "narrow", D = (e) => e % 2 == 0 ? "2-digit" : "numeric";
function ee(e, t) {
	switch (e.char) {
		case "y": return { year: D(e.width) };
		case "r": return {
			calendar: "gregory",
			year: "numeric"
		};
		default: return t(`${e.desc} is not supported; falling back to year:numeric`, T.WARNING), { year: "numeric" };
	}
}
function te(e, t) {
	switch (e.width) {
...
function k(e, t) {
	let { char: n, desc: r, width: i } = e;
	return (n === "c" || n === "e") && i < 3 && t(`Numeric value is not supported for ${r}; falling back to weekday:short`, T.WARNING), E(i);
}
function A(e) {
	let t = D(e.width), n;
	switch (e.char) {
...
function M(e, t) {
	switch (e.field) {
		...
		case "min": return { minute: D(e.width) };
		case "sec": return { second: D(e.width) };
...
function N(e, t, n = (e) => {
	...
	for (let t of e) {
		...
		if (e) {
			let r = new T(e.message, t);
			r.stack = e.stack, n(r);
		}
		o && n(new T(`Ignoring string part: ${o}`, t, T.WARNING)), a && (i.indexOf(a) === -1 ? i.push(a) : n(new T(`Duplicate ${a} token`, t)));
		let s = M(t, (e, r) => n(new T(e, t, r)));
		s && Object.assign(r, s);
	}
	return r;
}
...
function se(e, t) {
	return /^::/.test(e) ? N(oe(e.substring(2)), void 0, t) : e;
}
function ce(e, t = (e) => e) {
	return F((0, w.parse)(e), t);
}
function I(e, t = (e) => e) {
	try {
		return ce(e, t);
...
}), X = "%__lingui_octothorpe__%", le = (e, t, n = {}) => {
...
function de(e, t, n) {
	return (r = {}, i) => {
		let a = le(t, n, i), o = (e, t = !1) => Array.isArray(e) ? e.reduce((e, n) => {
			if (n === "#" && t) return e + X;
			if (L(n)) return e + n;
			let [i, s, c] = n, l = {};
...
var fe = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), this.setMessagesCompiler(I), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? B, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), L(s) && J.test(s) ? Y(s) : L(s) ? s : de(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
Z();
async function me(e, t = ["shared", "route"]) {
	let n = {};
	return await Promise.all(t.map(async (t) => {
		try {
			let r = await x(Object.assign({
...
var he = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/scripts/Wrapper.tsx";
function ge({ children: e }) {
	let t = r(() => me("en"), []), n = r(() => Q("en", t), [t]);
	return o(g, {
		i18n: n,
		children: e
	}, void 0, !1, {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/src/components/ThemeToggle.wrapper.tsx";
function _e() {
	return o(ge, { children: o(b, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
