...
var o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	...
	(function() {
		...
		function n(e, t) {
			...
			var s = i[0].inst, m = i[1];
			return u(function() {
				s.value = n, s.getSnapshot = t, r(s) && m({ inst: s });
			}, [
				e,
				n,
				t
			]), l(function() {
				return r(s) && m({ inst: s }), e(function() {
					r(s) && m({ inst: s });
				});
			}, [e]), d(n), n;
		}
		...
		var a = s("react"), o = typeof Object.is == "function" ? Object.is : t, c = a.useState, l = a.useEffect, u = a.useLayoutEffect, d = a.useDebugValue, f = !1, p = !1, m = typeof window > "u" || window.document === void 0 || window.document.createElement === void 0 ? i : n;
...
}, h = ({ i18n: e, defaultComponent: t, children: i }) => {
	let a = n(() => m(e, t), [e, t]), o = (0, l.useSyncExternalStore)(a.subscribe, a.getSnapshot, a.getSnapshot);
	return o.i18n.locale ? r(u.Provider, {
		value: o,
		children: i
...
}, g = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/src/components/pages/careers/OpenPositions.tsx";
function _() {
	let { i18n: e } = f(), t = [
		{
			title: e._({
...
var le = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), this.setMessagesCompiler(ae), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? B, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
Z();
async function Q(e, t = ["shared", "route"]) {
	let n = {};
	return await Promise.all(t.map(async (t) => {
		try {
			let r = await v(Object.assign({
				...
				"../locales/de/settings.mjs": () => import("./settings-8OeAPaa0.js"),
				"../locales/de/shared.mjs": () => import("./shared-DpEyrK48.js"),
				"../locales/de/team.mjs": () => import("./team-DHRK5LQG.js"),
				"../locales/en/about.mjs": () => import("./about-DixAftfs.js"),
				"../locales/en/blog.mjs": () => import("./blog-JcZ5XsRz.js"),
				"../locales/en/careers.mjs": () => import("./careers-BqbVndQu.js"),
				...
				"../locales/en/settings.mjs": () => import("./settings--LfWHZXs.js"),
				"../locales/en/shared.mjs": () => import("./shared-CMJxq6N3.js"),
				"../locales/en/team.mjs": () => import("./team-CobjIQXZ.js"),
				"../locales/es/about.mjs": () => import("./about-AEXawwHV.js"),
				"../locales/es/blog.mjs": () => import("./blog-D-T54KBf.js"),
				"../locales/es/careers.mjs": () => import("./careers-BJ9WdDns.js"),
				...
				"../locales/es/settings.mjs": () => import("./settings-PTOY0l2Z.js"),
				"../locales/es/shared.mjs": () => import("./shared-DE-NMadh.js"),
				"../locales/es/team.mjs": () => import("./team-whIiLfCb.js"),
				"../locales/fr/about.mjs": () => import("./about-CG_gSW2i.js"),
				"../locales/fr/blog.mjs": () => import("./blog-736GE1lG.js"),
				"../locales/fr/careers.mjs": () => import("./careers-CvLQChLa.js"),
				...
				"../locales/fr/settings.mjs": () => import("./settings-D8ec9KeL.js"),
				"../locales/fr/shared.mjs": () => import("./shared-Cvt5sfqy.js"),
				"../locales/fr/team.mjs": () => import("./team-BuKLqhrD.js"),
				"../locales/it/about.mjs": () => import("./about-BVn39k0A.js"),
				"../locales/it/blog.mjs": () => import("./blog-6wz2goNK.js"),
				"../locales/it/careers.mjs": () => import("./careers-BJVVwpgV.js"),
				...
				"../locales/it/settings.mjs": () => import("./settings-qnowe2rO.js"),
				"../locales/it/shared.mjs": () => import("./shared-0yvefH9n.js"),
				"../locales/it/team.mjs": () => import("./team-CunKhHGc.js"),
				"../locales/ja/about.mjs": () => import("./about-C7Jhn8Ik.js"),
				"../locales/ja/blog.mjs": () => import("./blog-FrF-rqEm.js"),
				"../locales/ja/careers.mjs": () => import("./careers-C99xPm2m.js"),
				...
				"../locales/ja/settings.mjs": () => import("./settings-DLQFGzI8.js"),
				"../locales/ja/shared.mjs": () => import("./shared-Elm_WPcW.js"),
				"../locales/ja/team.mjs": () => import("./team-DmVDBtyw.js"),
				"../locales/ko/about.mjs": () => import("./about-BW-to0jR.js"),
				"../locales/ko/blog.mjs": () => import("./blog-DlkuPRKu.js"),
				"../locales/ko/careers.mjs": () => import("./careers-D_kqCuyl.js"),
				...
				"../locales/ko/settings.mjs": () => import("./settings-BLWPIvHf.js"),
				"../locales/ko/shared.mjs": () => import("./shared-BBBPiwDg.js"),
				"../locales/ko/team.mjs": () => import("./team-BiDnmHWA.js"),
				"../locales/pt/about.mjs": () => import("./about-DsevUuWR.js"),
				"../locales/pt/blog.mjs": () => import("./blog-B0nwoA4e.js"),
				"../locales/pt/careers.mjs": () => import("./careers-Ccre0PdN.js"),
				...
				"../locales/pt/settings.mjs": () => import("./settings-CwEYXE44.js"),
				"../locales/pt/shared.mjs": () => import("./shared-DaexMEjm.js"),
				"../locales/pt/team.mjs": () => import("./team-BHNiMc37.js"),
				"../locales/ru/about.mjs": () => import("./about-DMquLDkl.js"),
				"../locales/ru/blog.mjs": () => import("./blog-BydoQuIh.js"),
				"../locales/ru/careers.mjs": () => import("./careers-XLAPd5Vo.js"),
				...
				"../locales/ru/settings.mjs": () => import("./settings-7kpGHovl.js"),
				"../locales/ru/shared.mjs": () => import("./shared-OFO3TF5x.js"),
				"../locales/ru/team.mjs": () => import("./team-BnJ_r_Kh.js"),
				"../locales/zh/about.mjs": () => import("./about-BHfjIu4D.js"),
				"../locales/zh/blog.mjs": () => import("./blog-DC2XHUBV.js"),
				"../locales/zh/careers.mjs": () => import("./careers-BABd6Bgy.js"),
				...
				"../locales/zh/settings.mjs": () => import("./settings-CJtmFHN3.js"),
				"../locales/zh/shared.mjs": () => import("./shared-DqC3arw4.js"),
...
var fe = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/scripts/Wrapper.tsx";
function pe({ children: e }) {
	let t = n(() => Q("en"), []), r = n(() => de("en", t), [t]);
	return a(h, {
		i18n: r,
		children: e
	}, void 0, !1, {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/src/components/pages/careers/OpenPositions.wrapper.tsx";
function me() {
	return a(pe, { children: a(_, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
