import { createContext as e, useContext as t, useLayoutEffect as n, useMemo as r } from "react";
...
}, h = ({ i18n: e, defaultComponent: t, children: n }) => {
	let a = r(() => m(e, t), [e, t]), o = (0, l.useSyncExternalStore)(a.subscribe, a.getSnapshot, a.getSnapshot);
	return o.i18n.locale ? i(u.Provider, {
		value: o,
		children: n
...
var _ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/src/components/pages/home/Hero.tsx";
function v() {
	let { i18n: e } = f(), t = (t) => e._(`hero.${t}`);
	return g("Hero"), a("section", {
...
function re(e, t) {
	return /^::/.test(e) ? j(I(e.substring(2)), void 0, t) : e;
}
function ie(e, t = (e) => e) {
	return L((0, S.parse)(e), t);
}
function ae(e, t = (e) => e) {
	try {
		return ie(e, t);
...
function U(e, t, n) {
	...
	return q(() => J("date", r, n), () => new Intl.DateTimeFormat(r, i)).format(R(t) ? new Date(t) : t);
}
function W(e, t, n) {
	let r;
...
function G(e, t, n) {
	let r = H(e);
	return q(() => J("number", r, n), () => new Intl.NumberFormat(r, n)).format(t);
}
function K(e, t, n, { offset: r = 0, ...i }) {
	let a = H(e), o = t ? q(() => J("plural-ordinal", a), () => new Intl.PluralRules(a, { type: "ordinal" })) : q(() => J("plural-cardinal", a), () => new Intl.PluralRules(a, { type: "cardinal" }));
...
var Y = /\\u[a-fA-F0-9]{4}|\\x[a-fA-F0-9]{2}/, X = (e) => e.replace(/\\u([a-fA-F0-9]{4})|\\x([a-fA-F0-9]{2})/g, (e, t, n) => {
	if (t) {
		let e = parseInt(t, 16);
...
}), Z = "%__lingui_octothorpe__%", oe = (e, t, n = {}) => {
	let r = t || e, i = (e) => typeof e == "object" ? e : n[e], a = (e, t) => {
		let a = Object.keys(n).length ? i("number") : void 0, o = G(r, e, a);
		return t.replace(new RegExp(Z, "g"), o);
	};
	return {
		plural: (e, t) => {
			let { offset: n = 0 } = t, i = K(r, !1, e, t);
			return a(e - n, i);
		},
		selectordinal: (e, t) => {
			let { offset: n = 0 } = t, i = K(r, !0, e, t);
			return a(e - n, i);
		},
		select: se,
		number: (e, t) => G(r, e, i(t) || { style: t }),
		date: (e, t) => U(r, e, i(t) || t),
		time: (e, t) => W(r, e, i(t) || t)
	};
}, se = (e, t) => t[e] ?? t.other;
function ce(e, t, n) {
	return (r = {}, i) => {
		...
		return R(s) && Y.test(s) ? X(s) : R(s) ? s : s ? String(s) : "";
	};
}
var le = class {
	_events = {};
	...
	_messageCompiler;
	constructor(e) {
		super(), this.setMessagesCompiler(ae), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? V, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), R(s) && Y.test(s) ? X(s) : R(s) ? s : ce(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
	...
	number(e, t) {
		return G(this._locales || this._locale, e, t);
	}
};
function Q(e = {}) {
	return new ue(e);
...
var pe = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/scripts/Wrapper.tsx";
function me({ children: e }) {
	let t = r(() => de("en"), []), n = r(() => fe("en", t), [t]);
	return a(h, {
		i18n: n,
		children: e
	}, void 0, !1, {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/src/components/pages/home/Hero.wrapper.tsx";
function he() {
	return a(me, { children: a(v, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
