...
}, h = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/src/components/pages/pricing/PricingTiers.tsx";
function g() {
	let { i18n: e } = d(), t = [
		{
			name: e._({
		...
		children: t.map((e) => i("div", {
			...
			children: [
				...
				i("ul", {
					...
					children: e.features.map((e, t) => i("li", {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/lingui-app/src/components/pages/pricing/PricingTiers.wrapper.tsx";
function pe() {
