...
function m() {
	...
	return s("div", {
		...
		children: [
			...
			{
				name: e._({
					id: "team-grid.aishaPatel",
					message: "Aisha Patel"
				}),
				role: e._({
					id: "team-grid.developerAdvocate",
			...
			{
				name: e._({
					id: "team-grid.tomasRodriguez",
					message: "Tomás Rodríguez"
				}),
				role: e._({
					id: "team-grid.fullStackDeveloper",
			...
			{
				name: e._({
					id: "team-grid.yukiTanaka",
					message: "Yuki Tanaka"
				}),
				role: e._({
					id: "team-grid.dataAnalyst",
					message: "Data Analyst"
				}),
				bio: e._({
					id: "team-grid.ensuresStatisticalRigorInAll",
					message: "Ensures statistical rigor in all benchmark results. PhD in Applied Statistics from MIT."
				})
			},
			{
				name: e._({
					id: "team-grid.elenaKowalski",
					message: "Elena Kowalski"
				}),
				role: e._({
					id: "team-grid.communityManager",
