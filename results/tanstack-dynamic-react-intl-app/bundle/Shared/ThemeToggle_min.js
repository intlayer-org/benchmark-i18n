...
}, wt = (t) => e.Children.toArray(t).map((t, n) => e.isValidElement(t) ? a(e.Fragment, { children: t }, n) : t);
function Tt(e) {
	return function(t) {
		return e(wt(t));
	};
...
function Nt(t) {
	...
	return (!r.current || !Et(r.current, s)) && (r.current = s, i.current = jt(s, n.current)), St(i.current), a(Dt, {
		value: i.current,
		children: t.children
	});
}
