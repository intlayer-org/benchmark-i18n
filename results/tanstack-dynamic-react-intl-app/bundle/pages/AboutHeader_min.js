...
}, Ct = (t) => e.Children.toArray(t).map((t, n) => e.isValidElement(t) ? a(e.Fragment, { children: t }, n) : t);
function wt(e) {
	return function(t) {
		return e(Ct(t));
	};
...
function Nt(t) {
	...
	return (!r.current || !Tt(r.current, s)) && (r.current = s, i.current = jt(s, n.current)), xt(i.current), a(Dt, {
		value: i.current,
		children: t.children
	});
}
...
function It() {
	let e = Ot();
	return Ft("AboutHeader"), o(i, { children: [a("h1", {
