...
var qt = { useSuspense: !1 }, Jt, Yt = () => (Jt ||= e.createContext(void 0), Jt), Z = void 0, Xt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	...
	let { tolgee: r, options: a } = Zt(), s = te(e), c = k(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Qt(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
}, Un = "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service.", Wn = {
	route: dn,
	header: fn,
	footer: pn,
	common: mn,
