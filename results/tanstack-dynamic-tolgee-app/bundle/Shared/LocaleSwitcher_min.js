...
function Wt(e, t, a, o = !0) {
	let [s] = i(() => Ut(e)), [c, l] = i(o);
	return n(() => {
		l(!1);
	}, []), r(() => {
...
var Gt = { useSuspense: !1 }, Kt, qt = () => (Kt ||= e.createContext(void 0), Kt), Q = void 0, Jt = ({ tolgee: r, options: a, children: o, fallback: s, ssr: c }) => {
	n(() => {
	...
	l = Wt(r, u, d, !!c);
	let [f, p] = i(!l.isLoaded()), m = Object.assign(Object.assign({}, Gt), a), h = qt();
...
}, kn = "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service.", An = {
	route: Zt,
	header: Qt,
	footer: $t,
	common: en,
