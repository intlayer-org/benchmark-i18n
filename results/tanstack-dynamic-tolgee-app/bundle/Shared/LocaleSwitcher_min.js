...
var qe = { useSuspense: !1 }, Je, Ye = () => (Je ||= t.createContext(void 0), Je), $ = void 0, Xe = ({ tolgee: e, options: i, children: o, fallback: s, ssr: c }) => {
	r(() => {
	...
	l = Ke(e, u, d, !!c);
	let [f, p] = a(!l.isLoaded()), m = Object.assign(Object.assign({}, qe), i), h = Ye();
