...
function xe({ options: e }) {
	let t = le(), n = L(!1, () => o.isFetching(), t.onFetchingChange.emit), r = L(!1, () => w.isLoading(), t.onLoadingChange.emit), i = ve(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = _e(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = pe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var an = () => c("div", {
	...
	children: c(rn, { keyName: "mockBanner" })
}), on = u({
	aboutGrid: () => _n,
	aboutHeader: () => gn,
	apiAccessSection: () => Pn,
...
}, Rn = "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service.", zn = {
	route: sn,
	header: cn,
	footer: ln,
	common: un,
