...
var Ke = { useSuspense: !1 }, qe, Je = () => (qe ||= t.createContext(void 0), qe), Q = void 0, Ye = ({ tolgee: e, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
	...
	l = Ge(e, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, Ke), r), h = Je();
...
var Qe = () => {
	...
	let { tolgee: n, options: i } = Qe(), o = C(e), c = w(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = $e(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
var $ = (e) => {
	let n = tt(e);
	return Array.isArray(n) ? n.map((e, n) => t.createElement(t.Fragment, { key: n }, rt(e))) : rt(n);
}, it = (e) => {
	...
	let { t: n } = et();
	return t.createElement(it, Object.assign({ t: n }, e));
}, ot = Ue().use(Ce()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
