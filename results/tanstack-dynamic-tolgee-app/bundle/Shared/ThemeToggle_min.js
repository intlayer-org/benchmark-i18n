...
function me({ options: e }) {
	let t = ne(), n = de(!1, () => o.isFetching(), t.onFetchingChange.emit), r = de(!1, () => D.isLoading(), t.onLoadingChange.emit), i = fe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ue(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, b, f, t), o = oe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var ge = () => {
	...
	return t;
}, B = 0, V = 1, _e = 2, ve = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var H = 0, U = 1, W = 2, G = 3, K = 4, be = new Set([
	W,
	U,
	H
]), q = "'", xe = new Set([
...
function Ce(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case H:
			...
			break;
		case U:
			xe.has(i) ? (n = n.slice(0, -1) + i, t = W) : (n += i, t = H);
			break;
		case W:
			i === q ? t = H : (n += i, t = W);
			break;
		case G:
			i === "}" ? (d(), t = H) : ye(i) ? r !== "" && (d(), t = K) : (u(), t = G);
			break;
		case K: i == "}" ? t = H : ye(i) ? t = K : c(V);
	}
...
var Ee = () => (e, t) => (t.setFinalFormatter(Te()), e), De = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, J = {};
(function(e) {
	function t(e, t) {
		var n;
...
(g = console.assert) == null || g.call(console, Oe), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function ke(e, t) {
	let n = (n) => {
...
var Y = null;
function Le(e) {
	return Y ||= Ie(`${Fe}/@tolgee/web@${e}/dist/${Me}`).then(() => window[Ne][Pe]), Y;
}
...
var Je = { useSuspense: !1 }, Ye, Xe = () => (Ye ||= t.createContext(void 0), Ye), X = void 0, Ze = ({ tolgee: e, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
...
var et = () => {
	...
	let { tolgee: n, options: i } = et(), o = C(e), c = w(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = tt(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
