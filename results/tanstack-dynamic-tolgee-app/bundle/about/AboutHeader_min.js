...
function ln() {
	return cn("AboutHeader"), d(l, { children: [u("h1", {
		className: "mb-4 text-3xl font-bold text-foreground",
		children: u(sn, { keyName: "aboutHeader.aboutThisBenchmark" })
	}), u("p", {
		className: "mb-8 max-w-3xl text-muted-foreground",
		children: u(sn, { keyName: "aboutHeader.thisIsAnOpenSource" })
	})] });
}
var un = p({
	aboutGrid: () => xn,
