...
}, f = Object.defineProperty, p = Object.defineProperties, m = Object.getOwnPropertyDescriptors, h = Object.getOwnPropertySymbols, g = Object.prototype.hasOwnProperty, _ = Object.prototype.propertyIsEnumerable, v = (e, t, n) => t in e ? f(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function Ce({ options: e }) {
	let t = ue(), n = I(!1, () => o.isFetching(), t.onFetchingChange.emit), r = I(!1, () => S.isLoading(), t.onLoadingChange.emit), i = be(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ye(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = me(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Kt = { useSuspense: !1 }, qt, Jt = () => (qt ||= e.createContext(void 0), qt), X = void 0, Yt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	let { tolgee: r, options: a } = Xt(), s = D(e), c = O(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Zt(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
function on() {
	return l("section", { children: [c("h2", {
		...
		children: c(Q, { keyName: "resultsTable.sampleResults" })
	}), c("div", {
			...
			children: [c("thead", {
				...
				children: l("tr", { children: [
					c("th", {
						...
						children: c(Q, { keyName: "resultsTable.library" })
					}),
					c("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: c(Q, { keyName: "resultsTable.bundleSize" })
					}),
					c("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: c(Q, { keyName: "resultsTable.lookupTime" })
					}),
					c("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: c(Q, { keyName: "resultsTable.lazyLoading" })
					})
				] })
			}), c("tbody", { children: [
				{
...
}, zn = "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service.", Bn = {
	route: cn,
	header: ln,
	footer: un,
	common: dn,
