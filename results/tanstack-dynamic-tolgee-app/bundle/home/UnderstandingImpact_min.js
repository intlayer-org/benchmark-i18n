	...
	return l("section", {
		...
		children: [
			c("h2", {
				...
				children: c(Q, { keyName: "understandingImpact.understandingTheImpact" })
			}),
			l("div", {
				...
				children: [
					c("h3", {
						...
						children: c(Q, { keyName: "understandingImpact.whyASingleLargeJson" })
					}),
					c("p", {
						className: "text-sm text-muted-foreground",
						children: c(Q, { keyName: "understandingImpact.manyI18nLibrariesStore" })
					}),
					l("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							c("li", { children: c(Q, { keyName: "understandingImpact.theJsonMustBeParsed" }) }),
							c("li", { children: c(Q, { keyName: "understandingImpact.contextBasedArchitecturesCan" }) }),
							c("li", { children: c(Q, { keyName: "understandingImpact.duringServerSideRenderingThe" }) })
						]
					})
				]
			}),
			l("div", {
				...
				children: [
					c("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: c(Q, { keyName: "understandingImpact.theTradeOffsOfDynamic" })
					}),
					c("p", {
						className: "text-sm text-muted-foreground",
						children: c(Q, { keyName: "understandingImpact.splittingTranslationsIntoPerRoute" })
					}),
					l("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							l("li", { children: [
								c("strong", {
									...
									children: c(Q, { keyName: "understandingImpact.waterfallRequests" })
								}),
								" ",
								c(Q, { keyName: "understandingImpact.theAppMustFirstLoad" })
							] }),
							l("li", { children: [
								c("strong", {
									className: "text-foreground",
									children: c(Q, { keyName: "understandingImpact.flashOfUntranslatedContent" })
								}),
								" ",
								c(Q, { keyName: "understandingImpact.usersMayBrieflySeeTranslation" })
							] }),
							l("li", { children: [
								c("strong", {
									className: "text-foreground",
									children: c(Q, { keyName: "understandingImpact.cacheInvalidation" })
								}),
								" ",
								c(Q, { keyName: "understandingImpact.updatingTranslationsRequiresCache" })
							] })
						]
					})
				]
			...
			l("div", {
				...
				children: [c("h3", {
					className: "mb-2 text-lg font-semibold text-foreground",
					children: c(Q, { keyName: "understandingImpact.whatThisBenchmarkMeasures" })
				}), c("p", {
					className: "text-sm text-muted-foreground",
					children: c(Q, { keyName: "understandingImpact.thisTestAppProvidesA" })
				})]
			})
		]
	});
