...
function ue(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return x(s.onError, (e) => new j("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return x(s.onError, (e) => new oe("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function E(e) {
		e && l.backends.push(e);
	}
	...
	let k = Object.freeze({
		...
		setStoredLanguage(e) {
			return x(s.onError, (e) => new j("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function pe({ options: e }) {
	let t = ie(), n = B(!1, () => o.isFetching(), t.onFetchingChange.emit), r = B(!1, () => E.isLoading(), t.onLoadingChange.emit), i = de(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ue(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = se(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var he = () => {
	...
	return t;
}, H = 0, U = 1, ge = 2, _e = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var we = () => (e, t) => (t.setFinalFormatter(Ce()), e), Te = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Ee = {};
(function(e) {
	function t(e, t) {
		var n;
...
(_ = console.assert) == null || _.call(console, De), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Oe(e, t) {
	let n = (n) => {
...
var Je = { useSuspense: !1 }, Ye, Xe = () => (Ye ||= t.createContext(void 0), Ye), Z = void 0, Ze = ({ tolgee: e, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
...
var et = () => {
	...
	let { tolgee: n, options: i } = et(), o = w(e), c = T(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = tt(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
...
var Q = (e) => {
	let n = rt(e);
	return Array.isArray(n) ? n.map((e, n) => t.createElement(t.Fragment, { key: n }, at(e))) : at(n);
}, ot = (e) => {
	...
	let { t: n } = nt();
	return t.createElement(ot, Object.assign({ t: n }, e));
}, ct = Ge().use(we()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
