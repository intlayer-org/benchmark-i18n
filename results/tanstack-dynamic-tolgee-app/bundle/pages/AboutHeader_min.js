...
var Ye = { useSuspense: !1 }, Xe, Ze = () => (Xe ||= t.createContext(void 0), Xe), Q = void 0, Qe = ({ tolgee: e, options: r, children: i, fallback: o, ssr: s }) => {
	...
	c = Je(e, u, d, !!s);
	let [f, p] = l(!c.isLoaded()), m = Object.assign(Object.assign({}, Ye), r), h = Ze();
...
var tt = () => {
	...
	let { tolgee: n, options: i } = tt(), o = E(e), s = D(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = nt(), f = c([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
