		...
		children: [
			u("div", {
				...
				children: [u("div", { children: [l("label", {
					...
					children: l(Q, { keyName: "contactForm.name" })
				}), l("input", {
					id: t,
					...
					htmlFor: n,
					className: "mb-1 block text-sm font-medium text-foreground",
					children: l(Q, { keyName: "contactForm.email" })
				}), l("input", {
					id: n,
					type: "email",
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			u("div", { children: [l("label", {
				htmlFor: r,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: l(Q, { keyName: "contactForm.topic" })
			}), u("select", {
				id: r,
			...
			u("div", { children: [l("label", {
				htmlFor: i,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: l(Q, { keyName: "contactForm.message" })
			}), l("textarea", {
				id: i,
				rows: 5,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			l("button", {
				...
				children: l(Q, { keyName: "contactForm.sendMessage" })
			})
		]
	});
}
