...
var Ce = () => {
	...
	return t;
}, we = 0, z = 1, Te = 2, Ee = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === we ? r = "Empty parameter" : e === z ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function De(e) {
	return /\s/.test(e);
...
var Wt = { useSuspense: !1 }, Gt, Kt = () => (Gt ||= e.createContext(void 0), Gt), Q = void 0, qt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	...
	let { tolgee: r, options: a } = Jt(), s = D(e), c = O(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Yt(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
}, Pn = "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service.", Fn = {
	route: nn,
	header: rn,
	footer: an,
	common: on,
