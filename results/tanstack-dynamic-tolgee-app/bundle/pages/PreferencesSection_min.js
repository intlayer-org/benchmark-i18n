...
function ln() {
	...
	return u("section", {
		...
		children: [l("h2", {
			...
			children: l(Q, { keyName: "preferencesSection.preferences" })
		}), u("div", {
			className: "space-y-4",
			children: [
				u("div", {
					...
					children: [u("div", { children: [l("p", {
						...
						children: l(Q, { keyName: "preferencesSection.emailNotifications" })
					}), l("p", {
						className: "text-xs text-muted-foreground",
						children: l(Q, { keyName: "preferencesSection.receiveWeeklyBenchmark" })
					})] }), l("button", {
						type: "button",
				...
				u("div", {
					...
					children: [u("div", { children: [l("p", {
						className: "text-sm font-medium text-foreground",
						children: l(Q, { keyName: "preferencesSection.darkMode" })
					}), l("p", {
						className: "text-xs text-muted-foreground",
						children: l(Q, { keyName: "preferencesSection.useDarkColorScheme" })
					})] }), l("button", {
						type: "button",
				...
				u("div", { children: [l("label", {
					...
					children: l(Q, { keyName: "preferencesSection.defaultLanguage" })
				}), u("select", {
					id: t,
