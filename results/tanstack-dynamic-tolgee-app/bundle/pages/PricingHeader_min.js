...
var qt = { useSuspense: !1 }, Jt, Yt = () => (Jt ||= e.createContext(void 0), Jt), X = void 0, Xt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	...
	let { tolgee: r, options: a } = Zt(), s = D(e), c = O(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Qt(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
var sn = () => l("div", {
	...
	children: l(Q, { keyName: "mockBanner" })
});
function cn() {
	return u(c, { children: [l(sn, {}), u("div", {
		className: "mb-12 text-center",
		children: [l("h1", {
			className: "mb-3 text-3xl font-bold text-foreground",
			children: l(Q, { keyName: "pricingHeader.pricing" })
		}), l("p", {
			className: "text-muted-foreground",
			children: l(Q, { keyName: "pricingHeader.transparentPricingForEvery" })
		})]
	})] });
}
var ln = f({
