...
var Ke = { useSuspense: !1 }, qe, Je = () => (qe ||= t.createContext(void 0), qe), $ = void 0, Ye = ({ tolgee: e, options: r, children: i, fallback: o, ssr: s }) => {
	a(() => {
...
var Qe = () => {
	...
	let { tolgee: n, options: i } = Qe(), o = w(e), c = T(o).join(":"), l = Object.assign(Object.assign({}, i), t), { rerender: u, instance: d } = $e(), f = s([]);
	f.current = [];
	let p = n.isLoaded(o);
	a(() => {
		let e = n.on("update", u);
