...
function Se({ options: e }) {
	let t = ue(), n = L(!1, () => o.isFetching(), t.onFetchingChange.emit), r = L(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ye(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ve(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = me(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
function on() {
	return l("div", {
		...
		children: [c("button", {
			...
			children: c(an, { keyName: "common.cancel" })
		}), c("button", {
			type: "submit",
			className: "rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity",
			children: c(an, { keyName: "common.saveChanges" })
		})]
	});
}
var sn = d({
