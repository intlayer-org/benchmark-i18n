...
var Gt = { useSuspense: !1 }, Kt, qt = () => (Kt ||= e.createContext(void 0), Kt), Z = void 0, Jt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	let { tolgee: r, options: a } = Yt(), s = D(e), c = O(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Xt(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
}, Vn = "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service.", Hn = {
	route: un,
	header: dn,
	footer: fn,
	common: pn,
