...
function sn() {
	...
	return u("section", {
		...
		children: [l("h2", {
			...
			children: l(Q, { keyName: "apiAccessSection.apiAccess" })
		}), u("div", { children: [
			l("label", {
				htmlFor: e,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: l(Q, { keyName: "apiAccessSection.apiKey" })
			}),
			u("div", {
				...
				children: [l("input", {
					...
					children: l(Q, { keyName: "common.copy" })
				})]
			}),
			l("p", {
				className: "mt-1 text-xs text-muted-foreground",
				children: l(Q, { keyName: "apiAccessSection.useThisKeyTo" })
			})
		] })]
	});
}
