...
var $ = n(void 0);
function Ye({ children: e, formats: t, getMessageFallback: n, locale: r, messages: i, now: s, onError: c, timeZone: u }) {
...
function et() {
	let e = $e("footer"), t = c({ strict: !1 }).locale ?? "en", n = [
		{
			label: e("github"),
			...
			children: [u("div", {
				...
				children: [
					...
					u("div", { children: [l("h3", {
						...
						className: "space-y-1",
						children: n.map((e) => l("li", { children: e.isInternal ? l(s, {
							preload: !1,
							to: e.to,
							params: { locale: t },
