...
var Pe = class {
	...
	parseTag(e, t) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !z(this.char())) return this.error(w.INVALID_TAG, I(o, this.clonePosition()));
				let e = this.clonePosition();
...
function B(e) {
	e.forEach((e) => {
		if (delete e.location, Se(e) || A(e)) for (let t in e.options) delete e.options[t].location, B(e.options[t].value);
		else O(e) && M(e.style) || (k(e) || xe(e)) && N(e.style) ? delete e.style.location : j(e) && B(e.children);
	});
}
function Re(e, t = {}) {
	t = {
...
var Q = n(void 0);
function at({ children: e, formats: t, getMessageFallback: n, locale: r, messages: i, now: s, onError: c, timeZone: u }) {
	let d = a(Q), f = o(() => d?.cache || ae(), [r, d?.cache]), p = o(() => d?.formatters || se(f), [f, d?.formatters]), m = o(() => ({
		...it({
			locale: r,
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/use-intl-app/src/components/Footer.tsx";
function dt() {
	let e = ut("footer"), t = c({ strict: !1 }).locale ?? "en", n = [
		{
			label: e("github"),
			...
			children: [u("div", {
				...
				children: [
					...
					u("div", { children: [u("h3", {
						...
						className: "space-y-1",
						children: n.map((e) => u("li", { children: e.isInternal ? u(s, {
							preload: !1,
							to: e.to,
							params: { locale: t },
...
var mt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/use-intl-app/scripts/Wrapper.tsx", ht = pt("en");
...
var _t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/use-intl-app/src/components/Footer.wrapper.tsx";
function vt() {
	return u(gt, { children: u(dt, {}, void 0, !1, {
		fileName: _t,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
