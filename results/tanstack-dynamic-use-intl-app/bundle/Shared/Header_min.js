...
var Ie = class {
	...
	parseTag(e, t) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !V(this.char())) return this.error(D.INVALID_TAG, B(o, this.clonePosition()));
				let e = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					...
					err: null
				} : this.error(D.INVALID_TAG, B(o, this.clonePosition()))) : this.error(D.UNMATCHED_CLOSING_TAG, B(e, this.clonePosition()));
			}
		...
		switch (a) {
			...
			case "time": {
				...
				if (this.bumpIf(",")) {
					...
					if (n.err) return n;
					let r = Ne(n.val);
					if (r.length === 0) return this.error(D.EXPECT_ARGUMENT_STYLE, B(this.clonePosition(), this.clonePosition()));
					e = {
						style: r,
			...
			case "select": {
				...
				if (this.bumpSpace(), !this.bumpIf(",")) return this.error(D.EXPECT_SELECT_ARGUMENT_OPTIONS, B(i, { ...i }));
				this.bumpSpace();
	...
	parseSimpleArgStyleIfPossible() {
		...
		for (; !this.isEOF();) switch (this.char()) {
			case 39: {
				this.bump();
				let e = this.clonePosition();
				if (!this.bumpUntil("'")) return this.error(D.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, B(e, this.clonePosition()));
				this.bump();
				break;
			}
			case 123:
	...
	tryParsePluralOrSelectOptions(e, t, n, r) {
		...
		return a.length === 0 ? this.error(t === "select" ? D.EXPECT_SELECT_ARGUMENT_SELECTOR : D.EXPECT_PLURAL_ARGUMENT_SELECTOR, B(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !i ? this.error(D.MISSING_OTHER_CLAUSE, B(this.clonePosition(), this.clonePosition())) : {
			val: a,
			err: null
		};
	}
...
function H(e) {
	e.forEach((e) => {
		...
		else j(e) && L(e.style) || (M(e) || N(e)) && R(e.style) ? delete e.style.location : I(e) && H(e.children);
	});
}
function Be(e, t = {}) {
	t = {
...
function Qe(e) {
	...
	return function({ cache: e, formats: n, formatters: i, getMessageFallback: a = Xe, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, h, g) {
			...
			if (d) {
				...
				try {
					...
					if (!_) return f(p, C.MISSING_MESSAGE, e.message, _);
					v = _;
				}
			}
			try {
				return Ye(Y(c, p), v, m && function(e) {
					let n = {};
				...
				let t, n;
				return e instanceof S ? (t = e.code, n = e.originalMessage) : (t = C.FORMATTING_ERROR, n = e.message), f(p, t, n, _);
			}
		}
		function m(e, t, n, r) {
			let i = p(e, t, n, r);
...
function tt({ formats: e, getMessageFallback: t, messages: n, onError: r, ...i }) {
	return {
		...
		messages: n || void 0,
		onError: r || Ze,
		getMessageFallback: t || Xe
	};
}
var Z = n(void 0);
function nt({ children: e, formats: t, getMessageFallback: n, locale: r, messages: i, now: o, onError: s, timeZone: l }) {
	let u = a(Z), d = c((() => u?.cache || oe()), [r, u?.cache]), f = c((() => u?.formatters || ce(d)), [d, u?.formatters]), p = c((() => ({
		...tt({
			locale: r,
...
var rt = !1, it = typeof window > "u";
function at(e) {
	return function(e, t, n) {
		let { cache: r, formats: i, formatters: a, getMessageFallback: o, locale: s, onError: l, timeZone: u } = Q(), d = e[n], f = $e(t, n);
		return u || rt || !it || (rt = !0, l(new S(C.ENVIRONMENT_FALLBACK, void 0))), c((() => Qe({
			cache: r,
			formatters: a,
...
function st() {
	let e = at("theme-toggle"), [t, n] = l("auto");
	o(() => {
		let e = ot();
		n(e), $(e);
	}, []), o(() => {
