...
var d = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/use-intl-app/src/components/LocaleSwitcher.tsx";
function f() {
...
function N(e) {
	return M(e.namespace, e.key);
}
function P(e) {
	console.error(e);
}
var F = 86400;
F * 7, 365 / 12 * F * 3, F * 365;
function I(e, t, n) {
	Object.entries(e).forEach(([e, r]) => {
		...
		typeof r == "object" && r && I(r, t, M(n, e));
	});
}
function L(e, t) {
	let n = [];
	I(e, n), n.length > 0 && t(new T(E.INVALID_KEY, `Namespace keys cannot contain the character "." as this is used to express nesting. Please remove it or replace it with another character.
...
function R({ formats: e, getMessageFallback: t, messages: n, onError: r, ...i }) {
	let a = r || P, o = t || N;
	return n && L(n, a), {
		...i,
		formats: e || void 0,
...
var z = t(void 0);
function B({ children: e, formats: t, getMessageFallback: n, locale: a, messages: o, now: s, onError: l, timeZone: u }) {
	let d = r(z), f = i(() => d?.cache || D(), [a, d?.cache]), p = i(() => d?.formatters || j(f), [f, d?.formatters]), m = i(() => ({
		...R({
			locale: a,
...
var U = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/use-intl-app/scripts/Wrapper.tsx", W = H("en");
...
var K = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/use-intl-app/src/components/LocaleSwitcher.wrapper.tsx";
function q() {
	return s(G, { children: s(f, {}, void 0, !1, {
		fileName: K,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
