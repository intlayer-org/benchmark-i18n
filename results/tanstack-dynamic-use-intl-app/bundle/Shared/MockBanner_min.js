...
function c(e, t) {
	let n = t && t.cache ? t.cache : g, r = t && t.serializer ? t.serializer : te;
...
var ae = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function oe(e) {
	let t = {};
	return e.replace(ae, (e) => {
		let n = e.length;
		switch (e[0]) {
			case "G":
...
function ce(e) {
	...
	let t = e.split(se).filter((e) => e.length > 0), n = [];
	for (let e of t) {
		let t = e.split("/");
...
var x = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, S = /^(@+)?(\+|#+)?[rs]?$/g, ue = /(\*)(0+)|(#+)(0+)|(0+)/g, C = /^(0+)$/;
function w(e) {
	let t = {};
...
function me(e) {
	...
	for (let n of e) {
		switch (n.stem) {
			...
			case "measure-unit":
			case "unit":
				t.style = "unit", t.unit = le(n.options[0]);
				continue;
			case "compact-short":
			case "K":
				...
				if (e && e.style.startsWith("::")) {
					...
					}
					{
						...
						let o = {
							...
							parsedOptions: this.shouldParseSkeletons ? oe(r) : {}
						};
						return {
							val: {
...
function He(e) {
	...
	return function({ cache: e, formats: n, formatters: i, getMessageFallback: a = Be, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, ee, te) {
			...
			try {
				return ze(Z(c, p), g, m && function(e) {
					let n = {};
...
function Ke({ children: e, formats: t, getMessageFallback: n, locale: r, messages: i, now: c, onError: l, timeZone: u }) {
	let d = a($), f = o((() => d?.cache || ne()), [r, d?.cache]), p = o((() => d?.formatters || ie(f)), [f, d?.formatters]), m = o((() => ({
		...Ge({
			locale: r,
...
function Xe(e) {
	return function(e, t, n) {
		...
		return u || Je || !Ye || (Je = !0, l(new v(y.ENVIRONMENT_FALLBACK, void 0))), o((() => He({
			cache: r,
			formatters: a,
