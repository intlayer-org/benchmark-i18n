...
var Z = n(void 0);
function at({ children: e, formats: t, getMessageFallback: n, locale: r, messages: i, now: c, onError: l, timeZone: u }) {
	let d = a(Z), f = o(() => d?.cache || ie(), [r, d?.cache]), p = o(() => d?.formatters || oe(f), [f, d?.formatters]), m = o(() => ({
		...it({
			locale: r,
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/use-intl-app/src/components/pages/careers/OpenPositions.tsx";
function ut() {
	let e = lt("open-positions"), t = [
		{
...
var gt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/use-intl-app/src/components/pages/careers/OpenPositions.wrapper.tsx";
function _t() {
