...
var de = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, S = /^(@+)?(\+|#+)?[rs]?$/g, fe = /(\*)(0+)|(#+)(0+)|(0+)/g, C = /^(0+)$/;
function w(e) {
	let t = {};
...
var Ce = RegExp(`^${F.source}*`), we = RegExp(`${F.source}*$`);
function L(e, t) {
	return {
		start: e,
		end: t
...
var Te = !!Object.fromEntries, Ee = !!String.prototype.trimStart, De = !!String.prototype.trimEnd, R = Te ? Object.fromEntries : function(e) {
	let t = {};
	...
	return e.replace(we, "");
}, z = /* @__PURE__ */ RegExp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
function Ae(e, t) {
	return z.lastIndex = t, z.exec(e)[1] ?? "";
}
var je = class {
	constructor(e, t = {}) {
	...
	parseTag(e, t) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !B(this.char())) return this.error(D.INVALID_TAG, L(o, this.clonePosition()));
				let e = this.clonePosition();
...
function V(e) {
	e.forEach((e) => {
		if (delete e.location, A(e) || j(e)) for (let t in e.options) delete e.options[t].location, V(e.options[t].value);
		else _e(e) && N(e.style) || (ve(e) || ye(e)) && P(e.style) ? delete e.style.location : M(e) && V(e.children);
	});
}
function Fe(e, t = {}) {
	t = {
...
function J(...[e, t, n, i]) {
	...
	s.getMessageFormat ||= Ge(a, s);
	let d;
	try {
		d = s.getMessageFormat(t, l, We(c, o, u), { formatters: {
			...s,
...
function Ze(e) {
	let t = Xe(e.locale, e.messages, e.namespace);
	return Qe({
		...e,
		messagesOrError: t
	});
}
function Qe({ cache: e, formats: t, formatters: n, getMessageFallback: r = qe, locale: i, messagesOrError: a, namespace: o, onError: s, timeZone: c }) {
...
function et(e, t, n) {
	Object.entries(e).forEach(([e, r]) => {
		...
		typeof r == "object" && r && et(r, t, Y(n, e));
	});
}
function tt(e, t) {
	let n = [];
	et(e, n), n.length > 0 && t(new v(y.INVALID_KEY, `Namespace keys cannot contain the character "." as this is used to express nesting. Please remove it or replace it with another character.
...
function nt({ formats: e, getMessageFallback: t, messages: n, onError: r, ...i }) {
	let a = r || Je, o = t || qe;
	return n && tt(n, a), {
		...i,
		formats: e || void 0,
...
function rt({ children: e, formats: t, getMessageFallback: n, locale: r, messages: i, now: c, onError: l, timeZone: u }) {
	let d = a(Q), f = o(() => d?.cache || re(), [r, d?.cache]), p = o(() => d?.formatters || ae(f), [f, d?.formatters]), m = o(() => ({
		...nt({
			locale: r,
...
function st(e, t, n) {
	...
	return !u && !at && ot && (at = !0, l(new v(y.ENVIRONMENT_FALLBACK, "There is no `timeZone` configured, this can lead to markup mismatches caused by environment differences. Consider adding a global default: https://next-intl.dev/docs/configuration#time-zone"))), o(() => Ze({
		cache: r,
		formatters: a,
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/use-intl-app/src/components/pages/home/ResultsTable.tsx";
function lt() {
	let e = ct("results-table");
	return c("section", { children: [c("h2", {
...
var ft = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/use-intl-app/scripts/Wrapper.tsx", pt = dt("en");
...
var ht = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/use-intl-app/src/components/pages/home/ResultsTable.wrapper.tsx";
function gt() {
	return c(mt, { children: c(lt, {}, void 0, !1, {
		fileName: ht,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
