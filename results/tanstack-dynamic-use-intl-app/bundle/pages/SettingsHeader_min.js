...
var Fe = class {
	...
	parseTag(e, t) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !L(this.char())) return this.error(S.INVALID_TAG, I(o, this.clonePosition()));
				let e = this.clonePosition();
...
function R(e) {
	e.forEach((e) => {
		if (delete e.location, k(e) || A(e)) for (let t in e.options) delete e.options[t].location, R(e.options[t].value);
		else E(e) && M(e.style) || (D(e) || O(e)) && N(e.style) ? delete e.style.location : j(e) && R(e.children);
	});
}
function ze(e, t = {}) {
	t = {
...
function it(e, t, n) {
	Object.entries(e).forEach(([e, r]) => {
		...
		typeof r == "object" && r && it(r, t, K(n, e));
	});
}
function at(e, t) {
	let n = [];
...
var Y = n(void 0);
function st({ children: e, formats: t, getMessageFallback: n, locale: r, messages: i, now: c, onError: l, timeZone: u }) {
	let d = a(Y), f = o(() => d?.cache || ie(), [r, d?.cache]), p = o(() => d?.formatters || oe(f), [f, d?.formatters]), m = o(() => ({
		...ot({
			locale: r,
...
function ut(e, t, n) {
	let { cache: r, formats: i, formatters: a, getMessageFallback: s, locale: c, onError: l, timeZone: u } = X(), d = e[n], f = rt(t, n);
	return !u && !ct && lt && (ct = !0, l(new v(y.ENVIRONMENT_FALLBACK, "There is no `timeZone` configured, this can lead to markup mismatches caused by environment differences. Consider adding a global default: https://next-intl.dev/docs/configuration#time-zone"))), o(() => tt({
		cache: r,
		formatters: a,
...
}, Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/use-intl-app/src/components/pages/settings/SettingsHeader.tsx";
function pt() {
	let e = Z("header"), t = Z("settings-header");
	return l(c, { children: [
		l(ft, {}, void 0, !1, {
			fileName: Q,
			lineNumber: 9,
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/use-intl-app/src/components/pages/settings/SettingsHeader.wrapper.tsx";
function yt() {
