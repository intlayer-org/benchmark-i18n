...
var Te = RegExp(`^${N.source}*`), Ee = RegExp(`${N.source}*$`);
function F(e, t) {
	return {
		start: e,
		end: t
...
var De = !!Object.fromEntries, Oe = !!String.prototype.trimStart, ke = !!String.prototype.trimEnd, I = De ? Object.fromEntries : function(e) {
	let t = {};
...
function tt(e, t, n) {
	Object.entries(e).forEach(([e, r]) => {
		...
		typeof r == "object" && r && tt(r, t, J(n, e));
	});
}
function nt(e, t) {
	let n = [];
...
var Z = n(void 0);
function it({ children: e, formats: t, getMessageFallback: n, locale: r, messages: i, now: c, onError: l, timeZone: u }) {
	let d = a(Z), f = o(() => d?.cache || re(), [r, d?.cache]), p = o(() => d?.formatters || oe(f), [f, d?.formatters]), m = o(() => ({
		...rt({
			locale: r,
...
function ct(e, t, n) {
	let { cache: r, formats: i, formatters: a, getMessageFallback: s, locale: c, onError: l, timeZone: u } = at(), d = e[n], f = et(t, n);
	return !u && !ot && st && (ot = !0, l(new v(y.ENVIRONMENT_FALLBACK, "There is no `timeZone` configured, this can lead to markup mismatches caused by environment differences. Consider adding a global default: https://next-intl.dev/docs/configuration#time-zone"))), o(() => Qe({
		cache: r,
		formatters: a,
...
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/use-intl-app/src/components/pages/settings/SettingsFooter.tsx";
function ut() {
	let e = lt("settings-footer");
	return c("div", {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-dynamic/use-intl-app/src/components/pages/settings/SettingsFooter.wrapper.tsx";
function gt() {
	return c(ht, { children: c(ut, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
