...
function f(e = { c: [] }, t = "") {
	let n = (t) => {
		let n = e.c[t];
		return typeof n == "string" ? [n] : Array.isArray(n) ? n : [u(t, e.c)];
	}, r = (e, t = []) => d(n(e), t, 0);
	return r._ = e, r.l = t, r.c = n, r.x = d, r.t = (e, t, r) => {
		let i = [""], a = [];
		for (let e of n(t)) {
			if (typeof e == "string") {
				i[i.length - 1] += e;
	...
	}, r.p = (t, n) => e.c[t]?.map((e) => typeof e == "string" ? e : d(e, n, 0)) ?? [], r;
}
function p(e) {
	return {
		get: (t) => e[t],
...
function g(e, t, n, r) {
	...
	for (let t = 0; t < n; t++) m[e].collection.set(t, h);
	return (t = 0) => m[e].collection.get(t);
}
function _(e) {
	for (let t of Object.values(m)) for (let [n, r] of t.catalogs.entries()) t.collection.set(n, f(r, e));
}
async function v(e, t = !0) {
	let n = [], r = [];
	for (let t of Object.values(m)) for (let i = 0; i < t.catalogs.length; i++) n.push(t.load(i, e)), r.push([i, t]);
...
var y = {
	en: [() => import("./main.0.en.compiled-CE-GbGFd.js")],
	es: [() => import("./main.0.es.compiled-DtqMT_L0.js")],
	fr: [() => import("./main.0.fr.compiled-D_eZv652.js")],
	de: [() => import("./main.0.de.compiled-DfDLnF4N.js")],
	it: [() => import("./main.0.it.compiled-bdwlpVuH.js")],
	pt: [() => import("./main.0.pt.compiled-Cu3xbrx5.js")],
	zh: [() => import("./main.0.zh.compiled-Bi5WRSLQ.js")],
	ja: [() => import("./main.0.ja.compiled-nlgTIdMX.js")],
	ko: [() => import("./main.0.ko.compiled-Dmtfti4i.js")],
	ru: [() => import("./main.0.ru.compiled-D2HVor-4.js")]
}, b = (e, t) => y[t][e](), x = "main", S = [], C = [], w = (e = 0) => C[e];
g(x, b, 1, {
	get: w,
	set: (e, t) => {
		C[e] = t, S[e]?.forEach((e) => {
...
var T = (t = 0) => {
	...
	return e(() => {
		let e = (e) => i(() => e);
		return S[t] ??= /* @__PURE__ */ new Set(), S[t].add(e), () => S[t].delete(e);
	}, [t]), r;
};
function E({ n: e, x: t, t: n, a: r }, i) {
	if (typeof t == "string") return t;
	if (typeof t == "number") return !e || i > 0 ? r[t] : void 0;
	let a = n[t[0]];
	return a == null ? "i18n-404:tag" : a(t);
}
var D = (e) => e.x.map((t, n) => E({
	...e,
	x: t
}, n));
function O() {
...
function A() {
	...
	function i() {
		...
		r(e), k(e), window.localStorage.setItem("theme", e);
	}
	let a = T(), o = t === "auto" ? a(21) : a(22, [t]);
	return c("button", {
		type: "button",
		onClick: i,
		"aria-label": o,
