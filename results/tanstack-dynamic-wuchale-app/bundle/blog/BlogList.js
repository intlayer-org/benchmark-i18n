...
var catalogs = {
	en: [() => import("./main.0.en.compiled-DiOwoiqW.js")],
	es: [() => import("./main.0.es.compiled-DMSxkSc9.js")],
	fr: [() => import("./main.0.fr.compiled-DUn3KOtZ.js")],
	de: [() => import("./main.0.de.compiled-hJIQZtyh.js")],
	it: [() => import("./main.0.it.compiled-BZpolhkh.js")],
	pt: [() => import("./main.0.pt.compiled-D4iOKcVo.js")],
	zh: [() => import("./main.0.zh.compiled-CHmkPgUb.js")],
	ja: [() => import("./main.0.ja.compiled-uTW2WmFK.js")],
	ko: [() => import("./main.0.ko.compiled-DTwk5a-O.js")],
	ru: [() => import("./main.0.ru.compiled-DxDjrfHH.js")]
};
...
var callbacks = [];
var store = [];
var getRuntime = (loadID = 0) => store[loadID];
registerLoaders(key, loadCatalog, 1, {
	get: getRuntime,
	set: (loadID, runtime) => {
...
function BlogList() {
	...
	const posts = [
		{
			title: _w_runtime_(187),
			date: _w_runtime_(188),
			excerpt: _w_runtime_(189),
			category: _w_runtime_(190)
		},
		{
			title: _w_runtime_(191),
			date: _w_runtime_(192),
			excerpt: _w_runtime_(193),
			category: _w_runtime_(194)
		},
		{
			title: _w_runtime_(195),
			date: _w_runtime_(196),
			excerpt: _w_runtime_(197),
			category: _w_runtime_(198)
		},
		{
			title: _w_runtime_(199),
			date: _w_runtime_(200),
			excerpt: _w_runtime_(201),
			category: _w_runtime_(194)
		},
		{
			title: _w_runtime_(202),
			date: _w_runtime_(203),
			excerpt: _w_runtime_(204),
			category: _w_runtime_(198)
		},
		{
			title: _w_runtime_(205),
			date: _w_runtime_(206),
			excerpt: _w_runtime_(207),
			category: _w_runtime_(208)
		}
	];
	return jsx("div", {
