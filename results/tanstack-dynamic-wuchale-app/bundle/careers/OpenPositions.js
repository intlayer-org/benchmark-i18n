...
function OpenPositions() {
	...
	const openings = [
		{
			title: _w_runtime_(223),
			location: _w_runtime_(224),
			type: _w_runtime_(225),
			dept: _w_runtime_(226),
			desc: _w_runtime_(227)
		},
		{
			title: _w_runtime_(228),
			location: _w_runtime_(224),
			type: _w_runtime_(225),
			dept: _w_runtime_(226),
			desc: _w_runtime_(229)
		},
		{
			title: _w_runtime_(230),
			location: _w_runtime_(224),
			type: _w_runtime_(231),
			dept: _w_runtime_(232),
			desc: _w_runtime_(233)
		},
		{
			title: _w_runtime_(234),
			location: _w_runtime_(235),
			type: _w_runtime_(225),
			dept: _w_runtime_(236),
			desc: _w_runtime_(237)
		},
		{
			title: _w_runtime_(238),
			location: _w_runtime_(224),
			type: _w_runtime_(225),
			dept: _w_runtime_(226),
			desc: _w_runtime_(239)
		}
	];
