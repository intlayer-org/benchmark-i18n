		...
		children: [
			jsxs("div", {
				...
				children: [jsxs("div", { children: [jsx("label", {
					...
					children: _w_runtime_(71)
				}), jsx("input", {
					id: nameId,
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
					placeholder: _w_runtime_(72)
			...
			jsxs("div", { children: [jsx("label", {
				...
				children: [
					jsx("option", { children: _w_runtime_(75) }),
					jsx("option", { children: _w_runtime_(76) }),
					jsx("option", { children: _w_runtime_(77) }),
					jsx("option", { children: _w_runtime_(78) }),
					jsx("option", { children: _w_runtime_(79) })
				]
			})] }),
			jsxs("div", { children: [jsx("label", {
				htmlFor: messageId,
				...
				rows: 5,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: _w_runtime_(81)
			})] }),
			jsx("button", {
				type: "submit",
				className: "rounded-md bg-primary px-6 py-2.5 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity",
				children: _w_runtime_(82)
			})
		]
	});
}
