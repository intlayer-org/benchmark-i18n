...
function c(e = { c: [] }, t = "") {
	let n = (t) => {
		let n = e.c[t];
		return typeof n == "string" ? [n] : Array.isArray(n) ? n : [o(t, e.c)];
	}, r = (e, t = []) => s(n(e), t, 0);
	return r._ = e, r.l = t, r.c = n, r.x = s, r.t = (e, t, r) => {
		let i = [""], a = [];
		for (let e of n(t)) {
			if (typeof e == "string") {
				i[i.length - 1] += e;
	...
	}, r.p = (t, n) => e.c[t]?.map((e) => typeof e == "string" ? e : s(e, n, 0)) ?? [], r;
}
function l(e) {
	return {
		get: (t) => e[t],
...
function f(e, t, n, r) {
	...
	for (let t = 0; t < n; t++) u[e].collection.set(t, d);
	return (t = 0) => u[e].collection.get(t);
}
function p(e) {
	for (let t of Object.values(u)) for (let [n, r] of t.catalogs.entries()) t.collection.set(n, c(r, e));
}
async function m(e, t = !0) {
	let n = [], r = [];
	for (let t of Object.values(u)) for (let i = 0; i < t.catalogs.length; i++) n.push(t.load(i, e)), r.push([i, t]);
...
}, g = (e, t) => h[t][e](), _ = "main", v = [], y = [], b = (e = 0) => y[e];
f(_, g, 1, {
	get: b,
	set: (e, t) => {
		y[e] = t, v[e]?.forEach((e) => {
...
var x = (t = 0) => {
	...
	return e(() => {
		let e = (e) => i(() => e);
		return v[t] ??= /* @__PURE__ */ new Set(), v[t].add(e), () => v[t].delete(e);
	}, [t]), r;
};
function S() {
	let e = t(), n = t(), r = x();
