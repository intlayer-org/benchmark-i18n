	...
	const products = [
		{
			...
			desc: _w_runtime_(210),
			price: _w_runtime_(211)
		},
		{
			name: _w_runtime_(212),
			desc: _w_runtime_(213),
			price: "$29/mo"
		},
		{
			name: _w_runtime_(214),
			desc: _w_runtime_(215),
			price: _w_runtime_(216)
		},
		{
			name: _w_runtime_(217),
			desc: _w_runtime_(218),
			price: "$99 one-time"
		},
		{
			name: _w_runtime_(219),
			desc: _w_runtime_(220),
			price: "$19/mo"
		},
		{
			name: _w_runtime_(221),
			desc: _w_runtime_(222),
			price: "$49/mo"
		}
	];
	return jsx("div", {
