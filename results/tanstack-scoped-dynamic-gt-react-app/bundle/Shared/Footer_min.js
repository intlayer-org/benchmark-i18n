...
import { Link as g, useParams as _ } from "@tanstack/react-router";
import { jsx as v } from "react/jsx-runtime";
import { jsxDEV as y } from "react/jsx-dev-runtime";
...
var ee = Object.defineProperty, te = Object.getOwnPropertyDescriptor, w = Object.getOwnPropertyNames, T = Object.prototype.hasOwnProperty, ne = (e, t, n) => () => {
	if (n) throw n[0];
	try {
		return e && (t = e(e = 0)), t;
	} catch (e) {
...
}, re = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), ie = (e, t) => {
	let n = {};
	...
	if (t && typeof t == "object" || typeof t == "function") for (var i = w(t), a = 0, o = i.length, s; a < o; a++) s = i[a], !T.call(e, s) && s !== n && ee(e, s, {
		get: ((e) => t[e]).bind(null, s),
		enumerable: !(r = te(t, s)) || r.enumerable
	});
	return e;
}, oe = (e) => T.call(e, "module.exports") ? e["module.exports"] : ae(ee({}, "__esModule", { value: !0 }), e), se = class extends Error {
	constructor(e, t, n) {
...
function me(e) {
	...
	if (e.response) {
		...
		throw new se(t, e.response.status, t);
	}
	throw e.error;
}
...
function Lt(e, t, n) {
	...
	for (let r of e) switch (r.type) {
		case D.literal:
			...
			break;
		case D.pound:
			n !== void 0 && i(Bt(t).format(n));
			break;
		case D.argument: {
			let e = Rt(t.variables, r.value);
			i(typeof e == "string" || typeof e == "number" ? String(e) : e || "");
			break;
		}
		case D.number: {
			let e = Rt(t.variables, r.value), { scale: n, ...a } = typeof r.style == "string" ? Mt[r.style] ?? {} : r.style?.type === tt.number ? r.style.parsedOptions : {}, o = zt(e, n);
			i(Bt(t, a).format(o));
			break;
		}
		case D.date:
		case D.time: {
			let e = Rt(t.variables, r.value), n = r.type === D.date ? Nt : Ft;
			i(Vt(t, typeof r.style == "string" ? n[r.style] : r.style?.type === tt.dateTime ? r.style.parsedOptions : r.type === D.time ? Ft.medium : void 0).format(e));
			break;
		}
		case D.select: {
			let e = String(Rt(t.variables, r.value)), n = Kt(r.options, e) ?? r.options.other;
			if (!n) throw qt(r.value, e, r.options);
			Lt(n.value, t).forEach(i);
			break;
		}
		case D.plural: {
			let e = Rt(t.variables, r.value), n = `=${String(e)}`, a = Kt(r.options, n), o = typeof e == "bigint" ? e : Number(e), s = typeof o == "bigint" ? o - BigInt(r.offset) : o - r.offset;
			if (!a && Gt(r.options)) {
				let e = Ht(t, r.pluralType ?? "cardinal").select(Wt(s));
				a = Kt(r.options, e);
			}
...
function Bt(e, t = {}) {
	return Ut(e.numberFormats ??= /* @__PURE__ */ new Map(), JSON.stringify(t), () => new Intl.NumberFormat(e.locales, t));
}
function Vt(e, t) {
	return Ut(e.dateTimeFormats ??= /* @__PURE__ */ new Map(), t ? JSON.stringify(t) : "", () => new Intl.DateTimeFormat(e.locales, t));
}
function Ht(e, t) {
	...
	return Ut(e.pluralRules ??= /* @__PURE__ */ new Map(), t, () => new Intl.PluralRules(e.locales, { type: t }));
}
function Ut(e, t, n) {
	let r = e.get(t);
	if (r) return r;
...
var Zt = RegExp(`^${Xt}$`);
function Qt(e) {
	return e.type === D.select && Zt.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === D.literal);
}
function $t(e) {
	let t = e;
...
function fn(e) {
	...
	for (let n = 0; n < t.length; n++) {
		...
		r.push(e.slice(i, a)), r.push(e.slice(a, a + Xt.length + 1)), r.push(String(n + 1)), r.push(e.slice(a + Xt.length + 1, s)), r.push("{}"), r.push(e.slice(c, o)), i = o;
	}
...
function _n({ value: e, locales: t = ["en"], currency: n = "USD", options: r = {} }) {
	return O.get("NumberFormat", t, {
		style: "currency",
		currency: n,
		numberingSystem: "latn",
...
function xn({ value: e, unit: t, locales: n = ["en"], options: r = {} }) {
...
var Tn = (e, t, n) => {
	...
	let n = e?.[t];
	return wn(n) && typeof n.code == "string" ? n.code : void 0;
}, Dn = /* @__PURE__ */ new Set([
	"Cham",
	"Jamo",
	"Kawi",
	...
	"Toto",
	"Thai"
]), On = (e) => e >= "qaa" && e <= "qtz", kn = (e, t) => {
	e = En(t, e) || e;
	try {
		let { language: t, region: n, script: r } = O.get("Locale", e), i = 1 + Number(!!n) + Number(!!r);
		return !(e.split("-").length !== i || O.get("DisplayNames", ["en"], { type: "language" }).of(t) === t && !On(t) || n && O.get("DisplayNames", ["en"], { type: "region" }).of(n) === n || r && O.get("DisplayNames", ["en"], { type: "script" }).of(r) === r && !Dn.has(r));
	} catch {
		return !1;
	}
}, An = (e) => {
...
function jn(e, t) {
	...
	for (let a of e) {
		...
		r.add(e);
		let o = i.get(e);
		o === void 0 && (o = /* @__PURE__ */ new Set(), i.set(e, o)), o.add(An(a));
	}
	return {
		allValid: n,
		languages: r,
...
function Mn(...e) {
	try {
		let t = e.flat().map((e) => O.get("Locale", An(e))), [n] = t, r = new Set(t.map(({ region: e }) => e).filter(Boolean)), i = new Set(t.map(({ script: e }) => e).filter(Boolean));
...
function Nn(e, t, n, r) {
	if (n && !n.allValid || !kn(e, r) || !kn(t, r) || Mn(e, t)) return !1;
	if (!n) return !0;
	let i = Sn(t);
...
function Bn(e, t) {
	...
	e = zn(e, t);
	try {
		let r = An(e), i = O.get("Locale", r), { language: a, region: o } = i;
		if (t) for (let i of [
			n,
			e,
			r,
...
function Zn(e, t = "en", n) {
	...
	e = zn(e, n), t ||= "en";
	try {
		let i = An(e), a = O.get("Locale", e), o = a.language, s = Xn([
			r,
			e,
			i,
			o
		...
		let t = kn(e) ? An(e) : e, r = t.split("-"), i = r[0] || t, a = r.length > 2 ? r[2] : r[1] || "", o = r[3] || "", s = Xn([t, i], n);
		t = s?.code || t;
...
function rr(e, t) {
	try {
		let { language: n, region: r, script: i } = O.get("Locale", An(e)), { language: a, region: o, script: s } = O.get("Locale", An(t));
...
function ir(e, t) {
	return t ? Object.keys(t).find((n) => En(t, n) === e) ?? e : e;
}
var ar = class {
	getResolutionScope() {
	...
	isResolutionScopeCurrent(e) {
		...
		for (let t = 0; t < this.locales.length; t++) {
			...
			if (r.locale !== n || r.canonicalLocale !== this.resolveCanonicalLocale(n) || e.canonicalMappingCodes[t] !== En(this.customMapping, r.canonicalLocale)) return !1;
		}
		return !0;
	}
	buildResolutionScope(e) {
		...
		return {
			...
			canonicalMappingCodes: t.map(({ canonicalLocale: e }) => En(this.customMapping, e)),
	...
	formatRelativeTimeFromDate(e, t, n = {}) {
		let { locales: r, baseDate: i, ...a } = n, { value: o, unit: s } = bn(e, i ?? /* @__PURE__ */ new Date());
		return xn({
			value: o,
			unit: s,
			locales: this.getFormattingLocales(t, r),
	...
	formatMessage(e, t, n = {}) {
		...
		return a === "STRING" ? e : mn(e, this.getFormattingLocales(t, r), i);
	}
	formatList(e, t, n = {}) {
		let { locales: r, ...i } = n;
		return vn({
	...
	isSameLanguage(...e) {
		return Cn(...e.map((e) => Array.isArray(e) ? e.map((e) => this.resolveCanonicalLocale(e)) : this.resolveCanonicalLocale(e)));
	}
...
var Or = class {
	...
	3204031479,
	3329325298
]), jr = /* @__PURE__ */ new Uint32Array(64), Mr = class extends Or {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) jr[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = jr[e - 15], n = jr[e - 2], r = yr(t, 7) ^ yr(t, 18) ^ t >>> 3, i = yr(n, 17) ^ yr(n, 19) ^ n >>> 10;
			jr[e] = i + jr[e - 7] + r + jr[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = yr(o, 6) ^ yr(o, 11) ^ yr(o, 25), u = l + t + Er(o, s, c) + Ar[e] + jr[e] | 0, d = (yr(n, 2) ^ yr(n, 13) ^ yr(n, 22)) + Dr(n, r, i) | 0;
...
async function oi(e) {
	if (!e.ok) {
		...
		throw new se(Ur(e.status, e.statusText, t), e.status, t);
	}
}
async function si(e, t, n, r) {
	...
	if (l.data === void 0 && l.response && !pe(l)) throw await oi(l.response), l.error;
	let u = me(l);
...
var ci = class {
	...
	setConfig({ apiKey: e, devApiKey: t, sourceLocale: n, targetLocale: r, locales: i, projectId: a, customMapping: o, baseUrl: s }) {
		if (e && (this.apiKey = e), t && (this.devApiKey = t), a && (this.projectId = a), n && (this.sourceLocale = lr(n), !sr(this.sourceLocale, o))) throw Error(Jr(this.sourceLocale));
		if (r && (this.targetLocale = lr(r), !sr(this.targetLocale, o))) throw Error(Jr(this.targetLocale));
		if (i) {
			let e = [], t = [];
			if (i.forEach((n) => {
				let r = lr(n);
				sr(r) ? e.push(r) : t.push(n);
	...
	requiresTranslation(e = this.sourceLocale, t = this.targetLocale, n = this.locales, r = this.customMapping) {
		...
		if (!t) throw Error(Wr("requiresTranslation"));
...
function gi({ namespace: e, key: t, source: n, notInitialized: r }) {
	function i() {
		let n = mi(e)[t];
		if (n == null) {
			let e = r();
...
function _i() {
	...
	return vi(e) ? e.isDebugLoggingEnabled() : di(ui());
}
function vi(e) {
...
function xi() {
	...
	let e = Si(() => "production");
	return e ? e === "development" ? "development" : "production" : Si(() => !0) === !0 ? "development" : "production";
}
function Si(e) {
	try {
		return e();
...
function Ti({ defaultLocale: e, locales: t, customMapping: n }) {
	...
	return Array.from(r).filter((e) => !sr(e, n));
}
...
var Oi = class extends ar {
	...
	getLocaleConfig(e) {
		return !e || !ji(e) ? this : new ar(Ai(e));
	}
...
var { getConditionStore: Fi, setConditionStore: Ii } = Pi(E({
	source: "gt-i18n",
	severity: "Error",
...
var zi = [];
function Bi({ locale: e, enableI18n: t, localesProp: n = zi }) {
...
var Vi = "server-render", Hi = Symbol.for("generaltranslation.react-core.ReactI18nConfig"), Ui = class extends Oi {
	renderStrategy;
	localeCookieName;
	regionCookieName;
	enableI18nCookieName;
	constructor(e = {}, t = Vi) {
		super(e), Gi(t), Object.defineProperty(this, Hi, { value: !0 }), this.renderStrategy = t, this.localeCookieName = e.localeCookieName ?? "generaltranslation.locale", this.regionCookieName = e.regionCookieName ?? "generaltranslation.region", this.enableI18nCookieName = e.enableI18nCookieName ?? "generaltranslation.enable-i18n";
	}
	getRenderStrategy() {
...
function Ki(e) {
	...
	let t = e;
	return t[Hi] === !0 && typeof t.getRenderStrategy == "function" && typeof t.getLocaleCookieName == "function" && typeof t.getRegionCookieName == "function" && typeof t.getEnableI18nCookieName == "function";
}
var { getConditionStore: qi, setConditionStore: Ji, isConditionStoreInitialized: Yi } = Pi(E({
	source: "@generaltranslation/react-core",
	severity: "Error",
...
function Xi({ Currency: e, GtInternalCurrency: t, DateTime: n, GtInternalDateTime: r, Num: i, GtInternalNum: a, RelativeTime: o, GtInternalRelativeTime: s, Var: c, GtInternalVar: l }) {
...
function Qi(e = {}, t) {
	return typeof e.name == "string" ? e.name : `_gt_${Zi[t] || "value"}_${e["data-_gt"]?.id}`;
}
function $i(e) {
...
function ra({ renderVariable: e }) {
	return function({ children: n, defaultLocale: r = "en", enableI18n: i }) {
		let a = (n) => {
			let a = ta(n);
			if ($i(n.props)) {
				let { variableType: t, variableValue: a, variableOptions: o, injectionType: s } = ea(n.props);
				return e({
					variableType: t,
					variableValue: a,
					variableOptions: o,
...
function ia({ renderVariable: e }) {
	let n = ra({ renderVariable: e });
	function r({ sourceElement: e, targetElement: r, locales: a = ["en"], enableI18n: o }) {
		...
		if (u && Object.entries(pn).forEach(([e, t]) => {
			u[e] && (d[t] = u[e]);
		}), l === "plural") {
			let t = e.props.n;
			return typeof t == "number" ? i({
				source: na(t, a, c.branches || {}) ?? e.props.children,
				target: na(t, a, r.d?.b || {}) ?? r.c,
				locales: a,
				enableI18n: o
			}) : n({
				children: e,
	...
	function i({ source: i, target: a, locales: o = ["en"], enableI18n: s }) {
		...
		if (Array.isArray(a) && !Array.isArray(i) && i && (i = [i]), Array.isArray(i) && Array.isArray(a)) {
			let n = {}, c = {}, l = {}, u = i.filter((e) => {
				if (t.isValidElement(e)) {
					if ($i(e.props)) {
						let { variableName: t, variableValue: r, variableOptions: i, injectionType: a } = ea(e.props);
						n[t] = r, c[t] = i, l[t] = a;
					} else return !0;
				}
				return !1;
			...
			return a.map((i, a) => {
				if (typeof i == "string") return v(t.Fragment, { children: i }, `string_${a}`);
				if ($t(i)) return v(t.Fragment, { children: e({
					variableType: i.v || "v",
					variableValue: n[i.k],
				...
				let u = d(i);
				return u ? v(t.Fragment, { children: r({
					sourceElement: u,
					targetElement: i,
					locales: o,
					enableI18n: s
		...
		if (a && typeof a == "object" && !Array.isArray(a)) {
			...
			if (t.isValidElement(i)) {
				...
				if ($i(i.props)) {
					let { variableValue: t, variableOptions: n, variableType: r, injectionType: a } = ea(i.props);
					return e({
						variableType: r,
						variableValue: t,
						variableOptions: n,
...
var sa = { display: "contents" }, ca = globalThis.navigator?.product === "ReactNative";
function la(e) {
...
function ua(e, t) {
	return ca || !aa() ? e : c(e) && typeof e.type == "string" ? a(e, { "data-_gt-hash": t }) : la(e) ? e : s("span", {
		"data-_gt-hash": t,
		style: sa
	}, e);
}
function da({ renderDefaultChildren: e, renderTranslatedChildren: t }) {
...
function fa(e) {
	let t = Xi(e), n = ra({ renderVariable: t }), r = ia({ renderVariable: t });
	return {
		renderVariable: t,
...
function ha() {
	let e = E({
		...
		fix: Wi().getRenderStrategy() === "SPA" ? "Initialize GT before reading GT runtime context." : "Add a <GTProvider> at the root of your component tree."
	});
	return Error(e);
}
var ga = gi({
...
function _a() {
	return ga.isInitialized() || ga.set(o(void 0)), ga.get();
}
function va() {
	let e = u(_a());
	if (e || Wi().getRenderStrategy() === "SPA") return e;
	throw Error(ya());
}
function ya() {
	return E({
...
function ba() {
	return va()?.conditionStore ?? qi();
}
function xa() {
	return ba().getLocale();
}
function Sa() {
	return ba().getEnableI18n();
}
function Ca() {
...
function Ta() {
	return va()?.i18nStore || ma();
}
function Ea() {
	return va()?.translationsSnapshot || {};
}
function Da() {
	return Oa(wa());
}
function Oa(e) {
	let t = va()?.onMissingTranslation, n = Aa(e);
	return l((e) => {
		t ? t(e) : n(Ri(e), {
			type: "translation",
			lookup: e
...
var ka = Da;
function Aa(e) {
	let t = k().isDevHotReloadEnabled(), n = Ta(), r = /* @__PURE__ */ new Map();
	return d(() => {
...
function ja({ _enableI18n: e, _locale: t, children: n, currency: r = "USD", options: i = {}, locales: a = [] }) {
	let o = Bi({
		locale: t,
		enableI18n: e,
		localesProp: a
...
Ma._gtt = "variable-currency-automatic", Na._gtt = "variable-currency";
...
Fa._gtt = "variable-datetime-automatic", Ia._gtt = "variable-datetime";
function La({ _enableI18n: e, _locale: t, children: n, options: r = {}, locales: i = [] }) {
	let a = Bi({
		locale: t,
		enableI18n: e,
		localesProp: i
...
Ra._gtt = "variable-number-automatic", za._gtt = "variable-number";
function Ba({ _enableI18n: e, _locale: t, date: n, children: r, value: i, unit: a, baseDate: o, locales: s = [], options: c = {} }) {
	let l = Bi({
		locale: t,
		enableI18n: e,
		localesProp: s
...
Va._gtt = "variable-relative-time-automatic", Ha._gtt = "variable-relative-time";
function Ua({ children: e }) {
	return e;
}
function Wa({ children: e }) {
	return Ua({ children: e });
}
function Ga({ children: e }) {
	return Ua({ children: e });
}
Wa._gtt = "variable-variable", Ga._gtt = "variable-variable-automatic";
function Ka(e) {
	let t = Ta(), n = Ea(), r = ka(), i = h((n) => t.subscribeToTranslate(e, n), () => t.getTranslateSnapshot(e, n), () => t.getTranslateSnapshot(e, n));
	return i == null && k().isDevHotReloadEnabled() && r(e), i;
}
var { renderVariable: qa, renderDefaultChildren: Ja, renderTranslatedChildren: Ya, renderPreparedT: Xa } = fa({
	Currency: Na,
	GtInternalCurrency: Ma,
	DateTime: Ia,
	GtInternalDateTime: Fa,
	Num: za,
	GtInternalNum: Ra,
	RelativeTime: Ha,
	GtInternalRelativeTime: Va,
	Var: Wa,
	GtInternalVar: Ga
});
function Za(e, n = 0) {
	let r = n, i = (e) => {
		...
		if (a) {
			...
			if ((e[1] === "automatic" || e[2] === "automatic") && (i.injectionType = "automatic"), e[0] === "translate" && (e[0] = "fragment"), e[0] === "variable" && (i.variableType = e?.[1] || "variable"), e[0] === "plural") {
				let e = Object.entries(n).reduce((e, [t, n]) => (cn(t) && (e[t] = Za(n, r)), e), {});
				Object.keys(e).length && (i.branches = e);
			}
			if (e[0] === "branch") {
				let { children: e, branch: t, ...a } = n, o = Object.fromEntries(Object.entries(a).filter(([e]) => !e.startsWith("data-"))), s = Object.entries(o).reduce((e, [t, n]) => (e[t] = Za(n, r), e), {});
...
function $a(e, t) {
	let { type: n, props: r } = e, i = no(n);
	if (typeof r != "object" || !r) return e;
	if (i) {
		let { componentType: n, injectionType: o } = i;
		if (n === "variable") return e;
		if (n === "branch") return a(e, { ...Object.entries(r).reduce((e, [n, r]) => (e[n] = n !== "branch" && !n.startsWith("data-") ? eo(r, t) : r, e), {}) });
		if (n === "plural") return a(e, { ...Object.entries(r).reduce((e, [n, r]) => (e[n] = cn(n) || n === "children" ? eo(r, t) : r, e), {}) });
		if (n === "derive") return a(e, {
			...r,
			..."children" in r && { children: to(r.children, t + 1) }
		});
		if (n === "translate" && o === "automatic" && t > 0) return "children" in r ? to(r.children, t) : void 0;
		n === "translate" && o === "automatic" && console.warn(ro);
	}
	return a(e, {
		...r,
		..."children" in r && { children: to(r.children, t) }
	});
}
function eo(e, t) {
	return c(e) ? $a(e, t) : e;
...
function to(e, t) {
	return Array.isArray(e) ? n.map(e, (e) => eo(e, t)) : eo(e, t);
}
function no(e) {
...
var ao = (e) => {
	...
	let r = Object.entries(pn).reduce((e, [n, r]) => {
		let i = t[r];
	...
	let { props: t } = e, n = { t: ao(e) };
	if (t["data-_gt"]) {
		let e = t["data-_gt"], r = e.transformation;
		if (r === "variable") {
			let n = e.variableType || "variable", r = Qi(t, n), i = dn(n);
			return {
				i: e.id,
				k: r,
				v: i
		...
		n.i = e.id, n.d = oo(r, t, e.branches);
	}
	return t.children && (n.c = lo(t.children)), n;
}, co = (e) => io(e) ? so(e) : typeof e == "number" ? e.toString() : e;
function lo(e) {
	return Array.isArray(e) ? e.map(co) : co(e);
}
function uo({ sourceChildren: e, params: t, locale: n }) {
	let r = fo(e), i = po(r), a = mo({
		options: ho(t),
		locale: n
	});
	return oa(i, a), {
...
function mo({ options: e, locale: t }) {
	return {
		...e,
		$locale: t
	};
...
function go({ sourceChildren: e, params: t, _locale: n, _enableI18n: r }) {
	let i = xa(), a = Sa(), o = Ca(), s = n ?? i, c = r ?? a;
	return {
		defaultLocale: o,
		enableI18n: c,
		locale: s,
...
_o._gtt = "translate-client";
function vo({ children: e, _locale: t, _enableI18n: n, _renderPreparedT: r = Xa, ...i }) {
	let { defaultLocale: a, locale: o, enableI18n: s, targetOptions: c, taggedSourceChildren: l, sourceJsxChildren: u, shouldTranslate: d } = go({
		sourceChildren: e,
		params: i,
		_locale: t,
		_enableI18n: n
...
var A = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/Footer.tsx";
function yo() {
	let e = _({ strict: !1 }).locale ?? "en", t = [
		{
			label: y(_o, { children: "GitHub" }, void 0, !1, {
				fileName: A,
				lineNumber: 10,
				columnNumber: 14
			}, this),
		...
		{
			label: y(_o, { children: "Methodology" }, void 0, !1, {
				fileName: A,
				lineNumber: 15,
				columnNumber: 14
			}, this),
		...
		{
			label: y(_o, { children: "Contributing" }, void 0, !1, {
				fileName: A,
				lineNumber: 20,
				columnNumber: 14
			}, this),
			...
			children: [y("div", {
				...
				children: [
					y("div", { children: [y("h3", {
						...
						children: y(_o, { children: "i18n Benchmark" }, void 0, !1, {
							fileName: A,
							lineNumber: 32,
							columnNumber: 15
						}, this)
						...
						children: y(_o, { children: "An open-source test application for measuring the real-world impact of internationalization libraries on bundle size, loading time, and app reactivity." }, void 0, !1, {
							fileName: A,
							lineNumber: 35,
							columnNumber: 15
						}, this)
					...
					y("div", { children: [y("h3", {
						className: "mb-2 text-sm font-semibold text-foreground",
						children: y(_o, { children: "Resources" }, void 0, !1, {
							fileName: A,
							lineNumber: 44,
							columnNumber: 15
						}, this)
						...
						className: "space-y-1",
						children: t.map((t) => y("li", { children: t.isInternal ? y(g, {
							preload: !1,
							to: t.to,
							params: { locale: e },
					...
					y("div", { children: [y("h3", {
						className: "mb-2 text-sm font-semibold text-foreground",
						children: y(_o, { children: "Contact" }, void 0, !1, {
							fileName: A,
							lineNumber: 74,
							columnNumber: 15
						}, this)
				...
				children: y(_o, { children: "i18n Benchmark — Open-source project. Built with React, Vite & TanStack Router." }, void 0, !1, {
					fileName: A,
					lineNumber: 82,
					columnNumber: 11
				}, this)
...
var Cc = re(((e) => {
	...
	Object.defineProperty(e, "__esModule", { value: !0 }), ys(), oe(Io), Cc();
})), Tc = Cc();
wc();
...
function xl(e, t = "en", n) {
	...
	try {
		let i = R(e), a = j.get("Locale", e), o = a.language, s = bl([
			...
			t,
			"en"
		], g = j.get("DisplayNames", m, { type: "language" }), _ = j.get("DisplayNames", h, { type: "language" }), v = s?.name, y = s?.nativeName || s?.name, b = v || g.of(e) || e, x = y || _.of(e) || e, S = s?.maximizedName || v || g.of(u) || e, C = s?.nativeMaximizedName || y || _.of(u) || e, ee = s?.minimizedName || v || g.of(p) || e, te = s?.nativeMinimizedName || y || _.of(p) || e, w = s?.languageName || v || g.of(o) || e, T = s?.nativeLanguageName || y || _.of(o) || e, ne = s?.nameWithRegionCode || c ? `${w} (${c})` : b, re = s?.nativeNameWithRegionCode || (c ? `${T} (${c})` : x) || ne, ie = j.get("DisplayNames", m, { type: "region" }), ae = j.get("DisplayNames", h, { type: "region" }), oe = s?.regionName || (d ? ie.of(d) : "") || "", se = s?.nativeRegionName || (d ? ae.of(d) : "") || "", ce = j.get("DisplayNames", m, { type: "script" }), le = j.get("DisplayNames", h, { type: "script" });
		return {
			code: i,
			name: b,
			nativeName: x,
...
function $g({ children: e, config: t, environment: n = "production", projectId: r = t?.projectId || "", devApiKey: a = t?.devApiKey || "", _versionId: o = t?._versionId, dictionary: s = t?.dictionary || {}, locales: c = t?.locales || [], defaultLocale: l = t?.defaultLocale || Lp, cacheUrl: u = t?.cacheUrl || Vp, runtimeUrl: p = t?.runtimeUrl || Hp, renderSettings: h = t?.renderSettings || Sg(n), ssr: g = t?.ssr || Xg(), localeCookieName: _ = t?.localeCookieName || "generaltranslation.locale", locale: y = "", region: b, loadDictionary: x, loadTranslations: S, fallback: C, translations: ee = null, customMapping: te = t?.customMapping, enableI18n: w = t?.enableI18n === void 0 || t.enableI18n, enableI18nLoaded: T, reloadOnLocaleUpdate: ne, useEnableI18n: re = Yg, readAuthFromEnv: ie = pg, useDetermineLocale: ae = Zg, useRegionState: oe = Qg, ...se }) {
	...
	let { projectId: ce, devApiKey: le } = ie({
		...
		ssr: g
	}), { locale: de, setLocale: E, locales: fe, translationRequired: pe, dialectTranslationRequired: me } = Wg({
		_locale: y,
		defaultLocale: l,
		locales: c,
		ssr: g,
	...
	let { translations: Ce, setTranslations: we } = qg({
		_translations: ee,
		...
		_versionId: o,
		gt: _e
	}), { registerIcuForTranslation: Te, registerJsxForTranslation: Ee, developmentApiEnabled: De } = Vg({
		gt: _e,
		locale: de,
		versionId: o,
		defaultLocale: l,
		...
		environment: n,
		...se
	}), { _gtFunction: Oe, _mFunction: ke, _filterMessagesForPreload: Ae, _preloadMessages: je } = Hg({
		gt: _e,
		translations: Ce,
		locale: de,
		defaultLocale: l,
		...
		environment: n
	}), Me = Ug(_e, ye, xe, Ce, de, l, pe, me, De, Te, n), Ne = Jg(ye || {}, xe || {}, be, Se, Ce, de, l, pe, me, De, Te, Me), Pe = !(pe && !Ce || !de);
	return v(Bg.Provider, {
		value: {
			gt: _e,
			registerIcuForTranslation: Te,
...
var cy = b().server(function({ defaultLocale: e, locales: t, customMapping: n }) {
	let r = [], i = x(Mp);
...
var Dy = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/Footer.wrapper.tsx";
function Oy() {
	return y(Ey, { children: y(yo, {}, void 0, !1, {
		fileName: Dy,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
