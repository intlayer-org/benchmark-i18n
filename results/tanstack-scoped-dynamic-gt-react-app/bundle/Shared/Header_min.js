...
import { Link as _, useNavigate as v, useParams as y, useRouter as b } from "@tanstack/react-router";
import { jsx as x } from "react/jsx-runtime";
import { ChevronDown as S } from "lucide-react";
import { jsxDEV as C } from "react/jsx-dev-runtime";
import ee, { locales as te } from "../../gt.config.json";
import { createIsomorphicFn as w } from "@tanstack/react-start";
import { getCookie as ne, getRequestHeader as re } from "@tanstack/react-start/server";
var ie = Object.defineProperty, ae = Object.getOwnPropertyDescriptor, oe = Object.getOwnPropertyNames, se = Object.prototype.hasOwnProperty, ce = (e, t, n) => () => {
...
}, le = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), ue = (e, t) => {
	let n = {};
	...
	return e;
}, fe = (e) => se.call(e, "module.exports") ? e["module.exports"] : de(ie({}, "__esModule", { value: !0 }), e), pe = class extends Error {
	constructor(e, t, n) {
...
function T({ source: e, severity: t, whatHappened: n, reassurance: r, why: i, fix: a, wayOut: o, details: s, docsUrl: c }) {
	let l = e ? t ? `${e} ${t}:` : `${e}:` : t ? `${t}:` : "", u = i ? `${ge(n)} because ${ge(i)}` : n, d = !!a && !!o && /^[a-z]/.test(ge(o)), f = [
		u,
		r,
		d ? `${ge(a)}, or ${ge(o)}` : a,
		d ? void 0 : o,
...
function ye(e) {
	return ve(e.error) || typeof e.error == "string";
}
function be(e) {
	if (e.data !== void 0) return e.data;
	if (e.response) {
		let t = ve(e.error) ? e.error.error : typeof e.error == "string" ? e.error : e.response.statusText;
		throw new pe(t, e.response.status, t);
	}
	throw e.error;
}
var xe = (e) => e.client.post({
	security: [{
		scheme: "bearer",
		type: "http"
	}],
...
}), Se = 3, Ce = 500, we = 6e4, Te = /* @__PURE__ */ new Set([
	"GET",
	"HEAD",
	"OPTIONS",
	"PUT",
...
function De({ fetch: e = globalThis.fetch, timeoutMs: t = Ee } = {}) {
	return async (n, r) => {
		if (t === !1) return e(n, r);
...
function je(e, t, n) {
	return e?.status === 429 ? Ae(e.headers.get("Retry-After")) ?? ke(e.headers.get("RateLimit-Reset")) ?? we : Ce * (n === "linear" ? t + 1 : 2 ** t);
}
function Me({ fetch: e = globalThis.fetch, retryPolicy: t = "exponential" } = {}) {
	return async (n, r) => {
		let i = new Request(n, r), a = t === "none" ? 0 : Se, o = Te.has(i.method);
		for (let n = 0; n <= a; n++) {
			let r;
			try {
				r = await e(i.clone());
			...
			r?.body?.cancel(), await Oe(je(r, n, t));
		}
		throw Error("Max retries exceeded");
	};
}
var Ne = { bodySerializer: (e) => JSON.stringify(e, (e, t) => typeof t == "bigint" ? t.toString() : t) }, Pe = ({ onRequest: e, onSseError: t, onSseEvent: n, responseTransformer: r, responseValidator: i, sseDefaultRetryDelay: a, sseMaxRetryAttempts: o, sseMaxRetryDelay: s, sseSleepFn: c, url: l, ...u }) => {
...
}, Re = ({ allowReserved: e, explode: t, name: n, style: r, value: i }) => {
	if (!t) {
		let t = (e ? i : i.map((e) => encodeURIComponent(e))).join(Ie(r));
		switch (r) {
			case "label": return `.${t}`;
	...
	let a = Fe(r), o = i.map((t) => r === "label" || r === "simple" ? e ? t : encodeURIComponent(t) : ze({
		allowReserved: e,
		name: n,
		value: t
	})).join(a);
	return r === "label" || r === "matrix" ? a + o : o;
}, ze = ({ allowReserved: e, name: t, value: n }) => {
	if (n == null) return "";
...
}, Be = ({ allowReserved: e, explode: t, name: n, style: r, value: i, valueOnly: a }) => {
	...
	let o = Le(r), s = Object.entries(i).map(([t, i]) => ze({
		allowReserved: e,
		name: r === "deepObject" ? `${n}[${t}]` : t,
		value: i
	})).join(o);
	return r === "label" || r === "matrix" ? o + s : s;
}, Ve = /\{[^{}]+\}/g, He = ({ path: e, url: t }) => {
	let n = t, r = t.match(Ve);
	if (r) for (let t of r) {
	...
	return n;
}, Ue = ({ baseUrl: e, path: t, query: n, querySerializer: r, url: i }) => {
...
var Ge = async (e, t) => {
...
}, Je = (e, t) => t ? !!(e.headers.has(t) || e.query?.[t] || e.headers.get("Cookie")?.includes(`${t}=`)) : !1, Ye = async ({ security: e, ...t }) => {
	for (let n of e) {
		if (Je(t, n.name)) continue;
		let e = await Ge(n, t.auth);
		if (!e) continue;
	...
	return n.baseUrl?.endsWith("/") && (n.baseUrl = n.baseUrl.substring(0, n.baseUrl.length - 1)), n.headers = $e(e.headers, t.headers), n;
}, Qe = (e) => {
	let t = [];
	...
	for (let n of e) {
		if (!n) continue;
		let e = n instanceof Headers ? Qe(n) : Object.entries(n);
...
}), rt = { "Content-Type": "application/json" }, it = (e = {}) => ({
	...Ne,
	headers: rt,
	parseAs: "auto",
	querySerializer: nt,
	...
	let t = Ze(it(), e), n = () => ({ ...t }), r = (e) => (t = Ze(t, e), n()), i = tt(), a = async (e) => {
		let n = {
			...t,
			...e,
			fetch: e.fetch ?? t.fetch ?? globalThis.fetch,
			headers: $e(t.headers, e.headers),
			serializedBody: void 0
		};
		return n.security && await Ye({
			...n,
			security: n.security
		...
		if (c.ok) {
			let e = (t.parseAs === "auto" ? qe(c.headers.get("Content-Type")) : t.parseAs) ?? "json";
...
function ot(e) {
	...
	return e.apiKey && t.set("Authorization", `Bearer ${e.apiKey}`), e.projectId && t.set("gt-project-id", e.projectId), at({
		baseUrl: e.baseUrl,
		fetch: Me({
			fetch: De({
				fetch: e.fetch,
...
var Mt = /[\t-\r \x85\u200E\u200F\u2028\u2029]/u, Nt = /[\t-\r \x85\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\x21-\x2F\x3A-\x40\x5B-\x5E\x60\x7B-\x7E\xA1-\xA7\xA9\xAB\xAC\xAE\xB0\xB1\xB6\xBB\xBF\xD7\xF7\u2010-\u2027\u2030-\u203E\u2041-\u2053\u2055-\u205E\u2190-\u245F\u2500-\u2775\u2794-\u2BFF\u2E00-\u2E7F\u3001-\u3003\u3008-\u3020\u3030\uFD3E-\uFD3F\uFE45-\uFE46]/u, Pt = class {
	constructor(e, t) {
	...
	parseMessage(e, t, n) {
		...
		for (; !this.atEnd();) {
			...
			} else i === "<" && !this.options.ignoreTag && At(this.peek()) ? r.push(this.parseTag(t)) : r.push(this.parseLiteral(e, t));
		}
		return r;
	}
	parseLiteral(e, t) {
		...
		for (; !this.atEnd();) {
			...
			let i = this.current();
			if (i === "{" || i === "}" && e || i === "#" && t || i === "<" && !this.options.ignoreTag && (At(this.peek()) || this.peek() === "/")) break;
	...
	parseTag(e) {
		...
		let a = this.index;
		return At(this.current()) || this.failAt("INVALID_TAG", i, this.index), this.readTagName() !== n && this.fail("UNMATCHED_CLOSING_TAG", a), this.skipSpace(), this.consume(">") || this.failAt("INVALID_TAG", i, this.index), this.withLocation({
			type: E.tag,
			value: n,
			children: r
		}, t, this.index);
	...
	readTagName() {
		let e = this.index;
		for (At(this.current()) || this.fail("INVALID_TAG", e), this.index += 1; !this.atEnd() && jt(this.current());) this.index += this.current().length;
	...
	readIdentifier() {
		let e = this.index;
		for (; !this.atEnd() && !Nt.test(this.current());) this.index += this.current().length;
		return this.message.slice(e, this.index);
	}
	skipSpace() {
	...
	current() {
		return It(this.message, this.index);
	}
	peek() {
		let e = this.current();
		return It(this.message, this.index + e.length);
	}
	atEnd() {
	...
	position(e) {
		let t = this.positions ??= Ft(this.message);
		return {
			offset: e,
			line: t[0][e],
			column: t[1][e]
...
function Ut(e, t, n) {
	...
	for (let r of e) switch (r.type) {
		...
		case E.pound:
			...
			break;
		case E.argument: {
			let e = Wt(t.variables, r.value);
			i(typeof e == "string" || typeof e == "number" ? String(e) : e || "");
			break;
		}
		case E.number: {
			let e = Wt(t.variables, r.value), { scale: n, ...a } = typeof r.style == "string" ? Rt[r.style] ?? {} : r.style?.type === st.number ? r.style.parsedOptions : {}, o = Gt(e, n);
			i(Kt(t, a).format(o));
			break;
		}
		case E.date:
		case E.time: {
			let e = Wt(t.variables, r.value), n = r.type === E.date ? zt : Vt;
			i(qt(t, typeof r.style == "string" ? n[r.style] : r.style?.type === st.dateTime ? r.style.parsedOptions : r.type === E.time ? Vt.medium : void 0).format(e));
			break;
		}
		case E.select: {
			let e = String(Wt(t.variables, r.value)), n = Qt(r.options, e) ?? r.options.other;
			if (!n) throw $t(r.value, e, r.options);
			Ut(n.value, t).forEach(i);
			break;
		}
		case E.plural: {
			let e = Wt(t.variables, r.value), n = `=${String(e)}`, a = Qt(r.options, n), o = typeof e == "bigint" ? e : Number(e), s = typeof o == "bigint" ? o - BigInt(r.offset) : o - r.offset;
			if (!a && Zt(r.options)) {
				let e = Jt(t, r.pluralType ?? "cardinal").select(Xt(s));
				a = Qt(r.options, e);
			}
			if (a ??= r.options.other, !a) throw $t(r.value, e, r.options);
			Ut(a.value, t, s).forEach(i);
			break;
		}
		case E.tag: {
			let e = Wt(t.variables, r.value);
			if (typeof e != "function") throw TypeError(`The ICU tag variable "${r.value}" must be a function.`);
			let a = e(Ut(r.children, t, n));
...
function Kt(e, t = {}) {
	return Yt(e.numberFormats ??= /* @__PURE__ */ new Map(), JSON.stringify(t), () => new Intl.NumberFormat(e.locales, t));
}
function qt(e, t) {
	return Yt(e.dateTimeFormats ??= /* @__PURE__ */ new Map(), t ? JSON.stringify(t) : "", () => new Intl.DateTimeFormat(e.locales, t));
}
function Jt(e, t) {
	...
	return Yt(e.pluralRules ??= /* @__PURE__ */ new Map(), t, () => new Intl.PluralRules(e.locales, { type: t }));
}
function Yt(e, t, n) {
	let r = e.get(t);
	if (r) return r;
...
function tn({ icuString: e, shouldVisit: t, visitor: n, options: { recurseIntoVisited: r = !0, ...i } }) {
	let a = Lt(e, i);
	return o(a), a;
	function o(e) {
		e.map(s);
...
var rn = RegExp(`^${nn}$`);
function an(e) {
	return e.type === E.select && rn.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === E.literal);
}
function on(e) {
	let t = e;
...
var sn = (e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`, cn = "DEFAULT_TERMINATOR_KEY", ln = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	constructor(t, n = {}) {
		...
		if (!ln[r]) throw Error(sn(r));
		let i = n.maxChars === void 0 ? void 0 : ln[r][new Intl.Locale(this.locale).language] || ln[r].DEFAULT_TERMINATOR_KEY, a = n.terminator ?? i?.terminator, o = a == null ? void 0 : n.separator ?? i?.separator;
	...
	get(e, ...t) {
		...
		let o = a[i];
		return o === void 0 && (o = new dn[e](...t), a[i] = o), o;
	}
}();
function fn(e) {
...
function hn(e, t = pn, n = ["en"]) {
	let r = fn(n).select(e), i = Math.abs(e);
...
function vn(e) {
	...
	for (let n = 0; n < t.length; n++) {
		...
		r.push(e.slice(i, a)), r.push(e.slice(a, a + nn.length + 1)), r.push(String(n + 1)), r.push(e.slice(a + nn.length + 1, s)), r.push("{}"), r.push(e.slice(c, o)), i = o;
	}
...
function Cn({ value: e, locales: t = ["en"], currency: n = "USD", options: r = {} }) {
	return D.get("NumberFormat", t, {
		style: "currency",
		currency: n,
		numberingSystem: "latn",
...
function Tn({ value: e, locales: t = ["en"], options: n = {} }) {
...
function Dn({ value: e, unit: t, locales: n = ["en"], options: r = {} }) {
...
var jn = (e, t, n) => {
	...
	let n = e?.[t];
	return An(n) && typeof n.code == "string" ? n.code : void 0;
}, Nn = /* @__PURE__ */ new Set([
	"Cham",
	"Jamo",
	"Kawi",
	...
	"Toto",
	"Thai"
]), Pn = (e) => e >= "qaa" && e <= "qtz", Fn = (e, t) => {
	e = Mn(t, e) || e;
	try {
		let { language: t, region: n, script: r } = D.get("Locale", e), i = 1 + Number(!!n) + Number(!!r);
		return !(e.split("-").length !== i || D.get("DisplayNames", ["en"], { type: "language" }).of(t) === t && !Pn(t) || n && D.get("DisplayNames", ["en"], { type: "region" }).of(n) === n || r && D.get("DisplayNames", ["en"], { type: "script" }).of(r) === r && !Nn.has(r));
	} catch {
		return !1;
	}
}, In = (e) => {
...
function Ln(e, t) {
	...
	for (let a of e) {
		...
		r.add(e);
		let o = i.get(e);
		o === void 0 && (o = /* @__PURE__ */ new Set(), i.set(e, o)), o.add(In(a));
	}
	return {
		allValid: n,
		languages: r,
...
function Rn(...e) {
	try {
		let t = e.flat().map((e) => D.get("Locale", In(e))), [n] = t, r = new Set(t.map(({ region: e }) => e).filter(Boolean)), i = new Set(t.map(({ script: e }) => e).filter(Boolean));
...
function zn(e, t, n, r) {
	if (n && !n.allValid || !Fn(e, r) || !Fn(t, r) || Rn(e, t)) return !1;
	if (!n) return !0;
	let i = On(t);
	return i !== void 0 && n.languages.has(i);
}
function Bn(e, t, n, r) {
	return zn(e, t, n ? Ln(n, r) : void 0, r);
}
function Vn(e) {
	try {
...
function Hn(e, t) {
	if (t.has(e)) return e;
	let { languageCode: n, regionCode: r, scriptCode: i, minimizedCode: a } = Vn(e), o = `${n}-${r}`;
	if (t.has(o)) return o;
	let s = `${n}-${i}`;
	if (t.has(s)) return s;
	if (t.has(a)) return a;
...
function Kn(e, t) {
	...
	e = Gn(e, t);
	try {
		let r = In(e), i = D.get("Locale", r), { language: a, region: o } = i;
		if (t) for (let i of [
			n,
			e,
			r,
		...
		if (s) return s;
		let c = i.maximize();
		return Xn[c.language] || er(c.region || "");
	} catch {
		return Yn;
	}
}
...
function tr(e) {
	...
	if (n) return n;
	if (Qn.has(t)) return String.fromCodePoint(t.charCodeAt(0) + $n, t.charCodeAt(1) + $n);
}
function nr(e, t) {
	if (!t) return;
	let n = {};
...
function rr(e, t = "en", n) {
	...
	e = Gn(e, n), t ||= "en";
	try {
		let i = In(e), a = D.get("Locale", e), o = a.language, s = nr([
			r,
			e,
			i,
			o
			...
			t,
			"en"
		], g = D.get("DisplayNames", m, { type: "language" }), _ = D.get("DisplayNames", h, { type: "language" }), v = s?.name, y = s?.nativeName || s?.name, b = v || g.of(e) || e, x = y || _.of(e) || e, S = s?.maximizedName || v || g.of(u) || e, C = s?.nativeMaximizedName || y || _.of(u) || e, ee = s?.minimizedName || v || g.of(p) || e, te = s?.nativeMinimizedName || y || _.of(p) || e, w = s?.languageName || v || g.of(o) || e, ne = s?.nativeLanguageName || y || _.of(o) || e, re = s?.nameWithRegionCode || (c ? `${w} (${c})` : b), ie = s?.nativeNameWithRegionCode || (c ? `${ne} (${c})` : x) || re, ae = D.get("DisplayNames", m, { type: "region" }), oe = D.get("DisplayNames", h, { type: "region" }), se = s?.regionName || (d ? ae.of(d) : "") || "", ce = s?.nativeRegionName || (d ? oe.of(d) : "") || "", le = D.get("DisplayNames", m, { type: "script" }), ue = D.get("DisplayNames", h, { type: "script" });
		return {
			code: i,
			name: b,
			nativeName: x,
			...
			languageCode: o,
			languageName: w,
			nativeLanguageName: ne,
			nameWithRegionCode: re,
			nativeNameWithRegionCode: ie,
			regionCode: d,
			regionName: se,
			nativeRegionName: ce,
			scriptCode: f,
			...
			emoji: s?.emoji || Kn(i, n)
		};
	} catch {
		let t = Fn(e) ? In(e) : e, r = t.split("-"), i = r[0] || t, a = r.length > 2 ? r[2] : r[1] || "", o = r[3] || "", s = nr([t, i], n);
		t = s?.code || t;
...
function ar(e) {
	try {
		let t = cr(D.get("Locale", e));
		if (t) return t;
	} catch {}
	let { scriptCode: t, languageCode: n } = rr(e);
	return t ? or.has(t.toLowerCase()) ? "rtl" : "ltr" : n && sr.has(n.toLowerCase()) ? "rtl" : "ltr";
}
...
function lr(e, t) {
	try {
		let { language: n, region: r, script: i } = D.get("Locale", In(e)), { language: a, region: o, script: s } = D.get("Locale", In(t));
...
function ur(e, t) {
	return t ? Object.keys(t).find((n) => Mn(t, n) === e) ?? e : e;
}
var dr = class {
	getResolutionScope() {
	...
	isResolutionScopeCurrent(e) {
		...
		for (let t = 0; t < this.locales.length; t++) {
			...
			if (r.locale !== n || r.canonicalLocale !== this.resolveCanonicalLocale(n) || e.canonicalMappingCodes[t] !== Mn(this.customMapping, r.canonicalLocale)) return !1;
		}
		return !0;
	}
	buildResolutionScope(e) {
		...
		return {
			...
			canonicalMappingCodes: t.map(({ canonicalLocale: e }) => Mn(this.customMapping, e)),
			approved: Ln(t.map(({ canonicalLocale: e }) => e), this.customMapping)
		};
	}
	...
	formatRelativeTimeFromDate(e, t, n = {}) {
		let { locales: r, baseDate: i, ...a } = n, { value: o, unit: s } = En(e, i ?? /* @__PURE__ */ new Date());
		return Dn({
			value: o,
			unit: s,
			locales: this.getFormattingLocales(t, r),
	...
	formatMessage(e, t, n = {}) {
		...
		return a === "STRING" ? e : bn(e, this.getFormattingLocales(t, r), i);
	}
	formatList(e, t, n = {}) {
		let { locales: r, ...i } = n;
		return wn({
	...
	getLocaleProperties(e) {
		return rr(e, this.defaultLocale, this.customMapping);
	}
	requiresTranslation(e, t = this.defaultLocale, n = this.locales.length ? this.locales : void 0) {
		let r = n ? n === this.locales ? this.getResolutionScope().approved : Ln(n.map((e) => this.resolveCanonicalLocale(e)), this.customMapping) : void 0;
		return zn(this.resolveCanonicalLocale(t), this.resolveCanonicalLocale(e), r, this.customMapping);
	}
	determineLocale(e, t = this.locales) {
		let { approvedLocalePairs: n, approved: r } = t === this.locales ? this.getResolutionScope() : this.buildResolutionScope(t), i = Un(Array.isArray(e) ? e.map((e) => this.resolveCanonicalLocale(e)) : this.resolveCanonicalLocale(e), r, this.customMapping);
		if (i) return n.find(({ canonicalLocale: e }) => e === i)?.locale ?? this.resolveAliasLocale(i);
	}
	getLocaleDirection(e) {
		return ar(this.resolveCanonicalLocale(e));
	}
	isValidLocale(e) {
		return Fn(e, this.customMapping);
	}
	resolveCanonicalLocale(e) {
		return Gn(e, this.customMapping);
	}
	resolveAliasLocale(e) {
		return ur(e, this.customMapping);
	}
	standardizeLocale(e) {
		return In(e);
	}
	isSameDialect(...e) {
		return Rn(...e.map((e) => Array.isArray(e) ? e.map((e) => this.resolveCanonicalLocale(e)) : this.resolveCanonicalLocale(e)));
	}
	isSameLanguage(...e) {
	...
	isSupersetLocale(e, t) {
		return lr(this.resolveCanonicalLocale(e), this.resolveCanonicalLocale(t));
	}
};
function fr(e, t = "en", n) {
	t ||= "en";
	let r = e, i = Yn;
	try {
		r = D.get("DisplayNames", [t, "en"], { type: "region" }).of(e) || e, i = er(e);
	} catch {}
	return {
		code: e,
		name: r,
...
function br(e, t, n = "") {
	let r = yr(e), i = e?.length, a = t !== void 0;
	if (!r || a && i !== t) {
...
var Er = typeof Uint8Array.from([]).toHex == "function" && typeof Uint8Array.fromHex == "function", Dr = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function Or(e) {
	if (br(e), Er) return e.toHex();
	let t = "";
...
var Pr = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = wr(this.buffer);
	}
	update(e) {
		xr(this), br(e);
	...
	digestInto(e) {
		xr(this), Sr(e, this), this.finished = !0;
	...
	3204031479,
	3329325298
]), Lr = /* @__PURE__ */ new Uint32Array(64), Rr = class extends Pr {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		...
		for (let e = 16; e < 64; e++) {
			let t = Lr[e - 15], n = Lr[e - 2], r = Tr(t, 7) ^ Tr(t, 18) ^ t >>> 3, i = Tr(n, 17) ^ Tr(n, 19) ^ n >>> 10;
			Lr[e] = i + Lr[e - 7] + r + Lr[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = Tr(o, 6) ^ Tr(o, 11) ^ Tr(o, 25), u = l + t + Mr(o, s, c) + Ir[e] + Lr[e] | 0, d = (Tr(n, 2) ^ Tr(n, 13) ^ Tr(n, 22)) + Nr(n, r, i) | 0;
...
var oi = class {
	...
	handle(e) {
		...
		let n = ri[e.level], r = `[${e.level.toUpperCase()}]`;
		t.push(`${n}${r}${ii}`), this.config.prefix && t.push(`[${this.config.prefix}]`), this.config.includeContext && e.context && t.push(`[${e.context}]`), t.push(e.message), e.metadata && Object.keys(e.metadata).length > 0 && t.push(`\n  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
		let i = t.join(" ");
		switch (e.level) {
			case "debug":
				console.debug(i);
	...
	constructor(e = {}) {
		this.config = {
			...
			handlers: [],
			...e
		}, this.handlers = [...this.config.handlers || []], this.config.enableConsole && this.handlers.push(new oi(this.config));
	}
	addHandler(e) {
	...
	shouldLog(e) {
		return ni[e] >= ni[this.config.level];
	}
	log(e, t, n, r) {
...
async function di(e, t, n) {
	...
	try {
		...
		throw e instanceof Error && e.name === "AbortError" ? Jr(n) : e;
	} finally {
		o && clearTimeout(o);
	}
}
async function fi(e) {
	if (!e.ok) {
		...
		throw new pe(Yr(e.status, e.statusText, t), e.status, t);
	}
}
async function pi(e, t, n, r) {
	...
	if (l.data === void 0 && l.response && !ye(l)) throw await fi(l.response), l.error;
	let u = be(l);
...
var mi = class {
	...
	setConfig({ apiKey: e, devApiKey: t, sourceLocale: n, targetLocale: r, locales: i, projectId: a, customMapping: o, baseUrl: s }) {
		if (e && (this.apiKey = e), t && (this.devApiKey = t), a && (this.projectId = a), n && (this.sourceLocale = hr(n), !pr(this.sourceLocale, o))) throw Error(ei(this.sourceLocale));
		if (r && (this.targetLocale = hr(r), !pr(this.targetLocale, o))) throw Error(ei(this.targetLocale));
		if (i) {
			let e = [], t = [];
			if (i.forEach((n) => {
				let r = hr(n);
				pr(r) ? e.push(r) : t.push(n);
			}), t.length > 0) throw Error(ti(t));
			this.locales = e;
		}
		s && (this.baseUrl = s), o && (this.customMapping = o, this.reverseCustomMapping = Object.fromEntries(Object.entries(o).filter(([, e]) => e && typeof e == "object" && "code" in e).map(([e, t]) => [t.code, e]))), this._localeConfig = new dr({
	...
	getRegionProperties(e = this.getLocaleProperties().regionCode, t) {
		...
		return fr(e, this.targetLocale, t);
	}
	requiresTranslation(e = this.sourceLocale, t = this.targetLocale, n = this.locales, r = this.customMapping) {
		if (!e) throw Error(Zr("requiresTranslation"));
		if (!t) throw Error(Xr("requiresTranslation"));
		return r === this.customMapping ? this.localeConfig.requiresTranslation(t, e, n) : gr(e, t, n, r);
	}
	determineLocale(e, t = this.locales || [], n = this.customMapping) {
		return n === this.customMapping ? this.localeConfig.determineLocale(e, t ?? []) : _r(e, t, n);
	}
	getLocaleDirection(e = this.targetLocale) {
		if (!e) throw Error(Xr("getLocaleDirection"));
		return this.localeConfig.getLocaleDirection(e);
	}
	isValidLocale(e = this.targetLocale, t = this.customMapping) {
		if (!e) throw Error(Xr("isValidLocale"));
		return t === this.customMapping ? this.localeConfig.isValidLocale(e) : pr(e, t);
	}
	resolveCanonicalLocale(e = this.targetLocale, t = this.customMapping) {
		if (!e) throw Error(Xr("resolveCanonicalLocale"));
		return t === this.customMapping ? this.localeConfig.resolveCanonicalLocale(e) : mr(e, t);
	}
	resolveAliasLocale(e, t = this.customMapping) {
		if (!e) throw Error(Xr("resolveAliasLocale"));
		return t === this.customMapping ? this.localeConfig.resolveAliasLocale(e) : vr(e, t);
	}
	standardizeLocale(e = this.targetLocale) {
		if (!e) throw Error(Xr("standardizeLocale"));
...
function gi() {
	let e = vi();
	return e === void 0 ? yi(() => void 0) : e;
}
function _i(e) {
	return e?.toUpperCase() === hi;
}
function vi() {
...
function Si({ namespace: e, key: t, source: n, notInitialized: r }) {
	function i() {
		let n = bi(e)[t];
		if (n == null) {
			let e = r();
...
function Ci() {
	let e = xi("i18n")?.i18nConfig;
	return wi(e) ? e.isDebugLoggingEnabled() : _i(gi());
}
function wi(e) {
...
function Di() {
	...
	let e = Oi(() => "production");
	return e ? e === "development" ? "development" : "production" : Oi(() => !0) === !0 ? "development" : "production";
}
function Oi(e) {
	try {
		return e();
...
function Ai(e, t) {
	if (!t) return;
	let n = ji(e), r = Mi(e), i = [...n, ...r];
	if (i.forEach((e) => {
		ki.error(`I18nConfig: ${Ni(e)}`);
...
function ji({ defaultLocale: e, locales: t, customMapping: n }) {
	let r = /* @__PURE__ */ new Set([...e ? [e] : [], ...t || []]);
	return Array.from(r).filter((e) => !pr(e, n));
}
...
var Pi = class extends dr {
	constructor(e = {}) {
		let t = Ri(e);
		super(Fi(e, t)), this.runtimeConfig = {
			...
			_tagIds: e._tagIds
		}, this.gtServicesEnabled = t, this.logLevel = gi();
	}
	getDefaultLocale() {
	...
	getLocaleConfig(e) {
		return !e || !Li(e) ? this : new dr(Ii(e));
	}
...
function Ii({ defaultLocale: e = "en", locales: t = [], customMapping: n } = {}) {
	return {
		defaultLocale: e,
...
var { getConditionStore: Vi, setConditionStore: Hi } = Bi(T({
	source: "gt-i18n",
	severity: "Error",
...
var Gi = [];
function Ki({ locale: e, enableI18n: t, localesProp: n = Gi }) {
	let r = O().getDefaultLocale();
	return t && O().requiresTranslation(e) ? [
		...n,
		e,
		r
	] : [r];
}
var qi = "server-render", Ji = Symbol.for("generaltranslation.react-core.ReactI18nConfig"), Yi = class extends Pi {
	renderStrategy;
	localeCookieName;
	regionCookieName;
	enableI18nCookieName;
	constructor(e = {}, t = qi) {
		super(e), Zi(t), Object.defineProperty(this, Ji, { value: !0 }), this.renderStrategy = t, this.localeCookieName = e.localeCookieName ?? "generaltranslation.locale", this.regionCookieName = e.regionCookieName ?? "generaltranslation.region", this.enableI18nCookieName = e.enableI18nCookieName ?? "generaltranslation.enable-i18n";
	}
	getRenderStrategy() {
...
function Qi(e) {
	...
	let t = e;
	return t[Ji] === !0 && typeof t.getRenderStrategy == "function" && typeof t.getLocaleCookieName == "function" && typeof t.getRegionCookieName == "function" && typeof t.getEnableI18nCookieName == "function";
}
var { getConditionStore: $i, setConditionStore: ea, isConditionStoreInitialized: ta } = Bi(T({
	source: "@generaltranslation/react-core",
	severity: "Error",
...
function na({ Currency: e, GtInternalCurrency: t, DateTime: n, GtInternalDateTime: r, Num: i, GtInternalNum: a, RelativeTime: o, GtInternalRelativeTime: s, Var: c, GtInternalVar: l }) {
...
function ia(e = {}, t) {
	return typeof e.name == "string" ? e.name : `_gt_${ra[t] || "value"}_${e["data-_gt"]?.id}`;
}
function aa(e) {
...
function ca(e, t, n) {
	let r = "", i = null;
	return typeof e == "number" && !i && n && (r = hn(e, Object.keys(n).filter(mn), t)), r && !i && (i = n[r]), i;
}
function la({ renderVariable: e }) {
	return function({ children: n, defaultLocale: r = "en", enableI18n: i }) {
		let a = (n) => {
			let a = sa(n);
			if (aa(n.props)) {
				let { variableType: t, variableValue: a, variableOptions: o, injectionType: s } = oa(n.props);
				return e({
					variableType: t,
					variableValue: a,
					variableOptions: o,
			...
			if (a?.transformation === "plural") {
				let e = a.branches || {};
				return typeof n.props.n == "number" ? s(ca(n.props.n, [r], e) ?? n.props.children) : n.props.children == null ? null : s(n.props.children);
			}
...
function ua({ renderVariable: e }) {
	let n = la({ renderVariable: e });
	function r({ sourceElement: e, targetElement: r, locales: a = ["en"], enableI18n: o }) {
		...
		if (u && Object.entries(yn).forEach(([e, t]) => {
			u[e] && (d[t] = u[e]);
		}), l === "plural") {
			let t = e.props.n;
			return typeof t == "number" ? i({
				source: ca(t, a, c.branches || {}) ?? e.props.children,
				target: ca(t, a, r.d?.b || {}) ?? r.c,
				locales: a,
				enableI18n: o
			}) : n({
				children: e,
	...
	function i({ source: i, target: a, locales: o = ["en"], enableI18n: s }) {
		...
		if (Array.isArray(a) && !Array.isArray(i) && i && (i = [i]), Array.isArray(i) && Array.isArray(a)) {
			let n = {}, c = {}, l = {}, u = i.filter((e) => {
				if (t.isValidElement(e)) {
					if (aa(e.props)) {
						let { variableName: t, variableValue: r, variableOptions: i, injectionType: a } = oa(e.props);
						n[t] = r, c[t] = i, l[t] = a;
					} else return !0;
				}
				return !1;
			...
			return a.map((i, a) => {
				if (typeof i == "string") return x(t.Fragment, { children: i }, `string_${a}`);
				if (on(i)) return x(t.Fragment, { children: e({
					variableType: i.v || "v",
					variableValue: n[i.k],
				...
				let u = d(i);
				return u ? x(t.Fragment, { children: r({
					sourceElement: u,
					targetElement: i,
					locales: o,
					enableI18n: s
		...
		if (a && typeof a == "object" && !Array.isArray(a)) {
			...
			if (t.isValidElement(i)) {
				...
				if (aa(i.props)) {
					let { variableValue: t, variableOptions: n, variableType: r, injectionType: a } = oa(i.props);
					return e({
						variableType: r,
						variableValue: t,
						variableOptions: n,
...
var pa = { display: "contents" }, ma = globalThis.navigator?.product === "ReactNative";
function ha(e) {
	if (e == null || typeof e == "boolean" || e === "") return !0;
	if (Array.isArray(e)) return !e.some((e) => !ha(e));
	if (c(e) && e.type === r) {
...
function ga(e, t) {
	return ma || !da() ? e : c(e) && typeof e.type == "string" ? a(e, { "data-_gt-hash": t }) : ha(e) ? e : s("span", {
		"data-_gt-hash": t,
		style: pa
	}, e);
}
function _a({ renderDefaultChildren: e, renderTranslatedChildren: t }) {
...
function va(e) {
	let t = na(e), n = la({ renderVariable: t }), r = ua({ renderVariable: t });
	return {
		renderVariable: t,
...
ya.set, ya.isInitialized;
function xa() {
	let e = T({
		source: "@generaltranslation/react-core",
		severity: "Error",
		whatHappened: "Cannot access I18nStore before it is initialized.",
		fix: Xi().getRenderStrategy() === "SPA" ? "Initialize GT before reading GT runtime context." : "Add a <GTProvider> at the root of your component tree."
	});
	return Error(e);
}
var Sa = Si({
...
function Ca() {
	return Sa.isInitialized() || Sa.set(o(void 0)), Sa.get();
}
function wa() {
	let e = u(Ca());
	if (e || Xi().getRenderStrategy() === "SPA") return e;
	throw Error(Ta());
}
function Ta() {
	return T({
...
function Ea() {
	return wa()?.conditionStore ?? $i();
}
function Da() {
	return Ea().getLocale();
}
function Oa() {
	return Ea().getEnableI18n();
}
function ka() {
	return p(() => O().getDefaultLocale(), []);
}
function Aa() {
	let e = Oa(), t = Da();
	return e && O().requiresTranslation(t);
}
function ja() {
	return wa()?.i18nStore || ba();
}
function Ma() {
	return wa()?.translationsSnapshot || {};
}
function Na() {
	return Pa(Aa());
}
function Pa(e) {
	let t = wa()?.onMissingTranslation, n = Ia(e);
	return l((e) => {
		t ? t(e) : n(Wi(e), {
			type: "translation",
			lookup: e
...
var Fa = Na;
function Ia(e) {
	let t = O().isDevHotReloadEnabled(), n = ja(), r = /* @__PURE__ */ new Map();
	return d(() => {
...
function La({ _enableI18n: e, _locale: t, children: n, currency: r = "USD", options: i = {}, locales: a = [] }) {
	let o = Ki({
		locale: t,
		enableI18n: e,
		localesProp: a
...
Ra._gtt = "variable-currency-automatic", za._gtt = "variable-currency";
function Ba({ _enableI18n: e, _locale: t, children: n, options: r = {}, locales: i = [] }) {
	let a = Ki({
		locale: t,
		enableI18n: e,
		localesProp: i
...
function Va({ _enableI18n: e, _locale: t, ...n }) {
	return Ba({
		...n,
		_enableI18n: e ?? Oa(),
		_locale: t ?? Da()
...
Va._gtt = "variable-datetime-automatic", Ha._gtt = "variable-datetime";
function Ua({ _enableI18n: e, _locale: t, children: n, options: r = {}, locales: i = [] }) {
	let a = Ki({
		locale: t,
		enableI18n: e,
		localesProp: i
...
function Wa({ _enableI18n: e, _locale: t, ...n }) {
	return Ua({
		...n,
		_enableI18n: e ?? Oa(),
		_locale: t ?? Da()
...
Wa._gtt = "variable-number-automatic", Ga._gtt = "variable-number";
function Ka({ _enableI18n: e, _locale: t, date: n, children: r, value: i, unit: a, baseDate: o, locales: s = [], options: c = {} }) {
	let l = Ki({
		locale: t,
		enableI18n: e,
		localesProp: s
	}), u = O().getGTClass(), d = n ?? r;
...
function qa({ _enableI18n: e, _locale: t, ...n }) {
	return Ka({
		...n,
		_enableI18n: e ?? Oa(),
		_locale: t ?? Da()
...
qa._gtt = "variable-relative-time-automatic", Ja._gtt = "variable-relative-time";
function Ya({ children: e }) {
	return e;
}
function Xa({ children: e }) {
	return Ya({ children: e });
}
function Za({ children: e }) {
	return Ya({ children: e });
}
Xa._gtt = "variable-variable", Za._gtt = "variable-variable-automatic";
function Qa(e) {
	let t = ja(), n = Ma(), r = Fa(), i = g((n) => t.subscribeToTranslate(e, n), () => t.getTranslateSnapshot(e, n), () => t.getTranslateSnapshot(e, n));
	return i == null && O().isDevHotReloadEnabled() && r(e), i;
}
var { renderVariable: $a, renderDefaultChildren: eo, renderTranslatedChildren: to, renderPreparedT: no } = va({
	Currency: za,
	GtInternalCurrency: Ra,
	DateTime: Ha,
	GtInternalDateTime: Va,
	Num: Ga,
	GtInternalNum: Wa,
	RelativeTime: Ja,
	GtInternalRelativeTime: qa,
	Var: Xa,
	GtInternalVar: Za
});
function ro(e, n = 0) {
	let r = n, i = (e) => {
		...
		if (a) {
			...
			if ((e[1] === "automatic" || e[2] === "automatic") && (i.injectionType = "automatic"), e[0] === "translate" && (e[0] = "fragment"), e[0] === "variable" && (i.variableType = e?.[1] || "variable"), e[0] === "plural") {
				let e = Object.entries(n).reduce((e, [t, n]) => (mn(t) && (e[t] = ro(n, r)), e), {});
				Object.keys(e).length && (i.branches = e);
			}
			if (e[0] === "branch") {
				let { children: e, branch: t, ...a } = n, o = Object.fromEntries(Object.entries(a).filter(([e]) => !e.startsWith("data-"))), s = Object.entries(o).reduce((e, [t, n]) => (e[t] = ro(n, r), e), {});
...
function ao(e, t) {
	let { type: n, props: r } = e, i = co(n);
	if (typeof r != "object" || !r) return e;
	if (i) {
		let { componentType: n, injectionType: o } = i;
		if (n === "variable") return e;
		if (n === "branch") return a(e, { ...Object.entries(r).reduce((e, [n, r]) => (e[n] = n !== "branch" && !n.startsWith("data-") ? oo(r, t) : r, e), {}) });
		if (n === "plural") return a(e, { ...Object.entries(r).reduce((e, [n, r]) => (e[n] = mn(n) || n === "children" ? oo(r, t) : r, e), {}) });
		if (n === "derive") return a(e, {
			...r,
			..."children" in r && { children: so(r.children, t + 1) }
		});
		if (n === "translate" && o === "automatic" && t > 0) return "children" in r ? so(r.children, t) : void 0;
		n === "translate" && o === "automatic" && console.warn(lo);
	}
	return a(e, {
		...r,
		..."children" in r && { children: so(r.children, t) }
	});
}
function oo(e, t) {
	return c(e) ? ao(e, t) : e;
...
function so(e, t) {
	return Array.isArray(e) ? n.map(e, (e) => oo(e, t)) : oo(e, t);
}
function co(e) {
...
var lo = "'@generaltranslation/react-core Warning: A <_T> component was found injected outside of a <Derive> boundary. This may affect translation resolution for this component.";
function uo(e) {
...
var fo = (e) => {
	...
	let r = Object.entries(yn).reduce((e, [n, r]) => {
		let i = t[r];
	...
	let { props: t } = e, n = { t: fo(e) };
	if (t["data-_gt"]) {
		let e = t["data-_gt"], r = e.transformation;
		if (r === "variable") {
			let n = e.variableType || "variable", r = ia(t, n), i = _n(n);
			return {
				i: e.id,
				k: r,
				v: i
		...
		n.i = e.id, n.d = po(r, t, e.branches);
	}
	return t.children && (n.c = go(t.children)), n;
}, ho = (e) => uo(e) ? mo(e) : typeof e == "number" ? e.toString() : e;
function go(e) {
	return Array.isArray(e) ? e.map(ho) : ho(e);
}
function _o({ sourceChildren: e, params: t, locale: n }) {
	let r = vo(e), i = yo(r), a = bo({
		options: xo(t),
		locale: n
	});
	return fa(i, a), {
...
function bo({ options: e, locale: t }) {
	return {
		...e,
		$locale: t
	};
...
function So({ sourceChildren: e, params: t, _locale: n, _enableI18n: r }) {
	let i = Da(), a = Oa(), o = ka(), s = n ?? i, c = r ?? a;
	return {
		defaultLocale: o,
		enableI18n: c,
		locale: s,
		shouldTranslate: c && O().requiresTranslation(s),
		...p(() => _o({
			sourceChildren: e,
			params: t,
			locale: s
...
k._gtt = "translate-client";
function Co({ children: e, _locale: t, _enableI18n: n, _renderPreparedT: r = no, ...i }) {
	let { defaultLocale: a, locale: o, enableI18n: s, targetOptions: c, taggedSourceChildren: l, sourceJsxChildren: u, shouldTranslate: d } = So({
		sourceChildren: e,
		params: i,
		_locale: t,
		_enableI18n: n
	...
	if (O().isDevHotReloadEnabled() && f == null && p.current != null && d) return p.current;
	let h = r({
...
var wo = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/ThemeToggle.tsx";
function To() {
...
function Do() {
	...
	d(() => {
		...
		if (e !== "auto") return;
		let t = window.matchMedia("(prefers-color-scheme: dark)"), n = () => Eo("auto");
	...
	function n() {
		...
		t(n), Eo(n), window.localStorage.setItem("theme", n);
	}
	...
	return C("button", {
		...
		children: e === "auto" ? C(k, { children: "Theme: Auto" }, void 0, !1, {
			fileName: wo,
			lineNumber: 80,
			columnNumber: 9
		}, this) : e === "dark" ? C(k, { children: "Theme: Dark" }, void 0, !1, {
			fileName: wo,
			lineNumber: 82,
			columnNumber: 9
		}, this) : C(k, { children: "Theme: Light" }, void 0, !1, {
			fileName: wo,
			lineNumber: 84,
			columnNumber: 9
		}, this)
...
var Oo = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/LocaleSwitcher.tsx";
function ko() {
	let e = y({ strict: !1 }).locale ?? "en";
	v();
	let t = (e) => {
		try {
	...
	return C("div", {
		...
		children: C("select", {
			...
			children: te.map((e) => C("option", {
				value: e,
				children: C(k, { children: t(e) }, void 0, !1, {
					fileName: Oo,
					lineNumber: 39,
					columnNumber: 13
				}, this)
...
var A = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/Header.tsx";
function jo() {
	Ao("Header");
	let [e, t] = h(!1), n = y({ strict: !1 }).locale ?? "en", r = [
		{
			to: "/$locale/products",
			label: C(k, { children: "Products" }, void 0, !1, {
				fileName: A,
				lineNumber: 17,
				columnNumber: 48
			}, this)
		...
		{
			to: "/$locale/pricing",
			label: C(k, { children: "Pricing" }, void 0, !1, {
				fileName: A,
				lineNumber: 18,
				columnNumber: 47
			}, this)
		...
		{
			to: "/$locale/team",
			label: C(k, { children: "Team" }, void 0, !1, {
				fileName: A,
				lineNumber: 19,
				columnNumber: 44
			}, this)
		...
		{
			to: "/$locale/blog",
			label: C(k, { children: "Blog" }, void 0, !1, {
				fileName: A,
				lineNumber: 20,
				columnNumber: 44
			}, this)
		...
		{
			to: "/$locale/careers",
			label: C(k, { children: "Careers" }, void 0, !1, {
				fileName: A,
				lineNumber: 21,
				columnNumber: 47
			}, this)
		...
		{
			to: "/$locale/faq",
			label: C(k, { children: "FAQ" }, void 0, !1, {
				fileName: A,
				lineNumber: 22,
				columnNumber: 43
			}, this)
		...
		{
			to: "/$locale/contact",
			label: C(k, { children: "Contact" }, void 0, !1, {
				fileName: A,
				lineNumber: 23,
				columnNumber: 47
			}, this)
		...
		{
			to: "/$locale/settings",
			label: C(k, { children: "Settings" }, void 0, !1, {
				fileName: A,
				lineNumber: 24,
				columnNumber: 48
			}, this)
				...
				children: [C(_, {
					...
					children: [
						C(_, {
							...
							className: "nav-link",
							children: C(k, { children: "Home" }, void 0, !1, {
								fileName: A,
								lineNumber: 49,
								columnNumber: 15
							}, this)
						...
						C(_, {
							...
							activeProps: { className: "is-active" },
							className: "nav-link",
							children: C(k, { children: "Methodology" }, void 0, !1, {
								fileName: A,
								lineNumber: 58,
								columnNumber: 15
							}, this)
						...
						C("div", {
							...
							children: [C("button", {
								...
								onMouseLeave: () => t(!1),
								onClick: () => t(!e),
								children: [C(k, { children: "Mock Pages" }, void 0, !1, {
									fileName: A,
									lineNumber: 70,
									columnNumber: 17
								}, this), C(S, {
...
var Mo = 6e4, No = (e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`, Po = "DEFAULT_TERMINATOR_KEY", Fo = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	constructor(e, t = {}) {
		...
		if (!Fo[t.style ?? "ellipsis"]) throw Error(No(t.style ?? "ellipsis"));
		let n, r;
		if (t.maxChars !== void 0) {
			n = t.style ?? "ellipsis";
			let e = new Intl.Locale(this.locale).language;
			r = Fo[n][e] || Fo[n].DEFAULT_TERMINATOR_KEY;
		}
	...
	get(e, ...t) {
		...
		return a === void 0 && (a = new Lo[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}(), Ro = "https://cdn.gtx.dev", zo = {
	GTJSON: ["GTJSON"],
	JSON: ["JSON"],
	PO: ["PO"],
	POT: ["POT", "PO"],
...
function Vo(e) {
	...
	if (!Bo(e.fileFormat, e.transformFormat)) return `Unsupported file format transform: ${e.fileFormat} -> ${e.transformFormat}`;
}
function Ho(e) {
	for (let t of e) {
		let e = Vo(t);
...
function Go(e) {
	...
	if (Array.isArray(e)) {
		let t = "[";
		for (let n = 0; n < e.length; n++) n && (t += ","), t += Go(e[n]) || "null";
		return t + "]";
	}
	let t = Object.keys(e).sort(), n = "";
	for (let r of t) {
...
var Jo = ue({
	...
	__await: () => fs,
	__awaiter: () => is,
	__classPrivateFieldGet: () => ys,
	__classPrivateFieldIn: () => xs,
	...
	__importDefault: () => vs,
	__importStar: () => _s,
	__makeTemplateObject: () => gs,
	__metadata: () => rs,
	__param: () => Qo,
	__propKey: () => ts,
	__read: () => cs,
	__rest: () => Xo,
	__rewriteRelativeImportExtension: () => ws,
	__runInitializers: () => es,
	__setFunctionName: () => ns,
	__spread: () => ls,
	__spreadArray: () => ds,
	__spreadArrays: () => us,
	__values: () => ss,
...
function os(e, t) {
	for (var n in e) n !== "default" && !Object.prototype.hasOwnProperty.call(t, n) && Es(t, e, n);
}
function ss(e) {
...
function fs(e) {
	return this instanceof fs ? (this.v = e, this) : new fs(e);
}
function ps(e, t, n) {
	...
	function l(e) {
		e.value instanceof fs ? Promise.resolve(e.value.v).then(u, d) : f(a[0][2], e);
	}
	function u(e) {
		c("next", e);
	}
...
function hs(e) {
	...
	return t ? t.call(e) : (e = typeof ss == "function" ? ss(e) : e[Symbol.iterator](), n = {}, r("next"), r("throw"), r("return"), n[Symbol.asyncIterator] = function() {
		return this;
	}, n);
	function r(t) {
		n[t] = e[t] && function(n) {
...
function _s(e) {
	...
	var t = {};
	if (e != null) for (var n = Os(e), r = 0; r < n.length; r++) n[r] !== "default" && Es(t, e, n[r]);
	return Ds(t, e), t;
}
function vs(e) {
...
function Cs(e) {
	function t(t) {
		e.error = e.hasError ? new ks(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	function i() {
...
var Ts, M, Es, Ds, Os, ks, As, js = ce((() => {
	...
	}, Es = Object.create ? (function(e, t, n, r) {
		r === void 0 && (r = n);
	...
	}, ks = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
		var r = Error(n);
...
function Hs(e) {
	return !!(e && typeof e == "object" && e.type === Ms.number);
}
function Us(e) {
	return !!(e && typeof e == "object" && e.type === Ms.dateTime);
}
var Ws = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, Gs = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Ks(e) {
	var t = {};
...
function Js(e) {
	...
	for (var t = e.split(qs).filter(function(e) {
		return e.length > 0;
...
var Xs = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, Zs = /^(@+)?(\+|#+)?[rs]?$/g, Qs = /(\*)(0+)|(#+)(0+)|(0+)/g, $s = /^(0+)$/;
function ec(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(Zs, function(e, n, r) {
...
function nc(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !$s.test(e)) throw Error("Malformed concise eng/scientific notation");
	...
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "integer-width":
				...
				i.options[0].replace(Qs, function(e, n, r, i, a, o) {
		...
		if (Xs.test(i.stem)) {
			...
			i.stem.replace(Xs, function(e, n, r, i, a, o) {
			...
			var a = i.options[0];
			a === "w" ? t = M(M({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = M(M({}, t), ec(a)));
			continue;
		}
		if (Zs.test(i.stem)) {
			t = M(M({}, t), ec(i.stem));
...
function oc(e, t) {
	for (var n = "", r = 0; r < e.length; r++) {
		...
		if (i === "j") {
			...
			var o = 1 + (a & 1), s = a < 2 ? 1 : 3 + (a >> 1), c = "a", l = sc(t);
...
function sc(e) {
	...
	var n = e.language, r;
	return n !== "root" && (r = e.maximize().region), (ac[r || ""] || ac[n || ""] || ac[`${n}-001`] || ac["001"])[0];
}
js();
var cc = RegExp(`^${Ws.source}*`), lc = RegExp(`${Ws.source}*\$`);
function F(e, t) {
	return {
		start: e,
		end: t
...
var uc = !!String.prototype.startsWith && "_a".startsWith("a", 1), dc = !!String.fromCodePoint, fc = !!Object.fromEntries, pc = !!String.prototype.codePointAt, mc = !!String.prototype.trimStart, hc = !!String.prototype.trimEnd, gc = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, _c = !0;
try {
	_c = wc("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	_c = !1;
}
var vc = uc ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, yc = dc ? String.fromCodePoint : function() {
	...
	return t;
}, bc = fc ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
var Tc;
if (_c) {
	var Ec = wc("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	Tc = function(e, t) {
		return Ec.lastIndex = t, Ec.exec(e)[1] ?? "";
	};
} else Tc = function(e, t) {
	for (var n = [];;) {
		var r = xc(e, t);
		if (r === void 0 || jc(r) || Mc(r)) break;
		n.push(r), t += r >= 65536 ? 2 : 1;
	}
	return yc.apply(void 0, n);
};
var Dc = function() {
	function e(e, t) {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			} else if (i === 60 && !this.ignoreTag && Oc(this.peek() || 0)) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !Oc(this.char())) return this.error(N.INVALID_TAG, F(o, this.clonePosition()));
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && Ac(this.char());) this.bump();
		...
		return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !kc(this.peek() || 0)) ? (this.bump(), "<") : null;
		...
		return yc.apply(void 0, t);
	}, e.prototype.tryParseUnquoted = function(e, t) {
		if (this.isEOF()) return null;
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), yc(n));
		...
		var e = this.clonePosition(), t = this.offset(), n = Tc(this.message, t), r = t + n.length;
		...
		switch (a) {
			...
			case "time":
				...
				if (s && vc(s?.style, "::", 0)) {
					...
					var m = p;
					this.locale && (m = oc(p, this.locale));
					var u = {
						type: Ms.dateTime,
						pattern: m,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? Ks(m) : {}
					};
					return {
						val: {
		...
		return {
			val: {
				...
				tokens: n,
				location: t,
				parsedOptions: this.shouldParseSkeletons ? ic(n) : {}
			},
			err: null
		};
		...
		if (vc(this.message, e, this.offset())) {
		...
		for (; !this.isEOF() && jc(this.char());) this.bump();
...
function Nc(e) {
	e.forEach(function(e) {
		if (delete e.location, Rs(e) || zs(e)) for (var t in e.options) delete e.options[t].location, Nc(e.options[t].value);
		else Fs(e) && Hs(e.style) || (Is(e) || Ls(e)) && Us(e.style) ? delete e.style.location : Vs(e) && Nc(e.children);
	});
}
function Pc(e, t) {
	t === void 0 && (t = {}), t = M({
	...
	var n = new Dc(e, t).parse();
	if (n.err) {
		var r = SyntaxError(N[n.err.kind]);
		throw r.location = n.err.location, r.originalMessage = n.err.message, r;
	}
	return t?.captureLocation || Nc(n.val), n.val;
}
var Fc = le(((e) => {
	...
	Object.defineProperty(e, "__esModule", { value: !0 }), js(), fe(Jo), Fc();
})), Lc = Fc();
Ic();
function Rc({ icuString: e, shouldVisit: t, visitor: n, options: { recurseIntoVisited: r = !0, ...i } }) {
	let a = Pc(e, i);
	return o(a), a;
	function o(e) {
		e.map(s);
...
var Bc = RegExp(`^${zc}$`);
function Vc(e) {
	return e.type === Lc.TYPE.select && Bc.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === Lc.TYPE.literal);
}
function Hc(e) {
	if (!e.includes("_gt_")) return e;
	let t = [];
...
function Uc(e, t) {
	var n = t && t.cache ? t.cache : $c, r = t && t.serializer ? t.serializer : Zc;
	return (t && t.strategy ? t.strategy : Jc)(e, {
		cache: n,
		serializer: r
	});
}
...
function Jc(e, t) {
	var n = e.length === 1 ? Gc : Kc;
	return qc(e, this, n, t.cache.create(), t.serializer);
}
function Yc(e, t) {
	return qc(e, this, Kc, t.cache.create(), t.serializer);
}
function Xc(e, t) {
	return qc(e, this, Gc, t.cache.create(), t.serializer);
}
var Zc = function() {
...
var nl = function(e) {
	...
	Yo(t, e);
	function t(t, n, r, i) {
		return e.call(this, `Invalid values for "${t}": "${n}". Options are "${Object.keys(r).join("\", \"")}"`, tl.INVALID_VALUE, i) || this;
	}
	return t;
}(nl), il = function(e) {
	Yo(t, e);
	function t(t, n, r) {
		return e.call(this, `Value for "${t}" must be of type ${n}`, tl.INVALID_VALUE, r) || this;
	}
	return t;
}(nl), al = function(e) {
	Yo(t, e);
	function t(t, n) {
		return e.call(this, `The intl string context variable "${t}" was not provided to the string "${n}"`, tl.MISSING_VALUE, n) || this;
	}
	return t;
}(nl), I;
(function(e) {
...
function cl(e, t, n, r, i, a, o) {
	...
	for (var s = [], c = 0, l = e; c < l.length; c++) {
		...
		if (Is(u)) {
			var p = typeof u.style == "string" ? r.date[u.style] : Us(u.style) ? u.style.parsedOptions : void 0;
			s.push({
				type: I.literal,
		...
		if (Ls(u)) {
			var p = typeof u.style == "string" ? r.time[u.style] : Us(u.style) ? u.style.parsedOptions : r.time.medium;
			s.push({
				type: I.literal,
				value: n.getDateTimeFormat(t, p).format(f)
			});
		...
		if (Fs(u)) {
			var p = typeof u.style == "string" ? r.number[u.style] : Hs(u.style) ? u.style.parsedOptions : void 0;
		...
		if (Vs(u)) {
			...
			if (!sl(g)) throw new il(h, "function", o);
			var _ = g(cl(m, t, n, r, i, a).map(function(e) {
				return e.value;
			}));
...
function fl(e) {
	return e === void 0 && (e = {
		...
		getNumberFormat: Uc(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.NumberFormat).bind.apply(e, ds([void 0], t, !1)))();
		}, {
			cache: dl(e.number),
			strategy: el.variadic
		}),
		getDateTimeFormat: Uc(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.DateTimeFormat).bind.apply(e, ds([void 0], t, !1)))();
		}, {
			cache: dl(e.dateTime),
			strategy: el.variadic
		}),
		getPluralRules: Uc(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.PluralRules).bind.apply(e, ds([void 0], t, !1)))();
		}, {
			cache: dl(e.pluralRules),
			strategy: el.variadic
		})
	};
}
var pl = function() {
	function e(t, n, r, i) {
		...
		if (this.formatterCache = {
			...
			return cl(a.ast, a.locales, a.formatters, a.formats, e, void 0, a.message);
		...
		this.formats = ul(e.formats, r), this.formatters = i && i.formatters || fl(this.formatterCache);
	}
	...
	try {
		...
		})() || j.get("DisplayNames", ["en"], { type: "language" }).of(t) === t && !hl(t) || n && j.get("DisplayNames", ["en"], { type: "region" }).of(n) === n || r && j.get("DisplayNames", ["en"], { type: "script" }).of(r) === r && !ml.includes(r));
	} catch {
		return !1;
	}
}, R = (e) => {
...
function _l(...e) {
	try {
		let t = e.flat().map(R);
		for (let e = 0; e < t.length; e++) for (let n = e + 1; n < t.length; n++) if (!gl(t[e], t[n])) return !1;
		return !0;
	} catch (e) {
		return console.error(e), !1;
	}
...
function yl(e, t, n, r) {
	return !(!L(e, r) || !L(t, r) || n && n.some((e) => !L(e, r)) || _l(e, t) || n && !n.some((e) => vl(t, e)));
}
var bl = (e, t, n) => {
	if (e?.[t]) return typeof e[t] == "string" ? n === "name" ? e[t] : void 0 : e[t][n];
}, xl = (e, t) => !!(t?.[e] && typeof t[e] == "object" && "code" in t[e] && t[e].code && L(t[e].code));
function Sl(e, t) {
	let n = e;
	t && xl(e, t) && (e = t[e].code);
	try {
		...
		if (s) return s;
		let c = i.maximize();
		return El[c.language] || Al(c.region || "");
	} catch {
		return Tl;
	}
}
var Cl = "🌍", wl = "🌏", Tl = Cl, El = {
	...
	EU: "🇪🇺",
	419: "🌎"
}, Ol = /* @__PURE__ */ new Set(/* @__PURE__ */ "AF.AX.AL.DZ.AS.AD.AO.AI.AQ.AG.AR.AM.AW.AU.AT.AZ.BS.BH.BD.BB.BY.BE.BZ.BJ.BM.BT.BO.BQ.BA.BW.BV.BR.IO.BN.BG.BF.BI.CV.KH.CM.CA.KY.CF.TD.CL.CN.CX.CC.CO.KM.CD.CG.CK.CR.CI.HR.CU.CW.CY.CZ.DK.DJ.DM.DO.EC.EG.SV.GQ.ER.EE.SZ.ET.FK.FO.FJ.FI.FR.GF.PF.TF.GA.GM.GE.DE.GH.GI.GR.GL.GD.GP.GU.GT.GG.GN.GW.GY.HT.HM.VA.HN.HK.HU.IS.IN.ID.IR.IQ.IE.IM.IL.IT.JM.JP.JE.JO.KZ.KE.KI.KP.KR.KW.KG.LA.LV.LB.LS.LR.LY.LI.LT.LU.MO.MG.MW.MY.MV.ML.MT.MH.MQ.MR.MU.YT.MX.FM.MD.MC.MN.ME.MS.MA.MZ.MM.NA.NR.NP.NL.NC.NZ.NI.NE.NG.NU.NF.MK.MP.NO.OM.PK.PW.PS.PA.PG.PY.PE.PH.PN.PL.PT.PR.QA.RE.RO.RU.RW.BL.SH.KN.LC.MF.PM.VC.WS.SM.ST.SA.SN.RS.SC.SL.SG.SX.SK.SI.SB.SO.ZA.GS.SS.ES.LK.SD.SR.SJ.SE.CH.SY.TW.TJ.TZ.TH.TL.TG.TK.TO.TT.TN.TR.TM.TC.TV.UG.UA.AE.GB.US.UM.UY.UZ.VU.VE.VN.VG.VI.WF.EH.YE.ZM.ZW".split(".")), kl = 127397;
function Al(e) {
	return jl(e) || "🌍";
}
function jl(e) {
	let t = e.toUpperCase(), n = Dl[t];
	if (n) return n;
	if (Ol.has(t)) return String.fromCodePoint(t.charCodeAt(0) + kl, t.charCodeAt(1) + kl);
}
function Ml(e, t) {
	if (t) {
		let n = {};
...
function Nl(e, t = "en", n) {
	let r = e;
	n && xl(e, n) && (e = n[e].code), t ||= "en";
	try {
		let i = R(e), a = j.get("Locale", e), o = a.language, s = Ml([
			r,
			e,
			i,
			o
			...
			t,
			"en"
		], g = j.get("DisplayNames", m, { type: "language" }), _ = j.get("DisplayNames", h, { type: "language" }), v = s?.name, y = s?.nativeName || s?.name, b = v || g.of(e) || e, x = y || _.of(e) || e, S = s?.maximizedName || v || g.of(u) || e, C = s?.nativeMaximizedName || y || _.of(u) || e, ee = s?.minimizedName || v || g.of(p) || e, te = s?.nativeMinimizedName || y || _.of(p) || e, w = s?.languageName || v || g.of(o) || e, ne = s?.nativeLanguageName || y || _.of(o) || e, re = s?.nameWithRegionCode || c ? `${w} (${c})` : b, ie = s?.nativeNameWithRegionCode || (c ? `${ne} (${c})` : x) || re, ae = j.get("DisplayNames", m, { type: "region" }), oe = j.get("DisplayNames", h, { type: "region" }), se = s?.regionName || (d ? ae.of(d) : "") || "", ce = s?.nativeRegionName || (d ? oe.of(d) : "") || "", le = j.get("DisplayNames", m, { type: "script" }), ue = j.get("DisplayNames", h, { type: "script" });
		return {
			code: i,
			name: b,
			nativeName: x,
		...
		let t = L(e) ? R(e) : e, r = t?.split("-"), i = r?.[0] || t || "", a = r.length > 2 ? r?.[2] : r?.[1] || "", o = r?.[3] || "", s = Ml([t, i], n);
		t = s?.code || t;
		let c = s?.name || t, l = s?.nativeName || c, u = s?.maximizedCode || t, d = s?.maximizedName || c, f = s?.nativeMaximizedName || l, p = s?.minimizedCode || t, m = s?.minimizedName || c, h = s?.nativeMinimizedName || l;
		i = s?.languageCode || i;
		let g = s?.languageName || c, _ = s?.nativeLanguageName || l;
...
function Pl(e, t, n) {
	...
	for (let n of e) {
		let e = t.filter((e) => vl(n, e)), r = ({ locale: t, languageCode: n, minimizedCode: r, regionCode: i, scriptCode: a }) => {
			let o = [
				t,
				`${n}-${i}`,
				`${n}-${a}`,
...
var zl = class {
	...
	handle(e) {
		let t = [];
		this.config.includeTimestamp && t.push(`[${e.timestamp.toISOString()}]`);
		let n = Il[e.level], r = `[${e.level.toUpperCase()}]`;
		t.push(`${n}${r}${Ll}`), this.config.prefix && t.push(`[${this.config.prefix}]`), this.config.includeContext && e.context && t.push(`[${e.context}]`), t.push(e.message), e.metadata && Object.keys(e.metadata).length > 0 && t.push(`\n  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
		let i = t.join(" ");
		switch (e.level) {
			case "debug":
				console.debug(i);
	...
	constructor(e = {}) {
		this.config = {
			...
			handlers: [],
			...e
		}, this.handlers = [...this.config.handlers || []], this.config.enableConsole && this.handlers.push(new zl(this.config));
	}
	addHandler(e) {
		this.handlers.push(e);
	}
	...
	shouldLog(e) {
		return Fl[e] >= Fl[this.config.level];
	}
	log(e, t, n, r) {
		if (!this.shouldLog(e)) return;
		let i = {
...
Hl.child("validation"), Hl.child("formatting"), Hl.child("locale");
var Wl = Hl.child("GT instance");
function Gl({ value: e, locales: t = "en", options: n = {} }) {
	return j.get("CutoffFormat", t, n).format(e);
}
function Kl(e, t = "en", n = {}) {
	return new pl(e, t).format(n)?.toString() ?? "";
}
function ql(e) {
	return e;
}
...
function Yl({ value: e, locales: t = ["en"], options: n = {} }) {
...
function Xl({ value: e, locales: t = ["en"], currency: n = "USD", options: r = {} }) {
	return j.get("NumberFormat", t, {
		style: "currency",
		currency: n,
		numberingSystem: "latn",
...
function eu({ date: e, baseDate: t, locales: n = ["en"], options: r = {} }) {
	let { value: i, unit: a } = $l(e, t);
	return tu({
		value: i,
		unit: a,
		locales: n,
...
function tu({ value: e, unit: t, locales: n = ["en"], options: r = {} }) {
...
function ru(e) {
	try {
		let t = ou(j.get("Locale", e));
		if (t) return t;
	} catch {}
	let { scriptCode: t, languageCode: n } = Nl(e);
	return t ? su(t) ? "rtl" : "ltr" : n && cu(n) ? "rtl" : "ltr";
}
...
function cu(e) {
	return e ? au.has(e.toLowerCase()) : !1;
}
function lu(e, t) {
	try {
...
var fu = class {
	...
	formatMessage(e, t, n = {}) {
		let { locales: r, variables: i, dataFormat: a } = n;
		return a === "STRING" ? ql(e) : Kl(e, this.getFormattingLocales(t, r), i);
	}
	formatList(e, t, n = {}) {
		let { locales: r, ...i } = n;
		return Zl({
	...
	getLocaleName(e) {
		return nu(e, this.defaultLocale, this.customMapping);
	}
	getLocaleEmoji(e) {
		return Sl(e, this.customMapping);
	}
	getLocaleProperties(e) {
		return Nl(e, this.defaultLocale, this.customMapping);
	}
	requiresTranslation(e, t = this.defaultLocale, n = this.translationLocales) {
		return yl(this.resolveCanonicalLocale(t), this.resolveCanonicalLocale(e), n ? this.resolveCanonicalLocaleList(n) : void 0, this.customMapping);
	}
	determineLocale(e, t = this.locales) {
		let n = t.map((e) => ({
			locale: e,
			canonicalLocale: this.resolveCanonicalLocale(e)
		})), r = Pl(Array.isArray(e) ? this.resolveCanonicalLocaleList(e) : this.resolveCanonicalLocale(e), n.map(({ canonicalLocale: e }) => e), this.customMapping);
		if (r) return n.find(({ canonicalLocale: e }) => e === r)?.locale || this.resolveAliasLocale(r);
	}
	getLocaleDirection(e) {
		return ru(this.resolveCanonicalLocale(e));
	}
	isValidLocale(e) {
		return L(e, this.customMapping);
	}
	resolveCanonicalLocale(e) {
		return du(e, this.customMapping);
	}
	resolveAliasLocale(e) {
	...
	isSameLanguage(...e) {
		return vl(...this.resolveCanonicalLocaleArgs(e));
	}
	isSupersetLocale(e, t) {
		return lu(this.resolveCanonicalLocale(e), this.resolveCanonicalLocale(t));
	}
};
function pu(e, t) {
	return L(e, t);
...
function yu({ source: e, context: t, id: n, maxChars: r, dataFormat: i }, a = vu) {
	let o;
	return o = i === "JSX" ? xu(e) : e, a(Ko({
		source: o,
		...n && { id: n },
		...t && { context: t },
		...r != null && { maxChars: Math.abs(r) },
...
var bu = (e) => {
	if (e && typeof e == "object") {
		let t = {};
		if ("c" in e && e.c && (t.c = xu(e.c)), "d" in e) {
			let n = e?.d;
			n?.b && (t.b = Object.fromEntries(Object.entries(n.b).map(([e, t]) => [e, xu(t)]))), n?.t && (t.t = n.t);
		}
		return qo(e) ? {
			k: e.k,
			...e.v && { v: e.v }
...
function xu(e) {
	return Array.isArray(e) ? e.map(bu) : bu(e);
}
var Su = "GT Error:", Cu = (e) => `${Su} Translation request timed out after ${e}ms.`, wu = (e) => `${Su} Translation request failed. Error: ${e}`, Tu = (e, t, n) => `${Su} API returned error status. Status: ${e}, Status Text: ${t}, Error: ${n}`, Eu = (e) => `${Su} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a targetLocale in the GT constructor.`, Du = (e) => `${Su} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a sourceLocale in the GT constructor.`, Ou = (e) => `${Su} Cannot call \`${e}\` without a specified project ID. Either pass a project ID to the \`${e}\` function or specify a projectId in the GT constructor.`, ku = (e) => `${Su} Cannot call \`${e}\` without a specified API key. Either pass an API key to the \`${e}\` function or specify an apiKey in the GT constructor.`, Au = (e) => `${Su} Invalid locale: ${e}.`, ju = (e) => `${Su} Invalid locales: ${e.join(", ")}.`;
...
async function Nu(e) {
	if (!e.ok) {
		...
		throw new _u(Tu(e.status, e.statusText, t), e.status, t);
	}
}
function Pu(e, t) {
	...
	let n = wu(e instanceof Error ? e.message : String(e));
	throw Ul.error(n), e;
}
var Fu = "2026-03-06.v1";
function Iu(e, t = !1) {
	let n = {
		...!t && { "Content-Type": "application/json" },
		"x-gt-project-id": e.projectId
	};
	return e.apiKey && (e.apiKey.startsWith("gtx-internal-") ? n["x-gt-internal-api-key"] = e.apiKey : n["x-gt-api-key"] = e.apiKey), n["gt-api-version"] = Fu, n;
}
var Lu = 3, Ru = 500;
function zu(e) {
...
function Bu(e, t) {
	switch (e) {
		case "linear": return Ru * (t + 1);
		case "exponential": return Ru * 2 ** t;
		default: return 0;
	}
}
async function z(e, t, n) {
	let r = n?.timeout ?? 6e4, i = `${e.baseUrl || "https://api2.gtx.dev"}${t}`, a = n?.method ?? "POST", o = n?.retryPolicy ?? "exponential", s = o === "none" ? 0 : Lu, c = {
		method: a,
		headers: Iu(e)
	};
	...
	for (let e = 0; e <= s; e++) {
		...
		return await Nu(t), await t.json();
	}
	throw Error("Max retries exceeded");
}
async function Vu(e, t, n, r) {
	let i = Array.isArray(e), a = i ? [] : void 0, o = {}, s = i ? e.map((e) => [void 0, e]) : Object.entries(e);
	for (let [e, t] of s) {
		let { source: n, metadata: r } = typeof t == "string" ? { source: t } : t, i = e ?? r?.hash ?? yu({
			source: n,
			dataFormat: r?.dataFormat ?? "STRING",
			...r ?? {}
		});
...
async function qu(e, t, n) {
	return Wu(e, async (e) => (await z(n, "/v2/project/files/download", {
		body: e,
		timeout: t.timeout
	})).files.map((e) => ({
		...e,
...
async function Ju(e, t, n = {}) {
	return await Wu(e.diffs, async (e) => (await z(t, "/v2/project/files/diffs", {
		body: { diffs: e },
		timeout: n.timeout
	}), [{ success: !0 }]), { batchSize: 100 }), { success: !0 };
}
function Yu(e, t = "en", n) {
	t ||= "en";
	try {
		return {
			code: e,
...
async function Xu(e, t, n) {
	return Wu(e, async (e) => (await z(n, "/v2/project/files/upload-files", {
		body: {
			data: e.map(({ source: e }) => ({ source: {
				content: Uo(e.content),
				fileName: e.fileName,
...
async function Zu(e, t, n) {
	return Ho(e.map(({ source: e }) => e)), Wu(e, async (e) => (await z(n, "/v2/project/files/upload-translations", {
		body: {
...
async function $u(e, t, n) {
	let { baseUrl: r } = n, i = t.timeout ? t.timeout : Mo, a = `${r || "https://api2.gtx.dev"}/v2/project/info/${encodeURIComponent(e)}`, o;
	try {
		o = await Mu(a, {
			method: "GET",
			headers: Iu(n)
	...
	return await Nu(o), await o.json();
}
...
async function ad(e, t, n) {
	...
	let r = await Wu(e, async (e) => (await z(n, "/v2/project/files/moves", {
		body: {
			branchId: t.branchId,
			moves: e
		},
...
async function od(e, t, n = {}, r) {
	...
	let a = Uu(t, 100), o = await Promise.all(a.map((e) => i(e)));
...
var cd = class {
	...
	setConfig({ apiKey: e, devApiKey: t, sourceLocale: n, targetLocale: r, locales: i, projectId: a, customMapping: o, baseUrl: s }) {
		if (e && (this.apiKey = e), t && (this.devApiKey = t), a && (this.projectId = a), n && (this.sourceLocale = R(n), !L(this.sourceLocale, o))) throw Error(Au(this.sourceLocale));
		if (r && (this.targetLocale = R(r), !L(this.targetLocale, o))) throw Error(Au(this.targetLocale));
		if (i) {
			let e = [], t = [];
			if (i.forEach((n) => {
				let r = R(n);
				L(r) ? e.push(r) : t.push(n);
			}), t.length > 0) throw Error(ju(t));
			this.locales = e;
		}
		s && (this.baseUrl = s), o && (this.customMapping = o, this.reverseCustomMapping = Object.fromEntries(Object.entries(o).filter(([, e]) => e && typeof e == "object" && "code" in e).map(([e, t]) => [t.code, e]))), this._localeConfig = new fu({
			defaultLocale: this.sourceLocale,
			locales: this.locales ?? [],
			customMapping: this.customMapping
		});
	...
	async queryBranchData(e) {
		return this._validateAuth("queryBranchData"), await rd(e, this._getTranslationConfig());
	}
	async createBranch(e) {
		return this._validateAuth("createBranch"), await id(e, this._getTranslationConfig());
	}
	async processFileMoves(e, t = {}) {
		return this._validateAuth("processFileMoves"), await ad(e, t, this._getTranslationConfig());
	}
	async getOrphanedFiles(e, t, n = {}) {
		return this._validateAuth("getOrphanedFiles"), await od(e, t, n, this._getTranslationConfig());
	}
	async setupProject(e, t) {
		return this._validateAuth("setupProject"), t = {
			...t,
			locales: t?.locales?.map((e) => this.resolveCanonicalLocale(e))
		}, await Hu(e, this._getTranslationConfig(), t);
	}
	async checkJobStatus(e, t) {
		return this._validateAuth("checkJobStatus"), await ed(e, this._getTranslationConfig(), t);
	}
	async awaitJobs(e, t) {
		return this._validateAuth("awaitJobs"), await td(e, t, this._getTranslationConfig());
	}
	async enqueueFiles(e, t) {
		...
		}, await Gu(e, n, this._getTranslationConfig());
	}
	async createTag(e) {
		return this._validateAuth("createTag"), await Ku(e, this._getTranslationConfig());
	}
	async publishFiles(e) {
		return this._validateAuth("publishFiles"), await sd(e, this._getTranslationConfig());
	}
	async submitUserEditDiffs(e) {
		this._validateAuth("submitUserEditDiffs"), await Ju({
			...e,
			diffs: (e.diffs || []).map((e) => ({
				...e,
	...
	async queryFileData(e, t = {}) {
		...
		let n = await nd(e, t, this._getTranslationConfig());
	...
	async getProjectData(e, t = {}) {
		...
		let n = await $u(e, t, this._getTranslationConfig());
	...
	async downloadFile(e, t = {}) {
		return this._validateAuth("downloadTranslatedFile"), (await qu([{
			fileId: e.fileId,
			branchId: e.branchId,
	...
	async uploadSourceFiles(e, t) {
		...
		let r = await Xu(e, n, this._getTranslationConfig());
		return {
	...
	async uploadTranslations(e, t) {
		...
		if (!n.sourceLocale) {
			let e = Du("uploadTranslations");
			throw Wl.error(e), Error(e);
		}
		let r = await Zu(e.map((e) => ({
			...e,
	...
	getLocaleName(e = this.targetLocale) {
		if (!e) throw Error(Eu("getLocaleName"));
		return this.localeConfig.getLocaleName(e);
	}
	getLocaleEmoji(e = this.targetLocale) {
		if (!e) throw Error(Eu("getLocaleEmoji"));
		return this.localeConfig.getLocaleEmoji(e);
	}
	getLocaleProperties(e = this.targetLocale) {
		if (!e) throw Error(Eu("getLocaleProperties"));
		return this.localeConfig.getLocaleProperties(e);
	}
	getRegionProperties(e = this.getLocaleProperties().regionCode, t) {
		if (!t) {
		...
		return Yu(e, this.targetLocale, t);
	}
	requiresTranslation(e = this.sourceLocale, t = this.targetLocale, n = this.locales, r = this.customMapping) {
		if (!e) throw Error(Du("requiresTranslation"));
		if (!t) throw Error(Eu("requiresTranslation"));
		return r === this.customMapping ? this.localeConfig.requiresTranslation(t, e, n) : yl(e, t, n, r);
	}
	determineLocale(e, t = this.locales || [], n = this.customMapping) {
		return n === this.customMapping ? this.localeConfig.determineLocale(e, t ?? []) : Pl(e, t, n);
	}
	getLocaleDirection(e = this.targetLocale) {
		if (!e) throw Error(Eu("getLocaleDirection"));
		return this.localeConfig.getLocaleDirection(e);
	}
	isValidLocale(e = this.targetLocale, t = this.customMapping) {
		if (!e) throw Error(Eu("isValidLocale"));
		return t === this.customMapping ? this.localeConfig.isValidLocale(e) : L(e, t);
	}
	resolveCanonicalLocale(e = this.targetLocale, t = this.customMapping) {
		if (!e) throw Error(Eu("resolveCanonicalLocale"));
		return t === this.customMapping ? this.localeConfig.resolveCanonicalLocale(e) : du(e, t);
	}
	resolveAliasLocale(e, t = this.customMapping) {
		if (!e) throw Error(Eu("resolveAliasLocale"));
		return t === this.customMapping ? this.localeConfig.resolveAliasLocale(e) : uu(e, t);
	}
	standardizeLocale(e = this.targetLocale) {
		if (!e) throw Error(Eu("standardizeLocale"));
		return this.localeConfig.standardizeLocale(e);
	}
	isSameDialect(...e) {
		return this.localeConfig.isSameDialect(...e);
...
function md(e, t = "", n = !0) {
	if (e.forEach((e) => {
		switch (e.type) {
			case "error":
				gu.error(t + e.message);
				break;
			case "warning": gu.warn(t + e.message);
		}
...
function xd(e) {
	let t = [];
	return t.push(...gd(e)), t.push(...vd(e)), t.push(...bd(e)), t;
}
var Sd = class {}, Cd = "fallback-storage-adapter", wd = class extends Sd {
	constructor(...e) {
...
function Dd(e) {
	let { cacheUrl: t = Ro, projectId: n, _versionId: r, _branchId: i } = e, a = r ? `/${r}` : "", o = i ? `?branchId=${i}` : "";
	return `${t}/${n}/[locale]` + a + o;
}
function Od() {
	return async (e) => ({});
}
function kd({ type: e, remoteTranslationLoaderParams: t, loadTranslations: n }) {
	e === "disabled" && gu.warn("I18nManager: No translation loader found. No translations will be loaded.");
	let { cacheUrl: r, projectId: i, _versionId: a, _branchId: o, customMapping: s } = t;
	switch (e) {
		case "remote":
		case "gt-remote": return Ed({
			cacheUrl: r || "",
			projectId: i || "",
			_versionId: a,
			_branchId: o,
...
var Md = 25, Nd = 100, Pd = 50, Fd = class extends Ad {
	...
	genKey(e) {
		return jd(e.message, e.options);
	}
	fallback(e) {
		let t = this._enqueueTranslation(e);
		return this._queue.length >= Md ? this._flushNow() : this._scheduleBatch(), t;
	}
	_flushNow() {
	...
	_drainQueue() {
		for (; this._queue.length > 0 && this._activeRequests < Nd;) {
			let e = this._queue.splice(0, Md);
	...
	async _sendBatchRequest(e) {
		...
		let t = Id(e), n = await this._sendBatchRequestWithErrorHandling(e, t);
...
var Ld = 6e4, Rd = class extends Ad {
	constructor({ init: e = {}, ttl: t, loadTranslations: n, createTranslateMany: r, lifecycle: { onLocalesCacheHit: i, onLocalesCacheMiss: a, onTranslationsCacheHit: o, onTranslationsCacheMiss: s } }) {
		super(e, {
			onHit: i,
			onMiss: a
		}), this.ttl = Ld, this.ttl = t === null ? -1 : t ?? 6e4, this._translationLoader = n, this._createTranslateMany = r, this._onTranslationsCacheHit = o, this._onTranslationsCacheMiss = s;
	}
	get(e) {
		let t = this.getCache(e);
...
function Vd({ onLocalesCacheHit: e, onLocalesCacheMiss: t, onTranslationsCacheHit: n, onTranslationsCacheMiss: r }, i) {
...
var Hd = 12e3, Ud = class extends Bd {
	constructor(e) {
		super(), this.resolveTranslationSync = (e, t = {}) => this.lookupTranslation(e, t), md(xd(e), "I18nManager: "), this.config = Wd(e), this.localeConfig = new fu({
			defaultLocale: this.config.defaultLocale,
			locales: this.config.locales,
			customMapping: this.config.customMapping
		}), this.storeAdapter = e.storeAdapter ?? new wd();
		let t = Jd(e), n = Td(this.getGTClassClean(), Hd);
		Vd(e.lifecycle ?? {}, (...e) => this.subscribe(...e)), this.localesCache = new Rd({
			loadTranslations: t,
			createTranslateMany: n,
			lifecycle: zd((...e) => this.emit(...e))
		});
	}
	...
	getLocale() {
		return this.storeAdapter.getItem("locale") || (gu.warn("getLocale() invoked outside of translation context, falling back to default locale"), this.config.defaultLocale);
	}
	setLocale(e) {
		try {
	...
	async getLookupTranslation(e = this.getLocale(), t = []) {
		try {
			...
			let r = qd(t, n, (e) => this.resolveLocale(e));
			r.length !== t.length && gu.warn(`I18nManager: getLookupTranslation(): prefetchEntries must all be the same locale, ignoring all entries that are not for ${n}`);
			let i = this.localesCache.get(n);
	...
	handleError(e) {
		switch (this.config.environment) {
			...
			default: gu.error("I18nManager: " + e);
		}
	}
	resolveLocale(e) {
...
function Gd({ defaultLocale: e, locales: t, customMapping: n }) {
	return {
		defaultLocale: e,
...
function Kd(e) {
	return {
		defaultLocale: hu(e.defaultLocale),
		locales: e.locales.map((t) => (typeof e.customMapping?.[t] == "string" ? e.customMapping?.[t] : e.customMapping?.[t]?.code) ? t : hu(t)),
		customMapping: Object.fromEntries(Object.entries(e.customMapping || {}).map(([e, t]) => [e, typeof t == "string" ? hu(t) : {
			...t,
			...t.code ? { code: hu(t.code) } : {}
		}]))
	};
}
function qd(e, t, n) {
...
var Yd = void 0;
function Xd() {
	return Yd ||= (gu.warn("getI18nManager(): Translation failed because I18nManager not initialized."), new Ud({
		defaultLocale: "en",
		locales: ["en"]
	})), Yd;
}
...
var Qd = "DEFAULT_TERMINATOR_KEY", $d = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	CutoffFormat: class {
		constructor(e, t = {}) {
			...
			if (!$d[t.style ?? "ellipsis"]) throw Error(((e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`)(t.style ?? "ellipsis"));
			let n, r;
			if (t.maxChars !== void 0) {
				n = t.style ?? "ellipsis";
				let e = new Intl.Locale(this.locale).language;
				r = $d[n][e] || $d[n].DEFAULT_TERMINATOR_KEY;
			}
			let i = t.terminator ?? r?.terminator, a = i == null ? void 0 : t.separator ?? r?.separator;
			this.additionLength = (i?.length ?? 0) + (a?.length ?? 0), t.maxChars !== void 0 && Math.abs(t.maxChars) < this.additionLength && (i = void 0, a = void 0), this.options = {
				maxChars: t.maxChars,
...
new class {
	...
	get(e, ...t) {
		let [n = "en", r = {}] = t, i = this._generateKey(n, r), a = this.cache[e]?.[i];
		return a === void 0 && (a = new ef[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}();
function tf(e, t, n = "") {
...
var lf = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = af(this.buffer);
	}
	update(e) {
		nf(this), tf(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		nf(this), function(e, t) {
			tf(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, rf(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = af(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), ff = /* @__PURE__ */ new Uint32Array(64), pf = class extends lf {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) ff[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = ff[e - 15], n = ff[e - 2], r = of(t, 7) ^ of(t, 18) ^ t >>> 3, i = of(n, 17) ^ of(n, 19) ^ n >>> 10;
			ff[e] = i + ff[e - 7] + r + ff[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (of(o, 6) ^ of(o, 11) ^ of(o, 25)) + sf(o, s, c) + df[e] + ff[e] | 0, u = (of(n, 2) ^ of(n, 13) ^ of(n, 22)) + cf(n, r, i) | 0;
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), rf(this.buffer);
	}
}, mf = class extends pf {
	A = 0 | uf[0];
	B = 0 | uf[1];
...
(function(e, t = {}) {
	let n = (t, n) => e(n).update(t).digest(), r = e(void 0);
	return n.outputLen = r.outputLen, n.blockLen = r.blockLen, n.canXOF = r.canXOF, n.create = (t) => e(t), Object.assign(n, t), Object.freeze(n);
})(() => new mf(), (hf = 1, { oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
var hf, gf = function(e, t) {
	return gf = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, gf(e, t);
...
function _f(e, t) {
	...
	gf(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var B = function() {
...
var Of = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function kf(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || Of(t, e, n);
}
function Af(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function Mf() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(jf(arguments[t]));
	return e;
}
function Nf() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function Ff(e) {
	return this instanceof Ff ? (this.v = e, this) : new Ff(e);
}
function If(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof Ff ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function Rf(e) {
	...
	return n ? n.call(e) : (e = Af(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var Bf = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return Vf = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, Vf(e);
...
function Hf(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = Vf(e), r = 0; r < n.length; r++) n[r] !== "default" && Of(t, e, n[r]);
	return Bf(t, e), t;
}
function Uf(e) {
	return e && e.__esModule ? e : { default: e };
...
var Jf = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function Yf(e) {
	function t(t) {
		e.error = e.hasError ? new Jf(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var $f = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, ep = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function tp(e) {
	var t = {};
	return e.replace(ep, function(e) {
		var n = e.length;
		switch (e[0]) {
			case "G":
				t.era = n === 4 ? "long" : n === 5 ? "narrow" : "short";
...
var ip = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, ap = /^(@+)?(\+|#+)?[rs]?$/g, op = /(\*)(0+)|(#+)(0+)|(0+)/g, sp = /^(0+)$/;
function cp(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(ap, function(e, n, r) {
		return typeof r == "string" ? r === "+" ? t.minimumSignificantDigits = n.length : n[0] === "#" ? t.maximumSignificantDigits = n.length : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length + (typeof r == "string" ? r.length : 0)) : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length), "";
	}), t;
}
function lp(e) {
...
function up(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !sp.test(e)) throw Error("Malformed concise eng/scientific notation");
		t.minimumIntegerDigits = e.length;
	}
	return t;
}
...
function fp(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "measure-unit":
			case "unit":
				t.style = "unit", t.unit = rp(i.options[0]);
				continue;
			case "compact-short":
			case "K":
				t.notation = "compact", t.compactDisplay = "short";
			...
			case "integer-width":
				if (i.options.length > 1) throw RangeError("integer-width stems only accept a single optional option");
				i.options[0].replace(op, function(e, n, r, i, a, o) {
					if (n) t.minimumIntegerDigits = r.length;
					else {
		...
		if (sp.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
		else if (ip.test(i.stem)) {
			if (i.options.length > 1) throw RangeError("Fraction-precision stems only accept a single optional option");
			i.stem.replace(ip, function(e, n, r, i, a, o) {
				return r === "*" ? t.minimumFractionDigits = n.length : i && i[0] === "#" ? t.maximumFractionDigits = i.length : a && o ? (t.minimumFractionDigits = a.length, t.maximumFractionDigits = a.length + o.length) : (t.minimumFractionDigits = n.length, t.maximumFractionDigits = n.length), "";
			});
			var a = i.options[0];
			a === "w" ? t = B(B({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = B(B({}, t), cp(a)));
		} else if (ap.test(i.stem)) t = B(B({}, t), cp(i.stem));
		else {
			var o = lp(i.stem);
			o && (t = B(B({}, t), o));
			var s = up(i.stem);
...
function mp(e) {
	...
	var n, r = e.language;
	return r !== "root" && (n = e.maximize().region), (pp[n || ""] || pp[r || ""] || pp[`${r}-001`] || pp["001"])[0];
}
var hp = RegExp(`^${$f.source}*`), gp = RegExp(`${$f.source}*\$`);
function U(e, t) {
	return {
		start: e,
		end: t
...
var _p = !!String.prototype.startsWith && "_a".startsWith("a", 1), vp = !!String.fromCodePoint, yp = !!Object.fromEntries, bp = !!String.prototype.codePointAt, xp = !!String.prototype.trimStart, Sp = !!String.prototype.trimEnd, Cp = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, wp = !0;
try {
	wp = Mp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	wp = !1;
}
var Tp, Ep = _p ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, Dp = vp ? String.fromCodePoint : function() {
	...
	return n;
}, Op = yp ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
if (wp) {
	var Np = Mp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	Tp = function(e, t) {
		return Np.lastIndex = t, Np.exec(e)[1] ?? "";
	};
} else Tp = function(e, t) {
	for (var n = [];;) {
		var r = kp(e, t);
		if (r === void 0 || Ip(r) || Lp(r)) break;
		n.push(r), t += r >= 65536 ? 2 : 1;
	}
	return Dp.apply(void 0, n);
};
(function() {
	function e(e, t) {
		t === void 0 && (t = {}), this.message = e, this.position = {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			if (i === 123) {
				...
				if (i !== 35 || t !== "plural" && t !== "selectordinal") {
					...
					if (i === 60 && !this.ignoreTag && Pp(this.peek() || 0)) {
		...
		if (this.bumpIf(">")) {
			...
			var a = i.val, o = this.clonePosition();
			if (this.bumpIf("</")) {
				if (this.isEOF() || !Pp(this.char())) return this.error(V.INVALID_TAG, U(o, this.clonePosition()));
				var s = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					val: {
						type: H.tag,
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && Fp(this.char());) this.bump();
		return this.message.slice(e, this.offset());
	}, e.prototype.parseLiteral = function(e, t) {
		for (var n = this.clonePosition(), r = "";;) {
			var i = this.tryParseQuote(t);
		...
		return this.isEOF() || this.char() !== 60 || !this.ignoreTag && (Pp(e = this.peek() || 0) || e === 47) ? null : (this.bump(), "<");
		var e;
	}, e.prototype.tryParseQuote = function(e) {
		if (this.isEOF() || this.char() !== 39) return null;
		switch (this.peek()) {
		...
		return Dp.apply(void 0, t);
	}, e.prototype.tryParseUnquoted = function(e, t) {
		if (this.isEOF()) return null;
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), Dp(n));
	}, e.prototype.parseArgument = function(e, t) {
		var n = this.clonePosition();
		...
		var e = this.clonePosition(), t = this.offset(), n = Tp(this.message, t), r = t + n.length;
		return this.bumpTo(r), {
			value: n,
		...
		switch (a) {
			...
			case "time":
				...
				if (this.bumpIf(",")) {
					...
					if ((f = jp(g.val)).length === 0) return this.error(V.EXPECT_ARGUMENT_STYLE, U(this.clonePosition(), this.clonePosition()));
					s = {
						style: f,
				...
				if (s && Ep(s?.style, "::", 0)) {
					...
					this.locale && (d = function(e, t) {
						for (var n = "", r = 0; r < e.length; r++) {
							...
							if (i === "j") {
								for (var a = 0; r + 1 < e.length && e.charAt(r + 1) === i;) a++, r++;
								var o = 1 + (1 & a), s = a < 2 ? 1 : 3 + (a >> 1), c = mp(t);
					...
					var f = {
						...
						pattern: d,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? tp(d) : {}
					};
					return {
						val: {
		...
		try {
			n = function(e) {
				if (e.length === 0) throw Error("Number skeleton cannot be empty");
				for (var t = [], n = 0, r = e.split(np).filter(function(e) {
					return e.length > 0;
				}); n < r.length; n++) {
					var i = r[n].split("/");
		...
		return {
			val: {
				...
				tokens: n,
				location: t,
				parsedOptions: this.shouldParseSkeletons ? fp(n) : {}
			},
			err: null
		};
	}, e.prototype.tryParsePluralOrSelectOptions = function(e, t, n, r) {
		...
		if (Ep(this.message, e, this.offset())) {
			for (var t = 0; t < e.length; t++) this.bump();
			return !0;
		}
		return !1;
		...
		for (; !this.isEOF() && Ip(this.char());) this.bump();
	}, e.prototype.peek = function() {
		if (this.isEOF()) return null;
		var e = this.char(), t = this.offset();
		return this.message.charCodeAt(t + (e >= 65536 ? 2 : 1)) ?? null;
...
var Rp, W = {};
function zp() {
	return Rp || (Rp = 1, Object.defineProperty(W, "__esModule", { value: !0 }), W.SKELETON_TYPE = W.TYPE = void 0, W.isLiteralElement = function(t) {
...
(function() {
	if (Bp) return Vp;
	Bp = 1, Object.defineProperty(Vp, "__esModule", { value: !0 }), Vp.printAST = n, Vp.doPrintAST = r, Vp.printDateTimeSkeleton = o;
	var e = Hp, t = zp();
	function n(e) {
		return r(e, !1);
	}
...
var Up = "_gt_";
RegExp(`^${Up}\\d+$`), RegExp(`^${Up}$`);
var Wp = "generaltranslation.locale";
e.use;
var Gp = {
	af: ["af"],
	am: ["am"],
...
function Kp(e) {
	if (!pu(e)) return null;
	e = hu(e);
	let { languageCode: t, ...n } = ld(e);
	if (Gp[t]?.length) {
		let r = Gp[t], i = ({ locale: e, languageCode: t, minimizedCode: n, regionCode: i, scriptCode: a }) => {
			let o = [
				e,
				`${t}-${i}`,
				`${t}-${a}`,
...
function Jp(e = {}, t) {
	return e.name ? e.name : `_gt_${qp[t] || "value"}_${e["data-_gt"]?.id}`;
}
var Yp = "en", Xp = "DEFAULT_TERMINATOR_KEY", Zp = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	CutoffFormat: class {
		constructor(e, t = {}) {
			...
			if (!Zp[t.style ?? "ellipsis"]) throw Error(((e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`)(t.style ?? "ellipsis"));
			let n, r;
			if (t.maxChars !== void 0) {
				n = t.style ?? "ellipsis";
				let e = new Intl.Locale(this.locale).language;
				r = Zp[n][e] || Zp[n].DEFAULT_TERMINATOR_KEY;
			}
			let i = t.terminator ?? r?.terminator, a = i == null ? void 0 : t.separator ?? r?.separator;
			this.additionLength = (i?.length ?? 0) + (a?.length ?? 0), t.maxChars !== void 0 && Math.abs(t.maxChars) < this.additionLength && (i = void 0, a = void 0), this.options = {
				maxChars: t.maxChars,
...
new class {
	...
	get(e, ...t) {
		let [n = "en", r = {}] = t, i = this._generateKey(n, r), a = this.cache[e]?.[i];
		return a === void 0 && (a = new Qp[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}();
var $p = "https://cdn.gtx.dev", em = "https://runtime2.gtx.dev";
function tm(e) {
	if (e === void 0) return;
	if (e === null) return "null";
	if (typeof e == "number") return isFinite(e) ? "" + e : "null";
	...
	if (Array.isArray(e)) {
		let t = "[";
		for (let n = 0; n < e.length; n++) n && (t += ","), t += tm(e[n]) || "null";
		return t + "]";
	}
	let t = Object.keys(e).sort(), n = "";
	for (let r of t) {
...
var lm = typeof Uint8Array.from([]).toHex == "function" && typeof Uint8Array.fromHex == "function", um = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function dm(e, t = {}) {
	let n = (t, n) => e(n).update(t).digest(), r = e(void 0);
	return n.outputLen = r.outputLen, n.blockLen = r.blockLen, n.canXOF = r.canXOF, n.create = (t) => e(t), Object.assign(n, t), Object.freeze(n);
}
var fm = (e) => ({ oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
var hm = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = sm(this.buffer);
	}
	update(e) {
		am(this), im(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		am(this), function(e, t) {
			im(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, om(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = sm(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), vm = /* @__PURE__ */ new Uint32Array(64), ym = class extends hm {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) vm[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = vm[e - 15], n = vm[e - 2], r = cm(t, 7) ^ cm(t, 18) ^ t >>> 3, i = cm(n, 17) ^ cm(n, 19) ^ n >>> 10;
			vm[e] = i + vm[e - 7] + r + vm[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (cm(o, 6) ^ cm(o, 11) ^ cm(o, 25)) + pm(o, s, c) + _m[e] + vm[e] | 0, u = (cm(n, 2) ^ cm(n, 13) ^ cm(n, 22)) + mm(n, r, i) | 0;
			l = c, c = s, s = o, o = a + t | 0, a = i, i = r, r = n, n = t + u | 0;
		}
		n = n + this.A | 0, r = r + this.B | 0, i = i + this.C | 0, a = a + this.D | 0, o = o + this.E | 0, s = s + this.F | 0, c = c + this.G | 0, l = l + this.H | 0, this.set(n, r, i, a, o, s, c, l);
	}
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), om(this.buffer);
	}
}, bm = class extends ym {
	A = 0 | gm[0];
	B = 0 | gm[1];
...
}, xm = dm(() => new bm(), fm(1)), Sm = function(e, t) {
...
var Pm = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function Fm(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || Pm(t, e, n);
}
function Im(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function Rm() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(Lm(arguments[t]));
	return e;
}
function zm() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function Vm(e) {
	return this instanceof Vm ? (this.v = e, this) : new Vm(e);
}
function Hm(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var r, i = n.apply(e, t || []), a = [];
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof Vm ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function Wm(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = Im(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var Km = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return qm = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, qm(e);
...
function Jm(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = qm(e), r = 0; r < n.length; r++) n[r] !== "default" && Pm(t, e, n[r]);
	return Km(t, e), t;
}
function Ym(e) {
	return e && e.__esModule ? e : { default: e };
...
var eh = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function th(e) {
	function t(t) {
		e.error = e.hasError ? new eh(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var K, q, rh, ih = Object.freeze({
	...
	__await: Vm,
	__awaiter: Mm,
	__classPrivateFieldGet: Xm,
	__classPrivateFieldIn: Qm,
	__classPrivateFieldSet: Zm,
	__createBinding: Pm,
	__decorate: Tm,
	__disposeResources: th,
	__esDecorate: Dm,
	__exportStar: Fm,
	__extends: Cm,
	__generator: Nm,
	...
	__read: Lm,
	__rest: wm,
	__rewriteRelativeImportExtension: nh,
	__runInitializers: Om,
	__setFunctionName: Am,
	__spread: Rm,
	__spreadArray: Bm,
	__spreadArrays: zm,
	__values: Im,
...
var ah = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, oh = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function sh(e) {
	var t = {};
	return e.replace(oh, function(e) {
		var n = e.length;
		switch (e[0]) {
			case "G":
				t.era = n === 4 ? "long" : n === 5 ? "narrow" : "short";
...
var uh = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, dh = /^(@+)?(\+|#+)?[rs]?$/g, fh = /(\*)(0+)|(#+)(0+)|(0+)/g, ph = /^(0+)$/;
function mh(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(dh, function(e, n, r) {
		return typeof r == "string" ? r === "+" ? t.minimumSignificantDigits = n.length : n[0] === "#" ? t.maximumSignificantDigits = n.length : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length + (typeof r == "string" ? r.length : 0)) : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length), "";
	}), t;
}
function hh(e) {
...
function gh(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !ph.test(e)) throw Error("Malformed concise eng/scientific notation");
		t.minimumIntegerDigits = e.length;
	}
	return t;
}
...
function vh(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "measure-unit":
			case "unit":
				t.style = "unit", t.unit = lh(i.options[0]);
				continue;
			case "compact-short":
			case "K":
				t.notation = "compact", t.compactDisplay = "short";
			...
			case "integer-width":
				if (i.options.length > 1) throw RangeError("integer-width stems only accept a single optional option");
				i.options[0].replace(fh, function(e, n, r, i, a, o) {
					if (n) t.minimumIntegerDigits = r.length;
					else {
						if (i && a) throw Error("We currently do not support maximum integer digits");
						if (o) throw Error("We currently do not support exact integer digits");
		...
		if (ph.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
		else if (uh.test(i.stem)) {
			if (i.options.length > 1) throw RangeError("Fraction-precision stems only accept a single optional option");
			i.stem.replace(uh, function(e, n, r, i, a, o) {
				return r === "*" ? t.minimumFractionDigits = n.length : i && i[0] === "#" ? t.maximumFractionDigits = i.length : a && o ? (t.minimumFractionDigits = a.length, t.maximumFractionDigits = a.length + o.length) : (t.minimumFractionDigits = n.length, t.maximumFractionDigits = n.length), "";
			});
			var a = i.options[0];
			a === "w" ? t = G(G({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = G(G({}, t), mh(a)));
		} else if (dh.test(i.stem)) t = G(G({}, t), mh(i.stem));
		else {
			var o = hh(i.stem);
			o && (t = G(G({}, t), o));
			var s = gh(i.stem);
...
function bh(e) {
	...
	var n, r = e.language;
	return r !== "root" && (n = e.maximize().region), (yh[n || ""] || yh[r || ""] || yh[`${r}-001`] || yh["001"])[0];
}
var xh = RegExp(`^${ah.source}*`), Sh = RegExp(`${ah.source}*\$`);
function J(e, t) {
	return {
		start: e,
		end: t
...
var Ch = !!String.prototype.startsWith && "_a".startsWith("a", 1), wh = !!String.fromCodePoint, Th = !!Object.fromEntries, Eh = !!String.prototype.codePointAt, Dh = !!String.prototype.trimStart, Oh = !!String.prototype.trimEnd, kh = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, Ah = !0;
try {
	Ah = Rh("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	Ah = !1;
}
var jh, Mh = Ch ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, Nh = wh ? String.fromCodePoint : function() {
	for (var e = [...arguments], t, n = "", r = e.length, i = 0; r > i;) {
		if ((t = e[i++]) > 1114111) throw RangeError(t + " is not a valid code point");
		n += t < 65536 ? String.fromCharCode(t) : String.fromCharCode(55296 + ((t -= 65536) >> 10), t % 1024 + 56320);
	}
	return n;
}, Ph = Th ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
if (Ah) {
	var zh = Rh("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	jh = function(e, t) {
		return zh.lastIndex = t, zh.exec(e)[1] ?? "";
	};
} else jh = function(e, t) {
	for (var n = [];;) {
		var r = Fh(e, t);
		if (r === void 0 || Uh(r) || Wh(r)) break;
		n.push(r), t += r >= 65536 ? 2 : 1;
	}
	return Nh.apply(void 0, n);
};
var Bh = function() {
	function e(e, t) {
		t === void 0 && (t = {}), this.message = e, this.position = {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			if (i === 123) {
				...
				if (i !== 35 || t !== "plural" && t !== "selectordinal") {
					...
					if (i === 60 && !this.ignoreTag && Vh(this.peek() || 0)) {
						if ((a = this.parseTag(e, t)).err) return a;
						r.push(a.val);
					} else {
						var a;
		...
		if (this.bumpIf(">")) {
			...
			var a = i.val, o = this.clonePosition();
			if (this.bumpIf("</")) {
				if (this.isEOF() || !Vh(this.char())) return this.error(K.INVALID_TAG, J(o, this.clonePosition()));
				var s = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					val: {
						type: q.tag,
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && Hh(this.char());) this.bump();
		return this.message.slice(e, this.offset());
	}, e.prototype.parseLiteral = function(e, t) {
		for (var n = this.clonePosition(), r = "";;) {
			var i = this.tryParseQuote(t);
		...
		return this.isEOF() || this.char() !== 60 || !this.ignoreTag && (Vh(e = this.peek() || 0) || e === 47) ? null : (this.bump(), "<");
		var e;
	}, e.prototype.tryParseQuote = function(e) {
		if (this.isEOF() || this.char() !== 39) return null;
		switch (this.peek()) {
		...
		return Nh.apply(void 0, t);
	}, e.prototype.tryParseUnquoted = function(e, t) {
		if (this.isEOF()) return null;
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), Nh(n));
	}, e.prototype.parseArgument = function(e, t) {
		var n = this.clonePosition();
		...
		var e = this.clonePosition(), t = this.offset(), n = jh(this.message, t), r = t + n.length;
		return this.bumpTo(r), {
			value: n,
		...
		switch (a) {
			...
			case "time":
				...
				if (this.bumpIf(",")) {
					...
					var c = this.clonePosition();
					if ((g = this.parseSimpleArgStyleIfPossible()).err) return g;
					if ((f = Lh(g.val)).length === 0) return this.error(K.EXPECT_ARGUMENT_STYLE, J(this.clonePosition(), this.clonePosition()));
					s = {
						style: f,
				...
				if (s && Mh(s?.style, "::", 0)) {
					...
					this.locale && (d = function(e, t) {
						for (var n = "", r = 0; r < e.length; r++) {
							...
							if (i === "j") {
								for (var a = 0; r + 1 < e.length && e.charAt(r + 1) === i;) a++, r++;
								var o = 1 + (1 & a), s = a < 2 ? 1 : 3 + (a >> 1), c = bh(t);
								for (c != "H" && c != "k" || (s = 0); s-- > 0;) n += "a";
								for (; o-- > 0;) n = c + n;
							} else n += i === "J" ? "H" : i;
						}
					...
					var f = {
						...
						pattern: d,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? sh(d) : {}
					};
					return {
						val: {
		...
		try {
			n = function(e) {
				if (e.length === 0) throw Error("Number skeleton cannot be empty");
				for (var t = [], n = 0, r = e.split(ch).filter(function(e) {
					return e.length > 0;
				}); n < r.length; n++) {
					var i = r[n].split("/");
					if (i.length === 0) throw Error("Invalid number skeleton");
		...
		return {
			val: {
				...
				tokens: n,
				location: t,
				parsedOptions: this.shouldParseSkeletons ? vh(n) : {}
			},
			err: null
		};
	}, e.prototype.tryParsePluralOrSelectOptions = function(e, t, n, r) {
		...
		if (Mh(this.message, e, this.offset())) {
			for (var t = 0; t < e.length; t++) this.bump();
			return !0;
		}
		return !1;
		...
		for (; !this.isEOF() && Uh(this.char());) this.bump();
	}, e.prototype.peek = function() {
		if (this.isEOF()) return null;
		var e = this.char(), t = this.offset();
		return this.message.charCodeAt(t + (e >= 65536 ? 2 : 1)) ?? null;
...
function Gh(e) {
	e.forEach(function(e) {
		...
		}(e)) for (var t in e.options) delete e.options[t].location, Gh(e.options[t].value);
		else (function(e) {
			return e.type === q.number;
		})(e) && function(e) {
			return !(!e || typeof e != "object" || e.type !== rh.number);
		}(e.style) ? delete e.style.location : !function(e) {
			return e.type === q.date;
		}(e) && !function(e) {
			return e.type === q.time;
		}(e) || !function(e) {
			return !(!e || typeof e != "object" || e.type !== rh.dateTime);
		}(e.style) ? function(e) {
			return e.type === q.tag;
		}(e) && Gh(e.children) : delete e.style.location;
	});
}
function Kh(e) {
	if (Object.prototype.hasOwnProperty.call(e, "__esModule")) return e;
...
function Jh() {
	if (qh) return Y;
	var e, t;
	return qh = 1, Object.defineProperty(Y, "__esModule", { value: !0 }), Y.SKELETON_TYPE = Y.TYPE = void 0, Y.isLiteralElement = function(t) {
		return t.type === e.literal;
...
var Yh, Xh = Jh(), Zh = {}, Qh = Kh(ih), $h = function() {
	if (Yh) return Zh;
	Yh = 1, Object.defineProperty(Zh, "__esModule", { value: !0 }), Zh.printAST = n, Zh.doPrintAST = r, Zh.printDateTimeSkeleton = o;
	var e = Qh, t = Jh();
	function n(e) {
		return r(e, !1);
	}
...
function ng({ icuString: e, shouldVisit: t, visitor: n, options: { recurseIntoVisited: r = !0, ...i } }) {
	let a = function(e, t) {
		t === void 0 && (t = {}), t = G({
			shouldParseSkeletons: !0,
			requiresOtherClause: !0
		}, t);
		var n = new Bh(e, t).parse();
		if (n.err) {
			var r = SyntaxError(K[n.err.kind]);
			throw r.location = n.err.location, r.originalMessage = n.err.message, r;
		}
		return t != null && t.captureLocation || Gh(n.val), n.val;
	}(e, i);
	return o(a), a;
	function o(e) {
		e.map(s);
...
var rg = "_gt_", ig = RegExp(`^${rg}\\d+$`), ag = RegExp(`^${rg}$`);
function og(e) {
	return e.type === Xh.TYPE.select && ig.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === Xh.TYPE.literal);
}
function sg(e) {
	return e.type === Xh.TYPE.select && ag.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === Xh.TYPE.literal);
}
function cg(e) {
	if (!e.includes("_gt_")) return e;
	let t = [];
...
function ug(e) {
	return e.includes("_gt_") ? $h.printAST(ng({
		icuString: e,
		shouldVisit: og,
		visitor: function(e) {
			e.type = Xh.TYPE.argument, delete e.options;
		},
		options: { recurseIntoVisited: !1 }
	})) : e;
}
...
var Z = "@generaltranslation/react-core", fg = `${Z} Error: Production environments cannot include an api key.`, pg = `${Z} Error: Fetching batched translations failed`, mg = (e, t) => e ? `${Z} Error: Translation failed for id: ${e}, hash: ${t} ` : `${Z} Error: Translation failed for hash: ${t}`, hg = (e, t) => `${Z} Error: error rendering string ${t ? `for id: "${t}"` : ""} original message: "${e}"`, gg = (e, t, n = "tx") => `${Z} Error: string translation error. ${n}("${e}")${t ? ` with id "${t}"` : ""} could not locate translation.`, _g = (e) => `${Z} Error: Dictionary subtree not found for id: "${e}"`, vg = (e) => `${Z} Error: Invalid ICU string dictionary entry found for id: "${e}"`, yg = `${Z} Warning: Translation cloud services require a project ID! Find yours at generaltranslation.com/dashboard.`, bg = (e) => `${Z} Warning: No valid dictionary entry found for id: "${e}"`, xg = `${Z} Warning: A development API key is required for runtime translation!  Find your development API key: generaltranslation.com/dashboard.  (Or, disable this warning message by setting runtimeUrl to an empty string which disables runtime translation.)`, Sg = `${Z} Warning: Runtime translation timed out.`, Cg = `${Z} Warning: No dictionary was found. Ensure you are either passing your dictionary to the <GTProvider>.`;
function wg(e) {
...
var Eg = {
	...
	let { props: t } = e, n = { t: Dg(e) };
	if (t["data-_gt"]) {
		let e = t["data-_gt"], r = e.transformation;
		if (r === "variable") {
			let n = e.variableType || "variable", r = Jp(t, n), i = tg(n);
			return {
				i: e.id,
				k: r,
				v: i
		...
		n.i = e.id, n.d = ((e, t, n) => {
			let r = Object.entries(Eg).reduce((e, [n, r]) => (t[r] && (e[n] = t[r]), e), {});
			if (e === "plural" && n) {
				let e = {};
		...
		let i = Object.entries(Eg).reduce((e, [n, r]) => (t[r] && (e[n] = t[r]), e), {});
	...
	return t.children && (n.c = Ag(t.children)), n;
}, kg = (e) => {
	return n = e, t.isValidElement(n) ? Og(e) : typeof e == "number" ? e.toString() : e;
	var n;
};
function Ag(e) {
	return Array.isArray(e) ? e.map(kg) : kg(e);
}
function jg(e) {
...
var Ig = (e) => typeof e == "string" || Array.isArray(e), Lg = (e) => typeof e == "object" && !!e && !Array.isArray(e);
function Rg(e, t) {
	if (Array.isArray(e)) return e.map((e, n) => Fg(e) ? t[n] : Rg(e, t[n]));
	let n = {
		...Object.fromEntries(Object.entries(e).filter(([, e]) => Ig(e))),
		...Object.fromEntries(Object.entries(t).filter(([, e]) => Ig(e)))
	}, r = Object.entries(e).filter(([, e]) => Lg(e)).map(([e]) => e), i = Object.entries(t).filter(([, e]) => Lg(e)).map(([e]) => e), a = /* @__PURE__ */ new Set([...r, ...i]);
	for (let r of a) n[r] = Rg(X(e, r) || {}, X(t, r) || {});
	return n;
}
function zg({ dictionary: e, id: t }) {
	if (t === "") return e;
	let n = e, r = t.split(".");
...
function Vg(e, t, n, r) {
	...
	i.forEach((e) => {
		if (function(e) {
			return !!Bg.includes(e);
		}(e)) throw Error(`Invalid key: ${e}`);
	}), t ||= {};
	for (let e of i.slice(0, -1)) X(t, e) ?? dg(t, e, Array.isArray(X(r, e)) ? [] : {}), t = X(t, e), r = X(r, e);
	dg(t, i[i.length - 1], e);
}
function Hg(e) {
	let t = {};
...
function Ug(e) {
	return function(e) {
		if (im(e), lm) return e.toHex();
		let t = "";
		for (let n = 0; n < e.length; n++) t += um[e[n]];
		return t;
	}(xm(function(e) {
		if (typeof e != "string") throw TypeError("string expected");
		return new Uint8Array(new TextEncoder().encode(e));
...
function Wg({ source: e, context: t, id: n, maxChars: r, dataFormat: i }, a = Ug) {
	let o;
	return o = i === "JSX" ? Kg(e) : e, a(nm({
		source: o,
		...n && { id: n },
		...t && { context: t },
		...r != null && { maxChars: Math.abs(r) },
...
var Gg = (e) => {
	if (e && typeof e == "object") {
		let t = {};
		if ("c" in e && e.c && (t.c = Kg(e.c)), "d" in e) {
			let n = e?.d;
			n?.b && (t.b = Object.fromEntries(Object.entries(n.b).map(([e, t]) => [e, Kg(t)]))), n?.t && (t.t = n.t);
		}
		return rm(e) ? {
			k: e.k,
			...e.v && { v: e.v }
...
function Kg(e) {
	return Array.isArray(e) ? e.map(Gg) : Gg(e);
}
function qg(e, t = "") {
	let n = !1;
	return Object.entries(e).forEach(([r, i]) => {
		let a = t ? `${t}.${r}` : r;
		if (Fg(i)) {
			let { entry: t, metadata: o } = Ng(i);
			o?.$_hash || (o ||= {}, o.$_hash = Wg({
				source: cg(t),
...
function Jg(e, t, n) {
	...
	if (!r) throw Error(_g(n));
	if (Fg(r)) throw Error(`${Z} Error: Cannot inject and merge a dictionary entry`);
...
function Yg(e, t, n = "") {
	...
	return Object.entries(e).forEach(([e, i]) => {
		...
		} else r.push(...Yg(i, X(t, e) || (Array.isArray(i) ? [] : {}), a));
	}), r;
}
function Xg(e) {
...
function $g({ gt: e, locale: t, versionId: n, defaultLocale: r, runtimeUrl: i, renderSettings: a, setTranslations: o, environment: s, ...c }) {
	...
	let S = m(0), C = m(/* @__PURE__ */ new Map()), ee = m(/* @__PURE__ */ new Map()), te = l(async (e) => {
		...
		try {
			...
			e?.name === "AbortError" ? console.warn(Sg) : console.warn(pg, e), a.forEach((e) => {
		...
		return o;
	}, []), w = m(null), ne = m(async () => {}), re = l((e) => {
		x(e), C.current.size > 0 && (w.current = setTimeout(() => {
			w.current = null, ne.current();
		}, 50));
	}, [x]), ie = l(() => {
		ne.current = async () => {
		...
		if (ie(), e) return w.current &&= (clearTimeout(w.current), null), void ne.current();
	...
	}, [ae]), se = p(() => oe("ICU"), [oe]), ce = p(() => oe("JSX"), [oe]);
	return d(() => () => {
		w.current && clearTimeout(w.current);
	}, []), {
		developmentApiEnabled: u,
		registerIcuForTranslation: se,
		registerJsxForTranslation: ce
	};
}
function e_({ gt: e, translations: t, locale: n, defaultLocale: r, translationRequired: i, developmentApiEnabled: a, registerIcuForTranslation: o, environment: s }) {
	function c({ message: t, variables: n, locales: r, fallback: i, id: a, maxChars: o, format: l }) {
		try {
			let a = lg(i || ""), s = e.formatMessage(Object.keys(a).length ? ug(t) : t, {
				locales: r,
				variables: {
					...n,
					...a,
			...
			if (s === "production") console.warn(((e, t) => `${Z} Warning: failed to render string ${t ? `for id: "${t}"` : ""} original message: "${e}"`)(t, a), "Error: ", l);
				...
				if (!i) throw Error(`${hg(t, a)} Error: ${l}`);
				console.error(hg(t, a), "Error: ", l);
			}
			return i ? c({
				message: i,
				locales: r,
	...
	let d = (e, t = {}, s) => {
		...
		}), g(e, [r])) : (console.warn(gg(e, d, "gt")), g(e, [r])) : s?.[v] ? g(s?.[v], [n, r], e) : g(e, [r]);
	};
	return {
		_gtFunction: d,
		_mFunction: (e, s = {}, l) => {
			...
			}), b(p, [r])) : l?.[f] ? b(l?.[f], [n, r], p) : b(p, [r]) : (console.warn(gg(p, Zg(e), "m")), b(p, [r]));
		},
...
function t_(e, t, n, r, i, a, o, s, c, u, d) {
	return l((s, l = {}) => {
		if (!t) return "";
		let f = Mg(t, s);
		if (!f) return console.warn(bg(s)), "";
		if (!jg(f)) return console.warn(((e) => `${Z} Warning: Invalid dictionary entry found for id: "${e}"`)(s)), "";
		let { entry: p, metadata: m } = Ng(f);
		if (!p || typeof p != "string") return "";
		let { $format: h, ...g } = l, _ = (t, n, r) => {
			try {
				let i = lg(r || ""), a = e.formatMessage(Object.keys(i).length ? ug(t) : t, {
					locales: n,
					variables: {
						...g,
						...i,
				...
				if (d === "production") console.warn(((e) => `${Z} Warning: Invalid ICU string dictionary entry found for id: "${e}"`)(s), "Error: ", i);
					...
					if (!r) throw Error(`${vg(s)} Error: ${i}`);
					console.error(vg(s), "Error: ", i);
				}
...
function n_({ _locale: e, defaultLocale: t, locales: n, ssr: r, localeCookieName: i, customMapping: a, useDetermineLocale: o, enableI18n: s, reloadOnLocaleUpdate: c }) {
...
function r_({ devApiKey: e, projectId: t, runtimeUrl: n, loadTranslationsType: r, cacheUrl: i, locales: a, environment: o }) {
	d(() => {
		if (o === "production" && e) throw Error(fg);
		if (r === "custom" || !i && !n || t || o !== "development" || console.warn(yg), t && n && r !== "custom" && !e && o === "development" && console.warn(xg), n === em || i === $p && r === "default") {
			let e = a.filter((e) => !Kp(e));
...
async function i_(e, t) {
	let n = Array.from(/* @__PURE__ */ new Set([e, ld(e).languageCode]));
	for (let e of n) try {
		let n = await t(e);
		if (n) return n;
	} catch {}
...
function a_({ _translations: e, translationRequired: t, loadTranslationsType: n, loadTranslations: r, locale: i, cacheUrl: a, projectId: o, _versionId: s, gt: c }) {
...
function o_(e, t, n, r, i, a, o, s, c, u, d, f) {
	return l((o, c, l = {}) => {
		...
		if (!p) return console.warn(bg(c)), {};
		if (Fg(p)) return f(o, l);
		if (!s) return Hg(p);
		let m = function({ dictionary: e, id: t, sourceDictionary: n }) {
			if (t === "") return e;
			let r = e, i = n, a = t.split(".");
			for (let e of a) X(r, e) === void 0 && (Array.isArray(X(i, e)) ? dg(r, e, []) : dg(r, e, {})), r = X(r, e);
			return r;
		}({
			dictionary: t,
			id: c,
			sourceDictionary: t
		}), { dictionary: h, updateDictionary: g } = qg(structuredClone(p), c), _ = Yg(h, m, c), { dictionary: v, updateDictionary: y } = function(e, t, n, r, i = "") {
			let a = !1, o = i ? i.split(".") : [];
			return r.forEach(({ metadata: r }) => {
				let { $_hash: i, $id: s } = r, c = o.length > 0 ? s.split(".").slice(o.length).join(".") : s, l = Mg(t, c), u;
				Fg(l) && (u = Ng(l).entry);
				let d = n[i] || u;
				d && (Vg(d, t, c, e), a = !0);
			}), {
			...
			return n.forEach(({ source: n, metadata: r }) => {
				let { $id: a } = r, o = i.length > 0 ? a.split(".").slice(i.length).join(".") : a, s = Mg(t, o), c;
				Fg(s) && (c = Ng(s).entry), Vg(c || n, t, o, e);
			}), t;
...
function s_({ enableI18n: e }) {
	let [t] = h(e);
	return { enableI18n: t };
}
function c_() {
	throw wg("isSSREnabled");
}
function l_({}) {
	throw wg("useDetermineLocale");
}
function u_({}) {
	throw wg("useRegionState");
}
function d_({ children: e, config: t, environment: n = "production", projectId: r = t?.projectId || "", devApiKey: a = t?.devApiKey || "", _versionId: o = t?._versionId, dictionary: s = t?.dictionary || {}, locales: c = t?.locales || [], defaultLocale: l = t?.defaultLocale || Yp, cacheUrl: u = t?.cacheUrl || $p, runtimeUrl: f = t?.runtimeUrl || em, renderSettings: m = t?.renderSettings || Pg(n), ssr: g = t?.ssr || c_(), localeCookieName: _ = t?.localeCookieName || "generaltranslation.locale", locale: v = "", region: y, loadDictionary: b, loadTranslations: S, fallback: C, translations: ee = null, customMapping: te = t?.customMapping, enableI18n: w = t?.enableI18n === void 0 || t.enableI18n, enableI18nLoaded: ne, reloadOnLocaleUpdate: re, useEnableI18n: ie = s_, readAuthFromEnv: ae = Tg, useDetermineLocale: oe = l_, useRegionState: se = u_, ...ce }) {
	v &&= fd(v, te);
	let { projectId: le, devApiKey: ue } = ae({
		projectId: r,
		devApiKey: a
	}), { enableI18n: de } = ie({
		enableI18n: w,
		...
		ssr: g
	}), { locale: fe, setLocale: pe, locales: me, translationRequired: he, dialectTranslationRequired: ge } = n_({
		_locale: v,
		defaultLocale: l,
		locales: c,
		ssr: g,
		localeCookieName: _,
		customMapping: te,
		useDetermineLocale: oe,
		enableI18n: de,
		reloadOnLocaleUpdate: re
	}), { region: _e, setRegion: T } = se({
		_region: y,
		ssr: g,
		...
		f,
		te
	]), ye = p(() => (S ? "custom" : u && le && "default") || "disabled", [
		S,
		u,
		le
	]), { dictionary: be, setDictionary: xe, dictionaryTranslations: Se, setDictionaryTranslations: Ce } = function({ _dictionary: e, _dictionaryTranslations: t = {}, loadDictionary: n, locale: r, defaultLocale: i }) {
		let [a, o] = h(e), [s, c] = h(t);
		return d(() => {
			if (!n) return;
			let e = !0;
			return (async () => {
				let t = await i_(i, n) || {}, a = await i_(r, n) || {};
				e && o(t || {}), e && c(a || {});
			})(), () => {
				e = !1;
			};
	...
	r_({
		...
		projectId: le,
		runtimeUrl: f,
		loadTranslationsType: ye,
		cacheUrl: u,
		locales: c,
		environment: n
	});
	let { translations: we, setTranslations: Te } = a_({
		_translations: ee,
		translationRequired: he,
		loadTranslationsType: ye,
		loadTranslations: S,
		locale: fe,
		cacheUrl: u,
		...
		_versionId: o,
		gt: ve
	}), { registerIcuForTranslation: Ee, registerJsxForTranslation: De, developmentApiEnabled: Oe } = $g({
		gt: ve,
		locale: fe,
		versionId: o,
		defaultLocale: l,
		...
		environment: n,
		...ce
	}), { _gtFunction: ke, _mFunction: Ae, _filterMessagesForPreload: je, _preloadMessages: Me } = e_({
		gt: ve,
		translations: we,
		locale: fe,
		defaultLocale: l,
		translationRequired: he,
		developmentApiEnabled: Oe,
		registerIcuForTranslation: Ee,
		environment: n
	}), Ne = t_(ve, be, Se, we, fe, l, he, ge, Oe, Ee, n), Pe = o_(be || {}, Se || {}, xe, Ce, we, fe, l, he, ge, Oe, Ee, Ne), Fe = !(he && !we || !fe);
	return x(Qg.Provider, {
		value: {
			gt: ve,
			registerIcuForTranslation: Ee,
			registerJsxForTranslation: De,
			_gtFunction: ke,
			_mFunction: Ae,
			_filterMessagesForPreload: je,
			_preloadMessages: Me,
			_dictionaryFunction: Ne,
			_dictionaryObjFunction: Pe,
			developmentApiEnabled: Oe,
			locale: fe,
			locales: me,
			setLocale: pe,
...
function f_({ projectId: e, devApiKey: t }) {
	try {
		return {
			projectId: e || "",
			devApiKey: t || void 0
...
function p_({ _region: e, regionCookieName: t }) {
...
function m_({ _region: e, ssr: t, regionCookieName: n }) {
	let [r, i] = h(t ? void 0 : p_({
		_region: e,
		regionCookieName: n
	}));
	return d(() => {
...
function h_({ enableI18n: e, enableI18nCookieName: t, enableI18nLoaded: n, ssr: r }) {
...
var __ = function(e, t) {
	return __ = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, __(e, t);
...
function v_(e, t) {
	...
	__(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var y_ = function() {
	return y_ = Object.assign || function(e) {
		for (var t, n = 1, r = arguments.length; n < r; n++) for (var i in t = arguments[n]) Object.prototype.hasOwnProperty.call(t, i) && (e[i] = t[i]);
		return e;
...
var A_ = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function j_(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || A_(t, e, n);
}
function M_(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function P_() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(N_(arguments[t]));
	return e;
}
function F_() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function L_(e) {
	return this instanceof L_ ? (this.v = e, this) : new L_(e);
}
function R_(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var r, i = n.apply(e, t || []), a = [];
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof L_ ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function B_(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = M_(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var H_ = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return U_ = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, U_(e);
...
function W_(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = U_(e), r = 0; r < n.length; r++) n[r] !== "default" && A_(t, e, n[r]);
	return H_(t, e), t;
}
function G_(e) {
	return e && e.__esModule ? e : { default: e };
...
var X_ = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function Z_(e) {
	function t(t) {
		e.error = e.hasError ? new X_(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var $_, ev, tv, nv, rv = Object.freeze({
	__proto__: null,
	__addDisposableResource: Y_,
	get __assign() {
		return y_;
	},
	__asyncDelegator: z_,
	...
	__await: L_,
	__awaiter: O_,
	__classPrivateFieldGet: K_,
	__classPrivateFieldIn: J_,
	__classPrivateFieldSet: q_,
	__createBinding: A_,
	__decorate: x_,
	__disposeResources: Z_,
	__esDecorate: C_,
	__exportStar: j_,
	__extends: v_,
	__generator: k_,
	...
	__read: N_,
	__rest: b_,
	__rewriteRelativeImportExtension: Q_,
	__runInitializers: w_,
	__setFunctionName: E_,
	__spread: P_,
	__spreadArray: I_,
	__spreadArrays: F_,
	__values: M_,
...
try {
	(nv = (/* @__PURE__ */ RegExp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu")).exec("a")) == null || nv[0];
} catch {}
function iv(e) {
	if (Object.prototype.hasOwnProperty.call(e, "__esModule")) return e;
	var t = e.default;
...
function ov() {
	if (av) return Q;
	var e, t;
	return av = 1, Object.defineProperty(Q, "__esModule", { value: !0 }), Q.SKELETON_TYPE = Q.TYPE = void 0, Q.isLiteralElement = function(t) {
		return t.type === e.literal;
...
(function() {
	if (sv) return cv;
	sv = 1, Object.defineProperty(cv, "__esModule", { value: !0 }), cv.printAST = n, cv.doPrintAST = r, cv.printDateTimeSkeleton = o;
	var e = lv, t = ov();
	function n(e) {
		return r(e, !1);
	}
...
var _v = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = pv(this.buffer);
	}
	update(e) {
		dv(this), uv(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		dv(this), function(e, t) {
			uv(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, fv(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = pv(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), bv = /* @__PURE__ */ new Uint32Array(64), xv = class extends _v {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) bv[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = bv[e - 15], n = bv[e - 2], r = mv(t, 7) ^ mv(t, 18) ^ t >>> 3, i = mv(n, 17) ^ mv(n, 19) ^ n >>> 10;
			bv[e] = i + bv[e - 7] + r + bv[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (mv(o, 6) ^ mv(o, 11) ^ mv(o, 25)) + hv(o, s, c) + yv[e] + bv[e] | 0, u = (mv(n, 2) ^ mv(n, 13) ^ mv(n, 22)) + gv(n, r, i) | 0;
			l = c, c = s, s = o, o = a + t | 0, a = i, i = r, r = n, n = t + u | 0;
		}
		n = n + this.A | 0, r = r + this.B | 0, i = i + this.C | 0, a = a + this.D | 0, o = o + this.E | 0, s = s + this.F | 0, c = c + this.G | 0, l = l + this.H | 0, this.set(n, r, i, a, o, s, c, l);
	}
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), fv(this.buffer);
	}
}, Sv = class extends xv {
	A = 0 | vv[0];
	B = 0 | vv[1];
...
var wv = function(e, t) {
	return wv = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, wv(e, t);
...
function Tv(e, t) {
	...
	wv(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var Ev = function() {
...
var Lv = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function Rv(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || Lv(t, e, n);
}
function zv(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function Vv() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(Bv(arguments[t]));
	return e;
}
function Hv() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function Wv(e) {
	return this instanceof Wv ? (this.v = e, this) : new Wv(e);
}
function Gv(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var r, i = n.apply(e, t || []), a = [];
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof Wv ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function qv(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = zv(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var Yv = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return Xv = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, Xv(e);
...
function Zv(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = Xv(e), r = 0; r < n.length; r++) n[r] !== "default" && Lv(t, e, n[r]);
	return Yv(t, e), t;
}
function Qv(e) {
	return e && e.__esModule ? e : { default: e };
...
var ry = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function iy(e) {
	function t(t) {
		e.error = e.hasError ? new ry(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var oy, sy, cy, ly, uy = Object.freeze({
	__proto__: null,
	...
	__importDefault: Qv,
	__importStar: Zv,
	__makeTemplateObject: Jv,
	__metadata: Pv,
	__param: kv,
	__propKey: Mv,
	__read: Bv,
	__rest: Dv,
	__rewriteRelativeImportExtension: ay,
...
try {
	(ly = function(e, t) {
		return new RegExp(e, t);
	}("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")) == null || ly[0];
} catch {}
var dy, fy, $ = {};
function py() {
	return dy || (dy = 1, Object.defineProperty($, "__esModule", { value: !0 }), $.SKELETON_TYPE = $.TYPE = void 0, $.isLiteralElement = function(t) {
		return t.type === e.literal;
...
(function() {
	if (fy) return my;
	fy = 1, Object.defineProperty(my, "__esModule", { value: !0 }), my.printAST = n, my.doPrintAST = r, my.printDateTimeSkeleton = o;
	var e = hy, t = py();
	function n(e) {
		return r(e, !1);
	}
...
var gy = "gt-react";
function _y({ locale: e = "", defaultLocale: t = "en", locales: n = [], localeCookieName: r = "generaltranslation.locale", ssr: i = !0, customMapping: a, enableI18n: o, reloadOnLocaleUpdate: s = !1 }) {
	let c = p(() => fd(e, a), [e, a]), l = p(() => n.map((e) => fd(e, a)), [n, a]), [u, f] = h(() => o ? fd(i ? c && dd(c, l, a) || "" : vy({
		_locale: c,
		locale: c,
		locales: l,
		defaultLocale: t,
		...
		let c = (r) => {
			if (!o) return n;
			if (r === e) return e;
			let s = fd(dd(r, t, a) || e || n, a);
			return s !== r && console.warn(((e, t, n = "@generaltranslation/react-core") => `${n} Warning: "${t}" is not a supported locale. Update supported locales in your dashboard or gt.config.json. Falling back to "${e}".`)(s, r, gy)), i(s), s;
		};
		return [(t) => {
			if (!o) return;
			t = fd(t);
...
function vy({ _locale: e, locale: t, locales: n, defaultLocale: r, localeCookieName: i, customMapping: a, enableI18n: o }) {
	if (!o) return r;
	if (e && e === t && dd(e, n, a) === t) return fd(e, a);
	...
	return l &&= fd(l, a), s && s !== l && typeof document < "u" && (document.cookie = `${i}=${l};path=/`), l;
}
function yy(e) {
	return x(d_, Object.assign({
		ssr: !(typeof process > "u" || !process.env.NEXT_RUNTIME) || (globalThis == null ? void 0 : globalThis.__NEXT_DATA__) !== void 0,
		environment: "development"
	}, e, {
		readAuthFromEnv: f_,
		useDetermineLocale: _y,
		useRegionState: m_,
		useEnableI18n: h_
	}));
}
var by = w().server(function({ defaultLocale: e, locales: t, customMapping: n }) {
	let r = [], i = ne(Wp);
	if (i && r.push(i), process.env._GENERALTRANSLATION_IGNORE_BROWSER_LOCALES === "false") {
		let e = re("accept-language")?.split(",").map((e) => e.split(";")?.[0].trim()) || [];
		e && r.push(...e);
	}
	return r.length === 0 && process.env._GENERALTRANSLATION_IGNORE_BROWSER_LOCALES === "false" && console.warn("gt-tanstack-start(server): no locales could be determined for this request"), dd(r, t, n) || e;
	...
	return a && r.push(a), r.length === 0 && (console.warn("gt-tanstack-start(client): no locales could be determined for this request"), r.push(e)), dd(r, t, n) || e;
}), xy = class extends Sd {
...
function Cy(e) {
	Zd(new Sy(Object.assign(Object.assign({}, e), { storeAdapter: new xy() })));
}
var wy = { exports: {} }, Ty, Ey, Dy = {};
function Oy() {
	return Ty || (Ty = 1, function() {
		...
		function o() {
			var t = e(this.type);
			return ae[t] || (ae[t] = !0, console.error("Accessing element.ref was removed in React 19. ref is now a regular prop. It will be removed from the JSX Element type in a future release.")), (t = this.props.ref) === void 0 ? null : t;
		}
		function s(t, n, i, a, s, l) {
			...
			if (ne.call(n, "key")) {
				...
				a = 0 < m.length ? "{key: someKey, " + m.join(": ..., ") + ": ...}" : "{key: someKey}", ce[p + a] || (m = 0 < m.length ? "{" + m.join(": ..., ") + ": ...}" : "{}", console.error("A props object containing a \"key\" prop is being spread into JSX:\n  let props = %s;\n  <%s {...props} />\nReact keys must be passed directly to JSX without using spread:\n  let props = %s;\n  <%s key={someKey} {...props} />", a, p, m, p), ce[p + a] = !0);
			}
		...
		var u, d = t, f = Symbol.for("react.transitional.element"), p = Symbol.for("react.portal"), m = Symbol.for("react.fragment"), h = Symbol.for("react.strict_mode"), g = Symbol.for("react.profiler"), _ = Symbol.for("react.consumer"), v = Symbol.for("react.context"), y = Symbol.for("react.forward_ref"), b = Symbol.for("react.suspense"), x = Symbol.for("react.suspense_list"), S = Symbol.for("react.memo"), C = Symbol.for("react.lazy"), ee = Symbol.for("react.activity"), te = Symbol.for("react.client.reference"), w = d.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, ne = Object.prototype.hasOwnProperty, re = Array.isArray, ie = console.createTask ? console.createTask : function() {
			return null;
		}, ae = {}, oe = (d = { react_stack_bottom_frame: function(e) {
			return e();
		} }).react_stack_bottom_frame.bind(d, a)(), se = ie(i(a)), ce = {};
		Dy.Fragment = m, Dy.jsx = function(e, t, n) {
			var r = 1e4 > w.recentlyCreatedOwnerStacks++;
			return s(e, t, n, !1, r ? Error("react-stack-top-frame") : oe, r ? ie(i(e)) : se);
		}, Dy.jsxs = function(e, t, n) {
			var r = 1e4 > w.recentlyCreatedOwnerStacks++;
			return s(e, t, n, !0, r ? Error("react-stack-top-frame") : oe, r ? ie(i(e)) : se);
		};
	}()), Dy;
}
var ky = (Ey || (Ey = 1, wy.exports = Oy()), wy.exports);
function Ay() {
...
function My(e) {
	return e.locale ? e.locale : Ay() ? jy() : void 0;
}
function Ny() {
	let e = Xd();
	if (!function(e) {
...
function Py(e) {
	let t = Ny().getProviderConfig();
	return ky.jsx(yy, Object.assign({ ssr: Ay() }, t, e, {
		reloadOnLocaleUpdate: !0,
		locale: My(e)
	}));
}
var Fy = Object.assign({
...
async function Iy(e, t = ["shared"]) {
	let n = {};
	return await Promise.all(t.map(async (t) => {
		let r = Fy[`./src/_gt/${e}/${t}.json`];
		if (!r) {
...
var Ly = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/scripts/Wrapper.tsx";
Cy({
	...ee,
	loadTranslations: Iy
});
...
var zy = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/Header.wrapper.tsx";
function By() {
	return C(Ry, { children: C(jo, {}, void 0, !1, {
		fileName: zy,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
