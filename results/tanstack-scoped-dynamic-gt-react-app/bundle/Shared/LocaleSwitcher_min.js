...
import { useNavigate as g, useParams as _, useRouter as v } from "@tanstack/react-router";
import { jsx as y } from "react/jsx-runtime";
import b, { locales as x } from "../../gt.config.json";
...
function oa({ renderVariable: e }) {
	...
	function i({ source: i, target: a, locales: o = ["en"], enableI18n: s }) {
		...
		if (Array.isArray(a) && !Array.isArray(i) && i && (i = [i]), Array.isArray(i) && Array.isArray(a)) {
			...
			return a.map((i, a) => {
				if (typeof i == "string") return y(t.Fragment, { children: i }, `string_${a}`);
				if (tn(i)) return y(t.Fragment, { children: e({
					variableType: i.v || "v",
					variableValue: n[i.k],
				...
				let u = d(i);
				return u ? y(t.Fragment, { children: r({
					sourceElement: u,
					targetElement: i,
					locales: o,
					enableI18n: s
...
function Ja(e) {
	let t = Da(), n = Oa(), r = ja(), i = h((n) => t.subscribeToTranslate(e, n), () => t.getTranslateSnapshot(e, n), () => t.getTranslateSnapshot(e, n));
...
yo._gtt = "translate-client";
function bo({ children: e, _locale: t, _enableI18n: n, _renderPreparedT: r = Qa, ...i }) {
...
var xo = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/LocaleSwitcher.tsx";
function So() {
	let e = _({ strict: !1 }).locale ?? "en";
	g();
	let t = (e) => {
		try {
	...
	return S("div", {
		...
		children: S("select", {
			...
			children: x.map((e) => S("option", {
				value: e,
				children: S(yo, { children: t(e) }, void 0, !1, {
					fileName: xo,
					lineNumber: 39,
					columnNumber: 13
				}, this)
...
var Co = 6e4, wo = (e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`, To = "DEFAULT_TERMINATOR_KEY", Eo = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	constructor(e, t = {}) {
		...
		if (!Eo[t.style ?? "ellipsis"]) throw Error(wo(t.style ?? "ellipsis"));
		let n, r;
		if (t.maxChars !== void 0) {
			n = t.style ?? "ellipsis";
			let e = new Intl.Locale(this.locale).language;
			r = Eo[n][e] || Eo[n].DEFAULT_TERMINATOR_KEY;
		}
	...
	get(e, ...t) {
		...
		return a === void 0 && (a = new Oo[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}(), ko = "https://cdn.gtx.dev", Ao = {
	GTJSON: ["GTJSON"],
	JSON: ["JSON"],
	PO: ["PO"],
	POT: ["POT", "PO"],
...
function Mo(e) {
	...
	if (!jo(e.fileFormat, e.transformFormat)) return `Unsupported file format transform: ${e.fileFormat} -> ${e.transformFormat}`;
}
function No(e) {
	for (let t of e) {
		let e = Mo(t);
...
function Io(e) {
	...
	if (Array.isArray(e)) {
		let t = "[";
		for (let n = 0; n < e.length; n++) n && (t += ","), t += Io(e[n]) || "null";
		return t + "]";
	}
	let t = Object.keys(e).sort(), n = "";
	for (let r of t) {
...
var zo = oe({
	...
	__classPrivateFieldIn: () => fs,
	__classPrivateFieldSet: () => ds,
	__createBinding: () => _s,
	__decorate: () => Ho,
	__disposeResources: () => ms,
	__esDecorate: () => Wo,
	__exportStar: () => Zo,
	__extends: () => Bo,
	__generator: () => Xo,
	...
	__read: () => $o,
	__rest: () => Vo,
	__rewriteRelativeImportExtension: () => hs,
	__runInitializers: () => Go,
...
function Zo(e, t) {
	for (var n in e) n !== "default" && !Object.prototype.hasOwnProperty.call(t, n) && _s(t, e, n);
}
function Qo(e) {
...
function is(e, t, n) {
	...
	function l(e) {
		e.value instanceof rs ? Promise.resolve(e.value.v).then(u, d) : f(a[0][2], e);
	}
	function u(e) {
		c("next", e);
	}
...
function cs(e) {
	...
	var t = {};
	if (e != null) for (var n = ys(e), r = 0; r < n.length; r++) n[r] !== "default" && _s(t, e, n[r]);
	return vs(t, e), t;
}
function ls(e) {
...
function ms(e) {
	function t(t) {
		e.error = e.hasError ? new bs(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	function i() {
...
var gs, j, _s, vs, ys, bs, xs, Ss = ie((() => {
	gs = function(e, t) {
		return gs = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
			e.__proto__ = t;
		} || function(e, t) {
	...
	}, _s = Object.create ? (function(e, t, n, r) {
		r === void 0 && (r = n);
		...
		return ys = Object.getOwnPropertyNames || function(e) {
			var t = [];
			for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
			return t;
		}, ys(e);
	}, bs = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
		var r = Error(n);
...
function Ns(e) {
	return !!(e && typeof e == "object" && e.type === Cs.number);
}
function Ps(e) {
	return !!(e && typeof e == "object" && e.type === Cs.dateTime);
}
var Fs = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, Is = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Ls(e) {
	var t = {};
	return e.replace(Is, function(e) {
		var n = e.length;
		switch (e[0]) {
			case "G":
...
function zs(e) {
	...
	for (var t = e.split(Rs).filter(function(e) {
		return e.length > 0;
...
var Vs = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, Hs = /^(@+)?(\+|#+)?[rs]?$/g, Us = /(\*)(0+)|(#+)(0+)|(0+)/g, Ws = /^(0+)$/;
function Gs(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(Hs, function(e, n, r) {
...
function qs(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !Ws.test(e)) throw Error("Malformed concise eng/scientific notation");
	...
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "integer-width":
				...
				i.options[0].replace(Us, function(e, n, r, i, a, o) {
		...
		if (Vs.test(i.stem)) {
			...
			i.stem.replace(Vs, function(e, n, r, i, a, o) {
			...
			var a = i.options[0];
			a === "w" ? t = j(j({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = j(j({}, t), Gs(a)));
			continue;
		}
		if (Hs.test(i.stem)) {
			t = j(j({}, t), Gs(i.stem));
...
function Qs(e) {
	...
	var n = e.language, r;
	return n !== "root" && (r = e.maximize().region), (Xs[r || ""] || Xs[n || ""] || Xs[`${n}-001`] || Xs["001"])[0];
}
Ss();
var $s = RegExp(`^${Fs.source}*`), ec = RegExp(`${Fs.source}*\$`);
function P(e, t) {
	return {
		start: e,
		end: t
...
var tc = !!String.prototype.startsWith && "_a".startsWith("a", 1), nc = !!String.fromCodePoint, rc = !!Object.fromEntries, ic = !!String.prototype.codePointAt, ac = !!String.prototype.trimStart, oc = !!String.prototype.trimEnd, sc = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, cc = !0;
try {
	cc = hc("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	cc = !1;
}
var lc = tc ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, uc = nc ? String.fromCodePoint : function() {
	...
	return t;
}, dc = rc ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
var gc;
if (cc) {
	var _c = hc("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	gc = function(e, t) {
		return _c.lastIndex = t, _c.exec(e)[1] ?? "";
	};
} else gc = function(e, t) {
	for (var n = [];;) {
		var r = fc(e, t);
		if (r === void 0 || Sc(r) || Cc(r)) break;
		n.push(r), t += r >= 65536 ? 2 : 1;
	}
	return uc.apply(void 0, n);
};
var vc = function() {
	function e(e, t) {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			} else if (i === 60 && !this.ignoreTag && yc(this.peek() || 0)) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !yc(this.char())) return this.error(M.INVALID_TAG, P(o, this.clonePosition()));
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && xc(this.char());) this.bump();
		...
		return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !bc(this.peek() || 0)) ? (this.bump(), "<") : null;
		...
		return uc.apply(void 0, t);
	}, e.prototype.tryParseUnquoted = function(e, t) {
		if (this.isEOF()) return null;
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), uc(n));
		...
		var e = this.clonePosition(), t = this.offset(), n = gc(this.message, t), r = t + n.length;
		...
		switch (a) {
			...
			case "time":
				...
				if (s && lc(s?.style, "::", 0)) {
					...
					var m = p;
					this.locale && (m = Zs(p, this.locale));
					var u = {
						type: Cs.dateTime,
						pattern: m,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? Ls(m) : {}
					};
					return {
						val: {
...
function wc(e) {
	e.forEach(function(e) {
		if (delete e.location, ks(e) || As(e)) for (var t in e.options) delete e.options[t].location, wc(e.options[t].value);
		else Es(e) && Ns(e.style) || (Ds(e) || Os(e)) && Ps(e.style) ? delete e.style.location : Ms(e) && wc(e.children);
	});
}
function Tc(e, t) {
	t === void 0 && (t = {}), t = j({
	...
	var n = new vc(e, t).parse();
	if (n.err) {
		var r = SyntaxError(M[n.err.kind]);
		throw r.location = n.err.location, r.originalMessage = n.err.message, r;
	}
	return t?.captureLocation || wc(n.val), n.val;
}
var Ec = ae(((e) => {
	...
	Object.defineProperty(e, "__esModule", { value: !0 }), Ss(), ce(zo), Ec();
})), Oc = Ec();
Dc();
function kc({ icuString: e, shouldVisit: t, visitor: n, options: { recurseIntoVisited: r = !0, ...i } }) {
	let a = Tc(e, i);
	return o(a), a;
	function o(e) {
		e.map(s);
...
var jc = RegExp(`^${Ac}$`);
function Mc(e) {
	return e.type === Oc.TYPE.select && jc.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === Oc.TYPE.literal);
}
function Nc(e) {
	if (!e.includes("_gt_")) return e;
	let t = [];
...
function Pc(e, t) {
	var n = t && t.cache ? t.cache : Wc, r = t && t.serializer ? t.serializer : Hc;
	return (t && t.strategy ? t.strategy : zc)(e, {
		cache: n,
		serializer: r
	});
}
...
function Vc(e, t) {
	return Rc(e, this, Ic, t.cache.create(), t.serializer);
}
var Hc = function() {
...
var qc = function(e) {
	...
	Bo(t, e);
	function t(t, n, r, i) {
		return e.call(this, `Invalid values for "${t}": "${n}". Options are "${Object.keys(r).join("\", \"")}"`, Kc.INVALID_VALUE, i) || this;
	}
	return t;
}(qc), Yc = function(e) {
	Bo(t, e);
	function t(t, n, r) {
		return e.call(this, `Value for "${t}" must be of type ${n}`, Kc.INVALID_VALUE, r) || this;
	}
	return t;
}(qc), Xc = function(e) {
	Bo(t, e);
	function t(t, n) {
		return e.call(this, `The intl string context variable "${t}" was not provided to the string "${n}"`, Kc.MISSING_VALUE, n) || this;
	}
	return t;
}(qc), F;
(function(e) {
...
function $c(e, t, n, r, i, a, o) {
	...
	for (var s = [], c = 0, l = e; c < l.length; c++) {
		...
		if (Ds(u)) {
			var p = typeof u.style == "string" ? r.date[u.style] : Ps(u.style) ? u.style.parsedOptions : void 0;
			s.push({
				type: F.literal,
		...
		if (Os(u)) {
			var p = typeof u.style == "string" ? r.time[u.style] : Ps(u.style) ? u.style.parsedOptions : r.time.medium;
			s.push({
				type: F.literal,
				value: n.getDateTimeFormat(t, p).format(f)
			});
		...
		if (Es(u)) {
			var p = typeof u.style == "string" ? r.number[u.style] : Ns(u.style) ? u.style.parsedOptions : void 0;
		...
		if (Ms(u)) {
			...
			if (!Qc(g)) throw new Yc(h, "function", o);
			var _ = g($c(m, t, n, r, i, a).map(function(e) {
				return e.value;
			}));
		...
		if (ks(u)) {
			...
			if (!v) throw new Jc(u.value, f, Object.keys(u.options), o);
			s.push.apply(s, $c(v.value, t, n, r, i));
			continue;
		}
		if (As(u)) {
			var v = u.options[`=${f}`];
			if (!v) {
				if (!Intl.PluralRules) throw new qc("Intl.PluralRules is not available in this environment.\nTry polyfilling it using \"@formatjs/intl-pluralrules\"\n", Kc.MISSING_INTL_API, o);
				var y = n.getPluralRules(t, { type: u.pluralType }).select(f - (u.offset || 0));
				v = u.options[y] || u.options.other;
			}
			if (!v) throw new Jc(u.value, f, Object.keys(u.options), o);
			s.push.apply(s, $c(v.value, t, n, r, i, f - (u.offset || 0)));
			continue;
		}
	}
	return Zc(s);
...
function rl(e) {
	return e === void 0 && (e = {
		...
		getNumberFormat: Pc(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.NumberFormat).bind.apply(e, ns([void 0], t, !1)))();
		}, {
			cache: nl(e.number),
			strategy: Gc.variadic
		}),
		getDateTimeFormat: Pc(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.DateTimeFormat).bind.apply(e, ns([void 0], t, !1)))();
		}, {
			cache: nl(e.dateTime),
			strategy: Gc.variadic
		}),
		getPluralRules: Pc(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.PluralRules).bind.apply(e, ns([void 0], t, !1)))();
		}, {
			cache: nl(e.pluralRules),
			strategy: Gc.variadic
		})
	};
}
var il = function() {
	function e(t, n, r, i) {
		...
		if (this.formatterCache = {
			...
			return $c(a.ast, a.locales, a.formatters, a.formats, e, void 0, a.message);
			...
			var o = i || {};
			o.formatters;
			var s = Vo(o, ["formatters"]);
			this.ast = e.__parse(t, j(j({}, s), { locale: this.resolvedLocale }));
		} else this.ast = t;
		if (!Array.isArray(this.ast)) throw TypeError("A message must be provided as a String or AST.");
		this.formats = tl(e.formats, r), this.formatters = i && i.formatters || rl(this.formatterCache);
	}
	...
	try {
		...
		})() || A.get("DisplayNames", ["en"], { type: "language" }).of(t) === t && !ol(t) || n && A.get("DisplayNames", ["en"], { type: "region" }).of(n) === n || r && A.get("DisplayNames", ["en"], { type: "script" }).of(r) === r && !al.includes(r));
	} catch {
		return !1;
	}
}, L = (e) => {
...
function cl(...e) {
	try {
		let t = e.flat().map(L);
		for (let e = 0; e < t.length; e++) for (let n = e + 1; n < t.length; n++) if (!sl(t[e], t[n])) return !1;
		return !0;
	} catch (e) {
		return console.error(e), !1;
	}
...
function ul(e, t, n, r) {
	return !(!I(e, r) || !I(t, r) || n && n.some((e) => !I(e, r)) || cl(e, t) || n && !n.some((e) => ll(t, e)));
}
var dl = (e, t, n) => {
	if (e?.[t]) return typeof e[t] == "string" ? n === "name" ? e[t] : void 0 : e[t][n];
}, fl = (e, t) => !!(t?.[e] && typeof t[e] == "object" && "code" in t[e] && t[e].code && I(t[e].code));
function pl(e, t) {
	let n = e;
	t && fl(e, t) && (e = t[e].code);
	try {
		...
		if (s) return s;
		let c = i.maximize();
		return _l[c.language] || xl(c.region || "");
	} catch {
		return gl;
	}
}
var ml = "🌍", hl = "🌏", gl = ml, _l = {
	...
	EU: "🇪🇺",
	419: "🌎"
}, yl = /* @__PURE__ */ new Set(/* @__PURE__ */ "AF.AX.AL.DZ.AS.AD.AO.AI.AQ.AG.AR.AM.AW.AU.AT.AZ.BS.BH.BD.BB.BY.BE.BZ.BJ.BM.BT.BO.BQ.BA.BW.BV.BR.IO.BN.BG.BF.BI.CV.KH.CM.CA.KY.CF.TD.CL.CN.CX.CC.CO.KM.CD.CG.CK.CR.CI.HR.CU.CW.CY.CZ.DK.DJ.DM.DO.EC.EG.SV.GQ.ER.EE.SZ.ET.FK.FO.FJ.FI.FR.GF.PF.TF.GA.GM.GE.DE.GH.GI.GR.GL.GD.GP.GU.GT.GG.GN.GW.GY.HT.HM.VA.HN.HK.HU.IS.IN.ID.IR.IQ.IE.IM.IL.IT.JM.JP.JE.JO.KZ.KE.KI.KP.KR.KW.KG.LA.LV.LB.LS.LR.LY.LI.LT.LU.MO.MG.MW.MY.MV.ML.MT.MH.MQ.MR.MU.YT.MX.FM.MD.MC.MN.ME.MS.MA.MZ.MM.NA.NR.NP.NL.NC.NZ.NI.NE.NG.NU.NF.MK.MP.NO.OM.PK.PW.PS.PA.PG.PY.PE.PH.PN.PL.PT.PR.QA.RE.RO.RU.RW.BL.SH.KN.LC.MF.PM.VC.WS.SM.ST.SA.SN.RS.SC.SL.SG.SX.SK.SI.SB.SO.ZA.GS.SS.ES.LK.SD.SR.SJ.SE.CH.SY.TW.TJ.TZ.TH.TL.TG.TK.TO.TT.TN.TR.TM.TC.TV.UG.UA.AE.GB.US.UM.UY.UZ.VU.VE.VN.VG.VI.WF.EH.YE.ZM.ZW".split(".")), bl = 127397;
function xl(e) {
	return Sl(e) || "🌍";
}
function Sl(e) {
	let t = e.toUpperCase(), n = vl[t];
	if (n) return n;
	if (yl.has(t)) return String.fromCodePoint(t.charCodeAt(0) + bl, t.charCodeAt(1) + bl);
}
function Cl(e, t) {
	if (t) {
		let n = {};
...
function wl(e, t = "en", n) {
	let r = e;
	n && fl(e, n) && (e = n[e].code), t ||= "en";
	try {
		let i = L(e), a = A.get("Locale", e), o = a.language, s = Cl([
			r,
			e,
			i,
			o
		...
		return {
			...
			scriptName: s?.scriptName || (f ? ce.of(f) : "") || "",
			nativeScriptName: s?.nativeScriptName || (f ? le.of(f) : "") || "",
			emoji: s?.emoji || pl(i, n)
		};
	} catch {
		let t = I(e) ? L(e) : e, r = t?.split("-"), i = r?.[0] || t || "", a = r.length > 2 ? r?.[2] : r?.[1] || "", o = r?.[3] || "", s = Cl([t, i], n);
		t = s?.code || t;
		let c = s?.name || t, l = s?.nativeName || c, u = s?.maximizedCode || t, d = s?.maximizedName || c, f = s?.nativeMaximizedName || l, p = s?.minimizedCode || t, m = s?.minimizedName || c, h = s?.nativeMinimizedName || l;
		i = s?.languageCode || i;
		let g = s?.languageName || c, _ = s?.nativeLanguageName || l;
...
function Tl(e, t, n) {
	...
	for (let n of e) {
		let e = t.filter((e) => ll(n, e)), r = ({ locale: t, languageCode: n, minimizedCode: r, regionCode: i, scriptCode: a }) => {
			let o = [
				t,
				`${n}-${i}`,
				`${n}-${a}`,
...
var Al = class {
	...
	handle(e) {
		let t = [];
		this.config.includeTimestamp && t.push(`[${e.timestamp.toISOString()}]`);
		let n = Dl[e.level], r = `[${e.level.toUpperCase()}]`;
		t.push(`${n}${r}${Ol}`), this.config.prefix && t.push(`[${this.config.prefix}]`), this.config.includeContext && e.context && t.push(`[${e.context}]`), t.push(e.message), e.metadata && Object.keys(e.metadata).length > 0 && t.push(`\n  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
		let i = t.join(" ");
		switch (e.level) {
			case "debug":
				console.debug(i);
	...
	constructor(e = {}) {
		this.config = {
			...
			handlers: [],
			...e
		}, this.handlers = [...this.config.handlers || []], this.config.enableConsole && this.handlers.push(new Al(this.config));
	}
	addHandler(e) {
		this.handlers.push(e);
	}
	...
	shouldLog(e) {
		return El[e] >= El[this.config.level];
	}
	log(e, t, n, r) {
		if (!this.shouldLog(e)) return;
		let i = {
...
Nl.child("validation"), Nl.child("formatting"), Nl.child("locale");
var Fl = Nl.child("GT instance");
function Il({ value: e, locales: t = "en", options: n = {} }) {
	return A.get("CutoffFormat", t, n).format(e);
}
function Ll(e, t = "en", n = {}) {
	return new il(e, t).format(n)?.toString() ?? "";
}
function Rl(e) {
	return e;
}
...
function Vl({ value: e, locales: t = ["en"], currency: n = "USD", options: r = {} }) {
	return A.get("NumberFormat", t, {
		style: "currency",
		currency: n,
		numberingSystem: "latn",
...
function Ul({ value: e, locales: t = ["en"], options: n = {} }) {
...
function Gl({ date: e, baseDate: t, locales: n = ["en"], options: r = {} }) {
	let { value: i, unit: a } = Wl(e, t);
	return Kl({
		value: i,
		unit: a,
		locales: n,
...
function Kl({ value: e, unit: t, locales: n = ["en"], options: r = {} }) {
...
function Jl(e) {
	try {
		let t = Zl(A.get("Locale", e));
		if (t) return t;
	} catch {}
	let { scriptCode: t, languageCode: n } = wl(e);
	return t ? Ql(t) ? "rtl" : "ltr" : n && $l(n) ? "rtl" : "ltr";
}
...
function $l(e) {
	return e ? Xl.has(e.toLowerCase()) : !1;
}
function eu(e, t) {
	try {
...
var ru = class {
	...
	formatMessage(e, t, n = {}) {
		let { locales: r, variables: i, dataFormat: a } = n;
		return a === "STRING" ? Rl(e) : Ll(e, this.getFormattingLocales(t, r), i);
	}
	formatList(e, t, n = {}) {
		let { locales: r, ...i } = n;
		return Hl({
	...
	getLocaleName(e) {
		return ql(e, this.defaultLocale, this.customMapping);
	}
	getLocaleEmoji(e) {
		return pl(e, this.customMapping);
	}
	getLocaleProperties(e) {
		return wl(e, this.defaultLocale, this.customMapping);
	}
	requiresTranslation(e, t = this.defaultLocale, n = this.translationLocales) {
		return ul(this.resolveCanonicalLocale(t), this.resolveCanonicalLocale(e), n ? this.resolveCanonicalLocaleList(n) : void 0, this.customMapping);
	}
	determineLocale(e, t = this.locales) {
		let n = t.map((e) => ({
			locale: e,
			canonicalLocale: this.resolveCanonicalLocale(e)
		})), r = Tl(Array.isArray(e) ? this.resolveCanonicalLocaleList(e) : this.resolveCanonicalLocale(e), n.map(({ canonicalLocale: e }) => e), this.customMapping);
		if (r) return n.find(({ canonicalLocale: e }) => e === r)?.locale || this.resolveAliasLocale(r);
	}
	getLocaleDirection(e) {
		return Jl(this.resolveCanonicalLocale(e));
	}
	isValidLocale(e) {
		return I(e, this.customMapping);
	}
	resolveCanonicalLocale(e) {
		return nu(e, this.customMapping);
	}
	resolveAliasLocale(e) {
	...
	isSameLanguage(...e) {
		return ll(...this.resolveCanonicalLocaleArgs(e));
	}
	isSupersetLocale(e, t) {
		return eu(this.resolveCanonicalLocale(e), this.resolveCanonicalLocale(t));
	}
};
function iu(e, t) {
	return I(e, t);
...
function uu({ source: e, context: t, id: n, maxChars: r, dataFormat: i }, a = lu) {
	let o;
	return o = i === "JSX" ? fu(e) : e, a(Lo({
		source: o,
		...n && { id: n },
		...t && { context: t },
		...r != null && { maxChars: Math.abs(r) },
...
function fu(e) {
	return Array.isArray(e) ? e.map(du) : du(e);
}
var pu = "GT Error:", mu = (e) => `${pu} Translation request timed out after ${e}ms.`, hu = (e) => `${pu} Translation request failed. Error: ${e}`, gu = (e, t, n) => `${pu} API returned error status. Status: ${e}, Status Text: ${t}, Error: ${n}`, R = (e) => `${pu} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a targetLocale in the GT constructor.`, _u = (e) => `${pu} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a sourceLocale in the GT constructor.`, vu = (e) => `${pu} Cannot call \`${e}\` without a specified project ID. Either pass a project ID to the \`${e}\` function or specify a projectId in the GT constructor.`, yu = (e) => `${pu} Cannot call \`${e}\` without a specified API key. Either pass an API key to the \`${e}\` function or specify an apiKey in the GT constructor.`, bu = (e) => `${pu} Invalid locale: ${e}.`, xu = (e) => `${pu} Invalid locales: ${e.join(", ")}.`;
async function Su(e, t, n) {
	...
	try {
		...
		throw e instanceof Error && e.name === "AbortError" ? mu(n) : e;
	} finally {
		a && clearTimeout(a);
	}
}
async function Cu(e) {
	if (!e.ok) {
		...
		throw new cu(gu(e.status, e.statusText, t), e.status, t);
	}
}
function wu(e, t) {
	...
	let n = hu(e instanceof Error ? e.message : String(e));
	throw Pl.error(n), e;
}
var Tu = "2026-03-06.v1";
function Eu(e, t = !1) {
	let n = {
		...!t && { "Content-Type": "application/json" },
		"x-gt-project-id": e.projectId
	};
	return e.apiKey && (e.apiKey.startsWith("gtx-internal-") ? n["x-gt-internal-api-key"] = e.apiKey : n["x-gt-api-key"] = e.apiKey), n["gt-api-version"] = Tu, n;
}
var Du = 3, Ou = 500;
function ku(e) {
...
function Au(e, t) {
	switch (e) {
		case "linear": return Ou * (t + 1);
		case "exponential": return Ou * 2 ** t;
		default: return 0;
	}
}
async function z(e, t, n) {
	let r = n?.timeout ?? 6e4, i = `${e.baseUrl || "https://api2.gtx.dev"}${t}`, a = n?.method ?? "POST", o = n?.retryPolicy ?? "exponential", s = o === "none" ? 0 : Du, c = {
		method: a,
		headers: Eu(e)
	};
	...
	for (let e = 0; e <= s; e++) {
		...
		return await Cu(t), await t.json();
	}
	throw Error("Max retries exceeded");
}
async function ju(e, t, n, r) {
	let i = Array.isArray(e), a = i ? [] : void 0, o = {}, s = i ? e.map((e) => [void 0, e]) : Object.entries(e);
	for (let [e, t] of s) {
		let { source: n, metadata: r } = typeof t == "string" ? { source: t } : t, i = e ?? r?.hash ?? uu({
			source: n,
			dataFormat: r?.dataFormat ?? "STRING",
			...r ?? {}
		});
...
async function Lu(e, t, n) {
	return Pu(e, async (e) => (await z(n, "/v2/project/files/download", {
		body: e,
		timeout: t.timeout
	})).files.map((e) => ({
		...e,
...
async function Ru(e, t, n = {}) {
	return await Pu(e.diffs, async (e) => (await z(t, "/v2/project/files/diffs", {
		body: { diffs: e },
		timeout: n.timeout
	}), [{ success: !0 }]), { batchSize: 100 }), { success: !0 };
}
function zu(e, t = "en", n) {
	t ||= "en";
	try {
		return {
			code: e,
...
async function Bu(e, t, n) {
	return Pu(e, async (e) => (await z(n, "/v2/project/files/upload-files", {
		body: {
			data: e.map(({ source: e }) => ({ source: {
				content: Po(e.content),
				fileName: e.fileName,
...
async function Vu(e, t, n) {
	return No(e.map(({ source: e }) => e)), Pu(e, async (e) => (await z(n, "/v2/project/files/upload-translations", {
		body: {
...
async function Uu(e, t, n) {
	let { baseUrl: r } = n, i = t.timeout ? t.timeout : Co, a = `${r || "https://api2.gtx.dev"}/v2/project/info/${encodeURIComponent(e)}`, o;
	try {
		o = await Su(a, {
			method: "GET",
			headers: Eu(n)
	...
	return await Cu(o), await o.json();
}
...
async function Yu(e, t, n) {
	...
	let r = await Pu(e, async (e) => (await z(n, "/v2/project/files/moves", {
		body: {
			branchId: t.branchId,
			moves: e
		},
...
async function Xu(e, t, n = {}, r) {
	...
	let a = Nu(t, 100), o = await Promise.all(a.map((e) => i(e)));
...
var Qu = class {
	...
	setConfig({ apiKey: e, devApiKey: t, sourceLocale: n, targetLocale: r, locales: i, projectId: a, customMapping: o, baseUrl: s }) {
		if (e && (this.apiKey = e), t && (this.devApiKey = t), a && (this.projectId = a), n && (this.sourceLocale = L(n), !I(this.sourceLocale, o))) throw Error(bu(this.sourceLocale));
		if (r && (this.targetLocale = L(r), !I(this.targetLocale, o))) throw Error(bu(this.targetLocale));
		if (i) {
			let e = [], t = [];
			if (i.forEach((n) => {
				let r = L(n);
				I(r) ? e.push(r) : t.push(n);
			}), t.length > 0) throw Error(xu(t));
			this.locales = e;
		}
		s && (this.baseUrl = s), o && (this.customMapping = o, this.reverseCustomMapping = Object.fromEntries(Object.entries(o).filter(([, e]) => e && typeof e == "object" && "code" in e).map(([e, t]) => [t.code, e]))), this._localeConfig = new ru({
			defaultLocale: this.sourceLocale,
			locales: this.locales ?? [],
			customMapping: this.customMapping
		});
	...
	async queryBranchData(e) {
		return this._validateAuth("queryBranchData"), await qu(e, this._getTranslationConfig());
	}
	async createBranch(e) {
		return this._validateAuth("createBranch"), await Ju(e, this._getTranslationConfig());
	}
	async processFileMoves(e, t = {}) {
		return this._validateAuth("processFileMoves"), await Yu(e, t, this._getTranslationConfig());
	}
	async getOrphanedFiles(e, t, n = {}) {
		return this._validateAuth("getOrphanedFiles"), await Xu(e, t, n, this._getTranslationConfig());
	}
	async setupProject(e, t) {
		return this._validateAuth("setupProject"), t = {
			...t,
			locales: t?.locales?.map((e) => this.resolveCanonicalLocale(e))
		}, await Mu(e, this._getTranslationConfig(), t);
	}
	async checkJobStatus(e, t) {
		return this._validateAuth("checkJobStatus"), await Wu(e, this._getTranslationConfig(), t);
	}
	async awaitJobs(e, t) {
		return this._validateAuth("awaitJobs"), await Gu(e, t, this._getTranslationConfig());
	}
	async enqueueFiles(e, t) {
		...
		if (!n.sourceLocale) {
			let e = _u("enqueueFiles");
			throw Fl.error(e), Error(e);
		}
		...
		}, await Fu(e, n, this._getTranslationConfig());
	}
	async createTag(e) {
		return this._validateAuth("createTag"), await Iu(e, this._getTranslationConfig());
	}
	async publishFiles(e) {
		return this._validateAuth("publishFiles"), await Zu(e, this._getTranslationConfig());
	}
	async submitUserEditDiffs(e) {
		this._validateAuth("submitUserEditDiffs"), await Ru({
			...e,
			diffs: (e.diffs || []).map((e) => ({
				...e,
	...
	async downloadFile(e, t = {}) {
		return this._validateAuth("downloadTranslatedFile"), (await Lu([{
			fileId: e.fileId,
			branchId: e.branchId,
	...
	async uploadSourceFiles(e, t) {
		...
		let r = await Bu(e, n, this._getTranslationConfig());
		return {
	...
	async uploadTranslations(e, t) {
		...
		if (!n.sourceLocale) {
			let e = _u("uploadTranslations");
			throw Fl.error(e), Error(e);
		}
		let r = await Vu(e.map((e) => ({
			...e,
	...
	getRegionProperties(e = this.getLocaleProperties().regionCode, t) {
		...
		return zu(e, this.targetLocale, t);
	}
	requiresTranslation(e = this.sourceLocale, t = this.targetLocale, n = this.locales, r = this.customMapping) {
		if (!e) throw Error(_u("requiresTranslation"));
		if (!t) throw Error(R("requiresTranslation"));
		return r === this.customMapping ? this.localeConfig.requiresTranslation(t, e, n) : ul(e, t, n, r);
	}
	determineLocale(e, t = this.locales || [], n = this.customMapping) {
		return n === this.customMapping ? this.localeConfig.determineLocale(e, t ?? []) : Tl(e, t, n);
	}
	getLocaleDirection(e = this.targetLocale) {
	...
	resolveCanonicalLocale(e = this.targetLocale, t = this.customMapping) {
		...
		return t === this.customMapping ? this.localeConfig.resolveCanonicalLocale(e) : nu(e, t);
	}
	resolveAliasLocale(e, t = this.customMapping) {
		if (!e) throw Error(R("resolveAliasLocale"));
		return t === this.customMapping ? this.localeConfig.resolveAliasLocale(e) : tu(e, t);
	}
	standardizeLocale(e = this.targetLocale) {
...
function id(e, t = "", n = !0) {
	if (e.forEach((e) => {
		switch (e.type) {
			case "error":
				su.error(t + e.message);
				break;
			case "warning": su.warn(t + e.message);
		}
...
function dd(e) {
	let t = [];
	return t.push(...od(e)), t.push(...cd(e)), t.push(...ud(e)), t;
}
var fd = class {}, pd = "fallback-storage-adapter", md = class extends fd {
	constructor(...e) {
		super(...e), this.type = pd, this.storage = {};
	}
	getItem(e) {
...
function _d(e) {
	let { cacheUrl: t = ko, projectId: n, _versionId: r, _branchId: i } = e, a = r ? `/${r}` : "", o = i ? `?branchId=${i}` : "";
	return `${t}/${n}/[locale]` + a + o;
}
function vd() {
	return async (e) => ({});
}
function yd({ type: e, remoteTranslationLoaderParams: t, loadTranslations: n }) {
	e === "disabled" && su.warn("I18nManager: No translation loader found. No translations will be loaded.");
	let { cacheUrl: r, projectId: i, _versionId: a, _branchId: o, customMapping: s } = t;
	switch (e) {
		case "remote":
		case "gt-remote": return gd({
			cacheUrl: r || "",
			projectId: i || "",
			_versionId: a,
			_branchId: o,
...
var Sd = 25, Cd = 100, wd = 50, Td = class extends bd {
	...
	genKey(e) {
		return xd(e.message, e.options);
	}
	fallback(e) {
		let t = this._enqueueTranslation(e);
		return this._queue.length >= Sd ? this._flushNow() : this._scheduleBatch(), t;
	}
	_flushNow() {
	...
	_drainQueue() {
		for (; this._queue.length > 0 && this._activeRequests < Cd;) {
			let e = this._queue.splice(0, Sd);
	...
	async _sendBatchRequest(e) {
		...
		let t = Ed(e), n = await this._sendBatchRequestWithErrorHandling(e, t);
...
var Dd = 6e4, Od = class extends bd {
	constructor({ init: e = {}, ttl: t, loadTranslations: n, createTranslateMany: r, lifecycle: { onLocalesCacheHit: i, onLocalesCacheMiss: a, onTranslationsCacheHit: o, onTranslationsCacheMiss: s } }) {
		super(e, {
			onHit: i,
			onMiss: a
		}), this.ttl = Dd, this.ttl = t === null ? -1 : t ?? 6e4, this._translationLoader = n, this._createTranslateMany = r, this._onTranslationsCacheHit = o, this._onTranslationsCacheMiss = s;
	}
	get(e) {
		let t = this.getCache(e);
...
function jd({ onLocalesCacheHit: e, onLocalesCacheMiss: t, onTranslationsCacheHit: n, onTranslationsCacheMiss: r }, i) {
...
var Md = 12e3, Nd = class extends Ad {
	constructor(e) {
		super(), this.resolveTranslationSync = (e, t = {}) => this.lookupTranslation(e, t), id(dd(e), "I18nManager: "), this.config = Pd(e), this.localeConfig = new ru({
			defaultLocale: this.config.defaultLocale,
			locales: this.config.locales,
			customMapping: this.config.customMapping
		}), this.storeAdapter = e.storeAdapter ?? new md();
		let t = Rd(e), n = hd(this.getGTClassClean(), Md);
		jd(e.lifecycle ?? {}, (...e) => this.subscribe(...e)), this.localesCache = new Od({
			loadTranslations: t,
			createTranslateMany: n,
			lifecycle: kd((...e) => this.emit(...e))
		});
	}
	...
	getLocale() {
		return this.storeAdapter.getItem("locale") || (su.warn("getLocale() invoked outside of translation context, falling back to default locale"), this.config.defaultLocale);
	}
	setLocale(e) {
		try {
	...
	async getLookupTranslation(e = this.getLocale(), t = []) {
		try {
			...
			let r = Ld(t, n, (e) => this.resolveLocale(e));
			r.length !== t.length && su.warn(`I18nManager: getLookupTranslation(): prefetchEntries must all be the same locale, ignoring all entries that are not for ${n}`);
			let i = this.localesCache.get(n);
	...
	handleError(e) {
		switch (this.config.environment) {
			...
			default: su.error("I18nManager: " + e);
		}
	}
	resolveLocale(e) {
...
function Fd({ defaultLocale: e, locales: t, customMapping: n }) {
	return {
		defaultLocale: e,
...
function Id(e) {
	return {
		defaultLocale: ou(e.defaultLocale),
		locales: e.locales.map((t) => (typeof e.customMapping?.[t] == "string" ? e.customMapping?.[t] : e.customMapping?.[t]?.code) ? t : ou(t)),
		customMapping: Object.fromEntries(Object.entries(e.customMapping || {}).map(([e, t]) => [e, typeof t == "string" ? ou(t) : {
			...t,
			...t.code ? { code: ou(t.code) } : {}
		}]))
	};
}
function Ld(e, t, n) {
...
var zd = void 0;
function Bd() {
	return zd ||= (su.warn("getI18nManager(): Translation failed because I18nManager not initialized."), new Nd({
		defaultLocale: "en",
		locales: ["en"]
	})), zd;
}
...
var Hd = "DEFAULT_TERMINATOR_KEY", Ud = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	CutoffFormat: class {
		constructor(e, t = {}) {
			...
			if (!Ud[t.style ?? "ellipsis"]) throw Error(((e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`)(t.style ?? "ellipsis"));
			let n, r;
			if (t.maxChars !== void 0) {
				n = t.style ?? "ellipsis";
				let e = new Intl.Locale(this.locale).language;
				r = Ud[n][e] || Ud[n].DEFAULT_TERMINATOR_KEY;
			}
			let i = t.terminator ?? r?.terminator, a = i == null ? void 0 : t.separator ?? r?.separator;
			this.additionLength = (i?.length ?? 0) + (a?.length ?? 0), t.maxChars !== void 0 && Math.abs(t.maxChars) < this.additionLength && (i = void 0, a = void 0), this.options = {
				maxChars: t.maxChars,
...
new class {
	...
	get(e, ...t) {
		let [n = "en", r = {}] = t, i = this._generateKey(n, r), a = this.cache[e]?.[i];
		return a === void 0 && (a = new Wd[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}();
function Gd(e, t, n = "") {
...
var Qd = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = Jd(this.buffer);
	}
	update(e) {
		Kd(this), Gd(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		Kd(this), function(e, t) {
			Gd(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, qd(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = Jd(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), tf = /* @__PURE__ */ new Uint32Array(64), nf = class extends Qd {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) tf[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = tf[e - 15], n = tf[e - 2], r = Yd(t, 7) ^ Yd(t, 18) ^ t >>> 3, i = Yd(n, 17) ^ Yd(n, 19) ^ n >>> 10;
			tf[e] = i + tf[e - 7] + r + tf[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (Yd(o, 6) ^ Yd(o, 11) ^ Yd(o, 25)) + Xd(o, s, c) + ef[e] + tf[e] | 0, u = (Yd(n, 2) ^ Yd(n, 13) ^ Yd(n, 22)) + Zd(n, r, i) | 0;
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), qd(this.buffer);
	}
}, rf = class extends nf {
	A = 0 | $d[0];
	B = 0 | $d[1];
...
(function(e, t = {}) {
	let n = (t, n) => e(n).update(t).digest(), r = e(void 0);
	return n.outputLen = r.outputLen, n.blockLen = r.blockLen, n.canXOF = r.canXOF, n.create = (t) => e(t), Object.assign(n, t), Object.freeze(n);
})(() => new rf(), (af = 1, { oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
function Sf() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(xf(arguments[t]));
	return e;
}
function Cf() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function Tf(e) {
	return this instanceof Tf ? (this.v = e, this) : new Tf(e);
}
function Ef(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof Tf ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function Of(e) {
	...
	return n ? n.call(e) : (e = bf(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var Af = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return jf = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, jf(e);
...
function Mf(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = jf(e), r = 0; r < n.length; r++) n[r] !== "default" && vf(t, e, n[r]);
	return Af(t, e), t;
}
function Nf(e) {
	return e && e.__esModule ? e : { default: e };
...
var Rf = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function zf(e) {
	function t(t) {
		e.error = e.hasError ? new Rf(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var Uf = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, Wf = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Gf(e) {
	var t = {};
	return e.replace(Wf, function(e) {
		var n = e.length;
		switch (e[0]) {
			case "G":
				t.era = n === 4 ? "long" : n === 5 ? "narrow" : "short";
...
var Jf = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, Yf = /^(@+)?(\+|#+)?[rs]?$/g, Xf = /(\*)(0+)|(#+)(0+)|(0+)/g, Zf = /^(0+)$/;
function Qf(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(Yf, function(e, n, r) {
		return typeof r == "string" ? r === "+" ? t.minimumSignificantDigits = n.length : n[0] === "#" ? t.maximumSignificantDigits = n.length : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length + (typeof r == "string" ? r.length : 0)) : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length), "";
	}), t;
}
function $f(e) {
...
function ep(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !Zf.test(e)) throw Error("Malformed concise eng/scientific notation");
		t.minimumIntegerDigits = e.length;
	}
	return t;
}
...
function np(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "measure-unit":
			case "unit":
				t.style = "unit", t.unit = qf(i.options[0]);
				continue;
			case "compact-short":
			case "K":
				t.notation = "compact", t.compactDisplay = "short";
			...
			case "integer-width":
				if (i.options.length > 1) throw RangeError("integer-width stems only accept a single optional option");
				i.options[0].replace(Xf, function(e, n, r, i, a, o) {
					if (n) t.minimumIntegerDigits = r.length;
					else {
		...
		if (Zf.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
		else if (Jf.test(i.stem)) {
			if (i.options.length > 1) throw RangeError("Fraction-precision stems only accept a single optional option");
			i.stem.replace(Jf, function(e, n, r, i, a, o) {
				return r === "*" ? t.minimumFractionDigits = n.length : i && i[0] === "#" ? t.maximumFractionDigits = i.length : a && o ? (t.minimumFractionDigits = a.length, t.maximumFractionDigits = a.length + o.length) : (t.minimumFractionDigits = n.length, t.maximumFractionDigits = n.length), "";
			});
			var a = i.options[0];
			a === "w" ? t = B(B({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = B(B({}, t), Qf(a)));
		} else if (Yf.test(i.stem)) t = B(B({}, t), Qf(i.stem));
		else {
			var o = $f(i.stem);
			o && (t = B(B({}, t), o));
			var s = ep(i.stem);
...
function ip(e) {
	...
	var n, r = e.language;
	return r !== "root" && (n = e.maximize().region), (rp[n || ""] || rp[r || ""] || rp[`${r}-001`] || rp["001"])[0];
}
var ap = RegExp(`^${Uf.source}*`), op = RegExp(`${Uf.source}*\$`);
function U(e, t) {
	return {
		start: e,
		end: t
...
var sp = !!String.prototype.startsWith && "_a".startsWith("a", 1), cp = !!String.fromCodePoint, lp = !!Object.fromEntries, up = !!String.prototype.codePointAt, dp = !!String.prototype.trimStart, fp = !!String.prototype.trimEnd, pp = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, mp = !0;
try {
	mp = Sp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	mp = !1;
}
var hp, gp = sp ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, _p = cp ? String.fromCodePoint : function() {
	...
	return n;
}, vp = lp ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
if (mp) {
	var Cp = Sp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	hp = function(e, t) {
		return Cp.lastIndex = t, Cp.exec(e)[1] ?? "";
	};
} else hp = function(e, t) {
	for (var n = [];;) {
		var r = yp(e, t);
		if (r === void 0 || Ep(r) || Dp(r)) break;
		n.push(r), t += r >= 65536 ? 2 : 1;
	}
	return _p.apply(void 0, n);
};
(function() {
	function e(e, t) {
		t === void 0 && (t = {}), this.message = e, this.position = {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			if (i === 123) {
				...
				if (i !== 35 || t !== "plural" && t !== "selectordinal") {
					...
					if (i === 60 && !this.ignoreTag && wp(this.peek() || 0)) {
		...
		if (this.bumpIf(">")) {
			...
			var a = i.val, o = this.clonePosition();
			if (this.bumpIf("</")) {
				if (this.isEOF() || !wp(this.char())) return this.error(V.INVALID_TAG, U(o, this.clonePosition()));
				var s = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					val: {
						type: H.tag,
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && Tp(this.char());) this.bump();
		return this.message.slice(e, this.offset());
	}, e.prototype.parseLiteral = function(e, t) {
		for (var n = this.clonePosition(), r = "";;) {
			var i = this.tryParseQuote(t);
		...
		return this.isEOF() || this.char() !== 60 || !this.ignoreTag && (wp(e = this.peek() || 0) || e === 47) ? null : (this.bump(), "<");
		var e;
	}, e.prototype.tryParseQuote = function(e) {
		if (this.isEOF() || this.char() !== 39) return null;
		switch (this.peek()) {
		...
		return _p.apply(void 0, t);
	}, e.prototype.tryParseUnquoted = function(e, t) {
		if (this.isEOF()) return null;
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), _p(n));
	}, e.prototype.parseArgument = function(e, t) {
		var n = this.clonePosition();
		...
		var e = this.clonePosition(), t = this.offset(), n = hp(this.message, t), r = t + n.length;
		return this.bumpTo(r), {
			value: n,
		...
		switch (a) {
			...
			case "time":
				...
				if (this.bumpIf(",")) {
					...
					if ((f = xp(g.val)).length === 0) return this.error(V.EXPECT_ARGUMENT_STYLE, U(this.clonePosition(), this.clonePosition()));
					s = {
						style: f,
				...
				if (s && gp(s?.style, "::", 0)) {
					...
					this.locale && (d = function(e, t) {
						for (var n = "", r = 0; r < e.length; r++) {
							...
							if (i === "j") {
								for (var a = 0; r + 1 < e.length && e.charAt(r + 1) === i;) a++, r++;
								var o = 1 + (1 & a), s = a < 2 ? 1 : 3 + (a >> 1), c = ip(t);
					...
					var f = {
						...
						pattern: d,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? Gf(d) : {}
					};
					return {
						val: {
		...
		try {
			n = function(e) {
				if (e.length === 0) throw Error("Number skeleton cannot be empty");
				for (var t = [], n = 0, r = e.split(Kf).filter(function(e) {
					return e.length > 0;
				}); n < r.length; n++) {
					var i = r[n].split("/");
		...
		return {
			val: {
				...
				tokens: n,
				location: t,
				parsedOptions: this.shouldParseSkeletons ? np(n) : {}
			},
			err: null
		};
	}, e.prototype.tryParsePluralOrSelectOptions = function(e, t, n, r) {
		...
		if (gp(this.message, e, this.offset())) {
			for (var t = 0; t < e.length; t++) this.bump();
			return !0;
		}
		return !1;
...
var Op, W = {};
function kp() {
	return Op || (Op = 1, Object.defineProperty(W, "__esModule", { value: !0 }), W.SKELETON_TYPE = W.TYPE = void 0, W.isLiteralElement = function(t) {
...
(function() {
	if (Ap) return jp;
	Ap = 1, Object.defineProperty(jp, "__esModule", { value: !0 }), jp.printAST = n, jp.doPrintAST = r, jp.printDateTimeSkeleton = o;
	var e = Mp, t = kp();
	function n(e) {
		return r(e, !1);
	}
...
var Np = "_gt_";
RegExp(`^${Np}\\d+$`), RegExp(`^${Np}$`);
var Pp = "generaltranslation.locale";
e.use;
var Fp = {
	af: ["af"],
	am: ["am"],
...
function Ip(e) {
	if (!iu(e)) return null;
	e = ou(e);
	let { languageCode: t, ...n } = $u(e);
	if (Fp[t]?.length) {
		let r = Fp[t], i = ({ locale: e, languageCode: t, minimizedCode: n, regionCode: i, scriptCode: a }) => {
			let o = [
				e,
				`${t}-${i}`,
				`${t}-${a}`,
...
function Rp(e = {}, t) {
	return e.name ? e.name : `_gt_${Lp[t] || "value"}_${e["data-_gt"]?.id}`;
}
var zp = "en", Bp = "DEFAULT_TERMINATOR_KEY", Vp = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	CutoffFormat: class {
		constructor(e, t = {}) {
			...
			if (!Vp[t.style ?? "ellipsis"]) throw Error(((e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`)(t.style ?? "ellipsis"));
			let n, r;
			if (t.maxChars !== void 0) {
				n = t.style ?? "ellipsis";
				let e = new Intl.Locale(this.locale).language;
				r = Vp[n][e] || Vp[n].DEFAULT_TERMINATOR_KEY;
			}
			let i = t.terminator ?? r?.terminator, a = i == null ? void 0 : t.separator ?? r?.separator;
			this.additionLength = (i?.length ?? 0) + (a?.length ?? 0), t.maxChars !== void 0 && Math.abs(t.maxChars) < this.additionLength && (i = void 0, a = void 0), this.options = {
				maxChars: t.maxChars,
...
new class {
	...
	get(e, ...t) {
		let [n = "en", r = {}] = t, i = this._generateKey(n, r), a = this.cache[e]?.[i];
		return a === void 0 && (a = new Hp[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}();
var Up = "https://cdn.gtx.dev", Wp = "https://runtime2.gtx.dev";
function Gp(e) {
	if (e === void 0) return;
	if (e === null) return "null";
	if (typeof e == "number") return isFinite(e) ? "" + e : "null";
	...
	if (Array.isArray(e)) {
		let t = "[";
		for (let n = 0; n < e.length; n++) n && (t += ","), t += Gp(e[n]) || "null";
		return t + "]";
	}
	let t = Object.keys(e).sort(), n = "";
	for (let r of t) {
...
var $p = typeof Uint8Array.from([]).toHex == "function" && typeof Uint8Array.fromHex == "function", em = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function tm(e, t = {}) {
	let n = (t, n) => e(n).update(t).digest(), r = e(void 0);
	return n.outputLen = r.outputLen, n.blockLen = r.blockLen, n.canXOF = r.canXOF, n.create = (t) => e(t), Object.assign(n, t), Object.freeze(n);
}
var nm = (e) => ({ oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
var am = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = Zp(this.buffer);
	}
	update(e) {
		Yp(this), Jp(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		Yp(this), function(e, t) {
			Jp(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, Xp(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = Zp(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), cm = /* @__PURE__ */ new Uint32Array(64), lm = class extends am {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) cm[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = cm[e - 15], n = cm[e - 2], r = Qp(t, 7) ^ Qp(t, 18) ^ t >>> 3, i = Qp(n, 17) ^ Qp(n, 19) ^ n >>> 10;
			cm[e] = i + cm[e - 7] + r + cm[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (Qp(o, 6) ^ Qp(o, 11) ^ Qp(o, 25)) + rm(o, s, c) + sm[e] + cm[e] | 0, u = (Qp(n, 2) ^ Qp(n, 13) ^ Qp(n, 22)) + im(n, r, i) | 0;
			l = c, c = s, s = o, o = a + t | 0, a = i, i = r, r = n, n = t + u | 0;
		}
		n = n + this.A | 0, r = r + this.B | 0, i = i + this.C | 0, a = a + this.D | 0, o = o + this.E | 0, s = s + this.F | 0, c = c + this.G | 0, l = l + this.H | 0, this.set(n, r, i, a, o, s, c, l);
	}
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), Xp(this.buffer);
	}
}, um = class extends lm {
	A = 0 | om[0];
	B = 0 | om[1];
...
}, dm = tm(() => new um(), nm(1)), fm = function(e, t) {
	return fm = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, fm(e, t);
...
function pm(e, t) {
	...
	fm(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var G = function() {
...
var wm = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function Tm(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || wm(t, e, n);
}
function Em(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function Om() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(Dm(arguments[t]));
	return e;
}
function km() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function jm(e) {
	return this instanceof jm ? (this.v = e, this) : new jm(e);
}
function Mm(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var r, i = n.apply(e, t || []), a = [];
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof jm ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function Pm(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = Em(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var Im = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return Lm = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, Lm(e);
...
function Rm(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = Lm(e), r = 0; r < n.length; r++) n[r] !== "default" && wm(t, e, n[r]);
	return Im(t, e), t;
}
function zm(e) {
	return e && e.__esModule ? e : { default: e };
...
var Wm = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function Gm(e) {
	function t(t) {
		e.error = e.hasError ? new Wm(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var K, q, qm, Jm = Object.freeze({
	__proto__: null,
	__addDisposableResource: Um,
	get __assign() {
		return G;
	},
	__asyncDelegator: Nm,
	...
	__await: jm,
	__awaiter: Sm,
	__classPrivateFieldGet: Bm,
	__classPrivateFieldIn: Hm,
	__classPrivateFieldSet: Vm,
	__createBinding: wm,
	__decorate: hm,
	__disposeResources: Gm,
	__esDecorate: _m,
	__exportStar: Tm,
	__extends: pm,
	__generator: Cm,
	__importDefault: zm,
	__importStar: Rm,
	__makeTemplateObject: Fm,
	__metadata: xm,
	__param: gm,
	__propKey: ym,
	__read: Dm,
	__rest: mm,
	__rewriteRelativeImportExtension: Km,
	__runInitializers: vm,
	__setFunctionName: bm,
	__spread: Om,
	__spreadArray: Am,
	__spreadArrays: km,
	__values: Em,
...
var Ym = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, Xm = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Zm(e) {
	var t = {};
	return e.replace(Xm, function(e) {
		var n = e.length;
		switch (e[0]) {
			case "G":
				t.era = n === 4 ? "long" : n === 5 ? "narrow" : "short";
...
var eh = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, th = /^(@+)?(\+|#+)?[rs]?$/g, nh = /(\*)(0+)|(#+)(0+)|(0+)/g, rh = /^(0+)$/;
function ih(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(th, function(e, n, r) {
		return typeof r == "string" ? r === "+" ? t.minimumSignificantDigits = n.length : n[0] === "#" ? t.maximumSignificantDigits = n.length : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length + (typeof r == "string" ? r.length : 0)) : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length), "";
	}), t;
}
function ah(e) {
...
function oh(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !rh.test(e)) throw Error("Malformed concise eng/scientific notation");
		t.minimumIntegerDigits = e.length;
	}
	return t;
}
...
function ch(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "measure-unit":
			case "unit":
				t.style = "unit", t.unit = $m(i.options[0]);
				continue;
			case "compact-short":
			case "K":
				t.notation = "compact", t.compactDisplay = "short";
			...
			case "integer-width":
				if (i.options.length > 1) throw RangeError("integer-width stems only accept a single optional option");
				i.options[0].replace(nh, function(e, n, r, i, a, o) {
					if (n) t.minimumIntegerDigits = r.length;
					else {
						if (i && a) throw Error("We currently do not support maximum integer digits");
						if (o) throw Error("We currently do not support exact integer digits");
		...
		if (rh.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
		else if (eh.test(i.stem)) {
			if (i.options.length > 1) throw RangeError("Fraction-precision stems only accept a single optional option");
			i.stem.replace(eh, function(e, n, r, i, a, o) {
				return r === "*" ? t.minimumFractionDigits = n.length : i && i[0] === "#" ? t.maximumFractionDigits = i.length : a && o ? (t.minimumFractionDigits = a.length, t.maximumFractionDigits = a.length + o.length) : (t.minimumFractionDigits = n.length, t.maximumFractionDigits = n.length), "";
			});
			var a = i.options[0];
			a === "w" ? t = G(G({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = G(G({}, t), ih(a)));
		} else if (th.test(i.stem)) t = G(G({}, t), ih(i.stem));
		else {
			var o = ah(i.stem);
			o && (t = G(G({}, t), o));
			var s = oh(i.stem);
...
function uh(e) {
	...
	var n, r = e.language;
	return r !== "root" && (n = e.maximize().region), (lh[n || ""] || lh[r || ""] || lh[`${r}-001`] || lh["001"])[0];
}
var dh = RegExp(`^${Ym.source}*`), fh = RegExp(`${Ym.source}*\$`);
function J(e, t) {
	return {
		start: e,
		end: t
...
var ph = !!String.prototype.startsWith && "_a".startsWith("a", 1), mh = !!String.fromCodePoint, hh = !!Object.fromEntries, gh = !!String.prototype.codePointAt, _h = !!String.prototype.trimStart, vh = !!String.prototype.trimEnd, yh = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, bh = !0;
try {
	bh = Oh("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	bh = !1;
}
var xh, Sh = ph ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, Ch = mh ? String.fromCodePoint : function() {
	for (var e = [...arguments], t, n = "", r = e.length, i = 0; r > i;) {
		if ((t = e[i++]) > 1114111) throw RangeError(t + " is not a valid code point");
		n += t < 65536 ? String.fromCharCode(t) : String.fromCharCode(55296 + ((t -= 65536) >> 10), t % 1024 + 56320);
	}
	return n;
}, wh = hh ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
if (bh) {
	var kh = Oh("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	xh = function(e, t) {
		return kh.lastIndex = t, kh.exec(e)[1] ?? "";
	};
} else xh = function(e, t) {
	for (var n = [];;) {
		var r = Th(e, t);
		if (r === void 0 || Nh(r) || Ph(r)) break;
		n.push(r), t += r >= 65536 ? 2 : 1;
	}
	return Ch.apply(void 0, n);
};
var Ah = function() {
	function e(e, t) {
		t === void 0 && (t = {}), this.message = e, this.position = {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			if (i === 123) {
				...
				if (i !== 35 || t !== "plural" && t !== "selectordinal") {
					...
					if (i === 60 && !this.ignoreTag && jh(this.peek() || 0)) {
						if ((a = this.parseTag(e, t)).err) return a;
						r.push(a.val);
					} else {
						var a;
		...
		if (this.bumpIf(">")) {
			...
			var a = i.val, o = this.clonePosition();
			if (this.bumpIf("</")) {
				if (this.isEOF() || !jh(this.char())) return this.error(K.INVALID_TAG, J(o, this.clonePosition()));
				var s = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					val: {
						type: q.tag,
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && Mh(this.char());) this.bump();
		return this.message.slice(e, this.offset());
	}, e.prototype.parseLiteral = function(e, t) {
		for (var n = this.clonePosition(), r = "";;) {
			var i = this.tryParseQuote(t);
		...
		return this.isEOF() || this.char() !== 60 || !this.ignoreTag && (jh(e = this.peek() || 0) || e === 47) ? null : (this.bump(), "<");
		var e;
	}, e.prototype.tryParseQuote = function(e) {
		if (this.isEOF() || this.char() !== 39) return null;
		switch (this.peek()) {
		...
		return Ch.apply(void 0, t);
	}, e.prototype.tryParseUnquoted = function(e, t) {
		if (this.isEOF()) return null;
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), Ch(n));
	}, e.prototype.parseArgument = function(e, t) {
		var n = this.clonePosition();
		...
		var e = this.clonePosition(), t = this.offset(), n = xh(this.message, t), r = t + n.length;
		return this.bumpTo(r), {
			value: n,
		...
		switch (a) {
			...
			case "time":
				...
				if (this.bumpIf(",")) {
					...
					var c = this.clonePosition();
					if ((g = this.parseSimpleArgStyleIfPossible()).err) return g;
					if ((f = Dh(g.val)).length === 0) return this.error(K.EXPECT_ARGUMENT_STYLE, J(this.clonePosition(), this.clonePosition()));
					s = {
						style: f,
				...
				if (s && Sh(s?.style, "::", 0)) {
					...
					this.locale && (d = function(e, t) {
						for (var n = "", r = 0; r < e.length; r++) {
							...
							if (i === "j") {
								for (var a = 0; r + 1 < e.length && e.charAt(r + 1) === i;) a++, r++;
								var o = 1 + (1 & a), s = a < 2 ? 1 : 3 + (a >> 1), c = uh(t);
								for (c != "H" && c != "k" || (s = 0); s-- > 0;) n += "a";
								for (; o-- > 0;) n = c + n;
							} else n += i === "J" ? "H" : i;
						}
					...
					var f = {
						...
						pattern: d,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? Zm(d) : {}
					};
					return {
						val: {
		...
		return {
			val: {
				...
				tokens: n,
				location: t,
				parsedOptions: this.shouldParseSkeletons ? ch(n) : {}
			},
			err: null
		};
	}, e.prototype.tryParsePluralOrSelectOptions = function(e, t, n, r) {
		...
		if (Sh(this.message, e, this.offset())) {
			for (var t = 0; t < e.length; t++) this.bump();
			return !0;
		}
		return !1;
		...
		for (; !this.isEOF() && Nh(this.char());) this.bump();
	}, e.prototype.peek = function() {
		if (this.isEOF()) return null;
		var e = this.char(), t = this.offset();
		return this.message.charCodeAt(t + (e >= 65536 ? 2 : 1)) ?? null;
...
function Fh(e) {
	e.forEach(function(e) {
		...
		}(e)) for (var t in e.options) delete e.options[t].location, Fh(e.options[t].value);
		else (function(e) {
			return e.type === q.number;
		})(e) && function(e) {
			return !(!e || typeof e != "object" || e.type !== qm.number);
		}(e.style) ? delete e.style.location : !function(e) {
			return e.type === q.date;
		}(e) && !function(e) {
			return e.type === q.time;
		}(e) || !function(e) {
			return !(!e || typeof e != "object" || e.type !== qm.dateTime);
		}(e.style) ? function(e) {
			return e.type === q.tag;
		}(e) && Fh(e.children) : delete e.style.location;
	});
}
function Ih(e) {
	if (Object.prototype.hasOwnProperty.call(e, "__esModule")) return e;
...
function Rh() {
	if (Lh) return Y;
	var e, t;
	return Lh = 1, Object.defineProperty(Y, "__esModule", { value: !0 }), Y.SKELETON_TYPE = Y.TYPE = void 0, Y.isLiteralElement = function(t) {
		return t.type === e.literal;
...
var zh, Bh = Rh(), Vh = {}, Hh = Ih(Jm), Uh = function() {
	if (zh) return Vh;
	zh = 1, Object.defineProperty(Vh, "__esModule", { value: !0 }), Vh.printAST = n, Vh.doPrintAST = r, Vh.printDateTimeSkeleton = o;
	var e = Hh, t = Rh();
	function n(e) {
		return r(e, !1);
	}
...
function Kh({ icuString: e, shouldVisit: t, visitor: n, options: { recurseIntoVisited: r = !0, ...i } }) {
	let a = function(e, t) {
		t === void 0 && (t = {}), t = G({
			shouldParseSkeletons: !0,
			requiresOtherClause: !0
		}, t);
		var n = new Ah(e, t).parse();
		if (n.err) {
			var r = SyntaxError(K[n.err.kind]);
			throw r.location = n.err.location, r.originalMessage = n.err.message, r;
		}
		return t != null && t.captureLocation || Fh(n.val), n.val;
	}(e, i);
	return o(a), a;
	function o(e) {
		e.map(s);
...
var qh = "_gt_", Jh = RegExp(`^${qh}\\d+$`), Yh = RegExp(`^${qh}$`);
function Xh(e) {
	return e.type === Bh.TYPE.select && Jh.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === Bh.TYPE.literal);
}
function Zh(e) {
	return e.type === Bh.TYPE.select && Yh.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === Bh.TYPE.literal);
}
function Qh(e) {
	if (!e.includes("_gt_")) return e;
	let t = [];
...
function eg(e) {
	return e.includes("_gt_") ? Uh.printAST(Kh({
		icuString: e,
		shouldVisit: Xh,
		visitor: function(e) {
			e.type = Bh.TYPE.argument, delete e.options;
		},
		options: { recurseIntoVisited: !1 }
	})) : e;
}
...
var Z = "@generaltranslation/react-core", ng = `${Z} Error: Production environments cannot include an api key.`, rg = `${Z} Error: Fetching batched translations failed`, ig = (e, t) => e ? `${Z} Error: Translation failed for id: ${e}, hash: ${t} ` : `${Z} Error: Translation failed for hash: ${t}`, ag = (e, t) => `${Z} Error: error rendering string ${t ? `for id: "${t}"` : ""} original message: "${e}"`, og = (e, t, n = "tx") => `${Z} Error: string translation error. ${n}("${e}")${t ? ` with id "${t}"` : ""} could not locate translation.`, sg = (e) => `${Z} Error: Dictionary subtree not found for id: "${e}"`, cg = (e) => `${Z} Error: Invalid ICU string dictionary entry found for id: "${e}"`, lg = `${Z} Warning: Translation cloud services require a project ID! Find yours at generaltranslation.com/dashboard.`, ug = (e) => `${Z} Warning: No valid dictionary entry found for id: "${e}"`, dg = `${Z} Warning: A development API key is required for runtime translation!  Find your development API key: generaltranslation.com/dashboard.  (Or, disable this warning message by setting runtimeUrl to an empty string which disables runtime translation.)`, fg = `${Z} Warning: Runtime translation timed out.`, pg = `${Z} Warning: No dictionary was found. Ensure you are either passing your dictionary to the <GTProvider>.`;
function mg(e) {
...
var gg = {
	...
	let { props: t } = e, n = { t: _g(e) };
	if (t["data-_gt"]) {
		let e = t["data-_gt"], r = e.transformation;
		if (r === "variable") {
			let n = e.variableType || "variable", r = Rp(t, n), i = Gh(n);
			return {
				i: e.id,
				k: r,
				v: i
		...
		n.i = e.id, n.d = ((e, t, n) => {
			let r = Object.entries(gg).reduce((e, [n, r]) => (t[r] && (e[n] = t[r]), e), {});
			if (e === "plural" && n) {
				let e = {};
		...
		let i = Object.entries(gg).reduce((e, [n, r]) => (t[r] && (e[n] = t[r]), e), {});
	...
	return t.children && (n.c = bg(t.children)), n;
}, yg = (e) => {
	return n = e, t.isValidElement(n) ? vg(e) : typeof e == "number" ? e.toString() : e;
	var n;
};
function bg(e) {
	return Array.isArray(e) ? e.map(yg) : yg(e);
}
function xg(e) {
...
var Eg = (e) => typeof e == "string" || Array.isArray(e), Dg = (e) => typeof e == "object" && !!e && !Array.isArray(e);
function Og(e, t) {
	if (Array.isArray(e)) return e.map((e, n) => Tg(e) ? t[n] : Og(e, t[n]));
	let n = {
		...Object.fromEntries(Object.entries(e).filter(([, e]) => Eg(e))),
		...Object.fromEntries(Object.entries(t).filter(([, e]) => Eg(e)))
	}, r = Object.entries(e).filter(([, e]) => Dg(e)).map(([e]) => e), i = Object.entries(t).filter(([, e]) => Dg(e)).map(([e]) => e), a = /* @__PURE__ */ new Set([...r, ...i]);
	for (let r of a) n[r] = Og(X(e, r) || {}, X(t, r) || {});
	return n;
}
function kg({ dictionary: e, id: t }) {
	if (t === "") return e;
	let n = e, r = t.split(".");
...
function jg(e, t, n, r) {
	...
	for (let e of i.slice(0, -1)) X(t, e) ?? tg(t, e, Array.isArray(X(r, e)) ? [] : {}), t = X(t, e), r = X(r, e);
	tg(t, i[i.length - 1], e);
}
function Mg(e) {
	let t = {};
...
function Ng(e) {
	return function(e) {
		if (Jp(e), $p) return e.toHex();
		let t = "";
		for (let n = 0; n < e.length; n++) t += em[e[n]];
		return t;
	}(dm(function(e) {
		if (typeof e != "string") throw TypeError("string expected");
		return new Uint8Array(new TextEncoder().encode(e));
...
function Pg({ source: e, context: t, id: n, maxChars: r, dataFormat: i }, a = Ng) {
	let o;
	return o = i === "JSX" ? Ig(e) : e, a(Kp({
		source: o,
		...n && { id: n },
		...t && { context: t },
		...r != null && { maxChars: Math.abs(r) },
...
var Fg = (e) => {
	if (e && typeof e == "object") {
		let t = {};
		if ("c" in e && e.c && (t.c = Ig(e.c)), "d" in e) {
			let n = e?.d;
			n?.b && (t.b = Object.fromEntries(Object.entries(n.b).map(([e, t]) => [e, Ig(t)]))), n?.t && (t.t = n.t);
		}
		return qp(e) ? {
			k: e.k,
			...e.v && { v: e.v }
...
function Ig(e) {
	return Array.isArray(e) ? e.map(Fg) : Fg(e);
}
function Lg(e, t = "") {
	let n = !1;
	return Object.entries(e).forEach(([r, i]) => {
		let a = t ? `${t}.${r}` : r;
		if (Tg(i)) {
			let { entry: t, metadata: o } = Cg(i);
			o?.$_hash || (o ||= {}, o.$_hash = Pg({
				source: Qh(t),
...
function Rg(e, t, n) {
	...
	if (!r) throw Error(sg(n));
	if (Tg(r)) throw Error(`${Z} Error: Cannot inject and merge a dictionary entry`);
...
function zg(e, t, n = "") {
	...
	return Object.entries(e).forEach(([e, i]) => {
		...
		} else r.push(...zg(i, X(t, e) || (Array.isArray(i) ? [] : {}), a));
	}), r;
}
function Bg(e) {
...
function Ug({ gt: e, locale: t, versionId: n, defaultLocale: r, runtimeUrl: i, renderSettings: a, setTranslations: o, environment: s, ...c }) {
	...
	let S = p(0), C = p(/* @__PURE__ */ new Map()), ee = p(/* @__PURE__ */ new Map()), te = l(async (e) => {
		...
		try {
			...
			e?.name === "AbortError" ? console.warn(fg) : console.warn(rg, e), a.forEach((e) => {
...
function Wg({ gt: e, translations: t, locale: n, defaultLocale: r, translationRequired: i, developmentApiEnabled: a, registerIcuForTranslation: o, environment: s }) {
	function c({ message: t, variables: n, locales: r, fallback: i, id: a, maxChars: o, format: l }) {
		try {
			let a = $h(i || ""), s = e.formatMessage(Object.keys(a).length ? eg(t) : t, {
				locales: r,
				variables: {
					...n,
					...a,
			...
			if (s === "production") console.warn(((e, t) => `${Z} Warning: failed to render string ${t ? `for id: "${t}"` : ""} original message: "${e}"`)(t, a), "Error: ", l);
				...
				if (!i) throw Error(`${ag(t, a)} Error: ${l}`);
				console.error(ag(t, a), "Error: ", l);
			}
			return i ? c({
				message: i,
				locales: r,
	...
	let d = (e, t = {}, s) => {
		...
		}), g(e, [r])) : (console.warn(og(e, d, "gt")), g(e, [r])) : s?.[v] ? g(s?.[v], [n, r], e) : g(e, [r]);
	};
	return {
		_gtFunction: d,
		_mFunction: (e, s = {}, l) => {
			...
			}), b(p, [r])) : l?.[f] ? b(l?.[f], [n, r], p) : b(p, [r]) : (console.warn(og(p, Vg(e), "m")), b(p, [r]));
		},
...
function Gg(e, t, n, r, i, a, o, s, c, u, d) {
	return l((s, l = {}) => {
		if (!t) return "";
		let f = Sg(t, s);
		if (!f) return console.warn(ug(s)), "";
		if (!xg(f)) return console.warn(((e) => `${Z} Warning: Invalid dictionary entry found for id: "${e}"`)(s)), "";
		let { entry: p, metadata: m } = Cg(f);
		if (!p || typeof p != "string") return "";
		let { $format: h, ...g } = l, _ = (t, n, r) => {
			try {
				let i = $h(r || ""), a = e.formatMessage(Object.keys(i).length ? eg(t) : t, {
					locales: n,
					variables: {
						...g,
						...i,
				...
				if (d === "production") console.warn(((e) => `${Z} Warning: Invalid ICU string dictionary entry found for id: "${e}"`)(s), "Error: ", i);
					...
					if (!r) throw Error(`${cg(s)} Error: ${i}`);
					console.error(cg(s), "Error: ", i);
				}
...
function Kg({ _locale: e, defaultLocale: t, locales: n, ssr: r, localeCookieName: i, customMapping: a, useDetermineLocale: o, enableI18n: s, reloadOnLocaleUpdate: c }) {
...
function qg({ devApiKey: e, projectId: t, runtimeUrl: n, loadTranslationsType: r, cacheUrl: i, locales: a, environment: o }) {
	d(() => {
		if (o === "production" && e) throw Error(ng);
		if (r === "custom" || !i && !n || t || o !== "development" || console.warn(lg), t && n && r !== "custom" && !e && o === "development" && console.warn(dg), n === Wp || i === Up && r === "default") {
			let e = a.filter((e) => !Ip(e));
...
async function Jg(e, t) {
	let n = Array.from(/* @__PURE__ */ new Set([e, $u(e).languageCode]));
	for (let e of n) try {
		let n = await t(e);
		if (n) return n;
	} catch {}
...
function Yg({ _translations: e, translationRequired: t, loadTranslationsType: n, loadTranslations: r, locale: i, cacheUrl: a, projectId: o, _versionId: s, gt: c }) {
...
function Xg(e, t, n, r, i, a, o, s, c, u, d, f) {
	return l((o, c, l = {}) => {
		...
		if (!p) return console.warn(ug(c)), {};
		if (Tg(p)) return f(o, l);
		if (!s) return Mg(p);
		let m = function({ dictionary: e, id: t, sourceDictionary: n }) {
			if (t === "") return e;
			let r = e, i = n, a = t.split(".");
			for (let e of a) X(r, e) === void 0 && (Array.isArray(X(i, e)) ? tg(r, e, []) : tg(r, e, {})), r = X(r, e);
			return r;
		}({
			dictionary: t,
			id: c,
			sourceDictionary: t
		}), { dictionary: h, updateDictionary: g } = Lg(structuredClone(p), c), _ = zg(h, m, c), { dictionary: v, updateDictionary: y } = function(e, t, n, r, i = "") {
			let a = !1, o = i ? i.split(".") : [];
			return r.forEach(({ metadata: r }) => {
				let { $_hash: i, $id: s } = r, c = o.length > 0 ? s.split(".").slice(o.length).join(".") : s, l = Sg(t, c), u;
				Tg(l) && (u = Cg(l).entry);
				let d = n[i] || u;
				d && (jg(d, t, c, e), a = !0);
			}), {
			...
			return n.forEach(({ source: n, metadata: r }) => {
				let { $id: a } = r, o = i.length > 0 ? a.split(".").slice(i.length).join(".") : a, s = Sg(t, o), c;
				Tg(s) && (c = Cg(s).entry), jg(c || n, t, o, e);
			}), t;
...
function Zg({ enableI18n: e }) {
	let [t] = m(e);
	return { enableI18n: t };
}
function Qg() {
	throw mg("isSSREnabled");
}
function $g({}) {
	throw mg("useDetermineLocale");
}
function e_({}) {
	throw mg("useRegionState");
}
function t_({ children: e, config: t, environment: n = "production", projectId: r = t?.projectId || "", devApiKey: a = t?.devApiKey || "", _versionId: o = t?._versionId, dictionary: s = t?.dictionary || {}, locales: c = t?.locales || [], defaultLocale: l = t?.defaultLocale || zp, cacheUrl: u = t?.cacheUrl || Up, runtimeUrl: p = t?.runtimeUrl || Wp, renderSettings: h = t?.renderSettings || wg(n), ssr: g = t?.ssr || Qg(), localeCookieName: _ = t?.localeCookieName || "generaltranslation.locale", locale: v = "", region: b, loadDictionary: x, loadTranslations: S, fallback: C, translations: ee = null, customMapping: te = t?.customMapping, enableI18n: w = t?.enableI18n === void 0 || t.enableI18n, enableI18nLoaded: T, reloadOnLocaleUpdate: ne, useEnableI18n: re = Zg, readAuthFromEnv: ie = hg, useDetermineLocale: ae = $g, useRegionState: oe = e_, ...se }) {
	v &&= nd(v, te);
	let { projectId: ce, devApiKey: le } = ie({
		...
		ssr: g
	}), { locale: de, setLocale: fe, locales: pe, translationRequired: E, dialectTranslationRequired: me } = Kg({
		_locale: v,
		defaultLocale: l,
		locales: c,
		ssr: g,
		...
		return d(() => {
			...
			let e = !0;
			return (async () => {
				let t = await Jg(i, n) || {}, a = await Jg(r, n) || {};
				e && o(t || {}), e && c(a || {});
			})(), () => {
				e = !1;
			};
	...
	let { translations: Ce, setTranslations: we } = Yg({
		_translations: ee,
		...
		_versionId: o,
		gt: _e
	}), { registerIcuForTranslation: Te, registerJsxForTranslation: Ee, developmentApiEnabled: De } = Ug({
		gt: _e,
		locale: de,
		versionId: o,
		defaultLocale: l,
		...
		environment: n,
		...se
	}), { _gtFunction: Oe, _mFunction: ke, _filterMessagesForPreload: Ae, _preloadMessages: je } = Wg({
		gt: _e,
		translations: Ce,
		locale: de,
		defaultLocale: l,
		...
		environment: n
	}), Me = Gg(_e, ye, xe, Ce, de, l, E, me, De, Te, n), Ne = Xg(ye || {}, xe || {}, be, Se, Ce, de, l, E, me, De, Te, Me), Pe = !(E && !Ce || !de);
	return y(Hg.Provider, {
		value: {
			gt: _e,
			registerIcuForTranslation: Te,
...
function n_({ projectId: e, devApiKey: t }) {
	try {
		return {
			projectId: e || "",
			devApiKey: t || void 0
...
function r_({ _region: e, regionCookieName: t }) {
...
function i_({ _region: e, ssr: t, regionCookieName: n }) {
	let [r, i] = m(t ? void 0 : r_({
		_region: e,
		regionCookieName: n
	}));
	return d(() => {
...
function a_({ enableI18n: e, enableI18nCookieName: t, enableI18nLoaded: n, ssr: r }) {
...
var s_ = function(e, t) {
	return s_ = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, s_(e, t);
...
function c_(e, t) {
	...
	s_(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var l_ = function() {
...
var b_ = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function x_(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || b_(t, e, n);
}
function S_(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function w_() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(C_(arguments[t]));
	return e;
}
function T_() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function D_(e) {
	return this instanceof D_ ? (this.v = e, this) : new D_(e);
}
function O_(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var r, i = n.apply(e, t || []), a = [];
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof D_ ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function A_(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = S_(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var M_ = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return N_ = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, N_(e);
...
function P_(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = N_(e), r = 0; r < n.length; r++) n[r] !== "default" && b_(t, e, n[r]);
	return M_(t, e), t;
}
function F_(e) {
	return e && e.__esModule ? e : { default: e };
...
var B_ = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function V_(e) {
	function t(t) {
		e.error = e.hasError ? new B_(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var U_, W_, G_, K_, q_ = Object.freeze({
	__proto__: null,
	__addDisposableResource: z_,
	get __assign() {
		return l_;
	},
	__asyncDelegator: k_,
	...
	__await: D_,
	__awaiter: v_,
	__classPrivateFieldGet: I_,
	__classPrivateFieldIn: R_,
	__classPrivateFieldSet: L_,
	__createBinding: b_,
	__decorate: d_,
	__disposeResources: V_,
	__esDecorate: p_,
	__exportStar: x_,
	__extends: c_,
	__generator: y_,
	__importDefault: F_,
	__importStar: P_,
	__makeTemplateObject: j_,
	__metadata: __,
	__param: f_,
	__propKey: h_,
	__read: C_,
	__rest: u_,
	__rewriteRelativeImportExtension: H_,
	__runInitializers: m_,
	__setFunctionName: g_,
	__spread: w_,
	__spreadArray: E_,
	__spreadArrays: T_,
	__values: S_,
...
try {
	(K_ = (/* @__PURE__ */ RegExp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu")).exec("a")) == null || K_[0];
} catch {}
function J_(e) {
	if (Object.prototype.hasOwnProperty.call(e, "__esModule")) return e;
	var t = e.default;
...
function X_() {
	if (Y_) return Q;
	var e, t;
	return Y_ = 1, Object.defineProperty(Q, "__esModule", { value: !0 }), Q.SKELETON_TYPE = Q.TYPE = void 0, Q.isLiteralElement = function(t) {
		return t.type === e.literal;
...
(function() {
	if (Z_) return Q_;
	Z_ = 1, Object.defineProperty(Q_, "__esModule", { value: !0 }), Q_.printAST = n, Q_.doPrintAST = r, Q_.printDateTimeSkeleton = o;
	var e = $_, t = X_();
	function n(e) {
		return r(e, !1);
	}
...
var sv = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = rv(this.buffer);
	}
	update(e) {
		tv(this), ev(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		tv(this), function(e, t) {
			ev(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, nv(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = rv(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), uv = /* @__PURE__ */ new Uint32Array(64), dv = class extends sv {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) uv[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = uv[e - 15], n = uv[e - 2], r = iv(t, 7) ^ iv(t, 18) ^ t >>> 3, i = iv(n, 17) ^ iv(n, 19) ^ n >>> 10;
			uv[e] = i + uv[e - 7] + r + uv[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (iv(o, 6) ^ iv(o, 11) ^ iv(o, 25)) + av(o, s, c) + lv[e] + uv[e] | 0, u = (iv(n, 2) ^ iv(n, 13) ^ iv(n, 22)) + ov(n, r, i) | 0;
			l = c, c = s, s = o, o = a + t | 0, a = i, i = r, r = n, n = t + u | 0;
		}
		n = n + this.A | 0, r = r + this.B | 0, i = i + this.C | 0, a = a + this.D | 0, o = o + this.E | 0, s = s + this.F | 0, c = c + this.G | 0, l = l + this.H | 0, this.set(n, r, i, a, o, s, c, l);
	}
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), nv(this.buffer);
	}
}, fv = class extends dv {
	A = 0 | cv[0];
	B = 0 | cv[1];
...
})(() => new fv(), (pv = 1, { oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
var mv = function(e, t) {
	return mv = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, mv(e, t);
...
function hv(e, t) {
	...
	mv(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var gv = function() {
...
var Dv = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function Ov(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || Dv(t, e, n);
}
function kv(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function jv() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(Av(arguments[t]));
	return e;
}
function Mv() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function Pv(e) {
	return this instanceof Pv ? (this.v = e, this) : new Pv(e);
}
function Fv(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var r, i = n.apply(e, t || []), a = [];
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof Pv ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function Lv(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = kv(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var zv = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return Bv = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, Bv(e);
...
function Vv(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = Bv(e), r = 0; r < n.length; r++) n[r] !== "default" && Dv(t, e, n[r]);
	return zv(t, e), t;
}
function Hv(e) {
	return e && e.__esModule ? e : { default: e };
...
var qv = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function Jv(e) {
	function t(t) {
		e.error = e.hasError ? new qv(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var Xv, Zv, Qv, $v, ey = Object.freeze({
	__proto__: null,
	__addDisposableResource: Kv,
	get __assign() {
		return gv;
	},
	__asyncDelegator: Iv,
...
try {
	($v = function(e, t) {
		return new RegExp(e, t);
	}("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")) == null || $v[0];
} catch {}
var ty, ny, $ = {};
function ry() {
	return ty || (ty = 1, Object.defineProperty($, "__esModule", { value: !0 }), $.SKELETON_TYPE = $.TYPE = void 0, $.isLiteralElement = function(t) {
		return t.type === e.literal;
...
(function() {
	if (ny) return iy;
	ny = 1, Object.defineProperty(iy, "__esModule", { value: !0 }), iy.printAST = n, iy.doPrintAST = r, iy.printDateTimeSkeleton = o;
	var e = ay, t = ry();
	function n(e) {
		return r(e, !1);
	}
...
var oy = "gt-react";
function sy({ locale: e = "", defaultLocale: t = "en", locales: n = [], localeCookieName: r = "generaltranslation.locale", ssr: i = !0, customMapping: a, enableI18n: o, reloadOnLocaleUpdate: s = !1 }) {
	let c = f(() => nd(e, a), [e, a]), l = f(() => n.map((e) => nd(e, a)), [n, a]), [u, p] = m(() => o ? nd(i ? c && td(c, l, a) || "" : cy({
		_locale: c,
		locale: c,
		locales: l,
		defaultLocale: t,
		...
		let c = (r) => {
			if (!o) return n;
			if (r === e) return e;
			let s = nd(td(r, t, a) || e || n, a);
			return s !== r && console.warn(((e, t, n = "@generaltranslation/react-core") => `${n} Warning: "${t}" is not a supported locale. Update supported locales in your dashboard or gt.config.json. Falling back to "${e}".`)(s, r, oy)), i(s), s;
		};
		return [(t) => {
			if (!o) return;
			t = nd(t);
...
function cy({ _locale: e, locale: t, locales: n, defaultLocale: r, localeCookieName: i, customMapping: a, enableI18n: o }) {
	if (!o) return r;
	if (e && e === t && td(e, n, a) === t) return nd(e, a);
	...
	return l &&= nd(l, a), s && s !== l && typeof document < "u" && (document.cookie = `${i}=${l};path=/`), l;
}
function ly(e) {
	return y(t_, Object.assign({
		ssr: !(typeof process > "u" || !process.env.NEXT_RUNTIME) || (globalThis == null ? void 0 : globalThis.__NEXT_DATA__) !== void 0,
		environment: "development"
	}, e, {
		readAuthFromEnv: n_,
		useDetermineLocale: sy,
		useRegionState: i_,
		useEnableI18n: a_
	}));
}
var uy = C().server(function({ defaultLocale: e, locales: t, customMapping: n }) {
	let r = [], i = ee(Pp);
	...
	return r.length === 0 && process.env._GENERALTRANSLATION_IGNORE_BROWSER_LOCALES === "false" && console.warn("gt-tanstack-start(server): no locales could be determined for this request"), td(r, t, n) || e;
	...
	return a && r.push(a), r.length === 0 && (console.warn("gt-tanstack-start(client): no locales could be determined for this request"), r.push(e)), td(r, t, n) || e;
}), dy = class extends fd {
...
function py(e) {
	Vd(new fy(Object.assign(Object.assign({}, e), { storeAdapter: new dy() })));
}
var my = { exports: {} }, hy, gy, _y = {};
function vy() {
	return hy || (hy = 1, function() {
		function e(t) {
...
function Sy(e) {
	return e.locale ? e.locale : by() ? xy() : void 0;
}
function Cy() {
	let e = Bd();
	if (!function(e) {
...
function wy(e) {
	let t = Cy().getProviderConfig();
	return yy.jsx(ly, Object.assign({ ssr: by() }, t, e, {
		reloadOnLocaleUpdate: !0,
		locale: Sy(e)
	}));
}
var Ty = Object.assign({
...
async function Ey(e, t = ["shared"]) {
	let n = {};
	return await Promise.all(t.map(async (t) => {
		let r = Ty[`./src/_gt/${e}/${t}.json`];
		if (!r) {
...
var Dy = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/scripts/Wrapper.tsx";
py({
	...b,
	loadTranslations: Ey
});
...
var ky = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/LocaleSwitcher.wrapper.tsx";
function Ay() {
	return S(Oy, { children: S(So, {}, void 0, !1, {
		fileName: ky,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
