...
var go = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/ThemeToggle.tsx";
function _o() {
...
var cy = v().server(function({ defaultLocale: e, locales: t, customMapping: n }) {
	let r = [], i = y(Mp);
...
async function wy(e, t = ["shared"]) {
	let n = {};
	return await Promise.all(t.map(async (t) => {
		let r = Cy[`./src/_gt/${e}/${t}.json`];
		if (!r) {
...
var Ty = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/scripts/Wrapper.tsx";
dy({
	...x,
	loadTranslations: wy
});
...
var Dy = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/ThemeToggle.wrapper.tsx";
function Oy() {
