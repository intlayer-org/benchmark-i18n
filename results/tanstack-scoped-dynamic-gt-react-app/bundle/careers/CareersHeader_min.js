...
function Ys() {
	return m(f, { children: [
		...
		p("h1", {
			...
			children: p(ys, { children: "Careers" })
		}),
		p("p", {
			className: "mb-4 text-muted-foreground",
			children: p(ys, { children: "Join our mission to improve the internationalization ecosystem. We're a remote-first team that values impact, transparency, and continuous learning." })
		})
	] });
}
function Xs(e) {
