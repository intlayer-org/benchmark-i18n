...
var yo = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/pages/home/Hero.tsx";
function bo() {
	return vo("Hero"), v("section", {
		className: "mb-16 text-center",
		children: [
			v("h1", {
				className: "mb-4 text-4xl font-bold tracking-tight text-foreground",
				children: v(go, { children: "i18n Benchmark" }, void 0, !1, {
					fileName: yo,
					lineNumber: 9,
					columnNumber: 9
				}, this)
			...
			v("p", {
				...
				children: v(go, { children: "A test application designed to measure the real-world impact of internationalization libraries on bundle size, loading performance, and rendering reactivity." }, void 0, !1, {
					fileName: yo,
					lineNumber: 12,
					columnNumber: 9
				}, this)
			...
			v("div", {
				...
				children: [v("button", {
					...
					children: v(go, { children: "View Results" }, void 0, !1, {
						fileName: yo,
						lineNumber: 23,
						columnNumber: 11
					}, this)
					...
					children: v(go, { children: "Methodology" }, void 0, !1, {
						fileName: yo,
						lineNumber: 29,
						columnNumber: 11
					}, this)
...
function qs(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		if (zs.test(i.stem)) {
			...
			var a = i.options[0];
			a === "w" ? t = j(j({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = j(j({}, t), Us(a)));
			continue;
		}
		if (Bs.test(i.stem)) {
			t = j(j({}, t), Us(i.stem));
...
var gc = function() {
	...
	return e.prototype.parse = function() {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !_c(this.char())) return this.error(M.INVALID_TAG, P(o, this.clonePosition()));
...
var nl = function() {
	...
	try {
		...
		})() || A.get("DisplayNames", ["en"], { type: "language" }).of(t) === t && !il(t) || n && A.get("DisplayNames", ["en"], { type: "region" }).of(n) === n || r && A.get("DisplayNames", ["en"], { type: "script" }).of(r) === r && !rl.includes(r));
	} catch {
		return !1;
	}
}, L = (e) => {
...
function cl(e, t, n, r) {
	return !(!I(e, r) || !I(t, r) || n && n.some((e) => !I(e, r)) || ol(e, t) || n && !n.some((e) => sl(t, e)));
}
var ll = (e, t, n) => {
	if (e?.[t]) return typeof e[t] == "string" ? n === "name" ? e[t] : void 0 : e[t][n];
}, ul = (e, t) => !!(t?.[e] && typeof t[e] == "object" && "code" in t[e] && t[e].code && I(t[e].code));
function dl(e, t) {
	let n = e;
	t && ul(e, t) && (e = t[e].code);
	try {
...
function Sl(e, t = "en", n) {
	...
	try {
		let i = L(e), a = A.get("Locale", e), o = a.language, s = xl([
			r,
			e,
			i,
			o
		...
		let t = I(e) ? L(e) : e, r = t?.split("-"), i = r?.[0] || t || "", a = r.length > 2 ? r?.[2] : r?.[1] || "", o = r?.[3] || "", s = xl([t, i], n);
		t = s?.code || t;
		let c = s?.name || t, l = s?.nativeName || c, u = s?.maximizedCode || t, d = s?.maximizedName || c, f = s?.nativeMaximizedName || l, p = s?.minimizedCode || t, m = s?.minimizedName || c, h = s?.nativeMinimizedName || l;
		i = s?.languageCode || i;
		let g = s?.languageName || c, _ = s?.nativeLanguageName || l;
...
var du = "GT Error:", fu = (e) => `${du} Translation request timed out after ${e}ms.`, pu = (e) => `${du} Translation request failed. Error: ${e}`, mu = (e, t, n) => `${du} API returned error status. Status: ${e}, Status Text: ${t}, Error: ${n}`, R = (e) => `${du} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a targetLocale in the GT constructor.`, hu = (e) => `${du} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a sourceLocale in the GT constructor.`, gu = (e) => `${du} Cannot call \`${e}\` without a specified project ID. Either pass a project ID to the \`${e}\` function or specify a projectId in the GT constructor.`, _u = (e) => `${du} Cannot call \`${e}\` without a specified API key. Either pass an API key to the \`${e}\` function or specify an apiKey in the GT constructor.`, vu = (e) => `${du} Invalid locale: ${e}.`, yu = (e) => `${du} Invalid locales: ${e.join(", ")}.`;
...
async function zu(e, t, n) {
	return jo(e.map(({ source: e }) => e)), Mu(e, async (e) => (await z(n, "/v2/project/files/upload-translations", {
		body: {
...
var Xu = class {
	...
	setConfig({ apiKey: e, devApiKey: t, sourceLocale: n, targetLocale: r, locales: i, projectId: a, customMapping: o, baseUrl: s }) {
		if (e && (this.apiKey = e), t && (this.devApiKey = t), a && (this.projectId = a), n && (this.sourceLocale = L(n), !I(this.sourceLocale, o))) throw Error(vu(this.sourceLocale));
		if (r && (this.targetLocale = L(r), !I(this.targetLocale, o))) throw Error(vu(this.targetLocale));
		if (i) {
			let e = [], t = [];
			if (i.forEach((n) => {
				let r = L(n);
...
var Ad = 12e3, jd = class extends Od {
	constructor(e) {
		super(), this.resolveTranslationSync = (e, t = {}) => this.lookupTranslation(e, t), nd(ld(e), "I18nManager: "), this.config = Md(e), this.localeConfig = new tu({
...
var Ld = void 0;
function Rd() {
	return Ld ||= (au.warn("getI18nManager(): Translation failed because I18nManager not initialized."), new jd({
		defaultLocale: "en",
		locales: ["en"]
	})), Ld;
}
...
function $g({ children: e, config: t, environment: n = "production", projectId: r = t?.projectId || "", devApiKey: a = t?.devApiKey || "", _versionId: o = t?._versionId, dictionary: s = t?.dictionary || {}, locales: c = t?.locales || [], defaultLocale: l = t?.defaultLocale || Lp, cacheUrl: u = t?.cacheUrl || Vp, runtimeUrl: f = t?.runtimeUrl || Hp, renderSettings: m = t?.renderSettings || Sg(n), ssr: g = t?.ssr || Xg(), localeCookieName: v = t?.localeCookieName || "generaltranslation.locale", locale: y = "", region: b, loadDictionary: x, loadTranslations: S, fallback: C, translations: ee = null, customMapping: te = t?.customMapping, enableI18n: w = t?.enableI18n === void 0 || t.enableI18n, enableI18nLoaded: T, reloadOnLocaleUpdate: ne, useEnableI18n: re = Yg, readAuthFromEnv: ie = pg, useDetermineLocale: ae = Zg, useRegionState: oe = Qg, ...se }) {
	...
	let { projectId: ce, devApiKey: le } = ie({
		...
		ssr: g
	}), { locale: E, setLocale: de, locales: fe, translationRequired: pe, dialectTranslationRequired: me } = Wg({
		_locale: y,
		defaultLocale: l,
		locales: c,
		ssr: g,
	...
	let { translations: Ce, setTranslations: we } = qg({
		...
		environment: n
	}), Me = Ug(_e, ye, xe, Ce, E, l, pe, me, De, Te, n), Ne = Jg(ye || {}, xe || {}, be, Se, Ce, E, l, pe, me, De, Te, Me), Pe = !(pe && !Ce || !E);
	return _(Bg.Provider, {
		value: {
			gt: _e,
			registerIcuForTranslation: Te,
...
function ay({ locale: e = "", defaultLocale: t = "en", locales: n = [], localeCookieName: r = "generaltranslation.locale", ssr: i = !0, customMapping: a, enableI18n: o, reloadOnLocaleUpdate: s = !1 }) {
	let c = p(() => ed(e, a), [e, a]), l = p(() => n.map((e) => ed(e, a)), [n, a]), [u, f] = h(() => o ? ed(i ? c && $u(c, l, a) || "" : oy({
		_locale: c,
		locale: c,
		locales: l,
		defaultLocale: t,
...
var Dy = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/pages/home/Hero.wrapper.tsx";
function Oy() {
	return v(Ey, { children: v(bo, {}, void 0, !1, {
		fileName: Dy,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
