...
function Ys() {
	return Js("Hero"), m("section", {
		className: "mb-16 text-center",
		children: [
			p("h1", {
				className: "mb-4 text-4xl font-bold tracking-tight text-foreground",
				children: p(Z, { children: "i18n Benchmark" })
			}),
			p("p", {
				className: "mx-auto max-w-2xl text-lg text-muted-foreground",
				children: p(Z, { children: "A test application designed to measure the real-world impact of internationalization libraries on bundle size, loading performance, and rendering reactivity." })
			}),
			m("div", {
				...
				children: [p("button", {
					...
					children: p(Z, { children: "View Results" })
				}), p("button", {
					type: "button",
					className: "rounded-lg border border-border px-6 py-3 text-sm font-medium text-foreground hover:bg-accent transition-colors",
					children: p(Z, { children: "Methodology" })
				})]
			})
		]
	});
