...
function qs() {
	return p("section", { children: [f("h2", {
		className: "mb-6 text-2xl font-bold text-foreground",
		children: f(Z, { children: "Sample Results" })
	}), f("div", {
			...
			children: [f("thead", {
				...
				children: p("tr", { children: [
					f("th", {
						...
						children: f(Z, { children: "Library" })
					}),
					f("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: f(Z, { children: "Bundle Size" })
					}),
					f("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: f(Z, { children: "Lookup Time" })
					}),
					f("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: f(Z, { children: "Lazy Loading" })
					})
				] })
			}), f("tbody", { children: [
				{
					...
					size: "42.3 kB",
					time: "0.12ms",
					lazy: f(Z, { children: "Yes" })
				},
				{
					lib: "react-intl",
					size: "38.1 kB",
					time: "0.15ms",
					lazy: f(Z, { children: "Manual" })
				},
				{
					lib: "lingui",
					size: "12.8 kB",
