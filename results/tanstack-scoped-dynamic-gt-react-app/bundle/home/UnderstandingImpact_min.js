	...
	return p("section", {
		...
		children: [
			f("h2", {
				...
				children: f(Z, { children: "Understanding the Impact" })
			}),
			p("div", {
				...
				children: [
					f("h3", {
						...
						children: f(Z, { children: "Why a single large JSON can hurt performance" })
					}),
					f("p", {
						className: "text-sm text-muted-foreground",
						children: f(Z, { children: "Many i18n libraries store translations in a single JSON object provided via React context. When this object is large (thousands of keys), every component that consumes translations holds a reference to the entire dictionary. This means:" })
					}),
					p("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							f("li", { children: f(Z, { children: "The JSON must be parsed on every page load — blocking the main thread." }) }),
							f("li", { children: f(Z, { children: "Context-based architectures can cause cascading re-renders when the locale changes, because every consumer is notified even if their specific keys didn't change." }) }),
							f("li", { children: f(Z, { children: "During server-side rendering, the full dictionary is serialized into the HTML payload, increasing the document size that must be downloaded and hydrated." }) })
						]
					})
				]
			}),
			p("div", {
				...
				children: [
					f("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: f(Z, { children: "The trade-offs of dynamic loading" })
					}),
					f("p", {
						className: "text-sm text-muted-foreground",
						children: f(Z, { children: "Splitting translations into per-route or per-namespace chunks can dramatically reduce the initial payload. But it introduces new challenges:" })
					}),
					p("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							p("li", { children: [
								f("strong", {
									...
									children: f(Z, { children: "Waterfall requests:" })
								}),
								" ",
								f(Z, { children: "the app must first load, determine the locale, then fetch the right chunk — adding network round-trips." })
							] }),
							p("li", { children: [
								f("strong", {
									className: "text-foreground",
									children: f(Z, { children: "Flash of untranslated content (FOUC):" })
								}),
								" ",
								f(Z, { children: "users may briefly see translation keys or a fallback language before the chunk arrives." })
							] }),
							p("li", { children: [
								f("strong", {
									className: "text-foreground",
									children: f(Z, { children: "Cache invalidation:" })
								}),
								" ",
								f(Z, { children: "updating translations requires cache-busting strategies to ensure users get fresh content without re-downloading unchanged chunks." })
							] })
						]
					})
				]
			...
			p("div", {
				...
				children: [f("h3", {
					className: "mb-2 text-lg font-semibold text-foreground",
					children: f(Z, { children: "What this benchmark measures" })
				}), f("p", {
					className: "text-sm text-muted-foreground",
					children: f(Z, { children: "This test app provides a controlled environment — 10 pages with realistic content — to compare i18n libraries across three axes: the weight they add to your JavaScript bundle, the time spent parsing and rendering translated content, and the effectiveness of their code-splitting and lazy-loading strategies. Each library is integrated into the same app so results are directly comparable." })
				})]
			})
		]
	});
