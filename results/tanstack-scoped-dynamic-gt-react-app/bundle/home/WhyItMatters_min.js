...
function qs() {
	return p("section", {
		...
		children: [f("h2", {
			...
			children: f(Z, { children: "Why These Metrics Matter" })
		}), p("div", {
			...
			children: [
				...
				p("div", {
					...
					children: [f("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: f(Z, { children: "Rendering & Hydration" })
					}), f("p", {
						className: "text-sm text-muted-foreground",
						children: f(Z, { children: "Connecting a large JSON dictionary to every component creates a hidden dependency: any change in the translation context can trigger re-renders across the entire tree. During SSR hydration, parsing and attaching massive translation objects adds latency before the page becomes interactive — directly impacting Time to Interactive (TTI)." })
					})]
				}),
				p("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [f("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: f(Z, { children: "Dynamic Loading" })
					}), f("p", {
						className: "text-sm text-muted-foreground",
						children: f(Z, { children: "Loading all translations upfront overloads the initial payload. Dynamic (lazy) loading splits translations by route or namespace, sending only what the current page needs. However, lazy loading introduces its own trade-offs: waterfall requests, flash of untranslated content, and caching complexity. Measuring both strategies is essential." })
					})]
				})
			]
		})]
