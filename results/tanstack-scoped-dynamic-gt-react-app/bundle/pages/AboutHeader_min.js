...
import { Fragment as v, jsxDEV as y } from "react/jsx-dev-runtime";
import { createIsomorphicFn as b } from "@tanstack/react-start";
import { getCookie as x, getRequestHeader as S } from "@tanstack/react-start/server";
import C from "../../../../gt.config.json";
var w = Object.defineProperty, ee = Object.getOwnPropertyDescriptor, T = Object.getOwnPropertyNames, E = Object.prototype.hasOwnProperty, te = (e, t, n) => () => {
	if (n) throw n[0];
	try {
		return e && (t = e(e = 0)), t;
	} catch (e) {
	...
	if (t && typeof t == "object" || typeof t == "function") for (var i = T(t), a = 0, o = i.length, s; a < o; a++) s = i[a], !E.call(e, s) && s !== n && w(e, s, {
		get: ((e) => t[e]).bind(null, s),
		enumerable: !(r = ee(t, s)) || r.enumerable
	});
	return e;
}, ae = (e) => E.call(e, "module.exports") ? e["module.exports"] : ie(w({}, "__esModule", { value: !0 }), e), oe = class extends Error {
	constructor(e, t, n) {
...
function D({ source: e, severity: t, whatHappened: n, reassurance: r, why: i, fix: a, wayOut: o, details: s, docsUrl: c }) {
	let l = e ? t ? `${e} ${t}:` : `${e}:` : t ? `${t}:` : "", u = i ? `${le(n)} because ${le(i)}` : n, d = !!a && !!o && /^[a-z]/.test(le(o)), f = [
		u,
		r,
		d ? `${le(a)}, or ${le(o)}` : a,
		d ? void 0 : o,
...
function It(e, t, n) {
	...
	for (let r of e) switch (r.type) {
		...
		case O.pound:
			...
			break;
		case O.argument: {
			let e = Lt(t.variables, r.value);
			i(typeof e == "string" || typeof e == "number" ? String(e) : e || "");
			break;
		}
		case O.number: {
			let e = Lt(t.variables, r.value), { scale: n, ...a } = typeof r.style == "string" ? jt[r.style] ?? {} : r.style?.type === et.number ? r.style.parsedOptions : {}, o = Rt(e, n);
			i(zt(t, a).format(o));
			break;
		}
		case O.date:
		case O.time: {
			let e = Lt(t.variables, r.value), n = r.type === O.date ? Mt : Pt;
			i(Bt(t, typeof r.style == "string" ? n[r.style] : r.style?.type === et.dateTime ? r.style.parsedOptions : r.type === O.time ? Pt.medium : void 0).format(e));
			break;
		}
		case O.select: {
			let e = String(Lt(t.variables, r.value)), n = Gt(r.options, e) ?? r.options.other;
			if (!n) throw Kt(r.value, e, r.options);
			It(n.value, t).forEach(i);
			break;
		}
		case O.plural: {
			let e = Lt(t.variables, r.value), n = `=${String(e)}`, a = Gt(r.options, n), o = typeof e == "bigint" ? e : Number(e), s = typeof o == "bigint" ? o - BigInt(r.offset) : o - r.offset;
			if (!a && Wt(r.options)) {
...
var Xt = RegExp(`^${Yt}$`);
function Zt(e) {
	return e.type === O.select && Xt.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === O.literal);
}
function Qt(e) {
	let t = e;
...
function gn({ value: e, locales: t = ["en"], currency: n = "USD", options: r = {} }) {
	return k.get("NumberFormat", t, {
		style: "currency",
		currency: n,
		numberingSystem: "latn",
...
function bn({ value: e, unit: t, locales: n = ["en"], options: r = {} }) {
...
var wn = (e, t, n) => {
	...
	let n = e?.[t];
	return Cn(n) && typeof n.code == "string" ? n.code : void 0;
}, En = /* @__PURE__ */ new Set([
	"Cham",
	"Jamo",
	"Kawi",
	...
	"Toto",
	"Thai"
]), Dn = (e) => e >= "qaa" && e <= "qtz", On = (e, t) => {
	e = Tn(t, e) || e;
	try {
		let { language: t, region: n, script: r } = k.get("Locale", e), i = 1 + Number(!!n) + Number(!!r);
		return !(e.split("-").length !== i || k.get("DisplayNames", ["en"], { type: "language" }).of(t) === t && !Dn(t) || n && k.get("DisplayNames", ["en"], { type: "region" }).of(n) === n || r && k.get("DisplayNames", ["en"], { type: "script" }).of(r) === r && !En.has(r));
	} catch {
		return !1;
	}
}, kn = (e) => {
...
function An(e, t) {
	...
	for (let a of e) {
		...
		r.add(e);
		let o = i.get(e);
		o === void 0 && (o = /* @__PURE__ */ new Set(), i.set(e, o)), o.add(kn(a));
	}
	return {
		allValid: n,
		languages: r,
...
function jn(...e) {
	try {
		let t = e.flat().map((e) => k.get("Locale", kn(e))), [n] = t, r = new Set(t.map(({ region: e }) => e).filter(Boolean)), i = new Set(t.map(({ script: e }) => e).filter(Boolean));
...
function Mn(e, t, n, r) {
	if (n && !n.allValid || !On(e, r) || !On(t, r) || jn(e, t)) return !1;
	if (!n) return !0;
	let i = xn(t);
	return i !== void 0 && n.languages.has(i);
}
function Nn(e, t, n, r) {
	return Mn(e, t, n ? An(n, r) : void 0, r);
}
function Pn(e) {
	try {
...
function Fn(e, t) {
	if (t.has(e)) return e;
	let { languageCode: n, regionCode: r, scriptCode: i, minimizedCode: a } = Pn(e), o = `${n}-${r}`;
	if (t.has(o)) return o;
	let s = `${n}-${i}`;
	if (t.has(s)) return s;
	if (t.has(a)) return a;
...
function zn(e, t) {
	...
	e = Rn(e, t);
	try {
		let r = kn(e), i = k.get("Locale", r), { language: a, region: o } = i;
		if (t) for (let i of [
			n,
			e,
			r,
...
function Xn(e, t = "en", n) {
	...
	e = Rn(e, n), t ||= "en";
	try {
		let i = kn(e), a = k.get("Locale", e), o = a.language, s = Yn([
			r,
			e,
			i,
			o
			...
			t,
			"en"
		], g = k.get("DisplayNames", m, { type: "language" }), _ = k.get("DisplayNames", h, { type: "language" }), v = s?.name, y = s?.nativeName || s?.name, b = v || g.of(e) || e, x = y || _.of(e) || e, S = s?.maximizedName || v || g.of(u) || e, C = s?.nativeMaximizedName || y || _.of(u) || e, w = s?.minimizedName || v || g.of(p) || e, ee = s?.nativeMinimizedName || y || _.of(p) || e, T = s?.languageName || v || g.of(o) || e, E = s?.nativeLanguageName || y || _.of(o) || e, te = s?.nameWithRegionCode || (c ? `${T} (${c})` : b), ne = s?.nativeNameWithRegionCode || (c ? `${E} (${c})` : x) || te, re = k.get("DisplayNames", m, { type: "region" }), ie = k.get("DisplayNames", h, { type: "region" }), ae = s?.regionName || (d ? re.of(d) : "") || "", oe = s?.nativeRegionName || (d ? ie.of(d) : "") || "", se = k.get("DisplayNames", m, { type: "script" }), ce = k.get("DisplayNames", h, { type: "script" });
		return {
			code: i,
			name: b,
			nativeName: x,
			...
			nativeRegionName: oe,
			scriptCode: f,
			scriptName: s?.scriptName || (f ? se.of(f) : "") || "",
			nativeScriptName: s?.nativeScriptName || (f ? ce.of(f) : "") || "",
			emoji: s?.emoji || zn(i, n)
		};
	} catch {
		let t = On(e) ? kn(e) : e, r = t.split("-"), i = r[0] || t, a = r.length > 2 ? r[2] : r[1] || "", o = r[3] || "", s = Yn([t, i], n);
		t = s?.code || t;
		...
		o = s?.scriptCode || o;
		let b = s?.scriptName || "", x = s?.nativeScriptName || "", S = s?.nameWithRegionCode || (v ? `${g} (${v})` : c), C = s?.nativeNameWithRegionCode || (y ? `${_} (${y})` : l), w = s?.emoji || "🌍";
		return {
			code: t,
			name: c,
			nativeName: l,
...
function nr(e, t) {
	try {
		let { language: n, region: r, script: i } = k.get("Locale", kn(e)), { language: a, region: o, script: s } = k.get("Locale", kn(t));
...
function rr(e, t) {
	return t ? Object.keys(t).find((n) => Tn(t, n) === e) ?? e : e;
}
var ir = class {
	getResolutionScope() {
	...
	isResolutionScopeCurrent(e) {
		...
		for (let t = 0; t < this.locales.length; t++) {
			...
			if (r.locale !== n || r.canonicalLocale !== this.resolveCanonicalLocale(n) || e.canonicalMappingCodes[t] !== Tn(this.customMapping, r.canonicalLocale)) return !1;
		}
		return !0;
	}
	buildResolutionScope(e) {
		...
		return {
			...
			canonicalMappingCodes: t.map(({ canonicalLocale: e }) => Tn(this.customMapping, e)),
			approved: An(t.map(({ canonicalLocale: e }) => e), this.customMapping)
		};
	}
	...
	formatRelativeTimeFromDate(e, t, n = {}) {
		let { locales: r, baseDate: i, ...a } = n, { value: o, unit: s } = yn(e, i ?? /* @__PURE__ */ new Date());
		return bn({
			value: o,
			unit: s,
			locales: this.getFormattingLocales(t, r),
	...
	formatMessage(e, t, n = {}) {
		...
		return a === "STRING" ? e : pn(e, this.getFormattingLocales(t, r), i);
	}
	formatList(e, t, n = {}) {
		let { locales: r, ...i } = n;
		return _n({
	...
	requiresTranslation(e, t = this.defaultLocale, n = this.locales.length ? this.locales : void 0) {
		let r = n ? n === this.locales ? this.getResolutionScope().approved : An(n.map((e) => this.resolveCanonicalLocale(e)), this.customMapping) : void 0;
		return Mn(this.resolveCanonicalLocale(t), this.resolveCanonicalLocale(e), r, this.customMapping);
	}
	determineLocale(e, t = this.locales) {
		let { approvedLocalePairs: n, approved: r } = t === this.locales ? this.getResolutionScope() : this.buildResolutionScope(t), i = In(Array.isArray(e) ? e.map((e) => this.resolveCanonicalLocale(e)) : this.resolveCanonicalLocale(e), r, this.customMapping);
	...
	resolveCanonicalLocale(e) {
		return Rn(e, this.customMapping);
	}
	...
	isSameDialect(...e) {
		return jn(...e.map((e) => Array.isArray(e) ? e.map((e) => this.resolveCanonicalLocale(e)) : this.resolveCanonicalLocale(e)));
	}
	isSameLanguage(...e) {
		return Sn(...e.map((e) => Array.isArray(e) ? e.map((e) => this.resolveCanonicalLocale(e)) : this.resolveCanonicalLocale(e)));
	}
...
function pr(e, t, n = "") {
	let r = fr(e), i = e?.length, a = t !== void 0;
	if (!r || a && i !== t) {
...
var Dr = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = _r(this.buffer);
	}
	update(e) {
		mr(this), pr(e);
	...
	digestInto(e) {
		mr(this), hr(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, gr(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(this.length * 8), i), this.process(n, 0);
		let o = _r(e), s = this.outputLen;
	...
	3204031479,
	3329325298
]), Ar = /* @__PURE__ */ new Uint32Array(64), jr = class extends Dr {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) Ar[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = Ar[e - 15], n = Ar[e - 2], r = vr(t, 7) ^ vr(t, 18) ^ t >>> 3, i = vr(n, 17) ^ vr(n, 19) ^ n >>> 10;
			Ar[e] = i + Ar[e - 7] + r + Ar[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = vr(o, 6) ^ vr(o, 11) ^ vr(o, 25), u = l + t + Tr(o, s, c) + kr[e] + Ar[e] | 0, d = (vr(n, 2) ^ vr(n, 13) ^ vr(n, 22)) + Er(n, r, i) | 0;
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), gr(this.buffer);
	}
}, Mr = class extends jr {
	A = Or[0] | 0;
	B = Or[1] | 0;
...
function Pr(e) {
	...
	if (Array.isArray(e)) {
		let t = "[";
		for (let n = 0; n < e.length; n++) n && (t += ","), t += Pr(e[n]) || "null";
		return t + "]";
	}
...
function Ir(e) {
	return xr(Nr(Sr(e))).slice(0, 16);
}
function Lr({ source: e, context: t, id: n, maxChars: r, requiresReview: i, dataFormat: a }, o = Ir) {
	let s;
	return s = a === "JSX" ? zr(e) : e, o(Fr({
		source: s,
		...n && { id: n },
		...t && { context: t },
...
var Rr = (e) => {
	if (e && typeof e == "object") {
		let t = {};
		if ("c" in e && e.c && (t.c = zr(e.c)), "d" in e) {
			let n = e?.d;
			n?.b && (t.b = Object.fromEntries(Object.entries(n.b).map(([e, t]) => [e, zr(t)]))), n?.t && (t.t = n.t);
		}
		return Qt(e) ? {
			k: e.k,
			...e.v && { v: e.v }
...
function zr(e) {
	return Array.isArray(e) ? e.map(Rr) : Rr(e);
}
var Br = "GT", Vr = (e) => D({
	source: Br,
	severity: "Error",
...
var $r = class {
	...
	handle(e) {
		...
		let n = Xr[e.level], r = `[${e.level.toUpperCase()}]`;
	...
	constructor(e = {}) {
		this.config = {
			...
			handlers: [],
			...e
		}, this.handlers = [...this.config.handlers || []], this.config.enableConsole && this.handlers.push(new $r(this.config));
	}
	addHandler(e) {
	...
	shouldLog(e) {
		return Yr[e] >= Yr[this.config.level];
	}
	log(e, t, n, r) {
...
async function ii(e, t, n) {
	...
	try {
		...
		throw e instanceof Error && e.name === "AbortError" ? Vr(n) : e;
	} finally {
		o && clearTimeout(o);
	}
}
async function ai(e) {
	if (!e.ok) {
		...
		throw new oe(Hr(e.status, e.statusText, t), e.status, t);
	}
}
async function oi(e, t, n, r) {
	let i = Array.isArray(e), a = i ? [] : void 0, o = {}, s = i ? e.map((e) => [void 0, e]) : Object.entries(e);
	for (let [e, t] of s) {
		let { source: n, metadata: r } = typeof t == "string" ? { source: t } : t, i = e ?? r?.hash ?? Lr({
			source: n,
	...
	if (l.data === void 0 && l.response && !fe(l)) throw await ai(l.response), l.error;
	let u = pe(l);
...
var si = class {
	...
	setConfig({ apiKey: e, devApiKey: t, sourceLocale: n, targetLocale: r, locales: i, projectId: a, customMapping: o, baseUrl: s }) {
		if (e && (this.apiKey = e), t && (this.devApiKey = t), a && (this.projectId = a), n && (this.sourceLocale = cr(n), !or(this.sourceLocale, o))) throw Error(qr(this.sourceLocale));
		if (r && (this.targetLocale = cr(r), !or(this.targetLocale, o))) throw Error(qr(this.targetLocale));
		if (i) {
			let e = [], t = [];
			if (i.forEach((n) => {
				let r = cr(n);
				or(r) ? e.push(r) : t.push(n);
			}), t.length > 0) throw Error(Jr(t));
			this.locales = e;
		}
	...
	requiresTranslation(e = this.sourceLocale, t = this.targetLocale, n = this.locales, r = this.customMapping) {
		if (!e) throw Error(Wr("requiresTranslation"));
		if (!t) throw Error(Ur("requiresTranslation"));
		return r === this.customMapping ? this.localeConfig.requiresTranslation(t, e, n) : lr(e, t, n, r);
	}
	determineLocale(e, t = this.locales || [], n = this.customMapping) {
		return n === this.customMapping ? this.localeConfig.determineLocale(e, t ?? []) : ur(e, t, n);
	}
	getLocaleDirection(e = this.targetLocale) {
		if (!e) throw Error(Ur("getLocaleDirection"));
		return this.localeConfig.getLocaleDirection(e);
	}
	isValidLocale(e = this.targetLocale, t = this.customMapping) {
		if (!e) throw Error(Ur("isValidLocale"));
		return t === this.customMapping ? this.localeConfig.isValidLocale(e) : or(e, t);
	}
	resolveCanonicalLocale(e = this.targetLocale, t = this.customMapping) {
		if (!e) throw Error(Ur("resolveCanonicalLocale"));
		return t === this.customMapping ? this.localeConfig.resolveCanonicalLocale(e) : sr(e, t);
	}
	resolveAliasLocale(e, t = this.customMapping) {
		if (!e) throw Error(Ur("resolveAliasLocale"));
		return t === this.customMapping ? this.localeConfig.resolveAliasLocale(e) : dr(e, t);
	}
	standardizeLocale(e = this.targetLocale) {
		if (!e) throw Error(Ur("standardizeLocale"));
...
function li() {
	let e = di();
	return e === void 0 ? fi(() => void 0) : e;
}
function ui(e) {
	return e?.toUpperCase() === ci;
}
function di() {
...
function hi({ namespace: e, key: t, source: n, notInitialized: r }) {
	function i() {
		let n = pi(e)[t];
		if (n == null) {
			let e = r();
...
function gi() {
	let e = mi("i18n")?.i18nConfig;
	return _i(e) ? e.isDebugLoggingEnabled() : ui(li());
}
function _i(e) {
...
function bi() {
	...
	let e = xi(() => "production");
	return e ? e === "development" ? "development" : "production" : xi(() => !0) === !0 ? "development" : "production";
}
function xi(e) {
	try {
		return e();
...
function Ci(e, t) {
	if (!t) return;
	let n = wi(e), r = Ti(e), i = [...n, ...r];
	if (i.forEach((e) => {
		Si.error(`I18nConfig: ${Ei(e)}`);
...
function wi({ defaultLocale: e, locales: t, customMapping: n }) {
	let r = /* @__PURE__ */ new Set([...e ? [e] : [], ...t || []]);
	return Array.from(r).filter((e) => !or(e, n));
}
function Ti({ customMapping: e }) {
...
var Di = class extends ir {
	constructor(e = {}) {
		let t = ji(e);
		super(Oi(e, t)), this.runtimeConfig = {
			...
			_tagIds: e._tagIds
		}, this.gtServicesEnabled = t, this.logLevel = li();
	}
	getDefaultLocale() {
	...
	isDevHotReloadEnabled() {
		return !this.runtimeConfig._disableDevHotReload && !!this.runtimeConfig.devApiKey && !!this.runtimeConfig.projectId && this.runtimeConfig.runtimeUrl !== null && this.runtimeConfig.runtimeUrl !== "" && bi() === "development";
	}
	isGTServicesEnabled() {
		return this.gtServicesEnabled;
	}
	isDebugLoggingEnabled() {
		return ui(this.logLevel);
	}
	getGTClassClean(e) {
		return new si({
	...
	getLocaleConfig(e) {
		return !e || !Ai(e) ? this : new ir(ki(e));
	}
...
function ki({ defaultLocale: e = "en", locales: t = [], customMapping: n } = {}) {
	return {
		defaultLocale: e,
...
var { getConditionStore: Pi, setConditionStore: Fi } = Ni(D({
	source: "gt-i18n",
	severity: "Error",
...
function Li(e) {
	let t = "hash" in e ? e.hash : Ii(e.message, e.options);
	return `${e.locale}:${t}`;
}
var Ri = [];
function zi({ locale: e, enableI18n: t, localesProp: n = Ri }) {
...
var Bi = "server-render", Vi = Symbol.for("generaltranslation.react-core.ReactI18nConfig"), Hi = class extends Di {
	renderStrategy;
	localeCookieName;
	regionCookieName;
	enableI18nCookieName;
	constructor(e = {}, t = Bi) {
		super(e), Wi(t), Object.defineProperty(this, Vi, { value: !0 }), this.renderStrategy = t, this.localeCookieName = e.localeCookieName ?? "generaltranslation.locale", this.regionCookieName = e.regionCookieName ?? "generaltranslation.region", this.enableI18nCookieName = e.enableI18nCookieName ?? "generaltranslation.enable-i18n";
	}
	getRenderStrategy() {
...
function Gi(e) {
	...
	let t = e;
	return t[Vi] === !0 && typeof t.getRenderStrategy == "function" && typeof t.getLocaleCookieName == "function" && typeof t.getRegionCookieName == "function" && typeof t.getEnableI18nCookieName == "function";
}
var { getConditionStore: Ki, setConditionStore: qi, isConditionStoreInitialized: Ji } = Ni(D({
	source: "@generaltranslation/react-core",
	severity: "Error",
...
function Yi({ Currency: e, GtInternalCurrency: t, DateTime: n, GtInternalDateTime: r, Num: i, GtInternalNum: a, RelativeTime: o, GtInternalRelativeTime: s, Var: c, GtInternalVar: l }) {
	return function({ variableType: u, variableValue: d, variableOptions: f, locales: p, enableI18n: m, injectionType: h }) {
		...
		if (u === "rt") {
			...
			if (typeof d == "number" && t?.unit) return _(e, {
				...g,
				value: d,
				unit: t.unit,
				baseDate: t?.baseDate,
...
function Zi(e = {}, t) {
	return typeof e.name == "string" ? e.name : `_gt_${Xi[t] || "value"}_${e["data-_gt"]?.id}`;
}
function Qi(e) {
...
function na({ renderVariable: e }) {
	return function({ children: n, defaultLocale: r = "en", enableI18n: i }) {
		let a = (n) => {
			let a = ea(n);
			if (Qi(n.props)) {
				let { variableType: t, variableValue: a, variableOptions: o, injectionType: s } = $i(n.props);
				return e({
					variableType: t,
					variableValue: a,
					variableOptions: o,
...
function ra({ renderVariable: e }) {
	let n = na({ renderVariable: e });
	function r({ sourceElement: e, targetElement: r, locales: a = ["en"], enableI18n: o }) {
		...
		if (u && Object.entries(fn).forEach(([e, t]) => {
			u[e] && (d[t] = u[e]);
		}), l === "plural") {
			let t = e.props.n;
			return typeof t == "number" ? i({
				source: ta(t, a, c.branches || {}) ?? e.props.children,
				target: ta(t, a, r.d?.b || {}) ?? r.c,
				locales: a,
				enableI18n: o
			}) : n({
				children: e,
	...
	function i({ source: i, target: a, locales: o = ["en"], enableI18n: s }) {
		...
		if (Array.isArray(a) && !Array.isArray(i) && i && (i = [i]), Array.isArray(i) && Array.isArray(a)) {
			let n = {}, c = {}, l = {}, u = i.filter((e) => {
				if (t.isValidElement(e)) {
					if (Qi(e.props)) {
						let { variableName: t, variableValue: r, variableOptions: i, injectionType: a } = $i(e.props);
						n[t] = r, c[t] = i, l[t] = a;
					} else return !0;
				}
				return !1;
			...
			return a.map((i, a) => {
				if (typeof i == "string") return _(t.Fragment, { children: i }, `string_${a}`);
				if (Qt(i)) return _(t.Fragment, { children: e({
					variableType: i.v || "v",
					variableValue: n[i.k],
				...
				let u = d(i);
				return u ? _(t.Fragment, { children: r({
					sourceElement: u,
					targetElement: i,
					locales: o,
					enableI18n: s
		...
		if (a && typeof a == "object" && !Array.isArray(a)) {
			...
			if (t.isValidElement(i)) {
				...
				if (Qi(i.props)) {
					let { variableValue: t, variableOptions: n, variableType: r, injectionType: a } = $i(i.props);
					return e({
						variableType: r,
						variableValue: t,
						variableOptions: n,
...
var oa = { display: "contents" }, sa = globalThis.navigator?.product === "ReactNative";
function ca(e) {
	if (e == null || typeof e == "boolean" || e === "") return !0;
	if (Array.isArray(e)) return !e.some((e) => !ca(e));
	if (c(e) && e.type === r) {
...
function la(e, t) {
	return sa || !ia() ? e : c(e) && typeof e.type == "string" ? a(e, { "data-_gt-hash": t }) : ca(e) ? e : s("span", {
		"data-_gt-hash": t,
		style: oa
	}, e);
}
...
function da(e) {
	let t = Yi(e), n = na({ renderVariable: t }), r = ra({ renderVariable: t });
	return {
		renderVariable: t,
...
fa.set, fa.isInitialized;
function ma() {
	let e = D({
		source: "@generaltranslation/react-core",
		severity: "Error",
		whatHappened: "Cannot access I18nStore before it is initialized.",
		fix: Ui().getRenderStrategy() === "SPA" ? "Initialize GT before reading GT runtime context." : "Add a <GTProvider> at the root of your component tree."
	});
	return Error(e);
}
var ha = hi({
...
function ga() {
	return ha.isInitialized() || ha.set(o(void 0)), ha.get();
}
function _a() {
	let e = u(ga());
	if (e || Ui().getRenderStrategy() === "SPA") return e;
	throw Error(va());
}
function va() {
	return D({
...
function wa() {
	return _a()?.i18nStore || pa();
}
function Ta() {
	return _a()?.translationsSnapshot || {};
}
function Ea() {
	return Da(Ca());
}
function Da(e) {
	let t = _a()?.onMissingTranslation, n = ka(e);
	return l((e) => {
		t ? t(e) : n(Li(e), {
			type: "translation",
			lookup: e
...
var Oa = Ea;
function ka(e) {
	let t = A().isDevHotReloadEnabled(), n = wa(), r = /* @__PURE__ */ new Map();
	return d(() => {
...
function Aa({ _enableI18n: e, _locale: t, children: n, currency: r = "USD", options: i = {}, locales: a = [] }) {
	let o = zi({
		locale: t,
		enableI18n: e,
		localesProp: a
...
ja._gtt = "variable-currency-automatic", Ma._gtt = "variable-currency";
...
Pa._gtt = "variable-datetime-automatic", Fa._gtt = "variable-datetime";
...
La._gtt = "variable-number-automatic", Ra._gtt = "variable-number";
function za({ _enableI18n: e, _locale: t, date: n, children: r, value: i, unit: a, baseDate: o, locales: s = [], options: c = {} }) {
	let l = zi({
		locale: t,
		enableI18n: e,
		localesProp: s
...
Ba._gtt = "variable-relative-time-automatic", Va._gtt = "variable-relative-time";
function Ha({ children: e }) {
	return e;
}
function Ua({ children: e }) {
	return Ha({ children: e });
}
function Wa({ children: e }) {
	return Ha({ children: e });
}
Ua._gtt = "variable-variable", Wa._gtt = "variable-variable-automatic";
function Ga(e) {
	let t = wa(), n = Ta(), r = Oa(), i = g((n) => t.subscribeToTranslate(e, n), () => t.getTranslateSnapshot(e, n), () => t.getTranslateSnapshot(e, n));
	return i == null && A().isDevHotReloadEnabled() && r(e), i;
}
var { renderVariable: Ka, renderDefaultChildren: qa, renderTranslatedChildren: Ja, renderPreparedT: Ya } = da({
	Currency: Ma,
	GtInternalCurrency: ja,
	DateTime: Fa,
	GtInternalDateTime: Pa,
	Num: Ra,
	GtInternalNum: La,
	RelativeTime: Va,
	GtInternalRelativeTime: Ba,
	Var: Ua,
	GtInternalVar: Wa
});
function Xa(e, n = 0) {
	let r = n, i = (e) => {
		...
		if (a) {
			...
			if ((e[1] === "automatic" || e[2] === "automatic") && (i.injectionType = "automatic"), e[0] === "translate" && (e[0] = "fragment"), e[0] === "variable" && (i.variableType = e?.[1] || "variable"), e[0] === "plural") {
				let e = Object.entries(n).reduce((e, [t, n]) => (sn(t) && (e[t] = Xa(n, r)), e), {});
				Object.keys(e).length && (i.branches = e);
			}
			if (e[0] === "branch") {
				let { children: e, branch: t, ...a } = n, o = Object.fromEntries(Object.entries(a).filter(([e]) => !e.startsWith("data-"))), s = Object.entries(o).reduce((e, [t, n]) => (e[t] = Xa(n, r), e), {});
...
function Qa(e, t) {
	let { type: n, props: r } = e, i = to(n);
	if (typeof r != "object" || !r) return e;
	if (i) {
		let { componentType: n, injectionType: o } = i;
		if (n === "variable") return e;
		if (n === "branch") return a(e, { ...Object.entries(r).reduce((e, [n, r]) => (e[n] = n !== "branch" && !n.startsWith("data-") ? $a(r, t) : r, e), {}) });
		if (n === "plural") return a(e, { ...Object.entries(r).reduce((e, [n, r]) => (e[n] = sn(n) || n === "children" ? $a(r, t) : r, e), {}) });
		if (n === "derive") return a(e, {
			...r,
			..."children" in r && { children: eo(r.children, t + 1) }
		});
		if (n === "translate" && o === "automatic" && t > 0) return "children" in r ? eo(r.children, t) : void 0;
		n === "translate" && o === "automatic" && console.warn(no);
	}
	return a(e, {
		...r,
		..."children" in r && { children: eo(r.children, t) }
	});
}
function $a(e, t) {
	return c(e) ? Qa(e, t) : e;
...
function eo(e, t) {
	return Array.isArray(e) ? n.map(e, (e) => $a(e, t)) : $a(e, t);
}
function to(e) {
...
var no = "'@generaltranslation/react-core Warning: A <_T> component was found injected outside of a <Derive> boundary. This may affect translation resolution for this component.";
function ro(e) {
...
var io = (e) => {
	...
	let r = Object.entries(fn).reduce((e, [n, r]) => {
		let i = t[r];
	...
	let { props: t } = e, n = { t: io(e) };
	if (t["data-_gt"]) {
		let e = t["data-_gt"], r = e.transformation;
		if (r === "variable") {
			let n = e.variableType || "variable", r = Zi(t, n), i = un(n);
			return {
				i: e.id,
				k: r,
				v: i
		...
		n.i = e.id, n.d = ao(r, t, e.branches);
	}
	return t.children && (n.c = co(t.children)), n;
}, so = (e) => ro(e) ? oo(e) : typeof e == "number" ? e.toString() : e;
function co(e) {
	return Array.isArray(e) ? e.map(so) : so(e);
}
function lo({ sourceChildren: e, params: t, locale: n }) {
	let r = uo(e), i = fo(r), a = po({
		options: mo(t),
		locale: n
	});
	return aa(i, a), {
...
function po({ options: e, locale: t }) {
	return {
		...e,
		$locale: t
	};
...
function ho({ sourceChildren: e, params: t, _locale: n, _enableI18n: r }) {
	let i = ba(), a = xa(), o = Sa(), s = n ?? i, c = r ?? a;
	return {
		defaultLocale: o,
		enableI18n: c,
		locale: s,
...
go._gtt = "translate-client";
function _o({ children: e, _locale: t, _enableI18n: n, _renderPreparedT: r = Ya, ...i }) {
	let { defaultLocale: a, locale: o, enableI18n: s, targetOptions: c, taggedSourceChildren: l, sourceJsxChildren: u, shouldTranslate: d } = ho({
		sourceChildren: e,
		params: i,
		_locale: t,
		_enableI18n: n
	...
	if (A().isDevHotReloadEnabled() && f == null && p.current != null && d) return p.current;
	let h = r({
...
var yo = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/pages/about/AboutHeader.tsx";
function bo() {
	return vo("AboutHeader"), y(v, { children: [y("h1", {
		className: "mb-4 text-3xl font-bold text-foreground",
		children: y(go, { children: "About This Benchmark" }, void 0, !1, {
			fileName: yo,
			lineNumber: 9,
			columnNumber: 9
		}, this)
		...
		children: y(go, { children: "This is an open-source test application — not a product or a company. Its sole purpose is to provide a realistic, multi-page React app where different i18n libraries can be integrated and measured under identical conditions." }, void 0, !1, {
			fileName: yo,
			lineNumber: 12,
			columnNumber: 9
		}, this)
...
var xo = 6e4, So = (e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`, Co = "DEFAULT_TERMINATOR_KEY", wo = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	constructor(e, t = {}) {
		...
		if (!wo[t.style ?? "ellipsis"]) throw Error(So(t.style ?? "ellipsis"));
		let n, r;
		if (t.maxChars !== void 0) {
			n = t.style ?? "ellipsis";
			let e = new Intl.Locale(this.locale).language;
			r = wo[n][e] || wo[n].DEFAULT_TERMINATOR_KEY;
		}
	...
	get(e, ...t) {
		...
		return a === void 0 && (a = new Eo[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}(), Do = "https://cdn.gtx.dev", Oo = {
	GTJSON: ["GTJSON"],
	JSON: ["JSON"],
	PO: ["PO"],
	POT: ["POT", "PO"],
...
function Ao(e) {
	...
	if (!ko(e.fileFormat, e.transformFormat)) return `Unsupported file format transform: ${e.fileFormat} -> ${e.transformFormat}`;
}
function jo(e) {
	for (let t of e) {
		let e = Ao(t);
...
function Po(e) {
	...
	if (Array.isArray(e)) {
		let t = "[";
		for (let n = 0; n < e.length; n++) n && (t += ","), t += Po(e[n]) || "null";
		return t + "]";
	}
	let t = Object.keys(e).sort(), n = "";
	for (let r of t) {
...
var Lo = re({
	...
	__await: () => ts,
	__awaiter: () => qo,
	__classPrivateFieldGet: () => cs,
	__classPrivateFieldIn: () => us,
	__classPrivateFieldSet: () => ls,
	__createBinding: () => hs,
	__decorate: () => Bo,
	__disposeResources: () => fs,
	__esDecorate: () => Ho,
	__exportStar: () => Yo,
	__extends: () => Ro,
	__generator: () => Jo,
	...
	__read: () => Zo,
	__rest: () => zo,
	__rewriteRelativeImportExtension: () => ps,
	__runInitializers: () => Uo,
	__setFunctionName: () => Go,
	__spread: () => Qo,
	__spreadArray: () => es,
	__spreadArrays: () => $o,
	__values: () => Xo,
...
function Yo(e, t) {
	for (var n in e) n !== "default" && !Object.prototype.hasOwnProperty.call(t, n) && hs(t, e, n);
}
function Xo(e) {
...
function Qo() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(Zo(arguments[t]));
	return e;
}
function $o() {
...
function ts(e) {
	return this instanceof ts ? (this.v = e, this) : new ts(e);
}
function ns(e, t, n) {
	...
	function l(e) {
		e.value instanceof ts ? Promise.resolve(e.value.v).then(u, d) : f(a[0][2], e);
	}
	function u(e) {
		c("next", e);
	}
...
function is(e) {
	...
	return t ? t.call(e) : (e = typeof Xo == "function" ? Xo(e) : e[Symbol.iterator](), n = {}, r("next"), r("throw"), r("return"), n[Symbol.asyncIterator] = function() {
		return this;
	}, n);
	function r(t) {
		n[t] = e[t] && function(n) {
...
function os(e) {
	...
	var t = {};
	if (e != null) for (var n = _s(e), r = 0; r < n.length; r++) n[r] !== "default" && hs(t, e, n[r]);
	return gs(t, e), t;
}
function ss(e) {
...
function fs(e) {
	function t(t) {
		e.error = e.hasError ? new vs(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	function i() {
...
var ms, M, hs, gs, _s, vs, ys, bs = te((() => {
	ms = function(e, t) {
	...
	}, hs = Object.create ? (function(e, t, n, r) {
		r === void 0 && (r = n);
		...
		return _s = Object.getOwnPropertyNames || function(e) {
			var t = [];
			for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
			return t;
		}, _s(e);
	}, vs = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
		var r = Error(n);
...
function js(e) {
	return !!(e && typeof e == "object" && e.type === xs.number);
}
function Ms(e) {
	return !!(e && typeof e == "object" && e.type === xs.dateTime);
}
var Ns = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, Ps = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Fs(e) {
	var t = {};
...
function Ls(e) {
	...
	for (var t = e.split(Is).filter(function(e) {
		return e.length > 0;
...
var zs = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, Bs = /^(@+)?(\+|#+)?[rs]?$/g, Vs = /(\*)(0+)|(#+)(0+)|(0+)/g, Hs = /^(0+)$/;
function Us(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(Bs, function(e, n, r) {
...
function Gs(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !Hs.test(e)) throw Error("Malformed concise eng/scientific notation");
	...
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "integer-width":
				...
				i.options[0].replace(Vs, function(e, n, r, i, a, o) {
		...
		if (zs.test(i.stem)) {
			...
			i.stem.replace(zs, function(e, n, r, i, a, o) {
			...
			var a = i.options[0];
			a === "w" ? t = M(M({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = M(M({}, t), Us(a)));
			continue;
		}
		if (Bs.test(i.stem)) {
			t = M(M({}, t), Us(i.stem));
...
function Ys(e, t) {
	for (var n = "", r = 0; r < e.length; r++) {
		...
		if (i === "j") {
			...
			var o = 1 + (a & 1), s = a < 2 ? 1 : 3 + (a >> 1), c = "a", l = Xs(t);
...
function Xs(e) {
	...
	var n = e.language, r;
	return n !== "root" && (r = e.maximize().region), (Js[r || ""] || Js[n || ""] || Js[`${n}-001`] || Js["001"])[0];
}
bs();
var Zs = RegExp(`^${Ns.source}*`), Qs = RegExp(`${Ns.source}*\$`);
function F(e, t) {
	return {
		start: e,
		end: t
...
var $s = !!String.prototype.startsWith && "_a".startsWith("a", 1), ec = !!String.fromCodePoint, tc = !!Object.fromEntries, nc = !!String.prototype.codePointAt, rc = !!String.prototype.trimStart, ic = !!String.prototype.trimEnd, ac = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, oc = !0;
try {
	oc = pc("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	oc = !1;
}
var sc = $s ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, cc = ec ? String.fromCodePoint : function() {
	...
	return t;
}, lc = tc ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
var mc;
if (oc) {
	var hc = pc("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	mc = function(e, t) {
		return hc.lastIndex = t, hc.exec(e)[1] ?? "";
	};
} else mc = function(e, t) {
	for (var n = [];;) {
		var r = uc(e, t);
		if (r === void 0 || bc(r) || xc(r)) break;
		n.push(r), t += r >= 65536 ? 2 : 1;
	}
	return cc.apply(void 0, n);
};
var gc = function() {
	function e(e, t) {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			} else if (i === 60 && !this.ignoreTag && _c(this.peek() || 0)) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !_c(this.char())) return this.error(N.INVALID_TAG, F(o, this.clonePosition()));
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && yc(this.char());) this.bump();
		...
		return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !vc(this.peek() || 0)) ? (this.bump(), "<") : null;
		...
		return cc.apply(void 0, t);
	}, e.prototype.tryParseUnquoted = function(e, t) {
		if (this.isEOF()) return null;
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), cc(n));
		...
		var e = this.clonePosition(), t = this.offset(), n = mc(this.message, t), r = t + n.length;
		...
		switch (a) {
			...
			case "time":
				...
				if (s && sc(s?.style, "::", 0)) {
					...
					var m = p;
					this.locale && (m = Ys(p, this.locale));
					var u = {
						type: xs.dateTime,
						pattern: m,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? Fs(m) : {}
					};
					return {
						val: {
		...
		if (sc(this.message, e, this.offset())) {
		...
		for (; !this.isEOF() && bc(this.char());) this.bump();
...
function Sc(e) {
	e.forEach(function(e) {
		if (delete e.location, Ds(e) || Os(e)) for (var t in e.options) delete e.options[t].location, Sc(e.options[t].value);
		else ws(e) && js(e.style) || (Ts(e) || Es(e)) && Ms(e.style) ? delete e.style.location : As(e) && Sc(e.children);
	});
}
function Cc(e, t) {
	t === void 0 && (t = {}), t = M({
	...
	var n = new gc(e, t).parse();
	if (n.err) {
		var r = SyntaxError(N[n.err.kind]);
		throw r.location = n.err.location, r.originalMessage = n.err.message, r;
	}
	return t?.captureLocation || Sc(n.val), n.val;
}
var wc = ne(((e) => {
	...
	Object.defineProperty(e, "__esModule", { value: !0 }), bs(), ae(Lo), wc();
})), Ec = wc();
Tc();
function Dc({ icuString: e, shouldVisit: t, visitor: n, options: { recurseIntoVisited: r = !0, ...i } }) {
	let a = Cc(e, i);
	return o(a), a;
	function o(e) {
		e.map(s);
...
var kc = RegExp(`^${Oc}$`);
function Ac(e) {
	return e.type === Ec.TYPE.select && kc.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === Ec.TYPE.literal);
}
function jc(e) {
	if (!e.includes("_gt_")) return e;
	let t = [];
...
function Mc(e, t) {
	var n = t && t.cache ? t.cache : Hc, r = t && t.serializer ? t.serializer : Bc;
	return (t && t.strategy ? t.strategy : Lc)(e, {
		cache: n,
		serializer: r
	});
}
...
function Lc(e, t) {
	var n = e.length === 1 ? Pc : Fc;
	return Ic(e, this, n, t.cache.create(), t.serializer);
}
function Rc(e, t) {
	return Ic(e, this, Fc, t.cache.create(), t.serializer);
}
function zc(e, t) {
	return Ic(e, this, Pc, t.cache.create(), t.serializer);
}
var Bc = function() {
...
var Gc = function(e) {
	...
	Ro(t, e);
	function t(t, n, r, i) {
		return e.call(this, `Invalid values for "${t}": "${n}". Options are "${Object.keys(r).join("\", \"")}"`, Wc.INVALID_VALUE, i) || this;
	}
	return t;
}(Gc), qc = function(e) {
	Ro(t, e);
	function t(t, n, r) {
		return e.call(this, `Value for "${t}" must be of type ${n}`, Wc.INVALID_VALUE, r) || this;
	}
	return t;
}(Gc), Jc = function(e) {
	Ro(t, e);
	function t(t, n) {
		return e.call(this, `The intl string context variable "${t}" was not provided to the string "${n}"`, Wc.MISSING_VALUE, n) || this;
	}
	return t;
}(Gc), I;
(function(e) {
...
function Zc(e, t, n, r, i, a, o) {
	...
	for (var s = [], c = 0, l = e; c < l.length; c++) {
		...
		if (Ts(u)) {
			var p = typeof u.style == "string" ? r.date[u.style] : Ms(u.style) ? u.style.parsedOptions : void 0;
			s.push({
				type: I.literal,
		...
		if (Es(u)) {
			var p = typeof u.style == "string" ? r.time[u.style] : Ms(u.style) ? u.style.parsedOptions : r.time.medium;
			s.push({
				type: I.literal,
				value: n.getDateTimeFormat(t, p).format(f)
			});
		...
		if (ws(u)) {
			var p = typeof u.style == "string" ? r.number[u.style] : js(u.style) ? u.style.parsedOptions : void 0;
		...
		if (As(u)) {
			...
			if (!Xc(g)) throw new qc(h, "function", o);
			var _ = g(Zc(m, t, n, r, i, a).map(function(e) {
				return e.value;
			}));
		...
		if (Ds(u)) {
			...
			if (!v) throw new Kc(u.value, f, Object.keys(u.options), o);
			s.push.apply(s, Zc(v.value, t, n, r, i));
			continue;
		}
		if (Os(u)) {
			var v = u.options[`=${f}`];
			if (!v) {
				if (!Intl.PluralRules) throw new Gc("Intl.PluralRules is not available in this environment.\nTry polyfilling it using \"@formatjs/intl-pluralrules\"\n", Wc.MISSING_INTL_API, o);
				var y = n.getPluralRules(t, { type: u.pluralType }).select(f - (u.offset || 0));
				v = u.options[y] || u.options.other;
			}
			if (!v) throw new Kc(u.value, f, Object.keys(u.options), o);
			s.push.apply(s, Zc(v.value, t, n, r, i, f - (u.offset || 0)));
			continue;
		}
	}
	return Yc(s);
...
function tl(e) {
	return e === void 0 && (e = {
		...
		getNumberFormat: Mc(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.NumberFormat).bind.apply(e, es([void 0], t, !1)))();
		}, {
			cache: el(e.number),
			strategy: Uc.variadic
		}),
		getDateTimeFormat: Mc(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.DateTimeFormat).bind.apply(e, es([void 0], t, !1)))();
		}, {
			cache: el(e.dateTime),
			strategy: Uc.variadic
		}),
		getPluralRules: Mc(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.PluralRules).bind.apply(e, es([void 0], t, !1)))();
		}, {
...
var nl = function() {
	function e(t, n, r, i) {
		...
		if (this.formatterCache = {
			...
			return Zc(a.ast, a.locales, a.formatters, a.formats, e, void 0, a.message);
		...
		this.formats = $c(e.formats, r), this.formatters = i && i.formatters || tl(this.formatterCache);
	}
	...
	try {
		...
		})() || j.get("DisplayNames", ["en"], { type: "language" }).of(t) === t && !il(t) || n && j.get("DisplayNames", ["en"], { type: "region" }).of(n) === n || r && j.get("DisplayNames", ["en"], { type: "script" }).of(r) === r && !rl.includes(r));
	} catch {
		return !1;
	}
}, R = (e) => {
...
function ol(...e) {
	try {
		let t = e.flat().map(R);
		for (let e = 0; e < t.length; e++) for (let n = e + 1; n < t.length; n++) if (!al(t[e], t[n])) return !1;
		return !0;
	} catch (e) {
		return console.error(e), !1;
	}
...
function cl(e, t, n, r) {
	return !(!L(e, r) || !L(t, r) || n && n.some((e) => !L(e, r)) || ol(e, t) || n && !n.some((e) => sl(t, e)));
}
var ll = (e, t, n) => {
	if (e?.[t]) return typeof e[t] == "string" ? n === "name" ? e[t] : void 0 : e[t][n];
}, ul = (e, t) => !!(t?.[e] && typeof t[e] == "object" && "code" in t[e] && t[e].code && L(t[e].code));
function dl(e, t) {
	let n = e;
	t && ul(e, t) && (e = t[e].code);
	try {
		...
		if (s) return s;
		let c = i.maximize();
		return hl[c.language] || yl(c.region || "");
	} catch {
		return ml;
	}
}
var fl = "🌍", pl = "🌏", ml = fl, hl = {
	...
	EU: "🇪🇺",
	419: "🌎"
}, _l = /* @__PURE__ */ new Set(/* @__PURE__ */ "AF.AX.AL.DZ.AS.AD.AO.AI.AQ.AG.AR.AM.AW.AU.AT.AZ.BS.BH.BD.BB.BY.BE.BZ.BJ.BM.BT.BO.BQ.BA.BW.BV.BR.IO.BN.BG.BF.BI.CV.KH.CM.CA.KY.CF.TD.CL.CN.CX.CC.CO.KM.CD.CG.CK.CR.CI.HR.CU.CW.CY.CZ.DK.DJ.DM.DO.EC.EG.SV.GQ.ER.EE.SZ.ET.FK.FO.FJ.FI.FR.GF.PF.TF.GA.GM.GE.DE.GH.GI.GR.GL.GD.GP.GU.GT.GG.GN.GW.GY.HT.HM.VA.HN.HK.HU.IS.IN.ID.IR.IQ.IE.IM.IL.IT.JM.JP.JE.JO.KZ.KE.KI.KP.KR.KW.KG.LA.LV.LB.LS.LR.LY.LI.LT.LU.MO.MG.MW.MY.MV.ML.MT.MH.MQ.MR.MU.YT.MX.FM.MD.MC.MN.ME.MS.MA.MZ.MM.NA.NR.NP.NL.NC.NZ.NI.NE.NG.NU.NF.MK.MP.NO.OM.PK.PW.PS.PA.PG.PY.PE.PH.PN.PL.PT.PR.QA.RE.RO.RU.RW.BL.SH.KN.LC.MF.PM.VC.WS.SM.ST.SA.SN.RS.SC.SL.SG.SX.SK.SI.SB.SO.ZA.GS.SS.ES.LK.SD.SR.SJ.SE.CH.SY.TW.TJ.TZ.TH.TL.TG.TK.TO.TT.TN.TR.TM.TC.TV.UG.UA.AE.GB.US.UM.UY.UZ.VU.VE.VN.VG.VI.WF.EH.YE.ZM.ZW".split(".")), vl = 127397;
function yl(e) {
	return bl(e) || "🌍";
}
function bl(e) {
	let t = e.toUpperCase(), n = gl[t];
	if (n) return n;
	if (_l.has(t)) return String.fromCodePoint(t.charCodeAt(0) + vl, t.charCodeAt(1) + vl);
}
function xl(e, t) {
	if (t) {
		let n = {};
...
function Sl(e, t = "en", n) {
	let r = e;
	n && ul(e, n) && (e = n[e].code), t ||= "en";
	try {
		let i = R(e), a = j.get("Locale", e), o = a.language, s = xl([
			r,
			e,
			i,
			o
			...
			t,
			"en"
		], g = j.get("DisplayNames", m, { type: "language" }), _ = j.get("DisplayNames", h, { type: "language" }), v = s?.name, y = s?.nativeName || s?.name, b = v || g.of(e) || e, x = y || _.of(e) || e, S = s?.maximizedName || v || g.of(u) || e, C = s?.nativeMaximizedName || y || _.of(u) || e, w = s?.minimizedName || v || g.of(p) || e, ee = s?.nativeMinimizedName || y || _.of(p) || e, T = s?.languageName || v || g.of(o) || e, E = s?.nativeLanguageName || y || _.of(o) || e, te = s?.nameWithRegionCode || c ? `${T} (${c})` : b, ne = s?.nativeNameWithRegionCode || (c ? `${E} (${c})` : x) || te, re = j.get("DisplayNames", m, { type: "region" }), ie = j.get("DisplayNames", h, { type: "region" }), ae = s?.regionName || (d ? re.of(d) : "") || "", oe = s?.nativeRegionName || (d ? ie.of(d) : "") || "", se = j.get("DisplayNames", m, { type: "script" }), ce = j.get("DisplayNames", h, { type: "script" });
		return {
			code: i,
			name: b,
			nativeName: x,
			...
			scriptName: s?.scriptName || (f ? se.of(f) : "") || "",
			nativeScriptName: s?.nativeScriptName || (f ? ce.of(f) : "") || "",
			emoji: s?.emoji || dl(i, n)
		};
	} catch {
		let t = L(e) ? R(e) : e, r = t?.split("-"), i = r?.[0] || t || "", a = r.length > 2 ? r?.[2] : r?.[1] || "", o = r?.[3] || "", s = xl([t, i], n);
		t = s?.code || t;
		let c = s?.name || t, l = s?.nativeName || c, u = s?.maximizedCode || t, d = s?.maximizedName || c, f = s?.nativeMaximizedName || l, p = s?.minimizedCode || t, m = s?.minimizedName || c, h = s?.nativeMinimizedName || l;
		i = s?.languageCode || i;
		let g = s?.languageName || c, _ = s?.nativeLanguageName || l;
...
function Cl(e, t, n) {
	...
	for (let n of e) {
		let e = t.filter((e) => sl(n, e)), r = ({ locale: t, languageCode: n, minimizedCode: r, regionCode: i, scriptCode: a }) => {
			let o = [
				t,
				`${n}-${i}`,
				`${n}-${a}`,
...
var Ol = class {
	...
	handle(e) {
		let t = [];
		this.config.includeTimestamp && t.push(`[${e.timestamp.toISOString()}]`);
		let n = Tl[e.level], r = `[${e.level.toUpperCase()}]`;
		t.push(`${n}${r}${El}`), this.config.prefix && t.push(`[${this.config.prefix}]`), this.config.includeContext && e.context && t.push(`[${e.context}]`), t.push(e.message), e.metadata && Object.keys(e.metadata).length > 0 && t.push(`\n  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
		let i = t.join(" ");
		switch (e.level) {
			case "debug":
				console.debug(i);
	...
	constructor(e = {}) {
		this.config = {
			...
			handlers: [],
			...e
		}, this.handlers = [...this.config.handlers || []], this.config.enableConsole && this.handlers.push(new Ol(this.config));
	}
	addHandler(e) {
		this.handlers.push(e);
	}
	...
	shouldLog(e) {
		return wl[e] >= wl[this.config.level];
	}
	log(e, t, n, r) {
		if (!this.shouldLog(e)) return;
		let i = {
...
jl.child("validation"), jl.child("formatting"), jl.child("locale");
var Nl = jl.child("GT instance");
function Pl({ value: e, locales: t = "en", options: n = {} }) {
	return j.get("CutoffFormat", t, n).format(e);
}
function Fl(e, t = "en", n = {}) {
	return new nl(e, t).format(n)?.toString() ?? "";
}
function Il(e) {
	return e;
}
...
function zl({ value: e, locales: t = ["en"], currency: n = "USD", options: r = {} }) {
	return j.get("NumberFormat", t, {
		style: "currency",
		currency: n,
		numberingSystem: "latn",
...
function Bl({ value: e, locales: t = ["en"], options: n = {} }) {
...
function Vl({ value: e, locales: t = ["en"], options: n = {} }) {
...
function Ul({ date: e, baseDate: t, locales: n = ["en"], options: r = {} }) {
	let { value: i, unit: a } = Hl(e, t);
	return Wl({
		value: i,
		unit: a,
		locales: n,
...
function Wl({ value: e, unit: t, locales: n = ["en"], options: r = {} }) {
...
function Kl(e) {
	try {
		let t = Yl(j.get("Locale", e));
		if (t) return t;
	} catch {}
	let { scriptCode: t, languageCode: n } = Sl(e);
	return t ? Xl(t) ? "rtl" : "ltr" : n && Zl(n) ? "rtl" : "ltr";
}
...
function Xl(e) {
	return e ? ql.has(e.toLowerCase()) : !1;
}
function Zl(e) {
	return e ? Jl.has(e.toLowerCase()) : !1;
}
function Ql(e, t) {
	try {
...
var tu = class {
	...
	formatMessage(e, t, n = {}) {
		let { locales: r, variables: i, dataFormat: a } = n;
		return a === "STRING" ? Il(e) : Fl(e, this.getFormattingLocales(t, r), i);
	}
	formatList(e, t, n = {}) {
		let { locales: r, ...i } = n;
		return Bl({
	...
	getLocaleName(e) {
		return Gl(e, this.defaultLocale, this.customMapping);
	}
	getLocaleEmoji(e) {
		return dl(e, this.customMapping);
	}
	getLocaleProperties(e) {
		return Sl(e, this.defaultLocale, this.customMapping);
	}
	requiresTranslation(e, t = this.defaultLocale, n = this.translationLocales) {
		return cl(this.resolveCanonicalLocale(t), this.resolveCanonicalLocale(e), n ? this.resolveCanonicalLocaleList(n) : void 0, this.customMapping);
	}
	determineLocale(e, t = this.locales) {
		let n = t.map((e) => ({
			locale: e,
			canonicalLocale: this.resolveCanonicalLocale(e)
		})), r = Cl(Array.isArray(e) ? this.resolveCanonicalLocaleList(e) : this.resolveCanonicalLocale(e), n.map(({ canonicalLocale: e }) => e), this.customMapping);
		if (r) return n.find(({ canonicalLocale: e }) => e === r)?.locale || this.resolveAliasLocale(r);
	}
	getLocaleDirection(e) {
		return Kl(this.resolveCanonicalLocale(e));
	}
	isValidLocale(e) {
		return L(e, this.customMapping);
	}
	resolveCanonicalLocale(e) {
		return eu(e, this.customMapping);
	}
	resolveAliasLocale(e) {
		return $l(e, this.customMapping);
	}
	...
	isSameDialect(...e) {
		return ol(...this.resolveCanonicalLocaleArgs(e));
	}
	isSameLanguage(...e) {
		return sl(...this.resolveCanonicalLocaleArgs(e));
	}
	isSupersetLocale(e, t) {
		return Ql(this.resolveCanonicalLocale(e), this.resolveCanonicalLocale(t));
	}
};
function nu(e, t) {
	return L(e, t);
...
function cu({ source: e, context: t, id: n, maxChars: r, dataFormat: i }, a = su) {
	let o;
	return o = i === "JSX" ? uu(e) : e, a(Fo({
		source: o,
		...n && { id: n },
		...t && { context: t },
		...r != null && { maxChars: Math.abs(r) },
...
var lu = (e) => {
	if (e && typeof e == "object") {
		let t = {};
		if ("c" in e && e.c && (t.c = uu(e.c)), "d" in e) {
			let n = e?.d;
			n?.b && (t.b = Object.fromEntries(Object.entries(n.b).map(([e, t]) => [e, uu(t)]))), n?.t && (t.t = n.t);
		}
		return Io(e) ? {
			k: e.k,
			...e.v && { v: e.v }
...
function uu(e) {
	return Array.isArray(e) ? e.map(lu) : lu(e);
}
var du = "GT Error:", fu = (e) => `${du} Translation request timed out after ${e}ms.`, pu = (e) => `${du} Translation request failed. Error: ${e}`, mu = (e, t, n) => `${du} API returned error status. Status: ${e}, Status Text: ${t}, Error: ${n}`, hu = (e) => `${du} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a targetLocale in the GT constructor.`, gu = (e) => `${du} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a sourceLocale in the GT constructor.`, _u = (e) => `${du} Cannot call \`${e}\` without a specified project ID. Either pass a project ID to the \`${e}\` function or specify a projectId in the GT constructor.`, vu = (e) => `${du} Cannot call \`${e}\` without a specified API key. Either pass an API key to the \`${e}\` function or specify an apiKey in the GT constructor.`, yu = (e) => `${du} Invalid locale: ${e}.`, bu = (e) => `${du} Invalid locales: ${e.join(", ")}.`;
async function xu(e, t, n) {
	...
	try {
		...
		throw e instanceof Error && e.name === "AbortError" ? fu(n) : e;
	} finally {
		a && clearTimeout(a);
	}
}
async function Su(e) {
	if (!e.ok) {
		...
		throw new ou(mu(e.status, e.statusText, t), e.status, t);
	}
}
function Cu(e, t) {
	if (e instanceof Error && e.name === "AbortError") {
		let e = fu(t);
		throw Ml.error(e), Error(e);
	}
	let n = pu(e instanceof Error ? e.message : String(e));
	throw Ml.error(n), e;
}
var wu = "2026-03-06.v1";
function Tu(e, t = !1) {
	let n = {
		...!t && { "Content-Type": "application/json" },
		"x-gt-project-id": e.projectId
	};
	return e.apiKey && (e.apiKey.startsWith("gtx-internal-") ? n["x-gt-internal-api-key"] = e.apiKey : n["x-gt-api-key"] = e.apiKey), n["gt-api-version"] = wu, n;
}
var Eu = 3, Du = 500;
function Ou(e) {
...
function ku(e, t) {
	switch (e) {
		case "linear": return Du * (t + 1);
		case "exponential": return Du * 2 ** t;
		default: return 0;
	}
}
async function z(e, t, n) {
	let r = n?.timeout ?? 6e4, i = `${e.baseUrl || "https://api2.gtx.dev"}${t}`, a = n?.method ?? "POST", o = n?.retryPolicy ?? "exponential", s = o === "none" ? 0 : Eu, c = {
		method: a,
		headers: Tu(e)
	};
	...
	for (let e = 0; e <= s; e++) {
		...
		return await Su(t), await t.json();
	}
	throw Error("Max retries exceeded");
}
async function Au(e, t, n, r) {
	let i = Array.isArray(e), a = i ? [] : void 0, o = {}, s = i ? e.map((e) => [void 0, e]) : Object.entries(e);
	for (let [e, t] of s) {
		let { source: n, metadata: r } = typeof t == "string" ? { source: t } : t, i = e ?? r?.hash ?? cu({
			source: n,
			dataFormat: r?.dataFormat ?? "STRING",
			...r ?? {}
		});
...
async function Iu(e, t, n) {
	return Nu(e, async (e) => (await z(n, "/v2/project/files/download", {
		body: e,
		timeout: t.timeout
	})).files.map((e) => ({
		...e,
...
async function Lu(e, t, n = {}) {
	return await Nu(e.diffs, async (e) => (await z(t, "/v2/project/files/diffs", {
		body: { diffs: e },
		timeout: n.timeout
	}), [{ success: !0 }]), { batchSize: 100 }), { success: !0 };
}
function Ru(e, t = "en", n) {
	t ||= "en";
	try {
		return {
			code: e,
...
async function zu(e, t, n) {
	return Nu(e, async (e) => (await z(n, "/v2/project/files/upload-files", {
		body: {
			data: e.map(({ source: e }) => ({ source: {
				content: Mo(e.content),
				fileName: e.fileName,
...
async function Bu(e, t, n) {
	return jo(e.map(({ source: e }) => e)), Nu(e, async (e) => (await z(n, "/v2/project/files/upload-translations", {
		body: {
...
async function Hu(e, t, n) {
	let { baseUrl: r } = n, i = t.timeout ? t.timeout : xo, a = `${r || "https://api2.gtx.dev"}/v2/project/info/${encodeURIComponent(e)}`, o;
	try {
		o = await xu(a, {
			method: "GET",
			headers: Tu(n)
	...
	return await Su(o), await o.json();
}
...
async function Ju(e, t, n) {
	...
	let r = await Nu(e, async (e) => (await z(n, "/v2/project/files/moves", {
		body: {
			branchId: t.branchId,
			moves: e
		},
...
async function Yu(e, t, n = {}, r) {
	...
	let a = Mu(t, 100), o = await Promise.all(a.map((e) => i(e)));
...
var Zu = class {
	...
	setConfig({ apiKey: e, devApiKey: t, sourceLocale: n, targetLocale: r, locales: i, projectId: a, customMapping: o, baseUrl: s }) {
		if (e && (this.apiKey = e), t && (this.devApiKey = t), a && (this.projectId = a), n && (this.sourceLocale = R(n), !L(this.sourceLocale, o))) throw Error(yu(this.sourceLocale));
		if (r && (this.targetLocale = R(r), !L(this.targetLocale, o))) throw Error(yu(this.targetLocale));
		if (i) {
			let e = [], t = [];
			if (i.forEach((n) => {
				let r = R(n);
				L(r) ? e.push(r) : t.push(n);
			}), t.length > 0) throw Error(bu(t));
			this.locales = e;
		}
		s && (this.baseUrl = s), o && (this.customMapping = o, this.reverseCustomMapping = Object.fromEntries(Object.entries(o).filter(([, e]) => e && typeof e == "object" && "code" in e).map(([e, t]) => [t.code, e]))), this._localeConfig = new tu({
			defaultLocale: this.sourceLocale,
			locales: this.locales ?? [],
			customMapping: this.customMapping
		});
	...
	async queryBranchData(e) {
		return this._validateAuth("queryBranchData"), await Ku(e, this._getTranslationConfig());
	}
	async createBranch(e) {
		return this._validateAuth("createBranch"), await qu(e, this._getTranslationConfig());
	}
	async processFileMoves(e, t = {}) {
		return this._validateAuth("processFileMoves"), await Ju(e, t, this._getTranslationConfig());
	}
	async getOrphanedFiles(e, t, n = {}) {
		return this._validateAuth("getOrphanedFiles"), await Yu(e, t, n, this._getTranslationConfig());
	}
	async setupProject(e, t) {
		return this._validateAuth("setupProject"), t = {
			...t,
			locales: t?.locales?.map((e) => this.resolveCanonicalLocale(e))
		}, await ju(e, this._getTranslationConfig(), t);
	}
	async checkJobStatus(e, t) {
		return this._validateAuth("checkJobStatus"), await Uu(e, this._getTranslationConfig(), t);
	}
	async awaitJobs(e, t) {
		return this._validateAuth("awaitJobs"), await Wu(e, t, this._getTranslationConfig());
	}
	async enqueueFiles(e, t) {
		...
		if (!n.sourceLocale) {
			let e = gu("enqueueFiles");
			throw Nl.error(e), Error(e);
		}
		if (!n.targetLocales || n.targetLocales.length === 0) {
			let e = hu("enqueueFiles");
			throw Nl.error(e), Error(e);
		}
		return n = {
			...n,
			targetLocales: n.targetLocales.map((e) => this.resolveCanonicalLocale(e))
		}, await Pu(e, n, this._getTranslationConfig());
	}
	async createTag(e) {
		return this._validateAuth("createTag"), await Fu(e, this._getTranslationConfig());
	}
	async publishFiles(e) {
		return this._validateAuth("publishFiles"), await Xu(e, this._getTranslationConfig());
	}
	async submitUserEditDiffs(e) {
		this._validateAuth("submitUserEditDiffs"), await Lu({
			...e,
			diffs: (e.diffs || []).map((e) => ({
				...e,
	...
	async queryFileData(e, t = {}) {
		...
		let n = await Gu(e, t, this._getTranslationConfig());
	...
	async downloadFile(e, t = {}) {
		return this._validateAuth("downloadTranslatedFile"), (await Iu([{
			fileId: e.fileId,
			branchId: e.branchId,
	...
	async downloadFileBatch(e, t = {}) {
		...
		let n = await Iu(e, t, this._getTranslationConfig());
		return {
			files: n.data.map((e) => ({
				...e,
				...e.locale && { locale: this.resolveAliasLocale(e.locale) }
	...
	async uploadSourceFiles(e, t) {
		...
		let r = await zu(e, n, this._getTranslationConfig());
		return {
	...
	async uploadTranslations(e, t) {
		...
		if (!n.sourceLocale) {
			let e = gu("uploadTranslations");
			throw Nl.error(e), Error(e);
		}
		let r = await Bu(e.map((e) => ({
			...e,
	...
	getLocaleName(e = this.targetLocale) {
		if (!e) throw Error(hu("getLocaleName"));
		return this.localeConfig.getLocaleName(e);
	}
	getLocaleEmoji(e = this.targetLocale) {
		if (!e) throw Error(hu("getLocaleEmoji"));
		return this.localeConfig.getLocaleEmoji(e);
	}
	getLocaleProperties(e = this.targetLocale) {
		if (!e) throw Error(hu("getLocaleProperties"));
		return this.localeConfig.getLocaleProperties(e);
	}
	getRegionProperties(e = this.getLocaleProperties().regionCode, t) {
		if (!t) {
		...
		return Ru(e, this.targetLocale, t);
	}
	requiresTranslation(e = this.sourceLocale, t = this.targetLocale, n = this.locales, r = this.customMapping) {
		if (!e) throw Error(gu("requiresTranslation"));
		if (!t) throw Error(hu("requiresTranslation"));
		return r === this.customMapping ? this.localeConfig.requiresTranslation(t, e, n) : cl(e, t, n, r);
	}
	determineLocale(e, t = this.locales || [], n = this.customMapping) {
		return n === this.customMapping ? this.localeConfig.determineLocale(e, t ?? []) : Cl(e, t, n);
	}
	getLocaleDirection(e = this.targetLocale) {
		if (!e) throw Error(hu("getLocaleDirection"));
		return this.localeConfig.getLocaleDirection(e);
	}
	isValidLocale(e = this.targetLocale, t = this.customMapping) {
		if (!e) throw Error(hu("isValidLocale"));
		return t === this.customMapping ? this.localeConfig.isValidLocale(e) : L(e, t);
	}
	resolveCanonicalLocale(e = this.targetLocale, t = this.customMapping) {
		if (!e) throw Error(hu("resolveCanonicalLocale"));
		return t === this.customMapping ? this.localeConfig.resolveCanonicalLocale(e) : eu(e, t);
	}
	resolveAliasLocale(e, t = this.customMapping) {
		if (!e) throw Error(hu("resolveAliasLocale"));
		return t === this.customMapping ? this.localeConfig.resolveAliasLocale(e) : $l(e, t);
	}
	standardizeLocale(e = this.targetLocale) {
		if (!e) throw Error(hu("standardizeLocale"));
		return this.localeConfig.standardizeLocale(e);
	}
	isSameDialect(...e) {
		return this.localeConfig.isSameDialect(...e);
...
function rd(e, t = "", n = !0) {
	if (e.forEach((e) => {
		switch (e.type) {
			case "error":
				au.error(t + e.message);
				break;
			case "warning": au.warn(t + e.message);
		}
...
function ud(e) {
	let t = [];
	return t.push(...ad(e)), t.push(...sd(e)), t.push(...ld(e)), t;
}
var dd = class {}, fd = "fallback-storage-adapter", pd = class extends dd {
	constructor(...e) {
		super(...e), this.type = fd, this.storage = {};
	}
	getItem(e) {
...
function gd(e) {
	let { cacheUrl: t = Do, projectId: n, _versionId: r, _branchId: i } = e, a = r ? `/${r}` : "", o = i ? `?branchId=${i}` : "";
	return `${t}/${n}/[locale]` + a + o;
}
function _d() {
	return async (e) => ({});
}
function vd({ type: e, remoteTranslationLoaderParams: t, loadTranslations: n }) {
	e === "disabled" && au.warn("I18nManager: No translation loader found. No translations will be loaded.");
	let { cacheUrl: r, projectId: i, _versionId: a, _branchId: o, customMapping: s } = t;
	switch (e) {
		case "remote":
		case "gt-remote": return hd({
			cacheUrl: r || "",
			projectId: i || "",
			_versionId: a,
			_branchId: o,
...
var xd = 25, Sd = 100, Cd = 50, wd = class extends yd {
	...
	genKey(e) {
		return bd(e.message, e.options);
	}
	fallback(e) {
		let t = this._enqueueTranslation(e);
		return this._queue.length >= xd ? this._flushNow() : this._scheduleBatch(), t;
	}
	_flushNow() {
	...
	_drainQueue() {
		for (; this._queue.length > 0 && this._activeRequests < Sd;) {
			let e = this._queue.splice(0, xd);
	...
	async _sendBatchRequest(e) {
		...
		let t = Td(e), n = await this._sendBatchRequestWithErrorHandling(e, t);
...
var Ed = 6e4, Dd = class extends yd {
	constructor({ init: e = {}, ttl: t, loadTranslations: n, createTranslateMany: r, lifecycle: { onLocalesCacheHit: i, onLocalesCacheMiss: a, onTranslationsCacheHit: o, onTranslationsCacheMiss: s } }) {
		super(e, {
			onHit: i,
			onMiss: a
		}), this.ttl = Ed, this.ttl = t === null ? -1 : t ?? 6e4, this._translationLoader = n, this._createTranslateMany = r, this._onTranslationsCacheHit = o, this._onTranslationsCacheMiss = s;
	}
	get(e) {
		let t = this.getCache(e);
...
function Ad({ onLocalesCacheHit: e, onLocalesCacheMiss: t, onTranslationsCacheHit: n, onTranslationsCacheMiss: r }, i) {
...
var jd = 12e3, Md = class extends kd {
	constructor(e) {
		super(), this.resolveTranslationSync = (e, t = {}) => this.lookupTranslation(e, t), rd(ud(e), "I18nManager: "), this.config = Nd(e), this.localeConfig = new tu({
			defaultLocale: this.config.defaultLocale,
			locales: this.config.locales,
			customMapping: this.config.customMapping
		}), this.storeAdapter = e.storeAdapter ?? new pd();
		let t = Ld(e), n = md(this.getGTClassClean(), jd);
		Ad(e.lifecycle ?? {}, (...e) => this.subscribe(...e)), this.localesCache = new Dd({
			loadTranslations: t,
			createTranslateMany: n,
			lifecycle: Od((...e) => this.emit(...e))
		});
	}
	...
	getLocale() {
		return this.storeAdapter.getItem("locale") || (au.warn("getLocale() invoked outside of translation context, falling back to default locale"), this.config.defaultLocale);
	}
	setLocale(e) {
		try {
	...
	async getLookupTranslation(e = this.getLocale(), t = []) {
		try {
			...
			let r = Id(t, n, (e) => this.resolveLocale(e));
			r.length !== t.length && au.warn(`I18nManager: getLookupTranslation(): prefetchEntries must all be the same locale, ignoring all entries that are not for ${n}`);
			let i = this.localesCache.get(n);
	...
	handleError(e) {
		switch (this.config.environment) {
			...
			default: au.error("I18nManager: " + e);
		}
	}
	resolveLocale(e) {
...
function Pd({ defaultLocale: e, locales: t, customMapping: n }) {
	return {
		defaultLocale: e,
...
function Fd(e) {
	return {
		defaultLocale: iu(e.defaultLocale),
		locales: e.locales.map((t) => (typeof e.customMapping?.[t] == "string" ? e.customMapping?.[t] : e.customMapping?.[t]?.code) ? t : iu(t)),
		customMapping: Object.fromEntries(Object.entries(e.customMapping || {}).map(([e, t]) => [e, typeof t == "string" ? iu(t) : {
			...t,
			...t.code ? { code: iu(t.code) } : {}
		}]))
	};
}
function Id(e, t, n) {
...
var Rd = void 0;
function zd() {
	return Rd ||= (au.warn("getI18nManager(): Translation failed because I18nManager not initialized."), new Md({
		defaultLocale: "en",
		locales: ["en"]
	})), Rd;
}
...
var Vd = "DEFAULT_TERMINATOR_KEY", Hd = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	CutoffFormat: class {
		constructor(e, t = {}) {
			...
			if (!Hd[t.style ?? "ellipsis"]) throw Error(((e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`)(t.style ?? "ellipsis"));
			let n, r;
			if (t.maxChars !== void 0) {
				n = t.style ?? "ellipsis";
				let e = new Intl.Locale(this.locale).language;
				r = Hd[n][e] || Hd[n].DEFAULT_TERMINATOR_KEY;
			}
			let i = t.terminator ?? r?.terminator, a = i == null ? void 0 : t.separator ?? r?.separator;
			this.additionLength = (i?.length ?? 0) + (a?.length ?? 0), t.maxChars !== void 0 && Math.abs(t.maxChars) < this.additionLength && (i = void 0, a = void 0), this.options = {
				maxChars: t.maxChars,
...
new class {
	...
	get(e, ...t) {
		let [n = "en", r = {}] = t, i = this._generateKey(n, r), a = this.cache[e]?.[i];
		return a === void 0 && (a = new Ud[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}();
function Wd(e, t, n = "") {
...
var Zd = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = qd(this.buffer);
	}
	update(e) {
		Gd(this), Wd(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		Gd(this), function(e, t) {
			Wd(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, Kd(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = qd(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), ef = /* @__PURE__ */ new Uint32Array(64), tf = class extends Zd {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) ef[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = ef[e - 15], n = ef[e - 2], r = Jd(t, 7) ^ Jd(t, 18) ^ t >>> 3, i = Jd(n, 17) ^ Jd(n, 19) ^ n >>> 10;
			ef[e] = i + ef[e - 7] + r + ef[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (Jd(o, 6) ^ Jd(o, 11) ^ Jd(o, 25)) + Yd(o, s, c) + $d[e] + ef[e] | 0, u = (Jd(n, 2) ^ Jd(n, 13) ^ Jd(n, 22)) + Xd(n, r, i) | 0;
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), Kd(this.buffer);
	}
}, nf = class extends tf {
	A = 0 | Qd[0];
	B = 0 | Qd[1];
...
(function(e, t = {}) {
	let n = (t, n) => e(n).update(t).digest(), r = e(void 0);
	return n.outputLen = r.outputLen, n.blockLen = r.blockLen, n.canXOF = r.canXOF, n.create = (t) => e(t), Object.assign(n, t), Object.freeze(n);
})(() => new nf(), (rf = 1, { oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
var rf, af = function(e, t) {
	return af = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, af(e, t);
...
function of(e, t) {
	...
	af(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var B = function() {
...
var _f = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function vf(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || _f(t, e, n);
}
function yf(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function wf(e) {
	return this instanceof wf ? (this.v = e, this) : new wf(e);
}
function Tf(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof wf ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function Df(e) {
	...
	return n ? n.call(e) : (e = yf(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var kf = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return Af = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, Af(e);
...
function jf(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = Af(e), r = 0; r < n.length; r++) n[r] !== "default" && _f(t, e, n[r]);
	return kf(t, e), t;
}
function Mf(e) {
	return e && e.__esModule ? e : { default: e };
...
var Lf = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function Rf(e) {
	function t(t) {
		e.error = e.hasError ? new Lf(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var V, H, Bf, Vf = Object.freeze({
	__proto__: null,
	__addDisposableResource: If,
	get __assign() {
		return B;
	},
	__asyncDelegator: Ef,
	...
	__runInitializers: df,
	__setFunctionName: pf,
	__spread: xf,
	__spreadArray: Cf,
	__spreadArrays: Sf,
	__values: yf,
...
var Hf = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, Uf = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Wf(e) {
	var t = {};
...
var qf = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, Jf = /^(@+)?(\+|#+)?[rs]?$/g, Yf = /(\*)(0+)|(#+)(0+)|(0+)/g, Xf = /^(0+)$/;
function Zf(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(Jf, function(e, n, r) {
		return typeof r == "string" ? r === "+" ? t.minimumSignificantDigits = n.length : n[0] === "#" ? t.maximumSignificantDigits = n.length : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length + (typeof r == "string" ? r.length : 0)) : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length), "";
	}), t;
}
function Qf(e) {
...
function $f(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !Xf.test(e)) throw Error("Malformed concise eng/scientific notation");
		t.minimumIntegerDigits = e.length;
	}
	return t;
}
...
function tp(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "measure-unit":
			case "unit":
				t.style = "unit", t.unit = Kf(i.options[0]);
				continue;
			case "compact-short":
			case "K":
				t.notation = "compact", t.compactDisplay = "short";
			...
			case "integer-width":
				if (i.options.length > 1) throw RangeError("integer-width stems only accept a single optional option");
				i.options[0].replace(Yf, function(e, n, r, i, a, o) {
					if (n) t.minimumIntegerDigits = r.length;
					else {
		...
		if (Xf.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
		else if (qf.test(i.stem)) {
			if (i.options.length > 1) throw RangeError("Fraction-precision stems only accept a single optional option");
			i.stem.replace(qf, function(e, n, r, i, a, o) {
				return r === "*" ? t.minimumFractionDigits = n.length : i && i[0] === "#" ? t.maximumFractionDigits = i.length : a && o ? (t.minimumFractionDigits = a.length, t.maximumFractionDigits = a.length + o.length) : (t.minimumFractionDigits = n.length, t.maximumFractionDigits = n.length), "";
			});
			var a = i.options[0];
			a === "w" ? t = B(B({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = B(B({}, t), Zf(a)));
		} else if (Jf.test(i.stem)) t = B(B({}, t), Zf(i.stem));
		else {
			var o = Qf(i.stem);
			o && (t = B(B({}, t), o));
			var s = $f(i.stem);
...
function rp(e) {
	...
	var n, r = e.language;
	return r !== "root" && (n = e.maximize().region), (np[n || ""] || np[r || ""] || np[`${r}-001`] || np["001"])[0];
}
var ip = RegExp(`^${Hf.source}*`), ap = RegExp(`${Hf.source}*\$`);
function U(e, t) {
	return {
		start: e,
		end: t
...
var op = !!String.prototype.startsWith && "_a".startsWith("a", 1), sp = !!String.fromCodePoint, cp = !!Object.fromEntries, lp = !!String.prototype.codePointAt, up = !!String.prototype.trimStart, dp = !!String.prototype.trimEnd, fp = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, pp = !0;
try {
	pp = xp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	pp = !1;
}
var mp, hp = op ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, gp = sp ? String.fromCodePoint : function() {
	...
	return n;
}, _p = cp ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
if (pp) {
	var Sp = xp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	mp = function(e, t) {
		return Sp.lastIndex = t, Sp.exec(e)[1] ?? "";
	};
} else mp = function(e, t) {
	for (var n = [];;) {
		var r = vp(e, t);
		if (r === void 0 || Tp(r) || Ep(r)) break;
		n.push(r), t += r >= 65536 ? 2 : 1;
	}
	return gp.apply(void 0, n);
};
(function() {
	function e(e, t) {
		t === void 0 && (t = {}), this.message = e, this.position = {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			if (i === 123) {
				...
				if (i !== 35 || t !== "plural" && t !== "selectordinal") {
					...
					if (i === 60 && !this.ignoreTag && Cp(this.peek() || 0)) {
		...
		if (this.bumpIf(">")) {
			...
			var a = i.val, o = this.clonePosition();
			if (this.bumpIf("</")) {
				if (this.isEOF() || !Cp(this.char())) return this.error(V.INVALID_TAG, U(o, this.clonePosition()));
				var s = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					val: {
						type: H.tag,
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && wp(this.char());) this.bump();
		return this.message.slice(e, this.offset());
	}, e.prototype.parseLiteral = function(e, t) {
		for (var n = this.clonePosition(), r = "";;) {
			var i = this.tryParseQuote(t);
		...
		return this.isEOF() || this.char() !== 60 || !this.ignoreTag && (Cp(e = this.peek() || 0) || e === 47) ? null : (this.bump(), "<");
		var e;
	}, e.prototype.tryParseQuote = function(e) {
		if (this.isEOF() || this.char() !== 39) return null;
		switch (this.peek()) {
		...
		return gp.apply(void 0, t);
	}, e.prototype.tryParseUnquoted = function(e, t) {
		if (this.isEOF()) return null;
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), gp(n));
	}, e.prototype.parseArgument = function(e, t) {
		var n = this.clonePosition();
		...
		var e = this.clonePosition(), t = this.offset(), n = mp(this.message, t), r = t + n.length;
		return this.bumpTo(r), {
			value: n,
		...
		switch (a) {
			...
			case "time":
				...
				if (this.bumpIf(",")) {
					...
					if ((f = bp(g.val)).length === 0) return this.error(V.EXPECT_ARGUMENT_STYLE, U(this.clonePosition(), this.clonePosition()));
					s = {
						style: f,
				...
				if (s && hp(s?.style, "::", 0)) {
					...
					this.locale && (d = function(e, t) {
						for (var n = "", r = 0; r < e.length; r++) {
							...
							if (i === "j") {
								for (var a = 0; r + 1 < e.length && e.charAt(r + 1) === i;) a++, r++;
								var o = 1 + (1 & a), s = a < 2 ? 1 : 3 + (a >> 1), c = rp(t);
					...
					var f = {
						...
						pattern: d,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? Wf(d) : {}
					};
					return {
						val: {
		...
		try {
			n = function(e) {
				if (e.length === 0) throw Error("Number skeleton cannot be empty");
				for (var t = [], n = 0, r = e.split(Gf).filter(function(e) {
					return e.length > 0;
				}); n < r.length; n++) {
					var i = r[n].split("/");
		...
		return {
			val: {
				...
				tokens: n,
				location: t,
				parsedOptions: this.shouldParseSkeletons ? tp(n) : {}
			},
			err: null
		};
	}, e.prototype.tryParsePluralOrSelectOptions = function(e, t, n, r) {
		...
		if (hp(this.message, e, this.offset())) {
			for (var t = 0; t < e.length; t++) this.bump();
			return !0;
		}
		return !1;
		...
		for (; !this.isEOF() && Tp(this.char());) this.bump();
	}, e.prototype.peek = function() {
		if (this.isEOF()) return null;
		var e = this.char(), t = this.offset();
		return this.message.charCodeAt(t + (e >= 65536 ? 2 : 1)) ?? null;
...
var Dp, W = {};
function Op() {
	return Dp || (Dp = 1, Object.defineProperty(W, "__esModule", { value: !0 }), W.SKELETON_TYPE = W.TYPE = void 0, W.isLiteralElement = function(t) {
...
(function() {
	if (kp) return Ap;
	kp = 1, Object.defineProperty(Ap, "__esModule", { value: !0 }), Ap.printAST = n, Ap.doPrintAST = r, Ap.printDateTimeSkeleton = o;
	var e = jp, t = Op();
	function n(e) {
		return r(e, !1);
	}
...
var Mp = "_gt_";
RegExp(`^${Mp}\\d+$`), RegExp(`^${Mp}$`);
var Np = "generaltranslation.locale";
e.use;
var Pp = {
	af: ["af"],
	am: ["am"],
...
function Fp(e) {
	if (!nu(e)) return null;
	e = iu(e);
	let { languageCode: t, ...n } = Qu(e);
	if (Pp[t]?.length) {
		let r = Pp[t], i = ({ locale: e, languageCode: t, minimizedCode: n, regionCode: i, scriptCode: a }) => {
			let o = [
				e,
				`${t}-${i}`,
				`${t}-${a}`,
...
function Lp(e = {}, t) {
	return e.name ? e.name : `_gt_${Ip[t] || "value"}_${e["data-_gt"]?.id}`;
}
var Rp = "en", zp = "DEFAULT_TERMINATOR_KEY", Bp = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	CutoffFormat: class {
		constructor(e, t = {}) {
			...
			if (!Bp[t.style ?? "ellipsis"]) throw Error(((e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`)(t.style ?? "ellipsis"));
			let n, r;
			if (t.maxChars !== void 0) {
				n = t.style ?? "ellipsis";
				let e = new Intl.Locale(this.locale).language;
				r = Bp[n][e] || Bp[n].DEFAULT_TERMINATOR_KEY;
			}
			let i = t.terminator ?? r?.terminator, a = i == null ? void 0 : t.separator ?? r?.separator;
			this.additionLength = (i?.length ?? 0) + (a?.length ?? 0), t.maxChars !== void 0 && Math.abs(t.maxChars) < this.additionLength && (i = void 0, a = void 0), this.options = {
				maxChars: t.maxChars,
...
new class {
	...
	get(e, ...t) {
		let [n = "en", r = {}] = t, i = this._generateKey(n, r), a = this.cache[e]?.[i];
		return a === void 0 && (a = new Vp[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}();
var Hp = "https://cdn.gtx.dev", Up = "https://runtime2.gtx.dev";
function Wp(e) {
	if (e === void 0) return;
	if (e === null) return "null";
	if (typeof e == "number") return isFinite(e) ? "" + e : "null";
	...
	if (Array.isArray(e)) {
		let t = "[";
		for (let n = 0; n < e.length; n++) n && (t += ","), t += Wp(e[n]) || "null";
		return t + "]";
	}
	let t = Object.keys(e).sort(), n = "";
	for (let r of t) {
...
var Qp = typeof Uint8Array.from([]).toHex == "function" && typeof Uint8Array.fromHex == "function", $p = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function em(e, t = {}) {
	let n = (t, n) => e(n).update(t).digest(), r = e(void 0);
	return n.outputLen = r.outputLen, n.blockLen = r.blockLen, n.canXOF = r.canXOF, n.create = (t) => e(t), Object.assign(n, t), Object.freeze(n);
}
var tm = (e) => ({ oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
var im = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = Xp(this.buffer);
	}
	update(e) {
		Jp(this), qp(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		Jp(this), function(e, t) {
			qp(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, Yp(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = Xp(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), sm = /* @__PURE__ */ new Uint32Array(64), cm = class extends im {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) sm[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = sm[e - 15], n = sm[e - 2], r = Zp(t, 7) ^ Zp(t, 18) ^ t >>> 3, i = Zp(n, 17) ^ Zp(n, 19) ^ n >>> 10;
			sm[e] = i + sm[e - 7] + r + sm[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (Zp(o, 6) ^ Zp(o, 11) ^ Zp(o, 25)) + nm(o, s, c) + om[e] + sm[e] | 0, u = (Zp(n, 2) ^ Zp(n, 13) ^ Zp(n, 22)) + rm(n, r, i) | 0;
			l = c, c = s, s = o, o = a + t | 0, a = i, i = r, r = n, n = t + u | 0;
		}
		n = n + this.A | 0, r = r + this.B | 0, i = i + this.C | 0, a = a + this.D | 0, o = o + this.E | 0, s = s + this.F | 0, c = c + this.G | 0, l = l + this.H | 0, this.set(n, r, i, a, o, s, c, l);
	}
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), Yp(this.buffer);
	}
}, lm = class extends cm {
	A = 0 | am[0];
	B = 0 | am[1];
...
}, um = em(() => new lm(), tm(1)), dm = function(e, t) {
	return dm = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, dm(e, t);
...
function fm(e, t) {
	...
	dm(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var G = function() {
...
var Cm = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function wm(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || Cm(t, e, n);
}
function Tm(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function Dm() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(Em(arguments[t]));
	return e;
}
function Om() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function Am(e) {
	return this instanceof Am ? (this.v = e, this) : new Am(e);
}
function jm(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var r, i = n.apply(e, t || []), a = [];
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof Am ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function Nm(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = Tm(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var Fm = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return Im = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, Im(e);
...
function Lm(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = Im(e), r = 0; r < n.length; r++) n[r] !== "default" && Cm(t, e, n[r]);
	return Fm(t, e), t;
}
function Rm(e) {
	return e && e.__esModule ? e : { default: e };
...
var Um = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function Wm(e) {
	function t(t) {
		e.error = e.hasError ? new Um(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var K, q, Km, qm = Object.freeze({
	__proto__: null,
	__addDisposableResource: Hm,
	get __assign() {
		return G;
	},
	__asyncDelegator: Mm,
	...
	__await: Am,
	__awaiter: xm,
	__classPrivateFieldGet: zm,
	__classPrivateFieldIn: Vm,
	...
	__read: Em,
	__rest: pm,
	__rewriteRelativeImportExtension: Gm,
	__runInitializers: _m,
...
var Jm = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, Ym = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Xm(e) {
	var t = {};
	return e.replace(Ym, function(e) {
		var n = e.length;
		switch (e[0]) {
			case "G":
				t.era = n === 4 ? "long" : n === 5 ? "narrow" : "short";
...
var $m = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, eh = /^(@+)?(\+|#+)?[rs]?$/g, th = /(\*)(0+)|(#+)(0+)|(0+)/g, nh = /^(0+)$/;
function rh(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(eh, function(e, n, r) {
		return typeof r == "string" ? r === "+" ? t.minimumSignificantDigits = n.length : n[0] === "#" ? t.maximumSignificantDigits = n.length : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length + (typeof r == "string" ? r.length : 0)) : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length), "";
	}), t;
}
function ih(e) {
...
function ah(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !nh.test(e)) throw Error("Malformed concise eng/scientific notation");
		t.minimumIntegerDigits = e.length;
	}
	return t;
}
...
function sh(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "measure-unit":
			case "unit":
				t.style = "unit", t.unit = Qm(i.options[0]);
				continue;
			case "compact-short":
			case "K":
				t.notation = "compact", t.compactDisplay = "short";
			...
			case "integer-width":
				if (i.options.length > 1) throw RangeError("integer-width stems only accept a single optional option");
				i.options[0].replace(th, function(e, n, r, i, a, o) {
					if (n) t.minimumIntegerDigits = r.length;
					else {
						if (i && a) throw Error("We currently do not support maximum integer digits");
						if (o) throw Error("We currently do not support exact integer digits");
		...
		if (nh.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
		else if ($m.test(i.stem)) {
			if (i.options.length > 1) throw RangeError("Fraction-precision stems only accept a single optional option");
			i.stem.replace($m, function(e, n, r, i, a, o) {
				return r === "*" ? t.minimumFractionDigits = n.length : i && i[0] === "#" ? t.maximumFractionDigits = i.length : a && o ? (t.minimumFractionDigits = a.length, t.maximumFractionDigits = a.length + o.length) : (t.minimumFractionDigits = n.length, t.maximumFractionDigits = n.length), "";
			});
			var a = i.options[0];
			a === "w" ? t = G(G({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = G(G({}, t), rh(a)));
		} else if (eh.test(i.stem)) t = G(G({}, t), rh(i.stem));
		else {
			var o = ih(i.stem);
			o && (t = G(G({}, t), o));
			var s = ah(i.stem);
...
function lh(e) {
	...
	var n, r = e.language;
	return r !== "root" && (n = e.maximize().region), (ch[n || ""] || ch[r || ""] || ch[`${r}-001`] || ch["001"])[0];
}
var uh = RegExp(`^${Jm.source}*`), dh = RegExp(`${Jm.source}*\$`);
function J(e, t) {
	return {
		start: e,
		end: t
...
var fh = !!String.prototype.startsWith && "_a".startsWith("a", 1), ph = !!String.fromCodePoint, mh = !!Object.fromEntries, hh = !!String.prototype.codePointAt, gh = !!String.prototype.trimStart, _h = !!String.prototype.trimEnd, vh = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, yh = !0;
try {
	yh = Dh("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	yh = !1;
}
var bh, xh = fh ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, Sh = ph ? String.fromCodePoint : function() {
	for (var e = [...arguments], t, n = "", r = e.length, i = 0; r > i;) {
		if ((t = e[i++]) > 1114111) throw RangeError(t + " is not a valid code point");
		n += t < 65536 ? String.fromCharCode(t) : String.fromCharCode(55296 + ((t -= 65536) >> 10), t % 1024 + 56320);
	}
	return n;
}, Ch = mh ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
if (yh) {
	var Oh = Dh("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	bh = function(e, t) {
		return Oh.lastIndex = t, Oh.exec(e)[1] ?? "";
	};
} else bh = function(e, t) {
	for (var n = [];;) {
		var r = wh(e, t);
		if (r === void 0 || Mh(r) || Nh(r)) break;
		n.push(r), t += r >= 65536 ? 2 : 1;
	}
	return Sh.apply(void 0, n);
};
var kh = function() {
	function e(e, t) {
		t === void 0 && (t = {}), this.message = e, this.position = {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			if (i === 123) {
				...
				if (i !== 35 || t !== "plural" && t !== "selectordinal") {
					...
					if (i === 60 && !this.ignoreTag && Ah(this.peek() || 0)) {
						if ((a = this.parseTag(e, t)).err) return a;
						r.push(a.val);
					} else {
						var a;
		...
		if (this.bumpIf(">")) {
			...
			var a = i.val, o = this.clonePosition();
			if (this.bumpIf("</")) {
				if (this.isEOF() || !Ah(this.char())) return this.error(K.INVALID_TAG, J(o, this.clonePosition()));
				var s = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					val: {
						type: q.tag,
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && jh(this.char());) this.bump();
		return this.message.slice(e, this.offset());
	}, e.prototype.parseLiteral = function(e, t) {
		for (var n = this.clonePosition(), r = "";;) {
			var i = this.tryParseQuote(t);
		...
		return this.isEOF() || this.char() !== 60 || !this.ignoreTag && (Ah(e = this.peek() || 0) || e === 47) ? null : (this.bump(), "<");
		var e;
	}, e.prototype.tryParseQuote = function(e) {
		if (this.isEOF() || this.char() !== 39) return null;
		switch (this.peek()) {
		...
		return Sh.apply(void 0, t);
	}, e.prototype.tryParseUnquoted = function(e, t) {
		if (this.isEOF()) return null;
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), Sh(n));
	}, e.prototype.parseArgument = function(e, t) {
		var n = this.clonePosition();
		...
		var e = this.clonePosition(), t = this.offset(), n = bh(this.message, t), r = t + n.length;
		return this.bumpTo(r), {
			value: n,
		...
		switch (a) {
			...
			case "time":
				...
				if (this.bumpIf(",")) {
					...
					var c = this.clonePosition();
					if ((g = this.parseSimpleArgStyleIfPossible()).err) return g;
					if ((f = Eh(g.val)).length === 0) return this.error(K.EXPECT_ARGUMENT_STYLE, J(this.clonePosition(), this.clonePosition()));
					s = {
						style: f,
				...
				if (s && xh(s?.style, "::", 0)) {
					...
					this.locale && (d = function(e, t) {
						for (var n = "", r = 0; r < e.length; r++) {
							...
							if (i === "j") {
								for (var a = 0; r + 1 < e.length && e.charAt(r + 1) === i;) a++, r++;
								var o = 1 + (1 & a), s = a < 2 ? 1 : 3 + (a >> 1), c = lh(t);
								for (c != "H" && c != "k" || (s = 0); s-- > 0;) n += "a";
								for (; o-- > 0;) n = c + n;
							} else n += i === "J" ? "H" : i;
						}
					...
					var f = {
						...
						pattern: d,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? Xm(d) : {}
					};
					return {
						val: {
		...
		try {
			n = function(e) {
				if (e.length === 0) throw Error("Number skeleton cannot be empty");
				for (var t = [], n = 0, r = e.split(Zm).filter(function(e) {
					return e.length > 0;
				}); n < r.length; n++) {
					var i = r[n].split("/");
					if (i.length === 0) throw Error("Invalid number skeleton");
		...
		return {
			val: {
				...
				tokens: n,
				location: t,
				parsedOptions: this.shouldParseSkeletons ? sh(n) : {}
			},
			err: null
		};
	}, e.prototype.tryParsePluralOrSelectOptions = function(e, t, n, r) {
		...
		for (; !this.isEOF() && Mh(this.char());) this.bump();
	}, e.prototype.peek = function() {
		if (this.isEOF()) return null;
		var e = this.char(), t = this.offset();
		return this.message.charCodeAt(t + (e >= 65536 ? 2 : 1)) ?? null;
...
function Ph(e) {
	e.forEach(function(e) {
		...
		}(e)) for (var t in e.options) delete e.options[t].location, Ph(e.options[t].value);
		else (function(e) {
			return e.type === q.number;
		})(e) && function(e) {
			return !(!e || typeof e != "object" || e.type !== Km.number);
		}(e.style) ? delete e.style.location : !function(e) {
			return e.type === q.date;
		}(e) && !function(e) {
			return e.type === q.time;
		}(e) || !function(e) {
			return !(!e || typeof e != "object" || e.type !== Km.dateTime);
		}(e.style) ? function(e) {
			return e.type === q.tag;
		}(e) && Ph(e.children) : delete e.style.location;
	});
}
function Fh(e) {
	if (Object.prototype.hasOwnProperty.call(e, "__esModule")) return e;
...
function Lh() {
	if (Ih) return Y;
	var e, t;
	return Ih = 1, Object.defineProperty(Y, "__esModule", { value: !0 }), Y.SKELETON_TYPE = Y.TYPE = void 0, Y.isLiteralElement = function(t) {
		return t.type === e.literal;
...
var Rh, zh = Lh(), Bh = {}, Vh = Fh(qm), Hh = function() {
	if (Rh) return Bh;
	Rh = 1, Object.defineProperty(Bh, "__esModule", { value: !0 }), Bh.printAST = n, Bh.doPrintAST = r, Bh.printDateTimeSkeleton = o;
	var e = Vh, t = Lh();
	function n(e) {
		return r(e, !1);
	}
...
function Gh({ icuString: e, shouldVisit: t, visitor: n, options: { recurseIntoVisited: r = !0, ...i } }) {
	let a = function(e, t) {
		t === void 0 && (t = {}), t = G({
			shouldParseSkeletons: !0,
			requiresOtherClause: !0
		...
		return t != null && t.captureLocation || Ph(n.val), n.val;
	}(e, i);
	return o(a), a;
	function o(e) {
		e.map(s);
...
var Kh = "_gt_", qh = RegExp(`^${Kh}\\d+$`), Jh = RegExp(`^${Kh}$`);
function Yh(e) {
	return e.type === zh.TYPE.select && qh.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === zh.TYPE.literal);
}
function Xh(e) {
	return e.type === zh.TYPE.select && Jh.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === zh.TYPE.literal);
}
function Zh(e) {
	if (!e.includes("_gt_")) return e;
	let t = [];
...
function $h(e) {
	return e.includes("_gt_") ? Hh.printAST(Gh({
		icuString: e,
		shouldVisit: Yh,
		visitor: function(e) {
			e.type = zh.TYPE.argument, delete e.options;
		},
		options: { recurseIntoVisited: !1 }
	})) : e;
}
...
var Z = "@generaltranslation/react-core", tg = `${Z} Error: Production environments cannot include an api key.`, ng = `${Z} Error: Fetching batched translations failed`, rg = (e, t) => e ? `${Z} Error: Translation failed for id: ${e}, hash: ${t} ` : `${Z} Error: Translation failed for hash: ${t}`, ig = (e, t) => `${Z} Error: error rendering string ${t ? `for id: "${t}"` : ""} original message: "${e}"`, ag = (e, t, n = "tx") => `${Z} Error: string translation error. ${n}("${e}")${t ? ` with id "${t}"` : ""} could not locate translation.`, og = (e) => `${Z} Error: Dictionary subtree not found for id: "${e}"`, sg = (e) => `${Z} Error: Invalid ICU string dictionary entry found for id: "${e}"`, cg = `${Z} Warning: Translation cloud services require a project ID! Find yours at generaltranslation.com/dashboard.`, lg = (e) => `${Z} Warning: No valid dictionary entry found for id: "${e}"`, ug = `${Z} Warning: A development API key is required for runtime translation!  Find your development API key: generaltranslation.com/dashboard.  (Or, disable this warning message by setting runtimeUrl to an empty string which disables runtime translation.)`, dg = `${Z} Warning: Runtime translation timed out.`, fg = `${Z} Warning: No dictionary was found. Ensure you are either passing your dictionary to the <GTProvider>.`;
function pg(e) {
...
var hg = {
	...
	let { props: t } = e, n = { t: gg(e) };
	if (t["data-_gt"]) {
		let e = t["data-_gt"], r = e.transformation;
		if (r === "variable") {
			let n = e.variableType || "variable", r = Lp(t, n), i = Wh(n);
			return {
				i: e.id,
				k: r,
				v: i
		...
		n.i = e.id, n.d = ((e, t, n) => {
			let r = Object.entries(hg).reduce((e, [n, r]) => (t[r] && (e[n] = t[r]), e), {});
			if (e === "plural" && n) {
				let e = {};
		...
		let i = Object.entries(hg).reduce((e, [n, r]) => (t[r] && (e[n] = t[r]), e), {});
	...
	return t.children && (n.c = yg(t.children)), n;
}, vg = (e) => {
	return n = e, t.isValidElement(n) ? _g(e) : typeof e == "number" ? e.toString() : e;
	var n;
};
function yg(e) {
	return Array.isArray(e) ? e.map(vg) : vg(e);
}
function bg(e) {
...
var Tg = (e) => typeof e == "string" || Array.isArray(e), Eg = (e) => typeof e == "object" && !!e && !Array.isArray(e);
function Dg(e, t) {
	if (Array.isArray(e)) return e.map((e, n) => wg(e) ? t[n] : Dg(e, t[n]));
	let n = {
		...Object.fromEntries(Object.entries(e).filter(([, e]) => Tg(e))),
		...Object.fromEntries(Object.entries(t).filter(([, e]) => Tg(e)))
	}, r = Object.entries(e).filter(([, e]) => Eg(e)).map(([e]) => e), i = Object.entries(t).filter(([, e]) => Eg(e)).map(([e]) => e), a = /* @__PURE__ */ new Set([...r, ...i]);
	for (let r of a) n[r] = Dg(X(e, r) || {}, X(t, r) || {});
	return n;
}
function Og({ dictionary: e, id: t }) {
	if (t === "") return e;
	let n = e, r = t.split(".");
...
function Ag(e, t, n, r) {
	...
	for (let e of i.slice(0, -1)) X(t, e) ?? eg(t, e, Array.isArray(X(r, e)) ? [] : {}), t = X(t, e), r = X(r, e);
	eg(t, i[i.length - 1], e);
}
function jg(e) {
	let t = {};
...
function Ng({ source: e, context: t, id: n, maxChars: r, dataFormat: i }, a = Mg) {
	let o;
	return o = i === "JSX" ? Fg(e) : e, a(Gp({
		source: o,
		...n && { id: n },
		...t && { context: t },
		...r != null && { maxChars: Math.abs(r) },
...
var Pg = (e) => {
	if (e && typeof e == "object") {
		let t = {};
		if ("c" in e && e.c && (t.c = Fg(e.c)), "d" in e) {
			let n = e?.d;
			n?.b && (t.b = Object.fromEntries(Object.entries(n.b).map(([e, t]) => [e, Fg(t)]))), n?.t && (t.t = n.t);
		}
		return Kp(e) ? {
			k: e.k,
			...e.v && { v: e.v }
...
function Fg(e) {
	return Array.isArray(e) ? e.map(Pg) : Pg(e);
}
function Ig(e, t = "") {
	let n = !1;
	return Object.entries(e).forEach(([r, i]) => {
		let a = t ? `${t}.${r}` : r;
		if (wg(i)) {
			let { entry: t, metadata: o } = Sg(i);
			o?.$_hash || (o ||= {}, o.$_hash = Ng({
				source: Zh(t),
...
function Lg(e, t, n) {
	...
	if (!r) throw Error(og(n));
	if (wg(r)) throw Error(`${Z} Error: Cannot inject and merge a dictionary entry`);
...
function Rg(e, t, n = "") {
	...
	return Object.entries(e).forEach(([e, i]) => {
		...
		} else r.push(...Rg(i, X(t, e) || (Array.isArray(i) ? [] : {}), a));
	}), r;
}
function zg(e) {
...
function Hg({ gt: e, locale: t, versionId: n, defaultLocale: r, runtimeUrl: i, renderSettings: a, setTranslations: o, environment: s, ...c }) {
	...
	let S = m(0), C = m(/* @__PURE__ */ new Map()), w = m(/* @__PURE__ */ new Map()), ee = l(async (e) => {
		if (e.size === 0) return {};
		S.current += 1;
		...
		try {
			...
			e?.name === "AbortError" ? console.warn(dg) : console.warn(ng, e), a.forEach((e) => {
		...
		return o;
	}, []), T = m(null), E = m(async () => {}), te = l((e) => {
		x(e), C.current.size > 0 && (T.current = setTimeout(() => {
			T.current = null, E.current();
		}, 50));
	}, [x]), ne = l(() => {
		E.current = async () => {
			if (S.current >= 100) return void (T.current = setTimeout(() => {
				T.current = null, E.current();
			}, 50));
			let e = C.current;
			if (e.size === 0) return;
		...
		if (ne(), e) return T.current &&= (clearTimeout(T.current), null), void E.current();
		T.current ||= setTimeout(() => {
			T.current = null, E.current();
		}, 50);
	}, [ne]), ie = l((e) => (t) => {
		let n = `${t.metadata.hash}:${t.targetLocale}`, r = w.current.get(n);
		if (r) return r;
		let i = new Promise((r) => {
			let i = e === "JSX" ? {
				dataFormat: "JSX",
		...
		return w.current.set(n, i), i;
	}, [re]), ae = p(() => ie("ICU"), [ie]), oe = p(() => ie("JSX"), [ie]);
	return d(() => () => {
		T.current && clearTimeout(T.current);
	}, []), {
		developmentApiEnabled: u,
		registerIcuForTranslation: ae,
		registerJsxForTranslation: oe
	};
}
function Ug({ gt: e, translations: t, locale: n, defaultLocale: r, translationRequired: i, developmentApiEnabled: a, registerIcuForTranslation: o, environment: s }) {
	function c({ message: t, variables: n, locales: r, fallback: i, id: a, maxChars: o, format: l }) {
		try {
			let a = Qh(i || ""), s = e.formatMessage(Object.keys(a).length ? $h(t) : t, {
				locales: r,
				variables: {
					...n,
					...a,
			...
			if (s === "production") console.warn(((e, t) => `${Z} Warning: failed to render string ${t ? `for id: "${t}"` : ""} original message: "${e}"`)(t, a), "Error: ", l);
				...
				if (!i) throw Error(`${ig(t, a)} Error: ${l}`);
				console.error(ig(t, a), "Error: ", l);
			}
			return i ? c({
				message: i,
				locales: r,
	...
	let d = (e, t = {}, s) => {
		...
		}), g(e, [r])) : (console.warn(ag(e, d, "gt")), g(e, [r])) : s?.[v] ? g(s?.[v], [n, r], e) : g(e, [r]);
	};
	return {
		_gtFunction: d,
		_mFunction: (e, s = {}, l) => {
			...
			}), b(p, [r])) : l?.[f] ? b(l?.[f], [n, r], p) : b(p, [r]) : (console.warn(ag(p, Bg(e), "m")), b(p, [r]));
		},
...
function Wg(e, t, n, r, i, a, o, s, c, u, d) {
	return l((s, l = {}) => {
		if (!t) return "";
		let f = xg(t, s);
		if (!f) return console.warn(lg(s)), "";
		if (!bg(f)) return console.warn(((e) => `${Z} Warning: Invalid dictionary entry found for id: "${e}"`)(s)), "";
		let { entry: p, metadata: m } = Sg(f);
		if (!p || typeof p != "string") return "";
		let { $format: h, ...g } = l, _ = (t, n, r) => {
			try {
				let i = Qh(r || ""), a = e.formatMessage(Object.keys(i).length ? $h(t) : t, {
					locales: n,
					variables: {
						...g,
						...i,
				...
				if (d === "production") console.warn(((e) => `${Z} Warning: Invalid ICU string dictionary entry found for id: "${e}"`)(s), "Error: ", i);
					...
					if (!r) throw Error(`${sg(s)} Error: ${i}`);
					console.error(sg(s), "Error: ", i);
				}
...
function Gg({ _locale: e, defaultLocale: t, locales: n, ssr: r, localeCookieName: i, customMapping: a, useDetermineLocale: o, enableI18n: s, reloadOnLocaleUpdate: c }) {
...
function Kg({ devApiKey: e, projectId: t, runtimeUrl: n, loadTranslationsType: r, cacheUrl: i, locales: a, environment: o }) {
	d(() => {
		if (o === "production" && e) throw Error(tg);
		if (r === "custom" || !i && !n || t || o !== "development" || console.warn(cg), t && n && r !== "custom" && !e && o === "development" && console.warn(ug), n === Up || i === Hp && r === "default") {
			let e = a.filter((e) => !Fp(e));
...
async function qg(e, t) {
	let n = Array.from(/* @__PURE__ */ new Set([e, Qu(e).languageCode]));
	for (let e of n) try {
		let n = await t(e);
		if (n) return n;
	} catch {}
...
function Jg({ _translations: e, translationRequired: t, loadTranslationsType: n, loadTranslations: r, locale: i, cacheUrl: a, projectId: o, _versionId: s, gt: c }) {
...
function Yg(e, t, n, r, i, a, o, s, c, u, d, f) {
	return l((o, c, l = {}) => {
		...
		if (!p) return console.warn(lg(c)), {};
		if (wg(p)) return f(o, l);
		if (!s) return jg(p);
		let m = function({ dictionary: e, id: t, sourceDictionary: n }) {
			if (t === "") return e;
			let r = e, i = n, a = t.split(".");
			for (let e of a) X(r, e) === void 0 && (Array.isArray(X(i, e)) ? eg(r, e, []) : eg(r, e, {})), r = X(r, e);
			return r;
		}({
			dictionary: t,
			id: c,
			sourceDictionary: t
		}), { dictionary: h, updateDictionary: g } = Ig(structuredClone(p), c), _ = Rg(h, m, c), { dictionary: v, updateDictionary: y } = function(e, t, n, r, i = "") {
			let a = !1, o = i ? i.split(".") : [];
			return r.forEach(({ metadata: r }) => {
				let { $_hash: i, $id: s } = r, c = o.length > 0 ? s.split(".").slice(o.length).join(".") : s, l = xg(t, c), u;
				wg(l) && (u = Sg(l).entry);
				let d = n[i] || u;
				d && (Ag(d, t, c, e), a = !0);
			}), {
			...
			return n.forEach(({ source: n, metadata: r }) => {
				let { $id: a } = r, o = i.length > 0 ? a.split(".").slice(i.length).join(".") : a, s = xg(t, o), c;
				wg(s) && (c = Sg(s).entry), Ag(c || n, t, o, e);
			}), t;
...
function Xg({ enableI18n: e }) {
	let [t] = h(e);
	return { enableI18n: t };
}
function Zg() {
	throw pg("isSSREnabled");
}
function Qg({}) {
	throw pg("useDetermineLocale");
}
function $g({}) {
	throw pg("useRegionState");
}
function e_({ children: e, config: t, environment: n = "production", projectId: r = t?.projectId || "", devApiKey: a = t?.devApiKey || "", _versionId: o = t?._versionId, dictionary: s = t?.dictionary || {}, locales: c = t?.locales || [], defaultLocale: l = t?.defaultLocale || Rp, cacheUrl: u = t?.cacheUrl || Hp, runtimeUrl: f = t?.runtimeUrl || Up, renderSettings: m = t?.renderSettings || Cg(n), ssr: g = t?.ssr || Zg(), localeCookieName: v = t?.localeCookieName || "generaltranslation.locale", locale: y = "", region: b, loadDictionary: x, loadTranslations: S, fallback: C, translations: w = null, customMapping: ee = t?.customMapping, enableI18n: T = t?.enableI18n === void 0 || t.enableI18n, enableI18nLoaded: E, reloadOnLocaleUpdate: te, useEnableI18n: ne = Xg, readAuthFromEnv: re = mg, useDetermineLocale: ie = Qg, useRegionState: ae = $g, ...oe }) {
	y &&= td(y, ee);
	let { projectId: se, devApiKey: ce } = re({
		projectId: r,
		devApiKey: a
	}), { enableI18n: le } = ne({
		enableI18n: T,
		...
		ssr: g
	}), { locale: ue, setLocale: D, locales: de, translationRequired: fe, dialectTranslationRequired: pe } = Gg({
		_locale: y,
		defaultLocale: l,
		locales: c,
		ssr: g,
		localeCookieName: v,
		customMapping: ee,
		useDetermineLocale: ie,
		enableI18n: le,
		reloadOnLocaleUpdate: te
	}), { region: me, setRegion: he } = ae({
		_region: b,
		ssr: g,
		...
		f,
		ee
	]), _e = p(() => (S ? "custom" : u && se && "default") || "disabled", [
		S,
		u,
		se
		...
		return d(() => {
			...
			let e = !0;
			return (async () => {
				let t = await qg(i, n) || {}, a = await qg(r, n) || {};
				e && o(t || {}), e && c(a || {});
			})(), () => {
				e = !1;
			};
	...
	let { translations: Se, setTranslations: Ce } = Jg({
		_translations: w,
		...
		_versionId: o,
		gt: ge
	}), { registerIcuForTranslation: we, registerJsxForTranslation: Te, developmentApiEnabled: Ee } = Hg({
		gt: ge,
		locale: ue,
		versionId: o,
		defaultLocale: l,
		...
		environment: n,
		...oe
	}), { _gtFunction: De, _mFunction: Oe, _filterMessagesForPreload: ke, _preloadMessages: Ae } = Ug({
		gt: ge,
		translations: Se,
		locale: ue,
		defaultLocale: l,
		...
		environment: n
	}), je = Wg(ge, ve, be, Se, ue, l, fe, pe, Ee, we, n), Me = Yg(ve || {}, be || {}, ye, xe, Se, ue, l, fe, pe, Ee, we, je), Ne = !(fe && !Se || !ue);
	return _(Vg.Provider, {
		value: {
			gt: ge,
			registerIcuForTranslation: we,
...
function t_({ projectId: e, devApiKey: t }) {
	try {
		return {
			projectId: e || "",
			devApiKey: t || void 0
...
function n_({ _region: e, regionCookieName: t }) {
...
function r_({ _region: e, ssr: t, regionCookieName: n }) {
	let [r, i] = h(t ? void 0 : n_({
		_region: e,
		regionCookieName: n
	}));
	return d(() => {
...
function i_({ enableI18n: e, enableI18nCookieName: t, enableI18nLoaded: n, ssr: r }) {
...
var o_ = function(e, t) {
	return o_ = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, o_(e, t);
...
function s_(e, t) {
	...
	o_(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var c_ = function() {
...
var y_ = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function b_(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || y_(t, e, n);
}
function x_(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function C_() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(S_(arguments[t]));
	return e;
}
function w_() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function E_(e) {
	return this instanceof E_ ? (this.v = e, this) : new E_(e);
}
function D_(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var r, i = n.apply(e, t || []), a = [];
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof E_ ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function k_(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = x_(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var j_ = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return M_ = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, M_(e);
...
function N_(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = M_(e), r = 0; r < n.length; r++) n[r] !== "default" && y_(t, e, n[r]);
	return j_(t, e), t;
}
function P_(e) {
	return e && e.__esModule ? e : { default: e };
...
var z_ = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function B_(e) {
	function t(t) {
		e.error = e.hasError ? new z_(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var H_, U_, W_, G_, K_ = Object.freeze({
	__proto__: null,
	__addDisposableResource: R_,
	get __assign() {
		return c_;
	},
	__asyncDelegator: O_,
	...
	__classPrivateFieldIn: L_,
	__classPrivateFieldSet: I_,
	__createBinding: y_,
	__decorate: u_,
	__disposeResources: B_,
	__esDecorate: f_,
	__exportStar: b_,
	__extends: s_,
	__generator: v_,
	...
	__read: S_,
	__rest: l_,
	__rewriteRelativeImportExtension: V_,
	__runInitializers: p_,
	__setFunctionName: h_,
	__spread: C_,
	__spreadArray: T_,
	__spreadArrays: w_,
	__values: x_,
...
try {
	(G_ = (/* @__PURE__ */ RegExp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu")).exec("a")) == null || G_[0];
} catch {}
function q_(e) {
	if (Object.prototype.hasOwnProperty.call(e, "__esModule")) return e;
	var t = e.default;
...
function Y_() {
	if (J_) return Q;
	var e, t;
	return J_ = 1, Object.defineProperty(Q, "__esModule", { value: !0 }), Q.SKELETON_TYPE = Q.TYPE = void 0, Q.isLiteralElement = function(t) {
		return t.type === e.literal;
...
(function() {
	if (X_) return Z_;
	X_ = 1, Object.defineProperty(Z_, "__esModule", { value: !0 }), Z_.printAST = n, Z_.doPrintAST = r, Z_.printDateTimeSkeleton = o;
	var e = Q_, t = Y_();
	function n(e) {
		return r(e, !1);
	}
...
var ov = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = nv(this.buffer);
	}
	update(e) {
		ev(this), $_(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		ev(this), function(e, t) {
			$_(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, tv(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = nv(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), lv = /* @__PURE__ */ new Uint32Array(64), uv = class extends ov {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) lv[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = lv[e - 15], n = lv[e - 2], r = rv(t, 7) ^ rv(t, 18) ^ t >>> 3, i = rv(n, 17) ^ rv(n, 19) ^ n >>> 10;
			lv[e] = i + lv[e - 7] + r + lv[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (rv(o, 6) ^ rv(o, 11) ^ rv(o, 25)) + iv(o, s, c) + cv[e] + lv[e] | 0, u = (rv(n, 2) ^ rv(n, 13) ^ rv(n, 22)) + av(n, r, i) | 0;
			l = c, c = s, s = o, o = a + t | 0, a = i, i = r, r = n, n = t + u | 0;
		}
		n = n + this.A | 0, r = r + this.B | 0, i = i + this.C | 0, a = a + this.D | 0, o = o + this.E | 0, s = s + this.F | 0, c = c + this.G | 0, l = l + this.H | 0, this.set(n, r, i, a, o, s, c, l);
	}
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), tv(this.buffer);
	}
}, dv = class extends uv {
	A = 0 | sv[0];
	B = 0 | sv[1];
...
})(() => new dv(), (fv = 1, { oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
var pv = function(e, t) {
	return pv = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, pv(e, t);
...
function mv(e, t) {
	...
	pv(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var hv = function() {
...
var Ev = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function Dv(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || Ev(t, e, n);
}
function Ov(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function Av() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(kv(arguments[t]));
	return e;
}
function jv() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function Nv(e) {
	return this instanceof Nv ? (this.v = e, this) : new Nv(e);
}
function Pv(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var r, i = n.apply(e, t || []), a = [];
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof Nv ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function Iv(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = Ov(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var Rv = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return zv = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, zv(e);
...
function Bv(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = zv(e), r = 0; r < n.length; r++) n[r] !== "default" && Ev(t, e, n[r]);
	return Rv(t, e), t;
}
function Vv(e) {
	return e && e.__esModule ? e : { default: e };
...
var Kv = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function qv(e) {
	function t(t) {
		e.error = e.hasError ? new Kv(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var Yv, Xv, Zv, Qv, $v = Object.freeze({
	__proto__: null,
	...
	__read: kv,
	__rest: gv,
	__rewriteRelativeImportExtension: Jv,
	__runInitializers: bv,
...
try {
	(Qv = function(e, t) {
		return new RegExp(e, t);
	}("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")) == null || Qv[0];
} catch {}
var ey, ty, $ = {};
function ny() {
	return ey || (ey = 1, Object.defineProperty($, "__esModule", { value: !0 }), $.SKELETON_TYPE = $.TYPE = void 0, $.isLiteralElement = function(t) {
		return t.type === e.literal;
...
(function() {
	if (ty) return ry;
	ty = 1, Object.defineProperty(ry, "__esModule", { value: !0 }), ry.printAST = n, ry.doPrintAST = r, ry.printDateTimeSkeleton = o;
	var e = iy, t = ny();
	function n(e) {
		return r(e, !1);
	}
...
var ay = "gt-react";
function oy({ locale: e = "", defaultLocale: t = "en", locales: n = [], localeCookieName: r = "generaltranslation.locale", ssr: i = !0, customMapping: a, enableI18n: o, reloadOnLocaleUpdate: s = !1 }) {
	let c = p(() => td(e, a), [e, a]), l = p(() => n.map((e) => td(e, a)), [n, a]), [u, f] = h(() => o ? td(i ? c && ed(c, l, a) || "" : sy({
		_locale: c,
		locale: c,
		locales: l,
		defaultLocale: t,
		...
		let c = (r) => {
			if (!o) return n;
			if (r === e) return e;
			let s = td(ed(r, t, a) || e || n, a);
			return s !== r && console.warn(((e, t, n = "@generaltranslation/react-core") => `${n} Warning: "${t}" is not a supported locale. Update supported locales in your dashboard or gt.config.json. Falling back to "${e}".`)(s, r, ay)), i(s), s;
		};
		return [(t) => {
			if (!o) return;
			t = td(t);
...
function sy({ _locale: e, locale: t, locales: n, defaultLocale: r, localeCookieName: i, customMapping: a, enableI18n: o }) {
	if (!o) return r;
	if (e && e === t && ed(e, n, a) === t) return td(e, a);
	...
	return l &&= td(l, a), s && s !== l && typeof document < "u" && (document.cookie = `${i}=${l};path=/`), l;
}
function cy(e) {
	return _(e_, Object.assign({
		ssr: !(typeof process > "u" || !process.env.NEXT_RUNTIME) || (globalThis == null ? void 0 : globalThis.__NEXT_DATA__) !== void 0,
		environment: "development"
	}, e, {
		readAuthFromEnv: t_,
		useDetermineLocale: oy,
		useRegionState: r_,
		useEnableI18n: i_
	}));
}
var ly = b().server(function({ defaultLocale: e, locales: t, customMapping: n }) {
	let r = [], i = x(Np);
	if (i && r.push(i), process.env._GENERALTRANSLATION_IGNORE_BROWSER_LOCALES === "false") {
		let e = S("accept-language")?.split(",").map((e) => e.split(";")?.[0].trim()) || [];
		e && r.push(...e);
	}
	return r.length === 0 && process.env._GENERALTRANSLATION_IGNORE_BROWSER_LOCALES === "false" && console.warn("gt-tanstack-start(server): no locales could be determined for this request"), ed(r, t, n) || e;
	...
	return a && r.push(a), r.length === 0 && (console.warn("gt-tanstack-start(client): no locales could be determined for this request"), r.push(e)), ed(r, t, n) || e;
}), uy = class extends dd {
...
function fy(e) {
	Bd(new dy(Object.assign(Object.assign({}, e), { storeAdapter: new uy() })));
}
var py = { exports: {} }, my, hy, gy = {};
function _y() {
	return my || (my = 1, function() {
		function e(t) {
		...
		function o() {
			var t = e(this.type);
			return re[t] || (re[t] = !0, console.error("Accessing element.ref was removed in React 19. ref is now a regular prop. It will be removed from the JSX Element type in a future release.")), (t = this.props.ref) === void 0 ? null : t;
		}
		function s(t, n, i, a, s, l) {
			...
			if (E.call(n, "key")) {
				...
				a = 0 < m.length ? "{key: someKey, " + m.join(": ..., ") + ": ...}" : "{key: someKey}", oe[p + a] || (m = 0 < m.length ? "{" + m.join(": ..., ") + ": ...}" : "{}", console.error("A props object containing a \"key\" prop is being spread into JSX:\n  let props = %s;\n  <%s {...props} />\nReact keys must be passed directly to JSX without using spread:\n  let props = %s;\n  <%s key={someKey} {...props} />", a, p, m, p), oe[p + a] = !0);
			}
			...
			}(t, p, i, (d = T.A) === null ? null : d.getOwner(), s, l);
		}
		function c(e) {
		...
		var u, d = t, f = Symbol.for("react.transitional.element"), p = Symbol.for("react.portal"), m = Symbol.for("react.fragment"), h = Symbol.for("react.strict_mode"), g = Symbol.for("react.profiler"), _ = Symbol.for("react.consumer"), v = Symbol.for("react.context"), y = Symbol.for("react.forward_ref"), b = Symbol.for("react.suspense"), x = Symbol.for("react.suspense_list"), S = Symbol.for("react.memo"), C = Symbol.for("react.lazy"), w = Symbol.for("react.activity"), ee = Symbol.for("react.client.reference"), T = d.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, E = Object.prototype.hasOwnProperty, te = Array.isArray, ne = console.createTask ? console.createTask : function() {
			return null;
		}, re = {}, ie = (d = { react_stack_bottom_frame: function(e) {
			return e();
		} }).react_stack_bottom_frame.bind(d, a)(), ae = ne(i(a)), oe = {};
		gy.Fragment = m, gy.jsx = function(e, t, n) {
			var r = 1e4 > T.recentlyCreatedOwnerStacks++;
			return s(e, t, n, !1, r ? Error("react-stack-top-frame") : ie, r ? ne(i(e)) : ae);
		}, gy.jsxs = function(e, t, n) {
			var r = 1e4 > T.recentlyCreatedOwnerStacks++;
			return s(e, t, n, !0, r ? Error("react-stack-top-frame") : ie, r ? ne(i(e)) : ae);
		};
	}()), gy;
}
var vy = (hy || (hy = 1, py.exports = _y()), py.exports);
function yy() {
...
function xy(e) {
	return e.locale ? e.locale : yy() ? by() : void 0;
}
function Sy() {
	let e = zd();
	if (!function(e) {
...
function Cy(e) {
	let t = Sy().getProviderConfig();
	return vy.jsx(cy, Object.assign({ ssr: yy() }, t, e, {
...
async function Ty(e, t = ["shared"]) {
	let n = {};
	return await Promise.all(t.map(async (t) => {
		let r = wy[`./src/_gt/${e}/${t}.json`];
		if (!r) {
...
var Ey = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/scripts/Wrapper.tsx";
fy({
	...C,
	loadTranslations: Ty
});
...
var Oy = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/pages/about/AboutHeader.wrapper.tsx";
function ky() {
	return y(Dy, { children: y(bo, {}, void 0, !1, {
		fileName: Oy,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
