...
var Js = () => p("div", {
	...
	children: p(ys, { children: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." })
});
function Ys() {
	return m(f, { children: [
		p(Js, {}),
		p("h1", {
			...
			children: p(ys, { children: "Blog" })
		}),
		p("p", {
			className: "mb-10 text-muted-foreground",
			children: p(ys, { children: "Insights, tutorials, and analysis from the i18n community." })
		})
	] });
}
function Xs(e) {
...
var uc = h().server(() => $().getLocale()).client(() => J().getLocale());
...
async function hc(e, t = ["shared"]) {
	let n = {};
	return await Promise.all(t.map(async (t) => {
		let r = mc[`./src/_gt/${e}/${t}.json`];
		if (!r) {
