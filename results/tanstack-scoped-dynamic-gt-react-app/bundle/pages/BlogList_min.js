...
function Pn(e, t, n, r) {
	if (n && !n.allValid || !k(e, r) || !k(t, r) || Nn(e, t)) return !1;
	if (!n) return !0;
	let i = Tn(t);
...
function Bn(e, t) {
	...
	try {
		...
		if (s) return s;
		let c = i.maximize();
		return Wn[c.language] || Jn(c.region || "");
	} catch {
		return Un;
	}
}
var Vn = "🌍", Hn = "🌏", Un = Vn, Wn = {
	...
	EU: "🇪🇺",
	419: "🌎"
}, Kn = /* @__PURE__ */ new Set(/* @__PURE__ */ "AF.AX.AL.DZ.AS.AD.AO.AI.AQ.AG.AR.AM.AW.AU.AT.AZ.BS.BH.BD.BB.BY.BE.BZ.BJ.BM.BT.BO.BQ.BA.BW.BV.BR.IO.BN.BG.BF.BI.CV.KH.CM.CA.KY.CF.TD.CL.CN.CX.CC.CO.KM.CD.CG.CK.CR.CI.HR.CU.CW.CY.CZ.DK.DJ.DM.DO.EC.EG.SV.GQ.ER.EE.SZ.ET.FK.FO.FJ.FI.FR.GF.PF.TF.GA.GM.GE.DE.GH.GI.GR.GL.GD.GP.GU.GT.GG.GN.GW.GY.HT.HM.VA.HN.HK.HU.IS.IN.ID.IR.IQ.IE.IM.IL.IT.JM.JP.JE.JO.KZ.KE.KI.KP.KR.KW.KG.LA.LV.LB.LS.LR.LY.LI.LT.LU.MO.MG.MW.MY.MV.ML.MT.MH.MQ.MR.MU.YT.MX.FM.MD.MC.MN.ME.MS.MA.MZ.MM.NA.NR.NP.NL.NC.NZ.NI.NE.NG.NU.NF.MK.MP.NO.OM.PK.PW.PS.PA.PG.PY.PE.PH.PN.PL.PT.PR.QA.RE.RO.RU.RW.BL.SH.KN.LC.MF.PM.VC.WS.SM.ST.SA.SN.RS.SC.SL.SG.SX.SK.SI.SB.SO.ZA.GS.SS.ES.LK.SD.SR.SJ.SE.CH.SY.TW.TJ.TZ.TH.TL.TG.TK.TO.TT.TN.TR.TM.TC.TV.UG.UA.AE.GB.US.UM.UY.UZ.VU.VE.VN.VG.VI.WF.EH.YE.ZM.ZW".split(".")), qn = 127397;
function Jn(e) {
	return Yn(e) || "🌍";
}
function Yn(e) {
	let t = e.toUpperCase(), n = Gn[t];
	if (n) return n;
	if (Kn.has(t)) return String.fromCodePoint(t.charCodeAt(0) + qn, t.charCodeAt(1) + qn);
}
function Xn(e, t) {
	if (!t) return;
	let n = {};
...
function Zn(e, t = "en", n) {
	...
	e = j(e, n), t ||= "en";
	try {
		let i = A(e), a = O.get("Locale", e), o = a.language, s = Xn([
			r,
			e,
			i,
			o
		...
		return {
			...
			emoji: s?.emoji || Bn(i, n)
		};
	} catch {
		let t = k(e) ? A(e) : e, r = t.split("-"), i = r[0] || t, a = r.length > 2 ? r[2] : r[1] || "", o = r[3] || "", s = Xn([t, i], n);
		t = s?.code || t;
...
function $n(e) {
	try {
		let t = nr(O.get("Locale", e));
		if (t) return t;
	} catch {}
	let { scriptCode: t, languageCode: n } = Zn(e);
	return t ? er.has(t.toLowerCase()) ? "rtl" : "ltr" : n && tr.has(n.toLowerCase()) ? "rtl" : "ltr";
}
...
function ir(e, t) {
	return t ? Object.keys(t).find((n) => kn(t, n) === e) ?? e : e;
}
var ar = class {
	getResolutionScope() {
	...
	isResolutionScopeCurrent(e) {
		...
		for (let t = 0; t < this.locales.length; t++) {
			...
			if (r.locale !== n || r.canonicalLocale !== this.resolveCanonicalLocale(n) || e.canonicalMappingCodes[t] !== kn(this.customMapping, r.canonicalLocale)) return !1;
		}
		return !0;
	}
	buildResolutionScope(e) {
		...
		return {
			...
			canonicalMappingCodes: t.map(({ canonicalLocale: e }) => kn(this.customMapping, e)),
	...
	getLocaleDirection(e) {
		return $n(this.resolveCanonicalLocale(e));
	}
	isValidLocale(e) {
	...
	resolveAliasLocale(e) {
		return ir(e, this.customMapping);
	}
	standardizeLocale(e) {
		return A(e);
	}
	...
	isSupersetLocale(e, t) {
		return rr(this.resolveCanonicalLocale(e), this.resolveCanonicalLocale(t));
	}
};
function or(e, t = "en", n) {
	...
	let r = e, i = Un;
	try {
		r = O.get("DisplayNames", [t, "en"], { type: "region" }).of(e) || e, i = Jn(e);
	} catch {}
	return {
		code: e,
		name: r,
...
function hr(e, t, n = "") {
	let r = mr(e), i = e?.length, a = t !== void 0;
	if (!r || a && i !== t) {
...
var br = typeof Uint8Array.from([]).toHex == "function" && typeof Uint8Array.fromHex == "function", xr = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function Sr(e) {
	if (hr(e), br) return e.toHex();
	let t = "";
...
var Or = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = yr(this.buffer);
	}
	update(e) {
		gr(this), hr(e);
	...
	digestInto(e) {
		gr(this), _r(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, vr(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(this.length * 8), i), this.process(n, 0);
		let o = yr(e), s = this.outputLen;
	...
	3204031479,
	3329325298
]), F = /* @__PURE__ */ new Uint32Array(64), Ar = class extends Or {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		...
		for (let e = 0; e < 64; e++) {
			let t = N(o, 6) ^ N(o, 11) ^ N(o, 25), u = l + t + Er(o, s, c) + kr[e] + F[e] | 0, d = (N(n, 2) ^ N(n, 13) ^ N(n, 22)) + Dr(n, r, i) | 0;
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), vr(this.buffer);
	}
}, jr = class extends Ar {
	A = P[0] | 0;
	B = P[1] | 0;
...
async function ni(e) {
	if (!e.ok) {
		...
		throw new y(Br(e.status, e.statusText, t), e.status, t);
	}
}
async function ri(e, t, n, r) {
	...
	if (l.data === void 0 && l.response && !ae(l)) throw await ni(l.response), l.error;
	let u = oe(l);
...
var ii = class {
	...
	setConfig({ apiKey: e, devApiKey: t, sourceLocale: n, targetLocale: r, locales: i, projectId: a, customMapping: o, baseUrl: s }) {
		if (e && (this.apiKey = e), t && (this.devApiKey = t), a && (this.projectId = a), n && (this.sourceLocale = ur(n), !M(this.sourceLocale, o))) throw Error(Wr(this.sourceLocale));
		if (r && (this.targetLocale = ur(r), !M(this.targetLocale, o))) throw Error(Wr(this.targetLocale));
		if (i) {
			let e = [], t = [];
			if (i.forEach((n) => {
				let r = ur(n);
		...
		s && (this.baseUrl = s), o && (this.customMapping = o, this.reverseCustomMapping = Object.fromEntries(Object.entries(o).filter(([, e]) => e && typeof e == "object" && "code" in e).map(([e, t]) => [t.code, e]))), this._localeConfig = new ar({
	...
	getRegionProperties(e = this.getLocaleProperties().regionCode, t) {
		...
		return or(e, this.targetLocale, t);
	}
	...
	determineLocale(e, t = this.locales || [], n = this.customMapping) {
		return n === this.customMapping ? this.localeConfig.determineLocale(e, t ?? []) : fr(e, t, n);
	}
	...
	resolveCanonicalLocale(e = this.targetLocale, t = this.customMapping) {
		...
		return t === this.customMapping ? this.localeConfig.resolveCanonicalLocale(e) : lr(e, t);
	}
	resolveAliasLocale(e, t = this.customMapping) {
		if (!e) throw Error(L("resolveAliasLocale"));
		return t === this.customMapping ? this.localeConfig.resolveAliasLocale(e) : pr(e, t);
	}
...
function fi() {
	...
	return pi(e) ? e.isDebugLoggingEnabled() : si(oi());
}
function pi(e) {
...
function yi() {
	let e = bi(() => "production");
	return e ? e === "development" ? "development" : "production" : bi(() => !1) === !0 ? "development" : "production";
}
function bi(e) {
	try {
		return e();
...
var Ti = class extends ar {
	...
	getLocaleConfig(e) {
		return !e || !Oi(e) ? this : new ar(Di(e));
	}
...
var Ni = (e) => `String interpolation failed for message: "${e}".`;
function Pi(e, t, n, r) {
	try {
		return cr(e, {
			variables: t,
		...
		return z.warn(Ni(e)), e;
	}
}
function Fi(e, t) {
	if (!e) return e;
	let n = t.$_fallback, r = Mi(t);
	try {
		let i = pn(n || "");
		return sr(Pi(Object.keys(i).length ? hn(e) : e, {
			...r,
			...i,
			[D]: "other"
		}, t.$locale, t.$format), { maxChars: t.$maxChars });
	} catch {
		return z.warn(Ni(e)), t.$_fallback == null ? sr(e, { maxChars: t.$maxChars }) : Fi(t.$_fallback, {
			...t,
			$_fallback: void 0
		});
	}
...
function Li({ source: e, target: t, options: n, sourceLocale: r }) {
	return t == null ? Ri(e, zi(n, r)) : Ri(t, {
		$_fallback: e,
		...n
	});
}
function Ri(e, t) {
	switch (t.$format ?? "STRING") {
		case "ICU": return Fi(e, t);
		case "I18NEXT":
		case "STRING": return Ii(e, t);
		default: return e;
	}
}
function zi(e, t) {
...
var { getConditionStore: Hi, setConditionStore: Ui } = Vi(S({
	source: "gt-i18n",
	severity: "Error",
...
async function Ji({ locale: e, enableI18n: t }, n) {
	let r = hi(), i = B().getDefaultLocale(), a = await r.getLookupTranslation(t ? e : i);
	return (n, r = {}) => {
		let o = Bi(t ? r.$locale ?? e : B().getDefaultLocale(), r, "ICU");
		return Li({
			source: n,
			target: a(n, o),
			options: o,
...
async function Yi({ locale: e, enableI18n: t }) {
	...
	return (e, t = {}) => {
		if (e == null) return e;
		let r = Gi(e) ?? {};
		return Ki(r) ? n(r.$_source, r) : n(e, t);
	};
}
...
async function ua({ locale: e, enableI18n: t, rootId: n }) {
	let r = hi(), i = B().getDefaultLocale(), a = t ? e : i, [o, s, c] = await Promise.all([
...
async function wa({ key: e, sourceValue: t, targetValue: n, translateEntry: r }) {
	...
	let a = H(n) ? n : {}, o = /* @__PURE__ */ new Set([...Object.keys(t), ...Object.keys(a)]), s = await Promise.all(Array.from(o).map(async (n) => {
		...
		Qi(n, i);
		let o = t[n];
		return o === void 0 ? [n, U(a[n])] : [n, await wa({
			key: i,
			sourceValue: o,
			targetValue: a[n],
			translateEntry: r
...
var Fa = "generaltranslation.locale-reset", Ia = "server-render", La = Symbol.for("generaltranslation.react-core.ReactI18nConfig"), Ra = class extends Ti {
	renderStrategy;
	localeCookieName;
	regionCookieName;
...
var { getConditionStore: J, setConditionStore: Ua, isConditionStoreInitialized: Wa } = Vi(S({
	source: "@generaltranslation/react-core",
	severity: "Error",
...
function vo(e, { locale: t, id: n }) {
	...
	for (let e of n.split(".")) {
		if (!yo(e) || !H(i) || !Object.prototype.hasOwnProperty.call(i, e)) return;
		i = i[e];
	}
	return i;
}
...
var xo = class {
	...
	getTranslateSnapshot = (e, t = {}) => ho(t, e) ?? K().lookupTranslation(e.locale, e.message, e.options);
	getDictionaryEntrySnapshot = (e, t = {}) => go(t, e) ?? K().lookupDictionary(e.locale, e.id);
	getDictionaryObjectSnapshot = (e, t = {}) => _o(t, e) ?? K().lookupDictionaryObj(e.locale, e.id);
	...
	let r = n, i = (e) => {
		...
		if (a) {
			...
			if ((e[1] === "automatic" || e[2] === "automatic") && (i.injectionType = "automatic"), e[0] === "translate" && (e[0] = "fragment"), e[0] === "variable" && (i.variableType = e?.[1] || "variable"), e[0] === "plural") {
				let e = Object.entries(n).reduce((e, [t, n]) => (cn(t) && (e[t] = $o(n, r)), e), {});
...
function ts(e, t) {
	...
	if (a) {
		...
		if (n === "plural") return r(e, { ...Object.entries(i).reduce((e, [n, r]) => (e[n] = cn(n) || n === "children" ? ns(r, t) : r, e), {}) });
...
var ss = (e) => {
	...
	if (t["data-_gt"]) {
		...
		if (r === "variable") {
			let n = e.variableType || "variable", r = qa(t, n), i = dn(n);
			return {
				i: e.id,
				k: r,
				v: i
...
var Cs = class {
	constructor(e) {
		...
		}, this.getRegion = () => xs({ cookieName: q().getRegionCookieName() }) || this.customGetRegion?.(), this.setRegion = (e) => {
			this.updateRegion(e), this.reload();
		}, this.getEnableI18n = () => {
			let e = xs({ cookieName: q().getEnableI18nCookieName() });
...
function ws(e) {
	let t = q(), n = Ss(t.getLocaleCookieName());
...
}), { setConditionStore: As, isConditionStoreInitialized: js } = Vi(ks), { getConditionStore: Ms, setConditionStore: Ns, isConditionStoreInitialized: Ps } = Vi(ks);
function Fs(e) {
...
function Ls({ _getRegion: e, region: t }) {
	return xs({ cookieName: q().getRegionCookieName() }) || e?.() || t;
}
function Rs({ enableI18n: e, _getEnableI18n: t }) {
	if (e !== void 0) return e;
	let n = xs({ cookieName: q().getEnableI18nCookieName() });
...
function Bs() {
	return {
		...
		devApiKey: yi() === "development" ? Vs(() => void 0) || Us() : void 0
	};
}
function Vs(e) {
	try {
...
function qs() {
	return f("div", {
		...
		children: [
			{
				title: f(Z, { children: "Comparing i18n Libraries in 2026: A Deep Dive" }),
				date: f(Z, { children: "March 15, 2026" }),
				excerpt: f(Z, { children: "We tested 12 different internationalization libraries across performance, bundle size, and DX. Here are the surprising results." }),
				category: f(Z, { children: "Benchmark" })
			},
			{
				title: f(Z, { children: "How to Reduce Your i18n Bundle by 60%" }),
				date: f(Z, { children: "March 8, 2026" }),
				excerpt: f(Z, { children: "Practical strategies for optimizing translation bundles including lazy loading, code splitting, and compile-time optimizations." }),
				category: f(Z, { children: "Tutorial" })
			},
			{
				title: f(Z, { children: "The State of Internationalization in React" }),
				date: f(Z, { children: "February 28, 2026" }),
				excerpt: f(Z, { children: "An overview of the current i18n ecosystem in React, covering trends, emerging patterns, and community preferences." }),
				category: f(Z, { children: "Analysis" })
			},
			{
				title: f(Z, { children: "Migrating from react-i18next to Lingui" }),
				date: f(Z, { children: "February 15, 2026" }),
				excerpt: f(Z, { children: "A step-by-step guide on migrating a production app with 50,000 translation keys from react-i18next to Lingui." }),
				category: f(Z, { children: "Tutorial" })
			},
			{
				title: f(Z, { children: "Server Components and i18n: What Changes?" }),
				date: f(Z, { children: "February 1, 2026" }),
				excerpt: f(Z, { children: "React Server Components introduce new patterns for internationalization. We explore the implications and best practices." }),
				category: f(Z, { children: "Analysis" })
			},
			{
				title: f(Z, { children: "Benchmark Methodology: How We Test" }),
				date: f(Z, { children: "January 20, 2026" }),
				excerpt: f(Z, { children: "A transparent look at our benchmarking methodology, including test environments, statistical methods, and reproducibility." }),
				category: f(Z, { children: "Meta" })
			}
		].map((e, t) => p("article", {
			...
			children: [
				...
				f("button", {
					...
					children: f(Z, { children: "Read More →" })
				})
			]
		}, t))
	});
...
function nc(e, t, n = rc()) {
	let r = q(), { basepath: i, pathname: a } = ic(e, n), o = tc(a, "/") ? a.replace(/^\/[^/]+/, "") || "/" : a, s = r.resolveSupportedLocale(t);
...
function sc(e, t, n = new URL(e.url).pathname) {
	...
	o && a.push(o), a.push(...qi(e.headers.get("accept-language"))), a.length === 0 && console.warn(oc);
...
var cc = m().server(() => $().getLocale()).client(() => J().getLocale());
m().server(() => $().getEnableI18n()).client(() => J().getEnableI18n()), m().server((e) => {
	let t = $();
	return Ji({
		locale: t.getLocale(),
