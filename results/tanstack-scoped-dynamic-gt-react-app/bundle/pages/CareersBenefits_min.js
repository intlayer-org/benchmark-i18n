...
function qs() {
	return f("div", {
		...
		children: [
			{
				label: f(Z, { children: "Remote-first" }),
				value: f(Z, { children: "Work from anywhere in the world" })
			},
			{
				label: f(Z, { children: "Competitive pay" }),
				value: f(Z, { children: "Top-of-market compensation" })
			},
			{
				label: f(Z, { children: "Open source time" }),
				value: f(Z, { children: "20% time for OSS contributions" })
			}
		].map((e) => p("div", {
