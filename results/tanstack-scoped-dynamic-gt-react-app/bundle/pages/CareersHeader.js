import a, { Children, Fragment, cloneElement, createContext, createElement, isValidElement, useContext, useEffect, useMemo, useRef, useSyncExternalStore } from "react";
...
var MockBanner = () => jsx("div", {
	...
	children: jsx(a$2, { children: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." })
});
function CareersHeader() {
	return jsxs(Fragment$1, { children: [
		...
		jsx("h1", {
			...
			children: jsx(a$2, { children: "Careers" })
		}),
		jsx("p", {
			className: "mb-4 text-muted-foreground",
			children: jsx(a$2, { children: "Join our mission to improve the internationalization ecosystem. We're a remote-first team that values impact, transparency, and continuous learning." })
		})
	] });
}
