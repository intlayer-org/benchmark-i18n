...
function qs() {
	return f("div", {
		...
		children: [
			{
				name: f(Z, { children: "Benchmark CLI" }),
				desc: f(Z, { children: "Run benchmarks locally from your terminal. Supports custom configurations and CI integration." }),
				price: f(Z, { children: "Free" })
			},
			{
				name: f(Z, { children: "Benchmark Cloud" }),
				desc: f(Z, { children: "Automated cloud-based benchmarking with historical tracking, alerts, and team dashboards." }),
				price: "$29/mo"
			},
			{
				name: f(Z, { children: "Benchmark Enterprise" }),
				desc: f(Z, { children: "On-premise deployment with SSO, audit logs, custom SLAs, and dedicated support." }),
				price: f(Z, { children: "Contact Us" })
			},
			{
				name: f(Z, { children: "Migration Assistant" }),
				desc: f(Z, { children: "AI-powered tool that helps migrate your codebase between i18n libraries with zero downtime." }),
				price: f(Z, { children: "$99 one-time" })
			},
			{
				name: f(Z, { children: "Translation QA" }),
				desc: f(Z, { children: "Automated quality checks for missing translations, pluralization issues, and context errors." }),
				price: "$19/mo"
			},
			{
				name: f(Z, { children: "Bundle Optimizer" }),
				desc: f(Z, { children: "Analyzes and optimizes your i18n bundle for production with tree-shaking and code splitting." }),
				price: "$49/mo"
			}
		].map((e) => p("div", {
			className: "flex flex-col justify-between rounded-lg border border-border bg-card p-6",
			children: [p("div", { children: [f("h3", {
				...
				children: [f("span", {
					...
					children: f(Z, { children: "Learn More" })
				})]
			})]
		}, e.name?.toString() || ""))
	});
