...
function Ys() {
	return m(f, { children: [
		...
		p("h1", {
			...
			children: p(ys, { children: "Our Team" })
		}),
		p("p", {
			className: "mb-10 text-muted-foreground",
			children: p(ys, { children: "Meet the people behind i18n Benchmark. A diverse team united by a shared passion for great developer tools." })
		})
	] });
}
function Xs(e) {
