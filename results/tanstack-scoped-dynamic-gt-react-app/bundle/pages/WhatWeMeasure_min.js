...
var j = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/pages/about/WhatWeMeasure.tsx";
function go() {
	let e = [
		{
			metric: _(mo, { children: "Bundle size impact" }, void 0, !1, {
				fileName: j,
				lineNumber: 6,
				columnNumber: 15
			}, this),
			desc: _(mo, { children: "The additional JavaScript bytes sent to users when the i18n library and its translation files are included. This directly affects download time on slow networks." }, void 0, !1, {
				fileName: j,
				lineNumber: 8,
				columnNumber: 9
			}, this)
		...
		{
			metric: _(mo, { children: "Rendering overhead" }, void 0, !1, {
				fileName: j,
				lineNumber: 16,
				columnNumber: 15
			}, this),
			desc: _(mo, { children: "How much extra time the library adds to React's render cycle. Libraries that inject translations via a single context provider can cause unnecessary re-renders across the component tree." }, void 0, !1, {
				fileName: j,
				lineNumber: 18,
				columnNumber: 9
			}, this)
		...
		{
			metric: _(mo, { children: "Hydration cost" }, void 0, !1, {
				fileName: j,
				lineNumber: 26,
				columnNumber: 15
			}, this),
			desc: _(mo, { children: "During SSR, translation data is serialized into HTML. Large dictionaries increase the HTML payload and slow down hydration — the moment the page becomes interactive." }, void 0, !1, {
				fileName: j,
				lineNumber: 28,
				columnNumber: 9
			}, this)
		...
		{
			metric: _(mo, { children: "Lazy loading effectiveness" }, void 0, !1, {
				fileName: j,
				lineNumber: 36,
				columnNumber: 15
			}, this),
			desc: _(mo, { children: "Whether splitting translations by route or namespace actually reduces the initial load, and what trade-offs it introduces (waterfall requests, FOUC, cache complexity)." }, void 0, !1, {
				fileName: j,
				lineNumber: 38,
				columnNumber: 9
			}, this)
		...
		{
			metric: _(mo, { children: "Locale switch speed" }, void 0, !1, {
				fileName: j,
				lineNumber: 46,
				columnNumber: 15
			}, this),
			desc: _(mo, { children: "How fast the app can switch from one language to another at runtime — including fetching new translations, re-rendering components, and updating the DOM." }, void 0, !1, {
				fileName: j,
				lineNumber: 48,
				columnNumber: 9
			}, this)
	...
	return _("section", {
		...
		children: [_("h2", {
			...
			children: _(mo, { children: "What We Measure" }, void 0, !1, {
				fileName: j,
				lineNumber: 60,
				columnNumber: 9
			}, this)
...
function yl(e, t = "en", n) {
	...
	try {
		let i = R(e), a = M.get("Locale", e), o = a.language, s = vl([
			...
			t,
			"en"
		], g = M.get("DisplayNames", m, { type: "language" }), _ = M.get("DisplayNames", h, { type: "language" }), v = s?.name, y = s?.nativeName || s?.name, b = v || g.of(e) || e, x = y || _.of(e) || e, S = s?.maximizedName || v || g.of(u) || e, C = s?.nativeMaximizedName || y || _.of(u) || e, ee = s?.minimizedName || v || g.of(p) || e, te = s?.nativeMinimizedName || y || _.of(p) || e, w = s?.languageName || v || g.of(o) || e, T = s?.nativeLanguageName || y || _.of(o) || e, ne = s?.nameWithRegionCode || c ? `${w} (${c})` : b, re = s?.nativeNameWithRegionCode || (c ? `${T} (${c})` : x) || ne, ie = M.get("DisplayNames", m, { type: "region" }), ae = M.get("DisplayNames", h, { type: "region" }), oe = s?.regionName || (d ? ie.of(d) : "") || "", se = s?.nativeRegionName || (d ? ae.of(d) : "") || "", E = M.get("DisplayNames", m, { type: "script" }), ce = M.get("DisplayNames", h, { type: "script" });
		return {
			code: i,
			name: b,
			nativeName: x,
...
var Ty = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/pages/about/WhatWeMeasure.wrapper.tsx";
function Ey() {
