...
function ApiAccessSection() {
	...
	return jsxs("section", {
		...
		children: [jsx("h2", {
			...
			children: jsx(a$2, { children: "API Access" })
		}), jsxs("div", { children: [
			jsx("label", {
				htmlFor: apiKeyId,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: jsx(a$2, { children: "API Key" })
			}),
			jsxs("div", {
				...
				children: [jsx("input", {
					...
					children: jsx(a$2, { children: "Copy" })
				})]
			}),
			jsx("p", {
				className: "mt-1 text-xs text-muted-foreground",
				children: jsx(a$2, { children: "Use this key to access the benchmarking API programmatically." })
			})
		] })]
	});
}
