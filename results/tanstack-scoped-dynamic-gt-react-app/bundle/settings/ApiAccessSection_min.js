...
import t, { Children as n, Fragment as r, Suspense as i, cloneElement as a, createContext as o, createElement as s, isValidElement as c, useCallback as l, useContext as u, useEffect as d, useId as f, useMemo as p, useRef as m, useState as h, useSyncExternalStore as g } from "react";
import { jsx as _ } from "react/jsx-runtime";
import { jsxDEV as v } from "react/jsx-dev-runtime";
...
var vo = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/pages/settings/ApiAccessSection.tsx";
function yo() {
	let e = f();
	return v("section", {
		...
		children: [v("h2", {
			...
			children: v(go, { children: "API Access" }, void 0, !1, {
				fileName: vo,
				lineNumber: 10,
				columnNumber: 9
			}, this)
			...
			v("label", {
				...
				children: v(go, { children: "API Key" }, void 0, !1, {
					fileName: vo,
					lineNumber: 17,
					columnNumber: 11
				}, this)
			...
			v("div", {
				...
				children: [v("input", {
					...
					children: v(go, { children: "Copy" }, void 0, !1, {
						fileName: vo,
						lineNumber: 30,
						columnNumber: 13
					}, this)
			...
			v("p", {
				...
				children: v(go, { children: "Use this key to access the benchmarking API programmatically." }, void 0, !1, {
					fileName: vo,
					lineNumber: 34,
					columnNumber: 11
				}, this)
...
var bo = 6e4, xo = (e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`, So = "DEFAULT_TERMINATOR_KEY", Co = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	constructor(e, t = {}) {
		...
		if (!Co[t.style ?? "ellipsis"]) throw Error(xo(t.style ?? "ellipsis"));
		let n, r;
		if (t.maxChars !== void 0) {
			n = t.style ?? "ellipsis";
			let e = new Intl.Locale(this.locale).language;
			r = Co[n][e] || Co[n].DEFAULT_TERMINATOR_KEY;
		}
	...
	get(e, ...t) {
		...
		return a === void 0 && (a = new To[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}(), Eo = "https://cdn.gtx.dev", Do = {
	GTJSON: ["GTJSON"],
	JSON: ["JSON"],
	PO: ["PO"],
	POT: ["POT", "PO"],
...
function ko(e) {
	...
	if (!Oo(e.fileFormat, e.transformFormat)) return `Unsupported file format transform: ${e.fileFormat} -> ${e.transformFormat}`;
}
function Ao(e) {
	for (let t of e) {
		let e = ko(t);
...
function No(e) {
	...
	if (Array.isArray(e)) {
		let t = "[";
		for (let n = 0; n < e.length; n++) n && (t += ","), t += No(e[n]) || "null";
		return t + "]";
	}
	let t = Object.keys(e).sort(), n = "";
	for (let r of t) {
...
var Io = re({
	...
	__classPrivateFieldIn: () => ls,
	__classPrivateFieldSet: () => cs,
	__createBinding: () => ms,
	__decorate: () => zo,
	__disposeResources: () => ds,
	__esDecorate: () => Vo,
	__exportStar: () => Jo,
	__extends: () => Lo,
	__generator: () => qo,
	...
	__read: () => Xo,
	__rest: () => Ro,
	__rewriteRelativeImportExtension: () => fs,
	__runInitializers: () => Ho,
	__setFunctionName: () => Wo,
	__spread: () => Zo,
	__spreadArray: () => $o,
	__spreadArrays: () => Qo,
	__values: () => Yo,
...
function Jo(e, t) {
	for (var n in e) n !== "default" && !Object.prototype.hasOwnProperty.call(t, n) && ms(t, e, n);
}
function Yo(e) {
...
function Zo() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(Xo(arguments[t]));
	return e;
}
function Qo() {
...
function es(e) {
	return this instanceof es ? (this.v = e, this) : new es(e);
}
function ts(e, t, n) {
	...
	function l(e) {
		e.value instanceof es ? Promise.resolve(e.value.v).then(u, d) : f(a[0][2], e);
	}
	function u(e) {
		c("next", e);
	}
...
function rs(e) {
	...
	return t ? t.call(e) : (e = typeof Yo == "function" ? Yo(e) : e[Symbol.iterator](), n = {}, r("next"), r("throw"), r("return"), n[Symbol.asyncIterator] = function() {
		return this;
	}, n);
	function r(t) {
		n[t] = e[t] && function(n) {
...
function as(e) {
	...
	var t = {};
	if (e != null) for (var n = gs(e), r = 0; r < n.length; r++) n[r] !== "default" && ms(t, e, n[r]);
	return hs(t, e), t;
}
function os(e) {
...
function ds(e) {
	function t(t) {
		e.error = e.hasError ? new _s(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	function i() {
...
var ps, j, ms, hs, gs, _s, vs, ys = T((() => {
	ps = function(e, t) {
		return ps = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
			e.__proto__ = t;
		} || function(e, t) {
	...
	}, ms = Object.create ? (function(e, t, n, r) {
		r === void 0 && (r = n);
	...
	}, _s = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
		var r = Error(n);
...
var Ms = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, Ns = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Ps(e) {
	var t = {};
...
function Is(e) {
	...
	for (var t = e.split(Fs).filter(function(e) {
		return e.length > 0;
...
var Rs = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, zs = /^(@+)?(\+|#+)?[rs]?$/g, Bs = /(\*)(0+)|(#+)(0+)|(0+)/g, Vs = /^(0+)$/;
function Hs(e) {
	var t = {};
...
function Ws(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !Vs.test(e)) throw Error("Malformed concise eng/scientific notation");
	...
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "integer-width":
				...
				i.options[0].replace(Bs, function(e, n, r, i, a, o) {
		...
		if (Rs.test(i.stem)) {
			...
			i.stem.replace(Rs, function(e, n, r, i, a, o) {
			...
			var a = i.options[0];
			a === "w" ? t = j(j({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = j(j({}, t), Hs(a)));
			continue;
		}
		if (zs.test(i.stem)) {
			t = j(j({}, t), Hs(i.stem));
...
function Js(e, t) {
	for (var n = "", r = 0; r < e.length; r++) {
		...
		if (i === "j") {
			...
			var o = 1 + (a & 1), s = a < 2 ? 1 : 3 + (a >> 1), c = "a", l = Ys(t);
...
function Ys(e) {
	...
	var n = e.language, r;
	return n !== "root" && (r = e.maximize().region), (qs[r || ""] || qs[n || ""] || qs[`${n}-001`] || qs["001"])[0];
}
ys();
var Xs = RegExp(`^${Ms.source}*`), Zs = RegExp(`${Ms.source}*\$`);
function P(e, t) {
	return {
		start: e,
		end: t
...
var Qs = !!String.prototype.startsWith && "_a".startsWith("a", 1), $s = !!String.fromCodePoint, ec = !!Object.fromEntries, tc = !!String.prototype.codePointAt, nc = !!String.prototype.trimStart, rc = !!String.prototype.trimEnd, ic = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, ac = !0;
try {
	ac = fc("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	ac = !1;
}
var oc = Qs ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, sc = $s ? String.fromCodePoint : function() {
	...
	return t;
}, cc = ec ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
var pc;
if (ac) {
	var mc = fc("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	pc = function(e, t) {
		return mc.lastIndex = t, mc.exec(e)[1] ?? "";
	};
} else pc = function(e, t) {
	for (var n = [];;) {
		var r = lc(e, t);
		if (r === void 0 || yc(r) || bc(r)) break;
...
var hc = function() {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			} else if (i === 60 && !this.ignoreTag && gc(this.peek() || 0)) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !gc(this.char())) return this.error(M.INVALID_TAG, P(o, this.clonePosition()));
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && vc(this.char());) this.bump();
		...
		return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !_c(this.peek() || 0)) ? (this.bump(), "<") : null;
		...
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), sc(n));
		...
		var e = this.clonePosition(), t = this.offset(), n = pc(this.message, t), r = t + n.length;
		...
		switch (a) {
			...
			case "time":
				...
				if (s && oc(s?.style, "::", 0)) {
					...
					var m = p;
					this.locale && (m = Js(p, this.locale));
					var u = {
						type: bs.dateTime,
						pattern: m,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? Ps(m) : {}
					};
					return {
						val: {
		...
		if (oc(this.message, e, this.offset())) {
		...
		for (; !this.isEOF() && yc(this.char());) this.bump();
...
function xc(e) {
	e.forEach(function(e) {
		if (delete e.location, Es(e) || Ds(e)) for (var t in e.options) delete e.options[t].location, xc(e.options[t].value);
		else Cs(e) && As(e.style) || (ws(e) || Ts(e)) && js(e.style) ? delete e.style.location : ks(e) && xc(e.children);
	});
}
function Sc(e, t) {
	t === void 0 && (t = {}), t = j({
	...
	var n = new hc(e, t).parse();
	if (n.err) {
		var r = SyntaxError(M[n.err.kind]);
		throw r.location = n.err.location, r.originalMessage = n.err.message, r;
	}
	return t?.captureLocation || xc(n.val), n.val;
}
var Cc = ne(((e) => {
	...
	Object.defineProperty(e, "__esModule", { value: !0 }), ys(), ae(Io), Cc();
})), Tc = Cc();
wc();
function Ec({ icuString: e, shouldVisit: t, visitor: n, options: { recurseIntoVisited: r = !0, ...i } }) {
	let a = Sc(e, i);
	return o(a), a;
	function o(e) {
		e.map(s);
...
var Oc = RegExp(`^${Dc}$`);
function kc(e) {
	return e.type === Tc.TYPE.select && Oc.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === Tc.TYPE.literal);
}
function Ac(e) {
	if (!e.includes("_gt_")) return e;
	let t = [];
...
function jc(e, t) {
	var n = t && t.cache ? t.cache : Vc, r = t && t.serializer ? t.serializer : zc;
	return (t && t.strategy ? t.strategy : Ic)(e, {
		cache: n,
		serializer: r
	});
}
...
function Ic(e, t) {
	var n = e.length === 1 ? Nc : Pc;
	return Fc(e, this, n, t.cache.create(), t.serializer);
}
function Lc(e, t) {
	return Fc(e, this, Pc, t.cache.create(), t.serializer);
}
function Rc(e, t) {
	return Fc(e, this, Nc, t.cache.create(), t.serializer);
}
var zc = function() {
...
var Wc = function(e) {
	...
	Lo(t, e);
	function t(t, n, r, i) {
		return e.call(this, `Invalid values for "${t}": "${n}". Options are "${Object.keys(r).join("\", \"")}"`, Uc.INVALID_VALUE, i) || this;
	}
	return t;
}(Wc), Kc = function(e) {
	Lo(t, e);
	function t(t, n, r) {
		return e.call(this, `Value for "${t}" must be of type ${n}`, Uc.INVALID_VALUE, r) || this;
	}
	return t;
}(Wc), qc = function(e) {
	Lo(t, e);
	function t(t, n) {
		return e.call(this, `The intl string context variable "${t}" was not provided to the string "${n}"`, Uc.MISSING_VALUE, n) || this;
	}
	return t;
}(Wc), F;
(function(e) {
...
function Xc(e, t, n, r, i, a, o) {
	...
	for (var s = [], c = 0, l = e; c < l.length; c++) {
		...
		if (ws(u)) {
			var p = typeof u.style == "string" ? r.date[u.style] : js(u.style) ? u.style.parsedOptions : void 0;
			s.push({
				type: F.literal,
		...
		if (Ts(u)) {
			var p = typeof u.style == "string" ? r.time[u.style] : js(u.style) ? u.style.parsedOptions : r.time.medium;
			s.push({
				type: F.literal,
				value: n.getDateTimeFormat(t, p).format(f)
			});
		...
		if (Cs(u)) {
			var p = typeof u.style == "string" ? r.number[u.style] : As(u.style) ? u.style.parsedOptions : void 0;
		...
		if (ks(u)) {
			...
			if (!Yc(g)) throw new Kc(h, "function", o);
			var _ = g(Xc(m, t, n, r, i, a).map(function(e) {
				return e.value;
			}));
		...
		if (Es(u)) {
			...
			if (!v) throw new Gc(u.value, f, Object.keys(u.options), o);
			s.push.apply(s, Xc(v.value, t, n, r, i));
			continue;
		}
		if (Ds(u)) {
			var v = u.options[`=${f}`];
			if (!v) {
				if (!Intl.PluralRules) throw new Wc("Intl.PluralRules is not available in this environment.\nTry polyfilling it using \"@formatjs/intl-pluralrules\"\n", Uc.MISSING_INTL_API, o);
				var y = n.getPluralRules(t, { type: u.pluralType }).select(f - (u.offset || 0));
				v = u.options[y] || u.options.other;
			}
			if (!v) throw new Gc(u.value, f, Object.keys(u.options), o);
			s.push.apply(s, Xc(v.value, t, n, r, i, f - (u.offset || 0)));
			continue;
		}
	}
	return Jc(s);
...
function el(e) {
	return e === void 0 && (e = {
		...
		getNumberFormat: jc(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.NumberFormat).bind.apply(e, $o([void 0], t, !1)))();
		}, {
			cache: $c(e.number),
			strategy: Hc.variadic
		}),
		getDateTimeFormat: jc(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
...
var tl = function() {
	function e(t, n, r, i) {
		...
		if (this.formatterCache = {
			...
			return Xc(a.ast, a.locales, a.formatters, a.formats, e, void 0, a.message);
			...
			var o = i || {};
			o.formatters;
			var s = Ro(o, ["formatters"]);
			this.ast = e.__parse(t, j(j({}, s), { locale: this.resolvedLocale }));
		} else this.ast = t;
		if (!Array.isArray(this.ast)) throw TypeError("A message must be provided as a String or AST.");
		this.formats = Qc(e.formats, r), this.formatters = i && i.formatters || el(this.formatterCache);
	}
	...
	try {
		...
		})() || A.get("DisplayNames", ["en"], { type: "language" }).of(t) === t && !rl(t) || n && A.get("DisplayNames", ["en"], { type: "region" }).of(n) === n || r && A.get("DisplayNames", ["en"], { type: "script" }).of(r) === r && !nl.includes(r));
	} catch {
		return !1;
	}
}, L = (e) => {
...
function al(...e) {
	try {
		let t = e.flat().map(L);
		for (let e = 0; e < t.length; e++) for (let n = e + 1; n < t.length; n++) if (!il(t[e], t[n])) return !1;
		return !0;
	} catch (e) {
		return console.error(e), !1;
	}
...
function sl(e, t, n, r) {
	return !(!I(e, r) || !I(t, r) || n && n.some((e) => !I(e, r)) || al(e, t) || n && !n.some((e) => ol(t, e)));
}
var cl = (e, t, n) => {
	if (e?.[t]) return typeof e[t] == "string" ? n === "name" ? e[t] : void 0 : e[t][n];
}, ll = (e, t) => !!(t?.[e] && typeof t[e] == "object" && "code" in t[e] && t[e].code && I(t[e].code));
function ul(e, t) {
	let n = e;
	t && ll(e, t) && (e = t[e].code);
	try {
		...
		if (s) return s;
		let c = i.maximize();
		return ml[c.language] || vl(c.region || "");
	} catch {
		return pl;
	}
}
var dl = "🌍", fl = "🌏", pl = dl, ml = {
	...
	EU: "🇪🇺",
	419: "🌎"
}, gl = /* @__PURE__ */ new Set(/* @__PURE__ */ "AF.AX.AL.DZ.AS.AD.AO.AI.AQ.AG.AR.AM.AW.AU.AT.AZ.BS.BH.BD.BB.BY.BE.BZ.BJ.BM.BT.BO.BQ.BA.BW.BV.BR.IO.BN.BG.BF.BI.CV.KH.CM.CA.KY.CF.TD.CL.CN.CX.CC.CO.KM.CD.CG.CK.CR.CI.HR.CU.CW.CY.CZ.DK.DJ.DM.DO.EC.EG.SV.GQ.ER.EE.SZ.ET.FK.FO.FJ.FI.FR.GF.PF.TF.GA.GM.GE.DE.GH.GI.GR.GL.GD.GP.GU.GT.GG.GN.GW.GY.HT.HM.VA.HN.HK.HU.IS.IN.ID.IR.IQ.IE.IM.IL.IT.JM.JP.JE.JO.KZ.KE.KI.KP.KR.KW.KG.LA.LV.LB.LS.LR.LY.LI.LT.LU.MO.MG.MW.MY.MV.ML.MT.MH.MQ.MR.MU.YT.MX.FM.MD.MC.MN.ME.MS.MA.MZ.MM.NA.NR.NP.NL.NC.NZ.NI.NE.NG.NU.NF.MK.MP.NO.OM.PK.PW.PS.PA.PG.PY.PE.PH.PN.PL.PT.PR.QA.RE.RO.RU.RW.BL.SH.KN.LC.MF.PM.VC.WS.SM.ST.SA.SN.RS.SC.SL.SG.SX.SK.SI.SB.SO.ZA.GS.SS.ES.LK.SD.SR.SJ.SE.CH.SY.TW.TJ.TZ.TH.TL.TG.TK.TO.TT.TN.TR.TM.TC.TV.UG.UA.AE.GB.US.UM.UY.UZ.VU.VE.VN.VG.VI.WF.EH.YE.ZM.ZW".split(".")), _l = 127397;
function vl(e) {
	return yl(e) || "🌍";
}
function yl(e) {
	let t = e.toUpperCase(), n = hl[t];
	if (n) return n;
	if (gl.has(t)) return String.fromCodePoint(t.charCodeAt(0) + _l, t.charCodeAt(1) + _l);
}
function bl(e, t) {
	if (t) {
		let n = {};
...
function xl(e, t = "en", n) {
	let r = e;
	n && ll(e, n) && (e = n[e].code), t ||= "en";
	try {
		let i = L(e), a = A.get("Locale", e), o = a.language, s = bl([
			r,
			e,
			i,
			o
		...
		return {
			...
			scriptName: s?.scriptName || (f ? ce.of(f) : "") || "",
			nativeScriptName: s?.nativeScriptName || (f ? le.of(f) : "") || "",
			emoji: s?.emoji || ul(i, n)
		};
	} catch {
		let t = I(e) ? L(e) : e, r = t?.split("-"), i = r?.[0] || t || "", a = r.length > 2 ? r?.[2] : r?.[1] || "", o = r?.[3] || "", s = bl([t, i], n);
		t = s?.code || t;
		let c = s?.name || t, l = s?.nativeName || c, u = s?.maximizedCode || t, d = s?.maximizedName || c, f = s?.nativeMaximizedName || l, p = s?.minimizedCode || t, m = s?.minimizedName || c, h = s?.nativeMinimizedName || l;
		i = s?.languageCode || i;
		let g = s?.languageName || c, _ = s?.nativeLanguageName || l;
...
function Sl(e, t, n) {
	...
	for (let n of e) {
		let e = t.filter((e) => ol(n, e)), r = ({ locale: t, languageCode: n, minimizedCode: r, regionCode: i, scriptCode: a }) => {
			let o = [
				t,
				`${n}-${i}`,
				`${n}-${a}`,
...
var Dl = class {
	...
	handle(e) {
		let t = [];
		this.config.includeTimestamp && t.push(`[${e.timestamp.toISOString()}]`);
		let n = wl[e.level], r = `[${e.level.toUpperCase()}]`;
		t.push(`${n}${r}${Tl}`), this.config.prefix && t.push(`[${this.config.prefix}]`), this.config.includeContext && e.context && t.push(`[${e.context}]`), t.push(e.message), e.metadata && Object.keys(e.metadata).length > 0 && t.push(`\n  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
		let i = t.join(" ");
		switch (e.level) {
			case "debug":
				console.debug(i);
	...
	constructor(e = {}) {
		this.config = {
			...
			handlers: [],
			...e
		}, this.handlers = [...this.config.handlers || []], this.config.enableConsole && this.handlers.push(new Dl(this.config));
	}
	addHandler(e) {
		this.handlers.push(e);
	}
	...
	shouldLog(e) {
		return Cl[e] >= Cl[this.config.level];
	}
	log(e, t, n, r) {
		if (!this.shouldLog(e)) return;
		let i = {
...
Al.child("validation"), Al.child("formatting"), Al.child("locale");
var Ml = Al.child("GT instance");
function Nl({ value: e, locales: t = "en", options: n = {} }) {
	return A.get("CutoffFormat", t, n).format(e);
}
function Pl(e, t = "en", n = {}) {
	return new tl(e, t).format(n)?.toString() ?? "";
}
function Fl(e) {
	return e;
}
...
function Rl({ value: e, locales: t = ["en"], currency: n = "USD", options: r = {} }) {
	return A.get("NumberFormat", t, {
		style: "currency",
		currency: n,
		numberingSystem: "latn",
...
function Hl({ date: e, baseDate: t, locales: n = ["en"], options: r = {} }) {
	let { value: i, unit: a } = Vl(e, t);
	return Ul({
		value: i,
		unit: a,
		locales: n,
...
function Ul({ value: e, unit: t, locales: n = ["en"], options: r = {} }) {
...
function Gl(e) {
	try {
		let t = Jl(A.get("Locale", e));
		if (t) return t;
	} catch {}
	let { scriptCode: t, languageCode: n } = xl(e);
	return t ? Yl(t) ? "rtl" : "ltr" : n && Xl(n) ? "rtl" : "ltr";
}
...
function Yl(e) {
	return e ? Kl.has(e.toLowerCase()) : !1;
}
function Xl(e) {
...
var eu = class {
	...
	formatMessage(e, t, n = {}) {
		let { locales: r, variables: i, dataFormat: a } = n;
		return a === "STRING" ? Fl(e) : Pl(e, this.getFormattingLocales(t, r), i);
	}
	formatList(e, t, n = {}) {
		let { locales: r, ...i } = n;
		return zl({
	...
	getLocaleName(e) {
		return Wl(e, this.defaultLocale, this.customMapping);
	}
	getLocaleEmoji(e) {
		return ul(e, this.customMapping);
	}
	getLocaleProperties(e) {
		return xl(e, this.defaultLocale, this.customMapping);
	}
	requiresTranslation(e, t = this.defaultLocale, n = this.translationLocales) {
		return sl(this.resolveCanonicalLocale(t), this.resolveCanonicalLocale(e), n ? this.resolveCanonicalLocaleList(n) : void 0, this.customMapping);
	}
	determineLocale(e, t = this.locales) {
		let n = t.map((e) => ({
			locale: e,
			canonicalLocale: this.resolveCanonicalLocale(e)
		})), r = Sl(Array.isArray(e) ? this.resolveCanonicalLocaleList(e) : this.resolveCanonicalLocale(e), n.map(({ canonicalLocale: e }) => e), this.customMapping);
		if (r) return n.find(({ canonicalLocale: e }) => e === r)?.locale || this.resolveAliasLocale(r);
	}
	getLocaleDirection(e) {
		return Gl(this.resolveCanonicalLocale(e));
	}
	isValidLocale(e) {
	...
	resolveAliasLocale(e) {
		return Ql(e, this.customMapping);
	}
	standardizeLocale(e) {
		return L(e);
	}
	isSameDialect(...e) {
		return al(...this.resolveCanonicalLocaleArgs(e));
	}
	isSameLanguage(...e) {
		return ol(...this.resolveCanonicalLocaleArgs(e));
	}
	isSupersetLocale(e, t) {
		return Zl(this.resolveCanonicalLocale(e), this.resolveCanonicalLocale(t));
	}
};
function tu(e, t) {
	return I(e, t);
...
function su({ source: e, context: t, id: n, maxChars: r, dataFormat: i }, a = ou) {
	let o;
	return o = i === "JSX" ? lu(e) : e, a(Po({
		source: o,
		...n && { id: n },
		...t && { context: t },
		...r != null && { maxChars: Math.abs(r) },
...
var cu = (e) => {
	if (e && typeof e == "object") {
		let t = {};
		if ("c" in e && e.c && (t.c = lu(e.c)), "d" in e) {
			let n = e?.d;
			n?.b && (t.b = Object.fromEntries(Object.entries(n.b).map(([e, t]) => [e, lu(t)]))), n?.t && (t.t = n.t);
		}
		return Fo(e) ? {
			k: e.k,
			...e.v && { v: e.v }
...
function lu(e) {
	return Array.isArray(e) ? e.map(cu) : cu(e);
}
var uu = "GT Error:", du = (e) => `${uu} Translation request timed out after ${e}ms.`, fu = (e) => `${uu} Translation request failed. Error: ${e}`, pu = (e, t, n) => `${uu} API returned error status. Status: ${e}, Status Text: ${t}, Error: ${n}`, R = (e) => `${uu} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a targetLocale in the GT constructor.`, mu = (e) => `${uu} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a sourceLocale in the GT constructor.`, hu = (e) => `${uu} Cannot call \`${e}\` without a specified project ID. Either pass a project ID to the \`${e}\` function or specify a projectId in the GT constructor.`, gu = (e) => `${uu} Cannot call \`${e}\` without a specified API key. Either pass an API key to the \`${e}\` function or specify an apiKey in the GT constructor.`, _u = (e) => `${uu} Invalid locale: ${e}.`, vu = (e) => `${uu} Invalid locales: ${e.join(", ")}.`;
async function yu(e, t, n) {
	...
	try {
		...
		throw e instanceof Error && e.name === "AbortError" ? du(n) : e;
	} finally {
		a && clearTimeout(a);
	}
}
async function bu(e) {
	if (!e.ok) {
		...
		throw new au(pu(e.status, e.statusText, t), e.status, t);
	}
}
function xu(e, t) {
	if (e instanceof Error && e.name === "AbortError") {
		let e = du(t);
		throw jl.error(e), Error(e);
	}
	let n = fu(e instanceof Error ? e.message : String(e));
	throw jl.error(n), e;
}
var Su = "2026-03-06.v1";
function Cu(e, t = !1) {
	let n = {
		...!t && { "Content-Type": "application/json" },
		"x-gt-project-id": e.projectId
	};
	return e.apiKey && (e.apiKey.startsWith("gtx-internal-") ? n["x-gt-internal-api-key"] = e.apiKey : n["x-gt-api-key"] = e.apiKey), n["gt-api-version"] = Su, n;
}
var wu = 3, Tu = 500;
function Eu(e) {
...
function Du(e, t) {
	switch (e) {
		case "linear": return Tu * (t + 1);
		case "exponential": return Tu * 2 ** t;
		default: return 0;
	}
}
async function z(e, t, n) {
	let r = n?.timeout ?? 6e4, i = `${e.baseUrl || "https://api2.gtx.dev"}${t}`, a = n?.method ?? "POST", o = n?.retryPolicy ?? "exponential", s = o === "none" ? 0 : wu, c = {
		method: a,
		headers: Cu(e)
	};
	...
	for (let e = 0; e <= s; e++) {
		...
		return await bu(t), await t.json();
	}
	throw Error("Max retries exceeded");
}
async function Ou(e, t, n, r) {
	let i = Array.isArray(e), a = i ? [] : void 0, o = {}, s = i ? e.map((e) => [void 0, e]) : Object.entries(e);
	for (let [e, t] of s) {
		let { source: n, metadata: r } = typeof t == "string" ? { source: t } : t, i = e ?? r?.hash ?? su({
			source: n,
			dataFormat: r?.dataFormat ?? "STRING",
			...r ?? {}
		});
...
async function Pu(e, t, n) {
	return ju(e, async (e) => (await z(n, "/v2/project/files/download", {
		body: e,
		timeout: t.timeout
	})).files.map((e) => ({
		...e,
...
async function Fu(e, t, n = {}) {
	return await ju(e.diffs, async (e) => (await z(t, "/v2/project/files/diffs", {
		body: { diffs: e },
		timeout: n.timeout
	}), [{ success: !0 }]), { batchSize: 100 }), { success: !0 };
}
function Iu(e, t = "en", n) {
	t ||= "en";
	try {
		return {
			code: e,
...
async function Lu(e, t, n) {
	return ju(e, async (e) => (await z(n, "/v2/project/files/upload-files", {
		body: {
			data: e.map(({ source: e }) => ({ source: {
				content: jo(e.content),
				fileName: e.fileName,
...
async function Ru(e, t, n) {
	return Ao(e.map(({ source: e }) => e)), ju(e, async (e) => (await z(n, "/v2/project/files/upload-translations", {
		body: {
...
async function Bu(e, t, n) {
	let { baseUrl: r } = n, i = t.timeout ? t.timeout : bo, a = `${r || "https://api2.gtx.dev"}/v2/project/info/${encodeURIComponent(e)}`, o;
	try {
		o = await yu(a, {
			method: "GET",
			headers: Cu(n)
	...
	return await bu(o), await o.json();
}
...
async function Ku(e, t, n) {
	...
	let r = await ju(e, async (e) => (await z(n, "/v2/project/files/moves", {
		body: {
			branchId: t.branchId,
			moves: e
		},
...
async function qu(e, t, n = {}, r) {
	...
	let a = Au(t, 100), o = await Promise.all(a.map((e) => i(e)));
...
var Yu = class {
	...
	setConfig({ apiKey: e, devApiKey: t, sourceLocale: n, targetLocale: r, locales: i, projectId: a, customMapping: o, baseUrl: s }) {
		if (e && (this.apiKey = e), t && (this.devApiKey = t), a && (this.projectId = a), n && (this.sourceLocale = L(n), !I(this.sourceLocale, o))) throw Error(_u(this.sourceLocale));
		if (r && (this.targetLocale = L(r), !I(this.targetLocale, o))) throw Error(_u(this.targetLocale));
		if (i) {
			let e = [], t = [];
			if (i.forEach((n) => {
				let r = L(n);
				I(r) ? e.push(r) : t.push(n);
			}), t.length > 0) throw Error(vu(t));
			this.locales = e;
		}
		s && (this.baseUrl = s), o && (this.customMapping = o, this.reverseCustomMapping = Object.fromEntries(Object.entries(o).filter(([, e]) => e && typeof e == "object" && "code" in e).map(([e, t]) => [t.code, e]))), this._localeConfig = new eu({
			defaultLocale: this.sourceLocale,
			locales: this.locales ?? [],
			customMapping: this.customMapping
		});
	...
	async queryBranchData(e) {
		return this._validateAuth("queryBranchData"), await Wu(e, this._getTranslationConfig());
	}
	async createBranch(e) {
		return this._validateAuth("createBranch"), await Gu(e, this._getTranslationConfig());
	}
	async processFileMoves(e, t = {}) {
		return this._validateAuth("processFileMoves"), await Ku(e, t, this._getTranslationConfig());
	}
	async getOrphanedFiles(e, t, n = {}) {
		return this._validateAuth("getOrphanedFiles"), await qu(e, t, n, this._getTranslationConfig());
	}
	async setupProject(e, t) {
		return this._validateAuth("setupProject"), t = {
			...t,
			locales: t?.locales?.map((e) => this.resolveCanonicalLocale(e))
		}, await ku(e, this._getTranslationConfig(), t);
	}
	async checkJobStatus(e, t) {
		return this._validateAuth("checkJobStatus"), await Vu(e, this._getTranslationConfig(), t);
	}
	async awaitJobs(e, t) {
		return this._validateAuth("awaitJobs"), await Hu(e, t, this._getTranslationConfig());
	}
	async enqueueFiles(e, t) {
		...
		}, await Mu(e, n, this._getTranslationConfig());
	}
	async createTag(e) {
		return this._validateAuth("createTag"), await Nu(e, this._getTranslationConfig());
	}
	async publishFiles(e) {
		return this._validateAuth("publishFiles"), await Ju(e, this._getTranslationConfig());
	}
	async submitUserEditDiffs(e) {
		this._validateAuth("submitUserEditDiffs"), await Fu({
			...e,
			diffs: (e.diffs || []).map((e) => ({
				...e,
	...
	async queryFileData(e, t = {}) {
		...
		let n = await Uu(e, t, this._getTranslationConfig());
	...
	async getProjectData(e, t = {}) {
		...
		let n = await Bu(e, t, this._getTranslationConfig());
	...
	async downloadFile(e, t = {}) {
		return this._validateAuth("downloadTranslatedFile"), (await Pu([{
			fileId: e.fileId,
			branchId: e.branchId,
	...
	async downloadFileBatch(e, t = {}) {
		...
		let n = await Pu(e, t, this._getTranslationConfig());
		return {
			files: n.data.map((e) => ({
				...e,
				...e.locale && { locale: this.resolveAliasLocale(e.locale) }
	...
	async uploadSourceFiles(e, t) {
		...
		let r = await Lu(e, n, this._getTranslationConfig());
		return {
	...
	async uploadTranslations(e, t) {
		...
		if (!n.sourceLocale) {
			let e = mu("uploadTranslations");
			throw Ml.error(e), Error(e);
		}
		let r = await Ru(e.map((e) => ({
			...e,
	...
	getRegionProperties(e = this.getLocaleProperties().regionCode, t) {
		...
		return Iu(e, this.targetLocale, t);
	}
	requiresTranslation(e = this.sourceLocale, t = this.targetLocale, n = this.locales, r = this.customMapping) {
		if (!e) throw Error(mu("requiresTranslation"));
		if (!t) throw Error(R("requiresTranslation"));
		return r === this.customMapping ? this.localeConfig.requiresTranslation(t, e, n) : sl(e, t, n, r);
	}
	determineLocale(e, t = this.locales || [], n = this.customMapping) {
		return n === this.customMapping ? this.localeConfig.determineLocale(e, t ?? []) : Sl(e, t, n);
	}
	getLocaleDirection(e = this.targetLocale) {
	...
	resolveCanonicalLocale(e = this.targetLocale, t = this.customMapping) {
		...
		return t === this.customMapping ? this.localeConfig.resolveCanonicalLocale(e) : $l(e, t);
	}
	resolveAliasLocale(e, t = this.customMapping) {
		if (!e) throw Error(R("resolveAliasLocale"));
		return t === this.customMapping ? this.localeConfig.resolveAliasLocale(e) : Ql(e, t);
	}
	standardizeLocale(e = this.targetLocale) {
...
function td(e, t = "", n = !0) {
	if (e.forEach((e) => {
		switch (e.type) {
			case "error":
				iu.error(t + e.message);
				break;
			case "warning": iu.warn(t + e.message);
		}
...
function cd(e) {
	let t = [];
	return t.push(...rd(e)), t.push(...ad(e)), t.push(...sd(e)), t;
}
var ld = class {}, ud = "fallback-storage-adapter", dd = class extends ld {
	constructor(...e) {
		super(...e), this.type = ud, this.storage = {};
	}
	getItem(e) {
...
function md(e) {
	let { cacheUrl: t = Eo, projectId: n, _versionId: r, _branchId: i } = e, a = r ? `/${r}` : "", o = i ? `?branchId=${i}` : "";
	return `${t}/${n}/[locale]` + a + o;
}
function hd() {
	return async (e) => ({});
}
function gd({ type: e, remoteTranslationLoaderParams: t, loadTranslations: n }) {
	e === "disabled" && iu.warn("I18nManager: No translation loader found. No translations will be loaded.");
	let { cacheUrl: r, projectId: i, _versionId: a, _branchId: o, customMapping: s } = t;
	switch (e) {
		case "remote":
		case "gt-remote": return pd({
			cacheUrl: r || "",
			projectId: i || "",
			_versionId: a,
			_branchId: o,
...
var yd = 25, bd = 100, xd = 50, Sd = class extends _d {
	...
	genKey(e) {
		return vd(e.message, e.options);
	}
	fallback(e) {
		let t = this._enqueueTranslation(e);
		return this._queue.length >= yd ? this._flushNow() : this._scheduleBatch(), t;
	}
	_flushNow() {
	...
	_drainQueue() {
		for (; this._queue.length > 0 && this._activeRequests < bd;) {
			let e = this._queue.splice(0, yd);
	...
	async _sendBatchRequest(e) {
		...
		let t = Cd(e), n = await this._sendBatchRequestWithErrorHandling(e, t);
...
var wd = 6e4, Td = class extends _d {
	constructor({ init: e = {}, ttl: t, loadTranslations: n, createTranslateMany: r, lifecycle: { onLocalesCacheHit: i, onLocalesCacheMiss: a, onTranslationsCacheHit: o, onTranslationsCacheMiss: s } }) {
		super(e, {
			onHit: i,
			onMiss: a
		}), this.ttl = wd, this.ttl = t === null ? -1 : t ?? 6e4, this._translationLoader = n, this._createTranslateMany = r, this._onTranslationsCacheHit = o, this._onTranslationsCacheMiss = s;
	}
	get(e) {
		let t = this.getCache(e);
...
function Od({ onLocalesCacheHit: e, onLocalesCacheMiss: t, onTranslationsCacheHit: n, onTranslationsCacheMiss: r }, i) {
...
var kd = 12e3, Ad = class extends Dd {
	constructor(e) {
		super(), this.resolveTranslationSync = (e, t = {}) => this.lookupTranslation(e, t), td(cd(e), "I18nManager: "), this.config = jd(e), this.localeConfig = new eu({
			defaultLocale: this.config.defaultLocale,
			locales: this.config.locales,
			customMapping: this.config.customMapping
		}), this.storeAdapter = e.storeAdapter ?? new dd();
		let t = Fd(e), n = fd(this.getGTClassClean(), kd);
		Od(e.lifecycle ?? {}, (...e) => this.subscribe(...e)), this.localesCache = new Td({
			loadTranslations: t,
			createTranslateMany: n,
			lifecycle: Ed((...e) => this.emit(...e))
		});
	}
	...
	getLocale() {
		return this.storeAdapter.getItem("locale") || (iu.warn("getLocale() invoked outside of translation context, falling back to default locale"), this.config.defaultLocale);
	}
	setLocale(e) {
		try {
	...
	async getLookupTranslation(e = this.getLocale(), t = []) {
		try {
			...
			let r = Pd(t, n, (e) => this.resolveLocale(e));
			r.length !== t.length && iu.warn(`I18nManager: getLookupTranslation(): prefetchEntries must all be the same locale, ignoring all entries that are not for ${n}`);
			let i = this.localesCache.get(n);
	...
	handleError(e) {
		switch (this.config.environment) {
			...
			default: iu.error("I18nManager: " + e);
		}
	}
	resolveLocale(e) {
...
function Md({ defaultLocale: e, locales: t, customMapping: n }) {
	return {
		defaultLocale: e,
...
function Nd(e) {
	return {
		defaultLocale: ru(e.defaultLocale),
		locales: e.locales.map((t) => (typeof e.customMapping?.[t] == "string" ? e.customMapping?.[t] : e.customMapping?.[t]?.code) ? t : ru(t)),
		customMapping: Object.fromEntries(Object.entries(e.customMapping || {}).map(([e, t]) => [e, typeof t == "string" ? ru(t) : {
			...t,
			...t.code ? { code: ru(t.code) } : {}
		}]))
	};
}
function Pd(e, t, n) {
...
var Id = void 0;
function Ld() {
	return Id ||= (iu.warn("getI18nManager(): Translation failed because I18nManager not initialized."), new Ad({
		defaultLocale: "en",
		locales: ["en"]
	})), Id;
}
...
var zd = "DEFAULT_TERMINATOR_KEY", Bd = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	CutoffFormat: class {
		constructor(e, t = {}) {
			...
			if (!Bd[t.style ?? "ellipsis"]) throw Error(((e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`)(t.style ?? "ellipsis"));
			let n, r;
			if (t.maxChars !== void 0) {
				n = t.style ?? "ellipsis";
				let e = new Intl.Locale(this.locale).language;
				r = Bd[n][e] || Bd[n].DEFAULT_TERMINATOR_KEY;
			}
			let i = t.terminator ?? r?.terminator, a = i == null ? void 0 : t.separator ?? r?.separator;
			this.additionLength = (i?.length ?? 0) + (a?.length ?? 0), t.maxChars !== void 0 && Math.abs(t.maxChars) < this.additionLength && (i = void 0, a = void 0), this.options = {
				maxChars: t.maxChars,
...
new class {
	...
	get(e, ...t) {
		let [n = "en", r = {}] = t, i = this._generateKey(n, r), a = this.cache[e]?.[i];
		return a === void 0 && (a = new Vd[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}();
function Hd(e, t, n = "") {
...
var Yd = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = Gd(this.buffer);
	}
	update(e) {
		Ud(this), Hd(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		Ud(this), function(e, t) {
			Hd(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, Wd(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
	...
	3204031479,
	3329325298
]), Qd = /* @__PURE__ */ new Uint32Array(64), $d = class extends Yd {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) Qd[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = Qd[e - 15], n = Qd[e - 2], r = Kd(t, 7) ^ Kd(t, 18) ^ t >>> 3, i = Kd(n, 17) ^ Kd(n, 19) ^ n >>> 10;
			Qd[e] = i + Qd[e - 7] + r + Qd[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (Kd(o, 6) ^ Kd(o, 11) ^ Kd(o, 25)) + qd(o, s, c) + Zd[e] + Qd[e] | 0, u = (Kd(n, 2) ^ Kd(n, 13) ^ Kd(n, 22)) + Jd(n, r, i) | 0;
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), Wd(this.buffer);
	}
}, ef = class extends $d {
	A = 0 | Xd[0];
	B = 0 | Xd[1];
...
(function(e, t = {}) {
	let n = (t, n) => e(n).update(t).digest(), r = e(void 0);
	return n.outputLen = r.outputLen, n.blockLen = r.blockLen, n.canXOF = r.canXOF, n.create = (t) => e(t), Object.assign(n, t), Object.freeze(n);
})(() => new ef(), (tf = 1, { oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
var tf, nf = function(e, t) {
	return nf = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, nf(e, t);
...
function rf(e, t) {
	...
	nf(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var B = function() {
...
var hf = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function gf(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || hf(t, e, n);
}
function _f(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function Sf(e) {
	return this instanceof Sf ? (this.v = e, this) : new Sf(e);
}
function Cf(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof Sf ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function Tf(e) {
	...
	return n ? n.call(e) : (e = _f(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var Df = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return Of = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, Of(e);
...
function kf(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = Of(e), r = 0; r < n.length; r++) n[r] !== "default" && hf(t, e, n[r]);
	return Df(t, e), t;
}
function Af(e) {
	return e && e.__esModule ? e : { default: e };
...
var Ff = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function If(e) {
	function t(t) {
		e.error = e.hasError ? new Ff(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var V, H, Rf, zf = Object.freeze({
	...
	__await: Sf,
	__awaiter: pf,
	__classPrivateFieldGet: jf,
	__classPrivateFieldIn: Nf,
	__classPrivateFieldSet: Mf,
	__createBinding: hf,
	__decorate: of,
	__disposeResources: If,
	__esDecorate: cf,
	__exportStar: gf,
	__extends: rf,
	__generator: mf,
	...
	__read: vf,
	__rest: af,
	__rewriteRelativeImportExtension: Lf,
	__runInitializers: lf,
...
var Bf = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, Vf = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Hf(e) {
	var t = {};
...
var Gf = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, Kf = /^(@+)?(\+|#+)?[rs]?$/g, qf = /(\*)(0+)|(#+)(0+)|(0+)/g, Jf = /^(0+)$/;
function Yf(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(Kf, function(e, n, r) {
		return typeof r == "string" ? r === "+" ? t.minimumSignificantDigits = n.length : n[0] === "#" ? t.maximumSignificantDigits = n.length : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length + (typeof r == "string" ? r.length : 0)) : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length), "";
	}), t;
}
function Xf(e) {
...
function Zf(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !Jf.test(e)) throw Error("Malformed concise eng/scientific notation");
		t.minimumIntegerDigits = e.length;
	}
	return t;
}
...
function $f(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "integer-width":
				if (i.options.length > 1) throw RangeError("integer-width stems only accept a single optional option");
				i.options[0].replace(qf, function(e, n, r, i, a, o) {
					if (n) t.minimumIntegerDigits = r.length;
					else {
		...
		if (Jf.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
		else if (Gf.test(i.stem)) {
			if (i.options.length > 1) throw RangeError("Fraction-precision stems only accept a single optional option");
			i.stem.replace(Gf, function(e, n, r, i, a, o) {
				return r === "*" ? t.minimumFractionDigits = n.length : i && i[0] === "#" ? t.maximumFractionDigits = i.length : a && o ? (t.minimumFractionDigits = a.length, t.maximumFractionDigits = a.length + o.length) : (t.minimumFractionDigits = n.length, t.maximumFractionDigits = n.length), "";
			});
			var a = i.options[0];
			a === "w" ? t = B(B({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = B(B({}, t), Yf(a)));
		} else if (Kf.test(i.stem)) t = B(B({}, t), Yf(i.stem));
		else {
			var o = Xf(i.stem);
			o && (t = B(B({}, t), o));
			var s = Zf(i.stem);
...
function tp(e) {
	...
	var n, r = e.language;
	return r !== "root" && (n = e.maximize().region), (ep[n || ""] || ep[r || ""] || ep[`${r}-001`] || ep["001"])[0];
}
var np = RegExp(`^${Bf.source}*`), rp = RegExp(`${Bf.source}*\$`);
function U(e, t) {
	return {
		start: e,
		end: t
...
var ip = !!String.prototype.startsWith && "_a".startsWith("a", 1), ap = !!String.fromCodePoint, op = !!Object.fromEntries, sp = !!String.prototype.codePointAt, cp = !!String.prototype.trimStart, lp = !!String.prototype.trimEnd, up = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, dp = !0;
try {
	dp = yp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	dp = !1;
}
var fp, pp = ip ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, mp = ap ? String.fromCodePoint : function() {
	...
	return n;
}, hp = op ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
if (dp) {
	var bp = yp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	fp = function(e, t) {
		return bp.lastIndex = t, bp.exec(e)[1] ?? "";
	};
} else fp = function(e, t) {
	for (var n = [];;) {
		var r = gp(e, t);
		if (r === void 0 || Cp(r) || wp(r)) break;
		n.push(r), t += r >= 65536 ? 2 : 1;
	}
	return mp.apply(void 0, n);
};
(function() {
	function e(e, t) {
		t === void 0 && (t = {}), this.message = e, this.position = {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			if (i === 123) {
				...
				if (i !== 35 || t !== "plural" && t !== "selectordinal") {
					...
					if (i === 60 && !this.ignoreTag && xp(this.peek() || 0)) {
		...
		if (this.bumpIf(">")) {
			...
			var a = i.val, o = this.clonePosition();
			if (this.bumpIf("</")) {
				if (this.isEOF() || !xp(this.char())) return this.error(V.INVALID_TAG, U(o, this.clonePosition()));
				var s = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					val: {
						type: H.tag,
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && Sp(this.char());) this.bump();
		return this.message.slice(e, this.offset());
	}, e.prototype.parseLiteral = function(e, t) {
		for (var n = this.clonePosition(), r = "";;) {
			var i = this.tryParseQuote(t);
		...
		return this.isEOF() || this.char() !== 60 || !this.ignoreTag && (xp(e = this.peek() || 0) || e === 47) ? null : (this.bump(), "<");
		var e;
	}, e.prototype.tryParseQuote = function(e) {
		if (this.isEOF() || this.char() !== 39) return null;
		switch (this.peek()) {
		...
		return mp.apply(void 0, t);
	}, e.prototype.tryParseUnquoted = function(e, t) {
		if (this.isEOF()) return null;
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), mp(n));
	}, e.prototype.parseArgument = function(e, t) {
		var n = this.clonePosition();
		...
		var e = this.clonePosition(), t = this.offset(), n = fp(this.message, t), r = t + n.length;
		return this.bumpTo(r), {
			value: n,
		...
		switch (a) {
			...
			case "time":
				...
				if (this.bumpIf(",")) {
					...
					if ((f = vp(g.val)).length === 0) return this.error(V.EXPECT_ARGUMENT_STYLE, U(this.clonePosition(), this.clonePosition()));
					s = {
						style: f,
				...
				if (s && pp(s?.style, "::", 0)) {
					...
					this.locale && (d = function(e, t) {
						for (var n = "", r = 0; r < e.length; r++) {
							...
							if (i === "j") {
								for (var a = 0; r + 1 < e.length && e.charAt(r + 1) === i;) a++, r++;
								var o = 1 + (1 & a), s = a < 2 ? 1 : 3 + (a >> 1), c = tp(t);
					...
					var f = {
						...
						pattern: d,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? Hf(d) : {}
					};
					return {
						val: {
		...
		try {
			n = function(e) {
				if (e.length === 0) throw Error("Number skeleton cannot be empty");
				for (var t = [], n = 0, r = e.split(Uf).filter(function(e) {
					return e.length > 0;
				}); n < r.length; n++) {
					var i = r[n].split("/");
		...
		return {
			val: {
				...
				tokens: n,
				location: t,
				parsedOptions: this.shouldParseSkeletons ? $f(n) : {}
			},
			err: null
		};
	}, e.prototype.tryParsePluralOrSelectOptions = function(e, t, n, r) {
		...
		if (pp(this.message, e, this.offset())) {
			for (var t = 0; t < e.length; t++) this.bump();
			return !0;
		}
		return !1;
		...
		for (; !this.isEOF() && Cp(this.char());) this.bump();
	}, e.prototype.peek = function() {
		if (this.isEOF()) return null;
		var e = this.char(), t = this.offset();
		return this.message.charCodeAt(t + (e >= 65536 ? 2 : 1)) ?? null;
...
var Tp, W = {};
function Ep() {
	return Tp || (Tp = 1, Object.defineProperty(W, "__esModule", { value: !0 }), W.SKELETON_TYPE = W.TYPE = void 0, W.isLiteralElement = function(t) {
...
(function() {
	if (Dp) return Op;
	Dp = 1, Object.defineProperty(Op, "__esModule", { value: !0 }), Op.printAST = n, Op.doPrintAST = r, Op.printDateTimeSkeleton = o;
	var e = kp, t = Ep();
	function n(e) {
		return r(e, !1);
	}
...
var Ap = "_gt_";
RegExp(`^${Ap}\\d+$`), RegExp(`^${Ap}$`);
var jp = "generaltranslation.locale";
e.use;
var Mp = {
	af: ["af"],
	am: ["am"],
...
function Np(e) {
	if (!tu(e)) return null;
	e = ru(e);
	let { languageCode: t, ...n } = Xu(e);
	if (Mp[t]?.length) {
		let r = Mp[t], i = ({ locale: e, languageCode: t, minimizedCode: n, regionCode: i, scriptCode: a }) => {
			let o = [
				e,
				`${t}-${i}`,
				`${t}-${a}`,
...
function Fp(e = {}, t) {
	return e.name ? e.name : `_gt_${Pp[t] || "value"}_${e["data-_gt"]?.id}`;
}
var Ip = "en", Lp = "DEFAULT_TERMINATOR_KEY", Rp = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	CutoffFormat: class {
		constructor(e, t = {}) {
			...
			if (!Rp[t.style ?? "ellipsis"]) throw Error(((e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`)(t.style ?? "ellipsis"));
			let n, r;
			if (t.maxChars !== void 0) {
				n = t.style ?? "ellipsis";
				let e = new Intl.Locale(this.locale).language;
				r = Rp[n][e] || Rp[n].DEFAULT_TERMINATOR_KEY;
			}
			let i = t.terminator ?? r?.terminator, a = i == null ? void 0 : t.separator ?? r?.separator;
			this.additionLength = (i?.length ?? 0) + (a?.length ?? 0), t.maxChars !== void 0 && Math.abs(t.maxChars) < this.additionLength && (i = void 0, a = void 0), this.options = {
				maxChars: t.maxChars,
...
var Bp = "https://cdn.gtx.dev", Vp = "https://runtime2.gtx.dev";
function Hp(e) {
	if (e === void 0) return;
	if (e === null) return "null";
	if (typeof e == "number") return isFinite(e) ? "" + e : "null";
	...
	if (Array.isArray(e)) {
		let t = "[";
		for (let n = 0; n < e.length; n++) n && (t += ","), t += Hp(e[n]) || "null";
		return t + "]";
	}
	let t = Object.keys(e).sort(), n = "";
	for (let r of t) {
...
var Xp = typeof Uint8Array.from([]).toHex == "function" && typeof Uint8Array.fromHex == "function", Zp = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function Qp(e, t = {}) {
	let n = (t, n) => e(n).update(t).digest(), r = e(void 0);
	return n.outputLen = r.outputLen, n.blockLen = r.blockLen, n.canXOF = r.canXOF, n.create = (t) => e(t), Object.assign(n, t), Object.freeze(n);
}
var $p = (e) => ({ oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
var nm = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = Jp(this.buffer);
	}
	update(e) {
		Kp(this), Gp(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		Kp(this), function(e, t) {
			Gp(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, qp(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = Jp(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), am = /* @__PURE__ */ new Uint32Array(64), om = class extends nm {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) am[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = am[e - 15], n = am[e - 2], r = Yp(t, 7) ^ Yp(t, 18) ^ t >>> 3, i = Yp(n, 17) ^ Yp(n, 19) ^ n >>> 10;
			am[e] = i + am[e - 7] + r + am[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (Yp(o, 6) ^ Yp(o, 11) ^ Yp(o, 25)) + em(o, s, c) + im[e] + am[e] | 0, u = (Yp(n, 2) ^ Yp(n, 13) ^ Yp(n, 22)) + tm(n, r, i) | 0;
			l = c, c = s, s = o, o = a + t | 0, a = i, i = r, r = n, n = t + u | 0;
		}
		n = n + this.A | 0, r = r + this.B | 0, i = i + this.C | 0, a = a + this.D | 0, o = o + this.E | 0, s = s + this.F | 0, c = c + this.G | 0, l = l + this.H | 0, this.set(n, r, i, a, o, s, c, l);
	}
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), qp(this.buffer);
	}
}, sm = class extends om {
	A = 0 | rm[0];
	B = 0 | rm[1];
...
}, cm = Qp(() => new sm(), $p(1)), lm = function(e, t) {
	return lm = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, lm(e, t);
...
function um(e, t) {
	...
	lm(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var G = function() {
...
var xm = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function Sm(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || xm(t, e, n);
}
function Cm(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function Om(e) {
	return this instanceof Om ? (this.v = e, this) : new Om(e);
}
function km(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var r, i = n.apply(e, t || []), a = [];
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof Om ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function jm(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = Cm(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var Nm = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return Pm = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, Pm(e);
...
function Fm(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = Pm(e), r = 0; r < n.length; r++) n[r] !== "default" && xm(t, e, n[r]);
	return Nm(t, e), t;
}
function Im(e) {
	return e && e.__esModule ? e : { default: e };
...
var Vm = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function Hm(e) {
	function t(t) {
		e.error = e.hasError ? new Vm(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var K, q, Wm, Gm = Object.freeze({
	...
	__read: wm,
	__rest: dm,
	__rewriteRelativeImportExtension: Um,
	__runInitializers: hm,
	__setFunctionName: _m,
	__spread: Tm,
	__spreadArray: Dm,
	__spreadArrays: Em,
	__values: Cm,
...
var Km = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, qm = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Jm(e) {
	var t = {};
	return e.replace(qm, function(e) {
		var n = e.length;
		switch (e[0]) {
			case "G":
				t.era = n === 4 ? "long" : n === 5 ? "narrow" : "short";
...
var Zm = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, Qm = /^(@+)?(\+|#+)?[rs]?$/g, $m = /(\*)(0+)|(#+)(0+)|(0+)/g, eh = /^(0+)$/;
function th(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(Qm, function(e, n, r) {
		return typeof r == "string" ? r === "+" ? t.minimumSignificantDigits = n.length : n[0] === "#" ? t.maximumSignificantDigits = n.length : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length + (typeof r == "string" ? r.length : 0)) : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length), "";
	}), t;
}
function nh(e) {
...
function rh(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !eh.test(e)) throw Error("Malformed concise eng/scientific notation");
		t.minimumIntegerDigits = e.length;
	}
	return t;
}
...
function ah(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "measure-unit":
			case "unit":
				t.style = "unit", t.unit = Xm(i.options[0]);
				continue;
			case "compact-short":
			case "K":
				t.notation = "compact", t.compactDisplay = "short";
			...
			case "integer-width":
				if (i.options.length > 1) throw RangeError("integer-width stems only accept a single optional option");
				i.options[0].replace($m, function(e, n, r, i, a, o) {
					if (n) t.minimumIntegerDigits = r.length;
					else {
						if (i && a) throw Error("We currently do not support maximum integer digits");
						if (o) throw Error("We currently do not support exact integer digits");
		...
		if (eh.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
		else if (Zm.test(i.stem)) {
			if (i.options.length > 1) throw RangeError("Fraction-precision stems only accept a single optional option");
			i.stem.replace(Zm, function(e, n, r, i, a, o) {
				return r === "*" ? t.minimumFractionDigits = n.length : i && i[0] === "#" ? t.maximumFractionDigits = i.length : a && o ? (t.minimumFractionDigits = a.length, t.maximumFractionDigits = a.length + o.length) : (t.minimumFractionDigits = n.length, t.maximumFractionDigits = n.length), "";
			});
			var a = i.options[0];
			a === "w" ? t = G(G({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = G(G({}, t), th(a)));
		} else if (Qm.test(i.stem)) t = G(G({}, t), th(i.stem));
		else {
			var o = nh(i.stem);
			o && (t = G(G({}, t), o));
			var s = rh(i.stem);
...
function sh(e) {
	...
	var n, r = e.language;
	return r !== "root" && (n = e.maximize().region), (oh[n || ""] || oh[r || ""] || oh[`${r}-001`] || oh["001"])[0];
}
var ch = RegExp(`^${Km.source}*`), lh = RegExp(`${Km.source}*\$`);
function J(e, t) {
	return {
		start: e,
		end: t
...
var uh = !!String.prototype.startsWith && "_a".startsWith("a", 1), dh = !!String.fromCodePoint, fh = !!Object.fromEntries, ph = !!String.prototype.codePointAt, mh = !!String.prototype.trimStart, hh = !!String.prototype.trimEnd, gh = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, _h = !0;
try {
	_h = Th("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	_h = !1;
}
var vh, yh = uh ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, bh = dh ? String.fromCodePoint : function() {
	for (var e = [...arguments], t, n = "", r = e.length, i = 0; r > i;) {
		if ((t = e[i++]) > 1114111) throw RangeError(t + " is not a valid code point");
		n += t < 65536 ? String.fromCharCode(t) : String.fromCharCode(55296 + ((t -= 65536) >> 10), t % 1024 + 56320);
	}
	return n;
}, xh = fh ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
if (_h) {
	var Eh = Th("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	vh = function(e, t) {
		return Eh.lastIndex = t, Eh.exec(e)[1] ?? "";
	};
} else vh = function(e, t) {
	for (var n = [];;) {
		var r = Sh(e, t);
		if (r === void 0 || Ah(r) || jh(r)) break;
		n.push(r), t += r >= 65536 ? 2 : 1;
	}
	return bh.apply(void 0, n);
};
var Dh = function() {
	function e(e, t) {
		t === void 0 && (t = {}), this.message = e, this.position = {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			if (i === 123) {
				...
				if (i !== 35 || t !== "plural" && t !== "selectordinal") {
					...
					if (i === 60 && !this.ignoreTag && Oh(this.peek() || 0)) {
						if ((a = this.parseTag(e, t)).err) return a;
						r.push(a.val);
					} else {
						var a;
		...
		if (this.bumpIf(">")) {
			...
			var a = i.val, o = this.clonePosition();
			if (this.bumpIf("</")) {
				if (this.isEOF() || !Oh(this.char())) return this.error(K.INVALID_TAG, J(o, this.clonePosition()));
				var s = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					val: {
						type: q.tag,
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && kh(this.char());) this.bump();
		return this.message.slice(e, this.offset());
	}, e.prototype.parseLiteral = function(e, t) {
		for (var n = this.clonePosition(), r = "";;) {
			var i = this.tryParseQuote(t);
		...
		return this.isEOF() || this.char() !== 60 || !this.ignoreTag && (Oh(e = this.peek() || 0) || e === 47) ? null : (this.bump(), "<");
		var e;
	}, e.prototype.tryParseQuote = function(e) {
		if (this.isEOF() || this.char() !== 39) return null;
		switch (this.peek()) {
		...
		return bh.apply(void 0, t);
	}, e.prototype.tryParseUnquoted = function(e, t) {
		if (this.isEOF()) return null;
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), bh(n));
	}, e.prototype.parseArgument = function(e, t) {
		var n = this.clonePosition();
		...
		var e = this.clonePosition(), t = this.offset(), n = vh(this.message, t), r = t + n.length;
		return this.bumpTo(r), {
			value: n,
		...
		switch (a) {
			...
			case "time":
				...
				if (this.bumpIf(",")) {
					...
					var c = this.clonePosition();
					if ((g = this.parseSimpleArgStyleIfPossible()).err) return g;
					if ((f = wh(g.val)).length === 0) return this.error(K.EXPECT_ARGUMENT_STYLE, J(this.clonePosition(), this.clonePosition()));
					s = {
						style: f,
				...
				if (s && yh(s?.style, "::", 0)) {
					...
					this.locale && (d = function(e, t) {
						for (var n = "", r = 0; r < e.length; r++) {
							...
							if (i === "j") {
								for (var a = 0; r + 1 < e.length && e.charAt(r + 1) === i;) a++, r++;
								var o = 1 + (1 & a), s = a < 2 ? 1 : 3 + (a >> 1), c = sh(t);
								for (c != "H" && c != "k" || (s = 0); s-- > 0;) n += "a";
								for (; o-- > 0;) n = c + n;
							} else n += i === "J" ? "H" : i;
						}
					...
					var f = {
						...
						pattern: d,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? Jm(d) : {}
					};
					return {
						val: {
		...
		try {
			n = function(e) {
				if (e.length === 0) throw Error("Number skeleton cannot be empty");
				for (var t = [], n = 0, r = e.split(Ym).filter(function(e) {
					return e.length > 0;
				}); n < r.length; n++) {
					var i = r[n].split("/");
					if (i.length === 0) throw Error("Invalid number skeleton");
		...
		if (yh(this.message, e, this.offset())) {
			for (var t = 0; t < e.length; t++) this.bump();
			return !0;
		}
		return !1;
		...
		for (; !this.isEOF() && Ah(this.char());) this.bump();
	}, e.prototype.peek = function() {
		if (this.isEOF()) return null;
		var e = this.char(), t = this.offset();
		return this.message.charCodeAt(t + (e >= 65536 ? 2 : 1)) ?? null;
...
function Mh(e) {
	e.forEach(function(e) {
		...
		}(e)) for (var t in e.options) delete e.options[t].location, Mh(e.options[t].value);
		else (function(e) {
			return e.type === q.number;
		})(e) && function(e) {
			return !(!e || typeof e != "object" || e.type !== Wm.number);
		}(e.style) ? delete e.style.location : !function(e) {
			return e.type === q.date;
		}(e) && !function(e) {
			return e.type === q.time;
		}(e) || !function(e) {
			return !(!e || typeof e != "object" || e.type !== Wm.dateTime);
		}(e.style) ? function(e) {
			return e.type === q.tag;
		}(e) && Mh(e.children) : delete e.style.location;
	});
}
function Nh(e) {
	if (Object.prototype.hasOwnProperty.call(e, "__esModule")) return e;
...
function Fh() {
	if (Ph) return Y;
	var e, t;
	return Ph = 1, Object.defineProperty(Y, "__esModule", { value: !0 }), Y.SKELETON_TYPE = Y.TYPE = void 0, Y.isLiteralElement = function(t) {
		return t.type === e.literal;
...
var Ih, Lh = Fh(), Rh = {}, zh = Nh(Gm), Bh = function() {
	if (Ih) return Rh;
	Ih = 1, Object.defineProperty(Rh, "__esModule", { value: !0 }), Rh.printAST = n, Rh.doPrintAST = r, Rh.printDateTimeSkeleton = o;
	var e = zh, t = Fh();
	function n(e) {
		return r(e, !1);
	}
...
function Uh({ icuString: e, shouldVisit: t, visitor: n, options: { recurseIntoVisited: r = !0, ...i } }) {
	let a = function(e, t) {
		t === void 0 && (t = {}), t = G({
			shouldParseSkeletons: !0,
			requiresOtherClause: !0
		}, t);
		var n = new Dh(e, t).parse();
		if (n.err) {
			var r = SyntaxError(K[n.err.kind]);
			throw r.location = n.err.location, r.originalMessage = n.err.message, r;
		}
		return t != null && t.captureLocation || Mh(n.val), n.val;
	}(e, i);
	return o(a), a;
	function o(e) {
		e.map(s);
...
var Wh = "_gt_", Gh = RegExp(`^${Wh}\\d+$`), Kh = RegExp(`^${Wh}$`);
function qh(e) {
	return e.type === Lh.TYPE.select && Gh.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === Lh.TYPE.literal);
}
function Jh(e) {
	return e.type === Lh.TYPE.select && Kh.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === Lh.TYPE.literal);
}
function Yh(e) {
	if (!e.includes("_gt_")) return e;
	let t = [];
...
function Zh(e) {
	return e.includes("_gt_") ? Bh.printAST(Uh({
		icuString: e,
		shouldVisit: qh,
		visitor: function(e) {
			e.type = Lh.TYPE.argument, delete e.options;
		},
		options: { recurseIntoVisited: !1 }
	})) : e;
}
...
var Z = "@generaltranslation/react-core", $h = `${Z} Error: Production environments cannot include an api key.`, eg = `${Z} Error: Fetching batched translations failed`, tg = (e, t) => e ? `${Z} Error: Translation failed for id: ${e}, hash: ${t} ` : `${Z} Error: Translation failed for hash: ${t}`, ng = (e, t) => `${Z} Error: error rendering string ${t ? `for id: "${t}"` : ""} original message: "${e}"`, rg = (e, t, n = "tx") => `${Z} Error: string translation error. ${n}("${e}")${t ? ` with id "${t}"` : ""} could not locate translation.`, ig = (e) => `${Z} Error: Dictionary subtree not found for id: "${e}"`, ag = (e) => `${Z} Error: Invalid ICU string dictionary entry found for id: "${e}"`, og = `${Z} Warning: Translation cloud services require a project ID! Find yours at generaltranslation.com/dashboard.`, sg = (e) => `${Z} Warning: No valid dictionary entry found for id: "${e}"`, cg = `${Z} Warning: A development API key is required for runtime translation!  Find your development API key: generaltranslation.com/dashboard.  (Or, disable this warning message by setting runtimeUrl to an empty string which disables runtime translation.)`, lg = `${Z} Warning: Runtime translation timed out.`, ug = `${Z} Warning: No dictionary was found. Ensure you are either passing your dictionary to the <GTProvider>.`;
function dg(e) {
...
var pg = {
	...
	let { props: t } = e, n = { t: mg(e) };
	if (t["data-_gt"]) {
		let e = t["data-_gt"], r = e.transformation;
		if (r === "variable") {
			let n = e.variableType || "variable", r = Fp(t, n), i = Hh(n);
			return {
				i: e.id,
				k: r,
				v: i
		...
		n.i = e.id, n.d = ((e, t, n) => {
			let r = Object.entries(pg).reduce((e, [n, r]) => (t[r] && (e[n] = t[r]), e), {});
			if (e === "plural" && n) {
				let e = {};
		...
		let i = Object.entries(pg).reduce((e, [n, r]) => (t[r] && (e[n] = t[r]), e), {});
	...
	return t.children && (n.c = _g(t.children)), n;
}, gg = (e) => {
	return n = e, t.isValidElement(n) ? hg(e) : typeof e == "number" ? e.toString() : e;
	var n;
};
function _g(e) {
...
var Cg = (e) => typeof e == "string" || Array.isArray(e), wg = (e) => typeof e == "object" && !!e && !Array.isArray(e);
function Tg(e, t) {
	if (Array.isArray(e)) return e.map((e, n) => Sg(e) ? t[n] : Tg(e, t[n]));
	let n = {
		...Object.fromEntries(Object.entries(e).filter(([, e]) => Cg(e))),
		...Object.fromEntries(Object.entries(t).filter(([, e]) => Cg(e)))
	}, r = Object.entries(e).filter(([, e]) => wg(e)).map(([e]) => e), i = Object.entries(t).filter(([, e]) => wg(e)).map(([e]) => e), a = /* @__PURE__ */ new Set([...r, ...i]);
	for (let r of a) n[r] = Tg(X(e, r) || {}, X(t, r) || {});
	return n;
}
function Eg({ dictionary: e, id: t }) {
	if (t === "") return e;
	let n = e, r = t.split(".");
...
function Og(e, t, n, r) {
	...
	i.forEach((e) => {
		if (function(e) {
			return !!Dg.includes(e);
		}(e)) throw Error(`Invalid key: ${e}`);
	}), t ||= {};
	for (let e of i.slice(0, -1)) X(t, e) ?? Qh(t, e, Array.isArray(X(r, e)) ? [] : {}), t = X(t, e), r = X(r, e);
	Qh(t, i[i.length - 1], e);
}
function kg(e) {
	let t = {};
...
function Ag(e) {
	return function(e) {
		if (Gp(e), Xp) return e.toHex();
		let t = "";
		for (let n = 0; n < e.length; n++) t += Zp[e[n]];
		return t;
	}(cm(function(e) {
		if (typeof e != "string") throw TypeError("string expected");
		return new Uint8Array(new TextEncoder().encode(e));
...
function jg({ source: e, context: t, id: n, maxChars: r, dataFormat: i }, a = Ag) {
	let o;
	return o = i === "JSX" ? Ng(e) : e, a(Up({
		source: o,
		...n && { id: n },
		...t && { context: t },
		...r != null && { maxChars: Math.abs(r) },
...
var Mg = (e) => {
	if (e && typeof e == "object") {
		let t = {};
		if ("c" in e && e.c && (t.c = Ng(e.c)), "d" in e) {
			let n = e?.d;
			n?.b && (t.b = Object.fromEntries(Object.entries(n.b).map(([e, t]) => [e, Ng(t)]))), n?.t && (t.t = n.t);
		}
		return Wp(e) ? {
			k: e.k,
			...e.v && { v: e.v }
...
function Pg(e, t = "") {
	...
	return Object.entries(e).forEach(([r, i]) => {
		let a = t ? `${t}.${r}` : r;
		if (Sg(i)) {
			let { entry: t, metadata: o } = bg(i);
			o?.$_hash || (o ||= {}, o.$_hash = jg({
				source: Yh(t),
...
function Fg(e, t, n) {
	...
	if (!r) throw Error(ig(n));
	if (Sg(r)) throw Error(`${Z} Error: Cannot inject and merge a dictionary entry`);
...
function Ig(e, t, n = "") {
	...
	return Object.entries(e).forEach(([e, i]) => {
		...
		} else r.push(...Ig(i, X(t, e) || (Array.isArray(i) ? [] : {}), a));
	}), r;
}
function Lg(e) {
...
function Bg({ gt: e, locale: t, versionId: n, defaultLocale: r, runtimeUrl: i, renderSettings: a, setTranslations: o, environment: s, ...c }) {
	...
	let S = m(0), C = m(/* @__PURE__ */ new Map()), ee = m(/* @__PURE__ */ new Map()), te = l(async (e) => {
		...
		try {
			...
			e?.name === "AbortError" ? console.warn(lg) : console.warn(eg, e), a.forEach((e) => {
...
function Vg({ gt: e, translations: t, locale: n, defaultLocale: r, translationRequired: i, developmentApiEnabled: a, registerIcuForTranslation: o, environment: s }) {
	function c({ message: t, variables: n, locales: r, fallback: i, id: a, maxChars: o, format: l }) {
		try {
			let a = Xh(i || ""), s = e.formatMessage(Object.keys(a).length ? Zh(t) : t, {
				locales: r,
				variables: {
					...n,
					...a,
			...
			if (s === "production") console.warn(((e, t) => `${Z} Warning: failed to render string ${t ? `for id: "${t}"` : ""} original message: "${e}"`)(t, a), "Error: ", l);
				...
				if (!i) throw Error(`${ng(t, a)} Error: ${l}`);
				console.error(ng(t, a), "Error: ", l);
			}
			return i ? c({
				message: i,
				locales: r,
	...
	let d = (e, t = {}, s) => {
		...
		}), g(e, [r])) : (console.warn(rg(e, d, "gt")), g(e, [r])) : s?.[v] ? g(s?.[v], [n, r], e) : g(e, [r]);
	};
	return {
		_gtFunction: d,
		_mFunction: (e, s = {}, l) => {
			...
			}), b(p, [r])) : l?.[f] ? b(l?.[f], [n, r], p) : b(p, [r]) : (console.warn(rg(p, Rg(e), "m")), b(p, [r]));
		},
...
function Hg(e, t, n, r, i, a, o, s, c, u, d) {
	return l((s, l = {}) => {
		if (!t) return "";
		let f = yg(t, s);
		if (!f) return console.warn(sg(s)), "";
		if (!vg(f)) return console.warn(((e) => `${Z} Warning: Invalid dictionary entry found for id: "${e}"`)(s)), "";
		let { entry: p, metadata: m } = bg(f);
		if (!p || typeof p != "string") return "";
		let { $format: h, ...g } = l, _ = (t, n, r) => {
			try {
				let i = Xh(r || ""), a = e.formatMessage(Object.keys(i).length ? Zh(t) : t, {
					locales: n,
					variables: {
						...g,
						...i,
				...
				if (d === "production") console.warn(((e) => `${Z} Warning: Invalid ICU string dictionary entry found for id: "${e}"`)(s), "Error: ", i);
					...
					if (!r) throw Error(`${ag(s)} Error: ${i}`);
					console.error(ag(s), "Error: ", i);
				}
...
function Ug({ _locale: e, defaultLocale: t, locales: n, ssr: r, localeCookieName: i, customMapping: a, useDetermineLocale: o, enableI18n: s, reloadOnLocaleUpdate: c }) {
...
function Wg({ devApiKey: e, projectId: t, runtimeUrl: n, loadTranslationsType: r, cacheUrl: i, locales: a, environment: o }) {
	d(() => {
		if (o === "production" && e) throw Error($h);
		if (r === "custom" || !i && !n || t || o !== "development" || console.warn(og), t && n && r !== "custom" && !e && o === "development" && console.warn(cg), n === Vp || i === Bp && r === "default") {
			let e = a.filter((e) => !Np(e));
...
async function Gg(e, t) {
	let n = Array.from(/* @__PURE__ */ new Set([e, Xu(e).languageCode]));
	for (let e of n) try {
		let n = await t(e);
		if (n) return n;
	} catch {}
...
function Kg({ _translations: e, translationRequired: t, loadTranslationsType: n, loadTranslations: r, locale: i, cacheUrl: a, projectId: o, _versionId: s, gt: c }) {
...
function qg(e, t, n, r, i, a, o, s, c, u, d, f) {
	return l((o, c, l = {}) => {
		...
		if (!p) return console.warn(sg(c)), {};
		if (Sg(p)) return f(o, l);
		if (!s) return kg(p);
		let m = function({ dictionary: e, id: t, sourceDictionary: n }) {
			if (t === "") return e;
			let r = e, i = n, a = t.split(".");
			for (let e of a) X(r, e) === void 0 && (Array.isArray(X(i, e)) ? Qh(r, e, []) : Qh(r, e, {})), r = X(r, e);
			return r;
		}({
			dictionary: t,
			id: c,
			sourceDictionary: t
		}), { dictionary: h, updateDictionary: g } = Pg(structuredClone(p), c), _ = Ig(h, m, c), { dictionary: v, updateDictionary: y } = function(e, t, n, r, i = "") {
			let a = !1, o = i ? i.split(".") : [];
			return r.forEach(({ metadata: r }) => {
				let { $_hash: i, $id: s } = r, c = o.length > 0 ? s.split(".").slice(o.length).join(".") : s, l = yg(t, c), u;
				Sg(l) && (u = bg(l).entry);
				let d = n[i] || u;
				d && (Og(d, t, c, e), a = !0);
			}), {
			...
			return n.forEach(({ source: n, metadata: r }) => {
				let { $id: a } = r, o = i.length > 0 ? a.split(".").slice(i.length).join(".") : a, s = yg(t, o), c;
				Sg(s) && (c = bg(s).entry), Og(c || n, t, o, e);
			}), t;
...
function Jg({ enableI18n: e }) {
	let [t] = h(e);
	return { enableI18n: t };
}
function Yg() {
	throw dg("isSSREnabled");
}
function Xg({}) {
	throw dg("useDetermineLocale");
}
function Zg({}) {
	throw dg("useRegionState");
}
function Qg({ children: e, config: t, environment: n = "production", projectId: r = t?.projectId || "", devApiKey: a = t?.devApiKey || "", _versionId: o = t?._versionId, dictionary: s = t?.dictionary || {}, locales: c = t?.locales || [], defaultLocale: l = t?.defaultLocale || Ip, cacheUrl: u = t?.cacheUrl || Bp, runtimeUrl: f = t?.runtimeUrl || Vp, renderSettings: m = t?.renderSettings || xg(n), ssr: g = t?.ssr || Yg(), localeCookieName: v = t?.localeCookieName || "generaltranslation.locale", locale: y = "", region: b, loadDictionary: x, loadTranslations: S, fallback: C, translations: ee = null, customMapping: te = t?.customMapping, enableI18n: w = t?.enableI18n === void 0 || t.enableI18n, enableI18nLoaded: T, reloadOnLocaleUpdate: ne, useEnableI18n: re = Jg, readAuthFromEnv: ie = fg, useDetermineLocale: ae = Xg, useRegionState: oe = Zg, ...se }) {
	y &&= $u(y, te);
	let { projectId: ce, devApiKey: le } = ie({
		...
		ssr: g
	}), { locale: E, setLocale: de, locales: fe, translationRequired: pe, dialectTranslationRequired: me } = Ug({
		_locale: y,
		defaultLocale: l,
		locales: c,
		ssr: g,
		...
		return d(() => {
			...
			let e = !0;
			return (async () => {
				let t = await Gg(i, n) || {}, a = await Gg(r, n) || {};
				e && o(t || {}), e && c(a || {});
			})(), () => {
				e = !1;
			};
	...
	let { translations: Ce, setTranslations: we } = Kg({
		_translations: ee,
		...
		_versionId: o,
		gt: _e
	}), { registerIcuForTranslation: Te, registerJsxForTranslation: Ee, developmentApiEnabled: De } = Bg({
		gt: _e,
		locale: E,
		versionId: o,
		defaultLocale: l,
		...
		environment: n,
		...se
	}), { _gtFunction: Oe, _mFunction: ke, _filterMessagesForPreload: Ae, _preloadMessages: je } = Vg({
		gt: _e,
		translations: Ce,
		locale: E,
		defaultLocale: l,
		...
		environment: n
	}), Me = Hg(_e, ye, xe, Ce, E, l, pe, me, De, Te, n), Ne = qg(ye || {}, xe || {}, be, Se, Ce, E, l, pe, me, De, Te, Me), Pe = !(pe && !Ce || !E);
	return _(zg.Provider, {
		value: {
			gt: _e,
			registerIcuForTranslation: Te,
...
function $g({ projectId: e, devApiKey: t }) {
	try {
		return {
			projectId: e || "",
			devApiKey: t || void 0
...
function e_({ _region: e, regionCookieName: t }) {
...
function t_({ _region: e, ssr: t, regionCookieName: n }) {
	let [r, i] = h(t ? void 0 : e_({
		_region: e,
		regionCookieName: n
	}));
	return d(() => {
...
function n_({ enableI18n: e, enableI18nCookieName: t, enableI18nLoaded: n, ssr: r }) {
...
var i_ = function(e, t) {
	return i_ = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, i_(e, t);
...
function a_(e, t) {
	...
	i_(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var o_ = function() {
...
var __ = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function v_(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || __(t, e, n);
}
function y_(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function x_() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(b_(arguments[t]));
	return e;
}
function S_() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function w_(e) {
	return this instanceof w_ ? (this.v = e, this) : new w_(e);
}
function T_(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var r, i = n.apply(e, t || []), a = [];
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof w_ ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function D_(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = y_(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var k_ = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return A_ = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, A_(e);
...
function j_(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = A_(e), r = 0; r < n.length; r++) n[r] !== "default" && __(t, e, n[r]);
	return k_(t, e), t;
}
function M_(e) {
	return e && e.__esModule ? e : { default: e };
...
var L_ = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function R_(e) {
	function t(t) {
		e.error = e.hasError ? new L_(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var B_, V_, H_, U_, W_ = Object.freeze({
	__proto__: null,
	__addDisposableResource: I_,
	get __assign() {
		return o_;
	},
	__asyncDelegator: E_,
	...
	__await: w_,
	__awaiter: h_,
	__classPrivateFieldGet: N_,
	__classPrivateFieldIn: F_,
	__classPrivateFieldSet: P_,
	__createBinding: __,
	__decorate: c_,
	__disposeResources: R_,
	__esDecorate: u_,
	__exportStar: v_,
	__extends: a_,
	__generator: g_,
	...
	__runInitializers: d_,
	__setFunctionName: p_,
	__spread: x_,
	__spreadArray: C_,
	__spreadArrays: S_,
	__values: y_,
...
try {
	(U_ = (/* @__PURE__ */ RegExp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu")).exec("a")) == null || U_[0];
} catch {}
function G_(e) {
	if (Object.prototype.hasOwnProperty.call(e, "__esModule")) return e;
	var t = e.default;
...
function q_() {
	if (K_) return Q;
	var e, t;
	return K_ = 1, Object.defineProperty(Q, "__esModule", { value: !0 }), Q.SKELETON_TYPE = Q.TYPE = void 0, Q.isLiteralElement = function(t) {
		return t.type === e.literal;
...
(function() {
	if (J_) return Y_;
	J_ = 1, Object.defineProperty(Y_, "__esModule", { value: !0 }), Y_.printAST = n, Y_.doPrintAST = r, Y_.printDateTimeSkeleton = o;
	var e = X_, t = q_();
	function n(e) {
		return r(e, !1);
	}
...
var iv = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = ev(this.buffer);
	}
	update(e) {
		Q_(this), Z_(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		Q_(this), function(e, t) {
			Z_(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, $_(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = ev(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), sv = /* @__PURE__ */ new Uint32Array(64), cv = class extends iv {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) sv[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = sv[e - 15], n = sv[e - 2], r = tv(t, 7) ^ tv(t, 18) ^ t >>> 3, i = tv(n, 17) ^ tv(n, 19) ^ n >>> 10;
			sv[e] = i + sv[e - 7] + r + sv[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (tv(o, 6) ^ tv(o, 11) ^ tv(o, 25)) + nv(o, s, c) + ov[e] + sv[e] | 0, u = (tv(n, 2) ^ tv(n, 13) ^ tv(n, 22)) + rv(n, r, i) | 0;
			l = c, c = s, s = o, o = a + t | 0, a = i, i = r, r = n, n = t + u | 0;
		}
		n = n + this.A | 0, r = r + this.B | 0, i = i + this.C | 0, a = a + this.D | 0, o = o + this.E | 0, s = s + this.F | 0, c = c + this.G | 0, l = l + this.H | 0, this.set(n, r, i, a, o, s, c, l);
	}
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), $_(this.buffer);
	}
}, lv = class extends cv {
	A = 0 | av[0];
	B = 0 | av[1];
...
})(() => new lv(), (uv = 1, { oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
var dv = function(e, t) {
	return dv = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, dv(e, t);
...
function fv(e, t) {
	...
	dv(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var pv = function() {
...
var wv = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function Tv(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || wv(t, e, n);
}
function Ev(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function Ov() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(Dv(arguments[t]));
	return e;
}
function kv() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function jv(e) {
	return this instanceof jv ? (this.v = e, this) : new jv(e);
}
function Mv(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var r, i = n.apply(e, t || []), a = [];
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof jv ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function Pv(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = Ev(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var Iv = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return Lv = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, Lv(e);
...
function Rv(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = Lv(e), r = 0; r < n.length; r++) n[r] !== "default" && wv(t, e, n[r]);
	return Iv(t, e), t;
}
function zv(e) {
	return e && e.__esModule ? e : { default: e };
...
var Wv = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function Gv(e) {
	function t(t) {
		e.error = e.hasError ? new Wv(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var qv, Jv, Yv, Xv, Zv = Object.freeze({
	__proto__: null,
	__addDisposableResource: Uv,
	get __assign() {
		return pv;
	},
	__asyncDelegator: Nv,
...
try {
	(Xv = function(e, t) {
		return new RegExp(e, t);
	}("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")) == null || Xv[0];
} catch {}
var Qv, $v, $ = {};
function ey() {
	return Qv || (Qv = 1, Object.defineProperty($, "__esModule", { value: !0 }), $.SKELETON_TYPE = $.TYPE = void 0, $.isLiteralElement = function(t) {
		return t.type === e.literal;
...
(function() {
	if ($v) return ty;
	$v = 1, Object.defineProperty(ty, "__esModule", { value: !0 }), ty.printAST = n, ty.doPrintAST = r, ty.printDateTimeSkeleton = o;
	var e = ny, t = ey();
	function n(e) {
		return r(e, !1);
	}
...
var ry = "gt-react";
function iy({ locale: e = "", defaultLocale: t = "en", locales: n = [], localeCookieName: r = "generaltranslation.locale", ssr: i = !0, customMapping: a, enableI18n: o, reloadOnLocaleUpdate: s = !1 }) {
	let c = p(() => $u(e, a), [e, a]), l = p(() => n.map((e) => $u(e, a)), [n, a]), [u, f] = h(() => o ? $u(i ? c && Qu(c, l, a) || "" : ay({
		_locale: c,
		locale: c,
		locales: l,
		defaultLocale: t,
		...
		let c = (r) => {
			if (!o) return n;
			if (r === e) return e;
			let s = $u(Qu(r, t, a) || e || n, a);
			return s !== r && console.warn(((e, t, n = "@generaltranslation/react-core") => `${n} Warning: "${t}" is not a supported locale. Update supported locales in your dashboard or gt.config.json. Falling back to "${e}".`)(s, r, ry)), i(s), s;
		};
		return [(t) => {
			if (!o) return;
			t = $u(t);
...
function ay({ _locale: e, locale: t, locales: n, defaultLocale: r, localeCookieName: i, customMapping: a, enableI18n: o }) {
	if (!o) return r;
	if (e && e === t && Qu(e, n, a) === t) return $u(e, a);
	...
	return l &&= $u(l, a), s && s !== l && typeof document < "u" && (document.cookie = `${i}=${l};path=/`), l;
}
function oy(e) {
	return _(Qg, Object.assign({
		ssr: !(typeof process > "u" || !process.env.NEXT_RUNTIME) || (globalThis == null ? void 0 : globalThis.__NEXT_DATA__) !== void 0,
		environment: "development"
	}, e, {
		readAuthFromEnv: $g,
		useDetermineLocale: iy,
		useRegionState: t_,
		useEnableI18n: n_
	}));
}
var sy = y().server(function({ defaultLocale: e, locales: t, customMapping: n }) {
	let r = [], i = b(jp);
	...
	return r.length === 0 && process.env._GENERALTRANSLATION_IGNORE_BROWSER_LOCALES === "false" && console.warn("gt-tanstack-start(server): no locales could be determined for this request"), Qu(r, t, n) || e;
	...
	return a && r.push(a), r.length === 0 && (console.warn("gt-tanstack-start(client): no locales could be determined for this request"), r.push(e)), Qu(r, t, n) || e;
}), cy = class extends ld {
...
function uy(e) {
	Rd(new ly(Object.assign(Object.assign({}, e), { storeAdapter: new cy() })));
}
var dy = { exports: {} }, fy, py, my = {};
function hy() {
	return fy || (fy = 1, function() {
		function e(t) {
...
function yy(e) {
	return e.locale ? e.locale : _y() ? vy() : void 0;
}
function by() {
	let e = Ld();
	if (!function(e) {
...
function xy(e) {
	let t = by().getProviderConfig();
	return gy.jsx(oy, Object.assign({ ssr: _y() }, t, e, {
...
async function Cy(e, t = ["shared"]) {
	let n = {};
	return await Promise.all(t.map(async (t) => {
		let r = Sy[`./src/_gt/${e}/${t}.json`];
		if (!r) {
...
var wy = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/scripts/Wrapper.tsx";
uy({
	...S,
	loadTranslations: Cy
});
...
var Ey = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/pages/settings/ApiAccessSection.wrapper.tsx";
function Dy() {
	return v(Ty, { children: v(yo, {}, void 0, !1, {
		fileName: Ey,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
