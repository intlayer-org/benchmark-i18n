import e, { Children as t, Fragment as n, cloneElement as r, createContext as i, createElement as a, isValidElement as o, useContext as s, useEffect as c, useId as l, useMemo as u, useRef as d, useSyncExternalStore as f } from "react";
...
function Js() {
	...
	return m("section", {
		...
		children: [p("h2", {
			...
			children: p(Z, { children: "API Access" })
		}), m("div", { children: [
			p("label", {
				htmlFor: e,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: p(Z, { children: "API Key" })
			}),
			m("div", {
				...
				children: [p("input", {
					...
					children: p(Z, { children: "Copy" })
				})]
			}),
			p("p", {
				className: "mt-1 text-xs text-muted-foreground",
				children: p(Z, { children: "Use this key to access the benchmarking API programmatically." })
			})
		] })]
	});
}
