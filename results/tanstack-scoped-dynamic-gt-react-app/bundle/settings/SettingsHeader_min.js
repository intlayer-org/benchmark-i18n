...
import { createIsomorphicFn as y } from "@tanstack/react-start";
import { getCookie as b, getRequestHeader as x } from "@tanstack/react-start/server";
import S from "../../../../gt.config.json";
var C = Object.defineProperty, ee = Object.getOwnPropertyDescriptor, te = Object.getOwnPropertyNames, w = Object.prototype.hasOwnProperty, T = (e, t, n) => () => {
	if (n) throw n[0];
	try {
		return e && (t = e(e = 0)), t;
	} catch (e) {
	...
	return e;
}, ae = (e) => w.call(e, "module.exports") ? e["module.exports"] : ie(C({}, "__esModule", { value: !0 }), e), oe = class extends Error {
	constructor(e, t, n) {
...
function It(e, t, n) {
	...
	for (let r of e) switch (r.type) {
		...
		case D.date:
		case D.time: {
			let e = Lt(t.variables, r.value), n = r.type === D.date ? Mt : Pt;
			i(Bt(t, typeof r.style == "string" ? n[r.style] : r.style?.type === et.dateTime ? r.style.parsedOptions : r.type === D.time ? Pt.medium : void 0).format(e));
			break;
		}
		case D.select: {
...
var Xt = RegExp(`^${Yt}$`);
function Zt(e) {
	return e.type === D.select && Xt.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === D.literal);
}
function Qt(e) {
	let t = e;
...
var wn = (e, t, n) => {
	...
	try {
		...
		return !(e.split("-").length !== i || O.get("DisplayNames", ["en"], { type: "language" }).of(t) === t && !Dn(t) || n && O.get("DisplayNames", ["en"], { type: "region" }).of(n) === n || r && O.get("DisplayNames", ["en"], { type: "script" }).of(r) === r && !En.has(r));
	} catch {
		return !1;
	}
}, kn = (e) => {
...
function jn(...e) {
	try {
		let t = e.flat().map((e) => O.get("Locale", kn(e))), [n] = t, r = new Set(t.map(({ region: e }) => e).filter(Boolean)), i = new Set(t.map(({ script: e }) => e).filter(Boolean));
...
function zn(e, t) {
	...
	e = Rn(e, t);
	try {
		let r = kn(e), i = O.get("Locale", r), { language: a, region: o } = i;
		if (t) for (let i of [
			n,
			e,
			r,
...
function Xn(e, t = "en", n) {
	...
	e = Rn(e, n), t ||= "en";
	try {
		let i = kn(e), a = O.get("Locale", e), o = a.language, s = Yn([
			r,
			e,
			i,
			o
...
function nr(e, t) {
	try {
		let { language: n, region: r, script: i } = O.get("Locale", kn(e)), { language: a, region: o, script: s } = O.get("Locale", kn(t));
...
var { getConditionStore: Pi, setConditionStore: Fi } = Ni(E({
	source: "gt-i18n",
	severity: "Error",
...
var { getConditionStore: Ki, setConditionStore: qi, isConditionStoreInitialized: Ji } = Ni(E({
	source: "@generaltranslation/react-core",
	severity: "Error",
	...
	function i({ source: i, target: a, locales: o = ["en"], enableI18n: s }) {
		...
		if (Array.isArray(a) && !Array.isArray(i) && i && (i = [i]), Array.isArray(i) && Array.isArray(a)) {
			...
			return a.map((i, a) => {
				...
				if (Qt(i)) return g(t.Fragment, { children: e({
					variableType: i.v || "v",
					variableValue: n[i.k],
...
var Oa = Ea;
function ka(e) {
	let t = k().isDevHotReloadEnabled(), n = wa(), r = /* @__PURE__ */ new Map();
	return d(() => {
...
function Ga(e) {
	let t = wa(), n = Ta(), r = Oa(), i = h((n) => t.subscribeToTranslate(e, n), () => t.getTranslateSnapshot(e, n), () => t.getTranslateSnapshot(e, n));
...
function _o({ children: e, _locale: t, _enableI18n: n, _renderPreparedT: r = Ya, ...i }) {
	...
	if (k().isDevHotReloadEnabled() && f == null && m.current != null && d) return m.current;
	let h = r({
...
var vo = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/MockBanner.tsx", yo = () => v("div", {
	className: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground",
	children: v(go, { children: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." }, void 0, !1, {
		fileName: vo,
		lineNumber: 5,
		columnNumber: 5
	}, void 0)
	...
	lineNumber: 4,
	columnNumber: 3
}, void 0), bo = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/pages/settings/SettingsHeader.tsx";
function xo() {
	return v(_, { children: [
		v(yo, {}, void 0, !1, {
			fileName: bo,
		...
		v("h1", {
			...
			children: v(go, { children: "Settings" }, void 0, !1, {
				fileName: bo,
				lineNumber: 9,
				columnNumber: 9
			}, this)
		...
		v("p", {
			...
			children: v(go, { children: "Manage your account preferences and configuration." }, void 0, !1, {
				fileName: bo,
				lineNumber: 12,
				columnNumber: 9
			}, this)
...
var So = 6e4, Co = (e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`, wo = "DEFAULT_TERMINATOR_KEY", To = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	constructor(e, t = {}) {
		...
		if (!To[t.style ?? "ellipsis"]) throw Error(Co(t.style ?? "ellipsis"));
		let n, r;
		if (t.maxChars !== void 0) {
			n = t.style ?? "ellipsis";
			let e = new Intl.Locale(this.locale).language;
			r = To[n][e] || To[n].DEFAULT_TERMINATOR_KEY;
		}
	...
	get(e, ...t) {
		...
		return a === void 0 && (a = new Do[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}(), Oo = "https://cdn.gtx.dev", ko = {
	GTJSON: ["GTJSON"],
	JSON: ["JSON"],
	PO: ["PO"],
	POT: ["POT", "PO"],
...
function jo(e) {
	...
	if (!Ao(e.fileFormat, e.transformFormat)) return `Unsupported file format transform: ${e.fileFormat} -> ${e.transformFormat}`;
}
function Mo(e) {
	for (let t of e) {
		let e = jo(t);
...
function Fo(e) {
	...
	if (Array.isArray(e)) {
		let t = "[";
		for (let n = 0; n < e.length; n++) n && (t += ","), t += Fo(e[n]) || "null";
		return t + "]";
	}
	let t = Object.keys(e).sort(), n = "";
	for (let r of t) {
...
var Ro = re({
	...
	__classPrivateFieldIn: () => ds,
	__classPrivateFieldSet: () => us,
	__createBinding: () => gs,
	__decorate: () => Vo,
	__disposeResources: () => ps,
	__esDecorate: () => Uo,
	__exportStar: () => Xo,
	__extends: () => zo,
	__generator: () => Yo,
	...
	__read: () => Qo,
	__rest: () => Bo,
	__rewriteRelativeImportExtension: () => ms,
	__runInitializers: () => Wo,
	__setFunctionName: () => Ko,
	__spread: () => $o,
	__spreadArray: () => ts,
	__spreadArrays: () => es,
	__values: () => Zo,
...
function Xo(e, t) {
	for (var n in e) n !== "default" && !Object.prototype.hasOwnProperty.call(t, n) && gs(t, e, n);
}
function Zo(e) {
...
function ns(e) {
	return this instanceof ns ? (this.v = e, this) : new ns(e);
}
function rs(e, t, n) {
	...
	function l(e) {
		e.value instanceof ns ? Promise.resolve(e.value.v).then(u, d) : f(a[0][2], e);
	}
	function u(e) {
		c("next", e);
	}
...
function as(e) {
	...
	return t ? t.call(e) : (e = typeof Zo == "function" ? Zo(e) : e[Symbol.iterator](), n = {}, r("next"), r("throw"), r("return"), n[Symbol.asyncIterator] = function() {
		return this;
	}, n);
	function r(t) {
		n[t] = e[t] && function(n) {
...
function ss(e) {
	...
	var t = {};
	if (e != null) for (var n = vs(e), r = 0; r < n.length; r++) n[r] !== "default" && gs(t, e, n[r]);
	return _s(t, e), t;
}
function cs(e) {
...
function ps(e) {
	function t(t) {
		e.error = e.hasError ? new ys(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	function i() {
...
var hs, j, gs, _s, vs, ys, bs, xs = T((() => {
	hs = function(e, t) {
	...
	}, gs = Object.create ? (function(e, t, n, r) {
		r === void 0 && (r = n);
		...
		return vs = Object.getOwnPropertyNames || function(e) {
			var t = [];
			for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
			return t;
		}, vs(e);
	}, ys = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
		var r = Error(n);
...
function Ms(e) {
	return !!(e && typeof e == "object" && e.type === Ss.number);
}
function Ns(e) {
	return !!(e && typeof e == "object" && e.type === Ss.dateTime);
}
var Ps = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, Fs = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Is(e) {
	var t = {};
...
function Rs(e) {
	...
	for (var t = e.split(Ls).filter(function(e) {
		return e.length > 0;
...
var Bs = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, Vs = /^(@+)?(\+|#+)?[rs]?$/g, Hs = /(\*)(0+)|(#+)(0+)|(0+)/g, Us = /^(0+)$/;
function Ws(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(Vs, function(e, n, r) {
...
function Ks(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !Us.test(e)) throw Error("Malformed concise eng/scientific notation");
	...
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "KK":
				...
				continue;
			case "scientific":
				t = j(j(j({}, t), { notation: "scientific" }), i.options.reduce(function(e, t) {
					return j(j({}, e), qs(t));
				}, {}));
				continue;
			case "engineering":
				t = j(j(j({}, t), { notation: "engineering" }), i.options.reduce(function(e, t) {
					return j(j({}, e), qs(t));
				}, {}));
				continue;
			case "notation-simple":
			...
			case "integer-width":
				...
				i.options[0].replace(Hs, function(e, n, r, i, a, o) {
		...
		if (Bs.test(i.stem)) {
			...
			i.stem.replace(Bs, function(e, n, r, i, a, o) {
			...
			var a = i.options[0];
			a === "w" ? t = j(j({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = j(j({}, t), Ws(a)));
			continue;
		}
		if (Vs.test(i.stem)) {
			t = j(j({}, t), Ws(i.stem));
...
function Xs(e, t) {
	for (var n = "", r = 0; r < e.length; r++) {
		...
		if (i === "j") {
			...
			var o = 1 + (a & 1), s = a < 2 ? 1 : 3 + (a >> 1), c = "a", l = Zs(t);
...
function Zs(e) {
	...
	var n = e.language, r;
	return n !== "root" && (r = e.maximize().region), (Ys[r || ""] || Ys[n || ""] || Ys[`${n}-001`] || Ys["001"])[0];
}
xs();
var Qs = RegExp(`^${Ps.source}*`), $s = RegExp(`${Ps.source}*\$`);
function P(e, t) {
	return {
		start: e,
		end: t
...
var ec = !!String.prototype.startsWith && "_a".startsWith("a", 1), tc = !!String.fromCodePoint, nc = !!Object.fromEntries, rc = !!String.prototype.codePointAt, ic = !!String.prototype.trimStart, ac = !!String.prototype.trimEnd, oc = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, sc = !0;
try {
	sc = mc("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	sc = !1;
}
var cc = ec ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, lc = tc ? String.fromCodePoint : function() {
	...
	return t;
}, uc = nc ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
var hc;
if (sc) {
	var gc = mc("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	hc = function(e, t) {
		return gc.lastIndex = t, gc.exec(e)[1] ?? "";
	};
} else hc = function(e, t) {
	for (var n = [];;) {
		var r = dc(e, t);
		if (r === void 0 || xc(r) || Sc(r)) break;
		n.push(r), t += r >= 65536 ? 2 : 1;
	}
	return lc.apply(void 0, n);
};
var _c = function() {
	function e(e, t) {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			} else if (i === 60 && !this.ignoreTag && vc(this.peek() || 0)) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !vc(this.char())) return this.error(M.INVALID_TAG, P(o, this.clonePosition()));
				...
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					...
					err: null
				} : this.error(M.INVALID_TAG, P(o, this.clonePosition()))) : this.error(M.UNMATCHED_CLOSING_TAG, P(s, this.clonePosition()));
			}
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && bc(this.char());) this.bump();
		...
		return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !yc(this.peek() || 0)) ? (this.bump(), "<") : null;
		...
		return lc.apply(void 0, t);
	}, e.prototype.tryParseUnquoted = function(e, t) {
		if (this.isEOF()) return null;
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), lc(n));
	}, e.prototype.parseArgument = function(e, t) {
		var n = this.clonePosition();
		if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(M.EXPECT_ARGUMENT_CLOSING_BRACE, P(n, this.clonePosition()));
		if (this.char() === 125) return this.bump(), this.error(M.EMPTY_ARGUMENT, P(n, this.clonePosition()));
		var r = this.parseIdentifierIfPossible().value;
		if (!r) return this.error(M.MALFORMED_ARGUMENT, P(n, this.clonePosition()));
		if (this.bumpSpace(), this.isEOF()) return this.error(M.EXPECT_ARGUMENT_CLOSING_BRACE, P(n, this.clonePosition()));
		switch (this.char()) {
			...
			case 44: return this.bump(), this.bumpSpace(), this.isEOF() ? this.error(M.EXPECT_ARGUMENT_CLOSING_BRACE, P(n, this.clonePosition())) : this.parseArgumentOptions(e, t, r, n);
			default: return this.error(M.MALFORMED_ARGUMENT, P(n, this.clonePosition()));
		}
	}, e.prototype.parseIdentifierIfPossible = function() {
		var e = this.clonePosition(), t = this.offset(), n = hc(this.message, t), r = t + n.length;
		...
		switch (a) {
			case "": return this.error(M.EXPECT_ARGUMENT_TYPE, P(i, o));
			case "number":
			case "date":
			case "time":
				this.bumpSpace();
				...
				if (this.bumpIf(",")) {
					...
					if (l.err) return l;
					var u = pc(l.val);
					if (u.length === 0) return this.error(M.EXPECT_ARGUMENT_STYLE, P(this.clonePosition(), this.clonePosition()));
					s = {
						style: u,
						styleLocation: P(c, this.clonePosition())
					};
				}
				...
				if (s && cc(s?.style, "::", 0)) {
					...
					var m = p;
					this.locale && (m = Xs(p, this.locale));
					var u = {
						type: Ss.dateTime,
						pattern: m,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? Is(m) : {}
					};
					return {
						val: {
			...
			case "select":
				...
				if (this.bumpSpace(), !this.bumpIf(",")) return this.error(M.EXPECT_SELECT_ARGUMENT_OPTIONS, P(h, j({}, h)));
				this.bumpSpace();
				var g = this.parseIdentifierIfPossible(), _ = 0;
				if (a !== "select" && g.value === "offset") {
					if (!this.bumpIf(":")) return this.error(M.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, P(this.clonePosition(), this.clonePosition()));
					this.bumpSpace();
			...
			default: return this.error(M.INVALID_ARGUMENT_TYPE, P(i, o));
		}
	}, e.prototype.tryParseArgumentClose = function(e) {
		return this.isEOF() || this.char() !== 125 ? this.error(M.EXPECT_ARGUMENT_CLOSING_BRACE, P(e, this.clonePosition())) : (this.bump(), {
			val: !0,
			err: null
		});
		...
		for (var e = 0, t = this.clonePosition(); !this.isEOF();) switch (this.char()) {
			case 39:
				this.bump();
				var n = this.clonePosition();
				if (!this.bumpUntil("'")) return this.error(M.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, P(n, this.clonePosition()));
				this.bump();
				break;
			case 123:
				e += 1, this.bump();
		...
		for (var i, a = !1, o = [], s = /* @__PURE__ */ new Set(), c = r.value, l = r.location;;) {
			if (c.length === 0) {
				...
				if (t !== "select" && this.bumpIf("=")) {
					...
					if (d.err) return d;
					l = P(u, this.clonePosition()), c = this.message.slice(u.offset, this.offset());
				} else break;
			}
			...
			if (!this.bumpIf("{")) return this.error(t === "select" ? M.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT : M.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT, P(this.clonePosition(), this.clonePosition()));
			...
			o.push([c, {
				value: p.val,
				location: P(f, this.clonePosition())
			}]), s.add(c), this.bumpSpace(), i = this.parseIdentifierIfPossible(), c = i.value, l = i.location;
		}
		return o.length === 0 ? this.error(t === "select" ? M.EXPECT_SELECT_ARGUMENT_SELECTOR : M.EXPECT_PLURAL_ARGUMENT_SELECTOR, P(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !a ? this.error(M.MISSING_OTHER_CLAUSE, P(this.clonePosition(), this.clonePosition())) : {
			val: o,
			err: null
		};
		...
		if (cc(this.message, e, this.offset())) {
		...
		for (; !this.isEOF() && xc(this.char());) this.bump();
...
function Cc(e) {
	e.forEach(function(e) {
		if (delete e.location, Os(e) || ks(e)) for (var t in e.options) delete e.options[t].location, Cc(e.options[t].value);
		else Ts(e) && Ms(e.style) || (Es(e) || Ds(e)) && Ns(e.style) ? delete e.style.location : js(e) && Cc(e.children);
	});
}
function wc(e, t) {
	t === void 0 && (t = {}), t = j({
	...
	var n = new _c(e, t).parse();
	if (n.err) {
		var r = SyntaxError(M[n.err.kind]);
		throw r.location = n.err.location, r.originalMessage = n.err.message, r;
	}
	return t?.captureLocation || Cc(n.val), n.val;
}
var Tc = ne(((e) => {
	...
	Object.defineProperty(e, "__esModule", { value: !0 }), xs(), ae(Ro), Tc();
})), Dc = Tc();
Ec();
function Oc({ icuString: e, shouldVisit: t, visitor: n, options: { recurseIntoVisited: r = !0, ...i } }) {
	let a = wc(e, i);
	return o(a), a;
	function o(e) {
		e.map(s);
	...
	function s(e) {
		let i = !1;
		t(e) && (n(e), i = !0), (!i || r) && (e.type === N.select || e.type === N.plural ? Object.values(e.options).map((e) => e.value).map(o) : e.type === N.tag && o(e.children));
	}
}
var kc = "_gt_";
RegExp(`^${kc}\\d+$`);
var Ac = RegExp(`^${kc}$`);
function jc(e) {
	return e.type === Dc.TYPE.select && Ac.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === Dc.TYPE.literal);
}
function Mc(e) {
	if (!e.includes("_gt_")) return e;
	let t = [];
...
function Nc(e, t) {
	var n = t && t.cache ? t.cache : Uc, r = t && t.serializer ? t.serializer : Vc;
...
function Rc(e, t) {
	var n = e.length === 1 ? Fc : Ic;
	return Lc(e, this, n, t.cache.create(), t.serializer);
}
function zc(e, t) {
	return Lc(e, this, Ic, t.cache.create(), t.serializer);
}
function Bc(e, t) {
	return Lc(e, this, Fc, t.cache.create(), t.serializer);
}
var Vc = function() {
...
var Kc = function(e) {
	...
	zo(t, e);
	function t(t, n, r, i) {
		return e.call(this, `Invalid values for "${t}": "${n}". Options are "${Object.keys(r).join("\", \"")}"`, Gc.INVALID_VALUE, i) || this;
	}
	return t;
}(Kc), Jc = function(e) {
	zo(t, e);
	function t(t, n, r) {
		return e.call(this, `Value for "${t}" must be of type ${n}`, Gc.INVALID_VALUE, r) || this;
	}
	return t;
}(Kc), Yc = function(e) {
	zo(t, e);
	function t(t, n) {
		return e.call(this, `The intl string context variable "${t}" was not provided to the string "${n}"`, Gc.MISSING_VALUE, n) || this;
	}
	return t;
}(Kc), F;
(function(e) {
...
function Qc(e, t, n, r, i, a, o) {
	...
	for (var s = [], c = 0, l = e; c < l.length; c++) {
		...
		if (Es(u)) {
			var p = typeof u.style == "string" ? r.date[u.style] : Ns(u.style) ? u.style.parsedOptions : void 0;
			s.push({
				type: F.literal,
		...
		if (Ds(u)) {
			var p = typeof u.style == "string" ? r.time[u.style] : Ns(u.style) ? u.style.parsedOptions : r.time.medium;
			s.push({
				type: F.literal,
				value: n.getDateTimeFormat(t, p).format(f)
			});
		...
		if (Ts(u)) {
			var p = typeof u.style == "string" ? r.number[u.style] : Ms(u.style) ? u.style.parsedOptions : void 0;
		...
		if (js(u)) {
			...
			if (!Zc(g)) throw new Jc(h, "function", o);
		...
		if (Os(u)) {
			...
			if (!v) throw new qc(u.value, f, Object.keys(u.options), o);
		...
		if (ks(u)) {
			var v = u.options[`=${f}`];
			if (!v) {
				if (!Intl.PluralRules) throw new Kc("Intl.PluralRules is not available in this environment.\nTry polyfilling it using \"@formatjs/intl-pluralrules\"\n", Gc.MISSING_INTL_API, o);
...
function nl(e) {
	return e === void 0 && (e = {
		...
		getNumberFormat: Nc(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.NumberFormat).bind.apply(e, ts([void 0], t, !1)))();
		}, {
			cache: tl(e.number),
			strategy: Wc.variadic
		}),
		getDateTimeFormat: Nc(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.DateTimeFormat).bind.apply(e, ts([void 0], t, !1)))();
		}, {
			cache: tl(e.dateTime),
			strategy: Wc.variadic
		}),
		getPluralRules: Nc(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.PluralRules).bind.apply(e, ts([void 0], t, !1)))();
		}, {
			cache: tl(e.pluralRules),
			strategy: Wc.variadic
		})
	};
}
var rl = function() {
	function e(t, n, r, i) {
		...
		if (this.formatterCache = {
			...
			var n = t.reduce(function(e, t) {
				return !e.length || t.type !== F.literal || typeof e[e.length - 1] != "string" ? e.push(t.value) : e[e.length - 1] += t.value, e;
			}, []);
			...
			var o = i || {};
			o.formatters;
			var s = Bo(o, ["formatters"]);
			this.ast = e.__parse(t, j(j({}, s), { locale: this.resolvedLocale }));
		} else this.ast = t;
		if (!Array.isArray(this.ast)) throw TypeError("A message must be provided as a String or AST.");
		this.formats = el(e.formats, r), this.formatters = i && i.formatters || nl(this.formatterCache);
	}
	...
	"Toto",
	"Thai"
], al = (e) => e >= "qaa" && e <= "qtz", I = (e, t) => {
	t?.[e] && typeof t[e] == "object" && "code" in t[e] && t[e].code && (e = t[e].code);
	try {
		let { language: t, region: n, script: r } = A.get("Locale", e);
		return !(e.split("-").length !== (() => {
			let e = 1;
			return n && (e += 1), r && (e += 1), e;
		})() || A.get("DisplayNames", ["en"], { type: "language" }).of(t) === t && !al(t) || n && A.get("DisplayNames", ["en"], { type: "region" }).of(n) === n || r && A.get("DisplayNames", ["en"], { type: "script" }).of(r) === r && !il.includes(r));
	} catch {
		return !1;
	}
}, L = (e) => {
...
function ol(e, t) {
	let { language: n, region: r, script: i } = A.get("Locale", e), { language: a, region: o, script: s } = A.get("Locale", t);
	return !(n !== a || r && o && r !== o || i && s && i !== s);
}
function sl(...e) {
	try {
		let t = e.flat().map(L);
		for (let e = 0; e < t.length; e++) for (let n = e + 1; n < t.length; n++) if (!ol(t[e], t[n])) return !1;
		return !0;
	} catch (e) {
		return console.error(e), !1;
	}
...
function cl(...e) {
	try {
		let t = e.flat().map((e) => A.get("Locale", e).language);
		return t.every((e) => e === t[0]);
	} catch (e) {
		return console.error(e), !1;
	}
...
function ll(e, t, n, r) {
	return !(!I(e, r) || !I(t, r) || n && n.some((e) => !I(e, r)) || sl(e, t) || n && !n.some((e) => cl(t, e)));
}
var ul = (e, t, n) => {
	if (e?.[t]) return typeof e[t] == "string" ? n === "name" ? e[t] : void 0 : e[t][n];
}, dl = (e, t) => !!(t?.[e] && typeof t[e] == "object" && "code" in t[e] && t[e].code && I(t[e].code));
function fl(e, t) {
	let n = e;
	t && dl(e, t) && (e = t[e].code);
	try {
		let r = L(e), i = A.get("Locale", r), { language: a, region: o } = i;
		if (t) for (let i of [
			n,
			e,
			r,
		...
		if (s) return s;
		let c = i.maximize();
		return gl[c.language] || bl(c.region || "");
	} catch {
		return hl;
	}
}
var pl = "🌍", ml = "🌏", hl = pl, gl = {
	...
	EU: "🇪🇺",
	419: "🌎"
}, vl = /* @__PURE__ */ new Set(/* @__PURE__ */ "AF.AX.AL.DZ.AS.AD.AO.AI.AQ.AG.AR.AM.AW.AU.AT.AZ.BS.BH.BD.BB.BY.BE.BZ.BJ.BM.BT.BO.BQ.BA.BW.BV.BR.IO.BN.BG.BF.BI.CV.KH.CM.CA.KY.CF.TD.CL.CN.CX.CC.CO.KM.CD.CG.CK.CR.CI.HR.CU.CW.CY.CZ.DK.DJ.DM.DO.EC.EG.SV.GQ.ER.EE.SZ.ET.FK.FO.FJ.FI.FR.GF.PF.TF.GA.GM.GE.DE.GH.GI.GR.GL.GD.GP.GU.GT.GG.GN.GW.GY.HT.HM.VA.HN.HK.HU.IS.IN.ID.IR.IQ.IE.IM.IL.IT.JM.JP.JE.JO.KZ.KE.KI.KP.KR.KW.KG.LA.LV.LB.LS.LR.LY.LI.LT.LU.MO.MG.MW.MY.MV.ML.MT.MH.MQ.MR.MU.YT.MX.FM.MD.MC.MN.ME.MS.MA.MZ.MM.NA.NR.NP.NL.NC.NZ.NI.NE.NG.NU.NF.MK.MP.NO.OM.PK.PW.PS.PA.PG.PY.PE.PH.PN.PL.PT.PR.QA.RE.RO.RU.RW.BL.SH.KN.LC.MF.PM.VC.WS.SM.ST.SA.SN.RS.SC.SL.SG.SX.SK.SI.SB.SO.ZA.GS.SS.ES.LK.SD.SR.SJ.SE.CH.SY.TW.TJ.TZ.TH.TL.TG.TK.TO.TT.TN.TR.TM.TC.TV.UG.UA.AE.GB.US.UM.UY.UZ.VU.VE.VN.VG.VI.WF.EH.YE.ZM.ZW".split(".")), yl = 127397;
function bl(e) {
	return xl(e) || "🌍";
}
function xl(e) {
	let t = e.toUpperCase(), n = _l[t];
	if (n) return n;
	if (vl.has(t)) return String.fromCodePoint(t.charCodeAt(0) + yl, t.charCodeAt(1) + yl);
}
function Sl(e, t) {
	if (t) {
		let n = {};
...
function Cl(e, t = "en", n) {
	let r = e;
	n && dl(e, n) && (e = n[e].code), t ||= "en";
	try {
		let i = L(e), a = A.get("Locale", e), o = a.language, s = Sl([
			r,
			e,
			i,
			o
			...
			t,
			"en"
		], g = A.get("DisplayNames", m, { type: "language" }), _ = A.get("DisplayNames", h, { type: "language" }), v = s?.name, y = s?.nativeName || s?.name, b = v || g.of(e) || e, x = y || _.of(e) || e, S = s?.maximizedName || v || g.of(u) || e, C = s?.nativeMaximizedName || y || _.of(u) || e, ee = s?.minimizedName || v || g.of(p) || e, te = s?.nativeMinimizedName || y || _.of(p) || e, w = s?.languageName || v || g.of(o) || e, T = s?.nativeLanguageName || y || _.of(o) || e, ne = s?.nameWithRegionCode || c ? `${w} (${c})` : b, re = s?.nativeNameWithRegionCode || (c ? `${T} (${c})` : x) || ne, ie = A.get("DisplayNames", m, { type: "region" }), ae = A.get("DisplayNames", h, { type: "region" }), oe = s?.regionName || (d ? ie.of(d) : "") || "", se = s?.nativeRegionName || (d ? ae.of(d) : "") || "", ce = A.get("DisplayNames", m, { type: "script" }), le = A.get("DisplayNames", h, { type: "script" });
		return {
			code: i,
			name: b,
			nativeName: x,
			...
			scriptName: s?.scriptName || (f ? ce.of(f) : "") || "",
			nativeScriptName: s?.nativeScriptName || (f ? le.of(f) : "") || "",
			emoji: s?.emoji || fl(i, n)
		};
	} catch {
		let t = I(e) ? L(e) : e, r = t?.split("-"), i = r?.[0] || t || "", a = r.length > 2 ? r?.[2] : r?.[1] || "", o = r?.[3] || "", s = Sl([t, i], n);
		t = s?.code || t;
		let c = s?.name || t, l = s?.nativeName || c, u = s?.maximizedCode || t, d = s?.maximizedName || c, f = s?.nativeMaximizedName || l, p = s?.minimizedCode || t, m = s?.minimizedName || c, h = s?.nativeMinimizedName || l;
		i = s?.languageCode || i;
		let g = s?.languageName || c, _ = s?.nativeLanguageName || l;
...
function wl(e, t, n) {
	typeof e == "string" && (e = [e]), e = e.filter((e) => I(e, n)).map(L), t = t.filter((e) => I(e, n)).map(L);
	for (let n of e) {
		let e = t.filter((e) => cl(n, e)), r = ({ locale: t, languageCode: n, minimizedCode: r, regionCode: i, scriptCode: a }) => {
			let o = [
				t,
				`${n}-${i}`,
				`${n}-${a}`,
...
var kl = class {
	...
	handle(e) {
		let t = [];
		this.config.includeTimestamp && t.push(`[${e.timestamp.toISOString()}]`);
		let n = El[e.level], r = `[${e.level.toUpperCase()}]`;
		t.push(`${n}${r}${Dl}`), this.config.prefix && t.push(`[${this.config.prefix}]`), this.config.includeContext && e.context && t.push(`[${e.context}]`), t.push(e.message), e.metadata && Object.keys(e.metadata).length > 0 && t.push(`\n  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
		let i = t.join(" ");
		switch (e.level) {
			case "debug":
				console.debug(i);
	...
	constructor(e = {}) {
		this.config = {
			...
			handlers: [],
			...e
		}, this.handlers = [...this.config.handlers || []], this.config.enableConsole && this.handlers.push(new kl(this.config));
	}
	addHandler(e) {
		this.handlers.push(e);
	}
	...
	shouldLog(e) {
		return Tl[e] >= Tl[this.config.level];
	}
	log(e, t, n, r) {
		if (!this.shouldLog(e)) return;
		let i = {
...
Ml.child("validation"), Ml.child("formatting"), Ml.child("locale");
var Pl = Ml.child("GT instance");
function Fl({ value: e, locales: t = "en", options: n = {} }) {
	return A.get("CutoffFormat", t, n).format(e);
}
function Il(e, t = "en", n = {}) {
	return new rl(e, t).format(n)?.toString() ?? "";
}
function Ll(e) {
	return e;
}
function Rl({ value: e, locales: t = ["en"], options: n = {} }) {
	return A.get("NumberFormat", t, {
		numberingSystem: "latn",
		...n
	}).format(e);
}
function zl({ value: e, locales: t = ["en"], options: n = {} }) {
	return A.get("DateTimeFormat", t, {
		calendar: "gregory",
		numberingSystem: "latn",
		...n
	}).format(e);
}
function Bl({ value: e, locales: t = ["en"], currency: n = "USD", options: r = {} }) {
	return A.get("NumberFormat", t, {
		style: "currency",
		currency: n,
		numberingSystem: "latn",
...
function Vl({ value: e, locales: t = ["en"], options: n = {} }) {
	return A.get("ListFormat", t, {
		type: "conjunction",
		style: "long",
		...n
	}).format(e);
}
function Hl({ value: e, locales: t = ["en"], options: n = {} }) {
	let r = A.get("ListFormat", t, {
		type: "conjunction",
		style: "long",
		...n
	}).formatToParts(e.map(() => "1")), i = 0;
...
function Wl({ date: e, baseDate: t, locales: n = ["en"], options: r = {} }) {
	let { value: i, unit: a } = Ul(e, t);
	return Gl({
		value: i,
		unit: a,
		locales: n,
...
function Gl({ value: e, unit: t, locales: n = ["en"], options: r = {} }) {
	return A.get("RelativeTimeFormat", n, {
		style: "long",
		numeric: "auto",
		...r
	}).format(e, t);
...
function Kl(e, t = "en", n) {
	...
	try {
		...
		if (n) for (let t of [
			...
			e,
			i,
			A.get("Locale", i).language
		]) {
			let e = ul(n, t, "name");
			if (e) return e;
		}
		return A.get("DisplayNames", [
			t,
			i,
			"en"
		], { type: "language" }).of(i) || "";
...
function ql(e) {
	try {
		let t = Xl(A.get("Locale", e));
		if (t) return t;
	} catch {}
	let { scriptCode: t, languageCode: n } = Cl(e);
	return t ? Zl(t) ? "rtl" : "ltr" : n && Ql(n) ? "rtl" : "ltr";
}
...
function Ql(e) {
	return e ? Yl.has(e.toLowerCase()) : !1;
}
function $l(e, t) {
	try {
		let { language: n, region: r, script: i } = A.get("Locale", L(e)), { language: a, region: o, script: s } = A.get("Locale", L(t));
		return !(n !== a || r && r !== o || i && i !== s);
	} catch (e) {
		return console.error(e), !1;
	}
...
var nu = class {
	...
	formatMessage(e, t, n = {}) {
		let { locales: r, variables: i, dataFormat: a } = n;
		return a === "STRING" ? Ll(e) : Il(e, this.getFormattingLocales(t, r), i);
	}
	formatList(e, t, n = {}) {
		let { locales: r, ...i } = n;
		return Vl({
	...
	getLocaleName(e) {
		return Kl(e, this.defaultLocale, this.customMapping);
	}
	getLocaleEmoji(e) {
		return fl(e, this.customMapping);
	}
	getLocaleProperties(e) {
		return Cl(e, this.defaultLocale, this.customMapping);
	}
	requiresTranslation(e, t = this.defaultLocale, n = this.translationLocales) {
		return ll(this.resolveCanonicalLocale(t), this.resolveCanonicalLocale(e), n ? this.resolveCanonicalLocaleList(n) : void 0, this.customMapping);
	}
	determineLocale(e, t = this.locales) {
		let n = t.map((e) => ({
			locale: e,
			canonicalLocale: this.resolveCanonicalLocale(e)
		})), r = wl(Array.isArray(e) ? this.resolveCanonicalLocaleList(e) : this.resolveCanonicalLocale(e), n.map(({ canonicalLocale: e }) => e), this.customMapping);
		if (r) return n.find(({ canonicalLocale: e }) => e === r)?.locale || this.resolveAliasLocale(r);
	}
	getLocaleDirection(e) {
		return ql(this.resolveCanonicalLocale(e));
	}
	isValidLocale(e) {
		return I(e, this.customMapping);
	}
	resolveCanonicalLocale(e) {
		return tu(e, this.customMapping);
	}
	resolveAliasLocale(e) {
	...
	isSameLanguage(...e) {
		return cl(...this.resolveCanonicalLocaleArgs(e));
	}
	isSupersetLocale(e, t) {
		return $l(this.resolveCanonicalLocale(e), this.resolveCanonicalLocale(t));
	}
};
function ru(e, t) {
	return I(e, t);
...
function lu({ source: e, context: t, id: n, maxChars: r, dataFormat: i }, a = cu) {
	let o;
	return o = i === "JSX" ? du(e) : e, a(Io({
		source: o,
		...n && { id: n },
		...t && { context: t },
		...r != null && { maxChars: Math.abs(r) },
...
var uu = (e) => {
	if (e && typeof e == "object") {
		let t = {};
		if ("c" in e && e.c && (t.c = du(e.c)), "d" in e) {
			let n = e?.d;
			n?.b && (t.b = Object.fromEntries(Object.entries(n.b).map(([e, t]) => [e, du(t)]))), n?.t && (t.t = n.t);
		}
		return Lo(e) ? {
			k: e.k,
			...e.v && { v: e.v }
...
function du(e) {
	return Array.isArray(e) ? e.map(uu) : uu(e);
}
var fu = "GT Error:", pu = (e) => `${fu} Translation request timed out after ${e}ms.`, mu = (e) => `${fu} Translation request failed. Error: ${e}`, hu = (e, t, n) => `${fu} API returned error status. Status: ${e}, Status Text: ${t}, Error: ${n}`, R = (e) => `${fu} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a targetLocale in the GT constructor.`, gu = (e) => `${fu} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a sourceLocale in the GT constructor.`, _u = (e) => `${fu} Cannot call \`${e}\` without a specified project ID. Either pass a project ID to the \`${e}\` function or specify a projectId in the GT constructor.`, vu = (e) => `${fu} Cannot call \`${e}\` without a specified API key. Either pass an API key to the \`${e}\` function or specify an apiKey in the GT constructor.`, yu = (e) => `${fu} Invalid locale: ${e}.`, bu = (e) => `${fu} Invalid locales: ${e.join(", ")}.`;
async function xu(e, t, n) {
	...
	try {
		...
		throw e instanceof Error && e.name === "AbortError" ? pu(n) : e;
	} finally {
		a && clearTimeout(a);
	}
}
async function Su(e) {
	if (!e.ok) {
		...
		throw new su(hu(e.status, e.statusText, t), e.status, t);
	}
}
function Cu(e, t) {
	...
	let n = mu(e instanceof Error ? e.message : String(e));
	throw Nl.error(n), e;
}
...
async function Au(e, t, n, r) {
	let i = Array.isArray(e), a = i ? [] : void 0, o = {}, s = i ? e.map((e) => [void 0, e]) : Object.entries(e);
	for (let [e, t] of s) {
		let { source: n, metadata: r } = typeof t == "string" ? { source: t } : t, i = e ?? r?.hash ?? lu({
			source: n,
			dataFormat: r?.dataFormat ?? "STRING",
			...r ?? {}
		});
...
function Ru(e, t = "en", n) {
	...
	try {
		return {
			code: e,
			name: A.get("DisplayNames", [t, "en"], { type: "region" }).of(e) || e,
			emoji: bl(e),
			...n?.[e]
		};
	} catch {
...
async function Bu(e, t, n) {
	return Mo(e.map(({ source: e }) => e)), Nu(e, async (e) => (await z(n, "/v2/project/files/upload-translations", {
		body: {
...
async function Hu(e, t, n) {
	let { baseUrl: r } = n, i = t.timeout ? t.timeout : So, a = `${r || "https://api2.gtx.dev"}/v2/project/info/${encodeURIComponent(e)}`, o;
	try {
		o = await xu(a, {
			method: "GET",
			headers: Tu(n)
...
var Zu = class {
	...
	setConfig({ apiKey: e, devApiKey: t, sourceLocale: n, targetLocale: r, locales: i, projectId: a, customMapping: o, baseUrl: s }) {
		if (e && (this.apiKey = e), t && (this.devApiKey = t), a && (this.projectId = a), n && (this.sourceLocale = L(n), !I(this.sourceLocale, o))) throw Error(yu(this.sourceLocale));
		if (r && (this.targetLocale = L(r), !I(this.targetLocale, o))) throw Error(yu(this.targetLocale));
		if (i) {
			let e = [], t = [];
			if (i.forEach((n) => {
				let r = L(n);
		...
		s && (this.baseUrl = s), o && (this.customMapping = o, this.reverseCustomMapping = Object.fromEntries(Object.entries(o).filter(([, e]) => e && typeof e == "object" && "code" in e).map(([e, t]) => [t.code, e]))), this._localeConfig = new nu({
			defaultLocale: this.sourceLocale,
			locales: this.locales ?? [],
			customMapping: this.customMapping
		});
	...
	async enqueueFiles(e, t) {
		...
		if (!n.sourceLocale) {
			...
			throw Pl.error(e), Error(e);
		}
		if (!n.targetLocales || n.targetLocales.length === 0) {
			let e = R("enqueueFiles");
			throw Pl.error(e), Error(e);
		}
		return n = {
			...n,
	...
	requiresTranslation(e = this.sourceLocale, t = this.targetLocale, n = this.locales, r = this.customMapping) {
		...
		return r === this.customMapping ? this.localeConfig.requiresTranslation(t, e, n) : ll(e, t, n, r);
	}
	determineLocale(e, t = this.locales || [], n = this.customMapping) {
		return n === this.customMapping ? this.localeConfig.determineLocale(e, t ?? []) : wl(e, t, n);
	}
	getLocaleDirection(e = this.targetLocale) {
	...
	resolveCanonicalLocale(e = this.targetLocale, t = this.customMapping) {
		...
		return t === this.customMapping ? this.localeConfig.resolveCanonicalLocale(e) : tu(e, t);
	}
	resolveAliasLocale(e, t = this.customMapping) {
		if (!e) throw Error(R("resolveAliasLocale"));
		return t === this.customMapping ? this.localeConfig.resolveAliasLocale(e) : eu(e, t);
	}
	standardizeLocale(e = this.targetLocale) {
...
function rd(e, t = "", n = !0) {
	if (e.forEach((e) => {
		switch (e.type) {
			case "error":
				ou.error(t + e.message);
				break;
			case "warning": ou.warn(t + e.message);
		}
...
function gd(e) {
	let { cacheUrl: t = Oo, projectId: n, _versionId: r, _branchId: i } = e, a = r ? `/${r}` : "", o = i ? `?branchId=${i}` : "";
...
function vd({ type: e, remoteTranslationLoaderParams: t, loadTranslations: n }) {
	e === "disabled" && ou.warn("I18nManager: No translation loader found. No translations will be loaded.");
...
var jd = 12e3, Md = class extends kd {
	constructor(e) {
		super(), this.resolveTranslationSync = (e, t = {}) => this.lookupTranslation(e, t), rd(ud(e), "I18nManager: "), this.config = Nd(e), this.localeConfig = new nu({
	...
	getLocale() {
		return this.storeAdapter.getItem("locale") || (ou.warn("getLocale() invoked outside of translation context, falling back to default locale"), this.config.defaultLocale);
	}
	setLocale(e) {
		try {
	...
	async getLookupTranslation(e = this.getLocale(), t = []) {
		try {
			...
			r.length !== t.length && ou.warn(`I18nManager: getLookupTranslation(): prefetchEntries must all be the same locale, ignoring all entries that are not for ${n}`);
			let i = this.localesCache.get(n);
	...
	handleError(e) {
		switch (this.config.environment) {
			...
			default: ou.error("I18nManager: " + e);
		}
	}
	resolveLocale(e) {
...
function Fd(e) {
	return {
		defaultLocale: au(e.defaultLocale),
		locales: e.locales.map((t) => (typeof e.customMapping?.[t] == "string" ? e.customMapping?.[t] : e.customMapping?.[t]?.code) ? t : au(t)),
		customMapping: Object.fromEntries(Object.entries(e.customMapping || {}).map(([e, t]) => [e, typeof t == "string" ? au(t) : {
			...t,
			...t.code ? { code: au(t.code) } : {}
		}]))
	};
}
function Id(e, t, n) {
...
var Rd = void 0;
function zd() {
	return Rd ||= (ou.warn("getI18nManager(): Translation failed because I18nManager not initialized."), new Md({
		defaultLocale: "en",
		locales: ["en"]
	})), Rd;
}
...
function e_({ children: e, config: t, environment: n = "production", projectId: r = t?.projectId || "", devApiKey: a = t?.devApiKey || "", _versionId: o = t?._versionId, dictionary: s = t?.dictionary || {}, locales: c = t?.locales || [], defaultLocale: l = t?.defaultLocale || Rp, cacheUrl: u = t?.cacheUrl || Hp, runtimeUrl: p = t?.runtimeUrl || Up, renderSettings: h = t?.renderSettings || Cg(n), ssr: _ = t?.ssr || Zg(), localeCookieName: v = t?.localeCookieName || "generaltranslation.locale", locale: y = "", region: b, loadDictionary: x, loadTranslations: S, fallback: C, translations: ee = null, customMapping: te = t?.customMapping, enableI18n: w = t?.enableI18n === void 0 || t.enableI18n, enableI18nLoaded: T, reloadOnLocaleUpdate: ne, useEnableI18n: re = Xg, readAuthFromEnv: ie = mg, useDetermineLocale: ae = Qg, useRegionState: oe = $g, ...se }) {
	y &&= td(y, te);
	let { projectId: ce, devApiKey: le } = ie({
		...
		ssr: _
	}), { locale: E, setLocale: de, locales: fe, translationRequired: pe, dialectTranslationRequired: me } = Gg({
		_locale: y,
		defaultLocale: l,
		locales: c,
		ssr: _,
	...
	let { translations: Ce, setTranslations: we } = Jg({
		_translations: ee,
		...
		_versionId: o,
		gt: _e
	}), { registerIcuForTranslation: Te, registerJsxForTranslation: Ee, developmentApiEnabled: De } = Hg({
		gt: _e,
		locale: E,
		versionId: o,
		defaultLocale: l,
		...
		environment: n,
		...se
	}), { _gtFunction: Oe, _mFunction: ke, _filterMessagesForPreload: Ae, _preloadMessages: je } = Ug({
		gt: _e,
		translations: Ce,
		locale: E,
		defaultLocale: l,
		...
		environment: n
	}), Me = Wg(_e, ye, xe, Ce, E, l, pe, me, De, Te, n), Ne = Yg(ye || {}, xe || {}, be, Se, Ce, E, l, pe, me, De, Te, Me), Pe = !(pe && !Ce || !E);
	return g(Vg.Provider, {
		value: {
			gt: _e,
			registerIcuForTranslation: Te,
...
function oy({ locale: e = "", defaultLocale: t = "en", locales: n = [], localeCookieName: r = "generaltranslation.locale", ssr: i = !0, customMapping: a, enableI18n: o, reloadOnLocaleUpdate: s = !1 }) {
	let c = f(() => td(e, a), [e, a]), l = f(() => n.map((e) => td(e, a)), [n, a]), [u, p] = m(() => o ? td(i ? c && ed(c, l, a) || "" : sy({
		_locale: c,
		locale: c,
		locales: l,
		defaultLocale: t,
...
var ly = y().server(function({ defaultLocale: e, locales: t, customMapping: n }) {
	let r = [], i = b(Np);
	if (i && r.push(i), process.env._GENERALTRANSLATION_IGNORE_BROWSER_LOCALES === "false") {
		let e = x("accept-language")?.split(",").map((e) => e.split(";")?.[0].trim()) || [];
		e && r.push(...e);
	}
...
var Oy = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/gt-react-app/src/components/pages/settings/SettingsHeader.wrapper.tsx";
function ky() {
	return v(Dy, { children: v(xo, {}, void 0, !1, {
		fileName: Oy,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
