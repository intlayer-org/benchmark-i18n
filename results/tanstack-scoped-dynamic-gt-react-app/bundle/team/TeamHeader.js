...
function TeamHeader() {
	return jsxs(Fragment$1, { children: [
		...
		jsx("h1", {
			...
			children: jsx(a$2, { children: "Our Team" })
		}),
		jsx("p", {
			className: "mb-10 text-muted-foreground",
			children: jsx(a$2, { children: "Meet the people behind i18n Benchmark. A diverse team united by a shared passion for great developer tools." })
		})
	] });
}
