...
var ce = (e) => {
...
}, Ge = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? q : {
	id: "insertion-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "insertion",
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: N }], i = e[N], a = {
...
}, Ke = q, qe = q, Q = /* @__PURE__ */ new Map(), Je = (e, t = !0) => {
	...
	return Q.set(n, r), r;
}, Ye = (e, t) => Le(e, t, Je(typeof t == "object" && t ? t.locale : t)), Xe = S(x), Ze = (e, t) => re(e, {
	...x,
	isCookieEnabled: t
}), Qe = () => {
	...
	if (l) return Ye(l, c);
	let u = e;
	return Ye(le(`${String(t)}.${c}`, u[c]?.()), c);
}, ot = () => {
	let e = at(w, "mock-banner");
	return l("div", {
