...
var ce = (e) => {
...
}, Pe = (e, t) => typeof t == "function" && Me.includes(e?.nodeType ?? "") ? (n) => Ne(e, t, n) : t, Fe = K, Z = K, Ie = (e) => K, Le = K, Re = (e, t = !0) => [
	q(e ?? p.defaultLocale, t ? p.defaultLocale : void 0),
	J,
	Y(e ?? p.defaultLocale),
	X,
	je,
	Ie(e ?? p.defaultLocale),
	Le,
	Fe,
	Z
	...
	return $.set(n, r), r;
}, Qe = (e, t) => Be(e, t, Ze(typeof t == "object" && t ? t.locale : t)), $e = re, et = (e, t) => ie(e, {
	...S,
	isCookieEnabled: t
}), tt = () => {
	...
	let { locales: f, defaultLocale: m } = p ?? {}, [h, g] = c(() => e ?? $e() ?? t ?? m), [_, v] = c(e);
	e !== _ && (v(e), e && e !== h && g(e)), o(() => {
		tt();
	}, []);
	let y = i((e) => {
	...
	if (l) return Qe(l, c);
	let u = e;
	return Qe(le(`${String(t)}.${c}`, u[c]?.()), c);
}, ot = () => {
	let e = at(O, "mock-banner");
	return u("div", {
