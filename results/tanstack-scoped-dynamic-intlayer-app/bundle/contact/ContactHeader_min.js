...
var b = {
	...
	en: () => import("./intlayer-ContactHeader-wrapper-bha9no-en-lhtocvUd.js").then((e) => e.n).then((e) => e.default),
...
var de = (e) => {
	...
	en: () => import("./intlayer-ContactHeader-wrapper-bha9no-en-lhtocvUd.js").then((e) => e.t).then((e) => e.default),
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/intlayer-app/src/components/pages/contact/ContactHeader.tsx";
function mt() {
	let e = lt(C, "contact-header");
	return f(d, { children: [
		f(pt, {}, void 0, !1, {
			fileName: $,
			lineNumber: 9,
...
var _t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/intlayer-app/src/components/pages/contact/ContactHeader.wrapper.tsx";
function vt() {
