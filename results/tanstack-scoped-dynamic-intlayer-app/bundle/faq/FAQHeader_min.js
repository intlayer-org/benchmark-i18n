...
var b = {
	...
	de: () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/de.json").then((e) => e.default),
	en: () => import("./intlayer-FAQHeader-wrapper-1rju7l-en-C6KWPLyJ.js").then((e) => e.n).then((e) => e.default),
	es: () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/es.json").then((e) => e.default),
	fr: () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/fr.json").then((e) => e.default),
	it: () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/it.json").then((e) => e.default),
	ja: () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/ja.json").then((e) => e.default),
	ko: () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/ko.json").then((e) => e.default),
	pt: () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/pt.json").then((e) => e.default),
	ru: () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/ru.json").then((e) => e.default),
	zh: () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header1/zh.json").then((e) => e.default)
}, w = S(), T = C[w];
...
var de = (e) => {
	...
	en: () => import("./intlayer-FAQHeader-wrapper-1rju7l-en-C6KWPLyJ.js").then((e) => e.t).then((e) => e.default),
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/intlayer-app/src/components/pages/faq/FAQHeader.tsx";
function mt() {
	let e = lt(C, "faq-header1");
	return f(d, { children: [
		f(pt, {}, void 0, !1, {
			fileName: $,
			lineNumber: 9,
...
var _t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/intlayer-app/src/components/pages/faq/FAQHeader.wrapper.tsx";
function vt() {
