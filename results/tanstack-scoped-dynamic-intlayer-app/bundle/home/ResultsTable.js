...
var content = {
	...
	"en": () => import("./intlayer-ResultsTable-wrapper-u9g6cm-en-Dj_diPyW.js").then((n) => n.t).then((m) => m.default),
...
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/intlayer-app/src/components/pages/home/ResultsTable.tsx";
function ResultsTable() {
	const content$1 = useDictionaryDynamic(content, "results-table");
	const results = [
		{
			lib: "react-i18next",
			size: content$1.c({ val: "42.3" }),
			time: content$1.h({ val: "0.12" }),
			lazy: content$1.j.value
		},
		{
			lib: "react-intl",
			size: content$1.c({ val: "38.1" }),
			time: content$1.h({ val: "0.15" }),
			lazy: content$1.g.value
		},
		{
			lib: "lingui",
			size: content$1.c({ val: "12.8" }),
			time: content$1.h({ val: "0.08" }),
			lazy: content$1.j.value
		},
		{
			lib: "typesafe-i18n",
			size: content$1.c({ val: "5.2" }),
			time: content$1.h({ val: "0.05" }),
			lazy: content$1.a.value
		}
	];
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/intlayer-app/src/components/pages/home/ResultsTable.wrapper.tsx";
function Wrapped() {
