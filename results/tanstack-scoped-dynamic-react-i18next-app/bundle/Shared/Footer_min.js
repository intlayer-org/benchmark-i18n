...
var I = (e) => !p(e) && typeof e != "boolean" && typeof e != "number", L = class e extends P {
	constructor(e, t = {}) {
		super(), g([
			"resourceStore",
			"languageUtils",
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			}), i.trim())), e = e.replace(r[0], H(h(i))), this.regexp.lastIndex = 0;
		}
		return e;
	}
}, ce = (e) => {
	...
	init(e, t = { interpolation: {} }) {
		...
		let n = t.cacheInBuiltFormats ? W : le;
		this.formats = {
			number: n((e, t) => {
...
}), K = (e) => (p(e.ns) && (e.ns = [e.ns]), p(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), p(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), q = () => {}, pe = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, J = class e extends P {
	constructor(e = {}, t) {
		if (super(), this.options = K(e), this.services = {}, this.logger = N, this.modules = { external: [] }, pe(this), t && !this.isInitialized && !e.isClone) {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/react-i18next-app/src/components/Footer.tsx";
function Le() {
	let { t: e } = Fe("shared"), t = l({ strict: !1 }).locale ?? "en", n = [
		{
...
function We(e = "en") {
	...
	return t.use(Oe).use(Ve((e, t) => Re(Object.assign({
...
var Je = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/react-i18next-app/src/components/Footer.wrapper.tsx";
function Ye() {
	return u(qe, { children: u(Le, {}, void 0, !1, {
		fileName: Je,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
