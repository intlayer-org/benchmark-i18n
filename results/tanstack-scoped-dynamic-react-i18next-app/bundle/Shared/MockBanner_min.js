...
var R = (e) => !d(e) && typeof e != "boolean" && typeof e != "number", z = class e extends N {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			b(n.loaded, [i], a), se(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), le = (e) => (d(e.ns) && (e.ns = [e.ns]), d(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), d(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), J = () => {}, ue = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Y = class e extends N {
	constructor(e = {}, t) {
		if (super(), this.options = le(e), this.services = {}, this.logger = M, this.modules = { external: [] }, ue(this), t && !this.isInitialized && !e.isClone) {
...
var de = (e, t, n, r) => {
	...
	Q(n) && fe[n] || (Q(n) && (fe[n] = /* @__PURE__ */ new Date()), de(e, t, n, r));
}, pe = (e, t) => () => {
	...
	d && !d.reportNamespaces && (d.reportNamespaces = new De()), d || X(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next or by passing it via props or context. In monorepo setups, make sure there is only one instance of react-i18next.");
	let f = a(() => ({
		...xe(),
		...d?.options?.react,
		...t
	...
	let v = o(0), y = n((e) => {
		...
		f,
		t.lng
	]), [S, C] = s(0), { t: w, ready: T } = (0, ke.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
...
function Ne({ i18n: e, defaultNS: n, children: r }) {
	let i = a(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
