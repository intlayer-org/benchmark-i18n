...
var L = (e) => !p(e) && typeof e != "boolean" && typeof e != "number", oe = class e extends P {
	constructor(e, t = {}) {
		super(), g([
			"resourceStore",
			"languageUtils",
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new se(W());
	...
	cloneInstance(t = {}, n = K) {
		...
		return a.translator = new oe(a.services, i), a.translator.on("*", (e, ...t) => {
			a.emit(e, ...t);
...
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/react-i18next-app/src/components/pages/about/AboutHeader.tsx";
function ze() {
	let { t: e } = Ie("about");
	return Re("AboutHeader"), u(l, { children: [u("h1", {
...
function Ge(e = "en") {
	...
	return t.use(ke).use(He((e, t) => Be(Object.assign({
...
var Ye = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/react-i18next-app/src/components/pages/about/AboutHeader.wrapper.tsx";
function Xe() {
	return u(Je, { children: u(ze, {}, void 0, !1, {
		fileName: Ye,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
