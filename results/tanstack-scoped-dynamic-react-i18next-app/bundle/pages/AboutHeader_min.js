...
var ze = (e, t, n) => {
	...
	return {
		...
		init: function(e, t, n) {},
		read: function(t, n, r) {
			if (!Ve(t, !1) || !Ve(n, !0)) return r(/* @__PURE__ */ Error("i18next-resources-to-backend: unsafe language/namespace value"), !1);
...
function Ge(e = "en") {
	...
	return t.use(Oe).use(He((e, t) => ze(Object.assign({
