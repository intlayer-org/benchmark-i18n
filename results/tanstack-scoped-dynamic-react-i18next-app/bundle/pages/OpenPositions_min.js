...
var R = (e) => !f(e) && typeof e != "boolean" && typeof e != "number", ie = class e extends N {
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			}), i.trim())), e = e.replace(r[0], V(m(i))), this.regexp.lastIndex = 0;
		}
		return e;
	}
}, ce = (e) => {
...
var me = (e, t, n, r) => {
	...
	Z(n) && J[n] || (Z(n) && (J[n] = /* @__PURE__ */ new Date()), me(e, t, n, r));
}, he = (e, t) => () => {
...
}, _e = (e, t, n = {}) => !t.languages || !t.languages.length ? (Y(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Z = (e) => typeof e == "string", ve = (e) => typeof e == "object" && !!e, ye = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, be = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (Z(t)) return t;
		if (ve(t) && Z(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: c } = t, { i18n: l, defaultNS: u } = r(Oe) || {}, d = c || l || Ee();
	d && !d.reportNamespaces && (d.reportNamespaces = new ke()), d || Y(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next or by passing it via props or context. In monorepo setups, make sure there is only one instance of react-i18next.");
	let f = a(() => ({
		...Ce(),
		...d?.options?.react,
		...t
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/react-i18next-app/src/components/pages/careers/OpenPositions.tsx";
function Ie() {
	let { t: e } = Pe("careers"), t = [{
...
function Ue(e = "en") {
	...
	return t.use(De).use(Be((e, t) => Le(Object.assign({
...
var We = Ue(), Ge = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/react-i18next-app/scripts/Wrapper.tsx";
...
var qe = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-scoped-dynamic/react-i18next-app/src/components/pages/careers/OpenPositions.wrapper.tsx";
function Je() {
	return l(Ke, { children: l(Ie, {}, void 0, !1, {
		fileName: qe,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
