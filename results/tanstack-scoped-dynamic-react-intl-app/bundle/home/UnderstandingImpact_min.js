	...
	return a("section", {
		...
		children: [
			i("h2", {
				...
				children: i($, { id: "understanding-impact.understandingTheImpact" })
			}),
			a("div", {
				...
				children: [
					i("h3", {
						...
						children: i($, { id: "understanding-impact.whyASingleLargeJson" })
					}),
					i("p", {
						className: "text-sm text-muted-foreground",
						children: i($, { id: "understanding-impact.manyI18nLibrariesStoreTranslations" })
					}),
					a("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							i("li", { children: i($, { id: "understanding-impact.theJsonMustBeParsed" }) }),
							i("li", { children: i($, { id: "understanding-impact.contextBasedArchitecturesCanCause" }) }),
							i("li", { children: i($, { id: "understanding-impact.duringServerSideRenderingThe" }) })
						]
					})
				]
			}),
			a("div", {
				...
				children: [
					i("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: i($, { id: "understanding-impact.theTradeOffsOfDynamic" })
					}),
					i("p", {
						className: "text-sm text-muted-foreground",
						children: i($, { id: "understanding-impact.splittingTranslationsIntoPerRoute" })
					}),
					a("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							a("li", { children: [
								i("strong", {
									...
									children: i($, { id: "understanding-impact.waterfallRequests" })
								}),
								" ",
								i($, { id: "understanding-impact.theAppMustFirstLoad" })
							] }),
							a("li", { children: [
								i("strong", {
									className: "text-foreground",
									children: i($, { id: "understanding-impact.flashOfUntranslatedContentFouc" })
								}),
								" ",
								i($, { id: "understanding-impact.usersMayBrieflySee" })
							] }),
							a("li", { children: [
								i("strong", {
									className: "text-foreground",
									children: i($, { id: "understanding-impact.cacheInvalidation" })
								}),
								" ",
								i($, { id: "understanding-impact.updatingTranslationsRequiresCacheBusting" })
							] })
						]
					})
				]
			...
			a("div", {
				...
				children: [i("h3", {
					className: "mb-2 text-lg font-semibold text-foreground",
					children: i($, { id: "understanding-impact.whatThisBenchmarkMeasures" })
				}), i("p", {
					className: "text-sm text-muted-foreground",
					children: i($, { id: "understanding-impact.thisTestAppProvidesA" })
				})]
			})
		]
	});
