...
async function getMessages(locale, namespaces = ["shared", "route"]) {
	...
	for (const ns of namespaces) try {
		const messages = await _rolldown_dynamic_import_helper_default(Object.assign({
			...
			"../messages/en/about.json": () => import("./about-CI0hCK_z.js"),
			"../messages/en/blog.json": () => import("./blog-BoYbZcjg.js"),
			"../messages/en/careers.json": () => import("./careers-JUAiiAN7.js"),
			"../messages/en/contact.json": () => import("./contact-DeRuW_zw.js"),
			"../messages/en/faq.json": () => import("./faq-jwCXaHED.js"),
			"../messages/en/home.json": () => import("./home-BUQLVzYW.js"),
			"../messages/en/pricing.json": () => import("./pricing-CJibxZRa.js"),
			"../messages/en/products.json": () => import("./products-CPL_B9ue.js"),
			"../messages/en/route.json": () => import("./route-UQnagTfi.js"),
			"../messages/en/settings.json": () => import("./settings-DsPKwqRK.js"),
			"../messages/en/shared.json": () => import("./shared-j4zBdnIe.js"),
			"../messages/en/team.json": () => import("./team-B6NZ-n0G.js"),
