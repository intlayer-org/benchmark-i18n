...
function ge(e, t, n, r, i, a, o, s) {
	...
	let O = Object.freeze({
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = N(n, ["formatEnabled"]);
...
function ye(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = N(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
function be({ options: e }) {
	let t = ce(), n = _e(!1, () => o.isFetching(), t.onFetchingChange.emit), r = _e(!1, () => T.isLoading(), t.onLoadingChange.emit), i = ve(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ge(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = fe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
(v = console.assert) == null || v.call(console, Le), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Re(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, qe = 3e3, Je = 200, Ye = 0, K = /* @__PURE__ */ new Map(), Xe = !1, q, J;
...
var Qe = (e) => new G("unavailable", `the Tolgee browser extension did not answer ${e} in time`), $e = () => `${Date.now()}-${Ye++}-${Math.random()}`;
function et() {
...
function tt(e) {
	return q ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: We }, window.origin), i = () => {
			clearInterval(a), nt(), J = void 0, n(new G("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Y = "__tolgee_", yt = `${Y}apiKey`, bt = `${Y}apiUrl`, xt = `${Y}branch`, St = `${Y}projectId`, Ct = `${Y}session`, wt = "tolgee-in-context-tools.umd.min.js", Tt = "@tolgee/in-context-tools", Et = "InContextTools", Dt = "https://cdn.jsdelivr.net/npm", Ot = null;
function kt(e) {
...
function Ft() {
	...
	if (i && r) return _(g({}, a), { transport: rt() });
}
function It() {
	let e = [];
...
var Ut = { useSuspense: !1 }, Wt, Gt = () => (Wt ||= e.createContext(void 0), Wt), X = void 0, Kt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	let { tolgee: r, options: a } = qt(), s = T(e), c = E(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Jt(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
function on() {
	...
	return c("button", {
		...
		children: t === "auto" ? c(Q, { keyName: "themeToggle.themeAuto" }) : t === "dark" ? c(Q, { keyName: "themeToggle.themeDark" }) : c(Q, { keyName: "themeToggle.themeLight" })
	});
}
