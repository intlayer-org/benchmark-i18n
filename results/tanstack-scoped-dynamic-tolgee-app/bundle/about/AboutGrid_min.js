	...
	return l("div", {
		...
		children: [l("div", {
			...
			children: [c("h2", {
				...
				children: c($, { keyName: "aboutGrid.whyThisExists" })
			}), c("p", {
				className: "text-sm text-muted-foreground",
				children: c($, { keyName: "aboutGrid.choosingAnI18nLibrary" })
			})]
		}), l("div", {
			className: "rounded-lg border border-border bg-card p-6",
			children: [c("h2", {
				className: "mb-3 text-xl font-semibold text-foreground",
				children: c($, { keyName: "aboutGrid.methodology" })
			}), c("p", {
				className: "text-sm text-muted-foreground",
				children: c($, { keyName: "aboutGrid.theSame10PageApp" })
			})]
		})]
	});
}
