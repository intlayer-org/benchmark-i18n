...
var Wt = { useSuspense: !1 }, Gt, Z = () => (Gt ||= e.createContext(void 0), Gt), Q = void 0, Kt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = Ut(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, Wt), r), h = Z();
