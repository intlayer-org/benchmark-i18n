...
function ge(e, t) {
	...
	return n.apiUrl = k(n.apiUrl), e?.fetch && (n.fetch = ae(e.fetch)), {
		initialOptions: n,
	...
	let O = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = te(e) || P, r = t().onFormatError, a = typeof r;
...
function Se({ options: e }) {
	let t = ce(), n = ve(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ve(!1, () => T.isLoading(), t.onLoadingChange.emit), i = ye(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = _e(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = fe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Le = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, U = {};
(function(e) {
	function t(e, t) {
...
var Wt = { useSuspense: !1 }, X, Gt = () => (X ||= e.createContext(void 0), X), Z = void 0, Kt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = Ut(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, Wt), r), h = Gt();
...
var Q = (t) => {
	let n = Xt(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, Qt(t))) : Qt(n);
}, $t = (t) => {
