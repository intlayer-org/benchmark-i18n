...
function nn() {
	return l("section", {
		...
		children: [c("h2", {
			...
			children: c($, { keyName: "whyItMatters.whyTheseMetricsMatter" })
		}), l("div", {
			...
			children: [
				l("div", {
					...
					children: [c("h3", {
						...
						children: c($, { keyName: "whyItMatters.bundleSize" })
					}), c("p", {
						className: "text-sm text-muted-foreground",
						children: c($, { keyName: "whyItMatters.theBundleIsTheData" })
					})]
				}),
				l("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [c("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: c($, { keyName: "whyItMatters.renderingHydration" })
					}), c("p", {
						className: "text-sm text-muted-foreground",
						children: c($, { keyName: "whyItMatters.connectingALargeJson" })
					})]
				}),
				l("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [c("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: c($, { keyName: "whyItMatters.dynamicLoading" })
					}), c("p", {
						className: "text-sm text-muted-foreground",
						children: c($, { keyName: "whyItMatters.loadingAllTranslationsUpfront" })
					})]
				})
			]
		})]
