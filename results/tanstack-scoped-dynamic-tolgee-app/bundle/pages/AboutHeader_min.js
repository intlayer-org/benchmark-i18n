...
function on() {
	return an("AboutHeader"), d(l, { children: [u("h1", {
		...
		children: u(rn, { keyName: "aboutHeader.aboutThisBenchmark" })
	}), u("p", {
		className: "mb-8 max-w-3xl text-muted-foreground",
		children: u(rn, { keyName: "aboutHeader.thisIsAnOpenSource" })
	})] });
}
