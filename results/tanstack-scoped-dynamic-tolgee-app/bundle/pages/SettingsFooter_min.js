...
}, j = (e) => Object.fromEntries(ae(e).entries()), M = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function he(e, t) {
	let n = I(me, t?.initialOptions, e);
	return n.apiUrl = A(n.apiUrl), e?.fetch && (n.fetch = ie(e.fetch)), {
		initialOptions: n,
...
function ge(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return C(s.onError, (e) => new ue("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return C(s.onError, (e) => new le("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function E(e) {
		e && l.backends.push(e);
	}
	...
	let k = Object.freeze({
		...
		setStoredLanguage(e) {
			return C(s.onError, (e) => new ue("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function xe({ options: e }) {
	let t = se(), n = _e(!1, () => o.isFetching(), t.onFetchingChange.emit), r = _e(!1, () => T.isLoading(), t.onLoadingChange.emit), i = ve(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ge(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = de(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Ie = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, W = {};
(function(e) {
	function t(e, t) {
...
(y = console.assert) == null || y.call(console, Le), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Re(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, qe = 3e3, Je = 200, Ye = 0, q = /* @__PURE__ */ new Map(), Xe = !1, J, Y;
...
var Qe = (e) => new K("unavailable", `the Tolgee browser extension did not answer ${e} in time`), $e = () => `${Date.now()}-${Ye++}-${Math.random()}`;
function et() {
...
function tt(e) {
	return J ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: We }, window.origin), i = () => {
			clearInterval(a), nt(), Y = void 0, n(new K("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Ut = { useSuspense: !1 }, Z, Wt = () => (Z ||= e.createContext(void 0), Z), Q = void 0, Gt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = Ht(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, Ut), r), h = Wt();
	...
	let { tolgee: r, options: a } = Kt(), s = E(e), c = D(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = qt(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
var $ = (t) => {
	let n = Yt(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, Zt(t))) : Zt(n);
}, Qt = (t) => {
	...
	let { t: n } = Jt();
	return e.createElement(Qt, Object.assign({ t: n }, t));
}, en = Bt().use(Pe()).init({ language: "en" });
function tn(e) {
	return c($t, { ...e });
}
function nn() {
	return l("div", {
		...
		children: [c("button", {
			...
			children: c(tn, { keyName: "common.cancel" })
		}), c("button", {
			type: "submit",
			className: "rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity",
			children: c(tn, { keyName: "common.saveChanges" })
		})]
	});
}
