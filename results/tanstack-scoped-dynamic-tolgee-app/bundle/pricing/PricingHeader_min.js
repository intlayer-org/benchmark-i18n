...
var Gt = { useSuspense: !1 }, Kt, X = () => (Kt ||= e.createContext(void 0), Kt), Z = void 0, qt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = Wt(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, Gt), r), h = X();
...
function an() {
	return u(c, { children: [l(rn, {}), u("div", {
		...
		children: [l("h1", {
			...
			children: l($, { keyName: "pricingHeader.pricing" })
		}), l("p", {
			className: "text-muted-foreground",
			children: l($, { keyName: "pricingHeader.transparentPricingForEvery" })
		})]
	})] });
}
