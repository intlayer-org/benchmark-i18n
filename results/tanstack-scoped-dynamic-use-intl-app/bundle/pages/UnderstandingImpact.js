...
function UnderstandingImpact() {
	const t = E("understanding-impact");
	return jsxs("section", {
			...
			jsxs("div", {
				...
				children: [
					...
					jsxs("ul", {
						...
						children: [
							jsx("li", { children: t("theJsonMustBeParsed") }),
							jsx("li", { children: t("contextBasedArchitecturesCanCause") }),
							jsx("li", { children: t("duringServerSideRenderingThe") })
						]
					})
				]
			}),
...
async function getMessages(locale, namespaces = ["shared", "route"]) {
	...
	for (const ns of namespaces) try {
		const messages = await _rolldown_dynamic_import_helper_default(Object.assign({
			"../messages/de/about.ts": () => import("./about-B-lRntKA.js"),
			"../messages/de/blog.ts": () => import("./blog-9hH5tp7t.js"),
			"../messages/de/careers.ts": () => import("./careers-CPeAPm4V.js"),
			"../messages/de/contact.ts": () => import("./contact-DcOfCziT.js"),
			"../messages/de/faq.ts": () => import("./faq-CMqPSoeL.js"),
			"../messages/de/home.ts": () => import("./home-D3dy5qzL.js"),
			"../messages/de/pricing.ts": () => import("./pricing-Q9MLgezP.js"),
			"../messages/de/products.ts": () => import("./products-bCGhLIvk.js"),
			"../messages/de/route.ts": () => import("./route-Dktbwc9I.js"),
			"../messages/de/settings.ts": () => import("./settings-B2HP7KG1.js"),
			"../messages/de/shared.ts": () => import("./shared-B1_1h7br.js"),
			"../messages/de/team.ts": () => import("./team-SV4wcEtc.js"),
			"../messages/en/about-grid.ts": () => import("./about-grid-CUF0XS1b.js"),
			"../messages/en/about-header.ts": () => import("./about-header-BUS4OlCX.js"),
			"../messages/en/about.ts": () => import("./about-CwbLhLEk.js"),
			"../messages/en/blog-header.ts": () => import("./blog-header-Mobjl-Ak.js"),
			"../messages/en/blog-list.ts": () => import("./blog-list-CRarkj3C.js"),
			"../messages/en/blog.ts": () => import("./blog-BH8FtKVe.js"),
			"../messages/en/careers-benefits.ts": () => import("./careers-benefits-c9UzOQJM.js"),
			"../messages/en/careers-header.ts": () => import("./careers-header-B1FsdXOy.js"),
			"../messages/en/careers.ts": () => import("./careers-Cic4cPRV.js"),
			"../messages/en/contact-form.ts": () => import("./contact-form-CPX7S0Xa.js"),
			"../messages/en/contact-header.ts": () => import("./contact-header-7TGq9I5m.js"),
			"../messages/en/contact.ts": () => import("./contact-DrzcwEmx.js"),
			"../messages/en/faq-header1.ts": () => import("./faq-header1-CMiRaTQK.js"),
			"../messages/en/faq-list.ts": () => import("./faq-list-Bgtr3UNq.js"),
			"../messages/en/faq.ts": () => import("./faq-OPU9ssUL.js"),
			"../messages/en/footer.ts": () => import("./footer-DWahzlkn.js"),
			"../messages/en/header.ts": () => import("./header-D7zNj_LL.js"),
			"../messages/en/hero.ts": () => import("./hero-Bs3QO7x1.js"),
			"../messages/en/home.ts": () => import("./home-BktppHAf.js"),
			"../messages/en/open-positions.ts": () => import("./open-positions-BpjTDbUt.js"),
			"../messages/en/pricing.ts": () => import("./pricing-JJj58x21.js"),
			"../messages/en/products.ts": () => import("./products-Cv49gfRS.js"),
			"../messages/en/results-table.ts": () => import("./results-table-CcCVLMnC.js"),
			"../messages/en/route.ts": () => import("./route-vDqHP-yO.js"),
			"../messages/en/settings.ts": () => import("./settings-DBZHkaHu.js"),
			"../messages/en/shared.ts": () => import("./shared-BGKMzNMq.js"),
			"../messages/en/team.ts": () => import("./team-BW6oevi4.js"),
			"../messages/en/theme-toggle.ts": () => import("./theme-toggle-BMwN60LN.js"),
			"../messages/en/understanding-impact.ts": () => import("./understanding-impact-BdkbFiKu.js"),
			"../messages/en/what-we-measure.ts": () => import("./what-we-measure-U9OvSSoI.js"),
			"../messages/en/why-it-matters.ts": () => import("./why-it-matters-DvwvThsL.js"),
			"../messages/es/about.ts": () => import("./about-BfJV4Sjl.js"),
			"../messages/es/blog.ts": () => import("./blog-BniN_w_1.js"),
			"../messages/es/careers.ts": () => import("./careers-BR1wXzBB.js"),
			"../messages/es/contact.ts": () => import("./contact-B4MXqwVP.js"),
			"../messages/es/faq.ts": () => import("./faq-CN6W5-BQ.js"),
			"../messages/es/home.ts": () => import("./home-BUP5Ua1M.js"),
			"../messages/es/pricing.ts": () => import("./pricing-BlJLcFpw.js"),
			"../messages/es/products.ts": () => import("./products-wH08kzH0.js"),
			"../messages/es/route.ts": () => import("./route-DFdgKsHZ.js"),
			"../messages/es/settings.ts": () => import("./settings-BEEAGfdh.js"),
			"../messages/es/shared.ts": () => import("./shared-DjqpIzGI.js"),
			"../messages/es/team.ts": () => import("./team-DHyfWq5p.js"),
			"../messages/fr/about.ts": () => import("./about-O2x_LDQF.js"),
			"../messages/fr/blog.ts": () => import("./blog-DAFI5qwc.js"),
			"../messages/fr/careers.ts": () => import("./careers-DZYDY2H5.js"),
			"../messages/fr/contact.ts": () => import("./contact-DH_yit-G.js"),
			"../messages/fr/faq.ts": () => import("./faq-CI2JErRq.js"),
			"../messages/fr/home.ts": () => import("./home-DtEYA1JB.js"),
			"../messages/fr/pricing.ts": () => import("./pricing-DnoPs17L.js"),
			"../messages/fr/products.ts": () => import("./products-BEFcqLZe.js"),
			"../messages/fr/route.ts": () => import("./route-RV2l16yX.js"),
			"../messages/fr/settings.ts": () => import("./settings-CWDvqCNm.js"),
			"../messages/fr/shared.ts": () => import("./shared-DuyJIchF.js"),
			"../messages/fr/team.ts": () => import("./team-BMLOEenz.js"),
			"../messages/it/about.ts": () => import("./about-FAkWtKSn.js"),
			"../messages/it/blog.ts": () => import("./blog-lFFxHDCN.js"),
			"../messages/it/careers.ts": () => import("./careers-Dd7dNBV1.js"),
			"../messages/it/contact.ts": () => import("./contact-9g7gcOZj.js"),
			"../messages/it/faq.ts": () => import("./faq-_WibI54a.js"),
			"../messages/it/home.ts": () => import("./home-C1vlMhdC.js"),
			"../messages/it/pricing.ts": () => import("./pricing-CYoaiPCf.js"),
			"../messages/it/products.ts": () => import("./products-01m1I9eJ.js"),
			"../messages/it/route.ts": () => import("./route-jGDambud.js"),
			"../messages/it/settings.ts": () => import("./settings-D3Ldek6F.js"),
			"../messages/it/shared.ts": () => import("./shared-CN7v2I7u.js"),
			"../messages/it/team.ts": () => import("./team-W7eMVyea.js"),
			"../messages/ja/about.ts": () => import("./about-B79KBiyP.js"),
			"../messages/ja/blog.ts": () => import("./blog-D_48geDS.js"),
			"../messages/ja/careers.ts": () => import("./careers-D3aoqhvU.js"),
			"../messages/ja/contact.ts": () => import("./contact-BdrelKI2.js"),
			"../messages/ja/faq.ts": () => import("./faq-DqhGzBX_.js"),
			"../messages/ja/home.ts": () => import("./home-BlAs4Txp.js"),
			"../messages/ja/pricing.ts": () => import("./pricing-DcauRRLl.js"),
			"../messages/ja/products.ts": () => import("./products-DEr5w6uL.js"),
			"../messages/ja/route.ts": () => import("./route-Zi0vxJ2B.js"),
			"../messages/ja/settings.ts": () => import("./settings-CukwZOHM.js"),
			"../messages/ja/shared.ts": () => import("./shared-D9sbFx0Y.js"),
			"../messages/ja/team.ts": () => import("./team-rP7DL6vf.js"),
			"../messages/ko/about.ts": () => import("./about-BJdJ9w6d.js"),
			"../messages/ko/blog.ts": () => import("./blog-BYhhOKDk.js"),
			"../messages/ko/careers.ts": () => import("./careers-DeNXy7oJ.js"),
			"../messages/ko/contact.ts": () => import("./contact-DWNblZQD.js"),
			"../messages/ko/faq.ts": () => import("./faq-BbqvIl6o.js"),
			"../messages/ko/home.ts": () => import("./home-B8A0m1Np.js"),
			"../messages/ko/pricing.ts": () => import("./pricing-CSHMbGJB.js"),
			"../messages/ko/products.ts": () => import("./products-BC1wjiZ9.js"),
			"../messages/ko/route.ts": () => import("./route-D2Igr45N.js"),
			"../messages/ko/settings.ts": () => import("./settings-BTF2UQ0A.js"),
			"../messages/ko/shared.ts": () => import("./shared-Dg9YGxIK.js"),
			"../messages/ko/team.ts": () => import("./team-Bnz1B34b.js"),
			"../messages/pt/about.ts": () => import("./about-DEzxikcc.js"),
			"../messages/pt/blog.ts": () => import("./blog-D0A0nV1H.js"),
			"../messages/pt/careers.ts": () => import("./careers-DrEBsra2.js"),
			"../messages/pt/contact.ts": () => import("./contact-Dmw1UZHO.js"),
			"../messages/pt/faq.ts": () => import("./faq-DtTh6OEm.js"),
			"../messages/pt/home.ts": () => import("./home-B6fj6m4l.js"),
			"../messages/pt/pricing.ts": () => import("./pricing-DXPQNZyv.js"),
			"../messages/pt/products.ts": () => import("./products-vNrkxvkD.js"),
			"../messages/pt/route.ts": () => import("./route-DsZMkogY.js"),
			"../messages/pt/settings.ts": () => import("./settings-C9CG35C_.js"),
			"../messages/pt/shared.ts": () => import("./shared-1JKm49J6.js"),
			"../messages/pt/team.ts": () => import("./team-DiCx1W9e.js"),
			"../messages/ru/about.ts": () => import("./about-Cw2dvB1e.js"),
			"../messages/ru/blog.ts": () => import("./blog-DkAFtANv.js"),
			"../messages/ru/careers.ts": () => import("./careers-MwDhGT_t.js"),
			"../messages/ru/contact.ts": () => import("./contact-7DMYUe-L.js"),
			"../messages/ru/faq.ts": () => import("./faq-D4-M-Ykb.js"),
			"../messages/ru/home.ts": () => import("./home-BV4t2bb4.js"),
			"../messages/ru/pricing.ts": () => import("./pricing-CJ7uSb_7.js"),
			"../messages/ru/products.ts": () => import("./products-DoKKgWFX.js"),
			"../messages/ru/route.ts": () => import("./route-C0CdqKsX.js"),
			"../messages/ru/settings.ts": () => import("./settings-CYEsTgjP.js"),
			"../messages/ru/shared.ts": () => import("./shared-DbW6PPHV.js"),
			"../messages/ru/team.ts": () => import("./team-CZ9j9JB9.js"),
			"../messages/zh/about.ts": () => import("./about-xP8Knt_1.js"),
			"../messages/zh/blog.ts": () => import("./blog-DkO0V7DY.js"),
			"../messages/zh/careers.ts": () => import("./careers-DXcIfuw0.js"),
			"../messages/zh/contact.ts": () => import("./contact-BdDv3d8m.js"),
			"../messages/zh/faq.ts": () => import("./faq-CbesQ0eA.js"),
			"../messages/zh/home.ts": () => import("./home-UdqXz3qF.js"),
			"../messages/zh/pricing.ts": () => import("./pricing-Bc4R-DJb.js"),
			"../messages/zh/products.ts": () => import("./products-DswFF7Yt.js"),
			"../messages/zh/route.ts": () => import("./route-0xiiZA8G.js"),
			"../messages/zh/settings.ts": () => import("./settings-C1GxJLe9.js"),
			"../messages/zh/shared.ts": () => import("./shared-CTqu1qIY.js"),
			"../messages/zh/team.ts": () => import("./team-B_RTAcuI.js")
