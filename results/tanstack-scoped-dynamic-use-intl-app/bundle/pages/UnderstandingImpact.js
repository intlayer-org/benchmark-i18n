...
function UnderstandingImpact() {
	const t = v("understanding-impact");
	return jsxs("section", {
...
async function getMessages(locale, namespaces = ["shared", "route"]) {
	...
	for (const ns of namespaces) try {
		const messages = await _rolldown_dynamic_import_helper_default(Object.assign({
			"../messages/de/about.ts": () => import("./about-C_rLAmKF.js"),
			"../messages/de/blog.ts": () => import("./blog-ce8dPK3j.js"),
			"../messages/de/careers.ts": () => import("./careers-Br2XEeaR.js"),
			"../messages/de/contact.ts": () => import("./contact-BCThKD5k.js"),
			"../messages/de/faq.ts": () => import("./faq-DbqKn4r3.js"),
			"../messages/de/home.ts": () => import("./home-CZ6Jar1Z.js"),
			"../messages/de/pricing.ts": () => import("./pricing-HIGFEJve.js"),
			"../messages/de/products.ts": () => import("./products-CDF9_Ke3.js"),
			"../messages/de/route.ts": () => import("./route-DYjQFtSA.js"),
			"../messages/de/settings.ts": () => import("./settings-B3jtLROi.js"),
			"../messages/de/shared.ts": () => import("./shared-oT4ip0e5.js"),
			"../messages/de/team.ts": () => import("./team-AZ1bOx1L.js"),
			"../messages/en/about-grid.ts": () => import("./about-grid-BNGttJvy.js"),
			"../messages/en/about-header.ts": () => import("./about-header-DAbI-4q-.js"),
			"../messages/en/about.ts": () => import("./about-DU3Tmkp7.js"),
			"../messages/en/blog-header.ts": () => import("./blog-header-rnjZX6fe.js"),
			"../messages/en/blog-list.ts": () => import("./blog-list-_GZn86Ox.js"),
			"../messages/en/blog.ts": () => import("./blog-CcJ01HIk.js"),
			"../messages/en/careers-benefits.ts": () => import("./careers-benefits-DRbxcHE0.js"),
			"../messages/en/careers-header.ts": () => import("./careers-header-BVY5uaGR.js"),
			"../messages/en/careers.ts": () => import("./careers-DeLCxl-R.js"),
			"../messages/en/contact-form.ts": () => import("./contact-form-Xfi4lxmy.js"),
			"../messages/en/contact-header.ts": () => import("./contact-header-DxOzh5-1.js"),
			"../messages/en/contact.ts": () => import("./contact-mi1wZB8f.js"),
			"../messages/en/faq-header1.ts": () => import("./faq-header1-BnRPA8Pw.js"),
			"../messages/en/faq-list.ts": () => import("./faq-list-ChwVQZGC.js"),
			"../messages/en/faq.ts": () => import("./faq-BAZ3dRXm.js"),
			"../messages/en/footer.ts": () => import("./footer-DJI9CfRQ.js"),
			"../messages/en/header.ts": () => import("./header-ANJ-C7cG.js"),
			"../messages/en/hero.ts": () => import("./hero-BwSA7cJU.js"),
			"../messages/en/home.ts": () => import("./home-Duf5aIiB.js"),
			"../messages/en/open-positions.ts": () => import("./open-positions-D_osNKJW.js"),
			"../messages/en/pricing.ts": () => import("./pricing-CPKocerY.js"),
			"../messages/en/products.ts": () => import("./products-CTVJ_Xg7.js"),
			"../messages/en/results-table.ts": () => import("./results-table-B3JiCwr-.js"),
			"../messages/en/route.ts": () => import("./route-Cf-h9M4U.js"),
			"../messages/en/settings.ts": () => import("./settings-DzhsP8hR.js"),
			"../messages/en/shared.ts": () => import("./shared-CpX5vISY.js"),
			"../messages/en/team.ts": () => import("./team-BuN9NH9r.js"),
			"../messages/en/theme-toggle.ts": () => import("./theme-toggle-BANIoUvt.js"),
			"../messages/en/understanding-impact.ts": () => import("./understanding-impact-B5bGK386.js"),
			"../messages/en/what-we-measure.ts": () => import("./what-we-measure-CIZG5NI-.js"),
			"../messages/en/why-it-matters.ts": () => import("./why-it-matters-tw7o3iGr.js"),
			"../messages/es/about.ts": () => import("./about-Bf9hpokY.js"),
			"../messages/es/blog.ts": () => import("./blog-DVrb4FSb.js"),
			"../messages/es/careers.ts": () => import("./careers-D3wcQIt5.js"),
			"../messages/es/contact.ts": () => import("./contact-DM_SZC4i.js"),
			"../messages/es/faq.ts": () => import("./faq-BOwgTRSz.js"),
			"../messages/es/home.ts": () => import("./home-BB_eijui.js"),
			"../messages/es/pricing.ts": () => import("./pricing-EHx5dOsp.js"),
			"../messages/es/products.ts": () => import("./products-C9BO4uMw.js"),
			"../messages/es/route.ts": () => import("./route-YLXN55s8.js"),
			"../messages/es/settings.ts": () => import("./settings-cypNbXnT.js"),
			"../messages/es/shared.ts": () => import("./shared-D4s4YVQU.js"),
			"../messages/es/team.ts": () => import("./team-COclzMlh.js"),
			"../messages/fr/about.ts": () => import("./about-BT0-NLHK.js"),
			"../messages/fr/blog.ts": () => import("./blog-CqKtJRFT.js"),
			"../messages/fr/careers.ts": () => import("./careers-UUc1eIoz.js"),
			"../messages/fr/contact.ts": () => import("./contact-D24SzJpt.js"),
			"../messages/fr/faq.ts": () => import("./faq-BBI0XhUw.js"),
			"../messages/fr/home.ts": () => import("./home-DWXv6Q6v.js"),
			"../messages/fr/pricing.ts": () => import("./pricing-DrDan4NB.js"),
			"../messages/fr/products.ts": () => import("./products-DErzdGkw.js"),
			"../messages/fr/route.ts": () => import("./route-C9_UK351.js"),
			"../messages/fr/settings.ts": () => import("./settings-Drm7bu1N.js"),
			"../messages/fr/shared.ts": () => import("./shared-ChpduM0M.js"),
			"../messages/fr/team.ts": () => import("./team-DeNSUrGK.js"),
			"../messages/it/about.ts": () => import("./about-4U-08x18.js"),
			"../messages/it/blog.ts": () => import("./blog-BgPAR_at.js"),
			"../messages/it/careers.ts": () => import("./careers-B6YpBbK9.js"),
			"../messages/it/contact.ts": () => import("./contact-DueTIdvj.js"),
			"../messages/it/faq.ts": () => import("./faq-DR5jGRt9.js"),
			"../messages/it/home.ts": () => import("./home-C2S2pHvI.js"),
			"../messages/it/pricing.ts": () => import("./pricing-DceVS7sZ.js"),
			"../messages/it/products.ts": () => import("./products-D8OPjnVw.js"),
			"../messages/it/route.ts": () => import("./route-DHGCe4kU.js"),
			"../messages/it/settings.ts": () => import("./settings-DTUz9CD8.js"),
			"../messages/it/shared.ts": () => import("./shared-D0LMBvCw.js"),
			"../messages/it/team.ts": () => import("./team-D4n5r7eX.js"),
			"../messages/ja/about.ts": () => import("./about-5i8ZrtKx.js"),
			"../messages/ja/blog.ts": () => import("./blog-BfyrPVcc.js"),
			"../messages/ja/careers.ts": () => import("./careers-fob90ejy.js"),
			"../messages/ja/contact.ts": () => import("./contact-DszAc3Oz.js"),
			"../messages/ja/faq.ts": () => import("./faq-CnEXAIwW.js"),
			"../messages/ja/home.ts": () => import("./home-4fqggxvs.js"),
			"../messages/ja/pricing.ts": () => import("./pricing-BlbYpNvP.js"),
			"../messages/ja/products.ts": () => import("./products-BTZLnFXj.js"),
			"../messages/ja/route.ts": () => import("./route-Cgj4ulFF.js"),
			"../messages/ja/settings.ts": () => import("./settings-BZWT7JFQ.js"),
			"../messages/ja/shared.ts": () => import("./shared-CMNsRLnV.js"),
			"../messages/ja/team.ts": () => import("./team-BjpPOcdz.js"),
			"../messages/ko/about.ts": () => import("./about-DzCPRKEj.js"),
			"../messages/ko/blog.ts": () => import("./blog-CNbIxc4u.js"),
			"../messages/ko/careers.ts": () => import("./careers-B5ZvmU5x.js"),
			"../messages/ko/contact.ts": () => import("./contact-U6uEB_HB.js"),
			"../messages/ko/faq.ts": () => import("./faq-alPlvEHJ.js"),
			"../messages/ko/home.ts": () => import("./home-D78efHGX.js"),
			"../messages/ko/pricing.ts": () => import("./pricing-C3NfLYu1.js"),
			"../messages/ko/products.ts": () => import("./products-CmHyLOTD.js"),
			"../messages/ko/route.ts": () => import("./route-CIYruZme.js"),
			"../messages/ko/settings.ts": () => import("./settings-BCgvePVt.js"),
			"../messages/ko/shared.ts": () => import("./shared-D8xQg98k.js"),
			"../messages/ko/team.ts": () => import("./team-DlxiVZhg.js"),
			"../messages/pt/about.ts": () => import("./about-CELEjicL.js"),
			"../messages/pt/blog.ts": () => import("./blog-B75sb8ro.js"),
			"../messages/pt/careers.ts": () => import("./careers-Pp63qso8.js"),
			"../messages/pt/contact.ts": () => import("./contact-CZBKCVa5.js"),
			"../messages/pt/faq.ts": () => import("./faq-CjXvnWCk.js"),
			"../messages/pt/home.ts": () => import("./home-Bsk7m70u.js"),
			"../messages/pt/pricing.ts": () => import("./pricing-BHEGcuBi.js"),
			"../messages/pt/products.ts": () => import("./products-D1fSNqn2.js"),
			"../messages/pt/route.ts": () => import("./route-C72SpE8P.js"),
			"../messages/pt/settings.ts": () => import("./settings-CFgFxmzQ.js"),
			"../messages/pt/shared.ts": () => import("./shared-DkRrsekO.js"),
			"../messages/pt/team.ts": () => import("./team-DGFOD2Bx.js"),
			"../messages/ru/about.ts": () => import("./about-D1hE_7um.js"),
			"../messages/ru/blog.ts": () => import("./blog-Cy3ZONop.js"),
			"../messages/ru/careers.ts": () => import("./careers-NUew0C3e.js"),
			"../messages/ru/contact.ts": () => import("./contact-D93RKM36.js"),
			"../messages/ru/faq.ts": () => import("./faq-Q9vzf-lD.js"),
			"../messages/ru/home.ts": () => import("./home-DjIfnNWg.js"),
			"../messages/ru/pricing.ts": () => import("./pricing-DID8Qr8h.js"),
			"../messages/ru/products.ts": () => import("./products-BivYDbvk.js"),
			"../messages/ru/route.ts": () => import("./route-D8K-mKeV.js"),
			"../messages/ru/settings.ts": () => import("./settings-xmjZzyds.js"),
			"../messages/ru/shared.ts": () => import("./shared-EOgFZjY5.js"),
			"../messages/ru/team.ts": () => import("./team-CDloxhiP.js"),
			"../messages/zh/about.ts": () => import("./about-Fp29kYNB.js"),
			"../messages/zh/blog.ts": () => import("./blog-DjiFnLb6.js"),
			"../messages/zh/careers.ts": () => import("./careers-eHaAZzJ4.js"),
			"../messages/zh/contact.ts": () => import("./contact-D6lMmZvU.js"),
			"../messages/zh/faq.ts": () => import("./faq-DcXEneqn.js"),
			"../messages/zh/home.ts": () => import("./home-CnL5HMRK.js"),
			"../messages/zh/pricing.ts": () => import("./pricing-CL8EjYdU.js"),
			"../messages/zh/products.ts": () => import("./products-BD-Kts_V.js"),
			"../messages/zh/route.ts": () => import("./route-CxqoFpCu.js"),
			"../messages/zh/settings.ts": () => import("./settings-DlUwxJ0L.js"),
			"../messages/zh/shared.ts": () => import("./shared-DbiFZ1ht.js"),
			"../messages/zh/team.ts": () => import("./team-DIDFKNuR.js")
