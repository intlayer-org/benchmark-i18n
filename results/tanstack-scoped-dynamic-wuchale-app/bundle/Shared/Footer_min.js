...
} }, h = d("shared", (e, t) => m[e][t](), ["shared"]);
function g() {
	let n = t({ strict: !1 }).locale ?? "en", a = h("shared"), o = [
		{
			label: a(6),
			...
			children: [i("div", {
				...
				children: [
					...
					i("div", { children: [r("h3", {
						...
						className: "space-y-1",
						children: o.map((t) => r("li", { children: t.isInternal ? r(e, {
							preload: !1,
							to: t.to,
							params: { locale: n },
