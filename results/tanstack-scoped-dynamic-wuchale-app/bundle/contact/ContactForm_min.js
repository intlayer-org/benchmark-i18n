...
}, m = u("contact", (e, t) => p[t][e](), 1);
function h() {
	let t = e(), i = e(), a = e(), o = e(), s = m();
	return r("form", {
		className: "space-y-6",
		children: [
			r("div", {
			...
			r("div", { children: [n("label", {
				...
				children: [
					n("option", { children: s(114) }),
					n("option", { children: s(115) }),
					n("option", { children: s(116) }),
					n("option", { children: s(117) }),
					n("option", { children: s(118) })
				]
			})] }),
			r("div", { children: [n("label", {
				htmlFor: o,
