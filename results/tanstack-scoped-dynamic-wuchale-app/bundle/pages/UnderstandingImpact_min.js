...
function a(e = { c: [] }, t = "") {
	let n = (t) => {
		let n = e.c[t];
		return typeof n == "string" ? [n] : Array.isArray(n) ? n : [r(t, e.c)];
	}, a = (e, t = []) => i(n(e), t, 0);
	return a._ = e, a.l = t, a.c = n, a.x = i, a.t = (e, t, r) => {
		let i = [""], a = [];
		for (let e of n(t)) {
			if (typeof e == "string") {
				i[i.length - 1] += e;
	...
	}, a.p = (t, n) => e.c[t]?.map((e) => typeof e == "string" ? e : i(e, n, 0)) ?? [], a;
}
function o(e) {
	return {
		get: (t) => e[t],
...
function l(e, t, n, r) {
	...
	for (let t = 0; t < n; t++) s[e].collection.set(t, c);
	return (t = 0) => s[e].collection.get(t);
}
function u(e) {
	for (let t of Object.values(s)) for (let [n, r] of t.catalogs.entries()) t.collection.set(n, a(r, e));
}
async function d(e, t = !0) {
	let n = [], r = [];
	for (let t of Object.values(s)) for (let i = 0; i < t.catalogs.length; i++) n.push(t.load(i, e)), r.push([i, t]);
...
var f = {
	en: [() => import("./shared.0.en.compiled-CbtKcpU1.js")],
	es: [() => import("./shared.0.es.compiled-XN5QK-GG.js")],
	fr: [() => import("./shared.0.fr.compiled-CzfWVDxu.js")],
	de: [() => import("./shared.0.de.compiled-BdGNU4OC.js")],
	it: [() => import("./shared.0.it.compiled-CezvA-_9.js")],
	pt: [() => import("./shared.0.pt.compiled-BhxKvL0-.js")],
	zh: [() => import("./shared.0.zh.compiled-EL9-BRhY.js")],
	ja: [() => import("./shared.0.ja.compiled-W_lQkLlA.js")],
	ko: [() => import("./shared.0.ko.compiled-C_GaK-0w.js")],
	ru: [() => import("./shared.0.ru.compiled-CyUTKekj.js")]
}, p = l("home", (e, t) => f[t][e](), 1);
