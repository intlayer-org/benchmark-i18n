		...
		children: [jsx("h2", {
			...
			children: [
				...
				jsxs("div", { children: [jsx("label", {
					...
					children: _w_runtime_(138)
				}), jsxs("select", {
					id: languageId,
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
					children: [
						jsx("option", { children: _w_runtime_(139) }),
						jsx("option", { children: _w_runtime_(140) }),
						jsx("option", { children: _w_runtime_(141) }),
						jsx("option", { children: _w_runtime_(142) }),
						jsx("option", { children: _w_runtime_(143) }),
						jsx("option", { children: _w_runtime_(144) }),
						jsx("option", { children: _w_runtime_(145) })
					]
				})] })
			]
		})]
