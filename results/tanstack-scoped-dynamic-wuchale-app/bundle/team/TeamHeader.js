...
var getRuntimeRx = registerLoaders("team", loadCatalog$10, ["team"]);
function TeamHeader() {
	...
	return jsxs(Fragment, { children: [
		...
		jsx("h1", {
			...
			children: _w_runtime_(152)
		}),
		jsx("p", {
			className: "mb-10 text-muted-foreground",
			children: _w_runtime_(153)
		})
	] });
}
...
registerLoaders("settings", loadCatalog, ["settings"]);
loadLocale("en");
