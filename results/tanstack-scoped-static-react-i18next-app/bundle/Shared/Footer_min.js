...
import k from "../i18n/locales/es/home.json";
import A from "../i18n/locales/es/pricing.json";
...
var j = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), M = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
}, Lt = /###/g, Rt = (e) => e && e.includes("###") ? e.replace(Lt, ".") : e, zt = (e) => !e || N(e), F = (e, t, n) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? N(e[r]) || e[r] instanceof String || N(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : Ut(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, L = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), Wt = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, Gt = (e) => N(e) ? e.replace(/[&<>"'\/]/g, (e) => Wt[e]) : e, Kt = class {
	constructor(e) {
...
var U = (e) => !N(e) && typeof e != "boolean" && typeof e != "number", tn = class e extends V {
	constructor(e, t = {}) {
		super(), It([
			"resourceStore",
			"languageUtils",
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? Gt : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? L(i) : a || "{{", this.suffix = o ? L(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? L(d) : f || L("$t("), this.nestingSuffix = p ? L(p) : m || L(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				else !N(a) && !this.useRawValueToEscape && (a = Ft(a));
				let s = t.safeValue(a);
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			N(i) || (i = Ft(i)), i ||= (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), ""), s.length && (i = s.reduce((e, t) => this.format(e, t, n.lng, {
				...n,
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			Vt(n.loaded, [i], a), pn(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), hn = (e) => (N(e.ns) && (e.ns = [e.ns]), N(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), N(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), K = () => {}, gn = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, q = class e extends V {
	constructor(e = {}, t) {
		if (super(), this.options = hn(e), this.services = {}, this.logger = B, this.modules = { external: [] }, gn(this), t && !this.isInitialized && !e.isClone) {
...
var _n = (e, t, n, r) => {
	...
	let { i18n: c } = t, { i18n: l, defaultNS: u } = r($) || {}, d = c || l || kn();
	...
	let v = o(0), y = n((e) => {
		...
		f,
		t.lng
	]), [S, C] = s(0), { t: w, ready: T } = (0, Pn.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
...
function zn() {
	let { t: e } = Ln("shared"), t = l({ strict: !1 }).locale ?? "en", n = [
		{
