...
import h from "../i18n/locales/de/about.json";
import g from "../i18n/locales/de/blog.json";
import _ from "../i18n/locales/de/careers.json";
import v from "../i18n/locales/de/contact.json";
import y from "../i18n/locales/de/faq.json";
import b from "../i18n/locales/de/home.json";
import x from "../i18n/locales/de/pricing.json";
import S from "../i18n/locales/de/products.json";
import C from "../i18n/locales/de/route.json";
import w from "../i18n/locales/de/settings.json";
import T from "../i18n/locales/de/shared.json";
import E from "../i18n/locales/de/team.json";
import D from "../i18n/locales/es/about.json";
import O from "../i18n/locales/es/blog.json";
import k from "../i18n/locales/es/careers.json";
import ee from "../i18n/locales/es/contact.json";
import te from "../i18n/locales/es/faq.json";
import ne from "../i18n/locales/es/home.json";
import re from "../i18n/locales/es/pricing.json";
import ie from "../i18n/locales/es/products.json";
import ae from "../i18n/locales/es/route.json";
import oe from "../i18n/locales/es/settings.json";
import se from "../i18n/locales/es/shared.json";
import ce from "../i18n/locales/es/team.json";
import le from "../i18n/locales/fr/about.json";
import ue from "../i18n/locales/fr/blog.json";
import de from "../i18n/locales/fr/careers.json";
import fe from "../i18n/locales/fr/contact.json";
import pe from "../i18n/locales/fr/faq.json";
import me from "../i18n/locales/fr/home.json";
import he from "../i18n/locales/fr/pricing.json";
import ge from "../i18n/locales/fr/products.json";
import _e from "../i18n/locales/fr/route.json";
import ve from "../i18n/locales/fr/settings.json";
import ye from "../i18n/locales/fr/shared.json";
import be from "../i18n/locales/fr/team.json";
import xe from "../i18n/locales/it/about.json";
import Se from "../i18n/locales/it/blog.json";
import Ce from "../i18n/locales/it/careers.json";
import we from "../i18n/locales/it/contact.json";
import Te from "../i18n/locales/it/faq.json";
import Ee from "../i18n/locales/it/home.json";
import De from "../i18n/locales/it/pricing.json";
import Oe from "../i18n/locales/it/products.json";
import ke from "../i18n/locales/it/route.json";
import Ae from "../i18n/locales/it/settings.json";
import je from "../i18n/locales/it/shared.json";
import Me from "../i18n/locales/it/team.json";
import Ne from "../i18n/locales/ja/about.json";
import Pe from "../i18n/locales/ja/blog.json";
import Fe from "../i18n/locales/ja/careers.json";
import Ie from "../i18n/locales/ja/contact.json";
import Le from "../i18n/locales/ja/faq.json";
import Re from "../i18n/locales/ja/home.json";
import ze from "../i18n/locales/ja/pricing.json";
import Be from "../i18n/locales/ja/products.json";
import Ve from "../i18n/locales/ja/route.json";
import He from "../i18n/locales/ja/settings.json";
import Ue from "../i18n/locales/ja/shared.json";
import We from "../i18n/locales/ja/team.json";
import Ge from "../i18n/locales/ko/about.json";
import Ke from "../i18n/locales/ko/blog.json";
import qe from "../i18n/locales/ko/careers.json";
import Je from "../i18n/locales/ko/contact.json";
import Ye from "../i18n/locales/ko/faq.json";
import Xe from "../i18n/locales/ko/home.json";
import Ze from "../i18n/locales/ko/pricing.json";
import Qe from "../i18n/locales/ko/products.json";
import $e from "../i18n/locales/ko/route.json";
import et from "../i18n/locales/ko/settings.json";
import tt from "../i18n/locales/ko/shared.json";
import nt from "../i18n/locales/ko/team.json";
import rt from "../i18n/locales/pt/about.json";
import it from "../i18n/locales/pt/blog.json";
import at from "../i18n/locales/pt/careers.json";
import ot from "../i18n/locales/pt/contact.json";
import st from "../i18n/locales/pt/faq.json";
import ct from "../i18n/locales/pt/home.json";
import lt from "../i18n/locales/pt/pricing.json";
import ut from "../i18n/locales/pt/products.json";
import dt from "../i18n/locales/pt/route.json";
import ft from "../i18n/locales/pt/settings.json";
import pt from "../i18n/locales/pt/shared.json";
import mt from "../i18n/locales/pt/team.json";
import ht from "../i18n/locales/ru/about.json";
import gt from "../i18n/locales/ru/blog.json";
import _t from "../i18n/locales/ru/careers.json";
import vt from "../i18n/locales/ru/contact.json";
import yt from "../i18n/locales/ru/faq.json";
import bt from "../i18n/locales/ru/home.json";
import xt from "../i18n/locales/ru/pricing.json";
import St from "../i18n/locales/ru/products.json";
import Ct from "../i18n/locales/ru/route.json";
import wt from "../i18n/locales/ru/settings.json";
import Tt from "../i18n/locales/ru/shared.json";
import Et from "../i18n/locales/ru/team.json";
import Dt from "../i18n/locales/zh/about.json";
import Ot from "../i18n/locales/zh/blog.json";
import kt from "../i18n/locales/zh/careers.json";
import At from "../i18n/locales/zh/contact.json";
import jt from "../i18n/locales/zh/faq.json";
import Mt from "../i18n/locales/zh/home.json";
import Nt from "../i18n/locales/zh/pricing.json";
import Pt from "../i18n/locales/zh/products.json";
import Ft from "../i18n/locales/zh/route.json";
import It from "../i18n/locales/zh/settings.json";
import Lt from "../i18n/locales/zh/shared.json";
import Rt from "../i18n/locales/zh/team.json";
var A = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), j = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
}, Vt = /###/g, Ht = (e) => e && e.includes("###") ? e.replace(Vt, ".") : e, Ut = (e) => !e || M(e), P = (e, t, n) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? M(e[r]) || e[r] instanceof String || M(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : qt(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, I = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), Jt = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, Yt = (e) => M(e) ? e.replace(/[&<>"'\/]/g, (e) => Jt[e]) : e, Xt = class {
	constructor(e) {
	...
	getResource(e, t, n, r = {}) {
		...
		let s = F(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !M(n) ? s : L(this.data?.[e]?.[t], n, i);
	}
...
var H = (e) => !M(e) && typeof e != "boolean" && typeof e != "number", on = class e extends B {
	constructor(e, t = {}) {
		super(), Bt([
			"resourceStore",
			"languageUtils",
			...
			"i18nFormat",
			"utils"
		], e, this), this.options = t, this.options.keySeparator === void 0 && (this.options.keySeparator = "."), this.logger = z.create("translator"), this.checkedLoadedFor = {};
	}
	changeLanguage(e) {
		e && (this.language = e);
	}
	...
	translate(t, n, r) {
		...
		y && !m && x && (E = T);
		let D = H(E), O = Object.prototype.toString.apply(E);
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return M(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? V(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	getScriptPartFromCode(e) {
		if (e = R(e), !e || !e.includes("-")) return null;
		let t = e.split("-");
		return t.length === 2 || (t.pop(), t[t.length - 1].toLowerCase() === "x") ? null : this.formatLanguageCode(t.join("-"));
	}
	getLanguagePartFromCode(e) {
		if (e = R(e), !e || !e.includes("-")) return e;
		let t = e.split("-");
	...
	getRule(e, t = {}) {
		...
		try {
			...
			if (typeof Intl > "u") return this.logger.error("No Intl support, please use an Intl polyfill!"), ln;
	...
	getSuffixes(e, t = {}) {
		let n = this.getRule(e, t);
		return n ||= this.getRule("dev", t), n ? n.resolvedOptions().pluralCategories.sort((e, t) => cn[e] - cn[t]).map((e) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${e}`) : [];
	}
	getSuffix(e, t, n = {}) {
	...
	let a = Kt(e, t, n);
	return !a && i && M(n) && (a = L(e, n, r), a === void 0 && (a = L(t, n, r))), a;
}, U = (e) => e.replace(/\$/g, "$$$$"), fn = class {
	constructor(e = {}) {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? Yt : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? I(i) : a || "{{", this.suffix = o ? I(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? I(d) : f || I("$t("), this.nestingSuffix = p ? I(p) : m || I(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		let i, a, o, s = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (e) => {
			if (!e.includes(this.formatSeparator)) {
				let i = dn(t, s, e, this.options.keySeparator, this.options.ignoreJSONStructure);
			...
			return this.format(dn(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
				...r,
				...t,
				interpolationkey: a
			});
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				else !M(a) && !this.useRawValueToEscape && (a = zt(a));
				let s = t.safeValue(a);
	...
	nest(e, t, n = {}) {
		let r, i, a, o = (e, t) => {
			...
			let r = e.split(RegExp(`${I(n)}[ ]*{`)), i = `{${r[1]}`;
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			M(i) || (i = zt(i)), i ||= (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), ""), s.length && (i = s.reduce((e, t) => this.format(e, t, n.lng, {
				...n,
	...
	addCached(e, t) {
		this.formats[e.toLowerCase().trim()] = mn(t);
	}
	format(e, t, n, r = {}) {
		...
		return i.reduce((e, t) => {
			let { formatName: i, formatOptions: a } = pn(t);
			if (this.formats[i]) {
				let t = e;
				try {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			Gt(n.loaded, [i], a), _n(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), yn = (e) => (M(e.ns) && (e.ns = [e.ns]), M(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), M(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), G = () => {}, bn = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, K = class e extends B {
	constructor(e = {}, t) {
		if (super(), this.options = yn(e), this.services = {}, this.logger = z, this.modules = { external: [] }, bn(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		...
		if (!this.options.isClone) {
			...
			let t = new sn(this.options);
			this.store = new tn(this.options.resources, this.options);
			let n = this.services;
			n.logger = z, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new un(t, { prepend: this.options.pluralSeparator }), e && (n.formatter = r(e), n.formatter.init && n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new fn(this.options), n.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }, n.backendConnector = new vn(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (e, ...t) => {
				this.emit(e, ...t);
			}), this.modules.languageDetector && (n.languageDetector = r(this.modules.languageDetector), n.languageDetector.init && n.languageDetector.init(n, this.options.detection, this.options)), this.modules.i18nFormat && (n.i18nFormat = r(this.modules.i18nFormat), n.i18nFormat.init && n.i18nFormat.init(this)), this.translator = new on(this.services, this.options), this.translator.on("*", (e, ...t) => {
				this.emit(e, ...t);
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new sn(W());
	...
	cloneInstance(t = {}, n = G) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a.services.interpolator = new fn(n);
		}
		return a.translator = new on(a.services, i), a.translator.on("*", (e, ...t) => {
			a.emit(e, ...t);
...
K.createInstance, K.dir, K.init, K.loadResources, K.reloadResources, K.use, K.changeLanguage, K.getFixedT, K.t, K.exists, K.setDefaultNamespace, K.hasLoadedNamespace, K.loadNamespaces, K.loadLanguages;
var xn = (e, t, n, r) => {
	let i = [n, {
		code: t,
		...r || {}
	...
	Y(n) && Sn[n] || (Y(n) && (Sn[n] = /* @__PURE__ */ new Date()), xn(e, t, n, r));
}, Cn = (e, t) => () => {
...
}, Tn = (e, t, n = {}) => !t.languages || !t.languages.length ? (q(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Y = (e) => typeof e == "string", En = (e) => typeof e == "object" && !!e, Dn = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, On = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (Y(t)) return t;
		if (En(t) && Y(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: a } = t, { i18n: l, defaultNS: u } = r(Z) || {}, d = a || l || Pn();
	d && !d.reportNamespaces && (d.reportNamespaces = new In()), d || q(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = o(() => ({
		...jn(),
		...d?.options?.react,
		...t
	...
	let v = s(0), y = n((e) => {
		...
		if (!d) return Bn;
		let e = !!(d.isInitialized || d.initializedStoreOnce) && _.every((e) => Tn(e, d, f)), n = t.lng || d.language, r = v.current, i = b.current;
		...
		f,
		t.lng
	]), [S, C] = c(0), { t: w, ready: T } = (0, zn.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
			t.lng ? wn(d, t.lng, _, e) : J(d, _, e);
		}
	}, [
		d,
		t.lng,
	...
	if (d && p && !T) throw new Promise((e) => {
		let n = () => e();
		t.lng ? wn(d, t.lng, _, n) : J(d, _, n);
	});
	return ee;
};
function Hn({ i18n: e, defaultNS: n, children: r }) {
	let i = o(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
	return t(Z.Provider, { value: i }, r);
}
function Un() {
