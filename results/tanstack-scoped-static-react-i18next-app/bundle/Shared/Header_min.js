...
var z = (e) => !_(e) && typeof e != "boolean" && typeof e != "number", B = class e extends P {
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			}), i.trim())), e = e.replace(r[0], G(y(i))), this.regexp.lastIndex = 0;
		}
		return e;
	}
}, ue = (e) => {
...
var ve = (e, t, n, r) => {
	...
	d && !d.reportNamespaces && (d.reportNamespaces = new Pe()), d || Y(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next or by passing it via props or context. In monorepo setups, make sure there is only one instance of react-i18next.");
	let f = o(() => ({
		...Oe(),
		...d?.options?.react,
		...t
...
function Be({ i18n: e, defaultNS: n, children: r }) {
	let i = o(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
