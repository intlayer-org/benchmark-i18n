...
import o from "../i18n/locales/de/about.json";
import s from "../i18n/locales/de/blog.json";
import c from "../i18n/locales/de/careers.json";
import l from "../i18n/locales/de/contact.json";
import u from "../i18n/locales/de/faq.json";
import d from "../i18n/locales/de/home.json";
import f from "../i18n/locales/de/pricing.json";
import p from "../i18n/locales/de/products.json";
import m from "../i18n/locales/de/route.json";
import h from "../i18n/locales/de/settings.json";
import g from "../i18n/locales/de/shared.json";
import _ from "../i18n/locales/de/team.json";
import v from "../i18n/locales/es/about.json";
import y from "../i18n/locales/es/blog.json";
import b from "../i18n/locales/es/careers.json";
import x from "../i18n/locales/es/contact.json";
...
import O from "../i18n/locales/es/shared.json";
import ee from "../i18n/locales/es/team.json";
import te from "../i18n/locales/fr/about.json";
import ne from "../i18n/locales/fr/blog.json";
import re from "../i18n/locales/fr/careers.json";
import ie from "../i18n/locales/fr/contact.json";
import ae from "../i18n/locales/fr/faq.json";
import oe from "../i18n/locales/fr/home.json";
import se from "../i18n/locales/fr/pricing.json";
import ce from "../i18n/locales/fr/products.json";
import le from "../i18n/locales/fr/route.json";
import ue from "../i18n/locales/fr/settings.json";
import de from "../i18n/locales/fr/shared.json";
import fe from "../i18n/locales/fr/team.json";
import pe from "../i18n/locales/it/about.json";
import me from "../i18n/locales/it/blog.json";
import he from "../i18n/locales/it/careers.json";
import ge from "../i18n/locales/it/contact.json";
import _e from "../i18n/locales/it/faq.json";
import ve from "../i18n/locales/it/home.json";
import ye from "../i18n/locales/it/pricing.json";
import be from "../i18n/locales/it/products.json";
import xe from "../i18n/locales/it/route.json";
import Se from "../i18n/locales/it/settings.json";
import Ce from "../i18n/locales/it/shared.json";
import we from "../i18n/locales/it/team.json";
import Te from "../i18n/locales/ja/about.json";
import Ee from "../i18n/locales/ja/blog.json";
import De from "../i18n/locales/ja/careers.json";
import Oe from "../i18n/locales/ja/contact.json";
import ke from "../i18n/locales/ja/faq.json";
import Ae from "../i18n/locales/ja/home.json";
import je from "../i18n/locales/ja/pricing.json";
import Me from "../i18n/locales/ja/products.json";
import Ne from "../i18n/locales/ja/route.json";
import Pe from "../i18n/locales/ja/settings.json";
import Fe from "../i18n/locales/ja/shared.json";
import Ie from "../i18n/locales/ja/team.json";
import Le from "../i18n/locales/ko/about.json";
import Re from "../i18n/locales/ko/blog.json";
import ze from "../i18n/locales/ko/careers.json";
import Be from "../i18n/locales/ko/contact.json";
import Ve from "../i18n/locales/ko/faq.json";
import He from "../i18n/locales/ko/home.json";
import Ue from "../i18n/locales/ko/pricing.json";
import We from "../i18n/locales/ko/products.json";
import Ge from "../i18n/locales/ko/route.json";
import Ke from "../i18n/locales/ko/settings.json";
import qe from "../i18n/locales/ko/shared.json";
import Je from "../i18n/locales/ko/team.json";
import Ye from "../i18n/locales/pt/about.json";
import Xe from "../i18n/locales/pt/blog.json";
import Ze from "../i18n/locales/pt/careers.json";
import Qe from "../i18n/locales/pt/contact.json";
import $e from "../i18n/locales/pt/faq.json";
import et from "../i18n/locales/pt/home.json";
import tt from "../i18n/locales/pt/pricing.json";
import nt from "../i18n/locales/pt/products.json";
import rt from "../i18n/locales/pt/route.json";
import it from "../i18n/locales/pt/settings.json";
import at from "../i18n/locales/pt/shared.json";
import ot from "../i18n/locales/pt/team.json";
import st from "../i18n/locales/ru/about.json";
import ct from "../i18n/locales/ru/blog.json";
import lt from "../i18n/locales/ru/careers.json";
import ut from "../i18n/locales/ru/contact.json";
import dt from "../i18n/locales/ru/faq.json";
import ft from "../i18n/locales/ru/home.json";
import pt from "../i18n/locales/ru/pricing.json";
import mt from "../i18n/locales/ru/products.json";
import ht from "../i18n/locales/ru/route.json";
import gt from "../i18n/locales/ru/settings.json";
import _t from "../i18n/locales/ru/shared.json";
import vt from "../i18n/locales/ru/team.json";
import yt from "../i18n/locales/zh/about.json";
import bt from "../i18n/locales/zh/blog.json";
import xt from "../i18n/locales/zh/careers.json";
import St from "../i18n/locales/zh/contact.json";
import Ct from "../i18n/locales/zh/faq.json";
import wt from "../i18n/locales/zh/home.json";
import Tt from "../i18n/locales/zh/pricing.json";
import Et from "../i18n/locales/zh/products.json";
import Dt from "../i18n/locales/zh/route.json";
import Ot from "../i18n/locales/zh/settings.json";
import kt from "../i18n/locales/zh/shared.json";
import At from "../i18n/locales/zh/team.json";
var jt = [
	"en",
	"fr",
	"es",
...
var k = (e) => typeof e == "string", A = () => {
...
}, j = (e) => e == null ? "" : String(e), Pt = (e, t, n) => {
	e.forEach((e) => {
		t[e] && (n[e] = t[e]);
	});
}, Ft = /###/g, M = (e) => e && e.includes("###") ? e.replace(Ft, ".") : e, N = (e) => !e || k(e), P = (e, t, n) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? k(e[r]) || e[r] instanceof String || k(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : L(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, R = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), Rt = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, zt = (e) => k(e) ? e.replace(/[&<>"'\/]/g, (e) => Rt[e]) : e, Bt = class {
	constructor(e) {
	...
	"!",
	";"
], Ht = new Bt(20), Ut = (e, t, n) => {
	t ||= "", n ||= "";
	let r = Vt.filter((e) => !t.includes(e) && !n.includes(e));
	if (r.length === 0) return !0;
	let i = Ht.getRegExp(`(${r.map((e) => e === "?" ? "\\?" : e).join("|")})`), a = !i.test(e);
	if (!a) {
		let t = e.indexOf(n);
	...
	getResource(e, t, n, r = {}) {
		...
		let s = I(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !k(n) ? s : z(this.data?.[e]?.[t], n, i);
	}
	...
	addResourceBundle(e, t, n, r, i, a = {
		...
		let s = I(this.data, o) || {};
		a.skipCopy || (n = JSON.parse(JSON.stringify(n))), r ? L(s, n, i) : s = {
			...s,
			...n
...
function K(e, t) {
	let { [G]: n } = e(Gt()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var q = (e) => !k(e) && typeof e != "boolean" && typeof e != "number", J = class e extends H {
	constructor(e, t = {}) {
		super(), Pt([
			"resourceStore",
			"languageUtils",
			...
			"i18nFormat",
			"utils"
		], e, this), this.options = t, this.options.keySeparator === void 0 && (this.options.keySeparator = "."), this.logger = V.create("translator"), this.checkedLoadedFor = {};
	}
	changeLanguage(e) {
		e && (this.language = e);
	}
	...
	extractFromKey(e, t) {
		...
		n === void 0 && (n = ":");
		let r = t.keySeparator === void 0 ? this.options.keySeparator : t.keySeparator, i = t.ns || this.options.defaultNS || [], a = n && e.includes(n), o = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !Ut(e, n, r);
		if (a && !o) {
	...
	translate(t, n, r) {
		...
		y && !m && x && (E = T);
		let D = q(E), O = Object.prototype.toString.apply(E);
		if (y && E && D && !_.includes(O) && !(k(v) && Array.isArray(E))) {
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return k(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? K(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	getRule(e, t = {}) {
		...
		try {
			...
			if (typeof Intl > "u") return this.logger.error("No Intl support, please use an Intl polyfill!"), Jt;
			if (!e.match(/-|_/)) return Jt;
	...
	getSuffixes(e, t = {}) {
		let n = this.getRule(e, t);
		return n ||= this.getRule("dev", t), n ? n.resolvedOptions().pluralCategories.sort((e, t) => qt[e] - qt[t]).map((e) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${e}`) : [];
	}
	getSuffix(e, t, n = {}) {
	...
	let a = Lt(e, t, n);
	return !a && i && k(n) && (a = z(e, n, r), a === void 0 && (a = z(t, n, r))), a;
}, Y = (e) => e.replace(/\$/g, "$$$$"), Zt = class {
	constructor(e = {}) {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? zt : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? R(i) : a || "{{", this.suffix = o ? R(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? R(d) : f || R("$t("), this.nestingSuffix = p ? R(p) : m || R(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		let i, a, o, s = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (e) => {
			if (!e.includes(this.formatSeparator)) {
				let i = Xt(t, s, e, this.options.keySeparator, this.options.ignoreJSONStructure);
			...
			return this.format(Xt(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
				...r,
				...t,
				interpolationkey: a
			});
	...
	format(e, t, n, r = {}) {
		...
		return i.reduce((e, t) => {
			let { formatName: i, formatOptions: a } = Qt(t);
			if (this.formats[i]) {
				let t = e;
				try {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			It(n.loaded, [i], a), nn(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), an = (e) => (k(e.ns) && (e.ns = [e.ns]), k(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), k(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), Z = () => {}, on = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Q = class e extends H {
	constructor(e = {}, t) {
		if (super(), this.options = an(e), this.services = {}, this.logger = V, this.modules = { external: [] }, on(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		...
		if (!this.options.isClone) {
			...
			let e;
			e = this.modules.formatter ? this.modules.formatter : tn;
			let t = new Kt(this.options);
			this.store = new U(this.options.resources, this.options);
			let n = this.services;
			n.logger = V, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new Yt(t, { prepend: this.options.pluralSeparator }), e && (n.formatter = r(e), n.formatter.init && n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new Zt(this.options), n.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }, n.backendConnector = new rn(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (e, ...t) => {
				this.emit(e, ...t);
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new Kt(X());
	...
	cloneInstance(t = {}, n = Z) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a.services.interpolator = new Zt(n);
		}
...
var sn = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, cn = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
...
function pn({ i18n: e, defaultNS: r, children: i }) {
	let a = n(() => ({
		i18n: e,
		defaultNS: r
	}), [e, r]);
	return t(fn.Provider, { value: a }, i);
}
Q.use(dn).init({
	resources: {
		de: {
