...
import S from "../i18n/locales/es/blog.json";
import C from "../i18n/locales/es/careers.json";
import w from "../i18n/locales/es/contact.json";
import T from "../i18n/locales/es/faq.json";
import E from "../i18n/locales/es/home.json";
import D from "../i18n/locales/es/pricing.json";
import O from "../i18n/locales/es/products.json";
import ee from "../i18n/locales/es/route.json";
import k from "../i18n/locales/es/settings.json";
...
var A = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), Nt = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
}, It = /###/g, Lt = (e) => e && e.includes("###") ? e.replace(It, ".") : e, Rt = (e) => !e || j(e), N = (e, t, n) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? j(e[r]) || e[r] instanceof String || j(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : Ht(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, F = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), Ut = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, Wt = (e) => j(e) ? e.replace(/[&<>"'\/]/g, (e) => Ut[e]) : e, Gt = class {
	constructor(e) {
...
var V = (e) => !j(e) && typeof e != "boolean" && typeof e != "number", H = class e extends z {
	...
	getRule(e, t = {}) {
		...
		try {
			...
			if (typeof Intl > "u") return this.logger.error("No Intl support, please use an Intl polyfill!"), en;
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? Wt : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? F(i) : a || "{{", this.suffix = o ? F(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? F(d) : f || F("$t("), this.nestingSuffix = p ? F(p) : m || F(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		let i, a, o, s = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (e) => {
			if (!e.includes(this.formatSeparator)) {
				let i = nn(t, s, e, this.options.keySeparator, this.options.ignoreJSONStructure);
			...
			return this.format(nn(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
				...r,
				...t,
				interpolationkey: a
			});
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				else !j(a) && !this.useRawValueToEscape && (a = Pt(a));
				let s = t.safeValue(a);
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			j(i) || (i = Pt(i)), i ||= (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), ""), s.length && (i = s.reduce((e, t) => this.format(e, t, n.lng, {
				...n,
	...
	addCached(e, t) {
		this.formats[e.toLowerCase().trim()] = on(t);
	}
	format(e, t, n, r = {}) {
		...
		return i.reduce((e, t) => {
			let { formatName: i, formatOptions: a } = an(t);
			if (this.formats[i]) {
				let t = e;
				try {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			Bt(n.loaded, [i], a), ln(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), dn = (e) => (j(e.ns) && (e.ns = [e.ns]), j(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), j(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), q = () => {}, fn = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, J = class e extends z {
	constructor(e = {}, t) {
		if (super(), this.options = dn(e), this.services = {}, this.logger = R, this.modules = { external: [] }, fn(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		...
		if (!this.options.isClone) {
			...
			let e;
			e = this.modules.formatter ? this.modules.formatter : cn;
			let t = new U(this.options);
			this.store = new Xt(this.options.resources, this.options);
			let n = this.services;
			n.logger = R, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new tn(t, { prepend: this.options.pluralSeparator }), e && (n.formatter = r(e), n.formatter.init && n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new rn(this.options), n.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }, n.backendConnector = new un(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (e, ...t) => {
				this.emit(e, ...t);
	...
	cloneInstance(t = {}, n = q) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a.services.interpolator = new rn(n);
		}
...
var pn = (e, t, n, r) => {
	...
	Q(n) && mn[n] || (Q(n) && (mn[n] = /* @__PURE__ */ new Date()), pn(e, t, n, r));
}, hn = (e, t) => () => {
	...
	e.loadNamespaces(t, hn(e, n));
}, Z = (e, t, n, r) => {
	if (Q(n) && (n = [n]), e.options.preload && e.options.preload.indexOf(t) > -1) return X(e, n, r);
	n.forEach((t) => {
		e.options.ns.indexOf(t) < 0 && e.options.ns.push(t);
	}), e.loadLanguages(t, hn(e, r));
}, gn = (e, t, n = {}) => !t.languages || !t.languages.length ? (Y(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Q = (e) => typeof e == "string", _n = (e) => typeof e == "object" && !!e, vn = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, yn = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	process.env.NODE_ENV === "production" ? t.exports = kn() : t.exports = An();
}))(), Mn = {
	t: (e, t) => {
		if (Q(t)) return t;
		if (_n(t) && Q(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: c } = t, { i18n: l, defaultNS: u } = r(Dn) || {}, d = c || l || Tn();
	d && !d.reportNamespaces && (d.reportNamespaces = new On()), d || Y(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = a(() => ({
		...Sn(),
		...d?.options?.react,
		...t
	...
	let v = o(0), y = n((e) => {
		...
		if (!d) return Mn;
		let e = !!(d.isInitialized || d.initializedStoreOnce) && _.every((e) => gn(e, d, f)), n = t.lng || d.language, r = v.current, i = b.current;
		...
		f,
		t.lng
	]), [S, C] = s(0), { t: w, ready: T } = (0, jn.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
...
function Fn({ i18n: e, defaultNS: n, children: r }) {
	let i = a(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
	return t(Dn.Provider, { value: i }, r);
}
var In = () => {
	let { t: e } = Pn("shared");
	return c("div", {
