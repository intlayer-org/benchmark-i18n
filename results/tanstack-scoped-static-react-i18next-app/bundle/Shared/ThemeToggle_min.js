...
var k = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), Pt = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
}, Lt = /###/g, Rt = (e) => e && e.includes("###") ? e.replace(Lt, ".") : e, zt = (e) => !e || A(e), M = (e, t, n) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? A(e[r]) || e[r] instanceof String || A(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : Ut(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, P = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), Wt = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, Gt = (e) => A(e) ? e.replace(/[&<>"'\/]/g, (e) => Wt[e]) : e, Kt = class {
	constructor(e) {
...
var B = (e) => !A(e) && typeof e != "boolean" && typeof e != "number", V = class e extends R {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? Gt : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? P(i) : a || "{{", this.suffix = o ? P(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? P(d) : f || P("$t("), this.nestingSuffix = p ? P(p) : m || P(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				else !A(a) && !this.useRawValueToEscape && (a = Ft(a));
				let s = t.safeValue(a);
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			A(i) || (i = Ft(i)), i ||= (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), ""), s.length && (i = s.reduce((e, t) => this.format(e, t, n.lng, {
				...n,
...
}), fn = (e) => (A(e.ns) && (e.ns = [e.ns]), A(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), A(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), K = () => {}, pn = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, q = class e extends R {
	constructor(e = {}, t) {
		if (super(), this.options = fn(e), this.services = {}, this.logger = L, this.modules = { external: [] }, pn(this), t && !this.isInitialized && !e.isClone) {
...
var mn = (e, t, n, r) => {
	...
	Z(n) && hn[n] || (Z(n) && (hn[n] = /* @__PURE__ */ new Date()), mn(e, t, n, r));
}, gn = (e, t) => () => {
...
}, _n = (e, t, n = {}) => !t.languages || !t.languages.length ? (J(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Z = (e) => typeof e == "string", vn = (e) => typeof e == "object" && !!e, yn = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, bn = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (Z(t)) return t;
		if (vn(t) && Z(t.defaultValue)) return t.defaultValue;
	...
	d && !d.reportNamespaces && (d.reportNamespaces = new kn()), d || J(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = a(() => ({
		...Cn(),
		...d?.options?.react,
		...t
