...
import u from "../../../i18n/locales/de/about.json";
import d from "../../../i18n/locales/de/blog.json";
import f from "../../../i18n/locales/de/careers.json";
import p from "../../../i18n/locales/de/contact.json";
import m from "../../../i18n/locales/de/faq.json";
import h from "../../../i18n/locales/de/home.json";
import g from "../../../i18n/locales/de/pricing.json";
import _ from "../../../i18n/locales/de/products.json";
import v from "../../../i18n/locales/de/route.json";
import y from "../../../i18n/locales/de/settings.json";
import b from "../../../i18n/locales/de/shared.json";
import x from "../../../i18n/locales/de/team.json";
import S from "../../../i18n/locales/es/about.json";
import C from "../../../i18n/locales/es/blog.json";
import w from "../../../i18n/locales/es/careers.json";
import T from "../../../i18n/locales/es/contact.json";
import E from "../../../i18n/locales/es/faq.json";
import D from "../../../i18n/locales/es/home.json";
import O from "../../../i18n/locales/es/pricing.json";
import ee from "../../../i18n/locales/es/products.json";
import k from "../../../i18n/locales/es/route.json";
...
var A = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), Pt = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
}, Ft = (e) => e == null ? "" : String(e), It = (e, t, n) => {
	e.forEach((e) => {
		t[e] && (n[e] = t[e]);
	});
}, Lt = /###/g, Rt = (e) => e && e.includes("###") ? e.replace(Lt, ".") : e, zt = (e) => !e || j(e), N = (e, t, n) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? j(e[r]) || e[r] instanceof String || j(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : Ut(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, F = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), Wt = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, Gt = (e) => j(e) ? e.replace(/[&<>"'\/]/g, (e) => Wt[e]) : e, Kt = class {
	constructor(e) {
	...
	"!",
	";"
], Jt = new Kt(20), Yt = (e, t, n) => {
	t ||= "", n ||= "";
	let r = qt.filter((e) => !t.includes(e) && !n.includes(e));
	if (r.length === 0) return !0;
	let i = Jt.getRegExp(`(${r.map((e) => e === "?" ? "\\?" : e).join("|")})`), a = !i.test(e);
	if (!a) {
		let t = e.indexOf(n);
	...
	init(e, t = {}) {
		this.prefix = t.prefix || "i18next:", this.logger = e || Xt, this.options = t, this.debug = t.debug;
	}
	log(...e) {
	...
	addResource(e, t, n, r, i = { silent: !1 }) {
		...
		n && (o = o.concat(a ? n.split(a) : n)), e.includes(".") && (o = e.split("."), r = t, t = o[1]), this.addNamespaces(t), Bt(this.data, o, r), i.silent || this.emit("added", e, t, n, r);
	}
	...
	addResourceBundle(e, t, n, r, i, a = {
		...
		let s = P(this.data, o) || {};
		a.skipCopy || (n = JSON.parse(JSON.stringify(n))), r ? Ut(s, n, i) : s = {
			...s,
			...n
		}, Bt(this.data, o, s), a.silent || this.emit("added", e, t, n);
	}
...
var V = (e) => !j(e) && typeof e != "boolean" && typeof e != "number", H = class e extends z {
	...
	extractFromKey(e, t) {
		...
		n === void 0 && (n = ":");
		let r = t.keySeparator === void 0 ? this.options.keySeparator : t.keySeparator, i = t.ns || this.options.defaultNS || [], a = n && e.includes(n), o = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !Yt(e, n, r);
		if (a && !o) {
	...
	extendTranslation(e, t, n, r, i) {
		...
		return e != null && o?.length && n.applyPostProcessor !== !1 && (e = Qt.handle(o, e, t, this.options && this.options.postProcessPassResolved ? {
			i18nResolved: {
				...r,
	...
	getRule(e, t = {}) {
		...
		try {
			...
			if (typeof Intl > "u") return this.logger.error("No Intl support, please use an Intl polyfill!"), tn;
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? Gt : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? F(i) : a || "{{", this.suffix = o ? F(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? F(d) : f || F("$t("), this.nestingSuffix = p ? F(p) : m || F(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		let i, a, o, s = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (e) => {
			if (!e.includes(this.formatSeparator)) {
				let i = rn(t, s, e, this.options.keySeparator, this.options.ignoreJSONStructure);
			...
			return this.format(rn(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
				...r,
				...t,
				interpolationkey: a
			});
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				else !j(a) && !this.useRawValueToEscape && (a = Ft(a));
				let s = t.safeValue(a);
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			j(i) || (i = Ft(i)), i ||= (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), ""), s.length && (i = s.reduce((e, t) => this.format(e, t, n.lng, {
				...n,
	...
	addCached(e, t) {
		this.formats[e.toLowerCase().trim()] = sn(t);
	}
	format(e, t, n, r = {}) {
		...
		return i.reduce((e, t) => {
			let { formatName: i, formatOptions: a } = on(t);
			if (this.formats[i]) {
				let t = e;
				try {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			Vt(n.loaded, [i], a), un(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), fn = (e) => (j(e.ns) && (e.ns = [e.ns]), j(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), j(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), q = () => {}, pn = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, J = class e extends z {
	constructor(e = {}, t) {
		if (super(), this.options = fn(e), this.services = {}, this.logger = R, this.modules = { external: [] }, pn(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		...
		if (!this.options.isClone) {
			...
			let e;
			e = this.modules.formatter ? this.modules.formatter : ln;
			let t = new U(this.options);
			this.store = new Zt(this.options.resources, this.options);
			let n = this.services;
			n.logger = R, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new nn(t, { prepend: this.options.pluralSeparator }), e && (n.formatter = r(e), n.formatter.init && n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new an(this.options), n.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }, n.backendConnector = new dn(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (e, ...t) => {
				this.emit(e, ...t);
	...
	cloneInstance(t = {}, n = q) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a[e] = this[e];
		}), a.services = { ...this.services }, a.services.utils = { hasLoadedNamespace: a.hasLoadedNamespace.bind(a) }, r && (a.store = new Zt(Object.keys(this.store.data).reduce((e, t) => (e[t] = { ...this.store.data[t] }, e[t] = Object.keys(e[t]).reduce((n, r) => (n[r] = { ...e[t][r] }, n), e[t]), e), {}), i), a.services.resourceStore = a.store), t.interpolation) {
			let e = {
				...K().interpolation,
				...this.options.interpolation,
				...t.interpolation
			...
			a.services.interpolator = new an(n);
		}
...
var mn = (e, t, n, r) => {
	...
	Q(n) && hn[n] || (Q(n) && (hn[n] = /* @__PURE__ */ new Date()), mn(e, t, n, r));
}, gn = (e, t) => () => {
	...
	e.loadNamespaces(t, gn(e, n));
}, Z = (e, t, n, r) => {
	if (Q(n) && (n = [n]), e.options.preload && e.options.preload.indexOf(t) > -1) return X(e, n, r);
	n.forEach((t) => {
		e.options.ns.indexOf(t) < 0 && e.options.ns.push(t);
	}), e.loadLanguages(t, gn(e, r));
}, _n = (e, t, n = {}) => !t.languages || !t.languages.length ? (Y(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Q = (e) => typeof e == "string", vn = (e) => typeof e == "object" && !!e, yn = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, bn = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (Q(t)) return t;
		if (vn(t) && Q(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: c } = t, { i18n: l, defaultNS: u } = r(On) || {}, d = c || l || En();
	d && !d.reportNamespaces && (d.reportNamespaces = new kn()), d || Y(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = a(() => ({
		...Cn(),
		...d?.options?.react,
		...t
	...
	let v = o(0), y = n((e) => {
		...
		if (!d) return Nn;
		let e = !!(d.isInitialized || d.initializedStoreOnce) && _.every((e) => _n(e, d, f)), n = t.lng || d.language, r = v.current, i = b.current;
		...
		f,
		t.lng
	]), [S, C] = s(0), { t: w, ready: T } = (0, Mn.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
...
function In({ i18n: e, defaultNS: n, children: r }) {
	let i = a(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
	return t(On.Provider, { value: i }, r);
}
function Ln() {
	let { t: e } = Fn("team");
	return c("div", {
