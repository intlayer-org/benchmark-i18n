			...
			children: [jsxs("div", {
				...
				children: [jsx(Link, {
					...
					children: [
						jsx(Link, {
							...
							className: "nav-link",
							children: jsx(MemoizedFormattedMessage, { id: "header.home" })
						}),
						jsx(Link, {
							preload: false,
							to: "/$locale/about",
							...
							activeProps: { className: "is-active" },
							className: "nav-link",
							children: jsx(MemoizedFormattedMessage, { id: "header.methodology" })
						}),
						jsxs("div", {
							className: "relative",
							children: [jsxs("button", {
								...
								children: [jsx(MemoizedFormattedMessage, { id: "header.mockPages" }), jsx(ChevronDown, {
									size: 14,
								...
								children: jsx("div", {
									...
									children: [
										...
										children: jsx(MemoizedFormattedMessage, { id: page.id })
									}, page.to))
								})
							})]
						})
				...
				children: [
					jsxs("a", {
						...
						children: [jsx("span", {
							className: "sr-only",
							children: jsx(MemoizedFormattedMessage, { id: "header.goToGithub" })
						}), jsx("svg", {
							viewBox: "0 0 16 16",
							"aria-hidden": "true",
							width: "20",
...
async function getMessages(locale, namespaces = ["shared", "route"]) {
	...
	for (const ns of namespaces) try {
		const messages = await _rolldown_dynamic_import_helper_default(Object.assign({
			"../messages/de/about.json": () => import("./about-CQh1zV4U.js"),
			"../messages/de/blog.json": () => import("./blog-vgG0SdKx.js"),
			"../messages/de/careers.json": () => import("./careers-D3cPnlZb.js"),
			"../messages/de/contact.json": () => import("./contact-BA4Zwve1.js"),
			"../messages/de/faq.json": () => import("./faq-DkrDTUwZ.js"),
			"../messages/de/home.json": () => import("./home-BLKYZ394.js"),
			"../messages/de/pricing.json": () => import("./pricing-B8Jdn290.js"),
			"../messages/de/products.json": () => import("./products-BoDFDq7R.js"),
			"../messages/de/route.json": () => import("./route-C6kEq9O0.js"),
			"../messages/de/settings.json": () => import("./settings-Dkn1IJCw.js"),
			"../messages/de/shared.json": () => import("./shared-CZ-AUqTF.js"),
			"../messages/de/team.json": () => import("./team-ghrQSNYP.js"),
			"../messages/en/about.json": () => import("./about-imhEHqgd.js"),
			"../messages/en/blog.json": () => import("./blog-Ct9pNU-x.js"),
			"../messages/en/careers.json": () => import("./careers-CikkpL4b.js"),
			"../messages/en/contact.json": () => import("./contact-BP2s6RCt.js"),
			"../messages/en/faq.json": () => import("./faq-MlAs5Jc2.js"),
			"../messages/en/home.json": () => import("./home-BAUlyM62.js"),
			"../messages/en/pricing.json": () => import("./pricing-R8SXJylp.js"),
			"../messages/en/products.json": () => import("./products-DUYSrNmK.js"),
			"../messages/en/route.json": () => import("./route-D4J5jMKf.js"),
			"../messages/en/settings.json": () => import("./settings-3t8rcskE.js"),
			"../messages/en/shared.json": () => import("./shared-CiKUOU02.js"),
			"../messages/en/team.json": () => import("./team-C1UFKjIS.js"),
			"../messages/es/about.json": () => import("./about-IbJxvqq3.js"),
			"../messages/es/blog.json": () => import("./blog-BrhAGvJr.js"),
			"../messages/es/careers.json": () => import("./careers-zF0TJhTk.js"),
			"../messages/es/contact.json": () => import("./contact-DBHz73Re.js"),
			"../messages/es/faq.json": () => import("./faq-C4q2bWGi.js"),
			"../messages/es/home.json": () => import("./home-DU4odRu_.js"),
			"../messages/es/pricing.json": () => import("./pricing-BfUvRZWx.js"),
			"../messages/es/products.json": () => import("./products-PFF2lXBc.js"),
			"../messages/es/route.json": () => import("./route-BHQHTPzm.js"),
			"../messages/es/settings.json": () => import("./settings-Cqe4XoNf.js"),
			"../messages/es/shared.json": () => import("./shared-B72ESmZB.js"),
			"../messages/es/team.json": () => import("./team-yIMWA5vm.js"),
			"../messages/fr/about.json": () => import("./about-DqCZdbHt.js"),
			"../messages/fr/blog.json": () => import("./blog-BAo8AL87.js"),
			"../messages/fr/careers.json": () => import("./careers-CsC0N91v.js"),
			"../messages/fr/contact.json": () => import("./contact-BxCTRI2d.js"),
			"../messages/fr/faq.json": () => import("./faq-BFhxBUPp.js"),
			"../messages/fr/home.json": () => import("./home-BrWiWPXQ.js"),
			"../messages/fr/pricing.json": () => import("./pricing-ThYXPkPA.js"),
			"../messages/fr/products.json": () => import("./products-BGLucUYh.js"),
			"../messages/fr/route.json": () => import("./route-6PoNOj8z.js"),
			"../messages/fr/settings.json": () => import("./settings-CrXQIR0C.js"),
			"../messages/fr/shared.json": () => import("./shared-hkugd_Hm.js"),
			"../messages/fr/team.json": () => import("./team-4xj0ZJ-Z.js"),
			"../messages/it/about.json": () => import("./about-M-UKmBcL.js"),
			"../messages/it/blog.json": () => import("./blog-Cir5rQtg.js"),
			"../messages/it/careers.json": () => import("./careers-Dj5uV7SW.js"),
			"../messages/it/contact.json": () => import("./contact-CZFZj6_h.js"),
			"../messages/it/faq.json": () => import("./faq-B8E_w4Mt.js"),
			"../messages/it/home.json": () => import("./home-BQgCK3-u.js"),
			"../messages/it/pricing.json": () => import("./pricing-DO1_IVHI.js"),
			"../messages/it/products.json": () => import("./products-W4PMcXLS.js"),
			"../messages/it/route.json": () => import("./route-h449QsMq.js"),
			"../messages/it/settings.json": () => import("./settings-OQQln7YU.js"),
			"../messages/it/shared.json": () => import("./shared-F7IZrUzb.js"),
			"../messages/it/team.json": () => import("./team-CtnXbXPY.js"),
			"../messages/ja/about.json": () => import("./about-CNkhC3AO.js"),
			"../messages/ja/blog.json": () => import("./blog--f50A2Bm.js"),
			"../messages/ja/careers.json": () => import("./careers-CFflokni.js"),
			"../messages/ja/contact.json": () => import("./contact-CuRIqdms.js"),
			"../messages/ja/faq.json": () => import("./faq-BXJiRuDd.js"),
			"../messages/ja/home.json": () => import("./home-PprsGgXu.js"),
			"../messages/ja/pricing.json": () => import("./pricing-oWjT6Gd_.js"),
			"../messages/ja/products.json": () => import("./products-Cdjes8ey.js"),
			"../messages/ja/route.json": () => import("./route-C0OQVOhm.js"),
			"../messages/ja/settings.json": () => import("./settings-DKVTmb-R.js"),
			"../messages/ja/shared.json": () => import("./shared-h7Pm5_FW.js"),
			"../messages/ja/team.json": () => import("./team-Bi0Yzz3O.js"),
			"../messages/ko/about.json": () => import("./about-Do5Jgqvb.js"),
			"../messages/ko/blog.json": () => import("./blog-DnlTq--l.js"),
			"../messages/ko/careers.json": () => import("./careers-Dvom0U5y.js"),
			"../messages/ko/contact.json": () => import("./contact-BQjJ9F6l.js"),
			"../messages/ko/faq.json": () => import("./faq--FBBxm1X.js"),
			"../messages/ko/home.json": () => import("./home-DN_BD48W.js"),
			"../messages/ko/pricing.json": () => import("./pricing-Dlh135Zx.js"),
			"../messages/ko/products.json": () => import("./products-Cl3Y6F21.js"),
			"../messages/ko/route.json": () => import("./route-DEO5F6O0.js"),
			"../messages/ko/settings.json": () => import("./settings-uSWnj_Oc.js"),
			"../messages/ko/shared.json": () => import("./shared-ubd3j7n8.js"),
			"../messages/ko/team.json": () => import("./team-Bk18o48g.js"),
			"../messages/pt/about.json": () => import("./about-CPoyMfPi.js"),
			"../messages/pt/blog.json": () => import("./blog-D3U5aSoo.js"),
			"../messages/pt/careers.json": () => import("./careers-Csogc4nT.js"),
			"../messages/pt/contact.json": () => import("./contact-BF_RZIZx.js"),
			"../messages/pt/faq.json": () => import("./faq-FMmyEtwd.js"),
			"../messages/pt/home.json": () => import("./home-C2FhpvI2.js"),
			"../messages/pt/pricing.json": () => import("./pricing-gztSeTsk.js"),
			"../messages/pt/products.json": () => import("./products-C3RN-6-c.js"),
			"../messages/pt/route.json": () => import("./route-CGInh12m.js"),
			"../messages/pt/settings.json": () => import("./settings-DWHdfczP.js"),
			"../messages/pt/shared.json": () => import("./shared-C0r4gPNj.js"),
			"../messages/pt/team.json": () => import("./team-B65ZroW0.js"),
			"../messages/ru/about.json": () => import("./about-DJOi_4rL.js"),
			"../messages/ru/blog.json": () => import("./blog-DSnjvtJY.js"),
			"../messages/ru/careers.json": () => import("./careers-7KyDP69W.js"),
			"../messages/ru/contact.json": () => import("./contact-0ByHyOYb.js"),
			"../messages/ru/faq.json": () => import("./faq-HxaeFSoW.js"),
			"../messages/ru/home.json": () => import("./home-BlxVgsJn.js"),
			"../messages/ru/pricing.json": () => import("./pricing-DsmyjLQ6.js"),
			"../messages/ru/products.json": () => import("./products-CrhWZy9Q.js"),
			"../messages/ru/route.json": () => import("./route-DyzaJPCf.js"),
			"../messages/ru/settings.json": () => import("./settings-phF_fRbC.js"),
			"../messages/ru/shared.json": () => import("./shared-BpsQ0RUJ.js"),
			"../messages/ru/team.json": () => import("./team-C-bfGLMI.js"),
			"../messages/zh/about.json": () => import("./about-CFtfwjER.js"),
			"../messages/zh/blog.json": () => import("./blog-CRobkC9W.js"),
			"../messages/zh/careers.json": () => import("./careers-B-k1Jv6p.js"),
			"../messages/zh/contact.json": () => import("./contact-DZMGUSuK.js"),
			"../messages/zh/faq.json": () => import("./faq-B9O4ZOki.js"),
			"../messages/zh/home.json": () => import("./home-DslI3VWP.js"),
			"../messages/zh/pricing.json": () => import("./pricing-D4sAA6i1.js"),
			"../messages/zh/products.json": () => import("./products-CbPYJnLe.js"),
			"../messages/zh/route.json": () => import("./route-wUHLUKsF.js"),
			"../messages/zh/settings.json": () => import("./settings-Cfu1iozi.js"),
			"../messages/zh/shared.json": () => import("./shared-BhU6GPR_.js"),
			"../messages/zh/team.json": () => import("./team-CtUIxfsy.js")
