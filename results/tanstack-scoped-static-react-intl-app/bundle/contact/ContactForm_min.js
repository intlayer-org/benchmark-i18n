...
var Te = !!Object.fromEntries, Ee = !!String.prototype.trimStart, De = !!String.prototype.trimEnd, O = Te ? Object.fromEntries : function(e) {
	let t = {};
...
var Me = class {
	...
	parseIdentifierIfPossible() {
		let e = this.clonePosition(), t = this.offset(), n = Ae(this.message, t), r = t + n.length;
...
function j(e) {
	e.forEach((e) => {
		if (delete e.location, ve(e) || S(e)) for (let t in e.options) delete e.options[t].location, j(e.options[t].value);
		else he(e) && w(e.style) || (ge(e) || _e(e)) && T(e.style) ? delete e.style.location : C(e) && j(e.children);
	});
}
function Ie(e, t = {}) {
	t = {
...
function I(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (C(c)) {
			...
			if (!F(u)) throw new Le(l, "function", o);
...
function Ve(e, t) {
	return t ? Object.keys(e).reduce((n, r) => (n[r] = Be(e[r], t[r]), n), { ...e }) : e;
}
function L(e) {
	return { create() {
		return {
...
function qe(e = G()) {
	...
	return {
		getDateTimeFormat: i,
		getNumberFormat: a,
		getMessageFormat: s((e, t, n, r) => new R(e, t, n, {
			formatters: {
				getNumberFormat: a,
				getDateTimeFormat: i,
				getPluralRules: o
...
function Ye(e, t) {
	...
	return {
		...n,
		...e,
		date: Je(J(n.date, t), J(e.date || {}, t)),
		time: Je(J(n.time, t), J(e.time || {}, t))
	};
}
function Xe(e) {
...
var Y = ({ locale: e, formats: t, messages: n, defaultLocale: r, defaultFormats: i, fallbackOnEmptyString: a, onError: o, timeZone: s, defaultRichTextElements: c }, l, u = { id: "" }, d, f) => {
	...
	p || Ke(!1, `[@formatjs/intl] An \`id\` must be provided to format a message. You can either:
1. Configure your build toolchain with [babel-plugin-formatjs](https://formatjs.github.io/docs/tooling/babel-plugin)
or [@formatjs/ts-transformer](https://formatjs.github.io/docs/tooling/ts-transformer) OR
2. Configure your \`eslint\` config to include [eslint-plugin-formatjs](https://formatjs.github.io/docs/tooling/linter#enforce-id)
to autofix this issue${Xe(u)}`);
...
function pt({ locale: e, formats: t, onError: n }, r, i = {}) {
	let { format: a } = i;
	return r(e, U(i, ft, !!a && q(t, "relative", a, n) || {}));
}
...
function gt({ locale: e, formats: t, onError: n }, r, i = {}) {
	let { format: a } = i;
	return r(e, U(i, ht, a && q(t, "number", a, n) || {}));
}
function _t(e, t, n, r = {}) {
	try {
...
}, Tt = (t) => e.Children.toArray(t).map((t, n) => e.isValidElement(t) ? a(e.Fragment, { children: t }, n) : t);
function Et(e) {
	return function(t) {
		return e(Tt(t));
	};
...
var Dt = e.createContext(null), Ot = Dt.Provider;
function Q() {
...
function $(t) {
	let n = (n) => {
		let r = Q(), { value: i, children: o, ...s } = n, c = r[t](i, s);
		if (typeof o == "function") return o(c);
		let l = r.textComponent || e.Fragment;
		return a(l, { children: c });
	};
	return n.displayName = kt[t], n;
}
function Mt(e) {
	return e && Object.keys(e).reduce((t, n) => {
		let r = e[n];
		return t[n] = F(r) ? Et(r) : r, t;
	}, {});
}
var Nt = (e, t, n, r, ...i) => {
	let a = Y(e, t, n, Mt(r), ...i);
	return Array.isArray(a) ? Tt(a) : a;
}, Pt = ({ defaultRichTextElements: e, ...t }, n) => {
	let r = Mt(e), i = xt({
		...wt,
		...t,
	...
	return {
		...i,
		formatMessage: Nt.bind(null, a, i.formatters),
		$t: Nt.bind(null, a, i.formatters)
	};
};
function Ft(e, t) {
...
function It(t) {
	let { formatMessage: n, textComponent: r = e.Fragment } = Q(), { id: o, description: s, defaultMessage: c, values: l, children: u, tagName: d = r, ignoreTag: f } = t, p = n({
		id: o,
		description: s,
		defaultMessage: c
	}, l, { ignoreTag: f });
...
It.displayName = "FormattedMessage";
var Lt = e.memo(It, Ft);
Lt.displayName = "MemoizedFormattedMessage";
function Rt(e) {
	return {
		locale: e.locale,
		timeZone: e.timeZone,
...
function zt(t) {
	let n = e.useRef(G()), r = e.useRef(void 0), i = e.useRef(void 0), o = {};
	for (let e in t) t[e] !== void 0 && (o[e] = t[e]);
	let s = Rt({
		...wt,
		...o
	});
	return (!r.current || !Z(r.current, s)) && (r.current = s, i.current = Pt(s, n.current)), Ct(i.current), a(Ot, {
		value: i.current,
		children: t.children
	});
}
zt.displayName = "IntlProvider";
var Bt = zt;
$("formatDate"), $("formatTime"), $("formatNumber"), $("formatList"), $("formatDisplayName"), jt("formatDate"), jt("formatTime");
function Vt() {
	let e = Q(), t = r(), n = r(), i = r(), s = r();
	return o("form", {
		className: "space-y-6",
		children: [
			o("div", {
				...
				children: [o("div", { children: [a("label", {
					...
					children: e.formatMessage({ id: "contact-form.name" })
				}), a("input", {
					id: t,
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
					placeholder: e.formatMessage({ id: "contact-form.yourName" })
				})] }), o("div", { children: [a("label", {
					htmlFor: n,
					className: "mb-1 block text-sm font-medium text-foreground",
					children: e.formatMessage({ id: "contact-form.email" })
				}), a("input", {
					id: n,
					type: "email",
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
					placeholder: e.formatMessage({ id: "contact-form.emailPlaceholder" })
				})] })]
			}),
			o("div", { children: [a("label", {
				htmlFor: i,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: e.formatMessage({ id: "contact-form.topic" })
			}), o("select", {
				id: i,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				children: [
					a("option", { children: e.formatMessage({ id: "contact-form.bugReport" }) }),
					a("option", { children: e.formatMessage({ id: "contact-form.newBenchmarkIdea" }) }),
					a("option", { children: e.formatMessage({ id: "contact-form.methodologyQuestion" }) }),
					a("option", { children: e.formatMessage({ id: "contact-form.contribution" }) }),
					a("option", { children: e.formatMessage({ id: "contact-form.other" }) })
				]
			})] }),
			o("div", { children: [a("label", {
				htmlFor: s,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: e.formatMessage({ id: "contact-form.message" })
			}), a("textarea", {
				id: s,
				rows: 5,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: e.formatMessage({ id: "contact-form.describeYourQuestionOrIdea" })
			})] }),
			a("button", {
				type: "submit",
				className: "rounded-md bg-primary px-6 py-2.5 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity",
				children: e.formatMessage({ id: "contact-form.sendMessage" })
			})
		]
	});
}
...
async function Ut(e, t = ["shared", "route"]) {
	let n = {};
	for (let r of t) try {
		let t = await Ht(Object.assign({
