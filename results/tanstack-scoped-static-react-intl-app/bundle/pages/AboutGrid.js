	...
	return jsxs("div", {
		...
		children: [jsxs("div", {
			...
			children: [jsx("h2", {
				...
				children: intl.formatMessage({ id: "about-grid.whyThisExists" })
			}), jsx("p", {
				className: "text-sm text-muted-foreground",
				children: intl.formatMessage({ id: "about-grid.choosingAnI18nLibraryIs" })
			})]
		}), jsxs("div", {
			className: "rounded-lg border border-border bg-card p-6",
			children: [jsx("h2", {
				className: "mb-3 text-xl font-semibold text-foreground",
				children: intl.formatMessage({ id: "about-grid.methodology" })
			}), jsx("p", {
				className: "text-sm text-muted-foreground",
				children: intl.formatMessage({ id: "about-grid.theSame10PageApp" })
			})]
		})]
	});
}
