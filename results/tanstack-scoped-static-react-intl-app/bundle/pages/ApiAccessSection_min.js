...
function Vt() {
	...
	return o("section", {
		...
		children: [a("h2", {
			...
			children: e.formatMessage({ id: "api-access-section.apiAccess" })
		}), o("div", { children: [
			a("label", {
				htmlFor: t,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: e.formatMessage({ id: "api-access-section.apiKey" })
			}),
			o("div", {
				...
				children: [a("input", {
					...
					children: e.formatMessage({ id: "api-access-section.copy" })
				})]
			}),
			a("p", {
				className: "mt-1 text-xs text-muted-foreground",
				children: e.formatMessage({ id: "api-access-section.useThisKeyToAccess" })
			})
		] })]
	});
}
