...
var MockBanner = () => jsx("div", {
	...
	children: jsx(MemoizedFormattedMessage, { id: "mockBanner" })
});
function FAQHeader() {
	const intl = useIntl();
	return jsxs(Fragment, { children: [
		...
		jsx("h1", {
			...
			children: intl.formatMessage({ id: "faq-header1.frequentlyAskedQuestions" })
		}),
		jsx("p", {
			className: "mb-10 text-muted-foreground",
			children: intl.formatMessage({ id: "faq-header1.everythingYouNeedToKnow" })
		})
	] });
}
