...
function ProfileSection() {
	...
	return jsxs("section", {
		...
		children: [jsx("h2", {
			...
			children: intl.formatMessage({ id: "profile-section.profile" })
		}), jsxs("div", {
			className: "space-y-4",
			children: [jsxs("div", { children: [jsx("label", {
				htmlFor: displayNameId,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: intl.formatMessage({ id: "profile-section.displayName" })
			}), jsx("input", {
				id: displayNameId,
				...
				htmlFor: emailId,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: intl.formatMessage({ id: "profile-section.email" })
			}), jsx("input", {
				id: emailId,
