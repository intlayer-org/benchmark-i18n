...
function WhatWeMeasure() {
	...
	const metrics = [
		{
			...
			desc: intl.formatMessage({ id: "what-we-measure.theAdditionalJavascriptBytesSent" })
		},
		{
		...
		{
			metric: intl.formatMessage({ id: "what-we-measure.lazyLoadingEffectiveness" }),
			desc: intl.formatMessage({ id: "what-we-measure.whetherSplittingTranslationsByRoute" })
		},
		{
	...
	return jsxs("section", {
		...
		children: [jsx("h2", {
			...
			children: intl.formatMessage({ id: "what-we-measure.whatWeMeasure" })
		}), jsx("ul", {
			className: "space-y-4",
