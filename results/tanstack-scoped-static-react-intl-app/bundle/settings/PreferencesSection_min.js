		...
		children: [a("h2", {
			...
			children: [
				...
				o("div", { children: [a("label", {
					...
					children: [
						a("option", { children: e.formatMessage({ id: "preferences-section.englishEn" }) }),
						a("option", { children: e.formatMessage({ id: "preferences-section.frenchFr" }) }),
						a("option", { children: e.formatMessage({ id: "preferences-section.germanDe" }) }),
						a("option", { children: e.formatMessage({ id: "preferences-section.spanishEs" }) }),
						a("option", { children: e.formatMessage({ id: "preferences-section.japaneseJa" }) }),
						a("option", { children: e.formatMessage({ id: "preferences-section.chineseSimplifiedZhCn" }) }),
						a("option", { children: e.formatMessage({ id: "preferences-section.arabicAr" }) })
					]
				})] })
			]
		})]
