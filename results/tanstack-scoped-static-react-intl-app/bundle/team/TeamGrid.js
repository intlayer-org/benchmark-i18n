...
function TeamGrid() {
	...
	const members = [
		...
		},
		{
			...
			bio: intl.formatMessage({ id: "team-grid.specializesInJavascriptPerformanceOptimization" })
		},
		{
			name: intl.formatMessage({ id: "team-grid.aishaPatel" }),
			role: intl.formatMessage({ id: "team-grid.developerAdvocate" }),
			bio: intl.formatMessage({ id: "team-grid.passionateAboutDeveloperExperienceAnd" })
		},
		{
			name: intl.formatMessage({ id: "team-grid.tomasRodriguez" }),
			role: intl.formatMessage({ id: "team-grid.fullStackDeveloper" }),
			bio: intl.formatMessage({ id: "team-grid.maintainsTheBenchmarkingInfrastructureAnd" })
		},
		{
		...
		},
		{
			...
			bio: intl.formatMessage({ id: "team-grid.managesCommunityContributionsPartnershipsAnd" })
		}
	];
	return jsx("div", {
