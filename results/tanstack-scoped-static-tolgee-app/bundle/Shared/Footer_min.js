...
var Jc = () => {
	...
	let { tolgee: r, options: a } = Jc(), s = Yo(e), c = M(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Yc(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
}, rl = zc.reduce((e, t) => (e[t] = Rc(t), e), {}), il = Js().use(Ds()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: rl
...
function ol() {
	let { t: e } = al(), t = l({ strict: !1 }).locale ?? "en", n = [
		{
