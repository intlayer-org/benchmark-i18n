...
for (let [e, t] of Object.entries(Wt)) {
...
var Jt = { useSuspense: !1 }, Yt, Xt = () => (Yt ||= e.createContext(void 0), Yt), Z = void 0, Zt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = qt(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, Jt), r), h = Xt();
	...
	let { tolgee: r, options: a } = Qt(), s = D(e), c = O(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = $t(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
			...
			children: [d("div", {
				...
				children: [
					d("div", { children: [u("h3", {
						...
						children: u($, { keyName: "footer.anOpenSourceTestApplication" })
					})] }),
					d("div", { children: [u("h3", {
						className: "mb-2 text-sm font-semibold text-foreground",
						children: u($, { keyName: "footer.resources" })
					}), u("ul", {
						className: "space-y-1",
					...
					d("div", { children: [u("h3", {
						className: "mb-2 text-sm font-semibold text-foreground",
						children: u($, { keyName: "footer.contact" })
					}), u("p", {
						className: "text-sm text-muted-foreground",
				...
				children: u($, { keyName: "footer.builtWith" })
			})]
		})
	});
}
