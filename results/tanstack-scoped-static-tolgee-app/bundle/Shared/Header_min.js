...
}, A = (e) => Object.fromEntries(de(e).entries()), j = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function Se(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return E(s.onError, (e) => new ge("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
		if (!l.languageDetector) return;
		let e = n();
		return E(s.onError, (e) => new he("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function C(e) {
		e && l.backends.push(e);
	}
	...
	let D = Object.freeze({
		...
		getInitialLanguage() {
			let e = n();
			return T(S(), (t) => (!e || e.includes(t)) && t ? t : ee());
		},
		setStoredLanguage(e) {
			return E(s.onError, (e) => new ge("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = oe(e) || P, r = t().onFormatError, a = typeof r;
...
function we(e, t, n) {
	let r = xe(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? k([t, ...ie(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
function Ee({ options: e }) {
	let t = pe(), n = Ce(!1, () => o.isFetching(), t.onFetchingChange.emit), r = Ce(!1, () => S.isLoading(), t.onLoadingChange.emit), i = we(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = Se(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = _e(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Oe = () => {
	let e = {
		...
		init(t) {
			let n = De(F(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, ke = 0, L = 1, Ae = 2, je = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === ke ? r = "Empty parameter" : e === L ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Me(e) {
	return /\s/.test(e);
}
var R = 0, z = 1, B = 2, V = 3, H = 4, Ne = /* @__PURE__ */ new Set([
	B,
	z,
	R
]), U = "'", Pe = /* @__PURE__ */ new Set([
	"{",
	"}",
	U
...
function Ie(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case R:
			...
			break;
		case z:
			Pe.has(i) ? (n = n.slice(0, -1) + i, t = B) : (n += i, t = R);
			break;
		case B:
			i === U ? t = R : (n += i, t = B);
			break;
		case V:
			i === "}" ? (d(), t = R) : Me(i) ? r !== "" && (d(), t = H) : (u(), t = V);
			break;
		case H: i == "}" ? t = R : Me(i) ? t = H : c(L);
	}
...
(C = console.assert) == null || C.call(console, Ue), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function We(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, $e = 3e3, et = 200, tt = 0, K = /* @__PURE__ */ new Map(), nt = !1, q, J;
...
var it = (e) => new G("unavailable", `the Tolgee browser extension did not answer ${e} in time`), at = () => `${Date.now()}-${tt++}-${Math.random()}`;
function ot() {
...
function st(e) {
	return q ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Xe }, window.origin), i = () => {
			clearInterval(a), ct(), J = void 0, n(new G("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Y = "__tolgee_", Tt = `${Y}apiKey`, Et = `${Y}apiUrl`, Dt = `${Y}branch`, Ot = `${Y}projectId`, kt = `${Y}session`, At = "tolgee-in-context-tools.umd.min.js", jt = "@tolgee/in-context-tools", Mt = "InContextTools", Nt = "https://cdn.jsdelivr.net/npm", Pt = null;
function Ft(e) {
...
function Vt() {
	...
	if (e) return ee(S({}, a), { apiKey: e });
	if (i && r) return ee(S({}, a), { transport: lt() });
}
function Ht() {
	let e = [];
...
for (let [e, t] of Object.entries(qt)) {
...
var Zt = { useSuspense: !1 }, Qt, $t = () => (Qt ||= e.createContext(void 0), Qt), Z = void 0, en = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
	...
	l = Xt(n, u, d, !!s);
	let [f, p] = c(!l.isLoaded()), m = Object.assign(Object.assign({}, Zt), r), h = $t();
	...
	let { tolgee: r, options: a } = tn(), o = re(e), c = O(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = nn(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
var sn = (t) => {
	...
	return Object.entries(t || {}).forEach(([t, r]) => {
		if (typeof r == "function") n[t] = (e) => r(ln(e));
		else if (e.isValidElement(r)) {
			let i = r;
			n[t] = (t) => i.props.children === void 0 && t?.length ? e.cloneElement(i, {}, ln(t)) : e.cloneElement(i);
		} else n[t] = r;
	}), n;
};
function cn(e) {
...
var ln = (t) => {
	let n = on(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, cn(t))) : cn(n);
}, un = (t) => {
	let n = t.keyName || t.children;
	n === void 0 && console.error("T component: keyName not defined");
	let r = t.defaultValue || (t.keyName ? t.children : void 0), i = ln(t.t({
		key: n,
		params: sn(t.params),
		defaultValue: r,
		noWrap: t.noWrap,
	...
	let { t: n } = rn();
	return e.createElement(un, Object.assign({ t: n }, t));
}, fn = Kt().use(ze()).init({
	language: "en",
	staticData: X
});
...
function hn() {
	...
	return p("button", {
		...
		children: t === "auto" ? p(Q, { keyName: "themeToggle.themeAuto" }) : t === "dark" ? p(Q, { keyName: "themeToggle.themeDark" }) : p(Q, { keyName: "themeToggle.themeLight" })
	});
}
var gn = [
	"en",
			...
			children: [m("div", {
				...
				children: [p(l, {
					...
					children: [
						p(l, {
							...
							className: "nav-link",
							children: p(Q, { keyName: "header.home" })
						}),
						p(l, {
							preload: !1,
							to: "/$locale/about",
							...
							activeProps: { className: "is-active" },
							className: "nav-link",
							children: p(Q, { keyName: "header.methodology" })
						}),
						m("div", {
							className: "relative",
							children: [m("button", {
								...
								onMouseLeave: () => n(!1),
								onClick: () => n(!t),
								children: [p(Q, { keyName: "header.mockPages" }), p(f, {
									size: 14,
				...
				children: [
					m("a", {
						...
						children: [p("span", {
							className: "sr-only",
							children: p(Q, { keyName: "header.goToGithub" })
						}), p("svg", {
							viewBox: "0 0 16 16",
							"aria-hidden": "true",
							width: "20",
