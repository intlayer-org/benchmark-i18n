...
import w from "../i18n/locales/fr/common.json";
...
import T from "../i18n/locales/it/common.json";
...
import E from "../i18n/locales/ja/common.json";
import br from "../i18n/locales/ja/home.json";
import xr from "../i18n/locales/ja/about.json";
import Sr from "../i18n/locales/ja/blog.json";
import Cr from "../i18n/locales/ja/careers.json";
import wr from "../i18n/locales/ja/contact.json";
import Tr from "../i18n/locales/ja/faq.json";
import Er from "../i18n/locales/ja/pricing.json";
import Dr from "../i18n/locales/ja/products.json";
import Or from "../i18n/locales/ja/settings.json";
import kr from "../i18n/locales/ja/team.json";
import Ar from "../i18n/locales/ko/route.json";
import jr from "../i18n/locales/ko/header.json";
import Mr from "../i18n/locales/ko/footer.json";
import Nr from "../i18n/locales/ko/themeToggle.json";
import Pr from "../i18n/locales/ko/hero.json";
import Fr from "../i18n/locales/ko/whyItMatters.json";
import Ir from "../i18n/locales/ko/understandingImpact.json";
import Lr from "../i18n/locales/ko/resultsTable.json";
import Rr from "../i18n/locales/ko/aboutHeader.json";
import zr from "../i18n/locales/ko/aboutGrid.json";
import Br from "../i18n/locales/ko/whatWeMeasure.json";
import Vr from "../i18n/locales/ko/blogHeader.json";
import Hr from "../i18n/locales/ko/blogList.json";
import Ur from "../i18n/locales/ko/careersHeader.json";
import Wr from "../i18n/locales/ko/careersBenefits.json";
import Gr from "../i18n/locales/ko/openPositions.json";
import Kr from "../i18n/locales/ko/contactHeader.json";
import qr from "../i18n/locales/ko/contactForm.json";
import Jr from "../i18n/locales/ko/faqHeader.json";
import Yr from "../i18n/locales/ko/faqList.json";
import Xr from "../i18n/locales/ko/pricingHeader.json";
import Zr from "../i18n/locales/ko/pricingTiers.json";
import Qr from "../i18n/locales/ko/productsHeader.json";
import $r from "../i18n/locales/ko/productsGrid.json";
import ei from "../i18n/locales/ko/settingsHeader.json";
import ti from "../i18n/locales/ko/profileSection.json";
import ni from "../i18n/locales/ko/preferencesSection.json";
import ri from "../i18n/locales/ko/apiAccessSection.json";
import ii from "../i18n/locales/ko/settingsFooter.json";
import ai from "../i18n/locales/ko/teamHeader.json";
import oi from "../i18n/locales/ko/teamGrid.json";
import D from "../i18n/locales/ko/common.json";
import si from "../i18n/locales/ko/home.json";
import ci from "../i18n/locales/ko/about.json";
import li from "../i18n/locales/ko/blog.json";
import ui from "../i18n/locales/ko/careers.json";
import di from "../i18n/locales/ko/contact.json";
import fi from "../i18n/locales/ko/faq.json";
import pi from "../i18n/locales/ko/pricing.json";
import mi from "../i18n/locales/ko/products.json";
import hi from "../i18n/locales/ko/settings.json";
import gi from "../i18n/locales/ko/team.json";
import _i from "../i18n/locales/pt/route.json";
import vi from "../i18n/locales/pt/header.json";
import yi from "../i18n/locales/pt/footer.json";
import bi from "../i18n/locales/pt/themeToggle.json";
import xi from "../i18n/locales/pt/hero.json";
import Si from "../i18n/locales/pt/whyItMatters.json";
import Ci from "../i18n/locales/pt/understandingImpact.json";
import wi from "../i18n/locales/pt/resultsTable.json";
import Ti from "../i18n/locales/pt/aboutHeader.json";
import Ei from "../i18n/locales/pt/aboutGrid.json";
import Di from "../i18n/locales/pt/whatWeMeasure.json";
import Oi from "../i18n/locales/pt/blogHeader.json";
import ki from "../i18n/locales/pt/blogList.json";
import Ai from "../i18n/locales/pt/careersHeader.json";
import ji from "../i18n/locales/pt/careersBenefits.json";
import Mi from "../i18n/locales/pt/openPositions.json";
import Ni from "../i18n/locales/pt/contactHeader.json";
import Pi from "../i18n/locales/pt/contactForm.json";
import Fi from "../i18n/locales/pt/faqHeader.json";
import Ii from "../i18n/locales/pt/faqList.json";
import Li from "../i18n/locales/pt/pricingHeader.json";
import Ri from "../i18n/locales/pt/pricingTiers.json";
import zi from "../i18n/locales/pt/productsHeader.json";
import Bi from "../i18n/locales/pt/productsGrid.json";
import Vi from "../i18n/locales/pt/settingsHeader.json";
import Hi from "../i18n/locales/pt/profileSection.json";
import Ui from "../i18n/locales/pt/preferencesSection.json";
import Wi from "../i18n/locales/pt/apiAccessSection.json";
import Gi from "../i18n/locales/pt/settingsFooter.json";
import Ki from "../i18n/locales/pt/teamHeader.json";
import qi from "../i18n/locales/pt/teamGrid.json";
import Ji from "../i18n/locales/pt/common.json";
...
function qs(e, t, a, o = !0) {
	let [s] = i(() => Ks(e)), [c, l] = i(o);
	return n(() => {
		l(!1);
	}, []), r(() => {
...
var Js = { useSuspense: !1 }, Ys, Xs = () => (Ys ||= e.createContext(void 0), Ys), $ = void 0, Zs = ({ tolgee: r, options: a, children: o, fallback: s, ssr: c }) => {
	n(() => {
	...
	l = qs(r, u, d, !!c);
	let [f, p] = i(!l.isLoaded()), m = Object.assign(Object.assign({}, Js), a), h = Xs();
...
var Hc = Io.reduce((e, t) => (e[t] = Vc(t), e), {}), Uc = Gs().use(Ts()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: Hc
