...
function Se({ options: e }) {
	let t = ue(), n = F(!1, () => o.isFetching(), t.onFetchingChange.emit), r = F(!1, () => w.isLoading(), t.onLoadingChange.emit), i = be(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ye(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = me(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var we = () => {
	...
	return t;
}, L = 0, R = 1, Te = 2, Ee = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
function nt(e) {
	return J ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Ge }, window.origin), i = () => {
			clearInterval(a), X(), Y = void 0, n(new K("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Z = "__tolgee_", yt = `${Z}apiKey`, bt = `${Z}apiUrl`, xt = `${Z}branch`, St = `${Z}projectId`, Ct = `${Z}session`, wt = "tolgee-in-context-tools.umd.min.js", Tt = "@tolgee/in-context-tools", Et = "InContextTools", Dt = "https://cdn.jsdelivr.net/npm", Ot = null;
function kt(e) {
...
function Ft() {
	...
	if (i && r) return y(v({}, a), { transport: rt() });
}
function It() {
	let e = [];
...
function Ht(e, t, a, o = !0) {
	let [s] = i(() => Vt(e)), [c, l] = i(o);
	return n(() => {
		l(!1);
	}, []), r(() => {
...
var Ut = { useSuspense: !1 }, Wt, Gt = () => (Wt ||= e.createContext(void 0), Wt), Q = void 0, Kt = ({ tolgee: r, options: a, children: o, fallback: s, ssr: c }) => {
	n(() => {
	...
	l = Ht(r, u, d, !!c);
	let [f, p] = i(!l.isLoaded()), m = Object.assign(Object.assign({}, Ut), a), h = Gt();
