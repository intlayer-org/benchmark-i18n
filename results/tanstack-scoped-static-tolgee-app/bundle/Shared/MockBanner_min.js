...
var Rc = { useSuspense: !1 }, zc, Bc = () => (zc ||= e.createContext(void 0), zc), Q = void 0, Vc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
...
var Wc = () => {
	...
	let { tolgee: r, options: a } = Wc(), s = qo(e), c = j(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Gc(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
var $ = (t) => {
	...
	let { t: n } = Kc();
	return e.createElement(Xc, Object.assign({ t: n }, t));
}, Qc = Fc.reduce((e, t) => (e[t] = Pc(t), e), {}), $c = Gs().use(ws()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: Qc
