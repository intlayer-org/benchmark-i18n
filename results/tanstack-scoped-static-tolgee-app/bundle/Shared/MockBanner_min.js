...
function he(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return S(s.onError, (e) => new le("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return S(s.onError, (e) => new ce("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function E(e) {
		e && l.backends.push(e);
	}
	...
	let k = Object.freeze({
		...
		setStoredLanguage(e) {
			return S(s.onError, (e) => new le("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function ye({ options: e }) {
	let t = se(), n = L(!1, () => o.isFetching(), t.onFetchingChange.emit), r = L(!1, () => T.isLoading(), t.onLoadingChange.emit), i = ge(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = he(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = ue(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var xe = () => {
	let e = {
		...
		init(t) {
			let n = be(I(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, Se = 0, R = 1, Ce = 2, we = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Se ? r = "Empty parameter" : e === R ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Te(e) {
	return /\s/.test(e);
}
var z = 0, B = 1, V = 2, H = 3, U = 4, Ee = /* @__PURE__ */ new Set([
	V,
	B,
	z
]), W = "'", De = /* @__PURE__ */ new Set([
	"{",
	"}",
	W
...
function ke(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case z:
			...
			break;
		case B:
			De.has(i) ? (n = n.slice(0, -1) + i, t = V) : (n += i, t = z);
			break;
		case V:
			i === W ? t = z : (n += i, t = V);
			break;
		case H:
			i === "}" ? (d(), t = z) : Te(i) ? r !== "" && (d(), t = U) : (u(), t = H);
			break;
		case U: i == "}" ? t = z : Te(i) ? t = U : c(R);
	}
...
for (let [e, t] of Object.entries(Bt)) {
...
var Wt = { useSuspense: !1 }, Gt, Kt = () => (Gt ||= e.createContext(void 0), Gt), Q = void 0, qt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	let { tolgee: r, options: a } = Jt(), s = T(e), c = E(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Yt(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
var an = () => c("div", {
	...
	children: c(rn, { keyName: "mockBanner.mockBanner" })
}), on = Vt("en");
