...
var Vc = { useSuspense: !1 }, Hc, Uc = () => (Hc ||= e.createContext(void 0), Hc), Q = void 0, Wc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
...
var qc = () => {
	...
	let { tolgee: r, options: a } = qc(), o = Xo(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Jc(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
}, tl = Rc.reduce((e, t) => (e[t] = Z(t), e), {}), nl = Js().use(Ds()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: tl
...
function al() {
	return il("AboutHeader"), Bo(zo, { children: [E("h1", {
