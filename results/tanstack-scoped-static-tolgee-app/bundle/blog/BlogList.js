...
function BlogList() {
	...
	const posts = [
		...
		},
		{
			...
			excerpt: t("blogList.aTransparentLookAtOurBenchmarking"),
		...
		children: posts.map((p) => jsxs("article", {
			...
			children: [
				...
				jsxs("button", {
					...
					children: [jsx(T, { keyName: "common.readMore" }), " →"]
				})
			]
		}, p.title))
	});
