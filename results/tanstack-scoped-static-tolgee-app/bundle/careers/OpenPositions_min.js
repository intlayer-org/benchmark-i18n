...
var Kc = () => {
	...
	let { tolgee: r, options: a } = Kc(), s = Jo(e), c = M(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = qc(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
}, tl = Lc.reduce((e, t) => (e[t] = Ic(t), e), {}), nl = Ks().use(Ts()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: tl
