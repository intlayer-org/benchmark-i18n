		...
		children: [
			u("div", {
				...
				children: [u("div", { children: [l("label", {
					...
					children: l($, { keyName: "contactForm.name" })
				}), l("input", {
					id: t,
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
					placeholder: e("contactForm.yourName")
				})] }), u("div", { children: [l("label", {
					htmlFor: n,
					className: "mb-1 block text-sm font-medium text-foreground",
					children: l($, { keyName: "contactForm.email" })
				}), l("input", {
					id: n,
					type: "email",
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
					placeholder: e("contactForm.emailPlaceholder")
				})] })]
			}),
			u("div", { children: [l("label", {
				htmlFor: r,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: l($, { keyName: "contactForm.topic" })
			}), u("select", {
				id: r,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				children: [
					l("option", { children: e("contactForm.bugReport") }),
					l("option", { children: e("contactForm.newBenchmarkIdea") }),
					l("option", { children: e("contactForm.methodologyQuestion") }),
					l("option", { children: e("contactForm.contribution") }),
					l("option", { children: e("contactForm.other") })
				]
			})] }),
			u("div", { children: [l("label", {
				htmlFor: i,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: l($, { keyName: "contactForm.message" })
			}), l("textarea", {
				id: i,
				rows: 5,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: e("contactForm.messagePlaceholder")
			})] }),
			l("button", {
				type: "submit",
				className: "rounded-md bg-primary px-6 py-2.5 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity",
				children: l($, { keyName: "contactForm.sendMessage" })
			})
		]
	});
}
