...
import w from "../../../i18n/locales/de/faqList.json";
...
import T from "../../../i18n/locales/pt/common.json";
...
import { jsx as E, jsxs as Ro } from "react/jsx-runtime";
...
function ss(e, t, n, r, i, a, o, s) {
	...
	function ee() {
		...
		let e = n();
		return k(s.onError, (e) => new ts("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let w = Object.freeze({
		...
		getBackendDevRecord: async ({ language: e, namespace: n }) => {
			...
			if (!(!r || !i || !w.hasDevBackend())) return l.devBackend?.getRecord(Object.assign({
				apiKey: r,
				apiUrl: i,
				projectId: a,
				branch: o,
...
function ls(e, t, n) {
	let r = os(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? M([t, ...Yo(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
var ws = () => (e, t) => (t.setFinalFormatter(Cs()), e), Ts = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Q = {};
(function(e) {
	function t(e, t) {
		var n;
...
(Go = console.assert) == null || Go.call(console, Es), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ds(e, t) {
	let n = (n) => {
...
var Rc = { useSuspense: !1 }, zc, Bc = () => (zc ||= e.createContext(void 0), zc), $ = void 0, Vc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = Lc(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, Rc), r), h = Bc();
...
var Wc = () => {
	...
	let { tolgee: r, options: a } = Wc(), s = Jo(e), c = j(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Gc(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
	...
	let { t: r, isLoading: i } = Kc(e, t);
	return {
		t: n((...e) => r(W(...e)), [r]),
		isLoading: i
	};
}, Jc = Fc.reduce((e, t) => (e[t] = Pc(t), e), {}), Yc = Ws().use(ws()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: Jc
