...
function os(e, t) {
	...
	return n.apiUrl = Xo(n.apiUrl), e?.fetch && (n.fetch = N(e.fetch)), {
		initialOptions: n,
...
function ss(e, t, n, r, i, a, o, s) {
	...
	let w = Object.freeze({
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = V(n, ["formatEnabled"]);
...
function us(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = V(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
function fs({ options: e }) {
	let t = ts(), n = cs(!1, () => o.isFetching(), t.onFetchingChange.emit), r = cs(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ls(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ss(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = rs(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
