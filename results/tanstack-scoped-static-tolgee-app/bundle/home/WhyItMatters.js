...
function WhyItMatters() {
	return jsxs("section", {
		...
		children: [jsx("h2", {
			...
			children: jsx(T, { keyName: "whyItMatters.whyTheseMetricsMatter" })
		}), jsxs("div", {
			...
			children: [
				jsxs("div", {
					...
					children: [jsx("h3", {
						...
						children: jsx(T, { keyName: "whyItMatters.bundleSize" })
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
						children: jsx(T, { keyName: "whyItMatters.theBundleIsTheData" })
					})]
				}),
				jsxs("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [jsx("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: jsx(T, { keyName: "whyItMatters.renderingHydration" })
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
						children: jsx(T, { keyName: "whyItMatters.connectingALargeJson" })
					})]
				}),
				jsxs("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [jsx("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: jsx(T, { keyName: "whyItMatters.dynamicLoading" })
					}), jsx("p", {
						className: "text-sm text-muted-foreground",
						children: jsx(T, { keyName: "whyItMatters.loadingAllTranslationsUpfront" })
					})]
				})
			]
		})]
