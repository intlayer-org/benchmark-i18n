...
function ApiAccessSection() {
	...
	return jsxs("section", {
		...
		children: [jsx("h2", {
			...
			children: jsx(T, { keyName: "apiAccessSection.apiAccess" })
		}), jsxs("div", { children: [
			jsx("label", {
				htmlFor: apiKeyId,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: jsx(T, { keyName: "apiAccessSection.apiKey" })
			}),
			jsxs("div", {
				...
				children: [jsx("input", {
					...
					children: jsx(T, { keyName: "common.copy" })
				})]
			}),
			jsx("p", {
				className: "mt-1 text-xs text-muted-foreground",
				children: jsx(T, { keyName: "apiAccessSection.useThisKeyTo" })
			})
		] })]
	});
}
