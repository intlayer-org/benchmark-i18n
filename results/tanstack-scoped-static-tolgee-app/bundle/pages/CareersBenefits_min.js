...
}, Je = 3e3, Ye = 200, Xe = 0, K = /* @__PURE__ */ new Map(), Ze = !1, q, J;
...
var $e = (e) => new G("unavailable", `the Tolgee browser extension did not answer ${e} in time`), et = () => `${Date.now()}-${Xe++}-${Math.random()}`;
function tt() {
...
function nt(e) {
	return q ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Ge }, window.origin), i = () => {
			clearInterval(a), rt(), J = void 0, n(new G("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Y = "__tolgee_", bt = `${Y}apiKey`, xt = `${Y}apiUrl`, St = `${Y}branch`, Ct = `${Y}projectId`, wt = `${Y}session`, Tt = "tolgee-in-context-tools.umd.min.js", Et = "@tolgee/in-context-tools", Dt = "InContextTools", Ot = "https://cdn.jsdelivr.net/npm", kt = null;
function At(e) {
...
function X() {
	...
	if (i && r) return v(_({}, a), { transport: it() });
}
function It() {
	let e = [];
...
for (let [e, t] of Object.entries(Vt)) {
...
var Gt = { useSuspense: !1 }, Kt, Q = () => (Kt ||= e.createContext(void 0), Kt), $ = void 0, qt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = Wt(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, Gt), r), h = Q();
...
function en() {
	let { t: e } = $t(), t = [
		{
			label: e("careersBenefits.remoteFirst"),
			value: e("careersBenefits.workFromAnywhere")
		},
		{
			label: e("careersBenefits.competitivePay"),
			value: e("careersBenefits.topOfMarketCompensation")
		},
		{
			label: e("careersBenefits.openSourceTime"),
			value: e("careersBenefits.percentTimeForOss")
		}
	];
	return c("div", {
