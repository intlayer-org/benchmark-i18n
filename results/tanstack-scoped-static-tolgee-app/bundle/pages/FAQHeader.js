...
var MockBanner = () => jsx("div", {
	...
	children: jsx(T, { keyName: "mockBanner.mockBanner" })
});
function FAQHeader() {
	return jsxs(Fragment, { children: [
		...
		jsx("h1", {
			...
			children: jsx(T, { keyName: "faqHeader.frequentlyAskedQuestions" })
		}),
		jsx("p", {
			className: "mb-10 text-muted-foreground",
			children: jsx(T, { keyName: "faqHeader.everythingYouNeedToKnow" })
		})
	] });
}
