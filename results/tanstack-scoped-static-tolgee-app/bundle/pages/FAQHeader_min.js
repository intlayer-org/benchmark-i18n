...
var we = () => {
	let e = {
		...
		init(t) {
			let n = Ce(I(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, Te = 0, L = 1, Ee = 2, De = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Te ? r = "Empty parameter" : e === L ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Oe(e) {
	return /\s/.test(e);
...
var qt = { useSuspense: !1 }, Jt, Yt = () => (Jt ||= e.createContext(void 0), Jt), Z = void 0, Xt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
...
var sn = () => l("div", {
	...
	children: l($, { keyName: "mockBanner.mockBanner" })
});
function cn() {
	return u(c, { children: [
		l(sn, {}),
		l("h1", {
			...
			children: l($, { keyName: "faqHeader.frequentlyAskedQuestions" })
		}),
		l("p", {
			className: "mb-10 text-muted-foreground",
			children: l($, { keyName: "faqHeader.everythingYouNeedToKnow" })
		})
	] });
}
var ln = Wt("en");
