...
var qt = { useSuspense: !1 }, Jt, Yt = () => (Jt ||= e.createContext(void 0), Jt), Z = void 0, Xt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	...
	let { tolgee: r, options: a } = Zt(), o = E(e), c = D(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Qt(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
	...
	return sn("Hero"), u("section", {
		...
		children: [
			...
			l("p", {
				...
				children: l($, { keyName: "hero.aTestApplicationDesignedTo" })
			}),
			u("div", {
				...
				children: [l("button", {
					...
					children: l($, { keyName: "hero.viewResults" })
				}), l("button", {
					type: "button",
					className: "rounded-lg border border-border px-6 py-3 text-sm font-medium text-foreground hover:bg-accent transition-colors",
					children: l($, { keyName: "header.methodology" })
				})]
			})
		]
	});
