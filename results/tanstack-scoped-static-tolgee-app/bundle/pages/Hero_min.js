...
import { jsx as E, jsxs as zo } from "react/jsx-runtime";
...
var qc = () => {
	...
	let { tolgee: r, options: a } = qc(), o = Yo(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Jc(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
