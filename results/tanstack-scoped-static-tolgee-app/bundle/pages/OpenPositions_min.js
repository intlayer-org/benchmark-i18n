...
function _e(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return w(s.onError, (e) => new de("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return w(s.onError, (e) => new ue("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function ee(e) {
		e && l.backends.push(e);
	}
	...
	let O = Object.freeze({
		...
		setStoredLanguage(e) {
			return w(s.onError, (e) => new de("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function xe({ options: e }) {
	let t = le(), n = ve(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ve(!1, () => w.isLoading(), t.onLoadingChange.emit), i = ye(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = _e(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = fe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
for (let [e, t] of Object.entries(Ht)) {
...
var Kt = { useSuspense: !1 }, qt, Jt = () => (qt ||= e.createContext(void 0), qt), Q = void 0, Yt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = Gt(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, Kt), r), h = Jt();
	...
	let { tolgee: r, options: a } = Xt(), s = E(e), c = D(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Zt(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
function ln() {
	let { t: e } = sn(), t = [
		{
			title: e("openPositions.seniorFrontendEngineer"),
			location: e("openPositions.remote"),
			type: e("openPositions.fullTime"),
			dept: e("openPositions.engineering"),
			desc: e("openPositions.buildAndMaintainOur")
		},
		{
			title: e("openPositions.backendEngineer"),
			location: e("openPositions.remote"),
			type: e("openPositions.fullTime"),
			dept: e("openPositions.engineering"),
			desc: e("openPositions.designAndScaleOur")
		},
		{
			title: e("openPositions.technicalWriter"),
			location: e("openPositions.remote"),
			type: e("openPositions.partTime"),
			dept: e("openPositions.documentation"),
			desc: e("openPositions.createComprehensiveGuidesApi")
		},
		{
			title: e("openPositions.devrelEngineer"),
			location: e("openPositions.sfRemote"),
			type: e("openPositions.fullTime"),
			dept: e("openPositions.community"),
			desc: e("openPositions.engageWithTheI18n")
		},
		{
			title: e("openPositions.qaEngineer"),
			location: e("openPositions.remote"),
			type: e("openPositions.fullTime"),
			dept: e("openPositions.engineering"),
			desc: e("openPositions.ensureTheAccuracyAnd")
		}
	];
	return u(c, { children: [l("h2", {
		className: "mb-6 text-2xl font-bold text-foreground",
		children: l(cn, { keyName: "openPositions.openPositions" })
	}), l("div", {
		className: "space-y-4",
		children: t.map((e) => u("div", {
			...
			children: [u("div", { children: [
				...
				children: l(cn, { keyName: "openPositions.applyNow" })
			})]
		}, e.title))
	})] });
}
