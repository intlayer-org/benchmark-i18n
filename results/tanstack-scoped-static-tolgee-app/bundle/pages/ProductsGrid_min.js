...
var Gc = () => {
	...
	let { tolgee: r, options: a } = Gc(), s = qo(e), c = M(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Kc(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
}, el = Ic.reduce((e, t) => (e[t] = Fc(t), e), {}), tl = Gs().use(ws()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: el
