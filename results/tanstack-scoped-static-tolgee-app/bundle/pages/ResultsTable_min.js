...
function on() {
	return l("section", { children: [c("h2", {
		...
		children: c($, { keyName: "resultsTable.sampleResults" })
	}), c("div", {
			...
			children: [c("thead", {
				...
				children: l("tr", { children: [
					c("th", {
						...
						children: c($, { keyName: "resultsTable.library" })
					}),
					c("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: c($, { keyName: "resultsTable.bundleSize" })
					}),
					c("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: c($, { keyName: "resultsTable.lookupTime" })
					}),
					c("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: c($, { keyName: "resultsTable.lazyLoading" })
					})
				] })
			}), c("tbody", { children: [
				{
