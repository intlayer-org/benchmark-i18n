...
import C from "../../../i18n/locales/de/contactForm.json";
import w from "../../../i18n/locales/de/faqHeader.json";
import T from "../../../i18n/locales/de/faqList.json";
import ne from "../../../i18n/locales/de/pricingHeader.json";
import re from "../../../i18n/locales/de/pricingTiers.json";
import ie from "../../../i18n/locales/de/productsHeader.json";
import ae from "../../../i18n/locales/de/productsGrid.json";
import oe from "../../../i18n/locales/de/settingsHeader.json";
import se from "../../../i18n/locales/de/profileSection.json";
import ce from "../../../i18n/locales/de/preferencesSection.json";
import le from "../../../i18n/locales/de/apiAccessSection.json";
import ue from "../../../i18n/locales/de/settingsFooter.json";
import de from "../../../i18n/locales/de/teamHeader.json";
import fe from "../../../i18n/locales/de/teamGrid.json";
import pe from "../../../i18n/locales/de/common.json";
...
import jo from "../../../i18n/locales/zh/careers.json";
import Mo from "../../../i18n/locales/zh/contact.json";
import No from "../../../i18n/locales/zh/faq.json";
import Po from "../../../i18n/locales/zh/pricing.json";
...
var Ro = Object.defineProperty, zo = Object.getOwnPropertySymbols, Bo = Object.prototype.hasOwnProperty, Vo = Object.prototype.propertyIsEnumerable, Ho = (e, t, n) => t in e ? Ro(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function os(e, t) {
	let n = U(as, t?.initialOptions, e);
	return n.apiUrl = Yo(n.apiUrl), e?.fetch && (n.fetch = P(e.fetch)), {
		initialOptions: n,
	...
	let T = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = Xo(e) || H, r = t().onFormatError, a = typeof r;
...
function ls(e, t, n) {
	let r = os(), i, a = Object.freeze({
		...
		overrideCredentials(e) {
			i = e ? Object.assign(Object.assign({}, e), { apiUrl: Yo(e.apiUrl) }) : void 0;
		}
	});
	return a;
}
...
var ms = () => {
	let e = {
		...
		init(t) {
			let n = ps(U(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, hs = 0, W = 1, gs = 2, _s = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === hs ? r = "Empty parameter" : e === W ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function vs(e) {
	return /\s/.test(e);
}
var G = 0, K = 1, q = 2, J = 3, Y = 4, ys = new Set([
	q,
	K,
	G
]), X = "'", bs = new Set([
...
function Ss(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case G:
			...
			break;
		case K:
			bs.has(i) ? (n = n.slice(0, -1) + i, t = q) : (n += i, t = G);
			break;
		case q:
			i === X ? t = G : (n += i, t = q);
			break;
		case J:
			i === "}" ? (d(), t = G) : vs(i) ? r !== "" && (d(), t = Y) : (u(), t = J);
			break;
		case Y: i == "}" ? t = G : vs(i) ? t = Y : c(W);
	}
...
(Wo = console.assert) == null || Wo.call(console, Os), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function ks(e, t) {
	let n = (n) => {
...
var Bc = { useSuspense: !1 }, Vc, Hc = () => (Vc ||= e.createContext(void 0), Vc), Z = void 0, Uc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
...
var Kc = () => {
	...
	let { tolgee: r, options: a } = Kc(), s = qo(e), c = M(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = qc(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
var Q = (t) => {
	let n = Yc(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, Zc(t))) : Zc(n);
}, Qc = (t) => {
	...
	let { t: n } = Jc();
	return e.createElement(Qc, Object.assign({ t: n }, t));
}, el = Lc.reduce((e, t) => (e[t] = Ic(t), e), {}), tl = Ks().use(Ts()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: el
...
function nl() {
	return D("section", { children: [E("h2", {
