...
var zc = { useSuspense: !1 }, Bc, Vc = () => (Bc ||= e.createContext(void 0), Bc), Q = void 0, Hc = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
...
var $ = (t) => {
	let n = Jc(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, Xc(t))) : Xc(n);
}, Zc = (t) => {
	...
	let { t: n } = qc();
	return e.createElement(Zc, Object.assign({ t: n }, t));
}, $c = Ic.reduce((e, t) => (e[t] = Z(t), e), {}), el = Ks().use(Ts()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: $c
