...
var qc = () => {
	...
	let { tolgee: r, options: a } = qc(), s = Yo(e), c = j(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Jc(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
}, tl = Rc.reduce((e, t) => (e[t] = X(t), e), {}), nl = Js().use(Ds()).init({
	language: "en",
	apiUrl: void 0,
	apiKey: void 0,
	staticData: tl
