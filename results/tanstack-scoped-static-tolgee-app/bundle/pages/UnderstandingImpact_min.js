...
var we = () => {
	let e = {
		...
		init(t) {
			let n = Ce(P(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, Te = 0, I = 1, Ee = 2, De = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Te ? r = "Empty parameter" : e === I ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Oe(e) {
	return /\s/.test(e);
}
var L = 0, R = 1, z = 2, B = 3, V = 4, ke = /* @__PURE__ */ new Set([
	z,
	R,
	L
]), H = "'", Ae = /* @__PURE__ */ new Set([
	"{",
	"}",
	H
]), je = (e) => /[0-9a-zA-Z_]/.test(e);
function Me(e) {
	let t = L, n = "", r = "", i = "", a = [], o = [], s = 0;
	function c(t) {
		throw new De(t, s, e);
	}
	let l = () => {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case L:
			i === H ? (n += i, t = R) : i === "{" ? (l(), t = B) : (n += i, t = L);
			break;
		case R:
			Ae.has(i) ? (n = n.slice(0, -1) + i, t = z) : (n += i, t = L);
			break;
		case z:
			i === H ? t = L : (n += i, t = z);
			break;
		case B:
			i === "}" ? (d(), t = L) : Oe(i) ? r !== "" && (d(), t = V) : (u(), t = B);
			break;
		case V: i == "}" ? t = L : Oe(i) ? t = V : c(I);
	}
...
(y = console.assert) == null || y.call(console, ze), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Be(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, Ye = 3e3, Xe = 200, Ze = 0, G = /* @__PURE__ */ new Map(), Qe = !1, K, q;
...
var et = (e) => new W("unavailable", `the Tolgee browser extension did not answer ${e} in time`), tt = () => `${Date.now()}-${Ze++}-${Math.random()}`;
function nt() {
	Qe || (Qe = !0, window.addEventListener("message", (e) => {
		...
		if (i) {
			...
			n === i.replyType && (G.delete(r.id), clearTimeout(i.timer), r.error ? i.reject(new W(r.error.kind, r.error.message)) : i.resolve(r));
		}
	}));
}
function rt(e) {
	return K ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Ke }, window.origin), i = () => {
			clearInterval(a), it(), q = void 0, n(new W("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
function at() {
	return async (e) => {
		...
		if (!n.response) throw new U("fetch_error");
...
function lt(e) {
	if (Ve(e)) return e;
	if (e instanceof W) switch (e.kind) {
		case "no_session": return new U("extension_session_missing", 401);
		case "too_large": return new U("extension_request_too_large");
		default: return console.warn(`Tolgee: the browser extension did not serve the request (${e.kind}): ${e.message}`), new U("fetch_error");
	}
	return new U("fetch_error");
}
...
var J = "__tolgee_", xt = `${J}apiKey`, St = `${J}apiUrl`, Ct = `${J}branch`, wt = `${J}projectId`, Tt = `${J}session`, Et = "tolgee-in-context-tools.umd.min.js", Dt = "@tolgee/in-context-tools", Ot = "InContextTools", kt = "https://cdn.jsdelivr.net/npm", At = null;
function jt(e) {
...
var Ut = Object.assign({
	...
	"./locales/de/apiAccessSection.json": {
	...
	"./locales/de/careersBenefits.json": {
	...
	"./locales/de/mockBanner.json": { mockBanner: "⚠️ Diese Seite enthält fiktive Daten, die nur Benchmark-Zwecken dienen. Sie stehen in keinem Zusammenhang mit realen Unternehmen oder Dienstleistungen." },
	"./locales/de/openPositions.json": {
		applyNow: "Apply Now",
	...
	"./locales/de/preferencesSection.json": {
		arabicAr: "Arabic (ar)",
	...
	"./locales/de/settingsFooter.json": {
		cancel: "Abbrechen",
		saveChanges: "Änderungen speichern"
	},
	"./locales/de/settingsHeader.json": {
	...
	"./locales/de/understandingImpact.json": {
	...
	"./locales/en/apiAccessSection.json": {
	...
	"./locales/en/careersBenefits.json": {
	...
	"./locales/en/faqHeader.json": {
		everythingYouNeedToKnow: "Everything you need to know about i18n Benchmark.",
		frequentlyAskedQuestions: "Frequently Asked Questions"
	},
	"./locales/en/faqList.json": {
	...
	"./locales/en/mockBanner.json": { mockBanner: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." },
	"./locales/en/openPositions.json": {
		applyNow: "Apply Now",
		backendEngineer: "Backend Engineer",
		buildAndMaintainOur: "Build and maintain our benchmarking suite and core application infrastructure.",
	...
	"./locales/en/preferencesSection.json": {
		arabicAr: "Arabic (ar)",
		chineseSimplifiedZhCn: "Chinese (Simplified, zh-CN)",
		darkMode: "Dark Mode",
	...
	"./locales/en/settingsFooter.json": {
		cancel: "Cancel",
		saveChanges: "Save Changes"
	},
	"./locales/en/settingsHeader.json": {
		manageYourAccount: "Manage your account settings and preferences.",
		manageYourAccountPreferences: "Manage your account preferences and configuration.",
		settings: "Settings"
	},
	"./locales/en/team.json": {
	...
	"./locales/en/understandingImpact.json": {
	...
	"./locales/es/apiAccessSection.json": {
	...
	"./locales/es/careersBenefits.json": {
	...
	"./locales/es/faqHeader.json": {
		everythingYouNeedToKnow: "Everything you need to know about i18n Benchmark.",
		frequentlyAskedQuestions: "Frequently Asked Questions"
	},
	"./locales/es/faqList.json": {
	...
	"./locales/es/mockBanner.json": { mockBanner: "⚠️ Esta página contiene datos simulados solo para fines de benchmarking. No está relacionada con ningún negocio o servicio real." },
	"./locales/es/openPositions.json": {
		applyNow: "Apply Now",
		backendEngineer: "Backend Engineer",
		buildAndMaintainOur: "Build and maintain our benchmarking suite and core application infrastructure.",
	...
	"./locales/es/preferencesSection.json": {
		arabicAr: "Arabic (ar)",
		chineseSimplifiedZhCn: "Chinese (Simplified, zh-CN)",
	...
	"./locales/es/understandingImpact.json": {
	...
	"./locales/fr/apiAccessSection.json": {
		apiAccess: "Accès API",
		apiKey: "Clé API",
	...
	"./locales/fr/careersBenefits.json": {
	...
	"./locales/fr/faqHeader.json": {
		everythingYouNeedToKnow: "Everything you need to know about i18n Benchmark.",
		frequentlyAskedQuestions: "Frequently Asked Questions"
	},
	"./locales/fr/faqList.json": {
	...
	"./locales/fr/mockBanner.json": { mockBanner: "⚠️ Cette page contient des données factices à des fins de benchmarking uniquement. Elle n'est liée à aucune entreprise ou service réel." },
	"./locales/fr/openPositions.json": {
		applyNow: "Apply Now",
		backendEngineer: "Backend Engineer",
		buildAndMaintainOur: "Build and maintain our benchmarking suite and core application infrastructure.",
	...
	"./locales/fr/preferencesSection.json": {
		arabicAr: "Arabic (ar)",
		chineseSimplifiedZhCn: "Chinese (Simplified, zh-CN)",
	...
	"./locales/fr/understandingImpact.json": {
	...
	"./locales/it/careersBenefits.json": {
	...
	"./locales/it/faqHeader.json": {
		everythingYouNeedToKnow: "Everything you need to know about i18n Benchmark.",
		frequentlyAskedQuestions: "Frequently Asked Questions"
	},
	"./locales/it/faqList.json": {
	...
	"./locales/it/mockBanner.json": { mockBanner: "⚠️ Questa pagina contiene dati fittizi solo a scopo di benchmarking. Non è correlata ad alcuna attività o servizio reale." },
	"./locales/it/openPositions.json": {
		applyNow: "Apply Now",
		backendEngineer: "Backend Engineer",
		buildAndMaintainOur: "Build and maintain our benchmarking suite and core application infrastructure.",
	...
	"./locales/it/preferencesSection.json": {
		arabicAr: "Arabic (ar)",
		chineseSimplifiedZhCn: "Chinese (Simplified, zh-CN)",
	...
	"./locales/it/understandingImpact.json": {
	...
	"./locales/ja/careersBenefits.json": {
	...
	"./locales/ja/faqHeader.json": {
		everythingYouNeedToKnow: "Everything you need to know about i18n Benchmark.",
		frequentlyAskedQuestions: "Frequently Asked Questions"
	},
	"./locales/ja/faqList.json": {
	...
	"./locales/ja/mockBanner.json": { mockBanner: "⚠️ このページにはベンチマークのみを目的とした模擬データが含まれています。実際のビジネスやサービスとは関係ありません。" },
	"./locales/ja/openPositions.json": {
		applyNow: "Apply Now",
		backendEngineer: "Backend Engineer",
		buildAndMaintainOur: "Build and maintain our benchmarking suite and core application infrastructure.",
	...
	"./locales/ja/preferencesSection.json": {
		arabicAr: "Arabic (ar)",
		chineseSimplifiedZhCn: "Chinese (Simplified, zh-CN)",
		darkMode: "ダークモード",
	...
	"./locales/ja/productsHeader.json": {
		products: "製品",
		toolsAndServicesTo: "国際化戦略の最適化に役立つツールとサービス。"
	},
	"./locales/ja/profileSection.json": {
		profile: "プロフィール",
		displayName: "表示名",
		email: "メールアドレス"
	},
	"./locales/ja/resultsTable.json": {
		bundleSize: "バンドルサイズ",
		lazyLoading: "遅延読み込み",
		library: "Library",
		lookupTime: "検索時間",
	...
	"./locales/ja/settingsFooter.json": {
		cancel: "キャンセル",
		saveChanges: "変更を保存"
	},
	"./locales/ja/settingsHeader.json": {
		manageYourAccount: "Manage your account settings and preferences.",
		manageYourAccountPreferences: "アカウントの設定と構成を管理します。",
		settings: "設定"
	},
	"./locales/ja/team.json": {
	...
	"./locales/ja/understandingImpact.json": {
	...
	"./locales/ko/careersBenefits.json": {
	...
	"./locales/ko/faqHeader.json": {
		everythingYouNeedToKnow: "Everything you need to know about i18n Benchmark.",
		frequentlyAskedQuestions: "Frequently Asked Questions"
	},
	"./locales/ko/faqList.json": {
	...
	"./locales/ko/mockBanner.json": { mockBanner: "⚠️ 이 페이지는 벤치마킹 목적으로만 사용되는 모의 데이터를 포함하고 있습니다. 실제 비즈니스나 서비스와는 관련이 없습니다." },
	"./locales/ko/openPositions.json": {
		applyNow: "Apply Now",
		backendEngineer: "Backend Engineer",
		buildAndMaintainOur: "Build and maintain our benchmarking suite and core application infrastructure.",
	...
	"./locales/ko/preferencesSection.json": {
		arabicAr: "Arabic (ar)",
		chineseSimplifiedZhCn: "Chinese (Simplified, zh-CN)",
		darkMode: "다크 모드",
	...
	"./locales/ko/pricingHeader.json": {
		pricing: "가격",
		transparentPricingForEvery: "i18n 여정의 모든 단계에 적합한 투명한 요금제."
	},
	"./locales/ko/pricingTiers.json": {
		freeTier: "무료 티어",
		free: "무료",
	...
	"./locales/ko/productsHeader.json": {
		products: "제품",
		toolsAndServicesTo: "국제화 전략을 최적화하는 데 도움이 되는 도구와 서비스."
	},
	"./locales/ko/profileSection.json": {
		profile: "프로필",
		displayName: "표시 이름",
		email: "이메일"
	},
	"./locales/ko/resultsTable.json": {
		bundleSize: "번들 크기",
		lazyLoading: "지연 로딩",
		library: "Library",
		lookupTime: "조회 시간",
	...
	"./locales/ko/settingsFooter.json": {
		cancel: "취소",
		saveChanges: "변경 사항 저장"
	},
	"./locales/ko/settingsHeader.json": {
		manageYourAccount: "Manage your account settings and preferences.",
		manageYourAccountPreferences: "계정 기본 설정 및 구성을 관리합니다.",
		settings: "설정"
	},
	"./locales/ko/team.json": {
	...
	"./locales/ko/understandingImpact.json": {
	...
	"./locales/pt/careersBenefits.json": {
	...
	"./locales/pt/faqHeader.json": {
		everythingYouNeedToKnow: "Everything you need to know about i18n Benchmark.",
		frequentlyAskedQuestions: "Frequently Asked Questions"
	},
	"./locales/pt/faqList.json": {
	...
	"./locales/pt/mockBanner.json": { mockBanner: "⚠️ Esta página contém dados fictícios apenas para fins de benchmarking. Não está relacionada com qualquer negócio ou serviço real." },
	"./locales/pt/openPositions.json": {
		applyNow: "Apply Now",
		backendEngineer: "Backend Engineer",
		buildAndMaintainOur: "Build and maintain our benchmarking suite and core application infrastructure.",
	...
	"./locales/pt/preferencesSection.json": {
		arabicAr: "Arabic (ar)",
		chineseSimplifiedZhCn: "Chinese (Simplified, zh-CN)",
	...
	"./locales/pt/understandingImpact.json": {
	...
	"./locales/ru/careersBenefits.json": {
	...
	"./locales/ru/faqHeader.json": {
		everythingYouNeedToKnow: "Everything you need to know about i18n Benchmark.",
		frequentlyAskedQuestions: "Frequently Asked Questions"
	},
	"./locales/ru/faqList.json": {
	...
	"./locales/ru/mockBanner.json": { mockBanner: "⚠️ Эта страница содержит фиктивные данные только для целей тестирования производительности. Она не связана с каким-либо реальным бизнесом или услугой." },
	"./locales/ru/openPositions.json": {
		applyNow: "Apply Now",
		backendEngineer: "Backend Engineer",
		buildAndMaintainOur: "Build and maintain our benchmarking suite and core application infrastructure.",
	...
	"./locales/ru/preferencesSection.json": {
		arabicAr: "Arabic (ar)",
		chineseSimplifiedZhCn: "Chinese (Simplified, zh-CN)",
	...
	"./locales/ru/understandingImpact.json": {
	...
	"./locales/zh/blogHeader.json": {
		blog: "博客",
		insightsDeepDivesAnd: "来自 i18n 基准测试社区的见解、深入探讨和更新。",
		insightsTutorialsAndAnalysis: "Insights, Tutorials, and Analysis"
	},
	"./locales/zh/blogList.json": {
	...
	"./locales/zh/careersBenefits.json": {
	...
	"./locales/zh/faqHeader.json": {
		everythingYouNeedToKnow: "Everything you need to know about i18n Benchmark.",
		frequentlyAskedQuestions: "Frequently Asked Questions"
	},
	"./locales/zh/faqList.json": {
	...
	"./locales/zh/mockBanner.json": { mockBanner: "⚠️ 此页面仅包含用于基准测试的模拟数据。它与任何真实的业务或服务无关。" },
	"./locales/zh/openPositions.json": {
		applyNow: "Apply Now",
		backendEngineer: "Backend Engineer",
		buildAndMaintainOur: "Build and maintain our benchmarking suite and core application infrastructure.",
	...
	"./locales/zh/preferencesSection.json": {
		arabicAr: "Arabic (ar)",
		chineseSimplifiedZhCn: "Chinese (Simplified, zh-CN)",
		darkMode: "深色模式",
	...
	"./locales/zh/pricingHeader.json": {
		pricing: "价格",
		transparentPricingForEvery: "为您 i18n 旅程的每个阶段提供透明的价格。"
	},
	"./locales/zh/pricingTiers.json": {
		freeTier: "免费版",
		free: "免费",
	...
	"./locales/zh/productsHeader.json": {
		products: "产品",
		toolsAndServicesTo: "帮助您优化国际化战略的工具和服务。"
	},
	"./locales/zh/profileSection.json": {
		profile: "个人资料",
		displayName: "显示名称",
		email: "电子邮件"
	},
	"./locales/zh/resultsTable.json": {
		bundleSize: "包大小",
		lazyLoading: "延迟加载",
		library: "Library",
		lookupTime: "查询时间",
	...
	"./locales/zh/settingsFooter.json": {
		cancel: "取消",
		saveChanges: "保存更改"
	},
	"./locales/zh/settingsHeader.json": {
		manageYourAccount: "Manage your account settings and preferences.",
		manageYourAccountPreferences: "管理您的账户偏好和配置。",
		settings: "设置"
	},
	"./locales/zh/team.json": {
	...
	"./locales/zh/understandingImpact.json": {
...
for (let [e, t] of Object.entries(Ut)) {
	let [, n, r] = e.match(/\.\/locales\/([^/]+)\/([^/]+)\.json$/);
	(Y[n] ??= {})[r] = t;
}
function Wt(e) {
	return Y[e] ?? Y.en;
...
var qt = { useSuspense: !1 }, Jt, Yt = () => (Jt ||= e.createContext(void 0), Jt), X = void 0, Xt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = Kt(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, qt), r), h = Yt();
	...
	let { tolgee: r, options: a } = Zt(), s = E(e), c = D(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Qt(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
var Q = (t) => {
	...
	let { t: n } = $t();
	return e.createElement(nn, Object.assign({ t: n }, t));
}, an = Ht().use(Fe()).init({
	language: "en",
	staticData: Y
});
	...
	return l("section", {
		...
		children: [
			c("h2", {
				...
				children: c($, { keyName: "understandingImpact.understandingTheImpact" })
			}),
			l("div", {
				...
				children: [
					c("h3", {
						...
						children: c($, { keyName: "understandingImpact.whyASingleLargeJson" })
					}),
					c("p", {
						className: "text-sm text-muted-foreground",
						children: c($, { keyName: "understandingImpact.manyI18nLibrariesStore" })
					}),
					l("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							c("li", { children: c($, { keyName: "understandingImpact.theJsonMustBeParsed" }) }),
							c("li", { children: c($, { keyName: "understandingImpact.contextBasedArchitecturesCan" }) }),
							c("li", { children: c($, { keyName: "understandingImpact.duringServerSideRenderingThe" }) })
						]
					})
				]
			}),
			l("div", {
				...
				children: [
					c("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: c($, { keyName: "understandingImpact.theTradeOffsOfDynamic" })
					}),
					c("p", {
						className: "text-sm text-muted-foreground",
						children: c($, { keyName: "understandingImpact.splittingTranslationsIntoPerRoute" })
					}),
					l("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							l("li", { children: [
								c("strong", {
									...
									children: c($, { keyName: "understandingImpact.waterfallRequests" })
								}),
								" ",
								c($, { keyName: "understandingImpact.theAppMustFirstLoad" })
							] }),
							l("li", { children: [
								c("strong", {
									className: "text-foreground",
									children: c($, { keyName: "understandingImpact.flashOfUntranslatedContent" })
								}),
								" ",
								c($, { keyName: "understandingImpact.usersMayBrieflySeeTranslation" })
							] }),
							l("li", { children: [
								c("strong", {
									className: "text-foreground",
									children: c($, { keyName: "understandingImpact.cacheInvalidation" })
								}),
								" ",
								c($, { keyName: "understandingImpact.updatingTranslationsRequiresCache" })
							] })
						]
					})
				]
			...
			l("div", {
				...
				children: [c("h3", {
					className: "mb-2 text-lg font-semibold text-foreground",
					children: c($, { keyName: "understandingImpact.whatThisBenchmarkMeasures" })
				}), c("p", {
					className: "text-sm text-muted-foreground",
					children: c($, { keyName: "understandingImpact.thisTestAppProvidesA" })
				})]
			})
		]
	});
