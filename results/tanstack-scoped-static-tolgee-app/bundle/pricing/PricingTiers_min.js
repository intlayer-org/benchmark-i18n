...
(Go = console.assert) == null || Go.call(console, Ds), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Os(e, t) {
	let n = (n) => {
...
var Rs = "__tolgee_apiKey", zs = "__tolgee_apiUrl", Q = "__tolgee_branch";
function Bs() {
	let e = sessionStorage.getItem(Rs) || void 0, t = sessionStorage.getItem(zs) || void 0, n = sessionStorage.getItem(Q) || void 0;
	if (!(!e || !t)) return Wo({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Vs() {
	sessionStorage.removeItem(Rs), sessionStorage.removeItem(zs), sessionStorage.removeItem(Q);
}
function Hs(e) {
