...
var Gt = { useSuspense: !1 }, Kt, qt = () => (Kt ||= e.createContext(void 0), Kt), Q = void 0, Jt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = Wt(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, Gt), r), h = qt();
	...
	let { tolgee: r, options: a } = Yt(), s = E(e), c = D(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = Xt(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
var $ = (t) => {
	let n = $t(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, tn(t))) : tn(n);
}, nn = (t) => {
		...
		children: t.map((e) => l("div", {
			...
			children: [l("div", { children: [c("h3", {
				...
				children: [c("span", {
					...
					children: c(sn, { keyName: "productsGrid.learnMore" })
				})]
			})]
		}, e.name))
	});
