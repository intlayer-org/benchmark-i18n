...
function sn() {
	...
	return u("section", {
		...
		children: [l("h2", {
			...
			children: l($, { keyName: "apiAccessSection.apiAccess" })
		}), u("div", { children: [
			l("label", {
				htmlFor: e,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: l($, { keyName: "apiAccessSection.apiKey" })
			}),
			u("div", {
				...
				children: [l("input", {
					...
					children: l($, { keyName: "common.copy" })
				})]
			}),
			l("p", {
				className: "mt-1 text-xs text-muted-foreground",
				children: l($, { keyName: "apiAccessSection.useThisKeyTo" })
			})
		] })]
	});
}
