...
function PreferencesSection() {
	...
	return jsxs("section", {
		...
		children: [jsx("h2", {
			...
			children: jsx(T, { keyName: "preferencesSection.preferences" })
		}), jsxs("div", {
			className: "space-y-4",
			children: [
				jsxs("div", {
					...
					children: [jsxs("div", { children: [jsx("p", {
						...
						children: jsx(T, { keyName: "preferencesSection.emailNotifications" })
					}), jsx("p", {
						className: "text-xs text-muted-foreground",
						children: jsx(T, { keyName: "preferencesSection.receiveWeeklyBenchmark" })
					})] }), jsx("button", {
						type: "button",
				...
				jsxs("div", {
					...
					children: [jsxs("div", { children: [jsx("p", {
						className: "text-sm font-medium text-foreground",
						children: jsx(T, { keyName: "preferencesSection.darkMode" })
					}), jsx("p", {
						className: "text-xs text-muted-foreground",
						children: jsx(T, { keyName: "preferencesSection.useDarkColorScheme" })
					})] }), jsx("button", {
						type: "button",
				...
				jsxs("div", { children: [jsx("label", {
					...
					children: jsx(T, { keyName: "preferencesSection.defaultLanguage" })
				}), jsxs("select", {
					id: languageId,
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
					children: [
						jsx("option", { children: t("preferencesSection.englishEn") }),
						jsx("option", { children: t("preferencesSection.frenchFr") }),
						jsx("option", { children: t("preferencesSection.germanDe") }),
						jsx("option", { children: t("preferencesSection.spanishEs") }),
						jsx("option", { children: t("preferencesSection.japaneseJa") }),
						jsx("option", { children: t("preferencesSection.chineseSimplifiedZhCn") }),
						jsx("option", { children: t("preferencesSection.arabicAr") })
					]
				})] })
			]
		})]
