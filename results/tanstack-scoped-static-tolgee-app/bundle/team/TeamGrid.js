	...
	const members = [
		{
			...
			bio: t("teamGrid.formerGoogleEngineerWith")
		},
		{
			name: "Marcus Weber",
			role: t("teamGrid.performanceEngineer"),
			bio: t("teamGrid.specializesInJavascriptPerformance")
		},
		{
			name: "Aisha Patel",
			role: t("teamGrid.developerAdvocate"),
			bio: t("teamGrid.passionateAboutDeveloperExperience")
		},
		{
			name: "Tomás Rodríguez",
			role: t("teamGrid.fullStackDeveloper"),
			bio: t("teamGrid.maintainsTheBenchmarkingInfrastructure")
		},
		{
			name: "Yuki Tanaka",
			role: t("teamGrid.dataAnalyst"),
			bio: t("teamGrid.ensuresStatisticalRigorIn")
		},
		{
			name: "Elena Kowalski",
			role: t("teamGrid.communityManager"),
			bio: t("teamGrid.managesCommunityContributions")
		}
	];
	return jsx("div", {
