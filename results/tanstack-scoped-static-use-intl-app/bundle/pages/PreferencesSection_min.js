...
var ke = class {
	...
	parseMessage(e, t, n) {
		...
		for (; !this.isEOF();) {
			...
			if (i === 123) {
				...
				if (n) break;
				return this.error(T.UNMATCHED_CLOSING_TAG, z(this.clonePosition(), this.clonePosition()));
	...
	parseTag(e, t) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !H(this.char())) return this.error(T.INVALID_TAG, z(o, this.clonePosition()));
				let e = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					...
					err: null
				} : this.error(T.INVALID_TAG, z(o, this.clonePosition()))) : this.error(T.UNMATCHED_CLOSING_TAG, z(e, this.clonePosition()));
			}
			return this.error(T.UNCLOSED_TAG, z(n, this.clonePosition()));
		}
		return this.error(T.INVALID_TAG, z(n, this.clonePosition()));
	}
	parseTagName() {
		let e = this.offset();
	...
	parseArgument(e, t) {
		let n = this.clonePosition();
		if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(T.EXPECT_ARGUMENT_CLOSING_BRACE, z(n, this.clonePosition()));
		if (this.char() === 125) return this.bump(), this.error(T.EMPTY_ARGUMENT, z(n, this.clonePosition()));
		let r = this.parseIdentifierIfPossible().value;
		if (!r) return this.error(T.MALFORMED_ARGUMENT, z(n, this.clonePosition()));
		if (this.bumpSpace(), this.isEOF()) return this.error(T.EXPECT_ARGUMENT_CLOSING_BRACE, z(n, this.clonePosition()));
		switch (this.char()) {
			...
			case 44: return this.bump(), this.bumpSpace(), this.isEOF() ? this.error(T.EXPECT_ARGUMENT_CLOSING_BRACE, z(n, this.clonePosition())) : this.parseArgumentOptions(e, t, r, n);
			default: return this.error(T.MALFORMED_ARGUMENT, z(n, this.clonePosition()));
		}
	}
	...
	parseArgumentOptions(e, t, n, r) {
		...
		switch (a) {
			case "": return this.error(T.EXPECT_ARGUMENT_TYPE, z(i, o));
			case "number":
			case "date":
			case "time": {
				this.bumpSpace();
				...
				if (this.bumpIf(",")) {
					...
					if (n.err) return n;
					let r = De(n.val);
					if (r.length === 0) return this.error(T.EXPECT_ARGUMENT_STYLE, z(this.clonePosition(), this.clonePosition()));
					e = {
						style: r,
			...
			case "select": {
				...
				if (this.bumpSpace(), !this.bumpIf(",")) return this.error(T.EXPECT_SELECT_ARGUMENT_OPTIONS, z(i, { ...i }));
				this.bumpSpace();
				let o = this.parseIdentifierIfPossible(), s = 0;
				if (a !== "select" && o.value === "offset") {
					if (!this.bumpIf(":")) return this.error(T.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, z(this.clonePosition(), this.clonePosition()));
					this.bumpSpace();
			...
			default: return this.error(T.INVALID_ARGUMENT_TYPE, z(i, o));
		}
	}
	tryParseArgumentClose(e) {
		return this.isEOF() || this.char() !== 125 ? this.error(T.EXPECT_ARGUMENT_CLOSING_BRACE, z(e, this.clonePosition())) : (this.bump(), {
			val: !0,
			err: null
		});
	}
	parseSimpleArgStyleIfPossible() {
		...
		for (; !this.isEOF();) switch (this.char()) {
			case 39: {
				this.bump();
				let e = this.clonePosition();
				if (!this.bumpUntil("'")) return this.error(T.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, z(e, this.clonePosition()));
				this.bump();
				break;
			}
			case 123:
	...
	parseNumberSkeletonFromString(e, t) {
		...
		return {
			val: {
				...
				tokens: n,
				location: t,
				parsedOptions: this.shouldParseSkeletons ? ge(n) : {}
			},
			err: null
		};
	}
	tryParsePluralOrSelectOptions(e, t, n, r) {
		...
		for (;;) {
			...
			if (!this.bumpIf("{")) return this.error(t === "select" ? T.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT : T.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT, z(this.clonePosition(), this.clonePosition()));
		...
		return a.length === 0 ? this.error(t === "select" ? T.EXPECT_SELECT_ARGUMENT_SELECTOR : T.EXPECT_PLURAL_ARGUMENT_SELECTOR, z(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !i ? this.error(T.MISSING_OTHER_CLAUSE, z(this.clonePosition(), this.clonePosition())) : {
			val: a,
			err: null
		};
	}
...
function U(e) {
	e.forEach((e) => {
		...
		else k(e) && F(e.style) || (A(e) || j(e)) && I(e.style) ? delete e.style.location : P(e) && U(e.children);
	});
}
function Ne(e, t = {}) {
	t = {
...
function J(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (A(c)) {
			let e = typeof c.style == "string" ? r.date[c.style] : I(c.style) ? c.style.parsedOptions : void 0;
			s.push({
				type: q.literal,
		...
		if (j(c)) {
			let e = typeof c.style == "string" ? r.time[c.style] : I(c.style) ? c.style.parsedOptions : r.time.medium;
			s.push({
				type: q.literal,
				value: n.getDateTimeFormat(t, e).format(l)
			});
		...
		if (k(c)) {
			let e = typeof c.style == "string" ? r.number[c.style] : F(c.style) ? c.style.parsedOptions : void 0;
			if (e && e.scale) {
				let t = e.scale || 1;
				if (typeof l == "bigint") {
...
var X = class e {
	constructor(t, n = e.defaultLocale, r, i) {
		...
		}, this.formatToParts = (e) => J(this.ast, this.locales, this.formatters, this.formats, e, void 0, this.message), this.resolvedOptions = () => ({ locale: this.resolvedLocale?.toString() || Intl.NumberFormat.supportedLocalesOf(this.locales)[0] }), this.getAst = () => this.ast, this.locales = n, this.resolvedLocale = e.resolveLocale(n), typeof t == "string") {
...
function We(e) {
	...
	return function({ cache: e, formats: n, formatters: i, getMessageFallback: a = He, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, ee, te) {
			...
			try {
				return Ve(Z(c, p), g, m && function(e) {
					let n = {};
...
function Qe(e) {
	return function(e, t, n) {
		...
		return u || Xe || !Ze || (Xe = !0, l(new v(y.ENVIRONMENT_FALLBACK, void 0))), s((() => We({
			cache: r,
			formatters: a,
...
async function tt(e, t = ["shared", "route"]) {
	...
	for (let r of t) try {
		let t = await et(Object.assign({
			"../messages/de/about.ts": () => import("./about-DCjEHKGJ.js"),
			"../messages/de/blog.ts": () => import("./blog-BBHq3Kz4.js"),
			"../messages/de/careers.ts": () => import("./careers-CYPPCLKi.js"),
			"../messages/de/contact.ts": () => import("./contact-DKtSkI-y.js"),
			"../messages/de/faq.ts": () => import("./faq-DL4jDSfM.js"),
			"../messages/de/home.ts": () => import("./home-DF2URkOy.js"),
			"../messages/de/pricing.ts": () => import("./pricing-CaU5lhGh.js"),
			"../messages/de/products.ts": () => import("./products-DvhdNcru.js"),
			"../messages/de/route.ts": () => import("./route-DvvL5wym.js"),
			"../messages/de/settings.ts": () => import("./settings-MXrml_ha.js"),
			"../messages/de/shared.ts": () => import("./shared-CyeXdnNl.js"),
			"../messages/de/team.ts": () => import("./team-C0yu8rVo.js"),
			"../messages/en/about-grid.ts": () => import("./about-grid-CKYVeza_.js"),
			"../messages/en/about-header.ts": () => import("./about-header-Cjon9WDK.js"),
			"../messages/en/about.ts": () => import("./about-CGViMUdH.js"),
			"../messages/en/blog-header.ts": () => import("./blog-header-BK-fF_-4.js"),
			"../messages/en/blog-list.ts": () => import("./blog-list-DujY0gq6.js"),
			"../messages/en/blog.ts": () => import("./blog-CPoyC6M-.js"),
			"../messages/en/careers-benefits.ts": () => import("./careers-benefits-fVb0Kwd0.js"),
			"../messages/en/careers-header.ts": () => import("./careers-header-N0i432Gy.js"),
			"../messages/en/careers.ts": () => import("./careers-DjWQkYRw.js"),
			"../messages/en/contact-form.ts": () => import("./contact-form-B2ZA2F9C.js"),
			"../messages/en/contact-header.ts": () => import("./contact-header-BFriksSb.js"),
			"../messages/en/contact.ts": () => import("./contact-DN5ruVrZ.js"),
			"../messages/en/faq-header1.ts": () => import("./faq-header1-BaOIUJmC.js"),
			"../messages/en/faq-list.ts": () => import("./faq-list-hMipStHH.js"),
			"../messages/en/faq.ts": () => import("./faq-BShUQCvE.js"),
			"../messages/en/footer.ts": () => import("./footer-c8iCoU_Q.js"),
			"../messages/en/header.ts": () => import("./header-DZvKt9sF.js"),
			"../messages/en/hero.ts": () => import("./hero-DdDMha9j.js"),
			"../messages/en/home.ts": () => import("./home-B9azya4W.js"),
			"../messages/en/open-positions.ts": () => import("./open-positions-1wk7xZ-B.js"),
			"../messages/en/pricing.ts": () => import("./pricing-BbXfh0Hb.js"),
			"../messages/en/products.ts": () => import("./products-DeRZIERV.js"),
			"../messages/en/results-table.ts": () => import("./results-table-Y-Gjp5by.js"),
			"../messages/en/route.ts": () => import("./route-DHntTRIF.js"),
			"../messages/en/settings.ts": () => import("./settings-jChHpHFv.js"),
			"../messages/en/shared.ts": () => import("./shared-D-iikTkP.js"),
			"../messages/en/team.ts": () => import("./team-DRO3mCIn.js"),
			"../messages/en/theme-toggle.ts": () => import("./theme-toggle-DeFmRrPm.js"),
			"../messages/en/understanding-impact.ts": () => import("./understanding-impact-BSojoYr_.js"),
			"../messages/en/what-we-measure.ts": () => import("./what-we-measure-CxB5ZLfG.js"),
			"../messages/en/why-it-matters.ts": () => import("./why-it-matters-C-zvOx5d.js"),
			"../messages/es/about.ts": () => import("./about-Bt5ZTSky.js"),
			"../messages/es/blog.ts": () => import("./blog-Gg7yNyaE.js"),
			"../messages/es/careers.ts": () => import("./careers-BNQ9J1oN.js"),
			"../messages/es/contact.ts": () => import("./contact-BvczYSXA.js"),
			"../messages/es/faq.ts": () => import("./faq-NniKoazO.js"),
			"../messages/es/home.ts": () => import("./home-8h1mw7bC.js"),
			"../messages/es/pricing.ts": () => import("./pricing-CB5degcB.js"),
			"../messages/es/products.ts": () => import("./products-CUQWdrkI.js"),
			"../messages/es/route.ts": () => import("./route-CTNJ5ZbY.js"),
			"../messages/es/settings.ts": () => import("./settings-BABLFLXZ.js"),
			"../messages/es/shared.ts": () => import("./shared-DeEdO-SE.js"),
			"../messages/es/team.ts": () => import("./team-DbohOT8d.js"),
			"../messages/fr/about.ts": () => import("./about-pRT9pFjf.js"),
			"../messages/fr/blog.ts": () => import("./blog-vkq2YomL.js"),
			"../messages/fr/careers.ts": () => import("./careers-Biteqa6Z.js"),
			"../messages/fr/contact.ts": () => import("./contact-DpW3c23G.js"),
			"../messages/fr/faq.ts": () => import("./faq-BtyUD4ps.js"),
			"../messages/fr/home.ts": () => import("./home-DOMC_ru8.js"),
			"../messages/fr/pricing.ts": () => import("./pricing-DuC-LQ0t.js"),
			"../messages/fr/products.ts": () => import("./products-D-CZKM6j.js"),
			"../messages/fr/route.ts": () => import("./route-CDeflOHk.js"),
			"../messages/fr/settings.ts": () => import("./settings-BlH0D_nS.js"),
			"../messages/fr/shared.ts": () => import("./shared-BeA_Vl5o.js"),
			"../messages/fr/team.ts": () => import("./team-rMGArgC4.js"),
			"../messages/it/about.ts": () => import("./about-BZKMrQuv.js"),
			"../messages/it/blog.ts": () => import("./blog-C04nLz0t.js"),
			"../messages/it/careers.ts": () => import("./careers-DhhkkL-y.js"),
			"../messages/it/contact.ts": () => import("./contact-DFj7Snxf.js"),
			"../messages/it/faq.ts": () => import("./faq-9wLvw_Vl.js"),
			"../messages/it/home.ts": () => import("./home-gRkvjHDC.js"),
			"../messages/it/pricing.ts": () => import("./pricing-DwxpZNTi.js"),
			"../messages/it/products.ts": () => import("./products-CeQgJBEJ.js"),
			"../messages/it/route.ts": () => import("./route-CkX-tooD.js"),
			"../messages/it/settings.ts": () => import("./settings-CwnQjnZG.js"),
			"../messages/it/shared.ts": () => import("./shared-DN4L7y8_.js"),
			"../messages/it/team.ts": () => import("./team-uhLQlwUQ.js"),
			"../messages/ja/about.ts": () => import("./about-HGCD_6ln.js"),
			"../messages/ja/blog.ts": () => import("./blog-B7V2q0aT.js"),
			"../messages/ja/careers.ts": () => import("./careers-ZRM8XpPM.js"),
			"../messages/ja/contact.ts": () => import("./contact-BcsNddtW.js"),
			"../messages/ja/faq.ts": () => import("./faq-DYIvHTGw.js"),
			"../messages/ja/home.ts": () => import("./home-sN8qcWKk.js"),
			"../messages/ja/pricing.ts": () => import("./pricing-BDTKiqz9.js"),
			"../messages/ja/products.ts": () => import("./products-DmMvfj6Z.js"),
			"../messages/ja/route.ts": () => import("./route-SvKnFBnI.js"),
			"../messages/ja/settings.ts": () => import("./settings-CzN-TL0N.js"),
			"../messages/ja/shared.ts": () => import("./shared-G1YpkIh6.js"),
			"../messages/ja/team.ts": () => import("./team-CSC8ssEB.js"),
			"../messages/ko/about.ts": () => import("./about-DVGIx-4L.js"),
			"../messages/ko/blog.ts": () => import("./blog-CJ728PQI.js"),
			"../messages/ko/careers.ts": () => import("./careers-DlXSIo19.js"),
			"../messages/ko/contact.ts": () => import("./contact-BLVAGGnP.js"),
			"../messages/ko/faq.ts": () => import("./faq-BzeYSYJf.js"),
			"../messages/ko/home.ts": () => import("./home-7yV7KjLJ.js"),
			"../messages/ko/pricing.ts": () => import("./pricing-DsWH8_bP.js"),
			"../messages/ko/products.ts": () => import("./products-DatuBruP.js"),
			"../messages/ko/route.ts": () => import("./route-CuWaPCtk.js"),
			"../messages/ko/settings.ts": () => import("./settings-uwttpNmR.js"),
			"../messages/ko/shared.ts": () => import("./shared-DjrdLbHw.js"),
			"../messages/ko/team.ts": () => import("./team-nbt2qVVx.js"),
			"../messages/pt/about.ts": () => import("./about-Gbh5uGC0.js"),
			"../messages/pt/blog.ts": () => import("./blog-B-h8bQtH.js"),
			"../messages/pt/careers.ts": () => import("./careers-C0XB_4lb.js"),
			"../messages/pt/contact.ts": () => import("./contact-DjFbD-dH.js"),
			"../messages/pt/faq.ts": () => import("./faq-GJAlebNZ.js"),
			"../messages/pt/home.ts": () => import("./home-CgHNVrPc.js"),
			"../messages/pt/pricing.ts": () => import("./pricing--cQWKdvd.js"),
			"../messages/pt/products.ts": () => import("./products-CrRJxaOM.js"),
			"../messages/pt/route.ts": () => import("./route-DwoVlc1o.js"),
			"../messages/pt/settings.ts": () => import("./settings-B3dHGfv1.js"),
			"../messages/pt/shared.ts": () => import("./shared-Ba5m-RVr.js"),
			"../messages/pt/team.ts": () => import("./team-EKZAJmnX.js"),
			"../messages/ru/about.ts": () => import("./about-DXk-jyfo.js"),
			"../messages/ru/blog.ts": () => import("./blog-C5dUkJ-e.js"),
			"../messages/ru/careers.ts": () => import("./careers-Yl1UMLcO.js"),
			"../messages/ru/contact.ts": () => import("./contact-DnuHaSkJ.js"),
			"../messages/ru/faq.ts": () => import("./faq-CqRJlhte.js"),
			"../messages/ru/home.ts": () => import("./home-DvmvmRn_.js"),
			"../messages/ru/pricing.ts": () => import("./pricing-DIs6ijNR.js"),
			"../messages/ru/products.ts": () => import("./products-CO9SALBo.js"),
			"../messages/ru/route.ts": () => import("./route-CRGjOACx.js"),
			"../messages/ru/settings.ts": () => import("./settings-BfLXO6f1.js"),
			"../messages/ru/shared.ts": () => import("./shared-BYxMk7PL.js"),
			"../messages/ru/team.ts": () => import("./team-D3zIJizL.js"),
			"../messages/zh/about.ts": () => import("./about-CPwHOuPQ.js"),
			"../messages/zh/blog.ts": () => import("./blog--wl2nfGY.js"),
			"../messages/zh/careers.ts": () => import("./careers-Bp3KPGXx.js"),
			"../messages/zh/contact.ts": () => import("./contact-CwuHyuXS.js"),
			"../messages/zh/faq.ts": () => import("./faq-D3uNATAm.js"),
			"../messages/zh/home.ts": () => import("./home-BL5kqg2t.js"),
			"../messages/zh/pricing.ts": () => import("./pricing-DhrOqka4.js"),
			"../messages/zh/products.ts": () => import("./products-BXobIYzF.js"),
			"../messages/zh/route.ts": () => import("./route-CI9O1uAj.js"),
			"../messages/zh/settings.ts": () => import("./settings-BZja3y4G.js"),
			"../messages/zh/shared.ts": () => import("./shared-DuG-ua8J.js"),
			"../messages/zh/team.ts": () => import("./team-CEgqeNaS.js")
		}), `../messages/${e}/${r}.ts`, 4);
