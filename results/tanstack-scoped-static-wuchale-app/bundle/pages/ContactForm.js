...
var getRuntimeRx = registerLoaders("contact", loadCatalog$11, ["contact"]);
	...
	return jsxs("form", {
		...
		children: [
			...
			jsxs("div", { children: [jsx("label", {
				...
				children: [
					jsx("option", { children: _w_runtime_(87) }),
					jsx("option", { children: _w_runtime_(88) }),
					jsx("option", { children: _w_runtime_(89) }),
					jsx("option", { children: _w_runtime_(90) }),
					jsx("option", { children: _w_runtime_(91) })
				]
			})] }),
			jsxs("div", { children: [jsx("label", {
				htmlFor: messageId,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: _w_runtime_(92)
			}), jsx("textarea", {
				id: messageId,
				rows: 5,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: _w_runtime_(93)
			})] }),
			jsx("button", {
				type: "submit",
				className: "rounded-md bg-primary px-6 py-2.5 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity",
				children: _w_runtime_(94)
			})
		]
	});
}
