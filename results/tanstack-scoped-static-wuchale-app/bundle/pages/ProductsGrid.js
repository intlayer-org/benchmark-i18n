...
function ProductsGrid() {
	...
	const products = [
		{
			name: _w_runtime_(166),
			desc: _w_runtime_(167),
			price: _w_runtime_(168)
		},
		{
		...
		{
			name: _w_runtime_(171),
			desc: _w_runtime_(172),
			price: _w_runtime_(173)
		},
		{
			name: _w_runtime_(174),
			desc: _w_runtime_(175),
			price: "$99 one-time"
		},
		{
			name: _w_runtime_(176),
			desc: _w_runtime_(177),
			price: "$19/mo"
		},
		{
			name: _w_runtime_(178),
			desc: _w_runtime_(179),
			price: "$49/mo"
		}
	];
	return jsxDEV("div", {
