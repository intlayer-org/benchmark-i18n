...
function TeamGrid() {
	...
	const members = [
		{
			name: _w_runtime_(207),
			role: _w_runtime_(208),
			bio: _w_runtime_(209)
		},
		{
			name: _w_runtime_(210),
			role: _w_runtime_(211),
			bio: _w_runtime_(212)
		},
		{
			name: _w_runtime_(213),
			role: _w_runtime_(214),
			bio: _w_runtime_(215)
		},
		{
			name: _w_runtime_(216),
			role: _w_runtime_(217),
			bio: _w_runtime_(218)
		},
		{
			name: _w_runtime_(219),
			role: _w_runtime_(220),
			bio: _w_runtime_(221)
		},
		{
			name: _w_runtime_(222),
			role: _w_runtime_(223),
			bio: _w_runtime_(224)
		}
	];
	return jsxDEV("div", {
