		...
		children: [n("h2", {
			...
			children: [
				...
				r("div", { children: [n("label", {
					...
					children: [
						n("option", { children: i(118) }),
						n("option", { children: i(119) }),
						n("option", { children: i(120) }),
						n("option", { children: i(121) }),
						n("option", { children: i(122) }),
						n("option", { children: i(123) }),
						n("option", { children: i(124) })
					]
				})] })
			]
		})]
