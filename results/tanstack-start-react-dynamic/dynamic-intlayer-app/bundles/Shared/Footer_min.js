...
import { Link as p, useParams as m } from "@tanstack/react-router";
...
}, T = process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false", ae = process.env.INTLAYER_NODE_TYPE_INSERTION === "false", E = {
	id: "fallback-plugin",
	canHandle: () => !1,
	transform: (e) => e
}, D = (e, t) => T ? E : {
...
var H = z ? E : {
	...
	K,
	q
].filter(Boolean), ce = (e, t) => F(e, t, se(t)), le = (e, t = g?.locales, n = g?.defaultLocale) => {
...
var ue = (e, t, n) => {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), _e = ({ locale: e, defaultLocale: t, children: n, setLocale: r, disableEditor: i, isCookieEnabled: a }) => {
	let { locales: s, defaultLocale: c } = g ?? {}, [u, f] = l(e ?? X ?? t ?? c);
	o(() => {
		e && e !== u && f(e);
	}, [e]), o(() => {
		ge();
...
}, Q = ({ children: e, ...t }) => /* @__PURE__ */ f(_e, {
	...t,
	children: [/* @__PURE__ */ d(he, {}), e]
}), ve = (e, t) => {
	let { locale: n } = a(Z) ?? {};
	return s(() => ce(e, t ?? n), [
		e.key,
...
}, $ = /* @__PURE__ */ new Map(), be = (e, t) => ($.has(e) || $.set(e, ye(t)), $.get(e).read()), xe = (e, t, n) => {
	let { locale: r } = a(Z) ?? {}, i = s(() => n ?? r ?? g.defaultLocale, [r, n]);
	return ve(be(`${String(t)}.${i}`, e[i]?.()), i);
};
//#endregion
//#region src/components/Footer.tsx
function Se() {
	let { a: e } = xe(ee, "shared"), t = m({ strict: !1 }).locale ?? "en", n = [
		{
			label: e.e,
			...
			children: [/* @__PURE__ */ f("div", {
				...
				children: [
					...
					/* @__PURE__ */ f("div", { children: [/* @__PURE__ */ d("h3", {
						...
						className: "space-y-1",
						children: n.map((e) => /* @__PURE__ */ d("li", { children: e.isInternal ? /* @__PURE__ */ d(p, {
							to: e.to,
							params: { locale: t },
