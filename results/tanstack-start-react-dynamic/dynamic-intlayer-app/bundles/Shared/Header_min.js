...
var g = (e, t, n) => {
...
}, re = "translation", S = "insertion", ie = "object", ae = "array", C = (e, t) => {
	...
	return n;
}, oe = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), w = (e) => {
...
}, se = process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false", ce = process.env.INTLAYER_NODE_TYPE_INSERTION === "false", D = {
	id: "fallback-plugin",
	canHandle: () => !1,
	transform: (e) => e
}, O = (e, t) => se ? D : {
...
var V = R ? D : {
	...
	me,
	he
].filter(Boolean), _e = (e, t) => P(e, t, ge(t)), ve = (e, t = v?.locales, n = v?.defaultLocale) => {
...
var W = (e, t, n) => {
	...
	if (!U) for (let t = 0; t < (y.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(y.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, be = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !U && y.storage.cookies) for (let n = 0; n < y.storage.cookies.length; n++) {
...
}, xe = 50, K = /* @__PURE__ */ new Map(), q = (e, t, n) => {
	let r = t ?? v?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = K.get(e);
...
}, Ce = (e, t = e) => new Se.DisplayNames(t, { type: "language" }).of(e) ?? "Unknown locale", J = ye(G), Y = (e, t) => be(e, {
	...G,
	isCookieEnabled: t
}), we = () => {
...
}, Z = /* @__PURE__ */ new Map(), je = (e, t) => (Z.has(e) || Z.set(e, Ae(t)), Z.get(e).read()), Q = (e, t, n) => {
	let { locale: r } = o(X) ?? {}, i = l(() => n ?? r ?? v.defaultLocale, [r, n]);
	return ke(je(`${String(t)}.${i}`, e[i]?.()), i);
}, Me = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { defaultLocale: n, locales: r } = v ?? {}, { locale: i, setLocale: s, isCookieEnabled: c } = o(X) ?? {};
	return {
		locale: i,
		defaultLocale: n,
		availableLocales: r,
...
function Fe() {
	let e = ee(), { locale: t, availableLocales: n, setLocale: r } = Me({ onLocaleChange: (t) => {
		e({
			to: ".",
			params: (e) => ({
				...e,
