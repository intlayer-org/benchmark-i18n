...
var f = (e, t, n) => {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), S = ({ locale: e, defaultLocale: t, children: r, setLocale: o, disableEditor: s, isCookieEnabled: l }) => {
	let { locales: d, defaultLocale: f } = c ?? {}, [p, m] = i(e ?? g ?? t ?? f);
	n(() => {
		e && e !== p && m(e);
	}, [e]), n(() => {
		b();
