...
function ThemeToggle() {
	const content$1 = useDictionaryDynamic(content, "shared");
	...
	const label = mode === "auto" ? content$1.g.value : `Theme mode: ${mode}. Click to switch mode.`;
	return /* @__PURE__ */ jsx("button", {
		...
		children: mode === "auto" ? content$1.d.value : mode === "dark" ? content$1.e.value : content$1.f.value
	});
}
//#endregion
