...
}, ie = process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false", ae = process.env.INTLAYER_NODE_TYPE_INSERTION === "false", w = {
	id: "fallback-plugin",
	canHandle: () => !1,
	transform: (e) => e
}, T = (e, t) => ie ? w : {
...
var z = I ? w : {
	...
	U,
	W
].filter(Boolean), K = (e, t) => M(e, t, G(t)), ce = (e, t = h?.locales, n = h?.defaultLocale) => {
...
var le = (e, t, n) => {
	...
	if (!q) for (let t = 0; t < (g.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(g.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, de = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !q && g.storage.cookies) for (let n = 0; n < g.storage.cookies.length; n++) {
	...
	locale: Y ?? h?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), Z = ({ locale: e, defaultLocale: t, children: n, setLocale: r, disableEditor: i, isCookieEnabled: a }) => {
	let { locales: s, defaultLocale: c } = h ?? {}, [u, f] = l(e ?? Y ?? t ?? c);
	o(() => {
		e && e !== u && f(e);
	}, [e]), o(() => {
		he();
...
}, ge = ({ children: e, ...t }) => /* @__PURE__ */ f(Z, {
	...t,
	children: [/* @__PURE__ */ d(me, {}), e]
}), _e = (e, t) => {
	let { locale: n } = a(X) ?? {};
	return s(() => K(e, t ?? n), [
		e.key,
...
}, Q = /* @__PURE__ */ new Map(), ye = (e, t) => (Q.has(e) || Q.set(e, ve(t)), Q.get(e).read()), be = (e, t, n) => {
	let { locale: r } = a(X) ?? {}, i = s(() => n ?? r ?? h.defaultLocale, [r, n]);
...
function Se() {
	...
	let i = t === "auto" ? e.g.value : `Theme mode: ${t}. Click to switch mode.`;
	return /* @__PURE__ */ d("button", {
		...
		children: t === "auto" ? e.d.value : t === "dark" ? e.e.value : e.f.value
	});
}
//#endregion
...
function we() {
	return /* @__PURE__ */ d(Ce, { children: /* @__PURE__ */ d(Se, {}) });
}
//#endregion
