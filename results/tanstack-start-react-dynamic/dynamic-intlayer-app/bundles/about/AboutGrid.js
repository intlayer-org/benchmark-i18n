...
var content = {
	"de": () => import("./de-2D2R43z0.js").then((m) => m.default),
	"en": () => import("./en-BoYrerAY.js").then((m) => m.default),
	"es": () => import("./es-CnN4Cryp.js").then((m) => m.default),
	"fr": () => import("./fr-Dlj5mhfD.js").then((m) => m.default),
	"it": () => import("./it-D5_SMYGH.js").then((m) => m.default),
	"ja": () => import("./ja-C3FFGNPD.js").then((m) => m.default),
	"ko": () => import("./ko-CqQvgmVq.js").then((m) => m.default),
	"pt": () => import("./pt-DgrRd017.js").then((m) => m.default),
	"ru": () => import("./ru-DxQHoRwB.js").then((m) => m.default),
	"zh": () => import("./zh-BKhK8NLa.js").then((m) => m.default)
};
//#endregion
