...
var content$1 = {
	"de": () => import("./de-DO20hg4m.js").then((m) => m.default),
	"en": () => import("./en-cIBEk6-s.js").then((m) => m.default),
	"es": () => import("./es-thaThyPc.js").then((m) => m.default),
	"fr": () => import("./fr-BvoS2I_C.js").then((m) => m.default),
	"it": () => import("./it-CfCSbf_d.js").then((m) => m.default),
	"ja": () => import("./ja-BjKeBlc2.js").then((m) => m.default),
	"ko": () => import("./ko-CCmQE_vz.js").then((m) => m.default),
	"pt": () => import("./pt-Daw7rajY.js").then((m) => m.default),
	"ru": () => import("./ru-hKa87I8n.js").then((m) => m.default),
	"zh": () => import("./zh-DCMwXJO-.js").then((m) => m.default)
};
//#endregion
