...
//#endregion
//#region .intlayer/dynamic_dictionary/blog.mjs
var content = loadContent("blog");
//#endregion
...
function BlogList() {
	const { b: content$1 } = useDictionaryDynamic(content, "blog");
	return /* @__PURE__ */ jsx("div", {
		...
		children: [
			...
			{
				title: content$1.i.value,
				date: content$1.k.value,
				excerpt: content$1.m.value,
				category: "Tutorial"
			},
			{
			...
			{
				title: content$1.l.value,
				date: content$1.g.value,
				excerpt: content$1.a.value,
				category: "Tutorial"
			},
			{
				title: content$1.p.value,
				date: content$1.f.value,
				excerpt: content$1.n.value,
				category: "Analysis"
			},
			{
				title: content$1.d.value,
