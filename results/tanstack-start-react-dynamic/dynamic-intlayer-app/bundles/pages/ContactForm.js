import { Fragment, createContext, createElement, isValidElement, lazy, useContext, useEffect, useId, useMemo, useRef, useState } from "react";
...
//#endregion
//#region .intlayer/dynamic_dictionary/contact.mjs
var content = loadContent("contact");
//#endregion
...
function ContactForm() {
	const { a: content$1 } = useDictionaryDynamic(content, "contact");
	const nameId = useId();
	const emailId = useId();
	const topicId = useId();
