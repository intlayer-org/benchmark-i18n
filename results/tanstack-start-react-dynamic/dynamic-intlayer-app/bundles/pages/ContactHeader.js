...
var content$1 = {
	"de": () => import("./de-BYr_vaJC.js").then((m) => m.default),
	"en": () => import("./en-DiMjl5-9.js").then((m) => m.default),
	"es": () => import("./es-BpsYS2y-.js").then((m) => m.default),
	"fr": () => import("./fr-Dxw_Dc_-.js").then((m) => m.default),
	"it": () => import("./it-CFw0qx8N.js").then((m) => m.default),
	"ja": () => import("./ja-C_ekCVCD.js").then((m) => m.default),
	"ko": () => import("./ko-D9T8lhGP.js").then((m) => m.default),
	"pt": () => import("./pt-D74wzX4f.js").then((m) => m.default),
	"ru": () => import("./ru-JkufxqUg.js").then((m) => m.default),
	"zh": () => import("./zh-D-wpfXqw.js").then((m) => m.default)
};
//#endregion
