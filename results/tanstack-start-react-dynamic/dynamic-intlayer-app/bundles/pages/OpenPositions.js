...
var content = {
	"de": () => import("./de-Df7d3UFt.js").then((m) => m.default),
	"en": () => import("./en-CpOy7N4H.js").then((m) => m.default),
	"es": () => import("./es-De423rXx.js").then((m) => m.default),
	"fr": () => import("./fr-CnfQz01G.js").then((m) => m.default),
	"it": () => import("./it-CIDXA3SM.js").then((m) => m.default),
	"ja": () => import("./ja-BE-Hb-RH.js").then((m) => m.default),
	"ko": () => import("./ko-CP6aZPB1.js").then((m) => m.default),
	"pt": () => import("./pt-sRzqpi5V.js").then((m) => m.default),
	"ru": () => import("./ru-ClBTLp9k.js").then((m) => m.default),
	"zh": () => import("./zh-Du84WhXt.js").then((m) => m.default)
};
//#endregion
