...
var content = {
	"de": () => import("./de-BBwo-gGV.js").then((m) => m.default),
	"en": () => import("./en-VmNo50H_.js").then((m) => m.default),
	"es": () => import("./es-DKjHOW2b.js").then((m) => m.default),
	"fr": () => import("./fr-CyHnuveO.js").then((m) => m.default),
	"it": () => import("./it--PSAUT_u.js").then((m) => m.default),
	"ja": () => import("./ja-BgJ7GqnG.js").then((m) => m.default),
	"ko": () => import("./ko-BaNxhR4z.js").then((m) => m.default),
	"pt": () => import("./pt-Clk5O47G.js").then((m) => m.default),
	"ru": () => import("./ru-DgzEDxPy.js").then((m) => m.default),
	"zh": () => import("./zh-Bx_aOtXz.js").then((m) => m.default)
};
//#endregion
