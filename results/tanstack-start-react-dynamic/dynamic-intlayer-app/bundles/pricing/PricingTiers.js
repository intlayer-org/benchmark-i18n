...
var content = {
	"de": () => import("./de-CcBgLtAZ.js").then((m) => m.default),
	"en": () => import("./en-DaBVKPq4.js").then((m) => m.default),
	"es": () => import("./es-BRhdYqez.js").then((m) => m.default),
	"fr": () => import("./fr-CD-xSRWG.js").then((m) => m.default),
	"it": () => import("./it-CXG2Gl_h.js").then((m) => m.default),
	"ja": () => import("./ja-Bu4Ddb_6.js").then((m) => m.default),
	"ko": () => import("./ko-CEgySFVN.js").then((m) => m.default),
	"pt": () => import("./pt-BgKEgn2s.js").then((m) => m.default),
	"ru": () => import("./ru-l2UVxv5_.js").then((m) => m.default),
	"zh": () => import("./zh-B1WfbtZ6.js").then((m) => m.default)
};
//#endregion
