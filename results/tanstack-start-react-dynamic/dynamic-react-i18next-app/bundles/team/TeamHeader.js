...
}((language) => _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({
	"./locales/de.json": () => import("./de-ByqLnW4q.js"),
	"./locales/en.json": () => import("./en-De8v_5z5.js"),
	"./locales/es.json": () => import("./es-CjyfEM_u.js"),
	"./locales/fr.json": () => import("./fr-DzbFH1iU.js"),
	"./locales/it.json": () => import("./it-FQYVuLuo.js"),
	"./locales/ja.json": () => import("./ja-I2A5quZd.js"),
	"./locales/ko.json": () => import("./ko-Dnrnr4LQ.js"),
	"./locales/pt.json": () => import("./pt-B18-k57N.js"),
	"./locales/ru.json": () => import("./ru-DM0LoKu5.js"),
	"./locales/zh.json": () => import("./zh-_bXSrdty.js")
...
var mockBanner = "⚠️ Diese Seite enthält fiktive Daten, die nur Benchmark-Zwecken dienen. Sie stehen in keinem Zusammenhang mit realen Unternehmen oder Dienstleistungen.";
var de_default = {
	route,
	header,
	footer,
...
//#endregion
export { aboutGrid, aboutHeader, apiAccessSection, blogHeader, blogList, careersBenefits, careersHeader, contactForm, contactHeader, de_default as default, faqList, footer, header, hero, mockBanner, openPositions, preferencesSection, pricingHeader, pricingTiers, productsGrid, productsHeader, profileSection, resultsTable, route, settingsFooter, settingsHeader, teamGrid, teamHeader, themeToggle, understandingImpact, whatWeMeasure, whyItMatters };
...
//#endregion
export { aboutGrid, aboutHeader, apiAccessSection, blogHeader, blogList, careersBenefits, careersHeader, contactForm, contactHeader, en_default as default, faqList, footer, header, hero, mockBanner, openPositions, preferencesSection, pricingHeader, pricingTiers, productsGrid, productsHeader, profileSection, resultsTable, route, settingsFooter, settingsHeader, teamGrid, teamHeader, themeToggle, understandingImpact, whatWeMeasure, whyItMatters };
...
var mockBanner = "⚠️ Esta página contiene datos simulados solo para fines de benchmarking. No está relacionada con ningún negocio o servicio real.";
var es_default = {
	route,
	header,
	footer,
...
//#endregion
export { aboutGrid, aboutHeader, apiAccessSection, blogHeader, blogList, careersBenefits, careersHeader, contactForm, contactHeader, es_default as default, faqList, footer, header, hero, mockBanner, openPositions, preferencesSection, pricingHeader, pricingTiers, productsGrid, productsHeader, profileSection, resultsTable, route, settingsFooter, settingsHeader, teamGrid, teamHeader, themeToggle, understandingImpact, whatWeMeasure, whyItMatters };
...
var mockBanner = "⚠️ Cette page contient des données factices à des fins de benchmarking uniquement. Elle n'est liée à aucune entreprise ou service réel.";
var fr_default = {
	route,
	header,
	footer,
...
//#endregion
export { aboutGrid, aboutHeader, apiAccessSection, blogHeader, blogList, careersBenefits, careersHeader, contactForm, contactHeader, fr_default as default, faqList, footer, header, hero, mockBanner, openPositions, preferencesSection, pricingHeader, pricingTiers, productsGrid, productsHeader, profileSection, resultsTable, route, settingsFooter, settingsHeader, teamGrid, teamHeader, themeToggle, understandingImpact, whatWeMeasure, whyItMatters };
...
var mockBanner = "⚠️ Questa pagina contiene dati fittizi solo a scopo di benchmarking. Non è correlata ad alcuna attività o servizio reale.";
var it_default = {
	route,
	header,
	footer,
...
//#endregion
export { aboutGrid, aboutHeader, apiAccessSection, blogHeader, blogList, careersBenefits, careersHeader, contactForm, contactHeader, it_default as default, faqList, footer, header, hero, mockBanner, openPositions, preferencesSection, pricingHeader, pricingTiers, productsGrid, productsHeader, profileSection, resultsTable, route, settingsFooter, settingsHeader, teamGrid, teamHeader, themeToggle, understandingImpact, whatWeMeasure, whyItMatters };
...
//#endregion
export { aboutGrid, aboutHeader, apiAccessSection, blogHeader, blogList, careersBenefits, careersHeader, contactForm, contactHeader, ja_default as default, faqList, footer, header, hero, mockBanner, openPositions, preferencesSection, pricingHeader, pricingTiers, productsGrid, productsHeader, profileSection, resultsTable, route, settingsFooter, settingsHeader, teamGrid, teamHeader, themeToggle, understandingImpact, whatWeMeasure, whyItMatters };
...
//#endregion
export { aboutGrid, aboutHeader, apiAccessSection, blogHeader, blogList, careersBenefits, careersHeader, contactForm, contactHeader, ko_default as default, faqList, footer, header, hero, mockBanner, openPositions, preferencesSection, pricingHeader, pricingTiers, productsGrid, productsHeader, profileSection, resultsTable, route, settingsFooter, settingsHeader, teamGrid, teamHeader, themeToggle, understandingImpact, whatWeMeasure, whyItMatters };
...
//#endregion
export { aboutGrid, aboutHeader, apiAccessSection, blogHeader, blogList, careersBenefits, careersHeader, contactForm, contactHeader, pt_default as default, faqList, footer, header, hero, mockBanner, openPositions, preferencesSection, pricingHeader, pricingTiers, productsGrid, productsHeader, profileSection, resultsTable, route, settingsFooter, settingsHeader, teamGrid, teamHeader, themeToggle, understandingImpact, whatWeMeasure, whyItMatters };
...
var mockBanner = "⚠️ Эта страница содержит фиктивные данные только для целей тестирования производительности. Она не связана с каким-либо реальным бизнесом или услугой.";
var ru_default = {
	route,
	header,
	footer,
...
//#endregion
export { aboutGrid, aboutHeader, apiAccessSection, blogHeader, blogList, careersBenefits, careersHeader, contactForm, contactHeader, ru_default as default, faqList, footer, header, hero, mockBanner, openPositions, preferencesSection, pricingHeader, pricingTiers, productsGrid, productsHeader, profileSection, resultsTable, route, settingsFooter, settingsHeader, teamGrid, teamHeader, themeToggle, understandingImpact, whatWeMeasure, whyItMatters };
...
//#endregion
export { aboutGrid, aboutHeader, apiAccessSection, blogHeader, blogList, careersBenefits, careersHeader, contactForm, contactHeader, zh_default as default, faqList, footer, header, hero, mockBanner, openPositions, preferencesSection, pricingHeader, pricingTiers, productsGrid, productsHeader, profileSection, resultsTable, route, settingsFooter, settingsHeader, teamGrid, teamHeader, themeToggle, understandingImpact, whatWeMeasure, whyItMatters };
