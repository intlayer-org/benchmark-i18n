	...
	return /* @__PURE__ */ i("div", {
		...
		children: [/* @__PURE__ */ i("div", {
			...
			children: [/* @__PURE__ */ r("h2", {
				...
				children: e.formatMessage({ id: "about-grid.whyThisExists" })
			}), /* @__PURE__ */ r("p", {
				className: "text-sm text-muted-foreground",
				children: e.formatMessage({ id: "about-grid.choosingAnI18nLibraryIs" })
			})]
		}), /* @__PURE__ */ i("div", {
			className: "rounded-lg border border-border bg-card p-6",
			children: [/* @__PURE__ */ r("h2", {
				className: "mb-3 text-xl font-semibold text-foreground",
				children: e.formatMessage({ id: "about-grid.methodology" })
			}), /* @__PURE__ */ r("p", {
				className: "text-sm text-muted-foreground",
				children: e.formatMessage({ id: "about-grid.theSame10PageApp" })
			})]
		})]
	});
}
