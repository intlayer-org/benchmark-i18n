...
function H(e) {
	e.forEach((e) => {
		...
		else A(e) && I(e.style) || (j(e) || M(e)) && L(e.style) ? delete e.style.location : F(e) && H(e.children);
	});
}
function Be(e, t = {}) {
	t = {
...
function K(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (A(c)) {
			let e = typeof c.style == "string" ? r.number[c.style] : I(c.style) ? c.style.parsedOptions : void 0;
			if (e && e.scale) {
				let t = e.scale || 1;
				if (typeof l == "bigint") {
...
function ut() {
	...
	return /* @__PURE__ */ m("div", {
		...
		children: /* @__PURE__ */ m("select", {
			...
			children: ct.map((e) => /* @__PURE__ */ m("option", {
				value: e,
				children: lt(e)
			}, e))
		})
					...
					children: [
						...
						/* @__PURE__ */ h("div", {
							...
							children: [/* @__PURE__ */ h("button", {
								...
								onMouseLeave: () => n(!1),
								onClick: () => n(!t),
								children: [e("mockPages"), /* @__PURE__ */ m(p, {
									size: 14,
...
function _t() {
	return /* @__PURE__ */ m(gt, { children: /* @__PURE__ */ m(ft, {}) });
}
//#endregion
