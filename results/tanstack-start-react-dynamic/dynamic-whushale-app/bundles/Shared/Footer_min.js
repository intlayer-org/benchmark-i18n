...
} }, m = (e, t) => p[e][t](), h = ["main"], g = "main", _ = {}, v = {}, y = (e) => v[e];
f(g, m, h, {
	get: y,
	set: (e, t) => {
		v[e] = t, _[e]?.forEach((e) => {
...
var b = (e) => {
	...
	return n(() => {
		let t = (e) => i(() => e);
		return _[e] ??= /* @__PURE__ */ new Set(), _[e].add(t), () => _[e].delete(t);
	}, [e]), t;
};
//#endregion
//#region src/components/Footer.tsx
function x() {
	let n = t({ strict: !1 }).locale ?? "en", r = b("main"), o = [
		{
			label: r(0),
			...
			children: [/* @__PURE__ */ a("div", {
				...
				children: [
					...
					/* @__PURE__ */ a("div", { children: [/* @__PURE__ */ i("h3", {
						...
						className: "space-y-1",
						children: o.map((t) => /* @__PURE__ */ i("li", { children: t.isInternal ? /* @__PURE__ */ i(e, {
							to: t.to,
							params: { locale: n },
