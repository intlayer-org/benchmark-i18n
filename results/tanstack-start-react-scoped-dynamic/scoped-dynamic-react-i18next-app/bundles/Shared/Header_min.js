...
function Ke() {
	...
	return /* @__PURE__ */ p("div", {
		...
		children: /* @__PURE__ */ p("select", {
			...
			children: We.map((e) => /* @__PURE__ */ p("option", {
				value: e,
				children: Ge(e)
			}, e))
		})
					...
					children: [
						...
						/* @__PURE__ */ m("div", {
							...
							children: [/* @__PURE__ */ m("button", {
								...
								onMouseLeave: () => n(!1),
								onClick: () => n(!t),
								children: [e("header.mockPages"), /* @__PURE__ */ p(f, {
									size: 14,
...
function et() {
	return /* @__PURE__ */ p($e, { children: /* @__PURE__ */ p(Je, {}) });
}
//#endregion
