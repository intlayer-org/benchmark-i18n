...
var g = (e, t, n) => {
	...
	O(e ?? y.defaultLocale, t ? y.defaultLocale : void 0),
	k,
	A,
	ue,
	M(e ?? y.defaultLocale),
...
var H = z ? D : {
	...
	he,
	ge
].filter(Boolean), ve = (e, t) => F(e, t, _e(t)), ye = (e, t = y?.locales, n = y?.defaultLocale) => {
...
var be = (e, t, n) => {
	...
	if (!U) for (let t = 0; t < (b.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(b.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, Se = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !U && b.storage.cookies) for (let n = 0; n < b.storage.cookies.length; n++) {
...
}, Ce = 50, G = /* @__PURE__ */ new Map(), K = (e, t, n) => {
	let r = t ?? y?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = G.get(e);
	a || (a = /* @__PURE__ */ new Map(), G.set(e, a));
	let o = a.get(i);
	return o || (a.size > Ce && a.clear(), o = new e(r, n), a.set(i, o)), o;
}, we = {
...
}, Te = (e, t = e) => new we.DisplayNames(t, { type: "language" }).of(e) ?? "Unknown locale", q = xe(W), J = (e, t) => Se(e, {
	...W,
	isCookieEnabled: t
}), Ee = () => {
...
}, De = ({ children: e }) => (Ee(), e), Oe = () => {
	typeof window < "u" && (window.intlayer = { enabled: !0 });
}, Y = t({
	locale: q ?? y?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), ke = ({ locale: e, defaultLocale: t, children: n, setLocale: r, disableEditor: i, isCookieEnabled: a }) => {
	let { locales: o, defaultLocale: c } = y ?? {}, [l, u] = d(e ?? q ?? t ?? c);
	s(() => {
		e && e !== l && u(e);
	}, [e]), s(() => {
		Oe();
...
}, Ae = ({ children: e, ...t }) => /* @__PURE__ */ m(ke, {
	...t,
	children: [/* @__PURE__ */ p(De, {}), e]
}), je = (e, t) => {
	let { locale: n } = o(Y) ?? {};
	return l(() => ve(e, t ?? n), [
		e.key,
...
}, X = /* @__PURE__ */ new Map(), Ne = (e, t) => (X.has(e) || X.set(e, Me(t)), X.get(e).read()), Z = (e, t, n) => {
	let { locale: r } = o(Y) ?? {}, i = l(() => n ?? r ?? y.defaultLocale, [r, n]);
	return je(Ne(`${String(t)}.${i}`, e[i]?.()), i);
}, Pe = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { defaultLocale: n, locales: r } = y ?? {}, { locale: i, setLocale: s, isCookieEnabled: c } = o(Y) ?? {};
	return {
		locale: i,
		defaultLocale: n,
		availableLocales: r,
...
function Ie() {
	let e = Z(Fe, "theme-toggle"), [t, n] = d("auto");
	s(() => {
		let e = Q();
		n(e), $(e);
	}, []), s(() => {
...
function Le() {
	let e = ee(), { locale: t, availableLocales: n, setLocale: r } = Pe({ onLocaleChange: (t) => {
		e({
			to: ".",
			params: (e) => ({
				...e,
...
function Ve() {
	return /* @__PURE__ */ p(Be, { children: /* @__PURE__ */ p(ze, {}) });
}
//#endregion
