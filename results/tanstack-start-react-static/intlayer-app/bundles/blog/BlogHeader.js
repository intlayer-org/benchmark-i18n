...
var blog_header_default = {
	...
	content: {
		...
		"translation": {
			"en": { "a": "Insights, tutorials, and analysis from the i18n community." },
			"fr": { "a": "Aperçus, tutoriels et analyses de la communauté i18n." },
			"es": { "a": "Información, tutoriales y análisis de la comunidad i18n." },
			"de": { "a": "Einblicke, Tutorials und Analysen aus der i18n-Community." },
			"it": { "a": "Approfondimenti, tutorial e analisi dalla comunità i18n." },
			"pt": { "a": "Insights, tutoriais e análises da comunidade i18n." },
			"zh": { "a": "来自 i18n 社区 de 见解、教程和分析。" },
			"ja": { "a": "i18n コミュニティからの洞察、チュートリアル、分析。" },
			"ko": { "a": "i18n 커뮤니티의 인사이트, 튜토리얼 및 분석." },
			"ru": { "a": "Инсайты, руководства и анализ от сообщества i18n." }
		}
	}
};
//#endregion
