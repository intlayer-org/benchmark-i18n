...
function xe() {
	let e = be(ee, "contact-form"), t = s(), n = s(), r = s(), i = s();
		...
		children: [
			...
			/* @__PURE__ */ p("div", { children: [/* @__PURE__ */ f("label", {
				...
				children: [
					...
					/* @__PURE__ */ f("option", { children: e.d }),
					/* @__PURE__ */ f("option", { children: e.c }),
					/* @__PURE__ */ f("option", { children: "Contribution" }),
					/* @__PURE__ */ f("option", { children: "Other" })
				]
			})] }),
			/* @__PURE__ */ p("div", { children: [/* @__PURE__ */ f("label", {
				htmlFor: i,
