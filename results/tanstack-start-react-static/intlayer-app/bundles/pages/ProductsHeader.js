...
var products_header_default = {
	...
	content: {
		...
		"translation": {
			"en": { "a": "Tools and services to streamline your internationalization workflow." },
			"fr": { "a": "Outils et services pour rationaliser votre flux de travail d'internationalisation." },
			"es": { "a": "Herramientas y servicios para simplificar su flujo de trabajo de internacionalización." },
			"de": { "a": "Tools und Dienste zur Optimierung Ihres Internationalisierungs-Worflows." },
			"it": { "a": "Strumenti e servizi per semplificare il flusso di lavoro di internazionalizzazione." },
			"pt": { "a": "Ferramentas e serviços para otimizar seu fluxo de trabalho de internacionalización." },
			"zh": { "a": "简化国际化工作流程的工具和服务。" },
			"ja": { "a": "国際化ワークフローを合理化するためのツールとサービス。" },
			"ko": { "a": "국제화 워크플로우를 합리화하기 위한 도구 및 서비스입니다." },
			"ru": { "a": "Инструменты и услуги для оптимизации рабочего процесса интернационализации." }
		}
	}
};
//#endregion
...
function ProductsHeader() {
	const content = useDictionary(products_header_default);
