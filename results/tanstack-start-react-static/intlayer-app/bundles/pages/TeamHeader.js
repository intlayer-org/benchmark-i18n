...
//#endregion
//#region .intlayer/dynamic_dictionary/_loadjson.mjs
var loadContent = (key) => ({
	"de": () => _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({
		"./json/about-grid/de.json": () => import("./de-BD5lf3uu.js"),
		"./json/about-header/de.json": () => import("./de-z5CKT47A.js"),
		"./json/api-access-section/de.json": () => import("./de-ClkhDOD8.js"),
		"./json/blog-header/de.json": () => import("./de-CPvEsSsZ.js"),
		"./json/blog-list/de.json": () => import("./de-CVyQd140.js"),
		"./json/careers-benefits/de.json": () => import("./de-DNwdmCMB.js"),
		"./json/careers-header/de.json": () => import("./de-idJ2RQLy.js"),
		"./json/contact-form/de.json": () => import("./de-2bjCEYtf.js"),
		"./json/contact-header/de.json": () => import("./de-DpHZ7g8t.js"),
		"./json/faq-header1/de.json": () => import("./de-CPvSIdUl.js"),
		"./json/faq-list/de.json": () => import("./de-Bhyp1pn4.js"),
		"./json/footer/de.json": () => import("./de-Gkna5nZH.js"),
		"./json/header/de.json": () => import("./de-Bt-AS0qh.js"),
		"./json/hero/de.json": () => import("./de-D0k-dzkf.js"),
		"./json/open-positions/de.json": () => import("./de-BvwUqbm9.js"),
		"./json/preferences-section/de.json": () => import("./de-DgEeTC8V.js"),
		"./json/pricing-header/de.json": () => import("./de-DUY7_bwA.js"),
		"./json/pricing-tiers/de.json": () => import("./de-DDk8JqxS.js"),
		"./json/products-grid/de.json": () => import("./de-DZ4AzM_a.js"),
		"./json/products-header/de.json": () => import("./de-C9Nle3vL.js"),
		"./json/profile-section/de.json": () => import("./de-D_9O_56i.js"),
		"./json/results-table/de.json": () => import("./de-CGRKmLSi.js"),
		"./json/route/de.json": () => import("./de-CBNRhL7K.js"),
		"./json/settings-footer/de.json": () => import("./de-BsdEE2mv.js"),
		"./json/settings-header/de.json": () => import("./de-B_Hd9a53.js"),
		"./json/team-grid/de.json": () => import("./de-U9Ruqt9E.js"),
		"./json/team-header/de.json": () => import("./de-C4TveQ18.js"),
		"./json/theme-toggle/de.json": () => import("./de-B9wSHEUI.js"),
		"./json/understanding-impact/de.json": () => import("./de-BG8Kw6LO.js"),
		"./json/what-we-measure/de.json": () => import("./de-Brc2bh6T.js"),
		"./json/why-it-matters/de.json": () => import("./de-CXbR4ou5.js")
	}), `./json/${key}/de.json`, 4).then((m) => m.default),
	"en": () => _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({
		"./json/about-grid/en.json": () => import("./en-gGlapLxH.js"),
		"./json/about-header/en.json": () => import("./en-CMUIh9mx.js"),
		"./json/api-access-section/en.json": () => import("./en-BSE1F8sQ.js"),
		"./json/blog-header/en.json": () => import("./en-VJEaocQZ.js"),
		"./json/blog-list/en.json": () => import("./en-BLUy_swJ.js"),
		"./json/careers-benefits/en.json": () => import("./en-BWFMls7w.js"),
		"./json/careers-header/en.json": () => import("./en-La1eWuMA.js"),
		"./json/contact-form/en.json": () => import("./en-DLLKtwTP.js"),
		"./json/contact-header/en.json": () => import("./en-DSYxNBAP.js"),
		"./json/faq-header1/en.json": () => import("./en-D9hnxTmL.js"),
		"./json/faq-list/en.json": () => import("./en-BsaLzdvq.js"),
		"./json/footer/en.json": () => import("./en-DwEIdUSd.js"),
		"./json/header/en.json": () => import("./en-BuKpGMbC.js"),
		"./json/hero/en.json": () => import("./en-N5BA6DnB.js"),
		"./json/open-positions/en.json": () => import("./en-DbE2qWVA.js"),
		"./json/preferences-section/en.json": () => import("./en-CvcUaBdu.js"),
		"./json/pricing-header/en.json": () => import("./en-DOQOfvxu.js"),
		"./json/pricing-tiers/en.json": () => import("./en-B634YgL7.js"),
		"./json/products-grid/en.json": () => import("./en-C7qxhkjH.js"),
		"./json/products-header/en.json": () => import("./en-DyEnTtm2.js"),
		"./json/profile-section/en.json": () => import("./en-BNWRWhga.js"),
		"./json/results-table/en.json": () => import("./en-cvuuAe5y.js"),
		"./json/route/en.json": () => import("./en-BKO2aMFr.js"),
		"./json/settings-footer/en.json": () => import("./en-Dq1XDcPn.js"),
		"./json/settings-header/en.json": () => import("./en-Bt-gmQOd.js"),
		"./json/team-grid/en.json": () => import("./en--38AGac9.js"),
		"./json/team-header/en.json": () => import("./en-DbD4EhdO.js"),
		"./json/theme-toggle/en.json": () => import("./en-DEsJHIK4.js"),
		"./json/understanding-impact/en.json": () => import("./en-CWuFt-5X.js"),
		"./json/what-we-measure/en.json": () => import("./en-DyibeesA.js"),
		"./json/why-it-matters/en.json": () => import("./en-b-FZN5_e.js")
	}), `./json/${key}/en.json`, 4).then((m) => m.default),
	"es": () => _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({
		"./json/about-grid/es.json": () => import("./es-do4KZXnP.js"),
		"./json/about-header/es.json": () => import("./es-UG3DxKGg.js"),
		"./json/api-access-section/es.json": () => import("./es-CfLIzm7N.js"),
		"./json/blog-header/es.json": () => import("./es-D8-BSWIz.js"),
		"./json/blog-list/es.json": () => import("./es-Cpd5KxQx.js"),
		"./json/careers-benefits/es.json": () => import("./es-BC5oE6NI.js"),
		"./json/careers-header/es.json": () => import("./es-Cf8vJfo9.js"),
		"./json/contact-form/es.json": () => import("./es-Bto9gd-K.js"),
		"./json/contact-header/es.json": () => import("./es-Bvbq-Lo6.js"),
		"./json/faq-header1/es.json": () => import("./es-CejQ3uE4.js"),
		"./json/faq-list/es.json": () => import("./es-C3hXtG7H.js"),
		"./json/footer/es.json": () => import("./es-COTPJTh4.js"),
		"./json/header/es.json": () => import("./es-dwhz6jbc.js"),
		"./json/hero/es.json": () => import("./es-qap-yhmG.js"),
		"./json/open-positions/es.json": () => import("./es-asJof-ty.js"),
		"./json/preferences-section/es.json": () => import("./es-D_EuNTah.js"),
		"./json/pricing-header/es.json": () => import("./es-a-dGJ17B.js"),
		"./json/pricing-tiers/es.json": () => import("./es-B-6Km_lG.js"),
		"./json/products-grid/es.json": () => import("./es-BAO57pxe.js"),
		"./json/products-header/es.json": () => import("./es-C88kNBOa.js"),
		"./json/profile-section/es.json": () => import("./es-GRAHBB95.js"),
		"./json/results-table/es.json": () => import("./es-yoiMG791.js"),
		"./json/route/es.json": () => import("./es-BKVwxpuz.js"),
		"./json/settings-footer/es.json": () => import("./es-BHaNpNAW.js"),
		"./json/settings-header/es.json": () => import("./es-BoK7wjam.js"),
		"./json/team-grid/es.json": () => import("./es-BjtNx9jA.js"),
		"./json/team-header/es.json": () => import("./es-C6AZhx4l.js"),
		"./json/theme-toggle/es.json": () => import("./es-DHLTly_t.js"),
		"./json/understanding-impact/es.json": () => import("./es-BV5YbeC8.js"),
		"./json/what-we-measure/es.json": () => import("./es-DDvKtw1Q.js"),
		"./json/why-it-matters/es.json": () => import("./es-D4o5n4Oo.js")
	}), `./json/${key}/es.json`, 4).then((m) => m.default),
	"fr": () => _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({
		"./json/about-grid/fr.json": () => import("./fr-B0kR--4E.js"),
		"./json/about-header/fr.json": () => import("./fr-BB0qiui4.js"),
		"./json/api-access-section/fr.json": () => import("./fr-D89iRq9c.js"),
		"./json/blog-header/fr.json": () => import("./fr-BXWuDg4r.js"),
		"./json/blog-list/fr.json": () => import("./fr-Bn4WHbeS.js"),
		"./json/careers-benefits/fr.json": () => import("./fr-BcOTM5tG.js"),
		"./json/careers-header/fr.json": () => import("./fr-U6CiwIvI.js"),
		"./json/contact-form/fr.json": () => import("./fr-poHenYvd.js"),
		"./json/contact-header/fr.json": () => import("./fr-Ba6oRWyh.js"),
		"./json/faq-header1/fr.json": () => import("./fr-BEv7Eqbh.js"),
		"./json/faq-list/fr.json": () => import("./fr-lNf_vSaz.js"),
		"./json/footer/fr.json": () => import("./fr-DJBRlQVB.js"),
		"./json/header/fr.json": () => import("./fr-B029McLR.js"),
		"./json/hero/fr.json": () => import("./fr-HUtyA40V.js"),
		"./json/open-positions/fr.json": () => import("./fr-DZqMkcDf.js"),
		"./json/preferences-section/fr.json": () => import("./fr-Bkm2-ZQf.js"),
		"./json/pricing-header/fr.json": () => import("./fr-DHCNDpZV.js"),
		"./json/pricing-tiers/fr.json": () => import("./fr-DqMET3oa.js"),
		"./json/products-grid/fr.json": () => import("./fr-bJRmM3rC.js"),
		"./json/products-header/fr.json": () => import("./fr-BrTj8_yc.js"),
		"./json/profile-section/fr.json": () => import("./fr-C4JftzBm.js"),
		"./json/results-table/fr.json": () => import("./fr-Bxql_IEj.js"),
		"./json/route/fr.json": () => import("./fr-DHW9nXyg.js"),
		"./json/settings-footer/fr.json": () => import("./fr-FKpTelA1.js"),
		"./json/settings-header/fr.json": () => import("./fr-CKQ3p7nh.js"),
		"./json/team-grid/fr.json": () => import("./fr-Tzxr_RzV.js"),
		"./json/team-header/fr.json": () => import("./fr-37iqKMGQ.js"),
		"./json/theme-toggle/fr.json": () => import("./fr-DkLv3XDQ.js"),
		"./json/understanding-impact/fr.json": () => import("./fr-cJYA2f-a.js"),
		"./json/what-we-measure/fr.json": () => import("./fr-CNifbmta.js"),
		"./json/why-it-matters/fr.json": () => import("./fr-FHNm3PhG.js")
	}), `./json/${key}/fr.json`, 4).then((m) => m.default),
	"it": () => _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({
		"./json/about-grid/it.json": () => import("./it-BMLLsz99.js"),
		"./json/about-header/it.json": () => import("./it-CaJjAcVt.js"),
		"./json/api-access-section/it.json": () => import("./it-DlxYdN86.js"),
		"./json/blog-header/it.json": () => import("./it-DTxFVRVQ.js"),
		"./json/blog-list/it.json": () => import("./it-AI3i4D5Q.js"),
		"./json/careers-benefits/it.json": () => import("./it-DjFYoslm.js"),
		"./json/careers-header/it.json": () => import("./it-D5_Fm8-r.js"),
		"./json/contact-form/it.json": () => import("./it-DEl4Tjmg.js"),
		"./json/contact-header/it.json": () => import("./it-C350okAb.js"),
		"./json/faq-header1/it.json": () => import("./it-B6GiAn-4.js"),
		"./json/faq-list/it.json": () => import("./it-B5sMAInR.js"),
		"./json/footer/it.json": () => import("./it-BYwD6p9f.js"),
		"./json/header/it.json": () => import("./it-Cv1iB5gw.js"),
		"./json/hero/it.json": () => import("./it-DL4k35DT.js"),
		"./json/open-positions/it.json": () => import("./it-CfUQtLGX.js"),
		"./json/preferences-section/it.json": () => import("./it-C7bIf9qK.js"),
		"./json/pricing-header/it.json": () => import("./it-B25cIH0i.js"),
		"./json/pricing-tiers/it.json": () => import("./it-BRsVAVC1.js"),
		"./json/products-grid/it.json": () => import("./it-DCw1oRRG.js"),
		"./json/products-header/it.json": () => import("./it-SvSInP6P.js"),
		"./json/profile-section/it.json": () => import("./it-CJpDJlJ8.js"),
		"./json/results-table/it.json": () => import("./it-Dt1rRUkA.js"),
		"./json/route/it.json": () => import("./it-CBFVhsmJ.js"),
		"./json/settings-footer/it.json": () => import("./it-D3mV329A.js"),
		"./json/settings-header/it.json": () => import("./it-D2g3Pn-n.js"),
		"./json/team-grid/it.json": () => import("./it-qSxpRLf5.js"),
		"./json/team-header/it.json": () => import("./it-CFtqQl1f.js"),
		"./json/theme-toggle/it.json": () => import("./it-DBjcZPhH.js"),
		"./json/understanding-impact/it.json": () => import("./it-BGugoJcG.js"),
		"./json/what-we-measure/it.json": () => import("./it-DECpd33s.js"),
		"./json/why-it-matters/it.json": () => import("./it-DLBwR2Ug.js")
	}), `./json/${key}/it.json`, 4).then((m) => m.default),
	"ja": () => _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({
		"./json/about-grid/ja.json": () => import("./ja-6XQ4-bbM.js"),
		"./json/about-header/ja.json": () => import("./ja-Bj78j9LH.js"),
		"./json/api-access-section/ja.json": () => import("./ja-D8nTeDB2.js"),
		"./json/blog-header/ja.json": () => import("./ja-CnQ5CAqw.js"),
		"./json/blog-list/ja.json": () => import("./ja-CXsQ6PBo.js"),
		"./json/careers-benefits/ja.json": () => import("./ja-CBZvr_cr.js"),
		"./json/careers-header/ja.json": () => import("./ja-DY6OgkEp.js"),
		"./json/contact-form/ja.json": () => import("./ja-AQBC2qlY.js"),
		"./json/contact-header/ja.json": () => import("./ja-D5xX7WuX.js"),
		"./json/faq-header1/ja.json": () => import("./ja-CY920yD-.js"),
		"./json/faq-list/ja.json": () => import("./ja-CbKdZZCm.js"),
		"./json/footer/ja.json": () => import("./ja-BUtOGwiA.js"),
		"./json/header/ja.json": () => import("./ja-CZsdylmI.js"),
		"./json/hero/ja.json": () => import("./ja-C2rTJ2DT.js"),
		"./json/open-positions/ja.json": () => import("./ja-U2qYRCqA.js"),
		"./json/preferences-section/ja.json": () => import("./ja-BRwgZahr.js"),
		"./json/pricing-header/ja.json": () => import("./ja-2DJz_5GZ.js"),
		"./json/pricing-tiers/ja.json": () => import("./ja-C70BXR5_.js"),
		"./json/products-grid/ja.json": () => import("./ja-BEjTi-6Z.js"),
		"./json/products-header/ja.json": () => import("./ja-DR_wDNtW.js"),
		"./json/profile-section/ja.json": () => import("./ja-VNHvhIfX.js"),
		"./json/results-table/ja.json": () => import("./ja-Of-Gp96L.js"),
		"./json/route/ja.json": () => import("./ja-OfIIWJWc.js"),
		"./json/settings-footer/ja.json": () => import("./ja-D_6UG1ty.js"),
		"./json/settings-header/ja.json": () => import("./ja-CZupWxNI.js"),
		"./json/team-grid/ja.json": () => import("./ja-DJJ71Mn8.js"),
		"./json/team-header/ja.json": () => import("./ja-BEHmTvz_.js"),
		"./json/theme-toggle/ja.json": () => import("./ja-CeQ6J48L.js"),
		"./json/understanding-impact/ja.json": () => import("./ja-B0FITCm3.js"),
		"./json/what-we-measure/ja.json": () => import("./ja-BktmEC_q.js"),
		"./json/why-it-matters/ja.json": () => import("./ja-BJvEvIes.js")
	}), `./json/${key}/ja.json`, 4).then((m) => m.default),
	"ko": () => _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({
		"./json/about-grid/ko.json": () => import("./ko-CpVJNYSy.js"),
		"./json/about-header/ko.json": () => import("./ko-UOloAtHo.js"),
		"./json/api-access-section/ko.json": () => import("./ko-C2AcsjVb.js"),
		"./json/blog-header/ko.json": () => import("./ko-CFbSGErE.js"),
		"./json/blog-list/ko.json": () => import("./ko-wMUeVBeI.js"),
		"./json/careers-benefits/ko.json": () => import("./ko-NjnkEsSR.js"),
		"./json/careers-header/ko.json": () => import("./ko-GOkGDYWo.js"),
		"./json/contact-form/ko.json": () => import("./ko-BNfnMtKE.js"),
		"./json/contact-header/ko.json": () => import("./ko-Bd8Q3HGD.js"),
		"./json/faq-header1/ko.json": () => import("./ko-CwsCTK1B.js"),
		"./json/faq-list/ko.json": () => import("./ko-BKxzhKgD.js"),
		"./json/footer/ko.json": () => import("./ko-DKuyGJqA.js"),
		"./json/header/ko.json": () => import("./ko-DKYiYmKe.js"),
		"./json/hero/ko.json": () => import("./ko-xo71bvHd.js"),
		"./json/open-positions/ko.json": () => import("./ko-DoK1RyaJ.js"),
		"./json/preferences-section/ko.json": () => import("./ko-2a2rjGz_.js"),
		"./json/pricing-header/ko.json": () => import("./ko-PngkYdsx.js"),
		"./json/pricing-tiers/ko.json": () => import("./ko-BzaC7xzI.js"),
		"./json/products-grid/ko.json": () => import("./ko-B6KCUStd.js"),
		"./json/products-header/ko.json": () => import("./ko-YS6Rzgoo.js"),
		"./json/profile-section/ko.json": () => import("./ko-x0Ax8VRj.js"),
		"./json/results-table/ko.json": () => import("./ko-DR-LK0Tb.js"),
		"./json/route/ko.json": () => import("./ko-DOZkEbJN.js"),
		"./json/settings-footer/ko.json": () => import("./ko-BfjLXICy.js"),
		"./json/settings-header/ko.json": () => import("./ko-BOiFjNTd.js"),
		"./json/team-grid/ko.json": () => import("./ko-NqnSiUS9.js"),
		"./json/team-header/ko.json": () => import("./ko-CmroWIGM.js"),
		"./json/theme-toggle/ko.json": () => import("./ko-B-CWdFqR.js"),
		"./json/understanding-impact/ko.json": () => import("./ko-CjMqmaI-.js"),
		"./json/what-we-measure/ko.json": () => import("./ko-CGbFQx8U.js"),
		"./json/why-it-matters/ko.json": () => import("./ko-Oz9ACJhX.js")
	}), `./json/${key}/ko.json`, 4).then((m) => m.default),
	"pt": () => _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({
		"./json/about-grid/pt.json": () => import("./pt-zilf6urW.js"),
		"./json/about-header/pt.json": () => import("./pt-BQC9Ajk8.js"),
		"./json/api-access-section/pt.json": () => import("./pt-aLblmC-T.js"),
		"./json/blog-header/pt.json": () => import("./pt-BsOsw_ri.js"),
		"./json/blog-list/pt.json": () => import("./pt-taXXfSYd.js"),
		"./json/careers-benefits/pt.json": () => import("./pt-Ic0OUQbt.js"),
		"./json/careers-header/pt.json": () => import("./pt-DRjPIYPO.js"),
		"./json/contact-form/pt.json": () => import("./pt-DBBZlVht.js"),
		"./json/contact-header/pt.json": () => import("./pt-DoWxsG5c.js"),
		"./json/faq-header1/pt.json": () => import("./pt-D6yleTe3.js"),
		"./json/faq-list/pt.json": () => import("./pt-Ll419Xnf.js"),
		"./json/footer/pt.json": () => import("./pt-Chor_Z0D.js"),
		"./json/header/pt.json": () => import("./pt-eR78RGvO.js"),
		"./json/hero/pt.json": () => import("./pt-7tpW0Oyv.js"),
		"./json/open-positions/pt.json": () => import("./pt-Dk2sIcMN.js"),
		"./json/preferences-section/pt.json": () => import("./pt-Bl2O3wH2.js"),
		"./json/pricing-header/pt.json": () => import("./pt-BsuajwK2.js"),
		"./json/pricing-tiers/pt.json": () => import("./pt-CpL0EOTW.js"),
		"./json/products-grid/pt.json": () => import("./pt-Dz7Quc43.js"),
		"./json/products-header/pt.json": () => import("./pt-cN4cB5NG.js"),
		"./json/profile-section/pt.json": () => import("./pt-Bo4wGMl0.js"),
		"./json/results-table/pt.json": () => import("./pt-VNiJmNQi.js"),
		"./json/route/pt.json": () => import("./pt-Bj7PU6iL.js"),
		"./json/settings-footer/pt.json": () => import("./pt-kXPY916b.js"),
		"./json/settings-header/pt.json": () => import("./pt-7LmmbgCq.js"),
		"./json/team-grid/pt.json": () => import("./pt-Bm2qLETn.js"),
		"./json/team-header/pt.json": () => import("./pt-Cw-SsxN8.js"),
		"./json/theme-toggle/pt.json": () => import("./pt-36s_0VOJ.js"),
		"./json/understanding-impact/pt.json": () => import("./pt-6RG_FS0t.js"),
		"./json/what-we-measure/pt.json": () => import("./pt-Db2JrkVb.js"),
		"./json/why-it-matters/pt.json": () => import("./pt-DlN89gaW.js")
	}), `./json/${key}/pt.json`, 4).then((m) => m.default),
	"ru": () => _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({
		"./json/about-grid/ru.json": () => import("./ru-wTIBfPPj.js"),
		"./json/about-header/ru.json": () => import("./ru-DSAEdX3Q.js"),
		"./json/api-access-section/ru.json": () => import("./ru-JhLh8sOQ.js"),
		"./json/blog-header/ru.json": () => import("./ru-C3X60Jte.js"),
		"./json/blog-list/ru.json": () => import("./ru-Ba5II1CV.js"),
		"./json/careers-benefits/ru.json": () => import("./ru-BC2Tk5tV.js"),
		"./json/careers-header/ru.json": () => import("./ru-DwtKxHhF.js"),
		"./json/contact-form/ru.json": () => import("./ru-PGVAAefQ.js"),
		"./json/contact-header/ru.json": () => import("./ru-CqMDRV6z.js"),
		"./json/faq-header1/ru.json": () => import("./ru-BUK6RCi_.js"),
		"./json/faq-list/ru.json": () => import("./ru-CFqmdpCh.js"),
		"./json/footer/ru.json": () => import("./ru-C2dEnSpH.js"),
		"./json/header/ru.json": () => import("./ru-Dv7AW20x.js"),
		"./json/hero/ru.json": () => import("./ru-BuAn4GLo.js"),
		"./json/open-positions/ru.json": () => import("./ru-DmZ-S72L.js"),
		"./json/preferences-section/ru.json": () => import("./ru-TBS92XOy.js"),
		"./json/pricing-header/ru.json": () => import("./ru-BFlUpcAG.js"),
		"./json/pricing-tiers/ru.json": () => import("./ru-CYPa9qYz.js"),
		"./json/products-grid/ru.json": () => import("./ru-l_hOcVpP.js"),
		"./json/products-header/ru.json": () => import("./ru-B9zjv63p.js"),
		"./json/profile-section/ru.json": () => import("./ru-BgssyEjm.js"),
		"./json/results-table/ru.json": () => import("./ru-m4F8nmRm.js"),
		"./json/route/ru.json": () => import("./ru-D9H-VNUz.js"),
		"./json/settings-footer/ru.json": () => import("./ru-CzQER0VD.js"),
		"./json/settings-header/ru.json": () => import("./ru-BgbFYaMI.js"),
		"./json/team-grid/ru.json": () => import("./ru-D8_Ac0KA.js"),
		"./json/team-header/ru.json": () => import("./ru-BWvUMDS6.js"),
		"./json/theme-toggle/ru.json": () => import("./ru-BJyO8FK-.js"),
		"./json/understanding-impact/ru.json": () => import("./ru-qJ9vl3kZ.js"),
		"./json/what-we-measure/ru.json": () => import("./ru-fxmN7_zQ.js"),
		"./json/why-it-matters/ru.json": () => import("./ru-hj4-0cAc.js")
	}), `./json/${key}/ru.json`, 4).then((m) => m.default),
	"zh": () => _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({
		"./json/about-grid/zh.json": () => import("./zh-BfL2e1Md.js"),
		"./json/about-header/zh.json": () => import("./zh-Dgn_AJfJ.js"),
		"./json/api-access-section/zh.json": () => import("./zh-B14iO3rv.js"),
		"./json/blog-header/zh.json": () => import("./zh-DyRUDmOL.js"),
		"./json/blog-list/zh.json": () => import("./zh-CSlVzqEk.js"),
		"./json/careers-benefits/zh.json": () => import("./zh-D6tBuDnv.js"),
		"./json/careers-header/zh.json": () => import("./zh-ByDXTmMh.js"),
		"./json/contact-form/zh.json": () => import("./zh-B5vMMAwH.js"),
		"./json/contact-header/zh.json": () => import("./zh-CngnOfVX.js"),
		"./json/faq-header1/zh.json": () => import("./zh-ykX3c4h4.js"),
		"./json/faq-list/zh.json": () => import("./zh-D5w010QK.js"),
		"./json/footer/zh.json": () => import("./zh-BTxvId-t.js"),
		"./json/header/zh.json": () => import("./zh-CPsqqRn1.js"),
		"./json/hero/zh.json": () => import("./zh-DXsmAWQL.js"),
		"./json/open-positions/zh.json": () => import("./zh-DIXeGWMJ.js"),
		"./json/preferences-section/zh.json": () => import("./zh-DE95MPqZ.js"),
		"./json/pricing-header/zh.json": () => import("./zh-DcmJGf7U.js"),
		"./json/pricing-tiers/zh.json": () => import("./zh-B8HPhD7S.js"),
		"./json/products-grid/zh.json": () => import("./zh-DWC_l3gW.js"),
		"./json/products-header/zh.json": () => import("./zh-BR4UsMwS.js"),
		"./json/profile-section/zh.json": () => import("./zh-HJ94f3x3.js"),
		"./json/results-table/zh.json": () => import("./zh-z_mIweC1.js"),
		"./json/route/zh.json": () => import("./zh-B187FOSB.js"),
		"./json/settings-footer/zh.json": () => import("./zh-Cc5AixqU.js"),
		"./json/settings-header/zh.json": () => import("./zh-DWiq5N2F.js"),
		"./json/team-grid/zh.json": () => import("./zh-HomblrY4.js"),
		"./json/team-header/zh.json": () => import("./zh-B1ohyrHq.js"),
		"./json/theme-toggle/zh.json": () => import("./zh-BwheWN-O.js"),
		"./json/understanding-impact/zh.json": () => import("./zh-BENwHShi.js"),
		"./json/what-we-measure/zh.json": () => import("./zh-D8C_uDLN.js"),
		"./json/why-it-matters/zh.json": () => import("./zh-0srfYWmT.js")
	}), `./json/${key}/zh.json`, 4).then((m) => m.default)
});
//#endregion
//#region .intlayer/dynamic_dictionary/team-header.mjs
var content = loadContent("team-header");
//#endregion
...
//#endregion
//#region ../../node_modules/.bun/react-intlayer@8.7.0-canary.0+21ccd8898788a04d/node_modules/react-intlayer/dist/esm/client/useLoadDynamic.mjs
...
//#endregion
//#region ../../node_modules/.bun/react-intlayer@8.7.0-canary.0+21ccd8898788a04d/node_modules/react-intlayer/dist/esm/client/useDictionaryDynamic.mjs
/**
* On the server side, Hook that transform a dictionary and return the content
*
* If the locale is not provided, it will use the locale from the client context
...
function TeamHeader() {
	const content$1 = useDictionaryDynamic(content, "team-header");
...
//#endregion
export { content, de_default as default, key };
...
var content = { "a": "Manage your account preferences and configuration." };
var de_default = {
	key,
	content
};
...
var content = { "a": "Tools und Dienste zur Optimierung Ihres Internationalisierungs-Worflows." };
var de_default = {
	key,
	content
};
...
var key = "blog-header";
var content = { "a": "Einblicke, Tutorials und Analysen aus der i18n-Community." };
var de_default = {
	key,
	content
};
...
var key = "products-header";
var content = { "a": "Tools and services to streamline your internationalization workflow." };
var en_default = {
	key,
	content
};
...
var key = "blog-header";
var content = { "a": "Insights, tutorials, and analysis from the i18n community." };
var en_default = {
	key,
	content
};
...
//#endregion
export { content, es_default as default, key };
...
var key = "products-header";
var content = { "a": "Herramientas y servicios para simplificar su flujo de trabajo de internacionalización." };
var es_default = {
	key,
	content
};
...
var key = "blog-header";
var content = { "a": "Información, tutoriales y análisis de la comunidad i18n." };
var es_default = {
	key,
	content
};
...
//#endregion
export { content, fr_default as default, key };
...
var key = "blog-header";
var content = { "a": "Aperçus, tutoriels et analyses de la communauté i18n." };
var fr_default = {
	key,
	content
};
...
var key = "products-header";
var content = { "a": "Outils et services pour rationaliser votre flux de travail d'internationalisation." };
var fr_default = {
	key,
	content
};
...
//#endregion
export { content, it_default as default, key };
...
var key = "blog-header";
var content = { "a": "Approfondimenti, tutorial e analisi dalla comunità i18n." };
var it_default = {
	key,
	content
};
...
var key = "products-header";
var content = { "a": "Strumenti e servizi per semplificare il flusso di lavoro di internazionalizzazione." };
var it_default = {
	key,
	content
};
...
//#endregion
export { content, ja_default as default, key };
...
var key = "blog-header";
var content = { "a": "i18n コミュニティからの洞察、チュートリアル、分析。" };
var ja_default = {
	key,
	content
};
...
var key = "products-header";
var content = { "a": "国際化ワークフローを合理化するためのツールとサービス。" };
var ja_default = {
	key,
	content
};
...
//#endregion
export { content, ko_default as default, key };
...
var key = "blog-header";
var content = { "a": "i18n 커뮤니티의 인사이트, 튜토리얼 및 분석." };
var ko_default = {
	key,
	content
};
...
var key = "products-header";
var content = { "a": "국제화 워크플로우를 합리화하기 위한 도구 및 서비스입니다." };
var ko_default = {
	key,
	content
};
...
//#endregion
export { content, pt_default as default, key };
...
var key = "blog-header";
var content = { "a": "Insights, tutoriais e análises da comunidade i18n." };
var pt_default = {
	key,
	content
};
...
var key = "products-header";
var content = { "a": "Ferramentas e serviços para otimizar seu fluxo de trabalho de internacionalización." };
var pt_default = {
	key,
	content
};
...
var key = "products-header";
var content = { "a": "Инструменты и услуги для оптимизации рабочего процесса интернационализации." };
var ru_default = {
	key,
	content
};
//#endregion
export { content, ru_default as default, key };
...
var key = "blog-header";
var content = { "a": "Инсайты, руководства и анализ от сообщества i18n." };
var ru_default = {
	key,
	content
};
...
//#endregion
export { content, zh_default as default, key };
...
var key = "blog-header";
var content = { "a": "来自 i18n 社区 de 见解、教程和分析。" };
var zh_default = {
	key,
	content
};
