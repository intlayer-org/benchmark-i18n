import { Fragment as e, createContext as t, createElement as n, isValidElement as r, lazy as i, useContext as a, useEffect as o, useId as s, useMemo as c, useRef as l, useState as u } from "react";
...
var m = (e, t, n) => {
	...
	let i = r(e) ? e : /* @__PURE__ */ f(d, { children: e });
...
}, te = "translation", y = "insertion", ne = "object", b = "array", x = (e, t) => {
...
}, ie = process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false", T = process.env.INTLAYER_NODE_TYPE_INSERTION === "false", E = {
	id: "fallback-plugin",
	canHandle: () => !1,
	transform: (e) => e
}, D = (e, t) => ie ? E : {
	...
	D(e ?? h.defaultLocale, t ? h.defaultLocale : void 0),
	O,
	k,
	ae,
	j(e ?? h.defaultLocale),
...
var H = z ? E : {
	...
	K,
	q
].filter(Boolean), oe = (e, t) => F(e, t, J(t)), se = (e, t = h?.locales, n = h?.defaultLocale) => {
...
var ce = (e, t, n) => {
...
}, ge = ({ children: e, ...t }) => /* @__PURE__ */ p(he, {
	...t,
	children: [/* @__PURE__ */ f(pe, {}), e]
}), _e = (e, t) => {
	let { locale: n } = a(Q) ?? {};
	return c(() => oe(e, t ?? n), [
		e.key,
	...
	let { locale: r } = a(Q) ?? {}, i = c(() => n ?? r ?? h.defaultLocale, [r, n]);
	return _e(ye(`${String(t)}.${i}`, e[i]?.()), i);
};
//#endregion
//#region src/components/pages/settings/PreferencesSection.tsx
function xe() {
	let e = be(ee, "preferences-section"), t = s();
			...
			children: [
				/* @__PURE__ */ p("div", {
					...
					children: [/* @__PURE__ */ p("div", { children: [/* @__PURE__ */ f("p", {
						...
						children: /* @__PURE__ */ f("span", { className: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" })
					})]
				}),
				/* @__PURE__ */ p("div", {
					className: "flex items-center justify-between",
					children: [/* @__PURE__ */ p("div", { children: [/* @__PURE__ */ f("p", {
						...
						children: /* @__PURE__ */ f("span", { className: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" })
					})]
				}),
				/* @__PURE__ */ p("div", { children: [/* @__PURE__ */ f("label", {
					...
					children: [
						/* @__PURE__ */ f("option", { children: e.f }),
						/* @__PURE__ */ f("option", { children: e.g }),
						/* @__PURE__ */ f("option", { children: e.h }),
						/* @__PURE__ */ f("option", { children: e.k }),
						/* @__PURE__ */ f("option", { children: e.i }),
						/* @__PURE__ */ f("option", { children: e.b }),
						/* @__PURE__ */ f("option", { children: e.a })
					]
				})] })
			]
		})]
...
function Ce() {
	return /* @__PURE__ */ f(Se, { children: /* @__PURE__ */ f(xe, {}) });
}
//#endregion
