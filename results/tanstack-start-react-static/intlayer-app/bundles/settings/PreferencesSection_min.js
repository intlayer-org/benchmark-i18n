...
var se = (e, t, n) => {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), $ = ({ locale: e, defaultLocale: t, children: n, setLocale: r, disableEditor: i, isCookieEnabled: a }) => {
	let { locales: s, defaultLocale: c } = m ?? {}, [l, u] = ee(e ?? Z ?? t ?? c);
	o(() => {
		e && e !== l && u(e);
	}, [e]), o(() => {
		pe();
