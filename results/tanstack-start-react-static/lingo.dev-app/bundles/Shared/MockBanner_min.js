...
}({ enableConsole: !0 }), l = function(e, t) {
...
var P = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, oe = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function se(e) {
	var t = {};
...
function le(e) {
	...
	for (var t = e.split(ce).filter(function(e) {
		return e.length > 0;
...
var F = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, I = /^(@+)?(\+|#+)?[rs]?$/g, de = /(\*)(0+)|(#+)(0+)|(0+)/g, L = /^(0+)$/;
function R(e) {
	var t = {};
...
function pe(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		if (F.test(i.stem)) {
			...
			var a = i.options[0];
			a === "w" ? t = d(d({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = d(d({}, t), R(a)));
			continue;
		}
		if (I.test(i.stem)) {
			t = d(d({}, t), R(i.stem));
...
function me(e, t) {
	for (var n = "", r = 0; r < e.length; r++) {
		...
		if (i === "j") {
			...
			var o = 1 + (a & 1), s = a < 2 ? 1 : 3 + (a >> 1), c = "a", l = he(t);
...
var ge = RegExp(`^${P.source}*`), _e = RegExp(`${P.source}*\$`);
function H(e, t) {
	return {
		start: e,
		end: t
...
var ve = !!Object.fromEntries, ye = !!String.prototype.trimStart, be = !!String.prototype.trimEnd, U = ve ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
var we = function() {
	...
	return e.prototype.parse = function() {
		...
		return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !Te(this.peek() || 0)) ? (this.bump(), "<") : null;
		...
		var e = this.clonePosition(), t = this.offset(), n = Ce(this.message, t), r = t + n.length;
		...
		switch (a) {
			...
			case "time":
				...
				if (s && s.style.startsWith("::")) {
					...
					if (a === "number") {
						...
						var h = m;
						this.locale && (h = me(m, this.locale));
						var u = {
							type: w.dateTime,
							pattern: h,
							location: s.styleLocation,
							parsedOptions: this.shouldParseSkeletons ? se(h) : {}
						};
						return {
							val: {
			...
			case "select":
				...
				if (this.bumpSpace(), !this.bumpIf(",")) return this.error(S.EXPECT_SELECT_ARGUMENT_OPTIONS, H(g, d({}, g)));
				this.bumpSpace();
...
function Fe(e) {
	return e === void 0 && (e = {
		...
		getNumberFormat: m(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.NumberFormat).bind.apply(e, p([void 0], t, !1)))();
		}, {
			cache: Q(e.number),
			strategy: x.variadic
		}),
		getDateTimeFormat: m(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.DateTimeFormat).bind.apply(e, p([void 0], t, !1)))();
		}, {
			cache: Q(e.dateTime),
			strategy: x.variadic
		}),
		getPluralRules: m(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.PluralRules).bind.apply(e, p([void 0], t, !1)))();
		}, {
...
function Le(e) {
	let t = {};
	for (let [n, r] of Object.entries(e)) typeof r == "function" ? t[n] = $(r) : t[n] = r;
	return t;
}
function Re(t, n, r) {
	try {
		let i = new Ie(t, r), o = Le(n), s = i.format(o);
		return Array.isArray(s) ? s.map((t, n) => /* @__PURE__ */ a(e, { children: t }, n)) : s;
	} catch (e) {
		return c.warn(`Error rendering rich text (${t}): ${e}`), t;
	}
}
//#endregion
...
var ze = (e) => {
	let { translations: t, registerHashes: r, locale: a, sourceLocale: o } = s();
	return i(() => {
		c.debug(`Registering ${e.length} hashes for component`), r(e);
	}, [
		e,
		r,
		a,
		...
		t: n((e, n, r) => {
			c.debug(`Client. The translations for locale ${a} are: ${JSON.stringify(t)}`);
			let i = t[e] || n;
			return r ? Re(i, r, a) : i;
		}, [
			t,
