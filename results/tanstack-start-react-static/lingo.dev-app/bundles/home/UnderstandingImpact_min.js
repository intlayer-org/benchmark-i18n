...
}({ enableConsole: !0 }), u = function(e, t) {
...
function h(e, t) {
	var n = t && t.cache ? t.cache : ie, r = t && t.serializer ? t.serializer : ne;
	return (t && t.strategy ? t.strategy : b)(e, {
		cache: n,
		serializer: r
	});
}
...
var P = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, se = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function ce(e) {
	var t = {};
...
var F = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, I = /^(@+)?(\+|#+)?[rs]?$/g, fe = /(\*)(0+)|(#+)(0+)|(0+)/g, L = /^(0+)$/;
function R(e) {
	var t = {};
...
function me(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		if (F.test(i.stem)) {
			...
			var a = i.options[0];
			a === "w" ? t = f(f({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = f(f({}, t), R(a)));
			continue;
		}
		if (I.test(i.stem)) {
			t = f(f({}, t), R(i.stem));
...
function he(e, t) {
	for (var n = "", r = 0; r < e.length; r++) {
		...
		if (i === "j") {
			...
			var o = 1 + (a & 1), s = a < 2 ? 1 : 3 + (a >> 1), c = "a", l = ge(t);
...
var _e = RegExp(`^${P.source}*`), ve = RegExp(`${P.source}*\$`);
function H(e, t) {
	return {
		start: e,
		end: t
...
var ye = !!Object.fromEntries, be = !!String.prototype.trimStart, xe = !!String.prototype.trimEnd, U = ye ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
			...
			case "time":
				...
				if (s && s.style.startsWith("::")) {
					...
					if (a === "number") {
						...
						if (m.length === 0) return this.error(S.EXPECT_DATE_TIME_SKELETON, p);
						var h = m;
						this.locale && (h = he(m, this.locale));
						var u = {
							type: w.dateTime,
							pattern: h,
							location: s.styleLocation,
							parsedOptions: this.shouldParseSkeletons ? ce(h) : {}
						};
						return {
							val: {
...
function q(e) {
	e.forEach(function(e) {
		if (delete e.location, k(e) || A(e)) for (var t in e.options) delete e.options[t].location, q(e.options[t].value);
		else E(e) && M(e.style) || (D(e) || O(e)) && N(e.style) ? delete e.style.location : j(e) && q(e.children);
	});
}
function Oe(e, t) {
	t === void 0 && (t = {}), t = f({
...
function Q(e, t, n, r, i, a, o) {
	...
	for (var s = [], c = 0, l = e; c < l.length; c++) {
		...
		if (j(u)) {
			...
			if (!Me(g)) throw new ke(h, "function", o);
...
function Fe(e) {
	return e === void 0 && (e = {
		...
		getNumberFormat: h(function() {
			...
			return new ((e = Intl.NumberFormat).bind.apply(e, m([void 0], t, !1)))();
		}, {
			cache: $(e.number),
			strategy: x.variadic
		}),
		getDateTimeFormat: h(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.DateTimeFormat).bind.apply(e, m([void 0], t, !1)))();
		}, {
			cache: $(e.dateTime),
			strategy: x.variadic
		}),
...
var Ie = function() {
	function e(t, n, r, i) {
		...
		if (this.formatterCache = {
			...
			var o = p(i || {}, []);
			this.ast = e.__parse(t, f(f({}, o), { locale: this.resolvedLocale }));
		} else this.ast = t;
...
function Re(e) {
	let t = {};
	for (let [n, r] of Object.entries(e)) typeof r == "function" ? t[n] = Le(r) : t[n] = r;
	return t;
}
function ze(t, n, r) {
	try {
		let i = new Ie(t, r), o = Re(n), s = i.format(o);
		return Array.isArray(s) ? s.map((t, n) => /* @__PURE__ */ a(e, { children: t }, n)) : s;
	} catch (e) {
		return l.warn(`Error rendering rich text (${t}): ${e}`), t;
	}
}
//#endregion
...
var Be = (e) => {
	let { translations: t, registerHashes: r, locale: a, sourceLocale: o } = c();
	return i(() => {
		l.debug(`Registering ${e.length} hashes for component`), r(e);
	}, [
		e,
		r,
		a,
		...
		t: n((e, n, r) => {
			l.debug(`Client. The translations for locale ${a} are: ${JSON.stringify(t)}`);
			let i = t[e] || n;
			return r ? ze(i, r, a) : i;
		}, [
			t,
	...
	return /* @__PURE__ */ o("section", {
		...
		children: [
			/* @__PURE__ */ a("h2", {
				...
				children: e("e26c90d08e1a", "Understanding the Impact")
			}),
			/* @__PURE__ */ o("div", {
				...
				children: [
					/* @__PURE__ */ a("h3", {
						...
						children: e("91793eb643b1", "Why a single large JSON can hurt performance")
					}),
					/* @__PURE__ */ a("p", {
						className: "text-sm text-muted-foreground",
						children: e("92b8b3d67ff6", "Many i18n libraries store translations in a single JSON object provided via React context. When this object is large (thousands of keys), every component that consumes translations holds a reference to the entire dictionary. This means:")
					}),
					/* @__PURE__ */ o("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							/* @__PURE__ */ a("li", { children: e("9575d5a89d9f", "The JSON must be parsed on every page load — blocking the main thread.") }),
							/* @__PURE__ */ a("li", { children: e("0c5eb8fa5db9", "Context-based architectures can cause cascading re-renders when the locale changes, because every consumer is notified even if their specific keys didn't change.") }),
							/* @__PURE__ */ a("li", { children: e("8e2ff24cfaef", "During server-side rendering, the full dictionary is serialized into the HTML payload, increasing the document size that must be downloaded and hydrated.") })
						]
					})
				]
			}),
			/* @__PURE__ */ o("div", {
				...
				children: [
					/* @__PURE__ */ a("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: e("10da99671dd1", "The trade-offs of dynamic loading")
					}),
					/* @__PURE__ */ a("p", {
						className: "text-sm text-muted-foreground",
						children: e("646712d04d39", "Splitting translations into per-route or per-namespace chunks can dramatically reduce the initial payload. But it introduces new challenges:")
					}),
					/* @__PURE__ */ o("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							/* @__PURE__ */ a("li", { children: e("aeac40ef060c", "<strong0>Waterfall requests:</strong0> the app must first load, determine the locale, then fetch the right chunk — adding network round-trips.", { strong0: (e) => /* @__PURE__ */ a("strong", {
								className: "text-foreground",
								children: e
							}) }) }),
							/* @__PURE__ */ a("li", { children: e("feba9a47b3b1", "<strong0>Flash of untranslated content (FOUC): </strong0> users may briefly see translation keys or a fallback language before the chunk arrives.", { strong0: (e) => /* @__PURE__ */ a("strong", {
								className: "text-foreground",
								children: e
							}) }) }),
							/* @__PURE__ */ a("li", { children: e("16f5b009ee51", "<strong0>Cache invalidation:</strong0> updating translations requires cache-busting strategies to ensure users get fresh content without re-downloading unchanged chunks.", { strong0: (e) => /* @__PURE__ */ a("strong", {
								className: "text-foreground",
								children: e
							}) }) })
						]
			...
			/* @__PURE__ */ o("div", {
				...
				children: [/* @__PURE__ */ a("h3", {
					className: "mb-2 text-lg font-semibold text-foreground",
					children: e("e88a846953a5", "What this benchmark measures")
				}), /* @__PURE__ */ a("p", {
					className: "text-sm text-muted-foreground",
					children: e("96f51568e926", "This test app provides a controlled environment — 10 pages with realistic content — to compare i18n libraries across three axes: the weight they add to your JavaScript bundle, the time spent parsing and rendering translated content, and the effectiveness of their code-splitting and lazy-loading strategies. Each library is integrated into the same app so results are directly comparable.")
				})]
			})
		]
	});
