...
function Ve() {
	...
	return /* @__PURE__ */ o("section", {
		...
		children: [/* @__PURE__ */ a("h2", {
			...
			children: e("e1a24d22a59b", "Why These Metrics Matter")
		}), /* @__PURE__ */ o("div", {
			...
			children: [
				/* @__PURE__ */ o("div", {
					...
					children: [/* @__PURE__ */ a("h3", {
						...
						children: e("7a6ebde895f3", "Bundle Size")
					}), /* @__PURE__ */ a("p", {
						className: "text-sm text-muted-foreground",
						children: e("65c7969afcf5", "The bundle is the data shipped to every user across the globe. A larger bundle means longer download times — especially on slow 3G connections common in many regions. i18n libraries vary dramatically in their weight: from a few kilobytes to tens of kilobytes of runtime code, plus the translation files themselves.")
					})]
				}),
				/* @__PURE__ */ o("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [/* @__PURE__ */ a("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: e("c9cb393387ac", "Rendering & Hydration")
					}), /* @__PURE__ */ a("p", {
						className: "text-sm text-muted-foreground",
						children: e("dce887a02e29", "Connecting a large JSON dictionary to every component creates a hidden dependency: any change in the translation context can trigger re-renders across the entire tree. During SSR hydration, parsing and attaching massive translation objects adds latency before the page becomes interactive — directly impacting Time to Interactive (TTI).")
					})]
				}),
				/* @__PURE__ */ o("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [/* @__PURE__ */ a("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: e("fcb0141f82c4", "Dynamic Loading")
					}), /* @__PURE__ */ a("p", {
						className: "text-sm text-muted-foreground",
						children: e("1c58748e151c", "Loading all translations upfront overloads the initial payload. Dynamic (lazy) loading splits translations by route or namespace, sending only what the current page needs. However, lazy loading introduces its own trade-offs: waterfall requests, flash of untranslated content, and caching complexity. Measuring both strategies is essential.")
					})]
				})
			]
		})]
