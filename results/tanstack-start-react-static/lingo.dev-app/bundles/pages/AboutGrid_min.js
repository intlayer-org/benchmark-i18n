	...
	return /* @__PURE__ */ o("div", {
		...
		children: [/* @__PURE__ */ o("div", {
			...
			children: [/* @__PURE__ */ a("h2", {
				...
				children: e("2cb7a60c6cb8", "Why This Exists")
			}), /* @__PURE__ */ a("p", {
				className: "text-sm text-muted-foreground",
				children: e("7e683049c683", "Choosing an i18n library is an architectural decision with long-term consequences. Most comparisons focus on API ergonomics, but few measure the performance cost: how much weight does the library add to the bundle? How does it affect rendering when thousands of translation keys are loaded? Does lazy loading actually help or just shift the cost? This benchmark answers those questions with real data.")
			})]
		}), /* @__PURE__ */ o("div", {
			className: "rounded-lg border border-border bg-card p-6",
			children: [/* @__PURE__ */ a("h2", {
				className: "mb-3 text-xl font-semibold text-foreground",
				children: e("b75f99394e1b", "Methodology")
			}), /* @__PURE__ */ a("p", {
				className: "text-sm text-muted-foreground",
				children: e("83d3572ceab8", "The same 10-page app is built once per library. We measure the production bundle (via rollup-plugin-visualizer), run Lighthouse audits for loading metrics, and use React Profiler to capture render times during locale switches. All tests run in CI on consistent hardware to ensure reproducible results.")
			})]
		})]
	});
}
