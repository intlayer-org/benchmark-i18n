...
function CareersHeader() {
	const { t } = useTranslation(["cb657bb2c2da", "46a9a1b1f5b1"]);
	return /* @__PURE__ */ jsxs(Fragment$1, { children: [
		/* @__PURE__ */ jsx(MockBanner, {}),
		/* @__PURE__ */ jsx("h1", {
			className: "mb-2 text-3xl font-bold text-foreground",
			children: t("cb657bb2c2da", "Careers")
		}),
		/* @__PURE__ */ jsx("p", {
			className: "mb-4 text-muted-foreground",
			children: t("46a9a1b1f5b1", "Join our mission to improve the internationalization ecosystem. We're a remote-first team that values impact, transparency, and continuous learning.")
		})
	] });
}
//#endregion
