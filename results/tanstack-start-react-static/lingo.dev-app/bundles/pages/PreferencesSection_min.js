import { Fragment as e, createContext as t, useCallback as n, useContext as r, useEffect as i, useId as a } from "react";
...
function Q(e, t, n, r, i, a, o) {
	...
	for (var s = [], c = 0, l = e; c < l.length; c++) {
		...
		if (j(u)) {
			...
			if (!Z(g)) throw new je(h, "function", o);
...
function ze(e) {
	let t = {};
	for (let [n, r] of Object.entries(e)) typeof r == "function" ? t[n] = Re(r) : t[n] = r;
	return t;
}
function Be(t, n, r) {
	try {
		let i = new Le(t, r), a = ze(n), s = i.format(a);
...
function He() {
	...
	return /* @__PURE__ */ s("section", {
		...
		children: [/* @__PURE__ */ o("h2", {
			...
			children: e("4e349c43b0c5", "Preferences")
		}), /* @__PURE__ */ s("div", {
			className: "space-y-4",
			children: [
				/* @__PURE__ */ s("div", {
					...
					children: [/* @__PURE__ */ s("div", { children: [/* @__PURE__ */ o("p", {
						...
						children: e("e0f9db5c07a9", "Email Notifications")
					}), /* @__PURE__ */ o("p", {
						className: "text-xs text-muted-foreground",
						children: e("f296bd4f5206", "Receive weekly benchmark reports")
					})] }), /* @__PURE__ */ o("button", {
						type: "button",
						className: "h-6 w-11 rounded-full bg-primary transition-colors",
						"aria-label": e("00eb4e9b4814", "Toggle notifications"),
				...
				/* @__PURE__ */ s("div", {
					...
					children: [/* @__PURE__ */ s("div", { children: [/* @__PURE__ */ o("p", {
						className: "text-sm font-medium text-foreground",
						children: e("4300ca2cf431", "Dark Mode")
					}), /* @__PURE__ */ o("p", {
						className: "text-xs text-muted-foreground",
						children: e("dc5c429344a7", "Use dark color scheme")
					})] }), /* @__PURE__ */ o("button", {
						type: "button",
						className: "h-6 w-11 rounded-full bg-muted transition-colors",
						"aria-label": e("49391efc8b79", "Toggle dark mode"),
				...
				/* @__PURE__ */ s("div", { children: [/* @__PURE__ */ o("label", {
					...
					children: e("8da0f6d51480", "Default Language")
				}), /* @__PURE__ */ s("select", {
					id: t,
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
					children: [
						/* @__PURE__ */ o("option", { children: e("7befbbae6794", "English (en)") }),
						/* @__PURE__ */ o("option", { children: e("8545d83f3e07", "French (fr)") }),
						/* @__PURE__ */ o("option", { children: e("bf4335e69758", "German (de)") }),
						/* @__PURE__ */ o("option", { children: e("bd284ebd791f", "Spanish (es)") }),
						/* @__PURE__ */ o("option", { children: e("44688c9d5f6f", "Japanese (ja)") }),
						/* @__PURE__ */ o("option", { children: e("2d4bfd1535a4", "Chinese Simplified (zh-CN)") }),
						/* @__PURE__ */ o("option", { children: e("fd6304ee4dc3", "Arabic (ar)") })
					]
				})] })
			]
		})]
