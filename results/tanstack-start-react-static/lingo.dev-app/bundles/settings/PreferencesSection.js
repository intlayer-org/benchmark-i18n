import { Fragment, createContext, useCallback, useContext, useEffect, useId } from "react";
...
//#endregion
//#region ../../node_modules/.bun/@lingo.dev+compiler@0.4.0+4058450e9543caf3/node_modules/@lingo.dev/compiler/build/utils/logger.mjs
var Logger = class {
	config;
...
//#endregion
//#region ../../node_modules/.bun/@formatjs+icu-messageformat-parser@3.1.1/node_modules/@formatjs/icu-messageformat-parser/error.js
var ErrorKind;
(function(ErrorKind) {
...
//#endregion
//#region ../../node_modules/.bun/@formatjs+icu-skeleton-parser@2.0.5/node_modules/@formatjs/icu-skeleton-parser/date-time.js
/**
...
//#endregion
//#region ../../node_modules/.bun/intl-messageformat@11.0.6/node_modules/intl-messageformat/src/formatters.js
var PART_TYPE;
(function(PART_TYPE) {
		...
		children: [/* @__PURE__ */ jsx("h2", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
					...
					children: [
						/* @__PURE__ */ jsx("option", { children: t("7befbbae6794", "English (en)") }),
						/* @__PURE__ */ jsx("option", { children: t("8545d83f3e07", "French (fr)") }),
						/* @__PURE__ */ jsx("option", { children: t("bf4335e69758", "German (de)") }),
						/* @__PURE__ */ jsx("option", { children: t("bd284ebd791f", "Spanish (es)") }),
						/* @__PURE__ */ jsx("option", { children: t("44688c9d5f6f", "Japanese (ja)") }),
						/* @__PURE__ */ jsx("option", { children: t("2d4bfd1535a4", "Chinese Simplified (zh-CN)") }),
						/* @__PURE__ */ jsx("option", { children: t("fd6304ee4dc3", "Arabic (ar)") })
					]
				})] })
			]
		})]
