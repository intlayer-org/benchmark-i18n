...
function SettingsHeader() {
	const { t } = useTranslation(["bc1955ec89a3", "abf3b17b1cd6"]);
	return /* @__PURE__ */ jsxs(Fragment$1, { children: [
		/* @__PURE__ */ jsx(MockBanner, {}),
		/* @__PURE__ */ jsx("h1", {
			className: "mb-2 text-3xl font-bold text-foreground",
			children: t("bc1955ec89a3", "Settings")
		}),
		/* @__PURE__ */ jsx("p", {
			className: "mb-8 text-muted-foreground",
			children: t("abf3b17b1cd6", "Manage your account preferences and configuration.")
		})
	] });
}
//#endregion
