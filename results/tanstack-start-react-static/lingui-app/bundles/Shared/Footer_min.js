...
var h = ({ i18n: e, defaultComponent: n, children: i }) => {
	...
	}, [e, c]), s.current ? /* @__PURE__ */ l(f.Provider, {
		value: u,
		children: i
...
function g() {
	let { i18n: e } = m(), t = (t) => e._(`footer.${t}`), n = c({ strict: !1 }).locale ?? "en", r = [
		{
			label: t("github"),
			...
			children: [/* @__PURE__ */ u("div", {
				...
				children: [
					...
					/* @__PURE__ */ u("div", { children: [/* @__PURE__ */ l("h3", {
						...
						className: "space-y-1",
						children: r.map((e) => /* @__PURE__ */ l("li", { children: e.isInternal ? /* @__PURE__ */ l(s, {
							to: e.to,
							params: { locale: n },
...
function _e() {
	return /* @__PURE__ */ l($, { children: /* @__PURE__ */ l(g, {}) });
}
//#endregion
