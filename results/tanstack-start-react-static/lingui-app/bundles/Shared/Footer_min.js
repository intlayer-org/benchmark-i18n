...
function v() {
	let { i18n: e } = g(), t = (t) => e._(`footer.${t}`), n = u({ strict: !1 }).locale ?? "en", r = [
		{
			label: t("github"),
			...
			children: [/* @__PURE__ */ f("div", {
				...
				children: [
					...
					/* @__PURE__ */ f("div", { children: [/* @__PURE__ */ d("h3", {
						...
						className: "space-y-1",
						children: r.map((e) => /* @__PURE__ */ d("li", { children: e.isInternal ? /* @__PURE__ */ d(l, {
							to: e.to,
							params: { locale: n },
...
function be() {
	return /* @__PURE__ */ d(ye, { children: /* @__PURE__ */ d(v, {}) });
}
//#endregion
