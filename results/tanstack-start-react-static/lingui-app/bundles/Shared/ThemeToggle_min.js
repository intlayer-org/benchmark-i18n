...
var c = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), l = e(null), u = (e) => {
	let t = n(l);
...
var f = ({ i18n: e, defaultComponent: n, children: i }) => {
	let c = a(e.locale), u = t(() => ({
		i18n: e,
		defaultComponent: n,
		_: e.t.bind(e)
	}), [e, n]), [d, f] = o(u());
	return r(() => {
		let t = () => {
			c.current = e.locale, f(u());
		}, n = e.on("change", t);
		return c.current !== e.locale && t(), n;
	}, [e, u]), c.current ? /* @__PURE__ */ s(l.Provider, {
		value: d,
		children: i
...
function h() {
	let { i18n: e } = d(), t = (t) => e._(`theme-toggle.${t}`), [n, i] = o("auto");
	r(() => {
		let e = p();
		i(e), m(e);
	}, []), r(() => {
	...
	function a() {
		...
		i(e), m(e), window.localStorage.setItem("theme", e);
	}
	let c = t(n === "auto" ? "themeModeAutoSystemClick" : n === "light" ? "themeModeLightClick" : "themeModeDarkClick");
...
var R = (e) => typeof e == "string", re = (e) => typeof e == "function", z = /* @__PURE__ */ new Map(), B = "en";
function V(e) {
...
}), X = "%__lingui_octothorpe__%", ie = (e, t, n = {}) => {
...
function oe(e, t, n) {
	return (r = {}, i) => {
		let a = ie(t, n, i), o = (e, t = !1) => Array.isArray(e) ? e.reduce((e, n) => {
			if (n === "#" && t) return e + X;
			if (R(n)) return e + n;
			let [i, s, c] = n, l = {};
...
var se = Object.defineProperty, ce = (e, t, n) => t in e ? se(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (ce(e, typeof t == "symbol" ? t : t + "", n), n), le = class {
	constructor() {
		Z(this, "_events", {});
	}
	on(e, t) {
	...
	writable: !0,
	value: n
}) : e[t] = n, Q = (e, t, n) => (de(e, typeof t == "symbol" ? t : t + "", n), n), fe = class extends le {
	constructor(e) {
		super(), Q(this, "_locale", ""), Q(this, "_locales"), Q(this, "_localeData", {}), Q(this, "_messages", {}), Q(this, "_missing"), Q(this, "_messageCompiler"), Q(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(ne), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? B, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), R(s) && J.test(s) ? Y(s) : R(s) ? s : oe(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
async function pe(e) {
	return (await g(/* @__PURE__ */ Object.assign({
...
function ge() {
	return /* @__PURE__ */ s(he, { children: /* @__PURE__ */ s(h, {}) });
}
//#endregion
