...
var u = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), d = t(null), f = (e) => {
	let t = i(d);
...
var m = ({ i18n: e, defaultComponent: t, children: n }) => {
	...
	return a(() => {
		let t = () => {
			i.current = e.locale, f(o());
		}, n = e.on("change", t);
		return i.current !== e.locale && t(), n;
	}, [e, o]), i.current ? /* @__PURE__ */ l(d.Provider, {
		value: u,
		children: n
...
function _() {
	let { i18n: e } = p(), t = (t) => e._(`theme-toggle.${t}`), [n, r] = c("auto");
	a(() => {
		let e = h();
		r(e), g(e);
	}, []), a(() => {
	...
	function i() {
		...
		r(e), g(e), window.localStorage.setItem("theme", e);
	}
...
function ye() {
	return /* @__PURE__ */ l(ve, { children: /* @__PURE__ */ l(_, {}) });
}
//#endregion
