...
var p = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), m = t(null), h = (e) => {
	let t = i(m);
...
var _ = ({ i18n: e, defaultComponent: t, children: n }) => {
	...
	}, [e, o]), i.current ? /* @__PURE__ */ d(m.Provider, {
		value: s,
		children: n
...
function y() {
	let { i18n: e } = g(), t = (t) => e._(`about-header.${t}`);
	return v("AboutHeader"), /* @__PURE__ */ f(u, { children: [/* @__PURE__ */ d("h1", {
...
var de = Object.defineProperty, fe = (e, t, n) => t in e ? de(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, pe = (e, t, n) => (fe(e, typeof t == "symbol" ? t : t + "", n), n), me = class {
	constructor() {
		pe(this, "_events", {});
	}
	on(e, t) {
...
}, he = Object.defineProperty, X = (e, t, n) => t in e ? he(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (X(e, typeof t == "symbol" ? t : t + "", n), n), ge = class extends me {
	constructor(e) {
		super(), Z(this, "_locale", ""), Z(this, "_locales"), Z(this, "_localeData", {}), Z(this, "_messages", {}), Z(this, "_missing"), Z(this, "_messageCompiler"), Z(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(se), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? z, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), I(s) && q.test(s) ? J(s) : I(s) ? s : ue(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
function be({ children: t }) {
	let r = n(ye), i = s(() => ve("en", r), [r]);
	return /* @__PURE__ */ d(e.Suspense, {
		fallback: null,
...
function xe() {
	return /* @__PURE__ */ d(be, { children: /* @__PURE__ */ d(y, {}) });
}
//#endregion
