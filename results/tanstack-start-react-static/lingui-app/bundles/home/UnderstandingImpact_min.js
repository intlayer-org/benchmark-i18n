...
var p = ({ i18n: e, defaultComponent: n, children: i }) => {
	...
	}, [e, l]), c.current ? /* @__PURE__ */ s(u.Provider, {
		value: d,
		children: i
...
function m() {
	let { i18n: e } = f(), t = (t) => e._(`understanding-impact.${t}`);
			...
			/* @__PURE__ */ c("div", {
				...
				children: [
					...
					/* @__PURE__ */ c("ul", {
						...
						children: [
							/* @__PURE__ */ s("li", { children: t("theJsonMustBeParsed") }),
							/* @__PURE__ */ s("li", { children: t("contextBasedArchitecturesCanCause") }),
							/* @__PURE__ */ s("li", { children: t("duringServerSideRenderingThe") })
						]
					})
				]
			}),
...
}, b = (e) => e < 4 ? "short" : e === 4 ? "long" : "narrow", x = (e) => e % 2 == 0 ? "2-digit" : "numeric";
function S(e, t) {
	switch (e.char) {
		case "y": return { year: x(e.width) };
		case "r": return {
			calendar: "gregory",
			year: "numeric"
		};
		default: return t(`${e.desc} is not supported; falling back to year:numeric`, y.WARNING), { year: "numeric" };
	}
}
function C(e, t) {
	switch (e.width) {
...
function T(e, t) {
	let { char: n, desc: r, width: i } = e;
	return (n === "c" || n === "e") && i < 3 && t(`Numeric value is not supported for ${r}; falling back to weekday:short`, y.WARNING), b(i);
}
function E(e) {
	let t = x(e.width), n;
	switch (e.char) {
...
function ee(e, t) {
	switch (e.field) {
		case "era": return { era: b(e.width) };
		case "year": return S(e, t);
		case "month": return { month: C(e, t) };
		case "day": return { day: w(e, t) };
		case "weekday": return { weekday: T(e, t) };
		case "period": return;
		case "hour": return E(e);
		case "min": return { minute: x(e.width) };
		case "sec": return { second: x(e.width) };
...
function te(e, t, n = (e) => {
	...
	for (let t of e) {
		...
		if (e) {
			let r = new y(e.message, t);
			r.stack = e.stack, n(r);
		}
		o && n(new y(`Ignoring string part: ${o}`, t, y.WARNING)), a && (i.indexOf(a) === -1 ? i.push(a) : n(new y(`Duplicate ${a} token`, t)));
		let s = ee(t, (e, r) => n(new y(e, t, r)));
		s && Object.assign(r, s);
	}
	return r;
}
...
function F(e, t) {
	return /^::/.test(e) ? te(N(e.substring(2)), void 0, t) : e;
}
function I(e, t = (e) => e) {
	return P((0, v.parse)(e), t);
}
function L(e, t = (e) => e) {
	try {
		return I(e, t);
...
var R = (e) => typeof e == "string", ne = (e) => typeof e == "function", z = /* @__PURE__ */ new Map(), B = "en";
function V(e) {
...
}), X = "%__lingui_octothorpe__%", re = (e, t, n = {}) => {
...
var oe = Object.defineProperty, se = (e, t, n) => t in e ? oe(e, t, {
	...
	writable: !0,
	value: n
}) : e[t] = n, ce = (e, t, n) => (se(e, typeof t == "symbol" ? t : t + "", n), n), Z = class {
	constructor() {
		ce(this, "_events", {});
	}
	on(e, t) {
...
}, le = Object.defineProperty, ue = (e, t, n) => t in e ? le(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Q = (e, t, n) => (ue(e, typeof t == "symbol" ? t : t + "", n), n), de = class extends Z {
	constructor(e) {
		super(), Q(this, "_locale", ""), Q(this, "_locales"), Q(this, "_localeData", {}), Q(this, "_messages", {}), Q(this, "_missing"), Q(this, "_messageCompiler"), Q(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(L), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? B, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), R(s) && J.test(s) ? Y(s) : R(s) ? s : ae(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
async function fe(e) {
	return (await h(/* @__PURE__ */ Object.assign({
...
function he() {
	return /* @__PURE__ */ s(me, { children: /* @__PURE__ */ s(m, {}) });
}
//#endregion
