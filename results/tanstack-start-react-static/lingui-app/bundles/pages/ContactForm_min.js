...
var m = ({ i18n: e, defaultComponent: n, children: i }) => {
	...
	}, [e, l]), a.current ? /* @__PURE__ */ c(d.Provider, {
		value: u,
		children: i
...
function h() {
	let { i18n: e } = p(), t = (t) => e._(`contact-form.${t}`), n = i(), r = i(), a = i(), o = i();
	return /* @__PURE__ */ l("form", {
		...
		children: [
			...
			/* @__PURE__ */ l("div", { children: [/* @__PURE__ */ c("label", {
				...
				children: [
					/* @__PURE__ */ c("option", { children: t("bugReport") }),
					/* @__PURE__ */ c("option", { children: t("newBenchmarkIdea") }),
					/* @__PURE__ */ c("option", { children: t("methodologyQuestion") }),
					/* @__PURE__ */ c("option", { children: "Contribution" }),
					/* @__PURE__ */ c("option", { children: "Other" })
				]
			})] }),
			/* @__PURE__ */ l("div", { children: [/* @__PURE__ */ c("label", {
				htmlFor: o,
...
function ge() {
	return /* @__PURE__ */ c(he, { children: /* @__PURE__ */ c(h, {}) });
}
//#endregion
