import e, { createContext as t, use as n, useCallback as r, useContext as i, useEffect as a, useId as o, useMemo as s, useRef as c, useState as l } from "react";
...
function _() {
	let { i18n: e } = h(), t = (t) => e._(`contact-form.${t}`), n = o(), r = o(), i = o(), a = o();
	return /* @__PURE__ */ d("form", {
		...
		children: [
			...
			/* @__PURE__ */ d("div", { children: [/* @__PURE__ */ u("label", {
				...
				children: [
					/* @__PURE__ */ u("option", { children: t("bugReport") }),
					/* @__PURE__ */ u("option", { children: t("newBenchmarkIdea") }),
					/* @__PURE__ */ u("option", { children: t("methodologyQuestion") }),
					/* @__PURE__ */ u("option", { children: "Contribution" }),
					/* @__PURE__ */ u("option", { children: "Other" })
				]
			})] }),
			/* @__PURE__ */ d("div", { children: [/* @__PURE__ */ u("label", {
				htmlFor: a,
...
var L = (e) => typeof e == "string", ae = (e) => typeof e == "function", R = /* @__PURE__ */ new Map(), z = "en";
function B(e) {
...
}), Y = "%__lingui_octothorpe__%", oe = (e, t, n = {}) => {
...
var le = Object.defineProperty, ue = (e, t, n) => t in e ? le(e, t, {
	...
	writable: !0,
	value: n
}) : e[t] = n, X = (e, t, n) => (me(e, typeof t == "symbol" ? t : t + "", n), n), he = class extends fe {
	constructor(e) {
		super(), X(this, "_locale", ""), X(this, "_locales"), X(this, "_localeData", {}), X(this, "_messages", {}), X(this, "_missing"), X(this, "_messageCompiler"), X(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(ie), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? z, e.locales);
	}
	get locale() {
		return this._locale;
	}
	...
	_(e, t, n) {
		...
		if (o && a) return ae(o) ? o(this._locale, e) : o;
		a && this.emit("missing", {
			id: e,
			locale: this._locale
		});
...
`)), L(s) && q.test(s) ? J(s) : L(s) ? s : ce(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
function ye() {
	return /* @__PURE__ */ u(ve, { children: /* @__PURE__ */ u(_, {}) });
}
//#endregion
