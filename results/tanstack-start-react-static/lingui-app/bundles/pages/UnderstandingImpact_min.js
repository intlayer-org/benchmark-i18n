...
function g() {
	let { i18n: e } = m(), t = (t) => e._(`understanding-impact.${t}`);
			...
			/* @__PURE__ */ u("div", {
				...
				children: [
					...
					/* @__PURE__ */ u("ul", {
						...
						children: [
							/* @__PURE__ */ l("li", { children: t("theJsonMustBeParsed") }),
							/* @__PURE__ */ l("li", { children: t("contextBasedArchitecturesCanCause") }),
							/* @__PURE__ */ l("li", { children: t("duringServerSideRenderingThe") })
						]
					})
				]
			}),
