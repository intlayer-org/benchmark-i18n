import e, { createContext as t, use as n, useCallback as r, useContext as i, useEffect as a, useMemo as o, useRef as s, useState as c } from "react";
import { jsx as l, jsxs as u } from "react/jsx-runtime";
//#region \0rolldown/runtime.js
var d = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), f = t(null), p = (e) => {
	let t = i(f);
...
var h = ({ i18n: e, defaultComponent: t, children: n }) => {
	let i = s(e.locale), o = r(() => ({
		i18n: e,
		defaultComponent: t,
		_: e.t.bind(e)
	}), [e, t]), [u, d] = c(o());
	return a(() => {
		let t = () => {
			i.current = e.locale, d(o());
		}, n = e.on("change", t);
		return i.current !== e.locale && t(), n;
	}, [e, o]), i.current ? /* @__PURE__ */ l(f.Provider, {
		value: u,
		children: n
...
function g() {
	let { i18n: e } = m(), t = (t) => e._(`what-we-measure.${t}`), n = [
		{
	...
	return /* @__PURE__ */ u("section", {
		...
		children: [/* @__PURE__ */ l("h2", {
			...
			className: "space-y-4",
			children: n.map((e) => /* @__PURE__ */ u("li", {
...
}, x = (e) => e < 4 ? "short" : e === 4 ? "long" : "narrow", S = (e) => e % 2 == 0 ? "2-digit" : "numeric";
function C(e, t) {
	switch (e.char) {
		case "y": return { year: S(e.width) };
		case "r": return {
			calendar: "gregory",
			year: "numeric"
		};
		default: return t(`${e.desc} is not supported; falling back to year:numeric`, b.WARNING), { year: "numeric" };
	}
}
function w(e, t) {
	switch (e.width) {
...
function E(e, t) {
	let { char: n, desc: r, width: i } = e;
	return (n === "c" || n === "e") && i < 3 && t(`Numeric value is not supported for ${r}; falling back to weekday:short`, b.WARNING), x(i);
}
function D(e) {
	let t = S(e.width), n;
	switch (e.char) {
...
function te(e, t) {
	switch (e.field) {
		case "era": return { era: x(e.width) };
		case "year": return C(e, t);
		case "month": return { month: w(e, t) };
		case "day": return { day: T(e, t) };
		case "weekday": return { weekday: E(e, t) };
		case "period": return;
		case "hour": return D(e);
		case "min": return { minute: S(e.width) };
		case "sec": return { second: S(e.width) };
...
function O(e, t, n = (e) => {
	...
	for (let t of e) {
		...
		if (e) {
			let r = new b(e.message, t);
			r.stack = e.stack, n(r);
		}
		o && n(new b(`Ignoring string part: ${o}`, t, b.WARNING)), a && (i.indexOf(a) === -1 ? i.push(a) : n(new b(`Duplicate ${a} token`, t)));
		let s = te(t, (e, r) => n(new b(e, t, r)));
		s && Object.assign(r, s);
	}
	return r;
}
...
function I(e, t) {
	return /^::/.test(e) ? O(P(e.substring(2)), void 0, t) : e;
}
function ne(e, t = (e) => e) {
	return F((0, y.parse)(e), t);
}
function re(e, t = (e) => e) {
	try {
		return ne(e, t);
...
var L = (e) => typeof e == "string", ie = (e) => typeof e == "function", R = /* @__PURE__ */ new Map(), z = "en";
function B(e) {
...
}), Y = "%__lingui_octothorpe__%", ae = (e, t, n = {}) => {
...
var ce = Object.defineProperty, le = (e, t, n) => t in e ? ce(e, t, {
	...
	writable: !0,
	value: n
}) : e[t] = n, X = (e, t, n) => (pe(e, typeof t == "symbol" ? t : t + "", n), n), me = class extends de {
	constructor(e) {
		super(), X(this, "_locale", ""), X(this, "_locales"), X(this, "_localeData", {}), X(this, "_messages", {}), X(this, "_missing"), X(this, "_messageCompiler"), X(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(re), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? z, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), L(s) && q.test(s) ? J(s) : L(s) ? s : se(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
async function he(e) {
	let t = Q[`../locales/${e}/messages.mjs`] || Q["../locales/en/messages.mjs"];
	try {
		return (await t()).messages;
	} catch (t) {
		return console.error(`Failed to load messages for locale: ${e}`, t), (await Q["../locales/en/messages.mjs"]()).messages;
	}
}
function ge(e, t) {
	let n = Z();
...
function _e({ children: t }) {
	let r = n($), i = o(() => ge("en", r), [r]);
	return /* @__PURE__ */ l(e.Suspense, {
		fallback: null,
...
function ve() {
	return /* @__PURE__ */ l(_e, { children: /* @__PURE__ */ l(g, {}) });
}
//#endregion
