import e, { createContext as t, use as n, useCallback as r, useEffect as i, useId as a, useMemo as o, useRef as s, useState as c } from "react";
...
var p = t(null), m = ({ i18n: e, defaultComponent: t, children: n }) => {
	let a = s(e.locale), o = r(() => ({
		i18n: e,
		defaultComponent: t,
		_: e.t.bind(e)
	}), [e, t]), [u, d] = c(o());
	return i(() => {
		let t = () => {
			a.current = e.locale, d(o());
		}, n = e.on("change", t);
		return a.current !== e.locale && t(), n;
	}, [e, o]), a.current ? /* @__PURE__ */ l(p.Provider, {
		value: u,
		children: n
...
function ge() {
	return /* @__PURE__ */ l(he, { children: /* @__PURE__ */ l(f, {}) });
}
//#endregion
