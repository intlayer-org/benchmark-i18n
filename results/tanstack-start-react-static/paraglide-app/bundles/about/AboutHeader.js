...
/** @typedef {{}} About_Header_Aboutthisbenchmark2Inputs */
...
*
* @param {About_Header_Aboutthisbenchmark2Inputs} inputs
...
var about_header_aboutthisbenchmark2 = ((inputs = {}, options = {}) => {
	...
	return pt_about_header_aboutthisbenchmark2(inputs);
});
//#endregion
//#region src/paraglide/messages/about_header_thisisanopensource4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} About_Header_Thisisanopensource4Inputs */
...
* | output |
* | --- |
* | "This is an open-source test application — not a product or a company. Its sole purpose is to provide a realistic, multi-page React app where different i18n l..." |
*
* @param {About_Header_Thisisanopensource4Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var about_header_thisisanopensource4 = ((inputs = {}, options = {}) => {
	...
	return pt_about_header_thisisanopensource4(inputs);
});
//#endregion
