...
/** @typedef {{}} Results_Table_Sampleresults1Inputs */
var en_results_table_sampleresults1 = () => {
	return `Sample Results`;
};
var de_results_table_sampleresults1 = () => {
...
* | "Sample Results" |
*
* @param {Results_Table_Sampleresults1Inputs} inputs
...
var results_table_sampleresults1 = ((inputs = {}, options = {}) => {
	...
	return pt_results_table_sampleresults1(inputs);
});
//#endregion
//#region src/paraglide/messages/results_table_bundlesize1.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Results_Table_Bundlesize1Inputs */
var en_results_table_bundlesize1 = () => {
	return `Bundle Size`;
};
var de_results_table_bundlesize1 = () => {
	return `Bundle-Größe`;
};
...
* | "Bundle Size" |
*
* @param {Results_Table_Bundlesize1Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var results_table_bundlesize1 = ((inputs = {}, options = {}) => {
	...
	return pt_results_table_bundlesize1(inputs);
});
//#endregion
//#region src/paraglide/messages/results_table_lookuptime1.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Results_Table_Lookuptime1Inputs */
...
* | "Lookup Time" |
*
* @param {Results_Table_Lookuptime1Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var results_table_lookuptime1 = ((inputs = {}, options = {}) => {
	...
	return pt_results_table_lookuptime1(inputs);
});
//#endregion
//#region src/paraglide/messages/results_table_lazyloading1.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Results_Table_Lazyloading1Inputs */
...
* | "Lazy Loading" |
*
* @param {Results_Table_Lazyloading1Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var results_table_lazyloading1 = ((inputs = {}, options = {}) => {
	...
	return pt_results_table_lazyloading1(inputs);
});
//#endregion
