...
/** @typedef {{}} Understanding_Impact_Understandingtheimpact2Inputs */
...
*
* @param {Understanding_Impact_Understandingtheimpact2Inputs} inputs
...
var understanding_impact_understandingtheimpact2 = ((inputs = {}, options = {}) => {
	...
	return pt_understanding_impact_understandingtheimpact2(inputs);
});
//#endregion
//#region src/paraglide/messages/understanding_impact_whyasinglelargejson4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Understanding_Impact_Whyasinglelargejson4Inputs */
...
*
* @param {Understanding_Impact_Whyasinglelargejson4Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var understanding_impact_whyasinglelargejson4 = ((inputs = {}, options = {}) => {
	...
	return pt_understanding_impact_whyasinglelargejson4(inputs);
});
//#endregion
//#region src/paraglide/messages/understanding_impact_manyi18nlibrariesstoretranslations4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Understanding_Impact_Manyi18nlibrariesstoretranslations4Inputs */
...
* | output |
* | --- |
* | "Many i18n libraries store translations in a single JSON object provided via React context. When this object is large (thousands of keys), every component tha..." |
*
* @param {Understanding_Impact_Manyi18nlibrariesstoretranslations4Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var understanding_impact_manyi18nlibrariesstoretranslations4 = ((inputs = {}, options = {}) => {
	...
	return pt_understanding_impact_manyi18nlibrariesstoretranslations4(inputs);
});
//#endregion
//#region src/paraglide/messages/understanding_impact_thejsonmustbeparsed4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Understanding_Impact_Thejsonmustbeparsed4Inputs */
...
*
* @param {Understanding_Impact_Thejsonmustbeparsed4Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var understanding_impact_thejsonmustbeparsed4 = ((inputs = {}, options = {}) => {
	...
	return pt_understanding_impact_thejsonmustbeparsed4(inputs);
});
//#endregion
//#region src/paraglide/messages/understanding_impact_contextbasedarchitecturescancause4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Understanding_Impact_Contextbasedarchitecturescancause4Inputs */
...
* | output |
* | --- |
* | "Context-based architectures can cause cascading re-renders when the locale changes, because every consumer is notified even if their specific keys didn't cha..." |
*
* @param {Understanding_Impact_Contextbasedarchitecturescancause4Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var understanding_impact_contextbasedarchitecturescancause4 = ((inputs = {}, options = {}) => {
	...
	return pt_understanding_impact_contextbasedarchitecturescancause4(inputs);
});
//#endregion
//#region src/paraglide/messages/understanding_impact_duringserversiderenderingthe4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Understanding_Impact_Duringserversiderenderingthe4Inputs */
...
*
* @param {Understanding_Impact_Duringserversiderenderingthe4Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var understanding_impact_duringserversiderenderingthe4 = ((inputs = {}, options = {}) => {
	...
	return pt_understanding_impact_duringserversiderenderingthe4(inputs);
});
//#endregion
//#region src/paraglide/messages/understanding_impact_thetradeoffsofdynamic4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Understanding_Impact_Thetradeoffsofdynamic4Inputs */
...
*
* @param {Understanding_Impact_Thetradeoffsofdynamic4Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var understanding_impact_thetradeoffsofdynamic4 = ((inputs = {}, options = {}) => {
	...
	return pt_understanding_impact_thetradeoffsofdynamic4(inputs);
});
//#endregion
//#region src/paraglide/messages/understanding_impact_splittingtranslationsintoperroute4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Understanding_Impact_Splittingtranslationsintoperroute4Inputs */
...
*
* @param {Understanding_Impact_Splittingtranslationsintoperroute4Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var understanding_impact_splittingtranslationsintoperroute4 = ((inputs = {}, options = {}) => {
	...
	return pt_understanding_impact_splittingtranslationsintoperroute4(inputs);
});
//#endregion
//#region src/paraglide/messages/understanding_impact_waterfallrequests1.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Understanding_Impact_Waterfallrequests1Inputs */
...
* | "Waterfall requests:" |
*
* @param {Understanding_Impact_Waterfallrequests1Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var understanding_impact_waterfallrequests1 = ((inputs = {}, options = {}) => {
	...
	return pt_understanding_impact_waterfallrequests1(inputs);
});
//#endregion
//#region src/paraglide/messages/understanding_impact_flashofuntranslatedcontentfouc4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Understanding_Impact_Flashofuntranslatedcontentfouc4Inputs */
...
*
* @param {Understanding_Impact_Flashofuntranslatedcontentfouc4Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var understanding_impact_flashofuntranslatedcontentfouc4 = ((inputs = {}, options = {}) => {
	...
	return pt_understanding_impact_flashofuntranslatedcontentfouc4(inputs);
});
//#endregion
//#region src/paraglide/messages/understanding_impact_cacheinvalidation1.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Understanding_Impact_Cacheinvalidation1Inputs */
...
* | "Cache invalidation:" |
*
* @param {Understanding_Impact_Cacheinvalidation1Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var understanding_impact_cacheinvalidation1 = ((inputs = {}, options = {}) => {
	...
	return pt_understanding_impact_cacheinvalidation1(inputs);
});
//#endregion
//#region src/paraglide/messages/understanding_impact_whatthisbenchmarkmeasures3.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Understanding_Impact_Whatthisbenchmarkmeasures3Inputs */
...
*
* @param {Understanding_Impact_Whatthisbenchmarkmeasures3Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var understanding_impact_whatthisbenchmarkmeasures3 = ((inputs = {}, options = {}) => {
	...
	return pt_understanding_impact_whatthisbenchmarkmeasures3(inputs);
});
//#endregion
//#region src/paraglide/messages/understanding_impact_thistestappprovidesa4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Understanding_Impact_Thistestappprovidesa4Inputs */
...
* | output |
* | --- |
* | "This test app provides a controlled environment — 10 pages with realistic content — to compare i18n libraries across three axes: the weight they add to your ..." |
*
* @param {Understanding_Impact_Thistestappprovidesa4Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var understanding_impact_thistestappprovidesa4 = ((inputs = {}, options = {}) => {
	...
	return pt_understanding_impact_thistestappprovidesa4(inputs);
});
//#endregion
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("ul", {
						...
						children: [
							/* @__PURE__ */ jsx("li", { children: understanding_impact_thejsonmustbeparsed4() }),
							/* @__PURE__ */ jsx("li", { children: understanding_impact_contextbasedarchitecturescancause4() }),
							/* @__PURE__ */ jsx("li", { children: understanding_impact_duringserversiderenderingthe4() })
						]
					})
				]
			}),
