...
/** @typedef {{}} What_We_Measure_Bundlesizeimpact2Inputs */
...
* | "Bundle size impact" |
*
* @param {What_We_Measure_Bundlesizeimpact2Inputs} inputs
...
var what_we_measure_bundlesizeimpact2 = ((inputs = {}, options = {}) => {
	...
	return pt_what_we_measure_bundlesizeimpact2(inputs);
});
//#endregion
//#region src/paraglide/messages/what_we_measure_theadditionaljavascriptbytessent4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} What_We_Measure_Theadditionaljavascriptbytessent4Inputs */
...
* | output |
* | --- |
* | "The additional JavaScript bytes sent to users when the i18n library and its translation files are included. This directly affects download time on slow netwo..." |
*
* @param {What_We_Measure_Theadditionaljavascriptbytessent4Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var what_we_measure_theadditionaljavascriptbytessent4 = ((inputs = {}, options = {}) => {
	...
	return pt_what_we_measure_theadditionaljavascriptbytessent4(inputs);
});
//#endregion
//#region src/paraglide/messages/what_we_measure_renderingoverhead1.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} What_We_Measure_Renderingoverhead1Inputs */
...
* | "Rendering overhead" |
*
* @param {What_We_Measure_Renderingoverhead1Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var what_we_measure_renderingoverhead1 = ((inputs = {}, options = {}) => {
	...
	return pt_what_we_measure_renderingoverhead1(inputs);
});
//#endregion
//#region src/paraglide/messages/what_we_measure_howmuchextratimethe4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} What_We_Measure_Howmuchextratimethe4Inputs */
...
* | output |
* | --- |
* | "How much extra time the library adds to React's render cycle. Libraries that inject translations via a single context provider can cause unnecessary re-rende..." |
*
* @param {What_We_Measure_Howmuchextratimethe4Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var what_we_measure_howmuchextratimethe4 = ((inputs = {}, options = {}) => {
	...
	return pt_what_we_measure_howmuchextratimethe4(inputs);
});
//#endregion
//#region src/paraglide/messages/what_we_measure_hydrationcost1.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} What_We_Measure_Hydrationcost1Inputs */
...
* | "Hydration cost" |
*
* @param {What_We_Measure_Hydrationcost1Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var what_we_measure_hydrationcost1 = ((inputs = {}, options = {}) => {
	...
	return pt_what_we_measure_hydrationcost1(inputs);
});
//#endregion
//#region src/paraglide/messages/what_we_measure_duringssrtranslationdatais4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} What_We_Measure_Duringssrtranslationdatais4Inputs */
...
* | output |
* | --- |
* | "During SSR, translation data is serialized into HTML. Large dictionaries increase the HTML payload and slow down hydration — the moment the page becomes inte..." |
*
* @param {What_We_Measure_Duringssrtranslationdatais4Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var what_we_measure_duringssrtranslationdatais4 = ((inputs = {}, options = {}) => {
	...
	return pt_what_we_measure_duringssrtranslationdatais4(inputs);
});
//#endregion
//#region src/paraglide/messages/what_we_measure_lazyloadingeffectiveness2.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} What_We_Measure_Lazyloadingeffectiveness2Inputs */
...
*
* @param {What_We_Measure_Lazyloadingeffectiveness2Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var what_we_measure_lazyloadingeffectiveness2 = ((inputs = {}, options = {}) => {
	...
	return pt_what_we_measure_lazyloadingeffectiveness2(inputs);
});
//#endregion
//#region src/paraglide/messages/what_we_measure_whethersplittingtranslationsbyroute4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} What_We_Measure_Whethersplittingtranslationsbyroute4Inputs */
...
* | output |
* | --- |
* | "Whether splitting translations by route or namespace actually reduces the initial load, and what trade-offs it introduces (waterfall requests, FOUC, cache co..." |
*
* @param {What_We_Measure_Whethersplittingtranslationsbyroute4Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var what_we_measure_whethersplittingtranslationsbyroute4 = ((inputs = {}, options = {}) => {
	...
	return pt_what_we_measure_whethersplittingtranslationsbyroute4(inputs);
});
//#endregion
//#region src/paraglide/messages/what_we_measure_localeswitchspeed2.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} What_We_Measure_Localeswitchspeed2Inputs */
...
* | "Locale switch speed" |
*
* @param {What_We_Measure_Localeswitchspeed2Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var what_we_measure_localeswitchspeed2 = ((inputs = {}, options = {}) => {
	...
	return pt_what_we_measure_localeswitchspeed2(inputs);
});
//#endregion
//#region src/paraglide/messages/what_we_measure_howfasttheappcan4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} What_We_Measure_Howfasttheappcan4Inputs */
...
*
* @param {What_We_Measure_Howfasttheappcan4Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var what_we_measure_howfasttheappcan4 = ((inputs = {}, options = {}) => {
	...
	return pt_what_we_measure_howfasttheappcan4(inputs);
});
//#endregion
//#region src/paraglide/messages/what_we_measure_whatwemeasure2.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} What_We_Measure_Whatwemeasure2Inputs */
...
* | "What We Measure" |
*
* @param {What_We_Measure_Whatwemeasure2Inputs} inputs
* @param {{ locale?: "en" | "de" | "fr" | "es" | "ja" | "zh" | "ko" | "it" | "pt" }} options
* @returns {LocalizedString}
*/
var what_we_measure_whatwemeasure2 = ((inputs = {}, options = {}) => {
	...
	return pt_what_we_measure_whatwemeasure2(inputs);
});
//#endregion
...
function WhatWeMeasure() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("h2", {
			...
			className: "space-y-4",
			children: metrics.map((metricEl) => /* @__PURE__ */ jsxs("li", {
