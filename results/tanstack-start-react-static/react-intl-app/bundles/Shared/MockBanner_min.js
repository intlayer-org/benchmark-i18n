...
var ae = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, _ = /^(@+)?(\+|#+)?[rs]?$/g, oe = /(\*)(0+)|(#+)(0+)|(0+)/g, v = /^(0+)$/;
function y(e) {
	let t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(_, function(e, n, r) {
...
function se(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		let n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !v.test(e)) throw Error("Malformed concise eng/scientific notation");
...
function ce(e) {
	...
	for (let n of e) {
		...
		if (ae.test(n.stem)) {
			...
			n.stem.replace(ae, function(e, n, r, i, a, o) {
...
function N(e) {
	e.forEach((e) => {
		if (delete e.location, pe(e) || me(e)) for (let t in e.options) delete e.options[t].location, N(e.options[t].value);
		else ue(e) && _e(e.style) || (de(e) || fe(e)) && T(e.style) ? delete e.style.location : ge(e) && N(e.children);
	});
}
function Me(e, t = {}) {
	t = {
...
function z(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (ge(c)) {
			...
			if (!R(u)) throw new Ne(l, "function", o);
...
function Ke(e = Ge()) {
	...
	return {
		getDateTimeFormat: i,
		getNumberFormat: o,
		getMessageFormat: a((e, t, n, r) => new V(e, t, n, {
			formatters: {
				getNumberFormat: o,
				getDateTimeFormat: i,
				getPluralRules: s
...
function Je(e, t) {
	...
	return {
		...n,
		...e,
		date: qe(Y(n.date, t), Y(e.date || {}, t)),
		time: qe(Y(n.time, t), Y(e.time || {}, t))
	};
}
var X = ({ locale: e, formats: t, messages: n, defaultLocale: r, defaultFormats: i, fallbackOnEmptyString: a, onError: o, timeZone: s, defaultRichTextElements: c }, l, u = { id: "" }, d, f) => {
	...
	Ue(!!p, "[@formatjs/intl] An `id` must be provided to format a message. You can either:\n1. Configure your build toolchain with [babel-plugin-formatjs](https://formatjs.github.io/docs/tooling/babel-plugin)\nor [@formatjs/ts-transformer](https://formatjs.github.io/docs/tooling/ts-transformer) OR\n2. Configure your `eslint` config to include [eslint-plugin-formatjs](https://formatjs.github.io/docs/tooling/linter#enforce-id)\nto autofix this issue");
...
function dt({ locale: e, formats: t, onError: n }, r, i = {}) {
	let { format: a } = i;
	return r(e, K(i, ut, !!a && J(t, "relative", a, n) || {}));
}
...
function mt({ locale: e, formats: t, onError: n }, r, i = {}) {
	let { format: a } = i;
	return r(e, K(i, pt, a && J(t, "number", a, n) || {}));
}
function ht(e, t, n, r = {}) {
	try {
...
function yt(e, t) {
	...
	return i ? !Intl.NumberFormat.supportedLocalesOf(i).length && o ? o(new Ve(`Missing locale data for locale: "${i}" in Intl.NumberFormat. Using default locale: "${a}" as fallback. See https://formatjs.github.io/docs/react-intl#runtime-requirements for more details`)) : !Intl.DateTimeFormat.supportedLocalesOf(i).length && o && o(new Ve(`Missing locale data for locale: "${i}" in Intl.DateTimeFormat. Using default locale: "${a}" as fallback. See https://formatjs.github.io/docs/react-intl#runtime-requirements for more details`)) : (o && o(new Be(`"locale" was not configured, using "${a}" as fallback. See https://formatjs.github.io/docs/react-intl/api#intlshape for more details`)), r.locale = r.defaultLocale || "en"), vt(r), {
		...r,
		formatters: n,
...
}, Ct = (t) => e.Children.toArray(t).map((t, n) => e.isValidElement(t) ? /* @__PURE__ */ i(e.Fragment, { children: t }, n) : t);
function wt(e) {
	return function(t) {
		return e(Ct(t));
	};
...
function Ft(t) {
	...
	return (!r.current || !Q(r.current, s)) && (r.current = s, a.current = At(s, n.current)), xt(a.current), /* @__PURE__ */ i(Et, {
		value: a.current,
		children: t.children
	});
}
...
function Vt() {
	return /* @__PURE__ */ i(Bt, { children: /* @__PURE__ */ i(Lt, {}) });
}
//#endregion
