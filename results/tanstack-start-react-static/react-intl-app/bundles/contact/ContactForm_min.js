...
function Nt(t) {
	...
	return (!r.current || !Et(r.current, s)) && (r.current = s, a.current = jt(s, n.current)), St(a.current), /* @__PURE__ */ i(Dt, {
		value: a.current,
		children: t.children
	});
}
...
function zt() {
	return /* @__PURE__ */ i(Rt, { children: /* @__PURE__ */ i(Ft, {}) });
}
//#endregion
