...
}, St = (t) => e.Children.toArray(t).map((t, n) => e.isValidElement(t) ? /* @__PURE__ */ r(e.Fragment, { children: t }, n) : t);
function Ct(e) {
	return function(t) {
		return e(St(t));
	};
...
function Mt(t) {
	let n = e.useRef(We()), i = e.useRef(void 0), a = e.useRef(void 0), o = {};
	for (let e in t) t[e] !== void 0 && (o[e] = t[e]);
	let s = jt({
		...xt,
		...o
	});
	return (!i.current || !wt(i.current, s)) && (i.current = s, a.current = At(s, n.current)), bt(a.current), /* @__PURE__ */ r(Et, {
		value: a.current,
		children: t.children
	});
}
...
function Rt() {
	return /* @__PURE__ */ r(Lt, { children: /* @__PURE__ */ r(Pt, {}) });
}
//#endregion
