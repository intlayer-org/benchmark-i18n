...
function Nt() {
	...
	return /* @__PURE__ */ r("div", {
		...
		children: [
			{
				name: e.formatMessage({ id: "pricing-tiers.starter" }),
				price: e.formatMessage({ id: "pricing-tiers.price0" }),
				period: e.formatMessage({ id: "pricing-tiers.forever" }),
				features: [
					e.formatMessage({ id: "pricing-tiers.benchmarkRunPerDay" }, { runs: 5 }),
					e.formatMessage({ id: "pricing-tiers.librariesNumber" }, { libs: 3 }),
					e.formatMessage({ id: "pricing-tiers.communitySupport" }),
					e.formatMessage({ id: "pricing-tiers.publicResults" })
				]
			},
			{
				name: e.formatMessage({ id: "pricing-tiers.pro" }),
				price: e.formatMessage({ id: "pricing-tiers.price29" }),
				period: e.formatMessage({ id: "pricing-tiers.month" }),
				features: [
					e.formatMessage({ id: "pricing-tiers.unlimitedRuns" }),
					e.formatMessage({ id: "pricing-tiers.allLibraries" }),
					e.formatMessage({ id: "pricing-tiers.prioritySupport" }),
					e.formatMessage({ id: "pricing-tiers.privateResults" }),
					e.formatMessage({ id: "pricing-tiers.ciIntegration" }),
					e.formatMessage({ id: "pricing-tiers.historicalData" })
				],
				highlighted: !0
			},
			{
				name: e.formatMessage({ id: "pricing-tiers.enterprise" }),
				price: e.formatMessage({ id: "pricing-tiers.customPrice" }),
				period: "",
				features: [
					e.formatMessage({ id: "pricing-tiers.everythingInPro" }),
					e.formatMessage({ id: "pricing-tiers.onPremiseOption" }),
					e.formatMessage({ id: "pricing-tiers.ssoSaml" }),
					e.formatMessage({ id: "pricing-tiers.dedicatedAccountManager" }),
					e.formatMessage({ id: "pricing-tiers.customSlas" }),
					e.formatMessage({ id: "pricing-tiers.auditLogs" }),
					e.formatMessage({ id: "pricing-tiers.trainingSessions" })
				]
			}
			...
			children: [
				...
				/* @__PURE__ */ r("ul", {
					...
					children: t.features.map((e) => /* @__PURE__ */ i("li", {
				...
				/* @__PURE__ */ r("button", {
					...
					children: t.name === e.formatMessage({ id: "pricing-tiers.enterprise" }) ? e.formatMessage({ id: "pricing-tiers.contactSales" }) : e.formatMessage({ id: "pricing-tiers.getStarted" })
				})
			]
		}, t.name))
	});
...
async function Ft(e) {
	return (await Pt(/* @__PURE__ */ Object.assign({
...
var e = "⚠️ Diese Seite enthält Beispieldaten nur zu Benchmarking-Zwecken. Sie steht in keinem Zusammenhang mit einem echten Unternehmen oder Dienst.", t = {
...
var e = "⚠️ Esta página contiene datos de muestra solo para fines de benchmarking. No está relacionada con ningún negocio o servicio real.", t = {
	"header.home": "Inicio",
...
var e = "⚠️ Cette page contient des données fictives à des fins de benchmarking uniquement. Elle n'est liée à aucune entreprise ou service réel.", t = {
	"header.home": "Accueil",
...
var e = "⚠️ Questa pagina contiene dati di esempio solo a scopo di benchmarking. Non è correlata ad alcuna attività o servizio reale.", t = {
	"header.home": "Home",
...
var e = "⚠️ このページにはベンチマークのみを目的とした模擬データが含まれています。実際のビジネスやサービスとは関係ありません。", t = {
	"header.home": "ホーム",
...
var e = "⚠️ 이 페이지는 벤치마킹 목적으로만 사용되는 모의 데이터를 포함하고 있습니다. 실제 비즈니스나 서비스와는 관련이 없습니다.", t = {
	"header.home": "홈",
...
var e = "⚠️ Esta página contém dados fictícios apenas para fins de benchmarking. Não está relacionada com qualquer negócio ou serviço real.", t = {
	"header.home": "Início",
	"header.methodology": "Metodologia",
...
var e = "⚠️ Эта страница содержит макетные данные только для целей бенчмаркинга. Она не связана с каким-либо реальным бизнесом или услугой.", t = {
	"header.home": "Главная",
...
var e = "⚠️ 此页面仅包含用于基准测试的模拟数据。它与任何真实的业务或服务无关。", t = {
	"header.home": "首页",
