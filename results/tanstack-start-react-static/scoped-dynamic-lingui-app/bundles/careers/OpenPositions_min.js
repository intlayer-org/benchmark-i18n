...
function h() {
	let { i18n: e } = p(), t = [{
		title: e._({
			id: "open-positions.seniorFrontendEngineer",
			message: "Senior Frontend Engineer"
		}),
		location: e._({
			id: "open-positions.remote",
			message: "Remote"
		}),
		type: e._({
			id: "open-positions.fullTime",
			message: "Full-time"
		}),
		dept: e._({
			id: "open-positions.engineering",
			message: "Engineering"
		}),
		desc: e._({
	...
	return /* @__PURE__ */ l(s, { children: [/* @__PURE__ */ c("h2", {
