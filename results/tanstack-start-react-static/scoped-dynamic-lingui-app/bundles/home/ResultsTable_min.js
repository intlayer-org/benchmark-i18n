...
function m() {
	let { i18n: e } = f(), t = (t) => e._(`results-table.${t}`);
	return /* @__PURE__ */ c("section", { children: [/* @__PURE__ */ s("h2", {
...
async function fe(e, t = ["shared", "route"]) {
	let n = {};
	for (let r of t) try {
		let t = await h(/* @__PURE__ */ Object.assign({
