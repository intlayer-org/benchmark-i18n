...
var h = ({ i18n: e, defaultComponent: n, children: i }) => {
	...
	}, [e, c]), a.current ? /* @__PURE__ */ l(f.Provider, {
		value: u,
		children: i
...
function _() {
	let { i18n: e } = m(), t = (t) => e._(`about-header.${t}`);
	return g("AboutHeader"), /* @__PURE__ */ u(c, { children: [/* @__PURE__ */ l("h1", {
...
function A(e, t) {
	switch (e.field) {
		...
		case "weekday": return { weekday: D(e, t) };
		case "period": return;
		case "hour": return O(e);
		case "min": return { minute: w(e.width) };
		case "sec": return { second: w(e.width) };
		case "tz": return { timeZoneName: k(e, t) };
		case "quarter":
		case "week":
		case "sec-frac":
...
function re(e, t) {
	return /^::/.test(e) ? j(ne(e.substring(2)), void 0, t) : e;
}
function ie(e, t = (e) => e) {
	return I((0, x.parse)(e), t);
}
function ae(e, t = (e) => e) {
	try {
		return ie(e, t);
...
var le = Object.defineProperty, ue = (e, t, n) => t in e ? le(e, t, {
	...
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (me(e, typeof t == "symbol" ? t : t + "", n), n), Q = class extends fe {
	constructor(e) {
		super(), Z(this, "_locale", ""), Z(this, "_locales"), Z(this, "_localeData", {}), Z(this, "_messages", {}), Z(this, "_missing"), Z(this, "_messageCompiler"), Z(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(ae), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? B, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
async function he(e, t = ["shared", "route"]) {
	let n = {};
	for (let r of t) try {
...
function ve() {
	return /* @__PURE__ */ l(_e, { children: /* @__PURE__ */ l(_, {}) });
}
//#endregion
