...
function d(e = { c: [] }, t) {
	let n = e.c, r = (e) => {
		let t = n[e];
		return typeof t == "string" ? [t] : Array.isArray(t) ? t : [l(e, n)];
	}, i = (e, t = []) => u(r(e), t, 0);
	return i._ = e, i.l = t, i.c = r, i.x = u, i.t = (e, t, n) => {
		let i = r(t), a = [""], o = [];
		for (let e of i) {
			if (typeof e == "string") {
				a[a.length - 1] += e;
...
function h(e, t, n, r) {
	...
	for (let t of n) p[e].collection.set(t, m);
	return (t) => p[e].collection.get(t);
}
//#endregion
...
function S() {
	...
	function n() {
		...
		t(n), x(n), window.localStorage.setItem("theme", n);
	}
	let r = _("shared"), a = e === "auto" ? r(21) : r(22, [e]);
	return /* @__PURE__ */ s("button", {
		...
		children: r(e === "auto" ? 23 : e === "dark" ? 24 : 25)
	});
}
//#endregion
...
function D() {
	let t = _("shared");
	E(t(13));
	let [i, a] = o(!1), l = n({ strict: !1 }).locale ?? "en", u = [
		{
			to: "/$locale/products",
			label: t(4)
		},
