...
var catalogs = { blog: {
	en: () => import("./shared.shared.en.compiled-MiWsCUcY.js"),
	es: () => import("./shared.shared.es.compiled-nla_KoAk.js"),
	fr: () => import("./shared.shared.fr.compiled-CR8bSt5Y.js"),
	de: () => import("./shared.shared.de.compiled-DDwLV7v-.js"),
	it: () => import("./shared.shared.it.compiled-BUF0TCjG.js"),
	pt: () => import("./shared.shared.pt.compiled-Cd_RpTue.js"),
	zh: () => import("./shared.shared.zh.compiled-CwkCI3L0.js"),
	ja: () => import("./shared.shared.ja.compiled-LUML9yw9.js"),
	ko: () => import("./shared.shared.ko.compiled-CXJ-XxTP.js"),
	ru: () => import("./shared.shared.ru.compiled-C9dW5pev.js")
} };
...
function BlogList() {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: [
			{
				title: _w_runtime_(157),
				date: _w_runtime_(158),
				excerpt: _w_runtime_(159),
				category: _w_runtime_(160)
			},
			{
				title: _w_runtime_(161),
				date: _w_runtime_(162),
				excerpt: _w_runtime_(163),
				category: _w_runtime_(164)
			},
			{
				title: _w_runtime_(165),
				date: _w_runtime_(166),
				excerpt: _w_runtime_(167),
				category: _w_runtime_(168)
			},
			{
				title: _w_runtime_(169),
				date: _w_runtime_(170),
				excerpt: _w_runtime_(171),
				category: _w_runtime_(164)
			},
			{
				title: _w_runtime_(172),
				date: _w_runtime_(173),
				excerpt: _w_runtime_(174),
				category: _w_runtime_(168)
			},
			{
				title: _w_runtime_(175),
				date: _w_runtime_(176),
				excerpt: _w_runtime_(177),
				category: _w_runtime_(178)
			}
		].map((p) => {
