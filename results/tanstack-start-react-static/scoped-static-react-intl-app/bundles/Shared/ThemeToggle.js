...
function ThemeToggle() {
	...
	const intl = useIntl();
	const label = mode === "auto" ? intl.formatMessage({ id: "theme-toggle.themeModeAutoSystemClick" }) : mode === "light" ? intl.formatMessage({ id: "theme-toggle.themeModeLightClick" }) : intl.formatMessage({ id: "theme-toggle.themeModeDarkClick" });
	return /* @__PURE__ */ jsx("button", {
		...
		children: mode === "auto" ? intl.formatMessage({ id: "theme-toggle.themeAuto" }) : mode === "dark" ? intl.formatMessage({ id: "theme-toggle.themeDark" }) : intl.formatMessage({ id: "theme-toggle.themeLight" })
	});
}
//#endregion
