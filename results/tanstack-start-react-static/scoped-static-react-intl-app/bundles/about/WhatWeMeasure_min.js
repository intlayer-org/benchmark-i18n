...
function Nt() {
	let e = Et(), t = [
		{
			metric: e.formatMessage({ id: "what-we-measure.bundleSizeImpact" }),
			desc: e.formatMessage({ id: "what-we-measure.theAdditionalJavascriptBytesSent" })
		},
		{
			metric: e.formatMessage({ id: "what-we-measure.renderingOverhead" }),
			desc: e.formatMessage({ id: "what-we-measure.howMuchExtraTimeThe" })
		},
		{
			metric: e.formatMessage({ id: "what-we-measure.hydrationCost" }),
			desc: e.formatMessage({ id: "what-we-measure.duringSsrTranslationDataIs" })
		},
		{
			metric: e.formatMessage({ id: "what-we-measure.lazyLoadingEffectiveness" }),
			desc: e.formatMessage({ id: "what-we-measure.whetherSplittingTranslationsByRoute" })
		},
		{
			metric: e.formatMessage({ id: "what-we-measure.localeSwitchSpeed" }),
			desc: e.formatMessage({ id: "what-we-measure.howFastTheAppCan" })
		}
	];
	return /* @__PURE__ */ i("section", {
		...
		children: [/* @__PURE__ */ r("h2", {
			...
			children: e.formatMessage({ id: "what-we-measure.whatWeMeasure" })
		}), /* @__PURE__ */ r("ul", {
			className: "space-y-4",
			children: t.map((e) => /* @__PURE__ */ i("li", {
