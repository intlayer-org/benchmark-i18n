...
function a(e, t) {
	let n = t && t.cache ? t.cache : h, r = t && t.serializer ? t.serializer : p;
...
function u(e, t) {
	let n = e.length === 1 ? s : c;
	return l(e, this, n, t.cache.create(), t.serializer);
}
function d(e, t) {
	return l(e, this, c, t.cache.create(), t.serializer);
}
function f(e, t) {
...
var _ = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, v = /^(@+)?(\+|#+)?[rs]?$/g, ae = /(\*)(0+)|(#+)(0+)|(0+)/g, y = /^(0+)$/;
function b(e) {
	let t = {};
...
function oe(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		let n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !y.test(e)) throw Error("Malformed concise eng/scientific notation");
...
function ge(e, t) {
	...
	for (let r = 0; r < e.length; r++) {
		...
		if (i === "j") {
			...
			let o = 1 + (a & 1), s = a < 2 ? 1 : 3 + (a >> 1), c = _e(t);
...
var be = !!Object.fromEntries, xe = !!String.prototype.trimStart, Se = !!String.prototype.trimEnd, M = be ? Object.fromEntries : function(e) {
	let t = {};
	...
	return e.replace(ye, "");
}, N = /* @__PURE__ */ RegExp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
function Te(e, t) {
	return N.lastIndex = t, N.exec(e)[1] ?? "";
}
var Ee = class {
	message;
	position;
	...
	parseMessage(e, t, n) {
		...
		for (; !this.isEOF();) {
			...
			if (i === 123) {
				...
				if (n) break;
				return this.error(O.UNMATCHED_CLOSING_TAG, j(this.clonePosition(), this.clonePosition()));
			} else if (i === 60 && !this.ignoreTag && P(this.peek() || 0)) {
	...
	parseTag(e, t) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !P(this.char())) return this.error(O.INVALID_TAG, j(o, this.clonePosition()));
				let e = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					...
					err: null
				} : this.error(O.INVALID_TAG, j(o, this.clonePosition()))) : this.error(O.UNMATCHED_CLOSING_TAG, j(e, this.clonePosition()));
			} else return this.error(O.UNCLOSED_TAG, j(n, this.clonePosition()));
		} else return this.error(O.INVALID_TAG, j(n, this.clonePosition()));
	}
	parseTagName() {
		let e = this.offset();
	...
	parseArgument(e, t) {
		let n = this.clonePosition();
		if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(O.EXPECT_ARGUMENT_CLOSING_BRACE, j(n, this.clonePosition()));
		if (this.char() === 125) return this.bump(), this.error(O.EMPTY_ARGUMENT, j(n, this.clonePosition()));
		let r = this.parseIdentifierIfPossible().value;
		if (!r) return this.error(O.MALFORMED_ARGUMENT, j(n, this.clonePosition()));
		if (this.bumpSpace(), this.isEOF()) return this.error(O.EXPECT_ARGUMENT_CLOSING_BRACE, j(n, this.clonePosition()));
		switch (this.char()) {
			...
			case 44: return this.bump(), this.bumpSpace(), this.isEOF() ? this.error(O.EXPECT_ARGUMENT_CLOSING_BRACE, j(n, this.clonePosition())) : this.parseArgumentOptions(e, t, r, n);
			default: return this.error(O.MALFORMED_ARGUMENT, j(n, this.clonePosition()));
		}
	}
	parseIdentifierIfPossible() {
		let e = this.clonePosition(), t = this.offset(), n = Te(this.message, t), r = t + n.length;
	...
	parseArgumentOptions(e, t, n, r) {
		...
		switch (a) {
			case "": return this.error(O.EXPECT_ARGUMENT_TYPE, j(i, o));
			case "number":
			case "date":
			case "time": {
				this.bumpSpace();
				...
				if (this.bumpIf(",")) {
					...
					if (n.err) return n;
					let r = we(n.val);
					if (r.length === 0) return this.error(O.EXPECT_ARGUMENT_STYLE, j(this.clonePosition(), this.clonePosition()));
					e = {
						style: r,
				...
				if (e && e.style.startsWith("::")) {
					...
					if (a === "number") {
						...
						let r = t;
						this.locale && (r = ge(t, this.locale));
						let o = {
							type: w.dateTime,
							pattern: r,
			...
			case "select": {
				...
				if (this.bumpSpace(), !this.bumpIf(",")) return this.error(O.EXPECT_SELECT_ARGUMENT_OPTIONS, j(i, { ...i }));
				this.bumpSpace();
				let o = this.parseIdentifierIfPossible(), s = 0;
				if (a !== "select" && o.value === "offset") {
					if (!this.bumpIf(":")) return this.error(O.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, j(this.clonePosition(), this.clonePosition()));
					this.bumpSpace();
			...
			default: return this.error(O.INVALID_ARGUMENT_TYPE, j(i, o));
		}
	}
	tryParseArgumentClose(e) {
		return this.isEOF() || this.char() !== 125 ? this.error(O.EXPECT_ARGUMENT_CLOSING_BRACE, j(e, this.clonePosition())) : (this.bump(), {
			val: !0,
			err: null
		});
	}
	parseSimpleArgStyleIfPossible() {
		...
		for (; !this.isEOF();) switch (this.char()) {
			case 39: {
				this.bump();
				let e = this.clonePosition();
				if (!this.bumpUntil("'")) return this.error(O.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, j(e, this.clonePosition()));
				this.bump();
				break;
			}
			case 123:
	...
	tryParsePluralOrSelectOptions(e, t, n, r) {
		...
		for (;;) {
			...
			if (!this.bumpIf("{")) return this.error(t === "select" ? O.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT : O.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT, j(this.clonePosition(), this.clonePosition()));
		...
		return a.length === 0 ? this.error(t === "select" ? O.EXPECT_SELECT_ARGUMENT_SELECTOR : O.EXPECT_PLURAL_ARGUMENT_SELECTOR, j(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !i ? this.error(O.MISSING_OTHER_CLAUSE, j(this.clonePosition(), this.clonePosition())) : {
			val: a,
			err: null
		};
	}
...
function F(e) {
	e.forEach((e) => {
		if (delete e.location, fe(e) || pe(e)) for (let t in e.options) delete e.options[t].location, F(e.options[t].value);
		else le(e) && E(e.style) || (ue(e) || de(e)) && D(e.style) ? delete e.style.location : he(e) && F(e.children);
	});
}
function Ae(e, t = {}) {
	t = {
...
var I = /* @__PURE__ */ function(e) {
	...
	constructor(e, t, n, r) {
		super(`Invalid values for "${e}": "${t}". Options are "${Object.keys(n).join("\", \"")}"`, I.INVALID_VALUE, r);
	}
}, je = class extends L {
	constructor(e, t, n) {
		super(`Value for "${e}" must be of type ${t}`, I.INVALID_VALUE, n);
	}
}, Me = class extends L {
	constructor(e, t) {
		super(`The intl string context variable "${e}" was not provided to the string "${t}"`, I.MISSING_VALUE, t);
	}
...
function V(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (he(c)) {
			...
			if (!B(u)) throw new je(l, "function", o);
			let d = u(V(e, t, n, r, i, a).map((e) => e.value));
		...
		if (fe(c)) {
			...
			if (!a) throw new R(c.value, l, Object.keys(c.options), o);
			s.push(...V(a.value, t, n, r, i));
			continue;
		}
		if (pe(c)) {
			...
			s.push(...V(a.value, t, n, r, i, u - (c.offset || 0)));
			continue;
		}
	}
	return Ne(s);
...
function Fe(e, t) {
	return t ? Object.keys(e).reduce((n, r) => (n[r] = Pe(e[r], t[r]), n), { ...e }) : e;
}
function H(e) {
	return { create() {
		return {
...
function Ie(e = {
	...
	return {
		getNumberFormat: a((...e) => new Intl.NumberFormat(...e), {
			cache: H(e.number),
			strategy: g.variadic
		}),
		getDateTimeFormat: a((...e) => new Intl.DateTimeFormat(...e), {
			cache: H(e.dateTime),
			strategy: g.variadic
		}),
		getPluralRules: a((...e) => new Intl.PluralRules(...e), {
...
var U = class e {
	...
	constructor(t, n = e.defaultLocale, r, i) {
		...
		this.formats = Fe(e.formats, r), this.formatters = i && i.formatters || Ie(this.formatterCache);
	}
	format = (e) => {
		let t = this.formatToParts(e);
		if (t.length === 1) return t[0].value;
		let n = t.reduce((e, t) => (!e.length || t.type !== z.literal || typeof e[e.length - 1] != "string" ? e.push(t.value) : e[e.length - 1] += t.value, e), []);
		return n.length <= 1 ? n[0] || "" : n;
	};
	formatToParts = (e) => V(this.ast, this.locales, this.formatters, this.formats, e, void 0, this.message);
...
function We(e = Ue()) {
	let t = Intl.RelativeTimeFormat, n = Intl.ListFormat, r = Intl.DisplayNames, i = a((...e) => new Intl.DateTimeFormat(...e), {
		cache: Y(e.dateTime),
		strategy: g.variadic
	}), o = a((...e) => new Intl.NumberFormat(...e), {
		cache: Y(e.number),
		strategy: g.variadic
	}), s = a((...e) => new Intl.PluralRules(...e), {
	...
	return {
		getDateTimeFormat: i,
		getNumberFormat: o,
		getMessageFormat: a((e, t, n, r) => new U(e, t, n, {
			formatters: {
				getNumberFormat: o,
				getDateTimeFormat: i,
				getPluralRules: s
		...
		getRelativeTimeFormat: a((...e) => new t(...e), {
			cache: Y(e.relativeTime),
			strategy: g.variadic
		}),
		getPluralRules: s,
		getListFormat: a((...e) => new n(...e), {
			cache: Y(e.list),
			strategy: g.variadic
		}),
		getDisplayNames: a((...e) => new r(...e), {
...
function Ke(e, t) {
	...
	return {
		...n,
		...e,
		date: Ge(Z(n.date, t), Z(e.date || {}, t)),
		time: Ge(Z(n.time, t), Z(e.time || {}, t))
	};
}
var Q = ({ locale: e, formats: t, messages: n, defaultLocale: r, defaultFormats: i, fallbackOnEmptyString: a, onError: o, timeZone: s, defaultRichTextElements: c }, l, u = { id: "" }, d, f) => {
	...
	Ve(!!p, "[@formatjs/intl] An `id` must be provided to format a message. You can either:\n1. Configure your build toolchain with [babel-plugin-formatjs](https://formatjs.github.io/docs/tooling/babel-plugin)\nor [@formatjs/ts-transformer](https://formatjs.github.io/docs/tooling/ts-transformer) OR\n2. Configure your `eslint` config to include [eslint-plugin-formatjs](https://formatjs.github.io/docs/tooling/linter#enforce-id)\nto autofix this issue");
	...
	if (d = {
		...
		if (a === !1 && g === "") return g;
		if ((!m || e && e.toLowerCase() !== r.toLowerCase()) && o(new Be(u, e)), m) try {
...
function et({ locale: e, onError: t }, n, r, i) {
	Intl.DisplayNames || t(new L("Intl.DisplayNames is not available in this environment.\nTry polyfilling it using \"@formatjs/intl-displaynames\"\n", I.MISSING_INTL_API));
	let a = J(i, $e);
	try {
		return n(e, a).of(r);
	} catch (n) {
...
var tt = ["type", "style"], nt = Date.now();
function rt(e) {
	return `${nt}_${e}_${nt}`;
}
function it(e, t, n, r = {}) {
	let i = at(e, t, n, r).reduce((e, t) => {
		let n = t.value;
...
function at({ locale: e, onError: t }, n, r, i = {}) {
	Intl.ListFormat || t(new L("Intl.ListFormat is not available in this environment.\nTry polyfilling it using \"@formatjs/intl-listformat\"\n", I.MISSING_INTL_API));
	let a = J(i, tt);
	try {
...
function st({ locale: e, onError: t }, n, r, i = {}) {
	Intl.PluralRules || t(new L("Intl.PluralRules is not available in this environment.\nTry polyfilling it using \"@formatjs/intl-pluralrules\"\n", I.MISSING_INTL_API));
	let a = J(i, ot);
	try {
...
function lt({ locale: e, formats: t, onError: n }, r, i = {}) {
	let { format: a } = i;
	return r(e, J(i, ct, !!a && X(t, "relative", a, n) || {}));
}
function ut(e, t, n, r, i = {}) {
	r ||= "second", Intl.RelativeTimeFormat || e.onError(new L("Intl.RelativeTimeFormat is not available in this environment.\nTry polyfilling it using \"@formatjs/intl-relativetimeformat\"\n", I.MISSING_INTL_API));
	try {
		return lt(e, t, i).format(n, r);
	} catch (t) {
...
function ft({ locale: e, formats: t, onError: n }, r, i = {}) {
	let { format: a } = i;
	return r(e, J(i, dt, a && X(t, "number", a, n) || {}));
}
function pt(e, t, n, r = {}) {
	try {
		return ft(e, t, r).format(n);
	} catch (t) {
...
function mt(e, t, n, r = {}) {
	try {
		return ft(e, t, r).formatToParts(n);
	} catch (t) {
		e.onError(new K("Error formatting number.", e.locale, t));
	}
	return [];
...
function gt(e) {
	e.onWarn && e.defaultRichTextElements && ht(e.messages || {}) && e.onWarn("[@formatjs/intl] \"defaultRichTextElements\" was specified but \"message\" was not pre-compiled. \nPlease consider using \"@formatjs/cli\" to pre-compile your messages for performance.\nFor more details see https://formatjs.github.io/docs/getting-started/message-distribution");
}
function _t(e, t) {
	let n = We(t), r = {
		...He,
	...
	return i ? !Intl.NumberFormat.supportedLocalesOf(i).length && o ? o(new ze(`Missing locale data for locale: "${i}" in Intl.NumberFormat. Using default locale: "${a}" as fallback. See https://formatjs.github.io/docs/react-intl#runtime-requirements for more details`)) : !Intl.DateTimeFormat.supportedLocalesOf(i).length && o && o(new ze(`Missing locale data for locale: "${i}" in Intl.DateTimeFormat. Using default locale: "${a}" as fallback. See https://formatjs.github.io/docs/react-intl#runtime-requirements for more details`)) : (o && o(new Re(`"locale" was not configured, using "${a}" as fallback. See https://formatjs.github.io/docs/react-intl/api#intlshape for more details`)), r.locale = r.defaultLocale || "en"), gt(r), {
		...r,
		formatters: n,
		formatNumber: pt.bind(null, r, n.getNumberFormat),
		formatNumberToParts: mt.bind(null, r, n.getNumberFormat),
		formatRelativeTime: ut.bind(null, r, n.getRelativeTimeFormat),
		formatDate: Je.bind(null, r, n.getDateTimeFormat),
		formatDateToParts: Ze.bind(null, r, n.getDateTimeFormat),
		formatTime: Ye.bind(null, r, n.getDateTimeFormat),
		formatDateTimeRange: Xe.bind(null, r, n.getDateTimeFormat),
		...
		$t: Q.bind(null, r, n),
		formatList: it.bind(null, r, n.getListFormat),
		formatListToParts: at.bind(null, r, n.getListFormat),
		formatDisplayName: et.bind(null, r, n.getDisplayNames)
	};
}
//#endregion
//#region ../../node_modules/.bun/react-intl@10.1.1+b2e33729a97476bf/node_modules/react-intl/src/utils.js
function vt(e, t, n = Error) {
	if (!e) throw new n(t);
}
function yt(e) {
	vt(e, "[React Intl] Could not find required `intl` object. <IntlProvider> needs to exist in the component ancestry.");
}
var bt = {
	...He,
	textComponent: e.Fragment
}, xt = (t) => e.Children.toArray(t).map((t, n) => e.isValidElement(t) ? /* @__PURE__ */ r(e.Fragment, { children: t }, n) : t);
function St(e) {
	return function(t) {
		return e(xt(t));
	};
...
var wt = e.createContext(null), Tt = wt.Provider;
//#endregion
...
function Dt(e) {
	return e && Object.keys(e).reduce((t, n) => {
		let r = e[n];
		return t[n] = B(r) ? St(r) : r, t;
	}, {});
}
var Ot = (e, t, n, r, ...i) => {
	let a = Q(e, t, n, Dt(r), ...i);
	return Array.isArray(a) ? xt(a) : a;
}, kt = ({ defaultRichTextElements: e, ...t }, n) => {
	let r = Dt(e), i = _t({
		...bt,
		...t,
	...
	return {
		...i,
		formatMessage: Ot.bind(null, a, i.formatters),
		$t: Ot.bind(null, a, i.formatters)
	};
};
//#endregion
...
function jt(t) {
	let n = e.useRef(Ue()), i = e.useRef(void 0), a = e.useRef(void 0), o = {};
	for (let e in t) t[e] !== void 0 && (o[e] = t[e]);
	let s = At({
		...bt,
		...o
	});
	return (!i.current || !Ct(i.current, s)) && (i.current = s, a.current = kt(s, n.current)), yt(a.current), /* @__PURE__ */ r(Tt, {
		value: a.current,
		children: t.children
	});
}
...
function Nt() {
	...
	return /* @__PURE__ */ r("div", {
		...
		children: [
			{
				title: e.formatMessage({ id: "blog-list.comparingI18nLibrariesIn2026" }),
				date: "March 15, 2026",
				excerpt: e.formatMessage({ id: "blog-list.weTested12DifferentInternationalization" }),
				category: "Benchmark"
			},
			{
				title: e.formatMessage({ id: "blog-list.howToReduceYourI18n" }),
				date: e.formatMessage({ id: "blog-list.march82026" }),
				excerpt: e.formatMessage({ id: "blog-list.practicalStrategiesForOptimizingTranslation" }),
				category: "Tutorial"
			},
			{
				title: e.formatMessage({ id: "blog-list.theStateOfInternationalizationIn" }),
				date: e.formatMessage({ id: "blog-list.february282026" }),
				excerpt: e.formatMessage({ id: "blog-list.anOverviewOfTheCurrent" }),
				category: "Analysis"
			},
			{
				title: e.formatMessage({ id: "blog-list.migratingFromReactI18nextTo" }),
				date: e.formatMessage({ id: "blog-list.february152026" }),
				excerpt: e.formatMessage({ id: "blog-list.aStepByStepGuide" }),
				category: "Tutorial"
			},
			{
				title: e.formatMessage({ id: "blog-list.serverComponentsAndI18nWhat" }),
				date: e.formatMessage({ id: "blog-list.february12026" }),
				excerpt: e.formatMessage({ id: "blog-list.reactServerComponentsIntroduceNew" }),
				category: "Analysis"
			},
			{
				title: e.formatMessage({ id: "blog-list.benchmarkMethodologyHowWeTest" }),
				date: e.formatMessage({ id: "blog-list.january202026" }),
				excerpt: e.formatMessage({ id: "blog-list.aTransparentLookAtOur" }),
				category: "Meta"
			}
		].map((t) => /* @__PURE__ */ i("article", {
			...
			children: [
				...
				/* @__PURE__ */ r("button", {
					...
					children: e.formatMessage({ id: "blog-list.readMore" })
				})
			]
		}, t.title))
	});
...
async function Ft(e, t = ["shared", "route"]) {
	let n = {};
	for (let r of t) try {
		let t = await Pt(/* @__PURE__ */ Object.assign({
			"../messages/de/about.json": () => import("./about-HDm7viGi.js"),
			"../messages/de/blog.json": () => import("./blog-CZMa41W-.js"),
			"../messages/de/careers.json": () => import("./careers-DWYtvrQf.js"),
			"../messages/de/contact.json": () => import("./contact-CAZt9-4b.js"),
			"../messages/de/faq.json": () => import("./faq-Cl3OlMk8.js"),
			"../messages/de/home.json": () => import("./home-D7AAXDkb.js"),
			"../messages/de/pricing.json": () => import("./pricing-CmmVENw5.js"),
			"../messages/de/products.json": () => import("./products-CdhOXV6x.js"),
			"../messages/de/route.json": () => import("./route-BJYwpKaB.js"),
			"../messages/de/settings.json": () => import("./settings-CqxjCyXW.js"),
			"../messages/de/shared.json": () => import("./shared-C68cCmuJ.js"),
			"../messages/de/team.json": () => import("./team-rf9FazQA.js"),
			"../messages/en/about.json": () => import("./about-BOJxCtTo.js"),
			"../messages/en/blog.json": () => import("./blog-D5-DPyed.js"),
			"../messages/en/careers.json": () => import("./careers-DSyykKip.js"),
			"../messages/en/contact.json": () => import("./contact-ChUyr_oH.js"),
			"../messages/en/faq.json": () => import("./faq-of8iQW6W.js"),
			"../messages/en/home.json": () => import("./home-DSU6b_Rs.js"),
			"../messages/en/pricing.json": () => import("./pricing-BwnG5NPQ.js"),
			"../messages/en/products.json": () => import("./products-9nfCOGFR.js"),
			"../messages/en/route.json": () => import("./route-Cqyal_iP.js"),
			"../messages/en/settings.json": () => import("./settings-4I_tg8Yy.js"),
			"../messages/en/shared.json": () => import("./shared-CpCeR2rM.js"),
			"../messages/en/team.json": () => import("./team-B-nxoAnS.js"),
			"../messages/es/about.json": () => import("./about-IbJJLooc.js"),
			"../messages/es/blog.json": () => import("./blog-CWprEaSv.js"),
			"../messages/es/careers.json": () => import("./careers-CG_kxBHK.js"),
			"../messages/es/contact.json": () => import("./contact-CtSq4PWi.js"),
			"../messages/es/faq.json": () => import("./faq-DkZr5tCy.js"),
			"../messages/es/home.json": () => import("./home-YHBoaeB2.js"),
			"../messages/es/pricing.json": () => import("./pricing-BfKVKUl9.js"),
			"../messages/es/products.json": () => import("./products-ZAv30Pxv.js"),
			"../messages/es/route.json": () => import("./route-Dooz2jmc.js"),
			"../messages/es/settings.json": () => import("./settings-P1H-Hqkw.js"),
			"../messages/es/shared.json": () => import("./shared-CwUqepZV.js"),
			"../messages/es/team.json": () => import("./team-BA--H0W4.js"),
			"../messages/fr/about.json": () => import("./about-tagoBjQV.js"),
			"../messages/fr/blog.json": () => import("./blog-BitqBv_5.js"),
			"../messages/fr/careers.json": () => import("./careers-WjAlThYD.js"),
			"../messages/fr/contact.json": () => import("./contact-CEjV0b-n.js"),
			"../messages/fr/faq.json": () => import("./faq-gHMcpzM9.js"),
			"../messages/fr/home.json": () => import("./home-lO9uo-1q.js"),
			"../messages/fr/pricing.json": () => import("./pricing-rzmO4kWK.js"),
			"../messages/fr/products.json": () => import("./products-CJ7OwREX.js"),
			"../messages/fr/route.json": () => import("./route-BduywQoH.js"),
			"../messages/fr/settings.json": () => import("./settings-BBrtgIpw.js"),
			"../messages/fr/shared.json": () => import("./shared-BSNLGB2A.js"),
			"../messages/fr/team.json": () => import("./team-C5nNE9vb.js"),
			"../messages/it/about.json": () => import("./about-DGu7Uw9N.js"),
			"../messages/it/blog.json": () => import("./blog-U83brWSu.js"),
			"../messages/it/careers.json": () => import("./careers-CN2MqDqz.js"),
			"../messages/it/contact.json": () => import("./contact-BCcQj4S-.js"),
			"../messages/it/faq.json": () => import("./faq-BiEuxxNf.js"),
			"../messages/it/home.json": () => import("./home-BFRnktVB.js"),
			"../messages/it/pricing.json": () => import("./pricing-CplYS0t0.js"),
			"../messages/it/products.json": () => import("./products-CyvPtwuy.js"),
			"../messages/it/route.json": () => import("./route-C475vOOn.js"),
			"../messages/it/settings.json": () => import("./settings-DI3PwbxC.js"),
			"../messages/it/shared.json": () => import("./shared-DTSOFQeH.js"),
			"../messages/it/team.json": () => import("./team-BPqFpZqr.js"),
			"../messages/ja/about.json": () => import("./about-DyQf--Bt.js"),
			"../messages/ja/blog.json": () => import("./blog-CUPCMhCI.js"),
			"../messages/ja/careers.json": () => import("./careers-kdiCyMDW.js"),
			"../messages/ja/contact.json": () => import("./contact-irAyr9Fn.js"),
			"../messages/ja/faq.json": () => import("./faq-hI_oHB2C.js"),
			"../messages/ja/home.json": () => import("./home-Cqavn2WU.js"),
			"../messages/ja/pricing.json": () => import("./pricing-C9Vl6u28.js"),
			"../messages/ja/products.json": () => import("./products-CMsNy-a7.js"),
			"../messages/ja/route.json": () => import("./route-BEc4TR4L.js"),
			"../messages/ja/settings.json": () => import("./settings-BJZcy0qo.js"),
			"../messages/ja/shared.json": () => import("./shared-B-CODxP-.js"),
			"../messages/ja/team.json": () => import("./team-3w6ApgXI.js"),
			"../messages/ko/about.json": () => import("./about-CrXP5hNo.js"),
			"../messages/ko/blog.json": () => import("./blog-HS14RjgR.js"),
			"../messages/ko/careers.json": () => import("./careers-CI6VRXme.js"),
			"../messages/ko/contact.json": () => import("./contact-WnFRxoUf.js"),
			"../messages/ko/faq.json": () => import("./faq-Bn8MlAIy.js"),
			"../messages/ko/home.json": () => import("./home-CSPGR7EV.js"),
			"../messages/ko/pricing.json": () => import("./pricing-BnwCXXUY.js"),
			"../messages/ko/products.json": () => import("./products-CibAh7S-.js"),
			"../messages/ko/route.json": () => import("./route--rK6R6jL.js"),
			"../messages/ko/settings.json": () => import("./settings-B-3gAu3w.js"),
			"../messages/ko/shared.json": () => import("./shared-Bg06lTHH.js"),
			"../messages/ko/team.json": () => import("./team-DtZC-1ku.js"),
			"../messages/pt/about.json": () => import("./about-BQuO9tUt.js"),
			"../messages/pt/blog.json": () => import("./blog-DMGMgbPp.js"),
			"../messages/pt/careers.json": () => import("./careers-dcfuXLS2.js"),
			"../messages/pt/contact.json": () => import("./contact-0gfF9cJw.js"),
			"../messages/pt/faq.json": () => import("./faq-CYpep7ID.js"),
			"../messages/pt/home.json": () => import("./home-CiZ12rOh.js"),
			"../messages/pt/pricing.json": () => import("./pricing-1BzhPu35.js"),
			"../messages/pt/products.json": () => import("./products-wb9H8Lf4.js"),
			"../messages/pt/route.json": () => import("./route-SdNhvxn1.js"),
			"../messages/pt/settings.json": () => import("./settings-dALWI6Jy.js"),
			"../messages/pt/shared.json": () => import("./shared-BhGTk7Qj.js"),
			"../messages/pt/team.json": () => import("./team-Bh1GCxWp.js"),
			"../messages/ru/about.json": () => import("./about-BHesSXoo.js"),
			"../messages/ru/blog.json": () => import("./blog-Cje6H7RQ.js"),
			"../messages/ru/careers.json": () => import("./careers-6b3ko2_G.js"),
			"../messages/ru/contact.json": () => import("./contact-0Vr-SWQL.js"),
			"../messages/ru/faq.json": () => import("./faq-DjzBsl9k.js"),
			"../messages/ru/home.json": () => import("./home-CKPEcg6m.js"),
			"../messages/ru/pricing.json": () => import("./pricing-sxYl5S7t.js"),
			"../messages/ru/products.json": () => import("./products-NCH4ygqQ.js"),
			"../messages/ru/route.json": () => import("./route-K3J_b504.js"),
			"../messages/ru/settings.json": () => import("./settings-DS-icF8U.js"),
			"../messages/ru/shared.json": () => import("./shared-D2S49vkc.js"),
			"../messages/ru/team.json": () => import("./team-DfWe-gQT.js"),
			"../messages/zh/about.json": () => import("./about-BmyEYR_1.js"),
			"../messages/zh/blog.json": () => import("./blog-0aXQ-xXQ.js"),
			"../messages/zh/careers.json": () => import("./careers-BsSgaFQL.js"),
			"../messages/zh/contact.json": () => import("./contact-CVBBQMFf.js"),
			"../messages/zh/faq.json": () => import("./faq-DJCESlug.js"),
			"../messages/zh/home.json": () => import("./home-BURwUXwe.js"),
			"../messages/zh/pricing.json": () => import("./pricing-DR7icgMu.js"),
			"../messages/zh/products.json": () => import("./products-CKNJZP3n.js"),
			"../messages/zh/route.json": () => import("./route-7YwLn3-j.js"),
			"../messages/zh/settings.json": () => import("./settings-BN_gpBbE.js"),
			"../messages/zh/shared.json": () => import("./shared-KmxoeIbw.js"),
			"../messages/zh/team.json": () => import("./team-BX9lkbNR.js")
		}), `../messages/${e}/${r}.json`, 4);
...
function Rt() {
	return /* @__PURE__ */ r(Lt, { children: /* @__PURE__ */ r(Nt, {}) });
}
//#endregion
export { Rt as default };
//#region src/messages/ru/about.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/about.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/pt/about.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/zh/about.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ko/about.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/it/about.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ja/about.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/de/about.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/es/about.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/fr/about.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/zh/blog.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/fr/blog.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ja/blog.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/es/blog.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/de/blog.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ru/blog.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/blog.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/pt/blog.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ko/blog.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/it/blog.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ru/careers.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/zh/careers.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/es/careers.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ko/careers.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/it/careers.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/careers.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/de/careers.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/fr/careers.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/pt/careers.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ja/careers.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ru/contact.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/pt/contact.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/it/contact.json
var e = {
	"contact-form.name": "Nome",
...
//#endregion
export { e as default };
//#region src/messages/de/contact.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/fr/contact.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/zh/contact.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/contact.json
var e = {
	"contact-form.name": "Name",
...
//#endregion
export { e as default };
//#region src/messages/es/contact.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ko/contact.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ja/contact.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/it/faq.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ko/faq.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/pt/faq.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/de/faq.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/zh/faq.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ru/faq.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/es/faq.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/fr/faq.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ja/faq.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/faq.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/it/home.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/zh/home.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ru/home.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ko/home.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/pt/home.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ja/home.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/de/home.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/home.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/es/home.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/fr/home.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/pt/pricing.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/es/pricing.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ko/pricing.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/pricing.json
var e = {
	"pricing-tiers.starter": "Starter",
	"pricing-tiers.price0": "$0",
...
//#endregion
export { e as default };
//#region src/messages/ja/pricing.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/de/pricing.json
var e = {
	"pricing-tiers.starter": "Starter",
	"pricing-tiers.price0": "0 $",
...
//#endregion
export { e as default };
//#region src/messages/it/pricing.json
var e = {
	"pricing-tiers.starter": "Starter",
	"pricing-tiers.price0": "0 $",
...
//#endregion
export { e as default };
//#region src/messages/zh/pricing.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/fr/pricing.json
var e = {
	"pricing-tiers.starter": "Starter",
	"pricing-tiers.price0": "0 $",
...
//#endregion
export { e as default };
//#region src/messages/ru/pricing.json
var e = {
	"pricing-tiers.starter": "Starter",
	"pricing-tiers.price0": "0 $",
...
//#endregion
export { e as default };
//#region src/messages/en/products.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/fr/products.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/zh/products.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ja/products.json
var e = {
	"products-grid.benchmarkCli": "Benchmark CLI",
...
//#endregion
export { e as default };
//#region src/messages/de/products.json
var e = {
	"products-grid.benchmarkCli": "Benchmark CLI",
...
//#endregion
export { e as default };
//#region src/messages/ko/products.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/it/products.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ru/products.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/es/products.json
var e = {
	"products-grid.benchmarkCli": "CLI de Benchmark",
...
//#endregion
export { e as default };
//#region src/messages/pt/products.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ko/route.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/zh/route.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ja/route.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/de/route.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/fr/route.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/it/route.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/route.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/es/route.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ru/route.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/pt/route.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/settings.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ko/settings.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/fr/settings.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ja/settings.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/zh/settings.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/de/settings.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/it/settings.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ru/settings.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/es/settings.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/pt/settings.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ja/shared.json
var e = {
	"header.home": "ホーム",
...
//#endregion
export { e as default };
//#region src/messages/fr/shared.json
var e = {
	"header.home": "Accueil",
	...
	"mock-banner.mockBanner": "⚠️ Cette page contient des données fictives à des fins de benchmarking uniquement. Elle n'est liée à aucune entreprise ou service réel."
};
//#endregion
export { e as default };
//#region src/messages/ko/shared.json
var e = {
	"header.home": "홈",
...
//#endregion
export { e as default };
//#region src/messages/pt/shared.json
var e = {
	"header.home": "Início",
...
//#endregion
export { e as default };
//#region src/messages/de/shared.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/shared.json
var e = {
	"header.home": "Home",
...
//#endregion
export { e as default };
//#region src/messages/es/shared.json
var e = {
	"header.home": "Inicio",
...
//#endregion
export { e as default };
//#region src/messages/ru/shared.json
var e = {
	"header.home": "Главная",
...
//#endregion
export { e as default };
//#region src/messages/it/shared.json
var e = {
	"header.home": "Home",
	"header.methodology": "Metodologia",
...
//#endregion
export { e as default };
//#region src/messages/zh/shared.json
var e = {
	"header.home": "首页",
...
//#endregion
export { e as default };
//#region src/messages/ja/team.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/en/team.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/es/team.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/it/team.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/zh/team.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/pt/team.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/fr/team.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ru/team.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/ko/team.json
var e = {
...
//#endregion
export { e as default };
//#region src/messages/de/team.json
var e = {
