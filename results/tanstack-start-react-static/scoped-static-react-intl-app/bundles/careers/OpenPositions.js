	...
	const openings = [
		{
			...
			desc: intl.formatMessage({ id: "open-positions.buildAndMaintainOurBenchmarking" })
		},
		{
			...
			type: intl.formatMessage({ id: "open-positions.fullTime" }),
			dept: intl.formatMessage({ id: "open-positions.engineering" }),
			desc: intl.formatMessage({ id: "open-positions.designAndScaleOurCloud" })
		},
		{
			...
			desc: intl.formatMessage({ id: "open-positions.createComprehensiveGuidesApiReferences" })
		},
		{
			...
			desc: intl.formatMessage({ id: "open-positions.engageWithTheI18nCommunity" })
		},
		{
			...
			type: intl.formatMessage({ id: "open-positions.fullTime" }),
			dept: intl.formatMessage({ id: "open-positions.engineering" }),
			desc: intl.formatMessage({ id: "open-positions.ensureTheAccuracyAndReliability" })
		}
	];
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("h2", {
		className: "mb-6 text-2xl font-bold text-foreground",
		children: intl.formatMessage({ id: "open-positions.openPositions" })
	}), /* @__PURE__ */ jsx("div", {
		className: "space-y-4",
		children: openings.map((o) => /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [
				...
				children: intl.formatMessage({ id: "open-positions.applyNow" })
			})]
		}, o.title))
	})] });
}
