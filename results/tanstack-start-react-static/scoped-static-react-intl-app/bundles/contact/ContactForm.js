		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
					...
					children: intl.formatMessage({ id: "contact-form.name" })
				}), /* @__PURE__ */ jsx("input", {
					id: nameId,
					...
					htmlFor: emailId,
					className: "mb-1 block text-sm font-medium text-foreground",
					children: intl.formatMessage({ id: "contact-form.email" })
				}), /* @__PURE__ */ jsx("input", {
					id: emailId,
					type: "email",
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
				htmlFor: topicId,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: intl.formatMessage({ id: "contact-form.topic" })
			}), /* @__PURE__ */ jsxs("select", {
				id: topicId,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				children: [
					/* @__PURE__ */ jsx("option", { children: intl.formatMessage({ id: "contact-form.bugReport" }) }),
					/* @__PURE__ */ jsx("option", { children: intl.formatMessage({ id: "contact-form.newBenchmarkIdea" }) }),
					/* @__PURE__ */ jsx("option", { children: intl.formatMessage({ id: "contact-form.methodologyQuestion" }) }),
					/* @__PURE__ */ jsx("option", { children: intl.formatMessage({ id: "contact-form.contribution" }) }),
					/* @__PURE__ */ jsx("option", { children: intl.formatMessage({ id: "contact-form.other" }) })
				]
			})] }),
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
				htmlFor: messageId,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: intl.formatMessage({ id: "contact-form.message" })
			}), /* @__PURE__ */ jsx("textarea", {
				id: messageId,
				rows: 5,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: intl.formatMessage({ id: "contact-form.describeYourQuestionOrIdea" })
			})] }),
			/* @__PURE__ */ jsx("button", {
				type: "submit",
				className: "rounded-md bg-primary px-6 py-2.5 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity",
				children: intl.formatMessage({ id: "contact-form.sendMessage" })
			})
		]
	});
}
