...
function Mt(t) {
	...
	return (!r.current || !wt(r.current, s)) && (r.current = s, a.current = At(s, n.current)), bt(a.current), /* @__PURE__ */ i(Et, {
		value: a.current,
		children: t.children
	});
}
	...
	return /* @__PURE__ */ a("form", {
		...
		children: [
			...
			/* @__PURE__ */ a("div", { children: [/* @__PURE__ */ i("label", {
				...
				children: [
					/* @__PURE__ */ i("option", { children: e.formatMessage({ id: "contact-form.bugReport" }) }),
					/* @__PURE__ */ i("option", { children: e.formatMessage({ id: "contact-form.newBenchmarkIdea" }) }),
					/* @__PURE__ */ i("option", { children: e.formatMessage({ id: "contact-form.methodologyQuestion" }) }),
					/* @__PURE__ */ i("option", { children: e.formatMessage({ id: "contact-form.contribution" }) }),
					/* @__PURE__ */ i("option", { children: e.formatMessage({ id: "contact-form.other" }) })
				]
			})] }),
			/* @__PURE__ */ a("div", { children: [/* @__PURE__ */ i("label", {
				htmlFor: s,
...
async function It(e, t = ["shared", "route"]) {
	let n = {};
	for (let r of t) try {
		let t = await Ft(/* @__PURE__ */ Object.assign({
...
function zt() {
	return /* @__PURE__ */ i(Rt, { children: /* @__PURE__ */ i(Pt, {}) });
}
//#endregion
