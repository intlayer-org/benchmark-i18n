	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("p", {
				...
				children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "hero.aTestApplicationDesignedTo" })
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("button", {
					...
					children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "hero.viewResults" })
				}), /* @__PURE__ */ jsx("button", {
					type: "button",
					className: "rounded-lg border border-border px-6 py-3 text-sm font-medium text-foreground hover:bg-accent transition-colors",
					children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "header.methodology" })
				})]
			})
		]
	});
