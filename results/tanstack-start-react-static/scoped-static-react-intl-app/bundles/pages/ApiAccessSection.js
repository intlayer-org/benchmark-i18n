...
function ApiAccessSection() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("h2", {
			...
			children: intl.formatMessage({ id: "api-access-section.apiAccess" })
		}), /* @__PURE__ */ jsxs("div", { children: [
			/* @__PURE__ */ jsx("label", {
				htmlFor: apiKeyId,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: intl.formatMessage({ id: "api-access-section.apiKey" })
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("input", {
					...
					children: intl.formatMessage({ id: "api-access-section.copy" })
				})]
			}),
			/* @__PURE__ */ jsx("p", {
				className: "mt-1 text-xs text-muted-foreground",
				children: intl.formatMessage({ id: "api-access-section.useThisKeyToAccess" })
			})
		] })]
	});
}
