...
function BlogList() {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: [
			{
				title: intl.formatMessage({ id: "blog-list.comparingI18nLibrariesIn2026" }),
				date: "March 15, 2026",
				excerpt: intl.formatMessage({ id: "blog-list.weTested12DifferentInternationalization" }),
				category: "Benchmark"
			},
			{
				title: intl.formatMessage({ id: "blog-list.howToReduceYourI18n" }),
				date: intl.formatMessage({ id: "blog-list.march82026" }),
				excerpt: intl.formatMessage({ id: "blog-list.practicalStrategiesForOptimizingTranslation" }),
				category: "Tutorial"
			},
			{
			...
			children: [
				...
				/* @__PURE__ */ jsx("button", {
					...
					children: intl.formatMessage({ id: "blog-list.readMore" })
				})
			]
		}, p.title))
	});
