		...
		children: [
			{
				...
				value: intl.formatMessage({ id: "careers-benefits.workFromAnywhereInThe" })
			},
			{
				label: intl.formatMessage({ id: "careers-benefits.competitivePay" }),
				value: intl.formatMessage({ id: "careers-benefits.topOfMarketCompensation" })
			},
			{
...
function Wrapped() {
	return /* @__PURE__ */ jsx(Wrapper, { children: /* @__PURE__ */ jsx(CareersBenefits, {}) });
}
//#endregion
