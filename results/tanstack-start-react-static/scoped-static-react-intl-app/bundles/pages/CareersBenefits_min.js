...
function Nt() {
	...
	return /* @__PURE__ */ r("div", {
		...
		children: [
			{
				label: e.formatMessage({ id: "careers-benefits.remoteFirst" }),
				value: e.formatMessage({ id: "careers-benefits.workFromAnywhereInThe" })
			},
			{
				label: e.formatMessage({ id: "careers-benefits.competitivePay" }),
				value: e.formatMessage({ id: "careers-benefits.topOfMarketCompensation" })
			},
			{
				label: e.formatMessage({ id: "careers-benefits.openSourceTime" }),
