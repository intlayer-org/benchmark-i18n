...
function Nt() {
	...
	return /* @__PURE__ */ r("div", {
		...
		children: [
			{
				q: e.formatMessage({ id: "faq-list.whatIsI18nBenchmark" }),
				a: e.formatMessage({ id: "faq-list.whatIsI18nBenchmarkAnswer" })
			},
			{
				q: e.formatMessage({ id: "faq-list.howAreBenchmarksConducted" }),
				a: e.formatMessage({ id: "faq-list.weRunStandardizedTestsIn" })
			},
			{
				q: e.formatMessage({ id: "faq-list.whichLibrariesAreCurrentlySupported" }),
				a: e.formatMessage({ id: "faq-list.weSupportReactI18nextReact" })
			},
			{
				q: e.formatMessage({ id: "faq-list.canISubmitMyOwn" }),
				a: e.formatMessage({ id: "faq-list.yesCommunityBenchmarkSubmissionsAre" })
			},
			{
				q: e.formatMessage({ id: "faq-list.howOftenAreBenchmarksUpdated" }),
				a: e.formatMessage({ id: "faq-list.weReRunAllBenchmarks" })
			},
			{
				q: e.formatMessage({ id: "faq-list.isTheDataReliable" }),
				a: e.formatMessage({ id: "faq-list.weFollowRigorousStatisticalMethodology" })
			},
			{
				q: e.formatMessage({ id: "faq-list.doYouOfferConsultingServices" }),
				a: e.formatMessage({ id: "faq-list.yesOurEnterprisePlanIncludes" })
			},
			{
				q: e.formatMessage({ id: "faq-list.howCanIContribute" }),
				a: e.formatMessage({ id: "faq-list.thereAreManyWaysTo" })
			}
		].map((e) => /* @__PURE__ */ i("details", {
