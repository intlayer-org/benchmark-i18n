		...
		children: [
			{
				...
				desc: intl.formatMessage({ id: "products-grid.runBenchmarksLocallyFromYour" }),
				price: "Free"
			},
			{
				name: intl.formatMessage({ id: "products-grid.benchmarkCloud" }),
				desc: intl.formatMessage({ id: "products-grid.automatedCloudBasedBenchmarkingWith" }),
				price: "$29/mo"
			},
			{
				name: intl.formatMessage({ id: "products-grid.benchmarkEnterprise" }),
				desc: intl.formatMessage({ id: "products-grid.onPremiseDeploymentWithSso" }),
			...
			},
			{
				...
				desc: intl.formatMessage({ id: "products-grid.automatedQualityChecksForMissing" }),
				price: "$19/mo"
			},
			{
				name: intl.formatMessage({ id: "products-grid.bundleOptimizer" }),
				desc: intl.formatMessage({ id: "products-grid.analyzesAndOptimizesYourI18n" }),
				price: "$49/mo"
			}
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
				...
				children: [/* @__PURE__ */ jsx("span", {
					...
					children: intl.formatMessage({ id: "products-grid.learnMore" })
				})]
			})]
		}, p.name))
	});
