...
function Nt() {
	...
	return /* @__PURE__ */ r("div", {
		...
		children: [
			{
				name: e.formatMessage({ id: "products-grid.benchmarkCli" }),
				desc: e.formatMessage({ id: "products-grid.runBenchmarksLocallyFromYour" }),
				price: "Free"
			},
			{
				name: e.formatMessage({ id: "products-grid.benchmarkCloud" }),
				desc: e.formatMessage({ id: "products-grid.automatedCloudBasedBenchmarkingWith" }),
				price: "$29/mo"
			},
			{
				name: e.formatMessage({ id: "products-grid.benchmarkEnterprise" }),
				desc: e.formatMessage({ id: "products-grid.onPremiseDeploymentWithSso" }),
				price: e.formatMessage({ id: "products-grid.contactUs" })
			},
			{
				name: e.formatMessage({ id: "products-grid.migrationAssistant" }),
				desc: e.formatMessage({ id: "products-grid.aiPoweredToolThatHelps" }),
				price: "$99 one-time"
			},
			{
				name: e.formatMessage({ id: "products-grid.translationQa" }),
				desc: e.formatMessage({ id: "products-grid.automatedQualityChecksForMissing" }),
				price: "$19/mo"
			},
			{
				name: e.formatMessage({ id: "products-grid.bundleOptimizer" }),
				desc: e.formatMessage({ id: "products-grid.analyzesAndOptimizesYourI18n" }),
				price: "$49/mo"
			}
		].map((t) => /* @__PURE__ */ i("div", {
			className: "flex flex-col justify-between rounded-lg border border-border bg-card p-6",
			children: [/* @__PURE__ */ i("div", { children: [/* @__PURE__ */ r("h3", {
				...
				children: [/* @__PURE__ */ r("span", {
					...
					children: e.formatMessage({ id: "products-grid.learnMore" })
				})]
			})]
		}, t.name))
	});
