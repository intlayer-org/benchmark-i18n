	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			/* @__PURE__ */ jsx("h2", {
				...
				children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "understanding-impact.understandingTheImpact" })
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("h3", {
						...
						children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "understanding-impact.whyASingleLargeJson" })
					}),
					/* @__PURE__ */ jsx("p", {
						className: "text-sm text-muted-foreground",
						children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "understanding-impact.manyI18nLibrariesStoreTranslations" })
					}),
					/* @__PURE__ */ jsxs("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							/* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "understanding-impact.theJsonMustBeParsed" }) }),
							/* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "understanding-impact.contextBasedArchitecturesCanCause" }) }),
							/* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "understanding-impact.duringServerSideRenderingThe" }) })
						]
					})
				]
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "understanding-impact.theTradeOffsOfDynamic" })
					}),
					/* @__PURE__ */ jsx("p", {
						className: "text-sm text-muted-foreground",
						children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "understanding-impact.splittingTranslationsIntoPerRoute" })
					}),
					/* @__PURE__ */ jsxs("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							/* @__PURE__ */ jsxs("li", { children: [
								/* @__PURE__ */ jsx("strong", {
									...
									children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "understanding-impact.waterfallRequests" })
								}),
								" ",
								/* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "understanding-impact.theAppMustFirstLoad" })
							] }),
							/* @__PURE__ */ jsxs("li", { children: [
								/* @__PURE__ */ jsx("strong", {
									className: "text-foreground",
									children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "understanding-impact.flashOfUntranslatedContentFouc" })
								}),
								" ",
								/* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "understanding-impact.usersMayBrieflySee" })
							] }),
							/* @__PURE__ */ jsxs("li", { children: [
								/* @__PURE__ */ jsx("strong", {
									className: "text-foreground",
									children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "understanding-impact.cacheInvalidation" })
								}),
								" ",
								/* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "understanding-impact.updatingTranslationsRequiresCacheBusting" })
							] })
						]
					})
				]
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("h3", {
					className: "mb-2 text-lg font-semibold text-foreground",
					children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "understanding-impact.whatThisBenchmarkMeasures" })
				}), /* @__PURE__ */ jsx("p", {
					className: "text-sm text-muted-foreground",
					children: /* @__PURE__ */ jsx(MemoizedFormattedMessage, { id: "understanding-impact.thisTestAppProvidesA" })
				})]
			})
		]
	});
...
async function getMessages(locale, namespaces = ["shared", "route"]) {
	...
	for (const ns of namespaces) try {
		const messages = await _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({
			"../messages/de/about.json": () => import("./about-CY8IdK44.js"),
			"../messages/de/blog.json": () => import("./blog-CVGBfCyX.js"),
			"../messages/de/careers.json": () => import("./careers-MDw6_GhC.js"),
			"../messages/de/contact.json": () => import("./contact-D0g2OVFk.js"),
			"../messages/de/faq.json": () => import("./faq-BEMmKVdA.js"),
			"../messages/de/home.json": () => import("./home-BHclDqdr.js"),
			"../messages/de/pricing.json": () => import("./pricing-BFbiDLEi.js"),
			"../messages/de/products.json": () => import("./products-D6mXRLCo.js"),
			"../messages/de/route.json": () => import("./route-B4OjylvF.js"),
			"../messages/de/settings.json": () => import("./settings-yzRKynEw.js"),
			"../messages/de/shared.json": () => import("./shared-DRoWayVg.js"),
			"../messages/de/team.json": () => import("./team-RNSxwaSI.js"),
			"../messages/en/about.json": () => import("./about-hITwE69H.js"),
			"../messages/en/blog.json": () => import("./blog-T3_tAxfg.js"),
			"../messages/en/careers.json": () => import("./careers-CAGeKiCP.js"),
			"../messages/en/contact.json": () => import("./contact-BbepRfd2.js"),
			"../messages/en/faq.json": () => import("./faq-BTlqE3Gk.js"),
			"../messages/en/home.json": () => import("./home-BvhCIWiB.js"),
			"../messages/en/pricing.json": () => import("./pricing-B7z2tkGk.js"),
			"../messages/en/products.json": () => import("./products-CGG9PaiZ.js"),
			"../messages/en/route.json": () => import("./route-Ce3VmdJN.js"),
			"../messages/en/settings.json": () => import("./settings--L3dO9Sv.js"),
			"../messages/en/shared.json": () => import("./shared-CW2SAeB9.js"),
			"../messages/en/team.json": () => import("./team-CKiM-MN_.js"),
			"../messages/es/about.json": () => import("./about-BxcUt2kb.js"),
			"../messages/es/blog.json": () => import("./blog-BcVtpFkv.js"),
			"../messages/es/careers.json": () => import("./careers-Gle8ITA7.js"),
			"../messages/es/contact.json": () => import("./contact-BNVW9qEb.js"),
			"../messages/es/faq.json": () => import("./faq-92nyj5qg.js"),
			"../messages/es/home.json": () => import("./home-CFm1hjnA.js"),
			"../messages/es/pricing.json": () => import("./pricing-CKW9bMSY.js"),
			"../messages/es/products.json": () => import("./products-CKteWyaI.js"),
			"../messages/es/route.json": () => import("./route-C9OKRyN3.js"),
			"../messages/es/settings.json": () => import("./settings-CleljClW.js"),
			"../messages/es/shared.json": () => import("./shared-D2ZkXvRZ.js"),
			"../messages/es/team.json": () => import("./team-QKuFoTTV.js"),
			"../messages/fr/about.json": () => import("./about-05oa_5yy.js"),
			"../messages/fr/blog.json": () => import("./blog-BhhhMrF6.js"),
			"../messages/fr/careers.json": () => import("./careers-BnVcOpIk.js"),
			"../messages/fr/contact.json": () => import("./contact-BfHP5PAy.js"),
			"../messages/fr/faq.json": () => import("./faq-C6iOMJiK.js"),
			"../messages/fr/home.json": () => import("./home-BmK8zZLz.js"),
			"../messages/fr/pricing.json": () => import("./pricing-DG6hxsMu.js"),
			"../messages/fr/products.json": () => import("./products-YCXSvhWI.js"),
			"../messages/fr/route.json": () => import("./route-t3x33ndM.js"),
			"../messages/fr/settings.json": () => import("./settings-CvVJsD4U.js"),
			"../messages/fr/shared.json": () => import("./shared-C9YIvjPz.js"),
			"../messages/fr/team.json": () => import("./team-Cq8Vk6q0.js"),
			"../messages/it/about.json": () => import("./about-BWjsxuKl.js"),
			"../messages/it/blog.json": () => import("./blog-B9YnUxj-.js"),
			"../messages/it/careers.json": () => import("./careers-BC5ASQAe.js"),
			"../messages/it/contact.json": () => import("./contact-BEIFNBfa.js"),
			"../messages/it/faq.json": () => import("./faq-CXYilsl3.js"),
			"../messages/it/home.json": () => import("./home-DExZrhQ9.js"),
			"../messages/it/pricing.json": () => import("./pricing-CtpmsNSZ.js"),
			"../messages/it/products.json": () => import("./products-BMd5CdTM.js"),
			"../messages/it/route.json": () => import("./route-CKhoQVQn.js"),
			"../messages/it/settings.json": () => import("./settings-Br6HLOgL.js"),
			"../messages/it/shared.json": () => import("./shared-DN0yZSlP.js"),
			"../messages/it/team.json": () => import("./team-BPk4wPkG.js"),
			"../messages/ja/about.json": () => import("./about-DVLpSBXA.js"),
			"../messages/ja/blog.json": () => import("./blog-pCvp5EXj.js"),
			"../messages/ja/careers.json": () => import("./careers--O6ejmWk.js"),
			"../messages/ja/contact.json": () => import("./contact-CVlFES1E.js"),
			"../messages/ja/faq.json": () => import("./faq-B3-jjAC1.js"),
			"../messages/ja/home.json": () => import("./home-kjs78IH9.js"),
			"../messages/ja/pricing.json": () => import("./pricing-D1ZF6jBv.js"),
			"../messages/ja/products.json": () => import("./products-Bd9odRPu.js"),
			"../messages/ja/route.json": () => import("./route-CFrmUvMU.js"),
			"../messages/ja/settings.json": () => import("./settings-8OSCWyXr.js"),
			"../messages/ja/shared.json": () => import("./shared-DEL9QaaE.js"),
			"../messages/ja/team.json": () => import("./team-C1UHGThq.js"),
			"../messages/ko/about.json": () => import("./about-BdYzlkEZ.js"),
			"../messages/ko/blog.json": () => import("./blog-0hgsKJkV.js"),
			"../messages/ko/careers.json": () => import("./careers-BNSQQKGL.js"),
			"../messages/ko/contact.json": () => import("./contact-D0s_UzB8.js"),
			"../messages/ko/faq.json": () => import("./faq-CVvyFnVr.js"),
			"../messages/ko/home.json": () => import("./home-Cy4Kvfqb.js"),
			"../messages/ko/pricing.json": () => import("./pricing-DWAk4YUq.js"),
			"../messages/ko/products.json": () => import("./products-C9fl31MY.js"),
			"../messages/ko/route.json": () => import("./route-DjchMkJ7.js"),
			"../messages/ko/settings.json": () => import("./settings-B5YnEukJ.js"),
			"../messages/ko/shared.json": () => import("./shared-yfzFSOd2.js"),
			"../messages/ko/team.json": () => import("./team-DQA0PHCw.js"),
			"../messages/pt/about.json": () => import("./about-DM2kW6U_.js"),
			"../messages/pt/blog.json": () => import("./blog-D4wqfyj2.js"),
			"../messages/pt/careers.json": () => import("./careers-B097rIrg.js"),
			"../messages/pt/contact.json": () => import("./contact-CYqH1eOQ.js"),
			"../messages/pt/faq.json": () => import("./faq-D5ODsqv-.js"),
			"../messages/pt/home.json": () => import("./home-CABWJPZZ.js"),
			"../messages/pt/pricing.json": () => import("./pricing-DcqwcfX4.js"),
			"../messages/pt/products.json": () => import("./products-DXuEKYXj.js"),
			"../messages/pt/route.json": () => import("./route-ByjuDpxK.js"),
			"../messages/pt/settings.json": () => import("./settings-BryYcWVX.js"),
			"../messages/pt/shared.json": () => import("./shared-BZI-y0g0.js"),
			"../messages/pt/team.json": () => import("./team-B8l_UWT-.js"),
			"../messages/ru/about.json": () => import("./about-DD0DbAwh.js"),
			"../messages/ru/blog.json": () => import("./blog-CBYbBYqE.js"),
			"../messages/ru/careers.json": () => import("./careers-COyOUI2H.js"),
			"../messages/ru/contact.json": () => import("./contact-DCUMQ22T.js"),
			"../messages/ru/faq.json": () => import("./faq-BF-kNUee.js"),
			"../messages/ru/home.json": () => import("./home-Bjnh83L6.js"),
			"../messages/ru/pricing.json": () => import("./pricing-DH3GXupc.js"),
			"../messages/ru/products.json": () => import("./products-BQMTVE2X.js"),
			"../messages/ru/route.json": () => import("./route-DkX9iAdJ.js"),
			"../messages/ru/settings.json": () => import("./settings-CLkGdfnh.js"),
			"../messages/ru/shared.json": () => import("./shared-BUvIJq_X.js"),
			"../messages/ru/team.json": () => import("./team-DvEnDpx-.js"),
			"../messages/zh/about.json": () => import("./about-C-2JeXec.js"),
			"../messages/zh/blog.json": () => import("./blog-BsC2WzPw.js"),
			"../messages/zh/careers.json": () => import("./careers-MhGfTPS3.js"),
			"../messages/zh/contact.json": () => import("./contact-Ch1YyoPn.js"),
			"../messages/zh/faq.json": () => import("./faq-CSb11Ais.js"),
			"../messages/zh/home.json": () => import("./home-DoGa2Mgd.js"),
			"../messages/zh/pricing.json": () => import("./pricing-DDGILulz.js"),
			"../messages/zh/products.json": () => import("./products-DXk3WF6P.js"),
			"../messages/zh/route.json": () => import("./route-Cq6IH5BG.js"),
			"../messages/zh/settings.json": () => import("./settings-CFBvEsZB.js"),
			"../messages/zh/shared.json": () => import("./shared-O1CdsFGh.js"),
			"../messages/zh/team.json": () => import("./team-PzHPXdFw.js")
		}), `../messages/${locale}/${ns}.json`, 4);
