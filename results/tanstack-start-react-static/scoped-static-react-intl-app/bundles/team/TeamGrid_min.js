...
function Nt() {
	...
	return /* @__PURE__ */ r("div", {
		...
		children: [
			{
				name: e.formatMessage({ id: "team-grid.sarahChen" }),
				role: e.formatMessage({ id: "team-grid.founderLeadEngineer" }),
				bio: e.formatMessage({ id: "team-grid.formerGoogleEngineerWith10" })
			},
			{
				name: e.formatMessage({ id: "team-grid.marcusWeber" }),
				role: e.formatMessage({ id: "team-grid.performanceEngineer" }),
				bio: e.formatMessage({ id: "team-grid.specializesInJavascriptPerformanceOptimization" })
			},
			{
				name: e.formatMessage({ id: "team-grid.aishaPatel" }),
				role: e.formatMessage({ id: "team-grid.developerAdvocate" }),
				bio: e.formatMessage({ id: "team-grid.passionateAboutDeveloperExperienceAnd" })
			},
			{
				name: e.formatMessage({ id: "team-grid.tomasRodriguez" }),
				role: e.formatMessage({ id: "team-grid.fullStackDeveloper" }),
				bio: e.formatMessage({ id: "team-grid.maintainsTheBenchmarkingInfrastructureAnd" })
			},
			{
				name: e.formatMessage({ id: "team-grid.yukiTanaka" }),
				role: e.formatMessage({ id: "team-grid.dataAnalyst" }),
				bio: e.formatMessage({ id: "team-grid.ensuresStatisticalRigorInAll" })
			},
			{
				name: e.formatMessage({ id: "team-grid.elenaKowalski" }),
				role: e.formatMessage({ id: "team-grid.communityManager" }),
				bio: e.formatMessage({ id: "team-grid.managesCommunityContributionsPartnershipsAnd" })
			}
