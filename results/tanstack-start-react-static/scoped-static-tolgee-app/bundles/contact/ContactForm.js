	...
	return /* @__PURE__ */ jsxs("form", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
				...
				children: [
					/* @__PURE__ */ jsx("option", { children: t("contactForm.bugReport", "Bug Report") }),
					/* @__PURE__ */ jsx("option", { children: t("contactForm.newBenchmarkIdea", "New Benchmark Idea") }),
					/* @__PURE__ */ jsx("option", { children: t("contactForm.methodologyQuestion", "Methodology Question") }),
					/* @__PURE__ */ jsx("option", { children: t("contactForm.contribution", "Contribution") }),
					/* @__PURE__ */ jsx("option", { children: t("contactForm.other", "Other") })
				]
			})] }),
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
				htmlFor: messageId,
