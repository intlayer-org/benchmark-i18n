...
function N() {
	let { t: e } = E("contact"), t = i(), n = i(), r = i(), a = i();
	return /* @__PURE__ */ c("form", {
		...
		children: [
			...
			/* @__PURE__ */ c("div", { children: [/* @__PURE__ */ s("label", {
				...
				children: [
					/* @__PURE__ */ s("option", { children: e("contactForm.bugReport", "Bug Report") }),
					/* @__PURE__ */ s("option", { children: e("contactForm.newBenchmarkIdea", "New Benchmark Idea") }),
					/* @__PURE__ */ s("option", { children: e("contactForm.methodologyQuestion", "Methodology Question") }),
					/* @__PURE__ */ s("option", { children: e("contactForm.contribution", "Contribution") }),
					/* @__PURE__ */ s("option", { children: e("contactForm.other", "Other") })
				]
			})] }),
			/* @__PURE__ */ c("div", { children: [/* @__PURE__ */ s("label", {
				htmlFor: a,
