...
function N() {
	let { t: e } = E("careers"), t = [{
		title: e("careersPositions.seniorFrontendEngineer", "Senior Frontend Engineer"),
		...
		desc: e("careersPositions.seniorFrontendEngineerDesc", "Build and maintain our benchmarking dashboard and developer tools using React, TypeScript, and Vite.")
	}];
