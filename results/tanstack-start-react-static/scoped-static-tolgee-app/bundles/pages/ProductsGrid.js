		...
		children: [
			{
				...
				desc: t("products.benchmarkCLIDesc", "Run benchmarks locally from your terminal. Supports custom configurations and CI integration."),
				price: t("products.benchmarkCLIPrice", "Free")
			},
			{
				name: t("products.benchmarkCloud", "Benchmark Cloud"),
				desc: t("products.benchmarkCloudDesc", "Automated cloud-based benchmarking with historical tracking, alerts, and team dashboards."),
				price: t("products.benchmarkCloudPrice", "$29/mo")
			},
			{
				name: t("products.benchmarkEnterprise", "Benchmark Enterprise"),
				desc: t("products.benchmarkEnterpriseDesc", "On-premise deployment with SSO, audit logs, custom SLAs, and dedicated support."),
				price: t("products.benchmarkEnterprisePrice", "Contact Us")
			},
			{
				name: t("products.migrationAssistant", "Migration Assistant"),
				desc: t("products.migrationAssistantDesc", "AI-powered tool that helps migrate your codebase between i18n libraries with zero downtime."),
				price: t("products.migrationAssistantPrice", "$99 one-time")
			},
			{
				name: t("products.translationQA", "Translation QA"),
				desc: t("products.translationQADesc", "Automated quality checks for missing translations, pluralization issues, and context errors."),
				price: t("products.translationQAPrice", "$19/mo")
			},
			{
				name: t("products.bundleOptimizer", "Bundle Optimizer"),
				desc: t("products.bundleOptimizerDesc", "Analyzes and optimizes your i18n bundle for production with tree-shaking and code splitting."),
