...
function M() {
	...
	return /* @__PURE__ */ o("div", {
		...
		children: [
			{
				name: e("products.benchmarkCLI", "Benchmark CLI"),
				desc: e("products.benchmarkCLIDesc", "Run benchmarks locally from your terminal. Supports custom configurations and CI integration."),
				price: e("products.benchmarkCLIPrice", "Free")
			},
			{
				name: e("products.benchmarkCloud", "Benchmark Cloud"),
				desc: e("products.benchmarkCloudDesc", "Automated cloud-based benchmarking with historical tracking, alerts, and team dashboards."),
				price: e("products.benchmarkCloudPrice", "$29/mo")
			},
			{
				name: e("products.benchmarkEnterprise", "Benchmark Enterprise"),
				desc: e("products.benchmarkEnterpriseDesc", "On-premise deployment with SSO, audit logs, custom SLAs, and dedicated support."),
				price: e("products.benchmarkEnterprisePrice", "Contact Us")
			},
			{
				name: e("products.migrationAssistant", "Migration Assistant"),
				desc: e("products.migrationAssistantDesc", "AI-powered tool that helps migrate your codebase between i18n libraries with zero downtime."),
				price: e("products.migrationAssistantPrice", "$99 one-time")
			},
			{
				name: e("products.translationQA", "Translation QA"),
				desc: e("products.translationQADesc", "Automated quality checks for missing translations, pluralization issues, and context errors."),
				price: e("products.translationQAPrice", "$19/mo")
			},
			{
				name: e("products.bundleOptimizer", "Bundle Optimizer"),
				desc: e("products.bundleOptimizerDesc", "Analyzes and optimizes your i18n bundle for production with tree-shaking and code splitting."),
				price: e("products.bundleOptimizerPrice", "$49/mo")
			}
