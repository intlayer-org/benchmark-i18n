		...
		children: [
			{
				...
				bio: t("formerGoogleEngineerWith10", "Former Google engineer with 10 years of experience building internationalization systems at scale.")
			},
			{
				name: t("marcusWeber", "Marcus Weber"),
				role: t("performanceEngineer", "Performance Engineer"),
				bio: t("specializesInJavascriptPerformanceOptimization", "Specializes in JavaScript performance optimization and benchmarking methodology. Previously at Vercel.")
			},
			{
				name: t("aishaPatel", "Aisha Patel"),
				role: t("developerAdvocate", "Developer Advocate"),
				bio: t("passionateAboutDeveloperExperienceAnd", "Passionate about developer experience and education. Speaker at React Conf, JSConf, and i18nNext.")
			},
			{
				name: t("tomasRodriguez", "Tomás Rodríguez"),
				role: t("fullStackDeveloper", "Full-Stack Developer"),
				bio: t("maintainsTheBenchmarkingInfrastructureAnd", "Maintains the benchmarking infrastructure and CI/CD pipeline. Open source contributor to Lingui.")
			},
			{
				name: t("yukiTanaka", "Yuki Tanaka"),
				role: t("dataAnalyst", "Data Analyst"),
				bio: t("ensuresStatisticalRigorInAll", "Ensures statistical rigor in all benchmark results. PhD in Applied Statistics from MIT.")
			},
			{
				name: t("elenaKowalski", "Elena Kowalski"),
				role: t("communityManager", "Community Manager"),
				bio: t("managesCommunityContributionsPartnershipsAnd", "Manages community contributions, partnerships, and events. Background in open source governance.")
			}
