...
function E() {
	...
	return /* @__PURE__ */ o("div", {
		...
		children: [
			{
				name: e("pricingTiers.starterTier", "Starter"),
				price: e("pricingTiers.starterPrice", "$0"),
				period: e("pricingTiers.forever", "forever"),
				features: [
					e("pricingTiers.runsPerDay", "5 benchmark runs/day"),
					e("pricingTiers.libraries3", "3 libraries"),
					e("pricingTiers.communitySupport", "Community support"),
					e("pricingTiers.publicResults", "Public results")
				],
				cta: e("pricingTiers.getStarted", "Get Started")
			},
			{
				name: e("pricingTiers.proTier", "Pro"),
				price: e("pricingTiers.proPrice", "$29"),
				period: e("pricingTiers.perMonth", "/month"),
				features: [
					e("pricingTiers.unlimitedRuns", "Unlimited runs"),
					e("pricingTiers.allLibraries", "All libraries"),
					e("pricingTiers.prioritySupport", "Priority support"),
					e("pricingTiers.privateResults", "Private results"),
					e("pricingTiers.ciIntegration", "CI integration"),
					e("pricingTiers.historicalData", "Historical data")
				],
				highlighted: !0,
				cta: e("pricingTiers.getStarted", "Get Started")
			},
			{
				name: e("pricingTiers.enterpriseTier", "Enterprise"),
				price: e("pricingTiers.custom", "Custom"),
				period: "",
				features: [
					e("pricingTiers.everythingInPro", "Everything in Pro"),
					e("pricingTiers.onPremiseOption", "On-premise option"),
					e("pricingTiers.ssoSaml", "SSO & SAML"),
					e("pricingTiers.dedicatedAccountManager", "Dedicated account manager"),
					e("pricingTiers.customSLAs", "Custom SLAs"),
					e("pricingTiers.auditLogs", "Audit logs"),
					e("pricingTiers.trainingSessions", "Training sessions")
				],
			...
			children: [
				...
				/* @__PURE__ */ o("ul", {
					...
					children: e.features.map((e) => /* @__PURE__ */ s("li", {
