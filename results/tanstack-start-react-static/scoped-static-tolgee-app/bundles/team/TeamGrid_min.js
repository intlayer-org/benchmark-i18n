...
function E() {
	...
	return /* @__PURE__ */ o("div", {
		...
		children: [
			{
				name: e("sarahChen", "Sarah Chen"),
				role: e("founderLeadEngineer", "Founder & Lead Engineer"),
				bio: e("formerGoogleEngineerWith10", "Former Google engineer with 10 years of experience building internationalization systems at scale.")
			},
			{
				name: e("marcusWeber", "Marcus Weber"),
				role: e("performanceEngineer", "Performance Engineer"),
				bio: e("specializesInJavascriptPerformanceOptimization", "Specializes in JavaScript performance optimization and benchmarking methodology. Previously at Vercel.")
			},
			{
				name: e("aishaPatel", "Aisha Patel"),
				role: e("developerAdvocate", "Developer Advocate"),
				bio: e("passionateAboutDeveloperExperienceAnd", "Passionate about developer experience and education. Speaker at React Conf, JSConf, and i18nNext.")
			},
			{
				name: e("tomasRodriguez", "Tomás Rodríguez"),
				role: e("fullStackDeveloper", "Full-Stack Developer"),
				bio: e("maintainsTheBenchmarkingInfrastructureAnd", "Maintains the benchmarking infrastructure and CI/CD pipeline. Open source contributor to Lingui.")
			},
			{
				name: e("yukiTanaka", "Yuki Tanaka"),
				role: e("dataAnalyst", "Data Analyst"),
				bio: e("ensuresStatisticalRigorInAll", "Ensures statistical rigor in all benchmark results. PhD in Applied Statistics from MIT.")
			},
			{
				name: e("elenaKowalski", "Elena Kowalski"),
				role: e("communityManager", "Community Manager"),
				bio: e("managesCommunityContributionsPartnershipsAnd", "Manages community contributions, partnerships, and events. Background in open source governance.")
			}
