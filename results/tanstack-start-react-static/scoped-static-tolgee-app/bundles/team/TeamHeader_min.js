...
function P() {
	let { t: e } = E("teamHeader");
	return /* @__PURE__ */ c(o, { children: [
		/* @__PURE__ */ s(N, {}),
		/* @__PURE__ */ s("h1", {
			className: "mb-2 text-3xl font-bold text-foreground",
			children: e("ourTeam", "Our Team")
		}),
		/* @__PURE__ */ s("p", {
			className: "mb-10 text-muted-foreground",
			children: e("meetThePeopleBehindI18n", "Meet the people behind i18n Benchmark. A diverse team united by a shared passion for great developer tools.")
		})
	] });
}
//#endregion
