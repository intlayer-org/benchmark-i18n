...
//#endregion
//#region src/locales/.wuchale/shared.proxy.js
...
var catalogs = { shared: {
	en: () => import("./shared.shared.en.compiled-DtRAstV4.js"),
	es: () => import("./shared.shared.es.compiled-RHNCtdQ9.js"),
	fr: () => import("./shared.shared.fr.compiled-ChsEdABe.js"),
	de: () => import("./shared.shared.de.compiled-BvFIiQeM.js"),
	it: () => import("./shared.shared.it.compiled-CrDRs4IB.js"),
	pt: () => import("./shared.shared.pt.compiled-CqwPguDC.js"),
	zh: () => import("./shared.shared.zh.compiled-D9maEi_p.js"),
	ja: () => import("./shared.shared.ja.compiled-DqJc4Yqq.js"),
	ko: () => import("./shared.shared.ko.compiled-Cnh1KYis.js"),
	ru: () => import("./shared.shared.ru.compiled-ClJyGpiG.js")
} };
var loadCatalog = (loadID, locale) => {
	return catalogs[loadID][locale]();
};
var getRuntimeRx = registerLoaders("shared", loadCatalog, ["shared"]);
//#endregion
...
function ThemeToggle() {
	...
	const _w_runtime_ = getRuntimeRx("shared");
...
function Header() {
	const _w_runtime_ = getRuntimeRx("shared");
	usePerformanceMeasure(_w_runtime_(13));
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("button", {
								...
								children: /* @__PURE__ */ jsx(runtime_default, {
									t: [() => /* @__PURE__ */ jsx(ChevronDown, {
										size: 14,
...
//#region src/locales/.wuchale/shared.shared.de.compiled.js
...
//#endregion
export { c };
//#region src/locales/.wuchale/shared.shared.en.compiled.js
/** @type import('wuchale').CompiledElement[] */
var c = [
	"i18n Benchmark",
	"Methodology",
...
//#endregion
export { c };
//#region src/locales/.wuchale/shared.shared.es.compiled.js
/** @type import('wuchale').CompiledElement[] */
var c = [
	"i18n Benchmark",
	"Metodología",
...
//#endregion
export { c };
//#region src/locales/.wuchale/shared.shared.fr.compiled.js
/** @type import('wuchale').CompiledElement[] */
var c = [
	"i18n Benchmark",
	"Méthodologie",
...
//#endregion
export { c };
//#region src/locales/.wuchale/shared.shared.it.compiled.js
/** @type import('wuchale').CompiledElement[] */
var c = [
	"i18n Benchmark",
	"Metodologia",
...
//#endregion
export { c };
//#region src/locales/.wuchale/shared.shared.ja.compiled.js
/** @type import('wuchale').CompiledElement[] */
var c = [
	"i18n Benchmark",
	"メソッド",
...
//#endregion
export { c };
//#region src/locales/.wuchale/shared.shared.ko.compiled.js
/** @type import('wuchale').CompiledElement[] */
var c = [
	"i18n Benchmark",
	"방법론",
...
//#endregion
export { c };
//#region src/locales/.wuchale/shared.shared.pt.compiled.js
/** @type import('wuchale').CompiledElement[] */
var c = [
	"i18n Benchmark",
	"Metodologia",
...
//#endregion
export { c };
//#region src/locales/.wuchale/shared.shared.ru.compiled.js
/** @type import('wuchale').CompiledElement[] */
var c = [
	"i18n Benchmark",
	"Методология",
...
//#endregion
export { c };
//#region src/locales/.wuchale/shared.shared.zh.compiled.js
/** @type import('wuchale').CompiledElement[] */
var c = [
	"i18n Benchmark",
	"方法学",
