...
function r(e = { c: [] }, r) {
	let i = e.c, a = (e) => {
		let n = i[e];
		return typeof n == "string" ? [n] : Array.isArray(n) ? n : [t(e, i)];
	}, o = (e, t = []) => n(a(e), t, 0);
	return o._ = e, o.l = r, o.c = a, o.x = n, o.t = (e, t, n) => {
		let r = a(t), i = [""], o = [];
		for (let e of r) {
			if (typeof e == "string") {
				i[i.length - 1] += e;
...
function s(e, t, n, r) {
	...
	for (let t of n) a[e].collection.set(t, o);
	return (t) => a[e].collection.get(t);
}
//#endregion
...
} }, l = s("shared", (e, t) => c[e][t](), ["shared"]), u = () => /* @__PURE__ */ e("div", {
	className: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground",
	children: l("shared")(20)
});
//#endregion
export { u as default };
