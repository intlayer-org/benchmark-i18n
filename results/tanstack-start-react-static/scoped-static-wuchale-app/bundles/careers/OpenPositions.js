...
var getRuntime = registerLoaders("careers", loadCatalog, ["careers"]);
...
function OpenPositions() {
	...
	const openings = [{
		...
		location: _w_runtime_(137),
		type: _w_runtime_(138),
		dept: _w_runtime_(139),
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("h2", {
		...
		children: openings.map((o) => {
			const _w_runtime_ = getRuntime("careers");
