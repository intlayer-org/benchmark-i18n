...
var getRuntime = registerLoaders("blog", loadCatalog, ["blog"]);
var getRuntimeRx = getRuntime;
//#endregion
...
function BlogList() {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: [
			{
				title: _w_runtime_(136),
				date: _w_runtime_(137),
				excerpt: _w_runtime_(138),
				category: _w_runtime_(139)
			},
			{
				title: _w_runtime_(140),
				date: _w_runtime_(141),
				excerpt: _w_runtime_(142),
				category: _w_runtime_(143)
			},
			{
				title: _w_runtime_(144),
				date: _w_runtime_(145),
				excerpt: _w_runtime_(146),
				category: _w_runtime_(147)
			},
			{
				title: _w_runtime_(148),
				date: _w_runtime_(149),
				excerpt: _w_runtime_(150),
				category: _w_runtime_(143)
			},
			{
				title: _w_runtime_(151),
				date: _w_runtime_(152),
				excerpt: _w_runtime_(153),
				category: _w_runtime_(147)
			},
			{
				title: _w_runtime_(154),
				date: _w_runtime_(155),
				excerpt: _w_runtime_(156),
				category: _w_runtime_(157)
			}
		].map((p) => {
			const _w_runtime_ = getRuntime("blog");
