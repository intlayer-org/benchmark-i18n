...
var getRuntime = registerLoaders("products", loadCatalog, ["products"]);
...
function ProductsGrid() {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: [
			{
				name: _w_runtime_(136),
				desc: _w_runtime_(137),
				price: _w_runtime_(138)
			},
			{
				name: _w_runtime_(139),
				desc: _w_runtime_(140),
				price: "$29/mo"
			},
			{
				name: _w_runtime_(141),
				desc: _w_runtime_(142),
				price: _w_runtime_(143)
			},
			{
				name: _w_runtime_(144),
				desc: _w_runtime_(145),
				price: "$99 one-time"
			},
			{
				name: _w_runtime_(146),
				desc: _w_runtime_(147),
				price: "$19/mo"
			},
			{
				name: _w_runtime_(148),
				desc: _w_runtime_(149),
				price: "$49/mo"
			}
		].map((p) => {
			const _w_runtime_ = getRuntime("products");
