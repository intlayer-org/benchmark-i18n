...
var getRuntimeRx = registerLoaders("team", loadCatalog, ["team"]);
//#endregion
//#region src/components/pages/team/TeamGrid.tsx
function TeamGrid() {
	const _w_runtime_ = getRuntimeRx("team");
	return /* @__PURE__ */ jsx("div", {
		className: "grid gap-6 md:grid-cols-2 lg:grid-cols-3",
		children: [
			{
				name: _w_runtime_(136),
				role: _w_runtime_(137),
				bio: _w_runtime_(138)
			},
			{
				name: _w_runtime_(139),
				role: _w_runtime_(140),
				bio: _w_runtime_(141)
			},
			{
				name: _w_runtime_(142),
				role: _w_runtime_(143),
				bio: _w_runtime_(144)
			},
			{
				name: _w_runtime_(145),
				role: _w_runtime_(146),
				bio: _w_runtime_(147)
			},
			{
				name: _w_runtime_(148),
				role: _w_runtime_(149),
				bio: _w_runtime_(150)
			},
			{
				name: _w_runtime_(151),
				role: _w_runtime_(152),
				bio: _w_runtime_(153)
			}
