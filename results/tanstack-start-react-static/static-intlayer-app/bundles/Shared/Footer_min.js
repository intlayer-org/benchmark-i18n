...
}, v = "translation", y = "insertion", ne = "object", b = "array", x = (e, t) => {
...
}, T = process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false", E = process.env.INTLAYER_NODE_TYPE_INSERTION === "false", D = {
	id: "fallback-plugin",
	canHandle: () => !1,
	transform: (e) => e
}, O = (e, t) => T ? D : {
...
}, R = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", z = /\{\{\s*(.*?)\s*\}\}/g, B = (e, t = {}) => {
	if (!Object.values(t).some(R)) return {
		isSimple: !0,
...
}, V = process.env.INTLAYER_NODE_TYPE_INTLAYER_NODE === "false", H = process.env.INTLAYER_NODE_TYPE_REACT_NODE === "false", U = process.env.INTLAYER_NODE_TYPE_INSERTION === "false";
...
var W = V ? D : {
	...
	q,
	J
].filter(Boolean), ae = (e, t) => L(e, t, Y(t)), oe = (e, t = m?.locales, n = m?.defaultLocale) => {
...
var se = (e, t, n) => {
	...
	let { locales: s, defaultLocale: c } = m ?? {}, [l, d] = ee(e ?? Q ?? t ?? c);
	o(() => {
		e && e !== l && d(e);
	}, [e]), o(() => {
		pe();
...
function _e() {
	let e = ge(te), t = p({ strict: !1 }).locale ?? "en", n = [
		{
			label: e.f,
