...
var g = {
  ...
  S = (e, t) => {
    for (let n of t.plugins ?? [])
      if (n.canHandle(e)) return n.transform(e, t, (e, t) => S(e, t));
    if (
      typeof e != "object" ||
      !e ||
      e.$$typeof !== void 0 ||
  ...
  ce = process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false",
  le = process.env.INTLAYER_NODE_TYPE_INSERTION === "false",
  T = {
    id: "fallback-plugin",
    canHandle: () => !1,
    transform: (e) => e,
...
var V = R
  ...
  he = (e, t) => P(e, t, me(t)),
  ge = (e, t = _?.locales, n = _?.defaultLocale) => {
    let r = [e].flat(),
...
var _e = (e, t, n) => {
  ...
  ve = (e) => {
    ...
    if (!W)
      for (let t = 0; t < (v.storage.cookies ?? []).length; t++)
        try {
  ...
  ye = (e, t) => {
    if (t?.isCookieEnabled !== !1 && !W && v.storage.cookies)
      for (let n = 0; n < v.storage.cookies.length; n++) {
  ...
  Se = (e, t = e) =>
    new xe.DisplayNames(t, { type: "language" }).of(e) ?? "Unknown locale",
  J = ve(G),
  Y = (e, t) =>
    ye(e, {
      ...G,
  ...
  Ee = ({
    ...
    let { locales: o, defaultLocale: c } = _ ?? {},
      [l, u] = d(e ?? J ?? t ?? c);
    (s(() => {
      e && e !== l && u(e);
    }, [e]),
  ...
  Z = (e, t) => {
    let { locale: n } = o(X) ?? {};
    return l(() => he(e, t ?? n), [e.key, n, t]);
  },
  Oe = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
    let { defaultLocale: n, locales: r } = _ ?? {},
      { locale: i, setLocale: s, isCookieEnabled: c } = o(X) ?? {};
    return {
      locale: i,
      defaultLocale: n,
      availableLocales: r,
    ...
    content: {
      ...
      translation: {
        ...
        fr: {
          ...
          themeModeLightClick:
            "Mode de thème : clair. Cliquez pour passer au mode sombre.",
          themeModeDarkClick:
          ...
          e: {
            ...
            nodeType: "insertion",
            insertion:
              "Mode de thème : {{mode}}. Cliquez pour changer de mode.",
          },
        },
        es: {
          d: "Modo de tema: automático (sistema). Haga clic para cambiar al modo claro.",
          themeModeLightClick:
            "Modo de tema: claro. Haga clic para cambiar al modo oscuro.",
          themeModeDarkClick:
            "Modo de tema: oscuro. Haga clic para cambiar al modo automático (sistema).",
          a: "Tema: Auto",
          b: "Tema: Oscuro",
          c: "Tema: Claro",
          e: {
            ...
            nodeType: "insertion",
            insertion:
              "Modo de tema: {{mode}}. Haga clic para cambiar de modo.",
          },
        },
        de: {
          d: "Design-Modus: Auto (System). Klicken, um in den hellen Modus zu wechseln.",
          themeModeLightClick:
            "Design-Modus: Hell. Klicken, um in den dunklen Modus zu wechseln.",
          themeModeDarkClick:
            "Design-Modus: Dunkel. Klicken, um in den Auto-Modus (System) zu wechseln.",
          a: "Design: Auto",
          b: "Design: Dunkel",
          c: "Design: Hell",
          e: {
        ...
        it: {
          ...
          themeModeLightClick:
            "Modalità tema: chiara. Clicca per passare alla modalità scura.",
          themeModeDarkClick:
            "Modalità tema: scura. Clicca per passare alla modalità auto (sistema).",
          a: "Tema: Auto",
          b: "Tema: Scuro",
          c: "Tema: Chiaro",
          e: {
        ...
        pt: {
          ...
          themeModeLightClick:
            "Modo de tema: claro. Clique para mudar para o modo escuro.",
          themeModeDarkClick:
            "Modo de tema: escuro. Clique para mudar para o modo automático (sistema).",
          a: "Tema: Auto",
          b: "Tema: Escuro",
          c: "Tema: Claro",
          e: {
        ...
        ja: {
          ...
          themeModeDarkClick:
            "テーマモード：ダーク。クリックして自動（システム）モードに切り替えます。",
          a: "テーマ：自動",
          b: "テーマ：ダーク",
          c: "テーマ：ライト",
          e: {
            ...
            nodeType: "insertion",
            insertion:
              "テーマモード：{{mode}}。モードを切り替えるにはクリックしてください。",
          },
        },
        ko: {
          d: "테마 모드: 자동(시스템). 라이트 모드로 전환하려면 클릭하세요.",
          themeModeLightClick:
            "테마 모드: 라이트. 다크 모드로 전환하려면 클릭하세요.",
          themeModeDarkClick:
            "테마 모드: 다크. 자동(시스템) 모드로 전환하려면 클릭하세요.",
          a: "테마: 자동",
          b: "테마: 다크",
          c: "테마: 라이트",
          e: {
        ...
        ru: {
          ...
          themeModeLightClick:
            "Режим темы: светлый. Нажмите, чтобы переключиться на темную тему.",
          themeModeDarkClick:
            "Режим темы: темный. Нажмите, чтобы переключиться на авто (системный) режим.",
          a: "Тема: Авто",
          b: "Тема: Темная",
          c: "Тема: Светлая",
          e: {
            ...
            nodeType: "insertion",
            insertion:
              "Режим темы: {{mode}}. Нажмите, чтобы переключить режим.",
          },
        },
      },
    },
...
function Ae() {
  ...
  return /* @__PURE__ */ p("button", {
    ...
    title: i,
    className:
      "rounded-md border border-border bg-accent px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-accent/80",
...
function Ne() {
  ...
  return /* @__PURE__ */ p("header", {
    className:
      "sticky top-0 z-50 border-b border-border bg-card/80 backdrop-blur-lg",
        ...
        /* @__PURE__ */ m("div", {
          ...
          children: [
            /* @__PURE__ */ p(h, {
              ...
              params: { locale: r },
              className:
                "text-lg font-bold tracking-tight text-primary no-underline",
              children: e.h,
            }),
            /* @__PURE__ */ m("div", {
              className:
                ...
                /* @__PURE__ */ m("div", {
                  ...
                  children: [
                    /* @__PURE__ */ m("button", {
                      type: "button",
                      className:
                        "flex items-center gap-1 nav-link bg-transparent border-none cursor-pointer",
                      onMouseEnter: () => n(!0),
                      onMouseLeave: () => n(!1),
                      onClick: () => n(!t),
                      children: [
                    ...
                    t &&
                      /* @__PURE__ */ p("div", {
                        ...
                        children: /* @__PURE__ */ p("div", {
                          className:
                            "bg-card border border-border rounded-md shadow-lg overflow-hidden py-1",
                          children: i.map((e) =>
                            /* @__PURE__ */ p(
                              h,
                              {
