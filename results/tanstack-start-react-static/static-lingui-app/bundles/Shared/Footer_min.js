...
function g(t, n = {}) {
	...
	for (let [t, o, s] of _(r)) {
		...
		(!r || h[r.type] && o) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${t}' as it is not declared in the original translation`), r = /* @__PURE__ */ d(u, {})), Array.isArray(r) && (r = /* @__PURE__ */ d(u, { children: r })), a.push(e(r, { key: i() }, o ? g(o, n) : r.props.children)), s && a.push(s);
	}
...
function y(e) {
	...
	else if (n && typeof n != "function") return console.error(`Invalid value supplied to prop \`component\`. It must be a React component, provided ${n}`), /* @__PURE__ */ d(p, {
		...m,
		children: f
	});
	return typeof t == "function" ? t(m) : /* @__PURE__ */ d(n || p, {
		...m,
		children: f
	});
}
var b = ({ children: e }) => e, x = (e) => {
	...
	return Object.entries(e.values).forEach(([e, r]) => {
		...
		n[i] = /* @__PURE__ */ d(u, { children: r }), t[e] = `<${i}/>`;
	}), {
		values: t,
		components: n
	};
...
var T = ({ i18n: e, defaultComponent: t, children: r }) => {
	...
	}, [e, c]), a.current ? /* @__PURE__ */ d(S.Provider, {
		value: l,
		children: r
			...
			children: [/* @__PURE__ */ f("div", {
				...
				children: [
					...
					/* @__PURE__ */ f("div", { children: [/* @__PURE__ */ d("h3", {
						...
						className: "space-y-1",
						children: n.map((e) => /* @__PURE__ */ d("li", { children: e.isInternal ? /* @__PURE__ */ d(c, {
							to: e.to,
							params: { locale: t },
...
function Oe() {
	return /* @__PURE__ */ d(De, { children: /* @__PURE__ */ d(D, {}) });
}
//#endregion
