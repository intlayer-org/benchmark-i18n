...
var l = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), u = /* @__PURE__ */ l(((e, t) => {
	(function(e, n) {
...
}, m = (e) => e < 4 ? "short" : e === 4 ? "long" : "narrow", h = (e) => e % 2 == 0 ? "2-digit" : "numeric";
function g(e, t) {
	switch (e.char) {
		case "y": return { year: h(e.width) };
		case "r": return {
			calendar: "gregory",
			year: "numeric"
		};
		default: return t(`${e.desc} is not supported; falling back to year:numeric`, p.WARNING), { year: "numeric" };
	}
}
function _(e, t) {
	switch (e.width) {
...
function y(e, t) {
	let { char: n, desc: r, width: i } = e;
	return (n === "c" || n === "e") && i < 3 && t(`Numeric value is not supported for ${r}; falling back to weekday:short`, p.WARNING), m(i);
}
function b(e) {
	let t = h(e.width), n;
	switch (e.char) {
...
function S(e, t) {
	switch (e.field) {
		case "era": return { era: m(e.width) };
		case "year": return g(e, t);
		case "month": return { month: _(e, t) };
		case "day": return { day: v(e, t) };
		case "weekday": return { weekday: y(e, t) };
		case "period": return;
		case "hour": return b(e);
		case "min": return { minute: h(e.width) };
		case "sec": return { second: h(e.width) };
		case "tz": return { timeZoneName: x(e, t) };
		case "quarter":
		case "week":
		case "sec-frac":
...
function C(e, t, n = (e) => {
	...
	for (let t of e) {
		...
		if (e) {
			let r = new p(e.message, t);
			r.stack = e.stack, n(r);
		}
		o && n(new p(`Ignoring string part: ${o}`, t, p.WARNING)), a && (i.indexOf(a) === -1 ? i.push(a) : n(new p(`Duplicate ${a} token`, t)));
		let s = S(t, (e, r) => n(new p(e, t, r)));
		s && Object.assign(r, s);
	}
	return r;
}
...
function k(e, t) {
	return /^::/.test(e) ? C(D(e.substring(2)), void 0, t) : e;
}
function A(e, t = (e) => e) {
	return O((0, f.parse)(e), t);
}
function ne(e, t = (e) => e) {
	try {
		return A(e, t);
...
var j = (e) => typeof e == "string", re = (e) => typeof e == "function", M = /* @__PURE__ */ new Map(), N = "en";
function P(e) {
	return [...Array.isArray(e) ? e : [e], N];
}
function F(e, t, n) {
	let r = P(e);
	n ||= "default";
	...
	return z(() => B("date", r, n), () => new Intl.DateTimeFormat(r, i)).format(j(t) ? new Date(t) : t);
}
function I(e, t, n) {
	let r;
...
function L(e, t, n) {
	let r = P(e);
	return z(() => B("number", r, n), () => new Intl.NumberFormat(r, n)).format(t);
}
function R(e, t, n, { offset: r = 0, ...i }) {
	let a = P(e), o = t ? z(() => B("plural-ordinal", a), () => new Intl.PluralRules(a, { type: "ordinal" })) : z(() => B("plural-cardinal", a), () => new Intl.PluralRules(a, { type: "cardinal" }));
	return i[n] ?? i[o.select(n - r)] ?? i.other;
}
function z(e, t) {
	let n = e(), r = M.get(n);
	return r || (r = t(), M.set(n, r)), r;
}
function B(e, t, n) {
	return `${e}-${t.join("-")}-${JSON.stringify(n)}`;
}
var V = /\\u[a-fA-F0-9]{4}|\\x[a-fA-F0-9]{2}/, H = (e) => e.replace(/\\u([a-fA-F0-9]{4})|\\x([a-fA-F0-9]{2})/g, (e, t, n) => {
	if (t) {
		let e = parseInt(t, 16);
...
}), U = "%__lingui_octothorpe__%", W = (e, t, n = {}) => {
	let r = t || e, i = (e) => typeof e == "object" ? e : n[e], a = (e, t) => {
		let a = L(r, e, Object.keys(n).length ? i("number") : void 0);
		return t.replace(new RegExp(U, "g"), a);
	};
	return {
		plural: (e, t) => {
			let { offset: n = 0 } = t, i = R(r, !1, e, t);
			return a(e - n, i);
		},
		selectordinal: (e, t) => {
			let { offset: n = 0 } = t, i = R(r, !0, e, t);
			return a(e - n, i);
		},
		select: G,
		number: (e, t) => L(r, e, i(t) || { style: t }),
		date: (e, t) => F(r, e, i(t) || t),
		time: (e, t) => I(r, e, i(t) || t)
	};
}, G = (e, t) => t[e] ?? t.other;
function K(e, t, n) {
	return (r = {}, i) => {
		let a = W(t, n, i), o = (e, t = !1) => Array.isArray(e) ? e.reduce((e, n) => {
			if (n === "#" && t) return e + U;
			if (j(n)) return e + n;
			let [i, s, c] = n, l = {};
		...
		return j(s) && V.test(s) ? H(s) : j(s) ? s : s ? String(s) : "";
	};
}
var q = Object.defineProperty, J = (e, t, n) => t in e ? q(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Y = (e, t, n) => (J(e, typeof t == "symbol" ? t : t + "", n), n), X = class {
	constructor() {
		Y(this, "_events", {});
	}
	on(e, t) {
...
}, ie = Object.defineProperty, ae = (e, t, n) => t in e ? ie(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (ae(e, typeof t == "symbol" ? t : t + "", n), n), oe = class extends X {
	constructor(e) {
		super(), Z(this, "_locale", ""), Z(this, "_locales"), Z(this, "_localeData", {}), Z(this, "_messages", {}), Z(this, "_missing"), Z(this, "_messageCompiler"), Z(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(ne), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? N, e.locales);
	}
	get locale() {
		return this._locale;
	}
	...
	_(e, t, n) {
		...
		let r = n?.message;
		e ||= "", j(e) || (t = e.values || t, r = e.message, e = e.id);
		...
		let s = i || r || e;
		return j(s) && (this._messageCompiler ? s = this._messageCompiler(s) : console.warn(`Uncompiled message detected! Message:
...
`)), j(s) && V.test(s) ? H(s) : j(s) ? s : K(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
		return F(this._locales || this._locale, e, t);
	}
	number(e, t) {
...
function xe() {
	...
	return /* @__PURE__ */ c("div", {
		...
		children: /* @__PURE__ */ c("select", {
			...
			children: _e.map((e) => /* @__PURE__ */ c("option", {
				value: e,
				children: ve(e)
			}, e))
		})
...
var Se = e(null), Ce = ({ i18n: e, defaultComponent: r, children: o }) => {
	...
	}, [e, l]), s.current ? /* @__PURE__ */ c(Se.Provider, {
		value: u,
		children: o
...
function Te() {
	return /* @__PURE__ */ c(we, { children: /* @__PURE__ */ c(xe, {}) });
}
//#endregion
