...
function P(e, t) {
	return /^::/.test(e) ? te(M(e.substring(2)), void 0, t) : e;
}
function F(e, t = (e) => e) {
...
var L = (e) => typeof e == "string", re = (e) => typeof e == "function", R = /* @__PURE__ */ new Map(), z = "en";
function B(e) {
...
}), Y = "%__lingui_octothorpe__%", ie = (e, t, n = {}) => {
...
var se = Object.defineProperty, ce = (e, t, n) => t in e ? se(e, t, {
	...
	writable: !0,
	value: n
}) : e[t] = n, le = (e, t, n) => (ce(e, typeof t == "symbol" ? t : t + "", n), n), X = class {
	constructor() {
		le(this, "_events", {});
	}
	on(e, t) {
	...
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (de(e, typeof t == "symbol" ? t : t + "", n), n), fe = class extends X {
	constructor(e) {
		super(), Z(this, "_locale", ""), Z(this, "_locales"), Z(this, "_localeData", {}), Z(this, "_messages", {}), Z(this, "_missing"), Z(this, "_messageCompiler"), Z(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(I), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? z, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), L(s) && q.test(s) ? J(s) : L(s) ? s : oe(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
