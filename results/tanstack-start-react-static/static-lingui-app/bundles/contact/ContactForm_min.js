	...
	return /* @__PURE__ */ l("form", {
		...
		children: [
			...
			/* @__PURE__ */ l("div", { children: [/* @__PURE__ */ c("label", {
				...
				children: [
					/* @__PURE__ */ c("option", { children: e._("contact-form.bugReport") }),
					/* @__PURE__ */ c("option", { children: e._("contact-form.newBenchmarkIdea") }),
					/* @__PURE__ */ c("option", { children: e._("contact-form.methodologyQuestion") }),
					/* @__PURE__ */ c("option", { children: e._("contact-form.contribution") }),
					/* @__PURE__ */ c("option", { children: e._("contact-form.other") })
				]
			})] }),
			/* @__PURE__ */ l("div", { children: [/* @__PURE__ */ c("label", {
				htmlFor: a,
