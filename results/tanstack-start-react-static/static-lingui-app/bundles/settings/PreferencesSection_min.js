import { cloneElement as e, createContext as t, useCallback as n, useContext as r, useEffect as i, useId as a, useMemo as o, useRef as s, useState as c } from "react";
...
function h(t, n = {}) {
	...
	for (let [t, o, s] of g(r)) {
		...
		(!r || m[r.type] && o) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${t}' as it is not declared in the original translation`), r = /* @__PURE__ */ u(l, {})), Array.isArray(r) && (r = /* @__PURE__ */ u(l, { children: r })), a.push(e(r, { key: i() }, o ? h(o, n) : r.props.children)), s && a.push(s);
	}
...
function v(e) {
	...
	else if (n && typeof n != "function") return console.error(`Invalid value supplied to prop \`component\`. It must be a React component, provided ${n}`), /* @__PURE__ */ u(p, {
		...m,
		children: f
	});
	return typeof t == "function" ? t(m) : /* @__PURE__ */ u(n || p, {
		...m,
		children: f
	});
}
var y = ({ children: e }) => e, b = (e) => {
	...
	return Object.entries(e.values).forEach(([e, r]) => {
		...
		n[i] = /* @__PURE__ */ u(l, { children: r }), t[e] = `<${i}/>`;
	}), {
		values: t,
		components: n
	};
	...
	}, [e, o]), a.current ? /* @__PURE__ */ u(x.Provider, {
		value: l,
		children: r
			...
			children: [
				/* @__PURE__ */ d("div", {
					...
					children: [/* @__PURE__ */ d("div", { children: [/* @__PURE__ */ u("p", {
						...
						children: /* @__PURE__ */ u("span", { className: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" })
					})]
				}),
				/* @__PURE__ */ d("div", {
					className: "flex items-center justify-between",
					children: [/* @__PURE__ */ d("div", { children: [/* @__PURE__ */ u("p", {
						...
						children: /* @__PURE__ */ u("span", { className: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" })
					})]
				}),
				/* @__PURE__ */ d("div", { children: [/* @__PURE__ */ u("label", {
					...
					children: [
						/* @__PURE__ */ u("option", { children: i18n._("settings.preferences.english") }),
						/* @__PURE__ */ u("option", { children: i18n._("settings.preferences.french") }),
						/* @__PURE__ */ u("option", { children: i18n._("settings.preferences.german") }),
						/* @__PURE__ */ u("option", { children: i18n._("settings.preferences.spanish") }),
						/* @__PURE__ */ u("option", { children: i18n._("settings.preferences.japanese") }),
						/* @__PURE__ */ u("option", { children: i18n._("settings.preferences.chinese") }),
						/* @__PURE__ */ u("option", { children: i18n._("settings.preferences.arabic") })
					]
				})] })
			]
		})]
...
}), Y = "%__lingui_octothorpe__%", me = (e, t, n = {}) => {
...
var _e = Object.defineProperty, ve = (e, t, n) => t in e ? _e(e, t, {
	...
	writable: !0,
	value: n
}) : e[t] = n, ye = (e, t, n) => (ve(e, typeof t == "symbol" ? t : t + "", n), n), be = class {
	constructor() {
		ye(this, "_events", {});
	}
	on(e, t) {
	...
	writable: !0,
	value: n
}) : e[t] = n, X = (e, t, n) => (Se(e, typeof t == "symbol" ? t : t + "", n), n), Z = class extends be {
	constructor(e) {
...
`)), L(s) && q.test(s) ? J(s) : L(s) ? s : ge(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
...
function Ee() {
	return /* @__PURE__ */ u(Te, { children: /* @__PURE__ */ u(T, {}) });
}
//#endregion
