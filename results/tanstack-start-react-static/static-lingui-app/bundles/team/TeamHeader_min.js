...
function m(t, n = {}) {
	...
	for (let [t, o, s] of h(r)) {
		...
		(!r || p[r.type] && o) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${t}' as it is not declared in the original translation`), r = /* @__PURE__ */ l(c, {})), Array.isArray(r) && (r = /* @__PURE__ */ l(c, { children: r })), a.push(e(r, { key: i() }, o ? m(o, n) : r.props.children)), s && a.push(s);
	}
...
function _(e) {
	...
	else if (n && typeof n != "function") return console.error(`Invalid value supplied to prop \`component\`. It must be a React component, provided ${n}`), /* @__PURE__ */ l(p, {
		...h,
		children: f
	});
	return typeof t == "function" ? t(h) : /* @__PURE__ */ l(n || p, {
		...h,
		children: f
	});
}
var v = ({ children: e }) => e, y = (e) => {
	...
	return Object.entries(e.values).forEach(([e, r]) => {
		...
		n[i] = /* @__PURE__ */ l(c, { children: r }), t[e] = `<${i}/>`;
	}), {
		values: t,
		components: n
	};
...
var C = ({ i18n: e, defaultComponent: t, children: r }) => {
	...
	}, [e, c]), a.current ? /* @__PURE__ */ l(b.Provider, {
		value: u,
		children: r
...
function De() {
	return /* @__PURE__ */ l(Ee, { children: /* @__PURE__ */ l(E, {}) });
}
//#endregion
