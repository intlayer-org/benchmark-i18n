...
var T = () => "Products", E = () => "Produits", D = () => "Productos", O = () => "Produkte", k = () => "Prodotti", A = () => "Produtos", j = () => "产品", M = () => "製品", N = () => "제품", P = () => "Продукты", F = ((e = {}, t = {}) => {
	let n = t.locale ?? g();
	return n === "en" ? T(e) : n === "fr" ? E(e) : n === "es" ? D(e) : n === "de" ? O(e) : n === "it" ? k(e) : n === "pt" ? A(e) : n === "zh" ? j(e) : n === "ja" ? M(e) : n === "ko" ? N(e) : P(e);
}), I = () => "Tools and services to streamline your internationalization workflow.", L = () => "Des outils et services pour rationaliser votre flux de travail d'internationalisation.", R = () => "Herramientas y servicios para agilizar tu flujo de trabajo de internacionalización.", z = () => "Tools und Services zur Optimierung Ihres Internationalisierungs-Worflows.", ee = () => "Strumenti e servizi per snellire il flusso di lavoro dell'internazionalizzazione.", B = () => "Ferramentas e serviços para agilizar seu fluxo de trabalho de internacionalização.", V = () => "简化国际化工作流程的工具和服务。", H = () => "国際化ワークフローを合理化するためのツールとサービス。", U = () => "국제화 워크플로우를 간소화하기 위한 도구 및 서비스.", W = () => "Инструменты и услуги для оптимизации рабочего процесса интернационализации.", G = ((e = {}, t = {}) => {
	let n = t.locale ?? g();
...
function se() {
	return /* @__PURE__ */ t(oe, { children: /* @__PURE__ */ t(ae, {}) });
}
//#endregion
