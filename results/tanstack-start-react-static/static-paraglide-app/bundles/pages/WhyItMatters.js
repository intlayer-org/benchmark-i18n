...
/** @typedef {{}} Why_It_Matters_Whythesemetricsmatter3Inputs */
...
*
* @param {Why_It_Matters_Whythesemetricsmatter3Inputs} inputs
...
//#endregion
//#region src/paraglide/messages/why_it_matters_bundlesize1.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Why_It_Matters_Bundlesize1Inputs */
...
* | "Bundle Size" |
*
* @param {Why_It_Matters_Bundlesize1Inputs} inputs
* @param {{ locale?: "en" | "fr" | "es" | "de" | "it" | "pt" | "zh" | "ja" | "ko" | "ru" }} options
* @returns {LocalizedString}
*/
...
//#endregion
//#region src/paraglide/messages/why_it_matters_thebundleisthedata4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Why_It_Matters_Thebundleisthedata4Inputs */
...
* | output |
* | --- |
* | "The bundle is the data shipped to every user across the globe. A larger bundle means longer download times — especially on slow 3G connections common in many..." |
*
* @param {Why_It_Matters_Thebundleisthedata4Inputs} inputs
* @param {{ locale?: "en" | "fr" | "es" | "de" | "it" | "pt" | "zh" | "ja" | "ko" | "ru" }} options
* @returns {LocalizedString}
*/
...
//#endregion
//#region src/paraglide/messages/why_it_matters_renderinghydration1.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Why_It_Matters_Renderinghydration1Inputs */
...
* | "Rendering & Hydration" |
*
* @param {Why_It_Matters_Renderinghydration1Inputs} inputs
* @param {{ locale?: "en" | "fr" | "es" | "de" | "it" | "pt" | "zh" | "ja" | "ko" | "ru" }} options
* @returns {LocalizedString}
*/
...
//#endregion
//#region src/paraglide/messages/why_it_matters_connectingalargejsondictionary4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Why_It_Matters_Connectingalargejsondictionary4Inputs */
...
* | output |
* | --- |
* | "Connecting a large JSON dictionary to every component creates a hidden dependency: any change in the translation context can trigger re-renders across the en..." |
*
* @param {Why_It_Matters_Connectingalargejsondictionary4Inputs} inputs
* @param {{ locale?: "en" | "fr" | "es" | "de" | "it" | "pt" | "zh" | "ja" | "ko" | "ru" }} options
* @returns {LocalizedString}
*/
...
//#endregion
//#region src/paraglide/messages/why_it_matters_dynamicloading1.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Why_It_Matters_Dynamicloading1Inputs */
...
* | "Dynamic Loading" |
*
* @param {Why_It_Matters_Dynamicloading1Inputs} inputs
* @param {{ locale?: "en" | "fr" | "es" | "de" | "it" | "pt" | "zh" | "ja" | "ko" | "ru" }} options
* @returns {LocalizedString}
*/
...
//#endregion
//#region src/paraglide/messages/why_it_matters_loadingalltranslationsupfrontoverloads4.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Why_It_Matters_Loadingalltranslationsupfrontoverloads4Inputs */
...
* | output |
* | --- |
* | "Loading all translations upfront overloads the initial payload. Dynamic (lazy) loading splits translations by route or namespace, sending only what the curre..." |
*
* @param {Why_It_Matters_Loadingalltranslationsupfrontoverloads4Inputs} inputs
* @param {{ locale?: "en" | "fr" | "es" | "de" | "it" | "pt" | "zh" | "ja" | "ko" | "ru" }} options
* @returns {LocalizedString}
*/
