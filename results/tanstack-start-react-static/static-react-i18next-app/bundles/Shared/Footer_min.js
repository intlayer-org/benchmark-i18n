...
function Re() {
	let { t: e } = Ie("shared"), t = l({ strict: !1 }).locale ?? "en", n = [
		{
			...
			children: [/* @__PURE__ */ d("div", {
				...
				children: [
					...
					/* @__PURE__ */ d("div", { children: [/* @__PURE__ */ u("h3", {
						...
						className: "space-y-1",
						children: n.map((e) => /* @__PURE__ */ u("li", { children: e.isInternal ? /* @__PURE__ */ u(c, {
							to: e.to,
							params: { locale: t },
...
function We() {
	return /* @__PURE__ */ u(Ue, { children: /* @__PURE__ */ u(Re, {}) });
}
//#endregion
