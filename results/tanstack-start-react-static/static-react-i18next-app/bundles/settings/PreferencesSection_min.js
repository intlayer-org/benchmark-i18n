...
function L(e, t) {
	let { [re]: n } = e(ie()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var R = (e) => !p(e) && typeof e != "boolean" && typeof e != "number", z = class e extends P {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new ae(K());
			...
			children: [
				/* @__PURE__ */ u("div", {
					...
					children: [/* @__PURE__ */ u("div", { children: [/* @__PURE__ */ l("p", {
						...
						children: /* @__PURE__ */ l("span", { className: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" })
					})]
				}),
				/* @__PURE__ */ u("div", {
					className: "flex items-center justify-between",
					children: [/* @__PURE__ */ u("div", { children: [/* @__PURE__ */ l("p", {
						...
						children: /* @__PURE__ */ l("span", { className: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" })
					})]
				}),
				/* @__PURE__ */ u("div", { children: [/* @__PURE__ */ l("label", {
					...
					children: [
						/* @__PURE__ */ l("option", { children: "English (en)" }),
						/* @__PURE__ */ l("option", { children: "French (fr)" }),
						/* @__PURE__ */ l("option", { children: "German (de)" }),
						/* @__PURE__ */ l("option", { children: "Spanish (es)" }),
						/* @__PURE__ */ l("option", { children: "Japanese (ja)" }),
						/* @__PURE__ */ l("option", { children: "Chinese Simplified (zh-CN)" }),
						/* @__PURE__ */ l("option", { children: "Arabic (ar)" })
					]
				})] })
			]
		})]
...
function Be() {
	return /* @__PURE__ */ l(ze, { children: /* @__PURE__ */ l(Le, {}) });
}
//#endregion
