...
function f(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = d(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
var p = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, f(r)), n)), n;
}, m = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, h = {};
(function(e) {
	function t(e, t) {
		var n;
...
(s = console.assert) == null || s.call(console, g), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g"), (() => {
...
var x = () => {
	...
	let { tolgee: a, options: o } = x(), s = l(e), c = u(s).join(":"), d = Object.assign(Object.assign({}, o), n), { rerender: f, instance: p } = S(), m = i([]);
	m.current = [];
	let h = a.isLoaded(s);
	r(() => {
		let e = a.on("update", f);
