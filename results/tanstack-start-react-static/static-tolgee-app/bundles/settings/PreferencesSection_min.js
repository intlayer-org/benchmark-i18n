...
var C = () => {
	...
	let { tolgee: i, options: o } = C(), s = d(e), c = f(s).join(":"), l = Object.assign(Object.assign({}, o), n), { rerender: u, instance: p } = w(), m = a([]);
	m.current = [];
	let h = i.isLoaded(s);
	r(() => {
		let e = i.on("update", u);
			...
			children: [
				/* @__PURE__ */ c("div", {
					...
					children: [/* @__PURE__ */ c("div", { children: [/* @__PURE__ */ s("p", {
						...
						children: /* @__PURE__ */ s("span", { className: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" })
					})]
				}),
				/* @__PURE__ */ c("div", {
					className: "flex items-center justify-between",
					children: [/* @__PURE__ */ c("div", { children: [/* @__PURE__ */ s("p", {
						...
						children: /* @__PURE__ */ s("span", { className: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" })
					})]
				}),
				/* @__PURE__ */ c("div", { children: [/* @__PURE__ */ s("label", {
					...
					children: [
						/* @__PURE__ */ s("option", { children: e("preferencesSection.englishEn", "English (en)") }),
						/* @__PURE__ */ s("option", { children: e("preferencesSection.frenchFr", "French (fr)") }),
						/* @__PURE__ */ s("option", { children: e("preferencesSection.germanDe", "German (de)") }),
						/* @__PURE__ */ s("option", { children: e("preferencesSection.spanishEs", "Spanish (es)") }),
						/* @__PURE__ */ s("option", { children: e("preferencesSection.japaneseJa", "Japanese (ja)") }),
						/* @__PURE__ */ s("option", { children: e("preferencesSection.chineseSimplifiedZhCn", "Chinese Simplified (zh-CN)") }),
						/* @__PURE__ */ s("option", { children: e("preferencesSection.arabicAr", "Arabic (ar)") })
					]
				})] })
			]
		})]
