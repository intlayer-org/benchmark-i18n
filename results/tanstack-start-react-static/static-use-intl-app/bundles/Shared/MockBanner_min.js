...
function U(e) {
	e.forEach((e) => {
		...
		else A(e) && ge(e.style) || (j(e) || me(e)) && F(e.style) ? delete e.style.location : P(e) && U(e.children);
	});
}
function je(e, t = {}) {
	t = {
...
function nt() {
	return /* @__PURE__ */ s(tt, { children: /* @__PURE__ */ s(Ze, {}) });
}
//#endregion
