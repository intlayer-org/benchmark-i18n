...
function OpenPositions() {
	...
	const openings = [
		...
		{
			title: _w_runtime_(143),
			location: _w_runtime_(137),
			type: _w_runtime_(144),
			dept: _w_runtime_(145),
			desc: _w_runtime_(146)
		},
		{
			title: _w_runtime_(147),
			location: _w_runtime_(148),
			type: _w_runtime_(138),
			dept: _w_runtime_(149),
			desc: _w_runtime_(150)
		},
		{
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("h2", {
		...
		children: openings.map((o) => {
			const _w_runtime_ = getRuntime("main");
