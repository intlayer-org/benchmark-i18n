...
var Q = n(void 0);
function Xe({ children: e, formats: t, getMessageFallback: n, locale: r, messages: i, now: s, onError: c, timeZone: u }) {
...
function tt() {
	let e = et("footer"), t = c({ strict: !1 }).locale ?? "en", n = [
		{
			label: e("github"),
...
function at() {
	return /* @__PURE__ */ l(it, { children: /* @__PURE__ */ l(tt, {}) });
}
//#endregion
