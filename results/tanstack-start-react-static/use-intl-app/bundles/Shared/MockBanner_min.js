...
var be = RegExp(`^${I.source}*`), xe = RegExp(`${I.source}*$`);
function R(e, t) {
	return {
		start: e,
		end: t
...
var Se = !!Object.fromEntries, Ce = !!String.prototype.trimStart, we = !!String.prototype.trimEnd, z = Se ? Object.fromEntries : function(e) {
	let t = {};
...
function H(e) {
	e.forEach((e) => {
		...
		else k(e) && _e(e.style) || (A(e) || he(e)) && P(e.style) ? delete e.style.location : N(e) && H(e.children);
	});
}
function Me(e, t = {}) {
	t = {
...
function Ue(e) {
	...
	return function({ cache: e, formats: n, formatters: i, getMessageFallback: a = Ve, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, ee, te) {
			...
			try {
				return Be(X(c, p), g, m && function(e) {
					let n = {};
...
function qe({ children: e, formats: t, getMessageFallback: n, locale: r, messages: i, now: c, onError: l, timeZone: u }) {
	let d = a(Q), f = o((() => d?.cache || ne()), [r, d?.cache]), p = o((() => d?.formatters || ie(f)), [f, d?.formatters]), m = o((() => ({
		...Ke({
			locale: r,
...
var Qe = () => /* @__PURE__ */ s("div", {
	className: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground",
	children: Ze()("mockBanner")
...
function nt() {
	return /* @__PURE__ */ s(tt, { children: /* @__PURE__ */ s(Qe, {}) });
}
//#endregion
