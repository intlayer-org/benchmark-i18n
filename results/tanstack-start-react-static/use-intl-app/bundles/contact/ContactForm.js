	...
	return /* @__PURE__ */ jsxs("form", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
				...
				children: [
					/* @__PURE__ */ jsx("option", { children: t("bugReport") }),
					/* @__PURE__ */ jsx("option", { children: t("newBenchmarkIdea") }),
					/* @__PURE__ */ jsx("option", { children: t("methodologyQuestion") }),
					/* @__PURE__ */ jsx("option", { children: tHeader("contact") }),
...
async function getMessages(locale) {
	const moduleLoader = messageModules[`../messages/${locale}.ts`] ?? messageModules["../messages/en.ts"];
	try {
		return (await moduleLoader()).default;
	} catch (error) {
		console.error(`Failed to load messages for locale: ${locale}`, error);
		return (await messageModules["../messages/en.ts"]()).default;
	}
}
//#endregion
