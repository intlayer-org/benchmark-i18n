			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
						...
						children: t("receiveWeeklyBenchmarkReports")
					})] }), /* @__PURE__ */ jsx("button", {
						type: "button",
				...
				/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
					...
					children: [
						/* @__PURE__ */ jsx("option", { children: t("englishEn") }),
						/* @__PURE__ */ jsx("option", { children: t("frenchFr") }),
						/* @__PURE__ */ jsx("option", { children: t("germanDe") }),
						/* @__PURE__ */ jsx("option", { children: t("spanishEs") }),
						/* @__PURE__ */ jsx("option", { children: t("japaneseJa") }),
						/* @__PURE__ */ jsx("option", { children: t("chineseSimplifiedZhCn") }),
						/* @__PURE__ */ jsx("option", { children: t("arabicAr") })
					]
				})] })
			]
		})]
...
async function getMessages(locale) {
	return (await _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({
		"../messages/de.ts": () => import("./de-BALbyVOY.js"),
		"../messages/en.ts": () => import("./en-C0ARhIX0.js"),
		"../messages/es.ts": () => import("./es-CbLEzbcI.js"),
		"../messages/fr.ts": () => import("./fr-C65hxNCw.js"),
		"../messages/it.ts": () => import("./it-HyeM8lag.js"),
		"../messages/ja.ts": () => import("./ja-C7vSRKvq.js"),
		"../messages/ko.ts": () => import("./ko-DirWQVfj.js"),
		"../messages/pt.ts": () => import("./pt-DxpoHPvl.js"),
		"../messages/ru.ts": () => import("./ru-DNQ2-bjn.js"),
		"../messages/zh.ts": () => import("./zh-BGkY0U_c.js")
