...
} }, d = (e, t) => u[e][t](), f = ["main"], p = "main", m = {}, h = {}, g = (e) => h[e];
l(p, d, f, {
	get: g,
	set: (e, t) => {
		h[e] = t, m[e]?.forEach((e) => {
...
var _ = (n) => {
	...
	return e(() => {
		let e = (e) => i(() => e);
		return m[n] ??= /* @__PURE__ */ new Set(), m[n].add(e), () => m[n].delete(e);
	}, [n]), r;
};
//#endregion
...
function b() {
	...
	function a() {
		...
		i(e), y(e), window.localStorage.setItem("theme", e);
	}
	let o = _("main"), s = r === "auto" ? o(21) : o(22, [r]);
