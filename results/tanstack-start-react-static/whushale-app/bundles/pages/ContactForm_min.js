...
} }, p = (e, t) => f[e][t](), m = ["main"], h = "main", g = {}, _ = {}, v = (e) => _[e];
d(h, p, m, {
	get: v,
	set: (e, t) => {
		_[e] = t, g[e]?.forEach((e) => {
...
var y = (t) => {
	...
	return e(() => {
		let e = (e) => i(() => e);
		return g[t] ??= /* @__PURE__ */ new Set(), g[t].add(e), () => g[t].delete(e);
	}, [t]), r;
};
//#endregion
//#region src/components/pages/contact/ContactForm.tsx
function b() {
	let e = t(), n = t(), a = t(), o = t(), s = y("main");
	return /* @__PURE__ */ i("form", {
		...
		children: [
			...
			/* @__PURE__ */ i("div", { children: [/* @__PURE__ */ r("label", {
				...
				children: [
					/* @__PURE__ */ r("option", { children: s(75) }),
					/* @__PURE__ */ r("option", { children: s(76) }),
					/* @__PURE__ */ r("option", { children: s(77) }),
					/* @__PURE__ */ r("option", { children: s(78) }),
					/* @__PURE__ */ r("option", { children: s(79) })
				]
			})] }),
			/* @__PURE__ */ i("div", { children: [/* @__PURE__ */ r("label", {
				htmlFor: o,
