...
import e, { Suspense, createContext, isValidElement, useCallback, useContext, useEffect, useMemo, useRef, useState } from "react";
...
(function() {
	if (de$3) return ye$2;
	de$3 = 1, Object.defineProperty(ye$2, "__esModule", { value: !0 }), ye$2.printAST = r, ye$2.doPrintAST = n, ye$2.printDateTimeSkeleton = a;
	var t = me$2, e = pe$2();
	function r(t) {
		return n(t, !1);
	}
...
function StartServer(props) {
	return jsx(RouterProvider, { router: props.router });
}
...
import * as import__tanstack_start_server_core from "@tanstack/start-server-core";
__reExport(esm_exports, import__tanstack_start_server_core);
var server_exports = __exportAll({
	StartServer: () => StartServer,
	defaultRenderHandler: () => defaultRenderHandler,
	defaultStreamHandler: () => defaultStreamHandler
});
__reExport(server_exports, esm_exports);
...
function _e$1(e) {
	...
	return r ? r.call(e) : (e = de$2(e), t = {}, n("next"), n("throw"), n("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function n(r) {
		t[r] = e[r] && function(t) {
...
var it$2 = !!String.prototype.startsWith && "_a".startsWith("a", 1);
	...
	return e.prototype.parse = function() {
		...
		switch (a) {
			...
			case "time":
				...
				if (c && pt$2(null == c ? void 0 : c.style, "::", 0)) {
		...
		if (pt$2(this.message, e, this.offset())) {
...
function or({ children: e$3, defaultLocale: t = A$1, renderVariable: r }) {
	const o = (e$2) => e.isValidElement(e$2) ? ((e$4) => {
		const o = nr(e$4);
		if (er(e$4.props)) {
			const { variableType: n, variableValue: o, variableOptions: i, injectionType: a } = tr(e$4.props);
			return r({
				variableType: n,
				variableValue: o,
				variableOptions: i,
		...
		if ("plural" === o?.transformation) {
			const r = o.branches || {};
			return i(rr(e$4.props.n, [t], r) || e$4.props.children);
		}
		if ("branch" === o?.transformation) {
			let { children: t, branch: r, "data-_gt": n, ...a } = e$4.props;
			return a = o.branches || {}, i(void 0 !== a[r] ? a[r] : t);
		}
		return "fragment" === o?.transformation ? e.createElement(e.Fragment, {
			key: e$4.props.key,
			children: i(e$4.props.children)
		}) : e$4.props.children ? e.cloneElement(e$4, {
			...e$4.props,
			"data-_gt": void 0,
			children: i(e$4.props.children)
		}) : e.cloneElement(e$4, {
	...
	})(e$2) : e$2, i = (e$5) => Array.isArray(e$5) ? e.Children.map(e$5, o) : o(e$5);
	return i(e$3);
}
function ir(e, t) {
...
function sr(e$8, t = 0) {
	...
	function a(e$7) {
		return isValidElement(e$7) ? function(e$6) {
			const { props: t } = e$6, r = i(e$6), o = {
				...t,
				"data-_gt": r
			};
			return t.children && !r.variableType && (o.children = s(t.children)), e$6.type === e.Fragment && (o["data-_gt"].transformation = "fragment"), e.cloneElement(e$6, o);
		}(e$7) : e$7;
	}
	function s(e$9) {
		return Array.isArray(e$9) ? e.Children.map(e$9, a) : a(e$9);
	}
	return s(e$8);
}
...
var fr$1 = (e, t) => `${cr} Error: error rendering string ${t ? `for id: "${t}"` : ""} original message: "${e}"`;
...
var Lr = (e$10) => {
	return t = e$10, e.isValidElement(t) ? Hr(e$10) : "number" == typeof e$10 ? e$10.toString() : e$10;
	var t;
};
function Pr(e) {
...
function Ir({ sourceElement: e$11, targetElement: t, locales: r = [A$1], renderVariable: o }) {
	const { props: i } = e$11, a = i["data-_gt"], s = a?.transformation, c = t.d, l = {};
	if (c && Object.entries(wr).forEach(([e, t]) => {
		c[e] && (l[t] = c[e]);
	}), "plural" === s) {
		const n = e$11.props.n;
		return Or({
			source: rr(n, r, a.branches || {}) || e$11.props.children,
	...
	if ("branch" === s) {
		...
		return Or({
			source: (a.branches || {})[e] || n,
			target: (t.d?.b || {})[e] || t.c,
			locales: r,
			renderVariable: o
		});
	}
	return "fragment" === s && t.c ? e.createElement(e.Fragment, {
		key: e$11.props.key,
		children: Or({
			source: i.children,
			target: t.c,
	...
	}) : i?.children && t?.c ? e.cloneElement(e$11, {
		...i,
		...l,
		"data-_gt": void 0,
		children: Or({
...
function Or({ source: t, target: r, locales: o = [A$1], renderVariable: i }) {
	...
	if (Array.isArray(r) && !Array.isArray(t) && t && (t = [t]), Array.isArray(t) && Array.isArray(r)) {
		const a = {}, s = {}, c = {}, l = t.filter((e$12) => {
			if (e.isValidElement(e$12)) {
				if (!er(e$12.props)) return !0;
				{
					const { variableName: t, variableValue: r, variableOptions: n, injectionType: o } = tr(e$12.props);
					a[t] = r, s[t] = n, c[t] = o;
				}
			}
			return !1;
		...
		return r.map((t, r) => {
			if ("string" == typeof t) return jsx(e.Fragment, { children: t }, `string_${r}`);
			if (N$2(t)) return jsx(e.Fragment, { children: i({
				variableType: t.v || "v",
				variableValue: a[t.k],
			...
			const l = u(t);
			return l ? jsx(e.Fragment, { children: Ir({
				sourceElement: l,
				targetElement: t,
				locales: o,
				renderVariable: i
	...
	if (r && "object" == typeof r && !Array.isArray(r)) {
		const e$13 = N$2(r) ? "variable" : "element";
		if (e.isValidElement(t)) {
			if ("element" === e$13) return Ir({
				sourceElement: t,
				targetElement: r,
				locales: o,
				renderVariable: i
...
function un({ children: r }) {
	return jsx(Fragment, { children: r });
}
...
function fn({ children: r, locales: n, options: o = {} }) {
	...
	return jsx(Fragment, { children: c });
}
function dn({ date: r, children: n, value: o, unit: i, baseDate: s, locales: c, options: l = {} }) {
	...
	return jsx(Fragment, { children: d });
}
...
function Tn({ children: r, id: n, context: o, _hash: i, ...a }) {
	...
	if (!h || u && !E && !f || null === E) return jsx(Fragment, { children: T() });
...
function Bn({ gt: e, translations: t, locale: r, defaultLocale: n, translationRequired: o, developmentApiEnabled: i, registerIcuForTranslation: a, environment: s }) {
	function c({ message: t, variables: r, locales: n, fallback: o, id: i, maxChars: a, format: l }) {
		try {
			...
			if ("production" === s) console.warn(((e, t) => `${cr} Warning: failed to render string ${t ? `for id: "${t}"` : ""} original message: "${e}"`)(t, i), "Error: ", l);
				...
				if (!o) throw new Error(`${fr$1(t, i)} Error: ${l}`);
				console.error(fr$1(t, i), "Error: ", l);
			}
			if (o) return c({
				message: o,
				locales: n,
	...
	return {
		...
		_mFunction: (e, s = {}, l) => {
			...
			}), v(d, [n])) : (console.warn(dr(d, en$1(e), "m")), v(d, [n]));
		},
...
var he = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = de$1(this.buffer);
	}
	update(e) {
		pe(this), _e(e);
	...
	digestInto(e) {
		...
		const i = de$1(e), c = this.outputLen;
...
var p = createIsomorphicFn().server(function({ defaultLocale: e, locales: t, customMapping: r }) {
	var n;
	const a = [], c = (0, server_exports.getCookie)(rr$1);
	c && a.push(c);
	if ("false" === process.env._GENERALTRANSLATION_IGNORE_BROWSER_LOCALES) {
		const e = (null === (n = (0, server_exports.getRequestHeader)("accept-language")) || void 0 === n ? void 0 : n.split(",").map((e) => {
			var t;
	...
	return h || (h = 1, function() {
		function e$1(t) {
			...
			if ("object" == typeof t) switch ("number" == typeof t.tag && console.error("Received an unexpected object in getComponentNameFromType(). This is likely a bug in React. Please file an issue."), t.$$typeof) {
				...
				case O: return null !== (r = t.displayName || null) ? r : e$1(t.type) || "Memo";
				case j:
