	...
	function i({ source: i, target: a, locales: o = ["en"], enableI18n: s }) {
		...
		if (Array.isArray(a) && !Array.isArray(i) && i && (i = [i]), Array.isArray(i) && Array.isArray(a)) {
			...
			return a.map((i, a) => {
				...
				if (Qt(i)) return v(t.Fragment, { children: e({
					variableType: i.v || "v",
					variableValue: n[i.k],
...
var A = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/gt-react-app/src/components/Footer.tsx";
function vo() {
	let e = _({ strict: !1 }).locale ?? "en", t = [
		{
			label: y(go, { children: "GitHub" }, void 0, !1, {
				fileName: A,
				lineNumber: 10,
				columnNumber: 14
			}, this),
		...
		{
			label: y(go, { children: "Methodology" }, void 0, !1, {
				fileName: A,
				lineNumber: 15,
				columnNumber: 14
			}, this),
		...
		{
			label: y(go, { children: "Contributing" }, void 0, !1, {
				fileName: A,
				lineNumber: 20,
				columnNumber: 14
			}, this),
			...
			children: [y("div", {
				...
				children: [
					y("div", { children: [y("h3", {
						...
						children: y(go, { children: "i18n Benchmark" }, void 0, !1, {
							fileName: A,
							lineNumber: 32,
							columnNumber: 15
						}, this)
						...
						children: y(go, { children: "An open-source test application for measuring the real-world impact of internationalization libraries on bundle size, loading time, and app reactivity." }, void 0, !1, {
							fileName: A,
							lineNumber: 35,
							columnNumber: 15
						}, this)
					...
					y("div", { children: [y("h3", {
						className: "mb-2 text-sm font-semibold text-foreground",
						children: y(go, { children: "Resources" }, void 0, !1, {
							fileName: A,
							lineNumber: 44,
							columnNumber: 15
						}, this)
					...
					y("div", { children: [y("h3", {
						className: "mb-2 text-sm font-semibold text-foreground",
						children: y(go, { children: "Contact" }, void 0, !1, {
							fileName: A,
							lineNumber: 74,
							columnNumber: 15
						}, this)
				...
				children: y(go, { children: "i18n Benchmark — Open-source project. Built with React, Vite & TanStack Router." }, void 0, !1, {
					fileName: A,
					lineNumber: 82,
					columnNumber: 11
				}, this)
...
var yo = 6e4, bo = (e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`, xo = "DEFAULT_TERMINATOR_KEY", So = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	constructor(e, t = {}) {
		...
		if (!So[t.style ?? "ellipsis"]) throw Error(bo(t.style ?? "ellipsis"));
		let n, r;
		if (t.maxChars !== void 0) {
			n = t.style ?? "ellipsis";
			let e = new Intl.Locale(this.locale).language;
			r = So[n][e] || So[n].DEFAULT_TERMINATOR_KEY;
		}
	...
	get(e, ...t) {
		...
		return a === void 0 && (a = new wo[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}(), To = "https://cdn.gtx.dev", Eo = {
	GTJSON: ["GTJSON"],
	JSON: ["JSON"],
	PO: ["PO"],
	POT: ["POT", "PO"],
...
function Oo(e) {
	...
	if (!Do(e.fileFormat, e.transformFormat)) return `Unsupported file format transform: ${e.fileFormat} -> ${e.transformFormat}`;
}
function ko(e) {
	for (let t of e) {
		let e = Oo(t);
...
function Mo(e) {
	...
	if (Array.isArray(e)) {
		let t = "[";
		for (let n = 0; n < e.length; n++) n && (t += ","), t += Mo(e[n]) || "null";
		return t + "]";
	}
	let t = Object.keys(e).sort(), n = "";
	for (let r of t) {
...
var Fo = re({
	...
	__await: () => $o,
	__awaiter: () => Go,
	__classPrivateFieldGet: () => os,
	__classPrivateFieldIn: () => cs,
	__classPrivateFieldSet: () => ss,
	__createBinding: () => ps,
	__decorate: () => Ro,
	__disposeResources: () => us,
	__esDecorate: () => Bo,
	__exportStar: () => qo,
	__extends: () => Io,
	__generator: () => Ko,
	...
	__read: () => Yo,
	__rest: () => Lo,
	__rewriteRelativeImportExtension: () => ds,
	__runInitializers: () => Vo,
	__setFunctionName: () => Uo,
	__spread: () => Xo,
	__spreadArray: () => Qo,
	__spreadArrays: () => Zo,
	__values: () => Jo,
...
function qo(e, t) {
	for (var n in e) n !== "default" && !Object.prototype.hasOwnProperty.call(t, n) && ps(t, e, n);
}
function Jo(e) {
...
function Xo() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(Yo(arguments[t]));
	return e;
}
function Zo() {
...
function ns(e) {
	...
	return t ? t.call(e) : (e = typeof Jo == "function" ? Jo(e) : e[Symbol.iterator](), n = {}, r("next"), r("throw"), r("return"), n[Symbol.asyncIterator] = function() {
		return this;
	}, n);
	function r(t) {
		n[t] = e[t] && function(n) {
...
function is(e) {
	...
	var t = {};
	if (e != null) for (var n = hs(e), r = 0; r < n.length; r++) n[r] !== "default" && ps(t, e, n[r]);
	return ms(t, e), t;
}
function as(e) {
...
function us(e) {
	function t(t) {
		e.error = e.hasError ? new gs(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	function i() {
...
var fs, M, ps, ms, hs, gs, _s, vs = T((() => {
	...
	}, ps = Object.create ? (function(e, t, n, r) {
		r === void 0 && (r = n);
	...
	}, gs = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
		var r = Error(n);
...
function ks(e) {
	return !!(e && typeof e == "object" && e.type === ys.number);
}
function As(e) {
	return !!(e && typeof e == "object" && e.type === ys.dateTime);
}
var js = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, Ms = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Ns(e) {
	var t = {};
	return e.replace(Ms, function(e) {
		var n = e.length;
		switch (e[0]) {
			case "G":
...
function Fs(e) {
	...
	for (var t = e.split(Ps).filter(function(e) {
		return e.length > 0;
...
var Ls = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, Rs = /^(@+)?(\+|#+)?[rs]?$/g, zs = /(\*)(0+)|(#+)(0+)|(0+)/g, Bs = /^(0+)$/;
function Vs(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(Rs, function(e, n, r) {
...
function Us(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !Bs.test(e)) throw Error("Malformed concise eng/scientific notation");
	...
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "integer-width":
				...
				i.options[0].replace(zs, function(e, n, r, i, a, o) {
		...
		if (Ls.test(i.stem)) {
			...
			i.stem.replace(Ls, function(e, n, r, i, a, o) {
			...
			var a = i.options[0];
			a === "w" ? t = M(M({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = M(M({}, t), Vs(a)));
			continue;
		}
		if (Rs.test(i.stem)) {
			t = M(M({}, t), Vs(i.stem));
...
function qs(e, t) {
	for (var n = "", r = 0; r < e.length; r++) {
		...
		if (i === "j") {
			...
			var o = 1 + (a & 1), s = a < 2 ? 1 : 3 + (a >> 1), c = "a", l = Js(t);
...
function Js(e) {
	...
	var n = e.language, r;
	return n !== "root" && (r = e.maximize().region), (Ks[r || ""] || Ks[n || ""] || Ks[`${n}-001`] || Ks["001"])[0];
}
vs();
var Ys = RegExp(`^${js.source}*`), Xs = RegExp(`${js.source}*\$`);
function F(e, t) {
	return {
		start: e,
		end: t
...
var Zs = !!String.prototype.startsWith && "_a".startsWith("a", 1), Qs = !!String.fromCodePoint, $s = !!Object.fromEntries, ec = !!String.prototype.codePointAt, tc = !!String.prototype.trimStart, nc = !!String.prototype.trimEnd, rc = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, ic = !0;
try {
	ic = dc("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	ic = !1;
}
var ac = Zs ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, oc = Qs ? String.fromCodePoint : function() {
	...
	return t;
}, sc = $s ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
var fc;
if (ic) {
	var pc = dc("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	fc = function(e, t) {
		return pc.lastIndex = t, pc.exec(e)[1] ?? "";
	};
} else fc = function(e, t) {
	for (var n = [];;) {
		var r = cc(e, t);
		if (r === void 0 || vc(r) || yc(r)) break;
...
var mc = function() {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			} else if (i === 60 && !this.ignoreTag && hc(this.peek() || 0)) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !hc(this.char())) return this.error(N.INVALID_TAG, F(o, this.clonePosition()));
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && _c(this.char());) this.bump();
		...
		return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !gc(this.peek() || 0)) ? (this.bump(), "<") : null;
		...
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), oc(n));
		...
		var e = this.clonePosition(), t = this.offset(), n = fc(this.message, t), r = t + n.length;
		...
		switch (a) {
			...
			case "time":
				...
				if (s && ac(s?.style, "::", 0)) {
					...
					var m = p;
					this.locale && (m = qs(p, this.locale));
					var u = {
						type: ys.dateTime,
						pattern: m,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? Ns(m) : {}
					};
					return {
						val: {
		...
		for (; !this.isEOF() && vc(this.char());) this.bump();
...
function bc(e) {
	e.forEach(function(e) {
		if (delete e.location, Ts(e) || Es(e)) for (var t in e.options) delete e.options[t].location, bc(e.options[t].value);
		else Ss(e) && ks(e.style) || (Cs(e) || ws(e)) && As(e.style) ? delete e.style.location : Os(e) && bc(e.children);
	});
}
function xc(e, t) {
	t === void 0 && (t = {}), t = M({
	...
	var n = new mc(e, t).parse();
	if (n.err) {
		var r = SyntaxError(N[n.err.kind]);
		throw r.location = n.err.location, r.originalMessage = n.err.message, r;
	}
	return t?.captureLocation || bc(n.val), n.val;
}
var Sc = ne(((e) => {
	...
	Object.defineProperty(e, "__esModule", { value: !0 }), vs(), ae(Fo), Sc();
})), wc = Sc();
Cc();
function Tc({ icuString: e, shouldVisit: t, visitor: n, options: { recurseIntoVisited: r = !0, ...i } }) {
	let a = xc(e, i);
	return o(a), a;
	function o(e) {
		e.map(s);
...
var Dc = RegExp(`^${Ec}$`);
function Oc(e) {
	return e.type === wc.TYPE.select && Dc.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === wc.TYPE.literal);
}
function kc(e) {
	if (!e.includes("_gt_")) return e;
	let t = [];
...
function Ac(e, t) {
	var n = t && t.cache ? t.cache : Bc, r = t && t.serializer ? t.serializer : Rc;
	return (t && t.strategy ? t.strategy : Fc)(e, {
		cache: n,
		serializer: r
	});
}
...
function Fc(e, t) {
	var n = e.length === 1 ? Mc : Nc;
	return Pc(e, this, n, t.cache.create(), t.serializer);
}
function Ic(e, t) {
	return Pc(e, this, Nc, t.cache.create(), t.serializer);
}
function Lc(e, t) {
	return Pc(e, this, Mc, t.cache.create(), t.serializer);
}
var Rc = function() {
...
var Uc = function(e) {
	...
	Io(t, e);
	function t(t, n, r, i) {
		return e.call(this, `Invalid values for "${t}": "${n}". Options are "${Object.keys(r).join("\", \"")}"`, Hc.INVALID_VALUE, i) || this;
	}
	return t;
}(Uc), Gc = function(e) {
	Io(t, e);
	function t(t, n, r) {
		return e.call(this, `Value for "${t}" must be of type ${n}`, Hc.INVALID_VALUE, r) || this;
	}
	return t;
}(Uc), Kc = function(e) {
	Io(t, e);
	function t(t, n) {
		return e.call(this, `The intl string context variable "${t}" was not provided to the string "${n}"`, Hc.MISSING_VALUE, n) || this;
	}
	return t;
}(Uc), I;
(function(e) {
...
function Yc(e, t, n, r, i, a, o) {
	...
	for (var s = [], c = 0, l = e; c < l.length; c++) {
		...
		if (Cs(u)) {
			var p = typeof u.style == "string" ? r.date[u.style] : As(u.style) ? u.style.parsedOptions : void 0;
			s.push({
				type: I.literal,
		...
		if (ws(u)) {
			var p = typeof u.style == "string" ? r.time[u.style] : As(u.style) ? u.style.parsedOptions : r.time.medium;
			s.push({
				type: I.literal,
				value: n.getDateTimeFormat(t, p).format(f)
			});
		...
		if (Ss(u)) {
			var p = typeof u.style == "string" ? r.number[u.style] : ks(u.style) ? u.style.parsedOptions : void 0;
		...
		if (Os(u)) {
			...
			if (!Jc(g)) throw new Gc(h, "function", o);
			var _ = g(Yc(m, t, n, r, i, a).map(function(e) {
				return e.value;
			}));
		...
		if (Ts(u)) {
			...
			if (!v) throw new Wc(u.value, f, Object.keys(u.options), o);
			s.push.apply(s, Yc(v.value, t, n, r, i));
			continue;
		}
		if (Es(u)) {
			var v = u.options[`=${f}`];
			if (!v) {
				if (!Intl.PluralRules) throw new Uc("Intl.PluralRules is not available in this environment.\nTry polyfilling it using \"@formatjs/intl-pluralrules\"\n", Hc.MISSING_INTL_API, o);
				var y = n.getPluralRules(t, { type: u.pluralType }).select(f - (u.offset || 0));
				v = u.options[y] || u.options.other;
			}
			if (!v) throw new Wc(u.value, f, Object.keys(u.options), o);
			s.push.apply(s, Yc(v.value, t, n, r, i, f - (u.offset || 0)));
			continue;
		}
	}
	return qc(s);
...
function $c(e) {
	return e === void 0 && (e = {
		...
		getNumberFormat: Ac(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.NumberFormat).bind.apply(e, Qo([void 0], t, !1)))();
		}, {
			cache: Qc(e.number),
			strategy: Vc.variadic
		}),
		getDateTimeFormat: Ac(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.DateTimeFormat).bind.apply(e, Qo([void 0], t, !1)))();
		}, {
			cache: Qc(e.dateTime),
			strategy: Vc.variadic
		}),
		getPluralRules: Ac(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.PluralRules).bind.apply(e, Qo([void 0], t, !1)))();
		}, {
			cache: Qc(e.pluralRules),
			strategy: Vc.variadic
		})
	};
}
var el = function() {
	function e(t, n, r, i) {
		...
		if (this.formatterCache = {
			...
			return Yc(a.ast, a.locales, a.formatters, a.formats, e, void 0, a.message);
			...
			var o = i || {};
			o.formatters;
			var s = Lo(o, ["formatters"]);
			this.ast = e.__parse(t, M(M({}, s), { locale: this.resolvedLocale }));
		} else this.ast = t;
		if (!Array.isArray(this.ast)) throw TypeError("A message must be provided as a String or AST.");
		this.formats = Zc(e.formats, r), this.formatters = i && i.formatters || $c(this.formatterCache);
	}
	...
	try {
		...
		})() || j.get("DisplayNames", ["en"], { type: "language" }).of(t) === t && !nl(t) || n && j.get("DisplayNames", ["en"], { type: "region" }).of(n) === n || r && j.get("DisplayNames", ["en"], { type: "script" }).of(r) === r && !tl.includes(r));
	} catch {
		return !1;
	}
}, R = (e) => {
...
function ol(e, t, n, r) {
	return !(!L(e, r) || !L(t, r) || n && n.some((e) => !L(e, r)) || il(e, t) || n && !n.some((e) => al(t, e)));
}
var sl = (e, t, n) => {
	if (e?.[t]) return typeof e[t] == "string" ? n === "name" ? e[t] : void 0 : e[t][n];
}, cl = (e, t) => !!(t?.[e] && typeof t[e] == "object" && "code" in t[e] && t[e].code && L(t[e].code));
function ll(e, t) {
	let n = e;
	t && cl(e, t) && (e = t[e].code);
	try {
...
function bl(e, t = "en", n) {
	...
	try {
		let i = R(e), a = j.get("Locale", e), o = a.language, s = yl([
			r,
			e,
			i,
			o
		...
		let t = L(e) ? R(e) : e, r = t?.split("-"), i = r?.[0] || t || "", a = r.length > 2 ? r?.[2] : r?.[1] || "", o = r?.[3] || "", s = yl([t, i], n);
		t = s?.code || t;
		let c = s?.name || t, l = s?.nativeName || c, u = s?.maximizedCode || t, d = s?.maximizedName || c, f = s?.nativeMaximizedName || l, p = s?.minimizedCode || t, m = s?.minimizedName || c, h = s?.nativeMinimizedName || l;
		i = s?.languageCode || i;
		let g = s?.languageName || c, _ = s?.nativeLanguageName || l;
...
function Nl(e, t = "en", n = {}) {
	return new el(e, t).format(n)?.toString() ?? "";
}
function Pl(e) {
	return e;
}
...
async function Ru(e, t, n) {
	return ko(e.map(({ source: e }) => e)), ju(e, async (e) => (await z(n, "/v2/project/files/upload-translations", {
		body: {
...
async function Bu(e, t, n) {
	let { baseUrl: r } = n, i = t.timeout ? t.timeout : yo, a = `${r || "https://api2.gtx.dev"}/v2/project/info/${encodeURIComponent(e)}`, o;
	try {
		o = await yu(a, {
			method: "GET",
			headers: Cu(n)
...
var Yu = class {
	...
	setConfig({ apiKey: e, devApiKey: t, sourceLocale: n, targetLocale: r, locales: i, projectId: a, customMapping: o, baseUrl: s }) {
		if (e && (this.apiKey = e), t && (this.devApiKey = t), a && (this.projectId = a), n && (this.sourceLocale = R(n), !L(this.sourceLocale, o))) throw Error(_u(this.sourceLocale));
		if (r && (this.targetLocale = R(r), !L(this.targetLocale, o))) throw Error(_u(this.targetLocale));
		if (i) {
			let e = [], t = [];
			if (i.forEach((n) => {
				let r = R(n);
...
function md(e) {
	let { cacheUrl: t = To, projectId: n, _versionId: r, _branchId: i } = e, a = r ? `/${r}` : "", o = i ? `?branchId=${i}` : "";
...
var sy = b().server(function({ defaultLocale: e, locales: t, customMapping: n }) {
	let r = [], i = x(jp);
...
var Dy = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/gt-react-app/src/components/Footer.wrapper.tsx";
function Oy() {
	return y(Ey, { children: y(vo, {}, void 0, !1, {
		fileName: Dy,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
