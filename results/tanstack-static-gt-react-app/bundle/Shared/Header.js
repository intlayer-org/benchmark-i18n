import a, { Children, Fragment, cloneElement, createContext, createElement, isValidElement, useContext, useEffect, useLayoutEffect, useMemo, useRef, useState, useSyncExternalStore } from "react";
				...
				children: [jsx(Link, {
					...
					children: [
						jsx(Link, {
							...
							className: "nav-link",
							children: jsx(a$2, { children: "Home" })
						}),
						jsx(Link, {
							preload: false,
							to: "/$locale/about",
						...
						jsxs("div", {
							...
							children: [jsxs("button", {
								...
								children: [jsx(a$2, { children: "Mock Pages" }), jsx(ChevronDown, {
									size: 14,
								...
								children: jsx("div", {
									...
									children: [
										{
											to: "/$locale/products",
											label: jsx(a$2, { children: "Products" })
										},
										{
											to: "/$locale/pricing",
											label: jsx(a$2, { children: "Pricing" })
										},
										{
											to: "/$locale/team",
											label: jsx(a$2, { children: "Team" })
										},
										{
											to: "/$locale/blog",
											label: jsx(a$2, { children: "Blog" })
										},
										{
											to: "/$locale/careers",
											label: jsx(a$2, { children: "Careers" })
										},
										{
											to: "/$locale/faq",
											label: jsx(a$2, { children: "FAQ" })
										},
										{
											to: "/$locale/contact",
											label: jsx(a$2, { children: "Contact" })
										},
										{
											to: "/$locale/settings",
											label: jsx(a$2, { children: "Settings" })
										}
									].map((page) => jsx(Link, {
										preload: false,
										to: page.to,
