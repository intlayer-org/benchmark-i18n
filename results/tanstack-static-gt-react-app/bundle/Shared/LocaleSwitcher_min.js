...
import { useNavigate as l, useParams as u } from "@tanstack/react-router";
import { jsxDEV as d } from "react/jsx-dev-runtime";
import { jsx as f } from "react/jsx-runtime";
import { createIsomorphicFn as p } from "@tanstack/react-start";
import { getCookie as m, getRequestHeader as h } from "@tanstack/react-start/server";
var g = Object.defineProperty, _ = Object.getOwnPropertyDescriptor, v = Object.getOwnPropertyNames, y = Object.prototype.hasOwnProperty, b = (e, t, n) => () => {
...
}, x = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), S = (e, t) => {
	let n = {};
	...
	return e;
}, ee = (e) => y.call(e, "module.exports") ? e["module.exports"] : C(g({}, "__esModule", { value: !0 }), e), w = [
	"en",
	"fr",
	"es",
	"de",
...
}, E = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/gt-react-app/src/components/LocaleSwitcher.tsx";
function te() {
...
var ne = 6e4, re = (e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`, ie = "DEFAULT_TERMINATOR_KEY", ae = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	constructor(e, t = {}) {
		...
		if (!ae[t.style ?? "ellipsis"]) throw Error(re(t.style ?? "ellipsis"));
		let n, r;
		if (t.maxChars !== void 0) {
			n = t.style ?? "ellipsis";
			let e = new Intl.Locale(this.locale).language;
			r = ae[n][e] || ae[n].DEFAULT_TERMINATOR_KEY;
		}
	...
	get(e, ...t) {
		...
		return a === void 0 && (a = new se[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}(), ce = "https://cdn.gtx.dev", le = {
	GTJSON: ["GTJSON"],
	JSON: ["JSON"],
	PO: ["PO"],
	POT: ["POT", "PO"],
...
function de(e) {
	...
	if (!ue(e.fileFormat, e.transformFormat)) return `Unsupported file format transform: ${e.fileFormat} -> ${e.transformFormat}`;
}
function fe(e) {
	for (let t of e) {
		let e = de(t);
...
function he(e) {
	...
	if (Array.isArray(e)) {
		let t = "[";
		for (let n = 0; n < e.length; n++) n && (t += ","), t += he(e[n]) || "null";
		return t + "]";
	}
...
var we = typeof Uint8Array.from([]).toHex == "function" && typeof Uint8Array.fromHex == "function", Te = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function Ee(e) {
	if (ye(e), we) return e.toHex();
	let t = "";
...
var Me = class {
	...
	digestInto(e) {
		be(this), xe(e, this), this.finished = !0;
	...
	3204031479,
	3329325298
]), Fe = /* @__PURE__ */ new Uint32Array(64), Ie = class extends Me {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		...
		for (let e = 16; e < 64; e++) {
			let t = Fe[e - 15], n = Fe[e - 2], r = O(t, 7) ^ O(t, 18) ^ t >>> 3, i = O(n, 17) ^ O(n, 19) ^ n >>> 10;
			Fe[e] = i + Fe[e - 7] + r + Fe[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = O(o, 6) ^ O(o, 11) ^ O(o, 25), u = l + t + Ae(o, s, c) + Pe[e] + Fe[e] | 0, d = (O(n, 2) ^ O(n, 13) ^ O(n, 22)) + je(n, r, i) | 0;
...
}, Re = Oe(() => new Le(), ke(1)), ze = S({
	__addDisposableResource: () => pt,
	__assign: () => k,
	__asyncDelegator: () => at,
	__asyncGenerator: () => it,
	__asyncValues: () => ot,
	...
	__runInitializers: () => Ge,
	__setFunctionName: () => qe,
	__spread: () => et,
	__spreadArray: () => nt,
	__spreadArrays: () => tt,
	__values: () => Qe,
...
function Ze(e, t) {
	for (var n in e) n !== "default" && !Object.prototype.hasOwnProperty.call(t, n) && _t(t, e, n);
}
function Qe(e) {
...
function it(e, t, n) {
	...
	function l(e) {
		e.value instanceof rt ? Promise.resolve(e.value.v).then(u, d) : f(a[0][2], e);
	}
	function u(e) {
		c("next", e);
	}
...
function ct(e) {
	...
	var t = {};
	if (e != null) for (var n = yt(e), r = 0; r < n.length; r++) n[r] !== "default" && _t(t, e, n[r]);
	return vt(t, e), t;
}
function lt(e) {
...
function mt(e) {
	function t(t) {
		e.error = e.hasError ? new bt(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	function i() {
...
var gt, k, _t, vt, yt, bt, xt, St = b((() => {
	gt = function(e, t) {
		return gt = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
			e.__proto__ = t;
		} || function(e, t) {
	...
	}, _t = Object.create ? (function(e, t, n, r) {
		r === void 0 && (r = n);
		...
		return yt = Object.getOwnPropertyNames || function(e) {
			var t = [];
			for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
			return t;
		}, yt(e);
	}, bt = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
		var r = Error(n);
...
var Ft = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, It = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Lt(e) {
	var t = {};
...
function zt(e) {
	...
	for (var t = e.split(Rt).filter(function(e) {
		return e.length > 0;
...
var Vt = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, Ht = /^(@+)?(\+|#+)?[rs]?$/g, Ut = /(\*)(0+)|(#+)(0+)|(0+)/g, Wt = /^(0+)$/;
function Gt(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(Ht, function(e, n, r) {
...
function qt(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !Wt.test(e)) throw Error("Malformed concise eng/scientific notation");
...
function Yt(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "measure-unit":
			case "unit":
				t.style = "unit", t.unit = Bt(i.options[0]);
				continue;
			case "compact-short":
			case "K":
			...
			case "KK":
				...
				continue;
			case "scientific":
				t = k(k(k({}, t), { notation: "scientific" }), i.options.reduce(function(e, t) {
					return k(k({}, e), Jt(t));
				}, {}));
				continue;
			case "engineering":
				t = k(k(k({}, t), { notation: "engineering" }), i.options.reduce(function(e, t) {
					return k(k({}, e), Jt(t));
				}, {}));
				continue;
			...
			case "integer-width":
				...
				i.options[0].replace(Ut, function(e, n, r, i, a, o) {
		...
		if (Vt.test(i.stem)) {
			...
			i.stem.replace(Vt, function(e, n, r, i, a, o) {
			...
			var a = i.options[0];
			a === "w" ? t = k(k({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = k(k({}, t), Gt(a)));
			continue;
		}
		if (Ht.test(i.stem)) {
			t = k(k({}, t), Gt(i.stem));
...
function Zt(e, t) {
	for (var n = "", r = 0; r < e.length; r++) {
		...
		if (i === "j") {
			...
			var o = 1 + (a & 1), s = a < 2 ? 1 : 3 + (a >> 1), c = "a", l = Qt(t);
...
function Qt(e) {
	...
	var n = e.language, r;
	return n !== "root" && (r = e.maximize().region), (Xt[r || ""] || Xt[n || ""] || Xt[`${n}-001`] || Xt["001"])[0];
}
St();
var $t = RegExp(`^${Ft.source}*`), en = RegExp(`${Ft.source}*\$`);
function M(e, t) {
	return {
		start: e,
		end: t
...
var tn = !!String.prototype.startsWith && "_a".startsWith("a", 1), nn = !!String.fromCodePoint, rn = !!Object.fromEntries, an = !!String.prototype.codePointAt, on = !!String.prototype.trimStart, sn = !!String.prototype.trimEnd, cn = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, ln = !0;
try {
	ln = gn("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	ln = !1;
}
var un = tn ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, dn = nn ? String.fromCodePoint : function() {
	...
	return t;
}, fn = rn ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
var _n;
if (ln) {
	var vn = gn("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	_n = function(e, t) {
		return vn.lastIndex = t, vn.exec(e)[1] ?? "";
	};
} else _n = function(e, t) {
	for (var n = [];;) {
		var r = pn(e, t);
		if (r === void 0 || Cn(r) || wn(r)) break;
...
var yn = function() {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			} else if (i === 60 && !this.ignoreTag && bn(this.peek() || 0)) {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !bn(this.char())) return this.error(A.INVALID_TAG, M(o, this.clonePosition()));
				...
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					...
					err: null
				} : this.error(A.INVALID_TAG, M(o, this.clonePosition()))) : this.error(A.UNMATCHED_CLOSING_TAG, M(s, this.clonePosition()));
			}
			return this.error(A.UNCLOSED_TAG, M(n, this.clonePosition()));
		}
		return this.error(A.INVALID_TAG, M(n, this.clonePosition()));
	}, e.prototype.parseTagName = function() {
		var e = this.offset();
		for (this.bump(); !this.isEOF() && Sn(this.char());) this.bump();
		...
		return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !xn(this.peek() || 0)) ? (this.bump(), "<") : null;
		...
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), dn(n));
	}, e.prototype.parseArgument = function(e, t) {
		var n = this.clonePosition();
		if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(A.EXPECT_ARGUMENT_CLOSING_BRACE, M(n, this.clonePosition()));
		if (this.char() === 125) return this.bump(), this.error(A.EMPTY_ARGUMENT, M(n, this.clonePosition()));
		var r = this.parseIdentifierIfPossible().value;
		if (!r) return this.error(A.MALFORMED_ARGUMENT, M(n, this.clonePosition()));
		if (this.bumpSpace(), this.isEOF()) return this.error(A.EXPECT_ARGUMENT_CLOSING_BRACE, M(n, this.clonePosition()));
		switch (this.char()) {
			...
			case 44: return this.bump(), this.bumpSpace(), this.isEOF() ? this.error(A.EXPECT_ARGUMENT_CLOSING_BRACE, M(n, this.clonePosition())) : this.parseArgumentOptions(e, t, r, n);
			default: return this.error(A.MALFORMED_ARGUMENT, M(n, this.clonePosition()));
		}
	}, e.prototype.parseIdentifierIfPossible = function() {
		var e = this.clonePosition(), t = this.offset(), n = _n(this.message, t), r = t + n.length;
		...
		switch (a) {
			case "": return this.error(A.EXPECT_ARGUMENT_TYPE, M(i, o));
			case "number":
			case "date":
			case "time":
				this.bumpSpace();
				...
				if (this.bumpIf(",")) {
					...
					if (l.err) return l;
					var u = hn(l.val);
					if (u.length === 0) return this.error(A.EXPECT_ARGUMENT_STYLE, M(this.clonePosition(), this.clonePosition()));
					s = {
						style: u,
				...
				if (s && un(s?.style, "::", 0)) {
					...
					if (p.length === 0) return this.error(A.EXPECT_DATE_TIME_SKELETON, f);
					var m = p;
					this.locale && (m = Zt(p, this.locale));
					var u = {
						type: Ct.dateTime,
						pattern: m,
			...
			case "select":
				...
				if (this.bumpSpace(), !this.bumpIf(",")) return this.error(A.EXPECT_SELECT_ARGUMENT_OPTIONS, M(h, k({}, h)));
				this.bumpSpace();
				var g = this.parseIdentifierIfPossible(), _ = 0;
				if (a !== "select" && g.value === "offset") {
					if (!this.bumpIf(":")) return this.error(A.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, M(this.clonePosition(), this.clonePosition()));
					this.bumpSpace();
					var l = this.tryParseDecimalInteger(A.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, A.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);
					if (l.err) return l;
			...
			default: return this.error(A.INVALID_ARGUMENT_TYPE, M(i, o));
		}
	}, e.prototype.tryParseArgumentClose = function(e) {
		return this.isEOF() || this.char() !== 125 ? this.error(A.EXPECT_ARGUMENT_CLOSING_BRACE, M(e, this.clonePosition())) : (this.bump(), {
			val: !0,
			err: null
		});
		...
		for (var e = 0, t = this.clonePosition(); !this.isEOF();) switch (this.char()) {
			case 39:
				this.bump();
				var n = this.clonePosition();
				if (!this.bumpUntil("'")) return this.error(A.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, M(n, this.clonePosition()));
				this.bump();
				break;
			case 123:
				e += 1, this.bump();
		...
		return {
			val: {
				...
				tokens: n,
				location: t,
				parsedOptions: this.shouldParseSkeletons ? Yt(n) : {}
			},
			err: null
		};
		...
		for (var i, a = !1, o = [], s = /* @__PURE__ */ new Set(), c = r.value, l = r.location;;) {
			...
			if (s.has(c)) return this.error(t === "select" ? A.DUPLICATE_SELECT_ARGUMENT_SELECTOR : A.DUPLICATE_PLURAL_ARGUMENT_SELECTOR, l);
			c === "other" && (a = !0), this.bumpSpace();
			var f = this.clonePosition();
			if (!this.bumpIf("{")) return this.error(t === "select" ? A.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT : A.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT, M(this.clonePosition(), this.clonePosition()));
		...
		return o.length === 0 ? this.error(t === "select" ? A.EXPECT_SELECT_ARGUMENT_SELECTOR : A.EXPECT_PLURAL_ARGUMENT_SELECTOR, M(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !a ? this.error(A.MISSING_OTHER_CLAUSE, M(this.clonePosition(), this.clonePosition())) : {
			val: o,
			err: null
		};
		...
		if (un(this.message, e, this.offset())) {
		...
		for (; !this.isEOF() && Cn(this.char());) this.bump();
...
function Tn(e) {
	e.forEach(function(e) {
		if (delete e.location, kt(e) || At(e)) for (var t in e.options) delete e.options[t].location, Tn(e.options[t].value);
		else Et(e) && Nt(e.style) || (Dt(e) || Ot(e)) && Pt(e.style) ? delete e.style.location : Mt(e) && Tn(e.children);
	});
}
function En(e, t) {
	t === void 0 && (t = {}), t = k({
...
var Dn = x(((e) => {
	...
	Object.defineProperty(e, "__esModule", { value: !0 }), St(), ee(ze), Dn();
})), kn = Dn();
On();
function An({ icuString: e, shouldVisit: t, visitor: n, options: { recurseIntoVisited: r = !0, ...i } }) {
	let a = En(e, i);
	return o(a), a;
	function o(e) {
		e.map(s);
	...
	function s(e) {
		let i = !1;
		t(e) && (n(e), i = !0), (!i || r) && (e.type === j.select || e.type === j.plural ? Object.values(e.options).map((e) => e.value).map(o) : e.type === j.tag && o(e.children));
	}
}
var jn = "_gt_";
RegExp(`^${jn}\\d+$`);
var Mn = RegExp(`^${jn}$`);
function Nn(e) {
	return e.type === kn.TYPE.select && Mn.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === kn.TYPE.literal);
}
function Pn(e) {
...
function Fn(e, t) {
	var n = t && t.cache ? t.cache : Gn, r = t && t.serializer ? t.serializer : Un;
	return (t && t.strategy ? t.strategy : Bn)(e, {
		cache: n,
		serializer: r
	});
}
...
function Bn(e, t) {
	var n = e.length === 1 ? Ln : Rn;
	return zn(e, this, n, t.cache.create(), t.serializer);
}
function Vn(e, t) {
	return zn(e, this, Rn, t.cache.create(), t.serializer);
}
function Hn(e, t) {
	return zn(e, this, Ln, t.cache.create(), t.serializer);
}
var Un = function() {
...
var Jn = function(e) {
	...
	Be(t, e);
	function t(t, n, r, i) {
		return e.call(this, `Invalid values for "${t}": "${n}". Options are "${Object.keys(r).join("\", \"")}"`, qn.INVALID_VALUE, i) || this;
	}
	return t;
}(Jn), Xn = function(e) {
	Be(t, e);
	function t(t, n, r) {
		return e.call(this, `Value for "${t}" must be of type ${n}`, qn.INVALID_VALUE, r) || this;
	}
	return t;
}(Jn), Zn = function(e) {
	Be(t, e);
	function t(t, n) {
		return e.call(this, `The intl string context variable "${t}" was not provided to the string "${n}"`, qn.MISSING_VALUE, n) || this;
	}
	return t;
}(Jn), N;
(function(e) {
...
function Qn(e) {
	return e.length < 2 ? e : e.reduce(function(e, t) {
		var n = e[e.length - 1];
		return !n || n.type !== N.literal || t.type !== N.literal ? e.push(t) : n.value += t.value, e;
	}, []);
}
function $n(e) {
...
function er(e, t, n, r, i, a, o) {
	...
	for (var s = [], c = 0, l = e; c < l.length; c++) {
		...
		if (Dt(u)) {
			var p = typeof u.style == "string" ? r.date[u.style] : Pt(u.style) ? u.style.parsedOptions : void 0;
			s.push({
				type: N.literal,
		...
		if (Ot(u)) {
			var p = typeof u.style == "string" ? r.time[u.style] : Pt(u.style) ? u.style.parsedOptions : r.time.medium;
			s.push({
				type: N.literal,
				value: n.getDateTimeFormat(t, p).format(f)
			});
		...
		if (Et(u)) {
			var p = typeof u.style == "string" ? r.number[u.style] : Nt(u.style) ? u.style.parsedOptions : void 0;
		...
		if (Mt(u)) {
			...
			if (!$n(g)) throw new Xn(h, "function", o);
			var _ = g(er(m, t, n, r, i, a).map(function(e) {
				return e.value;
			}));
		...
		if (kt(u)) {
			...
			if (!v) throw new Yn(u.value, f, Object.keys(u.options), o);
			s.push.apply(s, er(v.value, t, n, r, i));
			continue;
		}
		if (At(u)) {
			var v = u.options[`=${f}`];
			if (!v) {
				if (!Intl.PluralRules) throw new Jn("Intl.PluralRules is not available in this environment.\nTry polyfilling it using \"@formatjs/intl-pluralrules\"\n", qn.MISSING_INTL_API, o);
				var y = n.getPluralRules(t, { type: u.pluralType }).select(f - (u.offset || 0));
				v = u.options[y] || u.options.other;
			}
			if (!v) throw new Yn(u.value, f, Object.keys(u.options), o);
			s.push.apply(s, er(v.value, t, n, r, i, f - (u.offset || 0)));
			continue;
		}
	}
	return Qn(s);
...
function ir(e) {
	return e === void 0 && (e = {
		...
		getNumberFormat: Fn(function() {
			...
			return new ((e = Intl.NumberFormat).bind.apply(e, nt([void 0], t, !1)))();
		}, {
			cache: rr(e.number),
		...
		getDateTimeFormat: Fn(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.DateTimeFormat).bind.apply(e, nt([void 0], t, !1)))();
		}, {
			cache: rr(e.dateTime),
			strategy: Kn.variadic
		}),
		getPluralRules: Fn(function() {
			for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
			return new ((e = Intl.PluralRules).bind.apply(e, nt([void 0], t, !1)))();
		}, {
...
var ar = function() {
	function e(t, n, r, i) {
		...
		if (this.formatterCache = {
			...
			var n = t.reduce(function(e, t) {
				return !e.length || t.type !== N.literal || typeof e[e.length - 1] != "string" ? e.push(t.value) : e[e.length - 1] += t.value, e;
			}, []);
			return n.length <= 1 ? n[0] || "" : n;
		}, this.formatToParts = function(e) {
			return er(a.ast, a.locales, a.formatters, a.formats, e, void 0, a.message);
		...
		this.formats = nr(e.formats, r), this.formatters = i && i.formatters || ir(this.formatterCache);
	}
	...
	"Toto",
	"Thai"
], sr = (e) => e >= "qaa" && e <= "qtz", P = (e, t) => {
	t?.[e] && typeof t[e] == "object" && "code" in t[e] && t[e].code && (e = t[e].code);
	try {
		let { language: t, region: n, script: r } = D.get("Locale", e);
		return !(e.split("-").length !== (() => {
			let e = 1;
			return n && (e += 1), r && (e += 1), e;
		})() || D.get("DisplayNames", ["en"], { type: "language" }).of(t) === t && !sr(t) || n && D.get("DisplayNames", ["en"], { type: "region" }).of(n) === n || r && D.get("DisplayNames", ["en"], { type: "script" }).of(r) === r && !or.includes(r));
	} catch {
		return !1;
	}
}, F = (e) => {
...
function cr(e, t) {
	let { language: n, region: r, script: i } = D.get("Locale", e), { language: a, region: o, script: s } = D.get("Locale", t);
	return !(n !== a || r && o && r !== o || i && s && i !== s);
}
function lr(...e) {
	try {
		let t = e.flat().map(F);
		for (let e = 0; e < t.length; e++) for (let n = e + 1; n < t.length; n++) if (!cr(t[e], t[n])) return !1;
		return !0;
	} catch (e) {
...
function dr(e, t, n, r) {
	return !(!P(e, r) || !P(t, r) || n && n.some((e) => !P(e, r)) || lr(e, t) || n && !n.some((e) => ur(t, e)));
}
var fr = (e, t, n) => {
	if (e?.[t]) return typeof e[t] == "string" ? n === "name" ? e[t] : void 0 : e[t][n];
}, pr = (e, t) => !!(t?.[e] && typeof t[e] == "object" && "code" in t[e] && t[e].code && P(t[e].code));
function mr(e, t) {
	let n = e;
	t && pr(e, t) && (e = t[e].code);
	try {
		let r = F(e), i = D.get("Locale", r), { language: a, region: o } = i;
		if (t) for (let i of [
			n,
			e,
			r,
		...
		if (s) return s;
		let c = i.maximize();
		return vr[c.language] || Sr(c.region || "");
	} catch {
		return _r;
	}
}
var hr = "🌍", gr = "🌏", _r = hr, vr = {
	...
	EU: "🇪🇺",
	419: "🌎"
}, br = /* @__PURE__ */ new Set(/* @__PURE__ */ "AF.AX.AL.DZ.AS.AD.AO.AI.AQ.AG.AR.AM.AW.AU.AT.AZ.BS.BH.BD.BB.BY.BE.BZ.BJ.BM.BT.BO.BQ.BA.BW.BV.BR.IO.BN.BG.BF.BI.CV.KH.CM.CA.KY.CF.TD.CL.CN.CX.CC.CO.KM.CD.CG.CK.CR.CI.HR.CU.CW.CY.CZ.DK.DJ.DM.DO.EC.EG.SV.GQ.ER.EE.SZ.ET.FK.FO.FJ.FI.FR.GF.PF.TF.GA.GM.GE.DE.GH.GI.GR.GL.GD.GP.GU.GT.GG.GN.GW.GY.HT.HM.VA.HN.HK.HU.IS.IN.ID.IR.IQ.IE.IM.IL.IT.JM.JP.JE.JO.KZ.KE.KI.KP.KR.KW.KG.LA.LV.LB.LS.LR.LY.LI.LT.LU.MO.MG.MW.MY.MV.ML.MT.MH.MQ.MR.MU.YT.MX.FM.MD.MC.MN.ME.MS.MA.MZ.MM.NA.NR.NP.NL.NC.NZ.NI.NE.NG.NU.NF.MK.MP.NO.OM.PK.PW.PS.PA.PG.PY.PE.PH.PN.PL.PT.PR.QA.RE.RO.RU.RW.BL.SH.KN.LC.MF.PM.VC.WS.SM.ST.SA.SN.RS.SC.SL.SG.SX.SK.SI.SB.SO.ZA.GS.SS.ES.LK.SD.SR.SJ.SE.CH.SY.TW.TJ.TZ.TH.TL.TG.TK.TO.TT.TN.TR.TM.TC.TV.UG.UA.AE.GB.US.UM.UY.UZ.VU.VE.VN.VG.VI.WF.EH.YE.ZM.ZW".split(".")), xr = 127397;
function Sr(e) {
	return Cr(e) || "🌍";
}
function Cr(e) {
	let t = e.toUpperCase(), n = yr[t];
	if (n) return n;
	if (br.has(t)) return String.fromCodePoint(t.charCodeAt(0) + xr, t.charCodeAt(1) + xr);
}
function wr(e, t) {
	if (t) {
		let n = {};
...
function Tr(e, t = "en", n) {
	let r = e;
	n && pr(e, n) && (e = n[e].code), t ||= "en";
	try {
		let i = F(e), a = D.get("Locale", e), o = a.language, s = wr([
			r,
			e,
			i,
			o
			...
			t,
			"en"
		], g = D.get("DisplayNames", m, { type: "language" }), _ = D.get("DisplayNames", h, { type: "language" }), v = s?.name, y = s?.nativeName || s?.name, b = v || g.of(e) || e, x = y || _.of(e) || e, S = s?.maximizedName || v || g.of(u) || e, C = s?.nativeMaximizedName || y || _.of(u) || e, ee = s?.minimizedName || v || g.of(p) || e, w = s?.nativeMinimizedName || y || _.of(p) || e, T = s?.languageName || v || g.of(o) || e, E = s?.nativeLanguageName || y || _.of(o) || e, te = s?.nameWithRegionCode || c ? `${T} (${c})` : b, ne = s?.nativeNameWithRegionCode || (c ? `${E} (${c})` : x) || te, re = D.get("DisplayNames", m, { type: "region" }), ie = D.get("DisplayNames", h, { type: "region" }), ae = s?.regionName || (d ? re.of(d) : "") || "", oe = s?.nativeRegionName || (d ? ie.of(d) : "") || "", se = D.get("DisplayNames", m, { type: "script" }), ce = D.get("DisplayNames", h, { type: "script" });
		return {
			code: i,
			name: b,
			nativeName: x,
			...
			emoji: s?.emoji || mr(i, n)
		};
	} catch {
		let t = P(e) ? F(e) : e, r = t?.split("-"), i = r?.[0] || t || "", a = r.length > 2 ? r?.[2] : r?.[1] || "", o = r?.[3] || "", s = wr([t, i], n);
		t = s?.code || t;
...
function Er(e, t, n) {
	typeof e == "string" && (e = [e]), e = e.filter((e) => P(e, n)).map(F), t = t.filter((e) => P(e, n)).map(F);
	for (let n of e) {
		let e = t.filter((e) => ur(n, e)), r = ({ locale: t, languageCode: n, minimizedCode: r, regionCode: i, scriptCode: a }) => {
			let o = [
				t,
				`${n}-${i}`,
				`${n}-${a}`,
...
var jr = class {
	...
	handle(e) {
		...
		let n = Or[e.level], r = `[${e.level.toUpperCase()}]`;
		t.push(`${n}${r}${kr}`), this.config.prefix && t.push(`[${this.config.prefix}]`), this.config.includeContext && e.context && t.push(`[${e.context}]`), t.push(e.message), e.metadata && Object.keys(e.metadata).length > 0 && t.push(`\n  Metadata: ${JSON.stringify(e.metadata, null, 2)}`);
		let i = t.join(" ");
		switch (e.level) {
			case "debug":
				console.debug(i);
	...
	constructor(e = {}) {
		this.config = {
			...
			handlers: [],
			...e
		}, this.handlers = [...this.config.handlers || []], this.config.enableConsole && this.handlers.push(new jr(this.config));
	}
	addHandler(e) {
	...
	shouldLog(e) {
		return Dr[e] >= Dr[this.config.level];
	}
	log(e, t, n, r) {
...
Pr.child("validation"), Pr.child("formatting"), Pr.child("locale");
var Ir = Pr.child("GT instance");
function Lr({ value: e, locales: t = "en", options: n = {} }) {
	return D.get("CutoffFormat", t, n).format(e);
}
function Rr(e, t = "en", n = {}) {
	return new ar(e, t).format(n)?.toString() ?? "";
}
function zr(e) {
	return e;
}
function Br({ value: e, locales: t = ["en"], options: n = {} }) {
	return D.get("NumberFormat", t, {
		numberingSystem: "latn",
		...n
	}).format(e);
}
function Vr({ value: e, locales: t = ["en"], options: n = {} }) {
...
function Hr({ value: e, locales: t = ["en"], currency: n = "USD", options: r = {} }) {
	return D.get("NumberFormat", t, {
		style: "currency",
		currency: n,
		numberingSystem: "latn",
...
function Ur({ value: e, locales: t = ["en"], options: n = {} }) {
...
function Kr({ date: e, baseDate: t, locales: n = ["en"], options: r = {} }) {
	let { value: i, unit: a } = Gr(e, t);
	return qr({
		value: i,
		unit: a,
		locales: n,
...
function qr({ value: e, unit: t, locales: n = ["en"], options: r = {} }) {
...
function Yr(e) {
	try {
		let t = Qr(D.get("Locale", e));
		if (t) return t;
	} catch {}
	let { scriptCode: t, languageCode: n } = Tr(e);
	return t ? $r(t) ? "rtl" : "ltr" : n && ei(n) ? "rtl" : "ltr";
}
...
function $r(e) {
	return e ? Xr.has(e.toLowerCase()) : !1;
}
function ei(e) {
	return e ? Zr.has(e.toLowerCase()) : !1;
}
function ti(e, t) {
	try {
		let { language: n, region: r, script: i } = D.get("Locale", F(e)), { language: a, region: o, script: s } = D.get("Locale", F(t));
...
var ii = class {
	...
	formatMessage(e, t, n = {}) {
		...
		return a === "STRING" ? zr(e) : Rr(e, this.getFormattingLocales(t, r), i);
	}
	formatList(e, t, n = {}) {
		let { locales: r, ...i } = n;
		return Ur({
	...
	getLocaleName(e) {
		return Jr(e, this.defaultLocale, this.customMapping);
	}
	getLocaleEmoji(e) {
		return mr(e, this.customMapping);
	}
	getLocaleProperties(e) {
		return Tr(e, this.defaultLocale, this.customMapping);
	}
	requiresTranslation(e, t = this.defaultLocale, n = this.translationLocales) {
		return dr(this.resolveCanonicalLocale(t), this.resolveCanonicalLocale(e), n ? this.resolveCanonicalLocaleList(n) : void 0, this.customMapping);
	}
	determineLocale(e, t = this.locales) {
		let n = t.map((e) => ({
			locale: e,
			canonicalLocale: this.resolveCanonicalLocale(e)
		})), r = Er(Array.isArray(e) ? this.resolveCanonicalLocaleList(e) : this.resolveCanonicalLocale(e), n.map(({ canonicalLocale: e }) => e), this.customMapping);
		if (r) return n.find(({ canonicalLocale: e }) => e === r)?.locale || this.resolveAliasLocale(r);
	}
	getLocaleDirection(e) {
		return Yr(this.resolveCanonicalLocale(e));
	}
	isValidLocale(e) {
	...
	resolveAliasLocale(e) {
		return ni(e, this.customMapping);
	}
	standardizeLocale(e) {
		return F(e);
	}
	isSameDialect(...e) {
		return lr(...this.resolveCanonicalLocaleArgs(e));
	}
	isSameLanguage(...e) {
		return ur(...this.resolveCanonicalLocaleArgs(e));
	}
	isSupersetLocale(e, t) {
		return ti(this.resolveCanonicalLocale(e), this.resolveCanonicalLocale(t));
	}
};
function ai(e, t) {
	return P(e, t);
...
function ui(e) {
	return Ee(Re(De(e))).slice(0, 16);
}
function di({ source: e, context: t, id: n, maxChars: r, dataFormat: i }, a = ui) {
	let o;
	return o = i === "JSX" ? pi(e) : e, a(ge({
		source: o,
		...n && { id: n },
		...t && { context: t },
...
var fi = (e) => {
	if (e && typeof e == "object") {
		let t = {};
		if ("c" in e && e.c && (t.c = pi(e.c)), "d" in e) {
			let n = e?.d;
			n?.b && (t.b = Object.fromEntries(Object.entries(n.b).map(([e, t]) => [e, pi(t)]))), n?.t && (t.t = n.t);
		}
		return _e(e) ? {
			k: e.k,
			...e.v && { v: e.v }
...
function pi(e) {
	return Array.isArray(e) ? e.map(fi) : fi(e);
}
var mi = "GT Error:", hi = (e) => `${mi} Translation request timed out after ${e}ms.`, gi = (e) => `${mi} Translation request failed. Error: ${e}`, _i = (e, t, n) => `${mi} API returned error status. Status: ${e}, Status Text: ${t}, Error: ${n}`, I = (e) => `${mi} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a targetLocale in the GT constructor.`, vi = (e) => `${mi} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a sourceLocale in the GT constructor.`, yi = (e) => `${mi} Cannot call \`${e}\` without a specified project ID. Either pass a project ID to the \`${e}\` function or specify a projectId in the GT constructor.`, bi = (e) => `${mi} Cannot call \`${e}\` without a specified API key. Either pass an API key to the \`${e}\` function or specify an apiKey in the GT constructor.`, xi = (e) => `${mi} Invalid locale: ${e}.`, Si = (e) => `${mi} Invalid locales: ${e.join(", ")}.`;
async function Ci(e, t, n) {
	...
	try {
		...
		throw e instanceof Error && e.name === "AbortError" ? hi(n) : e;
	} finally {
		a && clearTimeout(a);
	}
}
async function wi(e) {
	if (!e.ok) {
		...
		throw new li(_i(e.status, e.statusText, t), e.status, t);
	}
}
function Ti(e, t) {
	if (e instanceof Error && e.name === "AbortError") {
		let e = hi(t);
		throw Fr.error(e), Error(e);
	}
	let n = gi(e instanceof Error ? e.message : String(e));
	throw Fr.error(n), e;
}
var Ei = "2026-03-06.v1";
function Di(e, t = !1) {
	let n = {
		...!t && { "Content-Type": "application/json" },
		"x-gt-project-id": e.projectId
	};
	return e.apiKey && (e.apiKey.startsWith("gtx-internal-") ? n["x-gt-internal-api-key"] = e.apiKey : n["x-gt-api-key"] = e.apiKey), n["gt-api-version"] = Ei, n;
}
var Oi = 3, ki = 500;
function Ai(e) {
...
function ji(e, t) {
	switch (e) {
		case "linear": return ki * (t + 1);
		case "exponential": return ki * 2 ** t;
		default: return 0;
	}
}
async function L(e, t, n) {
	let r = n?.timeout ?? 6e4, i = `${e.baseUrl || "https://api2.gtx.dev"}${t}`, a = n?.method ?? "POST", o = n?.retryPolicy ?? "exponential", s = o === "none" ? 0 : Oi, c = {
		method: a,
		headers: Di(e)
	};
	...
	for (let e = 0; e <= s; e++) {
		...
		return await wi(t), await t.json();
	}
...
async function Mi(e, t, n, r) {
	...
	for (let [e, t] of s) {
		let { source: n, metadata: r } = typeof t == "string" ? { source: t } : t, i = e ?? r?.hash ?? di({
			source: n,
...
async function Ni(e, t, n) {
	return L(t, "/v2/project/setup/generate", {
		body: {
			files: e.map((e) => ({
				branchId: e.branchId,
				fileId: e.fileId,
...
async function Ii(e, t, n) {
	fe(e);
	let r = await Fi(e, async (e) => {
		let r = await L(n, "/v2/project/translations/enqueue", {
			body: {
				files: e.map((e) => ({
					branchId: e.branchId,
					fileId: e.fileId,
...
async function Li(e, t) {
	return await L(t, "/v2/project/tags/create", { body: {
		tagId: e.tagId,
		files: e.files,
...
async function Ri(e, t, n) {
	return Fi(e, async (e) => (await L(n, "/v2/project/files/download", {
		body: e,
		timeout: t.timeout
	})).files.map((e) => ({
		...e,
...
async function zi(e, t, n = {}) {
	return await Fi(e.diffs, async (e) => (await L(t, "/v2/project/files/diffs", {
		body: { diffs: e },
		timeout: n.timeout
	}), [{ success: !0 }]), { batchSize: 100 }), { success: !0 };
}
function Bi(e, t = "en", n) {
	t ||= "en";
	try {
		return {
			code: e,
			name: D.get("DisplayNames", [t, "en"], { type: "region" }).of(e) || e,
			emoji: Sr(e),
			...n?.[e]
		};
	} catch {
...
async function Vi(e, t, n) {
	return Fi(e, async (e) => (await L(n, "/v2/project/files/upload-files", {
		body: {
...
async function Hi(e, t, n) {
	return fe(e.map(({ source: e }) => e)), Fi(e, async (e) => (await L(n, "/v2/project/files/upload-translations", {
		body: {
...
async function Ui(e, t, n) {
	...
	return r && o.set("branchId", r), i && o.set("versionId", i), L(n, `/v2/project/translations/files/status/${encodeURIComponent(a)}?${o.toString()}`, {
		method: "GET",
		timeout: t.timeout
	});
}
async function Wi(e, t, n) {
	let { baseUrl: r } = n, i = t.timeout ? t.timeout : ne, a = `${r || "https://api2.gtx.dev"}/v2/project/info/${encodeURIComponent(e)}`, o;
	try {
		o = await Ci(a, {
			method: "GET",
			headers: Di(n)
	...
	return await wi(o), await o.json();
}
async function Gi(e, t, n) {
	return L(t, "/v2/project/jobs/info", {
		body: { jobIds: e },
		timeout: n
	});
}
...
async function qi(e, t = {}, n) {
	return L(n, "/v2/project/files/info", {
		body: {
...
async function Ji(e, t) {
	return L(t, "/v2/project/branches/info", { body: e });
}
async function Yi(e, t) {
	return L(t, "/v2/project/branches/create", { body: e });
}
async function Xi(e, t, n) {
	...
	let r = await Fi(e, async (e) => (await L(n, "/v2/project/files/moves", {
		body: {
			branchId: t.branchId,
			moves: e
		},
...
async function Zi(e, t, n = {}, r) {
	let i = (t) => L(r, "/v2/project/files/orphaned", {
		body: {
			branchId: e,
			fileIds: t
		},
	...
	let a = Pi(t, 100), o = await Promise.all(a.map((e) => i(e)));
...
async function Qi(e, t) {
	return await L(t, "/v2/project/files/publish", { body: { files: e } });
}
var $i = class {
	get localeConfig() {
	...
	setConfig({ apiKey: e, devApiKey: t, sourceLocale: n, targetLocale: r, locales: i, projectId: a, customMapping: o, baseUrl: s }) {
		if (e && (this.apiKey = e), t && (this.devApiKey = t), a && (this.projectId = a), n && (this.sourceLocale = F(n), !P(this.sourceLocale, o))) throw Error(xi(this.sourceLocale));
		if (r && (this.targetLocale = F(r), !P(this.targetLocale, o))) throw Error(xi(this.targetLocale));
		if (i) {
			let e = [], t = [];
			if (i.forEach((n) => {
				let r = F(n);
				P(r) ? e.push(r) : t.push(n);
			}), t.length > 0) throw Error(Si(t));
			this.locales = e;
		}
		s && (this.baseUrl = s), o && (this.customMapping = o, this.reverseCustomMapping = Object.fromEntries(Object.entries(o).filter(([, e]) => e && typeof e == "object" && "code" in e).map(([e, t]) => [t.code, e]))), this._localeConfig = new ii({
	...
	async queryBranchData(e) {
		return this._validateAuth("queryBranchData"), await Ji(e, this._getTranslationConfig());
	}
	async createBranch(e) {
		return this._validateAuth("createBranch"), await Yi(e, this._getTranslationConfig());
	}
	async processFileMoves(e, t = {}) {
		return this._validateAuth("processFileMoves"), await Xi(e, t, this._getTranslationConfig());
	}
	async getOrphanedFiles(e, t, n = {}) {
		return this._validateAuth("getOrphanedFiles"), await Zi(e, t, n, this._getTranslationConfig());
	}
	async setupProject(e, t) {
		return this._validateAuth("setupProject"), t = {
			...t,
			locales: t?.locales?.map((e) => this.resolveCanonicalLocale(e))
		}, await Ni(e, this._getTranslationConfig(), t);
	}
	async checkJobStatus(e, t) {
		return this._validateAuth("checkJobStatus"), await Gi(e, this._getTranslationConfig(), t);
	}
	async awaitJobs(e, t) {
		return this._validateAuth("awaitJobs"), await Ki(e, t, this._getTranslationConfig());
	}
	async enqueueFiles(e, t) {
		...
		if (!n.sourceLocale) {
			let e = vi("enqueueFiles");
			throw Ir.error(e), Error(e);
		}
		if (!n.targetLocales || n.targetLocales.length === 0) {
			let e = I("enqueueFiles");
			throw Ir.error(e), Error(e);
		}
		return n = {
			...n,
			targetLocales: n.targetLocales.map((e) => this.resolveCanonicalLocale(e))
		}, await Ii(e, n, this._getTranslationConfig());
	}
	async createTag(e) {
		return this._validateAuth("createTag"), await Li(e, this._getTranslationConfig());
	}
	async publishFiles(e) {
		return this._validateAuth("publishFiles"), await Qi(e, this._getTranslationConfig());
	}
	async submitUserEditDiffs(e) {
		this._validateAuth("submitUserEditDiffs"), await zi({
			...e,
			diffs: (e.diffs || []).map((e) => ({
				...e,
	...
	async queryFileData(e, t = {}) {
		...
		let n = await qi(e, t, this._getTranslationConfig());
	...
	async querySourceFile(e, t = {}) {
		...
		let n = await Ui(e, t, this._getTranslationConfig());
	...
	async getProjectData(e, t = {}) {
		...
		let n = await Wi(e, t, this._getTranslationConfig());
	...
	async downloadFile(e, t = {}) {
		return this._validateAuth("downloadTranslatedFile"), (await Ri([{
			fileId: e.fileId,
			branchId: e.branchId,
	...
	async downloadFileBatch(e, t = {}) {
		...
		let n = await Ri(e, t, this._getTranslationConfig());
		return {
			files: n.data.map((e) => ({
				...e,
				...e.locale && { locale: this.resolveAliasLocale(e.locale) }
	...
	async uploadSourceFiles(e, t) {
		...
		let r = await Vi(e, n, this._getTranslationConfig());
		return {
	...
	async uploadTranslations(e, t) {
		...
		if (!n.sourceLocale) {
			let e = vi("uploadTranslations");
			throw Ir.error(e), Error(e);
		}
		let r = await Hi(e.map((e) => ({
			...e,
	...
	getRegionProperties(e = this.getLocaleProperties().regionCode, t) {
		...
		return Bi(e, this.targetLocale, t);
	}
	requiresTranslation(e = this.sourceLocale, t = this.targetLocale, n = this.locales, r = this.customMapping) {
		if (!e) throw Error(vi("requiresTranslation"));
		if (!t) throw Error(I("requiresTranslation"));
		return r === this.customMapping ? this.localeConfig.requiresTranslation(t, e, n) : dr(e, t, n, r);
	}
	...
	resolveCanonicalLocale(e = this.targetLocale, t = this.customMapping) {
		if (!e) throw Error(I("resolveCanonicalLocale"));
		return t === this.customMapping ? this.localeConfig.resolveCanonicalLocale(e) : ri(e, t);
	}
	resolveAliasLocale(e, t = this.customMapping) {
		if (!e) throw Error(I("resolveAliasLocale"));
		return t === this.customMapping ? this.localeConfig.resolveAliasLocale(e) : ni(e, t);
	}
	standardizeLocale(e = this.targetLocale) {
		if (!e) throw Error(I("standardizeLocale"));
...
function ia(e, t = "", n = !0) {
	if (e.forEach((e) => {
		switch (e.type) {
			case "error":
				ci.error(t + e.message);
				break;
			case "warning": ci.warn(t + e.message);
		}
...
function da(e) {
	let t = [];
	return t.push(...oa(e)), t.push(...ca(e)), t.push(...ua(e)), t;
}
var fa = class {}, pa = "fallback-storage-adapter", ma = class extends fa {
	constructor(...e) {
		super(...e), this.type = pa, this.storage = {};
	}
	getItem(e) {
...
function _a(e) {
	let { cacheUrl: t = ce, projectId: n, _versionId: r, _branchId: i } = e, a = r ? `/${r}` : "", o = i ? `?branchId=${i}` : "";
	return `${t}/${n}/[locale]` + a + o;
}
function va() {
	return async (e) => ({});
}
function ya({ type: e, remoteTranslationLoaderParams: t, loadTranslations: n }) {
	e === "disabled" && ci.warn("I18nManager: No translation loader found. No translations will be loaded.");
	let { cacheUrl: r, projectId: i, _versionId: a, _branchId: o, customMapping: s } = t;
	switch (e) {
		case "remote":
		case "gt-remote": return ga({
			cacheUrl: r || "",
			projectId: i || "",
			_versionId: a,
			_branchId: o,
...
var Sa = 25, Ca = 100, wa = 50, Ta = class extends ba {
	...
	genKey(e) {
		return xa(e.message, e.options);
	}
	fallback(e) {
		let t = this._enqueueTranslation(e);
		return this._queue.length >= Sa ? this._flushNow() : this._scheduleBatch(), t;
	}
	_flushNow() {
	...
	_drainQueue() {
		for (; this._queue.length > 0 && this._activeRequests < Ca;) {
			let e = this._queue.splice(0, Sa);
	...
	async _sendBatchRequest(e) {
		...
		let t = Ea(e), n = await this._sendBatchRequestWithErrorHandling(e, t);
...
var Da = 6e4, Oa = class extends ba {
	constructor({ init: e = {}, ttl: t, loadTranslations: n, createTranslateMany: r, lifecycle: { onLocalesCacheHit: i, onLocalesCacheMiss: a, onTranslationsCacheHit: o, onTranslationsCacheMiss: s } }) {
		super(e, {
			onHit: i,
			onMiss: a
		}), this.ttl = Da, this.ttl = t === null ? -1 : t ?? 6e4, this._translationLoader = n, this._createTranslateMany = r, this._onTranslationsCacheHit = o, this._onTranslationsCacheMiss = s;
	}
	get(e) {
		let t = this.getCache(e);
...
function ja({ onLocalesCacheHit: e, onLocalesCacheMiss: t, onTranslationsCacheHit: n, onTranslationsCacheMiss: r }, i) {
...
var Ma = 12e3, Na = class extends Aa {
	constructor(e) {
		super(), this.resolveTranslationSync = (e, t = {}) => this.lookupTranslation(e, t), ia(da(e), "I18nManager: "), this.config = Pa(e), this.localeConfig = new ii({
			defaultLocale: this.config.defaultLocale,
			locales: this.config.locales,
			customMapping: this.config.customMapping
		}), this.storeAdapter = e.storeAdapter ?? new ma();
		let t = Ra(e), n = ha(this.getGTClassClean(), Ma);
		ja(e.lifecycle ?? {}, (...e) => this.subscribe(...e)), this.localesCache = new Oa({
			loadTranslations: t,
			createTranslateMany: n,
			lifecycle: ka((...e) => this.emit(...e))
		});
	}
	...
	getLocale() {
		return this.storeAdapter.getItem("locale") || (ci.warn("getLocale() invoked outside of translation context, falling back to default locale"), this.config.defaultLocale);
	}
	setLocale(e) {
		try {
	...
	async getLookupTranslation(e = this.getLocale(), t = []) {
		try {
			...
			let r = La(t, n, (e) => this.resolveLocale(e));
			r.length !== t.length && ci.warn(`I18nManager: getLookupTranslation(): prefetchEntries must all be the same locale, ignoring all entries that are not for ${n}`);
			let i = this.localesCache.get(n);
	...
	handleError(e) {
		switch (this.config.environment) {
			...
			default: ci.error("I18nManager: " + e);
		}
	}
	resolveLocale(e) {
...
function Fa({ defaultLocale: e, locales: t, customMapping: n }) {
	return {
		defaultLocale: e,
...
function Ia(e) {
	return {
		defaultLocale: si(e.defaultLocale),
		locales: e.locales.map((t) => (typeof e.customMapping?.[t] == "string" ? e.customMapping?.[t] : e.customMapping?.[t]?.code) ? t : si(t)),
		customMapping: Object.fromEntries(Object.entries(e.customMapping || {}).map(([e, t]) => [e, typeof t == "string" ? si(t) : {
			...t,
			...t.code ? { code: si(t.code) } : {}
		}]))
	};
}
function La(e, t, n) {
...
var za = void 0;
function Ba() {
	return za ||= (ci.warn("getI18nManager(): Translation failed because I18nManager not initialized."), new Na({
		defaultLocale: "en",
		locales: ["en"]
	})), za;
}
...
var Ha = "DEFAULT_TERMINATOR_KEY", Ua = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	CutoffFormat: class {
		constructor(e, t = {}) {
			...
			if (!Ua[t.style ?? "ellipsis"]) throw Error(((e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`)(t.style ?? "ellipsis"));
			let n, r;
			if (t.maxChars !== void 0) {
				n = t.style ?? "ellipsis";
				let e = new Intl.Locale(this.locale).language;
				r = Ua[n][e] || Ua[n].DEFAULT_TERMINATOR_KEY;
			}
			let i = t.terminator ?? r?.terminator, a = i == null ? void 0 : t.separator ?? r?.separator;
			this.additionLength = (i?.length ?? 0) + (a?.length ?? 0), t.maxChars !== void 0 && Math.abs(t.maxChars) < this.additionLength && (i = void 0, a = void 0), this.options = {
				maxChars: t.maxChars,
...
new class {
	...
	get(e, ...t) {
		let [n = "en", r = {}] = t, i = this._generateKey(n, r), a = this.cache[e]?.[i];
		return a === void 0 && (a = new Wa[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}();
function Ga(e, t, n = "") {
...
var Qa = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = Ja(this.buffer);
	}
	update(e) {
		Ka(this), Ga(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		Ka(this), function(e, t) {
			Ga(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, qa(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = Ja(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), to = /* @__PURE__ */ new Uint32Array(64), no = class extends Qa {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) to[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = to[e - 15], n = to[e - 2], r = Ya(t, 7) ^ Ya(t, 18) ^ t >>> 3, i = Ya(n, 17) ^ Ya(n, 19) ^ n >>> 10;
			to[e] = i + to[e - 7] + r + to[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (Ya(o, 6) ^ Ya(o, 11) ^ Ya(o, 25)) + Xa(o, s, c) + eo[e] + to[e] | 0, u = (Ya(n, 2) ^ Ya(n, 13) ^ Ya(n, 22)) + Za(n, r, i) | 0;
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), qa(this.buffer);
	}
}, ro = class extends no {
	A = 0 | $a[0];
	B = 0 | $a[1];
...
(function(e, t = {}) {
	let n = (t, n) => e(n).update(t).digest(), r = e(void 0);
	return n.outputLen = r.outputLen, n.blockLen = r.blockLen, n.canXOF = r.canXOF, n.create = (t) => e(t), Object.assign(n, t), Object.freeze(n);
})(() => new ro(), (io = 1, { oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
function oo(e, t) {
	...
	ao(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var z = function() {
...
var vo = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function yo(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || vo(t, e, n);
}
function bo(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function Eo(e, t, n) {
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof To ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function Oo(e) {
	...
	return n ? n.call(e) : (e = bo(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var Ao = Object.create ? function(e, t) {
	...
	return jo = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, jo(e);
...
function Mo(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = jo(e), r = 0; r < n.length; r++) n[r] !== "default" && vo(t, e, n[r]);
	return Ao(t, e), t;
}
function No(e) {
	return e && e.__esModule ? e : { default: e };
...
var Ro = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function zo(e) {
	function t(t) {
		e.error = e.hasError ? new Ro(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var B, V, Vo, Ho = Object.freeze({
	__proto__: null,
	__addDisposableResource: Lo,
	get __assign() {
		return z;
	},
	__asyncDelegator: Do,
	...
	__await: To,
	__awaiter: go,
	__classPrivateFieldGet: Po,
	__classPrivateFieldIn: Io,
	__classPrivateFieldSet: Fo,
	__createBinding: vo,
	__decorate: co,
	...
	__importDefault: No,
	__importStar: Mo,
	__makeTemplateObject: ko,
	__metadata: ho,
	__param: lo,
	__propKey: po,
	__read: xo,
	__rest: so,
	__rewriteRelativeImportExtension: Bo,
	__runInitializers: fo,
	__setFunctionName: mo,
	__spread: So,
	__spreadArray: wo,
	__spreadArrays: Co,
	__values: bo,
...
var Uo = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, Wo = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Go(e) {
	var t = {};
...
var Jo = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, Yo = /^(@+)?(\+|#+)?[rs]?$/g, Xo = /(\*)(0+)|(#+)(0+)|(0+)/g, Zo = /^(0+)$/;
function Qo(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(Yo, function(e, n, r) {
		return typeof r == "string" ? r === "+" ? t.minimumSignificantDigits = n.length : n[0] === "#" ? t.maximumSignificantDigits = n.length : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length + (typeof r == "string" ? r.length : 0)) : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length), "";
	}), t;
}
function $o(e) {
...
function es(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !Zo.test(e)) throw Error("Malformed concise eng/scientific notation");
		t.minimumIntegerDigits = e.length;
	}
	return t;
}
	...
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "KK":
				...
				continue;
			case "scientific":
				t = z(z(z({}, t), { notation: "scientific" }), i.options.reduce(function(e, t) {
					return z(z({}, e), ts(t));
				}, {}));
				continue;
			case "engineering":
				t = z(z(z({}, t), { notation: "engineering" }), i.options.reduce(function(e, t) {
					return z(z({}, e), ts(t));
				}, {}));
				continue;
			case "notation-simple":
			...
			case "integer-width":
				if (i.options.length > 1) throw RangeError("integer-width stems only accept a single optional option");
				i.options[0].replace(Xo, function(e, n, r, i, a, o) {
					if (n) t.minimumIntegerDigits = r.length;
					else {
		...
		if (Zo.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
		else if (Jo.test(i.stem)) {
			if (i.options.length > 1) throw RangeError("Fraction-precision stems only accept a single optional option");
			i.stem.replace(Jo, function(e, n, r, i, a, o) {
				return r === "*" ? t.minimumFractionDigits = n.length : i && i[0] === "#" ? t.maximumFractionDigits = i.length : a && o ? (t.minimumFractionDigits = a.length, t.maximumFractionDigits = a.length + o.length) : (t.minimumFractionDigits = n.length, t.maximumFractionDigits = n.length), "";
			});
			var a = i.options[0];
			a === "w" ? t = z(z({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = z(z({}, t), Qo(a)));
		} else if (Yo.test(i.stem)) t = z(z({}, t), Qo(i.stem));
		else {
			var o = $o(i.stem);
			o && (t = z(z({}, t), o));
			var s = es(i.stem);
...
function is(e) {
	...
	var n, r = e.language;
	return r !== "root" && (n = e.maximize().region), (rs[n || ""] || rs[r || ""] || rs[`${r}-001`] || rs["001"])[0];
}
var as = RegExp(`^${Uo.source}*`), os = RegExp(`${Uo.source}*\$`);
function H(e, t) {
	return {
		start: e,
		end: t
...
var ss = !!String.prototype.startsWith && "_a".startsWith("a", 1), cs = !!String.fromCodePoint, ls = !!Object.fromEntries, us = !!String.prototype.codePointAt, ds = !!String.prototype.trimStart, fs = !!String.prototype.trimEnd, ps = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, ms = !0;
try {
	ms = Ss("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	ms = !1;
}
var hs, gs = ss ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, _s = cs ? String.fromCodePoint : function() {
	...
	return n;
}, vs = ls ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
if (ms) {
	...
	hs = function(e, t) {
		return Cs.lastIndex = t, Cs.exec(e)[1] ?? "";
	};
} else hs = function(e, t) {
	for (var n = [];;) {
		var r = ys(e, t);
		if (r === void 0 || Es(r) || Ds(r)) break;
		n.push(r), t += r >= 65536 ? 2 : 1;
	}
...
(function() {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			if (i === 123) {
				...
				if (i !== 35 || t !== "plural" && t !== "selectordinal") {
					...
					if (i === 60 && !this.ignoreTag && ws(this.peek() || 0)) {
		...
		if (this.bumpIf(">")) {
			...
			var a = i.val, o = this.clonePosition();
			if (this.bumpIf("</")) {
				if (this.isEOF() || !ws(this.char())) return this.error(B.INVALID_TAG, H(o, this.clonePosition()));
				var s = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					val: {
						type: V.tag,
					...
					err: null
				} : this.error(B.INVALID_TAG, H(o, this.clonePosition()))) : this.error(B.UNMATCHED_CLOSING_TAG, H(s, this.clonePosition()));
			}
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && Ts(this.char());) this.bump();
		return this.message.slice(e, this.offset());
	}, e.prototype.parseLiteral = function(e, t) {
		for (var n = this.clonePosition(), r = "";;) {
			var i = this.tryParseQuote(t);
		...
		return this.isEOF() || this.char() !== 60 || !this.ignoreTag && (ws(e = this.peek() || 0) || e === 47) ? null : (this.bump(), "<");
		var e;
	}, e.prototype.tryParseQuote = function(e) {
		if (this.isEOF() || this.char() !== 39) return null;
		switch (this.peek()) {
		...
		if (this.isEOF()) return null;
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), _s(n));
	}, e.prototype.parseArgument = function(e, t) {
		var n = this.clonePosition();
		if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(B.EXPECT_ARGUMENT_CLOSING_BRACE, H(n, this.clonePosition()));
		if (this.char() === 125) return this.bump(), this.error(B.EMPTY_ARGUMENT, H(n, this.clonePosition()));
		var r = this.parseIdentifierIfPossible().value;
		if (!r) return this.error(B.MALFORMED_ARGUMENT, H(n, this.clonePosition()));
		if (this.bumpSpace(), this.isEOF()) return this.error(B.EXPECT_ARGUMENT_CLOSING_BRACE, H(n, this.clonePosition()));
		switch (this.char()) {
			case 125: return this.bump(), {
				val: {
					type: V.argument,
			...
			case 44: return this.bump(), this.bumpSpace(), this.isEOF() ? this.error(B.EXPECT_ARGUMENT_CLOSING_BRACE, H(n, this.clonePosition())) : this.parseArgumentOptions(e, t, r, n);
			default: return this.error(B.MALFORMED_ARGUMENT, H(n, this.clonePosition()));
		}
	}, e.prototype.parseIdentifierIfPossible = function() {
		var e = this.clonePosition(), t = this.offset(), n = hs(this.message, t), r = t + n.length;
		return this.bumpTo(r), {
			value: n,
		...
		var i = this.clonePosition(), a = this.parseIdentifierIfPossible().value, o = this.clonePosition();
		switch (a) {
			case "": return this.error(B.EXPECT_ARGUMENT_TYPE, H(i, o));
			case "number":
			case "date":
			case "time":
				this.bumpSpace();
				...
				if (this.bumpIf(",")) {
					...
					if ((f = xs(g.val)).length === 0) return this.error(B.EXPECT_ARGUMENT_STYLE, H(this.clonePosition(), this.clonePosition()));
					s = {
						style: f,
				...
				if (s && gs(s?.style, "::", 0)) {
					...
					this.locale && (d = function(e, t) {
						for (var n = "", r = 0; r < e.length; r++) {
							...
							if (i === "j") {
								for (var a = 0; r + 1 < e.length && e.charAt(r + 1) === i;) a++, r++;
								var o = 1 + (1 & a), s = a < 2 ? 1 : 3 + (a >> 1), c = is(t);
					...
					var f = {
						...
						pattern: d,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? Go(d) : {}
					};
					return {
						val: {
			...
			case "select":
				...
				if (this.bumpSpace(), !this.bumpIf(",")) return this.error(B.EXPECT_SELECT_ARGUMENT_OPTIONS, H(p, z({}, p)));
				this.bumpSpace();
				var m = this.parseIdentifierIfPossible(), h = 0;
				if (a !== "select" && m.value === "offset") {
					if (!this.bumpIf(":")) return this.error(B.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, H(this.clonePosition(), this.clonePosition()));
					var g;
					if (this.bumpSpace(), (g = this.tryParseDecimalInteger(B.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, B.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE)).err) return g;
					this.bumpSpace(), m = this.parseIdentifierIfPossible(), h = g.val;
				}
				var _, v = this.tryParsePluralOrSelectOptions(e, a, t, m);
				if (v.err) return v;
				if ((_ = this.tryParseArgumentClose(r)).err) return _;
				var y = H(r, this.clonePosition());
				return a === "select" ? {
					val: {
						type: V.select,
						value: n,
			...
			default: return this.error(B.INVALID_ARGUMENT_TYPE, H(i, o));
		}
	}, e.prototype.tryParseArgumentClose = function(e) {
		return this.isEOF() || this.char() !== 125 ? this.error(B.EXPECT_ARGUMENT_CLOSING_BRACE, H(e, this.clonePosition())) : (this.bump(), {
			val: !0,
			err: null
		});
	}, e.prototype.parseSimpleArgStyleIfPossible = function() {
		for (var e = 0, t = this.clonePosition(); !this.isEOF();) switch (this.char()) {
			case 39:
				this.bump();
				var n = this.clonePosition();
				if (!this.bumpUntil("'")) return this.error(B.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, H(n, this.clonePosition()));
				this.bump();
				break;
			case 123:
				e += 1, this.bump();
		...
		try {
			n = function(e) {
				if (e.length === 0) throw Error("Number skeleton cannot be empty");
				for (var t = [], n = 0, r = e.split(Ko).filter(function(e) {
					return e.length > 0;
				}); n < r.length; n++) {
					var i = r[n].split("/");
		...
		for (var i, a = !1, o = [], s = /* @__PURE__ */ new Set(), c = r.value, l = r.location;;) {
			...
			c === "other" && (a = !0), this.bumpSpace();
			var f = this.clonePosition();
			if (!this.bumpIf("{")) return this.error(t === "select" ? B.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT : B.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT, H(this.clonePosition(), this.clonePosition()));
			var p = this.parseMessage(e + 1, t, n);
			if (p.err) return p;
			var m = this.tryParseArgumentClose(f);
			if (m.err) return m;
		...
		return o.length === 0 ? this.error(t === "select" ? B.EXPECT_SELECT_ARGUMENT_SELECTOR : B.EXPECT_PLURAL_ARGUMENT_SELECTOR, H(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !a ? this.error(B.MISSING_OTHER_CLAUSE, H(this.clonePosition(), this.clonePosition())) : {
			val: o,
			err: null
		};
	}, e.prototype.tryParseDecimalInteger = function(e, t) {
...
var Os, U = {};
function ks() {
	return Os || (Os = 1, Object.defineProperty(U, "__esModule", { value: !0 }), U.SKELETON_TYPE = U.TYPE = void 0, U.isLiteralElement = function(t) {
		return t.type === e.literal;
	}, U.isArgumentElement = function(t) {
		return t.type === e.argument;
	}, U.isNumberElement = function(t) {
		return t.type === e.number;
	}, U.isDateElement = function(t) {
		return t.type === e.date;
	}, U.isTimeElement = function(t) {
		return t.type === e.time;
	}, U.isSelectElement = function(t) {
		return t.type === e.select;
	}, U.isPluralElement = function(t) {
		return t.type === e.plural;
	}, U.isPoundElement = function(t) {
		return t.type === e.pound;
	}, U.isTagElement = function(t) {
		return t.type === e.tag;
	}, U.isNumberSkeleton = function(e) {
		return !(!e || typeof e != "object" || e.type !== t.number);
	}, U.isDateTimeSkeleton = function(e) {
		return !(!e || typeof e != "object" || e.type !== t.dateTime);
	}, U.createLiteralElement = function(t) {
		return {
			type: e.literal,
			value: t
		};
	}, U.createNumberElement = function(t, n) {
		return {
			type: e.number,
			value: t,
			style: n
		...
		e[e.literal = 0] = "literal", e[e.argument = 1] = "argument", e[e.number = 2] = "number", e[e.date = 3] = "date", e[e.time = 4] = "time", e[e.select = 5] = "select", e[e.plural = 6] = "plural", e[e.pound = 7] = "pound", e[e.tag = 8] = "tag";
	}(e || (U.TYPE = e = {})), function(e) {
		e[e.number = 0] = "number", e[e.dateTime = 1] = "dateTime";
	}(t || (U.SKELETON_TYPE = t = {}))), U;
	var e, t;
}
var As;
ks();
...
(function() {
	if (As) return js;
	As = 1, Object.defineProperty(js, "__esModule", { value: !0 }), js.printAST = n, js.doPrintAST = r, js.printDateTimeSkeleton = o;
	var e = Ms, t = ks();
	function n(e) {
		return r(e, !1);
	}
...
var Ns = "_gt_";
RegExp(`^${Ns}\\d+$`), RegExp(`^${Ns}$`);
var Ps = "generaltranslation.locale";
e.use;
var Fs = {
	af: ["af"],
	am: ["am"],
...
function Is(e) {
	if (!ai(e)) return null;
	e = si(e);
	let { languageCode: t, ...n } = ea(e);
	if (Fs[t]?.length) {
		let r = Fs[t], i = ({ locale: e, languageCode: t, minimizedCode: n, regionCode: i, scriptCode: a }) => {
			let o = [
				e,
				`${t}-${i}`,
				`${t}-${a}`,
...
function Rs(e = {}, t) {
	return e.name ? e.name : `_gt_${Ls[t] || "value"}_${e["data-_gt"]?.id}`;
}
var zs = "en", Bs = "DEFAULT_TERMINATOR_KEY", Vs = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	CutoffFormat: class {
		constructor(e, t = {}) {
			...
			if (!Vs[t.style ?? "ellipsis"]) throw Error(((e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`)(t.style ?? "ellipsis"));
			let n, r;
			if (t.maxChars !== void 0) {
				n = t.style ?? "ellipsis";
				let e = new Intl.Locale(this.locale).language;
				r = Vs[n][e] || Vs[n].DEFAULT_TERMINATOR_KEY;
			}
			let i = t.terminator ?? r?.terminator, a = i == null ? void 0 : t.separator ?? r?.separator;
			this.additionLength = (i?.length ?? 0) + (a?.length ?? 0), t.maxChars !== void 0 && Math.abs(t.maxChars) < this.additionLength && (i = void 0, a = void 0), this.options = {
				maxChars: t.maxChars,
...
new class {
	...
	get(e, ...t) {
		let [n = "en", r = {}] = t, i = this._generateKey(n, r), a = this.cache[e]?.[i];
		return a === void 0 && (a = new Hs[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}();
var Us = "https://cdn.gtx.dev", Ws = "https://runtime2.gtx.dev";
function Gs(e) {
	if (e === void 0) return;
	if (e === null) return "null";
	if (typeof e == "number") return isFinite(e) ? "" + e : "null";
	...
	if (Array.isArray(e)) {
		let t = "[";
		for (let n = 0; n < e.length; n++) n && (t += ","), t += Gs(e[n]) || "null";
		return t + "]";
	}
	let t = Object.keys(e).sort(), n = "";
	for (let r of t) {
...
var Qs = typeof Uint8Array.from([]).toHex == "function" && typeof Uint8Array.fromHex == "function", $s = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function ec(e, t = {}) {
	let n = (t, n) => e(n).update(t).digest(), r = e(void 0);
	return n.outputLen = r.outputLen, n.blockLen = r.blockLen, n.canXOF = r.canXOF, n.create = (t) => e(t), Object.assign(n, t), Object.freeze(n);
}
var tc = (e) => ({ oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
var ic = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = Zs(this.buffer);
	}
	update(e) {
		Ys(this), Js(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		Ys(this), function(e, t) {
			Js(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, Xs(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = Zs(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), sc = /* @__PURE__ */ new Uint32Array(64), cc = class extends ic {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		...
		for (let e = 16; e < 64; e++) {
			let t = sc[e - 15], n = sc[e - 2], r = W(t, 7) ^ W(t, 18) ^ t >>> 3, i = W(n, 17) ^ W(n, 19) ^ n >>> 10;
			sc[e] = i + sc[e - 7] + r + sc[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (W(o, 6) ^ W(o, 11) ^ W(o, 25)) + nc(o, s, c) + oc[e] + sc[e] | 0, u = (W(n, 2) ^ W(n, 13) ^ W(n, 22)) + rc(n, r, i) | 0;
			l = c, c = s, s = o, o = a + t | 0, a = i, i = r, r = n, n = t + u | 0;
		}
		n = n + this.A | 0, r = r + this.B | 0, i = i + this.C | 0, a = a + this.D | 0, o = o + this.E | 0, s = s + this.F | 0, c = c + this.G | 0, l = l + this.H | 0, this.set(n, r, i, a, o, s, c, l);
	}
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), Xs(this.buffer);
	}
}, lc = class extends cc {
	A = 0 | ac[0];
	B = 0 | ac[1];
...
}, uc = ec(() => new lc(), tc(1)), dc = function(e, t) {
...
function fc(e, t) {
	...
	dc(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var G = function() {
...
var Cc = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function wc(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || Cc(t, e, n);
}
function Tc(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function jc(e, t, n) {
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof Ac ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function Nc(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = Tc(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var Fc = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return Ic = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, Ic(e);
...
function Lc(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = Ic(e), r = 0; r < n.length; r++) n[r] !== "default" && Cc(t, e, n[r]);
	return Fc(t, e), t;
}
function Rc(e) {
	return e && e.__esModule ? e : { default: e };
...
var Uc = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function Wc(e) {
	function t(t) {
		e.error = e.hasError ? new Uc(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var K, q, Kc, qc = Object.freeze({
	__proto__: null,
	__addDisposableResource: Hc,
	get __assign() {
		return G;
	},
	__asyncDelegator: Mc,
	...
	__await: Ac,
	__awaiter: xc,
	__classPrivateFieldGet: zc,
	__classPrivateFieldIn: Vc,
	__classPrivateFieldSet: Bc,
	__createBinding: Cc,
	__decorate: mc,
	__disposeResources: Wc,
	__esDecorate: gc,
	__exportStar: wc,
	__extends: fc,
	__generator: Sc,
	__importDefault: Rc,
	__importStar: Lc,
	__makeTemplateObject: Pc,
	__metadata: bc,
	__param: hc,
	__propKey: vc,
	__read: Ec,
	__rest: pc,
	__rewriteRelativeImportExtension: Gc,
	__runInitializers: _c,
...
var Jc = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, Yc = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Xc(e) {
	var t = {};
	return e.replace(Yc, function(e) {
		var n = e.length;
		switch (e[0]) {
			case "G":
				t.era = n === 4 ? "long" : n === 5 ? "narrow" : "short";
...
var $c = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, el = /^(@+)?(\+|#+)?[rs]?$/g, tl = /(\*)(0+)|(#+)(0+)|(0+)/g, nl = /^(0+)$/;
function rl(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(el, function(e, n, r) {
		return typeof r == "string" ? r === "+" ? t.minimumSignificantDigits = n.length : n[0] === "#" ? t.maximumSignificantDigits = n.length : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length + (typeof r == "string" ? r.length : 0)) : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length), "";
	}), t;
}
function il(e) {
...
function al(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !nl.test(e)) throw Error("Malformed concise eng/scientific notation");
		t.minimumIntegerDigits = e.length;
	}
	return t;
}
...
function sl(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "measure-unit":
			case "unit":
				t.style = "unit", t.unit = Qc(i.options[0]);
				continue;
			case "compact-short":
			case "K":
				t.notation = "compact", t.compactDisplay = "short";
			...
			case "integer-width":
				if (i.options.length > 1) throw RangeError("integer-width stems only accept a single optional option");
				i.options[0].replace(tl, function(e, n, r, i, a, o) {
					if (n) t.minimumIntegerDigits = r.length;
					else {
						if (i && a) throw Error("We currently do not support maximum integer digits");
						if (o) throw Error("We currently do not support exact integer digits");
		...
		if (nl.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
		else if ($c.test(i.stem)) {
			if (i.options.length > 1) throw RangeError("Fraction-precision stems only accept a single optional option");
			i.stem.replace($c, function(e, n, r, i, a, o) {
				return r === "*" ? t.minimumFractionDigits = n.length : i && i[0] === "#" ? t.maximumFractionDigits = i.length : a && o ? (t.minimumFractionDigits = a.length, t.maximumFractionDigits = a.length + o.length) : (t.minimumFractionDigits = n.length, t.maximumFractionDigits = n.length), "";
			});
			var a = i.options[0];
			a === "w" ? t = G(G({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = G(G({}, t), rl(a)));
		} else if (el.test(i.stem)) t = G(G({}, t), rl(i.stem));
		else {
			var o = il(i.stem);
			o && (t = G(G({}, t), o));
			var s = al(i.stem);
...
function ll(e) {
	...
	var n, r = e.language;
	return r !== "root" && (n = e.maximize().region), (cl[n || ""] || cl[r || ""] || cl[`${r}-001`] || cl["001"])[0];
}
var ul = RegExp(`^${Jc.source}*`), dl = RegExp(`${Jc.source}*\$`);
function J(e, t) {
	return {
		start: e,
		end: t
...
var fl = !!String.prototype.startsWith && "_a".startsWith("a", 1), pl = !!String.fromCodePoint, ml = !!Object.fromEntries, hl = !!String.prototype.codePointAt, gl = !!String.prototype.trimStart, _l = !!String.prototype.trimEnd, vl = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, yl = !0;
try {
	yl = Dl("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	yl = !1;
}
var bl, xl = fl ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, Sl = pl ? String.fromCodePoint : function() {
	for (var e = [...arguments], t, n = "", r = e.length, i = 0; r > i;) {
		if ((t = e[i++]) > 1114111) throw RangeError(t + " is not a valid code point");
		n += t < 65536 ? String.fromCharCode(t) : String.fromCharCode(55296 + ((t -= 65536) >> 10), t % 1024 + 56320);
	}
	return n;
}, Cl = ml ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
if (yl) {
	var Ol = Dl("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	bl = function(e, t) {
		return Ol.lastIndex = t, Ol.exec(e)[1] ?? "";
	};
} else bl = function(e, t) {
	for (var n = [];;) {
		var r = wl(e, t);
		if (r === void 0 || Ml(r) || Nl(r)) break;
		n.push(r), t += r >= 65536 ? 2 : 1;
	}
	return Sl.apply(void 0, n);
};
var kl = function() {
	function e(e, t) {
		t === void 0 && (t = {}), this.message = e, this.position = {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			if (i === 123) {
				...
				if (i !== 35 || t !== "plural" && t !== "selectordinal") {
					...
					if (i === 60 && !this.ignoreTag && Al(this.peek() || 0)) {
						if ((a = this.parseTag(e, t)).err) return a;
						r.push(a.val);
					} else {
						var a;
		...
		if (this.bumpIf(">")) {
			...
			var a = i.val, o = this.clonePosition();
			if (this.bumpIf("</")) {
				if (this.isEOF() || !Al(this.char())) return this.error(K.INVALID_TAG, J(o, this.clonePosition()));
				var s = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					val: {
						type: q.tag,
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && jl(this.char());) this.bump();
		return this.message.slice(e, this.offset());
	}, e.prototype.parseLiteral = function(e, t) {
		for (var n = this.clonePosition(), r = "";;) {
			var i = this.tryParseQuote(t);
		...
		return this.isEOF() || this.char() !== 60 || !this.ignoreTag && (Al(e = this.peek() || 0) || e === 47) ? null : (this.bump(), "<");
		var e;
	}, e.prototype.tryParseQuote = function(e) {
		if (this.isEOF() || this.char() !== 39) return null;
		switch (this.peek()) {
		...
		if (this.isEOF()) return null;
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), Sl(n));
	}, e.prototype.parseArgument = function(e, t) {
		var n = this.clonePosition();
		...
		var e = this.clonePosition(), t = this.offset(), n = bl(this.message, t), r = t + n.length;
		return this.bumpTo(r), {
			value: n,
		...
		switch (a) {
			...
			case "time":
				...
				if (this.bumpIf(",")) {
					...
					var c = this.clonePosition();
					if ((g = this.parseSimpleArgStyleIfPossible()).err) return g;
					if ((f = El(g.val)).length === 0) return this.error(K.EXPECT_ARGUMENT_STYLE, J(this.clonePosition(), this.clonePosition()));
					s = {
						style: f,
				...
				if (s && xl(s?.style, "::", 0)) {
					...
					this.locale && (d = function(e, t) {
						for (var n = "", r = 0; r < e.length; r++) {
							...
							if (i === "j") {
								for (var a = 0; r + 1 < e.length && e.charAt(r + 1) === i;) a++, r++;
								var o = 1 + (1 & a), s = a < 2 ? 1 : 3 + (a >> 1), c = ll(t);
								for (c != "H" && c != "k" || (s = 0); s-- > 0;) n += "a";
								for (; o-- > 0;) n = c + n;
							} else n += i === "J" ? "H" : i;
						}
					...
					var f = {
						...
						pattern: d,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? Xc(d) : {}
					};
					return {
						val: {
		...
		try {
			n = function(e) {
				if (e.length === 0) throw Error("Number skeleton cannot be empty");
				for (var t = [], n = 0, r = e.split(Zc).filter(function(e) {
					return e.length > 0;
				}); n < r.length; n++) {
					var i = r[n].split("/");
					if (i.length === 0) throw Error("Invalid number skeleton");
		...
		for (; !this.isEOF() && Ml(this.char());) this.bump();
	}, e.prototype.peek = function() {
		if (this.isEOF()) return null;
		var e = this.char(), t = this.offset();
		return this.message.charCodeAt(t + (e >= 65536 ? 2 : 1)) ?? null;
...
function Pl(e) {
	e.forEach(function(e) {
		...
		}(e)) for (var t in e.options) delete e.options[t].location, Pl(e.options[t].value);
		else (function(e) {
			return e.type === q.number;
		})(e) && function(e) {
			return !(!e || typeof e != "object" || e.type !== Kc.number);
		}(e.style) ? delete e.style.location : !function(e) {
			return e.type === q.date;
		}(e) && !function(e) {
			return e.type === q.time;
		}(e) || !function(e) {
			return !(!e || typeof e != "object" || e.type !== Kc.dateTime);
		}(e.style) ? function(e) {
			return e.type === q.tag;
		}(e) && Pl(e.children) : delete e.style.location;
	});
}
function Fl(e) {
	if (Object.prototype.hasOwnProperty.call(e, "__esModule")) return e;
...
function Ll() {
	if (Il) return Y;
	var e, t;
	return Il = 1, Object.defineProperty(Y, "__esModule", { value: !0 }), Y.SKELETON_TYPE = Y.TYPE = void 0, Y.isLiteralElement = function(t) {
		return t.type === e.literal;
...
var Rl, zl = Ll(), Bl = {}, Vl = Fl(qc), Hl = function() {
	if (Rl) return Bl;
	Rl = 1, Object.defineProperty(Bl, "__esModule", { value: !0 }), Bl.printAST = n, Bl.doPrintAST = r, Bl.printDateTimeSkeleton = o;
	var e = Vl, t = Ll();
	function n(e) {
		return r(e, !1);
	}
...
function Gl({ icuString: e, shouldVisit: t, visitor: n, options: { recurseIntoVisited: r = !0, ...i } }) {
	let a = function(e, t) {
		t === void 0 && (t = {}), t = G({
			shouldParseSkeletons: !0,
			requiresOtherClause: !0
...
var Kl = "_gt_", ql = RegExp(`^${Kl}\\d+$`), Jl = RegExp(`^${Kl}$`);
function Yl(e) {
	return e.type === zl.TYPE.select && ql.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === zl.TYPE.literal);
}
function Xl(e) {
	return e.type === zl.TYPE.select && Jl.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === zl.TYPE.literal);
}
function Zl(e) {
	if (!e.includes("_gt_")) return e;
	let t = [];
...
function $l(e) {
	return e.includes("_gt_") ? Hl.printAST(Gl({
		icuString: e,
		shouldVisit: Yl,
		visitor: function(e) {
			e.type = zl.TYPE.argument, delete e.options;
		},
		options: { recurseIntoVisited: !1 }
	})) : e;
}
...
var Z = "@generaltranslation/react-core", tu = `${Z} Error: Production environments cannot include an api key.`, nu = `${Z} Error: Fetching batched translations failed`, ru = (e, t) => e ? `${Z} Error: Translation failed for id: ${e}, hash: ${t} ` : `${Z} Error: Translation failed for hash: ${t}`, iu = (e, t) => `${Z} Error: error rendering string ${t ? `for id: "${t}"` : ""} original message: "${e}"`, au = (e, t, n = "tx") => `${Z} Error: string translation error. ${n}("${e}")${t ? ` with id "${t}"` : ""} could not locate translation.`, ou = (e) => `${Z} Error: Dictionary subtree not found for id: "${e}"`, su = (e) => `${Z} Error: Invalid ICU string dictionary entry found for id: "${e}"`, cu = `${Z} Warning: Translation cloud services require a project ID! Find yours at generaltranslation.com/dashboard.`, lu = (e) => `${Z} Warning: No valid dictionary entry found for id: "${e}"`, uu = `${Z} Warning: A development API key is required for runtime translation!  Find your development API key: generaltranslation.com/dashboard.  (Or, disable this warning message by setting runtimeUrl to an empty string which disables runtime translation.)`, du = `${Z} Warning: Runtime translation timed out.`, fu = `${Z} Warning: No dictionary was found. Ensure you are either passing your dictionary to the <GTProvider>.`;
function pu(e) {
...
var hu = {
	...
	let { props: t } = e, n = { t: gu(e) };
	if (t["data-_gt"]) {
		let e = t["data-_gt"], r = e.transformation;
		if (r === "variable") {
			let n = e.variableType || "variable", r = Rs(t, n), i = Wl(n);
			return {
				i: e.id,
				k: r,
				v: i
		...
		n.i = e.id, n.d = ((e, t, n) => {
			let r = Object.entries(hu).reduce((e, [n, r]) => (t[r] && (e[n] = t[r]), e), {});
			if (e === "plural" && n) {
				let e = {};
		...
		let i = Object.entries(hu).reduce((e, [n, r]) => (t[r] && (e[n] = t[r]), e), {});
	...
	return t.children && (n.c = yu(t.children)), n;
}, vu = (e) => {
	return n = e, t.isValidElement(n) ? _u(e) : typeof e == "number" ? e.toString() : e;
	var n;
};
function yu(e) {
	return Array.isArray(e) ? e.map(vu) : vu(e);
}
function bu(e) {
...
var Tu = (e) => typeof e == "string" || Array.isArray(e), Eu = (e) => typeof e == "object" && !!e && !Array.isArray(e);
function Du(e, t) {
	if (Array.isArray(e)) return e.map((e, n) => wu(e) ? t[n] : Du(e, t[n]));
	let n = {
		...Object.fromEntries(Object.entries(e).filter(([, e]) => Tu(e))),
		...Object.fromEntries(Object.entries(t).filter(([, e]) => Tu(e)))
	}, r = Object.entries(e).filter(([, e]) => Eu(e)).map(([e]) => e), i = Object.entries(t).filter(([, e]) => Eu(e)).map(([e]) => e), a = /* @__PURE__ */ new Set([...r, ...i]);
	for (let r of a) n[r] = Du(X(e, r) || {}, X(t, r) || {});
	return n;
}
function Ou({ dictionary: e, id: t }) {
	if (t === "") return e;
	let n = e, r = t.split(".");
...
function Au(e, t, n, r) {
	...
	for (let e of i.slice(0, -1)) X(t, e) ?? eu(t, e, Array.isArray(X(r, e)) ? [] : {}), t = X(t, e), r = X(r, e);
	eu(t, i[i.length - 1], e);
}
function ju(e) {
	let t = {};
...
function Nu({ source: e, context: t, id: n, maxChars: r, dataFormat: i }, a = Mu) {
	let o;
	return o = i === "JSX" ? Fu(e) : e, a(Ks({
		source: o,
		...n && { id: n },
		...t && { context: t },
		...r != null && { maxChars: Math.abs(r) },
...
var Pu = (e) => {
	if (e && typeof e == "object") {
		let t = {};
		if ("c" in e && e.c && (t.c = Fu(e.c)), "d" in e) {
			let n = e?.d;
			n?.b && (t.b = Object.fromEntries(Object.entries(n.b).map(([e, t]) => [e, Fu(t)]))), n?.t && (t.t = n.t);
		}
		return qs(e) ? {
			k: e.k,
			...e.v && { v: e.v }
...
function Fu(e) {
	return Array.isArray(e) ? e.map(Pu) : Pu(e);
}
function Iu(e, t = "") {
	let n = !1;
	return Object.entries(e).forEach(([r, i]) => {
		let a = t ? `${t}.${r}` : r;
		if (wu(i)) {
			let { entry: t, metadata: o } = Su(i);
			o?.$_hash || (o ||= {}, o.$_hash = Nu({
				source: Zl(t),
...
function Lu(e, t, n) {
	...
	if (!r) throw Error(ou(n));
	if (wu(r)) throw Error(`${Z} Error: Cannot inject and merge a dictionary entry`);
...
function Ru(e, t, n = "") {
	...
	return Object.entries(e).forEach(([e, i]) => {
		...
		} else r.push(...Ru(i, X(t, e) || (Array.isArray(i) ? [] : {}), a));
	}), r;
}
function zu(e) {
...
function Hu({ gt: e, locale: t, versionId: n, defaultLocale: r, runtimeUrl: l, renderSettings: u, setTranslations: d, environment: f, ...p }) {
	...
	let S = s(0), C = s(/* @__PURE__ */ new Map()), ee = s(/* @__PURE__ */ new Map()), w = i(async (e) => {
		if (e.size === 0) return {};
		S.current += 1;
		...
		try {
			...
			e?.name === "AbortError" ? console.warn(du) : console.warn(nu, e), a.forEach((e) => {
	...
	}, [re]), ae = o(() => ie("ICU"), [ie]), oe = o(() => ie("JSX"), [ie]);
	return a(() => () => {
...
function Uu({ gt: e, translations: t, locale: n, defaultLocale: r, translationRequired: i, developmentApiEnabled: a, registerIcuForTranslation: o, environment: s }) {
	function c({ message: t, variables: n, locales: r, fallback: i, id: a, maxChars: o, format: l }) {
		try {
			let a = Ql(i || ""), s = e.formatMessage(Object.keys(a).length ? $l(t) : t, {
				locales: r,
				variables: {
					...n,
					...a,
			...
			if (s === "production") console.warn(((e, t) => `${Z} Warning: failed to render string ${t ? `for id: "${t}"` : ""} original message: "${e}"`)(t, a), "Error: ", l);
				...
				if (!i) throw Error(`${iu(t, a)} Error: ${l}`);
				console.error(iu(t, a), "Error: ", l);
			}
			return i ? c({
				message: i,
				locales: r,
	...
	let d = (e, t = {}, s) => {
		...
		}), g(e, [r])) : (console.warn(au(e, d, "gt")), g(e, [r])) : s?.[v] ? g(s?.[v], [n, r], e) : g(e, [r]);
	};
	return {
		_gtFunction: d,
		_mFunction: (e, s = {}, l) => {
			...
			}), b(p, [r])) : l?.[f] ? b(l?.[f], [n, r], p) : b(p, [r]) : (console.warn(au(p, Bu(e), "m")), b(p, [r]));
		},
...
function Wu(e, t, n, r, a, o, s, c, l, u, d) {
	return i((i, c = {}) => {
		if (!t) return "";
		let f = xu(t, i);
		if (!f) return console.warn(lu(i)), "";
		if (!bu(f)) return console.warn(((e) => `${Z} Warning: Invalid dictionary entry found for id: "${e}"`)(i)), "";
		let { entry: p, metadata: m } = Su(f);
		if (!p || typeof p != "string") return "";
		let { $format: h, ...g } = c, _ = (t, n, r) => {
			try {
				let i = Ql(r || ""), a = e.formatMessage(Object.keys(i).length ? $l(t) : t, {
					locales: n,
					variables: {
						...g,
						...i,
				...
				if (d === "production") console.warn(((e) => `${Z} Warning: Invalid ICU string dictionary entry found for id: "${e}"`)(i), "Error: ", a);
					...
					if (!r) throw Error(`${su(i)} Error: ${a}`);
					console.error(su(i), "Error: ", a);
				}
...
function Gu({ _locale: e, defaultLocale: t, locales: n, ssr: r, localeCookieName: i, customMapping: a, useDetermineLocale: s, enableI18n: c, reloadOnLocaleUpdate: l }) {
...
function Ku({ devApiKey: e, projectId: t, runtimeUrl: n, loadTranslationsType: r, cacheUrl: i, locales: o, environment: s }) {
	a(() => {
		if (s === "production" && e) throw Error(tu);
		if (r === "custom" || !i && !n || t || s !== "development" || console.warn(cu), t && n && r !== "custom" && !e && s === "development" && console.warn(uu), n === Ws || i === Us && r === "default") {
			let e = o.filter((e) => !Is(e));
...
async function qu(e, t) {
	let n = Array.from(/* @__PURE__ */ new Set([e, ea(e).languageCode]));
	for (let e of n) try {
		let n = await t(e);
		if (n) return n;
	} catch {}
...
function Ju({ _translations: e, translationRequired: t, loadTranslationsType: n, loadTranslations: r, locale: i, cacheUrl: o, projectId: l, _versionId: u, gt: d }) {
...
function Yu(e, t, n, r, a, o, s, c, l, u, d, f) {
	return i((i, s, l = {}) => {
		...
		if (!p) return console.warn(lu(s)), {};
		if (wu(p)) return f(i, l);
		if (!c) return ju(p);
		let m = function({ dictionary: e, id: t, sourceDictionary: n }) {
			if (t === "") return e;
			let r = e, i = n, a = t.split(".");
			for (let e of a) X(r, e) === void 0 && (Array.isArray(X(i, e)) ? eu(r, e, []) : eu(r, e, {})), r = X(r, e);
			return r;
		}({
			dictionary: t,
			id: s,
			sourceDictionary: t
		}), { dictionary: h, updateDictionary: g } = Iu(structuredClone(p), s), _ = Ru(h, m, s), { dictionary: v, updateDictionary: y } = function(e, t, n, r, i = "") {
			let a = !1, o = i ? i.split(".") : [];
			return r.forEach(({ metadata: r }) => {
				let { $_hash: i, $id: s } = r, c = o.length > 0 ? s.split(".").slice(o.length).join(".") : s, l = xu(t, c), u;
				wu(l) && (u = Su(l).entry);
				let d = n[i] || u;
				d && (Au(d, t, c, e), a = !0);
			}), {
			...
			return n.forEach(({ source: n, metadata: r }) => {
				let { $id: a } = r, o = i.length > 0 ? a.split(".").slice(i.length).join(".") : a, s = xu(t, o), c;
				wu(s) && (c = Su(s).entry), Au(c || n, t, o, e);
			}), t;
...
function Xu({ enableI18n: e }) {
	let [t] = c(e);
	return { enableI18n: t };
}
function Zu() {
	throw pu("isSSREnabled");
}
function Qu({}) {
	throw pu("useDetermineLocale");
}
function $u({}) {
	throw pu("useRegionState");
}
function ed({ children: e, config: t, environment: r = "production", projectId: i = t?.projectId || "", devApiKey: s = t?.devApiKey || "", _versionId: l = t?._versionId, dictionary: u = t?.dictionary || {}, locales: d = t?.locales || [], defaultLocale: p = t?.defaultLocale || zs, cacheUrl: m = t?.cacheUrl || Us, runtimeUrl: h = t?.runtimeUrl || Ws, renderSettings: g = t?.renderSettings || Cu(r), ssr: _ = t?.ssr || Zu(), localeCookieName: v = t?.localeCookieName || "generaltranslation.locale", locale: y = "", region: b, loadDictionary: x, loadTranslations: S, fallback: C, translations: ee = null, customMapping: w = t?.customMapping, enableI18n: T = t?.enableI18n === void 0 || t.enableI18n, enableI18nLoaded: E, reloadOnLocaleUpdate: te, useEnableI18n: ne = Xu, readAuthFromEnv: re = mu, useDetermineLocale: ie = Qu, useRegionState: ae = $u, ...oe }) {
	y &&= R(y, w);
	let { projectId: se, devApiKey: D } = re({
		projectId: i,
		devApiKey: s
	}), { enableI18n: ce } = ne({
		enableI18n: T,
		...
		ssr: _
	}), { locale: le, setLocale: ue, locales: de, translationRequired: fe, dialectTranslationRequired: pe } = Gu({
		_locale: y,
		defaultLocale: p,
		locales: d,
		ssr: _,
		...
		h,
		w
	]), _e = o(() => (S ? "custom" : m && se && "default") || "disabled", [
		S,
		m,
		se
		...
		return a(() => {
			...
			let e = !0;
			return (async () => {
				let t = await qu(i, n) || {}, a = await qu(r, n) || {};
				e && s(t || {}), e && u(a || {});
			})(), () => {
				e = !1;
			};
	...
	let { translations: Se, setTranslations: Ce } = Ju({
		_translations: ee,
		...
		_versionId: l,
		gt: ge
	}), { registerIcuForTranslation: O, registerJsxForTranslation: we, developmentApiEnabled: Te } = Hu({
		gt: ge,
		locale: le,
		versionId: l,
		defaultLocale: p,
		...
		environment: r,
		...oe
	}), { _gtFunction: Ee, _mFunction: De, _filterMessagesForPreload: Oe, _preloadMessages: ke } = Uu({
		gt: ge,
		translations: Se,
		locale: le,
		defaultLocale: p,
		...
		environment: r
	}), Ae = Wu(ge, ve, be, Se, le, p, fe, pe, Te, O, r), je = Yu(ve || {}, be || {}, ye, xe, Se, le, p, fe, pe, Te, O, Ae), Me = !(fe && !Se || !le);
	return f(Vu.Provider, {
		value: {
			gt: ge,
			registerIcuForTranslation: O,
...
function td({ projectId: e, devApiKey: t }) {
	try {
		return {
			projectId: e || "",
			devApiKey: t || void 0
...
function nd({ _region: e, regionCookieName: t }) {
...
function rd({ _region: e, ssr: t, regionCookieName: n }) {
	let [r, i] = c(t ? void 0 : nd({
		_region: e,
		regionCookieName: n
	}));
	return a(() => {
...
function id({ enableI18n: e, enableI18nCookieName: t, enableI18nLoaded: n, ssr: r }) {
...
var od = function(e, t) {
	return od = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, od(e, t);
...
function sd(e, t) {
	...
	od(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var cd = function() {
...
var yd = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function bd(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || yd(t, e, n);
}
function xd(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function Cd() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(Sd(arguments[t]));
	return e;
}
function wd() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function Ed(e) {
	return this instanceof Ed ? (this.v = e, this) : new Ed(e);
}
function Dd(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var r, i = n.apply(e, t || []), a = [];
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof Ed ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function kd(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = xd(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var jd = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return Md = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, Md(e);
...
function Nd(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = Md(e), r = 0; r < n.length; r++) n[r] !== "default" && yd(t, e, n[r]);
	return jd(t, e), t;
}
function Pd(e) {
	return e && e.__esModule ? e : { default: e };
...
var zd = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function Bd(e) {
	function t(t) {
		e.error = e.hasError ? new zd(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var Hd, Ud, Wd, Gd, Kd = Object.freeze({
	__proto__: null,
	__addDisposableResource: Rd,
	get __assign() {
		return cd;
	},
	__asyncDelegator: Od,
	...
	__classPrivateFieldIn: Ld,
	__classPrivateFieldSet: Id,
	__createBinding: yd,
	__decorate: ud,
	__disposeResources: Bd,
	__esDecorate: fd,
	__exportStar: bd,
	__extends: sd,
	__generator: vd,
	__importDefault: Pd,
	__importStar: Nd,
	__makeTemplateObject: Ad,
	__metadata: gd,
	__param: dd,
	__propKey: md,
	__read: Sd,
	__rest: ld,
	__rewriteRelativeImportExtension: Vd,
...
try {
	(Gd = (/* @__PURE__ */ RegExp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu")).exec("a")) == null || Gd[0];
} catch {}
function qd(e) {
	if (Object.prototype.hasOwnProperty.call(e, "__esModule")) return e;
	var t = e.default;
...
function Yd() {
	if (Jd) return Q;
	var e, t;
	return Jd = 1, Object.defineProperty(Q, "__esModule", { value: !0 }), Q.SKELETON_TYPE = Q.TYPE = void 0, Q.isLiteralElement = function(t) {
		return t.type === e.literal;
...
(function() {
	if (Xd) return Zd;
	Xd = 1, Object.defineProperty(Zd, "__esModule", { value: !0 }), Zd.printAST = n, Zd.doPrintAST = r, Zd.printDateTimeSkeleton = o;
	var e = Qd, t = Yd();
	function n(e) {
		return r(e, !1);
	}
...
var sf = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = nf(this.buffer);
	}
	update(e) {
		ef(this), $d(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		ef(this), function(e, t) {
			$d(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, tf(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = nf(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), uf = /* @__PURE__ */ new Uint32Array(64), df = class extends sf {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) uf[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = uf[e - 15], n = uf[e - 2], r = rf(t, 7) ^ rf(t, 18) ^ t >>> 3, i = rf(n, 17) ^ rf(n, 19) ^ n >>> 10;
			uf[e] = i + uf[e - 7] + r + uf[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (rf(o, 6) ^ rf(o, 11) ^ rf(o, 25)) + af(o, s, c) + lf[e] + uf[e] | 0, u = (rf(n, 2) ^ rf(n, 13) ^ rf(n, 22)) + of(n, r, i) | 0;
			l = c, c = s, s = o, o = a + t | 0, a = i, i = r, r = n, n = t + u | 0;
		}
		n = n + this.A | 0, r = r + this.B | 0, i = i + this.C | 0, a = a + this.D | 0, o = o + this.E | 0, s = s + this.F | 0, c = c + this.G | 0, l = l + this.H | 0, this.set(n, r, i, a, o, s, c, l);
	}
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), tf(this.buffer);
	}
}, ff = class extends df {
	A = 0 | cf[0];
	B = 0 | cf[1];
...
})(() => new ff(), (pf = 1, { oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
var mf = function(e, t) {
	return mf = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, mf(e, t);
...
function hf(e, t) {
	...
	mf(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var gf = function() {
...
var Xf, Zf, Qf, $f, ep = Object.freeze({
	__proto__: null,
...
try {
	($f = function(e, t) {
		return new RegExp(e, t);
	}("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")) == null || $f[0];
} catch {}
var tp, np, $ = {};
function rp() {
	return tp || (tp = 1, Object.defineProperty($, "__esModule", { value: !0 }), $.SKELETON_TYPE = $.TYPE = void 0, $.isLiteralElement = function(t) {
		return t.type === e.literal;
...
(function() {
	if (np) return ip;
	np = 1, Object.defineProperty(ip, "__esModule", { value: !0 }), ip.printAST = n, ip.doPrintAST = r, ip.printDateTimeSkeleton = o;
	var e = ap, t = rp();
	function n(e) {
		return r(e, !1);
	}
...
var op = "gt-react";
function sp({ locale: e = "", defaultLocale: t = "en", locales: n = [], localeCookieName: r = "generaltranslation.locale", ssr: i = !0, customMapping: s, enableI18n: l, reloadOnLocaleUpdate: u = !1 }) {
	let d = o(() => R(e, s), [e, s]), f = o(() => n.map((e) => R(e, s)), [n, s]), [p, m] = c(() => l ? R(i ? d && na(d, f, s) || "" : cp({
		_locale: d,
		locale: d,
		locales: f,
		defaultLocale: t,
		...
		let c = (r) => {
			if (!o) return n;
			if (r === e) return e;
			let s = R(na(r, t, a) || e || n, a);
			return s !== r && console.warn(((e, t, n = "@generaltranslation/react-core") => `${n} Warning: "${t}" is not a supported locale. Update supported locales in your dashboard or gt.config.json. Falling back to "${e}".`)(s, r, op)), i(s), s;
		};
		return [(t) => {
			if (!o) return;
			t = R(t);
...
function cp({ _locale: e, locale: t, locales: n, defaultLocale: r, localeCookieName: i, customMapping: a, enableI18n: o }) {
	if (!o) return r;
	if (e && e === t && na(e, n, a) === t) return R(e, a);
	...
	return l &&= R(l, a), s && s !== l && typeof document < "u" && (document.cookie = `${i}=${l};path=/`), l;
}
function lp(e) {
	return f(ed, Object.assign({
		ssr: !(typeof process > "u" || !process.env.NEXT_RUNTIME) || (globalThis == null ? void 0 : globalThis.__NEXT_DATA__) !== void 0,
		environment: "development"
	}, e, {
		readAuthFromEnv: td,
		useDetermineLocale: sp,
		useRegionState: rd,
		useEnableI18n: id
	}));
}
var up = p().server(function({ defaultLocale: e, locales: t, customMapping: n }) {
	let r = [], i = m(Ps);
	if (i && r.push(i), process.env._GENERALTRANSLATION_IGNORE_BROWSER_LOCALES === "false") {
		let e = h("accept-language")?.split(",").map((e) => e.split(";")?.[0].trim()) || [];
		e && r.push(...e);
	}
	return r.length === 0 && process.env._GENERALTRANSLATION_IGNORE_BROWSER_LOCALES === "false" && console.warn("gt-tanstack-start(server): no locales could be determined for this request"), na(r, t, n) || e;
	...
	return a && r.push(a), r.length === 0 && (console.warn("gt-tanstack-start(client): no locales could be determined for this request"), r.push(e)), na(r, t, n) || e;
}), dp = class extends fa {
...
function pp(e) {
	Va(new fp(Object.assign(Object.assign({}, e), { storeAdapter: new dp() })));
}
var mp = { exports: {} }, hp, gp, _p = {};
function vp() {
...
function Sp(e) {
	return e.locale ? e.locale : bp() ? xp() : void 0;
}
function Cp() {
	let e = Ba();
	if (!function(e) {
...
function wp(e) {
	let t = Cp().getProviderConfig();
	return yp.jsx(lp, Object.assign({ ssr: bp() }, t, e, {
...
var Dp = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/gt-react-app/scripts/Wrapper.tsx";
pp({
	...T,
	loadTranslations: Ep
});
...
var kp = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/gt-react-app/src/components/LocaleSwitcher.wrapper.tsx";
function Ap() {
	return d(Op, { children: d(te, {}, void 0, !1, {
		fileName: kp,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
