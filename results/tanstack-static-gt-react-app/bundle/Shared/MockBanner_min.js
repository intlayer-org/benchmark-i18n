...
import { createIsomorphicFn as p, createMiddleware as m } from "@tanstack/react-start";
import { getRequest as h, setCookie as g } from "@tanstack/react-start/server";
...
function ae(e) {
	...
	if (e.response) {
		...
		throw new _(t, e.response.status, t);
	}
	throw e.error;
}
...
var ht = /[\t-\r \x85\u200E\u200F\u2028\u2029]/u, gt = /[\t-\r \x85\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\x21-\x2F\x3A-\x40\x5B-\x5E\x60\x7B-\x7E\xA1-\xA7\xA9\xAB\xAC\xAE\xB0\xB1\xB6\xBB\xBF\xD7\xF7\u2010-\u2027\u2030-\u203E\u2041-\u2053\u2055-\u205E\u2190-\u245F\u2500-\u2775\u2794-\u2BFF\u2E00-\u2E7F\u3001-\u3003\u3008-\u3020\u3030\uFD3E-\uFD3F\uFE45-\uFE46]/u, _t = class {
	...
	readTagName() {
		let e = this.index;
		for (w(this.current()) || this.fail("INVALID_TAG", e), this.index += 1; !this.atEnd() && mt(this.current());) this.index += this.current().length;
...
function Et(e, t, n) {
	...
	for (let r of e) switch (r.type) {
		...
		case S.number: {
			let e = T(t.variables, r.value), { scale: n, ...a } = typeof r.style == "string" ? xt[r.style] ?? {} : r.style?.type === C.number ? r.style.parsedOptions : {}, o = Dt(e, n);
			i(Ot(t, a).format(o));
			break;
		}
		case S.date:
		case S.time: {
			let e = T(t.variables, r.value), n = r.type === S.date ? St : wt;
			i(kt(t, typeof r.style == "string" ? n[r.style] : r.style?.type === C.dateTime ? r.style.parsedOptions : r.type === S.time ? wt.medium : void 0).format(e));
			break;
		}
		case S.select: {
			let e = String(T(t.variables, r.value)), n = Pt(r.options, e) ?? r.options.other;
			if (!n) throw Ft(r.value, e, r.options);
			Et(n.value, t).forEach(i);
			break;
		}
		case S.plural: {
			let e = T(t.variables, r.value), n = `=${String(e)}`, a = Pt(r.options, n), o = typeof e == "bigint" ? e : Number(e), s = typeof o == "bigint" ? o - BigInt(r.offset) : o - r.offset;
			if (!a && Nt(r.options)) {
...
function Rt(e, t, n) {
	return e.map((r, i) => {
		switch (r.type) {
			case S.literal: return Vt(r, t, i > 0, i < e.length - 1 || n);
			case S.argument: return `{${r.value}}`;
			case S.date:
			case S.time:
			case S.number: return Ut(r);
			case S.select: return `{${r.value},select,${Gt(r.options, !1)}}`;
			case S.plural: {
				let e = r.pluralType === "cardinal" ? "plural" : "selectordinal", t = r.offset ? `offset:${r.offset} ` : "";
				return `{${r.value},${e},${t}${Gt(r.options, !0)}}`;
			}
			case S.pound: return "#";
			case S.tag: return `<${r.value}>${Rt(r.children, t, !0)}</${r.value}>`;
		}
	}).join("");
}
...
var E = "_gt_", Jt = RegExp(`^${E}\\d+$`), Yt = RegExp(`^${E}$`);
function Xt(e) {
	return e.type === S.select && Jt.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === S.literal);
}
function Zt(e) {
	return e.type === S.select && Yt.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === S.literal);
}
function Qt(e) {
	let t = e;
...
var Dn = (e, t, n) => {
	...
	"Toto",
	"Thai"
]), kn = (e) => e >= "qaa" && e <= "qtz", k = (e, t) => {
	e = O(t, e) || e;
	try {
		let { language: t, region: n, script: r } = D.get("Locale", e), i = 1 + Number(!!n) + Number(!!r);
		return !(e.split("-").length !== i || D.get("DisplayNames", ["en"], { type: "language" }).of(t) === t && !kn(t) || n && D.get("DisplayNames", ["en"], { type: "region" }).of(n) === n || r && D.get("DisplayNames", ["en"], { type: "script" }).of(r) === r && !On.has(r));
	} catch {
		return !1;
	}
}, A = (e) => {
...
function Mn(e, t, n, r) {
	if (n && !n.allValid || !k(e, r) || !k(t, r) || jn(e, t)) return !1;
	if (!n) return !0;
	let i = wn(t);
...
function Yn(e, t = "en", n) {
	...
	e = j(e, n), t ||= "en";
	try {
		let i = A(e), a = D.get("Locale", e), o = a.language, s = Jn([
			r,
			e,
			i,
			o
			...
			t,
			"en"
		], g = D.get("DisplayNames", m, { type: "language" }), _ = D.get("DisplayNames", h, { type: "language" }), v = s?.name, y = s?.nativeName || s?.name, b = v || g.of(e) || e, ee = y || _.of(e) || e, te = s?.maximizedName || v || g.of(u) || e, x = s?.nativeMaximizedName || y || _.of(u) || e, ne = s?.minimizedName || v || g.of(p) || e, re = s?.nativeMinimizedName || y || _.of(p) || e, ie = s?.languageName || v || g.of(o) || e, ae = s?.nativeLanguageName || y || _.of(o) || e, oe = s?.nameWithRegionCode || (c ? `${ie} (${c})` : b), se = s?.nativeNameWithRegionCode || (c ? `${ae} (${c})` : ee) || oe, ce = D.get("DisplayNames", m, { type: "region" }), le = D.get("DisplayNames", h, { type: "region" }), ue = s?.regionName || (d ? ce.of(d) : "") || "", de = s?.nativeRegionName || (d ? le.of(d) : "") || "", fe = D.get("DisplayNames", m, { type: "script" }), pe = D.get("DisplayNames", h, { type: "script" });
		return {
			code: i,
			name: b,
			nativeName: ee,
		...
		let t = k(e) ? A(e) : e, r = t.split("-"), i = r[0] || t, a = r.length > 2 ? r[2] : r[1] || "", o = r[3] || "", s = Jn([t, i], n);
		t = s?.code || t;
...
var Er = class {
	...
	3204031479,
	3329325298
]), F = /* @__PURE__ */ new Uint32Array(64), Or = class extends Er {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		...
		for (let e = 0; e < 64; e++) {
			let t = N(o, 6) ^ N(o, 11) ^ N(o, 25), u = l + t + wr(o, s, c) + Dr[e] + F[e] | 0, d = (N(n, 2) ^ N(n, 13) ^ N(n, 22)) + Tr(n, r, i) | 0;
...
var Jr = class {
	...
	handle(e) {
		...
		let n = Gr[e.level], r = `[${e.level.toUpperCase()}]`;
	...
	shouldLog(e) {
		return Wr[e] >= Wr[this.config.level];
	}
	log(e, t, n, r) {
...
async function $r(e, t, n) {
	...
	try {
		...
		throw e instanceof Error && e.name === "AbortError" ? Lr(n) : e;
	} finally {
		o && clearTimeout(o);
	}
}
async function ei(e) {
	if (!e.ok) {
		...
		throw new _(Rr(e.status, e.statusText, t), e.status, t);
	}
}
async function ti(e, t, n, r) {
	...
	if (l.data === void 0 && l.response && !ie(l)) throw await ei(l.response), l.error;
	let u = ae(l);
...
var ni = class {
	...
	setConfig({ apiKey: e, devApiKey: t, sourceLocale: n, targetLocale: r, locales: i, projectId: a, customMapping: o, baseUrl: s }) {
		if (e && (this.apiKey = e), t && (this.devApiKey = t), a && (this.projectId = a), n && (this.sourceLocale = cr(n), !M(this.sourceLocale, o))) throw Error(Hr(this.sourceLocale));
		if (r && (this.targetLocale = cr(r), !M(this.targetLocale, o))) throw Error(Hr(this.targetLocale));
		if (i) {
			let e = [], t = [];
			if (i.forEach((n) => {
				let r = cr(n);
				M(r) ? e.push(r) : t.push(n);
			}), t.length > 0) throw Error(Ur(t));
			this.locales = e;
		}
...
function ii() {
	let e = oi();
	return e === void 0 ? si(() => void 0) : e;
}
function ai(e) {
	return e?.toUpperCase() === ri;
}
function oi() {
...
function ui() {
	let e = li("i18n")?.i18nConfig;
	return di(e) ? e.isDebugLoggingEnabled() : ai(ii());
}
function di(e) {
...
var Ci = class extends rr {
	constructor(e = {}) {
		...
		super(wi(e, t)), this.runtimeConfig = {
			...
			_tagIds: e._tagIds
		}, this.gtServicesEnabled = t, this.logLevel = ii();
	}
	getDefaultLocale() {
	...
	getLocaleConfig(e) {
		return !e || !Ei(e) ? this : new rr(Ti(e));
	}
...
var ji = (e) => `String interpolation failed for message: "${e}".`;
function Mi(e, t, n, r) {
	try {
		return or(e, {
			variables: t,
		...
		return z.warn(ji(e)), e;
	}
}
function Ni(e, t) {
	if (!e) return e;
	let n = t.$_fallback, r = Ai(t);
	try {
		let i = fn(n || "");
		return ar(Mi(Object.keys(i).length ? mn(e) : e, {
			...r,
			...i,
			[E]: "other"
		}, t.$locale, t.$format), { maxChars: t.$maxChars });
	} catch {
		return z.warn(ji(e)), t.$_fallback == null ? ar(e, { maxChars: t.$maxChars }) : Ni(t.$_fallback, {
			...t,
			$_fallback: void 0
		});
	}
...
function Fi({ source: e, target: t, options: n, sourceLocale: r }) {
	return t == null ? Ii(e, Li(n, r)) : Ii(t, {
		$_fallback: e,
		...n
	});
}
function Ii(e, t) {
	switch (t.$format ?? "STRING") {
		case "ICU": return Ni(e, t);
		case "I18NEXT":
		case "STRING": return Pi(e, t);
		default: return e;
	}
}
function Li(e, t) {
...
var { getConditionStore: Bi, setConditionStore: Vi } = zi(x({
	source: "gt-i18n",
	severity: "Error",
...
async function Ki({ locale: e, enableI18n: t }, n) {
	let r = pi(), i = B().getDefaultLocale(), a = await r.getLookupTranslation(t ? e : i);
	return (n, r = {}) => {
		let o = Ri(t ? r.$locale ?? e : B().getDefaultLocale(), r, "ICU");
		return Fi({
			source: n,
			target: a(n, o),
			options: o,
...
async function qi({ locale: e, enableI18n: t }) {
	...
	return (e, t = {}) => {
		if (e == null) return e;
		let r = Ui(e) ?? {};
		return Wi(r) ? n(r.$_source, r) : n(e, t);
	};
}
function Ji({ sourceLocale: e, targetLocale: t, sourceEntry: n, target: r, dictionaryOptions: i, options: a = {} }) {
	let o = Ri(t, {
		...i,
		...Ai(a)
	}, i.$format);
...
function ta(e) {
	return typeof e == "string" ? !0 : !Array.isArray(e) || typeof e[0] != "string" ? !1 : e.length === 1 || e.length === 2 && na(e[1]);
}
function na(e) {
	if (typeof e != "object" || !e || Array.isArray(e)) return !1;
	let t = e;
	return (t.$context === void 0 || typeof t.$context == "string") && (t.$format === void 0 || ra(t.$format)) && (t.$maxChars === void 0 || typeof t.$maxChars == "number");
}
function ra(e) {
...
function oa({ sourceObject: e, targetObject: t, translate: n }) {
	let r = W(t);
	if (r !== void 0) return r.entry;
	if (H(t)) return H(e) ? sa({
		sourceObject: e,
		targetObject: t,
		translate: n
	}) : oa({
...
async function ca({ locale: e, enableI18n: t, rootId: n }) {
	let r = pi(), i = B().getDefaultLocale(), a = t ? e : i, [o, s, c] = await Promise.all([
...
function pa({ type: e, remoteTranslationLoaderParams: t, loadTranslations: n }) {
	let { cacheUrl: r, projectId: i, _versionId: a, _branchId: o } = t;
	switch (e) {
		case "remote":
		case "gt-remote": return i ? da({
			cacheUrl: r,
			projectId: i,
			_versionId: a,
			_branchId: o,
		...
		case "disabled": return r === null ? async () => ({}) : ma(x({
...
var ga = class {
	...
	load(e) {
		return ha(this.pendingLoads, e, () => this.loadResource(e).then((t) => (this.set(e, t), t)));
	}
	getExpiresAt() {
...
function ya(e) {
	return {
		maxConcurrentRequests: va(e?.maxConcurrentRequests, _a.maxConcurrentRequests, !0),
		maxBatchSize: va(e?.maxBatchSize, _a.maxBatchSize, !0),
		batchInterval: va(e?.batchInterval, _a.batchInterval)
	};
}
var ba = class {
	constructor({ init: e, translateMany: t, onMiss: n, batchConfig: r }) {
		this.pendingTranslations = /* @__PURE__ */ new Map(), this.queue = [], this.batchTimer = null, this.activeRequests = 0, this.cache = structuredClone(e), this.translateMany = t, this.batchConfig = ya(r), this.onMiss = n;
	}
	get(e) {
	...
	async miss(e) {
		let t = this.getCacheKey(e), n = await ha(this.pendingTranslations, t, () => this.translate(e));
	...
	async sendBatchRequest(e) {
		this.activeRequests++;
		let t = xa(e), n = await this.sendBatchRequestWithErrorHandling(e, t);
...
async function Sa({ key: e, sourceValue: t, targetValue: n, translateEntry: r }) {
	...
	let a = H(n) ? n : {}, o = /* @__PURE__ */ new Set([...Object.keys(t), ...Object.keys(a)]), s = await Promise.all(Array.from(o).map(async (n) => {
		...
		Xi(n, i);
		let o = t[n];
		return o === void 0 ? [n, U(a[n])] : [n, await Sa({
			key: i,
			sourceValue: o,
			targetValue: a[n],
			translateEntry: r
...
var wa = class {
	...
	getEntry(e) {
		let t = W(Zi(this.cache, e));
		if (t !== void 0) return Ca(t);
	}
	getValue(e) {
		let t = Zi(this.cache, e);
	...
	async materializeValue(e, t, n = Zi(this.cache, e)) {
		return ha(this.pendingMaterializations, e, () => Sa({
			key: e,
			sourceValue: t,
			targetValue: n,
			translateEntry: async (e, t) => $i(await this.materializeEntry(e, t))
		}).then((t) => (this.setValue(e, t), t)));
	}
	async materializeEntry(e, t) {
		return Ca(await ha(this.pendingTranslations, e, () => this.runtimeTranslate(e, t).then((t) => {
			Qi(this.cache, e, t);
			let n = W(t);
...
function Ta(e, t) {
	for (let [n, r] of Object.entries(t)) {
		let t = e[n];
		H(t) && H(r) ? Ta(t, r) : e[n] = U(r);
	}
}
var Ea = 12e3, Da = class {
	constructor(e) {
		Oa(e), this.config = {
			projectId: e.projectId,
			devApiKey: e.devApiKey,
		...
		this.createTranslateMany = ua(B().getGTClass(), this.config.runtimeTranslation?.timeout ?? Ea, {
	...
	async translateDictionaryEntry(e, t, n) {
		let r = await this.lookupTranslationWithFallbackResolved(e, n.entry, ea(n.options));
...
function ka(e) {
	let t = "hash" in e ? e.hash : Hi(e.message, e.options);
	return `${e.locale}:${t}`;
}
var Aa = [];
function ja({ locale: e, enableI18n: t, localesProp: n = Aa }) {
...
var Na = "generaltranslation.locale-reset", Pa = "server-render", Fa = Symbol.for("generaltranslation.react-core.ReactI18nConfig"), Ia = class extends Ci {
	renderStrategy;
	localeCookieName;
	regionCookieName;
	enableI18nCookieName;
	constructor(e = {}, t = Pa) {
		super(e), za(t), Object.defineProperty(this, Fa, { value: !0 }), this.renderStrategy = t, this.localeCookieName = e.localeCookieName ?? "generaltranslation.locale", this.regionCookieName = e.regionCookieName ?? "generaltranslation.region", this.enableI18nCookieName = e.enableI18nCookieName ?? "generaltranslation.enable-i18n";
	}
	getRenderStrategy() {
...
var { getConditionStore: J, setConditionStore: Va, isConditionStoreInitialized: Ha } = zi(x({
	source: "@generaltranslation/react-core",
	severity: "Error",
...
function Ua({ Currency: e, GtInternalCurrency: t, DateTime: n, GtInternalDateTime: r, Num: i, GtInternalNum: a, RelativeTime: o, GtInternalRelativeTime: s, Var: c, GtInternalVar: l }) {
...
function Ga(e = {}, t) {
	return typeof e.name == "string" ? e.name : `_gt_${Wa[t] || "value"}_${e["data-_gt"]?.id}`;
}
function Ka(e) {
	...
	return function({ children: n, defaultLocale: r = "en", enableI18n: i }) {
		let a = (n) => {
			...
			if (a?.transformation === "plural") {
				let e = a.branches || {};
				return typeof n.props.n == "number" ? s(Ya(n.props.n, [r], e) ?? n.props.children) : n.props.children == null ? null : s(n.props.children);
			}
	...
	function r({ sourceElement: t, targetElement: r, locales: a = ["en"], enableI18n: o }) {
		...
		if (u && Object.entries(hn).forEach(([e, t]) => {
			...
			return typeof e == "number" ? i({
				source: Ya(e, a, c.branches || {}) ?? t.props.children,
				target: Ya(e, a, r.d?.b || {}) ?? r.c,
				locales: a,
				enableI18n: o
			}) : n({
				children: t,
...
var eo = { display: "contents" }, to = globalThis.navigator?.product === "ReactNative";
function no(e) {
	if (e == null || typeof e == "boolean" || e === "") return !0;
	if (Array.isArray(e)) return !e.some((e) => !no(e));
	if (o(e) && e.type === n) {
...
function ro(e, t) {
	return to || !Qa() ? e : o(e) && typeof e.type == "string" ? r(e, { "data-_gt-hash": t }) : no(e) ? e : a("span", {
		"data-_gt-hash": t,
		style: eo
	}, e);
}
function io({ renderDefaultChildren: e, renderTranslatedChildren: t }) {
...
function ao(e) {
	let t = Ua(e), n = Xa({ renderVariable: t }), r = Za({ renderVariable: t });
	return {
		renderVariable: t,
...
var oo = class extends Da {};
function so(e) {
	Ra(e, "server-render"), Ma(new oo(e));
}
var co = R({
	namespace: "reactCore",
	key: "i18nStore",
...
function po(e, t) {
	let n = t.options.$_hash ?? Hi(t.message, t.options);
	return e?.[t.locale]?.[n];
}
function mo(e, t) {
	return W(go(e, t));
...
function go(e, { locale: t, id: n }) {
	let r = e?.[t];
	if (!r) return;
	if (!n) return r;
	let i = r;
	for (let e of n.split(".")) {
		if (!_o(e) || !H(i) || !Object.prototype.hasOwnProperty.call(i, e)) return;
		i = i[e];
	}
	return i;
}
...
var yo = class {
	...
	subscribeToTranslate = (e, t) => {
		let n = ka(e);
		return fo(this.translateListeners, (e) => {
			ka(e) === n && t();
		});
	};
	subscribeToTranslationEvents = (e) => fo(this.translateListeners, e);
	subscribeToDictionaryEntryEvents = (e) => fo(this.dictionaryEntryListeners, e);
	subscribeToDictionaryObjectEvents = (e) => fo(this.dictionaryObjectListeners, e);
	getTranslateSnapshot = (e, t = {}) => po(t, e) ?? K().lookupTranslation(e.locale, e.message, e.options);
	getDictionaryEntrySnapshot = (e, t = {}) => mo(t, e) ?? K().lookupDictionary(e.locale, e.id);
	getDictionaryObjectSnapshot = (e, t = {}) => ho(t, e) ?? K().lookupDictionaryObj(e.locale, e.id);
...
function xo() {
	return bo.isInitialized() || bo.set(i(void 0)), bo.get();
}
function So() {
	let e = s(xo());
...
function wo() {
	return So()?.conditionStore ?? J();
}
function Y() {
	return wo().getLocale();
}
function X() {
	return wo().getEnableI18n();
}
function To() {
	return l(() => B().getDefaultLocale(), []);
}
function Eo() {
	return So()?.i18nStore || lo();
}
function Do() {
...
var Ao = ko;
function jo({ _enableI18n: e, _locale: t, children: n, currency: r = "USD", options: i = {}, locales: a = [] }) {
	let o = ja({
		locale: t,
		enableI18n: e,
		localesProp: a
...
Mo._gtt = "variable-currency-automatic", No._gtt = "variable-currency";
function Po({ _enableI18n: e, _locale: t, children: n, options: r = {}, locales: i = [] }) {
	let a = ja({
		locale: t,
		enableI18n: e,
		localesProp: i
...
Fo._gtt = "variable-datetime-automatic", Io._gtt = "variable-datetime";
...
Ro._gtt = "variable-number-automatic", zo._gtt = "variable-number";
...
Vo._gtt = "variable-relative-time-automatic", Ho._gtt = "variable-relative-time";
function Uo({ children: e }) {
	return e;
}
function Wo({ children: e }) {
	return Uo({ children: e });
}
function Go({ children: e }) {
	return Uo({ children: e });
}
Wo._gtt = "variable-variable", Go._gtt = "variable-variable-automatic";
function Ko(e) {
	let t = Eo(), n = Do();
	return Ao(), d((n) => t.subscribeToTranslate(e, n), () => t.getTranslateSnapshot(e, n), () => t.getTranslateSnapshot(e, n));
}
var { renderVariable: qo, renderDefaultChildren: Jo, renderTranslatedChildren: Yo, renderPreparedT: Xo } = ao({
	Currency: No,
	GtInternalCurrency: Mo,
	DateTime: Io,
	GtInternalDateTime: Fo,
	Num: zo,
	GtInternalNum: Ro,
	RelativeTime: Ho,
	GtInternalRelativeTime: Vo,
	Var: Wo,
	GtInternalVar: Go
});
function Zo(t, n = 0) {
	let r = n, i = (e) => {
		...
		if (a) {
			...
			if ((e[1] === "automatic" || e[2] === "automatic") && (i.injectionType = "automatic"), e[0] === "translate" && (e[0] = "fragment"), e[0] === "variable" && (i.variableType = e?.[1] || "variable"), e[0] === "plural") {
				let e = Object.entries(n).reduce((e, [t, n]) => (sn(t) && (e[t] = Zo(n, r)), e), {});
...
function $o(e, t) {
	let { type: n, props: i } = e, a = ns(n);
	if (typeof i != "object" || !i) return e;
	if (a) {
		let { componentType: n, injectionType: o } = a;
		if (n === "variable") return e;
		if (n === "branch") return r(e, { ...Object.entries(i).reduce((e, [n, r]) => (e[n] = n !== "branch" && !n.startsWith("data-") ? es(r, t) : r, e), {}) });
		if (n === "plural") return r(e, { ...Object.entries(i).reduce((e, [n, r]) => (e[n] = sn(n) || n === "children" ? es(r, t) : r, e), {}) });
		if (n === "derive") return r(e, {
			...i,
			..."children" in i && { children: ts(i.children, t + 1) }
		});
		if (n === "translate" && o === "automatic" && t > 0) return "children" in i ? ts(i.children, t) : void 0;
		n === "translate" && o === "automatic" && console.warn(rs);
	}
	return r(e, {
		...i,
		..."children" in i && { children: ts(i.children, t) }
	});
}
function es(e, t) {
	return o(e) ? $o(e, t) : e;
...
function ts(e, n) {
	return Array.isArray(e) ? t.map(e, (e) => es(e, n)) : es(e, n);
}
function ns(e) {
...
var rs = "'@generaltranslation/react-core Warning: A <_T> component was found injected outside of a <Derive> boundary. This may affect translation resolution for this component.";
function is(t) {
...
var as = (e) => {
	...
	let { props: t } = e, n = { t: as(e) };
	if (t["data-_gt"]) {
		let e = t["data-_gt"], r = e.transformation;
		if (r === "variable") {
			let n = e.variableType || "variable", r = Ga(t, n), i = un(n);
			return {
				i: e.id,
				k: r,
				v: i
		...
		n.i = e.id, n.d = os(r, t, e.branches);
	}
	return t.children && (n.c = ls(t.children)), n;
}, cs = (e) => is(e) ? ss(e) : typeof e == "number" ? e.toString() : e;
function ls(e) {
	return Array.isArray(e) ? e.map(cs) : cs(e);
}
function us({ sourceChildren: e, params: t, locale: n }) {
	let r = ds(e), i = fs(r), a = ps({
		options: ms(t),
		locale: n
	});
	return $a(i, a), {
...
function ps({ options: e, locale: t }) {
	return {
		...e,
		$locale: t
	};
...
function hs({ sourceChildren: e, params: t, _locale: n, _enableI18n: r }) {
...
gs._gtt = "translate-client";
function _s({ children: e, _locale: t, _enableI18n: n, _renderPreparedT: r = Xo, ...i }) {
	let { defaultLocale: a, locale: o, enableI18n: s, targetOptions: c, taggedSourceChildren: l, sourceJsxChildren: d, shouldTranslate: f } = hs({
		sourceChildren: e,
		params: i,
		_locale: t,
		_enableI18n: n
...
function Ss(e) {
	let t = q(), n = bs(t.getLocaleCookieName());
...
function Es({ source: e, severity: t, whatHappened: n, reassurance: r, why: i, fix: a, wayOut: o, details: s, docsUrl: c }) {
	let l = e ? t ? `${e} ${t}:` : `${e}:` : t ? `${t}:` : "", u = i ? `${ws(n)} because ${ws(i)}` : n, d = !!a && !!o && /^[a-z]/.test(ws(o)), f = [
		u,
		r,
		d ? `${ws(a)}, or ${ws(o)}` : a,
		d ? void 0 : o,
...
}), { setConditionStore: Os, isConditionStoreInitialized: ks } = zi(Ds), { getConditionStore: As, setConditionStore: js, isConditionStoreInitialized: Ms } = zi(Ds);
function Ns(e) {
	let t = Ps(e), n = Fs(e), r = Is(e);
	if (Ms()) {
		let e = As();
...
function Ps({ _getLocale: e, locale: t }) {
	let n = q(), r = [];
	return t && r.push(...Array.isArray(t) ? t : [t]), e && r.push(e()), r.push(...bs(n.getLocaleCookieName())), n.resolveSupportedLocale(r);
}
function Fs({ _getRegion: e, region: t }) {
	return Z({ cookieName: q().getRegionCookieName() }) || e?.() || t;
}
function Is({ enableI18n: e, _getEnableI18n: t }) {
...
function Rs() {
	return {
		projectId: zs(() => void 0) || Bs(),
		devApiKey: _i() === "development" ? zs(() => void 0) || Vs() : void 0
	};
}
function zs(e) {
	try {
...
function Bs() {
	try {
		return Hs(process.env.VITE_GT_PROJECT_ID);
	} catch {
		return;
	}
}
function Vs() {
	try {
		return Hs(process.env.VITE_GT_DEV_API_KEY);
	} catch {
		return;
	}
}
...
var Gs = () => f("div", {
	...
	children: f(gs, { children: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." })
});
function Ks(e) {
	let t = e.trim();
	return t ? /[.!?)]$/.test(t) ? t : `${t}.` : "";
...
function Js(e) {
	if (!e) return "";
	let t = Array.isArray(e) ? e.join(", ") : e;
	return t.trim() ? Ks(`Details: ${t}`) : "";
}
function Ys({ source: e, severity: t, whatHappened: n, reassurance: r, why: i, fix: a, wayOut: o, details: s, docsUrl: c }) {
...
Zs.set;
var Qs = Zs.isInitialized;
function $s(e, t = tc()) {
	let { pathname: n } = nc(e, t), r = n.match(/^\/([^/]+)(?:\/|$)/);
	if (!r) return;
	let i;
	try {
...
function ec(e, t, n = tc()) {
	let r = q(), { basepath: i, pathname: a } = nc(e, n), o = $s(a, "/") ? a.replace(/^\/[^/]+/, "") || "/" : a, s = r.resolveSupportedLocale(t);
...
function ac(e, t, n = new URL(e.url).pathname) {
...
var oc = p().server(() => $().getLocale()).client(() => J().getLocale());
p().server(() => $().getEnableI18n()).client(() => J().getEnableI18n()), p().server((e) => {
	let t = $();
	return Ki({
		locale: t.getLocale(),
...
m().server(({ request: e, pathname: t, next: n }) => $().run(e, () => n(), t));
function lc(e) {
	let t = e.localeRouting && !e._reload ? {
		...e,
		_reload: ({ locale: e }) => {
			let t = ec(window.location.pathname, e), n = new URL(window.location.href);
