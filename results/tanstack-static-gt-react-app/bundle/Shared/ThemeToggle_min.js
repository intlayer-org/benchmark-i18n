...
function kn(...e) {
	try {
		let t = e.flat().map((e) => O.get("Locale", Dn(e))), [n] = t, r = new Set(t.map(({ region: e }) => e).filter(Boolean)), i = new Set(t.map(({ script: e }) => e).filter(Boolean));
...
function Ln(e, t) {
	...
	e = In(e, t);
	try {
		let r = Dn(e), i = O.get("Locale", r), { language: a, region: o } = i;
		if (t) for (let i of [
			n,
			e,
			r,
...
function Jn(e, t = "en", n) {
	...
	e = In(e, n), t ||= "en";
	try {
		let i = Dn(e), a = O.get("Locale", e), o = a.language, s = qn([
			r,
			e,
			i,
			o
...
function er(e, t) {
	try {
		let { language: n, region: r, script: i } = O.get("Locale", Dn(e)), { language: a, region: o, script: s } = O.get("Locale", Dn(t));
...
function rr(e, t = "en", n) {
	...
	let r = e, i = Bn;
	try {
		r = O.get("DisplayNames", [t, "en"], { type: "region" }).of(e) || e, i = Gn(e);
	} catch {}
	return {
		code: e,
		name: r,
...
async function ri(e) {
	if (!e.ok) {
		...
		throw new ie(Br(e.status, e.statusText, t), e.status, t);
	}
}
...
var { getConditionStore: Mi, setConditionStore: Ni } = ji(E({
	source: "gt-i18n",
	severity: "Error",
...
var { getConditionStore: Wi, setConditionStore: Gi, isConditionStoreInitialized: Ki } = ji(E({
	source: "@generaltranslation/react-core",
	severity: "Error",
...
var Ea = wa;
function Da(e) {
	let t = k().isDevHotReloadEnabled(), n = Sa(), r = /* @__PURE__ */ new Map();
	return d(() => {
...
var go = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/gt-react-app/src/components/ThemeToggle.tsx";
function _o() {
...
function yo() {
	...
	d(() => {
		...
		if (e !== "auto") return;
		let t = window.matchMedia("(prefers-color-scheme: dark)"), n = () => vo("auto");
	...
	function n() {
		...
		t(n), vo(n), window.localStorage.setItem("theme", n);
	}
	...
	return _("button", {
		...
		children: e === "auto" ? _(mo, { children: "Theme: Auto" }, void 0, !1, {
			fileName: go,
			lineNumber: 80,
			columnNumber: 9
		}, this) : e === "dark" ? _(mo, { children: "Theme: Dark" }, void 0, !1, {
			fileName: go,
			lineNumber: 82,
			columnNumber: 9
		}, this) : _(mo, { children: "Theme: Light" }, void 0, !1, {
			fileName: go,
			lineNumber: 84,
			columnNumber: 9
		}, this)
...
var Cc = w(((e) => {
	...
	Object.defineProperty(e, "__esModule", { value: !0 }), ys(), re(Io), Cc();
})), Tc = Cc();
wc();
...
function xl(e, t = "en", n) {
	...
	try {
		let i = L(e), a = A.get("Locale", e), o = a.language, s = bl([
			...
			t,
			"en"
		], g = A.get("DisplayNames", m, { type: "language" }), _ = A.get("DisplayNames", h, { type: "language" }), v = s?.name, y = s?.nativeName || s?.name, b = v || g.of(e) || e, x = y || _.of(e) || e, S = s?.maximizedName || v || g.of(u) || e, C = s?.nativeMaximizedName || y || _.of(u) || e, ee = s?.minimizedName || v || g.of(p) || e, te = s?.nativeMinimizedName || y || _.of(p) || e, w = s?.languageName || v || g.of(o) || e, T = s?.nativeLanguageName || y || _.of(o) || e, ne = s?.nameWithRegionCode || c ? `${w} (${c})` : b, re = s?.nativeNameWithRegionCode || (c ? `${T} (${c})` : x) || ne, ie = A.get("DisplayNames", m, { type: "region" }), ae = A.get("DisplayNames", h, { type: "region" }), oe = s?.regionName || (d ? ie.of(d) : "") || "", se = s?.nativeRegionName || (d ? ae.of(d) : "") || "", ce = A.get("DisplayNames", m, { type: "script" }), E = A.get("DisplayNames", h, { type: "script" });
		return {
			code: i,
			name: b,
			nativeName: x,
...
function Qg({ children: e, config: t, environment: n = "production", projectId: r = t?.projectId || "", devApiKey: a = t?.devApiKey || "", _versionId: o = t?._versionId, dictionary: s = t?.dictionary || {}, locales: c = t?.locales || [], defaultLocale: l = t?.defaultLocale || Ip, cacheUrl: u = t?.cacheUrl || Bp, runtimeUrl: p = t?.runtimeUrl || Vp, renderSettings: h = t?.renderSettings || xg(n), ssr: _ = t?.ssr || Yg(), localeCookieName: v = t?.localeCookieName || "generaltranslation.locale", locale: y = "", region: b, loadDictionary: x, loadTranslations: S, fallback: C, translations: ee = null, customMapping: te = t?.customMapping, enableI18n: w = t?.enableI18n === void 0 || t.enableI18n, enableI18nLoaded: T, reloadOnLocaleUpdate: ne, useEnableI18n: re = Jg, readAuthFromEnv: ie = fg, useDetermineLocale: ae = Xg, useRegionState: oe = Zg, ...se }) {
	...
	let { projectId: ce, devApiKey: E } = ie({
		...
		ssr: _
	}), { locale: ue, setLocale: de, locales: fe, translationRequired: pe, dialectTranslationRequired: me } = Ug({
		_locale: y,
		defaultLocale: l,
		locales: c,
		ssr: _,
	...
	let { translations: Ce, setTranslations: we } = Kg({
		...
		environment: n
	}), Me = Hg(_e, ye, xe, Ce, ue, l, pe, me, De, Te, n), Ne = qg(ye || {}, xe || {}, be, Se, Ce, ue, l, pe, me, De, Te, Me), Pe = !(pe && !Ce || !ue);
...
var sy = v().server(function({ defaultLocale: e, locales: t, customMapping: n }) {
	let r = [], i = y(jp);
...
var Ty = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/gt-react-app/scripts/Wrapper.tsx";
uy({
	...Sy,
	loadTranslations: wy
});
...
var Dy = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/gt-react-app/src/components/ThemeToggle.wrapper.tsx";
function Oy() {
	return _(Ey, { children: _(yo, {}, void 0, !1, {
		fileName: Dy,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
