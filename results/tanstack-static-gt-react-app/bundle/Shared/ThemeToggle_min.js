import e, { Children as t, Fragment as n, cloneElement as r, createContext as i, createElement as a, isValidElement as o, useContext as s, useEffect as c, useMemo as l, useRef as u, useState as d, useSyncExternalStore as f } from "react";
	...
	function i({ source: i, target: a, locales: o = ["en"], enableI18n: s }) {
		...
		if (Array.isArray(a) && !Array.isArray(i) && i && (i = [i]), Array.isArray(i) && Array.isArray(a)) {
			...
			return a.map((i, a) => {
				...
				if (Qt(i)) return p(e.Fragment, { children: t({
					variableType: i.v || "v",
					variableValue: n[i.k],
...
function Js() {
	...
	c(() => {
		...
		if (e !== "auto") return;
		let t = window.matchMedia("(prefers-color-scheme: dark)"), n = () => qs("auto");
	...
	function n() {
		...
		t(n), qs(n), window.localStorage.setItem("theme", n);
	}
	...
	return p("button", {
		...
		children: e === "auto" ? p(_s, { children: "Theme: Auto" }) : e === "dark" ? p(_s, { children: "Theme: Dark" }) : p(_s, { children: "Theme: Light" })
	});
}
function Ys(e) {
	let t = e.trim();
...
var lc = m().server(() => $().getLocale()).client(() => J().getLocale());
