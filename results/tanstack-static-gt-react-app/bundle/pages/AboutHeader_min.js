	...
	function i({ source: i, target: a, locales: o = ["en"], enableI18n: s }) {
		...
		if (Array.isArray(a) && !Array.isArray(i) && i && (i = [i]), Array.isArray(i) && Array.isArray(a)) {
			...
			return a.map((i, a) => {
				...
				if (en(i)) return m(e.Fragment, { children: t({
					variableType: i.v || "v",
					variableValue: n[i.k],
...
function Yo(e) {
	let t = ko(), n = Ao();
	return No(), f((n) => t.subscribeToTranslate(e, n), () => t.getTranslateSnapshot(e, n), () => t.getTranslateSnapshot(e, n));
}
...
ys._gtt = "translate-client";
function bs({ children: e, _locale: t, _enableI18n: n, _renderPreparedT: r = $o, ...i }) {
	let { defaultLocale: a, locale: o, enableI18n: s, targetOptions: c, taggedSourceChildren: l, sourceJsxChildren: u, shouldTranslate: f } = vs({
		sourceChildren: e,
		params: i,
		_locale: t,
		_enableI18n: n
...
function Ys() {
	return Js("AboutHeader"), h(p, { children: [m("h1", {
		className: "mb-4 text-3xl font-bold text-foreground",
		children: m(ys, { children: "About This Benchmark" })
	}), m("p", {
		className: "mb-8 max-w-3xl text-muted-foreground",
		children: m(ys, { children: "This is an open-source test application — not a product or a company. Its sole purpose is to provide a realistic, multi-page React app where different i18n libraries can be integrated and measured under identical conditions." })
	})] });
}
function Xs(e) {
	let t = e.trim();
...
function Qs(e) {
	if (!e) return "";
	let t = Array.isArray(e) ? e.join(", ") : e;
	return t.trim() ? Xs(`Details: ${t}`) : "";
}
function $s({ source: e, severity: t, whatHappened: n, reassurance: r, why: i, fix: a, wayOut: o, details: s, docsUrl: c }) {
	let l = e ? t ? `${e} ${t}:` : `${e}:` : t ? `${t}:` : "", u = i ? `${Zs(n)} because ${Zs(i)}` : n, d = !!a && !!o && /^[a-z]/.test(Zs(o)), f = [
		u,
		r,
		d ? `${Zs(a)}, or ${Zs(o)}` : a,
		d ? void 0 : o,
...
tc.set;
var nc = tc.isInitialized;
function rc(e, t = ac()) {
	let { pathname: n } = oc(e, t), r = n.match(/^\/([^/]+)(?:\/|$)/);
	if (!r) return;
	let i;
	try {
...
function ic(e, t, n = ac()) {
	let r = q(), { basepath: i, pathname: a } = oc(e, n), o = rc(a, "/") ? a.replace(/^\/[^/]+/, "") || "/" : a, s = r.resolveSupportedLocale(t);
...
function lc(e, t, n = new URL(e.url).pathname) {
...
var uc = g().server(() => $().getLocale()).client(() => J().getLocale());
...
function pc(e) {
	let t = e.localeRouting && !e._reload ? {
		...e,
		_reload: ({ locale: e }) => {
			let t = ic(window.location.pathname, e), n = new URL(window.location.href);
