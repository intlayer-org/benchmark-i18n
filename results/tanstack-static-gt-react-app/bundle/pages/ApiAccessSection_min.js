...
function qs() {
	...
	return m("section", {
		...
		children: [p("h2", {
			...
			children: p(_s, { children: "API Access" })
		}), m("div", { children: [
			p("label", {
				htmlFor: e,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: p(_s, { children: "API Key" })
			}),
			m("div", {
				...
				children: [p("input", {
					...
					children: p(_s, { children: "Copy" })
				})]
			}),
			p("p", {
				className: "mt-1 text-xs text-muted-foreground",
				children: p(_s, { children: "Use this key to access the benchmarking API programmatically." })
			})
		] })]
	});
}
