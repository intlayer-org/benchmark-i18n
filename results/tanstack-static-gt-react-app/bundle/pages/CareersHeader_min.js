...
var go = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/gt-react-app/src/components/MockBanner.tsx", _o = () => v("div", {
	className: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground",
	children: v(mo, { children: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." }, void 0, !1, {
		fileName: go,
		lineNumber: 5,
		columnNumber: 5
	}, void 0)
	...
	lineNumber: 4,
	columnNumber: 3
}, void 0), vo = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/gt-react-app/src/components/pages/careers/CareersHeader.tsx";
function yo() {
	return v(_, { children: [
		v(_o, {}, void 0, !1, {
			fileName: vo,
		...
		v("h1", {
			...
			children: v(mo, { children: "Careers" }, void 0, !1, {
				fileName: vo,
				lineNumber: 9,
				columnNumber: 9
			}, this)
		...
		v("p", {
			...
			children: v(mo, { children: "Join our mission to improve the internationalization ecosystem. We're a remote-first team that values impact, transparency, and continuous learning." }, void 0, !1, {
				fileName: vo,
				lineNumber: 12,
				columnNumber: 9
			}, this)
...
function Ks(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		if (Rs.test(i.stem)) {
			...
			var a = i.options[0];
			a === "w" ? t = M(M({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = M(M({}, t), Hs(a)));
			continue;
		}
		if (zs.test(i.stem)) {
			t = M(M({}, t), Hs(i.stem));
...
var hc = function() {
	...
	return e.prototype.parse = function() {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !gc(this.char())) return this.error(N.INVALID_TAG, F(o, this.clonePosition()));
...
var Cc = T(((e) => {
	...
	Object.defineProperty(e, "__esModule", { value: !0 }), ys(), ie(Io), Cc();
})), Tc = Cc();
wc();
...
var tl = function() {
	...
	try {
		...
		})() || j.get("DisplayNames", ["en"], { type: "language" }).of(t) === t && !rl(t) || n && j.get("DisplayNames", ["en"], { type: "region" }).of(n) === n || r && j.get("DisplayNames", ["en"], { type: "script" }).of(r) === r && !nl.includes(r));
	} catch {
		return !1;
	}
}, R = (e) => {
...
function sl(e, t, n, r) {
	return !(!L(e, r) || !L(t, r) || n && n.some((e) => !L(e, r)) || al(e, t) || n && !n.some((e) => ol(t, e)));
}
var cl = (e, t, n) => {
	if (e?.[t]) return typeof e[t] == "string" ? n === "name" ? e[t] : void 0 : e[t][n];
}, ll = (e, t) => !!(t?.[e] && typeof t[e] == "object" && "code" in t[e] && t[e].code && L(t[e].code));
function ul(e, t) {
	let n = e;
	t && ll(e, t) && (e = t[e].code);
	try {
...
function xl(e, t = "en", n) {
	...
	try {
		let i = R(e), a = j.get("Locale", e), o = a.language, s = bl([
			r,
			e,
			i,
			o
		...
		let t = L(e) ? R(e) : e, r = t?.split("-"), i = r?.[0] || t || "", a = r.length > 2 ? r?.[2] : r?.[1] || "", o = r?.[3] || "", s = bl([t, i], n);
		t = s?.code || t;
		let c = s?.name || t, l = s?.nativeName || c, u = s?.maximizedCode || t, d = s?.maximizedName || c, f = s?.nativeMaximizedName || l, p = s?.minimizedCode || t, m = s?.minimizedName || c, h = s?.nativeMinimizedName || l;
		i = s?.languageCode || i;
		let g = s?.languageName || c, _ = s?.nativeLanguageName || l;
...
var uu = "GT Error:", du = (e) => `${uu} Translation request timed out after ${e}ms.`, fu = (e) => `${uu} Translation request failed. Error: ${e}`, pu = (e, t, n) => `${uu} API returned error status. Status: ${e}, Status Text: ${t}, Error: ${n}`, mu = (e) => `${uu} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a targetLocale in the GT constructor.`, hu = (e) => `${uu} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a sourceLocale in the GT constructor.`, gu = (e) => `${uu} Cannot call \`${e}\` without a specified project ID. Either pass a project ID to the \`${e}\` function or specify a projectId in the GT constructor.`, _u = (e) => `${uu} Cannot call \`${e}\` without a specified API key. Either pass an API key to the \`${e}\` function or specify an apiKey in the GT constructor.`, vu = (e) => `${uu} Invalid locale: ${e}.`, yu = (e) => `${uu} Invalid locales: ${e.join(", ")}.`;
...
var Cu = "2026-03-06.v1";
function wu(e, t = !1) {
	let n = {
		...!t && { "Content-Type": "application/json" },
		"x-gt-project-id": e.projectId
	};
	return e.apiKey && (e.apiKey.startsWith("gtx-internal-") ? n["x-gt-internal-api-key"] = e.apiKey : n["x-gt-api-key"] = e.apiKey), n["gt-api-version"] = Cu, n;
}
var Tu = 3, Eu = 500;
function Du(e) {
...
function Ou(e, t) {
	switch (e) {
		case "linear": return Eu * (t + 1);
		case "exponential": return Eu * 2 ** t;
		default: return 0;
	}
}
async function z(e, t, n) {
	let r = n?.timeout ?? 6e4, i = `${e.baseUrl || "https://api2.gtx.dev"}${t}`, a = n?.method ?? "POST", o = n?.retryPolicy ?? "exponential", s = o === "none" ? 0 : Tu, c = {
		method: a,
		headers: wu(e)
	};
	...
	for (let e = 0; e <= s; e++) {
		...
		return await xu(t), await t.json();
	}
	throw Error("Max retries exceeded");
}
...
async function Fu(e, t, n) {
	return Mu(e, async (e) => (await z(n, "/v2/project/files/download", {
		body: e,
		timeout: t.timeout
	})).files.map((e) => ({
		...e,
...
async function Iu(e, t, n = {}) {
	return await Mu(e.diffs, async (e) => (await z(t, "/v2/project/files/diffs", {
		body: { diffs: e },
		timeout: n.timeout
	}), [{ success: !0 }]), { batchSize: 100 }), { success: !0 };
}
function Lu(e, t = "en", n) {
	t ||= "en";
	try {
		return {
			code: e,
...
async function Ru(e, t, n) {
	return Mu(e, async (e) => (await z(n, "/v2/project/files/upload-files", {
		body: {
...
async function zu(e, t, n) {
	return Ao(e.map(({ source: e }) => e)), Mu(e, async (e) => (await z(n, "/v2/project/files/upload-translations", {
		body: {
...
async function Vu(e, t, n) {
	...
	return await xu(o), await o.json();
}
...
async function qu(e, t, n) {
	...
	let r = await Mu(e, async (e) => (await z(n, "/v2/project/files/moves", {
		body: {
			branchId: t.branchId,
			moves: e
		},
...
async function Ju(e, t, n = {}, r) {
	...
	let a = ju(t, 100), o = await Promise.all(a.map((e) => i(e)));
...
var Xu = class {
	...
	setConfig({ apiKey: e, devApiKey: t, sourceLocale: n, targetLocale: r, locales: i, projectId: a, customMapping: o, baseUrl: s }) {
		if (e && (this.apiKey = e), t && (this.devApiKey = t), a && (this.projectId = a), n && (this.sourceLocale = R(n), !L(this.sourceLocale, o))) throw Error(vu(this.sourceLocale));
		if (r && (this.targetLocale = R(r), !L(this.targetLocale, o))) throw Error(vu(this.targetLocale));
		if (i) {
			let e = [], t = [];
			if (i.forEach((n) => {
				let r = R(n);
				L(r) ? e.push(r) : t.push(n);
			}), t.length > 0) throw Error(yu(t));
			this.locales = e;
		}
	...
	async queryBranchData(e) {
		return this._validateAuth("queryBranchData"), await Gu(e, this._getTranslationConfig());
	}
	async createBranch(e) {
		return this._validateAuth("createBranch"), await Ku(e, this._getTranslationConfig());
	}
	async processFileMoves(e, t = {}) {
		return this._validateAuth("processFileMoves"), await qu(e, t, this._getTranslationConfig());
	}
	async getOrphanedFiles(e, t, n = {}) {
		return this._validateAuth("getOrphanedFiles"), await Ju(e, t, n, this._getTranslationConfig());
	}
	async setupProject(e, t) {
		return this._validateAuth("setupProject"), t = {
			...t,
			locales: t?.locales?.map((e) => this.resolveCanonicalLocale(e))
		}, await Au(e, this._getTranslationConfig(), t);
	}
	async checkJobStatus(e, t) {
		return this._validateAuth("checkJobStatus"), await Hu(e, this._getTranslationConfig(), t);
	}
	async awaitJobs(e, t) {
		return this._validateAuth("awaitJobs"), await Uu(e, t, this._getTranslationConfig());
	}
	async enqueueFiles(e, t) {
		...
		}, await Nu(e, n, this._getTranslationConfig());
	}
	async createTag(e) {
		return this._validateAuth("createTag"), await Pu(e, this._getTranslationConfig());
	}
	async publishFiles(e) {
		return this._validateAuth("publishFiles"), await Yu(e, this._getTranslationConfig());
	}
	async submitUserEditDiffs(e) {
		this._validateAuth("submitUserEditDiffs"), await Iu({
			...e,
			diffs: (e.diffs || []).map((e) => ({
				...e,
	...
	async queryFileData(e, t = {}) {
		...
		let n = await Wu(e, t, this._getTranslationConfig());
	...
	async downloadFile(e, t = {}) {
		return this._validateAuth("downloadTranslatedFile"), (await Fu([{
			fileId: e.fileId,
			branchId: e.branchId,
	...
	async downloadFileBatch(e, t = {}) {
		...
		let n = await Fu(e, t, this._getTranslationConfig());
		return {
			files: n.data.map((e) => ({
				...e,
				...e.locale && { locale: this.resolveAliasLocale(e.locale) }
	...
	async uploadSourceFiles(e, t) {
		...
		let r = await Ru(e, n, this._getTranslationConfig());
		return {
	...
	getLocaleName(e = this.targetLocale) {
		if (!e) throw Error(mu("getLocaleName"));
		return this.localeConfig.getLocaleName(e);
	}
	getLocaleEmoji(e = this.targetLocale) {
		if (!e) throw Error(mu("getLocaleEmoji"));
		return this.localeConfig.getLocaleEmoji(e);
	}
	getLocaleProperties(e = this.targetLocale) {
		if (!e) throw Error(mu("getLocaleProperties"));
		return this.localeConfig.getLocaleProperties(e);
	}
	getRegionProperties(e = this.getLocaleProperties().regionCode, t) {
		if (!t) {
		...
		return Lu(e, this.targetLocale, t);
	}
	requiresTranslation(e = this.sourceLocale, t = this.targetLocale, n = this.locales, r = this.customMapping) {
		if (!e) throw Error(hu("requiresTranslation"));
		if (!t) throw Error(mu("requiresTranslation"));
...
function ld(e) {
	let t = [];
	return t.push(...id(e)), t.push(...od(e)), t.push(...cd(e)), t;
}
var ud = class {}, dd = "fallback-storage-adapter", fd = class extends ud {
	constructor(...e) {
		super(...e), this.type = dd, this.storage = {};
	}
	getItem(e) {
...
function _d({ type: e, remoteTranslationLoaderParams: t, loadTranslations: n }) {
...
var bd = 25, xd = 100, Sd = 50, Cd = class extends vd {
	...
	genKey(e) {
		return yd(e.message, e.options);
	}
	fallback(e) {
		let t = this._enqueueTranslation(e);
		return this._queue.length >= bd ? this._flushNow() : this._scheduleBatch(), t;
	}
	_flushNow() {
	...
	_drainQueue() {
		for (; this._queue.length > 0 && this._activeRequests < xd;) {
			let e = this._queue.splice(0, bd);
	...
	async _sendBatchRequest(e) {
		...
		let t = wd(e), n = await this._sendBatchRequestWithErrorHandling(e, t);
...
var Td = 6e4, Ed = class extends vd {
	constructor({ init: e = {}, ttl: t, loadTranslations: n, createTranslateMany: r, lifecycle: { onLocalesCacheHit: i, onLocalesCacheMiss: a, onTranslationsCacheHit: o, onTranslationsCacheMiss: s } }) {
		super(e, {
			onHit: i,
			onMiss: a
		}), this.ttl = Td, this.ttl = t === null ? -1 : t ?? 6e4, this._translationLoader = n, this._createTranslateMany = r, this._onTranslationsCacheHit = o, this._onTranslationsCacheMiss = s;
	}
	get(e) {
		let t = this.getCache(e);
...
function kd({ onLocalesCacheHit: e, onLocalesCacheMiss: t, onTranslationsCacheHit: n, onTranslationsCacheMiss: r }, i) {
...
var Ad = 12e3, jd = class extends Od {
	constructor(e) {
		super(), this.resolveTranslationSync = (e, t = {}) => this.lookupTranslation(e, t), nd(ld(e), "I18nManager: "), this.config = Md(e), this.localeConfig = new eu({
			defaultLocale: this.config.defaultLocale,
			locales: this.config.locales,
			customMapping: this.config.customMapping
		}), this.storeAdapter = e.storeAdapter ?? new fd();
		let t = Id(e), n = pd(this.getGTClassClean(), Ad);
		kd(e.lifecycle ?? {}, (...e) => this.subscribe(...e)), this.localesCache = new Ed({
			loadTranslations: t,
			createTranslateMany: n,
			lifecycle: Dd((...e) => this.emit(...e))
		});
	}
	...
	async getLookupTranslation(e = this.getLocale(), t = []) {
		try {
			...
			let r = Fd(t, n, (e) => this.resolveLocale(e));
...
function Nd({ defaultLocale: e, locales: t, customMapping: n }) {
	return {
		defaultLocale: e,
...
var Ld = void 0;
function Rd() {
	return Ld ||= (iu.warn("getI18nManager(): Translation failed because I18nManager not initialized."), new jd({
		defaultLocale: "en",
		locales: ["en"]
	})), Ld;
}
...
var Bd = "DEFAULT_TERMINATOR_KEY", Vd = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
	...
	CutoffFormat: class {
		constructor(e, t = {}) {
			...
			if (!Vd[t.style ?? "ellipsis"]) throw Error(((e) => `generaltranslation Formatting Error: Invalid cutoff style: ${e}.`)(t.style ?? "ellipsis"));
			let n, r;
			if (t.maxChars !== void 0) {
				n = t.style ?? "ellipsis";
				let e = new Intl.Locale(this.locale).language;
				r = Vd[n][e] || Vd[n].DEFAULT_TERMINATOR_KEY;
			}
			let i = t.terminator ?? r?.terminator, a = i == null ? void 0 : t.separator ?? r?.separator;
			this.additionLength = (i?.length ?? 0) + (a?.length ?? 0), t.maxChars !== void 0 && Math.abs(t.maxChars) < this.additionLength && (i = void 0, a = void 0), this.options = {
				maxChars: t.maxChars,
...
new class {
	...
	get(e, ...t) {
		let [n = "en", r = {}] = t, i = this._generateKey(n, r), a = this.cache[e]?.[i];
		return a === void 0 && (a = new Hd[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}();
function Ud(e, t, n = "") {
...
var Xd = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = Kd(this.buffer);
	}
	update(e) {
		Wd(this), Ud(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		Wd(this), function(e, t) {
			Ud(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, Gd(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = Kd(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), $d = /* @__PURE__ */ new Uint32Array(64), ef = class extends Xd {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		...
		for (let e = 16; e < 64; e++) {
			let t = $d[e - 15], n = $d[e - 2], r = qd(t, 7) ^ qd(t, 18) ^ t >>> 3, i = qd(n, 17) ^ qd(n, 19) ^ n >>> 10;
			$d[e] = i + $d[e - 7] + r + $d[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (qd(o, 6) ^ qd(o, 11) ^ qd(o, 25)) + Jd(o, s, c) + Qd[e] + $d[e] | 0, u = (qd(n, 2) ^ qd(n, 13) ^ qd(n, 22)) + Yd(n, r, i) | 0;
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), Gd(this.buffer);
	}
}, tf = class extends ef {
	A = 0 | Zd[0];
	B = 0 | Zd[1];
...
(function(e, t = {}) {
	let n = (t, n) => e(n).update(t).digest(), r = e(void 0);
	return n.outputLen = r.outputLen, n.blockLen = r.blockLen, n.canXOF = r.canXOF, n.create = (t) => e(t), Object.assign(n, t), Object.freeze(n);
})(() => new tf(), (nf = 1, { oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
var nf, rf = function(e, t) {
	return rf = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, rf(e, t);
...
function af(e, t) {
	...
	rf(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var B = function() {
...
var gf = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function _f(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || gf(t, e, n);
}
function vf(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function bf() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(yf(arguments[t]));
	return e;
}
function xf() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function wf(e, t, n) {
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof Cf ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function Ef(e) {
	...
	return n ? n.call(e) : (e = vf(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var Of = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return kf = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, kf(e);
...
function Af(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = kf(e), r = 0; r < n.length; r++) n[r] !== "default" && gf(t, e, n[r]);
	return Of(t, e), t;
}
function jf(e) {
	return e && e.__esModule ? e : { default: e };
...
var If = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function Lf(e) {
	function t(t) {
		e.error = e.hasError ? new If(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var V, H, zf, Bf = Object.freeze({
	__proto__: null,
	__addDisposableResource: Ff,
	get __assign() {
		return B;
	},
	__asyncDelegator: Tf,
...
var Vf = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, Hf = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Uf(e) {
	var t = {};
	return e.replace(Hf, function(e) {
		var n = e.length;
		switch (e[0]) {
			case "G":
				t.era = n === 4 ? "long" : n === 5 ? "narrow" : "short";
...
var Kf = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, qf = /^(@+)?(\+|#+)?[rs]?$/g, Jf = /(\*)(0+)|(#+)(0+)|(0+)/g, Yf = /^(0+)$/;
function Xf(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(qf, function(e, n, r) {
		return typeof r == "string" ? r === "+" ? t.minimumSignificantDigits = n.length : n[0] === "#" ? t.maximumSignificantDigits = n.length : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length + (typeof r == "string" ? r.length : 0)) : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length), "";
	}), t;
}
function Zf(e) {
...
function Qf(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !Yf.test(e)) throw Error("Malformed concise eng/scientific notation");
		t.minimumIntegerDigits = e.length;
	}
	return t;
}
...
function ep(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "measure-unit":
			case "unit":
				t.style = "unit", t.unit = Gf(i.options[0]);
				continue;
			case "compact-short":
			case "K":
				t.notation = "compact", t.compactDisplay = "short";
			...
			case "integer-width":
				if (i.options.length > 1) throw RangeError("integer-width stems only accept a single optional option");
				i.options[0].replace(Jf, function(e, n, r, i, a, o) {
					if (n) t.minimumIntegerDigits = r.length;
					else {
		...
		if (Yf.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
		else if (Kf.test(i.stem)) {
			if (i.options.length > 1) throw RangeError("Fraction-precision stems only accept a single optional option");
			i.stem.replace(Kf, function(e, n, r, i, a, o) {
				return r === "*" ? t.minimumFractionDigits = n.length : i && i[0] === "#" ? t.maximumFractionDigits = i.length : a && o ? (t.minimumFractionDigits = a.length, t.maximumFractionDigits = a.length + o.length) : (t.minimumFractionDigits = n.length, t.maximumFractionDigits = n.length), "";
			});
			var a = i.options[0];
			a === "w" ? t = B(B({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = B(B({}, t), Xf(a)));
		} else if (qf.test(i.stem)) t = B(B({}, t), Xf(i.stem));
		else {
			var o = Zf(i.stem);
			o && (t = B(B({}, t), o));
			var s = Qf(i.stem);
...
function np(e) {
	...
	var n, r = e.language;
	return r !== "root" && (n = e.maximize().region), (tp[n || ""] || tp[r || ""] || tp[`${r}-001`] || tp["001"])[0];
}
var rp = RegExp(`^${Vf.source}*`), ip = RegExp(`${Vf.source}*\$`);
function U(e, t) {
	return {
		start: e,
		end: t
...
var ap = !!String.prototype.startsWith && "_a".startsWith("a", 1), op = !!String.fromCodePoint, sp = !!Object.fromEntries, cp = !!String.prototype.codePointAt, lp = !!String.prototype.trimStart, up = !!String.prototype.trimEnd, dp = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, fp = !0;
try {
	fp = bp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	fp = !1;
}
var pp, mp = ap ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, hp = op ? String.fromCodePoint : function() {
	...
	return n;
}, gp = sp ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
if (fp) {
	var xp = bp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	pp = function(e, t) {
		return xp.lastIndex = t, xp.exec(e)[1] ?? "";
	};
} else pp = function(e, t) {
	for (var n = [];;) {
		var r = _p(e, t);
		if (r === void 0 || wp(r) || Tp(r)) break;
		n.push(r), t += r >= 65536 ? 2 : 1;
	}
	return hp.apply(void 0, n);
};
(function() {
	function e(e, t) {
		t === void 0 && (t = {}), this.message = e, this.position = {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			if (i === 123) {
				...
				if (i !== 35 || t !== "plural" && t !== "selectordinal") {
					...
					if (i === 60 && !this.ignoreTag && Sp(this.peek() || 0)) {
		...
		if (this.bumpIf(">")) {
			...
			var a = i.val, o = this.clonePosition();
			if (this.bumpIf("</")) {
				if (this.isEOF() || !Sp(this.char())) return this.error(V.INVALID_TAG, U(o, this.clonePosition()));
				var s = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					val: {
						type: H.tag,
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && Cp(this.char());) this.bump();
		return this.message.slice(e, this.offset());
	}, e.prototype.parseLiteral = function(e, t) {
		for (var n = this.clonePosition(), r = "";;) {
			var i = this.tryParseQuote(t);
		...
		return this.isEOF() || this.char() !== 60 || !this.ignoreTag && (Sp(e = this.peek() || 0) || e === 47) ? null : (this.bump(), "<");
		var e;
	}, e.prototype.tryParseQuote = function(e) {
		if (this.isEOF() || this.char() !== 39) return null;
		switch (this.peek()) {
		...
		return hp.apply(void 0, t);
	}, e.prototype.tryParseUnquoted = function(e, t) {
		if (this.isEOF()) return null;
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), hp(n));
	}, e.prototype.parseArgument = function(e, t) {
		var n = this.clonePosition();
		...
		var e = this.clonePosition(), t = this.offset(), n = pp(this.message, t), r = t + n.length;
		return this.bumpTo(r), {
			value: n,
		...
		switch (a) {
			...
			case "time":
				...
				if (this.bumpIf(",")) {
					...
					if ((f = yp(g.val)).length === 0) return this.error(V.EXPECT_ARGUMENT_STYLE, U(this.clonePosition(), this.clonePosition()));
					s = {
						style: f,
				...
				if (s && mp(s?.style, "::", 0)) {
					...
					this.locale && (d = function(e, t) {
						for (var n = "", r = 0; r < e.length; r++) {
							...
							if (i === "j") {
								for (var a = 0; r + 1 < e.length && e.charAt(r + 1) === i;) a++, r++;
								var o = 1 + (1 & a), s = a < 2 ? 1 : 3 + (a >> 1), c = np(t);
					...
					var f = {
						...
						pattern: d,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? Uf(d) : {}
					};
					return {
						val: {
		...
		try {
			n = function(e) {
				if (e.length === 0) throw Error("Number skeleton cannot be empty");
				for (var t = [], n = 0, r = e.split(Wf).filter(function(e) {
					return e.length > 0;
				}); n < r.length; n++) {
					var i = r[n].split("/");
		...
		return {
			val: {
				...
				tokens: n,
				location: t,
				parsedOptions: this.shouldParseSkeletons ? ep(n) : {}
			},
			err: null
		};
	}, e.prototype.tryParsePluralOrSelectOptions = function(e, t, n, r) {
		...
		if (mp(this.message, e, this.offset())) {
			for (var t = 0; t < e.length; t++) this.bump();
			return !0;
		}
		return !1;
		...
		for (; !this.isEOF() && wp(this.char());) this.bump();
	}, e.prototype.peek = function() {
		if (this.isEOF()) return null;
		var e = this.char(), t = this.offset();
		return this.message.charCodeAt(t + (e >= 65536 ? 2 : 1)) ?? null;
...
var Ep, W = {};
function Dp() {
	return Ep || (Ep = 1, Object.defineProperty(W, "__esModule", { value: !0 }), W.SKELETON_TYPE = W.TYPE = void 0, W.isLiteralElement = function(t) {
...
(function() {
	if (Op) return kp;
	Op = 1, Object.defineProperty(kp, "__esModule", { value: !0 }), kp.printAST = n, kp.doPrintAST = r, kp.printDateTimeSkeleton = o;
	var e = Ap, t = Dp();
	function n(e) {
		return r(e, !1);
	}
...
var jp = "_gt_";
RegExp(`^${jp}\\d+$`), RegExp(`^${jp}$`);
var Mp = "generaltranslation.locale";
e.use;
var Np = {
	af: ["af"],
	am: ["am"],
...
function Pp(e) {
	if (!tu(e)) return null;
	e = ru(e);
	let { languageCode: t, ...n } = Zu(e);
	if (Np[t]?.length) {
		let r = Np[t], i = ({ locale: e, languageCode: t, minimizedCode: n, regionCode: i, scriptCode: a }) => {
			let o = [
				e,
				`${t}-${i}`,
				`${t}-${a}`,
...
function Ip(e = {}, t) {
	return e.name ? e.name : `_gt_${Fp[t] || "value"}_${e["data-_gt"]?.id}`;
}
var Lp = "en", Rp = "DEFAULT_TERMINATOR_KEY", zp = {
	ellipsis: {
		fr: {
			terminator: "…",
			separator: " "
...
new class {
	...
	get(e, ...t) {
		let [n = "en", r = {}] = t, i = this._generateKey(n, r), a = this.cache[e]?.[i];
		return a === void 0 && (a = new Bp[e](...t), this.cache[e] || (this.cache[e] = {}), this.cache[e][i] = a), a;
	}
}();
var Vp = "https://cdn.gtx.dev", Hp = "https://runtime2.gtx.dev";
function Up(e) {
	if (e === void 0) return;
	if (e === null) return "null";
	if (typeof e == "number") return isFinite(e) ? "" + e : "null";
	...
	if (Array.isArray(e)) {
		let t = "[";
		for (let n = 0; n < e.length; n++) n && (t += ","), t += Up(e[n]) || "null";
		return t + "]";
	}
	let t = Object.keys(e).sort(), n = "";
	for (let r of t) {
...
var Zp = typeof Uint8Array.from([]).toHex == "function" && typeof Uint8Array.fromHex == "function", Qp = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function $p(e, t = {}) {
	let n = (t, n) => e(n).update(t).digest(), r = e(void 0);
	return n.outputLen = r.outputLen, n.blockLen = r.blockLen, n.canXOF = r.canXOF, n.create = (t) => e(t), Object.assign(n, t), Object.freeze(n);
}
var em = (e) => ({ oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
var rm = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = Yp(this.buffer);
	}
	update(e) {
		qp(this), Kp(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		qp(this), function(e, t) {
			Kp(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, Jp(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = Yp(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), om = /* @__PURE__ */ new Uint32Array(64), sm = class extends rm {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) om[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = om[e - 15], n = om[e - 2], r = Xp(t, 7) ^ Xp(t, 18) ^ t >>> 3, i = Xp(n, 17) ^ Xp(n, 19) ^ n >>> 10;
			om[e] = i + om[e - 7] + r + om[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (Xp(o, 6) ^ Xp(o, 11) ^ Xp(o, 25)) + tm(o, s, c) + am[e] + om[e] | 0, u = (Xp(n, 2) ^ Xp(n, 13) ^ Xp(n, 22)) + nm(n, r, i) | 0;
			l = c, c = s, s = o, o = a + t | 0, a = i, i = r, r = n, n = t + u | 0;
		}
		n = n + this.A | 0, r = r + this.B | 0, i = i + this.C | 0, a = a + this.D | 0, o = o + this.E | 0, s = s + this.F | 0, c = c + this.G | 0, l = l + this.H | 0, this.set(n, r, i, a, o, s, c, l);
	}
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), Jp(this.buffer);
	}
}, cm = class extends sm {
	A = 0 | im[0];
	B = 0 | im[1];
...
}, lm = $p(() => new cm(), em(1)), um = function(e, t) {
	return um = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, um(e, t);
...
function dm(e, t) {
	...
	um(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var G = function() {
...
var Sm = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function Cm(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || Sm(t, e, n);
}
function wm(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function Em() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(Tm(arguments[t]));
	return e;
}
function Dm() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function km(e) {
	return this instanceof km ? (this.v = e, this) : new km(e);
}
function Am(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var r, i = n.apply(e, t || []), a = [];
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof km ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function Mm(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = wm(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var Pm = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return Fm = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, Fm(e);
...
function Im(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = Fm(e), r = 0; r < n.length; r++) n[r] !== "default" && Sm(t, e, n[r]);
	return Pm(t, e), t;
}
function Lm(e) {
	return e && e.__esModule ? e : { default: e };
...
var Hm = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function Um(e) {
	function t(t) {
		e.error = e.hasError ? new Hm(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var qm = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, Jm = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Ym(e) {
	var t = {};
	return e.replace(Jm, function(e) {
		var n = e.length;
		switch (e[0]) {
			case "G":
				t.era = n === 4 ? "long" : n === 5 ? "narrow" : "short";
...
var Qm = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, $m = /^(@+)?(\+|#+)?[rs]?$/g, eh = /(\*)(0+)|(#+)(0+)|(0+)/g, th = /^(0+)$/;
function nh(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace($m, function(e, n, r) {
		return typeof r == "string" ? r === "+" ? t.minimumSignificantDigits = n.length : n[0] === "#" ? t.maximumSignificantDigits = n.length : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length + (typeof r == "string" ? r.length : 0)) : (t.minimumSignificantDigits = n.length, t.maximumSignificantDigits = n.length), "";
	}), t;
}
function rh(e) {
...
function ih(e) {
	...
	if (e[0] === "E" && e[1] === "E" ? (t = { notation: "engineering" }, e = e.slice(2)) : e[0] === "E" && (t = { notation: "scientific" }, e = e.slice(1)), t) {
		var n = e.slice(0, 2);
		if (n === "+!" ? (t.signDisplay = "always", e = e.slice(2)) : n === "+?" && (t.signDisplay = "exceptZero", e = e.slice(2)), !th.test(e)) throw Error("Malformed concise eng/scientific notation");
		t.minimumIntegerDigits = e.length;
	}
	return t;
}
...
function oh(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "measure-unit":
			case "unit":
				t.style = "unit", t.unit = Zm(i.options[0]);
				continue;
			case "compact-short":
			case "K":
				t.notation = "compact", t.compactDisplay = "short";
			...
			case "integer-width":
				if (i.options.length > 1) throw RangeError("integer-width stems only accept a single optional option");
				i.options[0].replace(eh, function(e, n, r, i, a, o) {
					if (n) t.minimumIntegerDigits = r.length;
					else {
						if (i && a) throw Error("We currently do not support maximum integer digits");
						if (o) throw Error("We currently do not support exact integer digits");
		...
		if (th.test(i.stem)) t.minimumIntegerDigits = i.stem.length;
		else if (Qm.test(i.stem)) {
			if (i.options.length > 1) throw RangeError("Fraction-precision stems only accept a single optional option");
			i.stem.replace(Qm, function(e, n, r, i, a, o) {
				return r === "*" ? t.minimumFractionDigits = n.length : i && i[0] === "#" ? t.maximumFractionDigits = i.length : a && o ? (t.minimumFractionDigits = a.length, t.maximumFractionDigits = a.length + o.length) : (t.minimumFractionDigits = n.length, t.maximumFractionDigits = n.length), "";
			});
			var a = i.options[0];
			a === "w" ? t = G(G({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = G(G({}, t), nh(a)));
		} else if ($m.test(i.stem)) t = G(G({}, t), nh(i.stem));
		else {
			var o = rh(i.stem);
			o && (t = G(G({}, t), o));
			var s = ih(i.stem);
...
function ch(e) {
	...
	var n, r = e.language;
	return r !== "root" && (n = e.maximize().region), (sh[n || ""] || sh[r || ""] || sh[`${r}-001`] || sh["001"])[0];
}
var lh = RegExp(`^${qm.source}*`), uh = RegExp(`${qm.source}*\$`);
function J(e, t) {
	return {
		start: e,
		end: t
...
var dh = !!String.prototype.startsWith && "_a".startsWith("a", 1), fh = !!String.fromCodePoint, ph = !!Object.fromEntries, mh = !!String.prototype.codePointAt, hh = !!String.prototype.trimStart, gh = !!String.prototype.trimEnd, _h = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, vh = !0;
try {
	vh = Eh("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	vh = !1;
}
var yh, bh = dh ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, xh = fh ? String.fromCodePoint : function() {
	for (var e = [...arguments], t, n = "", r = e.length, i = 0; r > i;) {
		if ((t = e[i++]) > 1114111) throw RangeError(t + " is not a valid code point");
		n += t < 65536 ? String.fromCharCode(t) : String.fromCharCode(55296 + ((t -= 65536) >> 10), t % 1024 + 56320);
	}
	return n;
}, Sh = ph ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
if (vh) {
	var Dh = Eh("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	yh = function(e, t) {
		return Dh.lastIndex = t, Dh.exec(e)[1] ?? "";
	};
} else yh = function(e, t) {
	for (var n = [];;) {
		var r = Ch(e, t);
		if (r === void 0 || jh(r) || Mh(r)) break;
		n.push(r), t += r >= 65536 ? 2 : 1;
	}
	return xh.apply(void 0, n);
};
var Oh = function() {
	function e(e, t) {
		t === void 0 && (t = {}), this.message = e, this.position = {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			if (i === 123) {
				...
				if (i !== 35 || t !== "plural" && t !== "selectordinal") {
					...
					if (i === 60 && !this.ignoreTag && kh(this.peek() || 0)) {
						if ((a = this.parseTag(e, t)).err) return a;
						r.push(a.val);
					} else {
						var a;
		...
		if (this.bumpIf(">")) {
			...
			var a = i.val, o = this.clonePosition();
			if (this.bumpIf("</")) {
				if (this.isEOF() || !kh(this.char())) return this.error(K.INVALID_TAG, J(o, this.clonePosition()));
				var s = this.clonePosition();
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					val: {
						type: q.tag,
		...
		var e = this.offset();
		for (this.bump(); !this.isEOF() && Ah(this.char());) this.bump();
		return this.message.slice(e, this.offset());
	}, e.prototype.parseLiteral = function(e, t) {
		for (var n = this.clonePosition(), r = "";;) {
			var i = this.tryParseQuote(t);
		...
		return this.isEOF() || this.char() !== 60 || !this.ignoreTag && (kh(e = this.peek() || 0) || e === 47) ? null : (this.bump(), "<");
		var e;
	}, e.prototype.tryParseQuote = function(e) {
		if (this.isEOF() || this.char() !== 39) return null;
		switch (this.peek()) {
		...
		return xh.apply(void 0, t);
	}, e.prototype.tryParseUnquoted = function(e, t) {
		if (this.isEOF()) return null;
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), xh(n));
	}, e.prototype.parseArgument = function(e, t) {
		var n = this.clonePosition();
		...
		var e = this.clonePosition(), t = this.offset(), n = yh(this.message, t), r = t + n.length;
		return this.bumpTo(r), {
			value: n,
		...
		switch (a) {
			...
			case "time":
				...
				if (this.bumpIf(",")) {
					...
					var c = this.clonePosition();
					if ((g = this.parseSimpleArgStyleIfPossible()).err) return g;
					if ((f = Th(g.val)).length === 0) return this.error(K.EXPECT_ARGUMENT_STYLE, J(this.clonePosition(), this.clonePosition()));
					s = {
						style: f,
				...
				if (s && bh(s?.style, "::", 0)) {
					...
					this.locale && (d = function(e, t) {
						for (var n = "", r = 0; r < e.length; r++) {
							...
							if (i === "j") {
								for (var a = 0; r + 1 < e.length && e.charAt(r + 1) === i;) a++, r++;
								var o = 1 + (1 & a), s = a < 2 ? 1 : 3 + (a >> 1), c = ch(t);
								for (c != "H" && c != "k" || (s = 0); s-- > 0;) n += "a";
								for (; o-- > 0;) n = c + n;
							} else n += i === "J" ? "H" : i;
						}
					...
					var f = {
						...
						pattern: d,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? Ym(d) : {}
					};
					return {
						val: {
		...
		try {
			n = function(e) {
				if (e.length === 0) throw Error("Number skeleton cannot be empty");
				for (var t = [], n = 0, r = e.split(Xm).filter(function(e) {
					return e.length > 0;
				}); n < r.length; n++) {
					var i = r[n].split("/");
					if (i.length === 0) throw Error("Invalid number skeleton");
		...
		return {
			val: {
				...
				tokens: n,
				location: t,
				parsedOptions: this.shouldParseSkeletons ? oh(n) : {}
			},
			err: null
		};
	}, e.prototype.tryParsePluralOrSelectOptions = function(e, t, n, r) {
		...
		if (bh(this.message, e, this.offset())) {
			for (var t = 0; t < e.length; t++) this.bump();
			return !0;
		}
		return !1;
		...
		for (; !this.isEOF() && jh(this.char());) this.bump();
	}, e.prototype.peek = function() {
		if (this.isEOF()) return null;
		var e = this.char(), t = this.offset();
		return this.message.charCodeAt(t + (e >= 65536 ? 2 : 1)) ?? null;
...
function Nh(e) {
	e.forEach(function(e) {
		...
		}(e)) for (var t in e.options) delete e.options[t].location, Nh(e.options[t].value);
		else (function(e) {
			return e.type === q.number;
		})(e) && function(e) {
			return !(!e || typeof e != "object" || e.type !== Gm.number);
		}(e.style) ? delete e.style.location : !function(e) {
			return e.type === q.date;
		}(e) && !function(e) {
			return e.type === q.time;
		}(e) || !function(e) {
			return !(!e || typeof e != "object" || e.type !== Gm.dateTime);
		}(e.style) ? function(e) {
			return e.type === q.tag;
		}(e) && Nh(e.children) : delete e.style.location;
	});
}
function Ph(e) {
	if (Object.prototype.hasOwnProperty.call(e, "__esModule")) return e;
...
function Ih() {
	if (Fh) return Y;
	var e, t;
	return Fh = 1, Object.defineProperty(Y, "__esModule", { value: !0 }), Y.SKELETON_TYPE = Y.TYPE = void 0, Y.isLiteralElement = function(t) {
		return t.type === e.literal;
...
var Lh, Rh = Ih(), zh = {}, Bh = Ph(Km), Vh = function() {
	if (Lh) return zh;
	Lh = 1, Object.defineProperty(zh, "__esModule", { value: !0 }), zh.printAST = n, zh.doPrintAST = r, zh.printDateTimeSkeleton = o;
	var e = Bh, t = Ih();
	function n(e) {
		return r(e, !1);
	}
...
function Wh({ icuString: e, shouldVisit: t, visitor: n, options: { recurseIntoVisited: r = !0, ...i } }) {
	let a = function(e, t) {
		t === void 0 && (t = {}), t = G({
			shouldParseSkeletons: !0,
			requiresOtherClause: !0
		}, t);
		var n = new Oh(e, t).parse();
		if (n.err) {
			var r = SyntaxError(K[n.err.kind]);
			throw r.location = n.err.location, r.originalMessage = n.err.message, r;
		}
		return t != null && t.captureLocation || Nh(n.val), n.val;
	}(e, i);
	return o(a), a;
	function o(e) {
		e.map(s);
...
var Gh = "_gt_", Kh = RegExp(`^${Gh}\\d+$`), qh = RegExp(`^${Gh}$`);
function Jh(e) {
	return e.type === Rh.TYPE.select && Kh.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === Rh.TYPE.literal);
}
function Yh(e) {
	return e.type === Rh.TYPE.select && qh.test(e.value) && !!e.options.other && (e.options.other.value.length === 0 || e.options.other.value.length > 0 && e.options.other.value[0]?.type === Rh.TYPE.literal);
}
function Xh(e) {
	if (!e.includes("_gt_")) return e;
	let t = [];
...
function Qh(e) {
	return e.includes("_gt_") ? Vh.printAST(Wh({
		icuString: e,
		shouldVisit: Jh,
		visitor: function(e) {
			e.type = Rh.TYPE.argument, delete e.options;
		},
		options: { recurseIntoVisited: !1 }
	})) : e;
}
...
var Z = "@generaltranslation/react-core", eg = `${Z} Error: Production environments cannot include an api key.`, tg = `${Z} Error: Fetching batched translations failed`, ng = (e, t) => e ? `${Z} Error: Translation failed for id: ${e}, hash: ${t} ` : `${Z} Error: Translation failed for hash: ${t}`, rg = (e, t) => `${Z} Error: error rendering string ${t ? `for id: "${t}"` : ""} original message: "${e}"`, ig = (e, t, n = "tx") => `${Z} Error: string translation error. ${n}("${e}")${t ? ` with id "${t}"` : ""} could not locate translation.`, ag = (e) => `${Z} Error: Dictionary subtree not found for id: "${e}"`, og = (e) => `${Z} Error: Invalid ICU string dictionary entry found for id: "${e}"`, sg = `${Z} Warning: Translation cloud services require a project ID! Find yours at generaltranslation.com/dashboard.`, cg = (e) => `${Z} Warning: No valid dictionary entry found for id: "${e}"`, lg = `${Z} Warning: A development API key is required for runtime translation!  Find your development API key: generaltranslation.com/dashboard.  (Or, disable this warning message by setting runtimeUrl to an empty string which disables runtime translation.)`, ug = `${Z} Warning: Runtime translation timed out.`, dg = `${Z} Warning: No dictionary was found. Ensure you are either passing your dictionary to the <GTProvider>.`;
function fg(e) {
...
var mg = {
	...
	let { props: t } = e, n = { t: hg(e) };
	if (t["data-_gt"]) {
		let e = t["data-_gt"], r = e.transformation;
		if (r === "variable") {
			let n = e.variableType || "variable", r = Ip(t, n), i = Uh(n);
			return {
				i: e.id,
				k: r,
				v: i
		...
		n.i = e.id, n.d = ((e, t, n) => {
			let r = Object.entries(mg).reduce((e, [n, r]) => (t[r] && (e[n] = t[r]), e), {});
			if (e === "plural" && n) {
				let e = {};
		...
		let i = Object.entries(mg).reduce((e, [n, r]) => (t[r] && (e[n] = t[r]), e), {});
	...
	return t.children && (n.c = vg(t.children)), n;
}, _g = (e) => {
	return n = e, t.isValidElement(n) ? gg(e) : typeof e == "number" ? e.toString() : e;
	var n;
};
function vg(e) {
	return Array.isArray(e) ? e.map(_g) : _g(e);
}
function yg(e) {
...
var wg = (e) => typeof e == "string" || Array.isArray(e), Tg = (e) => typeof e == "object" && !!e && !Array.isArray(e);
function Eg(e, t) {
	if (Array.isArray(e)) return e.map((e, n) => Cg(e) ? t[n] : Eg(e, t[n]));
	let n = {
		...Object.fromEntries(Object.entries(e).filter(([, e]) => wg(e))),
		...Object.fromEntries(Object.entries(t).filter(([, e]) => wg(e)))
	}, r = Object.entries(e).filter(([, e]) => Tg(e)).map(([e]) => e), i = Object.entries(t).filter(([, e]) => Tg(e)).map(([e]) => e), a = /* @__PURE__ */ new Set([...r, ...i]);
	for (let r of a) n[r] = Eg(X(e, r) || {}, X(t, r) || {});
	return n;
}
function Dg({ dictionary: e, id: t }) {
	if (t === "") return e;
	let n = e, r = t.split(".");
...
function kg(e, t, n, r) {
	...
	for (let e of i.slice(0, -1)) X(t, e) ?? $h(t, e, Array.isArray(X(r, e)) ? [] : {}), t = X(t, e), r = X(r, e);
	$h(t, i[i.length - 1], e);
}
function Ag(e) {
	let t = {};
...
function jg(e) {
	return function(e) {
		if (Kp(e), Zp) return e.toHex();
		let t = "";
		for (let n = 0; n < e.length; n++) t += Qp[e[n]];
		return t;
	}(lm(function(e) {
		if (typeof e != "string") throw TypeError("string expected");
		return new Uint8Array(new TextEncoder().encode(e));
...
function Mg({ source: e, context: t, id: n, maxChars: r, dataFormat: i }, a = jg) {
	let o;
	return o = i === "JSX" ? Pg(e) : e, a(Wp({
		source: o,
		...n && { id: n },
		...t && { context: t },
		...r != null && { maxChars: Math.abs(r) },
...
var Ng = (e) => {
	if (e && typeof e == "object") {
		let t = {};
		if ("c" in e && e.c && (t.c = Pg(e.c)), "d" in e) {
			let n = e?.d;
			n?.b && (t.b = Object.fromEntries(Object.entries(n.b).map(([e, t]) => [e, Pg(t)]))), n?.t && (t.t = n.t);
		}
		return Gp(e) ? {
			k: e.k,
			...e.v && { v: e.v }
...
function Pg(e) {
	return Array.isArray(e) ? e.map(Ng) : Ng(e);
}
function Fg(e, t = "") {
	let n = !1;
	return Object.entries(e).forEach(([r, i]) => {
		let a = t ? `${t}.${r}` : r;
		if (Cg(i)) {
			let { entry: t, metadata: o } = xg(i);
			o?.$_hash || (o ||= {}, o.$_hash = Mg({
				source: Xh(t),
...
function Ig(e, t, n) {
	...
	if (!r) throw Error(ag(n));
	if (Cg(r)) throw Error(`${Z} Error: Cannot inject and merge a dictionary entry`);
...
function Lg(e, t, n = "") {
	...
	return Object.entries(e).forEach(([e, i]) => {
		...
		} else r.push(...Lg(i, X(t, e) || (Array.isArray(i) ? [] : {}), a));
	}), r;
}
function Rg(e) {
...
function Vg({ gt: e, locale: t, versionId: n, defaultLocale: r, runtimeUrl: i, renderSettings: a, setTranslations: o, environment: s, ...c }) {
	...
	let S = p(0), C = p(/* @__PURE__ */ new Map()), ee = p(/* @__PURE__ */ new Map()), te = l(async (e) => {
		...
		try {
			...
			e?.name === "AbortError" ? console.warn(ug) : console.warn(tg, e), a.forEach((e) => {
...
function Hg({ gt: e, translations: t, locale: n, defaultLocale: r, translationRequired: i, developmentApiEnabled: a, registerIcuForTranslation: o, environment: s }) {
	function c({ message: t, variables: n, locales: r, fallback: i, id: a, maxChars: o, format: l }) {
		try {
			let a = Zh(i || ""), s = e.formatMessage(Object.keys(a).length ? Qh(t) : t, {
				locales: r,
				variables: {
					...n,
					...a,
			...
			if (s === "production") console.warn(((e, t) => `${Z} Warning: failed to render string ${t ? `for id: "${t}"` : ""} original message: "${e}"`)(t, a), "Error: ", l);
				...
				if (!i) throw Error(`${rg(t, a)} Error: ${l}`);
				console.error(rg(t, a), "Error: ", l);
			}
			return i ? c({
				message: i,
				locales: r,
	...
	let d = (e, t = {}, s) => {
		...
		}), g(e, [r])) : (console.warn(ig(e, d, "gt")), g(e, [r])) : s?.[v] ? g(s?.[v], [n, r], e) : g(e, [r]);
	};
	return {
		_gtFunction: d,
		_mFunction: (e, s = {}, l) => {
			...
			}), b(p, [r])) : l?.[f] ? b(l?.[f], [n, r], p) : b(p, [r]) : (console.warn(ig(p, zg(e), "m")), b(p, [r]));
		},
...
function Ug(e, t, n, r, i, a, o, s, c, u, d) {
	return l((s, l = {}) => {
		if (!t) return "";
		let f = bg(t, s);
		if (!f) return console.warn(cg(s)), "";
		if (!yg(f)) return console.warn(((e) => `${Z} Warning: Invalid dictionary entry found for id: "${e}"`)(s)), "";
		let { entry: p, metadata: m } = xg(f);
		if (!p || typeof p != "string") return "";
		let { $format: h, ...g } = l, _ = (t, n, r) => {
			try {
				let i = Zh(r || ""), a = e.formatMessage(Object.keys(i).length ? Qh(t) : t, {
					locales: n,
					variables: {
						...g,
						...i,
				...
				if (d === "production") console.warn(((e) => `${Z} Warning: Invalid ICU string dictionary entry found for id: "${e}"`)(s), "Error: ", i);
					...
					if (!r) throw Error(`${og(s)} Error: ${i}`);
					console.error(og(s), "Error: ", i);
				}
...
function Wg({ _locale: e, defaultLocale: t, locales: n, ssr: r, localeCookieName: i, customMapping: a, useDetermineLocale: o, enableI18n: s, reloadOnLocaleUpdate: c }) {
...
function Gg({ devApiKey: e, projectId: t, runtimeUrl: n, loadTranslationsType: r, cacheUrl: i, locales: a, environment: o }) {
	d(() => {
		if (o === "production" && e) throw Error(eg);
		if (r === "custom" || !i && !n || t || o !== "development" || console.warn(sg), t && n && r !== "custom" && !e && o === "development" && console.warn(lg), n === Hp || i === Vp && r === "default") {
			let e = a.filter((e) => !Pp(e));
...
async function Kg(e, t) {
	let n = Array.from(/* @__PURE__ */ new Set([e, Zu(e).languageCode]));
	for (let e of n) try {
		let n = await t(e);
		if (n) return n;
	} catch {}
...
function qg({ _translations: e, translationRequired: t, loadTranslationsType: n, loadTranslations: r, locale: i, cacheUrl: a, projectId: o, _versionId: s, gt: c }) {
...
function Jg(e, t, n, r, i, a, o, s, c, u, d, f) {
	return l((o, c, l = {}) => {
		...
		if (!p) return console.warn(cg(c)), {};
		if (Cg(p)) return f(o, l);
		if (!s) return Ag(p);
		let m = function({ dictionary: e, id: t, sourceDictionary: n }) {
			if (t === "") return e;
			let r = e, i = n, a = t.split(".");
			for (let e of a) X(r, e) === void 0 && (Array.isArray(X(i, e)) ? $h(r, e, []) : $h(r, e, {})), r = X(r, e);
			return r;
		}({
			dictionary: t,
			id: c,
			sourceDictionary: t
		}), { dictionary: h, updateDictionary: g } = Fg(structuredClone(p), c), _ = Lg(h, m, c), { dictionary: v, updateDictionary: y } = function(e, t, n, r, i = "") {
			let a = !1, o = i ? i.split(".") : [];
			return r.forEach(({ metadata: r }) => {
				let { $_hash: i, $id: s } = r, c = o.length > 0 ? s.split(".").slice(o.length).join(".") : s, l = bg(t, c), u;
				Cg(l) && (u = xg(l).entry);
				let d = n[i] || u;
				d && (kg(d, t, c, e), a = !0);
			}), {
			...
			return n.forEach(({ source: n, metadata: r }) => {
				let { $id: a } = r, o = i.length > 0 ? a.split(".").slice(i.length).join(".") : a, s = bg(t, o), c;
				Cg(s) && (c = xg(s).entry), kg(c || n, t, o, e);
			}), t;
...
function Yg({ enableI18n: e }) {
	let [t] = m(e);
	return { enableI18n: t };
}
function Xg() {
	throw fg("isSSREnabled");
}
function Zg({}) {
	throw fg("useDetermineLocale");
}
function Qg({}) {
	throw fg("useRegionState");
}
function $g({ children: e, config: t, environment: n = "production", projectId: r = t?.projectId || "", devApiKey: a = t?.devApiKey || "", _versionId: o = t?._versionId, dictionary: s = t?.dictionary || {}, locales: c = t?.locales || [], defaultLocale: l = t?.defaultLocale || Lp, cacheUrl: u = t?.cacheUrl || Vp, runtimeUrl: p = t?.runtimeUrl || Hp, renderSettings: h = t?.renderSettings || Sg(n), ssr: _ = t?.ssr || Xg(), localeCookieName: v = t?.localeCookieName || "generaltranslation.locale", locale: y = "", region: b, loadDictionary: x, loadTranslations: S, fallback: C, translations: ee = null, customMapping: te = t?.customMapping, enableI18n: w = t?.enableI18n === void 0 || t.enableI18n, enableI18nLoaded: T, reloadOnLocaleUpdate: ne, useEnableI18n: re = Yg, readAuthFromEnv: ie = pg, useDetermineLocale: ae = Zg, useRegionState: oe = Qg, ...se }) {
	y &&= ed(y, te);
	let { projectId: E, devApiKey: ce } = ie({
		...
		ssr: _
	}), { locale: le, setLocale: ue, locales: de, translationRequired: fe, dialectTranslationRequired: pe } = Wg({
		_locale: y,
		defaultLocale: l,
		locales: c,
		ssr: _,
		...
		return d(() => {
			...
			let e = !0;
			return (async () => {
				let t = await Kg(i, n) || {}, a = await Kg(r, n) || {};
				e && o(t || {}), e && c(a || {});
			})(), () => {
				e = !1;
			};
	...
	let { translations: Se, setTranslations: Ce } = qg({
		_translations: ee,
		...
		_versionId: o,
		gt: ge
	}), { registerIcuForTranslation: we, registerJsxForTranslation: Te, developmentApiEnabled: Ee } = Vg({
		gt: ge,
		locale: le,
		versionId: o,
		defaultLocale: l,
		...
		environment: n,
		...se
	}), { _gtFunction: De, _mFunction: Oe, _filterMessagesForPreload: ke, _preloadMessages: Ae } = Hg({
		gt: ge,
		translations: Se,
		locale: le,
		defaultLocale: l,
		...
		environment: n
	}), je = Ug(ge, ve, be, Se, le, l, fe, pe, Ee, we, n), Me = Jg(ve || {}, be || {}, ye, xe, Se, le, l, fe, pe, Ee, we, je), Ne = !(fe && !Se || !le);
	return g(Bg.Provider, {
		value: {
			gt: ge,
			registerIcuForTranslation: we,
...
function e_({ projectId: e, devApiKey: t }) {
	try {
		return {
			projectId: e || "",
			devApiKey: t || void 0
...
function t_({ _region: e, regionCookieName: t }) {
...
function n_({ _region: e, ssr: t, regionCookieName: n }) {
	let [r, i] = m(t ? void 0 : t_({
		_region: e,
		regionCookieName: n
	}));
	return d(() => {
...
function r_({ enableI18n: e, enableI18nCookieName: t, enableI18nLoaded: n, ssr: r }) {
...
var a_ = function(e, t) {
	return a_ = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, a_(e, t);
...
function o_(e, t) {
	...
	a_(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var s_ = function() {
	return s_ = Object.assign || function(e) {
		for (var t, n = 1, r = arguments.length; n < r; n++) for (var i in t = arguments[n]) Object.prototype.hasOwnProperty.call(t, i) && (e[i] = t[i]);
		return e;
...
var v_ = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function S_() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(x_(arguments[t]));
	return e;
}
function C_() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function T_(e) {
	return this instanceof T_ ? (this.v = e, this) : new T_(e);
}
function E_(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var r, i = n.apply(e, t || []), a = [];
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof T_ ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function O_(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = b_(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var A_ = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return j_ = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, j_(e);
...
function M_(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = j_(e), r = 0; r < n.length; r++) n[r] !== "default" && v_(t, e, n[r]);
	return A_(t, e), t;
}
function N_(e) {
	return e && e.__esModule ? e : { default: e };
...
var R_ = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function z_(e) {
	function t(t) {
		e.error = e.hasError ? new R_(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var V_, H_, U_, W_, G_ = Object.freeze({
	__proto__: null,
	__addDisposableResource: L_,
	get __assign() {
		return s_;
	},
	__asyncDelegator: D_,
	...
	__await: T_,
	__awaiter: g_,
	__classPrivateFieldGet: P_,
	__classPrivateFieldIn: I_,
	...
	__read: x_,
	__rest: c_,
	__rewriteRelativeImportExtension: B_,
	__runInitializers: f_,
	__setFunctionName: m_,
	__spread: S_,
	__spreadArray: w_,
	__spreadArrays: C_,
	__values: b_,
...
try {
	(W_ = (/* @__PURE__ */ RegExp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu")).exec("a")) == null || W_[0];
} catch {}
function K_(e) {
	if (Object.prototype.hasOwnProperty.call(e, "__esModule")) return e;
	var t = e.default;
...
function J_() {
	if (q_) return Q;
	var e, t;
	return q_ = 1, Object.defineProperty(Q, "__esModule", { value: !0 }), Q.SKELETON_TYPE = Q.TYPE = void 0, Q.isLiteralElement = function(t) {
		return t.type === e.literal;
...
(function() {
	if (Y_) return X_;
	Y_ = 1, Object.defineProperty(X_, "__esModule", { value: !0 }), X_.printAST = n, X_.doPrintAST = r, X_.printDateTimeSkeleton = o;
	var e = Z_, t = J_();
	function n(e) {
		return r(e, !1);
	}
...
var av = class {
	...
	destroyed = !1;
	constructor(e, t, n, r) {
		this.blockLen = e, this.outputLen = t, this.padOffset = n, this.isLE = r, this.buffer = new Uint8Array(e), this.view = tv(this.buffer);
	}
	update(e) {
		$_(this), Q_(e);
		let { view: t, buffer: n, blockLen: r } = this, i = e.length;
	...
	digestInto(e) {
		$_(this), function(e, t) {
			Q_(e, void 0, "digestInto() output");
			let n = t.outputLen;
			if (e.length < n) throw RangeError("\"digestInto() output\" expected to be of length >=" + n);
		}(e, this), this.finished = !0;
		let { buffer: t, view: n, blockLen: r, isLE: i } = this, { pos: a } = this;
		t[a++] = 128, ev(this.buffer.subarray(a)), this.padOffset > r - a && (this.process(n, 0), a = 0);
		for (let e = a; e < r; e++) t[e] = 0;
		n.setBigUint64(r - 8, BigInt(8 * this.length), i), this.process(n, 0);
		let o = tv(e), s = this.outputLen;
		if (s % 4) throw Error("_sha2: outputLen must be aligned to 32bit");
		let c = s / 4, l = this.get();
		if (c > l.length) throw Error("_sha2: outputLen bigger than state");
		for (let e = 0; e < c; e++) o.setUint32(4 * e, l[e], i);
	...
	3204031479,
	3329325298
]), cv = /* @__PURE__ */ new Uint32Array(64), lv = class extends av {
	constructor(e) {
		super(64, e, 8, !1);
	}
	get() {
	...
	process(e, t) {
		for (let n = 0; n < 16; n++, t += 4) cv[n] = e.getUint32(t, !1);
		for (let e = 16; e < 64; e++) {
			let t = cv[e - 15], n = cv[e - 2], r = nv(t, 7) ^ nv(t, 18) ^ t >>> 3, i = nv(n, 17) ^ nv(n, 19) ^ n >>> 10;
			cv[e] = i + cv[e - 7] + r + cv[e - 16] | 0;
		}
		let { A: n, B: r, C: i, D: a, E: o, F: s, G: c, H: l } = this;
		for (let e = 0; e < 64; e++) {
			let t = l + (nv(o, 6) ^ nv(o, 11) ^ nv(o, 25)) + rv(o, s, c) + sv[e] + cv[e] | 0, u = (nv(n, 2) ^ nv(n, 13) ^ nv(n, 22)) + iv(n, r, i) | 0;
			l = c, c = s, s = o, o = a + t | 0, a = i, i = r, r = n, n = t + u | 0;
		}
		n = n + this.A | 0, r = r + this.B | 0, i = i + this.C | 0, a = a + this.D | 0, o = o + this.E | 0, s = s + this.F | 0, c = c + this.G | 0, l = l + this.H | 0, this.set(n, r, i, a, o, s, c, l);
	}
	...
	destroy() {
		this.destroyed = !0, this.set(0, 0, 0, 0, 0, 0, 0, 0), ev(this.buffer);
	}
}, uv = class extends lv {
	A = 0 | ov[0];
	B = 0 | ov[1];
...
})(() => new uv(), (dv = 1, { oid: Uint8Array.from([
	6,
	9,
	96,
	134,
...
var fv = function(e, t) {
	return fv = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
		for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
	}, fv(e, t);
...
function pv(e, t) {
	...
	fv(e, t), e.prototype = t === null ? Object.create(t) : (n.prototype = t.prototype, new n());
}
var mv = function() {
...
var Tv = Object.create ? function(e, t, n, r) {
	r === void 0 && (r = n);
	var i = Object.getOwnPropertyDescriptor(t, n);
	i && !("get" in i ? !t.__esModule : i.writable || i.configurable) || (i = {
		enumerable: !0,
...
function Ev(e, t) {
	for (var n in e) n === "default" || Object.prototype.hasOwnProperty.call(t, n) || Tv(t, e, n);
}
function Dv(e) {
	var t = typeof Symbol == "function" && Symbol.iterator, n = t && e[t], r = 0;
	if (n) return n.call(e);
...
function kv() {
	for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(Ov(arguments[t]));
	return e;
}
function Av() {
	for (var e = 0, t = 0, n = arguments.length; t < n; t++) e += arguments[t].length;
...
function Mv(e) {
	return this instanceof Mv ? (this.v = e, this) : new Mv(e);
}
function Nv(e, t, n) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var r, i = n.apply(e, t || []), a = [];
	...
	function s(e, t) {
		try {
			(n = i[e](t)).value instanceof Mv ? Promise.resolve(n.value.v).then(c, l) : u(a[0][2], n);
		} catch (e) {
			u(a[0][3], e);
		}
		var n;
...
function Fv(e) {
	if (!Symbol.asyncIterator) throw TypeError("Symbol.asyncIterator is not defined.");
	var t, n = e[Symbol.asyncIterator];
	return n ? n.call(e) : (e = Dv(e), t = {}, r("next"), r("throw"), r("return"), t[Symbol.asyncIterator] = function() {
		return this;
	}, t);
	function r(n) {
		t[n] = e[n] && function(t) {
...
var Lv = Object.create ? function(e, t) {
	Object.defineProperty(e, "default", {
		enumerable: !0,
		value: t
	});
	...
	return Rv = Object.getOwnPropertyNames || function(e) {
		var t = [];
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[t.length] = n);
		return t;
	}, Rv(e);
...
function zv(e) {
	if (e && e.__esModule) return e;
	var t = {};
	if (e != null) for (var n = Rv(e), r = 0; r < n.length; r++) n[r] !== "default" && Tv(t, e, n[r]);
	return Lv(t, e), t;
}
function Bv(e) {
	return e && e.__esModule ? e : { default: e };
...
var Gv = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
	var r = Error(n);
	return r.name = "SuppressedError", r.error = e, r.suppressed = t, r;
};
function Kv(e) {
	function t(t) {
		e.error = e.hasError ? new Gv(t, e.error, "An error was suppressed during disposal.") : t, e.hasError = !0;
	}
	var n, r = 0;
	return function i() {
		for (; n = e.stack.pop();) try {
...
var Jv, Yv, Xv, Zv, Qv = Object.freeze({
	__proto__: null,
	...
	__runInitializers: yv,
	__setFunctionName: xv,
	__spread: kv,
	__spreadArray: jv,
	__spreadArrays: Av,
	__values: Dv,
...
try {
	(Zv = function(e, t) {
		return new RegExp(e, t);
	}("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")) == null || Zv[0];
} catch {}
var $v, ey, $ = {};
function ty() {
	return $v || ($v = 1, Object.defineProperty($, "__esModule", { value: !0 }), $.SKELETON_TYPE = $.TYPE = void 0, $.isLiteralElement = function(t) {
		return t.type === e.literal;
...
(function() {
	if (ey) return ny;
	ey = 1, Object.defineProperty(ny, "__esModule", { value: !0 }), ny.printAST = n, ny.doPrintAST = r, ny.printDateTimeSkeleton = o;
	var e = ry, t = ty();
	function n(e) {
		return r(e, !1);
	}
...
var iy = "gt-react";
function ay({ locale: e = "", defaultLocale: t = "en", locales: n = [], localeCookieName: r = "generaltranslation.locale", ssr: i = !0, customMapping: a, enableI18n: o, reloadOnLocaleUpdate: s = !1 }) {
	let c = f(() => ed(e, a), [e, a]), l = f(() => n.map((e) => ed(e, a)), [n, a]), [u, p] = m(() => o ? ed(i ? c && $u(c, l, a) || "" : oy({
		_locale: c,
		locale: c,
		locales: l,
		defaultLocale: t,
		...
		let c = (r) => {
			if (!o) return n;
			if (r === e) return e;
			let s = ed($u(r, t, a) || e || n, a);
			return s !== r && console.warn(((e, t, n = "@generaltranslation/react-core") => `${n} Warning: "${t}" is not a supported locale. Update supported locales in your dashboard or gt.config.json. Falling back to "${e}".`)(s, r, iy)), i(s), s;
		};
		return [(t) => {
			if (!o) return;
			t = ed(t);
...
function oy({ _locale: e, locale: t, locales: n, defaultLocale: r, localeCookieName: i, customMapping: a, enableI18n: o }) {
	if (!o) return r;
	if (e && e === t && $u(e, n, a) === t) return ed(e, a);
	...
	return l &&= ed(l, a), s && s !== l && typeof document < "u" && (document.cookie = `${i}=${l};path=/`), l;
}
function sy(e) {
	return g($g, Object.assign({
		ssr: !(typeof process > "u" || !process.env.NEXT_RUNTIME) || (globalThis == null ? void 0 : globalThis.__NEXT_DATA__) !== void 0,
		environment: "development"
	}, e, {
		readAuthFromEnv: e_,
		useDetermineLocale: ay,
		useRegionState: n_,
		useEnableI18n: r_
	}));
}
var cy = y().server(function({ defaultLocale: e, locales: t, customMapping: n }) {
	let r = [], i = b(Mp);
	...
	return r.length === 0 && process.env._GENERALTRANSLATION_IGNORE_BROWSER_LOCALES === "false" && console.warn("gt-tanstack-start(server): no locales could be determined for this request"), $u(r, t, n) || e;
	...
	return a && r.push(a), r.length === 0 && (console.warn("gt-tanstack-start(client): no locales could be determined for this request"), r.push(e)), $u(r, t, n) || e;
}), ly = class extends ud {
...
function dy(e) {
	zd(new uy(Object.assign(Object.assign({}, e), { storeAdapter: new ly() })));
}
var fy = { exports: {} }, py, my, hy = {};
function gy() {
	return py || (py = 1, function() {
		function e(t) {
...
function by(e) {
	return e.locale ? e.locale : vy() ? yy() : void 0;
}
function xy() {
	let e = Rd();
	if (!function(e) {
...
function Sy(e) {
	let t = xy().getProviderConfig();
	return _y.jsx(sy, Object.assign({ ssr: vy() }, t, e, {
...
var Ey = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/gt-react-app/scripts/Wrapper.tsx";
dy({
	...Cy,
	loadTranslations: Ty
});
...
var Oy = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/gt-react-app/src/components/pages/careers/CareersHeader.wrapper.tsx";
function ky() {
	return v(Dy, { children: v(yo, {}, void 0, !1, {
		fileName: Oy,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
