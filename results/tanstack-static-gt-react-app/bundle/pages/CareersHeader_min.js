...
var qs = () => p("div", {
	...
	children: p(_s, { children: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." })
});
function Js() {
	return m(f, { children: [
		p(qs, {}),
		p("h1", {
			...
			children: p(_s, { children: "Careers" })
		}),
		p("p", {
			className: "mb-4 text-muted-foreground",
			children: p(_s, { children: "Join our mission to improve the internationalization ecosystem. We're a remote-first team that values impact, transparency, and continuous learning." })
		})
	] });
}
function Ys(e) {
