	...
	return m("form", {
		...
		children: [
			...
			m("div", { children: [p("label", {
				htmlFor: n,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: p(Z, { children: "Topic" })
			}), m("select", {
				id: n,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				children: [
					p("option", { children: p(Z, { children: "Bug Report" }) }),
					p("option", { children: p(Z, { children: "New Benchmark Idea" }) }),
					p("option", { children: p(Z, { children: "Methodology Question" }) }),
					p("option", { children: p(Z, { children: "Contribution" }) }),
					p("option", { children: p(Z, { children: "Other" }) })
				]
			})] }),
			m("div", { children: [p("label", {
				htmlFor: r,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: p(Z, { children: "Message" })
			}), p("textarea", {
				id: r,
				rows: 5,
				className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			...
			p("button", {
				...
				children: p(Z, { children: "Send Message" })
			})
		]
	});
}
