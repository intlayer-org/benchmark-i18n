...
var _o = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/gt-react-app/src/components/pages/home/Hero.tsx";
function vo() {
	return go("Hero"), v("section", {
		className: "mb-16 text-center",
		children: [
			v("h1", {
				className: "mb-4 text-4xl font-bold tracking-tight text-foreground",
				children: v(mo, { children: "i18n Benchmark" }, void 0, !1, {
					fileName: _o,
					lineNumber: 9,
					columnNumber: 9
				}, this)
			...
			v("p", {
				...
				children: v(mo, { children: "A test application designed to measure the real-world impact of internationalization libraries on bundle size, loading performance, and rendering reactivity." }, void 0, !1, {
					fileName: _o,
					lineNumber: 12,
					columnNumber: 9
				}, this)
			...
			v("div", {
				...
				children: [v("button", {
					...
					children: v(mo, { children: "View Results" }, void 0, !1, {
						fileName: _o,
						lineNumber: 23,
						columnNumber: 11
					}, this)
					...
					children: v(mo, { children: "Methodology" }, void 0, !1, {
						fileName: _o,
						lineNumber: 29,
						columnNumber: 11
					}, this)
...
var Sc = T(((e) => {
	...
	Object.defineProperty(e, "__esModule", { value: !0 }), vs(), ie(Fo), Sc();
})), wc = Sc();
Cc();
...
function Qg({ children: e, config: t, environment: n = "production", projectId: r = t?.projectId || "", devApiKey: a = t?.devApiKey || "", _versionId: o = t?._versionId, dictionary: s = t?.dictionary || {}, locales: c = t?.locales || [], defaultLocale: l = t?.defaultLocale || Ip, cacheUrl: u = t?.cacheUrl || Bp, runtimeUrl: f = t?.runtimeUrl || Vp, renderSettings: m = t?.renderSettings || xg(n), ssr: g = t?.ssr || Yg(), localeCookieName: v = t?.localeCookieName || "generaltranslation.locale", locale: y = "", region: b, loadDictionary: x, loadTranslations: S, fallback: C, translations: ee = null, customMapping: te = t?.customMapping, enableI18n: w = t?.enableI18n === void 0 || t.enableI18n, enableI18nLoaded: T, reloadOnLocaleUpdate: ne, useEnableI18n: re = Jg, readAuthFromEnv: ie = fg, useDetermineLocale: ae = Xg, useRegionState: oe = Zg, ...se }) {
	...
	let { projectId: E, devApiKey: ce } = ie({
		...
		ssr: g
	}), { locale: le, setLocale: ue, locales: de, translationRequired: fe, dialectTranslationRequired: pe } = Ug({
		_locale: y,
		defaultLocale: l,
		locales: c,
		ssr: g,
	...
	let { translations: Se, setTranslations: Ce } = Kg({
		_translations: ee,
		...
		_versionId: o,
		gt: ge
	}), { registerIcuForTranslation: we, registerJsxForTranslation: Te, developmentApiEnabled: Ee } = Bg({
		gt: ge,
		locale: le,
		versionId: o,
		defaultLocale: l,
		...
		environment: n,
		...se
	}), { _gtFunction: De, _mFunction: Oe, _filterMessagesForPreload: ke, _preloadMessages: Ae } = Vg({
		gt: ge,
		translations: Se,
		locale: le,
		defaultLocale: l,
		...
		environment: n
	}), je = Hg(ge, ve, be, Se, le, l, fe, pe, Ee, we, n), Me = qg(ve || {}, be || {}, ye, xe, Se, le, l, fe, pe, Ee, we, je), Ne = !(fe && !Se || !le);
...
var Dy = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/gt-react-app/src/components/pages/home/Hero.wrapper.tsx";
function Oy() {
	return v(Ey, { children: v(vo, {}, void 0, !1, {
		fileName: Dy,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
