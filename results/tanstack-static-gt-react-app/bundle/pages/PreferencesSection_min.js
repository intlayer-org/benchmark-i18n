...
function Jo(e) {
	let t = Oo(), n = ko();
	return Mo(), f((n) => t.subscribeToTranslate(e, n), () => t.getTranslateSnapshot(e, n), () => t.getTranslateSnapshot(e, n));
}
...
function vs({ children: e, _locale: t, _enableI18n: n, _renderPreparedT: r = Qo, ...i }) {
	let { defaultLocale: a, locale: o, enableI18n: s, targetOptions: c, taggedSourceChildren: l, sourceJsxChildren: u, shouldTranslate: f } = _s({
		sourceChildren: e,
		params: i,
		_locale: t,
		_enableI18n: n
...
function qs() {
	...
	return m("section", {
		...
		children: [p("h2", {
			...
			children: p(Z, { children: "Preferences" })
		}), m("div", {
			className: "space-y-4",
			children: [
				m("div", {
					className: "flex items-center justify-between",
					children: [m("div", { children: [p("p", {
						className: "text-sm font-medium text-foreground",
						children: p(Z, { children: "Email Notifications" })
					}), p("p", {
						className: "text-xs text-muted-foreground",
						children: p(Z, { children: "Receive weekly benchmark reports" })
					})] }), p("button", {
						type: "button",
						className: "h-6 w-11 rounded-full bg-primary transition-colors",
						"aria-label": "Toggle notifications",
						children: p("span", { className: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" })
					})]
				}),
				m("div", {
					className: "flex items-center justify-between",
					children: [m("div", { children: [p("p", {
						className: "text-sm font-medium text-foreground",
						children: p(Z, { children: "Dark Mode" })
					}), p("p", {
						className: "text-xs text-muted-foreground",
						children: p(Z, { children: "Use dark color scheme" })
					})] }), p("button", {
						type: "button",
						className: "h-6 w-11 rounded-full bg-muted transition-colors",
						"aria-label": "Toggle dark mode",
						children: p("span", { className: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" })
					})]
				}),
				m("div", { children: [p("label", {
					htmlFor: e,
					className: "mb-1 block text-sm font-medium text-foreground",
					children: p(Z, { children: "Default Language" })
				}), m("select", {
					id: e,
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
					children: [
						p("option", { children: p(Z, { children: "English (en)" }) }),
						p("option", { children: p(Z, { children: "French (fr)" }) }),
						p("option", { children: p(Z, { children: "German (de)" }) }),
						p("option", { children: p(Z, { children: "Spanish (es)" }) }),
						p("option", { children: p(Z, { children: "Japanese (ja)" }) }),
						p("option", { children: p(Z, { children: "Chinese Simplified (zh-CN)" }) }),
						p("option", { children: p(Z, { children: "Arabic (ar)" }) })
					]
				})] })
			]
		})]
...
var cc = h().server(() => $().getLocale()).client(() => J().getLocale());
