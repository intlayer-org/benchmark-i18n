...
function Js() {
	return m(f, { children: [p(qs, {}), m("div", {
		className: "mb-12 text-center",
		children: [p("h1", {
			className: "mb-3 text-3xl font-bold text-foreground",
			children: p(_s, { children: "Simple, Transparent Pricing" })
		}), p("p", {
			className: "text-muted-foreground",
			children: p(_s, { children: "Choose the plan that fits your team. No hidden fees." })
		})]
	})] });
}
function Ys(e) {
