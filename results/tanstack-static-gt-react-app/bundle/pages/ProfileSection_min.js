...
function qs() {
	...
	return m("section", {
		...
		children: [p("h2", {
			...
			children: p(_s, { children: "Profile" })
		}), m("div", {
			className: "space-y-4",
			children: [m("div", { children: [p("label", {
				htmlFor: e,
				className: "mb-1 block text-sm font-medium text-foreground",
				children: p(_s, { children: "Display Name" })
			}), p("input", {
				id: e,
...
var cc = h().server(() => $().getLocale()).client(() => Y().getLocale());
