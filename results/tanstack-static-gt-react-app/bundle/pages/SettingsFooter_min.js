...
var go = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/gt-react-app/src/components/pages/settings/SettingsFooter.tsx";
function _o() {
	return _("div", {
...
function Ws(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		if (Is.test(i.stem)) {
			...
			var a = i.options[0];
			a === "w" ? t = j(j({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = j(j({}, t), Bs(a)));
			continue;
		}
		if (Ls.test(i.stem)) {
			t = j(j({}, t), Bs(i.stem));
...
var pc = function() {
	...
	return e.prototype.parse = function() {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !mc(this.char())) return this.error(M.INVALID_TAG, P(o, this.clonePosition()));
...
var xc = w(((e) => {
	...
	Object.defineProperty(e, "__esModule", { value: !0 }), _s(), re(Po), xc();
})), Cc = xc();
Sc();
...
var $c = function() {
	...
	try {
		...
		})() || A.get("DisplayNames", ["en"], { type: "language" }).of(t) === t && !tl(t) || n && A.get("DisplayNames", ["en"], { type: "region" }).of(n) === n || r && A.get("DisplayNames", ["en"], { type: "script" }).of(r) === r && !el.includes(r));
	} catch {
		return !1;
	}
}, L = (e) => {
...
function al(e, t, n, r) {
	return !(!I(e, r) || !I(t, r) || n && n.some((e) => !I(e, r)) || rl(e, t) || n && !n.some((e) => il(t, e)));
}
var ol = (e, t, n) => {
	if (e?.[t]) return typeof e[t] == "string" ? n === "name" ? e[t] : void 0 : e[t][n];
}, sl = (e, t) => !!(t?.[e] && typeof t[e] == "object" && "code" in t[e] && t[e].code && I(t[e].code));
function cl(e, t) {
	let n = e;
	t && sl(e, t) && (e = t[e].code);
	try {
...
function yl(e, t = "en", n) {
	...
	try {
		let i = L(e), a = A.get("Locale", e), o = a.language, s = vl([
			r,
			e,
			i,
			o
		...
		let t = I(e) ? L(e) : e, r = t?.split("-"), i = r?.[0] || t || "", a = r.length > 2 ? r?.[2] : r?.[1] || "", o = r?.[3] || "", s = vl([t, i], n);
		t = s?.code || t;
		let c = s?.name || t, l = s?.nativeName || c, u = s?.maximizedCode || t, d = s?.maximizedName || c, f = s?.nativeMaximizedName || l, p = s?.minimizedCode || t, m = s?.minimizedName || c, h = s?.nativeMinimizedName || l;
		i = s?.languageCode || i;
		let g = s?.languageName || c, _ = s?.nativeLanguageName || l;
...
var cu = "GT Error:", lu = (e) => `${cu} Translation request timed out after ${e}ms.`, uu = (e) => `${cu} Translation request failed. Error: ${e}`, du = (e, t, n) => `${cu} API returned error status. Status: ${e}, Status Text: ${t}, Error: ${n}`, R = (e) => `${cu} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a targetLocale in the GT constructor.`, fu = (e) => `${cu} Cannot call \`${e}\` without a specified locale. Either pass a locale to the \`${e}\` function or specify a sourceLocale in the GT constructor.`, pu = (e) => `${cu} Cannot call \`${e}\` without a specified project ID. Either pass a project ID to the \`${e}\` function or specify a projectId in the GT constructor.`, mu = (e) => `${cu} Cannot call \`${e}\` without a specified API key. Either pass an API key to the \`${e}\` function or specify an apiKey in the GT constructor.`, hu = (e) => `${cu} Invalid locale: ${e}.`, gu = (e) => `${cu} Invalid locales: ${e.join(", ")}.`;
...
async function Iu(e, t, n) {
	return Oo(e.map(({ source: e }) => e)), ku(e, async (e) => (await z(n, "/v2/project/files/upload-translations", {
		body: {
...
var qu = class {
	...
	setConfig({ apiKey: e, devApiKey: t, sourceLocale: n, targetLocale: r, locales: i, projectId: a, customMapping: o, baseUrl: s }) {
		if (e && (this.apiKey = e), t && (this.devApiKey = t), a && (this.projectId = a), n && (this.sourceLocale = L(n), !I(this.sourceLocale, o))) throw Error(hu(this.sourceLocale));
		if (r && (this.targetLocale = L(r), !I(this.targetLocale, o))) throw Error(hu(this.targetLocale));
		if (i) {
			let e = [], t = [];
			if (i.forEach((n) => {
				let r = L(n);
...
var Dd = 12e3, Od = class extends Td {
	constructor(e) {
		super(), this.resolveTranslationSync = (e, t = {}) => this.lookupTranslation(e, t), $u(od(e), "I18nManager: "), this.config = kd(e), this.localeConfig = new Ql({
...
var Pd = void 0;
function Fd() {
	return Pd ||= (nu.warn("getI18nManager(): Translation failed because I18nManager not initialized."), new Od({
		defaultLocale: "en",
		locales: ["en"]
	})), Pd;
}
...
var Ty = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/gt-react-app/src/components/pages/settings/SettingsFooter.wrapper.tsx";
function Ey() {
