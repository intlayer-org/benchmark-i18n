...
function Ks() {
	return f("div", {
		...
		children: [
			{
				name: f(Z, { children: "Sarah Chen" }),
				role: f(Z, { children: "Founder & Lead Engineer" }),
				bio: f(Z, { children: "Former Google engineer with 10 years of experience building internationalization systems at scale." })
			},
			{
				name: f(Z, { children: "Marcus Weber" }),
				role: f(Z, { children: "Performance Engineer" }),
				bio: f(Z, { children: "Specializes in JavaScript performance optimization and benchmarking methodology. Previously at Vercel." })
			},
			{
				name: f(Z, { children: "Aisha Patel" }),
				role: f(Z, { children: "Developer Advocate" }),
				bio: f(Z, { children: "Passionate about developer experience and education. Speaker at React Conf, JSConf, and i18nNext." })
			},
			{
				name: f(Z, { children: "Tomás Rodríguez" }),
				role: f(Z, { children: "Full-Stack Developer" }),
				bio: f(Z, { children: "Maintains the benchmarking infrastructure and CI/CD pipeline. Open source contributor to Lingui." })
			},
			{
				name: f(Z, { children: "Yuki Tanaka" }),
				role: f(Z, { children: "Data Analyst" }),
				bio: f(Z, { children: "Ensures statistical rigor in all benchmark results. PhD in Applied Statistics from MIT." })
			},
			{
				name: f(Z, { children: "Elena Kowalski" }),
				role: f(Z, { children: "Community Manager" }),
				bio: f(Z, { children: "Manages community contributions, partnerships, and events. Background in open source governance." })
			}
		].map((e, t) => p("div", {
