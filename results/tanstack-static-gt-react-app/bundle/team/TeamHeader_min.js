...
function Js() {
	return m(f, { children: [
		...
		p("h1", {
			...
			children: p(_s, { children: "Our Team" })
		}),
		p("p", {
			className: "mb-10 text-muted-foreground",
			children: p(_s, { children: "Meet the people behind i18n Benchmark. A diverse team united by a shared passion for great developer tools." })
		})
	] });
}
function Ys(e) {
