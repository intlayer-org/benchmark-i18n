...
var p = {
...
}, De = L, Oe = L, q = /* @__PURE__ */ new Map(), ke = (e, t = !0) => {
	...
	return q.set(n, r), r;
}, Ae = (e, t) => xe(e, t, ke(typeof t == "object" && t ? t.locale : t)), J = (e) => {
...
var X = {
	...
	let { locales: l, defaultLocale: u } = p ?? {}, [f, m] = c(e ?? Z ?? t ?? u);
	a(() => {
		e && e !== f && m(e);
	}, [e]), a(() => {
		ze();
	...
	let { locale: n, variant: r } = i(Q) ?? {}, a = t ?? n, s = typeof a == "object" && a ? `${a.locale ?? ""}|${M(a)}` : a;
