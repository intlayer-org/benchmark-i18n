...
var Y = {
	...
	let { locales: l, defaultLocale: u } = m ?? {}, [f, p] = c(e ?? X ?? t ?? u);
	a(() => {
		e && e !== f && p(e);
	}, [e]), a(() => {
		Ve();
...
}, Ge = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-app/scripts/EmptyComponent.tsx", Ke = () => (We(l), null);
function qe() {
	return p(Q, {
		locale: "en",
		children: p(Ke, {}, void 0, !1, {
			fileName: Ge,
			lineNumber: 13,
			columnNumber: 7
		}, this)
