...
var f = {
	...
	content: {
		...
		translation: {
			...
			fr: {
				b: "Aperçus, tutoriels et analyses de la communauté i18n.",
				a: "Blog"
			},
			es: {
			...
			zh: {
				b: "来自 i18n 社区 de 见解、教程和分析。",
				a: "博客"
			},
			ja: {
				b: "i18n コミュニティからの洞察、チュートリアル、分析。",
				a: "ブログ"
			},
			ko: {
			...
			ru: {
				b: "Инсайты, руководства и анализ от сообщества i18n.",
				a: "Блог"
			}
		}
	}
	...
	return n;
}, T = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), E = "default", se = /[^A-Za-z0-9._&=-]/g, D = /[^A-Za-z0-9._-]/g, ce = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, O = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, ce);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, k = (e) => e === void 0 ? E : typeof e == "string" ? O(e, se) : Object.keys(e).sort().map((t) => `${O(t, D)}=${O(String(e[t]), D)}`).join("&"), A = (e) => Array.isArray(e) ? e.length === 0 ? [E] : e.map(k) : [k(e)], j = (e, t) => {
	...
	if (!ue(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? E : j(A(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => le(e, n, t, s)).map((t) => de(e, t));
	...
	if (F(e)) return e.nodeType === "html" ? e[C] : e[S];
}, ge = (e, t) => {
...
}, z = L, _e = (e) => L, B = L, ve = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? L : {
	id: "insertion-plugin",
	...
	let { locale: r, selector: i } = pe(t), a = ne(r ?? p.defaultLocale, M(i), n), o = re(e, a);
...
}, Se = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", G = /\{\{\s*(.*?)\s*\}\}/g, Ce = (e, t = {}) => {
...
}, De = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? L : {
	id: "insertion-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "insertion",
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: x }], i = e[x], a = {
...
}, Oe = L, ke = L, K = /* @__PURE__ */ new Map(), Ae = (e, t = !0) => {
	...
	return K.set(n, r), r;
}, je = (e, t) => xe(e, t, Ae(typeof t == "object" && t ? t.locale : t)), q = (e) => {
...
var Y = {
...
}, Ve = (e, t = p?.locales, n = p?.defaultLocale) => {
	...
	let { locales: l, defaultLocale: d } = p ?? {}, [f, m] = c(e ?? X ?? t ?? d);
	a(() => {
		e && e !== f && m(e);
	}, [e]), a(() => {
		Be();
