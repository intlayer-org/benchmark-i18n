...
var g = {
...
}, y = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(ne).join("") : String(e ?? ""), re = /* @__PURE__ */ new WeakMap(), ie = 0, ae = (e) => {
	if (!e) return "base";
	let t = re.get(e);
	if (t) return t;
	ie += 1;
	let n = `p${ie}`;
	return re.set(e, n), n;
}, oe = 256, b = /* @__PURE__ */ new WeakMap(), se = (e) => typeof e == "object" && !!e, ce = (e, t, n) => `${e}_${t}_${ae(n)}`, le = (e, t) => {
...
}, ue = "translation", de = "enumeration", fe = "plural", S = "insertion", pe = "object", me = "array", he = "markdown", C = "html", ge = "gender", _e = "select", w = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), T = (e, t) => {
...
}, ye = (e, t) => e[ve(e, t) ?? "fallback"], be = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), E = "default", xe = /[^A-Za-z0-9._&=-]/g, Se = /[^A-Za-z0-9._-]/g, Ce = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, D = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, Ce);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, we = (e) => e === void 0 ? E : typeof e == "string" ? D(e, xe) : Object.keys(e).sort().map((t) => `${D(t, Se)}=${D(String(e[t]), Se)}`).join("&"), O = (e) => Array.isArray(e) ? e.length === 0 ? [E] : e.map(we) : [we(e)], Te = (e, t) => {
	...
	if (!De(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? E : Te(O(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Ee(e, n, t, s)).map((t) => Oe(e, t));
...
}, M = "\x1B[0m", Me = "\x1B[34m", Ne = "\x1B[31m", Pe = "\x1B[32m", Fe = "\x1B[38;5;3m", Ie = (e) => e, Le = (e, t) => {
...
}), N = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? M : n : M}` : e, ze = (e, t = Fe, n = M) => [e].flat().map((e) => N(e, t, n)).join(", ");
N("✗", Ne), N("✓", Pe), N("⏲", Me);
var Be = { messages: g }, Ve = () => Be, He = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	...
	let r = Ve()[e];
	return r ? L(r, t, n) : (We.has(e) || (Re({ log: je })(typeof window > "u" ? `Dictionary ${ze(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), We.add(e)), Ue(e));
...
function P(e, t, n) {
	let r = t ?? A?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = qe.get(a);
...
var Qe = (e, t, n) => e[P("PluralRules", n).select(t)] ?? e.other, $e = (e, t) => {
	...
	if (typeof e == "string") return e;
	if (F(e)) return e.nodeType === "html" ? e[C] : e[he];
}, it = (e, t) => {
	if (typeof e == "string") return t;
	if (F(e)) {
		let n = e.nodeType === "html" ? C : he;
		return {
			...e,
			[n]: t
		};
	...
	canHandle: () => !1,
	transform: (e) => e
}, ot = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? I : {
...
}, st = I, ct = (e) => I, lt = I, ut = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? I : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: S }], i = e[S], a = {
			...
			transform: (e, n, r) => {
				if (F(e)) return (i) => at(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, dt = I, ft = I, pt = (e) => I, mt = I, ht = (e, t = !0) => [
	ot(e ?? A.defaultLocale, t ? A.defaultLocale : void 0),
	st,
	lt,
	ut,
	pt(e ?? A.defaultLocale),
	mt,
	dt,
	ft
], gt = (e, t, n = []) => T(e, {
	...
	let { locale: r, selector: i } = Ae(t), a = ce(r ?? A.defaultLocale, k(i), n), o = le(e, a);
	if (o.hit) return o.content;
	let s = n ?? ht(r), c = ke(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
})() }), Tt = (e) => w(fe, e), Et = (e, t) => w(_e, e, { variable: t }), Dt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "html") return J(r[C], t, n);
	if (r.nodeType === "plural") {
		let e = r[fe];
		return J(Qe(e, Number(q(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[de], i = Rt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[_e], i = q(t, typeof r.variable == "string" ? r.variable : "value");
	...
	let i = J(typeof e == "string" ? Vt[r](e) : e, t, n);
	...
	get messages() {
		...
		for (let t of Wt()) try {
			Object.assign(e, _(Ge(t, this._locale)));
		} catch {}
		return {
...
}, Qt = I, $t = I, X = /* @__PURE__ */ new Map(), en = (e, t = !0) => {
	let n = `${e ?? A.defaultLocale}_${t}`;
	if (X.has(n)) return X.get(n);
	let r = [
		ot(e ?? A.defaultLocale, t ? A.defaultLocale : void 0),
		st,
		ct(e ?? A.defaultLocale),
		lt,
		pt(e ?? A.defaultLocale),
		mt,
		dt,
	...
	return X.set(n, r), r;
}, tn = (e, t) => L(e, t, en(typeof t == "object" && t ? t.locale : t)), nn = (e) => {
...
var Z = {
	...
	if (!an) for (let t = 0; t < (j.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(j.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, sn = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !an && j.storage.cookies) for (let n = 0; n < j.storage.cookies.length; n++) {
...
}, hn = (e, t = A?.locales, n = A?.defaultLocale) => {
	...
	locale: cn ?? A?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), gn = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: i, disableEditor: a, isCookieEnabled: s }) => {
	let { locales: c, defaultLocale: u } = A ?? {}, [d, f] = l(e ?? cn ?? t ?? u);
	o(() => {
		e && e !== d && f(e);
	}, [e]), o(() => {
		mn();
...
}, yn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	return e || n;
}, xn = ({ i18n: e, defaultComponent: t, children: n }) => {
	let r = (e) => ({
		i18n: e,
		_: e._.bind(e),
		defaultComponent: t
...
}), Cn = ({ id: e, message: t, values: n, components: r, formats: i, comment: a, render: o, component: s }) => {
	let { i18n: c, defaultComponent: l } = bn(), u = c._(e, n ?? {}, { message: t }), d = r && Object.keys(r).length > 0, m;
	if (d) {
		let e = Sn(Ut(u), r);
		m = p(f, { children: e });
	} else m = u;
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/Footer.tsx";
function En() {
	let { i18n: e } = Tn(g), t = d({ strict: !1 }).locale ?? "en", n = [
		{
...
var On = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
...
var An = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/Footer.wrapper.tsx";
function jn() {
	return h(kn, { children: h(En, {}, void 0, !1, {
		fileName: An,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
