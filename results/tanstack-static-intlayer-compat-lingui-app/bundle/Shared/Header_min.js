...
var g = {
...
}, v = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(oe).join("") : String(e ?? ""), se = /* @__PURE__ */ new WeakMap(), ce = 0, le = (e) => {
	if (!e) return "base";
	let t = se.get(e);
	if (t) return t;
	ce += 1;
	let n = `p${ce}`;
	return se.set(e, n), n;
}, ue = 256, y = /* @__PURE__ */ new WeakMap(), de = (e) => typeof e == "object" && !!e, fe = (e, t, n) => `${e}_${t}_${le(n)}`, pe = (e, t) => {
	if (!de(e)) return { hit: !1 };
	let n = y.get(e);
	return n?.has(t) ? {
		hit: !0,
		content: n.get(t)
	...
	if (!de(e)) return n;
	let r = y.get(e);
	return r || (r = /* @__PURE__ */ new Map(), y.set(e, r)), r.size >= ue && r.clear(), r.set(t, n), n;
}, me = "translation", he = "enumeration", ge = "plural", x = "insertion", _e = "object", ve = "array", ye = "markdown", S = "html", be = "gender", xe = "select", C = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), w = (e, t) => {
...
}, Ce = (e, t) => e[Se(e, t) ?? "fallback"], we = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), T = "default", Te = /[^A-Za-z0-9._&=-]/g, Ee = /[^A-Za-z0-9._-]/g, De = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, E = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, De);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, Oe = (e) => e === void 0 ? T : typeof e == "string" ? E(e, Te) : Object.keys(e).sort().map((t) => `${E(t, Ee)}=${E(String(e[t]), Ee)}`).join("&"), ke = (e) => Array.isArray(e) ? e.length === 0 ? [T] : e.map(Oe) : [Oe(e)], Ae = (e, t) => {
	...
	if (!Me(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? T : Ae(ke(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => je(e, n, t, s)).map((t) => Ne(e, t));
...
}, k = "\x1B[0m", Re = "\x1B[34m", ze = "\x1B[31m", Be = "\x1B[32m", Ve = "\x1B[38;5;3m", He = (e) => e, Ue = (e, t) => {
...
}), A = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? k : n : k}` : e, Ge = (e, t = Ve, n = k) => [e].flat().map((e) => A(e, t, n)).join(", ");
A("✗", ze), A("✓", Be), A("⏲", Re);
var Ke = { messages: g }, qe = () => Ke, Je = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), Ye = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Je.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : Ye(e ? `${e}.${String(n)}` : String(n)) }), Xe = /* @__PURE__ */ new Set(), Ze = (e, t, n) => {
	let r = qe()[e];
	return r ? xt(r, t, n) : (Xe.has(e) || (We({ log: Le })(typeof window > "u" ? `Dictionary ${Ge(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Xe.add(e)), Ye(e));
...
function j(e, t, n) {
	let r = t ?? D?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = $e.get(a);
...
var it = (e, t, n) => e[j("PluralRules", n).select(t)] ?? e.other, at = (e, t) => {
	...
	if (typeof e == "string") return e;
	if (P(e)) return e.nodeType === "html" ? e[S] : e[ye];
}, ct = (e, t) => {
	if (typeof e == "string") return t;
	if (P(e)) {
		let n = e.nodeType === "html" ? S : ye;
		return {
			...e,
			[n]: t
		};
	...
	canHandle: () => !1,
	transform: (e) => e
}, ut = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? F : {
...
}, dt = F, ft = (e) => F, pt = F, mt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? F : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: x }], i = e[x], a = {
			...
			transform: (e, n, r) => {
				if (P(e)) return (i) => lt(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, ht = F, gt = F, _t = (e) => F, vt = F, yt = (e, t = !0) => [
	ut(e ?? D.defaultLocale, t ? D.defaultLocale : void 0),
	dt,
	pt,
	mt,
	_t(e ?? D.defaultLocale),
	vt,
	ht,
	gt
], bt = (e, t, n = []) => w(e, {
	...
	let { locale: r, selector: i } = Fe(t), a = fe(r ?? D.defaultLocale, Ie(i), n), o = pe(e, a);
	if (o.hit) return o.content;
	let s = n ?? yt(r), c = Pe(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
}, St = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", Ct = /\{\{\s*(.*?)\s*\}\}/g, wt = (e, t = {}) => {
	if (!Object.values(t).some(St)) return {
		isSimple: !0,
		parts: e.replace(Ct, (e, n) => (t[n.trim()] ?? "").toString())
	};
	let n = e.split(Ct), r = [];
...
})() }), At = (e) => C(ge, e), jt = (e, t) => C(xe, e, { variable: t }), Mt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	let r = e;
	if (r.nodeType === "insertion") return K(r[x], t, n);
	if (r.nodeType === "html") return K(r[S], t, n);
	if (r.nodeType === "plural") {
		let e = r[ge];
		return K(it(e, Number(G(t, "count") ?? 1), n), t, n);
	}
	...
	if (r.nodeType === "select") {
		let e = r[xe], i = G(t, typeof r.variable == "string" ? r.variable : "value");
		return K(at(e, String(i ?? "")), t, n);
	}
	...
	let i = K(typeof e == "string" ? Kt[r](e) : e, t, n);
	...
	get messages() {
		let e = {};
		this._dictionaryContent !== void 0 && Object.assign(e, ae(this._dictionaryContent));
		for (let t of Jt()) try {
			Object.assign(e, ae(Ze(t, this._locale)));
		} catch {}
		return {
	...
	_(e, t, n) {
		...
		return qt(this.resolveTemplate(i) ?? a ?? i, o, this._locale, "icu") ?? i;
	}
...
}, Zt = t(null), Qt = ({ children: e, value: t, additionalProps: n }) => {
...
}, nn = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? F : {
	id: "insertion-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "insertion",
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: x }], i = e[x], a = {
...
}, rn = F, an = F, q = /* @__PURE__ */ new Map(), on = (e, t = !0) => {
	let n = `${e ?? D.defaultLocale}_${t}`;
	if (q.has(n)) return q.get(n);
	let r = [
		ut(e ?? D.defaultLocale, t ? D.defaultLocale : void 0),
		dt,
		ft(e ?? D.defaultLocale),
		pt,
		_t(e ?? D.defaultLocale),
		vt,
		ht,
	...
	return q.set(n, r), r;
}, sn = (e, t) => xt(e, t, on(typeof t == "object" && t ? t.locale : t)), cn = (e) => {
...
var Y = {
	...
	if (!J) for (let t = 0; t < (O.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(O.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, dn = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !J && O.storage.cookies) for (let n = 0; n < O.storage.cookies.length; n++) {
...
}, yn = (e, t = D?.locales, n = D?.defaultLocale) => {
	...
	let { locale: n, variant: r } = a(X) ?? {}, i = t ?? n, o = typeof i == "object" && i ? `${i.locale ?? ""}|${Ie(i)}` : i;
	return c(() => sn(e, i), [e.key, o]);
}, Cn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { defaultLocale: n, locales: r } = D ?? {}, { locale: o, setLocale: s, isCookieEnabled: c } = a(X) ?? {};
	return {
		locale: o,
		defaultLocale: n,
		availableLocales: r,
...
Tn({ locale: "en" });
var En = (e) => {
	let t = Sn(e), { locale: n } = Cn();
	return c(() => {
		let e = new Xt({ locale: n }).bindDictionaryContent(t);
		return {
			i18n: e,
			_: e._.bind(e)
		};
	}, [n, t]);
}, Dn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/ThemeToggle.tsx";
function On() {
...
var In = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
...
var Rn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/Header.wrapper.tsx";
function zn() {
	return h(Ln, { children: h(Fn, {}, void 0, !1, {
		fileName: Rn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
