...
}, h = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(m).join("") : String(e ?? ""), te = /* @__PURE__ */ new WeakMap(), ne = 0, re = (e) => {
	if (!e) return "base";
	let t = te.get(e);
	if (t) return t;
	ne += 1;
...
}, se = "translation", ce = "enumeration", le = "plural", y = "insertion", ue = "object", de = "array", fe = "markdown", b = "html", x = "gender", S = "select", C = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), w = (e, t) => {
...
}, me = (e, t) => e[pe(e, t) ?? "fallback"], T = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), E = "default", he = /[^A-Za-z0-9._&=-]/g, ge = /[^A-Za-z0-9._-]/g, _e = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, D = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, _e);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, ve = (e) => e === void 0 ? E : typeof e == "string" ? D(e, he) : Object.keys(e).sort().map((t) => `${D(t, ge)}=${D(String(e[t]), ge)}`).join("&"), ye = (e) => Array.isArray(e) ? e.length === 0 ? [E] : e.map(ve) : [ve(e)], be = (e, t) => {
...
}, A = "\x1B[0m", Oe = "\x1B[34m", ke = "\x1B[31m", Ae = "\x1B[32m", je = "\x1B[38;5;3m", Me = (e) => e, Ne = (e, t) => {
...
}), j = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? A : n : A}` : e, Fe = (e, t = je, n = A) => [e].flat().map((e) => j(e, t, n)).join(", ");
j("✗", ke), j("✓", Ae), j("⏲", Oe);
var Ie = { messages: {
	key: "messages",
	...
	let r = Le()[e];
	return r ? lt(r, t, n) : (Be.has(e) || (Pe({ log: De })(typeof window > "u" ? `Dictionary ${Fe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Be.add(e)), ze(e));
}, He = 50, Ue = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Set(), We = (e) => {
...
function N(e, t, n) {
	let r = t ?? O?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = Ue.get(a);
...
var qe = (e, t, n) => e[N("PluralRules", n).select(t)] ?? e.other, Je = (e, t) => {
	...
	if (typeof e == "string") return e;
	if (I(e)) return e.nodeType === "html" ? e[b] : e[fe];
}, Ze = (e, t) => {
	...
	$e(e ?? O.defaultLocale, t ? O.defaultLocale : void 0),
	et,
	tt,
	nt,
	at(e ?? O.defaultLocale),
	ot,
	rt,
	it
], ct = (e, t, n = []) => w(e, {
	...
	let { locale: r, selector: i } = Te(t), a = ae(r ?? O.defaultLocale, Ee(i), n), o = oe(e, a);
	if (o.hit) return o.content;
	let s = n ?? st(r), c = we(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
})() }), mt = (e) => C(le, e), ht = (e, t) => C(S, e, { variable: t }), gt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "enumeration") {
		let e = r[ce], i = Dt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[S], i = J(t, typeof r.variable == "string" ? r.variable : "value");
	...
	let i = Y(typeof e == "string" ? At[r](e) : e, t, n);
	...
	get messages() {
		let e = {};
		this._dictionaryContent !== void 0 && Object.assign(e, f(this._dictionaryContent));
		for (let t of Mt()) try {
			Object.assign(e, f(Ve(t, this._locale)));
		} catch {}
		return {
...
var X = {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), Jt = ({ locale: e, defaultLocale: t, variant: r, children: i, setLocale: o, disableEditor: s, isCookieEnabled: l }) => {
	let { locales: u, defaultLocale: ee } = O ?? {}, [d, f] = a(e ?? Z ?? t ?? ee);
	n(() => {
		e && e !== d && f(e);
	}, [e]), n(() => {
		Kt();
...
}), Xt = ({ i18n: e, defaultComponent: t, children: r }) => {
	let i = (e) => ({
		i18n: e,
		_: e._.bind(e),
		defaultComponent: t
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/LocaleSwitcher.tsx";
function tn() {
...
var an = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/LocaleSwitcher.wrapper.tsx";
function on() {
	return u(rn, { children: u(tn, {}, void 0, !1, {
		fileName: an,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
