...
var ze = { messages: p }, N = () => ze, Be = /* @__PURE__ */ new Set([
	...
	yield e;
} : P(e ? `${e}.${String(n)}` : String(n)) }), F = /* @__PURE__ */ new Set(), Ve = (e, t, n) => {
	let r = N()[e];
	return r ? ft(r, t, n) : (F.has(e) || (Le({ log: Ae })(typeof window > "u" ? `Dictionary ${Re(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), F.add(e)), P(e));
...
function I(e, t, n) {
	let r = t ?? k?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = Ue.get(a);
...
var Je = (e, t, n) => e[I("PluralRules", n).select(t)] ?? e.other, Ye = (e, t) => {
	...
	if (typeof e == "string") return e;
	if (L(e)) return e.nodeType === "html" ? e[x] : e[he];
}, et = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, nt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? R : {
...
}, rt = R, it = (e) => R, at = R, ot = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? R : {
	id: "insertion-plugin",
...
}, z = R, st = R, ct = (e) => R, lt = R, ut = (e, t = !0) => [
	nt(e ?? k.defaultLocale, t ? k.defaultLocale : void 0),
	rt,
	at,
	ot,
...
})() }), xt = (e) => S(fe, e), St = (e, t) => S(_e, e, { variable: t }), Ct = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "plural") {
		let e = r[fe];
		return X(Je(e, Number(Y(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[de], i = Pt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[_e], i = Y(t, typeof r.variable == "string" ? r.variable : "value");
		return X(Ye(e, String(i ?? "")), t, n);
	}
	...
	let i = X(typeof e == "string" ? Lt[r](e) : e, t, n);
	...
	get messages() {
		...
		for (let t of zt()) try {
			Object.assign(e, ne(Ve(t, this._locale)));
		} catch {}
		return {
	...
	_(e, t, n) {
		...
		return Rt(this.resolveTemplate(i) ?? a ?? i, o, this._locale, "icu") ?? i;
	}
...
}, Ht = t(null), Ut = ({ children: e, value: t, additionalProps: n }) => {
...
}, qt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? R : {
	id: "insertion-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "insertion",
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: b }], i = e[b], a = {
...
}, Jt = R, Yt = R, Z = /* @__PURE__ */ new Map(), Xt = (e, t = !0) => {
	let n = `${e ?? k.defaultLocale}_${t}`;
	if (Z.has(n)) return Z.get(n);
	let r = [
		nt(e ?? k.defaultLocale, t ? k.defaultLocale : void 0),
		rt,
		it(e ?? k.defaultLocale),
		at,
		ct(e ?? k.defaultLocale),
		lt,
		z,
	...
	return Z.set(n, r), r;
}, Zt = (e, t) => ft(e, t, Xt(typeof t == "object" && t ? t.locale : t)), Qt = (e) => {
...
var Q = {
	...
	if (!en) for (let t = 0; t < (A.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(A.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, nn = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !en && A.storage.cookies) for (let n = 0; n < A.storage.cookies.length; n++) {
	...
	let { locale: n, variant: r } = a($) ?? {}, i = t ?? n, o = typeof i == "object" && i ? `${i.locale ?? ""}|${O(i)}` : i;
	return s(() => Zt(e, i), [e.key, o]);
}, hn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { defaultLocale: n, locales: r } = k ?? {}, { locale: o, setLocale: s, isCookieEnabled: c } = a($) ?? {};
	return {
		locale: o,
		defaultLocale: n,
		availableLocales: r,
...
}, gn = ({ i18n: e, defaultComponent: t, children: n }) => {
	let r = (e) => ({
		i18n: e,
		_: e._.bind(e),
		defaultComponent: t
...
_n({ locale: "en" });
var vn = (e) => {
	let t = mn(e), { locale: n } = hn();
	return s(() => {
		let e = new Vt({ locale: n }).bindDictionaryContent(t);
		return {
			i18n: e,
			_: e._.bind(e)
		};
	}, [n, t]);
}, yn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/MockBanner.tsx", bn = () => {
	let { i18n: e } = vn(p);
	return f("div", {
...
var wn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/MockBanner.wrapper.tsx";
function Tn() {
