...
}, y = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(ee).join("") : String(e ?? ""), te = /* @__PURE__ */ new WeakMap(), ne = 0, re = (e) => {
	if (!e) return "base";
	let t = te.get(e);
	if (t) return t;
	ne += 1;
...
}, ce = "translation", le = "enumeration", ue = "plural", S = "insertion", de = "object", fe = "array", pe = "markdown", C = "html", me = "gender", he = "select", w = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), T = (e, t) => {
...
}, j = "\x1B[0m", je = "\x1B[34m", Me = "\x1B[31m", Ne = "\x1B[32m", Pe = "\x1B[38;5;3m", Fe = (e) => e, Ie = (e, t) => {
...
}), M = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? j : n : j}` : e, Re = (e, t = Pe, n = j) => [e].flat().map((e) => M(e, t, n)).join(", ");
M("✗", Me), M("✓", Ne), M("⏲", je);
var ze = { messages: m }, Be = () => ze, Ve = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), He = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Ve.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : He(e ? `${e}.${String(n)}` : String(n)) }), Ue = /* @__PURE__ */ new Set(), We = (e, t, n) => {
	let r = Be()[e];
	return r ? ht(r, t, n) : (Ue.has(e) || (Le({ log: Ae })(typeof window > "u" ? `Dictionary ${Re(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Ue.add(e)), He(e));
}, Ge = 50, Ke = /* @__PURE__ */ new Map(), qe = /* @__PURE__ */ new Set(), Je = (e) => {
	qe.has(e) || (qe.add(e), console.warn(`[intlayer] \`Intl.${e}\` is not available in this JavaScript engine. A degraded fallback is used instead. On React Native, load a polyfill (e.g. \`@formatjs/intl-${e.toLowerCase()}/polyfill\`) before rendering your app.`));
}, Ye = {
	DisplayNames: class {
		of(e) {
			return e;
	...
	let t = Intl[e];
	return typeof t == "function" ? t : (Je(e), Ye[e]);
};
function N(e, t, n) {
...
var Ze = (e, t, n) => e[N("PluralRules", n).select(t)] ?? e.other, Qe = (e, t) => {
	...
	if (typeof e == "string") return e;
	if (P(e)) return e.nodeType === "html" ? e[C] : e[pe];
}, rt = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, at = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? F : {
...
}, ot = F, st = (e) => F, ct = F, lt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? F : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: S }], i = e[S], a = {
			...
			transform: (e, n, r) => {
				if (P(e)) return (i) => it(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, I = F, ut = F, dt = (e) => F, ft = F, pt = (e, t = !0) => [
	at(e ?? k.defaultLocale, t ? k.defaultLocale : void 0),
	ot,
	ct,
	lt,
	...
	let { locale: r, selector: i } = ke(t), a = oe(r ?? k.defaultLocale, O(i), n), o = se(e, a);
	if (o.hit) return o.content;
	let s = n ?? pt(r), c = Oe(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
})() }), wt = (e) => w(ue, e), Tt = (e, t) => w(he, e, { variable: t }), Et = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "plural") {
		let e = r[ue];
		return q(Ze(e, Number(K(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[le], i = Lt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	let i = q(typeof e == "string" ? Bt[r](e) : e, t, n);
	...
	get messages() {
		let e = {};
		this._dictionaryContent !== void 0 && Object.assign(e, _(this._dictionaryContent));
		for (let t of Ut()) try {
			Object.assign(e, _(We(t, this._locale)));
		} catch {}
		return {
...
}, Gt = t(null), Kt = ({ children: e, value: t, additionalProps: n }) => {
...
}, Xt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? F : {
	id: "insertion-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "insertion",
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: S }], i = e[S], a = {
...
}, Zt = F, Qt = F, Y = /* @__PURE__ */ new Map(), $t = (e, t = !0) => {
	...
	return Y.set(n, r), r;
}, en = (e, t) => ht(e, t, $t(typeof t == "object" && t ? t.locale : t)), tn = (e) => {
...
}, rn = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false";
...
var X = {
	...
	if (!rn) for (let t = 0; t < (A.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(A.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, on = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !rn && A.storage.cookies) for (let n = 0; n < A.storage.cookies.length; n++) {
		let { name: r, attributes: i } = A.storage.cookies[n];
		try {
			t?.setCookieStore && t.setCookieStore(r, e, {
				...i,
				expires: tn(i.expires)
			});
		} catch {
			try {
				t?.setCookieString && t.setCookieString(r, nn(r, e, i));
			} catch {}
		}
	}
}, sn = an(X), cn = (e, t) => on(e, {
...
}, mn = (e, t = k?.locales, n = k?.defaultLocale) => {
	...
	return s(() => en(e, i), [e.key, o]);
}, vn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { defaultLocale: n, locales: r } = k ?? {}, { locale: o, setLocale: s, isCookieEnabled: c } = a(Z) ?? {};
	return {
		locale: o,
		defaultLocale: n,
		availableLocales: r,
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/about/AboutGrid.tsx";
function wn() {
	let { i18n: e } = Cn(m);
	return p("div", {
...
var En = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
...
var On = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/about/AboutGrid.wrapper.tsx";
function kn() {
	return p(Dn, { children: p(wn, {}, void 0, !1, {
		fileName: On,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
