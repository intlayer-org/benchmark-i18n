...
var m = {
...
}, g = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(ie).join("") : String(e ?? ""), _ = /* @__PURE__ */ new WeakMap(), ae = 0, oe = (e) => {
	if (!e) return "base";
	let t = _.get(e);
	if (t) return t;
	ae += 1;
	let n = `p${ae}`;
	return _.set(e, n), n;
}, se = 256, v = /* @__PURE__ */ new WeakMap(), ce = (e) => typeof e == "object" && !!e, le = (e, t, n) => `${e}_${t}_${oe(n)}`, ue = (e, t) => {
	...
	if (!ce(e)) return n;
	let r = v.get(e);
	return r || (r = /* @__PURE__ */ new Map(), v.set(e, r)), r.size >= se && r.clear(), r.set(t, n), n;
}, de = "translation", fe = "enumeration", pe = "plural", b = "insertion", me = "object", he = "array", ge = "markdown", x = "html", S = "gender", _e = "select", C = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), w = (e, t) => {
...
}, ye = (e, t) => e[ve(e, t) ?? "fallback"], be = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), T = "default", xe = /[^A-Za-z0-9._&=-]/g, Se = /[^A-Za-z0-9._-]/g, Ce = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, E = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, Ce);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, we = (e) => e === void 0 ? T : typeof e == "string" ? E(e, xe) : Object.keys(e).sort().map((t) => `${E(t, Se)}=${E(String(e[t]), Se)}`).join("&"), Te = (e) => Array.isArray(e) ? e.length === 0 ? [T] : e.map(we) : [we(e)], Ee = (e, t) => {
	...
	if (!Oe(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? T : Ee(Te(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => De(e, n, t, s)).map((t) => ke(e, t));
	...
	let n = e[t];
	return `${t}:${t === "variant" ? Te(n).join(",") : String(n)}`;
}).join("|") : "", D = {
	locales: [
		"en",
		"fr",
...
}, k = "\x1B[0m", Pe = "\x1B[34m", Fe = "\x1B[31m", Ie = "\x1B[32m", Le = "\x1B[38;5;3m", Re = (e) => e, ze = (e, t) => {
...
}), A = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? k : n : k}` : e, Ve = (e, t = Le, n = k) => [e].flat().map((e) => A(e, t, n)).join(", ");
A("✗", Fe), A("✓", Ie), A("⏲", Pe);
var He = { messages: m }, Ue = () => He, We = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	...
	let r = Ue()[e];
	return r ? ht(r, t, n) : (Ke.has(e) || (Be({ log: Ne })(typeof window > "u" ? `Dictionary ${Ve(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Ke.add(e)), Ge(e));
}, Je = 50, Ye = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Set(), Xe = (e) => {
...
function M(e, t, n) {
	let r = t ?? D?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = Ye.get(a);
...
var $e = (e, t, n) => e[M("PluralRules", n).select(t)] ?? e.other, et = (e, t) => {
	...
	if (typeof e == "string") return e;
	if (F(e)) return e.nodeType === "html" ? e[x] : e[ge];
}, rt = (e, t) => {
	if (typeof e == "string") return t;
	if (F(e)) {
		let n = e.nodeType === "html" ? x : ge;
		return {
			...e,
			[n]: t
		};
	...
	it(e ?? D.defaultLocale, t ? D.defaultLocale : void 0),
	at,
	st,
	ct,
	dt(e ?? D.defaultLocale),
	ft,
	lt,
	ut
], mt = (e, t, n = []) => w(e, {
	...
	let { locale: r, selector: i } = je(t), a = le(r ?? D.defaultLocale, Me(i), n), o = ue(e, a);
	if (o.hit) return o.content;
	let s = n ?? pt(r), c = Ae(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
})() }), wt = (e) => C(pe, e), Tt = (e, t) => C(_e, e, { variable: t }), Et = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "enumeration") {
		let e = r[fe], i = Lt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	get messages() {
		let e = {};
		this._dictionaryContent !== void 0 && Object.assign(e, re(this._dictionaryContent));
		for (let t of Ht()) try {
			Object.assign(e, re(qe(t, this._locale)));
		} catch {}
		return {
...
}, Zt = L, Qt = L, Y = /* @__PURE__ */ new Map(), $t = (e, t = !0) => {
	let n = `${e ?? D.defaultLocale}_${t}`;
	if (Y.has(n)) return Y.get(n);
	let r = [
		it(e ?? D.defaultLocale, t ? D.defaultLocale : void 0),
		at,
		ot(e ?? D.defaultLocale),
		st,
		dt(e ?? D.defaultLocale),
		ft,
		lt,
...
var Z = {
	...
	if (!X) for (let t = 0; t < (O.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(O.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, an = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !X && O.storage.cookies) for (let n = 0; n < O.storage.cookies.length; n++) {
...
}, pn = (e, t = D?.locales, n = D?.defaultLocale) => {
	...
	let { locale: n, variant: r } = a(Q) ?? {}, i = t ?? n, o = typeof i == "object" && i ? `${i.locale ?? ""}|${Me(i)}` : i;
	return s(() => en(e, i), [e.key, o]);
}, _n = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { defaultLocale: n, locales: r } = D ?? {}, { locale: o, setLocale: s, isCookieEnabled: c } = a(Q) ?? {};
	return {
		locale: o,
		defaultLocale: n,
		availableLocales: r,
...
}, vn = ({ i18n: e, defaultComponent: t, children: n }) => {
	let r = (e) => ({
		i18n: e,
		_: e._.bind(e),
		defaultComponent: t
...
var bn = (e) => {
	...
	return s(() => {
		let e = new Wt({ locale: n }).bindDictionaryContent(t);
		return {
			i18n: e,
			_: e._.bind(e)
		};
	}, [n, t]);
}, xn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/MockBanner.tsx", Sn = () => {
	let { i18n: e } = bn(m);
	return p("div", {
...
var Tn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
...
var Dn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/contact/ContactHeader.wrapper.tsx";
function On() {
	return p(En, { children: p(Cn, {}, void 0, !1, {
		fileName: Dn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
