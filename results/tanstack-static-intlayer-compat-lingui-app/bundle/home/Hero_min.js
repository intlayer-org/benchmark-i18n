...
var Z = {
	...
	let { locales: c, defaultLocale: l } = k ?? {}, [d, p] = u(e ?? sn ?? t ?? l);
	o(() => {
		e && e !== d && p(e);
	}, [e]), o(() => {
		pn();
	...
	let { i18n: c, defaultComponent: l } = yn(), u = c._(e, n ?? {}, { message: t }), p = r && Object.keys(r).length > 0, m;
	if (p) {
		let e = xn(Ht(u), r);
		m = f(d, { children: e });
	} else m = u;
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/home/Hero.tsx";
function En() {
	let { i18n: e } = wn(h);
	return Tn("Hero"), m("section", {
...
var An = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/home/Hero.wrapper.tsx";
function jn() {
	return m(kn, { children: m(En, {}, void 0, !1, {
		fileName: An,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
