...
var f = class {
...
}, _ = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(g).join("") : String(e ?? ""), ee = /* @__PURE__ */ new WeakMap(), te = 0, ne = (e) => {
	if (!e) return "base";
	let t = ee.get(e);
	if (t) return t;
	te += 1;
	let n = `p${te}`;
	return ee.set(e, n), n;
}, re = 256, v = /* @__PURE__ */ new WeakMap(), ie = (e) => typeof e == "object" && !!e, ae = (e, t, n) => `${e}_${t}_${ne(n)}`, oe = (e, t) => {
...
}, se = "translation", b = "enumeration", ce = "plural", x = "insertion", le = "object", ue = "array", S = "markdown", C = "html", de = "gender", fe = "select", w = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), T = (e, t) => {
...
}, me = (e, t) => e[pe(e, t) ?? "fallback"], he = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), E = "default", ge = /[^A-Za-z0-9._&=-]/g, _e = /[^A-Za-z0-9._-]/g, ve = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, D = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, ve);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, O = (e) => e === void 0 ? E : typeof e == "string" ? D(e, ge) : Object.keys(e).sort().map((t) => `${D(t, _e)}=${D(String(e[t]), _e)}`).join("&"), ye = (e) => Array.isArray(e) ? e.length === 0 ? [E] : e.map(O) : [O(e)], be = (e, t) => {
	...
	if (!Se(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? E : be(ye(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => xe(e, n, t, s)).map((t) => Ce(e, t));
...
}, j = "\x1B[0m", Oe = "\x1B[34m", ke = "\x1B[31m", Ae = "\x1B[32m", je = "\x1B[38;5;3m", Me = (e) => e, Ne = (e, t) => {
...
}), M = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? j : n : j}` : e, Fe = (e, t = je, n = j) => [e].flat().map((e) => M(e, t, n)).join(", ");
M("✗", ke), M("✓", Ae), M("⏲", Oe);
var Ie = { messages: {
	key: "messages",
	...
	"toLocaleString"
]), N = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Re.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : N(e ? `${e}.${String(n)}` : String(n)) }), P = /* @__PURE__ */ new Set(), ze = (e, t, n) => {
	let r = Le()[e];
	return r ? ut(r, t, n) : (P.has(e) || (Pe({ log: De })(typeof window > "u" ? `Dictionary ${Fe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), P.add(e)), N(e));
}, Be = 50, Ve = /* @__PURE__ */ new Map(), He = /* @__PURE__ */ new Set(), Ue = (e) => {
...
function F(e, t, n) {
	let r = t ?? k?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = Ve.get(a);
...
var Ke = (e, t, n) => e[F("PluralRules", n).select(t)] ?? e.other, qe = (e, t) => {
...
}, tt = L, nt = L, rt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? L : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: x }], i = e[x], a = {
			...
			transform: (e, n, r) => {
				if (I(e)) return (i) => $e(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, it = L, at = L, ot = (e) => L, st = L, ct = (e, t = !0) => [
	...
	let { locale: r, selector: i } = Te(t), a = ae(r ?? k.defaultLocale, Ee(i), n), o = oe(e, a);
	if (o.hit) return o.content;
	let s = n ?? ct(r), c = we(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
	...
	"track",
	"wbr"
]), pt = /<(\/)?([a-zA-Z][a-zA-Z0-9.-]*)\s*((?:[^\n]|\n(?!\n))*?)(\/?)>/g, mt = (e) => {
	let t = [], n = [];
	for (let r of e.matchAll(pt)) {
...
})() }), ht = (e) => w(ce, e), gt = (e, t) => w(fe, e, { variable: t }), _t = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	return String(e);
}, At = (e, t = {}, n = "en") => e.replace(/\{\{\s*([^{}]+?)\s*\}\}/g, (e, n) => {
	let r = q(t, n);
	...
	if (r.nodeType === "enumeration") {
		let e = r[b], i = Ot.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	let i = Y(typeof e == "string" ? jt[r](e) : e, t, n);
	...
	get messages() {
		let e = {};
		this._dictionaryContent !== void 0 && Object.assign(e, m(this._dictionaryContent));
		for (let t of Pt()) try {
			Object.assign(e, m(ze(t, this._locale)));
		} catch {}
		return {
...
var X = {
	...
	let { locales: u, defaultLocale: d } = k ?? {}, [f, p] = s(e ?? Ut ?? t ?? d);
	i(() => {
		e && e !== f && p(e);
	}, [e]), i(() => {
		Yt();
...
}), $t = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { defaultLocale: i, locales: a } = k ?? {}, { locale: o, setLocale: s, isCookieEnabled: c } = r(Z) ?? {};
	return {
		locale: o,
		defaultLocale: i,
		availableLocales: a,
	...
	let e = r(Lt), { locale: t } = $t(), n = a(() => {
		let e = new It({ locale: t });
		return {
			i18n: e,
			_: e._.bind(e)
		};
	...
	return e || n;
}, tn = ({ i18n: e, defaultComponent: t, children: n }) => {
	let r = (e) => ({
		i18n: e,
		_: e._.bind(e),
		defaultComponent: t
	...
	let i = nn(t.children, n), a = n[t.tag];
	...
	let { i18n: u, defaultComponent: d } = en(), f = u._(e, n ?? {}, { message: t }), p = r && Object.keys(r).length > 0, m;
	if (p) {
		let e = nn(Nt(f), r);
		m = l(c, { children: e });
	} else m = f;
...
rn({ locale: "en" });
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/home/UnderstandingImpact.tsx";
function an() {
	return d("section", {
...
var ln = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/home/UnderstandingImpact.wrapper.tsx";
function un() {
	return d(cn, { children: d(an, {}, void 0, !1, {
		fileName: ln,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
