...
}, ie = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(re).join("") : String(e ?? ""), ae = "translation", oe = "enumeration", se = "plural", v = "insertion", ce = "object", le = "array", ue = "markdown", y = "html", b = "gender", de = "select", x = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), S = (e, t) => {
...
})() }), ve = (e) => x(se, e), ye = (e, t) => x(de, e, { variable: t }), be = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (e.length === 1) {
		...
		if (t.type === "plural") {
			...
			if (n) {
				...
				return e.__intlayer_icu_var = t.name, fe(e);
			}
		...
		if (t.type === "selectordinal") {
			...
			return e.__intlayer_icu_var = t.name, e.__intlayer_icu_ordinal = !0, fe(e);
		}
	}
	return e.map((e) => D([e]));
}, xe = {
...
}, Ee = 50, De = /* @__PURE__ */ new Map(), Oe = /* @__PURE__ */ new Set(), ke = (e) => {
...
function A(e, t, n) {
	let r = t ?? O?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = De.get(a);
...
var Me = (e, t, n) => e[A("PluralRules", n).select(t)] ?? e.other, Ne = (e, t) => {
	...
	if (r.nodeType === "plural") {
		let e = r[se];
		return P(Me(e, Number(N(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[oe], i = j.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[de], i = N(t, typeof r.variable == "string" ? r.variable : "value");
		return P(Ne(e, String(i ?? "")), t, n);
	}
...
}, Le = (e) => (t, n = {}, r = "en") => Ie(typeof t == "string" ? e(t) : t, n, r), Re = (e) => {
	...
	lookupBoundDictionaries(e) {
		let { dictionaryKey: t, remainder: n } = Be(e), r = this._boundDictionaries[t];
		if (r !== void 0) {
			let e = _(r, n);
	...
	_(e, t, n) {
		...
		return (c.kind === "node" ? Ie(c.node, o, s) : ze(c.message, o, s)) ?? i;
	}
...
var ft = () => ({}), pt = /* @__PURE__ */ new Set([
	...
	let r = ft()[e];
	return r ? Nt(r, t, n) : (mt.has(e) || (ut({ log: Te })(typeof window > "u" ? `Dictionary ${dt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), mt.add(e)), K(e));
}, gt = (e) => {
	...
	if (typeof e == "string") return e;
	if (q(e)) return e.nodeType === "html" ? e[y] : e[ue];
}, bt = (e, t) => {
	if (typeof e == "string") return t;
	if (q(e)) {
		let n = e.nodeType === "html" ? y : ue;
		return {
			...e,
			[n]: t
		};
	...
	let { locale: r, selector: i } = nt(t), a = We(r ?? O.defaultLocale, rt(i), n), o = Ge(e, a);
...
var X = {
	...
	let { locales: c, defaultLocale: l } = O ?? {}, [d, p] = u(e ?? tn ?? t ?? l);
	o(() => {
		e && e !== d && p(e);
	}, [e]), o(() => {
		cn();
...
}), { defaultLocale: fn, locales: Q } = O ?? {}, pn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let n = new Ve({ locale: e }).bindDictionaries(t);
	return {
		i18n: n,
		_: n._.bind(n)
	};
	...
	return c(() => hn(t, Object.fromEntries(e.map((e) => [e.key, Yt(e, t)]))), [t, n]);
}, _n = (t, n) => t.map((t, r) => {
...
function Sn() {
	let { i18n: e } = gn(g);
	return xn("AboutHeader"), h(m, { children: [h("h1", {
...
var En = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/about/AboutHeader.wrapper.tsx";
function Dn() {
	return h(Tn, { children: h(Sn, {}, void 0, !1, {
		fileName: En,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
