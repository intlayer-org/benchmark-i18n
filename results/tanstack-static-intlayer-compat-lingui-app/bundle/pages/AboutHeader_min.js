...
import { Fragment as m, jsxDEV as h } from "react/jsx-dev-runtime";
var g = {
	key: "messages",
...
var Z = {
	...
	let { locales: c, defaultLocale: l } = A ?? {}, [d, p] = u(e ?? cn ?? t ?? l);
	o(() => {
		e && e !== d && p(e);
	}, [e]), o(() => {
		mn();
	...
	let { i18n: c, defaultComponent: l } = bn(), u = c._(e, n ?? {}, { message: t }), p = r && Object.keys(r).length > 0, m;
	if (p) {
		let e = Sn(Ut(u), r);
		m = f(d, { children: e });
	} else m = u;
...
function Dn() {
	let { i18n: e } = Tn(g);
	return En("AboutHeader"), h(m, { children: [h("h1", {
...
var jn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/about/AboutHeader.wrapper.tsx";
function Mn() {
	return h(An, { children: h(Dn, {}, void 0, !1, {
		fileName: jn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
