...
}, b = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(y).join("") : String(e ?? ""), ee = "translation", x = "enumeration", S = "plural", te = "condition", C = "insertion", ne = "object", re = "array", ie = "markdown", w = "html", T = "gender", E = "select", D = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), O = (e, t, n) => ({
...
})() }), de = (e) => D(S, e), fe = (e, t) => D(E, e, { variable: t }), pe = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
var Te = (e, t, n) => e[L("PluralRules", n).select(t)] ?? e.other, Ee = (e, t) => {
	...
	if (r.nodeType === "plural") {
		let e = r[S];
		return B(Te(e, Number(z(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[x], i = De.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
var V = {
	...
	if (!Re) for (let t = 0; t < (I.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(I.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, H = !1, Be, Ve = () => typeof window > "u" ? ze(V) : (H ||= (Be = ze(V), !0), Be), He = (e, t) => {
	if (t?.isCookieEnabled !== !1 && (H = !1, !Re && I.storage.cookies)) for (let n = 0; n < I.storage.cookies.length; n++) {
	...
	let n = `p${Je}`;
	return qe.set(e, n), n;
}, Xe = 256, U = /* @__PURE__ */ new WeakMap(), Ze = (e) => typeof e == "object" && !!e, Qe = (e, t, n) => `${e}_${t}_${Ye(n)}`, $e = (e, t) => {
	...
	if (!Ze(e)) return n;
	let r = U.get(e);
	return r || (r = /* @__PURE__ */ new Map(), U.set(e, r)), r.size >= Xe && r.clear(), r.set(t, n), n;
}, et = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), G = "\x1B[0m", tt = "\x1B[34m", nt = "\x1B[31m", rt = "\x1B[32m", it = "\x1B[38;5;3m", at = (e) => e, ot = (e, t) => {
...
var lt = () => ({}), ut = /* @__PURE__ */ new Set([
	...
	let r = lt()[e];
	return r ? Pt(r, t, n) : (ft.has(e) || (st({ log: ve })(typeof window > "u" ? `Dictionary ${ct(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), ft.add(e)), dt(e));
}, mt = (e) => {
	...
	if (typeof e == "string") return e;
	if (q(e)) return e.nodeType === "html" ? e[w] : e[ie];
}, vt = (e, t) => {
	if (typeof e == "string") return t;
	if (q(e)) {
		let n = e.nodeType === "html" ? w : ie;
		return {
			...e,
			[n]: t
		};
...
}, St = J, Ct = (e) => J, wt = J, Tt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? J : {
	id: "insertion-plugin",
...
}, Ot = (e, t) => typeof t == "function" && Et.includes(e?.nodeType ?? "") ? (n) => Dt(e, t, n) : t, kt = J, At = J, jt = (e) => J, Y = J, Mt = (e, t = !0) => [
	...
	kt,
	At
].filter((e) => e !== J), Nt = (e, t, n = []) => k(e, {
	...t,
	plugins: n
}), X = /* @__PURE__ */ new WeakSet(), Pt = (e, t, n) => {
...
}, Ht = J, Ut = J, Z = /* @__PURE__ */ new Map(), Wt = (e, t = !0) => {
	...
	return Z.set(n, r), r;
}, Gt = (e, t) => Pt(e, t, Wt(typeof t == "object" && t ? t.locale : t)), Kt = Ve, qt = (e, t) => He(e, {
	...V,
	isCookieEnabled: t
}), Jt = () => {
	typeof window < "u" && (window.intlayer = { enabled: !0 });
}, Yt = (e, t = F?.locales, n = F?.defaultLocale) => {
	...
	get locale() {
		return Kt() ?? F?.defaultLocale;
	},
	setLocale: () => null,
	isCookieEnabled: !0
}), Zt = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: s, isCookieEnabled: u }) => {
	let { locales: f, defaultLocale: p } = F ?? {}, [m, h] = l(() => e ?? Kt() ?? t ?? p), [g, _] = l(e);
	e !== g && (_(e), e && e !== m && h(e)), o(() => {
		Jt();
	}, []);
	let v = i((e) => {
...
}), { defaultLocale: $t, locales: Q } = F ?? {}, en = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { locale: n, setLocale: r, isCookieEnabled: o } = a(Xt) ?? {};
	return {
		locale: n,
		defaultLocale: $t,
		availableLocales: Q,
	...
	let { locale: t } = en(), n = e.map((e) => e.key).join("\0");
	return c(() => tn(t, Object.fromEntries(e.map((e) => [e.key, Gt(e, t)]))), [t, n]);
}, rn = () => {
	try {
	...
	let { i18n: n } = nn(e), { defaultComponent: r } = a(m) ?? {};
	return ln(t, n, r);
}, un = (e) => new Fe({
	...e,
	registry: sn()
