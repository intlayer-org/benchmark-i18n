...
var p = class {
...
}, _ = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(ee).join("") : String(e ?? ""), te = /* @__PURE__ */ new WeakMap(), ne = 0, re = (e) => {
	if (!e) return "base";
	let t = te.get(e);
	if (t) return t;
	ne += 1;
	let n = `p${ne}`;
	return te.set(e, n), n;
}, ie = 256, v = /* @__PURE__ */ new WeakMap(), y = (e) => typeof e == "object" && !!e, ae = (e, t, n) => `${e}_${t}_${re(n)}`, oe = (e, t) => {
	if (!y(e)) return { hit: !1 };
	let n = v.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	if (!y(e)) return n;
	let r = v.get(e);
	return r || (r = /* @__PURE__ */ new Map(), v.set(e, r)), r.size >= ie && r.clear(), r.set(t, n), n;
}, se = "translation", ce = "enumeration", le = "plural", x = "insertion", ue = "object", de = "array", S = "markdown", C = "html", fe = "gender", pe = "select", w = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), T = (e, t) => {
...
}, he = (e, t) => e[me(e, t) ?? "fallback"], ge = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), E = "default", _e = /[^A-Za-z0-9._&=-]/g, ve = /[^A-Za-z0-9._-]/g, ye = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, D = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, ye);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, O = (e) => e === void 0 ? E : typeof e == "string" ? D(e, _e) : Object.keys(e).sort().map((t) => `${D(t, ve)}=${D(String(e[t]), ve)}`).join("&"), be = (e) => Array.isArray(e) ? e.length === 0 ? [E] : e.map(O) : [O(e)], xe = (e, t) => {
	...
	if (!Ce(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? E : xe(be(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Se(e, n, t, s)).map((t) => we(e, t));
...
}, j = "\x1B[0m", ke = "\x1B[34m", Ae = "\x1B[31m", je = "\x1B[32m", Me = "\x1B[38;5;3m", Ne = (e) => e, Pe = (e, t) => {
...
}), M = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? j : n : j}` : e, Ie = (e, t = Me, n = j) => [e].flat().map((e) => M(e, t, n)).join(", ");
M("✗", Ae), M("✓", je), M("⏲", ke);
var Le = { messages: {
	key: "messages",
	...
	yield e;
} : Be(e ? `${e}.${String(n)}` : String(n)) }), Ve = /* @__PURE__ */ new Set(), N = (e, t, n) => {
	let r = Re()[e];
	return r ? dt(r, t, n) : (Ve.has(e) || (Fe({ log: Oe })(typeof window > "u" ? `Dictionary ${Ie(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Ve.add(e)), Be(e));
}, He = 50, P = /* @__PURE__ */ new Map(), Ue = /* @__PURE__ */ new Set(), We = (e) => {
...
function F(e, t, n) {
	let r = t ?? k?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = P.get(a);
...
var qe = (e, t, n) => e[F("PluralRules", n).select(t)] ?? e.other, Je = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, tt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? L : {
...
}, nt = L, rt = L, it = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? L : {
	id: "insertion-plugin",
...
}, at = L, ot = L, st = (e) => L, ct = L, lt = (e, t = !0) => [
	...
	let { locale: r, selector: i } = Ee(t), a = ae(r ?? k.defaultLocale, De(i), n), o = oe(e, a);
...
})() }), gt = (e) => w(le, e), _t = (e, t) => w(pe, e, { variable: t }), vt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "plural") {
		let e = r[le];
		return Y(qe(e, Number(J(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[ce], i = kt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	let i = Y(typeof e == "string" ? Mt[r](e) : e, t, n);
	...
	get messages() {
		...
		for (let t of Ft()) try {
			Object.assign(e, h(N(t, this._locale)));
		} catch {}
		return {
	...
	_(e, t, n) {
		...
		return Nt(this.resolveTemplate(i) ?? a ?? i, o, this._locale, "icu") ?? i;
	}
...
var X = {
	...
	if (!Vt) for (let t = 0; t < (A.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(A.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, Ut = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !Vt && A.storage.cookies) for (let n = 0; n < A.storage.cookies.length; n++) {
...
}, Zt = (e, t = k?.locales, n = k?.defaultLocale) => {
	...
	let e = r(Rt), { locale: t } = en(), n = o(() => {
		let e = new Lt({ locale: t });
		return {
			i18n: e,
			_: e._.bind(e)
		};
	...
	let { i18n: c, defaultComponent: d } = tn(), f = c._(e, n ?? {}, { message: t }), p = r && Object.keys(r).length > 0, m;
	if (p) {
		let e = rn(Pt(f), r);
		m = u(l, { children: e });
	} else m = f;
...
var un = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/settings/ApiAccessSection.wrapper.tsx";
function dn() {
	return f(ln, { children: f(on, {}, void 0, !1, {
		fileName: un,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
