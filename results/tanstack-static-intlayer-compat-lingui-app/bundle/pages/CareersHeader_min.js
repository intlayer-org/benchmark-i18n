...
var h = {
...
}, v = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(ne).join("") : String(e ?? ""), re = /* @__PURE__ */ new WeakMap(), ie = 0, ae = (e) => {
	if (!e) return "base";
	let t = re.get(e);
	if (t) return t;
	ie += 1;
	let n = `p${ie}`;
	return re.set(e, n), n;
}, oe = 256, y = /* @__PURE__ */ new WeakMap(), se = (e) => typeof e == "object" && !!e, ce = (e, t, n) => `${e}_${t}_${ae(n)}`, le = (e, t) => {
...
}, ue = "translation", x = "enumeration", de = "plural", S = "insertion", fe = "object", pe = "array", C = "markdown", w = "html", me = "gender", he = "select", T = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), E = (e, t) => {
...
}, _e = (e, t) => e[ge(e, t) ?? "fallback"], ve = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), D = "default", ye = /[^A-Za-z0-9._&=-]/g, be = /[^A-Za-z0-9._-]/g, xe = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, O = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, xe);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, Se = (e) => e === void 0 ? D : typeof e == "string" ? O(e, ye) : Object.keys(e).sort().map((t) => `${O(t, be)}=${O(String(e[t]), be)}`).join("&"), Ce = (e) => Array.isArray(e) ? e.length === 0 ? [D] : e.map(Se) : [Se(e)], we = (e, t) => {
	...
	if (!Ee(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? D : we(Ce(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Te(e, n, t, s)).map((t) => De(e, t));
...
}, j = "\x1B[0m", Me = "\x1B[34m", Ne = "\x1B[31m", Pe = "\x1B[32m", Fe = "\x1B[38;5;3m", Ie = (e) => e, Le = (e, t) => {
...
}), M = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? j : n : j}` : e, ze = (e, t = Fe, n = j) => [e].flat().map((e) => M(e, t, n)).join(", ");
M("✗", Ne), M("✓", Pe), M("⏲", Me);
var Be = { messages: h }, Ve = () => Be, He = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	...
	let r = Ve()[e];
	return r ? ht(r, t, n) : (We.has(e) || (Re({ log: je })(typeof window > "u" ? `Dictionary ${ze(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), We.add(e)), Ue(e));
...
function N(e, t, n) {
	let r = t ?? k?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = qe.get(a);
...
var Qe = (e, t, n) => e[N("PluralRules", n).select(t)] ?? e.other, $e = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, it = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? L : {
...
}, at = L, ot = (e) => L, st = L, ct = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? L : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: S }], i = e[S], a = {
			...
			transform: (e, n, r) => {
				if (I(e)) return (i) => rt(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, lt = L, ut = L, dt = (e) => L, ft = L, pt = (e, t = !0) => [
	it(e ?? k.defaultLocale, t ? k.defaultLocale : void 0),
	at,
	st,
	ct,
	...
	let { locale: r, selector: i } = ke(t), a = ce(r ?? k.defaultLocale, Ae(i), n), o = le(e, a);
...
})() }), wt = (e) => T(de, e), Tt = (e, t) => T(he, e, { variable: t }), Et = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	let r = e;
	if (r.nodeType === "insertion") return J(r[S], t, n);
	if (r.nodeType === "html") return J(r[w], t, n);
	if (r.nodeType === "plural") {
		let e = r[de];
		return J(Qe(e, Number(q(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[x], i = Lt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	let i = J(typeof e == "string" ? Bt[r](e) : e, t, n);
	...
	get messages() {
		let e = {};
		this._dictionaryContent !== void 0 && Object.assign(e, te(this._dictionaryContent));
		for (let t of Ut()) try {
			Object.assign(e, te(Ge(t, this._locale)));
		} catch {}
		return {
...
}, Xt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? L : {
	id: "insertion-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "insertion",
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: S }], i = e[S], a = {
...
}, Zt = L, Qt = L, X = /* @__PURE__ */ new Map(), $t = (e, t = !0) => {
	let n = `${e ?? k.defaultLocale}_${t}`;
	if (X.has(n)) return X.get(n);
	let r = [
		it(e ?? k.defaultLocale, t ? k.defaultLocale : void 0),
		at,
		ot(e ?? k.defaultLocale),
		st,
		dt(e ?? k.defaultLocale),
		ft,
		lt,
...
var Z = {
	...
	let { defaultLocale: n, locales: r } = k ?? {}, { locale: o, setLocale: s, isCookieEnabled: c } = a(Q) ?? {};
	return {
		locale: o,
		defaultLocale: n,
		availableLocales: r,
...
var wn = (e) => {
	...
	return s(() => {
		let e = new Y({ locale: n }).bindDictionaryContent(t);
		return {
			i18n: e,
			_: e._.bind(e)
		};
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/careers/CareersHeader.tsx";
function Dn() {
	let { i18n: e } = wn(h);
	return m(p, { children: [
		m(En, {}, void 0, !1, {
...
var jn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/careers/CareersHeader.wrapper.tsx";
function Mn() {
