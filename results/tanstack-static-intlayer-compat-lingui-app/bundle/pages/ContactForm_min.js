...
}, _ = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(re).join("") : String(e ?? ""), ie = /* @__PURE__ */ new WeakMap(), ae = 0, oe = (e) => {
	if (!e) return "base";
	let t = ie.get(e);
	if (t) return t;
	ae += 1;
...
}, de = "translation", fe = "enumeration", pe = "plural", b = "insertion", me = "object", he = "array", ge = "markdown", x = "html", S = "gender", C = "select", w = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), T = (e, t) => {
...
}, A = "\x1B[0m", Ne = "\x1B[34m", Pe = "\x1B[31m", Fe = "\x1B[32m", Ie = "\x1B[38;5;3m", Le = (e) => e, Re = (e, t) => {
...
}), j = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? A : n : A}` : e, Be = (e, t = Ie, n = A) => [e].flat().map((e) => j(e, t, n)).join(", ");
j("✗", Pe), j("✓", Fe), j("⏲", Ne);
var Ve = { messages: h }, He = () => Ve, Ue = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	...
	let r = He()[e];
	return r ? ht(r, t, n) : (Ge.has(e) || (ze({ log: Me })(typeof window > "u" ? `Dictionary ${Be(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Ge.add(e)), We(e));
...
var $e = (e, t, n) => e[M("PluralRules", n).select(t)] ?? e.other, et = (e, t) => {
	...
	it(e ?? O.defaultLocale, t ? O.defaultLocale : void 0),
	at,
	st,
	ct,
	...
	let { locale: r, selector: i } = Ae(t), a = le(r ?? O.defaultLocale, je(i), n), o = ue(e, a);
...
})() }), wt = (e) => w(pe, e), Tt = (e, t) => w(C, e, { variable: t }), Et = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	get messages() {
		...
		for (let t of Ht()) try {
			Object.assign(e, ne(Ke(t, this._locale)));
		} catch {}
		return {
...
}, pn = (e, t = O?.locales, n = O?.defaultLocale) => {
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/contact/ContactForm.tsx";
function xn() {
	let { i18n: e } = bn(h), t = s(), n = s(), r = s(), i = s();
	return m("form", {
		className: "space-y-6",
		children: [
			m("div", {
...
var Tn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/contact/ContactForm.wrapper.tsx";
function En() {
	return m(wn, { children: m(xn, {}, void 0, !1, {
		fileName: Tn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
