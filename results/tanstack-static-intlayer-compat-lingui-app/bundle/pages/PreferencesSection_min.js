...
var p = class {
...
}, _ = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(ee).join("") : String(e ?? ""), v = /* @__PURE__ */ new WeakMap(), te = 0, ne = (e) => {
	if (!e) return "base";
	let t = v.get(e);
	if (t) return t;
	te += 1;
...
}, oe = "translation", S = "enumeration", se = "plural", C = "insertion", ce = "object", le = "array", ue = "markdown", w = "html", de = "gender", fe = "select", T = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), E = (e, t) => {
...
}, me = (e, t) => e[pe(e, t) ?? "fallback"], he = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), D = "default", ge = /[^A-Za-z0-9._&=-]/g, O = /[^A-Za-z0-9._-]/g, _e = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, k = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, _e);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, A = (e) => e === void 0 ? D : typeof e == "string" ? k(e, ge) : Object.keys(e).sort().map((t) => `${k(t, O)}=${k(String(e[t]), O)}`).join("&"), ve = (e) => Array.isArray(e) ? e.length === 0 ? [D] : e.map(A) : [A(e)], ye = (e, t) => {
	...
	if (!xe(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? D : ye(ve(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => be(e, n, t, s)).map((t) => Se(e, t));
...
}, N = "\x1B[0m", De = "\x1B[34m", Oe = "\x1B[31m", ke = "\x1B[32m", Ae = "\x1B[38;5;3m", je = (e) => e, Me = (e, t) => {
...
}), P = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? N : n : N}` : e, Pe = (e, t = Ae, n = N) => [e].flat().map((e) => P(e, t, n)).join(", ");
P("✗", Oe), P("✓", ke), P("⏲", De);
var Fe = { messages: {
	key: "messages",
	...
	let r = Ie()[e];
	return r ? dt(r, t, n) : (ze.has(e) || (Ne({ log: Ee })(typeof window > "u" ? `Dictionary ${Pe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), ze.add(e)), Re(e));
...
function F(e, t, n) {
	let r = t ?? j?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = He.get(a);
...
var qe = (e, t, n) => e[F("PluralRules", n).select(t)] ?? e.other, Je = (e, t) => {
	...
	if (typeof e == "string") return e;
	if (I(e)) return e.nodeType === "html" ? e[w] : e[ue];
}, $e = (e, t) => {
	if (typeof e == "string") return t;
	if (I(e)) {
		let n = e.nodeType === "html" ? w : ue;
		return {
			...e,
			[n]: t
		};
	...
	let { locale: r, selector: i } = we(t), a = ie(r ?? j.defaultLocale, Te(i), n), o = ae(e, a);
	if (o.hit) return o.content;
	let s = n ?? lt(r), c = Ce(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
})() }), gt = (e) => T(se, e), _t = (e, t) => T(fe, e, { variable: t }), vt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "enumeration") {
		let e = r[S], i = kt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	get messages() {
		...
		for (let t of Ft()) try {
			Object.assign(e, h(Be(t, this._locale)));
		} catch {}
		return {
...
var X = {
	...
	if (!Vt) for (let t = 0; t < (M.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(M.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, Ut = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !Vt && M.storage.cookies) for (let n = 0; n < M.storage.cookies.length; n++) {
	...
	let { defaultLocale: i, locales: a } = j ?? {}, { locale: o, setLocale: s, isCookieEnabled: c } = r(Z) ?? {};
	return {
		locale: o,
		defaultLocale: i,
		availableLocales: a,
...
an({ locale: "en" });
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/settings/PreferencesSection.tsx";
function on() {
	let e = a();
	return f("section", {
		...
		children: [f("h2", {
			...
			children: [
				...
				f("div", { children: [f("label", {
					...
					children: [
						f("option", { children: i18n._("settings.preferences.english") }, void 0, !1, {
							fileName: $,
							lineNumber: 70,
							columnNumber: 13
						}, this),
						f("option", { children: i18n._("settings.preferences.french") }, void 0, !1, {
							fileName: $,
							lineNumber: 71,
							columnNumber: 13
						}, this),
						f("option", { children: i18n._("settings.preferences.german") }, void 0, !1, {
							fileName: $,
							lineNumber: 72,
							columnNumber: 13
						}, this),
						f("option", { children: i18n._("settings.preferences.spanish") }, void 0, !1, {
							fileName: $,
							lineNumber: 73,
							columnNumber: 13
						}, this),
						f("option", { children: i18n._("settings.preferences.japanese") }, void 0, !1, {
							fileName: $,
							lineNumber: 74,
							columnNumber: 13
						}, this),
						f("option", { children: i18n._("settings.preferences.chinese") }, void 0, !1, {
							fileName: $,
							lineNumber: 75,
							columnNumber: 13
						}, this),
						f("option", { children: i18n._("settings.preferences.arabic") }, void 0, !1, {
							fileName: $,
							lineNumber: 76,
							columnNumber: 13
						}, this)
...
var un = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/settings/PreferencesSection.wrapper.tsx";
function dn() {
