...
var lt = () => ({}), ut = /* @__PURE__ */ new Set([
	...
	let r = lt()[e];
	return r ? Ft(r, t, n) : (ft.has(e) || (st({ log: ve })(typeof window > "u" ? `Dictionary ${ct(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), ft.add(e)), dt(e));
}, mt = (e) => {
...
}, Ot = (e, t) => typeof t == "function" && Et.includes(e?.nodeType ?? "") ? (n) => Dt(e, t, n) : t, kt = J, At = J, jt = (e) => J, Mt = J, Nt = (e, t = !0) => [
	...
	kt,
	At
].filter((e) => e !== J), Pt = (e, t, n = []) => k(e, {
	...t,
	plugins: n
}), Y = /* @__PURE__ */ new WeakSet(), Ft = (e, t, n) => {
...
}, Ut = J, Wt = J, X = /* @__PURE__ */ new Map(), Gt = (e, t = !0) => {
	...
	let { locales: f, defaultLocale: p } = F ?? {}, [m, h] = l(() => e ?? qt() ?? t ?? p), [g, _] = l(e);
	e !== g && (_(e), e && e !== m && h(e)), o(() => {
		Yt();
	}, []);
	let v = i((e) => {
...
}), { defaultLocale: en, locales: Z } = F ?? {}, tn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let { i18n: n } = rn(e), { defaultComponent: r } = a(m) ?? {};
	return ln(t, n, r);
}, un = (e) => new Fe({
	...e,
	registry: sn()
		...
		children: [d("h2", {
			...
			children: [
				...
				f("div", { children: [d("label", {
					...
					children: [
						d("option", { children: e._("settings.preferences.english") }),
						d("option", { children: e._("settings.preferences.french") }),
						d("option", { children: e._("settings.preferences.german") }),
						d("option", { children: e._("settings.preferences.spanish") }),
						d("option", { children: e._("settings.preferences.japanese") }),
						d("option", { children: e._("settings.preferences.chinese") }),
						d("option", { children: e._("settings.preferences.arabic") })
					]
				})] })
			]
		})]
