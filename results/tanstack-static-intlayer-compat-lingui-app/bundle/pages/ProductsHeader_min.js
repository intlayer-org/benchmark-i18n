...
var Ae = (e, t, n) => e[j("PluralRules", n).select(t)] ?? e.other, je = (e, t) => {
...
}, F = t(null), I = /* @__PURE__ */ new WeakMap(), L = 0, Ve = (e) => {
	if (!e) return "base";
	let t = I.get(e);
	if (t) return t;
	L += 1;
	let n = `p${L}`;
	return I.set(e, n), n;
}, He = 256, R = /* @__PURE__ */ new WeakMap(), z = (e) => typeof e == "object" && !!e, Ue = (e, t, n) => `${e}_${t}_${Ve(n)}`, We = (e, t) => {
	if (!z(e)) return { hit: !1 };
	let n = R.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	if (!z(e)) return n;
	let r = R.get(e);
	return r || (r = /* @__PURE__ */ new Map(), R.set(e, r)), r.size >= He && r.clear(), r.set(t, n), n;
}, V = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), H = "default", Ge = /[^A-Za-z0-9._&=-]/g, Ke = /[^A-Za-z0-9._-]/g, qe = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, U = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, qe);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, Je = (e) => e === void 0 ? H : typeof e == "string" ? U(e, Ge) : Object.keys(e).sort().map((t) => `${U(t, Ke)}=${U(String(e[t]), Ke)}`).join("&"), Ye = (e) => Array.isArray(e) ? e.length === 0 ? [H] : e.map(Je) : [Je(e)], Xe = (e, t) => {
	...
	if (!Qe(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? H : Xe(Ye(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Ze(e, n, t, s)).map((t) => $e(e, t));
...
}).join("|") : "", W = "\x1B[0m", rt = "\x1B[34m", it = "\x1B[31m", at = "\x1B[32m", ot = "\x1B[38;5;3m", st = (e) => e, ct = (e, t) => {
...
}), G = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? W : n : W}` : e, ut = (e, t = ot, n = W) => [e].flat().map((e) => G(e, t, n)).join(", ");
G("✗", it), G("✓", at), G("⏲", rt);
var dt = () => ({}), ft = /* @__PURE__ */ new Set([
...
}, Ct = q, wt = (e) => q, Tt = q, Et = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? q : {
	id: "insertion-plugin",
...
}, Dt = q, Ot = q, kt = (e) => q, At = q, jt = (e, t = !0) => [
	St(e ?? k.defaultLocale, t ? k.defaultLocale : void 0),
	Ct,
	Tt,
	Et,
	...
	let { locale: r, selector: i } = tt(t), a = Ue(r ?? k.defaultLocale, nt(i), n), o = We(e, a);
...
}, Gt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? q : {
	id: "insertion-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "insertion",
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: v }], i = e[v], a = {
...
}, Kt = q, qt = q, J = /* @__PURE__ */ new Map(), Jt = (e, t = !0) => {
	let n = `${e ?? k.defaultLocale}_${t}`;
	if (J.has(n)) return J.get(n);
	let r = [
		St(e ?? k.defaultLocale, t ? k.defaultLocale : void 0),
		Ct,
		wt(e ?? k.defaultLocale),
		Tt,
		kt(e ?? k.defaultLocale),
		At,
		Dt,
	...
	return J.set(n, r), r;
}, Yt = (e, t) => Nt(e, t, Jt(typeof t == "object" && t ? t.locale : t)), Y = (e) => {
...
var X = {
	...
	if (!Zt) for (let t = 0; t < (A.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(A.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, $t = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !Zt && A.storage.cookies) for (let n = 0; n < A.storage.cookies.length; n++) {
...
}, cn = (e, t = k?.locales, n = k?.defaultLocale) => {
	...
	locale: en ?? k?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), ln = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: i, disableEditor: a, isCookieEnabled: s }) => {
	let { locales: c, defaultLocale: u } = k ?? {}, [f, p] = l(e ?? en ?? t ?? u);
	o(() => {
		e && e !== f && p(e);
	}, [e]), o(() => {
		sn();
...
}), { defaultLocale: dn, locales: Q } = k ?? {}, fn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let { locale: t } = fn(), n = e.map((e) => e.key).join("\0");
	return s(() => mn(t, Object.fromEntries(e.map((e) => [e.key, Yt(e, t)]))), [t, n]);
}, gn = (t, n) => t.map((t, r) => {
	...
	let { i18n: n } = hn(e), { defaultComponent: r } = a(F) ?? {};
	return _n(t, n, r);
}, yn = (e) => new Be({
	...e,
	registry: Bt()
...
var Dn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/products/ProductsHeader.wrapper.tsx";
function On() {
	return m(En, { children: m(Cn, {}, void 0, !1, {
		fileName: Dn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
