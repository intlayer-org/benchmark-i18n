...
var h = class {
...
}, v = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(te).join("") : String(e ?? ""), ne = /* @__PURE__ */ new WeakMap(), re = 0, ie = (e) => {
	if (!e) return "base";
	let t = ne.get(e);
	if (t) return t;
	re += 1;
	let n = `p${re}`;
	return ne.set(e, n), n;
}, ae = 256, y = /* @__PURE__ */ new WeakMap(), oe = (e) => typeof e == "object" && !!e, se = (e, t, n) => `${e}_${t}_${ie(n)}`, ce = (e, t) => {
	...
	if (!oe(e)) return n;
	let r = y.get(e);
	return r || (r = /* @__PURE__ */ new Map(), y.set(e, r)), r.size >= ae && r.clear(), r.set(t, n), n;
}, le = "translation", x = "enumeration", ue = "plural", S = "insertion", de = "object", fe = "array", pe = "markdown", C = "html", me = "gender", he = "select", w = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), T = (e, t) => {
...
}, _e = (e, t) => e[ge(e, t) ?? "fallback"], ve = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), E = "default", ye = /[^A-Za-z0-9._&=-]/g, be = /[^A-Za-z0-9._-]/g, xe = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, D = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, xe);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, Se = (e) => e === void 0 ? E : typeof e == "string" ? D(e, ye) : Object.keys(e).sort().map((t) => `${D(t, be)}=${D(String(e[t]), be)}`).join("&"), Ce = (e) => Array.isArray(e) ? e.length === 0 ? [E] : e.map(Se) : [Se(e)], we = (e, t) => {
	...
	if (!Ee(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? E : we(Ce(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Te(e, n, t, s)).map((t) => De(e, t));
...
}, A = "\x1B[0m", Me = "\x1B[34m", Ne = "\x1B[31m", Pe = "\x1B[32m", Fe = "\x1B[38;5;3m", Ie = (e) => e, Le = (e, t) => {
...
}), j = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? A : n : A}` : e, ze = (e, t = Fe, n = A) => [e].flat().map((e) => j(e, t, n)).join(", ");
j("✗", Ne), j("✓", Pe), j("⏲", Me);
var Be = {
	key: "messages",
...
}, Ve = { messages: Be }, He = () => Ve, Ue = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), We = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Ue.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : We(e ? `${e}.${String(n)}` : String(n)) }), Ge = /* @__PURE__ */ new Set(), Ke = (e, t, n) => {
	let r = He()[e];
	return r ? gt(r, t, n) : (Ge.has(e) || (Re({ log: je })(typeof window > "u" ? `Dictionary ${ze(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Ge.add(e)), We(e));
...
function M(e, t, n) {
	let r = t ?? O?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = Je.get(a);
...
var $e = (e, t, n) => e[M("PluralRules", n).select(t)] ?? e.other, et = (e, t) => {
	...
	if (typeof e == "string") return e;
	if (F(e)) return e.nodeType === "html" ? e[C] : e[pe];
}, rt = (e, t) => {
	if (typeof e == "string") return t;
	if (F(e)) {
		let n = e.nodeType === "html" ? C : pe;
		return {
			...e,
			[n]: t
		};
	...
	canHandle: () => !1,
	transform: (e) => e
}, at = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? I : {
...
}, ot = I, st = (e) => I, ct = I, lt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? I : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: S }], i = e[S], a = {
			...
			transform: (e, n, r) => {
				if (F(e)) return (i) => it(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, ut = I, dt = I, ft = (e) => I, pt = I, mt = (e, t = !0) => [
	at(e ?? O.defaultLocale, t ? O.defaultLocale : void 0),
	ot,
	ct,
	lt,
	ft(e ?? O.defaultLocale),
	pt,
	ut,
	dt
], ht = (e, t, n = []) => T(e, {
	...
	let { locale: r, selector: i } = ke(t), a = se(r ?? O.defaultLocale, Ae(i), n), o = ce(e, a);
	if (o.hit) return o.content;
	let s = n ?? mt(r), c = Oe(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
})() }), Tt = (e) => w(ue, e), Et = (e, t) => w(he, e, { variable: t }), Dt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	return String(e);
}, Bt = (e, t = {}, n = "en") => e.replace(/\{\{\s*([^{}]+?)\s*\}\}/g, (e, n) => {
	let r = G(t, n);
	...
	if (r.nodeType === "plural") {
		let e = r[ue];
		return q($e(e, Number(K(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[x], i = Rt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	let i = q(typeof e == "string" ? Vt[r](e) : e, t, n);
	...
	get messages() {
		let e = {};
		this._dictionaryContent !== void 0 && Object.assign(e, ee(this._dictionaryContent));
		for (let t of Wt()) try {
			Object.assign(e, ee(Ke(t, this._locale)));
		} catch {}
		return {
...
}, Kt = t(null), qt = ({ children: e, value: t, additionalProps: n }) => {
...
}, Qt = I, $t = I, Y = /* @__PURE__ */ new Map(), en = (e, t = !0) => {
	let n = `${e ?? O.defaultLocale}_${t}`;
	if (Y.has(n)) return Y.get(n);
	let r = [
		at(e ?? O.defaultLocale, t ? O.defaultLocale : void 0),
		ot,
		st(e ?? O.defaultLocale),
		ct,
		ft(e ?? O.defaultLocale),
		pt,
		ut,
	...
	return Y.set(n, r), r;
}, tn = (e, t) => gt(e, t, en(typeof t == "object" && t ? t.locale : t)), nn = (e) => {
...
}, an = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false";
...
var X = {
	...
	if (!an) for (let t = 0; t < (k.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(k.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, sn = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !an && k.storage.cookies) for (let n = 0; n < k.storage.cookies.length; n++) {
		let { name: r, attributes: i } = k.storage.cookies[n];
		try {
			t?.setCookieStore && t.setCookieStore(r, e, {
				...i,
				expires: nn(i.expires)
			});
		} catch {
			try {
				t?.setCookieString && t.setCookieString(r, rn(r, e, i));
			} catch {}
		}
	}
}, cn = on(X), Z = (e, t) => sn(e, {
...
}, mn = (e, t = O?.locales, n = O?.defaultLocale) => {
	...
	locale: cn ?? O?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), hn = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: i, disableEditor: a, isCookieEnabled: s }) => {
	let { locales: c, defaultLocale: u } = O ?? {}, [f, p] = l(e ?? cn ?? t ?? u);
	o(() => {
		e && e !== f && p(e);
	}, [e]), o(() => {
		pn();
	...
	return s(() => tn(e, i), [e.key, o]);
}, vn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { defaultLocale: n, locales: r } = O ?? {}, { locale: o, setLocale: s, isCookieEnabled: c } = a(Q) ?? {};
	return {
		locale: o,
		defaultLocale: n,
		availableLocales: r,
	...
	let e = a(Kt), { locale: t } = vn(), n = s(() => {
		let e = new J({ locale: t });
		return {
			i18n: e,
			_: e._.bind(e)
		};
...
}), Sn = ({ id: e, message: t, values: n, components: r, formats: i, comment: a, render: o, component: s }) => {
	let { i18n: c, defaultComponent: l } = yn(), f = c._(e, n ?? {}, { message: t }), p = r && Object.keys(r).length > 0, m;
	if (p) {
		let e = xn(Ut(f), r);
		m = d(u, { children: e });
	} else m = f;
...
Cn({ locale: "en" });
var wn = (e) => {
	let t = _n(e), { locale: n } = vn();
	return s(() => {
		let e = new J({ locale: n }).bindDictionaryContent(t);
		return {
			i18n: e,
			_: e._.bind(e)
		};
	}, [n, t]);
}, Tn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/MockBanner.tsx", En = () => {
	let { i18n: e } = wn(Be);
	return m("div", {
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/products/ProductsHeader.tsx";
function Dn() {
	return m(p, { children: [
		m(En, {}, void 0, !1, {
			fileName: $,
...
var kn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/scripts/Wrapper.tsx";
...
var jn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/products/ProductsHeader.wrapper.tsx";
function Mn() {
	return m(An, { children: m(Dn, {}, void 0, !1, {
		fileName: jn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
