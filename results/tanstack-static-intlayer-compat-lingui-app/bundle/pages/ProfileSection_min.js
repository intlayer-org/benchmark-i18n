...
var Be = { messages: h }, Ve = () => Be, He = /* @__PURE__ */ new Set([
	...
	let r = Ve()[e];
	return r ? gt(r, t, n) : (We.has(e) || (Re({ log: je })(typeof window > "u" ? `Dictionary ${ze(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), We.add(e)), Ue(e));
...
var Qe = (e, t, n) => e[N("PluralRules", n).select(t)] ?? e.other, $e = (e, t) => {
...
})() }), Tt = (e) => T(de, e), Et = (e, t) => T(he, e, { variable: t }), Dt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "html") return q(r[w], t, n);
...
var X = {
	...
	if (!an) for (let t = 0; t < (A.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(A.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, sn = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !an && A.storage.cookies) for (let n = 0; n < A.storage.cookies.length; n++) {
...
}, hn = (e, t = k?.locales, n = k?.defaultLocale) => {
	...
	let { locale: n, variant: r } = a(Z) ?? {}, i = t ?? n, o = typeof i == "object" && i ? `${i.locale ?? ""}|${Ae(i)}` : i;
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/settings/ProfileSection.tsx";
function Tn() {
	let { i18n: e } = wn(h), t = s(), n = s();
	return m("section", {
...
var kn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/settings/ProfileSection.wrapper.tsx";
function An() {
	return m(On, { children: m(Tn, {}, void 0, !1, {
		fileName: kn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
