...
M("✗", Me), M("✓", Ne), M("⏲", je);
var ze = { messages: m }, N = () => ze, Be = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	...
	let r = N()[e];
	return r ? mt(r, t, n) : (He.has(e) || (Le({ log: Ae })(typeof window > "u" ? `Dictionary ${Re(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), He.add(e)), Ve(e));
...
function P(e, t, n) {
	let r = t ?? k?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = Ge.get(a);
...
var Xe = (e, t, n) => e[P("PluralRules", n).select(t)] ?? e.other, Ze = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, it = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? I : {
...
}, at = I, ot = (e) => I, st = I, ct = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? I : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: S }], i = e[S], a = {
			...
			transform: (e, n, r) => {
				if (F(e)) return (i) => rt(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, L = I, lt = I, ut = (e) => I, dt = I, ft = (e, t = !0) => [
	it(e ?? k.defaultLocale, t ? k.defaultLocale : void 0),
	at,
	st,
	ct,
	ut(e ?? k.defaultLocale),
	dt,
	L,
	lt
], pt = (e, t, n = []) => T(e, {
	...
	"track",
	"wbr"
]), xt = /<(\/)?([a-zA-Z][a-zA-Z0-9.-]*)\s*((?:[^\n]|\n(?!\n))*?)(\/?)>/g, St = (e) => {
	let t = [], n = [];
	for (let r of e.matchAll(xt)) {
...
})() }), Ct = (e) => w(ue, e), wt = (e, t) => w(he, e, { variable: t }), Tt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	return String(e);
}, Rt = (e, t = {}, n = "en") => e.replace(/\{\{\s*([^{}]+?)\s*\}\}/g, (e, n) => {
	let r = K(t, n);
	return r === void 0 ? e : String(r);
}).replace(/\{\s*([\w.]+)\s*,\s*(\w+)\s*(?:,\s*([^}]+?)\s*)?\}/g, (e, r, i, a) => {
	let o = K(t, r);
	return o === void 0 ? e : Lt(o, i, a, n);
}).replace(/\{\s*([\w.]+)\s*\}/g, (e, n) => {
	let r = K(t, n);
	return r === void 0 ? e : String(r);
	...
	if (r.nodeType === "enumeration") {
		let e = r[le], i = It.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	let i = J(typeof e == "string" ? zt[r](e) : e, t, n);
	...
	get messages() {
		...
		for (let t of Ht()) try {
			Object.assign(e, _(Ue(t, this._locale)));
		} catch {}
		return {
	...
	_(e, t, n) {
		...
		return Bt(this.resolveTemplate(i) ?? a ?? i, o, this._locale, "icu") ?? i;
	}
...
}, Wt = t(null), Gt = ({ children: e, value: t, additionalProps: n }) => {
...
}, Yt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? I : {
	id: "insertion-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "insertion",
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: S }], i = e[S], a = {
...
}, Xt = I, Zt = I, X = /* @__PURE__ */ new Map(), Qt = (e, t = !0) => {
	...
	return X.set(n, r), r;
}, $t = (e, t) => mt(e, t, Qt(typeof t == "object" && t ? t.locale : t)), en = (e) => {
...
var Z = {
	...
	if (!nn) for (let t = 0; t < (A.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(A.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, an = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !nn && A.storage.cookies) for (let n = 0; n < A.storage.cookies.length; n++) {
...
}, pn = (e, t = k?.locales, n = k?.defaultLocale) => {
	...
	let { locale: n, variant: r } = a(Q) ?? {}, i = t ?? n, o = typeof i == "object" && i ? `${i.locale ?? ""}|${O(i)}` : i;
	return s(() => $t(e, i), [e.key, o]);
}, _n = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	return e || n;
}, yn = ({ i18n: e, defaultComponent: t, children: n }) => {
	let r = (e) => ({
		i18n: e,
		_: e._.bind(e),
		defaultComponent: t
	...
	let i = bn(t.children, n), a = n[t.tag];
...
}), xn = ({ id: e, message: t, values: n, components: r, formats: i, comment: a, render: o, component: s }) => {
	let { i18n: c, defaultComponent: l } = vn(), f = c._(e, n ?? {}, { message: t }), p = r && Object.keys(r).length > 0, m;
	if (p) {
		let e = bn(Vt(f), r);
		m = d(u, { children: e });
	} else m = f;
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/home/ResultsTable.tsx";
function wn() {
	let { i18n: e } = Cn(m);
...
var On = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/home/ResultsTable.wrapper.tsx";
function kn() {
