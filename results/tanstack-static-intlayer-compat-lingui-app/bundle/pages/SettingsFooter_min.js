...
var f = class {
...
}, _ = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(g).join("") : String(e ?? ""), v = /* @__PURE__ */ new WeakMap(), y = 0, ee = (e) => {
	if (!e) return "base";
	let t = v.get(e);
	if (t) return t;
	y += 1;
	let n = `p${y}`;
	return v.set(e, n), n;
}, te = 256, b = /* @__PURE__ */ new WeakMap(), ne = (e) => typeof e == "object" && !!e, re = (e, t, n) => `${e}_${t}_${ee(n)}`, ie = (e, t) => {
...
}, ae = "translation", S = "enumeration", C = "plural", w = "insertion", oe = "object", se = "array", ce = "markdown", T = "html", le = "gender", ue = "select", E = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), D = (e, t) => {
...
}, fe = (e, t) => e[de(e, t) ?? "fallback"], pe = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), O = "default", me = /[^A-Za-z0-9._&=-]/g, he = /[^A-Za-z0-9._-]/g, ge = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, k = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, ge);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, _e = (e) => e === void 0 ? O : typeof e == "string" ? k(e, me) : Object.keys(e).sort().map((t) => `${k(t, he)}=${k(String(e[t]), he)}`).join("&"), A = (e) => Array.isArray(e) ? e.length === 0 ? [O] : e.map(_e) : [_e(e)], ve = (e, t) => {
	...
	if (!be(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? O : ve(A(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => ye(e, n, t, s)).map((t) => xe(e, t));
...
}, N = "\x1B[0m", Ee = "\x1B[34m", De = "\x1B[31m", Oe = "\x1B[32m", ke = "\x1B[38;5;3m", Ae = (e) => e, je = (e, t) => {
...
}), P = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? N : n : N}` : e, Ne = (e, t = ke, n = N) => [e].flat().map((e) => P(e, t, n)).join(", ");
P("✗", De), P("✓", Oe), P("⏲", Ee);
var Pe = { messages: {
	key: "messages",
	...
	yield e;
} : Le(e ? `${e}.${String(n)}` : String(n)) }), Re = /* @__PURE__ */ new Set(), ze = (e, t, n) => {
	let r = Fe()[e];
	return r ? lt(r, t, n) : (Re.has(e) || (Me({ log: Te })(typeof window > "u" ? `Dictionary ${Ne(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Re.add(e)), Le(e));
...
var Ke = (e, t, n) => e[F("PluralRules", n).select(t)] ?? e.other, qe = (e, t) => {
	...
	if (typeof e == "string") return e;
	if (L(e)) return e.nodeType === "html" ? e[T] : e[ce];
}, Ze = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, $e = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? R : {
...
}, et = R, tt = R, nt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? R : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: w }], i = e[w], a = {
			...
			transform: (e, n, r) => {
				if (L(e)) return (i) => Qe(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, rt = R, it = R, at = (e) => R, ot = R, st = (e, t = !0) => [
	$e(e ?? j.defaultLocale, t ? j.defaultLocale : void 0),
	et,
	tt,
	nt,
	at(e ?? j.defaultLocale),
	ot,
	rt,
	it
], ct = (e, t, n = []) => D(e, {
	...
	let { locale: r, selector: i } = Ce(t), a = re(r ?? j.defaultLocale, we(i), n), o = ie(e, a);
	if (o.hit) return o.content;
	let s = n ?? st(r), c = Se(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
	...
	let n;
	if (typeof e == "function" ? n = e() : typeof e.then == "function" && (n = async () => V(await e)), typeof n == "string") return V(n);
	try {
...
})() }), mt = (e) => E(C, e), ht = (e, t) => E(ue, e, { variable: t }), gt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	let r = e;
	if (r.nodeType === "insertion") return X(r[w], t, n);
	if (r.nodeType === "html") return X(r[T], t, n);
	if (r.nodeType === "plural") {
		let e = r[C];
		return X(Ke(e, Number(Y(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[S], i = Dt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[ue], i = Y(t, typeof r.variable == "string" ? r.variable : "value");
		return X(qe(e, String(i ?? "")), t, n);
	}
	...
	let i = X(typeof e == "string" ? At[r](e) : e, t, n);
	...
	_(e, t, n) {
		...
		return jt(this.resolveTemplate(i) ?? a ?? i, o, this._locale, "icu") ?? i;
	}
...
var Z = {
...
}), Qt = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let e = r(It), { locale: t } = Qt(), n = a(() => {
		let e = new Ft({ locale: t });
		return {
			i18n: e,
			_: e._.bind(e)
		};
...
}), nn = ({ id: e, message: t, values: n, components: r, formats: i, comment: a, render: o, component: s }) => {
	let { i18n: u, defaultComponent: d } = $t(), f = u._(e, n ?? {}, { message: t }), p = r && Object.keys(r).length > 0, m;
	if (p) {
		let e = tn(Mt(f), r);
		m = l(c, { children: e });
	} else m = f;
...
var ln = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/settings/SettingsFooter.wrapper.tsx";
function un() {
