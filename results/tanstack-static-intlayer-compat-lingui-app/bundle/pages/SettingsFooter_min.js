...
})() }), fe = (e) => x(v, e), pe = (e, t) => x(oe, e, { variable: t }), me = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
function N(e, t, n) {
	let r = t ?? j?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = ke.get(a);
...
var Pe = (e, t, n) => e[N("PluralRules", n).select(t)] ?? e.other, Fe = (e, t) => {
	...
	if (r.nodeType === "enumeration") {
		let e = r[te], i = P.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
}, He = t(null), R = /* @__PURE__ */ new WeakMap(), z = 0, Ue = (e) => {
	if (!e) return "base";
	let t = R.get(e);
	if (t) return t;
	z += 1;
...
var pt = () => ({}), mt = /* @__PURE__ */ new Set([
	...
	let r = pt()[e];
	return r ? Pt(r, t, n) : (gt.has(e) || (dt({ log: De })(typeof window > "u" ? `Dictionary ${ft(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), gt.add(e)), ht(e));
}, vt = (e) => {
	...
	let { locale: r, selector: i } = rt(t), a = Ge(r ?? j.defaultLocale, it(i), n), o = Ke(e, a);
...
}, Xt = (e, t = j?.locales, n = j?.defaultLocale) => {
...
}), rn = ({ id: e, message: t, values: n, components: r, formats: i, comment: a, render: o, component: s }) => {
...
var un = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/settings/SettingsFooter.wrapper.tsx";
function dn() {
