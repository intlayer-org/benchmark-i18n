...
}, _ = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(ee).join("") : String(e ?? ""), te = "translation", ne = "enumeration", v = "plural", y = "insertion", re = "object", ie = "array", ae = "markdown", b = "html", oe = "gender", se = "select", x = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), S = (e, t) => {
...
})() }), pe = (e) => x(v, e), me = (e, t) => x(se, e, { variable: t }), he = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
function N(e, t, n) {
	let r = t ?? j?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = Ae.get(a);
...
var Fe = (e, t, n) => e[N("PluralRules", n).select(t)] ?? e.other, Ie = (e, t) => {
	...
	if (r.nodeType === "plural") {
		let e = r[v];
		return L(Fe(e, Number(I(t, "count") ?? 1), n), t, n);
	}
	...
	if (r.nodeType === "select") {
		let e = r[se], i = I(t, typeof r.variable == "string" ? r.variable : "value");
		return L(Ie(e, String(i ?? "")), t, n);
	}
	...
	let i = L(typeof e == "string" ? ze[r](e) : e, t, n);
...
}, Ue = t(null), R = /* @__PURE__ */ new WeakMap(), z = 0, We = (e) => {
	if (!e) return "base";
	let t = R.get(e);
	if (t) return t;
	z += 1;
...
}, Ze = (e) => e === void 0 ? W : typeof e == "string" ? G(e, Je) : Object.keys(e).sort().map((t) => `${G(t, Ye)}=${G(String(e[t]), Ye)}`).join("&"), Qe = (e) => Array.isArray(e) ? e.length === 0 ? [W] : e.map(Ze) : [Ze(e)], $e = (e, t) => {
	...
	if (!tt(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? W : $e(Qe(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => et(e, n, t, s)).map((t) => nt(e, t));
...
var mt = () => ({}), ht = /* @__PURE__ */ new Set([
	...
	let r = mt()[e];
	return r ? Ft(r, t, n) : (_t.has(e) || (ft({ log: Oe })(typeof window > "u" ? `Dictionary ${pt(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), _t.add(e)), gt(e));
}, yt = (e) => {
	...
	if (typeof e == "string") return e;
	if (J(e)) return e.nodeType === "html" ? e[b] : e[ae];
}, Ct = (e, t) => {
	if (typeof e == "string") return t;
	if (J(e)) {
		let n = e.nodeType === "html" ? b : ae;
		return {
			...e,
			[n]: t
		};
	...
	Tt(e ?? j.defaultLocale, t ? j.defaultLocale : void 0),
	Et,
	Dt,
	Ot,
	jt(e ?? j.defaultLocale),
	Mt,
	kt,
	At
], Pt = (e, t, n = []) => S(e, {
	...
	let { locale: r, selector: i } = it(t), a = Ke(r ?? j.defaultLocale, at(i), n), o = qe(e, a);
...
var X = {
	...
	if (!Ht) for (let t = 0; t < (M.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(M.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, Wt = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !Ht && M.storage.cookies) for (let n = 0; n < M.storage.cookies.length; n++) {
...
}, Zt = (e, t = j?.locales, n = j?.defaultLocale) => {
	...
	let { locales: u, defaultLocale: d } = j ?? {}, [f, p] = s(e ?? Z ?? t ?? d);
	i(() => {
		e && e !== f && p(e);
	}, [e]), i(() => {
		Xt();
	...
	let { defaultLocale: i, locales: a } = j ?? {}, { locale: o, setLocale: s, isCookieEnabled: c } = r(Q) ?? {};
	return {
		locale: o,
		defaultLocale: i,
		availableLocales: a,
...
}), an = ({ id: e, message: t, values: n, components: r, formats: i, comment: a, render: o, component: s }) => {
...
on({ locale: "en" });
var sn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/MockBanner.tsx", cn = () => {
	let { i18n: e } = tn();
	return f("div", {
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/pricing/PricingHeader.tsx";
function ln() {
	return f(d, { children: [f(cn, {}, void 0, !1, {
		fileName: $,
		lineNumber: 7,
		columnNumber: 7
	}, this), f("div", {
...
var pn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/pricing/PricingHeader.wrapper.tsx";
function mn() {
	return f(fn, { children: f(ln, {}, void 0, !1, {
		fileName: pn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
