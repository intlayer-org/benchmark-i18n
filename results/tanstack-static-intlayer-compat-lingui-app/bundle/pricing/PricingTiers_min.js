...
var p = {
...
}, g = (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map(re).join("") : String(e ?? ""), ie = /* @__PURE__ */ new WeakMap(), ae = 0, oe = (e) => {
	if (!e) return "base";
	let t = ie.get(e);
	if (t) return t;
	ae += 1;
	let n = `p${ae}`;
	return ie.set(e, n), n;
}, se = 256, _ = /* @__PURE__ */ new WeakMap(), v = (e) => typeof e == "object" && !!e, ce = (e, t, n) => `${e}_${t}_${oe(n)}`, le = (e, t) => {
	if (!v(e)) return { hit: !1 };
	let n = _.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	if (!v(e)) return n;
	let r = _.get(e);
	return r || (r = /* @__PURE__ */ new Map(), _.set(e, r)), r.size >= se && r.clear(), r.set(t, n), n;
}, ue = "translation", de = "enumeration", fe = "plural", b = "insertion", pe = "object", me = "array", he = "markdown", x = "html", ge = "gender", _e = "select", S = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), C = (e, t) => {
...
}, ye = (e, t) => e[ve(e, t) ?? "fallback"], be = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), w = "default", xe = /[^A-Za-z0-9._&=-]/g, Se = /[^A-Za-z0-9._-]/g, Ce = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, T = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, Ce);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, E = (e) => e === void 0 ? w : typeof e == "string" ? T(e, xe) : Object.keys(e).sort().map((t) => `${T(t, Se)}=${T(String(e[t]), Se)}`).join("&"), D = (e) => Array.isArray(e) ? e.length === 0 ? [w] : e.map(E) : [E(e)], we = (e, t) => {
	...
	if (!Ee(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? w : we(D(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Te(e, n, t, s)).map((t) => De(e, t));
...
M("✗", Me), M("✓", Ne), M("⏲", je);
var ze = { messages: p }, N = () => ze, Be = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), P = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Be.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : P(e ? `${e}.${String(n)}` : String(n)) }), Ve = /* @__PURE__ */ new Set(), He = (e, t, n) => {
	let r = N()[e];
	return r ? pt(r, t, n) : (Ve.has(e) || (Le({ log: Ae })(typeof window > "u" ? `Dictionary ${Re(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Ve.add(e)), P(e));
...
function F(e, t, n) {
	let r = t ?? k?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = We.get(a);
...
var Ye = (e, t, n) => e[F("PluralRules", n).select(t)] ?? e.other, Xe = (e, t) => {
	...
	if (typeof e == "string") return e;
	if (I(e)) return e.nodeType === "html" ? e[x] : e[he];
}, tt = (e, t) => {
	if (typeof e == "string") return t;
	if (I(e)) {
		let n = e.nodeType === "html" ? x : he;
		return {
			...e,
			[n]: t
		};
	...
	rt(e ?? k.defaultLocale, t ? k.defaultLocale : void 0),
	it,
	ot,
	st,
	lt(e ?? k.defaultLocale),
	ut,
	R,
	ct
], ft = (e, t, n = []) => C(e, {
	...
	let { locale: r, selector: i } = ke(t), a = ce(r ?? k.defaultLocale, O(i), n), o = le(e, a);
	if (o.hit) return o.content;
	let s = n ?? dt(r), c = Oe(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
})() }), St = (e) => S(fe, e), Ct = (e, t) => S(_e, e, { variable: t }), wt = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "enumeration") {
		let e = r[de], i = Ft.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[_e], i = J(t, typeof r.variable == "string" ? r.variable : "value");
	...
	get messages() {
		let e = {};
		this._dictionaryContent !== void 0 && Object.assign(e, ne(this._dictionaryContent));
		for (let t of Bt()) try {
			Object.assign(e, ne(He(t, this._locale)));
		} catch {}
		return {
...
var Z = {
	...
	let { locales: c, defaultLocale: ee } = k ?? {}, [d, f] = l(e ?? an ?? t ?? ee);
	o(() => {
		e && e !== d && f(e);
	}, [e]), o(() => {
		dn();
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/pricing/PricingTiers.tsx";
function bn() {
	let { i18n: e } = yn(p), t = [
		{
			name: e._({
...
var wn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-lingui-app/src/components/pages/pricing/PricingTiers.wrapper.tsx";
function Tn() {
	return f(Cn, { children: f(bn, {}, void 0, !1, {
		fileName: wn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
