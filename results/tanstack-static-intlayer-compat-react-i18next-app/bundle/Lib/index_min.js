...
var u = /* @__PURE__ */ new WeakMap(), d = 0, f = (e) => {
	if (!e) return "base";
	let t = u.get(e);
	if (t) return t;
	d += 1;
	let n = `p${d}`;
	return u.set(e, n), n;
}, p = 256, m = /* @__PURE__ */ new WeakMap(), h = (e) => typeof e == "object" && !!e, g = (e, t, n) => `${e}_${t}_${f(n)}`, _ = (e, t) => {
	if (!h(e)) return { hit: !1 };
	let n = m.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, y = "translation", b = "enumeration", x = "plural", ee = "condition", S = "insertion", te = "object", ne = "array", re = "markdown", C = "html", ie = "gender", ae = "select", w = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), T = (e, t) => {
...
}, se = (e, t) => e[oe(e, t) ?? "fallback"], ce = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), E = {
	locales: [
		"en",
		"fr",
		"es",
...
}, k = "\x1B[0m", le = "\x1B[34m", ue = "\x1B[31m", de = "\x1B[32m", fe = "\x1B[35m", pe = "\x1B[38;5;3m", A = "\x1B[36m", me = (e) => e, he = (e, t) => {
...
}), M = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? k : n : k}` : e, ge = (e, t = pe, n = k) => [e].flat().map((e) => M(e, t, n)).join(", ");
M("✗", ue), M("✓", de), M("⏲", le);
var _e = { index: s }, N = () => _e, ve = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), P = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : ve.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : P(e ? `${e}.${String(n)}` : String(n)) }), F = /* @__PURE__ */ new Set(), I = (e, t, n) => {
	let r = N()[e];
	return r ? qe(r, t, n) : (F.has(e) || (j({ log: O })(typeof window > "u" ? `Dictionary ${ge(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), F.add(e)), P(e));
}, ye = 50, L = /* @__PURE__ */ new Map(), be = /* @__PURE__ */ new Set(), xe = (e) => {
...
function R(e, t, n) {
	let r = t ?? E?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = L.get(a);
...
var we = (e, t, n) => e[R("PluralRules", n).select(t)] ?? e.other, Te = (e, t) => {
	...
	if (z(e)) return e.nodeType === "html" ? e[C] : e[re];
}, Ae = (e, t) => {
	if (typeof e == "string") return t;
	if (z(e)) {
		let n = e.nodeType === "html" ? C : re;
		return {
			...e,
			[n]: t
		};
...
}, Ne = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? B : {
...
}, Pe = B, Fe = (e) => B, Ie = B, Le = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? B : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: S }], i = e[S], a = {
			...
			transform: (e, n, r) => {
				if (z(e)) return (i) => je(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
	...
	let i = e?.nodeType;
	if (typeof t != "function" || !i || !Re.includes(i)) return t;
...
}, Be = (e, t) => typeof t == "function" && Re.includes(e?.nodeType ?? "") ? (n) => ze(e, t, n) : t, Ve = B, He = B;
process.env.INTLAYER_OPTIMIZED_NESTING;
var Ue = (e) => B, We = B, Ge = (e, t = !0) => [
	Ne(e ?? E.defaultLocale, t ? E.defaultLocale : void 0),
	Pe,
	Fe(e ?? E.defaultLocale),
	Ie,
	Le,
	Ue(e ?? E.defaultLocale),
	We,
	Ve,
	He
].filter((e) => e !== B), Ke = (e, t, n = []) => T(e, {
	...t,
	plugins: n
}), V = /* @__PURE__ */ new WeakSet(), qe = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = g(r ?? E.defaultLocale, "", n), o = _(e, a);
	...
	if (r.nodeType === "plural") {
		let e = r[x];
		return W(we(e, Number(U(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[b], i = Ye.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[ae], i = U(t, typeof r.variable == "string" ? r.variable : "value");
		return W(Te(e, String(i ?? "")), t, n);
	}
...
}, rt = (e, t = E?.locales, n = E?.defaultLocale) => {
...
var J = {
	...
	if (!ot) for (let t = 0; t < (D.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(D.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, ct = !1, lt, ut = () => typeof window > "u" ? st(J) : (ct ||= (lt = st(J), !0), lt), dt = (e, t) => {
	if (t?.isCookieEnabled !== !1 && (ct = !1, !ot && D.storage.cookies)) for (let n = 0; n < D.storage.cookies.length; n++) {
	...
	j({ log: O })(`${M(e, A)}: the ${M("`resources`", A)} option is ignored when using ${M("@intlayer/i18next", fe)} — translations are served from the compiled intlayer dictionaries instead. Remove the resource imports and the ${M("`resources`", A)} option to reduce your bundle size.`);
}, Y = (e = {}) => {
	e.resources !== void 0 && mt("createInstance");
	let t = E, n = e.lng ?? t?.defaultLocale ?? "en", r = e.defaultNS ?? (Array.isArray(e.ns) ? e.ns[0] : e.ns) ?? "translation", i = /* @__PURE__ */ new Map(), a = !1, o = (e, ...t) => {
		i.get(e)?.forEach((e) => {
			e(...t);
		});
	}, s = () => ({
		...
		async init(e, t) {
			...
			i.resources !== void 0 && mt("i18next.init"), i.lng && (n = i.lng), i.defaultNS ? r = i.defaultNS : i.ns && (r = Array.isArray(i.ns) ? i.ns[0] : i.ns), a = !0, o("initialized", i);
			let s = l.t.bind(l);
...
var ht = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	get locale() {
		return gt() ?? E?.defaultLocale;
	},
	setLocale: () => null,
	isCookieEnabled: !0
}), bt = ({ locale: e, defaultLocale: t, variant: r, children: s, setLocale: l, disableEditor: u, isCookieEnabled: d }) => {
	let { locales: f, defaultLocale: p } = E ?? {}, [m, h] = o(() => e ?? gt() ?? t ?? p), [g, _] = o(e);
	e !== g && (_(e), e && e !== m && h(e)), i(() => {
		vt();
	}, []);
	let v = n((e) => {
...
}), { defaultLocale: St, locales: Z } = E ?? {}, Ct = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { locale: i, setLocale: a, isCookieEnabled: o } = r(yt) ?? {};
	return {
		locale: i,
		defaultLocale: St,
		availableLocales: Z,
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: o } = Ct(), s = t?.keyPrefix, { translate: c, i18n: l } = a(() => ht({
		locale: r,
		setLocale: i,
		availableLocales: o ?? [],
		namespace: n,
...
}, Tt = ({ children: e, i18n: t }) => (t !== void 0 && j({ log: O })(`${M("I18nextProvider", A)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), c(xt, { children: e }));
