...
var I = {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), gt = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: o, isCookieEnabled: c }) => {
	let { locales: l, defaultLocale: d } = p ?? {}, [f, m] = s(e ?? L ?? t ?? d);
	i(() => {
		e && e !== f && m(e);
	}, [e]), i(() => {
		ft();
...
}, bt = ({ children: e, i18n: t }) => (t !== void 0 && y({ log: h })(`${b("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), u(_t, { children: e })), V = (e, t, n = ".") => {
	if (!t) return e;
...
var Dt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: o } = yt(), s = t?.keyPrefix, { translate: c, i18n: l } = a(() => Dt({
		locale: r,
		setLocale: i,
		availableLocales: o ?? [],
		namespace: n,
...
var kt = {
	type: "3rdParty",
	init: (e) => {}
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-react-i18next-app/src/components/Footer.tsx";
function At() {
	let { t: e } = Ot(), t = l({ strict: !1 }).locale ?? "en", n = [
		{
			...
			children: [f("div", {
				...
				children: [
					...
					f("div", { children: [f("h3", {
						...
						className: "space-y-1",
						children: n.map((e) => f("li", { children: e.isInternal ? f(c, {
							preload: !1,
							to: e.to,
							params: { locale: t },
...
var jt = Q, Mt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-react-i18next-app/scripts/Wrapper.tsx";
...
var Pt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-react-i18next-app/src/components/Footer.wrapper.tsx";
function Ft() {
	return f(Nt, { children: f(At, {}, void 0, !1, {
		fileName: Pt,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
