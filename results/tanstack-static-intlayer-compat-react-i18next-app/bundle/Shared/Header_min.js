...
}, v = "\x1B[0m", ee = "\x1B[34m", te = "\x1B[31m", ne = "\x1B[32m", re = "\x1B[35m", ie = "\x1B[38;5;3m", y = "\x1B[36m", ae = (e, t = h?.locales, n = h?.defaultLocale) => {
...
var b = {
	...
	if (!ce) for (let t = 0; t < (g.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(g.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, ue = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !ce && g.storage.cookies) for (let n = 0; n < g.storage.cookies.length; n++) {
...
function x(e, t, n) {
	let r = t ?? h?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = me.get(a);
...
}), C = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? v : n : v}` : e, xe = (e, t = ie, n = v) => [e].flat().map((e) => C(e, t, n)).join(", ");
C("✗", te), C("✓", ne), C("⏲", ee);
var Se = "translation", Ce = "enumeration", we = "plural", Te = "insertion", Ee = "object", De = "array", Oe = "html", w = "gender", T = "select", E = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), D = (e, t) => {
...
})() }), Pe = (e) => E(we, e), Fe = (e, t) => E(T, e, { variable: t }), Ie = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, Ye = (e, t) => e[Je(e, t) ?? "fallback"], Xe = (e, t, n) => e[x("PluralRules", n).select(t)] ?? e.other, Ze = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return z(r[Te], t, n);
	...
	if (r.nodeType === "enumeration") {
		let e = r[Ce], i = I.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	i18next: Ve,
	"vue-i18n": qe
}, B = (e, t = {}, n = "en", r = "icu") => tt(nt[r])(e, t, n), rt = /* @__PURE__ */ new WeakMap(), it = 0, at = (e) => {
	if (!e) return "base";
	let t = rt.get(e);
	if (t) return t;
	it += 1;
	let n = `p${it}`;
	return rt.set(e, n), n;
}, ot = 256, V = /* @__PURE__ */ new WeakMap(), st = (e) => typeof e == "object" && !!e, ct = (e, t, n) => `${e}_${t}_${at(n)}`, lt = (e, t) => {
	...
	if (!st(e)) return n;
	let r = V.get(e);
	return r || (r = /* @__PURE__ */ new Map(), V.set(e, r)), r.size >= ot && r.clear(), r.set(t, n), n;
}, U = "default", ut = /[^A-Za-z0-9._&=-]/g, dt = /[^A-Za-z0-9._-]/g, ft = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, W = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, ft);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, pt = (e) => e === void 0 ? U : typeof e == "string" ? W(e, ut) : Object.keys(e).sort().map((t) => `${W(t, dt)}=${W(String(e[t]), dt)}`).join("&"), mt = (e) => Array.isArray(e) ? e.length === 0 ? [U] : e.map(pt) : [pt(e)], ht = (e, t) => {
	...
	if (!_t(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? U : ht(mt(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => gt(e, n, t, s)).map((t) => vt(e, t));
	...
	yield e;
} : Tt(e ? `${e}.${String(n)}` : String(n)) }), Et = /* @__PURE__ */ new Set(), G = (e, t, n) => {
	let r = Ct()[e];
	return r ? Bt(r, t, n) : (Et.has(e) || (S({ log: _ })(typeof window > "u" ? `Dictionary ${xe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Et.add(e)), Tt(e));
}, Dt = (e) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, At = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? K : {
...
}, jt = K, Mt = K, Nt = K, Pt = K, Ft = K;
process.env.INTLAYER_OPTIMIZED_NESTING;
var It = (e) => K, Lt = K, Rt = (e, t = !0) => [
	At(e ?? h.defaultLocale, t ? h.defaultLocale : void 0),
	jt,
	Mt,
	Nt,
	...
	let { locale: r, selector: i } = bt(t), a = ct(r ?? h.defaultLocale, xt(i), n), o = lt(e, a);
	if (o.hit) return o.content;
	let s = n ?? Rt(r), c = yt(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
	...
	"nsMode",
	"keyPrefix"
]), Ht = 5, Ut = "index", Wt = (e, t) => {
	if (e in Ct()) return G(e, t);
}, Gt = (e, t, n, r, i) => {
	...
	else if (m = Wt(c, p), m === void 0 && c === t && c !== Ut && (m = Wt(Ut, p)), m === void 0) return;
	let h;
	...
	return o < Ht && _.includes("$t(") && (_ = _.replace(/\$t\(\s*([^),]+?)\s*(?:,[^)]*)?\)/g, (n, l) => {
		let u = J({
			locale: e,
			namespace: c,
			key: l.trim(),
	...
	S({ log: _ })(`${C(e, y)}: the ${C("`resources`", y)} option is ignored when using ${C("@intlayer/i18next", re)} — translations are served from the compiled intlayer dictionaries instead. Remove the resource imports and the ${C("`resources`", y)} option to reduce your bundle size.`);
}, Y = (e = {}) => {
	e.resources !== void 0 && Kt("createInstance");
	let t = h, n = e.lng ?? t?.defaultLocale ?? "en", r = e.defaultNS ?? (Array.isArray(e.ns) ? e.ns[0] : e.ns) ?? "translation", i = /* @__PURE__ */ new Map(), a = !1, o = (e, ...t) => {
		i.get(e)?.forEach((e) => {
			e(...t);
		});
	}, s = () => ({
...
var qt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	let o = (t, n) => J({
		locale: e,
		namespace: r,
		key: i ? `${i}.${t}` : t,
...
}), { defaultLocale: rn, locales: Q } = h ?? {}, an = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = an(), s = t?.keyPrefix, { translate: c, i18n: l } = o(() => qt({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
}, sn = ({ children: e, i18n: t }) => (t !== void 0 && S({ log: _ })(`${C("I18nextProvider", y)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), p(nn, { children: e }));
