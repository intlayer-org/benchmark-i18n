...
C("✗", te), C("✓", ne), C("⏲", ee);
var Se = "translation", Ce = "enumeration", we = "plural", w = "insertion", Te = "object", Ee = "array", De = "markdown", T = "html", Oe = "gender", ke = "select", E = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), D = (e, t) => {
...
})() }), Fe = (e) => E(we, e), Ie = (e, t) => E(ke, e, { variable: t }), Le = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, Xe = (e, t) => e[Ye(e, t) ?? "fallback"], Ze = (e, t, n) => e[x("PluralRules", n).select(t)] ?? e.other, Qe = (e, t) => {
	...
	if (r.nodeType === "enumeration") {
		let e = r[Ce], i = $e.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
}, ft = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), H = "default", pt = /[^A-Za-z0-9._&=-]/g, mt = /[^A-Za-z0-9._-]/g, ht = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, U = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, ht);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, gt = (e) => e === void 0 ? H : typeof e == "string" ? U(e, pt) : Object.keys(e).sort().map((t) => `${U(t, mt)}=${U(String(e[t]), mt)}`).join("&"), _t = (e) => Array.isArray(e) ? e.length === 0 ? [H] : e.map(gt) : [gt(e)], vt = (e, t) => {
	for (let n of e) if (t(n)) return n;
	return t("default") ? H : e[0] ?? "default";
}, yt = (e, t, n, r) => {
	let i = e.split("/");
	return t.every((e, t) => e === "variant" ? i[t] === r : n?.item === void 0 || i[t] === String(n.item));
}, bt = (e) => typeof e == "object" && !!e && "qualifierTypes" in e && Array.isArray(e.qualifierTypes) && "content" in e, xt = (e, t) => {
	let n = t.split("/"), r = {
		key: e.key,
		content: e.content[t]
	};
	...
	if (!bt(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? H : vt(_t(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => yt(e, n, t, s)).map((t) => xt(e, t));
	return i ? c.sort((e, t) => (e.item ?? 0) - (t.item ?? 0)) : c[0] ?? null;
}, Ct = (e) => typeof e == "object" && e ? {
	locale: e.locale,
	selector: e
} : { locale: e }, wt = (e) => e ? Object.keys(e).filter((e) => e !== "locale").sort().map((t) => {
	let n = e[t];
	return `${t}:${t === "variant" ? _t(n).join(",") : String(n)}`;
}).join("|") : "", Tt = { index: {
	key: "index",
	...
	yield e;
} : Ot(e ? `${e}.${String(n)}` : String(n)) }), kt = /* @__PURE__ */ new Set(), W = (e, t, n) => {
	let r = Et()[e];
	return r ? Kt(r, t, n) : (kt.has(e) || (S({ log: _ })(typeof window > "u" ? `Dictionary ${xe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), kt.add(e)), Ot(e));
}, At = (e) => {
	...
	if (G(e)) return e.nodeType === "html" ? e[T] : e[De];
}, Pt = (e, t) => {
	if (typeof e == "string") return t;
	if (G(e)) {
		let n = e.nodeType === "html" ? T : De;
		return {
			...e,
			[n]: t
		};
	...
	canHandle: () => !1,
	transform: (e) => e
}, It = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? K : {
...
}, Lt = K, Rt = K, zt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? K : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: w }], i = e[w], a = {
			...
			transform: (e, n, r) => {
				if (G(e)) return (i) => Ft(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
var Ht = (e) => K, Ut = K, Wt = (e, t = !0) => [
	It(e ?? h.defaultLocale, t ? h.defaultLocale : void 0),
	Lt,
	Rt,
	zt,
	...
	let { locale: r, selector: i } = Ct(t), a = ut(r ?? h.defaultLocale, wt(i), n), o = dt(e, a);
	if (o.hit) return o.content;
	let s = n ?? Wt(r), c = St(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
	...
	"nsMode",
	"keyPrefix"
]), Jt = 5, Yt = "index", Xt = (e, t) => {
	if (e in Et()) return W(e, t);
}, Zt = (e, t, n, r, i) => {
	...
	let n = {};
	for (let [t, r] of Object.entries(e)) qt.has(t) || (n[t] = r);
	return n;
	...
	else if (m = Xt(c, p), m === void 0 && c === t && c !== Yt && (m = Xt(Yt, p)), m === void 0) return;
	let h;
	...
	return o < Jt && _.includes("$t(") && (_ = _.replace(/\$t\(\s*([^),]+?)\s*(?:,[^)]*)?\)/g, (n, l) => {
		let u = J({
			locale: e,
			namespace: c,
			key: l.trim(),
...
var $t = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let { locales: l, defaultLocale: u } = h ?? {}, [d, f] = c(e ?? en ?? t ?? u);
	i(() => {
		e && e !== d && f(e);
	}, [e]), i(() => {
		sn();
...
}), { defaultLocale: un, locales: Q } = h ?? {}, dn = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
}, pn = ({ children: e, i18n: t }) => (t !== void 0 && S({ log: _ })(`${C("I18nextProvider", y)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), p(ln, { children: e }));
