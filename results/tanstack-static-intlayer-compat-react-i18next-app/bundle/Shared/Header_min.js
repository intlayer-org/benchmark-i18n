...
}, _ = "\x1B[0m", ee = "\x1B[34m", v = "\x1B[31m", y = "\x1B[32m", b = "\x1B[35m", te = "\x1B[38;5;3m", x = "\x1B[36m", ne = (e, t = m?.locales, n = m?.defaultLocale) => {
...
}, ae = !1, oe, se = () => typeof window > "u" ? ie(w) : (ae ||= (oe = ie(w), !0), oe), ce = (e, t) => {
	if (t?.isCookieEnabled !== !1 && (ae = !1, !C && h.storage.cookies)) for (let n = 0; n < h.storage.cookies.length; n++) {
...
function T(e, t, n) {
	let r = t ?? m?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = fe.get(a);
...
}), D = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? _ : n : _}` : e, ye = (e, t = te, n = _) => [e].flat().map((e) => D(e, t, n)).join(", ");
D("✗", v), D("✓", y), D("⏲", ee);
var be = "translation", O = "enumeration", k = "plural", xe = "condition", A = "insertion", Se = "object", Ce = "array", j = "markdown", M = "html", N = "gender", P = "select", F = (e, t, n) => ({
...
}, Ee = (e, t) => e[Te(e, t) ?? "fallback"], De = (e, t, n) => e[T("PluralRules", n).select(t)] ?? e.other, Oe = (e, t) => {
	...
	if (r.nodeType === "enumeration") {
		let e = r[O], i = ke.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
}, Me = /* @__PURE__ */ new WeakMap(), Ne = 0, Pe = (e) => {
	if (!e) return "base";
	let t = Me.get(e);
	if (t) return t;
	Ne += 1;
	let n = `p${Ne}`;
	return Me.set(e, n), n;
}, Fe = 256, V = /* @__PURE__ */ new WeakMap(), Ie = (e) => typeof e == "object" && !!e, Le = (e, t, n) => `${e}_${t}_${Pe(n)}`, Re = (e, t) => {
	...
	if (!Ie(e)) return n;
	let r = V.get(e);
	return r || (r = /* @__PURE__ */ new Map(), V.set(e, r)), r.size >= Fe && r.clear(), r.set(t, n), n;
}, ze = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), Be = { index: {
	key: "index",
	...
	yield e;
} : Ue(e ? `${e}.${String(n)}` : String(n)) }), We = /* @__PURE__ */ new Set(), U = (e, t, n) => {
	let r = Ve()[e];
	return r ? ft(r, t, n) : (We.has(e) || (E({ log: g })(typeof window > "u" ? `Dictionary ${ye(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), We.add(e)), Ue(e));
}, Ge = (e) => {
	...
	if (W(e)) return e.nodeType === "html" ? e[M] : e[j];
}, Ye = (e, t) => {
...
}, $e = G, et = (e) => G, tt = G, nt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? G : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: A }], i = e[A], a = {
			...
			transform: (e, n, r) => {
				if (W(e)) return (i) => Xe(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, at = (e, t) => typeof t == "function" && rt.includes(e?.nodeType ?? "") ? (n) => it(e, t, n) : t, ot = G, st = G;
process.env.INTLAYER_OPTIMIZED_NESTING;
var ct = (e) => G, lt = G, ut = (e, t = !0) => [
	Qe(e ?? m.defaultLocale, t ? m.defaultLocale : void 0),
	$e,
	et(e ?? m.defaultLocale),
	tt,
	nt,
	...
	ot,
	st
].filter((e) => e !== G), dt = (e, t, n = []) => I(e, {
	...t,
	plugins: n
}), K = /* @__PURE__ */ new WeakSet(), ft = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = Le(r ?? m.defaultLocale, "", n), o = Re(e, a);
	...
	"nsMode",
	"keyPrefix"
]), mt = 5, ht = "index", gt = (e, t) => {
	if (e in Ve()) return U(e, t);
}, _t = (e, t, n, r, i) => {
	...
	let n = {};
	for (let [t, r] of Object.entries(e)) pt.has(t) || (n[t] = r);
	return n;
	...
	else if (m = gt(c, p), m === void 0 && c === t && c !== ht && (m = gt(ht, p)), m === void 0) return;
	let h;
	for (let t of _t(l, r?.lng ?? e, u, d, f)) {
		let e = we(m, t, i);
		if (e != null) {
			h = e;
			break;
	...
	let g = q(r), _ = B(h, g, r?.lng ?? e);
	return o < mt && _.includes("$t(") && (_ = _.replace(/\$t\(\s*([^),]+?)\s*(?:,[^)]*)?\)/g, (n, l) => {
		let u = J({
			locale: e,
			namespace: c,
			key: l.trim(),
	...
	E({ log: g })(`${D(e, x)}: the ${D("`resources`", x)} option is ignored when using ${D("@intlayer/i18next", b)} — translations are served from the compiled intlayer dictionaries instead. Remove the resource imports and the ${D("`resources`", x)} option to reduce your bundle size.`);
}, Y = (e = {}) => {
	...
	let t = m, n = e.lng ?? t?.defaultLocale ?? "en", r = e.defaultNS ?? (Array.isArray(e.ns) ? e.ns[0] : e.ns) ?? "translation", i = /* @__PURE__ */ new Map(), a = !1, o = (e, ...t) => {
		...
		return typeof o == "string" ? B(o, q(i), e) : n;
	}, l = {
		get language() {
			return n;
		},
		...
		t(e, t, i) {
			...
			return typeof c == "string" ? B(c, q(a), n) : c ?? (Array.isArray(e) ? e[e.length - 1] : e);
		},
...
var yt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	let o = (t, n) => J({
		...
		return typeof s == "string" ? B(s, q(i), e) : a[a.length - 1];
	};
	return {
		translate: s,
		i18n: {
	...
	get locale() {
		return bt() ?? m?.defaultLocale;
	},
	setLocale: () => null,
	isCookieEnabled: !0
}), Ct = ({ locale: e, defaultLocale: t, variant: r, children: a, setLocale: c, disableEditor: l, isCookieEnabled: u }) => {
	let { locales: d, defaultLocale: p } = m ?? {}, [h, g] = s(() => e ?? bt() ?? t ?? p), [_, ee] = s(e);
...
}), { defaultLocale: Tt, locales: Q } = m ?? {}, Et = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { locale: i, setLocale: a, isCookieEnabled: o } = r(St) ?? {};
	return {
		locale: i,
		defaultLocale: Tt,
		availableLocales: Q,
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = Et(), s = t?.keyPrefix, { translate: c, i18n: l } = o(() => yt({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
}, Ot = ({ children: e, i18n: t }) => (t !== void 0 && E({ log: g })(`${D("I18nextProvider", x)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), f(wt, { children: e }));
					...
					children: [
						...
						p("div", {
							...
							children: [p("button", {
								...
								onMouseLeave: () => n(!1),
								onClick: () => n(!t),
								children: [e("header.mockPages"), f(d, {
									size: 14,
