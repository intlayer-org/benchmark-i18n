...
var ce = /* @__PURE__ */ new WeakMap(), le = 0, ue = (e) => {
	...
	let n = `p${le}`;
	return ce.set(e, n), n;
}, de = 256, C = /* @__PURE__ */ new WeakMap(), fe = (e) => typeof e == "object" && !!e, pe = (e, t, n) => `${e}_${t}_${ue(n)}`, me = (e, t) => {
	...
	if (!fe(e)) return n;
	let r = C.get(e);
	return r || (r = /* @__PURE__ */ new Map(), C.set(e, r)), r.size >= de && r.clear(), r.set(t, n), n;
}, he = "translation", ge = "enumeration", _e = "plural", ve = "insertion", ye = "object", be = "array", xe = "html", Se = "gender", Ce = "select", T = (e, t) => {
...
}, Te = (e, t) => e[we(e, t) ?? "fallback"], E = "default", Ee = /[^A-Za-z0-9._&=-]/g, De = /[^A-Za-z0-9._-]/g, Oe = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, D = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, Oe);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, ke = (e) => e === void 0 ? E : typeof e == "string" ? D(e, Ee) : Object.keys(e).sort().map((t) => `${D(t, De)}=${D(String(e[t]), De)}`).join("&"), O = (e) => Array.isArray(e) ? e.length === 0 ? [E] : e.map(ke) : [ke(e)], Ae = (e, t) => {
	...
	if (!Me(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? E : Ae(O(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => je(e, n, t, s)).map((t) => Ne(e, t));
	...
	yield e;
} : ze(e ? `${e}.${String(n)}` : String(n)) }), Be = /* @__PURE__ */ new Set(), A = (e, t, n) => {
	let r = k()[e];
	return r ? ot(r, t, n) : (Be.has(e) || (x({ log: v })(typeof window > "u" ? `Dictionary ${se(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Be.add(e)), ze(e));
}, Ve = 50, j = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Set(), He = (e) => {
...
function N(e, t, n) {
	let r = t ?? g?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = j.get(a);
...
var Ge = (e, t, n) => e[N("PluralRules", n).select(t)] ?? e.other, Ke = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, Xe = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? P : {
...
}, Ze = P, Qe = P, $e = P, et = P, tt = P;
process.env.INTLAYER_OPTIMIZED_NESTING;
var nt = (e) => P, rt = P, it = (e, t = !0) => [
	Xe(e ?? g.defaultLocale, t ? g.defaultLocale : void 0),
	Ze,
	Qe,
	$e,
	nt(e ?? g.defaultLocale),
	rt,
	et,
	tt
], at = (e, t, n = []) => T(e, {
	...
	let { locale: r, selector: i } = Fe(t), a = pe(r ?? g.defaultLocale, Ie(i), n), o = me(e, a);
	if (o.hit) return o.content;
	let s = n ?? it(r), c = Pe(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var F = {
	...
	if (!lt) for (let t = 0; t < (_.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(_.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, dt = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !lt && _.storage.cookies) for (let n = 0; n < _.storage.cookies.length; n++) {
...
}, _t = (e, t = g?.locales, n = g?.defaultLocale) => {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), bt = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: o, isCookieEnabled: s }) => {
	let { locales: l, defaultLocale: u } = g ?? {}, [d, f] = c(e ?? I ?? t ?? u);
	i(() => {
		e && e !== d && f(e);
	}, [e]), i(() => {
		gt();
...
}), { defaultLocale: St, locales: z } = g ?? {}, Ct = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	let { locale: i, setLocale: a, isCookieEnabled: o } = r(R) ?? {};
	return {
		locale: i,
		defaultLocale: St,
		availableLocales: z,
...
}, wt = ({ children: e, i18n: t }) => (t !== void 0 && x({ log: v })(`${S("I18nextProvider", b)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), p(xt, { children: e })), B = (e, t, n = ".") => {
	if (!t) return e;
	...
	let o = H(t, r);
	return o === void 0 ? e : i ? U(o, i, a, n) : String(o);
}).replace(/\{\s*([\w.]+)\s*,\s*(\w+)\s*(?:,\s*([^}]+?)\s*)?\}/g, (e, r, i, a) => {
	let o = H(t, r);
	return o === void 0 ? e : U(o, i, a, n);
}).replace(/\{\s*([\w.]+)\s*\}/g, (e, n) => {
	let r = H(t, n);
	...
	if (r.nodeType === "plural") {
		let e = r[_e];
		return G(Ge(e, Number(W(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[ge], i = V.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	else if (m = kt(c, p), m === void 0 && c === t && c !== Ot && (m = kt(Ot, p)), m === void 0) return;
	let h;
	...
	let t = g, n = e.lng ?? t?.defaultLocale ?? "en", r = e.defaultNS ?? (Array.isArray(e.ns) ? e.ns[0] : e.ns) ?? "translation", i = /* @__PURE__ */ new Map(), a = !1, o = (e, ...t) => {
		...
		return typeof o == "string" ? K(o, q(i), e) : n;
	}, l = {
		get language() {
			return n;
		},
		...
		t(e, t, i) {
			...
			return typeof c == "string" ? K(c, q(a), n) : c ?? (Array.isArray(e) ? e[e.length - 1] : e);
		},
...
var Mt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	let o = (t, n) => J({
		...
		return typeof s == "string" ? K(s, q(i), e) : a[a.length - 1];
	};
	return {
		translate: s,
		i18n: {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = Ct(), s = t?.keyPrefix, { translate: c, i18n: l } = o(() => Mt({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
...
var Pt = {
	type: "3rdParty",
	init: (e) => {}
}, Ft = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-react-i18next-app/src/components/ThemeToggle.tsx";
function It() {
...
var Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-react-i18next-app/src/components/LocaleSwitcher.tsx";
function Bt() {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-react-i18next-app/src/components/Header.tsx";
function Ht() {
	let { t: e } = Nt();
	Vt("Header");
					...
					children: [
						...
						h("div", {
							...
							children: [h("button", {
								...
								onMouseLeave: () => n(!1),
								onClick: () => n(!t),
								children: [e("header.mockPages"), h(f, {
									size: 14,
...
var Ut = X, Wt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-react-i18next-app/scripts/Wrapper.tsx";
...
var Kt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-react-i18next-app/src/components/Header.wrapper.tsx";
function qt() {
	return h(Gt, { children: h(Ht, {}, void 0, !1, {
		fileName: Kt,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
