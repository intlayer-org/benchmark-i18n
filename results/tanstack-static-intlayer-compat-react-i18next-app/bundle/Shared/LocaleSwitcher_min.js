...
}, ce = 50, le = /* @__PURE__ */ new Map(), ue = /* @__PURE__ */ new Set(), de = (e) => {
...
function S(e, t, n) {
	let r = t ?? p?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = le.get(a);
...
}), w = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? g : n : g}` : e, ge = (e, t = re, n = g) => [e].flat().map((e) => w(e, t, n)).join(", ");
w("✗", ee), w("✓", te), w("⏲", _);
var _e = "translation", ve = "enumeration", ye = "plural", be = "insertion", xe = "object", Se = "array", Ce = "html", we = "gender", T = "select", E = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), D = (e, t) => {
...
})() }), P = (e) => E(ye, e), ke = (e, t) => E(T, e, { variable: t }), Ae = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, Ue = (e, t) => e[He(e, t) ?? "fallback"], We = (e, t, n) => e[S("PluralRules", n).select(t)] ?? e.other, Ge = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return B(r[be], t, n);
	if (r.nodeType === "html") return B(r[Ce], t, n);
	if (r.nodeType === "plural") {
		let e = r[ye];
		return B(We(e, Number(z(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[ve], i = Ke.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[T], i = z(t, typeof r.variable == "string" ? r.variable : "value");
		return B(Ge(e, String(i ?? "")), t, n);
	}
	...
	let r = vt()[e];
	return r ? Ft(r, t, n) : (xt.has(e) || (C({ log: h })(typeof window > "u" ? `Dictionary ${ge(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), xt.add(e)), bt(e));
}, St = (e) => {
...
var jt = (e) => q, Mt = q, Nt = (e, t = !0) => [
	...
	let { locale: r, selector: i } = ht(t), a = rt(r ?? p.defaultLocale, gt(i), n), o = it(e, a);
	...
	else if (m = Rt(c, p), m === void 0 && c === t && c !== J && (m = Rt(J, p)), m === void 0) return;
	let h;
	...
	let g = Y(r), _ = V(h, g, r?.lng ?? e, "i18next");
	...
	C({ log: h })(`${w(e, v)}: the ${w("`resources`", v)} option is ignored when using ${w("@intlayer/i18next", ne)} — translations are served from the compiled intlayer dictionaries instead. Remove the resource imports and the ${w("`resources`", v)} option to reduce your bundle size.`);
}, Z = (e = {}) => {
	...
	let t = p, n = e.lng ?? t?.defaultLocale ?? "en", r = e.defaultNS ?? (Array.isArray(e.ns) ? e.ns[0] : e.ns) ?? "translation", i = /* @__PURE__ */ new Map(), a = !1, o = (e, ...t) => {
		...
		return typeof o == "string" ? V(o, Y(i), e, "i18next") : n;
	}, l = {
		get language() {
			return n;
		},
		...
		t(e, t, i) {
			...
			return typeof c == "string" ? V(c, Y(a), n, "i18next") : c ?? (Array.isArray(e) ? e[e.length - 1] : e);
		},
...
var Vt = oe(x), Ht = (e, t) => se(e, {
	...
	locale: Vt ?? p?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), Jt = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: o, disableEditor: s, isCookieEnabled: l }) => {
	let { locales: u, defaultLocale: d } = p ?? {}, [f, m] = a(e ?? Vt ?? t ?? d);
	r(() => {
		e && e !== f && m(e);
	}, [e]), r(() => {
		qt();
...
}), Xt = ({ children: e, i18n: t }) => (t !== void 0 && C({ log: h })(`${w("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), c(Yt, { children: e }));
