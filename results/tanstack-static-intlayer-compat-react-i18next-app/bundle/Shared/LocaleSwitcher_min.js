...
function x(e, t, n) {
	let r = t ?? p?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = ue.get(a);
...
}), C = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? g : n : g}` : e, _e = (e, t = re, n = g) => [e].flat().map((e) => C(e, t, n)).join(", ");
C("✗", ee), C("✓", te), C("⏲", _);
var ve = "translation", ye = "enumeration", be = "plural", w = "insertion", xe = "object", Se = "array", Ce = "markdown", T = "html", we = "gender", Te = "select", E = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), D = (e, t) => {
...
})() }), Ae = (e) => E(be, e), je = (e, t) => E(Te, e, { variable: t }), Me = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	let r = e;
	if (r.nodeType === "insertion") return z(r[w], t, n);
	...
	i18next: Le,
	"vue-i18n": Ue
}, B = (e, t = {}, n = "en", r = "icu") => Qe($e[r])(e, t, n), et = /* @__PURE__ */ new WeakMap(), tt = 0, nt = (e) => {
	if (!e) return "base";
	let t = et.get(e);
	if (t) return t;
	tt += 1;
...
}, st = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), U = "default", ct = /[^A-Za-z0-9._&=-]/g, lt = /[^A-Za-z0-9._-]/g, ut = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, W = (e, t) => {
	if (e === "") return "%";
	...
	let r = xt()[e];
	return r ? Vt(r, t, n) : (wt.has(e) || (S({ log: h })(typeof window > "u" ? `Dictionary ${_e(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), wt.add(e)), Ct(e));
}, Tt = (e) => {
	...
	if (K(e)) return e.nodeType === "html" ? e[T] : e[Ce];
}, kt = (e, t) => {
	if (typeof e == "string") return t;
	if (K(e)) {
		let n = e.nodeType === "html" ? T : Ce;
		return {
			...e,
			[n]: t
		};
...
}, Mt = q, Nt = q, Pt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? q : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: w }], i = e[w], a = {
			...
			transform: (e, n, r) => {
				if (K(e)) return (i) => At(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
var Lt = (e) => q, Rt = q, zt = (e, t = !0) => [
	jt(e ?? p.defaultLocale, t ? p.defaultLocale : void 0),
	Mt,
	Nt,
	Pt,
	...
	let { locale: r, selector: i } = vt(t), a = at(r ?? p.defaultLocale, yt(i), n), o = ot(e, a);
	...
	else if (m = J(c, p), m === void 0 && c === t && c !== Wt && (m = J(Wt, p)), m === void 0) return;
	let h;
	for (let t of Gt(l, r?.lng ?? e, u, d, f)) {
		let e = Re(m, t, i);
		if (e != null) {
			h = e;
			break;
...
var qt = se(b), Jt = (e, t) => ce(e, {
	...
	locale: qt ?? p?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), en = ({ locale: e, defaultLocale: t, variant: n, children: i, setLocale: o, disableEditor: s, isCookieEnabled: l }) => {
	let { locales: u, defaultLocale: d } = p ?? {}, [f, m] = a(e ?? qt ?? t ?? d);
	r(() => {
		e && e !== f && m(e);
	}, [e]), r(() => {
		$t();
...
}), nn = ({ children: e, i18n: t }) => (t !== void 0 && S({ log: h })(`${C("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), c(tn, { children: e }));
