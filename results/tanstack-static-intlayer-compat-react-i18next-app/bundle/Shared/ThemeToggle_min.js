...
}), w = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? p : n : p}` : e, he = (e, t = ee, n = p) => [e].flat().map((e) => w(e, t, n)).join(", ");
w("✗", h), w("✓", g), w("⏲", m);
var ge = "translation", T = "enumeration", _e = "plural", ve = "insertion", ye = "object", be = "array", xe = "html", Se = "gender", Ce = "select", E = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), D = (e, t) => {
...
})() }), Oe = (e) => E(_e, e), ke = (e, t) => E(Ce, e, { variable: t }), Ae = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	let r = e;
	if (r.nodeType === "insertion") return z(r[ve], t, n);
	if (r.nodeType === "html") return z(r[xe], t, n);
	if (r.nodeType === "plural") {
		let e = r[_e];
		return z(We(e, Number(R(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[T], i = Ke.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[Ce], i = R(t, typeof r.variable == "string" ? r.variable : "value");
		return z(Ge(e, String(i ?? "")), t, n);
	}
	...
	let r = vt()[e];
	return r ? Ft(r, t, n) : (xt.has(e) || (C({ log: f })(typeof window > "u" ? `Dictionary ${he(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), xt.add(e)), bt(e));
}, St = (e) => {
...
var jt = (e) => K, Mt = K, Nt = (e, t = !0) => [
	...
	C({ log: f })(`${w(e, v)}: the ${w("`resources`", v)} option is ignored when using ${w("@intlayer/i18next", _)} — translations are served from the compiled intlayer dictionaries instead. Remove the resource imports and the ${w("`resources`", v)} option to reduce your bundle size.`);
}, Y = (e = {}) => {
...
var Ht = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	locale: Ut ?? u?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), Xt = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: o, isCookieEnabled: l }) => {
	let { locales: d, defaultLocale: f } = u ?? {}, [p, m] = s(e ?? Ut ?? t ?? f);
	i(() => {
		e && e !== p && m(e);
	}, [e]), i(() => {
		Yt();
...
}), { defaultLocale: Qt, locales: Q } = u ?? {}, $t = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
}, tn = ({ children: e, i18n: t }) => (t !== void 0 && C({ log: f })(`${w("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), c(Zt, { children: e }));
