...
S("✗", h), S("✓", g), S("⏲", m);
var ve = "translation", ye = "enumeration", be = "plural", C = "insertion", xe = "object", Se = "array", w = "markdown", T = "html", Ce = "gender", we = "select", E = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), D = (e, t) => {
...
})() }), Ae = (e) => E(be, e), je = (e, t) => E(we, e, { variable: t }), Me = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
var Jt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), nn = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: o, isCookieEnabled: l }) => {
...
}), { defaultLocale: an, locales: Q } = u ?? {}, on = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
}, cn = ({ children: e, i18n: t }) => (t !== void 0 && x({ log: f })(`${S("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), c(rn, { children: e }));
