...
S("✗", g), S("✓", _), S("⏲", h);
var ye = "translation", be = "enumeration", xe = "plural", C = "insertion", Se = "object", Ce = "array", we = "markdown", w = "html", T = "gender", Te = "select", E = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), D = (e, t) => {
...
})() }), je = (e) => E(xe, e), Me = (e, t) => E(Te, e, { variable: t }), Ne = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
var Rt = (e) => K, zt = K, Bt = (e, t = !0) => [
	...
	else if (m = Gt(c, p), m === void 0 && c === t && c !== q && (m = Gt(q, p)), m === void 0) return;
	let h;
