...
function nn() {
	...
	return l("section", {
		...
		children: [c("h2", {
			...
			children: e("whyItMatters.whyTheseMetricsMatter")
		}), l("div", {
			...
			children: [
				l("div", {
					...
					children: [c("h3", {
						...
						children: e("whyItMatters.bundleSize")
					}), c("p", {
						className: "text-sm text-muted-foreground",
						children: e("whyItMatters.theBundleIsTheData")
					})]
				}),
				l("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [c("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: e("whyItMatters.renderingHydration")
					}), c("p", {
						className: "text-sm text-muted-foreground",
						children: e("whyItMatters.connectingALargeJson")
					})]
				}),
				l("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [c("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: e("whyItMatters.dynamicLoading")
					}), c("p", {
						className: "text-sm text-muted-foreground",
						children: e("whyItMatters.loadingAllTranslationsUpfront")
					})]
				})
			]
		})]
