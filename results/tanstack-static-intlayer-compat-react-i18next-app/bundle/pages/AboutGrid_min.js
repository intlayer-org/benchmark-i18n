...
}, m = "\x1B[0m", h = "\x1B[34m", g = "\x1B[31m", _ = "\x1B[32m", ee = "\x1B[35m", te = "\x1B[38;5;3m", v = "\x1B[36m", ne = (e) => e, re = (e, t) => {
...
}), b = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? m : n : m}` : e, ie = (e, t = te, n = m) => [e].flat().map((e) => b(e, t, n)).join(", ");
b("✗", g), b("✓", _), b("⏲", h);
var ae = /* @__PURE__ */ new WeakMap(), oe = 0, se = (e) => {
	if (!e) return "base";
	let t = ae.get(e);
	if (t) return t;
	oe += 1;
	let n = `p${oe}`;
	return ae.set(e, n), n;
}, ce = 256, x = /* @__PURE__ */ new WeakMap(), S = (e) => typeof e == "object" && !!e, le = (e, t, n) => `${e}_${t}_${se(n)}`, ue = (e, t) => {
	if (!S(e)) return { hit: !1 };
	let n = x.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	if (!S(e)) return n;
	let r = x.get(e);
	return r || (r = /* @__PURE__ */ new Map(), x.set(e, r)), r.size >= ce && r.clear(), r.set(t, n), n;
}, de = "translation", fe = "enumeration", pe = "plural", me = "insertion", he = "object", ge = "array", _e = "html", ve = "gender", ye = "select", w = (e, t) => {
...
}, xe = (e, t) => e[be(e, t) ?? "fallback"], T = "default", Se = /[^A-Za-z0-9._&=-]/g, Ce = /[^A-Za-z0-9._-]/g, we = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, E = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, we);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, D = (e) => e === void 0 ? T : typeof e == "string" ? E(e, Se) : Object.keys(e).sort().map((t) => `${E(t, Ce)}=${E(String(e[t]), Ce)}`).join("&"), O = (e) => Array.isArray(e) ? e.length === 0 ? [T] : e.map(D) : [D(e)], Te = (e, t) => {
	...
	if (!De(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? T : Te(O(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Ee(e, n, t, s)).map((t) => Oe(e, t));
	...
	yield e;
} : Pe(e ? `${e}.${String(n)}` : String(n)) }), Fe = /* @__PURE__ */ new Set(), A = (e, t, n) => {
	let r = k()[e];
	return r ? $e(r, t, n) : (Fe.has(e) || (y({ log: p })(typeof window > "u" ? `Dictionary ${ie(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Fe.add(e)), Pe(e));
}, Ie = 50, j = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Set(), Le = (e) => {
...
var Be = (e, t, n) => e[N("PluralRules", n).select(t)] ?? e.other, Ve = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, Ue = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? I : {
...
}, We = I, Ge = I, Ke = I, qe = I, Je = I;
process.env.INTLAYER_OPTIMIZED_NESTING;
var Ye = (e) => I, Xe = I, Ze = (e, t = !0) => [
	...
	let { locale: r, selector: i } = Ae(t), a = le(r ?? d.defaultLocale, je(i), n), o = ue(e, a);
	if (o.hit) return o.content;
	let s = n ?? Ze(r), c = ke(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var z = {
...
}, ot = ({ children: e }) => (at(), e), st = () => {
	typeof window < "u" && (window.intlayer = { enabled: !0 });
}, ct = (e, t = d?.locales, n = d?.defaultLocale) => {
	...
	try {
		...
		let n = t.maximize();
		return lt.includes(n.script ?? "") ? "rtl" : "ltr";
	} catch {
		return "ltr";
	}
}, H = t({
	...
	setLocale: () => null,
	isCookieEnabled: !0
}), dt = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: o, isCookieEnabled: l }) => {
	let { locales: u, defaultLocale: f } = d ?? {}, [p, m] = s(e ?? B ?? t ?? f);
	i(() => {
		e && e !== p && m(e);
	}, [e]), i(() => {
		st();
...
}), { defaultLocale: pt, locales: U } = d ?? {}, mt = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
...
}, ht = ({ children: e, i18n: t }) => (t !== void 0 && y({ log: p })(`${b("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), c(ft, { children: e })), gt = (e, t, n = ".") => {
	if (!t) return e;
	...
	let r = e;
	if (r.nodeType === "insertion") return K(r[me], t, n);
	if (r.nodeType === "html") return K(r[_e], t, n);
	if (r.nodeType === "plural") {
		let e = r[pe];
		return K(Be(e, Number(G(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[fe], i = _t.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[ye], i = G(t, typeof r.variable == "string" ? r.variable : "value");
	...
	y({ log: p })(`${b(e, v)}: the ${b("`resources`", v)} option is ignored when using ${b("@intlayer/i18next", ee)} — translations are served from the compiled intlayer dictionaries instead. Remove the resource imports and the ${b("`resources`", v)} option to reduce your bundle size.`);
}, X = (e = {}) => {
...
var Et = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: o } = mt(), s = t?.keyPrefix, { translate: c, i18n: l } = a(() => Et({
		locale: r,
		setLocale: i,
		availableLocales: o ?? [],
		namespace: n,
...
var Ot = {
	type: "3rdParty",
	init: (e) => {}
}, Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-react-i18next-app/src/components/pages/about/AboutGrid.tsx";
function kt() {
	let { t: e } = Dt();
	return u("div", {
...
var At = Z, jt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-react-i18next-app/scripts/Wrapper.tsx";
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-react-i18next-app/src/components/pages/about/AboutGrid.wrapper.tsx";
function Nt() {
	return u(Mt, { children: u(kt, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
