...
var Ut = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let { locales: l, defaultLocale: d } = f ?? {}, [p, m] = c(e ?? Wt ?? t ?? d);
	i(() => {
		e && e !== p && m(e);
	}, [e]), i(() => {
		Xt();
...
function on() {
	let { t: e } = tn();
	return an("AboutHeader"), d(l, { children: [u("h1", {
		className: "mb-4 text-3xl font-bold text-foreground",
		children: e("aboutHeader.methodology")
	}), u("p", {
		className: "mb-8 max-w-3xl text-muted-foreground",
		children: e("aboutHeader.weDesignedThisBenchmarkTo")
	})] });
}
Z.use(rn).init({
	lng: "en",
