...
var y = {
	...
	if (!ie) for (let t = 0; t < (d.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(d.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, oe = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !ie && d.storage.cookies) for (let n = 0; n < d.storage.cookies.length; n++) {
...
function b(e, t, n) {
	let r = t ?? u?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = ue.get(a);
...
}), S = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? p : n : p}` : e, _e = (e, t = ee, n = p) => [e].flat().map((e) => S(e, t, n)).join(", ");
S("✗", h), S("✓", g), S("⏲", m);
var ve = "translation", C = "enumeration", ye = "plural", be = "insertion", xe = "object", Se = "array", Ce = "html", we = "gender", Te = "select", w = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), T = (e, t) => {
...
})() }), je = (e) => w(ye, e), j = (e, t) => w(Te, e, { variable: t }), Me = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
...
}, We = (e, t) => e[Ue(e, t) ?? "fallback"], Ge = (e, t, n) => e[b("PluralRules", n).select(t)] ?? e.other, Ke = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return z(r[be], t, n);
	if (r.nodeType === "html") return z(r[Ce], t, n);
	if (r.nodeType === "plural") {
		let e = r[ye];
		return z(Ge(e, Number(R(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[C], i = I.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
}, Xe = (e) => (t, n = {}, r = "en") => Ye(typeof t == "string" ? e(t) : t, n, r), Ze = {
	icu: Pe,
	i18next: Le,
	"vue-i18n": He
}, B = (e, t = {}, n = "en", r = "icu") => Xe(Ze[r])(e, t, n), Qe = /* @__PURE__ */ new WeakMap(), $e = 0, et = (e) => {
	if (!e) return "base";
	let t = Qe.get(e);
	if (t) return t;
	$e += 1;
	let n = `p${$e}`;
	return Qe.set(e, n), n;
}, tt = 256, V = /* @__PURE__ */ new WeakMap(), nt = (e) => typeof e == "object" && !!e, rt = (e, t, n) => `${e}_${t}_${et(n)}`, it = (e, t) => {
	if (!nt(e)) return { hit: !1 };
	let n = V.get(e);
	return n?.has(t) ? {
		hit: !0,
		content: n.get(t)
	...
	if (!nt(e)) return n;
	let r = V.get(e);
	return r || (r = /* @__PURE__ */ new Map(), V.set(e, r)), r.size >= tt && r.clear(), r.set(t, n), n;
}, U = "default", at = /[^A-Za-z0-9._&=-]/g, ot = /[^A-Za-z0-9._-]/g, st = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, W = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, st);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, ct = (e) => e === void 0 ? U : typeof e == "string" ? W(e, at) : Object.keys(e).sort().map((t) => `${W(t, ot)}=${W(String(e[t]), ot)}`).join("&"), lt = (e) => Array.isArray(e) ? e.length === 0 ? [U] : e.map(ct) : [ct(e)], ut = (e, t) => {
	for (let n of e) if (t(n)) return n;
	return t("default") ? U : e[0] ?? "default";
}, dt = (e, t, n, r) => {
	let i = e.split("/");
	return t.every((e, t) => e === "variant" ? i[t] === r : n?.item === void 0 || i[t] === String(n.item));
}, ft = (e) => typeof e == "object" && !!e && "qualifierTypes" in e && Array.isArray(e.qualifierTypes) && "content" in e, pt = (e, t) => {
	let n = t.split("/"), r = {
		key: e.key,
		content: e.content[t]
	};
...
} }, vt = () => _t, yt = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), bt = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : yt.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : bt(e ? `${e}.${String(n)}` : String(n)) }), xt = /* @__PURE__ */ new Set(), G = (e, t, n) => {
	let r = vt()[e];
	return r ? Ft(r, t, n) : (xt.has(e) || (x({ log: f })(typeof window > "u" ? `Dictionary ${_e(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), xt.add(e)), bt(e));
}, St = (e) => {
...
}, Et = K, Dt = K, Ot = K, kt = K, At = K;
process.env.INTLAYER_OPTIMIZED_NESTING;
var jt = (e) => K, Mt = K, Nt = (e, t = !0) => [
	Tt(e ?? u.defaultLocale, t ? u.defaultLocale : void 0),
	Et,
	Dt,
	Ot,
	jt(e ?? u.defaultLocale),
	Mt,
	kt,
	At
], Pt = (e, t, n = []) => T(e, {
	...
	let { locale: r, selector: i } = ht(t), a = rt(r ?? u.defaultLocale, gt(i), n), o = it(e, a);
	if (o.hit) return o.content;
	let s = n ?? Nt(r), c = mt(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
	...
	let n = {};
	for (let [t, r] of Object.entries(e)) It.has(t) || (n[t] = r);
	return n;
	...
	else if (m = q(c, p), m === void 0 && c === t && c !== Rt && (m = q(Rt, p)), m === void 0) return;
	let h;
	for (let t of zt(l, r?.lng ?? e, u, d, f)) {
		let e = P(m, t, i);
		if (e != null) {
			h = e;
			break;
	...
	x({ log: f })(`${S(e, v)}: the ${S("`resources`", v)} option is ignored when using ${S("@intlayer/i18next", _)} — translations are served from the compiled intlayer dictionaries instead. Remove the resource imports and the ${S("`resources`", v)} option to reduce your bundle size.`);
}, X = (e = {}) => {
	e.resources !== void 0 && Bt("createInstance");
	let t = u, n = e.lng ?? t?.defaultLocale ?? "en", r = e.defaultNS ?? (Array.isArray(e.ns) ? e.ns[0] : e.ns) ?? "translation", i = /* @__PURE__ */ new Map(), a = !1, o = (e, ...t) => {
		...
		async init(e, t) {
			...
			i.resources !== void 0 && Bt("i18next.init"), i.lng && (n = i.lng), i.defaultNS ? r = i.defaultNS : i.ns && (r = Array.isArray(i.ns) ? i.ns[0] : i.ns), a = !0, o("initialized", i);
			let s = l.t.bind(l);
...
var Vt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	let o = (t, n) => Y({
		locale: e,
		namespace: r,
		key: i ? `${i}.${t}` : t,
	...
	locale: Ht ?? u?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), Yt = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: o, isCookieEnabled: l }) => {
	let { locales: d, defaultLocale: f } = u ?? {}, [p, m] = s(e ?? Ht ?? t ?? f);
	i(() => {
		e && e !== p && m(e);
	}, [e]), i(() => {
		Jt();
...
}), { defaultLocale: Zt, locales: $ } = u ?? {}, Qt = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: o } = Qt(), s = t?.keyPrefix, { translate: c, i18n: l } = a(() => Vt({
		locale: r,
		setLocale: i,
		availableLocales: o ?? [],
		namespace: n,
...
}, en = ({ children: e, i18n: t }) => (t !== void 0 && x({ log: f })(`${S("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), c(Xt, { children: e }));
...
function nn() {
	let { t: e } = $t(), t = [
		{
			name: e("productsGrid.benchmarkDashboard"),
			desc: e("productsGrid.interactiveChartsAndTables"),
			price: "Free"
		},
		{
			name: e("productsGrid.bundleAnalyzer"),
			desc: e("productsGrid.uploadYourBuildOutput"),
			price: "$29/mo"
		},
		{
			name: e("productsGrid.migrationAssistant"),
			desc: e("productsGrid.automatedCodemodsAndGuides"),
			price: "$99 one-time"
		},
		{
			name: e("productsGrid.performanceMonitor"),
			desc: e("productsGrid.continuousPerformanceTrackingFor"),
			price: "$49/mo"
		}
	];
	return c("div", {
		...
		children: t.map((t) => l("div", {
			...
			children: [l("div", { children: [c("h3", {
				...
				children: [c("span", {
					...
					children: e("productsGrid.learnMore")
				})]
			})]
		}, t.name))
	});
