...
var Ht = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	let { locales: u, defaultLocale: f } = d ?? {}, [p, m] = c(e ?? Ut ?? t ?? f);
	i(() => {
		e && e !== p && m(e);
	}, [e]), i(() => {
		Yt();
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: a } = $t(), s = t?.keyPrefix, { translate: c, i18n: l } = o(() => Ht({
		locale: r,
		setLocale: i,
		availableLocales: a ?? [],
		namespace: n,
