...
S("✗", h), S("✓", g), S("⏲", m);
var ve = "translation", ye = "enumeration", be = "plural", C = "insertion", xe = "object", Se = "array", Ce = "markdown", w = "html", we = "gender", Te = "select", T = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), E = (e, t) => {
...
})() }), Ae = (e) => T(be, e), je = (e, t) => T(Te, e, { variable: t }), Me = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "plural") {
		let e = r[be];
		return R(Ke(e, Number(L(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[ye], i = Je.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[Te], i = L(t, typeof r.variable == "string" ? r.variable : "value");
	...
	i18next: Le,
	"vue-i18n": Ue
}, z = (e, t = {}, n = "en", r = "icu") => Qe($e[r])(e, t, n), et = /* @__PURE__ */ new WeakMap(), tt = 0, nt = (e) => {
	if (!e) return "base";
	let t = et.get(e);
	if (t) return t;
	tt += 1;
	let n = `p${tt}`;
	return et.set(e, n), n;
}, rt = 256, B = /* @__PURE__ */ new WeakMap(), it = (e) => typeof e == "object" && !!e, at = (e, t, n) => `${e}_${t}_${nt(n)}`, ot = (e, t) => {
	...
	if (!it(e)) return n;
	let r = B.get(e);
	return r || (r = /* @__PURE__ */ new Map(), B.set(e, r)), r.size >= rt && r.clear(), r.set(t, n), n;
}, st = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), H = "default", ct = /[^A-Za-z0-9._&=-]/g, lt = /[^A-Za-z0-9._-]/g, ut = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, U = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, ut);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, dt = (e) => e === void 0 ? H : typeof e == "string" ? U(e, ct) : Object.keys(e).sort().map((t) => `${U(t, lt)}=${U(String(e[t]), lt)}`).join("&"), ft = (e) => Array.isArray(e) ? e.length === 0 ? [H] : e.map(dt) : [dt(e)], pt = (e, t) => {
	...
	if (!ht(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? H : pt(ft(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => mt(e, n, t, s)).map((t) => gt(e, t));
	...
	yield e;
} : Ct(e ? `${e}.${String(n)}` : String(n)) }), wt = /* @__PURE__ */ new Set(), W = (e, t, n) => {
	let r = xt()[e];
	return r ? Vt(r, t, n) : (wt.has(e) || (x({ log: f })(typeof window > "u" ? `Dictionary ${_e(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), wt.add(e)), Ct(e));
}, Tt = (e) => {
	...
	if (G(e)) return e.nodeType === "html" ? e[w] : e[Ce];
}, kt = (e, t) => {
	if (typeof e == "string") return t;
	if (G(e)) {
		let n = e.nodeType === "html" ? w : Ce;
		return {
			...e,
			[n]: t
		};
...
}, Mt = K, Nt = K, Pt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? K : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: C }], i = e[C], a = {
			...
			transform: (e, n, r) => {
				if (G(e)) return (i) => At(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
var Lt = (e) => K, Rt = K, zt = (e, t = !0) => [
	jt(e ?? u.defaultLocale, t ? u.defaultLocale : void 0),
	Mt,
	Nt,
	Pt,
	Lt(e ?? u.defaultLocale),
	Rt,
	Ft,
	It
], Bt = (e, t, n = []) => E(e, {
	...
	let { locale: r, selector: i } = vt(t), a = at(r ?? u.defaultLocale, yt(i), n), o = ot(e, a);
	if (o.hit) return o.content;
	let s = n ?? zt(r), c = _t(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var Jt = ({ locale: e, setLocale: t, availableLocales: n, namespace: r, keyPrefix: i, dictionaryContent: a }) => {
	...
	locale: Yt ?? u?.defaultLocale,
	setLocale: () => null,
	isCookieEnabled: !0
}), tn = ({ locale: e, defaultLocale: t, variant: n, children: r, setLocale: a, disableEditor: o, isCookieEnabled: l }) => {
	let { locales: d, defaultLocale: f } = u ?? {}, [p, m] = s(e ?? Yt ?? t ?? f);
	i(() => {
		e && e !== p && m(e);
	}, [e]), i(() => {
		en();
...
}), { defaultLocale: rn, locales: $ } = u ?? {}, an = ({ isCookieEnabled: e, onLocaleChange: t } = {}) => {
	...
	let n = Array.isArray(e) ? e[0] ?? "translation" : e ?? "translation", { locale: r, setLocale: i, availableLocales: o } = an(), s = t?.keyPrefix, { translate: c, i18n: l } = a(() => Jt({
		locale: r,
		setLocale: i,
		availableLocales: o ?? [],
		namespace: n,
...
}, sn = ({ children: e, i18n: t }) => (t !== void 0 && x({ log: f })(`${S("I18nextProvider", v)}: the \`i18n\` prop has no effect with intlayer. Intlayer manages its own i18n instance — you can safely remove the prop.`), c(nn, { children: e }));
