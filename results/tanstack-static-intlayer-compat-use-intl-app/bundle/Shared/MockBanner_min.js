...
var d = /* @__PURE__ */ new WeakMap(), f = 0, te = (e) => {
	...
	let n = `p${f}`;
	return d.set(e, n), n;
}, p = 256, m = /* @__PURE__ */ new WeakMap(), ne = (e) => typeof e == "object" && !!e, re = (e, t, n) => `${e}_${t}_${te(n)}`, ie = (e, t) => {
...
}, ae = "translation", g = "enumeration", _ = "plural", v = "insertion", oe = "object", se = "array", ce = "markdown", y = "html", le = "gender", ue = "select", b = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), x = (e, t) => {
...
}, fe = (e, t) => e[de(e, t) ?? "fallback"], pe = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), S = "default", me = /[^A-Za-z0-9._&=-]/g, he = /[^A-Za-z0-9._-]/g, ge = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, C = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, ge);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, _e = (e) => e === void 0 ? S : typeof e == "string" ? C(e, me) : Object.keys(e).sort().map((t) => `${C(t, he)}=${C(String(e[t]), he)}`).join("&"), ve = (e) => Array.isArray(e) ? e.length === 0 ? [S] : e.map(_e) : [_e(e)], ye = (e, t) => {
	...
	if (!xe(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? S : ye(ve(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => be(e, n, t, s)).map((t) => Se(e, t));
...
}, D = "\x1B[0m", Ee = "\x1B[34m", De = "\x1B[31m", Oe = "\x1B[32m", ke = "\x1B[38;5;3m", Ae = "\x1B[36m", je = (e) => e, Me = (e, t) => {
...
}), k = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? D : n : D}` : e, Ne = (e, t = ke, n = D) => [e].flat().map((e) => k(e, t, n)).join(", ");
k("✗", De), k("✓", Oe), k("⏲", Ee);
var Pe = {
	"products-grid": {
		key: "products-grid",
	...
	let r = A()[e];
	return r ? it(r, t, n) : (M.has(e) || (O({ log: E })(typeof window > "u" ? `Dictionary ${Ne(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), M.add(e)), j(e));
...
var Be = (e, t, n) => e[I("PluralRules", n).select(t)] ?? e.other, Ve = (e, t) => {
	...
	if (L(e)) return e.nodeType === "html" ? e[y] : e[ce];
}, Ke = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, Je = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? R : {
...
}, Ye = R, Xe = R, Ze = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? R : {
	id: "insertion-plugin",
...
}, Qe = R, $e = R, et = (e) => R, tt = R, nt = (e, t = !0) => [
	Je(e ?? w.defaultLocale, t ? w.defaultLocale : void 0),
	Ye,
	Xe,
	Ze,
	...
	let { locale: r, selector: i } = we(t), a = re(r ?? w.defaultLocale, Te(i), n), o = ie(e, a);
	if (o.hit) return o.content;
	let s = n ?? nt(r), c = Ce(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
})() }), ut = (e) => b(_, e), dt = (e, t) => b(ue, e, { variable: t }), ft = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "enumeration") {
		let e = r[g], i = wt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	let i = Y(typeof e == "string" ? Dt[r](e) : e, t, n);
...
var Q = {
	...
	let { locales: ee, defaultLocale: u } = w ?? {}, [d, f] = s(e ?? zt ?? t ?? u);
	i(() => {
		e && e !== d && f(e);
	}, [e]), i(() => {
		Gt();
...
}), Yt = ({ locale: e, children: t, messages: n, formats: r, now: i, timeZone: a, onError: o, getMessageFallback: s }) => (n !== void 0 && O({ log: E })(`${k("IntlProvider", Ae)} do not pass the messages prop with intlayer. Messages are loaded automatically under the hood for bundle optimization reason`), l(Jt, {
	locale: e,
	children: t
}, String(e))), Xt = ((e) => {
	let { locale: t } = r($) ?? {};
	return a(() => Mt(t, e), [t, e]);
}), Zt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-use-intl-app/src/components/MockBanner.tsx", Qt = () => {
	let e = Xt();
	return u("div", {
...
}, $t = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-use-intl-app/scripts/Wrapper.tsx";
...
var tn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-use-intl-app/src/components/MockBanner.wrapper.tsx";
function nn() {
	return u(en, { children: u(Qt, {}, void 0, !1, {
		fileName: tn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
