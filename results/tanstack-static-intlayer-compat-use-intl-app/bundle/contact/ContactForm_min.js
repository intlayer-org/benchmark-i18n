...
var X = {
	...
	locale: e,
	children: t
}, String(e))), $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-use-intl-app/src/components/pages/contact/ContactForm.tsx";
function un() {
	let e = cn(te), t = cn(ne), n = s(), r = s(), i = s(), a = s();
	return p("form", {
		className: "space-y-6",
		children: [
			p("div", {
...
var pn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-use-intl-app/src/components/pages/contact/ContactForm.wrapper.tsx";
function mn() {
