...
var h = {
...
}, ee = /* @__PURE__ */ new WeakMap(), g = 0, te = (e) => {
	if (!e) return "base";
	let t = ee.get(e);
	if (t) return t;
	g += 1;
...
}, ye = (e) => e === void 0 ? w : typeof e == "string" ? T(e, ge) : Object.keys(e).sort().map((t) => `${T(t, _e)}=${T(String(e[t]), _e)}`).join("&"), be = (e) => Array.isArray(e) ? e.length === 0 ? [w] : e.map(ye) : [ye(e)], xe = (e, t) => {
	...
	if (!Ce(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? w : xe(be(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Se(e, n, t, s)).map((t) => we(e, t));
...
}, A = "\x1B[0m", De = "\x1B[34m", Oe = "\x1B[31m", ke = "\x1B[32m", Ae = "\x1B[38;5;3m", je = "\x1B[36m", Me = (e) => e, Ne = (e, t) => {
...
}), M = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? A : n : A}` : e, Pe = (e, t = Ae, n = A) => [e].flat().map((e) => M(e, t, n)).join(", ");
M("✗", Oe), M("✓", ke), M("⏲", De);
var Fe = {
	"products-grid": {
		key: "products-grid",
	...
	yield e;
} : Re(e ? `${e}.${String(n)}` : String(n)) }), ze = /* @__PURE__ */ new Set(), Be = (e, t, n) => {
	let r = Ie()[e];
	return r ? dt(r, t, n) : (ze.has(e) || (j({ log: k })(typeof window > "u" ? `Dictionary ${Pe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), ze.add(e)), Re(e));
...
function N(e, t, n) {
	let r = t ?? D?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = He.get(a);
...
var qe = (e, t, n) => e[N("PluralRules", n).select(t)] ?? e.other, Je = (e, t) => {
	...
	if (P(e)) return e.nodeType === "html" ? e[x] : e[ue];
}, $e = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, tt = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? F : {
...
}, I = F, nt = (e) => F, rt = F, it = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? F : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: b }], i = e[b], a = {
			...
			transform: (e, n, r) => {
				if (P(e)) return (i) => et(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, at = F, ot = F, st = (e) => F, ct = F, lt = (e, t = !0) => [
	...
	let { locale: r, selector: i } = Ee(t), a = ie(r ?? D.defaultLocale, E(i), n), o = ae(e, a);
	if (o.hit) return o.content;
	let s = n ?? lt(r), c = Te(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
})() }), bt = (e) => S(se, e), xt = (e, t) => S(fe, e, { variable: t }), St = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "enumeration") {
		let e = r[y], i = Nt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	let i = J(typeof e == "string" ? It[r](e) : e, t, n);
	...
	return Wt(e, (t) => Ht(e, n ?? "", i, t), (e) => t ? `${t}.${e}` : e);
}, Ht = (e, t, n, r) => {
	let i = t, a = n ? `${n}.${r}` : r, o = Ie();
	if (!i) {
		let [t, ...n] = r.split(".");
	...
	return Object.assign((e, t) => r(e, t) ?? n(e), {
		...
		rich: (e, t) => {
			...
			return o === void 0 ? n(e) : d(u, { children: zt(Y(o), a) });
		},
		markup: (e, t) => {
			let { scalarValues: i, renderers: a } = Rt(t), o = r(e, i);
...
}, Yt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? F : {
	id: "insertion-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "insertion",
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: b }], i = e[b], a = {
...
}, Xt = F, Zt = F, X = /* @__PURE__ */ new Map(), Qt = (e, t = !0) => {
	...
	return X.set(n, r), r;
}, $t = (e, t) => dt(e, t, Qt(typeof t == "object" && t ? t.locale : t)), en = (e) => {
...
var Z = {
	...
	if (!nn) for (let t = 0; t < (O.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(O.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, an = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !nn && O.storage.cookies) for (let n = 0; n < O.storage.cookies.length; n++) {
	...
	let { locales: c, defaultLocale: u } = D ?? {}, [f, p] = l(e ?? on ?? t ?? u);
	o(() => {
		e && e !== f && p(e);
	}, [e]), o(() => {
		fn();
	...
	let { locale: n } = a(Q) ?? {};
	return Ut(n, gn(e), t);
}), vn = ({ locale: e, children: t, messages: n, formats: r, now: i, timeZone: a, onError: o, getMessageFallback: s }) => (n !== void 0 && j({ log: k })(`${M("IntlProvider", je)} do not pass the messages prop with intlayer. Messages are loaded automatically under the hood for bundle optimization reason`), d(hn, {
	locale: e,
	children: t
}, String(e))), yn = ((e) => {
	let { locale: t } = a(Q) ?? {};
	return s(() => Vt(t, e), [t, e]);
}), bn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-use-intl-app/src/components/MockBanner.tsx", xn = () => {
	let e = yn();
	return m("div", {
...
}, $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-use-intl-app/src/components/pages/faq/FAQHeader.tsx";
function Sn() {
	let e = _n(h);
	return m(p, { children: [
		m(xn, {}, void 0, !1, {
...
var Cn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-use-intl-app/scripts/Wrapper.tsx";
...
var Tn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-use-intl-app/src/components/pages/faq/FAQHeader.wrapper.tsx";
function En() {
	return m(wn, { children: m(Sn, {}, void 0, !1, {
		fileName: Tn,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
