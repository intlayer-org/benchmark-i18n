...
}, ae = "translation", oe = "enumeration", se = "plural", v = "insertion", ce = "object", le = "array", y = "markdown", b = "html", x = "gender", ue = "select", S = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), C = (e, t) => {
...
}), O = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? De : n : De}` : e;
O("✗", ke), O("✓", Ae), O("⏲", Oe);
...
function k(e, t, n) {
	let r = t ?? E?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = Ie.get(a);
...
var Ve = (e, t, n) => e[k("PluralRules", n).select(t)] ?? e.other, He = (e, t) => {
	...
	if (A(e)) return e.nodeType === "html" ? e[b] : e[y];
}, qe = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, Ye = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? j : {
...
}, M = j, Xe = (e) => j, N = j, Ze = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? j : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: v }], i = e[v], a = {
			...
			transform: (e, n, r) => {
				if (A(e)) return (i) => Je(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, P = j, F = j, I = (e) => j, L = j, Qe = (e, t = !0) => [
	Ye(e ?? E.defaultLocale, t ? E.defaultLocale : void 0),
	M,
	N,
	Ze,
	I(e ?? E.defaultLocale),
	...
	let { locale: r, selector: i } = we(t), a = re(r ?? E.defaultLocale, Te(i), n), o = ie(e, a);
...
}, tt = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", R = /\{\{\s*(.*?)\s*\}\}/g, nt = (e, t = {}) => {
...
})() }), ct = (e) => S(se, e), lt = (e, t) => S(ue, e, { variable: t }), ut = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	if (r.nodeType === "plural") {
		let e = r[se];
		return Y(Ve(e, Number(J(t, "count") ?? 1), n), t, n);
	}
...
}, Rt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? j : {
	id: "insertion-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "insertion",
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: v }], i = e[v], a = {
...
}, zt = j, Bt = j, Z = /* @__PURE__ */ new Map(), Vt = (e, t = !0) => {
	let n = `${e ?? E.defaultLocale}_${t}`;
	if (Z.has(n)) return Z.get(n);
	let r = [
		Ye(e ?? E.defaultLocale, t ? E.defaultLocale : void 0),
		M,
		Xe(e ?? E.defaultLocale),
		N,
		I(e ?? E.defaultLocale),
		L,
		P,
	...
	return Z.set(n, r), r;
}, Ht = (e, t) => et(e, t, Vt(typeof t == "object" && t ? t.locale : t)), Ut = (e) => {
...
var Q = {
	...
	if (!Gt) for (let t = 0; t < (D.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(D.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, qt = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !Gt && D.storage.cookies) for (let n = 0; n < D.storage.cookies.length; n++) {
	...
	let { locale: n, variant: r } = a($) ?? {}, i = t ?? n, o = typeof i == "object" && i ? `${i.locale ?? ""}|${Te(i)}` : i;
	return s(() => Ht(e, i), [e.key, o]);
}, on = ((e, t) => {
	let { locale: n } = a($) ?? {};
	return Mt(n, an(e), t);
}), sn = ({ locale: e, children: t, messages: n, formats: r, now: i, timeZone: a, onError: o, getMessageFallback: s }) => (n !== void 0 && Pe({ log: Ee })(`${O("IntlProvider", je)} do not pass the messages prop with intlayer. Messages are loaded automatically under the hood for bundle optimization reason`), d(rn, {
	locale: e,
	children: t
}, String(e)));
function cn() {
		...
		children: t.map((t) => f("div", {
			...
			children: [
				...
				d("ul", {
					...
					children: t.features.map((e) => f("li", {
