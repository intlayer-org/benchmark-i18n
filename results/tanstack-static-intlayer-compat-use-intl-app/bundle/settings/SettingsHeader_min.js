...
var h = {
...
}, g = /* @__PURE__ */ new WeakMap(), te = 0, ne = (e) => {
	if (!e) return "base";
	let t = g.get(e);
	if (t) return t;
	te += 1;
...
}, se = "translation", y = "enumeration", ce = "plural", b = "insertion", le = "object", ue = "array", de = "markdown", x = "html", fe = "gender", pe = "select", S = (e, t, n) => ({
	...n,
	nodeType: e,
	[e]: t
}), C = (e, t) => {
...
}, he = (e, t) => e[me(e, t) ?? "fallback"], ge = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), w = "default", _e = /[^A-Za-z0-9._&=-]/g, ve = /[^A-Za-z0-9._-]/g, ye = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, T = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, ye);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, be = (e) => e === void 0 ? w : typeof e == "string" ? T(e, _e) : Object.keys(e).sort().map((t) => `${T(t, ve)}=${T(String(e[t]), ve)}`).join("&"), xe = (e) => Array.isArray(e) ? e.length === 0 ? [w] : e.map(be) : [be(e)], Se = (e, t) => {
	...
	if (!we(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? w : Se(xe(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Ce(e, n, t, s)).map((t) => Te(e, t));
...
}, A = "\x1B[0m", Oe = "\x1B[34m", ke = "\x1B[31m", Ae = "\x1B[32m", je = "\x1B[38;5;3m", Me = "\x1B[36m", Ne = (e) => e, Pe = (e, t) => {
...
}), M = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? A : n : A}` : e, Fe = (e, t = je, n = A) => [e].flat().map((e) => M(e, t, n)).join(", ");
M("✗", ke), M("✓", Ae), M("⏲", Oe);
var Ie = {
	"products-grid": {
		key: "products-grid",
	...
	yield e;
} : ze(e ? `${e}.${String(n)}` : String(n)) }), Be = /* @__PURE__ */ new Set(), Ve = (e, t, n) => {
	let r = Le()[e];
	return r ? ft(r, t, n) : (Be.has(e) || (j({ log: k })(typeof window > "u" ? `Dictionary ${Fe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Be.add(e)), ze(e));
}, He = 50, Ue = /* @__PURE__ */ new Map(), We = /* @__PURE__ */ new Set(), Ge = (e) => {
...
var Je = (e, t, n) => e[N("PluralRules", n).select(t)] ?? e.other, Ye = (e, t) => {
	...
	if (P(e)) return e.nodeType === "html" ? e[x] : e[de];
}, et = (e, t) => {
...
}, nt = F, rt = (e) => F, it = F, at = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? F : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: b }], i = e[b], a = {
			...
			transform: (e, n, r) => {
				if (P(e)) return (i) => tt(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, ot = F, st = F, ct = (e) => F, lt = F, ut = (e, t = !0) => [
	...
	let { locale: r, selector: i } = De(t), a = ae(r ?? D.defaultLocale, E(i), n), o = oe(e, a);
	if (o.hit) return o.content;
	let s = n ?? ut(r), c = Ee(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
	...
	"track",
	"wbr"
]), yt = /<(\/)?([a-zA-Z][a-zA-Z0-9.-]*)\s*((?:[^\n]|\n(?!\n))*?)(\/?)>/g, bt = (e) => {
	let t = [], n = [];
	for (let r of e.matchAll(yt)) {
...
})() }), xt = (e) => S(ce, e), St = (e, t) => S(pe, e, { variable: t }), Ct = (e) => {
	let t = 0, n = () => {
		let n = [], i = "";
		for (; t < e.length;) {
			let a = e[t];
	...
	return String(e);
}, It = (e, t = {}, n = "en") => e.replace(/\{\{\s*([^{}]+?)\s*\}\}/g, (e, n) => {
	let r = K(t, n);
	...
	if (r.nodeType === "enumeration") {
		let e = r[y], i = Pt.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	let i = J(typeof e == "string" ? Lt[r](e) : e, t, n);
	...
	if (typeof e == "string") return e;
	let n = Vt(e.children, t), r = t[e.tag];
	return typeof r == "function" ? r(n) : n;
}).join(""), Ht = (e, t) => {
	let [n, ...r] = (t ?? "").split("."), i = r.join(".");
	return Gt(e, (t) => Ut(e, n ?? "", i, t), (e) => t ? `${t}.${e}` : e);
}, Ut = (e, t, n, r) => {
	let i = t, a = n ? `${n}.${r}` : r, o = Le();
	if (!i) {
		let [t, ...n] = r.split(".");
	...
	let r = (e) => n ? `${n}.${e}` : e;
	return Gt(e, (e) => W(t, r(e)), r);
}, Gt = (e, t, n) => {
	let r = (n, r = {}) => {
		let i = t(n);
		if (i != null) return Rt(i, r, e, "icu");
	};
	return Object.assign((e, t) => r(e, t) ?? n(e), {
		...
		rich: (e, t) => {
			...
			return o === void 0 ? n(e) : d(u, { children: Bt(Y(o), a) });
		},
		markup: (e, t) => {
			let { scalarValues: i, renderers: a } = zt(t), o = r(e, i);
			return o === void 0 ? n(e) : Vt(Y(o), a);
		}
	});
}, Kt = ({ children: e, value: t, additionalProps: n }) => {
...
}, Zt = F, Qt = F, X = /* @__PURE__ */ new Map(), $t = (e, t = !0) => {
	...
	return X.set(n, r), r;
}, en = (e, t) => ft(e, t, $t(typeof t == "object" && t ? t.locale : t)), tn = (e) => {
...
var Z = {
	...
	if (!rn) for (let t = 0; t < (O.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(O.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, on = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !rn && O.storage.cookies) for (let n = 0; n < O.storage.cookies.length; n++) {
...
}, mn = (e, t = D?.locales, n = D?.defaultLocale) => {
	...
	let { locale: n } = a(Q) ?? {};
	return Wt(n, _n(e), t);
}), yn = ({ locale: e, children: t, messages: n, formats: r, now: i, timeZone: a, onError: o, getMessageFallback: s }) => (n !== void 0 && j({ log: k })(`${M("IntlProvider", Me)} do not pass the messages prop with intlayer. Messages are loaded automatically under the hood for bundle optimization reason`), d(gn, {
	locale: e,
	children: t
}, String(e))), bn = ((e) => {
	let { locale: t } = a(Q) ?? {};
	return s(() => Ht(t, e), [t, e]);
}), xn = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-use-intl-app/src/components/MockBanner.tsx", Sn = () => {
	let e = bn();
	return m("div", {
...
var En = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/intlayer-compat-use-intl-app/src/components/pages/settings/SettingsHeader.wrapper.tsx";
function Dn() {
	return m(Tn, { children: m(Cn, {}, void 0, !1, {
		fileName: En,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
