...
var v = () => {}, y = ee;
function ee({ initialLocale: e, initialTranslations: t = {}, router: r, children: a }) {
	let [c, l] = o(() => e || (typeof window < "u" ? g() : "en")), [u, d] = o(t), [f, m] = o(!1);
	h.debug(`LingoProvider initialized with locale: ${c}`, t), i(() => {
	...
	let y = n(async (e) => {
		if (!(Object.keys(t).length > 0)) {
			...
			try {
				...
				let n = await t.json();
				d(n.entries || n), h.debug(`Loaded translations for ${e}:`, Object.keys(n.entries || n).length);
			} catch (t) {
				h.error(`Failed to load translations for ${e}:`, t), d({});
			} finally {
				m(!1);
			}
		}
...
function ae(e, t) {
	...
	return T(e, this, n, t.cache.create(), t.serializer);
}
function oe(e, t) {
	return T(e, this, ie, t.cache.create(), t.serializer);
}
function se(e, t) {
	return T(e, this, re, t.cache.create(), t.serializer);
}
var ce = function() {
...
var Te = RegExp(`^${z.source}*`), Ee = RegExp(`${z.source}*\$`);
function G(e, t) {
	return {
		start: e,
		end: t
...
var Fe = function() {
	...
	return e.prototype.parse = function() {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !K(this.char())) return this.error(D.INVALID_TAG, G(o, this.clonePosition()));
				...
				return r === this.parseTagName() ? (this.bumpSpace(), this.bumpIf(">") ? {
					...
					err: null
				} : this.error(D.INVALID_TAG, G(o, this.clonePosition()))) : this.error(D.UNMATCHED_CLOSING_TAG, G(s, this.clonePosition()));
			}
		...
		var n = this.clonePosition();
		if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(D.EXPECT_ARGUMENT_CLOSING_BRACE, G(n, this.clonePosition()));
		if (this.char() === 125) return this.bump(), this.error(D.EMPTY_ARGUMENT, G(n, this.clonePosition()));
		var r = this.parseIdentifierIfPossible().value;
		if (!r) return this.error(D.MALFORMED_ARGUMENT, G(n, this.clonePosition()));
		if (this.bumpSpace(), this.isEOF()) return this.error(D.EXPECT_ARGUMENT_CLOSING_BRACE, G(n, this.clonePosition()));
		switch (this.char()) {
			...
			case 44: return this.bump(), this.bumpSpace(), this.isEOF() ? this.error(D.EXPECT_ARGUMENT_CLOSING_BRACE, G(n, this.clonePosition())) : this.parseArgumentOptions(e, t, r, n);
			default: return this.error(D.MALFORMED_ARGUMENT, G(n, this.clonePosition()));
		}
		...
		switch (a) {
			case "": return this.error(D.EXPECT_ARGUMENT_TYPE, G(i, o));
			case "number":
			case "date":
			case "time":
				this.bumpSpace();
				...
				if (this.bumpIf(",")) {
					...
					if (l.err) return l;
					var u = Me(l.val);
					if (u.length === 0) return this.error(D.EXPECT_ARGUMENT_STYLE, G(this.clonePosition(), this.clonePosition()));
					s = {
						style: u,
			...
			case "select":
				...
				if (this.bumpSpace(), !this.bumpIf(",")) return this.error(D.EXPECT_SELECT_ARGUMENT_OPTIONS, G(h, S({}, h)));
				this.bumpSpace();
				var g = this.parseIdentifierIfPossible(), _ = 0;
				if (a !== "select" && g.value === "offset") {
					if (!this.bumpIf(":")) return this.error(D.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, G(this.clonePosition(), this.clonePosition()));
					this.bumpSpace();
			...
			default: return this.error(D.INVALID_ARGUMENT_TYPE, G(i, o));
		}
	}, e.prototype.tryParseArgumentClose = function(e) {
		return this.isEOF() || this.char() !== 125 ? this.error(D.EXPECT_ARGUMENT_CLOSING_BRACE, G(e, this.clonePosition())) : (this.bump(), {
			val: !0,
			err: null
		});
		...
		for (var e = 0, t = this.clonePosition(); !this.isEOF();) switch (this.char()) {
			case 39:
				this.bump();
				var n = this.clonePosition();
				if (!this.bumpUntil("'")) return this.error(D.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, G(n, this.clonePosition()));
				this.bump();
				break;
			case 123:
				e += 1, this.bump();
		...
		for (var i, a = !1, o = [], s = /* @__PURE__ */ new Set(), c = r.value, l = r.location;;) {
			...
			if (!this.bumpIf("{")) return this.error(t === "select" ? D.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT : D.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT, G(this.clonePosition(), this.clonePosition()));
		...
		return o.length === 0 ? this.error(t === "select" ? D.EXPECT_SELECT_ARGUMENT_SELECTOR : D.EXPECT_PLURAL_ARGUMENT_SELECTOR, G(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !a ? this.error(D.MISSING_OTHER_CLAUSE, G(this.clonePosition(), this.clonePosition())) : {
			val: o,
			err: null
		};
...
function q(e) {
	e.forEach(function(e) {
		...
		else j(e) && L(e.style) || (M(e) || N(e)) && R(e.style) ? delete e.style.location : I(e) && q(e.children);
	});
}
function ze(e, t) {
	t === void 0 && (t = {}), t = S({
...
function Xe(e) {
	let t = {};
	for (let [n, r] of Object.entries(e)) t[n] = typeof r == "function" ? Ye(r) : r;
	return t;
}
function Ze(t, n, r) {
	try {
		let i = new Je(t, r), a = Xe(n), o = i.format(a);
					...
					children: [
						...
						c("div", {
							...
							children: [c("button", {
								...
								onMouseLeave: () => n(!1),
								onClick: () => n(!t),
								children: [e("5a01d1dcc7d0", "Mock Pages"), s(f, {
									size: 14,
