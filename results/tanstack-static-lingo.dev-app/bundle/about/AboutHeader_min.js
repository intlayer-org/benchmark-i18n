...
var h = () => {}, g = _;
function _({ initialLocale: e, initialTranslations: t = {}, router: r, children: a }) {
	let [s, l] = o(() => e || (typeof window < "u" ? p() : "en")), [d, g] = o(t), [_, v] = o(!1);
	f.debug(`LingoProvider initialized with locale: ${s}`, t), i(() => {
...
function qe(t, n, r) {
	try {
		let i = new We(t, r), a = Ke(n), o = i.format(a);
		return Array.isArray(o) ? o.map((t, n) => c(e, { children: t }, n)) : o;
	} catch (e) {
...
function Xe() {
	let { t: e } = Je(["d69a92e868dc", "4371fc3273ff"]);
	return Ye("AboutHeader"), l(s, { children: [c("h1", {
