...
var g = 200, _ = v;
function v({ initialLocale: t, initialTranslations: n = {}, router: i, devWidget: o, children: u }) {
	let [f, _] = c(() => t || m()), [v, y] = c(n), [b, x] = c(!1), [S, C] = c(/* @__PURE__ */ new Set()), w = s(/* @__PURE__ */ new Set()), T = s(/* @__PURE__ */ new Set()), E = s(/* @__PURE__ */ new Set()), D = s(null), O = s(n), k = s(f);
	a(() => {
		O.current = v;
	}, [v]), a(() => {
		k.current = f;
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingo.dev-app/src/components/pages/home/Hero.tsx";
function Qe() {
	let { t: e } = Xe([
		"4ccfa10a4fe6",
		"ac2276d78a33",
...
var tt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingo.dev-app/src/components/pages/home/Hero.wrapper.tsx";
function nt() {
	return u(et, { children: u(Qe, {}, void 0, !1, {
		fileName: tt,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
