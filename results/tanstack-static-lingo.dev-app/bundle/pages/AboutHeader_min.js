...
function x({ initialLocale: t, initialTranslations: n = {}, router: i, children: o }) {
	let [s, l] = c(() => t || (typeof window < "u" ? h() : "en")), [d, p] = c(n), [m, v] = c(!1);
...
function S({ initialLocale: t, initialTranslations: n = {}, router: i, devWidget: o, children: l }) {
	let [d, p] = c(() => t || h()), [_, v] = c(n), [b, x] = c(!1), [S, C] = c(/* @__PURE__ */ new Set()), w = s(/* @__PURE__ */ new Set()), T = s(/* @__PURE__ */ new Set()), E = s(/* @__PURE__ */ new Set()), D = s(null), O = s(n), k = s(d);
	a(() => {
		O.current = _;
	}, [_]), a(() => {
		k.current = d;
...
var V = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, pe = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function me(e) {
	var t = {};
...
var H = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, U = /^(@+)?(\+|#+)?[rs]?$/g, ve = /(\*)(0+)|(#+)(0+)|(0+)/g, W = /^(0+)$/;
function ye(e) {
	var t = {};
...
function Ce(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		if (H.test(i.stem)) {
			...
			i.stem.replace(H, function(e, n, r, i, a, o) {
...
var Ee = RegExp(`^${V.source}*`), De = RegExp(`${V.source}*\$`);
function K(e, t) {
	return {
		start: e,
		end: t
...
function J(e) {
	e.forEach(function(e) {
		if (delete e.location, de(e) || L(e)) for (var t in e.options) delete e.options[t].location, J(e.options[t].value);
		else ce(e) && z(e.style) || (le(e) || ue(e)) && B(e.style) ? delete e.style.location : R(e) && J(e.children);
	});
}
function Be(e, t) {
	t === void 0 && (t = {}), t = T({
...
function Q(e, t, n, r, i, a, o) {
	...
	for (var s = [], c = 0, l = e; c < l.length; c++) {
		...
		if (le(u)) {
			var p = typeof u.style == "string" ? r.date[u.style] : B(u.style) ? u.style.parsedOptions : void 0;
			s.push({
				type: Z.literal,
		...
		if (ue(u)) {
			var p = typeof u.style == "string" ? r.time[u.style] : B(u.style) ? u.style.parsedOptions : r.time.medium;
			s.push({
				type: Z.literal,
				value: n.getDateTimeFormat(t, p).format(f)
			});
		...
		if (ce(u)) {
			var p = typeof u.style == "string" ? r.number[u.style] : z(u.style) ? u.style.parsedOptions : void 0;
...
function Qe(n, r, i) {
	try {
		...
		return Array.isArray(o) ? o.map((e, n) => u(t, { children: e }, n)) : o;
	} catch (t) {
...
function tt() {
	let { t: e } = $e(["d69a92e868dc", "4371fc3273ff"]);
	return et("AboutHeader"), d(l, { children: [u("h1", {
