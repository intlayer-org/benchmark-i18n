...
var _ = 200, v = y;
function y({ initialLocale: t, initialTranslations: n = {}, router: i, devWidget: o, children: u }) {
	let [d, p] = c(() => t || h()), [v, y] = c(n), [b, x] = c(!1), [S, ee] = c(/* @__PURE__ */ new Set()), C = s(/* @__PURE__ */ new Set()), w = s(/* @__PURE__ */ new Set()), T = s(/* @__PURE__ */ new Set()), E = s(null), D = s(n), O = s(d);
	a(() => {
		D.current = v;
	}, [v]), a(() => {
		O.current = d;
	...
	return a(() => {
		o?.enabled !== !1 && import("./lingo-dev-widget-C3EvpmD3.js").catch((t) => {
...
var z = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, fe = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function pe(e) {
	var t = {};
...
var B = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, V = /^(@+)?(\+|#+)?[rs]?$/g, _e = /(\*)(0+)|(#+)(0+)|(0+)/g, H = /^(0+)$/;
function U(e) {
	var t = {};
...
function xe(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		if (B.test(i.stem)) {
			...
			var a = i.options[0];
			a === "w" ? t = S(S({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = S(S({}, t), U(a)));
			continue;
		}
		if (V.test(i.stem)) {
			t = S(S({}, t), U(i.stem));
...
function q(e) {
	e.forEach(function(e) {
		if (delete e.location, P(e) || F(e)) for (var t in e.options) delete e.options[t].location, q(e.options[t].value);
		else le(e) && L(e.style) || (ue(e) || N(e)) && R(e.style) ? delete e.style.location : I(e) && q(e.children);
	});
}
function Re(e, t) {
	t === void 0 && (t = {}), t = S({
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingo.dev-app/src/components/pages/about/AboutHeader.tsx";
function $e() {
	let { t: e } = Ze(["d69a92e868dc", "4371fc3273ff"]);
	return Qe("AboutHeader"), d(u, { children: [d("h1", {
		className: "mb-4 text-3xl font-bold text-foreground",
		children: e("d69a92e868dc", "About This Benchmark")
	}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 7
		...
		children: e("4371fc3273ff", "This is an open-source test application — not a product or a company. Its sole purpose is to provide a realistic, multi-page React app where different i18n libraries can be integrated and measured under identical conditions.")
	}, void 0, !1, {
		fileName: $,
		lineNumber: 10,
		columnNumber: 7
...
var et = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingo.dev-app/scripts/Wrapper.tsx";
...
var nt = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingo.dev-app/src/components/pages/about/AboutHeader.wrapper.tsx";
function rt() {
	return d(tt, { children: d($e, {}, void 0, !1, {
		fileName: nt,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
