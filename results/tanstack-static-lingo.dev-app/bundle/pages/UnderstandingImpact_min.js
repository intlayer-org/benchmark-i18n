			...
			l("div", {
				...
				children: [
					...
					l("ul", {
						...
						children: [
							c("li", { children: e("9575d5a89d9f", "The JSON must be parsed on every page load — blocking the main thread.") }),
							c("li", { children: e("0c5eb8fa5db9", "Context-based architectures can cause cascading re-renders when the locale changes, because every consumer is notified even if their specific keys didn't change.") }),
							c("li", { children: e("8e2ff24cfaef", "During server-side rendering, the full dictionary is serialized into the HTML payload, increasing the document size that must be downloaded and hydrated.") })
						]
					})
				]
			}),
			l("div", {
				...
				children: [
					...
					l("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							c("li", { children: e("aeac40ef060c", "<strong0>Waterfall requests:</strong0> the app must first load, determine the locale, then fetch the right chunk — adding network round-trips.", { strong0: (e) => c("strong", {
								className: "text-foreground",
								children: e
							}) }) }),
							c("li", { children: e("feba9a47b3b1", "<strong0>Flash of untranslated content (FOUC): </strong0> users may briefly see translation keys or a fallback language before the chunk arrives.", { strong0: (e) => c("strong", {
								className: "text-foreground",
								children: e
							}) }) }),
							c("li", { children: e("16f5b009ee51", "<strong0>Cache invalidation:</strong0> updating translations requires cache-busting strategies to ensure users get fresh content without re-downloading unchanged chunks.", { strong0: (e) => c("strong", {
								className: "text-foreground",
								children: e
							}) }) })
						]
