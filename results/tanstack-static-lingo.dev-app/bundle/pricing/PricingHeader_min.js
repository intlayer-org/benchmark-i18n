...
function et() {
	let { t: e } = Qe(["6224437030b1", "fd52dee903fd"]);
	return u(c, { children: [l($e, {}), u("div", {
		className: "mb-12 text-center",
		children: [l("h1", {
			className: "mb-3 text-3xl font-bold text-foreground",
			children: e("6224437030b1", "Simple, Transparent Pricing")
		}), l("p", {
			className: "text-muted-foreground",
			children: e("fd52dee903fd", "Choose the plan that fits your team. No hidden fees.")
		})]
	})] });
}
