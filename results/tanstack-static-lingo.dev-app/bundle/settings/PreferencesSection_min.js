		...
		children: [s("h2", {
			...
			children: [
				...
				c("div", { children: [s("label", {
					...
					children: [
						s("option", { children: e("7befbbae6794", "English (en)") }),
						s("option", { children: e("8545d83f3e07", "French (fr)") }),
						s("option", { children: e("bf4335e69758", "German (de)") }),
						s("option", { children: e("bd284ebd791f", "Spanish (es)") }),
						s("option", { children: e("44688c9d5f6f", "Japanese (ja)") }),
						s("option", { children: e("2d4bfd1535a4", "Chinese Simplified (zh-CN)") }),
						s("option", { children: e("fd6304ee4dc3", "Arabic (ar)") })
					]
				})] })
			]
		})]
