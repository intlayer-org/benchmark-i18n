...
function LingoProvider__Dev({ initialLocale, initialTranslations = {}, router, devWidget, children }) {
	...
	useEffect(() => {
		...
		batchTimerRef.current = setTimeout(async () => {
			...
			setIsLoading(true);
			try {
				const newTranslations = await fetchTranslations(localeRef.current, hashesToFetch, void 0);
	...
	const setLocale = useCallback(async (newLocale) => {
		...
		try {
			logger.info(`Fetching translations for locale: ${newLocale}. Server url: undefined`);
			const translatedDict = await fetchTranslations(newLocale, [], void 0);
	...
	useEffect(() => {
		if (typeof window !== "undefined" && devWidget?.enabled !== false) {
			...
			window.__LINGO_DEV_WS_URL__ = void 0;
...
function matchIdentifierAtIndex(s, index) {
	...
	return (_a = IDENTIFIER_PREFIX_RE.exec(s)[1]) !== null && _a !== void 0 ? _a : "";
}
var Parser = function() {
...
var intl_messageformat_default = function() {
...
function renderRichText(text, params, locale) {
	try {
		const formatter = new intl_messageformat_default(text, locale);
		...
		if (Array.isArray(result)) return result.map((item, index) => {
			return jsx(Fragment, { children: item }, index);
		});
		return result;
	} catch (error) {
...
var _jsxFileName$2 = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingo.dev-app/src/components/pages/team/TeamGrid.tsx";
function TeamGrid() {
		...
		children: [
			jsxDEV("div", {
				...
				children: [
					...
					jsxDEV("h3", {
						...
						children: t("0a36d3cf09cc", "Sarah Chen")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 9,
						columnNumber: 9
					...
					jsxDEV("p", {
						...
						children: t("4e28477ee5d2", "Founder & Lead Engineer")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 10,
						columnNumber: 9
					...
					jsxDEV("p", {
						...
						children: t("cc23bd717c60", "Former Google engineer with 10 years of experience building internationalization systems at scale.")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 11,
						columnNumber: 9
			...
			jsxDEV("div", {
				...
				children: [
					...
					jsxDEV("h3", {
						className: "text-base font-semibold text-foreground",
						children: t("01ba85b9290a", "Marcus Weber")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 15,
						columnNumber: 9
					...
					jsxDEV("p", {
						className: "mb-2 text-xs font-medium text-primary",
						children: t("961573fec173", "Performance Engineer")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 16,
						columnNumber: 9
					...
					jsxDEV("p", {
						className: "text-sm text-muted-foreground",
						children: t("185ca8709747", "Specializes in JavaScript performance optimization and benchmarking methodology. Previously at Vercel.")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 17,
						columnNumber: 9
			...
			jsxDEV("div", {
				...
				children: [
					...
					jsxDEV("h3", {
						className: "text-base font-semibold text-foreground",
						children: t("a17b0c01f5aa", "Aisha Patel")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 21,
						columnNumber: 9
					...
					jsxDEV("p", {
						className: "mb-2 text-xs font-medium text-primary",
						children: t("388f3af70d50", "Developer Advocate")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 22,
						columnNumber: 9
					...
					jsxDEV("p", {
						className: "text-sm text-muted-foreground",
						children: t("afc15f93ec2e", "Passionate about developer experience and education. Speaker at React Conf, JSConf, and i18nNext.")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 23,
						columnNumber: 9
			...
			jsxDEV("div", {
				...
				children: [
					...
					jsxDEV("h3", {
						className: "text-base font-semibold text-foreground",
						children: t("9a8a9de3b9e7", "Tomás Rodríguez")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 27,
						columnNumber: 9
					...
					jsxDEV("p", {
						className: "mb-2 text-xs font-medium text-primary",
						children: t("4cfa582556d4", "Full-Stack Developer")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 28,
						columnNumber: 9
					...
					jsxDEV("p", {
						className: "text-sm text-muted-foreground",
						children: t("416afb18ce71", "Maintains the benchmarking infrastructure and CI/CD pipeline. Open source contributor to Lingui.")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 29,
						columnNumber: 9
			...
			jsxDEV("div", {
				...
				children: [
					...
					jsxDEV("h3", {
						className: "text-base font-semibold text-foreground",
						children: t("ed9071bb2411", "Yuki Tanaka")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 33,
						columnNumber: 9
					...
					jsxDEV("p", {
						className: "mb-2 text-xs font-medium text-primary",
						children: t("f5a2d303cab4", "Data Analyst")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 34,
						columnNumber: 9
					...
					jsxDEV("p", {
						className: "text-sm text-muted-foreground",
						children: t("3af1547c298b", "Ensures statistical rigor in all benchmark results. PhD in Applied Statistics from MIT.")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 35,
						columnNumber: 9
			...
			jsxDEV("div", {
				...
				children: [
					...
					jsxDEV("h3", {
						className: "text-base font-semibold text-foreground",
						children: t("83f20f6d0de0", "Elena Kowalski")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 39,
						columnNumber: 9
					...
					jsxDEV("p", {
						className: "mb-2 text-xs font-medium text-primary",
						children: t("57665295b26e", "Community Manager")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 40,
						columnNumber: 9
					...
					jsxDEV("p", {
						className: "text-sm text-muted-foreground",
						children: t("5dfd573d37b2", "Manages community contributions, partnerships, and events. Background in open source governance.")
					}, void 0, false, {
						fileName: _jsxFileName$2,
						lineNumber: 41,
						columnNumber: 9
...
var _jsxFileName = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingo.dev-app/src/components/pages/team/TeamGrid.wrapper.tsx";
function Wrapped() {
