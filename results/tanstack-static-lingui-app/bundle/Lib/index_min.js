...
var k = (e) => typeof e == "string", re = (e) => typeof e == "function", A = /* @__PURE__ */ new Map(), j = "en";
function M(e) {
...
var z = /\\u[a-fA-F0-9]{4}|\\x[a-fA-F0-9]{2}/, B = (e) => e.replace(/\\u([a-fA-F0-9]{4})|\\x([a-fA-F0-9]{2})/g, (e, t, n) => {
	...
	let r = t || e, i = (e) => typeof e == "object" ? e : n[e], a = (e, t) => {
		let a = F(r, e, Object.keys(n).length ? i("number") : void 0);
		return t.replace(new RegExp(V, "g"), a);
	};
	return {
		plural: (e, t) => {
...
var G = Object.defineProperty, K = (e, t, n) => t in e ? G(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, q = (e, t, n) => (K(e, typeof t == "symbol" ? t : t + "", n), n), J = class {
	constructor() {
		q(this, "_events", {});
	}
	on(e, t) {
...
}, Y = Object.defineProperty, ie = (e, t, n) => t in e ? Y(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, X = (e, t, n) => (ie(e, typeof t == "symbol" ? t : t + "", n), n), ae = class extends J {
	constructor(e) {
		super(), X(this, "_locale", ""), X(this, "_locales"), X(this, "_localeData", {}), X(this, "_messages", {}), X(this, "_missing"), X(this, "_messageCompiler"), X(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(O), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? j, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
var ce = ({ i18n: e, defaultComponent: n, children: s }) => {
