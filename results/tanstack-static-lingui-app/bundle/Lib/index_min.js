...
import { messages as a } from "../src/locales/en/messages.mjs";
import { messages as o } from "../src/locales/fr/messages.mjs";
import { messages as s } from "../src/locales/es/messages.mjs";
import { messages as c } from "../src/locales/de/messages.mjs";
import { messages as l } from "../src/locales/it/messages.mjs";
import { messages as u } from "../src/locales/pt/messages.mjs";
import { messages as d } from "../src/locales/zh/messages.mjs";
import { messages as f } from "../src/locales/ja/messages.mjs";
import { messages as p } from "../src/locales/ko/messages.mjs";
import { messages as m } from "../src/locales/ru/messages.mjs";
...
function M(e, t) {
	return /^::/.test(e) ? re(A(e.substring(2)), void 0, t) : e;
}
function oe(e, t = (e) => e) {
	return j((0, y.parse)(e), t);
}
function se(e, t = (e) => e) {
	try {
		return oe(e, t);
...
var N = (e) => typeof e == "string", ce = (e) => typeof e == "function", P = /* @__PURE__ */ new Map(), F = "en";
function I(e) {
...
function L(e, t, n) {
	...
	return B(() => V("date", r, n), () => new Intl.DateTimeFormat(r, i)).format(N(t) ? new Date(t) : t);
}
function le(e, t, n) {
	let r;
...
function R(e, t, n) {
	let r = I(e);
	return B(() => V("number", r, n), () => new Intl.NumberFormat(r, n)).format(t);
}
function z(e, t, n, { offset: r = 0, ...i }) {
	let a = I(e), o = t ? B(() => V("plural-ordinal", a), () => new Intl.PluralRules(a, { type: "ordinal" })) : B(() => V("plural-cardinal", a), () => new Intl.PluralRules(a, { type: "cardinal" }));
...
var H = /\\u[a-fA-F0-9]{4}|\\x[a-fA-F0-9]{2}/, U = (e) => e.replace(/\\u([a-fA-F0-9]{4})|\\x([a-fA-F0-9]{2})/g, (e, t, n) => {
	if (t) {
		let e = parseInt(t, 16);
...
}), W = "%__lingui_octothorpe__%", ue = (e, t, n = {}) => {
	let r = t || e, i = (e) => typeof e == "object" ? e : n[e], a = (e, t) => {
		let a = Object.keys(n).length ? i("number") : void 0, o = R(r, e, a);
		return t.replace(new RegExp(W, "g"), o);
	};
	return {
		plural: (e, t) => {
			let { offset: n = 0 } = t, i = z(r, !1, e, t);
			return a(e - n, i);
		},
		selectordinal: (e, t) => {
			let { offset: n = 0 } = t, i = z(r, !0, e, t);
			return a(e - n, i);
		},
		select: de,
		number: (e, t) => R(r, e, i(t) || { style: t }),
		date: (e, t) => L(r, e, i(t) || t),
		time: (e, t) => le(r, e, i(t) || t)
	};
}, de = (e, t) => t[e] ?? t.other;
function fe(e, t, n) {
	return (r = {}, i) => {
		...
		return N(s) && H.test(s) ? U(s) : N(s) ? s : s ? String(s) : "";
	};
}
var pe = class {
	_events = {};
	...
	_messageCompiler;
	constructor(e) {
		super(), this.setMessagesCompiler(se), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? F, e.locales);
	}
	get locale() {
		return this._locale;
	}
	...
	_(e, t, n) {
		...
		if (o && a) return ce(o) ? o(this._locale, e) : o;
		a && this.emit("missing", {
			id: e,
			locale: this._locale
		});
...
`)), N(s) && H.test(s) ? U(s) : N(s) ? s : fe(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
}, J = ({ i18n: e, defaultComponent: t, children: i }) => {
	let a = n(() => ye(e, t), [e, t]), o = (0, ge.useSyncExternalStore)(a.subscribe, a.getSnapshot, a.getSnapshot);
	return o.i18n.locale ? r(K.Provider, {
		value: o,
		children: i
...
}, Y = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/scripts/EmptyComponent.tsx", X = G();
X.load("en", {}), X.activate("en");
var be = () => {
	let { _: e, i18n: t } = ve();
...
var we = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/scripts/Wrapper.tsx";
function Q({ children: e }) {
	let t = n(() => Se("en"), []), r = n(() => Ce("en", t), [t]);
	return i(J, {
		i18n: r,
		children: e
	}, void 0, !1, {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/scripts/EmptyComponent.wrapper.tsx";
function Te() {
	return i(Q, { children: i(xe, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
