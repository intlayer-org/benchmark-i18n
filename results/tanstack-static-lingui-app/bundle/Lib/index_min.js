...
}, d = (e) => e < 4 ? "short" : e === 4 ? "long" : "narrow", f = (e) => e % 2 == 0 ? "2-digit" : "numeric";
function p(e, t) {
	switch (e.char) {
		case "y": return { year: f(e.width) };
		case "r": return {
			calendar: "gregory",
			year: "numeric"
		};
		default: return t(`${e.desc} is not supported; falling back to year:numeric`, u.WARNING), { year: "numeric" };
	}
}
function m(e, t) {
	switch (e.width) {
...
function g(e, t) {
	let { char: n, desc: r, width: i } = e;
	return (n === "c" || n === "e") && i < 3 && t(`Numeric value is not supported for ${r}; falling back to weekday:short`, u.WARNING), d(i);
}
function _(e) {
	let t = f(e.width), n;
	switch (e.char) {
...
function y(e, t) {
	switch (e.field) {
		...
		case "year": return p(e, t);
		case "month": return { month: m(e, t) };
		case "day": return { day: h(e, t) };
		case "weekday": return { weekday: g(e, t) };
		case "period": return;
		case "hour": return _(e);
		case "min": return { minute: f(e.width) };
		case "sec": return { second: f(e.width) };
		case "tz": return { timeZoneName: v(e, t) };
		case "quarter":
		case "week":
		case "sec-frac":
...
function b(e, t, n = (e) => {
	...
	for (let t of e) {
		...
		if (e) {
			let r = new u(e.message, t);
			r.stack = e.stack, n(r);
		}
		o && n(new u(`Ignoring string part: ${o}`, t, u.WARNING)), a && (i.indexOf(a) === -1 ? i.push(a) : n(new u(`Duplicate ${a} token`, t)));
		let s = y(t, (e, r) => n(new u(e, t, r)));
		s && Object.assign(r, s);
	}
	return r;
}
...
function O(e, t) {
	return /^::/.test(e) ? b(E(e.substring(2)), void 0, t) : e;
}
function ee(e, t = (e) => e) {
	return D((0, l.parse)(e), t);
}
function te(e, t = (e) => e) {
	try {
		return ee(e, t);
...
function P(e, t, n) {
	...
	return L(() => R("date", r, n), () => new Intl.DateTimeFormat(r, i)).format(k(t) ? new Date(t) : t);
}
function ne(e, t, n) {
	let r;
...
function F(e, t, n) {
	let r = N(e);
	return L(() => R("number", r, n), () => new Intl.NumberFormat(r, n)).format(t);
}
function I(e, t, n, { offset: r = 0, ...i }) {
	let a = N(e), o = t ? L(() => R("plural-ordinal", a), () => new Intl.PluralRules(a, { type: "ordinal" })) : L(() => R("plural-cardinal", a), () => new Intl.PluralRules(a, { type: "cardinal" }));
...
var z = /\\u[a-fA-F0-9]{4}|\\x[a-fA-F0-9]{2}/, B = (e) => e.replace(/\\u([a-fA-F0-9]{4})|\\x([a-fA-F0-9]{2})/g, (e, t, n) => {
	if (t) {
		let e = parseInt(t, 16);
...
}), V = "%__lingui_octothorpe__%", re = (e, t, n = {}) => {
	let r = t || e, i = (e) => typeof e == "object" ? e : n[e], a = (e, t) => {
		let a = Object.keys(n).length ? i("number") : void 0, o = F(r, e, a);
		return t.replace(new RegExp(V, "g"), o);
	};
	return {
		plural: (e, t) => {
			let { offset: n = 0 } = t, i = I(r, !1, e, t);
			return a(e - n, i);
		},
		selectordinal: (e, t) => {
			let { offset: n = 0 } = t, i = I(r, !0, e, t);
			return a(e - n, i);
		},
		select: ie,
		number: (e, t) => F(r, e, i(t) || { style: t }),
...
function ae(e, t, n) {
	return (r = {}, i) => {
		...
		return k(s) && z.test(s) ? B(s) : k(s) ? s : s ? String(s) : "";
	};
}
var H = class {
	_events = {};
	...
	_messageCompiler;
	constructor(e) {
		super(), this.setMessagesCompiler(te), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? M, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), k(s) && z.test(s) ? B(s) : k(s) ? s : ae(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
}, Y = ({ i18n: e, defaultComponent: t, children: i }) => {
	let a = n(() => ce(e, t), [e, t]), o = (0, K.useSyncExternalStore)(a.subscribe, a.getSnapshot, a.getSnapshot);
	return o.i18n.locale ? r(q.Provider, {
		value: o,
		children: i
...
}, X = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/scripts/EmptyComponent.tsx", Z = W();
Z.load("en", {}), Z.activate("en");
var le = () => {
	let { _: e, i18n: t } = se();
...
var pe = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/scripts/Wrapper.tsx";
function me({ children: e }) {
	let t = n(() => de("en"), []), r = n(() => fe("en", t), [t]);
	return i(Y, {
		i18n: r,
		children: e
	}, void 0, !1, {
...
function he() {
	return i(me, { children: i(ue, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
