...
import { Link as i, useParams as a } from "@tanstack/react-router";
...
function h(t, n = {}) {
	...
	let i = _(0, "$lingui$"), a = [], c = r.shift();
	c && a.push(c);
	for (let [t, c, l] of g(r)) {
		let r = t === void 0 ? void 0 : n[t];
		(!r || m[r.type] && c) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${t}' as it is not declared in the original translation`), r = s(o, {})), Array.isArray(r) && (r = s(o, { children: r })), a.push(e(r, { key: i() }, c ? h(c, n) : r.props.children)), l && a.push(l);
	}
...
var _ = (e = 0, t = "") => () => `${t}_${e++}`;
function v(e) {
	let { render: t, component: n, id: r, message: i, formats: a, lingui: { i18n: o, defaultComponent: c } } = e, { values: l, components: u } = b(e), d = o && typeof o._ == "function" ? o._(r, l, {
		message: i,
		formats: a
	}) : r, f = d ? h(d, u) : null;
	...
	else if (n && typeof n != "function") return console.error(`Invalid value supplied to prop \`component\`. It must be a React component, provided ${n}`), s(p, {
		...m,
		children: f
	});
	return typeof t == "function" ? t(m) : s(n || p, {
		...m,
		children: f
	});
}
...
var w = (e, t) => ({
	...
	let i = r(() => T(e, t), [e, t]), a = (0, f.useSyncExternalStore)(i.subscribe, i.getSnapshot, i.getSnapshot);
	return a.i18n.locale ? s(x.Provider, {
		value: a,
		children: n
...
var E = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/src/components/Footer.tsx";
function ne() {
	let { i18n: e } = C(), t = a({ strict: !1 }).locale ?? "en", n = [
		{
			...
			children: [c("div", {
				...
				children: [
					...
					c("div", { children: [c("h3", {
						...
						className: "space-y-1",
						children: n.map((e) => c("li", { children: e.isInternal ? c(i, {
							preload: !1,
							to: e.to,
							params: { locale: t },
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/src/components/Footer.wrapper.tsx";
function Ee() {
	return c(Te, { children: c(ne, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
