...
function x() {
	let { i18n: e } = _(), [t, n] = s("auto");
	r(() => {
		let e = y();
		n(e), b(e);
	}, []), r(() => {
		if (t !== "auto") return;
		let e = window.matchMedia("(prefers-color-scheme: dark)"), n = () => b("auto");
	...
	function i() {
		...
		n(e), b(e), window.localStorage.setItem("theme", e);
	}
...
function se(e, t) {
	return /^::/.test(e) ? re(P(e.substring(2)), void 0, t) : e;
}
function ce(e, t = (e) => e) {
...
}), Y = "%__lingui_octothorpe__%", ue = (e, t, n = {}) => {
...
var X = Object.defineProperty, pe = (e, t, n) => t in e ? X(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, me = (e, t, n) => (pe(e, typeof t == "symbol" ? t : t + "", n), n), he = class {
	constructor() {
		me(this, "_events", {});
	}
	on(e, t) {
...
}, ge = Object.defineProperty, _e = (e, t, n) => t in e ? ge(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t, n) => (_e(e, typeof t == "symbol" ? t : t + "", n), n), ve = class extends he {
	constructor(e) {
		super(), Z(this, "_locale", ""), Z(this, "_locales"), Z(this, "_localeData", {}), Z(this, "_messages", {}), Z(this, "_missing"), Z(this, "_messageCompiler"), Z(this, "t", this._.bind(this)), process.env.NODE_ENV !== "production" && this.setMessagesCompiler(le), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), e.localeData != null && this.loadLocaleData(e.localeData), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? z, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), I(s) && q.test(s) ? J(s) : I(s) ? s : fe(s, this._locale, this._locales)(t, n?.formats);
	}
	date(e, t) {
					...
					children: [
						...
						p("div", {
							...
							children: [p("button", {
								...
								onMouseLeave: () => n(!1),
								onClick: () => n(!t),
								children: [e._("header.mockPages"), f(d, {
									size: 14,
