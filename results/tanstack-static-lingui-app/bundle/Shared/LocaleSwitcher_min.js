...
import { useNavigate as n, useParams as r } from "@tanstack/react-router";
...
function te(e, t) {
	return /^::/.test(e) ? x(E(e.substring(2)), void 0, t) : e;
}
function ne(e, t = (e) => e) {
...
var O = (e) => typeof e == "string", ie = (e) => typeof e == "function", k = /* @__PURE__ */ new Map(), A = "en";
function j(e) {
	return [...Array.isArray(e) ? e : [e], A];
}
function M(e, t, n) {
	let r = j(e);
	n ||= "default";
	...
	return F(() => I("date", r, n), () => new Intl.DateTimeFormat(r, i)).format(O(t) ? new Date(t) : t);
}
function ae(e, t, n) {
	let r;
...
function N(e, t, n) {
	let r = j(e);
	return F(() => I("number", r, n), () => new Intl.NumberFormat(r, n)).format(t);
}
function P(e, t, n, { offset: r = 0, ...i }) {
	let a = j(e), o = t ? F(() => I("plural-ordinal", a), () => new Intl.PluralRules(a, { type: "ordinal" })) : F(() => I("plural-cardinal", a), () => new Intl.PluralRules(a, { type: "cardinal" }));
	return i[n] ?? i[o.select(n - r)] ?? i.other;
}
function F(e, t) {
	let n = e(), r = k.get(n);
	return r || (r = t(), k.set(n, r)), r;
}
function I(e, t, n) {
	return `${e}-${t.join("-")}-${JSON.stringify(n)}`;
}
var L = /\\u[a-fA-F0-9]{4}|\\x[a-fA-F0-9]{2}/, R = (e) => e.replace(/\\u([a-fA-F0-9]{4})|\\x([a-fA-F0-9]{2})/g, (e, t, n) => {
	if (t) {
		let e = parseInt(t, 16);
...
}), z = "%__lingui_octothorpe__%", B = (e, t, n = {}) => {
	let r = t || e, i = (e) => typeof e == "object" ? e : n[e], a = (e, t) => {
		let a = Object.keys(n).length ? i("number") : void 0, o = N(r, e, a);
		return t.replace(new RegExp(z, "g"), o);
	};
	return {
		plural: (e, t) => {
			let { offset: n = 0 } = t, i = P(r, !1, e, t);
			return a(e - n, i);
		},
		selectordinal: (e, t) => {
			let { offset: n = 0 } = t, i = P(r, !0, e, t);
			return a(e - n, i);
		},
		select: V,
		number: (e, t) => N(r, e, i(t) || { style: t }),
		date: (e, t) => M(r, e, i(t) || t),
		time: (e, t) => ae(r, e, i(t) || t)
	};
}, V = (e, t) => t[e] ?? t.other;
function H(e, t, n) {
	return (r = {}, i) => {
		let a = B(t, n, i), o = (e, t = !1) => Array.isArray(e) ? e.reduce((e, n) => {
			if (n === "#" && t) return e + z;
			if (O(n)) return e + n;
			let [i, s, c] = n, l = {};
		...
		return O(s) && L.test(s) ? R(s) : O(s) ? s : s ? String(s) : "";
	};
}
var U = class {
	_events = {};
	...
	_messageCompiler;
	constructor(e) {
		super(), this.setMessagesCompiler(re), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? A, e.locales);
	}
	get locale() {
		return this._locale;
	}
	...
	_(e, t, n) {
		...
		let r = n?.message;
		e ||= "", O(e) || (t = e.values || t, r = e.message, e = e.id);
		...
		let s = i || r || e;
		return O(s) && (this._messageCompiler ? s = this._messageCompiler(s) : console.warn(`Uncompiled message detected! Message:
...
`)), O(s) && L.test(s) ? R(s) : O(s) ? s : H(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
		return M(this._locales || this._locale, e, t);
	}
	number(e, t) {
...
var X = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/src/components/LocaleSwitcher.tsx";
function _e() {
	let e = r({ strict: !1 }).locale ?? "en", t = n(), a = (e) => {
		t({ params: (t) => ({
			...t,
			locale: e
		}) });
...
}, xe = ({ i18n: e, defaultComponent: n, children: r }) => {
	let i = t(() => be(e, n), [e, n]), o = (0, ve.useSyncExternalStore)(i.subscribe, i.getSnapshot, i.getSnapshot);
	return o.i18n.locale ? a(ye.Provider, {
		value: o,
		children: r
...
}, Se = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/scripts/Wrapper.tsx";
function Ce({ children: e }) {
	let n = t(() => he("en"), []), r = t(() => ge("en", n), [n]);
	return i(xe, {
		i18n: r,
		children: e
	}, void 0, !1, {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/src/components/LocaleSwitcher.wrapper.tsx";
function we() {
	return i(Ce, { children: i(_e, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
