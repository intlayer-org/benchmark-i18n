...
}, _ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/src/components/ThemeToggle.tsx";
function v() {
...
}), Y = "%__lingui_octothorpe__%", le = (e, t, n = {}) => {
...
var fe = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), this.setMessagesCompiler(ce), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? z, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
`)), I(s) && q.test(s) ? J(s) : I(s) ? s : de(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
var he = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/scripts/Wrapper.tsx";
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/src/components/ThemeToggle.wrapper.tsx";
function _e() {
