...
function h(t, n = {}) {
	...
	let i = _(0, "$lingui$"), s = [], c = r.shift();
	c && s.push(c);
	for (let [t, c, l] of g(r)) {
		let r = t === void 0 ? void 0 : n[t];
		(!r || m[r.type] && c) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${t}' as it is not declared in the original translation`), r = o(a, {})), Array.isArray(r) && (r = o(a, { children: r })), s.push(e(r, { key: i() }, c ? h(c, n) : r.props.children)), l && s.push(l);
	}
...
var _ = (e = 0, t = "") => () => `${t}_${e++}`;
function v(e) {
	let { render: t, component: n, id: r, message: i, formats: a, lingui: { i18n: s, defaultComponent: c } } = e, { values: l, components: u } = b(e), d = s && typeof s._ == "function" ? s._(r, l, {
		message: i,
		formats: a
	}) : r, f = d ? h(d, u) : null;
	...
	return typeof t == "function" ? t(m) : o(n || p, {
		...m,
		children: f
	});
}
...
var w = (e, t) => ({
	...
	let r = i(() => T(e, t), [e, t]), a = (0, f.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
...
var D = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/src/components/pages/about/AboutHeader.tsx";
function ne() {
	let { i18n: e } = C();
	return te("AboutHeader"), c(s, { children: [c("h1", {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/src/components/pages/about/AboutHeader.wrapper.tsx";
function De() {
	return c(Ee, { children: c(ne, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
