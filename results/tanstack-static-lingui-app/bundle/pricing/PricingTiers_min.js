...
}, h = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/src/components/pages/pricing/PricingTiers.tsx";
function g() {
	let { i18n: e } = d(), t = [
		{
			name: e._({
...
var ce = class {
	...
	_messageCompiler;
	constructor(e) {
		super(), this.setMessagesCompiler(re), e.missing != null && (this._missing = e.missing), e.messages != null && this.load(e.messages), (typeof e.locale == "string" || e.locales) && this.activate(e.locale ?? z, e.locales);
	}
	get locale() {
		return this._locale;
	}
...
var de = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/scripts/Wrapper.tsx";
function fe({ children: e }) {
	let t = n(() => ue("en"), []), r = n(() => Q("en", t), [t]);
	return i(m, {
		i18n: r,
		children: e
	}, void 0, !1, {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/src/components/pages/pricing/PricingTiers.wrapper.tsx";
function pe() {
