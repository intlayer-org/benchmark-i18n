import { cloneElement as e, createContext as t, useContext as n, useId as r, useMemo as i } from "react";
...
function m(t, n = {}) {
	...
	let i = g(0, "$lingui$"), s = [], c = r.shift();
	c && s.push(c);
	for (let [t, c, l] of h(r)) {
		let r = t === void 0 ? void 0 : n[t];
		(!r || p[r.type] && c) && (console.error(r ? `${r.type} is a void element tag therefore it must have no children` : `Can't use element at index '${t}' as it is not declared in the original translation`), r = o(a, {})), Array.isArray(r) && (r = o(a, { children: r })), s.push(e(r, { key: i() }, c ? m(c, n) : r.props.children)), l && s.push(l);
	}
...
var g = (e = 0, t = "") => () => `${t}_${e++}`;
function _(e) {
	let { render: t, component: n, id: r, message: i, formats: a, lingui: { i18n: s, defaultComponent: c } } = e, { values: l, components: u } = y(e), d = s && typeof s._ == "function" ? s._(r, l, {
		message: i,
		formats: a
	}) : r, f = d ? m(d, u) : null;
	...
	else if (n && typeof n != "function") return console.error(`Invalid value supplied to prop \`component\`. It must be a React component, provided ${n}`), o(p, {
		...h,
		children: f
	});
	return typeof t == "function" ? t(h) : o(n || p, {
		...h,
		children: f
	});
}
...
}, w = ({ i18n: e, defaultComponent: t, children: n }) => {
	let r = i(() => C(e, t), [e, t]), a = (0, d.useSyncExternalStore)(r.subscribe, r.getSnapshot, r.getSnapshot);
	return a.i18n.locale ? o(b.Provider, {
		value: a,
		children: n
...
var E = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/src/components/pages/settings/PreferencesSection.tsx";
function D() {
	let e = r();
	return s("section", {
		...
		children: [s("h2", {
			...
			children: [
				...
				s("div", { children: [s("label", {
					...
					children: [
						s("option", { children: i18n._("settings.preferences.english") }, void 0, !1, {
							fileName: E,
							lineNumber: 70,
							columnNumber: 13
						}, this),
						s("option", { children: i18n._("settings.preferences.french") }, void 0, !1, {
							fileName: E,
							lineNumber: 71,
							columnNumber: 13
						}, this),
						s("option", { children: i18n._("settings.preferences.german") }, void 0, !1, {
							fileName: E,
							lineNumber: 72,
							columnNumber: 13
						}, this),
						s("option", { children: i18n._("settings.preferences.spanish") }, void 0, !1, {
							fileName: E,
							lineNumber: 73,
							columnNumber: 13
						}, this),
						s("option", { children: i18n._("settings.preferences.japanese") }, void 0, !1, {
							fileName: E,
							lineNumber: 74,
							columnNumber: 13
						}, this),
						s("option", { children: i18n._("settings.preferences.chinese") }, void 0, !1, {
							fileName: E,
							lineNumber: 75,
							columnNumber: 13
						}, this),
						s("option", { children: i18n._("settings.preferences.arabic") }, void 0, !1, {
							fileName: E,
							lineNumber: 76,
							columnNumber: 13
						}, this)
...
function P(e, t) {
	return /^::/.test(e) ? le(me(e.substring(2)), void 0, t) : e;
}
function F(e, t = (e) => e) {
...
}), Y = "%__lingui_octothorpe__%", ge = (e, t, n = {}) => {
...
`)), L(s) && q.test(s) ? J(s) : L(s) ? s : ve(s, this._locale, this._locales)(t, n?.formats);
	}
	t = this._.bind(this);
	date(e, t) {
...
var Se = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/scripts/Wrapper.tsx";
function Ce({ children: e }) {
	let t = i(() => be("en"), []), n = i(() => xe("en", t), [t]);
	return s(w, {
		i18n: n,
		children: e
	}, void 0, !1, {
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/lingui-app/src/components/pages/settings/PreferencesSection.wrapper.tsx";
function we() {
	return s(Ce, { children: s(D, {}, void 0, !1, {
		fileName: $,
		lineNumber: 9,
		columnNumber: 11
	}, this) }, void 0, !1, {
