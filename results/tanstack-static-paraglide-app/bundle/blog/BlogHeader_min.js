...
var M = () => "Insights, tutorials, and analysis from the i18n community.", N = () => "Blog", P = () => "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service.", F = () => "Aperçus, tutoriels et analyses de la communauté i18n.", I = () => "Blog", L = () => "⚠️ Cette page contient des données factices à des fins de benchmarking uniquement. Elle n'est liée à aucune entreprise ou service réel.", R = () => "Información, tutoriales y análisis de la comunidad i18n.", z = () => "Blog", B = () => "⚠️ Esta página contiene datos ficticios solo con fines de benchmarking. No está relacionada con ninguna empresa o servicio real.", V = () => "Einblicke, Tutorials und Analysen aus der i18n-Community.", H = () => "Blog", U = () => "⚠️ Diese Seite enthält fiktive Daten nur zu Benchmarking-Zwecken. Sie steht in keiner Verbindung zu einem realen Unternehmen oder einer Dienstleistung.", W = () => "Approfondimenti, tutorial e analisi dalla comunità i18n.", G = () => "Blog", K = () => "⚠️ Questa pagina contiene dati fittizi solo a scopo di benchmarking. Non è collegata ad alcuna attività o servizio reale.", q = () => "Insights, tutoriais e análises da comunidade i18n.", re = () => "Blog", J = () => "⚠️ Esta página contém dados simulados apenas para fins de benchmarking. Não está relacionada com nenhum negócio ou serviço real.", Y = () => "来自 i18n 社区的见解、教程和分析。", X = () => "博客", ie = () => "⚠️ 此页面包含仅用于基准测试目的的模拟数据。它与任何真实的商业或服务无关。", ae = () => "i18nコミュニティからの洞察、チュートリアル、分析。", oe = () => "ブログ", se = () => "⚠️ このページには、ベンチマーク目的のみのモックデータが含まれています。実際のビジネスやサービスとは関係ありません。", ce = () => "i18n 커뮤니티의 인사이트, 튜토리얼 및 분석.", le = () => "블로그", ue = () => "⚠️ 이 페이지에는 벤치마킹 목적으로만 사용되는 모의 데이터가 포함되어 있습니다. 실제 비즈니스나 서비스와는 관련이 없습니다.", de = () => "Инсайты, руководства и анализ от сообщества i18n.", fe = () => "Блог", pe = () => "⚠️ Эта страница содержит имитационные данные только для целей тестирования. Она не связана с каким-либо реальным бизнесом или услугой.", me = ((e = {}, t = {}) => {
	let n = t.locale ?? d();
	...
	lineNumber: 4,
	columnNumber: 3
}, void 0), Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/paraglide-app/src/components/pages/blog/BlogHeader.tsx";
function ve() {
	return t(e, { children: [
		t(_e, {}, void 0, !1, {
			fileName: Q,
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/paraglide-app/src/components/pages/blog/BlogHeader.wrapper.tsx";
function xe() {
