...
var T = () => "Blog", E = () => "Blog", D = () => "Blog", O = () => "Blog", k = () => "Blog", A = () => "Blog", j = () => "博客", M = () => "ブログ", N = () => "블로그", P = () => "Блог", F = ((e = {}, t = {}) => {
	let n = t.locale ?? g();
	return n === "en" ? T(e) : n === "fr" ? E(e) : n === "es" ? D(e) : n === "de" ? O(e) : n === "it" ? k(e) : n === "pt" ? A(e) : n === "zh" ? j(e) : n === "ja" ? M(e) : n === "ko" ? N(e) : P(e);
}), I = () => "Insights, tutorials, and analysis from the i18n community.", L = () => "Aperçus, tutoriels et analyses de la communauté i18n.", R = () => "Información, tutoriales y análisis de la comunidad i18n.", z = () => "Einblicke, Tutorials und Analysen aus der i18n-Community.", ee = () => "Approfondimenti, tutorial e analisi dalla comunità i18n.", B = () => "Insights, tutoriais e análises da comunidade i18n.", V = () => "来自 i18n 社区的见解、教程和分析。", H = () => "i18nコミュニティからの洞察、チュートリアル、分析。", U = () => "i18n 커뮤니티의 인사이트, 튜토리얼 및 분석.", W = () => "Инсайты, руководства и анализ от сообщества i18n.", G = ((e = {}, t = {}) => {
	let n = t.locale ?? g();
