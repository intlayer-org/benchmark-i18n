...
var T = () => "Get in Touch", E = () => "Contactez-nous", D = () => "Ponte en contacto", O = () => "Kontakt aufnehmen", k = () => "Mettiti in contatto", A = () => "Entre em contato", j = () => "联系我们", M = () => "お問い合わせ", N = () => "연락하기", P = () => "Свяжитесь с нами", F = ((e = {}, t = {}) => {
	let n = t.locale ?? g();
	return n === "en" ? T(e) : n === "fr" ? E(e) : n === "es" ? D(e) : n === "de" ? O(e) : n === "it" ? k(e) : n === "pt" ? A(e) : n === "zh" ? j(e) : n === "ja" ? M(e) : n === "ko" ? N(e) : P(e);
}), I = () => "Have ideas, found a bug, or want to contribute a benchmark? Reach out to us at", L = () => "Vous avez des idées, trouvé un bug ou voulez proposer un benchmark ? Contactez-nous à", R = () => "¿Tienes ideas, has encontrado un bug o quieres contribuir con un benchmark? Contáctanos en", z = () => "Haben Sie Ideen, einen Fehler gefunden oder möchten Sie einen Benchmark beisteuern? Kontaktieren Sie uns unter", ee = () => "Hai idee, hai trovato un bug o vuoi contribuire con un benchmark? Contattaci all'indirizzo", B = () => "Tem ideias, encontrou um bug ou quer contribuir com um benchmark? Entre em contato conosco em", V = () => "有想法、发现了 Bug 或想贡献基准测试？请联系我们：", H = () => "アイデアがある、バグを見つけた、またはベンチマークを提供したいですか？こちらまでご連絡ください：", U = () => "아이디어가 있거나 버그를 발견했나요? 아니면 벤치마크를 기여하고 싶으신가요? 다음 주소로 연락주세요.", W = () => "Есть идеи, нашли баг или хотите предложить бенчмарк? Свяжитесь с нами по адресу", G = ((e = {}, t = {}) => {
	let n = t.locale ?? g();
