...
var T = () => "Frequently Asked Questions", E = () => "Foire aux questions", D = () => "Preguntas frecuentes", O = () => "Häufig gestellte Fragen", k = () => "Domande frequenti", A = () => "Perguntas Frequentes", j = () => "常见问题", M = () => "よくある質問", N = () => "자주 묻는 질문", P = () => "Часто задаваемые вопросы", F = ((e = {}, t = {}) => {
	let n = t.locale ?? g();
	return n === "en" ? T(e) : n === "fr" ? E(e) : n === "es" ? D(e) : n === "de" ? O(e) : n === "it" ? k(e) : n === "pt" ? A(e) : n === "zh" ? j(e) : n === "ja" ? M(e) : n === "ko" ? N(e) : P(e);
}), I = () => "Everything you need to know about i18n Benchmark.", L = () => "Tout ce que vous devez savoir sur i18n Benchmark.", R = () => "Todo lo que necesitas saber sobre i18n Benchmark.", z = () => "Alles, was Sie über i18n Benchmark wissen müssen.", ee = () => "Tutto quello che c'è da sapere su i18n Benchmark.", B = () => "Tudo o que você precisa saber sobre o i18n Benchmark.", V = () => "关于 i18n Benchmark 您需要了解的一切。", H = () => "i18n Benchmarkについて知っておくべきすべてのこと。", U = () => "i18n Benchmark에 대해 알아야 할 모든 것.", W = () => "Все, что вам нужно знать об i18n Benchmark.", G = ((e = {}, t = {}) => {
	let n = t.locale ?? g();
