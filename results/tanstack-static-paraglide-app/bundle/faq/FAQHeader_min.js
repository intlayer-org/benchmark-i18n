...
var M = () => "Everything you need to know about i18n Benchmark.", N = () => "Frequently Asked Questions", P = () => "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service.", F = () => "Tout ce que vous devez savoir sur i18n Benchmark.", I = () => "Foire aux questions", L = () => "⚠️ Cette page contient des données factices à des fins de benchmarking uniquement. Elle n'est liée à aucune entreprise ou service réel.", R = () => "Todo lo que necesitas saber sobre i18n Benchmark.", z = () => "Preguntas frecuentes", B = () => "⚠️ Esta página contiene datos ficticios solo con fines de benchmarking. No está relacionada con ninguna empresa o servicio real.", V = () => "Alles, was Sie über i18n Benchmark wissen müssen.", H = () => "Häufig gestellte Fragen", U = () => "⚠️ Diese Seite enthält fiktive Daten nur zu Benchmarking-Zwecken. Sie steht in keiner Verbindung zu einem realen Unternehmen oder einer Dienstleistung.", W = () => "Tutto quello che c'è da sapere su i18n Benchmark.", G = () => "Domande frequenti", K = () => "⚠️ Questa pagina contiene dati fittizi solo a scopo di benchmarking. Non è collegata ad alcuna attività o servizio reale.", q = () => "Tudo o que você precisa saber sobre o i18n Benchmark.", re = () => "Perguntas Frequentes", J = () => "⚠️ Esta página contém dados simulados apenas para fins de benchmarking. Não está relacionada com nenhum negócio ou serviço real.", Y = () => "关于 i18n Benchmark 您需要了解的一切。", X = () => "常见问题", ie = () => "⚠️ 此页面包含仅用于基准测试目的的模拟数据。它与任何真实的商业或服务无关。", ae = () => "i18n Benchmarkについて知っておくべきすべてのこと。", oe = () => "よくある質問", se = () => "⚠️ このページには、ベンチマーク目的のみのモックデータが含まれています。実際のビジネスやサービスとは関係ありません。", ce = () => "i18n Benchmark에 대해 알아야 할 모든 것.", le = () => "자주 묻는 질문", ue = () => "⚠️ 이 페이지에는 벤치마킹 목적으로만 사용되는 모의 데이터가 포함되어 있습니다. 실제 비즈니스나 서비스와는 관련이 없습니다.", de = () => "Все, что вам нужно знать об i18n Benchmark.", fe = () => "Часто задаваемые вопросы", pe = () => "⚠️ Эта страница содержит имитационные данные только для целей тестирования. Она не связана с каким-либо реальным бизнесом или услугой.", me = ((e = {}, t = {}) => {
	let n = t.locale ?? d();
	...
	lineNumber: 4,
	columnNumber: 3
}, void 0), Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/paraglide-app/src/components/pages/faq/FAQHeader.tsx";
function ve() {
	return t(e, { children: [
		t(_e, {}, void 0, !1, {
			fileName: Q,
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/paraglide-app/src/components/pages/faq/FAQHeader.wrapper.tsx";
function xe() {
