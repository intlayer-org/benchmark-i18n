...
var open_positions_applynow1 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_applynow1(inputs);
	return en_open_positions_applynow1(inputs);
});
...
var open_positions_backendengineer1 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_backendengineer1(inputs);
	return en_open_positions_backendengineer1(inputs);
});
...
var open_positions_buildandmaintainourbenchmarking4 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_buildandmaintainourbenchmarking4(inputs);
	return en_open_positions_buildandmaintainourbenchmarking4(inputs);
});
...
var open_positions_community = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_community(inputs);
	return en_open_positions_community(inputs);
});
...
var open_positions_createcomprehensiveguidesapireferences4 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_createcomprehensiveguidesapireferences4(inputs);
	return en_open_positions_createcomprehensiveguidesapireferences4(inputs);
});
...
var open_positions_designandscaleourcloud4 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_designandscaleourcloud4(inputs);
	return en_open_positions_designandscaleourcloud4(inputs);
});
...
var open_positions_devrelengineer1 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_devrelengineer1(inputs);
	return en_open_positions_devrelengineer1(inputs);
});
...
var open_positions_documentation = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_documentation(inputs);
	return en_open_positions_documentation(inputs);
});
...
var open_positions_engagewiththei18ncommunity4 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_engagewiththei18ncommunity4(inputs);
	return en_open_positions_engagewiththei18ncommunity4(inputs);
});
...
var open_positions_engineering = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_engineering(inputs);
	return en_open_positions_engineering(inputs);
});
...
var open_positions_ensuretheaccuracyandreliability4 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_ensuretheaccuracyandreliability4(inputs);
	return en_open_positions_ensuretheaccuracyandreliability4(inputs);
});
...
var open_positions_fulltime1 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_fulltime1(inputs);
	return en_open_positions_fulltime1(inputs);
});
...
var open_positions_openpositions1 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_openpositions1(inputs);
	return en_open_positions_openpositions1(inputs);
});
...
var open_positions_parttime1 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_parttime1(inputs);
	return en_open_positions_parttime1(inputs);
});
...
var open_positions_qaengineer1 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_qaengineer1(inputs);
	return en_open_positions_qaengineer1(inputs);
});
...
var open_positions_sanfranciscoremote2 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_sanfranciscoremote2(inputs);
	return en_open_positions_sanfranciscoremote2(inputs);
});
...
var open_positions_seniorfrontendengineer2 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_seniorfrontendengineer2(inputs);
	return en_open_positions_seniorfrontendengineer2(inputs);
});
...
var open_positions_technicalwriter1 = ((inputs = {}, options = {}) => {
	...
	if (locale === "ru") return ru_open_positions_technicalwriter1(inputs);
	return en_open_positions_technicalwriter1(inputs);
});
