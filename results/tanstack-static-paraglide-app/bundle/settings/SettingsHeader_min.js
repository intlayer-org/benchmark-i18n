...
var F = () => "Settings", I = () => "Paramètres", L = () => "Ajustes", R = () => "Einstellungen", z = () => "Impostazioni", B = () => "Configurações", V = () => "设置", H = () => "設定", U = () => "설정", W = () => "Настройки", G = ((e = {}, t = {}) => {
	let n = t.locale ?? f();
...
}), ae = () => "Manage your account preferences and configuration.", oe = () => "Gérez vos préférences de compte et votre configuration.", se = () => "Gestiona las preferencias y la configuración de tu cuenta.", ce = () => "Verwalten Sie Ihre Kontoeinstellungen und Konfigurationen.", le = () => "Gestisci le preferenze del tuo account e la configurazione.", ue = () => "Gerencie as preferências de sua conta e a configuração.", de = () => "管理您的账户偏好和配置。", fe = () => "アカウントの優先設定と構成を管理します。", pe = () => "계정 기본 설정 및 구성을 관리합니다.", $ = () => "Управляйте настройками и конфигурацией своего аккаунта.", me = ((e = {}, t = {}) => {
	let n = t.locale ?? f();
