...
var T = () => "Settings", E = () => "Paramètres", D = () => "Ajustes", O = () => "Einstellungen", k = () => "Impostazioni", A = () => "Configurações", j = () => "设置", M = () => "設定", N = () => "설정", P = () => "Настройки", F = ((e = {}, t = {}) => {
	let n = t.locale ?? g();
	return n === "en" ? T(e) : n === "fr" ? E(e) : n === "es" ? D(e) : n === "de" ? O(e) : n === "it" ? k(e) : n === "pt" ? A(e) : n === "zh" ? j(e) : n === "ja" ? M(e) : n === "ko" ? N(e) : P(e);
}), I = () => "Manage your account preferences and configuration.", L = () => "Gérez vos préférences de compte et votre configuration.", R = () => "Gestiona las preferencias y la configuración de tu cuenta.", z = () => "Verwalten Sie Ihre Kontoeinstellungen und Konfigurationen.", ee = () => "Gestisci le preferenze del tuo account e la configurazione.", B = () => "Gerencie as preferências de sua conta e a configuração.", V = () => "管理您的账户偏好和配置。", H = () => "アカウントの優先設定と構成を管理します。", U = () => "계정 기본 설정 및 구성을 관리합니다.", W = () => "Управляйте настройками и конфигурацией своего аккаунта.", G = ((e = {}, t = {}) => {
	let n = t.locale ?? g();
