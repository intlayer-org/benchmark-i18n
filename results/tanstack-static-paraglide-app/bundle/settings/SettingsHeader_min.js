...
var M = () => "Settings", N = () => "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service.", P = () => "Manage your account preferences and configuration.", F = () => "Paramètres", I = () => "⚠️ Cette page contient des données factices à des fins de benchmarking uniquement. Elle n'est liée à aucune entreprise ou service réel.", L = () => "Gérez vos préférences de compte et votre configuration.", R = () => "Ajustes", z = () => "⚠️ Esta página contiene datos ficticios solo con fines de benchmarking. No está relacionada con ninguna empresa o servicio real.", B = () => "Gestiona las preferencias y la configuración de tu cuenta.", V = () => "Einstellungen", H = () => "⚠️ Diese Seite enthält fiktive Daten nur zu Benchmarking-Zwecken. Sie steht in keiner Verbindung zu einem realen Unternehmen oder einer Dienstleistung.", U = () => "Verwalten Sie Ihre Kontoeinstellungen und Konfigurationen.", W = () => "Impostazioni", G = () => "⚠️ Questa pagina contiene dati fittizi solo a scopo di benchmarking. Non è collegata ad alcuna attività o servizio reale.", K = () => "Gestisci le preferenze del tuo account e la configurazione.", q = () => "Configurações", re = () => "⚠️ Esta página contém dados simulados apenas para fins de benchmarking. Não está relacionada com nenhum negócio ou serviço real.", J = () => "Gerencie as preferências de sua conta e a configuração.", Y = () => "设置", X = () => "⚠️ 此页面包含仅用于基准测试目的的模拟数据。它与任何真实的商业或服务无关。", ie = () => "管理您的账户偏好和配置。", ae = () => "設定", oe = () => "⚠️ このページには、ベンチマーク目的のみのモックデータが含まれています。実際のビジネスやサービスとは関係ありません。", se = () => "アカウントの優先設定と構成を管理します。", ce = () => "설정", le = () => "⚠️ 이 페이지에는 벤치마킹 목적으로만 사용되는 모의 데이터가 포함되어 있습니다. 실제 비즈니스나 서비스와는 관련이 없습니다.", ue = () => "계정 기본 설정 및 구성을 관리합니다.", de = () => "Настройки", fe = () => "⚠️ Эта страница содержит имитационные данные только для целей тестирования. Она не связана с каким-либо реальным бизнесом или услугой.", pe = () => "Управляйте настройками и конфигурацией своего аккаунта.", me = ((e = {}, t = {}) => {
	let n = t.locale ?? d();
	...
	lineNumber: 4,
	columnNumber: 3
}, void 0), Q = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/paraglide-app/src/components/pages/settings/SettingsHeader.tsx";
function ve() {
	return t(e, { children: [
		t(_e, {}, void 0, !1, {
			fileName: Q,
...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/paraglide-app/src/components/pages/settings/SettingsHeader.wrapper.tsx";
function xe() {
