...
var Ce = (e, t, n, r) => {
	...
	let { i18n: c } = t, { i18n: l, defaultNS: u } = r(Re) || {}, d = c || l || Ie();
	...
	let v = o(0), y = n((e) => {
		...
		f,
		t.lng
	]), [S, C] = s(0), { t: w, ready: T } = (0, He.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
...
function qe() {
	let { t: e } = Ge(), t = l({ strict: !1 }).locale ?? "en", n = [
		{
