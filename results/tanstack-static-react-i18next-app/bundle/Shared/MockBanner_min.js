...
var R = (e) => !b(e) && typeof e != "boolean" && typeof e != "number", z = class e extends F {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			k(n.loaded, [i], a), ge(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), ve = (e) => (b(e.ns) && (e.ns = [e.ns]), b(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), b(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), J = () => {}, ye = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Y = class e extends F {
	constructor(e = {}, t) {
		if (super(), this.options = ve(e), this.services = {}, this.logger = P, this.modules = { external: [] }, ye(this), t && !this.isInitialized && !e.isClone) {
...
var be = (e, t, n, r) => {
	...
	Q(n) && xe[n] || (Q(n) && (xe[n] = /* @__PURE__ */ new Date()), be(e, t, n, r));
}, Se = (e, t) => () => {
	...
	e.loadNamespaces(t, Se(e, n));
}, Ce = (e, t, n, r) => {
	if (Q(n) && (n = [n]), e.options.preload && e.options.preload.indexOf(t) > -1) return Z(e, n, r);
	n.forEach((t) => {
		e.options.ns.indexOf(t) < 0 && e.options.ns.push(t);
	}), e.loadLanguages(t, Se(e, r));
}, we = (e, t, n = {}) => !t.languages || !t.languages.length ? (X(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Q = (e) => typeof e == "string", Te = (e) => typeof e == "object" && !!e, Ee = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, De = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	t: (e, t) => {
		if (Q(t)) return t;
		if (Te(t) && Q(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: c } = t, { i18n: l, defaultNS: u } = r(Fe) || {}, d = c || l || Ne();
	d && !d.reportNamespaces && (d.reportNamespaces = new Ie()), d || X(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = a(() => ({
		...Ae(),
		...d?.options?.react,
		...t
	...
	let v = o(0), y = n((e) => {
		...
		f,
		t.lng
	]), [S, C] = s(0), { t: w, ready: T } = (0, ze.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
			t.lng ? Ce(d, t.lng, _, e) : Z(d, _, e);
		}
	}, [
		d,
		t.lng,
