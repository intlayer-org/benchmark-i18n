...
import g from "../../../i18n/locales/zh.json";
import _ from "../../../i18n/locales/ja.json";
import v from "../../../i18n/locales/ko.json";
import y from "../../../i18n/locales/ru.json";
var b = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), x = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	if (typeof require < "u") return require.apply(this, arguments);
	throw Error("Calling `require` for \"" + e + "\" in an environment that doesn't expose the `require` function. See https://rolldown.rs/in-depth/bundling-cjs#require-external-modules for more details.");
}), S = (e) => typeof e == "string", C = () => {
	let e, t, n = new Promise((n, r) => {
		e = n, t = r;
	});
	return n.resolve = e, n.reject = t, n;
}, w = (e) => e == null ? "" : String(e), T = (e, t, n) => {
	e.forEach((e) => {
		t[e] && (n[e] = t[e]);
	});
}, E = /###/g, D = (e) => e && e.includes("###") ? e.replace(E, ".") : e, O = (e) => !e || S(e), k = (e, t, n) => {
	...
	let { obj: r, k: i } = k(e, t, Object);
	if (r !== void 0 || t.length === 1) {
		r[i] = n;
		return;
	}
	let a = t[t.length - 1], o = t.slice(0, t.length - 1), s = k(e, o, Object);
	for (; s.obj === void 0 && o.length;) a = `${o[o.length - 1]}.${a}`, o = o.slice(0, o.length - 1), s = k(e, o, Object), s?.obj && s.obj[`${s.k}.${a}`] !== void 0 && (s.obj = void 0);
	s.obj[`${s.k}.${a}`] = n;
}, ee = (e, t, n, r) => {
	let { obj: i, k: a } = k(e, t, Object);
	i[a] = i[a] || [], i[a].push(n);
}, j = (e, t) => {
	let { obj: n, k: r } = k(e, t);
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? S(e[r]) || e[r] instanceof String || S(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : M(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, N = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), ne = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, re = (e) => S(e) ? e.replace(/[&<>"'\/]/g, (e) => ne[e]) : e, ie = class {
	constructor(e) {
	...
	getResource(e, t, n, r = {}) {
		...
		let s = j(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !S(n) ? s : P(this.data?.[e]?.[t], n, i);
	}
	addResource(e, t, n, r, i = { silent: !1 }) {
		let a = i.keySeparator === void 0 ? this.options.keySeparator : i.keySeparator, o = [e, t];
		n && (o = o.concat(a ? n.split(a) : n)), e.includes(".") && (o = e.split("."), r = t, t = o[1]), this.addNamespaces(t), A(this.data, o, r), i.silent || this.emit("added", e, t, n, r);
	}
	...
	addResourceBundle(e, t, n, r, i, a = {
		...
		a.skipCopy || (n = JSON.parse(JSON.stringify(n))), r ? M(s, n, i) : s = {
			...s,
			...n
		}, A(this.data, o, s), a.silent || this.emit("added", e, t, n);
	}
...
}, B = Symbol("i18next/PATH_KEY");
function le() {
	let e = [], t = Object.create(null), n;
	return t.get = (r, i) => (n?.revoke?.(), i === B ? e : (e.push(i), n = Proxy.revocable(r, t), n.proxy)), Proxy.revocable(Object.create(null), t).proxy;
}
function V(e, t) {
	let { [B]: n } = e(le()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var H = (e) => !S(e) && typeof e != "boolean" && typeof e != "number", U = class e extends L {
	constructor(e, t = {}) {
		super(), T([
			"resourceStore",
			"languageUtils",
	...
	translate(t, n, r) {
		...
		y && !m && x && (D = E);
		let O = H(D), k = Object.prototype.toString.apply(D);
		if (y && D && O && !_.includes(k) && !(S(v) && Array.isArray(D))) {
		...
		} else if (y && S(v) && Array.isArray(m)) m = m.join(v), m &&= this.extendTranslation(m, t, i, r);
		else {
			let e = !1, n = !1;
	...
	extendTranslation(e, t, n, r, i) {
		if (this.i18nFormat?.parse) e = this.i18nFormat.parse(e, {
			...
			let s = n.replace && !S(n.replace) ? n.replace : n;
		...
		return e != null && o?.length && n.applyPostProcessor !== !1 && (e = z.handle(o, e, t, this.options && this.options.postProcessPassResolved ? {
			i18nResolved: {
				...r,
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return S(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? V(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
			...
			let u = t.count !== void 0 && !S(t.count), d = u && !t.ordinal && t.count === 0, f = t.context !== void 0 && (S(t.context) || typeof t.context == "number") && t.context !== "", p = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
			l.forEach((e) => {
	...
	let a = te(e, t, n);
	return !a && i && S(n) && (a = P(e, n, r), a === void 0 && (a = P(t, n, r))), a;
}, G = (e) => e.replace(/\$/g, "$$$$"), me = class {
	constructor(e = {}) {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? re : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? N(i) : a || "{{", this.suffix = o ? N(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : l || "", this.nestingPrefix = d ? N(d) : f || N("$t("), this.nestingSuffix = p ? N(p) : m || N(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		let i, a, o, s = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (e) => {
			if (!e.includes(this.formatSeparator)) {
				let i = pe(t, s, e, this.options.keySeparator, this.options.ignoreJSONStructure);
			...
			return this.format(pe(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
				...r,
				...t,
				interpolationkey: a
			});
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				else !S(a) && !this.useRawValueToEscape && (a = w(a));
				let s = t.safeValue(a);
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			if (c !== -1 && (s = r[1].slice(c).split(this.formatSeparator).map((e) => e.trim()).filter(Boolean), r[1] = r[1].slice(0, c)), i = t(o.call(this, r[1].trim(), a), a), i && r[0] === e && !S(i)) return i;
			S(i) || (i = w(i)), i ||= (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), ""), s.length && (i = s.reduce((e, t) => this.format(e, t, n.lng, {
				...n,
...
}), xe = (e) => (S(e.ns) && (e.ns = [e.ns]), S(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), S(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), q = () => {}, Se = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, J = class e extends L {
	constructor(e = {}, t) {
		if (super(), this.options = xe(e), this.services = {}, this.logger = I, this.modules = { external: [] }, Se(this), t && !this.isInitialized && !e.isClone) {
	...
	use(e) {
		...
		return e.type === "backend" && (this.modules.backend = e), (e.type === "logger" || e.log && e.warn && e.error) && (this.modules.logger = e), e.type === "languageDetector" && (this.modules.languageDetector = e), e.type === "i18nFormat" && (this.modules.i18nFormat = e), e.type === "postProcessor" && z.addPostProcessor(e), e.type === "formatter" && (this.modules.formatter = e), e.type === "3rdParty" && this.modules.external.push(e), this;
	}
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new W(K());
	...
	cloneInstance(t = {}, n = q) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a[e] = this[e];
		}), a.services = { ...this.services }, a.services.utils = { hasLoadedNamespace: a.hasLoadedNamespace.bind(a) }, r && (a.store = new R(Object.keys(this.store.data).reduce((e, t) => (e[t] = { ...this.store.data[t] }, e[t] = Object.keys(e[t]).reduce((n, r) => (n[r] = { ...e[t][r] }, n), e[t]), e), {}), i), a.services.resourceStore = a.store), t.interpolation) {
			let e = {
				...K().interpolation,
				...this.options.interpolation,
				...t.interpolation
		...
		return a.translator = new U(a.services, i), a.translator.on("*", (e, ...t) => {
			a.emit(e, ...t);
...
var Ce = (e, t, n, r) => {
	...
	Z(n) && we[n] || (Z(n) && (we[n] = /* @__PURE__ */ new Date()), Ce(e, t, n, r));
}, Te = (e, t) => () => {
...
}, De = (e, t, n = {}) => !t.languages || !t.languages.length ? (Y(t, "NO_LANGUAGES", "i18n.languages were undefined or empty", { languages: t.languages }), !0) : t.hasLoadedNamespace(e, {
	lng: n.lng,
	precheck: (t, r) => {
...
}), Z = (e) => typeof e == "string", Oe = (e) => typeof e == "object" && !!e, ke = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Ae = {
	"&amp;": "&",
	"&#38;": "&",
	"&lt;": "<",
	"&#60;": "<",
	...
	process.env.NODE_ENV !== "production" && (function() {
		...
		var a = x("react"), o = typeof Object.is == "function" ? Object.is : t, s = a.useState, c = a.useEffect, l = a.useLayoutEffect, u = a.useDebugValue, d = !1, f = !1, p = typeof window > "u" || window.document === void 0 || window.document.createElement === void 0 ? i : n;
	...
	t: (e, t) => {
		if (Z(t)) return t;
		if (Oe(t) && Z(t.defaultValue)) return t.defaultValue;
	...
	let { i18n: c } = t, { i18n: l, defaultNS: u } = r($) || {}, d = c || l || Ie();
	d && !d.reportNamespaces && (d.reportNamespaces = new Re()), d || Y(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
	let f = a(() => ({
		...Ne(),
		...d?.options?.react,
		...t
	}), [d, t]), { useSuspense: p, keyPrefix: m } = f, h = e || u || d?.options?.defaultNS, g = Z(h) ? [h] : h || ["translation"], _ = a(() => g, g);
	...
	let v = o(0), y = n((e) => {
		...
		f,
		t.lng
	]), [S, C] = s(0), { t: w, ready: T } = (0, Ve.useSyncExternalStore)(y, x, x);
	i(() => {
		if (d && !T && !p) {
			let e = () => C((e) => e + 1);
			t.lng ? Ee(d, t.lng, _, e) : X(d, _, e);
		}
	}, [
		d,
		t.lng,
	...
	if (d && p && !T) throw new Promise((e) => {
		let n = () => e();
		t.lng ? Ee(d, t.lng, _, n) : X(d, _, n);
	});
	return A;
};
function Ge({ i18n: e, defaultNS: n, children: r }) {
	let i = a(() => ({
		i18n: e,
		defaultNS: n
	}), [e, n]);
	return t($.Provider, { value: i }, r);
}
function Ke() {
	let { t: e } = We(), t = [
		{
