...
function I(e, t) {
	let { [ie]: n } = e(ae()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":", a = t?.enableSelector === "strict";
	if (n.length > 1 && i) {
...
var L = (e) => !p(e) && typeof e != "boolean" && typeof e != "number", R = class e extends P {
	constructor(e, t = {}) {
		super(), g([
			"resourceStore",
			"languageUtils",
	...
	init(e, t = { interpolation: {} }) {
		...
		let n = t.cacheInBuiltFormats ? G : ce;
		this.formats = {
			number: n((e, t) => {
...
}), q = (e) => (p(e.ns) && (e.ns = [e.ns]), p(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), p(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), J = () => {}, fe = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Y = class e extends P {
	constructor(e = {}, t) {
		if (super(), this.options = q(e), this.services = {}, this.logger = N, this.modules = { external: [] }, fe(this), t && !this.isInitialized && !e.isClone) {
...
var pe = (e, t, n, r) => {
	...
	d && !d.reportNamespaces && (d.reportNamespaces = new ke()), d || X(d, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next or by passing it via props or context. In monorepo setups, make sure there is only one instance of react-i18next.");
	let f = a(() => ({
		...Ce(),
		...d?.options?.react,
		...t
