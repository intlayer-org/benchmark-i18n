	...
	return u("form", {
		...
		children: [
			...
			u("div", { children: [l("label", {
				...
				children: [
					l("option", { children: "Bug Report" }),
					l("option", { children: "New Benchmark Idea" }),
					l("option", { children: "Methodology Question" }),
					l("option", { children: "Contribution" }),
					l("option", { children: "Other" })
				]
			})] }),
			u("div", { children: [l("label", {
				htmlFor: i,
