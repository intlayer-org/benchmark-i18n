...
var en = {
	de: {
		...
		mockBanner: "⚠️ Diese Seite enthält Beispieldaten nur zu Benchmarking-Zwecken. Sie steht in keinem Zusammenhang mit einem echten Unternehmen oder Dienst."
	},
	en: {
		"header.home": "Home",
	...
	es: {
		...
		mockBanner: "⚠️ Esta página contiene datos de muestra solo para fines de benchmarking. No está relacionada con ningún negocio o servicio real."
	},
	fr: {
		"header.home": "Accueil",
		...
		mockBanner: "⚠️ Cette page contient des données fictives à des fins de benchmarking uniquement. Elle n'est liée à aucune entreprise ou service réel."
	},
	it: {
		"header.home": "Home",
		...
		mockBanner: "⚠️ Questa pagina contiene dati di esempio solo a scopo di benchmarking. Non è correlata ad alcuna attività o servizio reale."
	},
	ja: {
		"header.home": "ホーム",
	...
	ru: {
		...
		mockBanner: "⚠️ Эта страница содержит макетные данные только для целей бенчмаркинга. Она не связана с каким-либо реальным бизнесом или услугой."
	},
	zh: {
		"header.home": "首页",
