...
import p from "../messages/de.json";
import m from "../messages/es.json";
import h from "../messages/fr.json";
import g from "../messages/it.json";
import ee from "../messages/ja.json";
import te from "../messages/ko.json";
import ne from "../messages/pt.json";
import re from "../messages/ru.json";
import ie from "../messages/zh.json";
function _(e, t) {
	let n = t && t.cache ? t.cache : fe, r = t && t.serializer ? t.serializer : ue;
	return (t && t.strategy ? t.strategy : se)(e, {
		cache: n,
		serializer: r
	});
}
...
function se(e, t) {
	let n = e.length === 1 ? v : oe;
	return y(e, this, n, t.cache.create(), t.serializer);
}
function ce(e, t) {
	return y(e, this, oe, t.cache.create(), t.serializer);
}
function le(e, t) {
...
var ue = function() {
	...
	variadic: ce,
	monadic: le
}, pe = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function me(e) {
	let t = {};
...
function Fe(e, t) {
	...
	for (let r = 0; r < e.length; r++) {
		...
		if (i === "j") {
			...
			let o = 1 + (a & 1), s = a < 2 ? 1 : 3 + (a >> 1), c = Ie(t);
...
var Le = RegExp(`^${Pe.source}*`), Re = RegExp(`${Pe.source}*$`);
function k(e, t) {
	return {
		start: e,
		end: t
...
var ze = !!Object.fromEntries, Be = !!String.prototype.trimStart, Ve = !!String.prototype.trimEnd, A = ze ? Object.fromEntries : function(e) {
	let t = {};
			...
			case "time": {
				...
				if (e && e.style.startsWith("::")) {
					...
					if (a === "number") {
						...
						let r = t;
						this.locale && (r = Fe(t, this.locale));
						let o = {
							type: T.dateTime,
							pattern: r,
...
function N(e) {
	e.forEach((e) => {
		if (delete e.location, ke(e) || Ae(e)) for (let t in e.options) delete e.options[t].location, N(e.options[t].value);
		else Ee(e) && Ne(e.style) || (De(e) || Oe(e)) && E(e.style) ? delete e.style.location : Me(e) && N(e.children);
	});
}
function Ye(e, t = {}) {
	t = {
...
function R(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (Ee(c)) {
			let e = typeof c.style == "string" ? r.number[c.style] : Ne(c.style) ? c.style.parsedOptions : void 0;
			if (e && e.scale) {
				let t = e.scale || 1;
				if (typeof l == "bigint") {
...
function ut(e = lt()) {
	let t = Intl.RelativeTimeFormat, n = Intl.ListFormat, r = Intl.DisplayNames, i = _((...e) => new Intl.DateTimeFormat(...e), {
		cache: K(e.dateTime),
		strategy: b.variadic
	}), a = _((...e) => new Intl.NumberFormat(...e), {
		cache: K(e.number),
		strategy: b.variadic
	}), o = _((...e) => new Intl.PluralRules(...e), {
	...
	return {
		getDateTimeFormat: i,
		getNumberFormat: a,
		getMessageFormat: _((e, t, n, r) => new B(e, t, n, {
			formatters: {
				getNumberFormat: a,
				getDateTimeFormat: i,
				getPluralRules: o
		...
		getRelativeTimeFormat: _((...e) => new t(...e), {
			cache: K(e.relativeTime),
			strategy: b.variadic
		}),
		getPluralRules: o,
		getListFormat: _((...e) => new n(...e), {
			cache: K(e.list),
			strategy: b.variadic
		}),
		getDisplayNames: _((...e) => new r(...e), {
...
function ft(e, t) {
	...
	return {
		...n,
		...e,
		date: dt(J(n.date, t), J(e.date || {}, t)),
		time: dt(J(n.time, t), J(e.time || {}, t))
	};
}
var Y = ({ locale: e, formats: t, messages: n, defaultLocale: r, defaultFormats: i, fallbackOnEmptyString: a, onError: o, timeZone: s, defaultRichTextElements: c }, l, u = { id: "" }, d, f) => {
	...
	st(!!p, "[@formatjs/intl] An `id` must be provided to format a message. You can either:\n1. Configure your build toolchain with [babel-plugin-formatjs](https://formatjs.github.io/docs/tooling/babel-plugin)\nor [@formatjs/ts-transformer](https://formatjs.github.io/docs/tooling/ts-transformer) OR\n2. Configure your `eslint` config to include [eslint-plugin-formatjs](https://formatjs.github.io/docs/tooling/linter#enforce-id)\nto autofix this issue");
	...
	if (d = {
		...
		if (a === !1 && g === "") return g;
		if ((!m || e && e.toLowerCase() !== r.toLowerCase()) && o(new ot(u, e)), m) try {
...
var xt = ["type", "style"], St = Date.now();
function Ct(e) {
	return `${St}_${e}_${St}`;
}
function wt(e, t, n, r = {}) {
	let i = Tt(e, t, n, r).reduce((e, t) => {
		let n = t.value;
...
function kt({ locale: e, formats: t, onError: n }, r, i = {}) {
	let { format: a } = i;
	return r(e, G(i, Ot, !!a && q(t, "relative", a, n) || {}));
}
...
function Mt({ locale: e, formats: t, onError: n }, r, i = {}) {
	let { format: a } = i;
	return r(e, G(i, jt, a && q(t, "number", a, n) || {}));
}
function Nt(e, t, n, r = {}) {
	try {
...
function Lt(e, t) {
	...
	return i ? !Intl.NumberFormat.supportedLocalesOf(i).length && o ? o(new at(`Missing locale data for locale: "${i}" in Intl.NumberFormat. Using default locale: "${a}" as fallback. See https://formatjs.github.io/docs/react-intl#runtime-requirements for more details`)) : !Intl.DateTimeFormat.supportedLocalesOf(i).length && o && o(new at(`Missing locale data for locale: "${i}" in Intl.DateTimeFormat. Using default locale: "${a}" as fallback. See https://formatjs.github.io/docs/react-intl#runtime-requirements for more details`)) : (o && o(new it(`"locale" was not configured, using "${a}" as fallback. See https://formatjs.github.io/docs/react-intl/api#intlshape for more details`)), r.locale = r.defaultLocale || "en"), It(r), {
		...r,
		formatters: n,
		formatNumber: Nt.bind(null, r, n.getNumberFormat),
		formatNumberToParts: Pt.bind(null, r, n.getNumberFormat),
		formatRelativeTime: At.bind(null, r, n.getRelativeTimeFormat),
		formatDate: mt.bind(null, r, n.getDateTimeFormat),
		formatDateToParts: _t.bind(null, r, n.getDateTimeFormat),
		formatTime: ht.bind(null, r, n.getDateTimeFormat),
		formatDateTimeRange: gt.bind(null, r, n.getDateTimeFormat),
		...
		$t: Y.bind(null, r, n),
		formatList: wt.bind(null, r, n.getListFormat),
		formatListToParts: Tt.bind(null, r, n.getListFormat),
		formatDisplayName: bt.bind(null, r, n.getDisplayNames)
	};
}
function Rt(e, t, n = Error) {
	if (!e) throw new n(t);
}
function zt(e) {
	Rt(e, "[React Intl] Could not find required `intl` object. <IntlProvider> needs to exist in the component ancestry.");
}
var Bt = {
	...ct,
	textComponent: e.Fragment
}, Vt = (t) => e.Children.toArray(t).map((t, n) => e.isValidElement(t) ? d(e.Fragment, { children: t }, n) : t);
function Ht(e) {
	return function(t) {
		return e(Vt(t));
	};
...
var Ut = e.createContext(null), Wt = Ut.Provider;
function Gt() {
...
function Kt(e) {
	return e && Object.keys(e).reduce((t, n) => {
		let r = e[n];
		return t[n] = $e(r) ? Ht(r) : r, t;
	}, {});
}
var qt = (e, t, n, r, ...i) => {
	let a = Y(e, t, n, Kt(r), ...i);
...
function Xt(t) {
	let { formatMessage: n, textComponent: r = e.Fragment } = Gt(), { id: i, description: a, defaultMessage: o, values: s, children: c, tagName: l = r, ignoreTag: f } = t, p = n({
		id: i,
		description: a,
		defaultMessage: o
	}, s, { ignoreTag: f });
...
function Qt(t) {
	let n = e.useRef(lt()), r = e.useRef(void 0), i = e.useRef(void 0), a = {};
	for (let e in t) t[e] !== void 0 && (a[e] = t[e]);
	let o = Zt({
		...Bt,
		...a
	});
	return (!r.current || !Z(r.current, o)) && (r.current = o, i.current = Jt(o, n.current)), zt(i.current), d(Wt, {
		value: i.current,
		children: t.children
	});
}
Qt.displayName = "IntlProvider";
var $t = Qt;
function en() {
...
function tn() {
	...
	let i = Gt(), o = e === "auto" ? i.formatMessage({ id: "theme-toggle.themeModeAutoSystemClick" }) : e === "light" ? i.formatMessage({ id: "theme-toggle.themeModeLightClick" }) : i.formatMessage({ id: "theme-toggle.themeModeDarkClick" });
	return d("button", {
		type: "button",
		onClick: n,
		"aria-label": o,
