...
import a from "../../../messages/de.json";
import o from "../../../messages/es.json";
import s from "../../../messages/fr.json";
import c from "../../../messages/it.json";
import l from "../../../messages/ja.json";
import u from "../../../messages/ko.json";
import d from "../../../messages/pt.json";
import f from "../../../messages/ru.json";
import p from "../../../messages/zh.json";
function m(e, t) {
...
var b = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, de = /^(@+)?(\+|#+)?[rs]?$/g, fe = /(\*)(0+)|(#+)(0+)|(0+)/g, pe = /^(0+)$/;
function x(e) {
	let t = {};
...
function ge(e) {
	...
	for (let n of e) {
		...
		if (b.test(n.stem)) {
			...
			n.stem.replace(b, function(e, n, r, i, a, o) {
...
var De = RegExp(`^${k.source}*`), Oe = RegExp(`${k.source}*$`);
function j(e, t) {
	return {
		start: e,
		end: t
...
var ke = !!Object.fromEntries, Ae = !!String.prototype.trimStart, je = !!String.prototype.trimEnd, M = ke ? Object.fromEntries : function(e) {
	let t = {};
...
function F(e) {
	e.forEach((e) => {
		if (delete e.location, be(e) || xe(e)) for (let t in e.options) delete e.options[t].location, F(e.options[t].value);
		else ye(e) && we(e.style) || (T(e) || E(e)) && D(e.style) ? delete e.style.location : Ce(e) && F(e.children);
	});
}
function ze(e, t = {}) {
	t = {
...
function V(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (Ce(c)) {
			...
			if (!B(u)) throw new Be(l, "function", o);
...
function Ge(e = {
	...
	return {
		getNumberFormat: m((...e) => new Intl.NumberFormat(...e), {
			cache: H(e.number),
			strategy: y.variadic
		}),
		getDateTimeFormat: m((...e) => new Intl.DateTimeFormat(...e), {
			cache: H(e.dateTime),
			strategy: y.variadic
		}),
		getPluralRules: m((...e) => new Intl.PluralRules(...e), {
...
function et(e = $e()) {
	let t = Intl.RelativeTimeFormat, n = Intl.ListFormat, r = Intl.DisplayNames, i = m((...e) => new Intl.DateTimeFormat(...e), {
		cache: J(e.dateTime),
		strategy: y.variadic
	}), a = m((...e) => new Intl.NumberFormat(...e), {
		cache: J(e.number),
		strategy: y.variadic
	}), o = m((...e) => new Intl.PluralRules(...e), {
	...
	return {
		getDateTimeFormat: i,
		getNumberFormat: a,
		getMessageFormat: m((e, t, n, r) => new Ke(e, t, n, {
			formatters: {
				getNumberFormat: a,
				getDateTimeFormat: i,
				getPluralRules: o
		...
		getRelativeTimeFormat: m((...e) => new t(...e), {
			cache: J(e.relativeTime),
			strategy: y.variadic
		}),
		getPluralRules: o,
		getListFormat: m((...e) => new n(...e), {
			cache: J(e.list),
			strategy: y.variadic
		}),
		getDisplayNames: m((...e) => new r(...e), {
...
function nt(e, t) {
	...
	return {
		...n,
		...e,
		date: tt(X(n.date, t), X(e.date || {}, t)),
		time: tt(X(n.time, t), X(e.time || {}, t))
	};
}
...
function yt({ locale: e, formats: t, onError: n }, r, i = {}) {
	let { format: a } = i;
	return r(e, q(i, vt, !!a && Y(t, "relative", a, n) || {}));
}
...
function St({ locale: e, formats: t, onError: n }, r, i = {}) {
	let { format: a } = i;
	return r(e, q(i, xt, a && Y(t, "number", a, n) || {}));
}
function Ct(e, t, n, r = {}) {
	try {
...
}, jt = (t) => e.Children.toArray(t).map((t, n) => e.isValidElement(t) ? r(e.Fragment, { children: t }, n) : t);
function Mt(e) {
	return function(t) {
		return e(jt(t));
	};
...
function Lt(e) {
	return e && Object.keys(e).reduce((t, n) => {
		let r = e[n];
		return t[n] = B(r) ? Mt(r) : r, t;
	}, {});
}
var Rt = (e, t, n, r, ...i) => {
	let a = Z(e, t, n, Lt(r), ...i);
...
function Vt(t) {
	let n = e.useRef($e()), i = e.useRef(void 0), a = e.useRef(void 0), o = {};
	for (let e in t) t[e] !== void 0 && (o[e] = t[e]);
	let s = Bt({
		...At,
		...o
	});
	return (!i.current || !Nt(i.current, s)) && (i.current = s, a.current = zt(s, n.current)), kt(a.current), r(Ft, {
		value: a.current,
		children: t.children
	});
}
