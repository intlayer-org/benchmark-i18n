...
function A(e) {
	e.forEach((e) => {
		...
		else x(e) && w(e.style) || (ge(e) || _e(e)) && T(e.style) ? delete e.style.location : C(e) && A(e.children);
	});
}
function Le(e, t = {}) {
	t = {
...
function Q(t) {
	let n = (n) => {
		let r = Z(), { value: i, children: o, ...s } = n, c = r[t](i, s);
...
function Lt(t) {
	let { formatMessage: n, textComponent: r = e.Fragment } = Z(), { id: o, description: s, defaultMessage: c, values: l, children: u, tagName: d = r, ignoreTag: f } = t, p = n({
		id: o,
		description: s,
		defaultMessage: c
	}, l, { ignoreTag: f });
...
function zt(t) {
	let n = e.useRef(W()), r = e.useRef(void 0), i = e.useRef(void 0), o = {};
	for (let e in t) t[e] !== void 0 && (o[e] = t[e]);
	let s = Rt({
		...Tt,
		...o
	});
	return (!r.current || !X(r.current, s)) && (r.current = s, i.current = Ft(s, n.current)), wt(i.current), a(kt, {
		value: i.current,
		children: t.children
	});
}
