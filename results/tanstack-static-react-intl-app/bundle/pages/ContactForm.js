	...
	return jsxs("form", {
		...
		children: [
			...
			jsxs("div", { children: [jsx("label", {
				...
				children: [
					jsx("option", { children: intl.formatMessage({ id: "contact-form.bugReport" }) }),
					jsx("option", { children: intl.formatMessage({ id: "contact-form.newBenchmarkIdea" }) }),
					jsx("option", { children: intl.formatMessage({ id: "contact-form.methodologyQuestion" }) }),
					jsx("option", { children: intl.formatMessage({ id: "contact-form.contribution" }) }),
					jsx("option", { children: intl.formatMessage({ id: "contact-form.other" }) })
				]
			})] }),
			jsxs("div", { children: [jsx("label", {
				htmlFor: messageId,
