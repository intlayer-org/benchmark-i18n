...
import s from "../../../messages/de.json";
import c from "../../../messages/es.json";
import l from "../../../messages/fr.json";
import u from "../../../messages/it.json";
import d from "../../../messages/ja.json";
import f from "../../../messages/ko.json";
import p from "../../../messages/pt.json";
import m from "../../../messages/ru.json";
import h from "../../../messages/zh.json";
function g(e, t) {
...
var ae = function() {
	...
	variadic: re,
	monadic: ie
}, ce = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function le(e) {
	let t = {};
...
var b = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, x = /^(@+)?(\+|#+)?[rs]?$/g, pe = /(\*)(0+)|(#+)(0+)|(0+)/g, me = /^(0+)$/;
function he(e) {
	let t = {};
...
var Ae = RegExp(`^${De.source}*`), je = RegExp(`${De.source}*$`);
function A(e, t) {
	return {
		start: e,
		end: t
...
function M(e) {
	e.forEach((e) => {
		if (delete e.location, Se(e) || Ce(e)) for (let t in e.options) delete e.options[t].location, M(e.options[t].value);
		else ye(e) && Ee(e.style) || (be(e) || xe(e)) && D(e.style) ? delete e.style.location : Te(e) && M(e.children);
	});
}
function We(e, t = {}) {
	t = {
...
function R(e, t, n, r, i, a, o) {
	...
	for (let c of e) {
		...
		if (ye(c)) {
			let e = typeof c.style == "string" ? r.number[c.style] : Ee(c.style) ? c.style.parsedOptions : void 0;
			if (e && e.scale) {
				let t = e.scale || 1;
				if (typeof l == "bigint") {
		...
		if (Te(c)) {
			...
			if (!L(u)) throw new Ge(l, "function", o);
...
function it(e = rt()) {
	let t = Intl.RelativeTimeFormat, n = Intl.ListFormat, r = Intl.DisplayNames, i = g((...e) => new Intl.DateTimeFormat(...e), {
		cache: K(e.dateTime),
		strategy: y.variadic
	}), a = g((...e) => new Intl.NumberFormat(...e), {
		cache: K(e.number),
		strategy: y.variadic
	}), o = g((...e) => new Intl.PluralRules(...e), {
	...
	return {
		getDateTimeFormat: i,
		getNumberFormat: a,
		getMessageFormat: g((e, t, n, r) => new B(e, t, n, {
			formatters: {
				getNumberFormat: a,
				getDateTimeFormat: i,
				getPluralRules: o
		...
		getRelativeTimeFormat: g((...e) => new t(...e), {
			cache: K(e.relativeTime),
			strategy: y.variadic
		}),
		getPluralRules: o,
		getListFormat: g((...e) => new n(...e), {
			cache: K(e.list),
			strategy: y.variadic
		}),
		getDisplayNames: g((...e) => new r(...e), {
...
function ot(e, t) {
	...
	return {
		...n,
		...e,
		date: at(J(n.date, t), J(e.date || {}, t)),
		time: at(J(n.time, t), J(e.time || {}, t))
	};
}
var Y = ({ locale: e, formats: t, messages: n, defaultLocale: r, defaultFormats: i, fallbackOnEmptyString: a, onError: o, timeZone: s, defaultRichTextElements: c }, l, u = { id: "" }, d, f) => {
	...
	tt(!!p, "[@formatjs/intl] An `id` must be provided to format a message. You can either:\n1. Configure your build toolchain with [babel-plugin-formatjs](https://formatjs.github.io/docs/tooling/babel-plugin)\nor [@formatjs/ts-transformer](https://formatjs.github.io/docs/tooling/ts-transformer) OR\n2. Configure your `eslint` config to include [eslint-plugin-formatjs](https://formatjs.github.io/docs/tooling/linter#enforce-id)\nto autofix this issue");
	...
	if (d = {
		...
		if (a === !1 && g === "") return g;
		if ((!m || e && e.toLowerCase() !== r.toLowerCase()) && o(new et(u, e)), m) try {
...
function Ct({ locale: e, formats: t, onError: n }, r, i = {}) {
	let { format: a } = i;
	return r(e, G(i, St, !!a && q(t, "relative", a, n) || {}));
}
...
function Et({ locale: e, formats: t, onError: n }, r, i = {}) {
	let { format: a } = i;
	return r(e, G(i, Tt, a && q(t, "number", a, n) || {}));
}
function Dt(e, t, n, r = {}) {
	try {
...
function jt(e, t) {
	...
	return i ? !Intl.NumberFormat.supportedLocalesOf(i).length && o ? o(new $e(`Missing locale data for locale: "${i}" in Intl.NumberFormat. Using default locale: "${a}" as fallback. See https://formatjs.github.io/docs/react-intl#runtime-requirements for more details`)) : !Intl.DateTimeFormat.supportedLocalesOf(i).length && o && o(new $e(`Missing locale data for locale: "${i}" in Intl.DateTimeFormat. Using default locale: "${a}" as fallback. See https://formatjs.github.io/docs/react-intl#runtime-requirements for more details`)) : (o && o(new Qe(`"locale" was not configured, using "${a}" as fallback. See https://formatjs.github.io/docs/react-intl/api#intlshape for more details`)), r.locale = r.defaultLocale || "en"), At(r), {
		...r,
		formatters: n,
...
}, Pt = (t) => e.Children.toArray(t).map((t, n) => e.isValidElement(t) ? a(e.Fragment, { children: t }, n) : t);
function Ft(e) {
	return function(t) {
		return e(Pt(t));
	};
...
var It = e.createContext(null), Lt = It.Provider;
function Rt() {
...
function zt(e) {
	return e && Object.keys(e).reduce((t, n) => {
		let r = e[n];
		return t[n] = L(r) ? Ft(r) : r, t;
	}, {});
}
var Bt = (e, t, n, r, ...i) => {
	let a = Y(e, t, n, zt(r), ...i);
	return Array.isArray(a) ? Pt(a) : a;
}, Vt = ({ defaultRichTextElements: e, ...t }, n) => {
	let r = zt(e), i = jt({
		...Nt,
		...t,
	...
	return {
		...i,
		formatMessage: Bt.bind(null, a, i.formatters),
		$t: Bt.bind(null, a, i.formatters)
	};
};
function Ht(e, t) {
...
function Ut(t) {
	let { formatMessage: n, textComponent: r = e.Fragment } = Rt(), { id: o, description: s, defaultMessage: c, values: l, children: u, tagName: d = r, ignoreTag: f } = t, p = n({
		id: o,
		description: s,
		defaultMessage: c
	}, l, { ignoreTag: f });
...
function Gt(t) {
	let n = e.useRef(rt()), r = e.useRef(void 0), i = e.useRef(void 0), o = {};
	for (let e in t) t[e] !== void 0 && (o[e] = t[e]);
	let s = Wt({
		...Nt,
		...o
	});
	return (!r.current || !Q(r.current, s)) && (r.current = s, i.current = Vt(s, n.current)), Z(i.current), a(Lt, {
		value: i.current,
		children: t.children
	});
}
Gt.displayName = "IntlProvider";
var Kt = Gt;
function qt(e) {
