...
function sn() {
	let { t: e } = on(), t = l({ strict: !1 }).locale ?? "en", n = [
		{
			...
			children: [d("div", {
				...
				children: [
					d("div", { children: [u("h3", {
						...
						children: u(Q, { keyName: "footer.anOpenSourceTestApplication" })
					})] }),
					d("div", { children: [u("h3", {
						className: "mb-2 text-sm font-semibold text-foreground",
						children: u(Q, { keyName: "footer.resources" })
					}), u("ul", {
						className: "space-y-1",
					...
					d("div", { children: [u("h3", {
						className: "mb-2 text-sm font-semibold text-foreground",
						children: u(Q, { keyName: "footer.contact" })
					}), u("p", {
						className: "text-sm text-muted-foreground",
				...
				children: u(Q, { keyName: "footer.builtWith" })
			})]
		})
	});
}
