...
var Te = () => {
	...
	return t;
}, Ee = 0, H = 1, De = 2, Oe = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Ee ? r = "Empty parameter" : e === H ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function U(e) {
	return /\s/.test(e);
...
var at = { useSuspense: !1 }, ot, st = () => (ot ||= e.createContext(void 0), ot), X = void 0, ct = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = it(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, at), r), h = st();
...
var dt = () => {
	...
	let { tolgee: r, options: a } = dt(), s = A(e), c = j(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = ft(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
function xt() {
	let { t: e } = bt(), t = l({ strict: !1 }).locale ?? "en", n = [
		{
