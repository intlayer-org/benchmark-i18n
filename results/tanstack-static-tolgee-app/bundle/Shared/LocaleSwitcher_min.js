...
import l from "../i18n/locales/es.json";
import u from "../i18n/locales/fr.json";
import d from "../i18n/locales/it.json";
import f from "../i18n/locales/ja.json";
import p from "../i18n/locales/ko.json";
import m from "../i18n/locales/pt.json";
import h from "../i18n/locales/ru.json";
import g from "../i18n/locales/zh.json";
var _ = Object.defineProperty, v = Object.getOwnPropertySymbols, y = Object.prototype.hasOwnProperty, b = Object.prototype.propertyIsEnumerable, x = (e, t, n) => t in e ? _(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function fe(e, t) {
	let n = H(de, t?.initialOptions, e);
	return n.apiUrl = M(n.apiUrl), e?.fetch && (n.fetch = N(e.fetch)), {
		initialOptions: n,
...
function pe(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return D(s.onError, (e) => new ce("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function C() {
		if (!l.languageDetector) return;
		let e = n();
		return D(s.onError, (e) => new se("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function w(e) {
		e && l.backends.push(e);
	}
	...
	let k = Object.freeze({
		...
		setStoredLanguage(e) {
			return D(s.onError, (e) => new ce("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ne(e) || V, r = t().onFormatError, a = typeof r;
...
function he(e, t, n) {
	let r = fe(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? j([t, ...te(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
function ve({ options: e }) {
	let t = oe(), n = me(!1, () => o.isFetching(), t.onFetchingChange.emit), r = me(!1, () => S.isLoading(), t.onLoadingChange.emit), i = he(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = pe(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = le(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var be = () => {
	let e = {
		...
		init(t) {
			let n = ye(H(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, U = 0, W = 1, xe = 2, Se = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var K = 0, q = 1, J = 2, Y = 3, X = 4, Ce = new Set([
	J,
	q,
	K
]), Z = "'", we = new Set([
...
function Ee(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case K:
			...
			break;
		case q:
			we.has(i) ? (n = n.slice(0, -1) + i, t = J) : (n += i, t = K);
			break;
		case J:
			i === Z ? t = K : (n += i, t = J);
			break;
...
var ke = () => (e, t) => (t.setFinalFormatter(Oe()), e), Ae = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, je = {};
(function(e) {
	function t(e, t) {
		var n;
...
(C = console.assert) == null || C.call(console, Me), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ne(e, t) {
	let n = (n) => {
...
function Pe({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var Ie = "tolgee-in-context-tools.umd.min.js", Le = "@tolgee/in-context-tools", Re = "InContextTools", ze = "https://cdn.jsdelivr.net/npm";
function Be(e) {
...
var Ve = null;
function He(e) {
	return Ve ||= Be(`${ze}/@tolgee/web@${e}/dist/${Ie}`).then(() => window[Le][Re]), Ve;
}
var Ue = "__tolgee_apiKey", We = "__tolgee_apiUrl", Ge = "__tolgee_branch";
function Q() {
	let e = sessionStorage.getItem(Ue) || void 0, t = sessionStorage.getItem(We) || void 0, n = sessionStorage.getItem(Ge) || void 0;
	if (!(!e || !t)) return S({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Ke() {
	sessionStorage.removeItem(Ue), sessionStorage.removeItem(We), sessionStorage.removeItem(Ge);
}
function qe(e) {
...
function Ze(e, t, a, o = !0) {
	let [s] = i(() => Xe(e)), [c, l] = i(o);
	return n(() => {
		l(!1);
	}, []), r(() => {
...
var Qe = { useSuspense: !1 }, $e, et = () => ($e ||= e.createContext(void 0), $e), $ = void 0, tt = ({ tolgee: r, options: a, children: o, fallback: s, ssr: c }) => {
	n(() => {
	...
	l = Ze(r, u, d, !!c);
	let [f, p] = i(!l.isLoaded()), m = Object.assign(Object.assign({}, Qe), a), h = et();
