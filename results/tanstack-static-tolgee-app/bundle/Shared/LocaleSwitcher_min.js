...
}, A = (e) => Object.fromEntries(ie(e).entries()), j = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function me(e, t) {
	let n = F(pe, t?.initialOptions, e);
	return n.apiUrl = O(n.apiUrl), e?.fetch && (n.fetch = re(e.fetch)), {
		initialOptions: n,
...
function he(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return x(s.onError, (e) => new le("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return x(s.onError, (e) => new ce("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function E(e) {
		e && l.backends.push(e);
	}
	...
	let k = Object.freeze({
		...
		setStoredLanguage(e) {
			return x(s.onError, (e) => new le("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function ve({ options: e }) {
	let t = oe(), n = I(!1, () => o.isFetching(), t.onFetchingChange.emit), r = I(!1, () => E.isLoading(), t.onLoadingChange.emit), i = ge(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = he(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = ue(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var be = () => {
	...
	return t;
}, R = 0, z = 1, xe = 2, Se = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var B = 0, V = 1, H = 2, U = 3, W = 4, we = /* @__PURE__ */ new Set([
	H,
	V,
	B
]), G = "'", Te = /* @__PURE__ */ new Set([
	"{",
	"}",
	G
...
function De(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case B:
			...
			break;
		case V:
			Te.has(i) ? (n = n.slice(0, -1) + i, t = H) : (n += i, t = B);
			break;
		case H:
			i === G ? t = B : (n += i, t = H);
			break;
		case U:
			i === "}" ? (d(), t = B) : Ce(i) ? r !== "" && (d(), t = W) : (u(), t = U);
			break;
		case W: i == "}" ? t = B : Ce(i) ? t = W : c(z);
	}
	return we.has(t) || c(xe), l(), [a, o];
}
function Oe(e, t) {
	let [n, r] = De(e), i = [n[0]];
...
var Ae = () => (e, t) => (t.setFinalFormatter(ke()), e);
function je() {
	return globalThis.window?.document?.createElement === void 0;
}
var Me = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Ne = {};
(function(e) {
	function t(e, t) {
...
function zt(e, t, a, o = !0) {
	let [s] = i(() => Rt(e)), [c, l] = i(o);
	return n(() => {
		l(!1);
	}, []), r(() => {
...
var Bt = { useSuspense: !1 }, Vt, Ht = () => (Vt ||= e.createContext(void 0), Vt), Q = void 0, Ut = ({ tolgee: r, options: a, children: o, fallback: s, ssr: c }) => {
	n(() => {
	...
	l = zt(r, u, d, !!c);
	let [f, p] = i(!l.isLoaded()), m = Object.assign(Object.assign({}, Bt), a), h = Ht();
