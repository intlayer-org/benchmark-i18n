...
var v = Object.defineProperty, y = Object.getOwnPropertySymbols, b = Object.prototype.hasOwnProperty, x = Object.prototype.propertyIsEnumerable, S = (e, t, n) => t in e ? v(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function ge(e, t, n, r, i, a, o, s) {
	...
	function C() {
		...
		let e = n();
		return O(s.onError, (e) => new ue("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function w(e) {
		e && l.backends.push(e);
	}
	...
	let k = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ie(e) || z, r = t().onFormatError, a = typeof r;
...
function ve(e, t, n) {
	let r = he(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? j([t, ...ne(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
var Se = () => {
	let e = {
		...
		init(t) {
			let n = xe(B(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, H = 0, U = 1, Ce = 2, we = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var G = 0, K = 1, q = 2, J = 3, Y = 4, Te = new Set([
	q,
	K,
	G
]), X = "'", Ee = new Set([
...
function Oe(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case G:
			...
			break;
		case K:
			Ee.has(i) ? (n = n.slice(0, -1) + i, t = q) : (n += i, t = G);
			break;
		case q:
			i === X ? t = G : (n += i, t = q);
			break;
...
var je = () => (e, t) => (t.setFinalFormatter(Ae()), e), Me = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Ne = {};
(function(e) {
	function t(e, t) {
		var n;
...
(w = console.assert) == null || w.call(console, Pe), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Fe(e, t) {
	let n = (n) => {
...
function Ie({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var Re = "tolgee-in-context-tools.umd.min.js", ze = "@tolgee/in-context-tools", Be = "InContextTools", Ve = "https://cdn.jsdelivr.net/npm";
function He(e) {
...
var Ue = null;
function We(e) {
	return Ue ||= He(`${Ve}/@tolgee/web@${e}/dist/${Re}`).then(() => window[ze][Be]), Ue;
}
var Ge = "__tolgee_apiKey", Ke = "__tolgee_apiUrl", Z = "__tolgee_branch";
function qe() {
	let e = sessionStorage.getItem(Ge) || void 0, t = sessionStorage.getItem(Ke) || void 0, n = sessionStorage.getItem(Z) || void 0;
	if (!(!e || !t)) return C({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Je() {
	sessionStorage.removeItem(Ge), sessionStorage.removeItem(Ke), sessionStorage.removeItem(Z);
}
function Ye(e) {
...
var et = { useSuspense: !1 }, tt, nt = () => (tt ||= e.createContext(void 0), tt), Q = void 0, rt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
...
var ot = () => {
	...
	let { tolgee: r, options: a } = ot(), s = te(e), c = A(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = st(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
var $ = (t) => {
	let n = lt(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, dt(t))) : dt(n);
}, ft = (t) => {
	...
	let { t: n } = ct();
	return e.createElement(ft, Object.assign({ t: n }, t));
};
function mt(e) {
	return c(pt, { ...e });
}
