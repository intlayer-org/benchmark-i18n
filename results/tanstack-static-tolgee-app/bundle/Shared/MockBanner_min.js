...
}, j = (e) => Object.fromEntries(ie(e).entries()), M = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function be({ options: e }) {
	let t = oe(), n = ge(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ge(!1, () => T.isLoading(), t.onLoadingChange.emit), i = _e(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = he(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = ue(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Pe = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, G = {};
(function(e) {
	function t(e, t) {
...
var Vt = { useSuspense: !1 }, Ht, Ut = () => (Ht ||= e.createContext(void 0), Ht), Q = void 0, Wt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
...
var en = () => c("div", {
	...
	children: c($t, { keyName: "mockBanner" })
}), tn = {
	route: {
