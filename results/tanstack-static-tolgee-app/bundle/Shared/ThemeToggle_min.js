...
}, P = (e) => Object.fromEntries(fe(e).entries()), F = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function ge(e, t) {
	let n = z(he, t?.initialOptions, e);
	return n.apiUrl = re(n.apiUrl), e?.fetch && (n.fetch = M(e.fetch)), {
		initialOptions: n,
...
function _e(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return D(s.onError, (e) => new de("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function C() {
	...
	let O = Object.freeze({
		...
		setStoredLanguage(e) {
			return D(s.onError, (e) => new de("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function xe({ options: e }) {
	let t = ce(), n = ve(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ve(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ye(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = _e(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = pe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var U = 0, W = 1, G = 2, K = 3, q = 4, De = new Set([
	G,
	W,
	U
]), J = "'", Oe = new Set([
...
function Ae(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case U:
			...
			break;
		case W:
			Oe.has(i) ? (n = n.slice(0, -1) + i, t = G) : (n += i, t = U);
			break;
		case G:
			i === J ? t = U : (n += i, t = G);
			break;
...
(w = console.assert) == null || w.call(console, Ie), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Le(e, t) {
	let n = (n) => {
...
var qe = "__tolgee_apiKey", Je = "__tolgee_apiUrl", Y = "__tolgee_branch";
function Ye() {
	let e = sessionStorage.getItem(qe) || void 0, t = sessionStorage.getItem(Je) || void 0, n = sessionStorage.getItem(Y) || void 0;
	if (!(!e || !t)) return C({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Xe() {
	sessionStorage.removeItem(qe), sessionStorage.removeItem(Je), sessionStorage.removeItem(Y);
}
function Ze(e) {
...
var nt = { useSuspense: !1 }, rt, it = () => (rt ||= e.createContext(void 0), rt), X = void 0, at = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
