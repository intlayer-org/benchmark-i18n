...
var Ce = () => {
	...
	return t;
}, we = 0, I = 1, Te = 2, Ee = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === we ? r = "Empty parameter" : e === I ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function De(e) {
	return /\s/.test(e);
}
var L = 0, R = 1, z = 2, B = 3, V = 4, Oe = /* @__PURE__ */ new Set([
	z,
	R,
	L
]), H = "'", ke = /* @__PURE__ */ new Set([
	"{",
	"}",
	H
...
function je(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case L:
			...
			break;
		case R:
			ke.has(i) ? (n = n.slice(0, -1) + i, t = z) : (n += i, t = L);
			break;
		case z:
			i === H ? t = L : (n += i, t = z);
			break;
		case B:
			i === "}" ? (d(), t = L) : De(i) ? r !== "" && (d(), t = V) : (u(), t = B);
			break;
		case V: i == "}" ? t = L : De(i) ? t = V : c(I);
	}
...
(v = console.assert) == null || v.call(console, Re), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function ze(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, Je = 3e3, Ye = 200, Xe = 0, G = /* @__PURE__ */ new Map(), Ze = !1, K, q;
...
var $e = (e) => new W("unavailable", `the Tolgee browser extension did not answer ${e} in time`), et = () => `${Date.now()}-${Xe++}-${Math.random()}`;
function tt() {
...
function nt(e) {
	return K ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Ge }, window.origin), i = () => {
			clearInterval(a), rt(), q = void 0, n(new W("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var J = "__tolgee_", bt = `${J}apiKey`, xt = `${J}apiUrl`, St = `${J}branch`, Ct = `${J}projectId`, wt = `${J}session`, Tt = "tolgee-in-context-tools.umd.min.js", Et = "@tolgee/in-context-tools", Dt = "InContextTools", Ot = "https://cdn.jsdelivr.net/npm", kt = null;
function At(e) {
...
function It() {
	...
	if (i && r) return _(g({}, a), { transport: it() });
}
function Lt() {
	let e = [];
...
var Wt = { useSuspense: !1 }, Gt, Kt = () => (Gt ||= e.createContext(void 0), Gt), Y = void 0, qt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
