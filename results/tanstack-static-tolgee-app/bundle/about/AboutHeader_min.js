	...
	let T = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = oe(e) || B, r = t().onFormatError, a = typeof r;
...
function be({ options: e }) {
	let t = de(), n = U(!1, () => o.isFetching(), t.onFetchingChange.emit), r = U(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ve(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = _e(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = me(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Se = () => {
	...
	return t;
}, Ce = 0, G = 1, we = 2, Te = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Ce ? r = "Empty parameter" : e === G ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Ee(e) {
	return /\s/.test(e);
...
function Ae(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		...
		case J:
			...
			break;
		case Y:
			i === "}" ? (d(), t = K) : Ee(i) ? r !== "" && (d(), t = X) : (u(), t = Y);
			break;
		case X: i == "}" ? t = K : Ee(i) ? t = X : c(G);
	}
...
var lt = () => {
	...
	let { tolgee: r, options: a } = lt(), o = A(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = ut(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
...
function yt() {
	return vt("AboutHeader"), d(l, { children: [u("h1", {
