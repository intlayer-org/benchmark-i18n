...
var Le = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, W = {};
(function(e) {
	function t(e, t) {
...
function on() {
	...
	return u(c, { children: [l("h2", {
		...
		children: l(an, { keyName: "openPositions.openPositions" })
	}), l("div", {
		className: "space-y-4",
		children: t.map((e) => u("div", {
			...
			children: [u("div", { children: [
				...
				children: l(an, { keyName: "openPositions.applyNow" })
			})]
		}, e.title))
	})] });
}
