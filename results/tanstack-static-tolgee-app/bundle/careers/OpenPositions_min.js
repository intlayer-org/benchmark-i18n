...
}, I = (e) => Object.fromEntries(fe(e).entries()), L = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function _e(e, t) {
	let n = B(ge, t?.initialOptions, e);
	return n.apiUrl = ie(n.apiUrl), e?.fetch && (n.fetch = N(e.fetch)), {
		initialOptions: n,
	...
	let E = Object.freeze({
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ae(e) || z, r = t().onFormatError, a = typeof r;
...
var qe = "__tolgee_apiKey", Je = "__tolgee_apiUrl", Z = "__tolgee_branch";
function Ye() {
	let e = sessionStorage.getItem(qe) || void 0, t = sessionStorage.getItem(Je) || void 0, n = sessionStorage.getItem(Z) || void 0;
	if (!(!e || !t)) return w({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Xe() {
	sessionStorage.removeItem(qe), sessionStorage.removeItem(Je), sessionStorage.removeItem(Z);
}
function Ze(e) {
...
var ct = () => {
	...
	let { tolgee: r, options: a } = ct(), s = ne(e), c = j(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = lt(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
