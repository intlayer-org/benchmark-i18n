...
function rn() {
	return l("section", { children: [c("h2", {
		...
		children: c(Z, { keyName: "resultsTable.sampleResults" })
	}), c("div", {
			...
			children: [c("thead", {
				...
				children: l("tr", { children: [
					c("th", {
						...
						children: c(Z, { keyName: "resultsTable.library" })
					}),
					c("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: c(Z, { keyName: "resultsTable.bundleSize" })
					}),
					c("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: c(Z, { keyName: "resultsTable.lookupTime" })
					}),
					c("th", {
						className: "px-4 py-3 text-left font-medium text-muted-foreground",
						children: c(Z, { keyName: "resultsTable.lazyLoading" })
					})
				] })
			}), c("tbody", { children: [
				{
