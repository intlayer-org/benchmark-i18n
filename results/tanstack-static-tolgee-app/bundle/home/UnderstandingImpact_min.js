	...
	return l("section", {
		...
		children: [
			c("h2", {
				...
				children: c(Z, { keyName: "understandingImpact.understandingTheImpact" })
			}),
			l("div", {
				...
				children: [
					c("h3", {
						...
						children: c(Z, { keyName: "understandingImpact.whyASingleLargeJson" })
					}),
					c("p", {
						className: "text-sm text-muted-foreground",
						children: c(Z, { keyName: "understandingImpact.manyI18nLibrariesStore" })
					}),
					l("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							c("li", { children: c(Z, { keyName: "understandingImpact.theJsonMustBeParsed" }) }),
							c("li", { children: c(Z, { keyName: "understandingImpact.contextBasedArchitecturesCan" }) }),
							c("li", { children: c(Z, { keyName: "understandingImpact.duringServerSideRenderingThe" }) })
						]
					})
				]
			}),
			l("div", {
				...
				children: [
					c("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: c(Z, { keyName: "understandingImpact.theTradeOffsOfDynamic" })
					}),
					c("p", {
						className: "text-sm text-muted-foreground",
						children: c(Z, { keyName: "understandingImpact.splittingTranslationsIntoPerRoute" })
					}),
					l("ul", {
						className: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5",
						children: [
							l("li", { children: [
								c("strong", {
									...
									children: c(Z, { keyName: "understandingImpact.waterfallRequests" })
								}),
								" ",
								c(Z, { keyName: "understandingImpact.theAppMustFirstLoad" })
							] }),
							l("li", { children: [
								c("strong", {
									className: "text-foreground",
									children: c(Z, { keyName: "understandingImpact.flashOfUntranslatedContent" })
								}),
								" ",
								c(Z, { keyName: "understandingImpact.usersMayBrieflySeeTranslation" })
							] }),
							l("li", { children: [
								c("strong", {
									className: "text-foreground",
									children: c(Z, { keyName: "understandingImpact.cacheInvalidation" })
								}),
								" ",
								c(Z, { keyName: "understandingImpact.updatingTranslationsRequiresCache" })
							] })
						]
					})
				]
			...
			l("div", {
				...
				children: [c("h3", {
					className: "mb-2 text-lg font-semibold text-foreground",
					children: c(Z, { keyName: "understandingImpact.whatThisBenchmarkMeasures" })
				}), c("p", {
					className: "text-sm text-muted-foreground",
					children: c(Z, { keyName: "understandingImpact.thisTestAppProvidesA" })
				})]
			})
		]
	});
