...
}, I = (e) => Object.fromEntries(de(e).entries()), L = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function ge(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return D(s.onError, (e) => new F("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function C() {
		if (!l.languageDetector) return;
		let e = n();
		return D(s.onError, (e) => new ue("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function ee(e) {
		e && l.backends.push(e);
	}
	...
	let T = Object.freeze({
		...
		setStoredLanguage(e) {
			return D(s.onError, (e) => new F("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
var Ce = () => {
	let e = {
		...
		init(t) {
			let n = Se(V(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, H = 0, U = 1, we = 2, Te = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var Ke = "__tolgee_apiKey", qe = "__tolgee_apiUrl", Je = "__tolgee_branch";
function Ye() {
	let e = sessionStorage.getItem(Ke) || void 0, t = sessionStorage.getItem(qe) || void 0, n = sessionStorage.getItem(Je) || void 0;
	if (!(!e || !t)) return ee({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Xe() {
	sessionStorage.removeItem(Ke), sessionStorage.removeItem(qe), sessionStorage.removeItem(Je);
}
function Ze(e) {
...
var nt = { useSuspense: !1 }, rt, it = () => (rt ||= e.createContext(void 0), rt), Z = void 0, at = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = tt(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, nt), r), h = it();
...
var ct = () => {
	...
	let { tolgee: r, options: a } = ct(), s = k(e), c = A(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = lt(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
