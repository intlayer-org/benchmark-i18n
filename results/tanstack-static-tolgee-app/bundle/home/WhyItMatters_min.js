...
var Gt = { useSuspense: !1 }, Kt, qt = () => (Kt ||= e.createContext(void 0), Kt), Y = void 0, Jt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
...
function rn() {
	return l("section", {
		...
		children: [c("h2", {
			...
			children: c(Z, { keyName: "whyItMatters.whyTheseMetricsMatter" })
		}), l("div", {
			...
			children: [
				l("div", {
					...
					children: [c("h3", {
						...
						children: c(Z, { keyName: "whyItMatters.bundleSize" })
					}), c("p", {
						className: "text-sm text-muted-foreground",
						children: c(Z, { keyName: "whyItMatters.theBundleIsTheData" })
					})]
				}),
				l("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [c("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: c(Z, { keyName: "whyItMatters.renderingHydration" })
					}), c("p", {
						className: "text-sm text-muted-foreground",
						children: c(Z, { keyName: "whyItMatters.connectingALargeJson" })
					})]
				}),
				l("div", {
					className: "rounded-lg border border-border bg-card p-6",
					children: [c("h3", {
						className: "mb-2 text-lg font-semibold text-foreground",
						children: c(Z, { keyName: "whyItMatters.dynamicLoading" })
					}), c("p", {
						className: "text-sm text-muted-foreground",
						children: c(Z, { keyName: "whyItMatters.loadingAllTranslationsUpfront" })
					})]
				})
			]
		})]
