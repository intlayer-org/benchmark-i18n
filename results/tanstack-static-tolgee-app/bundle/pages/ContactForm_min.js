	...
	return u("form", {
		...
		children: [
			...
			u("div", { children: [l("label", {
				...
				children: [
					l("option", { children: e("contactForm.bugReport", "Bug Report") }),
					l("option", { children: e("contactForm.newBenchmarkIdea", "New Benchmark Idea") }),
					l("option", { children: e("contactForm.methodologyQuestion", "Methodology Question") }),
					l("option", { children: e("contactForm.contribution", "Contribution") }),
					l("option", { children: e("contactForm.other", "Other") })
				]
			})] }),
			u("div", { children: [l("label", {
				htmlFor: i,
