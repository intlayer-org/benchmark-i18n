...
function be({ options: e }) {
	let t = le(), n = H(!1, () => o.isFetching(), t.onFetchingChange.emit), r = H(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ve(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = _e(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = me(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Se = () => {
	...
	return t;
}, Ce = 0, W = 1, we = 2, Te = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Ce ? r = "Empty parameter" : e === W ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Ee(e) {
	return /\s/.test(e);
...
function Ae(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		...
		case q:
			...
			break;
		case J:
			i === "}" ? (d(), t = G) : Ee(i) ? r !== "" && (d(), t = Y) : (u(), t = J);
			break;
		case Y: i == "}" ? t = G : Ee(i) ? t = Y : c(W);
	}
...
var lt = () => {
	...
	let { tolgee: r, options: a } = lt(), o = ne(e), c = j(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = ut(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
		...
		children: [l("h2", {
			...
			children: [
				...
				u("div", { children: [l("label", {
					...
					children: [
						l("option", { children: e("preferencesSection.englishEn", "English (en)") }),
						l("option", { children: e("preferencesSection.frenchFr", "French (fr)") }),
						l("option", { children: e("preferencesSection.germanDe", "German (de)") }),
						l("option", { children: e("preferencesSection.spanishEs", "Spanish (es)") }),
						l("option", { children: e("preferencesSection.japaneseJa", "Japanese (ja)") }),
						l("option", { children: e("preferencesSection.chineseSimplifiedZhCn", "Chinese Simplified (zh-CN)") }),
						l("option", { children: e("preferencesSection.arabicAr", "Arabic (ar)") })
					]
				})] })
			]
		})]
