...
import u from "../../../i18n/locales/de.json";
import d from "../../../i18n/locales/es.json";
import f from "../../../i18n/locales/fr.json";
import p from "../../../i18n/locales/it.json";
import m from "../../../i18n/locales/ja.json";
import h from "../../../i18n/locales/ko.json";
import g from "../../../i18n/locales/pt.json";
import _ from "../../../i18n/locales/ru.json";
import v from "../../../i18n/locales/zh.json";
var y = Object.defineProperty, b = Object.getOwnPropertySymbols, x = Object.prototype.hasOwnProperty, S = Object.prototype.propertyIsEnumerable, C = (e, t, n) => t in e ? y(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
}, L = (e) => Object.fromEntries(ue(e).entries()), R = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
	};
}, z = ({ language: e, namespace: t }) => t ? `${e}:${t}` : e;
function de(e, t, n, r, i, a, o) {
	...
	let m = Object.freeze({
		...
		getAllRecords() {
			return Array.from(c.entries()).map(([e]) => m.getRecord(R(e)));
		},
		getTranslation(e, t) {
			return c.get(z(e))?.data[t];
		},
		getTranslationNs(e, t, n) {
			for (let r of e) for (let e of t) if (c.get(z({
				language: e,
				namespace: r
		...
		isFetching(e) {
			...
			let t = M(e);
			return !!Array.from(s.keys()).find((e) => t.includes(R(e).namespace));
		},
		isLoading(e, t) {
			let n = M(t);
		...
		async loadRecords(e, t) {
			...
			return n.forEach((e) => {
				e.promise && (e.data = L(c[0] ?? {}), c.shift());
...
function me(e, t) {
	let n = H(pe, t?.initialOptions, e);
	return n.apiUrl = ne(n.apiUrl), e?.fetch && (n.fetch = P(e.fetch)), {
		initialOptions: n,
...
function he(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return k(s.onError, (e) => new le("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function C() {
		if (!l.languageDetector) return;
		let e = n();
		return k(s.onError, (e) => new ce("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function w(e) {
		e && l.backends.push(e);
	}
	...
	let D = Object.freeze({
		...
		setStoredLanguage(e) {
			return k(s.onError, (e) => new le("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		getBackendDevRecord: async ({ language: e, namespace: n }) => {
			...
			if (!(!r || !i || !D.hasDevBackend())) return l.devBackend?.getRecord(Object.assign({
				apiKey: r,
				apiUrl: i,
				projectId: a,
				branch: o,
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = B(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = re(e) || V, r = t().onFormatError, a = typeof r;
...
function _e(e, t, n) {
	let r = me(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? N([t, ...te(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
		...
		getAvailableLanguages() {
			...
			if (r.initialOptions.staticData) {
				let e = Object.keys(r.initialOptions.staticData).map((e) => R(e).language);
				return Array.from(new Set(e));
			}
		},
		getAvailableNs() {
...
function ve(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = B(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
function ye({ options: e }) {
	let t = se(), n = ge(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ge(!1, () => S.isLoading(), t.onLoadingChange.emit), i = _e(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = he(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = de(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var xe = () => {
	let e = {
		...
		init(t) {
			let n = be(H(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, W = 0, G = 1, Se = 2, Ce = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var q = 0, J = 1, Y = 2, X = 3, Z = 4, we = new Set([
	Y,
	J,
	q
]), Q = "'", Te = new Set([
...
function De(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case q:
			...
			break;
		case J:
			Te.has(i) ? (n = n.slice(0, -1) + i, t = Y) : (n += i, t = q);
			break;
		case Y:
			i === Q ? t = q : (n += i, t = Y);
			break;
...
(T = console.assert) == null || T.call(console, Ne), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Pe(e, t) {
	let n = (n) => {
...
var et = { useSuspense: !1 }, tt, nt = () => (tt ||= e.createContext(void 0), tt), $ = void 0, rt = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = $e(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, et), r), h = nt();
...
var ot = () => {
	...
	let { tolgee: r, options: a } = ot(), s = j(e), c = M(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = st(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
