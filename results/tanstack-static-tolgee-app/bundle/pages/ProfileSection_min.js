...
var rt = { useSuspense: !1 }, it, at = () => (it ||= e.createContext(void 0), it), Z = void 0, ot = ({ tolgee: n, options: r, children: a, fallback: o, ssr: s }) => {
	i(() => {
...
var lt = () => {
	...
	let { tolgee: r, options: a } = lt(), o = re(e), c = A(o).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = ut(), f = s([]);
	f.current = [];
	let p = r.isLoaded(o);
	i(() => {
		let e = r.on("update", u);
