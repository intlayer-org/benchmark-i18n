...
function he(e, t) {
	let n = V(me, t?.initialOptions, e);
	return n.apiUrl = ie(n.apiUrl), e?.fetch && (n.fetch = M(e.fetch)), {
		initialOptions: n,
...
function ge(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return D(s.onError, (e) => new P("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function C() {
	...
	let T = Object.freeze({
		...
		setStoredLanguage(e) {
			return D(s.onError, (e) => new P("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ae(e) || B, r = t().onFormatError, a = typeof r;
...
function be({ options: e }) {
	let t = le(), n = _e(!1, () => o.isFetching(), t.onFetchingChange.emit), r = _e(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ve(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ge(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = fe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Se = () => {
	let e = {
		...
		init(t) {
			let n = xe(V(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, Ce = 0, U = 1, we = 2, Te = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Ce ? r = "Empty parameter" : e === U ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function W(e) {
	return /\s/.test(e);
}
var G = 0, K = 1, q = 2, J = 3, Y = 4, Ee = new Set([
	q,
	K,
	G
]), X = "'", De = new Set([
...
function ke(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case G:
			...
			break;
		case K:
			De.has(i) ? (n = n.slice(0, -1) + i, t = q) : (n += i, t = G);
			break;
		case q:
			i === X ? t = G : (n += i, t = q);
			break;
...
var Me = () => (e, t) => (t.setFinalFormatter(je()), e), Ne = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Pe = {};
(function(e) {
	function t(e, t) {
		var n;
...
(w = console.assert) == null || w.call(console, Fe), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ie(e, t) {
	let n = (n) => {
...
function Le({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var ze = "tolgee-in-context-tools.umd.min.js", Be = "@tolgee/in-context-tools", Ve = "InContextTools", He = "https://cdn.jsdelivr.net/npm";
function Ue(e) {
...
var We = null;
function Ge(e) {
	return We ||= Ue(`${He}/@tolgee/web@${e}/dist/${ze}`).then(() => window[Be][Ve]), We;
}
var Ke = "__tolgee_apiKey", qe = "__tolgee_apiUrl", Z = "__tolgee_branch";
function Je() {
	let e = sessionStorage.getItem(Ke) || void 0, t = sessionStorage.getItem(qe) || void 0, n = sessionStorage.getItem(Z) || void 0;
	if (!(!e || !t)) return ee({
		apiKey: e,
		apiUrl: t
	}, n === void 0 ? {} : { branch: n });
...
function Ye() {
	sessionStorage.removeItem(Ke), sessionStorage.removeItem(qe), sessionStorage.removeItem(Z);
}
function Xe(e) {
...
var tt = { useSuspense: !1 }, nt, rt = () => (nt ||= e.createContext(void 0), nt), Q = void 0, it = ({ tolgee: n, options: r, children: a, fallback: o, ssr: c }) => {
	i(() => {
	...
	l = et(n, u, d, !!c);
	let [f, p] = s(!l.isLoaded()), m = Object.assign(Object.assign({}, tt), r), h = rt();
...
var st = () => {
	...
	let { tolgee: r, options: a } = st(), s = k(e), c = A(s).join(":"), l = Object.assign(Object.assign({}, a), t), { rerender: u, instance: d } = ct(), f = o([]);
	f.current = [];
	let p = r.isLoaded(s);
	i(() => {
		let e = r.on("update", u);
...
var $ = (t) => {
	let n = dt(t);
	return Array.isArray(n) ? n.map((t, n) => e.createElement(e.Fragment, { key: n }, pt(t))) : pt(n);
}, mt = (t) => {
	...
	let { t: n } = lt();
	return e.createElement(mt, Object.assign({ t: n }, t));
};
function gt() {
	let { t: e, ...t } = ut();
	return {
