...
function Se({ options: e }) {
	let t = ue(), n = B(!1, () => o.isFetching(), t.onFetchingChange.emit), r = B(!1, () => S.isLoading(), t.onLoadingChange.emit), i = be(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ye(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = me(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
function je(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		...
		case K:
			...
			break;
		case q:
			i === "}" ? (d(), t = W) : De(i) ? r !== "" && (d(), t = J) : (u(), t = q);
			break;
		case J: i == "}" ? t = W : De(i) ? t = J : c(U);
	}
