...
function an() {
	...
	return u("section", {
		...
		children: [l("h2", {
			...
			children: l($, { keyName: "preferencesSection.preferences" })
		}), u("div", {
			className: "space-y-4",
			children: [
				u("div", {
					...
					children: [u("div", { children: [l("p", {
						...
						children: l($, { keyName: "preferencesSection.emailNotifications" })
					}), l("p", {
						className: "text-xs text-muted-foreground",
						children: l($, { keyName: "preferencesSection.receiveWeeklyBenchmark" })
					})] }), l("button", {
						type: "button",
				...
				u("div", {
					...
					children: [u("div", { children: [l("p", {
						className: "text-sm font-medium text-foreground",
						children: l($, { keyName: "preferencesSection.darkMode" })
					}), l("p", {
						className: "text-xs text-muted-foreground",
						children: l($, { keyName: "preferencesSection.useDarkColorScheme" })
					})] }), l("button", {
						type: "button",
				...
				u("div", { children: [l("label", {
					...
					children: l($, { keyName: "preferencesSection.defaultLanguage" })
				}), u("select", {
					id: t,
					className: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
					children: [
						l("option", { children: e("preferencesSection.englishEn") }),
						l("option", { children: e("preferencesSection.frenchFr") }),
						l("option", { children: e("preferencesSection.germanDe") }),
						l("option", { children: e("preferencesSection.spanishEs") }),
						l("option", { children: e("preferencesSection.japaneseJa") }),
						l("option", { children: e("preferencesSection.chineseSimplifiedZhCn") }),
						l("option", { children: e("preferencesSection.arabicAr") })
					]
				})] })
			]
		})]
