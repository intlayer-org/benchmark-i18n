...
var z = 0, B = 1, V = 2, H = 3, U = 4, De = /* @__PURE__ */ new Set([
	V,
	B,
	z
]), W = "'", Oe = /* @__PURE__ */ new Set([
	"{",
	"}",
	W
...
function Ae(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case z:
			...
			break;
		case B:
			Oe.has(i) ? (n = n.slice(0, -1) + i, t = V) : (n += i, t = z);
			break;
		case V:
			i === W ? t = z : (n += i, t = V);
			break;
		case H:
			i === "}" ? (d(), t = z) : Ee(i) ? r !== "" && (d(), t = U) : (u(), t = H);
			break;
		case U: i == "}" ? t = z : Ee(i) ? t = U : c(R);
	}
