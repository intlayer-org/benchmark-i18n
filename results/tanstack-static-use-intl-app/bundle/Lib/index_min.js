...
import c from "../src/messages/de.ts";
import l from "../src/messages/en.ts";
import u from "../src/messages/es.ts";
import d from "../src/messages/fr.ts";
import f from "../src/messages/it.ts";
import p from "../src/messages/ja.ts";
import m from "../src/messages/ko.ts";
import h from "../src/messages/pt.ts";
import ee from "../src/messages/ru.ts";
import g from "../src/messages/zh.ts";
function _(e, t) {
...
var C = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, w = /^(@+)?(\+|#+)?[rs]?$/g, ve = /(\*)(0+)|(#+)(0+)|(0+)/g, T = /^(0+)$/;
function E(e) {
	let t = {};
...
function U(e) {
	e.forEach((e) => {
		...
		else N(e) && Ce(e.style) || (P(e) || F(e)) && z(e.style) ? delete e.style.location : R(e) && U(e.children);
	});
}
function Ve(e, t = {}) {
	t = {
...
function $e(e) {
	...
	return function({ cache: e, formats: n, formatters: i, getMessageFallback: a = Ze, locale: o, messagesOrError: s, namespace: c, onError: l, timeZone: u }) {
		...
		function p(p, m, h, ee) {
			...
			try {
				return Xe(X(c, p), _, m && function(e) {
					let n = {};
...
function rt({ children: e, formats: t, getMessageFallback: n, locale: r, messages: i, now: c, onError: l, timeZone: u }) {
	let d = a(Q), f = o((() => d?.cache || ue()), [r, d?.cache]), p = o((() => d?.formatters || fe(f)), [f, d?.formatters]), m = o((() => ({
		...nt({
			locale: r,
