...
var $ = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/use-intl-app/src/components/pages/pricing/PricingTiers.tsx";
function lt() {
	let e = ct("pricing-tiers"), t = [
		{
			name: e("starter"),
			price: e("price0"),
			period: e("forever"),
		...
		children: t.map((t) => c("div", {
			...
			children: [
				...
				c("ul", {
					...
					children: t.features.map((e) => c("li", {
...
var ht = "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/tanstack-start-react-static/use-intl-app/src/components/pages/pricing/PricingTiers.wrapper.tsx";
function gt() {
