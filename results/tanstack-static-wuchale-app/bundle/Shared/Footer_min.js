...
import { Link as n, useParams as r } from "@tanstack/react-router";
...
function l(e = { c: [] }, t) {
	let n = e.c, r = (e) => {
		let t = n[e];
		return typeof t == "string" ? [t] : Array.isArray(t) ? t : [s(e, n)];
	}, i = (e, t = []) => c(r(e), t, 0);
	return i._ = e, i.l = t, i.c = r, i.x = c, i.t = (e, t, n) => {
		let i = r(t), a = [""], o = [];
		for (let e of i) {
			if (typeof e == "string") {
				a[a.length - 1] += e;
...
function p(e, t, n, r) {
	...
	for (let t of n) d[e].collection.set(t, f);
	return (t) => d[e].collection.get(t);
}
function m(e) {
	for (let t of Object.values(d)) for (let [n, r] of Object.entries(t.catalogs)) t.collection.set(n, l(r, e));
}
async function h(e, t = !0) {
	let n = [], r = [];
	for (let t of Object.values(d)) for (let i of Object.keys(t.catalogs)) n.push(t.load(i, e)), r.push([i, t]);
...
} }, _ = (e, t) => g[e][t](), v = ["main"], y = "main", b = {}, x = {}, S = (e) => x[e];
p(y, _, v, {
	get: S,
	set: (e, t) => {
		x[e] = t, b[e]?.forEach((e) => {
...
var C = (n) => {
	...
	return e(() => {
		let e = (e) => i(() => e);
		return b[n] ??= /* @__PURE__ */ new Set(), b[n].add(e), () => b[n].delete(e);
	}, [n]), r;
};
function w() {
	let e = r({ strict: !1 }).locale ?? "en", t = C("main"), i = [
		{
			label: t(0),
			...
			children: [o("div", {
				...
				children: [
					...
					o("div", { children: [a("h3", {
						...
						className: "space-y-1",
						children: i.map((t) => a("li", { children: t.isInternal ? a(n, {
							preload: !1,
							to: t.to,
							params: { locale: e },
...
function T({ children: e }) {
	return a(i, { children: e });
}
function E() {
	return a(T, { children: a(w, {}) });
}
export { E as default };
var e = [
	"GitHub",
