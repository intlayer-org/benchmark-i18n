...
function c(e = { c: [] }, t) {
	let n = e.c, r = (e) => {
		let t = n[e];
		return typeof t == "string" ? [t] : Array.isArray(t) ? t : [o(e, n)];
	}, i = (e, t = []) => s(r(e), t, 0);
	return i._ = e, i.l = t, i.c = r, i.x = s, i.t = (e, t, n) => {
		let i = r(t), a = [""], o = [];
		for (let e of i) {
			if (typeof e == "string") {
				a[a.length - 1] += e;
...
function f(e, t, n, r) {
	...
	for (let t of n) u[e].collection.set(t, d);
	return (t) => u[e].collection.get(t);
}
function p(e) {
	for (let t of Object.values(u)) for (let [n, r] of Object.entries(t.catalogs)) t.collection.set(n, c(r, e));
}
async function m(e, t = !0) {
	let n = [], r = [];
	for (let t of Object.values(u)) for (let i of Object.keys(t.catalogs)) n.push(t.load(i, e)), r.push([i, t]);
...
var h = { main: {
	en: () => import("./main.main.en.compiled-DJtJ5Agx.js"),
	es: () => import("./main.main.es.compiled-B4QCbWMm.js"),
	fr: () => import("./main.main.fr.compiled-DX3omuIt.js"),
	de: () => import("./main.main.de.compiled-Bbh5K93t.js"),
	it: () => import("./main.main.it.compiled-Dk7Tf94Q.js"),
	pt: () => import("./main.main.pt.compiled-hg6rTPYY.js"),
	zh: () => import("./main.main.zh.compiled-flxtz9OC.js"),
	ja: () => import("./main.main.ja.compiled-CYF16K2O.js"),
	ko: () => import("./main.main.ko.compiled-vo2I2Cv4.js"),
	ru: () => import("./main.main.ru.compiled-CAkBlk-Z.js")
} }, g = (e, t) => h[e][t](), _ = ["main"], v = "main", y = {}, b = {}, x = (e) => b[e];
f(v, g, _, {
	get: x,
	set: (e, t) => {
		b[e] = t, y[e]?.forEach((e) => {
...
var S = (t) => {
	...
	return e(() => {
		let e = (e) => i(() => e);
		return y[t] ??= /* @__PURE__ */ new Set(), y[t].add(e), () => y[t].delete(e);
	}, [t]), r;
};
function C() {
	let e = t(), n = t(), r = t(), o = t(), s = S("main");
	return a("form", {
		className: "space-y-6",
		children: [
			a("div", {
			...
			a("div", { children: [i("label", {
				...
				children: [
					i("option", { children: s(75) }),
					i("option", { children: s(76) }),
					i("option", { children: s(77) }),
					i("option", { children: s(78) }),
					i("option", { children: s(79) })
				]
			})] }),
			a("div", { children: [i("label", {
				htmlFor: o,
...
function w({ children: e }) {
	return i(r, { children: e });
}
function T() {
	return i(w, { children: i(C, {}) });
}
export { T as default };
var e = [
	"GitHub",
