...
function ProductsGrid() {
	...
	const products = [
		{
			name: _w_runtime_(194),
			desc: _w_runtime_(195),
			price: _w_runtime_(196)
		},
		{
			name: _w_runtime_(197),
			desc: _w_runtime_(198),
			price: "$29/mo"
		},
		{
			name: _w_runtime_(199),
			desc: _w_runtime_(200),
			price: _w_runtime_(201)
		},
		{
			name: _w_runtime_(202),
			desc: _w_runtime_(203),
			price: "$99 one-time"
		},
		{
			name: _w_runtime_(204),
			desc: _w_runtime_(205),
			price: "$19/mo"
		},
		{
			name: _w_runtime_(206),
			desc: _w_runtime_(207),
			price: "$49/mo"
		}
	];
	return jsx("div", {
