...
var i = t("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">Frequently Asked Questions"), a = t("<p class=\"mb-10 text-muted-foreground\">Everything you need to know about i18n Benchmark.");
function o() {
	return [
		e(r, {}),
		i(),
