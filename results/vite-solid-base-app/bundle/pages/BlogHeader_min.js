...
var i = t("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">Blog"), a = t("<p class=\"mb-10 text-muted-foreground\">Insights, tutorials, and analysis from the i18n community.");
function o() {
	return [
		e(r, {}),
		i(),
