...
var _tmpl$ = template(`<h1 class="mb-2 text-3xl font-bold text-foreground">Frequently Asked Questions`);
var _tmpl$2 = template(`<p class="mb-10 text-muted-foreground">Everything you need to know about i18n Benchmark.`);
function FAQHeader() {
	return [
