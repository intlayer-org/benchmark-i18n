...
var i = t("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">Products"), a = t("<p class=\"mb-10 text-muted-foreground\">Tools and services to streamline your internationalization workflow.");
function o() {
	return [
		e(r, {}),
		i(),
