...
var _tmpl$ = template(`<section><h2 class="mb-6 text-2xl font-bold text-foreground">Sample Results</h2><div class="overflow-x-auto rounded-lg border border-border"><table class="w-full text-sm"><thead class=bg-muted><tr><th class="px-4 py-3 text-left font-medium text-muted-foreground">Library</th><th class="px-4 py-3 text-left font-medium text-muted-foreground">Bundle Size</th><th class="px-4 py-3 text-left font-medium text-muted-foreground">Lookup Time</th><th class="px-4 py-3 text-left font-medium text-muted-foreground">Lazy Loading</th></tr></thead><tbody>`);
