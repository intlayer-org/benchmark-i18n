...
var _tmpl$ = template(`<h1 class="mb-2 text-3xl font-bold text-foreground">Our Team`), _tmpl$2 = template(`<p class="mb-10 text-muted-foreground">Meet the people behind i18n Benchmark. A diverse team united by a shared passion for great developer tools.`);
function TeamHeader() {
	return [
