...
function PreferencesSection() {
	...
	return (() => {
		var _el$ = _tmpl$(), _el$7 = _el$.firstChild.nextSibling.firstChild.nextSibling.nextSibling.firstChild, _el$8 = _el$7.nextSibling;
		setAttribute(_el$7, "for", languageId);
		setAttribute(_el$8, "id", languageId);
		return _el$;
	})();
}
