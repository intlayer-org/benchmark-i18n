...
var _tmpl$ = template(`<h1 class="mb-2 text-3xl font-bold text-foreground">Settings`), _tmpl$2 = template(`<p class="mb-8 text-muted-foreground">Manage your account preferences and configuration.`);
