...
var h = (e) => typeof e == "string", g = () => {
	...
	t ||= "", n ||= "";
	let r = j.filter((e) => !t.includes(e) && !n.includes(e));
...
function z(e, t) {
	let { [R]: n } = e(ie()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var B = (e) => !h(e) && typeof e != "boolean" && typeof e != "number", V = class e extends F {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? A : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? O(i) : a || "{{", this.suffix = o ? O(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u ? O(u) : "-", this.unescapeSuffix = this.unescapePrefix ? "" : l ? O(l) : "", this.nestingPrefix = d ? O(d) : f || O("$t("), this.nestingSuffix = p ? O(p) : m || O(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	constructor(e = {}, t) {
		if (super(), this.options = X(e), this.services = {}, this.logger = P, this.modules = { external: [] }, de(this), t && !this.isInitialized && !e.isClone) {
...
function ge() {
	...
	return (() => {
		var n = he(), i = n.firstChild.firstChild, o = i.firstChild, s = o.firstChild, c = s.nextSibling, l = o.nextSibling, u = l.firstChild, d = u.nextSibling.firstChild, f = d.firstChild, p = d.nextSibling, m = p.nextSibling, h = l.nextSibling.firstChild, g = h.nextSibling, _ = i.nextSibling;
		return t(s, () => $()("footer.title")), t(c, () => $()("footer.description")), t(u, () => $()("footer.resources")), t(f, () => $()("footer.github")), t(p, e(r, {
			get href() {
				return `/${a()}/about`;
			},
