...
import { A as i, useParams as a } from "@solidjs/router";
import { createSignal as o } from "solid-js";
var s = (e) => typeof e == "string", c = () => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (Object.prototype.hasOwnProperty.call(e, r) ? s(e[r]) || e[r] instanceof String || s(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : y(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, b = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), x = {
	"&": "&amp;",
	"<": "&lt;",
	...
	forward(e, t, n, r) {
		return r && !this.debug ? null : (e = e.map((e) => s(e) ? e.replace(/[\r\n\x00-\x1F\x7F]/g, " ") : e), s(e[0]) && (e[0] = `${n}${this.prefix} ${e[0]}`), this.logger[t](e));
	}
	create(t) {
...
var L = (e) => !s(e) && typeof e != "boolean" && typeof e != "number", R = class e extends j {
	constructor(e, t = {}) {
		super(), u([
			"resourceStore",
			"languageUtils",
	...
	translate(t, n, r) {
		...
		if (b && D && O && !v.includes(k) && !(s(y) && Array.isArray(D))) {
			...
			if (n || e || s) {
				if (this.logger.log(s ? "updateKey" : "missingKey", f, u, x && !s ? `${c}${this.pluralResolver.getSuffix(f, i.count, i)}` : c, s ? E : h), o) {
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return s(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? I(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	toResolveHierarchy(e, t) {
		...
		let i = t === void 0 || t === !1 || s(t), a = t === void 0 && typeof this.options.fallbackLng == "function", o = s(e) && i && !a, c = null;
		if (o) {
			let n;
		...
		return s(e) && (e.includes("-") || e.includes("_")) ? (this.options.load !== "languageOnly" && d(this.formatLanguageCode(e)), this.options.load !== "languageOnly" && this.options.load !== "currentOnly" && d(this.getScriptPartFromCode(e)), this.options.load !== "currentOnly" && d(this.getLanguagePartFromCode(e))) : s(e) && d(this.formatLanguageCode(e)), l.forEach((e) => {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? S : t, this.escapeValue = n === void 0 || n, this.useRawValueToEscape = r !== void 0 && r, this.prefix = i ? b(i) : a || "{{", this.suffix = o ? b(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u ? b(u) : "-", this.unescapeSuffix = this.unescapePrefix ? "" : l ? b(l) : "", this.nestingPrefix = d ? b(d) : f || b("$t("), this.nestingSuffix = p ? b(p) : m || b(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ !== void 0 && _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		let i, a, o, c = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, u = (e) => {
			if (!e.includes(this.formatSeparator)) {
				let i = U(t, c, e, this.options.keySeparator, this.options.ignoreJSONStructure);
			...
			return this.format(U(t, c, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
				...r,
				...t,
				interpolationkey: a
			});
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				let c = t.safeValue(a);
				if (e = e.replace(i[0], W(c)), f ? (t.regex.lastIndex += c.length, t.regex.lastIndex -= i[0].length) : t.regex.lastIndex = 0, o++, o >= this.maxReplaces) break;
			}
		}), e;
	}
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			}), i.trim())), e = e.replace(r[0], W(l(i))), this.regexp.lastIndex = 0;
		}
		return e;
	}
}, K = (e) => {
	...
	format(e, t, n, r = {}) {
		...
		return a.reduce((e, t) => {
			let { formatName: i, formatOptions: a } = K(t);
			if (this.formats[i]) {
				let t = e;
				try {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			g(n.loaded, [i], a), ne(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), X = (e) => (s(e.ns) && (e.ns = [e.ns]), s(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), s(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), Z = () => {}, re = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Q = class e extends j {
	constructor(e = {}, t) {
		if (super(), this.options = X(e), this.services = {}, this.logger = A, this.modules = { external: [] }, re(this), t && !this.isInitialized && !e.isClone) {
	...
	getFixedT(e, t, n, r) {
		...
		return s(e) ? a.lng = e : a.lngs = e, a.ns = t, a.keyPrefix = n, a;
	}
	t(...e) {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new z(Y());
...
var ge = r("<footer class=\"mt-20 border-t border-border bg-card\"><div class=\"container py-8\"><div class=\"grid gap-8 md:grid-cols-3\"><div><h3 class=\"mb-2 text-sm font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p></div><div><h3 class=\"mb-2 text-sm font-semibold text-foreground\"></h3><ul class=space-y-1><li><a href=https://github.com/intlayer-org/benchmark-i18n target=_blank rel=noreferrer class=\"text-sm text-muted-foreground transition-colors hover:text-foreground\"></a></li><li></li><li></li></ul></div><div><h3 class=\"mb-2 text-sm font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p></div></div><div class=\"mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground\">");
function _e() {
	let n = a(), r = () => n.locale ?? "en";
	return (() => {
		var n = ge(), a = n.firstChild.firstChild, o = a.firstChild, s = o.firstChild, c = s.nextSibling, l = o.nextSibling, u = l.firstChild, d = u.nextSibling.firstChild, f = d.firstChild, p = d.nextSibling, m = p.nextSibling, h = l.nextSibling.firstChild, g = h.nextSibling, _ = a.nextSibling;
		return t(s, () => $()("footer.title")), t(c, () => $()("footer.description")), t(u, () => $()("footer.resources")), t(f, () => $()("footer.github")), t(p, e(i, {
			get href() {
				return `/${r()}/about`;
			},
			class: "text-sm text-muted-foreground transition-colors hover:text-foreground",
			get children() {
				return $()("footer.methodology");
			}
		})), t(m, e(i, {
			get href() {
				return `/${r()}/contact`;
			...
			class: "text-sm text-muted-foreground transition-colors hover:text-foreground",
			get children() {
				return $()("footer.contributing");
			}
		})), t(h, () => $()("footer.contact")), t(g, () => $()("shared.contactEmail")), t(_, () => $()("footer.builtWith")), n;
	})();
}
function ve(e) {
	return n(() => e.children);
