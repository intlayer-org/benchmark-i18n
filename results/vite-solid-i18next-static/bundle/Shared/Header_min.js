...
import h from "../../locales/fr.json";
import g from "../../locales/es.json";
import _ from "../../locales/de.json";
import v from "../../locales/it.json";
import y from "../../locales/pt.json";
import b from "../../locales/zh.json";
import x from "../../locales/ja.json";
import S from "../../locales/ko.json";
import C from "../../locales/ru.json";
function w(e) {
...
var T = (e) => typeof e == "string", E = () => {
...
}, k = /###/g, A = (e) => e && e.includes("###") ? e.replace(k, ".") : e, j = (e) => !e || T(e), M = (e, t, n) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? T(e[r]) || e[r] instanceof String || T(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : ne(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, F = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), re = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, ie = (e) => T(e) ? e.replace(/[&<>"'\/]/g, (e) => re[e]) : e, ae = class {
	constructor(e) {
	...
	getResource(e, t, n, r = {}) {
		...
		let s = P(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !T(n) ? s : I(this.data?.[e]?.[t], n, i);
	}
	addResource(e, t, n, r, i = { silent: !1 }) {
		let a = i.keySeparator === void 0 ? this.options.keySeparator : i.keySeparator, o = [e, t];
		n && (o = o.concat(a ? n.split(a) : n)), e.includes(".") && (o = e.split("."), r = t, t = o[1]), this.addNamespaces(t), N(this.data, o, r), i.silent || this.emit("added", e, t, n, r);
	}
	...
	addResourceBundle(e, t, n, r, i, a = {
		...
		a.skipCopy || (n = JSON.parse(JSON.stringify(n))), r ? ne(s, n, i) : s = {
			...s,
			...n
		}, N(this.data, o, s), a.silent || this.emit("added", e, t, n);
	}
...
function U(e, t) {
	let { [H]: n } = e(ue()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var W = (e) => !T(e) && typeof e != "boolean" && typeof e != "number", G = class e extends z {
	constructor(e, t = {}) {
		super(), O([
			"resourceStore",
			"languageUtils",
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return T(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? U(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	toResolveHierarchy(e, t) {
		...
		return T(e) && (e.includes("-") || e.includes("_")) ? (this.options.load !== "languageOnly" && i(this.formatLanguageCode(e)), this.options.load !== "languageOnly" && this.options.load !== "currentOnly" && i(this.getScriptPartFromCode(e)), this.options.load !== "currentOnly" && i(this.getLanguagePartFromCode(e))) : T(e) && i(this.formatLanguageCode(e)), n.forEach((e) => {
	...
	getSuffixes(e, t = {}) {
		let n = this.getRule(e, t);
		return n ||= this.getRule("dev", t), n ? n.resolvedOptions().pluralCategories.sort((e, t) => de[e] - de[t]).map((e) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${e}`) : [];
	}
	getSuffix(e, t, n = {}) {
	...
	let a = te(e, t, n);
	return !a && i && T(n) && (a = I(e, n, r), a === void 0 && (a = I(t, n, r))), a;
}, q = (e) => e.replace(/\$/g, "$$$$"), he = class {
	constructor(e = {}) {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? ie : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? F(i) : a || "{{", this.suffix = o ? F(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u ? F(u) : "-", this.unescapeSuffix = this.unescapePrefix ? "" : l ? F(l) : "", this.nestingPrefix = d ? F(d) : f || F("$t("), this.nestingSuffix = p ? F(p) : m || F(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	interpolate(e, t, n, r) {
		let i, a, o, s = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (e) => {
			if (!e.includes(this.formatSeparator)) {
				let i = me(t, s, e, this.options.keySeparator, this.options.ignoreJSONStructure);
			...
			return this.format(me(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
				...r,
				...t,
				interpolationkey: a
			});
		...
		return [{
			...
			regex: this.regexp,
			safeValue: (e) => this.escapeValue ? q(this.escape(e)) : q(e)
		}].forEach((t) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			ee(n.loaded, [i], a), be(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), Se = (e) => (T(e.ns) && (e.ns = [e.ns]), T(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), T(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), Y = () => {}, Ce = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, X = class e extends z {
	constructor(e = {}, t) {
		if (super(), this.options = Se(e), this.services = {}, this.logger = R, this.modules = { external: [] }, Ce(this), t && !this.isInitialized && !e.isClone) {
	...
	getFixedT(e, t, n) {
		...
		return T(e) ? r.lng = e : r.lngs = e, r.ns = t, r.keyPrefix = n, r;
	}
	t(...e) {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new K(J());
	...
	cloneInstance(t = {}, n = Y) {
		...
		return a.translator = new G(a.services, i), a.translator.on("*", (e, ...t) => {
			a.emit(e, ...t);
...
var Me = o("<button type=button class=\"rounded-md border border-border bg-accent px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-accent/80\">");
function Ne() {
...
function Pe() {
	...
	let o = () => e() === "auto" ? Q("themeToggle.labelAuto") : Q("themeToggle.labelOther", { mode: e() }), s = () => e() === "auto" ? Q("themeToggle.auto") : e() === "dark" ? Q("themeToggle.dark") : Q("themeToggle.light");
	return (() => {
		var e = Me();
...
function ze() {
	...
	let [t, n] = p(!1), a = u(), o = () => a.locale ?? "en", c = () => [
		{
			to: `/${o()}/products`,
			label: Z()("header.products")
		},
		{
			to: `/${o()}/pricing`,
			label: Z()("header.pricing")
		},
		{
			to: `/${o()}/team`,
			label: Z()("header.team")
		...
		{
			to: `/${o()}/contact`,
			label: Z()("header.contact")
		},
		{
			to: `/${o()}/settings`,
			label: Z()("header.settings")
		}
	];
	return (() => {
		var a = Ie(), l = a.firstChild.firstChild, u = l.firstChild, f = u.firstChild, p = f.firstChild, m = l.nextSibling, h = m.firstChild.firstChild;
		return r(l, e(s, {
			get href() {
				return `/${o()}`;
			},
			...
			inactiveClass: "",
			get children() {
				return Z()("header.methodology");
			}
		}), f), p.$$click = () => n(!t()), p.addEventListener("mouseleave", () => n(!1)), p.addEventListener("mouseenter", () => n(!0)), r(p, () => Z()("header.mockPages"), null), r(p, e(Re, { get class() {
			return `transition-transform ${t() ? "rotate-180" : ""}`;
		} }), null), r(f, (() => {
			var a = i(() => !!t());
			return () => a() && (() => {
				var t = Le(), i = t.firstChild;
		...
		})(), null), r(h, () => Z()("shared.goToGithub")), r(m, e(je, {}), null), r(m, e(Pe, {}), null), a;
	})();
}
t(["click"]);
