...
function Footer() {
	...
	return (() => {
		...
		insert(_el$5, () => t()("footer.title"));
		insert(_el$6, () => t()("footer.description"));
		insert(_el$8, () => t()("footer.resources"));
		insert(_el$1, () => t()("footer.github"));
		...
		insert(_el$11, createComponent(A, {
			...
			"class": "text-sm text-muted-foreground transition-colors hover:text-foreground",
			get children() {
				return t()("footer.contributing");
			}
		}));
		insert(_el$13, () => t()("footer.contact"));
		insert(_el$14, () => t()("shared.contactEmail"));
		insert(_el$15, () => t()("footer.builtWith"));
		return _el$;
	})();
}
...
function ThemeToggle() {
	...
	const label = () => mode() === "auto" ? trans("themeToggle.labelAuto") : trans("themeToggle.labelOther", { mode: mode() });
	const buttonText = () => mode() === "auto" ? trans("themeToggle.auto") : mode() === "dark" ? trans("themeToggle.dark") : trans("themeToggle.light");
	return (() => {
		var _el$ = _tmpl$$1();
...
function Header() {
	...
	return (() => {
		...
		insert(_el$7, () => t()("header.mockPages"), null);
		...
		insert(_el$0, () => t()("shared.goToGithub"));
...
function Layout(props) {
	...
	createEffect(() => {
		...
		instance.changeLanguage(loc).then(() => {
			setT(() => instance.t.bind(instance));
		});
	});
	return [
