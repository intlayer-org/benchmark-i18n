...
function I(e, t) {
	let { [F]: n } = e(le()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":", a = t?.enableSelector === "strict";
	if (n.length > 1 && i) {
...
var L = (e) => !_(e) && typeof e != "boolean" && typeof e != "number", R = class e extends P {
	...
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			}), i.trim())), e = e.replace(r[0], U(y(i))), this.regexp.lastIndex = 0;
		}
		return e;
	}
}, de = (e) => {
	...
	init(e, t = { interpolation: {} }) {
		...
		let n = t.cacheInBuiltFormats ? G : fe;
		this.formats = {
			number: n((e, t) => {
...
}), q = (e) => (_(e.ns) && (e.ns = [e.ns]), _(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), _(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), J = () => {}, ge = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Y = class e extends P {
	constructor(e = {}, t) {
		if (super(), this.options = q(e), this.services = {}, this.logger = N, this.modules = { external: [] }, ge(this), t && !this.isInitialized && !e.isClone) {
