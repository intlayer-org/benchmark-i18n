...
import { recordHydrationDuration as w, recordRenderTime as T } from "test-utils/browser-metrics";
var E = (e) => typeof e == "string", D = () => {
	let e, t, n = new Promise((n, r) => {
		e = n, t = r;
	});
	return n.resolve = e, n.reject = t, n;
}, O = (e) => e == null ? "" : String(e), ee = (e, t, n) => {
	e.forEach((e) => {
		t[e] && (n[e] = t[e]);
	});
}, te = /###/g, k = (e) => e && e.includes("###") ? e.replace(te, ".") : e, A = (e) => !e || E(e), j = (e, t, n) => {
	...
	for (let r in t) r !== "__proto__" && r !== "constructor" && (r in e ? E(e[r]) || e[r] instanceof String || E(t[r]) || t[r] instanceof String ? n && (e[r] = t[r]) : ie(e[r], t[r], n) : e[r] = t[r]);
	return e;
}, P = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), ae = {
	"&": "&amp;",
	"<": "&lt;",
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, oe = (e) => E(e) ? e.replace(/[&<>"'\/]/g, (e) => ae[e]) : e, se = class {
	constructor(e) {
	...
	forward(e, t, n, r) {
		return r && !this.debug ? null : (e = e.map((e) => E(e) ? e.replace(/[\r\n\x00-\x1F\x7F]/g, " ") : e), E(e[0]) && (e[0] = `${n}${this.prefix} ${e[0]}`), this.logger[t](e));
	}
	create(t) {
	...
	getResource(e, t, n, r = {}) {
		...
		let s = N(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !E(n) ? s : F(this.data?.[e]?.[t], n, i);
	}
...
function H(e, t) {
	let { [V]: n } = e(fe()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var U = (e) => !E(e) && typeof e != "boolean" && typeof e != "number", W = class e extends R {
	constructor(e, t = {}) {
		super(), ee([
			"resourceStore",
			"languageUtils",
	...
	translate(t, n, r) {
		...
		y && !m && x && (D = T);
		let O = U(D), ee = Object.prototype.toString.apply(D);
		if (y && D && O && !_.includes(ee) && !(E(v) && Array.isArray(D))) {
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return E(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? H(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	let a = re(e, t, n);
	return !a && i && E(n) && (a = F(e, n, r), a === void 0 && (a = F(t, n, r))), a;
}, K = (e) => e.replace(/\$/g, "$$$$"), _e = class {
	constructor(e = {}) {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? oe : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? P(i) : a || "{{", this.suffix = o ? P(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u ? P(u) : "-", this.unescapeSuffix = this.unescapePrefix ? "" : l ? P(l) : "", this.nestingPrefix = d ? P(d) : f || P("$t("), this.nestingSuffix = p ? P(p) : m || P(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			ne(n.loaded, [i], a), Se(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), we = (e) => (E(e.ns) && (e.ns = [e.ns]), E(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), E(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), J = () => {}, Te = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Y = class e extends R {
	constructor(e = {}, t) {
		if (super(), this.options = we(e), this.services = {}, this.logger = L, this.modules = { external: [] }, Te(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		...
		if (!this.options.isClone) {
			...
			let e;
			e = this.modules.formatter ? this.modules.formatter : xe;
			let t = new G(this.options);
			this.store = new z(this.options.resources, this.options);
			let n = this.services;
			n.logger = L, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new he(t, { prepend: this.options.pluralSeparator }), e && (n.formatter = r(e), n.formatter.init && n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new _e(this.options), n.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }, n.backendConnector = new Ce(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (e, ...t) => {
				this.emit(e, ...t);
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new G(q());
	...
	cloneInstance(t = {}, n = J) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a.services.interpolator = new _e(n);
		}
...
function ke() {
	...
	return (() => {
		...
		return r(o, () => X()("footer.title")), r(c, () => X()("footer.description")), r(u, () => X()("footer.resources")), r(f, () => X()("footer.github")), r(p, e(s, {
			...
			class: "text-sm text-muted-foreground transition-colors hover:text-foreground",
			get children() {
				return X()("footer.contributing");
			}
		})), r(h, () => X()("footer.contact")), r(g, () => X()("shared.contactEmail")), r(_, () => X()("footer.builtWith")), t;
	})();
}
function Ae(e) {
...
}, Ne = o("<div class=\"flex items-center gap-2\"><select class=\"h-8 rounded-md border border-border bg-card px-2 text-xs font-medium transition-colors focus:outline-none focus:ring-1 focus:ring-primary\">"), Pe = o("<option>");
function Fe() {
	let t = u(), i = l(), a = c(), o = (e) => {
		i(`${a.pathname.replace(/^\/[^/]+/, `/${e}`)}${a.search}${a.hash}`);
	};
	return (() => {
		var i = Ne(), a = i.firstChild;
		return a.addEventListener("change", (e) => o(e.currentTarget.value)), r(a, e(d, {
			each: je,
			children: (e) => (() => {
				var t = Pe();
				return t.value = e, r(t, () => Me(e)), t;
			})()
		})), n(() => a.value = t.locale ?? "en"), i;
	})();
}
var Ie = o("<button type=button class=\"rounded-md border border-border bg-accent px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-accent/80\">");
function Le() {
...
t(["click"]);
var ze = o("<svg width=14 height=14 viewBox=\"0 0 24 24\"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round aria-hidden=true><path d=\"m6 9 6 6 6-6\">"), Be = o("<header class=\"sticky top-0 z-50 border-b border-border bg-card/80 backdrop-blur-lg\"><nav class=\"container flex h-16 items-center justify-between\"><div class=\"flex items-center gap-8\"><div class=\"hidden items-center gap-6 text-sm font-medium md:flex\"><div class=relative><button type=button class=\"flex cursor-pointer items-center gap-1 border-none bg-transparent nav-link\"></button></div></div></div><div class=\"flex items-center gap-4\"><a href=https://github.com/intlayer-org/benchmark-i18n target=_blank rel=noreferrer class=\"text-muted-foreground transition hover:text-foreground\"><span class=sr-only></span><svg viewBox=\"0 0 16 16\"aria-hidden=true width=20 height=20><path fill=currentColor d=\"M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z\">"), Ve = o("<div class=\"absolute left-0 top-full w-48 pt-2\"><div class=\"overflow-hidden rounded-md border border-border bg-card py-1 shadow-lg\">");
function He(e) {
	return (() => {
		var t = ze();
...
function Ue() {
	...
	let [t, n] = p(!1), a = u(), o = () => a.locale ?? "en", c = () => [
		{
			to: `/${o()}/products`,
			label: X()("header.products")
		},
		{
			to: `/${o()}/pricing`,
			label: X()("header.pricing")
		},
		{
			to: `/${o()}/team`,
			label: X()("header.team")
		...
		{
			to: `/${o()}/contact`,
			label: X()("header.contact")
		},
		{
			to: `/${o()}/settings`,
			label: X()("header.settings")
		}
	];
	return (() => {
		var a = Be(), l = a.firstChild.firstChild, u = l.firstChild, f = u.firstChild, p = f.firstChild, m = l.nextSibling, h = m.firstChild.firstChild;
		return r(l, e(s, {
			get href() {
				return `/${o()}`;
			},
			...
			inactiveClass: "",
			get children() {
				return X()("header.methodology");
			}
		}), f), p.$$click = () => n(!t()), p.addEventListener("mouseleave", () => n(!1)), p.addEventListener("mouseenter", () => n(!0)), r(p, () => X()("header.mockPages"), null), r(p, e(He, { get class() {
			return `transition-transform ${t() ? "rotate-180" : ""}`;
		} }), null), r(f, (() => {
			var a = i(() => !!t());
			return () => a() && (() => {
				var t = Ve(), i = t.firstChild;
		...
		})(), null), r(h, () => X()("shared.goToGithub")), r(m, e(Fe, {}), null), r(m, e(Re, {}), null), a;
	})();
}
t(["click"]);
function We(t) {
	...
	return m(() => {
		...
		let e = n.locale ?? "en";
		document.documentElement.lang = e, Y.changeLanguage(e).then(() => {
			Z(() => Y.t.bind(Y));
		});
	}), [
		e(Ue, {}),
