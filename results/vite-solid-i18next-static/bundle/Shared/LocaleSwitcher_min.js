import { createComponent as e, effect as t, insert as n, memo as r, template as i } from "solid-js/web";
import { useLocation as a, useNavigate as o, useParams as s } from "@solidjs/router";
import { For as c, createSignal as l } from "solid-js";
var u = [
	"en",
	"fr",
	"es",
...
}, f = i("<div class=\"flex items-center gap-2\"><select class=\"h-8 rounded-md border border-border bg-card px-2 text-xs font-medium transition-colors focus:outline-none focus:ring-1 focus:ring-primary\">"), p = i("<option>");
function m() {
	let r = s(), i = o(), l = a(), m = (e) => {
		let t = l.pathname.replace(/^\/[^/]+/, `/${e}`);
		i(`${t}${l.search}${l.hash}`);
	};
	return (() => {
		var i = f(), a = i.firstChild;
		return a.addEventListener("change", (e) => m(e.currentTarget.value)), n(a, e(c, {
			each: u,
			children: (e) => (() => {
				var t = p();
				return t.value = e, n(t, () => d(e)), t;
			})()
...
var h = (e) => typeof e == "string", g = () => {
	...
	"!",
	";"
], j = new ee(20), ne = (e, t, n) => {
	t ||= "", n ||= "";
	let r = te.filter((e) => !t.includes(e) && !n.includes(e));
	if (r.length === 0) return !0;
	let i = j.getRegExp(`(${r.map((e) => e === "?" ? "\\?" : e).join("|")})`), a = !i.test(e);
	if (!a) {
		let t = e.indexOf(n);
	...
	getResource(e, t, n, r = {}) {
		...
		let s = T(this.data, o);
		return !s && !t && !n && e.includes(".") && (e = o[0], t = o[1], n = o.slice(2).join(".")), s || !a || !h(n) ? s : M(this.data?.[e]?.[t], n, i);
	}
...
function z(e, t) {
	let { [R]: n } = e(ie()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":", a = t?.enableSelector === "strict";
	if (n.length > 1 && i) {
...
var B = (e) => !h(e) && typeof e != "boolean" && typeof e != "number", V = class e extends F {
	constructor(e, t = {}) {
		super(), v([
			"resourceStore",
			"languageUtils",
	...
	let a = E(e, t, n);
	return !a && i && h(n) && (a = M(e, n, r), a === void 0 && (a = M(t, n, r))), a;
	...
	interpolate(e, t, n, r) {
		...
		return [{
			...
			for (o = 0; i = t.regex.exec(e);) {
				...
				let s = t.safeValue(a);
				if (e = e.replace(i[0], K(s)), u ? (t.regex.lastIndex += s.length, t.regex.lastIndex -= i[0].length) : t.regex.lastIndex = 0, o++, o >= this.maxReplaces) break;
			}
		}), e;
	}
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			}), i.trim())), e = e.replace(r[0], K(_(i))), this.regexp.lastIndex = 0;
		}
		return e;
	}
}, oe = (e) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			w(n.loaded, [i], a), ce(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), Z = (e) => (h(e.ns) && (e.ns = [e.ns]), h(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), h(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), Q = () => {}, ue = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, $ = class e extends F {
	constructor(e = {}, t) {
		if (super(), this.options = Z(e), this.services = {}, this.logger = P, this.modules = { external: [] }, ue(this), t && !this.isInitialized && !e.isClone) {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new H(X());
