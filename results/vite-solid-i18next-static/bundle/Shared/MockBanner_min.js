...
var B = (e) => !f(e) && typeof e != "boolean" && typeof e != "number", V = class e extends P {
	...
	interpolate(e, t, n, r) {
		let i, a, o, s = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (e) => {
			if (!e.includes(this.formatSeparator)) {
				let i = K(t, s, e, this.options.keySeparator, this.options.ignoreJSONStructure);
			...
			return this.format(K(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
				...r,
				...t,
				interpolationkey: a
			});
	...
	init(e, t = { interpolation: {} }) {
		...
		let n = t.cacheInBuiltFormats ? Y : re;
		this.formats = {
			number: n((e, t) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			x(n.loaded, [i], a), ae(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), Z = (e) => (f(e.ns) && (e.ns = [e.ns]), f(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), f(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), Q = () => {}, se = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, $ = class e extends P {
	constructor(e = {}, t) {
		if (super(), this.options = Z(e), this.services = {}, this.logger = N, this.modules = { external: [] }, se(this), t && !this.isInitialized && !e.isClone) {
	...
	cloneInstance(t = {}, n = Q) {
		...
		if ((t.debug !== void 0 || t.prefix !== void 0) && (a.logger = a.logger.clone(t)), [
			...
			a.services.interpolator = new J(n);
		}
...
var fe = t("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\">");
function pe() {
	return (() => {
		var t = fe();
		return e(t, () => le()("mockBanner")), t;
	})();
}
