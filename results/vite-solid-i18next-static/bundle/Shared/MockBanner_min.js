...
var P = (e) => !a(e) && typeof e != "boolean" && typeof e != "number", F = class e extends k {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			m(n.loaded, [i], a), q(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), X = (e) => (a(e.ns) && (e.ns = [e.ns]), a(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), a(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), Z = () => {}, Q = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, $ = class e extends k {
	constructor(e = {}, t) {
		if (super(), this.options = X(e), this.services = {}, this.logger = O, this.modules = { external: [] }, Q(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		...
		if (!this.options.isClone) {
			...
			let e;
			e = this.modules.formatter ? this.modules.formatter : K;
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new I(Y());
...
var me = r("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\">");
function he() {
	return (() => {
		var e = me();
		return t(e, () => de()("mockBanner")), e;
	})();
}
function ge(e) {
	return n(() => e.children);
