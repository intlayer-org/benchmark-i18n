...
var ye = i("<button type=button class=\"rounded-md border border-border bg-accent px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-accent/80\">");
function be() {
...
function xe() {
	...
	let l = () => e() === "auto" ? Q("themeToggle.labelAuto") : Q("themeToggle.labelOther", { mode: e() }), u = () => e() === "auto" ? Q("themeToggle.auto") : e() === "dark" ? Q("themeToggle.dark") : Q("themeToggle.light");
	return (() => {
		var e = ye();
