...
import r from "../../../../locales/fr.json";
import i from "../../../../locales/es.json";
import a from "../../../../locales/de.json";
import o from "../../../../locales/it.json";
import s from "../../../../locales/pt.json";
import c from "../../../../locales/zh.json";
import l from "../../../../locales/ja.json";
import u from "../../../../locales/ko.json";
import d from "../../../../locales/ru.json";
var f = (e) => typeof e == "string", p = () => {
...
var B = (e) => !f(e) && typeof e != "boolean" && typeof e != "number", V = class e extends P {
	constructor(e, t = {}) {
		super(), h([
			"resourceStore",
			"languageUtils",
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return f(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? z(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? D : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? T(i) : a || "{{", this.suffix = o ? T(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u ? T(u) : "-", this.unescapeSuffix = this.unescapePrefix ? "" : l ? T(l) : "", this.nestingPrefix = d ? T(d) : f || T("$t("), this.nestingSuffix = p ? T(p) : m || T(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	init(e, t = { interpolation: {} }) {
		...
		let n = t.cacheInBuiltFormats ? J : ie;
		this.formats = {
			number: n((e, t) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			x(n.loaded, [i], a), oe(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), X = (e) => (f(e.ns) && (e.ns = [e.ns]), f(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), f(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), Z = () => {}, ce = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Q = class e extends P {
	constructor(e = {}, t) {
		if (super(), this.options = X(e), this.services = {}, this.logger = N, this.modules = { external: [] }, ce(this), t && !this.isInitialized && !e.isClone) {
...
var pe = t("<div class=\"grid gap-8 md:grid-cols-2\"><div class=\"rounded-lg border border-border bg-card p-6\"><h2 class=\"mb-3 text-xl font-semibold text-foreground\"></h2><p class=\"text-sm text-muted-foreground\"></p></div><div class=\"rounded-lg border border-border bg-card p-6\"><h2 class=\"mb-3 text-xl font-semibold text-foreground\"></h2><p class=\"text-sm text-muted-foreground\">");
function me() {
	return (() => {
		var t = pe(), n = t.firstChild, r = n.firstChild, i = r.nextSibling, a = n.nextSibling.firstChild, o = a.nextSibling;
		return e(r, () => $("about.grid.whyExistsTitle")), e(i, () => $("about.grid.whyExistsDesc")), e(a, () => $("about.grid.methodologyTitle")), e(o, () => $("about.grid.methodologyDesc")), t;
	})();
}
