...
var _e = r("<h1 class=\"mb-4 text-3xl font-bold text-foreground\">"), ve = r("<p class=\"mb-8 max-w-3xl text-muted-foreground\">");
function ye() {
	return o("AboutHeader"), [(() => {
		var e = _e();
		return t(e, () => $("about.header.title")), e;
	})(), (() => {
		var e = ve();
		return t(e, () => $("about.header.description")), e;
	})()];
}
function be(e) {
	return n(() => e.children);
