...
var he = n("<section class=\"mx-auto mt-12 max-w-3xl\"><h2 class=\"mb-4 text-2xl font-bold text-foreground\"></h2><ul class=space-y-4>"), ge = n("<li class=\"rounded-md border border-border p-4\"><span class=\"block text-sm font-bold text-primary\"></span><span class=\"mt-1 block text-sm text-muted-foreground\">");
function _e() {
	let n = [
		{
	...
	return (() => {
		var i = he(), a = i.firstChild, o = a.nextSibling;
		return t(a, () => $("about.whatWeMeasure.title")), t(o, e(r, {
			each: n,
			children: (e) => (() => {
