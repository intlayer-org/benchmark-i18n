...
import { For as r, createSignal as i } from "solid-js";
...
function R(e, t) {
	let { [I]: n } = e(L()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var z = (e) => !m(e) && typeof e != "boolean" && typeof e != "number", B = class e extends N {
	constructor(e, t = {}) {
		super(), _([
			"resourceStore",
			"languageUtils",
	...
	constructor(e = {}, t) {
		if (super(), this.options = X(e), this.services = {}, this.logger = M, this.modules = { external: [] }, ue(this), t && !this.isInitialized && !e.isClone) {
...
var he = n("<div class=\"grid gap-6 md:grid-cols-2\">"), ge = n("<article class=\"rounded-lg border border-border bg-card p-6\"><div class=\"mb-3 flex items-center gap-3\"><span class=\"rounded-full bg-accent px-3 py-0.5 text-xs font-medium text-accent-foreground\"></span><span class=\"text-xs text-muted-foreground\"></span></div><h2 class=\"mb-2 text-lg font-semibold text-foreground\"></h2><p class=\"mb-4 text-sm text-muted-foreground\"></p><button type=button class=\"text-sm font-medium text-primary hover:underline\">");
function _e() {
	let n = [
		1,
		2,
	...
	return (() => {
		...
		return t(i, e(r, {
			each: n,
			children: (e) => (() => {
				var n = ge(), r = n.firstChild, i = r.firstChild, a = i.nextSibling, o = r.nextSibling, s = o.nextSibling, c = s.nextSibling;
				return t(i, () => $(`blog.list.post${e}Category`)), t(a, () => $(`blog.list.post${e}Date`)), t(o, () => $(`blog.list.post${e}Title`)), t(s, () => $(`blog.list.post${e}Excerpt`)), t(c, () => $("blog.list.readMore")), n;
			})()
		})), i;
	})();
}
