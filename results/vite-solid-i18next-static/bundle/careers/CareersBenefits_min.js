...
var he = n("<div class=\"mb-12 grid gap-4 md:grid-cols-3\">"), ge = n("<div class=\"rounded-lg border border-border bg-card p-4 text-center\"><p class=\"text-sm font-semibold text-foreground\"></p><p class=\"text-xs text-muted-foreground\">");
function _e() {
	let n = [
		{
			label: "remoteLabel",
	...
	return (() => {
		...
		return t(i, e(r, {
			...
			children: (e) => (() => {
				...
				return t(r, () => $(`careers.benefits.${e.label}`)), t(i, () => $(`careers.benefits.${e.value}`)), n;
			})()
		})), i;
	})();
}
