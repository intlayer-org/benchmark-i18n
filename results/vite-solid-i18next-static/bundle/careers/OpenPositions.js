...
function OpenPositions() {
	...
	return [(() => {
		var _el$ = _tmpl$();
		insert(_el$, () => trans("careers.openPositions.title"));
		return _el$;
	})(), (() => {
		var _el$2 = _tmpl$2();
		insert(_el$2, createComponent(For, {
			...
			children: (o) => (() => {
				...
				insert(_el$5, () => trans(`careers.openPositions.${o.titleKey}`));
				insert(_el$6, () => trans(`careers.openPositions.${o.descKey}`));
				insert(_el$8, () => trans(`careers.openPositions.${o.deptKey}`));
				insert(_el$9, () => trans(`careers.openPositions.${o.locationKey}`));
				insert(_el$0, () => trans(`careers.openPositions.${o.typeKey}`));
				insert(_el$1, () => trans("careers.openPositions.applyNow"));
				return _el$3;
			})()
		}));
		return _el$2;
...
function Wrapped() {
	return createComponent(Wrapper, { get children() {
		return createComponent(OpenPositions, {});
	} });
}
