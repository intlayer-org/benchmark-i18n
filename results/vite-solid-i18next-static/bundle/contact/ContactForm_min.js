...
}), Y = (e) => (l(e.ns) && (e.ns = [e.ns]), l(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), l(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), X = () => {}, Z = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Q = class e extends M {
	constructor(e = {}, t) {
		if (super(), this.options = Y(e), this.services = {}, this.logger = j, this.modules = { external: [] }, Z(this), t && !this.isInitialized && !e.isClone) {
...
function Se() {
	let r = c(), a = c(), s = c(), l = c();
	return (() => {
		var c = ye(), u = c.firstChild, d = u.firstChild, f = d.firstChild, p = f.nextSibling, m = d.nextSibling.firstChild, h = m.nextSibling, g = u.nextSibling, _ = g.firstChild, v = _.nextSibling, y = g.nextSibling, b = y.firstChild, x = b.nextSibling, S = y.nextSibling;
