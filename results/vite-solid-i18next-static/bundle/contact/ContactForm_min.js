...
import { For as a, createSignal as o, createUniqueId as s } from "solid-js";
import c from "../../../../locales/fr.json";
import l from "../../../../locales/es.json";
import u from "../../../../locales/de.json";
import d from "../../../../locales/it.json";
import f from "../../../../locales/pt.json";
import p from "../../../../locales/zh.json";
import m from "../../../../locales/ja.json";
import h from "../../../../locales/ko.json";
import g from "../../../../locales/ru.json";
...
var z = (e) => !_(e) && typeof e != "boolean" && typeof e != "number", B = class e extends P {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? te : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? A(i) : a || "{{", this.suffix = o ? A(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u ? A(u) : "-", this.unescapeSuffix = this.unescapePrefix ? "" : l ? A(l) : "", this.nestingPrefix = d ? A(d) : f || A("$t("), this.nestingSuffix = p ? A(p) : m || A(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
...
function xe() {
	let i = s(), o = s(), c = s(), l = s();
	return (() => {
		var s = ve(), u = s.firstChild, d = u.firstChild, f = d.firstChild, p = f.nextSibling, m = d.nextSibling.firstChild, h = m.nextSibling, g = u.nextSibling, _ = g.firstChild, v = _.nextSibling, y = g.nextSibling, b = y.firstChild, x = b.nextSibling, S = y.nextSibling;
		return r(f, "for", i), n(f, () => $("contact.form.name")), r(p, "id", i), r(m, "for", o), n(m, () => $("contact.form.email")), r(h, "id", o), r(_, "for", c), n(_, () => $("contact.form.topic")), r(v, "id", c), n(v, e(a, {
			each: be,
			children: (e) => (() => {
				var t = ye();
				return t.value = e, n(t, () => $(`contact.form.${e}`)), t;
			})()
		})), r(b, "for", l), n(b, () => $("contact.form.message")), r(x, "id", l), n(S, () => $("contact.form.sendMessage")), t((e) => {
			var t = $("contact.form.yourName"), n = $("contact.form.emailPlaceholder"), i = $("contact.form.messagePlaceholder");
			return t !== e.e && r(p, "placeholder", e.e = t), n !== e.t && r(h, "placeholder", e.t = n), i !== e.a && r(x, "placeholder", e.a = i), e;
		}, {
			e: void 0,
			t: void 0,
			a: void 0
