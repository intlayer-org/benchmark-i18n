...
function N(e, t) {
	let { [M]: n } = e(ee()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":", a = t?.enableSelector === "strict";
	if (n.length > 1 && i) {
...
var P = (e) => !a(e) && typeof e != "boolean" && typeof e != "number", F = class e extends k {
	constructor(e, t = {}) {
		super(), c([
			"resourceStore",
			"languageUtils",
	...
	translate(t, n, r) {
		...
		let o = i.returnDetails === void 0 ? this.options.returnDetails : i.returnDetails, s = i.keySeparator === void 0 ? this.options.keySeparator : i.keySeparator, { key: c, namespaces: l } = this.extractFromKey(t[t.length - 1], i), u = l[l.length - 1], d = i.nsSeparator === void 0 ? this.options.nsSeparator : i.nsSeparator;
		d === void 0 && (d = ":");
		...
		b && !h && S && (D = E);
		let O = P(D), k = Object.prototype.toString.apply(D);
		if (b && D && O && !v.includes(k) && !(a(y) && Array.isArray(D))) {
			if (!i.returnObjects && !this.options.returnObjects) {
				...
				return o ? (m.res = e, m.usedParams = this.getUsedParamsDetails(i), m) : e;
			}
			if (s) {
		...
		} else if (b && a(y) && Array.isArray(h)) h = h.join(y), h &&= this.extendTranslation(h, t, i, r);
		else {
			let e = !1, n = !1;
		...
		return o ? (m.res = h, m.usedParams = this.getUsedParamsDetails(i), m) : h;
	}
	extendTranslation(e, t, n, r, i) {
		...
		return e != null && s?.length && n.applyPostProcessor !== !1 && (e = j.handle(s, e, t, this.options && this.options.postProcessPassResolved ? {
			i18nResolved: {
				...r,
	...
	resolve(e, t = {}) {
		let n, r, i, o, s;
		return a(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? N(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
			...
			u.forEach((e) => {
				this.isValidLookup(n) || (s = e, !this.checkedLoadedFor[`${m[0]}-${e}`] && this.utils?.hasLoadedNamespace && !this.utils?.hasLoadedNamespace(s) && (this.checkedLoadedFor[`${m[0]}-${e}`] = !0, this.logger.warn(`key "${r}" for languages "${m.join(", ")}" won't get resolved as namespace "${s}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), m.forEach((r) => {
					...
					if (this.i18nFormat?.addLookupKeys) this.i18nFormat.addLookupKeys(a, l, r, e, t);
						...
						if (d && (t.ordinal && e.startsWith(i) && a.push(l + e.replace(i, this.options.pluralSeparator)), a.push(l + e), f && a.push(l + n)), p) {
							let r = `${l}${this.options.contextSeparator || "_"}${t.context}`;
							a.push(r), d && (t.ordinal && e.startsWith(i) && a.push(r + e.replace(i, this.options.pluralSeparator)), a.push(r + e), f && a.push(r + n));
						}
					}
					let s;
					for (; s = a.pop();) this.isValidLookup(n) || (i = s, n = this.getResource(r, e, s, t));
				}));
			});
		}), {
			res: n,
	...
	constructor(e) {
		this.options = e, this.supportedLngs = this.options.supportedLngs || !1, this.logger = O.create("languageUtils"), this.resolveHierarchyCache = {};
	}
	clearCache() {
	...
	toResolveHierarchy(e, t) {
		...
		let i = t === void 0 || t === !1 || a(t), o = t === void 0 && typeof this.options.fallbackLng == "function", s = a(e) && i && !o, c = null;
		if (s) {
			let n;
		...
		return a(e) && (e.includes("-") || e.includes("_")) ? (this.options.load !== "languageOnly" && d(this.formatLanguageCode(e)), this.options.load !== "languageOnly" && this.options.load !== "currentOnly" && d(this.getScriptPartFromCode(e)), this.options.load !== "currentOnly" && d(this.getLanguagePartFromCode(e))) : a(e) && d(this.formatLanguageCode(e)), l.forEach((e) => {
	...
	interpolate(e, t, n, r) {
		let i, o, c, l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, u = (e) => {
			if (!e.includes(this.formatSeparator)) {
				let i = B(t, l, e, this.options.keySeparator, this.options.ignoreJSONStructure);
			...
			return this.format(B(t, l, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
				...r,
				...t,
				interpolationkey: a
			});
		...
		return [{
			...
			for (c = 0; i = t.regex.exec(e);) {
				...
				let l = t.safeValue(o);
				if (e = e.replace(i[0], V(l)), f ? (t.regex.lastIndex += l.length, t.regex.lastIndex -= i[0].length) : t.regex.lastIndex = 0, c++, c >= this.maxReplaces) break;
			}
		}), e;
	}
	nest(e, t, n = {}) {
		...
		for (; r = this.nestingRegexp.exec(e);) {
			...
			}), i.trim())), e = e.replace(r[0], V(s(i))), this.regexp.lastIndex = 0;
		}
		return e;
	}
}, U = (e) => {
	...
	format(e, t, n, r = {}) {
		...
		return a.reduce((e, t) => {
			let { formatName: i, formatOptions: a } = U(t);
			if (this.formats[i]) {
				let t = e;
				try {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			m(n.loaded, [i], a), ne(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), q = (e) => (a(e.ns) && (e.ns = [e.ns]), a(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), a(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), J = () => {}, Y = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, X = class e extends k {
	constructor(e = {}, t) {
		if (super(), this.options = q(e), this.services = {}, this.logger = O, this.modules = { external: [] }, Y(this), t && !this.isInitialized && !e.isClone) {
	...
	init(e = {}, t) {
		...
		if (!this.options.isClone) {
			...
			let t = new I(this.options);
			this.store = new A(this.options.resources, this.options);
			let n = this.services;
			n.logger = O, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new z(t, { prepend: this.options.pluralSeparator }), e && (n.formatter = r(e), n.formatter.init && n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new H(this.options), n.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }, n.backendConnector = new re(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (e, ...t) => {
				this.emit(e, ...t);
	...
	getFixedT(e, t, n, r) {
		let i = r?.scopeNs, o = (e, t, ...r) => {
			let a;
			a = typeof t == "object" ? { ...t } : this.options.overloadTranslationOptionHandler([e, t].concat(r)), a.lng = a.lng || o.lng, a.lngs = a.lngs || o.lngs;
			let s = a.ns !== void 0 && a.ns !== null;
			a.ns = a.ns || o.ns, a.keyPrefix !== "" && (a.keyPrefix = a.keyPrefix || n || o.keyPrefix);
			let c = {
				...this.options,
				...a
			};
			Array.isArray(i) && !s && (c.ns = i), typeof a.keyPrefix == "function" && (a.keyPrefix = N(a.keyPrefix, c));
			let l = this.options.keySeparator || ".", u;
			return a.keyPrefix && Array.isArray(e) ? u = e.map((e) => (typeof e == "function" && (e = N(e, c)), `${a.keyPrefix}${l}${e}`)) : (typeof e == "function" && (e = N(e, c)), u = a.keyPrefix ? `${a.keyPrefix}${l}${e}` : e), this.t(u, a);
		};
		return a(e) ? o.lng = e : o.lngs = e, o.ns = t, o.keyPrefix = n, o;
	}
	t(...e) {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new I(K());
	...
	cloneInstance(t = {}, n = J) {
		...
		return a.translator = new F(a.services, i), a.translator.on("*", (e, ...t) => {
			a.emit(e, ...t);
...
var ge = r("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\">");
function $() {
	return (() => {
		var e = ge();
		return t(e, () => Z()("mockBanner")), e;
	})();
}
var _e = r("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), ve = r("<p class=\"mb-8 text-muted-foreground\"> <a href=mailto:contact@intlayer.org class=\"text-primary hover:underline\"></a>.");
function ye() {
	return [
		e($, {}),
		(() => {
			var e = _e();
			return t(e, () => Q("contact.header.title")), e;
		})(),
		(() => {
			var e = ve(), n = e.firstChild, r = n.nextSibling;
			return t(e, () => Q("contact.header.description"), n), t(r, () => Q("shared.contactEmail")), e;
		})()
	];
}
function be(e) {
