...
import { createSignal as r } from "solid-js";
import i from "../../../../locales/fr.json";
import a from "../../../../locales/es.json";
import o from "../../../../locales/de.json";
import s from "../../../../locales/it.json";
import c from "../../../../locales/pt.json";
import l from "../../../../locales/zh.json";
import u from "../../../../locales/ja.json";
import d from "../../../../locales/ko.json";
import f from "../../../../locales/ru.json";
...
function L(e, t) {
	let { [I]: n } = e(ie()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var R = (e) => !p(e) && typeof e != "boolean" && typeof e != "number", z = class e extends N {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? O : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? E(i) : a || "{{", this.suffix = o ? E(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u ? E(u) : "-", this.unescapeSuffix = this.unescapePrefix ? "" : l ? E(l) : "", this.nestingPrefix = d ? E(d) : f || E("$t("), this.nestingSuffix = p ? E(p) : m || E(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = g || 1e3, this.alwaysFormat = _ === void 0 ? !1 : _, this.resetRegExp();
	}
	reset() {
	...
	init(e, t = { interpolation: {} }) {
		...
		let n = t.cacheInBuiltFormats ? q : oe;
		this.formats = {
			number: n((e, t) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			S(n.loaded, [i], a), ce(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), Y = (e) => (p(e.ns) && (e.ns = [e.ns]), p(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), p(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), X = () => {}, ue = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Z = class e extends N {
	constructor(e = {}, t) {
		if (super(), this.options = Y(e), this.services = {}, this.logger = M, this.modules = { external: [] }, ue(this), t && !this.isInitialized && !e.isClone) {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new B(J());
...
var me = n("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\">");
function he() {
	return (() => {
		var e = me();
...
var ge = n("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), _e = n("<p class=\"mb-8 text-muted-foreground\"> <a href=mailto:contact@intlayer.org class=\"text-primary hover:underline\"></a>.");
function ve() {
	return [
		e(he, {}),
		(() => {
			var e = ge();
			return t(e, () => $("contact.header.title")), e;
		})(),
		(() => {
			var e = _e(), n = e.firstChild, r = n.nextSibling;
			return t(e, () => $("contact.header.description"), n), t(r, () => $("shared.contactEmail")), e;
		})()
	];
}
