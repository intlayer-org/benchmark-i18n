...
var P = (e) => !a(e) && typeof e != "boolean" && typeof e != "number", F = class e extends k {
...
}), J = (e) => (a(e.ns) && (e.ns = [e.ns]), a(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), a(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), Y = () => {}, X = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Z = class e extends k {
	constructor(e = {}, t) {
		if (super(), this.options = J(e), this.services = {}, this.logger = O, this.modules = { external: [] }, X(this), t && !this.isInitialized && !e.isClone) {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new I(q());
...
var he = r("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\">");
function ge() {
	return (() => {
		var e = he();
		return t(e, () => Q()("mockBanner")), e;
	})();
}
var $ = r("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), _e = r("<p class=\"mb-10 text-muted-foreground\">");
function ve() {
	return [
		e(ge, {}),
		(() => {
			var e = $();
			return t(e, () => Q()("faq.header.title")), e;
		})(),
		(() => {
			var e = _e();
			return t(e, () => Q()("faq.header.description")), e;
		})()
	];
}
function ye(e) {
