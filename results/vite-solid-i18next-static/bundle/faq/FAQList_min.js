...
function L(e, t) {
	let { [I]: n } = e(ae()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var R = (e) => !m(e) && typeof e != "boolean" && typeof e != "number", z = class e extends N {
	...
	init(e, t = { interpolation: {} }) {
		...
		let n = t.cacheInBuiltFormats ? q : se;
		this.formats = {
			number: n((e, t) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			C(n.loaded, [i], a), le(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), Y = (e) => (m(e.ns) && (e.ns = [e.ns]), m(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), m(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), X = () => {}, de = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Z = class e extends N {
	constructor(e = {}, t) {
		if (super(), this.options = Y(e), this.services = {}, this.logger = M, this.modules = { external: [] }, de(this), t && !this.isInitialized && !e.isClone) {
...
var he = n("<div class=\"mx-auto max-w-3xl space-y-4\">"), ge = n("<details class=\"group rounded-lg border border-border bg-card\"><summary class=\"cursor-pointer px-6 py-4 text-sm font-medium text-foreground transition-colors hover:bg-accent/50\"></summary><p class=\"px-6 pb-4 text-sm text-muted-foreground\">");
function _e() {
	let n = [
		1,
		2,
	...
	return (() => {
		...
		return t(i, e(r, {
			...
			children: (e) => (() => {
				...
				return t(r, () => $(`faq.list.q${e}`)), t(i, () => $(`faq.list.a${e}`)), n;
			})()
		})), i;
	})();
}
