...
function ResultsTable() {
	...
	return (() => {
		...
		insert(_el$2, () => trans("home.resultsTable.title"));
		insert(_el$7, () => trans("home.resultsTable.library"));
		insert(_el$8, () => trans("home.resultsTable.bundleSize"));
		insert(_el$9, () => trans("home.resultsTable.lookupTime"));
		insert(_el$0, () => trans("home.resultsTable.lazyLoading"));
		insert(_el$1, createComponent(For, {
			...
			children: (r) => (() => {
				...
				insert(_el$14, () => trans(`home.resultsTable.${r.lazyMsg}`));
				return _el$10;
			})()
		}));
		return _el$;
