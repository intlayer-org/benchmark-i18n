...
var ve = r("<section><h2 class=\"mb-6 text-2xl font-bold text-foreground\"></h2><div class=\"overflow-x-auto rounded-lg border border-border\"><table class=\"w-full text-sm\"><thead class=bg-muted><tr><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th></tr></thead><tbody>"), ye = r("<tr class=\"border-t border-border\"><td class=\"px-4 py-3 font-medium text-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\">");
function be() {
	_e("ResultsTable");
	let n = [
		{
	...
	return (() => {
		var r = ve(), a = r.firstChild, o = a.nextSibling.firstChild.firstChild, s = o.firstChild.firstChild, c = s.nextSibling, l = c.nextSibling, u = l.nextSibling, d = o.nextSibling;
		return t(a, () => $("home.resultsTable.title")), t(s, () => $("home.resultsTable.library")), t(c, () => $("home.resultsTable.bundleSize")), t(l, () => $("home.resultsTable.lookupTime")), t(u, () => $("home.resultsTable.lazyLoading")), t(d, e(i, {
			each: n,
			children: (e) => (() => {
				var n = ye(), r = n.firstChild, i = r.nextSibling, a = i.nextSibling, o = a.nextSibling;
