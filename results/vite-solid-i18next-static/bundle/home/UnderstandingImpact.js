...
var _tmpl$ = template(`<section class="mx-auto mb-16 max-w-3xl space-y-6"><h2 class="text-2xl font-bold text-foreground"></h2><div class="rounded-lg border border-border bg-card p-6"><h3 class="mb-2 text-lg font-semibold text-foreground"></h3><p class="text-sm text-muted-foreground"></p><ul class="mt-3 list-disc space-y-2 pl-5 text-sm text-muted-foreground"><li></li><li></li><li></li></ul></div><div class="rounded-lg border border-border bg-card p-6"><h3 class="mb-2 text-lg font-semibold text-foreground"></h3><p class="text-sm text-muted-foreground"></p><ul class="mt-3 list-disc space-y-2 pl-5 text-sm text-muted-foreground"><li><strong class=text-foreground></strong> </li><li><strong class=text-foreground></strong> </li><li><strong class=text-foreground></strong> </li></ul></div><div class="rounded-lg border border-border bg-card p-6"><h3 class="mb-2 text-lg font-semibold text-foreground"></h3><p class="text-sm text-muted-foreground">`);
function UnderstandingImpact() {
	usePerformanceMeasure("UnderstandingImpact");
	return (() => {
		var _el$ = _tmpl$(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.firstChild, _el$5 = _el$4.nextSibling, _el$7 = _el$5.nextSibling.firstChild, _el$8 = _el$7.nextSibling, _el$9 = _el$8.nextSibling, _el$0 = _el$3.nextSibling, _el$1 = _el$0.firstChild, _el$10 = _el$1.nextSibling, _el$12 = _el$10.nextSibling.firstChild, _el$13 = _el$12.firstChild;
		_el$13.nextSibling;
		var _el$15 = _el$12.nextSibling, _el$16 = _el$15.firstChild;
		_el$16.nextSibling;
		var _el$18 = _el$15.nextSibling, _el$19 = _el$18.firstChild;
		_el$19.nextSibling;
		var _el$22 = _el$0.nextSibling.firstChild, _el$23 = _el$22.nextSibling;
		insert(_el$2, () => trans("home.understandingImpact.title"));
		insert(_el$4, () => trans("home.understandingImpact.singleJsonTitle"));
		insert(_el$5, () => trans("home.understandingImpact.singleJsonIntro"));
		insert(_el$7, () => trans("home.understandingImpact.singleJsonBullet1"));
		insert(_el$8, () => trans("home.understandingImpact.singleJsonBullet2"));
		insert(_el$9, () => trans("home.understandingImpact.singleJsonBullet3"));
		insert(_el$1, () => trans("home.understandingImpact.tradeOffsTitle"));
		insert(_el$10, () => trans("home.understandingImpact.tradeOffsIntro"));
		insert(_el$13, () => trans("home.understandingImpact.waterfallLabel"));
		insert(_el$12, () => trans("home.understandingImpact.waterfallDesc"), null);
		insert(_el$16, () => trans("home.understandingImpact.foucLabel"));
		insert(_el$15, () => trans("home.understandingImpact.foucDesc"), null);
		insert(_el$19, () => trans("home.understandingImpact.cacheLabel"));
		insert(_el$18, () => trans("home.understandingImpact.cacheDesc"), null);
		insert(_el$22, () => trans("home.understandingImpact.measuresTitle"));
		insert(_el$23, () => trans("home.understandingImpact.measuresDesc"));
		return _el$;
	})();
}
...
function Wrapped() {
	return createComponent(Wrapper, { get children() {
		return createComponent(UnderstandingImpact, {});
	} });
}
