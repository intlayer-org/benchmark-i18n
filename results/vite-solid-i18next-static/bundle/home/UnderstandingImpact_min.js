...
function ve() {
	return ge("UnderstandingImpact"), (() => {
		...
		return t(n, () => $("home.understandingImpact.title")), t(i, () => $("home.understandingImpact.singleJsonTitle")), t(a, () => $("home.understandingImpact.singleJsonIntro")), t(o, () => $("home.understandingImpact.singleJsonBullet1")), t(s, () => $("home.understandingImpact.singleJsonBullet2")), t(c, () => $("home.understandingImpact.singleJsonBullet3")), t(u, () => $("home.understandingImpact.tradeOffsTitle")), t(d, () => $("home.understandingImpact.tradeOffsIntro")), t(p, () => $("home.understandingImpact.waterfallLabel")), t(f, () => $("home.understandingImpact.waterfallDesc"), null), t(h, () => $("home.understandingImpact.foucLabel")), t(m, () => $("home.understandingImpact.foucDesc"), null), t(_, () => $("home.understandingImpact.cacheLabel")), t(g, () => $("home.understandingImpact.cacheDesc"), null), t(v, () => $("home.understandingImpact.measuresTitle")), t(y, () => $("home.understandingImpact.measuresDesc")), e;
	})();
}
function ye(e) {
	return n(() => e.children);
