...
function WhyItMatters() {
	...
	return (() => {
		...
		insert(_el$2, () => trans("home.whyItMatters.title"));
		insert(_el$5, () => trans("home.whyItMatters.bundleSizeTitle"));
		insert(_el$6, () => trans("home.whyItMatters.bundleSizeDesc"));
		insert(_el$8, () => trans("home.whyItMatters.renderingTitle"));
		insert(_el$9, () => trans("home.whyItMatters.renderingDesc"));
		insert(_el$1, () => trans("home.whyItMatters.dynamicLoadingTitle"));
		insert(_el$10, () => trans("home.whyItMatters.dynamicLoadingDesc"));
		return _el$;
	})();
}
...
function Wrapped() {
	return createComponent(Wrapper, { get children() {
		return createComponent(WhyItMatters, {});
	} });
}
