...
var he = t("<section class=mb-16><h2 class=\"mb-6 text-2xl font-bold text-foreground\"></h2><div class=\"grid gap-6 md:grid-cols-3\"><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p></div><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p></div><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\">");
function ge() {
	return me("WhyItMatters"), (() => {
		var t = he(), n = t.firstChild, r = n.nextSibling.firstChild, i = r.firstChild, a = i.nextSibling, o = r.nextSibling, s = o.firstChild, c = s.nextSibling, l = o.nextSibling.firstChild, u = l.nextSibling;
		return e(n, () => $("home.whyItMatters.title")), e(i, () => $("home.whyItMatters.bundleSizeTitle")), e(a, () => $("home.whyItMatters.bundleSizeDesc")), e(s, () => $("home.whyItMatters.renderingTitle")), e(c, () => $("home.whyItMatters.renderingDesc")), e(l, () => $("home.whyItMatters.dynamicLoadingTitle")), e(u, () => $("home.whyItMatters.dynamicLoadingDesc")), t;
	})();
}
