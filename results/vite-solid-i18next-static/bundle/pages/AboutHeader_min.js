...
var he = t("<h1 class=\"mb-4 text-3xl font-bold text-foreground\">"), ge = t("<p class=\"mb-8 max-w-3xl text-muted-foreground\">");
function _e() {
	return p("AboutHeader"), [(() => {
		var t = he();
		return e(t, () => $("about.header.title")), t;
	})(), (() => {
		var t = ge();
		return e(t, () => $("about.header.description")), t;
	})()];
}
