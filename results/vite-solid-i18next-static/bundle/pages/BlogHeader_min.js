...
var ge = n("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), _e = n("<p class=\"mb-10 text-muted-foreground\">");
function ve() {
	return [
		e(he, {}),
		(() => {
			var e = ge();
			return t(e, () => $("blog.header.title")), e;
		})(),
		(() => {
			var e = _e();
			return t(e, () => $("blog.header.description")), e;
		})()
	];
}
