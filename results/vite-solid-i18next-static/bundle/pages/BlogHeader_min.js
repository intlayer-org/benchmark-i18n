...
var $ = r("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\">");
function ge() {
	return (() => {
		var e = $();
...
var _e = r("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), ve = r("<p class=\"mb-10 text-muted-foreground\">");
function ye() {
	return [
		e(ge, {}),
		(() => {
			var e = _e();
			return t(e, () => Q("blog.header.title")), e;
		})(),
		(() => {
			var e = ve();
			return t(e, () => Q("blog.header.description")), e;
		})()
	];
}
function be(e) {
