...
var [t, setT] = createSignal(instance.t.bind(instance));
var resources = {
	...
	return (() => {
		...
		insert(_el$1, createComponent(For, {
			...
			children: (topic) => (() => {
				var _el$14 = _tmpl$2();
				_el$14.value = topic;
				insert(_el$14, () => trans(`contact.form.${topic}`));
				return _el$14;
			})()
		}));
		setAttribute(_el$11, "for", messageId);
		insert(_el$11, () => trans("contact.form.message"));
		setAttribute(_el$12, "id", messageId);
		insert(_el$13, () => trans("contact.form.sendMessage"));
		effect((_p$) => {
			var _v$ = trans("contact.form.yourName"), _v$2 = trans("contact.form.emailPlaceholder"), _v$3 = trans("contact.form.messagePlaceholder");
			_v$ !== _p$.e && setAttribute(_el$5, "placeholder", _p$.e = _v$);
			_v$2 !== _p$.t && setAttribute(_el$8, "placeholder", _p$.t = _v$2);
			_v$3 !== _p$.a && setAttribute(_el$12, "placeholder", _p$.a = _v$3);
			return _p$;
		}, {
			e: void 0,
			t: void 0,
