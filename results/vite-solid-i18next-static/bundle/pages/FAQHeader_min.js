...
var $ = n("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\">");
function me() {
	return (() => {
		var e = $();
...
var he = n("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), ge = n("<p class=\"mb-10 text-muted-foreground\">");
function _e() {
	return [
		e(me, {}),
		(() => {
