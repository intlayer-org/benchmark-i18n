...
function ve() {
	...
	return [(() => {
		...
		return t(i, e(r, {
			each: n,
			children: (e) => (() => {
				var n = _e(), r = n.firstChild, i = r.firstChild, a = i.nextSibling, o = a.nextSibling.firstChild, s = o.nextSibling, c = s.nextSibling, l = r.nextSibling;
