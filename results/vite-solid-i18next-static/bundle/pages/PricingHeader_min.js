...
var _e = r("<div class=\"mb-12 text-center\"><h1 class=\"mb-3 text-3xl font-bold text-foreground\"></h1><p class=text-muted-foreground>");
function ve() {
	return [e(ge, {}), (() => {
		var e = _e(), n = e.firstChild, r = n.nextSibling;
		return t(n, () => Q("pricing.header.title")), t(r, () => Q("pricing.header.description")), e;
	})()];
}
function ye(e) {
	return n(() => e.children);
