...
var ge = n("<div class=\"mb-12 text-center\"><h1 class=\"mb-3 text-3xl font-bold text-foreground\"></h1><p class=text-muted-foreground>");
function _e() {
	return [e(he, {}), (() => {
		var e = ge(), n = e.firstChild, r = n.nextSibling;
		return t(n, () => $("pricing.header.title")), t(r, () => $("pricing.header.description")), e;
	})()];
}
