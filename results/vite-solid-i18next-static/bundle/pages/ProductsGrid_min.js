...
function _e() {
	...
	return (() => {
		...
		return t(i, e(r, {
			each: n,
			children: (e) => (() => {
				var n = ge(), r = n.firstChild, i = r.firstChild, a = i.nextSibling, o = r.nextSibling.firstChild, s = o.nextSibling;
