...
import { For as r, createSignal as i, onMount as a } from "solid-js";
...
var h = (e) => typeof e == "string", g = () => {
	...
	"'": "&#39;",
	"/": "&#x2F;"
}, ee = (e) => h(e) ? e.replace(/[&<>"'\/]/g, (e) => k[e]) : e, A = class {
	constructor(e) {
...
function R(e, t) {
	let { [L]: n } = e(ae()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":";
	if (n.length > 1 && i) {
...
var z = (e) => !h(e) && typeof e != "boolean" && typeof e != "number", B = class e extends P {
	constructor(e, t = {}) {
		super(), v([
			"resourceStore",
			"languageUtils",
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return h(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? R(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	init(e, t = { interpolation: {} }) {
		...
		let n = t.cacheInBuiltFormats ? q : ce;
		this.formats = {
			number: n((e, t) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			w(n.loaded, [i], a), ue(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), Y = (e) => (h(e.ns) && (e.ns = [e.ns]), h(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), h(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), X = () => {}, fe = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Z = class e extends P {
	constructor(e = {}, t) {
		if (super(), this.options = Y(e), this.services = {}, this.logger = N, this.modules = { external: [] }, fe(this), t && !this.isInitialized && !e.isClone) {
	...
	dir(e) {
		...
		let t = /* @__PURE__ */ "ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb".split("."), n = this.services?.languageUtils || new V(J());
...
var _e = n("<section><h2 class=\"mb-6 text-2xl font-bold text-foreground\"></h2><div class=\"overflow-x-auto rounded-lg border border-border\"><table class=\"w-full text-sm\"><thead class=bg-muted><tr><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th></tr></thead><tbody>"), ve = n("<tr class=\"border-t border-border\"><td class=\"px-4 py-3 font-medium text-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\">");
function ye() {
	ge("ResultsTable");
	let n = [
		{
	...
	return (() => {
		var i = _e(), a = i.firstChild, o = a.nextSibling.firstChild.firstChild, s = o.firstChild.firstChild, c = s.nextSibling, l = c.nextSibling, u = l.nextSibling, d = o.nextSibling;
		return t(a, () => $("home.resultsTable.title")), t(s, () => $("home.resultsTable.library")), t(c, () => $("home.resultsTable.bundleSize")), t(l, () => $("home.resultsTable.lookupTime")), t(u, () => $("home.resultsTable.lazyLoading")), t(d, e(r, {
			each: n,
			children: (e) => (() => {
				var n = ve(), r = n.firstChild, i = r.nextSibling, a = i.nextSibling, o = a.nextSibling;
