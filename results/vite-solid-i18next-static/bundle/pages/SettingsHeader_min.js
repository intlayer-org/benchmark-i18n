...
var ge = n("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), _e = n("<p class=\"mb-8 text-muted-foreground\">");
function ve() {
	return [
		e(he, {}),
		(() => {
			var e = ge();
			return t(e, () => $("settings.header.title")), e;
		})(),
		(() => {
			var e = _e();
			return t(e, () => $("settings.header.description")), e;
		})()
	];
}
