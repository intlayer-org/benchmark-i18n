...
function _e() {
	...
	return (() => {
		...
		return t(i, e(r, {
			each: n,
			children: (e) => {
				let n = $(`team.grid.member${e}Name`), r = $(`team.grid.member${e}Role`), i = $(`team.grid.member${e}Bio`);
				return (() => {
					var e = ge(), a = e.firstChild, o = a.nextSibling, s = o.nextSibling, c = s.nextSibling;
					return t(a, () => n.split(" ").map((e) => e[0]).join("")), t(o, n), t(s, r), t(c, i), e;
				})();
			}
		})), i;
	})();
