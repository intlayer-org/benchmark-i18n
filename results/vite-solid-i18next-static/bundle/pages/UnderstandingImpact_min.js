...
import { createSignal as n, onMount as r } from "solid-js";
...
var p = (e) => typeof e == "string", m = () => {
	...
	let i = A.getRegExp(`(${r.map((e) => e === "?" ? "\\?" : e).join("|")})`), a = !i.test(e);
	if (!a) {
		let t = e.indexOf(n);
...
var B = (e) => !p(e) && typeof e != "boolean" && typeof e != "number", V = class e extends P {
	constructor(e, t = {}) {
		super(), g([
			"resourceStore",
			"languageUtils",
	...
	resolve(e, t = {}) {
		let n, r, i, a, o;
		return p(e) && (e = [e]), Array.isArray(e) && (e = e.map((e) => typeof e == "function" ? z(e, {
			...this.options,
			...t
		}) : e)), e.forEach((e) => {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			S(n.loaded, [i], a), se(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), X = (e) => (p(e.ns) && (e.ns = [e.ns]), p(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), p(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), Z = () => {}, le = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Q = class e extends P {
	constructor(e = {}, t) {
		if (super(), this.options = X(e), this.services = {}, this.logger = N, this.modules = { external: [] }, le(this), t && !this.isInitialized && !e.isClone) {
...
function ge() {
	return me("UnderstandingImpact"), (() => {
		...
		return e(n, () => $("home.understandingImpact.title")), e(i, () => $("home.understandingImpact.singleJsonTitle")), e(a, () => $("home.understandingImpact.singleJsonIntro")), e(o, () => $("home.understandingImpact.singleJsonBullet1")), e(s, () => $("home.understandingImpact.singleJsonBullet2")), e(c, () => $("home.understandingImpact.singleJsonBullet3")), e(u, () => $("home.understandingImpact.tradeOffsTitle")), e(d, () => $("home.understandingImpact.tradeOffsIntro")), e(p, () => $("home.understandingImpact.waterfallLabel")), e(f, () => $("home.understandingImpact.waterfallDesc"), null), e(h, () => $("home.understandingImpact.foucLabel")), e(m, () => $("home.understandingImpact.foucDesc"), null), e(_, () => $("home.understandingImpact.cacheLabel")), e(g, () => $("home.understandingImpact.cacheDesc"), null), e(v, () => $("home.understandingImpact.measuresTitle")), e(y, () => $("home.understandingImpact.measuresDesc")), t;
	})();
}
