...
function WhatWeMeasure() {
	...
	return (() => {
		...
		insert(_el$2, () => trans("about.whatWeMeasure.title"));
		insert(_el$3, createComponent(For, {
			each: metrics,
			children: (row) => (() => {
				var _el$4 = _tmpl$2(), _el$5 = _el$4.firstChild, _el$6 = _el$5.nextSibling;
				insert(_el$5, () => trans(`about.whatWeMeasure.${row.metricKey}`));
				insert(_el$6, () => trans(`about.whatWeMeasure.${row.descKey}`));
				return _el$4;
			})()
		}));
		return _el$;
...
function Wrapped() {
	return createComponent(Wrapper, { get children() {
		return createComponent(WhatWeMeasure, {});
	} });
}
