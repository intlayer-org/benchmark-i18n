...
var ge = r("<section class=\"mx-auto mt-12 max-w-3xl\"><h2 class=\"mb-4 text-2xl font-bold text-foreground\"></h2><ul class=space-y-4>"), _e = r("<li class=\"rounded-md border border-border p-4\"><span class=\"block text-sm font-bold text-primary\"></span><span class=\"mt-1 block text-sm text-muted-foreground\">");
function ve() {
	let n = [
		{
	...
	return (() => {
		var r = ge(), a = r.firstChild, o = a.nextSibling;
		return t(a, () => $("about.whatWeMeasure.title")), t(o, e(i, {
			each: n,
			children: (e) => (() => {
				var n = _e(), r = n.firstChild, i = r.nextSibling;
				return t(r, () => $(`about.whatWeMeasure.${e.metricKey}`)), t(i, () => $(`about.whatWeMeasure.${e.descKey}`)), n;
			})()
		})), r;
	})();
}
