...
var _e = r("<section class=mb-16><h2 class=\"mb-6 text-2xl font-bold text-foreground\"></h2><div class=\"grid gap-6 md:grid-cols-3\"><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p></div><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p></div><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\">");
function ve() {
	return ge("WhyItMatters"), (() => {
		var e = _e(), n = e.firstChild, r = n.nextSibling.firstChild, i = r.firstChild, a = i.nextSibling, o = r.nextSibling, s = o.firstChild, c = s.nextSibling, l = o.nextSibling.firstChild, u = l.nextSibling;
		return t(n, () => $("home.whyItMatters.title")), t(i, () => $("home.whyItMatters.bundleSizeTitle")), t(a, () => $("home.whyItMatters.bundleSizeDesc")), t(s, () => $("home.whyItMatters.renderingTitle")), t(c, () => $("home.whyItMatters.renderingDesc")), t(l, () => $("home.whyItMatters.dynamicLoadingTitle")), t(u, () => $("home.whyItMatters.dynamicLoadingDesc")), e;
	})();
}
function ye(e) {
	return n(() => e.children);
