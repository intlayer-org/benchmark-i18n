	...
	return (() => {
		...
		insert(_el$, createComponent(For, {
			...
			children: (tier) => (() => {
				...
				insert(_el$3, () => trans(`pricing.tiers.${tier.nameKey}`));
				insert(_el$5, () => trans(`pricing.tiers.${tier.priceKey}`));
				insert(_el$6, () => trans(`pricing.tiers.${tier.periodKey}`));
				insert(_el$7, createComponent(For, {
					...
					children: (f) => (() => {
						...
						insert(_el$9, () => trans(`pricing.tiers.${f}`), null);
						return _el$9;
					})()
				}));
				insert(_el$8, (() => {
					var _c$ = memo(() => tier.nameKey === "enterpriseName");
					return () => _c$() ? trans("pricing.tiers.contactSales") : trans("pricing.tiers.getStarted");
				})());
				effect((_p$) => {
