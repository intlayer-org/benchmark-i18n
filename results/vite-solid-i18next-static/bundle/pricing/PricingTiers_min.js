...
var ve = a("<div class=\"grid gap-6 md:grid-cols-3\">"), ye = a("<div><h3 class=\"text-lg font-semibold text-foreground\"></h3><div class=my-4><span class=\"text-3xl font-bold text-foreground\"></span><span class=\"text-sm text-muted-foreground\"></span></div><ul class=\"mb-6 flex-1 space-y-2\"></ul><button type=button>"), be = a("<li class=\"flex items-center gap-2 text-sm text-muted-foreground\"><span class=text-primary>✓</span> ");
function xe() {
	let a = [
		{
			nameKey: "starterName",
	...
	return (() => {
		...
		return r(s, t(o, {
			each: a,
			children: (a) => (() => {
				var s = ye(), c = s.firstChild, l = c.nextSibling, u = l.firstChild, d = u.nextSibling, f = l.nextSibling, p = f.nextSibling;
				return r(c, () => $(`pricing.tiers.${a.nameKey}`)), r(u, () => $(`pricing.tiers.${a.priceKey}`)), r(d, () => $(`pricing.tiers.${a.periodKey}`)), r(f, t(o, {
					get each() {
						return a.features;
					},
					children: (e) => (() => {
						var t = be();
						return t.firstChild.nextSibling, r(t, () => $(`pricing.tiers.${e}`), null), t;
					})()
				})), r(p, (() => {
					var e = i(() => a.nameKey === "enterpriseName");
					return () => e() ? $("pricing.tiers.contactSales") : $("pricing.tiers.getStarted");
				})()), n((t) => {
