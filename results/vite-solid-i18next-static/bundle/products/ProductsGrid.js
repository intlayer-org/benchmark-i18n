	...
	return (() => {
		...
		insert(_el$, createComponent(For, {
			...
			children: (p) => (() => {
				...
				insert(_el$4, () => trans(`products.grid.${p.nameKey}`));
				insert(_el$5, () => trans(`products.grid.${p.descKey}`));
				insert(_el$7, () => trans(`products.grid.${p.priceKey}`));
				insert(_el$8, () => trans("products.grid.learnMore"));
				return _el$2;
			})()
		}));
		return _el$;
...
function Wrapped() {
	return createComponent(Wrapper, { get children() {
		return createComponent(ProductsGrid, {});
	} });
}
