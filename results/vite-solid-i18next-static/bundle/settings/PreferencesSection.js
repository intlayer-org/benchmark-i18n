...
function PreferencesSection() {
	...
	return (() => {
		...
		insert(_el$2, () => trans("settings.preferences.title"));
		insert(_el$6, () => trans("settings.preferences.emailNotifications"));
		insert(_el$7, () => trans("settings.preferences.weeklyReports"));
		insert(_el$1, () => trans("settings.preferences.darkMode"));
		insert(_el$10, () => trans("settings.preferences.darkColorScheme"));
		setAttribute(_el$13, "for", languageId);
		insert(_el$13, () => trans("settings.preferences.defaultLanguage"));
		setAttribute(_el$14, "id", languageId);
		insert(_el$15, () => trans("settings.preferences.english"));
		insert(_el$16, () => trans("settings.preferences.french"));
		insert(_el$17, () => trans("settings.preferences.german"));
		insert(_el$18, () => trans("settings.preferences.spanish"));
		insert(_el$19, () => trans("settings.preferences.japanese"));
		insert(_el$20, () => trans("settings.preferences.chinese"));
		insert(_el$21, () => trans("settings.preferences.arabic"));
		effect((_p$) => {
			var _v$ = trans("settings.preferences.toggleNotifications"), _v$2 = trans("settings.preferences.toggleDarkMode");
...
function Wrapped() {
	return createComponent(Wrapper, { get children() {
		return createComponent(PreferencesSection, {});
	} });
}
