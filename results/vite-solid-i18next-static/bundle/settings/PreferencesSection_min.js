...
var L = (e) => !c(e) && typeof e != "boolean" && typeof e != "number", R = class e extends j {
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			_(n.loaded, [i], a), K(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), Y = (e) => (c(e.ns) && (e.ns = [e.ns]), c(e.fallbackLng) && (e.fallbackLng = [e.fallbackLng]), c(e.fallbackNS) && (e.fallbackNS = [e.fallbackNS]), e.supportedLngs && !e.supportedLngs.includes("cimode") && (e.supportedLngs = e.supportedLngs.concat(["cimode"])), e), X = () => {}, ae = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, Z = class e extends j {
	constructor(e = {}, t) {
		if (super(), this.options = Y(e), this.services = {}, this.logger = A, this.modules = { external: [] }, ae(this), t && !this.isInitialized && !e.isClone) {
...
var ve = a("<section class=\"rounded-lg border border-border bg-card p-6\"><h2 class=\"mb-4 text-lg font-semibold text-foreground\"></h2><div class=space-y-4><div class=\"flex items-center justify-between\"><div><p class=\"text-sm font-medium text-foreground\"></p><p class=\"text-xs text-muted-foreground\"></p></div><button type=button class=\"h-6 w-11 rounded-full bg-primary transition-colors\"><span class=\"block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform\"></span></button></div><div class=\"flex items-center justify-between\"><div><p class=\"text-sm font-medium text-foreground\"></p><p class=\"text-xs text-muted-foreground\"></p></div><button type=button class=\"h-6 w-11 rounded-full bg-muted transition-colors\"><span class=\"block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform\"></span></button></div><div><label class=\"mb-1 block text-sm font-medium text-foreground\"></label><select class=\"w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring\"><option></option><option></option><option></option><option></option><option></option><option></option><option>");
function ye() {
	let e = s();
	return (() => {
		var r = ve(), a = r.firstChild, o = a.nextSibling.firstChild, s = o.firstChild, c = s.firstChild, l = c.nextSibling, u = s.nextSibling, d = o.nextSibling, f = d.firstChild, p = f.firstChild, m = p.nextSibling, h = f.nextSibling, g = d.nextSibling.firstChild, _ = g.nextSibling, v = _.firstChild, y = v.nextSibling, b = y.nextSibling, x = b.nextSibling, S = x.nextSibling, C = S.nextSibling, w = C.nextSibling;
		return n(a, () => $("settings.preferences.title")), n(c, () => $("settings.preferences.emailNotifications")), n(l, () => $("settings.preferences.weeklyReports")), n(p, () => $("settings.preferences.darkMode")), n(m, () => $("settings.preferences.darkColorScheme")), i(g, "for", e), n(g, () => $("settings.preferences.defaultLanguage")), i(_, "id", e), n(v, () => $("settings.preferences.english")), n(y, () => $("settings.preferences.french")), n(b, () => $("settings.preferences.german")), n(x, () => $("settings.preferences.spanish")), n(S, () => $("settings.preferences.japanese")), n(C, () => $("settings.preferences.chinese")), n(w, () => $("settings.preferences.arabic")), t((e) => {
			var t = $("settings.preferences.toggleNotifications"), n = $("settings.preferences.toggleDarkMode");
