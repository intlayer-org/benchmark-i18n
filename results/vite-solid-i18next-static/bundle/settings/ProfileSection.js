...
function ProfileSection() {
	...
	return (() => {
		...
		insert(_el$2, () => trans("settings.profile.title"));
		setAttribute(_el$5, "for", displayNameId);
		insert(_el$5, () => trans("settings.profile.displayName"));
		setAttribute(_el$6, "id", displayNameId);
		setAttribute(_el$8, "for", emailId);
		insert(_el$8, () => trans("settings.profile.email"));
...
function Wrapped() {
	return createComponent(Wrapper, { get children() {
		return createComponent(ProfileSection, {});
	} });
}
