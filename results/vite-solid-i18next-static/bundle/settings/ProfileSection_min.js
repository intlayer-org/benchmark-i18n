...
function ge() {
	let n = i(), r = i();
	return (() => {
		var i = he(), a = i.firstChild, o = a.nextSibling.firstChild, s = o.firstChild, c = s.nextSibling, l = o.nextSibling.firstChild, u = l.nextSibling;
		return e(a, () => $("settings.profile.title")), t(s, "for", n), e(s, () => $("settings.profile.displayName")), t(c, "id", n), t(l, "for", r), e(l, () => $("settings.profile.email")), t(u, "id", r), i;
	})();
}
