...
var _e = r("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), ve = r("<p class=\"mb-8 text-muted-foreground\">");
function ye() {
	return [
		e(ge, {}),
		(() => {
			var e = _e();
			return t(e, () => Q("settings.header.title")), e;
		})(),
		(() => {
			var e = ve();
			return t(e, () => Q("settings.header.description")), e;
		})()
	];
}
function be(e) {
