	...
	return (() => {
		...
		return t(r, e(i, {
			...
			children: (e) => {
				...
				return (() => {
					var e = _e(), a = e.firstChild, o = a.nextSibling, s = o.nextSibling, c = s.nextSibling;
