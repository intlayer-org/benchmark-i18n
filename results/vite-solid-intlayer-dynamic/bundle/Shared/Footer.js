...
function Footer() {
	const content$1 = a(content, "footer");
	...
	return (() => {
		...
		insert(_el$6, () => content$1().anOpenSourceTestApplication);
		insert(_el$8, () => content$1().resources);
		...
		insert(_el$10, createComponent(A, {
			...
			"class": "text-sm text-muted-foreground transition-colors hover:text-foreground",
			get children() {
				return content$1().contributing;
			}
		}));
		insert(_el$12, () => content$1().contact);
		insert(_el$13, () => content$1().i18nBenchmarkOpenSourceProject);
		return _el$;
	})();
}
