...
var content = {
	"de": () => import("./intlayer-MockBanner-20yf0z-de-aUkkb7po.js").then((n) => n.t).then((m) => m.default),
	"en": () => import("./intlayer-MockBanner-20yf0z-en-CF_y39rA.js").then((n) => n.t).then((m) => m.default),
	"es": () => import("./intlayer-MockBanner-20yf0z-es-BzBV6SVh.js").then((n) => n.t).then((m) => m.default),
	"fr": () => import("./intlayer-MockBanner-20yf0z-fr-Jg2JxP2E.js").then((n) => n.t).then((m) => m.default),
	"it": () => import("./intlayer-MockBanner-20yf0z-it-C5ACRdzY.js").then((n) => n.t).then((m) => m.default),
	"ja": () => import("./intlayer-MockBanner-20yf0z-ja-DhrEg17n.js").then((n) => n.t).then((m) => m.default),
	"ko": () => import("./intlayer-MockBanner-20yf0z-ko-Cu8LYIMr.js").then((n) => n.t).then((m) => m.default),
	"pt": () => import("./intlayer-MockBanner-20yf0z-pt-DJnZNZ2f.js").then((n) => n.t).then((m) => m.default),
	"ru": () => import("./intlayer-MockBanner-20yf0z-ru-DAbFnLB_.js").then((n) => n.t).then((m) => m.default),
	"zh": () => import("./intlayer-MockBanner-20yf0z-zh-CxU0nSo-.js").then((n) => n.t).then((m) => m.default)
};
...
var _tmpl$ = template(`<div class="mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground">`);
function MockBanner() {
	const content$1 = _(content, "mock-banner");
	return (() => {
		var _el$ = _tmpl$();
