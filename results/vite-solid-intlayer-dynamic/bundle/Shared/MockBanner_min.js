...
}, q = n("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\">");
function J() {
	let e = K(o, "mock-banner");
	return (() => {
		var n = q();
		return t(n, () => e().thisPageContainsMockData), n;
	})();
}
export { J as default };
var e = {
