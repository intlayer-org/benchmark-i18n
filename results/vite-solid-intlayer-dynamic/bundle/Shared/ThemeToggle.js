...
function ThemeToggle() {
	const content$1 = a(content, "theme-toggle");
	...
	const label = () => mode() === "auto" ? content$1().themeModeAutoSystemClick.value : `Theme mode: ${mode()}. Click to switch mode.`;
	const buttonText = () => mode() === "auto" ? content$1().themeAuto.value : mode() === "dark" ? content$1().themeDark.value : content$1().themeLight.value;
	return (() => {
		var _el$ = _tmpl$();
