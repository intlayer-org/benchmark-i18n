...
var content = {
	...
	"en": () => import("./en-Cd1nFnrl.js").then((m) => m.default),
...
function AboutGrid() {
	const content$1 = a(content, "about-grid");
	return (() => {
		...
		insert(_el$3, () => content$1().whyThisExists);
		insert(_el$4, () => content$1().choosingAnI18nLibraryIs);
		insert(_el$6, () => content$1().methodology);
		insert(_el$7, () => content$1().theSame10PageApp);
		return _el$;
	})();
}
