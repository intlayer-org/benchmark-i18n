...
var content = {
	"de": () => import("./intlayer-AboutGrid-fjl599-de-7073WCYQ.js").then((n) => n.t).then((m) => m.default),
	"en": () => import("./intlayer-AboutGrid-fjl599-en-Croqj56B.js").then((n) => n.t).then((m) => m.default),
	"es": () => import("./intlayer-AboutGrid-fjl599-es-CPmfd-RA.js").then((n) => n.t).then((m) => m.default),
	"fr": () => import("./intlayer-AboutGrid-fjl599-fr-B5pAOphe.js").then((n) => n.t).then((m) => m.default),
	"it": () => import("./intlayer-AboutGrid-fjl599-it-Bm0n11cQ.js").then((n) => n.t).then((m) => m.default),
	"ja": () => import("./intlayer-AboutGrid-fjl599-ja-Cj8sKU1M.js").then((n) => n.t).then((m) => m.default),
	"ko": () => import("./intlayer-AboutGrid-fjl599-ko-DgwPjsbQ.js").then((n) => n.t).then((m) => m.default),
	"pt": () => import("./intlayer-AboutGrid-fjl599-pt-DiaioZ--.js").then((n) => n.t).then((m) => m.default),
	"ru": () => import("./intlayer-AboutGrid-fjl599-ru-O-CmtfY2.js").then((n) => n.t).then((m) => m.default),
	"zh": () => import("./intlayer-AboutGrid-fjl599-zh-BIGy77d1.js").then((n) => n.t).then((m) => m.default)
};
...
function AboutGrid() {
	const content$1 = _(content, "about-grid");
	return (() => {
		...
		insert(_el$3, () => content$1().d);
		insert(_el$4, () => content$1().a);
		insert(_el$6, () => content$1().b);
		insert(_el$7, () => content$1().c);
		return _el$;
	})();
}
