...
var content = {
	"de": () => import("./de-Doi39cTI.js").then((m) => m.default),
	"en": () => import("./en-BU997muy.js").then((m) => m.default),
	"es": () => import("./es-Dgp8n8e-.js").then((m) => m.default),
	"fr": () => import("./fr-COWlXWLA.js").then((m) => m.default),
	"it": () => import("./it-BVOqza1n.js").then((m) => m.default),
	"ja": () => import("./ja-5BMdA2AB.js").then((m) => m.default),
	"ko": () => import("./ko-BqoG9QF7.js").then((m) => m.default),
	"pt": () => import("./pt-BdXIshq9.js").then((m) => m.default),
	"ru": () => import("./ru-DMdM6ZiB.js").then((m) => m.default),
	"zh": () => import("./zh-Bo2AICV3.js").then((m) => m.default)
};
...
function WhatWeMeasure() {
	const content$1 = a(content, "what-we-measure");
	const metrics = [
		{
			metric: content$1().bundleSizeImpact.value,
			desc: content$1().theAdditionalJavascriptBytesSent.value
		},
		{
			metric: content$1().renderingOverhead.value,
			desc: content$1().howMuchExtraTimeThe.value
		},
		{
			metric: content$1().hydrationCost.value,
			desc: content$1().duringSsrTranslationDataIs.value
		},
		{
			metric: content$1().lazyLoadingEffectiveness.value,
			desc: content$1().whetherSplittingTranslationsByRoute.value
		},
		{
			metric: content$1().localeSwitchSpeed.value,
			desc: content$1().howFastTheAppCan.value
		}
	];
	return (() => {
		var _el$ = _tmpl$(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling;
		insert(_el$2, () => content$1().whatWeMeasure);
