...
var c = {
	de: () => import("./de-CKesPNZ-.js").then((e) => e.default),
	en: () => import("./en-nhPFKHXs.js").then((e) => e.default),
	es: () => import("./es-HRcJAU9N.js").then((e) => e.default),
	fr: () => import("./fr-BXwoLQu1.js").then((e) => e.default),
	it: () => import("./it-CnAM0lAM.js").then((e) => e.default),
	ja: () => import("./ja-T-WbuFLA.js").then((e) => e.default),
	ko: () => import("./ko-Bbp-vnU8.js").then((e) => e.default),
	pt: () => import("./pt-C8azj7qG.js").then((e) => e.default),
	ru: () => import("./ru-L1zf30-F.js").then((e) => e.default),
	zh: () => import("./zh-UTi1udEI.js").then((e) => e.default)
...
}, Y = r("<section class=\"mx-auto mt-12 max-w-3xl\"><h2 class=\"mb-4 text-2xl font-bold text-foreground\"></h2><ul class=space-y-4>"), X = r("<li class=\"rounded-md border border-border p-4\"><span class=\"block text-sm font-bold text-primary\"></span><span class=\"mt-1 block text-sm text-muted-foreground\">");
function Z() {
	let e = J(c, "what-we-measure"), r = [
		{
	...
	return (() => {
		var a = Y(), o = a.firstChild, s = o.nextSibling;
