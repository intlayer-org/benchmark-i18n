...
var content$1 = {
	"de": () => import("./de-BAMZPQxm.js").then((m) => m.default),
	"en": () => import("./en-Bzrgl9k3.js").then((m) => m.default),
	"es": () => import("./es-7_9nhj5Z.js").then((m) => m.default),
	"fr": () => import("./fr-DZwCquez.js").then((m) => m.default),
	"it": () => import("./it-B8nzpRZE.js").then((m) => m.default),
	"ja": () => import("./ja-DinE8QMS.js").then((m) => m.default),
	"ko": () => import("./ko-BB89BzQ9.js").then((m) => m.default),
	"pt": () => import("./pt-hadbHB-y.js").then((m) => m.default),
	"ru": () => import("./ru-C-TCHXfr.js").then((m) => m.default),
	"zh": () => import("./zh-B_Pud_wK.js").then((m) => m.default)
};
...
function BlogHeader() {
	const content = a(content$1, "blog-header");
	return [
