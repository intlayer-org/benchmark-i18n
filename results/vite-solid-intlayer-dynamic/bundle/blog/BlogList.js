...
var content = {
	"de": () => import("./de-D6Q7juxJ.js").then((m) => m.default),
	"en": () => import("./en-6gbncJb6.js").then((m) => m.default),
	"es": () => import("./es-9FnjGRgC.js").then((m) => m.default),
	"fr": () => import("./fr-BeeWTIzz.js").then((m) => m.default),
	"it": () => import("./it-C3FXws0G.js").then((m) => m.default),
	"ja": () => import("./ja-ChvZALLn.js").then((m) => m.default),
	"ko": () => import("./ko-DHj-9PFn.js").then((m) => m.default),
	"pt": () => import("./pt-SmI_CgFx.js").then((m) => m.default),
	"ru": () => import("./ru-Dkl7ZPao.js").then((m) => m.default),
	"zh": () => import("./zh-lKVSZmw9.js").then((m) => m.default)
};
...
function BlogList() {
	const content$1 = a(content, "blog-list");
	const posts = [
		{
			title: content$1().comparingI18nLibrariesIn2026.value,
			date: content$1().march152026.value,
			excerpt: content$1().weTested12DifferentInternationalization.value,
			category: content$1().benchmark.value
		},
		{
			title: content$1().howToReduceYourI18n.value,
			date: content$1().march82026.value,
			excerpt: content$1().practicalStrategiesForOptimizingTranslat.value,
			category: content$1().tutorial.value
		},
		{
			title: content$1().theStateOfInternationalizationIn.value,
			date: content$1().february282026.value,
			excerpt: content$1().anOverviewOfTheCurrent.value,
			category: content$1().analysis.value
		},
		{
			title: content$1().migratingFromReactI18nextTo.value,
			date: content$1().february152026.value,
			excerpt: content$1().aStepByStepGuide.value,
			category: content$1().tutorial.value
		},
		{
			title: content$1().serverComponentsAndI18nWhat.value,
			date: content$1().february12026.value,
			excerpt: content$1().reactServerComponentsIntroduceNew.value,
			category: content$1().analysis.value
		},
		{
			title: content$1().benchmarkMethodologyHowWeTest.value,
			date: content$1().january202026.value,
			excerpt: content$1().aTransparentLookAtOur.value,
			category: content$1().meta.value
		}
	];
	return (() => {
		var _el$ = _tmpl$();
		insert(_el$, createComponent(For, {
			...
			children: (p) => (() => {
				...
				insert(_el$8, () => content$1().readMore);
				return _el$2;
			})()
		}));
		return _el$;
