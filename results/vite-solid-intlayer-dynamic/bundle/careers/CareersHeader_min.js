...
var h = {
	...
	de: () => import("./intlayer-CareersHeader-1gvr5i-de-BwvY4644.js").then((e) => e.n).then((e) => e.default),
	en: () => import("./intlayer-CareersHeader-1gvr5i-en-DFsvryID.js").then((e) => e.n).then((e) => e.default),
	es: () => import("./intlayer-CareersHeader-1gvr5i-es-PFHZBgfD.js").then((e) => e.n).then((e) => e.default),
	fr: () => import("./intlayer-CareersHeader-1gvr5i-fr-5IKdkvZa.js").then((e) => e.n).then((e) => e.default),
	it: () => import("./intlayer-CareersHeader-1gvr5i-it-Da9U3W5F.js").then((e) => e.n).then((e) => e.default),
	ja: () => import("./intlayer-CareersHeader-1gvr5i-ja-Bt15M9Yt.js").then((e) => e.n).then((e) => e.default),
	ko: () => import("./intlayer-CareersHeader-1gvr5i-ko-CTD1X8Jp.js").then((e) => e.n).then((e) => e.default),
	pt: () => import("./intlayer-CareersHeader-1gvr5i-pt-DbTAKLpv.js").then((e) => e.n).then((e) => e.default),
	ru: () => import("./intlayer-CareersHeader-1gvr5i-ru-DKZy41a8.js").then((e) => e.n).then((e) => e.default),
	zh: () => import("./intlayer-CareersHeader-1gvr5i-zh-DuO5U_r7.js").then((e) => e.n).then((e) => e.default)
}, le = b(), S = x[le];
...
var Ae = N, G = /* @__PURE__ */ new Map(), je = (e, t = !0) => {
	...
	de: () => import("./intlayer-CareersHeader-1gvr5i-de-BwvY4644.js").then((e) => e.t).then((e) => e.default),
	en: () => import("./intlayer-CareersHeader-1gvr5i-en-DFsvryID.js").then((e) => e.t).then((e) => e.default),
	es: () => import("./intlayer-CareersHeader-1gvr5i-es-PFHZBgfD.js").then((e) => e.t).then((e) => e.default),
	fr: () => import("./intlayer-CareersHeader-1gvr5i-fr-5IKdkvZa.js").then((e) => e.t).then((e) => e.default),
	it: () => import("./intlayer-CareersHeader-1gvr5i-it-Da9U3W5F.js").then((e) => e.t).then((e) => e.default),
	ja: () => import("./intlayer-CareersHeader-1gvr5i-ja-Bt15M9Yt.js").then((e) => e.t).then((e) => e.default),
	ko: () => import("./intlayer-CareersHeader-1gvr5i-ko-CTD1X8Jp.js").then((e) => e.t).then((e) => e.default),
	pt: () => import("./intlayer-CareersHeader-1gvr5i-pt-DbTAKLpv.js").then((e) => e.t).then((e) => e.default),
	ru: () => import("./intlayer-CareersHeader-1gvr5i-ru-DKZy41a8.js").then((e) => e.t).then((e) => e.default),
	zh: () => import("./intlayer-CareersHeader-1gvr5i-zh-DuO5U_r7.js").then((e) => e.t).then((e) => e.default)
}, We = b(), Ge = $[We];
...
var Je = n("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), Ye = n("<p class=\"mb-4 text-muted-foreground\">");
function Xe() {
	let n = Ue(x, "careers-header");
	return [
		e(qe, {}),
		(() => {
			var e = Je();
