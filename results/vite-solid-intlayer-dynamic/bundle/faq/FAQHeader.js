...
var content$1 = {
	"de": () => import("./de-CjZiiiWN.js").then((m) => m.default),
	"en": () => import("./en-R_qYMd1Q.js").then((m) => m.default),
	"es": () => import("./es-COklBOFK.js").then((m) => m.default),
	"fr": () => import("./fr-CBTKPiyx.js").then((m) => m.default),
	"it": () => import("./it-CYdQf5bZ.js").then((m) => m.default),
	"ja": () => import("./ja-YaoTlcjP.js").then((m) => m.default),
	"ko": () => import("./ko-C81FWigJ.js").then((m) => m.default),
	"pt": () => import("./pt-C-EU0AYj.js").then((m) => m.default),
	"ru": () => import("./ru-CzHnvusw.js").then((m) => m.default),
	"zh": () => import("./zh-BcUBsrmH.js").then((m) => m.default)
};
