...
function ResultsTable() {
	...
	const results = [
		{
			...
			size: "42.3 kB",
			time: "0.12ms",
			lazy: content$1().yes.value
		},
		{
			lib: "react-intl",
			size: "38.1 kB",
			time: "0.15ms",
			lazy: content$1().manual.value
		},
		{
			lib: "lingui",
			size: "12.8 kB",
	...
	return (() => {
		...
		insert(_el$2, () => content$1().sampleResults);
		insert(_el$7, () => content$1().library);
		insert(_el$8, () => content$1().bundleSize);
		insert(_el$9, () => content$1().lookupTime);
		insert(_el$0, () => content$1().lazyLoading);
