...
var content = {
	"de": () => import("./de-nNCYSBjs.js").then((m) => m.default),
	"en": () => import("./en-DkA0v-Wq.js").then((m) => m.default),
	"es": () => import("./es-V8t7iq3t.js").then((m) => m.default),
	"fr": () => import("./fr-BXN9AGli.js").then((m) => m.default),
	"it": () => import("./it-D7WovVUk.js").then((m) => m.default),
	"ja": () => import("./ja-DptccpBI.js").then((m) => m.default),
	"ko": () => import("./ko-DnuYZLhB.js").then((m) => m.default),
	"pt": () => import("./pt-C0Q18tTb.js").then((m) => m.default),
	"ru": () => import("./ru-Ds-nBIdU.js").then((m) => m.default),
	"zh": () => import("./zh-B9flZo89.js").then((m) => m.default)
};
