...
var content = {
	...
	"en": () => import("./en-BbXnjyml.js").then((m) => m.default),
...
function WhyItMatters() {
	const content$1 = a(content, "why-it-matters");
	return (() => {
		...
		insert(_el$2, () => content$1().whyTheseMetricsMatter);
		insert(_el$5, () => content$1().bundleSize);
		insert(_el$6, () => content$1().theBundleIsTheData);
		insert(_el$8, () => content$1().renderingHydration);
		insert(_el$9, () => content$1().connectingALargeJsonDictionary);
		insert(_el$1, () => content$1().dynamicLoading);
		insert(_el$10, () => content$1().loadingAllTranslationsUpfrontOverloads);
		return _el$;
	})();
}
