...
var content = {
	"de": () => import("./intlayer-WhyItMatters-ifl0n3-de-CSaKBmV3.js").then((n) => n.t).then((m) => m.default),
	"en": () => import("./intlayer-WhyItMatters-ifl0n3-en-DMkdJ1-s.js").then((n) => n.t).then((m) => m.default),
	"es": () => import("./intlayer-WhyItMatters-ifl0n3-es-BeJdSU-K.js").then((n) => n.t).then((m) => m.default),
	"fr": () => import("./intlayer-WhyItMatters-ifl0n3-fr-DRSdXvCL.js").then((n) => n.t).then((m) => m.default),
	"it": () => import("./intlayer-WhyItMatters-ifl0n3-it-DaKL2E-3.js").then((n) => n.t).then((m) => m.default),
	"ja": () => import("./intlayer-WhyItMatters-ifl0n3-ja-BEUyQI2y.js").then((n) => n.t).then((m) => m.default),
	"ko": () => import("./intlayer-WhyItMatters-ifl0n3-ko-DHBrA2vx.js").then((n) => n.t).then((m) => m.default),
	"pt": () => import("./intlayer-WhyItMatters-ifl0n3-pt-DlJCqyf7.js").then((n) => n.t).then((m) => m.default),
	"ru": () => import("./intlayer-WhyItMatters-ifl0n3-ru-B_vyOG_g.js").then((n) => n.t).then((m) => m.default),
	"zh": () => import("./intlayer-WhyItMatters-ifl0n3-zh-CR1dWPHk.js").then((n) => n.t).then((m) => m.default)
};
...
function WhyItMatters() {
	const content$1 = _(content, "why-it-matters");
	return (() => {
		...
		insert(_el$2, () => content$1().g);
		insert(_el$5, () => content$1().a);
		insert(_el$6, () => content$1().f);
		insert(_el$8, () => content$1().e);
		insert(_el$9, () => content$1().b);
		insert(_el$1, () => content$1().c);
		insert(_el$10, () => content$1().d);
		return _el$;
	})();
}
