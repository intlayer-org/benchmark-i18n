...
var content = {
	"de": () => import("./de-CPZjIPRD.js").then((m) => m.default),
	"en": () => import("./en-EVOd5g-S.js").then((m) => m.default),
	"es": () => import("./es-23ljR5Rn.js").then((m) => m.default),
	"fr": () => import("./fr-6Lxz1wnc.js").then((m) => m.default),
	"it": () => import("./it-DOnioxms.js").then((m) => m.default),
	"ja": () => import("./ja-DVKES1ZO.js").then((m) => m.default),
	"ko": () => import("./ko-CAa0J9WA.js").then((m) => m.default),
	"pt": () => import("./pt-DLebwRhF.js").then((m) => m.default),
	"ru": () => import("./ru-tyAwaGtx.js").then((m) => m.default),
	"zh": () => import("./zh-5feXJ8E4.js").then((m) => m.default)
};
