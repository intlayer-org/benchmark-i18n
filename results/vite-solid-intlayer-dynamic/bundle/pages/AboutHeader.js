...
import { createContext, createMemo, createRenderEffect, createResource, lazy, onMount, untrack, useContext } from "solid-js";
...
var content = {
	"de": () => import("./intlayer-AboutHeader-11ly1u-de-oBeYtNiQ.js").then((n) => n.t).then((m) => m.default),
	"en": () => import("./intlayer-AboutHeader-11ly1u-en-DWgMl5V2.js").then((n) => n.t).then((m) => m.default),
	"es": () => import("./intlayer-AboutHeader-11ly1u-es-CHy-Kokq.js").then((n) => n.t).then((m) => m.default),
	"fr": () => import("./intlayer-AboutHeader-11ly1u-fr-CzvVFwda.js").then((n) => n.t).then((m) => m.default),
	"it": () => import("./intlayer-AboutHeader-11ly1u-it-CfGhXaxK.js").then((n) => n.t).then((m) => m.default),
	"ja": () => import("./intlayer-AboutHeader-11ly1u-ja-Cm4riK2w.js").then((n) => n.t).then((m) => m.default),
	"ko": () => import("./intlayer-AboutHeader-11ly1u-ko-VZsolQcO.js").then((n) => n.t).then((m) => m.default),
	"pt": () => import("./intlayer-AboutHeader-11ly1u-pt-BJahswlY.js").then((n) => n.t).then((m) => m.default),
	"ru": () => import("./intlayer-AboutHeader-11ly1u-ru-LG_VF55V.js").then((n) => n.t).then((m) => m.default),
	"zh": () => import("./intlayer-AboutHeader-11ly1u-zh-B3LK8I6y.js").then((n) => n.t).then((m) => m.default)
};
...
function AboutHeader() {
	const content$1 = _(content, "about-header");
	usePerformanceMeasure("AboutHeader");
	return [(() => {
		var _el$ = _tmpl$();
		insert(_el$, () => content$1().a);
		return _el$;
	})(), (() => {
		var _el$2 = _tmpl$2();
		insert(_el$2, () => content$1().b);
		return _el$2;
	})()];
}
