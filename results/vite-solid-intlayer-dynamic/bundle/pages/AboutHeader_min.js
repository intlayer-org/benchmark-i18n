...
var Y = n("<h1 class=\"mb-4 text-3xl font-bold text-foreground\">"), X = n("<p class=\"mb-8 max-w-3xl text-muted-foreground\">");
function Z() {
	let e = q(s, "about-header");
	return J("AboutHeader"), [(() => {
		var n = Y();
		return t(n, () => e().aboutThisBenchmark), n;
	})(), (() => {
		var n = X();
		return t(n, () => e().thisIsAnOpenSource), n;
	})()];
}
export { Z as default };
var e = {
