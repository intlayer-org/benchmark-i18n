...
var h = {
	...
	de: () => import("./intlayer-BlogHeader-1koj0y-de-LNg0PNNZ.js").then((e) => e.n).then((e) => e.default),
	en: () => import("./intlayer-BlogHeader-1koj0y-en-DjVflc99.js").then((e) => e.n).then((e) => e.default),
	es: () => import("./intlayer-BlogHeader-1koj0y-es-C5jfYvo0.js").then((e) => e.n).then((e) => e.default),
	fr: () => import("./intlayer-BlogHeader-1koj0y-fr-C83pM66a.js").then((e) => e.n).then((e) => e.default),
	it: () => import("./intlayer-BlogHeader-1koj0y-it-Dpd212RJ.js").then((e) => e.n).then((e) => e.default),
	ja: () => import("./intlayer-BlogHeader-1koj0y-ja-DrfTsU9g.js").then((e) => e.n).then((e) => e.default),
	ko: () => import("./intlayer-BlogHeader-1koj0y-ko-BU6wR7C0.js").then((e) => e.n).then((e) => e.default),
	pt: () => import("./intlayer-BlogHeader-1koj0y-pt-CGqTj10X.js").then((e) => e.n).then((e) => e.default),
	ru: () => import("./intlayer-BlogHeader-1koj0y-ru-C78Q__sq.js").then((e) => e.n).then((e) => e.default),
	zh: () => import("./intlayer-BlogHeader-1koj0y-zh-YVzgbzWP.js").then((e) => e.n).then((e) => e.default)
}, le = b(), S = x[le];
...
var Ae = N, G = /* @__PURE__ */ new Map(), je = (e, t = !0) => {
	...
	de: () => import("./intlayer-BlogHeader-1koj0y-de-LNg0PNNZ.js").then((e) => e.t).then((e) => e.default),
	en: () => import("./intlayer-BlogHeader-1koj0y-en-DjVflc99.js").then((e) => e.t).then((e) => e.default),
	es: () => import("./intlayer-BlogHeader-1koj0y-es-C5jfYvo0.js").then((e) => e.t).then((e) => e.default),
	fr: () => import("./intlayer-BlogHeader-1koj0y-fr-C83pM66a.js").then((e) => e.t).then((e) => e.default),
	it: () => import("./intlayer-BlogHeader-1koj0y-it-Dpd212RJ.js").then((e) => e.t).then((e) => e.default),
	ja: () => import("./intlayer-BlogHeader-1koj0y-ja-DrfTsU9g.js").then((e) => e.t).then((e) => e.default),
	ko: () => import("./intlayer-BlogHeader-1koj0y-ko-BU6wR7C0.js").then((e) => e.t).then((e) => e.default),
	pt: () => import("./intlayer-BlogHeader-1koj0y-pt-CGqTj10X.js").then((e) => e.t).then((e) => e.default),
	ru: () => import("./intlayer-BlogHeader-1koj0y-ru-C78Q__sq.js").then((e) => e.t).then((e) => e.default),
	zh: () => import("./intlayer-BlogHeader-1koj0y-zh-YVzgbzWP.js").then((e) => e.t).then((e) => e.default)
}, We = b(), Ge = $[We];
