...
var g = {
	...
	de: () => import("./intlayer-BlogList-122dlo-de-S2VJ8vdh.js").then((e) => e.t).then((e) => e.default),
	en: () => import("./intlayer-BlogList-122dlo-en-DSZQiF4T.js").then((e) => e.t).then((e) => e.default),
	es: () => import("./intlayer-BlogList-122dlo-es-CsAA79LJ.js").then((e) => e.t).then((e) => e.default),
	fr: () => import("./intlayer-BlogList-122dlo-fr-C5YvHtrT.js").then((e) => e.t).then((e) => e.default),
	it: () => import("./intlayer-BlogList-122dlo-it-Xg4FNGXd.js").then((e) => e.t).then((e) => e.default),
	ja: () => import("./intlayer-BlogList-122dlo-ja-Wk2qwX5Q.js").then((e) => e.t).then((e) => e.default),
	ko: () => import("./intlayer-BlogList-122dlo-ko-Dt1G-FIh.js").then((e) => e.t).then((e) => e.default),
	pt: () => import("./intlayer-BlogList-122dlo-pt-BgCHPGIa.js").then((e) => e.t).then((e) => e.default),
	ru: () => import("./intlayer-BlogList-122dlo-ru-CPBgeELs.js").then((e) => e.t).then((e) => e.default),
	zh: () => import("./intlayer-BlogList-122dlo-zh-Dhf2jIb7.js").then((e) => e.t).then((e) => e.default)
}, x = ue(), S = b[x];
...
}, We = n("<div class=\"grid gap-6 md:grid-cols-2\">"), Ge = n("<article class=\"rounded-lg border border-border bg-card p-6\"><div class=\"mb-3 flex items-center gap-3\"><span class=\"rounded-full bg-accent px-3 py-0.5 text-xs font-medium text-accent-foreground\"></span><span class=\"text-xs text-muted-foreground\"></span></div><h2 class=\"mb-2 text-lg font-semibold text-foreground\"></h2><p class=\"mb-4 text-sm text-muted-foreground\"></p><button type=button class=\"text-sm font-medium text-primary hover:underline\">");
function Ke() {
	let n = Ue(b, "blog-list"), i = () => [
		{
			title: n().g.value,
			date: n().m.value,
			excerpt: n().w.value,
	...
	return (() => {
		...
		return t(a, e(r, {
			...
			children: (e) => (() => {
				var r = Ge(), i = r.firstChild, a = i.firstChild, o = a.nextSibling, s = i.nextSibling, c = s.nextSibling, l = c.nextSibling;
