...
function CareersBenefits() {
	...
	const benefits = [
		{
			label: "Remote-first",
			value: content$1().workFromAnywhereInThe.value
		},
		{
			label: content$1().competitivePay.value,
			value: content$1().topOfMarketCompensation.value
		},
		{
			label: content$1().openSourceTime.value,
			value: content$1().x20TimeForOssContributions.value
		}
	];
	return (() => {
		var _el$ = _tmpl$();
