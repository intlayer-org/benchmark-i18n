...
var content$1 = {
	"de": () => import("./de-BGIxV_k8.js").then((m) => m.default),
	"en": () => import("./en-CXHRZojX.js").then((m) => m.default),
	"es": () => import("./es-DmNWZ8jJ.js").then((m) => m.default),
	"fr": () => import("./fr-B-GMpKF4.js").then((m) => m.default),
	"it": () => import("./it-DczYTaP5.js").then((m) => m.default),
	"ja": () => import("./ja-D4m5vh-h.js").then((m) => m.default),
	"ko": () => import("./ko-D-vYcd2R.js").then((m) => m.default),
	"pt": () => import("./pt-CxBzNXfQ.js").then((m) => m.default),
	"ru": () => import("./ru-BNfilBtO.js").then((m) => m.default),
	"zh": () => import("./zh-CUnC-08J.js").then((m) => m.default)
};
...
function CareersHeader() {
	const content = a(content$1, "careers-header");
	return [
