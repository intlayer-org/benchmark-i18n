...
var s = {
	...
	en: () => import("./en-DvKCbyhy.js").then((e) => e.default),
...
var Z = r("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), Q = r("<p class=\"mb-4 text-muted-foreground\">");
function $() {
	let e = q(s, "careers-header");
	return [
		t(X, {}),
		(() => {
			var t = Z();
			return n(t, () => e().careers), t;
		})(),
		(() => {
			var t = Q();
			return n(t, () => e().joinOurMissionToImprove), t;
		})()
	];
}
export { $ as default };
