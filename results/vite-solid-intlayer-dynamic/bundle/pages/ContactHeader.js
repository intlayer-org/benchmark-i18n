...
var content$1 = {
	"de": () => import("./de-kFm8AJSz.js").then((m) => m.default),
	"en": () => import("./en-BIkCkxuq.js").then((m) => m.default),
	"es": () => import("./es-BrzLhO-D.js").then((m) => m.default),
	"fr": () => import("./fr-DGJamwQ-.js").then((m) => m.default),
	"it": () => import("./it-DKx6dsul.js").then((m) => m.default),
	"ja": () => import("./ja-BG6-eWyz.js").then((m) => m.default),
	"ko": () => import("./ko-uGP2_dY5.js").then((m) => m.default),
	"pt": () => import("./pt-BTTMYCYH.js").then((m) => m.default),
	"ru": () => import("./ru-DeSPBavv.js").then((m) => m.default),
	"zh": () => import("./zh-D0UpHtfJ.js").then((m) => m.default)
};
...
function ContactHeader() {
	const content = a(content$1, "contact-header");
	return [
