...
var content$1 = {
	"de": () => import("./intlayer-ContactHeader-832ypu-de-DIZ7Frex.js").then((n) => n.n).then((m) => m.default),
	"en": () => import("./intlayer-ContactHeader-832ypu-en-iVCgPZVw.js").then((n) => n.n).then((m) => m.default),
	"es": () => import("./intlayer-ContactHeader-832ypu-es-mwpJ-IyW.js").then((n) => n.n).then((m) => m.default),
	"fr": () => import("./intlayer-ContactHeader-832ypu-fr-CIZ7RoaB.js").then((n) => n.n).then((m) => m.default),
	"it": () => import("./intlayer-ContactHeader-832ypu-it-Dvt50e86.js").then((n) => n.n).then((m) => m.default),
	"ja": () => import("./intlayer-ContactHeader-832ypu-ja-BIUEW83x.js").then((n) => n.n).then((m) => m.default),
	"ko": () => import("./intlayer-ContactHeader-832ypu-ko--Zogl9H-.js").then((n) => n.n).then((m) => m.default),
	"pt": () => import("./intlayer-ContactHeader-832ypu-pt-CedoYXxD.js").then((n) => n.n).then((m) => m.default),
	"ru": () => import("./intlayer-ContactHeader-832ypu-ru-Cg8ex3wG.js").then((n) => n.n).then((m) => m.default),
	"zh": () => import("./intlayer-ContactHeader-832ypu-zh-ChRh-dbd.js").then((n) => n.n).then((m) => m.default)
};
...
var content = {
	"de": () => import("./intlayer-ContactHeader-832ypu-de-DIZ7Frex.js").then((n) => n.t).then((m) => m.default),
	"en": () => import("./intlayer-ContactHeader-832ypu-en-iVCgPZVw.js").then((n) => n.t).then((m) => m.default),
	"es": () => import("./intlayer-ContactHeader-832ypu-es-mwpJ-IyW.js").then((n) => n.t).then((m) => m.default),
	"fr": () => import("./intlayer-ContactHeader-832ypu-fr-CIZ7RoaB.js").then((n) => n.t).then((m) => m.default),
	"it": () => import("./intlayer-ContactHeader-832ypu-it-Dvt50e86.js").then((n) => n.t).then((m) => m.default),
	"ja": () => import("./intlayer-ContactHeader-832ypu-ja-BIUEW83x.js").then((n) => n.t).then((m) => m.default),
	"ko": () => import("./intlayer-ContactHeader-832ypu-ko--Zogl9H-.js").then((n) => n.t).then((m) => m.default),
	"pt": () => import("./intlayer-ContactHeader-832ypu-pt-CedoYXxD.js").then((n) => n.t).then((m) => m.default),
	"ru": () => import("./intlayer-ContactHeader-832ypu-ru-Cg8ex3wG.js").then((n) => n.t).then((m) => m.default),
	"zh": () => import("./intlayer-ContactHeader-832ypu-zh-ChRh-dbd.js").then((n) => n.t).then((m) => m.default)
};
...
var _tmpl$2 = template(`<p class="mb-8 text-muted-foreground"> <a href=mailto:contact@intlayer.org class="text-primary hover:underline">contact@intlayer.org</a>.`);
function ContactHeader() {
	const content = _(content$1, "contact-header");
	return [
