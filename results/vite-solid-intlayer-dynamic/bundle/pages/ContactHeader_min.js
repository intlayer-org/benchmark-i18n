...
var h = {
	...
	de: () => import("./intlayer-ContactHeader-832ypu-de-DU-r9wmo.js").then((e) => e.n).then((e) => e.default),
	en: () => import("./intlayer-ContactHeader-832ypu-en-LCeD51MV.js").then((e) => e.n).then((e) => e.default),
	es: () => import("./intlayer-ContactHeader-832ypu-es-D3m8ZZ5q.js").then((e) => e.n).then((e) => e.default),
	fr: () => import("./intlayer-ContactHeader-832ypu-fr-BPoFfPpZ.js").then((e) => e.n).then((e) => e.default),
	it: () => import("./intlayer-ContactHeader-832ypu-it-D3ivxVVe.js").then((e) => e.n).then((e) => e.default),
	ja: () => import("./intlayer-ContactHeader-832ypu-ja-qPJIY6XC.js").then((e) => e.n).then((e) => e.default),
	ko: () => import("./intlayer-ContactHeader-832ypu-ko-f14BE6j2.js").then((e) => e.n).then((e) => e.default),
	pt: () => import("./intlayer-ContactHeader-832ypu-pt-CVGOp9nW.js").then((e) => e.n).then((e) => e.default),
	ru: () => import("./intlayer-ContactHeader-832ypu-ru-CRt6tKkB.js").then((e) => e.n).then((e) => e.default),
	zh: () => import("./intlayer-ContactHeader-832ypu-zh-DqGoEfLu.js").then((e) => e.n).then((e) => e.default)
}, le = b(), S = x[le];
...
var Ae = N, G = /* @__PURE__ */ new Map(), je = (e, t = !0) => {
	...
	de: () => import("./intlayer-ContactHeader-832ypu-de-DU-r9wmo.js").then((e) => e.t).then((e) => e.default),
	en: () => import("./intlayer-ContactHeader-832ypu-en-LCeD51MV.js").then((e) => e.t).then((e) => e.default),
	es: () => import("./intlayer-ContactHeader-832ypu-es-D3m8ZZ5q.js").then((e) => e.t).then((e) => e.default),
	fr: () => import("./intlayer-ContactHeader-832ypu-fr-BPoFfPpZ.js").then((e) => e.t).then((e) => e.default),
	it: () => import("./intlayer-ContactHeader-832ypu-it-D3ivxVVe.js").then((e) => e.t).then((e) => e.default),
	ja: () => import("./intlayer-ContactHeader-832ypu-ja-qPJIY6XC.js").then((e) => e.t).then((e) => e.default),
	ko: () => import("./intlayer-ContactHeader-832ypu-ko-f14BE6j2.js").then((e) => e.t).then((e) => e.default),
	pt: () => import("./intlayer-ContactHeader-832ypu-pt-CVGOp9nW.js").then((e) => e.t).then((e) => e.default),
	ru: () => import("./intlayer-ContactHeader-832ypu-ru-CRt6tKkB.js").then((e) => e.t).then((e) => e.default),
	zh: () => import("./intlayer-ContactHeader-832ypu-zh-DqGoEfLu.js").then((e) => e.t).then((e) => e.default)
}, We = b(), Ge = $[We];
...
var Je = n("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), Ye = n("<p class=\"mb-8 text-muted-foreground\"> <a href=mailto:contact@intlayer.org class=\"text-primary hover:underline\">contact@intlayer.org</a>.");
function Xe() {
	let n = Ue(x, "contact-header");
	return [
		e(qe, {}),
		(() => {
			var e = Je();
