...
var Z = r("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), Q = r("<p class=\"mb-8 text-muted-foreground\"> <a href=mailto:contact@intlayer.org class=\"text-primary hover:underline\">contact@intlayer.org</a>.");
function $() {
	let e = q(s, "contact-header");
	return [
		t(X, {}),
		(() => {
			var t = Z();
			return n(t, () => e().getInTouch), t;
		})(),
		(() => {
			var t = Q(), r = t.firstChild;
			return n(t, () => e().haveIdeasFoundABug, r), t;
		})()
	];
}
export { $ as default };
