...
var content$1 = {
	...
	"en": () => import("./en-B2tCLtCj.js").then((m) => m.default),
...
var content = {
	...
	"en": () => import("./en-qdOC_UpI.js").then((m) => m.default),
...
function FAQHeader() {
	const content = a(content$1, "faq-header");
	return [
		createComponent(MockBanner, {}),
		(() => {
			var _el$ = _tmpl$();
			insert(_el$, () => content().frequentlyAskedQuestions);
			return _el$;
		})(),
		(() => {
			var _el$2 = _tmpl$2();
			insert(_el$2, () => content().everythingYouNeedToKnow);
			return _el$2;
		})()
	];
}
