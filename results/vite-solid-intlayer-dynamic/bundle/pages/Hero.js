...
var content = {
	"de": () => import("./intlayer-Hero-hmkplk-de-DBclaMeN.js").then((n) => n.t).then((m) => m.default),
	"en": () => import("./intlayer-Hero-hmkplk-en-vTBFM4s6.js").then((n) => n.t).then((m) => m.default),
	"es": () => import("./intlayer-Hero-hmkplk-es-Cd43tzsO.js").then((n) => n.t).then((m) => m.default),
	"fr": () => import("./intlayer-Hero-hmkplk-fr-Bdh67OoZ.js").then((n) => n.t).then((m) => m.default),
	"it": () => import("./intlayer-Hero-hmkplk-it-JF6hw_jy.js").then((n) => n.t).then((m) => m.default),
	"ja": () => import("./intlayer-Hero-hmkplk-ja-BMDpBAwY.js").then((n) => n.t).then((m) => m.default),
	"ko": () => import("./intlayer-Hero-hmkplk-ko-2I6CQNhC.js").then((n) => n.t).then((m) => m.default),
	"pt": () => import("./intlayer-Hero-hmkplk-pt-3mEgzKjW.js").then((n) => n.t).then((m) => m.default),
	"ru": () => import("./intlayer-Hero-hmkplk-ru-BLPN9Gp3.js").then((n) => n.t).then((m) => m.default),
	"zh": () => import("./intlayer-Hero-hmkplk-zh-CaoGqhdn.js").then((n) => n.t).then((m) => m.default)
};
...
function Hero() {
	...
	const { d: title, a: description, e: viewResults, c: methodology } = _(content, "hero");
	return (() => {
