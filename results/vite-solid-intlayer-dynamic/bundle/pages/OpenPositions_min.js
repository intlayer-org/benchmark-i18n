...
var c = {
	de: () => import("./de-CWJoMbHt.js").then((e) => e.default),
	en: () => import("./en-DrgzASi3.js").then((e) => e.default),
	es: () => import("./es-CqZm-6Qw.js").then((e) => e.default),
	fr: () => import("./fr-DdzUfMg6.js").then((e) => e.default),
	it: () => import("./it-0lposZq8.js").then((e) => e.default),
	ja: () => import("./ja-BQ4aprfB.js").then((e) => e.default),
	ko: () => import("./ko-CTsaTDxs.js").then((e) => e.default),
	pt: () => import("./pt-BjgGgmio.js").then((e) => e.default),
	ru: () => import("./ru-Bf60b-SV.js").then((e) => e.default),
	zh: () => import("./zh-Dk01x9nj.js").then((e) => e.default)
...
function Q() {
	...
	return [(() => {
		...
		return n(a, t(i, {
			each: r,
			children: (t) => (() => {
				var r = Z(), i = r.firstChild, a = i.firstChild, o = a.nextSibling, s = o.nextSibling.firstChild, c = s.nextSibling, l = c.nextSibling, u = i.nextSibling;
