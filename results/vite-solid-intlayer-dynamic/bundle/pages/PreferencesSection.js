...
function PreferencesSection() {
	const content$1 = a(content, "preferences-section");
	...
	return (() => {
		...
		insert(_el$2, () => content$1().preferences);
		insert(_el$6, () => content$1().emailNotifications);
		insert(_el$7, () => content$1().receiveWeeklyBenchmarkReports);
		insert(_el$1, () => content$1().darkMode);
		insert(_el$10, () => content$1().useDarkColorScheme);
		setAttribute(_el$13, "for", languageId);
		insert(_el$13, () => content$1().defaultLanguage);
		setAttribute(_el$14, "id", languageId);
		insert(_el$15, () => content$1().englishEn);
		insert(_el$16, () => content$1().frenchFr);
		insert(_el$17, () => content$1().germanDe);
		insert(_el$18, () => content$1().spanishEs);
		insert(_el$19, () => content$1().japaneseJa);
		insert(_el$20, () => content$1().chineseSimplifiedZhCn);
		insert(_el$21, () => content$1().italianIt);
		insert(_el$22, () => content$1().portuguesePt);
		insert(_el$23, () => content$1().koreanKo);
		insert(_el$24, () => content$1().russianRu);
		insert(_el$25, () => content$1().arabicAr);
		effect((_p$) => {
			var _v$ = content$1().toggleNotifications.value, _v$2 = content$1().toggleDarkMode.value;
