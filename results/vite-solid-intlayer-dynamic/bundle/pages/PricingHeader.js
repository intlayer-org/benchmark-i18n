...
var content$1 = {
	"de": () => import("./de-V2_yT77W.js").then((m) => m.default),
	"en": () => import("./en-DSBs99NN.js").then((m) => m.default),
	"es": () => import("./es-DSYxNKBp.js").then((m) => m.default),
	"fr": () => import("./fr-DM7DFjcC.js").then((m) => m.default),
	"it": () => import("./it-DYy6_MTx.js").then((m) => m.default),
	"ja": () => import("./ja-DrIaZAPi.js").then((m) => m.default),
	"ko": () => import("./ko-C297DdTa.js").then((m) => m.default),
	"pt": () => import("./pt-BG2fMOGN.js").then((m) => m.default),
	"ru": () => import("./ru-CmAy0MPL.js").then((m) => m.default),
	"zh": () => import("./zh-DzccOQX6.js").then((m) => m.default)
};
...
function PricingHeader() {
	const content = a(content$1, "pricing-header");
