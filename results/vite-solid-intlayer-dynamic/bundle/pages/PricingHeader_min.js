...
var h = {
	...
	de: () => import("./intlayer-PricingHeader-pwms1u-de-B4uhIN_U.js").then((e) => e.t).then((e) => e.default),
	en: () => import("./intlayer-PricingHeader-pwms1u-en-DugcMU0W.js").then((e) => e.t).then((e) => e.default),
	es: () => import("./intlayer-PricingHeader-pwms1u-es-C2SF7C_e.js").then((e) => e.t).then((e) => e.default),
	fr: () => import("./intlayer-PricingHeader-pwms1u-fr-BBxNy206.js").then((e) => e.t).then((e) => e.default),
	it: () => import("./intlayer-PricingHeader-pwms1u-it-CvQRannN.js").then((e) => e.t).then((e) => e.default),
	ja: () => import("./intlayer-PricingHeader-pwms1u-ja-qfAU2gkb.js").then((e) => e.t).then((e) => e.default),
	ko: () => import("./intlayer-PricingHeader-pwms1u-ko-BApJHPNQ.js").then((e) => e.t).then((e) => e.default),
	pt: () => import("./intlayer-PricingHeader-pwms1u-pt-CbvbcoIm.js").then((e) => e.t).then((e) => e.default),
	ru: () => import("./intlayer-PricingHeader-pwms1u-ru-Ck8csJO-.js").then((e) => e.t).then((e) => e.default),
	zh: () => import("./intlayer-PricingHeader-pwms1u-zh-DKJgNvxU.js").then((e) => e.t).then((e) => e.default)
}, le = b(), S = x[le];
...
var Ae = N, G = /* @__PURE__ */ new Map(), je = (e, t = !0) => {
	...
	de: () => import("./intlayer-PricingHeader-pwms1u-de-B4uhIN_U.js").then((e) => e.n).then((e) => e.default),
	en: () => import("./intlayer-PricingHeader-pwms1u-en-DugcMU0W.js").then((e) => e.n).then((e) => e.default),
	es: () => import("./intlayer-PricingHeader-pwms1u-es-C2SF7C_e.js").then((e) => e.n).then((e) => e.default),
	fr: () => import("./intlayer-PricingHeader-pwms1u-fr-BBxNy206.js").then((e) => e.n).then((e) => e.default),
	it: () => import("./intlayer-PricingHeader-pwms1u-it-CvQRannN.js").then((e) => e.n).then((e) => e.default),
	ja: () => import("./intlayer-PricingHeader-pwms1u-ja-qfAU2gkb.js").then((e) => e.n).then((e) => e.default),
	ko: () => import("./intlayer-PricingHeader-pwms1u-ko-BApJHPNQ.js").then((e) => e.n).then((e) => e.default),
	pt: () => import("./intlayer-PricingHeader-pwms1u-pt-CbvbcoIm.js").then((e) => e.n).then((e) => e.default),
	ru: () => import("./intlayer-PricingHeader-pwms1u-ru-Ck8csJO-.js").then((e) => e.n).then((e) => e.default),
	zh: () => import("./intlayer-PricingHeader-pwms1u-zh-DKJgNvxU.js").then((e) => e.n).then((e) => e.default)
}, We = b(), Ge = $[We];
...
var Je = n("<div class=\"mb-12 text-center\"><h1 class=\"mb-3 text-3xl font-bold text-foreground\"></h1><p class=text-muted-foreground>");
function Ye() {
	let n = Ue(x, "pricing-header");
	return [e(qe, {}), (() => {
		var e = Je(), r = e.firstChild, i = r.nextSibling;
		return t(r, () => n().b), t(i, () => n().a), e;
	})()];
}
...
var t = e({
	...
	a: "Elija el plan que mejor se adapte a su equipo. Sin cargos ocultos."
}, c = {
	key: o,
	content: s
};
...
var t = e({
	...
	b: "Une tarification simple et transparente",
	a: "Choisissez le forfait qui convient à votre équipe. Pas de frais cachés."
}, c = {
	key: o,
	content: s
};
...
var t = e({
	...
	b: "シンプルで透明性の高い価格設定",
	a: "あなたのチームに合ったプランをお選びください。隠れた費用はありません。"
}, c = {
	key: o,
	content: s
};
...
var t = e({
	...
	b: "단순하고 투명한 가격 책정",
	a: "팀에 맞는 플랜을 선택하십시오. 숨겨진 비용은 없습니다."
}, c = {
	key: o,
	content: s
};
