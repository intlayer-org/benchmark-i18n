...
var h = {
	...
	de: () => import("./intlayer-ProductsHeader-1dk975-de-DRhNVT9p.js").then((e) => e.t).then((e) => e.default),
	en: () => import("./intlayer-ProductsHeader-1dk975-en-AvBAESdd.js").then((e) => e.t).then((e) => e.default),
	es: () => import("./intlayer-ProductsHeader-1dk975-es-CV3-3qz0.js").then((e) => e.t).then((e) => e.default),
	fr: () => import("./intlayer-ProductsHeader-1dk975-fr-XmHoSHFw.js").then((e) => e.t).then((e) => e.default),
	it: () => import("./intlayer-ProductsHeader-1dk975-it-DieA1BHr.js").then((e) => e.t).then((e) => e.default),
	ja: () => import("./intlayer-ProductsHeader-1dk975-ja-DSNPBVcf.js").then((e) => e.t).then((e) => e.default),
	ko: () => import("./intlayer-ProductsHeader-1dk975-ko-BkkZWAkI.js").then((e) => e.t).then((e) => e.default),
	pt: () => import("./intlayer-ProductsHeader-1dk975-pt-6gXAq_fZ.js").then((e) => e.t).then((e) => e.default),
	ru: () => import("./intlayer-ProductsHeader-1dk975-ru-zUnzL3SA.js").then((e) => e.t).then((e) => e.default),
	zh: () => import("./intlayer-ProductsHeader-1dk975-zh-CC9y04Xi.js").then((e) => e.t).then((e) => e.default)
}, le = b(), S = x[le];
...
var Ae = N, G = /* @__PURE__ */ new Map(), je = (e, t = !0) => {
	...
	de: () => import("./intlayer-ProductsHeader-1dk975-de-DRhNVT9p.js").then((e) => e.n).then((e) => e.default),
	en: () => import("./intlayer-ProductsHeader-1dk975-en-AvBAESdd.js").then((e) => e.n).then((e) => e.default),
	es: () => import("./intlayer-ProductsHeader-1dk975-es-CV3-3qz0.js").then((e) => e.n).then((e) => e.default),
	fr: () => import("./intlayer-ProductsHeader-1dk975-fr-XmHoSHFw.js").then((e) => e.n).then((e) => e.default),
	it: () => import("./intlayer-ProductsHeader-1dk975-it-DieA1BHr.js").then((e) => e.n).then((e) => e.default),
	ja: () => import("./intlayer-ProductsHeader-1dk975-ja-DSNPBVcf.js").then((e) => e.n).then((e) => e.default),
	ko: () => import("./intlayer-ProductsHeader-1dk975-ko-BkkZWAkI.js").then((e) => e.n).then((e) => e.default),
	pt: () => import("./intlayer-ProductsHeader-1dk975-pt-6gXAq_fZ.js").then((e) => e.n).then((e) => e.default),
	ru: () => import("./intlayer-ProductsHeader-1dk975-ru-zUnzL3SA.js").then((e) => e.n).then((e) => e.default),
	zh: () => import("./intlayer-ProductsHeader-1dk975-zh-CC9y04Xi.js").then((e) => e.n).then((e) => e.default)
}, We = b(), Ge = $[We];
...
var t = e({
	...
	a: "Produkte",
	b: "Tools und Dienstleistungen zur Optimierung Ihres Internationalisierungs-Workflows."
}, c = {
	key: o,
	content: s
};
...
var t = e({
	...
	a: "Produits",
	b: "Des outils et services pour rationaliser votre flux de travail d'internationalisation."
}, c = {
	key: o,
	content: s
};
...
var t = e({
	...
	a: "Produtos",
	b: "Ferramentas e serviços para simplificar seu fluxo de trabalho de internacionalização."
}, c = {
	key: o,
	content: s
};
