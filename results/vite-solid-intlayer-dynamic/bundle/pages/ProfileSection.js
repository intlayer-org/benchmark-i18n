...
var content = {
	"de": () => import("./intlayer-ProfileSection-1c6oem-de-BRiFzbAs.js").then((n) => n.t).then((m) => m.default),
	"en": () => import("./intlayer-ProfileSection-1c6oem-en-yBPFfqDR.js").then((n) => n.t).then((m) => m.default),
	"es": () => import("./intlayer-ProfileSection-1c6oem-es-gWmW0jcV.js").then((n) => n.t).then((m) => m.default),
	"fr": () => import("./intlayer-ProfileSection-1c6oem-fr-DxAmuDrp.js").then((n) => n.t).then((m) => m.default),
	"it": () => import("./intlayer-ProfileSection-1c6oem-it-CvvDl-qn.js").then((n) => n.t).then((m) => m.default),
	"ja": () => import("./intlayer-ProfileSection-1c6oem-ja-BM59Xu4T.js").then((n) => n.t).then((m) => m.default),
	"ko": () => import("./intlayer-ProfileSection-1c6oem-ko-CThImy7I.js").then((n) => n.t).then((m) => m.default),
	"pt": () => import("./intlayer-ProfileSection-1c6oem-pt-BRdkT0aR.js").then((n) => n.t).then((m) => m.default),
	"ru": () => import("./intlayer-ProfileSection-1c6oem-ru-Bb8AAuNS.js").then((n) => n.t).then((m) => m.default),
	"zh": () => import("./intlayer-ProfileSection-1c6oem-zh-Bhv2Lw8a.js").then((n) => n.t).then((m) => m.default)
};
...
function ProfileSection() {
	const content$1 = _(content, "profile-section");
