...
var content = {
	"de": () => import("./intlayer-ResultsTable-qpt6kk-de-BMA-lyNo.js").then((n) => n.t).then((m) => m.default),
	"en": () => import("./intlayer-ResultsTable-qpt6kk-en-D8Vowptg.js").then((n) => n.t).then((m) => m.default),
	"es": () => import("./intlayer-ResultsTable-qpt6kk-es-CBIeGdbm.js").then((n) => n.t).then((m) => m.default),
	"fr": () => import("./intlayer-ResultsTable-qpt6kk-fr-DgTVqwC2.js").then((n) => n.t).then((m) => m.default),
	"it": () => import("./intlayer-ResultsTable-qpt6kk-it-CIV_2ouf.js").then((n) => n.t).then((m) => m.default),
	"ja": () => import("./intlayer-ResultsTable-qpt6kk-ja-BXdWnzhF.js").then((n) => n.t).then((m) => m.default),
	"ko": () => import("./intlayer-ResultsTable-qpt6kk-ko-F1e3ikkW.js").then((n) => n.t).then((m) => m.default),
	"pt": () => import("./intlayer-ResultsTable-qpt6kk-pt-CrFuEW6k.js").then((n) => n.t).then((m) => m.default),
	"ru": () => import("./intlayer-ResultsTable-qpt6kk-ru-Cgpm-PCT.js").then((n) => n.t).then((m) => m.default),
	"zh": () => import("./intlayer-ResultsTable-qpt6kk-zh-fPS_hHxs.js").then((n) => n.t).then((m) => m.default)
};
...
function ResultsTable() {
	const content$1 = _(content, "results-table");
	const results = () => [
		{
			lib: "react-i18next",
			size: "42.3 kB",
	...
	return (() => {
		...
		insert(_el$2, () => content$1().f);
		insert(_el$7, () => content$1().c);
		insert(_el$8, () => content$1().a);
		insert(_el$9, () => content$1().d);
		insert(_el$0, () => content$1().b);
