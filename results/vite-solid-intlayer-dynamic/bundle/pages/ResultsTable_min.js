...
var g = {
	...
	de: () => import("./intlayer-ResultsTable-qpt6kk-de-Bym4Ic0H.js").then((e) => e.t).then((e) => e.default),
	en: () => import("./intlayer-ResultsTable-qpt6kk-en-D_654PCk.js").then((e) => e.t).then((e) => e.default),
	es: () => import("./intlayer-ResultsTable-qpt6kk-es-BAIrQwfR.js").then((e) => e.t).then((e) => e.default),
	fr: () => import("./intlayer-ResultsTable-qpt6kk-fr-eW7ZMklw.js").then((e) => e.t).then((e) => e.default),
	it: () => import("./intlayer-ResultsTable-qpt6kk-it-CoosP-A7.js").then((e) => e.t).then((e) => e.default),
	ja: () => import("./intlayer-ResultsTable-qpt6kk-ja-BcnWiwtl.js").then((e) => e.t).then((e) => e.default),
	ko: () => import("./intlayer-ResultsTable-qpt6kk-ko-DgZv39Yx.js").then((e) => e.t).then((e) => e.default),
	pt: () => import("./intlayer-ResultsTable-qpt6kk-pt-CzC7cn0A.js").then((e) => e.t).then((e) => e.default),
	ru: () => import("./intlayer-ResultsTable-qpt6kk-ru-CP-wQ9nI.js").then((e) => e.t).then((e) => e.default),
	zh: () => import("./intlayer-ResultsTable-qpt6kk-zh-DE_zSSs9.js").then((e) => e.t).then((e) => e.default)
}, S = le(), C = x[S];
...
var Ae = P, K = /* @__PURE__ */ new Map(), je = (e, t = !0) => {
	...
	return K.set(n, r), r;
}, Me = (e, t) => we(e, t, je(typeof t == "object" && t ? t.locale : t)), Ne = oe, q = i({
...
}, We = n("<section><h2 class=\"mb-6 text-2xl font-bold text-foreground\"></h2><div class=\"overflow-x-auto rounded-lg border border-border\"><table class=\"w-full text-sm\"><thead class=bg-muted><tr><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th></tr></thead><tbody>"), Ge = n("<tr class=\"border-t border-border\"><td class=\"px-4 py-3 font-medium text-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\">");
function Ke() {
	let n = Ue(x, "results-table"), i = () => [
		{
			lib: "react-i18next",
			size: "42.3 kB",
			time: "0.12ms",
	...
	return (() => {
		var a = We(), o = a.firstChild, s = o.nextSibling.firstChild.firstChild, c = s.firstChild.firstChild, l = c.nextSibling, u = l.nextSibling, d = u.nextSibling, f = s.nextSibling;
