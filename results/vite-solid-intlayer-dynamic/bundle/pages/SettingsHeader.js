...
var content$1 = {
	"de": () => import("./intlayer-SettingsHeader-chfb2k-de-Cc4vaS5x.js").then((n) => n.t).then((m) => m.default),
	"en": () => import("./intlayer-SettingsHeader-chfb2k-en-qfevcw9K.js").then((n) => n.t).then((m) => m.default),
	"es": () => import("./intlayer-SettingsHeader-chfb2k-es-Ddrtfl3b.js").then((n) => n.t).then((m) => m.default),
	"fr": () => import("./intlayer-SettingsHeader-chfb2k-fr-CTkDCiCx.js").then((n) => n.t).then((m) => m.default),
	"it": () => import("./intlayer-SettingsHeader-chfb2k-it-sto0n1Wa.js").then((n) => n.t).then((m) => m.default),
	"ja": () => import("./intlayer-SettingsHeader-chfb2k-ja-DgZlQPOq.js").then((n) => n.t).then((m) => m.default),
	"ko": () => import("./intlayer-SettingsHeader-chfb2k-ko-CcbGg_iL.js").then((n) => n.t).then((m) => m.default),
	"pt": () => import("./intlayer-SettingsHeader-chfb2k-pt-DlPfarvS.js").then((n) => n.t).then((m) => m.default),
	"ru": () => import("./intlayer-SettingsHeader-chfb2k-ru-B-uNunlf.js").then((n) => n.t).then((m) => m.default),
	"zh": () => import("./intlayer-SettingsHeader-chfb2k-zh-BBPdrrMV.js").then((n) => n.t).then((m) => m.default)
};
...
var content = {
	"de": () => import("./intlayer-SettingsHeader-chfb2k-de-Cc4vaS5x.js").then((n) => n.n).then((m) => m.default),
	"en": () => import("./intlayer-SettingsHeader-chfb2k-en-qfevcw9K.js").then((n) => n.n).then((m) => m.default),
	"es": () => import("./intlayer-SettingsHeader-chfb2k-es-Ddrtfl3b.js").then((n) => n.n).then((m) => m.default),
	"fr": () => import("./intlayer-SettingsHeader-chfb2k-fr-CTkDCiCx.js").then((n) => n.n).then((m) => m.default),
	"it": () => import("./intlayer-SettingsHeader-chfb2k-it-sto0n1Wa.js").then((n) => n.n).then((m) => m.default),
	"ja": () => import("./intlayer-SettingsHeader-chfb2k-ja-DgZlQPOq.js").then((n) => n.n).then((m) => m.default),
	"ko": () => import("./intlayer-SettingsHeader-chfb2k-ko-CcbGg_iL.js").then((n) => n.n).then((m) => m.default),
	"pt": () => import("./intlayer-SettingsHeader-chfb2k-pt-DlPfarvS.js").then((n) => n.n).then((m) => m.default),
	"ru": () => import("./intlayer-SettingsHeader-chfb2k-ru-B-uNunlf.js").then((n) => n.n).then((m) => m.default),
	"zh": () => import("./intlayer-SettingsHeader-chfb2k-zh-BBPdrrMV.js").then((n) => n.n).then((m) => m.default)
};
...
function SettingsHeader() {
	const content = _(content$1, "settings-header");
	return [
		createComponent(MockBanner, {}),
		(() => {
			var _el$ = _tmpl$();
			insert(_el$, () => content().b);
			return _el$;
		})(),
		(() => {
			var _el$2 = _tmpl$2();
			insert(_el$2, () => content().a);
			return _el$2;
		})()
	];
}
...
var key$1 = "mock-banner";
var content$1 = { "a": "⚠️ Diese Seite enthält Mock-Daten nur zu Benchmarking-Zwecken. Sie steht in keinem Zusammenhang mit einem echten Unternehmen oder einer echten Dienstleistung." };
var de_default$1 = {
	key: key$1,
	content: content$1
};
...
var key$1 = "mock-banner";
var content$1 = { "a": "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." };
var en_default$1 = {
	key: key$1,
	content: content$1
};
...
var key$1 = "mock-banner";
var content$1 = { "a": "⚠️ Esta página contiene datos de prueba solo para fines de benchmarking. No está relacionada con ninguna empresa o servicio real." };
var es_default$1 = {
	key: key$1,
	content: content$1
};
...
var key$1 = "mock-banner";
var content$1 = { "a": "⚠️ Cette page contient des données factices à des fins de benchmarking uniquement. Elle n'est liée à aucune entreprise ou service réel." };
var fr_default$1 = {
	key: key$1,
	content: content$1
};
...
var key$1 = "mock-banner";
var content$1 = { "a": "⚠️ Questa pagina contiene dati fittizi solo a scopo di benchmarking. Non è correlata ad alcuna attività o servizio reale." };
var it_default$1 = {
	key: key$1,
	content: content$1
};
...
var key$1 = "mock-banner";
var content$1 = { "a": "⚠️ このページにはベンチマーク目的のモックデータのみが含まれています。実際のビジネスやサービスとは関係ありません。" };
var ja_default$1 = {
	key: key$1,
	content: content$1
};
...
var key$1 = "mock-banner";
var content$1 = { "a": "⚠️ 이 페이지에는 벤치마킹 목적의 모의 데이터만 포함되어 있습니다. 실제 비즈니스나 서비스와는 관련이 없습니다." };
var ko_default$1 = {
	key: key$1,
	content: content$1
};
...
var key$1 = "mock-banner";
var content$1 = { "a": "⚠️ Esta página contém dados fictícios apenas para fins de benchmarking. Não está relacionada a nenhum negócio ou serviço real." };
var pt_default$1 = {
	key: key$1,
	content: content$1
};
...
var key$1 = "mock-banner";
var content$1 = { "a": "⚠️ Эта страница содержит мок-данные только для целей бенчмаркинга. Она не связана с каким-либо реальным бизнесом или услугой." };
var ru_default$1 = {
	key: key$1,
	content: content$1
};
...
var key$1 = "mock-banner";
var content$1 = { "a": "⚠️ 本页面包含仅用于基准测试目的的模拟数据。它与任何真实的业务 or 服务无关。" };
var zh_default$1 = {
	key: key$1,
	content: content$1
};
