...
var s = {
	de: () => import("./de-BJr9fiRz.js").then((e) => e.default),
	en: () => import("./en-DWc_yTmF.js").then((e) => e.default),
	es: () => import("./es-DqqX6W0f.js").then((e) => e.default),
	fr: () => import("./fr-CV4mXhrw.js").then((e) => e.default),
	it: () => import("./it-DWxeOJyw.js").then((e) => e.default),
	ja: () => import("./ja-FLx6_NWT.js").then((e) => e.default),
	ko: () => import("./ko-Bc1fmqlf.js").then((e) => e.default),
	pt: () => import("./pt-C5hCJs1_.js").then((e) => e.default),
	ru: () => import("./ru-Bb2BHjVN.js").then((e) => e.default),
	zh: () => import("./zh-BlbvZunx.js").then((e) => e.default)
...
var Z = r("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), Q = r("<p class=\"mb-8 text-muted-foreground\">");
function $() {
	let e = q(s, "settings-header");
	return [
		t(X, {}),
		(() => {
			var t = Z();
			return n(t, () => e().settings), t;
		})(),
		(() => {
			var t = Q();
			return n(t, () => e().manageYourAccountPreferencesAnd), t;
		})()
	];
}
export { $ as default };
