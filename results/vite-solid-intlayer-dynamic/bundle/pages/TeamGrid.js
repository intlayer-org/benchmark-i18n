...
var content = {
	"de": () => import("./intlayer-TeamGrid-kfg1o5-de-nFLV0Vdv.js").then((n) => n.t).then((m) => m.default),
	"en": () => import("./intlayer-TeamGrid-kfg1o5-en-CxoYejU2.js").then((n) => n.t).then((m) => m.default),
	"es": () => import("./intlayer-TeamGrid-kfg1o5-es-D2VdC6CF.js").then((n) => n.t).then((m) => m.default),
	"fr": () => import("./intlayer-TeamGrid-kfg1o5-fr-XEBkE5Hd.js").then((n) => n.t).then((m) => m.default),
	"it": () => import("./intlayer-TeamGrid-kfg1o5-it-D372OSAN.js").then((n) => n.t).then((m) => m.default),
	"ja": () => import("./intlayer-TeamGrid-kfg1o5-ja-DMjGXunT.js").then((n) => n.t).then((m) => m.default),
	"ko": () => import("./intlayer-TeamGrid-kfg1o5-ko-CZmTmDHA.js").then((n) => n.t).then((m) => m.default),
	"pt": () => import("./intlayer-TeamGrid-kfg1o5-pt-B81jJQHg.js").then((n) => n.t).then((m) => m.default),
	"ru": () => import("./intlayer-TeamGrid-kfg1o5-ru-DIcfm4Ec.js").then((n) => n.t).then((m) => m.default),
	"zh": () => import("./intlayer-TeamGrid-kfg1o5-zh-cLJbC-s6.js").then((n) => n.t).then((m) => m.default)
};
...
function TeamGrid() {
	const content$1 = _(content, "team-grid");
	const members = () => [
		{
			name: content$1().o.value,
			role: content$1().h.value,
			bio: content$1().g.value
		},
		{
			name: content$1().l.value,
			role: content$1().n.value,
			bio: content$1().p.value
		},
		{
			name: content$1().a.value,
			role: content$1().d.value,
			bio: content$1().m.value
		},
		{
			name: content$1().q.value,
			role: content$1().i.value,
			bio: content$1().j.value
		},
		{
			name: content$1().r.value,
			role: content$1().c.value,
			bio: content$1().f.value
		},
		{
