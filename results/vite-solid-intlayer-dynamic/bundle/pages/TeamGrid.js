...
var content = {
	"de": () => import("./de-LvNamR8_.js").then((m) => m.default),
	"en": () => import("./en-lR1Yni06.js").then((m) => m.default),
	"es": () => import("./es-CTtKUABr.js").then((m) => m.default),
	"fr": () => import("./fr-rZZCRUYu.js").then((m) => m.default),
	"it": () => import("./it-DHgs9jKq.js").then((m) => m.default),
	"ja": () => import("./ja-C_NlSz8f.js").then((m) => m.default),
	"ko": () => import("./ko-RdRjOPf1.js").then((m) => m.default),
	"pt": () => import("./pt-Bp0ywc3l.js").then((m) => m.default),
	"ru": () => import("./ru-CsC5xVmG.js").then((m) => m.default),
	"zh": () => import("./zh-B9NqTyLw.js").then((m) => m.default)
};
