...
var content = {
	"de": () => import("./intlayer-UnderstandingImpact-15m87b-de-Bw1ljcVb.js").then((n) => n.t).then((m) => m.default),
	"en": () => import("./intlayer-UnderstandingImpact-15m87b-en-CsQzPAUl.js").then((n) => n.t).then((m) => m.default),
	"es": () => import("./intlayer-UnderstandingImpact-15m87b-es-BINI15gq.js").then((n) => n.t).then((m) => m.default),
	"fr": () => import("./intlayer-UnderstandingImpact-15m87b-fr-KlALhvEC.js").then((n) => n.t).then((m) => m.default),
	"it": () => import("./intlayer-UnderstandingImpact-15m87b-it-BL-_qhYG.js").then((n) => n.t).then((m) => m.default),
	"ja": () => import("./intlayer-UnderstandingImpact-15m87b-ja-ru4t7YfC.js").then((n) => n.t).then((m) => m.default),
	"ko": () => import("./intlayer-UnderstandingImpact-15m87b-ko-DeyRl1BH.js").then((n) => n.t).then((m) => m.default),
	"pt": () => import("./intlayer-UnderstandingImpact-15m87b-pt-BAMhLfd9.js").then((n) => n.t).then((m) => m.default),
	"ru": () => import("./intlayer-UnderstandingImpact-15m87b-ru-_eImMHa2.js").then((n) => n.t).then((m) => m.default),
	"zh": () => import("./intlayer-UnderstandingImpact-15m87b-zh-C3_vloER.js").then((n) => n.t).then((m) => m.default)
};
...
function UnderstandingImpact() {
	const content$1 = _(content, "understanding-impact");
	return (() => {
		...
		insert(_el$2, () => content$1().k);
		insert(_el$4, () => content$1().p);
		insert(_el$5, () => content$1().e);
		insert(_el$7, () => content$1().h);
		insert(_el$8, () => content$1().b);
		insert(_el$9, () => content$1().c);
		insert(_el$1, () => content$1().i);
		insert(_el$10, () => content$1().f);
		insert(_el$13, () => content$1().n);
		insert(_el$12, () => content$1().g, null);
		insert(_el$15, () => content$1().d);
		insert(_el$14, () => content$1().m, null);
		insert(_el$18, () => content$1().a);
		insert(_el$17, () => content$1().l, null);
		insert(_el$20, () => content$1().o);
		insert(_el$21, () => content$1().j);
		return _el$;
	})();
}
