...
function ProductsGrid() {
	...
	const products = [
		{
			name: content$1().benchmarkCli.value,
			desc: content$1().runBenchmarksLocallyFromYour.value,
			price: content$1().free.value
		},
		{
			name: content$1().benchmarkCloud.value,
			desc: content$1().automatedCloudBasedBenchmarkingWith.value,
			price: "$29/mo"
		},
		{
			name: content$1().benchmarkEnterprise.value,
			desc: content$1().onPremiseDeploymentWithSso.value,
			price: content$1().contactUs.value
		},
		{
			name: content$1().migrationAssistant.value,
			desc: content$1().aiPoweredToolThatHelps.value,
			price: "$99 one-time"
		},
		{
			name: content$1().translationQa.value,
			desc: content$1().automatedQualityChecksForMissing.value,
			price: "$19/mo"
		},
		{
			name: content$1().bundleOptimizer.value,
			desc: content$1().analyzesAndOptimizesYourI18n.value,
			price: "$49/mo"
		}
	];
	return (() => {
		...
		insert(_el$, createComponent(For, {
			...
			children: (p) => (() => {
				...
				insert(_el$8, () => content$1().learnMore);
				return _el$2;
			})()
		}));
		return _el$;
