...
var content = {
	"de": () => import("./intlayer-ApiAccessSection-14l2p6-de-xqxGRD6z.js").then((n) => n.t).then((m) => m.default),
	"en": () => import("./intlayer-ApiAccessSection-14l2p6-en-Dt-im8ZP.js").then((n) => n.t).then((m) => m.default),
	"es": () => import("./intlayer-ApiAccessSection-14l2p6-es-CrHpsvQr.js").then((n) => n.t).then((m) => m.default),
	"fr": () => import("./intlayer-ApiAccessSection-14l2p6-fr-Nsuz1TEG.js").then((n) => n.t).then((m) => m.default),
	"it": () => import("./intlayer-ApiAccessSection-14l2p6-it-B3Fr87X5.js").then((n) => n.t).then((m) => m.default),
	"ja": () => import("./intlayer-ApiAccessSection-14l2p6-ja-BtWn7HT7.js").then((n) => n.t).then((m) => m.default),
	"ko": () => import("./intlayer-ApiAccessSection-14l2p6-ko-B51d-x6R.js").then((n) => n.t).then((m) => m.default),
	"pt": () => import("./intlayer-ApiAccessSection-14l2p6-pt-B-z3hOCn.js").then((n) => n.t).then((m) => m.default),
	"ru": () => import("./intlayer-ApiAccessSection-14l2p6-ru-C0ZqP5iP.js").then((n) => n.t).then((m) => m.default),
	"zh": () => import("./intlayer-ApiAccessSection-14l2p6-zh-CkaGaXGb.js").then((n) => n.t).then((m) => m.default)
};
...
function ApiAccessSection() {
	const content$1 = _(content, "api-access-section");
