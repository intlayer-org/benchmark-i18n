...
var h = {
	...
	de: () => import("./intlayer-TeamHeader-u08g3c-de-Bx0gkJyD.js").then((e) => e.t).then((e) => e.default),
	en: () => import("./intlayer-TeamHeader-u08g3c-en-Cgz1ewi1.js").then((e) => e.t).then((e) => e.default),
	es: () => import("./intlayer-TeamHeader-u08g3c-es-DcvWdyYM.js").then((e) => e.t).then((e) => e.default),
	fr: () => import("./intlayer-TeamHeader-u08g3c-fr-YtG1G-EH.js").then((e) => e.t).then((e) => e.default),
	it: () => import("./intlayer-TeamHeader-u08g3c-it-B_GrsbVf.js").then((e) => e.t).then((e) => e.default),
	ja: () => import("./intlayer-TeamHeader-u08g3c-ja-CYTyzn9n.js").then((e) => e.t).then((e) => e.default),
	ko: () => import("./intlayer-TeamHeader-u08g3c-ko-Bx0TsQDb.js").then((e) => e.t).then((e) => e.default),
	pt: () => import("./intlayer-TeamHeader-u08g3c-pt-DRCYknSg.js").then((e) => e.t).then((e) => e.default),
	ru: () => import("./intlayer-TeamHeader-u08g3c-ru-DeUmzMQK.js").then((e) => e.t).then((e) => e.default),
	zh: () => import("./intlayer-TeamHeader-u08g3c-zh-Vl39iLtT.js").then((e) => e.t).then((e) => e.default)
}, le = b(), S = x[le];
...
var Ae = N, G = /* @__PURE__ */ new Map(), je = (e, t = !0) => {
	...
	de: () => import("./intlayer-TeamHeader-u08g3c-de-Bx0gkJyD.js").then((e) => e.n).then((e) => e.default),
	en: () => import("./intlayer-TeamHeader-u08g3c-en-Cgz1ewi1.js").then((e) => e.n).then((e) => e.default),
	es: () => import("./intlayer-TeamHeader-u08g3c-es-DcvWdyYM.js").then((e) => e.n).then((e) => e.default),
	fr: () => import("./intlayer-TeamHeader-u08g3c-fr-YtG1G-EH.js").then((e) => e.n).then((e) => e.default),
	it: () => import("./intlayer-TeamHeader-u08g3c-it-B_GrsbVf.js").then((e) => e.n).then((e) => e.default),
	ja: () => import("./intlayer-TeamHeader-u08g3c-ja-CYTyzn9n.js").then((e) => e.n).then((e) => e.default),
	ko: () => import("./intlayer-TeamHeader-u08g3c-ko-Bx0TsQDb.js").then((e) => e.n).then((e) => e.default),
	pt: () => import("./intlayer-TeamHeader-u08g3c-pt-DRCYknSg.js").then((e) => e.n).then((e) => e.default),
	ru: () => import("./intlayer-TeamHeader-u08g3c-ru-DeUmzMQK.js").then((e) => e.n).then((e) => e.default),
	zh: () => import("./intlayer-TeamHeader-u08g3c-zh-Vl39iLtT.js").then((e) => e.n).then((e) => e.default)
}, We = b(), Ge = $[We];
