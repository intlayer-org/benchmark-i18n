...
import { Suspense, createContext, createEffect, createMemo, createSignal, on, onMount, untrack, useContext } from "solid-js";
...
var t = (n) => {
	...
	return k.set(n, r), r;
}, n = (n, r) => getDictionary(n, r, A(r)), a = getLocaleFromStorageClient(localeStorageOptions), s = (e, n) => setLocaleInStorageClient(e, {
