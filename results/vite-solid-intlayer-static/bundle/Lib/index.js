...
import { Suspense, createContext, createEffect, createMemo, createSignal, lazy, on, onCleanup, onMount, untrack, useContext } from "solid-js";
...
}, n$2 = (n, r) => getIntlayer(n, r, I$1(r)), a = getLocaleFromStorageClient(localeStorageOptions), s = (e, n) => setLocaleInStorageClient(e, {
	...localeStorageOptions,
	isCookieEnabled: n
}), w = process.env.INTLAYER_EDITOR_ENABLED === "false", T = () => {
	if (w || !isEnabled) return;
	let { locale: e } = O(), [t, n] = createSignal(null);
	onMount(() => {
		import("./esm-BDnjE-DT.js").then(({ initEditorClient: e }) => {
			n(e());
		});
	}), createEffect(() => {
		let n = t(), r = e();
		...
		import("./esm-BDnjE-DT.js").then(({ stopEditorClient: e }) => {
			e();
		});
	});
}, E = ({ children: e }) => (T(), e), D = createContext({
