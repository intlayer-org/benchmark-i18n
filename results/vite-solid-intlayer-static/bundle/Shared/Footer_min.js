...
import { Suspense as y, createContext as b, createMemo as x, lazy as S, useContext as C } from "solid-js";
import { A as w, useParams as T } from "@solidjs/router";
var E = {
	key: "footer",
	content: {
		...
		translation: {
			en: {
				...
				contact: "Contact",
				i18nBenchmarkOpenSourceProject: "i18n Benchmark — Open-source project. Built with Solid, Vite & Solid Router."
			},
			fr: {
				...
				contact: "Contact",
				i18nBenchmarkOpenSourceProject: "i18n Benchmark — Projet open source. Construit avec Solid, Vite & Solid Router."
			},
			es: {
				...
				contact: "Contacto",
				i18nBenchmarkOpenSourceProject: "i18n Benchmark — Proyecto de código abierto. Construido con Solid, Vite y Solid Router."
			},
			de: {
				anOpenSourceTestApplication: "Eine Open-Source-Testanwendung zur Messung der realen Auswirkungen von Internationalisierungsbibliotheken auf Bundle-Größe, Ladezeit und App-Reaktivität.",
				resources: "Ressourcen",
				methodology: "Methodik",
				contributing: "Beitragen",
				contact: "Kontakt",
				i18nBenchmarkOpenSourceProject: "i18n Benchmark — Open-Source-Projekt. Erstellt mit Solid, Vite & Solid Router."
			},
			it: {
				anOpenSourceTestApplication: "Un'applicazione di test open source per misurare l'impatto reale delle librerie di internazionalizzazione sulle dimensioni del bundle, sui tempi di caricamento e sulla reattività dell'app.",
				resources: "Risorse",
				methodology: "Metodologia",
				contributing: "Contribuire",
				contact: "Contatti",
				i18nBenchmarkOpenSourceProject: "i18n Benchmark — Progetto open source. Creato con Solid, Vite & Solid Router."
			},
			pt: {
				anOpenSourceTestApplication: "Uma aplicação de teste de código aberto para medir o impacto real das bibliotecas de internacionalização no tamanho do bundle, no tempo de carregamento e na reatividade da aplicação.",
				resources: "Recursos",
				methodology: "Metodologia",
				contributing: "Contribuindo",
				contact: "Contato",
				i18nBenchmarkOpenSourceProject: "i18n Benchmark — Projeto de código aberto. Construído com Solid, Vite & Solid Router."
			},
			zh: {
				...
				contributing: "贡献",
				contact: "联系我们",
				i18nBenchmarkOpenSourceProject: "i18n Benchmark — 开源项目。使用 Solid、Vite 和 Solid Router 构建。"
			},
			ja: {
				...
				contributing: "貢献する",
				contact: "お問い合わせ",
				i18nBenchmarkOpenSourceProject: "i18n Benchmark — オープンソースプロジェクト。Solid、Vite、Solid Routerで構築されています。"
			},
			ko: {
				anOpenSourceTestApplication: "번들 크기, 로딩 시간 및 앱 반응성에 대한 국제화 라이브러리의 실제 영향을 측정하기 위한 오픈 소스 테스트 애플ри케이션입니다.",
				resources: "리소스",
				methodology: "방법론",
				contributing: "기여",
				contact: "문의",
				i18nBenchmarkOpenSourceProject: "i18n Benchmark — 오픈 소스 프로젝트. Solid, Vite 및 Solid Router로 제작되었습니다."
			},
			ru: {
				...
				contributing: "Вклад",
				contact: "Контакт",
				i18nBenchmarkOpenSourceProject: "i18n Benchmark — проект с открытым исходным кодом. Построен на Solid, Vite и Solid Router."
			}
		}
	},
...
}, k = "\x1B[0m", A = "\x1B[34m", j = "\x1B[31m", te = "\x1B[32m", M = (e, t, n) => t ? `${t}${e}${n ? typeof n == "boolean" ? k : n : k}` : e;
M("✗", j), M("✓", te), M("⏲", A);
var ne = (e = "") => new Proxy(() => e, {
	get: (t, n) => {
		if (n === "toJSON" || n === Symbol.toPrimitive || n === "toString") return () => e;
		if (n !== "then") return n === Symbol.iterator ? function* () {
			yield e;
		} : ne(e ? `${e}.${String(n)}` : String(n));
	},
	apply: () => e
}), N = (e, t, n = d(t)) => {
	let r = {
...
}, L = process.env.INTLAYER_NODE_TYPE_INTLAYER_NODE === "false", R = process.env.INTLAYER_NODE_TYPE_SOLID_NODE === "false", z = !0, B = !0, V = !0, H = !0, U = null, W = null, G = null, K = null, q = null;
H || (U = S(() => import("./ContentSelector--hRpRV2o.js").then((e) => ({ default: e.ContentSelector })))), z || (W = S(() => import("./MarkdownRenderer-B7hyvLDf.js").then((e) => ({ default: e.MarkdownMetadataRenderer }))), G = S(() => import("./MarkdownRenderer-B7hyvLDf.js").then((e) => ({ default: e.MarkdownRenderer }))), import("./markdown-Cvh9lBUG.js").then((e) => {
	q = e.getMarkdownMetadata;
})), B || (K = S(() => import("./HTMLRenderer-C-wPH0rg.js").then((e) => ({ default: e.HTMLRenderer }))));
var J = L ? e : {
	id: "intlayer-node-plugin",
	canHandle: (e) => typeof e == "bigint" || typeof e == "string" || typeof e == "number",
	transform: (e, { plugins: t, ...r }) => D({
		...r,
		value: r.children,
		children: !H && n.enabled ? h(y, {
			get fallback() {
				return r.children;
			},
			get children() {
				return h(U, _(r, { get children() {
					return r.children;
				} }));
			}
		}) : r.children
	...
	transform: (e, { plugins: t, ...r }) => D({
		...
		children: !H && n.enabled ? h(y, {
			get fallback() {
				return typeof Node < "u" && e instanceof Node ? e : O(e);
			},
			get children() {
				return h(U, _(r, { get children() {
					return typeof Node < "u" && e instanceof Node ? e : O(e);
		...
		}) : typeof Node < "u" && e instanceof Node ? e : O(e)
	})
}, Y = (e, t) => {
	let n = I(e, t);
		...
		let { plugins: i, ...a } = t, o = r(q?.(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => D({
					...r,
					value: t,
					children: !H && n.enabled ? h(ContentSelector, _(a, { get children() {
						return h(y, {
							fallback: e,
							get children() {
								return h(W, _(a, {
	...
	transform: (e, t) => {
		let r = e[ee], { plugins: i, ...a } = t, o = (e) => D({
			...a,
			value: r,
			children: !H && n.enabled ? h(y, {
				fallback: r,
	...
	return Z.set(r, o), o;
}, Q = (e, t) => N(e, t, se(t)), ce = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false";
...
function ge() {
	...
	return (() => {
		...
		})), g(u, () => e().contact), g(d, () => e().i18nBenchmarkOpenSourceProject), t;
	})();
}
