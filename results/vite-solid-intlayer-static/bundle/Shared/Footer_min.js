...
import { Suspense as b, createContext as x, createMemo as ee, lazy as S, useContext as C } from "solid-js";
import { A as w, useParams as T } from "@solidjs/router";
var E = process.env.INTLAYER_EDITOR_ENABLED !== "false" && n?.enabled && typeof window < "u" && window.self !== window.top, D = process.env.INTLAYER_EDITOR_ENABLED === "false", O = (e) => D || !E ? e.children : g(h, {
...
}, te = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", j = /\{\{\s*(.*?)\s*\}\}/g, M = (e, t = {}) => {
		...
		let { plugins: i, ...a } = t, o = r(m(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => k({
					...r,
					value: t,
					children: !R && n.enabled ? g(O, v(a, { get children() {
						return g(b, {
							fallback: e,
							get children() {
								return g(z, v(a, {
...
function de() {
	...
	return (() => {
		...
		})), _(u, () => e().contact), _(d, () => e().i18nBenchmarkOpenSourceProject), t;
	})();
}
