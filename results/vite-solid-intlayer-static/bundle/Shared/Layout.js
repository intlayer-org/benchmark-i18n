...
import { For, Suspense, createContext, createEffect, createMemo, createSignal, lazy, on, onCleanup, onMount, untrack, useContext } from "solid-js";
...
}, A$1 = (e) => createComponent(k, mergeProps(e, { get children() {
