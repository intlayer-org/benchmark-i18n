...
import { Suspense as y, createContext as b, createMemo as te, lazy as x, useContext as S } from "solid-js";
var C = {
	key: "mock-banner",
	content: {
...
var se = (e = $) => {
	...
	let n = S(le) ?? {};
	return te(() => ae(e, t ?? n?.locale?.()));
}, { defaultLocale: de, locales: fe } = c, pe = v("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\">");
function me() {
	let e = ue(C);
	return (() => {
		var t = pe();
