...
import { Dynamic, createComponent, delegateEvents, effect, insert, mergeProps, setAttribute, template } from "solid-js/web";
import { Suspense, createContext, createEffect, createMemo, createSignal, lazy, onMount, useContext } from "solid-js";
...
function ThemeToggle() {
	const content = M(theme_toggle_default);
