import { a as e, c as t, f as n, h as r, i, l as a, n as o, o as s, p as c, r as l, s as u, t as ee } from "./getContent-C3Acg06C.js";
import { a as d, o as f, s as p } from "./nodeType-C3vWW1Sy.js";
...
var ie = {
	...
	content: {
		...
		translation: {
			...
			de: {
				themeModeAutoSystemClick: "Design-Modus: Auto (System). Klicken Sie hier, um in den hellen Modus zu wechseln.",
				themeAuto: "Design: Auto",
				themeDark: "Design: Dunkel",
				themeLight: "Design: Hell"
			},
			it: {
				themeModeAutoSystemClick: "Modalità tema: auto (sistema). Fai clic per passare alla modalità chiara.",
				themeAuto: "Tema: Auto",
			...
			ru: {
				themeModeAutoSystemClick: "Режим темы: авто (системный). Нажмите, чтобы перейти в светлую тему.",
				themeAuto: "Тема: Авто",
...
}, k = "\x1B[0m", A = "\x1B[34m", j = "\x1B[31m", M = "\x1B[32m", N = (e, t, n) => t ? `${t}${e}${n ? typeof n == "boolean" ? k : n : k}` : e;
N("✗", j), N("✓", M), N("⏲", A);
var P = (e = "") => new Proxy(() => e, {
	get: (t, n) => {
...
}, z = process.env.INTLAYER_NODE_TYPE_INTLAYER_NODE === "false", B = process.env.INTLAYER_NODE_TYPE_SOLID_NODE === "false", V = !0, H = !0, U = !0, W = !0, G = null, K = null, q = null, J = null, Y = null;
W || (G = E(() => import("./ContentSelector--hRpRV2o.js").then((e) => ({ default: e.ContentSelector })))), V || (K = E(() => import("./MarkdownRenderer-B7hyvLDf.js").then((e) => ({ default: e.MarkdownMetadataRenderer }))), q = E(() => import("./MarkdownRenderer-B7hyvLDf.js").then((e) => ({ default: e.MarkdownRenderer }))), import("./markdown-Cvh9lBUG.js").then((e) => {
	Y = e.getMarkdownMetadata;
})), H || (J = E(() => import("./HTMLRenderer-C-wPH0rg.js").then((e) => ({ default: e.HTMLRenderer }))));
var ae = z ? e : {
	...
	transform: (e, { plugins: t, ...r }) => D({
		...r,
		value: r.children,
		children: !W && n.enabled ? h(S, {
			get fallback() {
				return r.children;
			},
			get children() {
				return h(G, y(r, { get children() {
					return r.children;
				} }));
			}
		}) : r.children
		...
		let { plugins: i, ...a } = t, o = r(Y?.(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => D({
					...r,
					value: t,
					children: !W && n.enabled ? h(ContentSelector, y(a, { get children() {
						return h(S, {
							fallback: e,
							get children() {
								return h(K, y(a, {
	...
	return X.set(r, o), o;
}, pe = (e, t) => F(e, t, fe(t)), me = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false";
process.env.INTLAYER_ROUTING_STORAGE_HEADERS;
var he = (e = Z) => {
	let { locales: t } = c;
	if (e?.isCookieEnabled === !1) return;
	let n = (e) => !!e && t.includes(e);
	if (!me) for (let t = 0; t < (r.storage.cookies ?? []).length; t++) try {
	...
	locale: () => ge ?? c?.defaultLocale,
	setLocale: () => null
}), Q = (e, t) => {
	let n = re(_e) ?? {};
	return T(() => pe(e, t ?? n?.locale?.()));
}, { defaultLocale: ve, locales: ye } = c, be = x("<button type=button class=\"rounded-md border border-border bg-accent px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-accent/80\">");
function xe() {
