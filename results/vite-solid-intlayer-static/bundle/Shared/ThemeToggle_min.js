...
import { a as r, c as i, f as a, i as o, l as s, o as c, s as l, u } from "./getDictionary-BTlZiT1o.js";
import { c as d, o as ee, s as f } from "./nodeType-CG6hvPHO.js";
import { n as p } from "./markdown-BZysCahS.js";
import { Dynamic as m, createComponent as h, delegateEvents as g, effect as _, insert as v, mergeProps as y, setAttribute as b, template as x } from "solid-js/web";
import { Suspense as S, createContext as C, createEffect as w, createMemo as T, createSignal as te, lazy as E, onMount as ne, useContext as re } from "solid-js";
var ie = process.env.INTLAYER_EDITOR_ENABLED !== "false" && n?.enabled && typeof window < "u" && window.self !== window.top, D = process.env.INTLAYER_EDITOR_ENABLED === "false", O = (e) => D || !ie ? e.children : h(m, {
...
}), k = ({ children: e, value: t, additionalProps: n }) => {
	let r = [e];
...
}, P = process.env.INTLAYER_NODE_TYPE_INTLAYER_NODE === "false", F = process.env.INTLAYER_NODE_TYPE_SOLID_NODE === "false", I = process.env.INTLAYER_NODE_TYPE_MARKDOWN === "false", L = process.env.INTLAYER_NODE_TYPE_HTML === "false", R = process.env.INTLAYER_NODE_TYPE_INSERTION === "false", z = process.env.INTLAYER_EDITOR_ENABLED === "false", B = I ? null : E(() => import("./MarkdownRenderer-iWMAOT1d.js").then((e) => ({ default: e.MarkdownMetadataRenderer }))), V = I ? null : E(() => import("./MarkdownRenderer-iWMAOT1d.js").then((e) => ({ default: e.MarkdownRenderer }))), H = L ? null : E(() => import("./HTMLRenderer-_RkJwpIh.js").then((e) => ({ default: e.HTMLRenderer }))), U = P ? c : {
	id: "intlayer-node-plugin",
	canHandle: (e) => typeof e == "bigint" || typeof e == "string" || typeof e == "number",
	transform: (e, { plugins: t, ...r }) => k({
		...r,
		value: r.children,
		children: !z && n.enabled ? h(O, y(r, { get children() {
			return r.children;
		} })) : r.children
	})
}, W = F ? c : {
	...
	transform: (e, { plugins: t, ...r }) => k({
		...
		value: "[[solid-element]]",
		children: !z && n.enabled ? h(O, y(r, { get children() {
			return typeof Node < "u" && e instanceof Node ? e : A(e);
		} })) : typeof Node < "u" && e instanceof Node ? e : A(e)
	})
}, G = (e, t) => {
	let n = N(e, t);
		...
		let { plugins: i, ...a } = t, o = r(p(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => k({
					...r,
					value: t,
					children: !z && n.enabled ? h(O, y(a, { get children() {
						return h(S, {
							fallback: e,
							get children() {
								return h(B, y(a, {
	...
	transform: (e, t) => {
		let r = e[ee], { plugins: i, ...a } = t, o = (e) => k({
			...a,
			value: r,
			children: !z && n.enabled ? h(O, y(a, { get children() {
				return h(S, {
...
}, X = /* @__PURE__ */ new Map(), ae = (t, n = !0) => {
	let a = `${t ?? e.defaultLocale}_${n}`;
	if (X.has(a)) return X.get(a);
	let c = [
		u(t ?? e.defaultLocale, n ? e.defaultLocale : void 0),
		r,
		o,
		s(t ?? e.defaultLocale),
		l,
...
var se = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false", ce = process.env.INTLAYER_ROUTING_STORAGE_LOCALSTORAGE === "false", le = process.env.INTLAYER_ROUTING_STORAGE_SESSIONSTORAGE === "false";
process.env.INTLAYER_ROUTING_STORAGE_HEADERS;
var ue = (n = Z) => {
	let { locales: r } = e;
	if (n?.isCookieEnabled === !1) return;
	let i = (e) => !!e && r.includes(e);
	if (!se) for (let e = 0; e < (t.storage.cookies ?? []).length; e++) try {
		let r = n?.getCookie?.(t.storage.cookies[e].name);
		if (i(r)) return r;
	} catch {}
	if (!ce) for (let e = 0; e < (t.storage.localStorage ?? []).length; e++) try {
		let r = n?.getLocaleStorage?.(t.storage.localStorage[e].name);
		if (i(r)) return r;
	} catch {}
	if (!le && t.storage.sessionStorage) for (let e = 0; e < t.storage.sessionStorage.length; e++) try {
...
}, { defaultLocale: pe, locales: me } = e, he = x("<button type=button class=\"rounded-md border border-border bg-accent px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-accent/80\">");
function ge() {
...
function _e() {
	let e = fe("theme-toggle"), [t, n] = te("auto");
	ne(() => {
		let e = ge();
		n(e), $(e);
	}), w(() => {
	...
	let i = () => t() === "auto" ? e().themeModeAutoSystemClick.value : `Theme mode: ${t()}. Click to switch mode.`, a = () => t() === "auto" ? e().themeAuto.value : t() === "dark" ? e().themeDark.value : e().themeLight.value;
	return (() => {
		var e = he();
		return e.$$click = r, v(e, a), _((t) => {
			var n = i(), r = i();
			return n !== t.e && b(e, "aria-label", t.e = n), r !== t.t && b(e, "title", t.t = r), t;
		}, {
			e: void 0,
			t: void 0
		}), e;
