...
}, D = "\x1B[0m", O = "\x1B[34m", te = "\x1B[31m", ne = "\x1B[32m", k = (e, t, n) => t ? `${t}${e}${n ? typeof n == "boolean" ? D : n : D}` : e;
k("✗", te), k("✓", ne), k("⏲", O);
var A = (e = "") => new Proxy(() => e, {
	get: (t, n) => {
...
var K = F ? e : {
	...
	transform: (e, { plugins: t, ...r }) => T({
		...r,
		value: r.children,
		children: !B && n.enabled ? g(b, {
			get fallback() {
				return r.children;
			},
			get children() {
				return g(V, v(r, { get children() {
					return r.children;
				} }));
			}
		}) : r.children
		...
		let { plugins: i, ...a } = t, o = r(G?.(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => T({
					...r,
					value: t,
					children: !B && n.enabled ? g(ContentSelector, v(a, { get children() {
						return g(b, {
							fallback: e,
							get children() {
								return g(H, v(a, {
