...
var blog_header_default = {
	...
	content: {
		...
		"translation": {
			...
			"fr": {
				"blog": "Blog",
				"insightsTutorialsAndAnalysisFrom": "Idées, tutoriels et analyses de la communauté i18n."
			},
			"es": {
				"blog": "Blog",
			...
			"ru": {
				"blog": "Блог",
				"insightsTutorialsAndAnalysisFrom": "Инсайты, учебные пособия и анализ от сообщества i18n."
			}
		}
	},
	localIds: ["blog-header::local::src/components/pages/blog/blogHeader.content.ts"]
};
...
function BlogHeader() {
	const content = M(blog_header_default);
	return [
		createComponent(MockBanner, {}),
		(() => {
			var _el$ = _tmpl$();
			insert(_el$, () => content().blog);
			return _el$;
		})(),
		(() => {
			var _el$2 = _tmpl$2();
			insert(_el$2, () => content().insightsTutorialsAndAnalysisFrom);
			return _el$2;
		})()
	];
}
