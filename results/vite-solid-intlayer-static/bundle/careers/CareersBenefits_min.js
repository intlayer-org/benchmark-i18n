import { a as e, c as t, f as n, h as r, i, l as a, n as o, o as s, p as c, r as l, s as ee, t as u } from "./getContent-C3Acg06C.js";
	...
	content: {
		...
		translation: {
			...
			es: {
				...
				topOfMarketCompensation: "Compensación de nivel superior en el mercado",
			...
			pt: {
				...
				topOfMarketCompensation: "Compensação acima do mercado",
			...
			ja: {
				...
				openSourceTime: "オープンソース時間",
				x20TimeForOssContributions: "OSSへの貢献に20％の時間"
			},
			ko: {
				workFromAnywhereInThe: "전 세계 어디에서나 근무 가능",
				competitivePay: "경쟁력 있는 급여",
				topOfMarketCompensation: "업계 최고 수준의 보상",
				openSourceTime: "오픈 소스 시간",
				x20TimeForOssContributions: "OSS 기여를 위한 20% 시간"
			},
			ru: {
				workFromAnywhereInThe: "Работайте из любой точки мира",
				competitivePay: "Конкурентоспособная оплата",
				topOfMarketCompensation: "Компенсация на уровне лидеров рынка",
...
}, O = "\x1B[0m", te = "\x1B[34m", ne = "\x1B[31m", re = "\x1B[32m", k = (e, t, n) => t ? `${t}${e}${n ? typeof n == "boolean" ? O : n : O}` : e;
k("✗", ne), k("✓", re), k("⏲", te);
var A = (e = "") => new Proxy(() => e, {
	get: (t, n) => {
...
B || (V = C(() => import("./ContentSelector--hRpRV2o.js").then((e) => ({ default: e.ContentSelector })))), L || (H = C(() => import("./MarkdownRenderer-B7hyvLDf.js").then((e) => ({ default: e.MarkdownMetadataRenderer }))), U = C(() => import("./MarkdownRenderer-B7hyvLDf.js").then((e) => ({ default: e.MarkdownRenderer }))), import("./markdown-Cvh9lBUG.js").then((e) => {
	G = e.getMarkdownMetadata;
})), R || (W = C(() => import("./HTMLRenderer-C-wPH0rg.js").then((e) => ({ default: e.HTMLRenderer }))));
var K = F ? e : {
...
}, { defaultLocale: fe, locales: pe } = c, me = v("<div class=\"mb-12 grid gap-4 md:grid-cols-3\">"), he = v("<div class=\"rounded-lg border border-border bg-card p-4 text-center\"><p class=\"text-sm font-semibold text-foreground\"></p><p class=\"text-xs text-muted-foreground\">");
function ge() {
	let e = de(T), t = [
		{
			label: "Remote-first",
	...
	return (() => {
		...
		return g(e, h(y, {
			each: t,
			children: (e) => (() => {
				var t = he(), n = t.firstChild, r = n.nextSibling;
				return g(n, () => e.label), g(r, () => e.value), t;
			})()
		})), e;
	})();
}
