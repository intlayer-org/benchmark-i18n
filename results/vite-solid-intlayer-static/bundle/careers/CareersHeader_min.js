...
var ge = v("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), _e = v("<p class=\"mb-4 text-muted-foreground\">");
function ve() {
	let e = $(w);
	return [
		h(he, {}),
		(() => {
			var t = ge();
			return g(t, () => e().careers), t;
		})(),
		(() => {
			var t = _e();
			return g(t, () => e().joinOurMissionToImprove), t;
		})()
	];
}
