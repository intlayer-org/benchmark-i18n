...
function ContactForm() {
	const content = M(contact_form_default);
	...
	return (() => {
		...
		insert(_el$4, () => content().name);
		setAttribute(_el$5, "id", nameId);
		setAttribute(_el$7, "for", emailId);
		insert(_el$7, () => content().email);
		setAttribute(_el$8, "id", emailId);
		setAttribute(_el$0, "for", topicId);
		insert(_el$0, () => content().topic);
		setAttribute(_el$1, "id", topicId);
		insert(_el$10, () => content().bugReport);
		insert(_el$11, () => content().newBenchmarkIdea);
		insert(_el$12, () => content().methodologyQuestion);
		insert(_el$13, () => content().contribution);
		insert(_el$14, () => content().other);
		setAttribute(_el$16, "for", messageId);
		insert(_el$16, () => content().message);
		setAttribute(_el$17, "id", messageId);
		insert(_el$18, () => content().sendMessage);
		effect((_p$) => {
			var _v$ = content().yourName.value, _v$2 = content().describeYourQuestionOrIdea.value;
