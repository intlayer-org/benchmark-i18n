...
var O = process.env.INTLAYER_EDITOR_ENABLED !== "false" && n?.enabled && typeof window < "u" && window.self !== window.top, ee = process.env.INTLAYER_EDITOR_ENABLED === "false", k = (e) => ee || !O ? e.children : g(h, {
...
}, F = process.env.INTLAYER_NODE_TYPE_INTLAYER_NODE === "false", I = process.env.INTLAYER_NODE_TYPE_SOLID_NODE === "false", L = process.env.INTLAYER_NODE_TYPE_MARKDOWN === "false", R = process.env.INTLAYER_NODE_TYPE_HTML === "false", z = process.env.INTLAYER_NODE_TYPE_INSERTION === "false", B = process.env.INTLAYER_EDITOR_ENABLED === "false", V = L ? null : E(() => import("./MarkdownRenderer-iWMAOT1d.js").then((e) => ({ default: e.MarkdownMetadataRenderer }))), H = L ? null : E(() => import("./MarkdownRenderer-iWMAOT1d.js").then((e) => ({ default: e.MarkdownRenderer }))), U = R ? null : E(() => import("./HTMLRenderer-_RkJwpIh.js").then((e) => ({ default: e.HTMLRenderer }))), W = F ? c : {
	id: "intlayer-node-plugin",
	canHandle: (e) => typeof e == "bigint" || typeof e == "string" || typeof e == "number",
	transform: (e, { plugins: t, ...r }) => A({
		...r,
		value: r.children,
		children: !B && n.enabled ? g(k, y(r, { get children() {
			return r.children;
		} })) : r.children
	})
}, G = I ? c : {
		...
		let { plugins: i, ...a } = t, o = r(m(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => A({
					...r,
					value: t,
					children: !B && n.enabled ? g(k, y(a, { get children() {
						return g(S, {
							fallback: e,
							get children() {
								return g(V, y(a, {
...
var ne = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false", re = process.env.INTLAYER_ROUTING_STORAGE_LOCALSTORAGE === "false", ie = process.env.INTLAYER_ROUTING_STORAGE_SESSIONSTORAGE === "false";
process.env.INTLAYER_ROUTING_STORAGE_HEADERS;
var ae = (n = $) => {
	let { locales: r } = e;
	if (n?.isCookieEnabled === !1) return;
	let i = (e) => !!e && r.includes(e);
	if (!ne) for (let e = 0; e < (t.storage.cookies ?? []).length; e++) try {
	...
	if (!ie && t.storage.sessionStorage) for (let e = 0; e < t.storage.sessionStorage.length; e++) try {
