...
import { Suspense as S, createContext as C, createMemo as w, createUniqueId as T, lazy as E, useContext as ee } from "solid-js";
var D = {
	key: "contact-form",
	content: {
		...
		translation: {
			...
			ru: {
				...
				newBenchmarkIdea: "Новая идея бенчмарка",
...
}, A = "\x1B[0m", j = "\x1B[34m", M = "\x1B[31m", N = "\x1B[32m", P = (e, t, n) => t ? `${t}${e}${n ? typeof n == "boolean" ? A : n : A}` : e;
P("✗", M), P("✓", N), P("⏲", j);
var F = (e = "") => new Proxy(() => e, {
	get: (t, n) => {
...
}, L = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", R = /\{\{\s*(.*?)\s*\}\}/g, te = (e, t = {}) => {
...
}, ne = process.env.INTLAYER_NODE_TYPE_INTLAYER_NODE === "false", z = process.env.INTLAYER_NODE_TYPE_SOLID_NODE === "false", B = !0, V = !0, H = !0, U = !0, W = null, G = null, K = null, q = null, J = null;
