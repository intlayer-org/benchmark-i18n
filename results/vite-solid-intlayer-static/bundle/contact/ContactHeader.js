...
var _tmpl$ = template(`<h1 class="mb-2 text-3xl font-bold text-foreground">`), _tmpl$2 = template(`<p class="mb-8 text-muted-foreground"> <a href=mailto:contact@intlayer.org class="text-primary hover:underline">contact@intlayer.org</a>.`);
function ContactHeader() {
	const content = M(contact_header_default);
	return [
		createComponent(MockBanner, {}),
		(() => {
			var _el$ = _tmpl$();
			insert(_el$, () => content().getInTouch);
			return _el$;
		})(),
		(() => {
			var _el$2 = _tmpl$2(), _el$3 = _el$2.firstChild;
			insert(_el$2, () => content().haveIdeasFoundABug, _el$3);
			return _el$2;
		})()
	];
}
