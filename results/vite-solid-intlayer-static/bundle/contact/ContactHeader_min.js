...
var w = {
	...
	localIds: ["contact-header::local::src/components/pages/contact/contactHeader.content.ts"]
...
var ge = v("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), _e = v("<p class=\"mb-8 text-muted-foreground\"> <a href=mailto:contact@intlayer.org class=\"text-primary hover:underline\">contact@intlayer.org</a>.");
function ve() {
	let e = $(w);
	return [
		h(he, {}),
		(() => {
			var t = ge();
			return g(t, () => e().getInTouch), t;
		})(),
		(() => {
			var t = _e(), n = t.firstChild;
			return g(t, () => e().haveIdeasFoundABug, n), t;
		})()
	];
}
