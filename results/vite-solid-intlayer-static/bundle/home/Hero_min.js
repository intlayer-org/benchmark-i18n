import { a as e, c as t, f as n, h as r, i, l as a, n as o, o as s, p as c, r as ee, s as l, t as te } from "./getContent-C3Acg06C.js";
import { a as u, o as d, s as f } from "./nodeType-C3vWW1Sy.js";
import { Dynamic as p, createComponent as m, insert as h, mergeProps as g, template as _ } from "solid-js/web";
import { Suspense as v, createContext as y, createMemo as b, lazy as x, onMount as S, useContext as C } from "solid-js";
var w = {
	key: "hero",
	content: {
		...
		translation: {
			...
			es: {
				title: "i18n Benchmark",
				description: "Una aplicación de prueba diseñada para medir el impacto real de las bibliotecas de internacionalización en el tamaño del paquete, el rendimiento de carga и la reactividad de la representación.",
			...
			pt: {
				title: "i18n Benchmark",
				description: "Uma aplicação de teste progettada para medir o impacto real das bibliotecas de internacionalização no tamanho do bundle, no desempenho de carregamento e na reatividade de renderização.",
				viewResults: "Ver Resultados",
				methodology: "Metodologia",
				hero: "Herói"
			},
			zh: {
				title: "i18n Benchmark",
				description: "一个测试应用程序，旨在衡量国际化库对捆绑包大小、加载性能和渲染反应性的真实影响。",
				viewResults: "查看结果",
				methodology: "方法论",
				hero: "主页横幅"
			},
			ja: {
				title: "i18n Benchmark",
				description: "国際化ライブラリがバンドルサイズ、ロード性能、レンダリングの反応性に与える実際の影響を測定するために設計されたテストアプリケーションです。",
				viewResults: "結果を表示",
				methodology: "方法論",
				hero: "ヒーロー"
			},
			ko: {
				title: "i18n Benchmark",
				description: "번들 크기, 로딩 성능 및 렌더링 반응성에 대한 국제화 라이브러리의 실제 영향을 측정하기 위해 설계된 테스트 애플리케이션입니다.",
				viewResults: "결과 표시",
				methodology: "방법론",
				hero: "히어로"
			},
...
}, D = "\x1B[0m", ne = "\x1B[34m", re = "\x1B[31m", O = "\x1B[32m", k = (e, t, n) => t ? `${t}${e}${n ? typeof n == "boolean" ? D : n : D}` : e;
k("✗", re), k("✓", O), k("⏲", ne);
var A = (e = "") => new Proxy(() => e, {
	get: (t, n) => {
...
B || (V = x(() => import("./ContentSelector--hRpRV2o.js").then((e) => ({ default: e.ContentSelector })))), L || (H = x(() => import("./MarkdownRenderer-B7hyvLDf.js").then((e) => ({ default: e.MarkdownMetadataRenderer }))), U = x(() => import("./MarkdownRenderer-B7hyvLDf.js").then((e) => ({ default: e.MarkdownRenderer }))), import("./markdown-Cvh9lBUG.js").then((e) => {
	G = e.getMarkdownMetadata;
})), R || (W = x(() => import("./HTMLRenderer-C-wPH0rg.js").then((e) => ({ default: e.HTMLRenderer }))));
var K = F ? e : {
	...
	transform: (e, { plugins: t, ...r }) => T({
		...r,
		value: r.children,
		children: !B && n.enabled ? m(v, {
			get fallback() {
				return r.children;
			},
			get children() {
				return m(V, g(r, { get children() {
					return r.children;
				} }));
			}
		}) : r.children
		...
		let { plugins: i, ...a } = t, o = r(G?.(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => T({
					...r,
					value: t,
					children: !B && n.enabled ? m(ContentSelector, g(a, { get children() {
						return m(v, {
							fallback: e,
							get children() {
								return m(H, g(a, {
	...
	return Z.set(r, o), o;
}, se = (e, t) => j(e, t, oe(t)), Q = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false";
process.env.INTLAYER_ROUTING_STORAGE_HEADERS;
var ce = (e = $) => {
	let { locales: t } = c;
	if (e?.isCookieEnabled === !1) return;
	let n = (e) => !!e && t.includes(e);
	if (!Q) for (let t = 0; t < (r.storage.cookies ?? []).length; t++) try {
	...
	let n = C(ue) ?? {};
	return b(() => se(e, t ?? n?.locale?.()));
}, { defaultLocale: fe, locales: pe } = c;
function me(e) {
