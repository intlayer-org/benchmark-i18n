...
import { a as r, c as i, f as a, i as o, l as s, o as c, s as ee, u as te } from "./getDictionary-BTlZiT1o.js";
import { c as l, o as u, s as d } from "./nodeType-CG6hvPHO.js";
import { n as f } from "./markdown-BZysCahS.js";
...
var w = process.env.INTLAYER_EDITOR_ENABLED !== "false" && n?.enabled && typeof window < "u" && window.self !== window.top, T = process.env.INTLAYER_EDITOR_ENABLED === "false", E = (e) => T || !w ? e.children : m(p, {
		...
		let { plugins: i, ...a } = t, o = r(f(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => D({
					...r,
					value: t,
					children: !L && n.enabled ? m(E, g(a, { get children() {
						return m(v, {
							fallback: e,
							get children() {
								return m(R, g(a, {
	...
	let c = [
		te(t ?? e.defaultLocale, n ? e.defaultLocale : void 0),
		r,
		o,
		s(t ?? e.defaultLocale),
		ee,
