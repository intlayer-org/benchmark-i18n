...
var u = {
...
}, ee = "translation", S = "object", C = "array", w = (e, t) => {
	...
	return n;
}, T = "default", te = /[^A-Za-z0-9._&=-]/g, E = /[^A-Za-z0-9._-]/g, ne = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, D = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, ne);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, O = (e) => e === void 0 ? T : typeof e == "string" ? D(e, te) : Object.keys(e).sort().map((t) => `${D(t, E)}=${D(String(e[t]), E)}`).join("&"), k = (e) => Array.isArray(e) ? e.length === 0 ? [T] : e.map(O) : [O(e)], A = (e, t) => {
	...
	if (!j(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? T : A(k(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => re(e, n, t, s)).map((t) => M(e, t));
	...
	z(e ?? s.defaultLocale, t ? s.defaultLocale : void 0),
	B,
	H,
	U,
	K(e ?? s.defaultLocale),
	...
	let { locale: r, selector: i } = P(t), a = y(r ?? s.defaultLocale, F(i), n), o = b(e, a);
	if (o.hit) return o.content;
	let c = n ?? J(r), l = N(e, i), u = (e) => {
		let t = {
			dictionaryKey: e.key,
	...
	return new Proxy(r, { get(e, n, r) {
		...
		if (t != null && typeof n == "string" && n !== Y.constructor && n !== Y.length && !se(n)) {
			let e = Object(t);
			if (n in e) {
...
var fe = R, $ = /* @__PURE__ */ new Map(), pe = (e, t = !0) => {
	...
	return $.set(n, r), r;
}, me = (e, t) => oe(e, t, pe(typeof t == "object" && t ? t.locale : t)), he = Symbol("LOADABLE_SETTLED_VALUE"), ge = (e) => {
	if (!(e === null || typeof e != "object" && typeof e != "function")) return e[he];
}, _e = (e, t) => {
	let n = a(f) ?? {}, i = r(() => {
		let r = n?.locale?.();
		return me(ge(e) ?? e, t ?? r);
	});
	return new Proxy(i, {
		get(e, t) {
			return e()?.[t];
