...
}, { defaultLocale: oe, locales: se } = e, ce = v("<div class=\"grid gap-8 md:grid-cols-2\"><div class=\"rounded-lg border border-border bg-card p-6\"><h2 class=\"mb-3 text-xl font-semibold text-foreground\"></h2><p class=\"text-sm text-muted-foreground\"></p></div><div class=\"rounded-lg border border-border bg-card p-6\"><h2 class=\"mb-3 text-xl font-semibold text-foreground\"></h2><p class=\"text-sm text-muted-foreground\">");
function le() {
	let e = ae("about-grid");
	return (() => {
		var t = ce(), n = t.firstChild, r = n.firstChild, i = r.nextSibling, a = n.nextSibling.firstChild, o = a.nextSibling;
		return g(r, () => e().whyThisExists), g(i, () => e().choosingAnI18nLibraryIs), g(a, () => e().methodology), g(o, () => e().theSame10PageApp), t;
	})();
}
