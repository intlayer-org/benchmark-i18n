...
import { Suspense as y, createContext as b, createMemo as x, lazy as S, onMount as C, useContext as w } from "solid-js";
var T = {
	key: "about-header",
	content: {
...
var K = F ? e : {
	...
	return Z.set(r, o), o;
}, se = (e, t) => j(e, t, oe(t)), ce = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false";
...
var he = v("<h1 class=\"mb-4 text-3xl font-bold text-foreground\">"), ge = v("<p class=\"mb-8 max-w-3xl text-muted-foreground\">");
function _e() {
	let e = de(T);
	return me("AboutHeader"), [(() => {
		var t = he();
		return g(t, () => e().aboutThisBenchmark), t;
	})(), (() => {
		var t = ge();
		return g(t, () => e().thisIsAnOpenSource), t;
	})()];
}
