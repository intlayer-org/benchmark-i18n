...
}, { defaultLocale: se, locales: ce } = e, le = v("<div class=\"mb-12 grid gap-4 md:grid-cols-3\">"), ue = v("<div class=\"rounded-lg border border-border bg-card p-4 text-center\"><p class=\"text-sm font-semibold text-foreground\"></p><p class=\"text-xs text-muted-foreground\">");
function de() {
	let e = oe("careers-benefits"), t = [
		{
			label: "Remote-first",
