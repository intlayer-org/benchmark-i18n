...
function ContactForm() {
	const content = o(contact_form_default);
	...
	return (() => {
		...
		insert(_el$4, () => content().g);
		setAttribute(_el$5, "id", nameId);
		setAttribute(_el$7, "for", emailId);
		insert(_el$7, () => content().d);
		setAttribute(_el$8, "id", emailId);
		setAttribute(_el$0, "for", topicId);
		insert(_el$0, () => content().k);
		setAttribute(_el$1, "id", topicId);
		insert(_el$10, () => content().a);
		insert(_el$11, () => content().h);
		insert(_el$12, () => content().f);
		insert(_el$13, () => content().b);
		insert(_el$14, () => content().i);
		setAttribute(_el$16, "for", messageId);
		insert(_el$16, () => content().e);
		setAttribute(_el$17, "id", messageId);
		insert(_el$18, () => content().j);
		effect((_p$) => {
			var _v$ = content().l.value, _v$2 = content().c.value;
