...
var q = r("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), J = r("<p class=\"mb-8 text-muted-foreground\"> <a href=mailto:contact@intlayer.org class=\"text-primary hover:underline\">contact@intlayer.org</a>.");
function Y() {
	let e = U(s);
	return [
		t(K, {}),
