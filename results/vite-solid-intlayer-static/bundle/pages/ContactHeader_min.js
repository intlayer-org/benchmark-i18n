...
var he = n("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), ge = n("<p class=\"mb-8 text-muted-foreground\"> <a href=mailto:contact@intlayer.org class=\"text-primary hover:underline\">contact@intlayer.org</a>.");
function _e() {
	let n = $(s);
	return [
		e(me, {}),
