	...
	content: {
		...
		translation: {
			...
			de: {
				...
				everythingYouNeedToKnow: "Alles, was Sie über den i18n Benchmark wissen müssen."
			},
			it: {
			...
			ja: {
				...
				everythingYouNeedToKnow: "i18nベンチマークについて知っておくべきすべてのこと。"
			},
			ko: {
				frequentlyAskedQuestions: "자주 묻는 질문",
				everythingYouNeedToKnow: "i18n 벤치마크에 대해 알아야 할 모든 것."
			},
			ru: {
...
var ge = v("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), _e = v("<p class=\"mb-10 text-muted-foreground\">");
function ve() {
	let e = $(w);
	return [
		h(he, {}),
		(() => {
			var t = ge();
			return g(t, () => e().frequentlyAskedQuestions), t;
		})(),
		(() => {
			var t = _e();
			return g(t, () => e().everythingYouNeedToKnow), t;
		})()
	];
}
