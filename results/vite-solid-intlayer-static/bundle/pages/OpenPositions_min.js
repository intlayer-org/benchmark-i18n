...
function fe() {
	...
	return [(() => {
		...
		return g(n, h(y, {
			each: t,
			children: (t) => (() => {
				var n = de(), r = n.firstChild, i = r.firstChild, a = i.nextSibling, o = a.nextSibling.firstChild, s = o.nextSibling, c = s.nextSibling, l = r.nextSibling;
