...
var f = {
	...
	let n = `p${g}`;
	return h.set(e, n), n;
}, v = 256, y = /* @__PURE__ */ new WeakMap(), b = (e) => typeof e == "object" && !!e, ee = (e, t, n) => `${e}_${t}_${_(n)}`, te = (e, t) => {
	if (!b(e)) return { hit: !1 };
	let n = y.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, j = (e) => e === void 0 ? E : typeof e == "string" ? A(e, D) : Object.keys(e).sort().map((t) => `${A(t, O)}=${A(String(e[t]), O)}`).join("&"), M = (e) => Array.isArray(e) ? e.length === 0 ? [E] : e.map(j) : [j(e)], ne = (e, t) => {
	for (let n of e) if (t(n)) return n;
	return t("default") ? E : e[0] ?? "default";
}, re = (e, t, n, r) => {
	let i = e.split("/");
	return t.every((e, t) => e === "variant" ? i[t] === r : n?.item === void 0 || i[t] === String(n.item));
}, ie = (e) => typeof e == "object" && !!e && "qualifierTypes" in e && Array.isArray(e.qualifierTypes) && "content" in e, ae = (e, t) => {
	let n = t.split("/"), r = {
		key: e.key,
		content: e.content[t]
	};
	...
	if (!ie(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? E : ne(M(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => re(e, n, t, s)).map((t) => ae(e, t));
	...
	let { locale: r, selector: i } = P(t), a = ee(r ?? l.defaultLocale, F(i), n), o = te(e, a);
	...
	return c === null ? x(e, a, null) : Array.isArray(c) ? x(e, a, c.map(u)) : x(e, a, u(c));
}, Y = {
