...
import { n as m } from "./markdown-BZysCahS.js";
import { Dynamic as h, createComponent as g, insert as _, mergeProps as v, template as y } from "solid-js/web";
import { Suspense as b, createContext as x, createMemo as S, lazy as C, useContext as w } from "solid-js";
var ee = process.env.INTLAYER_EDITOR_ENABLED !== "false" && n?.enabled && typeof window < "u" && window.self !== window.top, T = process.env.INTLAYER_EDITOR_ENABLED === "false", E = (e) => T || !ee ? e.children : g(h, {
...
}, te = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", k = /\{\{\s*(.*?)\s*\}\}/g, ne = (e, t = {}) => {
		...
		let { plugins: i, ...a } = t, o = r(m(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => D({
					...r,
					value: t,
					children: !F && n.enabled ? g(E, v(a, { get children() {
						return g(b, {
							fallback: e,
							get children() {
								return g(I, v(a, {
...
}, { defaultLocale: oe, locales: se } = e, ce = y("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\">");
function le() {
	let e = $("mock-banner");
	return (() => {
		var t = ce();
		return _(t, () => e().thisPageContainsMockData), t;
	})();
}
var ue = y("<div class=\"mb-12 text-center\"><h1 class=\"mb-3 text-3xl font-bold text-foreground\"></h1><p class=text-muted-foreground>");
function de() {
	let e = $("pricing-header");
	return [g(le, {}), (() => {
		var t = ue(), n = t.firstChild, r = n.nextSibling;
		return _(n, () => e().simpleTransparentPricing), _(r, () => e().chooseThePlanThatFits), t;
	})()];
}
