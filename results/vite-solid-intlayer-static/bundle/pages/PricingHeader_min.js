...
var d = {
	...
	let n = `p${b}`;
	return y.set(e, n), n;
}, x = 256, S = /* @__PURE__ */ new WeakMap(), C = (e) => typeof e == "object" && !!e, w = (e, t, n) => `${e}_${t}_${te(n)}`, T = (e, t) => {
	if (!C(e)) return { hit: !1 };
	let n = S.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, ne = "translation", D = "object", O = "array", k = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), A = (e, t) => {
	...
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = w(r ?? c.defaultLocale, "", n), o = T(e, a);
...
var he = n("<div class=\"mb-12 text-center\"><h1 class=\"mb-3 text-3xl font-bold text-foreground\"></h1><p class=text-muted-foreground>");
function ge() {
	let n = $(s);
	return [e(me, {}), (() => {
		var e = he(), r = e.firstChild, i = r.nextSibling;
