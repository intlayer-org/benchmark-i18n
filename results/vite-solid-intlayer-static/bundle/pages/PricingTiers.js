...
import { Dynamic, className, createComponent, effect, insert, memo, mergeProps, template } from "solid-js/web";
	...
	content: {
		...
		"translation": {
			"en": {
				...
				"borderPrimaryBgPrimary5Ring": "border-primary bg-primary/5 ring-1 ring-primary",
				"borderBorderBorderTextForeground": "border border-border text-foreground hover:bg-accent",
				"contactSales": "Contact Sales",
				"getStarted": "Get Started"
			},
			"fr": {
				"starter": "Débutant",
				"x5BenchmarkRunsday": "5 exécutions de benchmark/jour",
			...
			"de": {
				...
				"customSlas": "Benutzerdefinierte SLAs",
			...
			"pt": {
				"starter": "Starter",
				"x5BenchmarkRunsday": "5 execuções de benchmark/dia",
				"communitySupport": "Suporte da comunidade",
				"publicResults": "Resultados públicos",
				"pro": "Pro",
				"unlimitedRuns": "Execuções ilimitadas",
				"allLibraries": "Todas as biblioteche",
			...
			"ja": {
				"starter": "スターター",
				"x5BenchmarkRunsday": "1日5回のベンチマーク実行",
			...
			"ko": {
				"starter": "스타터",
				"x5BenchmarkRunsday": "일일 5회 벤치마크 실행",
			...
			"ru": {
				"starter": "Стартовый",
				"x5BenchmarkRunsday": "5 запусков бенчмарка в день",
				...
				"everythingInPro": "Все, что в Профи",
...
function PricingTiers() {
	const content = M(pricing_tiers_default);
	const tiers = [
		{
