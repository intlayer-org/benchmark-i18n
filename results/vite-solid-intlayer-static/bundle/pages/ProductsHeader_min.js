...
var ue = v("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), de = v("<p class=\"mb-10 text-muted-foreground\">");
function fe() {
	let e = $("products-header");
	return [
		h(le, {}),
		(() => {
			var t = ue();
			return g(t, () => e().products), t;
		})(),
		(() => {
			var t = de();
			return g(t, () => e().toolsAndServicesToStreamline), t;
		})()
	];
}
