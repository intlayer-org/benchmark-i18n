...
import { Dynamic as h, createComponent as g, insert as _, mergeProps as v, setAttribute as y, template as b } from "solid-js/web";
import { Suspense as x, createContext as ee, createMemo as S, createUniqueId as C, lazy as w, useContext as T } from "solid-js";
var E = {
	key: "profile-section",
	content: {
...
}, k = "\x1B[0m", A = "\x1B[34m", te = "\x1B[31m", ne = "\x1B[32m", j = (e, t, n) => t ? `${t}${e}${n ? typeof n == "boolean" ? k : n : k}` : e;
j("✗", te), j("✓", ne), j("⏲", A);
var M = (e = "") => new Proxy(() => e, {
	get: (t, n) => {
...
H || (U = w(() => import("./ContentSelector--hRpRV2o.js").then((e) => ({ default: e.ContentSelector })))), z || (W = w(() => import("./MarkdownRenderer-B7hyvLDf.js").then((e) => ({ default: e.MarkdownMetadataRenderer }))), G = w(() => import("./MarkdownRenderer-B7hyvLDf.js").then((e) => ({ default: e.MarkdownRenderer }))), import("./markdown-Cvh9lBUG.js").then((e) => {
	q = e.getMarkdownMetadata;
})), B || (K = w(() => import("./HTMLRenderer-C-wPH0rg.js").then((e) => ({ default: e.HTMLRenderer }))));
var re = L ? e : {
	...
	transform: (e, { plugins: t, ...r }) => D({
		...r,
		value: r.children,
		children: !H && n.enabled ? g(x, {
			get fallback() {
				return r.children;
			},
			get children() {
				return g(U, v(r, { get children() {
					return r.children;
				} }));
			}
		}) : r.children
		...
		let { plugins: i, ...a } = t, o = r(q?.(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => D({
					...r,
					value: t,
					children: !H && n.enabled ? g(ContentSelector, v(a, { get children() {
						return g(x, {
							fallback: e,
							get children() {
								return g(W, v(a, {
