	...
	content: {
		...
		translation: {
			...
			es: {
				yes: "Sí",
				manual: "Manual",
				sampleResults: "Resultados de ejemplo",
				library: "Biblioteca",
			...
			pt: {
				yes: "Sim",
				manual: "Manual",
				sampleResults: "Resultados de exemplo",
				library: "Biblioteca",
...
var re = I ? e : {
	...
	return Z.set(r, o), o;
}, se = (e, t) => M(e, t, oe(t)), Q = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false";
...
}, { defaultLocale: fe, locales: pe } = c, me = v("<section><h2 class=\"mb-6 text-2xl font-bold text-foreground\"></h2><div class=\"overflow-x-auto rounded-lg border border-border\"><table class=\"w-full text-sm\"><thead class=bg-muted><tr><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th></tr></thead><tbody>"), he = v("<tr class=\"border-t border-border\"><td class=\"px-4 py-3 font-medium text-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\">");
function ge() {
	let e = de(T), t = [
		{
			lib: "react-i18next",
	...
	return (() => {
		var n = me(), r = n.firstChild, i = r.nextSibling.firstChild.firstChild, a = i.firstChild.firstChild, o = a.nextSibling, s = o.nextSibling, c = s.nextSibling, l = i.nextSibling;
		return g(r, () => e().sampleResults), g(a, () => e().library), g(o, () => e().bundleSize), g(s, () => e().lookupTime), g(c, () => e().lazyLoading), g(l, h(y, {
			each: t,
			children: (e) => (() => {
				var t = he(), n = t.firstChild, r = n.nextSibling, i = r.nextSibling, a = i.nextSibling;
