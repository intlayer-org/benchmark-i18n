...
import { a as r, c as i, f as a, i as o, l as s, o as c, s as l, u as ee } from "./getDictionary-BTlZiT1o.js";
import { c as u, o as d, s as f } from "./nodeType-CG6hvPHO.js";
import { n as p } from "./markdown-BZysCahS.js";
...
var T = process.env.INTLAYER_EDITOR_ENABLED !== "false" && n?.enabled && typeof window < "u" && window.self !== window.top, E = process.env.INTLAYER_EDITOR_ENABLED === "false", D = (e) => E || !T ? e.children : h(m, {
...
}, te = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", A = /\{\{\s*(.*?)\s*\}\}/g, j = (e, t = {}) => {
...
}, M = process.env.INTLAYER_NODE_TYPE_INTLAYER_NODE === "false", N = process.env.INTLAYER_NODE_TYPE_SOLID_NODE === "false", P = process.env.INTLAYER_NODE_TYPE_MARKDOWN === "false", F = process.env.INTLAYER_NODE_TYPE_HTML === "false", I = process.env.INTLAYER_NODE_TYPE_INSERTION === "false", L = process.env.INTLAYER_EDITOR_ENABLED === "false", R = P ? null : C(() => import("./MarkdownRenderer-iWMAOT1d.js").then((e) => ({ default: e.MarkdownMetadataRenderer }))), z = P ? null : C(() => import("./MarkdownRenderer-iWMAOT1d.js").then((e) => ({ default: e.MarkdownRenderer }))), B = F ? null : C(() => import("./HTMLRenderer-_RkJwpIh.js").then((e) => ({ default: e.HTMLRenderer }))), V = M ? c : {
	id: "intlayer-node-plugin",
	canHandle: (e) => typeof e == "bigint" || typeof e == "string" || typeof e == "number",
	transform: (e, { plugins: t, ...r }) => O({
		...r,
		value: r.children,
		children: !L && n.enabled ? h(D, _(r, { get children() {
			return r.children;
		} })) : r.children
	})
}, H = N ? c : {
		...
		let { plugins: i, ...a } = t, o = r(p(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => O({
					...r,
					value: t,
					children: !L && n.enabled ? h(D, _(a, { get children() {
						return h(b, {
							fallback: e,
							get children() {
								return h(R, _(a, {
...
}, q = /* @__PURE__ */ new Map(), J = (t, n = !0) => {
	let a = `${t ?? e.defaultLocale}_${n}`;
	if (q.has(a)) return q.get(a);
	let c = [
		ee(t ?? e.defaultLocale, n ? e.defaultLocale : void 0),
		r,
		o,
		s(t ?? e.defaultLocale),
		l,
...
var X = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false", Z = process.env.INTLAYER_ROUTING_STORAGE_LOCALSTORAGE === "false", re = process.env.INTLAYER_ROUTING_STORAGE_SESSIONSTORAGE === "false";
process.env.INTLAYER_ROUTING_STORAGE_HEADERS;
var ie = (n = Q) => {
	let { locales: r } = e;
	if (n?.isCookieEnabled === !1) return;
	let i = (e) => !!e && r.includes(e);
	if (!X) for (let e = 0; e < (t.storage.cookies ?? []).length; e++) try {
		let r = n?.getCookie?.(t.storage.cookies[e].name);
		if (i(r)) return r;
	} catch {}
	if (!Z) for (let e = 0; e < (t.storage.localStorage ?? []).length; e++) try {
		let r = n?.getLocaleStorage?.(t.storage.localStorage[e].name);
		if (i(r)) return r;
	} catch {}
	if (!re && t.storage.sessionStorage) for (let e = 0; e < t.storage.sessionStorage.length; e++) try {
...
}, { defaultLocale: se, locales: ce } = e, le = v("<section><h2 class=\"mb-6 text-2xl font-bold text-foreground\"></h2><div class=\"overflow-x-auto rounded-lg border border-border\"><table class=\"w-full text-sm\"><thead class=bg-muted><tr><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th></tr></thead><tbody>"), ue = v("<tr class=\"border-t border-border\"><td class=\"px-4 py-3 font-medium text-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\">");
function de() {
	let e = oe("results-table"), t = [
		{
			lib: "react-i18next",
			size: "42.3 kB",
			time: "0.12ms",
	...
	return (() => {
		var n = le(), r = n.firstChild, i = r.nextSibling.firstChild.firstChild, a = i.firstChild.firstChild, o = a.nextSibling, s = o.nextSibling, c = s.nextSibling, l = i.nextSibling;
		return g(r, () => e().sampleResults), g(a, () => e().library), g(o, () => e().bundleSize), g(s, () => e().lookupTime), g(c, () => e().lazyLoading), g(l, h(y, {
			each: t,
			children: (e) => (() => {
				var t = ue(), n = t.firstChild, r = n.nextSibling, i = r.nextSibling, a = i.nextSibling;
				return g(n, () => e.lib), g(r, () => e.size), g(i, () => e.time), g(a, () => e.lazy), t;
			})()
		})), n;
	})();
}
