...
function UnderstandingImpact() {
	const content = o(understanding_impact_default);
	return (() => {
		...
		insert(_el$2, () => content().k);
		insert(_el$4, () => content().p);
		insert(_el$5, () => content().e);
		insert(_el$7, () => content().h);
		insert(_el$8, () => content().b);
		insert(_el$9, () => content().c);
		insert(_el$1, () => content().i);
		insert(_el$10, () => content().f);
		insert(_el$13, () => content().n);
		insert(_el$12, () => content().g, null);
		insert(_el$15, () => content().d);
		insert(_el$14, () => content().m, null);
		insert(_el$18, () => content().a);
		insert(_el$17, () => content().l, null);
		insert(_el$20, () => content().o);
		insert(_el$21, () => content().j);
		return _el$;
	})();
}
