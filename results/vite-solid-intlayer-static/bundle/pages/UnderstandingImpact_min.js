...
var ee = process.env.INTLAYER_EDITOR_ENABLED !== "false" && n?.enabled && typeof window < "u" && window.self !== window.top, T = process.env.INTLAYER_EDITOR_ENABLED === "false", E = (e) => T || !ee ? e.children : g(h, {
	...
	transform: (e, { plugins: t, ...r }) => D({
		...r,
		value: r.children,
		children: !L && n.enabled ? g(E, v(r, { get children() {
			return r.children;
		} })) : r.children
	})
}, H = N ? c : {
		...
		let { plugins: i, ...a } = t, o = r(m(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => D({
					...r,
					value: t,
					children: !L && n.enabled ? g(E, v(a, { get children() {
						return g(b, {
							fallback: e,
							get children() {
								return g(R, v(a, {
...
var Z = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false", Q = process.env.INTLAYER_ROUTING_STORAGE_LOCALSTORAGE === "false", te = process.env.INTLAYER_ROUTING_STORAGE_SESSIONSTORAGE === "false";
...
var ne = (n = $) => {
	...
	if (!Q) for (let e = 0; e < (t.storage.localStorage ?? []).length; e++) try {
		let r = n?.getLocaleStorage?.(t.storage.localStorage[e].name);
		if (i(r)) return r;
	} catch {}
	if (!te && t.storage.sessionStorage) for (let e = 0; e < t.storage.sessionStorage.length; e++) try {
