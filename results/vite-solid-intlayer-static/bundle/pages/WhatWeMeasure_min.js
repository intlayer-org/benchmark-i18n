...
}, { defaultLocale: se, locales: ce } = e, le = v("<section class=\"mx-auto mt-12 max-w-3xl\"><h2 class=\"mb-4 text-2xl font-bold text-foreground\"></h2><ul class=space-y-4>"), ue = v("<li class=\"rounded-md border border-border p-4\"><span class=\"block text-sm font-bold text-primary\"></span><span class=\"mt-1 block text-sm text-muted-foreground\">");
function de() {
	let e = oe("what-we-measure"), t = [
		{
	...
	return (() => {
		var n = le(), r = n.firstChild, i = r.nextSibling;
		return g(r, () => e().whatWeMeasure), g(i, h(y, {
			each: t,
			children: (e) => (() => {
				var t = ue(), n = t.firstChild, r = n.nextSibling;
				return g(n, () => e.metric), g(r, () => e.desc), t;
			})()
		})), n;
	})();
}
