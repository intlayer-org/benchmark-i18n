...
}, E = "\x1B[0m", D = "\x1B[34m", O = "\x1B[31m", k = "\x1B[32m", A = (e, t, n) => t ? `${t}${e}${n ? typeof n == "boolean" ? E : n : E}` : e;
A("✗", O), A("✓", k), A("⏲", D);
var j = (e = "") => new Proxy(() => e, {
	get: (t, n) => {
...
V || (H = S(() => import("./ContentSelector--hRpRV2o.js").then((e) => ({ default: e.ContentSelector })))), R || (U = S(() => import("./MarkdownRenderer-B7hyvLDf.js").then((e) => ({ default: e.MarkdownMetadataRenderer }))), W = S(() => import("./MarkdownRenderer-B7hyvLDf.js").then((e) => ({ default: e.MarkdownRenderer }))), import("./markdown-Cvh9lBUG.js").then((e) => {
	K = e.getMarkdownMetadata;
})), z || (G = S(() => import("./HTMLRenderer-C-wPH0rg.js").then((e) => ({ default: e.HTMLRenderer }))));
var q = I ? e : {
	...
	return Q.set(r, o), o;
}, ae = (e, t) => M(e, t, ie(t)), oe = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false";
...
var se = (e = $) => {
	...
	let n = C(le) ?? {};
	return x(() => ae(e, t ?? n?.locale?.()));
}, { defaultLocale: de, locales: fe } = c, pe = v("<section class=mb-16><h2 class=\"mb-6 text-2xl font-bold text-foreground\"></h2><div class=\"grid gap-6 md:grid-cols-3\"><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p></div><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p></div><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\">");
function me() {
	let e = ue(te);
	return (() => {
		var t = pe(), n = t.firstChild, r = n.nextSibling.firstChild, i = r.firstChild, a = i.nextSibling, o = r.nextSibling, s = o.firstChild, c = s.nextSibling, l = o.nextSibling.firstChild, u = l.nextSibling;
		return g(n, () => e().whyTheseMetricsMatter), g(i, () => e().bundleSize), g(a, () => e().theBundleIsTheData), g(s, () => e().renderingHydration), g(c, () => e().connectingALargeJsonDictionary), g(l, () => e().dynamicLoading), g(u, () => e().loadingAllTranslationsUpfrontOverloads), t;
	})();
}
