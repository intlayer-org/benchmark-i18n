...
var T = process.env.INTLAYER_EDITOR_ENABLED !== "false" && n?.enabled && typeof window < "u" && window.self !== window.top, E = process.env.INTLAYER_EDITOR_ENABLED === "false", D = (e) => E || !T ? e.children : g(h, {
...
}, A = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", j = /\{\{\s*(.*?)\s*\}\}/g, ee = (e, t = {}) => {
	...
	transform: (e, { plugins: t, ...r }) => O({
		...r,
		value: r.children,
		children: !L && n.enabled ? g(D, v(r, { get children() {
			return r.children;
		} })) : r.children
	})
}, H = N ? c : {
		...
		let { plugins: i, ...a } = t, o = r(m(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => O({
					...r,
					value: t,
					children: !L && n.enabled ? g(D, v(a, { get children() {
						return g(b, {
							fallback: e,
							get children() {
								return g(R, v(a, {
...
}, { defaultLocale: oe, locales: se } = e, ce = y("<section class=mb-16><h2 class=\"mb-6 text-2xl font-bold text-foreground\"></h2><div class=\"grid gap-6 md:grid-cols-3\"><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p></div><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p></div><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\">");
function le() {
	let e = ae("why-it-matters");
	return (() => {
		var t = ce(), n = t.firstChild, r = n.nextSibling.firstChild, i = r.firstChild, a = i.nextSibling, o = r.nextSibling, s = o.firstChild, c = s.nextSibling, l = o.nextSibling.firstChild, u = l.nextSibling;
		return _(n, () => e().whyTheseMetricsMatter), _(i, () => e().bundleSize), _(a, () => e().theBundleIsTheData), _(s, () => e().renderingHydration), _(c, () => e().connectingALargeJsonDictionary), _(l, () => e().dynamicLoading), _(u, () => e().loadingAllTranslationsUpfrontOverloads), t;
	})();
}
