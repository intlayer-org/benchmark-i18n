...
var o = {
	...
	let n = `p${p}`;
	return f.set(e, n), n;
}, h = 256, g = /* @__PURE__ */ new WeakMap(), _ = (e) => typeof e == "object" && !!e, v = (e, t, n) => `${e}_${t}_${m(n)}`, ee = (e, t) => {
	if (!_(e)) return { hit: !1 };
	let n = g.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	if (!N(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? w : j(A(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => M(e, n, t, s)).map((t) => P(e, t));
	...
	let { locale: r, selector: i } = ne(t), a = v(r ?? u.defaultLocale, re(i), n), o = ee(e, a);
	if (o.hit) return o.content;
	let s = n ?? J(r), c = te(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
