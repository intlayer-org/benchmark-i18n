...
var q = r("<div class=\"mb-12 text-center\"><h1 class=\"mb-3 text-3xl font-bold text-foreground\"></h1><p class=text-muted-foreground>");
function J() {
	let e = U(s);
	return [t(K, {}), (() => {
		var t = q(), r = t.firstChild, i = r.nextSibling;
