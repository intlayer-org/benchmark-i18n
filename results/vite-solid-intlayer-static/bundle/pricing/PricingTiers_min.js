...
import { Dynamic as h, className as g, createComponent as _, effect as v, insert as y, memo as b, mergeProps as x, template as S } from "solid-js/web";
import { For as C, Suspense as w, createContext as ee, createMemo as te, lazy as T, useContext as E } from "solid-js";
var D = {
	key: "pricing-tiers",
	content: {
...
}, A = "\x1B[0m", j = "\x1B[34m", ne = "\x1B[31m", re = "\x1B[32m", M = (e, t, n) => t ? `${t}${e}${n ? typeof n == "boolean" ? A : n : A}` : e;
M("✗", ne), M("✓", re), M("⏲", j);
var N = (e = "") => new Proxy(() => e, {
	get: (t, n) => {
...
var Y = R ? e : {
	...
	transform: (e, { plugins: t, ...r }) => O({
		...r,
		value: r.children,
		children: !U && n.enabled ? _(w, {
			get fallback() {
				return r.children;
			},
			get children() {
				return _(W, x(r, { get children() {
					return r.children;
				} }));
			}
		}) : r.children
		...
		let { plugins: i, ...a } = t, o = r(J?.(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => O({
					...r,
					value: t,
					children: !U && n.enabled ? _(ContentSelector, x(a, { get children() {
						return _(w, {
							fallback: e,
							get children() {
								return _(G, x(a, {
	...
	return Z.set(r, o), o;
}, ue = (e, t) => P(e, t, le(t)), de = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false";
process.env.INTLAYER_ROUTING_STORAGE_HEADERS;
var fe = (e = Q) => {
	let { locales: t } = c;
	if (e?.isCookieEnabled === !1) return;
	let n = (e) => !!e && t.includes(e);
	if (!de) for (let t = 0; t < (r.storage.cookies ?? []).length; t++) try {
	...
	locale: () => pe ?? c?.defaultLocale,
	setLocale: () => null
}), $ = (e, t) => {
	let n = E(me) ?? {};
	return te(() => ue(e, t ?? n?.locale?.()));
}, { defaultLocale: he, locales: ge } = c, _e = S("<div class=\"grid gap-6 md:grid-cols-3\">"), ve = S("<div><h3 class=\"text-lg font-semibold text-foreground\"></h3><div class=my-4><span class=\"text-3xl font-bold text-foreground\"></span><span class=\"text-sm text-muted-foreground\"></span></div><ul class=\"mb-6 flex-1 space-y-2\"></ul><button type=button>"), ye = S("<li class=\"flex items-center gap-2 text-sm text-muted-foreground\"><span class=text-primary>✓</span> ");
function be() {
	let e = $(D), t = [
		{
	...
	return (() => {
		...
		return y(n, _(C, {
			each: t,
			children: (t) => (() => {
				var n = ve(), r = n.firstChild, i = r.nextSibling, a = i.firstChild, o = a.nextSibling, s = i.nextSibling, c = s.nextSibling;
				return y(r, () => t.name), y(a, () => t.price), y(o, () => t.period), y(s, _(C, {
					get each() {
						return t.features;
					},
					children: (e) => (() => {
						var t = ye();
						return t.firstChild.nextSibling, y(t, e, null), t;
					})()
				})), y(c, (() => {
					var n = b(() => t.name === e().enterprise.value);
					...
					return i !== r.e && g(n, r.e = i), a !== r.t && g(c, r.t = a), r;
				}, {
					e: void 0,
					t: void 0
				}), n;
