...
import { Dynamic, createComponent, insert, mergeProps, setAttribute, template } from "solid-js/web";
import { Suspense, createContext, createMemo, createUniqueId, lazy, useContext } from "solid-js";
	...
	content: {
		...
		"translation": {
			...
			"es": {
				...
				"apiKey": "Clave API",
				"copy": "Copiar",
				"useThisKeyToAccess": "Utilice esta clave para acceder a la API de benchmarking de forma programada."
			},
			"de": {
				"apiAccess": "API-Zugriff",
				"apiKey": "API-Schlüssel",
				"copy": "Kopieren",
				"useThisKeyToAccess": "Verwenden Sie diesen Schlüssel, um programmatisch auf die Benchmarking-API zuzugreifen."
			},
			"it": {
			...
			"ko": {
				...
				"apiKey": "API 키",
				"copy": "복사",
				"useThisKeyToAccess": "이 키를 사용하여 프로그래밍 방식으로 벤치마킹 API에 액세스하세요."
			},
			"ru": {
...
function ApiAccessSection() {
	const content = M(api_access_section_default);
