...
import { a as te, o as d, s as f } from "./nodeType-C3vWW1Sy.js";
...
}, O = "\x1B[0m", ne = "\x1B[34m", re = "\x1B[31m", k = "\x1B[32m", A = (e, t, n) => t ? `${t}${e}${n ? typeof n == "boolean" ? O : n : O}` : e;
A("✗", re), A("✓", k), A("⏲", ne);
var j = (e = "") => new Proxy(() => e, {
	get: (t, n) => {
...
var q = I ? e : {
	...
	transform: (e, { plugins: t, ...r }) => E({
		...r,
		value: r.children,
		children: !V && n.enabled ? m(y, {
			get fallback() {
				return r.children;
			},
			get children() {
				return m(H, g(r, { get children() {
					return r.children;
				} }));
			}
		}) : r.children
		...
		let { plugins: i, ...a } = t, o = r(K?.(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => E({
					...r,
					value: t,
					children: !V && n.enabled ? m(ContentSelector, g(a, { get children() {
						return m(y, {
							fallback: e,
							get children() {
								return m(U, g(a, {
	...
	transform: (e, t) => {
		let r = e[te], { plugins: i, ...a } = t, o = (e) => E({
			...a,
			value: r,
			children: !V && n.enabled ? m(y, {
				fallback: r,
	...
	return Z.set(r, o), o;
}, Q = (e, t) => M(e, t, se(t)), ce = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false";
