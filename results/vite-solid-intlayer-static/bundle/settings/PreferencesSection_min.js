...
import { Dynamic as h, createComponent as g, effect as ee, insert as _, mergeProps as v, setAttribute as y, template as b } from "solid-js/web";
import { Suspense as x, createContext as S, createMemo as C, createUniqueId as w, lazy as T, useContext as E } from "solid-js";
var D = process.env.INTLAYER_EDITOR_ENABLED !== "false" && n?.enabled && typeof window < "u" && window.self !== window.top, O = process.env.INTLAYER_EDITOR_ENABLED === "false", k = (e) => O || !D ? e.children : g(h, {
...
}), A = ({ children: e, value: t, additionalProps: n }) => {
	let r = [e];
...
}, F = process.env.INTLAYER_NODE_TYPE_INTLAYER_NODE === "false", te = process.env.INTLAYER_NODE_TYPE_SOLID_NODE === "false", I = process.env.INTLAYER_NODE_TYPE_MARKDOWN === "false", L = process.env.INTLAYER_NODE_TYPE_HTML === "false", R = process.env.INTLAYER_NODE_TYPE_INSERTION === "false", z = process.env.INTLAYER_EDITOR_ENABLED === "false", B = I ? null : T(() => import("./MarkdownRenderer-iWMAOT1d.js").then((e) => ({ default: e.MarkdownMetadataRenderer }))), V = I ? null : T(() => import("./MarkdownRenderer-iWMAOT1d.js").then((e) => ({ default: e.MarkdownRenderer }))), H = L ? null : T(() => import("./HTMLRenderer-_RkJwpIh.js").then((e) => ({ default: e.HTMLRenderer }))), U = F ? c : {
	id: "intlayer-node-plugin",
	canHandle: (e) => typeof e == "bigint" || typeof e == "string" || typeof e == "number",
	transform: (e, { plugins: t, ...r }) => A({
		...r,
		value: r.children,
		children: !z && n.enabled ? g(k, v(r, { get children() {
			return r.children;
		} })) : r.children
	})
}, W = te ? c : {
	...
	transform: (e, { plugins: t, ...r }) => A({
		...
		value: "[[solid-element]]",
		children: !z && n.enabled ? g(k, v(r, { get children() {
			return typeof Node < "u" && e instanceof Node ? e : j(e);
		} })) : typeof Node < "u" && e instanceof Node ? e : j(e)
	})
}, G = (e, t) => {
	let n = P(e, t);
		...
		let { plugins: i, ...a } = t, o = r(m(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => A({
					...r,
					value: t,
					children: !z && n.enabled ? g(k, v(a, { get children() {
						return g(x, {
							fallback: e,
							get children() {
								return g(B, v(a, {
