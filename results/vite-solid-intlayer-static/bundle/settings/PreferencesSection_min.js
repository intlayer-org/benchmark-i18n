...
var p = {
	...
	return n;
}, k = "default", ee = /[^A-Za-z0-9._&=-]/g, A = /[^A-Za-z0-9._-]/g, te = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, j = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, te);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, M = (e) => e === void 0 ? k : typeof e == "string" ? j(e, ee) : Object.keys(e).sort().map((t) => `${j(t, A)}=${j(String(e[t]), A)}`).join("&"), N = (e) => Array.isArray(e) ? e.length === 0 ? [k] : e.map(M) : [M(e)], ne = (e, t) => {
	for (let n of e) if (t(n)) return n;
	return t("default") ? k : e[0] ?? "default";
}, re = (e, t, n, r) => {
	let i = e.split("/");
	return t.every((e, t) => e === "variant" ? i[t] === r : n?.item === void 0 || i[t] === String(n.item));
}, ie = (e) => typeof e == "object" && !!e && "qualifierTypes" in e && Array.isArray(e.qualifierTypes) && "content" in e, P = (e, t) => {
	let n = t.split("/"), r = {
		key: e.key,
		content: e.content[t]
	};
	...
	if (!ie(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? k : ne(N(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => re(e, n, t, s)).map((t) => P(e, t));
	...
	let { locale: r, selector: i } = I(t), a = S(r ?? u.defaultLocale, ae(i), n), o = C(e, a);
	if (o.hit) return o.content;
	let s = n ?? se(r), c = F(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
