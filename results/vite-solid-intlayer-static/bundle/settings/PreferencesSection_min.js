...
import { Dynamic as h, createComponent as g, effect as _, insert as v, mergeProps as y, setAttribute as b, template as x } from "solid-js/web";
import { Suspense as S, createContext as C, createMemo as w, createUniqueId as T, lazy as E, useContext as D } from "solid-js";
var O = {
	...
	content: {
		...
		translation: {
			...
			fr: {
				...
				italianIt: "Italien (it)",
				portuguesePt: "Portugais (pt)",
				koreanKo: "Coréen (ko)",
				russianRu: "Russe (ru)",
				arabicAr: "Arabe (ar)"
			},
			es: {
				...
				receiveWeeklyBenchmarkReports: "Recibe informes semanales de benchmarks",
			...
			de: {
				...
				receiveWeeklyBenchmarkReports: "Erhalten Sie wöchentliche Benchmark-Berichte",
				...
				italianIt: "Italienisch (it)",
				portuguesePt: "Portugiesisch (pt)",
				koreanKo: "Koreanisch (ko)",
				russianRu: "Russisch (ru)",
			...
			pt: {
				...
				receiveWeeklyBenchmarkReports: "Receba relatórios semanais de benchmark",
				toggleNotifications: "Alternar notificações",
				darkMode: "Modo escuro",
				useDarkColorScheme: "Usar esquema de cores escuro",
			...
			ja: {
				...
				darkMode: "ダークモード",
				useDarkColorScheme: "ダークカラースキームを使用する",
			...
			ko: {
				...
				darkMode: "다크 모드",
				useDarkColorScheme: "다크 색상 테마 사용",
			...
			ru: {
				...
				italianIt: "Итальянский (it)",
				portuguesePt: "Португальский (pt)",
				koreanKo: "Корейский (ko)",
				russianRu: "Русский (ru)",
...
}, j = "\x1B[0m", M = "\x1B[34m", ee = "\x1B[31m", N = "\x1B[32m", P = (e, t, n) => t ? `${t}${e}${n ? typeof n == "boolean" ? j : n : j}` : e;
P("✗", ee), P("✓", N), P("⏲", M);
var F = (e = "") => new Proxy(() => e, {
	get: (t, n) => {
...
}, te = process.env.INTLAYER_NODE_TYPE_INTLAYER_NODE === "false", ne = process.env.INTLAYER_NODE_TYPE_SOLID_NODE === "false", B = !0, V = !0, H = !0, U = !0, W = null, G = null, K = null, q = null, J = null;
U || (W = E(() => import("./ContentSelector--hRpRV2o.js").then((e) => ({ default: e.ContentSelector })))), B || (G = E(() => import("./MarkdownRenderer-B7hyvLDf.js").then((e) => ({ default: e.MarkdownMetadataRenderer }))), K = E(() => import("./MarkdownRenderer-B7hyvLDf.js").then((e) => ({ default: e.MarkdownRenderer }))), import("./markdown-Cvh9lBUG.js").then((e) => {
	J = e.getMarkdownMetadata;
})), V || (q = E(() => import("./HTMLRenderer-C-wPH0rg.js").then((e) => ({ default: e.HTMLRenderer }))));
var Y = te ? e : {
	...
	transform: (e, { plugins: t, ...r }) => k({
		...r,
		value: r.children,
		children: !U && n.enabled ? g(S, {
			get fallback() {
				return r.children;
			},
			get children() {
				return g(W, y(r, { get children() {
					return r.children;
				} }));
			}
		}) : r.children
		...
		let { plugins: i, ...a } = t, o = r(J?.(e) ?? {}, {
			plugins: [{
				...
				transform: (t, r) => k({
					...r,
					value: t,
					children: !U && n.enabled ? g(ContentSelector, y(a, { get children() {
						return g(S, {
							fallback: e,
							get children() {
								return g(G, y(a, {
	...
	return Z.set(r, o), o;
}, le = (e, t) => I(e, t, ce(t)), ue = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false";
process.env.INTLAYER_ROUTING_STORAGE_HEADERS;
var de = (e = Q) => {
	let { locales: t } = c;
	if (e?.isCookieEnabled === !1) return;
	let n = (e) => !!e && t.includes(e);
	if (!ue) for (let t = 0; t < (r.storage.cookies ?? []).length; t++) try {
