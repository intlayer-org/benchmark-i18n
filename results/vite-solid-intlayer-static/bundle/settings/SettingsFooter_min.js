...
import { Dynamic as te, createComponent as m, insert as h, mergeProps as g, template as _ } from "solid-js/web";
import { Suspense as v, createContext as y, createMemo as b, lazy as x, useContext as S } from "solid-js";
var C = {
	key: "settings-footer",
	content: {
...
}, w = ({ children: e, value: t, additionalProps: n }) => {
	let r = [e];
...
}, E = "\x1B[0m", D = "\x1B[34m", O = "\x1B[31m", ne = "\x1B[32m", k = (e, t, n) => t ? `${t}${e}${n ? typeof n == "boolean" ? E : n : E}` : e;
k("✗", O), k("✓", ne), k("⏲", D);
var A = (e = "") => new Proxy(() => e, {
	get: (t, n) => {
...
var K = F ? e : {
	...
	transform: (e, { plugins: t, ...r }) => w({
		...
		children: !B && n.enabled ? m(v, {
			get fallback() {
				return typeof Node < "u" && e instanceof Node ? e : T(e);
			},
			get children() {
				return m(V, g(r, { get children() {
					return typeof Node < "u" && e instanceof Node ? e : T(e);
		...
		}) : typeof Node < "u" && e instanceof Node ? e : T(e)
	})
}, J = (e, t) => {
	let n = P(e, t);
	...
	transform: (e, t) => {
		let r = e[ee], { plugins: i, ...a } = t, o = (e) => w({
			...a,
			value: r,
			children: !B && n.enabled ? m(v, {
				fallback: r,
	...
	return Q.set(r, o), o;
}, ae = (e, t) => j(e, t, ie(t)), oe = process.env.INTLAYER_ROUTING_STORAGE_COOKIES === "false";
