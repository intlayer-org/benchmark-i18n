...
var w = {
	...
	content: {
		...
		translation: {
			...
			es: {
				settings: "Ajustes",
				manageYourAccountPreferencesAnd: "Gestione las preferencias y la configuración de su cuenta."
			},
			de: {
				settings: "Einstellungen",
				manageYourAccountPreferencesAnd: "Verwalten Sie Ihre Kontoeinstellungen und -konfigurationen."
			},
			it: {
			...
			pt: {
				...
				manageYourAccountPreferencesAnd: "Gerencie suas preferências de conta e configuração."
			},
			zh: {
				settings: "设置",
			...
			ko: {
				settings: "설정",
				manageYourAccountPreferencesAnd: "계정 환경 설정 및 구성을 관리하세요."
			},
			ru: {
				settings: "Настройки",
				manageYourAccountPreferencesAnd: "Управляйте настройками и конфигурацией вашего аккаунта."
			}
		}
	},
	localIds: ["settings-header::local::src/components/pages/settings/settingsHeader.content.ts"]
...
var ge = v("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), _e = v("<p class=\"mb-8 text-muted-foreground\">");
function ve() {
	let e = $(w);
	return [
		h(he, {}),
		(() => {
			var t = ge();
			return g(t, () => e().settings), t;
		})(),
		(() => {
			var t = _e();
			return g(t, () => e().manageYourAccountPreferencesAnd), t;
		})()
	];
}
