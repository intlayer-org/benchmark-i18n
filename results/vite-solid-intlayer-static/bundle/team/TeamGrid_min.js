	...
	return (() => {
		...
		return g(e, h(y, {
			...
			children: (e) => (() => {
				...
				return g(n, () => e.name.split(" ").map((e) => e[0]).join("")), g(r, () => e.name), g(i, () => e.role), g(a, () => e.bio), t;
			})()
		})), e;
	})();
}
