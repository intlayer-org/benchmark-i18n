	...
	content: {
		...
		translation: {
			...
			es: {
				...
				meetThePeopleBehindI18n: "Conozca a las personas detrás de i18n Benchmark. Un equipo diverso unido por una pasión compartida por las excelentes herramientas de desarrollo."
			},
			de: {
				ourTeam: "Unser Team",
				meetThePeopleBehindI18n: "Lernen Sie die Menschen hinter dem i18n Benchmark kennen. Ein vielfältiges Team, das die gemeinsame Leidenschaft für großartige Entwicklertools verbindet."
			},
			it: {
				ourTeam: "Il nostro team",
				meetThePeopleBehindI18n: "Incontra le persone dietro i18n Benchmark. Un team diversificato unito da una passione condivisa per i grandi strumenti per sviluppatori."
			},
			pt: {
				ourTeam: "Nossa Equipe",
				meetThePeopleBehindI18n: "Conheça as pessoas por trás do i18n Benchmark. Uma equipe diversificada unida por uma paixão compartilhata por ótimas ferramentas de desenvolvedor."
			},
			zh: {
				ourTeam: "我们的团队",
				meetThePeopleBehindI18n: "见见 i18n 基准测试背后的人。一个多元化的团队，因对出色开发人员工具的共同热情而团结在一起。"
			},
			ja: {
				ourTeam: "私たちのチーム",
				meetThePeopleBehindI18n: "i18nベンチマークを支える人々を紹介します。優れた開発者ツールへの情熱を共有する多様なチームです。"
			},
			ko: {
				ourTeam: "우리 팀",
				meetThePeopleBehindI18n: "i18n 벤치마크를 만든 사람들을 만나보세요. 훌륭한 개발자 도구에 대한 공통된 열정으로 뭉친 다양한 팀입니다."
			},
			ru: {
				ourTeam: "Наша команда",
				meetThePeopleBehindI18n: "Познакомьтесь с людьми, стоящими за i18n Benchmark. Разнообразная команда, объединенная общей страстью к отличным инструментам разработки."
			}
		}
	},
...
function ve() {
	...
	return [
		...
		(() => {
			var t = ge();
			return g(t, () => e().ourTeam), t;
		})(),
		(() => {
			var t = _e();
			return g(t, () => e().meetThePeopleBehindI18n), t;
		})()
	];
}
