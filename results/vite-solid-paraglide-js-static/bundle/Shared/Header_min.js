...
function k() {
	...
	return (() => {
		var a = E(), l = a.firstChild.firstChild, u = l.firstChild, f = u.firstChild, p = f.firstChild, m = l.nextSibling, h = m.firstChild.firstChild;
		return r(l, e(s, {
			get href() {
				return `/${o()}`;
			},
		...
		}), f), p.$$click = () => n(!t()), p.addEventListener("mouseleave", () => n(!1)), p.addEventListener("mouseenter", () => n(!0)), r(p, () => (void 0)(), null), r(p, e(O, { get class() {
		...
		})(), null), r(h, () => (void 0)()), r(m, e(b, {}), null), r(m, e(w, {}), null), a;
	})();
}
t(["click"]);
export { k as default };
