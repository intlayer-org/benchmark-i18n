...
}), I = () => "Blog", L = () => "Blog", R = () => "Blog", te = () => "Blog", z = () => "Blog", B = () => "Blog", V = () => "博客", H = () => "ブログ", U = () => "Blog", W = () => "Блог", G = ((e = {}, t = {}) => {
	let n = t.locale ?? _();
	return n === "en" ? I(e) : n === "fr" ? L(e) : n === "es" ? R(e) : n === "de" ? te(e) : n === "it" ? z(e) : n === "pt" ? B(e) : n === "zh" ? V(e) : n === "ja" ? H(e) : n === "ko" ? U(e) : W(e);
}), K = () => "Insights, tutorials, and analysis from the i18n community.", q = () => "Articles, tutoriels et analyses de la communauté i18n.", J = () => "Información, tutoriales y análisis de la comunidad i18n.", Y = () => "Einblicke, Tutorials und Analysen aus der i18n-Community.", X = () => "Approfondimenti, tutorial e analisi dalla comunità i18n.", Z = () => "Insights, tutoriais e análises da comunidade i18n.", Q = () => "来自 i18n 社区的见解、教程和分析。", ne = () => "i18nコミュニティからのインサイト、チュートリアル、分析。", re = () => "Insights, tutorials, and analysis from the i18n community.", ie = () => "Инсайты, туториалы и аналитика от сообщества i18n.", ae = ((e = {}, t = {}) => {
	let n = t.locale ?? _();
