...
function AboutGrid() {
	return (() => {
		...
		insert(_el$3, () => about_grid_whyexiststitle2());
		insert(_el$4, () => about_grid_whyexistsdesc2());
		insert(_el$6, () => about_grid_methodologytitle1());
		insert(_el$7, () => about_grid_methodologydesc1());
		return _el$;
	})();
}
