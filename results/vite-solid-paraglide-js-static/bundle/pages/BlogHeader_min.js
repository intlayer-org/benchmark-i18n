...
var F = () => "Insights, tutorials, and analysis from the i18n community.", I = () => "Articles, tutoriels et analyses de la communauté i18n.", L = () => "Información, tutoriales y análisis de la comunidad i18n.", R = () => "Einblicke, Tutorials und Analysen aus der i18n-Community.", z = () => "Approfondimenti, tutorial e analisi dalla comunità i18n.", B = () => "Insights, tutoriais e análises da comunidade i18n.", V = () => "来自 i18n 社区的见解、教程和分析。", H = () => "i18nコミュニティからのインサイト、チュートリアル、分析。", U = () => "Insights, tutorials, and analysis from the i18n community.", W = () => "Инсайты, туториалы и аналитика от сообщества i18n.", G = ((e = {}, t = {}) => {
	let n = t.locale ?? f();
	return n === "fr" ? I(e) : n === "es" ? L(e) : n === "de" ? R(e) : n === "it" ? z(e) : n === "pt" ? B(e) : n === "zh" ? V(e) : n === "ja" ? H(e) : n === "ko" ? U(e) : n === "ru" ? W(e) : F(e);
}), K = () => "Blog", te = () => "Blog", q = () => "Blog", J = () => "Blog", Y = () => "Blog", X = () => "Blog", Z = () => "博客", Q = () => "ブログ", ne = () => "Blog", re = () => "Блог", ie = ((e = {}, t = {}) => {
	let n = t.locale ?? f();
