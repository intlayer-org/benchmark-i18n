...
function UnderstandingImpact() {
	return (() => {
		...
		insert(_el$2, () => home_understandingimpact_title1());
		insert(_el$4, () => home_understandingimpact_singlejsontitle3());
		insert(_el$5, () => home_understandingimpact_singlejsonintro3());
		insert(_el$7, () => home_understandingimpact_singlejsonbullet13());
		insert(_el$8, () => home_understandingimpact_singlejsonbullet23());
		insert(_el$9, () => home_understandingimpact_singlejsonbullet33());
		insert(_el$1, () => home_understandingimpact_tradeoffstitle3());
		insert(_el$10, () => home_understandingimpact_tradeoffsintro3());
		insert(_el$13, () => home_understandingimpact_waterfalllabel2());
		insert(_el$12, () => home_understandingimpact_waterfalldesc2(), null);
		insert(_el$16, () => home_understandingimpact_fouclabel2());
		insert(_el$15, () => home_understandingimpact_foucdesc2(), null);
		insert(_el$19, () => home_understandingimpact_cachelabel2());
		insert(_el$18, () => home_understandingimpact_cachedesc2(), null);
		insert(_el$22, () => home_understandingimpact_measurestitle2());
		insert(_el$23, () => home_understandingimpact_measuresdesc2());
		return _el$;
	})();
}
