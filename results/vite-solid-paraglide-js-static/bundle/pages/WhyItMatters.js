...
function WhyItMatters() {
	return (() => {
		...
		insert(_el$2, () => home_whyitmatters_title2());
		insert(_el$5, () => home_whyitmatters_bundlesizetitle4());
		insert(_el$6, () => home_whyitmatters_bundlesizedesc4());
		insert(_el$8, () => home_whyitmatters_renderingtitle3());
		insert(_el$9, () => home_whyitmatters_renderingdesc3());
		insert(_el$1, () => home_whyitmatters_dynamicloadingtitle4());
		insert(_el$10, () => home_whyitmatters_dynamicloadingdesc4());
		return _el$;
	})();
}
