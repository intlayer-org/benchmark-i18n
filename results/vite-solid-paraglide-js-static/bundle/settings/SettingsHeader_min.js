...
}), K = () => "Manage your account preferences and configuration.", te = () => "Gérez les préférences et la configuration de votre compte.", q = () => "Gestiona las preferencias y la configuración de tu cuenta.", J = () => "Verwalten Sie Ihre Kontoeinstellungen und Konfiguration.", Y = () => "Gestisci le preferenze del tuo account e la configurazione.", X = () => "Gerencie suas preferências de conta e configuração.", Z = () => "管理您的账户偏好和配置。", Q = () => "アカウント設定と構成を管理します。", ne = () => "Manage your account preferences and configuration.", re = () => "Управляйте предпочтениями и конфигурацией вашей учетной записи.", ie = ((e = {}, t = {}) => {
	let n = t.locale ?? f();
	return n === "fr" ? te(e) : n === "es" ? q(e) : n === "de" ? J(e) : n === "it" ? Y(e) : n === "pt" ? X(e) : n === "zh" ? Z(e) : n === "ja" ? Q(e) : n === "ko" ? ne(e) : n === "ru" ? re(e) : K(e);
}), ae = () => "Settings", oe = () => "Paramètres", se = () => "Ajustes", ce = () => "Einstellungen", le = () => "Impostazioni", ue = () => "Configurações", de = () => "设置", fe = () => "設定", pe = () => "Settings", $ = () => "Настройки", me = ((e = {}, t = {}) => {
	let n = t.locale ?? f();
...
var _e = n("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), ve = n("<p class=\"mb-8 text-muted-foreground\">");
function ye() {
	return [
		e(ge, {}),
		(() => {
