...
}, [m, h] = o("en"), g = f(() => p[m()], u), _ = r("<footer class=\"mt-20 border-t border-border bg-card\"><div class=\"container py-8\"><div class=\"grid gap-8 md:grid-cols-3\"><div><h3 class=\"mb-2 text-sm font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p></div><div><h3 class=\"mb-2 text-sm font-semibold text-foreground\"></h3><ul class=space-y-1><li><a href=https://github.com/intlayer-org/benchmark-i18n target=_blank rel=noreferrer class=\"text-sm text-muted-foreground transition-colors hover:text-foreground\"></a></li><li></li><li></li></ul></div><div><h3 class=\"mb-2 text-sm font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p></div></div><div class=\"mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground\">");
function v() {
	let n = a(), r = () => n.locale ?? "en";
	return (() => {
		var n = _(), a = n.firstChild.firstChild, o = a.firstChild, s = o.firstChild, c = s.nextSibling, l = o.nextSibling, u = l.firstChild, d = u.nextSibling.firstChild, f = d.firstChild, p = d.nextSibling, m = p.nextSibling, h = l.nextSibling.firstChild, v = h.nextSibling, y = a.nextSibling;
		return t(s, () => g("footer.title")), t(c, () => g("footer.description")), t(u, () => g("footer.resources")), t(f, () => g("footer.github")), t(p, e(i, {
			get href() {
				return `/${r()}/about`;
			},
			class: "text-sm text-muted-foreground transition-colors hover:text-foreground",
			get children() {
				return g("footer.methodology");
			}
		})), t(m, e(i, {
			get href() {
				return `/${r()}/contact`;
			...
			class: "text-sm text-muted-foreground transition-colors hover:text-foreground",
			get children() {
				return g("footer.contributing");
			}
		})), t(h, () => g("footer.contact")), t(v, () => g("shared.contactEmail")), t(y, () => g("footer.builtWith")), n;
	})();
}
function y(e) {
	return n(() => e.children);
