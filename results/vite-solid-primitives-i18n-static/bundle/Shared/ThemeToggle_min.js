...
var u = o("<button type=button class=\"rounded-md border border-border bg-accent px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-accent/80\">");
function d() {
...
function p() {
	...
	l(() => {
		...
		if (e() !== "auto") return;
		let t = window.matchMedia("(prefers-color-scheme: dark)"), n = () => f("auto");
	...
	function i() {
		...
		t(r), f(r), window.localStorage.setItem("theme", r);
	}
	let o = () => e() === "auto" ? "Theme mode: auto (system). Click to switch to light mode." : `Theme mode: ${e()}. Click to switch mode.`, p = () => e() === "auto" ? "Theme: Auto" : e() === "dark" ? "Theme: Dark" : "Theme: Light";
	return (() => {
		var e = u();
		return e.$$click = i, r(e, p), n((t) => {
			var n = o(), r = o();
...
t(["click"]);
var m = (e) => e != null && (e = Object.getPrototypeOf(e), e === Array.prototype || e === Object.prototype);
function h(e, t, n) {
...
function g(e) {
	let t = { ...e };
	for (let [n, r] of Object.entries(e)) m(r) && h(t, r, n);
	return t;
}
g({
	shared: {
