...
}, [f, p] = i("en"), m = u(() => d[f()], c), h = r("<div class=\"grid gap-8 md:grid-cols-2\"><div class=\"rounded-lg border border-border bg-card p-6\"><h2 class=\"mb-3 text-xl font-semibold text-foreground\"></h2><p class=\"text-sm text-muted-foreground\"></p></div><div class=\"rounded-lg border border-border bg-card p-6\"><h2 class=\"mb-3 text-xl font-semibold text-foreground\"></h2><p class=\"text-sm text-muted-foreground\">");
function g() {
	return (() => {
		var e = h(), n = e.firstChild, r = n.firstChild, i = r.nextSibling, a = n.nextSibling.firstChild, o = a.nextSibling;
		return t(r, () => m("about.grid.whyExistsTitle")), t(i, () => m("about.grid.whyExistsDesc")), t(a, () => m("about.grid.methodologyTitle")), t(o, () => m("about.grid.methodologyDesc")), e;
	})();
}
function _(e) {
	return n(() => e.children);
