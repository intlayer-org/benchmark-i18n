...
import { createSignal as r, onMount as i } from "solid-js";
function a(e) {
...
var o = n("<h1 class=\"mb-4 text-3xl font-bold text-foreground\">About This Benchmark"), s = n("<p class=\"mb-8 max-w-3xl text-muted-foreground\">This is an open-source test application — not a product or a company. Its sole purpose is to provide a realistic, multi-page React app where different i18n libraries can be integrated and measured under identical conditions.");
function c() {
	return a("AboutHeader"), [o(), s()];
}
var l = (e) => e != null && (e = Object.getPrototypeOf(e), e === Array.prototype || e === Object.prototype);
function u(e, t, n) {
...
function d(e) {
	let t = { ...e };
	for (let [n, r] of Object.entries(e)) l(r) && u(t, r, n);
	return t;
}
d({
	shared: {
