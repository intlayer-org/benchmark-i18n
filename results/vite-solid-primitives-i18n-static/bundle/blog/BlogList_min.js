...
function c() {
	...
	return (() => {
		...
		return t(r, e(i, {
			each: n,
			children: (e) => (() => {
				var n = s(), r = n.firstChild, i = r.firstChild, a = i.nextSibling, o = r.nextSibling, c = o.nextSibling;
				return t(i, () => e.category), t(a, () => e.date), t(o, () => e.title), t(c, () => e.excerpt), n;
			})()
		})), r;
	})();
}
