...
var o = r("<div class=\"mb-12 grid gap-4 md:grid-cols-3\">"), s = r("<div class=\"rounded-lg border border-border bg-card p-4 text-center\"><p class=\"text-sm font-semibold text-foreground\"></p><p class=\"text-xs text-muted-foreground\">");
function c() {
	let n = [
		{
			label: "Remote-first",
	...
	return (() => {
		...
		return t(r, e(i, {
			each: n,
			children: (e) => (() => {
				var n = s(), r = n.firstChild, i = r.nextSibling;
