...
function y() {
	...
	return [(() => {
		var e = g();
		return t(e, () => h("careers.openPositions.title")), e;
	})(), (() => {
		var r = _();
		return t(r, e(i, {
			each: n,
			children: (e) => (() => {
				var n = v(), r = n.firstChild, i = r.firstChild, a = i.nextSibling, o = a.nextSibling.firstChild, s = o.nextSibling, c = s.nextSibling, l = r.nextSibling;
				return t(i, () => h(`careers.openPositions.${e.titleKey}`)), t(a, () => h(`careers.openPositions.${e.descKey}`)), t(o, () => h(`careers.openPositions.${e.deptKey}`)), t(s, () => h(`careers.openPositions.${e.locationKey}`)), t(c, () => h(`careers.openPositions.${e.typeKey}`)), t(l, () => h("careers.openPositions.applyNow")), n;
			})()
		})), r;
	})()];
}
