...
var a = r("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\">⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service.");
function o() {
	return a();
}
...
}, [m, h] = i("en"), g = f(() => p[m()], u), _ = r("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), v = r("<p class=\"mb-8 text-muted-foreground\"> <a href=mailto:contact@intlayer.org class=\"text-primary hover:underline\"></a>.");
function y() {
	return [
		e(o, {}),
		(() => {
			var e = _();
			return t(e, () => g("contact.header.title")), e;
		})(),
		(() => {
			var e = v(), n = e.firstChild, r = n.nextSibling;
			return t(e, () => g("contact.header.description"), n), t(r, () => g("shared.contactEmail")), e;
		})()
	];
}
function b(e) {
