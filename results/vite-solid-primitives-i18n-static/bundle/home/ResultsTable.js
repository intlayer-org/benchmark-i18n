...
function ResultsTable() {
	...
	return (() => {
		...
		insert(_el$2, () => t("home.resultsTable.title"));
		insert(_el$7, () => t("home.resultsTable.library"));
		insert(_el$8, () => t("home.resultsTable.bundleSize"));
		insert(_el$9, () => t("home.resultsTable.lookupTime"));
		insert(_el$0, () => t("home.resultsTable.lazyLoading"));
		insert(_el$1, createComponent(For, {
			...
			children: (r) => (() => {
				...
				insert(_el$14, () => t(`home.resultsTable.${r.lazyMsg}`));
				return _el$10;
			})()
		}));
		return _el$;
...
function Wrapped() {
	return createComponent(Wrapper, { get children() {
		return createComponent(ResultsTable, {});
	} });
}
