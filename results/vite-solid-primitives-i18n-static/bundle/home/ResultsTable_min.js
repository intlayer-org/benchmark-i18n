...
var s = (e) => e != null && (e = Object.getPrototypeOf(e), e === Array.prototype || e === Object.prototype);
function c(e, t, n) {
...
function l(e) {
	let t = { ...e };
	for (let [n, r] of Object.entries(e)) s(r) && c(t, r, n);
	return t;
}
var u = (e, t) => {
...
var v = r("<section><h2 class=\"mb-6 text-2xl font-bold text-foreground\"></h2><div class=\"overflow-x-auto rounded-lg border border-border\"><table class=\"w-full text-sm\"><thead class=bg-muted><tr><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th></tr></thead><tbody>"), y = r("<tr class=\"border-t border-border\"><td class=\"px-4 py-3 font-medium text-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\">");
function b() {
	_("ResultsTable");
	let n = [
		{
	...
	return (() => {
		var r = v(), a = r.firstChild, o = a.nextSibling.firstChild.firstChild, s = o.firstChild.firstChild, c = s.nextSibling, l = c.nextSibling, u = l.nextSibling, d = o.nextSibling;
		return t(a, () => g("home.resultsTable.title")), t(s, () => g("home.resultsTable.library")), t(c, () => g("home.resultsTable.bundleSize")), t(l, () => g("home.resultsTable.lookupTime")), t(u, () => g("home.resultsTable.lazyLoading")), t(d, e(i, {
			each: n,
			children: (e) => (() => {
				var n = y(), r = n.firstChild, i = r.nextSibling, a = i.nextSibling, o = a.nextSibling;
				return t(r, () => e.lib), t(i, () => e.size), t(a, () => e.time), t(o, () => g(`home.resultsTable.${e.lazyMsg}`)), n;
			})()
		})), r;
	})();
}
