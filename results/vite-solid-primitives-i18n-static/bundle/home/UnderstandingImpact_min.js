...
var o = (e) => e != null && (e = Object.getPrototypeOf(e), e === Array.prototype || e === Object.prototype);
function s(e, t, n) {
...
function c(e) {
	let t = { ...e };
	for (let [n, r] of Object.entries(e)) o(r) && s(t, r, n);
	return t;
}
var l = (e, t) => {
...
var _ = r("<section class=\"mx-auto mb-16 max-w-3xl space-y-6\"><h2 class=\"text-2xl font-bold text-foreground\"></h2><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p><ul class=\"mt-3 list-disc space-y-2 pl-5 text-sm text-muted-foreground\"><li></li><li></li><li></li></ul></div><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p><ul class=\"mt-3 list-disc space-y-2 pl-5 text-sm text-muted-foreground\"><li><strong class=text-foreground></strong> </li><li><strong class=text-foreground></strong> </li><li><strong class=text-foreground></strong> </li></ul></div><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\">");
function v() {
	return g("UnderstandingImpact"), (() => {
		var e = _(), n = e.firstChild, r = n.nextSibling, i = r.firstChild, a = i.nextSibling, o = a.nextSibling.firstChild, s = o.nextSibling, c = s.nextSibling, l = r.nextSibling, u = l.firstChild, d = u.nextSibling, f = d.nextSibling.firstChild, p = f.firstChild;
		p.nextSibling;
		var m = f.nextSibling, g = m.firstChild;
		g.nextSibling;
		var v = m.nextSibling, y = v.firstChild;
		y.nextSibling;
		var b = l.nextSibling.firstChild, x = b.nextSibling;
		return t(n, () => h("home.understandingImpact.title")), t(i, () => h("home.understandingImpact.singleJsonTitle")), t(a, () => h("home.understandingImpact.singleJsonIntro")), t(o, () => h("home.understandingImpact.singleJsonBullet1")), t(s, () => h("home.understandingImpact.singleJsonBullet2")), t(c, () => h("home.understandingImpact.singleJsonBullet3")), t(u, () => h("home.understandingImpact.tradeOffsTitle")), t(d, () => h("home.understandingImpact.tradeOffsIntro")), t(p, () => h("home.understandingImpact.waterfallLabel")), t(f, () => h("home.understandingImpact.waterfallDesc"), null), t(g, () => h("home.understandingImpact.foucLabel")), t(m, () => h("home.understandingImpact.foucDesc"), null), t(y, () => h("home.understandingImpact.cacheLabel")), t(v, () => h("home.understandingImpact.cacheDesc"), null), t(b, () => h("home.understandingImpact.measuresTitle")), t(x, () => h("home.understandingImpact.measuresDesc")), e;
	})();
}
function y(e) {
	return n(() => e.children);
