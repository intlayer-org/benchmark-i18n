...
function WhyItMatters() {
	...
	return (() => {
		...
		insert(_el$2, () => t("home.whyItMatters.title"));
		insert(_el$5, () => t("home.whyItMatters.bundleSizeTitle"));
		insert(_el$6, () => t("home.whyItMatters.bundleSizeDesc"));
		insert(_el$8, () => t("home.whyItMatters.renderingTitle"));
		insert(_el$9, () => t("home.whyItMatters.renderingDesc"));
		insert(_el$1, () => t("home.whyItMatters.dynamicLoadingTitle"));
		insert(_el$10, () => t("home.whyItMatters.dynamicLoadingDesc"));
		return _el$;
	})();
}
