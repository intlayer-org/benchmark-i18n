...
var _ = r("<section class=mb-16><h2 class=\"mb-6 text-2xl font-bold text-foreground\"></h2><div class=\"grid gap-6 md:grid-cols-3\"><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p></div><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p></div><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\">");
function v() {
	return g("WhyItMatters"), (() => {
		var e = _(), n = e.firstChild, r = n.nextSibling.firstChild, i = r.firstChild, a = i.nextSibling, o = r.nextSibling, s = o.firstChild, c = s.nextSibling, l = o.nextSibling.firstChild, u = l.nextSibling;
		return t(n, () => h("home.whyItMatters.title")), t(i, () => h("home.whyItMatters.bundleSizeTitle")), t(a, () => h("home.whyItMatters.bundleSizeDesc")), t(s, () => h("home.whyItMatters.renderingTitle")), t(c, () => h("home.whyItMatters.renderingDesc")), t(l, () => h("home.whyItMatters.dynamicLoadingTitle")), t(u, () => h("home.whyItMatters.dynamicLoadingDesc")), e;
	})();
}
function y(e) {
	return n(() => e.children);
