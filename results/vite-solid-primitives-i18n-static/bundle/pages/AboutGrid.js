...
function AboutGrid() {
	return (() => {
		...
		insert(_el$3, () => t("about.grid.whyExistsTitle"));
		insert(_el$4, () => t("about.grid.whyExistsDesc"));
		insert(_el$6, () => t("about.grid.methodologyTitle"));
		insert(_el$7, () => t("about.grid.methodologyDesc"));
		return _el$;
	})();
}
