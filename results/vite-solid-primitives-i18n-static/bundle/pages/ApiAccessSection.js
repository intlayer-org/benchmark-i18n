...
function ApiAccessSection() {
	...
	return (() => {
		...
		insert(_el$2, () => t("settings.apiAccess.title"));
		setAttribute(_el$4, "for", apiKeyId);
		insert(_el$4, () => t("settings.apiAccess.apiKey"));
		setAttribute(_el$6, "id", apiKeyId);
		insert(_el$7, () => t("settings.apiAccess.copy"));
		insert(_el$8, () => t("settings.apiAccess.description"));
		return _el$;
	})();
}
