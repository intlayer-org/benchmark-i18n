...
}, [m, h] = i("en"), g = f(() => p[m()], u), _ = r("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), v = r("<p class=\"mb-10 text-muted-foreground\">");
function y() {
	return [
		e(o, {}),
		(() => {
			var e = _();
			return t(e, () => g("blog.header.title")), e;
		})(),
		(() => {
			var e = v();
			return t(e, () => g("blog.header.description")), e;
		})()
	];
}
function b(e) {
