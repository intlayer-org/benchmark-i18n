	...
	return (() => {
		...
		insert(_el$1, createComponent(For, {
			...
			children: (topic) => (() => {
				var _el$14 = _tmpl$2();
				_el$14.value = topic;
				insert(_el$14, () => t(`contact.form.${topic}`));
				return _el$14;
			})()
		}));
		setAttribute(_el$11, "for", messageId);
		insert(_el$11, () => t("contact.form.message"));
		setAttribute(_el$12, "id", messageId);
		insert(_el$13, () => t("contact.form.sendMessage"));
		effect((_p$) => {
			var _v$ = t("contact.form.yourName"), _v$2 = t("contact.form.emailPlaceholder"), _v$3 = t("contact.form.messagePlaceholder");
