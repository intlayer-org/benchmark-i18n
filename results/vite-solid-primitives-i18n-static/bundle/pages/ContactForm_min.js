...
function S() {
	let r = c(), a = c(), s = c(), l = c();
	return (() => {
		var c = y(), u = c.firstChild, d = u.firstChild, f = d.firstChild, p = f.nextSibling, m = d.nextSibling.firstChild, h = m.nextSibling, g = u.nextSibling, _ = g.firstChild, S = _.nextSibling, C = g.nextSibling, w = C.firstChild, T = w.nextSibling, E = C.nextSibling;
		return i(f, "for", r), n(f, () => v("contact.form.name")), i(p, "id", r), i(m, "for", a), n(m, () => v("contact.form.email")), i(h, "id", a), i(_, "for", s), n(_, () => v("contact.form.topic")), i(S, "id", s), n(S, e(o, {
			each: x,
			children: (e) => (() => {
				var t = b();
				return t.value = e, n(t, () => v(`contact.form.${e}`)), t;
			})()
		})), i(w, "for", l), n(w, () => v("contact.form.message")), i(T, "id", l), n(E, () => v("contact.form.sendMessage")), t((e) => {
			var t = v("contact.form.yourName"), n = v("contact.form.emailPlaceholder"), r = v("contact.form.messagePlaceholder");
			return t !== e.e && i(p, "placeholder", e.e = t), n !== e.t && i(h, "placeholder", e.t = n), r !== e.a && i(T, "placeholder", e.a = r), e;
		}, {
			e: void 0,
			t: void 0,
			a: void 0
