...
function OpenPositions() {
	...
	return [(() => {
		var _el$ = _tmpl$();
		insert(_el$, () => t("careers.openPositions.title"));
		return _el$;
	})(), (() => {
		var _el$2 = _tmpl$2();
		insert(_el$2, createComponent(For, {
			...
			children: (o) => (() => {
				...
				insert(_el$5, () => t(`careers.openPositions.${o.titleKey}`));
				insert(_el$6, () => t(`careers.openPositions.${o.descKey}`));
				insert(_el$8, () => t(`careers.openPositions.${o.deptKey}`));
				insert(_el$9, () => t(`careers.openPositions.${o.locationKey}`));
				insert(_el$0, () => t(`careers.openPositions.${o.typeKey}`));
				insert(_el$1, () => t("careers.openPositions.applyNow"));
				return _el$3;
			})()
		}));
		return _el$2;
