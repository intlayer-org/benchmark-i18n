...
import { For as o, createSignal as s } from "solid-js";
...
}, [h, g] = s("en"), _ = p(() => m[h()], d), v = a("<div class=\"grid gap-6 md:grid-cols-3\">"), y = a("<div><h3 class=\"text-lg font-semibold text-foreground\"></h3><div class=my-4><span class=\"text-3xl font-bold text-foreground\"></span><span class=\"text-sm text-muted-foreground\"></span></div><ul class=\"mb-6 flex-1 space-y-2\"></ul><button type=button>"), b = a("<li class=\"flex items-center gap-2 text-sm text-muted-foreground\"><span class=text-primary>✓</span> "), x = [
	{
		id: "starter",
		highlighted: !1,
		featureKeys: [
...
function S() {
	return (() => {
		...
		return r(i, t(o, {
			each: x,
			children: (i) => {
				let a = i.id, s = a === "enterprise" ? "" : _(`pricing.tiers.${a}Period`);
				return (() => {
					var c = y(), l = c.firstChild, u = l.nextSibling, d = u.firstChild, f = d.nextSibling, p = u.nextSibling, m = p.nextSibling;
					return r(l, () => _(`pricing.tiers.${a}Name`)), r(d, () => _(`pricing.tiers.${a}Price`)), r(f, s), r(p, t(o, {
						get each() {
							return [...i.featureKeys];
						},
						children: (e) => (() => {
							var t = b();
							return t.firstChild.nextSibling, r(t, () => _(`pricing.tiers.${e}`), null), t;
						})()
					})), r(m, () => _(a === "enterprise" ? "pricing.tiers.contactSales" : "pricing.tiers.getStarted")), n((t) => {
