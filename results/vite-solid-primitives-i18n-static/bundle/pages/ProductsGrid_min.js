...
function v() {
	...
	return (() => {
		...
		return t(r, e(i, {
			each: n,
			children: (e) => (() => {
				var n = _(), r = n.firstChild, i = r.firstChild, a = i.nextSibling, o = r.nextSibling.firstChild, s = o.nextSibling;
				return t(i, () => h(`products.grid.${e}Name`)), t(a, () => h(`products.grid.${e}Desc`)), t(o, () => h(`products.grid.${e}Price`)), t(s, () => h("products.grid.learnMore")), n;
			})()
		})), r;
	})();
}
