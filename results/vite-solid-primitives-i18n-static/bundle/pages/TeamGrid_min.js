...
function v() {
	...
	return (() => {
		...
		return t(r, e(i, {
			each: n,
			children: (e) => {
				let n = h(`team.grid.member${e}Name`);
				return (() => {
					var r = _(), i = r.firstChild, a = i.nextSibling, o = a.nextSibling, s = o.nextSibling;
					return t(i, () => n.split(" ").map((e) => e[0]).join("")), t(a, n), t(o, () => h(`team.grid.member${e}Role`)), t(s, () => h(`team.grid.member${e}Bio`)), r;
				})();
			}
		})), r;
	})();
