...
var a = (e) => e != null && (e = Object.getPrototypeOf(e), e === Array.prototype || e === Object.prototype);
function o(e, t, n) {
...
function s(e) {
	let t = { ...e };
	for (let [n, r] of Object.entries(e)) a(r) && o(t, r, n);
	return t;
}
var c = (e, t) => {
...
}, [f, p] = i("en"), m = u(() => d[f()], c), h = r("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\">⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service.");
function g() {
	return h();
}
var _ = r("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), v = r("<p class=\"mb-10 text-muted-foreground\">");
function y() {
	return [
		e(g, {}),
		(() => {
			var e = _();
			return t(e, () => m("team.header.title")), e;
		})(),
		(() => {
			var e = v();
			return t(e, () => m("team.header.description")), e;
		})()
	];
}
function b(e) {
