...
function UnderstandingImpact() {
	...
	return (() => {
		...
		insert(_el$2, () => t("home.understandingImpact.title"));
		insert(_el$4, () => t("home.understandingImpact.singleJsonTitle"));
		insert(_el$5, () => t("home.understandingImpact.singleJsonIntro"));
		insert(_el$7, () => t("home.understandingImpact.singleJsonBullet1"));
		insert(_el$8, () => t("home.understandingImpact.singleJsonBullet2"));
		insert(_el$9, () => t("home.understandingImpact.singleJsonBullet3"));
		insert(_el$1, () => t("home.understandingImpact.tradeOffsTitle"));
		insert(_el$10, () => t("home.understandingImpact.tradeOffsIntro"));
		insert(_el$13, () => t("home.understandingImpact.waterfallLabel"));
		insert(_el$12, () => t("home.understandingImpact.waterfallDesc"), null);
		insert(_el$16, () => t("home.understandingImpact.foucLabel"));
		insert(_el$15, () => t("home.understandingImpact.foucDesc"), null);
		insert(_el$19, () => t("home.understandingImpact.cacheLabel"));
		insert(_el$18, () => t("home.understandingImpact.cacheDesc"), null);
		insert(_el$22, () => t("home.understandingImpact.measuresTitle"));
		insert(_el$23, () => t("home.understandingImpact.measuresDesc"));
		return _el$;
	})();
}
