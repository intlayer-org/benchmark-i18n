...
var [locale, setLocale] = createSignal("en");
...
function PreferencesSection() {
	...
	return (() => {
		...
		insert(_el$2, () => t("settings.preferences.title"));
		insert(_el$6, () => t("settings.preferences.emailNotifications"));
		insert(_el$7, () => t("settings.preferences.weeklyReports"));
		insert(_el$1, () => t("settings.preferences.darkMode"));
		insert(_el$10, () => t("settings.preferences.darkColorScheme"));
		setAttribute(_el$13, "for", languageId);
		insert(_el$13, () => t("settings.preferences.defaultLanguage"));
		setAttribute(_el$14, "id", languageId);
		insert(_el$15, () => t("settings.preferences.english"));
		insert(_el$16, () => t("settings.preferences.french"));
		insert(_el$17, () => t("settings.preferences.german"));
		insert(_el$18, () => t("settings.preferences.spanish"));
		insert(_el$19, () => t("settings.preferences.japanese"));
		insert(_el$20, () => t("settings.preferences.chinese"));
		insert(_el$21, () => t("settings.preferences.arabic"));
		effect((_p$) => {
			var _v$ = t("settings.preferences.toggleNotifications"), _v$2 = t("settings.preferences.toggleDarkMode");
