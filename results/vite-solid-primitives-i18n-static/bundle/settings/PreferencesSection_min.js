...
import { createSignal as o, createUniqueId as s } from "solid-js";
var c = (e) => e != null && (e = Object.getPrototypeOf(e), e === Array.prototype || e === Object.prototype);
function l(e, t, n) {
...
function u(e) {
	let t = { ...e };
	for (let [n, r] of Object.entries(e)) c(r) && l(t, r, n);
	return t;
}
var d = (e, t) => {
...
}, [h, g] = o("en"), _ = p(() => m[h()], d), v = a("<section class=\"rounded-lg border border-border bg-card p-6\"><h2 class=\"mb-4 text-lg font-semibold text-foreground\"></h2><div class=space-y-4><div class=\"flex items-center justify-between\"><div><p class=\"text-sm font-medium text-foreground\"></p><p class=\"text-xs text-muted-foreground\"></p></div><button type=button class=\"h-6 w-11 rounded-full bg-primary transition-colors\"><span class=\"block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform\"></span></button></div><div class=\"flex items-center justify-between\"><div><p class=\"text-sm font-medium text-foreground\"></p><p class=\"text-xs text-muted-foreground\"></p></div><button type=button class=\"h-6 w-11 rounded-full bg-muted transition-colors\"><span class=\"block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform\"></span></button></div><div><label class=\"mb-1 block text-sm font-medium text-foreground\"></label><select class=\"w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring\"><option></option><option></option><option></option><option></option><option></option><option></option><option>");
function y() {
	let e = s();
	return (() => {
		var r = v(), a = r.firstChild, o = a.nextSibling.firstChild, s = o.firstChild, c = s.firstChild, l = c.nextSibling, u = s.nextSibling, d = o.nextSibling, f = d.firstChild, p = f.firstChild, m = p.nextSibling, h = f.nextSibling, g = d.nextSibling.firstChild, y = g.nextSibling, b = y.firstChild, x = b.nextSibling, S = x.nextSibling, C = S.nextSibling, w = C.nextSibling, T = w.nextSibling, E = T.nextSibling;
		return n(a, () => _("settings.preferences.title")), n(c, () => _("settings.preferences.emailNotifications")), n(l, () => _("settings.preferences.weeklyReports")), n(p, () => _("settings.preferences.darkMode")), n(m, () => _("settings.preferences.darkColorScheme")), i(g, "for", e), n(g, () => _("settings.preferences.defaultLanguage")), i(y, "id", e), n(b, () => _("settings.preferences.english")), n(x, () => _("settings.preferences.french")), n(S, () => _("settings.preferences.german")), n(C, () => _("settings.preferences.spanish")), n(w, () => _("settings.preferences.japanese")), n(T, () => _("settings.preferences.chinese")), n(E, () => _("settings.preferences.arabic")), t((e) => {
			var t = _("settings.preferences.toggleNotifications"), n = _("settings.preferences.toggleDarkMode");
			return t !== e.e && i(u, "aria-label", e.e = t), n !== e.t && i(h, "aria-label", e.t = n), e;
		}, {
			e: void 0,
			t: void 0
		}), r;
