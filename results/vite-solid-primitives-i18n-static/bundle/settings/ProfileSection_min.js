...
function v() {
	let e = o(), n = o();
	return (() => {
		var i = _(), a = i.firstChild, o = a.nextSibling.firstChild, s = o.firstChild, c = s.nextSibling, l = o.nextSibling.firstChild, u = l.nextSibling;
		return t(a, () => g("settings.profile.title")), r(s, "for", e), t(s, () => g("settings.profile.displayName")), r(c, "id", e), r(l, "for", n), t(l, () => g("settings.profile.email")), r(u, "id", n), i;
	})();
}
function y(e) {
	return n(() => e.children);
