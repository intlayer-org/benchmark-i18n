		...
		insert(_el$, createComponent(For, {
			...
			children: (n) => {
				...
				return (() => {
					...
					insert(_el$3, () => name.split(" ").map((part) => part[0]).join(""));
					insert(_el$4, name);
					insert(_el$5, () => t(`team.grid.member${n}Role`));
					insert(_el$6, () => t(`team.grid.member${n}Bio`));
					return _el$2;
				})();
			}
		}));
...
function Wrapped() {
	return createComponent(Wrapper, { get children() {
		return createComponent(TeamGrid, {});
	} });
}
