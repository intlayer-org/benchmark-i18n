...
var _ = Object.defineProperty, v = Object.defineProperties, y = Object.getOwnPropertyDescriptors, b = Object.getOwnPropertySymbols, ee = Object.prototype.hasOwnProperty, x = Object.prototype.propertyIsEnumerable, S = (e, t, n) => t in e ? _(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
}, N = (e) => Object.fromEntries(ue(e).entries()), P = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function xe(e, t, n, r, i, a, o, s) {
	...
	let E = Object.freeze({
		...
		getInitialLanguage() {
			let e = n();
			return O(x(), (t) => (!e || e.includes(t)) && t ? t : S());
		},
		setStoredLanguage(e) {
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ae(e) || L, r = t().onFormatError, a = typeof r;
...
function Ee({ options: e }) {
	let t = fe(), n = Se(!1, () => o.isFetching(), t.onFetchingChange.emit), r = Se(!1, () => x.isLoading(), t.onLoadingChange.emit), i = Ce(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = xe(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = ge(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Oe = () => {
	...
	return t;
}, ke = 0, Ae = 1, je = 2, Me = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === ke ? r = "Empty parameter" : e === Ae ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Ne(e) {
	return /\s/.test(e);
}
var z = 0, B = 1, V = 2, H = 3, U = 4, Pe = /* @__PURE__ */ new Set([
	V,
	B,
	z
]), W = "'", Fe = /* @__PURE__ */ new Set([
	"{",
	"}",
	W
...
function Le(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case z:
			...
			break;
		case B:
			Fe.has(i) ? (n = n.slice(0, -1) + i, t = V) : (n += i, t = z);
			break;
		case V:
			i === W ? t = z : (n += i, t = V);
			break;
		case H:
			i === "}" ? (d(), t = z) : Ne(i) ? r !== "" && (d(), t = U) : (u(), t = H);
			break;
		case U: i == "}" ? t = z : Ne(i) ? t = U : c(Ae);
	}
...
(T = console.assert) == null || T.call(console, We), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ge(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, et = 3e3, tt = 200, nt = 0, q = /* @__PURE__ */ new Map(), rt = !1, J, Y;
...
var at = (e) => new K("unavailable", `the Tolgee browser extension did not answer ${e} in time`), ot = () => `${Date.now()}-${nt++}-${Math.random()}`;
function st() {
...
function ct(e) {
	return J ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Ze }, window.origin), i = () => {
			clearInterval(a), lt(), Y = void 0, n(new K("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
function Ht() {
	let e = sessionStorage.getItem(Et) || void 0, t = sessionStorage.getItem(Dt) || void 0, n = sessionStorage.getItem(Ot) || void 0, r = sessionStorage.getItem(kt) || void 0, i = $e(sessionStorage.getItem(At));
	if (!t) return;
	let a = C(C({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return w(C({}, a), { apiKey: e });
	if (i && r) return w(C({}, a), { transport: ut() });
}
function Ut() {
	let e = [];
...
Z.run();
var [Jt, Yt] = p(Z.getLanguage() || "en");
Z.on("language", (e) => {
	Yt(e.value);
});
function Q(...e) {
	return Jt(), e.length === 0 ? (...e) => (Jt(), Z.t(...e)) : Z.t(...e);
}
var $ = Q, Xt = o("<footer class=\"mt-20 border-t border-border bg-card\"><div class=\"container py-8\"><div class=\"grid gap-8 md:grid-cols-3\"><div><h3 class=\"mb-2 text-sm font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p></div><div><h3 class=\"mb-2 text-sm font-semibold text-foreground\"></h3><ul class=space-y-1><li><a href=https://github.com/intlayer-org/benchmark-i18n target=_blank rel=noreferrer class=\"text-sm text-muted-foreground transition-colors hover:text-foreground\"></a></li><li></li><li></li></ul></div><div><h3 class=\"mb-2 text-sm font-semibold text-foreground\"></h3><p class=\"text-sm text-muted-foreground\"></p></div></div><div class=\"mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground\">");
function Zt() {
	let t = u(), n = () => t.locale ?? "en";
	return (() => {
		var t = Xt(), i = t.firstChild.firstChild, a = i.firstChild, o = a.firstChild, c = o.nextSibling, l = a.nextSibling, u = l.firstChild, d = u.nextSibling.firstChild, f = d.firstChild, p = d.nextSibling, m = p.nextSibling, h = l.nextSibling.firstChild, g = h.nextSibling, _ = i.nextSibling;
		return r(o, () => Q()("footer.title")), r(c, () => Q()("footer.description")), r(u, () => Q()("footer.resources")), r(f, () => Q()("footer.github")), r(p, e(s, {
			get href() {
				return `/${n()}/about`;
			},
			class: "text-sm text-muted-foreground transition-colors hover:text-foreground",
			get children() {
				return Q()("footer.methodology");
			}
		})), r(m, e(s, {
			get href() {
				return `/${n()}/contact`;
			...
			class: "text-sm text-muted-foreground transition-colors hover:text-foreground",
			get children() {
				return Q()("footer.contributing");
			}
		})), r(h, () => Q()("footer.contact")), r(g, () => Q()("shared.contactEmail")), r(_, () => Q()("footer.builtWith")), t;
	})();
}
function Qt(e) {
...
}, tn = o("<div class=\"flex items-center gap-2\"><select class=\"h-8 rounded-md border border-border bg-card px-2 text-xs font-medium transition-colors focus:outline-none focus:ring-1 focus:ring-primary\">"), nn = o("<option>");
function rn() {
	let t = u(), i = l(), a = c(), o = (e) => {
	...
	return (() => {
		var i = tn(), a = i.firstChild;
		return a.addEventListener("change", (e) => o(e.currentTarget.value)), r(a, e(d, {
			each: $t,
			children: (e) => (() => {
				var t = nn();
				return t.value = e, r(t, () => en(e)), t;
			})()
		})), n(() => a.value = t.locale ?? "en"), i;
	})();
}
var an = o("<button type=button class=\"rounded-md border border-border bg-accent px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-accent/80\">");
function on() {
...
function cn() {
	...
	m(() => {
		...
		if (e() !== "auto") return;
		let t = window.matchMedia("(prefers-color-scheme: dark)"), n = () => sn("auto");
	...
	function i() {
		...
		t(r), sn(r), window.localStorage.setItem("theme", r);
	}
	let o = () => e() === "auto" ? $("themeToggle.labelAuto") : $("themeToggle.labelOther", { mode: e() }), s = () => e() === "auto" ? $("themeToggle.auto") : e() === "dark" ? $("themeToggle.dark") : $("themeToggle.light");
	return (() => {
		var e = an();
...
function pn() {
	...
	let [t, n] = p(!1), a = u(), o = () => a.locale ?? "en", c = () => [
		{
			to: `/${o()}/products`,
			label: Q()("header.products")
		},
		{
			to: `/${o()}/pricing`,
			label: Q()("header.pricing")
		},
		{
			to: `/${o()}/team`,
			label: Q()("header.team")
		...
		{
			to: `/${o()}/contact`,
			label: Q()("header.contact")
		},
		{
			to: `/${o()}/settings`,
			label: Q()("header.settings")
		}
	];
	return (() => {
		var a = un(), l = a.firstChild.firstChild, u = l.firstChild, f = u.firstChild, p = f.firstChild, m = l.nextSibling, h = m.firstChild.firstChild;
		return r(l, e(s, {
			get href() {
				return `/${o()}`;
			},
			...
			inactiveClass: "",
			get children() {
				return Q()("header.methodology");
			}
		}), f), p.$$click = () => n(!t()), p.addEventListener("mouseleave", () => n(!1)), p.addEventListener("mouseenter", () => n(!0)), r(p, () => Q()("header.mockPages"), null), r(p, e(fn, { get class() {
			return `transition-transform ${t() ? "rotate-180" : ""}`;
		} }), null), r(f, (() => {
			var a = i(() => !!t());
			return () => a() && (() => {
				var t = dn(), i = t.firstChild;
		...
		})(), null), r(h, () => Q()("shared.goToGithub")), r(m, e(rn, {}), null), r(m, e(cn, {}), null), a;
	})();
}
t(["click"]);
function mn(t) {
	...
	return m(() => {
		...
		let e = n.locale ?? "en";
		document.documentElement.lang = e, Z.changeLanguage(e).then(() => {
			Yt(e);
		});
	}), [
		e(pn, {}),
