...
var Ee = () => {
	...
	return t;
}, z = 0, B = 1, De = 2, Oe = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var V = 0, H = 1, U = 2, W = 3, G = 4, Ae = /* @__PURE__ */ new Set([
	U,
	H,
	V
]), K = "'", je = /* @__PURE__ */ new Set([
	"{",
	"}",
	K
...
function Ne(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case V:
			...
			break;
		case H:
			je.has(i) ? (n = n.slice(0, -1) + i, t = U) : (n += i, t = V);
			break;
		case U:
			i === K ? t = V : (n += i, t = U);
			break;
		case W:
			i === "}" ? (d(), t = V) : ke(i) ? r !== "" && (d(), t = G) : (u(), t = W);
			break;
		case G: i == "}" ? t = V : ke(i) ? t = G : c(B);
	}
...
(w = console.assert) == null || w.call(console, Be), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ve(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, Xe = 3e3, Ze = 200, Qe = 0, Y = /* @__PURE__ */ new Map(), $e = !1, X, Z;
...
var tt = (e) => new J("unavailable", `the Tolgee browser extension did not answer ${e} in time`), nt = () => `${Date.now()}-${Qe++}-${Math.random()}`;
function rt() {
...
function it(e) {
	return X ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: qe }, window.origin), i = () => {
			clearInterval(a), at(), Z = void 0, n(new J("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Q = "__tolgee_", St = `${Q}apiKey`, Ct = `${Q}apiUrl`, wt = `${Q}branch`, Tt = `${Q}projectId`, Et = `${Q}session`, Dt = "tolgee-in-context-tools.umd.min.js", Ot = "@tolgee/in-context-tools", kt = "InContextTools", At = "https://cdn.jsdelivr.net/npm", jt = null;
function Mt(e) {
...
function Rt() {
	...
	if (i && r) return C(S({}, a), { transport: ot() });
}
function zt() {
	let e = [];
