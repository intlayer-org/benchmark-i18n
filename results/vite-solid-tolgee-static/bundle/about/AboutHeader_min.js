...
import { createSignal as i, onMount as a } from "solid-js";
function o(e) {
...
var s = Object.defineProperty, c = Object.defineProperties, l = Object.getOwnPropertyDescriptors, u = Object.getOwnPropertySymbols, d = Object.prototype.hasOwnProperty, f = Object.prototype.propertyIsEnumerable, p = (e, t, n) => t in e ? s(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
function y(e, t) {
	return v(e) ? Promise.resolve(e).then(t) : t(e);
}
function b(e, t, n) {
	function r(n) {
		let r = t(n);
...
var ne = () => ({
	...
	let r = O(n?.headers);
	return r["x-api-key"] && (r = Object.assign(Object.assign({}, ne()), r)), e(t, Object.assign(Object.assign({}, n), { headers: r }));
}, re = (e) => {
...
}, A = (e) => Object.fromEntries(re(e).entries()), j = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function pe(e, t) {
	let n = F(fe, t?.initialOptions, e);
	return n.apiUrl = D(n.apiUrl), e?.fetch && (n.fetch = k(e.fetch)), {
		initialOptions: n,
...
function me(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return b(s.onError, (e) => new ce("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return b(s.onError, (e) => new se("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function E(e) {
		e && l.backends.push(e);
	}
	...
	let O = Object.freeze({
		...
		getInitialLanguage() {
			let e = n();
			return y(w(), (t) => (!e || e.includes(t)) && t ? t : T());
		},
		setStoredLanguage(e) {
			return b(s.onError, (e) => new ce("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ee(e) || P, r = t().onFormatError, a = typeof r;
	...
	let r = pe(), i, a = Object.freeze({
		...
		getRequiredNamespaces() {
			return E([
				a.getDefaultNs(),
				...r.initialOptions.ns || [],
				...w(r.initialOptions.fallbackNs),
				...r.activeNamespaces.keys()
			]);
		},
		getFallbackLangs(e) {
			let t = e || a.getLanguage();
			return t ? E([t, ...T(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
			return w(r.initialOptions.fallbackNs);
		},
		getNs() {
		...
		overrideCredentials(e) {
			i = e ? Object.assign(Object.assign({}, e), { apiUrl: D(e.apiUrl) }) : void 0;
		}
	});
	return a;
}
...
function ve({ options: e }) {
	let t = ae(), n = I(!1, () => o.isFetching(), t.onFetchingChange.emit), r = I(!1, () => D.isLoading(), t.onLoadingChange.emit), i = he(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = me(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, b, f, t), o = le(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
	...
	function d(e) {
		return E([...w(e ?? l()), ...i.getRequiredNamespaces()]);
	}
	function f(e, t, n) {
	...
	function b({ key: e, ns: t, language: n }) {
	...
	function S() {
		...
		if (v(e)) return i.setInitialLoading(!0), n.notify(), r.notify(), Promise.resolve(e).then(() => {
			i.setInitialLoading(!1), n.notify(), r.notify(), t.onInitialLoaded.emit();
		});
		t.onInitialLoaded.emit();
	}
	function C() {
		if (!i.getLanguage()) return y(a.getInitialLanguage(), (e) => {
			let t = e || i.getInitialOptions().defaultLanguage;
			t && i.setLanguage(t);
		});
	}
	function T() {
		if ((a.getLanguageDetector() || a.getLanguageStorage()) && !i.getAvailableLanguages()) throw Error(x("availableLanguages"));
		if (!i.getLanguage() && !i.getInitialOptions().defaultLanguage) throw Error(x(["defaultLanguage", "language"]));
	}
	let D = Object.freeze(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, t), i), a), o), {
		...
		run() {
			return T(), i.isRunning() || (i.setRunning(!0), a.run(), s = S()), Promise.resolve(s);
		},
		stop() {
...
var be = () => {
	let e = {
		...
		init(t) {
			let n = ye(F(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, L = 0, R = 1, xe = 2, Se = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var B = 0, V = 1, H = 2, U = 3, W = 4, Ce = /* @__PURE__ */ new Set([
	H,
	V,
	B
]), G = "'", we = /* @__PURE__ */ new Set([
	"{",
	"}",
	G
...
function Ee(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case B:
			...
			break;
		case V:
			we.has(i) ? (n = n.slice(0, -1) + i, t = H) : (n += i, t = B);
			break;
		case H:
			i === G ? t = B : (n += i, t = H);
			break;
...
(g = console.assert) == null || g.call(console, Ne), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Pe(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, Ue = 3e3, We = 200, Ge = 0, J = /* @__PURE__ */ new Map(), Ke = !1, Y, X;
...
var Je = (e) => new q("unavailable", `the Tolgee browser extension did not answer ${e} in time`), Ye = () => `${Date.now()}-${Ge++}-${Math.random()}`;
function Xe() {
...
function Ze(e) {
	return Y ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Be }, window.origin), i = () => {
			clearInterval(a), Qe(), X = void 0, n(new q("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Z = "__tolgee_", ht = `${Z}apiKey`, gt = `${Z}apiUrl`, _t = `${Z}branch`, vt = `${Z}projectId`, yt = `${Z}session`, bt = "tolgee-in-context-tools.umd.min.js", xt = "@tolgee/in-context-tools", St = "InContextTools", Ct = "https://cdn.jsdelivr.net/npm", wt = null;
function Tt(e) {
...
function jt() {
	...
	if (!t) return;
	let a = m(m({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return h(m({}, a), { apiKey: e });
	if (i && r) return h(m({}, a), { transport: $e() });
}
function Mt() {
	let e = [];
...
$.run();
var [It, Lt] = i($.getLanguage() || "en");
$.on("language", (e) => {
	Lt(e.value);
});
function Rt(...e) {
	return It(), e.length === 0 ? (...e) => (It(), $.t(...e)) : $.t(...e);
}
var zt = Rt, Bt = r("<h1 class=\"mb-4 text-3xl font-bold text-foreground\">"), Vt = r("<p class=\"mb-8 max-w-3xl text-muted-foreground\">");
function Ht() {
	return o("AboutHeader"), [(() => {
		var e = Bt();
		return t(e, () => zt("about.header.title")), e;
	})(), (() => {
		var e = Vt();
		return t(e, () => zt("about.header.description")), e;
	})()];
}
function Ut(e) {
	return n(() => e.children);
