	...
	return (() => {
		...
		insert(_el$, createComponent(For, {
			...
			children: (i) => (() => {
				...
				insert(_el$4, () => trans(`blog.list.post${i}Category`));
				insert(_el$5, () => trans(`blog.list.post${i}Date`));
				insert(_el$6, () => trans(`blog.list.post${i}Title`));
				insert(_el$7, () => trans(`blog.list.post${i}Excerpt`));
				insert(_el$8, () => trans("blog.list.readMore"));
				return _el$2;
			})()
		}));
		return _el$;
...
function Wrapped() {
	return createComponent(Wrapper, { get children() {
		return createComponent(BlogList, {});
	} });
}
