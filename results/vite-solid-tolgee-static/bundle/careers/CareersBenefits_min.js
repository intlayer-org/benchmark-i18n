...
var Rt = Lt, zt = r("<div class=\"mb-12 grid gap-4 md:grid-cols-3\">"), Bt = r("<div class=\"rounded-lg border border-border bg-card p-4 text-center\"><p class=\"text-sm font-semibold text-foreground\"></p><p class=\"text-xs text-muted-foreground\">");
function Vt() {
	let n = [
		{
			label: "remoteLabel",
	...
	return (() => {
		...
		return t(r, e(i, {
			...
			children: (e) => (() => {
				...
				return t(r, () => Rt(`careers.benefits.${e.label}`)), t(i, () => Rt(`careers.benefits.${e.value}`)), n;
			})()
		})), r;
	})();
}
