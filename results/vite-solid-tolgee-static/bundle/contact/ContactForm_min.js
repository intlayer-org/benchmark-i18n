import { createComponent as e, effect as t, insert as n, memo as r, setAttribute as i, template as a } from "solid-js/web";
import { For as o, createSignal as s, createUniqueId as c } from "solid-js";
...
var re = () => ({
	...
	let r = ne(n?.headers);
	return r["x-api-key"] && (r = Object.assign(Object.assign({}, re()), r)), e(t, Object.assign(Object.assign({}, n), { headers: r }));
}, ae = (e) => {
...
}, A = (e) => Object.fromEntries(ae(e).entries()), j = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function ge(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return S(s.onError, (e) => new ue("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return S(s.onError, (e) => new le("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function E(e) {
		e && l.backends.push(e);
	}
	...
	let k = Object.freeze({
		...
		setStoredLanguage(e) {
			return S(s.onError, (e) => new ue("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = fe(n, ["formatEnabled"]);
...
function ve(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = fe(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
function be({ options: e }) {
	let t = se(), n = I(!1, () => o.isFetching(), t.onFetchingChange.emit), r = I(!1, () => T.isLoading(), t.onLoadingChange.emit), i = _e(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ge(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = de(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Se = () => {
	let e = {
		...
		init(t) {
			let n = xe(F(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, L = 0, R = 1, Ce = 2, we = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var B = 0, V = 1, H = 2, U = 3, W = 4, Te = /* @__PURE__ */ new Set([
	H,
	V,
	B
]), G = "'", Ee = /* @__PURE__ */ new Set([
	"{",
	"}",
	G
...
function Oe(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case B:
			...
			break;
		case V:
			Ee.has(i) ? (n = n.slice(0, -1) + i, t = H) : (n += i, t = B);
			break;
		case H:
			i === G ? t = B : (n += i, t = H);
			break;
...
(v = console.assert) == null || v.call(console, Fe), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ie(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, Ge = 3e3, Ke = 200, qe = 0, J = /* @__PURE__ */ new Map(), Je = !1, Y, X;
...
var Xe = (e) => new q("unavailable", `the Tolgee browser extension did not answer ${e} in time`), Ze = () => `${Date.now()}-${qe++}-${Math.random()}`;
function Qe() {
...
function $e(e) {
	return Y ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: He }, window.origin), i = () => {
			clearInterval(a), et(), X = void 0, n(new q("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Z = "__tolgee_", _t = `${Z}apiKey`, vt = `${Z}apiUrl`, yt = `${Z}branch`, bt = `${Z}projectId`, xt = `${Z}session`, St = "tolgee-in-context-tools.umd.min.js", Ct = "@tolgee/in-context-tools", wt = "InContextTools", Tt = "https://cdn.jsdelivr.net/npm", Et = null;
function Dt(e) {
...
function Nt() {
	...
	if (i && r) return _(g({}, a), { transport: tt() });
}
function Pt() {
	let e = [];
...
Q.run();
var [zt, Bt] = s(Q.getLanguage() || "en");
Q.on("language", (e) => {
	Bt(e.value);
});
function Vt(...e) {
	return zt(), e.length === 0 ? (...e) => (zt(), Q.t(...e)) : Q.t(...e);
}
var $ = Vt, Ht = a("<form class=space-y-6><div class=\"grid gap-4 md:grid-cols-2\"><div><label class=\"mb-1 block text-sm font-medium text-foreground\"></label><input class=\"w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring\"></div><div><label class=\"mb-1 block text-sm font-medium text-foreground\"></label><input type=email class=\"w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring\"></div></div><div><label class=\"mb-1 block text-sm font-medium text-foreground\"></label><select class=\"w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring\"></select></div><div><label class=\"mb-1 block text-sm font-medium text-foreground\"></label><textarea rows=5 class=\"w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring\"></textarea></div><button type=submit class=\"rounded-md bg-primary px-6 py-2.5 text-sm font-medium text-primary-foreground transition-opacity hover:opacity-90\">"), Ut = a("<option>"), Wt = [
	"bugReport",
	"newBenchmarkIdea",
	"methodologyQuestion",
	"contribution",
...
function Gt() {
	let r = c(), a = c(), s = c(), l = c();
	return (() => {
		var c = Ht(), u = c.firstChild, d = u.firstChild, f = d.firstChild, p = f.nextSibling, m = d.nextSibling.firstChild, h = m.nextSibling, g = u.nextSibling, _ = g.firstChild, v = _.nextSibling, y = g.nextSibling, b = y.firstChild, x = b.nextSibling, S = y.nextSibling;
		return i(f, "for", r), n(f, () => $("contact.form.name")), i(p, "id", r), i(m, "for", a), n(m, () => $("contact.form.email")), i(h, "id", a), i(_, "for", s), n(_, () => $("contact.form.topic")), i(v, "id", s), n(v, e(o, {
			each: Wt,
			children: (e) => (() => {
				var t = Ut();
				return t.value = e, n(t, () => $(`contact.form.${e}`)), t;
			})()
		})), i(b, "for", l), n(b, () => $("contact.form.message")), i(x, "id", l), n(S, () => $("contact.form.sendMessage")), t((e) => {
			var t = $("contact.form.yourName"), n = $("contact.form.emailPlaceholder"), r = $("contact.form.messagePlaceholder");
			return t !== e.e && i(p, "placeholder", e.e = t), n !== e.t && i(h, "placeholder", e.t = n), r !== e.a && i(x, "placeholder", e.a = r), e;
		}, {
			e: void 0,
			t: void 0,
			a: void 0
