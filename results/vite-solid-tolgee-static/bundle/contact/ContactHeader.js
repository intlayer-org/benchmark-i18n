...
tolgee.run();
var [tolgeeLanguage, setTolgeeLanguage] = createSignal(tolgee.getLanguage() || "en");
...
function MockBanner() {
	return (() => {
		var _el$ = _tmpl$$1();
		insert(_el$, () => t()("mockBanner"));
		return _el$;
	})();
}
var _tmpl$ = template(`<h1 class="mb-2 text-3xl font-bold text-foreground">`);
var _tmpl$2 = template(`<p class="mb-8 text-muted-foreground"> <a href=mailto:contact@intlayer.org class="text-primary hover:underline"></a>.`);
function ContactHeader() {
	return [
		createComponent(MockBanner, {}),
		(() => {
			var _el$ = _tmpl$();
			insert(_el$, () => trans("contact.header.title"));
			return _el$;
		})(),
		(() => {
			var _el$2 = _tmpl$2(), _el$3 = _el$2.firstChild, _el$4 = _el$3.nextSibling;
			insert(_el$2, () => trans("contact.header.description"), _el$3);
			insert(_el$4, () => trans("shared.contactEmail"));
			return _el$2;
		})()
	];
}
...
function Wrapped() {
	return createComponent(Wrapper, { get children() {
		return createComponent(ContactHeader, {});
	} });
}
