...
function Ye(e) {
	return Y ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Re }, window.origin), i = () => {
			clearInterval(a), Xe(), X = void 0, n(new q("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var $ = Lt, Rt = r("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\">");
function zt() {
	return (() => {
		var e = Rt();
		return t(e, () => Lt()("mockBanner")), e;
	})();
}
var Bt = r("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), Vt = r("<p class=\"mb-8 text-muted-foreground\"> <a href=mailto:contact@intlayer.org class=\"text-primary hover:underline\"></a>.");
function Ht() {
	return [
		e(zt, {}),
		(() => {
		...
		(() => {
			var e = Vt(), n = e.firstChild, r = n.nextSibling;
