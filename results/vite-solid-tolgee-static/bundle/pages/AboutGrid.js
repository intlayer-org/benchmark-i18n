...
function AboutGrid() {
	return (() => {
		...
		insert(_el$3, () => trans("about.grid.whyExistsTitle"));
		insert(_el$4, () => trans("about.grid.whyExistsDesc"));
		insert(_el$6, () => trans("about.grid.methodologyTitle"));
		insert(_el$7, () => trans("about.grid.methodologyDesc"));
		return _el$;
	})();
}
...
function Wrapped() {
	return createComponent(Wrapper, { get children() {
		return createComponent(AboutGrid, {});
	} });
}
