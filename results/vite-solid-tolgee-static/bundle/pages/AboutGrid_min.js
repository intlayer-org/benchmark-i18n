...
var te = () => ({
	...
	let r = ee(n?.headers);
	return r["x-api-key"] && (r = Object.assign(Object.assign({}, te()), r)), e(t, Object.assign(Object.assign({}, n), { headers: r }));
}, ne = (e) => {
...
}, k = (e) => Object.fromEntries(ne(e).entries()), A = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function fe(e, t) {
	let n = P(de, t?.initialOptions, e);
	return n.apiUrl = T(n.apiUrl), e?.fetch && (n.fetch = O(e.fetch)), {
		initialOptions: n,
...
function pe(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return v(s.onError, (e) => new se("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return v(s.onError, (e) => new oe("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function D(e) {
		e && l.backends.push(e);
	}
	...
	let O = Object.freeze({
		...
		setStoredLanguage(e) {
			return v(s.onError, (e) => new se("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = E(e) || N, r = t().onFormatError, a = typeof r;
...
function _e({ options: e }) {
	let t = ie(), n = F(!1, () => o.isFetching(), t.onFetchingChange.emit), r = F(!1, () => D.isLoading(), t.onLoadingChange.emit), i = me(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = pe(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, b, x, f, t), o = ce(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var ye = () => {
	let e = {
		...
		init(t) {
			let n = ve(P(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, I = 0, L = 1, be = 2, xe = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var R = 0, z = 1, B = 2, V = 3, H = 4, Ce = /* @__PURE__ */ new Set([
	B,
	z,
	R
]), U = "'", we = /* @__PURE__ */ new Set([
	"{",
	"}",
	U
...
function Ee(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case R:
			...
			break;
		case z:
			we.has(i) ? (n = n.slice(0, -1) + i, t = B) : (n += i, t = R);
			break;
		case B:
			i === U ? t = R : (n += i, t = B);
			break;
		case V:
			i === "}" ? (d(), t = R) : Se(i) ? r !== "" && (d(), t = H) : (u(), t = V);
			break;
		case H: i == "}" ? t = R : Se(i) ? t = H : c(L);
	}
...
var je = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, W = {};
(function(e) {
	function t(e, t) {
...
(m = console.assert) == null || m.call(console, Me), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ne(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, He = 3e3, Ue = 200, We = 0, q = /* @__PURE__ */ new Map(), Ge = !1, J, Y;
...
var qe = (e) => new K("unavailable", `the Tolgee browser extension did not answer ${e} in time`), Je = () => `${Date.now()}-${We++}-${Math.random()}`;
function Ye() {
...
var nt = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
function rt(e) {
	let t = nt.indexOf(e);
...
function at(e) {
	...
	for (let o = 0; o < t; o++) r = r << 5 | rt(e[o]), n += 5, n >= 8 && (a[i++] = r >>> n - 8 & 255, n -= 8);
	return it(a.buffer);
}
function ot(e) {
	if (e) try {
...
var Z = "__tolgee_", pt = `${Z}apiKey`, mt = `${Z}apiUrl`, ht = `${Z}branch`, gt = `${Z}projectId`, _t = `${Z}session`, vt = "tolgee-in-context-tools.umd.min.js", yt = "@tolgee/in-context-tools", bt = "InContextTools", xt = "https://cdn.jsdelivr.net/npm", St = null;
function Ct(e) {
	return St ||= Ot(wt(e)).then(() => window[yt][bt]), St;
}
function wt(e) {
	return Tt() || `${xt}/@tolgee/web@${e}/dist/${vt}`;
}
function Tt() {
	if (Ae()) return;
...
function kt() {
	let e = sessionStorage.getItem(pt) || void 0, t = sessionStorage.getItem(mt) || void 0, n = sessionStorage.getItem(ht) || void 0, r = sessionStorage.getItem(gt) || void 0, i = Ve(sessionStorage.getItem(_t));
	if (!t) return;
	let a = f(f({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return p(f({}, a), { apiKey: e });
	if (i && r) return p(f({}, a), { transport: Ze() });
}
function At() {
	let e = [];
...
Q.run();
var [Ft, It] = i(Q.getLanguage() || "en");
Q.on("language", (e) => {
	It(e.value);
});
function Lt(...e) {
	return Ft(), e.length === 0 ? (...e) => (Ft(), Q.t(...e)) : Q.t(...e);
}
var $ = Lt, Rt = r("<div class=\"grid gap-8 md:grid-cols-2\"><div class=\"rounded-lg border border-border bg-card p-6\"><h2 class=\"mb-3 text-xl font-semibold text-foreground\"></h2><p class=\"text-sm text-muted-foreground\"></p></div><div class=\"rounded-lg border border-border bg-card p-6\"><h2 class=\"mb-3 text-xl font-semibold text-foreground\"></h2><p class=\"text-sm text-muted-foreground\">");
function zt() {
	return (() => {
		var e = Rt(), n = e.firstChild, r = n.firstChild, i = r.nextSibling, a = n.nextSibling.firstChild, o = a.nextSibling;
		return t(r, () => $("about.grid.whyExistsTitle")), t(i, () => $("about.grid.whyExistsDesc")), t(a, () => $("about.grid.methodologyTitle")), t(o, () => $("about.grid.methodologyDesc")), e;
	})();
}
function Bt(e) {
	return n(() => e.children);
