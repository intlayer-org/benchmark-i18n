...
var Bt = r("<div class=\"mb-12 text-center\"><h1 class=\"mb-3 text-3xl font-bold text-foreground\"></h1><p class=text-muted-foreground>");
function Vt() {
	return [e(zt, {}), (() => {
		var e = Bt(), n = e.firstChild, r = n.nextSibling;
		return t(n, () => Lt("pricing.header.title")), t(r, () => Lt("pricing.header.description")), e;
	})()];
}
function Ht(e) {
	return n(() => e.children);
