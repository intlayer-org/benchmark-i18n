...
function ve({ options: e }) {
	let t = oe(), n = L(!1, () => o.isFetching(), t.onFetchingChange.emit), r = L(!1, () => E.isLoading(), t.onLoadingChange.emit), i = he(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = me(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = ue(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var $ = Bt, Vt = a("<div class=\"grid gap-6 md:grid-cols-3\">"), Ht = a("<div><h3 class=\"text-lg font-semibold text-foreground\"></h3><div class=my-4><span class=\"text-3xl font-bold text-foreground\"></span><span class=\"text-sm text-muted-foreground\"></span></div><ul class=\"mb-6 flex-1 space-y-2\"></ul><button type=button>"), Ut = a("<li class=\"flex items-center gap-2 text-sm text-muted-foreground\"><span class=text-primary>✓</span> ");
function Wt() {
	let a = [
		{
			nameKey: "starterName",
	...
	return (() => {
		...
		return r(s, t(o, {
			each: a,
			children: (a) => (() => {
				var s = Ht(), c = s.firstChild, l = c.nextSibling, u = l.firstChild, d = u.nextSibling, f = l.nextSibling, p = f.nextSibling;
