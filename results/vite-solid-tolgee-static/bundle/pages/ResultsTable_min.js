...
import { For as i, createSignal as a, onMount as o } from "solid-js";
...
}, k = (e) => Object.fromEntries(ie(e).entries()), A = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function me(e, t) {
	let n = P(pe, t?.initialOptions, e);
	return n.apiUrl = D(n.apiUrl), e?.fetch && (n.fetch = re(e.fetch)), {
		initialOptions: n,
...
function he(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return b(s.onError, (e) => new le("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return b(s.onError, (e) => new ce("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function E(e) {
		e && l.backends.push(e);
	}
	...
	let O = Object.freeze({
		...
		setStoredLanguage(e) {
			return b(s.onError, (e) => new le("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function be({ options: e }) {
	let t = oe(), n = ge(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ge(!1, () => D.isLoading(), t.onLoadingChange.emit), i = _e(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = he(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, b, f, t), o = ue(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Se = () => {
	...
	return t;
}, F = 0, I = 1, Ce = 2, we = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var R = 0, z = 1, B = 2, V = 3, H = 4, Te = /* @__PURE__ */ new Set([
	B,
	z,
	R
]), U = "'", Ee = /* @__PURE__ */ new Set([
	"{",
	"}",
	U
...
function Oe(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case R:
			...
			break;
		case z:
			Ee.has(i) ? (n = n.slice(0, -1) + i, t = B) : (n += i, t = R);
			break;
		case B:
			i === U ? t = R : (n += i, t = B);
			break;
		case V:
			i === "}" ? (d(), t = R) : L(i) ? r !== "" && (d(), t = H) : (u(), t = V);
			break;
		case H: i == "}" ? t = R : L(i) ? t = H : c(I);
	}
	return Te.has(t) || c(Ce), l(), [a, o];
}
function ke(e, t) {
	let [n, r] = Oe(e), i = [n[0]];
...
(g = console.assert) == null || g.call(console, Fe), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ie(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, Ge = 3e3, Ke = 200, qe = 0, K = /* @__PURE__ */ new Map(), Je = !1, q, J;
...
var Xe = (e) => new G("unavailable", `the Tolgee browser extension did not answer ${e} in time`), Ze = () => `${Date.now()}-${qe++}-${Math.random()}`;
function Qe() {
...
function $e(e) {
	return q ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: He }, window.origin), i = () => {
			clearInterval(a), et(), J = void 0, n(new G("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Y = "__tolgee_", _t = `${Y}apiKey`, vt = `${Y}apiUrl`, yt = `${Y}branch`, bt = `${Y}projectId`, xt = `${Y}session`, St = "tolgee-in-context-tools.umd.min.js", Ct = "@tolgee/in-context-tools", wt = "InContextTools", Tt = "https://cdn.jsdelivr.net/npm", Et = null;
function Dt(e) {
...
function Nt() {
	...
	if (i && r) return h(m({}, a), { transport: tt() });
}
function Pt() {
	let e = [];
...
Z.run();
var [Q, Rt] = a(Z.getLanguage() || "en");
Z.on("language", (e) => {
	Rt(e.value);
});
function zt(...e) {
	return Q(), e.length === 0 ? (...e) => (Q(), Z.t(...e)) : Z.t(...e);
}
var $ = zt;
function Bt(e) {
...
var Vt = r("<section><h2 class=\"mb-6 text-2xl font-bold text-foreground\"></h2><div class=\"overflow-x-auto rounded-lg border border-border\"><table class=\"w-full text-sm\"><thead class=bg-muted><tr><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"></th></tr></thead><tbody>"), Ht = r("<tr class=\"border-t border-border\"><td class=\"px-4 py-3 font-medium text-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\"></td><td class=\"px-4 py-3 text-muted-foreground\">");
function Ut() {
	Bt("ResultsTable");
	let n = [
		{
	...
	return (() => {
		var r = Vt(), a = r.firstChild, o = a.nextSibling.firstChild.firstChild, s = o.firstChild.firstChild, c = s.nextSibling, l = c.nextSibling, u = l.nextSibling, d = o.nextSibling;
		return t(a, () => $("home.resultsTable.title")), t(s, () => $("home.resultsTable.library")), t(c, () => $("home.resultsTable.bundleSize")), t(l, () => $("home.resultsTable.lookupTime")), t(u, () => $("home.resultsTable.lazyLoading")), t(d, e(i, {
			each: n,
			children: (e) => (() => {
				var n = Ht(), r = n.firstChild, i = r.nextSibling, a = i.nextSibling, o = a.nextSibling;
				return t(r, () => e.lib), t(i, () => e.size), t(a, () => e.time), t(o, () => $(`home.resultsTable.${e.lazyMsg}`)), n;
			})()
		})), r;
	})();
}
