...
var z = 0, B = 1, V = 2, H = 3, U = 4, Se = /* @__PURE__ */ new Set([
	V,
	B,
	z
]), W = "'", Ce = /* @__PURE__ */ new Set([
	"{",
	"}",
	W
...
function Te(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case z:
			...
			break;
		case B:
			Ce.has(i) ? (n = n.slice(0, -1) + i, t = V) : (n += i, t = z);
			break;
		case V:
			i === W ? t = z : (n += i, t = V);
			break;
		case H:
			i === "}" ? (d(), t = z) : xe(i) ? r !== "" && (d(), t = U) : (u(), t = H);
			break;
		case U: i == "}" ? t = z : xe(i) ? t = U : c(R);
	}
...
var Ae = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, G = {};
(function(e) {
	function t(e, t) {
...
(m = console.assert) == null || m.call(console, je), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Me(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, Ve = 3e3, He = 200, Ue = 0, J = /* @__PURE__ */ new Map(), We = !1, Y, X;
...
var Ke = (e) => new q("unavailable", `the Tolgee browser extension did not answer ${e} in time`), qe = () => `${Date.now()}-${Ue++}-${Math.random()}`;
function Je() {
