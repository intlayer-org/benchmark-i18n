	...
	return (() => {
		...
		return t(r, e(i, {
			...
			children: (e) => {
				...
				return (() => {
					var e = Bt(), a = e.firstChild, o = a.nextSibling, s = o.nextSibling, c = s.nextSibling;
