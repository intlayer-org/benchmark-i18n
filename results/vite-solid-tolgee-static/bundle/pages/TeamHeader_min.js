...
function Rt() {
	return (() => {
		var e = Lt();
		return t(e, () => $()("mockBanner")), e;
	})();
}
var zt = r("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), Bt = r("<p class=\"mb-10 text-muted-foreground\">");
function Vt() {
	return [
		e(Rt, {}),
		(() => {
			var e = zt();
			return t(e, () => $()("team.header.title")), e;
		})(),
		(() => {
			var e = Bt();
			return t(e, () => $()("team.header.description")), e;
		})()
	];
}
function Ht(e) {
