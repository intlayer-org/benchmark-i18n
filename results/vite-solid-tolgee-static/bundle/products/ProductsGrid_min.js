...
function Vt() {
	...
	return (() => {
		...
		return t(r, e(i, {
			each: n,
			children: (e) => (() => {
				var n = Bt(), r = n.firstChild, i = r.firstChild, a = i.nextSibling, o = r.nextSibling.firstChild, s = o.nextSibling;
				return t(i, () => $(`products.grid.${e.nameKey}`)), t(a, () => $(`products.grid.${e.descKey}`)), t(o, () => $(`products.grid.${e.priceKey}`)), t(s, () => $("products.grid.learnMore")), n;
			})()
		})), r;
	})();
}
