...
function F(e, t) {
	...
	return n.apiUrl = T(n.apiUrl), e?.fetch && (n.fetch = D(e.fetch)), {
		initialOptions: n,
...
function ge({ options: e }) {
	let t = ie(), n = I(!1, () => o.isFetching(), t.onFetchingChange.emit), r = I(!1, () => E.isLoading(), t.onLoadingChange.emit), i = pe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = fe(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, b, x, f, t), o = ce(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
	...
	let E = Object.freeze(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, t), i), a), o), {
		...
		run() {
			return ee(), i.isRunning() || (i.setRunning(!0), a.run(), s = C()), Promise.resolve(s);
		},
		stop() {
...
var ve = () => {
	...
	return t;
}, L = 0, R = 1, ye = 2, be = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var B = 0, V = 1, H = 2, U = 3, W = 4, xe = /* @__PURE__ */ new Set([
	H,
	V,
	B
]), G = "'", Se = /* @__PURE__ */ new Set([
	"{",
	"}",
	G
...
function we(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case B:
			...
			break;
		case V:
			Se.has(i) ? (n = n.slice(0, -1) + i, t = H) : (n += i, t = B);
			break;
		case H:
			i === G ? t = B : (n += i, t = H);
			break;
...
var ke = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, K = {};
(function(e) {
	function t(e, t) {
...
(m = console.assert) == null || m.call(console, Ae), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function je(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, Be = 3e3, Ve = 200, He = 0, Y = /* @__PURE__ */ new Map(), Ue = !1, X, Z;
...
var Ge = (e) => new J("unavailable", `the Tolgee browser extension did not answer ${e} in time`), Ke = () => `${Date.now()}-${He++}-${Math.random()}`;
function qe() {
...
function Je(e) {
	return X ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Le }, window.origin), i = () => {
			clearInterval(a), Ye(), Z = void 0, n(new J("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Q = "__tolgee_", ft = `${Q}apiKey`, pt = `${Q}apiUrl`, mt = `${Q}branch`, ht = `${Q}projectId`, gt = `${Q}session`, _t = "tolgee-in-context-tools.umd.min.js", vt = "@tolgee/in-context-tools", yt = "InContextTools", bt = "https://cdn.jsdelivr.net/npm", xt = null;
function St(e) {
...
function Ot() {
	...
	if (i && r) return p(f({}, a), { transport: Xe() });
}
function kt() {
	let e = [];
...
$.run();
var [Pt, Ft] = i($.getLanguage() || "en");
$.on("language", (e) => {
	Ft(e.value);
});
function It(...e) {
	return Pt(), e.length === 0 ? (...e) => (Pt(), $.t(...e)) : $.t(...e);
}
var Lt = It, Rt = r("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\">");
function zt() {
	return (() => {
		var e = Rt();
		return t(e, () => It()("mockBanner")), e;
	})();
}
var Bt = r("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), Vt = r("<p class=\"mb-10 text-muted-foreground\">");
function Ht() {
	return [
		e(zt, {}),
		(() => {
			var e = Bt();
			return t(e, () => Lt("products.header.title")), e;
		})(),
		(() => {
			var e = Vt();
			return t(e, () => Lt("products.header.description")), e;
		})()
	];
}
function Ut(e) {
