import { createComponent, insert, memo, setAttribute, template } from "solid-js/web";
...
function ApiAccessSection() {
	...
	return (() => {
		...
		insert(_el$2, () => trans("settings.apiAccess.title"));
		setAttribute(_el$4, "for", apiKeyId);
		insert(_el$4, () => trans("settings.apiAccess.apiKey"));
		setAttribute(_el$6, "id", apiKeyId);
		insert(_el$7, () => trans("settings.apiAccess.copy"));
		insert(_el$8, () => trans("settings.apiAccess.description"));
		return _el$;
	})();
}
...
function Wrapped() {
	return createComponent(Wrapper, { get children() {
		return createComponent(ApiAccessSection, {});
	} });
}
