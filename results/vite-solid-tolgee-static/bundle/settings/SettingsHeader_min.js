...
var Bt = r("<h1 class=\"mb-2 text-3xl font-bold text-foreground\">"), Vt = r("<p class=\"mb-8 text-muted-foreground\">");
function Ht() {
	return [
		e(zt, {}),
		(() => {
			var e = Bt();
			return t(e, () => Lt("settings.header.title")), e;
		})(),
		(() => {
			var e = Vt();
			return t(e, () => Lt("settings.header.description")), e;
		})()
	];
}
function Ut(e) {
