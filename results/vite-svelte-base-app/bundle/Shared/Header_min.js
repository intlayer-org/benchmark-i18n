...
function S(n, r) {
	...
	var p = x(), m = e.child(p), h = e.child(m), _ = e.child(h), S = e.sibling(_, 2), C = e.child(S);
	let w;
	var T = e.sibling(C, 2);
	let E;
	var D = e.sibling(T, 2), O = e.child(D), k = e.sibling(e.child(O));
	{
	...
	e.if(A, (t) => {
		e.get(s) && t(j);
	}), e.reset(D), e.reset(S), e.reset(h);
	var M = e.sibling(h, 2), N = e.sibling(e.child(M), 2);
	g(N, {}), v(e.sibling(N, 2), {}), e.reset(M), e.reset(m), e.reset(p), e.template_effect(() => {
		e.set_attribute(_, "href", `/${e.get(c)}`), e.set_attribute(C, "href", `/${e.get(c)}`), w = e.set_class(C, 1, "nav-link", null, w, { "is-active": e.get(u) }), e.set_attribute(T, "href", `/${e.get(c)}/about`), E = e.set_class(T, 1, "nav-link", null, E, { "is-active": e.get(d) });
	}), e.event("mouseenter", O, () => e.set(s, !0)), e.event("mouseleave", O, () => e.set(s, !1)), e.delegated("click", O, () => e.set(s, !e.get(s))), e.append(n, p), e.pop(), o();
}
e.delegate(["click"]);
export { S as default };
