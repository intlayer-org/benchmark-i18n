...
var root = $.from_html(`<!> <h1 class="mb-2 text-3xl font-bold text-foreground">Get in Touch</h1> <p class="mb-8 text-muted-foreground">Have ideas, found a bug, or want to contribute a benchmark? Reach out to us at <a href="mailto:contact@intlayer.org" class="text-primary hover:underline">contact@intlayer.org</a> .</p>`, 1);
function ContactHeader($$anchor) {
	var fragment = root();
