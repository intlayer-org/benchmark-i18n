...
var root = $.from_html(`<!> <h1 class="mb-2 text-3xl font-bold text-foreground">Frequently Asked Questions</h1> <p class="mb-10 text-muted-foreground">Everything you need to know about i18n Benchmark.</p>`, 1);
function FAQHeader($$anchor) {
	var fragment = root();
