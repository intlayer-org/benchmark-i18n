...
var r = e.from_html("<!> <h1 class=\"mb-2 text-3xl font-bold text-foreground\">Products</h1> <p class=\"mb-10 text-muted-foreground\">Tools and services to streamline your internationalization workflow.</p>", 1);
function i(t) {
	var i = r();
