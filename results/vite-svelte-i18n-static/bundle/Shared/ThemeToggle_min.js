...
var ve = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, ye = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function be(e) {
	var t = {};
...
function Se(e) {
	...
	for (var t = e.split(xe).filter(function(e) {
		return e.length > 0;
	...
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "integer-width":
				...
				i.options[0].replace(Ee, function(e, n, r, i, a, o) {
		...
		if (we.test(i.stem)) {
			...
			i.stem.replace(we, function(e, n, r, i, a, o) {
			...
			var a = i.options[0];
			a === "w" ? t = g(g({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = g(g({}, t), Oe(a)));
			continue;
		}
		if (Te.test(i.stem)) {
			t = g(g({}, t), Oe(i.stem));
...
function Ne(e, t) {
	for (var n = "", r = 0; r < e.length; r++) {
		...
		if (i === "j") {
			...
			var o = 1 + (a & 1), s = a < 2 ? 1 : 3 + (a >> 1), c = "a", l = Pe(t);
...
var Fe = RegExp(`^${ve.source}*`), Ie = RegExp(`${ve.source}*\$`);
function O(e, t) {
	return {
		start: e,
		end: t
...
var Le = !!String.prototype.startsWith && "_a".startsWith("a", 1), Re = !!String.fromCodePoint, ze = !!Object.fromEntries, Be = !!String.prototype.codePointAt, Ve = !!String.prototype.trimStart, He = !!String.prototype.trimEnd, Ue = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, We = !0;
try {
	We = Xe("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	We = !1;
}
var Ge = Le ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, k = Re ? String.fromCodePoint : function() {
	...
	return t;
}, Ke = ze ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
		...
		switch (a) {
			...
			case "time":
				...
				if (s && Ge(s?.style, "::", 0)) {
					...
					var m = p;
					this.locale && (m = Ne(p, this.locale));
					var u = {
						type: T.dateTime,
						pattern: m,
						location: s.styleLocation,
						parsedOptions: this.shouldParseSkeletons ? be(m) : {}
					};
					return {
						val: {
			...
			case "select":
				...
				if (this.bumpSpace(), !this.bumpIf(",")) return this.error(C.EXPECT_SELECT_ARGUMENT_OPTIONS, O(h, g({}, h)));
				this.bumpSpace();
...
function M(e) {
	e.forEach(function(e) {
		...
		else ue(e) && _e(e.style) || (de(e) || fe(e)) && E(e.style) ? delete e.style.location : ge(e) && M(e.children);
	});
}
function rt(e, t) {
	t === void 0 && (t = {}), t = g({
...
function H(e) {
	return e != null && q(e).some((e) => Ct(e)?.size);
}
function Tt(e, t) {
...
var G = n(!1), Ot = Object.defineProperty, kt = Object.defineProperties, At = Object.getOwnPropertyDescriptors, jt = Object.getOwnPropertySymbols, Mt = Object.prototype.hasOwnProperty, Nt = Object.prototype.propertyIsEnumerable, Pt = (e, t, n) => t in e ? Ot(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
var Y = It(Ft({}, K), { set: (e) => {
	if (e && bt(e) && H(e)) {
		...
		return typeof window < "u" && J() != null && t ? n = window.setTimeout(() => G.set(!0), t) : G.set(!0), Et(e).then(() => {
			K.set(e);
		}).finally(() => {
...
}, Xt = X((e, t = J()) => new ft(e, t, W().formats, { ignoreTag: W().ignoreTag })), Zt = (e, t = {}) => {
	var n;
	let r = t;
	...
	return c;
}, Qt = (e, t) => Yt(t).format(e), $t = (e, t) => Jt(t).format(e), en = (e, t) => qt(t).format(e), tn = (e, t = J()) => gt(e, t), nn = t([Y, B], () => Zt);
t([Y], () => Qt), t([Y], () => $t), t([Y], () => en), t([Y, B], () => tn);
var rn = e.from_html("<button type=\"button\" class=\"rounded-md border border-border bg-accent px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-accent/80\"> </button>");
function an(t, n) {
	e.push(n, !0);
	let i = () => e.store_get(nn, "$_", a), [a, o] = e.setup_stores();
	function s() {
