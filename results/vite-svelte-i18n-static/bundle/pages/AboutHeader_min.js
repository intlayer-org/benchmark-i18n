...
var ye = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, be = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function xe(e) {
	var t = {};
...
function Ce(e) {
	...
	for (var t = e.split(Se).filter(function(e) {
		return e.length > 0;
...
var Te = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, Ee = /^(@+)?(\+|#+)?[rs]?$/g, De = /(\*)(0+)|(#+)(0+)|(0+)/g, Oe = /^(0+)$/;
function ke(e) {
	var t = {};
	return e[e.length - 1] === "r" ? t.roundingPriority = "morePrecision" : e[e.length - 1] === "s" && (t.roundingPriority = "lessPrecision"), e.replace(Ee, function(e, n, r) {
	...
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		switch (i.stem) {
			...
			case "integer-width":
				...
				i.options[0].replace(De, function(e, n, r, i, a, o) {
		...
		if (Te.test(i.stem)) {
			...
			i.stem.replace(Te, function(e, n, r, i, a, o) {
			...
			var a = i.options[0];
			a === "w" ? t = g(g({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = g(g({}, t), ke(a)));
			continue;
		}
		if (Ee.test(i.stem)) {
			t = g(g({}, t), ke(i.stem));
...
var Ie = RegExp(`^${ye.source}*`), Le = RegExp(`${ye.source}*\$`);
function D(e, t) {
	return {
		start: e,
		end: t
...
var Re = !!String.prototype.startsWith && "_a".startsWith("a", 1), ze = !!String.fromCodePoint, Be = !!Object.fromEntries, Ve = !!String.prototype.codePointAt, He = !!String.prototype.trimStart, Ue = !!String.prototype.trimEnd, We = Number.isSafeInteger ? Number.isSafeInteger : function(e) {
	return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, O = !0;
try {
	O = Xe("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	O = !1;
}
var Ge = Re ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, k = ze ? String.fromCodePoint : function() {
	...
	return t;
}, Ke = Be ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
var A;
if (O) {
	var Ze = Xe("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	A = function(e, t) {
	...
	return e.prototype.parse = function() {
		...
		for (var r = []; !this.isEOF();) {
			...
			if (i === 123) {
				...
				if (n) break;
				return this.error(C.UNMATCHED_CLOSING_TAG, D(this.clonePosition(), this.clonePosition()));
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !j(this.char())) return this.error(C.INVALID_TAG, D(o, this.clonePosition()));
		...
		var n = this.clonePosition();
		if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(C.EXPECT_ARGUMENT_CLOSING_BRACE, D(n, this.clonePosition()));
		if (this.char() === 125) return this.bump(), this.error(C.EMPTY_ARGUMENT, D(n, this.clonePosition()));
		var r = this.parseIdentifierIfPossible().value;
		if (!r) return this.error(C.MALFORMED_ARGUMENT, D(n, this.clonePosition()));
		if (this.bumpSpace(), this.isEOF()) return this.error(C.EXPECT_ARGUMENT_CLOSING_BRACE, D(n, this.clonePosition()));
		switch (this.char()) {
			...
			case 44: return this.bump(), this.bumpSpace(), this.isEOF() ? this.error(C.EXPECT_ARGUMENT_CLOSING_BRACE, D(n, this.clonePosition())) : this.parseArgumentOptions(e, t, r, n);
			default: return this.error(C.MALFORMED_ARGUMENT, D(n, this.clonePosition()));
		}
		...
		switch (a) {
			case "": return this.error(C.EXPECT_ARGUMENT_TYPE, D(i, o));
			case "number":
			case "date":
			case "time":
				this.bumpSpace();
				...
				if (this.bumpIf(",")) {
					...
					if (l.err) return l;
					var u = Ye(l.val);
					if (u.length === 0) return this.error(C.EXPECT_ARGUMENT_STYLE, D(this.clonePosition(), this.clonePosition()));
					s = {
						style: u,
						styleLocation: D(c, this.clonePosition())
					};
				}
			...
			case "select":
				...
				if (this.bumpSpace(), !this.bumpIf(",")) return this.error(C.EXPECT_SELECT_ARGUMENT_OPTIONS, D(h, g({}, h)));
				this.bumpSpace();
				var _ = this.parseIdentifierIfPossible(), v = 0;
				if (a !== "select" && _.value === "offset") {
					if (!this.bumpIf(":")) return this.error(C.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, D(this.clonePosition(), this.clonePosition()));
					this.bumpSpace();
			...
			default: return this.error(C.INVALID_ARGUMENT_TYPE, D(i, o));
		}
	}, e.prototype.tryParseArgumentClose = function(e) {
		return this.isEOF() || this.char() !== 125 ? this.error(C.EXPECT_ARGUMENT_CLOSING_BRACE, D(e, this.clonePosition())) : (this.bump(), {
			val: !0,
			err: null
		});
		...
		for (var e = 0, t = this.clonePosition(); !this.isEOF();) switch (this.char()) {
			case 39:
				this.bump();
				var n = this.clonePosition();
				if (!this.bumpUntil("'")) return this.error(C.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, D(n, this.clonePosition()));
				this.bump();
				break;
			case 123:
				e += 1, this.bump();
		...
		return {
			val: {
				...
				tokens: n,
				location: t,
				parsedOptions: this.shouldParseSkeletons ? Ne(n) : {}
			},
			err: null
		};
		...
		for (var i, a = !1, o = [], s = /* @__PURE__ */ new Set(), c = r.value, l = r.location;;) {
			if (c.length === 0) {
				...
				if (t !== "select" && this.bumpIf("=")) {
					...
					if (d.err) return d;
					l = D(u, this.clonePosition()), c = this.message.slice(u.offset, this.offset());
				} else break;
			}
			...
			if (!this.bumpIf("{")) return this.error(t === "select" ? C.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT : C.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT, D(this.clonePosition(), this.clonePosition()));
		...
		return o.length === 0 ? this.error(t === "select" ? C.EXPECT_SELECT_ARGUMENT_SELECTOR : C.EXPECT_PLURAL_ARGUMENT_SELECTOR, D(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !a ? this.error(C.MISSING_OTHER_CLAUSE, D(this.clonePosition(), this.clonePosition())) : {
			val: o,
			err: null
		};
		...
		if (Ge(this.message, e, this.offset())) {
...
function M(e) {
	e.forEach(function(e) {
		if (delete e.location, pe(e) || me(e)) for (var t in e.options) delete e.options[t].location, M(e.options[t].value);
		else ue(e) && _e(e.style) || (de(e) || fe(e)) && ve(e.style) ? delete e.style.location : ge(e) && M(e.children);
	});
}
function rt(e, t) {
	t === void 0 && (t = {}), t = g({
...
function I(e, t, n, r, i, a, o) {
	...
	for (var s = [], c = 0, l = e; c < l.length; c++) {
		...
		if (de(u)) {
			var p = typeof u.style == "string" ? r.date[u.style] : ve(u.style) ? u.style.parsedOptions : void 0;
			s.push({
				type: F.literal,
		...
		if (fe(u)) {
			var p = typeof u.style == "string" ? r.time[u.style] : ve(u.style) ? u.style.parsedOptions : r.time.medium;
			s.push({
				type: F.literal,
				value: n.getDateTimeFormat(t, p).format(f)
			});
		...
		if (ue(u)) {
			var p = typeof u.style == "string" ? r.number[u.style] : _e(u.style) ? u.style.parsedOptions : void 0;
		...
		if (ge(u)) {
			...
			if (!ct(g)) throw new at(h, "function", o);
		...
		if (pe(u)) {
			...
			if (!v) throw new it(u.value, f, Object.keys(u.options), o);
...
var ft = function() {
	function e(t, n, r, i) {
		...
		this.formats = ut(e.formats, r), this.formatters = i && i.formatters || dt(this.formatterCache);
	}
...
var R = {}, ht = (e, t, n) => n && (t in R || (R[t] = {}), e in R[t] || (R[t][e] = n), n), gt = (e, t) => {
	if (t == null) return;
...
function xt(e, ...t) {
	delete R[e], B.update((n) => (n[e] = pt.default.all([n[e] || {}, ...t]), n));
}
...
function Et(e) {
	...
	let t = wt(e);
	return U[e] = Promise.all(t.map(([e, t]) => Tt(e, t))).then(() => {
		if (H(e)) return Et(e);
		delete U[e];
	}), U[e];
}
...
var Ot = n(!1), kt = Object.defineProperty, At = Object.defineProperties, jt = Object.getOwnPropertyDescriptors, Mt = Object.getOwnPropertySymbols, Nt = Object.prototype.hasOwnProperty, Pt = Object.prototype.propertyIsEnumerable, Ft = (e, t, n) => t in e ? kt(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, It = (e, t) => {
	for (var n in t ||= {}) Nt.call(t, n) && Ft(e, n, t[n]);
	if (Mt) for (var n of Mt(t)) Pt.call(t, n) && Ft(e, n, t[n]);
	return e;
}, Lt = (e, t) => At(e, jt(t)), Rt, G = n(null);
function zt(e) {
...
var J = Lt(It({}, G), { set: (e) => {
	if (e && bt(e) && H(e)) {
		...
		return typeof window < "u" && q() != null && t ? n = window.setTimeout(() => Ot.set(!0), t) : Ot.set(!0), Et(e).then(() => {
			G.set(e);
		}).finally(() => {
...
}, Bt = Object.defineProperty, X = Object.getOwnPropertySymbols, Vt = Object.prototype.hasOwnProperty, Ht = Object.prototype.propertyIsEnumerable, Ut = (e, t, n) => t in e ? Bt(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, Z = (e, t) => {
	for (var n in t ||= {}) Vt.call(t, n) && Ut(e, n, t[n]);
	if (X) for (var n of X(t)) Ht.call(t, n) && Ut(e, n, t[n]);
	return e;
}, Q = (e, t) => {
	var n = {};
	for (var r in e) Vt.call(e, r) && t.indexOf(r) < 0 && (n[r] = e[r]);
	if (e != null && X) for (var r of X(e)) t.indexOf(r) < 0 && Ht.call(e, r) && (n[r] = e[r]);
	return n;
}, $ = (e, t) => {
	let { formats: n } = W();
	...
	var t = e, { locale: n = q() } = t, r = Q(t, ["locale"]);
	return Kt(Z({ locale: n }, r));
}, Xt = Y((e, t = q()) => new ft(e, t, W().formats, { ignoreTag: W().ignoreTag })), Zt = (e, t = {}) => {
	var n;
	let r = t;
	...
	return c;
}, Qt = (e, t) => Yt(t).format(e), $t = (e, t) => Jt(t).format(e), en = (e, t) => qt(t).format(e), tn = (e, t = q()) => gt(e, t), nn = t([J, B], () => Zt);
t([J], () => Qt), t([J], () => $t), t([J], () => en), t([J, B], () => tn);
function rn(e) {
...
var an = e.from_html("<h1 class=\"mb-4 text-3xl font-bold text-foreground\"> </h1> <p class=\"mb-8 max-w-3xl text-muted-foreground\"> </p>", 1);
function on(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(nn, "$_", i), [i, a] = e.setup_stores();
	rn("AboutHeader"), e.init();
	var o = an(), s = e.first_child(o), c = e.only_child(s, !0), l = e.sibling(s, 2), u = e.only_child(l, !0);
	e.template_effect((t, n) => {
		e.set_text(c, t), e.set_text(u, n);
	}, [() => r()("about.header.title"), () => r()("about.header.description")]), e.append(t, o), e.pop(), a();
}
