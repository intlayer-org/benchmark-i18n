...
function rn(t, n) {
	...
	e.init();
	var o = nn(), s = e.child(o), c = e.only_child(s, !0), l = e.sibling(s, 2), u = e.child(l), d = e.only_child(u, !0), f = e.sibling(u, 2), p = e.child(f), m = e.sibling(p, 2), h = e.only_child(m, !0);
	e.reset(f);
	var g = e.sibling(f, 2), _ = e.only_child(g, !0);
	e.reset(l), e.reset(o), e.template_effect((t, n, r, i) => {
		e.set_text(c, t), e.set_text(d, n), e.set_text(h, r), e.set_text(_, i);
	}, [
		() => r()("settings.apiAccess.title"),
		() => r()("settings.apiAccess.apiKey"),
		() => r()("settings.apiAccess.copy"),
		() => r()("settings.apiAccess.description")
