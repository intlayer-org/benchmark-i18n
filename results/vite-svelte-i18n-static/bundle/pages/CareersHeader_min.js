...
var an = e.from_html("<!> <h1 class=\"mb-2 text-3xl font-bold text-foreground\"> </h1> <p class=\"mb-4 text-muted-foreground\"> </p>", 1);
function on(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(tn, "$_", i), [i, a] = e.setup_stores();
	e.init();
	...
	}, [() => r()("careers.header.title"), () => r()("careers.header.description")]), e.append(t, o), e.pop(), a();
}
