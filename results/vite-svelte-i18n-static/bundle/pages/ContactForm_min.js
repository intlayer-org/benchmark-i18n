...
function v(e, t) {
	var n = t && t.cache ? t.cache : E, r = t && t.serializer ? t.serializer : T;
...
function Ee(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		...
		if (ve.test(i.stem)) {
			...
			var a = i.options[0];
			a === "w" ? t = h(h({}, t), { trailingZeroDisplay: "stripIfInteger" }) : a && (t = h(h({}, t), Se(a)));
			continue;
		}
		if (ye.test(i.stem)) {
			t = h(h({}, t), Se(i.stem));
...
try {
	P = Ue("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	P = !1;
}
var Re = je ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, F = Me ? String.fromCodePoint : function() {
	...
	return t;
}, ze = Ne ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
var Ke = function() {
	...
	return e.prototype.parse = function() {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !qe(this.char())) return this.error(O.INVALID_TAG, N(o, this.clonePosition()));
		...
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), F(n));
		...
		switch (a) {
			...
			case "time":
				...
				if (this.bumpIf(",")) {
					...
					if (l.err) return l;
					var u = He(l.val);
					if (u.length === 0) return this.error(O.EXPECT_ARGUMENT_STYLE, N(this.clonePosition(), this.clonePosition()));
					s = {
						style: u,
			...
			case "select":
				...
				if (this.bumpSpace(), !this.bumpIf(",")) return this.error(O.EXPECT_SELECT_ARGUMENT_OPTIONS, N(g, h({}, g)));
				this.bumpSpace();
		...
		for (var e = 0, t = this.clonePosition(); !this.isEOF();) switch (this.char()) {
			case 39:
				this.bump();
				var n = this.clonePosition();
				if (!this.bumpUntil("'")) return this.error(O.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, N(n, this.clonePosition()));
				this.bump();
				break;
			case 123:
				e += 1, this.bump();
		...
		return o.length === 0 ? this.error(t === "select" ? O.EXPECT_SELECT_ARGUMENT_SELECTOR : O.EXPECT_PLURAL_ARGUMENT_SELECTOR, N(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !a ? this.error(O.MISSING_OTHER_CLAUSE, N(this.clonePosition(), this.clonePosition())) : {
			val: o,
			err: null
		};
		...
		if (Re(this.message, e, this.offset())) {
...
function Qe(e) {
	e.forEach(function(e) {
		if (delete e.location, se(e) || ce(e)) for (var t in e.options) delete e.options[t].location, Qe(e.options[t].value);
		else ie(e) && de(e.style) || (ae(e) || oe(e)) && j(e.style) ? delete e.style.location : ue(e) && Qe(e.children);
	});
}
function $e(e, t) {
	t === void 0 && (t = {}), t = h({
...
var B = {}, ft = (e, t, n) => n && (t in B || (B[t] = {}), e in B[t] || (B[t][e] = n), n), pt = (e, t) => {
	if (t == null) return;
...
function yt(e, ...t) {
	delete B[e], V.update((n) => (n[e] = ut.default.all([n[e] || {}, ...t]), n));
}
t([V], ([e]) => Object.keys(e)), V.subscribe((e) => mt = e);
var H = {};
function bt(e, t) {
...
}, Yt = Y((e, t = q()) => new lt(e, t, W().formats, { ignoreTag: W().ignoreTag })), Xt = (e, t = {}) => {
	var n;
	let r = t;
