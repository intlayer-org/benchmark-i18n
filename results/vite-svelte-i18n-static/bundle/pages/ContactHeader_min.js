...
var W = {};
function wt(e) {
	if (!U(e)) return e in W ? W[e] : Promise.resolve();
	let t = St(e);
	return W[e] = Promise.all(t.map(([e, t]) => Ct(e, t))).then(() => {
		if (U(e)) return wt(e);
		delete W[e];
	}), W[e];
}
...
var Et = n(!1), Dt = Object.defineProperty, Ot = Object.defineProperties, kt = Object.getOwnPropertyDescriptors, At = Object.getOwnPropertySymbols, jt = Object.prototype.hasOwnProperty, Mt = Object.prototype.propertyIsEnumerable, Nt = (e, t, n) => t in e ? Dt(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
var Y = Ft(Pt({}, K), { set: (e) => {
	if (e && vt(e) && U(e)) {
		...
		return typeof window < "u" && J() != null && t ? n = window.setTimeout(() => Et.set(!0), t) : Et.set(!0), wt(e).then(() => {
			K.set(e);
		}).finally(() => {
...
}, Yt = X((e, t = J()) => new ut(e, t, G().formats, { ignoreTag: G().ignoreTag })), Xt = (e, t = {}) => {
	var n;
	let r = t;
	...
	return c;
}, Zt = (e, t) => Jt(t).format(e), Qt = (e, t) => qt(t).format(e), $t = (e, t) => Kt(t).format(e), en = (e, t = J()) => mt(e, t), tn = t([Y, V], () => Xt);
t([Y], () => Zt), t([Y], () => Qt), t([Y], () => $t), t([Y, V], () => en);
var nn = e.from_html("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\"> </div>");
function rn(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(tn, "$_", i), [i, a] = e.setup_stores();
	e.init();
	var o = nn(), s = e.only_child(o, !0);
	e.template_effect((t) => e.set_text(s, t), [() => r()("mockBanner")]), e.append(t, o), e.pop(), a();
}
var an = e.from_html("<!> <h1 class=\"mb-2 text-3xl font-bold text-foreground\"> </h1> <p class=\"mb-8 text-muted-foreground\"> <a href=\"mailto:contact@intlayer.org\" class=\"text-primary hover:underline\"> </a>.</p>", 1);
function on(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(tn, "$_", i), [i, a] = e.setup_stores();
	e.init();
	var o = an(), s = e.first_child(o);
	rn(s, {});
	var c = e.sibling(s, 2), l = e.only_child(c, !0), u = e.sibling(c, 2), d = e.child(u), f = e.sibling(d), p = e.only_child(f, !0);
	e.next(), e.reset(u), e.template_effect((t, n, r) => {
		e.set_text(l, t), e.set_text(d, `${n ?? ""} `), e.set_text(p, r);
	}, [
		() => r()("contact.header.title"),
		() => r()("contact.header.description"),
		() => r()("shared.contactEmail")
