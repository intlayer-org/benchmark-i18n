...
function rn(t, n) {
	...
	e.init();
	var o = nn(), s = e.child(o, !0);
	e.reset(o), e.template_effect((t) => e.set_text(s, t), [() => r()("mockBanner")]), e.append(t, o), e.pop(), a();
}
...
function on(t, n) {
	...
	e.reset(c);
	var u = e.sibling(c, 2), d = e.child(u), f = e.sibling(d), p = e.child(f, !0);
	e.reset(f), e.next(), e.reset(u), e.template_effect((t, n, r) => {
