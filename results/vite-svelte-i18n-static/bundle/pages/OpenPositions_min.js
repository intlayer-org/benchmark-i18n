...
function te(e, t) {
	var n = e.length === 1 ? b : ee;
	return x(e, this, n, t.cache.create(), t.serializer);
}
function ne(e, t) {
	return x(e, this, ee, t.cache.create(), t.serializer);
}
function re(e, t) {
...
try {
	k = Je("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")?.[0] === "a";
} catch {
	k = !1;
}
var Ue = Ie ? function(e, t, n) {
	return e.startsWith(t, n);
} : function(e, t, n) {
	return e.slice(n, n + t.length) === t;
}, A = Le ? String.fromCodePoint : function() {
	...
	return t;
}, We = Re ? Object.fromEntries : function(e) {
	for (var t = {}, n = 0, r = e; n < r.length; n++) {
		var i = r[n], a = i[0];
		t[a] = i[1];
	}
...
var j;
if (k) {
	var Ye = Je("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
	j = function(e, t) {
		return Ye.lastIndex = t, Ye.exec(e)[1] ?? "";
	};
} else j = function(e, t) {
	for (var n = [];;) {
		var r = Ge(e, t);
...
var Xe = function() {
	...
	return e.prototype.parse = function() {
		...
		if (this.bumpIf(">")) {
			...
			if (this.bumpIf("</")) {
				if (this.isEOF() || !M(this.char())) return this.error(C.INVALID_TAG, O(o, this.clonePosition()));
		...
		var n = this.char();
		return n === 60 || n === 123 || n === 35 && (t === "plural" || t === "selectordinal") || n === 125 && e > 0 ? null : (this.bump(), A(n));
		...
		var e = this.clonePosition(), t = this.offset(), n = j(this.message, t), r = t + n.length;
...
function N(e) {
	e.forEach(function(e) {
		if (delete e.location, fe(e) || pe(e)) for (var t in e.options) delete e.options[t].location, N(e.options[t].value);
		else le(e) && ge(e.style) || (ue(e) || de(e)) && E(e.style) ? delete e.style.location : he(e) && N(e.children);
	});
}
function tt(e, t) {
	t === void 0 && (t = {}), t = h({
...
function yt(e, ...t) {
	delete z[e], V.update((n) => (n[e] = dt.default.all([n[e] || {}, ...t]), n));
}
t([V], ([e]) => Object.keys(e)), V.subscribe((e) => B = e);
var H = {};
function bt(e, t) {
...
var U = {};
function Tt(e) {
	if (!Ct(e)) return e in U ? U[e] : Promise.resolve();
	let t = St(e);
...
var J = It(Ft({}, G), { set: (e) => {
	if (e && vt(e) && Ct(e)) {
		...
		return typeof window < "u" && q() != null && t ? n = window.setTimeout(() => Dt.set(!0), t) : Dt.set(!0), Tt(e).then(() => {
			G.set(e);
		}).finally(() => {
...
}, zt = Object.defineProperty, X = Object.getOwnPropertySymbols, Bt = Object.prototype.hasOwnProperty, Vt = Object.prototype.propertyIsEnumerable, Ht = (e, t, n) => t in e ? zt(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
	...
	if (X) for (var n of X(t)) Vt.call(t, n) && Ht(e, n, t[n]);
	return e;
}, Q = (e, t) => {
	var n = {};
	for (var r in e) Bt.call(e, r) && t.indexOf(r) < 0 && (n[r] = e[r]);
	if (e != null && X) for (var r of X(e)) t.indexOf(r) < 0 && Vt.call(e, r) && (n[r] = e[r]);
	return n;
}, $ = (e, t) => {
	let { formats: n } = W();
	...
	var t = e, { locale: n = q() } = t, r = Q(t, ["locale"]);
	return Ut(Z({ locale: n }, r));
}, qt = (e = {}) => {
	var t = e, { locale: n = q() } = t, r = Q(t, ["locale"]);
	return Wt(Z({ locale: n }, r));
}, Jt = (e = {}) => {
	var t = e, { locale: n = q() } = t, r = Q(t, ["locale"]);
	return Gt(Z({ locale: n }, r));
}, Yt = Y((e, t = q()) => new ut(e, t, W().formats, { ignoreTag: W().ignoreTag })), Xt = (e, t = {}) => {
	var n;
	let r = t;
	...
	return c;
}, Zt = (e, t) => Jt(t).format(e), Qt = (e, t) => qt(t).format(e), $t = (e, t) => Kt(t).format(e), en = (e, t = q()) => mt(e, t), tn = t([J, V], () => Xt);
t([J], () => Zt), t([J], () => Qt), t([J], () => $t), t([J, V], () => en);
var nn = e.from_html("<div class=\"flex flex-col gap-3 rounded-lg border border-border bg-card p-6 md:flex-row md:items-center md:justify-between\"><div><h3 class=\"text-base font-semibold text-foreground\"> </h3> <p class=\"text-sm text-muted-foreground\"> </p> <div class=\"mt-2 flex gap-2\"><span class=\"rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground\"> </span> <span class=\"rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground\"> </span> <span class=\"rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground\"> </span></div></div> <button type=\"button\" class=\"shrink-0 rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-opacity hover:opacity-90\"> </button></div>"), rn = e.from_html("<h2 class=\"mb-6 text-2xl font-bold text-foreground\"> </h2> <div class=\"space-y-4\"></div>", 1);
function an(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(tn, "$_", i), [i, a] = e.setup_stores(), o = [
		{
	...
	e.init();
	var s = rn(), c = e.first_child(s), l = e.only_child(c, !0), u = e.sibling(c, 2);
	e.each(u, 5, () => o, (e) => `${e.titleKey}-${e.locationKey}`, (t, n) => {
		var i = nn(), a = e.child(i), o = e.child(a), s = e.only_child(o, !0), c = e.sibling(o, 2), l = e.only_child(c, !0), u = e.sibling(c, 2), d = e.child(u), f = e.only_child(d, !0), p = e.sibling(d, 2), m = e.only_child(p, !0), h = e.sibling(p, 2), g = e.only_child(h, !0);
		e.reset(u), e.reset(a);
		var _ = e.sibling(a, 2), v = e.only_child(_, !0);
		e.reset(i), e.template_effect((t, n, r, i, a, o) => {
			e.set_text(s, t), e.set_text(l, n), e.set_text(f, r), e.set_text(m, i), e.set_text(g, a), e.set_text(v, o);
		}, [
			() => r()(`careers.openPositions.${e.get(n).titleKey}`),
			() => r()(`careers.openPositions.${e.get(n).descKey}`),
			() => r()(`careers.openPositions.${e.get(n).deptKey}`),
			() => r()(`careers.openPositions.${e.get(n).locationKey}`),
			() => r()(`careers.openPositions.${e.get(n).typeKey}`),
			() => r()("careers.openPositions.applyNow")
		]), e.append(t, i);
	}), e.reset(u), e.template_effect((t) => e.set_text(l, t), [() => r()("careers.openPositions.title")]), e.append(t, s), e.pop(), a();
}
