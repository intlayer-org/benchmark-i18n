...
var an = e.from_html("<!> <div class=\"mb-12 text-center\"><h1 class=\"mb-3 text-3xl font-bold text-foreground\"> </h1> <p class=\"text-muted-foreground\"> </p></div>", 1);
function on(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(tn, "$_", i), [i, a] = e.setup_stores();
	e.init();
	...
	rn(s, {});
	var c = e.sibling(s, 2), l = e.child(c), u = e.child(l, !0);
	e.reset(l);
	var d = e.sibling(l, 2), f = e.child(d, !0);
	e.reset(d), e.reset(c), e.template_effect((t, n) => {
		e.set_text(u, t), e.set_text(f, n);
	}, [() => r()("pricing.header.title"), () => r()("pricing.header.description")]), e.append(t, o), e.pop(), a();
}
