...
var nn = e.from_html("<div class=\"flex flex-col justify-between rounded-lg border border-border bg-card p-6\"><div><h3 class=\"mb-2 text-lg font-semibold text-foreground\"> </h3> <p class=\"mb-4 text-sm text-muted-foreground\"> </p></div> <div class=\"flex items-center justify-between\"><span class=\"text-sm font-bold text-primary\"> </span> <button type=\"button\" class=\"rounded-md bg-primary px-4 py-2 text-xs font-medium text-primary-foreground transition-opacity hover:opacity-90\"> </button></div></div>"), rn = e.from_html("<div class=\"grid gap-6 md:grid-cols-2 lg:grid-cols-3\"></div>");
function an(t, n) {
	e.push(n, !1);
	...
	e.each(s, 5, () => o, (e) => e.id, (t, n) => {
		var i = nn(), a = e.child(i), o = e.child(a), s = e.only_child(o, !0), c = e.sibling(o, 2), l = e.only_child(c, !0);
		e.reset(a);
		var u = e.sibling(a, 2), d = e.child(u), f = e.only_child(d, !0), p = e.sibling(d, 2), m = e.only_child(p, !0);
		e.reset(u), e.reset(i), e.template_effect((t, n, r, i) => {
			e.set_text(s, t), e.set_text(l, n), e.set_text(f, r), e.set_text(m, i);
		}, [
			() => r()(`products.grid.${e.get(n).nameKey}`),
			() => r()(`products.grid.${e.get(n).descKey}`),
			() => r()(`products.grid.${e.get(n).priceKey}`),
			() => r()("products.grid.learnMore")
		]), e.append(t, i);
	}), e.reset(s), e.append(t, s), e.pop(), a();
}
