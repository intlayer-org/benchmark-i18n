...
var an = e.from_html("<!> <h1 class=\"mb-2 text-3xl font-bold text-foreground\"> </h1> <p class=\"mb-10 text-muted-foreground\"> </p>", 1);
function on(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(tn, "$_", i), [i, a] = e.setup_stores();
	e.init();
	...
	rn(s, {});
	var c = e.sibling(s, 2), l = e.only_child(c, !0), u = e.sibling(c, 2), d = e.only_child(u, !0);
	e.template_effect((t, n) => {
		e.set_text(l, t), e.set_text(d, n);
	}, [() => r()("products.header.title"), () => r()("products.header.description")]), e.append(t, o), e.pop(), a();
}
