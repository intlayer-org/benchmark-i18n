...
function rn(t, n) {
	...
	e.reset(d), e.sibling(d, 2), e.reset(u);
	var p = e.sibling(u, 2), m = e.child(p), h = e.child(m, !0);
	e.reset(m), e.sibling(m, 2), e.reset(p), e.reset(l), e.reset(o), e.template_effect((t, n, r) => {
