...
function rn(t, n) {
	...
	e.init();
	var o = nn(), s = e.child(o), c = e.only_child(s, !0), l = e.sibling(s, 2), u = e.child(l), d = e.child(u), f = e.only_child(d, !0);
	e.sibling(d, 2), e.reset(u);
	var p = e.sibling(u, 2), m = e.child(p), h = e.only_child(m, !0);
	e.sibling(m, 2), e.reset(p), e.reset(l), e.reset(o), e.template_effect((t, n, r) => {
		e.set_text(c, t), e.set_text(f, n), e.set_text(h, r);
	}, [
		() => r()("settings.profile.title"),
		() => r()("settings.profile.displayName"),
		() => r()("settings.profile.email")
