...
function rn(t, n) {
	...
	e.reset(l), e.reset(o), e.template_effect((t, n) => {
		e.set_text(c, t), e.set_text(u, n);
	}, [() => r()("settings.footer.cancel"), () => r()("settings.footer.saveChanges")]), e.append(t, o), e.pop(), a();
}
