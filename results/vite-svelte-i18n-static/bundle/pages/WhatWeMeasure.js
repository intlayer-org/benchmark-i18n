...
function WhatWeMeasure($$anchor, $$props) {
	...
	var ul = $.sibling(h2, 2);
	$.each(ul, 5, () => metricKeys, (k) => k.m, ($$anchor, k) => {
		var li = root();
		var span = $.child(li);
		...
		$.template_effect(($0, $1) => {
			$.set_text(text_1, $0);
			$.set_text(text_2, $1);
		}, [() => $_()(`about.whatWeMeasure.${$.get(k).m}`), () => $_()(`about.whatWeMeasure.${$.get(k).d}`)]);
		$.append($$anchor, li);
	});
	$.reset(ul);
	$.reset(section);
	$.template_effect(($0) => $.set_text(text, $0), [() => $_()("about.whatWeMeasure.title")]);
