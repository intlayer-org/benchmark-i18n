...
var nn = e.from_html("<li class=\"rounded-md border border-border p-4\"><span class=\"block text-sm font-bold text-primary\"> </span> <span class=\"mt-1 block text-sm text-muted-foreground\"> </span></li>"), rn = e.from_html("<section class=\"mx-auto mt-12 max-w-3xl\"><h2 class=\"mb-4 text-2xl font-bold text-foreground\"> </h2> <ul class=\"space-y-4\"></ul></section>");
function an(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(tn, "$_", i), [i, a] = e.setup_stores(), o = [
		{
			m: "bundleSizeImpact",
			d: "bundleSizeImpactDesc"
		},
		{
			m: "renderingOverhead",
			d: "renderingOverheadDesc"
		},
		{
			m: "hydrationCost",
			d: "hydrationCostDesc"
	...
	e.init();
	var s = rn(), c = e.child(s), l = e.only_child(c, !0), u = e.sibling(c, 2);
	e.each(u, 5, () => o, (e) => e.m, (t, n) => {
		var i = nn(), a = e.child(i), o = e.only_child(a, !0), s = e.sibling(a, 2), c = e.only_child(s, !0);
		e.reset(i), e.template_effect((t, n) => {
			e.set_text(o, t), e.set_text(c, n);
		}, [() => r()(`about.whatWeMeasure.${e.get(n).m}`), () => r()(`about.whatWeMeasure.${e.get(n).d}`)]), e.append(t, i);
	}), e.reset(u), e.reset(s), e.template_effect((t) => e.set_text(l, t), [() => r()("about.whatWeMeasure.title")]), e.append(t, s), e.pop(), a();
}
