...
var ee = {
	...
	en: () => import("./intlayer-MockBanner-k7cdsn-en-Cy-1N2BQ.js").then((e) => e.t).then((e) => e.default),
...
var b = a?.defaultLocale, ie = (() => {
...
}, le = "translation", ue = "object", de = "array", w = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), T = (e, t) => {
	...
	return n;
}, E = /* @__PURE__ */ new WeakMap(), D = 0, fe = (e) => {
	if (!e) return "base";
	let t = E.get(e);
	if (t) return t;
	D += 1;
	let n = `p${D}`;
	return E.set(e, n), n;
}, pe = 256, O = /* @__PURE__ */ new WeakMap(), k = (e) => typeof e == "object" && !!e, me = (e, t, n) => `${e}_${t}_${fe(n)}`, he = (e, t) => {
	if (!k(e)) return { hit: !1 };
	let n = O.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	if (!k(e)) return n;
	let r = O.get(e);
	return r || (r = /* @__PURE__ */ new Map(), O.set(e, r)), r.size >= pe && r.clear(), r.set(t, n), n;
}, ge = (e, t = !0) => [
	...
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, o = me(r ?? a.defaultLocale, "", n), s = he(e, o);
	...
	let c = n ?? ge(r), l = e, u = (e) => {
		...
		M.add(e);
		try {
			return j(e.content, t, c);
		} finally {
			t.eager && M.delete(e);
		}
	};
	return l === null ? A(e, o, null) : Array.isArray(l) ? A(e, o, l.map(u)) : A(e, o, u(l));
}, P = (e) => {
...
var we = e.from_html("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\"> </div>");
function Te(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(o, "$banner", i), [i, a] = e.setup_stores(), o = $(_, "mock-banner");
	e.init();
	var s = we(), c = e.only_child(s, !0);
...
var e = Object.defineProperty, t = ((t, n) => {
	...
	default: () => i,
	key: () => n
}), n = "mock-banner", r = { message: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." }, i = {
	key: n,
	content: r
};
export { t };
