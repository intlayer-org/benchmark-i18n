...
var B = e.from_html("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\"> </div>");
function V(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(s, "$banner", a), [a, o] = e.setup_stores(), s = z(i, "mock-banner");
	e.init();
	var c = B(), l = e.child(c, !0);
	e.reset(c), e.template_effect(() => e.set_text(l, r().message)), e.append(t, c), e.pop(), o();
}
export { V as default };
var e = {
	key: "mock-banner",
