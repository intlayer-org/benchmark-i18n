...
var m = {
	...
	en: () => import("./intlayer-AboutGrid-1ylh59-en-eIIKbyi3.js").then((e) => e.t).then((e) => e.default),
...
function Te(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(o, "$content", i), [i, a] = e.setup_stores(), o = $(b, "about-grid");
	e.init();
	var s = we(), c = e.child(s), l = e.child(c), u = e.only_child(l, !0), d = e.sibling(l, 2), f = e.only_child(d, !0);
	e.reset(c);
	var p = e.sibling(c, 2), m = e.child(p), h = e.only_child(m, !0), g = e.sibling(m, 2), _ = e.only_child(g, !0);
	e.reset(p), e.reset(s), e.template_effect(() => {
		e.set_text(u, r().why.title), e.set_text(f, r().why.description), e.set_text(h, r().methodology.title), e.set_text(_, r().methodology.description);
