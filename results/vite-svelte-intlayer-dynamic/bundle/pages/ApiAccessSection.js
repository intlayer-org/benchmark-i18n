...
var content = {
	...
	"en": () => import("./intlayer-ApiAccessSection-13mvxz-en-BEGmibQx.js").then((n) => n.t).then((m) => m.default),
...
function ApiAccessSection($$anchor, $$props) {
	...
	$.reset(section);
	$.template_effect(() => {
		$.set_text(text, $content().apiAccess);
		$.set_text(text_1, $content().apiKey);
		$.set_text(text_2, $content().copy);
		$.set_text(text_3, $content().useThisKeyToAccess);
	});
