...
var i = {
	de: () => import("./de-qxyQcx1w.js").then((e) => e.default),
	en: () => import("./en-Cp_3RC5J.js").then((e) => e.default),
	es: () => import("./es-DDuhatiq.js").then((e) => e.default),
	fr: () => import("./fr-BrCwUdhs.js").then((e) => e.default),
	it: () => import("./it-DCkZNkl3.js").then((e) => e.default),
	ja: () => import("./ja-BdIIkvyA.js").then((e) => e.default),
	ko: () => import("./ko-BDgioh2I.js").then((e) => e.default),
	pt: () => import("./pt-e2bFJq2v.js").then((e) => e.default),
	ru: () => import("./ru-D2j0M49E.js").then((e) => e.default),
	zh: () => import("./zh-BilhHGmK.js").then((e) => e.default)
...
function W(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(s, "$content", a), [a, o] = e.setup_stores(), s = z(i, "blog-header");
	e.init();
