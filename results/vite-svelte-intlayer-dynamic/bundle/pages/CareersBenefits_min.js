...
var ee = {
	...
	en: () => import("./intlayer-CareersBenefits-1u6kyl-en-C3Uas9RO.js").then((e) => e.t).then((e) => e.default),
...
var we = e.from_html("<div class=\"rounded-lg border border-border bg-card p-4 text-center\"><p class=\"text-sm font-semibold text-foreground\"> </p> <p class=\"text-xs text-muted-foreground\"> </p></div>"), Te = e.from_html("<div class=\"mb-12 grid gap-4 md:grid-cols-3\"></div>");
function Ee(t, n) {
	e.push(n, !0);
	let r = () => e.store_get(o, "$content", i), [i, a] = e.setup_stores(), o = $(_, "careers-benefits"), s = e.derived(() => [
		{
			label: "Remote-first",
			value: r().workFromAnywhereInThe
		},
		{
			label: r().competitivePay,
			value: r().topOfMarketCompensation
		},
		{
			label: r().openSourceTime,
			value: r().x20TimeForOssContributions
		}
	]);
	var c = Te();
	e.each(c, 21, () => e.get(s), e.index, (t, n) => {
		var r = we(), i = e.child(r), a = e.only_child(i, !0), o = e.sibling(i, 2), s = e.only_child(o, !0);
