...
var content$1 = {
	...
	"en": () => import("./intlayer-CareersHeader-j5xw0o-en-deE60yLc.js").then((n) => n.n).then((m) => m.default),
...
var content = {
	...
	"en": () => import("./intlayer-CareersHeader-j5xw0o-en-deE60yLc.js").then((n) => n.t).then((m) => m.default),
...
var root = $.from_html(`<!> <h1 class="mb-2 text-3xl font-bold text-foreground"> </h1> <p class="mb-4 text-muted-foreground"> </p>`, 1);
function CareersHeader($$anchor, $$props) {
	$.push($$props, false);
	...
	$.template_effect(() => {
		$.set_text(text, $content().careers);
		$.set_text(text_1, $content().joinOurMissionToImprove);
	});
	$.append($$anchor, fragment);
	$.pop();
	$$cleanup();
