...
var ee = {
	...
	en: () => import("./intlayer-CareersHeader-j5xw0o-en-Bw57xH5-.js").then((e) => e.n).then((e) => e.default),
...
var Z = {
	...
	en: () => import("./intlayer-CareersHeader-j5xw0o-en-Bw57xH5-.js").then((e) => e.t).then((e) => e.default),
...
var ke = e.from_html("<!> <h1 class=\"mb-2 text-3xl font-bold text-foreground\"> </h1> <p class=\"mb-4 text-muted-foreground\"> </p>", 1);
function Ae(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(o, "$content", i), [i, a] = e.setup_stores(), o = X(_, "careers-header");
	e.init();
	var s = ke(), c = e.first_child(s);
	Oe(c, {});
	var l = e.sibling(c, 2), u = e.only_child(l, !0), d = e.sibling(l, 2), f = e.only_child(d, !0);
	e.template_effect(() => {
		e.set_text(u, r().careers), e.set_text(f, r().joinOurMissionToImprove);
