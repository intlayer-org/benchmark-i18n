...
var content$1 = {
	...
	"en": () => import("./intlayer-ContactHeader-dw1cme-en-B3C4o2hB.js").then((n) => n.n).then((m) => m.default),
...
var content = {
	...
	"en": () => import("./intlayer-ContactHeader-dw1cme-en-B3C4o2hB.js").then((n) => n.t).then((m) => m.default),
...
var root = $.from_html(`<!> <h1 class="mb-2 text-3xl font-bold text-foreground"> </h1> <p class="mb-8 text-muted-foreground"> <a href="mailto:contact@intlayer.org" class="text-primary hover:underline">contact@intlayer.org</a> .</p>`, 1);
function ContactHeader($$anchor, $$props) {
	$.push($$props, false);
	...
	$.reset(p);
	$.template_effect(() => {
		$.set_text(text, $content().getInTouch);
		$.set_text(text_1, $content().haveIdeasFoundABug);
	});
	$.append($$anchor, fragment);
	$.pop();
	$$cleanup();
...
var key = "mock-banner";
var content = { "message": "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." };
var en_default = {
	key,
	content
};
