...
var ee = {
	...
	en: () => import("./intlayer-ContactHeader-dw1cme-en-CbUowwoo.js").then((e) => e.n).then((e) => e.default),
...
var Z = {
	...
	en: () => import("./intlayer-ContactHeader-dw1cme-en-CbUowwoo.js").then((e) => e.t).then((e) => e.default),
...
var ke = e.from_html("<!> <h1 class=\"mb-2 text-3xl font-bold text-foreground\"> </h1> <p class=\"mb-8 text-muted-foreground\"> <a href=\"mailto:contact@intlayer.org\" class=\"text-primary hover:underline\">contact@intlayer.org</a> .</p>", 1);
function Ae(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(o, "$content", i), [i, a] = e.setup_stores(), o = X(_, "contact-header");
	e.init();
	var s = ke(), c = e.first_child(s);
	Oe(c, {});
	var l = e.sibling(c, 2), u = e.only_child(l, !0), d = e.sibling(l, 2), f = e.child(d, !0);
	e.next(2), e.reset(d), e.template_effect(() => {
		e.set_text(u, r().getInTouch), e.set_text(f, r().haveIdeasFoundABug);
...
var e = Object.defineProperty, t = (t, n) => {
	...
	default: () => l,
	key: () => s
}), s = "mock-banner", c = { message: "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." }, l = {
	key: s,
	content: c
};
export { n, o as t };
