...
var content$1 = {
	"de": () => import("./de-BQ3rPcN-.js").then((m) => m.default),
	"en": () => import("./en-DTxX5lXv.js").then((m) => m.default),
	"es": () => import("./es-BJ_Ibx7m.js").then((m) => m.default),
	"fr": () => import("./fr-DZ253nEr.js").then((m) => m.default),
	"it": () => import("./it-BNi5Zf__.js").then((m) => m.default),
	"ja": () => import("./ja-BHrZXI2O.js").then((m) => m.default),
	"ko": () => import("./ko-cTjnxtyT.js").then((m) => m.default),
	"pt": () => import("./pt-CN-2vRjn.js").then((m) => m.default),
	"ru": () => import("./ru-CdYP1Ifo.js").then((m) => m.default),
	"zh": () => import("./zh-VEmz82EI.js").then((m) => m.default)
};
