...
var content$1 = {
	"de": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header/de.json").then((m) => m.default),
	"en": () => import("./intlayer-FAQHeader-2b8iim-en-CPWEtkBC.js").then((n) => n.n).then((m) => m.default),
	"es": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header/es.json").then((m) => m.default),
	"fr": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header/fr.json").then((m) => m.default),
	"it": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header/it.json").then((m) => m.default),
	"ja": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header/ja.json").then((m) => m.default),
	"ko": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header/ko.json").then((m) => m.default),
	"pt": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header/pt.json").then((m) => m.default),
	"ru": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header/ru.json").then((m) => m.default),
	"zh": () => import("../../../../.intlayer/dynamic_dictionary/json/faq-header/zh.json").then((m) => m.default)
};
...
var content = {
	...
	"en": () => import("./intlayer-FAQHeader-2b8iim-en-CPWEtkBC.js").then((n) => n.t).then((m) => m.default),
...
function FAQHeader($$anchor, $$props) {
	$.push($$props, false);
	const $content = () => $.store_get(content, "$content", $$stores);
	const [$$stores, $$cleanup] = $.setup_stores();
	const content = useDictionaryDynamic(content$1, "faq-header");
	$.init();
	var fragment = root();
	var node = $.first_child(fragment);
	MockBanner(node, {});
