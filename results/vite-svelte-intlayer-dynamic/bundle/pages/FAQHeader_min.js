...
var ee = {
	...
	en: () => import("./intlayer-FAQHeader-2b8iim-en-DAgbEqxL.js").then((e) => e.n).then((e) => e.default),
...
var Z = {
	...
	en: () => import("./intlayer-FAQHeader-2b8iim-en-DAgbEqxL.js").then((e) => e.t).then((e) => e.default),
...
function Ae(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(o, "$content", i), [i, a] = e.setup_stores(), o = X(_, "faq-header");
	e.init();
