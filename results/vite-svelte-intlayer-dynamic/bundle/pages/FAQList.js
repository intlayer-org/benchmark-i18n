...
var content = {
	"de": () => import("./de-BhkO_U3F.js").then((m) => m.default),
	"en": () => import("./en-1L7nRLun.js").then((m) => m.default),
	"es": () => import("./es-Cfw1eV4M.js").then((m) => m.default),
	"fr": () => import("./fr-BtXveYay.js").then((m) => m.default),
	"it": () => import("./it-BQNMP0Ej.js").then((m) => m.default),
	"ja": () => import("./ja-OzjY2SDf.js").then((m) => m.default),
	"ko": () => import("./ko-BYtPv31f.js").then((m) => m.default),
	"pt": () => import("./pt-DP0glL6Z.js").then((m) => m.default),
	"ru": () => import("./ru-BO2CQpBD.js").then((m) => m.default),
	"zh": () => import("./zh-B_7--mfg.js").then((m) => m.default)
};
