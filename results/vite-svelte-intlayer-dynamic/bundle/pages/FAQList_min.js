...
var ee = {
	...
	en: () => import("./intlayer-FAQList-f2m3ip-en-DO-sIut5.js").then((e) => e.t).then((e) => e.default),
...
var we = e.from_html("<details class=\"group rounded-lg border border-border bg-card\"><summary class=\"cursor-pointer px-6 py-4 text-sm font-medium text-foreground transition-colors hover:bg-accent/50\"> </summary> <p class=\"px-6 pb-4 text-sm text-muted-foreground\"> </p></details>"), Te = e.from_html("<div class=\"mx-auto max-w-3xl space-y-4\"></div>");
function Ee(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(o, "$content", i), [i, a] = e.setup_stores(), o = $(_, "faq-list");
	e.init();
	var s = Te();
	e.each(s, 5, () => r().faqs, e.index, (t, n) => {
