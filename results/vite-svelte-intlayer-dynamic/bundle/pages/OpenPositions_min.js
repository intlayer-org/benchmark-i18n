...
var m = {
	...
	en: () => import("./intlayer-OpenPositions-1m50qo-en-DONmbkei.js").then((e) => e.t).then((e) => e.default),
...
function Ee(t, n) {
	...
	var c = Te(), l = e.first_child(c), u = e.only_child(l, !0), d = e.sibling(l, 2);
	e.each(d, 21, () => e.get(s), e.index, (t, n) => {
		var i = we(), a = e.child(i), o = e.child(a), s = e.only_child(o, !0), c = e.sibling(o, 2), l = e.only_child(c, !0), u = e.sibling(c, 2), d = e.child(u), f = e.only_child(d, !0), p = e.sibling(d, 2), m = e.only_child(p, !0), h = e.sibling(p, 2), g = e.only_child(h, !0);
		e.reset(u), e.reset(a);
	...
	}), e.reset(d), e.template_effect(() => e.set_text(u, r().openPositions)), e.append(t, c), e.pop(), a();
}
