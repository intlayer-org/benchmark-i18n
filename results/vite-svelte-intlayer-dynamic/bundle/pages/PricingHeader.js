...
var content$1 = {
	...
	"en": () => import("./intlayer-PricingHeader-qxnn8m-en-BRjvcesq.js").then((n) => n.t).then((m) => m.default),
...
var content = {
	...
	"en": () => import("./intlayer-PricingHeader-qxnn8m-en-BRjvcesq.js").then((n) => n.n).then((m) => m.default),
...
function PricingHeader($$anchor, $$props) {
	...
	$.reset(div);
	$.template_effect(() => {
		$.set_text(text, $content().simpleTransparentPricing);
		$.set_text(text_1, $content().chooseThePlanThatFits);
	});
	$.append($$anchor, fragment);
	$.pop();
	$$cleanup();
...
var content$1 = { "message": "⚠️ This page contains mock data for benchmarking purposes only. It is not related to any real business or service." };
var en_default$1 = {
	key: key$1,
	content: content$1
};
