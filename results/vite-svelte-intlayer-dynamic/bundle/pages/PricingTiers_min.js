...
var ee = {
	...
	en: () => import("./intlayer-PricingTiers-1vx3ju-en-EjCBpqrk.js").then((e) => e.t).then((e) => e.default),
...
var we = e.from_html("<li class=\"flex items-center gap-2 text-sm text-muted-foreground\"><span class=\"text-primary\">✓</span> </li>"), Te = e.from_html("<div><h3 class=\"text-lg font-semibold text-foreground\"> </h3> <div class=\"my-4\"><span class=\"text-3xl font-bold text-foreground\"> </span> <span class=\"text-sm text-muted-foreground\"> </span></div> <ul class=\"mb-6 flex-1 space-y-2\"></ul> <button type=\"button\"> </button></div>"), Ee = e.from_html("<div class=\"grid gap-6 md:grid-cols-3\"></div>");
function De(t, n) {
	e.push(n, !0);
	let r = () => e.store_get(o, "$content", i), [i, a] = e.setup_stores(), o = $(_, "pricing-tiers"), s = e.derived(() => [
		{
			name: r().starter,
			price: "$0",
			period: "forever",
	...
	e.each(c, 21, () => e.get(s), e.index, (t, n) => {
		var r = Te(), i = e.child(r), a = e.only_child(i, !0), o = e.sibling(i, 2), s = e.child(o), c = e.only_child(s, !0), l = e.sibling(s, 2), u = e.only_child(l, !0);
		e.reset(o);
		var d = e.sibling(o, 2);
		e.each(d, 21, () => e.get(n).features, e.index, (t, n) => {
			var r = we(), i = e.sibling(e.child(r));
