...
var content = {
	"de": () => import("./de-4tuNEcsh.js").then((m) => m.default),
	"en": () => import("./en-B-wy1rdH.js").then((m) => m.default),
	"es": () => import("./es-DVZucqn8.js").then((m) => m.default),
	"fr": () => import("./fr-S4wIC4xN.js").then((m) => m.default),
	"it": () => import("./it-BimFR7y-.js").then((m) => m.default),
	"ja": () => import("./ja-DVaKEKhE.js").then((m) => m.default),
	"ko": () => import("./ko-D1ZY0dvR.js").then((m) => m.default),
	"pt": () => import("./pt-C-iao0dm.js").then((m) => m.default),
	"ru": () => import("./ru-B_WvbIDP.js").then((m) => m.default),
	"zh": () => import("./zh-CS_OASSc.js").then((m) => m.default)
};
