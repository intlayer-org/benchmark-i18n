...
var i = {
	de: () => import("./de-DCM3GVJP.js").then((e) => e.default),
	en: () => import("./en-B1gE57-S.js").then((e) => e.default),
	es: () => import("./es-Bzq50Nx6.js").then((e) => e.default),
	fr: () => import("./fr-snKtPPeB.js").then((e) => e.default),
	it: () => import("./it-BJjwa5jv.js").then((e) => e.default),
	ja: () => import("./ja-DPnou4GC.js").then((e) => e.default),
	ko: () => import("./ko-CMBWxutF.js").then((e) => e.default),
	pt: () => import("./pt-D6MwrthO.js").then((e) => e.default),
	ru: () => import("./ru-fLZdCavk.js").then((e) => e.default),
	zh: () => import("./zh-PBCtveH6.js").then((e) => e.default)
...
function W(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(s, "$content", a), [a, o] = e.setup_stores(), s = z(i, "products-header");
	e.init();
