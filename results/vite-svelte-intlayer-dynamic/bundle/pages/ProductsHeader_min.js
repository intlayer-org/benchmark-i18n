...
var ee = {
	...
	en: () => import("./intlayer-ProductsHeader-1e72g5-en-6gdoh2dx.js").then((e) => e.t).then((e) => e.default),
...
var Z = {
	...
	en: () => import("./intlayer-ProductsHeader-1e72g5-en-6gdoh2dx.js").then((e) => e.n).then((e) => e.default),
...
function Ae(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(o, "$content", i), [i, a] = e.setup_stores(), o = X(_, "products-header");
	e.init();
	var s = ke(), c = e.first_child(s);
	Oe(c, {});
	var l = e.sibling(c, 2), u = e.only_child(l, !0), d = e.sibling(l, 2), f = e.only_child(d, !0);
	e.template_effect(() => {
		e.set_text(u, r().products), e.set_text(f, r().toolsAndServicesToStreamline);
