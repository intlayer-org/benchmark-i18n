...
var content = {
	...
	"en": () => import("./intlayer-ProfileSection-1vxwpb-en-sNG6mIy5.js").then((n) => n.t).then((m) => m.default),
...
function ProfileSection($$anchor, $$props) {
	...
	$.reset(section);
	$.template_effect(() => {
		$.set_text(text, $content().profile);
		$.set_text(text_1, $content().displayName);
		$.set_text(text_2, $content().email);
	});
