...
function V(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(s, "$content", a), [a, o] = e.setup_stores(), s = z(i, "profile-section");
	e.init();
	var c = B(), l = e.child(c), u = e.child(l, !0);
	e.reset(l);
	var d = e.sibling(l, 2), f = e.child(d), p = e.child(f), m = e.child(p, !0);
	e.reset(p), e.sibling(p, 2), e.reset(f);
	var h = e.sibling(f, 2), g = e.child(h), _ = e.child(g, !0);
	e.reset(g), e.sibling(g, 2), e.reset(h), e.reset(d), e.reset(c), e.template_effect(() => {
		e.set_text(u, r().profile), e.set_text(m, r().displayName), e.set_text(_, r().email);
