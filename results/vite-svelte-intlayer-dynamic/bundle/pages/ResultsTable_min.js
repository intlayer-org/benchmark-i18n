...
var h = {
	...
	en: () => import("./intlayer-ResultsTable-17lx2c-en-B_9-YjVF.js").then((e) => e.t).then((e) => e.default),
...
})(), te = Symbol("intlayer"), ne = () => t(te), E = /* @__PURE__ */ new Map(), D = (e, t) => Object.create(new Proxy(e, {
	get: (e, t, n) => {
...
function we(e, t, n) {
	let i = ne();
	ie(i?.variant, t);
	let a = n, o = r(ee, (e) => a ?? i?.locale ?? e.locale);
	return r(o, (t, n) => {
		let r = ae(e, t);
		if (r) {
			n($(X(r, t)));
...
function Oe(t, n) {
	...
	var c = De(), l = e.child(c), u = e.only_child(l, !0), d = e.sibling(l, 2), f = e.child(d), p = e.child(f), m = e.child(p), h = e.child(m), g = e.only_child(h, !0), _ = e.sibling(h), v = e.only_child(_, !0), y = e.sibling(_), b = e.only_child(y, !0), x = e.sibling(y), C = e.only_child(x, !0);
	e.reset(m), e.reset(p);
	var w = e.sibling(p);
	e.each(w, 21, () => e.get(s), e.index, (t, n) => {
		var r = Ee(), i = e.child(r), a = e.only_child(i, !0), o = e.sibling(i), s = e.only_child(o, !0), c = e.sibling(o), l = e.only_child(c, !0), u = e.sibling(c), d = e.only_child(u, !0);
	...
	}), e.reset(w), e.reset(f), e.reset(d), e.reset(c), e.template_effect(() => {
		e.set_text(u, r().title), e.set_text(g, r().columns.library), e.set_text(v, r().columns.bundleSize), e.set_text(b, r().columns.lookupTime), e.set_text(C, r().columns.lazyLoading);
