...
var content$1 = {
	...
	"en": () => import("./intlayer-SettingsHeader-om86ls-en-D0b3yHL2.js").then((n) => n.t).then((m) => m.default),
...
var content = {
	...
	"en": () => import("./intlayer-SettingsHeader-om86ls-en-D0b3yHL2.js").then((n) => n.n).then((m) => m.default),
...
function SettingsHeader($$anchor, $$props) {
	...
	$.template_effect(() => {
		$.set_text(text, $content().settings);
		$.set_text(text_1, $content().manageYourAccountPreferencesAnd);
	});
	$.append($$anchor, fragment);
	$.pop();
	$$cleanup();
