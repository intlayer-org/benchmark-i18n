...
var a = {
	de: () => import("./de-BeWs7qAK.js").then((e) => e.default),
	en: () => import("./en-Qc7NbCbB.js").then((e) => e.default),
	es: () => import("./es-BWKlkz3t.js").then((e) => e.default),
	fr: () => import("./fr-YZSTG2aw.js").then((e) => e.default),
	it: () => import("./it-CuqTgbx3.js").then((e) => e.default),
	ja: () => import("./ja-D0E8FjUz.js").then((e) => e.default),
	ko: () => import("./ko-mFZllVCF.js").then((e) => e.default),
	pt: () => import("./pt-Bt9UzkET.js").then((e) => e.default),
	ru: () => import("./ru-CDqxM2kf.js").then((e) => e.default),
	zh: () => import("./zh-DcYk9-_N.js").then((e) => e.default)
...
var V = e.from_html("<div class=\"rounded-lg border border-border bg-card p-6 text-center\"><div class=\"mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-accent text-lg font-bold text-accent-foreground\"> </div> <h3 class=\"text-base font-semibold text-foreground\"> </h3> <p class=\"mb-2 text-xs font-medium text-primary\"> </p> <p class=\"text-sm text-muted-foreground\"> </p></div>"), H = e.from_html("<div class=\"grid gap-6 md:grid-cols-2 lg:grid-cols-3\"></div>");
function U(t, n) {
	e.push(n, !1);
	let i = B(a, "team-grid"), o = [
		{
			name: r(i).sarahChen,
