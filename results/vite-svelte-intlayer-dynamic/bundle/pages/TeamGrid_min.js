...
var ee = {
	...
	en: () => import("./intlayer-TeamGrid-avnng9-en-aIfxpTu1.js").then((e) => e.t).then((e) => e.default),
...
var we = e.from_html("<div class=\"rounded-lg border border-border bg-card p-6 text-center\"><div class=\"mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-accent text-lg font-bold text-accent-foreground\"> </div> <h3 class=\"text-base font-semibold text-foreground\"> </h3> <p class=\"mb-2 text-xs font-medium text-primary\"> </p> <p class=\"text-sm text-muted-foreground\"> </p></div>"), Te = e.from_html("<div class=\"grid gap-6 md:grid-cols-2 lg:grid-cols-3\"></div>");
function Ee(t, n) {
	e.push(n, !0);
	let r = () => e.store_get(o, "$content", i), [i, a] = e.setup_stores(), o = $(_, "team-grid"), s = e.derived(() => [
		{
			name: r().sarahChen,
	...
	e.each(c, 21, () => e.get(s), e.index, (t, n) => {
		var r = we(), i = e.child(r), a = e.only_child(i, !0), o = e.sibling(i, 2), s = e.only_child(o, !0), c = e.sibling(o, 2), l = e.only_child(c, !0), u = e.sibling(c, 2), d = e.only_child(u, !0);
