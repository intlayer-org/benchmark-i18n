...
var ee = {
	...
	en: () => import("./intlayer-TeamHeader-2jfan0-en-x_tgfZDl.js").then((e) => e.t).then((e) => e.default),
...
var Z = {
	...
	en: () => import("./intlayer-TeamHeader-2jfan0-en-x_tgfZDl.js").then((e) => e.n).then((e) => e.default),
...
function Ae(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(o, "$content", i), [i, a] = e.setup_stores(), o = X(_, "team-header");
	e.init();
