...
}, z = e.from_html("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\"> </div>");
function B(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(s, "$banner", a), [a, o] = e.setup_stores(), s = R(i);
	e.init();
	var c = z(), l = e.child(c, !0);
