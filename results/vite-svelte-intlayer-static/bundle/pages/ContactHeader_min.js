...
var pe = e.from_html("<!> <h1 class=\"mb-2 text-3xl font-bold text-foreground\"> </h1> <p class=\"mb-8 text-muted-foreground\"> <a href=\"mailto:contact@intlayer.org\" class=\"text-primary hover:underline\">contact@intlayer.org</a> .</p>", 1);
function me(t, n) {
	e.push(n, !1);
	...
	fe(l, {});
	var u = e.sibling(l, 2), d = e.only_child(u, !0), f = e.sibling(u, 2), p = e.child(f, !0);
