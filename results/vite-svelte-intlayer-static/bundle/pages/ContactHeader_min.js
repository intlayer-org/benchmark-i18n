...
var ie = e.from_html("<!> <h1 class=\"mb-2 text-3xl font-bold text-foreground\"> </h1> <p class=\"mb-8 text-muted-foreground\"> <a href=\"mailto:contact@intlayer.org\" class=\"text-primary hover:underline\">contact@intlayer.org</a> .</p>", 1);
function ae(t, n) {
	e.push(n, !1);
