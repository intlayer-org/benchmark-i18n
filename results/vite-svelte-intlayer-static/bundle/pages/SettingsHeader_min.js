...
var U = e.from_html("<!> <h1 class=\"mb-2 text-3xl font-bold text-foreground\"> </h1> <p class=\"mb-8 text-muted-foreground\"> </p>", 1);
function W(t, n) {
	e.push(n, !1);
	...
	e.reset(f), e.template_effect(() => {
		e.set_text(d, r().settings), e.set_text(p, r().manageYourAccountPreferencesAnd);
