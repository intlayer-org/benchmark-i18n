...
var a = {
	...
	return n;
}, k = /* @__PURE__ */ new WeakMap(), A = 0, j = (e) => {
	if (!e) return "base";
	let t = k.get(e);
	if (t) return t;
	A += 1;
	let n = `p${A}`;
	return k.set(e, n), n;
}, ee = 256, M = /* @__PURE__ */ new WeakMap(), N = (e) => typeof e == "object" && !!e, te = (e, t, n) => `${e}_${t}_${j(n)}`, ne = (e, t) => {
	if (!N(e)) return { hit: !1 };
	let n = M.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	let { locale: r, selector: i } = C(t), a = te(r ?? o.defaultLocale, w(i), n), s = ne(e, a);
	if (s.hit) return s.content;
	let c = n ?? F(r), l = S(e, i), u = (e) => {
		let t = {
			dictionaryKey: e.key,
...
function pe(t, n) {
	...
	let s = ue(a);
	e.init();
	var c = fe(), l = e.child(c), u = e.only_child(l, !0), d = e.sibling(l, 2), f = e.child(d), p = e.child(f), m = e.only_child(p, !0), h = e.sibling(p, 2), g = e.only_child(h, !0);
	e.reset(f);
	var _ = e.sibling(f, 2), v = e.child(_), y = e.only_child(v, !0), b = e.sibling(v, 2), x = e.only_child(b, !0);
	e.reset(_);
	var S = e.sibling(_, 2), C = e.child(S), w = e.only_child(C, !0), T = e.sibling(C, 2), E = e.only_child(T, !0);
	e.reset(S), e.reset(d), e.reset(c), e.template_effect(() => {
