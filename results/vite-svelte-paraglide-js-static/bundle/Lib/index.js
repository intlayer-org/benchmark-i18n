...
function EmptyComponent($$anchor, $$props) {
	$.push($$props, false);
	const en_example = () => "Choosing an i18n library is an architectural decision with long-term consequences.";
	const example = (inputs = {}, options = {}) => {
		if ((options.locale ?? getLocale()) === "en") return en_example();
	};
	example();
	$.init();
	$.pop();
