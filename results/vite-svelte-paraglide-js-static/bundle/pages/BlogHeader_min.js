...
}), F = () => "Blog", I = () => "Blog", L = () => "Blog", R = () => "Blog", z = () => "Blog", ee = () => "Blog", B = () => "博客", V = () => "ブログ", H = () => "Blog", U = () => "Блог", W = ((e = {}, t = {}) => {
	let n = t.locale ?? h();
	return n === "en" ? F(e) : n === "fr" ? I(e) : n === "es" ? L(e) : n === "de" ? R(e) : n === "it" ? z(e) : n === "pt" ? ee(e) : n === "zh" ? B(e) : n === "ja" ? V(e) : n === "ko" ? H(e) : U(e);
}), G = () => "Insights, tutorials, and analysis from the i18n community.", K = () => "Articles, tutoriels et analyses de la communauté i18n.", q = () => "Información, tutoriales y análisis de la comunidad i18n.", J = () => "Einblicke, Tutorials und Analysen aus der i18n-Community.", Y = () => "Approfondimenti, tutorial e analisi dalla comunità i18n.", X = () => "Insights, tutoriais e análises da comunidade i18n.", Z = () => "来自 i18n 社区的见解、教程和分析。", Q = () => "i18nコミュニティからのインサイト、チュートリアル、分析。", $ = () => "Insights, tutorials, and analysis from the i18n community.", te = () => "Инсайты, туториалы и аналитика от сообщества i18n.", ne = ((e = {}, t = {}) => {
	let n = t.locale ?? h();
