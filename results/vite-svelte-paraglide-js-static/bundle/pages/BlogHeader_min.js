...
var N = () => "Insights, tutorials, and analysis from the i18n community.", P = () => "Articles, tutoriels et analyses de la communauté i18n.", F = () => "Información, tutoriales y análisis de la comunidad i18n.", I = () => "Einblicke, Tutorials und Analysen aus der i18n-Community.", L = () => "Approfondimenti, tutorial e analisi dalla comunità i18n.", R = () => "Insights, tutoriais e análises da comunidade i18n.", z = () => "来自 i18n 社区的见解、教程和分析。", B = () => "i18nコミュニティからのインサイト、チュートリアル、分析。", V = () => "Insights, tutorials, and analysis from the i18n community.", H = () => "Инсайты, туториалы и аналитика от сообщества i18n.", te = ((e = {}, t = {}) => {
	let n = t.locale ?? u();
	return n === "fr" ? P(e) : n === "es" ? F(e) : n === "de" ? I(e) : n === "it" ? L(e) : n === "pt" ? R(e) : n === "zh" ? z(e) : n === "ja" ? B(e) : n === "ko" ? V(e) : n === "ru" ? H(e) : N(e);
}), U = () => "Blog", W = () => "Blog", G = () => "Blog", K = () => "Blog", q = () => "Blog", J = () => "Blog", Y = () => "博客", X = () => "ブログ", Z = () => "Blog", Q = () => "Блог", ne = ((e = {}, t = {}) => {
	let n = t.locale ?? u();
