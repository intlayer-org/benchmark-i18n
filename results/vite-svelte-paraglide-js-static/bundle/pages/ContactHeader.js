...
var root = $.from_html(`<!> <h1 class="mb-2 text-3xl font-bold text-foreground"> </h1> <p class="mb-8 text-muted-foreground"> <a class="text-primary hover:underline"> </a> .</p>`, 1);
