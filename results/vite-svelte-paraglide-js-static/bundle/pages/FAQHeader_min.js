...
}), F = () => "Frequently Asked Questions", I = () => "Questions fréquentes", L = () => "Preguntas frecuentes", R = () => "Häufig gestellte Fragen", z = () => "Domande frequenti", ee = () => "Perguntas frequentes", B = () => "常见问题", V = () => "よくある質問", H = () => "Frequently Asked Questions", U = () => "Часто задаваемые вопросы", W = ((e = {}, t = {}) => {
	let n = t.locale ?? h();
	return n === "en" ? F(e) : n === "fr" ? I(e) : n === "es" ? L(e) : n === "de" ? R(e) : n === "it" ? z(e) : n === "pt" ? ee(e) : n === "zh" ? B(e) : n === "ja" ? V(e) : n === "ko" ? H(e) : U(e);
}), G = () => "Everything you need to know about i18n Benchmark.", K = () => "Tout savoir sur i18n Benchmark.", q = () => "Todo lo que necesitas saber sobre i18n Benchmark.", J = () => "Alles, was Sie über i18n Benchmark wissen müssen.", Y = () => "Tutto quello che c'è da sapere su i18n Benchmark.", X = () => "Tudo o que você precisa saber sobre o i18n Benchmark.", Z = () => "关于 i18n 基准测试您需要了解的一切。", Q = () => "i18n Benchmarkについて知っておくべきすべてのこと。", $ = () => "Everything you need to know about i18n Benchmark.", te = () => "Все, что вам нужно знать об i18n Benchmark.", ne = ((e = {}, t = {}) => {
	let n = t.locale ?? h();
