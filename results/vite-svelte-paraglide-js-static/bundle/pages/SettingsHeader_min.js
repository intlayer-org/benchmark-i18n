...
}), F = () => "Settings", I = () => "Paramètres", L = () => "Ajustes", R = () => "Einstellungen", z = () => "Impostazioni", ee = () => "Configurações", B = () => "设置", V = () => "設定", H = () => "Settings", U = () => "Настройки", W = ((e = {}, t = {}) => {
	let n = t.locale ?? h();
	return n === "en" ? F(e) : n === "fr" ? I(e) : n === "es" ? L(e) : n === "de" ? R(e) : n === "it" ? z(e) : n === "pt" ? ee(e) : n === "zh" ? B(e) : n === "ja" ? V(e) : n === "ko" ? H(e) : U(e);
}), G = () => "Manage your account preferences and configuration.", K = () => "Gérez les préférences et la configuration de votre compte.", q = () => "Gestiona las preferencias y la configuración de tu cuenta.", J = () => "Verwalten Sie Ihre Kontoeinstellungen und Konfiguration.", Y = () => "Gestisci le preferenze del tuo account e la configurazione.", X = () => "Gerencie suas preferências de conta e configuração.", Z = () => "管理您的账户偏好和配置。", Q = () => "アカウント設定と構成を管理します。", $ = () => "Manage your account preferences and configuration.", te = () => "Управляйте предпочтениями и конфигурацией вашей учетной записи.", ne = ((e = {}, t = {}) => {
	let n = t.locale ?? h();
...
var ae = e.from_html("<!> <h1 class=\"mb-2 text-3xl font-bold text-foreground\"> </h1> <p class=\"mb-8 text-muted-foreground\"> </p>", 1);
function oe(t, n) {
	e.push(n, !1), e.init();
