...
}), U = () => "Manage your account preferences and configuration.", W = () => "Gérez les préférences et la configuration de votre compte.", G = () => "Gestiona las preferencias y la configuración de tu cuenta.", K = () => "Verwalten Sie Ihre Kontoeinstellungen und Konfiguration.", q = () => "Gestisci le preferenze del tuo account e la configurazione.", J = () => "Gerencie suas preferências de conta e configuração.", Y = () => "管理您的账户偏好和配置。", X = () => "アカウント設定と構成を管理します。", Z = () => "Manage your account preferences and configuration.", Q = () => "Управляйте предпочтениями и конфигурацией вашей учетной записи.", ne = ((e = {}, t = {}) => {
	let n = t.locale ?? u();
	return n === "fr" ? W(e) : n === "es" ? G(e) : n === "de" ? K(e) : n === "it" ? q(e) : n === "pt" ? J(e) : n === "zh" ? Y(e) : n === "ja" ? X(e) : n === "ko" ? Z(e) : n === "ru" ? Q(e) : U(e);
}), re = () => "Settings", ie = () => "Paramètres", ae = () => "Ajustes", oe = () => "Einstellungen", $ = () => "Impostazioni", se = () => "Configurações", ce = () => "设置", le = () => "設定", ue = () => "Settings", de = () => "Настройки", fe = ((e = {}, t = {}) => {
	let n = t.locale ?? u();
...
var he = e.from_html("<!> <h1 class=\"mb-2 text-3xl font-bold text-foreground\"> </h1> <p class=\"mb-8 text-muted-foreground\"> </p>", 1);
function ge(t, n) {
	e.push(n, !1), e.init();
