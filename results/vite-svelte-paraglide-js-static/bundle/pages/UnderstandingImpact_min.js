...
var T = () => "Understanding the Impact", E = () => "Comprendre l'impact", D = () => "Entendiendo el impacto", O = () => "Die Auswirkungen verstehen", k = () => "Capire l'impatto", A = () => "Entendendo o impacto", j = () => "理解影响", M = () => "影響を理解する", N = () => "Understanding the Impact", P = () => "Понимание влияния", ee = ((e = {}, t = {}) => {
	let n = t.locale ?? g();
	return n === "en" ? T(e) : n === "fr" ? E(e) : n === "es" ? D(e) : n === "de" ? O(e) : n === "it" ? k(e) : n === "pt" ? A(e) : n === "zh" ? j(e) : n === "ja" ? M(e) : n === "ko" ? N(e) : P(e);
}), F = () => "Why a single large JSON can hurt performance", I = () => "Pourquoi un unique gros JSON peut nuire aux performances", L = () => "Por qué un solo JSON grande puede perjudicar el rendimiento", R = () => "Warum ein einzelnes großes JSON die Leistung beeinträchtigen kann", z = () => "Perché un singolo JSON di grandi dimensioni può danneggiare le prestazioni", B = () => "Por que um único JSON grande pode prejudicar o desempenho", te = () => "为什么单个大型 JSON 会损害性能", V = () => "なぜ1つの大きなJSONがパフォーマンスを低下させるのか", H = () => "Why a single large JSON can hurt performance", U = () => "Почему один большой JSON может снизить производительность", W = ((e = {}, t = {}) => {
	let n = t.locale ?? g();
	return n === "en" ? F(e) : n === "fr" ? I(e) : n === "es" ? L(e) : n === "de" ? R(e) : n === "it" ? z(e) : n === "pt" ? B(e) : n === "zh" ? te(e) : n === "ja" ? V(e) : n === "ko" ? H(e) : U(e);
...
function Hn(t, n) {
	...
	e.reset(g), e.reset(d), e.reset(o);
	var v = e.sibling(o, 2), y = e.child(v), b = e.child(y, !0);
	e.reset(y);
	var x = e.sibling(y, 2), S = e.child(x, !0);
	e.reset(x);
	var C = e.sibling(x, 2), w = e.child(C), T = e.child(w), E = e.child(T, !0);
	e.reset(T);
	var D = e.sibling(T);
	e.reset(w);
	var O = e.sibling(w, 2), k = e.child(O), A = e.child(k, !0);
	e.reset(k);
	var j = e.sibling(k);
	e.reset(O);
	var M = e.sibling(O, 2), N = e.child(M), P = e.child(N, !0);
	e.reset(N);
	var F = e.sibling(N);
	e.reset(M), e.reset(C), e.reset(v);
	var I = e.sibling(v, 2), L = e.child(I), R = e.child(L, !0);
	e.reset(L);
	var z = e.sibling(L, 2), B = e.child(z, !0);
	e.reset(z), e.reset(I), e.reset(r), e.template_effect((t, n, r, i, o, s, l, d, f, m, g, v, y, x, C, w) => {
