...
import n from "../locales/de.json";
import r from "../locales/en.json";
import i from "../locales/es.json";
import a from "../locales/fr.json";
import o from "../locales/it.json";
import s from "../locales/ja.json";
import c from "../locales/ko.json";
import l from "../locales/pt.json";
import u from "../locales/ru.json";
...
}, j = (e) => Object.fromEntries(se(e).entries()), M = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function _e(e, t) {
	...
	return n.apiUrl = A(n.apiUrl), e?.fetch && (n.fetch = oe(e.fetch)), {
		initialOptions: n,
...
var W = () => (e, t) => (t.setFinalFormatter(Fe()), e);
function Ie() {
...
var Ut = () => (e) => e, Z = Ht().use(W()).use(Ut()).init({
	language: "en",
	staticData: {
		en: r,
		fr: a,
...
function Gt(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(Wt, "$_", i), [i, a] = e.setup_stores();
	r()("header.home"), e.init(), e.pop(), a();
}
function Kt(t, n) {
	e.push(n, !1), Ht().use(W()).use(Ut()).init({
		language: "en",
		staticData: { en: { header: { home: "Home" } } }
	}).run(), e.init();
	var r = e.comment(), i = e.first_child(r);
	e.slot(i, n, "default", {}, null), e.append(t, r), e.pop();
}
function qt(e) {
	Kt(e, {
		children: (e, t) => {
