...
var D = () => ({
	...
	let r = E(n?.headers);
	return r["x-api-key"] && (r = Object.assign(Object.assign({}, D()), r)), e(t, Object.assign(Object.assign({}, n), { headers: r }));
}, k = (e) => {
...
}, A = (e) => Object.fromEntries(k(e).entries()), j = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function ae(e, t, n, r, i, a, o) {
	...
	let h = Object.freeze({
		...
		getAllRecords() {
			return Array.from(c.entries()).map(([e]) => h.getRecord(j(e)));
		},
		getTranslation(e, t) {
...
function le(e, t) {
	let n = F(ce, t?.initialOptions, e);
	return n.apiUrl = C(n.apiUrl), e?.fetch && (n.fetch = O(e.fetch)), {
		initialOptions: n,
...
function ue(e, t, n, r, i, a, o, s) {
	...
	function T() {
		return g(s.onError, (e) => new ie("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function E() {
		if (!l.languageDetector) return;
		let e = n();
		return g(s.onError, (e) => new re("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function D(e) {
		e && l.backends.push(e);
	}
	...
	let A = Object.freeze({
		...
		getInitialLanguage() {
			let e = n();
			return h(T(), (t) => (!e || e.includes(t)) && t ? t : E());
		},
		setStoredLanguage(e) {
			return g(s.onError, (e) => new ie("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = w(e) || P, r = t().onFormatError, a = typeof r;
...
function me({ options: e }) {
	let t = te(), n = I(!1, () => o.isFetching(), t.onFetchingChange.emit), r = I(!1, () => D.isLoading(), t.onLoadingChange.emit), i = de(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = ue(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, x, C, f, t), o = ae(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var ge = () => {
	let e = {
		...
		init(t) {
			let n = he(F(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, L = 0, R = 1, _e = 2, ve = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var z = 0, B = 1, V = 2, H = 3, U = 4, be = /* @__PURE__ */ new Set([
	V,
	B,
	z
]), W = "'", xe = /* @__PURE__ */ new Set([
	"{",
	"}",
	W
...
function Ce(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case z:
			...
			break;
		case B:
			xe.has(i) ? (n = n.slice(0, -1) + i, t = V) : (n += i, t = z);
			break;
		case V:
			i === W ? t = z : (n += i, t = V);
			break;
		case H:
			i === "}" ? (d(), t = z) : ye(i) ? r !== "" && (d(), t = U) : (u(), t = H);
			break;
		case U: i == "}" ? t = z : ye(i) ? t = U : c(R);
	}
	return be.has(t) || c(_e), l(), [a, o];
}
function we(e, t) {
	let [n, r] = Ce(e), i = [n[0]];
...
var Ee = () => (e, t) => (t.setFinalFormatter(Te()), e);
function De() {
	return globalThis.window?.document?.createElement === void 0;
}
var Oe = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, ke = {};
(function(e) {
	function t(e, t) {
...
(f = console.assert) == null || f.call(console, Ae), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function je(e, t) {
	return t ? `${t}: ${e}` : e;
}
var G = class e extends Error {
	constructor(t, n, r) {
		super(je(t, n)), this.code = t, this.status = n, this.params = r, Object.setPrototypeOf(this, e.prototype);
	}
};
function Me(e) {
	return e instanceof Error && typeof e.code == "string";
}
var Ne = 2, Pe = 35e3, Fe = "TOLGEE_API_REQUEST", Ie = "TOLGEE_API_RESPONSE", Le = "TOLGEE_PROXY_PING", Re = "TOLGEE_PROXY_PONG";
function ze(e) {
...
}, Be = 3e3, Ve = 200, He = 0, q = /* @__PURE__ */ new Map(), Ue = !1, J, Y;
async function We({ type: e, replyType: t, payload: n, timeoutMs: r = Pe, progressType: i, onProgress: a }) {
	qe();
	let o = Date.now() + r;
	await Je(Math.min(o, Date.now() + Be));
	let s = o - Date.now();
	if (s <= 0) throw Ge(e);
	let c = Ke();
	return new Promise((r, o) => {
		let l = setTimeout(() => {
			q.delete(c), Ye(), o(Ge(e));
		}, s);
		q.set(c, {
			replyType: t,
			progressType: i,
...
var Ge = (e) => new K("unavailable", `the Tolgee browser extension did not answer ${e} in time`), Ke = () => `${Date.now()}-${He++}-${Math.random()}`;
function qe() {
	Ue || (Ue = !0, window.addEventListener("message", (e) => {
		var t;
...
function Je(e) {
	return J ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Le }, window.origin), i = () => {
			clearInterval(a), Ye(), Y = void 0, n(new K("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var tt = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
function nt(e) {
	let t = tt.indexOf(e);
...
function it(e) {
	...
	for (let o = 0; o < t; o++) r = r << 5 | nt(e[o]), n += 5, n >= 8 && (a[i++] = r >>> n - 8 & 255, n -= 8);
	return rt(a.buffer);
}
function at(e) {
	if (e) try {
...
function ut({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var X = "__tolgee_", ft = `${X}apiKey`, pt = `${X}apiUrl`, mt = `${X}branch`, ht = `${X}projectId`, gt = `${X}session`, _t = "tolgee-in-context-tools.umd.min.js", vt = "@tolgee/in-context-tools", yt = "InContextTools", bt = "https://cdn.jsdelivr.net/npm", xt = null;
function St(e) {
	return xt ||= Dt(Ct(e)).then(() => window[vt][yt]), xt;
}
function Ct(e) {
	return wt() || `${bt}/@tolgee/web@${e}/dist/${_t}`;
}
function wt() {
	if (De()) return;
	let e = window.__TOLGEE_IN_CONTEXT_URL__;
	return Et(e, window.location) ? e : void 0;
}
var Tt = (e) => e === "localhost" || e === "127.0.0.1" || e === "::1" || e === "[::1]";
function Et(e, t) {
	if (!e || !Tt(t.hostname)) return !1;
	try {
		let n = new URL(e, t.href);
		return n.origin === t.origin || Tt(n.hostname);
	} catch {
		return !1;
	}
}
...
function Ot() {
	let e = sessionStorage.getItem(ft) || void 0, t = sessionStorage.getItem(pt) || void 0, n = sessionStorage.getItem(mt) || void 0, r = sessionStorage.getItem(ht) || void 0, i = ze(sessionStorage.getItem(gt));
	if (!t) return;
	let a = u(u({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return d(u({}, a), { apiKey: e });
	if (i && r) return d(u({}, a), { transport: Xe() });
}
function kt() {
	let e = [];
...
(() => {
	...
	return At(e), e.on("running", ({ value: e }) => {
		e && jt(() => {
			t.update(n()).catch(kt);
		});
	}), Ot() && (async () => {
		let e = await St("7.2.1");
		return (t) => {
			let n = Ot();
...
function Yt(e) {
	...
	let [n, ...r] = t;
	if (!Kt(n)) return { kind: "notfound" };
	let i = r[0] ?? "";
	return r.length > 1 || !Jt.has(i) ? { kind: "notfound" } : {
		kind: "ok",
		locale: n,
		page: i
	};
}
var Xt = n(typeof window < "u" ? window.location.pathname : "/en"), Zt = t(Xt, (e) => Yt(e)), Qt = e.from_html("<a class=\"text-sm text-muted-foreground transition-colors hover:text-foreground\"> </a>"), $t = e.from_html("<a target=\"_blank\" rel=\"noreferrer\" class=\"text-sm text-muted-foreground transition-colors hover:text-foreground\"> </a>"), en = e.from_html("<li><!></li>"), tn = e.from_html("<footer class=\"mt-20 border-t border-border bg-card\"><div class=\"container py-8\"><div class=\"grid gap-8 md:grid-cols-3\"><div><h3 class=\"mb-2 text-sm font-semibold text-foreground\"> </h3> <p class=\"text-sm text-muted-foreground\"> </p></div> <div><h3 class=\"mb-2 text-sm font-semibold text-foreground\"> </h3> <ul class=\"space-y-1\"></ul></div> <div><h3 class=\"mb-2 text-sm font-semibold text-foreground\"> </h3> <p class=\"text-sm text-muted-foreground\"> </p></div></div> <div class=\"mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground\"> </div></div></footer>");
function nn(t, n) {
	e.push(n, !0);
	let r = () => e.store_get(Zt, "$route", a), i = () => e.store_get(qt, "$_", a), [a, o] = e.setup_stores(), s = e.derived(() => r().kind === "ok" ? r().locale : "en"), c = e.derived(() => [
		{
			msg: "footer.github",
	...
	var l = tn(), u = e.child(l), d = e.child(u), f = e.child(d), p = e.child(f), m = e.only_child(p, !0), h = e.sibling(p, 2), g = e.only_child(h, !0);
	e.reset(f);
	var _ = e.sibling(f, 2), v = e.child(_), y = e.only_child(v, !0), b = e.sibling(v, 2);
	e.each(b, 21, () => e.get(c), (e) => e.msg, (t, n) => {
		var r = en(), a = e.child(r), o = (t) => {
			var r = Qt(), a = e.only_child(r, !0);
			e.template_effect((t) => {
				e.set_attribute(r, "href", e.get(n).to), e.set_text(a, t);
			}, [() => i()(e.get(n).msg)]), e.append(t, r);
		}, s = (t) => {
			var r = $t(), a = e.only_child(r, !0);
			e.template_effect((t) => {
