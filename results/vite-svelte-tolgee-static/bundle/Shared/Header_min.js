...
import a from "lucide-svelte/icons/chevron-down";
var o = Object.defineProperty, s = Object.defineProperties, c = Object.getOwnPropertyDescriptors, l = Object.getOwnPropertySymbols, u = Object.prototype.hasOwnProperty, d = Object.prototype.propertyIsEnumerable, f = (e, t, n) => t in e ? o(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
var A = () => ({
	...
	let r = k(n?.headers);
	return r["x-api-key"] && (r = Object.assign(Object.assign({}, A()), r)), e(t, Object.assign(Object.assign({}, n), { headers: r }));
}, M = (e) => {
...
}, N = (e) => Object.fromEntries(M(e).entries()), P = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function ue(e, t) {
	let n = le(ce, t?.initialOptions, e);
	return n.apiUrl = E(n.apiUrl), e?.fetch && (n.fetch = j(e.fetch)), {
		initialOptions: n,
...
function de(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return y(s.onError, (e) => new ie("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return y(s.onError, (e) => new re("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function E(e) {
		e && l.backends.push(e);
	}
	...
	let A = Object.freeze({
		...
		setStoredLanguage(e) {
			return y(s.onError, (e) => new ie("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = oe(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = D(e) || L, r = t().onFormatError, a = typeof r;
...
function me(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = oe(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
function ge({ options: e }) {
	let t = te(), n = fe(!1, () => o.isFetching(), t.onFetchingChange.emit), r = fe(!1, () => D.isLoading(), t.onLoadingChange.emit), i = pe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = de(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, y, x, f, t), o = ae(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var ve = () => {
	let e = {
		...
		updateDefaults(n) {
			return e.options = le(e.options, n), t;
		},
		init(t) {
			let n = _e(le(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, ye = 0, R = 1, be = 2, xe = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === ye ? r = "Empty parameter" : e === R ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Se(e) {
	return /\s/.test(e);
}
var z = 0, B = 1, V = 2, H = 3, U = 4, Ce = /* @__PURE__ */ new Set([
	V,
	B,
	z
]), W = "'", we = /* @__PURE__ */ new Set([
	"{",
	"}",
	W
]), Te = (e) => /[0-9a-zA-Z_]/.test(e);
function Ee(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case z:
			...
			break;
		case B:
			we.has(i) ? (n = n.slice(0, -1) + i, t = V) : (n += i, t = z);
			break;
		case V:
			i === W ? t = z : (n += i, t = V);
			break;
		case H:
			i === "}" ? (d(), t = z) : Se(i) ? r !== "" && (d(), t = U) : (u(), t = H);
			break;
		case U: i == "}" ? t = z : Se(i) ? t = U : c(R);
	}
	return Ce.has(t) || c(be), l(), [a, o];
}
function De(e, t) {
	let [n, r] = Ee(e), i = [n[0]];
...
function Oe() {
	return { format: ({ translation: e, params: t }) => De(e, t) };
}
var ke = () => (e, t) => (t.setFinalFormatter(Oe()), e);
function Ae() {
	return globalThis.window?.document?.createElement === void 0;
}
var je = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Me = {};
(function(e) {
	function t(e, t) {
...
(h = console.assert) == null || h.call(console, Ne), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Pe(e, t) {
	return t ? `${t}: ${e}` : e;
}
var G = class e extends Error {
	constructor(t, n, r) {
		super(Pe(t, n)), this.code = t, this.status = n, this.params = r, Object.setPrototypeOf(this, e.prototype);
	}
};
function Fe(e) {
	return e instanceof Error && typeof e.code == "string";
}
var Ie = 2, Le = 35e3, Re = "TOLGEE_API_REQUEST", ze = "TOLGEE_API_RESPONSE", Be = "TOLGEE_PROXY_PING", Ve = "TOLGEE_PROXY_PONG";
function He(e) {
...
}, Ue = 3e3, We = 200, Ge = 0, q = /* @__PURE__ */ new Map(), Ke = !1, J, Y;
async function qe({ type: e, replyType: t, payload: n, timeoutMs: r = Le, progressType: i, onProgress: a }) {
	Xe();
	let o = Date.now() + r;
	await Ze(Math.min(o, Date.now() + Ue));
	let s = o - Date.now();
	if (s <= 0) throw Je(e);
	let c = Ye();
	return new Promise((r, o) => {
		let l = setTimeout(() => {
			q.delete(c), Qe(), o(Je(e));
		}, s);
		q.set(c, {
			replyType: t,
			progressType: i,
...
var Je = (e) => new K("unavailable", `the Tolgee browser extension did not answer ${e} in time`), Ye = () => `${Date.now()}-${Ge++}-${Math.random()}`;
function Xe() {
	Ke || (Ke = !0, window.addEventListener("message", (e) => {
		var t;
...
function Ze(e) {
	return J ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Be }, window.origin), i = () => {
			clearInterval(a), Qe(), Y = void 0, n(new K("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var it = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
function at(e) {
	let t = it.indexOf(e);
...
function st(e) {
	...
	for (let o = 0; o < t; o++) r = r << 5 | at(e[o]), n += 5, n >= 8 && (a[i++] = r >>> n - 8 & 255, n -= 8);
	return ot(a.buffer);
}
function ct(e) {
	if (e) try {
...
function ut(e) {
	...
	return r ? {
		...
		hasCredential: !!t,
		projectId: ct(t) ?? n,
		requiresExplicitProject: lt(t) === "tgpat"
	};
}
function dt(e) {
...
function pt({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var X = "__tolgee_", ht = `${X}apiKey`, gt = `${X}apiUrl`, _t = `${X}branch`, vt = `${X}projectId`, yt = `${X}session`, bt = "tolgee-in-context-tools.umd.min.js", xt = "@tolgee/in-context-tools", St = "InContextTools", Ct = "https://cdn.jsdelivr.net/npm", wt = null;
function Tt(e) {
	return wt ||= At(Et(e)).then(() => window[xt][St]), wt;
}
function Et(e) {
	return Dt() || `${Ct}/@tolgee/web@${e}/dist/${bt}`;
}
function Dt() {
	if (Ae()) return;
	let e = window.__TOLGEE_IN_CONTEXT_URL__;
	return kt(e, window.location) ? e : void 0;
}
var Ot = (e) => e === "localhost" || e === "127.0.0.1" || e === "::1" || e === "[::1]";
function kt(e, t) {
	if (!e || !Ot(t.hostname)) return !1;
	try {
		let n = new URL(e, t.href);
		return n.origin === t.origin || Ot(n.hostname);
	} catch {
		return !1;
	}
}
...
function jt() {
	let e = sessionStorage.getItem(ht) || void 0, t = sessionStorage.getItem(gt) || void 0, n = sessionStorage.getItem(_t) || void 0, r = sessionStorage.getItem(vt) || void 0, i = He(sessionStorage.getItem(yt));
	if (!t) return;
	let a = p(p({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return m(p({}, a), { apiKey: e });
	if (i && r) return m(p({}, a), { transport: $e() });
}
function Mt() {
	let e = [];
...
function Nt(e) {
	if (!e.isDev()) return;
	let { requiresExplicitProject: t, projectId: n } = ut(e.getInitialOptions());
...
(() => {
	...
	return Nt(e), e.on("running", ({ value: e }) => {
		e && Pt(() => {
			t.update(n()).catch(Mt);
		});
	}), jt() && (async () => {
		let e = await Tt("7.2.1");
		return (t) => {
			let n = jt();
...
Z.on("update", () => {
	...
	typeof document < "u" && e?.value && (document.documentElement.lang = e.value), Q.set(Zt());
});
var Qt = Q;
function $t(e) {
...
function tn(e) {
	...
	let i = r[0] ?? "";
	return r.length > 1 || !en.has(i) ? { kind: "notfound" } : {
		kind: "ok",
		locale: n,
		page: i
	};
}
var $ = r(typeof window < "u" ? window.location.pathname : "/en"), nn = t($, (e) => tn(e));
function rn(e, t = !1) {
	typeof window > "u" || (t ? history.replaceState(null, "", e) : history.pushState(null, "", e), $.set(window.location.pathname));
}
var an = e.from_html("<option> </option>"), on = e.from_html("<div class=\"flex items-center gap-2\"><select class=\"h-8 rounded-md border border-border bg-card px-2 text-xs font-medium transition-colors focus:ring-1 focus:ring-primary focus:outline-none\"></select></div>");
function sn(t, r) {
	e.push(r, !1);
	let i = () => e.store_get($, "$pathname", a), [a, o] = e.setup_stores();
	function s(e) {
		let t = e.target.value;
		rn(n($).replace(/^\/[^/]+/, `/${t}`) + window.location.search + window.location.hash, !1);
	}
	e.init();
	var c = on(), l = e.child(c);
	e.each(l, 5, () => Jt, (e) => e, (t, n) => {
		var r = an(), i = e.only_child(r, !0), a = {};
		e.template_effect((t) => {
			e.set_text(i, t), a !== (a = e.get(n)) && (r.value = (r.__value = a) ?? "");
		}, [() => Yt(e.get(n))]), e.append(t, r);
	}), e.reset(l);
	var u;
...
e.delegate(["change"]);
var cn = e.from_html("<button type=\"button\" class=\"rounded-md border border-border bg-accent px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-accent/80\"> </button>");
function ln(t, n) {
	e.push(n, !0);
	let r = () => e.store_get(Qt, "$_", a), [a, o] = e.setup_stores();
	function s() {
...
function pn(t, n) {
	...
	var p = fn(), m = e.child(p), h = e.child(m), g = e.child(h), _ = e.only_child(g, !0), v = e.sibling(g, 2), y = e.child(v);
	let b;
	...
	e.reset(E);
	var k = e.sibling(E, 2), A = (t) => {
		var n = dn(), r = e.child(n);
	...
	var j = e.sibling(h, 2), M = e.child(j), N = e.child(M), P = e.only_child(N, !0);
	e.next(2), e.reset(M);
	var F = e.sibling(M, 2);
	sn(F, {}), ln(e.sibling(F, 2), {}), e.reset(j), e.reset(m), e.reset(p), e.template_effect((t, n, r, i, a) => {
		e.set_attribute(g, "href", `/${e.get(l)}`), e.set_text(_, t), e.set_attribute(y, "href", `/${e.get(l)}`), b = e.set_class(y, 1, "nav-link", null, b, { "is-active": e.get(d) }), e.set_text(x, n), e.set_attribute(S, "href", `/${e.get(l)}/about`), C = e.set_class(S, 1, "nav-link", null, C, { "is-active": e.get(f) }), e.set_text(w, r), e.set_text(D, `${i ?? ""} `), e.set_text(P, a);
	}, [
		() => i()("shared.appName"),
		() => i()("header.home"),
		...
		() => i()("header.mockPages"),
		() => i()("shared.goToGithub")
	]), e.event("mouseenter", E, () => e.set(c, !0)), e.event("mouseleave", E, () => e.set(c, !1)), e.delegated("click", E, () => e.set(c, !e.get(c))), e.append(t, p), e.pop(), s();
}
e.delegate(["click"]);
