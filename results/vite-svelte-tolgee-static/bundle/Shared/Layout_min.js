...
var c = Object.defineProperty, l = Object.defineProperties, u = Object.getOwnPropertyDescriptors, d = Object.getOwnPropertySymbols, f = Object.prototype.hasOwnProperty, p = Object.prototype.propertyIsEnumerable, m = (e, t, n) => t in e ? c(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, h = (e, t) => {
	for (var n in t ||= {}) f.call(t, n) && m(e, n, t[n]);
	if (d) for (var n of d(t)) p.call(t, n) && m(e, n, t[n]);
	return e;
}, g = (e, t) => l(e, u(t)), _;
function v(e, t) {
...
var j = () => ({
	...
	let r = A(n?.headers);
	return r["x-api-key"] && (r = Object.assign(Object.assign({}, j()), r)), e(t, Object.assign(Object.assign({}, n), { headers: r }));
}, N = (e) => {
...
function fe(e, t) {
	let n = de(ue, t?.initialOptions, e);
	return n.apiUrl = O(n.apiUrl), e?.fetch && (n.fetch = M(e.fetch)), {
		initialOptions: n,
...
function pe(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return x(s.onError, (e) => new ae("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return x(s.onError, (e) => new ie("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function E(e) {
		e && l.backends.push(e);
	}
	...
	let k = Object.freeze({
		...
		setStoredLanguage(e) {
			return x(s.onError, (e) => new ae("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = se(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = ee(e) || le, r = t().onFormatError, a = typeof r;
				h = a === "string" ? r : a === "function" ? r(n, i) : le, h = v(h);
			}
			return h;
		}
	});
...
function ge(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = se(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
var _e = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, ge(r)), n)), n;
};
function ve({ options: e }) {
	let t = ne(), n = me(!1, () => o.isFetching(), t.onFetchingChange.emit), r = me(!1, () => E.isLoading(), t.onLoadingChange.emit), i = he(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = pe(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = oe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var be = () => {
	let e = {
		...
		updateDefaults(n) {
			return e.options = de(e.options, n), t;
		},
		init(t) {
			let n = ye(de(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, xe = 0, R = 1, Se = 2, Ce = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === xe ? r = "Empty parameter" : e === R ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function we(e) {
	return /\s/.test(e);
}
var z = 0, B = 1, V = 2, H = 3, U = 4, Te = /* @__PURE__ */ new Set([
	V,
	B,
	z
]), W = "'", Ee = /* @__PURE__ */ new Set([
	"{",
	"}",
	W
...
function Oe(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case z:
			...
			break;
		case B:
			Ee.has(i) ? (n = n.slice(0, -1) + i, t = V) : (n += i, t = z);
			break;
		case V:
			i === W ? t = z : (n += i, t = V);
			break;
		case H:
			i === "}" ? (d(), t = z) : we(i) ? r !== "" && (d(), t = U) : (u(), t = H);
			break;
		case U: i == "}" ? t = z : we(i) ? t = U : c(R);
	}
...
(_ = console.assert) == null || _.call(console, Fe), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ie(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, Ge = 3e3, Ke = 200, qe = 0, q = /* @__PURE__ */ new Map(), Je = !1, J, Y;
...
var Xe = (e) => new K("unavailable", `the Tolgee browser extension did not answer ${e} in time`), Ze = () => `${Date.now()}-${qe++}-${Math.random()}`;
function Qe() {
...
function $e(e) {
	return J ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: He }, window.origin), i = () => {
			clearInterval(a), et(), Y = void 0, n(new K("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var X = "__tolgee_", _t = `${X}apiKey`, vt = `${X}apiUrl`, yt = `${X}branch`, bt = `${X}projectId`, xt = `${X}session`, St = "tolgee-in-context-tools.umd.min.js", Ct = "@tolgee/in-context-tools", wt = "InContextTools", Tt = "https://cdn.jsdelivr.net/npm", Et = null;
function Dt(e) {
...
function Nt() {
	...
	if (!t) return;
	let a = h(h({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return g(h({}, a), { apiKey: e });
	if (i && r) return g(h({}, a), { transport: tt() });
}
function Pt() {
	let e = [];
...
Z.run();
function Q() {
	return (e, t) => t?.values ? Z.t(e, t.values) : Z.t(e, t);
}
var $t = o(Q());
Z.on("update", () => {
	$t.set(Q());
}), Z.on("language", (e) => {
	typeof document < "u" && e?.value && (document.documentElement.lang = e.value), $t.set(Q());
});
var en = $t, tn = /* @__PURE__ */ new Set([
	"",
	"about",
	"blog",
	"careers",
...
function nn(e) {
	...
	let [n, ...r] = t;
	if (!Qt(n)) return { kind: "notfound" };
	let i = r[0] ?? "";
	return r.length > 1 || !tn.has(i) ? { kind: "notfound" } : {
		kind: "ok",
		locale: n,
		page: i
	};
}
var $ = o(typeof window < "u" ? window.location.pathname : "/en"), rn = i($, (e) => nn(e));
function an(e, t = !1) {
	typeof window > "u" || (t ? history.replaceState(null, "", e) : history.pushState(null, "", e), $.set(window.location.pathname));
}
var on = e.from_html("<a class=\"text-sm text-muted-foreground transition-colors hover:text-foreground\"> </a>"), sn = e.from_html("<a target=\"_blank\" rel=\"noreferrer\" class=\"text-sm text-muted-foreground transition-colors hover:text-foreground\"> </a>"), cn = e.from_html("<li><!></li>"), ln = e.from_html("<footer class=\"mt-20 border-t border-border bg-card\"><div class=\"container py-8\"><div class=\"grid gap-8 md:grid-cols-3\"><div><h3 class=\"mb-2 text-sm font-semibold text-foreground\"> </h3> <p class=\"text-sm text-muted-foreground\"> </p></div> <div><h3 class=\"mb-2 text-sm font-semibold text-foreground\"> </h3> <ul class=\"space-y-1\"></ul></div> <div><h3 class=\"mb-2 text-sm font-semibold text-foreground\"> </h3> <p class=\"text-sm text-muted-foreground\"> </p></div></div> <div class=\"mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground\"> </div></div></footer>");
function un(t, n) {
	e.push(n, !0);
	let r = () => e.store_get(rn, "$route", a), i = () => e.store_get(en, "$_", a), [a, o] = e.setup_stores(), s = e.derived(() => r().kind === "ok" ? r().locale : "en"), c = e.derived(() => [
		{
			msg: "footer.github",
	...
	var l = ln(), u = e.child(l), d = e.child(u), f = e.child(d), p = e.child(f), m = e.only_child(p, !0), h = e.sibling(p, 2), g = e.only_child(h, !0);
	e.reset(f);
	var _ = e.sibling(f, 2), v = e.child(_), y = e.only_child(v, !0), b = e.sibling(v, 2);
	e.each(b, 21, () => e.get(c), (e) => e.msg, (t, n) => {
		var r = cn(), a = e.child(r), o = (t) => {
			var r = on(), a = e.only_child(r, !0);
			e.template_effect((t) => {
				e.set_attribute(r, "href", e.get(n).to), e.set_text(a, t);
			}, [() => i()(e.get(n).msg)]), e.append(t, r);
		}, s = (t) => {
			var r = sn(), a = e.only_child(r, !0);
			e.template_effect((t) => {
...
var fn = e.from_html("<option> </option>"), pn = e.from_html("<div class=\"flex items-center gap-2\"><select class=\"h-8 rounded-md border border-border bg-card px-2 text-xs font-medium transition-colors focus:ring-1 focus:ring-primary focus:outline-none\"></select></div>");
function mn(t, n) {
	e.push(n, !1);
	let r = () => e.store_get($, "$pathname", i), [i, o] = e.setup_stores();
	function s(e) {
		let t = e.target.value;
		an(a($).replace(/^\/[^/]+/, `/${t}`) + window.location.search + window.location.hash, !1);
	}
	e.init();
	var c = pn(), l = e.child(c);
	e.each(l, 5, () => Xt, (e) => e, (t, n) => {
		var r = fn(), i = e.only_child(r, !0), a = {};
		e.template_effect((t) => {
			e.set_text(i, t), a !== (a = e.get(n)) && (r.value = (r.__value = a) ?? "");
		}, [() => Zt(e.get(n))]), e.append(t, r);
	}), e.reset(l);
	var u;
...
e.delegate(["change"]);
var hn = e.from_html("<button type=\"button\" class=\"rounded-md border border-border bg-accent px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-accent/80\"> </button>");
function gn(n, r) {
	e.push(r, !0);
	let i = () => e.store_get(en, "$_", a), [a, o] = e.setup_stores();
	function s() {
...
function bn(t, n) {
	...
	var p = yn(), m = e.child(p), h = e.child(m), g = e.child(h), _ = e.only_child(g, !0), v = e.sibling(g, 2), y = e.child(v);
	let b;
	var x = e.only_child(y, !0), S = e.sibling(y, 2);
	let C;
	var w = e.only_child(S, !0), T = e.sibling(S, 2), E = e.child(T), D = e.child(E), O = e.sibling(D);
	{
	...
	e.reset(E);
	var ee = e.sibling(E, 2), k = (t) => {
		var n = vn(), r = e.child(n);
	...
	var A = e.sibling(h, 2), j = e.child(A), M = e.child(j), N = e.only_child(M, !0);
	e.next(2), e.reset(j);
	var P = e.sibling(j, 2);
	mn(P, {}), gn(e.sibling(P, 2), {}), e.reset(A), e.reset(m), e.reset(p), e.template_effect((t, n, r, i, a) => {
		e.set_attribute(g, "href", `/${e.get(l)}`), e.set_text(_, t), e.set_attribute(y, "href", `/${e.get(l)}`), b = e.set_class(y, 1, "nav-link", null, b, { "is-active": e.get(d) }), e.set_text(x, n), e.set_attribute(S, "href", `/${e.get(l)}/about`), C = e.set_class(S, 1, "nav-link", null, C, { "is-active": e.get(f) }), e.set_text(w, r), e.set_text(D, `${i ?? ""} `), e.set_text(N, a);
	}, [
		() => i()("shared.appName"),
		() => i()("header.home"),
...
function Sn(i, a) {
	...
	var s = xn(), c = e.first_child(s);
	bn(c, {});
	var l = e.sibling(c, 2);
	e.snippet(l, () => a.children), un(e.sibling(l, 2), {}), e.append(i, s), e.pop();
}
