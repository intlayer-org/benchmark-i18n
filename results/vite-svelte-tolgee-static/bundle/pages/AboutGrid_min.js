...
var Nt = $, Pt = e.from_html("<div class=\"grid gap-8 md:grid-cols-2\"><div class=\"rounded-lg border border-border bg-card p-6\"><h2 class=\"mb-3 text-xl font-semibold text-foreground\"> </h2> <p class=\"text-sm text-muted-foreground\"> </p></div> <div class=\"rounded-lg border border-border bg-card p-6\"><h2 class=\"mb-3 text-xl font-semibold text-foreground\"> </h2> <p class=\"text-sm text-muted-foreground\"> </p></div></div>");
function Ft(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(Nt, "$_", i), [i, a] = e.setup_stores();
	e.init();
	var o = Pt(), s = e.child(o), c = e.child(s), l = e.only_child(c, !0), u = e.sibling(c, 2), d = e.only_child(u, !0);
	e.reset(s);
	var f = e.sibling(s, 2), p = e.child(f), m = e.only_child(p, !0), h = e.sibling(p, 2), g = e.only_child(h, !0);
	e.reset(f), e.reset(o), e.template_effect((t, n, r, i) => {
		e.set_text(l, t), e.set_text(d, n), e.set_text(m, r), e.set_text(g, i);
	}, [
		() => r()("about.grid.whyExistsTitle"),
		() => r()("about.grid.whyExistsDesc"),
		() => r()("about.grid.methodologyTitle"),
		() => r()("about.grid.methodologyDesc")
