...
var It = e.from_html("<h1 class=\"mb-4 text-3xl font-bold text-foreground\"> </h1> <p class=\"mb-8 max-w-3xl text-muted-foreground\"> </p>", 1);
function Lt(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(Pt, "$_", i), [i, a] = e.setup_stores();
	Ft("AboutHeader"), e.init();
	var o = It(), s = e.first_child(o), c = e.only_child(s, !0), l = e.sibling(s, 2), u = e.only_child(l, !0);
