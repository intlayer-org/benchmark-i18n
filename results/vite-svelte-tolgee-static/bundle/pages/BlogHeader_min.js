...
var It = e.from_html("<!> <h1 class=\"mb-2 text-3xl font-bold text-foreground\"> </h1> <p class=\"mb-10 text-muted-foreground\"> </p>", 1);
function Lt(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(Nt, "$_", i), [i, a] = e.setup_stores();
	e.init();
	...
	}, [() => r()("blog.header.title"), () => r()("blog.header.description")]), e.append(t, o), e.pop(), a();
}
