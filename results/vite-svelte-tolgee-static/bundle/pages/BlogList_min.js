...
var Nt = $, Pt = e.from_html("<article class=\"rounded-lg border border-border bg-card p-6\"><div class=\"mb-3 flex items-center gap-3\"><span class=\"rounded-full bg-accent px-3 py-0.5 text-xs font-medium text-accent-foreground\"> </span> <span class=\"text-xs text-muted-foreground\"> </span></div> <h2 class=\"mb-2 text-lg font-semibold text-foreground\"> </h2> <p class=\"mb-4 text-sm text-muted-foreground\"> </p> <button type=\"button\" class=\"text-sm font-medium text-primary hover:underline\"> </button></article>"), Ft = e.from_html("<div class=\"grid gap-6 md:grid-cols-2\"></div>");
function It(t, n) {
	e.push(n, !1);
	...
	e.init();
	var s = Ft();
	e.each(s, 5, () => o, (e) => e, (t, n) => {
		var i = Pt(), a = e.child(i), o = e.child(a), s = e.only_child(o, !0), c = e.sibling(o, 2), l = e.only_child(c, !0);
		e.reset(a);
		var u = e.sibling(a, 2), d = e.only_child(u, !0), f = e.sibling(u, 2), p = e.only_child(f, !0), m = e.sibling(f, 2), h = e.only_child(m, !0);
		e.reset(i), e.template_effect((t, n, r, i, a) => {
			e.set_text(s, t), e.set_text(l, n), e.set_text(d, r), e.set_text(p, i), e.set_text(h, a);
		}, [
			() => r()(`blog.list.post${e.get(n)}Category`),
			() => r()(`blog.list.post${e.get(n)}Date`),
			() => r()(`blog.list.post${e.get(n)}Title`),
			() => r()(`blog.list.post${e.get(n)}Excerpt`),
			() => r()("blog.list.readMore")
		]), e.append(t, i);
