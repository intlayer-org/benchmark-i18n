...
var Nt = $, Pt = e.from_html("<div class=\"rounded-lg border border-border bg-card p-4 text-center\"><p class=\"text-sm font-semibold text-foreground\"> </p> <p class=\"text-xs text-muted-foreground\"> </p></div>"), Ft = e.from_html("<div class=\"mb-12 grid gap-4 md:grid-cols-3\"></div>");
function It(t, n) {
	e.push(n, !1);
	...
	e.init();
	var s = Ft();
	e.each(s, 5, () => o, (e) => `${e.label}-${e.value}`, (t, n) => {
		...
		}, [() => r()(`careers.benefits.${e.get(n).label}`), () => r()(`careers.benefits.${e.get(n).value}`)]), e.append(t, i);
