...
function ContactForm($$anchor, $$props) {
	...
	$.template_effect(($0, $1, $2, $3, $4, $5, $6, $7) => {
		...
		$.set_text(text_2, $4);
		$.set_text(text_4, $5);
		$.set_attribute(textarea, "placeholder", $6);
		$.set_text(text_5, $7);
	}, [
		() => $_()("contact.form.name"),
		() => $_()("contact.form.yourName"),
		() => $_()("contact.form.email"),
		() => $_()("contact.form.emailPlaceholder"),
		() => $_()("contact.form.topic"),
		() => $_()("contact.form.message"),
		() => $_()("contact.form.messagePlaceholder"),
		() => $_()("contact.form.sendMessage")
	]);
	$.append($$anchor, form);
	$.pop();
	$$cleanup();
