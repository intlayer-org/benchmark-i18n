...
function le(e, t, n, r, i, a, o, s) {
	...
	function T() {
		return h(s.onError, (e) => new ie("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function E() {
		if (!l.languageDetector) return;
		let e = n();
		return h(s.onError, (e) => new re("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function D(e) {
		e && l.backends.push(e);
	}
	...
	let A = Object.freeze({
		...
		setStoredLanguage(e) {
			return h(s.onError, (e) => new ie("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = C(e) || N, r = t().onFormatError, a = typeof r;
...
function me({ options: e }) {
	let t = te(), n = ue(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ue(!1, () => D.isLoading(), t.onLoadingChange.emit), i = de(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = le(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, S, C, f, t), o = ae(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && h(e);
	let s;
	t.onUpdate.listen(() => {
...
var ge = () => {
	let e = {
		...
		init(t) {
			let n = he(P(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, _e = 0, I = 1, ve = 2, ye = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === _e ? r = "Empty parameter" : e === I ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function be(e) {
	return /\s/.test(e);
}
var L = 0, R = 1, z = 2, B = 3, V = 4, xe = /* @__PURE__ */ new Set([
	z,
	R,
	L
]), H = "'", Se = /* @__PURE__ */ new Set([
	"{",
	"}",
	H
...
function we(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case L:
			...
			break;
		case R:
			Se.has(i) ? (n = n.slice(0, -1) + i, t = z) : (n += i, t = L);
			break;
		case z:
			i === H ? t = L : (n += i, t = z);
			break;
		case B:
			i === "}" ? (d(), t = L) : be(i) ? r !== "" && (d(), t = V) : (u(), t = B);
			break;
		case V: i == "}" ? t = L : be(i) ? t = V : c(I);
	}
...
var De = () => (e, t) => (t.setFinalFormatter(Ee()), e);
function Oe() {
	return globalThis.window?.document?.createElement === void 0;
}
var ke = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Ae = {};
(function(e) {
	function t(e, t) {
...
(d = console.assert) == null || d.call(console, je), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Me(e, t) {
	return t ? `${t}: ${e}` : e;
}
var U = class e extends Error {
	constructor(t, n, r) {
		super(Me(t, n)), this.code = t, this.status = n, this.params = r, Object.setPrototypeOf(this, e.prototype);
	}
};
function Ne(e) {
	return e instanceof Error && typeof e.code == "string";
}
var Pe = 2, Fe = 35e3, Ie = "TOLGEE_API_REQUEST", Le = "TOLGEE_API_RESPONSE", Re = "TOLGEE_PROXY_PING", ze = "TOLGEE_PROXY_PONG";
function Be(e) {
...
}, Ve = 3e3, He = 200, Ue = 0, G = /* @__PURE__ */ new Map(), K = !1, q, J;
async function We({ type: e, replyType: t, payload: n, timeoutMs: r = Fe, progressType: i, onProgress: a }) {
	qe();
	let o = Date.now() + r;
	await Je(Math.min(o, Date.now() + Ve));
	let s = o - Date.now();
	if (s <= 0) throw Ge(e);
	let c = Ke();
	return new Promise((r, o) => {
		let u = setTimeout(() => {
			G.delete(c), Ye(), o(Ge(e));
		}, s);
		G.set(c, {
			replyType: t,
			progressType: i,
...
var Ge = (e) => new W("unavailable", `the Tolgee browser extension did not answer ${e} in time`), Ke = () => `${Date.now()}-${Ue++}-${Math.random()}`;
function qe() {
	K || (K = !0, window.addEventListener("message", (e) => {
		var t;
...
function Je(e) {
	return q ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Re }, window.origin), i = () => {
			clearInterval(a), Ye(), J = void 0, n(new W("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Y = "__tolgee_", ft = `${Y}apiKey`, pt = `${Y}apiUrl`, mt = `${Y}branch`, ht = `${Y}projectId`, gt = `${Y}session`, _t = "tolgee-in-context-tools.umd.min.js", vt = "@tolgee/in-context-tools", yt = "InContextTools", bt = "https://cdn.jsdelivr.net/npm", xt = null;
function St(e) {
...
function X() {
	let e = sessionStorage.getItem(ft) || void 0, t = sessionStorage.getItem(pt) || void 0, n = sessionStorage.getItem(mt) || void 0, r = sessionStorage.getItem(ht) || void 0, i = Be(sessionStorage.getItem(gt));
	if (!t) return;
	let a = l(l({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return u(l({}, a), { apiKey: e });
	if (i && r) return u(l({}, a), { transport: Xe() });
}
function Ot() {
	let e = [];
...
function It(t, n) {
	...
	e.init();
	var d = Ft(), f = e.child(d), p = e.child(f), m = e.child(p);
	...
	var C = e.only_child(S, !0), w = e.sibling(S, 2);
	e.set_attribute(w, "id", c), e.each(w, 5, () => u, (e) => e, (t, n) => {
		var i = Pt(), a = e.only_child(i, !0), o = {};
		e.template_effect((t) => {
			e.set_text(a, t), o !== (o = e.get(n)) && (i.value = (i.__value = o) ?? "");
		}, [() => r()(`contact.form.${e.get(n)}`)]), e.append(t, i);
	}), e.reset(w), e.reset(x);
	var T = e.sibling(x, 2), E = e.child(T);
	e.set_attribute(E, "for", l);
	var D = e.only_child(E, !0), O = e.sibling(E, 2);
	e.set_attribute(O, "id", l), e.set_attribute(O, "rows", 5), e.reset(T);
	var k = e.sibling(T, 2), A = e.only_child(k, !0);
	e.reset(d), e.template_effect((t, n, r, i, a, o, s, c) => {
		e.set_text(h, t), e.set_attribute(g, "placeholder", n), e.set_text(y, r), e.set_attribute(b, "placeholder", i), e.set_text(C, a), e.set_text(D, o), e.set_attribute(O, "placeholder", s), e.set_text(A, c);
	}, [
		() => r()("contact.form.name"),
		() => r()("contact.form.yourName"),
		() => r()("contact.form.email"),
		() => r()("contact.form.emailPlaceholder"),
		() => r()("contact.form.topic"),
		() => r()("contact.form.message"),
		() => r()("contact.form.messagePlaceholder"),
		() => r()("contact.form.sendMessage")
