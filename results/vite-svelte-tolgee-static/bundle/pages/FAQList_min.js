...
var Nt = $, Pt = e.from_html("<details class=\"group rounded-lg border border-border bg-card\"><summary class=\"cursor-pointer px-6 py-4 text-sm font-medium text-foreground transition-colors hover:bg-accent/50\"> </summary> <p class=\"px-6 pb-4 text-sm text-muted-foreground\"> </p></details>"), Ft = e.from_html("<div class=\"mx-auto max-w-3xl space-y-4\"></div>");
function It(t, n) {
	e.push(n, !1);
	...
	e.each(s, 5, () => o, (e) => e, (t, n) => {
		...
		}, [() => r()(`faq.list.q${e.get(n)}`), () => r()(`faq.list.a${e.get(n)}`)]), e.append(t, i);
