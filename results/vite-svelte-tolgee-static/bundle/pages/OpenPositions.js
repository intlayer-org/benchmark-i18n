...
function OpenPositions($$anchor, $$props) {
	...
	$.each(div, 5, () => openings, (o) => `${o.titleKey}-${o.locationKey}`, ($$anchor, o) => {
		...
		$.template_effect(($0, $1, $2, $3, $4, $5) => {
			...
			() => $_()(`careers.openPositions.${$.get(o).titleKey}`),
			() => $_()(`careers.openPositions.${$.get(o).descKey}`),
			() => $_()(`careers.openPositions.${$.get(o).deptKey}`),
			() => $_()(`careers.openPositions.${$.get(o).locationKey}`),
			() => $_()(`careers.openPositions.${$.get(o).typeKey}`),
			() => $_()("careers.openPositions.applyNow")
		]);
		$.append($$anchor, div_1);
	});
	$.reset(div);
	$.template_effect(($0) => $.set_text(text, $0), [() => $_()("careers.openPositions.title")]);
