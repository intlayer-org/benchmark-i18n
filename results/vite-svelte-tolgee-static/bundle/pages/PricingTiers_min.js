...
var Nt = $, Pt = e.from_html("<span class=\"text-sm text-muted-foreground\"> </span>"), Ft = e.from_html("<li class=\"flex items-center gap-2 text-sm text-muted-foreground\"><span class=\"text-primary\">✓</span> </li>"), It = e.from_html("<div><h3 class=\"text-lg font-semibold text-foreground\"> </h3> <div class=\"my-4\"><span class=\"text-3xl font-bold text-foreground\"> </span> <!></div> <ul class=\"mb-6 flex-1 space-y-2\"></ul> <button type=\"button\"> </button></div>"), Lt = e.from_html("<div class=\"grid gap-6 md:grid-cols-3\"></div>");
function Rt(t, n) {
	e.push(n, !1);
	...
	e.each(s, 5, () => o, (e) => e.id, (t, n) => {
		var i = It(), a = e.child(i), o = e.only_child(a, !0), s = e.sibling(a, 2), c = e.child(s), l = e.only_child(c, !0), u = e.sibling(c, 2), d = (t) => {
			var i = Pt(), a = e.only_child(i, !0);
		...
		var f = e.sibling(s, 2);
		e.each(f, 5, () => e.get(n).featureKeys, (e) => e, (t, n) => {
			var i = Ft(), a = e.sibling(e.child(i));
		...
		e.reset(i), e.template_effect((t, r, a) => {
			...
			() => r()(`pricing.tiers.${e.get(n).priceKey}`),
			() => r()(`pricing.tiers.${e.get(n).ctaKey}`)
		]), e.append(t, i);
