...
import { onMount as n } from "svelte";
var r = Object.defineProperty, i = Object.defineProperties, a = Object.getOwnPropertyDescriptors, o = Object.getOwnPropertySymbols, s = Object.prototype.hasOwnProperty, c = Object.prototype.propertyIsEnumerable, l = (e, t, n) => t in e ? r(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, u = (e, t) => {
	for (var n in t ||= {}) s.call(t, n) && l(e, n, t[n]);
	if (o) for (var n of o(t)) c.call(t, n) && l(e, n, t[n]);
	return e;
}, d = (e, t) => i(e, a(t)), f;
function p(e, t) {
...
function h(e, t) {
	return m(e) ? Promise.resolve(e).then(t) : t(e);
}
function g(e, t, n) {
	function r(n) {
		let r = t(n);
...
function ue(e, t) {
	let n = P(le, t?.initialOptions, e);
	return n.apiUrl = C(n.apiUrl), e?.fetch && (n.fetch = D(e.fetch)), {
		initialOptions: n,
...
function de(e, t, n, r, i, a, o, s) {
	...
	function w() {
		return g(s.onError, (e) => new ae("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function T() {
		if (!l.languageDetector) return;
		let e = n();
		return g(s.onError, (e) => new ie("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function E(e) {
		e && l.backends.push(e);
	}
	...
	let k = Object.freeze({
		...
		getInitialLanguage() {
			let e = n();
			return h(w(), (t) => (!e || e.includes(t)) && t ? t : T());
		},
		setStoredLanguage(e) {
			return g(s.onError, (e) => new ae("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ee(e) || N, r = t().onFormatError, a = typeof r;
	...
	let r = ue(), i, a = Object.freeze({
		...
		getRequiredNamespaces() {
			return S([
				a.getDefaultNs(),
				...r.initialOptions.ns || [],
				...b(r.initialOptions.fallbackNs),
				...r.activeNamespaces.keys()
			]);
		},
		getFallbackLangs(e) {
			let t = e || a.getLanguage();
			return t ? S([t, ...x(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
			return b(r.initialOptions.fallbackNs);
		},
		getNs() {
		...
		overrideCredentials(e) {
			i = e ? Object.assign(Object.assign({}, e), { apiUrl: C(e.apiUrl) }) : void 0;
		}
	});
	return a;
}
...
function ge({ options: e }) {
	let t = ne(), n = fe(!1, () => o.isFetching(), t.onFetchingChange.emit), r = fe(!1, () => E.isLoading(), t.onLoadingChange.emit), i = pe(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = de(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, x, C, f, t), o = oe(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
	...
	function d(e) {
		return S([...b(e ?? l()), ...i.getRequiredNamespaces()]);
	}
	function f(e, t, n) {
	...
	function v(e, t) {
		return g(e, t).filter((e) => !o.exists(e, !0));
	}
	function y(e) {
		let t = [], n = [];
	...
	function ee() {
		...
		if (m(e)) return i.setInitialLoading(!0), n.notify(), r.notify(), Promise.resolve(e).then(() => {
			i.setInitialLoading(!1), n.notify(), r.notify(), t.onInitialLoaded.emit();
		});
		t.onInitialLoaded.emit();
	}
	function w() {
		if (!i.getLanguage()) return h(a.getInitialLanguage(), (e) => {
			let t = e || i.getInitialOptions().defaultLanguage;
			t && i.setLanguage(t);
		});
	}
	function T() {
		if ((a.getLanguageDetector() || a.getLanguageStorage()) && !i.getAvailableLanguages()) throw Error(_("availableLanguages"));
		if (!i.getLanguage() && !i.getInitialOptions().defaultLanguage) throw Error(_(["defaultLanguage", "language"]));
	}
	let E = Object.freeze(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, t), i), a), o), {
		...
		getRequiredDescriptors: g,
		async changeLanguage(e) {
			(i.getPendingLanguage() !== e || i.getLanguage() !== e) && (i.setPendingLanguage(e), i.isRunning() && i.getInitialOptions().autoLoadRequiredData && await o.loadRecords(g(e), { useCache: !0 }), e === i.getPendingLanguage() && (i.setLanguage(e), await a.setStoredLanguage(e)));
		},
		async addActiveNs(e, t) {
			t || i.addActiveNs(e), i.isRunning() && await o.loadRecords(g(void 0, e), { useCache: !0 });
		},
		...
		run() {
			return T(), i.isRunning() || (i.setRunning(!0), a.run(), s = ee()), Promise.resolve(s);
		},
		stop() {
...
var ve = () => {
	let e = {
		...
		init(t) {
			let n = _e(P(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, F = 0, I = 1, ye = 2, be = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === F ? r = "Empty parameter" : e === I ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function xe(e) {
	return /\s/.test(e);
}
var L = 0, R = 1, z = 2, B = 3, V = 4, Se = /* @__PURE__ */ new Set([
	z,
	R,
	L
]), H = "'", Ce = /* @__PURE__ */ new Set([
	"{",
	"}",
	H
...
function Te(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case L:
			...
			break;
		case R:
			Ce.has(i) ? (n = n.slice(0, -1) + i, t = z) : (n += i, t = L);
			break;
		case z:
			i === H ? t = L : (n += i, t = z);
			break;
		case B:
			i === "}" ? (d(), t = L) : xe(i) ? r !== "" && (d(), t = V) : (u(), t = B);
			break;
		case V: i == "}" ? t = L : xe(i) ? t = V : c(I);
	}
...
var Oe = () => (e, t) => (t.setFinalFormatter(De()), e);
function ke() {
	return globalThis.window?.document?.createElement === void 0;
}
var Ae = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, je = {};
(function(e) {
	function t(e, t) {
...
(f = console.assert) == null || f.call(console, Me), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ne(e, t) {
	return t ? `${t}: ${e}` : e;
}
var U = class e extends Error {
	constructor(t, n, r) {
		super(Ne(t, n)), this.code = t, this.status = n, this.params = r, Object.setPrototypeOf(this, e.prototype);
	}
};
function Pe(e) {
	return e instanceof Error && typeof e.code == "string";
}
var Fe = 2, Ie = 35e3, Le = "TOLGEE_API_REQUEST", Re = "TOLGEE_API_RESPONSE", ze = "TOLGEE_PROXY_PING", Be = "TOLGEE_PROXY_PONG";
function Ve(e) {
...
}, He = 3e3, Ue = 200, We = 0, G = /* @__PURE__ */ new Map(), Ge = !1, K, q;
async function Ke({ type: e, replyType: t, payload: n, timeoutMs: r = Ie, progressType: i, onProgress: a }) {
	Ye();
	let o = Date.now() + r;
	await Xe(Math.min(o, Date.now() + He));
	let s = o - Date.now();
	if (s <= 0) throw qe(e);
	let c = Je();
	return new Promise((r, o) => {
		let l = setTimeout(() => {
			G.delete(c), Ze(), o(qe(e));
		}, s);
		G.set(c, {
			replyType: t,
			progressType: i,
...
var qe = (e) => new W("unavailable", `the Tolgee browser extension did not answer ${e} in time`), Je = () => `${Date.now()}-${We++}-${Math.random()}`;
function Ye() {
	Ge || (Ge = !0, window.addEventListener("message", (e) => {
		var t;
...
function Xe(e) {
	return K ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: ze }, window.origin), i = () => {
			clearInterval(a), Ze(), q = void 0, n(new W("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var rt = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
function it(e) {
	let t = rt.indexOf(e);
...
function ot(e) {
	...
	for (let o = 0; o < t; o++) r = r << 5 | it(e[o]), n += 5, n >= 8 && (a[i++] = r >>> n - 8 & 255, n -= 8);
	return at(a.buffer);
}
function st(e) {
	if (e) try {
...
function lt(e) {
	...
	return r ? {
		...
		hasCredential: !!t,
		projectId: st(t) ?? n,
		requiresExplicitProject: ct(t) === "tgpat"
	};
}
function ut(e) {
...
function ft({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var J = "__tolgee_", mt = `${J}apiKey`, ht = `${J}apiUrl`, gt = `${J}branch`, _t = `${J}projectId`, vt = `${J}session`, yt = "tolgee-in-context-tools.umd.min.js", bt = "@tolgee/in-context-tools", xt = "InContextTools", St = "https://cdn.jsdelivr.net/npm", Y = null;
function Ct(e) {
	return Y ||= Ot(wt(e)).then(() => window[bt][xt]), Y;
}
function wt(e) {
	return Tt() || `${St}/@tolgee/web@${e}/dist/${yt}`;
}
function Tt() {
	if (ke()) return;
	let e = window.__TOLGEE_IN_CONTEXT_URL__;
	return Dt(e, window.location) ? e : void 0;
}
var Et = (e) => e === "localhost" || e === "127.0.0.1" || e === "::1" || e === "[::1]";
function Dt(e, t) {
	if (!e || !Et(t.hostname)) return !1;
	try {
		let n = new URL(e, t.href);
		return n.origin === t.origin || Et(n.hostname);
	} catch {
		return !1;
	}
}
...
function kt() {
	let e = sessionStorage.getItem(mt) || void 0, t = sessionStorage.getItem(ht) || void 0, n = sessionStorage.getItem(gt) || void 0, r = sessionStorage.getItem(_t) || void 0, i = Ve(sessionStorage.getItem(vt));
	if (!t) return;
	let a = u(u({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return d(u({}, a), { apiKey: e });
	if (i && r) return d(u({}, a), { transport: Qe() });
}
function At() {
	let e = [];
...
function jt(e) {
	if (!e.isDev()) return;
	let { requiresExplicitProject: t, projectId: n } = lt(e.getInitialOptions());
...
(() => {
	...
	return jt(e), e.on("running", ({ value: e }) => {
		e && Mt(() => {
			t.update(n()).catch(At);
		});
	}), kt() && (async () => {
		let e = await Ct("7.2.1");
		return (t) => {
			let n = kt();
...
Z.on("update", () => {
	...
	typeof document < "u" && e?.value && (document.documentElement.lang = e.value), $.set(Q());
});
var Pt = $;
function Ft(e) {
...
var It = e.from_html("<tr class=\"border-t border-border\"><td class=\"px-4 py-3 font-medium text-foreground\"> </td><td class=\"px-4 py-3 text-muted-foreground\"> </td><td class=\"px-4 py-3 text-muted-foreground\"> </td><td class=\"px-4 py-3 text-muted-foreground\"> </td></tr>"), Lt = e.from_html("<section><h2 class=\"mb-6 text-2xl font-bold text-foreground\"> </h2> <div class=\"overflow-x-auto rounded-lg border border-border\"><table class=\"w-full text-sm\"><thead class=\"bg-muted\"><tr><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"> </th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"> </th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"> </th><th class=\"px-4 py-3 text-left font-medium text-muted-foreground\"> </th></tr></thead><tbody></tbody></table></div></section>");
function Rt(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(Pt, "$_", i), [i, a] = e.setup_stores();
	Ft("ResultsTable");
	let o = [
		{
			lib: "react-i18next",
	...
	e.init();
	var s = Lt(), c = e.child(s), l = e.only_child(c, !0), u = e.sibling(c, 2), d = e.child(u), f = e.child(d), p = e.child(f), m = e.child(p), h = e.only_child(m, !0), g = e.sibling(m), _ = e.only_child(g, !0), v = e.sibling(g), y = e.only_child(v, !0), b = e.sibling(v), x = e.only_child(b, !0);
	e.reset(p), e.reset(f);
	var S = e.sibling(f);
	e.each(S, 5, () => o, (e) => e.lib, (t, n) => {
		var i = It(), a = e.child(i), o = e.only_child(a, !0), s = e.sibling(a), c = e.only_child(s, !0), l = e.sibling(s), u = e.only_child(l, !0), d = e.sibling(l), f = e.only_child(d, !0);
		...
		() => r()("home.resultsTable.title"),
		() => r()("home.resultsTable.library"),
		() => r()("home.resultsTable.bundleSize"),
		() => r()("home.resultsTable.lookupTime"),
		() => r()("home.resultsTable.lazyLoading")
