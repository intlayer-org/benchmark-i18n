...
var Nt = $, Pt = e.from_html("<div class=\"mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground\"> </div>");
function Ft(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(Nt, "$_", i), [i, a] = e.setup_stores();
	e.init();
	var o = Pt(), s = e.only_child(o, !0);
	e.template_effect((t) => e.set_text(s, t), [() => r()("mockBanner")]), e.append(t, o), e.pop(), a();
}
var It = e.from_html("<!> <h1 class=\"mb-2 text-3xl font-bold text-foreground\"> </h1> <p class=\"mb-8 text-muted-foreground\"> </p>", 1);
function Lt(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(Nt, "$_", i), [i, a] = e.setup_stores();
	e.init();
	var o = It(), s = e.first_child(o);
	Ft(s, {});
