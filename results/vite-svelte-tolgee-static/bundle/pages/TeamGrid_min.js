...
var Nt = $, Pt = e.from_html("<div class=\"rounded-lg border border-border bg-card p-6 text-center\"><div class=\"mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-accent text-lg font-bold text-accent-foreground\"> </div> <h3 class=\"text-base font-semibold text-foreground\"> </h3> <p class=\"mb-2 text-xs font-medium text-primary\"> </p> <p class=\"text-sm text-muted-foreground\"> </p></div>"), Ft = e.from_html("<div class=\"grid gap-6 md:grid-cols-2 lg:grid-cols-3\"></div>");
function It(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(Nt, "$_", i), [i, a] = e.setup_stores(), o = [
		1,
		2,
		3,
		4,
	...
	function s(e) {
		return e.split(" ").map((e) => e[0] ?? "").join("");
	}
	e.init();
	var c = Ft();
	e.each(c, 5, () => o, (e) => e, (t, n) => {
		let i = e.derived_safe_equal(() => r()(`team.grid.member${e.get(n)}Name`));
		var a = Pt(), o = e.child(a), c = e.only_child(o, !0), l = e.sibling(o, 2), u = e.only_child(l, !0), d = e.sibling(l, 2), f = e.only_child(d, !0), p = e.sibling(d, 2), m = e.only_child(p, !0);
		e.reset(a), e.template_effect((t, n, r) => {
			e.set_text(c, t), e.set_text(u, e.get(i)), e.set_text(f, n), e.set_text(m, r);
		}, [
			() => s(e.get(i)),
			() => r()(`team.grid.member${e.get(n)}Role`),
			() => r()(`team.grid.member${e.get(n)}Bio`)
		]), e.append(t, a);
