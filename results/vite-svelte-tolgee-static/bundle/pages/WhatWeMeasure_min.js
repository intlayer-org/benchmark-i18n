...
var Nt = $, Pt = e.from_html("<li class=\"rounded-md border border-border p-4\"><span class=\"block text-sm font-bold text-primary\"> </span> <span class=\"mt-1 block text-sm text-muted-foreground\"> </span></li>"), Ft = e.from_html("<section class=\"mx-auto mt-12 max-w-3xl\"><h2 class=\"mb-4 text-2xl font-bold text-foreground\"> </h2> <ul class=\"space-y-4\"></ul></section>");
function It(t, n) {
	e.push(n, !1);
	...
	e.init();
	var s = Ft(), c = e.child(s), l = e.only_child(c, !0), u = e.sibling(c, 2);
	e.each(u, 5, () => o, (e) => e.m, (t, n) => {
		var i = Pt(), a = e.child(i), o = e.only_child(a, !0), s = e.sibling(a, 2), c = e.only_child(s, !0);
