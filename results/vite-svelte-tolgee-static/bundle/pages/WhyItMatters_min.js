...
var _e = () => {
	let e = {
		...
		init(t) {
			let n = ge(F(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, I = 0, L = 1, ve = 2, ye = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
...
var R = 0, z = 1, B = 2, V = 3, H = 4, xe = /* @__PURE__ */ new Set([
	B,
	z,
	R
]), U = "'", Se = /* @__PURE__ */ new Set([
	"{",
	"}",
	U
...
function we(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case R:
			...
			break;
		case z:
			Se.has(i) ? (n = n.slice(0, -1) + i, t = B) : (n += i, t = R);
			break;
		case B:
			i === U ? t = R : (n += i, t = B);
			break;
		case V:
			i === "}" ? (d(), t = R) : be(i) ? r !== "" && (d(), t = H) : (u(), t = V);
			break;
		case H: i == "}" ? t = R : be(i) ? t = H : c(L);
	}
...
(f = console.assert) == null || f.call(console, je), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Me(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
}, Ve = 3e3, He = 200, Ue = 0, K = /* @__PURE__ */ new Map(), We = !1, q, J;
...
var Ke = (e) => new G("unavailable", `the Tolgee browser extension did not answer ${e} in time`), qe = () => `${Date.now()}-${Ue++}-${Math.random()}`;
function Je() {
...
function Ye(e) {
	return q ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Re }, window.origin), i = () => {
			clearInterval(a), Xe(), J = void 0, n(new G("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var Y = "__tolgee_", pt = `${Y}apiKey`, mt = `${Y}apiUrl`, ht = `${Y}branch`, gt = `${Y}projectId`, _t = `${Y}session`, vt = "tolgee-in-context-tools.umd.min.js", yt = "@tolgee/in-context-tools", bt = "InContextTools", xt = "https://cdn.jsdelivr.net/npm", X = null;
function St(e) {
	return X ||= Dt(Ct(e)).then(() => window[yt][bt]), X;
}
function Ct(e) {
	return wt() || `${xt}/@tolgee/web@${e}/dist/${vt}`;
}
function wt() {
	if (Oe()) return;
...
function Ot() {
	...
	if (i && r) return d(u({}, a), { transport: Ze() });
}
function kt() {
	let e = [];
...
var It = e.from_html("<section class=\"mb-16\"><h2 class=\"mb-6 text-2xl font-bold text-foreground\"> </h2> <div class=\"grid gap-6 md:grid-cols-3\"><div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"> </h3> <p class=\"text-sm text-muted-foreground\"> </p></div> <div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"> </h3> <p class=\"text-sm text-muted-foreground\"> </p></div> <div class=\"rounded-lg border border-border bg-card p-6\"><h3 class=\"mb-2 text-lg font-semibold text-foreground\"> </h3> <p class=\"text-sm text-muted-foreground\"> </p></div></div></section>");
function Lt(t, n) {
	e.push(n, !1);
	let r = () => e.store_get(Pt, "$_", i), [i, a] = e.setup_stores();
	Ft("WhyItMatters"), e.init();
	var o = It(), s = e.child(o), c = e.only_child(s, !0), l = e.sibling(s, 2), u = e.child(l), d = e.child(u), f = e.only_child(d, !0), p = e.sibling(d, 2), m = e.only_child(p, !0);
	e.reset(u);
	var h = e.sibling(u, 2), g = e.child(h), _ = e.only_child(g, !0), v = e.sibling(g, 2), y = e.only_child(v, !0);
	e.reset(h);
	var b = e.sibling(h, 2), x = e.child(b), S = e.only_child(x, !0), C = e.sibling(x, 2), w = e.only_child(C, !0);
	e.reset(b), e.reset(l), e.reset(o), e.template_effect((t, n, r, i, a, o, s) => {
		e.set_text(c, t), e.set_text(f, n), e.set_text(m, r), e.set_text(_, i), e.set_text(y, a), e.set_text(S, o), e.set_text(w, s);
	}, [
