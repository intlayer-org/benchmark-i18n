...
function f(i, o, s, c, l, u) {
	return a(), t(e, null, [
		r(c.MockBanner),
		o[0] ||= n("h1", { class: "mb-2 text-3xl font-bold text-foreground" }, "Products", -1),
		o[1] ||= n("p", { class: "mb-10 text-muted-foreground" }, " Tools and services to streamline your internationalization workflow. ", -1)
	], 64);
}
var p = o(d, [["render", f], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-base-app/src/components/pages/products/ProductsHeader.vue"]]);
export { p as default };
