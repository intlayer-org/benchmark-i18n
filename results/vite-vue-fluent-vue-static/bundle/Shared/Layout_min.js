...
var A = { class: "mt-20 border-t border-border bg-card" }, j = { class: "container py-8" }, M = { class: "grid gap-8 md:grid-cols-3" }, N = { class: "mb-2 text-sm font-semibold text-foreground" }, P = { class: "text-sm text-muted-foreground" }, F = { class: "mb-2 text-sm font-semibold text-foreground" }, I = { class: "space-y-1" }, L = ["href"], R = { class: "mb-2 text-sm font-semibold text-foreground" }, z = { class: "text-sm text-muted-foreground" }, B = { class: "mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground" }, ee = c({
	__name: "Footer",
	setup(r) {
		let { td: s } = k(), c = S(), l = t(() => c.params.locale || "en"), u = t(() => [
			{
		...
		return (t, r) => {
			...
			return m(), i("footer", A, [a("div", j, [a("div", M, [
				a("div", null, [a("h3", N, v(y(s)("footer.title")), 1), a("p", P, v(y(s)("footer.description")), 1)]),
				a("div", null, [a("h3", F, v(y(s)("footer.resources")), 1), a("ul", I, [(m(!0), i(e, null, g(u.value, (e) => (m(), i("li", { key: e.label }, [e.isInternal ? (m(), n(c, {
					key: 0,
					to: e.to,
				...
				a("div", null, [a("h3", R, v(y(s)("footer.contact")), 1), a("p", z, v(y(s)("shared.contactEmail")), 1)])
			]), a("div", B, v(y(s)("footer.builtWith")), 1)])]);
		};
	}
});
function V(e) {
...
var H = [
...
}, W = { class: "flex items-center gap-2" }, G = ["value"], K = ["value"], q = c({
	...
	setup(n) {
		...
		}, [(m(!0), i(e, null, g(y(H), (e) => (m(), i("option", {
			key: e,
			value: e
		}, v(y(U)(e)), 9, K))), 128))], 40, G)]));
	}
}), J = ["aria-label", "title"], Y = c({
	__name: "ThemeToggle",
	setup(e) {
		let { td: t } = k(), n = h("auto");
		function r() {
		...
		}, v(n.value === "auto" ? y(t)("themeToggle.auto") : n.value === "dark" ? y(t)("themeToggle.dark") : y(t)("themeToggle.light")), 9, J));
	}
}), X = { class: "sticky top-0 z-50 border-b border-border bg-card/80 backdrop-blur-lg" }, Z = { class: "container flex h-16 items-center justify-between" }, Q = { class: "flex items-center gap-8" }, $ = { class: "hidden items-center gap-6 text-sm font-medium md:flex" }, te = { class: "relative" }, ne = { class: "bg-card border border-border rounded-md shadow-lg overflow-hidden py-1" }, re = { class: "flex items-center gap-4" }, ie = {
	href: "https://github.com/intlayer-org/benchmark-i18n",
	target: "_blank",
	rel: "noreferrer",
	class: "text-muted-foreground transition hover:text-foreground"
}, ae = { class: "sr-only" }, oe = c({
	__name: "Header",
	setup(c) {
		V("Header");
		let { td: l } = k(), d = h(!1), f = S(), p = t(() => f.params.locale || "en"), b = t(() => [
			{
				to: `/${p.value}/products`,
		...
		return (t, c) => {
			let f = _("router-link");
			return m(), i("header", X, [a("nav", Z, [a("div", Q, [s(f, {
				to: `/${p.value}`,
				...
				}, [a("div", ne, [(m(!0), i(e, null, g(b.value, (e) => (m(), n(f, {
					key: e.to,
					to: e.to,
				...
				a("a", ie, [a("span", ae, v(y(l)("shared.goToGithub")), 1), c[6] ||= a("svg", {
					viewBox: "0 0 16 16",
					"aria-hidden": "true",
					width: "20",
					height: "20"
