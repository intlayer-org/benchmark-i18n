...
function _(n, r, i, a, c, l) {
	return o(), e("section", m, [t("h1", h, s(a.td("faq.header.title")), 1), t("p", g, s(a.td("faq.header.description")), 1)]);
}
var v = p(f, [["render", _], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/fluent-vue-app/src/components/pages/faq/FAQHeader.vue"]]);
export { v as default };
