...
}), _ = { class: "mb-2 text-3xl font-bold text-foreground" }, v = { class: "mb-4 text-muted-foreground" };
function y(i, a, c, l, u, d) {
	return o(), t(e, null, [
		r(l.MockBanner),
		n("h1", _, s(l.td("careers.header.title")), 1),
		n("p", v, s(l.td("careers.header.description")), 1)
	], 64);
}
var b = f(g, [["render", y], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/fluent-vue-app/src/components/pages/careers/CareersHeader.vue"]]);
export { b as default };
