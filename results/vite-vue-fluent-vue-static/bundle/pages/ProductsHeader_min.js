...
function y(i, a, c, l, u, d) {
	return o(), t(e, null, [
		r(l.MockBanner),
		n("h1", _, s(l.td("products.header.title")), 1),
		n("p", v, s(l.td("products.header.description")), 1)
	], 64);
}
var b = f(g, [["render", y], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/fluent-vue-app/src/components/pages/products/ProductsHeader.vue"]]);
export { b as default };
