...
}), _ = { class: "mb-2 text-3xl font-bold text-foreground" }, v = { class: "mb-8 text-muted-foreground" };
function y(i, a, c, l, u, d) {
	return o(), t(e, null, [
		r(l.MockBanner),
		n("h1", _, s(l.td("settings.header.title")), 1),
		n("p", v, s(l.td("settings.header.description")), 1)
	], 64);
}
var b = f(g, [["render", y], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/fluent-vue-app/src/components/pages/settings/SettingsHeader.vue"]]);
export { b as default };
