...
}), m = { class: "mb-2 text-3xl font-bold text-foreground" }, h = { class: "mb-8 text-muted-foreground" }, g = i({
	__name: "SettingsHeader",
	setup(i) {
		let { td: a } = d();
		return (i, l) => (o(), t(e, null, [
			r(p),
			n("h1", m, s(c(a)("settings.header.title")), 1),
			n("p", h, s(c(a)("settings.header.description")), 1)
		], 64));
	}
});
export { g as default };
