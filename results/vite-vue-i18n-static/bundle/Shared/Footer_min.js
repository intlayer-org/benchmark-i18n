...
import { Fragment as t, Text as n, computed as r, createBlock as i, createElementBlock as a, createElementVNode as o, createTextVNode as s, createVNode as c, defineComponent as l, effectScope as u, getCurrentInstance as d, getCurrentScope as f, h as p, inject as m, isRef as h, onMounted as g, onScopeDispose as _, onUnmounted as v, openBlock as y, ref as b, renderList as x, renderSlot as S, resolveComponent as C, shallowRef as w, toDisplayString as T, unref as E, watch as ee, withCtx as D } from "vue";
...
var ae = /\{([0-9a-zA-Z]+)\}/g;
function oe(e, ...t) {
	return t.length === 1 && B(t[0]) && (t = t[0]), (!t || !t.hasOwnProperty) && (t = {}), e.replace(ae, (e, n) => t.hasOwnProperty(n) ? t[n] : "");
}
var j = (e, t = !1) => t ? Symbol.for(e) : Symbol(e), se = (e, t, n) => ce({
	l: e,
	k: t,
	s: n
}), ce = (e) => JSON.stringify(e).replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029").replace(/\u0027/g, "\\u0027"), M = (e) => typeof e == "number" && isFinite(e), le = (e) => xe(e) === "[object Date]", ue = (e) => xe(e) === "[object RegExp]", de = (e) => V(e) && Object.keys(e).length === 0, N = Object.assign, fe = Object.create, P = (e = null) => fe(e), pe, me = () => pe ||= typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : P();
function he(e) {
...
function U(e, t, n = {}) {
	let { domain: r, messages: i, args: a } = n, o = process.env.NODE_ENV === "production" ? e : oe((i || je)[e] || "", ...a || []), s = SyntaxError(String(o));
...
function He(e, t = {}) {
	...
	function T(e, t) {
		...
		let r = () => {
			let t = e.currentPeek();
			return t === "{" ? _(e.peek()) : t === "@" || t === "|" || t === ":" || t === "." || t === W || !t ? !1 : t === G ? (e.peek(), r()) : ee(e, !1);
		}, i = r();
	...
	function ce(e) {
		g(e);
		let t = "";
		return e.currentChar() === "-" ? (e.next(), t += `-${oe(e)}`) : t += oe(e), e.currentChar() === ze && d(H.UNTERMINATED_CLOSING_BRACE, a(), 0), t;
	}
	function M(e) {
		return e !== Be && e !== G;
	}
	...
	function he(e, t) {
		...
		switch (e.currentChar()) {
			...
			default: {
				let r = !0, i = !0, o = !0;
				if (E(e)) return t.braceNest > 0 && d(H.UNTERMINATED_CLOSING_BRACE, a(), 0), n = f(t, 1, me(e)), t.braceNest = 0, t.inLinked = !1, n;
	...
	function ge(e, t) {
		...
		switch ((n === 7 || n === 8 || n === 11 || n === 9) && (i === G || i === W) && d(H.INVALID_LINKED_FORMAT, a(), 0), i) {
			...
			default: return E(e) ? (r = f(t, 1, me(e)), t.braceNest = 0, t.inLinked = !1, r) : S(e, t) || w(e, t) ? (g(e), ge(e, t)) : C(e, t) ? (g(e), f(t, 11, P(e))) : T(e, t) ? (g(e), i === "{" ? he(e, t) || r : f(t, 10, pe(e))) : (n === 7 && d(H.INVALID_LINKED_FORMAT, a(), 0), t.braceNest = 0, t.inLinked = !1, _e(e, t));
		}
	}
	function _e(e, t) {
		let n = { type: 13 };
...
function Mn(e = {}) {
	...
	return D.datetimeFormats = s, D.numberFormats = c, D.__datetimeFormatters = T, D.__numberFormatters = E, process.env.NODE_ENV !== "production" && (D.__v_emitter = w.__v_emitter == null ? void 0 : w.__v_emitter), process.env.NODE_ENV !== "production" && Ut(D, n, ee), D;
}
var Nn = (e) => ({ [e]: P() });
function Pn(e, t) {
...
function Hn(e, ...t) {
	...
	if (!R(t[0]) && !le(t[0]) && !M(t[0])) return process.env.NODE_ENV !== "production" && a(mn(Y.INVALID_DATE_ARGUMENT, { value: String(t[0]) })), "";
...
function Kn(e, ...t) {
	...
	if (!M(t[0])) return process.env.NODE_ENV !== "production" && a(mn(Y.INVALID_NUMBER_ARGUMENT, { value: String(t[0]) })), "";
...
function Jn(...e) {
	...
	if (!M(t)) throw Kt(J.INVALID_ARGUMENT);
	let s = t;
	return R(n) ? a.key = n : V(n) && Object.keys(n).forEach((e) => {
...
function ar(e, ...t) {
	...
	if (f && R(T) && (T = _e(T)), process.env.NODE_ENV !== "production") {
		let t = {
			timestamp: Date.now(),
			key: R(c) ? c : X(b) ? b.key : "",
	...
	for (let r = 0; r < u.length; r++) {
		...
		if (process.env.NODE_ENV !== "production" && k && l && (_ = window.performance.now(), v = "intlify-message-resolve-start", y = "intlify-message-resolve-end", A && A(v)), (p = c(d, t)) === null && (p = d[t]), process.env.NODE_ENV !== "production" && k && l) {
			...
			l && _ && p && l.emit("message-resolve", {
				...
				time: e - _,
				groupId: `${g}:${t}`
			}), v && y && A && ie && (A(y), ie("intlify message resolve", v, y));
		}
...
function cr(e, t, n, r, i, a) {
	...
	if (process.env.NODE_ENV !== "production" && k && c) {
		...
		c && l && c.emit("message-compilation", {
			...
			time: e - l,
			groupId: `translate:${t}`
		}), u && d && A && ie && (A(d), ie("intlify message compilation", u, d));
	}
...
function lr(e, t, n) {
	...
	if (process.env.NODE_ENV !== "production" && k && r) {
		...
		}), a && o && A && ie && (A(o), ie("intlify message evaluation", a, o));
	}
	return s;
}
function ur(...e) {
	let [t, n, r] = e, i = P();
	if (!R(t) && !M(t) && !X(t) && !q(t)) throw Kt(J.INVALID_ARGUMENT);
	let a = M(t) ? String(t) : (X(t), t);
	return M(n) ? i.plural = n : R(n) ? i.default = n : V(n) && !de(n) ? i.named = n : I(n) && (i.list = n), M(r) ? i.plural = r : R(r) ? i.default = r : V(r) && N(i, r), [a, i];
}
...
}, Dr = j("__translateVNode"), Or = j("__datetimeParts"), kr = j("__numberParts"), Ar = j("__enableEmitter"), jr = j("__disableEmitter"), Mr = j("__setPluralRules");
j("__intlifyMeta");
var Nr = j("__injectWithOption"), Pr = j("__dispose"), $ = {
	FALLBACK_TO_ROOT: 10,
		...
		if (!t.includes(".")) B(e[t]) && Lr(e[t]);
			...
			for (let e = 0; e < r; e++) {
				...
				if (n[e] in i || (i[n[e]] = P()), !B(i[n[e]])) {
					process.env.NODE_ENV !== "production" && O(Ir($.IGNORE_OBJ_FLATTEN, { key: n[e] })), a = !0;
					break;
				}
				i = i[n[e]];
			}
...
function Yr(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = k ? b : w, s = !z(e.inheritLocale) || e.inheritLocale, c = o(t && s ? t.locale.value : R(e.locale) ? e.locale : gn), l = o(t && s ? t.fallbackLocale.value : R(e.fallbackLocale) || I(e.fallbackLocale) || V(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(Rr(c.value, e)), d = o(V(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(V(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : z(e.missingWarn) || ue(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : z(e.fallbackWarn) || ue(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : !z(e.fallbackRoot) || e.fallbackRoot, g = !!e.fallbackFormat, _ = L(e.missing) ? e.missing : null, v = L(e.missing) ? qr(e.missing) : null, y = L(e.postTranslation) ? e.postTranslation : null, x = t ? t.warnHtmlMessage : !z(e.warnHtmlMessage) || e.warnHtmlMessage, S = !!e.escapeParameter, C = t ? t.modifiers : V(e.modifiers) ? e.modifiers : {}, T = e.pluralRules || t && t.pluralRules, E;
	E = (() => {
		i && kn(null);
		let t = {
			version: Tr,
	...
	}), re = r(() => u.value), A = r(() => d.value), ie = r(() => f.value);
	function ae() {
		return L(y) ? y : null;
	}
	function oe(e) {
	...
	let le = (e, n, r, a, o, s) => {
		...
		let c;
		try {
			process.env.NODE_ENV !== "production" && En(Jr()), i || (E.fallbackContext = t ? An() : void 0), c = e(E);
		} finally {
			process.env.NODE_ENV !== "production" && En(null), i || (E.fallbackContext = void 0);
		}
		if (r !== "translate exists" && M(c) && c === -1 || r === "translate exists" && !c) {
			let [e, i] = n();
			if (process.env.NODE_ENV !== "production" && t && R(e) && ce(r, i) && (h && (Pn(m, e) || Fn(p, e)) && O(Ir($.FALLBACK_TO_ROOT, {
				key: e,
				type: r
	...
	function me(e) {
		return e.map((e) => R(e) || M(e) || z(e) ? Vr(String(e)) : e);
	}
	let he = {
		normalize: me,
		interpolate: (e) => e,
	...
	function _e(...e) {
		return le((t) => Reflect.apply(Kn, null, [t, ...e]), () => Jn(...e), "number format", (t) => t[kr](...e), Wr, (e) => R(e) || I(e));
	}
	function ve(...e) {
		return le((t) => Reflect.apply(Hn, null, [t, ...e]), () => Wn(...e), "datetime format", (t) => t[Or](...e), Wr, (e) => R(e) || I(e));
	}
	function ye(e) {
		T = e, E.pluralRules = T;
	}
	...
	return U.datetimeFormats = A, U.numberFormats = ie, U.rt = fe, U.te = be, U.tm = Se, U.d = P, U.n = pe, U.getDateTimeFormat = Ee, U.setDateTimeFormat = De, U.mergeDateTimeFormat = ke, U.getNumberFormat = Ae, U.setNumberFormat = H, U.mergeNumberFormat = je, U[Nr] = n, U[Dr] = ge, U[Or] = ve, U[kr] = _e, process.env.NODE_ENV !== "production" && (U[Ar] = (e) => {
		E.__v_emitter = e;
	}, U[jr] = () => {
...
function Ti(e) {
	let t = (t) => {
		process.env.NODE_ENV !== "production" && re(Ir($.DEPRECATE_TRANSLATE_CUSTOME_DIRECTIVE));
...
var ki = j("global-vue-i18n");
function Ai(e = {}) {
	process.env.NODE_ENV;
	let t = !z(e.globalInjection) || e.globalInjection, n = /* @__PURE__ */ new Map(), [r, i] = Mi(e, !1), a = j(process.env.NODE_ENV === "production" ? "" : "vue-i18n");
	function o(e) {
		return n.get(e) || null;
	}
	function s(e, t) {
...
function ji(e = {}) {
	...
	if (a === "parent") {
		...
		return i ??= (process.env.NODE_ENV !== "production" && O(Ir($.NOT_FOUND_PARENT_SCOPE)), r), i;
	}
	if (a === "isolated") {
	...
	} else process.env.NODE_ENV !== "production" && a === "local" && O(Ir($.DUPLICATE_USE_I18N_CALLING));
	return s;
}
function Mi(e, t) {
	let n = u(), r = n.run(() => Yr(e));
	if (r == null) throw Q(Z.UNEXPECTED_ERROR);
	return [n, r];
}
function Ni(e) {
	let t = m(e.isCE ? ki : e.appContext.app.__VUE_I18N_SYMBOL__);
...
process.env.NODE_ENV;
var Ui = { class: "mt-20 border-t border-border bg-card" }, Wi = { class: "container py-8" }, Gi = { class: "grid gap-8 md:grid-cols-3" }, Ki = { class: "mb-2 text-sm font-semibold text-foreground" }, qi = { class: "text-sm text-muted-foreground" }, Ji = { class: "mb-2 text-sm font-semibold text-foreground" }, Yi = { class: "space-y-1" }, Xi = ["href"], Zi = { class: "mb-2 text-sm font-semibold text-foreground" }, Qi = { class: "text-sm text-muted-foreground" }, $i = { class: "mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground" }, ea = l({
	__name: "Footer",
	setup(e) {
		let { t: n } = ji(), c = te(), l = r(() => c.params.locale || "en"), u = r(() => [
			{
		...
		return (e, r) => {
			let c = C("router-link");
			return y(), a("footer", Ui, [o("div", Wi, [o("div", Gi, [
				o("div", null, [o("h3", Ki, T(E(n)("footer.title")), 1), o("p", qi, T(E(n)("footer.description")), 1)]),
				o("div", null, [o("h3", Ji, T(E(n)("footer.resources")), 1), o("ul", Yi, [(y(!0), a(t, null, x(u.value, (e) => (y(), a("li", { key: e.label }, [e.isInternal ? (y(), i(c, {
					key: 0,
					to: e.to,
					class: "text-sm text-muted-foreground hover:text-foreground transition-colors"
				}, {
					default: D(() => [s(T(e.label), 1)]),
					_: 2
				}, 1032, ["to"])) : (y(), a("a", {
					key: 1,
					href: e.href,
				...
				o("div", null, [o("h3", Zi, T(E(n)("footer.contact")), 1), o("p", Qi, T(E(n)("shared.contactEmail")), 1)])
			]), o("div", $i, T(E(n)("footer.builtWith")), 1)])]);
		};
	}
}), ta = Ai({
	legacy: !1,
	...
	__name: "Wrapper",
	setup(e) {
		let t = d()?.appContext.app;
		return t && !t.config.globalProperties.$i18n && t.use(ta), (e, t) => S(e.$slots, "default");
	}
}), ra = { render() {
	return p(na, {}, { default: () => p(ea) });
} };
