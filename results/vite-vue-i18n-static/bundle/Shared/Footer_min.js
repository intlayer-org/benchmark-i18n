...
import { Fragment as t, Text as n, computed as r, createBlock as i, createElementBlock as a, createElementVNode as o, createTextVNode as s, createVNode as c, defineComponent as l, effectScope as u, getCurrentInstance as d, getCurrentScope as f, h as p, inject as m, isRef as h, onMounted as g, onScopeDispose as _, onUnmounted as v, openBlock as y, ref as b, renderList as x, renderSlot as S, resolveComponent as C, shallowRef as w, toDisplayString as T, watch as ee, withCtx as E } from "vue";
import { useRoute as D } from "vue-router";
import te from "../../locales/fr.json";
import ne from "../../locales/es.json";
import re from "../../locales/de.json";
import ie from "../../locales/it.json";
import ae from "../../locales/pt.json";
import oe from "../../locales/zh.json";
import se from "../../locales/ja.json";
import ce from "../../locales/ko.json";
import le from "../../locales/ru.json";
function O(e, t) {
...
var fe = /\{([0-9a-zA-Z]+)\}/g;
function pe(e, ...t) {
	return t.length === 1 && V(t[0]) && (t = t[0]), (!t || !t.hasOwnProperty) && (t = {}), e.replace(fe, (e, n) => t.hasOwnProperty(n) ? t[n] : "");
}
var M = (e, t = !1) => t ? Symbol.for(e) : Symbol(e), me = (e, t, n) => he({
	l: e,
	k: t,
	s: n
}), he = (e) => JSON.stringify(e).replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029").replace(/\u0027/g, "\\u0027"), N = (e) => typeof e == "number" && isFinite(e), ge = (e) => Oe(e) === "[object Date]", _e = (e) => Oe(e) === "[object RegExp]", ve = (e) => H(e) && Object.keys(e).length === 0, P = Object.assign, ye = Object.create, F = (e = null) => ye(e), be, xe = () => be ||= typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : F();
function Se(e) {
...
function we(e) {
	return e = e.replace(/(\w+)\s*=\s*"([^"]*)"/g, (e, t, n) => `${t}="${Ce(n)}"`), e = e.replace(/(\w+)\s*=\s*'([^']*)'/g, (e, t, n) => `${t}='${Ce(n)}'`), /\s*on\w+\s*=\s*["']?[^"'>]+["']?/gi.test(e) && (process.env.NODE_ENV !== "production" && O("Potentially dangerous event handlers detected in translation. Consider removing onclick, onerror, etc. from your translation messages."), e = e.replace(/(\s+)(on)(\w+\s*=)/gi, "$1&#111;n$3")), [/(\s+(?:href|src|action|formaction)\s*=\s*["']?)\s*javascript:/gi, /(style\s*=\s*["'][^"']*url\s*\(\s*)javascript:/gi].forEach((t) => {
...
var L = Array.isArray, R = (e) => typeof e == "function", z = (e) => typeof e == "string", B = (e) => typeof e == "boolean", V = (e) => typeof e == "object" && !!e, Ee = (e) => V(e) && R(e.then) && R(e.catch), De = Object.prototype.toString, Oe = (e) => De.call(e), H = (e) => Oe(e) === "[object Object]", ke = (e) => e == null ? "" : L(e) || H(e) && e.toString === De ? JSON.stringify(e, null, 2) : String(e);
function Ae(e, t = "") {
	return e.reduce((e, n, r) => r === 0 ? e + n : e + t + n, "");
}
var U = 2;
function je(e, t = 0, n = e.length) {
	let r = e.split(/\r?\n/), i = 0, a = [];
	for (let e = 0; e < r.length; e++) if (i += r[e].length + 1, i >= t) {
		for (let o = e - U; o <= e + U || n > i; o++) {
...
var Ne = (e) => !V(e) || L(e);
function Pe(e, t) {
	if (Ne(e) || Ne(t)) throw Error("Invalid value");
	let n = [{
		src: e,
		des: t
	}];
	for (; n.length;) {
		...
		Object.keys(e).forEach((r) => {
			r !== "__proto__" && (V(e[r]) && !V(t[r]) && (t[r] = Array.isArray(e[r]) ? [] : F()), Ne(t[r]) || Ne(e[r]) ? t[r] = e[r] : n.push({
				src: e[r],
				des: t[r]
			}));
		});
...
function Re(e, t, n = {}) {
	let { domain: r, messages: i, args: a } = n, o = process.env.NODE_ENV === "production" ? e : pe((i || Le)[e] || "", ...a || []), s = SyntaxError(String(o));
	return s.code = e, t && (s.location = t), s.domain = r, s;
}
function ze(e) {
	throw e;
}
var Be = /<\/?[\w\s="/.':;#-\/]+>/, Ve = (e) => Be.test(e), G = " ", He = "\r", K = "\n", Ue = "\u2028", We = "\u2029";
function Ge(e) {
	let t = e, n = 0, r = 1, i = 1, a = 0, o = (e) => t[e] === He && t[e + 1] === K, s = (e) => t[e] === K, c = (e) => t[e] === We, l = (e) => t[e] === Ue, u = (e) => o(e) || s(e) || c(e) || l(e), d = () => n, f = () => r, p = () => i, m = () => a, h = (e) => o(e) || c(e) || l(e) ? K : t[e], g = () => h(n), _ = () => h(n + a);
	function v() {
...
var Ke = void 0, qe = "'", Je = "tokenizer";
function Ye(e, t = {}) {
	let n = t.location !== !1, r = Ge(e), i = () => r.index(), a = () => Fe(r.line(), r.column(), r.index()), o = a(), s = i(), c = {
		currentType: 13,
		offset: s,
		startLoc: o,
		endLoc: o,
	...
	function d(e, t, r, ...i) {
		let a = l();
		t.column += r, t.offset += r, u && u(Re(e, n ? Ie(a.startLoc, t) : null, {
			domain: Je,
			args: i
		}));
	}
	function f(e, t, r) {
		...
		let i = { type: t };
		return n && (i.loc = Ie(e.startLoc, e.endLoc)), r != null && (i.value = r), i;
	}
	let p = (e) => f(e, 13);
	function m(e, t) {
	...
	function D(e, t) {
		let n = e.currentChar();
		return n === Ke ? Ke : t(n) ? (e.next(), n) : null;
	}
	function te(e) {
		let t = e.charCodeAt(0);
	...
	function ue(e) {
		...
		for (; t = ie(e);) n += t;
		let r = e.currentChar();
		if (r && r !== "}" && r !== Ke && r !== G && r !== K && r !== "　") {
			let t = M(e);
			return d(W.INVALID_TOKEN_IN_PLACEHOLDER, a(), 0, n + t), n + t;
		}
		return e.currentChar() === Ke && d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), n;
	}
	function k(e) {
		g(e);
		let t = "";
		return e.currentChar() === "-" ? (e.next(), t += `-${le(e)}`) : t += le(e), e.currentChar() === Ke && d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), t;
	}
	function A(e) {
		return e !== qe && e !== K;
	}
	function j(e) {
		g(e), m(e, "'");
		let t = "", n = "";
		for (; t = D(e, A);) t === "\\" ? n += de(e) : n += t;
		let r = e.currentChar();
		return r === K || r === Ke ? (d(W.UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER, a(), 0), r === K && (e.next(), m(e, "'")), n) : (m(e, "'"), n);
	}
	function de(e) {
		let t = e.currentChar();
		switch (t) {
	...
	function ge(e, t) {
		...
		switch (e.currentChar()) {
			...
			case "@": return t.braceNest > 0 && d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), n = _e(e, t) || p(t), t.braceNest = 0, n;
			default: {
				let r = !0, i = !0, o = !0;
				if (ee(e)) return t.braceNest > 0 && d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), n = f(t, 1, N(e)), t.braceNest = 0, t.inLinked = !1, n;
				if (t.braceNest > 0 && (t.currentType === 4 || t.currentType === 5 || t.currentType === 6)) return d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), t.braceNest = 0, ve(e, t);
				if (r = y(e, t)) return n = f(t, 4, ue(e)), g(e), n;
				if (i = b(e, t)) return n = f(t, 5, k(e)), g(e), n;
				if (o = x(e, t)) return n = f(t, 6, j(e)), g(e), n;
				if (!r && !i && !o) return n = f(t, 12, M(e)), d(W.INVALID_TOKEN_IN_PLACEHOLDER, a(), 0, n.value), g(e), n;
				break;
			}
		}
		return n;
	...
	function _e(e, t) {
		...
		switch ((n === 7 || n === 8 || n === 11 || n === 9) && (i === K || i === G) && d(W.INVALID_LINKED_FORMAT, a(), 0), i) {
			...
			default: return ee(e) ? (r = f(t, 1, N(e)), t.braceNest = 0, t.inLinked = !1, r) : S(e, t) || w(e, t) ? (g(e), _e(e, t)) : C(e, t) ? (g(e), f(t, 11, me(e))) : T(e, t) ? (g(e), i === "{" ? ge(e, t) || r : f(t, 10, he(e))) : (n === 7 && d(W.INVALID_LINKED_FORMAT, a(), 0), t.braceNest = 0, t.inLinked = !1, ve(e, t));
		}
	}
	function ve(e, t) {
		let n = { type: 13 };
		if (t.braceNest > 0) return ge(e, t) || p(t);
		if (t.inLinked) return _e(e, t) || p(t);
		switch (e.currentChar()) {
			case "{": return ge(e, t) || p(t);
			case "}": return d(W.UNBALANCED_CLOSING_BRACE, a(), 0), e.next(), f(t, 3, "}");
			case "@": return _e(e, t) || p(t);
			default:
				if (ee(e)) return n = f(t, 1, N(e)), t.braceNest = 0, t.inLinked = !1, n;
				if (E(e)) return f(t, 0, O(e));
				break;
		}
		return n;
	}
	function P() {
		...
		return c.lastType = e, c.lastOffset = t, c.lastStartLoc = n, c.lastEndLoc = o, c.offset = i(), c.startLoc = a(), r.currentChar() === Ke ? f(c, 13) : ve(r, c);
	}
	return {
		nextToken: P,
		currentOffset: i,
...
var Xe = "parser", Ze = /(?:\\\\|\\'|\\u([0-9a-fA-F]{4})|\\U([0-9a-fA-F]{6}))/g, Qe = /\\([\\@{}|])/g;
function $e(e, t) {
	return t;
}
function et(e, t, n) {
...
function tt(e = {}) {
	...
	function r(e, r, i, a, ...o) {
		...
		s.offset += a, s.column += a, n && n(Re(r, t ? Ie(i, s) : null, {
			domain: Xe,
			args: o
		}));
	}
	...
	function o(e, t) {
		...
		return r.value = t.replace(Qe, $e), a(r, e.currentOffset(), e.currentPosition()), r;
	}
	function s(e, t) {
	...
	function l(e, t) {
		...
		return o.value = t.replace(Ze, et), e.nextToken(), a(o, e.currentOffset(), e.currentPosition()), o;
	}
	function u(e) {
		let t = e.nextToken(), n = e.context(), { lastOffset: o, lastStartLoc: s } = n, c = i(8, o, s);
		return t.type === 11 ? (t.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, n.lastStartLoc, 0, nt(t)), c.value = t.value || "", a(c, e.currentOffset(), e.currentPosition()), { node: c }) : (r(e, W.UNEXPECTED_EMPTY_LINKED_MODIFIER, n.lastStartLoc, 0), c.value = "", a(c, o, s), {
			nextConsumeToken: t,
			node: c
		});
	}
	...
	function f(e) {
		...
		switch (o.type !== 9 && r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, nt(o)), o = e.nextToken(), o.type === 2 && (o = e.nextToken()), o.type) {
			case 10:
				o.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, nt(o)), n.key = d(e, o.value || "");
				break;
			case 4:
				o.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, nt(o)), n.key = c(e, o.value || "");
				break;
			case 5:
				o.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, nt(o)), n.key = s(e, o.value || "");
				break;
			case 6:
				o.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, nt(o)), n.key = l(e, o.value || "");
				break;
			default: {
	...
	function p(e) {
		...
		do {
			...
			switch (u = null, i.type) {
				case 0:
					i.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, nt(i)), n.items.push(o(e, i.value || ""));
					break;
				case 5:
					i.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, nt(i)), n.items.push(s(e, i.value || ""));
					break;
				case 4:
					i.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, nt(i)), n.items.push(c(e, i.value || ""));
					break;
				case 6:
					i.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, nt(i)), n.items.push(l(e, i.value || ""));
					break;
				case 7: {
					let t = f(e);
	...
	function g(n) {
		let o = Ye(n, P({}, e)), s = o.context(), c = i(0, s.offset, s.startLoc);
...
function at(e, t) {
	switch (e.type) {
		case 1:
			it(e.cases, t), t.helper("plural");
			break;
		case 2:
			it(e.items, t);
			break;
		case 6:
			at(e.key, t), t.helper("linked"), t.helper("type");
			break;
		case 5:
...
function ot(e, t = {}) {
	let n = rt(e);
	n.helper("normalize"), e.body && at(e.body, n);
	let r = n.context();
	e.helpers = Array.from(r.helpers);
}
function st(e) {
	let t = e.body;
	return t.type === 2 ? ct(t) : t.cases.forEach((e) => ct(e)), e;
}
function ct(e) {
	if (e.items.length === 1) {
		let t = e.items[0];
...
function ut(e) {
	switch (e.t = e.type, e.type) {
		...
		case 1: {
			let t = e, n = t.cases;
			for (let e = 0; e < n.length; e++) ut(n[e]);
		...
		default: if (process.env.NODE_ENV !== "production") throw Re(W.UNHANDLED_MINIFIER_NODE_TYPE, null, {
			domain: lt,
			args: [e.type]
		});
	}
...
function pt(e, t) {
	let { helper: n } = e;
	e.push(`${n("linked")}(`), _t(e, t.key), t.modifier ? (e.push(", "), _t(e, t.modifier), e.push(", _type")) : e.push(", undefined, _type"), e.push(")");
}
function mt(e, t) {
	let { helper: n, needIndent: r } = e;
	e.push(`${n("normalize")}([`), e.indent(r());
	let i = t.items.length;
	for (let n = 0; n < i && (_t(e, t.items[n]), n !== i - 1); n++) e.push(", ");
	e.deindent(r()), e.push("])");
}
function ht(e, t) {
	let { helper: n, needIndent: r } = e;
	if (t.cases.length > 1) {
		...
		for (let n = 0; n < i && (_t(e, t.cases[n]), n !== i - 1); n++) e.push(", ");
		e.deindent(r()), e.push("])");
	}
}
function gt(e, t) {
...
function _t(e, t) {
	...
	switch (t.type) {
		...
		case 3:
			e.push(JSON.stringify(t.value), t);
			break;
		default: if (process.env.NODE_ENV !== "production") throw Re(W.UNHANDLED_CODEGEN_NODE_TYPE, null, {
			domain: dt,
			args: [t.type]
		});
	}
...
var vt = (e, t = {}) => {
	...
	c.push(n === "normal" ? "function __msg__ (ctx) {" : "(ctx) => {"), c.indent(o), s.length > 0 && (c.push(`const { ${Ae(s.map((e) => `${e}: _${e}`), ", ")} } = ctx`), c.newline()), c.push("return "), _t(c, e), c.deindent(o), c.push("}"), delete e.helpers;
...
function yt(e, t = {}) {
	let n = P({}, t), r = !!n.jit, i = !!n.minify, a = n.optimize == null ? !0 : n.optimize, o = tt(n).parse(e);
	return r ? (a && st(o), i && ut(o), {
		ast: o,
		code: ""
	}) : (ot(o, n), vt(o, n));
}
function q(e) {
	return V(e) && kt(e) === 0 && (I(e, "b") || I(e, "body"));
}
var bt = ["b", "body"];
function xt(e) {
	return It(e, bt);
...
function Bt(e, t) {
	let n = xt(t);
	if (n == null) throw Rt(0);
	if (kt(n) === 1) {
		let t = Ct(n);
		return e.plural(t.reduce((t, n) => [...t, Vt(e, n)], []));
	} else return Vt(e, n);
}
function Vt(e, t) {
	let n = Tt(t);
	...
	{
		let n = Dt(t).reduce((t, n) => [...t, Ht(e, n)], []);
...
function Ht(e, t) {
	let n = kt(t);
	switch (n) {
		case 3: return jt(t, n);
		case 9: return jt(t, n);
		case 4: {
			let r = t;
		...
		case 6: {
			let n = t, r = Nt(n), i = Ft(n);
			return e.linked(Ht(e, i), r ? Ht(e, r) : void 0, e.type);
		}
		case 7: return jt(t, n);
		case 8: return jt(t, n);
		default: throw Error(`unhandled node on format message part: ${n}`);
	}
}
var Ut = "Detected HTML in '{source}' message. Recommend not using HTML messages to avoid XSS.";
function Wt(e, t) {
	t && Ve(e) && O(pe(Ut, { source: e }));
}
var Gt = (e) => e, Kt = F();
function qt(e, t = {}) {
	let n = !1, r = t.onError || ze;
	return t.onError = (e) => {
		n = !0, r(e);
	}, {
		...yt(e, t),
...
function Jt(e, t) {
	if (z(e)) {
		...
		process.env.NODE_ENV !== "production" && Wt(e, n);
		let r = (t.onCacheKey || Gt)(e), i = Kt[r];
		if (i) return i;
...
var Qt = $t("function:translate");
function $t(e) {
	return (t) => Yt && Yt.emit(e, t);
}
var J = {
	INVALID_ARGUMENT: 17,
...
function en(e) {
	return Re(e, null, process.env.NODE_ENV === "production" ? void 0 : { messages: tn });
}
var tn = {
...
function nn(e, t) {
	return t.locale == null ? an(e.locale) : an(t.locale);
}
var rn;
function an(e) {
	if (z(e)) return e;
	if (R(e)) {
		if (e.resolvedOnce && rn != null) return rn;
		if (e.constructor.name === "Function") {
			let t = e();
			if (Ee(t)) throw en(J.NOT_SUPPORT_LOCALE_PROMISE_VALUE);
			return rn = t;
		} else throw en(J.NOT_SUPPORT_LOCALE_ASYNC_FUNCTION);
	} else throw en(J.NOT_SUPPORT_LOCALE_TYPE);
}
function on(e, t, n) {
...
function sn(e, t, n) {
	...
	if (!a) {
		...
		e = z(o) ? [o] : o, L(e) && cn(a, e, !1), i.__localeChainCache.set(r, a);
	}
	return a;
}
function cn(e, t, n) {
...
function gn(e) {
	let t = e.trim();
	return e.charAt(0) === "0" && isNaN(parseInt(e)) ? !1 : pn(t) ? mn(t) : "*" + t;
}
function _n(e) {
	...
	f[0] = () => {
		...
		if (i > 0) i--, r = 4, f[0]();
			...
			if (i = 0, o === void 0 || (o = gn(o), o === !1)) return !1;
			f[1]();
		}
	};
	function p() {
	...
	for (; r !== null;) if (n++, a = e[n], !(a === "\\" && p())) {
		if (c = hn(a), d = dn[r], l = d[c] || d.l || 8, l === 8 || (r = l[0], l[1] !== void 0 && (u = f[l[1]], u && (s = a, u() === !1)))) return;
		if (r === 7) return t;
	}
}
...
function bn(e, t) {
	if (!V(e)) return null;
	let n = vn.get(t);
	if (n || (n = _n(t), n && vn.set(t, n)), !n) return null;
	let r = n.length, i = e, a = 0;
	for (; a < r;) {
		let e = n[a];
		if (Lt.includes(e) && q(i) || !V(i) || !I(i, e)) return null;
		let t = i[e];
...
var Cn = "11.4.0", wn = "en-US", Tn = (e) => `${e.charAt(0).toLocaleUpperCase()}${e.substr(1)}`;
function En() {
	return {
		...
		capitalize: (e, t) => t === "text" && z(e) ? Tn(e) : t === "vnode" && V(e) && "__v_isVNode" in e ? Tn(e.children) : e
	};
}
var Dn;
function On(e) {
...
function Bn(e = {}) {
	let t = R(e.onWarn) ? e.onWarn : O, n = z(e.version) ? e.version : Cn, r = z(e.locale) || R(e.locale) ? e.locale : wn, i = R(r) ? wn : r, a = L(e.fallbackLocale) || H(e.fallbackLocale) || z(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : i, o = H(e.messages) ? e.messages : Vn(i), s = H(e.datetimeFormats) ? e.datetimeFormats : Vn(i), c = H(e.numberFormats) ? e.numberFormats : Vn(i), l = P(F(), e.modifiers, En()), u = e.pluralRules || F(), d = R(e.missing) ? e.missing : null, f = B(e.missingWarn) || _e(e.missingWarn) ? e.missingWarn : !0, p = B(e.fallbackWarn) || _e(e.fallbackWarn) ? e.fallbackWarn : !0, m = !!e.fallbackFormat, h = !!e.unresolving, g = R(e.postTranslation) ? e.postTranslation : null, _ = H(e.processor) ? e.processor : null, v = B(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, y = !!e.escapeParameter, b = R(e.messageCompiler) ? e.messageCompiler : Dn;
	process.env.NODE_ENV !== "production" && R(e.messageCompiler) && k(Sn(Y.EXPERIMENTAL_CUSTOM_MESSAGE_COMPILER));
	let x = R(e.messageResolver) ? e.messageResolver : kn || yn, S = R(e.localeFallbacker) ? e.localeFallbacker : jn || on, C = V(e.fallbackContext) ? e.fallbackContext : void 0, w = e, T = V(w.__datetimeFormatters) ? w.__datetimeFormatters : /* @__PURE__ */ new Map(), ee = V(w.__numberFormatters) ? w.__numberFormatters : /* @__PURE__ */ new Map(), E = V(w.__meta) ? w.__meta : {};
	zn++;
	let D = {
		version: n,
		cid: zn,
	...
	return D.datetimeFormats = s, D.numberFormats = c, D.__datetimeFormatters = T, D.__numberFormatters = ee, process.env.NODE_ENV !== "production" && (D.__v_emitter = w.__v_emitter == null ? void 0 : w.__v_emitter), process.env.NODE_ENV !== "production" && Zt(D, n, E), D;
}
var Vn = (e) => ({ [e]: F() });
function Hn(e, t) {
...
function Wn(e, t, n, r, i) {
	...
	if (a !== null) {
		let r = a(e, n, t, i);
		return z(r) ? r : t;
	} else return process.env.NODE_ENV !== "production" && Un(r, t) && o(Sn(Y.NOT_FOUND_KEY, {
		key: t,
		locale: n
	})), t;
}
...
function Xn(e, ...t) {
	...
	if (process.env.NODE_ENV !== "production" && !Yn.dateTimeFormat) return a(Sn(Y.CANNOT_FORMAT_DATE)), "";
	if (!z(t[0]) && !ge(t[0]) && !N(t[0])) return process.env.NODE_ENV !== "production" && a(Sn(Y.INVALID_DATE_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = Qn(...t), f = B(u.missingWarn) ? u.missingWarn : e.missingWarn, p = B(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = nn(e, u), g = o(e, i, h);
	if (!z(c) || c === "") return new Intl.DateTimeFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "datetime format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && Hn(p, c) && a(Sn(Y.FALLBACK_TO_DATE_FORMAT, {
			key: c,
			target: v
...
function Qn(...e) {
	...
	if (z(t)) {
		...
		if (!e) throw en(J.INVALID_ISO_DATE_ARGUMENT);
		let n = e[3] ? e[3].trim().startsWith("T") ? `${e[1].trim()}${e[3].trim()}` : `${e[1].trim()}T${e[3].trim()}` : e[1].trim();
		s = new Date(n);
		try {
			s.toISOString();
		} catch {
			throw en(J.INVALID_ISO_DATE_ARGUMENT);
		}
	} else if (ge(t)) {
		if (isNaN(t.getTime())) throw en(J.INVALID_DATE_ARGUMENT);
		s = t;
	} else if (N(t)) s = t;
	else throw en(J.INVALID_ARGUMENT);
...
function er(e, ...t) {
	...
	if (process.env.NODE_ENV !== "production" && !Yn.numberFormat) return a(Sn(Y.CANNOT_FORMAT_NUMBER)), "";
	if (!N(t[0])) return process.env.NODE_ENV !== "production" && a(Sn(Y.INVALID_NUMBER_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = nr(...t), f = B(u.missingWarn) ? u.missingWarn : e.missingWarn, p = B(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = nn(e, u), g = o(e, i, h);
	if (!z(c) || c === "") return new Intl.NumberFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "number format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && Hn(p, c) && a(Sn(Y.FALLBACK_TO_NUMBER_FORMAT, {
			key: c,
			target: v
		})), process.env.NODE_ENV !== "production" && h !== v) {
			let t = e.__v_emitter;
...
function nr(...e) {
	...
	if (!N(t)) throw en(J.INVALID_ARGUMENT);
	let s = t;
	return z(n) ? a.key = n : H(n) && Object.keys(n).forEach((e) => {
...
var ir = (e) => e, ar = (e) => "", or = "text", sr = (e) => e.length === 0 ? "" : Ae(e), cr = ke;
function lr(e, t) {
...
function dr(e = {}) {
	let t = e.locale, n = ur(e), r = z(t) && R(e.pluralRules?.[t]) ? e.pluralRules[t] : lr, i = r === lr ? void 0 : lr, a = (e) => e[r(n, e.length, i)], o = e.list || [], s = (e) => o[e], c = e.named || F();
	N(e.pluralIndex) && (c.count ||= e.pluralIndex, c.n ||= e.pluralIndex);
	let l = (e) => c[e];
	function u(t, n) {
		return (R(e.messages) ? e.messages(t, !!n) : V(e.messages) ? e.messages[t] : !1) || (e.parent ? e.parent.message(t) : ar);
	}
	let d = (t) => e.modifiers ? e.modifiers[t] : ir, f = R(e.processor?.normalize) ? e.processor.normalize : sr, p = R(e.processor?.interpolate) ? e.processor.interpolate : cr, m = {
		list: s,
		named: l,
		plural: a,
		linked: (e, ...t) => {
		...
		message: u,
		type: z(e.processor?.type) ? e.processor.type : or,
		interpolate: p,
		normalize: f,
		values: P(F(), o, c)
	};
...
var fr = () => "", X = (e) => R(e);
function pr(e, ...t) {
	let { fallbackFormat: n, postTranslation: r, unresolving: i, messageCompiler: a, fallbackLocale: o, messages: s } = e, [c, l] = vr(...t), u = B(l.missingWarn) ? l.missingWarn : e.missingWarn, d = B(l.fallbackWarn) ? l.fallbackWarn : e.fallbackWarn, f = B(l.escapeParameter) ? l.escapeParameter : e.escapeParameter, p = !!l.resolvedMessage, m = z(l.default) || B(l.default) ? B(l.default) ? a ? c : () => c : l.default : n ? a ? c : () => c : null, h = n || m != null && (z(m) || R(m)), g = nn(e, l);
	f && mr(l);
	let [_, v, y] = p ? [
		c,
		g,
		s[g] || F()
	] : hr(e, c, g, o, d, u), b = _, x = c;
	...
	let S = !1, C = X(b) ? b : gr(e, c, v, b, x, () => {
		S = !0;
	});
	if (S) return b;
	let w = _r(e, C, dr(xr(e, v, y, l))), T = r ? r(w, c) : w;
	if (f && z(T) && (T = we(T)), process.env.NODE_ENV !== "production") {
		let t = {
			timestamp: Date.now(),
			key: z(c) ? c : X(b) ? b.key : "",
		...
		t.meta = P({}, e.__meta, Fn() || {}), Qt(t);
	}
	return T;
}
function mr(e) {
	L(e.list) ? e.list = e.list.map((e) => z(e) ? Se(e) : e) : V(e.named) && Object.keys(e.named).forEach((t) => {
		z(e.named[t]) && (e.named[t] = Se(e.named[t]));
	});
}
function hr(e, t, n, r, i, a) {
	...
	for (let r = 0; r < u.length; r++) {
		f = h = u[r], process.env.NODE_ENV !== "production" && n !== f && !Kn(n, f) && Hn(i, t) && s(Sn(Y.FALLBACK_TO_TRANSLATE, {
			key: t,
			target: f
		}));
		...
		if (process.env.NODE_ENV !== "production" && A && l && (_ = window.performance.now(), v = "intlify-message-resolve-start", y = "intlify-message-resolve-end", j && j(v)), (p = c(d, t)) === null && (p = d[t]), process.env.NODE_ENV !== "production" && A && l) {
			...
			l && _ && p && l.emit("message-resolve", {
				...
				time: e - _,
				groupId: `${g}:${t}`
			}), v && y && j && de && (j(y), de("intlify message resolve", v, y));
		}
...
function gr(e, t, n, r, i, a) {
	...
	if (process.env.NODE_ENV !== "production" && A && c) {
		...
		c && l && c.emit("message-compilation", {
			...
			time: e - l,
			groupId: `translate:${t}`
		}), u && d && j && de && (j(d), de("intlify message compilation", u, d));
	}
...
function _r(e, t, n) {
	...
	if (process.env.NODE_ENV !== "production" && A && r) {
		...
		}), a && o && j && de && (j(o), de("intlify message evaluation", a, o));
	}
	return s;
}
function vr(...e) {
	let [t, n, r] = e, i = F();
	if (!z(t) && !N(t) && !X(t) && !q(t)) throw en(J.INVALID_ARGUMENT);
	let a = N(t) ? String(t) : (X(t), t);
	return N(n) ? i.plural = n : z(n) ? i.default = n : H(n) && !ve(n) ? i.named = n : L(n) && (i.list = n), N(r) ? i.plural = r : z(r) ? i.default = r : H(r) && P(i, r), [a, i];
}
	...
	return {
		...
		onError: (t) => {
			if (a && a(t), process.env.NODE_ENV !== "production") {
				let i = br(r), a = t.location && i && je(i, t.location.start.offset, t.location.end.offset), o = e.__v_emitter;
...
function xr(e, t, n, r) {
	let { modifiers: i, pluralRules: a, messageResolver: o, fallbackLocale: s, fallbackWarn: c, missingWarn: l, fallbackContext: u } = e, d = {
		...
		messages: (r, i) => {
			let a = o(n, r);
			if (a == null && (u || i)) {
				let [n, , i] = hr(u || e, r, t, s, c, l);
				a = n ?? o(i, r);
			}
			if (z(a) || q(a)) {
				let n = !1, i = gr(e, r, t, a, r, () => {
					n = !0;
				});
				return n ? fr : i;
...
var wr = typeof Proxy == "function", Tr = "devtools-plugin:setup", Er = "plugin:settings:set", Dr, Or;
function kr() {
	return Dr === void 0 && (typeof window < "u" && window.performance ? (Dr = !0, Or = window.performance) : typeof globalThis < "u" && globalThis.perf_hooks?.performance ? (Dr = !0, Or = globalThis.perf_hooks.performance) : Dr = !1), Dr;
}
function Ar() {
	return kr() ? Or.now() : Date.now();
}
var jr = class {
	constructor(e, t) {
...
function Mr(e, t) {
	let n = e, r = Cr(), i = Sr(), a = wr && n.enableEarlyProxy;
	if (i && (r.__VUE_DEVTOOLS_PLUGIN_API_AVAILABLE__ || !a)) i.emit(Tr, e, t);
	else {
		let e = a ? new jr(n, i) : null;
...
function Q(e, ...t) {
	return Re(e, null, process.env.NODE_ENV === "production" ? void 0 : {
		messages: Pr,
		args: t
	});
}
...
}, Fr = M("__translateVNode"), Ir = M("__datetimeParts"), Lr = M("__numberParts"), Rr = M("__enableEmitter"), zr = M("__disableEmitter"), Br = M("__setPluralRules");
M("__intlifyMeta");
var Vr = M("__injectWithOption"), Hr = M("__dispose"), $ = {
	FALLBACK_TO_ROOT: 10,
...
function Gr(e) {
	if (!V(e) || q(e)) return e;
	for (let t in e) if (I(e, t)) if (!t.includes(".")) V(e[t]) && Gr(e[t]);
	else {
		let n = t.split("."), r = n.length - 1, i = e, a = !1;
		for (let e = 0; e < r; e++) {
			if (n[e] === "__proto__") throw Error(`unsafe key: ${n[e]}`);
			if (n[e] in i || (i[n[e]] = F()), !V(i[n[e]])) {
				process.env.NODE_ENV !== "production" && O(Wr($.IGNORE_OBJ_FLATTEN, { key: n[e] })), a = !0;
				break;
			}
			i = i[n[e]];
		}
		if (a || (q(i) ? Lt.includes(n[r]) || delete e[t] : (i[n[r]] = e[t], delete e[t])), !q(i)) {
			let e = i[n[r]];
			V(e) && Gr(e);
		}
	}
...
function Kr(e, t) {
	...
	if (L(r) && r.forEach((e) => {
		if ("locale" in e && "resource" in e) {
			...
			t ? (o[t] = o[t] || F(), Pe(n, o[t])) : Pe(n, o);
		} else z(e) && Pe(JSON.parse(e), o);
	}), i == null && a) for (let e in o) I(o, e) && Gr(o[e]);
	return o;
}
function qr(e) {
	return e.type;
...
function Jr(e, t, n) {
	...
	"__i18nGlobal" in n && (r = Kr(e.locale.value, {
		messages: r,
...
var Zr = "__INTLIFY_META__", Qr = () => [], $r = () => !1, ei = 0;
function ti(e) {
	return ((t, n, r, i) => e(n, r, Xr() || void 0, i));
}
var ni = () => {
	let e = Xr(), t = null;
	return e && (t = qr(e)[Zr]) ? { [Zr]: t } : null;
};
function ri(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = A ? b : w, s = B(e.inheritLocale) ? e.inheritLocale : !0, c = o(t && s ? t.locale.value : z(e.locale) ? e.locale : wn), l = o(t && s ? t.fallbackLocale.value : z(e.fallbackLocale) || L(e.fallbackLocale) || H(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(Kr(c.value, e)), d = o(H(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(H(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : B(e.missingWarn) || _e(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : B(e.fallbackWarn) || _e(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : B(e.fallbackRoot) ? e.fallbackRoot : !0, g = !!e.fallbackFormat, _ = R(e.missing) ? e.missing : null, v = R(e.missing) ? ti(e.missing) : null, y = R(e.postTranslation) ? e.postTranslation : null, x = t ? t.warnHtmlMessage : B(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, S = !!e.escapeParameter, C = t ? t.modifiers : H(e.modifiers) ? e.modifiers : {}, T = e.pluralRules || t && t.pluralRules, E;
	E = (() => {
		i && Ln(null);
		let t = {
			version: Nr,
	...
	let te = r({
		...
		get: () => l.value,
		set: (e) => {
			E.fallbackLocale = e, l.value = e, Gn(E, c.value, e);
		}
	...
	let k = (e, n, r, a, o, s) => {
		...
		let c;
		try {
			process.env.NODE_ENV !== "production" && Pn(ni()), i || (E.fallbackContext = t ? Rn() : void 0), c = e(E);
		} finally {
			process.env.NODE_ENV !== "production" && Pn(null), i || (E.fallbackContext = void 0);
		}
		if (r !== "translate exists" && N(c) && c === -1 || r === "translate exists" && !c) {
			let [e, i] = n();
			if (process.env.NODE_ENV !== "production" && t && z(e) && ue(r, i) && (h && (Hn(m, e) || Un(p, e)) && O(Wr($.FALLBACK_TO_ROOT, {
				key: e,
				type: r
	...
	function j(...e) {
		return k((t) => Reflect.apply(pr, null, [t, ...e]), () => vr(...e), "translate", (t) => Reflect.apply(t.t, t, [...e]), (e) => e, (e) => z(e));
	}
	function de(...e) {
		let [t, n, r] = e;
	...
	function fe(...e) {
		return k((t) => Reflect.apply(Xn, null, [t, ...e]), () => Qn(...e), "datetime format", (t) => Reflect.apply(t.d, t, [...e]), () => "", (e) => z(e) || L(e));
	}
	function pe(...e) {
		return k((t) => Reflect.apply(er, null, [t, ...e]), () => nr(...e), "number format", (t) => Reflect.apply(t.n, t, [...e]), () => "", (e) => z(e) || L(e));
	}
	function M(e) {
		return e.map((e) => z(e) || N(e) || B(e) ? Yr(String(e)) : e);
	}
	let me = {
		normalize: M,
		interpolate: (e) => e,
	...
	function he(...e) {
		return k((t) => {
			let n, r = t;
			try {
				r.processor = me, n = Reflect.apply(pr, null, [r, ...e]);
			} finally {
				r.processor = null;
			}
			return n;
		}, () => vr(...e), "translate", (t) => t[Fr](...e), (e) => [Yr(e)], (e) => L(e));
	}
	function ge(...e) {
		return k((t) => Reflect.apply(er, null, [t, ...e]), () => nr(...e), "number format", (t) => t[Lr](...e), Qr, (e) => z(e) || L(e));
	}
	function ve(...e) {
		return k((t) => Reflect.apply(Xn, null, [t, ...e]), () => Qn(...e), "datetime format", (t) => t[Ir](...e), Qr, (e) => z(e) || L(e));
	}
	function ye(e) {
		T = e, E.pluralRules = T;
	}
	function F(e, t) {
		return k(() => {
			if (!e) return !1;
			let n = z(t) ? t : c.value, r = z(t) ? [n] : sn(E, l.value, n);
			for (let t = 0; t < r.length; t++) {
				let n = Se(r[t]), i = E.messageResolver(n, e);
				if (i === null && (i = n[e]), q(i) || X(i) || z(i)) return !0;
			}
			return !1;
		}, () => [e], "translate exists", (n) => Reflect.apply(n.te, n, [e, t]), $r, (e) => B(e));
	}
	function be(e) {
		let t = null, n = sn(E, l.value, c.value);
	...
	function we(e, t) {
		u.value[e] = u.value[e] || {};
		let n = { [e]: t };
		if (a) for (let e in n) I(n, e) && Gr(n[e]);
		t = n[e], Pe(t, u.value[e]), E.messages = u.value;
	}
	function Te(e) {
		return d.value[e] || {};
	}
	function Ee(e, t) {
		d.value[e] = t, E.datetimeFormats = d.value, $n(E, e, t);
	}
	function De(e, t) {
		d.value[e] = P(d.value[e] || {}, t), E.datetimeFormats = d.value, $n(E, e, t);
	}
	function Oe(e) {
		return f.value[e] || {};
	}
	function ke(e, t) {
		f.value[e] = t, E.numberFormats = f.value, rr(E, e, t);
	}
	function Ae(e, t) {
		f.value[e] = P(f.value[e] || {}, t), E.numberFormats = f.value, rr(E, e, t);
	}
	ei++, t && A && (ee(t.locale, (e) => {
		s && (c.value = e, E.locale = e, Gn(E, c.value, l.value));
	}), ee(t.fallbackLocale, (e) => {
		s && (l.value = e, E.fallbackLocale = e, Gn(E, c.value, l.value));
	}));
	let U = {
		id: ei,
		locale: te,
		...
		set inheritLocale(e) {
			s = e, e && t && (c.value = t.locale.value, l.value = t.fallbackLocale.value, Gn(E, c.value, l.value));
		},
	...
	return U.datetimeFormats = ie, U.numberFormats = ae, U.rt = de, U.te = F, U.tm = xe, U.d = fe, U.n = pe, U.getDateTimeFormat = Te, U.setDateTimeFormat = Ee, U.mergeDateTimeFormat = De, U.getNumberFormat = Oe, U.setNumberFormat = ke, U.mergeNumberFormat = Ae, U[Vr] = n, U[Fr] = he, U[Ir] = ve, U[Lr] = ge, process.env.NODE_ENV !== "production" && (U[Rr] = (e) => {
		E.__v_emitter = e;
	}, U[zr] = () => {
		E.__v_emitter = void 0;
	}), U;
}
var ii = "vue-i18n: composer properties", ai = {
	"vue-devtools-plugin-vue-i18n": "Vue I18n DevTools",
	"vue-i18n-resource-inspector": "Vue I18n DevTools",
	"vue-i18n-timeline": "Vue I18n"
}, oi = { "vue-i18n-resource-inspector": "Search for scopes ..." }, si = { "vue-i18n-timeline": 16764185 }, ci;
async function li(e, t) {
	return new Promise((n, r) => {
		try {
			Mr({
				id: "vue-devtools-plugin-vue-i18n",
				label: ai["vue-devtools-plugin-vue-i18n"],
				...
				ci = r, r.on.visitComponentTree(({ componentInstance: e, treeNode: n }) => {
					di(e, n, t);
				}), r.on.inspectComponent(({ componentInstance: e, instanceData: n }) => {
					e.__VUE_I18N__ && n && (t.mode === "legacy" ? e.__VUE_I18N__ !== t.global.__composer && fi(n, e.__VUE_I18N__) : fi(n, e.__VUE_I18N__));
				}), r.addInspector({
					id: "vue-i18n-resource-inspector",
					label: ai["vue-i18n-resource-inspector"],
					icon: "language",
					treeFilterPlaceholder: oi["vue-i18n-resource-inspector"]
				}), r.on.getInspectorTree((n) => {
					n.app === e && n.inspectorId === "vue-i18n-resource-inspector" && vi(n, t);
				});
				let i = /* @__PURE__ */ new Map();
				r.on.getInspectorState(async (n) => {
					if (n.app === e && n.inspectorId === "vue-i18n-resource-inspector") if (r.unhighlightElement(), xi(n, t), n.nodeId === "global") {
						if (!i.has(n.app)) {
					...
					label: ai["vue-i18n-timeline"],
					color: si["vue-i18n-timeline"]
				}), n(!0);
			});
		} catch (e) {
			console.error(e), r(!1);
...
function pi(e) {
	...
	return Object.keys(e).forEach((n) => {
		let r = e[n];
		R(r) && "source" in r ? t[n] = _i(r) : q(r) && r.loc && r.loc.source ? t[n] = r.loc.source : V(r) ? t[n] = pi(r) : t[n] = r;
	}), t;
}
var mi = {
	"<": "&lt;",
...
var Oi = l({
	...
	setup(e, t) {
		let { slots: n, attrs: r } = t, i = e.i18n || zi({
			useScope: e.scope,
			__useComponent: !0
		});
		return () => {
			...
			let s = Ei(t, a), c = i[Fr](e.keypath, s, o), l = P(F(), r);
			return p(z(e.tag) || V(e.tag) ? e.tag : Di(), l, c);
		};
	}
});
function ki(e) {
...
function Ai(e, t, n, r) {
	...
	return () => {
		...
		L(s) ? c = s.map((e, t) => {
			...
			return ki(r) && (r[0].key = `${e.type}-${t}`), r;
		}) : z(s) && (c = [s]);
		let l = P(F(), a);
		return p(z(e.tag) || V(e.tag) ? e.tag : Di(), l, c);
	};
...
function Ni(e) {
	let t = (t) => {
		process.env.NODE_ENV !== "production" && k(Wr($.DEPRECATE_TRANSLATE_CUSTOME_DIRECTIVE));
		let { instance: n, value: r } = t;
		if (!n || !n.$) throw Q(Z.UNEXPECTED_ERROR);
		let i = Mi(e, n.$), a = Pi(r);
		return [Reflect.apply(i.t, i, [...Fi(a)]), i];
	};
	return {
		created: (e, n) => {
			let [r, i] = t(n);
			A && (e.__i18nWatcher = ee(i.locale, () => {
		...
		beforeUpdate: (e, { value: t }) => {
			if (e.__composer) {
				let n = e.__composer, r = Pi(t);
				e.textContent = Reflect.apply(n.t, n, [...Fi(r)]);
			}
		},
		getSSRProps: (e) => {
			let [n] = t(e);
...
function Ii(e, t, ...n) {
	let r = H(n[0]) ? n[0] : {};
	(!B(r.globalInstall) || r.globalInstall) && ([Oi.name, "I18nT"].forEach((t) => e.component(t, Oi)), [ji.name, "I18nN"].forEach((t) => e.component(t, ji)), [Xi.name, "I18nD"].forEach((t) => e.component(t, Xi))), e.directive("t", Ni(t));
}
var Li = M("global-vue-i18n");
function Ri(e = {}) {
	process.env.NODE_ENV;
	let t = B(e.globalInjection) ? e.globalInjection : !0, n = /* @__PURE__ */ new Map(), [r, i] = Bi(e, !1), a = M(process.env.NODE_ENV === "production" ? "" : "vue-i18n");
	function o(e) {
		return n.get(e) || null;
	}
	function s(e, t) {
	...
	let l = {
		...
		async install(e, ...n) {
			...
			let r = null;
			t && (r = Yi(e, l.global)), Ii(e, l, ...n);
			let o = e.unmount;
			if (e.unmount = () => {
				r && r(), l.dispose(), o();
			}, process.env.NODE_ENV !== "production") {
				if (!await li(e, l)) throw Q(Z.CANNOT_SETUP_VUE_DEVTOOLS_PLUGIN);
				let t = Me();
				{
					let e = i;
					e[Rr] && e[Rr](t);
...
function zi(e = {}) {
	...
	let n = Vi(t), r = Ui(n), i = qr(t), a = Hi(e, i);
	if (a === "global") return Jr(r, e, i), r;
	if (a === "parent") {
		let i = Wi(n, t, e.__useComponent);
		return i ??= (process.env.NODE_ENV !== "production" && O(Wr($.NOT_FOUND_PARENT_SCOPE)), r), i;
	}
	if (a === "isolated") {
	...
	if (s == null) {
		let n = P({}, e);
		"__i18n" in i && (n.__i18n = i.__i18n), r && (n.__root = r), s = ri(n), o.__composerExtend && (s[Hr] = o.__composerExtend(s)), Ki(o, t, s), o.__setInstance(t, s);
	} else process.env.NODE_ENV !== "production" && a === "local" && O(Wr($.DUPLICATE_USE_I18N_CALLING));
	return s;
}
function Bi(e, t) {
	let n = u(), r = n.run(() => ri(e));
	if (r == null) throw Q(Z.UNEXPECTED_ERROR);
	return [n, r];
}
function Vi(e) {
	let t = m(e.isCE ? Li : e.appContext.app.__VUE_I18N_SYMBOL__);
	if (!t) throw Q(e.isCE ? Z.NOT_INSTALLED_WITH_PROVIDE : Z.UNEXPECTED_ERROR);
	return t;
}
function Hi(e, t) {
	return ve(e) ? "__i18n" in t ? "local" : "global" : e.useScope ? e.useScope : "local";
}
function Ui(e) {
	return e.mode === "composition" ? e.global : e.global.__composer;
}
function Wi(e, t, n = !1) {
	let r = null, i = t.root, a = Gi(t, n);
	for (; a != null;) {
		let t = e;
...
function Ki(e, t, n) {
	...
	g(() => {
		if (process.env.NODE_ENV !== "production") {
			t.__VUE_I18N__ = n, r = Me();
			let e = n;
			e[Rr] && e[Rr](r), r.on("*", Ci);
		}
	}, t), v(() => {
		let i = n;
		process.env.NODE_ENV !== "production" && (r && r.off("*", Ci), i[zr] && i[zr](), delete t.__VUE_I18N__), e.__deleteInstance(t);
		let a = i[Hr];
		a && (a(), delete i[Hr]);
	}, t);
}
...
var Xi = l({
	...
	setup(e, t) {
		...
		return Ai(e, t, Zn, (...e) => n[Ir](...e));
	}
});
if (On(Jt), An(bn), Mn(sn), process.env.NODE_ENV !== "production") {
	let e = xe();
...
var Zi = l({
	...
	setup(e, { expose: t }) {
		t();
		let { t: n } = zi(), i = D(), a = r(() => i.params.locale || "en"), o = {
			t: n,
			route: i,
			currentLocale: a,
			footerLinks: r(() => [
	...
	return n;
}, $i = { class: "mt-20 border-t border-border bg-card" }, ea = { class: "container py-8" }, ta = { class: "grid gap-8 md:grid-cols-3" }, na = { class: "mb-2 text-sm font-semibold text-foreground" }, ra = { class: "text-sm text-muted-foreground" }, ia = { class: "mb-2 text-sm font-semibold text-foreground" }, aa = { class: "space-y-1" }, oa = ["href"], sa = { class: "mb-2 text-sm font-semibold text-foreground" }, ca = { class: "text-sm text-muted-foreground" }, la = { class: "mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground" };
function ua(e, n, r, c, l, u) {
	let d = C("router-link");
	return y(), a("footer", $i, [o("div", ea, [o("div", ta, [
		o("div", null, [o("h3", na, T(c.t("footer.title")), 1), o("p", ra, T(c.t("footer.description")), 1)]),
		o("div", null, [o("h3", ia, T(c.t("footer.resources")), 1), o("ul", aa, [(y(!0), a(t, null, x(c.footerLinks, (e) => (y(), a("li", { key: e.label }, [e.isInternal ? (y(), i(d, {
			key: 0,
			to: e.to,
			class: "text-sm text-muted-foreground hover:text-foreground transition-colors"
		}, {
			default: E(() => [s(T(e.label), 1)]),
			_: 2
		}, 1032, ["to"])) : (y(), a("a", {
			key: 1,
			href: e.href,
		...
		o("div", null, [o("h3", sa, T(c.t("footer.contact")), 1), o("p", ca, T(c.t("shared.contactEmail")), 1)])
	]), o("div", la, T(c.t("footer.builtWith")), 1)])]);
}
var da = Qi(Zi, [["render", ua], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/Footer.vue"]]), fa = Ri({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
	...
	setup(e, { expose: t }) {
		t();
		let n = d()?.appContext.app;
		n && !n.config.globalProperties.$i18n && n.use(fa);
		let r = { app: n };
...
var ha = Qi(pa, [["render", ma], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/scripts/Wrapper.vue"]]), ga = { render() {
	return p(ha, {}, { default: () => p(da) });
} };
