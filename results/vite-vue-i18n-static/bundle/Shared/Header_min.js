...
var ue = /\{([0-9a-zA-Z]+)\}/g;
function de(e, ...t) {
	return t.length === 1 && B(t[0]) && (t = t[0]), (!t || !t.hasOwnProperty) && (t = {}), e.replace(ue, (e, n) => t.hasOwnProperty(n) ? t[n] : "");
}
var j = (e, t = !1) => t ? Symbol.for(e) : Symbol(e), fe = (e, t, n) => pe({
	l: e,
	k: t,
	s: n
}), pe = (e) => JSON.stringify(e).replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029").replace(/\u0027/g, "\\u0027"), M = (e) => typeof e == "number" && isFinite(e), me = (e) => Ee(e) === "[object Date]", he = (e) => Ee(e) === "[object RegExp]", ge = (e) => V(e) && Object.keys(e).length === 0, N = Object.assign, _e = Object.create, P = (e = null) => _e(e), ve, ye = () => ve ||= typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : P();
function be(e) {
...
function Se(e) {
	return e = e.replace(/(\w+)\s*=\s*"([^"]*)"/g, (e, t, n) => `${t}="${xe(n)}"`), e = e.replace(/(\w+)\s*=\s*'([^']*)'/g, (e, t, n) => `${t}='${xe(n)}'`), /\s*on\w+\s*=\s*["']?[^"'>]+["']?/gi.test(e) && (process.env.NODE_ENV !== "production" && O("Potentially dangerous event handlers detected in translation. Consider removing onclick, onerror, etc. from your translation messages."), e = e.replace(/(\s+)(on)(\w+\s*=)/gi, "$1&#111;n$3")), [/(\s+(?:href|src|action|formaction)\s*=\s*["']?)\s*javascript:/gi, /(style\s*=\s*["'][^"']*url\s*\(\s*)javascript:/gi].forEach((t) => {
...
var I = Array.isArray, L = (e) => typeof e == "function", R = (e) => typeof e == "string", z = (e) => typeof e == "boolean", B = (e) => typeof e == "object" && !!e, we = (e) => B(e) && L(e.then) && L(e.catch), Te = Object.prototype.toString, Ee = (e) => Te.call(e), V = (e) => Ee(e) === "[object Object]", De = (e) => e == null ? "" : I(e) || V(e) && e.toString === Te ? JSON.stringify(e, null, 2) : String(e);
function Oe(e, t = "") {
	return e.reduce((e, n, r) => r === 0 ? e + n : e + t + n, "");
}
var ke = 2;
function Ae(e, t = 0, n = e.length) {
	let r = e.split(/\r?\n/), i = 0, a = [];
	for (let e = 0; e < r.length; e++) if (i += r[e].length + 1, i >= t) {
		for (let o = e - ke; o <= e + ke || n > i; o++) {
...
var H = (e) => !B(e) || I(e);
function Me(e, t) {
	if (H(e) || H(t)) throw Error("Invalid value");
	let n = [{
		src: e,
		des: t
	}];
	for (; n.length;) {
		...
		Object.keys(e).forEach((r) => {
			r !== "__proto__" && (B(e[r]) && !B(t[r]) && (t[r] = Array.isArray(e[r]) ? [] : P()), H(t[r]) || H(e[r]) ? t[r] = e[r] : n.push({
				src: e[r],
				des: t[r]
			}));
		});
...
function Ie(e, t, n = {}) {
	let { domain: r, messages: i, args: a } = n, o = process.env.NODE_ENV === "production" ? e : de((i || Fe)[e] || "", ...a || []), s = SyntaxError(String(o));
	return s.code = e, t && (s.location = t), s.domain = r, s;
}
function Le(e) {
	throw e;
}
var Re = /<\/?[\w\s="/.':;#-\/]+>/, ze = (e) => Re.test(e), W = " ", Be = "\r", G = "\n", Ve = "\u2028", He = "\u2029";
function Ue(e) {
	let t = e, n = 0, r = 1, i = 1, a = 0, o = (e) => t[e] === Be && t[e + 1] === G, s = (e) => t[e] === G, c = (e) => t[e] === He, l = (e) => t[e] === Ve, u = (e) => o(e) || s(e) || c(e) || l(e), d = () => n, f = () => r, p = () => i, m = () => a, h = (e) => o(e) || c(e) || l(e) ? G : t[e], g = () => h(n), _ = () => h(n + a);
	function v() {
...
var We = void 0, Ge = "'", Ke = "tokenizer";
function qe(e, t = {}) {
	let n = t.location !== !1, r = Ue(e), i = () => r.index(), a = () => Ne(r.line(), r.column(), r.index()), o = a(), s = i(), c = {
		currentType: 13,
		offset: s,
		startLoc: o,
		endLoc: o,
	...
	function d(e, t, r, ...i) {
		...
		if (t.column += r, t.offset += r, u) {
			let r = Ie(e, n ? Pe(a.startLoc, t) : null, {
				domain: Ke,
				args: i
			});
			u(r);
	...
	function f(e, t, r) {
		...
		let i = { type: t };
		return n && (i.loc = Pe(e.startLoc, e.endLoc)), r != null && (i.value = r), i;
	}
	let p = (e) => f(e, 13);
	function m(e, t) {
	...
	function E(e, t) {
		let n = e.currentChar();
		if (n !== We) return t(n) ? (e.next(), n) : null;
	}
	function D(e) {
		let t = e.charCodeAt(0);
	...
	function A(e) {
		...
		for (; t = ie(e);) n += t;
		let r = e.currentChar();
		if (r && r !== "}" && r !== We && r !== W && r !== G && r !== "　") {
			let t = M(e);
			return d(U.INVALID_TOKEN_IN_PLACEHOLDER, a(), 0, n + t), n + t;
		}
		return e.currentChar() === We && d(U.UNTERMINATED_CLOSING_BRACE, a(), 0), n;
	}
	function le(e) {
		g(e);
		let t = "";
		return e.currentChar() === "-" ? (e.next(), t += `-${ce(e)}`) : t += ce(e), e.currentChar() === We && d(U.UNTERMINATED_CLOSING_BRACE, a(), 0), t;
	}
	function ue(e) {
		return e !== Ge && e !== G;
	}
	function de(e) {
		g(e), m(e, "'");
		let t = "", n = "";
		for (; t = E(e, ue);) n += t === "\\" ? j(e) : t;
		let r = e.currentChar();
		return r === G || r === We ? (d(U.UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER, a(), 0), r === G && (e.next(), m(e, "'")), n) : (m(e, "'"), n);
	}
	function j(e) {
		let t = e.currentChar();
		switch (t) {
	...
	function N(e, t) {
		...
		switch (e.currentChar()) {
			...
			case "@": return t.braceNest > 0 && d(U.UNTERMINATED_CLOSING_BRACE, a(), 0), n = _e(e, t) || p(t), t.braceNest = 0, n;
			default: {
				let r = !0, i = !0, o = !0;
				if (ee(e)) return t.braceNest > 0 && d(U.UNTERMINATED_CLOSING_BRACE, a(), 0), n = f(t, 1, ge(e)), t.braceNest = 0, t.inLinked = !1, n;
				if (t.braceNest > 0 && (t.currentType === 4 || t.currentType === 5 || t.currentType === 6)) return d(U.UNTERMINATED_CLOSING_BRACE, a(), 0), t.braceNest = 0, P(e, t);
				if (r = y(e, t)) return n = f(t, 4, A(e)), g(e), n;
				if (i = b(e, t)) return n = f(t, 5, le(e)), g(e), n;
				if (o = x(e, t)) return n = f(t, 6, de(e)), g(e), n;
				if (!r && !i && !o) return n = f(t, 12, M(e)), d(U.INVALID_TOKEN_IN_PLACEHOLDER, a(), 0, n.value), g(e), n;
				break;
			}
		}
		return n;
	...
	function _e(e, t) {
		...
		switch ((n === 7 || n === 8 || n === 11 || n === 9) && (i === G || i === W) && d(U.INVALID_LINKED_FORMAT, a(), 0), i) {
			...
			default: return ee(e) ? (r = f(t, 1, ge(e)), t.braceNest = 0, t.inLinked = !1, r) : S(e, t) || w(e, t) ? (g(e), _e(e, t)) : C(e, t) ? (g(e), f(t, 11, me(e))) : T(e, t) ? (g(e), i === "{" ? N(e, t) || r : f(t, 10, he(e))) : (n === 7 && d(U.INVALID_LINKED_FORMAT, a(), 0), t.braceNest = 0, t.inLinked = !1, P(e, t));
		}
	}
	function P(e, t) {
		let n = { type: 13 };
		if (t.braceNest > 0) return N(e, t) || p(t);
		if (t.inLinked) return _e(e, t) || p(t);
		switch (e.currentChar()) {
			case "{": return N(e, t) || p(t);
			...
			default:
				...
				if (te(e)) return f(t, 0, k(e));
		}
		return n;
	}
	function ve() {
		let { currentType: e, offset: t, startLoc: n, endLoc: o } = c;
		return c.lastType = e, c.lastOffset = t, c.lastStartLoc = n, c.lastEndLoc = o, c.offset = i(), c.startLoc = a(), r.currentChar() === We ? f(c, 13) : P(r, c);
	}
	return {
		nextToken: ve,
		currentOffset: i,
...
var Je = "parser", Ye = /(?:\\\\|\\'|\\u([0-9a-fA-F]{4})|\\U([0-9a-fA-F]{6}))/g, Xe = /\\([\\@{}|])/g;
function Ze(e, t) {
	return t;
}
function Qe(e, t, n) {
...
function $e(e = {}) {
	...
	function o(e, t) {
		...
		return r.value = t.replace(Xe, Ze), a(r, e.currentOffset(), e.currentPosition()), r;
	}
	function s(e, t) {
	...
	function l(e, t) {
		...
		return o.value = t.replace(Ye, Qe), e.nextToken(), a(o, e.currentOffset(), e.currentPosition()), o;
	}
	function u(e) {
	...
	function g(n) {
		let o = qe(n, N({}, e)), s = o.context(), c = i(0, s.offset, s.startLoc);
...
function it(e) {
	let t = e.body;
	return t.type === 2 ? at(t) : t.cases.forEach((e) => at(e)), e;
}
function at(e) {
	if (e.items.length === 1) {
		let t = e.items[0];
...
function st(e) {
	switch (e.t = e.type, e.type) {
		...
		case 1: {
			let t = e, n = t.cases;
			for (let e = 0; e < n.length; e++) st(n[e]);
		...
		default: if (process.env.NODE_ENV !== "production") throw Ie(U.UNHANDLED_MINIFIER_NODE_TYPE, null, {
			domain: ot,
			args: [e.type]
		});
	}
...
function ut(e, t) {
	let { helper: n } = e;
	e.push(`${n("linked")}(`), mt(e, t.key), t.modifier ? (e.push(", "), mt(e, t.modifier), e.push(", _type")) : e.push(", undefined, _type"), e.push(")");
}
function dt(e, t) {
	let { helper: n, needIndent: r } = e;
	e.push(`${n("normalize")}([`), e.indent(r());
	let i = t.items.length;
	for (let n = 0; n < i && (mt(e, t.items[n]), n !== i - 1); n++) e.push(", ");
	e.deindent(r()), e.push("])");
}
function ft(e, t) {
	let { helper: n, needIndent: r } = e;
	if (t.cases.length > 1) {
		...
		for (let n = 0; n < i && (mt(e, t.cases[n]), n !== i - 1); n++) e.push(", ");
		e.deindent(r()), e.push("])");
	}
}
function pt(e, t) {
	t.body ? mt(e, t.body) : e.push("null");
}
function mt(e, t) {
	let { helper: n } = e;
	switch (t.type) {
		...
		case 3:
			e.push(JSON.stringify(t.value), t);
			break;
		default: if (process.env.NODE_ENV !== "production") throw Ie(U.UNHANDLED_CODEGEN_NODE_TYPE, null, {
			domain: ct,
			args: [t.type]
		});
	}
...
var ht = (e, t = {}) => {
	...
	c.push(n === "normal" ? "function __msg__ (ctx) {" : "(ctx) => {"), c.indent(o), s.length > 0 && (c.push(`const { ${Oe(s.map((e) => `${e}: _${e}`), ", ")} } = ctx`), c.newline()), c.push("return "), mt(c, e), c.deindent(o), c.push("}"), delete e.helpers;
...
function gt(e, t = {}) {
	let n = N({}, t), r = !!n.jit, i = !!n.minify, a = n.optimize == null || n.optimize, o = $e(n).parse(e);
	return r ? (a && it(o), i && st(o), {
		ast: o,
		code: ""
	}) : (rt(o, n), ht(o, n));
}
function q(e) {
	return B(e) && Et(e) === 0 && (F(e, "b") || F(e, "body"));
}
var _t = ["b", "body"];
function vt(e) {
	return Nt(e, _t);
...
function Lt(e, t) {
	let n = vt(t);
	if (n == null) throw Ft(0);
	if (Et(n) === 1) {
		let t = bt(n);
		return e.plural(t.reduce((t, n) => [...t, Rt(e, n)], []));
	}
	return Rt(e, n);
}
function Rt(e, t) {
	...
	{
		let n = wt(t).reduce((t, n) => [...t, zt(e, n)], []);
...
function zt(e, t) {
	let n = Et(t);
	switch (n) {
		case 3: return Ot(t, n);
		case 9: return Ot(t, n);
		case 4: {
			let r = t;
		...
		case 6: {
			let n = t, r = At(n), i = Mt(n);
			return e.linked(zt(e, i), r ? zt(e, r) : void 0, e.type);
		}
		case 7: return Ot(t, n);
		case 8: return Ot(t, n);
		default: throw Error(`unhandled node on format message part: ${n}`);
	}
}
var Bt = "Detected HTML in '{source}' message. Recommend not using HTML messages to avoid XSS.";
function Vt(e, t) {
	t && ze(e) && O(de(Bt, { source: e }));
}
var Ht = (e) => e, Ut = P();
function Wt(e, t = {}) {
	let n = !1, r = t.onError || Le;
	return t.onError = (e) => {
		n = !0, r(e);
	}, {
		...gt(e, t),
...
function Gt(e, t) {
	if (R(e)) {
		...
		process.env.NODE_ENV !== "production" && Vt(e, n);
		let r = (t.onCacheKey || Ht)(e), i = Ut[r];
		if (i) return i;
		let { ast: a, detectError: o } = Wt(e, {
			...t,
...
function Zt(e) {
	return Ie(e, null, process.env.NODE_ENV === "production" ? void 0 : { messages: Qt });
}
var Qt = {
...
function $t(e, t) {
	return t.locale == null ? tn(e.locale) : tn(t.locale);
}
var en;
function tn(e) {
	if (R(e)) return e;
	if (L(e)) {
		if (e.resolvedOnce && en != null) return en;
		if (e.constructor.name === "Function") {
			let t = e();
			if (we(t)) throw Zt(J.NOT_SUPPORT_LOCALE_PROMISE_VALUE);
			return en = t;
		}
		throw Zt(J.NOT_SUPPORT_LOCALE_ASYNC_FUNCTION);
	}
	throw Zt(J.NOT_SUPPORT_LOCALE_TYPE);
}
function nn(e, t, n) {
...
function rn(e, t, n) {
	...
	if (!a) {
		...
		e = R(o) ? [o] : o, I(e) && an(a, e, !1), i.__localeChainCache.set(r, a);
	}
	return a;
}
function an(e, t, n) {
...
function pn(e) {
	let t = e.trim();
	return e.charAt(0) === "0" && isNaN(parseInt(e)) ? !1 : un(t) ? dn(t) : "*" + t;
}
function mn(e) {
	...
	f[0] = () => {
		...
		if (i > 0) i--, r = 4, f[0]();
			...
			if (i = 0, o === void 0 || (o = pn(o), o === !1)) return !1;
			f[1]();
		}
	};
	function p() {
	...
	for (; r !== null;) if (n++, a = e[n], !(a === "\\" && p())) {
		if (c = fn(a), d = cn[r], l = d[c] || d.l || 8, l === 8 || (r = l[0], l[1] !== void 0 && (u = f[l[1]], u && (s = a, u() === !1)))) return;
		if (r === 7) return t;
	}
}
...
function _n(e, t) {
	if (!B(e)) return null;
	let n = hn.get(t);
	if (n || (n = mn(t), n && hn.set(t, n)), !n) return null;
	let r = n.length, i = e, a = 0;
	for (; a < r;) {
		let e = n[a];
		if (Pt.includes(e) && q(i) || !B(i) || !F(i, e)) return null;
		let t = i[e];
...
var bn = "11.4.0", xn = "en-US", Sn = (e) => `${e.charAt(0).toLocaleUpperCase()}${e.substr(1)}`;
function Cn() {
	return {
		...
		capitalize: (e, t) => t === "text" && R(e) ? Sn(e) : t === "vnode" && B(e) && "__v_isVNode" in e ? Sn(e.children) : e
	};
}
var wn;
function Tn(e) {
...
function Ln(e = {}) {
	let t = L(e.onWarn) ? e.onWarn : O, n = R(e.version) ? e.version : bn, r = R(e.locale) || L(e.locale) ? e.locale : xn, i = L(r) ? xn : r, a = I(e.fallbackLocale) || V(e.fallbackLocale) || R(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : i, o = V(e.messages) ? e.messages : Rn(i), s = V(e.datetimeFormats) ? e.datetimeFormats : Rn(i), c = V(e.numberFormats) ? e.numberFormats : Rn(i), l = N(P(), e.modifiers, Cn()), u = e.pluralRules || P(), d = L(e.missing) ? e.missing : null, f = z(e.missingWarn) || he(e.missingWarn) ? e.missingWarn : !0, p = z(e.fallbackWarn) || he(e.fallbackWarn) ? e.fallbackWarn : !0, m = !!e.fallbackFormat, h = !!e.unresolving, g = L(e.postTranslation) ? e.postTranslation : null, _ = V(e.processor) ? e.processor : null, v = !z(e.warnHtmlMessage) || e.warnHtmlMessage, y = !!e.escapeParameter, b = L(e.messageCompiler) ? e.messageCompiler : wn;
	process.env.NODE_ENV !== "production" && L(e.messageCompiler) && ce(yn(Y.EXPERIMENTAL_CUSTOM_MESSAGE_COMPILER));
	let x = L(e.messageResolver) ? e.messageResolver : En || gn, S = L(e.localeFallbacker) ? e.localeFallbacker : On || nn, C = B(e.fallbackContext) ? e.fallbackContext : void 0, w = e, T = B(w.__datetimeFormatters) ? w.__datetimeFormatters : /* @__PURE__ */ new Map(), ee = B(w.__numberFormatters) ? w.__numberFormatters : /* @__PURE__ */ new Map(), te = B(w.__meta) ? w.__meta : {};
	In++;
	let E = {
		version: n,
		cid: In,
	...
	return E.datetimeFormats = s, E.numberFormats = c, E.__datetimeFormatters = T, E.__numberFormatters = ee, process.env.NODE_ENV !== "production" && (E.__v_emitter = w.__v_emitter == null ? void 0 : w.__v_emitter), process.env.NODE_ENV !== "production" && Jt(E, n, te), E;
}
var Rn = (e) => ({ [e]: P() });
function zn(e, t) {
...
function Vn(e, t, n, r, i) {
	...
	return process.env.NODE_ENV !== "production" && Bn(r, t) && o(yn(Y.NOT_FOUND_KEY, {
		key: t,
		locale: n
	})), t;
}
...
function Wn(e, t) {
	let n = t.indexOf(e);
	if (n === -1) return !1;
	for (let r = n + 1; r < t.length; r++) if (Un(e, t[r])) return !0;
	return !1;
}
var Gn = typeof Intl < "u", Kn = {
	dateTimeFormat: Gn && Intl.DateTimeFormat !== void 0,
	numberFormat: Gn && Intl.NumberFormat !== void 0
};
function qn(e, ...t) {
	let { datetimeFormats: n, unresolving: r, fallbackLocale: i, onWarn: a, localeFallbacker: o } = e, { __datetimeFormatters: s } = e;
	if (process.env.NODE_ENV !== "production" && !Kn.dateTimeFormat) return a(yn(Y.CANNOT_FORMAT_DATE)), "";
	if (!R(t[0]) && !me(t[0]) && !M(t[0])) return process.env.NODE_ENV !== "production" && a(yn(Y.INVALID_DATE_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = Yn(...t), f = z(u.missingWarn) ? u.missingWarn : e.missingWarn, p = z(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = $t(e, u), g = o(e, i, h);
	if (!R(c) || c === "") return new Intl.DateTimeFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "datetime format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && zn(p, c) && a(yn(Y.FALLBACK_TO_DATE_FORMAT, {
			key: c,
			target: v
...
function Yn(...e) {
	...
	if (R(t)) {
		...
		if (!e) throw Zt(J.INVALID_ISO_DATE_ARGUMENT);
		let n = e[3] ? e[3].trim().startsWith("T") ? `${e[1].trim()}${e[3].trim()}` : `${e[1].trim()}T${e[3].trim()}` : e[1].trim();
		s = new Date(n);
		try {
			s.toISOString();
		} catch {
			throw Zt(J.INVALID_ISO_DATE_ARGUMENT);
		}
	} else if (me(t)) {
		if (isNaN(t.getTime())) throw Zt(J.INVALID_DATE_ARGUMENT);
		s = t;
	} else if (M(t)) s = t;
	else throw Zt(J.INVALID_ARGUMENT);
...
function Zn(e, ...t) {
	...
	if (process.env.NODE_ENV !== "production" && !Kn.numberFormat) return a(yn(Y.CANNOT_FORMAT_NUMBER)), "";
	if (!M(t[0])) return process.env.NODE_ENV !== "production" && a(yn(Y.INVALID_NUMBER_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = $n(...t), f = z(u.missingWarn) ? u.missingWarn : e.missingWarn, p = z(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = $t(e, u), g = o(e, i, h);
	if (!R(c) || c === "") return new Intl.NumberFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "number format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && zn(p, c) && a(yn(Y.FALLBACK_TO_NUMBER_FORMAT, {
			key: c,
			target: v
		})), process.env.NODE_ENV !== "production" && h !== v) {
			let t = e.__v_emitter;
...
function $n(...e) {
	...
	if (!M(t)) throw Zt(J.INVALID_ARGUMENT);
	let s = t;
	return R(n) ? a.key = n : V(n) && Object.keys(n).forEach((e) => {
...
var tr = (e) => e, nr = (e) => "", rr = "text", ir = (e) => e.length === 0 ? "" : Oe(e), ar = De;
function or(e, t) {
...
function cr(e = {}) {
	let t = e.locale, n = sr(e), r = R(t) && L(e.pluralRules?.[t]) ? e.pluralRules[t] : or, i = r === or ? void 0 : or, a = (e) => e[r(n, e.length, i)], o = e.list || [], s = (e) => o[e], c = e.named || P();
	M(e.pluralIndex) && (c.count ||= e.pluralIndex, c.n ||= e.pluralIndex);
	let l = (e) => c[e];
	function u(t, n) {
		return (L(e.messages) ? e.messages(t, !!n) : B(e.messages) ? e.messages[t] : !1) || (e.parent ? e.parent.message(t) : nr);
	}
	let d = (t) => e.modifiers ? e.modifiers[t] : tr, f = L(e.processor?.normalize) ? e.processor.normalize : ir, p = L(e.processor?.interpolate) ? e.processor.interpolate : ar, m = {
		list: s,
		named: l,
		plural: a,
		linked: (e, ...t) => {
		...
		message: u,
		type: R(e.processor?.type) ? e.processor.type : rr,
		interpolate: p,
		normalize: f,
		values: N(P(), o, c)
	};
...
var lr = () => "", X = (e) => L(e);
function ur(e, ...t) {
	let { fallbackFormat: n, postTranslation: r, unresolving: i, messageCompiler: a, fallbackLocale: o, messages: s } = e, [c, l] = hr(...t), u = z(l.missingWarn) ? l.missingWarn : e.missingWarn, d = z(l.fallbackWarn) ? l.fallbackWarn : e.fallbackWarn, f = z(l.escapeParameter) ? l.escapeParameter : e.escapeParameter, p = !!l.resolvedMessage, m = R(l.default) || z(l.default) ? z(l.default) ? a ? c : () => c : l.default : n ? a ? c : () => c : null, h = n || m != null && (R(m) || L(m)), g = $t(e, l);
	f && dr(l);
	let [_, v, y] = p ? [
		c,
		g,
		s[g] || P()
	] : fr(e, c, g, o, d, u), b = _, x = c;
	...
	let S = !1, C = X(b) ? b : pr(e, c, v, b, x, () => {
		S = !0;
	});
	if (S) return b;
	let w = mr(e, C, cr(vr(e, v, y, l))), T = r ? r(w, c) : w;
	if (f && R(T) && (T = Se(T)), process.env.NODE_ENV !== "production") {
		let t = {
			timestamp: Date.now(),
			key: R(c) ? c : X(b) ? b.key : "",
		...
		t.meta = N({}, e.__meta, Mn() || {}), Yt(t);
	}
	return T;
}
function dr(e) {
	I(e.list) ? e.list = e.list.map((e) => R(e) ? be(e) : e) : B(e.named) && Object.keys(e.named).forEach((t) => {
		R(e.named[t]) && (e.named[t] = be(e.named[t]));
	});
}
function fr(e, t, n, r, i, a) {
	...
	for (let r = 0; r < u.length; r++) {
		f = h = u[r], process.env.NODE_ENV !== "production" && n !== f && !Un(n, f) && zn(i, t) && s(yn(Y.FALLBACK_TO_TRANSLATE, {
			key: t,
			target: f
		}));
		...
		if (process.env.NODE_ENV !== "production" && k && l && (_ = window.performance.now(), v = "intlify-message-resolve-start", y = "intlify-message-resolve-end", A && A(v)), (p = c(d, t)) === null && (p = d[t]), process.env.NODE_ENV !== "production" && k && l) {
			...
			l && _ && p && l.emit("message-resolve", {
				...
				time: e - _,
				groupId: `${g}:${t}`
			}), v && y && A && le && (A(y), le("intlify message resolve", v, y));
		}
...
function pr(e, t, n, r, i, a) {
	...
	if (process.env.NODE_ENV !== "production" && k && c) {
		...
		c && l && c.emit("message-compilation", {
			...
			time: e - l,
			groupId: `translate:${t}`
		}), u && d && A && le && (A(d), le("intlify message compilation", u, d));
	}
...
function mr(e, t, n) {
	...
	if (process.env.NODE_ENV !== "production" && k && r) {
		...
		}), a && o && A && le && (A(o), le("intlify message evaluation", a, o));
	}
	return s;
}
function hr(...e) {
	let [t, n, r] = e, i = P();
	if (!R(t) && !M(t) && !X(t) && !q(t)) throw Zt(J.INVALID_ARGUMENT);
	let a = M(t) ? String(t) : (X(t), t);
	return M(n) ? i.plural = n : R(n) ? i.default = n : V(n) && !ge(n) ? i.named = n : I(n) && (i.list = n), M(r) ? i.plural = r : R(r) ? i.default = r : V(r) && N(i, r), [a, i];
}
	...
	return {
		...
		onError: (t) => {
			if (a && a(t), process.env.NODE_ENV !== "production") {
				let i = _r(r), a = t.location && i && Ae(i, t.location.start.offset, t.location.end.offset), o = e.__v_emitter;
...
function vr(e, t, n, r) {
	let { modifiers: i, pluralRules: a, messageResolver: o, fallbackLocale: s, fallbackWarn: c, missingWarn: l, fallbackContext: u } = e, d = {
		...
		messages: (r, i) => {
			let a = o(n, r);
			if (a == null && (u || i)) {
				let [n, , i] = fr(u || e, r, t, s, c, l);
				a = n ?? o(i, r);
			}
			if (R(a) || q(a)) {
				let n = !1, i = pr(e, r, t, a, r, () => {
					n = !0;
				});
				return n ? lr : i;
			}
...
var xr = typeof Proxy == "function", Sr = "devtools-plugin:setup", Cr = "plugin:settings:set", wr, Tr;
function Er() {
	return wr === void 0 && (typeof window < "u" && window.performance ? (wr = !0, Tr = window.performance) : typeof globalThis < "u" && globalThis.perf_hooks?.performance ? (wr = !0, Tr = globalThis.perf_hooks.performance) : wr = !1), wr;
}
function Dr() {
	return Er() ? Tr.now() : Date.now();
}
var Or = class {
	constructor(e, t) {
...
function kr(e, t) {
	let n = e, r = br(), i = yr(), a = xr && n.enableEarlyProxy;
	if (i && (r.__VUE_DEVTOOLS_PLUGIN_API_AVAILABLE__ || !a)) i.emit(Sr, e, t);
	else {
		let e = a ? new Or(n, i) : null;
...
function Q(e, ...t) {
	return Ie(e, null, process.env.NODE_ENV === "production" ? void 0 : {
		messages: jr,
		args: t
	});
}
...
}, Mr = j("__translateVNode"), Nr = j("__datetimeParts"), Pr = j("__numberParts"), Fr = j("__enableEmitter"), Ir = j("__disableEmitter"), Lr = j("__setPluralRules");
j("__intlifyMeta");
var Rr = j("__injectWithOption"), zr = j("__dispose"), $ = {
	FALLBACK_TO_ROOT: 10,
...
function Hr(e) {
	...
	for (let t in e) if (F(e, t)) {
		if (!t.includes(".")) B(e[t]) && Hr(e[t]);
		else {
			let n = t.split("."), r = n.length - 1, i = e, a = !1;
			for (let e = 0; e < r; e++) {
				if (n[e] === "__proto__") throw Error(`unsafe key: ${n[e]}`);
				if (n[e] in i || (i[n[e]] = P()), !B(i[n[e]])) {
					process.env.NODE_ENV !== "production" && O(Vr($.IGNORE_OBJ_FLATTEN, { key: n[e] })), a = !0;
					break;
				}
				i = i[n[e]];
			}
			if (a || (q(i) ? Pt.includes(n[r]) || delete e[t] : (i[n[r]] = e[t], delete e[t])), !q(i)) {
				let e = i[n[r]];
				B(e) && Hr(e);
			}
		}
...
function Ur(e, t) {
	...
	if (I(r) && r.forEach((e) => {
		if ("locale" in e && "resource" in e) {
			...
			t ? (o[t] = o[t] || P(), Me(n, o[t])) : Me(n, o);
		} else R(e) && Me(JSON.parse(e), o);
	}), i == null && a) for (let e in o) F(o, e) && Hr(o[e]);
	return o;
}
function Wr(e) {
	return e.type;
...
var Jr = "__INTLIFY_META__", Yr = () => [], Xr = () => !1, Zr = 0;
function Qr(e) {
	return ((t, n, r, i) => e(n, r, qr() || void 0, i));
}
var $r = () => {
	let e = qr(), t = null;
	return e && (t = Wr(e)[Jr]) ? { [Jr]: t } : null;
};
function ei(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = k ? C : te, s = !z(e.inheritLocale) || e.inheritLocale, c = o(t && s ? t.locale.value : R(e.locale) ? e.locale : xn), l = o(t && s ? t.fallbackLocale.value : R(e.fallbackLocale) || I(e.fallbackLocale) || V(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(Ur(c.value, e)), d = o(V(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(V(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : z(e.missingWarn) || he(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : z(e.fallbackWarn) || he(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : !z(e.fallbackRoot) || e.fallbackRoot, g = !!e.fallbackFormat, _ = L(e.missing) ? e.missing : null, v = L(e.missing) ? Qr(e.missing) : null, y = L(e.postTranslation) ? e.postTranslation : null, b = t ? t.warnHtmlMessage : !z(e.warnHtmlMessage) || e.warnHtmlMessage, x = !!e.escapeParameter, S = t ? t.modifiers : V(e.modifiers) ? e.modifiers : {}, w = e.pluralRules || t && t.pluralRules, T;
	T = (() => {
		i && Pn(null);
		let t = {
			version: Ar,
	...
	let E = r({
		...
		get: () => l.value,
		set: (e) => {
			T.fallbackLocale = e, l.value = e, Hn(T, c.value, e);
		}
	...
	let ue = (e, n, r, a, o, s) => {
		...
		let c;
		try {
			process.env.NODE_ENV !== "production" && jn($r()), i || (T.fallbackContext = t ? Fn() : void 0), c = e(T);
		} finally {
			process.env.NODE_ENV !== "production" && jn(null), i || (T.fallbackContext = void 0);
		}
		if (r !== "translate exists" && M(c) && c === -1 || r === "translate exists" && !c) {
			let [e, i] = n();
			if (process.env.NODE_ENV !== "production" && t && R(e) && le(r, i) && (h && (zn(m, e) || Bn(p, e)) && O(Vr($.FALLBACK_TO_ROOT, {
				key: e,
				type: r
	...
	function de(...e) {
		return ue((t) => Reflect.apply(ur, null, [t, ...e]), () => hr(...e), "translate", (t) => Reflect.apply(t.t, t, [...e]), (e) => e, (e) => R(e));
	}
	function j(...e) {
		let [t, n, r] = e;
	...
	function fe(...e) {
		return ue((t) => Reflect.apply(qn, null, [t, ...e]), () => Yn(...e), "datetime format", (t) => Reflect.apply(t.d, t, [...e]), () => "", (e) => R(e) || I(e));
	}
	function pe(...e) {
		return ue((t) => Reflect.apply(Zn, null, [t, ...e]), () => $n(...e), "number format", (t) => Reflect.apply(t.n, t, [...e]), () => "", (e) => R(e) || I(e));
	}
	function me(e) {
		return e.map((e) => R(e) || M(e) || z(e) ? Kr(String(e)) : e);
	}
	let ge = {
		normalize: me,
		interpolate: (e) => e,
	...
	function _e(...e) {
		return ue((t) => {
			let n, r = t;
			try {
				r.processor = ge, n = Reflect.apply(ur, null, [r, ...e]);
			} finally {
				r.processor = null;
			}
			return n;
		}, () => hr(...e), "translate", (t) => t[Mr](...e), (e) => [Kr(e)], (e) => I(e));
	}
	function P(...e) {
		return ue((t) => Reflect.apply(Zn, null, [t, ...e]), () => $n(...e), "number format", (t) => t[Pr](...e), Yr, (e) => R(e) || I(e));
	}
	function ve(...e) {
		return ue((t) => Reflect.apply(qn, null, [t, ...e]), () => Yn(...e), "datetime format", (t) => t[Nr](...e), Yr, (e) => R(e) || I(e));
	}
	function ye(e) {
		w = e, T.pluralRules = w;
	}
	function be(e, t) {
		return ue(() => {
			if (!e) return !1;
			let n = R(t) ? t : c.value, r = R(t) ? [n] : rn(T, l.value, n);
			for (let t = 0; t < r.length; t++) {
				let n = Ce(r[t]), i = T.messageResolver(n, e);
				if (i === null && (i = n[e]), q(i) || X(i) || R(i)) return !0;
			}
			return !1;
		}, () => [e], "translate exists", (n) => Reflect.apply(n.te, n, [e, t]), Xr, (e) => z(e));
	}
	function xe(e) {
		let t = null, n = rn(T, l.value, c.value);
	...
	function Te(e, t) {
		u.value[e] = u.value[e] || {};
		let n = { [e]: t };
		if (a) for (let e in n) F(n, e) && Hr(n[e]);
		t = n[e], Me(t, u.value[e]), T.messages = u.value;
	}
	function Ee(e) {
		return d.value[e] || {};
	}
	function De(e, t) {
		d.value[e] = t, T.datetimeFormats = d.value, Xn(T, e, t);
	}
	function Oe(e, t) {
		d.value[e] = N(d.value[e] || {}, t), T.datetimeFormats = d.value, Xn(T, e, t);
	}
	function ke(e) {
		return f.value[e] || {};
	}
	function Ae(e, t) {
		f.value[e] = t, T.numberFormats = f.value, er(T, e, t);
	}
	function je(e, t) {
		f.value[e] = N(f.value[e] || {}, t), T.numberFormats = f.value, er(T, e, t);
	}
	Zr++, t && k && (ne(t.locale, (e) => {
		s && (c.value = e, T.locale = e, Hn(T, c.value, l.value));
	}), ne(t.fallbackLocale, (e) => {
		s && (l.value = e, T.fallbackLocale = e, Hn(T, c.value, l.value));
	}));
	let H = {
		id: Zr,
		locale: E,
		...
		set inheritLocale(e) {
			s = e, e && t && (c.value = t.locale.value, l.value = t.fallbackLocale.value, Hn(T, c.value, l.value));
		},
	...
	return H.datetimeFormats = ie, H.numberFormats = ae, H.rt = j, H.te = be, H.tm = Se, H.d = fe, H.n = pe, H.getDateTimeFormat = Ee, H.setDateTimeFormat = De, H.mergeDateTimeFormat = Oe, H.getNumberFormat = ke, H.setNumberFormat = Ae, H.mergeNumberFormat = je, H[Rr] = n, H[Mr] = _e, H[Nr] = ve, H[Pr] = P, process.env.NODE_ENV !== "production" && (H[Fr] = (e) => {
		T.__v_emitter = e;
	}, H[Ir] = () => {
		T.__v_emitter = void 0;
	}), H;
}
var ti = "vue-i18n: composer properties", ni = {
	"vue-devtools-plugin-vue-i18n": "Vue I18n DevTools",
	"vue-i18n-resource-inspector": "Vue I18n DevTools",
	"vue-i18n-timeline": "Vue I18n"
}, ri = { "vue-i18n-resource-inspector": "Search for scopes ..." }, ii = { "vue-i18n-timeline": 16764185 }, ai;
async function oi(e, t) {
	return new Promise((n, r) => {
		try {
			kr({
				id: "vue-devtools-plugin-vue-i18n",
				label: ni["vue-devtools-plugin-vue-i18n"],
				packageName: "vue-i18n",
				homepage: "https://vue-i18n.intlify.dev",
				logo: "https://vue-i18n.intlify.dev/vue-i18n-devtools-logo.png",
				componentStateTypes: [ti],
				app: e
			}, (r) => {
				ai = r, r.on.visitComponentTree(({ componentInstance: e, treeNode: n }) => {
					ci(e, n, t);
				}), r.on.inspectComponent(({ componentInstance: e, instanceData: n }) => {
					e.__VUE_I18N__ && n && (t.mode === "legacy" ? e.__VUE_I18N__ !== t.global.__composer && li(n, e.__VUE_I18N__) : li(n, e.__VUE_I18N__));
				}), r.addInspector({
					id: "vue-i18n-resource-inspector",
					label: ni["vue-i18n-resource-inspector"],
					icon: "language",
					treeFilterPlaceholder: ri["vue-i18n-resource-inspector"]
				}), r.on.getInspectorTree((n) => {
					n.app === e && n.inspectorId === "vue-i18n-resource-inspector" && hi(n, t);
				});
				let i = /* @__PURE__ */ new Map();
				r.on.getInspectorState(async (n) => {
					if (n.app === e && n.inspectorId === "vue-i18n-resource-inspector") {
						if (r.unhighlightElement(), vi(n, t), n.nodeId === "global") {
							if (!i.has(n.app)) {
					...
					n.app === e && n.inspectorId === "vue-i18n-resource-inspector" && xi(n, t);
				}), r.addTimelineLayer({
					id: "vue-i18n-timeline",
					label: ni["vue-i18n-timeline"],
					color: ii["vue-i18n-timeline"]
				}), n(!0);
			});
		} catch (e) {
			console.error(e), r(!1);
...
function ui(e) {
	...
	return Object.keys(e).forEach((n) => {
		let r = e[n];
		L(r) && "source" in r ? t[n] = mi(r) : q(r) && r.loc && r.loc.source ? t[n] = r.loc.source : B(r) ? t[n] = ui(r) : t[n] = r;
	}), t;
}
var di = {
	"<": "&lt;",
...
function mi(e) {
	return { _custom: {
		type: "function",
		display: `<span>ƒ</span> ${e.source ? `("${fi(e.source)}")` : "(?)"}`
	} };
}
function hi(e, t) {
	e.rootNodes.push({
...
var Ti = u({
	...
	setup(e, t) {
		let { slots: n, attrs: r } = t, i = e.i18n || Ii({
			useScope: e.scope,
			__useComponent: !0
		});
		return () => {
			...
			let s = Ci(t, a), c = i[Mr](e.keypath, s, o), l = N(P(), r), u = R(e.tag) || B(e.tag) ? e.tag : wi();
			return m(u, l, c);
		};
	}
});
...
function Di(e, t, n, r) {
	...
	return () => {
		...
		I(s) ? c = s.map((e, t) => {
			...
			return Ei(r) && (r[0].key = `${e.type}-${t}`), r;
		}) : R(s) && (c = [s]);
		let l = N(P(), a), u = R(e.tag) || B(e.tag) ? e.tag : wi();
		return m(u, l, c);
	};
}
var Oi = u({
...
function Ai(e) {
	let t = (t) => {
		process.env.NODE_ENV !== "production" && ce(Vr($.DEPRECATE_TRANSLATE_CUSTOME_DIRECTIVE));
		let { instance: n, value: r } = t;
		if (!n || !n.$) throw Q(Z.UNEXPECTED_ERROR);
		let i = ki(e, n.$), a = ji(r);
		return [Reflect.apply(i.t, i, [...Mi(a)]), i];
	};
	return {
		created: (e, n) => {
			let [r, i] = t(n);
			k && (e.__i18nWatcher = ne(i.locale, () => {
		...
		beforeUpdate: (e, { value: t }) => {
			if (e.__composer) {
				let n = e.__composer, r = ji(t);
				e.textContent = Reflect.apply(n.t, n, [...Mi(r)]);
			}
		},
		getSSRProps: (e) => {
			let [n] = t(e);
...
function Ni(e, t, ...n) {
	let r = V(n[0]) ? n[0] : {};
	(!z(r.globalInstall) || r.globalInstall) && ([Ti.name, "I18nT"].forEach((t) => e.component(t, Ti)), [Oi.name, "I18nN"].forEach((t) => e.component(t, Oi)), [qi.name, "I18nD"].forEach((t) => e.component(t, qi))), e.directive("t", Ai(t));
}
var Pi = j("global-vue-i18n");
function Fi(e = {}) {
	process.env.NODE_ENV;
	let t = !z(e.globalInjection) || e.globalInjection, n = /* @__PURE__ */ new Map(), [r, i] = Li(e, !1), a = j(process.env.NODE_ENV === "production" ? "" : "vue-i18n");
	function o(e) {
		return n.get(e) || null;
	}
	function s(e, t) {
	...
	let l = {
		...
		async install(e, ...n) {
			...
			let r = null;
			t && (r = Ki(e, l.global)), Ni(e, l, ...n);
			let o = e.unmount;
			if (e.unmount = () => {
				r && r(), l.dispose(), o();
			}, process.env.NODE_ENV !== "production") {
				if (!await oi(e, l)) throw Q(Z.CANNOT_SETUP_VUE_DEVTOOLS_PLUGIN);
				let t = je();
				{
					let e = i;
					e[Fr] && e[Fr](t);
...
function Ii(e = {}) {
	...
	let n = Ri(t), r = Bi(n), i = Wr(t), a = zi(e, i);
	if (a === "global") return Gr(r, e, i), r;
	if (a === "parent") {
		let i = Vi(n, t, e.__useComponent);
		return i ??= (process.env.NODE_ENV !== "production" && O(Vr($.NOT_FOUND_PARENT_SCOPE)), r), i;
	}
	if (a === "isolated") {
		...
		a.__root = Vi(n, t) || r;
		let o = ei(a);
		i.__composerExtend && (o[zr] = i.__composerExtend(o));
		let s = null;
		if (process.env.NODE_ENV !== "production") {
			s = je();
			let e = o;
	...
	if (s == null) {
		let n = N({}, e);
		"__i18n" in i && (n.__i18n = i.__i18n), r && (n.__root = r), s = ei(n), o.__composerExtend && (s[zr] = o.__composerExtend(s)), Ui(o, t, s), o.__setInstance(t, s);
	} else process.env.NODE_ENV !== "production" && a === "local" && O(Vr($.DUPLICATE_USE_I18N_CALLING));
	return s;
}
function Li(e, t) {
	let n = d(), r = n.run(() => ei(e));
	if (r == null) throw Q(Z.UNEXPECTED_ERROR);
	return [n, r];
}
function Ri(e) {
	let t = h(e.isCE ? Pi : e.appContext.app.__VUE_I18N_SYMBOL__);
...
function Ui(e, t, n) {
	...
	y(() => {
		if (process.env.NODE_ENV !== "production") {
			t.__VUE_I18N__ = n, r = je();
			let e = n;
			e[Fr] && e[Fr](r), r.on("*", bi);
		}
	}, t), x(() => {
		let i = n;
		process.env.NODE_ENV !== "production" && (r && r.off("*", bi), i[Ir] && i[Ir](), delete t.__VUE_I18N__), e.__deleteInstance(t);
		let a = i[zr];
		a && (a(), delete i[zr]);
	}, t);
}
...
var qi = u({
	...
	setup(e, t) {
		...
		return Di(e, t, Jn, (...e) => n[Nr](...e));
	}
});
if (Tn(Gt), Dn(_n), kn(rn), process.env.NODE_ENV !== "production") {
	let e = ye();
	e.__INTLIFY__ = !0, qt(e.__INTLIFY_DEVTOOLS_GLOBAL_HOOK__);
}
process.env.NODE_ENV;
function Ji(e) {
	v(() => {
...
var Yi = [
...
}, Zi = { class: "flex items-center gap-2" }, Qi = ["value"], $i = ["value"], ea = u({
	__name: "LocaleSwitcher",
	setup(e) {
		let n = ie(), i = ae(), a = r(() => n.params.locale || "en"), c = (e) => {
		...
		return (e, n) => (S(), o("div", Zi, [s("select", {
			value: a.value,
		...
		}, [(S(!0), o(t, null, w(D(Yi), (e) => (S(), o("option", {
			key: e,
			value: e
		}, E(D(Xi)(e)), 9, $i))), 128))], 40, Qi)]));
	}
}), ta = ["aria-label", "title"], na = u({
	__name: "ThemeToggle",
	setup(e) {
		let { t } = Ii(), n = C("auto");
		function r() {
		...
		}, E(n.value === "auto" ? D(t)("themeToggle.auto") : n.value === "dark" ? D(t)("themeToggle.dark") : D(t)("themeToggle.light")), 9, ta));
	}
}), ra = { class: "sticky top-0 z-50 border-b border-border bg-card/80 backdrop-blur-lg" }, ia = { class: "container flex h-16 items-center justify-between" }, aa = { class: "flex items-center gap-8" }, oa = { class: "hidden items-center gap-6 text-sm font-medium md:flex" }, sa = ["href", "onClick"], ca = ["href", "onClick"], la = { class: "relative" }, ua = { class: "bg-card border border-border rounded-md shadow-lg overflow-hidden py-1" }, da = { class: "flex items-center gap-4" }, fa = {
	href: "https://github.com/intlayer-org/benchmark-i18n",
	target: "_blank",
	rel: "noreferrer",
	class: "text-muted-foreground transition hover:text-foreground"
}, pa = { class: "sr-only" }, ma = u({
	__name: "Header",
	setup(e) {
		Ji("Header");
		let { t: n } = Ii(), u = C(!1), d = ie(), f = r(() => d.params.locale || "en"), p = r(() => [
			{
				to: `/${f.value}/products`,
		...
		return (e, r) => {
			...
			return S(), o("header", ra, [s("nav", ia, [s("div", aa, [l(d, {
				to: `/${f.value}`,
				class: "text-lg font-bold tracking-tight text-primary no-underline"
			}, {
				default: re(() => [c(E(D(n)("shared.appName")), 1)]),
				_: 1
			}, 8, ["to"]), s("div", oa, [
				l(d, {
					to: `/${f.value}`,
					...
					default: re(({ href: e, navigate: t, isExactActive: r }) => [s("a", {
						href: e,
						class: _(["nav-link", { "router-link-active": r }]),
						onClick: t
					}, E(D(n)("header.home")), 11, sa)]),
					_: 1
				}, 8, ["to"]),
				l(d, {
					to: `/${f.value}/about`,
					...
					default: re(({ href: e, navigate: t, isActive: r }) => [s("a", {
						href: e,
						class: _(["nav-link", { "router-link-active": r }]),
						onClick: t
					}, E(D(n)("header.methodology")), 11, ca)]),
					_: 1
				}, 8, ["to"]),
				s("div", la, [s("button", {
					type: "button",
				...
				}, [c(E(D(n)("header.mockPages")) + " ", 1), l(D(oe), {
					size: 14,
					class: _(["transition-transform", u.value ? "rotate-180" : ""])
				}, null, 8, ["class"])], 32), u.value ? (S(), o("div", {
					key: 0,
					class: "absolute left-0 top-full pt-2 w-48",
					onMouseenter: r[4] ||= (e) => u.value = !0,
					onMouseleave: r[5] ||= (e) => u.value = !1
				}, [s("div", ua, [(S(!0), o(t, null, w(p.value, (e) => (S(), i(d, {
					key: e.to,
					to: e.to,
				...
				s("a", fa, [s("span", pa, E(D(n)("shared.goToGithub")), 1), r[6] ||= s("svg", {
					viewBox: "0 0 16 16",
					"aria-hidden": "true",
					width: "20",
					height: "20"
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(ha), (e, t) => T(e.$slots, "default");
	}
}), _a = { render() {
	return m(ga, {}, { default: () => m(ma) });
} };
