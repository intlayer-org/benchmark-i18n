...
var Xi = { class: "mt-20 border-t border-border bg-card" }, Zi = { class: "container py-8" }, Qi = { class: "grid gap-8 md:grid-cols-3" }, $i = { class: "mb-2 text-sm font-semibold text-foreground" }, ea = { class: "text-sm text-muted-foreground" }, ta = { class: "mb-2 text-sm font-semibold text-foreground" }, na = { class: "space-y-1" }, ra = ["href"], ia = { class: "mb-2 text-sm font-semibold text-foreground" }, aa = { class: "text-sm text-muted-foreground" }, oa = { class: "mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground" }, sa = u({
	__name: "Footer",
	setup(e) {
		let { t: n } = Ii(), a = ie(), l = r(() => a.params.locale || "en"), u = r(() => [
			{
		...
		return (e, r) => {
			let a = ee("router-link");
			return S(), o("footer", Xi, [s("div", Zi, [s("div", Qi, [
				s("div", null, [s("h3", $i, E(D(n)("footer.title")), 1), s("p", ea, E(D(n)("footer.description")), 1)]),
				s("div", null, [s("h3", ta, E(D(n)("footer.resources")), 1), s("ul", na, [(S(!0), o(t, null, w(u.value, (e) => (S(), o("li", { key: e.label }, [e.isInternal ? (S(), i(a, {
					key: 0,
					to: e.to,
				...
				s("div", null, [s("h3", ia, E(D(n)("footer.contact")), 1), s("p", aa, E(D(n)("shared.contactEmail")), 1)])
			]), s("div", oa, E(D(n)("footer.builtWith")), 1)])]);
		};
	}
});
function ca(e) {
...
var la = [
...
}, da = { class: "flex items-center gap-2" }, fa = ["value"], pa = ["value"], ma = u({
	...
	setup(e) {
		...
		return (e, n) => (S(), o("div", da, [s("select", {
			value: a.value,
		...
		}, [(S(!0), o(t, null, w(D(la), (e) => (S(), o("option", {
			key: e,
			value: e
		}, E(D(ua)(e)), 9, pa))), 128))], 40, fa)]));
	}
}), ha = ["aria-label", "title"], ga = u({
	__name: "ThemeToggle",
	setup(e) {
		let { t } = Ii(), n = C("auto");
		function r() {
		...
		}, E(n.value === "auto" ? D(t)("themeToggle.auto") : n.value === "dark" ? D(t)("themeToggle.dark") : D(t)("themeToggle.light")), 9, ha));
	}
	...
	setup(e) {
		...
		return (e, r) => {
			...
			return S(), o("header", _a, [s("nav", va, [s("div", ya, [l(d, {
				to: `/${f.value}`,
				...
				l(d, {
					...
					default: re(({ href: e, navigate: t, isActive: r }) => [s("a", {
						...
						class: _(["nav-link", { "router-link-active": r }]),
						onClick: t
					}, E(D(n)("header.methodology")), 11, Sa)]),
					_: 1
				}, 8, ["to"]),
				s("div", Ca, [s("button", {
					type: "button",
				...
				}, [s("div", wa, [(S(!0), o(t, null, w(p.value, (e) => (S(), i(d, {
					key: e.to,
					to: e.to,
				...
				s("a", Ea, [s("span", Da, E(D(n)("shared.goToGithub")), 1), r[6] ||= s("svg", {
					viewBox: "0 0 16 16",
					"aria-hidden": "true",
					width: "20",
					height: "20"
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Aa), (e, t) => T(e.$slots, "default");
	}
}), Ma = { render() {
	return m(ja, {}, { default: () => m(ka) });
} };
