...
import { Fragment as t, Text as n, computed as r, createElementBlock as i, createElementVNode as a, createVNode as o, defineComponent as s, effectScope as c, getCurrentInstance as l, getCurrentScope as u, h as d, inject as f, isRef as p, onMounted as m, onScopeDispose as h, onUnmounted as g, openBlock as _, ref as v, renderList as y, renderSlot as b, shallowRef as x, toDisplayString as S, unref as C, watch as w } from "vue";
...
}, ee = { class: "flex items-center gap-2" }, te = ["value"], ne = ["value"], re = s({
	__name: "LocaleSwitcher",
	setup(e) {
		let n = T(), o = E(), s = r(() => n.params.locale || "en"), c = (e) => {
		...
		return (e, n) => (_(), i("div", ee, [a("select", {
			value: s.value,
		...
		}, [(_(!0), i(t, null, y(C(D), (e) => (_(), i("option", {
			key: e,
			value: e
		}, S(C(O)(e)), 9, ne))), 128))], 40, te)]));
	}
});
function k(e, t) {
...
function We(e, t = {}) {
	...
	function d(e, t, r, ...i) {
		...
		if (t.column += r, t.offset += r, u) {
			let r = Ne(e, n ? U(a.startLoc, t) : null, {
				domain: Ue,
				args: i
			});
			u(r);
	...
	function D(e, t = !0) {
		let n = (t = !1, r = "") => {
			let i = e.currentPeek();
			return i === "{" || i === "@" || !i ? t : i === "|" ? r !== G && r !== K : i === G ? (e.peek(), n(!0, G)) : i !== K || (e.peek(), n(!0, K));
		}, r = n();
		return t && e.resetPeek(), r;
	}
	function O(e, t) {
		let n = e.currentChar();
		if (n !== Ve) return t(n) ? (e.next(), n) : null;
	}
	function ee(e) {
		let t = e.charCodeAt(0);
...
function mt(e, t = {}) {
	let n = P({}, t), r = !!n.jit, i = !!n.minify, a = n.optimize == null || n.optimize, o = Xe(n).parse(e);
...
function $t(e) {
	...
	if (R(e)) {
		...
		throw Yt(J.NOT_SUPPORT_LOCALE_ASYNC_FUNCTION);
	}
	throw Yt(J.NOT_SUPPORT_LOCALE_TYPE);
}
function en(e, t, n) {
...
function zn(e, t, n, r, i) {
	...
	return process.env.NODE_ENV !== "production" && Rn(r, t) && o(_n(Y.NOT_FOUND_KEY, {
		key: t,
		locale: n
	})), t;
}
...
function Qr(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = A ? v : x, s = !B(e.inheritLocale) || e.inheritLocale, c = o(t && s ? t.locale.value : z(e.locale) ? e.locale : yn), l = o(t && s ? t.fallbackLocale.value : z(e.fallbackLocale) || L(e.fallbackLocale) || H(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(Vr(c.value, e)), d = o(H(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(H(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : B(e.missingWarn) || fe(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : B(e.fallbackWarn) || fe(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : !B(e.fallbackRoot) || e.fallbackRoot, g = !!e.fallbackFormat, _ = R(e.missing) ? e.missing : null, y = R(e.missing) ? Xr(e.missing) : null, b = R(e.postTranslation) ? e.postTranslation : null, S = t ? t.warnHtmlMessage : !B(e.warnHtmlMessage) || e.warnHtmlMessage, C = !!e.escapeParameter, T = t ? t.modifiers : H(e.modifiers) ? e.modifiers : {}, E = e.pluralRules || t && t.pluralRules, D;
	D = (() => {
		i && Mn(null);
		let t = {
			version: Or,
			...
			Dr({
				...
				r.on.getInspectorState(async (n) => {
					if (n.app === e && n.inspectorId === "vue-i18n-resource-inspector") {
						if (r.unhighlightElement(), gi(n, t), n.nodeId === "global") {
							if (!i.has(n.app)) {
...
var Ci = s({
	...
	setup(e, t) {
		...
		return () => {
			...
			let s = xi(t, a), c = i[Ar](e.keypath, s, o), l = P(F(), r), u = z(e.tag) || V(e.tag) ? e.tag : Si();
			return d(u, l, c);
		};
	}
});
...
function Ti(e, t, n, r) {
	...
	return () => {
		...
		let l = P(F(), a), u = z(e.tag) || V(e.tag) ? e.tag : Si();
		return d(u, l, c);
	};
}
var Ei = s({
...
function Ni(e = {}) {
	...
	let t = !B(e.globalInjection) || e.globalInjection, n = /* @__PURE__ */ new Map(), [r, i] = Fi(e, !1), a = M(process.env.NODE_ENV === "production" ? "" : "vue-i18n");
	function o(e) {
		return n.get(e) || null;
	}
	function s(e, t) {
...
var Ki = Ni({
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Ki), (e, t) => b(e.$slots, "default");
	}
}), Ji = { render() {
	return d(qi, {}, { default: () => d(re) });
} };
