...
import { Fragment as t, Text as n, computed as r, createElementBlock as i, createVNode as a, defineComponent as o, getCurrentScope as s, h as c, inject as l, onMounted as u, onScopeDispose as d, onUnmounted as f, openBlock as p, ref as m, shallowRef as h, toDisplayString as g, unref as _, watch as v } from "vue";
function y(e, t) {
...
function Y(e) {
	return Se(e, null, process.env.NODE_ENV === "production" ? void 0 : { messages: Ft });
}
var Ft = {
...
function It(e, t) {
	return t.locale == null ? Rt(e.locale) : Rt(t.locale);
}
var Lt;
function Rt(e) {
	if (F(e)) return e;
	if (P(e)) {
		if (e.resolvedOnce && Lt != null) return Lt;
...
function Bt(e, t, n) {
	...
	if (!a) {
		...
		e = F(o) ? [o] : o, N(e) && Vt(a, e, !1), i.__localeChainCache.set(r, a);
	}
	return a;
}
function Vt(e, t, n) {
...
function Yt(e) {
	let t = e.trim();
	return e.charAt(0) === "0" && isNaN(parseInt(e)) ? !1 : Kt(t) ? qt(t) : "*" + t;
}
function Xt(e) {
	...
	f[0] = () => {
		...
		if (i > 0) i--, r = 4, f[0]();
			...
			if (i = 0, o === void 0 || (o = Yt(o), o === !1)) return !1;
			f[1]();
		}
	};
	function p() {
	...
	for (; r !== null;) if (n++, a = e[n], !(a === "\\" && p())) {
		if (c = Jt(a), d = Wt[r], l = d[c] || d.l || 8, l === 8 || (r = l[0], l[1] !== void 0 && (u = f[l[1]], u && (s = a, u() === !1)))) return;
		if (r === 7) return t;
	}
}
...
function $t(e, t) {
	if (!L(e)) return null;
	let n = Zt.get(t);
	if (n || (n = Xt(t), n && Zt.set(t, n)), !n) return null;
...
var nn = "11.4.0", rn = "en-US", an = (e) => `${e.charAt(0).toLocaleUpperCase()}${e.substr(1)}`;
function on() {
	return {
		...
		capitalize: (e, t) => t === "text" && F(e) ? an(e) : t === "vnode" && L(e) && "__v_isVNode" in e ? an(e.children) : e
	};
}
var sn;
function cn(e) {
...
function bn(e = {}) {
	let t = P(e.onWarn) ? e.onWarn : y, n = F(e.version) ? e.version : nn, r = F(e.locale) || P(e.locale) ? e.locale : rn, i = P(r) ? rn : r, a = N(e.fallbackLocale) || B(e.fallbackLocale) || F(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : i, o = B(e.messages) ? e.messages : xn(i), s = B(e.datetimeFormats) ? e.datetimeFormats : xn(i), c = B(e.numberFormats) ? e.numberFormats : xn(i), l = A(j(), e.modifiers, on()), u = e.pluralRules || j(), d = P(e.missing) ? e.missing : null, f = I(e.missingWarn) || ne(e.missingWarn) ? e.missingWarn : !0, p = I(e.fallbackWarn) || ne(e.fallbackWarn) ? e.fallbackWarn : !0, m = !!e.fallbackFormat, h = !!e.unresolving, g = P(e.postTranslation) ? e.postTranslation : null, _ = B(e.processor) ? e.processor : null, v = I(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, b = !!e.escapeParameter, S = P(e.messageCompiler) ? e.messageCompiler : sn;
	process.env.NODE_ENV !== "production" && P(e.messageCompiler) && x(tn(X.EXPERIMENTAL_CUSTOM_MESSAGE_COMPILER));
	let C = P(e.messageResolver) ? e.messageResolver : ln || Qt, w = P(e.localeFallbacker) ? e.localeFallbacker : dn || zt, ee = L(e.fallbackContext) ? e.fallbackContext : void 0, T = e, E = L(T.__datetimeFormatters) ? T.__datetimeFormatters : /* @__PURE__ */ new Map(), D = L(T.__numberFormatters) ? T.__numberFormatters : /* @__PURE__ */ new Map(), O = L(T.__meta) ? T.__meta : {};
	yn++;
	let k = {
		version: n,
		cid: yn,
...
function wn(e, t, n, r, i) {
	...
	if (a !== null) {
		let r = a(e, n, t, i);
		return F(r) ? r : t;
	} else return process.env.NODE_ENV !== "production" && Cn(r, t) && o(tn(X.NOT_FOUND_KEY, {
		key: t,
		locale: n
	})), t;
}
...
var On = typeof Intl < "u", kn = {
	dateTimeFormat: On && Intl.DateTimeFormat !== void 0,
	numberFormat: On && Intl.NumberFormat !== void 0
};
function An(e, ...t) {
	let { datetimeFormats: n, unresolving: r, fallbackLocale: i, onWarn: a, localeFallbacker: o } = e, { __datetimeFormatters: s } = e;
	if (process.env.NODE_ENV !== "production" && !kn.dateTimeFormat) return a(tn(X.CANNOT_FORMAT_DATE)), "";
	if (!F(t[0]) && !te(t[0]) && !k(t[0])) return process.env.NODE_ENV !== "production" && a(tn(X.INVALID_DATE_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = Mn(...t), f = I(u.missingWarn) ? u.missingWarn : e.missingWarn, p = I(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = It(e, u), g = o(e, i, h);
	if (!F(c) || c === "") return new Intl.DateTimeFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "datetime format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && Sn(p, c) && a(tn(X.FALLBACK_TO_DATE_FORMAT, {
			key: c,
			target: v
...
function Pn(e, ...t) {
	...
	if (process.env.NODE_ENV !== "production" && !kn.numberFormat) return a(tn(X.CANNOT_FORMAT_NUMBER)), "";
	if (!k(t[0])) return process.env.NODE_ENV !== "production" && a(tn(X.INVALID_NUMBER_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = In(...t), f = I(u.missingWarn) ? u.missingWarn : e.missingWarn, p = I(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = It(e, u), g = o(e, i, h);
	if (!F(c) || c === "") return new Intl.NumberFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "number format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && Sn(p, c) && a(tn(X.FALLBACK_TO_NUMBER_FORMAT, {
			key: c,
			target: v
		})), process.env.NODE_ENV !== "production" && h !== v) {
			let t = e.__v_emitter;
...
function In(...e) {
	...
	if (!k(t)) throw Y(J.INVALID_ARGUMENT);
	let s = t;
	return F(n) ? a.key = n : B(n) && Object.keys(n).forEach((e) => {
		Fn.includes(e) ? o[e] = n[e] : a[e] = n[e];
	}), F(r) ? a.locale = r : B(r) && (o = r), B(i) && (o = i), [
		a.key || "",
		s,
		a,
...
var Rn = (e) => e, zn = (e) => "", Bn = "text", Vn = (e) => e.length === 0 ? "" : pe(e), Hn = fe;
function Un(e, t) {
...
function Gn(e = {}) {
	let t = e.locale, n = Wn(e), r = F(t) && P(e.pluralRules?.[t]) ? e.pluralRules[t] : Un, i = r === Un ? void 0 : Un, a = (e) => e[r(n, e.length, i)], o = e.list || [], s = (e) => o[e], c = e.named || j();
	k(e.pluralIndex) && (c.count ||= e.pluralIndex, c.n ||= e.pluralIndex);
	let l = (e) => c[e];
	function u(t, n) {
		return (P(e.messages) ? e.messages(t, !!n) : L(e.messages) ? e.messages[t] : !1) || (e.parent ? e.parent.message(t) : zn);
	}
	let d = (t) => e.modifiers ? e.modifiers[t] : Rn, f = P(e.processor?.normalize) ? e.processor.normalize : Vn, p = P(e.processor?.interpolate) ? e.processor.interpolate : Hn, m = {
		list: s,
		named: l,
		plural: a,
		linked: (e, ...t) => {
		...
		message: u,
		type: F(e.processor?.type) ? e.processor.type : Bn,
		interpolate: p,
		normalize: f,
		values: A(j(), o, c)
	};
...
var Kn = () => "", Z = (e) => P(e);
function qn(e, ...t) {
	let { fallbackFormat: n, postTranslation: r, unresolving: i, messageCompiler: a, fallbackLocale: o, messages: s } = e, [c, l] = Qn(...t), u = I(l.missingWarn) ? l.missingWarn : e.missingWarn, d = I(l.fallbackWarn) ? l.fallbackWarn : e.fallbackWarn, f = I(l.escapeParameter) ? l.escapeParameter : e.escapeParameter, p = !!l.resolvedMessage, m = F(l.default) || I(l.default) ? I(l.default) ? a ? c : () => c : l.default : n ? a ? c : () => c : null, h = n || m != null && (F(m) || P(m)), g = It(e, l);
	f && Jn(l);
	let [_, v, b] = p ? [
		c,
		g,
		s[g] || j()
	] : Yn(e, c, g, o, d, u), x = _, S = c;
	if (!p && !(F(x) || q(x) || Z(x)) && h && (x = m, S = x), !p && (!(F(x) || q(x) || Z(x)) || !F(v))) return i ? -1 : c;
	...
	let C = !1, w = Z(x) ? x : Xn(e, c, v, x, S, () => {
		C = !0;
	});
	if (C) return x;
	let ee = Zn(e, w, Gn(tr(e, v, b, l))), T = r ? r(ee, c) : ee;
...
function Yn(e, t, n, r, i, a) {
	...
	for (let r = 0; r < u.length; r++) {
		f = h = u[r], process.env.NODE_ENV !== "production" && n !== f && !En(n, f) && Sn(i, t) && s(tn(X.FALLBACK_TO_TRANSLATE, {
			key: t,
			target: f
		}));
...
function Qn(...e) {
	let [t, n, r] = e, i = j();
	if (!F(t) && !k(t) && !Z(t) && !q(t)) throw Y(J.INVALID_ARGUMENT);
	let a = k(t) ? String(t) : (Z(t), t);
	...
	return {
		...
		onError: (t) => {
			if (a && a(t), process.env.NODE_ENV !== "production") {
				let i = er(r), a = t.location && i && he(i, t.location.start.offset, t.location.end.offset), o = e.__v_emitter;
...
function tr(e, t, n, r) {
	let { modifiers: i, pluralRules: a, messageResolver: o, fallbackLocale: s, fallbackWarn: c, missingWarn: l, fallbackContext: u } = e, d = {
		...
		messages: (r, i) => {
			let a = o(n, r);
			if (a == null && (u || i)) {
				let [n, , i] = Yn(u || e, r, t, s, c, l);
				a = n ?? o(i, r);
			}
			if (F(a) || q(a)) {
				let n = !1, i = Xn(e, r, t, a, r, () => {
					n = !0;
				});
				return n ? Kn : i;
...
}, ar = E("__translateVNode"), or = E("__datetimeParts"), sr = E("__numberParts"), cr = E("__enableEmitter"), lr = E("__disableEmitter"), ur = E("__setPluralRules");
E("__intlifyMeta");
var dr = E("__injectWithOption"), fr = E("__dispose"), $ = {
	FALLBACK_TO_ROOT: 10,
...
function hr(e) {
	if (!L(e) || q(e)) return e;
	for (let t in e) if (M(e, t)) if (!t.includes(".")) L(e[t]) && hr(e[t]);
	else {
		let n = t.split("."), r = n.length - 1, i = e, a = !1;
		for (let e = 0; e < r; e++) {
			if (n[e] === "__proto__") throw Error(`unsafe key: ${n[e]}`);
			if (n[e] in i || (i[n[e]] = j()), !L(i[n[e]])) {
				process.env.NODE_ENV !== "production" && y(mr($.IGNORE_OBJ_FLATTEN, { key: n[e] })), a = !0;
				break;
			}
			i = i[n[e]];
		}
...
function gr(e, t) {
	...
	}), i == null && a) for (let e in o) M(o, e) && hr(o[e]);
	return o;
}
function _r(e) {
	return e.type;
...
var xr = "__INTLIFY_META__", Sr = () => [], Cr = () => !1, wr = 0;
function Tr(e) {
	return ((t, n, r, i) => e(n, r, br() || void 0, i));
}
var Er = () => {
	let e = br(), t = null;
	return e && (t = _r(e)[xr]) ? { [xr]: t } : null;
};
function Dr(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = S ? m : h, s = I(e.inheritLocale) ? e.inheritLocale : !0, c = o(t && s ? t.locale.value : F(e.locale) ? e.locale : rn), l = o(t && s ? t.fallbackLocale.value : F(e.fallbackLocale) || N(e.fallbackLocale) || B(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(gr(c.value, e)), d = o(B(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(B(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : I(e.missingWarn) || ne(e.missingWarn) ? e.missingWarn : !0, g = t ? t.fallbackWarn : I(e.fallbackWarn) || ne(e.fallbackWarn) ? e.fallbackWarn : !0, _ = t ? t.fallbackRoot : I(e.fallbackRoot) ? e.fallbackRoot : !0, b = !!e.fallbackFormat, x = P(e.missing) ? e.missing : null, C = P(e.missing) ? Tr(e.missing) : null, w = P(e.postTranslation) ? e.postTranslation : null, ee = t ? t.warnHtmlMessage : I(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, T = !!e.escapeParameter, E = t ? t.modifiers : B(e.modifiers) ? e.modifiers : {}, D = e.pluralRules || t && t.pluralRules, O;
	O = (() => {
		i && _n(null);
		let t = {
			version: nr,
	...
	let re = r({
		...
		get: () => l.value,
		set: (e) => {
			O.fallbackLocale = e, l.value = e, Tn(O, c.value, e);
		}
	...
	let R = (e, n, r, a, o, s) => {
		...
		let c;
		try {
			process.env.NODE_ENV !== "production" && mn(Er()), i || (O.fallbackContext = t ? vn() : void 0), c = e(O);
		} finally {
			process.env.NODE_ENV !== "production" && mn(null), i || (O.fallbackContext = void 0);
		}
		if (r !== "translate exists" && k(c) && c === -1 || r === "translate exists" && !c) {
			let [e, i] = n();
			if (process.env.NODE_ENV !== "production" && t && F(e) && de(r, i) && (_ && (Sn(g, e) || Cn(p, e)) && y(mr($.FALLBACK_TO_ROOT, {
				key: e,
				type: r
		...
		else throw rr(Q.UNEXPECTED_RETURN_TYPE);
	};
	function z(...e) {
		return R((t) => Reflect.apply(qn, null, [t, ...e]), () => Qn(...e), "translate", (t) => Reflect.apply(t.t, t, [...e]), (e) => e, (e) => F(e));
	}
	function fe(...e) {
		let [t, n, r] = e;
		if (r && !L(r)) throw rr(Q.INVALID_ARGUMENT);
		return z(t, n, A({ resolvedMessage: !0 }, r || {}));
	}
	function pe(...e) {
		return R((t) => Reflect.apply(An, null, [t, ...e]), () => Mn(...e), "datetime format", (t) => Reflect.apply(t.d, t, [...e]), () => "", (e) => F(e) || N(e));
	}
	function me(...e) {
		return R((t) => Reflect.apply(Pn, null, [t, ...e]), () => In(...e), "number format", (t) => Reflect.apply(t.n, t, [...e]), () => "", (e) => F(e) || N(e));
	}
	function he(e) {
		return e.map((e) => F(e) || k(e) || I(e) ? yr(String(e)) : e);
	}
	let ge = {
		normalize: he,
		interpolate: (e) => e,
	...
	function _e(...e) {
		return R((t) => {
			let n, r = t;
			try {
				r.processor = ge, n = Reflect.apply(qn, null, [r, ...e]);
			} finally {
				r.processor = null;
			}
			return n;
		}, () => Qn(...e), "translate", (t) => t[ar](...e), (e) => [yr(e)], (e) => N(e));
	}
	function ye(...e) {
		return R((t) => Reflect.apply(Pn, null, [t, ...e]), () => In(...e), "number format", (t) => t[sr](...e), Sr, (e) => F(e) || N(e));
	}
	function be(...e) {
		return R((t) => Reflect.apply(An, null, [t, ...e]), () => Mn(...e), "datetime format", (t) => t[or](...e), Sr, (e) => F(e) || N(e));
	}
	function V(e) {
		D = e, O.pluralRules = D;
	}
	function xe(e, t) {
		return R(() => {
			if (!e) return !1;
			let n = F(t) ? t : c.value, r = F(t) ? [n] : Bt(O, l.value, n);
			for (let t = 0; t < r.length; t++) {
				let n = we(r[t]), i = O.messageResolver(n, e);
				if (i === null && (i = n[e]), q(i) || Z(i) || F(i)) return !0;
			}
			return !1;
		}, () => [e], "translate exists", (n) => Reflect.apply(n.te, n, [e, t]), Cr, (e) => I(e));
	}
	function Se(e) {
		let t = null, n = Bt(O, l.value, c.value);
	...
	function H(e, t) {
		u.value[e] = u.value[e] || {};
		let n = { [e]: t };
		if (a) for (let e in n) M(n, e) && hr(n[e]);
	...
	function U(e, t) {
		d.value[e] = t, O.datetimeFormats = d.value, Nn(O, e, t);
	}
	function De(e, t) {
		d.value[e] = A(d.value[e] || {}, t), O.datetimeFormats = d.value, Nn(O, e, t);
	}
	function Oe(e) {
		return f.value[e] || {};
	}
	function ke(e, t) {
		f.value[e] = t, O.numberFormats = f.value, Ln(O, e, t);
	}
	function W(e, t) {
		f.value[e] = A(f.value[e] || {}, t), O.numberFormats = f.value, Ln(O, e, t);
	}
	wr++, t && S && (v(t.locale, (e) => {
		s && (c.value = e, O.locale = e, Tn(O, c.value, l.value));
	}), v(t.fallbackLocale, (e) => {
		s && (l.value = e, O.fallbackLocale = e, Tn(O, c.value, l.value));
	}));
	let G = {
		id: wr,
		locale: re,
		...
		set inheritLocale(e) {
			s = e, e && t && (c.value = t.locale.value, l.value = t.fallbackLocale.value, Tn(O, c.value, l.value));
		},
	...
	return G.datetimeFormats = ae, G.numberFormats = oe, G.rt = fe, G.te = xe, G.tm = Ce, G.d = pe, G.n = me, G.getDateTimeFormat = Ee, G.setDateTimeFormat = U, G.mergeDateTimeFormat = De, G.getNumberFormat = Oe, G.setNumberFormat = ke, G.mergeNumberFormat = W, G[dr] = n, G[ar] = _e, G[or] = be, G[sr] = ye, process.env.NODE_ENV !== "production" && (G[cr] = (e) => {
		O.__v_emitter = e;
	}, G[lr] = () => {
...
function kr(e, t) {
	if (Or) {
		let n;
		t && "groupId" in t && (n = t.groupId, delete t.groupId), Or.addTimelineEvent({
...
o({
	...
	setup(e, t) {
		let { slots: n, attrs: r } = t, i = e.i18n || Ir({
			useScope: e.scope,
			__useComponent: !0
		});
		return () => {
			...
			let s = jr(t, a), l = i[ar](e.keypath, s, o), u = A(j(), r);
			return c(F(e.tag) || L(e.tag) ? e.tag : Mr(), u, l);
		};
	}
});
function Nr(e) {
...
function Pr(e, t, n, r) {
	...
	return () => {
		...
		N(s) ? l = s.map((e, t) => {
			...
			return Nr(r) && (r[0].key = `${e.type}-${t}`), r;
		}) : F(s) && (l = [s]);
		let u = A(j(), a);
		return c(F(e.tag) || L(e.tag) ? e.tag : Mr(), u, l);
	};
...
o({
	...
	setup(e, t) {
		...
		return Pr(e, t, Fn, (...e) => n[sr](...e));
	}
});
var Fr = E("global-vue-i18n");
function Ir(e = {}) {
	let t = br();
	if (t == null) throw rr(Q.MUST_BE_CALL_SETUP_TOP);
	if (!t.isCE && t.appContext.app != null && !t.appContext.app.__VUE_I18N_SYMBOL__) throw rr(Q.NOT_INSTALLED);
	let n = Lr(t), r = zr(n), i = _r(t), a = Rr(e, i);
	if (a === "global") return vr(r, e, i), r;
	if (a === "parent") {
		let i = Br(n, t, e.__useComponent);
		return i ??= (process.env.NODE_ENV !== "production" && y(mr($.NOT_FOUND_PARENT_SCOPE)), r), i;
	}
	if (a === "isolated") {
		if (n.mode !== "composition") throw rr(Q.NOT_AVAILABLE_COMPOSITION_IN_LEGACY);
		let i = n, a = A({}, e);
		a.__root = Br(n, t) || r;
		let o = Dr(a);
	...
	if (c == null) {
		let n = A({}, e);
		"__i18n" in i && (n.__i18n = i.__i18n), r && (n.__root = r), c = Dr(n), o.__composerExtend && (c[fr] = o.__composerExtend(c)), Hr(o, t, c), o.__setInstance(t, c);
	} else process.env.NODE_ENV !== "production" && a === "local" && y(mr($.DUPLICATE_USE_I18N_CALLING));
	return c;
}
function Lr(e) {
	let t = l(e.isCE ? Fr : e.appContext.app.__VUE_I18N_SYMBOL__);
	if (!t) throw rr(e.isCE ? Q.NOT_INSTALLED_WITH_PROVIDE : Q.UNEXPECTED_ERROR);
	return t;
}
function Rr(e, t) {
...
function Hr(e, t, n) {
	...
	u(() => {
		...
		let i = n;
		process.env.NODE_ENV !== "production" && (r && r.off("*", kr), i[lr] && i[lr](), delete t.__VUE_I18N__), e.__deleteInstance(t);
		let a = i[fr];
		a && (a(), delete i[fr]);
	}, t);
}
if (o({
	...
	setup(e, t) {
		...
		return Pr(e, t, jn, (...e) => n[or](...e));
	}
}), cn(kt), un($t), fn(Bt), process.env.NODE_ENV !== "production") {
	let e = oe();
	e.__INTLIFY__ = !0, jt(e.__INTLIFY_DEVTOOLS_GLOBAL_HOOK__);
}
process.env.NODE_ENV;
var Ur = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, Wr = o({
	__name: "MockBanner",
	setup(e) {
		let { t } = Ir();
		return (e, n) => (p(), i("div", Ur, g(_(t)("mockBanner")), 1));
	}
});
