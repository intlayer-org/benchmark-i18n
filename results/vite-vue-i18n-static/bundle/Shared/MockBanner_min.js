...
var A = (e, t = !1) => t ? Symbol.for(e) : Symbol(e), te = (e, t, n) => ne({
	l: e,
	k: t,
	s: n
}), ne = (e) => JSON.stringify(e).replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029").replace(/\u0027/g, "\\u0027"), j = (e) => typeof e == "number" && isFinite(e), re = (e) => me(e) === "[object Date]", ie = (e) => me(e) === "[object RegExp]", ae = (e) => V(e) && Object.keys(e).length === 0, M = Object.assign, oe = Object.create, N = (e = null) => oe(e), se, ce = () => se ||= typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : N();
function le(e) {
...
var I = Array.isArray, L = (e) => typeof e == "function", R = (e) => typeof e == "string", z = (e) => typeof e == "boolean", B = (e) => typeof e == "object" && !!e, fe = (e) => B(e) && L(e.then) && L(e.catch), pe = Object.prototype.toString, me = (e) => pe.call(e), V = (e) => me(e) === "[object Object]", he = (e) => e == null ? "" : I(e) || V(e) && e.toString === pe ? JSON.stringify(e, null, 2) : String(e);
function ge(e, t = "") {
...
function xe(e, t) {
	...
	for (; n.length;) {
		...
		Object.keys(e).forEach((r) => {
			r !== "__proto__" && (B(e[r]) && !B(t[r]) && (t[r] = Array.isArray(e[r]) ? [] : N()), be(t[r]) || be(e[r]) ? t[r] = e[r] : n.push({
				src: e[r],
				des: t[r]
			}));
		});
...
function Te(e, t, n = {}) {
	let { domain: r, messages: i, args: a } = n, o = process.env.NODE_ENV === "production" ? e : k((i || we)[e] || "", ...a || []), s = SyntaxError(String(o));
	return s.code = e, t && (s.location = t), s.domain = r, s;
}
function Ee(e) {
	throw e;
}
var De = /<\/?[\w\s="/.':;#-\/]+>/, Oe = (e) => De.test(e), U = " ", ke = "\r", W = "\n", G = "\u2028", Ae = "\u2029";
function je(e) {
	let t = e, n = 0, r = 1, i = 1, a = 0, o = (e) => t[e] === ke && t[e + 1] === W, s = (e) => t[e] === W, c = (e) => t[e] === Ae, l = (e) => t[e] === G, u = (e) => o(e) || s(e) || c(e) || l(e), d = () => n, f = () => r, p = () => i, m = () => a, h = (e) => o(e) || c(e) || l(e) ? W : t[e], g = () => h(n), _ = () => h(n + a);
	function v() {
...
var Me = void 0, Ne = "'", Pe = "tokenizer";
function Fe(e, t = {}) {
	let n = t.location !== !1, r = je(e), i = () => r.index(), a = () => Se(r.line(), r.column(), r.index()), o = a(), s = i(), c = {
		currentType: 13,
		offset: s,
		startLoc: o,
		endLoc: o,
	...
	function ee(e, t) {
		...
		let r = () => {
			let t = e.currentPeek();
			return t === "{" ? _(e.peek()) : t === "@" || t === "|" || t === ":" || t === "." || t === U || !t ? !1 : t === W ? (e.peek(), r()) : E(e, !1);
		}, i = r();
	...
	function E(e, t = !0) {
		let n = (t = !1, r = "") => {
			let i = e.currentPeek();
			return i === "{" || i === "@" || !i ? t : i === "|" ? r !== U && r !== W : i === U ? (e.peek(), n(!0, U)) : i !== W || (e.peek(), n(!0, W));
		}, r = n();
		return t && e.resetPeek(), r;
	}
	function D(e, t) {
		let n = e.currentChar();
		if (n !== Me) return t(n) ? (e.next(), n) : null;
	}
	function O(e) {
		let t = e.charCodeAt(0);
	...
	function oe(e) {
		...
		for (; t = te(e);) n += t;
		let r = e.currentChar();
		if (r && r !== "}" && r !== Me && r !== U && r !== W && r !== "　") {
			let t = de(e);
			return d(H.INVALID_TOKEN_IN_PLACEHOLDER, a(), 0, n + t), n + t;
		}
		return e.currentChar() === Me && d(H.UNTERMINATED_CLOSING_BRACE, a(), 0), n;
	}
	function N(e) {
		g(e);
		let t = "";
		return e.currentChar() === "-" ? (e.next(), t += `-${ae(e)}`) : t += ae(e), e.currentChar() === Me && d(H.UNTERMINATED_CLOSING_BRACE, a(), 0), t;
	}
	function se(e) {
		return e !== Ne && e !== W;
	}
	function ce(e) {
		g(e), m(e, "'");
		let t = "", n = "";
		for (; t = D(e, se);) n += t === "\\" ? le(e) : t;
		let r = e.currentChar();
		return r === W || r === Me ? (d(H.UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER, a(), 0), r === W && (e.next(), m(e, "'")), n) : (m(e, "'"), n);
	}
	function le(e) {
		let t = e.currentChar();
		switch (t) {
	...
	function R(e, t) {
		...
		switch (e.currentChar()) {
			...
			case "@": return t.braceNest > 0 && d(H.UNTERMINATED_CLOSING_BRACE, a(), 0), n = z(e, t) || p(t), t.braceNest = 0, n;
			default: {
				let r = !0, i = !0, o = !0;
				if (T(e)) return t.braceNest > 0 && d(H.UNTERMINATED_CLOSING_BRACE, a(), 0), n = f(t, 1, L(e)), t.braceNest = 0, t.inLinked = !1, n;
				if (t.braceNest > 0 && (t.currentType === 4 || t.currentType === 5 || t.currentType === 6)) return d(H.UNTERMINATED_CLOSING_BRACE, a(), 0), t.braceNest = 0, B(e, t);
				if (r = y(e, t)) return n = f(t, 4, oe(e)), g(e), n;
				if (i = b(e, t)) return n = f(t, 5, N(e)), g(e), n;
				if (o = x(e, t)) return n = f(t, 6, ce(e)), g(e), n;
				if (!r && !i && !o) return n = f(t, 12, de(e)), d(H.INVALID_TOKEN_IN_PLACEHOLDER, a(), 0, n.value), g(e), n;
				break;
			}
		}
		return n;
	...
	function z(e, t) {
		...
		switch ((n === 7 || n === 8 || n === 11 || n === 9) && (i === W || i === U) && d(H.INVALID_LINKED_FORMAT, a(), 0), i) {
			...
			default: return T(e) ? (r = f(t, 1, L(e)), t.braceNest = 0, t.inLinked = !1, r) : S(e, t) || w(e, t) ? (g(e), z(e, t)) : C(e, t) ? (g(e), f(t, 11, F(e))) : ee(e, t) ? (g(e), i === "{" ? R(e, t) || r : f(t, 10, I(e))) : (n === 7 && d(H.INVALID_LINKED_FORMAT, a(), 0), t.braceNest = 0, t.inLinked = !1, B(e, t));
		}
	}
	function B(e, t) {
		let n = { type: 13 };
		...
		switch (e.currentChar()) {
			...
			default:
				if (T(e)) return n = f(t, 1, L(e)), t.braceNest = 0, t.inLinked = !1, n;
				if (E(e)) return f(t, 0, M(e));
		}
		return n;
	}
	function fe() {
		let { currentType: e, offset: t, startLoc: n, endLoc: o } = c;
		return c.lastType = e, c.lastOffset = t, c.lastStartLoc = n, c.lastEndLoc = o, c.offset = i(), c.startLoc = a(), r.currentChar() === Me ? f(c, 13) : B(r, c);
	}
	return {
		nextToken: fe,
		currentOffset: i,
...
function Ve(e = {}) {
	...
	function g(n) {
		let o = Fe(n, M({}, e)), s = o.context(), c = i(0, s.offset, s.startLoc);
...
function We(e, t) {
	switch (e.type) {
		...
		case 2:
			...
			break;
		case 6:
			We(e.key, t), t.helper("linked"), t.helper("type");
			break;
		case 5:
...
function Ge(e, t = {}) {
	let n = He(e);
	n.helper("normalize"), e.body && We(e.body, n);
	let r = n.context();
	e.helpers = Array.from(r.helpers);
}
function Ke(e) {
	let t = e.body;
	return t.type === 2 ? qe(t) : t.cases.forEach((e) => qe(e)), e;
}
function qe(e) {
	if (e.items.length === 1) {
		let t = e.items[0];
...
function Ye(e) {
	switch (e.t = e.type, e.type) {
		...
		default: if (process.env.NODE_ENV !== "production") throw Te(H.UNHANDLED_MINIFIER_NODE_TYPE, null, {
			domain: Je,
			args: [e.type]
		});
	}
...
function Qe(e, t) {
	let { helper: n } = e;
	e.push(`${n("linked")}(`), nt(e, t.key), t.modifier ? (e.push(", "), nt(e, t.modifier), e.push(", _type")) : e.push(", undefined, _type"), e.push(")");
}
function $e(e, t) {
	let { helper: n, needIndent: r } = e;
	e.push(`${n("normalize")}([`), e.indent(r());
	let i = t.items.length;
	for (let n = 0; n < i && (nt(e, t.items[n]), n !== i - 1); n++) e.push(", ");
	e.deindent(r()), e.push("])");
}
function et(e, t) {
	let { helper: n, needIndent: r } = e;
	if (t.cases.length > 1) {
		...
		for (let n = 0; n < i && (nt(e, t.cases[n]), n !== i - 1); n++) e.push(", ");
		e.deindent(r()), e.push("])");
	}
}
function tt(e, t) {
...
function nt(e, t) {
	...
	switch (t.type) {
		...
		case 3:
			e.push(JSON.stringify(t.value), t);
			break;
		default: if (process.env.NODE_ENV !== "production") throw Te(H.UNHANDLED_CODEGEN_NODE_TYPE, null, {
			domain: Xe,
			args: [t.type]
		});
	}
...
var rt = (e, t = {}) => {
	...
	c.push(n === "normal" ? "function __msg__ (ctx) {" : "(ctx) => {"), c.indent(o), s.length > 0 && (c.push(`const { ${ge(s.map((e) => `${e}: _${e}`), ", ")} } = ctx`), c.newline()), c.push("return "), nt(c, e), c.deindent(o), c.push("}"), delete e.helpers;
...
function it(e, t = {}) {
	let n = M({}, t), r = !!n.jit, i = !!n.minify, a = n.optimize == null || n.optimize, o = Ve(n).parse(e);
	return r ? (a && Ke(o), i && Ye(o), {
		ast: o,
		code: ""
	}) : (Ge(o, n), rt(o, n));
}
function q(e) {
	return B(e) && mt(e) === 0 && (F(e, "b") || F(e, "body"));
}
var at = ["b", "body"];
function ot(e) {
	return xt(e, at);
...
function Tt(e, t) {
	let n = ot(t);
	if (n == null) throw Ct(0);
	if (mt(n) === 1) {
		let t = ct(n);
		return e.plural(t.reduce((t, n) => [...t, Et(e, n)], []));
	}
	return Et(e, n);
}
function Et(e, t) {
	...
	{
		let n = ft(t).reduce((t, n) => [...t, Dt(e, n)], []);
...
function Dt(e, t) {
	let n = mt(t);
	switch (n) {
		case 3: return gt(t, n);
		case 9: return gt(t, n);
		case 4: {
			let r = t;
		...
		case 6: {
			let n = t, r = vt(n), i = bt(n);
			return e.linked(Dt(e, i), r ? Dt(e, r) : void 0, e.type);
		}
		case 7: return gt(t, n);
		case 8: return gt(t, n);
		default: throw Error(`unhandled node on format message part: ${n}`);
	}
}
var Ot = "Detected HTML in '{source}' message. Recommend not using HTML messages to avoid XSS.";
function kt(e, t) {
	t && Oe(e) && C(k(Ot, { source: e }));
}
var At = (e) => e, jt = N();
function Mt(e, t = {}) {
...
function Nt(e, t) {
	if (R(e)) {
		...
		let r = (t.onCacheKey || At)(e), i = jt[r];
		if (i) return i;
		let { ast: a, detectError: o } = Mt(e, {
			...t,
	...
	{
		if (process.env.NODE_ENV !== "production" && !q(e)) return C(`the message that is resolve with key '${t.key}' is not supported for jit compilation`), (() => e);
		let n = e.cacheKey;
		return n ? jt[n] || (jt[n] = wt(e)) : wt(e);
	}
}
var Pt = null;
function Ft(e) {
...
function zt(e) {
	return Te(e, null, process.env.NODE_ENV === "production" ? void 0 : { messages: Bt });
}
var Bt = {
...
function Vt(e, t) {
	return t.locale == null ? Ut(e.locale) : Ut(t.locale);
}
var Ht;
function Ut(e) {
	if (R(e)) return e;
	if (L(e)) {
		if (e.resolvedOnce && Ht != null) return Ht;
		if (e.constructor.name === "Function") {
			let t = e();
			if (fe(t)) throw zt(J.NOT_SUPPORT_LOCALE_PROMISE_VALUE);
			return Ht = t;
		}
...
function Gt(e, t, n) {
	...
	if (!a) {
		...
		e = R(o) ? [o] : o, I(e) && Kt(a, e, !1), i.__localeChainCache.set(r, a);
	}
	return a;
}
function Kt(e, t, n) {
...
function en(e) {
	let t = e.trim();
	return e.charAt(0) === "0" && isNaN(parseInt(e)) ? !1 : Zt(t) ? Qt(t) : "*" + t;
}
function tn(e) {
	...
	f[0] = () => {
		...
		if (i > 0) i--, r = 4, f[0]();
			...
			if (i = 0, o === void 0 || (o = en(o), o === !1)) return !1;
			f[1]();
		}
	};
	function p() {
	...
	for (; r !== null;) if (n++, a = e[n], !(a === "\\" && p())) {
		if (c = $t(a), d = Yt[r], l = d[c] || d.l || 8, l === 8 || (r = l[0], l[1] !== void 0 && (u = f[l[1]], u && (s = a, u() === !1)))) return;
		if (r === 7) return t;
	}
}
...
function an(e, t) {
	if (!B(e)) return null;
	let n = nn.get(t);
	if (n || (n = tn(t), n && nn.set(t, n)), !n) return null;
	let r = n.length, i = e, a = 0;
	for (; a < r;) {
		let e = n[a];
		if (St.includes(e) && q(i) || !B(i) || !F(i, e)) return null;
		let t = i[e];
...
var cn = "11.4.0", ln = "en-US", un = (e) => `${e.charAt(0).toLocaleUpperCase()}${e.substr(1)}`;
function dn() {
	return {
		...
		capitalize: (e, t) => t === "text" && R(e) ? un(e) : t === "vnode" && B(e) && "__v_isVNode" in e ? un(e.children) : e
	};
}
var fn;
function pn(e) {
...
function Tn(e = {}) {
	let t = L(e.onWarn) ? e.onWarn : C, n = R(e.version) ? e.version : cn, r = R(e.locale) || L(e.locale) ? e.locale : ln, i = L(r) ? ln : r, a = I(e.fallbackLocale) || V(e.fallbackLocale) || R(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : i, o = V(e.messages) ? e.messages : En(i), s = V(e.datetimeFormats) ? e.datetimeFormats : En(i), c = V(e.numberFormats) ? e.numberFormats : En(i), l = M(N(), e.modifiers, dn()), u = e.pluralRules || N(), d = L(e.missing) ? e.missing : null, f = z(e.missingWarn) || ie(e.missingWarn) ? e.missingWarn : !0, p = z(e.fallbackWarn) || ie(e.fallbackWarn) ? e.fallbackWarn : !0, m = !!e.fallbackFormat, h = !!e.unresolving, g = L(e.postTranslation) ? e.postTranslation : null, _ = V(e.processor) ? e.processor : null, v = !z(e.warnHtmlMessage) || e.warnHtmlMessage, y = !!e.escapeParameter, b = L(e.messageCompiler) ? e.messageCompiler : fn;
	process.env.NODE_ENV !== "production" && L(e.messageCompiler) && ee(sn(Y.EXPERIMENTAL_CUSTOM_MESSAGE_COMPILER));
	let x = L(e.messageResolver) ? e.messageResolver : mn || rn, S = L(e.localeFallbacker) ? e.localeFallbacker : gn || Wt, w = B(e.fallbackContext) ? e.fallbackContext : void 0, T = e, E = B(T.__datetimeFormatters) ? T.__datetimeFormatters : /* @__PURE__ */ new Map(), D = B(T.__numberFormatters) ? T.__numberFormatters : /* @__PURE__ */ new Map(), O = B(T.__meta) ? T.__meta : {};
	wn++;
	let k = {
		version: n,
		cid: wn,
	...
	return k.datetimeFormats = s, k.numberFormats = c, k.__datetimeFormatters = E, k.__numberFormatters = D, process.env.NODE_ENV !== "production" && (k.__v_emitter = T.__v_emitter == null ? void 0 : T.__v_emitter), process.env.NODE_ENV !== "production" && It(k, n, O), k;
}
var En = (e) => ({ [e]: N() });
function Dn(e, t) {
...
function kn(e, t, n, r, i) {
	...
	return process.env.NODE_ENV !== "production" && On(r, t) && o(sn(Y.NOT_FOUND_KEY, {
		key: t,
		locale: n
	})), t;
}
...
function Mn(e, t) {
	let n = t.indexOf(e);
	if (n === -1) return !1;
	for (let r = n + 1; r < t.length; r++) if (jn(e, t[r])) return !0;
	return !1;
}
var Nn = typeof Intl < "u", Pn = {
	dateTimeFormat: Nn && Intl.DateTimeFormat !== void 0,
	numberFormat: Nn && Intl.NumberFormat !== void 0
};
function Fn(e, ...t) {
	let { datetimeFormats: n, unresolving: r, fallbackLocale: i, onWarn: a, localeFallbacker: o } = e, { __datetimeFormatters: s } = e;
	if (process.env.NODE_ENV !== "production" && !Pn.dateTimeFormat) return a(sn(Y.CANNOT_FORMAT_DATE)), "";
	if (!R(t[0]) && !re(t[0]) && !j(t[0])) return process.env.NODE_ENV !== "production" && a(sn(Y.INVALID_DATE_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = Ln(...t), f = z(u.missingWarn) ? u.missingWarn : e.missingWarn, p = z(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = Vt(e, u), g = o(e, i, h);
	if (!R(c) || c === "") return new Intl.DateTimeFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "datetime format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && Dn(p, c) && a(sn(Y.FALLBACK_TO_DATE_FORMAT, {
			key: c,
			target: v
...
function zn(e, ...t) {
	...
	if (process.env.NODE_ENV !== "production" && !Pn.numberFormat) return a(sn(Y.CANNOT_FORMAT_NUMBER)), "";
	if (!j(t[0])) return process.env.NODE_ENV !== "production" && a(sn(Y.INVALID_NUMBER_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = Vn(...t), f = z(u.missingWarn) ? u.missingWarn : e.missingWarn, p = z(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = Vt(e, u), g = o(e, i, h);
	if (!R(c) || c === "") return new Intl.NumberFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "number format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && Dn(p, c) && a(sn(Y.FALLBACK_TO_NUMBER_FORMAT, {
			key: c,
			target: v
		})), process.env.NODE_ENV !== "production" && h !== v) {
			let t = e.__v_emitter;
...
function Vn(...e) {
	...
	if (!j(t)) throw zt(J.INVALID_ARGUMENT);
	let s = t;
	return R(n) ? a.key = n : V(n) && Object.keys(n).forEach((e) => {
		Bn.includes(e) ? o[e] = n[e] : a[e] = n[e];
	}), R(r) ? a.locale = r : V(r) && (o = r), V(i) && (o = i), [
		a.key || "",
		s,
		a,
...
var Un = (e) => e, Wn = (e) => "", Gn = "text", Kn = (e) => e.length === 0 ? "" : ge(e), qn = he;
function Jn(e, t) {
...
function Xn(e = {}) {
	let t = e.locale, n = Yn(e), r = R(t) && L(e.pluralRules?.[t]) ? e.pluralRules[t] : Jn, i = r === Jn ? void 0 : Jn, a = (e) => e[r(n, e.length, i)], o = e.list || [], s = (e) => o[e], c = e.named || N();
	j(e.pluralIndex) && (c.count ||= e.pluralIndex, c.n ||= e.pluralIndex);
	let l = (e) => c[e];
	function u(t, n) {
		return (L(e.messages) ? e.messages(t, !!n) : B(e.messages) ? e.messages[t] : !1) || (e.parent ? e.parent.message(t) : Wn);
	}
	let d = (t) => e.modifiers ? e.modifiers[t] : Un, f = L(e.processor?.normalize) ? e.processor.normalize : Kn, p = L(e.processor?.interpolate) ? e.processor.interpolate : qn, m = {
		list: s,
		named: l,
		plural: a,
		linked: (e, ...t) => {
		...
		message: u,
		type: R(e.processor?.type) ? e.processor.type : Gn,
		interpolate: p,
		normalize: f,
		values: M(N(), o, c)
	};
...
var Zn = () => "", X = (e) => L(e);
function Qn(e, ...t) {
	let { fallbackFormat: n, postTranslation: r, unresolving: i, messageCompiler: a, fallbackLocale: o, messages: s } = e, [c, l] = rr(...t), u = z(l.missingWarn) ? l.missingWarn : e.missingWarn, d = z(l.fallbackWarn) ? l.fallbackWarn : e.fallbackWarn, f = z(l.escapeParameter) ? l.escapeParameter : e.escapeParameter, p = !!l.resolvedMessage, m = R(l.default) || z(l.default) ? z(l.default) ? a ? c : () => c : l.default : n ? a ? c : () => c : null, h = n || m != null && (R(m) || L(m)), g = Vt(e, l);
	f && $n(l);
	let [_, v, y] = p ? [
		c,
		g,
		s[g] || N()
	] : er(e, c, g, o, d, u), b = _, x = c;
	if (!p && !(R(b) || q(b) || X(b)) && h && (b = m, x = b), !p && (!(R(b) || q(b) || X(b)) || !R(v))) return i ? -1 : c;
	if (process.env.NODE_ENV !== "production" && R(b) && e.messageCompiler == null) return C(`The message format compilation is not supported in this build. Because message compiler isn't included. You need to pre-compilation all message format. So translate function return '${c}'.`), c;
	let S = !1, w = X(b) ? b : tr(e, c, v, b, x, () => {
		S = !0;
	});
	if (S) return b;
	let ee = nr(e, w, Xn(or(e, v, y, l))), T = r ? r(ee, c) : ee;
	if (f && R(T) && (T = ue(T)), process.env.NODE_ENV !== "production") {
		let t = {
			timestamp: Date.now(),
			key: R(c) ? c : X(b) ? b.key : "",
		...
		t.meta = M({}, e.__meta, bn() || {}), Lt(t);
	}
	return T;
}
function $n(e) {
	I(e.list) ? e.list = e.list.map((e) => R(e) ? le(e) : e) : B(e.named) && Object.keys(e.named).forEach((t) => {
		R(e.named[t]) && (e.named[t] = le(e.named[t]));
	});
}
function er(e, t, n, r, i, a) {
	let { messages: o, onWarn: s, messageResolver: c, localeFallbacker: l } = e, u = l(e, r, n), d = N(), f, p = null, m = n, h = null, g = "translate";
	for (let r = 0; r < u.length; r++) {
		f = h = u[r], process.env.NODE_ENV !== "production" && n !== f && !jn(n, f) && Dn(i, t) && s(sn(Y.FALLBACK_TO_TRANSLATE, {
			key: t,
			target: f
		}));
...
function rr(...e) {
	let [t, n, r] = e, i = N();
	if (!R(t) && !j(t) && !X(t) && !q(t)) throw zt(J.INVALID_ARGUMENT);
	let a = j(t) ? String(t) : (X(t), t);
	return j(n) ? i.plural = n : R(n) ? i.default = n : V(n) && !ae(n) ? i.named = n : I(n) && (i.list = n), j(r) ? i.plural = r : R(r) ? i.default = r : V(r) && M(i, r), [a, i];
}
	...
	return {
		...
		onError: (t) => {
			if (a && a(t), process.env.NODE_ENV !== "production") {
				let i = ar(r), a = t.location && i && ve(i, t.location.start.offset, t.location.end.offset), o = e.__v_emitter;
...
function or(e, t, n, r) {
	let { modifiers: i, pluralRules: a, messageResolver: o, fallbackLocale: s, fallbackWarn: c, missingWarn: l, fallbackContext: u } = e, d = {
		...
		messages: (r, i) => {
			let a = o(n, r);
			if (a == null && (u || i)) {
				let [n, , i] = er(u || e, r, t, s, c, l);
				a = n ?? o(i, r);
			}
			if (R(a) || q(a)) {
				let n = !1, i = tr(e, r, t, a, r, () => {
					n = !0;
				});
				return n ? Zn : i;
			}
...
var lr = typeof Proxy == "function", ur = "devtools-plugin:setup", dr = "plugin:settings:set", fr, pr;
function mr() {
	return fr === void 0 && (typeof window < "u" && window.performance ? (fr = !0, pr = window.performance) : typeof globalThis < "u" && globalThis.perf_hooks?.performance ? (fr = !0, pr = globalThis.perf_hooks.performance) : fr = !1), fr;
}
function hr() {
	return mr() ? pr.now() : Date.now();
}
var gr = class {
	constructor(e, t) {
...
function _r(e, t) {
	let n = e, r = cr(), i = sr(), a = lr && n.enableEarlyProxy;
	if (i && (r.__VUE_DEVTOOLS_PLUGIN_API_AVAILABLE__ || !a)) i.emit(ur, e, t);
	else {
		let e = a ? new gr(n, i) : null;
...
}, br = A("__translateVNode"), xr = A("__datetimeParts"), Sr = A("__numberParts"), Cr = A("__enableEmitter"), wr = A("__disableEmitter"), Tr = A("__setPluralRules");
A("__intlifyMeta");
var Er = A("__injectWithOption"), Dr = A("__dispose"), $ = {
	FALLBACK_TO_ROOT: 10,
...
function Ar(e) {
	...
	for (let t in e) if (F(e, t)) {
		if (!t.includes(".")) B(e[t]) && Ar(e[t]);
		else {
			let n = t.split("."), r = n.length - 1, i = e, a = !1;
			for (let e = 0; e < r; e++) {
				if (n[e] === "__proto__") throw Error(`unsafe key: ${n[e]}`);
				if (n[e] in i || (i[n[e]] = N()), !B(i[n[e]])) {
					process.env.NODE_ENV !== "production" && C(kr($.IGNORE_OBJ_FLATTEN, { key: n[e] })), a = !0;
					break;
				}
				i = i[n[e]];
			}
			if (a || (q(i) ? St.includes(n[r]) || delete e[t] : (i[n[r]] = e[t], delete e[t])), !q(i)) {
				let e = i[n[r]];
				B(e) && Ar(e);
			}
		}
...
function jr(e, t) {
	...
	if (I(r) && r.forEach((e) => {
		if ("locale" in e && "resource" in e) {
			...
			t ? (o[t] = o[t] || N(), xe(n, o[t])) : xe(n, o);
		} else R(e) && xe(JSON.parse(e), o);
	}), i == null && a) for (let e in o) F(o, e) && Ar(o[e]);
	return o;
}
function Mr(e) {
	return e.type;
...
var Ir = "__INTLIFY_META__", Lr = () => [], Rr = () => !1, zr = 0;
function Br(e) {
	return ((t, n, r, i) => e(n, r, Fr() || void 0, i));
}
var Vr = () => {
	let e = Fr(), t = null;
	return e && (t = Mr(e)[Ir]) ? { [Ir]: t } : null;
};
function Hr(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = T ? _ : y, s = !z(e.inheritLocale) || e.inheritLocale, c = o(t && s ? t.locale.value : R(e.locale) ? e.locale : ln), l = o(t && s ? t.fallbackLocale.value : R(e.fallbackLocale) || I(e.fallbackLocale) || V(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(jr(c.value, e)), d = o(V(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(V(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : z(e.missingWarn) || ie(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : z(e.fallbackWarn) || ie(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : !z(e.fallbackRoot) || e.fallbackRoot, g = !!e.fallbackFormat, v = L(e.missing) ? e.missing : null, b = L(e.missing) ? Br(e.missing) : null, x = L(e.postTranslation) ? e.postTranslation : null, w = t ? t.warnHtmlMessage : !z(e.warnHtmlMessage) || e.warnHtmlMessage, ee = !!e.escapeParameter, E = t ? t.modifiers : V(e.modifiers) ? e.modifiers : {}, D = e.pluralRules || t && t.pluralRules, O;
	O = (() => {
		i && Sn(null);
		let t = {
			version: vr,
		...
		t.datetimeFormats = d.value, t.numberFormats = f.value, t.__datetimeFormatters = V(O) ? O.__datetimeFormatters : void 0, t.__numberFormatters = V(O) ? O.__numberFormatters : void 0, process.env.NODE_ENV !== "production" && (t.__v_emitter = V(O) ? O.__v_emitter : void 0);
		let n = Tn(t);
		return i && Sn(n), n;
	})(), An(O, c.value, l.value);
	function k() {
		return [
			c.value,
			l.value,
	...
	let A = r({
		...
		get: () => l.value,
		set: (e) => {
			O.fallbackLocale = e, l.value = e, An(O, c.value, e);
		}
	}), ne = r(() => u.value), re = r(() => d.value), ae = r(() => f.value);
	function oe() {
		return L(x) ? x : null;
	}
	function N(e) {
	...
	let P = (e, n, r, a, o, s) => {
		...
		let c;
		try {
			process.env.NODE_ENV !== "production" && yn(Vr()), i || (O.fallbackContext = t ? Cn() : void 0), c = e(O);
		} finally {
			process.env.NODE_ENV !== "production" && yn(null), i || (O.fallbackContext = void 0);
		}
		if (r !== "translate exists" && j(c) && c === -1 || r === "translate exists" && !c) {
			let [e, i] = n();
			if (process.env.NODE_ENV !== "production" && t && R(e) && le(r, i) && (h && (Dn(m, e) || On(p, e)) && C(kr($.FALLBACK_TO_ROOT, {
				key: e,
				type: r
	...
	function ue(...e) {
		return P((t) => Reflect.apply(Qn, null, [t, ...e]), () => rr(...e), "translate", (t) => Reflect.apply(t.t, t, [...e]), (e) => e, (e) => R(e));
	}
	function de(...e) {
		let [t, n, r] = e;
	...
	function fe(...e) {
		return P((t) => Reflect.apply(Fn, null, [t, ...e]), () => Ln(...e), "datetime format", (t) => Reflect.apply(t.d, t, [...e]), () => "", (e) => R(e) || I(e));
	}
	function pe(...e) {
		return P((t) => Reflect.apply(zn, null, [t, ...e]), () => Vn(...e), "number format", (t) => Reflect.apply(t.n, t, [...e]), () => "", (e) => R(e) || I(e));
	}
	function me(e) {
		return e.map((e) => R(e) || j(e) || z(e) ? Pr(String(e)) : e);
	}
	let he = {
		normalize: me,
		interpolate: (e) => e,
	...
	function ge(...e) {
		return P((t) => {
			let n, r = t;
			try {
				r.processor = he, n = Reflect.apply(Qn, null, [r, ...e]);
			} finally {
				r.processor = null;
			}
			return n;
		}, () => rr(...e), "translate", (t) => t[br](...e), (e) => [Pr(e)], (e) => I(e));
	}
	function _e(...e) {
		return P((t) => Reflect.apply(zn, null, [t, ...e]), () => Vn(...e), "number format", (t) => t[Sr](...e), Lr, (e) => R(e) || I(e));
	}
	function ve(...e) {
		return P((t) => Reflect.apply(Fn, null, [t, ...e]), () => Ln(...e), "datetime format", (t) => t[xr](...e), Lr, (e) => R(e) || I(e));
	}
	function ye(e) {
		D = e, O.pluralRules = D;
	}
	function be(e, t) {
		return P(() => {
			if (!e) return !1;
			let n = R(t) ? t : c.value, r = R(t) ? [n] : Gt(O, l.value, n);
			for (let t = 0; t < r.length; t++) {
				let n = H(r[t]), i = O.messageResolver(n, e);
				if (i === null && (i = n[e]), q(i) || X(i) || R(i)) return !0;
			}
			return !1;
		}, () => [e], "translate exists", (n) => Reflect.apply(n.te, n, [e, t]), Rr, (e) => z(e));
	}
	function Se(e) {
		let t = null, n = Gt(O, l.value, c.value);
	...
	function Te(e, t) {
		u.value[e] = u.value[e] || {};
		let n = { [e]: t };
		if (a) for (let e in n) F(n, e) && Ar(n[e]);
		t = n[e], xe(t, u.value[e]), O.messages = u.value;
	}
	function Ee(e) {
		return d.value[e] || {};
	}
	function De(e, t) {
		d.value[e] = t, O.datetimeFormats = d.value, Rn(O, e, t);
	}
	function Oe(e, t) {
		d.value[e] = M(d.value[e] || {}, t), O.datetimeFormats = d.value, Rn(O, e, t);
	}
	function U(e) {
		return f.value[e] || {};
	}
	function ke(e, t) {
		f.value[e] = t, O.numberFormats = f.value, Hn(O, e, t);
	}
	function W(e, t) {
		f.value[e] = M(f.value[e] || {}, t), O.numberFormats = f.value, Hn(O, e, t);
	}
	zr++, t && T && (S(t.locale, (e) => {
		s && (c.value = e, O.locale = e, An(O, c.value, l.value));
	}), S(t.fallbackLocale, (e) => {
		s && (l.value = e, O.fallbackLocale = e, An(O, c.value, l.value));
	}));
	let G = {
		id: zr,
		locale: A,
		...
		set inheritLocale(e) {
			s = e, e && t && (c.value = t.locale.value, l.value = t.fallbackLocale.value, An(O, c.value, l.value));
		},
	...
	return G.datetimeFormats = re, G.numberFormats = ae, G.rt = de, G.te = be, G.tm = Ce, G.d = fe, G.n = pe, G.getDateTimeFormat = Ee, G.setDateTimeFormat = De, G.mergeDateTimeFormat = Oe, G.getNumberFormat = U, G.setNumberFormat = ke, G.mergeNumberFormat = W, G[Er] = n, G[br] = ge, G[xr] = ve, G[Sr] = _e, process.env.NODE_ENV !== "production" && (G[Cr] = (e) => {
		O.__v_emitter = e;
	}, G[wr] = () => {
		O.__v_emitter = void 0;
	}), G;
}
var Ur = "vue-i18n: composer properties", Wr = {
	"vue-devtools-plugin-vue-i18n": "Vue I18n DevTools",
	"vue-i18n-resource-inspector": "Vue I18n DevTools",
	"vue-i18n-timeline": "Vue I18n"
}, Gr = { "vue-i18n-resource-inspector": "Search for scopes ..." }, Kr = { "vue-i18n-timeline": 16764185 }, qr;
async function Jr(e, t) {
	return new Promise((n, r) => {
		try {
			_r({
				id: "vue-devtools-plugin-vue-i18n",
				label: Wr["vue-devtools-plugin-vue-i18n"],
				...
				qr = r, r.on.visitComponentTree(({ componentInstance: e, treeNode: n }) => {
					Xr(e, n, t);
				}), r.on.inspectComponent(({ componentInstance: e, instanceData: n }) => {
					e.__VUE_I18N__ && n && (t.mode === "legacy" ? e.__VUE_I18N__ !== t.global.__composer && Zr(n, e.__VUE_I18N__) : Zr(n, e.__VUE_I18N__));
				}), r.addInspector({
					id: "vue-i18n-resource-inspector",
					label: Wr["vue-i18n-resource-inspector"],
					icon: "language",
					treeFilterPlaceholder: Gr["vue-i18n-resource-inspector"]
				}), r.on.getInspectorTree((n) => {
					n.app === e && n.inspectorId === "vue-i18n-resource-inspector" && ri(n, t);
				});
				let i = /* @__PURE__ */ new Map();
				r.on.getInspectorState(async (n) => {
					if (n.app === e && n.inspectorId === "vue-i18n-resource-inspector") {
						if (r.unhighlightElement(), oi(n, t), n.nodeId === "global") {
							if (!i.has(n.app)) {
					...
					n.app === e && n.inspectorId === "vue-i18n-resource-inspector" && li(n, t);
				}), r.addTimelineLayer({
					id: "vue-i18n-timeline",
					label: Wr["vue-i18n-timeline"],
...
function Qr(e) {
	...
	return Object.keys(e).forEach((n) => {
		let r = e[n];
		L(r) && "source" in r ? t[n] = ni(r) : q(r) && r.loc && r.loc.source ? t[n] = r.loc.source : B(r) ? t[n] = Qr(r) : t[n] = r;
	}), t;
}
var $r = {
	"<": "&lt;",
...
function ni(e) {
	return { _custom: {
		type: "function",
		display: `<span>ƒ</span> ${e.source ? `("${ei(e.source)}")` : "(?)"}`
	} };
}
function ri(e, t) {
	e.rootNodes.push({
...
function ci(e, t) {
	if (qr) {
		let n;
		t && "groupId" in t && (n = t.groupId, delete t.groupId), qr.addTimelineEvent({
...
var pi = o({
	...
	setup(e, t) {
		...
		return () => {
			...
			let s = di(t, a), c = i[br](e.keypath, s, o), l = M(N(), r), d = R(e.tag) || B(e.tag) ? e.tag : fi();
			return u(d, l, c);
		};
	}
});
...
function hi(e, t, n, r) {
	...
	return () => {
		...
		I(s) ? c = s.map((e, t) => {
			...
			return mi(r) && (r[0].key = `${e.type}-${t}`), r;
		}) : R(s) && (c = [s]);
		let l = M(N(), a), d = R(e.tag) || B(e.tag) ? e.tag : fi();
		return u(d, l, c);
	};
}
var gi = o({
...
function vi(e) {
	let t = (t) => {
		process.env.NODE_ENV !== "production" && ee(kr($.DEPRECATE_TRANSLATE_CUSTOME_DIRECTIVE));
	...
	return {
		created: (e, n) => {
			let [r, i] = t(n);
			T && (e.__i18nWatcher = S(i.locale, () => {
				n.instance && n.instance.$forceUpdate();
			})), e.__composer = i, e.textContent = r;
		},
		unmounted: (e) => {
			T && e.__i18nWatcher && (e.__i18nWatcher(), e.__i18nWatcher = void 0, delete e.__i18nWatcher), e.__composer && (e.__composer = void 0, delete e.__composer);
		},
		beforeUpdate: (e, { value: t }) => {
			if (e.__composer) {
				let n = e.__composer, r = yi(t);
...
function xi(e, t, ...n) {
	let r = V(n[0]) ? n[0] : {};
	(!z(r.globalInstall) || r.globalInstall) && ([pi.name, "I18nT"].forEach((t) => e.component(t, pi)), [gi.name, "I18nN"].forEach((t) => e.component(t, gi)), [Fi.name, "I18nD"].forEach((t) => e.component(t, Fi))), e.directive("t", vi(t));
}
var Si = A("global-vue-i18n");
function Ci(e = {}) {
	process.env.NODE_ENV;
	let t = !z(e.globalInjection) || e.globalInjection, n = /* @__PURE__ */ new Map(), [r, i] = Ti(e, !1), a = A(process.env.NODE_ENV === "production" ? "" : "vue-i18n");
	function o(e) {
		return n.get(e) || null;
	}
	function s(e, t) {
	...
	let l = {
		...
		async install(e, ...n) {
			...
			let r = null;
			t && (r = Pi(e, l.global)), xi(e, l, ...n);
			let o = e.unmount;
			if (e.unmount = () => {
				r && r(), l.dispose(), o();
			}, process.env.NODE_ENV !== "production") {
				if (!await Jr(e, l)) throw Q(Z.CANNOT_SETUP_VUE_DEVTOOLS_PLUGIN);
				let t = ye();
				{
					let e = i;
					e[Cr] && e[Cr](t);
...
function wi(e = {}) {
	...
	let n = Ei(t), r = Oi(n), i = Mr(t), a = Di(e, i);
	if (a === "global") return Nr(r, e, i), r;
	if (a === "parent") {
		let i = ki(n, t, e.__useComponent);
		return i ??= (process.env.NODE_ENV !== "production" && C(kr($.NOT_FOUND_PARENT_SCOPE)), r), i;
	}
	if (a === "isolated") {
		...
		a.__root = ki(n, t) || r;
		let o = Hr(a);
		i.__composerExtend && (o[Dr] = i.__composerExtend(o));
		let s = null;
		if (process.env.NODE_ENV !== "production") {
			s = ye();
			let e = o;
	...
	if (s == null) {
		let n = M({}, e);
		"__i18n" in i && (n.__i18n = i.__i18n), r && (n.__root = r), s = Hr(n), o.__composerExtend && (s[Dr] = o.__composerExtend(s)), ji(o, t, s), o.__setInstance(t, s);
	} else process.env.NODE_ENV !== "production" && a === "local" && C(kr($.DUPLICATE_USE_I18N_CALLING));
	return s;
}
function Ti(e, t) {
	let n = s(), r = n.run(() => Hr(e));
	if (r == null) throw Q(Z.UNEXPECTED_ERROR);
	return [n, r];
}
function Ei(e) {
	let t = d(e.isCE ? Si : e.appContext.app.__VUE_I18N_SYMBOL__);
...
function ji(e, t, n) {
	...
	p(() => {
		...
		let i = n;
		process.env.NODE_ENV !== "production" && (r && r.off("*", ci), i[wr] && i[wr](), delete t.__VUE_I18N__), e.__deleteInstance(t);
		let a = i[Dr];
		a && (a(), delete i[Dr]);
	}, t);
}
...
var Fi = o({
	...
	setup(e, t) {
		...
		return hi(e, t, In, (...e) => n[xr](...e));
	}
});
if (pn(Nt), hn(an), _n(Gt), process.env.NODE_ENV !== "production") {
	let e = ce();
	e.__INTLIFY__ = !0, Ft(e.__INTLIFY_DEVTOOLS_GLOBAL_HOOK__);
}
process.env.NODE_ENV;
var Ii = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, Li = o({
	__name: "MockBanner",
	setup(e) {
		let { t } = wi();
		return (e, n) => (g(), i("div", Ii, b(x(t)("mockBanner")), 1));
	}
}), Ri = Ci({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Ri), (e, t) => v(e.$slots, "default");
	}
}), Bi = { render() {
	return u(zi, {}, { default: () => u(Li) });
} };
