...
var zi = { class: "grid gap-8 md:grid-cols-2" }, Bi = { class: "rounded-lg border border-border bg-card p-6" }, Vi = { class: "mb-3 text-xl font-semibold text-foreground" }, Hi = { class: "text-sm text-muted-foreground" }, Ui = { class: "rounded-lg border border-border bg-card p-6" }, Wi = { class: "mb-3 text-xl font-semibold text-foreground" }, Gi = { class: "text-sm text-muted-foreground" }, Ki = s({
	__name: "AboutGrid",
	setup(e) {
		Ri("AboutGrid");
		let { t } = Ei();
		return (e, n) => (v(), i("div", zi, [a("div", Bi, [a("h2", Vi, S(C(t)("about.grid.whyExistsTitle")), 1), a("p", Hi, S(C(t)("about.grid.whyExistsDesc")), 1)]), a("div", Ui, [a("h2", Wi, S(C(t)("about.grid.methodologyTitle")), 1), a("p", Gi, S(C(t)("about.grid.methodologyDesc")), 1)])]));
	}
}), qi = Ti({
	legacy: !1,
	locale: "en",
