...
var Bi = { class: "mt-12 mx-auto max-w-3xl" }, Vi = { class: "mb-4 text-2xl font-bold text-foreground" }, Hi = { class: "space-y-4" }, Ui = { class: "block text-sm font-bold text-primary" }, Wi = { class: "block mt-1 text-sm text-muted-foreground" }, Gi = s({
	...
	setup(e) {
		...
		return (e, r) => (v(), i("section", Bi, [a("h2", Vi, C(w(n)("about.whatWeMeasure.title")), 1), a("ul", Hi, [(v(!0), i(t, null, b(o.value, (e) => (v(), i("li", {
			key: e.metric,
			class: "rounded-md border border-border p-4"
		}, [a("span", Ui, C(e.metric), 1), a("span", Wi, C(e.desc), 1)]))), 128))])]));
	}
}), Ki = Ei({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Ki), (e, t) => x(e.$slots, "default");
	}
}), Ji = { render() {
	return d(qi, {}, { default: () => d(Gi) });
} };
