...
import ee from "../../../../locales/fr.json";
...
var Ie = /<\/?[\w\s="/.':;#-\/]+>/, Le = (e) => Ie.test(e), Re = " ", ze = "\r", G = "\n", Be = "\u2028", Ve = "\u2029";
function He(e) {
	let t = e, n = 0, r = 1, i = 1, a = 0, o = (e) => t[e] === ze && t[e + 1] === G, s = (e) => t[e] === G, c = (e) => t[e] === Ve, l = (e) => t[e] === Be, u = (e) => o(e) || s(e) || c(e) || l(e), d = () => n, f = () => r, p = () => i, m = () => a, h = (e) => o(e) || c(e) || l(e) ? G : t[e], g = () => h(n), _ = () => h(n + a);
	function v() {
...
var Ue = void 0, We = "'", Ge = "tokenizer";
function Ke(e, t = {}) {
	let n = t.location !== !1, r = He(e), i = () => r.index(), a = () => U(r.line(), r.column(), r.index()), o = a(), s = i(), c = {
		currentType: 13,
		offset: s,
		startLoc: o,
		endLoc: o,
	...
	function h(e) {
		let t = "";
		for (; e.currentPeek() === Re || e.currentPeek() === G;) t += e.currentPeek(), e.peek();
		return t;
	}
	function g(e) {
		let t = h(e);
	...
	function ee(e, t) {
		...
		let r = () => {
			let t = e.currentPeek();
			return t === "{" ? _(e.peek()) : t === "@" || t === "|" || t === ":" || t === "." || t === Re || !t ? !1 : t === G ? (e.peek(), r()) : E(e, !1);
		}, i = r();
	...
	function E(e, t = !0) {
		let n = (t = !1, r = "") => {
			let i = e.currentPeek();
			return i === "{" || i === "@" || !i ? t : i === "|" ? !(r === Re || r === G) : i === Re ? (e.peek(), n(!0, Re)) : i === G ? (e.peek(), n(!0, G)) : !0;
		}, r = n();
		return t && e.resetPeek(), r;
	}
	function D(e, t) {
		let n = e.currentChar();
		return n === Ue ? Ue : t(n) ? (e.next(), n) : null;
	}
	function te(e) {
		let t = e.charCodeAt(0);
	...
	function A(e) {
		...
		for (;;) {
			...
			else if (n === Re || n === G) if (E(e)) t += n, e.next();
			else if (T(e)) break;
			else t += n, e.next();
			else t += n, e.next();
		}
	...
	function ce(e) {
		...
		for (; t = ie(e);) n += t;
		let r = e.currentChar();
		if (r && r !== "}" && r !== Ue && r !== Re && r !== G && r !== "　") {
			let t = fe(e);
			return d(W.INVALID_TOKEN_IN_PLACEHOLDER, a(), 0, n + t), n + t;
		}
		return e.currentChar() === Ue && d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), n;
	}
	function le(e) {
		g(e);
		let t = "";
		return e.currentChar() === "-" ? (e.next(), t += `-${k(e)}`) : t += k(e), e.currentChar() === Ue && d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), t;
	}
	function j(e) {
		return e !== We && e !== G;
	}
	function M(e) {
		...
		let r = e.currentChar();
		return r === G || r === Ue ? (d(W.UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER, a(), 0), r === G && (e.next(), m(e, "'")), n) : (m(e, "'"), n);
	}
	function ue(e) {
		let t = e.currentChar();
		switch (t) {
	...
	function me(e) {
		let t = (n) => {
			let r = e.currentChar();
			return r === "{" || r === "@" || r === "|" || r === "(" || r === ")" || !r || r === Re ? n : (n += r, e.next(), t(n));
		};
		return t("");
	}
	function P(e) {
	...
	function he(e, t) {
		...
		switch (e.currentChar()) {
			...
			default: {
				let r = !0, i = !0, o = !0;
				if (T(e)) return t.braceNest > 0 && d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), n = f(t, 1, P(e)), t.braceNest = 0, t.inLinked = !1, n;
	...
	function F(e, t) {
		...
		switch ((n === 7 || n === 8 || n === 11 || n === 9) && (i === G || i === Re) && d(W.INVALID_LINKED_FORMAT, a(), 0), i) {
			case "@": return e.next(), r = f(t, 7, "@"), t.inLinked = !0, r;
			case ".": return g(e), e.next(), f(t, 8, ".");
			case ":": return g(e), e.next(), f(t, 9, ":");
			default: return T(e) ? (r = f(t, 1, P(e)), t.braceNest = 0, t.inLinked = !1, r) : S(e, t) || w(e, t) ? (g(e), F(e, t)) : C(e, t) ? (g(e), f(t, 11, pe(e))) : ee(e, t) ? (g(e), i === "{" ? he(e, t) || r : f(t, 10, me(e))) : (n === 7 && d(W.INVALID_LINKED_FORMAT, a(), 0), t.braceNest = 0, t.inLinked = !1, ge(e, t));
		}
	}
	function ge(e, t) {
		let n = { type: 13 };
		...
		switch (e.currentChar()) {
			...
			default:
				if (T(e)) return n = f(t, 1, P(e)), t.braceNest = 0, t.inLinked = !1, n;
	...
	function _e() {
		...
		return c.lastType = e, c.lastOffset = t, c.lastStartLoc = n, c.lastEndLoc = o, c.offset = i(), c.startLoc = a(), r.currentChar() === Ue ? f(c, 13) : ge(r, c);
	}
	return {
		nextToken: _e,
		currentOffset: i,
...
var qe = "parser", Je = /(?:\\\\|\\'|\\u([0-9a-fA-F]{4})|\\U([0-9a-fA-F]{6}))/g, Ye = /\\([\\@{}|])/g;
function Xe(e, t) {
	return t;
}
function Ze(e, t, n) {
...
function Qe(e = {}) {
	...
	function o(e, t) {
		...
		return r.value = t.replace(Ye, Xe), a(r, e.currentOffset(), e.currentPosition()), r;
	}
	function s(e, t) {
	...
	function l(e, t) {
		...
		return o.value = t.replace(Je, Ze), e.nextToken(), a(o, e.currentOffset(), e.currentPosition()), o;
	}
	function u(e) {
		let t = e.nextToken(), n = e.context(), { lastOffset: o, lastStartLoc: s } = n, c = i(8, o, s);
		return t.type === 11 ? (t.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, n.lastStartLoc, 0, K(t)), c.value = t.value || "", a(c, e.currentOffset(), e.currentPosition()), { node: c }) : (r(e, W.UNEXPECTED_EMPTY_LINKED_MODIFIER, n.lastStartLoc, 0), c.value = "", a(c, o, s), {
			nextConsumeToken: t,
			node: c
		});
	}
	...
	function f(e) {
		...
		switch (o.type !== 9 && r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, K(o)), o = e.nextToken(), o.type === 2 && (o = e.nextToken()), o.type) {
			case 10:
				o.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, K(o)), n.key = d(e, o.value || "");
				break;
			case 4:
				o.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, K(o)), n.key = c(e, o.value || "");
				break;
			case 5:
				o.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, K(o)), n.key = s(e, o.value || "");
				break;
			case 6:
				o.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, K(o)), n.key = l(e, o.value || "");
				break;
			default: {
	...
	function p(e) {
		...
		do {
			...
			switch (u = null, i.type) {
				case 0:
					i.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, K(i)), n.items.push(o(e, i.value || ""));
					break;
				case 5:
					i.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, K(i)), n.items.push(s(e, i.value || ""));
					break;
				case 4:
					i.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, K(i)), n.items.push(c(e, i.value || ""));
					break;
				case 6:
					i.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, K(i)), n.items.push(l(e, i.value || ""));
					break;
				case 7: {
					let t = f(e);
	...
	function g(n) {
		let o = Ke(n, P({}, e)), s = o.context(), c = i(0, s.offset, s.startLoc);
...
function ht(e, t = {}) {
	let n = P({}, t), r = !!n.jit, i = !!n.minify, a = n.optimize == null ? !0 : n.optimize, o = Qe(n).parse(e);
...
function In(e = {}) {
	...
	let x = R(e.messageResolver) ? e.messageResolver : Tn || hn, S = R(e.localeFallbacker) ? e.localeFallbacker : Dn || tn, C = V(e.fallbackContext) ? e.fallbackContext : void 0, w = e, ee = V(w.__datetimeFormatters) ? w.__datetimeFormatters : /* @__PURE__ */ new Map(), T = V(w.__numberFormatters) ? w.__numberFormatters : /* @__PURE__ */ new Map(), E = V(w.__meta) ? w.__meta : {};
	Fn++;
	let D = {
		version: n,
		cid: Fn,
	...
	return D.datetimeFormats = s, D.numberFormats = c, D.__datetimeFormatters = ee, D.__numberFormatters = T, process.env.NODE_ENV !== "production" && (D.__v_emitter = w.__v_emitter == null ? void 0 : w.__v_emitter), process.env.NODE_ENV !== "production" && qt(D, n, E), D;
}
var Ln = (e) => ({ [e]: F() });
function Rn(e, t) {
...
function lr(e, ...t) {
	...
	if (S) return b;
	let w = pr(e, C, sr(_r(e, v, y, l))), ee = r ? r(w, c) : w;
	if (f && z(ee) && (ee = be(ee)), process.env.NODE_ENV !== "production") {
		let t = {
			timestamp: Date.now(),
			key: z(c) ? c : X(b) ? b.key : "",
...
var Ji = s({
	...
	return n;
}, Xi = { class: "mt-12 mx-auto max-w-3xl" }, Zi = { class: "mb-4 text-2xl font-bold text-foreground" }, Qi = { class: "space-y-4" }, $i = { class: "block text-sm font-bold text-primary" }, ea = { class: "block mt-1 text-sm text-muted-foreground" };
function ta(e, n, r, o, s, c) {
	return v(), i("section", Xi, [a("h2", Zi, C(o.t("about.whatWeMeasure.title")), 1), a("ul", Qi, [(v(!0), i(t, null, b(o.metrics, (e) => (v(), i("li", {
		key: e.metric,
		class: "rounded-md border border-border p-4"
	}, [a("span", $i, C(e.metric), 1), a("span", ea, C(e.desc), 1)]))), 128))])]);
}
var na = Yi(Ji, [["render", ta], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/about/WhatWeMeasure.vue"]]), ra = Pi({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
...
var oa = Yi(ia, [["render", aa], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/scripts/Wrapper.vue"]]), sa = { render() {
	return d(oa, {}, { default: () => d(na) });
} };
