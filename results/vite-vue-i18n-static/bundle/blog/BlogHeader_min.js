...
}), Kr = { class: "mb-2 text-3xl font-bold text-foreground" }, qr = { class: "mb-10 text-muted-foreground" }, Jr = s({
	__name: "BlogHeader",
	setup(e) {
		let { t: n } = Lr();
		return (e, r) => (m(), i(t, null, [
			o(Gr),
			a("h1", Kr, _(v(n)("blog.header.title")), 1),
			a("p", qr, _(v(n)("blog.header.description")), 1)
		], 64));
	}
});
