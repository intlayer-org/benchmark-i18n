...
process.env.NODE_ENV;
var Ri = { class: "grid gap-6 md:grid-cols-2" }, zi = { class: "mb-3 flex items-center gap-3" }, Bi = { class: "rounded-full bg-accent px-3 py-0.5 text-xs font-medium text-accent-foreground" }, Vi = { class: "text-xs text-muted-foreground" }, Hi = { class: "mb-2 text-lg font-semibold text-foreground" }, Ui = { class: "mb-4 text-sm text-muted-foreground" }, Wi = {
	type: "button",
	...
	setup(e) {
		...
		return (e, r) => (_(), i("div", Ri, [(_(!0), i(t, null, y(s.value, (e) => (_(), i("article", {
			key: e.title,
			class: "rounded-lg border border-border bg-card p-6"
		}, [
			a("div", zi, [a("span", Bi, S(e.category), 1), a("span", Vi, S(e.date), 1)]),
			a("h2", Hi, S(e.title), 1),
			a("p", Ui, S(e.excerpt), 1),
			a("button", Wi, S(C(n)("blog.list.readMore")), 1)
		]))), 128))]));
	}
}), Ki = Ti({
	legacy: !1,
