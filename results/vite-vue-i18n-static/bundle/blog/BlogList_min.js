...
var Ki = s({
	...
	setup(e, { expose: t }) {
		...
		let { t: n } = Pi(), i = [
			...
			postIndices: i,
			posts: r(() => i.map((e) => ({
				title: n(`blog.list.post${e}Title`),
				date: n(`blog.list.post${e}Date`),
				excerpt: n(`blog.list.post${e}Excerpt`),
				category: n(`blog.list.post${e}Category`)
			})))
		};
	...
	return n;
}, Ji = { class: "grid gap-6 md:grid-cols-2" }, Yi = { class: "mb-3 flex items-center gap-3" }, Xi = { class: "rounded-full bg-accent px-3 py-0.5 text-xs font-medium text-accent-foreground" }, Zi = { class: "text-xs text-muted-foreground" }, Qi = { class: "mb-2 text-lg font-semibold text-foreground" }, $i = { class: "mb-4 text-sm text-muted-foreground" }, ea = {
	type: "button",
	class: "text-sm font-medium text-primary hover:underline"
};
function ta(e, n, r, o, s, c) {
	return _(), i("div", Ji, [(_(!0), i(t, null, y(o.posts, (e) => (_(), i("article", {
		key: e.title,
		class: "rounded-lg border border-border bg-card p-6"
	}, [
		a("div", Yi, [a("span", Xi, S(e.category), 1), a("span", Zi, S(e.date), 1)]),
		a("h2", Qi, S(e.title), 1),
		a("p", $i, S(e.excerpt), 1),
		a("button", ea, S(o.t("blog.list.readMore")), 1)
	]))), 128))]);
}
var na = qi(Ki, [["render", ta], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/blog/BlogList.vue"]]), ra = Ni({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
