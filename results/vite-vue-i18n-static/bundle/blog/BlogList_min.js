...
var Gr = { class: "grid gap-6 md:grid-cols-2" }, Kr = { class: "mb-3 flex items-center gap-3" }, qr = { class: "rounded-full bg-accent px-3 py-0.5 text-xs font-medium text-accent-foreground" }, Jr = { class: "text-xs text-muted-foreground" }, Yr = { class: "mb-2 text-lg font-semibold text-foreground" }, Xr = { class: "mb-4 text-sm text-muted-foreground" }, Zr = {
	type: "button",
	...
	setup(e) {
		...
		return (e, r) => (m(), i("div", Gr, [(m(!0), i(t, null, g(s.value, (e) => (m(), i("article", {
			key: e.title,
			class: "rounded-lg border border-border bg-card p-6"
		}, [
			a("div", Kr, [a("span", qr, v(e.category), 1), a("span", Jr, v(e.date), 1)]),
			a("h2", Yr, v(e.title), 1),
			a("p", Xr, v(e.excerpt), 1),
			a("button", Zr, v(y(n)("blog.list.readMore")), 1)
		]))), 128))]));
	}
});
