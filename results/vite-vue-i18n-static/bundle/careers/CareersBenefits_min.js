...
process.env.NODE_ENV;
var Ri = { class: "mb-12 grid gap-4 md:grid-cols-3" }, zi = { class: "text-sm font-semibold text-foreground" }, Bi = { class: "text-xs text-muted-foreground" }, Vi = s({
	...
	setup(e) {
		...
		return (e, o) => (_(), i("div", Ri, [(_(), i(t, null, y(r, (e) => a("div", {
			key: e.labelKey,
			class: "rounded-lg border border-border bg-card p-4 text-center"
		}, [a("p", zi, S(C(n)(e.labelKey)), 1), a("p", Bi, S(C(n)(e.valueKey)), 1)])), 64))]));
	}
}), Hi = Ti({
	legacy: !1,
	locale: "en",
