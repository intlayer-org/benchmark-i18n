...
}), Kr = { class: "mb-2 text-3xl font-bold text-foreground" }, qr = { class: "mb-4 text-muted-foreground" }, Jr = s({
	__name: "CareersHeader",
	setup(e) {
		let { t: n } = Lr();
		return (e, r) => (m(), i(t, null, [
			o(Gr),
			a("h1", Kr, _(v(n)("careers.header.title")), 1),
			a("p", qr, _(v(n)("careers.header.description")), 1)
		], 64));
	}
});
