...
}), Zi = { class: "mb-2 text-3xl font-bold text-foreground" }, Qi = { class: "mb-4 text-muted-foreground" };
function $i(e, n, r, s, c, l) {
	return _(), i(t, null, [
		o(s.MockBanner),
		a("h1", Zi, x(s.t("careers.header.title")), 1),
		a("p", Qi, x(s.t("careers.header.description")), 1)
	], 64);
}
var ea = Ki(Xi, [["render", $i], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/careers/CareersHeader.vue"]]), ta = Mi({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
