...
import { Fragment, Text, computed, createElementBlock, createElementVNode, createVNode, defineComponent, effectScope, getCurrentInstance, getCurrentScope, h, inject, isRef, onMounted, onScopeDispose, onUnmounted, openBlock, ref, renderList, renderSlot, shallowRef, toDisplayString, watch } from "vue";
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock(Fragment, null, [createElementVNode("h2", _hoisted_1, toDisplayString($setup.t("careers.openPositions.title")), 1), createElementVNode("div", _hoisted_2, [(openBlock(), createElementBlock(Fragment, null, renderList($setup.openings, (o, i) => {
		return createElementVNode("div", {
			...
			createElementVNode("h3", _hoisted_3, toDisplayString($setup.t(`careers.openPositions.${o.titleKey}`)), 1),
			createElementVNode("p", _hoisted_4, toDisplayString($setup.t(`careers.openPositions.${o.descKey}`)), 1),
			createElementVNode("div", _hoisted_5, [
				createElementVNode("span", _hoisted_6, toDisplayString($setup.t(`careers.openPositions.${o.deptKey}`)), 1),
				createElementVNode("span", _hoisted_7, toDisplayString($setup.t(`careers.openPositions.${o.locationKey}`)), 1),
				createElementVNode("span", _hoisted_8, toDisplayString($setup.t(`careers.openPositions.${o.typeKey}`)), 1)
			])
		]), createElementVNode("button", _hoisted_9, toDisplayString($setup.t("careers.openPositions.applyNow")), 1)]);
	}), 64))])], 64);
}
var OpenPositions_default = _plugin_vue_export_helper_default(OpenPositions_vue_vue_type_script_setup_true_lang_default, [["render", _sfc_render$1], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/careers/OpenPositions.vue"]]);
var i18n = createI18n({
	legacy: false,
	locale: "en",
	fallbackLocale: "en",
...
var OpenPositions_wrapper_default = { render() {
	return h(Wrapper_default, {}, { default: () => h(OpenPositions_default) });
} };
export { OpenPositions_wrapper_default as default };
