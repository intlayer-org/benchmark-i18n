...
function kr(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = w ? h : _, s = R(e.inheritLocale) ? e.inheritLocale : !0, c = o(t && s ? t.locale.value : L(e.locale) ? e.locale : on), l = o(t && s ? t.fallbackLocale.value : L(e.fallbackLocale) || F(e.fallbackLocale) || B(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(vr(c.value, e)), d = o(B(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(B(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : R(e.missingWarn) || re(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : R(e.fallbackWarn) || re(e.fallbackWarn) ? e.fallbackWarn : !0, g = t ? t.fallbackRoot : R(e.fallbackRoot) ? e.fallbackRoot : !0, v = !!e.fallbackFormat, y = I(e.missing) ? e.missing : null, S = I(e.missing) ? Dr(e.missing) : null, C = I(e.postTranslation) ? e.postTranslation : null, T = t ? t.warnHtmlMessage : R(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, E = !!e.escapeParameter, ee = t ? t.modifiers : B(e.modifiers) ? e.modifiers : {}, D = e.pluralRules || t && t.pluralRules, O;
	O = (() => {
		i && yn(null);
		let t = {
			version: ir,
	...
	let N = (e, n, r, a, o, s) => {
		...
		if (r !== "translate exists" && A(c) && c === -1 || r === "translate exists" && !c) {
			let [e, i] = n();
			if (process.env.NODE_ENV !== "production" && t && L(e) && ue(r, i) && (g && (wn(m, e) || Tn(p, e)) && x(gr($.FALLBACK_TO_ROOT, {
				key: e,
				type: r
...
var Gr = { class: "mb-6 text-2xl font-bold text-foreground" }, Kr = { class: "space-y-4" }, qr = { class: "text-base font-semibold text-foreground" }, Jr = { class: "text-sm text-muted-foreground" }, Yr = { class: "mt-2 flex gap-2" }, Xr = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, Zr = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, Qr = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, $r = {
	type: "button",
	...
	setup(e) {
		...
		return (e, o) => (m(), i(t, null, [a("h2", Gr, v(y(n)("careers.openPositions.title")), 1), a("div", Kr, [(m(), i(t, null, g(r, (e, t) => a("div", {
			...
			a("h3", qr, v(y(n)(`careers.openPositions.${e.titleKey}`)), 1),
			a("p", Jr, v(y(n)(`careers.openPositions.${e.descKey}`)), 1),
			a("div", Yr, [
				a("span", Xr, v(y(n)(`careers.openPositions.${e.deptKey}`)), 1),
				a("span", Zr, v(y(n)(`careers.openPositions.${e.locationKey}`)), 1),
				a("span", Qr, v(y(n)(`careers.openPositions.${e.typeKey}`)), 1)
			])
		]), a("button", $r, v(y(n)("careers.openPositions.applyNow")), 1)])), 64))])], 64));
	}
});
