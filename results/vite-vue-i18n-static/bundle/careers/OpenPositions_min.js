...
function Wr(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = D ? v : x, s = !z(e.inheritLocale) || e.inheritLocale, c = o(t && s ? t.locale.value : R(e.locale) ? e.locale : dn), l = o(t && s ? t.fallbackLocale.value : R(e.fallbackLocale) || I(e.fallbackLocale) || V(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(Nr(c.value, e)), d = o(V(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(V(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : z(e.missingWarn) || oe(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : z(e.fallbackWarn) || oe(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : !z(e.fallbackRoot) || e.fallbackRoot, g = !!e.fallbackFormat, _ = L(e.missing) ? e.missing : null, y = L(e.missing) ? Hr(e.missing) : null, b = L(e.postTranslation) ? e.postTranslation : null, S = t ? t.warnHtmlMessage : !z(e.warnHtmlMessage) || e.warnHtmlMessage, C = !!e.escapeParameter, E = t ? t.modifiers : V(e.modifiers) ? e.modifiers : {}, ee = e.pluralRules || t && t.pluralRules, O;
	O = (() => {
		i && wn(null);
		let t = {
			version: br,
...
process.env.NODE_ENV;
var Ri = { class: "mb-6 text-2xl font-bold text-foreground" }, zi = { class: "space-y-4" }, Bi = { class: "text-base font-semibold text-foreground" }, Vi = { class: "text-sm text-muted-foreground" }, Hi = { class: "mt-2 flex gap-2" }, Ui = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, Wi = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, Gi = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, Ki = {
	type: "button",
	...
	setup(e) {
		...
		return (e, o) => (_(), i(t, null, [a("h2", Ri, S(C(n)("careers.openPositions.title")), 1), a("div", zi, [(_(), i(t, null, y(r, (e, t) => a("div", {
			...
			a("h3", Bi, S(C(n)(`careers.openPositions.${e.titleKey}`)), 1),
			a("p", Vi, S(C(n)(`careers.openPositions.${e.descKey}`)), 1),
			a("div", Hi, [
				a("span", Ui, S(C(n)(`careers.openPositions.${e.deptKey}`)), 1),
				a("span", Wi, S(C(n)(`careers.openPositions.${e.locationKey}`)), 1),
				a("span", Gi, S(C(n)(`careers.openPositions.${e.typeKey}`)), 1)
			])
		]), a("button", Ki, S(C(n)("careers.openPositions.applyNow")), 1)])), 64))])], 64));
	}
}), Ji = Ti({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Ji), (e, t) => b(e.$slots, "default");
	}
}), Xi = { render() {
	return d(Yi, {}, { default: () => d(qi) });
} };
