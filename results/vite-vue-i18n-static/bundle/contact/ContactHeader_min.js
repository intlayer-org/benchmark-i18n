...
c({
	...
	setup(e, t) {
		...
		return () => {
			...
			let s = Nr(t, a), c = i[sr](e.keypath, s, o), l = j(M(), r);
			return u(L(e.tag) || z(e.tag) ? e.tag : Pr(), l, c);
		};
	}
});
function Fr(e) {
...
function zr(e) {
	let t = d(e.isCE ? Lr : e.appContext.app.__VUE_I18N_SYMBOL__);
...
var Gr = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, Kr = c({
	__name: "MockBanner",
	setup(e) {
		let { t } = Rr();
		return (e, n) => (h(), i("div", Gr, v(y(t)("mockBanner")), 1));
	}
}), qr = { class: "mb-2 text-3xl font-bold text-foreground" }, Jr = { class: "mb-8 text-muted-foreground" }, Yr = {
	...
	setup(e) {
		let { t: n } = Rr();
		return (e, r) => (h(), i(t, null, [
			s(Kr),
			a("h1", qr, v(y(n)("contact.header.title")), 1),
			a("p", Jr, [
				o(v(y(n)("contact.header.description")) + " ", 1),
				a("a", Yr, v(y(n)("shared.contactEmail")), 1),
				r[0] ||= o(". ", -1)
			])
		], 64));
	}
