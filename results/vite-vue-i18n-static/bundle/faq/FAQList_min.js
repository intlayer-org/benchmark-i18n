...
process.env.NODE_ENV;
var Ri = { class: "mx-auto max-w-3xl space-y-4" }, zi = { class: "cursor-pointer px-6 py-4 text-sm font-medium text-foreground hover:bg-accent/50 transition-colors" }, Bi = { class: "px-6 pb-4 text-sm text-muted-foreground" }, Vi = s({
	__name: "FAQList",
	setup(e) {
		let { t: n } = Ei(), r = [
			1,
		...
		return (e, n) => (_(), i("div", Ri, [(_(!0), i(t, null, y(C(r), (e, t) => (_(), i("details", {
			key: t,
			class: "group rounded-lg border border-border bg-card"
		}, [a("summary", zi, S(e.q), 1), a("p", Bi, S(e.a), 1)]))), 128))]));
	}
}), Hi = Ti({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Hi), (e, t) => b(e.$slots, "default");
	}
}), Wi = { render() {
