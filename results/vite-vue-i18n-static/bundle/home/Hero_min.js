...
var qi = s({
	...
	return n;
}, Yi = { class: "mb-16 text-center" }, Xi = { class: "mb-4 text-4xl font-bold tracking-tight text-foreground" }, Zi = { class: "mx-auto max-w-2xl text-lg text-muted-foreground" }, Qi = { class: "mt-8 flex justify-center gap-4" }, $i = {
	type: "button",
...
function ta(e, t, n, r, o, s) {
	return v(), i("section", Yi, [
		a("h1", Xi, S(r.t("home.hero.title")), 1),
		a("p", Zi, S(r.t("home.hero.description")), 1),
		a("div", Qi, [a("button", $i, S(r.t("home.hero.viewResults")), 1), a("button", ea, S(r.t("home.hero.methodology")), 1)])
	]);
}
var na = Ji(qi, [["render", ta], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/home/Hero.vue"]]), ra = Ni({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
...
var oa = Ji(ia, [["render", aa], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/scripts/Wrapper.vue"]]), sa = { render() {
