...
var zi = { class: "mb-16 text-center" }, Bi = { class: "mb-4 text-4xl font-bold tracking-tight text-foreground" }, Vi = { class: "mx-auto max-w-2xl text-lg text-muted-foreground" }, Hi = { class: "mt-8 flex justify-center gap-4" }, Ui = {
	type: "button",
	...
	setup(e) {
		Ri("Hero");
		let { t } = Ei();
		return (e, n) => (v(), i("section", zi, [
			a("h1", Bi, S(C(t)("home.hero.title")), 1),
			a("p", Vi, S(C(t)("home.hero.description")), 1),
			a("div", Hi, [a("button", Ui, S(C(t)("home.hero.viewResults")), 1), a("button", Wi, S(C(t)("home.hero.methodology")), 1)])
		]));
	}
}), Ki = Ti({
	legacy: !1,
