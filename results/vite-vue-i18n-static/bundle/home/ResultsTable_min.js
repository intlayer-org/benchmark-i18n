...
var qr = { class: "mb-6 text-2xl font-bold text-foreground" }, Jr = { class: "overflow-x-auto rounded-lg border border-border" }, Yr = { class: "w-full text-sm" }, Xr = { class: "bg-muted" }, Zr = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, Qr = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, $r = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, ei = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, ti = { class: "px-4 py-3 font-medium text-foreground" }, ni = { class: "px-4 py-3 text-muted-foreground" }, ri = { class: "px-4 py-3 text-muted-foreground" }, ii = { class: "px-4 py-3 text-muted-foreground" }, ai = s({
	__name: "ResultsTable",
	setup(e) {
		Kr("ResultsTable");
		let { t: n } = zr(), o = r(() => [
		...
		return (e, r) => (h(), i("section", null, [a("h2", qr, y(b(n)("home.resultsTable.title")), 1), a("div", Jr, [a("table", Yr, [a("thead", Xr, [a("tr", null, [
			a("th", Zr, y(b(n)("home.resultsTable.library")), 1),
			a("th", Qr, y(b(n)("home.resultsTable.bundleSize")), 1),
			a("th", $r, y(b(n)("home.resultsTable.lookupTime")), 1),
			a("th", ei, y(b(n)("home.resultsTable.lazyLoading")), 1)
		])]), a("tbody", null, [(h(!0), i(t, null, _(o.value, (e) => (h(), i("tr", {
			key: e.lib,
