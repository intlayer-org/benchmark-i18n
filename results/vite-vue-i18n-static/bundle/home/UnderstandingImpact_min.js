...
import { Fragment as t, Text as n, computed as r, createElementBlock as i, createElementVNode as a, createTextVNode as o, createVNode as s, defineComponent as c, getCurrentScope as l, h as u, inject as d, onBeforeMount as f, onMounted as p, onScopeDispose as m, onUnmounted as h, openBlock as g, ref as _, shallowRef as v, toDisplayString as y, unref as b, watch as x } from "vue";
function S(e, t) {
...
function Ar(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = T ? _ : v, s = z(e.inheritLocale) ? e.inheritLocale : !0, c = o(t && s ? t.locale.value : R(e.locale) ? e.locale : sn), l = o(t && s ? t.fallbackLocale.value : R(e.fallbackLocale) || I(e.fallbackLocale) || V(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(yr(c.value, e)), d = o(V(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(V(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : z(e.missingWarn) || re(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : z(e.fallbackWarn) || re(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : z(e.fallbackRoot) ? e.fallbackRoot : !0, g = !!e.fallbackFormat, y = L(e.missing) ? e.missing : null, b = L(e.missing) ? Or(e.missing) : null, C = L(e.postTranslation) ? e.postTranslation : null, w = t ? t.warnHtmlMessage : z(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, E = !!e.escapeParameter, D = t ? t.modifiers : V(e.modifiers) ? e.modifiers : {}, O = e.pluralRules || t && t.pluralRules, k;
	k = (() => {
		i && bn(null);
		let t = {
			version: ar,
...
c({
	...
	setup(e, t) {
		...
		return () => {
			...
			let s = Pr(t, a), c = i[cr](e.keypath, s, o), l = M(N(), r);
			return u(R(e.tag) || B(e.tag) ? e.tag : Fr(), l, c);
		};
	}
});
function Ir(e) {
...
function Br(e) {
	let t = d(e.isCE ? Rr : e.appContext.app.__VUE_I18N_SYMBOL__);
...
var qr = { class: "mb-16 mx-auto max-w-3xl space-y-6" }, Jr = { class: "text-2xl font-bold text-foreground" }, Yr = { class: "rounded-lg border border-border bg-card p-6" }, Xr = { class: "mb-2 text-lg font-semibold text-foreground" }, Zr = { class: "text-sm text-muted-foreground" }, Qr = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, $r = { class: "rounded-lg border border-border bg-card p-6" }, ei = { class: "mb-2 text-lg font-semibold text-foreground" }, ti = { class: "text-sm text-muted-foreground" }, ni = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, ri = { class: "text-foreground" }, ii = { class: "text-foreground" }, ai = { class: "text-foreground" }, oi = { class: "rounded-lg border border-border bg-card p-6" }, si = { class: "mb-2 text-lg font-semibold text-foreground" }, ci = { class: "text-sm text-muted-foreground" }, li = c({
	__name: "UnderstandingImpact",
	setup(e) {
		Kr("UnderstandingImpact");
		let { t } = zr();
		return (e, n) => (g(), i("section", qr, [
			a("h2", Jr, y(b(t)("home.understandingImpact.title")), 1),
			a("div", Yr, [
				a("h3", Xr, y(b(t)("home.understandingImpact.singleJsonTitle")), 1),
				a("p", Zr, y(b(t)("home.understandingImpact.singleJsonIntro")), 1),
				a("ul", Qr, [
					a("li", null, y(b(t)("home.understandingImpact.singleJsonBullet1")), 1),
					a("li", null, y(b(t)("home.understandingImpact.singleJsonBullet2")), 1),
					a("li", null, y(b(t)("home.understandingImpact.singleJsonBullet3")), 1)
				])
			]),
			a("div", $r, [
				a("h3", ei, y(b(t)("home.understandingImpact.tradeOffsTitle")), 1),
				a("p", ti, y(b(t)("home.understandingImpact.tradeOffsIntro")), 1),
				a("ul", ni, [
					a("li", null, [a("strong", ri, y(b(t)("home.understandingImpact.waterfallLabel")), 1), o(" " + y(b(t)("home.understandingImpact.waterfallDesc")), 1)]),
					a("li", null, [a("strong", ii, y(b(t)("home.understandingImpact.foucLabel")), 1), o(" " + y(b(t)("home.understandingImpact.foucDesc")), 1)]),
					a("li", null, [a("strong", ai, y(b(t)("home.understandingImpact.cacheLabel")), 1), o(" " + y(b(t)("home.understandingImpact.cacheDesc")), 1)])
				])
			]),
			a("div", oi, [a("h3", si, y(b(t)("home.understandingImpact.measuresTitle")), 1), a("p", ci, y(b(t)("home.understandingImpact.measuresDesc")), 1)])
		]));
	}
});
