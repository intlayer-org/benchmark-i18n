...
import { Fragment as t, Text as n, computed as r, createElementBlock as i, createElementVNode as a, createTextVNode as o, createVNode as s, defineComponent as c, effectScope as l, getCurrentInstance as u, getCurrentScope as d, h as f, inject as p, isRef as m, onBeforeMount as h, onMounted as g, onScopeDispose as _, onUnmounted as v, openBlock as y, ref as b, renderSlot as x, shallowRef as S, toDisplayString as C, unref as w, watch as T } from "vue";
function E(e, t) {
...
var te = /\{([0-9a-zA-Z]+)\}/g;
function ne(e, ...t) {
	return t.length === 1 && V(t[0]) && (t = t[0]), (!t || !t.hasOwnProperty) && (t = {}), e.replace(te, (e, n) => t.hasOwnProperty(n) ? t[n] : "");
}
var j = (e, t = !1) => t ? Symbol.for(e) : Symbol(e), re = (e, t, n) => ie({
	l: e,
	k: t,
	s: n
}), ie = (e) => JSON.stringify(e).replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029").replace(/\u0027/g, "\\u0027"), M = (e) => typeof e == "number" && isFinite(e), ae = (e) => ge(e) === "[object Date]", oe = (e) => ge(e) === "[object RegExp]", se = (e) => H(e) && Object.keys(e).length === 0, N = Object.assign, ce = Object.create, P = (e = null) => ce(e), F, le = () => F ||= typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : P();
function ue(e) {
...
function fe(e) {
	return e = e.replace(/(\w+)\s*=\s*"([^"]*)"/g, (e, t, n) => `${t}="${de(n)}"`), e = e.replace(/(\w+)\s*=\s*'([^']*)'/g, (e, t, n) => `${t}='${de(n)}'`), /\s*on\w+\s*=\s*["']?[^"'>]+["']?/gi.test(e) && (process.env.NODE_ENV !== "production" && E("Potentially dangerous event handlers detected in translation. Consider removing onclick, onerror, etc. from your translation messages."), e = e.replace(/(\s+)(on)(\w+\s*=)/gi, "$1&#111;n$3")), [/(\s+(?:href|src|action|formaction)\s*=\s*["']?)\s*javascript:/gi, /(style\s*=\s*["'][^"']*url\s*\(\s*)javascript:/gi].forEach((t) => {
...
var L = Array.isArray, R = (e) => typeof e == "function", z = (e) => typeof e == "string", B = (e) => typeof e == "boolean", V = (e) => typeof e == "object" && !!e, me = (e) => V(e) && R(e.then) && R(e.catch), he = Object.prototype.toString, ge = (e) => he.call(e), H = (e) => ge(e) === "[object Object]", _e = (e) => e == null ? "" : L(e) || H(e) && e.toString === he ? JSON.stringify(e, null, 2) : String(e);
function ve(e, t = "") {
	return e.reduce((e, n, r) => r === 0 ? e + n : e + t + n, "");
}
var ye = 2;
function be(e, t = 0, n = e.length) {
	let r = e.split(/\r?\n/), i = 0, a = [];
	for (let e = 0; e < r.length; e++) if (i += r[e].length + 1, i >= t) {
		for (let o = e - ye; o <= e + ye || n > i; o++) {
...
var Se = (e) => !V(e) || L(e);
function Ce(e, t) {
	if (Se(e) || Se(t)) throw Error("Invalid value");
	let n = [{
		src: e,
		des: t
	}];
	for (; n.length;) {
		...
		Object.keys(e).forEach((r) => {
			r !== "__proto__" && (V(e[r]) && !V(t[r]) && (t[r] = Array.isArray(e[r]) ? [] : P()), Se(t[r]) || Se(e[r]) ? t[r] = e[r] : n.push({
				src: e[r],
				des: t[r]
			}));
		});
...
function De(e, t, n = {}) {
	let { domain: r, messages: i, args: a } = n, o = process.env.NODE_ENV === "production" ? e : ne((i || Ee)[e] || "", ...a || []), s = SyntaxError(String(o));
	return s.code = e, t && (s.location = t), s.domain = r, s;
}
function Oe(e) {
	throw e;
}
var ke = /<\/?[\w\s="/.':;#-\/]+>/, Ae = (e) => ke.test(e), W = " ", je = "\r", G = "\n", Me = "\u2028", Ne = "\u2029";
function Pe(e) {
	let t = e, n = 0, r = 1, i = 1, a = 0, o = (e) => t[e] === je && t[e + 1] === G, s = (e) => t[e] === G, c = (e) => t[e] === Ne, l = (e) => t[e] === Me, u = (e) => o(e) || s(e) || c(e) || l(e), d = () => n, f = () => r, p = () => i, m = () => a, h = (e) => o(e) || c(e) || l(e) ? G : t[e], g = () => h(n), _ = () => h(n + a);
	function v() {
...
var Fe = void 0, Ie = "'", Le = "tokenizer";
function Re(e, t = {}) {
	let n = t.location !== !1, r = Pe(e), i = () => r.index(), a = () => we(r.line(), r.column(), r.index()), o = a(), s = i(), c = {
		currentType: 13,
		offset: s,
		startLoc: o,
		endLoc: o,
	...
	function d(e, t, r, ...i) {
		...
		if (t.column += r, t.offset += r, u) {
			let r = De(e, n ? Te(a.startLoc, t) : null, {
				domain: Le,
				args: i
			});
			u(r);
	...
	function f(e, t, r) {
		...
		let i = { type: t };
		return n && (i.loc = Te(e.startLoc, e.endLoc)), r != null && (i.value = r), i;
	}
	let p = (e) => f(e, 13);
	function m(e, t) {
	...
	function O(e, t) {
		let n = e.currentChar();
		if (n !== Fe) return t(n) ? (e.next(), n) : null;
	}
	function k(e) {
		let t = e.charCodeAt(0);
	...
	function oe(e) {
		...
		for (; t = te(e);) n += t;
		let r = e.currentChar();
		if (r && r !== "}" && r !== Fe && r !== W && r !== G && r !== "　") {
			let t = ue(e);
			return d(U.INVALID_TOKEN_IN_PLACEHOLDER, a(), 0, n + t), n + t;
		}
		return e.currentChar() === Fe && d(U.UNTERMINATED_CLOSING_BRACE, a(), 0), n;
	}
	function se(e) {
		g(e);
		let t = "";
		return e.currentChar() === "-" ? (e.next(), t += `-${M(e)}`) : t += M(e), e.currentChar() === Fe && d(U.UNTERMINATED_CLOSING_BRACE, a(), 0), t;
	}
	function N(e) {
		return e !== Ie && e !== G;
	}
	function ce(e) {
		g(e), m(e, "'");
		let t = "", n = "";
		for (; t = O(e, N);) n += t === "\\" ? P(e) : t;
		let r = e.currentChar();
		return r === G || r === Fe ? (d(U.UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER, a(), 0), r === G && (e.next(), m(e, "'")), n) : (m(e, "'"), n);
	}
	function P(e) {
		let t = e.currentChar();
		switch (t) {
	...
	function I(e, t) {
		...
		switch (e.currentChar()) {
			...
			case "@": return t.braceNest > 0 && d(U.UNTERMINATED_CLOSING_BRACE, a(), 0), n = L(e, t) || p(t), t.braceNest = 0, n;
			default: {
				let r = !0, i = !0, o = !0;
				if (E(e)) return t.braceNest > 0 && d(U.UNTERMINATED_CLOSING_BRACE, a(), 0), n = f(t, 1, pe(e)), t.braceNest = 0, t.inLinked = !1, n;
				if (t.braceNest > 0 && (t.currentType === 4 || t.currentType === 5 || t.currentType === 6)) return d(U.UNTERMINATED_CLOSING_BRACE, a(), 0), t.braceNest = 0, R(e, t);
	...
	function L(e, t) {
		...
		switch ((n === 7 || n === 8 || n === 11 || n === 9) && (i === G || i === W) && d(U.INVALID_LINKED_FORMAT, a(), 0), i) {
			...
			default: return E(e) ? (r = f(t, 1, pe(e)), t.braceNest = 0, t.inLinked = !1, r) : S(e, t) || w(e, t) ? (g(e), L(e, t)) : C(e, t) ? (g(e), f(t, 11, de(e))) : T(e, t) ? (g(e), i === "{" ? I(e, t) || r : f(t, 10, fe(e))) : (n === 7 && d(U.INVALID_LINKED_FORMAT, a(), 0), t.braceNest = 0, t.inLinked = !1, R(e, t));
		}
	}
	function R(e, t) {
		let n = { type: 13 };
		if (t.braceNest > 0) return I(e, t) || p(t);
		if (t.inLinked) return L(e, t) || p(t);
		switch (e.currentChar()) {
			case "{": return I(e, t) || p(t);
	...
	function z() {
		...
		return c.lastType = e, c.lastOffset = t, c.lastStartLoc = n, c.lastEndLoc = o, c.offset = i(), c.startLoc = a(), r.currentChar() === Fe ? f(c, 13) : R(r, c);
	}
	return {
		nextToken: z,
		currentOffset: i,
...
var ze = "parser", Be = /(?:\\\\|\\'|\\u([0-9a-fA-F]{4})|\\U([0-9a-fA-F]{6}))/g, Ve = /\\([\\@{}|])/g;
function He(e, t) {
	return t;
}
function Ue(e, t, n) {
...
function We(e = {}) {
	...
	function o(e, t) {
		...
		return r.value = t.replace(Ve, He), a(r, e.currentOffset(), e.currentPosition()), r;
	}
	function s(e, t) {
	...
	function l(e, t) {
		...
		return o.value = t.replace(Be, Ue), e.nextToken(), a(o, e.currentOffset(), e.currentPosition()), o;
	}
	function u(e) {
	...
	function g(n) {
		let o = Re(n, N({}, e)), s = o.context(), c = i(0, s.offset, s.startLoc);
...
function Ye(e) {
	let t = e.body;
	return t.type === 2 ? Xe(t) : t.cases.forEach((e) => Xe(e)), e;
}
function Xe(e) {
	if (e.items.length === 1) {
		let t = e.items[0];
...
function Qe(e) {
	switch (e.t = e.type, e.type) {
		...
		default: if (process.env.NODE_ENV !== "production") throw De(U.UNHANDLED_MINIFIER_NODE_TYPE, null, {
			domain: Ze,
			args: [e.type]
		});
	}
...
function tt(e, t) {
	let { helper: n } = e;
	e.push(`${n("linked")}(`), at(e, t.key), t.modifier ? (e.push(", "), at(e, t.modifier), e.push(", _type")) : e.push(", undefined, _type"), e.push(")");
}
function nt(e, t) {
	let { helper: n, needIndent: r } = e;
	e.push(`${n("normalize")}([`), e.indent(r());
	let i = t.items.length;
	for (let n = 0; n < i && (at(e, t.items[n]), n !== i - 1); n++) e.push(", ");
	e.deindent(r()), e.push("])");
}
function rt(e, t) {
	let { helper: n, needIndent: r } = e;
	if (t.cases.length > 1) {
		...
		for (let n = 0; n < i && (at(e, t.cases[n]), n !== i - 1); n++) e.push(", ");
		e.deindent(r()), e.push("])");
	}
}
function it(e, t) {
...
function at(e, t) {
	...
	switch (t.type) {
		...
		case 3:
			e.push(JSON.stringify(t.value), t);
			break;
		default: if (process.env.NODE_ENV !== "production") throw De(U.UNHANDLED_CODEGEN_NODE_TYPE, null, {
			domain: $e,
			args: [t.type]
		});
	}
...
var ot = (e, t = {}) => {
	...
	c.push(n === "normal" ? "function __msg__ (ctx) {" : "(ctx) => {"), c.indent(o), s.length > 0 && (c.push(`const { ${ve(s.map((e) => `${e}: _${e}`), ", ")} } = ctx`), c.newline()), c.push("return "), at(c, e), c.deindent(o), c.push("}"), delete e.helpers;
...
function st(e, t = {}) {
	let n = N({}, t), r = !!n.jit, i = !!n.minify, a = n.optimize == null || n.optimize, o = We(n).parse(e);
	return r ? (a && Ye(o), i && Qe(o), {
		ast: o,
		code: ""
	}) : (Je(o, n), ot(o, n));
}
function q(e) {
	return V(e) && _t(e) === 0 && (I(e, "b") || I(e, "body"));
}
var ct = ["b", "body"];
function lt(e) {
	return wt(e, ct);
...
function kt(e, t) {
	...
	{
		let n = ht(t).reduce((t, n) => [...t, At(e, n)], []);
...
function At(e, t) {
	let n = _t(t);
	switch (n) {
		case 3: return yt(t, n);
		case 9: return yt(t, n);
		case 4: {
			let r = t;
		...
		case 6: {
			let n = t, r = xt(n), i = Ct(n);
			return e.linked(At(e, i), r ? At(e, r) : void 0, e.type);
		}
		case 7: return yt(t, n);
		case 8: return yt(t, n);
...
function Mt(e, t) {
	t && Ae(e) && E(ne(jt, { source: e }));
}
var Nt = (e) => e, Pt = P();
function Ft(e, t = {}) {
	let n = !1, r = t.onError || Oe;
	return t.onError = (e) => {
		n = !0, r(e);
	}, {
		...st(e, t),
...
function It(e, t) {
	if (z(e)) {
		...
		process.env.NODE_ENV !== "production" && Mt(e, n);
		let r = (t.onCacheKey || Nt)(e), i = Pt[r];
		if (i) return i;
		let { ast: a, detectError: o } = Ft(e, {
			...t,
	...
	{
		if (process.env.NODE_ENV !== "production" && !q(e)) return E(`the message that is resolve with key '${t.key}' is not supported for jit compilation`), (() => e);
		let n = e.cacheKey;
		return n ? Pt[n] || (Pt[n] = Dt(e)) : Dt(e);
	}
}
var Lt = null;
function Rt(e) {
...
function Ht(e) {
	return De(e, null, process.env.NODE_ENV === "production" ? void 0 : { messages: Ut });
}
var Ut = {
...
function Wt(e, t) {
	return t.locale == null ? Kt(e.locale) : Kt(t.locale);
}
var Gt;
function Kt(e) {
	if (z(e)) return e;
	if (R(e)) {
		if (e.resolvedOnce && Gt != null) return Gt;
		if (e.constructor.name === "Function") {
			let t = e();
			if (me(t)) throw Ht(J.NOT_SUPPORT_LOCALE_PROMISE_VALUE);
			return Gt = t;
		}
		throw Ht(J.NOT_SUPPORT_LOCALE_ASYNC_FUNCTION);
	}
	throw Ht(J.NOT_SUPPORT_LOCALE_TYPE);
}
function qt(e, t, n) {
...
function Jt(e, t, n) {
	...
	if (!a) {
		...
		e = z(o) ? [o] : o, L(e) && Yt(a, e, !1), i.__localeChainCache.set(r, a);
	}
	return a;
}
function Yt(e, t, n) {
...
function an(e) {
	...
	f[0] = () => {
		...
		if (i > 0) i--, r = 4, f[0]();
			...
			if (i = 0, o === void 0 || (o = rn(o), o === !1)) return !1;
			f[1]();
		}
	};
	function p() {
	...
	for (; r !== null;) if (n++, a = e[n], !(a === "\\" && p())) {
		if (c = nn(a), d = Qt[r], l = d[c] || d.l || 8, l === 8 || (r = l[0], l[1] !== void 0 && (u = f[l[1]], u && (s = a, u() === !1)))) return;
		if (r === 7) return t;
	}
}
...
function cn(e, t) {
	if (!V(e)) return null;
	let n = on.get(t);
	if (n || (n = an(t), n && on.set(t, n)), !n) return null;
	let r = n.length, i = e, a = 0;
	for (; a < r;) {
		let e = n[a];
		if (Tt.includes(e) && q(i) || !V(i) || !I(i, e)) return null;
		let t = i[e];
...
var dn = "11.4.0", fn = "en-US", pn = (e) => `${e.charAt(0).toLocaleUpperCase()}${e.substr(1)}`;
function mn() {
	return {
		...
		capitalize: (e, t) => t === "text" && z(e) ? pn(e) : t === "vnode" && V(e) && "__v_isVNode" in e ? pn(e.children) : e
	};
}
var hn;
function gn(e) {
...
function On(e = {}) {
	let t = R(e.onWarn) ? e.onWarn : E, n = z(e.version) ? e.version : dn, r = z(e.locale) || R(e.locale) ? e.locale : fn, i = R(r) ? fn : r, a = L(e.fallbackLocale) || H(e.fallbackLocale) || z(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : i, o = H(e.messages) ? e.messages : kn(i), s = H(e.datetimeFormats) ? e.datetimeFormats : kn(i), c = H(e.numberFormats) ? e.numberFormats : kn(i), l = N(P(), e.modifiers, mn()), u = e.pluralRules || P(), d = R(e.missing) ? e.missing : null, f = B(e.missingWarn) || oe(e.missingWarn) ? e.missingWarn : !0, p = B(e.fallbackWarn) || oe(e.fallbackWarn) ? e.fallbackWarn : !0, m = !!e.fallbackFormat, h = !!e.unresolving, g = R(e.postTranslation) ? e.postTranslation : null, _ = H(e.processor) ? e.processor : null, v = !B(e.warnHtmlMessage) || e.warnHtmlMessage, y = !!e.escapeParameter, b = R(e.messageCompiler) ? e.messageCompiler : hn;
	process.env.NODE_ENV !== "production" && R(e.messageCompiler) && O(un(Y.EXPERIMENTAL_CUSTOM_MESSAGE_COMPILER));
	let x = R(e.messageResolver) ? e.messageResolver : _n || sn, S = R(e.localeFallbacker) ? e.localeFallbacker : yn || qt, C = V(e.fallbackContext) ? e.fallbackContext : void 0, w = e, T = V(w.__datetimeFormatters) ? w.__datetimeFormatters : /* @__PURE__ */ new Map(), D = V(w.__numberFormatters) ? w.__numberFormatters : /* @__PURE__ */ new Map(), k = V(w.__meta) ? w.__meta : {};
	Dn++;
	let A = {
		version: n,
		cid: Dn,
	...
	return A.datetimeFormats = s, A.numberFormats = c, A.__datetimeFormatters = T, A.__numberFormatters = D, process.env.NODE_ENV !== "production" && (A.__v_emitter = w.__v_emitter == null ? void 0 : w.__v_emitter), process.env.NODE_ENV !== "production" && zt(A, n, k), A;
}
var kn = (e) => ({ [e]: P() });
function An(e, t) {
...
function Mn(e, t, n, r, i) {
	...
	return process.env.NODE_ENV !== "production" && jn(r, t) && o(un(Y.NOT_FOUND_KEY, {
		key: t,
		locale: n
	})), t;
}
...
function Fn(e, t) {
	let n = t.indexOf(e);
	if (n === -1) return !1;
	for (let r = n + 1; r < t.length; r++) if (Pn(e, t[r])) return !0;
	return !1;
}
var In = typeof Intl < "u", Ln = {
	dateTimeFormat: In && Intl.DateTimeFormat !== void 0,
	numberFormat: In && Intl.NumberFormat !== void 0
};
function Rn(e, ...t) {
	let { datetimeFormats: n, unresolving: r, fallbackLocale: i, onWarn: a, localeFallbacker: o } = e, { __datetimeFormatters: s } = e;
	if (process.env.NODE_ENV !== "production" && !Ln.dateTimeFormat) return a(un(Y.CANNOT_FORMAT_DATE)), "";
	if (!z(t[0]) && !ae(t[0]) && !M(t[0])) return process.env.NODE_ENV !== "production" && a(un(Y.INVALID_DATE_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = Bn(...t), f = B(u.missingWarn) ? u.missingWarn : e.missingWarn, p = B(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = Wt(e, u), g = o(e, i, h);
	if (!z(c) || c === "") return new Intl.DateTimeFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "datetime format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && An(p, c) && a(un(Y.FALLBACK_TO_DATE_FORMAT, {
			key: c,
			target: v
...
function Bn(...e) {
	...
	if (z(t)) {
		...
		if (!e) throw Ht(J.INVALID_ISO_DATE_ARGUMENT);
		let n = e[3] ? e[3].trim().startsWith("T") ? `${e[1].trim()}${e[3].trim()}` : `${e[1].trim()}T${e[3].trim()}` : e[1].trim();
		s = new Date(n);
		try {
			s.toISOString();
		} catch {
			throw Ht(J.INVALID_ISO_DATE_ARGUMENT);
		}
	} else if (ae(t)) {
		if (isNaN(t.getTime())) throw Ht(J.INVALID_DATE_ARGUMENT);
		s = t;
	} else if (M(t)) s = t;
	else throw Ht(J.INVALID_ARGUMENT);
...
function Hn(e, ...t) {
	...
	if (process.env.NODE_ENV !== "production" && !Ln.numberFormat) return a(un(Y.CANNOT_FORMAT_NUMBER)), "";
	if (!M(t[0])) return process.env.NODE_ENV !== "production" && a(un(Y.INVALID_NUMBER_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = Wn(...t), f = B(u.missingWarn) ? u.missingWarn : e.missingWarn, p = B(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = Wt(e, u), g = o(e, i, h);
	if (!z(c) || c === "") return new Intl.NumberFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "number format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && An(p, c) && a(un(Y.FALLBACK_TO_NUMBER_FORMAT, {
			key: c,
			target: v
		})), process.env.NODE_ENV !== "production" && h !== v) {
			let t = e.__v_emitter;
...
function Wn(...e) {
	...
	if (!M(t)) throw Ht(J.INVALID_ARGUMENT);
	let s = t;
	return z(n) ? a.key = n : H(n) && Object.keys(n).forEach((e) => {
...
var Kn = (e) => e, qn = (e) => "", Jn = "text", Yn = (e) => e.length === 0 ? "" : ve(e), Xn = _e;
function Zn(e, t) {
...
function $n(e = {}) {
	let t = e.locale, n = Qn(e), r = z(t) && R(e.pluralRules?.[t]) ? e.pluralRules[t] : Zn, i = r === Zn ? void 0 : Zn, a = (e) => e[r(n, e.length, i)], o = e.list || [], s = (e) => o[e], c = e.named || P();
	...
	let d = (t) => e.modifiers ? e.modifiers[t] : Kn, f = R(e.processor?.normalize) ? e.processor.normalize : Yn, p = R(e.processor?.interpolate) ? e.processor.interpolate : Xn, m = {
		list: s,
		named: l,
		plural: a,
		linked: (e, ...t) => {
		...
		message: u,
		type: z(e.processor?.type) ? e.processor.type : Jn,
		interpolate: p,
		normalize: f,
		values: N(P(), o, c)
	};
...
var er = () => "", X = (e) => R(e);
function tr(e, ...t) {
	let { fallbackFormat: n, postTranslation: r, unresolving: i, messageCompiler: a, fallbackLocale: o, messages: s } = e, [c, l] = or(...t), u = B(l.missingWarn) ? l.missingWarn : e.missingWarn, d = B(l.fallbackWarn) ? l.fallbackWarn : e.fallbackWarn, f = B(l.escapeParameter) ? l.escapeParameter : e.escapeParameter, p = !!l.resolvedMessage, m = z(l.default) || B(l.default) ? B(l.default) ? a ? c : () => c : l.default : n ? a ? c : () => c : null, h = n || m != null && (z(m) || R(m)), g = Wt(e, l);
	f && nr(l);
	let [_, v, y] = p ? [
		c,
		g,
		s[g] || P()
	] : rr(e, c, g, o, d, u), b = _, x = c;
	if (!p && !(z(b) || q(b) || X(b)) && h && (b = m, x = b), !p && (!(z(b) || q(b) || X(b)) || !z(v))) return i ? -1 : c;
	if (process.env.NODE_ENV !== "production" && z(b) && e.messageCompiler == null) return E(`The message format compilation is not supported in this build. Because message compiler isn't included. You need to pre-compilation all message format. So translate function return '${c}'.`), c;
	let S = !1, C = X(b) ? b : ir(e, c, v, b, x, () => {
		S = !0;
	});
	if (S) return b;
	let w = ar(e, C, $n(lr(e, v, y, l))), T = r ? r(w, c) : w;
	if (f && z(T) && (T = fe(T)), process.env.NODE_ENV !== "production") {
		let t = {
			timestamp: Date.now(),
			key: z(c) ? c : X(b) ? b.key : "",
		...
		t.meta = N({}, e.__meta, Cn() || {}), Bt(t);
	}
	return T;
}
function nr(e) {
	L(e.list) ? e.list = e.list.map((e) => z(e) ? ue(e) : e) : V(e.named) && Object.keys(e.named).forEach((t) => {
		z(e.named[t]) && (e.named[t] = ue(e.named[t]));
	});
}
function rr(e, t, n, r, i, a) {
	let { messages: o, onWarn: s, messageResolver: c, localeFallbacker: l } = e, u = l(e, r, n), d = P(), f, p = null, m = n, h = null, g = "translate";
	for (let r = 0; r < u.length; r++) {
		f = h = u[r], process.env.NODE_ENV !== "production" && n !== f && !Pn(n, f) && An(i, t) && s(un(Y.FALLBACK_TO_TRANSLATE, {
			key: t,
			target: f
		}));
		...
		if (process.env.NODE_ENV !== "production" && k && l && (_ = window.performance.now(), v = "intlify-message-resolve-start", y = "intlify-message-resolve-end", A && A(v)), (p = c(d, t)) === null && (p = d[t]), process.env.NODE_ENV !== "production" && k && l) {
			...
			l && _ && p && l.emit("message-resolve", {
				...
				time: e - _,
				groupId: `${g}:${t}`
			}), v && y && A && ee && (A(y), ee("intlify message resolve", v, y));
		}
...
function ir(e, t, n, r, i, a) {
	...
	if (process.env.NODE_ENV !== "production" && k && c) {
		...
		c && l && c.emit("message-compilation", {
			...
			time: e - l,
			groupId: `translate:${t}`
		}), u && d && A && ee && (A(d), ee("intlify message compilation", u, d));
	}
...
function ar(e, t, n) {
	...
	if (process.env.NODE_ENV !== "production" && k && r) {
		...
		}), a && o && A && ee && (A(o), ee("intlify message evaluation", a, o));
	}
	return s;
}
function or(...e) {
	let [t, n, r] = e, i = P();
	if (!z(t) && !M(t) && !X(t) && !q(t)) throw Ht(J.INVALID_ARGUMENT);
	let a = M(t) ? String(t) : (X(t), t);
	return M(n) ? i.plural = n : z(n) ? i.default = n : H(n) && !se(n) ? i.named = n : L(n) && (i.list = n), M(r) ? i.plural = r : z(r) ? i.default = r : H(r) && N(i, r), [a, i];
}
	...
	return {
		...
		onError: (t) => {
			if (a && a(t), process.env.NODE_ENV !== "production") {
				let i = cr(r), a = t.location && i && be(i, t.location.start.offset, t.location.end.offset), o = e.__v_emitter;
...
function lr(e, t, n, r) {
	let { modifiers: i, pluralRules: a, messageResolver: o, fallbackLocale: s, fallbackWarn: c, missingWarn: l, fallbackContext: u } = e, d = {
		...
		messages: (r, i) => {
			let a = o(n, r);
			if (a == null && (u || i)) {
				let [n, , i] = rr(u || e, r, t, s, c, l);
				a = n ?? o(i, r);
			}
			if (z(a) || q(a)) {
				let n = !1, i = ir(e, r, t, a, r, () => {
					n = !0;
				});
				return n ? er : i;
			}
...
var fr = typeof Proxy == "function", pr = "devtools-plugin:setup", mr = "plugin:settings:set", hr, gr;
function _r() {
	return hr === void 0 && (typeof window < "u" && window.performance ? (hr = !0, gr = window.performance) : typeof globalThis < "u" && globalThis.perf_hooks?.performance ? (hr = !0, gr = globalThis.perf_hooks.performance) : hr = !1), hr;
}
function vr() {
	return _r() ? gr.now() : Date.now();
}
var yr = class {
	constructor(e, t) {
...
function br(e, t) {
	let n = e, r = dr(), i = ur(), a = fr && n.enableEarlyProxy;
	if (i && (r.__VUE_DEVTOOLS_PLUGIN_API_AVAILABLE__ || !a)) i.emit(pr, e, t);
	else {
		let e = a ? new yr(n, i) : null;
...
function Q(e, ...t) {
	return De(e, null, process.env.NODE_ENV === "production" ? void 0 : {
		messages: Sr,
		args: t
	});
}
...
}, Cr = j("__translateVNode"), wr = j("__datetimeParts"), Tr = j("__numberParts"), Er = j("__enableEmitter"), Dr = j("__disableEmitter"), Or = j("__setPluralRules");
j("__intlifyMeta");
var kr = j("__injectWithOption"), Ar = j("__dispose"), $ = {
	FALLBACK_TO_ROOT: 10,
...
function Nr(e) {
	...
	for (let t in e) if (I(e, t)) {
		if (!t.includes(".")) V(e[t]) && Nr(e[t]);
		else {
			let n = t.split("."), r = n.length - 1, i = e, a = !1;
			for (let e = 0; e < r; e++) {
				if (n[e] === "__proto__") throw Error(`unsafe key: ${n[e]}`);
				if (n[e] in i || (i[n[e]] = P()), !V(i[n[e]])) {
					process.env.NODE_ENV !== "production" && E(Mr($.IGNORE_OBJ_FLATTEN, { key: n[e] })), a = !0;
					break;
				}
				i = i[n[e]];
			}
			if (a || (q(i) ? Tt.includes(n[r]) || delete e[t] : (i[n[r]] = e[t], delete e[t])), !q(i)) {
				let e = i[n[r]];
				V(e) && Nr(e);
			}
		}
...
function Pr(e, t) {
	...
	if (L(r) && r.forEach((e) => {
		if ("locale" in e && "resource" in e) {
			...
			t ? (o[t] = o[t] || P(), Ce(n, o[t])) : Ce(n, o);
		} else z(e) && Ce(JSON.parse(e), o);
	}), i == null && a) for (let e in o) I(o, e) && Nr(o[e]);
	return o;
}
function Fr(e) {
	return e.type;
...
function Ir(e, t, n) {
	...
	"__i18nGlobal" in n && (r = Pr(e.locale.value, {
		messages: r,
...
var zr = "__INTLIFY_META__", Br = () => [], Vr = () => !1, Hr = 0;
function Ur(e) {
	return ((t, n, r, i) => e(n, r, Rr() || void 0, i));
}
var Wr = () => {
	let e = Rr(), t = null;
	return e && (t = Fr(e)[zr]) ? { [zr]: t } : null;
};
function Gr(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = k ? b : S, s = !B(e.inheritLocale) || e.inheritLocale, c = o(t && s ? t.locale.value : z(e.locale) ? e.locale : fn), l = o(t && s ? t.fallbackLocale.value : z(e.fallbackLocale) || L(e.fallbackLocale) || H(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(Pr(c.value, e)), d = o(H(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(H(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : B(e.missingWarn) || oe(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : B(e.fallbackWarn) || oe(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : !B(e.fallbackRoot) || e.fallbackRoot, g = !!e.fallbackFormat, _ = R(e.missing) ? e.missing : null, v = R(e.missing) ? Ur(e.missing) : null, y = R(e.postTranslation) ? e.postTranslation : null, x = t ? t.warnHtmlMessage : !B(e.warnHtmlMessage) || e.warnHtmlMessage, C = !!e.escapeParameter, w = t ? t.modifiers : H(e.modifiers) ? e.modifiers : {}, D = e.pluralRules || t && t.pluralRules, O;
	O = (() => {
		i && Tn(null);
		let t = {
			version: xr,
		...
		t.datetimeFormats = d.value, t.numberFormats = f.value, t.__datetimeFormatters = H(O) ? O.__datetimeFormatters : void 0, t.__numberFormatters = H(O) ? O.__numberFormatters : void 0, process.env.NODE_ENV !== "production" && (t.__v_emitter = H(O) ? O.__v_emitter : void 0);
		let n = On(t);
		return i && Tn(n), n;
	})(), Nn(O, c.value, l.value);
	function A() {
		return [
			c.value,
			l.value,
	...
	let ee = r({
		...
		get: () => l.value,
		set: (e) => {
			O.fallbackLocale = e, l.value = e, Nn(O, c.value, e);
		}
	}), ne = r(() => u.value), j = r(() => d.value), re = r(() => f.value);
	function ie() {
		return R(y) ? y : null;
	}
	function ae(e) {
		y = e, O.postTranslation = e;
	}
	function se() {
		return _;
	}
	function ce(e) {
		e !== null && (v = Ur(e)), _ = e, O.missing = v;
	}
	function P(e, t) {
	...
	let F = (e, n, r, a, o, s) => {
		...
		let c;
		try {
			process.env.NODE_ENV !== "production" && Sn(Wr()), i || (O.fallbackContext = t ? En() : void 0), c = e(O);
		} finally {
			process.env.NODE_ENV !== "production" && Sn(null), i || (O.fallbackContext = void 0);
		}
		if (r !== "translate exists" && M(c) && c === -1 || r === "translate exists" && !c) {
			let [e, i] = n();
			if (process.env.NODE_ENV !== "production" && t && z(e) && P(r, i) && (h && (An(m, e) || jn(p, e)) && E(Mr($.FALLBACK_TO_ROOT, {
				key: e,
				type: r
	...
	function le(...e) {
		return F((t) => Reflect.apply(tr, null, [t, ...e]), () => or(...e), "translate", (t) => Reflect.apply(t.t, t, [...e]), (e) => e, (e) => z(e));
	}
	function ue(...e) {
		let [t, n, r] = e;
	...
	function de(...e) {
		return F((t) => Reflect.apply(Rn, null, [t, ...e]), () => Bn(...e), "datetime format", (t) => Reflect.apply(t.d, t, [...e]), () => "", (e) => z(e) || L(e));
	}
	function fe(...e) {
		return F((t) => Reflect.apply(Hn, null, [t, ...e]), () => Wn(...e), "number format", (t) => Reflect.apply(t.n, t, [...e]), () => "", (e) => z(e) || L(e));
	}
	function pe(e) {
		return e.map((e) => z(e) || M(e) || B(e) ? Lr(String(e)) : e);
	}
	let me = {
		normalize: pe,
		interpolate: (e) => e,
	...
	function he(...e) {
		return F((t) => {
			let n, r = t;
			try {
				r.processor = me, n = Reflect.apply(tr, null, [r, ...e]);
			} finally {
				r.processor = null;
			}
			return n;
		}, () => or(...e), "translate", (t) => t[Cr](...e), (e) => [Lr(e)], (e) => L(e));
	}
	function ge(...e) {
		return F((t) => Reflect.apply(Hn, null, [t, ...e]), () => Wn(...e), "number format", (t) => t[Tr](...e), Br, (e) => z(e) || L(e));
	}
	function _e(...e) {
		return F((t) => Reflect.apply(Rn, null, [t, ...e]), () => Bn(...e), "datetime format", (t) => t[wr](...e), Br, (e) => z(e) || L(e));
	}
	function ve(e) {
		D = e, O.pluralRules = D;
	}
	function ye(e, t) {
		return F(() => {
			if (!e) return !1;
			let n = z(t) ? t : c.value, r = z(t) ? [n] : Jt(O, l.value, n);
			for (let t = 0; t < r.length; t++) {
				let n = Se(r[t]), i = O.messageResolver(n, e);
				if (i === null && (i = n[e]), q(i) || X(i) || z(i)) return !0;
			}
			return !1;
		}, () => [e], "translate exists", (n) => Reflect.apply(n.te, n, [e, t]), Vr, (e) => B(e));
	}
	function be(e) {
		let t = null, n = Jt(O, l.value, c.value);
	...
	function Te(e, t) {
		u.value[e] = u.value[e] || {};
		let n = { [e]: t };
		if (a) for (let e in n) I(n, e) && Nr(n[e]);
		t = n[e], Ce(t, u.value[e]), O.messages = u.value;
	}
	function U(e) {
		return d.value[e] || {};
	}
	function Ee(e, t) {
		d.value[e] = t, O.datetimeFormats = d.value, Vn(O, e, t);
	}
	function De(e, t) {
		d.value[e] = N(d.value[e] || {}, t), O.datetimeFormats = d.value, Vn(O, e, t);
	}
	function Oe(e) {
		return f.value[e] || {};
	}
	function ke(e, t) {
		f.value[e] = t, O.numberFormats = f.value, Gn(O, e, t);
	}
	function Ae(e, t) {
		f.value[e] = N(f.value[e] || {}, t), O.numberFormats = f.value, Gn(O, e, t);
	}
	Hr++, t && k && (T(t.locale, (e) => {
		s && (c.value = e, O.locale = e, Nn(O, c.value, l.value));
	}), T(t.fallbackLocale, (e) => {
		s && (l.value = e, O.fallbackLocale = e, Nn(O, c.value, l.value));
	}));
	let W = {
		id: Hr,
		locale: ee,
		...
		set inheritLocale(e) {
			s = e, e && t && (c.value = t.locale.value, l.value = t.fallbackLocale.value, Nn(O, c.value, l.value));
		},
		...
		set warnHtmlMessage(e) {
			x = e, O.warnHtmlMessage = e;
		},
		get escapeParameter() {
			return C;
		},
		set escapeParameter(e) {
			C = e, O.escapeParameter = e;
		},
		t: le,
		getLocaleMessage: Se,
		setLocaleMessage: we,
	...
	return W.datetimeFormats = j, W.numberFormats = re, W.rt = ue, W.te = ye, W.tm = xe, W.d = de, W.n = fe, W.getDateTimeFormat = U, W.setDateTimeFormat = Ee, W.mergeDateTimeFormat = De, W.getNumberFormat = Oe, W.setNumberFormat = ke, W.mergeNumberFormat = Ae, W[kr] = n, W[Cr] = he, W[wr] = _e, W[Tr] = ge, process.env.NODE_ENV !== "production" && (W[Er] = (e) => {
		O.__v_emitter = e;
	}, W[Dr] = () => {
		O.__v_emitter = void 0;
	}), W;
}
var Kr = "vue-i18n: composer properties", qr = {
	"vue-devtools-plugin-vue-i18n": "Vue I18n DevTools",
	"vue-i18n-resource-inspector": "Vue I18n DevTools",
	"vue-i18n-timeline": "Vue I18n"
}, Jr = { "vue-i18n-resource-inspector": "Search for scopes ..." }, Yr = { "vue-i18n-timeline": 16764185 }, Xr;
	...
	return new Promise((n, r) => {
		try {
			br({
				...
				Xr = r, r.on.visitComponentTree(({ componentInstance: e, treeNode: n }) => {
					$r(e, n, t);
				}), r.on.inspectComponent(({ componentInstance: e, instanceData: n }) => {
					e.__VUE_I18N__ && n && (t.mode === "legacy" ? e.__VUE_I18N__ !== t.global.__composer && ei(n, e.__VUE_I18N__) : ei(n, e.__VUE_I18N__));
				}), r.addInspector({
				...
				r.on.getInspectorState(async (n) => {
					if (n.app === e && n.inspectorId === "vue-i18n-resource-inspector") {
						if (r.unhighlightElement(), li(n, t), n.nodeId === "global") {
							if (!i.has(n.app)) {
...
function ti(e) {
	...
	return Object.keys(e).forEach((n) => {
		let r = e[n];
		R(r) && "source" in r ? t[n] = ai(r) : q(r) && r.loc && r.loc.source ? t[n] = r.loc.source : V(r) ? t[n] = ti(r) : t[n] = r;
	}), t;
}
var ni = {
	"<": "&lt;",
...
function ai(e) {
	return { _custom: {
		type: "function",
		display: `<span>ƒ</span> ${e.source ? `("${ri(e.source)}")` : "(?)"}`
	} };
}
function oi(e, t) {
	e.rootNodes.push({
...
function di(e, t) {
	if (Xr) {
		let n;
		t && "groupId" in t && (n = t.groupId, delete t.groupId), Xr.addTimelineEvent({
...
var gi = c({
	...
	setup(e, t) {
		let { slots: n, attrs: r } = t, i = e.i18n || Di({
			useScope: e.scope,
			__useComponent: !0
		});
		return () => {
			...
			let s = mi(t, a), c = i[Cr](e.keypath, s, o), l = N(P(), r), u = z(e.tag) || V(e.tag) ? e.tag : hi();
			return f(u, l, c);
		};
	}
});
...
function vi(e, t, n, r) {
	...
	return () => {
		...
		L(s) ? c = s.map((e, t) => {
			...
			return _i(r) && (r[0].key = `${e.type}-${t}`), r;
		}) : z(s) && (c = [s]);
		let l = N(P(), a), u = z(e.tag) || V(e.tag) ? e.tag : hi();
		return f(u, l, c);
	};
}
var yi = c({
...
function xi(e) {
	let t = (t) => {
		process.env.NODE_ENV !== "production" && O(Mr($.DEPRECATE_TRANSLATE_CUSTOME_DIRECTIVE));
		let { instance: n, value: r } = t;
		if (!n || !n.$) throw Q(Z.UNEXPECTED_ERROR);
		let i = bi(e, n.$), a = Si(r);
		return [Reflect.apply(i.t, i, [...Ci(a)]), i];
	};
	return {
		created: (e, n) => {
			let [r, i] = t(n);
			k && (e.__i18nWatcher = T(i.locale, () => {
		...
		beforeUpdate: (e, { value: t }) => {
			if (e.__composer) {
				let n = e.__composer, r = Si(t);
				e.textContent = Reflect.apply(n.t, n, [...Ci(r)]);
			}
		},
		getSSRProps: (e) => {
			let [n] = t(e);
...
function wi(e, t, ...n) {
	let r = H(n[0]) ? n[0] : {};
	(!B(r.globalInstall) || r.globalInstall) && ([gi.name, "I18nT"].forEach((t) => e.component(t, gi)), [yi.name, "I18nN"].forEach((t) => e.component(t, yi)), [Ri.name, "I18nD"].forEach((t) => e.component(t, Ri))), e.directive("t", xi(t));
}
var Ti = j("global-vue-i18n");
function Ei(e = {}) {
	process.env.NODE_ENV;
	let t = !B(e.globalInjection) || e.globalInjection, n = /* @__PURE__ */ new Map(), [r, i] = Oi(e, !1), a = j(process.env.NODE_ENV === "production" ? "" : "vue-i18n");
	function o(e) {
		return n.get(e) || null;
	}
	function s(e, t) {
	...
	let l = {
		...
		async install(e, ...n) {
			...
			let r = null;
			t && (r = Li(e, l.global)), wi(e, l, ...n);
			let o = e.unmount;
			if (e.unmount = () => {
				r && r(), l.dispose(), o();
			}, process.env.NODE_ENV !== "production") {
				if (!await Zr(e, l)) throw Q(Z.CANNOT_SETUP_VUE_DEVTOOLS_PLUGIN);
				let t = xe();
				{
					let e = i;
					e[Er] && e[Er](t);
...
function Di(e = {}) {
	...
	let n = ki(t), r = ji(n), i = Fr(t), a = Ai(e, i);
	if (a === "global") return Ir(r, e, i), r;
	if (a === "parent") {
		let i = Mi(n, t, e.__useComponent);
		return i ??= (process.env.NODE_ENV !== "production" && E(Mr($.NOT_FOUND_PARENT_SCOPE)), r), i;
	}
	if (a === "isolated") {
		...
		a.__root = Mi(n, t) || r;
		let o = Gr(a);
		i.__composerExtend && (o[Ar] = i.__composerExtend(o));
		let s = null;
		if (process.env.NODE_ENV !== "production") {
			s = xe();
			let e = o;
	...
	if (s == null) {
		let n = N({}, e);
		"__i18n" in i && (n.__i18n = i.__i18n), r && (n.__root = r), s = Gr(n), o.__composerExtend && (s[Ar] = o.__composerExtend(s)), Pi(o, t, s), o.__setInstance(t, s);
	} else process.env.NODE_ENV !== "production" && a === "local" && E(Mr($.DUPLICATE_USE_I18N_CALLING));
	return s;
}
function Oi(e, t) {
	let n = l(), r = n.run(() => Gr(e));
	if (r == null) throw Q(Z.UNEXPECTED_ERROR);
	return [n, r];
}
function ki(e) {
	let t = p(e.isCE ? Ti : e.appContext.app.__VUE_I18N_SYMBOL__);
	if (!t) throw Q(e.isCE ? Z.NOT_INSTALLED_WITH_PROVIDE : Z.UNEXPECTED_ERROR);
	return t;
}
function Ai(e, t) {
	return se(e) ? "__i18n" in t ? "local" : "global" : e.useScope ? e.useScope : "local";
}
function ji(e) {
	return e.mode === "composition" ? e.global : e.global.__composer;
}
function Mi(e, t, n = !1) {
	let r = null, i = t.root, a = Ni(t, n);
	for (; a != null;) {
		let t = e;
...
function Pi(e, t, n) {
	...
	g(() => {
		if (process.env.NODE_ENV !== "production") {
			t.__VUE_I18N__ = n, r = xe();
			let e = n;
			e[Er] && e[Er](r), r.on("*", di);
		}
	}, t), v(() => {
		let i = n;
		process.env.NODE_ENV !== "production" && (r && r.off("*", di), i[Dr] && i[Dr](), delete t.__VUE_I18N__), e.__deleteInstance(t);
		let a = i[Ar];
		a && (a(), delete i[Ar]);
	}, t);
}
...
var Ri = c({
	...
	setup(e, t) {
		...
		return vi(e, t, zn, (...e) => n[wr](...e));
	}
});
if (gn(It), vn(cn), bn(Jt), process.env.NODE_ENV !== "production") {
	let e = le();
...
var Bi = { class: "mb-16 mx-auto max-w-3xl space-y-6" }, Vi = { class: "text-2xl font-bold text-foreground" }, Hi = { class: "rounded-lg border border-border bg-card p-6" }, Ui = { class: "mb-2 text-lg font-semibold text-foreground" }, Wi = { class: "text-sm text-muted-foreground" }, Gi = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, Ki = { class: "rounded-lg border border-border bg-card p-6" }, qi = { class: "mb-2 text-lg font-semibold text-foreground" }, Ji = { class: "text-sm text-muted-foreground" }, Yi = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, Xi = { class: "text-foreground" }, Zi = { class: "text-foreground" }, Qi = { class: "text-foreground" }, $i = { class: "rounded-lg border border-border bg-card p-6" }, ea = { class: "mb-2 text-lg font-semibold text-foreground" }, ta = { class: "text-sm text-muted-foreground" }, na = c({
	__name: "UnderstandingImpact",
	setup(e) {
		zi("UnderstandingImpact");
		let { t } = Di();
		return (e, n) => (y(), i("section", Bi, [
			a("h2", Vi, C(w(t)("home.understandingImpact.title")), 1),
			a("div", Hi, [
				a("h3", Ui, C(w(t)("home.understandingImpact.singleJsonTitle")), 1),
				a("p", Wi, C(w(t)("home.understandingImpact.singleJsonIntro")), 1),
				a("ul", Gi, [
					a("li", null, C(w(t)("home.understandingImpact.singleJsonBullet1")), 1),
					a("li", null, C(w(t)("home.understandingImpact.singleJsonBullet2")), 1),
					a("li", null, C(w(t)("home.understandingImpact.singleJsonBullet3")), 1)
				])
			]),
			a("div", Ki, [
				a("h3", qi, C(w(t)("home.understandingImpact.tradeOffsTitle")), 1),
				a("p", Ji, C(w(t)("home.understandingImpact.tradeOffsIntro")), 1),
				a("ul", Yi, [
					a("li", null, [a("strong", Xi, C(w(t)("home.understandingImpact.waterfallLabel")), 1), o(" " + C(w(t)("home.understandingImpact.waterfallDesc")), 1)]),
					a("li", null, [a("strong", Zi, C(w(t)("home.understandingImpact.foucLabel")), 1), o(" " + C(w(t)("home.understandingImpact.foucDesc")), 1)]),
					a("li", null, [a("strong", Qi, C(w(t)("home.understandingImpact.cacheLabel")), 1), o(" " + C(w(t)("home.understandingImpact.cacheDesc")), 1)])
				])
			]),
			a("div", $i, [a("h3", ea, C(w(t)("home.understandingImpact.measuresTitle")), 1), a("p", ta, C(w(t)("home.understandingImpact.measuresDesc")), 1)])
		]));
	}
}), ra = Ei({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(ra), (e, t) => x(e.$slots, "default");
	}
}), aa = { render() {
	return f(ia, {}, { default: () => f(na) });
} };
