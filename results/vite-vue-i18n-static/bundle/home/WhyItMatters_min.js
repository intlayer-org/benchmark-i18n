...
import { Fragment as t, Text as n, computed as r, createElementBlock as i, createElementVNode as a, createVNode as o, defineComponent as s, effectScope as c, getCurrentInstance as l, getCurrentScope as u, h as d, inject as f, isRef as p, onBeforeMount as m, onMounted as h, onScopeDispose as g, onUnmounted as _, openBlock as v, ref as y, renderSlot as b, shallowRef as x, toDisplayString as S, unref as C, watch as w } from "vue";
function T(e, t) {
...
var te = /\{([0-9a-zA-Z]+)\}/g;
function ne(e, ...t) {
	return t.length === 1 && B(t[0]) && (t = t[0]), (!t || !t.hasOwnProperty) && (t = {}), e.replace(te, (e, n) => t.hasOwnProperty(n) ? t[n] : "");
}
var A = (e, t = !1) => t ? Symbol.for(e) : Symbol(e), re = (e, t, n) => ie({
	l: e,
	k: t,
	s: n
}), ie = (e) => JSON.stringify(e).replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029").replace(/\u0027/g, "\\u0027"), j = (e) => typeof e == "number" && isFinite(e), ae = (e) => ge(e) === "[object Date]", oe = (e) => ge(e) === "[object RegExp]", se = (e) => V(e) && Object.keys(e).length === 0, M = Object.assign, ce = Object.create, N = (e = null) => ce(e), le, P = () => le ||= typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : N();
function ue(e) {
...
function fe(e) {
	return e = e.replace(/(\w+)\s*=\s*"([^"]*)"/g, (e, t, n) => `${t}="${de(n)}"`), e = e.replace(/(\w+)\s*=\s*'([^']*)'/g, (e, t, n) => `${t}='${de(n)}'`), /\s*on\w+\s*=\s*["']?[^"'>]+["']?/gi.test(e) && (process.env.NODE_ENV !== "production" && T("Potentially dangerous event handlers detected in translation. Consider removing onclick, onerror, etc. from your translation messages."), e = e.replace(/(\s+)(on)(\w+\s*=)/gi, "$1&#111;n$3")), [/(\s+(?:href|src|action|formaction)\s*=\s*["']?)\s*javascript:/gi, /(style\s*=\s*["'][^"']*url\s*\(\s*)javascript:/gi].forEach((t) => {
...
var I = Array.isArray, L = (e) => typeof e == "function", R = (e) => typeof e == "string", z = (e) => typeof e == "boolean", B = (e) => typeof e == "object" && !!e, me = (e) => B(e) && L(e.then) && L(e.catch), he = Object.prototype.toString, ge = (e) => he.call(e), V = (e) => ge(e) === "[object Object]", _e = (e) => e == null ? "" : I(e) || V(e) && e.toString === he ? JSON.stringify(e, null, 2) : String(e);
function ve(e, t = "") {
...
function Ce(e, t) {
	...
	for (; n.length;) {
		...
		Object.keys(e).forEach((r) => {
			r !== "__proto__" && (B(e[r]) && !B(t[r]) && (t[r] = Array.isArray(e[r]) ? [] : N()), Se(t[r]) || Se(e[r]) ? t[r] = e[r] : n.push({
				src: e[r],
				des: t[r]
			}));
		});
...
var ke = /<\/?[\w\s="/.':;#-\/]+>/, Ae = (e) => ke.test(e), U = " ", W = "\r", G = "\n", je = "\u2028", Me = "\u2029";
function Ne(e) {
	let t = e, n = 0, r = 1, i = 1, a = 0, o = (e) => t[e] === W && t[e + 1] === G, s = (e) => t[e] === G, c = (e) => t[e] === Me, l = (e) => t[e] === je, u = (e) => o(e) || s(e) || c(e) || l(e), d = () => n, f = () => r, p = () => i, m = () => a, h = (e) => o(e) || c(e) || l(e) ? G : t[e], g = () => h(n), _ = () => h(n + a);
	function v() {
...
function Le(e, t = {}) {
	let n = t.location !== !1, r = Ne(e), i = () => r.index(), a = () => we(r.line(), r.column(), r.index()), o = a(), s = i(), c = {
		currentType: 13,
		offset: s,
		startLoc: o,
		endLoc: o,
	...
	function h(e) {
		let t = "";
		for (; e.currentPeek() === U || e.currentPeek() === G;) t += e.currentPeek(), e.peek();
		return t;
	}
	function g(e) {
		let t = h(e);
	...
	function T(e, t) {
		...
		let r = () => {
			let t = e.currentPeek();
			return t === "{" ? _(e.peek()) : t === "@" || t === "|" || t === ":" || t === "." || t === U || !t ? !1 : t === G ? (e.peek(), r()) : ee(e, !1);
		}, i = r();
	...
	function ee(e, t = !0) {
		let n = (t = !1, r = "") => {
			let i = e.currentPeek();
			return i === "{" || i === "@" || !i ? t : i === "|" ? r !== U && r !== G : i === U ? (e.peek(), n(!0, U)) : i !== G || (e.peek(), n(!0, G));
		}, r = n();
		return t && e.resetPeek(), r;
	}
	function D(e, t) {
		let n = e.currentChar();
		if (n !== Pe) return t(n) ? (e.next(), n) : null;
	}
	function O(e) {
		let t = e.charCodeAt(0);
	...
	function M(e) {
		g(e);
		let t = "";
		return e.currentChar() === "-" ? (e.next(), t += `-${ae(e)}`) : t += ae(e), e.currentChar() === Pe && d(H.UNTERMINATED_CLOSING_BRACE, a(), 0), t;
	}
	function ce(e) {
		return e !== Fe && e !== G;
	}
	function N(e) {
		g(e), m(e, "'");
		let t = "", n = "";
		for (; t = D(e, ce);) n += t === "\\" ? le(e) : t;
		let r = e.currentChar();
		return r === G || r === Pe ? (d(H.UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER, a(), 0), r === G && (e.next(), m(e, "'")), n) : (m(e, "'"), n);
	}
	function le(e) {
		let t = e.currentChar();
		switch (t) {
	...
	function I(e, t) {
		...
		switch (e.currentChar()) {
			...
			case "@": return t.braceNest > 0 && d(H.UNTERMINATED_CLOSING_BRACE, a(), 0), n = L(e, t) || p(t), t.braceNest = 0, n;
			default: {
				let r = !0, i = !0, o = !0;
				if (E(e)) return t.braceNest > 0 && d(H.UNTERMINATED_CLOSING_BRACE, a(), 0), n = f(t, 1, F(e)), t.braceNest = 0, t.inLinked = !1, n;
				if (t.braceNest > 0 && (t.currentType === 4 || t.currentType === 5 || t.currentType === 6)) return d(H.UNTERMINATED_CLOSING_BRACE, a(), 0), t.braceNest = 0, R(e, t);
	...
	function L(e, t) {
		...
		switch ((n === 7 || n === 8 || n === 11 || n === 9) && (i === G || i === U) && d(H.INVALID_LINKED_FORMAT, a(), 0), i) {
			case "@": return e.next(), r = f(t, 7, "@"), t.inLinked = !0, r;
			case ".": return g(e), e.next(), f(t, 8, ".");
			case ":": return g(e), e.next(), f(t, 9, ":");
			default: return E(e) ? (r = f(t, 1, F(e)), t.braceNest = 0, t.inLinked = !1, r) : S(e, t) || w(e, t) ? (g(e), L(e, t)) : C(e, t) ? (g(e), f(t, 11, fe(e))) : T(e, t) ? (g(e), i === "{" ? I(e, t) || r : f(t, 10, pe(e))) : (n === 7 && d(H.INVALID_LINKED_FORMAT, a(), 0), t.braceNest = 0, t.inLinked = !1, R(e, t));
		}
	}
	function R(e, t) {
		let n = { type: 13 };
		...
		switch (e.currentChar()) {
			...
			default:
				...
				if (ee(e)) return f(t, 0, oe(e));
		}
		return n;
	}
	function z() {
		let { currentType: e, offset: t, startLoc: n, endLoc: o } = c;
		return c.lastType = e, c.lastOffset = t, c.lastStartLoc = n, c.lastEndLoc = o, c.offset = i(), c.startLoc = a(), r.currentChar() === Pe ? f(c, 13) : R(r, c);
	}
	return {
		nextToken: z,
		currentOffset: i,
...
function Ue(e = {}) {
	...
	function g(n) {
		let o = Le(n, M({}, e)), s = o.context(), c = i(0, s.offset, s.startLoc);
...
function Ze(e) {
	switch (e.t = e.type, e.type) {
		...
		default: if (process.env.NODE_ENV !== "production") throw De(H.UNHANDLED_MINIFIER_NODE_TYPE, null, {
			domain: Xe,
			args: [e.type]
		});
	}
...
function it(e, t) {
	...
	switch (t.type) {
		...
		case 3:
			e.push(JSON.stringify(t.value), t);
			break;
		default: if (process.env.NODE_ENV !== "production") throw De(H.UNHANDLED_CODEGEN_NODE_TYPE, null, {
			domain: Qe,
			args: [t.type]
		});
	}
...
var at = (e, t = {}) => {
	...
	c.push(n === "normal" ? "function __msg__ (ctx) {" : "(ctx) => {"), c.indent(o), s.length > 0 && (c.push(`const { ${ve(s.map((e) => `${e}: _${e}`), ", ")} } = ctx`), c.newline()), c.push("return "), it(c, e), c.deindent(o), c.push("}"), delete e.helpers;
...
function ot(e, t = {}) {
	let n = M({}, t), r = !!n.jit, i = !!n.minify, a = n.optimize == null || n.optimize, o = Ue(n).parse(e);
...
function q(e) {
	return B(e) && gt(e) === 0 && (F(e, "b") || F(e, "body"));
}
var st = ["b", "body"];
function ct(e) {
	return Ct(e, st);
...
function Ft(e, t) {
	...
	{
		if (process.env.NODE_ENV !== "production" && !q(e)) return T(`the message that is resolve with key '${t.key}' is not supported for jit compilation`), (() => e);
		let n = e.cacheKey;
...
function Vt(e) {
	return De(e, null, process.env.NODE_ENV === "production" ? void 0 : { messages: Ht });
}
var Ht = {
...
function Gt(e) {
	...
	if (L(e)) {
		...
		if (e.constructor.name === "Function") {
			let t = e();
			if (me(t)) throw Vt(J.NOT_SUPPORT_LOCALE_PROMISE_VALUE);
			return Wt = t;
		}
		throw Vt(J.NOT_SUPPORT_LOCALE_ASYNC_FUNCTION);
	}
	throw Vt(J.NOT_SUPPORT_LOCALE_TYPE);
}
function Kt(e, t, n) {
...
function qt(e, t, n) {
	...
	if (!a) {
		...
		e = R(o) ? [o] : o, I(e) && Jt(a, e, !1), i.__localeChainCache.set(r, a);
	}
	return a;
}
function Jt(e, t, n) {
...
function sn(e, t) {
	...
	for (; a < r;) {
		let e = n[a];
		if (wt.includes(e) && q(i) || !B(i) || !F(i, e)) return null;
		let t = i[e];
...
function pn() {
	return {
		...
		capitalize: (e, t) => t === "text" && R(e) ? fn(e) : t === "vnode" && B(e) && "__v_isVNode" in e ? fn(e.children) : e
	};
}
var mn;
function hn(e) {
...
function Dn(e = {}) {
	let t = L(e.onWarn) ? e.onWarn : T, n = R(e.version) ? e.version : un, r = R(e.locale) || L(e.locale) ? e.locale : dn, i = L(r) ? dn : r, a = I(e.fallbackLocale) || V(e.fallbackLocale) || R(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : i, o = V(e.messages) ? e.messages : On(i), s = V(e.datetimeFormats) ? e.datetimeFormats : On(i), c = V(e.numberFormats) ? e.numberFormats : On(i), l = M(N(), e.modifiers, pn()), u = e.pluralRules || N(), d = L(e.missing) ? e.missing : null, f = z(e.missingWarn) || oe(e.missingWarn) ? e.missingWarn : !0, p = z(e.fallbackWarn) || oe(e.fallbackWarn) ? e.fallbackWarn : !0, m = !!e.fallbackFormat, h = !!e.unresolving, g = L(e.postTranslation) ? e.postTranslation : null, _ = V(e.processor) ? e.processor : null, v = !z(e.warnHtmlMessage) || e.warnHtmlMessage, y = !!e.escapeParameter, b = L(e.messageCompiler) ? e.messageCompiler : mn;
	process.env.NODE_ENV !== "production" && L(e.messageCompiler) && ee(ln(Y.EXPERIMENTAL_CUSTOM_MESSAGE_COMPILER));
	let x = L(e.messageResolver) ? e.messageResolver : gn || on, S = L(e.localeFallbacker) ? e.localeFallbacker : vn || Kt, C = B(e.fallbackContext) ? e.fallbackContext : void 0, w = e, E = B(w.__datetimeFormatters) ? w.__datetimeFormatters : /* @__PURE__ */ new Map(), D = B(w.__numberFormatters) ? w.__numberFormatters : /* @__PURE__ */ new Map(), O = B(w.__meta) ? w.__meta : {};
	En++;
	let k = {
		version: n,
		cid: En,
	...
	return k.datetimeFormats = s, k.numberFormats = c, k.__datetimeFormatters = E, k.__numberFormatters = D, process.env.NODE_ENV !== "production" && (k.__v_emitter = w.__v_emitter == null ? void 0 : w.__v_emitter), process.env.NODE_ENV !== "production" && Rt(k, n, O), k;
}
var On = (e) => ({ [e]: N() });
function kn(e, t) {
...
function jn(e, t, n, r, i) {
	...
	return process.env.NODE_ENV !== "production" && An(r, t) && o(ln(Y.NOT_FOUND_KEY, {
		key: t,
		locale: n
	})), t;
}
...
function Ln(e, ...t) {
	...
	if (process.env.NODE_ENV !== "production" && !In.dateTimeFormat) return a(ln(Y.CANNOT_FORMAT_DATE)), "";
	if (!R(t[0]) && !ae(t[0]) && !j(t[0])) return process.env.NODE_ENV !== "production" && a(ln(Y.INVALID_DATE_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = zn(...t), f = z(u.missingWarn) ? u.missingWarn : e.missingWarn, p = z(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = Ut(e, u), g = o(e, i, h);
	if (!R(c) || c === "") return new Intl.DateTimeFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "datetime format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && kn(p, c) && a(ln(Y.FALLBACK_TO_DATE_FORMAT, {
			key: c,
			target: v
...
function zn(...e) {
	...
	if (R(t)) {
		...
		if (!e) throw Vt(J.INVALID_ISO_DATE_ARGUMENT);
		let n = e[3] ? e[3].trim().startsWith("T") ? `${e[1].trim()}${e[3].trim()}` : `${e[1].trim()}T${e[3].trim()}` : e[1].trim();
		s = new Date(n);
		try {
			s.toISOString();
		} catch {
			throw Vt(J.INVALID_ISO_DATE_ARGUMENT);
		}
	} else if (ae(t)) {
		if (isNaN(t.getTime())) throw Vt(J.INVALID_DATE_ARGUMENT);
		s = t;
	} else if (j(t)) s = t;
	else throw Vt(J.INVALID_ARGUMENT);
...
function Vn(e, ...t) {
	...
	if (process.env.NODE_ENV !== "production" && !In.numberFormat) return a(ln(Y.CANNOT_FORMAT_NUMBER)), "";
	if (!j(t[0])) return process.env.NODE_ENV !== "production" && a(ln(Y.INVALID_NUMBER_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = Un(...t), f = z(u.missingWarn) ? u.missingWarn : e.missingWarn, p = z(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = Ut(e, u), g = o(e, i, h);
	if (!R(c) || c === "") return new Intl.NumberFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "number format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && kn(p, c) && a(ln(Y.FALLBACK_TO_NUMBER_FORMAT, {
			key: c,
			target: v
		})), process.env.NODE_ENV !== "production" && h !== v) {
			let t = e.__v_emitter;
...
function Un(...e) {
	...
	if (!j(t)) throw Vt(J.INVALID_ARGUMENT);
	let s = t;
	return R(n) ? a.key = n : V(n) && Object.keys(n).forEach((e) => {
...
var Gn = (e) => e, Kn = (e) => "", qn = "text", Jn = (e) => e.length === 0 ? "" : ve(e), Yn = _e;
function Xn(e, t) {
...
function Qn(e = {}) {
	let t = e.locale, n = Zn(e), r = R(t) && L(e.pluralRules?.[t]) ? e.pluralRules[t] : Xn, i = r === Xn ? void 0 : Xn, a = (e) => e[r(n, e.length, i)], o = e.list || [], s = (e) => o[e], c = e.named || N();
	j(e.pluralIndex) && (c.count ||= e.pluralIndex, c.n ||= e.pluralIndex);
	let l = (e) => c[e];
	function u(t, n) {
		return (L(e.messages) ? e.messages(t, !!n) : B(e.messages) ? e.messages[t] : !1) || (e.parent ? e.parent.message(t) : Kn);
	}
	let d = (t) => e.modifiers ? e.modifiers[t] : Gn, f = L(e.processor?.normalize) ? e.processor.normalize : Jn, p = L(e.processor?.interpolate) ? e.processor.interpolate : Yn, m = {
		list: s,
		named: l,
		plural: a,
		linked: (e, ...t) => {
...
var $n = () => "", X = (e) => L(e);
function er(e, ...t) {
	let { fallbackFormat: n, postTranslation: r, unresolving: i, messageCompiler: a, fallbackLocale: o, messages: s } = e, [c, l] = ar(...t), u = z(l.missingWarn) ? l.missingWarn : e.missingWarn, d = z(l.fallbackWarn) ? l.fallbackWarn : e.fallbackWarn, f = z(l.escapeParameter) ? l.escapeParameter : e.escapeParameter, p = !!l.resolvedMessage, m = R(l.default) || z(l.default) ? z(l.default) ? a ? c : () => c : l.default : n ? a ? c : () => c : null, h = n || m != null && (R(m) || L(m)), g = Ut(e, l);
	f && tr(l);
	let [_, v, y] = p ? [
		c,
		g,
	...
	if (process.env.NODE_ENV !== "production" && R(b) && e.messageCompiler == null) return T(`The message format compilation is not supported in this build. Because message compiler isn't included. You need to pre-compilation all message format. So translate function return '${c}'.`), c;
	let S = !1, C = X(b) ? b : rr(e, c, v, b, x, () => {
		S = !0;
	});
	if (S) return b;
	let w = ir(e, C, Qn(cr(e, v, y, l))), E = r ? r(w, c) : w;
	if (f && R(E) && (E = fe(E)), process.env.NODE_ENV !== "production") {
		let t = {
			timestamp: Date.now(),
			key: R(c) ? c : X(b) ? b.key : "",
		...
		t.meta = M({}, e.__meta, Sn() || {}), zt(t);
	}
	return E;
}
function tr(e) {
	I(e.list) ? e.list = e.list.map((e) => R(e) ? ue(e) : e) : B(e.named) && Object.keys(e.named).forEach((t) => {
		R(e.named[t]) && (e.named[t] = ue(e.named[t]));
	});
}
function nr(e, t, n, r, i, a) {
	...
	for (let r = 0; r < u.length; r++) {
		f = h = u[r], process.env.NODE_ENV !== "production" && n !== f && !Nn(n, f) && kn(i, t) && s(ln(Y.FALLBACK_TO_TRANSLATE, {
			key: t,
			target: f
		}));
...
function ar(...e) {
	let [t, n, r] = e, i = N();
	if (!R(t) && !j(t) && !X(t) && !q(t)) throw Vt(J.INVALID_ARGUMENT);
	let a = j(t) ? String(t) : (X(t), t);
	return j(n) ? i.plural = n : R(n) ? i.default = n : V(n) && !se(n) ? i.named = n : I(n) && (i.list = n), j(r) ? i.plural = r : R(r) ? i.default = r : V(r) && M(i, r), [a, i];
}
	...
	return {
		...
		onError: (t) => {
			if (a && a(t), process.env.NODE_ENV !== "production") {
				let i = sr(r), a = t.location && i && be(i, t.location.start.offset, t.location.end.offset), o = e.__v_emitter;
...
var dr = typeof Proxy == "function", fr = "devtools-plugin:setup", pr = "plugin:settings:set", mr, hr;
function gr() {
	return mr === void 0 && (typeof window < "u" && window.performance ? (mr = !0, hr = window.performance) : typeof globalThis < "u" && globalThis.perf_hooks?.performance ? (mr = !0, hr = globalThis.perf_hooks.performance) : mr = !1), mr;
}
function _r() {
	return gr() ? hr.now() : Date.now();
}
var vr = class {
	constructor(e, t) {
...
function yr(e, t) {
	let n = e, r = ur(), i = lr(), a = dr && n.enableEarlyProxy;
	if (i && (r.__VUE_DEVTOOLS_PLUGIN_API_AVAILABLE__ || !a)) i.emit(fr, e, t);
	else {
		let e = a ? new vr(n, i) : null;
...
}, Sr = A("__translateVNode"), Cr = A("__datetimeParts"), wr = A("__numberParts"), Tr = A("__enableEmitter"), Er = A("__disableEmitter"), Dr = A("__setPluralRules");
A("__intlifyMeta");
var Or = A("__injectWithOption"), kr = A("__dispose"), $ = {
	FALLBACK_TO_ROOT: 10,
...
function Mr(e) {
	...
	for (let t in e) if (F(e, t)) {
		if (!t.includes(".")) B(e[t]) && Mr(e[t]);
		else {
			let n = t.split("."), r = n.length - 1, i = e, a = !1;
			for (let e = 0; e < r; e++) {
				if (n[e] === "__proto__") throw Error(`unsafe key: ${n[e]}`);
				if (n[e] in i || (i[n[e]] = N()), !B(i[n[e]])) {
					process.env.NODE_ENV !== "production" && T(jr($.IGNORE_OBJ_FLATTEN, { key: n[e] })), a = !0;
					break;
				}
				i = i[n[e]];
			}
			if (a || (q(i) ? wt.includes(n[r]) || delete e[t] : (i[n[r]] = e[t], delete e[t])), !q(i)) {
				let e = i[n[r]];
				B(e) && Mr(e);
			}
		}
...
function Nr(e, t) {
	...
	if (I(r) && r.forEach((e) => {
		if ("locale" in e && "resource" in e) {
			...
			t ? (o[t] = o[t] || N(), Ce(n, o[t])) : Ce(n, o);
		} else R(e) && Ce(JSON.parse(e), o);
	}), i == null && a) for (let e in o) F(o, e) && Mr(o[e]);
	return o;
}
function Pr(e) {
	return e.type;
...
function Fr(e, t, n) {
	...
	"__i18nGlobal" in n && (r = Nr(e.locale.value, {
		messages: r,
...
var Rr = "__INTLIFY_META__", zr = () => [], Br = () => !1, Vr = 0;
function Hr(e) {
	return ((t, n, r, i) => e(n, r, Lr() || void 0, i));
}
var Ur = () => {
	let e = Lr(), t = null;
	return e && (t = Pr(e)[Rr]) ? { [Rr]: t } : null;
};
function Wr(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = D ? y : x, s = !z(e.inheritLocale) || e.inheritLocale, c = o(t && s ? t.locale.value : R(e.locale) ? e.locale : dn), l = o(t && s ? t.fallbackLocale.value : R(e.fallbackLocale) || I(e.fallbackLocale) || V(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(Nr(c.value, e)), d = o(V(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(V(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : z(e.missingWarn) || oe(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : z(e.fallbackWarn) || oe(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : !z(e.fallbackRoot) || e.fallbackRoot, g = !!e.fallbackFormat, _ = L(e.missing) ? e.missing : null, v = L(e.missing) ? Hr(e.missing) : null, b = L(e.postTranslation) ? e.postTranslation : null, S = t ? t.warnHtmlMessage : !z(e.warnHtmlMessage) || e.warnHtmlMessage, C = !!e.escapeParameter, E = t ? t.modifiers : V(e.modifiers) ? e.modifiers : {}, ee = e.pluralRules || t && t.pluralRules, O;
	O = (() => {
		i && wn(null);
		let t = {
			version: br,
	...
	}), A = r(() => u.value), re = r(() => d.value), ie = r(() => f.value);
	function ae() {
		return L(b) ? b : null;
	}
	function se(e) {
	...
	let P = (e, n, r, a, o, s) => {
		...
		let c;
		try {
			process.env.NODE_ENV !== "production" && xn(Ur()), i || (O.fallbackContext = t ? Tn() : void 0), c = e(O);
		} finally {
			process.env.NODE_ENV !== "production" && xn(null), i || (O.fallbackContext = void 0);
		}
		if (r !== "translate exists" && j(c) && c === -1 || r === "translate exists" && !c) {
			let [e, i] = n();
			if (process.env.NODE_ENV !== "production" && t && R(e) && le(r, i) && (h && (kn(m, e) || An(p, e)) && T(jr($.FALLBACK_TO_ROOT, {
				key: e,
				type: r
	...
	function ue(...e) {
		return P((t) => Reflect.apply(er, null, [t, ...e]), () => ar(...e), "translate", (t) => Reflect.apply(t.t, t, [...e]), (e) => e, (e) => R(e));
	}
	function de(...e) {
		let [t, n, r] = e;
	...
	function fe(...e) {
		return P((t) => Reflect.apply(Ln, null, [t, ...e]), () => zn(...e), "datetime format", (t) => Reflect.apply(t.d, t, [...e]), () => "", (e) => R(e) || I(e));
	}
	function pe(...e) {
		return P((t) => Reflect.apply(Vn, null, [t, ...e]), () => Un(...e), "number format", (t) => Reflect.apply(t.n, t, [...e]), () => "", (e) => R(e) || I(e));
	}
	function me(e) {
		return e.map((e) => R(e) || j(e) || z(e) ? Ir(String(e)) : e);
	}
	let he = {
		normalize: me,
		interpolate: (e) => e,
	...
	function ge(...e) {
		return P((t) => {
			let n, r = t;
			try {
				r.processor = he, n = Reflect.apply(er, null, [r, ...e]);
			} finally {
				r.processor = null;
			}
			return n;
		}, () => ar(...e), "translate", (t) => t[Sr](...e), (e) => [Ir(e)], (e) => I(e));
	}
	function _e(...e) {
		return P((t) => Reflect.apply(Vn, null, [t, ...e]), () => Un(...e), "number format", (t) => t[wr](...e), zr, (e) => R(e) || I(e));
	}
	function ve(...e) {
		return P((t) => Reflect.apply(Ln, null, [t, ...e]), () => zn(...e), "datetime format", (t) => t[Cr](...e), zr, (e) => R(e) || I(e));
	}
	function ye(e) {
		ee = e, O.pluralRules = ee;
	}
	function be(e, t) {
		return P(() => {
			if (!e) return !1;
			let n = R(t) ? t : c.value, r = R(t) ? [n] : qt(O, l.value, n);
			for (let t = 0; t < r.length; t++) {
				let n = we(r[t]), i = O.messageResolver(n, e);
				if (i === null && (i = n[e]), q(i) || X(i) || R(i)) return !0;
			}
			return !1;
		}, () => [e], "translate exists", (n) => Reflect.apply(n.te, n, [e, t]), Br, (e) => z(e));
	}
	function xe(e) {
	...
	function H(e, t) {
		u.value[e] = u.value[e] || {};
		let n = { [e]: t };
		if (a) for (let e in n) F(n, e) && Mr(n[e]);
	...
	function Oe(e, t) {
		d.value[e] = M(d.value[e] || {}, t), O.datetimeFormats = d.value, Bn(O, e, t);
	}
	function ke(e) {
		return f.value[e] || {};
	}
	...
	function U(e, t) {
		f.value[e] = M(f.value[e] || {}, t), O.numberFormats = f.value, Wn(O, e, t);
	}
	Vr++, t && D && (w(t.locale, (e) => {
	...
	return W.datetimeFormats = re, W.numberFormats = ie, W.rt = de, W.te = be, W.tm = Se, W.d = fe, W.n = pe, W.getDateTimeFormat = Ee, W.setDateTimeFormat = De, W.mergeDateTimeFormat = Oe, W.getNumberFormat = ke, W.setNumberFormat = Ae, W.mergeNumberFormat = U, W[Or] = n, W[Sr] = ge, W[Cr] = ve, W[wr] = _e, process.env.NODE_ENV !== "production" && (W[Tr] = (e) => {
		O.__v_emitter = e;
	}, W[Er] = () => {
		O.__v_emitter = void 0;
	}), W;
}
var Gr = "vue-i18n: composer properties", Kr = {
	"vue-devtools-plugin-vue-i18n": "Vue I18n DevTools",
	"vue-i18n-resource-inspector": "Vue I18n DevTools",
	"vue-i18n-timeline": "Vue I18n"
}, qr = { "vue-i18n-resource-inspector": "Search for scopes ..." }, Jr = { "vue-i18n-timeline": 16764185 }, Yr;
async function Xr(e, t) {
	return new Promise((n, r) => {
		try {
			yr({
				id: "vue-devtools-plugin-vue-i18n",
				label: Kr["vue-devtools-plugin-vue-i18n"],
				...
				Yr = r, r.on.visitComponentTree(({ componentInstance: e, treeNode: n }) => {
					Qr(e, n, t);
				}), r.on.inspectComponent(({ componentInstance: e, instanceData: n }) => {
					e.__VUE_I18N__ && n && (t.mode === "legacy" ? e.__VUE_I18N__ !== t.global.__composer && $r(n, e.__VUE_I18N__) : $r(n, e.__VUE_I18N__));
				}), r.addInspector({
					id: "vue-i18n-resource-inspector",
					label: Kr["vue-i18n-resource-inspector"],
					icon: "language",
				...
				r.on.getInspectorState(async (n) => {
					if (n.app === e && n.inspectorId === "vue-i18n-resource-inspector") {
						if (r.unhighlightElement(), ci(n, t), n.nodeId === "global") {
							if (!i.has(n.app)) {
					...
					label: Kr["vue-i18n-timeline"],
					color: Jr["vue-i18n-timeline"]
				}), n(!0);
			});
		} catch (e) {
			console.error(e), r(!1);
...
function ei(e) {
	...
	return Object.keys(e).forEach((n) => {
		let r = e[n];
		L(r) && "source" in r ? t[n] = ii(r) : q(r) && r.loc && r.loc.source ? t[n] = r.loc.source : B(r) ? t[n] = ei(r) : t[n] = r;
	}), t;
}
var ti = {
	"<": "&lt;",
...
function ui(e, t) {
	if (Yr) {
		let n;
		t && "groupId" in t && (n = t.groupId, delete t.groupId), Yr.addTimelineEvent({
...
var hi = s({
	...
	setup(e, t) {
		let { slots: n, attrs: r } = t, i = e.i18n || Ei({
			useScope: e.scope,
			__useComponent: !0
		});
		return () => {
			...
			let s = pi(t, a), c = i[Sr](e.keypath, s, o), l = M(N(), r), u = R(e.tag) || B(e.tag) ? e.tag : mi();
			return d(u, l, c);
		};
	}
});
...
function _i(e, t, n, r) {
	...
	return () => {
		...
		I(s) ? c = s.map((e, t) => {
			...
			return gi(r) && (r[0].key = `${e.type}-${t}`), r;
		}) : R(s) && (c = [s]);
		let l = M(N(), a), u = R(e.tag) || B(e.tag) ? e.tag : mi();
		return d(u, l, c);
	};
}
var vi = s({
...
function bi(e) {
	let t = (t) => {
		process.env.NODE_ENV !== "production" && ee(jr($.DEPRECATE_TRANSLATE_CUSTOME_DIRECTIVE));
		let { instance: n, value: r } = t;
		if (!n || !n.$) throw Q(Z.UNEXPECTED_ERROR);
		let i = yi(e, n.$), a = xi(r);
		return [Reflect.apply(i.t, i, [...Si(a)]), i];
	};
	return {
		created: (e, n) => {
			let [r, i] = t(n);
			D && (e.__i18nWatcher = w(i.locale, () => {
		...
		beforeUpdate: (e, { value: t }) => {
			if (e.__composer) {
				let n = e.__composer, r = xi(t);
				e.textContent = Reflect.apply(n.t, n, [...Si(r)]);
			}
		},
		getSSRProps: (e) => {
			let [n] = t(e);
...
function Ci(e, t, ...n) {
	let r = V(n[0]) ? n[0] : {};
	(!z(r.globalInstall) || r.globalInstall) && ([hi.name, "I18nT"].forEach((t) => e.component(t, hi)), [vi.name, "I18nN"].forEach((t) => e.component(t, vi)), [Li.name, "I18nD"].forEach((t) => e.component(t, Li))), e.directive("t", bi(t));
}
var wi = A("global-vue-i18n");
function Ti(e = {}) {
	process.env.NODE_ENV;
	let t = !z(e.globalInjection) || e.globalInjection, n = /* @__PURE__ */ new Map(), [r, i] = Di(e, !1), a = A(process.env.NODE_ENV === "production" ? "" : "vue-i18n");
	function o(e) {
		return n.get(e) || null;
	}
	function s(e, t) {
	...
	let l = {
		...
		async install(e, ...n) {
			...
			let r = null;
			t && (r = Ii(e, l.global)), Ci(e, l, ...n);
			let o = e.unmount;
			if (e.unmount = () => {
				r && r(), l.dispose(), o();
			}, process.env.NODE_ENV !== "production") {
				if (!await Xr(e, l)) throw Q(Z.CANNOT_SETUP_VUE_DEVTOOLS_PLUGIN);
				let t = xe();
				{
					let e = i;
					e[Tr] && e[Tr](t);
...
function Ei(e = {}) {
	...
	let n = Oi(t), r = Ai(n), i = Pr(t), a = ki(e, i);
	if (a === "global") return Fr(r, e, i), r;
	if (a === "parent") {
		let i = ji(n, t, e.__useComponent);
		return i ??= (process.env.NODE_ENV !== "production" && T(jr($.NOT_FOUND_PARENT_SCOPE)), r), i;
	}
	if (a === "isolated") {
	...
	if (s == null) {
		let n = M({}, e);
		"__i18n" in i && (n.__i18n = i.__i18n), r && (n.__root = r), s = Wr(n), o.__composerExtend && (s[kr] = o.__composerExtend(s)), Ni(o, t, s), o.__setInstance(t, s);
	} else process.env.NODE_ENV !== "production" && a === "local" && T(jr($.DUPLICATE_USE_I18N_CALLING));
	return s;
}
function Di(e, t) {
	let n = c(), r = n.run(() => Wr(e));
	if (r == null) throw Q(Z.UNEXPECTED_ERROR);
	return [n, r];
}
function Oi(e) {
	let t = f(e.isCE ? wi : e.appContext.app.__VUE_I18N_SYMBOL__);
...
function Ni(e, t, n) {
	...
	h(() => {
		...
		let i = n;
		process.env.NODE_ENV !== "production" && (r && r.off("*", ui), i[Er] && i[Er](), delete t.__VUE_I18N__), e.__deleteInstance(t);
		let a = i[kr];
		a && (a(), delete i[kr]);
	}, t);
}
...
var Li = s({
	...
	setup(e, t) {
		...
		return _i(e, t, Rn, (...e) => n[Cr](...e));
	}
});
if (hn(Ft), _n(sn), yn(qt), process.env.NODE_ENV !== "production") {
	let e = P();
...
var zi = { class: "mb-16" }, Bi = { class: "mb-6 text-2xl font-bold text-foreground" }, Vi = { class: "grid gap-6 md:grid-cols-3" }, Hi = { class: "rounded-lg border border-border bg-card p-6" }, Ui = { class: "mb-2 text-lg font-semibold text-foreground" }, Wi = { class: "text-sm text-muted-foreground" }, Gi = { class: "rounded-lg border border-border bg-card p-6" }, Ki = { class: "mb-2 text-lg font-semibold text-foreground" }, qi = { class: "text-sm text-muted-foreground" }, Ji = { class: "rounded-lg border border-border bg-card p-6" }, Yi = { class: "mb-2 text-lg font-semibold text-foreground" }, Xi = { class: "text-sm text-muted-foreground" }, Zi = s({
	__name: "WhyItMatters",
	setup(e) {
		Ri("WhyItMatters");
		let { t } = Ei();
		return (e, n) => (v(), i("section", zi, [a("h2", Bi, S(C(t)("home.whyItMatters.title")), 1), a("div", Vi, [
			a("div", Hi, [a("h3", Ui, S(C(t)("home.whyItMatters.bundleSizeTitle")), 1), a("p", Wi, S(C(t)("home.whyItMatters.bundleSizeDesc")), 1)]),
			a("div", Gi, [a("h3", Ki, S(C(t)("home.whyItMatters.renderingTitle")), 1), a("p", qi, S(C(t)("home.whyItMatters.renderingDesc")), 1)]),
			a("div", Ji, [a("h3", Yi, S(C(t)("home.whyItMatters.dynamicLoadingTitle")), 1), a("p", Xi, S(C(t)("home.whyItMatters.dynamicLoadingDesc")), 1)])
		])]));
	}
}), Qi = Ti({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Qi), (e, t) => b(e.$slots, "default");
	}
}), ea = { render() {
	return d($i, {}, { default: () => d(Zi) });
} };
