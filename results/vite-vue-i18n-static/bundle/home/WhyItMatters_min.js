...
import { Fragment as t, Text as n, computed as r, createElementBlock as i, createElementVNode as a, createVNode as o, defineComponent as s, effectScope as c, getCurrentInstance as l, getCurrentScope as u, h as d, inject as f, isRef as p, onBeforeMount as m, onMounted as h, onScopeDispose as g, onUnmounted as _, openBlock as v, ref as y, renderSlot as b, shallowRef as x, toDisplayString as S, watch as C } from "vue";
import w from "../../../../locales/fr.json";
import T from "../../../../locales/es.json";
import E from "../../../../locales/de.json";
import D from "../../../../locales/it.json";
import O from "../../../../locales/pt.json";
import ee from "../../../../locales/zh.json";
import te from "../../../../locales/ja.json";
import ne from "../../../../locales/ko.json";
import re from "../../../../locales/ru.json";
function k(e, t) {
...
var se = /\{([0-9a-zA-Z]+)\}/g;
function ce(e, ...t) {
	return t.length === 1 && V(t[0]) && (t = t[0]), (!t || !t.hasOwnProperty) && (t = {}), e.replace(se, (e, n) => t.hasOwnProperty(n) ? t[n] : "");
}
var M = (e, t = !1) => t ? Symbol.for(e) : Symbol(e), le = (e, t, n) => ue({
	l: e,
	k: t,
	s: n
}), ue = (e) => JSON.stringify(e).replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029").replace(/\u0027/g, "\\u0027"), N = (e) => typeof e == "number" && isFinite(e), de = (e) => Ce(e) === "[object Date]", fe = (e) => Ce(e) === "[object RegExp]", pe = (e) => H(e) && Object.keys(e).length === 0, P = Object.assign, me = Object.create, F = (e = null) => me(e), he, ge = () => he ||= typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : F();
function _e(e) {
...
function ye(e) {
	return e = e.replace(/(\w+)\s*=\s*"([^"]*)"/g, (e, t, n) => `${t}="${ve(n)}"`), e = e.replace(/(\w+)\s*=\s*'([^']*)'/g, (e, t, n) => `${t}='${ve(n)}'`), /\s*on\w+\s*=\s*["']?[^"'>]+["']?/gi.test(e) && (process.env.NODE_ENV !== "production" && k("Potentially dangerous event handlers detected in translation. Consider removing onclick, onerror, etc. from your translation messages."), e = e.replace(/(\s+)(on)(\w+\s*=)/gi, "$1&#111;n$3")), [/(\s+(?:href|src|action|formaction)\s*=\s*["']?)\s*javascript:/gi, /(style\s*=\s*["'][^"']*url\s*\(\s*)javascript:/gi].forEach((t) => {
...
var L = Array.isArray, R = (e) => typeof e == "function", z = (e) => typeof e == "string", B = (e) => typeof e == "boolean", V = (e) => typeof e == "object" && !!e, xe = (e) => V(e) && R(e.then) && R(e.catch), Se = Object.prototype.toString, Ce = (e) => Se.call(e), H = (e) => Ce(e) === "[object Object]", we = (e) => e == null ? "" : L(e) || H(e) && e.toString === Se ? JSON.stringify(e, null, 2) : String(e);
function Te(e, t = "") {
	return e.reduce((e, n, r) => r === 0 ? e + n : e + t + n, "");
}
var Ee = 2;
function De(e, t = 0, n = e.length) {
	let r = e.split(/\r?\n/), i = 0, a = [];
	for (let e = 0; e < r.length; e++) if (i += r[e].length + 1, i >= t) {
		for (let o = e - Ee; o <= e + Ee || n > i; o++) {
...
var ke = (e) => !V(e) || L(e);
function Ae(e, t) {
	if (ke(e) || ke(t)) throw Error("Invalid value");
	let n = [{
		src: e,
		des: t
	}];
	for (; n.length;) {
		...
		Object.keys(e).forEach((r) => {
			r !== "__proto__" && (V(e[r]) && !V(t[r]) && (t[r] = Array.isArray(e[r]) ? [] : F()), ke(t[r]) || ke(e[r]) ? t[r] = e[r] : n.push({
				src: e[r],
				des: t[r]
			}));
		});
...
function Ne(e, t, n = {}) {
	let { domain: r, messages: i, args: a } = n, o = process.env.NODE_ENV === "production" ? e : ce((i || Me)[e] || "", ...a || []), s = SyntaxError(String(o));
	return s.code = e, t && (s.location = t), s.domain = r, s;
}
function Pe(e) {
	throw e;
}
var Fe = /<\/?[\w\s="/.':;#-\/]+>/, Ie = (e) => Fe.test(e), G = " ", Le = "\r", K = "\n", Re = "\u2028", ze = "\u2029";
function Be(e) {
	let t = e, n = 0, r = 1, i = 1, a = 0, o = (e) => t[e] === Le && t[e + 1] === K, s = (e) => t[e] === K, c = (e) => t[e] === ze, l = (e) => t[e] === Re, u = (e) => o(e) || s(e) || c(e) || l(e), d = () => n, f = () => r, p = () => i, m = () => a, h = (e) => o(e) || c(e) || l(e) ? K : t[e], g = () => h(n), _ = () => h(n + a);
	function v() {
...
function We(e, t = {}) {
	let n = t.location !== !1, r = Be(e), i = () => r.index(), a = () => je(r.line(), r.column(), r.index()), o = a(), s = i(), c = {
		currentType: 13,
		offset: s,
		startLoc: o,
		endLoc: o,
	...
	function d(e, t, r, ...i) {
		let a = l();
		t.column += r, t.offset += r, u && u(Ne(e, n ? U(a.startLoc, t) : null, {
			domain: Ue,
			args: i
		}));
	}
	function f(e, t, r) {
		...
		let i = { type: t };
		return n && (i.loc = U(e.startLoc, e.endLoc)), r != null && (i.value = r), i;
	}
	let p = (e) => f(e, 13);
	function m(e, t) {
	...
	function se(e) {
		...
		for (; t = re(e);) n += t;
		let r = e.currentChar();
		if (r && r !== "}" && r !== Ve && r !== G && r !== K && r !== "　") {
			let t = fe(e);
			return d(W.INVALID_TOKEN_IN_PLACEHOLDER, a(), 0, n + t), n + t;
		}
		return e.currentChar() === Ve && d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), n;
	}
	function ce(e) {
		g(e);
		let t = "";
		return e.currentChar() === "-" ? (e.next(), t += `-${j(e)}`) : t += j(e), e.currentChar() === Ve && d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), t;
	}
	function M(e) {
		return e !== He && e !== K;
	}
	function le(e) {
		...
		let r = e.currentChar();
		return r === K || r === Ve ? (d(W.UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER, a(), 0), r === K && (e.next(), m(e, "'")), n) : (m(e, "'"), n);
	}
	function ue(e) {
		let t = e.currentChar();
		switch (t) {
	...
	function F(e, t) {
		...
		switch (e.currentChar()) {
			...
			case "@": return t.braceNest > 0 && d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), n = he(e, t) || p(t), t.braceNest = 0, n;
			default: {
				let r = !0, i = !0, o = !0;
				if (E(e)) return t.braceNest > 0 && d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), n = f(t, 1, me(e)), t.braceNest = 0, t.inLinked = !1, n;
	...
	function he(e, t) {
		...
		switch ((n === 7 || n === 8 || n === 11 || n === 9) && (i === K || i === G) && d(W.INVALID_LINKED_FORMAT, a(), 0), i) {
			...
			default: return E(e) ? (r = f(t, 1, me(e)), t.braceNest = 0, t.inLinked = !1, r) : S(e, t) || w(e, t) ? (g(e), he(e, t)) : C(e, t) ? (g(e), f(t, 11, pe(e))) : T(e, t) ? (g(e), i === "{" ? F(e, t) || r : f(t, 10, P(e))) : (n === 7 && d(W.INVALID_LINKED_FORMAT, a(), 0), t.braceNest = 0, t.inLinked = !1, ge(e, t));
		}
	}
	function ge(e, t) {
		let n = { type: 13 };
		...
		switch (e.currentChar()) {
			...
			default:
				if (E(e)) return n = f(t, 1, me(e)), t.braceNest = 0, t.inLinked = !1, n;
...
function Xe(e = {}) {
	...
	function r(e, r, i, a, ...o) {
		...
		s.offset += a, s.column += a, n && n(Ne(r, t ? U(i, s) : null, {
			domain: Ge,
			args: o
		}));
	}
	...
	function u(e) {
		...
		return t.type === 11 ? (t.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, n.lastStartLoc, 0, Ze(t)), c.value = t.value || "", a(c, e.currentOffset(), e.currentPosition()), { node: c }) : (r(e, W.UNEXPECTED_EMPTY_LINKED_MODIFIER, n.lastStartLoc, 0), c.value = "", a(c, o, s), {
			nextConsumeToken: t,
			node: c
		});
	}
	...
	function f(e) {
		...
		switch (o.type !== 9 && r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Ze(o)), o = e.nextToken(), o.type === 2 && (o = e.nextToken()), o.type) {
			case 10:
				o.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Ze(o)), n.key = d(e, o.value || "");
				break;
			case 4:
				o.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Ze(o)), n.key = c(e, o.value || "");
				break;
			case 5:
				o.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Ze(o)), n.key = s(e, o.value || "");
				break;
			case 6:
				o.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Ze(o)), n.key = l(e, o.value || "");
				break;
			default: {
	...
	function p(e) {
		...
		do {
			...
			switch (u = null, i.type) {
				case 0:
					i.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Ze(i)), n.items.push(o(e, i.value || ""));
					break;
				case 5:
					i.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Ze(i)), n.items.push(s(e, i.value || ""));
					break;
				case 4:
					i.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Ze(i)), n.items.push(c(e, i.value || ""));
					break;
				case 6:
					i.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Ze(i)), n.items.push(l(e, i.value || ""));
					break;
				case 7: {
					let t = f(e);
...
function et(e, t) {
	switch (e.type) {
		...
		case 2:
			...
			break;
		case 6:
			et(e.key, t), t.helper("linked"), t.helper("type");
			break;
		case 5:
...
function tt(e, t = {}) {
	let n = Qe(e);
	n.helper("normalize"), e.body && et(e.body, n);
	let r = n.context();
	e.helpers = Array.from(r.helpers);
}
function nt(e) {
	let t = e.body;
	return t.type === 2 ? rt(t) : t.cases.forEach((e) => rt(e)), e;
}
function rt(e) {
	if (e.items.length === 1) {
		let t = e.items[0];
...
function at(e) {
	switch (e.t = e.type, e.type) {
		...
		case 1: {
			let t = e, n = t.cases;
			for (let e = 0; e < n.length; e++) at(n[e]);
		...
		default: if (process.env.NODE_ENV !== "production") throw Ne(W.UNHANDLED_MINIFIER_NODE_TYPE, null, {
			domain: it,
			args: [e.type]
		});
	}
...
function ct(e, t) {
	let { helper: n } = e;
	e.push(`${n("linked")}(`), ft(e, t.key), t.modifier ? (e.push(", "), ft(e, t.modifier), e.push(", _type")) : e.push(", undefined, _type"), e.push(")");
}
function lt(e, t) {
	let { helper: n, needIndent: r } = e;
	e.push(`${n("normalize")}([`), e.indent(r());
	let i = t.items.length;
	for (let n = 0; n < i && (ft(e, t.items[n]), n !== i - 1); n++) e.push(", ");
	e.deindent(r()), e.push("])");
}
function ut(e, t) {
	let { helper: n, needIndent: r } = e;
	if (t.cases.length > 1) {
		...
		for (let n = 0; n < i && (ft(e, t.cases[n]), n !== i - 1); n++) e.push(", ");
		e.deindent(r()), e.push("])");
	}
}
function dt(e, t) {
...
function ft(e, t) {
	...
	switch (t.type) {
		...
		case 3:
			e.push(JSON.stringify(t.value), t);
			break;
		default: if (process.env.NODE_ENV !== "production") throw Ne(W.UNHANDLED_CODEGEN_NODE_TYPE, null, {
			domain: ot,
			args: [t.type]
		});
	}
...
var pt = (e, t = {}) => {
	...
	c.push(n === "normal" ? "function __msg__ (ctx) {" : "(ctx) => {"), c.indent(o), s.length > 0 && (c.push(`const { ${Te(s.map((e) => `${e}: _${e}`), ", ")} } = ctx`), c.newline()), c.push("return "), ft(c, e), c.deindent(o), c.push("}"), delete e.helpers;
...
function mt(e, t = {}) {
	...
	return r ? (a && nt(o), i && at(o), {
		ast: o,
		code: ""
	}) : (tt(o, n), pt(o, n));
}
function q(e) {
	return V(e) && wt(e) === 0 && (I(e, "b") || I(e, "body"));
}
var ht = ["b", "body"];
function gt(e) {
	return jt(e, ht);
...
function Ft(e, t) {
	let n = gt(t);
	if (n == null) throw Nt(0);
	if (wt(n) === 1) {
		let t = vt(n);
		return e.plural(t.reduce((t, n) => [...t, It(e, n)], []));
	} else return It(e, n);
}
function It(e, t) {
	let n = bt(t);
	...
	{
		let n = St(t).reduce((t, n) => [...t, Lt(e, n)], []);
...
function Lt(e, t) {
	let n = wt(t);
	switch (n) {
		case 3: return Et(t, n);
		case 9: return Et(t, n);
		case 4: {
			let r = t;
		...
		case 6: {
			let n = t, r = Ot(n), i = At(n);
			return e.linked(Lt(e, i), r ? Lt(e, r) : void 0, e.type);
		}
		case 7: return Et(t, n);
		case 8: return Et(t, n);
		default: throw Error(`unhandled node on format message part: ${n}`);
	}
}
var Rt = "Detected HTML in '{source}' message. Recommend not using HTML messages to avoid XSS.";
function zt(e, t) {
	t && Ie(e) && k(ce(Rt, { source: e }));
}
var Bt = (e) => e, Vt = F();
function Ht(e, t = {}) {
...
function Ut(e, t) {
	if (z(e)) {
		...
		process.env.NODE_ENV !== "production" && zt(e, n);
		let r = (t.onCacheKey || Bt)(e), i = Vt[r];
		if (i) return i;
		let { ast: a, detectError: o } = Ht(e, {
			...t,
...
var qt = Jt("function:translate");
function Jt(e) {
	return (t) => Wt && Wt.emit(e, t);
}
var J = {
	INVALID_ARGUMENT: 17,
...
function Yt(e) {
	return Ne(e, null, process.env.NODE_ENV === "production" ? void 0 : { messages: Xt });
}
var Xt = {
...
function Zt(e, t) {
	return t.locale == null ? $t(e.locale) : $t(t.locale);
}
var Qt;
function $t(e) {
	if (z(e)) return e;
	if (R(e)) {
		if (e.resolvedOnce && Qt != null) return Qt;
		if (e.constructor.name === "Function") {
			let t = e();
			if (xe(t)) throw Yt(J.NOT_SUPPORT_LOCALE_PROMISE_VALUE);
			return Qt = t;
		} else throw Yt(J.NOT_SUPPORT_LOCALE_ASYNC_FUNCTION);
	} else throw Yt(J.NOT_SUPPORT_LOCALE_TYPE);
}
function en(e, t, n) {
...
function tn(e, t, n) {
	...
	if (!a) {
		...
		e = z(o) ? [o] : o, L(e) && nn(a, e, !1), i.__localeChainCache.set(r, a);
	}
	return a;
}
function nn(e, t, n) {
...
function dn(e) {
	let t = e.trim();
	return e.charAt(0) === "0" && isNaN(parseInt(e)) ? !1 : cn(t) ? ln(t) : "*" + t;
}
function fn(e) {
	...
	f[0] = () => {
		...
		if (i > 0) i--, r = 4, f[0]();
			...
			if (i = 0, o === void 0 || (o = dn(o), o === !1)) return !1;
			f[1]();
		}
	};
	function p() {
	...
	for (; r !== null;) if (n++, a = e[n], !(a === "\\" && p())) {
		if (c = un(a), d = on[r], l = d[c] || d.l || 8, l === 8 || (r = l[0], l[1] !== void 0 && (u = f[l[1]], u && (s = a, u() === !1)))) return;
		if (r === 7) return t;
	}
}
...
function hn(e, t) {
	if (!V(e)) return null;
	let n = pn.get(t);
	if (n || (n = fn(t), n && pn.set(t, n)), !n) return null;
	let r = n.length, i = e, a = 0;
	for (; a < r;) {
		let e = n[a];
		if (Mt.includes(e) && q(i) || !V(i) || !I(i, e)) return null;
		let t = i[e];
...
var vn = "11.4.0", yn = "en-US", bn = (e) => `${e.charAt(0).toLocaleUpperCase()}${e.substr(1)}`;
function xn() {
	return {
		...
		capitalize: (e, t) => t === "text" && z(e) ? bn(e) : t === "vnode" && V(e) && "__v_isVNode" in e ? bn(e.children) : e
	};
}
var Sn;
function Cn(e) {
...
function Fn(e = {}) {
	let t = R(e.onWarn) ? e.onWarn : k, n = z(e.version) ? e.version : vn, r = z(e.locale) || R(e.locale) ? e.locale : yn, i = R(r) ? yn : r, a = L(e.fallbackLocale) || H(e.fallbackLocale) || z(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : i, o = H(e.messages) ? e.messages : In(i), s = H(e.datetimeFormats) ? e.datetimeFormats : In(i), c = H(e.numberFormats) ? e.numberFormats : In(i), l = P(F(), e.modifiers, xn()), u = e.pluralRules || F(), d = R(e.missing) ? e.missing : null, f = B(e.missingWarn) || fe(e.missingWarn) ? e.missingWarn : !0, p = B(e.fallbackWarn) || fe(e.fallbackWarn) ? e.fallbackWarn : !0, m = !!e.fallbackFormat, h = !!e.unresolving, g = R(e.postTranslation) ? e.postTranslation : null, _ = H(e.processor) ? e.processor : null, v = B(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, y = !!e.escapeParameter, b = R(e.messageCompiler) ? e.messageCompiler : Sn;
	process.env.NODE_ENV !== "production" && R(e.messageCompiler) && ae(_n(Y.EXPERIMENTAL_CUSTOM_MESSAGE_COMPILER));
	let x = R(e.messageResolver) ? e.messageResolver : wn || mn, S = R(e.localeFallbacker) ? e.localeFallbacker : En || en, C = V(e.fallbackContext) ? e.fallbackContext : void 0, w = e, T = V(w.__datetimeFormatters) ? w.__datetimeFormatters : /* @__PURE__ */ new Map(), E = V(w.__numberFormatters) ? w.__numberFormatters : /* @__PURE__ */ new Map(), D = V(w.__meta) ? w.__meta : {};
	Pn++;
	let O = {
		version: n,
		cid: Pn,
	...
	return O.datetimeFormats = s, O.numberFormats = c, O.__datetimeFormatters = T, O.__numberFormatters = E, process.env.NODE_ENV !== "production" && (O.__v_emitter = w.__v_emitter == null ? void 0 : w.__v_emitter), process.env.NODE_ENV !== "production" && Kt(O, n, D), O;
}
var In = (e) => ({ [e]: F() });
function Ln(e, t) {
...
function zn(e, t, n, r, i) {
	...
	if (a !== null) {
		let r = a(e, n, t, i);
		return z(r) ? r : t;
	} else return process.env.NODE_ENV !== "production" && Rn(r, t) && o(_n(Y.NOT_FOUND_KEY, {
		key: t,
		locale: n
	})), t;
}
...
function Hn(e, t) {
	let n = t.indexOf(e);
	if (n === -1) return !1;
	for (let r = n + 1; r < t.length; r++) if (Vn(e, t[r])) return !0;
	return !1;
}
var Un = typeof Intl < "u", Wn = {
	dateTimeFormat: Un && Intl.DateTimeFormat !== void 0,
	numberFormat: Un && Intl.NumberFormat !== void 0
};
function Gn(e, ...t) {
	let { datetimeFormats: n, unresolving: r, fallbackLocale: i, onWarn: a, localeFallbacker: o } = e, { __datetimeFormatters: s } = e;
	if (process.env.NODE_ENV !== "production" && !Wn.dateTimeFormat) return a(_n(Y.CANNOT_FORMAT_DATE)), "";
	if (!z(t[0]) && !de(t[0]) && !N(t[0])) return process.env.NODE_ENV !== "production" && a(_n(Y.INVALID_DATE_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = qn(...t), f = B(u.missingWarn) ? u.missingWarn : e.missingWarn, p = B(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = Zt(e, u), g = o(e, i, h);
	if (!z(c) || c === "") return new Intl.DateTimeFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "datetime format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && Ln(p, c) && a(_n(Y.FALLBACK_TO_DATE_FORMAT, {
			key: c,
			target: v
...
function qn(...e) {
	...
	if (z(t)) {
		...
		if (!e) throw Yt(J.INVALID_ISO_DATE_ARGUMENT);
		let n = e[3] ? e[3].trim().startsWith("T") ? `${e[1].trim()}${e[3].trim()}` : `${e[1].trim()}T${e[3].trim()}` : e[1].trim();
		s = new Date(n);
		try {
			s.toISOString();
		} catch {
			throw Yt(J.INVALID_ISO_DATE_ARGUMENT);
		}
	} else if (de(t)) {
		if (isNaN(t.getTime())) throw Yt(J.INVALID_DATE_ARGUMENT);
		s = t;
	} else if (N(t)) s = t;
	else throw Yt(J.INVALID_ARGUMENT);
	return z(n) ? a.key = n : H(n) && Object.keys(n).forEach((e) => {
		Kn.includes(e) ? o[e] = n[e] : a[e] = n[e];
...
function Yn(e, ...t) {
	...
	if (process.env.NODE_ENV !== "production" && !Wn.numberFormat) return a(_n(Y.CANNOT_FORMAT_NUMBER)), "";
	if (!N(t[0])) return process.env.NODE_ENV !== "production" && a(_n(Y.INVALID_NUMBER_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = Zn(...t), f = B(u.missingWarn) ? u.missingWarn : e.missingWarn, p = B(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = Zt(e, u), g = o(e, i, h);
	if (!z(c) || c === "") return new Intl.NumberFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "number format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && Ln(p, c) && a(_n(Y.FALLBACK_TO_NUMBER_FORMAT, {
			key: c,
			target: v
		})), process.env.NODE_ENV !== "production" && h !== v) {
			let t = e.__v_emitter;
...
function Zn(...e) {
	...
	if (!N(t)) throw Yt(J.INVALID_ARGUMENT);
	let s = t;
	return z(n) ? a.key = n : H(n) && Object.keys(n).forEach((e) => {
		Xn.includes(e) ? o[e] = n[e] : a[e] = n[e];
	}), z(r) ? a.locale = r : H(r) && (o = r), H(i) && (o = i), [
		a.key || "",
		s,
		a,
...
var $n = (e) => e, er = (e) => "", tr = "text", nr = (e) => e.length === 0 ? "" : Te(e), rr = we;
function ir(e, t) {
...
function or(e = {}) {
	let t = e.locale, n = ar(e), r = z(t) && R(e.pluralRules?.[t]) ? e.pluralRules[t] : ir, i = r === ir ? void 0 : ir, a = (e) => e[r(n, e.length, i)], o = e.list || [], s = (e) => o[e], c = e.named || F();
	N(e.pluralIndex) && (c.count ||= e.pluralIndex, c.n ||= e.pluralIndex);
	let l = (e) => c[e];
	function u(t, n) {
		return (R(e.messages) ? e.messages(t, !!n) : V(e.messages) ? e.messages[t] : !1) || (e.parent ? e.parent.message(t) : er);
	}
	let d = (t) => e.modifiers ? e.modifiers[t] : $n, f = R(e.processor?.normalize) ? e.processor.normalize : nr, p = R(e.processor?.interpolate) ? e.processor.interpolate : rr, m = {
		list: s,
		named: l,
		plural: a,
		linked: (e, ...t) => {
		...
		message: u,
		type: z(e.processor?.type) ? e.processor.type : tr,
		interpolate: p,
		normalize: f,
		values: P(F(), o, c)
	};
...
var sr = () => "", X = (e) => R(e);
function cr(e, ...t) {
	let { fallbackFormat: n, postTranslation: r, unresolving: i, messageCompiler: a, fallbackLocale: o, messages: s } = e, [c, l] = pr(...t), u = B(l.missingWarn) ? l.missingWarn : e.missingWarn, d = B(l.fallbackWarn) ? l.fallbackWarn : e.fallbackWarn, f = B(l.escapeParameter) ? l.escapeParameter : e.escapeParameter, p = !!l.resolvedMessage, m = z(l.default) || B(l.default) ? B(l.default) ? a ? c : () => c : l.default : n ? a ? c : () => c : null, h = n || m != null && (z(m) || R(m)), g = Zt(e, l);
	f && lr(l);
	let [_, v, y] = p ? [
		c,
		g,
		s[g] || F()
	] : ur(e, c, g, o, d, u), b = _, x = c;
	...
	let S = !1, C = X(b) ? b : dr(e, c, v, b, x, () => {
		S = !0;
	});
	if (S) return b;
	let w = fr(e, C, or(gr(e, v, y, l))), T = r ? r(w, c) : w;
	if (f && z(T) && (T = ye(T)), process.env.NODE_ENV !== "production") {
		let t = {
			timestamp: Date.now(),
			key: z(c) ? c : X(b) ? b.key : "",
		...
		t.meta = P({}, e.__meta, An() || {}), qt(t);
	}
	return T;
}
function lr(e) {
	L(e.list) ? e.list = e.list.map((e) => z(e) ? _e(e) : e) : V(e.named) && Object.keys(e.named).forEach((t) => {
		z(e.named[t]) && (e.named[t] = _e(e.named[t]));
	});
}
function ur(e, t, n, r, i, a) {
	let { messages: o, onWarn: s, messageResolver: c, localeFallbacker: l } = e, u = l(e, r, n), d = F(), f, p = null, m = n, h = null, g = "translate";
	for (let r = 0; r < u.length; r++) {
		f = h = u[r], process.env.NODE_ENV !== "production" && n !== f && !Vn(n, f) && Ln(i, t) && s(_n(Y.FALLBACK_TO_TRANSLATE, {
			key: t,
			target: f
		}));
		...
		if (process.env.NODE_ENV !== "production" && A && l && (_ = window.performance.now(), v = "intlify-message-resolve-start", y = "intlify-message-resolve-end", j && j(v)), (p = c(d, t)) === null && (p = d[t]), process.env.NODE_ENV !== "production" && A && l) {
			...
			l && _ && p && l.emit("message-resolve", {
				...
				time: e - _,
				groupId: `${g}:${t}`
			}), v && y && j && oe && (j(y), oe("intlify message resolve", v, y));
		}
...
function dr(e, t, n, r, i, a) {
	...
	if (process.env.NODE_ENV !== "production" && A && c) {
		...
		c && l && c.emit("message-compilation", {
			...
			time: e - l,
			groupId: `translate:${t}`
		}), u && d && j && oe && (j(d), oe("intlify message compilation", u, d));
	}
...
function fr(e, t, n) {
	...
	if (process.env.NODE_ENV !== "production" && A && r) {
		...
		}), a && o && j && oe && (j(o), oe("intlify message evaluation", a, o));
	}
	return s;
}
function pr(...e) {
	let [t, n, r] = e, i = F();
	if (!z(t) && !N(t) && !X(t) && !q(t)) throw Yt(J.INVALID_ARGUMENT);
	let a = N(t) ? String(t) : (X(t), t);
	return N(n) ? i.plural = n : z(n) ? i.default = n : H(n) && !pe(n) ? i.named = n : L(n) && (i.list = n), N(r) ? i.plural = r : z(r) ? i.default = r : H(r) && P(i, r), [a, i];
}
	...
	return {
		...
		onError: (t) => {
			if (a && a(t), process.env.NODE_ENV !== "production") {
				let i = hr(r), a = t.location && i && De(i, t.location.start.offset, t.location.end.offset), o = e.__v_emitter;
...
function gr(e, t, n, r) {
	let { modifiers: i, pluralRules: a, messageResolver: o, fallbackLocale: s, fallbackWarn: c, missingWarn: l, fallbackContext: u } = e, d = {
		...
		messages: (r, i) => {
			let a = o(n, r);
			if (a == null && (u || i)) {
				let [n, , i] = ur(u || e, r, t, s, c, l);
				a = n ?? o(i, r);
			}
			if (z(a) || q(a)) {
				let n = !1, i = dr(e, r, t, a, r, () => {
					n = !0;
				});
				return n ? sr : i;
...
var yr = typeof Proxy == "function", br = "devtools-plugin:setup", xr = "plugin:settings:set", Sr, Cr;
function wr() {
	return Sr === void 0 && (typeof window < "u" && window.performance ? (Sr = !0, Cr = window.performance) : typeof globalThis < "u" && globalThis.perf_hooks?.performance ? (Sr = !0, Cr = globalThis.perf_hooks.performance) : Sr = !1), Sr;
}
function Tr() {
	return wr() ? Cr.now() : Date.now();
}
var Er = class {
	constructor(e, t) {
...
function Dr(e, t) {
	let n = e, r = vr(), i = _r(), a = yr && n.enableEarlyProxy;
	if (i && (r.__VUE_DEVTOOLS_PLUGIN_API_AVAILABLE__ || !a)) i.emit(br, e, t);
	else {
		let e = a ? new Er(n, i) : null;
...
}, Ar = M("__translateVNode"), jr = M("__datetimeParts"), Mr = M("__numberParts"), Nr = M("__enableEmitter"), Pr = M("__disableEmitter"), Fr = M("__setPluralRules");
M("__intlifyMeta");
var Ir = M("__injectWithOption"), Lr = M("__dispose"), $ = {
	FALLBACK_TO_ROOT: 10,
...
function Br(e) {
	if (!V(e) || q(e)) return e;
	for (let t in e) if (I(e, t)) if (!t.includes(".")) V(e[t]) && Br(e[t]);
	else {
		let n = t.split("."), r = n.length - 1, i = e, a = !1;
		for (let e = 0; e < r; e++) {
			if (n[e] === "__proto__") throw Error(`unsafe key: ${n[e]}`);
			if (n[e] in i || (i[n[e]] = F()), !V(i[n[e]])) {
				process.env.NODE_ENV !== "production" && k(zr($.IGNORE_OBJ_FLATTEN, { key: n[e] })), a = !0;
				break;
			}
			i = i[n[e]];
		}
		if (a || (q(i) ? Mt.includes(n[r]) || delete e[t] : (i[n[r]] = e[t], delete e[t])), !q(i)) {
			let e = i[n[r]];
			V(e) && Br(e);
		}
	}
...
function Vr(e, t) {
	...
	if (L(r) && r.forEach((e) => {
		if ("locale" in e && "resource" in e) {
			...
			t ? (o[t] = o[t] || F(), Ae(n, o[t])) : Ae(n, o);
		} else z(e) && Ae(JSON.parse(e), o);
	}), i == null && a) for (let e in o) I(o, e) && Br(o[e]);
	return o;
}
function Hr(e) {
	return e.type;
...
var Kr = "__INTLIFY_META__", qr = () => [], Jr = () => !1, Yr = 0;
function Xr(e) {
	return ((t, n, r, i) => e(n, r, Gr() || void 0, i));
}
var Zr = () => {
	let e = Gr(), t = null;
	return e && (t = Hr(e)[Kr]) ? { [Kr]: t } : null;
};
function Qr(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = A ? y : x, s = B(e.inheritLocale) ? e.inheritLocale : !0, c = o(t && s ? t.locale.value : z(e.locale) ? e.locale : yn), l = o(t && s ? t.fallbackLocale.value : z(e.fallbackLocale) || L(e.fallbackLocale) || H(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(Vr(c.value, e)), d = o(H(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(H(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : B(e.missingWarn) || fe(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : B(e.fallbackWarn) || fe(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : B(e.fallbackRoot) ? e.fallbackRoot : !0, g = !!e.fallbackFormat, _ = R(e.missing) ? e.missing : null, v = R(e.missing) ? Xr(e.missing) : null, b = R(e.postTranslation) ? e.postTranslation : null, S = t ? t.warnHtmlMessage : B(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, w = !!e.escapeParameter, T = t ? t.modifiers : H(e.modifiers) ? e.modifiers : {}, E = e.pluralRules || t && t.pluralRules, D;
	D = (() => {
		i && Mn(null);
		let t = {
			version: Or,
	...
	let ee = r({
		...
		get: () => l.value,
		set: (e) => {
			D.fallbackLocale = e, l.value = e, Bn(D, c.value, e);
		}
	...
	function j(e) {
		b = e, D.postTranslation = e;
	}
	function oe() {
		return _;
	}
	function se(e) {
		e !== null && (v = Xr(e)), _ = e, D.missing = v;
	}
	function ce(e, t) {
	...
	let M = (e, n, r, a, o, s) => {
		...
		let c;
		try {
			process.env.NODE_ENV !== "production" && kn(Zr()), i || (D.fallbackContext = t ? Nn() : void 0), c = e(D);
		} finally {
			process.env.NODE_ENV !== "production" && kn(null), i || (D.fallbackContext = void 0);
		}
		if (r !== "translate exists" && N(c) && c === -1 || r === "translate exists" && !c) {
			let [e, i] = n();
			if (process.env.NODE_ENV !== "production" && t && z(e) && ce(r, i) && (h && (Ln(m, e) || Rn(p, e)) && k(zr($.FALLBACK_TO_ROOT, {
				key: e,
				type: r
	...
	function le(...e) {
		return M((t) => Reflect.apply(cr, null, [t, ...e]), () => pr(...e), "translate", (t) => Reflect.apply(t.t, t, [...e]), (e) => e, (e) => z(e));
	}
	function ue(...e) {
		let [t, n, r] = e;
	...
	function de(...e) {
		return M((t) => Reflect.apply(Gn, null, [t, ...e]), () => qn(...e), "datetime format", (t) => Reflect.apply(t.d, t, [...e]), () => "", (e) => z(e) || L(e));
	}
	function pe(...e) {
		return M((t) => Reflect.apply(Yn, null, [t, ...e]), () => Zn(...e), "number format", (t) => Reflect.apply(t.n, t, [...e]), () => "", (e) => z(e) || L(e));
	}
	function me(e) {
		return e.map((e) => z(e) || N(e) || B(e) ? Wr(String(e)) : e);
	}
	let F = {
		normalize: me,
		interpolate: (e) => e,
	...
	function he(...e) {
		return M((t) => {
			let n, r = t;
			try {
				r.processor = F, n = Reflect.apply(cr, null, [r, ...e]);
			} finally {
				r.processor = null;
			}
			return n;
		}, () => pr(...e), "translate", (t) => t[Ar](...e), (e) => [Wr(e)], (e) => L(e));
	}
	function ge(...e) {
		return M((t) => Reflect.apply(Yn, null, [t, ...e]), () => Zn(...e), "number format", (t) => t[Mr](...e), qr, (e) => z(e) || L(e));
	}
	function _e(...e) {
		return M((t) => Reflect.apply(Gn, null, [t, ...e]), () => qn(...e), "datetime format", (t) => t[jr](...e), qr, (e) => z(e) || L(e));
	}
	function ve(e) {
		E = e, D.pluralRules = E;
	}
	function ye(e, t) {
		return M(() => {
			if (!e) return !1;
			let n = z(t) ? t : c.value, r = z(t) ? [n] : tn(D, l.value, n);
			for (let t = 0; t < r.length; t++) {
				let n = Se(r[t]), i = D.messageResolver(n, e);
				if (i === null && (i = n[e]), q(i) || X(i) || z(i)) return !0;
			}
			return !1;
		}, () => [e], "translate exists", (n) => Reflect.apply(n.te, n, [e, t]), Jr, (e) => B(e));
	}
	function be(e) {
		let t = null, n = tn(D, l.value, c.value);
	...
	function we(e, t) {
		u.value[e] = u.value[e] || {};
		let n = { [e]: t };
		if (a) for (let e in n) I(n, e) && Br(n[e]);
		t = n[e], Ae(t, u.value[e]), D.messages = u.value;
	}
	function Te(e) {
		return d.value[e] || {};
	}
	function Ee(e, t) {
		d.value[e] = t, D.datetimeFormats = d.value, Jn(D, e, t);
	}
	function De(e, t) {
		d.value[e] = P(d.value[e] || {}, t), D.datetimeFormats = d.value, Jn(D, e, t);
	}
	function Oe(e) {
		return f.value[e] || {};
	}
	function ke(e, t) {
		f.value[e] = t, D.numberFormats = f.value, Qn(D, e, t);
	}
	function je(e, t) {
		f.value[e] = P(f.value[e] || {}, t), D.numberFormats = f.value, Qn(D, e, t);
	}
	Yr++, t && A && (C(t.locale, (e) => {
		s && (c.value = e, D.locale = e, Bn(D, c.value, l.value));
	}), C(t.fallbackLocale, (e) => {
		s && (l.value = e, D.fallbackLocale = e, Bn(D, c.value, l.value));
	}));
	let U = {
		id: Yr,
		locale: ee,
		...
		set inheritLocale(e) {
			s = e, e && t && (c.value = t.locale.value, l.value = t.fallbackLocale.value, Bn(D, c.value, l.value));
		},
	...
	return U.datetimeFormats = re, U.numberFormats = ie, U.rt = ue, U.te = ye, U.tm = xe, U.d = de, U.n = pe, U.getDateTimeFormat = Te, U.setDateTimeFormat = Ee, U.mergeDateTimeFormat = De, U.getNumberFormat = Oe, U.setNumberFormat = ke, U.mergeNumberFormat = je, U[Ir] = n, U[Ar] = he, U[jr] = _e, U[Mr] = ge, process.env.NODE_ENV !== "production" && (U[Nr] = (e) => {
		D.__v_emitter = e;
	}, U[Pr] = () => {
		D.__v_emitter = void 0;
	}), U;
}
var $r = "vue-i18n: composer properties", ei = {
	"vue-devtools-plugin-vue-i18n": "Vue I18n DevTools",
	"vue-i18n-resource-inspector": "Vue I18n DevTools",
	"vue-i18n-timeline": "Vue I18n"
}, ti = { "vue-i18n-resource-inspector": "Search for scopes ..." }, ni = { "vue-i18n-timeline": 16764185 }, ri;
async function ii(e, t) {
	return new Promise((n, r) => {
		try {
			Dr({
				id: "vue-devtools-plugin-vue-i18n",
				label: ei["vue-devtools-plugin-vue-i18n"],
				...
				ri = r, r.on.visitComponentTree(({ componentInstance: e, treeNode: n }) => {
					oi(e, n, t);
				}), r.on.inspectComponent(({ componentInstance: e, instanceData: n }) => {
					e.__VUE_I18N__ && n && (t.mode === "legacy" ? e.__VUE_I18N__ !== t.global.__composer && si(n, e.__VUE_I18N__) : si(n, e.__VUE_I18N__));
				}), r.addInspector({
					id: "vue-i18n-resource-inspector",
					label: ei["vue-i18n-resource-inspector"],
					icon: "language",
					treeFilterPlaceholder: ti["vue-i18n-resource-inspector"]
				}), r.on.getInspectorTree((n) => {
					n.app === e && n.inspectorId === "vue-i18n-resource-inspector" && pi(n, t);
				});
				let i = /* @__PURE__ */ new Map();
				r.on.getInspectorState(async (n) => {
					if (n.app === e && n.inspectorId === "vue-i18n-resource-inspector") if (r.unhighlightElement(), gi(n, t), n.nodeId === "global") {
						if (!i.has(n.app)) {
					...
					n.app === e && n.inspectorId === "vue-i18n-resource-inspector" && yi(n, t);
				}), r.addTimelineLayer({
					id: "vue-i18n-timeline",
					label: ei["vue-i18n-timeline"],
					color: ni["vue-i18n-timeline"]
				}), n(!0);
			});
		} catch (e) {
			console.error(e), r(!1);
...
function ci(e) {
	...
	return Object.keys(e).forEach((n) => {
		let r = e[n];
		R(r) && "source" in r ? t[n] = fi(r) : q(r) && r.loc && r.loc.source ? t[n] = r.loc.source : V(r) ? t[n] = ci(r) : t[n] = r;
	}), t;
}
var li = {
	"<": "&lt;",
...
function fi(e) {
	return { _custom: {
		type: "function",
		display: `<span>ƒ</span> ${e.source ? `("${ui(e.source)}")` : "(?)"}`
	} };
}
function pi(e, t) {
	e.rootNodes.push({
...
function vi(e, t) {
	if (ri) {
		let n;
		t && "groupId" in t && (n = t.groupId, delete t.groupId), ri.addTimelineEvent({
...
var Ci = s({
	...
	setup(e, t) {
		let { slots: n, attrs: r } = t, i = e.i18n || Pi({
			useScope: e.scope,
			__useComponent: !0
		});
		return () => {
			...
			let s = xi(t, a), c = i[Ar](e.keypath, s, o), l = P(F(), r);
			return d(z(e.tag) || V(e.tag) ? e.tag : Si(), l, c);
		};
	}
});
function wi(e) {
...
function Ti(e, t, n, r) {
	...
	return () => {
		...
		L(s) ? c = s.map((e, t) => {
			...
			return wi(r) && (r[0].key = `${e.type}-${t}`), r;
		}) : z(s) && (c = [s]);
		let l = P(F(), a);
		return d(z(e.tag) || V(e.tag) ? e.tag : Si(), l, c);
	};
...
function Oi(e) {
	let t = (t) => {
		process.env.NODE_ENV !== "production" && ae(zr($.DEPRECATE_TRANSLATE_CUSTOME_DIRECTIVE));
		let { instance: n, value: r } = t;
		if (!n || !n.$) throw Q(Z.UNEXPECTED_ERROR);
		let i = Di(e, n.$), a = ki(r);
		return [Reflect.apply(i.t, i, [...Ai(a)]), i];
	};
	return {
		created: (e, n) => {
			let [r, i] = t(n);
			A && (e.__i18nWatcher = C(i.locale, () => {
		...
		beforeUpdate: (e, { value: t }) => {
			if (e.__composer) {
				let n = e.__composer, r = ki(t);
				e.textContent = Reflect.apply(n.t, n, [...Ai(r)]);
			}
		},
		getSSRProps: (e) => {
			let [n] = t(e);
...
function ji(e, t, ...n) {
	let r = H(n[0]) ? n[0] : {};
	(!B(r.globalInstall) || r.globalInstall) && ([Ci.name, "I18nT"].forEach((t) => e.component(t, Ci)), [Ei.name, "I18nN"].forEach((t) => e.component(t, Ei)), [Gi.name, "I18nD"].forEach((t) => e.component(t, Gi))), e.directive("t", Oi(t));
}
var Mi = M("global-vue-i18n");
function Ni(e = {}) {
	process.env.NODE_ENV;
	let t = B(e.globalInjection) ? e.globalInjection : !0, n = /* @__PURE__ */ new Map(), [r, i] = Fi(e, !1), a = M(process.env.NODE_ENV === "production" ? "" : "vue-i18n");
	function o(e) {
		return n.get(e) || null;
	}
	function s(e, t) {
	...
	let l = {
		...
		async install(e, ...n) {
			...
			let r = null;
			t && (r = Wi(e, l.global)), ji(e, l, ...n);
			let o = e.unmount;
			if (e.unmount = () => {
				r && r(), l.dispose(), o();
			}, process.env.NODE_ENV !== "production") {
				if (!await ii(e, l)) throw Q(Z.CANNOT_SETUP_VUE_DEVTOOLS_PLUGIN);
				let t = Oe();
				{
					let e = i;
					e[Nr] && e[Nr](t);
...
function Pi(e = {}) {
	...
	let n = Ii(t), r = Ri(n), i = Hr(t), a = Li(e, i);
	if (a === "global") return Ur(r, e, i), r;
	if (a === "parent") {
		let i = zi(n, t, e.__useComponent);
		return i ??= (process.env.NODE_ENV !== "production" && k(zr($.NOT_FOUND_PARENT_SCOPE)), r), i;
	}
	if (a === "isolated") {
		...
		a.__root = zi(n, t) || r;
		let o = Qr(a);
		i.__composerExtend && (o[Lr] = i.__composerExtend(o));
		let s = null;
		if (process.env.NODE_ENV !== "production") {
			s = Oe();
			let e = o;
	...
	if (s == null) {
		let n = P({}, e);
		"__i18n" in i && (n.__i18n = i.__i18n), r && (n.__root = r), s = Qr(n), o.__composerExtend && (s[Lr] = o.__composerExtend(s)), Vi(o, t, s), o.__setInstance(t, s);
	} else process.env.NODE_ENV !== "production" && a === "local" && k(zr($.DUPLICATE_USE_I18N_CALLING));
	return s;
}
function Fi(e, t) {
	let n = c(), r = n.run(() => Qr(e));
	if (r == null) throw Q(Z.UNEXPECTED_ERROR);
	return [n, r];
}
function Ii(e) {
	let t = f(e.isCE ? Mi : e.appContext.app.__VUE_I18N_SYMBOL__);
	if (!t) throw Q(e.isCE ? Z.NOT_INSTALLED_WITH_PROVIDE : Z.UNEXPECTED_ERROR);
	return t;
}
function Li(e, t) {
	return pe(e) ? "__i18n" in t ? "local" : "global" : e.useScope ? e.useScope : "local";
}
function Ri(e) {
	return e.mode === "composition" ? e.global : e.global.__composer;
}
function zi(e, t, n = !1) {
	let r = null, i = t.root, a = Bi(t, n);
	for (; a != null;) {
		let t = e;
...
function Vi(e, t, n) {
	...
	h(() => {
		if (process.env.NODE_ENV !== "production") {
			t.__VUE_I18N__ = n, r = Oe();
			let e = n;
			e[Nr] && e[Nr](r), r.on("*", vi);
		}
	}, t), _(() => {
		let i = n;
		process.env.NODE_ENV !== "production" && (r && r.off("*", vi), i[Pr] && i[Pr](), delete t.__VUE_I18N__), e.__deleteInstance(t);
		let a = i[Lr];
		a && (a(), delete i[Lr]);
	}, t);
}
...
var Gi = s({
	...
	setup(e, t) {
		...
		return Ti(e, t, Kn, (...e) => n[jr](...e));
	}
});
if (Cn(Ut), Tn(hn), Dn(tn), process.env.NODE_ENV !== "production") {
	let e = ge();
...
var qi = s({
	...
	return n;
}, Yi = { class: "mb-16" }, Xi = { class: "mb-6 text-2xl font-bold text-foreground" }, Zi = { class: "grid gap-6 md:grid-cols-3" }, Qi = { class: "rounded-lg border border-border bg-card p-6" }, $i = { class: "mb-2 text-lg font-semibold text-foreground" }, ea = { class: "text-sm text-muted-foreground" }, ta = { class: "rounded-lg border border-border bg-card p-6" }, na = { class: "mb-2 text-lg font-semibold text-foreground" }, ra = { class: "text-sm text-muted-foreground" }, ia = { class: "rounded-lg border border-border bg-card p-6" }, aa = { class: "mb-2 text-lg font-semibold text-foreground" }, oa = { class: "text-sm text-muted-foreground" };
function sa(e, t, n, r, o, s) {
	return v(), i("section", Yi, [a("h2", Xi, S(r.t("home.whyItMatters.title")), 1), a("div", Zi, [
		a("div", Qi, [a("h3", $i, S(r.t("home.whyItMatters.bundleSizeTitle")), 1), a("p", ea, S(r.t("home.whyItMatters.bundleSizeDesc")), 1)]),
		a("div", ta, [a("h3", na, S(r.t("home.whyItMatters.renderingTitle")), 1), a("p", ra, S(r.t("home.whyItMatters.renderingDesc")), 1)]),
		a("div", ia, [a("h3", aa, S(r.t("home.whyItMatters.dynamicLoadingTitle")), 1), a("p", oa, S(r.t("home.whyItMatters.dynamicLoadingDesc")), 1)])
	])]);
}
var ca = Ji(qi, [["render", sa], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/home/WhyItMatters.vue"]]), la = Ni({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
	...
	setup(e, { expose: t }) {
		...
		n && !n.config.globalProperties.$i18n && n.use(la);
		let r = { app: n };
		return Object.defineProperty(r, "__isScriptSetup", {
			enumerable: !1,
			value: !0
...
var fa = Ji(ua, [["render", da], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/scripts/Wrapper.vue"]]), pa = { render() {
	return d(fa, {}, { default: () => d(ca) });
} };
