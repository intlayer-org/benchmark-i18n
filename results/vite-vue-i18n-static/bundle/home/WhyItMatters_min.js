...
var Kr = { class: "mb-16" }, qr = { class: "mb-6 text-2xl font-bold text-foreground" }, Jr = { class: "grid gap-6 md:grid-cols-3" }, Yr = { class: "rounded-lg border border-border bg-card p-6" }, Xr = { class: "mb-2 text-lg font-semibold text-foreground" }, Zr = { class: "text-sm text-muted-foreground" }, Qr = { class: "rounded-lg border border-border bg-card p-6" }, $r = { class: "mb-2 text-lg font-semibold text-foreground" }, ei = { class: "text-sm text-muted-foreground" }, ti = { class: "rounded-lg border border-border bg-card p-6" }, ni = { class: "mb-2 text-lg font-semibold text-foreground" }, ri = { class: "text-sm text-muted-foreground" }, ii = s({
	__name: "WhyItMatters",
	setup(e) {
		Gr("WhyItMatters");
		let { t } = Rr();
		return (e, n) => (h(), i("section", Kr, [a("h2", qr, v(y(t)("home.whyItMatters.title")), 1), a("div", Jr, [
			a("div", Yr, [a("h3", Xr, v(y(t)("home.whyItMatters.bundleSizeTitle")), 1), a("p", Zr, v(y(t)("home.whyItMatters.bundleSizeDesc")), 1)]),
			a("div", Qr, [a("h3", $r, v(y(t)("home.whyItMatters.renderingTitle")), 1), a("p", ei, v(y(t)("home.whyItMatters.renderingDesc")), 1)]),
			a("div", ti, [a("h3", ni, v(y(t)("home.whyItMatters.dynamicLoadingTitle")), 1), a("p", ri, v(y(t)("home.whyItMatters.dynamicLoadingDesc")), 1)])
		])]));
	}
});
