...
var qi = s({
	...
	return n;
}, Yi = { class: "grid gap-8 md:grid-cols-2" }, Xi = { class: "rounded-lg border border-border bg-card p-6" }, Zi = { class: "mb-3 text-xl font-semibold text-foreground" }, Qi = { class: "text-sm text-muted-foreground" }, $i = { class: "rounded-lg border border-border bg-card p-6" }, ea = { class: "mb-3 text-xl font-semibold text-foreground" }, ta = { class: "text-sm text-muted-foreground" };
function na(e, t, n, r, o, s) {
	return v(), i("div", Yi, [a("div", Xi, [a("h2", Zi, S(r.t("about.grid.whyExistsTitle")), 1), a("p", Qi, S(r.t("about.grid.whyExistsDesc")), 1)]), a("div", $i, [a("h2", ea, S(r.t("about.grid.methodologyTitle")), 1), a("p", ta, S(r.t("about.grid.methodologyDesc")), 1)])]);
}
var ra = Ji(qi, [["render", na], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/about/AboutGrid.vue"]]), ia = Ni({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
	...
	setup(e, { expose: t }) {
		...
		n && !n.config.globalProperties.$i18n && n.use(ia);
		let r = { app: n };
		return Object.defineProperty(r, "__isScriptSetup", {
			enumerable: !1,
			value: !0
...
var sa = Ji(aa, [["render", oa], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/scripts/Wrapper.vue"]]), ca = { render() {
	return d(sa, {}, { default: () => d(ra) });
} };
