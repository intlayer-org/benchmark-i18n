...
var zi = { class: "mb-4 text-3xl font-bold text-foreground" }, Bi = { class: "mb-8 max-w-3xl text-muted-foreground" }, Vi = s({
	__name: "AboutHeader",
	setup(e) {
		Ri("AboutHeader");
		let { t: n } = Ei();
		return (e, r) => (v(), i(t, null, [a("h1", zi, S(C(n)("about.header.title")), 1), a("p", Bi, S(C(n)("about.header.description")), 1)], 64));
	}
}), Hi = Ti({
	legacy: !1,
	locale: "en",
