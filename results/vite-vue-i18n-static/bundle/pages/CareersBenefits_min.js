...
var Gr = { class: "mb-12 grid gap-4 md:grid-cols-3" }, Kr = { class: "text-sm font-semibold text-foreground" }, qr = { class: "text-xs text-muted-foreground" }, Jr = s({
	...
	setup(e) {
		...
		return (e, o) => (m(), i("div", Gr, [(m(), i(t, null, g(r, (e) => a("div", {
			key: e.labelKey,
			class: "rounded-lg border border-border bg-card p-4 text-center"
		}, [a("p", Kr, v(y(n)(e.labelKey)), 1), a("p", qr, v(y(n)(e.valueKey)), 1)])), 64))]));
	}
});
