...
var Ki = s({
	...
	return n;
}, Ji = { class: "mb-12 grid gap-4 md:grid-cols-3" }, Yi = { class: "text-sm font-semibold text-foreground" }, Xi = { class: "text-xs text-muted-foreground" };
function Zi(e, n, r, o, s, c) {
	return _(), i("div", Ji, [(_(), i(t, null, y(o.benefits, (e) => a("div", {
		key: e.labelKey,
		class: "rounded-lg border border-border bg-card p-4 text-center"
	}, [a("p", Yi, S(o.t(e.labelKey)), 1), a("p", Xi, S(o.t(e.valueKey)), 1)])), 64))]);
}
var Qi = qi(Ki, [["render", Zi], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/careers/CareersBenefits.vue"]]), $i = Ni({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
	...
	setup(e, { expose: t }) {
		...
		n && !n.config.globalProperties.$i18n && n.use($i);
		let r = { app: n };
		return Object.defineProperty(r, "__isScriptSetup", {
			enumerable: !1,
			value: !0
...
var na = qi(ea, [["render", ta], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/scripts/Wrapper.vue"]]), ra = { render() {
	return d(na, {}, { default: () => d(Qi) });
} };
