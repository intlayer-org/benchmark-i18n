...
}), zi = { class: "mb-2 text-3xl font-bold text-foreground" }, Bi = { class: "mb-4 text-muted-foreground" }, Vi = s({
	__name: "CareersHeader",
	setup(e) {
		let { t: n } = Ti();
		return (e, r) => (_(), i(t, null, [
			o(Ri),
			a("h1", zi, x(S(n)("careers.header.title")), 1),
			a("p", Bi, x(S(n)("careers.header.description")), 1)
		], 64));
	}
}), Hi = wi({
	legacy: !1,
