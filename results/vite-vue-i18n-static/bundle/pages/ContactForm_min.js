...
function Ar(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = T ? h : _, s = z(e.inheritLocale) ? e.inheritLocale : !0, c = o(t && s ? t.locale.value : R(e.locale) ? e.locale : sn), l = o(t && s ? t.fallbackLocale.value : R(e.fallbackLocale) || I(e.fallbackLocale) || V(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(yr(c.value, e)), d = o(V(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(V(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : z(e.missingWarn) || re(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : z(e.fallbackWarn) || re(e.fallbackWarn) ? e.fallbackWarn : !0, g = t ? t.fallbackRoot : z(e.fallbackRoot) ? e.fallbackRoot : !0, v = !!e.fallbackFormat, y = L(e.missing) ? e.missing : null, x = L(e.missing) ? Or(e.missing) : null, C = L(e.postTranslation) ? e.postTranslation : null, w = t ? t.warnHtmlMessage : z(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, E = !!e.escapeParameter, D = t ? t.modifiers : V(e.modifiers) ? e.modifiers : {}, O = e.pluralRules || t && t.pluralRules, k;
	k = (() => {
		i && bn(null);
		let t = {
			version: ar,
	...
	let P = (e, n, r, a, o, s) => {
		...
		if (r !== "translate exists" && j(c) && c === -1 || r === "translate exists" && !c) {
			let [e, i] = n();
			if (process.env.NODE_ENV !== "production" && t && R(e) && le(r, i) && (g && (Tn(m, e) || En(p, e)) && S(_r($.FALLBACK_TO_ROOT, {
				key: e,
				type: r
...
var Kr = { class: "grid gap-4 md:grid-cols-2" }, qr = {
	for: "name",
	...
	setup(e) {
		...
		return (e, o) => (m(), i("form", {
			class: "space-y-6",
			onSubmit: o[0] ||= x(() => {}, ["prevent"])
		}, [
			a("div", Kr, [a("div", null, [a("label", qr, v(y(n)("contact.form.name")), 1), a("input", {
				id: "name",
				...
				placeholder: y(n)("contact.form.yourName")
			}, null, 8, Jr)]), a("div", null, [a("label", Yr, v(y(n)("contact.form.email")), 1), a("input", {
				id: "email",
				type: "email",
				class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: y(n)("contact.form.emailPlaceholder")
			}, null, 8, Xr)])]),
			a("div", null, [a("label", Zr, v(y(n)("contact.form.topic")), 1), a("select", Qr, [(m(), i(t, null, g(r, (e) => a("option", {
				key: e,
				value: e
			}, v(y(n)(`contact.form.${e}`)), 9, $r)), 64))])]),
			a("div", null, [a("label", ei, v(y(n)("contact.form.message")), 1), a("textarea", {
				id: "message",
				rows: "5",
				class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: y(n)("contact.form.messagePlaceholder")
			}, null, 8, ti)]),
			a("button", ni, v(y(n)("contact.form.sendMessage")), 1)
		], 32));
	}
});
