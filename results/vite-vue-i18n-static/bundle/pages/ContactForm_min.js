...
import { Fragment as t, Text as n, computed as r, createElementBlock as i, createElementVNode as a, createVNode as o, defineComponent as s, effectScope as c, getCurrentInstance as l, getCurrentScope as u, h as d, inject as f, isRef as p, onMounted as m, onScopeDispose as h, onUnmounted as g, openBlock as _, ref as v, renderList as y, renderSlot as b, shallowRef as x, toDisplayString as S, watch as C, withModifiers as w } from "vue";
...
function $r(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = k ? v : x, s = B(e.inheritLocale) ? e.inheritLocale : !0, c = o(t && s ? t.locale.value : z(e.locale) ? e.locale : bn), l = o(t && s ? t.fallbackLocale.value : z(e.fallbackLocale) || L(e.fallbackLocale) || H(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(Hr(c.value, e)), d = o(H(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(H(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : B(e.missingWarn) || pe(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : B(e.fallbackWarn) || pe(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : B(e.fallbackRoot) ? e.fallbackRoot : !0, g = !!e.fallbackFormat, _ = R(e.missing) ? e.missing : null, y = R(e.missing) ? Zr(e.missing) : null, b = R(e.postTranslation) ? e.postTranslation : null, S = t ? t.warnHtmlMessage : B(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, w = !!e.escapeParameter, T = t ? t.modifiers : H(e.modifiers) ? e.modifiers : {}, ee = e.pluralRules || t && t.pluralRules, E;
	E = (() => {
		i && Nn(null);
		let t = {
			version: kr,
...
var qi = s({
	...
	return n;
}, Yi = { class: "grid gap-4 md:grid-cols-2" }, Xi = {
	for: "name",
...
function oa(e, n, r, o, s, c) {
	return _(), i("form", {
		class: "space-y-6",
		onSubmit: n[0] ||= w(() => {}, ["prevent"])
	}, [
		a("div", Yi, [a("div", null, [a("label", Xi, S(o.t("contact.form.name")), 1), a("input", {
			id: "name",
			...
			placeholder: o.t("contact.form.yourName")
		}, null, 8, Zi)]), a("div", null, [a("label", Qi, S(o.t("contact.form.email")), 1), a("input", {
			id: "email",
			type: "email",
			class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			placeholder: o.t("contact.form.emailPlaceholder")
		}, null, 8, $i)])]),
		a("div", null, [a("label", ea, S(o.t("contact.form.topic")), 1), a("select", ta, [(_(), i(t, null, y(o.topics, (e) => a("option", {
			key: e,
			value: e
		}, S(o.t(`contact.form.${e}`)), 9, na)), 64))])]),
		a("div", null, [a("label", ra, S(o.t("contact.form.message")), 1), a("textarea", {
			id: "message",
			rows: "5",
			class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
			placeholder: o.t("contact.form.messagePlaceholder")
		}, null, 8, ia)]),
		a("button", aa, S(o.t("contact.form.sendMessage")), 1)
	], 32);
}
var sa = Ji(qi, [["render", oa], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/contact/ContactForm.vue"]]), ca = Pi({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
	...
	setup(e, { expose: t }) {
		...
		n && !n.config.globalProperties.$i18n && n.use(ca);
		let r = { app: n };
		return Object.defineProperty(r, "__isScriptSetup", {
			enumerable: !1,
			value: !0
...
var da = Ji(la, [["render", ua], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/scripts/Wrapper.vue"]]), fa = { render() {
	return d(da, {}, { default: () => d(sa) });
} };
