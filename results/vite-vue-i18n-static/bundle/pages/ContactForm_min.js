...
import { Fragment as t, Text as n, computed as r, createElementBlock as i, createElementVNode as a, createVNode as o, defineComponent as s, effectScope as c, getCurrentInstance as l, getCurrentScope as u, h as d, inject as f, isRef as p, onMounted as m, onScopeDispose as h, onUnmounted as g, openBlock as _, ref as v, renderList as y, renderSlot as b, shallowRef as x, toDisplayString as S, unref as C, watch as w, withModifiers as T } from "vue";
function E(e, t) {
...
function Gr(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = k ? v : x, s = !B(e.inheritLocale) || e.inheritLocale, c = o(t && s ? t.locale.value : z(e.locale) ? e.locale : fn), l = o(t && s ? t.fallbackLocale.value : z(e.fallbackLocale) || L(e.fallbackLocale) || H(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(Pr(c.value, e)), d = o(H(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(H(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : B(e.missingWarn) || oe(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : B(e.fallbackWarn) || oe(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : !B(e.fallbackRoot) || e.fallbackRoot, g = !!e.fallbackFormat, _ = R(e.missing) ? e.missing : null, y = R(e.missing) ? Ur(e.missing) : null, b = R(e.postTranslation) ? e.postTranslation : null, S = t ? t.warnHtmlMessage : !B(e.warnHtmlMessage) || e.warnHtmlMessage, C = !!e.escapeParameter, T = t ? t.modifiers : H(e.modifiers) ? e.modifiers : {}, D = e.pluralRules || t && t.pluralRules, O;
	O = (() => {
		i && Tn(null);
		let t = {
			version: xr,
...
process.env.NODE_ENV;
var zi = { class: "grid gap-4 md:grid-cols-2" }, Bi = {
	for: "name",
	...
	setup(e) {
		...
		return (e, o) => (_(), i("form", {
			class: "space-y-6",
			onSubmit: o[0] ||= T(() => {}, ["prevent"])
		}, [
			a("div", zi, [a("div", null, [a("label", Bi, S(C(n)("contact.form.name")), 1), a("input", {
				id: "name",
				...
				placeholder: C(n)("contact.form.yourName")
			}, null, 8, Vi)]), a("div", null, [a("label", Hi, S(C(n)("contact.form.email")), 1), a("input", {
				id: "email",
				type: "email",
				class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: C(n)("contact.form.emailPlaceholder")
			}, null, 8, Ui)])]),
			a("div", null, [a("label", Wi, S(C(n)("contact.form.topic")), 1), a("select", Gi, [(_(), i(t, null, y(r, (e) => a("option", {
				key: e,
				value: e
			}, S(C(n)(`contact.form.${e}`)), 9, Ki)), 64))])]),
			a("div", null, [a("label", qi, S(C(n)("contact.form.message")), 1), a("textarea", {
				id: "message",
				rows: "5",
				class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: C(n)("contact.form.messagePlaceholder")
			}, null, 8, Ji)]),
			a("button", Yi, S(C(n)("contact.form.sendMessage")), 1)
		], 32));
	}
}), Zi = Ei({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Zi), (e, t) => b(e.$slots, "default");
	}
}), $i = { render() {
