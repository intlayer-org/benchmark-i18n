...
import { Fragment as t, Text as n, computed as r, createElementBlock as i, createElementVNode as a, createTextVNode as o, createVNode as s, defineComponent as c, effectScope as l, getCurrentInstance as u, getCurrentScope as d, h as f, inject as p, isRef as m, onMounted as h, onScopeDispose as g, onUnmounted as _, openBlock as v, ref as y, renderSlot as b, shallowRef as x, toDisplayString as S, unref as C, watch as w } from "vue";
function T(e, t) {
...
function Di(e, t) {
	let n = l(), r = n.run(() => Wr(e));
	if (r == null) throw Q(Z.UNEXPECTED_ERROR);
	return [n, r];
}
function Oi(e) {
	let t = p(e.isCE ? wi : e.appContext.app.__VUE_I18N_SYMBOL__);
...
process.env.NODE_ENV;
var Ri = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, zi = c({
	__name: "MockBanner",
	setup(e) {
		let { t } = Ei();
		return (e, n) => (v(), i("div", Ri, S(C(t)("mockBanner")), 1));
	}
}), Bi = { class: "mb-2 text-3xl font-bold text-foreground" }, Vi = { class: "mb-8 text-muted-foreground" }, Hi = {
	...
	setup(e) {
		let { t: n } = Ei();
		return (e, r) => (v(), i(t, null, [
			s(zi),
			a("h1", Bi, S(C(n)("contact.header.title")), 1),
			a("p", Vi, [
				o(S(C(n)("contact.header.description")) + " ", 1),
				a("a", Hi, S(C(n)("shared.contactEmail")), 1),
				r[0] ||= o(". ", -1)
			])
		], 64));
	}
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Wi), (e, t) => b(e.$slots, "default");
	}
}), Ki = { render() {
	return f(Gi, {}, { default: () => f(Ui) });
} };
