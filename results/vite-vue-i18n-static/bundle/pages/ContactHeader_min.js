...
import { Fragment as t, Text as n, computed as r, createElementBlock as i, createElementVNode as a, createTextVNode as o, createVNode as s, defineComponent as c, effectScope as l, getCurrentInstance as u, getCurrentScope as d, h as f, inject as p, isRef as m, onMounted as h, onScopeDispose as g, onUnmounted as _, openBlock as v, ref as y, renderSlot as b, shallowRef as x, toDisplayString as S, watch as C } from "vue";
...
var Ci = c({
	...
	setup(e, t) {
		...
		return () => {
			...
			return f(z(e.tag) || V(e.tag) ? e.tag : Si(), l, c);
		};
	}
});
function wi(e) {
...
function Fi(e, t) {
	let n = l(), r = n.run(() => Qr(e));
	if (r == null) throw Q(Z.UNEXPECTED_ERROR);
	return [n, r];
}
function Ii(e) {
	let t = p(e.isCE ? Mi : e.appContext.app.__VUE_I18N_SYMBOL__);
...
var Ki = c({
	...
	return n;
}, Ji = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" };
function Yi(e, t, n, r, a, o) {
	return v(), i("div", Ji, S(r.t("mockBanner")), 1);
}
var Xi = qi(Ki, [["render", Yi], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/MockBanner.vue"]]), Zi = c({
...
}), Qi = { class: "mb-2 text-3xl font-bold text-foreground" }, $i = { class: "mb-8 text-muted-foreground" }, ea = {
	href: "mailto:contact@intlayer.org",
	class: "text-primary hover:underline"
};
function ta(e, n, r, c, l, u) {
	return v(), i(t, null, [
		s(c.MockBanner),
		a("h1", Qi, S(c.t("contact.header.title")), 1),
		a("p", $i, [
			o(S(c.t("contact.header.description")) + " ", 1),
			a("a", ea, S(c.t("shared.contactEmail")), 1),
			n[0] ||= o(". ", -1)
		])
	], 64);
}
var na = qi(Zi, [["render", ta], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/contact/ContactHeader.vue"]]), ra = Ni({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
...
var oa = qi(ia, [["render", aa], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/scripts/Wrapper.vue"]]), sa = { render() {
	return f(oa, {}, { default: () => f(na) });
} };
