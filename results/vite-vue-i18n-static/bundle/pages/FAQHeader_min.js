...
function $i(e, n, r, s, c, l) {
	return _(), i(t, null, [
		o(s.MockBanner),
		a("h1", Zi, x(s.t("faq.header.title")), 1),
		a("p", Qi, x(s.t("faq.header.description")), 1)
	], 64);
}
var ea = Ki(Xi, [["render", $i], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/faq/FAQHeader.vue"]]), ta = Mi({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
