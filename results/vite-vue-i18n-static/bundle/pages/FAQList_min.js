...
var Ki = s({
	...
	return n;
}, Ji = { class: "mx-auto max-w-3xl space-y-4" }, Yi = { class: "cursor-pointer px-6 py-4 text-sm font-medium text-foreground hover:bg-accent/50 transition-colors" }, Xi = { class: "px-6 pb-4 text-sm text-muted-foreground" };
function Zi(e, n, r, o, s, c) {
	return _(), i("div", Ji, [(_(!0), i(t, null, y(o.faqs, (e, t) => (_(), i("details", {
		key: t,
		class: "group rounded-lg border border-border bg-card"
	}, [a("summary", Yi, S(e.q), 1), a("p", Xi, S(e.a), 1)]))), 128))]);
}
var Qi = qi(Ki, [["render", Zi], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/faq/FAQList.vue"]]), $i = Ni({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
