...
var Gr = { class: "mx-auto max-w-3xl space-y-4" }, Kr = { class: "cursor-pointer px-6 py-4 text-sm font-medium text-foreground hover:bg-accent/50 transition-colors" }, qr = { class: "px-6 pb-4 text-sm text-muted-foreground" }, Jr = s({
	__name: "FAQList",
	setup(e) {
		let { t: n } = Rr(), r = [
			1,
		...
		return (e, n) => (m(), i("div", Gr, [(m(!0), i(t, null, g(y(r), (e, t) => (m(), i("details", {
			key: t,
			class: "group rounded-lg border border-border bg-card"
		}, [a("summary", Kr, v(e.q), 1), a("p", qr, v(e.a), 1)]))), 128))]));
	}
});
