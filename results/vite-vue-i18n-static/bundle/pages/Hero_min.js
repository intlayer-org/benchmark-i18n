...
var Kr = { class: "mb-16 text-center" }, qr = { class: "mb-4 text-4xl font-bold tracking-tight text-foreground" }, Jr = { class: "mx-auto max-w-2xl text-lg text-muted-foreground" }, Yr = { class: "mt-8 flex justify-center gap-4" }, Xr = {
	type: "button",
	...
	setup(e) {
		Gr("Hero");
		let { t } = Rr();
		return (e, n) => (h(), i("section", Kr, [
			a("h1", qr, v(y(t)("home.hero.title")), 1),
			a("p", Jr, v(y(t)("home.hero.description")), 1),
			a("div", Yr, [a("button", Xr, v(y(t)("home.hero.viewResults")), 1), a("button", Zr, v(y(t)("home.hero.methodology")), 1)])
		]));
	}
});
