...
function Qr(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = A ? v : x, s = B(e.inheritLocale) ? e.inheritLocale : !0, c = o(t && s ? t.locale.value : z(e.locale) ? e.locale : yn), l = o(t && s ? t.fallbackLocale.value : z(e.fallbackLocale) || L(e.fallbackLocale) || H(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(Vr(c.value, e)), d = o(H(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(H(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : B(e.missingWarn) || fe(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : B(e.fallbackWarn) || fe(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : B(e.fallbackRoot) ? e.fallbackRoot : !0, g = !!e.fallbackFormat, _ = R(e.missing) ? e.missing : null, y = R(e.missing) ? Xr(e.missing) : null, b = R(e.postTranslation) ? e.postTranslation : null, S = t ? t.warnHtmlMessage : B(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, w = !!e.escapeParameter, T = t ? t.modifiers : H(e.modifiers) ? e.modifiers : {}, E = e.pluralRules || t && t.pluralRules, D;
	D = (() => {
		i && Mn(null);
		let t = {
			version: Or,
...
var Ki = s({
	...
	return n;
}, Ji = { class: "mb-6 text-2xl font-bold text-foreground" }, Yi = { class: "space-y-4" }, Xi = { class: "text-base font-semibold text-foreground" }, Zi = { class: "text-sm text-muted-foreground" }, Qi = { class: "mt-2 flex gap-2" }, $i = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, ea = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, ta = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, na = {
	type: "button",
...
function ra(e, n, r, o, s, c) {
	return _(), i(t, null, [a("h2", Ji, S(o.t("careers.openPositions.title")), 1), a("div", Yi, [(_(), i(t, null, y(o.openings, (e, t) => a("div", {
		...
		a("h3", Xi, S(o.t(`careers.openPositions.${e.titleKey}`)), 1),
		a("p", Zi, S(o.t(`careers.openPositions.${e.descKey}`)), 1),
		a("div", Qi, [
			a("span", $i, S(o.t(`careers.openPositions.${e.deptKey}`)), 1),
			a("span", ea, S(o.t(`careers.openPositions.${e.locationKey}`)), 1),
			a("span", ta, S(o.t(`careers.openPositions.${e.typeKey}`)), 1)
		])
	]), a("button", na, S(o.t("careers.openPositions.applyNow")), 1)])), 64))])], 64);
}
var ia = qi(Ki, [["render", ra], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/careers/OpenPositions.vue"]]), aa = Ni({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
...
var ca = qi(oa, [["render", sa], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/scripts/Wrapper.vue"]]), la = { render() {
	return d(ca, {}, { default: () => d(ia) });
} };
