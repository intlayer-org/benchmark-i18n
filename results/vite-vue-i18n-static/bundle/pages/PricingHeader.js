...
import { Fragment, Text, computed, createElementBlock, createElementVNode, createVNode, defineComponent, effectScope, getCurrentInstance, getCurrentScope, h, inject, isRef, onMounted, onScopeDispose, onUnmounted, openBlock, ref, renderSlot, shallowRef, toDisplayString, watch } from "vue";
...
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("div", _hoisted_1, toDisplayString($setup.t("mockBanner")), 1);
}
var MockBanner_default = _plugin_vue_export_helper_default(MockBanner_vue_vue_type_script_setup_true_lang_default, [["render", _sfc_render$2], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/MockBanner.vue"]]);
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock(Fragment, null, [createVNode($setup["MockBanner"]), _cache[0] || (_cache[0] = createElementVNode("div", { class: "mb-12 text-center" }, [createElementVNode("h1", { class: "mb-3 text-3xl font-bold text-foreground" }, " Simple, Transparent Pricing "), createElementVNode("p", { class: "text-muted-foreground" }, " Choose the plan that fits your team. No hidden fees. ")], -1))], 64);
}
var PricingHeader_default = _plugin_vue_export_helper_default(PricingHeader_vue_vue_type_script_setup_true_lang_default, [["render", _sfc_render$1], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/pricing/PricingHeader.vue"]]);
var i18n = createI18n({
	legacy: false,
	locale: "en",
	fallbackLocale: "en",
