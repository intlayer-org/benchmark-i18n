...
import { Fragment as t, Text as n, computed as r, createElementBlock as i, createElementVNode as a, createVNode as o, defineComponent as s, effectScope as c, getCurrentInstance as l, getCurrentScope as u, h as d, inject as f, isRef as p, onBeforeMount as m, onMounted as h, onScopeDispose as g, onUnmounted as _, openBlock as v, ref as y, renderList as b, renderSlot as x, shallowRef as S, toDisplayString as C, watch as w } from "vue";
import T from "../../../../locales/fr.json";
import ee from "../../../../locales/es.json";
import E from "../../../../locales/de.json";
import D from "../../../../locales/it.json";
import te from "../../../../locales/pt.json";
import ne from "../../../../locales/zh.json";
import re from "../../../../locales/ja.json";
import ie from "../../../../locales/ko.json";
import ae from "../../../../locales/ru.json";
function O(e, t) {
...
var le = /\{([0-9a-zA-Z]+)\}/g;
function j(e, ...t) {
	return t.length === 1 && V(t[0]) && (t = t[0]), (!t || !t.hasOwnProperty) && (t = {}), e.replace(le, (e, n) => t.hasOwnProperty(n) ? t[n] : "");
}
var M = (e, t = !1) => t ? Symbol.for(e) : Symbol(e), ue = (e, t, n) => de({
	l: e,
	k: t,
	s: n
}), de = (e) => JSON.stringify(e).replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029").replace(/\u0027/g, "\\u0027"), N = (e) => typeof e == "number" && isFinite(e), fe = (e) => we(e) === "[object Date]", pe = (e) => we(e) === "[object RegExp]", me = (e) => H(e) && Object.keys(e).length === 0, P = Object.assign, he = Object.create, F = (e = null) => he(e), ge, _e = () => ge ||= typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : F();
function ve(e) {
...
function be(e) {
	return e = e.replace(/(\w+)\s*=\s*"([^"]*)"/g, (e, t, n) => `${t}="${ye(n)}"`), e = e.replace(/(\w+)\s*=\s*'([^']*)'/g, (e, t, n) => `${t}='${ye(n)}'`), /\s*on\w+\s*=\s*["']?[^"'>]+["']?/gi.test(e) && (process.env.NODE_ENV !== "production" && O("Potentially dangerous event handlers detected in translation. Consider removing onclick, onerror, etc. from your translation messages."), e = e.replace(/(\s+)(on)(\w+\s*=)/gi, "$1&#111;n$3")), [/(\s+(?:href|src|action|formaction)\s*=\s*["']?)\s*javascript:/gi, /(style\s*=\s*["'][^"']*url\s*\(\s*)javascript:/gi].forEach((t) => {
...
var L = Array.isArray, R = (e) => typeof e == "function", z = (e) => typeof e == "string", B = (e) => typeof e == "boolean", V = (e) => typeof e == "object" && !!e, Se = (e) => V(e) && R(e.then) && R(e.catch), Ce = Object.prototype.toString, we = (e) => Ce.call(e), H = (e) => we(e) === "[object Object]", Te = (e) => e == null ? "" : L(e) || H(e) && e.toString === Ce ? JSON.stringify(e, null, 2) : String(e);
function Ee(e, t = "") {
	return e.reduce((e, n, r) => r === 0 ? e + n : e + t + n, "");
}
var De = 2;
function Oe(e, t = 0, n = e.length) {
	let r = e.split(/\r?\n/), i = 0, a = [];
	for (let e = 0; e < r.length; e++) if (i += r[e].length + 1, i >= t) {
		for (let o = e - De; o <= e + De || n > i; o++) {
...
var Ae = (e) => !V(e) || L(e);
function je(e, t) {
	if (Ae(e) || Ae(t)) throw Error("Invalid value");
	let n = [{
		src: e,
		des: t
	}];
	for (; n.length;) {
		...
		Object.keys(e).forEach((r) => {
			r !== "__proto__" && (V(e[r]) && !V(t[r]) && (t[r] = Array.isArray(e[r]) ? [] : F()), Ae(t[r]) || Ae(e[r]) ? t[r] = e[r] : n.push({
				src: e[r],
				des: t[r]
			}));
		});
...
function Pe(e, t, n = {}) {
	let { domain: r, messages: i, args: a } = n, o = process.env.NODE_ENV === "production" ? e : j((i || Ne)[e] || "", ...a || []), s = SyntaxError(String(o));
	return s.code = e, t && (s.location = t), s.domain = r, s;
}
function Fe(e) {
	throw e;
}
var Ie = /<\/?[\w\s="/.':;#-\/]+>/, Le = (e) => Ie.test(e), G = " ", Re = "\r", K = "\n", ze = "\u2028", Be = "\u2029";
function Ve(e) {
	let t = e, n = 0, r = 1, i = 1, a = 0, o = (e) => t[e] === Re && t[e + 1] === K, s = (e) => t[e] === K, c = (e) => t[e] === Be, l = (e) => t[e] === ze, u = (e) => o(e) || s(e) || c(e) || l(e), d = () => n, f = () => r, p = () => i, m = () => a, h = (e) => o(e) || c(e) || l(e) ? K : t[e], g = () => h(n), _ = () => h(n + a);
	function v() {
...
var He = void 0, Ue = "'", We = "tokenizer";
function Ge(e, t = {}) {
	let n = t.location !== !1, r = Ve(e), i = () => r.index(), a = () => U(r.line(), r.column(), r.index()), o = a(), s = i(), c = {
		currentType: 13,
		offset: s,
		startLoc: o,
		endLoc: o,
	...
	function d(e, t, r, ...i) {
		let a = l();
		t.column += r, t.offset += r, u && u(Pe(e, n ? Me(a.startLoc, t) : null, {
			domain: We,
			args: i
		}));
	}
	function f(e, t, r) {
		...
		let i = { type: t };
		return n && (i.loc = Me(e.startLoc, e.endLoc)), r != null && (i.value = r), i;
	}
	let p = (e) => f(e, 13);
	function m(e, t) {
	...
	function D(e, t) {
		let n = e.currentChar();
		return n === He ? He : t(n) ? (e.next(), n) : null;
	}
	function te(e) {
		let t = e.charCodeAt(0);
	...
	function ce(e) {
		...
		for (; t = ie(e);) n += t;
		let r = e.currentChar();
		if (r && r !== "}" && r !== He && r !== G && r !== K && r !== "　") {
			let t = fe(e);
			return d(W.INVALID_TOKEN_IN_PLACEHOLDER, a(), 0, n + t), n + t;
		}
		return e.currentChar() === He && d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), n;
	}
	function le(e) {
		g(e);
		let t = "";
		return e.currentChar() === "-" ? (e.next(), t += `-${k(e)}`) : t += k(e), e.currentChar() === He && d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), t;
	}
	function j(e) {
		return e !== Ue && e !== K;
	}
	function M(e) {
		g(e), m(e, "'");
		let t = "", n = "";
		for (; t = D(e, j);) t === "\\" ? n += ue(e) : n += t;
		let r = e.currentChar();
		return r === K || r === He ? (d(W.UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER, a(), 0), r === K && (e.next(), m(e, "'")), n) : (m(e, "'"), n);
	}
	function ue(e) {
		let t = e.currentChar();
		switch (t) {
	...
	function he(e, t) {
		...
		switch (e.currentChar()) {
			...
			case "@": return t.braceNest > 0 && d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), n = F(e, t) || p(t), t.braceNest = 0, n;
			default: {
				let r = !0, i = !0, o = !0;
				if (ee(e)) return t.braceNest > 0 && d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), n = f(t, 1, P(e)), t.braceNest = 0, t.inLinked = !1, n;
				if (t.braceNest > 0 && (t.currentType === 4 || t.currentType === 5 || t.currentType === 6)) return d(W.UNTERMINATED_CLOSING_BRACE, a(), 0), t.braceNest = 0, ge(e, t);
				if (r = y(e, t)) return n = f(t, 4, ce(e)), g(e), n;
				if (i = b(e, t)) return n = f(t, 5, le(e)), g(e), n;
				if (o = x(e, t)) return n = f(t, 6, M(e)), g(e), n;
				if (!r && !i && !o) return n = f(t, 12, fe(e)), d(W.INVALID_TOKEN_IN_PLACEHOLDER, a(), 0, n.value), g(e), n;
				break;
			}
		}
		return n;
	...
	function F(e, t) {
		...
		switch ((n === 7 || n === 8 || n === 11 || n === 9) && (i === K || i === G) && d(W.INVALID_LINKED_FORMAT, a(), 0), i) {
			...
			default: return ee(e) ? (r = f(t, 1, P(e)), t.braceNest = 0, t.inLinked = !1, r) : S(e, t) || w(e, t) ? (g(e), F(e, t)) : C(e, t) ? (g(e), f(t, 11, pe(e))) : T(e, t) ? (g(e), i === "{" ? he(e, t) || r : f(t, 10, me(e))) : (n === 7 && d(W.INVALID_LINKED_FORMAT, a(), 0), t.braceNest = 0, t.inLinked = !1, ge(e, t));
		}
	}
	function ge(e, t) {
		let n = { type: 13 };
		...
		switch (e.currentChar()) {
			...
			case "@": return F(e, t) || p(t);
			default:
				if (ee(e)) return n = f(t, 1, P(e)), t.braceNest = 0, t.inLinked = !1, n;
				if (E(e)) return f(t, 0, A(e));
				break;
		}
		return n;
	}
	function _e() {
		...
		return c.lastType = e, c.lastOffset = t, c.lastStartLoc = n, c.lastEndLoc = o, c.offset = i(), c.startLoc = a(), r.currentChar() === He ? f(c, 13) : ge(r, c);
	}
	return {
		nextToken: _e,
		currentOffset: i,
...
var Ke = "parser", qe = /(?:\\\\|\\'|\\u([0-9a-fA-F]{4})|\\U([0-9a-fA-F]{6}))/g, Je = /\\([\\@{}|])/g;
function Ye(e, t) {
	return t;
}
function Xe(e, t, n) {
...
function Ze(e = {}) {
	...
	function r(e, r, i, a, ...o) {
		...
		s.offset += a, s.column += a, n && n(Pe(r, t ? Me(i, s) : null, {
			domain: Ke,
			args: o
		}));
	}
	...
	function o(e, t) {
		...
		return r.value = t.replace(Je, Ye), a(r, e.currentOffset(), e.currentPosition()), r;
	}
	function s(e, t) {
	...
	function l(e, t) {
		...
		return o.value = t.replace(qe, Xe), e.nextToken(), a(o, e.currentOffset(), e.currentPosition()), o;
	}
	function u(e) {
		let t = e.nextToken(), n = e.context(), { lastOffset: o, lastStartLoc: s } = n, c = i(8, o, s);
		return t.type === 11 ? (t.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, n.lastStartLoc, 0, Qe(t)), c.value = t.value || "", a(c, e.currentOffset(), e.currentPosition()), { node: c }) : (r(e, W.UNEXPECTED_EMPTY_LINKED_MODIFIER, n.lastStartLoc, 0), c.value = "", a(c, o, s), {
			nextConsumeToken: t,
			node: c
		});
	}
	...
	function f(e) {
		...
		switch (o.type !== 9 && r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Qe(o)), o = e.nextToken(), o.type === 2 && (o = e.nextToken()), o.type) {
			case 10:
				o.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Qe(o)), n.key = d(e, o.value || "");
				break;
			case 4:
				o.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Qe(o)), n.key = c(e, o.value || "");
				break;
			case 5:
				o.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Qe(o)), n.key = s(e, o.value || "");
				break;
			case 6:
				o.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Qe(o)), n.key = l(e, o.value || "");
				break;
			default: {
	...
	function p(e) {
		...
		do {
			...
			switch (u = null, i.type) {
				case 0:
					i.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Qe(i)), n.items.push(o(e, i.value || ""));
					break;
				case 5:
					i.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Qe(i)), n.items.push(s(e, i.value || ""));
					break;
				case 4:
					i.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Qe(i)), n.items.push(c(e, i.value || ""));
					break;
				case 6:
					i.value ?? r(e, W.UNEXPECTED_LEXICAL_ANALYSIS, t.lastStartLoc, 0, Qe(i)), n.items.push(l(e, i.value || ""));
					break;
				case 7: {
					let t = f(e);
	...
	function g(n) {
		let o = Ge(n, P({}, e)), s = o.context(), c = i(0, s.offset, s.startLoc);
...
function tt(e, t) {
	switch (e.type) {
		case 1:
			et(e.cases, t), t.helper("plural");
			break;
		case 2:
			et(e.items, t);
			break;
		case 6:
			tt(e.key, t), t.helper("linked"), t.helper("type");
			break;
		case 5:
...
function nt(e, t = {}) {
	let n = $e(e);
	n.helper("normalize"), e.body && tt(e.body, n);
	let r = n.context();
	e.helpers = Array.from(r.helpers);
}
function rt(e) {
	let t = e.body;
	return t.type === 2 ? it(t) : t.cases.forEach((e) => it(e)), e;
}
function it(e) {
	if (e.items.length === 1) {
		let t = e.items[0];
...
function ot(e) {
	switch (e.t = e.type, e.type) {
		case 0: {
			let t = e;
			ot(t.body), t.b = t.body, delete t.body;
			break;
		}
		case 1: {
			let t = e, n = t.cases;
		...
		case 6: {
			let t = e;
			ot(t.key), t.k = t.key, delete t.key, t.modifier && (ot(t.modifier), t.m = t.modifier, delete t.modifier);
			break;
		}
		case 5: {
			let t = e;
		...
		default: if (process.env.NODE_ENV !== "production") throw Pe(W.UNHANDLED_MINIFIER_NODE_TYPE, null, {
			domain: at,
			args: [e.type]
		});
	}
...
function lt(e, t) {
	let { helper: n } = e;
	e.push(`${n("linked")}(`), pt(e, t.key), t.modifier ? (e.push(", "), pt(e, t.modifier), e.push(", _type")) : e.push(", undefined, _type"), e.push(")");
}
function ut(e, t) {
	let { helper: n, needIndent: r } = e;
	e.push(`${n("normalize")}([`), e.indent(r());
	let i = t.items.length;
	for (let n = 0; n < i && (pt(e, t.items[n]), n !== i - 1); n++) e.push(", ");
	e.deindent(r()), e.push("])");
}
function dt(e, t) {
	let { helper: n, needIndent: r } = e;
	if (t.cases.length > 1) {
		...
		for (let n = 0; n < i && (pt(e, t.cases[n]), n !== i - 1); n++) e.push(", ");
		e.deindent(r()), e.push("])");
	}
}
function ft(e, t) {
...
function pt(e, t) {
	...
	switch (t.type) {
		...
		case 3:
			e.push(JSON.stringify(t.value), t);
			break;
		default: if (process.env.NODE_ENV !== "production") throw Pe(W.UNHANDLED_CODEGEN_NODE_TYPE, null, {
			domain: st,
			args: [t.type]
		});
	}
...
var mt = (e, t = {}) => {
	...
	c.push(n === "normal" ? "function __msg__ (ctx) {" : "(ctx) => {"), c.indent(o), s.length > 0 && (c.push(`const { ${Ee(s.map((e) => `${e}: _${e}`), ", ")} } = ctx`), c.newline()), c.push("return "), pt(c, e), c.deindent(o), c.push("}"), delete e.helpers;
...
function ht(e, t = {}) {
	let n = P({}, t), r = !!n.jit, i = !!n.minify, a = n.optimize == null ? !0 : n.optimize, o = Ze(n).parse(e);
	return r ? (a && rt(o), i && ot(o), {
		ast: o,
		code: ""
	}) : (nt(o, n), mt(o, n));
}
function q(e) {
	return V(e) && Tt(e) === 0 && (I(e, "b") || I(e, "body"));
}
var gt = ["b", "body"];
function _t(e) {
	return Mt(e, gt);
...
function It(e, t) {
	let n = _t(t);
	if (n == null) throw Pt(0);
	if (Tt(n) === 1) {
		let t = yt(n);
		return e.plural(t.reduce((t, n) => [...t, Lt(e, n)], []));
	} else return Lt(e, n);
}
function Lt(e, t) {
	let n = xt(t);
	...
	{
		let n = Ct(t).reduce((t, n) => [...t, Rt(e, n)], []);
...
function Rt(e, t) {
	let n = Tt(t);
	switch (n) {
		case 3: return Dt(t, n);
		case 9: return Dt(t, n);
		case 4: {
			let r = t;
		...
		case 6: {
			let n = t, r = kt(n), i = jt(n);
			return e.linked(Rt(e, i), r ? Rt(e, r) : void 0, e.type);
		}
		case 7: return Dt(t, n);
		case 8: return Dt(t, n);
		default: throw Error(`unhandled node on format message part: ${n}`);
	}
}
var zt = "Detected HTML in '{source}' message. Recommend not using HTML messages to avoid XSS.";
function Bt(e, t) {
	t && Le(e) && O(j(zt, { source: e }));
}
var Vt = (e) => e, Ht = F();
function Ut(e, t = {}) {
	let n = !1, r = t.onError || Fe;
	return t.onError = (e) => {
		n = !0, r(e);
	}, {
		...ht(e, t),
...
function Wt(e, t) {
	if (z(e)) {
		...
		process.env.NODE_ENV !== "production" && Bt(e, n);
		let r = (t.onCacheKey || Vt)(e), i = Ht[r];
		if (i) return i;
		let { ast: a, detectError: o } = Ut(e, {
			...t,
...
function Xt(e) {
	return Pe(e, null, process.env.NODE_ENV === "production" ? void 0 : { messages: Zt });
}
var Zt = {
...
function Qt(e, t) {
	return t.locale == null ? en(e.locale) : en(t.locale);
}
var $t;
function en(e) {
	if (z(e)) return e;
	if (R(e)) {
		if (e.resolvedOnce && $t != null) return $t;
		if (e.constructor.name === "Function") {
			let t = e();
			if (Se(t)) throw Xt(J.NOT_SUPPORT_LOCALE_PROMISE_VALUE);
			return $t = t;
		} else throw Xt(J.NOT_SUPPORT_LOCALE_ASYNC_FUNCTION);
	} else throw Xt(J.NOT_SUPPORT_LOCALE_TYPE);
}
function tn(e, t, n) {
...
function nn(e, t, n) {
	...
	if (!a) {
		...
		e = z(o) ? [o] : o, L(e) && rn(a, e, !1), i.__localeChainCache.set(r, a);
	}
	return a;
}
function rn(e, t, n) {
...
function fn(e) {
	let t = e.trim();
	return e.charAt(0) === "0" && isNaN(parseInt(e)) ? !1 : ln(t) ? un(t) : "*" + t;
}
function pn(e) {
	...
	f[0] = () => {
		...
		if (i > 0) i--, r = 4, f[0]();
			...
			if (i = 0, o === void 0 || (o = fn(o), o === !1)) return !1;
			f[1]();
		}
	};
	function p() {
	...
	for (; r !== null;) if (n++, a = e[n], !(a === "\\" && p())) {
		if (c = dn(a), d = sn[r], l = d[c] || d.l || 8, l === 8 || (r = l[0], l[1] !== void 0 && (u = f[l[1]], u && (s = a, u() === !1)))) return;
		if (r === 7) return t;
	}
}
...
function gn(e, t) {
	if (!V(e)) return null;
	let n = mn.get(t);
	if (n || (n = pn(t), n && mn.set(t, n)), !n) return null;
	let r = n.length, i = e, a = 0;
	for (; a < r;) {
		let e = n[a];
		if (Nt.includes(e) && q(i) || !V(i) || !I(i, e)) return null;
		let t = i[e];
...
var yn = "11.4.0", bn = "en-US", xn = (e) => `${e.charAt(0).toLocaleUpperCase()}${e.substr(1)}`;
function Sn() {
	return {
		...
		capitalize: (e, t) => t === "text" && z(e) ? xn(e) : t === "vnode" && V(e) && "__v_isVNode" in e ? xn(e.children) : e
	};
}
var Cn;
function wn(e) {
...
function In(e = {}) {
	let t = R(e.onWarn) ? e.onWarn : O, n = z(e.version) ? e.version : yn, r = z(e.locale) || R(e.locale) ? e.locale : bn, i = R(r) ? bn : r, a = L(e.fallbackLocale) || H(e.fallbackLocale) || z(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : i, o = H(e.messages) ? e.messages : Ln(i), s = H(e.datetimeFormats) ? e.datetimeFormats : Ln(i), c = H(e.numberFormats) ? e.numberFormats : Ln(i), l = P(F(), e.modifiers, Sn()), u = e.pluralRules || F(), d = R(e.missing) ? e.missing : null, f = B(e.missingWarn) || pe(e.missingWarn) ? e.missingWarn : !0, p = B(e.fallbackWarn) || pe(e.fallbackWarn) ? e.fallbackWarn : !0, m = !!e.fallbackFormat, h = !!e.unresolving, g = R(e.postTranslation) ? e.postTranslation : null, _ = H(e.processor) ? e.processor : null, v = B(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, y = !!e.escapeParameter, b = R(e.messageCompiler) ? e.messageCompiler : Cn;
	process.env.NODE_ENV !== "production" && R(e.messageCompiler) && se(vn(Y.EXPERIMENTAL_CUSTOM_MESSAGE_COMPILER));
	let x = R(e.messageResolver) ? e.messageResolver : Tn || hn, S = R(e.localeFallbacker) ? e.localeFallbacker : Dn || tn, C = V(e.fallbackContext) ? e.fallbackContext : void 0, w = e, T = V(w.__datetimeFormatters) ? w.__datetimeFormatters : /* @__PURE__ */ new Map(), ee = V(w.__numberFormatters) ? w.__numberFormatters : /* @__PURE__ */ new Map(), E = V(w.__meta) ? w.__meta : {};
	Fn++;
	let D = {
		version: n,
		cid: Fn,
	...
	return D.datetimeFormats = s, D.numberFormats = c, D.__datetimeFormatters = T, D.__numberFormatters = ee, process.env.NODE_ENV !== "production" && (D.__v_emitter = w.__v_emitter == null ? void 0 : w.__v_emitter), process.env.NODE_ENV !== "production" && qt(D, n, E), D;
}
var Ln = (e) => ({ [e]: F() });
function Rn(e, t) {
...
function Bn(e, t, n, r, i) {
	...
	if (a !== null) {
		let r = a(e, n, t, i);
		return z(r) ? r : t;
	} else return process.env.NODE_ENV !== "production" && zn(r, t) && o(vn(Y.NOT_FOUND_KEY, {
		key: t,
		locale: n
	})), t;
}
...
function Un(e, t) {
	let n = t.indexOf(e);
	if (n === -1) return !1;
	for (let r = n + 1; r < t.length; r++) if (Hn(e, t[r])) return !0;
	return !1;
}
var Wn = typeof Intl < "u", Gn = {
...
function Kn(e, ...t) {
	...
	if (process.env.NODE_ENV !== "production" && !Gn.dateTimeFormat) return a(vn(Y.CANNOT_FORMAT_DATE)), "";
	if (!z(t[0]) && !fe(t[0]) && !N(t[0])) return process.env.NODE_ENV !== "production" && a(vn(Y.INVALID_DATE_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = Jn(...t), f = B(u.missingWarn) ? u.missingWarn : e.missingWarn, p = B(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = Qt(e, u), g = o(e, i, h);
	if (!z(c) || c === "") return new Intl.DateTimeFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "datetime format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && Rn(p, c) && a(vn(Y.FALLBACK_TO_DATE_FORMAT, {
			key: c,
			target: v
...
function Jn(...e) {
	...
	if (z(t)) {
		...
		if (!e) throw Xt(J.INVALID_ISO_DATE_ARGUMENT);
		let n = e[3] ? e[3].trim().startsWith("T") ? `${e[1].trim()}${e[3].trim()}` : `${e[1].trim()}T${e[3].trim()}` : e[1].trim();
		s = new Date(n);
		try {
			s.toISOString();
		} catch {
			throw Xt(J.INVALID_ISO_DATE_ARGUMENT);
		}
	} else if (fe(t)) {
		if (isNaN(t.getTime())) throw Xt(J.INVALID_DATE_ARGUMENT);
		s = t;
	} else if (N(t)) s = t;
	else throw Xt(J.INVALID_ARGUMENT);
...
function Xn(e, ...t) {
	...
	if (process.env.NODE_ENV !== "production" && !Gn.numberFormat) return a(vn(Y.CANNOT_FORMAT_NUMBER)), "";
	if (!N(t[0])) return process.env.NODE_ENV !== "production" && a(vn(Y.INVALID_NUMBER_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = Qn(...t), f = B(u.missingWarn) ? u.missingWarn : e.missingWarn, p = B(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = Qt(e, u), g = o(e, i, h);
	if (!z(c) || c === "") return new Intl.NumberFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "number format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && Rn(p, c) && a(vn(Y.FALLBACK_TO_NUMBER_FORMAT, {
			key: c,
			target: v
		})), process.env.NODE_ENV !== "production" && h !== v) {
			let t = e.__v_emitter;
...
function Qn(...e) {
	...
	if (!N(t)) throw Xt(J.INVALID_ARGUMENT);
	let s = t;
	return z(n) ? a.key = n : H(n) && Object.keys(n).forEach((e) => {
		Zn.includes(e) ? o[e] = n[e] : a[e] = n[e];
	}), z(r) ? a.locale = r : H(r) && (o = r), H(i) && (o = i), [
		a.key || "",
		s,
		a,
...
var er = (e) => e, tr = (e) => "", nr = "text", rr = (e) => e.length === 0 ? "" : Ee(e), ir = Te;
function ar(e, t) {
...
function sr(e = {}) {
	let t = e.locale, n = or(e), r = z(t) && R(e.pluralRules?.[t]) ? e.pluralRules[t] : ar, i = r === ar ? void 0 : ar, a = (e) => e[r(n, e.length, i)], o = e.list || [], s = (e) => o[e], c = e.named || F();
	N(e.pluralIndex) && (c.count ||= e.pluralIndex, c.n ||= e.pluralIndex);
	let l = (e) => c[e];
	function u(t, n) {
		return (R(e.messages) ? e.messages(t, !!n) : V(e.messages) ? e.messages[t] : !1) || (e.parent ? e.parent.message(t) : tr);
	}
	let d = (t) => e.modifiers ? e.modifiers[t] : er, f = R(e.processor?.normalize) ? e.processor.normalize : rr, p = R(e.processor?.interpolate) ? e.processor.interpolate : ir, m = {
		list: s,
		named: l,
		plural: a,
		linked: (e, ...t) => {
		...
		message: u,
		type: z(e.processor?.type) ? e.processor.type : nr,
		interpolate: p,
		normalize: f,
		values: P(F(), o, c)
	};
...
var cr = () => "", X = (e) => R(e);
function lr(e, ...t) {
	let { fallbackFormat: n, postTranslation: r, unresolving: i, messageCompiler: a, fallbackLocale: o, messages: s } = e, [c, l] = mr(...t), u = B(l.missingWarn) ? l.missingWarn : e.missingWarn, d = B(l.fallbackWarn) ? l.fallbackWarn : e.fallbackWarn, f = B(l.escapeParameter) ? l.escapeParameter : e.escapeParameter, p = !!l.resolvedMessage, m = z(l.default) || B(l.default) ? B(l.default) ? a ? c : () => c : l.default : n ? a ? c : () => c : null, h = n || m != null && (z(m) || R(m)), g = Qt(e, l);
	f && ur(l);
	let [_, v, y] = p ? [
		c,
		g,
		s[g] || F()
	] : dr(e, c, g, o, d, u), b = _, x = c;
	...
	let S = !1, C = X(b) ? b : fr(e, c, v, b, x, () => {
		S = !0;
	});
	if (S) return b;
	let w = pr(e, C, sr(_r(e, v, y, l))), T = r ? r(w, c) : w;
	if (f && z(T) && (T = be(T)), process.env.NODE_ENV !== "production") {
		let t = {
			timestamp: Date.now(),
			key: z(c) ? c : X(b) ? b.key : "",
		...
		t.meta = P({}, e.__meta, jn() || {}), Jt(t);
	}
	return T;
}
function ur(e) {
	L(e.list) ? e.list = e.list.map((e) => z(e) ? ve(e) : e) : V(e.named) && Object.keys(e.named).forEach((t) => {
		z(e.named[t]) && (e.named[t] = ve(e.named[t]));
	});
}
function dr(e, t, n, r, i, a) {
	let { messages: o, onWarn: s, messageResolver: c, localeFallbacker: l } = e, u = l(e, r, n), d = F(), f, p = null, m = n, h = null, g = "translate";
	for (let r = 0; r < u.length; r++) {
		f = h = u[r], process.env.NODE_ENV !== "production" && n !== f && !Hn(n, f) && Rn(i, t) && s(vn(Y.FALLBACK_TO_TRANSLATE, {
			key: t,
			target: f
		}));
		...
		if (process.env.NODE_ENV !== "production" && k && l && (_ = window.performance.now(), v = "intlify-message-resolve-start", y = "intlify-message-resolve-end", A && A(v)), (p = c(d, t)) === null && (p = d[t]), process.env.NODE_ENV !== "production" && k && l) {
			...
			l && _ && p && l.emit("message-resolve", {
				...
				time: e - _,
				groupId: `${g}:${t}`
			}), v && y && A && ce && (A(y), ce("intlify message resolve", v, y));
		}
...
function fr(e, t, n, r, i, a) {
	...
	if (process.env.NODE_ENV !== "production" && k && c) {
		...
		c && l && c.emit("message-compilation", {
			...
			time: e - l,
			groupId: `translate:${t}`
		}), u && d && A && ce && (A(d), ce("intlify message compilation", u, d));
	}
...
function pr(e, t, n) {
	...
	if (process.env.NODE_ENV !== "production" && k && r) {
		...
		}), a && o && A && ce && (A(o), ce("intlify message evaluation", a, o));
	}
	return s;
}
function mr(...e) {
	let [t, n, r] = e, i = F();
	if (!z(t) && !N(t) && !X(t) && !q(t)) throw Xt(J.INVALID_ARGUMENT);
	let a = N(t) ? String(t) : (X(t), t);
	return N(n) ? i.plural = n : z(n) ? i.default = n : H(n) && !me(n) ? i.named = n : L(n) && (i.list = n), N(r) ? i.plural = r : z(r) ? i.default = r : H(r) && P(i, r), [a, i];
}
	...
	return {
		...
		onError: (t) => {
			if (a && a(t), process.env.NODE_ENV !== "production") {
				let i = gr(r), a = t.location && i && Oe(i, t.location.start.offset, t.location.end.offset), o = e.__v_emitter;
...
function _r(e, t, n, r) {
	let { modifiers: i, pluralRules: a, messageResolver: o, fallbackLocale: s, fallbackWarn: c, missingWarn: l, fallbackContext: u } = e, d = {
		...
		messages: (r, i) => {
			let a = o(n, r);
			if (a == null && (u || i)) {
				let [n, , i] = dr(u || e, r, t, s, c, l);
				a = n ?? o(i, r);
			}
			if (z(a) || q(a)) {
				let n = !1, i = fr(e, r, t, a, r, () => {
					n = !0;
				});
				return n ? cr : i;
...
function vr() {
	return yr().__VUE_DEVTOOLS_GLOBAL_HOOK__;
}
function yr() {
	return typeof navigator < "u" && typeof window < "u" ? window : typeof globalThis < "u" ? globalThis : {};
}
var br = typeof Proxy == "function", xr = "devtools-plugin:setup", Sr = "plugin:settings:set", Cr, wr;
function Tr() {
	return Cr === void 0 && (typeof window < "u" && window.performance ? (Cr = !0, wr = window.performance) : typeof globalThis < "u" && globalThis.perf_hooks?.performance ? (Cr = !0, wr = globalThis.perf_hooks.performance) : Cr = !1), Cr;
}
function Er() {
	return Tr() ? wr.now() : Date.now();
}
var Dr = class {
	constructor(e, t) {
...
function Or(e, t) {
	let n = e, r = yr(), i = vr(), a = br && n.enableEarlyProxy;
	if (i && (r.__VUE_DEVTOOLS_PLUGIN_API_AVAILABLE__ || !a)) i.emit(xr, e, t);
	else {
		let e = a ? new Dr(n, i) : null;
...
function Q(e, ...t) {
	return Pe(e, null, process.env.NODE_ENV === "production" ? void 0 : {
		messages: Ar,
		args: t
	});
}
...
}, jr = M("__translateVNode"), Mr = M("__datetimeParts"), Nr = M("__numberParts"), Pr = M("__enableEmitter"), Fr = M("__disableEmitter"), Ir = M("__setPluralRules");
M("__intlifyMeta");
var Lr = M("__injectWithOption"), Rr = M("__dispose"), $ = {
	FALLBACK_TO_ROOT: 10,
...
function Vr(e) {
	if (!V(e) || q(e)) return e;
	for (let t in e) if (I(e, t)) if (!t.includes(".")) V(e[t]) && Vr(e[t]);
	else {
		let n = t.split("."), r = n.length - 1, i = e, a = !1;
		for (let e = 0; e < r; e++) {
			if (n[e] === "__proto__") throw Error(`unsafe key: ${n[e]}`);
			if (n[e] in i || (i[n[e]] = F()), !V(i[n[e]])) {
				process.env.NODE_ENV !== "production" && O(Br($.IGNORE_OBJ_FLATTEN, { key: n[e] })), a = !0;
				break;
			}
			i = i[n[e]];
		}
		if (a || (q(i) ? Nt.includes(n[r]) || delete e[t] : (i[n[r]] = e[t], delete e[t])), !q(i)) {
			let e = i[n[r]];
			V(e) && Vr(e);
		}
	}
...
function Hr(e, t) {
	...
	if (L(r) && r.forEach((e) => {
		if ("locale" in e && "resource" in e) {
			...
			t ? (o[t] = o[t] || F(), je(n, o[t])) : je(n, o);
		} else z(e) && je(JSON.parse(e), o);
	}), i == null && a) for (let e in o) I(o, e) && Vr(o[e]);
	return o;
}
function Ur(e) {
	return e.type;
...
var qr = "__INTLIFY_META__", Jr = () => [], Yr = () => !1, Xr = 0;
function Zr(e) {
	return ((t, n, r, i) => e(n, r, Kr() || void 0, i));
}
var Qr = () => {
	let e = Kr(), t = null;
	return e && (t = Ur(e)[qr]) ? { [qr]: t } : null;
};
function $r(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = k ? y : S, s = B(e.inheritLocale) ? e.inheritLocale : !0, c = o(t && s ? t.locale.value : z(e.locale) ? e.locale : bn), l = o(t && s ? t.fallbackLocale.value : z(e.fallbackLocale) || L(e.fallbackLocale) || H(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(Hr(c.value, e)), d = o(H(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(H(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : B(e.missingWarn) || pe(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : B(e.fallbackWarn) || pe(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : B(e.fallbackRoot) ? e.fallbackRoot : !0, g = !!e.fallbackFormat, _ = R(e.missing) ? e.missing : null, v = R(e.missing) ? Zr(e.missing) : null, b = R(e.postTranslation) ? e.postTranslation : null, x = t ? t.warnHtmlMessage : B(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, C = !!e.escapeParameter, T = t ? t.modifiers : H(e.modifiers) ? e.modifiers : {}, ee = e.pluralRules || t && t.pluralRules, E;
	E = (() => {
		i && Nn(null);
		let t = {
			version: kr,
	...
	let te = r({
		...
		get: () => l.value,
		set: (e) => {
			E.fallbackLocale = e, l.value = e, Vn(E, c.value, e);
		}
	...
	let j = (e, n, r, a, o, s) => {
		...
		let c;
		try {
			process.env.NODE_ENV !== "production" && An(Qr()), i || (E.fallbackContext = t ? Pn() : void 0), c = e(E);
		} finally {
			process.env.NODE_ENV !== "production" && An(null), i || (E.fallbackContext = void 0);
		}
		if (r !== "translate exists" && N(c) && c === -1 || r === "translate exists" && !c) {
			let [e, i] = n();
			if (process.env.NODE_ENV !== "production" && t && z(e) && le(r, i) && (h && (Rn(m, e) || zn(p, e)) && O(Br($.FALLBACK_TO_ROOT, {
				key: e,
				type: r
	...
	function M(...e) {
		return j((t) => Reflect.apply(lr, null, [t, ...e]), () => mr(...e), "translate", (t) => Reflect.apply(t.t, t, [...e]), (e) => e, (e) => z(e));
	}
	function ue(...e) {
		let [t, n, r] = e;
		if (r && !V(r)) throw Q(Z.INVALID_ARGUMENT);
		return M(t, n, P({ resolvedMessage: !0 }, r || {}));
	}
	function de(...e) {
		return j((t) => Reflect.apply(Kn, null, [t, ...e]), () => Jn(...e), "datetime format", (t) => Reflect.apply(t.d, t, [...e]), () => "", (e) => z(e) || L(e));
	}
	function fe(...e) {
		return j((t) => Reflect.apply(Xn, null, [t, ...e]), () => Qn(...e), "number format", (t) => Reflect.apply(t.n, t, [...e]), () => "", (e) => z(e) || L(e));
	}
	function me(e) {
		return e.map((e) => z(e) || N(e) || B(e) ? Gr(String(e)) : e);
	}
	let he = {
		normalize: me,
		interpolate: (e) => e,
	...
	function F(...e) {
		return j((t) => {
			let n, r = t;
			try {
				r.processor = he, n = Reflect.apply(lr, null, [r, ...e]);
			} finally {
				r.processor = null;
			}
			return n;
		}, () => mr(...e), "translate", (t) => t[jr](...e), (e) => [Gr(e)], (e) => L(e));
	}
	function ge(...e) {
		return j((t) => Reflect.apply(Xn, null, [t, ...e]), () => Qn(...e), "number format", (t) => t[Nr](...e), Jr, (e) => z(e) || L(e));
	}
	function _e(...e) {
		return j((t) => Reflect.apply(Kn, null, [t, ...e]), () => Jn(...e), "datetime format", (t) => t[Mr](...e), Jr, (e) => z(e) || L(e));
	}
	function ve(e) {
	...
	function ye(e, t) {
		return j(() => {
			if (!e) return !1;
			let n = z(t) ? t : c.value, r = z(t) ? [n] : nn(E, l.value, n);
			for (let t = 0; t < r.length; t++) {
				let n = Se(r[t]), i = E.messageResolver(n, e);
				if (i === null && (i = n[e]), q(i) || X(i) || z(i)) return !0;
			}
			return !1;
		}, () => [e], "translate exists", (n) => Reflect.apply(n.te, n, [e, t]), Yr, (e) => B(e));
	}
	function be(e) {
		let t = null, n = nn(E, l.value, c.value);
	...
	function we(e, t) {
		u.value[e] = u.value[e] || {};
		let n = { [e]: t };
		if (a) for (let e in n) I(n, e) && Vr(n[e]);
		t = n[e], je(t, u.value[e]), E.messages = u.value;
	}
	function Te(e) {
		return d.value[e] || {};
	}
	function Ee(e, t) {
		d.value[e] = t, E.datetimeFormats = d.value, Yn(E, e, t);
	}
	function De(e, t) {
		d.value[e] = P(d.value[e] || {}, t), E.datetimeFormats = d.value, Yn(E, e, t);
	}
	function Oe(e) {
		return f.value[e] || {};
	}
	function ke(e, t) {
		f.value[e] = t, E.numberFormats = f.value, $n(E, e, t);
	}
	function Ae(e, t) {
		f.value[e] = P(f.value[e] || {}, t), E.numberFormats = f.value, $n(E, e, t);
	}
	Xr++, t && k && (w(t.locale, (e) => {
		s && (c.value = e, E.locale = e, Vn(E, c.value, l.value));
	}), w(t.fallbackLocale, (e) => {
		s && (l.value = e, E.fallbackLocale = e, Vn(E, c.value, l.value));
	}));
	let U = {
		id: Xr,
		locale: te,
		...
		set inheritLocale(e) {
			s = e, e && t && (c.value = t.locale.value, l.value = t.fallbackLocale.value, Vn(E, c.value, l.value));
		},
	...
	return U.datetimeFormats = ie, U.numberFormats = ae, U.rt = ue, U.te = ye, U.tm = xe, U.d = de, U.n = fe, U.getDateTimeFormat = Te, U.setDateTimeFormat = Ee, U.mergeDateTimeFormat = De, U.getNumberFormat = Oe, U.setNumberFormat = ke, U.mergeNumberFormat = Ae, U[Lr] = n, U[jr] = F, U[Mr] = _e, U[Nr] = ge, process.env.NODE_ENV !== "production" && (U[Pr] = (e) => {
		E.__v_emitter = e;
	}, U[Fr] = () => {
		E.__v_emitter = void 0;
	}), U;
}
var ei = "vue-i18n: composer properties", ti = {
	"vue-devtools-plugin-vue-i18n": "Vue I18n DevTools",
	"vue-i18n-resource-inspector": "Vue I18n DevTools",
	"vue-i18n-timeline": "Vue I18n"
}, ni = { "vue-i18n-resource-inspector": "Search for scopes ..." }, ri = { "vue-i18n-timeline": 16764185 }, ii;
async function ai(e, t) {
	return new Promise((n, r) => {
		try {
			Or({
				id: "vue-devtools-plugin-vue-i18n",
				label: ti["vue-devtools-plugin-vue-i18n"],
				...
				ii = r, r.on.visitComponentTree(({ componentInstance: e, treeNode: n }) => {
					si(e, n, t);
				}), r.on.inspectComponent(({ componentInstance: e, instanceData: n }) => {
					e.__VUE_I18N__ && n && (t.mode === "legacy" ? e.__VUE_I18N__ !== t.global.__composer && ci(n, e.__VUE_I18N__) : ci(n, e.__VUE_I18N__));
				}), r.addInspector({
					id: "vue-i18n-resource-inspector",
					label: ti["vue-i18n-resource-inspector"],
					icon: "language",
					treeFilterPlaceholder: ni["vue-i18n-resource-inspector"]
				}), r.on.getInspectorTree((n) => {
					n.app === e && n.inspectorId === "vue-i18n-resource-inspector" && mi(n, t);
				});
				let i = /* @__PURE__ */ new Map();
				r.on.getInspectorState(async (n) => {
					if (n.app === e && n.inspectorId === "vue-i18n-resource-inspector") if (r.unhighlightElement(), _i(n, t), n.nodeId === "global") {
						if (!i.has(n.app)) {
					...
					n.app === e && n.inspectorId === "vue-i18n-resource-inspector" && bi(n, t);
				}), r.addTimelineLayer({
					id: "vue-i18n-timeline",
					label: ti["vue-i18n-timeline"],
					color: ri["vue-i18n-timeline"]
				}), n(!0);
			});
		} catch (e) {
			console.error(e), r(!1);
...
function li(e) {
	...
	return Object.keys(e).forEach((n) => {
		let r = e[n];
		R(r) && "source" in r ? t[n] = pi(r) : q(r) && r.loc && r.loc.source ? t[n] = r.loc.source : V(r) ? t[n] = li(r) : t[n] = r;
	}), t;
}
var ui = {
	"<": "&lt;",
...
function pi(e) {
	return { _custom: {
		type: "function",
		display: `<span>ƒ</span> ${e.source ? `("${di(e.source)}")` : "(?)"}`
	} };
}
function mi(e, t) {
	e.rootNodes.push({
...
function yi(e, t) {
	if (ii) {
		let n;
		t && "groupId" in t && (n = t.groupId, delete t.groupId), ii.addTimelineEvent({
...
var wi = s({
	...
	setup(e, t) {
		let { slots: n, attrs: r } = t, i = e.i18n || Fi({
			useScope: e.scope,
			__useComponent: !0
		});
		return () => {
			...
			let s = Si(t, a), c = i[jr](e.keypath, s, o), l = P(F(), r);
			return d(z(e.tag) || V(e.tag) ? e.tag : Ci(), l, c);
		};
	}
});
function Ti(e) {
...
function Ei(e, t, n, r) {
	...
	return () => {
		...
		L(s) ? c = s.map((e, t) => {
			...
			return Ti(r) && (r[0].key = `${e.type}-${t}`), r;
		}) : z(s) && (c = [s]);
		let l = P(F(), a);
		return d(z(e.tag) || V(e.tag) ? e.tag : Ci(), l, c);
	};
...
function ki(e) {
	let t = (t) => {
		process.env.NODE_ENV !== "production" && se(Br($.DEPRECATE_TRANSLATE_CUSTOME_DIRECTIVE));
		let { instance: n, value: r } = t;
		if (!n || !n.$) throw Q(Z.UNEXPECTED_ERROR);
		let i = Oi(e, n.$), a = Ai(r);
		return [Reflect.apply(i.t, i, [...ji(a)]), i];
	};
	return {
		created: (e, n) => {
			let [r, i] = t(n);
			k && (e.__i18nWatcher = w(i.locale, () => {
		...
		beforeUpdate: (e, { value: t }) => {
			if (e.__composer) {
				let n = e.__composer, r = Ai(t);
				e.textContent = Reflect.apply(n.t, n, [...ji(r)]);
			}
		},
		getSSRProps: (e) => {
			let [n] = t(e);
...
function Mi(e, t, ...n) {
	let r = H(n[0]) ? n[0] : {};
	(!B(r.globalInstall) || r.globalInstall) && ([wi.name, "I18nT"].forEach((t) => e.component(t, wi)), [Di.name, "I18nN"].forEach((t) => e.component(t, Di)), [Ki.name, "I18nD"].forEach((t) => e.component(t, Ki))), e.directive("t", ki(t));
}
var Ni = M("global-vue-i18n");
function Pi(e = {}) {
	process.env.NODE_ENV;
	let t = B(e.globalInjection) ? e.globalInjection : !0, n = /* @__PURE__ */ new Map(), [r, i] = Ii(e, !1), a = M(process.env.NODE_ENV === "production" ? "" : "vue-i18n");
	function o(e) {
		return n.get(e) || null;
	}
	function s(e, t) {
	...
	let l = {
		...
		async install(e, ...n) {
			...
			let r = null;
			t && (r = Gi(e, l.global)), Mi(e, l, ...n);
			let o = e.unmount;
			if (e.unmount = () => {
				r && r(), l.dispose(), o();
			}, process.env.NODE_ENV !== "production") {
				if (!await ai(e, l)) throw Q(Z.CANNOT_SETUP_VUE_DEVTOOLS_PLUGIN);
				let t = ke();
				{
					let e = i;
					e[Pr] && e[Pr](t);
...
function Fi(e = {}) {
	...
	let n = Li(t), r = zi(n), i = Ur(t), a = Ri(e, i);
	if (a === "global") return Wr(r, e, i), r;
	if (a === "parent") {
		let i = Bi(n, t, e.__useComponent);
		return i ??= (process.env.NODE_ENV !== "production" && O(Br($.NOT_FOUND_PARENT_SCOPE)), r), i;
	}
	if (a === "isolated") {
		...
		a.__root = Bi(n, t) || r;
		let o = $r(a);
		i.__composerExtend && (o[Rr] = i.__composerExtend(o));
		let s = null;
		if (process.env.NODE_ENV !== "production") {
			s = ke();
			let e = o;
	...
	if (s == null) {
		let n = P({}, e);
		"__i18n" in i && (n.__i18n = i.__i18n), r && (n.__root = r), s = $r(n), o.__composerExtend && (s[Rr] = o.__composerExtend(s)), Hi(o, t, s), o.__setInstance(t, s);
	} else process.env.NODE_ENV !== "production" && a === "local" && O(Br($.DUPLICATE_USE_I18N_CALLING));
	return s;
}
function Ii(e, t) {
	let n = c(), r = n.run(() => $r(e));
...
function Li(e) {
	let t = f(e.isCE ? Ni : e.appContext.app.__VUE_I18N_SYMBOL__);
...
function Hi(e, t, n) {
	...
	h(() => {
		if (process.env.NODE_ENV !== "production") {
			t.__VUE_I18N__ = n, r = ke();
			let e = n;
			e[Pr] && e[Pr](r), r.on("*", yi);
		}
	}, t), _(() => {
		let i = n;
		process.env.NODE_ENV !== "production" && (r && r.off("*", yi), i[Fr] && i[Fr](), delete t.__VUE_I18N__), e.__deleteInstance(t);
		let a = i[Rr];
		a && (a(), delete i[Rr]);
	}, t);
}
...
var Ki = s({
	...
	setup(e, t) {
		...
		return Ei(e, t, qn, (...e) => n[Mr](...e));
	}
});
if (wn(Wt), En(gn), On(nn), process.env.NODE_ENV !== "production") {
	let e = _e();
...
var Ji = s({
			...
			results: r(() => [
				{
					...
					size: "42.3 kB",
					time: "0.12ms",
					lazy: n("home.resultsTable.yes")
				},
				{
					lib: "react-intl",
					size: "38.1 kB",
					time: "0.15ms",
					lazy: n("home.resultsTable.manual")
				},
				{
					lib: "lingui",
					size: "12.8 kB",
				...
				},
				{
					...
					size: "5.2 kB",
					time: "0.05ms",
					lazy: n("home.resultsTable.builtIn")
				}
			])
		};
	...
	return n;
}, Xi = { class: "mb-6 text-2xl font-bold text-foreground" }, Zi = { class: "overflow-x-auto rounded-lg border border-border" }, Qi = { class: "w-full text-sm" }, $i = { class: "bg-muted" }, ea = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, ta = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, na = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, ra = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, ia = { class: "px-4 py-3 font-medium text-foreground" }, aa = { class: "px-4 py-3 text-muted-foreground" }, oa = { class: "px-4 py-3 text-muted-foreground" }, sa = { class: "px-4 py-3 text-muted-foreground" };
function ca(e, n, r, o, s, c) {
	return v(), i("section", null, [a("h2", Xi, C(o.t("home.resultsTable.title")), 1), a("div", Zi, [a("table", Qi, [a("thead", $i, [a("tr", null, [
		a("th", ea, C(o.t("home.resultsTable.library")), 1),
		a("th", ta, C(o.t("home.resultsTable.bundleSize")), 1),
		a("th", na, C(o.t("home.resultsTable.lookupTime")), 1),
		a("th", ra, C(o.t("home.resultsTable.lazyLoading")), 1)
	])]), a("tbody", null, [(v(!0), i(t, null, b(o.results, (e) => (v(), i("tr", {
		key: e.lib,
...
var la = Yi(Ji, [["render", ca], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/home/ResultsTable.vue"]]), ua = Pi({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
	...
	setup(e, { expose: t }) {
		...
		n && !n.config.globalProperties.$i18n && n.use(ua);
		let r = { app: n };
...
var pa = Yi(da, [["render", fa], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/scripts/Wrapper.vue"]]), ma = { render() {
	return d(pa, {}, { default: () => d(la) });
} };
