...
import { Fragment as t, Text as n, computed as r, createElementBlock as i, createElementVNode as a, createVNode as o, defineComponent as s, effectScope as c, getCurrentInstance as l, getCurrentScope as u, h as d, inject as f, isRef as p, onBeforeMount as m, onMounted as h, onScopeDispose as g, onUnmounted as _, openBlock as v, ref as y, renderList as b, renderSlot as x, shallowRef as S, toDisplayString as C, unref as w, watch as T } from "vue";
function E(e, t) {
...
function Gr(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = k ? y : S, s = !B(e.inheritLocale) || e.inheritLocale, c = o(t && s ? t.locale.value : z(e.locale) ? e.locale : fn), l = o(t && s ? t.fallbackLocale.value : z(e.fallbackLocale) || L(e.fallbackLocale) || H(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(Pr(c.value, e)), d = o(H(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(H(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : B(e.missingWarn) || oe(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : B(e.fallbackWarn) || oe(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : !B(e.fallbackRoot) || e.fallbackRoot, g = !!e.fallbackFormat, _ = R(e.missing) ? e.missing : null, v = R(e.missing) ? Ur(e.missing) : null, b = R(e.postTranslation) ? e.postTranslation : null, x = t ? t.warnHtmlMessage : !B(e.warnHtmlMessage) || e.warnHtmlMessage, C = !!e.escapeParameter, w = t ? t.modifiers : H(e.modifiers) ? e.modifiers : {}, D = e.pluralRules || t && t.pluralRules, O;
	O = (() => {
		i && Tn(null);
		let t = {
			version: xr,
...
function Oi(e, t) {
	let n = c(), r = n.run(() => Gr(e));
	if (r == null) throw Q(Z.UNEXPECTED_ERROR);
	return [n, r];
}
function ki(e) {
	let t = f(e.isCE ? Ti : e.appContext.app.__VUE_I18N_SYMBOL__);
...
var Bi = { class: "mb-6 text-2xl font-bold text-foreground" }, Vi = { class: "overflow-x-auto rounded-lg border border-border" }, Hi = { class: "w-full text-sm" }, Ui = { class: "bg-muted" }, Wi = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, Gi = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, Ki = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, qi = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, Ji = { class: "px-4 py-3 font-medium text-foreground" }, Yi = { class: "px-4 py-3 text-muted-foreground" }, Xi = { class: "px-4 py-3 text-muted-foreground" }, Zi = { class: "px-4 py-3 text-muted-foreground" }, Qi = s({
	__name: "ResultsTable",
	setup(e) {
		zi("ResultsTable");
		let { t: n } = Di(), o = r(() => [
		...
		return (e, r) => (v(), i("section", null, [a("h2", Bi, C(w(n)("home.resultsTable.title")), 1), a("div", Vi, [a("table", Hi, [a("thead", Ui, [a("tr", null, [
			a("th", Wi, C(w(n)("home.resultsTable.library")), 1),
			a("th", Gi, C(w(n)("home.resultsTable.bundleSize")), 1),
			a("th", Ki, C(w(n)("home.resultsTable.lookupTime")), 1),
			a("th", qi, C(w(n)("home.resultsTable.lazyLoading")), 1)
		])]), a("tbody", null, [(v(!0), i(t, null, b(o.value, (e) => (v(), i("tr", {
			key: e.lib,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use($i), (e, t) => x(e.$slots, "default");
	}
}), ta = { render() {
	return d(ea, {}, { default: () => d(Qi) });
} };
