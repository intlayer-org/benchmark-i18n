...
process.env.NODE_ENV;
var Li = { class: "flex justify-end gap-3" }, Ri = {
	type: "button",
	...
	setup(e) {
		let { t } = Ti();
		return (e, n) => (_(), i("div", Li, [a("button", Ri, x(S(t)("settings.footer.cancel")), 1), a("button", zi, x(S(t)("settings.footer.saveChanges")), 1)]));
	}
}), Vi = wi({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Vi), (e, t) => y(e.$slots, "default");
	}
}), Ui = { render() {
	return d(Hi, {}, { default: () => d(Bi) });
} };
