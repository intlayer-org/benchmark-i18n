...
}), zi = { class: "mb-2 text-3xl font-bold text-foreground" }, Bi = { class: "mb-8 text-muted-foreground" }, Vi = s({
	__name: "SettingsHeader",
	setup(e) {
		let { t: n } = Ti();
		return (e, r) => (_(), i(t, null, [
			o(Ri),
			a("h1", zi, x(S(n)("settings.header.title")), 1),
			a("p", Bi, x(S(n)("settings.header.description")), 1)
		], 64));
	}
}), Hi = wi({
	legacy: !1,
