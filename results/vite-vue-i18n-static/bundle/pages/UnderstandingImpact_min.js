...
function $r(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = k ? b : S, s = B(e.inheritLocale) ? e.inheritLocale : !0, c = o(t && s ? t.locale.value : z(e.locale) ? e.locale : bn), l = o(t && s ? t.fallbackLocale.value : z(e.fallbackLocale) || L(e.fallbackLocale) || H(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(Hr(c.value, e)), d = o(H(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(H(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : B(e.missingWarn) || pe(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : B(e.fallbackWarn) || pe(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : B(e.fallbackRoot) ? e.fallbackRoot : !0, g = !!e.fallbackFormat, _ = R(e.missing) ? e.missing : null, v = R(e.missing) ? Zr(e.missing) : null, y = R(e.postTranslation) ? e.postTranslation : null, x = t ? t.warnHtmlMessage : B(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, C = !!e.escapeParameter, T = t ? t.modifiers : H(e.modifiers) ? e.modifiers : {}, ee = e.pluralRules || t && t.pluralRules, E;
	E = (() => {
		i && Nn(null);
		let t = {
			version: kr,
...
var wi = c({
	...
	setup(e, t) {
		...
		return () => {
			...
			return f(z(e.tag) || V(e.tag) ? e.tag : Ci(), l, c);
		};
	}
});
function Ti(e) {
...
function Li(e) {
	let t = p(e.isCE ? Ni : e.appContext.app.__VUE_I18N_SYMBOL__);
...
var Ji = c({
	...
	return n;
}, Xi = { class: "mb-16 mx-auto max-w-3xl space-y-6" }, Zi = { class: "text-2xl font-bold text-foreground" }, Qi = { class: "rounded-lg border border-border bg-card p-6" }, $i = { class: "mb-2 text-lg font-semibold text-foreground" }, ea = { class: "text-sm text-muted-foreground" }, ta = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, na = { class: "rounded-lg border border-border bg-card p-6" }, ra = { class: "mb-2 text-lg font-semibold text-foreground" }, ia = { class: "text-sm text-muted-foreground" }, aa = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, oa = { class: "text-foreground" }, sa = { class: "text-foreground" }, ca = { class: "text-foreground" }, la = { class: "rounded-lg border border-border bg-card p-6" }, ua = { class: "mb-2 text-lg font-semibold text-foreground" }, da = { class: "text-sm text-muted-foreground" };
function fa(e, t, n, r, s, c) {
	return y(), i("section", Xi, [
		a("h2", Zi, C(r.t("home.understandingImpact.title")), 1),
		a("div", Qi, [
			a("h3", $i, C(r.t("home.understandingImpact.singleJsonTitle")), 1),
			a("p", ea, C(r.t("home.understandingImpact.singleJsonIntro")), 1),
			a("ul", ta, [
				a("li", null, C(r.t("home.understandingImpact.singleJsonBullet1")), 1),
				a("li", null, C(r.t("home.understandingImpact.singleJsonBullet2")), 1),
				a("li", null, C(r.t("home.understandingImpact.singleJsonBullet3")), 1)
			])
		]),
		a("div", na, [
			a("h3", ra, C(r.t("home.understandingImpact.tradeOffsTitle")), 1),
			a("p", ia, C(r.t("home.understandingImpact.tradeOffsIntro")), 1),
			a("ul", aa, [
				a("li", null, [a("strong", oa, C(r.t("home.understandingImpact.waterfallLabel")), 1), o(" " + C(r.t("home.understandingImpact.waterfallDesc")), 1)]),
				a("li", null, [a("strong", sa, C(r.t("home.understandingImpact.foucLabel")), 1), o(" " + C(r.t("home.understandingImpact.foucDesc")), 1)]),
				a("li", null, [a("strong", ca, C(r.t("home.understandingImpact.cacheLabel")), 1), o(" " + C(r.t("home.understandingImpact.cacheDesc")), 1)])
			])
		]),
		a("div", la, [a("h3", ua, C(r.t("home.understandingImpact.measuresTitle")), 1), a("p", da, C(r.t("home.understandingImpact.measuresDesc")), 1)])
	]);
}
var pa = Yi(Ji, [["render", fa], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/home/UnderstandingImpact.vue"]]), ma = Pi({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
	...
	setup(e, { expose: t }) {
		...
		n && !n.config.globalProperties.$i18n && n.use(ma);
		let r = { app: n };
		return Object.defineProperty(r, "__isScriptSetup", {
			enumerable: !1,
			value: !0
...
var _a = Yi(ha, [["render", ga], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/scripts/Wrapper.vue"]]), va = { render() {
	return f(_a, {}, { default: () => f(pa) });
} };
