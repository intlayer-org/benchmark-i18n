...
var Li = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, Ri = s({
	...
	setup(e) {
		return (e, n) => (_(), i(t, null, [o(Ri), n[0] ||= a("div", { class: "mb-12 text-center" }, [a("h1", { class: "mb-3 text-3xl font-bold text-foreground" }, " Simple, Transparent Pricing "), a("p", { class: "text-muted-foreground" }, " Choose the plan that fits your team. No hidden fees. ")], -1)], 64));
	}
}), Bi = wi({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Bi), (e, t) => y(e.$slots, "default");
	}
}), Hi = { render() {
	return d(Vi, {}, { default: () => d(zi) });
} };
