...
import { Fragment as t, Text as n, computed as r, createElementBlock as i, createElementVNode as a, createTextVNode as o, createVNode as s, defineComponent as c, effectScope as l, getCurrentInstance as u, getCurrentScope as d, h as f, inject as p, isRef as m, normalizeClass as h, onMounted as g, onScopeDispose as _, onUnmounted as v, openBlock as y, ref as b, renderList as x, renderSlot as S, shallowRef as C, toDisplayString as w, watch as ee } from "vue";
...
var ce = c({
	...
	return n;
}, ue = { class: "grid gap-6 md:grid-cols-3" }, de = { class: "text-lg font-semibold text-foreground" }, fe = { class: "my-4" }, pe = { class: "text-3xl font-bold text-foreground" }, me = { class: "text-sm text-muted-foreground" }, he = { class: "mb-6 flex-1 space-y-2" };
function ge(e, n, r, s, c, l) {
	return y(), i("div", ue, [(y(), i(t, null, x(s.tiers, (e) => a("div", {
		key: e.name,
		class: h(["flex flex-col rounded-lg border p-6", e.highlighted ? "border-primary bg-primary/5 ring-1 ring-primary" : "border-border bg-card"])
	}, [
		a("h3", de, w(e.name), 1),
		a("div", fe, [a("span", pe, w(e.price), 1), a("span", me, w(e.period), 1)]),
		a("ul", he, [(y(!0), i(t, null, x(e.features, (e) => (y(), i("li", {
			key: e,
			class: "flex items-center gap-2 text-sm text-muted-foreground"
		}, [n[0] ||= a("span", { class: "text-primary" }, "✓", -1), o(" " + w(e), 1)]))), 128))]),
		a("button", {
			type: "button",
			class: h(["w-full rounded-md px-4 py-2 text-sm font-medium transition-opacity hover:opacity-90", e.highlighted ? "bg-primary text-primary-foreground" : "border border-border text-foreground hover:bg-accent"])
		}, w(e.name === "Enterprise" ? "Contact Sales" : "Get Started"), 3)
	], 2)), 64))]);
}
var _e = le(ce, [["render", ge], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/pricing/PricingTiers.vue"]]);
function D(e, t) {
...
var be = /\{([0-9a-zA-Z]+)\}/g;
function xe(e, ...t) {
	return t.length === 1 && V(t[0]) && (t = t[0]), (!t || !t.hasOwnProperty) && (t = {}), e.replace(be, (e, n) => t.hasOwnProperty(n) ? t[n] : "");
}
var j = (e, t = !1) => t ? Symbol.for(e) : Symbol(e), Se = (e, t, n) => Ce({
	l: e,
	k: t,
	s: n
}), Ce = (e) => JSON.stringify(e).replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029").replace(/\u0027/g, "\\u0027"), M = (e) => typeof e == "number" && isFinite(e), we = (e) => Fe(e) === "[object Date]", Te = (e) => Fe(e) === "[object RegExp]", Ee = (e) => H(e) && Object.keys(e).length === 0, N = Object.assign, De = Object.create, P = (e = null) => De(e), Oe, ke = () => Oe ||= typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : P();
function Ae(e) {
...
function F(e) {
	return e = e.replace(/(\w+)\s*=\s*"([^"]*)"/g, (e, t, n) => `${t}="${je(n)}"`), e = e.replace(/(\w+)\s*=\s*'([^']*)'/g, (e, t, n) => `${t}='${je(n)}'`), /\s*on\w+\s*=\s*["']?[^"'>]+["']?/gi.test(e) && (process.env.NODE_ENV !== "production" && D("Potentially dangerous event handlers detected in translation. Consider removing onclick, onerror, etc. from your translation messages."), e = e.replace(/(\s+)(on)(\w+\s*=)/gi, "$1&#111;n$3")), [/(\s+(?:href|src|action|formaction)\s*=\s*["']?)\s*javascript:/gi, /(style\s*=\s*["'][^"']*url\s*\(\s*)javascript:/gi].forEach((t) => {
...
var L = Array.isArray, R = (e) => typeof e == "function", z = (e) => typeof e == "string", B = (e) => typeof e == "boolean", V = (e) => typeof e == "object" && !!e, Ne = (e) => V(e) && R(e.then) && R(e.catch), Pe = Object.prototype.toString, Fe = (e) => Pe.call(e), H = (e) => Fe(e) === "[object Object]", Ie = (e) => e == null ? "" : L(e) || H(e) && e.toString === Pe ? JSON.stringify(e, null, 2) : String(e);
function Le(e, t = "") {
	return e.reduce((e, n, r) => r === 0 ? e + n : e + t + n, "");
}
var Re = 2;
function ze(e, t = 0, n = e.length) {
	let r = e.split(/\r?\n/), i = 0, a = [];
	for (let e = 0; e < r.length; e++) if (i += r[e].length + 1, i >= t) {
		for (let o = e - Re; o <= e + Re || n > i; o++) {
...
var Ve = (e) => !V(e) || L(e);
function He(e, t) {
	if (Ve(e) || Ve(t)) throw Error("Invalid value");
	let n = [{
		src: e,
		des: t
	}];
	for (; n.length;) {
		...
		Object.keys(e).forEach((r) => {
			r !== "__proto__" && (V(e[r]) && !V(t[r]) && (t[r] = Array.isArray(e[r]) ? [] : P()), Ve(t[r]) || Ve(e[r]) ? t[r] = e[r] : n.push({
				src: e[r],
				des: t[r]
			}));
		});
...
function Ke(e, t, n = {}) {
	let { domain: r, messages: i, args: a } = n, o = process.env.NODE_ENV === "production" ? e : xe((i || Ge)[e] || "", ...a || []), s = SyntaxError(String(o));
	return s.code = e, t && (s.location = t), s.domain = r, s;
}
function qe(e) {
	throw e;
}
var Je = /<\/?[\w\s="/.':;#-\/]+>/, Ye = (e) => Je.test(e), W = " ", Xe = "\r", G = "\n", Ze = "\u2028", Qe = "\u2029";
function $e(e) {
	let t = e, n = 0, r = 1, i = 1, a = 0, o = (e) => t[e] === Xe && t[e + 1] === G, s = (e) => t[e] === G, c = (e) => t[e] === Qe, l = (e) => t[e] === Ze, u = (e) => o(e) || s(e) || c(e) || l(e), d = () => n, f = () => r, p = () => i, m = () => a, h = (e) => o(e) || c(e) || l(e) ? G : t[e], g = () => h(n), _ = () => h(n + a);
	function v() {
...
var et = void 0, tt = "'", nt = "tokenizer";
function rt(e, t = {}) {
	let n = t.location !== !1, r = $e(e), i = () => r.index(), a = () => Ue(r.line(), r.column(), r.index()), o = a(), s = i(), c = {
		currentType: 13,
		offset: s,
		startLoc: o,
		endLoc: o,
	...
	function d(e, t, r, ...i) {
		let a = l();
		t.column += r, t.offset += r, u && u(Ke(e, n ? We(a.startLoc, t) : null, {
			domain: nt,
			args: i
		}));
	}
	...
	function E(e, t) {
		let n = e.currentChar();
		return n === et ? et : t(n) ? (e.next(), n) : null;
	}
	function ne(e) {
		let t = e.charCodeAt(0);
	...
	function fe(e) {
		...
		for (; t = ae(e);) n += t;
		let r = e.currentChar();
		if (r && r !== "}" && r !== et && r !== W && r !== G && r !== "　") {
			let t = ve(e);
			return d(U.INVALID_TOKEN_IN_PLACEHOLDER, a(), 0, n + t), n + t;
		}
		return e.currentChar() === et && d(U.UNTERMINATED_CLOSING_BRACE, a(), 0), n;
	}
	function pe(e) {
		g(e);
		let t = "";
		return e.currentChar() === "-" ? (e.next(), t += `-${ue(e)}`) : t += ue(e), e.currentChar() === et && d(U.UNTERMINATED_CLOSING_BRACE, a(), 0), t;
	}
	function me(e) {
		return e !== tt && e !== G;
	}
	function he(e) {
		...
		let r = e.currentChar();
		return r === G || r === et ? (d(U.UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER, a(), 0), r === G && (e.next(), m(e, "'")), n) : (m(e, "'"), n);
	}
	function ge(e) {
		let t = e.currentChar();
		switch (t) {
			...
			case "u": return _e(e, t, 4);
			case "U": return _e(e, t, 6);
	...
	function A(e, t) {
		...
		switch (e.currentChar()) {
			...
			default: {
				let r = !0, i = !0, o = !0;
				if (te(e)) return t.braceNest > 0 && d(U.UNTERMINATED_CLOSING_BRACE, a(), 0), n = f(t, 1, k(e)), t.braceNest = 0, t.inLinked = !1, n;
				if (t.braceNest > 0 && (t.currentType === 4 || t.currentType === 5 || t.currentType === 6)) return d(U.UNTERMINATED_CLOSING_BRACE, a(), 0), t.braceNest = 0, xe(e, t);
	...
	function be(e, t) {
		...
		switch ((n === 7 || n === 8 || n === 11 || n === 9) && (i === G || i === W) && d(U.INVALID_LINKED_FORMAT, a(), 0), i) {
			...
			default: return te(e) ? (r = f(t, 1, k(e)), t.braceNest = 0, t.inLinked = !1, r) : S(e, t) || w(e, t) ? (g(e), be(e, t)) : C(e, t) ? (g(e), f(t, 11, ye(e))) : ee(e, t) ? (g(e), i === "{" ? A(e, t) || r : f(t, 10, O(e))) : (n === 7 && d(U.INVALID_LINKED_FORMAT, a(), 0), t.braceNest = 0, t.inLinked = !1, xe(e, t));
		}
	}
	function xe(e, t) {
		let n = { type: 13 };
		if (t.braceNest > 0) return A(e, t) || p(t);
		if (t.inLinked) return be(e, t) || p(t);
		switch (e.currentChar()) {
			case "{": return A(e, t) || p(t);
			case "}": return d(U.UNBALANCED_CLOSING_BRACE, a(), 0), e.next(), f(t, 3, "}");
			case "@": return be(e, t) || p(t);
			default:
				if (te(e)) return n = f(t, 1, k(e)), t.braceNest = 0, t.inLinked = !1, n;
	...
	function j() {
		...
		return c.lastType = e, c.lastOffset = t, c.lastStartLoc = n, c.lastEndLoc = o, c.offset = i(), c.startLoc = a(), r.currentChar() === et ? f(c, 13) : xe(r, c);
	}
	return {
		nextToken: j,
		currentOffset: i,
...
var it = "parser", at = /(?:\\\\|\\'|\\u([0-9a-fA-F]{4})|\\U([0-9a-fA-F]{6}))/g, ot = /\\([\\@{}|])/g;
function st(e, t) {
	return t;
}
function ct(e, t, n) {
...
function lt(e = {}) {
	...
	function r(e, r, i, a, ...o) {
		...
		s.offset += a, s.column += a, n && n(Ke(r, t ? We(i, s) : null, {
			domain: it,
			args: o
		}));
	}
	...
	function o(e, t) {
		...
		return r.value = t.replace(ot, st), a(r, e.currentOffset(), e.currentPosition()), r;
	}
	function s(e, t) {
	...
	function l(e, t) {
		...
		return o.value = t.replace(at, ct), e.nextToken(), a(o, e.currentOffset(), e.currentPosition()), o;
	}
	function u(e) {
	...
	function g(n) {
		let o = rt(n, N({}, e)), s = o.context(), c = i(0, s.offset, s.startLoc);
...
function ft(e, t) {
	switch (e.type) {
		...
		case 2:
			...
			break;
		case 6:
			ft(e.key, t), t.helper("linked"), t.helper("type");
			break;
		case 5:
...
function pt(e, t = {}) {
	let n = ut(e);
	n.helper("normalize"), e.body && ft(e.body, n);
	let r = n.context();
	e.helpers = Array.from(r.helpers);
}
function mt(e) {
	let t = e.body;
	return t.type === 2 ? ht(t) : t.cases.forEach((e) => ht(e)), e;
}
function ht(e) {
	if (e.items.length === 1) {
		let t = e.items[0];
...
function _t(e) {
	switch (e.t = e.type, e.type) {
		...
		case 1: {
			let t = e, n = t.cases;
			for (let e = 0; e < n.length; e++) _t(n[e]);
		...
		default: if (process.env.NODE_ENV !== "production") throw Ke(U.UNHANDLED_MINIFIER_NODE_TYPE, null, {
			domain: gt,
			args: [e.type]
		});
	}
...
function bt(e, t) {
	let { helper: n } = e;
	e.push(`${n("linked")}(`), wt(e, t.key), t.modifier ? (e.push(", "), wt(e, t.modifier), e.push(", _type")) : e.push(", undefined, _type"), e.push(")");
}
function xt(e, t) {
	let { helper: n, needIndent: r } = e;
	e.push(`${n("normalize")}([`), e.indent(r());
	let i = t.items.length;
	for (let n = 0; n < i && (wt(e, t.items[n]), n !== i - 1); n++) e.push(", ");
	e.deindent(r()), e.push("])");
}
function St(e, t) {
	let { helper: n, needIndent: r } = e;
	if (t.cases.length > 1) {
		...
		for (let n = 0; n < i && (wt(e, t.cases[n]), n !== i - 1); n++) e.push(", ");
		e.deindent(r()), e.push("])");
	}
}
function Ct(e, t) {
...
function wt(e, t) {
	...
	switch (t.type) {
		...
		case 3:
			e.push(JSON.stringify(t.value), t);
			break;
		default: if (process.env.NODE_ENV !== "production") throw Ke(U.UNHANDLED_CODEGEN_NODE_TYPE, null, {
			domain: vt,
			args: [t.type]
		});
	}
...
var Tt = (e, t = {}) => {
	...
	c.push(n === "normal" ? "function __msg__ (ctx) {" : "(ctx) => {"), c.indent(o), s.length > 0 && (c.push(`const { ${Le(s.map((e) => `${e}: _${e}`), ", ")} } = ctx`), c.newline()), c.push("return "), wt(c, e), c.deindent(o), c.push("}"), delete e.helpers;
...
function Et(e, t = {}) {
	let n = N({}, t), r = !!n.jit, i = !!n.minify, a = n.optimize == null ? !0 : n.optimize, o = lt(n).parse(e);
	return r ? (a && mt(o), i && _t(o), {
		ast: o,
		code: ""
	}) : (pt(o, n), Tt(o, n));
}
function q(e) {
	return V(e) && It(e) === 0 && (I(e, "b") || I(e, "body"));
}
var Dt = ["b", "body"];
function Ot(e) {
	return Ut(e, Dt);
...
function qt(e, t) {
	...
	if (It(n) === 1) {
		let t = At(n);
		return e.plural(t.reduce((t, n) => [...t, Jt(e, n)], []));
	} else return Jt(e, n);
}
function Jt(e, t) {
	let n = Mt(t);
	...
	{
		let n = Pt(t).reduce((t, n) => [...t, Yt(e, n)], []);
...
function Yt(e, t) {
	let n = It(t);
	switch (n) {
		case 3: return Rt(t, n);
		case 9: return Rt(t, n);
		case 4: {
			let r = t;
		...
		case 6: {
			let n = t, r = Bt(n), i = Ht(n);
			return e.linked(Yt(e, i), r ? Yt(e, r) : void 0, e.type);
		}
		case 7: return Rt(t, n);
		case 8: return Rt(t, n);
...
function Zt(e, t) {
	t && Ye(e) && D(xe(Xt, { source: e }));
}
var Qt = (e) => e, $t = P();
function en(e, t = {}) {
	let n = !1, r = t.onError || qe;
	return t.onError = (e) => {
		n = !0, r(e);
	}, {
		...Et(e, t),
...
function tn(e, t) {
	if (z(e)) {
		...
		let r = (t.onCacheKey || Qt)(e), i = $t[r];
		if (i) return i;
		let { ast: a, detectError: o } = en(e, {
			...t,
...
function cn(e) {
	return Ke(e, null, process.env.NODE_ENV === "production" ? void 0 : { messages: ln });
}
var ln = {
...
function un(e, t) {
	return t.locale == null ? fn(e.locale) : fn(t.locale);
}
var dn;
function fn(e) {
	if (z(e)) return e;
	if (R(e)) {
		if (e.resolvedOnce && dn != null) return dn;
		if (e.constructor.name === "Function") {
			let t = e();
			if (Ne(t)) throw cn(J.NOT_SUPPORT_LOCALE_PROMISE_VALUE);
			return dn = t;
		} else throw cn(J.NOT_SUPPORT_LOCALE_ASYNC_FUNCTION);
	} else throw cn(J.NOT_SUPPORT_LOCALE_TYPE);
}
function pn(e, t, n) {
...
function mn(e, t, n) {
	...
	if (!a) {
		...
		e = z(o) ? [o] : o, L(e) && hn(a, e, !1), i.__localeChainCache.set(r, a);
	}
	return a;
}
function hn(e, t, n) {
...
function Cn(e) {
	let t = e.trim();
	return e.charAt(0) === "0" && isNaN(parseInt(e)) ? !1 : bn(t) ? xn(t) : "*" + t;
}
function wn(e) {
	...
	for (; r !== null;) if (n++, a = e[n], !(a === "\\" && p())) {
		if (c = Sn(a), d = vn[r], l = d[c] || d.l || 8, l === 8 || (r = l[0], l[1] !== void 0 && (u = f[l[1]], u && (s = a, u() === !1)))) return;
		if (r === 7) return t;
	}
}
...
function Dn(e, t) {
	if (!V(e)) return null;
	let n = Tn.get(t);
	if (n || (n = wn(t), n && Tn.set(t, n)), !n) return null;
	let r = n.length, i = e, a = 0;
	for (; a < r;) {
		let e = n[a];
		if (Wt.includes(e) && q(i) || !V(i) || !I(i, e)) return null;
		let t = i[e];
...
var An = "11.4.0", jn = "en-US", Mn = (e) => `${e.charAt(0).toLocaleUpperCase()}${e.substr(1)}`;
function Nn() {
	return {
		...
		capitalize: (e, t) => t === "text" && z(e) ? Mn(e) : t === "vnode" && V(e) && "__v_isVNode" in e ? Mn(e.children) : e
	};
}
var Pn;
function Fn(e) {
...
function qn(e = {}) {
	let t = R(e.onWarn) ? e.onWarn : D, n = z(e.version) ? e.version : An, r = z(e.locale) || R(e.locale) ? e.locale : jn, i = R(r) ? jn : r, a = L(e.fallbackLocale) || H(e.fallbackLocale) || z(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : i, o = H(e.messages) ? e.messages : Jn(i), s = H(e.datetimeFormats) ? e.datetimeFormats : Jn(i), c = H(e.numberFormats) ? e.numberFormats : Jn(i), l = N(P(), e.modifiers, Nn()), u = e.pluralRules || P(), d = R(e.missing) ? e.missing : null, f = B(e.missingWarn) || Te(e.missingWarn) ? e.missingWarn : !0, p = B(e.fallbackWarn) || Te(e.fallbackWarn) ? e.fallbackWarn : !0, m = !!e.fallbackFormat, h = !!e.unresolving, g = R(e.postTranslation) ? e.postTranslation : null, _ = H(e.processor) ? e.processor : null, v = B(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, y = !!e.escapeParameter, b = R(e.messageCompiler) ? e.messageCompiler : Pn;
	process.env.NODE_ENV !== "production" && R(e.messageCompiler) && ye(kn(Y.EXPERIMENTAL_CUSTOM_MESSAGE_COMPILER));
	let x = R(e.messageResolver) ? e.messageResolver : In || En, S = R(e.localeFallbacker) ? e.localeFallbacker : Rn || pn, C = V(e.fallbackContext) ? e.fallbackContext : void 0, w = e, ee = V(w.__datetimeFormatters) ? w.__datetimeFormatters : /* @__PURE__ */ new Map(), te = V(w.__numberFormatters) ? w.__numberFormatters : /* @__PURE__ */ new Map(), T = V(w.__meta) ? w.__meta : {};
	Kn++;
	let E = {
		version: n,
		cid: Kn,
	...
	return E.datetimeFormats = s, E.numberFormats = c, E.__datetimeFormatters = ee, E.__numberFormatters = te, process.env.NODE_ENV !== "production" && (E.__v_emitter = w.__v_emitter == null ? void 0 : w.__v_emitter), process.env.NODE_ENV !== "production" && an(E, n, T), E;
}
var Jn = (e) => ({ [e]: P() });
function Yn(e, t) {
...
function Zn(e, t, n, r, i) {
	...
	if (a !== null) {
		let r = a(e, n, t, i);
		return z(r) ? r : t;
	} else return process.env.NODE_ENV !== "production" && Xn(r, t) && o(kn(Y.NOT_FOUND_KEY, {
		key: t,
		locale: n
	})), t;
}
...
function er(e, t) {
	let n = t.indexOf(e);
	if (n === -1) return !1;
	for (let r = n + 1; r < t.length; r++) if ($n(e, t[r])) return !0;
	return !1;
}
var tr = typeof Intl < "u", nr = {
	dateTimeFormat: tr && Intl.DateTimeFormat !== void 0,
	numberFormat: tr && Intl.NumberFormat !== void 0
};
function rr(e, ...t) {
	let { datetimeFormats: n, unresolving: r, fallbackLocale: i, onWarn: a, localeFallbacker: o } = e, { __datetimeFormatters: s } = e;
	if (process.env.NODE_ENV !== "production" && !nr.dateTimeFormat) return a(kn(Y.CANNOT_FORMAT_DATE)), "";
	if (!z(t[0]) && !we(t[0]) && !M(t[0])) return process.env.NODE_ENV !== "production" && a(kn(Y.INVALID_DATE_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = ar(...t), f = B(u.missingWarn) ? u.missingWarn : e.missingWarn, p = B(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = un(e, u), g = o(e, i, h);
	if (!z(c) || c === "") return new Intl.DateTimeFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "datetime format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && Yn(p, c) && a(kn(Y.FALLBACK_TO_DATE_FORMAT, {
			key: c,
			target: v
...
function ar(...e) {
	...
	if (z(t)) {
		...
		if (!e) throw cn(J.INVALID_ISO_DATE_ARGUMENT);
		let n = e[3] ? e[3].trim().startsWith("T") ? `${e[1].trim()}${e[3].trim()}` : `${e[1].trim()}T${e[3].trim()}` : e[1].trim();
		s = new Date(n);
		try {
			s.toISOString();
		} catch {
			throw cn(J.INVALID_ISO_DATE_ARGUMENT);
		}
	} else if (we(t)) {
		if (isNaN(t.getTime())) throw cn(J.INVALID_DATE_ARGUMENT);
		s = t;
	} else if (M(t)) s = t;
	else throw cn(J.INVALID_ARGUMENT);
...
function sr(e, ...t) {
	...
	if (process.env.NODE_ENV !== "production" && !nr.numberFormat) return a(kn(Y.CANNOT_FORMAT_NUMBER)), "";
	if (!M(t[0])) return process.env.NODE_ENV !== "production" && a(kn(Y.INVALID_NUMBER_ARGUMENT, { value: String(t[0]) })), "";
	let [c, l, u, d] = lr(...t), f = B(u.missingWarn) ? u.missingWarn : e.missingWarn, p = B(u.fallbackWarn) ? u.fallbackWarn : e.fallbackWarn, m = !!u.part, h = un(e, u), g = o(e, i, h);
	if (!z(c) || c === "") return new Intl.NumberFormat(h.replace(/!/g, ""), d).format(l);
	let _ = {}, v, y = null, b = h, x = null, S = "number format";
	for (let t = 0; t < g.length; t++) {
		if (v = x = g[t], process.env.NODE_ENV !== "production" && h !== v && Yn(p, c) && a(kn(Y.FALLBACK_TO_NUMBER_FORMAT, {
			key: c,
			target: v
		})), process.env.NODE_ENV !== "production" && h !== v) {
			let t = e.__v_emitter;
...
function lr(...e) {
	...
	if (!M(t)) throw cn(J.INVALID_ARGUMENT);
	let s = t;
	return z(n) ? a.key = n : H(n) && Object.keys(n).forEach((e) => {
...
var dr = (e) => e, fr = (e) => "", pr = "text", mr = (e) => e.length === 0 ? "" : Le(e), hr = Ie;
function gr(e, t) {
...
function vr(e = {}) {
	let t = e.locale, n = _r(e), r = z(t) && R(e.pluralRules?.[t]) ? e.pluralRules[t] : gr, i = r === gr ? void 0 : gr, a = (e) => e[r(n, e.length, i)], o = e.list || [], s = (e) => o[e], c = e.named || P();
	M(e.pluralIndex) && (c.count ||= e.pluralIndex, c.n ||= e.pluralIndex);
	let l = (e) => c[e];
	function u(t, n) {
		return (R(e.messages) ? e.messages(t, !!n) : V(e.messages) ? e.messages[t] : !1) || (e.parent ? e.parent.message(t) : fr);
	}
	let d = (t) => e.modifiers ? e.modifiers[t] : dr, f = R(e.processor?.normalize) ? e.processor.normalize : mr, p = R(e.processor?.interpolate) ? e.processor.interpolate : hr, m = {
		list: s,
		named: l,
		plural: a,
		linked: (e, ...t) => {
		...
		message: u,
		type: z(e.processor?.type) ? e.processor.type : pr,
		interpolate: p,
		normalize: f,
		values: N(P(), o, c)
	};
...
var yr = () => "", X = (e) => R(e);
function br(e, ...t) {
	let { fallbackFormat: n, postTranslation: r, unresolving: i, messageCompiler: a, fallbackLocale: o, messages: s } = e, [c, l] = Tr(...t), u = B(l.missingWarn) ? l.missingWarn : e.missingWarn, d = B(l.fallbackWarn) ? l.fallbackWarn : e.fallbackWarn, f = B(l.escapeParameter) ? l.escapeParameter : e.escapeParameter, p = !!l.resolvedMessage, m = z(l.default) || B(l.default) ? B(l.default) ? a ? c : () => c : l.default : n ? a ? c : () => c : null, h = n || m != null && (z(m) || R(m)), g = un(e, l);
	f && xr(l);
	let [_, v, y] = p ? [
		c,
		g,
	...
	if (S) return b;
	let w = wr(e, C, vr(Or(e, v, y, l))), ee = r ? r(w, c) : w;
	if (f && z(ee) && (ee = F(ee)), process.env.NODE_ENV !== "production") {
		let t = {
			timestamp: Date.now(),
			key: z(c) ? c : X(b) ? b.key : "",
		...
		t.meta = N({}, e.__meta, Hn() || {}), on(t);
	}
	return ee;
}
function xr(e) {
	L(e.list) ? e.list = e.list.map((e) => z(e) ? Ae(e) : e) : V(e.named) && Object.keys(e.named).forEach((t) => {
		z(e.named[t]) && (e.named[t] = Ae(e.named[t]));
	});
}
function Sr(e, t, n, r, i, a) {
	...
	for (let r = 0; r < u.length; r++) {
		f = h = u[r], process.env.NODE_ENV !== "production" && n !== f && !$n(n, f) && Yn(i, t) && s(kn(Y.FALLBACK_TO_TRANSLATE, {
			key: t,
			target: f
		}));
...
function Tr(...e) {
	let [t, n, r] = e, i = P();
	if (!z(t) && !M(t) && !X(t) && !q(t)) throw cn(J.INVALID_ARGUMENT);
	let a = M(t) ? String(t) : (X(t), t);
	return M(n) ? i.plural = n : z(n) ? i.default = n : H(n) && !Ee(n) ? i.named = n : L(n) && (i.list = n), M(r) ? i.plural = r : z(r) ? i.default = r : H(r) && N(i, r), [a, i];
}
	...
	return {
		...
		onError: (t) => {
			if (a && a(t), process.env.NODE_ENV !== "production") {
				let i = Dr(r), a = t.location && i && ze(i, t.location.start.offset, t.location.end.offset), o = e.__v_emitter;
...
var jr = typeof Proxy == "function", Mr = "devtools-plugin:setup", Nr = "plugin:settings:set", Pr, Fr;
function Ir() {
	return Pr === void 0 && (typeof window < "u" && window.performance ? (Pr = !0, Fr = window.performance) : typeof globalThis < "u" && globalThis.perf_hooks?.performance ? (Pr = !0, Fr = globalThis.perf_hooks.performance) : Pr = !1), Pr;
}
function Lr() {
	return Ir() ? Fr.now() : Date.now();
}
var Rr = class {
	constructor(e, t) {
...
function zr(e, t) {
	let n = e, r = Ar(), i = kr(), a = jr && n.enableEarlyProxy;
	if (i && (r.__VUE_DEVTOOLS_PLUGIN_API_AVAILABLE__ || !a)) i.emit(Mr, e, t);
	else {
		let e = a ? new Rr(n, i) : null;
...
function Q(e, ...t) {
	return Ke(e, null, process.env.NODE_ENV === "production" ? void 0 : {
		messages: Vr,
		args: t
	});
}
...
}, Hr = j("__translateVNode"), Ur = j("__datetimeParts"), Wr = j("__numberParts"), Gr = j("__enableEmitter"), Kr = j("__disableEmitter"), qr = j("__setPluralRules");
j("__intlifyMeta");
var Jr = j("__injectWithOption"), Yr = j("__dispose"), $ = {
	FALLBACK_TO_ROOT: 10,
...
function Qr(e) {
	if (!V(e) || q(e)) return e;
	for (let t in e) if (I(e, t)) if (!t.includes(".")) V(e[t]) && Qr(e[t]);
	else {
		let n = t.split("."), r = n.length - 1, i = e, a = !1;
		for (let e = 0; e < r; e++) {
			if (n[e] === "__proto__") throw Error(`unsafe key: ${n[e]}`);
			if (n[e] in i || (i[n[e]] = P()), !V(i[n[e]])) {
				process.env.NODE_ENV !== "production" && D(Zr($.IGNORE_OBJ_FLATTEN, { key: n[e] })), a = !0;
				break;
			}
			i = i[n[e]];
		}
...
function $r(e, t) {
	...
	if (L(r) && r.forEach((e) => {
		if ("locale" in e && "resource" in e) {
			...
			t ? (o[t] = o[t] || P(), He(n, o[t])) : He(n, o);
		} else z(e) && He(JSON.parse(e), o);
	}), i == null && a) for (let e in o) I(o, e) && Qr(o[e]);
	return o;
}
function ei(e) {
	return e.type;
...
function ti(e, t, n) {
	...
	"__i18nGlobal" in n && (r = $r(e.locale.value, {
		messages: r,
...
var ii = "__INTLIFY_META__", ai = () => [], oi = () => !1, si = 0;
function ci(e) {
	return ((t, n, r, i) => e(n, r, ri() || void 0, i));
}
var li = () => {
	let e = ri(), t = null;
	return e && (t = ei(e)[ii]) ? { [ii]: t } : null;
};
function ui(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = O ? b : C, s = B(e.inheritLocale) ? e.inheritLocale : !0, c = o(t && s ? t.locale.value : z(e.locale) ? e.locale : jn), l = o(t && s ? t.fallbackLocale.value : z(e.fallbackLocale) || L(e.fallbackLocale) || H(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o($r(c.value, e)), d = o(H(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(H(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : B(e.missingWarn) || Te(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : B(e.fallbackWarn) || Te(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : B(e.fallbackRoot) ? e.fallbackRoot : !0, g = !!e.fallbackFormat, _ = R(e.missing) ? e.missing : null, v = R(e.missing) ? ci(e.missing) : null, y = R(e.postTranslation) ? e.postTranslation : null, x = t ? t.warnHtmlMessage : B(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, S = !!e.escapeParameter, w = t ? t.modifiers : H(e.modifiers) ? e.modifiers : {}, te = e.pluralRules || t && t.pluralRules, T;
	T = (() => {
		i && Wn(null);
		let t = {
			version: Br,
	...
	let ne = r({
		...
		get: () => l.value,
		set: (e) => {
			T.fallbackLocale = e, l.value = e, Qn(T, c.value, e);
		}
	...
	let fe = (e, n, r, a, o, s) => {
		...
		let c;
		try {
			process.env.NODE_ENV !== "production" && Vn(li()), i || (T.fallbackContext = t ? Gn() : void 0), c = e(T);
		} finally {
			process.env.NODE_ENV !== "production" && Vn(null), i || (T.fallbackContext = void 0);
		}
		if (r !== "translate exists" && M(c) && c === -1 || r === "translate exists" && !c) {
			let [e, i] = n();
			if (process.env.NODE_ENV !== "production" && t && z(e) && de(r, i) && (h && (Yn(m, e) || Xn(p, e)) && D(Zr($.FALLBACK_TO_ROOT, {
				key: e,
				type: r
	...
	function pe(...e) {
		return fe((t) => Reflect.apply(br, null, [t, ...e]), () => Tr(...e), "translate", (t) => Reflect.apply(t.t, t, [...e]), (e) => e, (e) => z(e));
	}
	function me(...e) {
		let [t, n, r] = e;
	...
	function he(...e) {
		return fe((t) => Reflect.apply(rr, null, [t, ...e]), () => ar(...e), "datetime format", (t) => Reflect.apply(t.d, t, [...e]), () => "", (e) => z(e) || L(e));
	}
	function ge(...e) {
		return fe((t) => Reflect.apply(sr, null, [t, ...e]), () => lr(...e), "number format", (t) => Reflect.apply(t.n, t, [...e]), () => "", (e) => z(e) || L(e));
	}
	function _e(e) {
		return e.map((e) => z(e) || M(e) || B(e) ? ni(String(e)) : e);
	}
	let ve = {
		normalize: _e,
		interpolate: (e) => e,
	...
	function ye(...e) {
		return fe((t) => {
			let n, r = t;
			try {
				r.processor = ve, n = Reflect.apply(br, null, [r, ...e]);
			} finally {
				r.processor = null;
			}
			return n;
		}, () => Tr(...e), "translate", (t) => t[Hr](...e), (e) => [ni(e)], (e) => L(e));
	}
	function k(...e) {
		return fe((t) => Reflect.apply(sr, null, [t, ...e]), () => lr(...e), "number format", (t) => t[Wr](...e), ai, (e) => z(e) || L(e));
	}
	function A(...e) {
		return fe((t) => Reflect.apply(rr, null, [t, ...e]), () => ar(...e), "datetime format", (t) => t[Ur](...e), ai, (e) => z(e) || L(e));
	}
	function be(e) {
	...
	function xe(e, t) {
		return fe(() => {
			if (!e) return !1;
			let n = z(t) ? t : c.value, r = z(t) ? [n] : mn(T, l.value, n);
			for (let t = 0; t < r.length; t++) {
				let n = Ce(r[t]), i = T.messageResolver(n, e);
				if (i === null && (i = n[e]), q(i) || X(i) || z(i)) return !0;
			}
			return !1;
		}, () => [e], "translate exists", (n) => Reflect.apply(n.te, n, [e, t]), oi, (e) => B(e));
	}
	function j(e) {
		let t = null, n = mn(T, l.value, c.value);
	...
	function Ee(e, t) {
		u.value[e] = u.value[e] || {};
		let n = { [e]: t };
		if (a) for (let e in n) I(n, e) && Qr(n[e]);
		t = n[e], He(t, u.value[e]), T.messages = u.value;
	}
	function De(e) {
		return d.value[e] || {};
	}
	function P(e, t) {
		d.value[e] = t, T.datetimeFormats = d.value, or(T, e, t);
	}
	function Oe(e, t) {
		d.value[e] = N(d.value[e] || {}, t), T.datetimeFormats = d.value, or(T, e, t);
	}
	function ke(e) {
		return f.value[e] || {};
	}
	function Ae(e, t) {
		f.value[e] = t, T.numberFormats = f.value, ur(T, e, t);
	}
	function je(e, t) {
		f.value[e] = N(f.value[e] || {}, t), T.numberFormats = f.value, ur(T, e, t);
	}
	si++, t && O && (ee(t.locale, (e) => {
		s && (c.value = e, T.locale = e, Qn(T, c.value, l.value));
	}), ee(t.fallbackLocale, (e) => {
		s && (l.value = e, T.fallbackLocale = e, Qn(T, c.value, l.value));
	}));
	let F = {
		id: si,
		locale: ne,
		...
		set inheritLocale(e) {
			s = e, e && t && (c.value = t.locale.value, l.value = t.fallbackLocale.value, Qn(T, c.value, l.value));
		},
	...
	return F.datetimeFormats = ae, F.numberFormats = oe, F.rt = me, F.te = xe, F.tm = Se, F.d = he, F.n = ge, F.getDateTimeFormat = De, F.setDateTimeFormat = P, F.mergeDateTimeFormat = Oe, F.getNumberFormat = ke, F.setNumberFormat = Ae, F.mergeNumberFormat = je, F[Jr] = n, F[Hr] = ye, F[Ur] = A, F[Wr] = k, process.env.NODE_ENV !== "production" && (F[Gr] = (e) => {
		T.__v_emitter = e;
	}, F[Kr] = () => {
		T.__v_emitter = void 0;
	}), F;
}
var di = "vue-i18n: composer properties", fi = {
	"vue-devtools-plugin-vue-i18n": "Vue I18n DevTools",
	"vue-i18n-resource-inspector": "Vue I18n DevTools",
	"vue-i18n-timeline": "Vue I18n"
}, pi = { "vue-i18n-resource-inspector": "Search for scopes ..." }, mi = { "vue-i18n-timeline": 16764185 }, hi;
	...
	return new Promise((n, r) => {
		try {
			zr({
				...
				hi = r, r.on.visitComponentTree(({ componentInstance: e, treeNode: n }) => {
					vi(e, n, t);
				}), r.on.inspectComponent(({ componentInstance: e, instanceData: n }) => {
					e.__VUE_I18N__ && n && (t.mode === "legacy" ? e.__VUE_I18N__ !== t.global.__composer && yi(n, e.__VUE_I18N__) : yi(n, e.__VUE_I18N__));
				}), r.addInspector({
					...
					n.app === e && n.inspectorId === "vue-i18n-resource-inspector" && Ti(n, t);
				});
				let i = /* @__PURE__ */ new Map();
				r.on.getInspectorState(async (n) => {
					if (n.app === e && n.inspectorId === "vue-i18n-resource-inspector") if (r.unhighlightElement(), Oi(n, t), n.nodeId === "global") {
						if (!i.has(n.app)) {
					...
					n.app === e && n.inspectorId === "vue-i18n-resource-inspector" && ji(n, t);
				}), r.addTimelineLayer({
...
function bi(e) {
	...
	return Object.keys(e).forEach((n) => {
		let r = e[n];
		R(r) && "source" in r ? t[n] = wi(r) : q(r) && r.loc && r.loc.source ? t[n] = r.loc.source : V(r) ? t[n] = bi(r) : t[n] = r;
	}), t;
}
var xi = {
	"<": "&lt;",
...
function Ai(e, t) {
	if (hi) {
		let n;
		t && "groupId" in t && (n = t.groupId, delete t.groupId), hi.addTimelineEvent({
...
var Fi = c({
	...
	setup(e, t) {
		...
		return () => {
			...
			let s = Ni(t, a), c = i[Hr](e.keypath, s, o), l = N(P(), r);
			return f(z(e.tag) || V(e.tag) ? e.tag : Pi(), l, c);
		};
	}
});
function Ii(e) {
...
function Bi(e) {
	let t = (t) => {
		process.env.NODE_ENV !== "production" && ye(Zr($.DEPRECATE_TRANSLATE_CUSTOME_DIRECTIVE));
...
function Ui(e, t, ...n) {
	let r = H(n[0]) ? n[0] : {};
	(!B(r.globalInstall) || r.globalInstall) && ([Fi.name, "I18nT"].forEach((t) => e.component(t, Fi)), [Ri.name, "I18nN"].forEach((t) => e.component(t, Ri)), [ra.name, "I18nD"].forEach((t) => e.component(t, ra))), e.directive("t", Bi(t));
}
var Wi = j("global-vue-i18n");
function Gi(e = {}) {
	process.env.NODE_ENV;
	let t = B(e.globalInjection) ? e.globalInjection : !0, n = /* @__PURE__ */ new Map(), [r, i] = qi(e, !1), a = j(process.env.NODE_ENV === "production" ? "" : "vue-i18n");
	function o(e) {
		return n.get(e) || null;
	}
	function s(e, t) {
	...
	let l = {
		...
		async install(e, ...n) {
			...
			let r = null;
			t && (r = na(e, l.global)), Ui(e, l, ...n);
			let o = e.unmount;
			if (e.unmount = () => {
				r && r(), l.dispose(), o();
			}, process.env.NODE_ENV !== "production") {
				if (!await gi(e, l)) throw Q(Z.CANNOT_SETUP_VUE_DEVTOOLS_PLUGIN);
				let t = Be();
				{
					let e = i;
					e[Gr] && e[Gr](t);
...
function Ki(e = {}) {
	...
	let n = Ji(t), r = Xi(n), i = ei(t), a = Yi(e, i);
	if (a === "global") return ti(r, e, i), r;
	if (a === "parent") {
		let i = Zi(n, t, e.__useComponent);
		return i ??= (process.env.NODE_ENV !== "production" && D(Zr($.NOT_FOUND_PARENT_SCOPE)), r), i;
	}
	if (a === "isolated") {
	...
	if (s == null) {
		let n = N({}, e);
		"__i18n" in i && (n.__i18n = i.__i18n), r && (n.__root = r), s = ui(n), o.__composerExtend && (s[Yr] = o.__composerExtend(s)), $i(o, t, s), o.__setInstance(t, s);
	} else process.env.NODE_ENV !== "production" && a === "local" && D(Zr($.DUPLICATE_USE_I18N_CALLING));
	return s;
}
function qi(e, t) {
	let n = l(), r = n.run(() => ui(e));
...
function Yi(e, t) {
	return Ee(e) ? "__i18n" in t ? "local" : "global" : e.useScope ? e.useScope : "local";
}
function Xi(e) {
...
function $i(e, t, n) {
	...
	g(() => {
		...
		let i = n;
		process.env.NODE_ENV !== "production" && (r && r.off("*", Ai), i[Kr] && i[Kr](), delete t.__VUE_I18N__), e.__deleteInstance(t);
		let a = i[Yr];
		a && (a(), delete i[Yr]);
	}, t);
}
...
var ra = c({
	...
	setup(e, t) {
		...
		return Li(e, t, ir, (...e) => n[Ur](...e));
	}
});
if (Fn(tn), Ln(Dn), zn(mn), process.env.NODE_ENV !== "production") {
	let e = ke();
	e.__INTLIFY__ = !0, rn(e.__INTLIFY_DEVTOOLS_GLOBAL_HOOK__);
}
process.env.NODE_ENV;
var ia = Gi({
	legacy: !1,
...
var sa = le(aa, [["render", oa], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/scripts/Wrapper.vue"]]), ca = { render() {
	return f(sa, {}, { default: () => f(_e) });
} };
