...
var E = { class: "grid gap-6 md:grid-cols-3" }, D = { class: "text-lg font-semibold text-foreground" }, O = { class: "my-4" }, ee = { class: "text-3xl font-bold text-foreground" }, te = { class: "text-sm text-muted-foreground" }, ne = { class: "mb-6 flex-1 space-y-2" }, re = c({
	...
	setup(e) {
		...
		return (e, r) => (y(), i("div", E, [(y(), i(t, null, x(n, (e) => a("div", {
			key: e.name,
			...
			a("h3", D, w(e.name), 1),
			a("div", O, [a("span", ee, w(e.price), 1), a("span", te, w(e.period), 1)]),
			a("ul", ne, [(y(!0), i(t, null, x(e.features, (e) => (y(), i("li", {
				key: e,
				class: "flex items-center gap-2 text-sm text-muted-foreground"
			}, [r[0] ||= a("span", { class: "text-primary" }, "✓", -1), o(" " + w(e), 1)]))), 128))]),
			a("button", {
				type: "button",
...
function Qr(e = {}) {
	let { __root: t, __injectWithOption: n } = e, i = t === void 0, a = e.flatJson, o = A ? b : C, s = !B(e.inheritLocale) || e.inheritLocale, c = o(t && s ? t.locale.value : z(e.locale) ? e.locale : yn), l = o(t && s ? t.fallbackLocale.value : z(e.fallbackLocale) || L(e.fallbackLocale) || H(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value), u = o(Vr(c.value, e)), d = o(H(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), f = o(H(e.numberFormats) ? e.numberFormats : { [c.value]: {} }), p = t ? t.missingWarn : B(e.missingWarn) || fe(e.missingWarn) ? e.missingWarn : !0, m = t ? t.fallbackWarn : B(e.fallbackWarn) || fe(e.fallbackWarn) ? e.fallbackWarn : !0, h = t ? t.fallbackRoot : !B(e.fallbackRoot) || e.fallbackRoot, g = !!e.fallbackFormat, _ = R(e.missing) ? e.missing : null, v = R(e.missing) ? Xr(e.missing) : null, y = R(e.postTranslation) ? e.postTranslation : null, x = t ? t.warnHtmlMessage : !B(e.warnHtmlMessage) || e.warnHtmlMessage, S = !!e.escapeParameter, w = t ? t.modifiers : H(e.modifiers) ? e.modifiers : {}, E = e.pluralRules || t && t.pluralRules, D;
	D = (() => {
		i && Mn(null);
		let t = {
			version: Or,
...
var Ki = Ni({
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Ki), (e, t) => S(e.$slots, "default");
	}
}), Ji = { render() {
	return f(qi, {}, { default: () => f(re) });
} };
