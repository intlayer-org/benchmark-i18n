...
var ae = s({
	...
	return n;
}, se = { class: "grid gap-6 md:grid-cols-2 lg:grid-cols-3" }, ce = { class: "mb-2 text-lg font-semibold text-foreground" }, le = { class: "mb-4 text-sm text-muted-foreground" }, ue = { class: "flex items-center justify-between" }, de = { class: "text-sm font-bold text-primary" };
function fe(e, n, r, o, s, c) {
	return _(), i("div", se, [(_(), i(t, null, y(o.products, (e) => a("div", {
		key: e.name,
		class: "flex flex-col justify-between rounded-lg border border-border bg-card p-6"
	}, [a("div", null, [a("h3", ce, S(e.name), 1), a("p", le, S(e.desc), 1)]), a("div", ue, [a("span", de, S(e.price), 1), n[0] ||= a("button", {
		type: "button",
		class: "rounded-md bg-primary px-4 py-2 text-xs font-medium text-primary-foreground hover:opacity-90 transition-opacity"
	}, " Learn More ", -1)])])), 64))]);
}
var pe = oe(ae, [["render", fe], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/products/ProductsGrid.vue"]]);
function O(e, t) {
