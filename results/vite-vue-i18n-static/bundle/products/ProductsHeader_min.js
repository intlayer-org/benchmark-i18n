...
process.env.NODE_ENV;
var Li = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, Ri = s({
	__name: "MockBanner",
	setup(e) {
		let { t } = Ti();
		return (e, n) => (_(), i("div", Li, x(S(t)("mockBanner")), 1));
	}
}), zi = { class: "mb-2 text-3xl font-bold text-foreground" }, Bi = { class: "mb-10 text-muted-foreground" }, Vi = s({
	__name: "ProductsHeader",
	setup(e) {
		let { t: n } = Ti();
		return (e, r) => (_(), i(t, null, [
			o(Ri),
			a("h1", zi, x(S(n)("products.header.title")), 1),
			a("p", Bi, x(S(n)("products.header.description")), 1)
		], 64));
	}
}), Hi = wi({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Hi), (e, t) => y(e.$slots, "default");
	}
}), Wi = { render() {
	return d(Ui, {}, { default: () => d(Vi) });
} };
