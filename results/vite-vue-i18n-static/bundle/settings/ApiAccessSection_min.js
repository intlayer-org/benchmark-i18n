...
var Gi = s({
	...
	return n;
}, qi = { class: "rounded-lg border border-border bg-card p-6" }, Ji = { class: "mb-4 text-lg font-semibold text-foreground" }, Yi = {
	for: "api-key",
	class: "mb-1 block text-sm font-medium text-foreground"
}, Xi = { class: "flex gap-2" }, Zi = {
	type: "button",
	class: "rounded-md border border-border px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent"
}, Qi = { class: "mt-1 text-xs text-muted-foreground" };
function $i(e, t, n, r, o, s) {
	return _(), i("section", qi, [a("h2", Ji, x(r.t("settings.apiAccess.title")), 1), a("div", null, [
		a("label", Yi, x(r.t("settings.apiAccess.apiKey")), 1),
		a("div", Xi, [t[0] ||= a("input", {
			id: "api-key",
			readonly: "",
		...
		}, null, -1), a("button", Zi, x(r.t("settings.apiAccess.copy")), 1)]),
		a("p", Qi, x(r.t("settings.apiAccess.description")), 1)
	])]);
}
var ea = Ki(Gi, [["render", $i], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/settings/ApiAccessSection.vue"]]), ta = Mi({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
