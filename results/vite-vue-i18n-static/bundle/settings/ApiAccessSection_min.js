...
var Wr = { class: "rounded-lg border border-border bg-card p-6" }, Gr = { class: "mb-4 text-lg font-semibold text-foreground" }, Kr = {
	for: "api-key",
	class: "mb-1 block text-sm font-medium text-foreground"
}, qr = { class: "flex gap-2" }, Jr = {
	type: "button",
	class: "rounded-md border border-border px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent"
}, Yr = { class: "mt-1 text-xs text-muted-foreground" }, Xr = s({
	__name: "ApiAccessSection",
	setup(e) {
		let { t } = Lr();
		return (e, n) => (m(), i("section", Wr, [a("h2", Gr, _(v(t)("settings.apiAccess.title")), 1), a("div", null, [
			a("label", Kr, _(v(t)("settings.apiAccess.apiKey")), 1),
			a("div", qr, [n[0] ||= a("input", {
				id: "api-key",
				readonly: "",
			...
			}, null, -1), a("button", Jr, _(v(t)("settings.apiAccess.copy")), 1)]),
			a("p", Yr, _(v(t)("settings.apiAccess.description")), 1)
		])]));
	}
});
