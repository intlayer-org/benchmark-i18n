...
var Gi = s({
	...
	return n;
}, qi = { class: "rounded-lg border border-border bg-card p-6" }, Ji = { class: "mb-4 text-lg font-semibold text-foreground" }, Yi = { class: "space-y-4" }, Xi = { class: "flex items-center justify-between" }, Zi = { class: "text-sm font-medium text-foreground" }, Qi = { class: "text-xs text-muted-foreground" }, $i = ["aria-label"], ea = { class: "flex items-center justify-between" }, ta = { class: "text-sm font-medium text-foreground" }, na = { class: "text-xs text-muted-foreground" }, ra = ["aria-label"], ia = {
	for: "language",
...
function oa(e, t, n, r, o, s) {
	return _(), i("section", qi, [a("h2", Ji, x(r.t("settings.preferences.title")), 1), a("div", Yi, [
		a("div", Xi, [a("div", null, [a("p", Zi, x(r.t("settings.preferences.emailNotifications")), 1), a("p", Qi, x(r.t("settings.preferences.weeklyReports")), 1)]), a("button", {
			type: "button",
			class: "h-6 w-11 rounded-full bg-primary transition-colors",
			"aria-label": r.t("settings.preferences.toggleNotifications")
		}, [...t[0] ||= [a("span", { class: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" }, null, -1)]], 8, $i)]),
		a("div", ea, [a("div", null, [a("p", ta, x(r.t("settings.preferences.darkMode")), 1), a("p", na, x(r.t("settings.preferences.darkColorScheme")), 1)]), a("button", {
			type: "button",
			class: "h-6 w-11 rounded-full bg-muted transition-colors",
			"aria-label": r.t("settings.preferences.toggleDarkMode")
		}, [...t[1] ||= [a("span", { class: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" }, null, -1)]], 8, ra)]),
		a("div", null, [a("label", ia, x(r.t("settings.preferences.defaultLanguage")), 1), a("select", aa, [
			a("option", null, x(r.t("settings.preferences.english")), 1),
			a("option", null, x(r.t("settings.preferences.french")), 1),
			a("option", null, x(r.t("settings.preferences.german")), 1),
			a("option", null, x(r.t("settings.preferences.spanish")), 1),
			a("option", null, x(r.t("settings.preferences.japanese")), 1),
			a("option", null, x(r.t("settings.preferences.chinese")), 1),
			a("option", null, x(r.t("settings.preferences.arabic")), 1)
		])])
	])]);
}
var sa = Ki(Gi, [["render", oa], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/settings/PreferencesSection.vue"]]), ca = Mi({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
...
var da = Ki(la, [["render", ua], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/scripts/Wrapper.vue"]]), fa = { render() {
