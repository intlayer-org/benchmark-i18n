...
var Wr = { class: "rounded-lg border border-border bg-card p-6" }, Gr = { class: "mb-4 text-lg font-semibold text-foreground" }, Kr = { class: "space-y-4" }, qr = { class: "flex items-center justify-between" }, Jr = { class: "text-sm font-medium text-foreground" }, Yr = { class: "text-xs text-muted-foreground" }, Xr = ["aria-label"], Zr = { class: "flex items-center justify-between" }, Qr = { class: "text-sm font-medium text-foreground" }, $r = { class: "text-xs text-muted-foreground" }, ei = ["aria-label"], ti = {
	for: "language",
	...
	setup(e) {
		let { t } = Lr();
		return (e, n) => (m(), i("section", Wr, [a("h2", Gr, _(v(t)("settings.preferences.title")), 1), a("div", Kr, [
			a("div", qr, [a("div", null, [a("p", Jr, _(v(t)("settings.preferences.emailNotifications")), 1), a("p", Yr, _(v(t)("settings.preferences.weeklyReports")), 1)]), a("button", {
				type: "button",
				class: "h-6 w-11 rounded-full bg-primary transition-colors",
				"aria-label": v(t)("settings.preferences.toggleNotifications")
			}, [...n[0] ||= [a("span", { class: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" }, null, -1)]], 8, Xr)]),
			a("div", Zr, [a("div", null, [a("p", Qr, _(v(t)("settings.preferences.darkMode")), 1), a("p", $r, _(v(t)("settings.preferences.darkColorScheme")), 1)]), a("button", {
				type: "button",
				class: "h-6 w-11 rounded-full bg-muted transition-colors",
				"aria-label": v(t)("settings.preferences.toggleDarkMode")
			}, [...n[1] ||= [a("span", { class: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" }, null, -1)]], 8, ei)]),
			a("div", null, [a("label", ti, _(v(t)("settings.preferences.defaultLanguage")), 1), a("select", ni, [
				a("option", null, _(v(t)("settings.preferences.english")), 1),
				a("option", null, _(v(t)("settings.preferences.french")), 1),
				a("option", null, _(v(t)("settings.preferences.german")), 1),
				a("option", null, _(v(t)("settings.preferences.spanish")), 1),
				a("option", null, _(v(t)("settings.preferences.japanese")), 1),
				a("option", null, _(v(t)("settings.preferences.chinese")), 1),
				a("option", null, _(v(t)("settings.preferences.arabic")), 1)
			])])
		])]));
	}
});
