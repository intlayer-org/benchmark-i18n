...
var Wr = { class: "rounded-lg border border-border bg-card p-6" }, Gr = { class: "mb-4 text-lg font-semibold text-foreground" }, Kr = { class: "space-y-4" }, qr = {
	for: "display-name",
	...
	setup(e) {
		let { t } = Lr();
		return (e, n) => (m(), i("section", Wr, [a("h2", Gr, _(v(t)("settings.profile.title")), 1), a("div", Kr, [a("div", null, [a("label", qr, _(v(t)("settings.profile.displayName")), 1), n[0] ||= a("input", {
			id: "display-name",
		...
		}, null, -1)]), a("div", null, [a("label", Jr, _(v(t)("settings.profile.email")), 1), n[1] ||= a("input", {
			id: "email",
