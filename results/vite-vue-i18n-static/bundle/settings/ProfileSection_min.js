...
process.env.NODE_ENV;
var Li = { class: "rounded-lg border border-border bg-card p-6" }, Ri = { class: "mb-4 text-lg font-semibold text-foreground" }, zi = { class: "space-y-4" }, Bi = {
	for: "display-name",
	...
	setup(e) {
		let { t } = Ti();
		return (e, n) => (_(), i("section", Li, [a("h2", Ri, x(S(t)("settings.profile.title")), 1), a("div", zi, [a("div", null, [a("label", Bi, x(S(t)("settings.profile.displayName")), 1), n[0] ||= a("input", {
			id: "display-name",
		...
		}, null, -1)]), a("div", null, [a("label", Vi, x(S(t)("settings.profile.email")), 1), n[1] ||= a("input", {
			id: "email",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Ui), (e, t) => y(e.$slots, "default");
	}
}), Gi = { render() {
	return d(Wi, {}, { default: () => d(Hi) });
} };
