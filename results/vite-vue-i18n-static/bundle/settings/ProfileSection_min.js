...
var Gi = s({
	...
	return n;
}, qi = { class: "rounded-lg border border-border bg-card p-6" }, Ji = { class: "mb-4 text-lg font-semibold text-foreground" }, Yi = { class: "space-y-4" }, Xi = {
	for: "display-name",
...
function Qi(e, t, n, r, o, s) {
	return _(), i("section", qi, [a("h2", Ji, x(r.t("settings.profile.title")), 1), a("div", Yi, [a("div", null, [a("label", Xi, x(r.t("settings.profile.displayName")), 1), t[0] ||= a("input", {
		id: "display-name",
	...
	}, null, -1)]), a("div", null, [a("label", Zi, x(r.t("settings.profile.email")), 1), t[1] ||= a("input", {
		id: "email",
		value: "john@example.com",
		class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring"
	}, null, -1)])])]);
}
var $i = Ki(Gi, [["render", Qi], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/settings/ProfileSection.vue"]]), ea = Mi({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
	...
	setup(e, { expose: t }) {
		...
		n && !n.config.globalProperties.$i18n && n.use(ea);
		let r = { app: n };
		return Object.defineProperty(r, "__isScriptSetup", {
			enumerable: !1,
			value: !0
...
var ra = Ki(ta, [["render", na], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/scripts/Wrapper.vue"]]), ia = { render() {
	return d(ra, {}, { default: () => d($i) });
} };
