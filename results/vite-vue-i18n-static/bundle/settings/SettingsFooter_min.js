...
var Wr = { class: "flex justify-end gap-3" }, Gr = {
	type: "button",
	...
	setup(e) {
		let { t } = Lr();
		return (e, n) => (m(), i("div", Wr, [a("button", Gr, _(v(t)("settings.footer.cancel")), 1), a("button", Kr, _(v(t)("settings.footer.saveChanges")), 1)]));
	}
});
