...
var Gi = s({
	...
	return n;
}, qi = { class: "flex justify-end gap-3" }, Ji = {
	type: "button",
...
function Xi(e, t, n, r, o, s) {
	return _(), i("div", qi, [a("button", Ji, x(r.t("settings.footer.cancel")), 1), a("button", Yi, x(r.t("settings.footer.saveChanges")), 1)]);
}
var Zi = Ki(Gi, [["render", Xi], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/src/components/pages/settings/SettingsFooter.vue"]]), Qi = Mi({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en",
	messages: {
	...
	setup(e, { expose: t }) {
		...
		n && !n.config.globalProperties.$i18n && n.use(Qi);
		let r = { app: n };
		return Object.defineProperty(r, "__isScriptSetup", {
			enumerable: !1,
			value: !0
...
var ta = Ki($i, [["render", ea], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-i18n-app/scripts/Wrapper.vue"]]), na = { render() {
	return d(ta, {}, { default: () => d(Zi) });
} };
