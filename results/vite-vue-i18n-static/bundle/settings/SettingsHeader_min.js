...
}), Kr = { class: "mb-2 text-3xl font-bold text-foreground" }, qr = { class: "mb-8 text-muted-foreground" }, Jr = s({
	__name: "SettingsHeader",
	setup(e) {
		let { t: n } = Lr();
		return (e, r) => (m(), i(t, null, [
			o(Gr),
			a("h1", Kr, _(v(n)("settings.header.title")), 1),
			a("p", qr, _(v(n)("settings.header.description")), 1)
		], 64));
	}
});
