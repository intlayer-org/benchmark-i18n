...
var w = { class: "grid gap-6 md:grid-cols-2 lg:grid-cols-3" }, ee = { class: "mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-accent text-lg font-bold text-accent-foreground" }, te = { class: "text-base font-semibold text-foreground" }, T = { class: "mb-2 text-xs font-medium text-primary" }, E = { class: "text-sm text-muted-foreground" }, ne = s({
	__name: "TeamGrid",
	setup(e) {
		let n = [
			{
		...
		return (e, o) => (_(), i("div", w, [(_(), i(t, null, y(n, (e) => a("div", {
			key: e.name,
			class: "rounded-lg border border-border bg-card p-6 text-center"
		}, [
			a("div", ee, S(r(e.name)), 1),
			a("h3", te, S(e.name), 1),
			a("p", T, S(e.role), 1),
			a("p", E, S(e.bio), 1)
		])), 64))]));
