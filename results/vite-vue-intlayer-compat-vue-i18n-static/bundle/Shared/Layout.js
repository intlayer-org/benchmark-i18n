import { a as getDictionaries, i as l, n as c, o as internationalization, r as s$1, s as log, t as a$1 } from "./installIntlayer-BXT-KuGG.js";
import { Fragment, computed, createBlock, createCommentVNode, createElementBlock, createElementVNode, createTextVNode, createVNode, defineComponent, getCurrentInstance, h, inject, normalizeClass, onBeforeMount, onMounted, onUnmounted, openBlock, ref, renderList, renderSlot, resolveComponent, toDisplayString, unref, watch, withCtx } from "vue";
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("footer", _hoisted_1$3, [createElementVNode("div", _hoisted_2$2, [createElementVNode("div", _hoisted_3$2, [
				createElementVNode("div", null, [createElementVNode("h3", _hoisted_4$1, toDisplayString(unref(t)("footer.title")), 1), createElementVNode("p", _hoisted_5$1, toDisplayString(unref(t)("footer.description")), 1)]),
				createElementVNode("div", null, [createElementVNode("h3", _hoisted_6$1, toDisplayString(unref(t)("footer.resources")), 1), createElementVNode("ul", _hoisted_7$1, [(openBlock(true), createElementBlock(Fragment, null, renderList(footerLinks.value, (linkEl) => {
				...
				createElementVNode("div", null, [createElementVNode("h3", _hoisted_9$1, toDisplayString(unref(t)("footer.contact")), 1), createElementVNode("p", _hoisted_10$1, toDisplayString(unref(t)("shared.contactEmail")), 1)])
			]), createElementVNode("div", _hoisted_11$1, toDisplayString(unref(t)("footer.builtWith")), 1)])]);
		};
	}
});
...
var ThemeToggle_default = defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			}, toDisplayString(mode.value === "auto" ? unref(t)("themeToggle.auto") : mode.value === "dark" ? unref(t)("themeToggle.dark") : unref(t)("themeToggle.light")), 9, _hoisted_1$1);
		};
	}
});
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("header", _hoisted_1, [createElementVNode("nav", _hoisted_2, [createElementVNode("div", _hoisted_3, [createVNode(_component_router_link, {
				...
				default: withCtx(() => [createTextVNode(toDisplayString(unref(t)("shared.appName")), 1)]),
				_: 1
				...
				createVNode(_component_router_link, {
					...
					default: withCtx(({ href, navigate, isExactActive }) => [createElementVNode("a", {
						...
						onClick: navigate
					}, toDisplayString(unref(t)("header.home")), 11, _hoisted_5)]),
					_: 1
				}, 8, ["to"]),
				createVNode(_component_router_link, {
					to: `/${currentLocale.value}/about`,
					...
					default: withCtx(({ href, navigate, isActive }) => [createElementVNode("a", {
						...
						onClick: navigate
					}, toDisplayString(unref(t)("header.methodology")), 11, _hoisted_6)]),
					_: 1
				}, 8, ["to"]),
				...
				}, [createTextVNode(toDisplayString(unref(t)("header.mockPages")) + " ", 1), createVNode(unref(ChevronDown), {
					size: 14,
				...
				}, [createElementVNode("div", _hoisted_8, [(openBlock(true), createElementBlock(Fragment, null, renderList(mockPages.value, (page) => {
				...
				createElementVNode("a", _hoisted_10, [createElementVNode("span", _hoisted_11, toDisplayString(unref(t)("shared.goToGithub")), 1), _cache[6] || (_cache[6] = createElementVNode("svg", {
					viewBox: "0 0 16 16",
					"aria-hidden": "true",
					width: "20",
					height: "20"
...
import { a as getDictionaries, i as l, o as internationalization, r as s$1 } from "./installIntlayer-BXT-KuGG.js";
...
var c = (e, t) => {
	...
	return e.provide(a, o), process.env.INTLAYER_DEVTOOLS_ENABLED !== "false" && import("./devtools-Cw55a7Ej.js").then(({ enableIntlayerDevtools: t }) => {
		t(e);
	}).catch(() => {}), e;
};
