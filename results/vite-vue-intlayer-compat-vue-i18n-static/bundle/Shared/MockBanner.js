...
import { computed, createElementBlock, defineComponent, getCurrentInstance, h, inject, openBlock, renderSlot, toDisplayString, unref } from "vue";
...
var MockBanner_default = defineComponent({
	...
	setup(__props) {
		const { t } = useI18n();
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, toDisplayString(unref(t)("mockBanner")), 1);
		};
	}
});
var i18n = createI18n({
