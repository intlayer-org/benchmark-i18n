...
import { computed as s, createElementBlock as c, defineComponent as l, getCurrentInstance as u, h as d, inject as f, openBlock as p, renderSlot as m, toDisplayString as h, unref as g } from "vue";
var _ = (e, t, n) => typeof e == "string" ? n?.[t]?.[e] ?? n?.[t.split("-")[0] ?? ""]?.[e] : e, v = (e, t, n, r) => {
...
}, ae = (e, t) => e[ie(e, t) ?? "fallback"], oe = 50, se = /* @__PURE__ */ new Map(), ce = /* @__PURE__ */ new Set(), le = (e) => {
	...
	let t = Intl[e];
	return typeof t == "function" ? t : (le(e), ue[e]);
};
function A(e, t, n) {
	let i = t ?? r?.defaultLocale, a = `${i}|${n ? JSON.stringify(n) : ""}`, o = e, s = se.get(o);
	s || (s = /* @__PURE__ */ new Map(), se.set(o, s));
	let c = s.get(a);
	if (!c) {
		let t = typeof e == "string" ? de(e) : e;
		if (typeof t != "function") throw Error(`[intlayer] \`Intl.${String(e)}\` is not available in this JavaScript engine and has no fallback. Load the matching polyfill before formatting.`);
		s.size > oe && s.clear(), c = new t(i, n), s.set(a, c);
	}
	return c;
}
var fe = (e, t, n) => e[A("PluralRules", n).select(t)] ?? e.other, pe = (e, t) => {
	...
	return String(e);
}, P = (e, t = {}, n = "en") => e.replace(/\{\{\s*([^{},]+?)\s*(?:,\s*(\w+)\s*(?:,\s*([^{}]+?)\s*)?)?\}\}/g, (e, r, i, a) => {
	let o = M(t, r);
	return o === void 0 ? e : i ? N(o, i, a, n) : String(o);
}).replace(/\{\s*([\w.]+)\s*,\s*(\w+)\s*(?:,\s*([^}]+?)\s*)?\}/g, (e, r, i, a) => {
	let o = M(t, r);
	return o === void 0 ? e : N(o, i, a, n);
}).replace(/\{\s*([\w.]+)\s*\}/g, (e, n) => {
	let r = M(t, n);
	return r === void 0 ? e : String(r);
}), F = (e, t) => e[t] ?? e.count ?? e.n, I = (e, t = {}, n = "en") => {
	if (e == null) return e;
	if (typeof e == "string") return P(e, t, n);
	...
	let r = e;
	if (r.nodeType === "insertion") return I(r[S], t, n);
	if (r.nodeType === "html") return I(r[w], t, n);
	if (r.nodeType === "plural") {
		let e = r[ee];
		return I(fe(e, Number(F(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[x], i = j.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[E], i = F(t, typeof r.variable == "string" ? r.variable : "value");
		return I(pe(e, String(i ?? "")), t, n);
	}
...
}, z = "\x1B[0m", B = "\x1B[90m", ge = "\x1B[34m", _e = "\x1B[31m", ve = "\x1B[32m", ye = "\x1B[35m", be = "\x1B[38;5;3m", V = "\x1B[36m", xe = (e) => e, Se = (e, t) => {
...
}), U = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? z : n : z}` : e, Ce = (e, t = be, n = z) => [e].flat().map((e) => U(e, t, n)).join(", ");
U("✗", _e), U("✓", ve), U("⏲", ge);
var W = /* @__PURE__ */ new WeakMap(), G = 0, we = (e) => {
	if (!e) return "base";
	let t = W.get(e);
	if (t) return t;
	G += 1;
	let n = `p${G}`;
	return W.set(e, n), n;
}, Te = 256, K = /* @__PURE__ */ new WeakMap(), Ee = (e) => typeof e == "object" && !!e, De = (e, t, n) => `${e}_${t}_${we(n)}`, Oe = (e, t) => {
	...
	if (!Ee(e)) return n;
	let r = K.get(e);
	return r || (r = /* @__PURE__ */ new Map(), K.set(e, r)), r.size >= Te && r.clear(), r.set(t, n), n;
}, ke = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), Ae = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), je = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Ae.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : je(e ? `${e}.${String(n)}` : String(n)) }), Me = /* @__PURE__ */ new Set(), Ne = (t, n, r) => {
	let i = e()[t];
	return i ? tt(i, n, r) : (Me.has(t) || (H({ log: a })(typeof window > "u" ? `Dictionary ${Ce(t)} was not found. Using fallback proxy.` : `Dictionary ${t} was not found. Using fallback proxy.`, { level: "warn" }), Me.add(t)), je(t));
}, Pe = (e) => {
	...
	for (let r of Object.keys(t)) {
		...
		let a = e[r], o = a === void 0 ? i : typeof a == "object" ? Fe(a, i) : a;
		o !== a && (n === e && (n = { ...e }), n[r] = o);
	}
	return n;
}, Ie = (e, t, n) => {
	...
	if (o.length !== 0) return o.length === 1 || Array.isArray(o[0]) ? o[0] : o.reduce((e, t) => Fe(e, t));
}, J = (e) => {
	...
	if (J(e)) return e.nodeType === "html" ? e[w] : e[C];
}, Re = (e, t) => {
...
}, Ve = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? Y : {
...
}, He = Y, Ue = (e) => Y, We = Y, Ge = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? Y : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: S }], i = e[S], a = {
			...
			transform: (e, n, r) => {
				if (J(e)) return (i) => ze(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
	...
	let i = e?.nodeType;
	if (typeof t != "function" || !i || !Ke.includes(i)) return t;
...
}, Je = (e, t) => typeof t == "function" && Ke.includes(e?.nodeType ?? "") ? (n) => qe(e, t, n) : t, Ye = Y, Xe = Y;
process.env.INTLAYER_OPTIMIZED_NESTING;
var Ze = (e) => Y, Qe = Y, $e = (e, t = !0) => [
	Ve(e ?? r.defaultLocale, t ? r.defaultLocale : void 0),
	He,
	Ue(e ?? r.defaultLocale),
	We,
	Ge,
	...
	Ye,
	Xe
].filter((e) => e !== Y), et = (e, t, n = []) => O(e, {
	...t,
	plugins: n
}), X = /* @__PURE__ */ new WeakSet(), tt = (e, t, n) => {
	let { locale: i, selector: a } = {
		locale: t,
		selector: void 0
	}, o = De(i ?? r.defaultLocale, "", n), s = Oe(e, o);
	...
	let c = n ?? $e(i), l = e, u = (e) => {
		...
		X.add(e);
		try {
			return et(e.content, t, c);
		} finally {
			t.eager && X.delete(e);
		}
	};
	return l === null ? q(e, o, null) : Array.isArray(l) ? q(e, o, l.map(u)) : q(e, o, u(l));
}, { defaultLocale: nt, locales: rt } = r ?? {}, it = ({ isCookieEnabled: e, onLocaleChange: n } = {}) => {
	let r = f(o);
	return {
		locale: s(() => r?.locale?.value ?? nt),
		defaultLocale: nt,
		availableLocales: rt,
		setLocale: (i) => {
			if (!rt?.map(String).includes(i)) {
...
}, at = Symbol("global-i18n"), ot = "translation", Z = (e, t, n) => {
	try {
		let r = k(Ne(t, e), n);
		if (r != null) return r;
	} catch {}
	...
	let { values: a, count: o, defaultMessage: s } = L(r), c = Q(e, t, n);
	if (c === void 0) {
		if (i?.[e]) {
			let r = t ? `${t}.${n}` : n, s = k(i[e], r);
			if (s !== void 0) return R(s, a, o, e);
		}
		return s === void 0 ? n : R(s, a, o, e);
	}
	return R(c, a, o, e);
}, ct = () => r?.locales?.map(String) ?? [], $ = (e) => {
	H({ log: a })(`${U(e, V)} has no effect with ${U("@intlayer/vue-i18n", ye)} — translations are managed by the compiled intlayer dictionaries.`);
}, lt = ((e = {}) => {
	let t = e.messages;
	e.messages !== void 0 && H({ log: a })(`${U("createI18n", V)}: the ${U("`messages`", V)} option is used as a fallback. For optimal bundle size, remove the locale JSON imports and use ${U("useDictionary", V)} or compile your intlayer dictionaries instead:\n  ${U("Before:", B)} createI18n({ messages: { en, fr, … } })\n  ${U("After: ", B)} createI18n({})`);
	let o = i(e.locale), c = e.datetimeFormats, l = e.numberFormats, u = () => String(o.locale.value), d = s({
		get: () => u(),
		set: (e) => {
			o.setLocale(e);
		}
	}), f = (e, ...n) => st(u(), void 0, e, n, t), p = (e, t) => v(e, t, u(), c), m = (e, t) => y(e, t, u(), l), h = {
		locale: d,
		availableLocales: ct(),
		...
		__optionsMessages: t,
		install(t) {
			n(t, { locale: e.locale }), t.provide(at, b), t.config.globalProperties.$t = f, t.config.globalProperties.$tc = f, t.config.globalProperties.$te = h.te, t.config.globalProperties.$tm = h.tm, t.config.globalProperties.$rt = h.rt, t.config.globalProperties.$d = p, t.config.globalProperties.$n = m, t.config.globalProperties.$i18n = g, t.directive("t", {
				beforeMount: _,
				updated: _
			});
		}
	...
	let { locale: t, setLocale: n, availableLocales: r } = it(), i = f(at)?.__optionsMessages, a = e?.namespace, o = e?.datetimeFormats, c = e?.numberFormats, l = s({
		get: () => t.value,
		set: (e) => {
			n(e);
		}
	}), u = (e, ...n) => st(t.value, a, e, n, i);
	return {
		locale: l,
		availableLocales: r,
		t: u,
		...
		tm: (e) => Q(t.value, a, e) ?? {},
		rt: (e, ...n) => {
			let { values: r, count: i } = L(n);
			return R(e, r, i, t.value);
		},
		d: (e, n) => v(e, n, t.value, o),
		n: (e, n) => y(e, n, t.value, c)
	};
}), dt = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, ft = l({
	__name: "MockBanner",
	setup(e) {
		let { t } = ut();
		return (e, n) => (p(), c("div", dt, h(g(t)("mockBanner")), 1));
	}
}), pt = lt({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(pt), (e, t) => m(e.$slots, "default");
	}
}), ht = { render() {
	return d(mt, {}, { default: () => d(ft) });
} };
