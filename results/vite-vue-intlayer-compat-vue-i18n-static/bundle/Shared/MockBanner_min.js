import { computed as e, createElementBlock as t, defineComponent as n, getCurrentInstance as r, h as i, inject as a, openBlock as o, readonly as s, ref as c, renderSlot as l, toDisplayString as u, unref as d } from "vue";
...
var L = /* @__PURE__ */ new WeakMap(), R = 0, De = (e) => {
...
}, Ne = (e) => e === void 0 ? U : typeof e == "string" ? G(e, je) : Object.keys(e).sort().map((t) => `${G(t, W)}=${G(String(e[t]), W)}`).join("&"), Pe = (e) => Array.isArray(e) ? e.length === 0 ? [U] : e.map(Ne) : [Ne(e)], Fe = (e, t) => {
	for (let n of e) if (t(n)) return n;
	return t("default") ? U : e[0] ?? "default";
}, Ie = (e, t, n, r) => {
	let i = e.split("/");
	return t.every((e, t) => e === "variant" ? i[t] === r : n?.item === void 0 || i[t] === String(n.item));
}, Le = (e) => typeof e == "object" && !!e && "qualifierTypes" in e && Array.isArray(e.qualifierTypes) && "content" in e, Re = (e, t) => {
	let n = t.split("/"), r = {
		key: e.key,
		content: e.content[t]
	};
	...
	if (!Le(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? U : Fe(Pe(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Ie(e, n, t, s)).map((t) => Re(e, t));
	...
	let n = e[t];
	return `${t}:${t === "variant" ? Pe(n).join(",") : String(n)}`;
}).join("|") : "", He = () => ({}), Ue = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	...
	let r = He()[e];
	return r ? lt(r, t, n) : (Ge.has(e) || (F({ log: S })(typeof window > "u" ? `Dictionary ${Ee(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Ge.add(e)), We(e));
}, qe = (e) => {
	...
	if (K(e)) return e.nodeType === "html" ? e[_] : e[ie];
}, Ze = (e, t) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, $e = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? q : {
...
}, et = q, tt = q, nt = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? q : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: g }], i = e[g], a = {
			...
			transform: (e, n, r) => {
				if (K(e)) return (i) => Qe(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, rt = q, it = q, at = (e) => q, ot = q, st = (e, t = !0) => [
	...
	let { locale: r, selector: i } = Be(t), a = ke(r ?? b.defaultLocale, Ve(i), n), o = Ae(e, a);
	if (o.hit) return o.content;
	let s = n ?? st(r), c = ze(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
}, dt = Symbol("intlayer"), J = null, ft = (e, t = !0, n) => {
	if (J) return J;
	ut();
	let { defaultLocale: r } = b ?? {}, i = c(e ?? r), a = (e) => {
		i.value = e;
	}, o = c(n);
	return J = {
		locale: s(i),
...
var yt = (e, t) => vt(e, {
...
}, X = Symbol("global-i18n"), Ct = "translation", Z = (e, t, n) => {
	try {
		let r = y(Ke(t, e), n);
		if (r != null) return r;
	} catch {}
	...
	let { locale: n, setLocale: r, availableLocales: i } = St(), o = a(X)?.__optionsMessages, s = t?.namespace, c = t?.datetimeFormats, l = t?.numberFormats, u = e({
		get: () => n.value,
		set: (e) => {
			r(e);
		}
	}), d = (e, ...t) => wt(n.value, s, e, t, o);
	return {
		locale: u,
		availableLocales: i,
		t: d,
...
}), Ot = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, kt = n({
	__name: "MockBanner",
	setup(e) {
		let { t: n } = Dt();
		return (e, r) => (o(), t("div", Ot, u(d(n)("mockBanner")), 1));
	}
}), At = Et({
	legacy: !1,
	locale: "en",
	...
	__name: "Wrapper",
	setup(e) {
		let t = r()?.appContext.app;
		return t && !t.config.globalProperties.$i18n && t.use(At), (e, t) => l(e.$slots, "default");
	}
}), Mt = { render() {
	return i(jt, {}, { default: () => i(kt) });
} };
