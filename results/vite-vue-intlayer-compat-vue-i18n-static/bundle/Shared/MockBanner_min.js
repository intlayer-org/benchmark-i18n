...
var L = /* @__PURE__ */ new WeakMap(), R = 0, De = (e) => {
...
}, K = (e) => e === void 0 ? U : typeof e == "string" ? G(e, je) : Object.keys(e).sort().map((t) => `${G(t, W)}=${G(String(e[t]), W)}`).join("&"), Ne = (e) => Array.isArray(e) ? e.length === 0 ? [U] : e.map(K) : [K(e)], Pe = (e, t) => {
	...
	if (!Ie(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? U : Pe(Ne(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Fe(e, n, t, s)).map((t) => Le(e, t));
...
var yt = (e, t) => vt(e, {
	...
	}), c = (e, ...t) => Tt(o(), void 0, e, t, n), l = (e, t) => p(e, t, o(), i), u = (e, t) => ee(e, t, o(), a), d = {
		locale: s,
		availableLocales: Et(),
	...
	let { locale: n, setLocale: r, availableLocales: i } = St(), o = a(Ct)?.__optionsMessages, s = t?.namespace, c = t?.datetimeFormats, l = t?.numberFormats, u = e({
		get: () => n.value,
		set: (e) => {
			r(e);
		}
	}), d = (e, ...t) => Tt(n.value, s, e, t, o);
	return {
		locale: u,
		availableLocales: i,
		t: d,
...
}), kt = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, At = n({
	__name: "MockBanner",
	setup(e) {
		let { t: n } = Ot();
		return (e, r) => (o(), t("div", kt, u(d(n)("mockBanner")), 1));
	}
}), jt = Dt({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(jt), (e, t) => l(e.$slots, "default");
	}
}), Nt = { render() {
	return i(Mt, {}, { default: () => i(At) });
} };
