...
import { computed as s, createElementBlock as c, defineComponent as l, getCurrentInstance as u, h as d, inject as f, onMounted as p, onUnmounted as m, openBlock as h, ref as g, renderSlot as _, toDisplayString as v, unref as y, watch as ee } from "vue";
...
}, ie = "translation", b = "enumeration", x = "plural", ae = "condition", S = "insertion", oe = "object", se = "array", C = "markdown", w = "html", ce = "gender", le = "select", T = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), E = (e, t) => {
...
}, fe = (e, t) => e[de(e, t) ?? "fallback"], pe = 50, D = /* @__PURE__ */ new Map(), O = /* @__PURE__ */ new Set(), me = (e) => {
...
var _e = (e, t, n) => e[k("PluralRules", n).select(t)] ?? e.other, ve = (e, t) => {
	...
	if (r.nodeType === "plural") {
		let e = r[x];
		return F(_e(e, Number(P(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[b], i = A.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[le], i = P(t, typeof r.variable == "string" ? r.variable : "value");
		return F(ve(e, String(i ?? "")), t, n);
	}
...
}, R = "\x1B[0m", z = "\x1B[90m", xe = "\x1B[34m", Se = "\x1B[31m", Ce = "\x1B[32m", we = "\x1B[35m", Te = "\x1B[38;5;3m", B = "\x1B[36m", Ee = (e) => e, De = (e, t) => {
...
}), H = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? R : n : R}` : e, Oe = (e, t = Te, n = R) => [e].flat().map((e) => H(e, t, n)).join(", ");
H("✗", Se), H("✓", Ce), H("⏲", xe);
var U = /* @__PURE__ */ new WeakMap(), W = 0, ke = (e) => {
	if (!e) return "base";
	let t = U.get(e);
	if (t) return t;
	W += 1;
	...
	let i = e()[t];
	return i ? ot(i, n, r) : (Le.has(t) || (V({ log: a })(typeof window > "u" ? `Dictionary ${Oe(t)} was not found. Using fallback proxy.` : `Dictionary ${t} was not found. Using fallback proxy.`, { level: "warn" }), Le.add(t)), Ie(t));
}, ze = (e) => {
...
}, Ke = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? J : {
...
}, qe = J, Je = (e) => J, Ye = J, Xe = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? J : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: S }], i = e[S], a = {
			...
			transform: (e, n, r) => {
				if (q(e)) return (i) => We(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, $e = (e, t) => typeof t == "function" && Ze.includes(e?.nodeType ?? "") ? (n) => Qe(e, t, n) : t, et = J, tt = J;
process.env.INTLAYER_OPTIMIZED_NESTING;
var nt = (e) => J, rt = J, it = (e, t = !0) => [
	...
	et,
	tt
].filter((e) => e !== J), at = (e, t, n = []) => E(e, {
	...t,
	plugins: n
}), Y = /* @__PURE__ */ new WeakSet(), ot = (e, t, n) => {
...
}, { defaultLocale: st, locales: X } = r ?? {}, ct = ({ isCookieEnabled: e, onLocaleChange: n } = {}) => {
	let r = f(o);
	return {
		locale: s(() => r?.locale?.value ?? st),
		defaultLocale: st,
		availableLocales: X,
		setLocale: (i) => {
			if (!X?.map(String).includes(i)) {
	...
	V({ log: a })(`${H(e, B)} has no effect with ${H("@intlayer/vue-i18n", we)} — translations are managed by the compiled intlayer dictionaries.`);
}, pt = ((e = {}) => {
	let t = e.messages;
	...
	}), f = (e, ...n) => dt(u(), void 0, e, n, t), p = (e, t) => ne(e, t, u(), c), m = (e, t) => re(e, t, u(), l), h = {
		locale: d,
		availableLocales: ft(),
	...
	let { locale: t, setLocale: n, availableLocales: r } = ct(), i = f(lt)?.__optionsMessages, a = e?.namespace, o = e?.datetimeFormats, c = e?.numberFormats, l = s({
		get: () => t.value,
		set: (e) => {
			n(e);
		}
	...
	return {
		...
		n: (e, n) => re(e, n, t.value, c)
	};
}), ht = ["aria-label", "title"], gt = l({
	__name: "ThemeToggle",
	setup(e) {
		let { t } = mt(), n = g("auto");
		function r() {
		...
		}, v(n.value === "auto" ? y(t)("themeToggle.auto") : n.value === "dark" ? y(t)("themeToggle.dark") : y(t)("themeToggle.light")), 9, ht));
	}
}), _t = pt({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(_t), (e, t) => _(e.$slots, "default");
	}
}), yt = { render() {
	return d(vt, {}, { default: () => d(gt) });
} };
