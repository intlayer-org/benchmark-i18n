...
var je = /* @__PURE__ */ new WeakMap(), Me = 0, Ne = (e) => {
	...
	let r = qe()[e];
	return r ? ft(r, t, n) : (K.has(e) || (P({ log: S })(typeof window > "u" ? `Dictionary ${Ae(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), K.add(e)), G(e));
}, Xe = (e) => {
...
var St = (e, t) => xt(e, {
	...X,
	isCookieEnabled: t
}), { defaultLocale: Ct, locales: wt } = b ?? {}, Tt = ({ isCookieEnabled: t, onLocaleChange: n } = {}) => {
	let r = a(mt);
	return {
	...
	}), c = (e, ...t) => Ot(o(), void 0, e, t, n), l = (e, t) => te(e, t, o(), i), u = (e, t) => ne(e, t, o(), a), d = {
		locale: s,
		availableLocales: kt(),
	...
	let { locale: n, setLocale: r, availableLocales: i } = Tt(), o = a(Et)?.__optionsMessages, s = t?.namespace, c = t?.datetimeFormats, l = t?.numberFormats, u = e({
		get: () => n.value,
		set: (e) => {
			r(e);
		}
	}), d = (e, ...t) => Ot(n.value, s, e, t, o);
	return {
		locale: u,
		availableLocales: i,
		t: d,
	...
	setup(e) {
		...
		}, ee(r.value === "auto" ? f(n)("themeToggle.auto") : r.value === "dark" ? f(n)("themeToggle.dark") : f(n)("themeToggle.light")), 9, Mt));
	}
}), Pt = At({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Pt), (e, t) => d(e.$slots, "default");
	}
}), It = { render() {
	return i(Ft, {}, { default: () => i(Nt) });
} };
