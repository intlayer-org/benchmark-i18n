...
var jt = r({
	...
	return n;
}, Nt = { class: "grid gap-8 md:grid-cols-2" }, Pt = { class: "rounded-lg border border-border bg-card p-6" }, Ft = { class: "mb-3 text-xl font-semibold text-foreground" }, It = { class: "text-sm text-muted-foreground" }, Lt = { class: "rounded-lg border border-border bg-card p-6" }, Rt = { class: "mb-3 text-xl font-semibold text-foreground" }, zt = { class: "text-sm text-muted-foreground" };
function Bt(e, r, i, a, o, s) {
	return l(), t("div", Nt, [n("div", Pt, [n("h2", Ft, p(a.t("about.grid.whyExistsTitle")), 1), n("p", It, p(a.t("about.grid.whyExistsDesc")), 1)]), n("div", Lt, [n("h2", Rt, p(a.t("about.grid.methodologyTitle")), 1), n("p", zt, p(a.t("about.grid.methodologyDesc")), 1)])]);
}
var Vt = Mt(jt, [["render", Bt], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/src/components/pages/about/AboutGrid.vue"]]), Ht = Ot({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en"
}), Ut = r({
...
var Gt = Mt(Ut, [["render", Wt], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/scripts/Wrapper.vue"]]), Kt = { render() {
	return a(Gt, {}, { default: () => a(Vt) });
} };
