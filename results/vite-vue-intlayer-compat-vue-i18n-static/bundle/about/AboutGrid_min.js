...
var Nt = { class: "grid gap-8 md:grid-cols-2" }, Pt = { class: "rounded-lg border border-border bg-card p-6" }, Ft = { class: "mb-3 text-xl font-semibold text-foreground" }, It = { class: "text-sm text-muted-foreground" }, Lt = { class: "rounded-lg border border-border bg-card p-6" }, Rt = { class: "mb-3 text-xl font-semibold text-foreground" }, zt = { class: "text-sm text-muted-foreground" }, Bt = r({
	__name: "AboutGrid",
	setup(e) {
		Mt("AboutGrid");
		let { t: r } = jt();
		return (e, i) => (l(), t("div", Nt, [n("div", Pt, [n("h2", Ft, f(p(r)("about.grid.whyExistsTitle")), 1), n("p", It, f(p(r)("about.grid.whyExistsDesc")), 1)]), n("div", Lt, [n("h2", Rt, f(p(r)("about.grid.methodologyTitle")), 1), n("p", zt, f(p(r)("about.grid.methodologyDesc")), 1)])]));
	}
}), Vt = At({
	legacy: !1,
	locale: "en",
