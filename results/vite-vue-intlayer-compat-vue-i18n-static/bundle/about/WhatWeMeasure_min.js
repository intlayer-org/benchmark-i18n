...
var B = /* @__PURE__ */ new WeakMap(), V = 0, Oe = (e) => {
...
}, Le = (e) => e === void 0 ? W : typeof e == "string" ? G(e, Pe) : Object.keys(e).sort().map((t) => `${G(t, Fe)}=${G(String(e[t]), Fe)}`).join("&"), K = (e) => Array.isArray(e) ? e.length === 0 ? [W] : e.map(Le) : [Le(e)], Re = (e, t) => {
	...
	if (!Be(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? W : Re(K(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => ze(e, n, t, s)).map((t) => Ve(e, t));
...
var Nt = i({
	...
	return n;
}, Ft = { class: "mt-12 mx-auto max-w-3xl" }, It = { class: "mb-4 text-2xl font-bold text-foreground" }, Lt = { class: "space-y-4" }, Rt = { class: "block text-sm font-bold text-primary" }, zt = { class: "block mt-1 text-sm text-muted-foreground" };
function Bt(t, i, a, o, s, c) {
	return u(), n("section", Ft, [r("h2", It, h(o.t("about.whatWeMeasure.title")), 1), r("ul", Lt, [(u(!0), n(e, null, p(o.metrics, (e) => (u(), n("li", {
		key: e.metric,
		class: "rounded-md border border-border p-4"
	}, [r("span", Rt, h(e.metric), 1), r("span", zt, h(e.desc), 1)]))), 128))])]);
}
var Vt = Pt(Nt, [["render", Bt], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/src/components/pages/about/WhatWeMeasure.vue"]]), Ht = At({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en"
}), Ut = i({
...
var Gt = Pt(Ut, [["render", Wt], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/scripts/Wrapper.vue"]]), Kt = { render() {
	return o(Gt, {}, { default: () => o(Vt) });
} };
