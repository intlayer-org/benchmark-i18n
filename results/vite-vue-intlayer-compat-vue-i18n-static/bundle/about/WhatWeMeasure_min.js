...
import { Fragment as s, computed as c, createElementBlock as l, createElementVNode as u, defineComponent as d, getCurrentInstance as f, h as p, inject as m, onBeforeMount as h, onMounted as ee, openBlock as g, renderList as _, renderSlot as te, toDisplayString as v, unref as ne } from "vue";
var re = (e, t, n) => typeof e == "string" ? n?.[t]?.[e] ?? n?.[t.split("-")[0] ?? ""]?.[e] : e, y = (e, t, n, r) => {
...
}, fe = (e, t) => e[de(e, t) ?? "fallback"], pe = 50, me = /* @__PURE__ */ new Map(), O = /* @__PURE__ */ new Set(), he = (e) => {
...
function k(e, t, n) {
	let i = t ?? r?.defaultLocale, a = `${i}|${n ? JSON.stringify(n) : ""}`, o = e, s = me.get(o);
	s || (s = /* @__PURE__ */ new Map(), me.set(o, s));
	let c = s.get(a);
	if (!c) {
...
var U = /* @__PURE__ */ new WeakMap(), W = 0, Ae = (e) => {
	...
	let i = e()[t];
	return i ? st(i, n, r) : (Re.has(t) || (V({ log: a })(typeof window > "u" ? `Dictionary ${ke(t)} was not found. Using fallback proxy.` : `Dictionary ${t} was not found. Using fallback proxy.`, { level: "warn" }), Re.add(t)), Le(t));
}, Be = (e) => {
...
var rt = (e) => J, it = J, at = (e, t = !0) => [
	...
	}), f = (e, ...n) => ft(u(), void 0, e, n, t), p = (e, t) => y(e, t, u(), s), m = (e, t) => b(e, t, u(), l), h = {
		locale: d,
		availableLocales: pt(),
...
var _t = { class: "mt-12 mx-auto max-w-3xl" }, vt = { class: "mb-4 text-2xl font-bold text-foreground" }, yt = { class: "space-y-4" }, bt = { class: "block text-sm font-bold text-primary" }, xt = { class: "block mt-1 text-sm text-muted-foreground" }, St = d({
	...
	setup(e) {
		...
		return (e, r) => (g(), l("section", _t, [u("h2", vt, v(ne(t)("about.whatWeMeasure.title")), 1), u("ul", yt, [(g(!0), l(s, null, _(n.value, (e) => (g(), l("li", {
			key: e.metric,
			class: "rounded-md border border-border p-4"
		}, [u("span", bt, v(e.metric), 1), u("span", xt, v(e.desc), 1)]))), 128))])]));
	}
}), Ct = mt({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Ct), (e, t) => te(e.$slots, "default");
	}
}), Tt = { render() {
	return p(wt, {}, { default: () => p(St) });
} };
