...
}, Je = () => qe, Ye = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), K = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Ye.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : K(e ? `${e}.${String(n)}` : String(n)) }), Xe = /* @__PURE__ */ new Set(), Ze = (e, t, n) => {
	let r = Je()[e];
	return r ? mt(r, t, n) : (Xe.has(e) || (F({ log: C })(typeof window > "u" ? `Dictionary ${je(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Xe.add(e)), K(e));
}, Qe = (e) => {
...
var wt = (e, t) => Ct(e, {
	...
	}), c = (e, ...t) => At(o(), void 0, e, t, n), l = (e, t) => _(e, t, o(), i), u = (e, t) => te(e, t, o(), a), d = {
		locale: s,
		availableLocales: jt(),
...
var Ft = { class: "mt-12 mx-auto max-w-3xl" }, It = { class: "mb-4 text-2xl font-bold text-foreground" }, Lt = { class: "space-y-4" }, Rt = { class: "block text-sm font-bold text-primary" }, zt = { class: "block mt-1 text-sm text-muted-foreground" }, Bt = i({
	...
	setup(i) {
		...
		return (t, i) => (u(), n("section", Ft, [r("h2", It, h(ee(a)("about.whatWeMeasure.title")), 1), r("ul", Lt, [(u(!0), n(e, null, p(o.value, (e) => (u(), n("li", {
			key: e.metric,
