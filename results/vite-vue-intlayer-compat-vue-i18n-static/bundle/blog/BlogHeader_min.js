...
function Rt(t, a, o, s, c, u) {
	return l(), n(e, null, [
		i(s.MockBanner),
		r("h1", It, p(s.t("blog.header.title")), 1),
		r("p", Lt, p(s.t("blog.header.description")), 1)
	], 64);
}
var zt = $(Ft, [["render", Rt], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/src/components/pages/blog/BlogHeader.vue"]]), Bt = kt({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en"
}), Vt = a({
