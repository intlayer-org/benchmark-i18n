...
}), Nt = { class: "mb-2 text-3xl font-bold text-foreground" }, Pt = { class: "mb-10 text-muted-foreground" }, Ft = a({
	__name: "BlogHeader",
	setup(t) {
		let { t: a } = At();
		return (t, o) => (l(), n(e, null, [
			i(Mt),
			r("h1", Nt, f(p(a)("blog.header.title")), 1),
			r("p", Pt, f(p(a)("blog.header.description")), 1)
		], 64));
	}
}), It = kt({
	legacy: !1,
