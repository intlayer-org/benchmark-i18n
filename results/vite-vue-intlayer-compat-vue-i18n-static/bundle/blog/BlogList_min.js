...
import { Fragment as s, computed as c, createElementBlock as l, createElementVNode as u, defineComponent as d, getCurrentInstance as f, h as p, inject as m, openBlock as h, renderList as ee, renderSlot as g, toDisplayString as _, unref as te } from "vue";
var ne = (e, t, n) => typeof e == "string" ? n?.[t]?.[e] ?? n?.[t.split("-")[0] ?? ""]?.[e] : e, v = (e, t, n, r) => {
...
}, re = "translation", ie = "enumeration", ae = "plural", oe = "condition", b = "insertion", se = "object", ce = "array", le = "markdown", x = "html", S = "gender", C = "select", w = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), T = (e, t) => {
...
}, de = (e, t) => e[ue(e, t) ?? "fallback"], fe = 50, D = /* @__PURE__ */ new Map(), O = /* @__PURE__ */ new Set(), pe = (e) => {
...
function k(e, t, n) {
	let i = t ?? r?.defaultLocale, a = `${i}|${n ? JSON.stringify(n) : ""}`, o = e, s = D.get(o);
	s || (s = /* @__PURE__ */ new Map(), D.set(o, s));
	let c = s.get(a);
	if (!c) {
...
var ge = (e, t, n) => e[k("PluralRules", n).select(t)] ?? e.other, _e = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return M(r[b], t, n);
	if (r.nodeType === "html") return M(r[x], t, n);
	...
	if (r.nodeType === "select") {
		let e = r[C], i = j(t, typeof r.variable == "string" ? r.variable : "value");
...
}, F = "\x1B[0m", I = "\x1B[90m", Ce = "\x1B[34m", we = "\x1B[31m", Te = "\x1B[32m", Ee = "\x1B[35m", De = "\x1B[38;5;3m", L = "\x1B[36m", Oe = (e) => e, ke = (e, t) => {
...
}), z = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? F : n : F}` : e, Ae = (e, t = De, n = F) => [e].flat().map((e) => z(e, t, n)).join(", ");
z("✗", we), z("✓", Te), z("⏲", Ce);
var B = /* @__PURE__ */ new WeakMap(), V = 0, je = (e) => {
	if (!e) return "base";
	let t = B.get(e);
	if (t) return t;
	V += 1;
	let n = `p${V}`;
	return B.set(e, n), n;
}, Me = 256, H = /* @__PURE__ */ new WeakMap(), U = (e) => typeof e == "object" && !!e, Ne = (e, t, n) => `${e}_${t}_${je(n)}`, Pe = (e, t) => {
	if (!U(e)) return { hit: !1 };
	let n = H.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, G = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), Fe = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), K = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Fe.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : K(e ? `${e}.${String(n)}` : String(n)) }), Ie = /* @__PURE__ */ new Set(), Le = (t, n, r) => {
	let i = e()[t];
	return i ? at(i, n, r) : (Ie.has(t) || (R({ log: a })(typeof window > "u" ? `Dictionary ${Ae(t)} was not found. Using fallback proxy.` : `Dictionary ${t} was not found. Using fallback proxy.`, { level: "warn" }), Ie.add(t)), K(t));
}, Re = (e) => {
	...
	if (q(e)) return e.nodeType === "html" ? e[x] : e[le];
}, He = (e, t) => {
...
}, Ge = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? J : {
...
}, Ke = J, qe = (e) => J, Je = J, Ye = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? J : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: b }], i = e[b], a = {
			...
			transform: (e, n, r) => {
				if (q(e)) return (i) => Ue(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, Qe = (e, t) => typeof t == "function" && Xe.includes(e?.nodeType ?? "") ? (n) => Ze(e, t, n) : t, $e = J, et = J;
process.env.INTLAYER_OPTIMIZED_NESTING;
var tt = (e) => J, nt = J, rt = (e, t = !0) => [
	...
	$e,
	et
].filter((e) => e !== J), it = (e, t, n = []) => T(e, {
	...t,
	plugins: n
}), Y = /* @__PURE__ */ new WeakSet(), at = (e, t, n) => {
	let { locale: i, selector: a } = {
		locale: t,
		selector: void 0
	}, o = Ne(i ?? r.defaultLocale, "", n), s = Pe(e, o);
...
}, X = Symbol("global-i18n"), lt = "translation", Z = (e, t, n) => {
	try {
		let r = E(Le(t, e), n);
		if (r != null) return r;
	} catch {}
	...
	R({ log: a })(`${z(e, L)} has no effect with ${z("@intlayer/vue-i18n", Ee)} — translations are managed by the compiled intlayer dictionaries.`);
}, ft = ((e = {}) => {
	let t = e.messages;
	...
	let o = i(e.locale), s = e.datetimeFormats, l = e.numberFormats, u = () => String(o.locale.value), d = c({
	...
	}), f = (e, ...n) => ut(u(), void 0, e, n, t), p = (e, t) => v(e, t, u(), s), m = (e, t) => y(e, t, u(), l), h = {
		locale: d,
		availableLocales: dt(),
		...
		__optionsMessages: t,
		install(t) {
			n(t, { locale: e.locale }), t.provide(X, _), t.config.globalProperties.$t = f, t.config.globalProperties.$tc = f, t.config.globalProperties.$te = h.te, t.config.globalProperties.$tm = h.tm, t.config.globalProperties.$rt = h.rt, t.config.globalProperties.$d = p, t.config.globalProperties.$n = m, t.config.globalProperties.$i18n = ee, t.directive("t", {
				beforeMount: g,
				updated: g
			});
		}
	...
	let { locale: t, setLocale: n, availableLocales: r } = ct(), i = m(X)?.__optionsMessages, a = e?.namespace, o = e?.datetimeFormats, s = e?.numberFormats, l = c({
		get: () => t.value,
		set: (e) => {
			n(e);
		}
	...
	return {
		...
		n: (e, n) => y(e, n, t.value, s)
	};
}), mt = { class: "grid gap-6 md:grid-cols-2" }, ht = { class: "mb-3 flex items-center gap-3" }, gt = { class: "rounded-full bg-accent px-3 py-0.5 text-xs font-medium text-accent-foreground" }, _t = { class: "text-xs text-muted-foreground" }, vt = { class: "mb-2 text-lg font-semibold text-foreground" }, yt = { class: "mb-4 text-sm text-muted-foreground" }, bt = {
	type: "button",
	...
	setup(e) {
		let { t } = pt(), n = [
			...
			title: t(`blog.list.post${e}Title`),
			date: t(`blog.list.post${e}Date`),
			excerpt: t(`blog.list.post${e}Excerpt`),
			category: t(`blog.list.post${e}Category`)
		})));
		return (e, n) => (h(), l("div", mt, [(h(!0), l(s, null, ee(r.value, (e) => (h(), l("article", {
			key: e.title,
			class: "rounded-lg border border-border bg-card p-6"
		}, [
			u("div", ht, [u("span", gt, _(e.category), 1), u("span", _t, _(e.date), 1)]),
			u("h2", vt, _(e.title), 1),
			u("p", yt, _(e.excerpt), 1),
			u("button", bt, _(te(t)("blog.list.readMore")), 1)
		]))), 128))]));
	}
}), St = ft({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(St), (e, t) => g(e.$slots, "default");
	}
}), wt = { render() {
	return p(Ct, {}, { default: () => p(xt) });
} };
