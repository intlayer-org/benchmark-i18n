...
import { Fragment, computed, createElementBlock, createElementVNode, defineComponent, getCurrentInstance, h, inject, openBlock, renderList, renderSlot, toDisplayString, unref } from "vue";
...
var OpenPositions_default = defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock(Fragment, null, [createElementVNode("h2", _hoisted_1, toDisplayString(unref(t)("careers.openPositions.title")), 1), createElementVNode("div", _hoisted_2, [(openBlock(), createElementBlock(Fragment, null, renderList(openings, (o, i) => {
				return createElementVNode("div", {
					...
					createElementVNode("h3", _hoisted_3, toDisplayString(unref(t)(`careers.openPositions.${o.titleKey}`)), 1),
					createElementVNode("p", _hoisted_4, toDisplayString(unref(t)(`careers.openPositions.${o.descKey}`)), 1),
					createElementVNode("div", _hoisted_5, [
						createElementVNode("span", _hoisted_6, toDisplayString(unref(t)(`careers.openPositions.${o.deptKey}`)), 1),
						createElementVNode("span", _hoisted_7, toDisplayString(unref(t)(`careers.openPositions.${o.locationKey}`)), 1),
						createElementVNode("span", _hoisted_8, toDisplayString(unref(t)(`careers.openPositions.${o.typeKey}`)), 1)
					])
				]), createElementVNode("button", _hoisted_9, toDisplayString(unref(t)("careers.openPositions.applyNow")), 1)]);
			}), 64))])], 64);
		};
	}
});
