import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, defineComponent as i, getCurrentInstance as a, h as o, inject as s, openBlock as c, readonly as l, ref as u, renderList as d, renderSlot as ee, toDisplayString as f, unref as p } from "vue";
...
var Me = /* @__PURE__ */ new WeakMap(), F = 0, Ne = (e) => {
	...
	"toLocaleString"
]), G = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Je.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : G(e ? `${e}.${String(n)}` : String(n)) }), K = /* @__PURE__ */ new Set(), Ye = (e, t, n) => {
	let r = qe()[e];
	return r ? ft(r, t, n) : (K.has(e) || (N({ log: b })(typeof window > "u" ? `Dictionary ${je(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), K.add(e)), G(e));
}, Xe = (e) => {
...
var ct = (e) => J, lt = J, ut = (e, t = !0) => [
	...
	if (Y) return Y;
	pt();
	let { defaultLocale: r } = v ?? {}, i = u(e ?? r), a = (e) => {
		i.value = e;
	}, o = u(n);
	return Y = {
		locale: l(i),
...
var X = {
	...
	if (!yt) for (let t = 0; t < (y.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(y.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, xt = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !yt && y.storage.cookies) for (let n = 0; n < y.storage.cookies.length; n++) {
...
var St = (e, t) => xt(e, {
	...X,
	isCookieEnabled: t
}), { defaultLocale: Ct, locales: wt } = v ?? {}, Tt = ({ isCookieEnabled: e, onLocaleChange: n } = {}) => {
	let r = s(mt);
	return {
	...
	let r = ht(e.locale), i = e.datetimeFormats, a = e.numberFormats, o = () => String(r.locale.value), s = t({
	...
	}), c = (e, ...t) => Ot(o(), void 0, e, t, n), l = (e, t) => ne(e, t, o(), i), u = (e, t) => re(e, t, o(), a), d = {
		locale: s,
		availableLocales: kt(),
		...
		__optionsMessages: n,
		install(t) {
			gt(t, { locale: e.locale }), t.provide(Et, p), t.config.globalProperties.$t = c, t.config.globalProperties.$tc = c, t.config.globalProperties.$te = d.te, t.config.globalProperties.$tm = d.tm, t.config.globalProperties.$rt = d.rt, t.config.globalProperties.$d = l, t.config.globalProperties.$n = u, t.config.globalProperties.$i18n = ee, t.directive("t", {
				beforeMount: f,
				updated: f
			});
		}
	...
	let { locale: n, setLocale: r, availableLocales: i } = Tt(), a = s(Et)?.__optionsMessages, o = e?.namespace, c = e?.datetimeFormats, l = e?.numberFormats, u = t({
		get: () => n.value,
		set: (e) => {
			r(e);
		}
	...
	return {
		...
		d: (e, t) => ne(e, t, n.value, c),
		n: (e, t) => re(e, t, n.value, l)
	};
}), Mt = { class: "mb-6 text-2xl font-bold text-foreground" }, Nt = { class: "space-y-4" }, Pt = { class: "text-base font-semibold text-foreground" }, Ft = { class: "text-sm text-muted-foreground" }, It = { class: "mt-2 flex gap-2" }, Lt = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, Rt = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, zt = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, Bt = {
	type: "button",
	...
	setup(t) {
		...
		return (t, o) => (c(), n(e, null, [r("h2", Mt, f(p(i)("careers.openPositions.title")), 1), r("div", Nt, [(c(), n(e, null, d(a, (e, t) => r("div", {
			...
			r("h3", Pt, f(p(i)(`careers.openPositions.${e.titleKey}`)), 1),
			r("p", Ft, f(p(i)(`careers.openPositions.${e.descKey}`)), 1),
			r("div", It, [
				r("span", Lt, f(p(i)(`careers.openPositions.${e.deptKey}`)), 1),
				r("span", Rt, f(p(i)(`careers.openPositions.${e.locationKey}`)), 1),
				r("span", zt, f(p(i)(`careers.openPositions.${e.typeKey}`)), 1)
			])
		]), r("button", Bt, f(p(i)("careers.openPositions.applyNow")), 1)])), 64))])], 64));
	}
}), Ht = At({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Ht), (e, t) => ee(e.$slots, "default");
	}
}), Wt = { render() {
	return o(Ut, {}, { default: () => o(Vt) });
} };
