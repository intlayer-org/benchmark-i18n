...
import { Fragment as s, computed as c, createElementBlock as l, createElementVNode as u, defineComponent as d, getCurrentInstance as f, h as p, inject as m, openBlock as h, renderList as g, renderSlot as _, toDisplayString as v, unref as y, withModifiers as ee } from "vue";
...
}, re = "translation", x = "enumeration", ie = "plural", ae = "condition", S = "insertion", oe = "object", se = "array", ce = "markdown", C = "html", w = "gender", T = "select", E = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), D = (e, t) => {
...
}, ue = (e, t) => e[le(e, t) ?? "fallback"], de = 50, fe = /* @__PURE__ */ new Map(), pe = /* @__PURE__ */ new Set(), me = (e) => {
...
var _e = (e, t, n) => e[k("PluralRules", n).select(t)] ?? e.other, ve = (e, t) => {
	...
	if (r.nodeType === "plural") {
		let e = r[ie];
		return P(_e(e, Number(N(t, "count") ?? 1), n), t, n);
	}
...
}, L = "\x1B[0m", R = "\x1B[90m", Se = "\x1B[34m", Ce = "\x1B[31m", we = "\x1B[32m", Te = "\x1B[35m", Ee = "\x1B[38;5;3m", z = "\x1B[36m", De = (e) => e, Oe = (e, t) => {
...
}), V = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? L : n : L}` : e, ke = (e, t = Ee, n = L) => [e].flat().map((e) => V(e, t, n)).join(", ");
V("✗", Ce), V("✓", we), V("⏲", Se);
var H = /* @__PURE__ */ new WeakMap(), U = 0, Ae = (e) => {
	if (!e) return "base";
	let t = H.get(e);
	if (t) return t;
	U += 1;
	let n = `p${U}`;
	return H.set(e, n), n;
}, je = 256, W = /* @__PURE__ */ new WeakMap(), G = (e) => typeof e == "object" && !!e, Me = (e, t, n) => `${e}_${t}_${Ae(n)}`, Ne = (e, t) => {
	if (!G(e)) return { hit: !1 };
	let n = W.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, q = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), Pe = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	...
	yield e;
} : Fe(e ? `${e}.${String(n)}` : String(n)) }), Ie = /* @__PURE__ */ new Set(), Le = (t, n, r) => {
	let i = e()[t];
	return i ? at(i, n, r) : (Ie.has(t) || (B({ log: a })(typeof window > "u" ? `Dictionary ${ke(t)} was not found. Using fallback proxy.` : `Dictionary ${t} was not found. Using fallback proxy.`, { level: "warn" }), Ie.add(t)), Fe(t));
}, Re = (e) => {
	...
	if (J(e)) return e.nodeType === "html" ? e[C] : e[ce];
}, He = (e, t) => {
...
var tt = (e) => Y, nt = Y, rt = (e, t = !0) => [
	...
	B({ log: a })(`${V(e, z)} has no effect with ${V("@intlayer/vue-i18n", Te)} — translations are managed by the compiled intlayer dictionaries.`);
}, pt = ((e = {}) => {
	let t = e.messages;
	...
	}), f = (e, ...n) => dt(u(), void 0, e, n, t), p = (e, t) => ne(e, t, u(), s), m = (e, t) => b(e, t, u(), l), h = {
		locale: d,
		availableLocales: ft(),
	...
	let { locale: t, setLocale: n, availableLocales: r } = ct(), i = m(lt)?.__optionsMessages, a = e?.namespace, o = e?.datetimeFormats, s = e?.numberFormats, l = c({
		get: () => t.value,
		set: (e) => {
			n(e);
		}
...
}), ht = { class: "grid gap-4 md:grid-cols-2" }, gt = {
	for: "name",
	...
	setup(e) {
		...
		return (e, r) => (h(), l("form", {
			class: "space-y-6",
			onSubmit: r[0] ||= ee(() => {}, ["prevent"])
		}, [
			u("div", ht, [u("div", null, [u("label", gt, v(y(t)("contact.form.name")), 1), u("input", {
				id: "name",
				...
				placeholder: y(t)("contact.form.yourName")
			}, null, 8, _t)]), u("div", null, [u("label", vt, v(y(t)("contact.form.email")), 1), u("input", {
				id: "email",
				type: "email",
				class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: y(t)("contact.form.emailPlaceholder")
			}, null, 8, yt)])]),
			u("div", null, [u("label", bt, v(y(t)("contact.form.topic")), 1), u("select", xt, [(h(), l(s, null, g(n, (e) => u("option", {
				key: e,
				value: e
			}, v(y(t)(`contact.form.${e}`)), 9, St)), 64))])]),
			u("div", null, [u("label", Ct, v(y(t)("contact.form.message")), 1), u("textarea", {
				id: "message",
				rows: "5",
				class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: y(t)("contact.form.messagePlaceholder")
			}, null, 8, wt)]),
			u("button", Tt, v(y(t)("contact.form.sendMessage")), 1)
		], 32));
	}
}), Dt = pt({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Dt), (e, t) => _(e.$slots, "default");
	}
}), kt = { render() {
	return p(Ot, {}, { default: () => p(Et) });
} };
