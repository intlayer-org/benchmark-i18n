...
var R = /* @__PURE__ */ new WeakMap(), z = 0, Ae = (e) => {
	...
	let r = qe()[e];
	return r ? mt(r, t, n) : (Xe.has(e) || (I({ log: C })(typeof window > "u" ? `Dictionary ${ke(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Xe.add(e)), Ye(e));
}, Qe = (e) => {
...
var wt = (e, t) => Ct(e, {
	...
	}), c = (e, ...t) => At(o(), void 0, e, t, n), l = (e, t) => te(e, t, o(), i), u = (e, t) => ne(e, t, o(), a), d = {
		locale: s,
		availableLocales: Q(),
...
}), Nt = { class: "grid gap-4 md:grid-cols-2" }, Pt = {
	for: "name",
	...
	setup(t) {
		...
		return (t, o) => (c(), n("form", {
			...
			r("div", Nt, [r("div", null, [r("label", Pt, p(m(i)("contact.form.name")), 1), r("input", {
				id: "name",
			...
			}, null, 8, Ft)]), r("div", null, [r("label", It, p(m(i)("contact.form.email")), 1), r("input", {
				id: "email",
				type: "email",
				class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: m(i)("contact.form.emailPlaceholder")
			}, null, 8, Lt)])]),
			r("div", null, [r("label", Rt, p(m(i)("contact.form.topic")), 1), r("select", zt, [(c(), n(e, null, d(a, (e) => r("option", {
				key: e,
				value: e
			}, p(m(i)(`contact.form.${e}`)), 9, Bt)), 64))])]),
			r("div", null, [r("label", Vt, p(m(i)("contact.form.message")), 1), r("textarea", {
				id: "message",
				rows: "5",
				class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: m(i)("contact.form.messagePlaceholder")
			}, null, 8, Ht)]),
			r("button", Ut, p(m(i)("contact.form.sendMessage")), 1)
		], 32));
	}
}), Gt = jt({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Gt), (e, t) => f(e.$slots, "default");
	}
}), qt = { render() {
	return o(Kt, {}, { default: () => o(Wt) });
} };
