...
var B = /* @__PURE__ */ new WeakMap(), V = 0, Oe = (e) => {
...
}, Ne = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), W = "default", Pe = /[^A-Za-z0-9._&=-]/g, Fe = /[^A-Za-z0-9._-]/g, Ie = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, G = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, Ie);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, Le = (e) => e === void 0 ? W : typeof e == "string" ? G(e, Pe) : Object.keys(e).sort().map((t) => `${G(t, Fe)}=${G(String(e[t]), Fe)}`).join("&"), Re = (e) => Array.isArray(e) ? e.length === 0 ? [W] : e.map(Le) : [Le(e)], ze = (e, t) => {
	...
	if (!Ve(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? W : ze(Re(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => Be(e, n, t, s)).map((t) => He(e, t));
	...
	let n = e[t];
	return `${t}:${t === "variant" ? Re(n).join(",") : String(n)}`;
}).join("|") : "", Ke = {
	faq: {
		key: "faq",
	...
	let r = qe()[e];
	return r ? mt(r, t, n) : (Xe.has(e) || (R({ log: T })(typeof window > "u" ? `Dictionary ${De(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Xe.add(e)), Ye(e));
}, Qe = (e) => {
	...
	canHandle: () => !1,
	transform: (e) => e
}, it = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? q : {
...
}, at = q, ot = q, st = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? q : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: v }], i = e[v], a = {
			...
			transform: (e, n, r) => {
				if (K(e)) return (i) => rt(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
var ut = (e) => q, dt = q, ft = (e, t = !0) => [
	it(e ?? C.defaultLocale, t ? C.defaultLocale : void 0),
	at,
	ot,
	st,
	ut(e ?? C.defaultLocale),
	dt,
	ct,
	lt
], pt = (e, t, n = []) => x(e, {
	...
	let { locale: r, selector: i } = We(t), a = je(r ?? C.defaultLocale, Ge(i), n), o = Me(e, a);
	if (o.hit) return o.content;
	let s = n ?? ft(r), c = Ue(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
}, gt = Symbol("intlayer"), J = null, _t = (e, t = !0, n) => {
	if (J) return J;
	ht();
	...
	let { locale: n, isCookieEnabled: r, variant: i } = t ?? {}, a = _t(n, r, i);
	return e.provide(gt, a), e;
}, yt = (e) => {
...
var Y = {
	...
	if (!xt) for (let t = 0; t < (w.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(w.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, Ct = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !xt && w.storage.cookies) for (let n = 0; n < w.storage.cookies.length; n++) {
		let { name: r, attributes: i } = w.storage.cookies[n];
		try {
			t?.setCookieStore && t.setCookieStore(r, e, {
				...i,
				expires: yt(i.expires)
			});
		} catch {
			try {
...
var wt = (e, t) => Ct(e, {
	...Y,
	isCookieEnabled: t
}), { defaultLocale: Tt, locales: Et } = C ?? {}, Dt = ({ isCookieEnabled: e, onLocaleChange: n } = {}) => {
	let r = l(gt);
	return {
		locale: t(() => r?.locale?.value ?? Tt),
		defaultLocale: Tt,
		availableLocales: Et,
		setLocale: (t) => {
			if (!Et?.map(String).includes(t)) {
				console.error(`Locale ${t} is not available`);
				return;
			}
			r && r.setLocale(t), wt(t, e ?? r?.isCookieEnabled ?? !0), n?.(t);
		}
	};
}, Ot = Symbol("global-i18n"), kt = "translation", X = (e, t, n) => {
	try {
		let r = S(Ze(t, e), n);
		if (r != null) return r;
	} catch {}
	...
	let { values: a, count: o, defaultMessage: s } = N(r), c = Z(e, t, n);
	if (c === void 0) {
		if (i?.[e]) {
	...
	let r = _t(e.locale), i = e.datetimeFormats, a = e.numberFormats, o = () => String(r.locale.value), s = t({
		get: () => o(),
		set: (e) => {
			r.setLocale(e);
		}
	}), c = (e, ...t) => At(o(), void 0, e, t, n), l = (e, t) => g(e, t, o(), i), u = (e, t) => _(e, t, o(), a), d = {
		locale: s,
		availableLocales: jt(),
		...
		__optionsMessages: n,
		install(t) {
			vt(t, { locale: e.locale }), t.provide(Ot, m), t.config.globalProperties.$t = c, t.config.globalProperties.$tc = c, t.config.globalProperties.$te = d.te, t.config.globalProperties.$tm = d.tm, t.config.globalProperties.$rt = d.rt, t.config.globalProperties.$d = l, t.config.globalProperties.$n = u, t.config.globalProperties.$i18n = f, t.directive("t", {
				beforeMount: p,
				updated: p
			});
		}
	...
	let { locale: n, setLocale: r, availableLocales: i } = Dt(), a = l(Ot)?.__optionsMessages, o = e?.namespace, s = e?.datetimeFormats, c = e?.numberFormats, u = t({
		get: () => n.value,
		set: (e) => {
			r(e);
		}
	}), d = (e, ...t) => At(n.value, o, e, t, a);
	return {
		locale: u,
		availableLocales: i,
		t: d,
...
}), Nt = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, Pt = o({
	__name: "MockBanner",
	setup(e) {
		let { t } = $();
		return (e, r) => (u(), n("div", Nt, m(h(t)("mockBanner")), 1));
	}
}), Ft = { class: "mb-2 text-3xl font-bold text-foreground" }, It = { class: "mb-8 text-muted-foreground" }, Lt = {
	...
	setup(t) {
		...
		return (t, s) => (u(), n(e, null, [
			a(Pt),
			r("h1", Ft, m(h(o)("contact.header.title")), 1),
			r("p", It, [
				i(m(h(o)("contact.header.description")) + " ", 1),
				r("a", Lt, m(h(o)("shared.contactEmail")), 1),
				s[0] ||= i(". ", -1)
			])
		], 64));
	}
