...
import { Fragment as s, computed as c, createElementBlock as l, createElementVNode as u, createTextVNode as d, createVNode as f, defineComponent as p, getCurrentInstance as m, h, inject as g, openBlock as _, renderSlot as v, toDisplayString as y, unref as b } from "vue";
var x = (e, t, n) => typeof e == "string" ? n?.[t]?.[e] ?? n?.[t.split("-")[0] ?? ""]?.[e] : e, S = (e, t, n, r) => {
...
}, te = "translation", C = "enumeration", w = "plural", ne = "condition", T = "insertion", re = "object", ie = "array", E = "markdown", D = "html", ae = "gender", oe = "select", O = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), k = (e, t) => {
...
var ge = (e, t, n) => e[A("PluralRules", n).select(t)] ?? e.other, _e = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return I(r[T], t, n);
	if (r.nodeType === "html") return I(r[D], t, n);
	if (r.nodeType === "plural") {
		let e = r[w];
		return I(ge(e, Number(F(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[C], i = j.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
}, z = "\x1B[0m", B = "\x1B[90m", be = "\x1B[34m", xe = "\x1B[31m", Se = "\x1B[32m", Ce = "\x1B[35m", we = "\x1B[38;5;3m", V = "\x1B[36m", Te = (e) => e, Ee = (e, t) => {
...
}), U = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? z : n : z}` : e, De = (e, t = we, n = z) => [e].flat().map((e) => U(e, t, n)).join(", ");
U("✗", xe), U("✓", Se), U("⏲", be);
var Oe = /* @__PURE__ */ new WeakMap(), ke = 0, Ae = (e) => {
	...
	let n = `p${ke}`;
	return Oe.set(e, n), n;
}, je = 256, W = /* @__PURE__ */ new WeakMap(), Me = (e) => typeof e == "object" && !!e, Ne = (e, t, n) => `${e}_${t}_${Ae(n)}`, Pe = (e, t) => {
...
}, Fe = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), Ie = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	...
	yield e;
} : Le(e ? `${e}.${String(n)}` : String(n)) }), Re = /* @__PURE__ */ new Set(), ze = (t, n, r) => {
	let i = e()[t];
	return i ? st(i, n, r) : (Re.has(t) || (H({ log: a })(typeof window > "u" ? `Dictionary ${De(t)} was not found. Using fallback proxy.` : `Dictionary ${t} was not found. Using fallback proxy.`, { level: "warn" }), Re.add(t)), Le(t));
}, Be = (e) => {
	...
	if (K(e)) return e.nodeType === "html" ? e[D] : e[E];
}, We = (e, t) => {
...
var rt = (e) => q, it = q, at = (e, t = !0) => [
	qe(e ?? r.defaultLocale, t ? r.defaultLocale : void 0),
	Je,
	Ye(e ?? r.defaultLocale),
	Xe,
	Ze,
	rt(e ?? r.defaultLocale),
	it,
	tt,
	nt
].filter((e) => e !== q), ot = (e, t, n = []) => k(e, {
	...t,
	plugins: n
	...
	let c = n ?? at(i), l = e, u = (e) => {
		...
		J.add(e);
		try {
			return ot(e.content, t, c);
		} finally {
			t.eager && J.delete(e);
		}
	};
	return l === null ? G(e, o, null) : Array.isArray(l) ? G(e, o, l.map(u)) : G(e, o, u(l));
}, { defaultLocale: ct, locales: Y } = r ?? {}, lt = ({ isCookieEnabled: e, onLocaleChange: n } = {}) => {
	let r = g(o);
	return {
		locale: c(() => r?.locale?.value ?? ct),
		defaultLocale: ct,
		availableLocales: Y,
		setLocale: (i) => {
			if (!Y?.map(String).includes(i)) {
...
}, ut = Symbol("global-i18n"), dt = "translation", X = (e, t, n) => {
	try {
		let r = se(ze(t, e), n);
		if (r != null) return r;
	} catch {}
	...
	let { values: a, count: o, defaultMessage: s } = L(r), c = Z(e, t, n);
	if (c === void 0) {
		if (i?.[e]) {
	...
	return R(c, a, o, e);
}, pt = () => r?.locales?.map(String) ?? [], Q = (e) => {
	H({ log: a })(`${U(e, V)} has no effect with ${U("@intlayer/vue-i18n", Ce)} — translations are managed by the compiled intlayer dictionaries.`);
}, mt = ((e = {}) => {
	let t = e.messages;
	...
	let o = i(e.locale), s = e.datetimeFormats, l = e.numberFormats, u = () => String(o.locale.value), d = c({
	...
	}), f = (e, ...n) => ft(u(), void 0, e, n, t), p = (e, t) => S(e, t, u(), s), m = (e, t) => ee(e, t, u(), l), h = {
		locale: d,
		availableLocales: pt(),
		...
		__optionsMessages: t,
		install(t) {
			n(t, { locale: e.locale }), t.provide(ut, v), t.config.globalProperties.$t = f, t.config.globalProperties.$tc = f, t.config.globalProperties.$te = h.te, t.config.globalProperties.$tm = h.tm, t.config.globalProperties.$rt = h.rt, t.config.globalProperties.$d = p, t.config.globalProperties.$n = m, t.config.globalProperties.$i18n = g, t.directive("t", {
				beforeMount: _,
				updated: _
			});
		}
	...
	let { locale: t, setLocale: n, availableLocales: r } = lt(), i = g(ut)?.__optionsMessages, a = e?.namespace, o = e?.datetimeFormats, s = e?.numberFormats, l = c({
		get: () => t.value,
		set: (e) => {
			n(e);
		}
	...
	return {
		...
		d: (e, n) => S(e, n, t.value, o),
		n: (e, n) => ee(e, n, t.value, s)
	};
}), ht = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, gt = p({
	__name: "MockBanner",
	setup(e) {
		let { t } = $();
		return (e, n) => (_(), l("div", ht, y(b(t)("mockBanner")), 1));
	}
}), _t = { class: "mb-2 text-3xl font-bold text-foreground" }, vt = { class: "mb-8 text-muted-foreground" }, yt = {
	...
	setup(e) {
		let { t } = $();
		return (e, n) => (_(), l(s, null, [
			f(gt),
			u("h1", _t, y(b(t)("contact.header.title")), 1),
			u("p", vt, [
				d(y(b(t)("contact.header.description")) + " ", 1),
				u("a", yt, y(b(t)("shared.contactEmail")), 1),
				n[0] ||= d(". ", -1)
			])
		], 64));
	}
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(xt), (e, t) => v(e.$slots, "default");
	}
}), Ct = { render() {
	return h(St, {}, { default: () => h(bt) });
} };
