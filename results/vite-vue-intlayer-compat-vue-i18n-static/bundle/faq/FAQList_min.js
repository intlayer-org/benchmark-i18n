...
var tt = (e) => J, nt = J, rt = (e, t = !0) => [
...
}), mt = { class: "mx-auto max-w-3xl space-y-4" }, ht = { class: "cursor-pointer px-6 py-4 text-sm font-medium text-foreground hover:bg-accent/50 transition-colors" }, gt = { class: "px-6 pb-4 text-sm text-muted-foreground" }, _t = d({
	__name: "FAQList",
	setup(e) {
		let { t } = pt(), n = [
			1,
		...
		return (e, t) => (h(), l("div", mt, [(h(!0), l(s, null, ee(te(n), (e, t) => (h(), l("details", {
			key: t,
			class: "group rounded-lg border border-border bg-card"
		}, [u("summary", ht, _(e.q), 1), u("p", gt, _(e.a), 1)]))), 128))]));
	}
}), vt = ft({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(vt), (e, t) => g(e.$slots, "default");
	}
}), bt = { render() {
