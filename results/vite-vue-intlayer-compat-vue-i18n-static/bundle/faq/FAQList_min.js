...
var St = (e, t) => xt(e, {
...
}), Mt = { class: "mx-auto max-w-3xl space-y-4" }, Nt = { class: "cursor-pointer px-6 py-4 text-sm font-medium text-foreground hover:bg-accent/50 transition-colors" }, Pt = { class: "px-6 pb-4 text-sm text-muted-foreground" }, Ft = i({
	__name: "FAQList",
	setup(t) {
		let { t: i } = jt(), a = [
			1,
		...
		return (t, i) => (c(), n("div", Mt, [(c(!0), n(e, null, d(m(a), (e, t) => (c(), n("details", {
			key: t,
			class: "group rounded-lg border border-border bg-card"
		}, [r("summary", Nt, p(e.q), 1), r("p", Pt, p(e.a), 1)]))), 128))]));
	}
}), It = At({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(It), (e, t) => f(e.$slots, "default");
	}
}), Rt = { render() {
