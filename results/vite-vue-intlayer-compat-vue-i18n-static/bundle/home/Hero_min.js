...
var Nt = { class: "mb-16 text-center" }, Pt = { class: "mb-4 text-4xl font-bold tracking-tight text-foreground" }, Ft = { class: "mx-auto max-w-2xl text-lg text-muted-foreground" }, It = { class: "mt-8 flex justify-center gap-4" }, Lt = {
	type: "button",
	...
	setup(e) {
		Mt("Hero");
		let { t: r } = jt();
		return (e, i) => (l(), t("section", Nt, [
			n("h1", Pt, f(p(r)("home.hero.title")), 1),
			n("p", Ft, f(p(r)("home.hero.description")), 1),
			n("div", It, [n("button", Lt, f(p(r)("home.hero.viewResults")), 1), n("button", Rt, f(p(r)("home.hero.methodology")), 1)])
		]));
	}
}), Bt = At({
	legacy: !1,
