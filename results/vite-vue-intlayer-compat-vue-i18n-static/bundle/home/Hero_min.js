...
var Mt = { class: "mb-16 text-center" }, Nt = { class: "mb-4 text-4xl font-bold tracking-tight text-foreground" }, Pt = { class: "mx-auto max-w-2xl text-lg text-muted-foreground" }, Ft = { class: "mt-8 flex justify-center gap-4" }, It = {
	type: "button",
	...
	setup(e) {
		jt("Hero");
		let { t: r } = At();
		return (e, i) => (l(), t("section", Mt, [
			n("h1", Nt, f(p(r)("home.hero.title")), 1),
			n("p", Pt, f(p(r)("home.hero.description")), 1),
			n("div", Ft, [n("button", It, f(p(r)("home.hero.viewResults")), 1), n("button", Lt, f(p(r)("home.hero.methodology")), 1)])
		]));
	}
}), zt = kt({
	legacy: !1,
