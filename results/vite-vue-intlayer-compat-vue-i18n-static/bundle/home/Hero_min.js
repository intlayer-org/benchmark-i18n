...
var ht = { class: "mb-16 text-center" }, gt = { class: "mb-4 text-4xl font-bold tracking-tight text-foreground" }, _t = { class: "mx-auto max-w-2xl text-lg text-muted-foreground" }, vt = { class: "mt-8 flex justify-center gap-4" }, yt = {
	type: "button",
	...
	setup(e) {
		mt("Hero");
		let { t } = pt();
		return (e, n) => (g(), c("section", ht, [
			l("h1", gt, v(y(t)("home.hero.title")), 1),
			l("p", _t, v(y(t)("home.hero.description")), 1),
			l("div", vt, [l("button", yt, v(y(t)("home.hero.viewResults")), 1), l("button", bt, v(y(t)("home.hero.methodology")), 1)])
		]));
	}
}), St = ft({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(St), (e, t) => _(e.$slots, "default");
	}
}), wt = { render() {
	return f(Ct, {}, { default: () => f(xt) });
} };
