...
var jt = r({
	...
	return n;
}, Nt = { class: "mb-16 text-center" }, Pt = { class: "mb-4 text-4xl font-bold tracking-tight text-foreground" }, Ft = { class: "mx-auto max-w-2xl text-lg text-muted-foreground" }, It = { class: "mt-8 flex justify-center gap-4" }, Lt = {
	type: "button",
...
function zt(e, r, i, a, o, s) {
	return l(), t("section", Nt, [
		n("h1", Pt, p(a.t("home.hero.title")), 1),
		n("p", Ft, p(a.t("home.hero.description")), 1),
		n("div", It, [n("button", Lt, p(a.t("home.hero.viewResults")), 1), n("button", Rt, p(a.t("home.hero.methodology")), 1)])
	]);
}
var Bt = Mt(jt, [["render", zt], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/src/components/pages/home/Hero.vue"]]), Vt = Ot({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en"
}), Ht = r({
...
var Wt = Mt(Ht, [["render", Ut], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/scripts/Wrapper.vue"]]), Gt = { render() {
	return a(Wt, {}, { default: () => a(Bt) });
} };
