...
var je = /* @__PURE__ */ new WeakMap(), Me = 0, Ne = (e) => {
	...
	let r = qe()[e];
	return r ? mt(r, t, n) : (Xe.has(e) || (I({ log: C })(typeof window > "u" ? `Dictionary ${Ae(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Xe.add(e)), Ye(e));
}, Qe = (e) => {
...
}, at = J, ot = J, st = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? J : {
	id: "insertion-plugin",
...
var ut = (e) => J, dt = J, ft = (e, t = !0) => [
	it(e ?? x.defaultLocale, t ? x.defaultLocale : void 0),
	at,
	ot,
	st,
	ut(e ?? x.defaultLocale),
	dt,
	ct,
	lt
], pt = (e, t, n = []) => b(e, {
...
}, gt = Symbol("intlayer"), Y = null, _t = (e, t = !0, n) => {
	if (Y) return Y;
	ht();
...
var X = {
	...
	if (!xt) for (let t = 0; t < (S.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(S.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, Ct = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !xt && S.storage.cookies) for (let n = 0; n < S.storage.cookies.length; n++) {
...
var wt = (e, t) => Ct(e, {
	...X,
	isCookieEnabled: t
}), { defaultLocale: Tt, locales: Et } = x ?? {}, Dt = ({ isCookieEnabled: e, onLocaleChange: n } = {}) => {
	let r = s(gt);
	return {
...
}, Ot = Symbol("global-i18n"), kt = "translation", Z = (e, t, n) => {
	try {
		let r = ue(Ze(t, e), n);
		if (r != null) return r;
	} catch {}
	...
	}), c = (e, ...t) => At(o(), void 0, e, t, n), l = (e, t) => ee(e, t, o(), i), u = (e, t) => te(e, t, o(), a), d = {
		locale: s,
		availableLocales: jt(),
	...
	let { locale: n, setLocale: r, availableLocales: i } = Dt(), a = s(Ot)?.__optionsMessages, o = e?.namespace, c = e?.datetimeFormats, l = e?.numberFormats, u = t({
		get: () => n.value,
		set: (e) => {
			r(e);
		}
...
var Ft = { class: "mb-6 text-2xl font-bold text-foreground" }, It = { class: "overflow-x-auto rounded-lg border border-border" }, Lt = { class: "w-full text-sm" }, Rt = { class: "bg-muted" }, zt = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, Bt = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, Vt = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, Ht = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, Ut = { class: "px-4 py-3 font-medium text-foreground" }, Wt = { class: "px-4 py-3 text-muted-foreground" }, Gt = { class: "px-4 py-3 text-muted-foreground" }, Kt = { class: "px-4 py-3 text-muted-foreground" }, qt = i({
	__name: "ResultsTable",
	setup(i) {
		Pt("ResultsTable");
		let { t: a } = Nt(), o = t(() => [
		...
		return (t, i) => (u(), n("section", null, [r("h2", Ft, h(g(a)("home.resultsTable.title")), 1), r("div", It, [r("table", Lt, [r("thead", Rt, [r("tr", null, [
			r("th", zt, h(g(a)("home.resultsTable.library")), 1),
			r("th", Bt, h(g(a)("home.resultsTable.bundleSize")), 1),
			r("th", Vt, h(g(a)("home.resultsTable.lookupTime")), 1),
			r("th", Ht, h(g(a)("home.resultsTable.lazyLoading")), 1)
