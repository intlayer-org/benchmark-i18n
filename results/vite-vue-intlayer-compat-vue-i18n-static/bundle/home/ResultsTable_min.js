import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, defineComponent as i, getCurrentInstance as a, h as o, inject as s, onBeforeMount as c, onMounted as l, openBlock as u, readonly as d, ref as f, renderList as p, renderSlot as m, toDisplayString as h } from "vue";
...
var Nt = i({
	...
	return n;
}, Ft = { class: "mb-6 text-2xl font-bold text-foreground" }, It = { class: "overflow-x-auto rounded-lg border border-border" }, Lt = { class: "w-full text-sm" }, Rt = { class: "bg-muted" }, zt = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, Bt = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, Vt = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, Ht = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, Ut = { class: "px-4 py-3 font-medium text-foreground" }, Wt = { class: "px-4 py-3 text-muted-foreground" }, Gt = { class: "px-4 py-3 text-muted-foreground" }, Kt = { class: "px-4 py-3 text-muted-foreground" };
function qt(t, i, a, o, s, c) {
	return u(), n("section", null, [r("h2", Ft, h(o.t("home.resultsTable.title")), 1), r("div", It, [r("table", Lt, [r("thead", Rt, [r("tr", null, [
		r("th", zt, h(o.t("home.resultsTable.library")), 1),
		r("th", Bt, h(o.t("home.resultsTable.bundleSize")), 1),
		r("th", Vt, h(o.t("home.resultsTable.lookupTime")), 1),
		r("th", Ht, h(o.t("home.resultsTable.lazyLoading")), 1)
	])]), r("tbody", null, [(u(!0), n(e, null, p(o.results, (e) => (u(), n("tr", {
		key: e.lib,
...
var Jt = Pt(Nt, [["render", qt], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/src/components/pages/home/ResultsTable.vue"]]), Yt = At({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en"
}), Xt = i({
	...
	setup(e, { expose: t }) {
		...
		n && !n.config.globalProperties.$i18n && n.use(Yt);
		let r = { app: n };
...
var Qt = Pt(Xt, [["render", Zt], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/scripts/Wrapper.vue"]]), $t = { render() {
	return o(Qt, {}, { default: () => o(Jt) });
} };
export { $t as default };
