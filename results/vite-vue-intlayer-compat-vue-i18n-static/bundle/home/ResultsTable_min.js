...
import { Fragment as s, computed as c, createElementBlock as l, createElementVNode as u, defineComponent as d, getCurrentInstance as f, h as p, inject as m, onBeforeMount as h, onMounted as ee, openBlock as g, renderList as _, renderSlot as te, toDisplayString as v, unref as y } from "vue";
var ne = (e, t, n) => typeof e == "string" ? n?.[t]?.[e] ?? n?.[t.split("-")[0] ?? ""]?.[e] : e, b = (e, t, n, r) => {
	let i = e instanceof Date ? e : new Date(e), a = ne(t, n, r);
	try {
...
}, re = "translation", ie = "enumeration", ae = "plural", oe = "condition", S = "insertion", se = "object", ce = "array", le = "markdown", C = "html", w = "gender", T = "select", E = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), D = (e, t) => {
...
}, de = (e, t) => e[ue(e, t) ?? "fallback"], fe = 50, pe = /* @__PURE__ */ new Map(), me = /* @__PURE__ */ new Set(), he = (e) => {
...
function k(e, t, n) {
	let i = t ?? r?.defaultLocale, a = `${i}|${n ? JSON.stringify(n) : ""}`, o = e, s = pe.get(o);
	s || (s = /* @__PURE__ */ new Map(), pe.set(o, s));
	let c = s.get(a);
	if (!c) {
...
var ve = (e, t, n) => e[k("PluralRules", n).select(t)] ?? e.other, ye = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return F(r[S], t, n);
	if (r.nodeType === "html") return F(r[C], t, n);
	if (r.nodeType === "plural") {
		let e = r[ae];
		return F(ve(e, Number(P(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[ie], i = A.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	return e;
}, be = (e) => e.split(/(?<!\\)\|/).map((e) => e.replace(/\\\|/g, "|").trim()), xe = (e, t) => {
	let n = Math.abs(e);
	...
	if (n !== void 0 && (i.count ??= n, i.n ??= n), typeof e == "string") {
		...
		if (/(?<!\\)\|/.test(t)) {
			let e = be(t);
			t = e[xe(n ?? 1, e.length)] ?? t;
		}
		return N(t, i, r);
	}
	let a = F(e, i, r);
	return typeof a == "string" ? a : String(a ?? "");
}, R = "\x1B[0m", z = "\x1B[90m", Se = "\x1B[34m", Ce = "\x1B[31m", we = "\x1B[32m", Te = "\x1B[35m", Ee = "\x1B[38;5;3m", B = "\x1B[36m", De = (e) => e, Oe = (e, t) => {
...
}), H = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? R : n : R}` : e, ke = (e, t = Ee, n = R) => [e].flat().map((e) => H(e, t, n)).join(", ");
H("✗", Ce), H("✓", we), H("⏲", Se);
var U = /* @__PURE__ */ new WeakMap(), W = 0, Ae = (e) => {
	if (!e) return "base";
	let t = U.get(e);
	if (t) return t;
	W += 1;
	let n = `p${W}`;
	return U.set(e, n), n;
}, je = 256, G = /* @__PURE__ */ new WeakMap(), K = (e) => typeof e == "object" && !!e, Me = (e, t, n) => `${e}_${t}_${Ae(n)}`, Ne = (e, t) => {
	if (!K(e)) return { hit: !1 };
	let n = G.get(e);
	return n?.has(t) ? {
		hit: !0,
	...
	let i = e()[t];
	return i ? ot(i, n, r) : (Le.has(t) || (V({ log: a })(typeof window > "u" ? `Dictionary ${ke(t)} was not found. Using fallback proxy.` : `Dictionary ${t} was not found. Using fallback proxy.`, { level: "warn" }), Le.add(t)), Ie(t));
}, ze = (e) => {
	...
	if (J(e)) return e.nodeType === "html" ? e[C] : e[le];
}, Ue = (e, t) => {
	if (typeof e == "string") return t;
	if (J(e)) {
		let n = e.nodeType === "html" ? C : le;
		return {
			...e,
			[n]: t
		};
...
}, Ke = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? Y : {
...
}, qe = Y, Je = (e) => Y, Ye = Y, Xe = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? Y : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: S }], i = e[S], a = {
			...
			transform: (e, n, r) => {
				if (J(e)) return (i) => We(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, $e = (e, t) => typeof t == "function" && Ze.includes(e?.nodeType ?? "") ? (n) => Qe(e, t, n) : t, et = Y, tt = Y;
process.env.INTLAYER_OPTIMIZED_NESTING;
var nt = (e) => Y, rt = Y, it = (e, t = !0) => [
	Ke(e ?? r.defaultLocale, t ? r.defaultLocale : void 0),
	qe,
	Je(e ?? r.defaultLocale),
	Ye,
	Xe,
	nt(e ?? r.defaultLocale),
	rt,
	et,
	tt
].filter((e) => e !== Y), at = (e, t, n = []) => D(e, {
	...t,
	plugins: n
}), X = /* @__PURE__ */ new WeakSet(), ot = (e, t, n) => {
	let { locale: i, selector: a } = {
		locale: t,
		selector: void 0
	}, o = Me(i ?? r.defaultLocale, "", n), s = Ne(e, o);
	if (s.hit) return s.content;
	let c = n ?? it(i), l = e, u = (e) => {
		let t = {
			dictionaryKey: e.key,
...
}, { defaultLocale: st, locales: ct } = r ?? {}, lt = ({ isCookieEnabled: e, onLocaleChange: n } = {}) => {
	let r = m(o);
	return {
		locale: c(() => r?.locale?.value ?? st),
		defaultLocale: st,
		availableLocales: ct,
		setLocale: (i) => {
			if (!ct?.map(String).includes(i)) {
	...
	if (c === void 0) {
		if (i?.[e]) {
			let r = t ? `${t}.${n}` : n, s = O(i[e], r);
			if (s !== void 0) return L(s, a, o, e);
		}
		return s === void 0 ? n : L(s, a, o, e);
	}
	return L(c, a, o, e);
}, pt = () => r?.locales?.map(String) ?? [], $ = (e) => {
	V({ log: a })(`${H(e, B)} has no effect with ${H("@intlayer/vue-i18n", Te)} — translations are managed by the compiled intlayer dictionaries.`);
}, mt = ((e = {}) => {
	let t = e.messages;
	...
	let o = i(e.locale), s = e.datetimeFormats, l = e.numberFormats, u = () => String(o.locale.value), d = c({
	...
	}), f = (e, ...n) => ft(u(), void 0, e, n, t), p = (e, t) => b(e, t, u(), s), m = (e, t) => x(e, t, u(), l), h = {
		locale: d,
		availableLocales: pt(),
		...
		__optionsMessages: t,
		install(t) {
			n(t, { locale: e.locale }), t.provide(ut, _), t.config.globalProperties.$t = f, t.config.globalProperties.$tc = f, t.config.globalProperties.$te = h.te, t.config.globalProperties.$tm = h.tm, t.config.globalProperties.$rt = h.rt, t.config.globalProperties.$d = p, t.config.globalProperties.$n = m, t.config.globalProperties.$i18n = ee, t.directive("t", {
				beforeMount: g,
				updated: g
			});
		}
	...
	let { locale: t, setLocale: n, availableLocales: r } = lt(), i = m(ut)?.__optionsMessages, a = e?.namespace, o = e?.datetimeFormats, s = e?.numberFormats, l = c({
		get: () => t.value,
		set: (e) => {
			n(e);
		}
	}), u = (e, ...n) => ft(t.value, a, e, n, i);
	return {
		locale: l,
		availableLocales: r,
		t: u,
...
var _t = { class: "mb-6 text-2xl font-bold text-foreground" }, vt = { class: "overflow-x-auto rounded-lg border border-border" }, yt = { class: "w-full text-sm" }, bt = { class: "bg-muted" }, xt = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, St = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, Ct = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, wt = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, Tt = { class: "px-4 py-3 font-medium text-foreground" }, Et = { class: "px-4 py-3 text-muted-foreground" }, Dt = { class: "px-4 py-3 text-muted-foreground" }, Ot = { class: "px-4 py-3 text-muted-foreground" }, kt = d({
	__name: "ResultsTable",
	setup(e) {
		gt("ResultsTable");
		let { t } = ht(), n = c(() => [
		...
		return (e, r) => (g(), l("section", null, [u("h2", _t, v(y(t)("home.resultsTable.title")), 1), u("div", vt, [u("table", yt, [u("thead", bt, [u("tr", null, [
			u("th", xt, v(y(t)("home.resultsTable.library")), 1),
			u("th", St, v(y(t)("home.resultsTable.bundleSize")), 1),
			u("th", Ct, v(y(t)("home.resultsTable.lookupTime")), 1),
			u("th", wt, v(y(t)("home.resultsTable.lazyLoading")), 1)
		])]), u("tbody", null, [(g(!0), l(s, null, _(n.value, (e) => (g(), l("tr", {
			key: e.lib,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(At), (e, t) => te(e.$slots, "default");
	}
}), Mt = { render() {
	return p(jt, {}, { default: () => p(kt) });
} };
