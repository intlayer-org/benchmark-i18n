...
var St = (e, t) => xt(e, {
	...X,
	isCookieEnabled: t
}), { defaultLocale: Ct, locales: wt } = C ?? {}, Tt = ({ isCookieEnabled: t, onLocaleChange: n } = {}) => {
	let r = s(mt);
	return {
		locale: e(() => r?.locale?.value ?? Ct),
		defaultLocale: Ct,
		availableLocales: wt,
		setLocale: (e) => {
			if (!wt?.map(String).includes(e)) {
				console.error(`Locale ${e} is not available`);
				return;
			}
			r && r.setLocale(e), St(e, t ?? r?.isCookieEnabled ?? !0), n?.(e);
		}
	};
	...
	let n = t.messages;
	t.messages !== void 0 && R({ log: T })(`${z("createI18n", L)}: the ${z("`messages`", L)} option is used as a fallback. For optimal bundle size, remove the locale JSON imports and use ${z("useDictionary", L)} or compile your intlayer dictionaries instead:\n  ${z("Before:", I)} createI18n({ messages: { en, fr, … } })\n  ${z("After: ", I)} createI18n({})`);
	let r = ht(t.locale), i = t.datetimeFormats, a = t.numberFormats, o = () => String(r.locale.value), s = e({
		...
		locale: s,
		availableLocales: kt(),
		fallbackLocale: t.fallbackLocale ?? C?.defaultLocale,
		t: c,
		tc: c,
	...
	let { locale: n, setLocale: r, availableLocales: i } = Tt(), a = s(Et)?.__optionsMessages, o = t?.namespace, c = t?.datetimeFormats, l = t?.numberFormats, u = e({
		get: () => n.value,
		set: (e) => {
			r(e);
		}
...
var Nt = { class: "mb-16 mx-auto max-w-3xl space-y-6" }, Pt = { class: "text-2xl font-bold text-foreground" }, Ft = { class: "rounded-lg border border-border bg-card p-6" }, It = { class: "mb-2 text-lg font-semibold text-foreground" }, Lt = { class: "text-sm text-muted-foreground" }, Rt = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, zt = { class: "rounded-lg border border-border bg-card p-6" }, Bt = { class: "mb-2 text-lg font-semibold text-foreground" }, Vt = { class: "text-sm text-muted-foreground" }, Ht = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, Ut = { class: "text-foreground" }, Wt = { class: "text-foreground" }, Gt = { class: "text-foreground" }, Kt = { class: "rounded-lg border border-border bg-card p-6" }, qt = { class: "mb-2 text-lg font-semibold text-foreground" }, Jt = { class: "text-sm text-muted-foreground" }, Yt = i({
	__name: "UnderstandingImpact",
	setup(e) {
		Mt("UnderstandingImpact");
		let { t: i } = jt();
		return (e, a) => (u(), t("section", Nt, [
			n("h2", Pt, m(h(i)("home.understandingImpact.title")), 1),
			n("div", Ft, [
				n("h3", It, m(h(i)("home.understandingImpact.singleJsonTitle")), 1),
				n("p", Lt, m(h(i)("home.understandingImpact.singleJsonIntro")), 1),
				n("ul", Rt, [
			...
			n("div", zt, [
				n("h3", Bt, m(h(i)("home.understandingImpact.tradeOffsTitle")), 1),
				n("p", Vt, m(h(i)("home.understandingImpact.tradeOffsIntro")), 1),
				n("ul", Ht, [
					n("li", null, [n("strong", Ut, m(h(i)("home.understandingImpact.waterfallLabel")), 1), r(" " + m(h(i)("home.understandingImpact.waterfallDesc")), 1)]),
					n("li", null, [n("strong", Wt, m(h(i)("home.understandingImpact.foucLabel")), 1), r(" " + m(h(i)("home.understandingImpact.foucDesc")), 1)]),
					n("li", null, [n("strong", Gt, m(h(i)("home.understandingImpact.cacheLabel")), 1), r(" " + m(h(i)("home.understandingImpact.cacheDesc")), 1)])
				])
			]),
			n("div", Kt, [n("h3", qt, m(h(i)("home.understandingImpact.measuresTitle")), 1), n("p", Jt, m(h(i)("home.understandingImpact.measuresDesc")), 1)])
		]));
	}
}), Xt = At({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Xt), (e, t) => p(e.$slots, "default");
	}
}), Qt = { render() {
	return o(Zt, {}, { default: () => o(Yt) });
} };
