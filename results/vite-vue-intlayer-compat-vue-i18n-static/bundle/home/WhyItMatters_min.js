...
var St = (e, t) => xt(e, {
	...X,
	isCookieEnabled: t
}), { defaultLocale: Ct, locales: wt } = v ?? {}, Tt = ({ isCookieEnabled: t, onLocaleChange: n } = {}) => {
	let r = o(mt);
	return {
	...
	let { locale: n, setLocale: r, availableLocales: i } = Tt(), a = o(Et)?.__optionsMessages, s = t?.namespace, c = t?.datetimeFormats, l = t?.numberFormats, u = e({
		get: () => n.value,
		set: (e) => {
			r(e);
		}
	}), d = (e, ...t) => Ot(n.value, s, e, t, a);
	return {
		locale: u,
		availableLocales: i,
		t: d,
...
var Nt = { class: "mb-16" }, Pt = { class: "mb-6 text-2xl font-bold text-foreground" }, Ft = { class: "grid gap-6 md:grid-cols-3" }, It = { class: "rounded-lg border border-border bg-card p-6" }, Lt = { class: "mb-2 text-lg font-semibold text-foreground" }, Rt = { class: "text-sm text-muted-foreground" }, zt = { class: "rounded-lg border border-border bg-card p-6" }, Bt = { class: "mb-2 text-lg font-semibold text-foreground" }, Vt = { class: "text-sm text-muted-foreground" }, Ht = { class: "rounded-lg border border-border bg-card p-6" }, Ut = { class: "mb-2 text-lg font-semibold text-foreground" }, Wt = { class: "text-sm text-muted-foreground" }, Gt = r({
	__name: "WhyItMatters",
	setup(e) {
		Mt("WhyItMatters");
		let { t: r } = jt();
		return (e, i) => (l(), t("section", Nt, [n("h2", Pt, f(p(r)("home.whyItMatters.title")), 1), n("div", Ft, [
			n("div", It, [n("h3", Lt, f(p(r)("home.whyItMatters.bundleSizeTitle")), 1), n("p", Rt, f(p(r)("home.whyItMatters.bundleSizeDesc")), 1)]),
			n("div", zt, [n("h3", Bt, f(p(r)("home.whyItMatters.renderingTitle")), 1), n("p", Vt, f(p(r)("home.whyItMatters.renderingDesc")), 1)]),
			n("div", Ht, [n("h3", Ut, f(p(r)("home.whyItMatters.dynamicLoadingTitle")), 1), n("p", Wt, f(p(r)("home.whyItMatters.dynamicLoadingDesc")), 1)])
		])]));
	}
}), Kt = At({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Kt), (e, t) => ee(e.$slots, "default");
	}
}), Jt = { render() {
	return a(qt, {}, { default: () => a(Gt) });
} };
