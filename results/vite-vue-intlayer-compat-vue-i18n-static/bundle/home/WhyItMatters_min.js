import { computed as e, createElementBlock as t, createElementVNode as n, defineComponent as r, getCurrentInstance as i, h as a, inject as o, onBeforeMount as s, onMounted as c, openBlock as l, readonly as u, ref as d, renderSlot as ee, toDisplayString as f, unref as p } from "vue";
...
var xt = (e, t) => bt(e, {
	...X,
	isCookieEnabled: t
}), { defaultLocale: St, locales: Ct } = v ?? {}, wt = ({ isCookieEnabled: t, onLocaleChange: n } = {}) => {
	let r = o(pt);
	return {
	...
	let n = t.messages;
	t.messages !== void 0 && N({ log: b })(`${P("createI18n", M)}: the ${P("`messages`", M)} option is used as a fallback. For optimal bundle size, remove the locale JSON imports and use ${P("useDictionary", M)} or compile your intlayer dictionaries instead:\n  ${P("Before:", j)} createI18n({ messages: { en, fr, … } })\n  ${P("After: ", j)} createI18n({})`);
	let r = mt(t.locale), i = t.datetimeFormats, a = t.numberFormats, o = () => String(r.locale.value), s = e({
		...
		locale: s,
		availableLocales: Ot(),
		fallbackLocale: t.fallbackLocale ?? v?.defaultLocale,
		t: c,
		tc: c,
	...
	let { locale: n, setLocale: r, availableLocales: i } = wt(), a = o(Tt)?.__optionsMessages, s = t?.namespace, c = t?.datetimeFormats, l = t?.numberFormats, u = e({
		get: () => n.value,
		set: (e) => {
			r(e);
		}
	}), d = (e, ...t) => Dt(n.value, s, e, t, a);
	return {
		locale: u,
		availableLocales: i,
		t: d,
...
var Mt = { class: "mb-16" }, Nt = { class: "mb-6 text-2xl font-bold text-foreground" }, Pt = { class: "grid gap-6 md:grid-cols-3" }, Ft = { class: "rounded-lg border border-border bg-card p-6" }, It = { class: "mb-2 text-lg font-semibold text-foreground" }, Lt = { class: "text-sm text-muted-foreground" }, Rt = { class: "rounded-lg border border-border bg-card p-6" }, zt = { class: "mb-2 text-lg font-semibold text-foreground" }, Bt = { class: "text-sm text-muted-foreground" }, Vt = { class: "rounded-lg border border-border bg-card p-6" }, Ht = { class: "mb-2 text-lg font-semibold text-foreground" }, Ut = { class: "text-sm text-muted-foreground" }, Wt = r({
	__name: "WhyItMatters",
	setup(e) {
		jt("WhyItMatters");
		let { t: r } = At();
		return (e, i) => (l(), t("section", Mt, [n("h2", Nt, f(p(r)("home.whyItMatters.title")), 1), n("div", Pt, [
			n("div", Ft, [n("h3", It, f(p(r)("home.whyItMatters.bundleSizeTitle")), 1), n("p", Lt, f(p(r)("home.whyItMatters.bundleSizeDesc")), 1)]),
			n("div", Rt, [n("h3", zt, f(p(r)("home.whyItMatters.renderingTitle")), 1), n("p", Bt, f(p(r)("home.whyItMatters.renderingDesc")), 1)]),
			n("div", Vt, [n("h3", Ht, f(p(r)("home.whyItMatters.dynamicLoadingTitle")), 1), n("p", Ut, f(p(r)("home.whyItMatters.dynamicLoadingDesc")), 1)])
		])]));
	}
}), Gt = kt({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Gt), (e, t) => ee(e.$slots, "default");
	}
}), qt = { render() {
	return a(Kt, {}, { default: () => a(Wt) });
} };
