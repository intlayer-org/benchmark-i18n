...
var ee = (e, t, n) => typeof e == "string" ? n?.[t]?.[e] ?? n?.[t.split("-")[0] ?? ""]?.[e] : e, b = (e, t, n, r) => {
...
}, te = "translation", S = "enumeration", ne = "plural", re = "condition", C = "insertion", ie = "object", ae = "array", oe = "markdown", w = "html", T = "gender", E = "select", D = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), O = (e, t) => {
...
}, le = (e, t) => e[ce(e, t) ?? "fallback"], ue = 50, de = /* @__PURE__ */ new Map(), k = /* @__PURE__ */ new Set(), fe = (e) => {
...
var he = (e, t, n) => e[A("PluralRules", n).select(t)] ?? e.other, ge = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return P(r[C], t, n);
	if (r.nodeType === "html") return P(r[w], t, n);
	if (r.nodeType === "plural") {
		let e = r[ne];
		return P(he(e, Number(N(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[S], i = j.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[E], i = N(t, typeof r.variable == "string" ? r.variable : "value");
		return P(ge(e, String(i ?? "")), t, n);
	}
...
var H = /* @__PURE__ */ new WeakMap(), U = 0, ke = (e) => {
	...
	if (J(e)) return e.nodeType === "html" ? e[w] : e[oe];
}, Ve = (e, t) => {
...
var et = (e) => Y, tt = Y, nt = (e, t = !0) => [
	...
	}), f = (e, ...n) => ut(u(), void 0, e, n, t), p = (e, t) => b(e, t, u(), c), m = (e, t) => x(e, t, u(), l), h = {
		locale: d,
		availableLocales: dt(),
...
var ht = { class: "grid gap-8 md:grid-cols-2" }, gt = { class: "rounded-lg border border-border bg-card p-6" }, _t = { class: "mb-3 text-xl font-semibold text-foreground" }, vt = { class: "text-sm text-muted-foreground" }, yt = { class: "rounded-lg border border-border bg-card p-6" }, bt = { class: "mb-3 text-xl font-semibold text-foreground" }, xt = { class: "text-sm text-muted-foreground" }, St = u({
	__name: "AboutGrid",
	setup(e) {
		mt("AboutGrid");
		let { t } = pt();
		return (e, n) => (g(), c("div", ht, [l("div", gt, [l("h2", _t, v(y(t)("about.grid.whyExistsTitle")), 1), l("p", vt, v(y(t)("about.grid.whyExistsDesc")), 1)]), l("div", yt, [l("h2", bt, v(y(t)("about.grid.methodologyTitle")), 1), l("p", xt, v(y(t)("about.grid.methodologyDesc")), 1)])]));
	}
}), Ct = ft({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Ct), (e, t) => _(e.$slots, "default");
	}
}), Tt = { render() {
	return f(wt, {}, { default: () => f(St) });
} };
