...
var Mt = { class: "grid gap-8 md:grid-cols-2" }, Nt = { class: "rounded-lg border border-border bg-card p-6" }, Pt = { class: "mb-3 text-xl font-semibold text-foreground" }, Ft = { class: "text-sm text-muted-foreground" }, It = { class: "rounded-lg border border-border bg-card p-6" }, Lt = { class: "mb-3 text-xl font-semibold text-foreground" }, Rt = { class: "text-sm text-muted-foreground" }, zt = r({
	__name: "AboutGrid",
	setup(e) {
		jt("AboutGrid");
		let { t: r } = At();
		return (e, i) => (l(), t("div", Mt, [n("div", Nt, [n("h2", Pt, f(p(r)("about.grid.whyExistsTitle")), 1), n("p", Ft, f(p(r)("about.grid.whyExistsDesc")), 1)]), n("div", It, [n("h2", Lt, f(p(r)("about.grid.methodologyTitle")), 1), n("p", Rt, f(p(r)("about.grid.methodologyDesc")), 1)])]));
	}
}), Bt = kt({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Bt), (e, t) => ee(e.$slots, "default");
	}
}), Ht = { render() {
	return a(Vt, {}, { default: () => a(zt) });
} };
