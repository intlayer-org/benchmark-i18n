...
var wt = (e, t) => Ct(e, {
	...
	}), c = (e, ...t) => At(o(), void 0, e, t, n), l = (e, t) => _(e, t, o(), i), u = (e, t) => ee(e, t, o(), a), d = {
		locale: s,
		availableLocales: Q(),
...
var Pt = { class: "mb-4 text-3xl font-bold text-foreground" }, Ft = { class: "mb-8 max-w-3xl text-muted-foreground" }, It = i({
	__name: "AboutHeader",
	setup(t) {
		Nt("AboutHeader");
		let { t: i } = Mt();
		return (t, a) => (u(), n(e, null, [r("h1", Pt, m(h(i)("about.header.title")), 1), r("p", Ft, m(h(i)("about.header.description")), 1)], 64));
	}
}), Lt = jt({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Lt), (e, t) => p(e.$slots, "default");
	}
}), zt = { render() {
	return o(Rt, {}, { default: () => o(It) });
} };
