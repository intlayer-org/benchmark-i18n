...
import { Fragment as s, computed as c, createElementBlock as l, createElementVNode as u, defineComponent as d, getCurrentInstance as f, h as p, inject as m, onBeforeMount as h, onMounted as g, openBlock as _, renderSlot as v, toDisplayString as ee, unref as te } from "vue";
var ne = (e, t, n) => typeof e == "string" ? n?.[t]?.[e] ?? n?.[t.split("-")[0] ?? ""]?.[e] : e, y = (e, t, n, r) => {
...
}, re = "translation", x = "enumeration", S = "plural", ie = "condition", C = "insertion", ae = "object", oe = "array", w = "markdown", T = "html", se = "gender", ce = "select", E = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), D = (e, t) => {
...
}, de = (e, t) => e[ue(e, t) ?? "fallback"], fe = 50, pe = /* @__PURE__ */ new Map(), O = /* @__PURE__ */ new Set(), me = (e) => {
...
var nt = (e) => J, rt = J, it = (e, t = !0) => [
	...
	}), f = (e, ...n) => dt(u(), void 0, e, n, t), p = (e, t) => y(e, t, u(), s), m = (e, t) => b(e, t, u(), l), h = {
		locale: d,
		availableLocales: ft(),
...
var gt = { class: "mb-4 text-3xl font-bold text-foreground" }, _t = { class: "mb-8 max-w-3xl text-muted-foreground" }, vt = d({
	__name: "AboutHeader",
	setup(e) {
		ht("AboutHeader");
		let { t } = mt();
		return (e, n) => (_(), l(s, null, [u("h1", gt, ee(te(t)("about.header.title")), 1), u("p", _t, ee(te(t)("about.header.description")), 1)], 64));
	}
}), yt = pt({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(yt), (e, t) => v(e.$slots, "default");
	}
}), xt = { render() {
