...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("section", _hoisted_1, [createElementVNode("h2", _hoisted_2, toDisplayString($setup.t("settings.apiAccess.title")), 1), createElementVNode("div", null, [
		createElementVNode("label", _hoisted_3, toDisplayString($setup.t("settings.apiAccess.apiKey")), 1),
		...
		}, null, -1)), createElementVNode("button", _hoisted_5, toDisplayString($setup.t("settings.apiAccess.copy")), 1)]),
		createElementVNode("p", _hoisted_6, toDisplayString($setup.t("settings.apiAccess.description")), 1)
	])]);
}
var ApiAccessSection_default = _plugin_vue_export_helper_default(ApiAccessSection_vue_vue_type_script_setup_true_lang_default, [["render", _sfc_render$1], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/src/components/pages/settings/ApiAccessSection.vue"]]);
var i18n = createI18n({
	legacy: false,
	locale: "en",
	fallbackLocale: "en"
