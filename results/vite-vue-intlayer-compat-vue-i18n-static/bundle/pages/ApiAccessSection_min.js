...
var xt = (e, t) => bt(e, {
...
}, Ft = { class: "mt-1 text-xs text-muted-foreground" }, It = r({
	__name: "ApiAccessSection",
	setup(e) {
		let { t: r } = kt();
		return (e, i) => (s(), t("section", At, [n("h2", jt, d(f(r)("settings.apiAccess.title")), 1), n("div", null, [
			n("label", Mt, d(f(r)("settings.apiAccess.apiKey")), 1),
			n("div", Nt, [i[0] ||= n("input", {
				id: "api-key",
				readonly: "",
			...
			}, null, -1), n("button", Pt, d(f(r)("settings.apiAccess.copy")), 1)]),
			n("p", Ft, d(f(r)("settings.apiAccess.description")), 1)
		])]));
	}
}), Lt = Ot({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Lt), (e, t) => u(e.$slots, "default");
	}
}), zt = { render() {
	return a(Rt, {}, { default: () => a(It) });
} };
