...
var je = /* @__PURE__ */ new WeakMap(), Me = 0, Ne = (e) => {
	...
	let r = qe()[e];
	return r ? ft(r, t, n) : (K.has(e) || (P({ log: C })(typeof window > "u" ? `Dictionary ${Ae(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), K.add(e)), G(e));
}, Xe = (e) => {
...
var St = (e, t) => xt(e, {
	...X,
	isCookieEnabled: t
}), { defaultLocale: Ct, locales: wt } = x ?? {}, Tt = ({ isCookieEnabled: e, onLocaleChange: n } = {}) => {
	let r = s(mt);
	return {
	...
	}), c = (e, ...t) => Ot(o(), void 0, e, t, n), l = (e, t) => h(e, t, o(), i), u = (e, t) => g(e, t, o(), a), d = {
		locale: s,
		availableLocales: kt(),
	...
	setup(i) {
		...
		return (t, i) => (c(), n("div", Mt, [(c(!0), n(e, null, d(s.value, (e) => (c(), n("article", {
			key: e.title,
			...
			r("button", Rt, p(m(a)("blog.list.readMore")), 1)
		]))), 128))]));
	}
}), Bt = At({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Bt), (e, t) => f(e.$slots, "default");
	}
}), Ht = { render() {
