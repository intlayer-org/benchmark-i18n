...
var St = (e, t) => xt(e, {
...
}), Mt = { class: "mb-12 grid gap-4 md:grid-cols-3" }, Nt = { class: "text-sm font-semibold text-foreground" }, Pt = { class: "text-xs text-muted-foreground" }, Ft = i({
	...
	setup(t) {
		...
		}, [r("p", Nt, f(p(i)(e.labelKey)), 1), r("p", Pt, f(p(i)(e.valueKey)), 1)])), 64))]));
	}
}), It = At({
	legacy: !1,
	locale: "en",
