...
import { Fragment as s, computed as c, createElementBlock as l, createElementVNode as u, defineComponent as d, getCurrentInstance as f, h as p, inject as m, openBlock as h, renderList as g, renderSlot as _, toDisplayString as v, unref as ee } from "vue";
...
}, ue = (e, t) => e[le(e, t) ?? "fallback"], de = 50, O = /* @__PURE__ */ new Map(), k = /* @__PURE__ */ new Set(), fe = (e) => {
...
var he = (e, t, n) => e[A("PluralRules", n).select(t)] ?? e.other, ge = (e, t) => {
	...
	if (r.nodeType === "enumeration") {
		let e = r[ne], i = j.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
var et = (e) => Y, tt = Y, nt = (e, t = !0) => [
	...
	}), f = (e, ...n) => ut(u(), void 0, e, n, t), p = (e, t) => b(e, t, u(), s), m = (e, t) => x(e, t, u(), l), h = {
		locale: d,
		availableLocales: dt(),
...
}), mt = { class: "mb-12 grid gap-4 md:grid-cols-3" }, ht = { class: "text-sm font-semibold text-foreground" }, gt = { class: "text-xs text-muted-foreground" }, _t = d({
	...
	setup(e) {
		...
		}, [u("p", ht, v(ee(t)(e.labelKey)), 1), u("p", gt, v(ee(t)(e.valueKey)), 1)])), 64))]));
	}
}), vt = ft({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(vt), (e, t) => _(e.$slots, "default");
	}
}), bt = { render() {
	return p(yt, {}, { default: () => p(_t) });
} };
