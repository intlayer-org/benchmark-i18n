...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock(Fragment, null, [
		...
		createElementVNode("h1", _hoisted_1, toDisplayString($setup.t("faq.header.title")), 1),
		createElementVNode("p", _hoisted_2, toDisplayString($setup.t("faq.header.description")), 1)
	], 64);
}
var FAQHeader_default = _plugin_vue_export_helper_default(FAQHeader_vue_vue_type_script_setup_true_lang_default, [["render", _sfc_render$1], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/src/components/pages/faq/FAQHeader.vue"]]);
var i18n = createI18n({
	legacy: false,
	locale: "en",
	fallbackLocale: "en"
