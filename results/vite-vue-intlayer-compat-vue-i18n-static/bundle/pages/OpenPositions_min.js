...
var et = (e) => Y, tt = Y, nt = (e, t = !0) => [
...
}), mt = { class: "mb-6 text-2xl font-bold text-foreground" }, ht = { class: "space-y-4" }, gt = { class: "text-base font-semibold text-foreground" }, _t = { class: "text-sm text-muted-foreground" }, vt = { class: "mt-2 flex gap-2" }, yt = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, bt = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, xt = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, St = {
	type: "button",
	...
	setup(e) {
		...
		return (e, r) => (h(), l(s, null, [u("h2", mt, v(y(t)("careers.openPositions.title")), 1), u("div", ht, [(h(), l(s, null, g(n, (e, n) => u("div", {
			key: `${e.titleKey}-${e.locationKey}-${n}`,
			class: "flex flex-col gap-3 rounded-lg border border-border bg-card p-6 md:flex-row md:items-center md:justify-between"
		}, [u("div", null, [
			u("h3", gt, v(y(t)(`careers.openPositions.${e.titleKey}`)), 1),
			u("p", _t, v(y(t)(`careers.openPositions.${e.descKey}`)), 1),
			u("div", vt, [
				u("span", yt, v(y(t)(`careers.openPositions.${e.deptKey}`)), 1),
				u("span", bt, v(y(t)(`careers.openPositions.${e.locationKey}`)), 1),
				u("span", xt, v(y(t)(`careers.openPositions.${e.typeKey}`)), 1)
			])
		]), u("button", St, v(y(t)("careers.openPositions.applyNow")), 1)])), 64))])], 64));
	}
}), wt = ft({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(wt), (e, t) => _(e.$slots, "default");
	}
}), Et = { render() {
	return p(Tt, {}, { default: () => p(Ct) });
} };
