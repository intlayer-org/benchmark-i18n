...
import { computed as s, createElementBlock as c, createElementVNode as l, defineComponent as u, getCurrentInstance as ee, h as d, inject as f, openBlock as p, renderSlot as m, toDisplayString as h, unref as g } from "vue";
var _ = (e, t, n) => typeof e == "string" ? n?.[t]?.[e] ?? n?.[t.split("-")[0] ?? ""]?.[e] : e, te = (e, t, n, r) => {
...
}, re = "translation", ie = "enumeration", v = "plural", ae = "condition", y = "insertion", oe = "object", se = "array", ce = "markdown", b = "html", x = "gender", le = "select", S = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), C = (e, t) => {
...
}, de = (e, t) => e[ue(e, t) ?? "fallback"], fe = 50, T = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Set(), pe = (e) => {
...
function D(e, t, n) {
	let i = t ?? r?.defaultLocale, a = `${i}|${n ? JSON.stringify(n) : ""}`, o = e, s = T.get(o);
	s || (s = /* @__PURE__ */ new Map(), T.set(o, s));
	let c = s.get(a);
	if (!c) {
		let t = typeof e == "string" ? he(e) : e;
		if (typeof t != "function") throw Error(`[intlayer] \`Intl.${String(e)}\` is not available in this JavaScript engine and has no fallback. Load the matching polyfill before formatting.`);
		s.size > fe && s.clear(), c = new t(i, n), s.set(a, c);
	}
	return c;
}
var ge = (e, t, n) => e[D("PluralRules", n).select(t)] ?? e.other, _e = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return M(r[y], t, n);
	...
	if (r.nodeType === "enumeration") {
		let e = r[ie], i = ve.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	return e;
}, ye = (e) => e.split(/(?<!\\)\|/).map((e) => e.replace(/\\\|/g, "|").trim()), be = (e, t) => {
	let n = Math.abs(e);
	...
	if (n !== void 0 && (i.count ??= n, i.n ??= n), typeof e == "string") {
		...
		if (/(?<!\\)\|/.test(t)) {
			let e = ye(t);
			t = e[be(n ?? 1, e.length)] ?? t;
		}
		return A(t, i, r);
	}
	let a = M(e, i, r);
	return typeof a == "string" ? a : String(a ?? "");
}, F = "\x1B[0m", I = "\x1B[90m", xe = "\x1B[34m", Se = "\x1B[31m", Ce = "\x1B[32m", we = "\x1B[35m", Te = "\x1B[38;5;3m", L = "\x1B[36m", Ee = (e) => e, De = (e, t) => {
...
}), z = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? F : n : F}` : e, Oe = (e, t = Te, n = F) => [e].flat().map((e) => z(e, t, n)).join(", ");
z("✗", Se), z("✓", Ce), z("⏲", xe);
var B = /* @__PURE__ */ new WeakMap(), V = 0, ke = (e) => {
	if (!e) return "base";
	let t = B.get(e);
	if (t) return t;
	V += 1;
	let n = `p${V}`;
	return B.set(e, n), n;
}, Ae = 256, H = /* @__PURE__ */ new WeakMap(), U = (e) => typeof e == "object" && !!e, je = (e, t, n) => `${e}_${t}_${ke(n)}`, Me = (e, t) => {
	if (!U(e)) return { hit: !1 };
	let n = H.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, G = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), Ne = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), K = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Ne.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : K(e ? `${e}.${String(n)}` : String(n)) }), q = /* @__PURE__ */ new Set(), Pe = (t, n, r) => {
	let i = e()[t];
	return i ? nt(i, n, r) : (q.has(t) || (R({ log: a })(typeof window > "u" ? `Dictionary ${Oe(t)} was not found. Using fallback proxy.` : `Dictionary ${t} was not found. Using fallback proxy.`, { level: "warn" }), q.add(t)), K(t));
}, Fe = (e) => {
	...
	if (t === void 0 || Array.isArray(e) || !Fe(e) || !Fe(t)) return e;
	let n = e;
	for (let r of Object.keys(t)) {
		let i = t[r];
		if (r === "__proto__" || r === "constructor" || i === void 0) continue;
		let a = e[r], o = a === void 0 ? i : typeof a == "object" ? Ie(a, i) : a;
		o !== a && (n === e && (n = { ...e }), n[r] = o);
	}
	return n;
}, Le = (e, t, n) => {
	...
	if (o.length !== 0) return o.length === 1 || Array.isArray(o[0]) ? o[0] : o.reduce((e, t) => Ie(e, t));
}, J = (e) => {
	...
	if (J(e)) return e.nodeType === "html" ? e[b] : e[ce];
}, ze = (e, t) => {
	if (typeof e == "string") return t;
	if (J(e)) {
		let n = e.nodeType === "html" ? b : ce;
		return {
			...e,
			[n]: t
		};
...
}, He = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? Y : {
	id: "translation-plugin",
	canHandle: (e) => typeof e == "object" && e?.nodeType === "translation",
	transform: (n, r, i) => {
		let a = Le(n.translation ?? {}, e, t);
		return i(a, {
			...r,
			children: a,
			keyPath: [...r.keyPath, {
...
}, Ue = Y, We = (e) => Y, Ge = Y, Ke = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? Y : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: y }], i = e[y], a = {
			...
			transform: (e, n, r) => {
				if (J(e)) return (i) => Be(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, Ye = (e, t) => typeof t == "function" && qe.includes(e?.nodeType ?? "") ? (n) => Je(e, t, n) : t, Xe = Y, Ze = Y;
process.env.INTLAYER_OPTIMIZED_NESTING;
var Qe = (e) => Y, $e = Y, et = (e, t = !0) => [
	He(e ?? r.defaultLocale, t ? r.defaultLocale : void 0),
	Ue,
	We(e ?? r.defaultLocale),
	Ge,
	Ke,
	...
	let { locale: i, selector: a } = {
		locale: t,
		selector: void 0
	}, o = je(i ?? r.defaultLocale, "", n), s = Me(e, o);
	if (s.hit) return s.content;
	let c = n ?? et(i), l = e, u = (e) => {
		let t = {
			dictionaryKey: e.key,
		...
		X.add(e);
		try {
			return tt(e.content, t, c);
		} finally {
			t.eager && X.delete(e);
		}
	};
	return l === null ? W(e, o, null) : Array.isArray(l) ? W(e, o, l.map(u)) : W(e, o, u(l));
}, { defaultLocale: rt, locales: it } = r ?? {}, at = ({ isCookieEnabled: e, onLocaleChange: n } = {}) => {
	let r = f(o);
	return {
		locale: s(() => r?.locale?.value ?? rt),
		defaultLocale: rt,
		availableLocales: it,
		setLocale: (i) => {
			if (!it?.map(String).includes(i)) {
...
}, ot = Symbol("global-i18n"), st = "translation", Z = (e, t, n) => {
	try {
		let r = w(Pe(t, e), n);
		if (r != null) return r;
	} catch {}
	...
	if (c === void 0) {
		if (i?.[e]) {
			let r = t ? `${t}.${n}` : n, s = w(i[e], r);
			if (s !== void 0) return P(s, a, o, e);
		}
		return s === void 0 ? n : P(s, a, o, e);
	}
	return P(c, a, o, e);
}, lt = () => r?.locales?.map(String) ?? [], $ = (e) => {
	R({ log: a })(`${z(e, L)} has no effect with ${z("@intlayer/vue-i18n", we)} — translations are managed by the compiled intlayer dictionaries.`);
}, ut = ((e = {}) => {
	let t = e.messages;
	e.messages !== void 0 && R({ log: a })(`${z("createI18n", L)}: the ${z("`messages`", L)} option is used as a fallback. For optimal bundle size, remove the locale JSON imports and use ${z("useDictionary", L)} or compile your intlayer dictionaries instead:\n  ${z("Before:", I)} createI18n({ messages: { en, fr, … } })\n  ${z("After: ", I)} createI18n({})`);
	let o = i(e.locale), c = e.datetimeFormats, l = e.numberFormats, u = () => String(o.locale.value), ee = s({
		get: () => u(),
		set: (e) => {
			o.setLocale(e);
		}
	}), d = (e, ...n) => ct(u(), void 0, e, n, t), f = (e, t) => te(e, t, u(), c), p = (e, t) => ne(e, t, u(), l), m = {
		locale: ee,
		availableLocales: lt(),
		...
		let n = t.value;
		if (typeof n == "string") e.textContent = d(n);
		else if (n && typeof n == "object") {
			let t = [];
			n.args && t.push(n.args), typeof n.choice == "number" && t.push(n.choice), e.textContent = d(n.path, ...t);
		}
	}, _ = {
		global: m,
		...
		__optionsMessages: t,
		install(t) {
			n(t, { locale: e.locale }), t.provide(ot, _), t.config.globalProperties.$t = d, t.config.globalProperties.$tc = d, t.config.globalProperties.$te = m.te, t.config.globalProperties.$tm = m.tm, t.config.globalProperties.$rt = m.rt, t.config.globalProperties.$d = f, t.config.globalProperties.$n = p, t.config.globalProperties.$i18n = h, t.directive("t", {
				beforeMount: g,
				updated: g
			});
		}
	...
	let { locale: t, setLocale: n, availableLocales: r } = at(), i = f(ot)?.__optionsMessages, a = e?.namespace, o = e?.datetimeFormats, c = e?.numberFormats, l = s({
		get: () => t.value,
		set: (e) => {
			n(e);
		}
	}), u = (e, ...n) => ct(t.value, a, e, n, i);
	return {
		locale: l,
		availableLocales: r,
		t: u,
		...
		tm: (e) => Q(t.value, a, e) ?? {},
		rt: (e, ...n) => {
			let { values: r, count: i } = N(n);
			return P(e, r, i, t.value);
		},
		d: (e, n) => te(e, n, t.value, o),
		n: (e, n) => ne(e, n, t.value, c)
	};
}), ft = { class: "rounded-lg border border-border bg-card p-6" }, pt = { class: "mb-4 text-lg font-semibold text-foreground" }, mt = { class: "space-y-4" }, ht = { class: "flex items-center justify-between" }, gt = { class: "text-sm font-medium text-foreground" }, _t = { class: "text-xs text-muted-foreground" }, vt = ["aria-label"], yt = { class: "flex items-center justify-between" }, bt = { class: "text-sm font-medium text-foreground" }, xt = { class: "text-xs text-muted-foreground" }, St = ["aria-label"], Ct = {
	for: "language",
	...
	setup(e) {
		let { t } = dt();
		return (e, n) => (p(), c("section", ft, [l("h2", pt, h(g(t)("settings.preferences.title")), 1), l("div", mt, [
			l("div", ht, [l("div", null, [l("p", gt, h(g(t)("settings.preferences.emailNotifications")), 1), l("p", _t, h(g(t)("settings.preferences.weeklyReports")), 1)]), l("button", {
				type: "button",
				class: "h-6 w-11 rounded-full bg-primary transition-colors",
				"aria-label": g(t)("settings.preferences.toggleNotifications")
			}, [...n[0] ||= [l("span", { class: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" }, null, -1)]], 8, vt)]),
			l("div", yt, [l("div", null, [l("p", bt, h(g(t)("settings.preferences.darkMode")), 1), l("p", xt, h(g(t)("settings.preferences.darkColorScheme")), 1)]), l("button", {
				type: "button",
				class: "h-6 w-11 rounded-full bg-muted transition-colors",
				"aria-label": g(t)("settings.preferences.toggleDarkMode")
			}, [...n[1] ||= [l("span", { class: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" }, null, -1)]], 8, St)]),
			l("div", null, [l("label", Ct, h(g(t)("settings.preferences.defaultLanguage")), 1), l("select", wt, [
				l("option", null, h(g(t)("settings.preferences.english")), 1),
				l("option", null, h(g(t)("settings.preferences.french")), 1),
				l("option", null, h(g(t)("settings.preferences.german")), 1),
				l("option", null, h(g(t)("settings.preferences.spanish")), 1),
				l("option", null, h(g(t)("settings.preferences.japanese")), 1),
				l("option", null, h(g(t)("settings.preferences.chinese")), 1),
				l("option", null, h(g(t)("settings.preferences.arabic")), 1)
			])])
		])]));
	}
}), Et = ut({
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Et), (e, t) => m(e.$slots, "default");
	}
}), Ot = { render() {
	return d(Dt, {}, { default: () => d(Tt) });
} };
