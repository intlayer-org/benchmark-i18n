...
var Ae = /* @__PURE__ */ new WeakMap(), je = 0, Me = (e) => {
	...
	let r = Ke()[e];
	return r ? ut(r, t, n) : (G.has(e) || (N({ log: S })(typeof window > "u" ? `Dictionary ${ke(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), G.add(e)), W(e));
}, K = (e) => {
...
var ot = (e) => J, st = J, ct = (e, t = !0) => [
	et(e ?? b.defaultLocale, t ? b.defaultLocale : void 0),
	tt,
	nt,
	rt,
	ot(e ?? b.defaultLocale),
	st,
	it,
	at
], lt = (e, t, n = []) => y(e, {
...
var X = {
	...
	if (!_t) for (let t = 0; t < (x.storage.cookies ?? []).length; t++) try {
		let r = e?.getCookie?.(x.storage.cookies[t].name);
		if (n(r)) return r;
	} catch {}
}, yt = (e, t) => {
	if (t?.isCookieEnabled !== !1 && !_t && x.storage.cookies) for (let n = 0; n < x.storage.cookies.length; n++) {
...
var bt = (e, t) => yt(e, {
	...X,
	isCookieEnabled: t
}), { defaultLocale: xt, locales: St } = b ?? {}, Ct = ({ isCookieEnabled: t, onLocaleChange: n } = {}) => {
	let r = o(ft);
	return {
...
}), At = { class: "rounded-lg border border-border bg-card p-6" }, jt = { class: "mb-4 text-lg font-semibold text-foreground" }, Mt = { class: "space-y-4" }, Nt = { class: "flex items-center justify-between" }, Pt = { class: "text-sm font-medium text-foreground" }, Ft = { class: "text-xs text-muted-foreground" }, It = ["aria-label"], Lt = { class: "flex items-center justify-between" }, Rt = { class: "text-sm font-medium text-foreground" }, zt = { class: "text-xs text-muted-foreground" }, Bt = ["aria-label"], Vt = {
	for: "language",
	...
	setup(e) {
		let { t: r } = kt();
		return (e, i) => (s(), t("section", At, [n("h2", jt, d(f(r)("settings.preferences.title")), 1), n("div", Mt, [
			n("div", Nt, [n("div", null, [n("p", Pt, d(f(r)("settings.preferences.emailNotifications")), 1), n("p", Ft, d(f(r)("settings.preferences.weeklyReports")), 1)]), n("button", {
				type: "button",
				class: "h-6 w-11 rounded-full bg-primary transition-colors",
				"aria-label": f(r)("settings.preferences.toggleNotifications")
			}, [...i[0] ||= [n("span", { class: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" }, null, -1)]], 8, It)]),
			n("div", Lt, [n("div", null, [n("p", Rt, d(f(r)("settings.preferences.darkMode")), 1), n("p", zt, d(f(r)("settings.preferences.darkColorScheme")), 1)]), n("button", {
				type: "button",
				class: "h-6 w-11 rounded-full bg-muted transition-colors",
				"aria-label": f(r)("settings.preferences.toggleDarkMode")
			}, [...i[1] ||= [n("span", { class: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" }, null, -1)]], 8, Bt)]),
			n("div", null, [n("label", Vt, d(f(r)("settings.preferences.defaultLanguage")), 1), n("select", Ht, [
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Wt), (e, t) => u(e.$slots, "default");
	}
}), Kt = { render() {
	return a(Gt, {}, { default: () => a(Ut) });
} };
