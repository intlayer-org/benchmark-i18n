...
var et = (e) => Y, tt = Y, nt = (e, t = !0) => [
...
}), gt = { class: "mb-12 text-center" }, _t = { class: "mb-3 text-3xl font-bold text-foreground" }, vt = { class: "text-muted-foreground" }, yt = d({
	__name: "PricingHeader",
	setup(e) {
		let { t } = pt();
		return (e, n) => (h(), l(s, null, [ee(ht), u("div", gt, [u("h1", _t, _(v(t)("pricing.header.title")), 1), u("p", vt, _(v(t)("pricing.header.description")), 1)])], 64));
	}
}), bt = ft({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(bt), (e, t) => g(e.$slots, "default");
	}
}), St = { render() {
