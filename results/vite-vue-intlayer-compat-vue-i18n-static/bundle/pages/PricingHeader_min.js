...
}, ne = "translation", re = "enumeration", ie = "plural", g = "insertion", ae = "object", oe = "array", se = "markdown", _ = "html", ce = "gender", le = "select", v = (e, t) => {
...
}, pe = 50, me = /* @__PURE__ */ new Map(), S = /* @__PURE__ */ new Set(), he = (e) => {
...
var je = /* @__PURE__ */ new WeakMap(), Me = 0, Ne = (e) => {
	...
	let r = Ke()[e];
	return r ? dt(r, t, n) : (K.has(e) || (P({ log: x })(typeof window > "u" ? `Dictionary ${Ae(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), K.add(e)), G(e));
}, Ye = (e) => {
	...
	if (q(e)) return e.nodeType === "html" ? e[_] : e[se];
}, $e = (e, t) => {
...
var xt = (e, t) => bt(e, {
	...
	P({ log: x })(`${F(e, N)} has no effect with ${F("@intlayer/vue-i18n", Ee)} — translations are managed by the compiled intlayer dictionaries.`);
}, kt = ((e = {}) => {
	let n = e.messages;
	e.messages !== void 0 && P({ log: x })(`${F("createI18n", N)}: the ${F("`messages`", N)} option is used as a fallback. For optimal bundle size, remove the locale JSON imports and use ${F("useDictionary", N)} or compile your intlayer dictionaries instead:\n  ${F("Before:", M)} createI18n({ messages: { en, fr, … } })\n  ${F("After: ", M)} createI18n({})`);
	let r = mt(e.locale), i = e.datetimeFormats, a = e.numberFormats, o = () => String(r.locale.value), s = t({
		get: () => o(),
		set: (e) => {
			r.setLocale(e);
		}
	}), c = (e, ...t) => Dt(o(), void 0, e, t, n), l = (e, t) => te(e, t, o(), i), u = (e, t) => h(e, t, o(), a), d = {
		locale: s,
		availableLocales: Ot(),
	...
	setup(t) {
		return (t, a) => (l(), n(e, null, [i(Mt), a[0] ||= r("div", { class: "mb-12 text-center" }, [r("h1", { class: "mb-3 text-3xl font-bold text-foreground" }, " Simple, Transparent Pricing "), r("p", { class: "text-muted-foreground" }, " Choose the plan that fits your team. No hidden fees. ")], -1)], 64));
	}
}), Pt = kt({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Pt), (e, t) => ee(e.$slots, "default");
	}
}), It = { render() {
	return s(Ft, {}, { default: () => s(Nt) });
} };
