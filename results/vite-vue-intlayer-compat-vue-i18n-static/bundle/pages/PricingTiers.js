import { Fragment, computed, createElementBlock, createElementVNode, createTextVNode, defineComponent, getCurrentInstance, h, normalizeClass, openBlock, readonly, ref, renderList, renderSlot, toDisplayString } from "vue";
...
var PricingTiers_default = _plugin_vue_export_helper_default(PricingTiers_vue_vue_type_script_setup_true_lang_default, [["render", _sfc_render$1], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/src/components/pages/pricing/PricingTiers.vue"]]);
...
var s = (e, t) => {
	let { locale: n, isCookieEnabled: r, variant: a } = t ?? {}, s = o(n, r, a);
