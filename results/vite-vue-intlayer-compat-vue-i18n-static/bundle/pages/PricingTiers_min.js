import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, createTextVNode as i, defineComponent as a, getCurrentInstance as o, h as s, inject as c, normalizeClass as l, openBlock as u, readonly as d, ref as f, renderList as p, renderSlot as m, toDisplayString as h, unref as g } from "vue";
var ee = (e, t, n) => typeof e == "string" ? n?.[t]?.[e] ?? n?.[t.split("-")[0] ?? ""]?.[e] : e, _ = (e, t, n, r) => {
...
}, te = "translation", ne = "enumeration", re = "plural", y = "insertion", ie = "object", ae = "array", oe = "markdown", b = "html", se = "gender", ce = "select", x = (e, t) => {
...
function E(e, t, n) {
	let r = t ?? C?.defaultLocale, i = `${r}|${n ? JSON.stringify(n) : ""}`, a = e, o = fe.get(a);
...
var je = /* @__PURE__ */ new WeakMap(), Me = 0, Ne = (e) => {
	...
	let r = qe()[e];
	return r ? mt(r, t, n) : (Xe.has(e) || (I({ log: T })(typeof window > "u" ? `Dictionary ${Ae(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), Xe.add(e)), Ye(e));
}, Qe = (e) => {
	...
	if (q(e)) return e.nodeType === "html" ? e[b] : e[oe];
}, nt = (e, t) => {
...
var ut = (e) => J, dt = J, ft = (e, t = !0) => [
	...
	let { locale: r, selector: i } = We(t), a = Fe(r ?? C.defaultLocale, Ge(i), n), o = Ie(e, a);
...
var wt = (e, t) => Ct(e, {
	...
	return M(c, a, o, e);
}, jt = () => C?.locales?.map(String) ?? [], $ = (e) => {
	I({ log: T })(`${L(e, F)} has no effect with ${L("@intlayer/vue-i18n", Ee)} — translations are managed by the compiled intlayer dictionaries.`);
}, Mt = ((e = {}) => {
	let n = e.messages;
	e.messages !== void 0 && I({ log: T })(`${L("createI18n", F)}: the ${L("`messages`", F)} option is used as a fallback. For optimal bundle size, remove the locale JSON imports and use ${L("useDictionary", F)} or compile your intlayer dictionaries instead:\n  ${L("Before:", P)} createI18n({ messages: { en, fr, … } })\n  ${L("After: ", P)} createI18n({})`);
	let r = _t(e.locale), i = e.datetimeFormats, a = e.numberFormats, o = () => String(r.locale.value), s = t({
		get: () => o(),
		set: (e) => {
			r.setLocale(e);
		}
	}), c = (e, ...t) => At(o(), void 0, e, t, n), l = (e, t) => _(e, t, o(), i), u = (e, t) => v(e, t, o(), a), d = {
		locale: s,
		availableLocales: jt(),
	...
	let { locale: n, setLocale: r, availableLocales: i } = Dt(), a = c(Ot)?.__optionsMessages, o = e?.namespace, s = e?.datetimeFormats, l = e?.numberFormats, u = t({
		get: () => n.value,
		set: (e) => {
			r(e);
		}
	...
	return {
		...
		d: (e, t) => _(e, t, n.value, s),
		n: (e, t) => v(e, t, n.value, l)
	};
}), Pt = { class: "grid gap-6 md:grid-cols-3" }, Ft = { class: "text-lg font-semibold text-foreground" }, It = { class: "my-4" }, Lt = { class: "text-3xl font-bold text-foreground" }, Rt = { class: "text-sm text-muted-foreground" }, zt = { class: "mb-6 flex-1 space-y-2" }, Bt = a({
	__name: "PricingTiers",
	setup(t) {
		let { t: a } = Nt(), o = [
			{
		...
		return (t, s) => (u(), n("div", Pt, [(u(), n(e, null, p(o, (t) => r("div", {
			key: t.nameKey,
			...
			r("h3", Ft, h(g(a)(`pricing.tiers.${t.nameKey}`)), 1),
			r("div", It, [r("span", Lt, h(g(a)(`pricing.tiers.${t.priceKey}`)), 1), r("span", Rt, h(t.periodKey ? g(a)(`pricing.tiers.${t.periodKey}`) : ""), 1)]),
			r("ul", zt, [(u(!0), n(e, null, p(t.features, (e) => (u(), n("li", {
				key: e,
				class: "flex items-center gap-2 text-sm text-muted-foreground"
			}, [s[0] ||= r("span", { class: "text-primary" }, "✓", -1), i(" " + h(g(a)(`pricing.tiers.${e}`)), 1)]))), 128))]),
			r("button", {
				type: "button",
			...
			}, h(t.nameKey === "enterpriseName" ? g(a)("pricing.tiers.contactSales") : g(a)("pricing.tiers.getStarted")), 3)
		], 2)), 64))]));
	}
}), Vt = Mt({
	legacy: !1,
