...
var St = (e, t) => xt(e, {
...
}), Mt = { class: "grid gap-6 md:grid-cols-2 lg:grid-cols-3" }, Nt = { class: "mb-2 text-lg font-semibold text-foreground" }, Pt = { class: "mb-4 text-sm text-muted-foreground" }, Ft = { class: "flex items-center justify-between" }, It = { class: "text-sm font-bold text-primary" }, Lt = {
	type: "button",
	...
	setup(t) {
		...
		return (t, o) => (c(), n("div", Mt, [(c(), n(e, null, d(a, (e) => r("div", {
			key: e,
			class: "flex flex-col justify-between rounded-lg border border-border bg-card p-6"
		}, [r("div", null, [r("h3", Nt, f(p(i)(`products.grid.${e}Name`)), 1), r("p", Pt, f(p(i)(`products.grid.${e}Desc`)), 1)]), r("div", Ft, [r("span", It, f(p(i)(`products.grid.${e}Price`)), 1), r("button", Lt, f(p(i)("products.grid.learnMore")), 1)])])), 64))]));
	}
}), zt = At({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(zt), (e, t) => ee(e.$slots, "default");
	}
}), Vt = { render() {
