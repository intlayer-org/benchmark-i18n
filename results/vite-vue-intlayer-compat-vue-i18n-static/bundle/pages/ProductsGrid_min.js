...
import { Fragment as s, computed as c, createElementBlock as l, createElementVNode as u, defineComponent as d, getCurrentInstance as f, h as p, inject as m, openBlock as h, renderList as g, renderSlot as _, toDisplayString as v, unref as y } from "vue";
...
}, ne = "translation", x = "enumeration", re = "plural", ie = "condition", S = "insertion", ae = "object", oe = "array", se = "markdown", C = "html", w = "gender", T = "select", E = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), D = (e, t) => {
...
var et = (e) => Y, tt = Y, nt = (e, t = !0) => [
	...
	}), f = (e, ...n) => ut(u(), void 0, e, n, t), p = (e, t) => te(e, t, u(), s), m = (e, t) => b(e, t, u(), l), h = {
		locale: d,
		availableLocales: dt(),
	...
	return {
		...
		n: (e, n) => b(e, n, t.value, s)
	};
}), mt = { class: "grid gap-6 md:grid-cols-2 lg:grid-cols-3" }, ht = { class: "mb-2 text-lg font-semibold text-foreground" }, gt = { class: "mb-4 text-sm text-muted-foreground" }, _t = { class: "flex items-center justify-between" }, vt = { class: "text-sm font-bold text-primary" }, yt = {
	type: "button",
	...
	setup(e) {
		...
		return (e, r) => (h(), l("div", mt, [(h(), l(s, null, g(n, (e) => u("div", {
			key: e,
			class: "flex flex-col justify-between rounded-lg border border-border bg-card p-6"
		}, [u("div", null, [u("h3", ht, v(y(t)(`products.grid.${e}Name`)), 1), u("p", gt, v(y(t)(`products.grid.${e}Desc`)), 1)]), u("div", _t, [u("span", vt, v(y(t)(`products.grid.${e}Price`)), 1), u("button", yt, v(y(t)("products.grid.learnMore")), 1)])])), 64))]));
	}
}), xt = ft({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(xt), (e, t) => _(e.$slots, "default");
	}
}), Ct = { render() {
	return p(St, {}, { default: () => p(bt) });
} };
