...
}), gt = { class: "mb-2 text-3xl font-bold text-foreground" }, _t = { class: "mb-10 text-muted-foreground" }, vt = d({
	__name: "ProductsHeader",
	setup(e) {
		let { t } = pt();
		return (e, n) => (h(), l(s, null, [
			ee(ht),
			u("h1", gt, _(v(t)("products.header.title")), 1),
			u("p", _t, _(v(t)("products.header.description")), 1)
		], 64));
	}
}), yt = ft({
	legacy: !1,
