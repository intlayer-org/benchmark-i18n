...
var Qe = (e) => Y, $e = Y, et = (e, t = !0) => [
...
}), ft = { class: "rounded-lg border border-border bg-card p-6" }, pt = { class: "mb-4 text-lg font-semibold text-foreground" }, mt = { class: "space-y-4" }, ht = {
	for: "display-name",
	...
	setup(e) {
		let { t } = dt();
		return (e, n) => (p(), c("section", ft, [l("h2", pt, h(g(t)("settings.profile.title")), 1), l("div", mt, [l("div", null, [l("label", ht, h(g(t)("settings.profile.displayName")), 1), n[0] ||= l("input", {
			id: "display-name",
		...
		}, null, -1)]), l("div", null, [l("label", gt, h(g(t)("settings.profile.email")), 1), n[1] ||= l("input", {
			id: "email",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(vt), (e, t) => m(e.$slots, "default");
	}
}), bt = { render() {
	return d(yt, {}, { default: () => d(_t) });
} };
