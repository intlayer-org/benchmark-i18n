...
var vt = (e, t) => _t(e, {
	...
	return n;
}, At = { class: "rounded-lg border border-border bg-card p-6" }, jt = { class: "mb-4 text-lg font-semibold text-foreground" }, Mt = { class: "space-y-4" }, Nt = {
	for: "display-name",
...
function Ft(e, r, i, a, o, c) {
	return s(), t("section", At, [n("h2", jt, d(a.t("settings.profile.title")), 1), n("div", Mt, [n("div", null, [n("label", Nt, d(a.t("settings.profile.displayName")), 1), r[0] ||= n("input", {
		id: "display-name",
	...
	}, null, -1)]), n("div", null, [n("label", Pt, d(a.t("settings.profile.email")), 1), r[1] ||= n("input", {
		id: "email",
		value: "john@example.com",
		class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring"
	}, null, -1)])])]);
}
var It = kt(Ot, [["render", Ft], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/src/components/pages/settings/ProfileSection.vue"]]), Lt = Et({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en"
}), Rt = r({
...
var Bt = kt(Rt, [["render", zt], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/scripts/Wrapper.vue"]]), Vt = { render() {
	return a(Bt, {}, { default: () => a(It) });
} };
