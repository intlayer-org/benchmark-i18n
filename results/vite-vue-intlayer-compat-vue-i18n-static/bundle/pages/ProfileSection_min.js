...
var L = /* @__PURE__ */ new WeakMap(), R = 0, Oe = (e) => {
	...
	let r = We()[e];
	return r ? dt(r, t, n) : (qe.has(e) || (F({ log: C })(typeof window > "u" ? `Dictionary ${De(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), qe.add(e)), Ke(e));
}, Ye = (e) => {
...
var xt = (e, t) => bt(e, {
	...
	setup(e) {
		let { t: r } = kt();
		return (e, i) => (s(), t("section", At, [n("h2", jt, d(f(r)("settings.profile.title")), 1), n("div", Mt, [n("div", null, [n("label", Nt, d(f(r)("settings.profile.displayName")), 1), i[0] ||= n("input", {
			id: "display-name",
		...
		}, null, -1)]), n("div", null, [n("label", Pt, d(f(r)("settings.profile.email")), 1), i[1] ||= n("input", {
			id: "email",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(It), (e, t) => u(e.$slots, "default");
	}
}), Rt = { render() {
	return a(Lt, {}, { default: () => a(Ft) });
} };
