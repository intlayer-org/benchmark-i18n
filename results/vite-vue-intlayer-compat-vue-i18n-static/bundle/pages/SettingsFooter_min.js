...
var vt = (e, t) => _t(e, {
	...
	return n;
}, At = { class: "flex justify-end gap-3" }, jt = {
	type: "button",
...
function Nt(e, r, i, a, o, c) {
	return s(), t("div", At, [n("button", jt, d(a.t("settings.footer.cancel")), 1), n("button", Mt, d(a.t("settings.footer.saveChanges")), 1)]);
}
var Pt = kt(Ot, [["render", Nt], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/src/components/pages/settings/SettingsFooter.vue"]]), Ft = Et({
	legacy: !1,
	locale: "en",
	fallbackLocale: "en"
}), It = r({
...
var Rt = kt(It, [["render", Lt], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/scripts/Wrapper.vue"]]), zt = { render() {
	return a(Rt, {}, { default: () => a(Pt) });
} };
