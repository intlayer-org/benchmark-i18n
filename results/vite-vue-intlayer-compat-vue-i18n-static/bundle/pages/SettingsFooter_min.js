...
var xt = (e, t) => bt(e, {
	...
	setup(e) {
		let { t: r } = kt();
		return (e, i) => (s(), t("div", At, [n("button", jt, d(f(r)("settings.footer.cancel")), 1), n("button", Mt, d(f(r)("settings.footer.saveChanges")), 1)]));
	}
}), Pt = Ot({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Pt), (e, t) => u(e.$slots, "default");
	}
}), It = { render() {
	return a(Ft, {}, { default: () => a(Nt) });
} };
