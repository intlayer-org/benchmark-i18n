...
}), Pt = { class: "mb-2 text-3xl font-bold text-foreground" }, Ft = { class: "mb-8 text-muted-foreground" }, It = a({
	__name: "SettingsHeader",
	setup(t) {
		let { t: a } = jt();
		return (t, o) => (l(), n(e, null, [
			i(Nt),
			r("h1", Pt, f(p(a)("settings.header.title")), 1),
			r("p", Ft, f(p(a)("settings.header.description")), 1)
		], 64));
	}
}), Lt = At({
	legacy: !1,
