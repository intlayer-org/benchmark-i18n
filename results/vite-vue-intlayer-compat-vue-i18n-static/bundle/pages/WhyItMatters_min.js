...
import { computed as s, createElementBlock as c, createElementVNode as l, defineComponent as u, getCurrentInstance as d, h as f, inject as p, onBeforeMount as m, onMounted as h, openBlock as g, renderSlot as _, toDisplayString as v, unref as y } from "vue";
...
}, ne = "translation", x = "enumeration", S = "plural", re = "condition", C = "insertion", ie = "object", ae = "array", w = "markdown", T = "html", oe = "gender", se = "select", E = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), D = (e, t) => {
...
}, ue = (e, t) => e[le(e, t) ?? "fallback"], de = 50, fe = /* @__PURE__ */ new Map(), O = /* @__PURE__ */ new Set(), pe = (e) => {
...
function k(e, t, n) {
	let i = t ?? r?.defaultLocale, a = `${i}|${n ? JSON.stringify(n) : ""}`, o = e, s = fe.get(o);
	s || (s = /* @__PURE__ */ new Map(), fe.set(o, s));
	let c = s.get(a);
	if (!c) {
		let t = typeof e == "string" ? he(e) : e;
		if (typeof t != "function") throw Error(`[intlayer] \`Intl.${String(e)}\` is not available in this JavaScript engine and has no fallback. Load the matching polyfill before formatting.`);
		s.size > de && s.clear(), c = new t(i, n), s.set(a, c);
	}
	return c;
}
var ge = (e, t, n) => e[k("PluralRules", n).select(t)] ?? e.other, _e = (e, t) => {
	...
	return String(e);
}, N = (e, t = {}, n = "en") => e.replace(/\{\{\s*([^{},]+?)\s*(?:,\s*(\w+)\s*(?:,\s*([^{}]+?)\s*)?)?\}\}/g, (e, r, i, a) => {
	let o = j(t, r);
	return o === void 0 ? e : i ? M(o, i, a, n) : String(o);
}).replace(/\{\s*([\w.]+)\s*,\s*(\w+)\s*(?:,\s*([^}]+?)\s*)?\}/g, (e, r, i, a) => {
	let o = j(t, r);
	return o === void 0 ? e : M(o, i, a, n);
}).replace(/\{\s*([\w.]+)\s*\}/g, (e, n) => {
	let r = j(t, n);
	return r === void 0 ? e : String(r);
}), P = (e, t) => e[t] ?? e.count ?? e.n, F = (e, t = {}, n = "en") => {
	if (e == null) return e;
	if (typeof e == "string") return N(e, t, n);
	...
	let r = e;
	if (r.nodeType === "insertion") return F(r[C], t, n);
	if (r.nodeType === "html") return F(r[T], t, n);
	if (r.nodeType === "plural") {
		let e = r[S];
		return F(ge(e, Number(P(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[x], i = A.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
	...
	if (r.nodeType === "select") {
		let e = r[se], i = P(t, typeof r.variable == "string" ? r.variable : "value");
		return F(_e(e, String(i ?? "")), t, n);
	}
...
}, R = "\x1B[0m", z = "\x1B[90m", be = "\x1B[34m", xe = "\x1B[31m", Se = "\x1B[32m", Ce = "\x1B[35m", we = "\x1B[38;5;3m", B = "\x1B[36m", Te = (e) => e, Ee = (e, t) => {
...
}), H = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? R : n : R}` : e, De = (e, t = we, n = R) => [e].flat().map((e) => H(e, t, n)).join(", ");
H("✗", xe), H("✓", Se), H("⏲", be);
var U = /* @__PURE__ */ new WeakMap(), W = 0, Oe = (e) => {
	if (!e) return "base";
	let t = U.get(e);
	if (t) return t;
	W += 1;
	let n = `p${W}`;
	return U.set(e, n), n;
}, ke = 256, G = /* @__PURE__ */ new WeakMap(), Ae = (e) => typeof e == "object" && !!e, je = (e, t, n) => `${e}_${t}_${Oe(n)}`, Me = (e, t) => {
	...
	if (!Ae(e)) return n;
	let r = G.get(e);
	return r || (r = /* @__PURE__ */ new Map(), G.set(e, r)), r.size >= ke && r.clear(), r.set(t, n), n;
}, Ne = (e, t) => e.replace(/\{\{\s*(.*?)\s*\}\}/g, (e, n) => (t[n.trim()] ?? "").toString()), Pe = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), q = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : Pe.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : q(e ? `${e}.${String(n)}` : String(n)) }), Fe = /* @__PURE__ */ new Set(), Ie = (t, n, r) => {
	let i = e()[t];
	return i ? it(i, n, r) : (Fe.has(t) || (V({ log: a })(typeof window > "u" ? `Dictionary ${De(t)} was not found. Using fallback proxy.` : `Dictionary ${t} was not found. Using fallback proxy.`, { level: "warn" }), Fe.add(t)), q(t));
}, Le = (e) => {
	...
	if (t === void 0 || Array.isArray(e) || !Le(e) || !Le(t)) return e;
	let n = e;
	for (let r of Object.keys(t)) {
		let i = t[r];
		if (r === "__proto__" || r === "constructor" || i === void 0) continue;
		let a = e[r], o = a === void 0 ? i : typeof a == "object" ? Re(a, i) : a;
		o !== a && (n === e && (n = { ...e }), n[r] = o);
	}
	return n;
}, ze = (e, t, n) => {
	...
	if (o.length !== 0) return o.length === 1 || Array.isArray(o[0]) ? o[0] : o.reduce((e, t) => Re(e, t));
}, J = (e) => {
	...
	if (J(e)) return e.nodeType === "html" ? e[T] : e[w];
}, Ve = (e, t) => {
...
}, We = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? Y : {
...
}, Ge = Y, Ke = (e) => Y, qe = Y, Je = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? Y : {
	id: "insertion-plugin",
	...
	let i = e?.nodeType;
	if (typeof t != "function" || !i || !Ye.includes(i)) return t;
...
}, Ze = (e, t) => typeof t == "function" && Ye.includes(e?.nodeType ?? "") ? (n) => Xe(e, t, n) : t, Qe = Y, $e = Y;
process.env.INTLAYER_OPTIMIZED_NESTING;
var et = (e) => Y, tt = Y, nt = (e, t = !0) => [
	We(e ?? r.defaultLocale, t ? r.defaultLocale : void 0),
	Ge,
	Ke(e ?? r.defaultLocale),
	qe,
	Je,
	et(e ?? r.defaultLocale),
	tt,
	Qe,
	$e
].filter((e) => e !== Y), rt = (e, t, n = []) => D(e, {
	...t,
	plugins: n
	...
	let c = n ?? nt(i), l = e, u = (e) => {
		...
		X.add(e);
		try {
			return rt(e.content, t, c);
		} finally {
			t.eager && X.delete(e);
		}
	};
	return l === null ? K(e, o, null) : Array.isArray(l) ? K(e, o, l.map(u)) : K(e, o, u(l));
}, { defaultLocale: at, locales: ot } = r ?? {}, st = ({ isCookieEnabled: e, onLocaleChange: n } = {}) => {
	let r = p(o);
	return {
		locale: s(() => r?.locale?.value ?? at),
		defaultLocale: at,
		availableLocales: ot,
		setLocale: (i) => {
			if (!ot?.map(String).includes(i)) {
...
}, ct = Symbol("global-i18n"), lt = "translation", Z = (e, t, n) => {
	try {
		let r = ce(Ie(t, e), n);
		if (r != null) return r;
	} catch {}
	...
	let { values: a, count: o, defaultMessage: s } = I(r), c = Q(e, t, n);
	if (c === void 0) {
		if (i?.[e]) {
			let r = t ? `${t}.${n}` : n, s = ce(i[e], r);
			if (s !== void 0) return L(s, a, o, e);
		}
		return s === void 0 ? n : L(s, a, o, e);
	}
	return L(c, a, o, e);
}, dt = () => r?.locales?.map(String) ?? [], $ = (e) => {
	V({ log: a })(`${H(e, B)} has no effect with ${H("@intlayer/vue-i18n", Ce)} — translations are managed by the compiled intlayer dictionaries.`);
}, ft = ((e = {}) => {
	let t = e.messages;
	e.messages !== void 0 && V({ log: a })(`${H("createI18n", B)}: the ${H("`messages`", B)} option is used as a fallback. For optimal bundle size, remove the locale JSON imports and use ${H("useDictionary", B)} or compile your intlayer dictionaries instead:\n  ${H("Before:", z)} createI18n({ messages: { en, fr, … } })\n  ${H("After: ", z)} createI18n({})`);
	let o = i(e.locale), c = e.datetimeFormats, l = e.numberFormats, u = () => String(o.locale.value), d = s({
		get: () => u(),
		set: (e) => {
			o.setLocale(e);
		}
	}), f = (e, ...n) => ut(u(), void 0, e, n, t), p = (e, t) => te(e, t, u(), c), m = (e, t) => b(e, t, u(), l), h = {
		locale: d,
		availableLocales: dt(),
		...
		__optionsMessages: t,
		install(t) {
			n(t, { locale: e.locale }), t.provide(ct, v), t.config.globalProperties.$t = f, t.config.globalProperties.$tc = f, t.config.globalProperties.$te = h.te, t.config.globalProperties.$tm = h.tm, t.config.globalProperties.$rt = h.rt, t.config.globalProperties.$d = p, t.config.globalProperties.$n = m, t.config.globalProperties.$i18n = g, t.directive("t", {
				beforeMount: _,
				updated: _
			});
		}
	...
	let { locale: t, setLocale: n, availableLocales: r } = st(), i = p(ct)?.__optionsMessages, a = e?.namespace, o = e?.datetimeFormats, c = e?.numberFormats, l = s({
		get: () => t.value,
		set: (e) => {
			n(e);
		}
	}), u = (e, ...n) => ut(t.value, a, e, n, i);
	return {
		locale: l,
		availableLocales: r,
		t: u,
		...
		tm: (e) => Q(t.value, a, e) ?? {},
		rt: (e, ...n) => {
			let { values: r, count: i } = I(n);
			return L(e, r, i, t.value);
		},
		d: (e, n) => te(e, n, t.value, o),
		n: (e, n) => b(e, n, t.value, c)
	};
});
function mt(e) {
	m(() => {
...
var ht = { class: "mb-16" }, gt = { class: "mb-6 text-2xl font-bold text-foreground" }, _t = { class: "grid gap-6 md:grid-cols-3" }, vt = { class: "rounded-lg border border-border bg-card p-6" }, yt = { class: "mb-2 text-lg font-semibold text-foreground" }, bt = { class: "text-sm text-muted-foreground" }, xt = { class: "rounded-lg border border-border bg-card p-6" }, St = { class: "mb-2 text-lg font-semibold text-foreground" }, Ct = { class: "text-sm text-muted-foreground" }, wt = { class: "rounded-lg border border-border bg-card p-6" }, Tt = { class: "mb-2 text-lg font-semibold text-foreground" }, Et = { class: "text-sm text-muted-foreground" }, Dt = u({
	__name: "WhyItMatters",
	setup(e) {
		mt("WhyItMatters");
		let { t } = pt();
		return (e, n) => (g(), c("section", ht, [l("h2", gt, v(y(t)("home.whyItMatters.title")), 1), l("div", _t, [
			l("div", vt, [l("h3", yt, v(y(t)("home.whyItMatters.bundleSizeTitle")), 1), l("p", bt, v(y(t)("home.whyItMatters.bundleSizeDesc")), 1)]),
			l("div", xt, [l("h3", St, v(y(t)("home.whyItMatters.renderingTitle")), 1), l("p", Ct, v(y(t)("home.whyItMatters.renderingDesc")), 1)]),
			l("div", wt, [l("h3", Tt, v(y(t)("home.whyItMatters.dynamicLoadingTitle")), 1), l("p", Et, v(y(t)("home.whyItMatters.dynamicLoadingDesc")), 1)])
		])]));
	}
}), Ot = ft({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Ot), (e, t) => _(e.$slots, "default");
	}
}), At = { render() {
	return f(kt, {}, { default: () => f(Dt) });
} };
