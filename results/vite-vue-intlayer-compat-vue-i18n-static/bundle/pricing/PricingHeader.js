...
import { Fragment, computed, createElementBlock, createElementVNode, createVNode, defineComponent, getCurrentInstance, h, inject, openBlock, renderSlot, toDisplayString, unref } from "vue";
...
var PricingHeader_default = defineComponent({
	...
	setup(__props) {
		const { t } = useI18n();
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock(Fragment, null, [createVNode(MockBanner_default), createElementVNode("div", _hoisted_1, [createElementVNode("h1", _hoisted_2, toDisplayString(unref(t)("pricing.header.title")), 1), createElementVNode("p", _hoisted_3, toDisplayString(unref(t)("pricing.header.description")), 1)])], 64);
		};
	}
});
var i18n = createI18n({
