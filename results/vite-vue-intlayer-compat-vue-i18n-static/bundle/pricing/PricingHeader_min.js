...
var St = (e, t) => xt(e, {
	...
	let { locale: n, setLocale: r, availableLocales: i } = Tt(), a = c(Et)?.__optionsMessages, o = e?.namespace, s = e?.datetimeFormats, l = e?.numberFormats, u = t({
		get: () => n.value,
		set: (e) => {
			r(e);
		}
...
}), Mt = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, Nt = a({
	__name: "MockBanner",
	setup(e) {
		let { t } = jt();
		return (e, r) => (l(), n("div", Mt, f(p(t)("mockBanner")), 1));
	}
}), Pt = { class: "mb-12 text-center" }, Ft = { class: "mb-3 text-3xl font-bold text-foreground" }, It = { class: "text-muted-foreground" }, Lt = a({
	__name: "PricingHeader",
	setup(t) {
		let { t: a } = jt();
		return (t, o) => (l(), n(e, null, [i(Nt), r("div", Pt, [r("h1", Ft, f(p(a)("pricing.header.title")), 1), r("p", It, f(p(a)("pricing.header.description")), 1)])], 64));
	}
}), Rt = At({
	legacy: !1,
	locale: "en",
