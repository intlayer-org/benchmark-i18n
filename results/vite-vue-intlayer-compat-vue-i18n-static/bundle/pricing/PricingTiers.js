import { Fragment, computed, createElementBlock, createElementVNode, createTextVNode, defineComponent, getCurrentInstance, h, inject, normalizeClass, openBlock, readonly, ref, renderList, renderSlot, toDisplayString, unref } from "vue";
...
var PricingTiers_default = defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [(openBlock(), createElementBlock(Fragment, null, renderList(tiers, (tier) => {
				return createElementVNode("div", {
					...
					createElementVNode("h3", _hoisted_2, toDisplayString(unref(t)(`pricing.tiers.${tier.nameKey}`)), 1),
					createElementVNode("div", _hoisted_3, [createElementVNode("span", _hoisted_4, toDisplayString(unref(t)(`pricing.tiers.${tier.priceKey}`)), 1), createElementVNode("span", _hoisted_5, toDisplayString(tier.periodKey ? unref(t)(`pricing.tiers.${tier.periodKey}`) : ""), 1)]),
					createElementVNode("ul", _hoisted_6, [(openBlock(true), createElementBlock(Fragment, null, renderList(tier.features, (f) => {
						...
						}, [_cache[0] || (_cache[0] = createElementVNode("span", { class: "text-primary" }, "✓", -1)), createTextVNode(" " + toDisplayString(unref(t)(`pricing.tiers.${f}`)), 1)]);
					}), 128))]),
					...
					}, toDisplayString(tier.nameKey === "enterpriseName" ? unref(t)("pricing.tiers.contactSales") : unref(t)("pricing.tiers.getStarted")), 3)
				], 2);
			}), 64))]);
		};
	}
