...
import { Fragment as s, computed as c, createElementBlock as l, createElementVNode as u, createTextVNode as d, defineComponent as f, getCurrentInstance as p, h as m, inject as h, normalizeClass as g, openBlock as _, renderList as v, renderSlot as ee, toDisplayString as y, unref as b } from "vue";
...
}, ie = "translation", x = "enumeration", S = "plural", ae = "condition", C = "insertion", oe = "object", se = "array", w = "markdown", T = "html", ce = "gender", le = "select", E = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), D = (e, t) => {
...
}, fe = (e, t) => e[de(e, t) ?? "fallback"], pe = 50, O = /* @__PURE__ */ new Map(), k = /* @__PURE__ */ new Set(), me = (e) => {
...
function A(e, t, n) {
	...
	if (!c) {
		...
		s.size > pe && s.clear(), c = new t(i, n), s.set(a, c);
	}
	return c;
}
var _e = (e, t, n) => e[A("PluralRules", n).select(t)] ?? e.other, ve = (e, t) => {
	...
	let r = e;
	if (r.nodeType === "insertion") return I(r[C], t, n);
	if (r.nodeType === "html") return I(r[T], t, n);
	if (r.nodeType === "plural") {
		let e = r[S];
		return I(_e(e, Number(F(t, "count") ?? 1), n), t, n);
	}
...
}, z = "\x1B[0m", B = "\x1B[90m", xe = "\x1B[34m", Se = "\x1B[31m", Ce = "\x1B[32m", we = "\x1B[35m", Te = "\x1B[38;5;3m", V = "\x1B[36m", Ee = (e) => e, De = (e, t) => {
...
}), U = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? z : n : z}` : e, Oe = (e, t = Te, n = z) => [e].flat().map((e) => U(e, t, n)).join(", ");
U("✗", Se), U("✓", Ce), U("⏲", xe);
var W = /* @__PURE__ */ new WeakMap(), ke = 0, Ae = (e) => {
	if (!e) return "base";
	let t = W.get(e);
	if (t) return t;
	ke += 1;
	...
	let i = e()[t];
	return i ? st(i, n, r) : (Re.has(t) || (H({ log: a })(typeof window > "u" ? `Dictionary ${Oe(t)} was not found. Using fallback proxy.` : `Dictionary ${t} was not found. Using fallback proxy.`, { level: "warn" }), Re.add(t)), Le(t));
}, Be = (e) => {
...
}, Je = J, Ye = (e) => J, Xe = J, Ze = process.env.INTLAYER_NODE_TYPE_INSERTION === "false" ? J : {
	id: "insertion-plugin",
	...
	transform: (e, t, n) => {
		let r = [...t.keyPath, { type: C }], i = e[C], a = {
			...
			transform: (e, n, r) => {
				if (q(e)) return (i) => Ge(e, i, n, t.plugins, r);
				let i = r(e, {
					...n,
					children: e,
...
}, et = (e, t) => typeof t == "function" && Qe.includes(e?.nodeType ?? "") ? (n) => $e(e, t, n) : t, tt = J, nt = J;
process.env.INTLAYER_OPTIMIZED_NESTING;
var rt = (e) => J, it = J, at = (e, t = !0) => [
	...
	tt,
	nt
].filter((e) => e !== J), ot = (e, t, n = []) => D(e, {
	...t,
	plugins: n
}), Y = /* @__PURE__ */ new WeakSet(), st = (e, t, n) => {
...
}, { defaultLocale: X, locales: ct } = r ?? {}, lt = ({ isCookieEnabled: e, onLocaleChange: n } = {}) => {
	let r = h(o);
	return {
		locale: c(() => r?.locale?.value ?? X),
		defaultLocale: X,
		availableLocales: ct,
		setLocale: (i) => {
	...
	H({ log: a })(`${U(e, V)} has no effect with ${U("@intlayer/vue-i18n", we)} — translations are managed by the compiled intlayer dictionaries.`);
}, mt = ((e = {}) => {
	let t = e.messages;
	...
	}), f = (e, ...n) => ft(u(), void 0, e, n, t), p = (e, t) => ne(e, t, u(), s), m = (e, t) => re(e, t, u(), l), h = {
		locale: d,
		availableLocales: pt(),
	...
	let { locale: t, setLocale: n, availableLocales: r } = lt(), i = h(ut)?.__optionsMessages, a = e?.namespace, o = e?.datetimeFormats, s = e?.numberFormats, l = c({
		get: () => t.value,
		set: (e) => {
			n(e);
		}
	...
	return {
		...
		d: (e, n) => ne(e, n, t.value, o),
		n: (e, n) => re(e, n, t.value, s)
	};
}), gt = { class: "grid gap-6 md:grid-cols-3" }, _t = { class: "text-lg font-semibold text-foreground" }, vt = { class: "my-4" }, yt = { class: "text-3xl font-bold text-foreground" }, bt = { class: "text-sm text-muted-foreground" }, xt = { class: "mb-6 flex-1 space-y-2" }, St = f({
	__name: "PricingTiers",
	setup(e) {
		let { t } = ht(), n = [
			{
		...
		return (e, r) => (_(), l("div", gt, [(_(), l(s, null, v(n, (e) => u("div", {
			key: e.nameKey,
			class: g(["flex flex-col rounded-lg border p-6", e.highlighted ? "border-primary bg-primary/5 ring-1 ring-primary" : "border-border bg-card"])
		}, [
			u("h3", _t, y(b(t)(`pricing.tiers.${e.nameKey}`)), 1),
			u("div", vt, [u("span", yt, y(b(t)(`pricing.tiers.${e.priceKey}`)), 1), u("span", bt, y(e.periodKey ? b(t)(`pricing.tiers.${e.periodKey}`) : ""), 1)]),
			u("ul", xt, [(_(!0), l(s, null, v(e.features, (e) => (_(), l("li", {
				key: e,
				class: "flex items-center gap-2 text-sm text-muted-foreground"
			}, [r[0] ||= u("span", { class: "text-primary" }, "✓", -1), d(" " + y(b(t)(`pricing.tiers.${e}`)), 1)]))), 128))]),
			u("button", {
				type: "button",
				class: g(["w-full rounded-md px-4 py-2 text-sm font-medium transition-opacity hover:opacity-90", e.highlighted ? "bg-primary text-primary-foreground" : "border border-border text-foreground hover:bg-accent"])
			}, y(e.nameKey === "enterpriseName" ? b(t)("pricing.tiers.contactSales") : b(t)("pricing.tiers.getStarted")), 3)
		], 2)), 64))]));
	}
}), Ct = mt({
	legacy: !1,
	...
	__name: "Wrapper",
	setup(e) {
		let t = p()?.appContext.app;
		return t && !t.config.globalProperties.$i18n && t.use(Ct), (e, t) => ee(e.$slots, "default");
	}
}), Tt = { render() {
	return m(wt, {}, { default: () => m(St) });
} };
