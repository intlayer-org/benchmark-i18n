	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [(openBlock(), createElementBlock(Fragment, null, renderList(products, (p) => {
				...
				}, [createElementVNode("div", null, [createElementVNode("h3", _hoisted_2, toDisplayString(unref(t)(`products.grid.${p}Name`)), 1), createElementVNode("p", _hoisted_3, toDisplayString(unref(t)(`products.grid.${p}Desc`)), 1)]), createElementVNode("div", _hoisted_4, [createElementVNode("span", _hoisted_5, toDisplayString(unref(t)(`products.grid.${p}Price`)), 1), createElementVNode("button", _hoisted_6, toDisplayString(unref(t)("products.grid.learnMore")), 1)])]);
			}), 64))]);
		};
	}
});
