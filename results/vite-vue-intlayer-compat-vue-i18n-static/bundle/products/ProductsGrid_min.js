...
var p = i({
	...
	return n;
}, ee = { class: "grid gap-6 md:grid-cols-2 lg:grid-cols-3" }, te = { class: "mb-2 text-lg font-semibold text-foreground" }, ne = { class: "mb-4 text-sm text-muted-foreground" }, re = { class: "flex items-center justify-between" }, ie = { class: "text-sm font-bold text-primary" };
function ae(t, i, a, o, c, l) {
	return s(), n("div", ee, [(s(), n(e, null, u(o.products, (e) => r("div", {
		key: e.name,
		class: "flex flex-col justify-between rounded-lg border border-border bg-card p-6"
	}, [r("div", null, [r("h3", te, f(e.name), 1), r("p", ne, f(e.desc), 1)]), r("div", re, [r("span", ie, f(e.price), 1), i[0] ||= r("button", {
		type: "button",
		class: "rounded-md bg-primary px-4 py-2 text-xs font-medium text-primary-foreground hover:opacity-90 transition-opacity"
	}, " Learn More ", -1)])])), 64))]);
}
var oe = m(p, [["render", ae], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/intlayer-compat-vue-i18n-app/src/components/pages/products/ProductsGrid.vue"]]), se = (e, t, n) => typeof e == "string" ? n?.[t]?.[e] ?? n?.[t.split("-")[0] ?? ""]?.[e] : e, ce = (e, t, n, r) => {
