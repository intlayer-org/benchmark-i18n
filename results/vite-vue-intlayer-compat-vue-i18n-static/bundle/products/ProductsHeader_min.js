...
var St = (e, t) => xt(e, {
...
}), Pt = { class: "mb-2 text-3xl font-bold text-foreground" }, Ft = { class: "mb-10 text-muted-foreground" }, It = a({
	__name: "ProductsHeader",
	setup(t) {
		let { t: a } = jt();
		return (t, o) => (l(), n(e, null, [
			i(Nt),
			r("h1", Pt, f(p(a)("products.header.title")), 1),
			r("p", Ft, f(p(a)("products.header.description")), 1)
		], 64));
	}
}), Lt = At({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Lt), (e, t) => ee(e.$slots, "default");
	}
}), zt = { render() {
	return s(Rt, {}, { default: () => s(It) });
} };
