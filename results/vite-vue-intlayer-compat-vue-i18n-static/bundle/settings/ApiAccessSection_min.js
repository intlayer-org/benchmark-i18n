...
var Qe = (e) => Y, $e = Y, et = (e, t = !0) => [
...
}), ft = { class: "rounded-lg border border-border bg-card p-6" }, pt = { class: "mb-4 text-lg font-semibold text-foreground" }, mt = {
	for: "api-key",
	class: "mb-1 block text-sm font-medium text-foreground"
}, ht = { class: "flex gap-2" }, gt = {
	type: "button",
	class: "rounded-md border border-border px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent"
}, _t = { class: "mt-1 text-xs text-muted-foreground" }, vt = u({
	__name: "ApiAccessSection",
	setup(e) {
		let { t } = dt();
		return (e, n) => (p(), c("section", ft, [l("h2", pt, h(g(t)("settings.apiAccess.title")), 1), l("div", null, [
			l("label", mt, h(g(t)("settings.apiAccess.apiKey")), 1),
			l("div", ht, [n[0] ||= l("input", {
				id: "api-key",
				readonly: "",
			...
			}, null, -1), l("button", gt, h(g(t)("settings.apiAccess.copy")), 1)]),
			l("p", _t, h(g(t)("settings.apiAccess.description")), 1)
		])]));
	}
}), yt = ut({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(yt), (e, t) => m(e.$slots, "default");
	}
}), xt = { render() {
	return d(bt, {}, { default: () => d(vt) });
} };
