...
var bt = (e, t) => yt(e, {
...
}), kt = { class: "rounded-lg border border-border bg-card p-6" }, At = { class: "mb-4 text-lg font-semibold text-foreground" }, jt = { class: "space-y-4" }, Mt = {
	for: "display-name",
	...
	setup(e) {
		let { t: r } = Ot();
		return (e, i) => (s(), t("section", kt, [n("h2", At, d(f(r)("settings.profile.title")), 1), n("div", jt, [n("div", null, [n("label", Mt, d(f(r)("settings.profile.displayName")), 1), i[0] ||= n("input", {
			id: "display-name",
		...
		}, null, -1)]), n("div", null, [n("label", Nt, d(f(r)("settings.profile.email")), 1), i[1] ||= n("input", {
			id: "email",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Ft), (e, t) => u(e.$slots, "default");
	}
}), Lt = { render() {
	return a(It, {}, { default: () => a(Pt) });
} };
