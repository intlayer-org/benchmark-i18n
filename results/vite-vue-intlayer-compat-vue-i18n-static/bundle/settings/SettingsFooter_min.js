...
}, ne = "translation", re = "enumeration", ie = "plural", ae = "condition", y = "insertion", oe = "object", se = "array", b = "markdown", x = "html", S = "gender", C = "select", w = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), T = (e, t) => {
...
var _e = (e, t, n) => e[E("PluralRules", n).select(t)] ?? e.other, ve = (e, t) => {
	...
	if (r.nodeType === "plural") {
		let e = r[ie];
		return M(_e(e, Number(j(t, "count") ?? 1), n), t, n);
	}
	if (r.nodeType === "enumeration") {
		let e = r[re], i = D.map((t) => e[t]).find((e) => typeof e == "string") ?? "count", a = e.__intlayer_icu_ordinal === !0, o = {};
...
var Qe = (e) => Y, $e = Y, et = (e, t = !0) => [
	...
	}), d = (e, ...n) => ct(u(), void 0, e, n, t), f = (e, t) => te(e, t, u(), c), p = (e, t) => v(e, t, u(), l), m = {
		locale: ee,
		availableLocales: lt(),
	...
	return {
		...
		n: (e, n) => v(e, n, t.value, c)
	};
}), ft = { class: "flex justify-end gap-3" }, pt = {
	type: "button",
	...
	setup(e) {
		let { t } = dt();
		return (e, n) => (p(), c("div", ft, [l("button", pt, h(g(t)("settings.footer.cancel")), 1), l("button", mt, h(g(t)("settings.footer.saveChanges")), 1)]));
	}
}), gt = ut({
	legacy: !1,
	locale: "en",
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(gt), (e, t) => m(e.$slots, "default");
	}
}), vt = { render() {
	return d(_t, {}, { default: () => d(ht) });
} };
