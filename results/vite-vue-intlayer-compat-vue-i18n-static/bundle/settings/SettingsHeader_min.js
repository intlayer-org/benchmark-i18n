...
}), gt = { class: "mb-2 text-3xl font-bold text-foreground" }, _t = { class: "mb-8 text-muted-foreground" }, vt = d({
	__name: "SettingsHeader",
	setup(e) {
		let { t } = pt();
		return (e, n) => (h(), l(s, null, [
			ee(ht),
			u("h1", gt, _(v(t)("settings.header.title")), 1),
			u("p", _t, _(v(t)("settings.header.description")), 1)
		], 64));
	}
}), yt = ft({
	legacy: !1,
