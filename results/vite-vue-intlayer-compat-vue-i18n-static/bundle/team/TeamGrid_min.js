...
var et = (e) => Y, tt = Y, nt = (e, t = !0) => [
...
}), mt = { class: "grid gap-6 md:grid-cols-2 lg:grid-cols-3" }, ht = { class: "mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-accent text-lg font-bold text-accent-foreground" }, gt = { class: "text-base font-semibold text-foreground" }, _t = { class: "mb-2 text-xs font-medium text-primary" }, vt = { class: "text-sm text-muted-foreground" }, yt = d({
	__name: "TeamGrid",
	setup(e) {
		let { t } = pt(), n = [
			1,
			...
			5,
			6
		], r = (e) => e.split(" ").map((e) => e[0]).join("");
		return (e, i) => (h(), l("div", mt, [(h(), l(s, null, g(n, (e) => u("div", {
			key: e,
			class: "rounded-lg border border-border bg-card p-6 text-center"
		}, [
			u("div", ht, v(r(y(t)(`team.grid.member${e}Name`))), 1),
			u("h3", gt, v(y(t)(`team.grid.member${e}Name`)), 1),
			u("p", _t, v(y(t)(`team.grid.member${e}Role`)), 1),
			u("p", vt, v(y(t)(`team.grid.member${e}Bio`)), 1)
		])), 64))]));
	}
}), bt = ft({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(bt), (e, t) => _(e.$slots, "default");
	}
}), St = { render() {
	return p(xt, {}, { default: () => p(yt) });
} };
