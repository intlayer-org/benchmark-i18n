...
var St = (e, t) => xt(e, {
...
}), Mt = { class: "grid gap-6 md:grid-cols-2 lg:grid-cols-3" }, Nt = { class: "mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-accent text-lg font-bold text-accent-foreground" }, Pt = { class: "text-base font-semibold text-foreground" }, Ft = { class: "mb-2 text-xs font-medium text-primary" }, It = { class: "text-sm text-muted-foreground" }, Lt = i({
	__name: "TeamGrid",
	setup(t) {
		let { t: i } = jt(), a = [
			1,
			...
			5,
			6
		], o = (e) => e.split(" ").map((e) => e[0]).join("");
		return (t, s) => (c(), n("div", Mt, [(c(), n(e, null, d(a, (e) => r("div", {
			key: e,
			class: "rounded-lg border border-border bg-card p-6 text-center"
		}, [
			r("div", Nt, f(o(p(i)(`team.grid.member${e}Name`))), 1),
			r("h3", Pt, f(p(i)(`team.grid.member${e}Name`)), 1),
			r("p", Ft, f(p(i)(`team.grid.member${e}Role`)), 1),
			r("p", It, f(p(i)(`team.grid.member${e}Bio`)), 1)
		])), 64))]));
	}
}), Rt = At({
	legacy: !1,
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$i18n && t.use(Rt), (e, t) => ee(e.$slots, "default");
	}
}), Bt = { render() {
	return o(zt, {}, { default: () => o(Lt) });
} };
