import { Fragment as e, computed as t, createBlock as n, createElementBlock as r, createElementVNode as i, createTextVNode as a, defineComponent as o, h as s, inject as c, isRef as l, markRaw as u, openBlock as d, ref as f, renderList as p, resolveComponent as ee, shallowRef as m, toDisplayString as h, toValue as g, unref as _, watch as v, withCtx as te } from "vue";
...
var y = /* @__PURE__ */ new WeakMap(), b = 0, x = (e) => {
	...
	let n = `p${b}`;
	return y.set(e, n), n;
}, S = 256, C = /* @__PURE__ */ new WeakMap(), w = (e) => typeof e == "object" && !!e, re = (e, t, n) => `${e}_${t}_${x(n)}`, ie = (e, t) => {
	if (!w(e)) return { hit: !1 };
	let n = C.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, ae = "translation", oe = "object", se = "array", E = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), D = (e, t) => {
...
}, k = "\x1B[0m", le = "\x1B[34m", ue = "\x1B[31m", de = "\x1B[32m", fe = "\x1B[38;5;3m", pe = (e) => e, me = (e, t) => {
...
}), A = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? k : n : k}` : e, ge = (e, t = fe, n = k) => [e].flat().map((e) => A(e, t, n)).join(", ");
A("✗", ue), A("✓", de), A("⏲", le);
var _e = {
	"products-grid": {
		key: "products-grid",
	...
	"toLocaleString"
]), j = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : ye.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : j(e ? `${e}.${String(n)}` : String(n)) }), M = /* @__PURE__ */ new Set(), be = (e, t, n) => {
	let r = ve()[e];
	return r ? G(r, t, n) : (M.has(e) || (he({ log: ce })(typeof window > "u" ? `Dictionary ${ge(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), M.add(e)), j(e));
}, N = (e) => {
...
}, L = F, R = (e) => F, z = F, Se = F, B = F, V = F;
process.env.INTLAYER_OPTIMIZED_NESTING;
var H = (e) => F, U = F, Ce = (e, t = !0) => [
	...
	...t,
	plugins: n
}), W = /* @__PURE__ */ new WeakSet(), G = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = re(r ?? O.defaultLocale, "", n), o = ie(e, a);
...
}, K = /* @__PURE__ */ new Map(), Te = (e, t) => Object.create(new Proxy(e, {
	get: (e, t, n) => {
	...
	return Object.assign(o, {
		...
		...n
	}), Object.setPrototypeOf(o, Ee(e, Function.prototype)), u(o);
}, De = {
...
}, Oe = F, ke = F, Ae = F, J = /* @__PURE__ */ new Map(), je = (e, t = !0) => {
	...
	return J.set(n, r), r;
}, Y = (e, t) => be(e, t, je(typeof t == "object" && t ? t.locale : t)), Me = Symbol("intlayer"), X = (e, t) => t.reduce((e, t) => e?.[t], e), Z = (e) => typeof e == "object" && !!e, Q = (e) => typeof e == "function" || Z(e) && ("render" in e || "setup" in e), Ne = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, $ = (e) => u(o({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = c(Me), i = l(r?.locale) ? r.locale : f(r?.locale ?? O.defaultLocale), a = t(() => ({
		selector: void 0,
		locale: n === void 0 ? void 0 : g(n)
	})), o = t(() => a.value.locale ?? i.value), s = m({});
	v([
		() => g(e),
		() => o.value,
		() => a.value.selector
	...
	let u = /* @__PURE__ */ new Map(), d = (e) => {
		...
		let r = t(() => X(s.value, e)), i = new Proxy({}, {
			get(n, i, a) {
				...
				let o = e.concat(i), c = X(s.value, o);
				if (c === void 0 || Z(c) && !Q(c)) return d(o);
				if (Ne(c)) return Pe(t(() => X(s.value, o)));
				if (typeof c == "function") {
					let t = X(s.value, e);
					return t != null && !Object.hasOwn(t, i) ? c.bind(t) : (...e) => X(s.value, o)?.(...e);
				}
				let l = t(() => X(s.value, o));
	...
	return d([]);
}, Ie = { class: "mt-20 border-t border-border bg-card" }, Le = { class: "container py-8" }, Re = { class: "grid gap-8 md:grid-cols-3" }, ze = { class: "mb-2 text-sm font-semibold text-foreground" }, Be = { class: "text-sm text-muted-foreground" }, Ve = { class: "mb-2 text-sm font-semibold text-foreground" }, He = { class: "space-y-1" }, Ue = ["href"], We = { class: "mb-2 text-sm font-semibold text-foreground" }, Ge = { class: "text-sm text-muted-foreground" }, Ke = { class: "mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground" }, qe = o({
	__name: "Footer",
	setup(o) {
		let s = ne(), c = t(() => s.params.locale || "en"), { description: l, resources: u, contact: f, github: m, methodology: g, contributing: v, footerText: y, appName: b, contactEmail: x } = Fe("footer"), S = t(() => [
			{
				label: m,
		...
		return (t, o) => {
			...
			return d(), r("footer", Ie, [i("div", Le, [i("div", Re, [
				i("div", null, [i("h3", ze, h(_(b)), 1), i("p", Be, h(_(l)), 1)]),
				i("div", null, [i("h3", Ve, h(_(u)), 1), i("ul", He, [(d(!0), r(e, null, p(S.value, (e) => (d(), r("li", { key: e.label }, [e.isInternal ? (d(), n(s, {
					key: 0,
					to: e.to,
				...
				i("div", null, [i("h3", We, h(_(f)), 1), i("p", Ge, h(_(x)), 1)])
			]), i("div", Ke, h(_(y)), 1)])]);
		};
	}
});
