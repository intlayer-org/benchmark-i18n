import { Fragment as e, computed as t, createBlock as n, createCommentVNode as r, createElementBlock as i, createElementVNode as a, createTextVNode as o, createVNode as s, defineComponent as c, h as l, inject as u, isRef as d, markRaw as f, normalizeClass as p, onBeforeMount as m, onMounted as h, onUnmounted as g, openBlock as _, ref as v, renderList as y, resolveComponent as ee, shallowRef as b, toDisplayString as x, toValue as S, unref as C, watch as w, withCtx as T } from "vue";
import { useRoute as te, useRouter as E } from "vue-router";
import { ChevronDown as ne } from "lucide-vue-next";
var D = /* @__PURE__ */ new WeakMap(), O = 0, k = (e) => {
	if (!e) return "base";
	let t = D.get(e);
	if (t) return t;
	O += 1;
...
}, ae = "translation", oe = "object", se = "array", P = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), F = (e, t) => {
...
}, R = "\x1B[0m", le = "\x1B[34m", ue = "\x1B[31m", de = "\x1B[32m", fe = "\x1B[38;5;3m", pe = (e) => e, me = (e, t) => {
...
}), z = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? R : n : R}` : e, ge = (e, t = fe, n = R) => [e].flat().map((e) => z(e, t, n)).join(", ");
z("✗", ue), z("✓", de), z("⏲", le);
var _e = {
	"products-grid": {
		key: "products-grid",
...
}, ve = () => _e, ye = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), B = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : ye.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : B(e ? `${e}.${String(n)}` : String(n)) }), V = /* @__PURE__ */ new Set(), be = (e, t, n) => {
	let r = ve()[e];
	return r ? ke(r, t, n) : (V.has(e) || (he({ log: ce })(typeof window > "u" ? `Dictionary ${ge(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), V.add(e)), B(e));
}, H = (e) => {
...
}, K = W, q = (e) => W, J = W, Se = W, Ce = W, we = W;
process.env.INTLAYER_OPTIMIZED_NESTING;
var Te = (e) => W, Ee = W, De = (e, t = !0) => [
	G(e ?? I.defaultLocale, t ? I.defaultLocale : void 0),
	K,
	q(e ?? I.defaultLocale),
	J,
	Se,
	Te(e ?? I.defaultLocale),
	Ee,
	Ce,
	we
].filter((e) => e !== W), Oe = (e, t, n = []) => F(e, {
	...t,
	plugins: n
	...
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = re(r ?? I.defaultLocale, "", n), o = ie(e, a);
...
var Ne = {
	...
	if (t?.isCookieEnabled !== !1 && !Me && L.storage.cookies) for (let n = 0; n < L.storage.cookies.length; n++) {
...
}, Be = W, Ve = W, He = W, X = /* @__PURE__ */ new Map(), Ue = (e, t = !0) => {
	...
	return X.set(n, r), r;
}, We = (e, t) => be(e, t, Ue(typeof t == "object" && t ? t.locale : t)), Ge = (e, t) => Pe(e, {
	...Ne,
	isCookieEnabled: t
	...
	let r = u(Ke), i = d(r?.locale) ? r.locale : v(r?.locale ?? I.defaultLocale), a = t(() => ({
		selector: void 0,
		locale: n === void 0 ? void 0 : S(n)
	})), o = t(() => a.value.locale ?? i.value), s = b({});
	w([
		() => S(e),
		() => o.value,
		() => a.value.selector
	...
	return l([]);
}, { defaultLocale: Qe, locales: $ } = I ?? {}, $e = ({ isCookieEnabled: e, onLocaleChange: n } = {}) => {
	let r = u(Ke);
	return {
		locale: t(() => r?.locale?.value ?? Qe),
		defaultLocale: Qe,
		availableLocales: $,
		setLocale: (t) => {
...
var tt = I.locales;
I.requiredLocales, I.defaultLocale;
var nt = (e) => {
	try {
...
}, rt = { class: "flex items-center gap-2" }, it = ["value"], at = ["value"], ot = c({
	__name: "LocaleSwitcher",
	setup(n) {
		let r = te(), o = E(), { setLocale: s } = $e(), c = t(() => r.params.locale || "en"), l = (e) => {
			s(e);
		...
		return w(c, (e) => {
			s(e);
		}, { immediate: !0 }), (t, n) => (_(), i("div", rt, [a("select", {
			value: c.value,
		...
		}, [(_(!0), i(e, null, y(C(tt), (e) => (_(), i("option", {
			key: e,
			value: e
		}, x(C(nt)(e)), 9, at))), 128))], 40, it)]));
	}
}), st = ["aria-label", "title"], ct = c({
	__name: "ThemeToggle",
	setup(e) {
		let { auto: t, dark: n, light: r, ariaLabelAuto: a, ariaLabelLight: o, ariaLabelDark: s } = Ze("theme-toggle"), c = v("auto");
		function l() {
		...
		}, x(c.value === "auto" ? C(t) : c.value === "dark" ? C(n) : C(r)), 9, st));
	}
...
}, _t = { class: "sr-only" }, vt = c({
	__name: "Header",
	setup(c) {
		et("Header");
		let { home: l, methodology: u, mockPages: d, products: f, pricing: m, team: h, blog: g, careers: b, faq: S, contact: w, settings: E, appName: D, goToGithub: O } = Ze("header"), k = v(!1), A = te(), j = t(() => A.params.locale || "en"), M = t(() => [
			{
				to: `/${j.value}/products`,
				label: f
			},
		...
		return (t, c) => {
			...
			return _(), i("header", lt, [a("nav", ut, [a("div", dt, [s(f, {
				to: `/${j.value}`,
				...
				a("div", pt, [a("button", {
					...
					size: 14,
					class: p(["transition-transform", k.value ? "rotate-180" : ""])
				...
				}, [a("div", mt, [(_(!0), i(e, null, y(M.value, (e) => (_(), n(f, {
					key: e.to,
					to: e.to,
				...
				a("a", gt, [a("span", _t, x(C(O)), 1), c[6] ||= a("svg", {
					viewBox: "0 0 16 16",
					"aria-hidden": "true",
					width: "20",
					height: "20"
