import { Fragment as e, computed as t, createBlock as n, createCommentVNode as r, createElementBlock as i, createElementVNode as a, createTextVNode as o, createVNode as s, defineComponent as c, h as l, inject as u, isRef as d, markRaw as f, normalizeClass as p, onBeforeMount as m, onMounted as h, onUnmounted as g, openBlock as _, ref as v, renderList as y, resolveComponent as b, shallowRef as x, toDisplayString as S, toValue as C, unref as w, watch as T, withCtx as E } from "vue";
import { useRoute as D, useRouter as ee } from "vue-router";
import { ChevronDown as te } from "lucide-vue-next";
var O = /* @__PURE__ */ new WeakMap(), k = 0, A = (e) => {
	if (!e) return "base";
	let t = O.get(e);
	if (t) return t;
	k += 1;
	let n = `p${k}`;
	return O.set(e, n), n;
}, j = 256, M = /* @__PURE__ */ new WeakMap(), N = (e) => typeof e == "object" && !!e, ne = (e, t, n) => `${e}_${t}_${A(n)}`, re = (e, t) => {
	if (!N(e)) return { hit: !1 };
	let n = M.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, ie = "translation", ae = "object", oe = "array", F = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), I = (e, t) => {
...
}, z = "\x1B[0m", ce = "\x1B[34m", le = "\x1B[31m", ue = "\x1B[32m", de = "\x1B[38;5;3m", fe = (e) => e, pe = (e, t) => {
...
}), B = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? z : n : z}` : e, he = (e, t = de, n = z) => [e].flat().map((e) => B(e, t, n)).join(", ");
B("✗", le), B("✓", ue), B("⏲", ce);
var ge = {
	"products-grid": {
		key: "products-grid",
...
}, _e = () => ge, ve = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), ye = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : ve.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : ye(e ? `${e}.${String(n)}` : String(n)) }), be = /* @__PURE__ */ new Set(), xe = (e, t, n) => {
	let r = _e()[e];
	return r ? ke(r, t, n) : (be.has(e) || (me({ log: se })(typeof window > "u" ? `Dictionary ${he(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), be.add(e)), ye(e));
}, Se = (e) => {
	...
	if (t === void 0 || Array.isArray(e) || !Se(e) || !Se(t)) return e;
	let n = e;
	for (let r of Object.keys(t)) {
		let i = t[r];
		if (r === "__proto__" || r === "constructor" || i === void 0) continue;
		let a = e[r], o = a === void 0 ? i : typeof a == "object" ? Ce(a, i) : a;
		o !== a && (n === e && (n = { ...e }), n[r] = o);
	}
	return n;
}, we = (e, t, n) => {
	...
	if (o.length !== 0) return o.length === 1 || Array.isArray(o[0]) ? o[0] : o.reduce((e, t) => Ce(e, t));
}, V = {
	id: "fallback-plugin",
	canHandle: () => !1,
	transform: (e) => e
}, Te = (e, t) => process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false" ? V : {
...
}, H = V, U = (e) => V, W = V, Ee = V, G = V, K = V;
process.env.INTLAYER_OPTIMIZED_NESTING;
var q = (e) => V, J = V, De = (e, t = !0) => [
	Te(e ?? L.defaultLocale, t ? L.defaultLocale : void 0),
	H,
	U(e ?? L.defaultLocale),
	W,
	Ee,
	...
	G,
	K
].filter((e) => e !== V), Oe = (e, t, n = []) => I(e, {
	...t,
	plugins: n
}), Y = /* @__PURE__ */ new WeakSet(), ke = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = ne(r ?? L.defaultLocale, "", n), o = re(e, a);
	if (o.hit) return o.content;
	let s = n ?? De(r), c = e, l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
var Ne = {
	...
	if (t?.isCookieEnabled !== !1 && !Me && R.storage.cookies) for (let n = 0; n < R.storage.cookies.length; n++) {
...
}, Fe = /* @__PURE__ */ new Map(), Ie = (e, t) => Object.create(new Proxy(e, {
	get: (e, t, n) => {
	...
	let n = typeof e, r = e == null ? null : n === "object" || n === "function" ? Object.getPrototypeOf(e) : n, i = Fe.get(t);
	i || (i = /* @__PURE__ */ new Map(), Fe.set(t, i));
	let a = i.get(r);
	return a || (a = Ie(t, r === null ? null : Object.getPrototypeOf(Object(e))), i.set(r, a)), a;
}, Re = ({ value: e, children: t, additionalProps: n = {} }) => {
	...
	return Object.assign(o, {
		...
		...n
	}), Object.setPrototypeOf(o, Le(e, Function.prototype)), f(o);
}, ze = {
	id: "intlayer-node-plugin",
	canHandle: (e) => typeof e == "bigint" || typeof e == "string" || typeof e == "number",
	transform: (e, t) => {
		let { children: n, dictionaryKey: r, keyPath: i } = t, a = (e) => Re({
			value: e,
			children: e
		}), o = a(n);
...
}, Be = V, Ve = V, He = V, X = /* @__PURE__ */ new Map(), Ue = (e, t = !0) => {
	...
	return X.set(n, r), r;
}, We = (e, t) => xe(e, t, Ue(typeof t == "object" && t ? t.locale : t)), Ge = (e, t) => Pe(e, {
	...Ne,
	isCookieEnabled: t
}), Ke = Symbol("intlayer"), Z = (e, t) => t.reduce((e, t) => e?.[t], e), Q = (e) => typeof e == "object" && !!e, qe = (e) => typeof e == "function" || Q(e) && ("render" in e || "setup" in e), Je = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, Ye = (e) => f(c({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
			return t == null ? null : qe(t) ? l(t) : Array.isArray(t) ? l("span", t) : t;
		};
	}
})), Xe = (e) => new Proxy({}, {
	get(t, n) {
		...
		if (n === "c" || n === "asComponent") return Ye(() => e.value);
	...
	let r = u(Ke), i = d(r?.locale) ? r.locale : v(r?.locale ?? L.defaultLocale), a = t(() => ({
		selector: void 0,
		locale: n === void 0 ? void 0 : C(n)
	})), o = t(() => a.value.locale ?? i.value), s = x({});
	T([
		() => C(e),
		() => o.value,
		() => a.value.selector
	...
	let c = /* @__PURE__ */ new Map(), l = (e) => {
		...
		let r = t(() => Z(s.value, e)), i = new Proxy({}, {
			get(n, i, a) {
				...
				if (i === "c" || i === "asComponent") return Ye(() => r.value);
				if (i === "$raw") return r;
				if (i === Symbol.toPrimitive) return () => String(r.value ?? "");
				let o = e.concat(i), c = Z(s.value, o);
				if (c === void 0 || Q(c) && !qe(c)) return l(o);
				if (Je(c)) return Xe(t(() => Z(s.value, o)));
				if (typeof c == "function") {
					let t = Z(s.value, e);
					return t != null && !Object.hasOwn(t, i) ? c.bind(t) : (...e) => Z(s.value, o)?.(...e);
				}
				let u = t(() => Z(s.value, o));
	...
	return l([]);
}, { defaultLocale: Ze, locales: Qe } = L ?? {}, $e = ({ isCookieEnabled: e, onLocaleChange: n } = {}) => {
	let r = u(Ke);
	return {
		locale: t(() => r?.locale?.value ?? Ze),
		defaultLocale: Ze,
		availableLocales: Qe,
		setLocale: (t) => {
...
var nt = { class: "mt-20 border-t border-border bg-card" }, rt = { class: "container py-8" }, it = { class: "grid gap-8 md:grid-cols-3" }, at = { class: "mb-2 text-sm font-semibold text-foreground" }, ot = { class: "text-sm text-muted-foreground" }, st = { class: "mb-2 text-sm font-semibold text-foreground" }, ct = { class: "space-y-1" }, lt = ["href"], ut = { class: "mb-2 text-sm font-semibold text-foreground" }, dt = { class: "text-sm text-muted-foreground" }, ft = { class: "mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground" }, pt = c({
	__name: "Footer",
	setup(r) {
		let s = D(), c = t(() => s.params.locale || "en"), { description: l, resources: u, contact: d, github: f, methodology: p, contributing: m, footerText: h, appName: g, contactEmail: v } = $("footer"), x = t(() => [
			{
				label: f,
		...
		return (t, r) => {
			let s = b("router-link");
			return _(), i("footer", nt, [a("div", rt, [a("div", it, [
				a("div", null, [a("h3", at, S(w(g)), 1), a("p", ot, S(w(l)), 1)]),
				a("div", null, [a("h3", st, S(w(u)), 1), a("ul", ct, [(_(!0), i(e, null, y(x.value, (e) => (_(), i("li", { key: e.label }, [e.isInternal ? (_(), n(s, {
					key: 0,
					to: e.to,
					class: "text-sm text-muted-foreground hover:text-foreground transition-colors"
				}, {
					default: E(() => [o(S(e.label), 1)]),
					_: 2
				}, 1032, ["to"])) : (_(), i("a", {
					key: 1,
					href: e.href,
				...
				a("div", null, [a("h3", ut, S(w(d)), 1), a("p", dt, S(w(v)), 1)])
			]), a("div", ft, S(w(h)), 1)])]);
		};
	}
});
...
var gt = (e) => {
...
}, _t = { class: "flex items-center gap-2" }, vt = ["value"], yt = ["value"], bt = c({
	__name: "LocaleSwitcher",
	setup(n) {
		let r = D(), o = ee(), { setLocale: s } = $e(), c = t(() => r.params.locale || "en"), l = (e) => {
			s(e);
		...
		return T(c, (e) => {
			s(e);
		}, { immediate: !0 }), (t, n) => (_(), i("div", _t, [a("select", {
			value: c.value,
		...
		}, [(_(!0), i(e, null, y(w(ht), (e) => (_(), i("option", {
			key: e,
			value: e
		}, S(w(gt)(e)), 9, yt))), 128))], 40, vt)]));
	}
}), xt = ["aria-label", "title"], St = c({
	__name: "ThemeToggle",
	setup(e) {
		let { auto: t, dark: n, light: r, ariaLabelAuto: a, ariaLabelLight: o, ariaLabelDark: s } = $("theme-toggle"), c = v("auto");
		function l() {
		...
		}, S(c.value === "auto" ? w(t) : c.value === "dark" ? w(n) : w(r)), 9, xt));
	}
}), Ct = { class: "sticky top-0 z-50 border-b border-border bg-card/80 backdrop-blur-lg" }, wt = { class: "container flex h-16 items-center justify-between" }, Tt = { class: "flex items-center gap-8" }, Et = { class: "hidden items-center gap-6 text-sm font-medium md:flex" }, Dt = { class: "relative" }, Ot = { class: "bg-card border border-border rounded-md shadow-lg overflow-hidden py-1" }, kt = { class: "flex items-center gap-4" }, At = {
	href: "https://github.com/intlayer-org/benchmark-i18n",
	target: "_blank",
	rel: "noreferrer",
	class: "text-muted-foreground transition hover:text-foreground"
}, jt = { class: "sr-only" }, Mt = c({
	__name: "Header",
	setup(c) {
		mt("Header");
		let { home: l, methodology: u, mockPages: d, products: f, pricing: m, team: h, blog: g, careers: x, faq: C, contact: T, settings: ee, appName: O, goToGithub: k } = $("header"), A = v(!1), j = D(), M = t(() => j.params.locale || "en"), N = t(() => [
			{
				to: `/${M.value}/products`,
				label: f
			},
		...
		return (t, c) => {
			let f = b("router-link");
			return _(), i("header", Ct, [a("nav", wt, [a("div", Tt, [s(f, {
				to: `/${M.value}`,
				...
				a("div", Dt, [a("button", {
					...
					size: 14,
					class: p(["transition-transform", A.value ? "rotate-180" : ""])
				}, null, 8, ["class"])], 32), A.value ? (_(), i("div", {
					key: 0,
					class: "absolute left-0 top-full pt-2 w-48",
					onMouseenter: c[4] ||= (e) => A.value = !0,
					onMouseleave: c[5] ||= (e) => A.value = !1
				}, [a("div", Ot, [(_(!0), i(e, null, y(N.value, (e) => (_(), n(f, {
					key: e.to,
					to: e.to,
				...
				a("a", At, [a("span", jt, S(w(k)), 1), c[6] ||= a("svg", {
					viewBox: "0 0 16 16",
					"aria-hidden": "true",
					width: "20",
					height: "20"
	...
	__name: "Layout",
	setup(t) {
		let n = D(), { setLocale: r } = $e(), a = v(0);
		return m(() => {
			a.value = typeof performance < "u" ? performance.now() : 0;
		}), h(() => {
			et(), tt("AppRoot", a.value);
		}), T(() => n.params.locale, (e) => {
