import { computed as e, createElementBlock as t, defineComponent as n, h as r, inject as i, isRef as a, markRaw as o, openBlock as s, ref as c, shallowRef as l, toDisplayString as u, toValue as d, unref as f, watch as ee } from "vue";
var p = /* @__PURE__ */ new WeakMap(), m = 0, te = (e) => {
	if (!e) return "base";
	let t = p.get(e);
	if (t) return t;
	m += 1;
	let n = `p${m}`;
	return p.set(e, n), n;
}, ne = 256, h = /* @__PURE__ */ new WeakMap(), g = (e) => typeof e == "object" && !!e, re = (e, t, n) => `${e}_${t}_${te(n)}`, _ = (e, t) => {
	if (!g(e)) return { hit: !1 };
	let n = h.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, ie = "translation", y = "object", ae = "array", b = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), x = (e, t) => {
	for (let n of t.plugins ?? []) if (n.canHandle(e)) return n.transform(e, t, x);
	if (typeof e != "object" || !e || e.$$typeof !== void 0 || e.__v_isVNode !== void 0 || e._isVNode !== void 0 || e.isJSX !== void 0) return e;
	if (Array.isArray(e)) return e.map((e, n) => x(e, b(t, e, {
		type: ae,
		key: n
	})));
	let n = {};
...
}, C = "\x1B[0m", w = "\x1B[34m", T = "\x1B[31m", E = "\x1B[32m", D = "\x1B[38;5;3m", O = (e) => e, se = (e, t) => {
...
}), k = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? C : n : C}` : e, le = (e, t = D, n = C) => [e].flat().map((e) => k(e, t, n)).join(", ");
k("✗", T), k("✓", E), k("⏲", w);
var ue = {
	"products-grid": {
		key: "products-grid",
	...
	yield e;
} : A(e ? `${e}.${String(n)}` : String(n)) }), j = /* @__PURE__ */ new Set(), pe = (e, t, n) => {
	let r = de()[e];
	return r ? ge(r, t, n) : (j.has(e) || (ce({ log: oe })(typeof window > "u" ? `Dictionary ${le(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), j.add(e)), A(e));
}, M = (e) => {
...
}, L = F, R = (e) => F, z = F, B = F, V = F, H = F;
process.env.INTLAYER_OPTIMIZED_NESTING;
var U = (e) => F, W = F, me = (e, t = !0) => [
	...
	V,
	H
].filter((e) => e !== F), he = (e, t, n = []) => x(e, {
	...t,
	plugins: n
}), G = /* @__PURE__ */ new WeakSet(), ge = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = re(r ?? S.defaultLocale, "", n), o = _(e, a);
	if (o.hit) return o.content;
	let s = n ?? me(r), c = e, l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
}, K = /* @__PURE__ */ new Map(), _e = (e, t) => Object.create(new Proxy(e, {
	get: (e, t, n) => {
	...
	let a = i.get(r);
	return a || (a = _e(t, r === null ? null : Object.getPrototypeOf(Object(e))), i.set(r, a)), a;
}, q = ({ value: e, children: t, additionalProps: n = {} }) => {
	let r = c(e), i = typeof t == "function" ? (e) => t(e) : () => t, a = (e) => (r.value, i(e)), s = ((e) => a(e));
	return Object.assign(s, {
		...
		...n
	}), Object.setPrototypeOf(s, ve(e, Function.prototype)), o(s);
}, ye = {
...
}, be = F, xe = F, Se = F, J = /* @__PURE__ */ new Map(), Ce = (e, t = !0) => {
	...
	return J.set(n, r), r;
}, Y = (e, t) => pe(e, t, Ce(typeof t == "object" && t ? t.locale : t)), we = Symbol("intlayer"), X = (e, t) => t.reduce((e, t) => e?.[t], e), Z = (e) => typeof e == "object" && !!e, Q = (e) => typeof e == "function" || Z(e) && ("render" in e || "setup" in e), Te = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, $ = (e) => o(n({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = i(we), o = a(r?.locale) ? r.locale : c(r?.locale ?? S.defaultLocale), s = e(() => ({
		selector: void 0,
		locale: n === void 0 ? void 0 : d(n)
	})), u = e(() => s.value.locale ?? o.value), f = l({});
	ee([
		() => d(t),
		() => u.value,
		() => s.value.selector
	...
	let p = /* @__PURE__ */ new Map(), m = (t) => {
		let n = t.join(".");
		if (p.has(n)) return p.get(n);
		let r = e(() => X(f.value, t)), i = new Proxy({}, {
			get(n, i, a) {
				...
				let o = t.concat(i), s = X(f.value, o);
				if (s === void 0 || Z(s) && !Q(s)) return m(o);
				if (Te(s)) return Ee(e(() => X(f.value, o)));
				if (typeof s == "function") {
					let e = X(f.value, t);
					return e != null && !Object.hasOwn(e, i) ? s.bind(e) : (...e) => X(f.value, o)?.(...e);
				}
				let c = e(() => X(f.value, o));
	...
	return m([]);
}, Oe = { class: "mb-8 rounded-lg border border-yellow-500/20 bg-yellow-500/10 p-4 text-sm text-yellow-600 dark:text-yellow-400" }, ke = n({
	__name: "MockBanner",
	setup(e) {
		let { message: n } = De("mock-banner");
		return (e, r) => (s(), t("div", Oe, u(f(n)), 1));
	}
});
