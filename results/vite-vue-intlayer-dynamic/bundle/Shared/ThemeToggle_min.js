import { computed as e, createElementBlock as t, defineComponent as n, h as r, inject as i, isRef as a, markRaw as o, onMounted as s, onUnmounted as c, openBlock as l, ref as u, shallowRef as d, toDisplayString as f, toValue as p, unref as m, watch as h } from "vue";
var g = /* @__PURE__ */ new WeakMap(), _ = 0, v = (e) => {
	if (!e) return "base";
	let t = g.get(e);
	if (t) return t;
	_ += 1;
	let n = `p${_}`;
	return g.set(e, n), n;
}, y = 256, b = /* @__PURE__ */ new WeakMap(), x = (e) => typeof e == "object" && !!e, ee = (e, t, n) => `${e}_${t}_${v(n)}`, te = (e, t) => {
	if (!x(e)) return { hit: !1 };
	let n = b.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, ne = "translation", re = "object", ie = "array", C = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), w = (e, t) => {
...
}, E = "\x1B[0m", D = "\x1B[34m", O = "\x1B[31m", k = "\x1B[32m", oe = "\x1B[38;5;3m", se = (e) => e, ce = (e, t) => {
...
}), A = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? E : n : E}` : e, ue = (e, t = oe, n = E) => [e].flat().map((e) => A(e, t, n)).join(", ");
A("✗", O), A("✓", k), A("⏲", D);
var de = {
	"products-grid": {
		key: "products-grid",
...
}, fe = () => de, pe = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), j = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : pe.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : j(e ? `${e}.${String(n)}` : String(n)) }), M = /* @__PURE__ */ new Set(), me = (e, t, n) => {
	let r = fe()[e];
	return r ? ye(r, t, n) : (M.has(e) || (le({ log: ae })(typeof window > "u" ? `Dictionary ${ue(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), M.add(e)), j(e));
}, N = (e) => {
...
}, L = F, R = (e) => F, z = F, ge = F, B = F, V = F;
process.env.INTLAYER_OPTIMIZED_NESTING;
var H = (e) => F, U = F, _e = (e, t = !0) => [
	...
	B,
	V
].filter((e) => e !== F), ve = (e, t, n = []) => w(e, {
	...t,
	plugins: n
}), W = /* @__PURE__ */ new WeakSet(), ye = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = ee(r ?? T.defaultLocale, "", n), o = te(e, a);
...
}, G = /* @__PURE__ */ new Map(), be = (e, t) => Object.create(new Proxy(e, {
	get: (e, t, n) => {
	...
	let r = u(e), i = typeof t == "function" ? (e) => t(e) : () => t, a = (e) => (r.value, i(e)), s = ((e) => a(e));
	return Object.assign(s, {
		...
		...n
	}), Object.setPrototypeOf(s, xe(e, Function.prototype)), o(s);
}, Se = {
...
}, Ce = F, we = F, Te = F, q = /* @__PURE__ */ new Map(), J = (e, t = !0) => {
	...
	return q.set(n, r), r;
}, Y = (e, t) => me(e, t, J(typeof t == "object" && t ? t.locale : t)), Ee = Symbol("intlayer"), X = (e, t) => t.reduce((e, t) => e?.[t], e), Z = (e) => typeof e == "object" && !!e, Q = (e) => typeof e == "function" || Z(e) && ("render" in e || "setup" in e), De = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, $ = (e) => o(n({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
			return t == null ? null : Q(t) ? r(t) : Array.isArray(t) ? r("span", t) : t;
		};
	}
})), Oe = (e) => new Proxy({}, {
	get(t, n) {
	...
	let r = i(Ee), o = a(r?.locale) ? r.locale : u(r?.locale ?? T.defaultLocale), s = e(() => ({
		selector: void 0,
		locale: n === void 0 ? void 0 : p(n)
	})), c = e(() => s.value.locale ?? o.value), l = d({});
	h([
		() => p(t),
		() => c.value,
		() => s.value.selector
	...
	let f = /* @__PURE__ */ new Map(), m = (t) => {
		let n = t.join(".");
		if (f.has(n)) return f.get(n);
		let r = e(() => X(l.value, t)), i = new Proxy({}, {
			get(n, i, a) {
				...
				let o = t.concat(i), s = X(l.value, o);
				if (s === void 0 || Z(s) && !Q(s)) return m(o);
				if (De(s)) return Oe(e(() => X(l.value, o)));
				if (typeof s == "function") {
					let e = X(l.value, t);
					return e != null && !Object.hasOwn(e, i) ? s.bind(e) : (...e) => X(l.value, o)?.(...e);
				}
				let c = e(() => X(l.value, o));
	...
	return m([]);
}, Ae = ["aria-label", "title"], je = n({
	__name: "ThemeToggle",
	setup(e) {
		let { auto: n, dark: r, light: i, ariaLabelAuto: a, ariaLabelLight: o, ariaLabelDark: d } = ke("theme-toggle"), p = u("auto");
		function g() {
		...
		h(p, (e) => {
			if (e === "auto") {
				...
				v = () => _("auto"), e.addEventListener("change", v);
			} else v &&= (window.matchMedia("(prefers-color-scheme: dark)").removeEventListener("change", v), null);
		}, { immediate: !0 }), c(() => {
			v && window.matchMedia("(prefers-color-scheme: dark)").removeEventListener("change", v);
		});
		function y() {
			let e = p.value === "light" ? "dark" : p.value === "dark" ? "auto" : "light";
			p.value = e, _(e), window.localStorage.setItem("theme", e);
		}
		let b = () => p.value === "auto" ? a.value : p.value === "light" ? o.value : d.value;
		return (e, a) => (l(), t("button", {
			type: "button",
			onClick: y,
			"aria-label": b(),
			title: b(),
		...
		}, f(p.value === "auto" ? m(n) : p.value === "dark" ? m(r) : m(i)), 9, Ae));
	}
});
