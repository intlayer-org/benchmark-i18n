...
var te = { class: "grid gap-8 md:grid-cols-2" }, ne = { class: "rounded-lg border border-border bg-card p-6" }, re = { class: "mb-3 text-xl font-semibold text-foreground" }, ie = { class: "text-sm text-muted-foreground" }, ae = { class: "rounded-lg border border-border bg-card p-6" }, oe = { class: "mb-3 text-xl font-semibold text-foreground" }, se = { class: "text-sm text-muted-foreground" }, ce = r({
	__name: "AboutGrid",
	setup(e) {
		ee("AboutGrid");
		let { b: r, a: i } = $(v);
		return (e, a) => (d(), t("div", te, [n("div", ne, [n("h2", re, m(g(r).title), 1), n("p", ie, m(g(r).description), 1)]), n("div", ae, [n("h2", oe, m(g(i).title), 1), n("p", se, m(g(i).description), 1)])]));
	}
});
