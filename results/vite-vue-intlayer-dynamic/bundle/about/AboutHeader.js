import { Fragment, computed, createElementBlock, createElementVNode, defineComponent, h, inject, isRef, markRaw, onBeforeMount, onMounted, openBlock, ref, shallowRef, toDisplayString, toValue, unref, watch } from "vue";
...
var AboutHeader_default = defineComponent({
	...
	setup(__props) {
		...
		const { title, description } = v("about-header");
		return (_ctx, _cache) => {
