...
var WhatWeMeasure_vue_vue_type_script_setup_true_lang_default = defineComponent({
	...
	setup(__props, { expose: __expose }) {
		...
		const { b: title, a: metrics } = b(what_we_measure_default);
		const __returned__ = {
			title,
			metrics
		};
...
var WhatWeMeasure_default = _plugin_vue_export_helper_default(WhatWeMeasure_vue_vue_type_script_setup_true_lang_default, [["render", _sfc_render], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-dynamic/vue-intlayer-app/src/components/pages/about/WhatWeMeasure.vue"]]);
