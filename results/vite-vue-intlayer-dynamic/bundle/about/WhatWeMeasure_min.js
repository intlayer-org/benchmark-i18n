import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, defineComponent as i, getCurrentInstance as a, h as o, inject as s, isRef as c, markRaw as l, onBeforeMount as u, onMounted as d, openBlock as f, ref as p, renderList as m, shallowRef as h, toDisplayString as g, toValue as _, unref as v, watch as y } from "vue";
var b = {
	key: "what-we-measure",
...
}, M = A, N = A, ee = A, P = A, F = (e) => A, I = A, L = (e, t = !0) => [
...
}, V = A, H = A, U = A, W = /* @__PURE__ */ new Map(), G = (e, t = !0) => {
	...
	let r = a() ? s(q) : void 0, i = c(r?.locale) ? r.locale : p(r?.locale ?? E.defaultLocale), o = t(() => (n === void 0 ? void 0 : _(n)) ?? i.value), l = h({});
	y([() => _(e), () => o.value], ([e, t]) => {
		l.value = K(e, t);
	}, {
		immediate: !0,
...
var re = { class: "mt-12 mx-auto max-w-3xl" }, ie = { class: "mb-4 text-2xl font-bold text-foreground" }, ae = { class: "space-y-4" }, oe = { class: "block text-sm font-bold text-primary" }, se = { class: "block mt-1 text-sm text-muted-foreground" }, ce = i({
	__name: "WhatWeMeasure",
	setup(t) {
		ne("WhatWeMeasure");
		let { b: i, a } = te(b);
		return (t, o) => (f(), n("section", re, [r("h2", ie, g(v(i)), 1), r("ul", ae, [(f(!0), n(e, null, m(v(a), (e) => (f(), n("li", {
			key: e.metric,
			class: "rounded-md border border-border p-4"
		}, [r("span", oe, g(e.metric), 1), r("span", se, g(e.desc), 1)]))), 128))])]));
	}
});
