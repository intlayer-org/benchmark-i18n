...
}), Ne = { class: "mb-2 text-3xl font-bold text-foreground" }, Pe = { class: "mb-10 text-muted-foreground" }, Fe = a({
	__name: "BlogHeader",
	setup(t) {
		let a = $("blog-header");
		return (t, o) => (u(), n(e, null, [
			i(Me),
			r("h1", Ne, p(h(a).blog), 1),
			r("p", Pe, p(h(a).insightsTutorialsAndAnalysisFrom), 1)
		], 64));
	}
});
