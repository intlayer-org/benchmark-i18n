import { Fragment, computed, createElementBlock, createElementVNode, defineComponent, h, inject, isRef, markRaw, openBlock, ref, renderList, shallowRef, toDisplayString, toValue, watch } from "vue";
...
var CareersBenefits_default = defineComponent({
	...
	setup(__props) {
		const content = v("careers-benefits");
		const benefits = [
			{
				label: "Remote-first",
