...
var H = (e) => F, U = F, ve = (e, t = !0) => [
	...
	return q.set(n, r), r;
}, J = (e, t) => ge(e, t, De(typeof t == "object" && t ? t.locale : t)), Oe = Symbol("intlayer"), Y = (e, t) => t.reduce((e, t) => e?.[t], e), X = (e) => typeof e == "object" && !!e, Z = (e) => typeof e == "function" || X(e) && ("render" in e || "setup" in e), Q = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, $ = (e) => c(i({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = o(Oe), i = s(r?.locale) ? r.locale : u(r?.locale ?? D.defaultLocale), a = t(() => ({
		selector: void 0,
	...
	setup(t) {
		let { title: i, applyNow: a, openings: o } = Ae("open-positions");
		return (t, s) => (l(), n(e, null, [r("h2", je, p(h(i)), 1), r("div", Me, [(l(!0), n(e, null, d(h(o), (e) => (l(), n("div", {
			key: e.title,
			...
			r("p", Pe, p(e.desc), 1),
			r("div", Fe, [
				r("span", Ie, p(e.dept), 1),
				r("span", Le, p(e.location), 1),
				r("span", Re, p(e.type), 1)
			])
		]), r("button", ze, p(h(a)), 1)]))), 128))])], 64));
	}
});
