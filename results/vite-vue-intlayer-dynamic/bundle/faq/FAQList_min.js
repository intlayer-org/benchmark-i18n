...
var _ = {
	...
	return n;
}, te = { class: "mx-auto max-w-3xl space-y-4" }, ne = { class: "cursor-pointer px-6 py-4 text-sm font-medium text-foreground hover:bg-accent/50 transition-colors" }, re = { class: "px-6 pb-4 text-sm text-muted-foreground" };
function ie(t, i, a, o, s, c) {
	return u(), n("div", te, [(u(!0), n(e, null, f(o.faqs, (e) => (u(), n("details", {
		key: e.q,
		class: "group rounded-lg border border-border bg-card"
	}, [r("summary", ne, m(e.q), 1), r("p", re, m(e.a), 1)]))), 128))]);
}
var ae = ee($, [["render", ie], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-dynamic/vue-intlayer-app/src/components/pages/faq/FAQList.vue"]]);
