...
}, b = "translation", x = "object", ee = "array", S = (e, t) => {
...
}, k = D, A = D, te = D, j = D, M = (e) => D, N = D, P = (e, t = !0) => [
...
var ne = { class: "mb-16" }, re = { class: "mb-6 text-2xl font-bold text-foreground" }, ie = { class: "grid gap-6 md:grid-cols-3" }, ae = { class: "rounded-lg border border-border bg-card p-6" }, oe = { class: "mb-2 text-lg font-semibold text-foreground" }, $ = { class: "text-sm text-muted-foreground" }, se = { class: "rounded-lg border border-border bg-card p-6" }, ce = { class: "mb-2 text-lg font-semibold text-foreground" }, le = { class: "text-sm text-muted-foreground" }, ue = { class: "rounded-lg border border-border bg-card p-6" }, de = { class: "mb-2 text-lg font-semibold text-foreground" }, fe = { class: "text-sm text-muted-foreground" }, pe = r({
	__name: "WhyItMatters",
	setup(e) {
		Q("WhyItMatters");
		let { d: r, a: i, c: a, b: o } = Z(v);
		return (e, s) => (d(), t("section", ne, [n("h2", re, m(g(r)), 1), n("div", ie, [
			n("div", ae, [n("h3", oe, m(g(i).title), 1), n("p", $, m(g(i).description), 1)]),
			n("div", se, [n("h3", ce, m(g(a).title), 1), n("p", le, m(g(a).description), 1)]),
			n("div", ue, [n("h3", de, m(g(o).title), 1), n("p", fe, m(g(o).description), 1)])
		])]));
	}
});
