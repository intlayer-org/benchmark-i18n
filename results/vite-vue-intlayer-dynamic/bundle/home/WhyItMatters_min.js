...
var Q = r({
	...
	return n;
}, re = { class: "mb-16" }, ie = { class: "mb-6 text-2xl font-bold text-foreground" }, ae = { class: "grid gap-6 md:grid-cols-3" }, oe = { class: "rounded-lg border border-border bg-card p-6" }, $ = { class: "mb-2 text-lg font-semibold text-foreground" }, se = { class: "text-sm text-muted-foreground" }, ce = { class: "rounded-lg border border-border bg-card p-6" }, le = { class: "mb-2 text-lg font-semibold text-foreground" }, ue = { class: "text-sm text-muted-foreground" }, de = { class: "rounded-lg border border-border bg-card p-6" }, fe = { class: "mb-2 text-lg font-semibold text-foreground" }, pe = { class: "text-sm text-muted-foreground" };
function me(e, r, i, a, o, s) {
	return d(), t("section", re, [n("h2", ie, m(a.title), 1), n("div", ae, [
		n("div", oe, [n("h3", $, m(a.bundleSize.title), 1), n("p", se, m(a.bundleSize.description), 1)]),
		n("div", ce, [n("h3", le, m(a.renderingHydration.title), 1), n("p", ue, m(a.renderingHydration.description), 1)]),
		n("div", de, [n("h3", fe, m(a.dynamicLoading.title), 1), n("p", pe, m(a.dynamicLoading.description), 1)])
	])]);
}
var he = ne(Q, [["render", me], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-dynamic/vue-intlayer-app/src/components/pages/home/WhyItMatters.vue"]]);
