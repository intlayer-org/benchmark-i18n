import { computed, createElementBlock, createElementVNode, defineComponent, h, inject, isRef, markRaw, onBeforeMount, onMounted, openBlock, ref, shallowRef, toDisplayString, toValue, unref, watch } from "vue";
...
var AboutGrid_default = defineComponent({
	...
	setup(__props) {
		...
		const { why, methodology } = v("about-grid");
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [createElementVNode("div", _hoisted_2, [createElementVNode("h2", _hoisted_3, toDisplayString(unref(why).title), 1), createElementVNode("p", _hoisted_4, toDisplayString(unref(why).description), 1)]), createElementVNode("div", _hoisted_5, [createElementVNode("h2", _hoisted_6, toDisplayString(unref(methodology).title), 1), createElementVNode("p", _hoisted_7, toDisplayString(unref(methodology).description), 1)])]);
		};
	}
});
