...
var Me = { class: "grid gap-8 md:grid-cols-2" }, Ne = { class: "rounded-lg border border-border bg-card p-6" }, Pe = { class: "mb-3 text-xl font-semibold text-foreground" }, Fe = { class: "text-sm text-muted-foreground" }, Ie = { class: "rounded-lg border border-border bg-card p-6" }, Le = { class: "mb-3 text-xl font-semibold text-foreground" }, Re = { class: "text-sm text-muted-foreground" }, ze = r({
	__name: "AboutGrid",
	setup(e) {
		je("AboutGrid");
		let { why: r, methodology: i } = Ae("about-grid");
		return (e, a) => (u(), t("div", Me, [n("div", Ne, [n("h2", Pe, p(h(r).title), 1), n("p", Fe, p(h(r).description), 1)]), n("div", Ie, [n("h2", Le, p(h(i).title), 1), n("p", Re, p(h(i).description), 1)])]));
	}
});
