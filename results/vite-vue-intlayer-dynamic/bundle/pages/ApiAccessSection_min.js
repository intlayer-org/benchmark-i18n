...
var H = (e) => F, U = F, ge = (e, t = !0) => [
...
}, G = /* @__PURE__ */ new Map(), K = (e, t) => Object.create(new Proxy(e, {
	get: (e, t, n) => {
	...
	return Object.assign(o, {
		...
		...n
	}), Object.setPrototypeOf(o, ye(e, Function.prototype)), s(o);
}, be = {
...
}, xe = F, Se = F, Ce = F, J = /* @__PURE__ */ new Map(), we = (e, t = !0) => {
	...
	return J.set(n, r), r;
}, Y = (e, t) => me(e, t, we(typeof t == "object" && t ? t.locale : t)), Te = Symbol("intlayer"), X = (e, t) => t.reduce((e, t) => e?.[t], e), Z = (e) => typeof e == "object" && !!e, Q = (e) => typeof e == "function" || Z(e) && ("render" in e || "setup" in e), Ee = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, $ = (e) => s(r({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = a(Te), i = o(r?.locale) ? r.locale : l(r?.locale ?? S.defaultLocale), s = e(() => ({
		selector: void 0,
	...
	return p([]);
}, ke = { class: "rounded-lg border border-border bg-card p-6" }, Ae = { class: "mb-4 text-lg font-semibold text-foreground" }, je = {
	for: "apiKey",
	class: "mb-1 block text-sm font-medium text-foreground"
}, Me = { class: "flex gap-2" }, Ne = {
	type: "button",
	class: "rounded-md border border-border px-4 py-2 text-sm font-medium text-foreground hover:bg-accent transition-colors"
}, Pe = { class: "mt-1 text-xs text-muted-foreground" }, Fe = r({
	__name: "ApiAccessSection",
	setup(e) {
		let { title: r, apiKeyLabel: i, copy: a, description: o } = Oe("api-access-section");
		return (e, s) => (c(), t("section", ke, [n("h2", Ae, u(f(r)), 1), n("div", null, [
			n("label", je, u(f(i)), 1),
			n("div", Me, [s[0] ||= n("input", {
				id: "apiKey",
				readonly: "",
