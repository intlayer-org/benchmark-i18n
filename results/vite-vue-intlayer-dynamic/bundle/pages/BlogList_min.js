...
var v = {
	...
	return u([]);
}, ee = { class: "grid gap-6 md:grid-cols-2" }, te = { class: "mb-3 flex items-center gap-3" }, ne = { class: "rounded-full bg-accent px-3 py-0.5 text-xs font-medium text-accent-foreground" }, re = { class: "text-xs text-muted-foreground" }, ie = { class: "mb-2 text-lg font-semibold text-foreground" }, ae = { class: "mb-4 text-sm text-muted-foreground" }, oe = {
	type: "button",
	...
	setup(t) {
		let { b: i, a } = $(v);
		return (t, o) => (u(), n("div", ee, [(u(!0), n(e, null, f(g(a), (e) => (u(), n("article", {
			key: e.title,
			class: "rounded-lg border border-border bg-card p-6"
		}, [
			r("div", te, [r("span", ne, m(e.category), 1), r("span", re, m(e.date), 1)]),
			r("h2", ie, m(e.title), 1),
			r("p", ae, m(e.excerpt), 1),
			r("button", oe, m(g(i)), 1)
		]))), 128))]));
	}
});
