...
var H = (e) => F, U = F, ve = (e, t = !0) => [
	...
	return p([]);
}, je = { class: "grid gap-6 md:grid-cols-2" }, Me = { class: "mb-3 flex items-center gap-3" }, Ne = { class: "rounded-full bg-accent px-3 py-0.5 text-xs font-medium text-accent-foreground" }, Pe = { class: "text-xs text-muted-foreground" }, Fe = { class: "mb-2 text-lg font-semibold text-foreground" }, Ie = { class: "mb-4 text-sm text-muted-foreground" }, Le = {
	type: "button",
	class: "text-sm font-medium text-primary hover:underline"
}, Re = i({
	__name: "BlogList",
	setup(t) {
		let { readMore: i, posts: a } = Ae("blog-list");
		return (t, o) => (l(), n("div", je, [(l(!0), n(e, null, d(h(a), (e) => (l(), n("article", {
			key: e.title,
			class: "rounded-lg border border-border bg-card p-6"
		}, [
			r("div", Me, [r("span", Ne, p(e.category), 1), r("span", Pe, p(e.date), 1)]),
			r("h2", Fe, p(e.title), 1),
			r("p", Ie, p(e.excerpt), 1),
			r("button", Le, p(h(i)), 1)
		]))), 128))]));
	}
});
