import { Fragment, computed, createElementBlock, createElementVNode, defineComponent, h, inject, isRef, markRaw, openBlock, ref, renderList, shallowRef, toDisplayString, toValue, unref, watch, withModifiers } from "vue";
...
var ContactForm_default = defineComponent({
	__name: "ContactForm",
	setup(__props) {
		const { nameLabel, namePlaceholder, emailLabel, emailPlaceholder, topicLabel, topics, messageLabel, messagePlaceholder, sendMessage } = v("contact-form");
		return (_ctx, _cache) => {
