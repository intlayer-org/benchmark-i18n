...
var v = {
	...
	return u([]);
}, ee = { class: "mx-auto max-w-3xl space-y-4" }, te = { class: "cursor-pointer px-6 py-4 text-sm font-medium text-foreground hover:bg-accent/50 transition-colors" }, ne = { class: "px-6 pb-4 text-sm text-muted-foreground" }, re = i({
	__name: "FAQList",
	setup(t) {
		let { a: i } = $(v);
		return (t, a) => (u(), n("div", ee, [(u(!0), n(e, null, f(g(i), (e) => (u(), n("details", {
			key: e.q,
			class: "group rounded-lg border border-border bg-card"
		}, [r("summary", te, m(e.q), 1), r("p", ne, m(e.a), 1)]))), 128))]));
	}
});
