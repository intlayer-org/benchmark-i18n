import { computed as e, createElementBlock as t, createElementVNode as n, defineComponent as r, h as i, inject as a, isRef as o, markRaw as s, onBeforeMount as c, onMounted as l, openBlock as u, ref as d, shallowRef as f, toDisplayString as p, toValue as m, unref as h, watch as g } from "vue";
...
}, re = "translation", C = "object", w = "array", T = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), E = (e, t) => {
...
}, O = "\x1B[0m", ae = "\x1B[34m", oe = "\x1B[31m", se = "\x1B[32m", ce = "\x1B[38;5;3m", le = (e) => e, ue = (e, t) => {
...
}), k = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? O : n : O}` : e, fe = (e, t = ce, n = O) => [e].flat().map((e) => k(e, t, n)).join(", ");
k("✗", oe), k("✓", se), k("⏲", ae);
var pe = {
	"products-grid": {
		key: "products-grid",
	...
	let r = me()[e];
	return r ? be(r, t, n) : (j.has(e) || (de({ log: ie })(typeof window > "u" ? `Dictionary ${fe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), j.add(e)), A(e));
}, M = (e) => {
...
var H = (e) => F, U = F, ve = (e, t = !0) => [
	...
	return Object.assign(o, {
		...
		...n
	}), Object.setPrototypeOf(o, Se(e, Function.prototype)), s(o);
}, Ce = {
	...
	return q.set(n, r), r;
}, J = (e, t) => ge(e, t, De(typeof t == "object" && t ? t.locale : t)), Oe = Symbol("intlayer"), Y = (e, t) => t.reduce((e, t) => e?.[t], e), X = (e) => typeof e == "object" && !!e, Z = (e) => typeof e == "function" || X(e) && ("render" in e || "setup" in e), Q = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, $ = (e) => s(r({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = a(Oe), i = o(r?.locale) ? r.locale : d(r?.locale ?? D.defaultLocale), s = e(() => ({
		selector: void 0,
		locale: n === void 0 ? void 0 : m(n)
	})), c = e(() => s.value.locale ?? i.value), l = f({});
	g([
		() => m(t),
		() => c.value,
		() => s.value.selector
	...
	let u = /* @__PURE__ */ new Map(), p = (t) => {
		let n = t.join(".");
		if (u.has(n)) return u.get(n);
		let r = e(() => Y(l.value, t)), i = new Proxy({}, {
			get(n, i, a) {
				...
				let o = t.concat(i), s = Y(l.value, o);
				if (s === void 0 || X(s) && !Z(s)) return p(o);
				if (Q(s)) return ke(e(() => Y(l.value, o)));
				if (typeof s == "function") {
					let e = Y(l.value, t);
					return e != null && !Object.hasOwn(e, i) ? s.bind(e) : (...e) => Y(l.value, o)?.(...e);
				}
				let c = e(() => Y(l.value, o));
...
var Me = { class: "mb-16 text-center" }, Ne = { class: "mb-4 text-4xl font-bold tracking-tight text-foreground" }, Pe = { class: "mx-auto max-w-2xl text-lg text-muted-foreground" }, Fe = { class: "mt-8 flex justify-center gap-4" }, Ie = {
	type: "button",
	...
	setup(e) {
		je("Hero");
		let { title: r, description: i, viewResults: a, methodology: o } = Ae("hero");
		return (e, s) => (u(), t("section", Me, [
			n("h1", Ne, p(h(r)), 1),
			n("p", Pe, p(h(i)), 1),
			n("div", Fe, [n("button", Ie, p(h(a)), 1), n("button", Le, p(h(o)), 1)])
		]));
	}
});
