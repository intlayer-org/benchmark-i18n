...
var v = {
...
}, A = O, j = O, ee = O, M = O, N = (e) => O, P = O, F = (e, t = !0) => [
	...
	let r = a() ? s(G) : void 0, i = c(r?.locale) ? r.locale : d(r?.locale ?? w.defaultLocale), o = t(() => (n === void 0 ? void 0 : h(n)) ?? i.value), l = p({});
	_([() => h(e), () => o.value], ([e, t]) => {
		l.value = W(e, t);
	}, {
		immediate: !0,
	...
	return u([]);
}, te = { class: "mb-6 text-2xl font-bold text-foreground" }, ne = { class: "space-y-4" }, re = { class: "text-base font-semibold text-foreground" }, ie = { class: "text-sm text-muted-foreground" }, ae = { class: "mt-2 flex gap-2" }, oe = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, $ = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, se = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, ce = {
	type: "button",
	...
	setup(t) {
		let { c: i, a, b: o } = Q(v);
		return (t, s) => (u(), n(e, null, [r("h2", te, m(g(i)), 1), r("div", ne, [(u(!0), n(e, null, f(g(o), (e) => (u(), n("div", {
			key: e.title,
			...
			r("p", ie, m(e.desc), 1),
			r("div", ae, [
				r("span", oe, m(e.dept), 1),
				r("span", $, m(e.location), 1),
				r("span", se, m(e.type), 1)
			])
		]), r("button", ce, m(g(a)), 1)]))), 128))])], 64));
	}
});
