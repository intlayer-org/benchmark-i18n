...
var PreferencesSection_default = defineComponent({
	...
	setup(__props) {
		const { title, notificationsTitle, notificationsDescription, toggleNotifications, darkModeTitle, darkModeDescription, toggleDarkMode, languageLabel, languages } = v("preferences-section");
		return (_ctx, _cache) => {
