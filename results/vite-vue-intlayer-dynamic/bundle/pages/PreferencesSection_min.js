import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, defineComponent as i, h as a, inject as o, isRef as s, markRaw as c, openBlock as l, ref as u, renderList as d, shallowRef as f, toDisplayString as p, toValue as m, unref as h, watch as g } from "vue";
var _ = /* @__PURE__ */ new WeakMap(), v = 0, ee = (e) => {
	if (!e) return "base";
	let t = _.get(e);
	if (t) return t;
	v += 1;
	let n = `p${v}`;
	return _.set(e, n), n;
}, te = 256, y = /* @__PURE__ */ new WeakMap(), b = (e) => typeof e == "object" && !!e, x = (e, t, n) => `${e}_${t}_${ee(n)}`, ne = (e, t) => {
	if (!b(e)) return { hit: !1 };
	let n = y.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, re = "translation", ie = "object", ae = "array", C = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), w = (e, t) => {
...
}, E = "\x1B[0m", se = "\x1B[34m", ce = "\x1B[31m", le = "\x1B[32m", D = "\x1B[38;5;3m", O = (e) => e, ue = (e, t) => {
	let n = t?.config ?? {}, r = n.mode ?? "default";
	if (r === "disabled" || t?.isVerbose && r !== "verbose") return;
	let i = O(n.prefix), a = i ? [i, ...[e].flat()] : [e].flat(), o = t?.level ?? "info";
...
}), k = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? E : n : E}` : e, fe = (e, t = D, n = E) => [e].flat().map((e) => k(e, t, n)).join(", ");
k("✗", ce), k("✓", le), k("⏲", se);
var pe = {
	"products-grid": {
		key: "products-grid",
	...
	yield e;
} : A(e ? `${e}.${String(n)}` : String(n)) }), j = /* @__PURE__ */ new Set(), ge = (e, t, n) => {
	let r = me()[e];
	return r ? be(r, t, n) : (j.has(e) || (de({ log: oe })(typeof window > "u" ? `Dictionary ${fe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), j.add(e)), A(e));
}, M = (e) => {
...
}, L = F, R = (e) => F, z = F, _e = F, B = F, V = F;
process.env.INTLAYER_OPTIMIZED_NESTING;
var H = (e) => F, U = F, ve = (e, t = !0) => [
	...
	B,
	V
].filter((e) => e !== F), ye = (e, t, n = []) => w(e, {
	...t,
	plugins: n
}), W = /* @__PURE__ */ new WeakSet(), be = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = x(r ?? T.defaultLocale, "", n), o = ne(e, a);
...
}, G = /* @__PURE__ */ new Map(), xe = (e, t) => Object.create(new Proxy(e, {
	get: (e, t, n) => {
	...
	return Object.assign(o, {
		...
		...n
	}), Object.setPrototypeOf(o, Se(e, Function.prototype)), c(o);
}, Ce = {
	id: "intlayer-node-plugin",
	canHandle: (e) => typeof e == "bigint" || typeof e == "string" || typeof e == "number",
	transform: (e, t) => {
		let { children: n, dictionaryKey: r, keyPath: i } = t, a = (e) => K({
			value: e,
			children: e
		}), o = a(n);
...
}, we = F, Te = F, Ee = F, q = /* @__PURE__ */ new Map(), De = (e, t = !0) => {
	...
	return q.set(n, r), r;
}, J = (e, t) => ge(e, t, De(typeof t == "object" && t ? t.locale : t)), Oe = Symbol("intlayer"), Y = (e, t) => t.reduce((e, t) => e?.[t], e), X = (e) => typeof e == "object" && !!e, Z = (e) => typeof e == "function" || X(e) && ("render" in e || "setup" in e), ke = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, Q = (e) => c(i({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = o(Oe), i = s(r?.locale) ? r.locale : u(r?.locale ?? T.defaultLocale), a = t(() => ({
		selector: void 0,
		locale: n === void 0 ? void 0 : m(n)
	})), c = t(() => a.value.locale ?? i.value), l = f({});
	g([
		() => m(e),
		() => c.value,
		() => a.value.selector
	...
	let d = /* @__PURE__ */ new Map(), p = (e) => {
		let n = e.join(".");
		if (d.has(n)) return d.get(n);
		let r = t(() => Y(l.value, e)), i = new Proxy({}, {
			get(n, i, a) {
				...
				if (i === "c" || i === "asComponent") return Q(() => r.value);
				if (i === "$raw") return r;
				if (i === Symbol.toPrimitive) return () => String(r.value ?? "");
				let o = e.concat(i), s = Y(l.value, o);
				if (s === void 0 || X(s) && !Z(s)) return p(o);
				if (ke(s)) return Ae(t(() => Y(l.value, o)));
				if (typeof s == "function") {
					let t = Y(l.value, e);
					return t != null && !Object.hasOwn(t, i) ? s.bind(t) : (...e) => Y(l.value, o)?.(...e);
				}
				let c = t(() => Y(l.value, o));
	...
	setup(t) {
		let { title: i, notificationsTitle: a, notificationsDescription: o, toggleNotifications: s, darkModeTitle: c, darkModeDescription: u, toggleDarkMode: f, languageLabel: m, languages: g } = je("preferences-section");
		return (t, _) => (l(), n("section", Me, [r("h2", Ne, p(h(i)), 1), r("div", Pe, [
			r("div", Fe, [r("div", null, [r("p", $, p(h(a)), 1), r("p", Ie, p(h(o)), 1)]), r("button", {
				type: "button",
				class: "h-6 w-11 rounded-full bg-primary transition-colors",
				"aria-label": h(s)
			}, [..._[0] ||= [r("span", { class: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" }, null, -1)]], 8, Le)]),
			r("div", Re, [r("div", null, [r("p", ze, p(h(c)), 1), r("p", Be, p(h(u)), 1)]), r("button", {
				type: "button",
				class: "h-6 w-11 rounded-full bg-muted transition-colors",
				"aria-label": h(f)
			}, [..._[1] ||= [r("span", { class: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" }, null, -1)]], 8, Ve)]),
			r("div", null, [r("label", He, p(h(m)), 1), r("select", Ue, [(l(!0), n(e, null, d(h(g), (e) => (l(), n("option", { key: e }, p(e), 1))), 128))])])
		])]));
	}
});
