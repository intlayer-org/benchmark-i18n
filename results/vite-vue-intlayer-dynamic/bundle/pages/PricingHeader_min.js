...
}), re = { class: "mb-12 text-center" }, ie = { class: "mb-3 text-3xl font-bold text-foreground" }, ae = { class: "text-muted-foreground" }, oe = a({
	__name: "PricingHeader",
	setup(t) {
		let { b: a, a: o } = Q(_);
		return (t, s) => (d(), n(e, null, [i(ne), r("div", re, [r("h1", ie, p(h(a)), 1), r("p", ae, p(h(o)), 1)])], 64));
	}
});
