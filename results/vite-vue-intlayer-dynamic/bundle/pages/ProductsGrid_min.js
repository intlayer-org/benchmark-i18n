...
var v = {
	...
	let r = a() ? s(K) : void 0, i = c(r?.locale) ? r.locale : d(r?.locale ?? w.defaultLocale), o = t(() => (n === void 0 ? void 0 : h(n)) ?? i.value), l = p({});
	_([() => h(e), () => o.value], ([e, t]) => {
		l.value = G(e, t);
	}, {
		immediate: !0,
	...
	return u([]);
}, ee = { class: "grid gap-6 md:grid-cols-2 lg:grid-cols-3" }, te = { class: "mb-2 text-lg font-semibold text-foreground" }, ne = { class: "mb-4 text-sm text-muted-foreground" }, re = { class: "flex items-center justify-between" }, ie = { class: "text-sm font-bold text-primary" }, ae = {
	type: "button",
	...
	setup(t) {
		let { a: i, b: a } = $(v);
		return (t, o) => (u(), n("div", ee, [(u(!0), n(e, null, f(g(a), (e) => (u(), n("div", {
			key: e.name,
			class: "flex flex-col justify-between rounded-lg border border-border bg-card p-6"
		}, [r("div", null, [r("h3", te, m(e.name), 1), r("p", ne, m(e.desc), 1)]), r("div", re, [r("span", ie, m(e.price), 1), r("button", ae, m(g(i)), 1)])]))), 128))]));
	}
});
