import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, defineComponent as i, h as a, inject as o, isRef as s, markRaw as c, onBeforeMount as l, onMounted as u, openBlock as d, ref as f, renderList as ee, shallowRef as te, toDisplayString as p, toValue as m, unref as h, watch as ne } from "vue";
var g = /* @__PURE__ */ new WeakMap(), _ = 0, v = (e) => {
	...
	let n = `p${_}`;
	return g.set(e, n), n;
}, y = 256, b = /* @__PURE__ */ new WeakMap(), x = (e) => typeof e == "object" && !!e, re = (e, t, n) => `${e}_${t}_${v(n)}`, ie = (e, t) => {
	if (!x(e)) return { hit: !1 };
	let n = b.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, ae = "translation", oe = "object", se = "array", C = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), w = (e, t) => {
...
}, D = "\x1B[0m", ce = "\x1B[34m", le = "\x1B[31m", ue = "\x1B[32m", de = "\x1B[38;5;3m", fe = (e) => e, pe = (e, t) => {
...
}), O = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? D : n : D}` : e, he = (e, t = de, n = D) => [e].flat().map((e) => O(e, t, n)).join(", ");
O("✗", le), O("✓", ue), O("⏲", ce);
var ge = {
	"products-grid": {
		key: "products-grid",
	...
	"toLocaleString"
]), k = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : ve.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : k(e ? `${e}.${String(n)}` : String(n)) }), A = /* @__PURE__ */ new Set(), j = (e, t, n) => {
	let r = _e()[e];
	return r ? Se(r, t, n) : (A.has(e) || (me({ log: E })(typeof window > "u" ? `Dictionary ${he(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), A.add(e)), k(e));
}, M = (e) => {
...
}, L = F, R = (e) => F, z = F, ye = F, B = F, V = F;
process.env.INTLAYER_OPTIMIZED_NESTING;
var H = (e) => F, U = F, be = (e, t = !0) => [
	...
	B,
	V
].filter((e) => e !== F), xe = (e, t, n = []) => w(e, {
	...t,
	plugins: n
}), W = /* @__PURE__ */ new WeakSet(), Se = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = re(r ?? T.defaultLocale, "", n), o = ie(e, a);
...
}, G = /* @__PURE__ */ new Map(), Ce = (e, t) => Object.create(new Proxy(e, {
	get: (e, t, n) => {
	...
	return Object.assign(o, {
		...
		...n
	}), Object.setPrototypeOf(o, we(e, Function.prototype)), c(o);
}, Te = {
...
}, Ee = F, De = F, Oe = F, q = /* @__PURE__ */ new Map(), ke = (e, t = !0) => {
	...
	return q.set(n, r), r;
}, J = (e, t) => j(e, t, ke(typeof t == "object" && t ? t.locale : t)), Ae = Symbol("intlayer"), Y = (e, t) => t.reduce((e, t) => e?.[t], e), X = (e) => typeof e == "object" && !!e, Z = (e) => typeof e == "function" || X(e) && ("render" in e || "setup" in e), je = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, Q = (e) => c(i({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = o(Ae), i = s(r?.locale) ? r.locale : f(r?.locale ?? T.defaultLocale), a = t(() => ({
		selector: void 0,
		locale: n === void 0 ? void 0 : m(n)
	})), c = t(() => a.value.locale ?? i.value), l = te({});
	ne([
		() => m(e),
		() => c.value,
		() => a.value.selector
	...
	let u = /* @__PURE__ */ new Map(), d = (e) => {
		...
		let r = t(() => Y(l.value, e)), i = new Proxy({}, {
			get(n, i, a) {
				...
				if (je(s)) return Me(t(() => Y(l.value, o)));
...
var Fe = { class: "mb-6 text-2xl font-bold text-foreground" }, Ie = { class: "overflow-x-auto rounded-lg border border-border" }, Le = { class: "w-full text-sm" }, Re = { class: "bg-muted" }, ze = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, Be = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, $ = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, Ve = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, He = { class: "px-4 py-3 font-medium text-foreground" }, Ue = { class: "px-4 py-3 text-muted-foreground" }, We = { class: "px-4 py-3 text-muted-foreground" }, Ge = { class: "px-4 py-3 text-muted-foreground" }, Ke = i({
	__name: "ResultsTable",
	setup(t) {
		Pe("ResultsTable");
		let { title: i, columns: a, yes1: o, manual: s, yes: c } = Ne("results-table"), l = [
			{
				lib: "react-i18next",
				size: "42.3 kB",
				time: "0.12ms",
		...
		return (t, o) => (d(), n("section", null, [r("h2", Fe, p(h(i)), 1), r("div", Ie, [r("table", Le, [r("thead", Re, [r("tr", null, [
			r("th", ze, p(h(a).library), 1),
			r("th", Be, p(h(a).bundleSize), 1),
			r("th", $, p(h(a).lookupTime), 1),
			r("th", Ve, p(h(a).lazyLoading), 1)
		])]), r("tbody", null, [(d(), n(e, null, ee(l, (e) => r("tr", {
			key: e.lib,
