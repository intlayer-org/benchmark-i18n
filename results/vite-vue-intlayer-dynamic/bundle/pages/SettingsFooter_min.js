...
var p = /* @__PURE__ */ new WeakMap(), m = 0, ne = (e) => {
	...
	let n = `p${m}`;
	return p.set(e, n), n;
}, h = 256, g = /* @__PURE__ */ new WeakMap(), _ = (e) => typeof e == "object" && !!e, re = (e, t, n) => `${e}_${t}_${ne(n)}`, ie = (e, t) => {
	if (!_(e)) return { hit: !1 };
	let n = g.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, ae = "translation", oe = "object", se = "array", y = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), b = (e, t) => {
...
}, S = "\x1B[0m", C = "\x1B[34m", w = "\x1B[31m", T = "\x1B[32m", E = "\x1B[38;5;3m", D = (e) => e, O = (e, t) => {
...
}), k = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? S : n : S}` : e, ue = (e, t = E, n = S) => [e].flat().map((e) => k(e, t, n)).join(", ");
k("✗", w), k("✓", T), k("⏲", C);
var de = {
	"products-grid": {
		key: "products-grid",
	...
	let r = fe()[e];
	return r ? ve(r, t, n) : (j.has(e) || (le({ log: ce })(typeof window > "u" ? `Dictionary ${ue(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), j.add(e)), A(e));
}, M = (e) => {
...
var H = (e) => F, U = F, ge = (e, t = !0) => [
	I(e ?? x.defaultLocale, t ? x.defaultLocale : void 0),
	L,
	R(e ?? x.defaultLocale),
	z,
	he,
	...
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = re(r ?? x.defaultLocale, "", n), o = ie(e, a);
	...
	let r = a(Y), i = o(r?.locale) ? r.locale : l(r?.locale ?? x.defaultLocale), s = e(() => ({
		selector: void 0,
	...
	return p([]);
}, ke = { class: "flex justify-end gap-3" }, Ae = {
	type: "button",
	...
	setup(e) {
		let { cancel: r, saveChanges: i } = Oe("settings-footer");
		return (e, a) => (c(), t("div", ke, [n("button", Ae, u(f(r)), 1), n("button", je, u(f(i)), 1)]));
	}
});
