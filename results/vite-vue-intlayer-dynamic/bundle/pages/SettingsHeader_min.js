import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, createVNode as i, defineComponent as a, h as o, inject as s, isRef as c, markRaw as l, openBlock as u, ref as d, shallowRef as f, toDisplayString as p, toValue as m, unref as h, watch as g } from "vue";
...
}, re = "translation", ie = "object", C = "array", w = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), T = (e, t) => {
...
}, D = "\x1B[0m", oe = "\x1B[34m", se = "\x1B[31m", ce = "\x1B[32m", le = "\x1B[38;5;3m", ue = (e) => e, de = (e, t) => {
	let n = t?.config ?? {}, r = n.mode ?? "default";
	if (r === "disabled" || t?.isVerbose && r !== "verbose") return;
	let i = ue(n.prefix), a = i ? [i, ...[e].flat()] : [e].flat(), o = t?.level ?? "info";
...
}), O = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? D : n : D}` : e, pe = (e, t = le, n = D) => [e].flat().map((e) => O(e, t, n)).join(", ");
O("✗", se), O("✓", ce), O("⏲", oe);
var me = {
	"products-grid": {
		key: "products-grid",
...
}, he = () => me, ge = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), k = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : ge.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : k(e ? `${e}.${String(n)}` : String(n)) }), A = /* @__PURE__ */ new Set(), _e = (e, t, n) => {
	let r = he()[e];
	return r ? xe(r, t, n) : (A.has(e) || (fe({ log: ae })(typeof window > "u" ? `Dictionary ${pe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), A.add(e)), k(e));
}, j = (e) => {
...
}, I = P, L = (e) => P, R = P, ve = P, z = P, B = P;
process.env.INTLAYER_OPTIMIZED_NESTING;
var V = (e) => P, H = P, ye = (e, t = !0) => [
	...
	z,
	B
].filter((e) => e !== P), be = (e, t, n = []) => T(e, {
	...t,
	plugins: n
}), U = /* @__PURE__ */ new WeakSet(), xe = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = te(r ?? E.defaultLocale, "", n), o = ne(e, a);
...
}, W = /* @__PURE__ */ new Map(), Se = (e, t) => Object.create(new Proxy(e, {
	get: (e, t, n) => {
	...
	transform: (e, t) => {
		let { children: n, dictionaryKey: r, keyPath: i } = t, a = (e) => G({
			value: e,
			children: e
		}), o = a(n);
...
}, Te = P, Ee = P, De = P, K = /* @__PURE__ */ new Map(), Oe = (e, t = !0) => {
	...
	return K.set(n, r), r;
}, q = (e, t) => _e(e, t, Oe(typeof t == "object" && t ? t.locale : t)), ke = Symbol("intlayer"), J = (e, t) => t.reduce((e, t) => e?.[t], e), Y = (e) => typeof e == "object" && !!e, X = (e) => typeof e == "function" || Y(e) && ("render" in e || "setup" in e), Z = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, Q = (e) => l(a({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = s(ke), i = c(r?.locale) ? r.locale : d(r?.locale ?? E.defaultLocale), a = t(() => ({
		selector: void 0,
		locale: n === void 0 ? void 0 : m(n)
	})), o = t(() => a.value.locale ?? i.value), l = f({});
	g([
		() => m(e),
		() => o.value,
		() => a.value.selector
	...
	let u = /* @__PURE__ */ new Map(), p = (e) => {
		let n = e.join(".");
		if (u.has(n)) return u.get(n);
		let r = t(() => J(l.value, e)), i = new Proxy({}, {
			get(n, i, a) {
				...
				let o = e.concat(i), s = J(l.value, o);
				if (s === void 0 || Y(s) && !X(s)) return p(o);
				if (Z(s)) return Ae(t(() => J(l.value, o)));
				if (typeof s == "function") {
					let t = J(l.value, e);
					return t != null && !Object.hasOwn(t, i) ? s.bind(t) : (...e) => J(l.value, o)?.(...e);
				}
				let c = t(() => J(l.value, o));
	...
	return p([]);
}, je = { class: "mb-8 rounded-lg border border-yellow-500/20 bg-yellow-500/10 p-4 text-sm text-yellow-600 dark:text-yellow-400" }, Me = a({
	__name: "MockBanner",
	setup(e) {
		let { message: t } = $("mock-banner");
		return (e, r) => (u(), n("div", je, p(h(t)), 1));
	}
}), Ne = { class: "mb-2 text-3xl font-bold text-foreground" }, Pe = { class: "mb-8 text-muted-foreground" }, Fe = a({
	__name: "SettingsHeader",
	setup(t) {
		let a = $("settings-header");
		return (t, o) => (u(), n(e, null, [
			i(Me),
			r("h1", Ne, p(h(a).settings), 1),
			r("p", Pe, p(h(a).manageYourAccountPreferencesAnd), 1)
		], 64));
	}
});
