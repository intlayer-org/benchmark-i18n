...
var ae = Q(ne, [["render", ie], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-dynamic/vue-intlayer-app/src/components/MockBanner.vue"]]), oe = a({
...
}), $ = { class: "mb-2 text-3xl font-bold text-foreground" }, se = { class: "mb-8 text-muted-foreground" };
function ce(t, a, o, s, c, l) {
	return d(), n(e, null, [
		i(s.MockBanner),
		r("h1", $, m(s.content.settings), 1),
		r("p", se, m(s.content.manageYourAccountPreferencesAnd), 1)
	], 64);
}
var le = Q(oe, [["render", ce], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-dynamic/vue-intlayer-app/src/components/pages/settings/SettingsHeader.vue"]]);
