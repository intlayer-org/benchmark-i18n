...
var ae = { class: "mb-16 mx-auto max-w-3xl space-y-6" }, oe = { class: "text-2xl font-bold text-foreground" }, se = { class: "rounded-lg border border-border bg-card p-6" }, ce = { class: "mb-2 text-lg font-semibold text-foreground" }, le = { class: "text-sm text-muted-foreground" }, ue = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, de = { class: "rounded-lg border border-border bg-card p-6" }, fe = { class: "mb-2 text-lg font-semibold text-foreground" }, pe = { class: "text-sm text-muted-foreground" }, $ = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, me = { class: "text-foreground" }, he = { class: "rounded-lg border border-border bg-card p-6" }, ge = { class: "mb-2 text-lg font-semibold text-foreground" }, _e = { class: "text-sm text-muted-foreground" }, ve = a({
	__name: "UnderstandingImpact",
	setup(t) {
		ie("UnderstandingImpact");
		let { d: a, c: o, b: s, a: c } = re(b);
		return (t, l) => (f(), n("section", ae, [
			r("h2", oe, g(v(a)), 1),
			r("div", se, [
				r("h3", ce, g(v(o).title), 1),
				r("p", le, g(v(o).description), 1),
				r("ul", ue, [(f(!0), n(e, null, m(v(o).points, (e, t) => (f(), n("li", { key: t }, g(e), 1))), 128))])
			]),
			r("div", de, [
				r("h3", fe, g(v(s).title), 1),
				r("p", pe, g(v(s).description), 1),
				r("ul", $, [(f(!0), n(e, null, m(v(s).points, (e, t) => (f(), n("li", { key: t }, [r("strong", me, g(e.label), 1), i(" " + g(e.text), 1)]))), 128))])
			]),
			r("div", he, [r("h3", ge, g(v(c).title), 1), r("p", _e, g(v(c).description), 1)])
		]));
	}
});
