import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, defineComponent as i, h as a, inject as o, isRef as s, markRaw as c, onBeforeMount as l, onMounted as u, openBlock as d, ref as f, renderList as ee, shallowRef as te, toDisplayString as p, toValue as m, unref as h, watch as g } from "vue";
var _ = /* @__PURE__ */ new WeakMap(), v = 0, ne = (e) => {
	if (!e) return "base";
	let t = _.get(e);
	if (t) return t;
	v += 1;
...
}, oe = "translation", se = "object", ce = "array", S = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), C = (e, t) => {
...
}, E = "\x1B[0m", D = "\x1B[34m", le = "\x1B[31m", ue = "\x1B[32m", de = "\x1B[38;5;3m", fe = (e) => e, pe = (e, t) => {
...
}), O = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? E : n : E}` : e, he = (e, t = de, n = E) => [e].flat().map((e) => O(e, t, n)).join(", ");
O("✗", le), O("✓", ue), O("⏲", D);
var ge = {
	"products-grid": {
		key: "products-grid",
	...
	let r = _e()[e];
	return r ? Se(r, t, n) : (A.has(e) || (me({ log: T })(typeof window > "u" ? `Dictionary ${he(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), A.add(e)), k(e));
}, M = (e) => {
...
var H = (e) => F, U = F, be = (e, t = !0) => [
	...
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = ie(r ?? w.defaultLocale, "", n), o = ae(e, a);
	...
	let r = o(Ae), i = s(r?.locale) ? r.locale : f(r?.locale ?? w.defaultLocale), a = t(() => ({
		selector: void 0,
...
var Fe = { class: "mt-12 mx-auto max-w-3xl" }, $ = { class: "mb-4 text-2xl font-bold text-foreground" }, Ie = { class: "space-y-4" }, Le = { class: "block text-sm font-bold text-primary" }, Re = { class: "block mt-1 text-sm text-muted-foreground" }, ze = i({
	__name: "WhatWeMeasure",
	setup(t) {
		Pe("WhatWeMeasure");
		let { title: i, metrics: a } = Ne("what-we-measure");
		return (t, o) => (d(), n("section", Fe, [r("h2", $, p(h(i)), 1), r("ul", Ie, [(d(!0), n(e, null, ee(h(a), (e) => (d(), n("li", {
			key: e.metric,
			class: "rounded-md border border-border p-4"
		}, [r("span", Le, p(e.metric), 1), r("span", Re, p(e.desc), 1)]))), 128))])]));
	}
});
