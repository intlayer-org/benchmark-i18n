...
var H = (e) => F, U = F, ve = (e, t = !0) => [
	...
	__name: "ProductsGrid",
	setup(t) {
		let { learnMore: i, products: a } = Ae("products-grid");
		return (t, o) => (l(), n("div", je, [(l(!0), n(e, null, d(h(a), (e) => (l(), n("div", {
			key: e.name,
			class: "flex flex-col justify-between rounded-lg border border-border bg-card p-6"
		}, [r("div", null, [r("h3", Me, p(e.name), 1), r("p", Ne, p(e.desc), 1)]), r("div", Pe, [r("span", Fe, p(e.price), 1), r("button", Ie, p(h(i)), 1)])]))), 128))]));
	}
});
