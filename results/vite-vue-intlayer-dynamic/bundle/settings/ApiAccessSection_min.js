...
var g = {
	...
	return f([]);
}, Q = { class: "rounded-lg border border-border bg-card p-6" }, $ = { class: "mb-4 text-lg font-semibold text-foreground" }, ee = {
	for: "apiKey",
	class: "mb-1 block text-sm font-medium text-foreground"
}, te = { class: "flex gap-2" }, ne = {
	type: "button",
	class: "rounded-md border border-border px-4 py-2 text-sm font-medium text-foreground hover:bg-accent transition-colors"
}, re = { class: "mt-1 text-xs text-muted-foreground" }, ie = r({
	__name: "ApiAccessSection",
	setup(e) {
		let { d: r, a: i, b: a, c: o } = Z(g);
		return (e, s) => (l(), t("section", Q, [n("h2", $, f(m(r)), 1), n("div", null, [
			n("label", ee, f(m(i)), 1),
			n("div", te, [s[0] ||= n("input", {
				id: "apiKey",
				readonly: "",
