...
var h = {
	...
	return n;
}, $ = { class: "rounded-lg border border-border bg-card p-6" }, ee = { class: "mb-4 text-lg font-semibold text-foreground" }, te = { class: "space-y-4" }, ne = {
	for: "displayName",
...
function ie(e, r, i, a, o, s) {
	return l(), t("section", $, [n("h2", ee, f(a.title), 1), n("div", te, [n("div", null, [n("label", ne, f(a.displayNameLabel), 1), r[0] ||= n("input", {
		id: "displayName",
	...
	}, null, -1)]), n("div", null, [n("label", re, f(a.emailLabel), 1), r[1] ||= n("input", {
		id: "email",
		value: "john@example.com",
		class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring"
	}, null, -1)])])]);
}
var ae = Q(Z, [["render", ie], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-dynamic/vue-intlayer-app/src/components/pages/settings/ProfileSection.vue"]]);
