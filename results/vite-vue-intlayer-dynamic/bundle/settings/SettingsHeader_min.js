...
}), re = { class: "mb-2 text-3xl font-bold text-foreground" }, ie = { class: "mb-8 text-muted-foreground" }, ae = a({
	__name: "SettingsHeader",
	setup(t) {
		let a = Q(_);
		return (t, o) => (d(), n(e, null, [
			i(ne),
			r("h1", re, p(h(a).settings), 1),
			r("p", ie, p(h(a).manageYourAccountPreferencesAnd), 1)
		], 64));
	}
});
