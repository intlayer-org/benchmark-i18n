...
import { computed, defineComponent, getCurrentInstance, h, inject, isRef, markRaw, ref, shallowRef, toValue, watch } from "vue";
...
var EmptyComponent_vue_vue_type_script_setup_true_lang_default = defineComponent({
	...
	setup(__props, { expose: __expose }) {
		__expose();
		const __returned__ = { content: S(_609x7od68v) };
