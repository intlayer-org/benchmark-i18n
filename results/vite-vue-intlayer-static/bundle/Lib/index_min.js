...
}, ae = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", k = /\{\{\s*(.*?)\s*\}\}/g, A = (e, t = {}) => {
...
W(1), W(2);
var G = (e) => (t, n = {}) => {
	let r = performance.now(), i = (t, n = {}) => G(e)(t, n);
	if (Array.isArray(t)) {
	...
	transform: (e, t, n) => {
		let { plugins: r, ...i } = t, a = n(ce(e) ?? {}, {
			...
			value: e,
			children: () => {
				let { renderMarkdown: t, components: r } = ue(), a = t(e, void 0, {
					...r ?? {},
					...n ?? {}
				});
