import { Fragment as e, computed as t, createBlock as n, createElementBlock as r, createElementVNode as i, createTextVNode as a, defineComponent as o, getCurrentInstance as s, h as c, inject as l, isRef as u, markRaw as d, openBlock as f, ref as p, renderList as ee, resolveComponent as te, shallowRef as m, toDisplayString as h, toValue as g, unref as _, watch as v, withCtx as ne } from "vue";
...
var ie = {
	...
	defaultLocale: "en"
}, b = Symbol("intlayer"), x = /* @__PURE__ */ new WeakMap(), S = 0, ae = (e) => {
	if (!e) return "base";
	let t = x.get(e);
	if (t) return t;
	S += 1;
...
}, B = R, ve = (e) => R, V = R, ye = R, H = R, U = R, W = (e) => R, G = R, be = (e, t = !0) => [
	...
	let { locale: r, selector: i } = P(t), a = T(r ?? y.defaultLocale, F(i), n), o = E(e, a);
	if (o.hit) return o.content;
	let s = n ?? be(r), c = ge(e, i), l = (e) => {
		let t = {
			dictionaryKey: e.key,
...
}, we = R, Te = R, Ee = R, q = /* @__PURE__ */ new Map(), De = (e, t = !0) => {
	let n = `${e ?? y.defaultLocale}_${t}`;
	if (q.has(n)) return q.get(n);
	let r = [
		z(e ?? y.defaultLocale, t ? y.defaultLocale : void 0),
		B,
		ve(e ?? y.defaultLocale),
		V,
		W(e ?? y.defaultLocale),
		G,
		H,
	...
	return q.set(n, r), r;
}, J = (e, t) => Se(e, t, De(typeof t == "object" && t ? t.locale : t)), Y = (e, t) => t.reduce((e, t) => e?.[t], e), X = (e) => typeof e == "object" && !!e, Z = (e) => typeof e == "function" || X(e) && ("render" in e || "setup" in e), Oe = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, Q = (e) => d(o({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = s() ? l(b) : void 0, i = u(r?.locale) ? r.locale : p(r?.locale ?? y.defaultLocale), a = t(() => ({
		selector: void 0,
	...
	let d = (e) => new Proxy({}, {
		get(n, r, i) {
			...
			if (Oe(s)) return ke(t(() => Y(c.value, o)));
	...
	return d([]);
}, je = { class: "mt-20 border-t border-border bg-card" }, Me = { class: "container py-8" }, Ne = { class: "grid gap-8 md:grid-cols-3" }, Pe = { class: "mb-2 text-sm font-semibold text-foreground" }, $ = { class: "text-sm text-muted-foreground" }, Fe = { class: "mb-2 text-sm font-semibold text-foreground" }, Ie = { class: "space-y-1" }, Le = ["href"], Re = { class: "mb-2 text-sm font-semibold text-foreground" }, ze = { class: "text-sm text-muted-foreground" }, Be = { class: "mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground" }, Ve = o({
	__name: "Footer",
	setup(o) {
		let s = re(), c = t(() => s.params.locale || "en"), { e: l, i: u, b: d, g: p, h: m, d: g, f: v, a: y, c: b } = Ae(ie), x = t(() => [
			{
				label: p,
		...
		return (t, o) => {
			let s = te("router-link");
			return f(), r("footer", je, [i("div", Me, [i("div", Ne, [
				i("div", null, [i("h3", Pe, h(_(y)), 1), i("p", $, h(_(l)), 1)]),
				i("div", null, [i("h3", Fe, h(_(u)), 1), i("ul", Ie, [(f(!0), r(e, null, ee(x.value, (e) => (f(), r("li", { key: e.label }, [e.isInternal ? (f(), n(s, {
					key: 0,
					to: e.to,
					class: "text-sm text-muted-foreground hover:text-foreground transition-colors"
				}, {
					default: ne(() => [a(h(e.label), 1)]),
					_: 2
				}, 1032, ["to"])) : (f(), r("a", {
					key: 1,
					href: e.href,
				...
				i("div", null, [i("h3", Re, h(_(d)), 1), i("p", ze, h(_(b)), 1)])
			]), i("div", Be, h(_(v)), 1)])]);
		};
	}
});
