...
var x = {
...
}, C = "translation", te = "object", w = "array", T = (e, t) => {
...
}, A = process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false", j = {
	id: "fallback-plugin",
	canHandle: () => !1,
	transform: (e) => e
}, M = (e, t) => A ? j : {
...
}, N = j, P = j, F = j, I = j, L = (e) => j, R = j, z = (e, t = !0) => [
	M(e ?? E.defaultLocale, t ? E.defaultLocale : void 0),
	N,
	P,
	F,
	L(e ?? E.defaultLocale),
...
}, U = j, W = j, G = j, K = /* @__PURE__ */ new Map(), q = (e, t = !0) => {
	...
	return K.set(n, r), r;
}, J = (e, t) => V(e, t, q(t)), ne = Symbol("intlayer"), Y = (e, t) => t.reduce((e, t) => e?.[t], e), X = (e) => typeof e == "object" && !!e, Z = (e) => typeof e == "function" || X(e) && ("render" in e || "setup" in e), re = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, Q = (e) => d(o({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = s() ? l(ne) : void 0, i = u(r?.locale) ? r.locale : p(r?.locale ?? E.defaultLocale), a = t(() => (n === void 0 ? void 0 : _(n)) ?? i.value), o = h({});
	v([() => _(e), () => a.value], ([e, t]) => {
		o.value = J(e, t);
	}, {
		immediate: !0,
	...
	setup(e, { expose: n }) {
		n();
		let r = b(), i = t(() => r.params.locale || "en"), { e: a, i: o, b: s, g: c, h: l, d: u, f: d, a: f, c: p } = ae(x), m = {
			route: r,
			currentLocale: i,
			description: a,
			resources: o,
	...
	return n;
}, ce = { class: "mt-20 border-t border-border bg-card" }, le = { class: "container py-8" }, ue = { class: "grid gap-8 md:grid-cols-3" }, de = { class: "mb-2 text-sm font-semibold text-foreground" }, $ = { class: "text-sm text-muted-foreground" }, fe = { class: "mb-2 text-sm font-semibold text-foreground" }, pe = { class: "space-y-1" }, me = ["href"], he = { class: "mb-2 text-sm font-semibold text-foreground" }, ge = { class: "text-sm text-muted-foreground" }, _e = { class: "mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground" };
function ve(t, o, s, c, l, u) {
	let d = ee("router-link");
	return f(), r("footer", ce, [i("div", le, [i("div", ue, [
		i("div", null, [i("h3", de, g(c.appName), 1), i("p", $, g(c.description), 1)]),
		...
		i("div", null, [i("h3", he, g(c.contactLabel), 1), i("p", ge, g(c.contactEmail), 1)])
	]), i("div", _e, g(c.footerText), 1)])]);
}
var ye = se(oe, [["render", ve], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/Footer.vue"]]);
