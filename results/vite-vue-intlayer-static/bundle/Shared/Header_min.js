...
var ie = {
...
}, le = process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false", N = {
	id: "fallback-plugin",
	canHandle: () => !1,
	transform: (e) => e
}, P = (e, t) => le ? N : {
...
}, F = N, I = N, ue = N, L = N, R = (e) => N, z = N, de = (e, t = !0) => [
...
}, fe = N, pe = N, me = N, U = /* @__PURE__ */ new Map(), he = (e, t = !0) => {
	...
	return U.set(n, r), r;
}, ge = (e, t) => V(e, t, he(t)), W = Symbol("intlayer"), G = (e, t) => t.reduce((e, t) => e?.[t], e), K = (e) => typeof e == "object" && !!e, q = (e) => typeof e == "function" || K(e) && ("render" in e || "setup" in e), _e = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, J = (e) => p(c({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let s = (e) => new Proxy({}, {
		get(n, r, i) {
			...
			if (_e(l)) return ve(t(() => G(o.value, c)));
			let u = t(() => G(o.value, c));
...
var Se = (e, t) => xe(e, {
	...Z,
	isCookieEnabled: t
}), Ce = ({ isCookieEnabled: e, onLocaleChange: n } = {}) => {
...
var Te = A.internationalization.locales;
...
var Ee = (e) => {
	...
	setup(e, { expose: n }) {
		n();
		let r = T(), i = ne(), { setLocale: a } = Ce(), o = t(() => r.params.locale || "en"), s = (e) => {
			a(e);
	...
	return n;
}, Oe = { class: "flex items-center gap-2" }, ke = ["value"], Ae = ["value"];
function je(t, n, r, o, s, c) {
	return v(), i("div", Oe, [a("select", {
		...
		key: e,
		value: e
	}, x(o.getLocaleName(e)), 9, Ae))), 128))], 40, ke)]);
}
var Me = Q(De, [["render", je], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/LocaleSwitcher.vue"]]), Ne = {
	key: "theme-toggle",
	content: {
		nodeType: "translation",
		translation: {
	...
	setup(e, { expose: t }) {
		t();
		let { d: n, e: r, f: i, a, c: o, b: s } = Y(Ne), c = y("auto");
		function l() {
...
function Fe(e, t, n, r, a, o) {
	...
	}, x(r.mode === "auto" ? r.auto : r.mode === "dark" ? r.dark : r.light), 9, $);
}
var Ie = Q(Pe, [["render", Fe], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/ThemeToggle.vue"]]), Le = c({
	__name: "Header",
	setup(e, { expose: n }) {
		n(), we("Header");
...
}), Re = { class: "sticky top-0 z-50 border-b border-border bg-card/80 backdrop-blur-lg" }, ze = { class: "container flex h-16 items-center justify-between" }, Be = { class: "flex items-center gap-8" }, Ve = { class: "hidden items-center gap-6 text-sm font-medium md:flex" }, He = { class: "relative" }, Ue = { class: "bg-card border border-border rounded-md shadow-lg overflow-hidden py-1" }, We = { class: "flex items-center gap-4" }, Ge = {
	href: "https://github.com/intlayer-org/benchmark-i18n",
	target: "_blank",
	rel: "noreferrer",
	class: "text-muted-foreground transition hover:text-foreground"
}, Ke = { class: "sr-only" };
function qe(t, c, l, u, d, f) {
	let p = ee("router-link");
	return v(), i("header", Re, [a("nav", ze, [a("div", Be, [s(p, {
		to: `/${u.currentLocale}`,
		...
		}, [a("div", Ue, [(v(!0), i(e, null, b(u.mockPagesList, (e) => (v(), n(p, {
			key: e.to,
			to: e.to,
		...
		a("a", Ge, [a("span", Ke, x(u.goToGithub), 1), c[6] ||= a("svg", {
			viewBox: "0 0 16 16",
			"aria-hidden": "true",
			width: "20",
			height: "20"
...
var Je = Q(Le, [["render", qe], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/Header.vue"]]);
