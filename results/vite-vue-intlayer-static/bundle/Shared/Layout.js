...
}, r$2 = Symbol("intlayerHTML"), c$2 = () => inject(r$2), i$2 = (e, { components: t = {} } = {}) => {
...
defineComponent({
	...
	setup(e) {
		let t = a$5({ components: e.components });
		return () => t(e.content);
	}
});
...
var r = Symbol("intlayerMarkdown"), c$1 = () => {
	...
	transform: (n, { children: r, ...i }) => {
		let s = (n) => n$1({
			...i,
			value: n,
			children: !C && editor$1.enabled ? () => h(i$4, {
	...
	canHandle: (e) => typeof e == "string",
	transform: (n, i, o) => {
		let { plugins: s, ...c } = i, l = o(getMarkdownMetadata(n) ?? {}, {
			plugins: [{
			...
			value: n,
			children: () => {
				let { renderMarkdown: e, components: i } = c$1(), s = e(n, void 0, {
					...i ?? {},
					...o ?? {}
				});
				return !C && editor$1.enabled ? h(i$4, {
					dictionaryKey: c.dictionaryKey,
					keyPath: c.keyPath
				}, { default: () => s }) : s;
			},
...
var a = ({ isCookieEnabled: a, onLocaleChange: o } = {}) => {
	let { defaultLocale: s$4, locales: c } = internationalization ?? {}, l = inject(f);
	return {
		locale: computed(() => l?.locale?.value ?? s$4),
		defaultLocale: s$4,
		availableLocales: c,
		setLocale: (e) => {
