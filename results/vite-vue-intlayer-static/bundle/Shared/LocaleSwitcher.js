...
var a = ({ isCookieEnabled: a, onLocaleChange: o } = {}) => {
	let { defaultLocale: s$1, locales: c } = internationalization ?? {}, l = inject(f);
	return {
...
import { n as editor, r as internationalization, t as configuration } from "./configuration-DivPfHYI.js";
