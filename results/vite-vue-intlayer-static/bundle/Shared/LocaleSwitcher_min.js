...
import { n as e, r as t, t as n } from "./configuration-DcjpUdjr.js";
var r = "translation", i = "object", a = "array", o = (e, t) => {
...
}, ee = process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false", u = {
	id: "fallback-plugin",
	canHandle: () => !1,
	transform: (e) => e
}, d = (e, t) => ee ? u : {
...
}, f = u, p = u, m = u, te = u, h = (e) => u, g = u, ne = (e, n = !0) => [
	d(e ?? t.defaultLocale, n ? t.defaultLocale : void 0),
	f,
	p,
	m,
	h(e ?? t.defaultLocale),
	...
	...t,
	plugins: n
}), v = (e, t) => e.every((e, n) => t[n] && t[n].key === e.key && t[n].type === e.type), y = (e, t) => {
	try {
...
}, x = "__intlayer_editor_manager__", S = "__intlayer_editor_manager_events__", C = () => {
	if (typeof window > "u") return new EventTarget();
	let e = window;
	return e[S] || (e[S] = new EventTarget()), e[S];
}, w = () => typeof window > "u" ? null : window[x] ?? null, T = (e) => {
	if (typeof window < "u") {
		let t = window;
		t[x] = e;
	}
	C().dispatchEvent(new CustomEvent("change", { detail: e }));
}, E = (e) => {
	let t = C(), n = (t) => {
		e(t.detail);
	};
...
}, D = typeof HTMLElement < "u" ? HTMLElement : class {}, O = class extends D {
	_keyPathJson = "[]";
	_dictionaryKey = "";
	_editorEnabled = !1;
	_isInIframe = !1;
	...
	_getFilteredKeyPath() {
		return this._getRawKeyPath().filter((e) => e.type !== r);
	}
	_updateEditedValue(e) {
		...
		let n = this._getRawKeyPath(), i = n[n.length - 1]?.type;
	...
	_updateIsSelected(e) {
		...
		let t = this._getFilteredKeyPath();
		this._isSelected = e.dictionaryKey === this._dictionaryKey && (e.keyPath?.length ?? 0) > 0 && v(e.keyPath ?? [], t), this._updateSelectorAttr();
	}
	_updateSelectorAttr() {
	...
	_subscribeToManager() {
		let e = w();
		e && this._setupManagerSubscriptions(e), this._unsubManager = E((e) => {
	...
	_handleHover(e) {
		e.stopPropagation(), w()?.messenger.send("INTLAYER_HOVERED_CONTENT_CHANGED/post", {
			dictionaryKey: this._dictionaryKey,
			keyPath: this._getFilteredKeyPath()
		});
	}
	_handleUnhover(e) {
		e.stopPropagation(), w()?.messenger.send("INTLAYER_HOVERED_CONTENT_CHANGED/post", null);
	}
	_render() {
	...
	typeof customElements > "u" || customElements.get("intlayer-content-selector-wrapper") || customElements.define("intlayer-content-selector-wrapper", O);
}, A = typeof HTMLElement < "u" ? HTMLElement : class {}, j = class extends A {
	_dictionaryKey = "";
	_keyPathJson = "[]";
	_locale = "";
	_editedText = null;
	...
	_resolveEditedText(e) {
		...
		if (typeof n == "object") {
			let e = this._locale || void 0, r = _(n, {
				locale: e,
				dictionaryKey: this._dictionaryKey,
				keyPath: t
			}, ne(e));
	...
	typeof customElements > "u" || customElements.get("intlayer-edited-content") || customElements.define("intlayer-edited-content", j);
}, N = () => Math.random().toString(36).slice(2), P = class {
	senderId;
	_config;
	...
	constructor(e) {
		this._config = e, this.senderId = N();
	}
	start() {
	...
	_handleMessage(e) {
		...
		if (!(!o || o.length === 0 || o.includes("*") || o.filter((e) => !!e && e !== "").some((t) => y(t, e.origin)))) return;
	...
	startMerger() {
		this._unsubscribeMerge = this._messenger.subscribe("INTLAYER_IFRAME_CLICKED", b);
	}
	stopInterceptor() {
	...
	for (let e of t) n && i?.nodeType === "translation" && (i = i?.[r]?.[n]), (e.type === "object" || e.type === "array") && (i = i?.[e.key]), (e.type === "translation" || e.type === "condition" || e.type === "enumeration") && (i = i?.[e.type]?.[e.key]), (e.type === "markdown" || e.type === "html" || e.type === "insertion" || e.type === "file") && (i = i?.[e.type]);
	return i;
}, B = (e, t, n) => {
	...
	constructor(e) {
		this._mode = e.mode, this._configuration = e.configuration, this.messenger = new P(e.messenger), this.editorEnabled = new F("INTLAYER_EDITOR_ENABLED", this.messenger, {
			emit: !1,
			receive: !0,
			initialValue: !1
		}), this.focusedContent = new F("INTLAYER_FOCUSED_CONTENT_CHANGED", this.messenger, {
			emit: !0,
			receive: !0,
			initialValue: null
		}), this.localeDictionaries = new F("INTLAYER_LOCALE_DICTIONARIES_CHANGED", this.messenger), this.editedContent = new F("INTLAYER_EDITED_CONTENT_CHANGED", this.messenger), this.configuration = new F("INTLAYER_CONFIGURATION", this.messenger, {
			emit: !0,
			receive: !1,
			...e.configuration ? { initialValue: e.configuration } : {}
		}), this.currentLocale = new F("INTLAYER_CURRENT_LOCALE", this.messenger, {
			emit: e.mode === "client",
			receive: e.mode === "editor"
		}), this._urlManager = new L(this.messenger), this._iframeInterceptor = new I(this.messenger);
	}
	start() {
	...
	setFocusedContentKeyPath(e) {
		let t = e.filter((e) => e.type !== r), n = this.focusedContent.value;
	...
	addContent(e, t, n = [], r = !0) {
		...
		if (!r) {
			...
			for (; z(o, s) !== void 0;) e++, i = e === 0 ? r.key : `${r.key} (${e})`, s = [...t, {
				...r,
				key: i
			}];
		}
	...
	renameContent(e, t, n = []) {
		let r = this.editedContent.value ?? {}, i = (this.localeDictionaries.value ?? {})[e]?.content, a = B(structuredClone(r[e]?.content ?? i), t, n);
		this.editedContent.set({
			...r,
			[e]: {
				...r[e],
	...
	removeContent(e, t) {
		let n = this.editedContent.value ?? {}, r = (this.localeDictionaries.value ?? {})[e]?.content, i = R(structuredClone(n[e]?.content ?? r), t, z(r, t));
		this.editedContent.set({
			...n,
			[e]: {
				...n[e],
	...
	getContentValue(e, t) {
		let n = this.editedContent.value;
		if (!n) return;
		let i = t.filter((e) => e.type !== r), a = this.localeDictionaries.value;
		if (e.includes(":local:") || e.includes(":remote:")) return a && !(e in a) ? void 0 : z(n[e]?.content ?? {}, i, this.currentLocale.value);
		let o = Object.keys(n).filter((t) => t.startsWith(`${e}:`) && (!a || t in a));
		for (let e of o) {
			let t = z(n[e]?.content ?? {}, i, this.currentLocale.value);
			if (t) return t;
		}
	}
...
}, H = typeof HTMLElement < "u" ? HTMLElement : class {}, U = class extends H {
	...
	_syncLocale(e) {
		let t = w();
		t ? t.currentLocale.set(e) : (this._unsubManager?.(), this._unsubManager = E((t) => {
	...
	typeof customElements > "u" || (customElements.get("intlayer-content-selector") || customElements.define("intlayer-content-selector", J), k(), M(), W());
}, X = () => ({
	...
	return T(t), Y(), t.start(), t;
}, $ = () => {
	Z = Math.max(0, Z - 1), !(Z > 0) && (w()?.stop(), T(null));
};
