...
import { Fragment, computed, createElementBlock, defineComponent, getCurrentInstance, h, inject, isRef, markRaw, openBlock, ref, shallowRef, toDisplayString, toValue, unref, watch } from "vue";
...
var MockBanner_default = defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, toDisplayString(unref(message)), 1);
		};
	}
});
