...
var ne = r({
	...
	return n;
}, ie = { class: "grid gap-8 md:grid-cols-2" }, ae = { class: "rounded-lg border border-border bg-card p-6" }, oe = { class: "mb-3 text-xl font-semibold text-foreground" }, $ = { class: "text-sm text-muted-foreground" }, se = { class: "rounded-lg border border-border bg-card p-6" }, ce = { class: "mb-3 text-xl font-semibold text-foreground" }, le = { class: "text-sm text-muted-foreground" };
function ue(e, r, i, a, o, s) {
	return d(), t("div", ie, [n("div", ae, [n("h2", oe, p(a.why.title), 1), n("p", $, p(a.why.description), 1)]), n("div", se, [n("h2", ce, p(a.methodology.title), 1), n("p", le, p(a.methodology.description), 1)])]);
}
var de = re(ne, [["render", ue], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/about/AboutGrid.vue"]]);
