import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, defineComponent as i, h as a, inject as o, isRef as s, markRaw as c, onBeforeMount as l, onMounted as u, openBlock as d, ref as f, shallowRef as ee, toDisplayString as p, toValue as m, unref as h, watch as g } from "vue";
...
}, ae = "translation", oe = "object", se = "array", S = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), C = (e, t) => {
...
}, E = "\x1B[0m", D = "\x1B[34m", O = "\x1B[31m", ce = "\x1B[32m", le = "\x1B[38;5;3m", ue = (e) => e, de = (e, t) => {
...
}), k = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? E : n : E}` : e, pe = (e, t = le, n = E) => [e].flat().map((e) => k(e, t, n)).join(", ");
k("✗", O), k("✓", ce), k("⏲", D);
var me = {
	"products-grid": {
		key: "products-grid",
	...
	"toLocaleString"
]), A = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : ge.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : A(e ? `${e}.${String(n)}` : String(n)) }), j = /* @__PURE__ */ new Set(), _e = (e, t, n) => {
	let r = he()[e];
	return r ? xe(r, t, n) : (j.has(e) || (fe({ log: T })(typeof window > "u" ? `Dictionary ${pe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), j.add(e)), A(e));
}, M = (e) => {
...
}, L = F, R = (e) => F, z = F, ve = F, B = F, V = F;
process.env.INTLAYER_OPTIMIZED_NESTING;
var H = (e) => F, U = F, ye = (e, t = !0) => [
	I(e ?? w.defaultLocale, t ? w.defaultLocale : void 0),
	L,
	R(e ?? w.defaultLocale),
	z,
	ve,
	...
	B,
	V
].filter((e) => e !== F), be = (e, t, n = []) => C(e, {
	...t,
	plugins: n
}), W = /* @__PURE__ */ new WeakSet(), xe = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = re(r ?? w.defaultLocale, "", n), o = ie(e, a);
	...
	return Object.assign(o, {
		...
		...n
	}), Object.setPrototypeOf(o, Ce(e, Function.prototype)), c(o);
}, we = {
...
}, Te = F, Ee = F, De = F, q = /* @__PURE__ */ new Map(), Oe = (e, t = !0) => {
	...
	return q.set(n, r), r;
}, J = (e, t) => _e(e, t, Oe(typeof t == "object" && t ? t.locale : t)), ke = Symbol("intlayer"), Y = (e, t) => t.reduce((e, t) => e?.[t], e), X = (e) => typeof e == "object" && !!e, Z = (e) => typeof e == "function" || X(e) && ("render" in e || "setup" in e), Ae = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, Q = (e) => c(i({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = o(ke), i = s(r?.locale) ? r.locale : f(r?.locale ?? w.defaultLocale), a = t(() => ({
		selector: void 0,
	...
	let u = /* @__PURE__ */ new Map(), d = (e) => {
		...
		let r = t(() => Y(l.value, e)), i = new Proxy({}, {
			get(n, i, a) {
				...
				if (Ae(s)) return je(t(() => Y(l.value, o)));
...
var Pe = { class: "mb-4 text-3xl font-bold text-foreground" }, $ = { class: "mb-8 max-w-3xl text-muted-foreground" }, Fe = i({
	__name: "AboutHeader",
	setup(t) {
		Ne("AboutHeader");
		let { title: i, description: a } = Me("about-header");
		return (t, o) => (d(), n(e, null, [r("h1", Pe, p(h(i)), 1), r("p", $, p(h(a)), 1)], 64));
	}
});
