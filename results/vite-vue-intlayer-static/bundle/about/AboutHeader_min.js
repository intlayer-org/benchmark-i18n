...
var v = {
...
}, O = process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false", k = {
	id: "fallback-plugin",
	canHandle: () => !1,
	transform: (e) => e
}, A = (e, t) => O ? k : {
	...
	let r = a() ? s(q) : void 0, i = c(r?.locale) ? r.locale : p(r?.locale ?? w.defaultLocale), o = t(() => (n === void 0 ? void 0 : g(n)) ?? i.value), l = m({});
	_([() => g(e), () => o.value], ([e, t]) => {
		l.value = K(e, t);
	}, {
		immediate: !0,
...
var ne = i({
	...
	return n;
}, ie = { class: "mb-4 text-3xl font-bold text-foreground" }, ae = { class: "mb-8 max-w-3xl text-muted-foreground" };
function oe(t, i, a, o, s, c) {
	return f(), n(e, null, [r("h1", ie, h(o.title), 1), r("p", ae, h(o.description), 1)], 64);
}
var se = re(ne, [["render", oe], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/about/AboutHeader.vue"]]);
