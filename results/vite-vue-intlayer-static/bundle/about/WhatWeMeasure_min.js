...
var ge = (e) => (t, n = {}) => {
	...
	return e;
}, K = process.env.INTLAYER_NODE_TYPE_INTLAYER_NODE === "false", q = !0, ye = !0, be = !0, J = !0, xe = K ? t : {
	...
	return Y.set(i, s), s;
}, Oe = (e, t) => ae(e, t, De(t)), ke = Symbol("intlayer"), X = (e, t) => t.reduce((e, t) => e?.[t], e), Z = (e) => typeof e == "object" && !!e, Q = (e) => typeof e == "function" || Z(e) && ("render" in e || "setup" in e), Ae = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, $ = (e) => S(v({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = y() ? x(ke) : void 0, i = ee(r?.locale) ? r.locale : T(r?.locale ?? e.defaultLocale), a = h(() => (n === void 0 ? void 0 : O(n)) ?? i.value), o = E({});
	re([() => O(t), () => a.value], ([e, t]) => {
		o.value = Oe(e, t);
	}, {
		immediate: !0,
...
var Pe = { class: "mt-12 mx-auto max-w-3xl" }, Fe = { class: "mb-4 text-2xl font-bold text-foreground" }, Ie = { class: "space-y-4" }, Le = { class: "block text-sm font-bold text-primary" }, Re = { class: "block mt-1 text-sm text-muted-foreground" }, ze = v({
	__name: "WhatWeMeasure",
	setup(e) {
		Ne("WhatWeMeasure");
		let { title: t, metrics: n } = Me(ie);
		return (e, r) => (w(), g("section", Pe, [_("h2", Fe, D(k(t)), 1), _("ul", Ie, [(w(!0), g(m, null, ne(k(n), (e) => (w(), g("li", {
			key: e.metric,
			class: "rounded-md border border-border p-4"
		}, [_("span", Le, D(e.metric), 1), _("span", Re, D(e.desc), 1)]))), 128))])]));
	}
});
