...
}), Pe = { class: "mb-2 text-3xl font-bold text-foreground" }, Fe = { class: "mb-4 text-muted-foreground" }, Ie = y({
	__name: "CareersHeader",
	setup(e) {
		let t = $(ie);
		return (e, n) => (C(), g(m, null, [
			v(Ne),
			_("h1", Pe, T(D(t).careers), 1),
			_("p", Fe, T(D(t).joinOurMissionToImprove), 1)
		], 64));
	}
});
