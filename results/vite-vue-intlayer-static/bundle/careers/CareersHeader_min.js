...
}), Ne = { class: "mb-2 text-3xl font-bold text-foreground" }, Pe = { class: "mb-4 text-muted-foreground" }, Fe = a({
	__name: "CareersHeader",
	setup(t) {
		let a = $("careers-header");
		return (t, o) => (u(), n(e, null, [
			i(Me),
			r("h1", Ne, p(h(a).careers), 1),
			r("p", Pe, p(h(a).joinOurMissionToImprove), 1)
		], 64));
	}
});
