import { Fragment, computed, createElementBlock, createElementVNode, createTextVNode, createVNode, defineComponent, h, inject, isRef, markRaw, openBlock, ref, shallowRef, toDisplayString, toValue, unref, watch } from "vue";
...
var ContactHeader_default = defineComponent({
	...
	setup(__props) {
		const content = v("contact-header");
		return (_ctx, _cache) => {
