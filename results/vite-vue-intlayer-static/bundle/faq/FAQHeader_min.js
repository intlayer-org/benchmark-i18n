...
}), ce = { class: "mb-2 text-3xl font-bold text-foreground" }, le = { class: "mb-10 text-muted-foreground" };
function $(t, a, o, s, c, l) {
	return d(), n(e, null, [
		i(s.MockBanner),
		r("h1", ce, p(s.title), 1),
		r("p", le, p(s.description), 1)
	], 64);
}
var ue = Q(se, [["render", $], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/faq/FAQHeader.vue"]]);
