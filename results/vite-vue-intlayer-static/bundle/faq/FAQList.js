...
var FAQList_vue_vue_type_script_setup_true_lang_default = defineComponent({
	...
	setup(__props, { expose: __expose }) {
		__expose();
		const { a: faqs } = b(faq_list_default);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("div", _hoisted_1, [(openBlock(true), createElementBlock(Fragment, null, renderList($setup.faqs, (f) => {
...
var FAQList_default = _plugin_vue_export_helper_default(FAQList_vue_vue_type_script_setup_true_lang_default, [["render", _sfc_render], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/faq/FAQList.vue"]]);
