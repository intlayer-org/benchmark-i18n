import { Fragment, computed, createElementBlock, createElementVNode, defineComponent, h, inject, isRef, markRaw, onBeforeMount, onMounted, openBlock, ref, renderList, shallowRef, toDisplayString, toValue, unref, watch } from "vue";
...
var ResultsTable_default = defineComponent({
	...
	setup(__props) {
		...
		const { title, columns, yes1, manual, yes } = v("results-table");
		const results = [
			{
				lib: "react-i18next",
				size: "42.3 kB",
