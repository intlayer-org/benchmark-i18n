...
var y = {
...
}, ee = "translation", te = "object", x = "array", S = (e, t) => {
	...
	let r = a() ? s(K) : void 0, i = c(r?.locale) ? r.locale : p(r?.locale ?? C.defaultLocale), o = t(() => (n === void 0 ? void 0 : _(n)) ?? i.value), l = h({});
	v([() => _(e), () => o.value], ([e, t]) => {
		l.value = G(e, t);
	}, {
		immediate: !0,
...
var ie = i({
	...
	setup(e, { expose: t }) {
		t(), re("ResultsTable");
		let { c: n, a: r, yes1: i, b: a, d: o } = ne(y), s = {
			title: n,
			columns: r,
			yes1: i,
			manual: a,
	...
	return n;
}, oe = { class: "mb-6 text-2xl font-bold text-foreground" }, se = { class: "overflow-x-auto rounded-lg border border-border" }, ce = { class: "w-full text-sm" }, le = { class: "bg-muted" }, ue = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, de = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, fe = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, pe = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, $ = { class: "px-4 py-3 font-medium text-foreground" }, me = { class: "px-4 py-3 text-muted-foreground" }, he = { class: "px-4 py-3 text-muted-foreground" }, ge = { class: "px-4 py-3 text-muted-foreground" };
function _e(t, i, a, o, s, c) {
	return f(), n("section", null, [r("h2", oe, g(o.title), 1), r("div", se, [r("table", ce, [r("thead", le, [r("tr", null, [
		r("th", ue, g(o.columns.library), 1),
		r("th", de, g(o.columns.bundleSize), 1),
		r("th", fe, g(o.columns.lookupTime), 1),
		r("th", pe, g(o.columns.lazyLoading), 1)
...
var ve = ae(ie, [["render", _e], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/home/ResultsTable.vue"]]);
