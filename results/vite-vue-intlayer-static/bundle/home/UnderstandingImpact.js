import { Fragment, computed, createElementBlock, createElementVNode, createTextVNode, defineComponent, getCurrentInstance, h, inject, isRef, markRaw, onBeforeMount, onMounted, openBlock, ref, renderList, shallowRef, toDisplayString, toValue, unref, watch } from "vue";
...
var UnderstandingImpact_default = defineComponent({
	...
	setup(__props) {
		...
		const { d: title, c: largeJson, b: dynamicLoading, a: benchmarkMeasures } = S(understanding_impact_default);
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("section", _hoisted_1, [
				createElementVNode("h2", _hoisted_2, toDisplayString(unref(title)), 1),
				createElementVNode("div", _hoisted_3, [
					createElementVNode("h3", _hoisted_4, toDisplayString(unref(largeJson).title), 1),
					createElementVNode("p", _hoisted_5, toDisplayString(unref(largeJson).description), 1),
					createElementVNode("ul", _hoisted_6, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(largeJson).points, (point, index) => {
						return openBlock(), createElementBlock("li", { key: index }, toDisplayString(point), 1);
					}), 128))])
				]),
				createElementVNode("div", _hoisted_7, [
					createElementVNode("h3", _hoisted_8, toDisplayString(unref(dynamicLoading).title), 1),
					createElementVNode("p", _hoisted_9, toDisplayString(unref(dynamicLoading).description), 1),
					createElementVNode("ul", _hoisted_10, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(dynamicLoading).points, (point, index) => {
				...
				createElementVNode("div", _hoisted_12, [createElementVNode("h3", _hoisted_13, toDisplayString(unref(benchmarkMeasures).title), 1), createElementVNode("p", _hoisted_14, toDisplayString(unref(benchmarkMeasures).description), 1)])
			]);
		};
	}
});
