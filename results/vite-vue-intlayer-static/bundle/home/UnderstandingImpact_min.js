import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, createTextVNode as i, defineComponent as a, h as o, inject as s, isRef as c, markRaw as l, onBeforeMount as u, onMounted as d, openBlock as f, ref as p, renderList as m, shallowRef as ee, toDisplayString as h, toValue as g, unref as _, watch as te } from "vue";
var v = /* @__PURE__ */ new WeakMap(), y = 0, ne = (e) => {
	if (!e) return "base";
	let t = v.get(e);
	if (t) return t;
	y += 1;
...
}, oe = "translation", C = "object", se = "array", w = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), T = (e, t) => {
...
}, D = "\x1B[0m", O = "\x1B[34m", le = "\x1B[31m", ue = "\x1B[32m", de = "\x1B[38;5;3m", fe = (e) => e, pe = (e, t) => {
...
}), k = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? D : n : D}` : e, he = (e, t = de, n = D) => [e].flat().map((e) => k(e, t, n)).join(", ");
k("✗", le), k("✓", ue), k("⏲", O);
var ge = {
	"products-grid": {
		key: "products-grid",
	...
	"toLocaleString"
]), A = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : ve.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : A(e ? `${e}.${String(n)}` : String(n)) }), j = /* @__PURE__ */ new Set(), ye = (e, t, n) => {
	let r = _e()[e];
	return r ? Ce(r, t, n) : (j.has(e) || (me({ log: ce })(typeof window > "u" ? `Dictionary ${he(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), j.add(e)), A(e));
}, M = (e) => {
...
}, L = F, R = (e) => F, z = F, be = F, B = F, V = F;
process.env.INTLAYER_OPTIMIZED_NESTING;
var H = (e) => F, U = F, xe = (e, t = !0) => [
	...
	B,
	V
].filter((e) => e !== F), Se = (e, t, n = []) => T(e, {
	...t,
	plugins: n
}), W = /* @__PURE__ */ new WeakSet(), Ce = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = ie(r ?? E.defaultLocale, "", n), o = ae(e, a);
...
}, G = /* @__PURE__ */ new Map(), we = (e, t) => Object.create(new Proxy(e, {
	get: (e, t, n) => {
	...
	return Object.assign(o, {
		...
		...n
	}), Object.setPrototypeOf(o, Te(e, Function.prototype)), l(o);
}, Ee = {
...
}, De = F, Oe = F, ke = F, q = /* @__PURE__ */ new Map(), Ae = (e, t = !0) => {
	...
	return q.set(n, r), r;
}, J = (e, t) => ye(e, t, Ae(typeof t == "object" && t ? t.locale : t)), je = Symbol("intlayer"), Y = (e, t) => t.reduce((e, t) => e?.[t], e), X = (e) => typeof e == "object" && !!e, Z = (e) => typeof e == "function" || X(e) && ("render" in e || "setup" in e), Me = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, Q = (e) => l(a({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = s(je), i = c(r?.locale) ? r.locale : p(r?.locale ?? E.defaultLocale), a = t(() => ({
		selector: void 0,
		locale: n === void 0 ? void 0 : g(n)
	})), o = t(() => a.value.locale ?? i.value), l = ee({});
	te([
		() => g(e),
		() => o.value,
		() => a.value.selector
	...
	let u = /* @__PURE__ */ new Map(), d = (e) => {
		...
		let r = t(() => Y(l.value, e)), i = new Proxy({}, {
			get(n, i, a) {
				...
				if (Me(s)) return Ne(t(() => Y(l.value, o)));
...
var Ie = { class: "mb-16 mx-auto max-w-3xl space-y-6" }, Le = { class: "text-2xl font-bold text-foreground" }, Re = { class: "rounded-lg border border-border bg-card p-6" }, ze = { class: "mb-2 text-lg font-semibold text-foreground" }, Be = { class: "text-sm text-muted-foreground" }, Ve = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, $ = { class: "rounded-lg border border-border bg-card p-6" }, He = { class: "mb-2 text-lg font-semibold text-foreground" }, Ue = { class: "text-sm text-muted-foreground" }, We = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, Ge = { class: "text-foreground" }, Ke = { class: "rounded-lg border border-border bg-card p-6" }, qe = { class: "mb-2 text-lg font-semibold text-foreground" }, Je = { class: "text-sm text-muted-foreground" }, Ye = a({
	__name: "UnderstandingImpact",
	setup(t) {
		Fe("UnderstandingImpact");
		let { title: a, largeJson: o, dynamicLoading: s, benchmarkMeasures: c } = Pe("understanding-impact");
		return (t, l) => (f(), n("section", Ie, [
			r("h2", Le, h(_(a)), 1),
			r("div", Re, [
				r("h3", ze, h(_(o).title), 1),
				r("p", Be, h(_(o).description), 1),
				r("ul", Ve, [(f(!0), n(e, null, m(_(o).points, (e, t) => (f(), n("li", { key: t }, h(e), 1))), 128))])
			]),
			r("div", $, [
				r("h3", He, h(_(s).title), 1),
				r("p", Ue, h(_(s).description), 1),
				r("ul", We, [(f(!0), n(e, null, m(_(s).points, (e, t) => (f(), n("li", { key: t }, [r("strong", Ge, h(e.label), 1), i(" " + h(e.text), 1)]))), 128))])
			]),
			r("div", Ke, [r("h3", qe, h(_(c).title), 1), r("p", Je, h(_(c).description), 1)])
		]));
	}
});
