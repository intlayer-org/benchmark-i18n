...
var ne = {
	...
	let n = `p${b}`;
	return y.set(e, n), n;
}, ie = 256, x = /* @__PURE__ */ new WeakMap(), S = (e) => typeof e == "object" && !!e, ae = (e, t, n) => `${e}_${t}_${re(n)}`, C = (e, t) => {
	if (!S(e)) return { hit: !1 };
	let n = x.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, V = z, me = (e) => z, H = z, he = z, U = z, W = z, G = (e) => z, K = z, ge = (e, t = !0) => [
	...
	let { locale: r, selector: i } = pe(t), a = ae(r ?? F.defaultLocale, P(i), n), o = C(e, a);
...
}, be = z, xe = z, Se = z, q = /* @__PURE__ */ new Map(), Ce = (e, t = !0) => {
	let n = `${e ?? F.defaultLocale}_${t}`;
	if (q.has(n)) return q.get(n);
	let r = [
		B(e ?? F.defaultLocale, t ? F.defaultLocale : void 0),
		V,
		me(e ?? F.defaultLocale),
		H,
		G(e ?? F.defaultLocale),
		K,
		U,
	...
	return q.set(n, r), r;
}, J = (e, t) => ve(e, t, Ce(typeof t == "object" && t ? t.locale : t)), we = Symbol("intlayer"), Y = (e, t) => t.reduce((e, t) => e?.[t], e), X = (e) => typeof e == "object" && !!e, Z = (e) => typeof e == "function" || X(e) && ("render" in e || "setup" in e), Te = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, Q = (e) => u(a({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = o() ? c(we) : void 0, i = l(r?.locale) ? r.locale : p(r?.locale ?? F.defaultLocale), a = t(() => ({
		selector: void 0,
...
var ke = a({
	...
	setup(e, { expose: t }) {
		t(), Oe("UnderstandingImpact");
		let { d: n, c: r, b: i, a } = De(ne), o = {
			title: n,
			largeJson: r,
			dynamicLoading: i,
			benchmarkMeasures: a
	...
	return n;
}, je = { class: "mb-16 mx-auto max-w-3xl space-y-6" }, Me = { class: "text-2xl font-bold text-foreground" }, Ne = { class: "rounded-lg border border-border bg-card p-6" }, Pe = { class: "mb-2 text-lg font-semibold text-foreground" }, $ = { class: "text-sm text-muted-foreground" }, Fe = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, Ie = { class: "rounded-lg border border-border bg-card p-6" }, Le = { class: "mb-2 text-lg font-semibold text-foreground" }, Re = { class: "text-sm text-muted-foreground" }, ze = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, Be = { class: "text-foreground" }, Ve = { class: "rounded-lg border border-border bg-card p-6" }, He = { class: "mb-2 text-lg font-semibold text-foreground" }, Ue = { class: "text-sm text-muted-foreground" };
function We(t, a, o, s, c, l) {
	return f(), n("section", je, [
		r("h2", Me, g(s.title), 1),
		r("div", Ne, [
			r("h3", Pe, g(s.largeJson.title), 1),
			r("p", $, g(s.largeJson.description), 1),
			r("ul", Fe, [(f(!0), n(e, null, m(s.largeJson.points, (e, t) => (f(), n("li", { key: t }, g(e), 1))), 128))])
		]),
		r("div", Ie, [
			r("h3", Le, g(s.dynamicLoading.title), 1),
			r("p", Re, g(s.dynamicLoading.description), 1),
			r("ul", ze, [(f(!0), n(e, null, m(s.dynamicLoading.points, (e, t) => (f(), n("li", { key: t }, [r("strong", Be, g(e.label), 1), i(" " + g(e.text), 1)]))), 128))])
		]),
		r("div", Ve, [r("h3", He, g(s.benchmarkMeasures.title), 1), r("p", Ue, g(s.benchmarkMeasures.description), 1)])
	]);
}
var Ge = Ae(ke, [["render", We], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/home/UnderstandingImpact.vue"]]);
