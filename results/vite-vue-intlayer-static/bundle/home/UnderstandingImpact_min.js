...
var b = {
...
}, ee = "translation", te = "object", S = "array", C = (e, t) => {
	...
	let r = o() ? c(q) : void 0, i = l(r?.locale) ? r.locale : m(r?.locale ?? w.defaultLocale), a = t(() => (n === void 0 ? void 0 : v(n)) ?? i.value), s = g({});
	y([() => v(e), () => a.value], ([e, t]) => {
		s.value = K(e, t);
	}, {
		immediate: !0,
	...
	let u = (e) => new Proxy({}, {
		get(n, r, i) {
			...
			if (Z(c)) return ne(t(() => J(s.value, o)));
			let l = t(() => J(s.value, o));
...
var ae = a({
	...
	setup(e, { expose: t }) {
		t(), ie("UnderstandingImpact");
		let { d: n, c: r, b: i, a } = re(b), o = {
			title: n,
			largeJson: r,
			dynamicLoading: i,
			benchmarkMeasures: a
	...
	return n;
}, se = { class: "mb-16 mx-auto max-w-3xl space-y-6" }, ce = { class: "text-2xl font-bold text-foreground" }, le = { class: "rounded-lg border border-border bg-card p-6" }, ue = { class: "mb-2 text-lg font-semibold text-foreground" }, de = { class: "text-sm text-muted-foreground" }, fe = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, pe = { class: "rounded-lg border border-border bg-card p-6" }, $ = { class: "mb-2 text-lg font-semibold text-foreground" }, me = { class: "text-sm text-muted-foreground" }, he = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, ge = { class: "text-foreground" }, _e = { class: "rounded-lg border border-border bg-card p-6" }, ve = { class: "mb-2 text-lg font-semibold text-foreground" }, ye = { class: "text-sm text-muted-foreground" };
function be(t, a, o, s, c, l) {
	return p(), n("section", se, [
		r("h2", ce, _(s.title), 1),
		r("div", le, [
			r("h3", ue, _(s.largeJson.title), 1),
			r("p", de, _(s.largeJson.description), 1),
			r("ul", fe, [(p(!0), n(e, null, h(s.largeJson.points, (e, t) => (p(), n("li", { key: t }, _(e), 1))), 128))])
		]),
		r("div", pe, [
			r("h3", $, _(s.dynamicLoading.title), 1),
			r("p", me, _(s.dynamicLoading.description), 1),
			r("ul", he, [(p(!0), n(e, null, h(s.dynamicLoading.points, (e, t) => (p(), n("li", { key: t }, [r("strong", ge, _(e.label), 1), i(" " + _(e.text), 1)]))), 128))])
		]),
		r("div", _e, [r("h3", ve, _(s.benchmarkMeasures.title), 1), r("p", ye, _(s.benchmarkMeasures.description), 1)])
	]);
}
var xe = oe(ae, [["render", be], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/home/UnderstandingImpact.vue"]]);
