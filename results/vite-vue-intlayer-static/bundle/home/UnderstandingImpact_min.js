...
var v = {
	...
	defaultLocale: "en"
}, re = Symbol("intlayer"), b = /* @__PURE__ */ new WeakMap(), x = 0, ie = (e) => {
	if (!e) return "base";
	let t = b.get(e);
	if (t) return t;
	x += 1;
...
}, ce = "translation", T = "object", E = "array", D = (e, t) => {
	...
	return n;
}, O = "default", le = /[^A-Za-z0-9._&=-]/g, k = /[^A-Za-z0-9._-]/g, ue = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase().padStart(4, "0")}`, A = (e, t) => {
	if (e === "") return "%";
	let n = e.replace(t, ue);
	return n === "." || n === ".." ? n.replace(/\./g, "%002E") : n;
}, j = (e) => e === void 0 ? O : typeof e == "string" ? A(e, le) : Object.keys(e).sort().map((t) => `${A(t, k)}=${A(String(e[t]), k)}`).join("&"), M = (e) => Array.isArray(e) ? e.length === 0 ? [O] : e.map(j) : [j(e)], de = (e, t) => {
	...
	if (!pe(e)) return e;
	let { qualifierTypes: n, content: r } = e, i = n.includes("item") && t?.item === void 0, a = Object.keys(r), o = n.indexOf("variant"), s = o === -1 ? O : de(M(t?.variant), (e) => a.some((t) => t.split("/")[o] === e)), c = a.filter((e) => fe(e, n, t, s)).map((t) => me(e, t));
...
}, B = R, ge = (e) => R, V = R, _e = R, H = R, U = R, W = (e) => R, G = R, ve = (e, t = !0) => [
	...
	let { locale: r, selector: i } = N(t), a = oe(r ?? y.defaultLocale, P(i), n), o = se(e, a);
...
}, q = R, Se = R, Ce = R, J = /* @__PURE__ */ new Map(), we = (e, t = !0) => {
	let n = `${e ?? y.defaultLocale}_${t}`;
	if (J.has(n)) return J.get(n);
	let r = [
		z(e ?? y.defaultLocale, t ? y.defaultLocale : void 0),
		B,
		ge(e ?? y.defaultLocale),
		V,
		W(e ?? y.defaultLocale),
		G,
		H,
	...
	return J.set(n, r), r;
}, Y = (e, t) => be(e, t, we(typeof t == "object" && t ? t.locale : t)), X = (e, t) => t.reduce((e, t) => e?.[t], e), Z = (e) => typeof e == "object" && !!e, Q = (e) => typeof e == "function" || Z(e) && ("render" in e || "setup" in e), Te = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, $ = (e) => u(a({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = o() ? c(re) : void 0, i = l(r?.locale) ? r.locale : p(r?.locale ?? y.defaultLocale), a = t(() => ({
		selector: void 0,
		locale: n === void 0 ? void 0 : g(n)
	})), s = t(() => a.value.locale ?? i.value), u = te({});
	ne([
		() => g(e),
		() => s.value,
		() => a.value.selector
	...
	let d = (e) => new Proxy({}, {
		get(n, r, i) {
			...
			if (Te(s)) return Ee(t(() => X(u.value, o)));
...
var ke = { class: "mb-16 mx-auto max-w-3xl space-y-6" }, Ae = { class: "text-2xl font-bold text-foreground" }, je = { class: "rounded-lg border border-border bg-card p-6" }, Me = { class: "mb-2 text-lg font-semibold text-foreground" }, Ne = { class: "text-sm text-muted-foreground" }, Pe = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, Fe = { class: "rounded-lg border border-border bg-card p-6" }, Ie = { class: "mb-2 text-lg font-semibold text-foreground" }, Le = { class: "text-sm text-muted-foreground" }, Re = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, ze = { class: "text-foreground" }, Be = { class: "rounded-lg border border-border bg-card p-6" }, Ve = { class: "mb-2 text-lg font-semibold text-foreground" }, He = { class: "text-sm text-muted-foreground" }, Ue = a({
	__name: "UnderstandingImpact",
	setup(t) {
		Oe("UnderstandingImpact");
		let { d: a, c: o, b: s, a: c } = De(v);
		return (t, l) => (f(), n("section", ke, [
			r("h2", Ae, h(_(a)), 1),
			r("div", je, [
				r("h3", Me, h(_(o).title), 1),
				r("p", Ne, h(_(o).description), 1),
				r("ul", Pe, [(f(!0), n(e, null, m(_(o).points, (e, t) => (f(), n("li", { key: t }, h(e), 1))), 128))])
			]),
			r("div", Fe, [
				r("h3", Ie, h(_(s).title), 1),
				r("p", Le, h(_(s).description), 1),
				r("ul", Re, [(f(!0), n(e, null, m(_(s).points, (e, t) => (f(), n("li", { key: t }, [r("strong", ze, h(e.label), 1), i(" " + h(e.text), 1)]))), 128))])
			]),
			r("div", Be, [r("h3", Ve, h(_(c).title), 1), r("p", He, h(_(c).description), 1)])
		]));
	}
});
