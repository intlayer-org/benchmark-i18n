...
var _ = {
...
}, ve = L, ye = L, be = L, J = /* @__PURE__ */ new Map(), xe = (e, t = !0) => {
	...
	return J.set(n, r), r;
}, Y = (e, t) => _e(e, t, xe(typeof t == "object" && t ? t.locale : t)), X = (e, t) => t.reduce((e, t) => e?.[t], e), Z = (e) => typeof e == "object" && !!e, Q = (e) => typeof e == "function" || Z(e) && ("render" in e || "setup" in e), Se = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, $ = (e) => c(r({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let d = (t) => new Proxy({}, {
		get(n, r, i) {
			...
			if (Se(s)) return Ce(e(() => X(u.value, o)));
...
var Ee = { class: "grid gap-8 md:grid-cols-2" }, De = { class: "rounded-lg border border-border bg-card p-6" }, Oe = { class: "mb-3 text-xl font-semibold text-foreground" }, ke = { class: "text-sm text-muted-foreground" }, Ae = { class: "rounded-lg border border-border bg-card p-6" }, je = { class: "mb-3 text-xl font-semibold text-foreground" }, Me = { class: "text-sm text-muted-foreground" }, Ne = r({
	__name: "AboutGrid",
	setup(e) {
		Te("AboutGrid");
		let { b: r, a: i } = we(_);
		return (e, a) => (d(), t("div", Ee, [n("div", De, [n("h2", Oe, p(h(r).title), 1), n("p", ke, p(h(r).description), 1)]), n("div", Ae, [n("h2", je, p(h(i).title), 1), n("p", Me, p(h(i).description), 1)])]));
	}
});
