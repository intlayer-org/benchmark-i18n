...
var h = {
	...
	return n;
}, ee = { class: "rounded-lg border border-border bg-card p-6" }, te = { class: "mb-4 text-lg font-semibold text-foreground" }, ne = {
	for: "apiKey",
	class: "mb-1 block text-sm font-medium text-foreground"
}, re = { class: "flex gap-2" }, ie = {
	type: "button",
	class: "rounded-md border border-border px-4 py-2 text-sm font-medium text-foreground hover:bg-accent transition-colors"
}, ae = { class: "mt-1 text-xs text-muted-foreground" };
function oe(e, r, i, a, o, s) {
	return l(), t("section", ee, [n("h2", te, f(a.title), 1), n("div", null, [
		n("label", ne, f(a.apiKeyLabel), 1),
		n("div", re, [r[0] ||= n("input", {
			id: "apiKey",
			readonly: "",
		...
		}, null, -1), n("button", ie, f(a.copy), 1)]),
		n("p", ae, f(a.description), 1)
	])]);
}
var se = $(Q, [["render", oe], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/settings/ApiAccessSection.vue"]]);
