...
var g = {
	...
	return n;
}, re = { class: "grid gap-6 md:grid-cols-2" }, ie = { class: "mb-3 flex items-center gap-3" }, ae = { class: "rounded-full bg-accent px-3 py-0.5 text-xs font-medium text-accent-foreground" }, oe = { class: "text-xs text-muted-foreground" }, $ = { class: "mb-2 text-lg font-semibold text-foreground" }, se = { class: "mb-4 text-sm text-muted-foreground" }, ce = {
	type: "button",
	class: "text-sm font-medium text-primary hover:underline"
};
function le(t, i, a, o, s, c) {
	return u(), n("div", re, [(u(!0), n(e, null, f(o.posts, (e) => (u(), n("article", {
		key: e.title,
		class: "rounded-lg border border-border bg-card p-6"
	}, [
		r("div", ie, [r("span", ae, p(e.category), 1), r("span", oe, p(e.date), 1)]),
		r("h2", $, p(e.title), 1),
		r("p", se, p(e.excerpt), 1),
		r("button", ce, p(o.readMore), 1)
	]))), 128))]);
}
var ue = ne(Q, [["render", le], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/blog/BlogList.vue"]]);
