...
var pe = (e) => (t, n = {}) => {
	...
	return n;
}, Me = { class: "grid gap-6 md:grid-cols-2" }, Ne = { class: "mb-3 flex items-center gap-3" }, Pe = { class: "rounded-full bg-accent px-3 py-0.5 text-xs font-medium text-accent-foreground" }, Fe = { class: "text-xs text-muted-foreground" }, Ie = { class: "mb-2 text-lg font-semibold text-foreground" }, Le = { class: "mb-4 text-sm text-muted-foreground" }, Re = {
	type: "button",
	class: "text-sm font-medium text-primary hover:underline"
};
function ze(e, t, n, r, i, a) {
	return C(), g("div", Me, [(C(!0), g(m, null, te(r.posts, (e) => (C(), g("article", {
		key: e.title,
		class: "rounded-lg border border-border bg-card p-6"
	}, [
		_("div", Ne, [_("span", Pe, T(e.category), 1), _("span", Fe, T(e.date), 1)]),
		_("h2", Ie, T(e.title), 1),
		_("p", Le, T(e.excerpt), 1),
		_("button", Re, T(r.readMore), 1)
	]))), 128))]);
}
var Be = je(Ae, [["render", ze], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/blog/BlogList.vue"]]);
