...
var me = (e) => (t, n = {}) => {
	...
	__name: "BlogList",
	setup(e) {
		let { readMore: t, posts: n } = Ae(re);
		return (e, r) => (C(), g("div", je, [(C(!0), g(m, null, te(D(n), (e) => (C(), g("article", {
			key: e.title,
			class: "rounded-lg border border-border bg-card p-6"
		}, [
			_("div", Me, [_("span", Ne, T(e.category), 1), _("span", Pe, T(e.date), 1)]),
			_("h2", Fe, T(e.title), 1),
			_("p", Ie, T(e.excerpt), 1),
			_("button", Le, T(D(t)), 1)
		]))), 128))]));
	}
});
