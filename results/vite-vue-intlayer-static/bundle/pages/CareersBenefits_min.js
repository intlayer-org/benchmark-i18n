...
var _ = {
	...
	return n;
}, ne = { class: "mb-12 grid gap-4 md:grid-cols-3" }, re = { class: "text-sm font-semibold text-foreground" }, ie = { class: "text-xs text-muted-foreground" };
function ae(t, i, a, o, s, c) {
	return u(), n("div", ne, [(u(), n(e, null, f(o.benefits, (e) => r("div", {
		key: e.label,
		class: "rounded-lg border border-border bg-card p-4 text-center"
	}, [r("p", re, m(e.label), 1), r("p", ie, m(e.value), 1)])), 64))]);
}
var oe = te(ee, [["render", ae], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/careers/CareersBenefits.vue"]]);
