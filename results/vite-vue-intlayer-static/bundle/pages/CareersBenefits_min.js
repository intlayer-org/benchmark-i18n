import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, defineComponent as i, h as a, inject as o, isRef as s, markRaw as c, openBlock as l, ref as u, renderList as d, shallowRef as ee, toDisplayString as f, toValue as p, watch as m } from "vue";
var h = /* @__PURE__ */ new WeakMap(), g = 0, te = (e) => {
	if (!e) return "base";
	let t = h.get(e);
	if (t) return t;
	g += 1;
	let n = `p${g}`;
	return h.set(e, n), n;
}, _ = 256, v = /* @__PURE__ */ new WeakMap(), y = (e) => typeof e == "object" && !!e, ne = (e, t, n) => `${e}_${t}_${te(n)}`, re = (e, t) => {
	if (!y(e)) return { hit: !1 };
	let n = v.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, ie = "translation", ae = "object", oe = "array", x = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), S = (e, t) => {
	for (let n of t.plugins ?? []) if (n.canHandle(e)) return n.transform(e, t, S);
	if (typeof e != "object" || !e || e.$$typeof !== void 0 || e.__v_isVNode !== void 0 || e._isVNode !== void 0 || e.isJSX !== void 0) return e;
	if (Array.isArray(e)) return e.map((e, n) => S(e, x(t, e, {
		type: oe,
		key: n
	})));
	let n = {};
...
}, w = "\x1B[0m", T = "\x1B[34m", E = "\x1B[31m", D = "\x1B[32m", O = "\x1B[38;5;3m", ce = (e) => e, le = (e, t) => {
...
}), k = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? w : n : w}` : e, de = (e, t = O, n = w) => [e].flat().map((e) => k(e, t, n)).join(", ");
k("✗", E), k("✓", D), k("⏲", T);
var fe = {
	"products-grid": {
		key: "products-grid",
...
}, pe = () => fe, me = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), A = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : me.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : A(e ? `${e}.${String(n)}` : String(n)) }), j = /* @__PURE__ */ new Set(), he = (e, t, n) => {
	let r = pe()[e];
	return r ? ye(r, t, n) : (j.has(e) || (ue({ log: se })(typeof window > "u" ? `Dictionary ${de(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), j.add(e)), A(e));
}, M = (e) => {
...
var H = (e) => F, U = F, _e = (e, t = !0) => [
	I(e ?? C.defaultLocale, t ? C.defaultLocale : void 0),
	L,
	R(e ?? C.defaultLocale),
	z,
	ge,
	...
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = ne(r ?? C.defaultLocale, "", n), o = re(e, a);
	...
	return Object.assign(o, {
		...
		...n
	}), Object.setPrototypeOf(o, xe(e, Function.prototype)), c(o);
}, Se = {
	...
	return q.set(n, r), r;
}, Y = (e, t) => he(e, t, J(typeof t == "object" && t ? t.locale : t)), Ee = Symbol("intlayer"), X = (e, t) => t.reduce((e, t) => e?.[t], e), Z = (e) => typeof e == "object" && !!e, Q = (e) => typeof e == "function" || Z(e) && ("render" in e || "setup" in e), De = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, $ = (e) => c(i({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = o(Ee), i = s(r?.locale) ? r.locale : u(r?.locale ?? C.defaultLocale), a = t(() => ({
		selector: void 0,
		locale: n === void 0 ? void 0 : p(n)
	})), c = t(() => a.value.locale ?? i.value), l = ee({});
	m([
		() => p(e),
		() => c.value,
		() => a.value.selector
	...
	let d = /* @__PURE__ */ new Map(), f = (e) => {
		...
		let r = t(() => X(l.value, e)), i = new Proxy({}, {
			get(n, i, a) {
				...
				if (De(s)) return Oe(t(() => X(l.value, o)));
	...
	return f([]);
}, Ae = { class: "mb-12 grid gap-4 md:grid-cols-3" }, je = { class: "text-sm font-semibold text-foreground" }, Me = { class: "text-xs text-muted-foreground" }, Ne = i({
	__name: "CareersBenefits",
	setup(t) {
		let i = ke("careers-benefits"), a = [
			{
				label: "Remote-first",
		...
		return (t, i) => (l(), n("div", Ae, [(l(), n(e, null, d(a, (e) => r("div", {
			key: e.label,
			class: "rounded-lg border border-border bg-card p-4 text-center"
		}, [r("p", je, f(e.label), 1), r("p", Me, f(e.value), 1)])), 64))]));
	}
});
