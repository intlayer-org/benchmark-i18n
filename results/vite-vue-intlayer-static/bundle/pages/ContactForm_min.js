import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, defineComponent as i, h as a, inject as o, isRef as s, markRaw as c, openBlock as l, ref as u, renderList as d, shallowRef as f, toDisplayString as p, toValue as m, unref as h, watch as g, withModifiers as ee } from "vue";
var _ = /* @__PURE__ */ new WeakMap(), v = 0, te = (e) => {
	...
	let n = `p${v}`;
	return _.set(e, n), n;
}, ne = 256, y = /* @__PURE__ */ new WeakMap(), b = (e) => typeof e == "object" && !!e, x = (e, t, n) => `${e}_${t}_${te(n)}`, re = (e, t) => {
	if (!b(e)) return { hit: !1 };
	let n = y.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, E = "\x1B[0m", ce = "\x1B[34m", D = "\x1B[31m", O = "\x1B[32m", le = "\x1B[38;5;3m", ue = (e) => e, de = (e, t) => {
...
var me = {
	...
	let r = he()[e];
	return r ? xe(r, t, n) : (j.has(e) || (fe({ log: se })(typeof window > "u" ? `Dictionary ${pe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), j.add(e)), A(e));
}, M = (e) => {
...
var H = (e) => F, U = F, ye = (e, t = !0) => [
	...
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = x(r ?? T.defaultLocale, "", n), o = re(e, a);
...
}, we = F, Te = F, Ee = F, J = /* @__PURE__ */ new Map(), De = (e, t = !0) => {
	...
	return J.set(n, r), r;
}, Y = (e, t) => _e(e, t, De(typeof t == "object" && t ? t.locale : t)), Oe = Symbol("intlayer"), X = (e, t) => t.reduce((e, t) => e?.[t], e), Z = (e) => typeof e == "object" && !!e, Q = (e) => typeof e == "function" || Z(e) && ("render" in e || "setup" in e), ke = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, $ = (e) => c(i({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let d = /* @__PURE__ */ new Map(), p = (e) => {
		...
		let r = t(() => X(l.value, e)), i = new Proxy({}, {
			get(n, i, a) {
				...
				if (ke(s)) return Ae(t(() => X(l.value, o)));
	...
	__name: "ContactForm",
	setup(t) {
		let { nameLabel: i, namePlaceholder: a, emailLabel: o, emailPlaceholder: s, topicLabel: c, topics: u, messageLabel: f, messagePlaceholder: m, sendMessage: g } = je("contact-form");
		return (t, _) => (l(), n("form", {
			class: "space-y-6",
			onSubmit: _[0] ||= ee(() => {}, ["prevent"])
		}, [
			r("div", Me, [r("div", null, [r("label", Ne, p(h(i)), 1), r("input", {
				id: "name",
				...
				placeholder: h(a)
			}, null, 8, Pe)]), r("div", null, [r("label", Fe, p(h(o)), 1), r("input", {
				id: "email",
				type: "email",
				class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: h(s)
			}, null, 8, Ie)])]),
			r("div", null, [r("label", Le, p(h(c)), 1), r("select", Re, [(l(!0), n(e, null, d(h(u), (e) => (l(), n("option", { key: e }, p(e), 1))), 128))])]),
			r("div", null, [r("label", ze, p(h(f)), 1), r("textarea", {
				id: "message",
				rows: "5",
				class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: h(m)
