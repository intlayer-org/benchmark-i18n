...
import { Fragment, computed, createElementBlock, createElementVNode, createTextVNode, createVNode, defineComponent, getCurrentInstance, h, inject, isRef, markRaw, openBlock, ref, shallowRef, toDisplayString, toValue, unref, watch } from "vue";
...
var ContactHeader_default = defineComponent({
	...
	setup(__props) {
		const content = b(contact_header_default);
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock(Fragment, null, [
				createVNode(MockBanner_default),
				createElementVNode("h1", _hoisted_1, toDisplayString(unref(content).getInTouch), 1),
				createElementVNode("p", _hoisted_2, [
					createTextVNode(toDisplayString(unref(content).haveIdeasFoundABug), 1),
