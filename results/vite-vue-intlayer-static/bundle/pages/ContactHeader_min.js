import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, createTextVNode as i, createVNode as a, defineComponent as o, h as s, inject as c, isRef as l, markRaw as u, openBlock as d, ref as f, shallowRef as p, toDisplayString as m, toValue as h, unref as g, watch as ee } from "vue";
var _ = /* @__PURE__ */ new WeakMap(), v = 0, te = (e) => {
	if (!e) return "base";
	let t = _.get(e);
	if (t) return t;
	v += 1;
	let n = `p${v}`;
	return _.set(e, n), n;
}, y = 256, b = /* @__PURE__ */ new WeakMap(), x = (e) => typeof e == "object" && !!e, ne = (e, t, n) => `${e}_${t}_${te(n)}`, re = (e, t) => {
	if (!x(e)) return { hit: !1 };
	let n = b.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, ie = "translation", ae = "object", oe = "array", C = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), w = (e, t) => {
...
}, E = "\x1B[0m", D = "\x1B[34m", ce = "\x1B[31m", le = "\x1B[32m", ue = "\x1B[38;5;3m", de = (e) => e, fe = (e, t) => {
...
}), O = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? E : n : E}` : e, me = (e, t = ue, n = E) => [e].flat().map((e) => O(e, t, n)).join(", ");
O("✗", ce), O("✓", le), O("⏲", D);
var he = {
	"products-grid": {
		key: "products-grid",
...
}, ge = () => he, _e = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), k = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : _e.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : k(e ? `${e}.${String(n)}` : String(n)) }), A = /* @__PURE__ */ new Set(), ve = (e, t, n) => {
	let r = ge()[e];
	return r ? W(r, t, n) : (A.has(e) || (pe({ log: se })(typeof window > "u" ? `Dictionary ${me(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), A.add(e)), k(e));
}, j = (e) => {
...
}, I = P, L = (e) => P, R = P, ye = P, z = P, B = P;
process.env.INTLAYER_OPTIMIZED_NESTING;
var V = (e) => P, H = P, be = (e, t = !0) => [
	F(e ?? T.defaultLocale, t ? T.defaultLocale : void 0),
	I,
	L(e ?? T.defaultLocale),
	R,
	ye,
	...
	z,
	B
].filter((e) => e !== P), xe = (e, t, n = []) => w(e, {
	...t,
	plugins: n
}), U = /* @__PURE__ */ new WeakSet(), W = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = ne(r ?? T.defaultLocale, "", n), o = re(e, a);
...
}, G = /* @__PURE__ */ new Map(), Se = (e, t) => Object.create(new Proxy(e, {
	get: (e, t, n) => {
	...
	return Object.assign(o, {
		...
		...n
	}), Object.setPrototypeOf(o, Ce(e, Function.prototype)), u(o);
}, we = {
...
}, Te = P, Ee = P, De = P, q = /* @__PURE__ */ new Map(), Oe = (e, t = !0) => {
	...
	return q.set(n, r), r;
}, J = (e, t) => ve(e, t, Oe(typeof t == "object" && t ? t.locale : t)), ke = Symbol("intlayer"), Y = (e, t) => t.reduce((e, t) => e?.[t], e), X = (e) => typeof e == "object" && !!e, Z = (e) => typeof e == "function" || X(e) && ("render" in e || "setup" in e), Ae = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, Q = (e) => u(o({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = c(ke), i = l(r?.locale) ? r.locale : f(r?.locale ?? T.defaultLocale), a = t(() => ({
		selector: void 0,
		locale: n === void 0 ? void 0 : h(n)
	})), o = t(() => a.value.locale ?? i.value), s = p({});
	ee([
		() => h(e),
		() => o.value,
		() => a.value.selector
	...
	let u = /* @__PURE__ */ new Map(), d = (e) => {
		...
		let r = t(() => Y(s.value, e)), i = new Proxy({}, {
			get(n, i, a) {
				...
				let o = e.concat(i), c = Y(s.value, o);
				if (c === void 0 || X(c) && !Z(c)) return d(o);
				if (Ae(c)) return je(t(() => Y(s.value, o)));
				if (typeof c == "function") {
					let t = Y(s.value, e);
					return t != null && !Object.hasOwn(t, i) ? c.bind(t) : (...e) => Y(s.value, o)?.(...e);
				}
				let l = t(() => Y(s.value, o));
	...
	return d([]);
}, Me = { class: "mb-8 rounded-lg border border-yellow-500/20 bg-yellow-500/10 p-4 text-sm text-yellow-600 dark:text-yellow-400" }, Ne = o({
	__name: "MockBanner",
	setup(e) {
		let { message: t } = $("mock-banner");
		return (e, r) => (d(), n("div", Me, m(g(t)), 1));
	}
}), Pe = { class: "mb-2 text-3xl font-bold text-foreground" }, Fe = { class: "mb-8 text-muted-foreground" }, Ie = o({
	__name: "ContactHeader",
	setup(t) {
		let o = $("contact-header");
		return (t, s) => (d(), n(e, null, [
			a(Ne),
			r("h1", Pe, m(g(o).getInTouch), 1),
			r("p", Fe, [
