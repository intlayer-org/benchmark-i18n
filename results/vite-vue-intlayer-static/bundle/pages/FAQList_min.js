import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, defineComponent as i, h as a, inject as o, isRef as s, markRaw as c, openBlock as l, ref as u, renderList as d, shallowRef as ee, toDisplayString as f, toValue as p, unref as te, watch as ne } from "vue";
var m = /* @__PURE__ */ new WeakMap(), h = 0, g = (e) => {
	if (!e) return "base";
	let t = m.get(e);
	if (t) return t;
	h += 1;
	let n = `p${h}`;
	return m.set(e, n), n;
}, _ = 256, v = /* @__PURE__ */ new WeakMap(), y = (e) => typeof e == "object" && !!e, re = (e, t, n) => `${e}_${t}_${g(n)}`, ie = (e, t) => {
	if (!y(e)) return { hit: !1 };
	let n = v.get(e);
	return n?.has(t) ? {
		hit: !0,
...
var me = {
	...
	let r = he()[e];
	return r ? be(r, t, n) : (A.has(e) || (fe({ log: ae })(typeof window > "u" ? `Dictionary ${pe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), A.add(e)), k(e));
}, M = (e) => {
...
var H = (e) => F, U = F, ve = (e, t = !0) => [
	I(e ?? E.defaultLocale, t ? E.defaultLocale : void 0),
	L,
	R(e ?? E.defaultLocale),
	z,
	_e,
	...
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = re(r ?? E.defaultLocale, "", n), o = ie(e, a);
	...
	return q.set(n, r), r;
}, J = (e, t) => j(e, t, De(typeof t == "object" && t ? t.locale : t)), Oe = Symbol("intlayer"), Y = (e, t) => t.reduce((e, t) => e?.[t], e), X = (e) => typeof e == "object" && !!e, Z = (e) => typeof e == "function" || X(e) && ("render" in e || "setup" in e), Q = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, $ = (e) => c(i({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = o(Oe), i = s(r?.locale) ? r.locale : u(r?.locale ?? E.defaultLocale), a = t(() => ({
		selector: void 0,
	...
	let d = /* @__PURE__ */ new Map(), f = (e) => {
		...
		let r = t(() => Y(l.value, e)), i = new Proxy({}, {
			get(n, i, a) {
				...
				if (Q(s)) return ke(t(() => Y(l.value, o)));
	...
	return f([]);
}, je = { class: "mx-auto max-w-3xl space-y-4" }, Me = { class: "cursor-pointer px-6 py-4 text-sm font-medium text-foreground hover:bg-accent/50 transition-colors" }, Ne = { class: "px-6 pb-4 text-sm text-muted-foreground" }, Pe = i({
	__name: "FAQList",
	setup(t) {
		let { faqs: i } = Ae("faq-list");
		return (t, a) => (l(), n("div", je, [(l(!0), n(e, null, d(te(i), (e) => (l(), n("details", {
			key: e.q,
			class: "group rounded-lg border border-border bg-card"
		}, [r("summary", Me, f(e.q), 1), r("p", Ne, f(e.a), 1)]))), 128))]));
	}
});
