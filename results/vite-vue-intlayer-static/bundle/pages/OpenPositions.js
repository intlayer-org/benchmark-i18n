...
var OpenPositions_vue_vue_type_script_setup_true_lang_default = defineComponent({
	...
	setup(__props, { expose: __expose }) {
		__expose();
		const { c: title, a: applyNow, b: openings } = S(open_positions_default);
		const __returned__ = {
			title,
			applyNow,
			openings
...
var OpenPositions_default = _plugin_vue_export_helper_default(OpenPositions_vue_vue_type_script_setup_true_lang_default, [["render", _sfc_render], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/careers/OpenPositions.vue"]]);
