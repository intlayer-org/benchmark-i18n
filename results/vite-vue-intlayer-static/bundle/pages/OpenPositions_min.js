...
var g = {
	...
	return n;
}, re = { class: "mb-6 text-2xl font-bold text-foreground" }, ie = { class: "space-y-4" }, ae = { class: "text-base font-semibold text-foreground" }, oe = { class: "text-sm text-muted-foreground" }, $ = { class: "mt-2 flex gap-2" }, se = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, ce = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, le = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, ue = {
	type: "button",
...
function de(t, i, a, o, s, c) {
	return u(), n(e, null, [r("h2", re, p(o.title), 1), r("div", ie, [(u(!0), n(e, null, f(o.openings, (e) => (u(), n("div", {
		key: e.title,
		...
		r("p", oe, p(e.desc), 1),
		r("div", $, [
			r("span", se, p(e.dept), 1),
			r("span", ce, p(e.location), 1),
			r("span", le, p(e.type), 1)
		])
	]), r("button", ue, p(o.applyNow), 1)]))), 128))])], 64);
}
var fe = ne(Q, [["render", de], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/careers/OpenPositions.vue"]]);
