...
}), Me = { class: "mb-12 text-center" }, Ne = { class: "mb-3 text-3xl font-bold text-foreground" }, $ = { class: "text-muted-foreground" };
function Pe(t, a, o, s, c, l) {
	return d(), n(e, null, [i(s.MockBanner), r("div", Me, [r("h1", Ne, p(s.title), 1), r("p", $, p(s.description), 1)])], 64);
}
var Fe = Q(je, [["render", Pe], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/pricing/PricingHeader.vue"]]);
