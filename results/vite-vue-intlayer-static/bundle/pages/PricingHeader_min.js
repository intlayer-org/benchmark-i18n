...
}), Ne = { class: "mb-12 text-center" }, Pe = { class: "mb-3 text-3xl font-bold text-foreground" }, Fe = { class: "text-muted-foreground" }, Ie = a({
	__name: "PricingHeader",
	setup(t) {
		let { title: a, description: o } = $("pricing-header");
		return (t, s) => (u(), n(e, null, [i(Me), r("div", Ne, [r("h1", Pe, p(h(a)), 1), r("p", Fe, p(h(o)), 1)])], 64));
	}
});
