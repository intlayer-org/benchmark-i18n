import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, createTextVNode as i, defineComponent as a, h as o, inject as s, isRef as c, markRaw as l, normalizeClass as u, openBlock as d, ref as f, renderList as p, shallowRef as m, toDisplayString as h, toValue as g, unref as _, watch as v } from "vue";
var y = /* @__PURE__ */ new WeakMap(), b = 0, x = (e) => {
	if (!e) return "base";
	let t = y.get(e);
	if (t) return t;
	b += 1;
	let n = `p${b}`;
	return y.set(e, n), n;
}, S = 256, C = /* @__PURE__ */ new WeakMap(), w = (e) => typeof e == "object" && !!e, T = (e, t, n) => `${e}_${t}_${x(n)}`, ee = (e, t) => {
	if (!w(e)) return { hit: !1 };
	let n = C.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, te = "translation", ne = "object", re = "array", D = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), O = (e, t) => {
...
}, A = "\x1B[0m", ae = "\x1B[34m", oe = "\x1B[31m", se = "\x1B[32m", ce = "\x1B[38;5;3m", le = (e) => e, ue = (e, t) => {
...
}), j = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? A : n : A}` : e, fe = (e, t = ce, n = A) => [e].flat().map((e) => j(e, t, n)).join(", ");
j("✗", oe), j("✓", se), j("⏲", ae);
var pe = {
	"products-grid": {
		key: "products-grid",
...
}, me = () => pe, he = /* @__PURE__ */ new Set([
	"hasOwnProperty",
	"isPrototypeOf",
	"propertyIsEnumerable",
	"toLocaleString"
]), M = (e = "") => new Proxy((() => e), { get: (t, n) => n === "toJSON" || n === Symbol.toPrimitive || n === "toString" || n === "valueOf" ? () => e : n === "then" ? void 0 : he.has(n) ? Object.prototype[n].bind(t) : n === Symbol.iterator ? function* () {
	yield e;
} : M(e ? `${e}.${String(n)}` : String(n)) }), N = /* @__PURE__ */ new Set(), ge = (e, t, n) => {
	let r = me()[e];
	return r ? xe(r, t, n) : (N.has(e) || (de({ log: ie })(typeof window > "u" ? `Dictionary ${fe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), N.add(e)), M(e));
}, P = (e) => {
...
}, R = I, z = (e) => I, B = I, ve = I, V = I, H = I;
process.env.INTLAYER_OPTIMIZED_NESTING;
var U = (e) => I, W = I, ye = (e, t = !0) => [
	L(e ?? k.defaultLocale, t ? k.defaultLocale : void 0),
	R,
	z(e ?? k.defaultLocale),
	B,
	ve,
	...
	V,
	H
].filter((e) => e !== I), be = (e, t, n = []) => O(e, {
	...t,
	plugins: n
}), G = /* @__PURE__ */ new WeakSet(), xe = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = T(r ?? k.defaultLocale, "", n), o = ee(e, a);
...
}, K = /* @__PURE__ */ new Map(), Se = (e, t) => Object.create(new Proxy(e, {
	get: (e, t, n) => {
...
}, q = ({ value: e, children: t, additionalProps: n = {} }) => {
	...
	return Object.assign(o, {
		...
		...n
	}), Object.setPrototypeOf(o, Ce(e, Function.prototype)), l(o);
}, we = {
	id: "intlayer-node-plugin",
	canHandle: (e) => typeof e == "bigint" || typeof e == "string" || typeof e == "number",
	transform: (e, t) => {
		let { children: n, dictionaryKey: r, keyPath: i } = t, a = (e) => q({
			value: e,
			children: e
		}), o = a(n);
...
}, Te = I, Ee = I, De = I, J = /* @__PURE__ */ new Map(), Oe = (e, t = !0) => {
	...
	return J.set(n, r), r;
}, Y = (e, t) => ge(e, t, Oe(typeof t == "object" && t ? t.locale : t)), ke = Symbol("intlayer"), X = (e, t) => t.reduce((e, t) => e?.[t], e), Z = (e) => typeof e == "object" && !!e, Q = (e) => typeof e == "function" || Z(e) && ("render" in e || "setup" in e), Ae = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, $ = (e) => l(a({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = s(ke), i = c(r?.locale) ? r.locale : f(r?.locale ?? k.defaultLocale), a = t(() => ({
		selector: void 0,
		locale: n === void 0 ? void 0 : g(n)
	})), o = t(() => a.value.locale ?? i.value), l = m({});
	v([
		() => g(e),
		() => o.value,
		() => a.value.selector
	...
	let u = /* @__PURE__ */ new Map(), d = (e) => {
		...
		let r = t(() => X(l.value, e)), i = new Proxy({}, {
			get(n, i, a) {
				...
				let o = e.concat(i), s = X(l.value, o);
				if (s === void 0 || Z(s) && !Q(s)) return d(o);
				if (Ae(s)) return je(t(() => X(l.value, o)));
				if (typeof s == "function") {
					let t = X(l.value, e);
					return t != null && !Object.hasOwn(t, i) ? s.bind(t) : (...e) => X(l.value, o)?.(...e);
				}
				let c = t(() => X(l.value, o));
	...
	return d([]);
}, Ne = { class: "grid gap-6 md:grid-cols-3" }, Pe = { class: "text-lg font-semibold text-foreground" }, Fe = { class: "my-4" }, Ie = { class: "text-3xl font-bold text-foreground" }, Le = { class: "text-sm text-muted-foreground" }, Re = { class: "mb-6 flex-1 space-y-2" }, ze = a({
	__name: "PricingTiers",
	setup(a) {
		let { starterName: o, starterPrice: s, starterPeriod: c, starterFeatures: l, proName: f, proPrice: m, proPeriod: g, proFeatures: v, enterpriseName: y, enterprisePrice: b, enterprisePeriod: x, enterpriseFeatures: S, contactSales: C, getStarted: w } = Me("pricing-tiers"), T = t(() => [
			{
				name: o.value,
				price: s.value,
				period: c.value,
		...
		return (t, a) => (d(), n("div", Ne, [(d(!0), n(e, null, p(T.value, (t) => (d(), n("div", {
			key: t.name,
			class: u(["flex flex-col rounded-lg border p-6", t.highlighted ? "border-primary bg-primary/5 ring-1 ring-primary" : "border-border bg-card"])
		}, [
			r("h3", Pe, h(t.name), 1),
			r("div", Fe, [r("span", Ie, h(t.price), 1), r("span", Le, h(t.period), 1)]),
			r("ul", Re, [(d(!0), n(e, null, p(t.features, (e) => (d(), n("li", {
				key: e,
				class: "flex items-center gap-2 text-sm text-muted-foreground"
			}, [a[0] ||= r("span", { class: "text-primary" }, "✓", -1), i(" " + h(e), 1)]))), 128))]),
			r("button", {
				type: "button",
				class: u(["w-full rounded-md px-4 py-2 text-sm font-medium transition-opacity hover:opacity-90", t.highlighted ? "bg-primary text-primary-foreground" : "border border-border text-foreground hover:bg-accent"])
			}, h(t.name === _(y) ? _(C) : _(w)), 3)
		], 2))), 128))]));
	}
});
