...
var y = {
...
}, ee = process.env.INTLAYER_NODE_TYPE_TRANSLATION === "false", k = {
	id: "fallback-plugin",
	canHandle: () => !1,
	transform: (e) => e
}, A = (e, t) => ee ? k : {
	...
	let r = o() ? c(q) : void 0, i = l(r?.locale) ? r.locale : p(r?.locale ?? T.defaultLocale), a = t(() => (n === void 0 ? void 0 : _(n)) ?? i.value), s = h({});
	v([() => _(e), () => a.value], ([e, t]) => {
		s.value = K(e, t);
	}, {
		immediate: !0,
	...
	setup(e, { expose: n }) {
		n();
		let { l: r, n: i, m: a, k: o, h: s, j: c, i: l, g: u, c: d, e: f, d: p, b: m, a: h, f: g } = ne(y), _ = {
			starterName: r,
			starterPrice: i,
			starterPeriod: a,
			starterFeatures: o,
	...
	return n;
}, ae = { class: "grid gap-6 md:grid-cols-3" }, $ = { class: "text-lg font-semibold text-foreground" }, oe = { class: "my-4" }, se = { class: "text-3xl font-bold text-foreground" }, ce = { class: "text-sm text-muted-foreground" }, le = { class: "mb-6 flex-1 space-y-2" };
function ue(t, a, o, s, c, l) {
	return f(), n("div", ae, [(f(!0), n(e, null, m(s.tiers, (t) => (f(), n("div", {
		key: t.name,
		...
		r("h3", $, g(t.name), 1),
		r("div", oe, [r("span", se, g(t.price), 1), r("span", ce, g(t.period), 1)]),
		r("ul", le, [(f(!0), n(e, null, m(t.features, (e) => (f(), n("li", {
			key: e,
...
var de = ie(re, [["render", ue], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/pricing/PricingTiers.vue"]]);
