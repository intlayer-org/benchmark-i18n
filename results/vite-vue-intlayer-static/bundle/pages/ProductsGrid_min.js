...
var te = {
	...
	let { locale: r, selector: i } = pe(t), a = ae(r ?? _.defaultLocale, N(i), n), o = S(e, a);
	...
	let r = a() ? s(ne) : void 0, i = c(r?.locale) ? r.locale : d(r?.locale ?? _.defaultLocale), o = t(() => ({
		selector: void 0,
	...
	return f([]);
}, Te = { class: "grid gap-6 md:grid-cols-2 lg:grid-cols-3" }, Ee = { class: "mb-2 text-lg font-semibold text-foreground" }, De = { class: "mb-4 text-sm text-muted-foreground" }, Oe = { class: "flex items-center justify-between" }, ke = { class: "text-sm font-bold text-primary" }, Ae = {
	type: "button",
	...
	setup(t) {
		let { a: i, b: a } = we(te);
		return (t, o) => (u(), n("div", Te, [(u(!0), n(e, null, f(h(a), (e) => (u(), n("div", {
			key: e.name,
			class: "flex flex-col justify-between rounded-lg border border-border bg-card p-6"
		}, [r("div", null, [r("h3", Ee, p(e.name), 1), r("p", De, p(e.desc), 1)]), r("div", Oe, [r("span", ke, p(e.price), 1), r("button", Ae, p(h(i)), 1)])]))), 128))]));
	}
});
