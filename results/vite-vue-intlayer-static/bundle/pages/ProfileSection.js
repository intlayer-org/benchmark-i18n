import { computed, createElementBlock, createElementVNode, defineComponent, h, inject, isRef, markRaw, openBlock, ref, shallowRef, toDisplayString, toValue, unref, watch } from "vue";
...
var ProfileSection_default = defineComponent({
	...
	setup(__props) {
		const { title, displayNameLabel, emailLabel } = v("profile-section");
		return (_ctx, _cache) => {
