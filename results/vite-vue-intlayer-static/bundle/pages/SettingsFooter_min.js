...
var h = {
	...
	return n;
}, we = { class: "flex justify-end gap-3" }, Te = {
	type: "button",
...
function De(e, r, i, a, o, s) {
	return l(), t("div", we, [n("button", Te, f(a.cancel), 1), n("button", Ee, f(a.saveChanges), 1)]);
}
var Oe = $(Ce, [["render", De], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/settings/SettingsFooter.vue"]]);
