...
function $(t, a, o, s, c, l) {
	return d(), n(e, null, [
		i(s.MockBanner),
		r("h1", Me, p(s.content.settings), 1),
		r("p", Ne, p(s.content.manageYourAccountPreferencesAnd), 1)
	], 64);
}
var Pe = Q(je, [["render", $], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/settings/SettingsHeader.vue"]]);
