...
}), Oe = { class: "mb-2 text-3xl font-bold text-foreground" }, ke = { class: "mb-8 text-muted-foreground" }, Ae = a({
	__name: "SettingsHeader",
	setup(t) {
		let a = $(te);
		return (t, o) => (d(), n(e, null, [
			i(De),
			r("h1", Oe, p(h(a).settings), 1),
			r("p", ke, p(h(a).manageYourAccountPreferencesAnd), 1)
		], 64));
	}
});
