...
function $(t, a, o, s, c, l) {
	return d(), n(e, null, [
		i(s.MockBanner),
		r("h1", ce, p(s.content.settings), 1),
		r("p", le, p(s.content.manageYourAccountPreferencesAnd), 1)
	], 64);
}
var ue = Q(se, [["render", $], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/settings/SettingsHeader.vue"]]);
