...
var _ = {
	...
	return n;
}, te = { class: "grid gap-6 md:grid-cols-2 lg:grid-cols-3" }, ne = { class: "mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-accent text-lg font-bold text-accent-foreground" }, re = { class: "text-base font-semibold text-foreground" }, ie = { class: "mb-2 text-xs font-medium text-primary" }, ae = { class: "text-sm text-muted-foreground" };
function oe(t, i, a, o, s, c) {
	return u(), n("div", te, [(u(!0), n(e, null, f(o.members, (e) => (u(), n("div", {
		key: e.name,
		class: "rounded-lg border border-border bg-card p-6 text-center"
	}, [
		r("div", ne, m(o.getInitials(e.name)), 1),
		r("h3", re, m(e.name), 1),
		r("p", ie, m(e.role), 1),
		r("p", ae, m(e.bio), 1)
	]))), 128))]);
}
var se = ee($, [["render", oe], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/team/TeamGrid.vue"]]);
