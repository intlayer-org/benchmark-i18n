...
}), Me = { class: "mb-2 text-3xl font-bold text-foreground" }, Ne = { class: "mb-10 text-muted-foreground" };
function $(t, a, o, s, c, l) {
	return d(), n(e, null, [
		i(s.MockBanner),
		r("h1", Me, p(s.title), 1),
		r("p", Ne, p(s.description), 1)
	], 64);
}
var Pe = Q(je, [["render", $], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/team/TeamHeader.vue"]]);
