import { Fragment, computed, createElementBlock, createElementVNode, createTextVNode, defineComponent, h, inject, isRef, markRaw, onBeforeMount, onMounted, openBlock, ref, renderList, shallowRef, toDisplayString, toValue, unref, watch } from "vue";
...
var UnderstandingImpact_default = defineComponent({
	...
	setup(__props) {
		...
		const { title, largeJson, dynamicLoading, benchmarkMeasures } = v("understanding-impact");
		return (_ctx, _cache) => {
