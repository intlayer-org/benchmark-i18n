...
import { Fragment as m, computed as h, createElementBlock as g, createElementVNode as _, createTextVNode as v, defineComponent as y, getCurrentInstance as ee, h as b, inject as x, isRef as te, markRaw as S, onBeforeMount as ne, onMounted as re, openBlock as C, ref as w, renderList as T, shallowRef as ie, toDisplayString as E, toValue as D, unref as O, watch as ae } from "vue";
var oe = {
...
}, N = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", P = /\{\{\s*(.*?)\s*\}\}/g, ue = (e, t = {}) => {
...
y({
	...
	setup(e) {
		let t = pe({ components: e.components });
		return () => t(e.content);
	}
});
var me = new Set([
	...
	}, l = (e) => me.has(e) || /^0x[0-9a-fA-F]+$/.test(e) || /^#/.test(e) ? e : /^-?\d+(?:\.\d+)?(?:e[+-]?\d+)?$/i.test(e) ? e === "3.14159265359" ? Math.PI : Number(e) : e, u = (e) => {
	...
	try {
		...
		return r === -1 ? {} : he(t.slice(1, r).join("\n")) ?? {};
	} catch {
		return {};
	}
};
...
G(1), G(2);
var _e = (e) => (t, n = {}) => {
	let r = performance.now(), i = (t, n = {}) => _e(e)(t, n);
	if (Array.isArray(t)) {
...
}, ve = Symbol("intlayerMarkdown"), ye = () => {
	let e = x(ve, { renderMarkdown: (e) => e });
	if (!e) throw Error("useMarkdown must be used within a MarkdownProvider");
	return e;
}, be = process.env.INTLAYER_NODE_TYPE_INTLAYER_NODE === "false", K = !0, xe = !0, Se = !0, q = !0, Ce = be ? t : {
	...
	transform: (e, t, n) => {
		let { plugins: r, ...i } = t, a = n(ge(e) ?? {}, {
			...
			value: e,
			children: () => {
				let { renderMarkdown: t, components: r } = ye(), a = t(e, void 0, {
					...r ?? {},
					...n ?? {}
				});
	...
	return Y.set(i, s), s;
}, ke = (e, t) => se(e, t, Oe(t)), Ae = Symbol("intlayer"), X = (e, t) => t.reduce((e, t) => e?.[t], e), Z = (e) => typeof e == "object" && !!e, Q = (e) => typeof e == "function" || Z(e) && ("render" in e || "setup" in e), je = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, $ = (e) => S(y({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = ee() ? x(Ae) : void 0, i = te(r?.locale) ? r.locale : w(r?.locale ?? e.defaultLocale), a = h(() => (n === void 0 ? void 0 : D(n)) ?? i.value), o = ie({});
	ae([() => D(t), () => a.value], ([e, t]) => {
		o.value = ke(e, t);
	}, {
		immediate: !0,
	...
	let s = (e) => new Proxy({}, {
		get(t, n, r) {
			...
			if (je(c)) return Me(h(() => X(o.value, a)));
			let l = h(() => X(o.value, a));
...
var Fe = { class: "mb-16 mx-auto max-w-3xl space-y-6" }, Ie = { class: "text-2xl font-bold text-foreground" }, Le = { class: "rounded-lg border border-border bg-card p-6" }, Re = { class: "mb-2 text-lg font-semibold text-foreground" }, ze = { class: "text-sm text-muted-foreground" }, Be = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, Ve = { class: "rounded-lg border border-border bg-card p-6" }, He = { class: "mb-2 text-lg font-semibold text-foreground" }, Ue = { class: "text-sm text-muted-foreground" }, We = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, Ge = { class: "text-foreground" }, Ke = { class: "rounded-lg border border-border bg-card p-6" }, qe = { class: "mb-2 text-lg font-semibold text-foreground" }, Je = { class: "text-sm text-muted-foreground" }, Ye = y({
	__name: "UnderstandingImpact",
	setup(e) {
		Pe("UnderstandingImpact");
		let { title: t, largeJson: n, dynamicLoading: r, benchmarkMeasures: i } = Ne(oe);
		return (e, a) => (C(), g("section", Fe, [
			_("h2", Ie, E(O(t)), 1),
			_("div", Le, [
				_("h3", Re, E(O(n).title), 1),
				_("p", ze, E(O(n).description), 1),
				_("ul", Be, [(C(!0), g(m, null, T(O(n).points, (e, t) => (C(), g("li", { key: t }, E(e), 1))), 128))])
			]),
			_("div", Ve, [
				_("h3", He, E(O(r).title), 1),
				_("p", Ue, E(O(r).description), 1),
				_("ul", We, [(C(!0), g(m, null, T(O(r).points, (e, t) => (C(), g("li", { key: t }, [_("strong", Ge, E(e.label), 1), v(" " + E(e.text), 1)]))), 128))])
			]),
			_("div", Ke, [_("h3", qe, E(O(i).title), 1), _("p", Je, E(O(i).description), 1)])
		]));
	}
});
