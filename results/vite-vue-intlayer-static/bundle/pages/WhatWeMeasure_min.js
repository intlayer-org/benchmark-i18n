...
var re = i({
	...
	return n;
}, ae = { class: "mt-12 mx-auto max-w-3xl" }, oe = { class: "mb-4 text-2xl font-bold text-foreground" }, se = { class: "space-y-4" }, ce = { class: "block text-sm font-bold text-primary" }, le = { class: "block mt-1 text-sm text-muted-foreground" };
function ue(t, i, a, o, s, c) {
	return f(), n("section", ae, [r("h2", oe, h(o.title), 1), r("ul", se, [(f(!0), n(e, null, ee(o.metrics, (e) => (f(), n("li", {
		key: e.metric,
		class: "rounded-md border border-border p-4"
	}, [r("span", ce, h(e.metric), 1), r("span", le, h(e.desc), 1)]))), 128))])]);
}
var de = ie(re, [["render", ue], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/about/WhatWeMeasure.vue"]]);
