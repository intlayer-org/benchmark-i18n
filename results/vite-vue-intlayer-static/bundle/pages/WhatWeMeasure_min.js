...
var Oe = { class: "mt-12 mx-auto max-w-3xl" }, ke = { class: "mb-4 text-2xl font-bold text-foreground" }, Ae = { class: "space-y-4" }, je = { class: "block text-sm font-bold text-primary" }, Me = { class: "block mt-1 text-sm text-muted-foreground" }, Ne = i({
	__name: "WhatWeMeasure",
	setup(t) {
		$("WhatWeMeasure");
		let { b: i, a } = De(re);
		return (t, o) => (f(), n("section", Oe, [r("h2", ke, m(g(i)), 1), r("ul", Ae, [(f(!0), n(e, null, ee(g(a), (e) => (f(), n("li", {
			key: e.metric,
			class: "rounded-md border border-border p-4"
		}, [r("span", je, m(e.metric), 1), r("span", Me, m(e.desc), 1)]))), 128))])]));
	}
});
