	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("section", _hoisted_1, [createElementVNode("h2", _hoisted_2, toDisplayString(unref(title)), 1), createElementVNode("div", _hoisted_3, [
				createElementVNode("div", _hoisted_4, [createElementVNode("h3", _hoisted_5, toDisplayString(unref(bundleSize).title), 1), createElementVNode("p", _hoisted_6, toDisplayString(unref(bundleSize).description), 1)]),
				createElementVNode("div", _hoisted_7, [createElementVNode("h3", _hoisted_8, toDisplayString(unref(renderingHydration).title), 1), createElementVNode("p", _hoisted_9, toDisplayString(unref(renderingHydration).description), 1)]),
				createElementVNode("div", _hoisted_10, [createElementVNode("h3", _hoisted_11, toDisplayString(unref(dynamicLoading).title), 1), createElementVNode("p", _hoisted_12, toDisplayString(unref(dynamicLoading).description), 1)])
			])]);
		};
	}
});
