import { computed as e, createElementBlock as t, createElementVNode as n, defineComponent as r, h as i, inject as a, isRef as o, markRaw as s, onBeforeMount as c, onMounted as l, openBlock as u, ref as d, shallowRef as f, toDisplayString as p, toValue as m, unref as h, watch as ee } from "vue";
var g = /* @__PURE__ */ new WeakMap(), _ = 0, te = (e) => {
	if (!e) return "base";
	let t = g.get(e);
	if (t) return t;
	_ += 1;
	let n = `p${_}`;
	return g.set(e, n), n;
}, v = 256, y = /* @__PURE__ */ new WeakMap(), b = (e) => typeof e == "object" && !!e, ne = (e, t, n) => `${e}_${t}_${te(n)}`, re = (e, t) => {
	if (!b(e)) return { hit: !1 };
	let n = y.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, ie = "translation", ae = "object", oe = "array", S = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), C = (e, t) => {
...
}, E = "\x1B[0m", D = "\x1B[34m", O = "\x1B[31m", se = "\x1B[32m", ce = "\x1B[38;5;3m", le = (e) => e, ue = (e, t) => {
...
}), k = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? E : n : E}` : e, fe = (e, t = ce, n = E) => [e].flat().map((e) => k(e, t, n)).join(", ");
k("✗", O), k("✓", se), k("⏲", D);
var pe = {
	"products-grid": {
		key: "products-grid",
	...
	let r = me()[e];
	return r ? be(r, t, n) : (j.has(e) || (de({ log: T })(typeof window > "u" ? `Dictionary ${fe(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), j.add(e)), A(e));
}, M = (e) => {
...
var H = (e) => F, U = F, ve = (e, t = !0) => [
	...
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = ne(r ?? w.defaultLocale, "", n), o = re(e, a);
	...
	return q.set(n, r), r;
}, J = (e, t) => ge(e, t, De(typeof t == "object" && t ? t.locale : t)), Oe = Symbol("intlayer"), Y = (e, t) => t.reduce((e, t) => e?.[t], e), X = (e) => typeof e == "object" && !!e, Z = (e) => typeof e == "function" || X(e) && ("render" in e || "setup" in e), ke = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, Q = (e) => s(r({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = a(Oe), i = o(r?.locale) ? r.locale : d(r?.locale ?? w.defaultLocale), s = e(() => ({
		selector: void 0,
	...
	let u = /* @__PURE__ */ new Map(), p = (t) => {
		...
		let r = e(() => Y(l.value, t)), i = new Proxy({}, {
			get(n, i, a) {
				...
				if (ke(s)) return Ae(e(() => Y(l.value, o)));
...
var Ne = { class: "mb-16" }, Pe = { class: "mb-6 text-2xl font-bold text-foreground" }, Fe = { class: "grid gap-6 md:grid-cols-3" }, Ie = { class: "rounded-lg border border-border bg-card p-6" }, Le = { class: "mb-2 text-lg font-semibold text-foreground" }, Re = { class: "text-sm text-muted-foreground" }, ze = { class: "rounded-lg border border-border bg-card p-6" }, $ = { class: "mb-2 text-lg font-semibold text-foreground" }, Be = { class: "text-sm text-muted-foreground" }, Ve = { class: "rounded-lg border border-border bg-card p-6" }, He = { class: "mb-2 text-lg font-semibold text-foreground" }, Ue = { class: "text-sm text-muted-foreground" }, We = r({
	__name: "WhyItMatters",
	setup(e) {
		Me("WhyItMatters");
		let { title: r, bundleSize: i, renderingHydration: a, dynamicLoading: o } = je("why-it-matters");
		return (e, s) => (u(), t("section", Ne, [n("h2", Pe, p(h(r)), 1), n("div", Fe, [
			n("div", Ie, [n("h3", Le, p(h(i).title), 1), n("p", Re, p(h(i).description), 1)]),
			n("div", ze, [n("h3", $, p(h(a).title), 1), n("p", Be, p(h(a).description), 1)]),
			n("div", Ve, [n("h3", He, p(h(o).title), 1), n("p", Ue, p(h(o).description), 1)])
		])]));
	}
});
