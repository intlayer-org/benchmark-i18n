import { Fragment, computed, createElementBlock, createElementVNode, createTextVNode, defineComponent, h, inject, isRef, markRaw, normalizeClass, openBlock, ref, renderList, shallowRef, toDisplayString, toValue, unref, watch } from "vue";
...
var PricingTiers_default = defineComponent({
	__name: "PricingTiers",
	setup(__props) {
		const { starterName, starterPrice, starterPeriod, starterFeatures, proName, proPrice, proPeriod, proFeatures, enterpriseName, enterprisePrice, enterprisePeriod, enterpriseFeatures, contactSales, getStarted } = v("pricing-tiers");
