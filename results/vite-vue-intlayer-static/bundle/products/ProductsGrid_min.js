...
var g = {
	...
	let r = a() ? s(G) : void 0, i = c(r?.locale) ? r.locale : d(r?.locale ?? S.defaultLocale), o = t(() => (n === void 0 ? void 0 : m(n)) ?? i.value), l = ee({});
	h([() => m(e), () => o.value], ([e, t]) => {
		l.value = W(e, t);
	}, {
		immediate: !0,
	...
	return n;
}, re = { class: "grid gap-6 md:grid-cols-2 lg:grid-cols-3" }, ie = { class: "mb-2 text-lg font-semibold text-foreground" }, ae = { class: "mb-4 text-sm text-muted-foreground" }, oe = { class: "flex items-center justify-between" }, $ = { class: "text-sm font-bold text-primary" }, se = {
	type: "button",
...
function ce(t, i, a, o, s, c) {
	return u(), n("div", re, [(u(!0), n(e, null, f(o.products, (e) => (u(), n("div", {
		key: e.name,
		class: "flex flex-col justify-between rounded-lg border border-border bg-card p-6"
	}, [r("div", null, [r("h3", ie, p(e.name), 1), r("p", ae, p(e.desc), 1)]), r("div", oe, [r("span", $, p(e.price), 1), r("button", se, p(o.learnMore), 1)])]))), 128))]);
}
var le = ne(te, [["render", ce], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/products/ProductsGrid.vue"]]);
