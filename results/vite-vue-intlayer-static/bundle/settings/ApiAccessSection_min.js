...
import { Fragment as m, computed as h, createElementBlock as g, createElementVNode as _, defineComponent as v, getCurrentInstance as y, h as b, inject as x, isRef as ee, markRaw as S, openBlock as C, ref as w, shallowRef as te, toDisplayString as T, toValue as E, watch as ne } from "vue";
var re = {
...
}, N = (e) => e != null && typeof e != "string" && typeof e != "number" && typeof e != "boolean", P = /\{\{\s*(.*?)\s*\}\}/g, ae = (e, t = {}) => {
...
}, oe = Symbol("intlayerHTML"), se = () => x(oe), F = (e, { components: t = {} } = {}) => {
...
var fe = (e) => (t, n = {}) => {
	...
	return J.set(i, s), s;
}, Te = (e, t) => k(e, t, we(t)), Ee = Symbol("intlayer"), Y = (e, t) => t.reduce((e, t) => e?.[t], e), X = (e) => typeof e == "object" && !!e, Z = (e) => typeof e == "function" || X(e) && ("render" in e || "setup" in e), De = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, Q = (e) => S(v({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = y() ? x(Ee) : void 0, i = ee(r?.locale) ? r.locale : w(r?.locale ?? e.defaultLocale), a = h(() => (n === void 0 ? void 0 : E(n)) ?? i.value), o = te({});
	ne([() => E(t), () => a.value], ([e, t]) => {
		o.value = Te(e, t);
	}, {
		immediate: !0,
	...
	let s = (e) => new Proxy({}, {
		get(t, n, r) {
			...
			if (De(c)) return Oe(h(() => Y(o.value, a)));
			let l = h(() => Y(o.value, a));
	...
	return n;
}, Me = { class: "rounded-lg border border-border bg-card p-6" }, $ = { class: "mb-4 text-lg font-semibold text-foreground" }, Ne = {
	for: "apiKey",
	class: "mb-1 block text-sm font-medium text-foreground"
}, Pe = { class: "flex gap-2" }, Fe = {
	type: "button",
...
function Le(e, t, n, r, i, a) {
	return C(), g("section", Me, [_("h2", $, T(r.title), 1), _("div", null, [
		_("label", Ne, T(r.apiKeyLabel), 1),
		_("div", Pe, [t[0] ||= _("input", {
			id: "apiKey",
			readonly: "",
		...
		}, null, -1), _("button", Fe, T(r.copy), 1)]),
		_("p", Ie, T(r.description), 1)
	])]);
}
var Re = je(Ae, [["render", Le], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/settings/ApiAccessSection.vue"]]);
