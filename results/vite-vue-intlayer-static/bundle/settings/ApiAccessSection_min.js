...
import { Fragment as m, computed as h, createElementBlock as g, createElementVNode as _, defineComponent as v, getCurrentInstance as y, h as b, inject as x, isRef as ee, markRaw as S, openBlock as te, ref as C, shallowRef as ne, toDisplayString as w, toValue as T, unref as E, watch as re } from "vue";
var D = {
...
var pe = (e) => (t, n = {}) => {
	...
	transform: (e, t, n) => {
		let { plugins: r, ...i } = t, a = n(fe(e) ?? {}, {
			...
			value: e,
			children: () => {
				let { renderMarkdown: t, components: r } = K(), a = t(e, void 0, {
					...r ?? {},
					...n ?? {}
				});
	...
	return s([]);
}, Ae = { class: "rounded-lg border border-border bg-card p-6" }, je = { class: "mb-4 text-lg font-semibold text-foreground" }, Me = {
	for: "apiKey",
	class: "mb-1 block text-sm font-medium text-foreground"
}, Ne = { class: "flex gap-2" }, Pe = {
	type: "button",
	class: "rounded-md border border-border px-4 py-2 text-sm font-medium text-foreground hover:bg-accent transition-colors"
}, Fe = { class: "mt-1 text-xs text-muted-foreground" }, Ie = v({
	__name: "ApiAccessSection",
	setup(e) {
		let { title: t, apiKeyLabel: n, copy: r, description: i } = ke(D);
		return (e, a) => (te(), g("section", Ae, [_("h2", je, w(E(t)), 1), _("div", null, [
			_("label", Me, w(E(n)), 1),
			_("div", Ne, [a[0] ||= _("input", {
				id: "apiKey",
				readonly: "",
