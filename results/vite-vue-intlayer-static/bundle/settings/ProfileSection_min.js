import { computed as e, createElementBlock as t, createElementVNode as n, defineComponent as r, h as i, inject as a, isRef as o, markRaw as s, openBlock as c, ref as l, shallowRef as ee, toDisplayString as u, toValue as d, unref as f, watch as te } from "vue";
var p = /* @__PURE__ */ new WeakMap(), m = 0, ne = (e) => {
	if (!e) return "base";
	let t = p.get(e);
	if (t) return t;
	m += 1;
	let n = `p${m}`;
	return p.set(e, n), n;
}, h = 256, g = /* @__PURE__ */ new WeakMap(), _ = (e) => typeof e == "object" && !!e, v = (e, t, n) => `${e}_${t}_${ne(n)}`, re = (e, t) => {
	if (!_(e)) return { hit: !1 };
	let n = g.get(e);
	return n?.has(t) ? {
		hit: !0,
...
}, ie = "translation", ae = "object", oe = "array", b = (e, t, n) => ({
	...e,
	children: t,
	keyPath: [...e.keyPath, n]
}), x = (e, t) => {
...
}, C = "\x1B[0m", w = "\x1B[34m", T = "\x1B[31m", E = "\x1B[32m", D = "\x1B[38;5;3m", O = (e) => e, ce = (e, t) => {
...
}), k = (e, t, n) => t && typeof window > "u" ? `${t}${e}${n ? typeof n == "boolean" ? C : n : C}` : e, ue = (e, t = D, n = C) => [e].flat().map((e) => k(e, t, n)).join(", ");
k("✗", T), k("✓", E), k("⏲", w);
var de = {
	"products-grid": {
		key: "products-grid",
	...
	yield e;
} : A(e ? `${e}.${String(n)}` : String(n)) }), j = /* @__PURE__ */ new Set(), me = (e, t, n) => {
	let r = fe()[e];
	return r ? ve(r, t, n) : (j.has(e) || (le({ log: se })(typeof window > "u" ? `Dictionary ${ue(e)} was not found. Using fallback proxy.` : `Dictionary ${e} was not found. Using fallback proxy.`, { level: "warn" }), j.add(e)), A(e));
}, M = (e) => {
...
var H = (e) => F, U = F, ge = (e, t = !0) => [
	...
	B,
	V
].filter((e) => e !== F), _e = (e, t, n = []) => x(e, {
	...t,
	plugins: n
}), W = /* @__PURE__ */ new WeakSet(), ve = (e, t, n) => {
	let { locale: r, selector: i } = {
		locale: t,
		selector: void 0
	}, a = v(r ?? S.defaultLocale, "", n), o = re(e, a);
...
}, G = /* @__PURE__ */ new Map(), ye = (e, t) => Object.create(new Proxy(e, {
	get: (e, t, n) => {
	...
	return Object.assign(o, {
		...
		...n
	}), Object.setPrototypeOf(o, be(e, Function.prototype)), s(o);
}, xe = {
...
}, Se = F, Ce = F, we = F, q = /* @__PURE__ */ new Map(), Te = (e, t = !0) => {
	...
	return q.set(n, r), r;
}, J = (e, t) => me(e, t, Te(typeof t == "object" && t ? t.locale : t)), Y = Symbol("intlayer"), X = (e, t) => t.reduce((e, t) => e?.[t], e), Z = (e) => typeof e == "object" && !!e, Q = (e) => typeof e == "function" || Z(e) && ("render" in e || "setup" in e), Ee = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, $ = (e) => s(r({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	let r = a(Y), i = o(r?.locale) ? r.locale : l(r?.locale ?? S.defaultLocale), s = e(() => ({
		selector: void 0,
		locale: n === void 0 ? void 0 : d(n)
	})), c = e(() => s.value.locale ?? i.value), u = ee({});
	te([
		() => d(t),
		() => c.value,
		() => s.value.selector
	...
	let f = /* @__PURE__ */ new Map(), p = (t) => {
		let n = t.join(".");
		if (f.has(n)) return f.get(n);
		let r = e(() => X(u.value, t)), i = new Proxy({}, {
			get(n, i, a) {
				...
				let o = t.concat(i), s = X(u.value, o);
				if (s === void 0 || Z(s) && !Q(s)) return p(o);
				if (Ee(s)) return De(e(() => X(u.value, o)));
				if (typeof s == "function") {
					let e = X(u.value, t);
					return e != null && !Object.hasOwn(e, i) ? s.bind(e) : (...e) => X(u.value, o)?.(...e);
				}
				let c = e(() => X(u.value, o));
	...
	return p([]);
}, ke = { class: "rounded-lg border border-border bg-card p-6" }, Ae = { class: "mb-4 text-lg font-semibold text-foreground" }, je = { class: "space-y-4" }, Me = {
	for: "displayName",
	...
	setup(e) {
		let { title: r, displayNameLabel: i, emailLabel: a } = Oe("profile-section");
		return (e, o) => (c(), t("section", ke, [n("h2", Ae, u(f(r)), 1), n("div", je, [n("div", null, [n("label", Me, u(f(i)), 1), o[0] ||= n("input", {
			id: "displayName",
		...
		}, null, -1)]), n("div", null, [n("label", Ne, u(f(a)), 1), o[1] ||= n("input", {
			id: "email",
