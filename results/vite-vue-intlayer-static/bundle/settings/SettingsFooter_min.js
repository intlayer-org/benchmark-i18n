...
var h = {
	...
	return J.set(n, r), r;
}, Y = (e, t) => me(e, t, ye(typeof t == "object" && t ? t.locale : t)), X = (e, t) => t.reduce((e, t) => e?.[t], e), Z = (e) => typeof e == "object" && !!e, Q = (e) => typeof e == "function" || Z(e) && ("render" in e || "setup" in e), be = (e) => e != null && (typeof e == "object" || typeof e == "function") && "__update" in e && "render" in e && "raw" in e, $ = (e) => c(r({
	name: "IntlayerLeaf",
	setup() {
		return () => {
			let t = e();
	...
	return p([]);
}, Ce = { class: "flex justify-end gap-3" }, we = {
	type: "button",
	...
	setup(e) {
		let { a: r, b: i } = Se(h);
		return (e, a) => (l(), t("div", Ce, [n("button", we, d(p(r)), 1), n("button", Te, d(p(i)), 1)]));
	}
});
