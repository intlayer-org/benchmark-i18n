...
}), Le = { class: "mb-2 text-3xl font-bold text-foreground" }, Re = { class: "mb-8 text-muted-foreground" };
function ze(e, t, n, r, i, a) {
	return C(), g(m, null, [
		v(r.MockBanner),
		_("h1", Le, T(r.content.settings), 1),
		_("p", Re, T(r.content.manageYourAccountPreferencesAnd), 1)
	], 64);
}
var Be = $(Ie, [["render", ze], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/settings/SettingsHeader.vue"]]);
