...
}), Pe = { class: "mb-2 text-3xl font-bold text-foreground" }, Fe = { class: "mb-8 text-muted-foreground" }, Ie = y({
	__name: "SettingsHeader",
	setup(e) {
		let t = $(ie);
		return (e, n) => (C(), g(m, null, [
			v(Ne),
			_("h1", Pe, T(D(t).settings), 1),
			_("p", Fe, T(D(t).manageYourAccountPreferencesAnd), 1)
		], 64));
	}
});
