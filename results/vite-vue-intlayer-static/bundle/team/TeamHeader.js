...
var team_header_default = {
	...
	content: {
		...
		"translation": {
			...
			"de": {
				"b": "Unser Team",
				"a": "Lernen Sie die Menschen hinter i18n Benchmark kennen. Ein vielfältiges Team, vereint durch die gemeinsame Leidenschaft für großartige Entwickler-Tools."
			},
			"it": {
				"b": "Il nostro team",
				"a": "Incontra le persone dietro i18n Benchmark. Un team diversificato unito da una passione condivisa per gli ottimi strumenti per sviluppatori."
			},
			"pt": {
				"b": "Nossa Equipe",
			...
			"zh": {
				"b": "我们的团队",
				"a": "了解 i18n 基准测试背后的人员。一支多元化的团队，因对出色开发工具的共同热情 an 团结在一起。"
			},
			"ja": {
				"b": "私たちのチーム",
				"a": "i18n ベンチマークを支える人々を紹介します。優れた開発者ツールへの共通の情熱によって結ばれた、多様なチームです。"
			},
			"ko": {
				"b": "우리 팀",
...
var TeamHeader_vue_vue_type_script_setup_true_lang_default = defineComponent({
	...
	setup(__props, { expose: __expose }) {
		__expose();
		const { b: title, a: description } = b(team_header_default);
		const __returned__ = {
			title,
			description,
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock(Fragment, null, [
		...
		createElementVNode("h1", _hoisted_1, toDisplayString($setup.title), 1),
		createElementVNode("p", _hoisted_2, toDisplayString($setup.description), 1)
	], 64);
}
var TeamHeader_default = _plugin_vue_export_helper_default(TeamHeader_vue_vue_type_script_setup_true_lang_default, [["render", _sfc_render], ["__file", "/Users/aymericpineau/Documents/benchmark-bloom/apps-benchmark/vite-vue-static/vue-intlayer-app/src/components/pages/team/TeamHeader.vue"]]);
export { TeamHeader_default as default };
