import { Fragment, computed, createElementBlock, createElementVNode, createVNode, defineComponent, h, inject, isRef, markRaw, openBlock, ref, shallowRef, toDisplayString, toValue, unref, watch } from "vue";
...
var TeamHeader_default = defineComponent({
	__name: "TeamHeader",
	setup(__props) {
		const { title, description } = v("team-header");
		return (_ctx, _cache) => {
