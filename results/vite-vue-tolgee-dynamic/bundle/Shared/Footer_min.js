import { Fragment as e, computed as t, createBlock as n, createElementBlock as r, createElementVNode as i, createTextVNode as a, defineComponent as o, getCurrentInstance as s, h as c, inject as l, onBeforeMount as u, onMounted as d, onUnmounted as f, openBlock as p, ref as m, renderList as h, renderSlot as g, resolveComponent as _, toDisplayString as v, unref as y, watch as b, withCtx as x } from "vue";
import { useRoute as S } from "vue-router";
var ee = Object.defineProperty, C = Object.defineProperties, te = Object.getOwnPropertyDescriptors, w = Object.getOwnPropertySymbols, T = Object.prototype.hasOwnProperty, ne = Object.prototype.propertyIsEnumerable, re = (e, t, n) => t in e ? ee(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, E = (e, t) => {
	for (var n in t ||= {}) T.call(t, n) && re(e, n, t[n]);
	if (w) for (var n of w(t)) ne.call(t, n) && re(e, n, t[n]);
	return e;
}, ie = (e, t) => C(e, te(t)), ae;
function oe(e, t) {
...
var me = () => ({
	...
	let r = pe(n?.headers);
	return r["x-api-key"] && (r = Object.assign(Object.assign({}, me()), r)), e(t, Object.assign(Object.assign({}, n), { headers: r }));
}, ge = (e) => {
...
}, N = (e) => Object.fromEntries(ge(e).entries()), P = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function Ee(e, t) {
	let n = R(Te, t?.initialOptions, e);
	return n.apiUrl = ue(n.apiUrl), e?.fetch && (n.fetch = he(e.fetch)), {
		initialOptions: n,
...
function De(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return k(s.onError, (e) => new xe("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
		if (!l.languageDetector) return;
		let e = n();
		return k(s.onError, (e) => new be("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function C(e) {
		e && l.backends.push(e);
	}
	...
	let T = Object.freeze({
		...
		setStoredLanguage(e) {
			return k(s.onError, (e) => new xe("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = de(e) || L, r = t().onFormatError, a = typeof r;
...
function ke(e, t, n) {
	let r = Ee(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? M([t, ...le(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
		...
		overrideCredentials(e) {
			i = e ? Object.assign(Object.assign({}, e), { apiUrl: ue(e.apiUrl) }) : void 0;
		}
	});
	return a;
}
...
var z = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, Ae(r)), n)), n;
};
function je({ options: e }) {
	let t = ve(), n = Oe(!1, () => o.isFetching(), t.onFetchingChange.emit), r = Oe(!1, () => S.isLoading(), t.onLoadingChange.emit), i = ke(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = De(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = Se(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Ne = () => {
	let e = {
		...
		init(t) {
			let n = Me(R(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, B = 0, V = 1, Pe = 2, Fe = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === B ? r = "Empty parameter" : e === V ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Ie(e) {
	return /\s/.test(e);
}
var H = 0, U = 1, W = 2, G = 3, K = 4, Le = /* @__PURE__ */ new Set([
	W,
	U,
	H
]), q = "'", Re = /* @__PURE__ */ new Set([
	"{",
	"}",
	q
]), ze = (e) => /[0-9a-zA-Z_]/.test(e);
function Be(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case H:
			...
			break;
		case U:
			Re.has(i) ? (n = n.slice(0, -1) + i, t = W) : (n += i, t = H);
			break;
		case W:
			i === q ? t = H : (n += i, t = W);
			break;
		case G:
			i === "}" ? (d(), t = H) : Ie(i) ? r !== "" && (d(), t = K) : (u(), t = G);
			break;
		case K: i == "}" ? t = H : Ie(i) ? t = K : c(V);
	}
	return Le.has(t) || c(Pe), l(), [a, o];
}
function Ve(e, t) {
	let [n, r] = Be(e), i = [n[0]];
...
function He() {
	return { format: ({ translation: e, params: t }) => Ve(e, t) };
}
var Ue = () => (e, t) => (t.setFinalFormatter(He()), e);
function We() {
...
})(typeof window < "u" ? window : Ge);
var qe = oe({
	__proto__: null,
	default: Ke
}, [Ke]);
(ae = console.assert) == null || ae.call(console, qe), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Je(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
var Xe = 2, Ze = 35e3, Qe = "TOLGEE_API_REQUEST", $e = "TOLGEE_API_RESPONSE", et = "TOLGEE_PROXY_PING", tt = "TOLGEE_PROXY_PONG";
function nt(e) {
...
}, rt = 3e3, it = 200, at = 0, X = /* @__PURE__ */ new Map(), ot = !1, Z, Q;
async function st({ type: e, replyType: t, payload: n, timeoutMs: r = Ze, progressType: i, onProgress: a }) {
	ut();
	let o = Date.now() + r;
	await dt(Math.min(o, Date.now() + rt));
	let s = o - Date.now();
	if (s <= 0) throw ct(e);
	let c = lt();
	return new Promise((r, o) => {
		let l = setTimeout(() => {
			X.delete(c), ft(), o(ct(e));
		}, s);
		X.set(c, {
			replyType: t,
			progressType: i,
...
var ct = (e) => new Y("unavailable", `the Tolgee browser extension did not answer ${e} in time`), lt = () => `${Date.now()}-${at++}-${Math.random()}`;
function ut() {
	ot || (ot = !0, window.addEventListener("message", (e) => {
		var t;
...
function dt(e) {
	return Z ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: et }, window.origin), i = () => {
			clearInterval(a), ft(), Q = void 0, n(new Y("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var vt = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
function yt(e) {
	let t = vt.indexOf(e);
...
function xt(e) {
	...
	for (let o = 0; o < t; o++) r = r << 5 | yt(e[o]), n += 5, n >= 8 && (a[i++] = r >>> n - 8 & 255, n -= 8);
	return bt(a.buffer);
}
function St(e) {
	if (e) try {
...
function Dt({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var $ = "__tolgee_", kt = `${$}apiKey`, At = `${$}apiUrl`, jt = `${$}branch`, Mt = `${$}projectId`, Nt = `${$}session`, Pt = "tolgee-in-context-tools.umd.min.js", Ft = "@tolgee/in-context-tools", It = "InContextTools", Lt = "https://cdn.jsdelivr.net/npm", Rt = null;
function zt(e) {
	return Rt ||= Wt(Bt(e)).then(() => window[Ft][It]), Rt;
}
function Bt(e) {
	return Vt() || `${Lt}/@tolgee/web@${e}/dist/${Pt}`;
}
function Vt() {
	if (We()) return;
	let e = window.__TOLGEE_IN_CONTEXT_URL__;
	return Ut(e, window.location) ? e : void 0;
}
var Ht = (e) => e === "localhost" || e === "127.0.0.1" || e === "::1" || e === "[::1]";
function Ut(e, t) {
	if (!e || !Ht(t.hostname)) return !1;
	try {
		let n = new URL(e, t.href);
		return n.origin === t.origin || Ht(n.hostname);
	} catch {
		return !1;
	}
}
...
function Gt() {
	let e = sessionStorage.getItem(kt) || void 0, t = sessionStorage.getItem(At) || void 0, n = sessionStorage.getItem(jt) || void 0, r = sessionStorage.getItem(Mt) || void 0, i = nt(sessionStorage.getItem(Nt));
	if (!t) return;
	let a = E(E({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return ie(E({}, a), { apiKey: e });
	if (i && r) return ie(E({}, a), { transport: pt() });
}
function Kt() {
	let e = [];
...
function qt(e) {
	if (!e.isDev()) return;
	let { requiresExplicitProject: t, projectId: n } = wt(e.getInitialOptions());
...
var Zt = (e) => {
	let n = ce(e), r = l("tolgeeContext"), i = t(() => r.value.tolgee);
	if (!i.value) throw Error("Tolgee instance not provided");
	let a = m(c()), o = i.value.on("update", () => {
		a.value = c(), s.value = !i.value.isLoaded(n);
	});
	i.value.addActiveNs(n), f(() => {
		o?.unsubscribe(), i.value.removeActiveNs(n);
	});
	let s = m(!i.value.isLoaded(n));
	function c() {
		return (e) => {
			let t = e.ns ?? n?.[0];
...
var Qt = (e) => {
	...
	if (e.provide("tolgeeContext", i), r) {
		...
		i.value.tolgee = t(), b(() => i.value.isInitialRender, (t) => {
			t || (i.value.tolgee = e());
		});
	}
...
var nn = window.location.pathname.split("/")[1] ?? "", rn = Xt().use(Ue()).init({
	language: tn(nn) ? nn : "en",
	staticData: {
...
var on = { class: "mt-20 border-t border-border bg-card" }, sn = { class: "container py-8" }, cn = { class: "grid gap-8 md:grid-cols-3" }, ln = { class: "mb-2 text-sm font-semibold text-foreground" }, un = { class: "text-sm text-muted-foreground" }, dn = { class: "mb-2 text-sm font-semibold text-foreground" }, fn = { class: "space-y-1" }, pn = ["href"], mn = { class: "mb-2 text-sm font-semibold text-foreground" }, hn = { class: "text-sm text-muted-foreground" }, gn = { class: "mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground" }, _n = o({
	__name: "Footer",
	setup(o) {
		let { t: s } = an(), c = S(), l = t(() => c.params.locale || "en"), u = t(() => [
			{
		...
		return (t, o) => {
			let c = _("router-link");
			return p(), r("footer", on, [i("div", sn, [i("div", cn, [
				i("div", null, [i("h3", ln, v(y(s)("footer.title")), 1), i("p", un, v(y(s)("footer.description")), 1)]),
				i("div", null, [i("h3", dn, v(y(s)("footer.resources")), 1), i("ul", fn, [(p(!0), r(e, null, h(u.value, (e) => (p(), r("li", { key: e.label }, [e.isInternal ? (p(), n(c, {
					key: 0,
					to: e.to,
					class: "text-sm text-muted-foreground hover:text-foreground transition-colors"
				}, {
					default: x(() => [a(v(e.label), 1)]),
					_: 2
				}, 1032, ["to"])) : (p(), r("a", {
					key: 1,
					href: e.href,
				...
				i("div", null, [i("h3", mn, v(y(s)("footer.contact")), 1), i("p", hn, v(y(s)("shared.contactEmail")), 1)])
			]), i("div", gn, v(y(s)("footer.builtWith")), 1)])]);
		};
	}
}), vn = o({
	__name: "Wrapper",
	setup(e) {
		...
		return t && !t.config.globalProperties.$t && t.use($t, { tolgee: rn }), (e, t) => g(e.$slots, "default");
	}
}), yn = { render() {
	return c(vn, {}, { default: () => c(_n) });
} };
