...
var mn = { class: "mt-20 border-t border-border bg-card" }, hn = { class: "container py-8" }, gn = { class: "grid gap-8 md:grid-cols-3" }, _n = { class: "mb-2 text-sm font-semibold text-foreground" }, vn = { class: "text-sm text-muted-foreground" }, yn = { class: "mb-2 text-sm font-semibold text-foreground" }, bn = { class: "space-y-1" }, xn = ["href"], Sn = { class: "mb-2 text-sm font-semibold text-foreground" }, Cn = { class: "text-sm text-muted-foreground" }, wn = { class: "mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground" }, Tn = c({
	__name: "Footer",
	setup(r) {
		let { t: s } = dn(), c = T(), l = t(() => c.params.locale || "en"), u = t(() => [
			{
		...
		return (t, r) => {
			let c = b("router-link");
			return g(), i("footer", mn, [a("div", hn, [a("div", gn, [
				a("div", null, [a("h3", _n, x(S(s)("footer.title")), 1), a("p", vn, x(S(s)("footer.description")), 1)]),
				a("div", null, [a("h3", yn, x(S(s)("footer.resources")), 1), a("ul", bn, [(g(!0), i(e, null, v(u.value, (e) => (g(), i("li", { key: e.label }, [e.isInternal ? (g(), n(c, {
					key: 0,
					to: e.to,
				...
				a("div", null, [a("h3", Sn, x(S(s)("footer.contact")), 1), a("p", Cn, x(S(s)("shared.contactEmail")), 1)])
			]), a("div", wn, x(S(s)("footer.builtWith")), 1)])]);
		};
	}
});
function En(e) {
...
var Dn = { class: "flex items-center gap-2" }, On = ["value"], kn = ["value"], An = c({
	...
	setup(n) {
		...
		return (t, n) => (g(), i("div", Dn, [a("select", {
			value: s.value,
			...
			key: e,
			value: e
		}, x(S(cn)(e)), 9, kn))), 128))], 40, On)]));
	}
}), jn = ["aria-label", "title"], Mn = c({
	__name: "ThemeToggle",
	setup(e) {
		let { t } = dn(), n = _("auto");
		function r() {
		...
		}, x(n.value === "auto" ? S(t)("themeToggle.auto") : n.value === "dark" ? S(t)("themeToggle.dark") : S(t)("themeToggle.light")), 9, jn));
	}
}), Nn = { class: "sticky top-0 z-50 border-b border-border bg-card/80 backdrop-blur-lg" }, Pn = { class: "container flex h-16 items-center justify-between" }, Fn = { class: "flex items-center gap-8" }, In = { class: "hidden items-center gap-6 text-sm font-medium md:flex" }, Ln = ["href", "onClick"], Rn = ["href", "onClick"], zn = { class: "relative" }, Bn = { class: "bg-card border border-border rounded-md shadow-lg overflow-hidden py-1" }, Vn = { class: "flex items-center gap-4" }, Hn = {
	href: "https://github.com/intlayer-org/benchmark-i18n",
	target: "_blank",
	rel: "noreferrer",
	class: "text-muted-foreground transition hover:text-foreground"
}, Un = { class: "sr-only" }, Wn = c({
	__name: "Header",
	setup(c) {
		En("Header");
		...
		return (t, c) => {
			let d = b("router-link");
			return g(), i("header", Nn, [a("nav", Pn, [a("div", Fn, [s(d, {
				to: `/${p.value}`,
				...
				s(d, {
					...
					default: w(({ href: e, navigate: t, isActive: n }) => [a("a", {
						...
						class: f(["nav-link", { "router-link-active": n }]),
						onClick: t
					}, x(S(l)("header.methodology")), 11, Rn)]),
					_: 1
				}, 8, ["to"]),
				a("div", zn, [a("button", {
					type: "button",
				...
				}, [a("div", Bn, [(g(!0), i(e, null, v(m.value, (e) => (g(), n(d, {
					key: e.to,
					to: e.to,
				...
				a("a", Hn, [a("span", Un, x(S(l)("shared.goToGithub")), 1), c[6] ||= a("svg", {
					viewBox: "0 0 16 16",
					"aria-hidden": "true",
					width: "20",
					height: "20"
	...
	setup(t) {
		...
		return p(() => {
			...
			fn(), pn("AppRoot", r.value);
		}), C(() => n.params.locale, (e) => {
			e && (document.documentElement.lang = e, un.changeLanguage(e));
		}, { immediate: !0 }), (t, n) => {
			let r = b("router-view");
			return g(), i(e, null, [
				s(Wn),
