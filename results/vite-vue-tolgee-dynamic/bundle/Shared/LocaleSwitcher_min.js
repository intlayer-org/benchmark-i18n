...
var S = (e) => {
...
}, ee = { class: "flex items-center gap-2" }, te = ["value"], ne = ["value"], re = i({
	...
	setup(i) {
		...
		return (t, i) => (d(), n("div", ee, [r("select", {
			value: s.value,
			...
			key: e,
			value: e
		}, h(g(S)(e)), 9, ne))), 128))], 40, te)]));
	}
}), C = Object.defineProperty, ie = Object.defineProperties, ae = Object.getOwnPropertyDescriptors, oe = Object.getOwnPropertySymbols, se = Object.prototype.hasOwnProperty, ce = Object.prototype.propertyIsEnumerable, w = (e, t, n) => t in e ? C(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, T = (e, t) => {
	for (var n in t ||= {}) se.call(t, n) && w(e, n, t[n]);
	if (oe) for (var n of oe(t)) ce.call(t, n) && w(e, n, t[n]);
	return e;
}, le = (e, t) => ie(e, ae(t)), ue;
function de(e, t) {
...
var ye = () => ({
	...
	let r = ve(n?.headers);
	return r["x-api-key"] && (r = Object.assign(Object.assign({}, ye()), r)), e(t, Object.assign(Object.assign({}, n), { headers: r }));
}, M = (e) => {
...
function Ae(e, t) {
	let n = R(ke, t?.initialOptions, e);
	return n.apiUrl = he(n.apiUrl), e?.fetch && (n.fetch = be(e.fetch)), {
		initialOptions: n,
...
function je(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return O(s.onError, (e) => new Te("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
		if (!l.languageDetector) return;
		let e = n();
		return O(s.onError, (e) => new we("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let C = Object.freeze({
		...
		setStoredLanguage(e) {
			return O(s.onError, (e) => new Te("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = ge(e) || L, r = t().onFormatError, a = typeof r;
...
function Ne(e, t, n) {
	let r = Ae(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? j([t, ...me(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
		...
		overrideCredentials(e) {
			i = e ? Object.assign(Object.assign({}, e), { apiUrl: he(e.apiUrl) }) : void 0;
		}
	});
	return a;
}
...
var Le = () => {
	let e = {
		...
		init(t) {
			let n = Ie(R(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, Re = 0, B = 1, ze = 2, Be = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Re ? r = "Empty parameter" : e === B ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Ve(e) {
	return /\s/.test(e);
}
var V = 0, H = 1, U = 2, W = 3, G = 4, He = /* @__PURE__ */ new Set([
	U,
	H,
	V
]), K = "'", Ue = /* @__PURE__ */ new Set([
	"{",
	"}",
	K
...
function Ge(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case V:
			...
			break;
		case H:
			Ue.has(i) ? (n = n.slice(0, -1) + i, t = U) : (n += i, t = V);
			break;
		case U:
			i === K ? t = V : (n += i, t = U);
			break;
		case W:
			i === "}" ? (d(), t = V) : Ve(i) ? r !== "" && (d(), t = G) : (u(), t = W);
			break;
		case G: i == "}" ? t = V : Ve(i) ? t = G : c(B);
	}
...
var Xe = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, q = {};
(function(e) {
	function t(e, t) {
...
}, st = 3e3, ct = 200, lt = 0, X = /* @__PURE__ */ new Map(), ut = !1, Z, Q;
async function dt({ type: e, replyType: t, payload: n, timeoutMs: r = tt, progressType: i, onProgress: a }) {
	mt();
	let o = Date.now() + r;
	await ht(Math.min(o, Date.now() + st));
	let s = o - Date.now();
	if (s <= 0) throw ft(e);
	let c = pt();
	return new Promise((r, o) => {
		let l = setTimeout(() => {
			X.delete(c), gt(), o(ft(e));
		}, s);
		X.set(c, {
			replyType: t,
			progressType: i,
...
var ft = (e) => new Y("unavailable", `the Tolgee browser extension did not answer ${e} in time`), pt = () => `${Date.now()}-${lt++}-${Math.random()}`;
function mt() {
	ut || (ut = !0, window.addEventListener("message", (e) => {
		var t;
...
function ht(e) {
	return Z ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: it }, window.origin), i = () => {
			clearInterval(a), gt(), Q = void 0, n(new Y("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
function jt({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var $ = "__tolgee_", Nt = `${$}apiKey`, Pt = `${$}apiUrl`, Ft = `${$}branch`, It = `${$}projectId`, Lt = `${$}session`, Rt = "tolgee-in-context-tools.umd.min.js", zt = "@tolgee/in-context-tools", Bt = "InContextTools", Vt = "https://cdn.jsdelivr.net/npm", Ht = null;
function Ut(e) {
	return Ht ||= Jt(Wt(e)).then(() => window[zt][Bt]), Ht;
}
function Wt(e) {
	return Gt() || `${Vt}/@tolgee/web@${e}/dist/${Rt}`;
}
function Gt() {
	if (Ye()) return;
	let e = window.__TOLGEE_IN_CONTEXT_URL__;
	return qt(e, window.location) ? e : void 0;
}
...
function Yt() {
	let e = sessionStorage.getItem(Nt) || void 0, t = sessionStorage.getItem(Pt) || void 0, n = sessionStorage.getItem(Ft) || void 0, r = sessionStorage.getItem(It) || void 0, i = ot(sessionStorage.getItem(Lt));
	if (!t) return;
	let a = T(T({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return le(T({}, a), { apiKey: e });
	if (i && r) return le(T({}, a), { transport: _t() });
}
function Xt() {
	let e = [];
...
function Zt(e) {
	if (!e.isDev()) return;
	let { requiresExplicitProject: t, projectId: n } = Ot(e.getInitialOptions());
...
var tn = (e) => {
	let n = pe(e), r = s("tolgeeContext"), i = t(() => r.value.tolgee);
...
var nn = { install(e, t) {
...
} }, rn = window.location.pathname.split("/")[1] ?? "", an = en().use(Je()).init({
	language: x(rn) ? rn : "en",
	staticData: {
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$t && t.use(nn, { tolgee: an }), (e, t) => m(e.$slots, "default");
	}
}), sn = { render() {
	return o(on, {}, { default: () => o(re) });
} };
