...
var Zt = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, Qt = n({
	__name: "MockBanner",
	setup(e) {
		let { t: n } = Xt();
		return (e, r) => (l(), t("div", Zt, f(p(n)("mockBanner")), 1));
	}
}), $t = n({
	__name: "Wrapper",
	setup(e) {
