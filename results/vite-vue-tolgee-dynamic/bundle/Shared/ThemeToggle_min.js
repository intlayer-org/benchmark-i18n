import { computed as e, createElementBlock as t, defineComponent as n, getCurrentInstance as r, h as i, inject as a, onBeforeMount as o, onMounted as s, onUnmounted as c, openBlock as l, ref as u, renderSlot as d, toDisplayString as f, unref as p, watch as m } from "vue";
...
var Wt = (t) => {
	...
	if (e.provide("tolgeeContext", i), r) {
		...
		i.value.tolgee = t(), m(() => i.value.isInitialRender, (t) => {
			t || (i.value.tolgee = e());
		});
	}
...
var Jt = window.location.pathname.split("/")[1] ?? "", Yt = Ht().use(Fe()).init({
	language: qt(Jt) ? Jt : "en",
	staticData: {
...
var Zt = ["aria-label", "title"], Qt = n({
	...
	setup(e) {
		...
		let h = () => r.value === "auto" ? n("themeToggle.labelAuto") : n("themeToggle.labelOther", { mode: r.value });
		return (e, i) => (l(), t("button", {
			type: "button",
			onClick: d,
			"aria-label": h(),
			title: h(),
		...
		}, f(r.value === "auto" ? p(n)("themeToggle.auto") : r.value === "dark" ? p(n)("themeToggle.dark") : p(n)("themeToggle.light")), 9, Zt));
	}
}), $t = n({
	__name: "Wrapper",
	setup(e) {
		let t = r()?.appContext.app;
		return t && !t.config.globalProperties.$t && t.use(Gt, { tolgee: Yt }), (e, t) => d(e.$slots, "default");
	}
}), en = { render() {
	return i($t, {}, { default: () => i(Qt) });
} };
