...
var tn = { class: "mt-12 mx-auto max-w-3xl" }, nn = { class: "mb-4 text-2xl font-bold text-foreground" }, rn = { class: "space-y-4" }, an = { class: "block text-sm font-bold text-primary" }, on = { class: "block mt-1 text-sm text-muted-foreground" }, sn = i({
	...
	setup(i) {
		...
		return (t, i) => (d(), n("section", tn, [r("h2", nn, h(g(a)("about.whatWeMeasure.title")), 1), r("ul", rn, [(d(!0), n(e, null, p(o.value, (e) => (d(), n("li", {
			key: e.metric,
			class: "rounded-md border border-border p-4"
		}, [r("span", an, h(e.metric), 1), r("span", on, h(e.desc), 1)]))), 128))])]));
	}
}), cn = i({
	__name: "Wrapper",
	setup(e) {
