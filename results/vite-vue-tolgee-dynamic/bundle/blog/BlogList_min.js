...
var en = { class: "grid gap-6 md:grid-cols-2" }, tn = { class: "mb-3 flex items-center gap-3" }, nn = { class: "rounded-full bg-accent px-3 py-0.5 text-xs font-medium text-accent-foreground" }, rn = { class: "text-xs text-muted-foreground" }, an = { class: "mb-2 text-lg font-semibold text-foreground" }, on = { class: "mb-4 text-sm text-muted-foreground" }, sn = {
	type: "button",
	...
	setup(i) {
		...
		return (t, i) => (d(), n("div", en, [(d(!0), n(e, null, p(s.value, (e) => (d(), n("article", {
			key: e.title,
			class: "rounded-lg border border-border bg-card p-6"
		}, [
			r("div", tn, [r("span", nn, h(e.category), 1), r("span", rn, h(e.date), 1)]),
			r("h2", an, h(e.title), 1),
			r("p", on, h(e.excerpt), 1),
			r("button", sn, h(g(a)("blog.list.readMore")), 1)
		]))), 128))]));
	}
}), ln = i({
	__name: "Wrapper",
