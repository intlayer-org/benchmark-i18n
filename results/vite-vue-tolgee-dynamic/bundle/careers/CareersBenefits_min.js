...
var en = { class: "mb-12 grid gap-4 md:grid-cols-3" }, tn = { class: "text-sm font-semibold text-foreground" }, nn = { class: "text-xs text-muted-foreground" }, rn = i({
	...
	setup(t) {
		...
		return (t, o) => (d(), n("div", en, [(d(), n(e, null, p(a, (e) => r("div", {
			key: e.labelKey,
			class: "rounded-lg border border-border bg-card p-4 text-center"
		}, [r("p", tn, h(g(i)(e.labelKey)), 1), r("p", nn, h(g(i)(e.valueKey)), 1)])), 64))]));
	}
}), an = i({
	__name: "Wrapper",
	setup(e) {
