...
var tn = { class: "grid gap-4 md:grid-cols-2" }, nn = {
	for: "name",
	...
	setup(t) {
		...
		return (t, o) => (d(), n("form", {
			...
			r("div", tn, [r("div", null, [r("label", nn, h(g(i)("contact.form.name")), 1), r("input", {
				id: "name",
			...
			}, null, 8, rn)]), r("div", null, [r("label", an, h(g(i)("contact.form.email")), 1), r("input", {
				id: "email",
				type: "email",
				class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: g(i)("contact.form.emailPlaceholder")
			}, null, 8, on)])]),
			r("div", null, [r("label", sn, h(g(i)("contact.form.topic")), 1), r("select", cn, [(d(), n(e, null, p(a, (e) => r("option", {
				key: e,
				value: e
			}, h(g(i)(`contact.form.${e}`)), 9, ln)), 64))])]),
			r("div", null, [r("label", un, h(g(i)("contact.form.message")), 1), r("textarea", {
				id: "message",
				rows: "5",
				class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: g(i)("contact.form.messagePlaceholder")
			}, null, 8, dn)]),
			r("button", fn, h(g(i)("contact.form.sendMessage")), 1)
		], 32));
	}
}), mn = i({
	__name: "Wrapper",
	setup(e) {
		...
		return t && !t.config.globalProperties.$t && t.use(Yt, { tolgee: $t }), (e, t) => m(e.$slots, "default");
	}
}), hn = { render() {
	return o(mn, {}, { default: () => o(pn) });
} };
