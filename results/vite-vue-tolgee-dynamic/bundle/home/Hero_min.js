...
var $t = { class: "mb-16 text-center" }, en = { class: "mb-4 text-4xl font-bold tracking-tight text-foreground" }, tn = { class: "mx-auto max-w-2xl text-lg text-muted-foreground" }, nn = { class: "mt-8 flex justify-center gap-4" }, rn = {
	type: "button",
	...
	setup(e) {
		Qt("Hero");
		let { t: r } = Zt();
		return (e, i) => (u(), t("section", $t, [
			n("h1", en, p(m(r)("home.hero.title")), 1),
			n("p", tn, p(m(r)("home.hero.description")), 1),
			n("div", nn, [n("button", rn, p(m(r)("home.hero.viewResults")), 1), n("button", an, p(m(r)("home.hero.methodology")), 1)])
		]));
	}
}), sn = r({
	__name: "Wrapper",
