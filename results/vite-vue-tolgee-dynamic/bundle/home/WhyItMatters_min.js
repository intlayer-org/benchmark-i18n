...
var $t = { class: "mb-16" }, en = { class: "mb-6 text-2xl font-bold text-foreground" }, tn = { class: "grid gap-6 md:grid-cols-3" }, nn = { class: "rounded-lg border border-border bg-card p-6" }, rn = { class: "mb-2 text-lg font-semibold text-foreground" }, an = { class: "text-sm text-muted-foreground" }, on = { class: "rounded-lg border border-border bg-card p-6" }, sn = { class: "mb-2 text-lg font-semibold text-foreground" }, cn = { class: "text-sm text-muted-foreground" }, ln = { class: "rounded-lg border border-border bg-card p-6" }, un = { class: "mb-2 text-lg font-semibold text-foreground" }, dn = { class: "text-sm text-muted-foreground" }, fn = r({
	__name: "WhyItMatters",
	setup(e) {
		Qt("WhyItMatters");
		let { t: r } = Zt();
		return (e, i) => (u(), t("section", $t, [n("h2", en, p(m(r)("home.whyItMatters.title")), 1), n("div", tn, [
			n("div", nn, [n("h3", rn, p(m(r)("home.whyItMatters.bundleSizeTitle")), 1), n("p", an, p(m(r)("home.whyItMatters.bundleSizeDesc")), 1)]),
			n("div", on, [n("h3", sn, p(m(r)("home.whyItMatters.renderingTitle")), 1), n("p", cn, p(m(r)("home.whyItMatters.renderingDesc")), 1)]),
			n("div", ln, [n("h3", un, p(m(r)("home.whyItMatters.dynamicLoadingTitle")), 1), n("p", dn, p(m(r)("home.whyItMatters.dynamicLoadingDesc")), 1)])
		])]));
	}
}), pn = r({
	__name: "Wrapper",
