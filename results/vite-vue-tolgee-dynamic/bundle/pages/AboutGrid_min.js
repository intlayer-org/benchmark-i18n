...
var $t = { class: "grid gap-8 md:grid-cols-2" }, en = { class: "rounded-lg border border-border bg-card p-6" }, tn = { class: "mb-3 text-xl font-semibold text-foreground" }, nn = { class: "text-sm text-muted-foreground" }, rn = { class: "rounded-lg border border-border bg-card p-6" }, an = { class: "mb-3 text-xl font-semibold text-foreground" }, on = { class: "text-sm text-muted-foreground" }, sn = r({
	__name: "AboutGrid",
	setup(e) {
		Qt("AboutGrid");
		let { t: r } = Zt();
		return (e, i) => (u(), t("div", $t, [n("div", en, [n("h2", tn, p(m(r)("about.grid.whyExistsTitle")), 1), n("p", nn, p(m(r)("about.grid.whyExistsDesc")), 1)]), n("div", rn, [n("h2", an, p(m(r)("about.grid.methodologyTitle")), 1), n("p", on, p(m(r)("about.grid.methodologyDesc")), 1)])]));
	}
}), cn = r({
	__name: "Wrapper",
	setup(e) {
