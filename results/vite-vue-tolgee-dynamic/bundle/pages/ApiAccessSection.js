import { computed, createElementBlock, createElementVNode, defineComponent, getCurrentInstance, h, inject, onBeforeMount, onMounted, onUnmounted, openBlock, ref, renderSlot, toDisplayString, unref, watch } from "vue";
...
var ApiAccessSection_default = defineComponent({
	...
	setup(__props) {
		const { t } = useT();
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("section", _hoisted_1, [createElementVNode("h2", _hoisted_2, toDisplayString(unref(t)("settings.apiAccess.title")), 1), createElementVNode("div", null, [
				createElementVNode("label", _hoisted_3, toDisplayString(unref(t)("settings.apiAccess.apiKey")), 1),
				...
				}, null, -1)), createElementVNode("button", _hoisted_5, toDisplayString(unref(t)("settings.apiAccess.copy")), 1)]),
				createElementVNode("p", _hoisted_6, toDisplayString(unref(t)("settings.apiAccess.description")), 1)
			])]);
		};
	}
});
