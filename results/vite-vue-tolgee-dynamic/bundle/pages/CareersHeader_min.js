...
}), nn = { class: "mb-2 text-3xl font-bold text-foreground" }, rn = { class: "mb-4 text-muted-foreground" }, an = a({
	__name: "CareersHeader",
	setup(t) {
		let { t: a } = $t();
		return (t, o) => (f(), n(e, null, [
			i(tn),
			r("h1", nn, h(g(a)("careers.header.title")), 1),
			r("p", rn, h(g(a)("careers.header.description")), 1)
		], 64));
	}
}), on = a({
	__name: "Wrapper",
