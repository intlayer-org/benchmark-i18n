import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, createTextVNode as i, createVNode as a, defineComponent as o, getCurrentInstance as s, h as c, inject as l, onBeforeMount as u, onMounted as d, onUnmounted as f, openBlock as p, ref as m, renderSlot as h, toDisplayString as g, unref as _, watch as v } from "vue";
...
var qt = (e) => {
	let n = A(e), r = l("tolgeeContext"), i = t(() => r.value.tolgee);
...
var Qt = window.location.pathname.split("/")[1] ?? "", $t = Kt().use(Be()).init({
	language: Zt(Qt) ? Qt : "en",
	staticData: {
...
var tn = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, nn = o({
	__name: "MockBanner",
	setup(e) {
		let { t } = en();
		return (e, r) => (p(), n("div", tn, g(_(t)("mockBanner")), 1));
	}
}), rn = { class: "mb-2 text-3xl font-bold text-foreground" }, an = { class: "mb-8 text-muted-foreground" }, on = {
	...
	setup(t) {
		let { t: o } = en();
		return (t, s) => (p(), n(e, null, [
			a(nn),
			r("h1", rn, g(_(o)("contact.header.title")), 1),
			r("p", an, [
				i(g(_(o)("contact.header.description")) + " ", 1),
				r("a", on, g(_(o)("shared.contactEmail")), 1),
				s[0] ||= i(". ", -1)
			])
		], 64));
	}
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$t && t.use(Yt, { tolgee: $t }), (e, t) => h(e.$slots, "default");
	}
}), ln = { render() {
	return c(cn, {}, { default: () => c(sn) });
} };
