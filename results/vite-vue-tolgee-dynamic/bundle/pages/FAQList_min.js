...
var en = { class: "mx-auto max-w-3xl space-y-4" }, tn = { class: "cursor-pointer px-6 py-4 text-sm font-medium text-foreground hover:bg-accent/50 transition-colors" }, nn = { class: "px-6 pb-4 text-sm text-muted-foreground" }, rn = i({
	__name: "FAQList",
	setup(t) {
		let { t: i } = $t(), a = [
			1,
		...
		return (t, i) => (d(), n("div", en, [(d(!0), n(e, null, p(g(a), (e, t) => (d(), n("details", {
			key: t,
			class: "group rounded-lg border border-border bg-card"
		}, [r("summary", tn, h(e.q), 1), r("p", nn, h(e.a), 1)]))), 128))]));
	}
}), an = i({
	__name: "Wrapper",
	setup(e) {
