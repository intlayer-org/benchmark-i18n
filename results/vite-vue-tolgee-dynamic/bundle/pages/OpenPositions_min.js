...
var en = { class: "mb-6 text-2xl font-bold text-foreground" }, tn = { class: "space-y-4" }, nn = { class: "text-base font-semibold text-foreground" }, rn = { class: "text-sm text-muted-foreground" }, an = { class: "mt-2 flex gap-2" }, on = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, sn = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, cn = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, ln = {
	type: "button",
	...
	setup(t) {
		...
		return (t, o) => (d(), n(e, null, [r("h2", en, h(g(i)("careers.openPositions.title")), 1), r("div", tn, [(d(), n(e, null, p(a, (e, t) => r("div", {
			...
			r("h3", nn, h(g(i)(`careers.openPositions.${e.titleKey}`)), 1),
			r("p", rn, h(g(i)(`careers.openPositions.${e.descKey}`)), 1),
			r("div", an, [
				r("span", on, h(g(i)(`careers.openPositions.${e.deptKey}`)), 1),
				r("span", sn, h(g(i)(`careers.openPositions.${e.locationKey}`)), 1),
				r("span", cn, h(g(i)(`careers.openPositions.${e.typeKey}`)), 1)
			])
		]), r("button", ln, h(g(i)("careers.openPositions.applyNow")), 1)])), 64))])], 64));
	}
}), dn = i({
	__name: "Wrapper",
	setup(e) {
