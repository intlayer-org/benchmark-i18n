...
var Qt = { class: "rounded-lg border border-border bg-card p-6" }, $t = { class: "mb-4 text-lg font-semibold text-foreground" }, en = { class: "space-y-4" }, tn = { class: "flex items-center justify-between" }, nn = { class: "text-sm font-medium text-foreground" }, rn = { class: "text-xs text-muted-foreground" }, an = ["aria-label"], on = { class: "flex items-center justify-between" }, sn = { class: "text-sm font-medium text-foreground" }, cn = { class: "text-xs text-muted-foreground" }, ln = ["aria-label"], un = {
	for: "language",
	...
	setup(e) {
		let { t: r } = Zt();
		return (e, i) => (u(), t("section", Qt, [n("h2", $t, p(m(r)("settings.preferences.title")), 1), n("div", en, [
			n("div", tn, [n("div", null, [n("p", nn, p(m(r)("settings.preferences.emailNotifications")), 1), n("p", rn, p(m(r)("settings.preferences.weeklyReports")), 1)]), n("button", {
				type: "button",
				class: "h-6 w-11 rounded-full bg-primary transition-colors",
				"aria-label": m(r)("settings.preferences.toggleNotifications")
			}, [...i[0] ||= [n("span", { class: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" }, null, -1)]], 8, an)]),
			n("div", on, [n("div", null, [n("p", sn, p(m(r)("settings.preferences.darkMode")), 1), n("p", cn, p(m(r)("settings.preferences.darkColorScheme")), 1)]), n("button", {
				type: "button",
				class: "h-6 w-11 rounded-full bg-muted transition-colors",
				"aria-label": m(r)("settings.preferences.toggleDarkMode")
			}, [...i[1] ||= [n("span", { class: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" }, null, -1)]], 8, ln)]),
			n("div", null, [n("label", un, p(m(r)("settings.preferences.defaultLanguage")), 1), n("select", dn, [
