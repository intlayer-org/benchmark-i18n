...
var Zt = window.location.pathname.split("/")[1] ?? "", Qt = Gt().use(ze()).init({
...
var en = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, tn = a({
	...
	setup(t) {
		return (t, a) => (f(), n(e, null, [i(tn), a[0] ||= r("div", { class: "mb-12 text-center" }, [r("h1", { class: "mb-3 text-3xl font-bold text-foreground" }, " Simple, Transparent Pricing "), r("p", { class: "text-muted-foreground" }, " Choose the plan that fits your team. No hidden fees. ")], -1)], 64));
	}
}), rn = a({
	__name: "Wrapper",
	setup(e) {
