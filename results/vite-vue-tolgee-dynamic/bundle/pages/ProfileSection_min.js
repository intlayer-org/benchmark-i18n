...
var Qt = { class: "rounded-lg border border-border bg-card p-6" }, $t = { class: "mb-4 text-lg font-semibold text-foreground" }, en = { class: "space-y-4" }, tn = {
	for: "display-name",
	...
	setup(e) {
		let { t: r } = Zt();
		return (e, i) => (u(), t("section", Qt, [n("h2", $t, p(m(r)("settings.profile.title")), 1), n("div", en, [n("div", null, [n("label", tn, p(m(r)("settings.profile.displayName")), 1), i[0] ||= n("input", {
			id: "display-name",
		...
		}, null, -1)]), n("div", null, [n("label", nn, p(m(r)("settings.profile.email")), 1), i[1] ||= n("input", {
			id: "email",
