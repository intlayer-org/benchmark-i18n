...
var tn = { class: "mb-6 text-2xl font-bold text-foreground" }, nn = { class: "overflow-x-auto rounded-lg border border-border" }, rn = { class: "w-full text-sm" }, an = { class: "bg-muted" }, on = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, sn = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, cn = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, ln = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, un = { class: "px-4 py-3 font-medium text-foreground" }, dn = { class: "px-4 py-3 text-muted-foreground" }, fn = { class: "px-4 py-3 text-muted-foreground" }, pn = { class: "px-4 py-3 text-muted-foreground" }, mn = i({
	__name: "ResultsTable",
	setup(i) {
		en("ResultsTable");
		let { t: a } = $t(), o = t(() => [
		...
		return (t, i) => (d(), n("section", null, [r("h2", tn, h(g(a)("home.resultsTable.title")), 1), r("div", nn, [r("table", rn, [r("thead", an, [r("tr", null, [
			r("th", on, h(g(a)("home.resultsTable.library")), 1),
			r("th", sn, h(g(a)("home.resultsTable.bundleSize")), 1),
			r("th", cn, h(g(a)("home.resultsTable.lookupTime")), 1),
			r("th", ln, h(g(a)("home.resultsTable.lazyLoading")), 1)
