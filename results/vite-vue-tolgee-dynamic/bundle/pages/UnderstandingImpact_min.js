...
var en = { class: "mb-16 mx-auto max-w-3xl space-y-6" }, tn = { class: "text-2xl font-bold text-foreground" }, nn = { class: "rounded-lg border border-border bg-card p-6" }, rn = { class: "mb-2 text-lg font-semibold text-foreground" }, an = { class: "text-sm text-muted-foreground" }, on = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, sn = { class: "rounded-lg border border-border bg-card p-6" }, cn = { class: "mb-2 text-lg font-semibold text-foreground" }, ln = { class: "text-sm text-muted-foreground" }, un = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, dn = { class: "text-foreground" }, fn = { class: "text-foreground" }, pn = { class: "text-foreground" }, mn = { class: "rounded-lg border border-border bg-card p-6" }, hn = { class: "mb-2 text-lg font-semibold text-foreground" }, gn = { class: "text-sm text-muted-foreground" }, _n = i({
	__name: "UnderstandingImpact",
	setup(e) {
		$t("UnderstandingImpact");
		let { t: i } = Qt();
		return (e, a) => (d(), t("section", en, [
			n("h2", tn, m(h(i)("home.understandingImpact.title")), 1),
			n("div", nn, [
				n("h3", rn, m(h(i)("home.understandingImpact.singleJsonTitle")), 1),
				n("p", an, m(h(i)("home.understandingImpact.singleJsonIntro")), 1),
				n("ul", on, [
			...
			n("div", sn, [
				n("h3", cn, m(h(i)("home.understandingImpact.tradeOffsTitle")), 1),
				n("p", ln, m(h(i)("home.understandingImpact.tradeOffsIntro")), 1),
				n("ul", un, [
					n("li", null, [n("strong", dn, m(h(i)("home.understandingImpact.waterfallLabel")), 1), r(" " + m(h(i)("home.understandingImpact.waterfallDesc")), 1)]),
					n("li", null, [n("strong", fn, m(h(i)("home.understandingImpact.foucLabel")), 1), r(" " + m(h(i)("home.understandingImpact.foucDesc")), 1)]),
					n("li", null, [n("strong", pn, m(h(i)("home.understandingImpact.cacheLabel")), 1), r(" " + m(h(i)("home.understandingImpact.cacheDesc")), 1)])
				])
			]),
			n("div", mn, [n("h3", hn, m(h(i)("home.understandingImpact.measuresTitle")), 1), n("p", gn, m(h(i)("home.understandingImpact.measuresDesc")), 1)])
		]));
	}
}), vn = i({
	__name: "Wrapper",
