import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, createTextVNode as i, defineComponent as a, getCurrentInstance as o, h as s, inject as c, normalizeClass as l, onBeforeMount as u, onMounted as d, onUnmounted as f, openBlock as p, ref as m, renderList as h, renderSlot as g, toDisplayString as _, watch as v } from "vue";
var y = { class: "grid gap-6 md:grid-cols-3" }, b = { class: "text-lg font-semibold text-foreground" }, x = { class: "my-4" }, S = { class: "text-3xl font-bold text-foreground" }, ee = { class: "text-sm text-muted-foreground" }, te = { class: "mb-6 flex-1 space-y-2" }, ne = a({
	__name: "PricingTiers",
	setup(t) {
		let a = [
			{
		...
		return (t, o) => (p(), n("div", y, [(p(), n(e, null, h(a, (t) => r("div", {
			key: t.name,
			class: l(["flex flex-col rounded-lg border p-6", t.highlighted ? "border-primary bg-primary/5 ring-1 ring-primary" : "border-border bg-card"])
		}, [
			r("h3", b, _(t.name), 1),
			r("div", x, [r("span", S, _(t.price), 1), r("span", ee, _(t.period), 1)]),
			r("ul", te, [(p(!0), n(e, null, h(t.features, (e) => (p(), n("li", {
				key: e,
				class: "flex items-center gap-2 text-sm text-muted-foreground"
			}, [o[0] ||= r("span", { class: "text-primary" }, "✓", -1), i(" " + _(e), 1)]))), 128))]),
			r("button", {
				type: "button",
				class: l(["w-full rounded-md px-4 py-2 text-sm font-medium transition-opacity hover:opacity-90", t.highlighted ? "bg-primary text-primary-foreground" : "border border-border text-foreground hover:bg-accent"])
			}, _(t.name === "Enterprise" ? "Contact Sales" : "Get Started"), 3)
		], 2)), 64))]));
	}
}), re = Object.defineProperty, C = Object.defineProperties, ie = Object.getOwnPropertyDescriptors, ae = Object.getOwnPropertySymbols, oe = Object.prototype.hasOwnProperty, se = Object.prototype.propertyIsEnumerable, ce = (e, t, n) => t in e ? re(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
...
}, M = (e) => Object.fromEntries(be(e).entries()), N = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function je(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return D(s.onError, (e) => new Te("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
		if (!l.languageDetector) return;
		let e = n();
		return D(s.onError, (e) => new we("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let C = Object.freeze({
		...
		setStoredLanguage(e) {
			return D(s.onError, (e) => new Te("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		getBackendDevRecord: async ({ language: e, namespace: n }) => {
			...
			if ((r || i) && a && C.hasDevBackend()) return l.devBackend?.getRecord(Object.assign({
				apiKey: r,
				transport: i,
				apiUrl: a,
				projectId: o,
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = he(e) || I, r = t().onFormatError, a = typeof r;
...
function Me(e, t, n) {
	let r = Ae(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? j([t, ...pe(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
var z = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, Ne(r)), n)), n;
};
function Pe({ options: e }) {
	let t = Se(), n = R(!1, () => o.isFetching(), t.onFetchingChange.emit), r = R(!1, () => S.isLoading(), t.onLoadingChange.emit), i = Me(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = je(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = Ee(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Ie = () => {
	...
	return t;
}, Le = 0, B = 1, Re = 2, ze = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Le ? r = "Empty parameter" : e === B ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Be(e) {
	return /\s/.test(e);
...
var V = 0, H = 1, U = 2, W = 3, G = 4, Ve = /* @__PURE__ */ new Set([
	...
	H,
	V
]), K = "'", He = /* @__PURE__ */ new Set([
	"{",
	"}",
	K
]), Ue = (e) => /[0-9a-zA-Z_]/.test(e);
function We(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case V:
			...
			break;
		case H:
			He.has(i) ? (n = n.slice(0, -1) + i, t = U) : (n += i, t = V);
			break;
		case U:
			i === K ? t = V : (n += i, t = U);
			break;
		case W:
			i === "}" ? (d(), t = V) : Be(i) ? r !== "" && (d(), t = G) : (u(), t = W);
			break;
		case G: i == "}" ? t = V : Be(i) ? t = G : c(B);
	}
	return Ve.has(t) || c(Re), l(), [a, o];
}
function Ge(e, t) {
	let [n, r] = We(e), i = [n[0]];
...
function Ke() {
	return { format: ({ translation: e, params: t }) => Ge(e, t) };
}
var qe = () => (e, t) => (t.setFinalFormatter(Ke()), e);
function Je() {
	return globalThis.window?.document?.createElement === void 0;
}
var Ye = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Xe = {};
(function(e) {
	function t(e, t) {
...
(ue = console.assert) == null || ue.call(console, Ze), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Qe(e, t) {
	return t ? `${t}: ${e}` : e;
}
...
var et = 2, tt = 35e3, nt = "TOLGEE_API_REQUEST", rt = "TOLGEE_API_RESPONSE", it = "TOLGEE_PROXY_PING", at = "TOLGEE_PROXY_PONG";
function ot(e) {
...
}, st = 3e3, ct = 200, lt = 0, Y = /* @__PURE__ */ new Map(), X = !1, Z, Q;
async function ut({ type: e, replyType: t, payload: n, timeoutMs: r = tt, progressType: i, onProgress: a }) {
	pt();
	let o = Date.now() + r;
	await mt(Math.min(o, Date.now() + st));
	let s = o - Date.now();
	if (s <= 0) throw dt(e);
	let c = ft();
	return new Promise((r, o) => {
		let l = setTimeout(() => {
			Y.delete(c), ht(), o(dt(e));
		}, s);
		Y.set(c, {
			replyType: t,
			progressType: i,
...
var dt = (e) => new J("unavailable", `the Tolgee browser extension did not answer ${e} in time`), ft = () => `${Date.now()}-${lt++}-${Math.random()}`;
function pt() {
...
function mt(e) {
	return Z ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: it }, window.origin), i = () => {
			clearInterval(a), ht(), Q = void 0, n(new J("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var xt = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
function St(e) {
	let t = xt.indexOf(e);
...
function Dt(e) {
	...
	return r ? {
		...
		hasCredential: !!t,
		projectId: Tt(t) ?? n,
		requiresExplicitProject: Et(t) === "tgpat"
	};
}
function Ot(e) {
...
function At({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var $ = "__tolgee_", Mt = `${$}apiKey`, Nt = `${$}apiUrl`, Pt = `${$}branch`, Ft = `${$}projectId`, It = `${$}session`, Lt = "tolgee-in-context-tools.umd.min.js", Rt = "@tolgee/in-context-tools", zt = "InContextTools", Bt = "https://cdn.jsdelivr.net/npm", Vt = null;
function Ht(e) {
	return Vt ||= qt(Ut(e)).then(() => window[Rt][zt]), Vt;
}
function Ut(e) {
	return Wt() || `${Bt}/@tolgee/web@${e}/dist/${Lt}`;
}
function Wt() {
	if (Je()) return;
...
var Gt = (e) => e === "localhost" || e === "127.0.0.1" || e === "::1" || e === "[::1]";
function Kt(e, t) {
	if (!e || !Gt(t.hostname)) return !1;
	try {
		let n = new URL(e, t.href);
		return n.origin === t.origin || Gt(n.hostname);
	} catch {
		return !1;
	}
}
...
function Jt() {
	let e = sessionStorage.getItem(Mt) || void 0, t = sessionStorage.getItem(Nt) || void 0, n = sessionStorage.getItem(Pt) || void 0, r = sessionStorage.getItem(Ft) || void 0, i = ot(sessionStorage.getItem(It));
	if (!t) return;
	let a = w(w({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return le(w({}, a), { apiKey: e });
	if (i && r) return le(w({}, a), { transport: gt() });
}
function Yt() {
	let e = [];
...
function Xt(e) {
	if (!e.isDev()) return;
	let { requiresExplicitProject: t, projectId: n } = Dt(e.getInitialOptions());
...
(() => {
	...
	return Xt(e), e.on("running", ({ value: e }) => {
		e && Zt(() => {
			t.update(n()).catch(Yt);
		});
	}), Jt() && (async () => {
		let e = await Ht("7.2.1");
		return (t) => {
			let n = Jt();
...
var en = (e) => {
	let n = k(e), r = c("tolgeeContext"), i = t(() => r.value.tolgee);
	if (!i.value) throw Error("Tolgee instance not provided");
	let a = m(l()), o = i.value.on("update", () => {
...
var tn = { install(e, t) {
	...
	if (e.provide("tolgeeContext", i), r) {
		...
		i.value.tolgee = t(), v(() => i.value.isInitialRender, (t) => {
			t || (i.value.tolgee = e());
		});
	}
...
var an = window.location.pathname.split("/")[1] ?? "", on = $t().use(qe()).init({
	language: rn(an) ? an : "en",
	staticData: {
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$t && t.use(tn, { tolgee: on }), (e, t) => g(e.$slots, "default");
	}
}), cn = { render() {
	return s(sn, {}, { default: () => s(ne) });
} };
