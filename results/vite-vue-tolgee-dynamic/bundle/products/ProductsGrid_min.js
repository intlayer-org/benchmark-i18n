import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, defineComponent as i, getCurrentInstance as a, h as o, inject as s, onBeforeMount as c, onMounted as l, onUnmounted as u, openBlock as d, ref as f, renderList as p, renderSlot as m, toDisplayString as h, watch as g } from "vue";
var _ = { class: "grid gap-6 md:grid-cols-2 lg:grid-cols-3" }, v = { class: "mb-2 text-lg font-semibold text-foreground" }, y = { class: "mb-4 text-sm text-muted-foreground" }, b = { class: "flex items-center justify-between" }, x = { class: "text-sm font-bold text-primary" }, S = i({
	__name: "ProductsGrid",
	setup(t) {
		let i = [
			{
		...
		return (t, a) => (d(), n("div", _, [(d(), n(e, null, p(i, (e) => r("div", {
			key: e.name,
			class: "flex flex-col justify-between rounded-lg border border-border bg-card p-6"
		}, [r("div", null, [r("h3", v, h(e.name), 1), r("p", y, h(e.desc), 1)]), r("div", b, [r("span", x, h(e.price), 1), a[0] ||= r("button", {
			type: "button",
			class: "rounded-md bg-primary px-4 py-2 text-xs font-medium text-primary-foreground hover:opacity-90 transition-opacity"
		}, " Learn More ", -1)])])), 64))]));
	}
}), ee = Object.defineProperty, te = Object.defineProperties, ne = Object.getOwnPropertyDescriptors, C = Object.getOwnPropertySymbols, w = Object.prototype.hasOwnProperty, re = Object.prototype.propertyIsEnumerable, ie = (e, t, n) => t in e ? ee(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, T = (e, t) => {
	for (var n in t ||= {}) w.call(t, n) && ie(e, n, t[n]);
	if (C) for (var n of C(t)) re.call(t, n) && ie(e, n, t[n]);
	return e;
}, ae = (e, t) => te(e, ne(t)), oe;
function se(e, t) {
...
var he = () => ({
	...
	let r = me(n?.headers);
	return r["x-api-key"] && (r = Object.assign(Object.assign({}, he()), r)), e(t, Object.assign(Object.assign({}, n), { headers: r }));
}, _e = (e) => {
...
}, M = (e) => Object.fromEntries(_e(e).entries()), N = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function De(e, t) {
	let n = L(Ee, t?.initialOptions, e);
	return n.apiUrl = de(n.apiUrl), e?.fetch && (n.fetch = ge(e.fetch)), {
		initialOptions: n,
...
function Oe(e, t, n, r, i, a, o, s) {
	...
	function f(e) {
		...
		return w.formatTranslation(Object.assign(Object.assign({}, e), {
			translation: t,
			formatEnabled: !0
		}));
	}
	...
	function S() {
		return O(s.onError, (e) => new Se("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
		if (!l.languageDetector) return;
		let e = n();
		return O(s.onError, (e) => new xe("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let w = Object.freeze({
		...
		setStoredLanguage(e) {
			return O(s.onError, (e) => new Se("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		getBackendDevRecord: async ({ language: e, namespace: n }) => {
			...
			if ((r || i) && a && w.hasDevBackend()) return l.devBackend?.getRecord(Object.assign({
				apiKey: r,
				transport: i,
				apiUrl: a,
				projectId: o,
		...
		hasDevBackend() {
			return !!w.getDevBackend();
		},
		formatTranslation(n) {
			var { formatEnabled: r } = n, i = we(n, ["formatEnabled"]);
			...
			try {
				...
				console.error(e);
				let n = fe(e) || I, r = t().onFormatError, a = typeof r;
...
function Ae(e, t, n) {
	let r = De(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? j([t, ...ue(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
		...
		overrideCredentials(e) {
			i = e ? Object.assign(Object.assign({}, e), { apiUrl: de(e.apiUrl) }) : void 0;
		}
	});
	return a;
}
function je(e) {
	var { ns: t, noWrap: n, orEmpty: r, params: i, language: a } = e, o = we(e, [
		"ns",
		"noWrap",
		"orEmpty",
		"params",
...
var R = (e, ...t) => {
	let n = {}, r;
	return typeof e == "object" && e ? n = e : (n.key = e, typeof t[0] == "string" ? (n.defaultValue = t[0], r = t[1]) : typeof t[0] == "object" && (r = t[0])), r && (n = Object.assign(Object.assign({}, je(r)), n)), n;
};
function Me({ options: e }) {
	let t = ye(), n = ke(!1, () => o.isFetching(), t.onFetchingChange.emit), r = ke(!1, () => S.isLoading(), t.onLoadingChange.emit), i = Ae(t.onLanguageChange, t.onPendingLanguageChange, t.onRunningChange), a = Oe(i.getLanguage, i.getInitialOptions, i.getAvailableLanguages, u, _, v, f, t), o = Ce(t, a.getBackendRecord, a.getBackendDevRecord, i.withDefaultNs, i.isInitialLoading, n, r);
	e && p(e);
	let s;
	t.onUpdate.listen(() => {
...
var Pe = () => {
	let e = {
		...
		init(t) {
			let n = Ne(L(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, Fe = 0, z = 1, Ie = 2, Le = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Fe ? r = "Empty parameter" : e === z ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Re(e) {
	return /\s/.test(e);
}
var B = 0, V = 1, H = 2, U = 3, W = 4, ze = /* @__PURE__ */ new Set([
	H,
	V,
	B
]), G = "'", Be = /* @__PURE__ */ new Set([
	"{",
	"}",
	G
...
function He(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case B:
			...
			break;
		case V:
			Be.has(i) ? (n = n.slice(0, -1) + i, t = H) : (n += i, t = B);
			break;
		case H:
			i === G ? t = B : (n += i, t = H);
			break;
		case U:
			i === "}" ? (d(), t = B) : Re(i) ? r !== "" && (d(), t = W) : (u(), t = U);
			break;
		case W: i == "}" ? t = B : Re(i) ? t = W : c(z);
	}
	return ze.has(t) || c(Ie), l(), [a, o];
}
function Ue(e, t) {
	let [n, r] = He(e), i = [n[0]];
...
function We() {
	return { format: ({ translation: e, params: t }) => Ue(e, t) };
}
var Ge = () => (e, t) => (t.setFinalFormatter(We()), e);
function Ke() {
	return globalThis.window?.document?.createElement === void 0;
}
var qe = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, K = {};
(function(e) {
	function t(e, t) {
...
})(typeof window < "u" ? window : qe);
var Je = se({
	__proto__: null,
	default: K
}, [K]);
(oe = console.assert) == null || oe.call(console, Je), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ye(e, t) {
	return t ? `${t}: ${e}` : e;
}
var q = class e extends Error {
	constructor(t, n, r) {
		super(Ye(t, n)), this.code = t, this.status = n, this.params = r, Object.setPrototypeOf(this, e.prototype);
	}
};
function Xe(e) {
	return e instanceof Error && typeof e.code == "string";
}
var Ze = 2, Qe = 35e3, $e = "TOLGEE_API_REQUEST", et = "TOLGEE_API_RESPONSE", tt = "TOLGEE_PROXY_PING", nt = "TOLGEE_PROXY_PONG";
function rt(e) {
...
}, it = 3e3, at = 200, ot = 0, Y = /* @__PURE__ */ new Map(), st = !1, X, Z;
async function ct({ type: e, replyType: t, payload: n, timeoutMs: r = Qe, progressType: i, onProgress: a }) {
	dt();
	let o = Date.now() + r;
	await ft(Math.min(o, Date.now() + it));
	let s = o - Date.now();
	if (s <= 0) throw lt(e);
	let c = ut();
	return new Promise((r, o) => {
		let l = setTimeout(() => {
			Y.delete(c), pt(), o(lt(e));
		}, s);
		Y.set(c, {
			replyType: t,
			progressType: i,
...
var lt = (e) => new J("unavailable", `the Tolgee browser extension did not answer ${e} in time`), ut = () => `${Date.now()}-${ot++}-${Math.random()}`;
function dt() {
	st || (st = !0, window.addEventListener("message", (e) => {
		var t;
...
function ft(e) {
	return X ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: tt }, window.origin), i = () => {
			clearInterval(a), pt(), Z = void 0, n(new J("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var yt = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
function bt(e) {
	let t = yt.indexOf(e);
...
function St(e) {
	...
	for (let o = 0; o < t; o++) r = r << 5 | bt(e[o]), n += 5, n >= 8 && (a[i++] = r >>> n - 8 & 255, n -= 8);
	return xt(a.buffer);
}
function Ct(e) {
	if (e) try {
...
function Tt(e) {
	...
	return r ? {
		...
		hasCredential: !!t,
		projectId: Ct(t) ?? n,
		requiresExplicitProject: wt(t) === "tgpat"
	};
}
function Et(e) {
...
function Ot({ message: e, recievingMessage: t, data: n, attempts: r = 1, timeout: i = 300 }) {
...
var Q = "__tolgee_", At = `${Q}apiKey`, jt = `${Q}apiUrl`, Mt = `${Q}branch`, Nt = `${Q}projectId`, Pt = `${Q}session`, Ft = "tolgee-in-context-tools.umd.min.js", It = "@tolgee/in-context-tools", Lt = "InContextTools", Rt = "https://cdn.jsdelivr.net/npm", zt = null;
function Bt(e) {
	return zt ||= Gt(Vt(e)).then(() => window[It][Lt]), zt;
}
function Vt(e) {
	return Ht() || `${Rt}/@tolgee/web@${e}/dist/${Ft}`;
}
function Ht() {
	if (Ke()) return;
...
var Ut = (e) => e === "localhost" || e === "127.0.0.1" || e === "::1" || e === "[::1]";
function Wt(e, t) {
	if (!e || !Ut(t.hostname)) return !1;
	try {
		let n = new URL(e, t.href);
		return n.origin === t.origin || Ut(n.hostname);
	} catch {
		return !1;
	}
}
...
function Kt() {
	let e = sessionStorage.getItem(At) || void 0, t = sessionStorage.getItem(jt) || void 0, n = sessionStorage.getItem(Mt) || void 0, r = sessionStorage.getItem(Nt) || void 0, i = rt(sessionStorage.getItem(Pt));
	if (!t) return;
	let a = T(T({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return ae(T({}, a), { apiKey: e });
	if (i && r) return ae(T({}, a), { transport: mt() });
}
function qt() {
	let e = [];
...
function Jt(e) {
	if (!e.isDev()) return;
	let { requiresExplicitProject: t, projectId: n } = Tt(e.getInitialOptions());
	...
	setup(e) {
		...
		if (n.value.isInitialRender && e.ssr) {
			...
			if (r.value.setEmitterActive(!1), r.value.addStaticData(t.staticData), r.value.changeLanguage(t.language), r.value.setEmitterActive(!0), !r.value.isLoaded()) {
				let e = r.value.getRequiredDescriptors(t.language).map((e) => P(e)).filter((e) => !t.staticData?.[e]);
...
var Qt = (e) => {
	let n = le(e), r = s("tolgeeContext"), i = t(() => r.value.tolgee);
...
var $ = window.location.pathname.split("/")[1] ?? "", nn = Zt().use(Ge()).init({
	language: tn($) ? $ : "en",
	staticData: {
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$t && t.use($t, { tolgee: nn }), (e, t) => m(e.$slots, "default");
	}
}), an = { render() {
	return o(rn, {}, { default: () => o(S) });
} };
