import { computed, createBlock, defineComponent, getCurrentInstance, h, inject, onBeforeMount, onMounted, onUnmounted, openBlock, ref, renderSlot, unref, watch, withCtx } from "vue";
...
var LibWrapper_default = defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(TolgeeProvider), null, {
