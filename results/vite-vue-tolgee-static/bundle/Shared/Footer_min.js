...
var nn = { class: "mt-20 border-t border-border bg-card" }, rn = { class: "container py-8" }, an = { class: "grid gap-8 md:grid-cols-3" }, on = { class: "mb-2 text-sm font-semibold text-foreground" }, sn = { class: "text-sm text-muted-foreground" }, cn = { class: "mb-2 text-sm font-semibold text-foreground" }, ln = { class: "space-y-1" }, un = ["href"], dn = { class: "mb-2 text-sm font-semibold text-foreground" }, fn = { class: "text-sm text-muted-foreground" }, pn = { class: "mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground" }, mn = o({
	__name: "Footer",
	setup(o) {
		let { t: s } = tn(), c = S(), l = t(() => c.params.locale || "en"), u = t(() => [
			{
		...
		return (t, o) => {
			let c = _("router-link");
			return p(), r("footer", nn, [i("div", rn, [i("div", an, [
				i("div", null, [i("h3", on, v(y(s)("footer.title")), 1), i("p", sn, v(y(s)("footer.description")), 1)]),
				i("div", null, [i("h3", cn, v(y(s)("footer.resources")), 1), i("ul", ln, [(p(!0), r(e, null, h(u.value, (e) => (p(), r("li", { key: e.label }, [e.isInternal ? (p(), n(c, {
					key: 0,
					to: e.to,
				...
				i("div", null, [i("h3", dn, v(y(s)("footer.contact")), 1), i("p", fn, v(y(s)("shared.contactEmail")), 1)])
			]), i("div", pn, v(y(s)("footer.builtWith")), 1)])]);
		};
	}
}), hn = o({
	__name: "Wrapper",
	setup(e) {
		...
		return t && !t.config.globalProperties.$t && t.use($t, { tolgee: en }), (e, t) => g(e.$slots, "default");
	}
}), gn = { render() {
	return c(hn, {}, { default: () => c(mn) });
} };
