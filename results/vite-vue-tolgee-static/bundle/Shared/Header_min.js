...
var ln = [
...
}, dn = { class: "flex items-center gap-2" }, fn = ["value"], pn = ["value"], mn = c({
	...
	setup(n) {
		...
		}, [(g(!0), i(e, null, v(S(ln), (e) => (g(), i("option", {
			key: e,
			value: e
		}, x(S(un)(e)), 9, pn))), 128))], 40, fn)]));
	}
}), hn = ["aria-label", "title"], gn = c({
	__name: "ThemeToggle",
	setup(e) {
		let { t } = sn(), n = _("auto");
		function r() {
		...
		}, x(n.value === "auto" ? S(t)("themeToggle.auto") : n.value === "dark" ? S(t)("themeToggle.dark") : S(t)("themeToggle.light")), 9, hn));
	}
}), _n = { class: "sticky top-0 z-50 border-b border-border bg-card/80 backdrop-blur-lg" }, vn = { class: "container flex h-16 items-center justify-between" }, yn = { class: "flex items-center gap-8" }, bn = { class: "hidden items-center gap-6 text-sm font-medium md:flex" }, xn = ["href", "onClick"], Sn = ["href", "onClick"], Cn = { class: "relative" }, wn = { class: "bg-card border border-border rounded-md shadow-lg overflow-hidden py-1" }, Tn = { class: "flex items-center gap-4" }, En = {
	href: "https://github.com/intlayer-org/benchmark-i18n",
	target: "_blank",
	rel: "noreferrer",
	class: "text-muted-foreground transition hover:text-foreground"
}, Dn = { class: "sr-only" }, On = c({
	__name: "Header",
	setup(c) {
		cn("Header");
		...
		return (t, c) => {
			let d = b("router-link");
			return g(), i("header", _n, [a("nav", vn, [a("div", yn, [s(d, {
				to: `/${p.value}`,
				...
				s(d, {
					...
					default: w(({ href: e, navigate: t, isActive: n }) => [a("a", {
						...
						class: f(["nav-link", { "router-link-active": n }]),
						onClick: t
					}, x(S(l)("header.methodology")), 11, Sn)]),
					_: 1
				}, 8, ["to"]),
				a("div", Cn, [a("button", {
					type: "button",
				...
				}, [a("div", wn, [(g(!0), i(e, null, v(m.value, (e) => (g(), n(d, {
					key: e.to,
					to: e.to,
				...
				a("a", En, [a("span", Dn, x(S(l)("shared.goToGithub")), 1), c[6] ||= a("svg", {
					viewBox: "0 0 16 16",
					"aria-hidden": "true",
					width: "20",
					height: "20"
