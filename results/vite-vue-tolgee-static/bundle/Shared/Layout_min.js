...
var un = { class: "mt-20 border-t border-border bg-card" }, dn = { class: "container py-8" }, fn = { class: "grid gap-8 md:grid-cols-3" }, pn = { class: "mb-2 text-sm font-semibold text-foreground" }, mn = { class: "text-sm text-muted-foreground" }, hn = { class: "mb-2 text-sm font-semibold text-foreground" }, gn = { class: "space-y-1" }, _n = ["href"], vn = { class: "mb-2 text-sm font-semibold text-foreground" }, yn = { class: "text-sm text-muted-foreground" }, bn = { class: "mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground" }, xn = c({
	__name: "Footer",
	setup(r) {
		let { t: s } = sn(), c = T(), l = t(() => c.params.locale || "en"), u = t(() => [
			{
		...
		return (t, r) => {
			let c = b("router-link");
			return g(), i("footer", un, [a("div", dn, [a("div", fn, [
				a("div", null, [a("h3", pn, x(S(s)("footer.title")), 1), a("p", mn, x(S(s)("footer.description")), 1)]),
				a("div", null, [a("h3", hn, x(S(s)("footer.resources")), 1), a("ul", gn, [(g(!0), i(e, null, v(u.value, (e) => (g(), i("li", { key: e.label }, [e.isInternal ? (g(), n(c, {
					key: 0,
					to: e.to,
				...
				a("div", null, [a("h3", vn, x(S(s)("footer.contact")), 1), a("p", yn, x(S(s)("shared.contactEmail")), 1)])
			]), a("div", bn, x(S(s)("footer.builtWith")), 1)])]);
		};
	}
});
function Sn(e) {
...
var Cn = [
...
}, Tn = { class: "flex items-center gap-2" }, En = ["value"], Dn = ["value"], On = c({
	...
	setup(n) {
		...
		return (t, n) => (g(), i("div", Tn, [a("select", {
			value: s.value,
		...
		}, [(g(!0), i(e, null, v(S(Cn), (e) => (g(), i("option", {
			key: e,
			value: e
		}, x(S(wn)(e)), 9, Dn))), 128))], 40, En)]));
	}
}), kn = ["aria-label", "title"], An = c({
	__name: "ThemeToggle",
	setup(e) {
		let { t } = sn(), n = _("auto");
		function r() {
		...
		}, x(n.value === "auto" ? S(t)("themeToggle.auto") : n.value === "dark" ? S(t)("themeToggle.dark") : S(t)("themeToggle.light")), 9, kn));
	}
}), jn = { class: "sticky top-0 z-50 border-b border-border bg-card/80 backdrop-blur-lg" }, Mn = { class: "container flex h-16 items-center justify-between" }, Nn = { class: "flex items-center gap-8" }, Pn = { class: "hidden items-center gap-6 text-sm font-medium md:flex" }, Fn = ["href", "onClick"], In = ["href", "onClick"], Ln = { class: "relative" }, Rn = { class: "bg-card border border-border rounded-md shadow-lg overflow-hidden py-1" }, zn = { class: "flex items-center gap-4" }, Bn = {
	href: "https://github.com/intlayer-org/benchmark-i18n",
	target: "_blank",
	rel: "noreferrer",
	class: "text-muted-foreground transition hover:text-foreground"
}, Vn = { class: "sr-only" }, Hn = c({
	__name: "Header",
	setup(c) {
		Sn("Header");
		let { t: l } = sn(), u = _(!1), d = T(), p = t(() => d.params.locale || "en"), m = t(() => [
			{
				to: `/${p.value}/products`,
		...
		return (t, c) => {
			let d = b("router-link");
			return g(), i("header", jn, [a("nav", Mn, [a("div", Nn, [s(d, {
				to: `/${p.value}`,
				...
				s(d, {
					...
					default: w(({ href: e, navigate: t, isActive: n }) => [a("a", {
						...
						class: f(["nav-link", { "router-link-active": n }]),
						onClick: t
					}, x(S(l)("header.methodology")), 11, In)]),
					_: 1
				}, 8, ["to"]),
				a("div", Ln, [a("button", {
					type: "button",
				...
				}, [a("div", Rn, [(g(!0), i(e, null, v(m.value, (e) => (g(), n(d, {
					key: e.to,
					to: e.to,
				...
				a("a", Bn, [a("span", Vn, x(S(l)("shared.goToGithub")), 1), c[6] ||= a("svg", {
					viewBox: "0 0 16 16",
					"aria-hidden": "true",
					width: "20",
					height: "20"
	...
	setup(t) {
		...
		return p(() => {
			...
			cn(), ln("AppRoot", r.value);
		}), C(() => n.params.locale, (e) => {
			e && (document.documentElement.lang = e, on.changeLanguage(e));
		}, { immediate: !0 }), (t, n) => {
			let r = b("router-view");
			return g(), i(e, null, [
				s(Hn),
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$t && t.use(an, { tolgee: on }), (e, t) => y(e.$slots, "default");
	}
}), Gn = { render() {
	return u(Wn, {}, { default: () => u(Un) });
} };
