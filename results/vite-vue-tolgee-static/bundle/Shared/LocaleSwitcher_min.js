import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, defineComponent as i, getCurrentInstance as a, h as o, inject as s, onBeforeMount as c, onMounted as l, onUnmounted as u, openBlock as d, ref as f, renderList as p, renderSlot as m, toDisplayString as h, unref as g, watch as _ } from "vue";
...
}, S = { class: "flex items-center gap-2" }, ee = ["value"], te = ["value"], ne = i({
	__name: "LocaleSwitcher",
	setup(i) {
		let a = v(), o = y(), s = t(() => a.params.locale || "en"), c = (e) => {
		...
		return (t, i) => (d(), n("div", S, [r("select", {
			value: s.value,
			onChange: i[0] ||= (e) => c(e.target.value),
		...
		}, [(d(!0), n(e, null, p(g(b), (e) => (d(), n("option", {
			key: e,
			value: e
		}, h(g(x)(e)), 9, te))), 128))], 40, ee)]));
	}
...
var en = (e) => {
	let n = k(e), r = s("tolgeeContext"), i = t(() => r.value.tolgee);
...
var tn = { install(e, t) {
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$t && t.use(tn, { tolgee: nn }), (e, t) => m(e.$slots, "default");
	}
}), an = { render() {
	return o(rn, {}, { default: () => o(ne) });
} };
