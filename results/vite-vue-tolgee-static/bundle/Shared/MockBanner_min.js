...
var Jt = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, Yt = n({
	__name: "MockBanner",
	setup(e) {
		let { t: n } = qt();
		return (e, r) => (l(), t("div", Jt, f(p(n)("mockBanner")), 1));
	}
}), Xt = n({
	__name: "Wrapper",
	setup(e) {
