...
var Jt = ["aria-label", "title"], Yt = n({
	...
	setup(e) {
		...
		}, f(r.value === "auto" ? p(n)("themeToggle.auto") : r.value === "dark" ? p(n)("themeToggle.dark") : p(n)("themeToggle.light")), 9, Jt));
	}
}), Xt = n({
	__name: "Wrapper",
	setup(e) {
		let t = r()?.appContext.app;
		return t && !t.config.globalProperties.$t && t.use(Gt, { tolgee: Kt }), (e, t) => d(e.$slots, "default");
	}
}), Zt = { render() {
	return i(Xt, {}, { default: () => i(Yt) });
} };
