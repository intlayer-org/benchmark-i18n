...
var Zt = { class: "mb-4 text-3xl font-bold text-foreground" }, Qt = { class: "mb-8 max-w-3xl text-muted-foreground" }, $t = i({
	__name: "AboutHeader",
	setup(t) {
		Xt("AboutHeader");
		let { t: i } = Yt();
		return (t, a) => (d(), n(e, null, [r("h1", Zt, m(h(i)("about.header.title")), 1), r("p", Qt, m(h(i)("about.header.description")), 1)], 64));
	}
}), en = i({
	__name: "Wrapper",
	setup(e) {
