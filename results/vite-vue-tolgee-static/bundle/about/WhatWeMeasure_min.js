...
var Qt = { class: "mt-12 mx-auto max-w-3xl" }, $t = { class: "mb-4 text-2xl font-bold text-foreground" }, en = { class: "space-y-4" }, tn = { class: "block text-sm font-bold text-primary" }, nn = { class: "block mt-1 text-sm text-muted-foreground" }, rn = i({
	...
	setup(i) {
		...
		return (t, i) => (d(), n("section", Qt, [r("h2", $t, h(g(a)("about.whatWeMeasure.title")), 1), r("ul", en, [(d(!0), n(e, null, p(o.value, (e) => (d(), n("li", {
			key: e.metric,
			class: "rounded-md border border-border p-4"
		}, [r("span", tn, h(e.metric), 1), r("span", nn, h(e.desc), 1)]))), 128))])]));
	}
}), an = i({
	__name: "Wrapper",
	setup(e) {
