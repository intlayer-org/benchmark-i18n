...
var Qt = { class: "mb-6 rounded-md border border-border bg-muted px-4 py-3 text-center text-sm text-muted-foreground" }, $t = o({
	__name: "MockBanner",
	setup(e) {
		let { t } = Zt();
		return (e, r) => (p(), n("div", Qt, g(_(t)("mockBanner")), 1));
	}
}), en = { class: "mb-2 text-3xl font-bold text-foreground" }, tn = { class: "mb-8 text-muted-foreground" }, nn = {
	...
	setup(t) {
		...
		return (t, s) => (p(), n(e, null, [
			a($t),
			r("h1", en, g(_(o)("contact.header.title")), 1),
			r("p", tn, [
				i(g(_(o)("contact.header.description")) + " ", 1),
				r("a", nn, g(_(o)("shared.contactEmail")), 1),
				s[0] ||= i(". ", -1)
			])
		], 64));
	}
	...
	setup(e) {
		...
		return t && !t.config.globalProperties.$t && t.use(Yt, { tolgee: Xt }), (e, t) => h(e.$slots, "default");
	}
}), on = { render() {
	return c(an, {}, { default: () => c(rn) });
} };
