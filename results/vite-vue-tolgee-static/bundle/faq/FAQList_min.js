...
var Zt = { class: "mx-auto max-w-3xl space-y-4" }, Qt = { class: "cursor-pointer px-6 py-4 text-sm font-medium text-foreground hover:bg-accent/50 transition-colors" }, $t = { class: "px-6 pb-4 text-sm text-muted-foreground" }, en = i({
	__name: "FAQList",
	setup(t) {
		let { t: i } = Xt(), a = [
			1,
		...
		return (t, i) => (d(), n("div", Zt, [(d(!0), n(e, null, p(g(a), (e, t) => (d(), n("details", {
			key: t,
			class: "group rounded-lg border border-border bg-card"
		}, [r("summary", Qt, h(e.q), 1), r("p", $t, h(e.a), 1)]))), 128))]));
	}
}), tn = i({
	__name: "Wrapper",
	setup(e) {
