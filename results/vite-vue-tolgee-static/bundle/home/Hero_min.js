...
var Xt = { class: "mb-16 text-center" }, Zt = { class: "mb-4 text-4xl font-bold tracking-tight text-foreground" }, Qt = { class: "mx-auto max-w-2xl text-lg text-muted-foreground" }, $t = { class: "mt-8 flex justify-center gap-4" }, en = {
	type: "button",
	...
	setup(e) {
		Yt("Hero");
		let { t: r } = Jt();
		return (e, i) => (u(), t("section", Xt, [
			n("h1", Zt, p(m(r)("home.hero.title")), 1),
			n("p", Qt, p(m(r)("home.hero.description")), 1),
			n("div", $t, [n("button", en, p(m(r)("home.hero.viewResults")), 1), n("button", tn, p(m(r)("home.hero.methodology")), 1)])
		]));
	}
}), rn = r({
	__name: "Wrapper",
