import { computed as e, createElementBlock as t, createElementVNode as n, createTextVNode as r, defineComponent as i, getCurrentInstance as a, h as o, inject as s, onBeforeMount as c, onMounted as l, onUnmounted as u, openBlock as d, ref as f, renderSlot as p, toDisplayString as m, unref as h, watch as g } from "vue";
	...
	setup(t) {
		...
		if (n.value.isInitialRender && t.ssr) {
			...
			if (r.value.setEmitterActive(!1), r.value.addStaticData(e.staticData), r.value.changeLanguage(e.language), r.value.setEmitterActive(!0), !r.value.isLoaded()) {
				let t = r.value.getRequiredDescriptors(e.language).map((e) => I(e)).filter((t) => !e.staticData?.[t]);
...
var Gt = (t) => {
	let n = te(t), r = s("tolgeeContext"), i = e(() => r.value.tolgee);
...
var Zt = { class: "mb-16 mx-auto max-w-3xl space-y-6" }, Qt = { class: "text-2xl font-bold text-foreground" }, $t = { class: "rounded-lg border border-border bg-card p-6" }, en = { class: "mb-2 text-lg font-semibold text-foreground" }, tn = { class: "text-sm text-muted-foreground" }, nn = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, rn = { class: "rounded-lg border border-border bg-card p-6" }, an = { class: "mb-2 text-lg font-semibold text-foreground" }, on = { class: "text-sm text-muted-foreground" }, sn = { class: "mt-3 space-y-2 text-sm text-muted-foreground list-disc pl-5" }, cn = { class: "text-foreground" }, ln = { class: "text-foreground" }, un = { class: "text-foreground" }, dn = { class: "rounded-lg border border-border bg-card p-6" }, fn = { class: "mb-2 text-lg font-semibold text-foreground" }, pn = { class: "text-sm text-muted-foreground" }, mn = i({
	__name: "UnderstandingImpact",
	setup(e) {
		Xt("UnderstandingImpact");
		let { t: i } = Yt();
		return (e, a) => (d(), t("section", Zt, [
			n("h2", Qt, m(h(i)("home.understandingImpact.title")), 1),
			n("div", $t, [
				n("h3", en, m(h(i)("home.understandingImpact.singleJsonTitle")), 1),
				n("p", tn, m(h(i)("home.understandingImpact.singleJsonIntro")), 1),
				n("ul", nn, [
			...
			n("div", rn, [
				n("h3", an, m(h(i)("home.understandingImpact.tradeOffsTitle")), 1),
				n("p", on, m(h(i)("home.understandingImpact.tradeOffsIntro")), 1),
				n("ul", sn, [
					n("li", null, [n("strong", cn, m(h(i)("home.understandingImpact.waterfallLabel")), 1), r(" " + m(h(i)("home.understandingImpact.waterfallDesc")), 1)]),
					n("li", null, [n("strong", ln, m(h(i)("home.understandingImpact.foucLabel")), 1), r(" " + m(h(i)("home.understandingImpact.foucDesc")), 1)]),
					n("li", null, [n("strong", un, m(h(i)("home.understandingImpact.cacheLabel")), 1), r(" " + m(h(i)("home.understandingImpact.cacheDesc")), 1)])
				])
			]),
			n("div", dn, [n("h3", fn, m(h(i)("home.understandingImpact.measuresTitle")), 1), n("p", pn, m(h(i)("home.understandingImpact.measuresDesc")), 1)])
		]));
	}
}), hn = i({
	__name: "Wrapper",
	setup(e) {
		...
		return t && !t.config.globalProperties.$t && t.use(qt, { tolgee: Jt }), (e, t) => p(e.$slots, "default");
	}
}), gn = { render() {
	return o(hn, {}, { default: () => o(mn) });
} };
