...
var Xt = { class: "mb-16" }, Zt = { class: "mb-6 text-2xl font-bold text-foreground" }, Qt = { class: "grid gap-6 md:grid-cols-3" }, $t = { class: "rounded-lg border border-border bg-card p-6" }, en = { class: "mb-2 text-lg font-semibold text-foreground" }, tn = { class: "text-sm text-muted-foreground" }, nn = { class: "rounded-lg border border-border bg-card p-6" }, rn = { class: "mb-2 text-lg font-semibold text-foreground" }, an = { class: "text-sm text-muted-foreground" }, on = { class: "rounded-lg border border-border bg-card p-6" }, sn = { class: "mb-2 text-lg font-semibold text-foreground" }, cn = { class: "text-sm text-muted-foreground" }, ln = r({
	__name: "WhyItMatters",
	setup(e) {
		Yt("WhyItMatters");
		let { t: r } = Jt();
		return (e, i) => (u(), t("section", Xt, [n("h2", Zt, p(m(r)("home.whyItMatters.title")), 1), n("div", Qt, [
			n("div", $t, [n("h3", en, p(m(r)("home.whyItMatters.bundleSizeTitle")), 1), n("p", tn, p(m(r)("home.whyItMatters.bundleSizeDesc")), 1)]),
			n("div", nn, [n("h3", rn, p(m(r)("home.whyItMatters.renderingTitle")), 1), n("p", an, p(m(r)("home.whyItMatters.renderingDesc")), 1)]),
			n("div", on, [n("h3", sn, p(m(r)("home.whyItMatters.dynamicLoadingTitle")), 1), n("p", cn, p(m(r)("home.whyItMatters.dynamicLoadingDesc")), 1)])
		])]));
	}
}), un = r({
	__name: "Wrapper",
