...
var Xt = { class: "grid gap-8 md:grid-cols-2" }, Zt = { class: "rounded-lg border border-border bg-card p-6" }, Qt = { class: "mb-3 text-xl font-semibold text-foreground" }, $t = { class: "text-sm text-muted-foreground" }, en = { class: "rounded-lg border border-border bg-card p-6" }, tn = { class: "mb-3 text-xl font-semibold text-foreground" }, nn = { class: "text-sm text-muted-foreground" }, rn = r({
	__name: "AboutGrid",
	setup(e) {
		Yt("AboutGrid");
		let { t: r } = Jt();
		return (e, i) => (u(), t("div", Xt, [n("div", Zt, [n("h2", Qt, p(m(r)("about.grid.whyExistsTitle")), 1), n("p", $t, p(m(r)("about.grid.whyExistsDesc")), 1)]), n("div", en, [n("h2", tn, p(m(r)("about.grid.methodologyTitle")), 1), n("p", nn, p(m(r)("about.grid.methodologyDesc")), 1)])]));
	}
}), an = r({
	__name: "Wrapper",
	setup(e) {
