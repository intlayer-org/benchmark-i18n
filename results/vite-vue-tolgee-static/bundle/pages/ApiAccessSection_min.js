...
function ye(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return k(s.onError, (e) => new pe("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function C() {
		if (!l.languageDetector) return;
		let e = n();
		return k(s.onError, (e) => new fe("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function w(e) {
		e && l.backends.push(e);
	}
	...
	let D = Object.freeze({
		...
		setStoredLanguage(e) {
			return k(s.onError, (e) => new pe("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
...
function xe(e, t, n) {
	let r = ve(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? M([t, ...ne(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
...
var Wt = (t) => {
	let n = te(t), r = o("tolgeeContext"), i = e(() => r.value.tolgee);
...
var Yt = { class: "rounded-lg border border-border bg-card p-6" }, Xt = { class: "mb-4 text-lg font-semibold text-foreground" }, Zt = {
	for: "api-key",
	class: "mb-1 block text-sm font-medium text-foreground"
}, Qt = { class: "flex gap-2" }, $t = {
	type: "button",
	class: "rounded-md border border-border px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent"
}, en = { class: "mt-1 text-xs text-muted-foreground" }, tn = r({
	__name: "ApiAccessSection",
	setup(e) {
		let { t: r } = Jt();
		return (e, i) => (u(), t("section", Yt, [n("h2", Xt, p(m(r)("settings.apiAccess.title")), 1), n("div", null, [
			n("label", Zt, p(m(r)("settings.apiAccess.apiKey")), 1),
			n("div", Qt, [i[0] ||= n("input", {
				id: "api-key",
				readonly: "",
			...
			}, null, -1), n("button", $t, p(m(r)("settings.apiAccess.copy")), 1)]),
			n("p", en, p(m(r)("settings.apiAccess.description")), 1)
		])]));
	}
}), nn = r({
	__name: "Wrapper",
	setup(e) {
		...
		return t && !t.config.globalProperties.$t && t.use(Kt, { tolgee: qt }), (e, t) => f(e.$slots, "default");
	}
}), rn = { render() {
	return a(nn, {}, { default: () => a(tn) });
} };
