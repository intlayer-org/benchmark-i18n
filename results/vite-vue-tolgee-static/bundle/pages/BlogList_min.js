...
var Zt = { class: "grid gap-6 md:grid-cols-2" }, Qt = { class: "mb-3 flex items-center gap-3" }, $t = { class: "rounded-full bg-accent px-3 py-0.5 text-xs font-medium text-accent-foreground" }, en = { class: "text-xs text-muted-foreground" }, tn = { class: "mb-2 text-lg font-semibold text-foreground" }, nn = { class: "mb-4 text-sm text-muted-foreground" }, rn = {
	type: "button",
	...
	setup(i) {
		...
		return (t, i) => (d(), n("div", Zt, [(d(!0), n(e, null, p(s.value, (e) => (d(), n("article", {
			key: e.title,
			class: "rounded-lg border border-border bg-card p-6"
		}, [
			r("div", Qt, [r("span", $t, h(e.category), 1), r("span", en, h(e.date), 1)]),
			r("h2", tn, h(e.title), 1),
			r("p", nn, h(e.excerpt), 1),
			r("button", rn, h(g(a)("blog.list.readMore")), 1)
		]))), 128))]));
	}
}), on = i({
	__name: "Wrapper",
