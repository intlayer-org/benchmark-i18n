...
var Zt = { class: "mb-12 grid gap-4 md:grid-cols-3" }, Qt = { class: "text-sm font-semibold text-foreground" }, $t = { class: "text-xs text-muted-foreground" }, en = i({
	...
	setup(t) {
		...
		return (t, o) => (d(), n("div", Zt, [(d(), n(e, null, p(a, (e) => r("div", {
			key: e.labelKey,
			class: "rounded-lg border border-border bg-card p-4 text-center"
		}, [r("p", Qt, h(g(i)(e.labelKey)), 1), r("p", $t, h(g(i)(e.valueKey)), 1)])), 64))]));
	}
}), tn = i({
	__name: "Wrapper",
	setup(e) {
