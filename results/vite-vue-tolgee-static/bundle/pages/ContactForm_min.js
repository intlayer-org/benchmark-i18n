import { Fragment as e, computed as t, createElementBlock as n, createElementVNode as r, defineComponent as i, getCurrentInstance as a, h as o, inject as s, onBeforeMount as c, onMounted as l, onUnmounted as u, openBlock as d, ref as f, renderList as p, renderSlot as m, toDisplayString as h, unref as g, watch as _, withModifiers as v } from "vue";
...
var ue = () => ({
	...
	let r = le(n?.headers);
	return r["x-api-key"] && (r = Object.assign(Object.assign({}, ue()), r)), e(t, Object.assign(Object.assign({}, n), { headers: r }));
}, fe = (e) => {
...
}, N = (e) => Object.fromEntries(fe(e).entries()), P = (e) => {
	let [t, ...n] = e.split(":");
	return {
		language: t,
		namespace: n.join(":") || ""
...
function Se(e, t) {
	let n = R(xe, t?.initialOptions, e);
	return n.apiUrl = oe(n.apiUrl), e?.fetch && (n.fetch = de(e.fetch)), {
		initialOptions: n,
...
function Ce(e, t, n, r, i, a, o, s) {
	...
	function S() {
		return O(s.onError, (e) => new _e("Tolgee: Failed to load language", e), () => l.languageStorage?.getLanguage(p()));
	}
	function ee() {
		if (!l.languageDetector) return;
		let e = n();
		return O(s.onError, (e) => new ge("Tolgee: Failed to detect language", e), () => l.languageDetector?.getLanguage(Object.assign({ availableLanguages: e }, p())));
	}
	function te(e) {
		e && l.backends.push(e);
	}
	...
	let T = Object.freeze({
		...
		setStoredLanguage(e) {
			return O(s.onError, (e) => new _e("Tolgee: Failed to store language", e), () => l.languageStorage?.setLanguage(e, p()));
		},
		getDevBackend() {
			return l.devBackend;
		},
		...
		formatTranslation(n) {
			...
			try {
				...
				console.error(e);
				let n = se(e) || L, r = t().onFormatError, a = typeof r;
...
function Te(e, t, n) {
	let r = Se(), i, a = Object.freeze({
		...
		getFallbackLangs(e) {
			...
			return t ? M([t, ...ae(t, r.initialOptions.fallbackLanguage)]) : [];
		},
		getFallbackNs() {
		...
		overrideCredentials(e) {
			i = e ? Object.assign(Object.assign({}, e), { apiUrl: oe(e.apiUrl) }) : void 0;
		}
	});
	return a;
}
...
var ke = () => {
	let e = {
		...
		init(t) {
			let n = Oe(R(e.options, t));
			return e.plugins.forEach(n.addPlugin), n;
		}
	});
	return t;
}, Ae = 0, B = 1, je = 2, Me = class extends Error {
	constructor(e, t, n) {
		let r, i = "";
		e === Ae ? r = "Empty parameter" : e === B ? (r = "Unexpected character", i = "Did you forget to use FormatIcu to render ICU message syntax?") : r = "Unexpected end", super(`Tolgee parser: ${r} at ${t} in "${n}"` + (i ? "\n" + i : "")), this.code = e, this.index = t;
	}
};
function Ne(e) {
	return /\s/.test(e);
}
var V = 0, H = 1, U = 2, W = 3, G = 4, Pe = /* @__PURE__ */ new Set([
	U,
	H,
	V
]), K = "'", Fe = /* @__PURE__ */ new Set([
	"{",
	"}",
	K
]), Ie = (e) => /[0-9a-zA-Z_]/.test(e);
function Le(e) {
	...
	for (s = 0; s < e.length; s++) switch (i = e[s], t) {
		case V:
			...
			break;
		case H:
			Fe.has(i) ? (n = n.slice(0, -1) + i, t = U) : (n += i, t = V);
			break;
		case U:
			i === K ? t = V : (n += i, t = U);
			break;
		case W:
			i === "}" ? (d(), t = V) : Ne(i) ? r !== "" && (d(), t = G) : (u(), t = W);
			break;
		case G: i == "}" ? t = V : Ne(i) ? t = G : c(B);
	}
	return Pe.has(t) || c(je), l(), [a, o];
}
function Re(e, t) {
	let [n, r] = Le(e), i = [n[0]];
...
function ze() {
	return { format: ({ translation: e, params: t }) => Re(e, t) };
}
var Be = () => (e, t) => (t.setFinalFormatter(ze()), e);
function Ve() {
	return globalThis.window?.document?.createElement === void 0;
}
var He = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Ue = {};
(function(e) {
	function t(e, t) {
...
(ne = console.assert) == null || ne.call(console, We), RegExp(`([${["‌", "‍"].join("")}]{9})+`, "g");
function Ge(e, t) {
	return t ? `${t}: ${e}` : e;
}
var q = class e extends Error {
	constructor(t, n, r) {
		super(Ge(t, n)), this.code = t, this.status = n, this.params = r, Object.setPrototypeOf(this, e.prototype);
	}
};
function Ke(e) {
	return e instanceof Error && typeof e.code == "string";
}
var qe = 2, Je = 35e3, Ye = "TOLGEE_API_REQUEST", Xe = "TOLGEE_API_RESPONSE", Ze = "TOLGEE_PROXY_PING", Qe = "TOLGEE_PROXY_PONG";
function $e(e) {
...
}, et = 3e3, tt = 200, nt = 0, Y = /* @__PURE__ */ new Map(), rt = !1, X, Z;
async function it({ type: e, replyType: t, payload: n, timeoutMs: r = Je, progressType: i, onProgress: a }) {
	st();
	let o = Date.now() + r;
	await ct(Math.min(o, Date.now() + et));
	let s = o - Date.now();
	if (s <= 0) throw at(e);
	let c = ot();
...
var at = (e) => new J("unavailable", `the Tolgee browser extension did not answer ${e} in time`), ot = () => `${Date.now()}-${nt++}-${Math.random()}`;
function st() {
	rt || (rt = !0, window.addEventListener("message", (e) => {
		var t;
...
function ct(e) {
	return X ||= new Promise((t, n) => {
		let r = () => window.postMessage({ type: Ze }, window.origin), i = () => {
			clearInterval(a), Q(), Z = void 0, n(new J("unavailable", "the Tolgee browser extension did not answer"));
		}, a = setInterval(() => {
			if (Date.now() > e) {
				i();
				return;
...
var $ = "__tolgee_", Tt = `${$}apiKey`, Et = `${$}apiUrl`, Dt = `${$}branch`, Ot = `${$}projectId`, kt = `${$}session`, At = "tolgee-in-context-tools.umd.min.js", jt = "@tolgee/in-context-tools", Mt = "InContextTools", Nt = "https://cdn.jsdelivr.net/npm", Pt = null;
function Ft(e) {
...
function Vt() {
	let e = sessionStorage.getItem(Tt) || void 0, t = sessionStorage.getItem(Et) || void 0, n = sessionStorage.getItem(Dt) || void 0, r = sessionStorage.getItem(Ot) || void 0, i = $e(sessionStorage.getItem(kt));
	if (!t) return;
	let a = w(w({ apiUrl: t }, r === void 0 ? {} : { projectId: r }), n === void 0 ? {} : { branch: n });
	if (e) return T(w({}, a), { apiKey: e });
	if (i && r) return T(w({}, a), { transport: lt() });
}
function Ht() {
	let e = [];
...
var qt = (e) => {
	let n = A(e), r = s("tolgeeContext"), i = t(() => r.value.tolgee);
...
var Qt = { class: "grid gap-4 md:grid-cols-2" }, $t = {
	for: "name",
	...
	setup(t) {
		...
		return (t, o) => (d(), n("form", {
			class: "space-y-6",
			onSubmit: o[0] ||= v(() => {}, ["prevent"])
		}, [
			r("div", Qt, [r("div", null, [r("label", $t, h(g(i)("contact.form.name")), 1), r("input", {
				id: "name",
				...
				placeholder: g(i)("contact.form.yourName")
			}, null, 8, en)]), r("div", null, [r("label", tn, h(g(i)("contact.form.email")), 1), r("input", {
				id: "email",
				type: "email",
				class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: g(i)("contact.form.emailPlaceholder")
			}, null, 8, nn)])]),
			r("div", null, [r("label", rn, h(g(i)("contact.form.topic")), 1), r("select", an, [(d(), n(e, null, p(a, (e) => r("option", {
				key: e,
				value: e
			}, h(g(i)(`contact.form.${e}`)), 9, on)), 64))])]),
			r("div", null, [r("label", sn, h(g(i)("contact.form.message")), 1), r("textarea", {
				id: "message",
				rows: "5",
				class: "w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring",
				placeholder: g(i)("contact.form.messagePlaceholder")
			}, null, 8, cn)]),
			r("button", ln, h(g(i)("contact.form.sendMessage")), 1)
		], 32));
	}
}), dn = i({
	__name: "Wrapper",
	setup(e) {
		...
		return t && !t.config.globalProperties.$t && t.use(Yt, { tolgee: Xt }), (e, t) => m(e.$slots, "default");
	}
}), fn = { render() {
	return o(dn, {}, { default: () => o(un) });
} };
