...
var Zt = { class: "mb-6 text-2xl font-bold text-foreground" }, Qt = { class: "space-y-4" }, $t = { class: "text-base font-semibold text-foreground" }, en = { class: "text-sm text-muted-foreground" }, tn = { class: "mt-2 flex gap-2" }, nn = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, rn = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, an = { class: "rounded bg-accent px-2 py-0.5 text-xs text-accent-foreground" }, on = {
	type: "button",
	...
	setup(t) {
		...
		return (t, o) => (d(), n(e, null, [r("h2", Zt, h(g(i)("careers.openPositions.title")), 1), r("div", Qt, [(d(), n(e, null, p(a, (e, t) => r("div", {
			...
			r("h3", $t, h(g(i)(`careers.openPositions.${e.titleKey}`)), 1),
			r("p", en, h(g(i)(`careers.openPositions.${e.descKey}`)), 1),
			r("div", tn, [
				r("span", nn, h(g(i)(`careers.openPositions.${e.deptKey}`)), 1),
				r("span", rn, h(g(i)(`careers.openPositions.${e.locationKey}`)), 1),
				r("span", an, h(g(i)(`careers.openPositions.${e.typeKey}`)), 1)
			])
		]), r("button", on, h(g(i)("careers.openPositions.applyNow")), 1)])), 64))])], 64));
	}
}), cn = i({
	__name: "Wrapper",
	setup(e) {
