...
var Kt = (e) => {
	let n = re(e), r = s("tolgeeContext"), i = t(() => r.value.tolgee);
...
var Qt = { class: "mb-6 text-2xl font-bold text-foreground" }, $t = { class: "overflow-x-auto rounded-lg border border-border" }, en = { class: "w-full text-sm" }, tn = { class: "bg-muted" }, nn = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, rn = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, an = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, on = { class: "px-4 py-3 text-left font-medium text-muted-foreground" }, sn = { class: "px-4 py-3 font-medium text-foreground" }, cn = { class: "px-4 py-3 text-muted-foreground" }, ln = { class: "px-4 py-3 text-muted-foreground" }, un = { class: "px-4 py-3 text-muted-foreground" }, dn = i({
	__name: "ResultsTable",
	setup(i) {
		Zt("ResultsTable");
		let { t: a } = Xt(), o = t(() => [
		...
		return (t, i) => (d(), n("section", null, [r("h2", Qt, h(g(a)("home.resultsTable.title")), 1), r("div", $t, [r("table", en, [r("thead", tn, [r("tr", null, [
			r("th", nn, h(g(a)("home.resultsTable.library")), 1),
			r("th", rn, h(g(a)("home.resultsTable.bundleSize")), 1),
			r("th", an, h(g(a)("home.resultsTable.lookupTime")), 1),
			r("th", on, h(g(a)("home.resultsTable.lazyLoading")), 1)
		])]), r("tbody", null, [(d(!0), n(e, null, p(o.value, (e) => (d(), n("tr", {
			key: e.lib,
