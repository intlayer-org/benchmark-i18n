...
var Yt = { class: "flex justify-end gap-3" }, Xt = {
	type: "button",
	...
	setup(e) {
		let { t: r } = Jt();
		return (e, i) => (u(), t("div", Yt, [n("button", Xt, p(m(r)("settings.footer.cancel")), 1), n("button", Zt, p(m(r)("settings.footer.saveChanges")), 1)]));
	}
}), $t = r({
	__name: "Wrapper",
	setup(e) {
