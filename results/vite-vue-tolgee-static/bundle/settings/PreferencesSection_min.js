...
var Yt = { class: "rounded-lg border border-border bg-card p-6" }, Xt = { class: "mb-4 text-lg font-semibold text-foreground" }, Zt = { class: "space-y-4" }, Qt = { class: "flex items-center justify-between" }, $t = { class: "text-sm font-medium text-foreground" }, en = { class: "text-xs text-muted-foreground" }, tn = ["aria-label"], nn = { class: "flex items-center justify-between" }, rn = { class: "text-sm font-medium text-foreground" }, an = { class: "text-xs text-muted-foreground" }, on = ["aria-label"], sn = {
	for: "language",
	...
	setup(e) {
		let { t: r } = Jt();
		return (e, i) => (u(), t("section", Yt, [n("h2", Xt, p(m(r)("settings.preferences.title")), 1), n("div", Zt, [
			n("div", Qt, [n("div", null, [n("p", $t, p(m(r)("settings.preferences.emailNotifications")), 1), n("p", en, p(m(r)("settings.preferences.weeklyReports")), 1)]), n("button", {
				type: "button",
				class: "h-6 w-11 rounded-full bg-primary transition-colors",
				"aria-label": m(r)("settings.preferences.toggleNotifications")
			}, [...i[0] ||= [n("span", { class: "block h-5 w-5 translate-x-5 rounded-full bg-primary-foreground transition-transform" }, null, -1)]], 8, tn)]),
			n("div", nn, [n("div", null, [n("p", rn, p(m(r)("settings.preferences.darkMode")), 1), n("p", an, p(m(r)("settings.preferences.darkColorScheme")), 1)]), n("button", {
				type: "button",
				class: "h-6 w-11 rounded-full bg-muted transition-colors",
				"aria-label": m(r)("settings.preferences.toggleDarkMode")
			}, [...i[1] ||= [n("span", { class: "block h-5 w-5 translate-x-0.5 rounded-full bg-foreground/20 transition-transform" }, null, -1)]], 8, on)]),
			n("div", null, [n("label", sn, p(m(r)("settings.preferences.defaultLanguage")), 1), n("select", cn, [
				n("option", null, p(m(r)("settings.preferences.english")), 1),
				n("option", null, p(m(r)("settings.preferences.french")), 1),
				n("option", null, p(m(r)("settings.preferences.german")), 1),
				n("option", null, p(m(r)("settings.preferences.spanish")), 1),
				n("option", null, p(m(r)("settings.preferences.japanese")), 1),
				n("option", null, p(m(r)("settings.preferences.chinese")), 1),
				n("option", null, p(m(r)("settings.preferences.arabic")), 1)
			])])
		])]));
	}
}), un = r({
