...
var Yt = { class: "rounded-lg border border-border bg-card p-6" }, Xt = { class: "mb-4 text-lg font-semibold text-foreground" }, Zt = { class: "space-y-4" }, Qt = {
	for: "display-name",
	...
	setup(e) {
		let { t: r } = Jt();
		return (e, i) => (u(), t("section", Yt, [n("h2", Xt, p(m(r)("settings.profile.title")), 1), n("div", Zt, [n("div", null, [n("label", Qt, p(m(r)("settings.profile.displayName")), 1), i[0] ||= n("input", {
			id: "display-name",
		...
		}, null, -1)]), n("div", null, [n("label", $t, p(m(r)("settings.profile.email")), 1), i[1] ||= n("input", {
			id: "email",
