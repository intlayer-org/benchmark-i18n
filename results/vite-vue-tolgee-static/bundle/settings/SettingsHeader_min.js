...
}), $t = { class: "mb-2 text-3xl font-bold text-foreground" }, en = { class: "mb-8 text-muted-foreground" }, tn = a({
	__name: "SettingsHeader",
	setup(t) {
		let { t: a } = Xt();
		return (t, o) => (f(), n(e, null, [
			i(Qt),
			r("h1", $t, h(g(a)("settings.header.title")), 1),
			r("p", en, h(g(a)("settings.header.description")), 1)
		], 64));
	}
}), nn = a({
	__name: "Wrapper",
