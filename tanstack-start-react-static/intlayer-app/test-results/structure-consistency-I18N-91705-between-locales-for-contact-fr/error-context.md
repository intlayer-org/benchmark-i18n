...
- Name: structure-consistency.test.ts >> I18N Structural Consistency >> Structure should match between locales for contact
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e22]:
    ...
    - heading "Contactez-nous" [level=1] [ref=e24]
    - paragraph [ref=e25]:
      - text: Vous avez des idées, trouvé un bug ou vous voulez contribuer à un benchmark ? Contactez-nous à
    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e35]:
        ...
        - combobox "Topic" [ref=e37]:
          - option "Rapport de Bug" [selected]
          - option "Nouvelle Idée de Benchmark"
          - option "Question sur la Méthodologie"
          - option "Contribution"
          - option "Other"
      - generic [ref=e38]:
      ...
      - button "Envoyer le Message" [ref=e41]
  - contentinfo [ref=e42]:
    - generic [ref=e43]:
      - generic [ref=e44]:
        - generic [ref=e45]:
